...
describe('v1.DatabaseAdminClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new databaseadminModule.v1.DatabaseAdminClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'spanner.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new databaseadminModule.v1.DatabaseAdminClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'spanner.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new databaseadminModule.v1.DatabaseAdminClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new databaseadminModule.v1.DatabaseAdminClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getDatabase', () => {
        it('invokes getDatabase without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.spanner.admin.database.v1.GetDatabaseRequest', ['name']);
    ...
    describe('dropDatabase', () => {
        it('invokes dropDatabase without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.spanner.admin.database.v1.DropDatabaseRequest', ['database']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.dropDatabase as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.dropDatabase as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('getDatabaseDdl', () => {
        it('invokes getDatabaseDdl without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.spanner.admin.database.v1.GetDatabaseDdlRequest', ['database']);
            request.database = defaultValue1;
            const expectedHeaderRequestParams = `database=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getDatabaseDdl as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDatabaseDdl as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('getBackup', () => {
        it('invokes getBackup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.spanner.admin.database.v1.GetBackupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateBackup', () => {
        it('invokes updateBackup without error', async () => {
            ...
            request.backup ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.spanner.admin.database.v1.UpdateBackupRequest', ['backup', 'name']);
    ...
    describe('deleteBackup', () => {
        it('invokes deleteBackup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.spanner.admin.database.v1.DeleteBackupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('createBackupSchedule', () => {
        it('invokes createBackupSchedule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.spanner.admin.database.v1.CreateBackupScheduleRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.spanner.admin.database.v1.BackupSchedule()
            );
            client.innerApiCalls.createBackupSchedule = stubSimpleCall(expectedResponse);
            const [response] = await client.createBackupSchedule(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createBackupSchedule as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createBackupSchedule as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createBackupSchedule without error using callback', async () => {
            ...
            client.innerApiCalls.createBackupSchedule = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createBackupSchedule(
                    request,
                    (err?: Error|null, result?: protos.google.spanner.admin.database.v1.IBackupSchedule|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getBackupSchedule', () => {
        it('invokes getBackupSchedule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.spanner.admin.database.v1.GetBackupScheduleRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.spanner.admin.database.v1.BackupSchedule()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getBackupSchedule as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getBackupSchedule as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getBackupSchedule without error using callback', async () => {
            ...
            client.innerApiCalls.getBackupSchedule = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
    ...
    describe('updateBackupSchedule', () => {
        it('invokes updateBackupSchedule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.spanner.admin.database.v1.UpdateBackupScheduleRequest', ['backupSchedule', 'name']);
            request.backupSchedule.name = defaultValue1;
            const expectedHeaderRequestParams = `backup_schedule.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.spanner.admin.database.v1.BackupSchedule()
            );
            client.innerApiCalls.updateBackupSchedule = stubSimpleCall(expectedResponse);
            const [response] = await client.updateBackupSchedule(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateBackupSchedule as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateBackupSchedule as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateBackupSchedule without error using callback', async () => {
            ...
            client.innerApiCalls.updateBackupSchedule = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
    ...
    describe('deleteBackupSchedule', () => {
        it('invokes deleteBackupSchedule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.spanner.admin.database.v1.DeleteBackupScheduleRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteBackupSchedule = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteBackupSchedule(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteBackupSchedule as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteBackupSchedule as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteBackupSchedule without error using callback', async () => {
            ...
            client.innerApiCalls.deleteBackupSchedule = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
    ...
    describe('internalUpdateGraphOperation', () => {
        it('invokes internalUpdateGraphOperation without error', async () => {
            ...
            client.innerApiCalls.internalUpdateGraphOperation = stubSimpleCall(expectedResponse);
        ...
        it('invokes internalUpdateGraphOperation without error using callback', async () => {
            ...
            client.innerApiCalls.internalUpdateGraphOperation = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.internalUpdateGraphOperation(
                    request,
                    (err?: Error|null, result?: protos.google.spanner.admin.database.v1.IInternalUpdateGraphOperationResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createDatabase', () => {
        it('invokes createDatabase without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.spanner.admin.database.v1.CreateDatabaseRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateDatabase', () => {
        it('invokes updateDatabase without error', async () => {
            ...
            request.database ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.spanner.admin.database.v1.UpdateDatabaseRequest', ['database', 'name']);
        ...
        it('invokes updateDatabase without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updateDatabase(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.spanner.admin.database.v1.IDatabase, protos.google.spanner.admin.database.v1.IUpdateDatabaseMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.spanner.admin.database.v1.IDatabase, protos.google.spanner.admin.database.v1.IUpdateDatabaseMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateDatabase as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateDatabaseDdl', () => {
        it('invokes updateDatabaseDdl without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.spanner.admin.database.v1.UpdateDatabaseDdlRequest', ['database']);
            request.database = defaultValue1;
            const expectedHeaderRequestParams = `database=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateDatabaseDdl as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateDatabaseDdl as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('createBackup', () => {
        it('invokes createBackup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.spanner.admin.database.v1.CreateBackupRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('copyBackup', () => {
        it('invokes copyBackup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.spanner.admin.database.v1.CopyBackupRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.copyBackup as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.copyBackup as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('restoreDatabase', () => {
        it('invokes restoreDatabase without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.spanner.admin.database.v1.RestoreDatabaseRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.restoreDatabase as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.restoreDatabase as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('listDatabases', () => {
        it('invokes listDatabases without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.spanner.admin.database.v1.ListDatabasesRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listBackups', () => {
        it('invokes listBackups without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.spanner.admin.database.v1.ListBackupsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
    ...
    describe('listDatabaseOperations', () => {
        it('invokes listDatabaseOperations without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.spanner.admin.database.v1.ListDatabaseOperationsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listDatabaseOperations as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listDatabaseOperations as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('listBackupOperations', () => {
        it('invokes listBackupOperations without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.spanner.admin.database.v1.ListBackupOperationsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.longrunning.Operation()),
              generateSampleMessage(new protos.google.longrunning.Operation()),
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listBackupOperations as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listBackupOperations as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('listDatabaseRoles', () => {
        it('invokes listDatabaseRoles without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.spanner.admin.database.v1.ListDatabaseRolesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listDatabaseRoles as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listDatabaseRoles as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('listBackupSchedules', () => {
        it('invokes listBackupSchedules without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.spanner.admin.database.v1.ListBackupSchedulesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
            ...
            client.innerApiCalls.listBackupSchedules = stubSimpleCall(expectedResponse);
            const [response] = await client.listBackupSchedules(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listBackupSchedules as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listBackupSchedules as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listBackupSchedules without error using callback', async () => {
            ...
            client.innerApiCalls.listBackupSchedules = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listBackupSchedulesStream without error', async () => {
            ...
            client.descriptors.page.listBackupSchedules.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.spanner.admin.database.v1.BackupSchedule) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listBackupSchedules.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listBackupSchedules, request));
            assert(
        ...
        it('invokes listBackupSchedulesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listBackupSchedules.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listBackupSchedulesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.spanner.admin.database.v1.BackupSchedule[] = [];
                stream.on('data', (response: protos.google.spanner.admin.database.v1.BackupSchedule) => {
        ...
        it('uses async iteration with listBackupSchedules without error', async () => {
            ...
            client.descriptors.page.listBackupSchedules.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listBackupSchedules with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listBackupSchedules.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listBackupSchedulesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.spanner.admin.database.v1.IBackupSchedule[] = [];
                for await (const resource of iterable) {
