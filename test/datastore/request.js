...
var https = {
  request: function() {
    var result = httpsRequestOverride.apply(this, util.toArray(arguments));
...
describe('Request', function() {
  ...
  describe('get', function() {
    it('should get by key', function(done) {
      request.createRequest_ = function(method, proto, typ, callback) {
  ...
  describe('save', function() {
    ...
    describe('transactions', function() {
      ...
      it('should not set an indexed value by default', function(done) {
        request.createRequest_ = function(method, proto) {
          var property = proto.mutation.upsert[0].property[0];
  ...
  describe('createRequest_', function() {
    var mockProtoRequest = { fake: 'request' };
    mockProtoRequest.toBuffer = function() {
      return mockProtoRequest;
    };
    ...
    it('should assemble correct request', function(done) {
      ...
      request.createRequest_(method, null, null, util.noop);
    });

    it('should make https request', function(done) {
      var mockRequest = { fake: 'request' };
      ...
      request.createRequest_('commit', mockProtoRequest, null, util.noop);
    });
  });
});
