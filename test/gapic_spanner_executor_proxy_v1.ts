...
describe('v1.SpannerExecutorProxyClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new spannerexecutorproxyModule.v1.SpannerExecutorProxyClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'spanner-cloud-executor.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new spannerexecutorproxyModule.v1.SpannerExecutorProxyClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'spanner-cloud-executor.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new spannerexecutorproxyModule.v1.SpannerExecutorProxyClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new spannerexecutorproxyModule.v1.SpannerExecutorProxyClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('executeActionAsync', () => {
        it('invokes executeActionAsync without error', async () => {
            ...
            client.innerApiCalls.executeActionAsync = stubBidiStreamingCall(expectedResponse);
            const stream = client.executeActionAsync();
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.spanner.executor.v1.SpannerAsyncActionResponse) => {
                    resolve(response);
                });
            ...
            assert((client.innerApiCalls.executeActionAsync as SinonStub)
    ...
    describe('Path templates', () => {
        ...
        describe('backupSchedule', async () => {
            ...
            it('backupSchedulePath', () => {
                ...
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.backupSchedulePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromBackupScheduleName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.backupSchedulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
