...
describe('v2.TableServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          tableserviceModule.v2.TableServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          tableserviceModule.v2.TableServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'bigquery.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new tableserviceModule.v2.TableServiceClient({
          universe_domain: 'example.com',
    ...
    it('invokes getTable without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getTable(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.bigquery.v2.ITable | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('insertTable', () => {
    it('invokes insertTable without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.insertTable as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.insertTable as SinonStub
    ...
    it('invokes insertTable without error using callback', async () => {
      ...
      client.innerApiCalls.insertTable =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.insertTable(
          request,
    ...
    it('invokes insertTable with error', async () => {
      ...
      const expectedHeaderRequestParams = `project_id=${defaultValue1 ?? ''}&dataset_id=${defaultValue2 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.insertTable = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('patchTable', () => {
    it('invokes patchTable without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.patchTable as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.patchTable as SinonStub
    ...
    it('invokes patchTable without error using callback', async () => {
      ...
      client.innerApiCalls.patchTable =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.patchTable(
          request,
    ...
    it('invokes patchTable with error', async () => {
      ...
      const expectedHeaderRequestParams = `project_id=${defaultValue1 ?? ''}&dataset_id=${defaultValue2 ?? ''}&table_id=${defaultValue3 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.patchTable = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateTable', () => {
    ...
    it('invokes updateTable with error', async () => {
      ...
      const expectedHeaderRequestParams = `project_id=${defaultValue1 ?? ''}&dataset_id=${defaultValue2 ?? ''}&table_id=${defaultValue3 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateTable = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listTables', () => {
    it('invokes listTables without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.bigquery.v2.ListFormatTable(),
        ),
        generateSampleMessage(
          new protos.google.cloud.bigquery.v2.ListFormatTable(),
        ),
    ...
    it('invokes listTables without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listTables(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.bigquery.v2.IListFormatTable[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listTablesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.bigquery.v2.ListFormatTable[] = [];
        stream.on(
          'data',
          (response: protos.google.cloud.bigquery.v2.ListFormatTable) => {
    ...
    it('uses async iteration with listTables without error', async () => {
      ...
      const responses: protos.google.cloud.bigquery.v2.IListFormatTable[] = [];
