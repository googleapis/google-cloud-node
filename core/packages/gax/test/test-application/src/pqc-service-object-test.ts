...
import {Service, ServiceObject} from '@google-cloud/common';

/**
 * Tests Post Quantum Cryptography (PQC) using the specified CA cert and port.
 * It verifies ServiceObject REST client by inspecting the negotiated TLS group.
...
async function testPqc(pemPath: string, port: number) {
  console.log('Running Post Quantum Cryptography (PQC) ServiceObject Integration Tests...');
...
/**
 * Spins up a TLS-enabled showcase server and runs the ServiceObject PQC compliance tests.
 * Cleans up the generated certificate file after the tests complete.
 */
export async function runPqcServiceObjectTests() {
