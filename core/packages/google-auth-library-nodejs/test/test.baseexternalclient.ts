...
describe('BaseExternalAccountClient', () => {
  ...
  beforeEach(() => {
    ...
    sandbox.stub(BaseExternalAccountClient.prototype, 'getRegionalAccessBoundaryUrl').resolves(undefined);
  });
  ...
  describe('regional access boundaries', () => {
    ...
    beforeEach(() => {
      (BaseExternalAccountClient.prototype.getRegionalAccessBoundaryUrl as sinon.SinonStub).restore();
    });
