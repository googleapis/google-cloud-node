...
Some APIs contain additional handwritten samples in [nodejs-docs-samples](https://github.com/GoogleCloudPlatform/nodejs-docs-samples). Additionally, all APIs in this repository contain autogenerated samples, under api-name/samples/generated. Handwritten samples are always recommended over generated samples, if present.
