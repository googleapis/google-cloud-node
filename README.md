...
| [Game Servers](https://github.com/googleapis/nodejs-game-servers) | [:notebook:](https://googleapis.dev/nodejs/game-services/latest) | `npm i @google-cloud/game-servers` | [enable](https://console.cloud.google.com/flows/enableapi?apiid=gameservices.googleapis.com) | ✖ |
...
| [Google BigQuery Storage](https://github.com/googleapis/nodejs-bigquery-storage) | [:notebook:](undefined) | `npm i @google-cloud/bigquery-storage` | [enable](https://console.cloud.google.com/flows/enableapi?apiid=bigquerystorage.googleapis.com) | ✖ |
...
| [Service Directory](https://github.com/googleapis/nodejs-security-directory) | [:notebook:](https://googleapis.dev/nodejs/servicedirectory/latest/index.html) | `npm i @google-cloud/service-directory` | [enable](https://console.cloud.google.com/flows/enableapi?apiid=servicedirectory.googleapis.com) | ✖ |
...
| [Stackdriver Logging for Bunyan](https://github.com/googleapis/nodejs-logging-bunyan) | [:notebook:](https://googleapis.dev/nodejs/logging-bunyan/latest) | `npm i @google-cloud/logging-bunyan` | [enable](https://console.cloud.google.com/flows/enableapi?apiid=logging.googleapis.com) | ✔ |
