...
export {v1, ConsumerProcurementServiceClient, LicenseManagementServiceClient};
export default {v1, ConsumerProcurementServiceClient, LicenseManagementServiceClient};
