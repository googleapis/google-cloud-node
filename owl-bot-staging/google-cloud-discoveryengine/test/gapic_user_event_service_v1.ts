  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          usereventserviceModule.v1.UserEventServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          usereventserviceModule.v1.UserEventServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'discoveryengine.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new usereventserviceModule.v1.UserEventServiceClient({
          universe_domain: 'example.com',
    ...
    it('invokes writeUserEvent without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.writeUserEvent(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.discoveryengine.v1.IUserEvent | null,
          ) => {
            if (err) {
              reject(err);
            } else {
      ...
      const promise = new Promise((resolve, reject) => {
        client.purgeUserEvents(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.discoveryengine.v1.IPurgeUserEventsResponse,
              protos.google.cloud.discoveryengine.v1.IPurgeUserEventsMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
