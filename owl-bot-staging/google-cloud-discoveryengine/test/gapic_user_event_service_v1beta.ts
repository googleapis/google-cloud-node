...
describe('v1beta.UserEventServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          usereventserviceModule.v1beta.UserEventServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          usereventserviceModule.v1beta.UserEventServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'discoveryengine.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new usereventserviceModule.v1beta.UserEventServiceClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'discoveryengine.example.com');
          if (saved) {
    ...
    it('invokes writeUserEvent without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.writeUserEvent(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.discoveryengine.v1beta.IUserEvent | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('purgeUserEvents', () => {
    it('invokes purgeUserEvents without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.PurgeUserEventsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
