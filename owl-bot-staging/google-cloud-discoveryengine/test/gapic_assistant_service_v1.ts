...
describe('v1.AssistantServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client = new assistantserviceModule.v1.AssistantServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          assistantserviceModule.v1.AssistantServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          assistantserviceModule.v1.AssistantServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'discoveryengine.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new assistantserviceModule.v1.AssistantServiceClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = assistantserviceModule.v1.AssistantServiceClient.port;
      assert(port);
  ...
  describe('streamAssist', () => {
    it('invokes streamAssist without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1.StreamAssistRequest(),
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1.StreamAssistResponse(),
      );
      client.innerApiCalls.streamAssist =
      ...
      const promise = new Promise((resolve, reject) => {
        stream.on(
          'data',
          (
            response: protos.google.cloud.discoveryengine.v1.StreamAssistResponse,
          ) => {
            resolve(response);
          },
        );
      ...
      const actualRequest = (
        client.innerApiCalls.streamAssist as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes streamAssist with error', async () => {
      ...
      client.innerApiCalls.streamAssist = stubServerStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.streamAssist(request);
