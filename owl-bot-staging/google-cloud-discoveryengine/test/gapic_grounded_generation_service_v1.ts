...
describe('v1.GroundedGenerationServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          groundedgenerationserviceModule.v1.GroundedGenerationServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        groundedgenerationserviceModule.v1.GroundedGenerationServiceClient.port;
      assert(port);
  ...
  describe('generateGroundedContent', () => {
    it('invokes generateGroundedContent without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1.GenerateGroundedContentRequest(),
      );
    ...
    it('invokes generateGroundedContent without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.generateGroundedContent(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.discoveryengine.v1.IGenerateGroundedContentResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('checkGrounding', () => {
    it('invokes checkGrounding without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1.CheckGroundingRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
    ...
    it('invokes checkGrounding without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.checkGrounding(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.discoveryengine.v1.ICheckGroundingResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes streamGenerateGroundedContent without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        stream.on(
          'data',
          (
            response: protos.google.cloud.discoveryengine.v1.GenerateGroundedContentResponse,
          ) => {
            resolve(response);
          },
        );
