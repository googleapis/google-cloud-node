 ...
 */
import * as gapicConfig from './sample_query_service_client_config.json';
 ...
 * @memberof v1alpha
 */
export class SampleQueryServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const importSampleQueriesResponse = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1alpha.ImportSampleQueriesResponse') as gax.protobuf.Type;
    const importSampleQueriesMetadata = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1alpha.ImportSampleQueriesMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.discoveryengine.v1alpha.SampleQueryService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.sampleQueryServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.discoveryengine.v1alpha.SampleQueryService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.discoveryengine.v1alpha.SampleQueryService,
 ...
 */
  getSampleQuery(
      request?: protos.google.cloud.discoveryengine.v1alpha.IGetSampleQueryRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.discoveryengine.v1alpha.ISampleQuery,
        protos.google.cloud.discoveryengine.v1alpha.IGetSampleQueryRequest|undefined, {}|undefined
      ]>;
  getSampleQuery(
      request: protos.google.cloud.discoveryengine.v1alpha.IGetSampleQueryRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.discoveryengine.v1alpha.ISampleQuery,
          protos.google.cloud.discoveryengine.v1alpha.IGetSampleQueryRequest|null|undefined,
          {}|null|undefined>): void;
  getSampleQuery(
      request: protos.google.cloud.discoveryengine.v1alpha.IGetSampleQueryRequest,
      callback: Callback<
 ...
 */
  createSampleQuery(
      request?: protos.google.cloud.discoveryengine.v1alpha.ICreateSampleQueryRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.discoveryengine.v1alpha.ISampleQuery,
        protos.google.cloud.discoveryengine.v1alpha.ICreateSampleQueryRequest|undefined, {}|undefined
      ]>;
  createSampleQuery(
      request: protos.google.cloud.discoveryengine.v1alpha.ICreateSampleQueryRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.discoveryengine.v1alpha.ISampleQuery,
          protos.google.cloud.discoveryengine.v1alpha.ICreateSampleQueryRequest|null|undefined,
          {}|null|undefined>): void;
  createSampleQuery(
      request: protos.google.cloud.discoveryengine.v1alpha.ICreateSampleQueryRequest,
      callback: Callback<
 ...
 */
  updateSampleQuery(
      request?: protos.google.cloud.discoveryengine.v1alpha.IUpdateSampleQueryRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.discoveryengine.v1alpha.ISampleQuery,
        protos.google.cloud.discoveryengine.v1alpha.IUpdateSampleQueryRequest|undefined, {}|undefined
      ]>;
  updateSampleQuery(
      request: protos.google.cloud.discoveryengine.v1alpha.IUpdateSampleQueryRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.discoveryengine.v1alpha.ISampleQuery,
          protos.google.cloud.discoveryengine.v1alpha.IUpdateSampleQueryRequest|null|undefined,
          {}|null|undefined>): void;
  updateSampleQuery(
      request: protos.google.cloud.discoveryengine.v1alpha.IUpdateSampleQueryRequest,
      callback: Callback<
 ...
 */
  deleteSampleQuery(
      request?: protos.google.cloud.discoveryengine.v1alpha.IDeleteSampleQueryRequest,
      options?: CallOptions):
      Promise<[
        protos.google.protobuf.IEmpty,
        protos.google.cloud.discoveryengine.v1alpha.IDeleteSampleQueryRequest|undefined, {}|undefined
      ]>;
  deleteSampleQuery(
      request: protos.google.cloud.discoveryengine.v1alpha.IDeleteSampleQueryRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.protobuf.IEmpty,
          protos.google.cloud.discoveryengine.v1alpha.IDeleteSampleQueryRequest|null|undefined,
          {}|null|undefined>): void;
  deleteSampleQuery(
      request: protos.google.cloud.discoveryengine.v1alpha.IDeleteSampleQueryRequest,
      callback: Callback<
 ...
 */
  importSampleQueries(
      request?: protos.google.cloud.discoveryengine.v1alpha.IImportSampleQueriesRequest,
      options?: CallOptions):
      Promise<[
 ...
 * region_tag:discoveryengine_v1alpha_generated_SampleQueryService_ImportSampleQueries_async
 */
  async checkImportSampleQueriesProgress(name: string): Promise<LROperation<protos.google.cloud.discoveryengine.v1alpha.ImportSampleQueriesResponse, protos.google.cloud.discoveryengine.v1alpha.ImportSampleQueriesMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.discoveryengine.v1alpha.ImportSampleQueriesResponse, protos.google.cloud.discoveryengine.v1alpha.ImportSampleQueriesMetadata>;
  }
 /**
 * Gets a list of
 * {@link protos.google.cloud.discoveryengine.v1alpha.SampleQuery|SampleQuery}s.
 ...
 */
  listSampleQueries(
      request?: protos.google.cloud.discoveryengine.v1alpha.IListSampleQueriesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.discoveryengine.v1alpha.ISampleQuery[],
  ...
  listSampleQueries(
      ...
      callback: PaginationCallback<
          protos.google.cloud.discoveryengine.v1alpha.IListSampleQueriesRequest,
          protos.google.cloud.discoveryengine.v1alpha.IListSampleQueriesResponse|null|undefined,
          protos.google.cloud.discoveryengine.v1alpha.ISampleQuery>): void;
  listSampleQueries(
      request: protos.google.cloud.discoveryengine.v1alpha.IListSampleQueriesRequest,
      callback: PaginationCallback<
          protos.google.cloud.discoveryengine.v1alpha.IListSampleQueriesRequest,
  ...
  listSampleQueries(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.discoveryengine.v1alpha.IListSampleQueriesRequest,
      protos.google.cloud.discoveryengine.v1alpha.IListSampleQueriesResponse|null|undefined,
      protos.google.cloud.discoveryengine.v1alpha.ISampleQuery>|undefined = callback
 ...
 */
  listSampleQueriesAsync(
      request?: protos.google.cloud.discoveryengine.v1alpha.IListSampleQueriesRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.discoveryengine.v1alpha.ISampleQuery>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listSampleQueries.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.discoveryengine.v1alpha.ISampleQuery>;
  }
/**
