 ...
 */
import * as gapicConfig from './search_tuning_service_client_config.json';
 ...
 * @memberof v1alpha
 */
export class SearchTuningServiceClient {
  ...
  searchTuningServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof SearchTuningServiceClient;
    ...
    const trainCustomModelResponse = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1alpha.TrainCustomModelResponse') as gax.protobuf.Type;
    const trainCustomModelMetadata = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1alpha.TrainCustomModelMetadata') as gax.protobuf.Type;

    this.descriptors.longrunning = {
      trainCustomModel: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        trainCustomModelResponse.decode.bind(trainCustomModelResponse),
        trainCustomModelMetadata.decode.bind(trainCustomModelMetadata))
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.discoveryengine.v1alpha.SearchTuningService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.searchTuningServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.discoveryengine.v1alpha.SearchTuningService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.discoveryengine.v1alpha.SearchTuningService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const searchTuningServiceStubMethods =
        ['trainCustomModel', 'listCustomModels'];
 ...
 *   The first element of the array is an object representing {@link protos.google.cloud.discoveryengine.v1alpha.ListCustomModelsResponse|ListCustomModelsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1alpha/search_tuning_service.list_custom_models.js</caption>
 * region_tag:discoveryengine_v1alpha_generated_SearchTuningService_ListCustomModels_async
 */
  listCustomModels(
      request?: protos.google.cloud.discoveryengine.v1alpha.IListCustomModelsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.discoveryengine.v1alpha.IListCustomModelsResponse,
        protos.google.cloud.discoveryengine.v1alpha.IListCustomModelsRequest|undefined, {}|undefined
      ]>;
  listCustomModels(
      request: protos.google.cloud.discoveryengine.v1alpha.IListCustomModelsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.discoveryengine.v1alpha.IListCustomModelsResponse,
          protos.google.cloud.discoveryengine.v1alpha.IListCustomModelsRequest|null|undefined,
          {}|null|undefined>): void;
  listCustomModels(
      request: protos.google.cloud.discoveryengine.v1alpha.IListCustomModelsRequest,
      callback: Callback<
 ...
 */
  trainCustomModel(
      request?: protos.google.cloud.discoveryengine.v1alpha.ITrainCustomModelRequest,
      options?: CallOptions):
      Promise<[
 ...
 * region_tag:discoveryengine_v1alpha_generated_SearchTuningService_TrainCustomModel_async
 */
  async checkTrainCustomModelProgress(name: string): Promise<LROperation<protos.google.cloud.discoveryengine.v1alpha.TrainCustomModelResponse, protos.google.cloud.discoveryengine.v1alpha.TrainCustomModelMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.discoveryengine.v1alpha.TrainCustomModelResponse, protos.google.cloud.discoveryengine.v1alpha.TrainCustomModelMetadata>;
  }
/**
