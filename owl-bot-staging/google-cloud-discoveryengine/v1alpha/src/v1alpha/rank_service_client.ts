...
export class RankServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.discoveryengine.v1alpha.RankService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.rankServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.discoveryengine.v1alpha.RankService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.discoveryengine.v1alpha.RankService,
 ...
 */
  rank(
      request?: protos.google.cloud.discoveryengine.v1alpha.IRankRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.discoveryengine.v1alpha.IRankResponse,
        protos.google.cloud.discoveryengine.v1alpha.IRankRequest|undefined, {}|undefined
      ]>;
  rank(
      request: protos.google.cloud.discoveryengine.v1alpha.IRankRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.discoveryengine.v1alpha.IRankResponse,
          protos.google.cloud.discoveryengine.v1alpha.IRankRequest|null|undefined,
          {}|null|undefined>): void;
  rank(
      request: protos.google.cloud.discoveryengine.v1alpha.IRankRequest,
      callback: Callback<
