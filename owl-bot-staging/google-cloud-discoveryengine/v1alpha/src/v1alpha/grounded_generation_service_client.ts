...
export class GroundedGenerationServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof GroundedGenerationServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.discoveryengine.v1alpha.GroundedGenerationService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.groundedGenerationServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.discoveryengine.v1alpha.GroundedGenerationService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.discoveryengine.v1alpha.GroundedGenerationService,
 ...
 */
  checkGrounding(
      request?: protos.google.cloud.discoveryengine.v1alpha.ICheckGroundingRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.discoveryengine.v1alpha.ICheckGroundingResponse,
        protos.google.cloud.discoveryengine.v1alpha.ICheckGroundingRequest|undefined, {}|undefined
      ]>;
  checkGrounding(
      request: protos.google.cloud.discoveryengine.v1alpha.ICheckGroundingRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.discoveryengine.v1alpha.ICheckGroundingResponse,
          protos.google.cloud.discoveryengine.v1alpha.ICheckGroundingRequest|null|undefined,
          {}|null|undefined>): void;
  checkGrounding(
      request: protos.google.cloud.discoveryengine.v1alpha.ICheckGroundingRequest,
      callback: Callback<
