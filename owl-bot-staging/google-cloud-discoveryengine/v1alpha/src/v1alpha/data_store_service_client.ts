...
export class DataStoreServiceClient {
  ...
  initialize() {
    ...
    const dataStoreServiceStubMethods =
        ['createDataStore', 'getDataStore', 'listDataStores', 'deleteDataStore', 'updateDataStore', 'getDocumentProcessingConfig', 'updateDocumentProcessingConfig'];
 ...
 */
  getDocumentProcessingConfig(
      ...
      Promise<[
        ...
        protos.google.cloud.discoveryengine.v1alpha.IGetDocumentProcessingConfigRequest|undefined, {}|undefined
      ]>;
  getDocumentProcessingConfig(
      request: protos.google.cloud.discoveryengine.v1alpha.IGetDocumentProcessingConfigRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.discoveryengine.v1alpha.IDocumentProcessingConfig,
          protos.google.cloud.discoveryengine.v1alpha.IGetDocumentProcessingConfigRequest|null|undefined,
          {}|null|undefined>): void;
  getDocumentProcessingConfig(
      request: protos.google.cloud.discoveryengine.v1alpha.IGetDocumentProcessingConfigRequest,
      callback: Callback<
 ...
 */
  updateDocumentProcessingConfig(
      request?: protos.google.cloud.discoveryengine.v1alpha.IUpdateDocumentProcessingConfigRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.discoveryengine.v1alpha.IDocumentProcessingConfig,
        protos.google.cloud.discoveryengine.v1alpha.IUpdateDocumentProcessingConfigRequest|undefined, {}|undefined
      ]>;
  updateDocumentProcessingConfig(
      request: protos.google.cloud.discoveryengine.v1alpha.IUpdateDocumentProcessingConfigRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.discoveryengine.v1alpha.IDocumentProcessingConfig,
          protos.google.cloud.discoveryengine.v1alpha.IUpdateDocumentProcessingConfigRequest|null|undefined,
          {}|null|undefined>): void;
  updateDocumentProcessingConfig(
      request: protos.google.cloud.discoveryengine.v1alpha.IUpdateDocumentProcessingConfigRequest,
      callback: Callback<
...
/**
  ...
  matchSampleQuerySetFromSampleQueryName(sampleQueryName: string) {
    return this.pathTemplates.sampleQueryPathTemplate.match(sampleQueryName).sampleQuerySet;
  }
  ...
  matchSampleQueryFromSampleQueryName(sampleQueryName: string) {
    return this.pathTemplates.sampleQueryPathTemplate.match(sampleQueryName).sampleQuery;
  }
  ...
  matchSampleQuerySetFromSampleQuerySetName(sampleQuerySetName: string) {
    return this.pathTemplates.sampleQuerySetPathTemplate.match(sampleQuerySetName).sampleQuerySet;
  }
