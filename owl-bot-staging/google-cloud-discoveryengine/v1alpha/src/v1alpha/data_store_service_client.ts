...
export class DataStoreServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this.descriptors.page = {
      listDataStores:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'dataStores')
    };
    ...
    if (opts.fallback) {
      ...
      lroOptions.httpRules = [{selector: 'google.longrunning.Operations.GetOperation',get: '/v1alpha/{name=projects/*/locations/*/collections/*/dataStores/*/branches/*/operations/*}',additional_bindings: [{get: '/v1alpha/{name=projects/*/locations/*/collections/*/dataStores/*/models/*/operations/*}',},{get: '/v1alpha/{name=projects/*/locations/*/collections/*/dataStores/*/operations/*}',},{get: '/v1alpha/{name=projects/*/locations/*/collections/*/dataStores/*/schemas/*/operations/*}',},{get: '/v1alpha/{name=projects/*/locations/*/collections/*/dataStores/*/siteSearchEngine/operations/*}',},{get: '/v1alpha/{name=projects/*/locations/*/collections/*/dataStores/*/siteSearchEngine/targetSites/operations/*}',},{get: '/v1alpha/{name=projects/*/locations/*/collections/*/engines/*/operations/*}',},{get: '/v1alpha/{name=projects/*/locations/*/collections/*/operations/*}',},{get: '/v1alpha/{name=projects/*/locations/*/dataStores/*/branches/*/operations/*}',},{get: '/v1alpha/{name=projects/*/locations/*/dataStores/*/models/*/operations/*}',},{get: '/v1alpha/{name=projects/*/locations/*/dataStores/*/operations/*}',},{get: '/v1alpha/{name=projects/*/locations/*/operations/*}',},{get: '/v1alpha/{name=projects/*/operations/*}',}],
      },{selector: 'google.longrunning.Operations.ListOperations',get: '/v1alpha/{name=projects/*/locations/*/collections/*/dataStores/*/branches/*}/operations',additional_bindings: [{get: '/v1alpha/{name=projects/*/locations/*/collections/*/dataStores/*/models/*}/operations',},{get: '/v1alpha/{name=projects/*/locations/*/collections/*/dataStores/*/schemas/*}/operations',},{get: '/v1alpha/{name=projects/*/locations/*/collections/*/dataStores/*/siteSearchEngine/targetSites}/operations',},{get: '/v1alpha/{name=projects/*/locations/*/collections/*/dataStores/*/siteSearchEngine}/operations',},{get: '/v1alpha/{name=projects/*/locations/*/collections/*/dataStores/*}/operations',},{get: '/v1alpha/{name=projects/*/locations/*/collections/*/engines/*}/operations',},{get: '/v1alpha/{name=projects/*/locations/*/collections/*}/operations',},{get: '/v1alpha/{name=projects/*/locations/*/dataStores/*/branches/*}/operations',},{get: '/v1alpha/{name=projects/*/locations/*/dataStores/*/models/*}/operations',},{get: '/v1alpha/{name=projects/*/locations/*/dataStores/*}/operations',},{get: '/v1alpha/{name=projects/*/locations/*}/operations',},{get: '/v1alpha/{name=projects/*}/operations',}],
      }];
    }
    this.operationsClient = this._gaxModule.lro(lroOptions).operationsClient(opts);
    const createDataStoreResponse = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1alpha.DataStore') as gax.protobuf.Type;
    const createDataStoreMetadata = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1alpha.CreateDataStoreMetadata') as gax.protobuf.Type;
    const deleteDataStoreResponse = protoFilesRoot.lookup(
      '.google.protobuf.Empty') as gax.protobuf.Type;
    const deleteDataStoreMetadata = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1alpha.DeleteDataStoreMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.discoveryengine.v1alpha.DataStoreService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.dataStoreServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.discoveryengine.v1alpha.DataStoreService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.discoveryengine.v1alpha.DataStoreService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const dataStoreServiceStubMethods =
        ['createDataStore', 'getDataStore', 'listDataStores', 'deleteDataStore', 'updateDataStore'];
 ...
 */
  getDataStore(
      request?: protos.google.cloud.discoveryengine.v1alpha.IGetDataStoreRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.discoveryengine.v1alpha.IDataStore,
        protos.google.cloud.discoveryengine.v1alpha.IGetDataStoreRequest|undefined, {}|undefined
      ]>;
  getDataStore(
      request: protos.google.cloud.discoveryengine.v1alpha.IGetDataStoreRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.discoveryengine.v1alpha.IDataStore,
          protos.google.cloud.discoveryengine.v1alpha.IGetDataStoreRequest|null|undefined,
          {}|null|undefined>): void;
  getDataStore(
      request: protos.google.cloud.discoveryengine.v1alpha.IGetDataStoreRequest,
      callback: Callback<
 ...
 */
  updateDataStore(
      request?: protos.google.cloud.discoveryengine.v1alpha.IUpdateDataStoreRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.discoveryengine.v1alpha.IDataStore,
        protos.google.cloud.discoveryengine.v1alpha.IUpdateDataStoreRequest|undefined, {}|undefined
      ]>;
  updateDataStore(
      request: protos.google.cloud.discoveryengine.v1alpha.IUpdateDataStoreRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.discoveryengine.v1alpha.IDataStore,
          protos.google.cloud.discoveryengine.v1alpha.IUpdateDataStoreRequest|null|undefined,
          {}|null|undefined>): void;
  updateDataStore(
      request: protos.google.cloud.discoveryengine.v1alpha.IUpdateDataStoreRequest,
      callback: Callback<
 ...
 */
  createDataStore(
      request?: protos.google.cloud.discoveryengine.v1alpha.ICreateDataStoreRequest,
      options?: CallOptions):
      Promise<[
 ...
 * region_tag:discoveryengine_v1alpha_generated_DataStoreService_CreateDataStore_async
 */
  async checkCreateDataStoreProgress(name: string): Promise<LROperation<protos.google.cloud.discoveryengine.v1alpha.DataStore, protos.google.cloud.discoveryengine.v1alpha.CreateDataStoreMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.discoveryengine.v1alpha.DataStore, protos.google.cloud.discoveryengine.v1alpha.CreateDataStoreMetadata>;
  }
/**
 ...
 */
  deleteDataStore(
      request?: protos.google.cloud.discoveryengine.v1alpha.IDeleteDataStoreRequest,
      options?: CallOptions):
      Promise<[
 ...
 * region_tag:discoveryengine_v1alpha_generated_DataStoreService_DeleteDataStore_async
 */
  async checkDeleteDataStoreProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.discoveryengine.v1alpha.DeleteDataStoreMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    ...
    return decodeOperation as LROperation<protos.google.protobuf.Empty, protos.google.cloud.discoveryengine.v1alpha.DeleteDataStoreMetadata>;
  }
 /**
 ...
 */
  listDataStores(
      request?: protos.google.cloud.discoveryengine.v1alpha.IListDataStoresRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.discoveryengine.v1alpha.IDataStore[],
  ...
  listDataStores(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.discoveryengine.v1alpha.IListDataStoresResponse|null|undefined,
          protos.google.cloud.discoveryengine.v1alpha.IDataStore>): void;
  listDataStores(
      request: protos.google.cloud.discoveryengine.v1alpha.IListDataStoresRequest,
      callback: PaginationCallback<
          protos.google.cloud.discoveryengine.v1alpha.IListDataStoresRequest,
 ...
 */
  listDataStoresAsync(
      request?: protos.google.cloud.discoveryengine.v1alpha.IListDataStoresRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.discoveryengine.v1alpha.IDataStore>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listDataStores.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.discoveryengine.v1alpha.IDataStore>;
  }
/**
