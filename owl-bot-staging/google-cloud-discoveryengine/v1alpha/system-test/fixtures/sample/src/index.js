...
function main() {
  const aclConfigServiceClient = new discoveryengine.AclConfigServiceClient();
  const chunkServiceClient = new discoveryengine.ChunkServiceClient();
  ...
  const estimateBillingServiceClient = new discoveryengine.EstimateBillingServiceClient();
  const evaluationServiceClient = new discoveryengine.EvaluationServiceClient();
  ...
  const sampleQueryServiceClient = new discoveryengine.SampleQueryServiceClient();
  const sampleQuerySetServiceClient = new discoveryengine.SampleQuerySetServiceClient();
