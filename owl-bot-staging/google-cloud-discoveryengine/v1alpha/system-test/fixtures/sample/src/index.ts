...
import {AclConfigServiceClient, ChunkServiceClient, CompletionServiceClient, ControlServiceClient, ConversationalSearchServiceClient, DataStoreServiceClient, DocumentServiceClient, EngineServiceClient, EstimateBillingServiceClient, EvaluationServiceClient, GroundedGenerationServiceClient, ProjectServiceClient, RankServiceClient, RecommendationServiceClient, SampleQueryServiceClient, SampleQuerySetServiceClient, SchemaServiceClient, SearchServiceClient, SearchTuningServiceClient, ServingConfigServiceClient, SiteSearchEngineServiceClient, UserEventServiceClient} from '@google-cloud/discoveryengine';

// check that the client class type name can be used
function doStuffWithAclConfigServiceClient(client: AclConfigServiceClient) {
  client.close();
}
function doStuffWithChunkServiceClient(client: ChunkServiceClient) {
  client.close();
}
...
function doStuffWithEstimateBillingServiceClient(client: EstimateBillingServiceClient) {
  client.close();
}
...
function doStuffWithSampleQueryServiceClient(client: SampleQueryServiceClient) {
  client.close();
}
function doStuffWithSampleQuerySetServiceClient(client: SampleQuerySetServiceClient) {
  client.close();
}
...
function main() {
  ...
  const aclConfigServiceClient = new AclConfigServiceClient();
  doStuffWithAclConfigServiceClient(aclConfigServiceClient);
  // check that the client instance can be created
  const chunkServiceClient = new ChunkServiceClient();
  doStuffWithChunkServiceClient(chunkServiceClient);
  // check that the client instance can be created
  ...
  // check that the client instance can be created
  const estimateBillingServiceClient = new EstimateBillingServiceClient();
  doStuffWithEstimateBillingServiceClient(estimateBillingServiceClient);
  // check that the client instance can be created
  ...
  // check that the client instance can be created
  const sampleQueryServiceClient = new SampleQueryServiceClient();
  doStuffWithSampleQueryServiceClient(sampleQueryServiceClient);
  // check that the client instance can be created
  const sampleQuerySetServiceClient = new SampleQuerySetServiceClient();
  doStuffWithSampleQuerySetServiceClient(sampleQuerySetServiceClient);
  // check that the client instance can be created
