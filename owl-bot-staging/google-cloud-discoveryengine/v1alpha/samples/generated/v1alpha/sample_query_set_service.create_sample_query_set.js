...
function main(parent, sampleQuerySet, sampleQuerySetId) {
  // [START discoveryengine_v1alpha_generated_SampleQuerySetService_CreateSampleQuerySet_async]
  /**
   ...
   */
  // const sampleQuerySetId = 'abc123'

  // Imports the Discoveryengine library
  const {SampleQuerySetServiceClient} = require('@google-cloud/discoveryengine').v1alpha;

  // Instantiates a client
  const discoveryengineClient = new SampleQuerySetServiceClient();

  async function callCreateSampleQuerySet() {
    // Construct request
    const request = {
      parent,
      sampleQuerySet,
    ...
    // Run request
    const response = await discoveryengineClient.createSampleQuerySet(request);
    console.log(response);
  }

  callCreateSampleQuerySet();
