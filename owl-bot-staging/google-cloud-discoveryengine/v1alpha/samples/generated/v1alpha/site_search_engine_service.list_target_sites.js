...
function main(parent) {
  ...
  async function callListTargetSites() {
    ...
    // Run request
    const iterable = await discoveryengineClient.listTargetSitesAsync(request);
  ...
  callListTargetSites();
  // [END discoveryengine_v1alpha_generated_SiteSearchEngineService_ListTargetSites_async]
}
