...
# [Discoveryengine: Nodejs Client][homepage]
...
Discoveryengine client for Node.js
...
* [Discoveryengine Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/discoveryengine/latest)
* [Discoveryengine Documentation](https://cloud.google.com/generative-ai-app-builder/docs)
...
1.  [Enable the Discoveryengine API][enable_api].
