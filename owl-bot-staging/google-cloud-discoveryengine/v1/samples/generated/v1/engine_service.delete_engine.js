...
function main(name) {
  // [START discoveryengine_v1_generated_EngineService_DeleteEngine_async]
  /**
  ...
  async function callDeleteEngine() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const [operation] = await discoveryengineClient.deleteEngine(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callDeleteEngine();
  // [END discoveryengine_v1_generated_EngineService_DeleteEngine_async]
}
