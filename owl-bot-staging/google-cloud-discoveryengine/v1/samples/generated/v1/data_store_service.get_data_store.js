...
function main(name) {
  // [START discoveryengine_v1_generated_DataStoreService_GetDataStore_async]
  /**
  ...
  async function callGetDataStore() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await discoveryengineClient.getDataStore(request);
    console.log(response);
  }

  callGetDataStore();
  // [END discoveryengine_v1_generated_DataStoreService_GetDataStore_async]
}
