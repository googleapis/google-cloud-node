...
export class CompletionServiceClient {
  ...
  initialize() {
    ...
    const completionServiceStubMethods =
        ['completeQuery', 'importSuggestionDenyListEntries', 'purgeSuggestionDenyListEntries'];
