...
export class SearchTuningServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const trainCustomModelResponse = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1.TrainCustomModelResponse') as gax.protobuf.Type;
    const trainCustomModelMetadata = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1.TrainCustomModelMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.discoveryengine.v1.SearchTuningService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.searchTuningServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.discoveryengine.v1.SearchTuningService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.discoveryengine.v1.SearchTuningService,
 ...
 */
  listCustomModels(
      request?: protos.google.cloud.discoveryengine.v1.IListCustomModelsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.discoveryengine.v1.IListCustomModelsResponse,
        protos.google.cloud.discoveryengine.v1.IListCustomModelsRequest|undefined, {}|undefined
      ]>;
  listCustomModels(
      request: protos.google.cloud.discoveryengine.v1.IListCustomModelsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.discoveryengine.v1.IListCustomModelsResponse,
          protos.google.cloud.discoveryengine.v1.IListCustomModelsRequest|null|undefined,
          {}|null|undefined>): void;
  listCustomModels(
      request: protos.google.cloud.discoveryengine.v1.IListCustomModelsRequest,
      callback: Callback<
 ...
 */
  trainCustomModel(
      request?: protos.google.cloud.discoveryengine.v1.ITrainCustomModelRequest,
      options?: CallOptions):
      Promise<[
 ...
 * region_tag:discoveryengine_v1_generated_SearchTuningService_TrainCustomModel_async
 */
  async checkTrainCustomModelProgress(name: string): Promise<LROperation<protos.google.cloud.discoveryengine.v1.TrainCustomModelResponse, protos.google.cloud.discoveryengine.v1.TrainCustomModelMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.discoveryengine.v1.TrainCustomModelResponse, protos.google.cloud.discoveryengine.v1.TrainCustomModelMetadata>;
  }
/**
...
/**
   ...
   * @returns {string} Resource name string.
   */
  projectLocationCmekConfigPath(project:string,location:string,cmekConfig:string) {
    return this.pathTemplates.projectLocationCmekConfigPathTemplate.render({
      project: project,
      location: location,
   ...
   */
  matchCmekConfigFromProjectLocationCmekConfigName(projectLocationCmekConfigName: string) {
    return this.pathTemplates.projectLocationCmekConfigPathTemplate.match(projectLocationCmekConfigName).cmek_config;
  }
