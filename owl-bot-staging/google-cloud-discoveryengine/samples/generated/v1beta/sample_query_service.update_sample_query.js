...
function main(sampleQuery) {
  ...
  async function callUpdateSampleQuery() {
    // Construct request
    const request = {
      sampleQuery,
    };
    ...
    // Run request
    const response = await discoveryengineClient.updateSampleQuery(request);
    console.log(response);
  }

  callUpdateSampleQuery();
