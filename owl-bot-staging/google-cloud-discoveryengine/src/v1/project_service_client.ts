...
export class ProjectServiceClient {
  ...
  constructor(
    ...
    const provisionProjectMetadata = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1.ProvisionProjectMetadata',
    ) as gax.protobuf.Type;
    ...
    this.projectServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ...
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.discoveryengine.v1.ProjectService,
      this._opts,
      this._providedCustomServicePath,
   ...
   */
  provisionProject(
    request?: protos.google.cloud.discoveryengine.v1.IProvisionProjectRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<
  ...
  async checkProvisionProjectProgress(
    ...
    LROperation<
      protos.google.cloud.discoveryengine.v1.Project,
      protos.google.cloud.discoveryengine.v1.ProvisionProjectMetadata
    >
  > {
