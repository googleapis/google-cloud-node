...
import {CompletionServiceClient, ConversationalSearchServiceClient, DocumentServiceClient, RecommendationServiceClient, SchemaServiceClient, SearchServiceClient, UserEventServiceClient} from '@google-cloud/discoveryengine';
