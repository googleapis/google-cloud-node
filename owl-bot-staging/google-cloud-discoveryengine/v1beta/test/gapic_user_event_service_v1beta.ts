...
describe('v1beta.UserEventServiceClient', () => {
    ...
    describe('Path templates', () => {
        ...
        describe('dataStore', () => {
            const fakePath = "/rendered/path/dataStore";
            ...
            client.initialize();
            client.pathTemplates.dataStorePathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.dataStorePathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('dataStorePath', () => {
                const result = client.dataStorePath("projectValue", "locationValue", "dataStoreValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.dataStorePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromDataStoreName', () => {
                const result = client.matchProjectFromDataStoreName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.dataStorePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromDataStoreName', () => {
                const result = client.matchLocationFromDataStoreName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.dataStorePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchDataStoreFromDataStoreName', () => {
                const result = client.matchDataStoreFromDataStoreName(fakePath);
