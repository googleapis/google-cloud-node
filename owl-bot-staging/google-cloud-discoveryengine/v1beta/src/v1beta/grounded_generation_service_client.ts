...
export class GroundedGenerationServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.discoveryengine.v1beta.GroundedGenerationService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.groundedGenerationServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.discoveryengine.v1beta.GroundedGenerationService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.discoveryengine.v1beta.GroundedGenerationService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const groundedGenerationServiceStubMethods =
        ['streamGenerateGroundedContent', 'generateGroundedContent', 'checkGrounding'];
 ...
 */
  generateGroundedContent(
      request?: protos.google.cloud.discoveryengine.v1beta.IGenerateGroundedContentRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.discoveryengine.v1beta.IGenerateGroundedContentResponse,
        protos.google.cloud.discoveryengine.v1beta.IGenerateGroundedContentRequest|undefined, {}|undefined
      ]>;
  generateGroundedContent(
      request: protos.google.cloud.discoveryengine.v1beta.IGenerateGroundedContentRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.discoveryengine.v1beta.IGenerateGroundedContentResponse,
          protos.google.cloud.discoveryengine.v1beta.IGenerateGroundedContentRequest|null|undefined,
          {}|null|undefined>): void;
  generateGroundedContent(
      request: protos.google.cloud.discoveryengine.v1beta.IGenerateGroundedContentRequest,
      callback: Callback<
  ...
  generateGroundedContent(
    ...
    this.initialize();
    return this.innerApiCalls.generateGroundedContent(request, options, callback);
  }
/**
 ...
 */
  checkGrounding(
      ...
      Promise<[
        ...
        protos.google.cloud.discoveryengine.v1beta.ICheckGroundingRequest|undefined, {}|undefined
      ]>;
  checkGrounding(
      request: protos.google.cloud.discoveryengine.v1beta.ICheckGroundingRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.discoveryengine.v1beta.ICheckGroundingResponse,
          protos.google.cloud.discoveryengine.v1beta.ICheckGroundingRequest|null|undefined,
          {}|null|undefined>): void;
  checkGrounding(
      request: protos.google.cloud.discoveryengine.v1beta.ICheckGroundingRequest,
      callback: Callback<
