...
export default {v1beta, CompletionServiceClient, DocumentServiceClient, RecommendationServiceClient, SchemaServiceClient, SearchServiceClient, UserEventServiceClient};
