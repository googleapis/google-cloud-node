...
export class ConversationsClient {
  ...
  initialize() {
    ...
    const conversationsStubMethods =
        ['createConversation', 'listConversations', 'getConversation', 'completeConversation', 'listMessages', 'suggestConversationSummary', 'generateStatelessSummary', 'searchKnowledge'];
