 ...
 *  {@link protos.google.cloud.dialogflow.v2.SessionEntityType|SessionEntityTypes}.
 * @class
 * @memberof v2
 */
export class SessionEntityTypesClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.dialogflow.v2.SessionEntityTypes', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.sessionEntityTypesStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.dialogflow.v2.SessionEntityTypes') :
 ...
 *   The first element of the array is an object representing {@link protos.google.cloud.dialogflow.v2.SessionEntityType|SessionEntityType}.
  ...
  getSessionEntityType(
    ...
    return this.innerApiCalls.getSessionEntityType(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.dialogflow.v2.ISessionEntityType,
        protos.google.cloud.dialogflow.v2.IGetSessionEntityTypeRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getSessionEntityType response %j', response);
 ...
 */
  ...
  createSessionEntityType(
    ...
    return this.innerApiCalls.createSessionEntityType(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.dialogflow.v2.ISessionEntityType,
        protos.google.cloud.dialogflow.v2.ICreateSessionEntityTypeRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('createSessionEntityType response %j', response);
        return [response, options, rawResponse];
 ...
 */
  ...
  updateSessionEntityType(
    ...
    return this.innerApiCalls.updateSessionEntityType(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.dialogflow.v2.ISessionEntityType,
        protos.google.cloud.dialogflow.v2.IUpdateSessionEntityTypeRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('updateSessionEntityType response %j', response);
        return [response, options, rawResponse];
 ...
 */
  ...
  deleteSessionEntityType(
    ...
    return this.innerApiCalls.deleteSessionEntityType(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.protobuf.IEmpty,
        protos.google.cloud.dialogflow.v2.IDeleteSessionEntityTypeRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('deleteSessionEntityType response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.cloud.dialogflow.v2.SessionEntityType|SessionEntityType}.
 ...
 */
  ...
  listSessionEntityTypes(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.dialogflow.v2.IListSessionEntityTypesRequest,
      protos.google.cloud.dialogflow.v2.IListSessionEntityTypesResponse|null|undefined,
      protos.google.cloud.dialogflow.v2.ISessionEntityType>|undefined = callback
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.cloud.dialogflow.v2.SessionEntityType|SessionEntityType} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   {@link protos.google.cloud.dialogflow.v2.SessionEntityType|SessionEntityType}. The API will be called under the hood as needed, once per the page,
