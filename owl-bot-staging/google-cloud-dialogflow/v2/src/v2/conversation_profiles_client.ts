...
export class ConversationProfilesClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const setSuggestionFeatureConfigResponse = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.v2.ConversationProfile') as gax.protobuf.Type;
    const setSuggestionFeatureConfigMetadata = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.v2.SetSuggestionFeatureConfigOperationMetadata') as gax.protobuf.Type;
    ...
    const clearSuggestionFeatureConfigMetadata = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.v2.ClearSuggestionFeatureConfigOperationMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.dialogflow.v2.ConversationProfiles', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.conversationProfilesStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.dialogflow.v2.ConversationProfiles') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.dialogflow.v2.ConversationProfiles,
 ...
 */
  getConversationProfile(
      ...
      Promise<[
        ...
        protos.google.cloud.dialogflow.v2.IGetConversationProfileRequest|undefined, {}|undefined
      ]>;
  getConversationProfile(
      request: protos.google.cloud.dialogflow.v2.IGetConversationProfileRequest,
      options: CallOptions,
  ...
  getConversationProfile(
    ...
    return this.innerApiCalls.getConversationProfile(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.dialogflow.v2.IConversationProfile,
        protos.google.cloud.dialogflow.v2.IGetConversationProfileRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getConversationProfile response %j', response);
 ...
 */
  createConversationProfile(
      ...
      Promise<[
        protos.google.cloud.dialogflow.v2.IConversationProfile,
        protos.google.cloud.dialogflow.v2.ICreateConversationProfileRequest|undefined, {}|undefined
      ]>;
  createConversationProfile(
      request: protos.google.cloud.dialogflow.v2.ICreateConversationProfileRequest,
      options: CallOptions,
  ...
  createConversationProfile(
    ...
    return this.innerApiCalls.createConversationProfile(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.dialogflow.v2.IConversationProfile,
        protos.google.cloud.dialogflow.v2.ICreateConversationProfileRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('createConversationProfile response %j', response);
        return [response, options, rawResponse];
 ...
 */
  updateConversationProfile(
      ...
      Promise<[
        protos.google.cloud.dialogflow.v2.IConversationProfile,
        protos.google.cloud.dialogflow.v2.IUpdateConversationProfileRequest|undefined, {}|undefined
      ]>;
  updateConversationProfile(
      request: protos.google.cloud.dialogflow.v2.IUpdateConversationProfileRequest,
      options: CallOptions,
  ...
  updateConversationProfile(
    ...
    return this.innerApiCalls.updateConversationProfile(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.dialogflow.v2.IConversationProfile,
        protos.google.cloud.dialogflow.v2.IUpdateConversationProfileRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('updateConversationProfile response %j', response);
        return [response, options, rawResponse];
 ...
 */
  deleteConversationProfile(
      ...
      Promise<[
        ...
        protos.google.cloud.dialogflow.v2.IDeleteConversationProfileRequest|undefined, {}|undefined
      ]>;
  deleteConversationProfile(
      request: protos.google.cloud.dialogflow.v2.IDeleteConversationProfileRequest,
      options: CallOptions,
  ...
  deleteConversationProfile(
    ...
    return this.innerApiCalls.deleteConversationProfile(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.protobuf.IEmpty,
        protos.google.cloud.dialogflow.v2.IDeleteConversationProfileRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('deleteConversationProfile response %j', response);
        return [response, options, rawResponse];
 ...
 */
  setSuggestionFeatureConfig(
      ...
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.dialogflow.v2.IConversationProfile, protos.google.cloud.dialogflow.v2.ISetSuggestionFeatureConfigOperationMetadata>,
 ...
 * region_tag:dialogflow_v2_generated_ConversationProfiles_SetSuggestionFeatureConfig_async
 */
  async checkSetSuggestionFeatureConfigProgress(name: string): Promise<LROperation<protos.google.cloud.dialogflow.v2.ConversationProfile, protos.google.cloud.dialogflow.v2.SetSuggestionFeatureConfigOperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.dialogflow.v2.ConversationProfile, protos.google.cloud.dialogflow.v2.SetSuggestionFeatureConfigOperationMetadata>;
  }
/**
 ...
 */
  clearSuggestionFeatureConfig(
      ...
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.dialogflow.v2.IConversationProfile, protos.google.cloud.dialogflow.v2.IClearSuggestionFeatureConfigOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
      ]>;
  clearSuggestionFeatureConfig(
      request: protos.google.cloud.dialogflow.v2.IClearSuggestionFeatureConfigRequest,
 ...
 * region_tag:dialogflow_v2_generated_ConversationProfiles_ClearSuggestionFeatureConfig_async
 */
  async checkClearSuggestionFeatureConfigProgress(name: string): Promise<LROperation<protos.google.cloud.dialogflow.v2.ConversationProfile, protos.google.cloud.dialogflow.v2.ClearSuggestionFeatureConfigOperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.dialogflow.v2.ConversationProfile, protos.google.cloud.dialogflow.v2.ClearSuggestionFeatureConfigOperationMetadata>;
  }
 /**
 ...
 */
  ...
  listConversationProfiles(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.dialogflow.v2.IConversationProfile>): void;
  listConversationProfiles(
      request: protos.google.cloud.dialogflow.v2.IListConversationProfilesRequest,
      callback: PaginationCallback<
          protos.google.cloud.dialogflow.v2.IListConversationProfilesRequest,
  ...
  listConversationProfiles(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.dialogflow.v2.IListConversationProfilesRequest,
      protos.google.cloud.dialogflow.v2.IListConversationProfilesResponse|null|undefined,
      protos.google.cloud.dialogflow.v2.IConversationProfile>|undefined = callback
 ...
 */
  listConversationProfilesAsync(
      request?: protos.google.cloud.dialogflow.v2.IListConversationProfilesRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.dialogflow.v2.IConversationProfile>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listConversationProfiles.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.dialogflow.v2.IConversationProfile>;
  }
/**
