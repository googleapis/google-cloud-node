...
/**
 *  Service for managing {@link protos.google.cloud.dialogflow.v2.Environment|Environments}.
 * @class
 * @memberof v2
 */
export class EnvironmentsClient {
  ...
  initialize() {
    ...
    const environmentsStubMethods =
        ['listEnvironments', 'getEnvironment', 'createEnvironment', 'updateEnvironment', 'deleteEnvironment', 'getEnvironmentHistory'];
 ...
 *   The first element of the array is an object representing {@link protos.google.cloud.dialogflow.v2.Environment|Environment}.
 ...
 */
  getEnvironment(
      ...
      Promise<[
        ...
        protos.google.cloud.dialogflow.v2.IGetEnvironmentRequest|undefined, {}|undefined
      ]>;
  getEnvironment(
      request: protos.google.cloud.dialogflow.v2.IGetEnvironmentRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2.IEnvironment,
          protos.google.cloud.dialogflow.v2.IGetEnvironmentRequest|null|undefined,
          {}|null|undefined>): void;
  getEnvironment(
      request: protos.google.cloud.dialogflow.v2.IGetEnvironmentRequest,
      callback: Callback<
 ...
 */
  createEnvironment(
      ...
      Promise<[
        protos.google.cloud.dialogflow.v2.IEnvironment,
        protos.google.cloud.dialogflow.v2.ICreateEnvironmentRequest|undefined, {}|undefined
      ]>;
  createEnvironment(
      request: protos.google.cloud.dialogflow.v2.ICreateEnvironmentRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2.IEnvironment,
          protos.google.cloud.dialogflow.v2.ICreateEnvironmentRequest|null|undefined,
          {}|null|undefined>): void;
  createEnvironment(
      request: protos.google.cloud.dialogflow.v2.ICreateEnvironmentRequest,
      callback: Callback<
 ...
 */
  updateEnvironment(
      ...
      Promise<[
        protos.google.cloud.dialogflow.v2.IEnvironment,
        protos.google.cloud.dialogflow.v2.IUpdateEnvironmentRequest|undefined, {}|undefined
      ]>;
  updateEnvironment(
      request: protos.google.cloud.dialogflow.v2.IUpdateEnvironmentRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2.IEnvironment,
          protos.google.cloud.dialogflow.v2.IUpdateEnvironmentRequest|null|undefined,
          {}|null|undefined>): void;
  updateEnvironment(
      request: protos.google.cloud.dialogflow.v2.IUpdateEnvironmentRequest,
      callback: Callback<
 ...
 */
  deleteEnvironment(
      ...
      Promise<[
        ...
        protos.google.cloud.dialogflow.v2.IDeleteEnvironmentRequest|undefined, {}|undefined
      ]>;
  deleteEnvironment(
      request: protos.google.cloud.dialogflow.v2.IDeleteEnvironmentRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.protobuf.IEmpty,
          protos.google.cloud.dialogflow.v2.IDeleteEnvironmentRequest|null|undefined,
          {}|null|undefined>): void;
  deleteEnvironment(
      request: protos.google.cloud.dialogflow.v2.IDeleteEnvironmentRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.cloud.dialogflow.v2.Environment|Environment}.
 ...
 */
  ...
  listEnvironments(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.dialogflow.v2.IListEnvironmentsRequest,
      protos.google.cloud.dialogflow.v2.IListEnvironmentsResponse|null|undefined,
      protos.google.cloud.dialogflow.v2.IEnvironment>|undefined = callback
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.cloud.dialogflow.v2.Environment|Environment} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   {@link protos.google.cloud.dialogflow.v2.Environment|Environment}. The API will be called under the hood as needed, once per the page,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.cloud.dialogflow.v2.EnvironmentHistory.Entry|Entry}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 ...
 */
  ...
  getEnvironmentHistory(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.dialogflow.v2.EnvironmentHistory.IEntry>): void;
  getEnvironmentHistory(
      request: protos.google.cloud.dialogflow.v2.IGetEnvironmentHistoryRequest,
      callback: PaginationCallback<
          protos.google.cloud.dialogflow.v2.IGetEnvironmentHistoryRequest,
  ...
  getEnvironmentHistory(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.dialogflow.v2.IGetEnvironmentHistoryRequest,
      protos.google.cloud.dialogflow.v2.IEnvironmentHistory|null|undefined,
      protos.google.cloud.dialogflow.v2.EnvironmentHistory.IEntry>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
...
/**
 * Equivalent to `getEnvironmentHistory`, but returns a NodeJS Stream object.
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 *   Required. The name of the environment to retrieve history for.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.cloud.dialogflow.v2.EnvironmentHistory.Entry|Entry} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed. Note that it can affect your quota.
 *   We recommend using `getEnvironmentHistoryAsync()`
 *   method described below for async iteration which you can stop as needed.
 ...
 *   An iterable Object that allows {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols | async iteration }.
 *   When you iterate the returned iterable, each element will be an object representing
 *   {@link protos.google.cloud.dialogflow.v2.EnvironmentHistory.Entry|Entry}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
