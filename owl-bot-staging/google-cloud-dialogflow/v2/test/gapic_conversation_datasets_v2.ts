...
describe('v2.ConversationDatasetsClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new conversationdatasetsModule.v2.ConversationDatasetsClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = conversationdatasetsModule.v2.ConversationDatasetsClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = conversationdatasetsModule.v2.ConversationDatasetsClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new conversationdatasetsModule.v2.ConversationDatasetsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new conversationdatasetsModule.v2.ConversationDatasetsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new conversationdatasetsModule.v2.ConversationDatasetsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new conversationdatasetsModule.v2.ConversationDatasetsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = conversationdatasetsModule.v2.ConversationDatasetsClient.port;
            assert(port);
    ...
    describe('getConversationDataset', () => {
        it('invokes getConversationDataset without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.GetConversationDatasetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.ConversationDataset()
            );
            client.innerApiCalls.getConversationDataset = stubSimpleCall(expectedResponse);
            const [response] = await client.getConversationDataset(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getConversationDataset as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getConversationDataset as SinonStub)
        ...
        it('invokes getConversationDataset without error using callback', async () => {
            ...
            client.innerApiCalls.getConversationDataset = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getConversationDataset(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.IConversationDataset|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getConversationDataset with error', async () => {
            ...
            client.innerApiCalls.getConversationDataset = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getConversationDataset(request), expectedError);
            const actualRequest = (client.innerApiCalls.getConversationDataset as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getConversationDataset as SinonStub)
    ...
    describe('createConversationDataset', () => {
        it('invokes createConversationDataset without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.CreateConversationDatasetRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createConversationDataset = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createConversationDataset(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createConversationDataset as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createConversationDataset as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createConversationDataset without error using callback', async () => {
            ...
            client.innerApiCalls.createConversationDataset = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createConversationDataset(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dialogflow.v2.IConversationDataset, protos.google.cloud.dialogflow.v2.ICreateConversationDatasetOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dialogflow.v2.IConversationDataset, protos.google.cloud.dialogflow.v2.ICreateConversationDatasetOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createConversationDataset as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createConversationDataset with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createConversationDataset = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createConversationDataset(request), expectedError);
            const actualRequest = (client.innerApiCalls.createConversationDataset as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createConversationDataset as SinonStub)
        ...
        it('invokes createConversationDataset with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createConversationDataset = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createConversationDataset(request);
        ...
        it('invokes checkCreateConversationDatasetProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateConversationDatasetProgress(expectedResponse.name);
        ...
        it('invokes checkCreateConversationDatasetProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreateConversationDatasetProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('deleteConversationDataset', () => {
        it('invokes deleteConversationDataset without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.DeleteConversationDatasetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteConversationDataset = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteConversationDataset(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteConversationDataset as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteConversationDataset as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteConversationDataset without error using callback', async () => {
            ...
            client.innerApiCalls.deleteConversationDataset = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteConversationDataset(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.dialogflow.v2.IDeleteConversationDatasetOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.dialogflow.v2.IDeleteConversationDatasetOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteConversationDataset as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes deleteConversationDataset with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteConversationDataset = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteConversationDataset(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteConversationDataset as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteConversationDataset as SinonStub)
        ...
        it('invokes deleteConversationDataset with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteConversationDataset = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteConversationDataset(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteConversationDataset as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteConversationDatasetProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteConversationDatasetProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteConversationDatasetProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteConversationDatasetProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('importConversationData', () => {
        it('invokes importConversationData without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.ImportConversationDataRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.importConversationData = stubLongRunningCall(expectedResponse);
            const [operation] = await client.importConversationData(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importConversationData as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.importConversationData as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes importConversationData without error using callback', async () => {
            ...
            client.innerApiCalls.importConversationData = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.importConversationData(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dialogflow.v2.IImportConversationDataOperationResponse, protos.google.cloud.dialogflow.v2.IImportConversationDataOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dialogflow.v2.IImportConversationDataOperationResponse, protos.google.cloud.dialogflow.v2.IImportConversationDataOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importConversationData as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes importConversationData with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.importConversationData = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.importConversationData(request), expectedError);
            const actualRequest = (client.innerApiCalls.importConversationData as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.importConversationData as SinonStub)
        ...
        it('invokes importConversationData with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.importConversationData = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.importConversationData(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.importConversationData as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkImportConversationDataProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkImportConversationDataProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkImportConversationDataProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkImportConversationDataProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('listConversationDatasets', () => {
        it('invokes listConversationDatasets without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.ListConversationDatasetsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.ConversationDataset()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.ConversationDataset()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.ConversationDataset()),
            ];
            client.innerApiCalls.listConversationDatasets = stubSimpleCall(expectedResponse);
            const [response] = await client.listConversationDatasets(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listConversationDatasets as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listConversationDatasets as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listConversationDatasets without error using callback', async () => {
            ...
            client.innerApiCalls.listConversationDatasets = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listConversationDatasets(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.IConversationDataset[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listConversationDatasets with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listConversationDatasets = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listConversationDatasets(request), expectedError);
            const actualRequest = (client.innerApiCalls.listConversationDatasets as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listConversationDatasets as SinonStub)
        ...
        it('invokes listConversationDatasetsStream without error', async () => {
            ...
            client.descriptors.page.listConversationDatasets.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listConversationDatasetsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2.ConversationDataset[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2.ConversationDataset) => {
            ...
            assert((client.descriptors.page.listConversationDatasets.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listConversationDatasets, request));
            assert(
                (client.descriptors.page.listConversationDatasets.createStream as SinonStub)
        ...
        it('invokes listConversationDatasetsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listConversationDatasets.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listConversationDatasetsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2.ConversationDataset[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2.ConversationDataset) => {
        ...
        it('uses async iteration with listConversationDatasets without error', async () => {
            ...
            client.descriptors.page.listConversationDatasets.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.dialogflow.v2.IConversationDataset[] = [];
            const iterable = client.listConversationDatasetsAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listConversationDatasets.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listConversationDatasets with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listConversationDatasets.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listConversationDatasetsAsync(request);
