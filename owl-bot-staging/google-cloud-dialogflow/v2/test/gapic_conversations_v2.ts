...
describe('v2.ConversationsClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new conversationsModule.v2.ConversationsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new conversationsModule.v2.ConversationsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new conversationsModule.v2.ConversationsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new conversationsModule.v2.ConversationsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createConversation', () => {
        it('invokes createConversation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.CreateConversationRequest', ['parent']);
        ...
        it('invokes createConversation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createConversation(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.IConversation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getConversation', () => {
        it('invokes getConversation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.GetConversationRequest', ['name']);
    ...
    describe('completeConversation', () => {
        it('invokes completeConversation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.CompleteConversationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.Conversation()
    ...
    describe('ingestContextReferences', () => {
        it('invokes ingestContextReferences without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.IngestContextReferencesRequest', ['conversation']);
        ...
        it('invokes ingestContextReferences without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.ingestContextReferences(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.IIngestContextReferencesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('suggestConversationSummary', () => {
        it('invokes suggestConversationSummary without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.SuggestConversationSummaryRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.SuggestConversationSummaryRequest', ['conversation']);
            request.conversation = defaultValue1;
            const expectedHeaderRequestParams = `conversation=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.SuggestConversationSummaryResponse()
            );
        ...
        it('invokes suggestConversationSummary without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.suggestConversationSummary(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.ISuggestConversationSummaryResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateStatelessSummary', () => {
        it('invokes generateStatelessSummary without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.GenerateStatelessSummaryRequest()
            );
            request.statelessConversation ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.GenerateStatelessSummaryRequest', ['statelessConversation', 'parent']);
            ...
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.GenerateStatelessSummaryResponse()
            );
        ...
        it('invokes generateStatelessSummary without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateStatelessSummary(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.IGenerateStatelessSummaryResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateStatelessSuggestion', () => {
        it('invokes generateStatelessSuggestion without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.GenerateStatelessSuggestionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.GenerateStatelessSuggestionRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.GenerateStatelessSuggestionResponse()
            );
        ...
        it('invokes generateStatelessSuggestion without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateStatelessSuggestion(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.IGenerateStatelessSuggestionResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('searchKnowledge', () => {
        it('invokes searchKnowledge without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.SearchKnowledgeRequest', ['parent']);
            request.parent = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.SearchKnowledgeRequest', ['conversation']);
        ...
        it('invokes searchKnowledge without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.searchKnowledge(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.ISearchKnowledgeResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateSuggestions', () => {
        it('invokes generateSuggestions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.GenerateSuggestionsRequest', ['conversation']);
            request.conversation = defaultValue1;
            const expectedHeaderRequestParams = `conversation=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes generateSuggestions without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateSuggestions(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.IGenerateSuggestionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listConversations', () => {
        it('invokes listConversations without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.ListConversationsRequest', ['parent']);
            request.parent = defaultValue1;
        ...
        it('invokes listConversationsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.dialogflow.v2.Conversation) => {
    ...
    describe('listMessages', () => {
        it('invokes listMessages without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.ListMessagesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
        ...
        it('invokes listMessages without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listMessages(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.IMessage[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listMessagesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.dialogflow.v2.Message) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
