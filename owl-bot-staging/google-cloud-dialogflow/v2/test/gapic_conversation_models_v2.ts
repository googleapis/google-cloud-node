...
import * as conversationmodelsModule from '../src';
...
describe('v2.ConversationModelsClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = conversationmodelsModule.v2.ConversationModelsClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = conversationmodelsModule.v2.ConversationModelsClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new conversationmodelsModule.v2.ConversationModelsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new conversationmodelsModule.v2.ConversationModelsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = conversationmodelsModule.v2.ConversationModelsClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.conversationModelsStub, undefined);
            await client.initialize();
            assert(client.conversationModelsStub);
        });
    ...
    describe('getConversationModel', () => {
        it('invokes getConversationModel without error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.GetConversationModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.ConversationModel()
            );
            client.innerApiCalls.getConversationModel = stubSimpleCall(expectedResponse);
            const [response] = await client.getConversationModel(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getConversationModel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getConversationModel as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getConversationModel without error using callback', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getConversationModel = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getConversationModel(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.IConversationModel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getConversationModel with error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getConversationModel = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes getConversationModel with closed client', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('getConversationModelEvaluation', () => {
        it('invokes getConversationModelEvaluation without error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.GetConversationModelEvaluationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.ConversationModelEvaluation()
            );
            client.innerApiCalls.getConversationModelEvaluation = stubSimpleCall(expectedResponse);
            const [response] = await client.getConversationModelEvaluation(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getConversationModelEvaluation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getConversationModelEvaluation as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getConversationModelEvaluation without error using callback', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getConversationModelEvaluation = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getConversationModelEvaluation(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.IConversationModelEvaluation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getConversationModelEvaluation with error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getConversationModelEvaluation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getConversationModelEvaluation(request), expectedError);
            const actualRequest = (client.innerApiCalls.getConversationModelEvaluation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getConversationModelEvaluation as SinonStub)
        ...
        it('invokes getConversationModelEvaluation with closed client', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('createConversationModel', () => {
        it('invokes createConversationModel without error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.CreateConversationModelRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createConversationModel = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createConversationModel(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createConversationModel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createConversationModel as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes createConversationModel without error using callback', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.createConversationModel = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createConversationModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dialogflow.v2.IConversationModel, protos.google.cloud.dialogflow.v2.ICreateConversationModelOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dialogflow.v2.IConversationModel, protos.google.cloud.dialogflow.v2.ICreateConversationModelOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createConversationModel as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createConversationModel with call error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createConversationModel = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createConversationModel(request), expectedError);
            const actualRequest = (client.innerApiCalls.createConversationModel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createConversationModel as SinonStub)
        ...
        it('invokes createConversationModel with LRO error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createConversationModel = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createConversationModel(request);
        ...
        it('invokes checkCreateConversationModelProgress without error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const decodedOperation = await client.checkCreateConversationModelProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkCreateConversationModelProgress with error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            await assert.rejects(client.checkCreateConversationModelProgress(''), expectedError);
    ...
    describe('deleteConversationModel', () => {
        it('invokes deleteConversationModel without error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.DeleteConversationModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteConversationModel = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteConversationModel(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteConversationModel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteConversationModel as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes deleteConversationModel without error using callback', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.deleteConversationModel = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteConversationModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.dialogflow.v2.IDeleteConversationModelOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.dialogflow.v2.IDeleteConversationModelOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteConversationModel as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes deleteConversationModel with call error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteConversationModel = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteConversationModel(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteConversationModel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteConversationModel as SinonStub)
        ...
        it('invokes deleteConversationModel with LRO error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteConversationModel = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteConversationModel(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteConversationModel as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteConversationModelProgress without error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteConversationModelProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkDeleteConversationModelProgress with error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteConversationModelProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('deployConversationModel', () => {
        it('invokes deployConversationModel without error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.DeployConversationModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deployConversationModel = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deployConversationModel(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deployConversationModel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deployConversationModel as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes deployConversationModel without error using callback', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.deployConversationModel = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deployConversationModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.dialogflow.v2.IDeployConversationModelOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.dialogflow.v2.IDeployConversationModelOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deployConversationModel as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes deployConversationModel with call error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deployConversationModel = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deployConversationModel(request), expectedError);
            const actualRequest = (client.innerApiCalls.deployConversationModel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deployConversationModel as SinonStub)
        ...
        it('invokes deployConversationModel with LRO error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deployConversationModel = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deployConversationModel(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deployConversationModel as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeployConversationModelProgress without error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeployConversationModelProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkDeployConversationModelProgress with error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeployConversationModelProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('undeployConversationModel', () => {
        it('invokes undeployConversationModel without error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.UndeployConversationModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.undeployConversationModel = stubLongRunningCall(expectedResponse);
            const [operation] = await client.undeployConversationModel(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.undeployConversationModel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.undeployConversationModel as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes undeployConversationModel without error using callback', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.undeployConversationModel = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.undeployConversationModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.dialogflow.v2.IUndeployConversationModelOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.dialogflow.v2.IUndeployConversationModelOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.undeployConversationModel as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes undeployConversationModel with call error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.undeployConversationModel = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.undeployConversationModel(request), expectedError);
            const actualRequest = (client.innerApiCalls.undeployConversationModel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.undeployConversationModel as SinonStub)
        ...
        it('invokes undeployConversationModel with LRO error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.undeployConversationModel = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.undeployConversationModel(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.undeployConversationModel as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUndeployConversationModelProgress without error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUndeployConversationModelProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkUndeployConversationModelProgress with error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUndeployConversationModelProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('createConversationModelEvaluation', () => {
        it('invokes createConversationModelEvaluation without error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.CreateConversationModelEvaluationRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createConversationModelEvaluation = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createConversationModelEvaluation(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createConversationModelEvaluation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createConversationModelEvaluation as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes createConversationModelEvaluation without error using callback', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.createConversationModelEvaluation = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createConversationModelEvaluation(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dialogflow.v2.IConversationModelEvaluation, protos.google.cloud.dialogflow.v2.ICreateConversationModelEvaluationOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dialogflow.v2.IConversationModelEvaluation, protos.google.cloud.dialogflow.v2.ICreateConversationModelEvaluationOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createConversationModelEvaluation as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createConversationModelEvaluation with call error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createConversationModelEvaluation = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createConversationModelEvaluation(request), expectedError);
            const actualRequest = (client.innerApiCalls.createConversationModelEvaluation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createConversationModelEvaluation as SinonStub)
        ...
        it('invokes createConversationModelEvaluation with LRO error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createConversationModelEvaluation = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createConversationModelEvaluation(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.createConversationModelEvaluation as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkCreateConversationModelEvaluationProgress without error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkCreateConversationModelEvaluationProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkCreateConversationModelEvaluationProgress with error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkCreateConversationModelEvaluationProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('listConversationModels', () => {
        it('invokes listConversationModels without error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.ListConversationModelsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.ConversationModel()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.ConversationModel()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.ConversationModel()),
            ];
            client.innerApiCalls.listConversationModels = stubSimpleCall(expectedResponse);
            const [response] = await client.listConversationModels(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listConversationModels as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listConversationModels as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes listConversationModels without error using callback', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listConversationModels = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listConversationModels(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.IConversationModel[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listConversationModels with error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listConversationModels = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listConversationModels(request), expectedError);
            const actualRequest = (client.innerApiCalls.listConversationModels as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listConversationModels as SinonStub)
        ...
        it('invokes listConversationModelsStream without error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listConversationModels.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listConversationModelsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2.ConversationModel[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2.ConversationModel) => {
            ...
            assert((client.descriptors.page.listConversationModels.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listConversationModels, request));
            assert(
                (client.descriptors.page.listConversationModels.createStream as SinonStub)
        ...
        it('invokes listConversationModelsStream with error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listConversationModels.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listConversationModelsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2.ConversationModel[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2.ConversationModel) => {
        ...
        it('uses async iteration with listConversationModels without error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listConversationModels.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.dialogflow.v2.IConversationModel[] = [];
            const iterable = client.listConversationModelsAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listConversationModels.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listConversationModels with error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listConversationModels.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listConversationModelsAsync(request);
    ...
    describe('listConversationModelEvaluations', () => {
        it('invokes listConversationModelEvaluations without error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.ListConversationModelEvaluationsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
            ...
            client.innerApiCalls.listConversationModelEvaluations = stubSimpleCall(expectedResponse);
            const [response] = await client.listConversationModelEvaluations(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listConversationModelEvaluations as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listConversationModelEvaluations as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes listConversationModelEvaluations without error using callback', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listConversationModelEvaluations = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listConversationModelEvaluations(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.IConversationModelEvaluation[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listConversationModelEvaluations with error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listConversationModelEvaluations = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listConversationModelEvaluations(request), expectedError);
            const actualRequest = (client.innerApiCalls.listConversationModelEvaluations as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listConversationModelEvaluations as SinonStub)
        ...
        it('invokes listConversationModelEvaluationsStream without error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const stream = client.listConversationModelEvaluationsStream(request);
            const promise = new Promise((resolve, reject) => {
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listConversationModelEvaluations.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listConversationModelEvaluations, request));
            assert(
                (client.descriptors.page.listConversationModelEvaluations.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listConversationModelEvaluationsStream with error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listConversationModelEvaluations.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listConversationModelEvaluationsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2.ConversationModelEvaluation[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2.ConversationModelEvaluation) => {
        ...
        it('uses async iteration with listConversationModelEvaluations without error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listConversationModelEvaluations.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.dialogflow.v2.IConversationModelEvaluation[] = [];
            const iterable = client.listConversationModelEvaluationsAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listConversationModelEvaluations.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listConversationModelEvaluations.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listConversationModelEvaluations with error', async () => {
            const client = new conversationmodelsModule.v2.ConversationModelsClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listConversationModelEvaluations.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listConversationModelEvaluationsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.dialogflow.v2.IConversationModelEvaluation[] = [];
                for await (const resource of iterable) {
