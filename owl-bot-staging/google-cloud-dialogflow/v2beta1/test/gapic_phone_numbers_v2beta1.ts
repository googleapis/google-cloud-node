...
describe('v2beta1.PhoneNumbersClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = phonenumbersModule.v2beta1.PhoneNumbersClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = phonenumbersModule.v2beta1.PhoneNumbersClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new phonenumbersModule.v2beta1.PhoneNumbersClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new phonenumbersModule.v2beta1.PhoneNumbersClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new phonenumbersModule.v2beta1.PhoneNumbersClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new phonenumbersModule.v2beta1.PhoneNumbersClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = phonenumbersModule.v2beta1.PhoneNumbersClient.port;
            assert(port);
    ...
    describe('updatePhoneNumber', () => {
        it('invokes updatePhoneNumber without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.UpdatePhoneNumberRequest()
            );
            request.phoneNumber ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.UpdatePhoneNumberRequest', ['phoneNumber', 'name']);
            request.phoneNumber.name = defaultValue1;
            const expectedHeaderRequestParams = `phone_number.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.PhoneNumber()
            );
            ...
            const actualRequest = (client.innerApiCalls.updatePhoneNumber as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updatePhoneNumber as SinonStub)
        ...
        it('invokes updatePhoneNumber without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updatePhoneNumber(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2beta1.IPhoneNumber|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deletePhoneNumber', () => {
        it('invokes deletePhoneNumber without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.DeletePhoneNumberRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.DeletePhoneNumberRequest', ['name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deletePhoneNumber as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deletePhoneNumber as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('undeletePhoneNumber', () => {
        it('invokes undeletePhoneNumber without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.UndeletePhoneNumberRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.UndeletePhoneNumberRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.PhoneNumber()
            );
            client.innerApiCalls.undeletePhoneNumber = stubSimpleCall(expectedResponse);
            const [response] = await client.undeletePhoneNumber(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.undeletePhoneNumber as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.undeletePhoneNumber as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes undeletePhoneNumber without error using callback', async () => {
            ...
            client.innerApiCalls.undeletePhoneNumber = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.undeletePhoneNumber(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2beta1.IPhoneNumber|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes undeletePhoneNumber with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.undeletePhoneNumber = stubSimpleCall(undefined, expectedError);
    ...
    describe('listPhoneNumbers', () => {
        it('invokes listPhoneNumbers without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.ListPhoneNumbersRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.ListPhoneNumbersRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.PhoneNumber()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.PhoneNumber()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.PhoneNumber()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listPhoneNumbers as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listPhoneNumbers as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listPhoneNumbersStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2beta1.PhoneNumber[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2beta1.PhoneNumber) => {
        ...
        it('uses async iteration with listPhoneNumbers without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.v2beta1.IPhoneNumber[] = [];
