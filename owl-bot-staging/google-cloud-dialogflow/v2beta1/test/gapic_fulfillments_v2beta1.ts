...
describe('v2beta1.FulfillmentsClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new fulfillmentsModule.v2beta1.FulfillmentsClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = fulfillmentsModule.v2beta1.FulfillmentsClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = fulfillmentsModule.v2beta1.FulfillmentsClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new fulfillmentsModule.v2beta1.FulfillmentsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new fulfillmentsModule.v2beta1.FulfillmentsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new fulfillmentsModule.v2beta1.FulfillmentsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new fulfillmentsModule.v2beta1.FulfillmentsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = fulfillmentsModule.v2beta1.FulfillmentsClient.port;
            assert(port);
    ...
    describe('getFulfillment', () => {
        it('invokes getFulfillment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.GetFulfillmentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.Fulfillment()
            );
        ...
        it('invokes getFulfillment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getFulfillment(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2beta1.IFulfillment|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateFulfillment', () => {
        it('invokes updateFulfillment without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.UpdateFulfillmentRequest()
            );
            request.fulfillment ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.UpdateFulfillmentRequest', ['fulfillment', 'name']);
