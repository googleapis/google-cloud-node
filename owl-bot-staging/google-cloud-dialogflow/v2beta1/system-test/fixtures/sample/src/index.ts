...
function doStuffWithPhoneNumbersClient(client: PhoneNumbersClient) {
  client.close();
}
...
function main() {
  ...
  doStuffWithPhoneNumbersClient(phoneNumbersClient);
  // check that the client instance can be created
