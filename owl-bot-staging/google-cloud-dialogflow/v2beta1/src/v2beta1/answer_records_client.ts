 ...
 */
import * as gapicConfig from './answer_records_client_config.json';
const version = require('../../../package.json').version;

/**
 *  Service for managing
 *  {@link protos.google.cloud.dialogflow.v2beta1.AnswerRecord|AnswerRecords}.
 * @class
 * @memberof v2beta1
 */
export class AnswerRecordsClient {
  ...
  answerRecordsStub?: Promise<{[name: string]: Function}>;
   ...
   *     const client = new AnswerRecordsClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof AnswerRecordsClient;
    ...
    this.descriptors.page = {
      listAnswerRecords:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'answerRecords')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.dialogflow.v2beta1.AnswerRecords', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.answerRecordsStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.dialogflow.v2beta1.AnswerRecords') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.dialogflow.v2beta1.AnswerRecords,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const answerRecordsStubMethods =
        ['getAnswerRecord', 'listAnswerRecords', 'updateAnswerRecord'];
    for (const methodName of answerRecordsStubMethods) {
      const callPromise = this.answerRecordsStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.cloud.dialogflow.v2beta1.AnswerRecord|AnswerRecord}.
 ...
 */
  getAnswerRecord(
      ...
      Promise<[
        ...
        protos.google.cloud.dialogflow.v2beta1.IGetAnswerRecordRequest|undefined, {}|undefined
      ]>;
  getAnswerRecord(
      request: protos.google.cloud.dialogflow.v2beta1.IGetAnswerRecordRequest,
      options: CallOptions,
  ...
  getAnswerRecord(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getAnswerRecord(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.dialogflow.v2beta1.IAnswerRecord,
        protos.google.cloud.dialogflow.v2beta1.IGetAnswerRecordRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getAnswerRecord response %j', response);
 ...
 */
  updateAnswerRecord(
      ...
      Promise<[
        protos.google.cloud.dialogflow.v2beta1.IAnswerRecord,
        protos.google.cloud.dialogflow.v2beta1.IUpdateAnswerRecordRequest|undefined, {}|undefined
      ]>;
  updateAnswerRecord(
      request: protos.google.cloud.dialogflow.v2beta1.IUpdateAnswerRecordRequest,
      options: CallOptions,
  ...
  updateAnswerRecord(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.updateAnswerRecord(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.dialogflow.v2beta1.IAnswerRecord,
        protos.google.cloud.dialogflow.v2beta1.IUpdateAnswerRecordRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('updateAnswerRecord response %j', response);
        return [response, options, rawResponse];
 ...
 *   Optional. The
 *   {@link protos.google.cloud.dialogflow.v2beta1.ListAnswerRecordsResponse.next_page_token|ListAnswerRecordsResponse.next_page_token}
 *   value returned from a previous list request used to continue listing on
 *   the next page.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.cloud.dialogflow.v2beta1.AnswerRecord|AnswerRecord}.
 ...
 */
  ...
  listAnswerRecords(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.dialogflow.v2beta1.IAnswerRecord>): void;
  listAnswerRecords(
      request: protos.google.cloud.dialogflow.v2beta1.IListAnswerRecordsRequest,
      callback: PaginationCallback<
          protos.google.cloud.dialogflow.v2beta1.IListAnswerRecordsRequest,
  ...
  listAnswerRecords(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.dialogflow.v2beta1.IListAnswerRecordsRequest,
      protos.google.cloud.dialogflow.v2beta1.IListAnswerRecordsResponse|null|undefined,
      protos.google.cloud.dialogflow.v2beta1.IAnswerRecord>|undefined = callback
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.cloud.dialogflow.v2beta1.AnswerRecord|AnswerRecord} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   {@link protos.google.cloud.dialogflow.v2beta1.AnswerRecord|AnswerRecord}. The API will be called under the hood as needed, once per the page,
 ...
 */
  listAnswerRecordsAsync(
      request?: protos.google.cloud.dialogflow.v2beta1.IListAnswerRecordsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.dialogflow.v2beta1.IAnswerRecord>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listAnswerRecords.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.dialogflow.v2beta1.IAnswerRecord>;
  }
/**
