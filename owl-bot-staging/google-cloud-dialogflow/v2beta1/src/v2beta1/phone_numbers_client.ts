...
export class PhoneNumbersClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.dialogflow.v2beta1.PhoneNumbers', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.phoneNumbersStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.dialogflow.v2beta1.PhoneNumbers') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.dialogflow.v2beta1.PhoneNumbers,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const phoneNumbersStubMethods =
        ['listPhoneNumbers', 'updatePhoneNumber', 'deletePhoneNumber', 'undeletePhoneNumber'];
 ...
 */
  updatePhoneNumber(
      request?: protos.google.cloud.dialogflow.v2beta1.IUpdatePhoneNumberRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v2beta1.IPhoneNumber,
        protos.google.cloud.dialogflow.v2beta1.IUpdatePhoneNumberRequest|undefined, {}|undefined
      ]>;
  updatePhoneNumber(
      request: protos.google.cloud.dialogflow.v2beta1.IUpdatePhoneNumberRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2beta1.IPhoneNumber,
          protos.google.cloud.dialogflow.v2beta1.IUpdatePhoneNumberRequest|null|undefined,
          {}|null|undefined>): void;
  updatePhoneNumber(
      request: protos.google.cloud.dialogflow.v2beta1.IUpdatePhoneNumberRequest,
      callback: Callback<
 ...
 */
  deletePhoneNumber(
      request?: protos.google.cloud.dialogflow.v2beta1.IDeletePhoneNumberRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v2beta1.IPhoneNumber,
        protos.google.cloud.dialogflow.v2beta1.IDeletePhoneNumberRequest|undefined, {}|undefined
      ]>;
  deletePhoneNumber(
      request: protos.google.cloud.dialogflow.v2beta1.IDeletePhoneNumberRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2beta1.IPhoneNumber,
          protos.google.cloud.dialogflow.v2beta1.IDeletePhoneNumberRequest|null|undefined,
          {}|null|undefined>): void;
  deletePhoneNumber(
      request: protos.google.cloud.dialogflow.v2beta1.IDeletePhoneNumberRequest,
      callback: Callback<
 ...
 */
  undeletePhoneNumber(
      request?: protos.google.cloud.dialogflow.v2beta1.IUndeletePhoneNumberRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v2beta1.IPhoneNumber,
        protos.google.cloud.dialogflow.v2beta1.IUndeletePhoneNumberRequest|undefined, {}|undefined
      ]>;
  undeletePhoneNumber(
      request: protos.google.cloud.dialogflow.v2beta1.IUndeletePhoneNumberRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2beta1.IPhoneNumber,
          protos.google.cloud.dialogflow.v2beta1.IUndeletePhoneNumberRequest|null|undefined,
          {}|null|undefined>): void;
  undeletePhoneNumber(
      request: protos.google.cloud.dialogflow.v2beta1.IUndeletePhoneNumberRequest,
      callback: Callback<
 ...
 */
  listPhoneNumbers(
      request?: protos.google.cloud.dialogflow.v2beta1.IListPhoneNumbersRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v2beta1.IPhoneNumber[],
  ...
  listPhoneNumbers(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.dialogflow.v2beta1.IListPhoneNumbersResponse|null|undefined,
          protos.google.cloud.dialogflow.v2beta1.IPhoneNumber>): void;
  listPhoneNumbers(
      request: protos.google.cloud.dialogflow.v2beta1.IListPhoneNumbersRequest,
      callback: PaginationCallback<
          protos.google.cloud.dialogflow.v2beta1.IListPhoneNumbersRequest,
  ...
  listPhoneNumbers(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.dialogflow.v2beta1.IListPhoneNumbersRequest,
      protos.google.cloud.dialogflow.v2beta1.IListPhoneNumbersResponse|null|undefined,
      protos.google.cloud.dialogflow.v2beta1.IPhoneNumber>|undefined = callback
 ...
 */
  listPhoneNumbersAsync(
      request?: protos.google.cloud.dialogflow.v2beta1.IListPhoneNumbersRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.dialogflow.v2beta1.IPhoneNumber>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listPhoneNumbers.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.dialogflow.v2beta1.IPhoneNumber>;
  }
/**
