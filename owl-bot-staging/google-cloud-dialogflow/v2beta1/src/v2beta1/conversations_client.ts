...
export class ConversationsClient {
  ...
  initialize() {
    ...
    const conversationsStubMethods =
        ['createConversation', 'listConversations', 'getConversation', 'completeConversation', 'batchCreateMessages', 'listMessages', 'suggestConversationSummary', 'generateStatelessSummary', 'searchKnowledge'];
