...
export class EncryptionSpecServiceClient {
  ...
  constructor(
    ...
    const initializeEncryptionSpecResponse = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.v2beta1.InitializeEncryptionSpecResponse',
    ) as gax.protobuf.Type;
    const initializeEncryptionSpecMetadata = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.v2beta1.InitializeEncryptionSpecMetadata',
    ) as gax.protobuf.Type;
  ...
  async checkInitializeEncryptionSpecProgress(
    ...
    LROperation<
      protos.google.cloud.dialogflow.v2beta1.InitializeEncryptionSpecResponse,
