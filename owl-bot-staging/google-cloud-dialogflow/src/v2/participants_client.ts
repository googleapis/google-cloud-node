...
export class ParticipantsClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.dialogflow.v2.Participants', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.participantsStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.dialogflow.v2.Participants') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.dialogflow.v2.Participants,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const participantsStubMethods =
        ['createParticipant', 'getParticipant', 'listParticipants', 'updateParticipant', 'analyzeContent', 'streamingAnalyzeContent', 'suggestArticles', 'suggestFaqAnswers', 'suggestSmartReplies', 'suggestKnowledgeAssist'];
 ...
 */
  createParticipant(
      ...
      Promise<[
        ...
        protos.google.cloud.dialogflow.v2.ICreateParticipantRequest|undefined, {}|undefined
      ]>;
  createParticipant(
      request: protos.google.cloud.dialogflow.v2.ICreateParticipantRequest,
      options: CallOptions,
  ...
  createParticipant(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.createParticipant(request, options, wrappedCallback)
 ...
 */
  getParticipant(
      ...
      Promise<[
        protos.google.cloud.dialogflow.v2.IParticipant,
        protos.google.cloud.dialogflow.v2.IGetParticipantRequest|undefined, {}|undefined
      ]>;
  getParticipant(
      request: protos.google.cloud.dialogflow.v2.IGetParticipantRequest,
      options: CallOptions,
 ...
 */
  updateParticipant(
      ...
      Promise<[
        protos.google.cloud.dialogflow.v2.IParticipant,
        protos.google.cloud.dialogflow.v2.IUpdateParticipantRequest|undefined, {}|undefined
      ]>;
  updateParticipant(
      request: protos.google.cloud.dialogflow.v2.IUpdateParticipantRequest,
      options: CallOptions,
  ...
  updateParticipant(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.updateParticipant(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.dialogflow.v2.IParticipant,
 ...
 */
  analyzeContent(
      ...
      Promise<[
        ...
        protos.google.cloud.dialogflow.v2.IAnalyzeContentRequest|undefined, {}|undefined
      ]>;
  analyzeContent(
      request: protos.google.cloud.dialogflow.v2.IAnalyzeContentRequest,
      options: CallOptions,
  ...
  analyzeContent(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.analyzeContent(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.dialogflow.v2.IAnalyzeContentResponse,
 ...
 */
  suggestArticles(
      ...
      Promise<[
        ...
        protos.google.cloud.dialogflow.v2.ISuggestArticlesRequest|undefined, {}|undefined
      ]>;
  suggestArticles(
      request: protos.google.cloud.dialogflow.v2.ISuggestArticlesRequest,
      options: CallOptions,
  ...
  suggestArticles(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.suggestArticles(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.dialogflow.v2.ISuggestArticlesResponse,
 ...
 */
  suggestFaqAnswers(
      ...
      Promise<[
        ...
        protos.google.cloud.dialogflow.v2.ISuggestFaqAnswersRequest|undefined, {}|undefined
      ]>;
  suggestFaqAnswers(
      request: protos.google.cloud.dialogflow.v2.ISuggestFaqAnswersRequest,
      options: CallOptions,
  ...
  suggestFaqAnswers(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.suggestFaqAnswers(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.dialogflow.v2.ISuggestFaqAnswersResponse,
 ...
 */
  suggestSmartReplies(
      ...
      Promise<[
        ...
        protos.google.cloud.dialogflow.v2.ISuggestSmartRepliesRequest|undefined, {}|undefined
      ]>;
  suggestSmartReplies(
      request: protos.google.cloud.dialogflow.v2.ISuggestSmartRepliesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2.ISuggestSmartRepliesResponse,
          protos.google.cloud.dialogflow.v2.ISuggestSmartRepliesRequest|null|undefined,
          {}|null|undefined>): void;
  suggestSmartReplies(
      request: protos.google.cloud.dialogflow.v2.ISuggestSmartRepliesRequest,
      callback: Callback<
  ...
  suggestSmartReplies(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.suggestSmartReplies(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.dialogflow.v2.ISuggestSmartRepliesResponse,
 ...
 */
  suggestKnowledgeAssist(
      ...
      Promise<[
        ...
        protos.google.cloud.dialogflow.v2.ISuggestKnowledgeAssistRequest|undefined, {}|undefined
      ]>;
  suggestKnowledgeAssist(
      request: protos.google.cloud.dialogflow.v2.ISuggestKnowledgeAssistRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2.ISuggestKnowledgeAssistResponse,
          protos.google.cloud.dialogflow.v2.ISuggestKnowledgeAssistRequest|null|undefined,
          {}|null|undefined>): void;
  suggestKnowledgeAssist(
      request: protos.google.cloud.dialogflow.v2.ISuggestKnowledgeAssistRequest,
      callback: Callback<
  ...
  suggestKnowledgeAssist(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.suggestKnowledgeAssist(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.dialogflow.v2.ISuggestKnowledgeAssistResponse,
        protos.google.cloud.dialogflow.v2.ISuggestKnowledgeAssistRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('suggestKnowledgeAssist response %j', response);
        return [response, options, rawResponse];
 ...
 */
  ...
  listParticipants(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.dialogflow.v2.IParticipant>): void;
  listParticipants(
      request: protos.google.cloud.dialogflow.v2.IListParticipantsRequest,
      callback: PaginationCallback<
          protos.google.cloud.dialogflow.v2.IListParticipantsRequest,
  ...
  listParticipants(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.dialogflow.v2.IListParticipantsRequest,
      protos.google.cloud.dialogflow.v2.IListParticipantsResponse|null|undefined,
      protos.google.cloud.dialogflow.v2.IParticipant>|undefined = callback
 ...
 */
  listParticipantsAsync(
    ...
    return this.descriptors.page.listParticipants.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.dialogflow.v2.IParticipant>;
  }
/**
