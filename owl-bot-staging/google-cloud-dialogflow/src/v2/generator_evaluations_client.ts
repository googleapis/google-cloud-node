 ...
 * `src/v2/generator_evaluations_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './generator_evaluations_client_config.json';
 ...
 * @memberof v2
 */
export class GeneratorEvaluationsClient {
  ...
  generatorEvaluationsStub?: Promise<{ [name: string]: Function }>;
  ...
  constructor(
    ...
    const staticMembers = this.constructor as typeof GeneratorEvaluationsClient;
    if (
    ...
    this.descriptors.page = {
      listGeneratorEvaluations: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
    ...
    const createGeneratorEvaluationResponse = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.v2.GeneratorEvaluation',
    ) as gax.protobuf.Type;
    const createGeneratorEvaluationMetadata = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.v2.GeneratorEvaluationOperationMetadata',
    ) as gax.protobuf.Type;

    this.descriptors.longrunning = {
      createGeneratorEvaluation: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        createGeneratorEvaluationResponse.decode.bind(
          createGeneratorEvaluationResponse,
        ),
        createGeneratorEvaluationMetadata.decode.bind(
          createGeneratorEvaluationMetadata,
        ),
      ),
    };
  ...
  initialize() {
    ...
    // google.cloud.dialogflow.v2.GeneratorEvaluations.
    this.generatorEvaluationsStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ? (this._protos as protobuf.Root).lookupService(
            'google.cloud.dialogflow.v2.GeneratorEvaluations',
          )
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.dialogflow.v2.GeneratorEvaluations,
      this._opts,
      this._providedCustomServicePath,
    ...
    const generatorEvaluationsStubMethods = [
    ...
    for (const methodName of generatorEvaluationsStubMethods) {
      const callPromise = this.generatorEvaluationsStub.then(
        (stub) =>
          (...args: Array<{}>) => {
            if (this._terminated) {
   ...
   *   The first element of the array is an object representing {@link protos.google.cloud.dialogflow.v2.GeneratorEvaluation|GeneratorEvaluation}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v2/generator_evaluations.get_generator_evaluation.js</caption>
   * region_tag:dialogflow_v2_generated_GeneratorEvaluations_GetGeneratorEvaluation_async
   */
  getGeneratorEvaluation(
    request?: protos.google.cloud.dialogflow.v2.IGetGeneratorEvaluationRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.dialogflow.v2.IGeneratorEvaluation,
      (
        | protos.google.cloud.dialogflow.v2.IGetGeneratorEvaluationRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    return this.innerApiCalls
      .getGeneratorEvaluation(request, options, wrappedCallback)
      ?.then(
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v2/generator_evaluations.delete_generator_evaluation.js</caption>
   * region_tag:dialogflow_v2_generated_GeneratorEvaluations_DeleteGeneratorEvaluation_async
   */
  deleteGeneratorEvaluation(
    request?: protos.google.cloud.dialogflow.v2.IDeleteGeneratorEvaluationRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.protobuf.IEmpty,
      (
        | protos.google.cloud.dialogflow.v2.IDeleteGeneratorEvaluationRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .deleteGeneratorEvaluation(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.protobuf.IEmpty,
          (
   ...
   *   `projects/<Project ID>/locations/<Location ID>/generators/<Generator ID>`
   * @param {google.cloud.dialogflow.v2.GeneratorEvaluation} request.generatorEvaluation
   ...
   *   for more details and examples.
   * @example <caption>include:samples/generated/v2/generator_evaluations.create_generator_evaluation.js</caption>
   * region_tag:dialogflow_v2_generated_GeneratorEvaluations_CreateGeneratorEvaluation_async
   */
  createGeneratorEvaluation(
    request?: protos.google.cloud.dialogflow.v2.ICreateGeneratorEvaluationRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<
        protos.google.cloud.dialogflow.v2.IGeneratorEvaluation,
        protos.google.cloud.dialogflow.v2.IGeneratorEvaluationOperationMetadata
      >,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .createGeneratorEvaluation(request, options, wrappedCallback)
      ?.then(
   ...
   * region_tag:dialogflow_v2_generated_GeneratorEvaluations_CreateGeneratorEvaluation_async
   */
  async checkCreateGeneratorEvaluationProgress(
    name: string,
  ): Promise<
    LROperation<
      protos.google.cloud.dialogflow.v2.GeneratorEvaluation,
      protos.google.cloud.dialogflow.v2.GeneratorEvaluationOperationMetadata
    >
  > {
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.createGeneratorEvaluation,
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.cloud.dialogflow.v2.GeneratorEvaluation|GeneratorEvaluation}.
   ...
   */
  listGeneratorEvaluations(
    request?: protos.google.cloud.dialogflow.v2.IListGeneratorEvaluationsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.dialogflow.v2.IGeneratorEvaluation[],
      protos.google.cloud.dialogflow.v2.IListGeneratorEvaluationsRequest | null,
      protos.google.cloud.dialogflow.v2.IListGeneratorEvaluationsResponse,
    ]
  >;
  listGeneratorEvaluations(
    request: protos.google.cloud.dialogflow.v2.IListGeneratorEvaluationsRequest,
    ...
    callback: PaginationCallback<
      protos.google.cloud.dialogflow.v2.IListGeneratorEvaluationsRequest,
      | protos.google.cloud.dialogflow.v2.IListGeneratorEvaluationsResponse
      | null
      | undefined,
      protos.google.cloud.dialogflow.v2.IGeneratorEvaluation
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.cloud.dialogflow.v2.GeneratorEvaluation|GeneratorEvaluation} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
   ...
   *   for more details and examples.
   */
  listGeneratorEvaluationsStream(
    request?: protos.google.cloud.dialogflow.v2.IListGeneratorEvaluationsRequest,
    options?: CallOptions,
  ): Transform {
    request = request || {};
    ...
    return this.descriptors.page.listGeneratorEvaluations.createStream(
      this.innerApiCalls.listGeneratorEvaluations as GaxCall,
      request,
      callSettings,
    );
  }
   ...
   *   {@link protos.google.cloud.dialogflow.v2.GeneratorEvaluation|GeneratorEvaluation}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v2/generator_evaluations.list_generator_evaluations.js</caption>
   * region_tag:dialogflow_v2_generated_GeneratorEvaluations_ListGeneratorEvaluations_async
   */
  listGeneratorEvaluationsAsync(
    request?: protos.google.cloud.dialogflow.v2.IListGeneratorEvaluationsRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.cloud.dialogflow.v2.IGeneratorEvaluation> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listGeneratorEvaluations.asyncIterate(
      this.innerApiCalls['listGeneratorEvaluations'] as GaxCall,
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.cloud.dialogflow.v2.IGeneratorEvaluation>;
  }
