 ...
 * `src/v2/sip_trunks_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './sip_trunks_client_config.json';
const version = require('../../../package.json').version;

/**
 *  Service for managing {@link protos.google.cloud.dialogflow.v2.SipTrunk|SipTrunks}.
 * @class
 * @memberof v2
 */
export class SipTrunksClient {
  ...
  initialize() {
    ...
    if (this.sipTrunksStub) {
      return this.sipTrunksStub;
    }
