...
export class ToolsClient {
    ...
    this.toolsStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ...
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.dialogflow.v2.Tools,
      this._opts,
      this._providedCustomServicePath,
   ...
   */
  createTool(
    request?: protos.google.cloud.dialogflow.v2.ICreateToolRequest,
    options?: CallOptions,
  ): Promise<
    [
  ...
  createTool(
    ...
    callback: Callback<
      protos.google.cloud.dialogflow.v2.ITool,
      protos.google.cloud.dialogflow.v2.ICreateToolRequest | null | undefined,
      {} | null | undefined
    >,
  ): void;
  createTool(
  ...
  createTool(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.cloud.dialogflow.v2.ITool,
          | protos.google.cloud.dialogflow.v2.ICreateToolRequest
          | null
          | undefined,
          {} | null | undefined
        >,
   ...
   */
  getTool(
    request?: protos.google.cloud.dialogflow.v2.IGetToolRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.dialogflow.v2.ITool,
  ...
  getTool(
    ...
    callback: Callback<
      protos.google.cloud.dialogflow.v2.ITool,
      protos.google.cloud.dialogflow.v2.IGetToolRequest | null | undefined,
      {} | null | undefined
    >,
  ): void;
  getTool(
   ...
   */
  deleteTool(
    request?: protos.google.cloud.dialogflow.v2.IDeleteToolRequest,
    options?: CallOptions,
  ): Promise<
    [
  ...
  deleteTool(
    ...
    callback: Callback<
      protos.google.protobuf.IEmpty,
      protos.google.cloud.dialogflow.v2.IDeleteToolRequest | null | undefined,
      {} | null | undefined
    >,
  ): void;
  deleteTool(
  ...
  deleteTool(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.protobuf.IEmpty,
          | protos.google.cloud.dialogflow.v2.IDeleteToolRequest
          | null
          | undefined,
          {} | null | undefined
        >,
   ...
   */
  updateTool(
    request?: protos.google.cloud.dialogflow.v2.IUpdateToolRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.dialogflow.v2.ITool,
  ...
  updateTool(
    ...
    callback: Callback<
      protos.google.cloud.dialogflow.v2.ITool,
      protos.google.cloud.dialogflow.v2.IUpdateToolRequest | null | undefined,
      {} | null | undefined
    >,
  ): void;
  updateTool(
  ...
  updateTool(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.cloud.dialogflow.v2.ITool,
          | protos.google.cloud.dialogflow.v2.IUpdateToolRequest
          | null
          | undefined,
          {} | null | undefined
        >,
   ...
   */
  listTools(
    request?: protos.google.cloud.dialogflow.v2.IListToolsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.dialogflow.v2.ITool[],
  ...
  listTools(
    ...
    callback: PaginationCallback<
      protos.google.cloud.dialogflow.v2.IListToolsRequest,
      protos.google.cloud.dialogflow.v2.IListToolsResponse | null | undefined,
      protos.google.cloud.dialogflow.v2.ITool
    >,
  ): void;
  listTools(
  ...
  listToolsAsync(
    request?: protos.google.cloud.dialogflow.v2.IListToolsRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.cloud.dialogflow.v2.ITool> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listTools.asyncIterate(
      ...
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.cloud.dialogflow.v2.ITool>;
  }
