...
describe('v2beta1.ToolsClient', () => {
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new toolsModule.v2beta1.ToolsClient({
          universe_domain: 'example.com',
    ...
    it('invokes createTool without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createTool(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2beta1.ITool | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('deleteTool', () => {
    it('invokes deleteTool without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.dialogflow.v2beta1.DeleteToolRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('listTools', () => {
    ...
    it('invokes listToolsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.v2beta1.Tool) => {
