...
describe('v2.GeneratorEvaluationsClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new generatorevaluationsModule.v2.GeneratorEvaluationsClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          generatorevaluationsModule.v2.GeneratorEvaluationsClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          generatorevaluationsModule.v2.GeneratorEvaluationsClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        generatorevaluationsModule.v2.GeneratorEvaluationsClient.port;
      assert(port);
    ...
    it('invokes getGeneratorEvaluation without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getGeneratorEvaluation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2.IGeneratorEvaluation | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listGeneratorEvaluations', () => {
    ...
    it('invokes listGeneratorEvaluationsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.v2.GeneratorEvaluation) => {
