...
describe('v2.GeneratorEvaluationsClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new generatorevaluationsModule.v2.GeneratorEvaluationsClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = generatorevaluationsModule.v2.GeneratorEvaluationsClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = generatorevaluationsModule.v2.GeneratorEvaluationsClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new generatorevaluationsModule.v2.GeneratorEvaluationsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new generatorevaluationsModule.v2.GeneratorEvaluationsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new generatorevaluationsModule.v2.GeneratorEvaluationsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new generatorevaluationsModule.v2.GeneratorEvaluationsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = generatorevaluationsModule.v2.GeneratorEvaluationsClient.port;
            assert(port);
    ...
    describe('getGeneratorEvaluation', () => {
        it('invokes getGeneratorEvaluation without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.GetGeneratorEvaluationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.GetGeneratorEvaluationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.GeneratorEvaluation()
            );
        ...
        it('invokes getGeneratorEvaluation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getGeneratorEvaluation(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.IGeneratorEvaluation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deleteGeneratorEvaluation', () => {
        it('invokes deleteGeneratorEvaluation without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.DeleteGeneratorEvaluationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.DeleteGeneratorEvaluationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createGeneratorEvaluation', () => {
        it('invokes createGeneratorEvaluation without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.CreateGeneratorEvaluationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.CreateGeneratorEvaluationRequest', ['parent']);
        ...
        it('invokes createGeneratorEvaluation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createGeneratorEvaluation(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dialogflow.v2.IGeneratorEvaluation, protos.google.cloud.dialogflow.v2.IGeneratorEvaluationOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dialogflow.v2.IGeneratorEvaluation, protos.google.cloud.dialogflow.v2.IGeneratorEvaluationOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createGeneratorEvaluation as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listGeneratorEvaluations', () => {
        it('invokes listGeneratorEvaluations without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.ListGeneratorEvaluationsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.ListGeneratorEvaluationsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.GeneratorEvaluation()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.GeneratorEvaluation()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.GeneratorEvaluation()),
            ];
        ...
        it('invokes listGeneratorEvaluationsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2.GeneratorEvaluation[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2.GeneratorEvaluation) => {
        ...
        it('uses async iteration with listGeneratorEvaluations without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.v2.IGeneratorEvaluation[] = [];
