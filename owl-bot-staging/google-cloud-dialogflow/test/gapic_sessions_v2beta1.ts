...
describe('v2beta1.SessionsClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new sessionsModule.v2beta1.SessionsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new sessionsModule.v2beta1.SessionsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new sessionsModule.v2beta1.SessionsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new sessionsModule.v2beta1.SessionsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('detectIntent', () => {
        it('invokes detectIntent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.DetectIntentRequest', ['session']);
    ...
    describe('Path templates', () => {
        ...
        describe('projectAgentEnvironmentUserSession', async () => {
        ...
        describe('projectLocationAgentEnvironmentUserSession', async () => {
            const fakePath = "/rendered/path/projectLocationAgentEnvironmentUserSession";
            const expectedParameters = {
                project: "projectValue",
                location: "locationValue",
                environment: "environmentValue",
            ...
            it('projectLocationAgentEnvironmentUserSessionPath', () => {
                const result = client.projectLocationAgentEnvironmentUserSessionPath("projectValue", "locationValue", "environmentValue", "userValue", "sessionValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectLocationAgentEnvironmentUserSessionPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectLocationAgentEnvironmentUserSessionName', () => {
                const result = client.matchProjectFromProjectLocationAgentEnvironmentUserSessionName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectLocationAgentEnvironmentUserSessionPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromProjectLocationAgentEnvironmentUserSessionName', () => {
                const result = client.matchLocationFromProjectLocationAgentEnvironmentUserSessionName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.projectLocationAgentEnvironmentUserSessionPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchEnvironmentFromProjectLocationAgentEnvironmentUserSessionName', () => {
                const result = client.matchEnvironmentFromProjectLocationAgentEnvironmentUserSessionName(fakePath);
                assert.strictEqual(result, "environmentValue");
                assert((client.pathTemplates.projectLocationAgentEnvironmentUserSessionPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchUserFromProjectLocationAgentEnvironmentUserSessionName', () => {
                const result = client.matchUserFromProjectLocationAgentEnvironmentUserSessionName(fakePath);
                assert.strictEqual(result, "userValue");
                assert((client.pathTemplates.projectLocationAgentEnvironmentUserSessionPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchSessionFromProjectLocationAgentEnvironmentUserSessionName', () => {
                const result = client.matchSessionFromProjectLocationAgentEnvironmentUserSessionName(fakePath);
                assert.strictEqual(result, "sessionValue");
                assert((client.pathTemplates.projectLocationAgentEnvironmentUserSessionPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
