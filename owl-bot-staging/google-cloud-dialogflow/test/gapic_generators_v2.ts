...
describe('v2.GeneratorsClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new generatorsModule.v2.GeneratorsClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = generatorsModule.v2.GeneratorsClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = generatorsModule.v2.GeneratorsClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new generatorsModule.v2.GeneratorsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new generatorsModule.v2.GeneratorsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new generatorsModule.v2.GeneratorsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new generatorsModule.v2.GeneratorsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = generatorsModule.v2.GeneratorsClient.port;
            assert(port);
    ...
    describe('createGenerator', () => {
        it('invokes createGenerator without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.CreateGeneratorRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.CreateGeneratorRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.Generator()
            );
        ...
        it('invokes createGenerator without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createGenerator(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.IGenerator|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getGenerator', () => {
        it('invokes getGenerator without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.GetGeneratorRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.GetGeneratorRequest', ['name']);
    ...
    describe('deleteGenerator', () => {
        it('invokes deleteGenerator without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.DeleteGeneratorRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.DeleteGeneratorRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateGenerator', () => {
        it('invokes updateGenerator without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.UpdateGeneratorRequest()
            );
            request.generator ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.UpdateGeneratorRequest', ['generator', 'name']);
    ...
    describe('listGenerators', () => {
        it('invokes listGenerators without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.ListGeneratorsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.ListGeneratorsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.Generator()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.Generator()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.Generator()),
            ];
        ...
        it('invokes listGeneratorsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2.Generator[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2.Generator) => {
        ...
        it('uses async iteration with listGenerators without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.v2.IGenerator[] = [];
