...
describe('v2beta1.SipTrunksClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = siptrunksModule.v2beta1.SipTrunksClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = siptrunksModule.v2beta1.SipTrunksClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new siptrunksModule.v2beta1.SipTrunksClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new siptrunksModule.v2beta1.SipTrunksClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new siptrunksModule.v2beta1.SipTrunksClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new siptrunksModule.v2beta1.SipTrunksClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = siptrunksModule.v2beta1.SipTrunksClient.port;
            assert(port);
    ...
    describe('createSipTrunk', () => {
        it('invokes createSipTrunk without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.CreateSipTrunkRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.SipTrunk()
            );
        ...
        it('invokes createSipTrunk without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createSipTrunk(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2beta1.ISipTrunk|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deleteSipTrunk', () => {
        it('invokes deleteSipTrunk without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.DeleteSipTrunkRequest', ['name']);
    ...
    describe('getSipTrunk', () => {
        it('invokes getSipTrunk without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.GetSipTrunkRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.SipTrunk()
    ...
    describe('updateSipTrunk', () => {
        it('invokes updateSipTrunk without error', async () => {
            ...
            request.sipTrunk ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.UpdateSipTrunkRequest', ['sipTrunk', 'name']);
    ...
    describe('listSipTrunks', () => {
        it('invokes listSipTrunks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.ListSipTrunksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.SipTrunk()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.SipTrunk()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.SipTrunk()),
            ];
        ...
        it('invokes listSipTrunksStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2beta1.SipTrunk[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2beta1.SipTrunk) => {
        ...
        it('uses async iteration with listSipTrunks without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.v2beta1.ISipTrunk[] = [];
