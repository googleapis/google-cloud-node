...
describe('v2beta1.ConversationProfilesClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          conversationprofilesModule.v2beta1.ConversationProfilesClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        conversationprofilesModule.v2beta1.ConversationProfilesClient.port;
      assert(port);
  ...
  describe('getConversationProfile', () => {
    it('invokes getConversationProfile without error', async () => {
      ...
      client.innerApiCalls.getConversationProfile =
    ...
    it('invokes getConversationProfile without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getConversationProfile(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2beta1.IConversationProfile | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createConversationProfile', () => {
    it('invokes createConversationProfile without error', async () => {
      ...
      client.innerApiCalls.createConversationProfile =
        stubSimpleCall(expectedResponse);
  ...
  describe('updateConversationProfile', () => {
    it('invokes updateConversationProfile without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.dialogflow.v2beta1.UpdateConversationProfileRequest(),
      );
      ...
      client.innerApiCalls.updateConversationProfile =
        stubSimpleCall(expectedResponse);
  ...
  describe('deleteConversationProfile', () => {
    it('invokes deleteConversationProfile without error', async () => {
      ...
      client.innerApiCalls.deleteConversationProfile =
        stubSimpleCall(expectedResponse);
  ...
  describe('setSuggestionFeatureConfig', () => {
    it('invokes setSuggestionFeatureConfig without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.dialogflow.v2beta1.SetSuggestionFeatureConfigRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('clearSuggestionFeatureConfig', () => {
    it('invokes clearSuggestionFeatureConfig without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.dialogflow.v2beta1.ClearSuggestionFeatureConfigRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('listConversationProfiles', () => {
    it('invokes listConversationProfiles without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.dialogflow.v2beta1.ListConversationProfilesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
    ...
    it('invokes listConversationProfilesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.dialogflow.v2beta1.ConversationProfile[] =
          [];
        stream.on(
          'data',
          (
            response: protos.google.cloud.dialogflow.v2beta1.ConversationProfile,
          ) => {
    ...
    it('uses async iteration with listConversationProfiles without error', async () => {
      ...
      const responses: protos.google.cloud.dialogflow.v2beta1.IConversationProfile[] =
        [];
  ...
  describe('Path templates', () => {
    describe('cXSecuritySettings', async () => {
