...
function main(name) {
  // [START dialogflow_v2beta1_generated_Tools_GetTool_async]
  /**
  ...
  async function callGetTool() {
    ...
    // Run request
    const response = await dialogflowClient.getTool(request);
    console.log(response);
  }

  callGetTool();
  // [END dialogflow_v2beta1_generated_Tools_GetTool_async]
}
