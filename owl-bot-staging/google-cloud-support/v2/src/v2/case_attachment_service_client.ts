...
export class CaseAttachmentServiceClient {
   ...
   *     const client = new CaseAttachmentServiceClient({fallback: 'rest'}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.support.v2.CaseAttachmentService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.caseAttachmentServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.support.v2.CaseAttachmentService') :
 ...
 *   The first element of the array is Array of {@link google.cloud.support.v2.Attachment | Attachment}.
 ...
 */
  ...
  listAttachments(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.support.v2.IListAttachmentsResponse|null|undefined,
          protos.google.cloud.support.v2.IAttachment>): void;
  listAttachments(
      request: protos.google.cloud.support.v2.IListAttachmentsRequest,
      callback: PaginationCallback<
          protos.google.cloud.support.v2.IListAttachmentsRequest,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link google.cloud.support.v2.Attachment | Attachment} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   {@link google.cloud.support.v2.Attachment | Attachment}. The API will be called under the hood as needed, once per the page,
