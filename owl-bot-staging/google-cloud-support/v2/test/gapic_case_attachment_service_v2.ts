...
describe('v2.CaseAttachmentServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new caseattachmentserviceModule.v2.CaseAttachmentServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = caseattachmentserviceModule.v2.CaseAttachmentServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = caseattachmentserviceModule.v2.CaseAttachmentServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'cloudsupport.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new caseattachmentserviceModule.v2.CaseAttachmentServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'cloudsupport.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new caseattachmentserviceModule.v2.CaseAttachmentServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'cloudsupport.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new caseattachmentserviceModule.v2.CaseAttachmentServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new caseattachmentserviceModule.v2.CaseAttachmentServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = caseattachmentserviceModule.v2.CaseAttachmentServiceClient.port;
            assert(port);
    ...
    describe('listAttachments', () => {
        it('invokes listAttachments without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.support.v2.ListAttachmentsRequest', ['parent']);
        ...
        it('invokes listAttachments without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listAttachments(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.support.v2.IAttachment[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listAttachmentsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.support.v2.Attachment) => {
