...
describe('v2beta.CaseAttachmentServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = caseattachmentserviceModule.v2beta.CaseAttachmentServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = caseattachmentserviceModule.v2beta.CaseAttachmentServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'cloudsupport.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new caseattachmentserviceModule.v2beta.CaseAttachmentServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'cloudsupport.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new caseattachmentserviceModule.v2beta.CaseAttachmentServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'cloudsupport.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new caseattachmentserviceModule.v2beta.CaseAttachmentServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new caseattachmentserviceModule.v2beta.CaseAttachmentServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = caseattachmentserviceModule.v2beta.CaseAttachmentServiceClient.port;
            assert(port);
    ...
    describe('listAttachments', () => {
        it('invokes listAttachments without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.support.v2beta.ListAttachmentsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.support.v2beta.Attachment()),
              generateSampleMessage(new protos.google.cloud.support.v2beta.Attachment()),
              generateSampleMessage(new protos.google.cloud.support.v2beta.Attachment()),
            ];
            ...
            const actualRequest = (client.innerApiCalls.listAttachments as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAttachments as SinonStub)
        ...
        it('invokes listAttachments without error using callback', async () => {
            ...
            client.innerApiCalls.listAttachments = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listAttachments with error', async () => {
            ...
            client.innerApiCalls.listAttachments = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listAttachmentsStream without error', async () => {
            ...
            client.descriptors.page.listAttachments.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listAttachmentsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.support.v2beta.Attachment[] = [];
                stream.on('data', (response: protos.google.cloud.support.v2beta.Attachment) => {
            ...
            assert((client.descriptors.page.listAttachments.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listAttachments, request));
            assert(
        ...
        it('invokes listAttachmentsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAttachments.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listAttachmentsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.support.v2beta.Attachment[] = [];
                stream.on('data', (response: protos.google.cloud.support.v2beta.Attachment) => {
        ...
        it('uses async iteration with listAttachments without error', async () => {
            ...
            client.descriptors.page.listAttachments.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listAttachments with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAttachments.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listAttachmentsAsync(request);
    ...
    describe('Path templates', () => {
        ...
        describe('organizationCaseEmailMessage', async () => {
            ...
            it('organizationCaseEmailMessagePath', () => {
                const result = client.organizationCaseEmailMessagePath("organizationValue", "caseValue", "emailMessageValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationCaseEmailMessagePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationCaseEmailMessageName', () => {
                const result = client.matchOrganizationFromOrganizationCaseEmailMessageName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationCaseEmailMessagePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchCaseFromOrganizationCaseEmailMessageName', () => {
                const result = client.matchCaseFromOrganizationCaseEmailMessageName(fakePath);
                assert.strictEqual(result, "caseValue");
                assert((client.pathTemplates.organizationCaseEmailMessagePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchEmailMessageFromOrganizationCaseEmailMessageName', () => {
                const result = client.matchEmailMessageFromOrganizationCaseEmailMessageName(fakePath);
        ...
        describe('projectCaseEmailMessage', async () => {
            ...
            await client.initialize();
            client.pathTemplates.projectCaseEmailMessagePathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.projectCaseEmailMessagePathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('projectCaseEmailMessagePath', () => {
                const result = client.projectCaseEmailMessagePath("projectValue", "caseValue", "emailMessageValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectCaseEmailMessagePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectCaseEmailMessageName', () => {
                const result = client.matchProjectFromProjectCaseEmailMessageName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectCaseEmailMessagePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchCaseFromProjectCaseEmailMessageName', () => {
                const result = client.matchCaseFromProjectCaseEmailMessageName(fakePath);
                assert.strictEqual(result, "caseValue");
                assert((client.pathTemplates.projectCaseEmailMessagePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchEmailMessageFromProjectCaseEmailMessageName', () => {
                const result = client.matchEmailMessageFromProjectCaseEmailMessageName(fakePath);
                assert.strictEqual(result, "emailMessageValue");
                assert((client.pathTemplates.projectCaseEmailMessagePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
