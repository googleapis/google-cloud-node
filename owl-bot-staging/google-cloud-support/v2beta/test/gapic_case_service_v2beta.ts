...
describe('v2beta.CaseServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = caseserviceModule.v2beta.CaseServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = caseserviceModule.v2beta.CaseServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'cloudsupport.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new caseserviceModule.v2beta.CaseServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'cloudsupport.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new caseserviceModule.v2beta.CaseServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'cloudsupport.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new caseserviceModule.v2beta.CaseServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new caseserviceModule.v2beta.CaseServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getCase', () => {
        it('invokes getCase without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.support.v2beta.GetCaseRequest', ['name']);
        ...
        it('invokes getCase without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCase(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.support.v2beta.ICase|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createCase', () => {
        it('invokes createCase without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.support.v2beta.CreateCaseRequest', ['parent']);
    ...
    describe('updateCase', () => {
        it('invokes updateCase without error', async () => {
            ...
            request.case ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.support.v2beta.UpdateCaseRequest', ['case', 'name']);
    ...
    describe('escalateCase', () => {
        it('invokes escalateCase without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.support.v2beta.EscalateCaseRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.support.v2beta.Case()
    ...
    describe('closeCase', () => {
        it('invokes closeCase without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.support.v2beta.CloseCaseRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.support.v2beta.Case()
    ...
    describe('listCases', () => {
        it('invokes listCases without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.support.v2beta.ListCasesRequest', ['parent']);
            request.parent = defaultValue1;
        ...
        it('invokes listCasesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.support.v2beta.Case) => {
    ...
    describe('searchCases', () => {
        it('invokes searchCases without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.support.v2beta.SearchCasesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.support.v2beta.Case()),
              generateSampleMessage(new protos.google.cloud.support.v2beta.Case()),
    ...
    describe('searchCaseClassifications', () => {
        it('invokes searchCaseClassifications without error', async () => {
            ...
            const request = generateSampleMessage(
              ...
              generateSampleMessage(new protos.google.cloud.support.v2beta.CaseClassification()),
              generateSampleMessage(new protos.google.cloud.support.v2beta.CaseClassification()),
              generateSampleMessage(new protos.google.cloud.support.v2beta.CaseClassification()),
            ];
        ...
        it('invokes searchCaseClassifications without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.searchCaseClassifications(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.support.v2beta.ICaseClassification[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes searchCaseClassificationsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.support.v2beta.CaseClassification) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
