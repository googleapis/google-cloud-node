...
export class CommentServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this.pathTemplates = {
      ...
      organizationCaseEmailMessagePathTemplate: new this._gaxModule.PathTemplate(
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.support.v2beta.CommentService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.commentServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.support.v2beta.CommentService') :
 ...
 */
  createComment(
      ...
      Promise<[
        ...
        protos.google.cloud.support.v2beta.ICreateCommentRequest|undefined, {}|undefined
      ]>;
  createComment(
      request: protos.google.cloud.support.v2beta.ICreateCommentRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.support.v2beta.IComment,
          protos.google.cloud.support.v2beta.ICreateCommentRequest|null|undefined,
          {}|null|undefined>): void;
  createComment(
      request: protos.google.cloud.support.v2beta.ICreateCommentRequest,
      callback: Callback<
 ...
 */
  ...
  listComments(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.support.v2beta.IListCommentsResponse|null|undefined,
          protos.google.cloud.support.v2beta.IComment>): void;
  listComments(
      request: protos.google.cloud.support.v2beta.IListCommentsRequest,
      callback: PaginationCallback<
          protos.google.cloud.support.v2beta.IListCommentsRequest,
  ...
  listComments(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.support.v2beta.IListCommentsRequest,
      protos.google.cloud.support.v2beta.IListCommentsResponse|null|undefined,
      protos.google.cloud.support.v2beta.IComment>|undefined = callback
 ...
 */
   ...
   * @returns {string} Resource name string.
   */
  organizationCaseEmailMessagePath(organization:string,caseParam:string,emailMessage:string) {
   ...
   * @returns {string} A string representing the organization.
   */
  matchOrganizationFromOrganizationCaseEmailMessageName(organizationCaseEmailMessageName: string) {
    return this.pathTemplates.organizationCaseEmailMessagePathTemplate.match(organizationCaseEmailMessageName).organization;
  }
   ...
   * @returns {string} A string representing the case.
   */
  matchCaseFromOrganizationCaseEmailMessageName(organizationCaseEmailMessageName: string) {
    return this.pathTemplates.organizationCaseEmailMessagePathTemplate.match(organizationCaseEmailMessageName).case;
  }
   ...
   */
  matchEmailMessageFromOrganizationCaseEmailMessageName(organizationCaseEmailMessageName: string) {
    return this.pathTemplates.organizationCaseEmailMessagePathTemplate.match(organizationCaseEmailMessageName).email_message;
  }
   ...
   * @returns {string} Resource name string.
   */
  projectCaseEmailMessagePath(project:string,caseParam:string,emailMessage:string) {
   ...
   * @returns {string} A string representing the project.
   */
  matchProjectFromProjectCaseEmailMessageName(projectCaseEmailMessageName: string) {
    return this.pathTemplates.projectCaseEmailMessagePathTemplate.match(projectCaseEmailMessageName).project;
  }
   ...
   * @returns {string} A string representing the case.
   */
  matchCaseFromProjectCaseEmailMessageName(projectCaseEmailMessageName: string) {
    return this.pathTemplates.projectCaseEmailMessagePathTemplate.match(projectCaseEmailMessageName).case;
  }
   ...
   * @returns {string} A string representing the email_message.
   */
  matchEmailMessageFromProjectCaseEmailMessageName(projectCaseEmailMessageName: string) {
    return this.pathTemplates.projectCaseEmailMessagePathTemplate.match(projectCaseEmailMessageName).email_message;
  }
