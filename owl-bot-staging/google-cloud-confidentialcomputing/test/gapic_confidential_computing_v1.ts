...
describe('v1.ConfidentialComputingClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = confidentialcomputingModule.v1.ConfidentialComputingClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = confidentialcomputingModule.v1.ConfidentialComputingClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'confidentialcomputing.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new confidentialcomputingModule.v1.ConfidentialComputingClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'confidentialcomputing.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new confidentialcomputingModule.v1.ConfidentialComputingClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'confidentialcomputing.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new confidentialcomputingModule.v1.ConfidentialComputingClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new confidentialcomputingModule.v1.ConfidentialComputingClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = confidentialcomputingModule.v1.ConfidentialComputingClient.port;
            assert(port);
    ...
    describe('createChallenge', () => {
        it('invokes createChallenge without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.confidentialcomputing.v1.CreateChallengeRequest', ['parent']);
        ...
        it('invokes createChallenge without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createChallenge(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.confidentialcomputing.v1.IChallenge|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('verifyAttestation', () => {
        it('invokes verifyAttestation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.confidentialcomputing.v1.VerifyAttestationRequest', ['challenge']);
        ...
        it('invokes verifyAttestation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.verifyAttestation(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.confidentialcomputing.v1.IVerifyAttestationResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
