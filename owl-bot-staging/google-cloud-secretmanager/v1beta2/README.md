...
# [Secretmanager: Nodejs Client][homepage]

[//]: # "releaseLevel"

[![npm version](https://img.shields.io/npm/v/@google-cloud/secretmanager.svg)](https://www.npmjs.org/package/@google-cloud/secretmanager)

Secretmanager client for Node.js
...
* [Secretmanager Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/secretmanager/latest)
* [Secretmanager Documentation](https://cloud.google.com/secret-manager/docs/overview)
...
1.  [Enable the Secretmanager API][enable_api].
1.  [Set up authentication][auth] so you can access the
    API from your local workstation.
### Installing the client library

```bash
npm install @google-cloud/secretmanager
```
...
For example, `npm install @google-cloud/secretmanager@legacy-8` installs client libraries
