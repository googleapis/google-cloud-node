...
function main(name) {
  // [START merchantapi_v1_generated_RegionalInventoryService_DeleteRegionalInventory_async]
  /**
  ...
  const {RegionalInventoryServiceClient} = require('@google-cloud/inventories').v1;
  ...
  // [END merchantapi_v1_generated_RegionalInventoryService_DeleteRegionalInventory_async]
}
