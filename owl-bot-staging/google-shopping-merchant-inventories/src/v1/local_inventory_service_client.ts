 ...
 * `src/v1/local_inventory_service_client_config.json`.
...
export class LocalInventoryServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.shopping.merchant.inventories.v1.LocalInventoryService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.localInventoryServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.shopping.merchant.inventories.v1.LocalInventoryService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.shopping.merchant.inventories.v1.LocalInventoryService,
 ...
 * {@link protos.google.shopping.merchant.inventories.v1.LocalInventory.store_code|`storeCode`}
 ...
 * @param {google.shopping.merchant.inventories.v1.LocalInventory} request.localInventory
 ...
 *   The first element of the array is an object representing {@link protos.google.shopping.merchant.inventories.v1.LocalInventory|LocalInventory}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/local_inventory_service.insert_local_inventory.js</caption>
 * region_tag:merchantapi_v1_generated_LocalInventoryService_InsertLocalInventory_async
 */
  insertLocalInventory(
      request?: protos.google.shopping.merchant.inventories.v1.IInsertLocalInventoryRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.inventories.v1.ILocalInventory,
        protos.google.shopping.merchant.inventories.v1.IInsertLocalInventoryRequest|undefined, {}|undefined
      ]>;
  insertLocalInventory(
      request: protos.google.shopping.merchant.inventories.v1.IInsertLocalInventoryRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.inventories.v1.ILocalInventory,
          protos.google.shopping.merchant.inventories.v1.IInsertLocalInventoryRequest|null|undefined,
          {}|null|undefined>): void;
  insertLocalInventory(
      request: protos.google.shopping.merchant.inventories.v1.IInsertLocalInventoryRequest,
      callback: Callback<
  ...
  insertLocalInventory(
    ...
    return this.innerApiCalls.insertLocalInventory(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.inventories.v1.ILocalInventory,
        protos.google.shopping.merchant.inventories.v1.IInsertLocalInventoryRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('insertLocalInventory response %j', response);
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/local_inventory_service.delete_local_inventory.js</caption>
 * region_tag:merchantapi_v1_generated_LocalInventoryService_DeleteLocalInventory_async
 */
  deleteLocalInventory(
      request?: protos.google.shopping.merchant.inventories.v1.IDeleteLocalInventoryRequest,
      options?: CallOptions):
      Promise<[
        protos.google.protobuf.IEmpty,
        protos.google.shopping.merchant.inventories.v1.IDeleteLocalInventoryRequest|undefined, {}|undefined
      ]>;
  deleteLocalInventory(
      request: protos.google.shopping.merchant.inventories.v1.IDeleteLocalInventoryRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.protobuf.IEmpty,
          protos.google.shopping.merchant.inventories.v1.IDeleteLocalInventoryRequest|null|undefined,
          {}|null|undefined>): void;
  deleteLocalInventory(
      request: protos.google.shopping.merchant.inventories.v1.IDeleteLocalInventoryRequest,
      callback: Callback<
  ...
  deleteLocalInventory(
    ...
    return this.innerApiCalls.deleteLocalInventory(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.protobuf.IEmpty,
        protos.google.shopping.merchant.inventories.v1.IDeleteLocalInventoryRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('deleteLocalInventory response %j', response);
        return [response, options, rawResponse];
 ...
 *   {@link protos.google.shopping.merchant.inventories.v1.ListLocalInventoriesResponse.next_page_token|nextPageToken}
 *   in the response to the previous request.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.shopping.merchant.inventories.v1.LocalInventory|LocalInventory}.
 ...
 */
  listLocalInventories(
      request?: protos.google.shopping.merchant.inventories.v1.IListLocalInventoriesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.inventories.v1.ILocalInventory[],
        protos.google.shopping.merchant.inventories.v1.IListLocalInventoriesRequest|null,
        protos.google.shopping.merchant.inventories.v1.IListLocalInventoriesResponse
      ]>;
  listLocalInventories(
      request: protos.google.shopping.merchant.inventories.v1.IListLocalInventoriesRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.shopping.merchant.inventories.v1.IListLocalInventoriesRequest,
          protos.google.shopping.merchant.inventories.v1.IListLocalInventoriesResponse|null|undefined,
          protos.google.shopping.merchant.inventories.v1.ILocalInventory>): void;
  listLocalInventories(
      request: protos.google.shopping.merchant.inventories.v1.IListLocalInventoriesRequest,
      callback: PaginationCallback<
          protos.google.shopping.merchant.inventories.v1.IListLocalInventoriesRequest,
  ...
  listLocalInventories(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.shopping.merchant.inventories.v1.IListLocalInventoriesRequest,
      protos.google.shopping.merchant.inventories.v1.IListLocalInventoriesResponse|null|undefined,
      protos.google.shopping.merchant.inventories.v1.ILocalInventory>|undefined = callback
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.shopping.merchant.inventories.v1.LocalInventory|LocalInventory} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   {@link protos.google.shopping.merchant.inventories.v1.LocalInventory|LocalInventory}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/local_inventory_service.list_local_inventories.js</caption>
 * region_tag:merchantapi_v1_generated_LocalInventoryService_ListLocalInventories_async
 */
  listLocalInventoriesAsync(
      request?: protos.google.shopping.merchant.inventories.v1.IListLocalInventoriesRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.shopping.merchant.inventories.v1.ILocalInventory>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listLocalInventories.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.shopping.merchant.inventories.v1.ILocalInventory>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
