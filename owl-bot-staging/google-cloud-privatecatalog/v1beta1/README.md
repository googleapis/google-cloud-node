...
# [Privatecatalog: Nodejs Client][homepage]
...
Privatecatalog client for Node.js
...
* [Privatecatalog Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/privatecatalog/latest)
...
1.  [Enable the Privatecatalog API][enable_api].
