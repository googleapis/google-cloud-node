...
describe('v1.ReachabilityServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = reachabilityserviceModule.v1.ReachabilityServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = reachabilityserviceModule.v1.ReachabilityServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'networkmanagement.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new reachabilityserviceModule.v1.ReachabilityServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networkmanagement.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new reachabilityserviceModule.v1.ReachabilityServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networkmanagement.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new reachabilityserviceModule.v1.ReachabilityServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new reachabilityserviceModule.v1.ReachabilityServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getConnectivityTest', () => {
        it('invokes getConnectivityTest without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkmanagement.v1.GetConnectivityTestRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getConnectivityTest as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getConnectivityTest as SinonStub)
        ...
        it('invokes getConnectivityTest without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getConnectivityTest(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networkmanagement.v1.IConnectivityTest|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createConnectivityTest', () => {
        it('invokes createConnectivityTest without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkmanagement.v1.CreateConnectivityTestRequest', ['parent']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createConnectivityTest as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createConnectivityTest as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createConnectivityTest without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createConnectivityTest(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networkmanagement.v1.IConnectivityTest, protos.google.cloud.networkmanagement.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networkmanagement.v1.IConnectivityTest, protos.google.cloud.networkmanagement.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createConnectivityTest as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateConnectivityTest', () => {
        it('invokes updateConnectivityTest without error', async () => {
            ...
            request.resource ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkmanagement.v1.UpdateConnectivityTestRequest', ['resource', 'name']);
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateConnectivityTest as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateConnectivityTest as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('rerunConnectivityTest', () => {
        it('invokes rerunConnectivityTest without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkmanagement.v1.RerunConnectivityTestRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.rerunConnectivityTest as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.rerunConnectivityTest as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('deleteConnectivityTest', () => {
        it('invokes deleteConnectivityTest without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkmanagement.v1.DeleteConnectivityTestRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteConnectivityTest as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteConnectivityTest as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('listConnectivityTests', () => {
        it('invokes listConnectivityTests without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkmanagement.v1.ListConnectivityTestsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networkmanagement.v1.ConnectivityTest()),
              generateSampleMessage(new protos.google.cloud.networkmanagement.v1.ConnectivityTest()),
              generateSampleMessage(new protos.google.cloud.networkmanagement.v1.ConnectivityTest()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listConnectivityTests as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listConnectivityTests as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listConnectivityTestsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networkmanagement.v1.ConnectivityTest) => {
