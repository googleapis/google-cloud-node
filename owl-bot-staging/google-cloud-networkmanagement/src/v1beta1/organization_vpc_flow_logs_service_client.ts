 ...
 * `src/v1beta1/organization_vpc_flow_logs_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './organization_vpc_flow_logs_service_client_config.json';
...
export class OrganizationVpcFlowLogsServiceClient {
  ...
  organizationVpcFlowLogsServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of OrganizationVpcFlowLogsServiceClient.
   *
   ...
   *     const client = new OrganizationVpcFlowLogsServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof OrganizationVpcFlowLogsServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.networkmanagement.v1beta1.OrganizationVpcFlowLogsService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.organizationVpcFlowLogsServiceStub) {
      return this.organizationVpcFlowLogsServiceStub;
    }

    // Put together the "service stub" for
    // google.cloud.networkmanagement.v1beta1.OrganizationVpcFlowLogsService.
    this.organizationVpcFlowLogsServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.networkmanagement.v1beta1.OrganizationVpcFlowLogsService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.networkmanagement.v1beta1.OrganizationVpcFlowLogsService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const organizationVpcFlowLogsServiceStubMethods =
        ['listVpcFlowLogsConfigs', 'getVpcFlowLogsConfig', 'createVpcFlowLogsConfig', 'updateVpcFlowLogsConfig', 'deleteVpcFlowLogsConfig'];
    for (const methodName of organizationVpcFlowLogsServiceStubMethods) {
      const callPromise = this.organizationVpcFlowLogsServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 * @example <caption>include:samples/generated/v1beta1/organization_vpc_flow_logs_service.get_vpc_flow_logs_config.js</caption>
 * region_tag:networkmanagement_v1beta1_generated_OrganizationVpcFlowLogsService_GetVpcFlowLogsConfig_async
 */
 ...
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta1/organization_vpc_flow_logs_service.create_vpc_flow_logs_config.js</caption>
 * region_tag:networkmanagement_v1beta1_generated_OrganizationVpcFlowLogsService_CreateVpcFlowLogsConfig_async
 */
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta1/organization_vpc_flow_logs_service.update_vpc_flow_logs_config.js</caption>
 * region_tag:networkmanagement_v1beta1_generated_OrganizationVpcFlowLogsService_UpdateVpcFlowLogsConfig_async
 */
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta1/organization_vpc_flow_logs_service.delete_vpc_flow_logs_config.js</caption>
 * region_tag:networkmanagement_v1beta1_generated_OrganizationVpcFlowLogsService_DeleteVpcFlowLogsConfig_async
 */
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta1/organization_vpc_flow_logs_service.list_vpc_flow_logs_configs.js</caption>
 * region_tag:networkmanagement_v1beta1_generated_OrganizationVpcFlowLogsService_ListVpcFlowLogsConfigs_async
 */
...
/**
   ...
   */
  close(): Promise<void> {
    if (this.organizationVpcFlowLogsServiceStub && !this._terminated) {
