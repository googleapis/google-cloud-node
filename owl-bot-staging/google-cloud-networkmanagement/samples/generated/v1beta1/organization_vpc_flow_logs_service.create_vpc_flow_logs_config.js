...
function main(parent, vpcFlowLogsConfigId, vpcFlowLogsConfig) {
  // [START networkmanagement_v1beta1_generated_OrganizationVpcFlowLogsService_CreateVpcFlowLogsConfig_async]
  /**
  ...
  const {OrganizationVpcFlowLogsServiceClient} = require('@google-cloud/network-management').v1beta1;

  // Instantiates a client
  const networkmanagementClient = new OrganizationVpcFlowLogsServiceClient();
  ...
  // [END networkmanagement_v1beta1_generated_OrganizationVpcFlowLogsService_CreateVpcFlowLogsConfig_async]
}
