...
function main(parent) {
  ...
  const {OrganizationVpcFlowLogsServiceClient} = require('@google-cloud/network-management').v1;
  ...
  // [END networkmanagement_v1_generated_OrganizationVpcFlowLogsService_ListVpcFlowLogsConfigs_async]
}
