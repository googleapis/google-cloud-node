...
describe('v3beta1.PlaybooksClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new playbooksModule.v3beta1.PlaybooksClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new playbooksModule.v3beta1.PlaybooksClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new playbooksModule.v3beta1.PlaybooksClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new playbooksModule.v3beta1.PlaybooksClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createPlaybook', () => {
        it('invokes createPlaybook without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.CreatePlaybookRequest', ['parent']);
            ...
            const actualRequest = (client.innerApiCalls.createPlaybook as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createPlaybook as SinonStub)
        ...
        it('invokes createPlaybook without error using callback', async () => {
            ...
            client.innerApiCalls.createPlaybook = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createPlaybook(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3beta1.IPlaybook|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createPlaybook with error', async () => {
            ...
            client.innerApiCalls.createPlaybook = stubSimpleCall(undefined, expectedError);
    ...
    describe('deletePlaybook', () => {
        it('invokes deletePlaybook without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.DeletePlaybookRequest', ['name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deletePlaybook as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deletePlaybook as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deletePlaybook without error using callback', async () => {
            ...
            client.innerApiCalls.deletePlaybook = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deletePlaybook with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deletePlaybook = stubSimpleCall(undefined, expectedError);
    ...
    describe('getPlaybook', () => {
        it('invokes getPlaybook without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.GetPlaybookRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.Playbook()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getPlaybook as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getPlaybook as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getPlaybook without error using callback', async () => {
            ...
            client.innerApiCalls.getPlaybook = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getPlaybook(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3beta1.IPlaybook|null) => {
        ...
        it('invokes getPlaybook with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getPlaybook = stubSimpleCall(undefined, expectedError);
    ...
    describe('updatePlaybook', () => {
        it('invokes updatePlaybook without error', async () => {
            ...
            request.playbook ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.UpdatePlaybookRequest', ['playbook', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updatePlaybook as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updatePlaybook as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updatePlaybook without error using callback', async () => {
            ...
            client.innerApiCalls.updatePlaybook = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updatePlaybook with error', async () => {
            ...
            const expectedHeaderRequestParams = `playbook.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updatePlaybook = stubSimpleCall(undefined, expectedError);
    ...
    describe('createPlaybookVersion', () => {
        it('invokes createPlaybookVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.CreatePlaybookVersionRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.PlaybookVersion()
            );
            client.innerApiCalls.createPlaybookVersion = stubSimpleCall(expectedResponse);
            const [response] = await client.createPlaybookVersion(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createPlaybookVersion as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createPlaybookVersion as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createPlaybookVersion without error using callback', async () => {
            ...
            client.innerApiCalls.createPlaybookVersion = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createPlaybookVersion(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3beta1.IPlaybookVersion|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createPlaybookVersion with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createPlaybookVersion = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createPlaybookVersion(request), expectedError);
            const actualRequest = (client.innerApiCalls.createPlaybookVersion as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createPlaybookVersion as SinonStub)
    ...
    describe('getPlaybookVersion', () => {
        it('invokes getPlaybookVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.GetPlaybookVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.PlaybookVersion()
            );
            client.innerApiCalls.getPlaybookVersion = stubSimpleCall(expectedResponse);
            const [response] = await client.getPlaybookVersion(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getPlaybookVersion as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getPlaybookVersion as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getPlaybookVersion without error using callback', async () => {
            ...
            client.innerApiCalls.getPlaybookVersion = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getPlaybookVersion with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getPlaybookVersion = stubSimpleCall(undefined, expectedError);
    ...
    describe('deletePlaybookVersion', () => {
        it('invokes deletePlaybookVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.DeletePlaybookVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deletePlaybookVersion = stubSimpleCall(expectedResponse);
            const [response] = await client.deletePlaybookVersion(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deletePlaybookVersion as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deletePlaybookVersion as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deletePlaybookVersion without error using callback', async () => {
            ...
            client.innerApiCalls.deletePlaybookVersion = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deletePlaybookVersion with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deletePlaybookVersion = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.deletePlaybookVersion(request), expectedError);
            const actualRequest = (client.innerApiCalls.deletePlaybookVersion as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deletePlaybookVersion as SinonStub)
    ...
    describe('listPlaybooks', () => {
        it('invokes listPlaybooks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.ListPlaybooksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.Playbook()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.Playbook()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.Playbook()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listPlaybooks as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listPlaybooks as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listPlaybooks without error using callback', async () => {
            ...
            client.innerApiCalls.listPlaybooks = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listPlaybooks with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listPlaybooks = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listPlaybooksStream without error', async () => {
            ...
            client.descriptors.page.listPlaybooks.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listPlaybooksStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.cx.v3beta1.Playbook[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3beta1.Playbook) => {
            ...
            assert((client.descriptors.page.listPlaybooks.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listPlaybooks, request));
            assert(
        ...
        it('invokes listPlaybooksStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listPlaybooks.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listPlaybooksStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.cx.v3beta1.Playbook[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3beta1.Playbook) => {
        ...
        it('uses async iteration with listPlaybooks without error', async () => {
            ...
            client.descriptors.page.listPlaybooks.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listPlaybooks with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listPlaybooks.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listPlaybooksAsync(request);
    ...
    describe('listPlaybookVersions', () => {
        it('invokes listPlaybookVersions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.ListPlaybookVersionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.PlaybookVersion()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.PlaybookVersion()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.PlaybookVersion()),
            ];
            client.innerApiCalls.listPlaybookVersions = stubSimpleCall(expectedResponse);
            const [response] = await client.listPlaybookVersions(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listPlaybookVersions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listPlaybookVersions as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listPlaybookVersions without error using callback', async () => {
            ...
            client.innerApiCalls.listPlaybookVersions = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listPlaybookVersions with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listPlaybookVersions = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listPlaybookVersionsStream without error', async () => {
            ...
            client.descriptors.page.listPlaybookVersions.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3beta1.PlaybookVersion) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listPlaybookVersions.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listPlaybookVersions, request));
            assert(
        ...
        it('invokes listPlaybookVersionsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listPlaybookVersions.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listPlaybookVersionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.cx.v3beta1.PlaybookVersion[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3beta1.PlaybookVersion) => {
        ...
        it('uses async iteration with listPlaybookVersions without error', async () => {
            ...
            client.descriptors.page.listPlaybookVersions.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listPlaybookVersions with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listPlaybookVersions.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listPlaybookVersionsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.dialogflow.cx.v3beta1.IPlaybookVersion[] = [];
                for await (const resource of iterable) {
