...
describe('v3beta1.SessionsClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = sessionsModule.v3beta1.SessionsClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = sessionsModule.v3beta1.SessionsClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new sessionsModule.v3beta1.SessionsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new sessionsModule.v3beta1.SessionsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new sessionsModule.v3beta1.SessionsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new sessionsModule.v3beta1.SessionsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = sessionsModule.v3beta1.SessionsClient.port;
            assert(port);
    ...
    describe('detectIntent', () => {
        it('invokes detectIntent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.DetectIntentRequest', ['session']);
        ...
        it('invokes detectIntent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.detectIntent(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3beta1.IDetectIntentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('matchIntent', () => {
        it('invokes matchIntent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.MatchIntentRequest', ['session']);
            request.session = defaultValue1;
            const expectedHeaderRequestParams = `session=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes matchIntent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.matchIntent(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3beta1.IMatchIntentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('fulfillIntent', () => {
        it('invokes fulfillIntent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.FulfillIntentRequest', ['matchIntentRequest', 'session']);
        ...
        it('invokes fulfillIntent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.fulfillIntent(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3beta1.IFulfillIntentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('submitAnswerFeedback', () => {
        it('invokes submitAnswerFeedback without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.SubmitAnswerFeedbackRequest', ['session']);
            request.session = defaultValue1;
            const expectedHeaderRequestParams = `session=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes submitAnswerFeedback without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.submitAnswerFeedback(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3beta1.IAnswerFeedback|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('serverStreamingDetectIntent', () => {
        it('invokes serverStreamingDetectIntent without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3beta1.DetectIntentResponse) => {
                    resolve(response);
                });
        ...
        it('invokes serverStreamingDetectIntent without error and gaxServerStreamingRetries enabled', async () => {
            const client = new sessionsModule.v3beta1.SessionsClient({gaxServerStreamingRetries: true});
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.DetectIntentRequest()
            );
    ...
    describe('streamingDetectIntent', () => {
        it('invokes streamingDetectIntent without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.StreamingDetectIntentResponse()
            );
            ...
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3beta1.StreamingDetectIntentResponse) => {
                    resolve(response);
                });
                stream.on('error', (err: Error) => {
                    reject(err);
