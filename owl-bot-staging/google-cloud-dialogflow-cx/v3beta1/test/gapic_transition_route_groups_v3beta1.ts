...
describe('v3beta1.TransitionRouteGroupsClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = transitionroutegroupsModule.v3beta1.TransitionRouteGroupsClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = transitionroutegroupsModule.v3beta1.TransitionRouteGroupsClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new transitionroutegroupsModule.v3beta1.TransitionRouteGroupsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new transitionroutegroupsModule.v3beta1.TransitionRouteGroupsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new transitionroutegroupsModule.v3beta1.TransitionRouteGroupsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new transitionroutegroupsModule.v3beta1.TransitionRouteGroupsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = transitionroutegroupsModule.v3beta1.TransitionRouteGroupsClient.port;
            assert(port);
    ...
    describe('getTransitionRouteGroup', () => {
        it('invokes getTransitionRouteGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.GetTransitionRouteGroupRequest', ['name']);
        ...
        it('invokes getTransitionRouteGroup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getTransitionRouteGroup(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3beta1.ITransitionRouteGroup|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createTransitionRouteGroup', () => {
        it('invokes createTransitionRouteGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.CreateTransitionRouteGroupRequest', ['parent']);
    ...
    describe('updateTransitionRouteGroup', () => {
        it('invokes updateTransitionRouteGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.UpdateTransitionRouteGroupRequest', ['transitionRouteGroup', 'name']);
    ...
    describe('deleteTransitionRouteGroup', () => {
        it('invokes deleteTransitionRouteGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.DeleteTransitionRouteGroupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listTransitionRouteGroups', () => {
        it('invokes listTransitionRouteGroups without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.ListTransitionRouteGroupsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.TransitionRouteGroup()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.TransitionRouteGroup()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.TransitionRouteGroup()),
            ];
        ...
        it('invokes listTransitionRouteGroupsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3beta1.TransitionRouteGroup) => {
