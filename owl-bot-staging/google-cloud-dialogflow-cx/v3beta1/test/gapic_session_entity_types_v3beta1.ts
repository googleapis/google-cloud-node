...
describe('v3beta1.SessionEntityTypesClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = sessionentitytypesModule.v3beta1.SessionEntityTypesClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = sessionentitytypesModule.v3beta1.SessionEntityTypesClient.apiEndpoint;
            assert(apiEndpoint);
        });

        it('has port', () => {
            const port = sessionentitytypesModule.v3beta1.SessionEntityTypesClient.port;
            assert(port);
    ...
    describe('getSessionEntityType', () => {
        it('invokes getSessionEntityType without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.GetSessionEntityTypeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.SessionEntityType()
            );
        ...
        it('invokes getSessionEntityType without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getSessionEntityType(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3beta1.ISessionEntityType|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createSessionEntityType', () => {
        it('invokes createSessionEntityType without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.CreateSessionEntityTypeRequest', ['parent']);
    ...
    describe('updateSessionEntityType', () => {
        it('invokes updateSessionEntityType without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.UpdateSessionEntityTypeRequest()
            );
            request.sessionEntityType ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.UpdateSessionEntityTypeRequest', ['sessionEntityType', 'name']);
    ...
    describe('deleteSessionEntityType', () => {
        it('invokes deleteSessionEntityType without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.DeleteSessionEntityTypeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listSessionEntityTypes', () => {
        it('invokes listSessionEntityTypes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.ListSessionEntityTypesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.SessionEntityType()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.SessionEntityType()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.SessionEntityType()),
            ];
        ...
        it('invokes listSessionEntityTypesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.cx.v3beta1.SessionEntityType[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3beta1.SessionEntityType) => {
        ...
        it('uses async iteration with listSessionEntityTypes without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.cx.v3beta1.ISessionEntityType[] = [];
    ...
    describe('Path templates', () => {
        ...
        describe('transitionRouteGroup', () => {
            ...
            client.initialize();
            client.pathTemplates.transitionRouteGroupPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.transitionRouteGroupPathTemplate.match =
                sinon.stub().returns(expectedParameters);
            ...
            it('transitionRouteGroupPath', () => {
                ...
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.transitionRouteGroupPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromTransitionRouteGroupName', () => {
                const result = client.matchProjectFromTransitionRouteGroupName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.transitionRouteGroupPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromTransitionRouteGroupName', () => {
                const result = client.matchLocationFromTransitionRouteGroupName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.transitionRouteGroupPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchTransitionRouteGroupFromTransitionRouteGroupName', () => {
                const result = client.matchTransitionRouteGroupFromTransitionRouteGroupName(fakePath);
