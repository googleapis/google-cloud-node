...
describe('v3beta1.SecuritySettingsServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = securitysettingsserviceModule.v3beta1.SecuritySettingsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = securitysettingsserviceModule.v3beta1.SecuritySettingsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new securitysettingsserviceModule.v3beta1.SecuritySettingsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new securitysettingsserviceModule.v3beta1.SecuritySettingsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new securitysettingsserviceModule.v3beta1.SecuritySettingsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new securitysettingsserviceModule.v3beta1.SecuritySettingsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = securitysettingsserviceModule.v3beta1.SecuritySettingsServiceClient.port;
            assert(port);
    ...
    describe('createSecuritySettings', () => {
        it('invokes createSecuritySettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.CreateSecuritySettingsRequest', ['parent']);
        ...
        it('invokes createSecuritySettings without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createSecuritySettings(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3beta1.ISecuritySettings|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getSecuritySettings', () => {
        it('invokes getSecuritySettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.GetSecuritySettingsRequest', ['name']);
    ...
    describe('updateSecuritySettings', () => {
        it('invokes updateSecuritySettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.UpdateSecuritySettingsRequest', ['securitySettings', 'name']);
    ...
    describe('deleteSecuritySettings', () => {
        it('invokes deleteSecuritySettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.DeleteSecuritySettingsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listSecuritySettings', () => {
        it('invokes listSecuritySettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.ListSecuritySettingsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.SecuritySettings()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.SecuritySettings()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.SecuritySettings()),
            ];
        ...
        it('invokes listSecuritySettingsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3beta1.SecuritySettings) => {
