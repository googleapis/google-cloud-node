...
function main(parent, playbook) {
  ...
  async function callCreatePlaybook() {
    // Construct request
    const request = {
      parent,
      playbook,
    ...
    // Run request
    const response = await cxClient.createPlaybook(request);
    console.log(response);
  }

  callCreatePlaybook();
  // [END dialogflow_v3beta1_generated_Playbooks_CreatePlaybook_async]
}
