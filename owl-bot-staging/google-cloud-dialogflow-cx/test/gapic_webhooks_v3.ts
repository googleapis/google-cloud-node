...
describe('v3.WebhooksClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath = webhooksModule.v3.WebhooksClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint = webhooksModule.v3.WebhooksClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new webhooksModule.v3.WebhooksClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = webhooksModule.v3.WebhooksClient.port;
      assert(port);
  ...
  describe('getWebhook', () => {
    it('invokes getWebhook without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.dialogflow.cx.v3.GetWebhookRequest(),
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.dialogflow.cx.v3.Webhook(),
      );
    ...
    it('invokes getWebhook without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getWebhook(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3.IWebhook | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createWebhook', () => {
    it('invokes createWebhook without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.dialogflow.cx.v3.CreateWebhookRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('updateWebhook', () => {
    it('invokes updateWebhook without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.dialogflow.cx.v3.UpdateWebhookRequest(),
      );
      request.webhook ??= {};
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('deleteWebhook', () => {
    it('invokes deleteWebhook without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.dialogflow.cx.v3.DeleteWebhookRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('listWebhooks', () => {
    it('invokes listWebhooks without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.dialogflow.cx.v3.ListWebhooksRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
    ...
    it('invokes listWebhooksStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.dialogflow.cx.v3.Webhook[] = [];
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.cx.v3.Webhook) => {
    ...
    it('uses async iteration with listWebhooks without error', async () => {
      ...
      const responses: protos.google.cloud.dialogflow.cx.v3.IWebhook[] = [];
