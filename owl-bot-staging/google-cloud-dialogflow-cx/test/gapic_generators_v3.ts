...
describe('v3.GeneratorsClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client = new generatorsModule.v3.GeneratorsClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath = generatorsModule.v3.GeneratorsClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint = generatorsModule.v3.GeneratorsClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new generatorsModule.v3.GeneratorsClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = generatorsModule.v3.GeneratorsClient.port;
      assert(port);
  ...
  describe('getGenerator', () => {
    it('invokes getGenerator without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.dialogflow.cx.v3.GetGeneratorRequest(),
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.dialogflow.cx.v3.Generator(),
      );
      ...
      const actualRequest = (
        client.innerApiCalls.getGenerator as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getGenerator without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getGenerator(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3.IGenerator | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createGenerator', () => {
    it('invokes createGenerator without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.dialogflow.cx.v3.CreateGeneratorRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createGenerator as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createGenerator as SinonStub
    ...
    it('invokes createGenerator without error using callback', async () => {
      ...
      client.innerApiCalls.createGenerator =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
  ...
  describe('updateGenerator', () => {
    it('invokes updateGenerator without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.dialogflow.cx.v3.UpdateGeneratorRequest(),
      );
      request.generator ??= {};
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateGenerator as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateGenerator as SinonStub
    ...
    it('invokes updateGenerator without error using callback', async () => {
      ...
      client.innerApiCalls.updateGenerator =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
  ...
  describe('deleteGenerator', () => {
    it('invokes deleteGenerator without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.dialogflow.cx.v3.DeleteGeneratorRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteGenerator as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteGenerator as SinonStub
    ...
    it('invokes deleteGenerator without error using callback', async () => {
      ...
      client.innerApiCalls.deleteGenerator =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
  ...
  describe('listGenerators', () => {
    it('invokes listGenerators without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.dialogflow.cx.v3.ListGeneratorsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listGenerators as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listGenerators as SinonStub
    ...
    it('invokes listGenerators without error using callback', async () => {
      ...
      client.innerApiCalls.listGenerators =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listGeneratorsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.dialogflow.cx.v3.Generator[] = [];
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.cx.v3.Generator) => {
      ...
      assert(
        (client.descriptors.page.listGenerators.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listGenerators, request),
      );
      assert(
        (client.descriptors.page.listGenerators.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listGenerators without error', async () => {
      ...
      const responses: protos.google.cloud.dialogflow.cx.v3.IGenerator[] = [];
