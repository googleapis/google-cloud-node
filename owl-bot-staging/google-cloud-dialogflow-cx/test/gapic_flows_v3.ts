...
describe('v3.FlowsClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = flowsModule.v3.FlowsClient.servicePath;
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new flowsModule.v3.FlowsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new flowsModule.v3.FlowsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new flowsModule.v3.FlowsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new flowsModule.v3.FlowsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = flowsModule.v3.FlowsClient.port;
            assert(port);
    ...
    describe('createFlow', () => {
        it('invokes createFlow without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.CreateFlowRequest', ['parent']);
            ...
            const actualRequest = (client.innerApiCalls.createFlow as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createFlow as SinonStub)
        ...
        it('invokes createFlow without error using callback', async () => {
            ...
            client.innerApiCalls.createFlow = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createFlow(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3.IFlow|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createFlow with error', async () => {
            ...
            client.innerApiCalls.createFlow = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteFlow', () => {
        it('invokes deleteFlow without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.DeleteFlowRequest', ['name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteFlow as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteFlow as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteFlow without error using callback', async () => {
            ...
            client.innerApiCalls.deleteFlow = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteFlow(
                    request,
        ...
        it('invokes deleteFlow with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteFlow = stubSimpleCall(undefined, expectedError);
    ...
    describe('getFlow', () => {
        it('invokes getFlow without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.GetFlowRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.Flow()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getFlow as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getFlow as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getFlow without error using callback', async () => {
            ...
            client.innerApiCalls.getFlow = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getFlow(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3.IFlow|null) => {
    ...
    describe('updateFlow', () => {
        it('invokes updateFlow without error', async () => {
            ...
            request.flow ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.UpdateFlowRequest', ['flow', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateFlow as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateFlow as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateFlow without error using callback', async () => {
            ...
            client.innerApiCalls.updateFlow = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateFlow(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3.IFlow|null) => {
        ...
        it('invokes updateFlow with error', async () => {
            ...
            const expectedHeaderRequestParams = `flow.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateFlow = stubSimpleCall(undefined, expectedError);
    ...
    describe('validateFlow', () => {
        it('invokes validateFlow without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.ValidateFlowRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.validateFlow as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.validateFlow as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes validateFlow without error using callback', async () => {
            ...
            client.innerApiCalls.validateFlow = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.validateFlow(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3.IFlowValidationResult|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes validateFlow with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.validateFlow = stubSimpleCall(undefined, expectedError);
    ...
    describe('getFlowValidationResult', () => {
        it('invokes getFlowValidationResult without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.GetFlowValidationResultRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.FlowValidationResult()
            );
            client.innerApiCalls.getFlowValidationResult = stubSimpleCall(expectedResponse);
            const [response] = await client.getFlowValidationResult(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getFlowValidationResult as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getFlowValidationResult as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getFlowValidationResult without error using callback', async () => {
            ...
            client.innerApiCalls.getFlowValidationResult = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getFlowValidationResult with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getFlowValidationResult = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getFlowValidationResult(request), expectedError);
            const actualRequest = (client.innerApiCalls.getFlowValidationResult as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getFlowValidationResult as SinonStub)
    ...
    describe('trainFlow', () => {
        it('invokes trainFlow without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.TrainFlowRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.trainFlow as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.trainFlow as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes trainFlow without error using callback', async () => {
            ...
            client.innerApiCalls.trainFlow = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.trainFlow(
                    request,
                    (err?: Error|null,
        ...
        it('invokes trainFlow with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.trainFlow = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes trainFlow with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.trainFlow = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.trainFlow(request);
        ...
        it('invokes checkTrainFlowProgress without error', async () => {
            ...
            const decodedOperation = await client.checkTrainFlowProgress(expectedResponse.name);
    ...
    describe('importFlow', () => {
        it('invokes importFlow without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.ImportFlowRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importFlow as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.importFlow as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes importFlow without error using callback', async () => {
            ...
            client.innerApiCalls.importFlow = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.importFlow(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dialogflow.cx.v3.IImportFlowResponse, protos.google.protobuf.IStruct>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dialogflow.cx.v3.IImportFlowResponse, protos.google.protobuf.IStruct>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importFlow as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes importFlow with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.importFlow = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes importFlow with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.importFlow = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.importFlow(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.importFlow as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkImportFlowProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkImportFlowProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('exportFlow', () => {
        it('invokes exportFlow without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.ExportFlowRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportFlow as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.exportFlow as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes exportFlow without error using callback', async () => {
            ...
            client.innerApiCalls.exportFlow = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.exportFlow(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dialogflow.cx.v3.IExportFlowResponse, protos.google.protobuf.IStruct>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dialogflow.cx.v3.IExportFlowResponse, protos.google.protobuf.IStruct>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportFlow as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes exportFlow with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.exportFlow = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes exportFlow with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.exportFlow = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.exportFlow(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.exportFlow as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkExportFlowProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkExportFlowProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('listFlows', () => {
        it('invokes listFlows without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.ListFlowsRequest', ['parent']);
            request.parent = defaultValue1;
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listFlows as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listFlows as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listFlows without error using callback', async () => {
            ...
            client.innerApiCalls.listFlows = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listFlows(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3.IFlow[]|null) => {
        ...
        it('invokes listFlowsStream without error', async () => {
            ...
            client.descriptors.page.listFlows.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listFlowsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.cx.v3.Flow[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3.Flow) => {
            ...
            assert((client.descriptors.page.listFlows.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listFlows, request));
            assert(
        ...
        it('invokes listFlowsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listFlows.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listFlowsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.cx.v3.Flow[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3.Flow) => {
        ...
        it('uses async iteration with listFlows without error', async () => {
            ...
            client.descriptors.page.listFlows.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.dialogflow.cx.v3.IFlow[] = [];
        ...
        it('uses async iteration with listFlows with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listFlows.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listFlowsAsync(request);
