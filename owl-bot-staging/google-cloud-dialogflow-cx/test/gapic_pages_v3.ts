...
describe('v3.PagesClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath = pagesModule.v3.PagesClient.servicePath;
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new pagesModule.v3.PagesClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = pagesModule.v3.PagesClient.port;
      assert(port);
  ...
  describe('getPage', () => {
    it('invokes getPage without error', async () => {
      ...
      const actualRequest = (client.innerApiCalls.getPage as SinonStub).getCall(
        0,
      ).args[0];
    ...
    it('invokes getPage without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getPage(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3.IPage | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listPages', () => {
    ...
    it('invokes listPagesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.dialogflow.cx.v3.Page[] = [];
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.cx.v3.Page) => {
    ...
    it('uses async iteration with listPages without error', async () => {
      ...
      const responses: protos.google.cloud.dialogflow.cx.v3.IPage[] = [];
