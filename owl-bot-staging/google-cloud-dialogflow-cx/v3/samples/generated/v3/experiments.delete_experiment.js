...
function main(name) {
  // [START dialogflow_v3_generated_Experiments_DeleteExperiment_async]
  /**
  ...
  async function callDeleteExperiment() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await cxClient.deleteExperiment(request);
    console.log(response);
  }

  callDeleteExperiment();
  // [END dialogflow_v3_generated_Experiments_DeleteExperiment_async]
}
