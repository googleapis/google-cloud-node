...
describe('v3.TransitionRouteGroupsClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = transitionroutegroupsModule.v3.TransitionRouteGroupsClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = transitionroutegroupsModule.v3.TransitionRouteGroupsClient.apiEndpoint;
            assert(apiEndpoint);
        });

        it('has port', () => {
            const port = transitionroutegroupsModule.v3.TransitionRouteGroupsClient.port;
            assert(port);
    ...
    describe('getTransitionRouteGroup', () => {
        it('invokes getTransitionRouteGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.GetTransitionRouteGroupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.TransitionRouteGroup()
            );
            client.innerApiCalls.getTransitionRouteGroup = stubSimpleCall(expectedResponse);
            const [response] = await client.getTransitionRouteGroup(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getTransitionRouteGroup as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getTransitionRouteGroup as SinonStub)
        ...
        it('invokes getTransitionRouteGroup without error using callback', async () => {
            ...
            client.innerApiCalls.getTransitionRouteGroup = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getTransitionRouteGroup(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3.ITransitionRouteGroup|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getTransitionRouteGroup with error', async () => {
            ...
            client.innerApiCalls.getTransitionRouteGroup = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getTransitionRouteGroup(request), expectedError);
            const actualRequest = (client.innerApiCalls.getTransitionRouteGroup as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getTransitionRouteGroup as SinonStub)
    ...
    describe('createTransitionRouteGroup', () => {
        it('invokes createTransitionRouteGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.CreateTransitionRouteGroupRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.TransitionRouteGroup()
            );
            client.innerApiCalls.createTransitionRouteGroup = stubSimpleCall(expectedResponse);
            const [response] = await client.createTransitionRouteGroup(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createTransitionRouteGroup as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createTransitionRouteGroup as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createTransitionRouteGroup without error using callback', async () => {
            ...
            client.innerApiCalls.createTransitionRouteGroup = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createTransitionRouteGroup with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createTransitionRouteGroup = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createTransitionRouteGroup(request), expectedError);
            const actualRequest = (client.innerApiCalls.createTransitionRouteGroup as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createTransitionRouteGroup as SinonStub)
    ...
    describe('updateTransitionRouteGroup', () => {
        it('invokes updateTransitionRouteGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.UpdateTransitionRouteGroupRequest', ['transitionRouteGroup', 'name']);
            ...
            client.innerApiCalls.updateTransitionRouteGroup = stubSimpleCall(expectedResponse);
            const [response] = await client.updateTransitionRouteGroup(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateTransitionRouteGroup as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateTransitionRouteGroup as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateTransitionRouteGroup without error using callback', async () => {
            ...
            client.innerApiCalls.updateTransitionRouteGroup = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateTransitionRouteGroup with error', async () => {
            ...
            const expectedHeaderRequestParams = `transition_route_group.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateTransitionRouteGroup = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateTransitionRouteGroup(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateTransitionRouteGroup as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateTransitionRouteGroup as SinonStub)
    ...
    describe('deleteTransitionRouteGroup', () => {
        it('invokes deleteTransitionRouteGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.DeleteTransitionRouteGroupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteTransitionRouteGroup = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteTransitionRouteGroup(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteTransitionRouteGroup as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteTransitionRouteGroup as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteTransitionRouteGroup without error using callback', async () => {
            ...
            client.innerApiCalls.deleteTransitionRouteGroup = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteTransitionRouteGroup with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteTransitionRouteGroup = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.deleteTransitionRouteGroup(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteTransitionRouteGroup as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteTransitionRouteGroup as SinonStub)
    ...
    describe('listTransitionRouteGroups', () => {
        it('invokes listTransitionRouteGroups without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.ListTransitionRouteGroupsRequest', ['parent']);
            request.parent = defaultValue1;
            ...
            client.innerApiCalls.listTransitionRouteGroups = stubSimpleCall(expectedResponse);
            const [response] = await client.listTransitionRouteGroups(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listTransitionRouteGroups as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listTransitionRouteGroups as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listTransitionRouteGroups without error using callback', async () => {
            ...
            client.innerApiCalls.listTransitionRouteGroups = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listTransitionRouteGroups with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listTransitionRouteGroups = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listTransitionRouteGroups(request), expectedError);
            const actualRequest = (client.innerApiCalls.listTransitionRouteGroups as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listTransitionRouteGroups as SinonStub)
        ...
        it('invokes listTransitionRouteGroupsStream without error', async () => {
            ...
            client.descriptors.page.listTransitionRouteGroups.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3.TransitionRouteGroup) => {
            ...
            assert((client.descriptors.page.listTransitionRouteGroups.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listTransitionRouteGroups, request));
            assert(
                (client.descriptors.page.listTransitionRouteGroups.createStream as SinonStub)
        ...
        it('invokes listTransitionRouteGroupsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listTransitionRouteGroups.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listTransitionRouteGroupsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.cx.v3.TransitionRouteGroup[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3.TransitionRouteGroup) => {
        ...
        it('uses async iteration with listTransitionRouteGroups without error', async () => {
            ...
            client.descriptors.page.listTransitionRouteGroups.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(
                (client.descriptors.page.listTransitionRouteGroups.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listTransitionRouteGroups with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listTransitionRouteGroups.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listTransitionRouteGroupsAsync(request);
