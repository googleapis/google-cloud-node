...
describe('v3.SecuritySettingsServiceClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = securitysettingsserviceModule.v3.SecuritySettingsServiceClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = securitysettingsserviceModule.v3.SecuritySettingsServiceClient.apiEndpoint;
            assert(apiEndpoint);
        });

        it('has port', () => {
            const port = securitysettingsserviceModule.v3.SecuritySettingsServiceClient.port;
            assert(port);
    ...
    describe('createSecuritySettings', () => {
        it('invokes createSecuritySettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.CreateSecuritySettingsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.SecuritySettings()
            );
            client.innerApiCalls.createSecuritySettings = stubSimpleCall(expectedResponse);
            const [response] = await client.createSecuritySettings(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createSecuritySettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createSecuritySettings as SinonStub)
        ...
        it('invokes createSecuritySettings without error using callback', async () => {
            ...
            client.innerApiCalls.createSecuritySettings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createSecuritySettings(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3.ISecuritySettings|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createSecuritySettings with error', async () => {
            ...
            client.innerApiCalls.createSecuritySettings = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createSecuritySettings(request), expectedError);
            const actualRequest = (client.innerApiCalls.createSecuritySettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createSecuritySettings as SinonStub)
    ...
    describe('getSecuritySettings', () => {
        it('invokes getSecuritySettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.GetSecuritySettingsRequest', ['name']);
    ...
    describe('updateSecuritySettings', () => {
        it('invokes updateSecuritySettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.UpdateSecuritySettingsRequest', ['securitySettings', 'name']);
    ...
    describe('deleteSecuritySettings', () => {
        it('invokes deleteSecuritySettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.DeleteSecuritySettingsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteSecuritySettings = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteSecuritySettings(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteSecuritySettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteSecuritySettings as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteSecuritySettings without error using callback', async () => {
            ...
            client.innerApiCalls.deleteSecuritySettings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteSecuritySettings with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteSecuritySettings = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.deleteSecuritySettings(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteSecuritySettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteSecuritySettings as SinonStub)
    ...
    describe('listSecuritySettings', () => {
        it('invokes listSecuritySettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.ListSecuritySettingsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.SecuritySettings()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.SecuritySettings()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.SecuritySettings()),
            ];
            client.innerApiCalls.listSecuritySettings = stubSimpleCall(expectedResponse);
            const [response] = await client.listSecuritySettings(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listSecuritySettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listSecuritySettings as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listSecuritySettings without error using callback', async () => {
            ...
            client.innerApiCalls.listSecuritySettings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listSecuritySettings with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listSecuritySettings = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listSecuritySettingsStream without error', async () => {
            ...
            client.descriptors.page.listSecuritySettings.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3.SecuritySettings) => {
            ...
            assert((client.descriptors.page.listSecuritySettings.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listSecuritySettings, request));
            assert(
        ...
        it('invokes listSecuritySettingsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listSecuritySettings.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listSecuritySettingsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.cx.v3.SecuritySettings[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3.SecuritySettings) => {
        ...
        it('uses async iteration with listSecuritySettings without error', async () => {
            ...
            client.descriptors.page.listSecuritySettings.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listSecuritySettings with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listSecuritySettings.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listSecuritySettingsAsync(request);
