...
describe('v3.DeploymentsClient', () => {
    describe('Common methods', () => {
        ...
        it('has port', () => {
            const port = deploymentsModule.v3.DeploymentsClient.port;
            assert(port);
    ...
    describe('getDeployment', () => {
        it('invokes getDeployment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.GetDeploymentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.Deployment()
            );
        ...
        it('invokes getDeployment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getDeployment(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3.IDeployment|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listDeployments', () => {
        it('invokes listDeployments without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.ListDeploymentsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.ListDeploymentsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.Deployment()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.Deployment()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.Deployment()),
            ];
        ...
        it('invokes listDeploymentsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.cx.v3.Deployment[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3.Deployment) => {
        ...
        it('uses async iteration with listDeployments without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.cx.v3.IDeployment[] = [];
