...
describe('v3.GeneratorsClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new generatorsModule.v3.GeneratorsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new generatorsModule.v3.GeneratorsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new generatorsModule.v3.GeneratorsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new generatorsModule.v3.GeneratorsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getGenerator', () => {
        it('invokes getGenerator without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.GetGeneratorRequest', ['name']);
        ...
        it('invokes getGenerator without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getGenerator(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3.IGenerator|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createGenerator', () => {
        it('invokes createGenerator without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.CreateGeneratorRequest', ['parent']);
    ...
    describe('updateGenerator', () => {
        it('invokes updateGenerator without error', async () => {
            ...
            request.generator ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.UpdateGeneratorRequest', ['generator', 'name']);
    ...
    describe('deleteGenerator', () => {
        it('invokes deleteGenerator without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.DeleteGeneratorRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listGenerators', () => {
        it('invokes listGenerators without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.ListGeneratorsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.Generator()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.Generator()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.Generator()),
            ];
        ...
        it('invokes listGeneratorsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3.Generator) => {
