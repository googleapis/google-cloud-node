...
describe('v3.WebhooksClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new webhooksModule.v3.WebhooksClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new webhooksModule.v3.WebhooksClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new webhooksModule.v3.WebhooksClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new webhooksModule.v3.WebhooksClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getWebhook', () => {
        it('invokes getWebhook without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.GetWebhookRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getWebhook as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getWebhook as SinonStub)
        ...
        it('invokes getWebhook without error using callback', async () => {
            ...
            client.innerApiCalls.getWebhook = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getWebhook(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3.IWebhook|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getWebhook with error', async () => {
            ...
            client.innerApiCalls.getWebhook = stubSimpleCall(undefined, expectedError);
    ...
    describe('createWebhook', () => {
        it('invokes createWebhook without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.CreateWebhookRequest', ['parent']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createWebhook as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createWebhook as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createWebhook without error using callback', async () => {
            ...
            client.innerApiCalls.createWebhook = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createWebhook with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createWebhook = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateWebhook', () => {
        it('invokes updateWebhook without error', async () => {
            ...
            request.webhook ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.UpdateWebhookRequest', ['webhook', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateWebhook as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateWebhook as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateWebhook without error using callback', async () => {
            ...
            client.innerApiCalls.updateWebhook = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateWebhook with error', async () => {
            ...
            const expectedHeaderRequestParams = `webhook.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateWebhook = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteWebhook', () => {
        it('invokes deleteWebhook without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.DeleteWebhookRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteWebhook as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteWebhook as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteWebhook without error using callback', async () => {
            ...
            client.innerApiCalls.deleteWebhook = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteWebhook with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteWebhook = stubSimpleCall(undefined, expectedError);
    ...
    describe('listWebhooks', () => {
        it('invokes listWebhooks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.ListWebhooksRequest', ['parent']);
            request.parent = defaultValue1;
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listWebhooks as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listWebhooks as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listWebhooks without error using callback', async () => {
            ...
            client.innerApiCalls.listWebhooks = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listWebhooks(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3.IWebhook[]|null) => {
        ...
        it('invokes listWebhooks with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listWebhooks = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listWebhooksStream without error', async () => {
            ...
            client.descriptors.page.listWebhooks.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listWebhooksStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.cx.v3.Webhook[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3.Webhook) => {
            ...
            assert((client.descriptors.page.listWebhooks.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listWebhooks, request));
            assert(
        ...
        it('invokes listWebhooksStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listWebhooks.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listWebhooksStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.cx.v3.Webhook[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3.Webhook) => {
        ...
        it('uses async iteration with listWebhooks without error', async () => {
            ...
            client.descriptors.page.listWebhooks.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listWebhooks with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listWebhooks.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listWebhooksAsync(request);
