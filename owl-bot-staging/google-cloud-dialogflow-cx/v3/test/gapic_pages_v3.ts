...
describe('v3.PagesClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new pagesModule.v3.PagesClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new pagesModule.v3.PagesClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new pagesModule.v3.PagesClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new pagesModule.v3.PagesClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getPage', () => {
        it('invokes getPage without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.GetPageRequest', ['name']);
        ...
        it('invokes getPage without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getPage(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3.IPage|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createPage', () => {
        it('invokes createPage without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.CreatePageRequest', ['parent']);
    ...
    describe('updatePage', () => {
        it('invokes updatePage without error', async () => {
            ...
            request.page ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.UpdatePageRequest', ['page', 'name']);
    ...
    describe('deletePage', () => {
        it('invokes deletePage without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.DeletePageRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listPages', () => {
        it('invokes listPages without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.ListPagesRequest', ['parent']);
            request.parent = defaultValue1;
        ...
        it('invokes listPagesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3.Page) => {
