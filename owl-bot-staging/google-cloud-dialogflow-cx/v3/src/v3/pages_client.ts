 ...
 */
import * as gapicConfig from './pages_client_config.json';
const version = require('../../../package.json').version;

/**
 *  Service for managing {@link google.cloud.dialogflow.cx.v3.Page|Pages}.
 * @class
 * @memberof v3
 */
export class PagesClient {
   ...
   *     const client = new PagesClient({fallback: 'rest'}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.dialogflow.cx.v3.Pages', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.pagesStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.dialogflow.cx.v3.Pages') :
 ...
 *   The first element of the array is an object representing [Page]{@link google.cloud.dialogflow.cx.v3.Page}.
 *   Please see the
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [Page]{@link google.cloud.dialogflow.cx.v3.Page}.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [Page]{@link google.cloud.dialogflow.cx.v3.Page} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   [Page]{@link google.cloud.dialogflow.cx.v3.Page}. The API will be called under the hood as needed, once per the page,
 ...
 */
  listPagesAsync(
      request?: protos.google.cloud.dialogflow.cx.v3.IListPagesRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.dialogflow.cx.v3.IPage>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listPages.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.dialogflow.cx.v3.IPage>;
  }
/**
