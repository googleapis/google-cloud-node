...
function main(name) {
  // [START dialogflow_v3beta1_generated_Environments_DeleteEnvironment_async]
  /**
  ...
  async function callDeleteEnvironment() {
    ...
    // Run request
    const response = await cxClient.deleteEnvironment(request);
    console.log(response);
  }

  callDeleteEnvironment();
  // [END dialogflow_v3beta1_generated_Environments_DeleteEnvironment_async]
}
