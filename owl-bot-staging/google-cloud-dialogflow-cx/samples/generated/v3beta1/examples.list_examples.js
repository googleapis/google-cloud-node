...
function main(parent) {
  // [START dialogflow_v3beta1_generated_Examples_ListExamples_async]
  /**
  ...
  async function callListExamples() {
    ...
    // Run request
    const iterable = cxClient.listExamplesAsync(request);
  ...
  callListExamples();
  // [END dialogflow_v3beta1_generated_Examples_ListExamples_async]
}
