...
function main(name) {
  ...
  async function callDeletePlaybookVersion() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await cxClient.deletePlaybookVersion(request);
    console.log(response);
  }

  callDeletePlaybookVersion();
  // [END dialogflow_v3beta1_generated_Playbooks_DeletePlaybookVersion_async]
}
