...
function main(name) {
  // [START dialogflow_v3beta1_generated_Changelogs_GetChangelog_async]
  /**
  ...
  async function callGetChangelog() {
    ...
    // Run request
    const response = await cxClient.getChangelog(request);
    console.log(response);
  }

  callGetChangelog();
  // [END dialogflow_v3beta1_generated_Changelogs_GetChangelog_async]
}
