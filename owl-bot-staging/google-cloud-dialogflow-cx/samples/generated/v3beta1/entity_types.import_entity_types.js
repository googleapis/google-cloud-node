...
function main(parent, mergeOption) {
  ...
  async function callImportEntityTypes() {
    // Construct request
    const request = {
      parent,
      mergeOption,
    ...
    // Run request
    const [operation] = await cxClient.importEntityTypes(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callImportEntityTypes();
