...
export class DeploymentsClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.dialogflow.cx.v3.Deployments', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.deploymentsStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.dialogflow.cx.v3.Deployments') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.dialogflow.cx.v3.Deployments,
 ...
 */
  getDeployment(
      request?: protos.google.cloud.dialogflow.cx.v3.IGetDeploymentRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.cx.v3.IDeployment,
        protos.google.cloud.dialogflow.cx.v3.IGetDeploymentRequest|undefined, {}|undefined
      ]>;
  getDeployment(
      request: protos.google.cloud.dialogflow.cx.v3.IGetDeploymentRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.cx.v3.IDeployment,
          protos.google.cloud.dialogflow.cx.v3.IGetDeploymentRequest|null|undefined,
          {}|null|undefined>): void;
  getDeployment(
      request: protos.google.cloud.dialogflow.cx.v3.IGetDeploymentRequest,
      callback: Callback<
 ...
 */
  listDeployments(
      request?: protos.google.cloud.dialogflow.cx.v3.IListDeploymentsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.cx.v3.IDeployment[],
  ...
  listDeployments(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.dialogflow.cx.v3.IListDeploymentsResponse|null|undefined,
          protos.google.cloud.dialogflow.cx.v3.IDeployment>): void;
  listDeployments(
      request: protos.google.cloud.dialogflow.cx.v3.IListDeploymentsRequest,
      callback: PaginationCallback<
          protos.google.cloud.dialogflow.cx.v3.IListDeploymentsRequest,
  ...
  listDeployments(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.dialogflow.cx.v3.IListDeploymentsRequest,
      protos.google.cloud.dialogflow.cx.v3.IListDeploymentsResponse|null|undefined,
      protos.google.cloud.dialogflow.cx.v3.IDeployment>|undefined = callback
 ...
 */
  listDeploymentsAsync(
      request?: protos.google.cloud.dialogflow.cx.v3.IListDeploymentsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.dialogflow.cx.v3.IDeployment>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listDeployments.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.dialogflow.cx.v3.IDeployment>;
  }
/**
