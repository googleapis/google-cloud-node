...
describe('v1.WebRiskServiceClient', () => {
        ...
        it('invokes computeThreatListDiff without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.computeThreatListDiff(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.webrisk.v1.IComputeThreatListDiffResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('searchUris', () => {
        ...
        it('invokes searchUris without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.searchUris(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.webrisk.v1.ISearchUrisResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('searchHashes', () => {
        ...
        it('invokes searchHashes without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.searchHashes(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.webrisk.v1.ISearchHashesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createSubmission', () => {
        it('invokes createSubmission without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.webrisk.v1.CreateSubmissionRequest', ['parent']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createSubmission as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createSubmission as SinonStub)
        ...
        it('invokes createSubmission without error using callback', async () => {
            ...
            client.innerApiCalls.createSubmission = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createSubmission(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.webrisk.v1.ISubmission|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createSubmission with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createSubmission = stubSimpleCall(undefined, expectedError);
    ...
    describe('submitUri', () => {
        it('invokes submitUri without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.webrisk.v1.SubmitUriRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.submitUri as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.submitUri as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes submitUri without error using callback', async () => {
            ...
            client.innerApiCalls.submitUri = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.submitUri(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.webrisk.v1.ISubmission, protos.google.cloud.webrisk.v1.ISubmitUriMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.webrisk.v1.ISubmission, protos.google.cloud.webrisk.v1.ISubmitUriMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.submitUri as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes submitUri with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.submitUri = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes submitUri with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.submitUri = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.submitUri(request);
        ...
        it('invokes checkSubmitUriProgress without error', async () => {
            ...
            const decodedOperation = await client.checkSubmitUriProgress(expectedResponse.name);
