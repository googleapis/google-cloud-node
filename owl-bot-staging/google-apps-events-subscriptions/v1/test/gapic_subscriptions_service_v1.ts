...
describe('v1.SubscriptionsServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new subscriptionsserviceModule.v1.SubscriptionsServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = subscriptionsserviceModule.v1.SubscriptionsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = subscriptionsserviceModule.v1.SubscriptionsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'workspaceevents.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new subscriptionsserviceModule.v1.SubscriptionsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'workspaceevents.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new subscriptionsserviceModule.v1.SubscriptionsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'workspaceevents.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new subscriptionsserviceModule.v1.SubscriptionsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new subscriptionsserviceModule.v1.SubscriptionsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = subscriptionsserviceModule.v1.SubscriptionsServiceClient.port;
            assert(port);
    ...
    describe('getSubscription', () => {
        it('invokes getSubscription without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.events.subscriptions.v1.GetSubscriptionRequest', ['name']);
        ...
        it('invokes getSubscription without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getSubscription(
                    request,
                    (err?: Error|null, result?: protos.google.apps.events.subscriptions.v1.ISubscription|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createSubscription without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createSubscription(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.apps.events.subscriptions.v1.ISubscription, protos.google.apps.events.subscriptions.v1.ICreateSubscriptionMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.apps.events.subscriptions.v1.ISubscription, protos.google.apps.events.subscriptions.v1.ICreateSubscriptionMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
        });
    ...
    describe('deleteSubscription', () => {
        it('invokes deleteSubscription without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.events.subscriptions.v1.DeleteSubscriptionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes deleteSubscription without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deleteSubscription(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.apps.events.subscriptions.v1.IDeleteSubscriptionMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.apps.events.subscriptions.v1.IDeleteSubscriptionMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteSubscription as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateSubscription', () => {
        it('invokes updateSubscription without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.events.subscriptions.v1.UpdateSubscriptionRequest', ['subscription', 'name']);
        ...
        it('invokes updateSubscription without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updateSubscription(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.apps.events.subscriptions.v1.ISubscription, protos.google.apps.events.subscriptions.v1.IUpdateSubscriptionMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.apps.events.subscriptions.v1.ISubscription, protos.google.apps.events.subscriptions.v1.IUpdateSubscriptionMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateSubscription as SinonStub)
                .getCall(0).args[0];
    ...
    describe('reactivateSubscription', () => {
        it('invokes reactivateSubscription without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.events.subscriptions.v1.ReactivateSubscriptionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes reactivateSubscription without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.reactivateSubscription(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.apps.events.subscriptions.v1.ISubscription, protos.google.apps.events.subscriptions.v1.IReactivateSubscriptionMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.apps.events.subscriptions.v1.ISubscription, protos.google.apps.events.subscriptions.v1.IReactivateSubscriptionMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.reactivateSubscription as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listSubscriptions', () => {
        it('invokes listSubscriptions without error', async () => {
            ...
            const request = generateSampleMessage(
              ...
              generateSampleMessage(new protos.google.apps.events.subscriptions.v1.Subscription()),
              generateSampleMessage(new protos.google.apps.events.subscriptions.v1.Subscription()),
              generateSampleMessage(new protos.google.apps.events.subscriptions.v1.Subscription()),
            ];
        ...
        it('invokes listSubscriptionsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.apps.events.subscriptions.v1.Subscription) => {
