...
describe('v1beta.SubscriptionsServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new subscriptionsserviceModule.v1beta.SubscriptionsServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = subscriptionsserviceModule.v1beta.SubscriptionsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = subscriptionsserviceModule.v1beta.SubscriptionsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'workspaceevents.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new subscriptionsserviceModule.v1beta.SubscriptionsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'workspaceevents.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new subscriptionsserviceModule.v1beta.SubscriptionsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'workspaceevents.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new subscriptionsserviceModule.v1beta.SubscriptionsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
                    assert.strictEqual(servicePath, 'workspaceevents.configured.example.com');
                    if (saved) {
                        process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = saved;
                    } else {
                        delete process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new subscriptionsserviceModule.v1beta.SubscriptionsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = subscriptionsserviceModule.v1beta.SubscriptionsServiceClient.port;
            assert(port);
    ...
    describe('getSubscription', () => {
        it('invokes getSubscription without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.apps.events.subscriptions.v1beta.GetSubscriptionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.events.subscriptions.v1beta.GetSubscriptionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.apps.events.subscriptions.v1beta.Subscription()
            );
        ...
        it('invokes getSubscription without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getSubscription(
                    request,
                    (err?: Error|null, result?: protos.google.apps.events.subscriptions.v1beta.ISubscription|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createSubscription', () => {
        it('invokes createSubscription without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.apps.events.subscriptions.v1beta.CreateSubscriptionRequest()
            );
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createSubscription = stubLongRunningCall(expectedResponse);
        ...
        it('invokes createSubscription without error using callback', async () => {
            ...
            client.innerApiCalls.createSubscription = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createSubscription(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.apps.events.subscriptions.v1beta.ISubscription, protos.google.apps.events.subscriptions.v1beta.ICreateSubscriptionMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.apps.events.subscriptions.v1beta.ISubscription, protos.google.apps.events.subscriptions.v1beta.ICreateSubscriptionMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
        });
        ...
        it('invokes createSubscription with call error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.createSubscription = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes createSubscription with LRO error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.createSubscription = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createSubscription(request);
        ...
        it('invokes checkCreateSubscriptionProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateSubscriptionProgress(expectedResponse.name);
        ...
        it('invokes checkCreateSubscriptionProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreateSubscriptionProgress(''), expectedError);
    ...
    describe('deleteSubscription', () => {
        it('invokes deleteSubscription without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.apps.events.subscriptions.v1beta.DeleteSubscriptionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.events.subscriptions.v1beta.DeleteSubscriptionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes deleteSubscription without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deleteSubscription(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.apps.events.subscriptions.v1beta.IDeleteSubscriptionMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.apps.events.subscriptions.v1beta.IDeleteSubscriptionMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteSubscription as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateSubscription', () => {
        it('invokes updateSubscription without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.apps.events.subscriptions.v1beta.UpdateSubscriptionRequest()
            );
            request.subscription ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.events.subscriptions.v1beta.UpdateSubscriptionRequest', ['subscription', 'name']);
            request.subscription.name = defaultValue1;
            const expectedHeaderRequestParams = `subscription.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updateSubscription = stubLongRunningCall(expectedResponse);
        ...
        it('invokes updateSubscription without error using callback', async () => {
            ...
            client.innerApiCalls.updateSubscription = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateSubscription(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.apps.events.subscriptions.v1beta.ISubscription, protos.google.apps.events.subscriptions.v1beta.IUpdateSubscriptionMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.apps.events.subscriptions.v1beta.ISubscription, protos.google.apps.events.subscriptions.v1beta.IUpdateSubscriptionMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateSubscription as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes updateSubscription with call error', async () => {
            ...
            const expectedHeaderRequestParams = `subscription.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateSubscription = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes updateSubscription with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `subscription.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateSubscription = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateSubscription(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateSubscription as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateSubscriptionProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateSubscriptionProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateSubscriptionProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateSubscriptionProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('reactivateSubscription', () => {
        it('invokes reactivateSubscription without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.apps.events.subscriptions.v1beta.ReactivateSubscriptionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.events.subscriptions.v1beta.ReactivateSubscriptionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.reactivateSubscription = stubLongRunningCall(expectedResponse);
            const [operation] = await client.reactivateSubscription(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.reactivateSubscription as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.reactivateSubscription as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes reactivateSubscription without error using callback', async () => {
            ...
            client.innerApiCalls.reactivateSubscription = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.reactivateSubscription(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.apps.events.subscriptions.v1beta.ISubscription, protos.google.apps.events.subscriptions.v1beta.IReactivateSubscriptionMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.apps.events.subscriptions.v1beta.ISubscription, protos.google.apps.events.subscriptions.v1beta.IReactivateSubscriptionMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.reactivateSubscription as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes reactivateSubscription with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.reactivateSubscription = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.reactivateSubscription(request), expectedError);
            const actualRequest = (client.innerApiCalls.reactivateSubscription as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.reactivateSubscription as SinonStub)
        ...
        it('invokes reactivateSubscription with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.reactivateSubscription = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.reactivateSubscription(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.reactivateSubscription as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkReactivateSubscriptionProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkReactivateSubscriptionProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkReactivateSubscriptionProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkReactivateSubscriptionProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listSubscriptions', () => {
        it('invokes listSubscriptions without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.apps.events.subscriptions.v1beta.ListSubscriptionsRequest()
            );const expectedResponse = [
              generateSampleMessage(new protos.google.apps.events.subscriptions.v1beta.Subscription()),
              generateSampleMessage(new protos.google.apps.events.subscriptions.v1beta.Subscription()),
              generateSampleMessage(new protos.google.apps.events.subscriptions.v1beta.Subscription()),
            ];
        ...
        it('invokes listSubscriptionsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.apps.events.subscriptions.v1beta.Subscription[] = [];
                stream.on('data', (response: protos.google.apps.events.subscriptions.v1beta.Subscription) => {
        ...
        it('uses async iteration with listSubscriptions without error', async () => {
            ...
            const responses: protos.google.apps.events.subscriptions.v1beta.ISubscription[] = [];
