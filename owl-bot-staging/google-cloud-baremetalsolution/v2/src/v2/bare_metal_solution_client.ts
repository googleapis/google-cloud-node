...
export class BareMetalSolutionClient {
  ...
  initialize() {
    ...
    const bareMetalSolutionStubMethods =
        ['listInstances', 'getInstance', 'updateInstance', 'resetInstance', 'startInstance', 'stopInstance', 'detachLun', 'listVolumes', 'getVolume', 'updateVolume', 'resizeVolume', 'listNetworks', 'listNetworkUsage', 'getNetwork', 'updateNetwork', 'getLun', 'listLuns', 'getNfsShare', 'listNfsShares', 'updateNfsShare'];
