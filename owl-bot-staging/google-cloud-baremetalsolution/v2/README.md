...
# [Baremetalsolution: Nodejs Client][homepage]
...
* [Baremetalsolution Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/baremetalsolution/latest)
