...
describe('v1.DataCatalogClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new datacatalogModule.v1.DataCatalogClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'datacatalog.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new datacatalogModule.v1.DataCatalogClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'datacatalog.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new datacatalogModule.v1.DataCatalogClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new datacatalogModule.v1.DataCatalogClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createEntryGroup', () => {
        it('invokes createEntryGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.CreateEntryGroupRequest', ['parent']);
        ...
        it('invokes createEntryGroup without error using callback', async () => {
            ...
            client.innerApiCalls.createEntryGroup = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createEntryGroup(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datacatalog.v1.IEntryGroup|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createEntryGroup with error', async () => {
            ...
            client.innerApiCalls.createEntryGroup = stubSimpleCall(undefined, expectedError);
    ...
    describe('getEntryGroup', () => {
        it('invokes getEntryGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.GetEntryGroupRequest', ['name']);
    ...
    describe('updateEntryGroup', () => {
        it('invokes updateEntryGroup without error', async () => {
            ...
            request.entryGroup ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.UpdateEntryGroupRequest', ['entryGroup', 'name']);
        ...
        it('invokes updateEntryGroup without error using callback', async () => {
            ...
            client.innerApiCalls.updateEntryGroup = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateEntryGroup with error', async () => {
            ...
            const expectedHeaderRequestParams = `entry_group.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateEntryGroup = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteEntryGroup', () => {
        it('invokes deleteEntryGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.DeleteEntryGroupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes deleteEntryGroup without error using callback', async () => {
            ...
            client.innerApiCalls.deleteEntryGroup = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteEntryGroup with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteEntryGroup = stubSimpleCall(undefined, expectedError);
    ...
    describe('createEntry', () => {
        it('invokes createEntry without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.CreateEntryRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes createEntry without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createEntry(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datacatalog.v1.IEntry|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateEntry', () => {
        it('invokes updateEntry without error', async () => {
            ...
            request.entry ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.UpdateEntryRequest', ['entry', 'name']);
    ...
    describe('deleteEntry', () => {
        it('invokes deleteEntry without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.DeleteEntryRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('getEntry', () => {
        it('invokes getEntry without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.GetEntryRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.datacatalog.v1.Entry()
    ...
    describe('modifyEntryOverview', () => {
        it('invokes modifyEntryOverview without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.ModifyEntryOverviewRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.datacatalog.v1.EntryOverview()
            );
            client.innerApiCalls.modifyEntryOverview = stubSimpleCall(expectedResponse);
            const [response] = await client.modifyEntryOverview(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.modifyEntryOverview as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.modifyEntryOverview as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes modifyEntryOverview without error using callback', async () => {
            ...
            client.innerApiCalls.modifyEntryOverview = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.modifyEntryOverview(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datacatalog.v1.IEntryOverview|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes modifyEntryOverview with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.modifyEntryOverview = stubSimpleCall(undefined, expectedError);
    ...
    describe('modifyEntryContacts', () => {
        it('invokes modifyEntryContacts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.ModifyEntryContactsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.datacatalog.v1.Contacts()
            );
            client.innerApiCalls.modifyEntryContacts = stubSimpleCall(expectedResponse);
            const [response] = await client.modifyEntryContacts(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.modifyEntryContacts as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.modifyEntryContacts as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes modifyEntryContacts without error using callback', async () => {
            ...
            client.innerApiCalls.modifyEntryContacts = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.modifyEntryContacts(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datacatalog.v1.IContacts|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes modifyEntryContacts with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.modifyEntryContacts = stubSimpleCall(undefined, expectedError);
    ...
    describe('createTagTemplate', () => {
        it('invokes createTagTemplate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.CreateTagTemplateRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createTagTemplate as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createTagTemplate as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createTagTemplate without error using callback', async () => {
            ...
            client.innerApiCalls.createTagTemplate = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createTagTemplate(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datacatalog.v1.ITagTemplate|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createTagTemplate with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createTagTemplate = stubSimpleCall(undefined, expectedError);
    ...
    describe('getTagTemplate', () => {
        it('invokes getTagTemplate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.GetTagTemplateRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.datacatalog.v1.TagTemplate()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getTagTemplate as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getTagTemplate as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getTagTemplate without error using callback', async () => {
            ...
            client.innerApiCalls.getTagTemplate = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getTagTemplate with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getTagTemplate = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateTagTemplate', () => {
        it('invokes updateTagTemplate without error', async () => {
            ...
            request.tagTemplate ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.UpdateTagTemplateRequest', ['tagTemplate', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateTagTemplate as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateTagTemplate as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateTagTemplate without error using callback', async () => {
            ...
            client.innerApiCalls.updateTagTemplate = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateTagTemplate with error', async () => {
            ...
            const expectedHeaderRequestParams = `tag_template.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateTagTemplate = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteTagTemplate', () => {
        it('invokes deleteTagTemplate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.DeleteTagTemplateRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteTagTemplate as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteTagTemplate as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteTagTemplate without error using callback', async () => {
            ...
            client.innerApiCalls.deleteTagTemplate = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteTagTemplate with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteTagTemplate = stubSimpleCall(undefined, expectedError);
    ...
    describe('createTagTemplateField', () => {
        it('invokes createTagTemplateField without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.CreateTagTemplateFieldRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.datacatalog.v1.TagTemplateField()
            );
            client.innerApiCalls.createTagTemplateField = stubSimpleCall(expectedResponse);
            const [response] = await client.createTagTemplateField(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createTagTemplateField as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createTagTemplateField as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createTagTemplateField without error using callback', async () => {
            ...
            client.innerApiCalls.createTagTemplateField = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createTagTemplateField(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datacatalog.v1.ITagTemplateField|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createTagTemplateField with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createTagTemplateField = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createTagTemplateField(request), expectedError);
            const actualRequest = (client.innerApiCalls.createTagTemplateField as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createTagTemplateField as SinonStub)
    ...
    describe('updateTagTemplateField', () => {
        it('invokes updateTagTemplateField without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.UpdateTagTemplateFieldRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.datacatalog.v1.TagTemplateField()
            );
            client.innerApiCalls.updateTagTemplateField = stubSimpleCall(expectedResponse);
            const [response] = await client.updateTagTemplateField(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateTagTemplateField as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateTagTemplateField as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateTagTemplateField without error using callback', async () => {
            ...
            client.innerApiCalls.updateTagTemplateField = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateTagTemplateField with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateTagTemplateField = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateTagTemplateField(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateTagTemplateField as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateTagTemplateField as SinonStub)
    ...
    describe('renameTagTemplateField', () => {
        it('invokes renameTagTemplateField without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.RenameTagTemplateFieldRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.datacatalog.v1.TagTemplateField()
            );
            client.innerApiCalls.renameTagTemplateField = stubSimpleCall(expectedResponse);
            const [response] = await client.renameTagTemplateField(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.renameTagTemplateField as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.renameTagTemplateField as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes renameTagTemplateField without error using callback', async () => {
            ...
            client.innerApiCalls.renameTagTemplateField = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes renameTagTemplateField with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.renameTagTemplateField = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.renameTagTemplateField(request), expectedError);
            const actualRequest = (client.innerApiCalls.renameTagTemplateField as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.renameTagTemplateField as SinonStub)
    ...
    describe('renameTagTemplateFieldEnumValue', () => {
        it('invokes renameTagTemplateFieldEnumValue without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.RenameTagTemplateFieldEnumValueRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.datacatalog.v1.TagTemplateField()
            );
            client.innerApiCalls.renameTagTemplateFieldEnumValue = stubSimpleCall(expectedResponse);
            const [response] = await client.renameTagTemplateFieldEnumValue(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.renameTagTemplateFieldEnumValue as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.renameTagTemplateFieldEnumValue as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes renameTagTemplateFieldEnumValue without error using callback', async () => {
            ...
            client.innerApiCalls.renameTagTemplateFieldEnumValue = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes renameTagTemplateFieldEnumValue with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.renameTagTemplateFieldEnumValue = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.renameTagTemplateFieldEnumValue(request), expectedError);
            const actualRequest = (client.innerApiCalls.renameTagTemplateFieldEnumValue as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.renameTagTemplateFieldEnumValue as SinonStub)
    ...
    describe('deleteTagTemplateField', () => {
        it('invokes deleteTagTemplateField without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.DeleteTagTemplateFieldRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteTagTemplateField = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteTagTemplateField(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteTagTemplateField as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteTagTemplateField as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteTagTemplateField without error using callback', async () => {
            ...
            client.innerApiCalls.deleteTagTemplateField = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteTagTemplateField with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteTagTemplateField = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.deleteTagTemplateField(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteTagTemplateField as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteTagTemplateField as SinonStub)
    ...
    describe('createTag', () => {
        it('invokes createTag without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.CreateTagRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes createTag without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createTag(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datacatalog.v1.ITag|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateTag', () => {
        it('invokes updateTag without error', async () => {
            ...
            request.tag ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.UpdateTagRequest', ['tag', 'name']);
    ...
    describe('deleteTag', () => {
        it('invokes deleteTag without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.DeleteTagRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('starEntry', () => {
        it('invokes starEntry without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.StarEntryRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.starEntry as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.starEntry as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes starEntry without error using callback', async () => {
            ...
            client.innerApiCalls.starEntry = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.starEntry(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datacatalog.v1.IStarEntryResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('unstarEntry', () => {
        it('invokes unstarEntry without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.UnstarEntryRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.unstarEntry as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.unstarEntry as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes unstarEntry without error using callback', async () => {
            ...
            client.innerApiCalls.unstarEntry = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.unstarEntry(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datacatalog.v1.IUnstarEntryResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes unstarEntry with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.unstarEntry = stubSimpleCall(undefined, expectedError);
    ...
    describe('setConfig', () => {
        it('invokes setConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.SetConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.setConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.setConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes setConfig without error using callback', async () => {
            ...
            client.innerApiCalls.setConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.setConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datacatalog.v1.IMigrationConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('retrieveConfig', () => {
        it('invokes retrieveConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.RetrieveConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.retrieveConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.retrieveConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes retrieveConfig without error using callback', async () => {
            ...
            client.innerApiCalls.retrieveConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.retrieveConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datacatalog.v1.IOrganizationConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes retrieveConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.retrieveConfig = stubSimpleCall(undefined, expectedError);
    ...
    describe('retrieveEffectiveConfig', () => {
        it('invokes retrieveEffectiveConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.RetrieveEffectiveConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.datacatalog.v1.MigrationConfig()
            );
            client.innerApiCalls.retrieveEffectiveConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.retrieveEffectiveConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.retrieveEffectiveConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.retrieveEffectiveConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes retrieveEffectiveConfig without error using callback', async () => {
            ...
            client.innerApiCalls.retrieveEffectiveConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes retrieveEffectiveConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.retrieveEffectiveConfig = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.retrieveEffectiveConfig(request), expectedError);
            const actualRequest = (client.innerApiCalls.retrieveEffectiveConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.retrieveEffectiveConfig as SinonStub)
    ...
    describe('reconcileTags', () => {
        it('invokes reconcileTags without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.ReconcileTagsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.reconcileTags = stubLongRunningCall(expectedResponse);
            const [operation] = await client.reconcileTags(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.reconcileTags as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.reconcileTags as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes reconcileTags without error using callback', async () => {
            ...
            client.innerApiCalls.reconcileTags = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.reconcileTags(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.datacatalog.v1.IReconcileTagsResponse, protos.google.cloud.datacatalog.v1.IReconcileTagsMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.datacatalog.v1.IReconcileTagsResponse, protos.google.cloud.datacatalog.v1.IReconcileTagsMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.reconcileTags as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes reconcileTags with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.reconcileTags = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes reconcileTags with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.reconcileTags = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.reconcileTags(request);
        ...
        it('invokes checkReconcileTagsProgress without error', async () => {
            ...
            const decodedOperation = await client.checkReconcileTagsProgress(expectedResponse.name);
        ...
        it('invokes checkReconcileTagsProgress with error', async () => {
            ...
            await assert.rejects(client.checkReconcileTagsProgress(''), expectedError);
    ...
    describe('importEntries', () => {
        it('invokes importEntries without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.ImportEntriesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.importEntries = stubLongRunningCall(expectedResponse);
            const [operation] = await client.importEntries(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importEntries as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.importEntries as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes importEntries without error using callback', async () => {
            ...
            client.innerApiCalls.importEntries = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.importEntries(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.datacatalog.v1.IImportEntriesResponse, protos.google.cloud.datacatalog.v1.IImportEntriesMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.datacatalog.v1.IImportEntriesResponse, protos.google.cloud.datacatalog.v1.IImportEntriesMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importEntries as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes importEntries with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.importEntries = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes importEntries with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.importEntries = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.importEntries(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.importEntries as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkImportEntriesProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkImportEntriesProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkImportEntriesProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkImportEntriesProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('searchCatalog', () => {
        ...
        it('invokes searchCatalog without error using callback', async () => {
            ...
            client.innerApiCalls.searchCatalog = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.searchCatalog(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datacatalog.v1.ISearchCatalogResult[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes searchCatalogStream without error', async () => {
            ...
            client.descriptors.page.searchCatalog.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.searchCatalogStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.datacatalog.v1.SearchCatalogResult[] = [];
                stream.on('data', (response: protos.google.cloud.datacatalog.v1.SearchCatalogResult) => {
            ...
            assert((client.descriptors.page.searchCatalog.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.searchCatalog, request));
        });
        ...
        it('invokes searchCatalogStream with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.descriptors.page.searchCatalog.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.searchCatalogStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.datacatalog.v1.SearchCatalogResult[] = [];
                stream.on('data', (response: protos.google.cloud.datacatalog.v1.SearchCatalogResult) => {
        ...
        it('uses async iteration with searchCatalog without error', async () => {
            ...
            client.descriptors.page.searchCatalog.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with searchCatalog with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.descriptors.page.searchCatalog.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.searchCatalogAsync(request);
    ...
    describe('listEntryGroups', () => {
        it('invokes listEntryGroups without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.ListEntryGroupsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.datacatalog.v1.EntryGroup()),
              generateSampleMessage(new protos.google.cloud.datacatalog.v1.EntryGroup()),
              generateSampleMessage(new protos.google.cloud.datacatalog.v1.EntryGroup()),
            ];
        ...
        it('invokes listEntryGroupsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.datacatalog.v1.EntryGroup) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listEntries', () => {
        it('invokes listEntries without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.ListEntriesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
        ...
        it('invokes listEntriesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.datacatalog.v1.Entry) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listTags', () => {
        it('invokes listTags without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.ListTagsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
        ...
        it('invokes listTagsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.datacatalog.v1.Tag) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('Path templates', () => {
        ...
        describe('tagTemplateFieldEnumValue', () => {
            ...
            client.initialize();
            client.pathTemplates.tagTemplateFieldEnumValuePathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.tagTemplateFieldEnumValuePathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('tagTemplateFieldEnumValuePath', () => {
                const result = client.tagTemplateFieldEnumValuePath("projectValue", "locationValue", "tagTemplateValue", "tagTemplateFieldIdValue", "enumValueDisplayNameValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.tagTemplateFieldEnumValuePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromTagTemplateFieldEnumValueName', () => {
                const result = client.matchProjectFromTagTemplateFieldEnumValueName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.tagTemplateFieldEnumValuePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromTagTemplateFieldEnumValueName', () => {
                const result = client.matchLocationFromTagTemplateFieldEnumValueName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.tagTemplateFieldEnumValuePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchTagTemplateFromTagTemplateFieldEnumValueName', () => {
                const result = client.matchTagTemplateFromTagTemplateFieldEnumValueName(fakePath);
                assert.strictEqual(result, "tagTemplateValue");
                assert((client.pathTemplates.tagTemplateFieldEnumValuePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchTagTemplateFieldIdFromTagTemplateFieldEnumValueName', () => {
                const result = client.matchTagTemplateFieldIdFromTagTemplateFieldEnumValueName(fakePath);
            ...
            it('matchEnumValueDisplayNameFromTagTemplateFieldEnumValueName', () => {
                const result = client.matchEnumValueDisplayNameFromTagTemplateFieldEnumValueName(fakePath);
