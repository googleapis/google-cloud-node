...
export class PolicyTagManagerSerializationClient {
  ...
  initialize() {
    ...
    const policyTagManagerSerializationStubMethods =
        ['replaceTaxonomy', 'importTaxonomies', 'exportTaxonomies'];
 ...
 */
  ...
  replaceTaxonomy(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.replaceTaxonomy(request, options, wrappedCallback)
 ...
 */
  ...
  importTaxonomies(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.importTaxonomies(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.datacatalog.v1.IImportTaxonomiesResponse,
 ...
 */
  ...
  exportTaxonomies(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.exportTaxonomies(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.datacatalog.v1.IExportTaxonomiesResponse,
