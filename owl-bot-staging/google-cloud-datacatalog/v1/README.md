...
* [Datacatalog Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/datacatalog/latest)
* [Datacatalog Documentation](https://cloud.google.com/data-catalog/docs)
