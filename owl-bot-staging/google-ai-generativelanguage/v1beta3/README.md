...
# [Generativelanguage: Nodejs Client][homepage]
...
Generativelanguage client for Node.js
...
* [Generativelanguage Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/generativelanguage/latest)
* [Generativelanguage Documentation](https://developers.generativeai.google/)
...
1.  [Enable the Generativelanguage API][enable_api].
