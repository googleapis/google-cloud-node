...
describe('v1alpha.DiscussServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = discussserviceModule.v1alpha.DiscussServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = discussserviceModule.v1alpha.DiscussServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'generativelanguage.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new discussserviceModule.v1alpha.DiscussServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'generativelanguage.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new discussserviceModule.v1alpha.DiscussServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'generativelanguage.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new discussserviceModule.v1alpha.DiscussServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new discussserviceModule.v1alpha.DiscussServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('generateMessage', () => {
        it('invokes generateMessage without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.GenerateMessageRequest', ['model']);
        ...
        it('invokes generateMessage without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateMessage(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1alpha.IGenerateMessageResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('countMessageTokens', () => {
        it('invokes countMessageTokens without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.CountMessageTokensRequest', ['model']);
            request.model = defaultValue1;
            const expectedHeaderRequestParams = `model=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes countMessageTokens without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.countMessageTokens(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1alpha.ICountMessageTokensResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
