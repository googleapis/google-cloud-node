...
describe('v1alpha.RetrieverServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = retrieverserviceModule.v1alpha.RetrieverServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = retrieverserviceModule.v1alpha.RetrieverServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'generativelanguage.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new retrieverserviceModule.v1alpha.RetrieverServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'generativelanguage.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new retrieverserviceModule.v1alpha.RetrieverServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'generativelanguage.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new retrieverserviceModule.v1alpha.RetrieverServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new retrieverserviceModule.v1alpha.RetrieverServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createCorpus', () => {
        ...
        it('invokes createCorpus without error using callback', async () => {
            ...
            client.innerApiCalls.createCorpus = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createCorpus(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1alpha.ICorpus|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createCorpus with error', async () => {
            ...
            client.innerApiCalls.createCorpus = stubSimpleCall(undefined, expectedError);
    ...
    describe('getCorpus', () => {
        it('invokes getCorpus without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.GetCorpusRequest', ['name']);
    ...
    describe('updateCorpus', () => {
        it('invokes updateCorpus without error', async () => {
            ...
            request.corpus ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.UpdateCorpusRequest', ['corpus', 'name']);
    ...
    describe('deleteCorpus', () => {
        it('invokes deleteCorpus without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.DeleteCorpusRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('queryCorpus', () => {
        it('invokes queryCorpus without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.QueryCorpusRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.queryCorpus as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.queryCorpus as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes queryCorpus without error using callback', async () => {
            ...
            client.innerApiCalls.queryCorpus = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.queryCorpus(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1alpha.IQueryCorpusResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes queryCorpus with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.queryCorpus = stubSimpleCall(undefined, expectedError);
    ...
    describe('createDocument', () => {
        it('invokes createDocument without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.CreateDocumentRequest', ['parent']);
        ...
        it('invokes createDocument without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createDocument(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1alpha.IDocument|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getDocument', () => {
        it('invokes getDocument without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.GetDocumentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ai.generativelanguage.v1alpha.Document()
    ...
    describe('updateDocument', () => {
        it('invokes updateDocument without error', async () => {
            ...
            request.document ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.UpdateDocumentRequest', ['document', 'name']);
    ...
    describe('deleteDocument', () => {
        it('invokes deleteDocument without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.DeleteDocumentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('queryDocument', () => {
        it('invokes queryDocument without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.QueryDocumentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.queryDocument as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.queryDocument as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes queryDocument without error using callback', async () => {
            ...
            client.innerApiCalls.queryDocument = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.queryDocument(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1alpha.IQueryDocumentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes queryDocument with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.queryDocument = stubSimpleCall(undefined, expectedError);
    ...
    describe('createChunk', () => {
        it('invokes createChunk without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.CreateChunkRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createChunk as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createChunk as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createChunk without error using callback', async () => {
            ...
            client.innerApiCalls.createChunk = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createChunk(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1alpha.IChunk|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createChunk with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createChunk = stubSimpleCall(undefined, expectedError);
    ...
    describe('batchCreateChunks', () => {
        it('invokes batchCreateChunks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.BatchCreateChunksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchCreateChunks as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchCreateChunks as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes batchCreateChunks without error using callback', async () => {
            ...
            client.innerApiCalls.batchCreateChunks = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchCreateChunks(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1alpha.IBatchCreateChunksResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchCreateChunks with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchCreateChunks = stubSimpleCall(undefined, expectedError);
    ...
    describe('getChunk', () => {
        it('invokes getChunk without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.GetChunkRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ai.generativelanguage.v1alpha.Chunk()
    ...
    describe('updateChunk', () => {
        it('invokes updateChunk without error', async () => {
            ...
            request.chunk ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.UpdateChunkRequest', ['chunk', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateChunk as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateChunk as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateChunk without error using callback', async () => {
            ...
            client.innerApiCalls.updateChunk = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateChunk(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1alpha.IChunk|null) => {
        ...
        it('invokes updateChunk with error', async () => {
            ...
            const expectedHeaderRequestParams = `chunk.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateChunk = stubSimpleCall(undefined, expectedError);
    ...
    describe('batchUpdateChunks', () => {
        it('invokes batchUpdateChunks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.BatchUpdateChunksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchUpdateChunks as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchUpdateChunks as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes batchUpdateChunks without error using callback', async () => {
            ...
            client.innerApiCalls.batchUpdateChunks = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchUpdateChunks(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1alpha.IBatchUpdateChunksResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchUpdateChunks with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchUpdateChunks = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteChunk', () => {
        it('invokes deleteChunk without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.DeleteChunkRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteChunk as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteChunk as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteChunk without error using callback', async () => {
            ...
            client.innerApiCalls.deleteChunk = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteChunk(
                    request,
                    (err?: Error|null, result?: protos.google.protobuf.IEmpty|null) => {
        ...
        it('invokes deleteChunk with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteChunk = stubSimpleCall(undefined, expectedError);
    ...
    describe('batchDeleteChunks', () => {
        it('invokes batchDeleteChunks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.BatchDeleteChunksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchDeleteChunks as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchDeleteChunks as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes batchDeleteChunks without error using callback', async () => {
            ...
            client.innerApiCalls.batchDeleteChunks = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes batchDeleteChunks with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchDeleteChunks = stubSimpleCall(undefined, expectedError);
    ...
    describe('listCorpora', () => {
        it('invokes listCorpora without error', async () => {
            ...
            const request = generateSampleMessage(
              ...
              generateSampleMessage(new protos.google.ai.generativelanguage.v1alpha.Corpus()),
              generateSampleMessage(new protos.google.ai.generativelanguage.v1alpha.Corpus()),
              generateSampleMessage(new protos.google.ai.generativelanguage.v1alpha.Corpus()),
            ];
        ...
        it('invokes listCorporaStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.ai.generativelanguage.v1alpha.Corpus) => {
    ...
    describe('listDocuments', () => {
        it('invokes listDocuments without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.ListDocumentsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ai.generativelanguage.v1alpha.Document()),
              generateSampleMessage(new protos.google.ai.generativelanguage.v1alpha.Document()),
              generateSampleMessage(new protos.google.ai.generativelanguage.v1alpha.Document()),
            ];
        ...
        it('invokes listDocumentsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.ai.generativelanguage.v1alpha.Document) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listChunks', () => {
        it('invokes listChunks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.ListChunksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ai.generativelanguage.v1alpha.Chunk()),
              generateSampleMessage(new protos.google.ai.generativelanguage.v1alpha.Chunk()),
              generateSampleMessage(new protos.google.ai.generativelanguage.v1alpha.Chunk()),
            ];
        ...
        it('invokes listChunksStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.ai.generativelanguage.v1alpha.Chunk) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
