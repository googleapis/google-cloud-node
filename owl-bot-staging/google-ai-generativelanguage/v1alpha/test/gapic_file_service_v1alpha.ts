...
describe('v1alpha.FileServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = fileserviceModule.v1alpha.FileServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = fileserviceModule.v1alpha.FileServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'generativelanguage.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new fileserviceModule.v1alpha.FileServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'generativelanguage.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new fileserviceModule.v1alpha.FileServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'generativelanguage.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new fileserviceModule.v1alpha.FileServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new fileserviceModule.v1alpha.FileServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = fileserviceModule.v1alpha.FileServiceClient.port;
            assert(port);
    ...
    describe('createFile', () => {
        it('invokes createFile without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(
              new protos.google.ai.generativelanguage.v1alpha.CreateFileResponse()
            );
        ...
        it('invokes createFile without error using callback', async () => {
            ...
            client.innerApiCalls.createFile = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createFile(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1alpha.ICreateFileResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createFile with error', async () => {
            ...
            client.innerApiCalls.createFile = stubSimpleCall(undefined, expectedError);
    ...
    describe('getFile', () => {
        it('invokes getFile without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ai.generativelanguage.v1alpha.GetFileRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.GetFileRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ai.generativelanguage.v1alpha.File()
            );
        ...
        it('invokes getFile without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getFile(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1alpha.IFile|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deleteFile', () => {
        it('invokes deleteFile without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ai.generativelanguage.v1alpha.DeleteFileRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.DeleteFileRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteFile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteFile as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteFile without error using callback', async () => {
            ...
            client.innerApiCalls.deleteFile = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteFile(
                    request,
        ...
        it('invokes deleteFile with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteFile = stubSimpleCall(undefined, expectedError);
    ...
    describe('listFiles', () => {
        it('invokes listFiles without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ai.generativelanguage.v1alpha.ListFilesRequest()
            );const expectedResponse = [
              generateSampleMessage(new protos.google.ai.generativelanguage.v1alpha.File()),
              generateSampleMessage(new protos.google.ai.generativelanguage.v1alpha.File()),
              generateSampleMessage(new protos.google.ai.generativelanguage.v1alpha.File()),
            ];
        ...
        it('invokes listFilesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ai.generativelanguage.v1alpha.File[] = [];
                stream.on('data', (response: protos.google.ai.generativelanguage.v1alpha.File) => {
        ...
        it('uses async iteration with listFiles without error', async () => {
            ...
            const responses: protos.google.ai.generativelanguage.v1alpha.IFile[] = [];
