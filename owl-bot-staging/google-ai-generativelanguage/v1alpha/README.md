...
[![npm version](https://img.shields.io/npm/v/@google-cloud/generativelanguage.svg)](https://www.npmjs.org/package/@google-cloud/generativelanguage)
...
* [Generativelanguage Documentation](https://ai.google.dev/docs)
...
```bash
npm install @google-cloud/generativelanguage
```
...
For example, `npm install @google-cloud/generativelanguage@legacy-8` installs client libraries
