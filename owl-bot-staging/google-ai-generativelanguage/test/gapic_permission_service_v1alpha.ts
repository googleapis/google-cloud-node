...
describe('v1alpha.PermissionServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new permissionserviceModule.v1alpha.PermissionServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = permissionserviceModule.v1alpha.PermissionServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = permissionserviceModule.v1alpha.PermissionServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'generativelanguage.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new permissionserviceModule.v1alpha.PermissionServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'generativelanguage.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new permissionserviceModule.v1alpha.PermissionServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'generativelanguage.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new permissionserviceModule.v1alpha.PermissionServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new permissionserviceModule.v1alpha.PermissionServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createPermission', () => {
        it('invokes createPermission without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.CreatePermissionRequest', ['parent']);
        ...
        it('invokes createPermission without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createPermission(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1alpha.IPermission|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getPermission', () => {
        it('invokes getPermission without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.GetPermissionRequest', ['name']);
    ...
    describe('updatePermission', () => {
        it('invokes updatePermission without error', async () => {
            ...
            request.permission ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.UpdatePermissionRequest', ['permission', 'name']);
    ...
    describe('deletePermission', () => {
        it('invokes deletePermission without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.DeletePermissionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('transferOwnership', () => {
        it('invokes transferOwnership without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.TransferOwnershipRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes transferOwnership without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.transferOwnership(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1alpha.ITransferOwnershipResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listPermissions', () => {
        it('invokes listPermissions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.ListPermissionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ai.generativelanguage.v1alpha.Permission()),
              generateSampleMessage(new protos.google.ai.generativelanguage.v1alpha.Permission()),
              generateSampleMessage(new protos.google.ai.generativelanguage.v1alpha.Permission()),
            ];
        ...
        it('invokes listPermissionsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.ai.generativelanguage.v1alpha.Permission) => {
