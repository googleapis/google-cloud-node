...
describe('v1alpha.DiscussServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          discussserviceModule.v1alpha.DiscussServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          discussserviceModule.v1alpha.DiscussServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'generativelanguage.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new discussserviceModule.v1alpha.DiscussServiceClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'generativelanguage.example.com');
          if (saved) {
    ...
    it('has port', () => {
      const port = discussserviceModule.v1alpha.DiscussServiceClient.port;
      assert(port);
  ...
  describe('generateMessage', () => {
    it('invokes generateMessage without error', async () => {
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.ai.generativelanguage.v1alpha.GenerateMessageResponse(),
      );
    ...
    it('invokes generateMessage without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.generateMessage(
          ...
          (
            err?: Error | null,
            result?: protos.google.ai.generativelanguage.v1alpha.IGenerateMessageResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('countMessageTokens', () => {
    it('invokes countMessageTokens without error', async () => {
      ...
      const expectedHeaderRequestParams = `model=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ai.generativelanguage.v1alpha.CountMessageTokensResponse(),
      );
    ...
    it('invokes countMessageTokens without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.countMessageTokens(
          ...
          (
            err?: Error | null,
            result?: protos.google.ai.generativelanguage.v1alpha.ICountMessageTokensResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
