...
function main(parent) {
  // [START generativelanguage_v1beta_generated_PermissionService_ListPermissions_async]
  /**
  ...
  async function callListPermissions() {
    ...
    // Run request
    const iterable = await generativelanguageClient.listPermissionsAsync(request);
