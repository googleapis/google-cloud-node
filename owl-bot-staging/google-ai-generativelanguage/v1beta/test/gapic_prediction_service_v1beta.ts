...
describe('v1beta.PredictionServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = predictionserviceModule.v1beta.PredictionServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = predictionserviceModule.v1beta.PredictionServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'generativelanguage.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new predictionserviceModule.v1beta.PredictionServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'generativelanguage.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new predictionserviceModule.v1beta.PredictionServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'generativelanguage.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new predictionserviceModule.v1beta.PredictionServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new predictionserviceModule.v1beta.PredictionServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('predict', () => {
        it('invokes predict without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.PredictRequest', ['model']);
        ...
        it('invokes predict without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.predict(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1beta.IPredictResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('predictLongRunning', () => {
        it('invokes predictLongRunning without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.PredictLongRunningRequest', ['model']);
            request.model = defaultValue1;
            const expectedHeaderRequestParams = `model=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.predictLongRunning = stubLongRunningCall(expectedResponse);
            const [operation] = await client.predictLongRunning(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.predictLongRunning as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.predictLongRunning as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes predictLongRunning without error using callback', async () => {
            ...
            client.innerApiCalls.predictLongRunning = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.predictLongRunning(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.ai.generativelanguage.v1beta.IPredictLongRunningResponse, protos.google.ai.generativelanguage.v1beta.IPredictLongRunningMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.ai.generativelanguage.v1beta.IPredictLongRunningResponse, protos.google.ai.generativelanguage.v1beta.IPredictLongRunningMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.predictLongRunning as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes predictLongRunning with call error', async () => {
            ...
            const expectedHeaderRequestParams = `model=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.predictLongRunning = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes predictLongRunning with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `model=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.predictLongRunning = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.predictLongRunning(request);
        ...
        it('invokes checkPredictLongRunningProgress without error', async () => {
            ...
            const decodedOperation = await client.checkPredictLongRunningProgress(expectedResponse.name);
        ...
        it('invokes checkPredictLongRunningProgress with error', async () => {
            ...
            await assert.rejects(client.checkPredictLongRunningProgress(''), expectedError);
