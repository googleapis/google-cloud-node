...
export class GenerativeServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this.descriptors.stream = {
      streamGenerateContent: new this._gaxModule.StreamDescriptor(this._gaxModule.StreamType.SERVER_STREAMING, !!opts.fallback, /* gaxStreamingRetries: */ false)
    };
  ...
  initialize() {
    ...
    const generativeServiceStubMethods =
        ['generateContent', 'generateAnswer', 'streamGenerateContent', 'embedContent', 'batchEmbedContents', 'countTokens'];
