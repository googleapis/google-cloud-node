...
[![npm version](https://img.shields.io/npm/v/@google-cloud/configmanagement.svg)](https://www.npmjs.org/package/@google-cloud/configmanagement)
...
* [Data Lineage API Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/configmanagement/latest)
...
```bash
npm install @google-cloud/configmanagement
```
...
For example, `npm install @google-cloud/configmanagement@legacy-8` installs client libraries
...
[homepage_samples]: https://github.com/googleapis/google-cloud-node/blob/main/packages/google-cloud-datacatalog-lineage-configmanagement/samples
[homepage_changelog]: https://github.com/googleapis/google-cloud-node/blob/main/packages/google-cloud-datacatalog-lineage-configmanagement/CHANGELOG.md
[homepage]: https://github.com/googleapis/google-cloud-node/blob/main/packages/google-cloud-datacatalog-lineage-configmanagement
