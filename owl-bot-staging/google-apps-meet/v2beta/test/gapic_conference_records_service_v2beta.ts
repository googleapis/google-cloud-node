...
describe('v2beta.ConferenceRecordsServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new conferencerecordsserviceModule.v2beta.ConferenceRecordsServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = conferencerecordsserviceModule.v2beta.ConferenceRecordsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = conferencerecordsserviceModule.v2beta.ConferenceRecordsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'meet.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new conferencerecordsserviceModule.v2beta.ConferenceRecordsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'meet.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new conferencerecordsserviceModule.v2beta.ConferenceRecordsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'meet.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new conferencerecordsserviceModule.v2beta.ConferenceRecordsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new conferencerecordsserviceModule.v2beta.ConferenceRecordsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = conferencerecordsserviceModule.v2beta.ConferenceRecordsServiceClient.port;
            assert(port);
    ...
    describe('getConferenceRecord', () => {
        it('invokes getConferenceRecord without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.meet.v2beta.GetConferenceRecordRequest', ['name']);
        ...
        it('invokes getConferenceRecord without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getConferenceRecord(
                    request,
                    (err?: Error|null, result?: protos.google.apps.meet.v2beta.IConferenceRecord|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getParticipant', () => {
        it('invokes getParticipant without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.meet.v2beta.GetParticipantRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getParticipant without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getParticipant(
                    request,
                    (err?: Error|null, result?: protos.google.apps.meet.v2beta.IParticipant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getParticipantSession', () => {
        it('invokes getParticipantSession without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.meet.v2beta.GetParticipantSessionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getParticipantSession without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getParticipantSession(
                    request,
                    (err?: Error|null, result?: protos.google.apps.meet.v2beta.IParticipantSession|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getRecording', () => {
        it('invokes getRecording without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.meet.v2beta.GetRecordingRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getRecording without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getRecording(
                    request,
                    (err?: Error|null, result?: protos.google.apps.meet.v2beta.IRecording|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getTranscript', () => {
        it('invokes getTranscript without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.meet.v2beta.GetTranscriptRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getTranscript without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getTranscript(
                    request,
                    (err?: Error|null, result?: protos.google.apps.meet.v2beta.ITranscript|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getTranscriptEntry', () => {
        it('invokes getTranscriptEntry without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.meet.v2beta.GetTranscriptEntryRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getTranscriptEntry without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getTranscriptEntry(
                    request,
                    (err?: Error|null, result?: protos.google.apps.meet.v2beta.ITranscriptEntry|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listConferenceRecords', () => {
        it('invokes listConferenceRecords without error', async () => {
            ...
            const request = generateSampleMessage(
              ...
              generateSampleMessage(new protos.google.apps.meet.v2beta.ConferenceRecord()),
              generateSampleMessage(new protos.google.apps.meet.v2beta.ConferenceRecord()),
              generateSampleMessage(new protos.google.apps.meet.v2beta.ConferenceRecord()),
            ];
        ...
        it('invokes listConferenceRecordsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.apps.meet.v2beta.ConferenceRecord) => {
    ...
    describe('listParticipants', () => {
        it('invokes listParticipants without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.meet.v2beta.ListParticipantsRequest', ['parent']);
        ...
        it('invokes listParticipantsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.apps.meet.v2beta.Participant) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listParticipantSessions', () => {
        it('invokes listParticipantSessions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.meet.v2beta.ListParticipantSessionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.apps.meet.v2beta.ParticipantSession()),
              generateSampleMessage(new protos.google.apps.meet.v2beta.ParticipantSession()),
              generateSampleMessage(new protos.google.apps.meet.v2beta.ParticipantSession()),
            ];
        ...
        it('invokes listParticipantSessionsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.apps.meet.v2beta.ParticipantSession) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listRecordings', () => {
        it('invokes listRecordings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.meet.v2beta.ListRecordingsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
        ...
        it('invokes listRecordingsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.apps.meet.v2beta.Recording) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listTranscripts', () => {
        it('invokes listTranscripts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.meet.v2beta.ListTranscriptsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
        ...
        it('invokes listTranscriptsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.apps.meet.v2beta.Transcript) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listTranscriptEntries', () => {
        it('invokes listTranscriptEntries without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.meet.v2beta.ListTranscriptEntriesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.apps.meet.v2beta.TranscriptEntry()),
              generateSampleMessage(new protos.google.apps.meet.v2beta.TranscriptEntry()),
              generateSampleMessage(new protos.google.apps.meet.v2beta.TranscriptEntry()),
            ];
        ...
        it('invokes listTranscriptEntriesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.apps.meet.v2beta.TranscriptEntry) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('Path templates', () => {
        ...
        describe('member', async () => {
            ...
            await client.initialize();
            client.pathTemplates.memberPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.memberPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('memberPath', () => {
                const result = client.memberPath("spaceValue", "memberValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.memberPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchSpaceFromMemberName', () => {
                ...
                assert((client.pathTemplates.memberPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
