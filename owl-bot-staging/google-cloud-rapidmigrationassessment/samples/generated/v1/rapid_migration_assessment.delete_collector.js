...
function main(name) {
  ...
  async function callDeleteCollector() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const [operation] = await rapidmigrationassessmentClient.deleteCollector(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callDeleteCollector();
  // [END rapidmigrationassessment_v1_generated_RapidMigrationAssessment_DeleteCollector_async]
}
