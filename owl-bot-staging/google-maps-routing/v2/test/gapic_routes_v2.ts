...
describe('v2.RoutesClient', () => {
    ...
    describe('computeRoutes', () => {
        it('invokes computeRoutes without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.maps.routing.v2.ComputeRoutesRequest());
            const expectedOptions = {otherArgs: {headers: {}}};;
            const expectedResponse = generateSampleMessage(new protos.google.maps.routing.v2.ComputeRoutesResponse());
            ...
            assert((client.innerApiCalls.computeRoutes as SinonStub)
    ...
    describe('computeRouteMatrix', () => {
        it('invokes computeRouteMatrix without error', async () => {
            ...
            const expectedOptions = {otherArgs: {headers: {}}};;
            const expectedResponse = generateSampleMessage(new protos.google.maps.routing.v2.RouteMatrixElement());
            ...
            const response = await promise;
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.computeRouteMatrix as SinonStub)
