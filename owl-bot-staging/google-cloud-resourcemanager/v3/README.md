...
# [Resourcemanager: Nodejs Client][homepage]
...
* [Resourcemanager Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/resourcemanager/latest)
...
1.  [Enable the Resourcemanager API][enable_api].
