...
describe('v3.TagBindingsClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new tagbindingsModule.v3.TagBindingsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'cloudresourcemanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new tagbindingsModule.v3.TagBindingsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'cloudresourcemanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new tagbindingsModule.v3.TagBindingsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new tagbindingsModule.v3.TagBindingsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('deleteTagBinding', () => {
        it('invokes deleteTagBinding without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.resourcemanager.v3.DeleteTagBindingRequest', ['name']);
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteTagBinding as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteTagBinding as SinonStub)
    ...
    describe('listEffectiveTags', () => {
        it('invokes listEffectiveTags without error', async () => {
            ...
            const request = generateSampleMessage(
              ...
              generateSampleMessage(new protos.google.cloud.resourcemanager.v3.EffectiveTag()),
              generateSampleMessage(new protos.google.cloud.resourcemanager.v3.EffectiveTag()),
              generateSampleMessage(new protos.google.cloud.resourcemanager.v3.EffectiveTag()),
            ];
        ...
        it('invokes listEffectiveTags without error using callback', async () => {
            ...
            client.innerApiCalls.listEffectiveTags = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listEffectiveTags(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.resourcemanager.v3.IEffectiveTag[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listEffectiveTags with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listEffectiveTags = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listEffectiveTagsStream without error', async () => {
            ...
            client.descriptors.page.listEffectiveTags.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listEffectiveTagsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.resourcemanager.v3.EffectiveTag[] = [];
                stream.on('data', (response: protos.google.cloud.resourcemanager.v3.EffectiveTag) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listEffectiveTags.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listEffectiveTags, request));
        });
        ...
        it('invokes listEffectiveTagsStream with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.descriptors.page.listEffectiveTags.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listEffectiveTagsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.resourcemanager.v3.EffectiveTag[] = [];
                stream.on('data', (response: protos.google.cloud.resourcemanager.v3.EffectiveTag) => {
        ...
        it('uses async iteration with listEffectiveTags without error', async () => {
            ...
            client.descriptors.page.listEffectiveTags.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listEffectiveTags with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.descriptors.page.listEffectiveTags.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listEffectiveTagsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.resourcemanager.v3.IEffectiveTag[] = [];
                for await (const resource of iterable) {
