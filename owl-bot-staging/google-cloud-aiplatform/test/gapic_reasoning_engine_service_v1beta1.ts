...
describe('v1beta1.ReasoningEngineServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = reasoningengineserviceModule.v1beta1.ReasoningEngineServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = reasoningengineserviceModule.v1beta1.ReasoningEngineServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new reasoningengineserviceModule.v1beta1.ReasoningEngineServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new reasoningengineserviceModule.v1beta1.ReasoningEngineServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new reasoningengineserviceModule.v1beta1.ReasoningEngineServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new reasoningengineserviceModule.v1beta1.ReasoningEngineServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = reasoningengineserviceModule.v1beta1.ReasoningEngineServiceClient.port;
            assert(port);
    ...
    describe('getReasoningEngine', () => {
        it('invokes getReasoningEngine without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.GetReasoningEngineRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.GetReasoningEngineRequest', ['name']);
        ...
        it('invokes getReasoningEngine without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getReasoningEngine(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IReasoningEngine|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createReasoningEngine', () => {
        it('invokes createReasoningEngine without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.CreateReasoningEngineRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.CreateReasoningEngineRequest', ['parent']);
        ...
        it('invokes createReasoningEngine without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createReasoningEngine(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IReasoningEngine, protos.google.cloud.aiplatform.v1beta1.ICreateReasoningEngineOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IReasoningEngine, protos.google.cloud.aiplatform.v1beta1.ICreateReasoningEngineOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createReasoningEngine as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteReasoningEngine', () => {
        it('invokes deleteReasoningEngine without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.DeleteReasoningEngineRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.DeleteReasoningEngineRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listReasoningEngines', () => {
        it('invokes listReasoningEngines without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.ListReasoningEnginesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ListReasoningEnginesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ReasoningEngine()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ReasoningEngine()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ReasoningEngine()),
            ];
        ...
        it('invokes listReasoningEnginesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.ReasoningEngine[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.ReasoningEngine) => {
        ...
        it('uses async iteration with listReasoningEngines without error', async () => {
            ...
            const responses: protos.google.cloud.aiplatform.v1beta1.IReasoningEngine[] = [];
