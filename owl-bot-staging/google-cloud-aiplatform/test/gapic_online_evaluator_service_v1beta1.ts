...
describe('v1beta1.OnlineEvaluatorServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new onlineevaluatorserviceModule.v1beta1.OnlineEvaluatorServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = onlineevaluatorserviceModule.v1beta1.OnlineEvaluatorServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = onlineevaluatorserviceModule.v1beta1.OnlineEvaluatorServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new onlineevaluatorserviceModule.v1beta1.OnlineEvaluatorServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new onlineevaluatorserviceModule.v1beta1.OnlineEvaluatorServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new onlineevaluatorserviceModule.v1beta1.OnlineEvaluatorServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new onlineevaluatorserviceModule.v1beta1.OnlineEvaluatorServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = onlineevaluatorserviceModule.v1beta1.OnlineEvaluatorServiceClient.port;
            assert(port);
    ...
    describe('getOnlineEvaluator', () => {
        it('invokes getOnlineEvaluator without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.GetOnlineEvaluatorRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.GetOnlineEvaluatorRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.OnlineEvaluator()
            );
            client.innerApiCalls.getOnlineEvaluator = stubSimpleCall(expectedResponse);
            const [response] = await client.getOnlineEvaluator(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getOnlineEvaluator as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getOnlineEvaluator as SinonStub)
        ...
        it('invokes getOnlineEvaluator without error using callback', async () => {
            ...
            client.innerApiCalls.getOnlineEvaluator = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getOnlineEvaluator(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getOnlineEvaluator with error', async () => {
            ...
            client.innerApiCalls.getOnlineEvaluator = stubSimpleCall(undefined, expectedError);
    ...
    describe('createOnlineEvaluator', () => {
        it('invokes createOnlineEvaluator without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.CreateOnlineEvaluatorRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.CreateOnlineEvaluatorRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createOnlineEvaluator = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createOnlineEvaluator(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createOnlineEvaluator as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createOnlineEvaluator as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createOnlineEvaluator without error using callback', async () => {
            ...
            client.innerApiCalls.createOnlineEvaluator = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createOnlineEvaluator(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator, protos.google.cloud.aiplatform.v1beta1.ICreateOnlineEvaluatorOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator, protos.google.cloud.aiplatform.v1beta1.ICreateOnlineEvaluatorOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createOnlineEvaluator as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createOnlineEvaluator with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createOnlineEvaluator = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createOnlineEvaluator(request), expectedError);
            const actualRequest = (client.innerApiCalls.createOnlineEvaluator as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createOnlineEvaluator as SinonStub)
        ...
        it('invokes createOnlineEvaluator with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createOnlineEvaluator = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createOnlineEvaluator(request);
        ...
        it('invokes checkCreateOnlineEvaluatorProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateOnlineEvaluatorProgress(expectedResponse.name);
        ...
        it('invokes checkCreateOnlineEvaluatorProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreateOnlineEvaluatorProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('updateOnlineEvaluator', () => {
        it('invokes updateOnlineEvaluator without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.UpdateOnlineEvaluatorRequest()
            );
            request.onlineEvaluator ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.UpdateOnlineEvaluatorRequest', ['onlineEvaluator', 'name']);
            request.onlineEvaluator.name = defaultValue1;
            const expectedHeaderRequestParams = `online_evaluator.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updateOnlineEvaluator = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateOnlineEvaluator(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateOnlineEvaluator as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateOnlineEvaluator as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateOnlineEvaluator without error using callback', async () => {
            ...
            client.innerApiCalls.updateOnlineEvaluator = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateOnlineEvaluator(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator, protos.google.cloud.aiplatform.v1beta1.IUpdateOnlineEvaluatorOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator, protos.google.cloud.aiplatform.v1beta1.IUpdateOnlineEvaluatorOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateOnlineEvaluator as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes updateOnlineEvaluator with call error', async () => {
            ...
            const expectedHeaderRequestParams = `online_evaluator.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateOnlineEvaluator = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.updateOnlineEvaluator(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateOnlineEvaluator as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateOnlineEvaluator as SinonStub)
        ...
        it('invokes updateOnlineEvaluator with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `online_evaluator.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateOnlineEvaluator = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateOnlineEvaluator(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateOnlineEvaluator as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateOnlineEvaluatorProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateOnlineEvaluatorProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateOnlineEvaluatorProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateOnlineEvaluatorProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('deleteOnlineEvaluator', () => {
        it('invokes deleteOnlineEvaluator without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.DeleteOnlineEvaluatorRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.DeleteOnlineEvaluatorRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteOnlineEvaluator = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteOnlineEvaluator(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteOnlineEvaluator as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteOnlineEvaluator as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteOnlineEvaluator without error using callback', async () => {
            ...
            client.innerApiCalls.deleteOnlineEvaluator = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteOnlineEvaluator(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.aiplatform.v1beta1.IDeleteOnlineEvaluatorOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.aiplatform.v1beta1.IDeleteOnlineEvaluatorOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteOnlineEvaluator as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes deleteOnlineEvaluator with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteOnlineEvaluator = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteOnlineEvaluator(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteOnlineEvaluator as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteOnlineEvaluator as SinonStub)
        ...
        it('invokes deleteOnlineEvaluator with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteOnlineEvaluator = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteOnlineEvaluator(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteOnlineEvaluator as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteOnlineEvaluatorProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteOnlineEvaluatorProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteOnlineEvaluatorProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteOnlineEvaluatorProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('activateOnlineEvaluator', () => {
        it('invokes activateOnlineEvaluator without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.ActivateOnlineEvaluatorRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ActivateOnlineEvaluatorRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.activateOnlineEvaluator = stubLongRunningCall(expectedResponse);
            const [operation] = await client.activateOnlineEvaluator(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.activateOnlineEvaluator as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.activateOnlineEvaluator as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes activateOnlineEvaluator without error using callback', async () => {
            ...
            client.innerApiCalls.activateOnlineEvaluator = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.activateOnlineEvaluator(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator, protos.google.cloud.aiplatform.v1beta1.IActivateOnlineEvaluatorOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator, protos.google.cloud.aiplatform.v1beta1.IActivateOnlineEvaluatorOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.activateOnlineEvaluator as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes activateOnlineEvaluator with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.activateOnlineEvaluator = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.activateOnlineEvaluator(request), expectedError);
            const actualRequest = (client.innerApiCalls.activateOnlineEvaluator as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.activateOnlineEvaluator as SinonStub)
        ...
        it('invokes activateOnlineEvaluator with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.activateOnlineEvaluator = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.activateOnlineEvaluator(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.activateOnlineEvaluator as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkActivateOnlineEvaluatorProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkActivateOnlineEvaluatorProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkActivateOnlineEvaluatorProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkActivateOnlineEvaluatorProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('suspendOnlineEvaluator', () => {
        it('invokes suspendOnlineEvaluator without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.SuspendOnlineEvaluatorRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.SuspendOnlineEvaluatorRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.suspendOnlineEvaluator = stubLongRunningCall(expectedResponse);
            const [operation] = await client.suspendOnlineEvaluator(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.suspendOnlineEvaluator as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.suspendOnlineEvaluator as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes suspendOnlineEvaluator without error using callback', async () => {
            ...
            client.innerApiCalls.suspendOnlineEvaluator = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.suspendOnlineEvaluator(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator, protos.google.cloud.aiplatform.v1beta1.ISuspendOnlineEvaluatorOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator, protos.google.cloud.aiplatform.v1beta1.ISuspendOnlineEvaluatorOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.suspendOnlineEvaluator as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes suspendOnlineEvaluator with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.suspendOnlineEvaluator = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.suspendOnlineEvaluator(request), expectedError);
            const actualRequest = (client.innerApiCalls.suspendOnlineEvaluator as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.suspendOnlineEvaluator as SinonStub)
        ...
        it('invokes suspendOnlineEvaluator with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.suspendOnlineEvaluator = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.suspendOnlineEvaluator(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.suspendOnlineEvaluator as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkSuspendOnlineEvaluatorProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkSuspendOnlineEvaluatorProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkSuspendOnlineEvaluatorProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkSuspendOnlineEvaluatorProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('listOnlineEvaluators', () => {
        it('invokes listOnlineEvaluators without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.ListOnlineEvaluatorsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ListOnlineEvaluatorsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.OnlineEvaluator()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.OnlineEvaluator()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.OnlineEvaluator()),
            ];
            client.innerApiCalls.listOnlineEvaluators = stubSimpleCall(expectedResponse);
            const [response] = await client.listOnlineEvaluators(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listOnlineEvaluators as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listOnlineEvaluators as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listOnlineEvaluators without error using callback', async () => {
            ...
            client.innerApiCalls.listOnlineEvaluators = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listOnlineEvaluators(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listOnlineEvaluators with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listOnlineEvaluators = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listOnlineEvaluators(request), expectedError);
            const actualRequest = (client.innerApiCalls.listOnlineEvaluators as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listOnlineEvaluators as SinonStub)
        ...
        it('invokes listOnlineEvaluatorsStream without error', async () => {
            ...
            client.descriptors.page.listOnlineEvaluators.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listOnlineEvaluatorsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.OnlineEvaluator[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.OnlineEvaluator) => {
            ...
            assert((client.descriptors.page.listOnlineEvaluators.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listOnlineEvaluators, request));
            assert(
        ...
        it('invokes listOnlineEvaluatorsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listOnlineEvaluators.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listOnlineEvaluatorsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.OnlineEvaluator[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.OnlineEvaluator) => {
        ...
        it('uses async iteration with listOnlineEvaluators without error', async () => {
            ...
            client.descriptors.page.listOnlineEvaluators.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator[] = [];
            const iterable = client.listOnlineEvaluatorsAsync(request);
        ...
        it('uses async iteration with listOnlineEvaluators with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listOnlineEvaluators.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listOnlineEvaluatorsAsync(request);
