...
describe('v1beta1.GenAiTuningServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = genaituningserviceModule.v1beta1.GenAiTuningServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = genaituningserviceModule.v1beta1.GenAiTuningServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new genaituningserviceModule.v1beta1.GenAiTuningServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new genaituningserviceModule.v1beta1.GenAiTuningServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new genaituningserviceModule.v1beta1.GenAiTuningServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new genaituningserviceModule.v1beta1.GenAiTuningServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = genaituningserviceModule.v1beta1.GenAiTuningServiceClient.port;
            assert(port);
    ...
    describe('createTuningJob', () => {
        it('invokes createTuningJob without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.CreateTuningJobRequest()
            );
            const defaultValue1 =
            ...
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.TuningJob()
            );
        ...
        it('invokes createTuningJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createTuningJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.ITuningJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getTuningJob', () => {
        it('invokes getTuningJob without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.GetTuningJobRequest()
            );
            const defaultValue1 =
    ...
    describe('cancelTuningJob', () => {
        it('invokes cancelTuningJob without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.CancelTuningJobRequest()
            );
            const defaultValue1 =
    ...
    describe('rebaseTunedModel', () => {
        it('invokes rebaseTunedModel without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.RebaseTunedModelRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.RebaseTunedModelRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes rebaseTunedModel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.rebaseTunedModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.ITuningJob, protos.google.cloud.aiplatform.v1beta1.IRebaseTunedModelOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.ITuningJob, protos.google.cloud.aiplatform.v1beta1.IRebaseTunedModelOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.rebaseTunedModel as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listTuningJobs', () => {
        it('invokes listTuningJobs without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.ListTuningJobsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ListTuningJobsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.TuningJob()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.TuningJob()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.TuningJob()),
            ];
        ...
        it('invokes listTuningJobsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.TuningJob[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.TuningJob) => {
        ...
        it('uses async iteration with listTuningJobs without error', async () => {
            ...
            const responses: protos.google.cloud.aiplatform.v1beta1.ITuningJob[] = [];
