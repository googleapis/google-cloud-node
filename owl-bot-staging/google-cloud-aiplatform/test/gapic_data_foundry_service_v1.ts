...
describe('v1.DataFoundryServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = datafoundryserviceModule.v1.DataFoundryServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = datafoundryserviceModule.v1.DataFoundryServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new datafoundryserviceModule.v1.DataFoundryServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new datafoundryserviceModule.v1.DataFoundryServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new datafoundryserviceModule.v1.DataFoundryServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new datafoundryserviceModule.v1.DataFoundryServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = datafoundryserviceModule.v1.DataFoundryServiceClient.port;
            assert(port);
    ...
    describe('generateSyntheticData', () => {
        it('invokes generateSyntheticData without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.GenerateSyntheticDataRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.GenerateSyntheticDataRequest', ['location']);
            request.location = defaultValue1;
            const expectedHeaderRequestParams = `location=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.GenerateSyntheticDataResponse()
            );
            client.innerApiCalls.generateSyntheticData = stubSimpleCall(expectedResponse);
            const [response] = await client.generateSyntheticData(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.generateSyntheticData as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateSyntheticData as SinonStub)
        ...
        it('invokes generateSyntheticData without error using callback', async () => {
            ...
            client.innerApiCalls.generateSyntheticData = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.generateSyntheticData(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IGenerateSyntheticDataResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes generateSyntheticData with error', async () => {
            ...
            client.innerApiCalls.generateSyntheticData = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.generateSyntheticData(request), expectedError);
            const actualRequest = (client.innerApiCalls.generateSyntheticData as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateSyntheticData as SinonStub)
