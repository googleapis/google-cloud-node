...
describe('v1beta1.MigrationServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new migrationserviceModule.v1beta1.MigrationServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          migrationserviceModule.v1beta1.MigrationServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          migrationserviceModule.v1beta1.MigrationServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('invokes searchMigratableResources without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.aiplatform.v1beta1.MigratableResource(),
        ),
        generateSampleMessage(
          new protos.google.cloud.aiplatform.v1beta1.MigratableResource(),
        ),
    ...
    it('invokes searchMigratableResourcesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.aiplatform.v1beta1.MigratableResource,
          ) => {
