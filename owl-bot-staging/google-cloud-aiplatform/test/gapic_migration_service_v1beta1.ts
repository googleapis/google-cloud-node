...
describe('v1beta1.MigrationServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = migrationserviceModule.v1beta1.MigrationServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = migrationserviceModule.v1beta1.MigrationServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new migrationserviceModule.v1beta1.MigrationServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new migrationserviceModule.v1beta1.MigrationServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new migrationserviceModule.v1beta1.MigrationServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new migrationserviceModule.v1beta1.MigrationServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = migrationserviceModule.v1beta1.MigrationServiceClient.port;
            assert(port);
    ...
    describe('batchMigrateResources', () => {
        it('invokes batchMigrateResources without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.BatchMigrateResourcesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.BatchMigrateResourcesRequest', ['parent']);
        ...
        it('invokes batchMigrateResources without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchMigrateResources(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IBatchMigrateResourcesResponse, protos.google.cloud.aiplatform.v1beta1.IBatchMigrateResourcesOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IBatchMigrateResourcesResponse, protos.google.cloud.aiplatform.v1beta1.IBatchMigrateResourcesOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchMigrateResources as SinonStub)
                .getCall(0).args[0];
    ...
    describe('searchMigratableResources', () => {
        it('invokes searchMigratableResources without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.SearchMigratableResourcesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.SearchMigratableResourcesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.MigratableResource()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.MigratableResource()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.MigratableResource()),
            ];
        ...
        it('invokes searchMigratableResources without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.searchMigratableResources(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IMigratableResource[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes searchMigratableResourcesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.MigratableResource[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.MigratableResource) => {
        ...
        it('uses async iteration with searchMigratableResources without error', async () => {
            ...
            const responses: protos.google.cloud.aiplatform.v1beta1.IMigratableResource[] = [];
