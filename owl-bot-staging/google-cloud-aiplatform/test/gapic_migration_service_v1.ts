...
describe('v1.MigrationServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = migrationserviceModule.v1.MigrationServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = migrationserviceModule.v1.MigrationServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new migrationserviceModule.v1.MigrationServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new migrationserviceModule.v1.MigrationServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new migrationserviceModule.v1.MigrationServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new migrationserviceModule.v1.MigrationServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = migrationserviceModule.v1.MigrationServiceClient.port;
            assert(port);
    ...
    describe('batchMigrateResources', () => {
        it('invokes batchMigrateResources without error', async () => {
            ...
            client.innerApiCalls.batchMigrateResources = stubLongRunningCall(expectedResponse);
            const [operation] = await client.batchMigrateResources(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchMigrateResources as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchMigrateResources as SinonStub)
        ...
        it('invokes batchMigrateResources without error using callback', async () => {
            ...
            client.innerApiCalls.batchMigrateResources = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchMigrateResources(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IBatchMigrateResourcesResponse, protos.google.cloud.aiplatform.v1.IBatchMigrateResourcesOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IBatchMigrateResourcesResponse, protos.google.cloud.aiplatform.v1.IBatchMigrateResourcesOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchMigrateResources as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkBatchMigrateResourcesProgress without error', async () => {
            ...
            const decodedOperation = await client.checkBatchMigrateResourcesProgress(expectedResponse.name);
        ...
        it('invokes checkBatchMigrateResourcesProgress with error', async () => {
            ...
            await assert.rejects(client.checkBatchMigrateResourcesProgress(''), expectedError);
    ...
    describe('searchMigratableResources', () => {
        it('invokes searchMigratableResources without error', async () => {
            ...
            client.innerApiCalls.searchMigratableResources = stubSimpleCall(expectedResponse);
            const [response] = await client.searchMigratableResources(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.searchMigratableResources as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.searchMigratableResources as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes searchMigratableResources without error using callback', async () => {
            ...
            client.innerApiCalls.searchMigratableResources = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.searchMigratableResources(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IMigratableResource[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes searchMigratableResourcesStream without error', async () => {
            ...
            client.descriptors.page.searchMigratableResources.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.searchMigratableResourcesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.MigratableResource[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.MigratableResource) => {
            ...
            assert((client.descriptors.page.searchMigratableResources.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.searchMigratableResources, request));
            assert(
                (client.descriptors.page.searchMigratableResources.createStream as SinonStub)
        ...
        it('uses async iteration with searchMigratableResources without error', async () => {
            ...
            client.descriptors.page.searchMigratableResources.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.aiplatform.v1.IMigratableResource[] = [];
            ...
            assert.deepStrictEqual(
                (client.descriptors.page.searchMigratableResources.asyncIterate as SinonStub)
