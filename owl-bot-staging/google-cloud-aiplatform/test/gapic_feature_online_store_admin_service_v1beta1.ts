...
describe('v1beta1.FeatureOnlineStoreAdminServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = featureonlinestoreadminserviceModule.v1beta1.FeatureOnlineStoreAdminServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = featureonlinestoreadminserviceModule.v1beta1.FeatureOnlineStoreAdminServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new featureonlinestoreadminserviceModule.v1beta1.FeatureOnlineStoreAdminServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new featureonlinestoreadminserviceModule.v1beta1.FeatureOnlineStoreAdminServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new featureonlinestoreadminserviceModule.v1beta1.FeatureOnlineStoreAdminServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new featureonlinestoreadminserviceModule.v1beta1.FeatureOnlineStoreAdminServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = featureonlinestoreadminserviceModule.v1beta1.FeatureOnlineStoreAdminServiceClient.port;
            assert(port);
    ...
    describe('getFeatureOnlineStore', () => {
        it('invokes getFeatureOnlineStore without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.GetFeatureOnlineStoreRequest()
            );
            const defaultValue1 =
        ...
        it('invokes getFeatureOnlineStore without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getFeatureOnlineStore(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IFeatureOnlineStore|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getFeatureView', () => {
        it('invokes getFeatureView without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.GetFeatureViewRequest()
            );
            const defaultValue1 =
        ...
        it('invokes getFeatureView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getFeatureView(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IFeatureView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('syncFeatureView', () => {
        it('invokes syncFeatureView without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.SyncFeatureViewRequest()
            );
            const defaultValue1 =
        ...
        it('invokes syncFeatureView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.syncFeatureView(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.ISyncFeatureViewResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getFeatureViewSync', () => {
        it('invokes getFeatureViewSync without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.GetFeatureViewSyncRequest()
            );
            const defaultValue1 =
        ...
        it('invokes getFeatureViewSync without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getFeatureViewSync(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IFeatureViewSync|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createFeatureOnlineStore', () => {
        it('invokes createFeatureOnlineStore without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.CreateFeatureOnlineStoreRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.CreateFeatureOnlineStoreRequest', ['parent']);
        ...
        it('invokes createFeatureOnlineStore without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createFeatureOnlineStore(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IFeatureOnlineStore, protos.google.cloud.aiplatform.v1beta1.ICreateFeatureOnlineStoreOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IFeatureOnlineStore, protos.google.cloud.aiplatform.v1beta1.ICreateFeatureOnlineStoreOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createFeatureOnlineStore as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateFeatureOnlineStore', () => {
        it('invokes updateFeatureOnlineStore without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.UpdateFeatureOnlineStoreRequest()
            );
            request.featureOnlineStore ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.UpdateFeatureOnlineStoreRequest', ['featureOnlineStore', 'name']);
        ...
        it('invokes updateFeatureOnlineStore without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updateFeatureOnlineStore(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IFeatureOnlineStore, protos.google.cloud.aiplatform.v1beta1.IUpdateFeatureOnlineStoreOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IFeatureOnlineStore, protos.google.cloud.aiplatform.v1beta1.IUpdateFeatureOnlineStoreOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateFeatureOnlineStore as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteFeatureOnlineStore', () => {
        it('invokes deleteFeatureOnlineStore without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.DeleteFeatureOnlineStoreRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.DeleteFeatureOnlineStoreRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createFeatureView', () => {
        it('invokes createFeatureView without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.CreateFeatureViewRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.CreateFeatureViewRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createFeatureView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createFeatureView(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IFeatureView, protos.google.cloud.aiplatform.v1beta1.ICreateFeatureViewOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IFeatureView, protos.google.cloud.aiplatform.v1beta1.ICreateFeatureViewOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createFeatureView as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateFeatureView', () => {
        it('invokes updateFeatureView without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.UpdateFeatureViewRequest()
            );
            request.featureView ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.UpdateFeatureViewRequest', ['featureView', 'name']);
        ...
        it('invokes updateFeatureView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updateFeatureView(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IFeatureView, protos.google.cloud.aiplatform.v1beta1.IUpdateFeatureViewOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IFeatureView, protos.google.cloud.aiplatform.v1beta1.IUpdateFeatureViewOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateFeatureView as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteFeatureView', () => {
        it('invokes deleteFeatureView without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.DeleteFeatureViewRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.DeleteFeatureViewRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listFeatureOnlineStores', () => {
        it('invokes listFeatureOnlineStores without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.ListFeatureOnlineStoresRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ListFeatureOnlineStoresRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.FeatureOnlineStore()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.FeatureOnlineStore()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.FeatureOnlineStore()),
            ];
        ...
        it('invokes listFeatureOnlineStoresStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.FeatureOnlineStore[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.FeatureOnlineStore) => {
        ...
        it('uses async iteration with listFeatureOnlineStores without error', async () => {
            ...
            const responses: protos.google.cloud.aiplatform.v1beta1.IFeatureOnlineStore[] = [];
    ...
    describe('listFeatureViews', () => {
        it('invokes listFeatureViews without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.ListFeatureViewsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ListFeatureViewsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.FeatureView()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.FeatureView()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.FeatureView()),
            ];
        ...
        it('invokes listFeatureViewsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.FeatureView[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.FeatureView) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listFeatureViews without error', async () => {
            ...
            const responses: protos.google.cloud.aiplatform.v1beta1.IFeatureView[] = [];
    ...
    describe('listFeatureViewSyncs', () => {
        it('invokes listFeatureViewSyncs without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.ListFeatureViewSyncsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ListFeatureViewSyncsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.FeatureViewSync()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.FeatureViewSync()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.FeatureViewSync()),
            ];
        ...
        it('invokes listFeatureViewSyncsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.FeatureViewSync[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.FeatureViewSync) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listFeatureViewSyncs without error', async () => {
            ...
            const responses: protos.google.cloud.aiplatform.v1beta1.IFeatureViewSync[] = [];
