  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          vizierserviceModule.v1beta1.VizierServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          vizierserviceModule.v1beta1.VizierServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new vizierserviceModule.v1beta1.VizierServiceClient({
          universe_domain: 'example.com',
    ...
    it('invokes createStudy without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createStudy(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IStudy | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createTrial without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createTrial(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.ITrial | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listOptimalTrials without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listOptimalTrials(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IListOptimalTrialsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listStudies', () => {
    ...
    it('invokes listStudiesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.aiplatform.v1beta1.Study) => {
  ...
  describe('listTrials', () => {
    ...
    it('invokes listTrialsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.aiplatform.v1beta1.Trial) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
