...
describe('v1beta1.SessionServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          sessionserviceModule.v1beta1.SessionServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          sessionserviceModule.v1beta1.SessionServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new sessionserviceModule.v1beta1.SessionServiceClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'aiplatform.example.com');
          if (saved) {
    ...
    it('invokes getSession without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getSession(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.ISession | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes appendEvent without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.appendEvent(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IAppendEventResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
        ...
        client.createSession(
          ...
          (
            ...
            result?: LROperation<
              ...
              protos.google.cloud.aiplatform.v1beta1.ICreateSessionOperationMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
  ...
  describe('listSessions', () => {
    ...
    it('invokes listSessionsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.aiplatform.v1beta1.Session) => {
  ...
  describe('listEvents', () => {
    it('invokes listEvents without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.aiplatform.v1beta1.SessionEvent(),
        ),
        generateSampleMessage(
          new protos.google.cloud.aiplatform.v1beta1.SessionEvent(),
        ),
    ...
    it('invokes listEventsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.aiplatform.v1beta1.SessionEvent) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
