...
describe('v1beta1.PredictionServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new predictionserviceModule.v1beta1.PredictionServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new predictionserviceModule.v1beta1.PredictionServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('predict', () => {
        ...
        it('invokes predict without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.predict(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IPredictResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes directPredict without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.directPredict(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IDirectPredictResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes directRawPredict without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.directRawPredict(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IDirectRawPredictResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('explain', () => {
        ...
        it('invokes explain without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.explain(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IExplainResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('countTokens', () => {
        it('invokes countTokens without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.CountTokensRequest()
            );
            const defaultValue1 =
        ...
        it('invokes countTokens without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.countTokens(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.ICountTokensResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateContent', () => {
        it('invokes generateContent without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.GenerateContentRequest()
            );
            const defaultValue1 =
        ...
        it('invokes generateContent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateContent(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IGenerateContentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('embedContent', () => {
        it('invokes embedContent without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.EmbedContentRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.EmbedContentRequest', ['model']);
            request.model = defaultValue1;
            const expectedHeaderRequestParams = `model=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.EmbedContentResponse()
            );
        ...
        it('invokes embedContent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.embedContent(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IEmbedContentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('streamRawPredict', () => {
        it('invokes streamRawPredict without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.StreamRawPredictRequest()
            );
            const defaultValue1 =
    ...
    describe('chatCompletions', () => {
        it('invokes chatCompletions without error', async () => {
            const client = new predictionserviceModule.v1beta1.PredictionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.ChatCompletionsRequest()
            );
            const defaultValue1 =
            ...
            client.innerApiCalls.chatCompletions = stubServerStreamingCall(expectedResponse);
            ...
            const response = await promise;
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.chatCompletions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.chatCompletions as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes chatCompletions without error and gaxServerStreamingRetries enabled', async () => {
            const client = new predictionserviceModule.v1beta1.PredictionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
              gaxServerStreamingRetries: true
        ...
        it('invokes chatCompletions with error', async () => {
            const client = new predictionserviceModule.v1beta1.PredictionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
        ...
        it('invokes chatCompletions with closed client', async () => {
            const client = new predictionserviceModule.v1beta1.PredictionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedError = new Error('The client has already been closed.');
            client.close().catch(err => {throw err});
            const stream = client.chatCompletions(request, {retryRequestOptions: {noResponseRetries: 0}});
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.api.HttpBody) => {
                    resolve(response);
                });
    ...
    describe('streamDirectPredict', () => {
        it('invokes streamDirectPredict without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.StreamDirectPredictRequest()
            );
            
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.StreamDirectPredictResponse()
            );
    ...
    describe('streamDirectRawPredict', () => {
        it('invokes streamDirectRawPredict without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.StreamDirectRawPredictRequest()
            );
            
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.StreamDirectRawPredictResponse()
            );
            ...
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.StreamDirectRawPredictResponse) => {
                    resolve(response);
                });
                stream.on('error', (err: Error) => {
                    reject(err);
    ...
    describe('streamingRawPredict', () => {
        it('invokes streamingRawPredict without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.StreamingRawPredictResponse) => {
                    resolve(response);
                });
                stream.on('error', (err: Error) => {
                    reject(err);
