...
describe('v1.ModelServiceClient', () => {
    ...
    describe('listModelVersionCheckpoints', () => {
        it('invokes listModelVersionCheckpoints without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.ListModelVersionCheckpointsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListModelVersionCheckpointsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.ModelVersionCheckpoint()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.ModelVersionCheckpoint()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.ModelVersionCheckpoint()),
            ];
        ...
        it('invokes listModelVersionCheckpoints without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listModelVersionCheckpoints(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IModelVersionCheckpoint[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listModelVersionCheckpointsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.ModelVersionCheckpoint[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.ModelVersionCheckpoint) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
