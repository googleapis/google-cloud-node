...
import * as vertexragserviceModule from '../src';
...
describe('v1beta1.VertexRagServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new vertexragserviceModule.v1beta1.VertexRagServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = vertexragserviceModule.v1beta1.VertexRagServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = vertexragserviceModule.v1beta1.VertexRagServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new vertexragserviceModule.v1beta1.VertexRagServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new vertexragserviceModule.v1beta1.VertexRagServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new vertexragserviceModule.v1beta1.VertexRagServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new vertexragserviceModule.v1beta1.VertexRagServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = vertexragserviceModule.v1beta1.VertexRagServiceClient.port;
            assert(port);
    ...
    describe('retrieveContexts', () => {
        it('invokes retrieveContexts without error', async () => {
            const client = new vertexragserviceModule.v1beta1.VertexRagServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.RetrieveContextsRequest()
            );
            const defaultValue1 =
            ...
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.RetrieveContextsResponse()
            );
            client.innerApiCalls.retrieveContexts = stubSimpleCall(expectedResponse);
            const [response] = await client.retrieveContexts(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.retrieveContexts as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.retrieveContexts as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes retrieveContexts without error using callback', async () => {
            const client = new vertexragserviceModule.v1beta1.VertexRagServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.retrieveContexts = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.retrieveContexts(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IRetrieveContextsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes retrieveContexts with error', async () => {
            const client = new vertexragserviceModule.v1beta1.VertexRagServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.retrieveContexts = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes retrieveContexts with closed client', async () => {
            const client = new vertexragserviceModule.v1beta1.VertexRagServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('augmentPrompt', () => {
        it('invokes augmentPrompt without error', async () => {
            const client = new vertexragserviceModule.v1beta1.VertexRagServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.AugmentPromptRequest()
            );
            const defaultValue1 =
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.AugmentPromptResponse()
            );
            client.innerApiCalls.augmentPrompt = stubSimpleCall(expectedResponse);
            const [response] = await client.augmentPrompt(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.augmentPrompt as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.augmentPrompt as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes augmentPrompt without error using callback', async () => {
            const client = new vertexragserviceModule.v1beta1.VertexRagServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.augmentPrompt = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.augmentPrompt(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IAugmentPromptResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes augmentPrompt with error', async () => {
            const client = new vertexragserviceModule.v1beta1.VertexRagServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.augmentPrompt = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes augmentPrompt with closed client', async () => {
            const client = new vertexragserviceModule.v1beta1.VertexRagServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('corroborateContent', () => {
        it('invokes corroborateContent without error', async () => {
            const client = new vertexragserviceModule.v1beta1.VertexRagServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.CorroborateContentRequest()
            );
            const defaultValue1 =
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.CorroborateContentResponse()
            );
            client.innerApiCalls.corroborateContent = stubSimpleCall(expectedResponse);
            const [response] = await client.corroborateContent(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.corroborateContent as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.corroborateContent as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes corroborateContent without error using callback', async () => {
            const client = new vertexragserviceModule.v1beta1.VertexRagServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.corroborateContent = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.corroborateContent(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.ICorroborateContentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes corroborateContent with error', async () => {
            const client = new vertexragserviceModule.v1beta1.VertexRagServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.corroborateContent = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes corroborateContent with closed client', async () => {
            const client = new vertexragserviceModule.v1beta1.VertexRagServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('askContexts', () => {
        it('invokes askContexts without error', async () => {
            const client = new vertexragserviceModule.v1beta1.VertexRagServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.AskContextsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.AskContextsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.AskContextsResponse()
            );
            client.innerApiCalls.askContexts = stubSimpleCall(expectedResponse);
            const [response] = await client.askContexts(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.askContexts as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.askContexts as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes askContexts without error using callback', async () => {
            const client = new vertexragserviceModule.v1beta1.VertexRagServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.askContexts = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.askContexts(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IAskContextsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes askContexts with error', async () => {
            const client = new vertexragserviceModule.v1beta1.VertexRagServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.askContexts = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.askContexts(request), expectedError);
            const actualRequest = (client.innerApiCalls.askContexts as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.askContexts as SinonStub)
        ...
        it('invokes askContexts with closed client', async () => {
            const client = new vertexragserviceModule.v1beta1.VertexRagServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('asyncRetrieveContexts', () => {
        it('invokes asyncRetrieveContexts without error', async () => {
            const client = new vertexragserviceModule.v1beta1.VertexRagServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.AsyncRetrieveContextsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.AsyncRetrieveContextsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.asyncRetrieveContexts = stubLongRunningCall(expectedResponse);
            const [operation] = await client.asyncRetrieveContexts(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.asyncRetrieveContexts as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.asyncRetrieveContexts as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes asyncRetrieveContexts without error using callback', async () => {
            const client = new vertexragserviceModule.v1beta1.VertexRagServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.asyncRetrieveContexts = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.asyncRetrieveContexts(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IAsyncRetrieveContextsResponse, protos.google.cloud.aiplatform.v1beta1.IAsyncRetrieveContextsOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IAsyncRetrieveContextsResponse, protos.google.cloud.aiplatform.v1beta1.IAsyncRetrieveContextsOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.asyncRetrieveContexts as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes asyncRetrieveContexts with call error', async () => {
            const client = new vertexragserviceModule.v1beta1.VertexRagServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.asyncRetrieveContexts = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.asyncRetrieveContexts(request), expectedError);
            const actualRequest = (client.innerApiCalls.asyncRetrieveContexts as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.asyncRetrieveContexts as SinonStub)
        ...
        it('invokes asyncRetrieveContexts with LRO error', async () => {
            const client = new vertexragserviceModule.v1beta1.VertexRagServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.asyncRetrieveContexts = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.asyncRetrieveContexts(request);
        ...
        it('invokes checkAsyncRetrieveContextsProgress without error', async () => {
            const client = new vertexragserviceModule.v1beta1.VertexRagServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const decodedOperation = await client.checkAsyncRetrieveContextsProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkAsyncRetrieveContextsProgress with error', async () => {
            const client = new vertexragserviceModule.v1beta1.VertexRagServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            await assert.rejects(client.checkAsyncRetrieveContextsProgress(''), expectedError);
