...
describe('v1beta1.EndpointServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new endpointserviceModule.v1beta1.EndpointServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new endpointserviceModule.v1beta1.EndpointServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('updateEndpoint', () => {
        it('invokes updateEndpoint without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.UpdateEndpointRequest()
            );
            request.endpoint ??= {};
            const defaultValue1 =
    ...
    describe('fetchPublisherModelConfig', () => {
        it('invokes fetchPublisherModelConfig without error', async () => {
            const client = new endpointserviceModule.v1beta1.EndpointServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.FetchPublisherModelConfigRequest()
            );
            const defaultValue1 =
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.PublisherModelConfig()
            );
            client.innerApiCalls.fetchPublisherModelConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.fetchPublisherModelConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.fetchPublisherModelConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.fetchPublisherModelConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes fetchPublisherModelConfig without error using callback', async () => {
            const client = new endpointserviceModule.v1beta1.EndpointServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.fetchPublisherModelConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.fetchPublisherModelConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IPublisherModelConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes fetchPublisherModelConfig with error', async () => {
            const client = new endpointserviceModule.v1beta1.EndpointServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.fetchPublisherModelConfig = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes fetchPublisherModelConfig with closed client', async () => {
            const client = new endpointserviceModule.v1beta1.EndpointServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('createEndpoint', () => {
        it('invokes createEndpoint without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.CreateEndpointRequest()
            );
            const defaultValue1 =
    ...
    describe('updateEndpointLongRunning', () => {
        it('invokes updateEndpointLongRunning without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.UpdateEndpointLongRunningRequest()
            );
            request.endpoint ??= {};
            const defaultValue1 =
        ...
        it('invokes updateEndpointLongRunning without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updateEndpointLongRunning(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IEndpoint, protos.google.cloud.aiplatform.v1beta1.IUpdateEndpointOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IEndpoint, protos.google.cloud.aiplatform.v1beta1.IUpdateEndpointOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateEndpointLongRunning as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteEndpoint', () => {
        it('invokes deleteEndpoint without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.DeleteEndpointRequest()
            );
            const defaultValue1 =
    ...
    describe('deployModel', () => {
        it('invokes deployModel without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.DeployModelRequest()
            );
            const defaultValue1 =
    ...
    describe('undeployModel', () => {
        it('invokes undeployModel without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.UndeployModelRequest()
            );
            const defaultValue1 =
    ...
    describe('mutateDeployedModel', () => {
        it('invokes mutateDeployedModel without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.MutateDeployedModelRequest()
            );
            const defaultValue1 =
        ...
        it('invokes mutateDeployedModel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateDeployedModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IMutateDeployedModelResponse, protos.google.cloud.aiplatform.v1beta1.IMutateDeployedModelOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IMutateDeployedModelResponse, protos.google.cloud.aiplatform.v1beta1.IMutateDeployedModelOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.mutateDeployedModel as SinonStub)
                .getCall(0).args[0];
    ...
    describe('setPublisherModelConfig', () => {
        it('invokes setPublisherModelConfig without error', async () => {
            const client = new endpointserviceModule.v1beta1.EndpointServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.SetPublisherModelConfigRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.SetPublisherModelConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.setPublisherModelConfig = stubLongRunningCall(expectedResponse);
            const [operation] = await client.setPublisherModelConfig(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.setPublisherModelConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.setPublisherModelConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes setPublisherModelConfig without error using callback', async () => {
            const client = new endpointserviceModule.v1beta1.EndpointServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.setPublisherModelConfig = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.setPublisherModelConfig(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IPublisherModelConfig, protos.google.cloud.aiplatform.v1beta1.ISetPublisherModelConfigOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IPublisherModelConfig, protos.google.cloud.aiplatform.v1beta1.ISetPublisherModelConfigOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.setPublisherModelConfig as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes setPublisherModelConfig with call error', async () => {
            const client = new endpointserviceModule.v1beta1.EndpointServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.setPublisherModelConfig = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.setPublisherModelConfig(request), expectedError);
            const actualRequest = (client.innerApiCalls.setPublisherModelConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.setPublisherModelConfig as SinonStub)
        ...
        it('invokes setPublisherModelConfig with LRO error', async () => {
            const client = new endpointserviceModule.v1beta1.EndpointServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.setPublisherModelConfig = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.setPublisherModelConfig(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.setPublisherModelConfig as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkSetPublisherModelConfigProgress without error', async () => {
            const client = new endpointserviceModule.v1beta1.EndpointServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkSetPublisherModelConfigProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkSetPublisherModelConfigProgress with error', async () => {
            const client = new endpointserviceModule.v1beta1.EndpointServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkSetPublisherModelConfigProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listEndpoints', () => {
        it('invokes listEndpoints without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.ListEndpointsRequest()
            );
            const defaultValue1 =
