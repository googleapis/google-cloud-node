...
export class IndexServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const createIndexResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.Index') as gax.protobuf.Type;
    const createIndexMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.CreateIndexOperationMetadata') as gax.protobuf.Type;
    const updateIndexResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.Index') as gax.protobuf.Type;
    const updateIndexMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.UpdateIndexOperationMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.aiplatform.v1.IndexService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.indexServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.aiplatform.v1.IndexService') :
 ...
 */
  getIndex(
      ...
      Promise<[
        ...
        protos.google.cloud.aiplatform.v1.IGetIndexRequest|undefined, {}|undefined
      ]>;
  getIndex(
      request: protos.google.cloud.aiplatform.v1.IGetIndexRequest,
      options: CallOptions,
 ...
 */
  upsertDatapoints(
      ...
      Promise<[
        ...
        protos.google.cloud.aiplatform.v1.IUpsertDatapointsRequest|undefined, {}|undefined
      ]>;
  upsertDatapoints(
      request: protos.google.cloud.aiplatform.v1.IUpsertDatapointsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1.IUpsertDatapointsResponse,
          protos.google.cloud.aiplatform.v1.IUpsertDatapointsRequest|null|undefined,
          {}|null|undefined>): void;
  upsertDatapoints(
      request: protos.google.cloud.aiplatform.v1.IUpsertDatapointsRequest,
      callback: Callback<
 ...
 */
  removeDatapoints(
      ...
      Promise<[
        ...
        protos.google.cloud.aiplatform.v1.IRemoveDatapointsRequest|undefined, {}|undefined
      ]>;
  removeDatapoints(
      request: protos.google.cloud.aiplatform.v1.IRemoveDatapointsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1.IRemoveDatapointsResponse,
          protos.google.cloud.aiplatform.v1.IRemoveDatapointsRequest|null|undefined,
          {}|null|undefined>): void;
  removeDatapoints(
      request: protos.google.cloud.aiplatform.v1.IRemoveDatapointsRequest,
      callback: Callback<
 ...
 */
  async checkCreateIndexProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1.Index, protos.google.cloud.aiplatform.v1.CreateIndexOperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1.Index, protos.google.cloud.aiplatform.v1.CreateIndexOperationMetadata>;
  }
/**
 * Updates an Index.
 *
 ...
 */
  async checkUpdateIndexProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1.Index, protos.google.cloud.aiplatform.v1.UpdateIndexOperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1.Index, protos.google.cloud.aiplatform.v1.UpdateIndexOperationMetadata>;
  }
/**
 * Deletes an Index.
 ...
 */
  ...
  listIndexes(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.aiplatform.v1.IIndex>): void;
  listIndexes(
      request: protos.google.cloud.aiplatform.v1.IListIndexesRequest,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1.IListIndexesRequest,
