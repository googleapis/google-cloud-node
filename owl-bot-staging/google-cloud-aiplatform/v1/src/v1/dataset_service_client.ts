...
export class DatasetServiceClient {
  ...
  initialize() {
    ...
    const datasetServiceStubMethods =
        ['createDataset', 'getDataset', 'updateDataset', 'listDatasets', 'deleteDataset', 'importData', 'exportData', 'listDataItems', 'searchDataItems', 'listSavedQueries', 'deleteSavedQuery', 'getAnnotationSpec', 'listAnnotations'];
