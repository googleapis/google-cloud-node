...
export class DatasetServiceClient {
  ...
  initialize() {
    ...
    const datasetServiceStubMethods =
        ['createDataset', 'getDataset', 'updateDataset', 'listDatasets', 'deleteDataset', 'importData', 'exportData', 'createDatasetVersion', 'deleteDatasetVersion', 'getDatasetVersion', 'listDatasetVersions', 'restoreDatasetVersion', 'listDataItems', 'searchDataItems', 'listSavedQueries', 'deleteSavedQuery', 'getAnnotationSpec', 'listAnnotations'];
