...
export class MigrationServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const batchMigrateResourcesResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.BatchMigrateResourcesResponse') as gax.protobuf.Type;
    const batchMigrateResourcesMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.BatchMigrateResourcesOperationMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.aiplatform.v1.MigrationService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.migrationServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.aiplatform.v1.MigrationService') :
