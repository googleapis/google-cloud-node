...
function main(datasetVersion, updateMask) {
  ...
  async function callUpdateDatasetVersion() {
    // Construct request
    const request = {
      datasetVersion,
      updateMask,
    ...
    // Run request
    const response = await aiplatformClient.updateDatasetVersion(request);
    console.log(response);
  }

  callUpdateDatasetVersion();
