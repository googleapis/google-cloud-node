...
describe('v1.GenAiCacheServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = genaicacheserviceModule.v1.GenAiCacheServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = genaicacheserviceModule.v1.GenAiCacheServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new genaicacheserviceModule.v1.GenAiCacheServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new genaicacheserviceModule.v1.GenAiCacheServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new genaicacheserviceModule.v1.GenAiCacheServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new genaicacheserviceModule.v1.GenAiCacheServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = genaicacheserviceModule.v1.GenAiCacheServiceClient.port;
            assert(port);
    ...
    describe('createCachedContent', () => {
        it('invokes createCachedContent without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.CreateCachedContentRequest()
            );
            const defaultValue1 =
            ...
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.CachedContent()
            );
            ...
            const actualRequest = (client.innerApiCalls.createCachedContent as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createCachedContent as SinonStub)
        ...
        it('invokes createCachedContent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createCachedContent(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.ICachedContent|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getCachedContent', () => {
        it('invokes getCachedContent without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.GetCachedContentRequest()
            );
            const defaultValue1 =
    ...
    describe('updateCachedContent', () => {
        it('invokes updateCachedContent without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.UpdateCachedContentRequest()
            );
    ...
    describe('deleteCachedContent', () => {
        it('invokes deleteCachedContent without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.DeleteCachedContentRequest()
            );
            const defaultValue1 =
    ...
    describe('listCachedContents', () => {
        it('invokes listCachedContents without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.ListCachedContentsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListCachedContentsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.CachedContent()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.CachedContent()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.CachedContent()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listCachedContents as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listCachedContents as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listCachedContentsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.CachedContent[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.CachedContent) => {
        ...
        it('uses async iteration with listCachedContents without error', async () => {
            ...
            const responses: protos.google.cloud.aiplatform.v1.ICachedContent[] = [];
