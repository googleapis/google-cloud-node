...
describe('v1.FeaturestoreServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = featurestoreserviceModule.v1.FeaturestoreServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = featurestoreserviceModule.v1.FeaturestoreServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new featurestoreserviceModule.v1.FeaturestoreServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new featurestoreserviceModule.v1.FeaturestoreServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new featurestoreserviceModule.v1.FeaturestoreServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new featurestoreserviceModule.v1.FeaturestoreServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getFeaturestore', () => {
        it('invokes getFeaturestore without error', async () => {
            ...
            const actualRequest = (client.innerApiCalls.getFeaturestore as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getFeaturestore as SinonStub)
        ...
        it('invokes getFeaturestore without error using callback', async () => {
            ...
            client.innerApiCalls.getFeaturestore = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getFeaturestore(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IFeaturestore|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getEntityType without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getEntityType(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IEntityType|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getFeature', () => {
        ...
        it('invokes getFeature without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getFeature(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IFeature|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateFeature', () => {
        ...
        it('invokes updateFeature without error using callback', async () => {
            ...
            client.innerApiCalls.updateFeature = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
    ...
    describe('createFeaturestore', () => {
        it('invokes createFeaturestore without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.CreateFeaturestoreRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createFeaturestore = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createFeaturestore(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createFeaturestore as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createFeaturestore as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createFeaturestore without error using callback', async () => {
            ...
            client.innerApiCalls.createFeaturestore = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createFeaturestore(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IFeaturestore, protos.google.cloud.aiplatform.v1.ICreateFeaturestoreOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IFeaturestore, protos.google.cloud.aiplatform.v1.ICreateFeaturestoreOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createFeaturestore as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkCreateFeaturestoreProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateFeaturestoreProgress(expectedResponse.name);
        ...
        it('invokes checkCreateFeaturestoreProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreateFeaturestoreProgress(''), expectedError);
    ...
    describe('updateFeaturestore', () => {
        it('invokes updateFeaturestore without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.UpdateFeaturestoreRequest', ['featurestore', 'name']);
            request.featurestore.name = defaultValue1;
            const expectedHeaderRequestParams = `featurestore.name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updateFeaturestore = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateFeaturestore(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateFeaturestore as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateFeaturestore as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateFeaturestore without error using callback', async () => {
            ...
            client.innerApiCalls.updateFeaturestore = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateFeaturestore(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IFeaturestore, protos.google.cloud.aiplatform.v1.IUpdateFeaturestoreOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IFeaturestore, protos.google.cloud.aiplatform.v1.IUpdateFeaturestoreOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateFeaturestore as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateFeaturestoreProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateFeaturestoreProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateFeaturestoreProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateFeaturestoreProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteFeaturestore', () => {
        it('invokes deleteFeaturestore without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeleteFeaturestoreRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteFeaturestore = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteFeaturestore(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteFeaturestore as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteFeaturestore as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteFeaturestore without error using callback', async () => {
            ...
            client.innerApiCalls.deleteFeaturestore = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes checkDeleteFeaturestoreProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteFeaturestoreProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteFeaturestoreProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteFeaturestoreProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('createEntityType', () => {
        it('invokes createEntityType without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.CreateEntityTypeRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createEntityType = stubLongRunningCall(expectedResponse);
        ...
        it('invokes createEntityType without error using callback', async () => {
            ...
            client.innerApiCalls.createEntityType = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createEntityType(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IEntityType, protos.google.cloud.aiplatform.v1.ICreateEntityTypeOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IEntityType, protos.google.cloud.aiplatform.v1.ICreateEntityTypeOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createEntityType as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkCreateEntityTypeProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkCreateEntityTypeProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkCreateEntityTypeProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkCreateEntityTypeProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteEntityType', () => {
        it('invokes deleteEntityType without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeleteEntityTypeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteEntityType = stubLongRunningCall(expectedResponse);
        ...
        it('invokes deleteEntityType without error using callback', async () => {
            ...
            client.innerApiCalls.deleteEntityType = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes checkDeleteEntityTypeProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteEntityTypeProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteEntityTypeProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteEntityTypeProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('createFeature', () => {
        it('invokes createFeature without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.CreateFeatureRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createFeature without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createFeature(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IFeature, protos.google.cloud.aiplatform.v1.ICreateFeatureOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IFeature, protos.google.cloud.aiplatform.v1.ICreateFeatureOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createFeature as SinonStub)
                .getCall(0).args[0];
    ...
    describe('batchCreateFeatures', () => {
        it('invokes batchCreateFeatures without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.BatchCreateFeaturesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes batchCreateFeatures without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchCreateFeatures(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IBatchCreateFeaturesResponse, protos.google.cloud.aiplatform.v1.IBatchCreateFeaturesOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IBatchCreateFeaturesResponse, protos.google.cloud.aiplatform.v1.IBatchCreateFeaturesOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchCreateFeatures as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteFeature', () => {
        it('invokes deleteFeature without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeleteFeatureRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('importFeatureValues', () => {
        it('invokes importFeatureValues without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ImportFeatureValuesRequest', ['entityType']);
            request.entityType = defaultValue1;
            const expectedHeaderRequestParams = `entity_type=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.importFeatureValues = stubLongRunningCall(expectedResponse);
            const [operation] = await client.importFeatureValues(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importFeatureValues as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.importFeatureValues as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes importFeatureValues without error using callback', async () => {
            ...
            client.innerApiCalls.importFeatureValues = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.importFeatureValues(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IImportFeatureValuesResponse, protos.google.cloud.aiplatform.v1.IImportFeatureValuesOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IImportFeatureValuesResponse, protos.google.cloud.aiplatform.v1.IImportFeatureValuesOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importFeatureValues as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkImportFeatureValuesProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkImportFeatureValuesProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkImportFeatureValuesProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkImportFeatureValuesProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('batchReadFeatureValues', () => {
        it('invokes batchReadFeatureValues without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.BatchReadFeatureValuesRequest', ['featurestore']);
            request.featurestore = defaultValue1;
            const expectedHeaderRequestParams = `featurestore=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.batchReadFeatureValues = stubLongRunningCall(expectedResponse);
            const [operation] = await client.batchReadFeatureValues(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchReadFeatureValues as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchReadFeatureValues as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes batchReadFeatureValues without error using callback', async () => {
            ...
            client.innerApiCalls.batchReadFeatureValues = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchReadFeatureValues(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IBatchReadFeatureValuesResponse, protos.google.cloud.aiplatform.v1.IBatchReadFeatureValuesOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IBatchReadFeatureValuesResponse, protos.google.cloud.aiplatform.v1.IBatchReadFeatureValuesOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchReadFeatureValues as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkBatchReadFeatureValuesProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkBatchReadFeatureValuesProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkBatchReadFeatureValuesProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkBatchReadFeatureValuesProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('exportFeatureValues', () => {
        it('invokes exportFeatureValues without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ExportFeatureValuesRequest', ['entityType']);
            request.entityType = defaultValue1;
            const expectedHeaderRequestParams = `entity_type=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.exportFeatureValues = stubLongRunningCall(expectedResponse);
            const [operation] = await client.exportFeatureValues(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportFeatureValues as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.exportFeatureValues as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes exportFeatureValues without error using callback', async () => {
            ...
            client.innerApiCalls.exportFeatureValues = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.exportFeatureValues(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IExportFeatureValuesResponse, protos.google.cloud.aiplatform.v1.IExportFeatureValuesOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IExportFeatureValuesResponse, protos.google.cloud.aiplatform.v1.IExportFeatureValuesOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportFeatureValues as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkExportFeatureValuesProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkExportFeatureValuesProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkExportFeatureValuesProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkExportFeatureValuesProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteFeatureValues', () => {
        it('invokes deleteFeatureValues without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeleteFeatureValuesRequest', ['entityType']);
            request.entityType = defaultValue1;
            const expectedHeaderRequestParams = `entity_type=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteFeatureValues = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteFeatureValues(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteFeatureValues as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteFeatureValues as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteFeatureValues without error using callback', async () => {
            ...
            client.innerApiCalls.deleteFeatureValues = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteFeatureValues(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IDeleteFeatureValuesResponse, protos.google.cloud.aiplatform.v1.IDeleteFeatureValuesOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IDeleteFeatureValuesResponse, protos.google.cloud.aiplatform.v1.IDeleteFeatureValuesOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteFeatureValues as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteFeatureValuesProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteFeatureValuesProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteFeatureValuesProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteFeatureValuesProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listFeaturestores', () => {
        it('invokes listFeaturestores without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListFeaturestoresRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.Featurestore()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.Featurestore()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.Featurestore()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listFeaturestores as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listFeaturestores as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listFeaturestores without error using callback', async () => {
            ...
            client.innerApiCalls.listFeaturestores = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listFeaturestoresStream without error', async () => {
            ...
            client.descriptors.page.listFeaturestores.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listFeaturestoresStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.Featurestore[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.Featurestore) => {
            ...
            assert((client.descriptors.page.listFeaturestores.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listFeaturestores, request));
            assert(
        ...
        it('uses async iteration with listFeaturestores without error', async () => {
            ...
            client.descriptors.page.listFeaturestores.asyncIterate = stubAsyncIterationCall(expectedResponse);
    ...
    describe('listEntityTypes', () => {
        it('invokes listEntityTypes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListEntityTypesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.EntityType()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.EntityType()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.EntityType()),
            ];
        ...
        it('invokes listEntityTypesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.EntityType) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listFeatures', () => {
        it('invokes listFeatures without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListFeaturesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
        ...
        it('invokes listFeaturesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.Feature) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('searchFeatures', () => {
        it('invokes searchFeatures without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.SearchFeaturesRequest', ['location']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.searchFeatures as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.searchFeatures as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes searchFeatures without error using callback', async () => {
            ...
            client.innerApiCalls.searchFeatures = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes searchFeaturesStream without error', async () => {
            ...
            client.descriptors.page.searchFeatures.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.searchFeatures.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.searchFeatures, request));
            assert(
        ...
        it('uses async iteration with searchFeatures without error', async () => {
            ...
            client.descriptors.page.searchFeatures.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.aiplatform.v1.IFeature[] = [];
