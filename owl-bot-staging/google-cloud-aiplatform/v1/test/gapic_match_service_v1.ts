...
describe('v1.MatchServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = matchserviceModule.v1.MatchServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = matchserviceModule.v1.MatchServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new matchserviceModule.v1.MatchServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new matchserviceModule.v1.MatchServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new matchserviceModule.v1.MatchServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new matchserviceModule.v1.MatchServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = matchserviceModule.v1.MatchServiceClient.port;
            assert(port);
    ...
    describe('findNeighbors', () => {
        it('invokes findNeighbors without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.FindNeighborsResponse()
            );
            ...
            const actualRequest = (client.innerApiCalls.findNeighbors as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.findNeighbors as SinonStub)
        ...
        it('invokes findNeighbors without error using callback', async () => {
            ...
            client.innerApiCalls.findNeighbors = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.findNeighbors(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IFindNeighborsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('readIndexDatapoints', () => {
        it('invokes readIndexDatapoints without error', async () => {
            ...
            const expectedHeaderRequestParams = `index_endpoint=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.ReadIndexDatapointsResponse()
            );
            client.innerApiCalls.readIndexDatapoints = stubSimpleCall(expectedResponse);
            const [response] = await client.readIndexDatapoints(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.readIndexDatapoints as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.readIndexDatapoints as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes readIndexDatapoints without error using callback', async () => {
            ...
            client.innerApiCalls.readIndexDatapoints = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.readIndexDatapoints(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IReadIndexDatapointsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
