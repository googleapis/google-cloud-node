...
describe('v1beta1.ModelMonitoringServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new modelmonitoringserviceModule.v1beta1.ModelMonitoringServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = modelmonitoringserviceModule.v1beta1.ModelMonitoringServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = modelmonitoringserviceModule.v1beta1.ModelMonitoringServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new modelmonitoringserviceModule.v1beta1.ModelMonitoringServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new modelmonitoringserviceModule.v1beta1.ModelMonitoringServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new modelmonitoringserviceModule.v1beta1.ModelMonitoringServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new modelmonitoringserviceModule.v1beta1.ModelMonitoringServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = modelmonitoringserviceModule.v1beta1.ModelMonitoringServiceClient.port;
            assert(port);
    ...
    describe('getModelMonitor', () => {
        it('invokes getModelMonitor without error', async () => {
            ...
            const actualRequest = (client.innerApiCalls.getModelMonitor as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getModelMonitor as SinonStub)
        ...
        it('invokes getModelMonitor without error using callback', async () => {
            ...
            client.innerApiCalls.getModelMonitor = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getModelMonitor(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IModelMonitor|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createModelMonitoringJob', () => {
        it('invokes createModelMonitoringJob without error', async () => {
            ...
            client.innerApiCalls.createModelMonitoringJob = stubSimpleCall(expectedResponse);
            const [response] = await client.createModelMonitoringJob(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createModelMonitoringJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createModelMonitoringJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createModelMonitoringJob without error using callback', async () => {
            ...
            client.innerApiCalls.createModelMonitoringJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createModelMonitoringJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IModelMonitoringJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getModelMonitoringJob', () => {
        it('invokes getModelMonitoringJob without error', async () => {
            ...
            client.innerApiCalls.getModelMonitoringJob = stubSimpleCall(expectedResponse);
            const [response] = await client.getModelMonitoringJob(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getModelMonitoringJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getModelMonitoringJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getModelMonitoringJob without error using callback', async () => {
            ...
            client.innerApiCalls.getModelMonitoringJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
    ...
    describe('createModelMonitor', () => {
        it('invokes createModelMonitor without error', async () => {
            ...
            client.innerApiCalls.createModelMonitor = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createModelMonitor(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createModelMonitor as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createModelMonitor as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createModelMonitor without error using callback', async () => {
            ...
            client.innerApiCalls.createModelMonitor = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createModelMonitor(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IModelMonitor, protos.google.cloud.aiplatform.v1beta1.ICreateModelMonitorOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IModelMonitor, protos.google.cloud.aiplatform.v1beta1.ICreateModelMonitorOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createModelMonitor as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkCreateModelMonitorProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateModelMonitorProgress(expectedResponse.name);
        ...
        it('invokes checkCreateModelMonitorProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreateModelMonitorProgress(''), expectedError);
    ...
    describe('updateModelMonitor', () => {
        it('invokes updateModelMonitor without error', async () => {
            ...
            client.innerApiCalls.updateModelMonitor = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateModelMonitor(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateModelMonitor as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateModelMonitor as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateModelMonitor without error using callback', async () => {
            ...
            client.innerApiCalls.updateModelMonitor = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateModelMonitor(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IModelMonitor, protos.google.cloud.aiplatform.v1beta1.IUpdateModelMonitorOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IModelMonitor, protos.google.cloud.aiplatform.v1beta1.IUpdateModelMonitorOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateModelMonitor as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateModelMonitorProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateModelMonitorProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateModelMonitorProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateModelMonitorProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteModelMonitor', () => {
        it('invokes deleteModelMonitor without error', async () => {
            ...
            client.innerApiCalls.deleteModelMonitor = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteModelMonitor(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteModelMonitor as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteModelMonitor as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteModelMonitor without error using callback', async () => {
            ...
            client.innerApiCalls.deleteModelMonitor = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes checkDeleteModelMonitorProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteModelMonitorProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteModelMonitorProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteModelMonitorProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteModelMonitoringJob', () => {
        it('invokes deleteModelMonitoringJob without error', async () => {
            ...
            client.innerApiCalls.deleteModelMonitoringJob = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteModelMonitoringJob(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteModelMonitoringJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteModelMonitoringJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteModelMonitoringJob without error using callback', async () => {
            ...
            client.innerApiCalls.deleteModelMonitoringJob = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes checkDeleteModelMonitoringJobProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteModelMonitoringJobProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteModelMonitoringJobProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteModelMonitoringJobProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listModelMonitors', () => {
        it('invokes listModelMonitors without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listModelMonitors as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listModelMonitors as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listModelMonitors without error using callback', async () => {
            ...
            client.innerApiCalls.listModelMonitors = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listModelMonitorsStream without error', async () => {
            ...
            client.descriptors.page.listModelMonitors.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listModelMonitorsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.ModelMonitor[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.ModelMonitor) => {
            ...
            assert((client.descriptors.page.listModelMonitors.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listModelMonitors, request));
            assert(
        ...
        it('uses async iteration with listModelMonitors without error', async () => {
            ...
            client.descriptors.page.listModelMonitors.asyncIterate = stubAsyncIterationCall(expectedResponse);
    ...
    describe('listModelMonitoringJobs', () => {
        it('invokes listModelMonitoringJobs without error', async () => {
            ...
            client.innerApiCalls.listModelMonitoringJobs = stubSimpleCall(expectedResponse);
            const [response] = await client.listModelMonitoringJobs(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listModelMonitoringJobs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listModelMonitoringJobs as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listModelMonitoringJobs without error using callback', async () => {
            ...
            client.innerApiCalls.listModelMonitoringJobs = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listModelMonitoringJobsStream without error', async () => {
            ...
            client.descriptors.page.listModelMonitoringJobs.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.ModelMonitoringJob) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listModelMonitoringJobs.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listModelMonitoringJobs, request));
            assert(
                (client.descriptors.page.listModelMonitoringJobs.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('uses async iteration with listModelMonitoringJobs without error', async () => {
            ...
            client.descriptors.page.listModelMonitoringJobs.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listModelMonitoringJobs.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listModelMonitoringJobs.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
    ...
    describe('searchModelMonitoringStats', () => {
        it('invokes searchModelMonitoringStats without error', async () => {
            ...
            client.innerApiCalls.searchModelMonitoringStats = stubSimpleCall(expectedResponse);
            const [response] = await client.searchModelMonitoringStats(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.searchModelMonitoringStats as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.searchModelMonitoringStats as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes searchModelMonitoringStats without error using callback', async () => {
            ...
            client.innerApiCalls.searchModelMonitoringStats = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.searchModelMonitoringStats(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IModelMonitoringStats[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes searchModelMonitoringStatsStream without error', async () => {
            ...
            client.descriptors.page.searchModelMonitoringStats.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.ModelMonitoringStats) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.searchModelMonitoringStats.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.searchModelMonitoringStats, request));
            assert(
                (client.descriptors.page.searchModelMonitoringStats.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('uses async iteration with searchModelMonitoringStats without error', async () => {
            ...
            client.descriptors.page.searchModelMonitoringStats.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.searchModelMonitoringStats.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.searchModelMonitoringStats.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
    ...
    describe('searchModelMonitoringAlerts', () => {
        it('invokes searchModelMonitoringAlerts without error', async () => {
            ...
            client.innerApiCalls.searchModelMonitoringAlerts = stubSimpleCall(expectedResponse);
            const [response] = await client.searchModelMonitoringAlerts(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.searchModelMonitoringAlerts as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.searchModelMonitoringAlerts as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes searchModelMonitoringAlerts without error using callback', async () => {
            ...
            client.innerApiCalls.searchModelMonitoringAlerts = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.searchModelMonitoringAlerts(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IModelMonitoringAlert[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes searchModelMonitoringAlertsStream without error', async () => {
            ...
            client.descriptors.page.searchModelMonitoringAlerts.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.ModelMonitoringAlert) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.searchModelMonitoringAlerts.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.searchModelMonitoringAlerts, request));
            assert(
                (client.descriptors.page.searchModelMonitoringAlerts.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('uses async iteration with searchModelMonitoringAlerts without error', async () => {
            ...
            client.descriptors.page.searchModelMonitoringAlerts.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.searchModelMonitoringAlerts.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.searchModelMonitoringAlerts.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
