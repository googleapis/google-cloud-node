...
describe('v1beta1.TensorboardServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = tensorboardserviceModule.v1beta1.TensorboardServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = tensorboardserviceModule.v1beta1.TensorboardServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new tensorboardserviceModule.v1beta1.TensorboardServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new tensorboardserviceModule.v1beta1.TensorboardServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new tensorboardserviceModule.v1beta1.TensorboardServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new tensorboardserviceModule.v1beta1.TensorboardServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getTensorboard', () => {
        it('invokes getTensorboard without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.GetTensorboardRequest', ['name']);
        ...
        it('invokes getTensorboard without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getTensorboard(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.ITensorboard|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('readTensorboardUsage', () => {
        it('invokes readTensorboardUsage without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ReadTensorboardUsageRequest', ['tensorboard']);
        ...
        it('invokes readTensorboardUsage without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.readTensorboardUsage(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IReadTensorboardUsageResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('readTensorboardSize', () => {
        it('invokes readTensorboardSize without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ReadTensorboardSizeRequest', ['tensorboard']);
            request.tensorboard = defaultValue1;
            const expectedHeaderRequestParams = `tensorboard=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes readTensorboardSize without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.readTensorboardSize(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IReadTensorboardSizeResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createTensorboardExperiment', () => {
        it('invokes createTensorboardExperiment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.CreateTensorboardExperimentRequest', ['parent']);
        ...
        it('invokes createTensorboardExperiment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createTensorboardExperiment(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.ITensorboardExperiment|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getTensorboardExperiment', () => {
        it('invokes getTensorboardExperiment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.GetTensorboardExperimentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.TensorboardExperiment()
    ...
    describe('updateTensorboardExperiment', () => {
        it('invokes updateTensorboardExperiment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.UpdateTensorboardExperimentRequest', ['tensorboardExperiment', 'name']);
    ...
    describe('createTensorboardRun', () => {
        it('invokes createTensorboardRun without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.CreateTensorboardRunRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes createTensorboardRun without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createTensorboardRun(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.ITensorboardRun|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('batchCreateTensorboardRuns', () => {
        it('invokes batchCreateTensorboardRuns without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.BatchCreateTensorboardRunsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes batchCreateTensorboardRuns without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchCreateTensorboardRuns(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IBatchCreateTensorboardRunsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getTensorboardRun', () => {
        it('invokes getTensorboardRun without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.GetTensorboardRunRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.TensorboardRun()
    ...
    describe('updateTensorboardRun', () => {
        it('invokes updateTensorboardRun without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.UpdateTensorboardRunRequest', ['tensorboardRun', 'name']);
    ...
    describe('batchCreateTensorboardTimeSeries', () => {
        it('invokes batchCreateTensorboardTimeSeries without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.BatchCreateTensorboardTimeSeriesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes batchCreateTensorboardTimeSeries without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchCreateTensorboardTimeSeries(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IBatchCreateTensorboardTimeSeriesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createTensorboardTimeSeries', () => {
        it('invokes createTensorboardTimeSeries without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.CreateTensorboardTimeSeriesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes createTensorboardTimeSeries without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createTensorboardTimeSeries(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.ITensorboardTimeSeries|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getTensorboardTimeSeries', () => {
        it('invokes getTensorboardTimeSeries without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.GetTensorboardTimeSeriesRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.TensorboardTimeSeries()
    ...
    describe('updateTensorboardTimeSeries', () => {
        it('invokes updateTensorboardTimeSeries without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.UpdateTensorboardTimeSeriesRequest', ['tensorboardTimeSeries', 'name']);
    ...
    describe('batchReadTensorboardTimeSeriesData', () => {
        it('invokes batchReadTensorboardTimeSeriesData without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.BatchReadTensorboardTimeSeriesDataRequest', ['tensorboard']);
            request.tensorboard = defaultValue1;
            const expectedHeaderRequestParams = `tensorboard=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes batchReadTensorboardTimeSeriesData without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchReadTensorboardTimeSeriesData(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IBatchReadTensorboardTimeSeriesDataResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('readTensorboardTimeSeriesData', () => {
        it('invokes readTensorboardTimeSeriesData without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ReadTensorboardTimeSeriesDataRequest', ['tensorboardTimeSeries']);
        ...
        it('invokes readTensorboardTimeSeriesData without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.readTensorboardTimeSeriesData(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IReadTensorboardTimeSeriesDataResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('writeTensorboardExperimentData', () => {
        it('invokes writeTensorboardExperimentData without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.WriteTensorboardExperimentDataRequest', ['tensorboardExperiment']);
        ...
        it('invokes writeTensorboardExperimentData without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.writeTensorboardExperimentData(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IWriteTensorboardExperimentDataResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('writeTensorboardRunData', () => {
        it('invokes writeTensorboardRunData without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.WriteTensorboardRunDataRequest', ['tensorboardRun']);
        ...
        it('invokes writeTensorboardRunData without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.writeTensorboardRunData(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IWriteTensorboardRunDataResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createTensorboard', () => {
        it('invokes createTensorboard without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.CreateTensorboardRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes createTensorboard without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createTensorboard(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.ITensorboard, protos.google.cloud.aiplatform.v1beta1.ICreateTensorboardOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.ITensorboard, protos.google.cloud.aiplatform.v1beta1.ICreateTensorboardOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createTensorboard as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateTensorboard', () => {
        it('invokes updateTensorboard without error', async () => {
            ...
            request.tensorboard ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.UpdateTensorboardRequest', ['tensorboard', 'name']);
        ...
        it('invokes updateTensorboard without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updateTensorboard(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.ITensorboard, protos.google.cloud.aiplatform.v1beta1.IUpdateTensorboardOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.ITensorboard, protos.google.cloud.aiplatform.v1beta1.IUpdateTensorboardOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateTensorboard as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteTensorboard', () => {
        it('invokes deleteTensorboard without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.DeleteTensorboardRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('deleteTensorboardExperiment', () => {
        it('invokes deleteTensorboardExperiment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.DeleteTensorboardExperimentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('deleteTensorboardRun', () => {
        it('invokes deleteTensorboardRun without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.DeleteTensorboardRunRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('deleteTensorboardTimeSeries', () => {
        it('invokes deleteTensorboardTimeSeries without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.DeleteTensorboardTimeSeriesRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listTensorboards', () => {
        it('invokes listTensorboards without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ListTensorboardsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.Tensorboard()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.Tensorboard()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.Tensorboard()),
            ];
        ...
        it('invokes listTensorboardsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.Tensorboard) => {
    ...
    describe('listTensorboardExperiments', () => {
        it('invokes listTensorboardExperiments without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ListTensorboardExperimentsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.TensorboardExperiment()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.TensorboardExperiment()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.TensorboardExperiment()),
            ];
        ...
        it('invokes listTensorboardExperimentsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.TensorboardExperiment) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listTensorboardRuns', () => {
        it('invokes listTensorboardRuns without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ListTensorboardRunsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.TensorboardRun()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.TensorboardRun()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.TensorboardRun()),
            ];
        ...
        it('invokes listTensorboardRunsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.TensorboardRun) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listTensorboardTimeSeries', () => {
        it('invokes listTensorboardTimeSeries without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ListTensorboardTimeSeriesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.TensorboardTimeSeries()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.TensorboardTimeSeries()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.TensorboardTimeSeries()),
            ];
        ...
        it('invokes listTensorboardTimeSeriesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.TensorboardTimeSeries) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('exportTensorboardTimeSeriesData', () => {
        it('invokes exportTensorboardTimeSeriesData without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ExportTensorboardTimeSeriesDataRequest', ['tensorboardTimeSeries']);
            request.tensorboardTimeSeries = defaultValue1;
            const expectedHeaderRequestParams = `tensorboard_time_series=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.TimeSeriesDataPoint()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.TimeSeriesDataPoint()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.TimeSeriesDataPoint()),
            ];
        ...
        it('invokes exportTensorboardTimeSeriesData without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.exportTensorboardTimeSeriesData(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.ITimeSeriesDataPoint[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes exportTensorboardTimeSeriesDataStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.TimeSeriesDataPoint) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
