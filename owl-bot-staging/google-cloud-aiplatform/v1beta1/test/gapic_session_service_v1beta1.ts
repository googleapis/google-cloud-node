...
describe('v1beta1.SessionServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = sessionserviceModule.v1beta1.SessionServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = sessionserviceModule.v1beta1.SessionServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new sessionserviceModule.v1beta1.SessionServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new sessionserviceModule.v1beta1.SessionServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new sessionserviceModule.v1beta1.SessionServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new sessionserviceModule.v1beta1.SessionServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = sessionserviceModule.v1beta1.SessionServiceClient.port;
            assert(port);
    ...
    describe('getSession', () => {
        it('invokes getSession without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.GetSessionRequest()
            );
            const defaultValue1 =
            ...
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.Session()
            );
        ...
        it('invokes getSession without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getSession(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.ISession|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateSession', () => {
        it('invokes updateSession without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.UpdateSessionRequest()
            );
            request.session ??= {};
            const defaultValue1 =
    ...
    describe('appendEvent', () => {
        it('invokes appendEvent without error', async () => {
            const client = new sessionserviceModule.v1beta1.SessionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.AppendEventResponse()
            );
            client.innerApiCalls.appendEvent = stubSimpleCall(expectedResponse);
            const [response] = await client.appendEvent(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.appendEvent as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.appendEvent as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes appendEvent without error using callback', async () => {
            const client = new sessionserviceModule.v1beta1.SessionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.appendEvent = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.appendEvent(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IAppendEventResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes appendEvent with error', async () => {
            const client = new sessionserviceModule.v1beta1.SessionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.appendEvent = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes appendEvent with closed client', async () => {
            const client = new sessionserviceModule.v1beta1.SessionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('createSession', () => {
        it('invokes createSession without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.CreateSessionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.CreateSessionRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createSession = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createSession(request);
        ...
        it('invokes createSession without error using callback', async () => {
            ...
            client.innerApiCalls.createSession = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createSession(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.ISession, protos.google.cloud.aiplatform.v1beta1.ICreateSessionOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.ISession, protos.google.cloud.aiplatform.v1beta1.ICreateSessionOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createSession as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createSession with call error', async () => {
            const client = new sessionserviceModule.v1beta1.SessionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createSession = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes createSession with LRO error', async () => {
            const client = new sessionserviceModule.v1beta1.SessionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createSession = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createSession(request);
        ...
        it('invokes checkCreateSessionProgress without error', async () => {
            const client = new sessionserviceModule.v1beta1.SessionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const decodedOperation = await client.checkCreateSessionProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkCreateSessionProgress with error', async () => {
            const client = new sessionserviceModule.v1beta1.SessionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            await assert.rejects(client.checkCreateSessionProgress(''), expectedError);
    ...
    describe('deleteSession', () => {
        it('invokes deleteSession without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.DeleteSessionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.DeleteSessionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteSession = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteSession(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
        ...
        it('invokes deleteSession without error using callback', async () => {
            ...
            client.innerApiCalls.deleteSession = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteSession with call error', async () => {
            const client = new sessionserviceModule.v1beta1.SessionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteSession = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes deleteSession with LRO error', async () => {
            const client = new sessionserviceModule.v1beta1.SessionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteSession = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteSession(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteSession as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteSessionProgress without error', async () => {
            const client = new sessionserviceModule.v1beta1.SessionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteSessionProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkDeleteSessionProgress with error', async () => {
            const client = new sessionserviceModule.v1beta1.SessionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteSessionProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listSessions', () => {
        it('invokes listSessions without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.ListSessionsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ListSessionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.Session()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.Session()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.Session()),
            ];
        ...
        it('invokes listSessionsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.Session[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.Session) => {
        ...
        it('uses async iteration with listSessions without error', async () => {
            ...
            const responses: protos.google.cloud.aiplatform.v1beta1.ISession[] = [];
    ...
    describe('listEvents', () => {
        it('invokes listEvents without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.ListEventsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ListEventsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.SessionEvent()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.SessionEvent()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.SessionEvent()),
            ];
        ...
        it('invokes listEvents without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listEvents(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.ISessionEvent[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listEventsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.SessionEvent[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.SessionEvent) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listEvents without error', async () => {
            ...
            const responses: protos.google.cloud.aiplatform.v1beta1.ISessionEvent[] = [];
