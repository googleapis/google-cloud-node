...
describe('v1beta1.IndexEndpointServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = indexendpointserviceModule.v1beta1.IndexEndpointServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = indexendpointserviceModule.v1beta1.IndexEndpointServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new indexendpointserviceModule.v1beta1.IndexEndpointServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new indexendpointserviceModule.v1beta1.IndexEndpointServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new indexendpointserviceModule.v1beta1.IndexEndpointServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new indexendpointserviceModule.v1beta1.IndexEndpointServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = indexendpointserviceModule.v1beta1.IndexEndpointServiceClient.port;
            assert(port);
        ...
        it('invokes getIndexEndpoint without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getIndexEndpoint(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IIndexEndpoint|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateIndexEndpoint', () => {
        it('invokes updateIndexEndpoint without error', async () => {
            ...
            client.innerApiCalls.updateIndexEndpoint = stubSimpleCall(expectedResponse);
        ...
        it('invokes updateIndexEndpoint without error using callback', async () => {
            ...
            client.innerApiCalls.updateIndexEndpoint = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateIndexEndpoint with error', async () => {
            ...
            const expectedHeaderRequestParams = `index_endpoint.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateIndexEndpoint = stubSimpleCall(undefined, expectedError);
    ...
    describe('createIndexEndpoint', () => {
        it('invokes createIndexEndpoint without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.CreateIndexEndpointRequest', ['parent']);
        ...
        it('invokes createIndexEndpoint without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createIndexEndpoint(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IIndexEndpoint, protos.google.cloud.aiplatform.v1beta1.ICreateIndexEndpointOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IIndexEndpoint, protos.google.cloud.aiplatform.v1beta1.ICreateIndexEndpointOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createIndexEndpoint as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteIndexEndpoint', () => {
        it('invokes deleteIndexEndpoint without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.DeleteIndexEndpointRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('deployIndex', () => {
        it('invokes deployIndex without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.DeployIndexRequest', ['indexEndpoint']);
        ...
        it('invokes deployIndex without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deployIndex(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IDeployIndexResponse, protos.google.cloud.aiplatform.v1beta1.IDeployIndexOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IDeployIndexResponse, protos.google.cloud.aiplatform.v1beta1.IDeployIndexOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deployIndex as SinonStub)
                .getCall(0).args[0];
    ...
    describe('undeployIndex', () => {
        it('invokes undeployIndex without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.UndeployIndexRequest', ['indexEndpoint']);
            request.indexEndpoint = defaultValue1;
            const expectedHeaderRequestParams = `index_endpoint=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes undeployIndex without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.undeployIndex(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IUndeployIndexResponse, protos.google.cloud.aiplatform.v1beta1.IUndeployIndexOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IUndeployIndexResponse, protos.google.cloud.aiplatform.v1beta1.IUndeployIndexOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.undeployIndex as SinonStub)
                .getCall(0).args[0];
    ...
    describe('mutateDeployedIndex', () => {
        it('invokes mutateDeployedIndex without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.MutateDeployedIndexRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.MutateDeployedIndexRequest', ['indexEndpoint']);
            request.indexEndpoint = defaultValue1;
            const expectedHeaderRequestParams = `index_endpoint=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.mutateDeployedIndex = stubLongRunningCall(expectedResponse);
            const [operation] = await client.mutateDeployedIndex(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.mutateDeployedIndex as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.mutateDeployedIndex as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes mutateDeployedIndex without error using callback', async () => {
            ...
            client.innerApiCalls.mutateDeployedIndex = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateDeployedIndex(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IMutateDeployedIndexResponse, protos.google.cloud.aiplatform.v1beta1.IMutateDeployedIndexOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IMutateDeployedIndexResponse, protos.google.cloud.aiplatform.v1beta1.IMutateDeployedIndexOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.mutateDeployedIndex as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes mutateDeployedIndex with call error', async () => {
            ...
            const expectedHeaderRequestParams = `index_endpoint=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateDeployedIndex = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes mutateDeployedIndex with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `index_endpoint=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateDeployedIndex = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.mutateDeployedIndex(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.mutateDeployedIndex as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkMutateDeployedIndexProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkMutateDeployedIndexProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkMutateDeployedIndexProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkMutateDeployedIndexProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listIndexEndpoints', () => {
        it('invokes listIndexEndpoints without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ListIndexEndpointsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.IndexEndpoint()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.IndexEndpoint()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.IndexEndpoint()),
            ];
        ...
        it('invokes listIndexEndpointsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.IndexEndpoint) => {
