...
describe('v1beta1.ModelGardenServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = modelgardenserviceModule.v1beta1.ModelGardenServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = modelgardenserviceModule.v1beta1.ModelGardenServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new modelgardenserviceModule.v1beta1.ModelGardenServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = modelgardenserviceModule.v1beta1.ModelGardenServiceClient.port;
            assert(port);
        ...
        it('invokes getPublisherModel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getPublisherModel(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IPublisherModel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('checkPublisherModelEulaAcceptance', () => {
        it('invokes checkPublisherModelEulaAcceptance without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.CheckPublisherModelEulaAcceptanceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.CheckPublisherModelEulaAcceptanceRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.PublisherModelEulaAcceptance()
            );
            client.innerApiCalls.checkPublisherModelEulaAcceptance = stubSimpleCall(expectedResponse);
            const [response] = await client.checkPublisherModelEulaAcceptance(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.checkPublisherModelEulaAcceptance as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.checkPublisherModelEulaAcceptance as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes checkPublisherModelEulaAcceptance without error using callback', async () => {
            ...
            client.innerApiCalls.checkPublisherModelEulaAcceptance = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.checkPublisherModelEulaAcceptance(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IPublisherModelEulaAcceptance|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes checkPublisherModelEulaAcceptance with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.checkPublisherModelEulaAcceptance = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkPublisherModelEulaAcceptance(request), expectedError);
            const actualRequest = (client.innerApiCalls.checkPublisherModelEulaAcceptance as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.checkPublisherModelEulaAcceptance as SinonStub)
    ...
    describe('acceptPublisherModelEula', () => {
        it('invokes acceptPublisherModelEula without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.AcceptPublisherModelEulaRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.AcceptPublisherModelEulaRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.PublisherModelEulaAcceptance()
            );
            client.innerApiCalls.acceptPublisherModelEula = stubSimpleCall(expectedResponse);
            const [response] = await client.acceptPublisherModelEula(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.acceptPublisherModelEula as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.acceptPublisherModelEula as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes acceptPublisherModelEula without error using callback', async () => {
            ...
            client.innerApiCalls.acceptPublisherModelEula = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.acceptPublisherModelEula(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IPublisherModelEulaAcceptance|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes acceptPublisherModelEula with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.acceptPublisherModelEula = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.acceptPublisherModelEula(request), expectedError);
            const actualRequest = (client.innerApiCalls.acceptPublisherModelEula as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.acceptPublisherModelEula as SinonStub)
    ...
    describe('deploy', () => {
        it('invokes deploy without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.DeployRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.DeployRequest', ['destination']);
        ...
        it('invokes deploy without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deploy(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IDeployResponse, protos.google.cloud.aiplatform.v1beta1.IDeployOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IDeployResponse, protos.google.cloud.aiplatform.v1beta1.IDeployOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deploy as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deployPublisherModel', () => {
        it('invokes deployPublisherModel without error', async () => {
            ...
            client.innerApiCalls.deployPublisherModel = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deployPublisherModel(request);
            const [response] = await operation.promise();
            assert(stub.calledOnce);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deployPublisherModel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deployPublisherModel as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deployPublisherModel without error using callback', async () => {
            ...
            client.innerApiCalls.deployPublisherModel = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deployPublisherModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IDeployPublisherModelResponse, protos.google.cloud.aiplatform.v1beta1.IDeployPublisherModelOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IDeployPublisherModelResponse, protos.google.cloud.aiplatform.v1beta1.IDeployPublisherModelOperationMetadata>;
            const [response] = await operation.promise();
            assert(stub.calledOnce);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deployPublisherModel as SinonStub)
        ...
        it('invokes checkDeployPublisherModelProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeployPublisherModelProgress(expectedResponse.name);
            assert(stub.calledOnce);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        ...
        it('invokes checkDeployPublisherModelProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeployPublisherModelProgress(''), expectedError);
            assert(stub.calledOnce);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    ...
    describe('exportPublisherModel', () => {
        it('invokes exportPublisherModel without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.ExportPublisherModelRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ExportPublisherModelRequest', ['parent']);
            request.parent = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ExportPublisherModelRequest', ['name']);
            request.name = defaultValue2;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }&name=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.exportPublisherModel = stubLongRunningCall(expectedResponse);
            const [operation] = await client.exportPublisherModel(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportPublisherModel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.exportPublisherModel as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes exportPublisherModel without error using callback', async () => {
            ...
            client.innerApiCalls.exportPublisherModel = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.exportPublisherModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IExportPublisherModelResponse, protos.google.cloud.aiplatform.v1beta1.IExportPublisherModelOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IExportPublisherModelResponse, protos.google.cloud.aiplatform.v1beta1.IExportPublisherModelOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportPublisherModel as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes exportPublisherModel with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }&name=${defaultValue2 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.exportPublisherModel = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.exportPublisherModel(request), expectedError);
            const actualRequest = (client.innerApiCalls.exportPublisherModel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.exportPublisherModel as SinonStub)
        ...
        it('invokes exportPublisherModel with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }&name=${defaultValue2 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.exportPublisherModel = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.exportPublisherModel(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.exportPublisherModel as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkExportPublisherModelProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkExportPublisherModelProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkExportPublisherModelProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkExportPublisherModelProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('listPublisherModels', () => {
        it('invokes listPublisherModels without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.ListPublisherModelsRequest()
            );
            const defaultValue1 =
            ...
            client.innerApiCalls.listPublisherModels = stubSimpleCall(expectedResponse);
            const [response] = await client.listPublisherModels(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listPublisherModels as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listPublisherModels as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listPublisherModels without error using callback', async () => {
            ...
            client.innerApiCalls.listPublisherModels = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listPublisherModels(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IPublisherModel[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listPublisherModelsStream without error', async () => {
            ...
            assert((client.descriptors.page.listPublisherModels.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listPublisherModels, request));
            assert(
        ...
        it('uses async iteration with listPublisherModels without error', async () => {
            ...
            client.descriptors.page.listPublisherModels.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.aiplatform.v1beta1.IPublisherModel[] = [];
