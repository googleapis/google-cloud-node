...
describe('v1beta1.PredictionServiceClient', () => {
    ...
    describe('serverStreamingPredict', () => {
        ...
        it('invokes serverStreamingPredict with closed client', async () => {
            ...
            const expectedError = new Error('The client has already been closed.');
            client.close();
            const stream = client.serverStreamingPredict(request, {retry: {shouldRetryFn: () => { return false; }}});
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.StreamingPredictResponse) => {
                    resolve(response);
                });
    ...
    describe('streamGenerateContent', () => {
        ...
        it('invokes streamGenerateContent with closed client', async () => {
            ...
            const expectedError = new Error('The client has already been closed.');
            client.close();
            const stream = client.streamGenerateContent(request, {retry: {shouldRetryFn: () => { return false; }}});
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.GenerateContentResponse) => {
                    resolve(response);
                });
