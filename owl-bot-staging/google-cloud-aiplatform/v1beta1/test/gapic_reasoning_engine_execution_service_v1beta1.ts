...
import * as reasoningengineexecutionserviceModule from '../src';
...
describe('v1beta1.ReasoningEngineExecutionServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = reasoningengineexecutionserviceModule.v1beta1.ReasoningEngineExecutionServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = reasoningengineexecutionserviceModule.v1beta1.ReasoningEngineExecutionServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new reasoningengineexecutionserviceModule.v1beta1.ReasoningEngineExecutionServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new reasoningengineexecutionserviceModule.v1beta1.ReasoningEngineExecutionServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new reasoningengineexecutionserviceModule.v1beta1.ReasoningEngineExecutionServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new reasoningengineexecutionserviceModule.v1beta1.ReasoningEngineExecutionServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = reasoningengineexecutionserviceModule.v1beta1.ReasoningEngineExecutionServiceClient.port;
            assert(port);
    ...
    describe('queryReasoningEngine', () => {
        it('invokes queryReasoningEngine without error', async () => {
            const client = new reasoningengineexecutionserviceModule.v1beta1.ReasoningEngineExecutionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.QueryReasoningEngineRequest()
            );
            const defaultValue1 =
            ...
            client.innerApiCalls.queryReasoningEngine = stubSimpleCall(expectedResponse);
            const [response] = await client.queryReasoningEngine(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.queryReasoningEngine as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.queryReasoningEngine as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes queryReasoningEngine without error using callback', async () => {
            const client = new reasoningengineexecutionserviceModule.v1beta1.ReasoningEngineExecutionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.queryReasoningEngine = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.queryReasoningEngine(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IQueryReasoningEngineResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes queryReasoningEngine with error', async () => {
            const client = new reasoningengineexecutionserviceModule.v1beta1.ReasoningEngineExecutionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
        ...
        it('invokes queryReasoningEngine with closed client', async () => {
            const client = new reasoningengineexecutionserviceModule.v1beta1.ReasoningEngineExecutionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('streamQueryReasoningEngine', () => {
        it('invokes streamQueryReasoningEngine without error', async () => {
            const client = new reasoningengineexecutionserviceModule.v1beta1.ReasoningEngineExecutionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.StreamQueryReasoningEngineRequest()
            );
            const defaultValue1 =
            ...
            client.innerApiCalls.streamQueryReasoningEngine = stubServerStreamingCall(expectedResponse);
            ...
            const response = await promise;
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.streamQueryReasoningEngine as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.streamQueryReasoningEngine as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes streamQueryReasoningEngine without error and gaxServerStreamingRetries enabled', async () => {
            const client = new reasoningengineexecutionserviceModule.v1beta1.ReasoningEngineExecutionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        ...
        it('invokes streamQueryReasoningEngine with error', async () => {
            const client = new reasoningengineexecutionserviceModule.v1beta1.ReasoningEngineExecutionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
        ...
        it('invokes streamQueryReasoningEngine with closed client', async () => {
            const client = new reasoningengineexecutionserviceModule.v1beta1.ReasoningEngineExecutionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
