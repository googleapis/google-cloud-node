...
describe('v1beta1.PersistentResourceServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = persistentresourceserviceModule.v1beta1.PersistentResourceServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = persistentresourceserviceModule.v1beta1.PersistentResourceServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new persistentresourceserviceModule.v1beta1.PersistentResourceServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new persistentresourceserviceModule.v1beta1.PersistentResourceServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new persistentresourceserviceModule.v1beta1.PersistentResourceServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new persistentresourceserviceModule.v1beta1.PersistentResourceServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = persistentresourceserviceModule.v1beta1.PersistentResourceServiceClient.port;
            assert(port);
    ...
    describe('getPersistentResource', () => {
        it('invokes getPersistentResource without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.GetPersistentResourceRequest()
            );
            const defaultValue1 =
        ...
        it('invokes getPersistentResource without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getPersistentResource(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IPersistentResource|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createPersistentResource', () => {
        it('invokes createPersistentResource without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.CreatePersistentResourceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.CreatePersistentResourceRequest', ['parent']);
        ...
        it('invokes createPersistentResource without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createPersistentResource(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IPersistentResource, protos.google.cloud.aiplatform.v1beta1.ICreatePersistentResourceOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IPersistentResource, protos.google.cloud.aiplatform.v1beta1.ICreatePersistentResourceOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createPersistentResource as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deletePersistentResource', () => {
        it('invokes deletePersistentResource without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.DeletePersistentResourceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.DeletePersistentResourceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('updatePersistentResource', () => {
        it('invokes updatePersistentResource without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.UpdatePersistentResourceRequest()
            );
            request.persistentResource ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.UpdatePersistentResourceRequest', ['persistentResource', 'name']);
        ...
        it('invokes updatePersistentResource without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updatePersistentResource(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IPersistentResource, protos.google.cloud.aiplatform.v1beta1.IUpdatePersistentResourceOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IPersistentResource, protos.google.cloud.aiplatform.v1beta1.IUpdatePersistentResourceOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updatePersistentResource as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listPersistentResources', () => {
        it('invokes listPersistentResources without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.ListPersistentResourcesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ListPersistentResourcesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.PersistentResource()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.PersistentResource()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.PersistentResource()),
            ];
        ...
        it('invokes listPersistentResourcesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.PersistentResource[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.PersistentResource) => {
