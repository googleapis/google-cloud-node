...
describe('v1beta1.ExampleStoreServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = examplestoreserviceModule.v1beta1.ExampleStoreServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = examplestoreserviceModule.v1beta1.ExampleStoreServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new examplestoreserviceModule.v1beta1.ExampleStoreServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new examplestoreserviceModule.v1beta1.ExampleStoreServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new examplestoreserviceModule.v1beta1.ExampleStoreServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new examplestoreserviceModule.v1beta1.ExampleStoreServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = examplestoreserviceModule.v1beta1.ExampleStoreServiceClient.port;
            assert(port);
    ...
    describe('getExampleStore', () => {
        it('invokes getExampleStore without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.GetExampleStoreRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.GetExampleStoreRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.ExampleStore()
            );
            client.innerApiCalls.getExampleStore = stubSimpleCall(expectedResponse);
            const [response] = await client.getExampleStore(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getExampleStore as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getExampleStore as SinonStub)
        ...
        it('invokes getExampleStore without error using callback', async () => {
            ...
            client.innerApiCalls.getExampleStore = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getExampleStore(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IExampleStore|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getExampleStore with error', async () => {
            ...
            client.innerApiCalls.getExampleStore = stubSimpleCall(undefined, expectedError);
    ...
    describe('upsertExamples', () => {
        it('invokes upsertExamples without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.UpsertExamplesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.UpsertExamplesRequest', ['exampleStore']);
            request.exampleStore = defaultValue1;
            const expectedHeaderRequestParams = `example_store=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.UpsertExamplesResponse()
            );
            client.innerApiCalls.upsertExamples = stubSimpleCall(expectedResponse);
            const [response] = await client.upsertExamples(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.upsertExamples as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.upsertExamples as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes upsertExamples without error using callback', async () => {
            ...
            client.innerApiCalls.upsertExamples = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.upsertExamples(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IUpsertExamplesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes upsertExamples with error', async () => {
            ...
            const expectedHeaderRequestParams = `example_store=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.upsertExamples = stubSimpleCall(undefined, expectedError);
    ...
    describe('removeExamples', () => {
        it('invokes removeExamples without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.RemoveExamplesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.RemoveExamplesRequest', ['exampleStore']);
            request.exampleStore = defaultValue1;
            const expectedHeaderRequestParams = `example_store=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.RemoveExamplesResponse()
            );
            client.innerApiCalls.removeExamples = stubSimpleCall(expectedResponse);
            const [response] = await client.removeExamples(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.removeExamples as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.removeExamples as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes removeExamples without error using callback', async () => {
            ...
            client.innerApiCalls.removeExamples = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.removeExamples(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IRemoveExamplesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes removeExamples with error', async () => {
            ...
            const expectedHeaderRequestParams = `example_store=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.removeExamples = stubSimpleCall(undefined, expectedError);
    ...
    describe('searchExamples', () => {
        it('invokes searchExamples without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.SearchExamplesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.SearchExamplesRequest', ['exampleStore']);
            request.exampleStore = defaultValue1;
            const expectedHeaderRequestParams = `example_store=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.SearchExamplesResponse()
            );
            client.innerApiCalls.searchExamples = stubSimpleCall(expectedResponse);
            const [response] = await client.searchExamples(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.searchExamples as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.searchExamples as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes searchExamples without error using callback', async () => {
            ...
            client.innerApiCalls.searchExamples = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.searchExamples(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.ISearchExamplesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes searchExamples with error', async () => {
            ...
            const expectedHeaderRequestParams = `example_store=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.searchExamples = stubSimpleCall(undefined, expectedError);
    ...
    describe('createExampleStore', () => {
        it('invokes createExampleStore without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.CreateExampleStoreRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.CreateExampleStoreRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createExampleStore = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createExampleStore(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createExampleStore as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createExampleStore as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createExampleStore without error using callback', async () => {
            ...
            client.innerApiCalls.createExampleStore = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createExampleStore(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IExampleStore, protos.google.cloud.aiplatform.v1beta1.ICreateExampleStoreOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IExampleStore, protos.google.cloud.aiplatform.v1beta1.ICreateExampleStoreOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createExampleStore as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createExampleStore with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createExampleStore = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createExampleStore(request), expectedError);
            const actualRequest = (client.innerApiCalls.createExampleStore as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createExampleStore as SinonStub)
        ...
        it('invokes createExampleStore with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createExampleStore = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createExampleStore(request);
        ...
        it('invokes checkCreateExampleStoreProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateExampleStoreProgress(expectedResponse.name);
        ...
        it('invokes checkCreateExampleStoreProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreateExampleStoreProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('updateExampleStore', () => {
        it('invokes updateExampleStore without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.UpdateExampleStoreRequest()
            );
            request.exampleStore ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.UpdateExampleStoreRequest', ['exampleStore', 'name']);
            request.exampleStore.name = defaultValue1;
            const expectedHeaderRequestParams = `example_store.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updateExampleStore = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateExampleStore(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateExampleStore as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateExampleStore as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateExampleStore without error using callback', async () => {
            ...
            client.innerApiCalls.updateExampleStore = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateExampleStore(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IExampleStore, protos.google.cloud.aiplatform.v1beta1.IUpdateExampleStoreOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IExampleStore, protos.google.cloud.aiplatform.v1beta1.IUpdateExampleStoreOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateExampleStore as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes updateExampleStore with call error', async () => {
            ...
            const expectedHeaderRequestParams = `example_store.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateExampleStore = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.updateExampleStore(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateExampleStore as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateExampleStore as SinonStub)
        ...
        it('invokes updateExampleStore with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `example_store.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateExampleStore = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateExampleStore(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateExampleStore as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateExampleStoreProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateExampleStoreProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateExampleStoreProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateExampleStoreProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('deleteExampleStore', () => {
        it('invokes deleteExampleStore without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.DeleteExampleStoreRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.DeleteExampleStoreRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteExampleStore = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteExampleStore(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteExampleStore as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteExampleStore as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteExampleStore without error using callback', async () => {
            ...
            client.innerApiCalls.deleteExampleStore = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteExampleStore(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.aiplatform.v1beta1.IDeleteExampleStoreOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.aiplatform.v1beta1.IDeleteExampleStoreOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteExampleStore as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes deleteExampleStore with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteExampleStore = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteExampleStore(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteExampleStore as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteExampleStore as SinonStub)
        ...
        it('invokes deleteExampleStore with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteExampleStore = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteExampleStore(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteExampleStore as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteExampleStoreProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteExampleStoreProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteExampleStoreProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteExampleStoreProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('listExampleStores', () => {
        it('invokes listExampleStores without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.ListExampleStoresRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ListExampleStoresRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ExampleStore()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ExampleStore()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ExampleStore()),
            ];
            client.innerApiCalls.listExampleStores = stubSimpleCall(expectedResponse);
            const [response] = await client.listExampleStores(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listExampleStores as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listExampleStores as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listExampleStores without error using callback', async () => {
            ...
            client.innerApiCalls.listExampleStores = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listExampleStores(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IExampleStore[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listExampleStores with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listExampleStores = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listExampleStores(request), expectedError);
            const actualRequest = (client.innerApiCalls.listExampleStores as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listExampleStores as SinonStub)
        ...
        it('invokes listExampleStoresStream without error', async () => {
            ...
            client.descriptors.page.listExampleStores.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listExampleStoresStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.ExampleStore[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.ExampleStore) => {
            ...
            assert((client.descriptors.page.listExampleStores.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listExampleStores, request));
            assert(
        ...
        it('invokes listExampleStoresStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listExampleStores.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listExampleStoresStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.ExampleStore[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.ExampleStore) => {
        ...
        it('uses async iteration with listExampleStores without error', async () => {
            ...
            client.descriptors.page.listExampleStores.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.aiplatform.v1beta1.IExampleStore[] = [];
            const iterable = client.listExampleStoresAsync(request);
        ...
        it('uses async iteration with listExampleStores with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listExampleStores.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listExampleStoresAsync(request);
    ...
    describe('fetchExamples', () => {
        it('invokes fetchExamples without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.FetchExamplesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.FetchExamplesRequest', ['exampleStore']);
            request.exampleStore = defaultValue1;
            const expectedHeaderRequestParams = `example_store=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.Example()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.Example()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.Example()),
            ];
            client.innerApiCalls.fetchExamples = stubSimpleCall(expectedResponse);
            const [response] = await client.fetchExamples(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.fetchExamples as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.fetchExamples as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes fetchExamples without error using callback', async () => {
            ...
            client.innerApiCalls.fetchExamples = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.fetchExamples(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IExample[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes fetchExamples with error', async () => {
            ...
            const expectedHeaderRequestParams = `example_store=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.fetchExamples = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.fetchExamples(request), expectedError);
            const actualRequest = (client.innerApiCalls.fetchExamples as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.fetchExamples as SinonStub)
        ...
        it('invokes fetchExamplesStream without error', async () => {
            ...
            client.descriptors.page.fetchExamples.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.fetchExamplesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.Example[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.Example) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.fetchExamples.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.fetchExamples, request));
            assert(
        ...
        it('invokes fetchExamplesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `example_store=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.fetchExamples.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.fetchExamplesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.Example[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.Example) => {
        ...
        it('uses async iteration with fetchExamples without error', async () => {
            ...
            client.descriptors.page.fetchExamples.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.aiplatform.v1beta1.IExample[] = [];
            const iterable = client.fetchExamplesAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
        ...
        it('uses async iteration with fetchExamples with error', async () => {
            ...
            const expectedHeaderRequestParams = `example_store=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.fetchExamples.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.fetchExamplesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.aiplatform.v1beta1.IExample[] = [];
                for await (const resource of iterable) {
