...
describe('v1beta1.EvaluationServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = evaluationserviceModule.v1beta1.EvaluationServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = evaluationserviceModule.v1beta1.EvaluationServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new evaluationserviceModule.v1beta1.EvaluationServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new evaluationserviceModule.v1beta1.EvaluationServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new evaluationserviceModule.v1beta1.EvaluationServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new evaluationserviceModule.v1beta1.EvaluationServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
        ...
        it('invokes evaluateInstances without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.evaluateInstances(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IEvaluateInstancesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('evaluateDataset', () => {
        it('invokes evaluateDataset without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.EvaluateDatasetRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.EvaluateDatasetRequest', ['location']);
            request.location = defaultValue1;
            const expectedHeaderRequestParams = `location=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.evaluateDataset = stubLongRunningCall(expectedResponse);
            const [operation] = await client.evaluateDataset(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.evaluateDataset as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.evaluateDataset as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes evaluateDataset without error using callback', async () => {
            const client = new evaluationserviceModule.v1beta1.EvaluationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.evaluateDataset = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.evaluateDataset(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IEvaluateDatasetResponse, protos.google.cloud.aiplatform.v1beta1.IEvaluateDatasetOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IEvaluateDatasetResponse, protos.google.cloud.aiplatform.v1beta1.IEvaluateDatasetOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.evaluateDataset as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes evaluateDataset with call error', async () => {
            const client = new evaluationserviceModule.v1beta1.EvaluationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `location=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.evaluateDataset = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.evaluateDataset(request), expectedError);
            const actualRequest = (client.innerApiCalls.evaluateDataset as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.evaluateDataset as SinonStub)
        ...
        it('invokes evaluateDataset with LRO error', async () => {
            const client = new evaluationserviceModule.v1beta1.EvaluationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `location=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.evaluateDataset = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.evaluateDataset(request);
        ...
        it('invokes checkEvaluateDatasetProgress without error', async () => {
            const client = new evaluationserviceModule.v1beta1.EvaluationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const decodedOperation = await client.checkEvaluateDatasetProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkEvaluateDatasetProgress with error', async () => {
            const client = new evaluationserviceModule.v1beta1.EvaluationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            await assert.rejects(client.checkEvaluateDatasetProgress(''), expectedError);
