...
describe('v1beta1.ExtensionRegistryServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = extensionregistryserviceModule.v1beta1.ExtensionRegistryServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = extensionregistryserviceModule.v1beta1.ExtensionRegistryServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new extensionregistryserviceModule.v1beta1.ExtensionRegistryServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new extensionregistryserviceModule.v1beta1.ExtensionRegistryServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new extensionregistryserviceModule.v1beta1.ExtensionRegistryServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new extensionregistryserviceModule.v1beta1.ExtensionRegistryServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = extensionregistryserviceModule.v1beta1.ExtensionRegistryServiceClient.port;
            assert(port);
    ...
    describe('getExtension', () => {
        it('invokes getExtension without error', async () => {
            ...
            const actualRequest = (client.innerApiCalls.getExtension as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getExtension as SinonStub)
        ...
        it('invokes getExtension without error using callback', async () => {
            ...
            client.innerApiCalls.getExtension = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getExtension(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IExtension|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateExtension', () => {
        it('invokes updateExtension without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateExtension as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateExtension as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateExtension without error using callback', async () => {
            ...
            client.innerApiCalls.updateExtension = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
    ...
    describe('importExtension', () => {
        it('invokes importExtension without error', async () => {
            ...
            client.innerApiCalls.importExtension = stubLongRunningCall(expectedResponse);
            const [operation] = await client.importExtension(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importExtension as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.importExtension as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes importExtension without error using callback', async () => {
            ...
            client.innerApiCalls.importExtension = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.importExtension(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IExtension, protos.google.cloud.aiplatform.v1beta1.IImportExtensionOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IExtension, protos.google.cloud.aiplatform.v1beta1.IImportExtensionOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importExtension as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkImportExtensionProgress without error', async () => {
            ...
            const decodedOperation = await client.checkImportExtensionProgress(expectedResponse.name);
        ...
        it('invokes checkImportExtensionProgress with error', async () => {
            ...
            await assert.rejects(client.checkImportExtensionProgress(''), expectedError);
    ...
    describe('deleteExtension', () => {
        it('invokes deleteExtension without error', async () => {
            ...
            client.innerApiCalls.deleteExtension = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteExtension(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteExtension as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteExtension as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteExtension without error using callback', async () => {
            ...
            client.innerApiCalls.deleteExtension = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes checkDeleteExtensionProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteExtensionProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteExtensionProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteExtensionProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listExtensions', () => {
        it('invokes listExtensions without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listExtensions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listExtensions as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listExtensions without error using callback', async () => {
            ...
            client.innerApiCalls.listExtensions = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listExtensionsStream without error', async () => {
            ...
            client.descriptors.page.listExtensions.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listExtensionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.Extension[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.Extension) => {
            ...
            assert((client.descriptors.page.listExtensions.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listExtensions, request));
            assert(
        ...
        it('uses async iteration with listExtensions without error', async () => {
            ...
            client.descriptors.page.listExtensions.asyncIterate = stubAsyncIterationCall(expectedResponse);
