...
export class SessionServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this.descriptors.page = {
      ...
      listEvents:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'sessionEvents')
    };
    ...
    const createSessionResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.Session') as gax.protobuf.Type;
    const createSessionMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.CreateSessionOperationMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.aiplatform.v1beta1.SessionService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.sessionServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.aiplatform.v1beta1.SessionService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.aiplatform.v1beta1.SessionService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const sessionServiceStubMethods =
        ['createSession', 'getSession', 'listSessions', 'updateSession', 'deleteSession', 'listEvents', 'appendEvent'];
 ...
 * {@link protos.google.cloud.aiplatform.v1beta1.Session|Session}.
 *
 ...
 *   The first element of the array is an object representing {@link protos.google.cloud.aiplatform.v1beta1.Session|Session}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta1/session_service.get_session.js</caption>
 * region_tag:aiplatform_v1beta1_generated_SessionService_GetSession_async
 */
  getSession(
      request?: protos.google.cloud.aiplatform.v1beta1.IGetSessionRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.ISession,
        protos.google.cloud.aiplatform.v1beta1.IGetSessionRequest|undefined, {}|undefined
      ]>;
  getSession(
      request: protos.google.cloud.aiplatform.v1beta1.IGetSessionRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1beta1.ISession,
          protos.google.cloud.aiplatform.v1beta1.IGetSessionRequest|null|undefined,
          {}|null|undefined>): void;
  getSession(
      request: protos.google.cloud.aiplatform.v1beta1.IGetSessionRequest,
      callback: Callback<
  ...
  getSession(
    ...
    return this.innerApiCalls.getSession(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.aiplatform.v1beta1.ISession,
        protos.google.cloud.aiplatform.v1beta1.IGetSessionRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getSession response %j', response);
...
/**
 * Updates the specific {@link protos.google.cloud.aiplatform.v1beta1.Session|Session}.
 *
 * @param {Object} request
 *   The request object that will be sent.
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta1/session_service.update_session.js</caption>
 * region_tag:aiplatform_v1beta1_generated_SessionService_UpdateSession_async
 */
  updateSession(
      request?: protos.google.cloud.aiplatform.v1beta1.IUpdateSessionRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.ISession,
        protos.google.cloud.aiplatform.v1beta1.IUpdateSessionRequest|undefined, {}|undefined
      ]>;
  updateSession(
      request: protos.google.cloud.aiplatform.v1beta1.IUpdateSessionRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1beta1.ISession,
          protos.google.cloud.aiplatform.v1beta1.IUpdateSessionRequest|null|undefined,
          {}|null|undefined>): void;
  updateSession(
      request: protos.google.cloud.aiplatform.v1beta1.IUpdateSessionRequest,
      callback: Callback<
  ...
  updateSession(
    ...
    return this.innerApiCalls.updateSession(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.aiplatform.v1beta1.ISession,
        protos.google.cloud.aiplatform.v1beta1.IUpdateSessionRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('updateSession response %j', response);
        return [response, options, rawResponse];
 ...
 *   Format:
 *   `projects/{project}/locations/{location}/reasoningEngines/{reasoning_engine}/sessions/{session}`
 * @param {google.cloud.aiplatform.v1beta1.SessionEvent} request.event
 *   Required. The event to append to the session.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.cloud.aiplatform.v1beta1.AppendEventResponse|AppendEventResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta1/session_service.append_event.js</caption>
 * region_tag:aiplatform_v1beta1_generated_SessionService_AppendEvent_async
 */
  appendEvent(
      request?: protos.google.cloud.aiplatform.v1beta1.IAppendEventRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.IAppendEventResponse,
        protos.google.cloud.aiplatform.v1beta1.IAppendEventRequest|undefined, {}|undefined
      ]>;
  appendEvent(
      request: protos.google.cloud.aiplatform.v1beta1.IAppendEventRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1beta1.IAppendEventResponse,
          protos.google.cloud.aiplatform.v1beta1.IAppendEventRequest|null|undefined,
          {}|null|undefined>): void;
  appendEvent(
      request: protos.google.cloud.aiplatform.v1beta1.IAppendEventRequest,
      callback: Callback<
  ...
  appendEvent(
    ...
    return this.innerApiCalls.appendEvent(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.aiplatform.v1beta1.IAppendEventResponse,
        protos.google.cloud.aiplatform.v1beta1.IAppendEventRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('appendEvent response %j', response);
        return [response, options, rawResponse];
...
/**
 * Creates a new {@link protos.google.cloud.aiplatform.v1beta1.Session|Session}.
 *
 * @param {Object} request
 *   The request object that will be sent.
 ...
 */
  createSession(
      request?: protos.google.cloud.aiplatform.v1beta1.ICreateSessionRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.aiplatform.v1beta1.ISession, protos.google.cloud.aiplatform.v1beta1.ICreateSessionOperationMetadata>,
 ...
 * region_tag:aiplatform_v1beta1_generated_SessionService_CreateSession_async
 */
  async checkCreateSessionProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1beta1.Session, protos.google.cloud.aiplatform.v1beta1.CreateSessionOperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1beta1.Session, protos.google.cloud.aiplatform.v1beta1.CreateSessionOperationMetadata>;
  }
/**
 ...
 */
  deleteSession(
      request?: protos.google.cloud.aiplatform.v1beta1.IDeleteSessionRequest,
      options?: CallOptions):
      Promise<[
 ...
 * region_tag:aiplatform_v1beta1_generated_SessionService_DeleteSession_async
 */
  async checkDeleteSessionProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata>>{
 ...
 /**
 * Lists {@link protos.google.cloud.aiplatform.v1beta1.Session|Sessions} in a given
 * reasoning engine.
 *
 * @param {Object} request
 *   The request object that will be sent.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.cloud.aiplatform.v1beta1.Session|Session}.
 ...
 */
  listSessions(
      request?: protos.google.cloud.aiplatform.v1beta1.IListSessionsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.ISession[],
        protos.google.cloud.aiplatform.v1beta1.IListSessionsRequest|null,
        protos.google.cloud.aiplatform.v1beta1.IListSessionsResponse
      ]>;
  listSessions(
      request: protos.google.cloud.aiplatform.v1beta1.IListSessionsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1beta1.IListSessionsRequest,
          protos.google.cloud.aiplatform.v1beta1.IListSessionsResponse|null|undefined,
          protos.google.cloud.aiplatform.v1beta1.ISession>): void;
  listSessions(
      request: protos.google.cloud.aiplatform.v1beta1.IListSessionsRequest,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1beta1.IListSessionsRequest,
  ...
  listSessions(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.aiplatform.v1beta1.IListSessionsRequest,
      protos.google.cloud.aiplatform.v1beta1.IListSessionsResponse|null|undefined,
      protos.google.cloud.aiplatform.v1beta1.ISession>|undefined = callback
 ...
 */
  listSessionsAsync(
      request?: protos.google.cloud.aiplatform.v1beta1.IListSessionsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.aiplatform.v1beta1.ISession>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listSessions.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.aiplatform.v1beta1.ISession>;
  }
 /**
 * Lists {@link protos.google.cloud.aiplatform.v1beta1.Event|Events} in a given session.
 *
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.cloud.aiplatform.v1beta1.SessionEvent|SessionEvent}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 ...
 */
  listEvents(
      request?: protos.google.cloud.aiplatform.v1beta1.IListEventsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.ISessionEvent[],
        protos.google.cloud.aiplatform.v1beta1.IListEventsRequest|null,
        protos.google.cloud.aiplatform.v1beta1.IListEventsResponse
      ]>;
  listEvents(
      request: protos.google.cloud.aiplatform.v1beta1.IListEventsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1beta1.IListEventsRequest,
          protos.google.cloud.aiplatform.v1beta1.IListEventsResponse|null|undefined,
          protos.google.cloud.aiplatform.v1beta1.ISessionEvent>): void;
  listEvents(
      request: protos.google.cloud.aiplatform.v1beta1.IListEventsRequest,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1beta1.IListEventsRequest,
  ...
  listEvents(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.aiplatform.v1beta1.IListEventsRequest,
      protos.google.cloud.aiplatform.v1beta1.IListEventsResponse|null|undefined,
      protos.google.cloud.aiplatform.v1beta1.ISessionEvent>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
 ...
 */
  listEventsAsync(
      request?: protos.google.cloud.aiplatform.v1beta1.IListEventsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.aiplatform.v1beta1.ISessionEvent>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listEvents.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.aiplatform.v1beta1.ISessionEvent>;
  }
/**
