...
export class FeatureOnlineStoreServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this.descriptors.stream = {
      streamingFetchFeatureValues: new this._gaxModule.StreamDescriptor(this._gaxModule.StreamType.BIDI_STREAMING, !!opts.fallback, /* gaxStreamingRetries: */ false)
    };
  ...
  initialize() {
    ...
    const featureOnlineStoreServiceStubMethods =
        ['fetchFeatureValues', 'streamingFetchFeatureValues', 'searchNearestEntities'];
