 ...
 */
import * as gapicConfig from './example_store_service_client_config.json';
 ...
 * @memberof v1beta1
 */
export class ExampleStoreServiceClient {
  ...
  exampleStoreServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof ExampleStoreServiceClient;
    ...
    this.descriptors.page = {
      listExampleStores:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'exampleStores'),
      fetchExamples:
    ...
    const createExampleStoreResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.ExampleStore') as gax.protobuf.Type;
    const createExampleStoreMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.CreateExampleStoreOperationMetadata') as gax.protobuf.Type;
    const updateExampleStoreResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.ExampleStore') as gax.protobuf.Type;
    const updateExampleStoreMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.UpdateExampleStoreOperationMetadata') as gax.protobuf.Type;
    const deleteExampleStoreResponse = protoFilesRoot.lookup(
      '.google.protobuf.Empty') as gax.protobuf.Type;
    const deleteExampleStoreMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.DeleteExampleStoreOperationMetadata') as gax.protobuf.Type;

    this.descriptors.longrunning = {
      createExampleStore: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        createExampleStoreResponse.decode.bind(createExampleStoreResponse),
        createExampleStoreMetadata.decode.bind(createExampleStoreMetadata)),
      updateExampleStore: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        updateExampleStoreResponse.decode.bind(updateExampleStoreResponse),
        updateExampleStoreMetadata.decode.bind(updateExampleStoreMetadata)),
      deleteExampleStore: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        deleteExampleStoreResponse.decode.bind(deleteExampleStoreResponse),
        deleteExampleStoreMetadata.decode.bind(deleteExampleStoreMetadata))
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.aiplatform.v1beta1.ExampleStoreService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.exampleStoreServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.aiplatform.v1beta1.ExampleStoreService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.aiplatform.v1beta1.ExampleStoreService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const exampleStoreServiceStubMethods =
        ['createExampleStore', 'getExampleStore', 'updateExampleStore', 'deleteExampleStore', 'listExampleStores', 'upsertExamples', 'removeExamples', 'searchExamples', 'fetchExamples'];
    for (const methodName of exampleStoreServiceStubMethods) {
      const callPromise = this.exampleStoreServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 */
  getExampleStore(
      request?: protos.google.cloud.aiplatform.v1beta1.IGetExampleStoreRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.IExampleStore,
        protos.google.cloud.aiplatform.v1beta1.IGetExampleStoreRequest|undefined, {}|undefined
      ]>;
  getExampleStore(
      request: protos.google.cloud.aiplatform.v1beta1.IGetExampleStoreRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1beta1.IExampleStore,
          protos.google.cloud.aiplatform.v1beta1.IGetExampleStoreRequest|null|undefined,
          {}|null|undefined>): void;
  getExampleStore(
      request: protos.google.cloud.aiplatform.v1beta1.IGetExampleStoreRequest,
      callback: Callback<
 ...
 */
  upsertExamples(
      request?: protos.google.cloud.aiplatform.v1beta1.IUpsertExamplesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.IUpsertExamplesResponse,
        protos.google.cloud.aiplatform.v1beta1.IUpsertExamplesRequest|undefined, {}|undefined
      ]>;
  upsertExamples(
      request: protos.google.cloud.aiplatform.v1beta1.IUpsertExamplesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1beta1.IUpsertExamplesResponse,
          protos.google.cloud.aiplatform.v1beta1.IUpsertExamplesRequest|null|undefined,
          {}|null|undefined>): void;
  upsertExamples(
      request: protos.google.cloud.aiplatform.v1beta1.IUpsertExamplesRequest,
      callback: Callback<
 ...
 */
  removeExamples(
      request?: protos.google.cloud.aiplatform.v1beta1.IRemoveExamplesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.IRemoveExamplesResponse,
        protos.google.cloud.aiplatform.v1beta1.IRemoveExamplesRequest|undefined, {}|undefined
      ]>;
  removeExamples(
      request: protos.google.cloud.aiplatform.v1beta1.IRemoveExamplesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1beta1.IRemoveExamplesResponse,
          protos.google.cloud.aiplatform.v1beta1.IRemoveExamplesRequest|null|undefined,
          {}|null|undefined>): void;
  removeExamples(
      request: protos.google.cloud.aiplatform.v1beta1.IRemoveExamplesRequest,
      callback: Callback<
 ...
 */
  searchExamples(
      request?: protos.google.cloud.aiplatform.v1beta1.ISearchExamplesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.ISearchExamplesResponse,
        protos.google.cloud.aiplatform.v1beta1.ISearchExamplesRequest|undefined, {}|undefined
      ]>;
  searchExamples(
      request: protos.google.cloud.aiplatform.v1beta1.ISearchExamplesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1beta1.ISearchExamplesResponse,
          protos.google.cloud.aiplatform.v1beta1.ISearchExamplesRequest|null|undefined,
          {}|null|undefined>): void;
  searchExamples(
      request: protos.google.cloud.aiplatform.v1beta1.ISearchExamplesRequest,
      callback: Callback<
 ...
 */
  createExampleStore(
      request?: protos.google.cloud.aiplatform.v1beta1.ICreateExampleStoreRequest,
      options?: CallOptions):
      Promise<[
 ...
 * region_tag:aiplatform_v1beta1_generated_ExampleStoreService_CreateExampleStore_async
 */
  async checkCreateExampleStoreProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1beta1.ExampleStore, protos.google.cloud.aiplatform.v1beta1.CreateExampleStoreOperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1beta1.ExampleStore, protos.google.cloud.aiplatform.v1beta1.CreateExampleStoreOperationMetadata>;
  }
/**
 ...
 */
  updateExampleStore(
      request?: protos.google.cloud.aiplatform.v1beta1.IUpdateExampleStoreRequest,
      options?: CallOptions):
      Promise<[
 ...
 * region_tag:aiplatform_v1beta1_generated_ExampleStoreService_UpdateExampleStore_async
 */
  async checkUpdateExampleStoreProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1beta1.ExampleStore, protos.google.cloud.aiplatform.v1beta1.UpdateExampleStoreOperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1beta1.ExampleStore, protos.google.cloud.aiplatform.v1beta1.UpdateExampleStoreOperationMetadata>;
  }
/**
 ...
 */
  deleteExampleStore(
      request?: protos.google.cloud.aiplatform.v1beta1.IDeleteExampleStoreRequest,
      options?: CallOptions):
      Promise<[
 ...
 * region_tag:aiplatform_v1beta1_generated_ExampleStoreService_DeleteExampleStore_async
 */
  async checkDeleteExampleStoreProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.aiplatform.v1beta1.DeleteExampleStoreOperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.protobuf.Empty, protos.google.cloud.aiplatform.v1beta1.DeleteExampleStoreOperationMetadata>;
  }
 /**
 ...
 */
  listExampleStores(
      request?: protos.google.cloud.aiplatform.v1beta1.IListExampleStoresRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.IExampleStore[],
  ...
  listExampleStores(
      ...
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1beta1.IListExampleStoresRequest,
          protos.google.cloud.aiplatform.v1beta1.IListExampleStoresResponse|null|undefined,
          protos.google.cloud.aiplatform.v1beta1.IExampleStore>): void;
  listExampleStores(
      request: protos.google.cloud.aiplatform.v1beta1.IListExampleStoresRequest,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1beta1.IListExampleStoresRequest,
  ...
  listExampleStores(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.aiplatform.v1beta1.IListExampleStoresRequest,
      protos.google.cloud.aiplatform.v1beta1.IListExampleStoresResponse|null|undefined,
      protos.google.cloud.aiplatform.v1beta1.IExampleStore>|undefined = callback
 ...
 */
  listExampleStoresStream(
    ...
    return this.descriptors.page.listExampleStores.createStream(
      this.innerApiCalls.listExampleStores as GaxCall,
      request,
      callSettings
    );
  }
 ...
 */
  listExampleStoresAsync(
      request?: protos.google.cloud.aiplatform.v1beta1.IListExampleStoresRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.aiplatform.v1beta1.IExampleStore>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listExampleStores.asyncIterate(
      this.innerApiCalls['listExampleStores'] as GaxCall,
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.aiplatform.v1beta1.IExampleStore>;
  }
 /**
 ...
 */
  fetchExamples(
      request?: protos.google.cloud.aiplatform.v1beta1.IFetchExamplesRequest,
      options?: CallOptions):
      Promise<[
  ...
  fetchExamples(
      ...
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1beta1.IFetchExamplesRequest,
          protos.google.cloud.aiplatform.v1beta1.IFetchExamplesResponse|null|undefined,
          protos.google.cloud.aiplatform.v1beta1.IExample>): void;
  fetchExamples(
      request: protos.google.cloud.aiplatform.v1beta1.IFetchExamplesRequest,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1beta1.IFetchExamplesRequest,
  ...
  fetchExamples(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.aiplatform.v1beta1.IFetchExamplesRequest,
      protos.google.cloud.aiplatform.v1beta1.IFetchExamplesResponse|null|undefined,
      protos.google.cloud.aiplatform.v1beta1.IExample>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
 ...
 */
  fetchExamplesStream(
    ...
    return this.descriptors.page.fetchExamples.createStream(
      this.innerApiCalls.fetchExamples as GaxCall,
      request,
      callSettings
    );
  }
 ...
 */
  fetchExamplesAsync(
      request?: protos.google.cloud.aiplatform.v1beta1.IFetchExamplesRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.aiplatform.v1beta1.IExample>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.fetchExamples.asyncIterate(
      this.innerApiCalls['fetchExamples'] as GaxCall,
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.aiplatform.v1beta1.IExample>;
  }
/**
