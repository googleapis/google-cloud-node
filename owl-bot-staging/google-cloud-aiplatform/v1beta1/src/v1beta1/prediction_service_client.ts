...
export class PredictionServiceClient {
  ...
  initialize() {
    ...
    const predictionServiceStubMethods =
        ['predict', 'rawPredict', 'directPredict', 'directRawPredict', 'streamingPredict', 'serverStreamingPredict', 'streamingRawPredict', 'explain', 'countTokens', 'streamGenerateContent'];
