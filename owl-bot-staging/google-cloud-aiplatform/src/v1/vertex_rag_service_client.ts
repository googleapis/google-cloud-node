...
export class VertexRagServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const asyncRetrieveContextsResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.AsyncRetrieveContextsResponse') as gax.protobuf.Type;
    const asyncRetrieveContextsMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.AsyncRetrieveContextsOperationMetadata') as gax.protobuf.Type;

    this.descriptors.longrunning = {
      asyncRetrieveContexts: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        asyncRetrieveContextsResponse.decode.bind(asyncRetrieveContextsResponse),
        asyncRetrieveContextsMetadata.decode.bind(asyncRetrieveContextsMetadata))
    };
  ...
  initialize() {
    ...
    const vertexRagServiceStubMethods =
        ['retrieveContexts', 'augmentPrompt', 'corroborateContent', 'askContexts', 'asyncRetrieveContexts'];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.cloud.aiplatform.v1.AskContextsResponse|AskContextsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/vertex_rag_service.ask_contexts.js</caption>
 * region_tag:aiplatform_v1_generated_VertexRagService_AskContexts_async
 */
  askContexts(
      request?: protos.google.cloud.aiplatform.v1.IAskContextsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1.IAskContextsResponse,
        protos.google.cloud.aiplatform.v1.IAskContextsRequest|undefined, {}|undefined
      ]>;
  askContexts(
      request: protos.google.cloud.aiplatform.v1.IAskContextsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1.IAskContextsResponse,
          protos.google.cloud.aiplatform.v1.IAskContextsRequest|null|undefined,
          {}|null|undefined>): void;
  askContexts(
      request: protos.google.cloud.aiplatform.v1.IAskContextsRequest,
      callback: Callback<
  ...
  askContexts(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('askContexts request %j', request);
    const wrappedCallback: Callback<
        protos.google.cloud.aiplatform.v1.IAskContextsResponse,
        protos.google.cloud.aiplatform.v1.IAskContextsRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('askContexts response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.askContexts(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.aiplatform.v1.IAskContextsResponse,
        protos.google.cloud.aiplatform.v1.IAskContextsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('askContexts response %j', response);
        return [response, options, rawResponse];
 ...
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/vertex_rag_service.async_retrieve_contexts.js</caption>
 * region_tag:aiplatform_v1_generated_VertexRagService_AsyncRetrieveContexts_async
 */
  asyncRetrieveContexts(
      request?: protos.google.cloud.aiplatform.v1.IAsyncRetrieveContextsRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.aiplatform.v1.IAsyncRetrieveContextsResponse, protos.google.cloud.aiplatform.v1.IAsyncRetrieveContextsOperationMetadata>,
  ...
  asyncRetrieveContexts(
    ...
    const wrappedCallback: Callback<
      ...
      ? (error, response, rawResponse, _) => {
          this._log.info('asyncRetrieveContexts response %j', rawResponse);
          callback!(error, response, rawResponse, _); // We verified callback above.
        }
      : undefined;
    this._log.info('asyncRetrieveContexts request %j', request);
    return this.innerApiCalls.asyncRetrieveContexts(request, options, wrappedCallback)
...
/**
 * Check the status of the long running operation returned by `asyncRetrieveContexts()`.
 * @param {String} name
 ...
 * region_tag:aiplatform_v1_generated_VertexRagService_AsyncRetrieveContexts_async
 */
  async checkAsyncRetrieveContextsProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1.AsyncRetrieveContextsResponse, protos.google.cloud.aiplatform.v1.AsyncRetrieveContextsOperationMetadata>>{
    this._log.info('asyncRetrieveContexts long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.asyncRetrieveContexts, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1.AsyncRetrieveContextsResponse, protos.google.cloud.aiplatform.v1.AsyncRetrieveContextsOperationMetadata>;
  }
/**
