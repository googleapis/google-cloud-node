...
export class EndpointServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const createEndpointResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.Endpoint') as gax.protobuf.Type;
    const createEndpointMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.CreateEndpointOperationMetadata') as gax.protobuf.Type;
    ...
    const updateEndpointLongRunningMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.UpdateEndpointOperationMetadata') as gax.protobuf.Type;
    ...
    const deployModelResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.DeployModelResponse') as gax.protobuf.Type;
    const deployModelMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.DeployModelOperationMetadata') as gax.protobuf.Type;
    const undeployModelResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.UndeployModelResponse') as gax.protobuf.Type;
    const undeployModelMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.UndeployModelOperationMetadata') as gax.protobuf.Type;
    const mutateDeployedModelResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.MutateDeployedModelResponse') as gax.protobuf.Type;
    const mutateDeployedModelMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.MutateDeployedModelOperationMetadata') as gax.protobuf.Type;
    ...
    this.descriptors.longrunning = {
      ...
      updateEndpointLongRunning: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        updateEndpointLongRunningResponse.decode.bind(updateEndpointLongRunningResponse),
        updateEndpointLongRunningMetadata.decode.bind(updateEndpointLongRunningMetadata)),
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.aiplatform.v1.EndpointService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.endpointServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.aiplatform.v1.EndpointService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.aiplatform.v1.EndpointService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const endpointServiceStubMethods =
        ['createEndpoint', 'getEndpoint', 'listEndpoints', 'updateEndpoint', 'updateEndpointLongRunning', 'deleteEndpoint', 'deployModel', 'undeployModel', 'mutateDeployedModel'];
 ...
 */
  getEndpoint(
      ...
      Promise<[
        ...
        protos.google.cloud.aiplatform.v1.IGetEndpointRequest|undefined, {}|undefined
      ]>;
  getEndpoint(
      request: protos.google.cloud.aiplatform.v1.IGetEndpointRequest,
      options: CallOptions,
 ...
 */
  updateEndpoint(
      ...
      Promise<[
        protos.google.cloud.aiplatform.v1.IEndpoint,
        protos.google.cloud.aiplatform.v1.IUpdateEndpointRequest|undefined, {}|undefined
      ]>;
  updateEndpoint(
      request: protos.google.cloud.aiplatform.v1.IUpdateEndpointRequest,
      options: CallOptions,
  ...
  updateEndpoint(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.updateEndpoint(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.aiplatform.v1.IEndpoint,
 ...
 * region_tag:aiplatform_v1_generated_EndpointService_CreateEndpoint_async
 */
  async checkCreateEndpointProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1.Endpoint, protos.google.cloud.aiplatform.v1.CreateEndpointOperationMetadata>>{
 ...
 */
  updateEndpointLongRunning(
      ...
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.aiplatform.v1.IEndpoint, protos.google.cloud.aiplatform.v1.IUpdateEndpointOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
      ]>;
  updateEndpointLongRunning(
      request: protos.google.cloud.aiplatform.v1.IUpdateEndpointLongRunningRequest,
  ...
  updateEndpointLongRunning(
    ...
    const wrappedCallback: Callback<
          ...
          {}|null|undefined>|undefined = callback
      ? (error, response, rawResponse, _) => {
          this._log.info('updateEndpointLongRunning response %j', rawResponse);
          callback!(error, response, rawResponse, _); // We verified callback above.
        }
      : undefined;
    this._log.info('updateEndpointLongRunning request %j', request);
    return this.innerApiCalls.updateEndpointLongRunning(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.aiplatform.v1.IEndpoint, protos.google.cloud.aiplatform.v1.IUpdateEndpointOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:aiplatform_v1_generated_EndpointService_UpdateEndpointLongRunning_async
 */
  async checkUpdateEndpointLongRunningProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1.Endpoint, protos.google.cloud.aiplatform.v1.UpdateEndpointOperationMetadata>>{
    this._log.info('updateEndpointLongRunning long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.updateEndpointLongRunning, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1.Endpoint, protos.google.cloud.aiplatform.v1.UpdateEndpointOperationMetadata>;
  }
/**
 * Deletes an Endpoint.
 *
 ...
 * region_tag:aiplatform_v1_generated_EndpointService_DeleteEndpoint_async
 */
  async checkDeleteEndpointProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.aiplatform.v1.DeleteOperationMetadata>>{
 ...
 * region_tag:aiplatform_v1_generated_EndpointService_DeployModel_async
 */
  async checkDeployModelProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1.DeployModelResponse, protos.google.cloud.aiplatform.v1.DeployModelOperationMetadata>>{
 ...
 * region_tag:aiplatform_v1_generated_EndpointService_UndeployModel_async
 */
  async checkUndeployModelProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1.UndeployModelResponse, protos.google.cloud.aiplatform.v1.UndeployModelOperationMetadata>>{
 ...
 */
  ...
  mutateDeployedModel(
    ...
    const wrappedCallback: Callback<
          ...
          {}|null|undefined>|undefined = callback
      ? (error, response, rawResponse, _) => {
          this._log.info('mutateDeployedModel response %j', rawResponse);
          callback!(error, response, rawResponse, _); // We verified callback above.
        }
      : undefined;
    this._log.info('mutateDeployedModel request %j', request);
    return this.innerApiCalls.mutateDeployedModel(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.aiplatform.v1.IMutateDeployedModelResponse, protos.google.cloud.aiplatform.v1.IMutateDeployedModelOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:aiplatform_v1_generated_EndpointService_MutateDeployedModel_async
 */
  async checkMutateDeployedModelProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1.MutateDeployedModelResponse, protos.google.cloud.aiplatform.v1.MutateDeployedModelOperationMetadata>>{
    this._log.info('mutateDeployedModel long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    ...
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1.MutateDeployedModelResponse, protos.google.cloud.aiplatform.v1.MutateDeployedModelOperationMetadata>;
  }
 /**
 ...
 */
  ...
  listEndpoints(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.aiplatform.v1.IEndpoint>): void;
  listEndpoints(
      request: protos.google.cloud.aiplatform.v1.IListEndpointsRequest,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1.IListEndpointsRequest,
  ...
  listEndpoints(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.aiplatform.v1.IListEndpointsRequest,
      protos.google.cloud.aiplatform.v1.IListEndpointsResponse|null|undefined,
      protos.google.cloud.aiplatform.v1.IEndpoint>|undefined = callback
 ...
 */
  listEndpointsAsync(
      request?: protos.google.cloud.aiplatform.v1.IListEndpointsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.aiplatform.v1.IEndpoint>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listEndpoints.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.aiplatform.v1.IEndpoint>;
  }
/**
