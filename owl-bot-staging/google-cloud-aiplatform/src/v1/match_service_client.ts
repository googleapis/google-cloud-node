 ...
 */
import * as gapicConfig from './match_service_client_config.json';
...
export class MatchServiceClient {
  ...
  matchServiceStub?: Promise<{ [name: string]: Function }>;
  ...
  constructor(
    ...
    const staticMembers = this.constructor as typeof MatchServiceClient;
    if (
  ...
  initialize() {
    ...
    // google.cloud.aiplatform.v1.MatchService.
    this.matchServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ? (this._protos as protobuf.Root).lookupService(
            'google.cloud.aiplatform.v1.MatchService',
          )
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.aiplatform.v1.MatchService,
      this._opts,
      this._providedCustomServicePath,
    ...
    for (const methodName of matchServiceStubMethods) {
      const callPromise = this.matchServiceStub.then(
        (stub) =>
          (...args: Array<{}>) => {
            if (this._terminated) {
   ...
   */
  findNeighbors(
    request?: protos.google.cloud.aiplatform.v1.IFindNeighborsRequest,
    options?: CallOptions,
  ): Promise<
    [
   ...
   */
  readIndexDatapoints(
    request?: protos.google.cloud.aiplatform.v1.IReadIndexDatapointsRequest,
    options?: CallOptions,
  ): Promise<
    [
