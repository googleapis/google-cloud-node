 ...
 * `src/v1/reasoning_engine_execution_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './reasoning_engine_execution_service_client_config.json';
...
export class ReasoningEngineExecutionServiceClient {
  ...
  reasoningEngineExecutionServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof ReasoningEngineExecutionServiceClient;
    ...
    this.descriptors.stream = {
      streamQueryReasoningEngine: new this._gaxModule.StreamDescriptor(this._gaxModule.StreamType.SERVER_STREAMING, !!opts.fallback, !!opts.gaxServerStreamingRetries)
    };
    ...
    const asyncQueryReasoningEngineResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.AsyncQueryReasoningEngineResponse') as gax.protobuf.Type;
    const asyncQueryReasoningEngineMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.AsyncQueryReasoningEngineOperationMetadata') as gax.protobuf.Type;

    this.descriptors.longrunning = {
      asyncQueryReasoningEngine: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        asyncQueryReasoningEngineResponse.decode.bind(asyncQueryReasoningEngineResponse),
        asyncQueryReasoningEngineMetadata.decode.bind(asyncQueryReasoningEngineMetadata))
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.aiplatform.v1.ReasoningEngineExecutionService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.reasoningEngineExecutionServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.aiplatform.v1.ReasoningEngineExecutionService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.aiplatform.v1.ReasoningEngineExecutionService,
 ...
 *   The first element of the array is an object representing {@link protos.google.cloud.aiplatform.v1.QueryReasoningEngineResponse|QueryReasoningEngineResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/reasoning_engine_execution_service.query_reasoning_engine.js</caption>
 * region_tag:aiplatform_v1_generated_ReasoningEngineExecutionService_QueryReasoningEngine_async
 */
  queryReasoningEngine(
      request?: protos.google.cloud.aiplatform.v1.IQueryReasoningEngineRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1.IQueryReasoningEngineResponse,
        protos.google.cloud.aiplatform.v1.IQueryReasoningEngineRequest|undefined, {}|undefined
      ]>;
  queryReasoningEngine(
      request: protos.google.cloud.aiplatform.v1.IQueryReasoningEngineRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1.IQueryReasoningEngineResponse,
          protos.google.cloud.aiplatform.v1.IQueryReasoningEngineRequest|null|undefined,
          {}|null|undefined>): void;
  queryReasoningEngine(
      request: protos.google.cloud.aiplatform.v1.IQueryReasoningEngineRequest,
      callback: Callback<
  ...
  queryReasoningEngine(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.queryReasoningEngine(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.aiplatform.v1.IQueryReasoningEngineResponse,
        protos.google.cloud.aiplatform.v1.IQueryReasoningEngineRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('queryReasoningEngine response %j', response);
 ...
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/reasoning_engine_execution_service.stream_query_reasoning_engine.js</caption>
 * region_tag:aiplatform_v1_generated_ReasoningEngineExecutionService_StreamQueryReasoningEngine_async
 */
 ...
 *   Format:
 *   `projects/{project}/locations/{location}/reasoningEngines/{reasoning_engine}`
 * @param {string} [request.inputGcsUri]
 ...
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/reasoning_engine_execution_service.async_query_reasoning_engine.js</caption>
 * region_tag:aiplatform_v1_generated_ReasoningEngineExecutionService_AsyncQueryReasoningEngine_async
 */
  asyncQueryReasoningEngine(
      request?: protos.google.cloud.aiplatform.v1.IAsyncQueryReasoningEngineRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.aiplatform.v1.IAsyncQueryReasoningEngineResponse, protos.google.cloud.aiplatform.v1.IAsyncQueryReasoningEngineOperationMetadata>,
  ...
  asyncQueryReasoningEngine(
    ...
    const wrappedCallback: Callback<
      ...
      ? (error, response, rawResponse, _) => {
          this._log.info('asyncQueryReasoningEngine response %j', rawResponse);
          callback!(error, response, rawResponse, _); // We verified callback above.
        }
      : undefined;
    this._log.info('asyncQueryReasoningEngine request %j', request);
    return this.innerApiCalls.asyncQueryReasoningEngine(request, options, wrappedCallback)
...
/**
 * Check the status of the long running operation returned by `asyncQueryReasoningEngine()`.
 * @param {String} name
 ...
 * region_tag:aiplatform_v1_generated_ReasoningEngineExecutionService_AsyncQueryReasoningEngine_async
 */
  async checkAsyncQueryReasoningEngineProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1.AsyncQueryReasoningEngineResponse, protos.google.cloud.aiplatform.v1.AsyncQueryReasoningEngineOperationMetadata>>{
    this._log.info('asyncQueryReasoningEngine long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.asyncQueryReasoningEngine, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1.AsyncQueryReasoningEngineResponse, protos.google.cloud.aiplatform.v1.AsyncQueryReasoningEngineOperationMetadata>;
  }
/**
