...
export class PredictionServiceClient {
  ...
  initialize() {
    ...
    const predictionServiceStubMethods =
        ['predict', 'rawPredict', 'streamRawPredict', 'directPredict', 'directRawPredict', 'streamDirectPredict', 'streamDirectRawPredict', 'streamingPredict', 'serverStreamingPredict', 'streamingRawPredict', 'explain', 'countTokens', 'generateContent', 'streamGenerateContent', 'chatCompletions', 'embedContent'];
 ...
 */
  embedContent(
      request?: protos.google.cloud.aiplatform.v1beta1.IEmbedContentRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.IEmbedContentResponse,
        protos.google.cloud.aiplatform.v1beta1.IEmbedContentRequest|undefined, {}|undefined
      ]>;
  embedContent(
      request: protos.google.cloud.aiplatform.v1beta1.IEmbedContentRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1beta1.IEmbedContentResponse,
          protos.google.cloud.aiplatform.v1beta1.IEmbedContentRequest|null|undefined,
          {}|null|undefined>): void;
  embedContent(
      request: protos.google.cloud.aiplatform.v1beta1.IEmbedContentRequest,
      callback: Callback<
