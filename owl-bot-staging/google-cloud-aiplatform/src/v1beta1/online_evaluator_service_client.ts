 ...
 * `src/v1beta1/online_evaluator_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './online_evaluator_service_client_config.json';
 ...
 * @memberof v1beta1
 */
export class OnlineEvaluatorServiceClient {
  ...
  onlineEvaluatorServiceStub?: Promise<{ [name: string]: Function }>;

  /**
   * Construct an instance of OnlineEvaluatorServiceClient.
   *
   ...
   *     const client = new OnlineEvaluatorServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(
    opts?: ClientOptions,
    ...
    const staticMembers = this
      .constructor as typeof OnlineEvaluatorServiceClient;
    if (
    ...
    this.descriptors.page = {
      listOnlineEvaluators: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'onlineEvaluators',
      ),
    ...
    const createOnlineEvaluatorResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.OnlineEvaluator',
    ) as gax.protobuf.Type;
    const createOnlineEvaluatorMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.CreateOnlineEvaluatorOperationMetadata',
    ) as gax.protobuf.Type;
    const updateOnlineEvaluatorResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.OnlineEvaluator',
    ) as gax.protobuf.Type;
    const updateOnlineEvaluatorMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.UpdateOnlineEvaluatorOperationMetadata',
    ) as gax.protobuf.Type;
    const deleteOnlineEvaluatorResponse = protoFilesRoot.lookup(
      '.google.protobuf.Empty',
    ) as gax.protobuf.Type;
    const deleteOnlineEvaluatorMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.DeleteOnlineEvaluatorOperationMetadata',
    ) as gax.protobuf.Type;
    const activateOnlineEvaluatorResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.OnlineEvaluator',
    ) as gax.protobuf.Type;
    const activateOnlineEvaluatorMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.ActivateOnlineEvaluatorOperationMetadata',
    ) as gax.protobuf.Type;
    const suspendOnlineEvaluatorResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.OnlineEvaluator',
    ) as gax.protobuf.Type;
    const suspendOnlineEvaluatorMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.SuspendOnlineEvaluatorOperationMetadata',
    ) as gax.protobuf.Type;

    this.descriptors.longrunning = {
      createOnlineEvaluator: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        createOnlineEvaluatorResponse.decode.bind(
          createOnlineEvaluatorResponse,
        ),
        createOnlineEvaluatorMetadata.decode.bind(
          createOnlineEvaluatorMetadata,
        ),
      ),
      updateOnlineEvaluator: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        updateOnlineEvaluatorResponse.decode.bind(
          updateOnlineEvaluatorResponse,
        ),
        updateOnlineEvaluatorMetadata.decode.bind(
          updateOnlineEvaluatorMetadata,
        ),
      ),
      deleteOnlineEvaluator: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        deleteOnlineEvaluatorResponse.decode.bind(
          deleteOnlineEvaluatorResponse,
        ),
        deleteOnlineEvaluatorMetadata.decode.bind(
          deleteOnlineEvaluatorMetadata,
        ),
      ),
      activateOnlineEvaluator: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        activateOnlineEvaluatorResponse.decode.bind(
          activateOnlineEvaluatorResponse,
        ),
        activateOnlineEvaluatorMetadata.decode.bind(
          activateOnlineEvaluatorMetadata,
        ),
      ),
      suspendOnlineEvaluator: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        suspendOnlineEvaluatorResponse.decode.bind(
          suspendOnlineEvaluatorResponse,
        ),
        suspendOnlineEvaluatorMetadata.decode.bind(
          suspendOnlineEvaluatorMetadata,
        ),
      ),
    };
  ...
  initialize() {
    ...
    if (this.onlineEvaluatorServiceStub) {
      return this.onlineEvaluatorServiceStub;
    }

    // Put together the "service stub" for
    // google.cloud.aiplatform.v1beta1.OnlineEvaluatorService.
    this.onlineEvaluatorServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
    ...
    const onlineEvaluatorServiceStubMethods = [
    ...
    for (const methodName of onlineEvaluatorServiceStubMethods) {
      const callPromise = this.onlineEvaluatorServiceStub.then(
        (stub) =>
          (...args: Array<{}>) => {
            if (this._terminated) {
   ...
   *   The first element of the array is an object representing {@link protos.google.cloud.aiplatform.v1beta1.OnlineEvaluator|OnlineEvaluator}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta1/online_evaluator_service.get_online_evaluator.js</caption>
   * region_tag:aiplatform_v1beta1_generated_OnlineEvaluatorService_GetOnlineEvaluator_async
   */
  getOnlineEvaluator(
    request?: protos.google.cloud.aiplatform.v1beta1.IGetOnlineEvaluatorRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator,
      (
        | protos.google.cloud.aiplatform.v1beta1.IGetOnlineEvaluatorRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    this._log.info('getOnlineEvaluator request %j', request);
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('getOnlineEvaluator response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .getOnlineEvaluator(request, options, wrappedCallback)
      ?.then(
   ...
   * @param {google.cloud.aiplatform.v1beta1.OnlineEvaluator} request.onlineEvaluator
   ...
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta1/online_evaluator_service.create_online_evaluator.js</caption>
   * region_tag:aiplatform_v1beta1_generated_OnlineEvaluatorService_CreateOnlineEvaluator_async
   */
  createOnlineEvaluator(
    request?: protos.google.cloud.aiplatform.v1beta1.ICreateOnlineEvaluatorRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<
        protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator,
        protos.google.cloud.aiplatform.v1beta1.ICreateOnlineEvaluatorOperationMetadata
      >,
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, rawResponse, _) => {
          this._log.info('createOnlineEvaluator response %j', rawResponse);
          callback!(error, response, rawResponse, _); // We verified callback above.
        }
      : undefined;
    this._log.info('createOnlineEvaluator request %j', request);
    return this.innerApiCalls
      .createOnlineEvaluator(request, options, wrappedCallback)
      ?.then(
  ...
  /**
   * Check the status of the long running operation returned by `createOnlineEvaluator()`.
   * @param {String} name
   ...
   * region_tag:aiplatform_v1beta1_generated_OnlineEvaluatorService_CreateOnlineEvaluator_async
   */
  async checkCreateOnlineEvaluatorProgress(
    name: string,
  ): Promise<
    LROperation<
      protos.google.cloud.aiplatform.v1beta1.OnlineEvaluator,
      protos.google.cloud.aiplatform.v1beta1.CreateOnlineEvaluatorOperationMetadata
    >
  > {
    this._log.info('createOnlineEvaluator long-running');
    const request =
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.createOnlineEvaluator,
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta1/online_evaluator_service.update_online_evaluator.js</caption>
   * region_tag:aiplatform_v1beta1_generated_OnlineEvaluatorService_UpdateOnlineEvaluator_async
   */
  updateOnlineEvaluator(
    request?: protos.google.cloud.aiplatform.v1beta1.IUpdateOnlineEvaluatorRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<
        protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator,
        protos.google.cloud.aiplatform.v1beta1.IUpdateOnlineEvaluatorOperationMetadata
      >,
      protos.google.longrunning.IOperation | undefined,
      {} | undefined,
    ]
  ...
  > | void {
    ...
    options.otherArgs.headers['x-goog-request-params'] =
      this._gaxModule.routingHeader.fromParams({
        'online_evaluator.name': request.onlineEvaluator!.name ?? '',
      });
    this.initialize().catch((err) => {
      throw err;
    });
    const wrappedCallback:
      ...
      | undefined = callback
      ? (error, response, rawResponse, _) => {
          this._log.info('updateOnlineEvaluator response %j', rawResponse);
          callback!(error, response, rawResponse, _); // We verified callback above.
        }
      : undefined;
    this._log.info('updateOnlineEvaluator request %j', request);
    return this.innerApiCalls
      .updateOnlineEvaluator(request, options, wrappedCallback)
      ?.then(
        ([response, rawResponse, _]: [
          LROperation<
            protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator,
  ...
  /**
   * Check the status of the long running operation returned by `updateOnlineEvaluator()`.
   * @param {String} name
   *   The operation name that will be passed.
   * @returns {Promise} - The promise which resolves to an object.
   *   The decoded operation object has result and metadata field to get information from.
   ...
   * region_tag:aiplatform_v1beta1_generated_OnlineEvaluatorService_UpdateOnlineEvaluator_async
   */
  async checkUpdateOnlineEvaluatorProgress(
    name: string,
  ): Promise<
    LROperation<
      protos.google.cloud.aiplatform.v1beta1.OnlineEvaluator,
      protos.google.cloud.aiplatform.v1beta1.UpdateOnlineEvaluatorOperationMetadata
    >
  > {
    this._log.info('updateOnlineEvaluator long-running');
    const request =
      new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest(
        { name },
      );
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.updateOnlineEvaluator,
      this._gaxModule.createDefaultBackoffSettings(),
    );
    return decodeOperation as LROperation<
      protos.google.cloud.aiplatform.v1beta1.OnlineEvaluator,
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta1/online_evaluator_service.delete_online_evaluator.js</caption>
   * region_tag:aiplatform_v1beta1_generated_OnlineEvaluatorService_DeleteOnlineEvaluator_async
   */
  deleteOnlineEvaluator(
    request?: protos.google.cloud.aiplatform.v1beta1.IDeleteOnlineEvaluatorRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<
        protos.google.protobuf.IEmpty,
        protos.google.cloud.aiplatform.v1beta1.IDeleteOnlineEvaluatorOperationMetadata
      >,
      protos.google.longrunning.IOperation | undefined,
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      | undefined = callback
      ? (error, response, rawResponse, _) => {
          this._log.info('deleteOnlineEvaluator response %j', rawResponse);
          callback!(error, response, rawResponse, _); // We verified callback above.
        }
      : undefined;
    this._log.info('deleteOnlineEvaluator request %j', request);
    return this.innerApiCalls
      .deleteOnlineEvaluator(request, options, wrappedCallback)
      ?.then(
        ([response, rawResponse, _]: [
          LROperation<
            protos.google.protobuf.IEmpty,
  ...
  /**
   * Check the status of the long running operation returned by `deleteOnlineEvaluator()`.
   * @param {String} name
   *   The operation name that will be passed.
   * @returns {Promise} - The promise which resolves to an object.
   *   The decoded operation object has result and metadata field to get information from.
   ...
   * region_tag:aiplatform_v1beta1_generated_OnlineEvaluatorService_DeleteOnlineEvaluator_async
   */
  async checkDeleteOnlineEvaluatorProgress(
    name: string,
  ): Promise<
    LROperation<
      protos.google.protobuf.Empty,
      protos.google.cloud.aiplatform.v1beta1.DeleteOnlineEvaluatorOperationMetadata
    >
  > {
    this._log.info('deleteOnlineEvaluator long-running');
    const request =
      new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest(
        { name },
      );
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.deleteOnlineEvaluator,
      this._gaxModule.createDefaultBackoffSettings(),
    );
    return decodeOperation as LROperation<
      protos.google.protobuf.Empty,
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta1/online_evaluator_service.activate_online_evaluator.js</caption>
   * region_tag:aiplatform_v1beta1_generated_OnlineEvaluatorService_ActivateOnlineEvaluator_async
   */
  activateOnlineEvaluator(
    request?: protos.google.cloud.aiplatform.v1beta1.IActivateOnlineEvaluatorRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<
        protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator,
        protos.google.cloud.aiplatform.v1beta1.IActivateOnlineEvaluatorOperationMetadata
      >,
      protos.google.longrunning.IOperation | undefined,
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      | undefined = callback
      ? (error, response, rawResponse, _) => {
          this._log.info('activateOnlineEvaluator response %j', rawResponse);
          callback!(error, response, rawResponse, _); // We verified callback above.
        }
      : undefined;
    this._log.info('activateOnlineEvaluator request %j', request);
    return this.innerApiCalls
      .activateOnlineEvaluator(request, options, wrappedCallback)
      ?.then(
        ([response, rawResponse, _]: [
          LROperation<
            protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator,
  ...
  /**
   * Check the status of the long running operation returned by `activateOnlineEvaluator()`.
   * @param {String} name
   *   The operation name that will be passed.
   * @returns {Promise} - The promise which resolves to an object.
   *   The decoded operation object has result and metadata field to get information from.
   ...
   * region_tag:aiplatform_v1beta1_generated_OnlineEvaluatorService_ActivateOnlineEvaluator_async
   */
  async checkActivateOnlineEvaluatorProgress(
    name: string,
  ): Promise<
    LROperation<
      protos.google.cloud.aiplatform.v1beta1.OnlineEvaluator,
      protos.google.cloud.aiplatform.v1beta1.ActivateOnlineEvaluatorOperationMetadata
    >
  > {
    this._log.info('activateOnlineEvaluator long-running');
    const request =
      new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest(
        { name },
      );
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.activateOnlineEvaluator,
      this._gaxModule.createDefaultBackoffSettings(),
    );
    return decodeOperation as LROperation<
      protos.google.cloud.aiplatform.v1beta1.OnlineEvaluator,
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta1/online_evaluator_service.suspend_online_evaluator.js</caption>
   * region_tag:aiplatform_v1beta1_generated_OnlineEvaluatorService_SuspendOnlineEvaluator_async
   */
  suspendOnlineEvaluator(
    request?: protos.google.cloud.aiplatform.v1beta1.ISuspendOnlineEvaluatorRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<
        protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator,
        protos.google.cloud.aiplatform.v1beta1.ISuspendOnlineEvaluatorOperationMetadata
      >,
      protos.google.longrunning.IOperation | undefined,
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      | undefined = callback
      ? (error, response, rawResponse, _) => {
          this._log.info('suspendOnlineEvaluator response %j', rawResponse);
          callback!(error, response, rawResponse, _); // We verified callback above.
        }
      : undefined;
    this._log.info('suspendOnlineEvaluator request %j', request);
    return this.innerApiCalls
      .suspendOnlineEvaluator(request, options, wrappedCallback)
      ?.then(
        ([response, rawResponse, _]: [
          LROperation<
            protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator,
  ...
  /**
   * Check the status of the long running operation returned by `suspendOnlineEvaluator()`.
   * @param {String} name
   *   The operation name that will be passed.
   * @returns {Promise} - The promise which resolves to an object.
   *   The decoded operation object has result and metadata field to get information from.
   ...
   * region_tag:aiplatform_v1beta1_generated_OnlineEvaluatorService_SuspendOnlineEvaluator_async
   */
  async checkSuspendOnlineEvaluatorProgress(
    name: string,
  ): Promise<
    LROperation<
      protos.google.cloud.aiplatform.v1beta1.OnlineEvaluator,
      protos.google.cloud.aiplatform.v1beta1.SuspendOnlineEvaluatorOperationMetadata
    >
  > {
    this._log.info('suspendOnlineEvaluator long-running');
    const request =
      new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest(
        { name },
      );
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.suspendOnlineEvaluator,
      this._gaxModule.createDefaultBackoffSettings(),
    );
    return decodeOperation as LROperation<
      protos.google.cloud.aiplatform.v1beta1.OnlineEvaluator,
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.cloud.aiplatform.v1beta1.OnlineEvaluator|OnlineEvaluator}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   *   We recommend using `listOnlineEvaluatorsAsync()`
   *   method described below for async iteration which you can stop as needed.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   */
  listOnlineEvaluators(
    request?: protos.google.cloud.aiplatform.v1beta1.IListOnlineEvaluatorsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator[],
      protos.google.cloud.aiplatform.v1beta1.IListOnlineEvaluatorsRequest | null,
      protos.google.cloud.aiplatform.v1beta1.IListOnlineEvaluatorsResponse,
    ]
  >;
  listOnlineEvaluators(
    request: protos.google.cloud.aiplatform.v1beta1.IListOnlineEvaluatorsRequest,
    ...
    callback: PaginationCallback<
      protos.google.cloud.aiplatform.v1beta1.IListOnlineEvaluatorsRequest,
      | protos.google.cloud.aiplatform.v1beta1.IListOnlineEvaluatorsResponse
      | null
      | undefined,
      protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listOnlineEvaluators values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listOnlineEvaluators request %j', request);
    return this.innerApiCalls
      .listOnlineEvaluators(request, options, wrappedCallback)
      ?.then(
        ([response, input, output]: [
          ...
          this._log.info('listOnlineEvaluators values %j', response);
  ...
  /**
   * Equivalent to `listOnlineEvaluators`, but returns a NodeJS Stream object.
   * @param {Object} request
   *   The request object that will be sent.
   * @param {string} request.parent
   *   Required. The parent resource of the OnlineEvaluators to list.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.cloud.aiplatform.v1beta1.OnlineEvaluator|OnlineEvaluator} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
  ...
  listOnlineEvaluatorsStream(
    ...
    const defaultCallSettings = this._defaults['listOnlineEvaluators'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch((err) => {
      throw err;
    });
    this._log.info('listOnlineEvaluators stream %j', request);
    return this.descriptors.page.listOnlineEvaluators.createStream(
      this.innerApiCalls.listOnlineEvaluators as GaxCall,
      request,
      callSettings,
    );
  }
  ...
  /**
   * Equivalent to `listOnlineEvaluators`, but returns an iterable object.
   *
   ...
   *   {@link protos.google.cloud.aiplatform.v1beta1.OnlineEvaluator|OnlineEvaluator}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta1/online_evaluator_service.list_online_evaluators.js</caption>
   * region_tag:aiplatform_v1beta1_generated_OnlineEvaluatorService_ListOnlineEvaluators_async
   */
  listOnlineEvaluatorsAsync(
    request?: protos.google.cloud.aiplatform.v1beta1.IListOnlineEvaluatorsRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    this._log.info('listOnlineEvaluators iterate %j', request);
    return this.descriptors.page.listOnlineEvaluators.asyncIterate(
      this.innerApiCalls['listOnlineEvaluators'] as GaxCall,
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator>;
  }
  /**
   ...
   */
  close(): Promise<void> {
    if (this.onlineEvaluatorServiceStub && !this._terminated) {
      return this.onlineEvaluatorServiceStub.then((stub) => {
