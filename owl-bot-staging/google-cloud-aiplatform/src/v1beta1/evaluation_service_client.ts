...
export class EvaluationServiceClient {
  ...
  initialize() {
    ...
    const evaluationServiceStubMethods =
        ['evaluateInstances', 'evaluateDataset', 'generateInstanceRubrics'];
 ...
 * @param {number[]} [request.metricSources]
 *   Optional. The metrics (either inline or registered) used for evaluation.
 *   Currently, we only support evaluating a single metric. If multiple metrics
 *   are provided, only the first one will be evaluated.
 * @param {google.cloud.aiplatform.v1beta1.EvaluationInstance} request.instance
 ...
 *   request.
 * @param {google.cloud.aiplatform.v1beta1.PredefinedMetricSpec} [request.predefinedRubricGenerationSpec]
 ...
 * @param {google.cloud.aiplatform.v1beta1.RubricGenerationSpec} [request.rubricGenerationSpec]
 *   Optional. Specification for how the rubrics should be generated.
 * @param {google.cloud.aiplatform.v1beta1.EvaluationInstance.DeprecatedAgentConfig} [request.agentConfig]
 *   Optional. Agent configuration, required for agent-based rubric generation.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.cloud.aiplatform.v1beta1.GenerateInstanceRubricsResponse|GenerateInstanceRubricsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta1/evaluation_service.generate_instance_rubrics.js</caption>
 * region_tag:aiplatform_v1beta1_generated_EvaluationService_GenerateInstanceRubrics_async
 */
  generateInstanceRubrics(
      request?: protos.google.cloud.aiplatform.v1beta1.IGenerateInstanceRubricsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.IGenerateInstanceRubricsResponse,
        protos.google.cloud.aiplatform.v1beta1.IGenerateInstanceRubricsRequest|undefined, {}|undefined
      ]>;
  generateInstanceRubrics(
      request: protos.google.cloud.aiplatform.v1beta1.IGenerateInstanceRubricsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1beta1.IGenerateInstanceRubricsResponse,
          protos.google.cloud.aiplatform.v1beta1.IGenerateInstanceRubricsRequest|null|undefined,
          {}|null|undefined>): void;
  generateInstanceRubrics(
      request: protos.google.cloud.aiplatform.v1beta1.IGenerateInstanceRubricsRequest,
      callback: Callback<
  ...
  generateInstanceRubrics(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('generateInstanceRubrics request %j', request);
    const wrappedCallback: Callback<
        protos.google.cloud.aiplatform.v1beta1.IGenerateInstanceRubricsResponse,
        protos.google.cloud.aiplatform.v1beta1.IGenerateInstanceRubricsRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('generateInstanceRubrics response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.generateInstanceRubrics(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.aiplatform.v1beta1.IGenerateInstanceRubricsResponse,
        protos.google.cloud.aiplatform.v1beta1.IGenerateInstanceRubricsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('generateInstanceRubrics response %j', response);
        return [response, options, rawResponse];
