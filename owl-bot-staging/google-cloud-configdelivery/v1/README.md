...
# [Configdelivery: Nodejs Client][homepage]
...
Configdelivery client for Node.js
...
* [Configdelivery Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/configdelivery/latest)
* [Configdelivery Documentation](https://cloud.google.com/kubernetes-engine/enterprise/config-sync/docs/concepts/fleet-packages)
