...
describe('v1.PlacesClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new placesModule.v1.PlacesClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'places.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new placesModule.v1.PlacesClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'places.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new placesModule.v1.PlacesClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new placesModule.v1.PlacesClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('searchNearby', () => {
        ...
        it('invokes searchNearby without error using callback', async () => {
            ...
            client.innerApiCalls.searchNearby = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.searchNearby(
                    request,
                    (err?: Error|null, result?: protos.google.maps.places.v1.ISearchNearbyResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes searchNearby with error', async () => {
            ...
            client.innerApiCalls.searchNearby = stubSimpleCall(undefined, expectedError);
    ...
    describe('searchText', () => {
        ...
        it('invokes searchText without error using callback', async () => {
            ...
            client.innerApiCalls.searchText = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.searchText(
                    request,
                    (err?: Error|null, result?: protos.google.maps.places.v1.ISearchTextResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes searchText with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.searchText = stubSimpleCall(undefined, expectedError);
    ...
    describe('getPhotoMedia', () => {
        it('invokes getPhotoMedia without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.maps.places.v1.GetPhotoMediaRequest', ['name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getPhotoMedia as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getPhotoMedia as SinonStub)
        ...
        it('invokes getPhotoMedia without error using callback', async () => {
            ...
            client.innerApiCalls.getPhotoMedia = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getPhotoMedia(
                    request,
                    (err?: Error|null, result?: protos.google.maps.places.v1.IPhotoMedia|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getPhotoMedia with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getPhotoMedia = stubSimpleCall(undefined, expectedError);
    ...
    describe('getPlace', () => {
        it('invokes getPlace without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.maps.places.v1.GetPlaceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getPlace as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getPlace as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getPlace without error using callback', async () => {
            ...
            client.innerApiCalls.getPlace = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getPlace(
                    request,
                    (err?: Error|null, result?: protos.google.maps.places.v1.IPlace|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('autocompletePlaces', () => {
        it('invokes autocompletePlaces without error', async () => {
            ...
            client.innerApiCalls.autocompletePlaces = stubSimpleCall(expectedResponse);
        ...
        it('invokes autocompletePlaces without error using callback', async () => {
            ...
            client.innerApiCalls.autocompletePlaces = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.autocompletePlaces(
                    request,
                    (err?: Error|null, result?: protos.google.maps.places.v1.IAutocompletePlacesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes autocompletePlaces with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.autocompletePlaces = stubSimpleCall(undefined, expectedError);
    ...
    describe('Path templates', () => {
        ...
        describe('photo', () => {
            ...
            client.initialize();
            client.pathTemplates.photoPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.photoPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('photoPath', () => {
                const result = client.photoPath("placeValue", "photoValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.photoPathTemplate.render as SinonStub)
            ...
            it('matchPlaceFromPhotoName', () => {
                ...
                assert((client.pathTemplates.photoPathTemplate.match as SinonStub)
        ...
        describe('photoMedia', () => {
            ...
            client.initialize();
            client.pathTemplates.photoMediaPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.photoMediaPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('photoMediaPath', () => {
                const result = client.photoMediaPath("placeIdValue", "photoReferenceValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.photoMediaPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchPlaceIdFromPhotoMediaName', () => {
                ...
                assert((client.pathTemplates.photoMediaPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('place', () => {
            ...
            client.initialize();
            client.pathTemplates.placePathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.placePathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('placePath', () => {
                const result = client.placePath("placeIdValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.placePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchPlaceIdFromPlaceName', () => {
                ...
                assert.strictEqual(result, "placeIdValue");
                assert((client.pathTemplates.placePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
        ...
        describe('review', () => {
            ...
            client.initialize();
            client.pathTemplates.reviewPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.reviewPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('reviewPath', () => {
                const result = client.reviewPath("placeValue", "reviewValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.reviewPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchPlaceFromReviewName', () => {
                ...
                assert.strictEqual(result, "placeValue");
                assert((client.pathTemplates.reviewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
