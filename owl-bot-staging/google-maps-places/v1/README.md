...
* [Places Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/places/latest)
* [Places Documentation](https://developers.google.com/maps/documentation/places/web-service/)
