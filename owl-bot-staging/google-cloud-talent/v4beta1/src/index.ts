...
export {v4beta1, CompanyServiceClient, CompletionClient, EventServiceClient, JobServiceClient, TenantServiceClient};
export default {v4beta1, CompanyServiceClient, CompletionClient, EventServiceClient, JobServiceClient, TenantServiceClient};
