...
describe('v4beta1.TenantServiceClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new tenantserviceModule.v4beta1.TenantServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'jobs.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new tenantserviceModule.v4beta1.TenantServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'jobs.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new tenantserviceModule.v4beta1.TenantServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new tenantserviceModule.v4beta1.TenantServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createTenant', () => {
        it('invokes createTenant without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.talent.v4beta1.CreateTenantRequest', ['parent']);
    ...
    describe('getTenant', () => {
        it('invokes getTenant without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.talent.v4beta1.GetTenantRequest', ['name']);
    ...
    describe('updateTenant', () => {
        it('invokes updateTenant without error', async () => {
            ...
            request.tenant ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.talent.v4beta1.UpdateTenantRequest', ['tenant', 'name']);
    ...
    describe('deleteTenant', () => {
        it('invokes deleteTenant without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.talent.v4beta1.DeleteTenantRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listTenants', () => {
        it('invokes listTenants without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.talent.v4beta1.ListTenantsRequest', ['parent']);
            request.parent = defaultValue1;
