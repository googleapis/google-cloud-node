...
* [Promotions Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/promotions/latest)
* [Promotions Documentation](https://developers.google.com/merchant/api)
...
1.  [Enable the Promotions API][enable_api].
