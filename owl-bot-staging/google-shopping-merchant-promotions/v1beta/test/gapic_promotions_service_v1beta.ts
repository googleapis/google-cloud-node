...
describe('v1beta.PromotionsServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = promotionsserviceModule.v1beta.PromotionsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = promotionsserviceModule.v1beta.PromotionsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new promotionsserviceModule.v1beta.PromotionsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new promotionsserviceModule.v1beta.PromotionsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new promotionsserviceModule.v1beta.PromotionsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new promotionsserviceModule.v1beta.PromotionsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('insertPromotion', () => {
        it('invokes insertPromotion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.promotions.v1beta.InsertPromotionRequest', ['parent']);
        ...
        it('invokes insertPromotion without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.insertPromotion(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.promotions.v1beta.IPromotion|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getPromotion', () => {
        it('invokes getPromotion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.promotions.v1beta.GetPromotionRequest', ['name']);
    ...
    describe('listPromotions', () => {
        it('invokes listPromotions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.promotions.v1beta.ListPromotionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.shopping.merchant.promotions.v1beta.Promotion()),
              generateSampleMessage(new protos.google.shopping.merchant.promotions.v1beta.Promotion()),
              generateSampleMessage(new protos.google.shopping.merchant.promotions.v1beta.Promotion()),
            ];
        ...
        it('invokes listPromotionsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.shopping.merchant.promotions.v1beta.Promotion) => {
