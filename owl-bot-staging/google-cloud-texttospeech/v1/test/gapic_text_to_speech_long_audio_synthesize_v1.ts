...
describe('v1.TextToSpeechLongAudioSynthesizeClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new texttospeechlongaudiosynthesizeModule.v1.TextToSpeechLongAudioSynthesizeClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = texttospeechlongaudiosynthesizeModule.v1.TextToSpeechLongAudioSynthesizeClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = texttospeechlongaudiosynthesizeModule.v1.TextToSpeechLongAudioSynthesizeClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'texttospeech.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new texttospeechlongaudiosynthesizeModule.v1.TextToSpeechLongAudioSynthesizeClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'texttospeech.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new texttospeechlongaudiosynthesizeModule.v1.TextToSpeechLongAudioSynthesizeClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'texttospeech.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new texttospeechlongaudiosynthesizeModule.v1.TextToSpeechLongAudioSynthesizeClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new texttospeechlongaudiosynthesizeModule.v1.TextToSpeechLongAudioSynthesizeClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = texttospeechlongaudiosynthesizeModule.v1.TextToSpeechLongAudioSynthesizeClient.port;
            assert(port);
    ...
    describe('synthesizeLongAudio', () => {
        it('invokes synthesizeLongAudio without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.texttospeech.v1.SynthesizeLongAudioRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.synthesizeLongAudio = stubLongRunningCall(expectedResponse);
            const [operation] = await client.synthesizeLongAudio(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.synthesizeLongAudio as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.synthesizeLongAudio as SinonStub)
        ...
        it('invokes synthesizeLongAudio without error using callback', async () => {
            ...
            client.innerApiCalls.synthesizeLongAudio = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.synthesizeLongAudio(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.texttospeech.v1.ISynthesizeLongAudioResponse, protos.google.cloud.texttospeech.v1.ISynthesizeLongAudioMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.texttospeech.v1.ISynthesizeLongAudioResponse, protos.google.cloud.texttospeech.v1.ISynthesizeLongAudioMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.synthesizeLongAudio as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes synthesizeLongAudio with call error', async () => {
            ...
            client.innerApiCalls.synthesizeLongAudio = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes synthesizeLongAudio with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.synthesizeLongAudio = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.synthesizeLongAudio(request);
        ...
        it('invokes checkSynthesizeLongAudioProgress without error', async () => {
            ...
            const decodedOperation = await client.checkSynthesizeLongAudioProgress(expectedResponse.name);
        ...
        it('invokes checkSynthesizeLongAudioProgress with error', async () => {
            ...
            await assert.rejects(client.checkSynthesizeLongAudioProgress(''), expectedError);
