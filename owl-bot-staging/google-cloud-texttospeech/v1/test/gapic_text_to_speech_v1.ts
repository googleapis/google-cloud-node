...
describe('v1.TextToSpeechClient', () => {
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new texttospeechModule.v1.TextToSpeechClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
    ...
    describe('listVoices', () => {
        ...
        it('invokes listVoices without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listVoices(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.texttospeech.v1.IListVoicesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes synthesizeSpeech without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.synthesizeSpeech(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.texttospeech.v1.ISynthesizeSpeechResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('streamingSynthesize', () => {
        it('invokes streamingSynthesize without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.texttospeech.v1.StreamingSynthesizeResponse) => {
                    resolve(response);
                });
