...
function main(parent) {
  // [START merchantapi_v1_generated_ProgramsService_ListPrograms_async]
  /**
  ...
  async function callListPrograms() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = accountsClient.listProgramsAsync(request);
  ...
  callListPrograms();
  // [END merchantapi_v1_generated_ProgramsService_ListPrograms_async]
}
