...
describe('v1.OnlineReturnPolicyServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new onlinereturnpolicyserviceModule.v1.OnlineReturnPolicyServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = onlinereturnpolicyserviceModule.v1.OnlineReturnPolicyServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = onlinereturnpolicyserviceModule.v1.OnlineReturnPolicyServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new onlinereturnpolicyserviceModule.v1.OnlineReturnPolicyServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new onlinereturnpolicyserviceModule.v1.OnlineReturnPolicyServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new onlinereturnpolicyserviceModule.v1.OnlineReturnPolicyServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new onlinereturnpolicyserviceModule.v1.OnlineReturnPolicyServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = onlinereturnpolicyserviceModule.v1.OnlineReturnPolicyServiceClient.port;
            assert(port);
    ...
    describe('getOnlineReturnPolicy', () => {
        it('invokes getOnlineReturnPolicy without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.GetOnlineReturnPolicyRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.GetOnlineReturnPolicyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.OnlineReturnPolicy()
            );
        ...
        it('invokes getOnlineReturnPolicy without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getOnlineReturnPolicy(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1.IOnlineReturnPolicy|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createOnlineReturnPolicy', () => {
        it('invokes createOnlineReturnPolicy without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.CreateOnlineReturnPolicyRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.CreateOnlineReturnPolicyRequest', ['parent']);
    ...
    describe('deleteOnlineReturnPolicy', () => {
        it('invokes deleteOnlineReturnPolicy without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.DeleteOnlineReturnPolicyRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.DeleteOnlineReturnPolicyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listOnlineReturnPolicies', () => {
        it('invokes listOnlineReturnPolicies without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.ListOnlineReturnPoliciesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.ListOnlineReturnPoliciesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1.OnlineReturnPolicy()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1.OnlineReturnPolicy()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1.OnlineReturnPolicy()),
            ];
        ...
        it('invokes listOnlineReturnPoliciesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.shopping.merchant.accounts.v1.OnlineReturnPolicy[] = [];
                stream.on('data', (response: protos.google.shopping.merchant.accounts.v1.OnlineReturnPolicy) => {
        ...
        it('uses async iteration with listOnlineReturnPolicies without error', async () => {
            ...
            const responses: protos.google.shopping.merchant.accounts.v1.IOnlineReturnPolicy[] = [];
