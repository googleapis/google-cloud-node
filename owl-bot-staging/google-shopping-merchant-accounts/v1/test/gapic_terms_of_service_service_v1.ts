...
describe('v1.TermsOfServiceServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new termsofserviceserviceModule.v1.TermsOfServiceServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = termsofserviceserviceModule.v1.TermsOfServiceServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = termsofserviceserviceModule.v1.TermsOfServiceServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new termsofserviceserviceModule.v1.TermsOfServiceServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new termsofserviceserviceModule.v1.TermsOfServiceServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new termsofserviceserviceModule.v1.TermsOfServiceServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new termsofserviceserviceModule.v1.TermsOfServiceServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = termsofserviceserviceModule.v1.TermsOfServiceServiceClient.port;
            assert(port);
    ...
    describe('getTermsOfService', () => {
        it('invokes getTermsOfService without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.GetTermsOfServiceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.GetTermsOfServiceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.TermsOfService()
            );
        ...
        it('invokes getTermsOfService without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getTermsOfService(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1.ITermsOfService|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('retrieveLatestTermsOfService', () => {
        it('invokes retrieveLatestTermsOfService without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.RetrieveLatestTermsOfServiceRequest()
            );
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.TermsOfService()
            );
    ...
    describe('acceptTermsOfService', () => {
        it('invokes acceptTermsOfService without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.AcceptTermsOfServiceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.AcceptTermsOfServiceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.AcceptTermsOfServiceResponse()
            );
        ...
        it('invokes acceptTermsOfService without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.acceptTermsOfService(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1.IAcceptTermsOfServiceResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
