...
describe('v1.DeveloperRegistrationServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = developerregistrationserviceModule.v1.DeveloperRegistrationServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = developerregistrationserviceModule.v1.DeveloperRegistrationServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new developerregistrationserviceModule.v1.DeveloperRegistrationServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new developerregistrationserviceModule.v1.DeveloperRegistrationServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new developerregistrationserviceModule.v1.DeveloperRegistrationServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new developerregistrationserviceModule.v1.DeveloperRegistrationServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = developerregistrationserviceModule.v1.DeveloperRegistrationServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.developerRegistrationServiceStub, undefined);
    ...
    describe('registerGcp', () => {
        it('invokes registerGcp without error', async () => {
            const client = new developerregistrationserviceModule.v1.DeveloperRegistrationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.RegisterGcpRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.RegisterGcpRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.DeveloperRegistration()
            );
            client.innerApiCalls.registerGcp = stubSimpleCall(expectedResponse);
            const [response] = await client.registerGcp(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.registerGcp as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.registerGcp as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes registerGcp without error using callback', async () => {
            const client = new developerregistrationserviceModule.v1.DeveloperRegistrationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.registerGcp = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.registerGcp(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1.IDeveloperRegistration|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes registerGcp with error', async () => {
            const client = new developerregistrationserviceModule.v1.DeveloperRegistrationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.registerGcp = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes registerGcp with closed client', async () => {
            const client = new developerregistrationserviceModule.v1.DeveloperRegistrationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('getDeveloperRegistration', () => {
        it('invokes getDeveloperRegistration without error', async () => {
            const client = new developerregistrationserviceModule.v1.DeveloperRegistrationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.GetDeveloperRegistrationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.GetDeveloperRegistrationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.DeveloperRegistration()
            );
            client.innerApiCalls.getDeveloperRegistration = stubSimpleCall(expectedResponse);
            const [response] = await client.getDeveloperRegistration(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getDeveloperRegistration as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDeveloperRegistration as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getDeveloperRegistration without error using callback', async () => {
            const client = new developerregistrationserviceModule.v1.DeveloperRegistrationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getDeveloperRegistration = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getDeveloperRegistration(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1.IDeveloperRegistration|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes getDeveloperRegistration with error', async () => {
            const client = new developerregistrationserviceModule.v1.DeveloperRegistrationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getDeveloperRegistration = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getDeveloperRegistration(request), expectedError);
            const actualRequest = (client.innerApiCalls.getDeveloperRegistration as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDeveloperRegistration as SinonStub)
        ...
        it('invokes getDeveloperRegistration with closed client', async () => {
            const client = new developerregistrationserviceModule.v1.DeveloperRegistrationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('unregisterGcp', () => {
        it('invokes unregisterGcp without error', async () => {
            const client = new developerregistrationserviceModule.v1.DeveloperRegistrationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.UnregisterGcpRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.UnregisterGcpRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.unregisterGcp = stubSimpleCall(expectedResponse);
            const [response] = await client.unregisterGcp(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.unregisterGcp as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.unregisterGcp as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes unregisterGcp without error using callback', async () => {
            const client = new developerregistrationserviceModule.v1.DeveloperRegistrationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.unregisterGcp = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.unregisterGcp(
                    request,
        ...
        it('invokes unregisterGcp with error', async () => {
            const client = new developerregistrationserviceModule.v1.DeveloperRegistrationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.unregisterGcp = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes unregisterGcp with closed client', async () => {
            const client = new developerregistrationserviceModule.v1.DeveloperRegistrationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
