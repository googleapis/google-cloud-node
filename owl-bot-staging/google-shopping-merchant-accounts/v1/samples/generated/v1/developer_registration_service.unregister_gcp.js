...
function main(name) {
  // [START merchantapi_v1_generated_DeveloperRegistrationService_UnregisterGcp_async]
  /**
  ...
  async function callUnregisterGcp() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await accountsClient.unregisterGcp(request);
    console.log(response);
  }

  callUnregisterGcp();
  // [END merchantapi_v1_generated_DeveloperRegistrationService_UnregisterGcp_async]
}
