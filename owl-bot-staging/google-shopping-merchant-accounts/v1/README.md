...
# [Accounts: Nodejs Client][homepage]

[//]: # "releaseLevel"

[![npm version](https://img.shields.io/npm/v/@google-cloud/accounts.svg)](https://www.npmjs.org/package/@google-cloud/accounts)

Accounts client for Node.js
...
* [Accounts Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/accounts/latest)
* [Accounts Documentation](https://developers.google.com/merchant/api)
...
1.  [Enable the Accounts API][enable_api].
1.  [Set up authentication][auth] so you can access the
    API from your local workstation.
### Installing the client library

```bash
npm install @google-cloud/accounts
```
...
For example, `npm install @google-cloud/accounts@legacy-8` installs client libraries
