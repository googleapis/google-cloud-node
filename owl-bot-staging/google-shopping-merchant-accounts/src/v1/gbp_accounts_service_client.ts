 ...
 * `src/v1/gbp_accounts_service_client_config.json`.
...
export class GbpAccountsServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.shopping.merchant.accounts.v1.GbpAccountsService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.gbpAccountsServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.shopping.merchant.accounts.v1.GbpAccountsService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.shopping.merchant.accounts.v1.GbpAccountsService,
 ...
 *   The first element of the array is an object representing {@link protos.google.shopping.merchant.accounts.v1.LinkGbpAccountResponse|LinkGbpAccountResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/gbp_accounts_service.link_gbp_account.js</caption>
 * region_tag:merchantapi_v1_generated_GbpAccountsService_LinkGbpAccount_async
 */
  linkGbpAccount(
      request?: protos.google.shopping.merchant.accounts.v1.ILinkGbpAccountRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.ILinkGbpAccountResponse,
        protos.google.shopping.merchant.accounts.v1.ILinkGbpAccountRequest|undefined, {}|undefined
      ]>;
  linkGbpAccount(
      request: protos.google.shopping.merchant.accounts.v1.ILinkGbpAccountRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1.ILinkGbpAccountResponse,
          protos.google.shopping.merchant.accounts.v1.ILinkGbpAccountRequest|null|undefined,
          {}|null|undefined>): void;
  linkGbpAccount(
      request: protos.google.shopping.merchant.accounts.v1.ILinkGbpAccountRequest,
      callback: Callback<
  ...
  linkGbpAccount(
    ...
    return this.innerApiCalls.linkGbpAccount(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1.ILinkGbpAccountResponse,
        protos.google.shopping.merchant.accounts.v1.ILinkGbpAccountRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('linkGbpAccount response %j', response);
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.shopping.merchant.accounts.v1.GbpAccount|GbpAccount}.
 ...
 */
  listGbpAccounts(
      request?: protos.google.shopping.merchant.accounts.v1.IListGbpAccountsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.IGbpAccount[],
        protos.google.shopping.merchant.accounts.v1.IListGbpAccountsRequest|null,
        protos.google.shopping.merchant.accounts.v1.IListGbpAccountsResponse
      ]>;
  listGbpAccounts(
      request: protos.google.shopping.merchant.accounts.v1.IListGbpAccountsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          ...
          protos.google.shopping.merchant.accounts.v1.IListGbpAccountsResponse|null|undefined,
          protos.google.shopping.merchant.accounts.v1.IGbpAccount>): void;
  listGbpAccounts(
      request: protos.google.shopping.merchant.accounts.v1.IListGbpAccountsRequest,
      callback: PaginationCallback<
          protos.google.shopping.merchant.accounts.v1.IListGbpAccountsRequest,
  ...
  listGbpAccounts(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.shopping.merchant.accounts.v1.IListGbpAccountsRequest,
      protos.google.shopping.merchant.accounts.v1.IListGbpAccountsResponse|null|undefined,
      protos.google.shopping.merchant.accounts.v1.IGbpAccount>|undefined = callback
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.shopping.merchant.accounts.v1.GbpAccount|GbpAccount} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   {@link protos.google.shopping.merchant.accounts.v1.GbpAccount|GbpAccount}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/gbp_accounts_service.list_gbp_accounts.js</caption>
 * region_tag:merchantapi_v1_generated_GbpAccountsService_ListGbpAccounts_async
 */
  listGbpAccountsAsync(
      request?: protos.google.shopping.merchant.accounts.v1.IListGbpAccountsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.shopping.merchant.accounts.v1.IGbpAccount>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listGbpAccounts.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.shopping.merchant.accounts.v1.IGbpAccount>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
