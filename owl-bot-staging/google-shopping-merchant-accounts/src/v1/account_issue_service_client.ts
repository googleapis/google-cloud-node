 ...
 * `src/v1/account_issue_service_client_config.json`.
...
export class AccountIssueServiceClient {
   ...
   * {@link protos.google.shopping.merchant.accounts.v1.AccountsService.ListSubAccounts|accounts.listSubaccounts}
   ...
   *   The first element of the array is Array of {@link protos.google.shopping.merchant.accounts.v1.AccountIssue|AccountIssue}.
   ...
   */
  listAccountIssues(
    request?: protos.google.shopping.merchant.accounts.v1.IListAccountIssuesRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.shopping.merchant.accounts.v1.IAccountIssue[],
      protos.google.shopping.merchant.accounts.v1.IListAccountIssuesRequest | null,
      protos.google.shopping.merchant.accounts.v1.IListAccountIssuesResponse,
    ]
  >;
  listAccountIssues(
    request: protos.google.shopping.merchant.accounts.v1.IListAccountIssuesRequest,
    ...
    callback: PaginationCallback<
      protos.google.shopping.merchant.accounts.v1.IListAccountIssuesRequest,
      | protos.google.shopping.merchant.accounts.v1.IListAccountIssuesResponse
      | null
      | undefined,
      protos.google.shopping.merchant.accounts.v1.IAccountIssue
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.shopping.merchant.accounts.v1.AccountIssue|AccountIssue} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
   ...
   *   {@link protos.google.shopping.merchant.accounts.v1.AccountIssue|AccountIssue}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/account_issue_service.list_account_issues.js</caption>
   * region_tag:merchantapi_v1_generated_AccountIssueService_ListAccountIssues_async
   */
  listAccountIssuesAsync(
    request?: protos.google.shopping.merchant.accounts.v1.IListAccountIssuesRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.shopping.merchant.accounts.v1.IAccountIssue> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listAccountIssues.asyncIterate(
      ...
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.shopping.merchant.accounts.v1.IAccountIssue>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
