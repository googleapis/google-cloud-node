 ...
 * `src/v1/regions_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './regions_service_client_config.json';
 ...
 *
 *  - {@link protos.google.shopping.merchant.accounts.v1.Region|Region}
 * @class
 * @memberof v1
 */
export class RegionsServiceClient {
  ...
  regionsServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of RegionsServiceClient.
   *
   ...
   *     const client = new RegionsServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof RegionsServiceClient;
    ...
    this.descriptors.page = {
      listRegions:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'regions')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.shopping.merchant.accounts.v1.RegionsService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.regionsServiceStub) {
      return this.regionsServiceStub;
    }

    // Put together the "service stub" for
    // google.shopping.merchant.accounts.v1.RegionsService.
    this.regionsServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.shopping.merchant.accounts.v1.RegionsService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.shopping.merchant.accounts.v1.RegionsService,
 ...
 *   The first element of the array is an object representing {@link protos.google.shopping.merchant.accounts.v1.Region|Region}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/regions_service.get_region.js</caption>
 * region_tag:merchantapi_v1_generated_RegionsService_GetRegion_async
 */
  getRegion(
      request?: protos.google.shopping.merchant.accounts.v1.IGetRegionRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.IRegion,
        protos.google.shopping.merchant.accounts.v1.IGetRegionRequest|undefined, {}|undefined
      ]>;
  getRegion(
      request: protos.google.shopping.merchant.accounts.v1.IGetRegionRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1.IRegion,
          protos.google.shopping.merchant.accounts.v1.IGetRegionRequest|null|undefined,
          {}|null|undefined>): void;
  getRegion(
      request: protos.google.shopping.merchant.accounts.v1.IGetRegionRequest,
      callback: Callback<
  ...
  getRegion(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getRegion(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1.IRegion,
        protos.google.shopping.merchant.accounts.v1.IGetRegionRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getRegion response %j', response);
 ...
 * @param {string} request.regionId
 *   Required. The identifier for the region, unique over all regions of the
 *   same account.
 * @param {google.shopping.merchant.accounts.v1.Region} request.region
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/regions_service.create_region.js</caption>
 * region_tag:merchantapi_v1_generated_RegionsService_CreateRegion_async
 */
  createRegion(
      request?: protos.google.shopping.merchant.accounts.v1.ICreateRegionRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.IRegion,
        protos.google.shopping.merchant.accounts.v1.ICreateRegionRequest|undefined, {}|undefined
      ]>;
  createRegion(
      request: protos.google.shopping.merchant.accounts.v1.ICreateRegionRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1.IRegion,
          protos.google.shopping.merchant.accounts.v1.ICreateRegionRequest|null|undefined,
          {}|null|undefined>): void;
  createRegion(
      request: protos.google.shopping.merchant.accounts.v1.ICreateRegionRequest,
      callback: Callback<
  ...
  createRegion(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.createRegion(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1.IRegion,
        protos.google.shopping.merchant.accounts.v1.ICreateRegionRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('createRegion response %j', response);
        return [response, options, rawResponse];
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/regions_service.update_region.js</caption>
 * region_tag:merchantapi_v1_generated_RegionsService_UpdateRegion_async
 */
  updateRegion(
      request?: protos.google.shopping.merchant.accounts.v1.IUpdateRegionRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.IRegion,
        protos.google.shopping.merchant.accounts.v1.IUpdateRegionRequest|undefined, {}|undefined
      ]>;
  updateRegion(
      request: protos.google.shopping.merchant.accounts.v1.IUpdateRegionRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1.IRegion,
          protos.google.shopping.merchant.accounts.v1.IUpdateRegionRequest|null|undefined,
          {}|null|undefined>): void;
  updateRegion(
      request: protos.google.shopping.merchant.accounts.v1.IUpdateRegionRequest,
      callback: Callback<
  ...
  updateRegion(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.updateRegion(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1.IRegion,
        protos.google.shopping.merchant.accounts.v1.IUpdateRegionRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('updateRegion response %j', response);
        return [response, options, rawResponse];
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/regions_service.delete_region.js</caption>
 * region_tag:merchantapi_v1_generated_RegionsService_DeleteRegion_async
 */
  deleteRegion(
      request?: protos.google.shopping.merchant.accounts.v1.IDeleteRegionRequest,
      options?: CallOptions):
      Promise<[
        protos.google.protobuf.IEmpty,
        protos.google.shopping.merchant.accounts.v1.IDeleteRegionRequest|undefined, {}|undefined
      ]>;
  deleteRegion(
      request: protos.google.shopping.merchant.accounts.v1.IDeleteRegionRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.protobuf.IEmpty,
          protos.google.shopping.merchant.accounts.v1.IDeleteRegionRequest|null|undefined,
          {}|null|undefined>): void;
  deleteRegion(
      request: protos.google.shopping.merchant.accounts.v1.IDeleteRegionRequest,
      callback: Callback<
  ...
  deleteRegion(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.deleteRegion(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.protobuf.IEmpty,
        protos.google.shopping.merchant.accounts.v1.IDeleteRegionRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('deleteRegion response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.shopping.merchant.accounts.v1.Region|Region}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listRegionsAsync()`
 *   method described below for async iteration which you can stop as needed.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 */
  listRegions(
      request?: protos.google.shopping.merchant.accounts.v1.IListRegionsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.IRegion[],
        protos.google.shopping.merchant.accounts.v1.IListRegionsRequest|null,
        protos.google.shopping.merchant.accounts.v1.IListRegionsResponse
      ]>;
  listRegions(
      request: protos.google.shopping.merchant.accounts.v1.IListRegionsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.shopping.merchant.accounts.v1.IListRegionsRequest,
          protos.google.shopping.merchant.accounts.v1.IListRegionsResponse|null|undefined,
          protos.google.shopping.merchant.accounts.v1.IRegion>): void;
  listRegions(
      request: protos.google.shopping.merchant.accounts.v1.IListRegionsRequest,
      callback: PaginationCallback<
          protos.google.shopping.merchant.accounts.v1.IListRegionsRequest,
  ...
  listRegions(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.shopping.merchant.accounts.v1.IListRegionsRequest,
      protos.google.shopping.merchant.accounts.v1.IListRegionsResponse|null|undefined,
      protos.google.shopping.merchant.accounts.v1.IRegion>|undefined = callback
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.shopping.merchant.accounts.v1.Region|Region} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
...
/**
 * Equivalent to `listRegions`, but returns an iterable object.
 *
 ...
 *   {@link protos.google.shopping.merchant.accounts.v1.Region|Region}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/regions_service.list_regions.js</caption>
 * region_tag:merchantapi_v1_generated_RegionsService_ListRegions_async
 */
  listRegionsAsync(
      request?: protos.google.shopping.merchant.accounts.v1.IListRegionsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.shopping.merchant.accounts.v1.IRegion>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listRegions.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.shopping.merchant.accounts.v1.IRegion>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   *
   * @param {string} accountRelationshipName
   ...
   *
   * @param {string} accountServiceName
   ...
   *
   * @param {string} developerRegistrationName
