 ...
 * `src/v1/developer_registration_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './developer_registration_service_client_config.json';
 ...
 * @memberof v1
 */
export class DeveloperRegistrationServiceClient {
  ...
  initialize() {
    ...
    if (this.developerRegistrationServiceStub) {
      return this.developerRegistrationServiceStub;
    }
