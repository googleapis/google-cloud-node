...
describe('v1beta.EmailPreferencesServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new emailpreferencesserviceModule.v1beta.EmailPreferencesServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = emailpreferencesserviceModule.v1beta.EmailPreferencesServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = emailpreferencesserviceModule.v1beta.EmailPreferencesServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new emailpreferencesserviceModule.v1beta.EmailPreferencesServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new emailpreferencesserviceModule.v1beta.EmailPreferencesServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new emailpreferencesserviceModule.v1beta.EmailPreferencesServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new emailpreferencesserviceModule.v1beta.EmailPreferencesServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = emailpreferencesserviceModule.v1beta.EmailPreferencesServiceClient.port;
            assert(port);
    ...
    describe('getEmailPreferences', () => {
        it('invokes getEmailPreferences without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.GetEmailPreferencesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.GetEmailPreferencesRequest', ['name']);
        ...
        it('invokes getEmailPreferences without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getEmailPreferences(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1beta.IEmailPreferences|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateEmailPreferences', () => {
        it('invokes updateEmailPreferences without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.UpdateEmailPreferencesRequest()
            );
            request.emailPreferences ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.UpdateEmailPreferencesRequest', ['emailPreferences', 'name']);
