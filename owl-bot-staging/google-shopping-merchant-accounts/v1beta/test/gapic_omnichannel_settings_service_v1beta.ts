...
describe('v1beta.OmnichannelSettingsServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new omnichannelsettingsserviceModule.v1beta.OmnichannelSettingsServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = omnichannelsettingsserviceModule.v1beta.OmnichannelSettingsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = omnichannelsettingsserviceModule.v1beta.OmnichannelSettingsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new omnichannelsettingsserviceModule.v1beta.OmnichannelSettingsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new omnichannelsettingsserviceModule.v1beta.OmnichannelSettingsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new omnichannelsettingsserviceModule.v1beta.OmnichannelSettingsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new omnichannelsettingsserviceModule.v1beta.OmnichannelSettingsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = omnichannelsettingsserviceModule.v1beta.OmnichannelSettingsServiceClient.port;
            assert(port);
    ...
    describe('getOmnichannelSetting', () => {
        it('invokes getOmnichannelSetting without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.GetOmnichannelSettingRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.OmnichannelSetting()
            );
            client.innerApiCalls.getOmnichannelSetting = stubSimpleCall(expectedResponse);
            const [response] = await client.getOmnichannelSetting(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getOmnichannelSetting as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getOmnichannelSetting as SinonStub)
        ...
        it('invokes getOmnichannelSetting without error using callback', async () => {
            ...
            client.innerApiCalls.getOmnichannelSetting = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getOmnichannelSetting(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1beta.IOmnichannelSetting|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getOmnichannelSetting with error', async () => {
            ...
            client.innerApiCalls.getOmnichannelSetting = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getOmnichannelSetting(request), expectedError);
            const actualRequest = (client.innerApiCalls.getOmnichannelSetting as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getOmnichannelSetting as SinonStub)
    ...
    describe('createOmnichannelSetting', () => {
        it('invokes createOmnichannelSetting without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.CreateOmnichannelSettingRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.OmnichannelSetting()
            );
            client.innerApiCalls.createOmnichannelSetting = stubSimpleCall(expectedResponse);
            const [response] = await client.createOmnichannelSetting(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createOmnichannelSetting as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createOmnichannelSetting as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createOmnichannelSetting without error using callback', async () => {
            ...
            client.innerApiCalls.createOmnichannelSetting = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createOmnichannelSetting with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createOmnichannelSetting = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createOmnichannelSetting(request), expectedError);
            const actualRequest = (client.innerApiCalls.createOmnichannelSetting as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createOmnichannelSetting as SinonStub)
    ...
    describe('updateOmnichannelSetting', () => {
        it('invokes updateOmnichannelSetting without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.UpdateOmnichannelSettingRequest', ['omnichannelSetting', 'name']);
            request.omnichannelSetting.name = defaultValue1;
            const expectedHeaderRequestParams = `omnichannel_setting.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.OmnichannelSetting()
            );
            client.innerApiCalls.updateOmnichannelSetting = stubSimpleCall(expectedResponse);
            const [response] = await client.updateOmnichannelSetting(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateOmnichannelSetting as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateOmnichannelSetting as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateOmnichannelSetting without error using callback', async () => {
            ...
            client.innerApiCalls.updateOmnichannelSetting = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateOmnichannelSetting with error', async () => {
            ...
            const expectedHeaderRequestParams = `omnichannel_setting.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateOmnichannelSetting = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateOmnichannelSetting(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateOmnichannelSetting as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateOmnichannelSetting as SinonStub)
    ...
    describe('requestInventoryVerification', () => {
        it('invokes requestInventoryVerification without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.RequestInventoryVerificationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.RequestInventoryVerificationResponse()
            );
            client.innerApiCalls.requestInventoryVerification = stubSimpleCall(expectedResponse);
            const [response] = await client.requestInventoryVerification(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.requestInventoryVerification as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.requestInventoryVerification as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes requestInventoryVerification without error using callback', async () => {
            ...
            client.innerApiCalls.requestInventoryVerification = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.requestInventoryVerification(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1beta.IRequestInventoryVerificationResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes requestInventoryVerification with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.requestInventoryVerification = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.requestInventoryVerification(request), expectedError);
            const actualRequest = (client.innerApiCalls.requestInventoryVerification as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.requestInventoryVerification as SinonStub)
    ...
    describe('listOmnichannelSettings', () => {
        it('invokes listOmnichannelSettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.ListOmnichannelSettingsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1beta.OmnichannelSetting()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1beta.OmnichannelSetting()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1beta.OmnichannelSetting()),
            ];
            client.innerApiCalls.listOmnichannelSettings = stubSimpleCall(expectedResponse);
            const [response] = await client.listOmnichannelSettings(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listOmnichannelSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listOmnichannelSettings as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listOmnichannelSettings without error using callback', async () => {
            ...
            client.innerApiCalls.listOmnichannelSettings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listOmnichannelSettings with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listOmnichannelSettings = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listOmnichannelSettings(request), expectedError);
            const actualRequest = (client.innerApiCalls.listOmnichannelSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listOmnichannelSettings as SinonStub)
        ...
        it('invokes listOmnichannelSettingsStream without error', async () => {
            ...
            client.descriptors.page.listOmnichannelSettings.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.shopping.merchant.accounts.v1beta.OmnichannelSetting) => {
            ...
            assert((client.descriptors.page.listOmnichannelSettings.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listOmnichannelSettings, request));
            assert(
                (client.descriptors.page.listOmnichannelSettings.createStream as SinonStub)
        ...
        it('invokes listOmnichannelSettingsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listOmnichannelSettings.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listOmnichannelSettingsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.shopping.merchant.accounts.v1beta.OmnichannelSetting[] = [];
                stream.on('data', (response: protos.google.shopping.merchant.accounts.v1beta.OmnichannelSetting) => {
        ...
        it('uses async iteration with listOmnichannelSettings without error', async () => {
            ...
            client.descriptors.page.listOmnichannelSettings.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(
                (client.descriptors.page.listOmnichannelSettings.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listOmnichannelSettings with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listOmnichannelSettings.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listOmnichannelSettingsAsync(request);
