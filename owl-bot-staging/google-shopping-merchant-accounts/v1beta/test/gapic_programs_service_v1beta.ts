...
describe('v1beta.ProgramsServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = programsserviceModule.v1beta.ProgramsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = programsserviceModule.v1beta.ProgramsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new programsserviceModule.v1beta.ProgramsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new programsserviceModule.v1beta.ProgramsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new programsserviceModule.v1beta.ProgramsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new programsserviceModule.v1beta.ProgramsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getProgram', () => {
        it('invokes getProgram without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.GetProgramRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getProgram as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getProgram as SinonStub)
        ...
        it('invokes getProgram without error using callback', async () => {
            ...
            client.innerApiCalls.getProgram = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getProgram(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1beta.IProgram|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getProgram with error', async () => {
            ...
            client.innerApiCalls.getProgram = stubSimpleCall(undefined, expectedError);
    ...
    describe('enableProgram', () => {
        it('invokes enableProgram without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.EnableProgramRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.Program()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.enableProgram as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.enableProgram as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes enableProgram without error using callback', async () => {
            ...
            client.innerApiCalls.enableProgram = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes enableProgram with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.enableProgram = stubSimpleCall(undefined, expectedError);
    ...
    describe('disableProgram', () => {
        it('invokes disableProgram without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.DisableProgramRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.Program()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.disableProgram as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.disableProgram as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes disableProgram without error using callback', async () => {
            ...
            client.innerApiCalls.disableProgram = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes disableProgram with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.disableProgram = stubSimpleCall(undefined, expectedError);
    ...
    describe('listPrograms', () => {
        it('invokes listPrograms without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.ListProgramsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1beta.Program()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1beta.Program()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1beta.Program()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listPrograms as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listPrograms as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listPrograms without error using callback', async () => {
            ...
            client.innerApiCalls.listPrograms = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listPrograms(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1beta.IProgram[]|null) => {
        ...
        it('invokes listPrograms with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listPrograms = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listProgramsStream without error', async () => {
            ...
            client.descriptors.page.listPrograms.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listProgramsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.shopping.merchant.accounts.v1beta.Program[] = [];
                stream.on('data', (response: protos.google.shopping.merchant.accounts.v1beta.Program) => {
            ...
            assert((client.descriptors.page.listPrograms.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listPrograms, request));
            assert(
        ...
        it('invokes listProgramsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listPrograms.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listProgramsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.shopping.merchant.accounts.v1beta.Program[] = [];
                stream.on('data', (response: protos.google.shopping.merchant.accounts.v1beta.Program) => {
        ...
        it('uses async iteration with listPrograms without error', async () => {
            ...
            client.descriptors.page.listPrograms.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listPrograms with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listPrograms.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listProgramsAsync(request);
