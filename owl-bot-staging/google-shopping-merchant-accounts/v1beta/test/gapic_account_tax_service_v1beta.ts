...
describe('v1beta.AccountTaxServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = accounttaxserviceModule.v1beta.AccountTaxServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = accounttaxserviceModule.v1beta.AccountTaxServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new accounttaxserviceModule.v1beta.AccountTaxServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new accounttaxserviceModule.v1beta.AccountTaxServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new accounttaxserviceModule.v1beta.AccountTaxServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new accounttaxserviceModule.v1beta.AccountTaxServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getAccountTax', () => {
        it('invokes getAccountTax without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.GetAccountTaxRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getAccountTax as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getAccountTax as SinonStub)
        ...
        it('invokes getAccountTax without error using callback', async () => {
            ...
            client.innerApiCalls.getAccountTax = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAccountTax(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1beta.IAccountTax|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAccountTax with error', async () => {
            ...
            client.innerApiCalls.getAccountTax = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateAccountTax', () => {
        it('invokes updateAccountTax without error', async () => {
            ...
            request.accountTax ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.UpdateAccountTaxRequest', ['accountTax', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateAccountTax as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateAccountTax as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateAccountTax without error using callback', async () => {
            ...
            client.innerApiCalls.updateAccountTax = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateAccountTax with error', async () => {
            ...
            const expectedHeaderRequestParams = `account_tax.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateAccountTax = stubSimpleCall(undefined, expectedError);
    ...
    describe('listAccountTax', () => {
        it('invokes listAccountTax without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.ListAccountTaxRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1beta.AccountTax()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1beta.AccountTax()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1beta.AccountTax()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listAccountTax as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAccountTax as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listAccountTax without error using callback', async () => {
            ...
            client.innerApiCalls.listAccountTax = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listAccountTax with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listAccountTax = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listAccountTaxStream without error', async () => {
            ...
            client.descriptors.page.listAccountTax.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.shopping.merchant.accounts.v1beta.AccountTax) => {
            ...
            assert((client.descriptors.page.listAccountTax.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listAccountTax, request));
            assert(
        ...
        it('invokes listAccountTaxStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAccountTax.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listAccountTaxStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.shopping.merchant.accounts.v1beta.AccountTax[] = [];
                stream.on('data', (response: protos.google.shopping.merchant.accounts.v1beta.AccountTax) => {
        ...
        it('uses async iteration with listAccountTax without error', async () => {
            ...
            client.descriptors.page.listAccountTax.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listAccountTax with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAccountTax.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listAccountTaxAsync(request);
