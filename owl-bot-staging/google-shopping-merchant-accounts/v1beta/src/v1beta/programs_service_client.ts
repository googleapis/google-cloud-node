 ...
 * `src/v1beta/programs_service_client_config.json`.
...
export class ProgramsServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.shopping.merchant.accounts.v1beta.ProgramsService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.programsServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.shopping.merchant.accounts.v1beta.ProgramsService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.shopping.merchant.accounts.v1beta.ProgramsService,
 ...
 *   The first element of the array is an object representing {@link protos.google.shopping.merchant.accounts.v1beta.Program|Program}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta/programs_service.get_program.js</caption>
 * region_tag:merchantapi_v1beta_generated_ProgramsService_GetProgram_async
 */
  getProgram(
      request?: protos.google.shopping.merchant.accounts.v1beta.IGetProgramRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1beta.IProgram,
        protos.google.shopping.merchant.accounts.v1beta.IGetProgramRequest|undefined, {}|undefined
      ]>;
  getProgram(
      request: protos.google.shopping.merchant.accounts.v1beta.IGetProgramRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1beta.IProgram,
          protos.google.shopping.merchant.accounts.v1beta.IGetProgramRequest|null|undefined,
          {}|null|undefined>): void;
  getProgram(
      request: protos.google.shopping.merchant.accounts.v1beta.IGetProgramRequest,
      callback: Callback<
  ...
  getProgram(
    ...
    return this.innerApiCalls.getProgram(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1beta.IProgram,
        protos.google.shopping.merchant.accounts.v1beta.IGetProgramRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getProgram response %j', response);
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta/programs_service.enable_program.js</caption>
 * region_tag:merchantapi_v1beta_generated_ProgramsService_EnableProgram_async
 */
  enableProgram(
      request?: protos.google.shopping.merchant.accounts.v1beta.IEnableProgramRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1beta.IProgram,
        protos.google.shopping.merchant.accounts.v1beta.IEnableProgramRequest|undefined, {}|undefined
      ]>;
  enableProgram(
      request: protos.google.shopping.merchant.accounts.v1beta.IEnableProgramRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1beta.IProgram,
          protos.google.shopping.merchant.accounts.v1beta.IEnableProgramRequest|null|undefined,
          {}|null|undefined>): void;
  enableProgram(
      request: protos.google.shopping.merchant.accounts.v1beta.IEnableProgramRequest,
      callback: Callback<
  ...
  enableProgram(
    ...
    return this.innerApiCalls.enableProgram(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1beta.IProgram,
        protos.google.shopping.merchant.accounts.v1beta.IEnableProgramRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('enableProgram response %j', response);
        return [response, options, rawResponse];
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta/programs_service.disable_program.js</caption>
 * region_tag:merchantapi_v1beta_generated_ProgramsService_DisableProgram_async
 */
  disableProgram(
      request?: protos.google.shopping.merchant.accounts.v1beta.IDisableProgramRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1beta.IProgram,
        protos.google.shopping.merchant.accounts.v1beta.IDisableProgramRequest|undefined, {}|undefined
      ]>;
  disableProgram(
      request: protos.google.shopping.merchant.accounts.v1beta.IDisableProgramRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1beta.IProgram,
          protos.google.shopping.merchant.accounts.v1beta.IDisableProgramRequest|null|undefined,
          {}|null|undefined>): void;
  disableProgram(
      request: protos.google.shopping.merchant.accounts.v1beta.IDisableProgramRequest,
      callback: Callback<
  ...
  disableProgram(
    ...
    return this.innerApiCalls.disableProgram(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1beta.IProgram,
        protos.google.shopping.merchant.accounts.v1beta.IDisableProgramRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('disableProgram response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.shopping.merchant.accounts.v1beta.Program|Program}.
 ...
 */
  listPrograms(
      request?: protos.google.shopping.merchant.accounts.v1beta.IListProgramsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1beta.IProgram[],
  ...
  listPrograms(
      ...
      callback: PaginationCallback<
          ...
          protos.google.shopping.merchant.accounts.v1beta.IListProgramsResponse|null|undefined,
          protos.google.shopping.merchant.accounts.v1beta.IProgram>): void;
  listPrograms(
      request: protos.google.shopping.merchant.accounts.v1beta.IListProgramsRequest,
      callback: PaginationCallback<
          protos.google.shopping.merchant.accounts.v1beta.IListProgramsRequest,
  ...
  listPrograms(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.shopping.merchant.accounts.v1beta.IListProgramsRequest,
      protos.google.shopping.merchant.accounts.v1beta.IListProgramsResponse|null|undefined,
      protos.google.shopping.merchant.accounts.v1beta.IProgram>|undefined = callback
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.shopping.merchant.accounts.v1beta.Program|Program} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   {@link protos.google.shopping.merchant.accounts.v1beta.Program|Program}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta/programs_service.list_programs.js</caption>
 * region_tag:merchantapi_v1beta_generated_ProgramsService_ListPrograms_async
 */
  listProgramsAsync(
      request?: protos.google.shopping.merchant.accounts.v1beta.IListProgramsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.shopping.merchant.accounts.v1beta.IProgram>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listPrograms.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.shopping.merchant.accounts.v1beta.IProgram>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
