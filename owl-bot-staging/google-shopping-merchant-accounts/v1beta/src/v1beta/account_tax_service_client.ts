 ...
 * `src/v1beta/account_tax_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './account_tax_service_client_config.json';
 ...
 *
 *  - {@link protos.google.shopping.merchant.accounts.v1main.AccountTax|AccountTax}
 * @class
 * @memberof v1beta
 */
export class AccountTaxServiceClient {
  ...
  accountTaxServiceStub?: Promise<{[name: string]: Function}>;
  ...
  initialize() {
    ...
    if (this.accountTaxServiceStub) {
      return this.accountTaxServiceStub;
    }
 ...
 */
  listAccountTaxAsync(
    ...
    return this.descriptors.page.listAccountTax.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.shopping.merchant.accounts.v1beta.IAccountTax>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
