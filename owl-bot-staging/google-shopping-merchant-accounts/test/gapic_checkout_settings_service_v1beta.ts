...
describe('v1beta.CheckoutSettingsServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new checkoutsettingsserviceModule.v1beta.CheckoutSettingsServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = checkoutsettingsserviceModule.v1beta.CheckoutSettingsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = checkoutsettingsserviceModule.v1beta.CheckoutSettingsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new checkoutsettingsserviceModule.v1beta.CheckoutSettingsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new checkoutsettingsserviceModule.v1beta.CheckoutSettingsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new checkoutsettingsserviceModule.v1beta.CheckoutSettingsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new checkoutsettingsserviceModule.v1beta.CheckoutSettingsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = checkoutsettingsserviceModule.v1beta.CheckoutSettingsServiceClient.port;
            assert(port);
    ...
    describe('getCheckoutSettings', () => {
        it('invokes getCheckoutSettings without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.GetCheckoutSettingsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.GetCheckoutSettingsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.CheckoutSettings()
            );
            client.innerApiCalls.getCheckoutSettings = stubSimpleCall(expectedResponse);
            const [response] = await client.getCheckoutSettings(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getCheckoutSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getCheckoutSettings as SinonStub)
        ...
        it('invokes getCheckoutSettings without error using callback', async () => {
            ...
            client.innerApiCalls.getCheckoutSettings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCheckoutSettings(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1beta.ICheckoutSettings|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCheckoutSettings with error', async () => {
            ...
            client.innerApiCalls.getCheckoutSettings = stubSimpleCall(undefined, expectedError);
    ...
    describe('createCheckoutSettings', () => {
        it('invokes createCheckoutSettings without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.CreateCheckoutSettingsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.CreateCheckoutSettingsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.CheckoutSettings()
            );
            client.innerApiCalls.createCheckoutSettings = stubSimpleCall(expectedResponse);
            const [response] = await client.createCheckoutSettings(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createCheckoutSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createCheckoutSettings as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createCheckoutSettings without error using callback', async () => {
            ...
            client.innerApiCalls.createCheckoutSettings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createCheckoutSettings(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1beta.ICheckoutSettings|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes createCheckoutSettings with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createCheckoutSettings = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createCheckoutSettings(request), expectedError);
            const actualRequest = (client.innerApiCalls.createCheckoutSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createCheckoutSettings as SinonStub)
    ...
    describe('updateCheckoutSettings', () => {
        it('invokes updateCheckoutSettings without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.UpdateCheckoutSettingsRequest()
            );
            request.checkoutSettings ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.UpdateCheckoutSettingsRequest', ['checkoutSettings', 'name']);
            request.checkoutSettings.name = defaultValue1;
            const expectedHeaderRequestParams = `checkout_settings.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.CheckoutSettings()
            );
            client.innerApiCalls.updateCheckoutSettings = stubSimpleCall(expectedResponse);
            const [response] = await client.updateCheckoutSettings(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateCheckoutSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateCheckoutSettings as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateCheckoutSettings without error using callback', async () => {
            ...
            client.innerApiCalls.updateCheckoutSettings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateCheckoutSettings(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1beta.ICheckoutSettings|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes updateCheckoutSettings with error', async () => {
            ...
            const expectedHeaderRequestParams = `checkout_settings.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateCheckoutSettings = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateCheckoutSettings(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateCheckoutSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateCheckoutSettings as SinonStub)
    ...
    describe('deleteCheckoutSettings', () => {
        it('invokes deleteCheckoutSettings without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.DeleteCheckoutSettingsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.DeleteCheckoutSettingsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteCheckoutSettings = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteCheckoutSettings(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteCheckoutSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteCheckoutSettings as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteCheckoutSettings without error using callback', async () => {
            ...
            client.innerApiCalls.deleteCheckoutSettings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteCheckoutSettings(
                    request,
        ...
        it('invokes deleteCheckoutSettings with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteCheckoutSettings = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.deleteCheckoutSettings(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteCheckoutSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteCheckoutSettings as SinonStub)
