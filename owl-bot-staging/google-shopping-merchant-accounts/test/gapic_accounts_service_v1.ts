...
describe('v1.AccountsServiceClient', () => {
  ...
  describe('getAccount', () => {
    it('invokes getAccount without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.shopping.merchant.accounts.v1.GetAccountRequest(),
      );
    ...
    it('invokes getAccount without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getAccount(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1.IAccount | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createAndConfigureAccount', () => {
    it('invokes createAndConfigureAccount without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.shopping.merchant.accounts.v1.CreateAndConfigureAccountRequest(),
      );
      const expectedResponse = generateSampleMessage(
        new protos.google.shopping.merchant.accounts.v1.Account(),
      );
  ...
  describe('createTestAccount', () => {
    it('invokes createTestAccount without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createTestAccount as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createTestAccount as SinonStub
    ...
    it('invokes createTestAccount without error using callback', async () => {
      ...
      client.innerApiCalls.createTestAccount =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes createTestAccount with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createTestAccount = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteAccount', () => {
    it('invokes deleteAccount without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.shopping.merchant.accounts.v1.DeleteAccountRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('updateAccount', () => {
    it('invokes updateAccount without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.shopping.merchant.accounts.v1.UpdateAccountRequest(),
      );
      request.account ??= {};
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('listAccounts', () => {
    it('invokes listAccounts without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.shopping.merchant.accounts.v1.ListAccountsRequest(),
      );
    ...
    it('invokes listAccountsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.shopping.merchant.accounts.v1.Account[] =
          [];
        stream.on(
          'data',
          (response: protos.google.shopping.merchant.accounts.v1.Account) => {
    ...
    it('uses async iteration with listAccounts without error', async () => {
      ...
      const responses: protos.google.shopping.merchant.accounts.v1.IAccount[] =
        [];
  ...
  describe('listSubAccounts', () => {
    it('invokes listSubAccounts without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.shopping.merchant.accounts.v1.ListSubAccountsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('Path templates', () => {
    ...
    describe('accountRelationship', async () => {
      ...
      await client.initialize();
      client.pathTemplates.accountRelationshipPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.accountRelationshipPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('accountRelationshipPath', () => {
        const result = client.accountRelationshipPath(
          'accountValue',
          'relationshipValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.accountRelationshipPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchRelationshipFromAccountRelationshipName', () => {
        const result =
          client.matchRelationshipFromAccountRelationshipName(fakePath);
    ...
    describe('accountService', async () => {
      ...
      await client.initialize();
      client.pathTemplates.accountServicePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.accountServicePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('accountServicePath', () => {
        const result = client.accountServicePath(
          'accountValue',
          'serviceValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.accountServicePathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchAccountFromAccountServiceName', () => {
        ...
        assert.strictEqual(result, 'accountValue');
        assert(
          (client.pathTemplates.accountServicePathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('checkoutSettings', async () => {
      ...
      await client.initialize();
      client.pathTemplates.checkoutSettingsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.checkoutSettingsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('checkoutSettingsPath', () => {
        const result = client.checkoutSettingsPath(
          'accountValue',
          'programValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.checkoutSettingsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchAccountFromCheckoutSettingsName', () => {
        ...
        assert.strictEqual(result, 'accountValue');
        assert(
          (client.pathTemplates.checkoutSettingsPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('developerRegistration', async () => {
      ...
      await client.initialize();
      client.pathTemplates.developerRegistrationPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.developerRegistrationPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);
      ...
      it('developerRegistrationPath', () => {
        ...
        assert(
          (
            client.pathTemplates.developerRegistrationPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchAccountFromDeveloperRegistrationName', () => {
        const result =
          client.matchAccountFromDeveloperRegistrationName(fakePath);
        assert.strictEqual(result, 'accountValue');
        assert(
          (
            client.pathTemplates.developerRegistrationPathTemplate
