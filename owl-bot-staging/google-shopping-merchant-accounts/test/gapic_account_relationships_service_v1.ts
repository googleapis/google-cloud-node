...
describe('v1.AccountRelationshipsServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new accountrelationshipsserviceModule.v1.AccountRelationshipsServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = accountrelationshipsserviceModule.v1.AccountRelationshipsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = accountrelationshipsserviceModule.v1.AccountRelationshipsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new accountrelationshipsserviceModule.v1.AccountRelationshipsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new accountrelationshipsserviceModule.v1.AccountRelationshipsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new accountrelationshipsserviceModule.v1.AccountRelationshipsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new accountrelationshipsserviceModule.v1.AccountRelationshipsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = accountrelationshipsserviceModule.v1.AccountRelationshipsServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.accountRelationshipsServiceStub, undefined);
    ...
    describe('getAccountRelationship', () => {
        it('invokes getAccountRelationship without error', async () => {
            const client = new accountrelationshipsserviceModule.v1.AccountRelationshipsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.GetAccountRelationshipRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.GetAccountRelationshipRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.AccountRelationship()
            );
            client.innerApiCalls.getAccountRelationship = stubSimpleCall(expectedResponse);
            const [response] = await client.getAccountRelationship(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getAccountRelationship as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getAccountRelationship as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getAccountRelationship without error using callback', async () => {
            const client = new accountrelationshipsserviceModule.v1.AccountRelationshipsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getAccountRelationship = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAccountRelationship(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1.IAccountRelationship|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAccountRelationship with error', async () => {
            const client = new accountrelationshipsserviceModule.v1.AccountRelationshipsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getAccountRelationship = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAccountRelationship(request), expectedError);
            const actualRequest = (client.innerApiCalls.getAccountRelationship as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getAccountRelationship as SinonStub)
        ...
        it('invokes getAccountRelationship with closed client', async () => {
            const client = new accountrelationshipsserviceModule.v1.AccountRelationshipsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('updateAccountRelationship', () => {
        it('invokes updateAccountRelationship without error', async () => {
            const client = new accountrelationshipsserviceModule.v1.AccountRelationshipsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.UpdateAccountRelationshipRequest()
            );
            request.accountRelationship ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.UpdateAccountRelationshipRequest', ['accountRelationship', 'name']);
            request.accountRelationship.name = defaultValue1;
            const expectedHeaderRequestParams = `account_relationship.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.AccountRelationship()
            );
            client.innerApiCalls.updateAccountRelationship = stubSimpleCall(expectedResponse);
            const [response] = await client.updateAccountRelationship(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateAccountRelationship as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateAccountRelationship as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes updateAccountRelationship without error using callback', async () => {
            const client = new accountrelationshipsserviceModule.v1.AccountRelationshipsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.updateAccountRelationship = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateAccountRelationship(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1.IAccountRelationship|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes updateAccountRelationship with error', async () => {
            const client = new accountrelationshipsserviceModule.v1.AccountRelationshipsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `account_relationship.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateAccountRelationship = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateAccountRelationship(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateAccountRelationship as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateAccountRelationship as SinonStub)
        ...
        it('invokes updateAccountRelationship with closed client', async () => {
            const client = new accountrelationshipsserviceModule.v1.AccountRelationshipsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('listAccountRelationships', () => {
        it('invokes listAccountRelationships without error', async () => {
            const client = new accountrelationshipsserviceModule.v1.AccountRelationshipsServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.ListAccountRelationshipsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.ListAccountRelationshipsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1.AccountRelationship()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1.AccountRelationship()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1.AccountRelationship()),
            ];
            client.innerApiCalls.listAccountRelationships = stubSimpleCall(expectedResponse);
            const [response] = await client.listAccountRelationships(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listAccountRelationships as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAccountRelationships as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes listAccountRelationships without error using callback', async () => {
            const client = new accountrelationshipsserviceModule.v1.AccountRelationshipsServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listAccountRelationships = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listAccountRelationships(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1.IAccountRelationship[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listAccountRelationships with error', async () => {
            const client = new accountrelationshipsserviceModule.v1.AccountRelationshipsServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listAccountRelationships = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listAccountRelationships(request), expectedError);
            const actualRequest = (client.innerApiCalls.listAccountRelationships as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAccountRelationships as SinonStub)
        ...
        it('invokes listAccountRelationshipsStream without error', async () => {
            const client = new accountrelationshipsserviceModule.v1.AccountRelationshipsServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listAccountRelationships.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listAccountRelationshipsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.shopping.merchant.accounts.v1.AccountRelationship[] = [];
                stream.on('data', (response: protos.google.shopping.merchant.accounts.v1.AccountRelationship) => {
            ...
            assert((client.descriptors.page.listAccountRelationships.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listAccountRelationships, request));
            assert(
                (client.descriptors.page.listAccountRelationships.createStream as SinonStub)
        ...
        it('invokes listAccountRelationshipsStream with error', async () => {
            const client = new accountrelationshipsserviceModule.v1.AccountRelationshipsServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAccountRelationships.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listAccountRelationshipsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.shopping.merchant.accounts.v1.AccountRelationship[] = [];
                stream.on('data', (response: protos.google.shopping.merchant.accounts.v1.AccountRelationship) => {
        ...
        it('uses async iteration with listAccountRelationships without error', async () => {
            const client = new accountrelationshipsserviceModule.v1.AccountRelationshipsServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listAccountRelationships.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.shopping.merchant.accounts.v1.IAccountRelationship[] = [];
            const iterable = client.listAccountRelationshipsAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listAccountRelationships.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listAccountRelationships with error', async () => {
            const client = new accountrelationshipsserviceModule.v1.AccountRelationshipsServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAccountRelationships.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listAccountRelationshipsAsync(request);
