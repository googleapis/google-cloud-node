...
describe('v1.AccountServicesServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new accountservicesserviceModule.v1.AccountServicesServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          accountservicesserviceModule.v1.AccountServicesServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        accountservicesserviceModule.v1.AccountServicesServiceClient.port;
      assert(port);
  ...
  describe('getAccountService', () => {
    it('invokes getAccountService without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getAccountService as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getAccountService without error using callback', async () => {
      ...
      client.innerApiCalls.getAccountService =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getAccountService(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1.IAccountService | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getAccountService with error', async () => {
      ...
      client.innerApiCalls.getAccountService = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('proposeAccountService', () => {
    it('invokes proposeAccountService without error', async () => {
      ...
      client.innerApiCalls.proposeAccountService =
        stubSimpleCall(expectedResponse);
      const [response] = await client.proposeAccountService(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.proposeAccountService as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.proposeAccountService as SinonStub
    ...
    it('invokes proposeAccountService with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.proposeAccountService = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.proposeAccountService(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.proposeAccountService as SinonStub
  ...
  describe('approveAccountService', () => {
    it('invokes approveAccountService without error', async () => {
      ...
      client.innerApiCalls.approveAccountService =
        stubSimpleCall(expectedResponse);
      const [response] = await client.approveAccountService(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.approveAccountService as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.approveAccountService as SinonStub
    ...
    it('invokes approveAccountService with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.approveAccountService = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.approveAccountService(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.approveAccountService as SinonStub
  ...
  describe('rejectAccountService', () => {
    it('invokes rejectAccountService without error', async () => {
      ...
      client.innerApiCalls.rejectAccountService =
        stubSimpleCall(expectedResponse);
      const [response] = await client.rejectAccountService(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.rejectAccountService as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.rejectAccountService as SinonStub
    ...
    it('invokes rejectAccountService with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.rejectAccountService = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listAccountServices', () => {
    it('invokes listAccountServices without error', async () => {
      ...
      client.innerApiCalls.listAccountServices =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listAccountServices(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listAccountServices as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listAccountServices as SinonStub
      ...
      const promise = new Promise((resolve, reject) => {
        client.listAccountServices(
          ...
          (
            err?: Error | null,
            result?:
              | protos.google.shopping.merchant.accounts.v1.IAccountService[]
              | null,
          ) => {
            if (err) {
              reject(err);
    ...
    it('invokes listAccountServices with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listAccountServices = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listAccountServicesStream without error', async () => {
      ...
      client.descriptors.page.listAccountServices.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.shopping.merchant.accounts.v1.AccountService,
          ) => {
      ...
      assert(
        (client.descriptors.page.listAccountServices.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listAccountServices, request),
      );
      assert(
        (client.descriptors.page.listAccountServices.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listAccountServices without error', async () => {
      ...
      client.descriptors.page.listAccountServices.asyncIterate =
