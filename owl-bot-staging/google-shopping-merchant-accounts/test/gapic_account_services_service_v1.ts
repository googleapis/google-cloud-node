...
import * as accountservicesserviceModule from '../src';
...
describe('v1.AccountServicesServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new accountservicesserviceModule.v1.AccountServicesServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = accountservicesserviceModule.v1.AccountServicesServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = accountservicesserviceModule.v1.AccountServicesServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new accountservicesserviceModule.v1.AccountServicesServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new accountservicesserviceModule.v1.AccountServicesServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new accountservicesserviceModule.v1.AccountServicesServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new accountservicesserviceModule.v1.AccountServicesServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = accountservicesserviceModule.v1.AccountServicesServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.accountServicesServiceStub, undefined);
            await client.initialize();
            assert(client.accountServicesServiceStub);
        });
    ...
    describe('getAccountService', () => {
        it('invokes getAccountService without error', async () => {
            const client = new accountservicesserviceModule.v1.AccountServicesServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.GetAccountServiceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.GetAccountServiceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.AccountService()
            );
            client.innerApiCalls.getAccountService = stubSimpleCall(expectedResponse);
            const [response] = await client.getAccountService(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getAccountService as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getAccountService as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getAccountService without error using callback', async () => {
            const client = new accountservicesserviceModule.v1.AccountServicesServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getAccountService = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAccountService(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1.IAccountService|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAccountService with error', async () => {
            const client = new accountservicesserviceModule.v1.AccountServicesServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getAccountService = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAccountService(request), expectedError);
            const actualRequest = (client.innerApiCalls.getAccountService as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getAccountService as SinonStub)
        ...
        it('invokes getAccountService with closed client', async () => {
            const client = new accountservicesserviceModule.v1.AccountServicesServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('proposeAccountService', () => {
        it('invokes proposeAccountService without error', async () => {
            const client = new accountservicesserviceModule.v1.AccountServicesServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.ProposeAccountServiceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.ProposeAccountServiceRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.AccountService()
            );
            client.innerApiCalls.proposeAccountService = stubSimpleCall(expectedResponse);
            const [response] = await client.proposeAccountService(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.proposeAccountService as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.proposeAccountService as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes proposeAccountService without error using callback', async () => {
            const client = new accountservicesserviceModule.v1.AccountServicesServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.proposeAccountService = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.proposeAccountService(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1.IAccountService|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes proposeAccountService with error', async () => {
            const client = new accountservicesserviceModule.v1.AccountServicesServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.proposeAccountService = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.proposeAccountService(request), expectedError);
            const actualRequest = (client.innerApiCalls.proposeAccountService as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.proposeAccountService as SinonStub)
        ...
        it('invokes proposeAccountService with closed client', async () => {
            const client = new accountservicesserviceModule.v1.AccountServicesServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('approveAccountService', () => {
        it('invokes approveAccountService without error', async () => {
            const client = new accountservicesserviceModule.v1.AccountServicesServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.ApproveAccountServiceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.ApproveAccountServiceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.AccountService()
            );
            client.innerApiCalls.approveAccountService = stubSimpleCall(expectedResponse);
            const [response] = await client.approveAccountService(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.approveAccountService as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.approveAccountService as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes approveAccountService without error using callback', async () => {
            const client = new accountservicesserviceModule.v1.AccountServicesServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.approveAccountService = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.approveAccountService(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1.IAccountService|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes approveAccountService with error', async () => {
            const client = new accountservicesserviceModule.v1.AccountServicesServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.approveAccountService = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.approveAccountService(request), expectedError);
            const actualRequest = (client.innerApiCalls.approveAccountService as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.approveAccountService as SinonStub)
        ...
        it('invokes approveAccountService with closed client', async () => {
            const client = new accountservicesserviceModule.v1.AccountServicesServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('rejectAccountService', () => {
        it('invokes rejectAccountService without error', async () => {
            const client = new accountservicesserviceModule.v1.AccountServicesServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.RejectAccountServiceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.RejectAccountServiceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.rejectAccountService = stubSimpleCall(expectedResponse);
            const [response] = await client.rejectAccountService(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.rejectAccountService as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.rejectAccountService as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes rejectAccountService without error using callback', async () => {
            const client = new accountservicesserviceModule.v1.AccountServicesServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.rejectAccountService = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.rejectAccountService(
                    request,
        ...
        it('invokes rejectAccountService with error', async () => {
            const client = new accountservicesserviceModule.v1.AccountServicesServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.rejectAccountService = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.rejectAccountService(request), expectedError);
            const actualRequest = (client.innerApiCalls.rejectAccountService as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.rejectAccountService as SinonStub)
        ...
        it('invokes rejectAccountService with closed client', async () => {
            const client = new accountservicesserviceModule.v1.AccountServicesServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('listAccountServices', () => {
        it('invokes listAccountServices without error', async () => {
            const client = new accountservicesserviceModule.v1.AccountServicesServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.ListAccountServicesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.ListAccountServicesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1.AccountService()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1.AccountService()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1.AccountService()),
            ];
            client.innerApiCalls.listAccountServices = stubSimpleCall(expectedResponse);
            const [response] = await client.listAccountServices(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listAccountServices as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAccountServices as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes listAccountServices without error using callback', async () => {
            const client = new accountservicesserviceModule.v1.AccountServicesServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listAccountServices = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listAccountServices(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1.IAccountService[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listAccountServices with error', async () => {
            const client = new accountservicesserviceModule.v1.AccountServicesServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listAccountServices = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listAccountServices(request), expectedError);
            const actualRequest = (client.innerApiCalls.listAccountServices as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAccountServices as SinonStub)
        ...
        it('invokes listAccountServicesStream without error', async () => {
            const client = new accountservicesserviceModule.v1.AccountServicesServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listAccountServices.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listAccountServicesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.shopping.merchant.accounts.v1.AccountService[] = [];
                stream.on('data', (response: protos.google.shopping.merchant.accounts.v1.AccountService) => {
            ...
            assert((client.descriptors.page.listAccountServices.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listAccountServices, request));
            assert(
                (client.descriptors.page.listAccountServices.createStream as SinonStub)
        ...
        it('invokes listAccountServicesStream with error', async () => {
            const client = new accountservicesserviceModule.v1.AccountServicesServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAccountServices.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listAccountServicesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.shopping.merchant.accounts.v1.AccountService[] = [];
                stream.on('data', (response: protos.google.shopping.merchant.accounts.v1.AccountService) => {
        ...
        it('uses async iteration with listAccountServices without error', async () => {
            const client = new accountservicesserviceModule.v1.AccountServicesServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listAccountServices.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.shopping.merchant.accounts.v1.IAccountService[] = [];
            const iterable = client.listAccountServicesAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listAccountServices.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listAccountServices with error', async () => {
            const client = new accountservicesserviceModule.v1.AccountServicesServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAccountServices.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listAccountServicesAsync(request);
