...
describe('v1beta.AutomaticImprovementsServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new automaticimprovementsserviceModule.v1beta.AutomaticImprovementsServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = automaticimprovementsserviceModule.v1beta.AutomaticImprovementsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = automaticimprovementsserviceModule.v1beta.AutomaticImprovementsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new automaticimprovementsserviceModule.v1beta.AutomaticImprovementsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new automaticimprovementsserviceModule.v1beta.AutomaticImprovementsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new automaticimprovementsserviceModule.v1beta.AutomaticImprovementsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new automaticimprovementsserviceModule.v1beta.AutomaticImprovementsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = automaticimprovementsserviceModule.v1beta.AutomaticImprovementsServiceClient.port;
            assert(port);
    ...
    describe('getAutomaticImprovements', () => {
        it('invokes getAutomaticImprovements without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.GetAutomaticImprovementsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.AutomaticImprovements()
            );
            client.innerApiCalls.getAutomaticImprovements = stubSimpleCall(expectedResponse);
            const [response] = await client.getAutomaticImprovements(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getAutomaticImprovements as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getAutomaticImprovements as SinonStub)
        ...
        it('invokes getAutomaticImprovements without error using callback', async () => {
            ...
            client.innerApiCalls.getAutomaticImprovements = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAutomaticImprovements(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1beta.IAutomaticImprovements|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAutomaticImprovements with error', async () => {
            ...
            client.innerApiCalls.getAutomaticImprovements = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAutomaticImprovements(request), expectedError);
            const actualRequest = (client.innerApiCalls.getAutomaticImprovements as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getAutomaticImprovements as SinonStub)
    ...
    describe('updateAutomaticImprovements', () => {
        it('invokes updateAutomaticImprovements without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.UpdateAutomaticImprovementsRequest', ['automaticImprovements', 'name']);
            ...
            client.innerApiCalls.updateAutomaticImprovements = stubSimpleCall(expectedResponse);
            const [response] = await client.updateAutomaticImprovements(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateAutomaticImprovements as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateAutomaticImprovements as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateAutomaticImprovements without error using callback', async () => {
            ...
            client.innerApiCalls.updateAutomaticImprovements = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateAutomaticImprovements with error', async () => {
            ...
            const expectedHeaderRequestParams = `automatic_improvements.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateAutomaticImprovements = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateAutomaticImprovements(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateAutomaticImprovements as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateAutomaticImprovements as SinonStub)
