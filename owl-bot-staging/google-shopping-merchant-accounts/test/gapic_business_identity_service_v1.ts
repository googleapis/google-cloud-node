...
describe('v1.BusinessIdentityServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new businessidentityserviceModule.v1.BusinessIdentityServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          businessidentityserviceModule.v1.BusinessIdentityServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        businessidentityserviceModule.v1.BusinessIdentityServiceClient.port;
      assert(port);
  ...
  describe('getBusinessIdentity', () => {
    it('invokes getBusinessIdentity without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.shopping.merchant.accounts.v1.GetBusinessIdentityRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.shopping.merchant.accounts.v1.GetBusinessIdentityRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.shopping.merchant.accounts.v1.BusinessIdentity(),
      );
      client.innerApiCalls.getBusinessIdentity =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getBusinessIdentity(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getBusinessIdentity as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getBusinessIdentity without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getBusinessIdentity(
          request,
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1.IBusinessIdentity | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getBusinessIdentity with error', async () => {
      ...
      client.innerApiCalls.getBusinessIdentity = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateBusinessIdentity', () => {
    it('invokes updateBusinessIdentity without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.shopping.merchant.accounts.v1.UpdateBusinessIdentityRequest(),
      );
      ...
      const expectedHeaderRequestParams = `business_identity.name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.shopping.merchant.accounts.v1.BusinessIdentity(),
      );
      client.innerApiCalls.updateBusinessIdentity =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateBusinessIdentity(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateBusinessIdentity as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateBusinessIdentity as SinonStub
    ...
    it('invokes updateBusinessIdentity with error', async () => {
      ...
      const expectedHeaderRequestParams = `business_identity.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateBusinessIdentity = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateBusinessIdentity(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateBusinessIdentity as SinonStub
