...
describe('v1beta.OnlineReturnPolicyServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new onlinereturnpolicyserviceModule.v1beta.OnlineReturnPolicyServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = onlinereturnpolicyserviceModule.v1beta.OnlineReturnPolicyServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = onlinereturnpolicyserviceModule.v1beta.OnlineReturnPolicyServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new onlinereturnpolicyserviceModule.v1beta.OnlineReturnPolicyServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new onlinereturnpolicyserviceModule.v1beta.OnlineReturnPolicyServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new onlinereturnpolicyserviceModule.v1beta.OnlineReturnPolicyServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new onlinereturnpolicyserviceModule.v1beta.OnlineReturnPolicyServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = onlinereturnpolicyserviceModule.v1beta.OnlineReturnPolicyServiceClient.port;
            assert(port);
    ...
    describe('getOnlineReturnPolicy', () => {
        it('invokes getOnlineReturnPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.GetOnlineReturnPolicyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.OnlineReturnPolicy()
            );
            client.innerApiCalls.getOnlineReturnPolicy = stubSimpleCall(expectedResponse);
            const [response] = await client.getOnlineReturnPolicy(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getOnlineReturnPolicy as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getOnlineReturnPolicy as SinonStub)
        ...
        it('invokes getOnlineReturnPolicy without error using callback', async () => {
            ...
            client.innerApiCalls.getOnlineReturnPolicy = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getOnlineReturnPolicy(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1beta.IOnlineReturnPolicy|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getOnlineReturnPolicy with error', async () => {
            ...
            client.innerApiCalls.getOnlineReturnPolicy = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getOnlineReturnPolicy(request), expectedError);
            const actualRequest = (client.innerApiCalls.getOnlineReturnPolicy as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getOnlineReturnPolicy as SinonStub)
    ...
    describe('createOnlineReturnPolicy', () => {
        it('invokes createOnlineReturnPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.CreateOnlineReturnPolicyRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.OnlineReturnPolicy()
            );
            client.innerApiCalls.createOnlineReturnPolicy = stubSimpleCall(expectedResponse);
            const [response] = await client.createOnlineReturnPolicy(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createOnlineReturnPolicy as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createOnlineReturnPolicy as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createOnlineReturnPolicy without error using callback', async () => {
            ...
            client.innerApiCalls.createOnlineReturnPolicy = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createOnlineReturnPolicy with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createOnlineReturnPolicy = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createOnlineReturnPolicy(request), expectedError);
            const actualRequest = (client.innerApiCalls.createOnlineReturnPolicy as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createOnlineReturnPolicy as SinonStub)
    ...
    describe('updateOnlineReturnPolicy', () => {
        it('invokes updateOnlineReturnPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.UpdateOnlineReturnPolicyRequest', ['onlineReturnPolicy', 'name']);
            request.onlineReturnPolicy.name = defaultValue1;
            const expectedHeaderRequestParams = `online_return_policy.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.OnlineReturnPolicy()
            );
            client.innerApiCalls.updateOnlineReturnPolicy = stubSimpleCall(expectedResponse);
            const [response] = await client.updateOnlineReturnPolicy(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateOnlineReturnPolicy as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateOnlineReturnPolicy as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateOnlineReturnPolicy without error using callback', async () => {
            ...
            client.innerApiCalls.updateOnlineReturnPolicy = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateOnlineReturnPolicy with error', async () => {
            ...
            const expectedHeaderRequestParams = `online_return_policy.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateOnlineReturnPolicy = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateOnlineReturnPolicy(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateOnlineReturnPolicy as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateOnlineReturnPolicy as SinonStub)
    ...
    describe('deleteOnlineReturnPolicy', () => {
        it('invokes deleteOnlineReturnPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.DeleteOnlineReturnPolicyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteOnlineReturnPolicy = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteOnlineReturnPolicy(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteOnlineReturnPolicy as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteOnlineReturnPolicy as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteOnlineReturnPolicy without error using callback', async () => {
            ...
            client.innerApiCalls.deleteOnlineReturnPolicy = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteOnlineReturnPolicy with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteOnlineReturnPolicy = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.deleteOnlineReturnPolicy(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteOnlineReturnPolicy as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteOnlineReturnPolicy as SinonStub)
    ...
    describe('listOnlineReturnPolicies', () => {
        it('invokes listOnlineReturnPolicies without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.ListOnlineReturnPoliciesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1beta.OnlineReturnPolicy()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1beta.OnlineReturnPolicy()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1beta.OnlineReturnPolicy()),
            ];
            client.innerApiCalls.listOnlineReturnPolicies = stubSimpleCall(expectedResponse);
            const [response] = await client.listOnlineReturnPolicies(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listOnlineReturnPolicies as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listOnlineReturnPolicies as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listOnlineReturnPolicies without error using callback', async () => {
            ...
            client.innerApiCalls.listOnlineReturnPolicies = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listOnlineReturnPolicies with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listOnlineReturnPolicies = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listOnlineReturnPolicies(request), expectedError);
            const actualRequest = (client.innerApiCalls.listOnlineReturnPolicies as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listOnlineReturnPolicies as SinonStub)
        ...
        it('invokes listOnlineReturnPoliciesStream without error', async () => {
            ...
            client.descriptors.page.listOnlineReturnPolicies.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.shopping.merchant.accounts.v1beta.OnlineReturnPolicy) => {
            ...
            assert((client.descriptors.page.listOnlineReturnPolicies.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listOnlineReturnPolicies, request));
            assert(
                (client.descriptors.page.listOnlineReturnPolicies.createStream as SinonStub)
        ...
        it('invokes listOnlineReturnPoliciesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listOnlineReturnPolicies.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listOnlineReturnPoliciesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.shopping.merchant.accounts.v1beta.OnlineReturnPolicy[] = [];
                stream.on('data', (response: protos.google.shopping.merchant.accounts.v1beta.OnlineReturnPolicy) => {
        ...
        it('uses async iteration with listOnlineReturnPolicies without error', async () => {
            ...
            client.descriptors.page.listOnlineReturnPolicies.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(
                (client.descriptors.page.listOnlineReturnPolicies.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listOnlineReturnPolicies with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listOnlineReturnPolicies.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listOnlineReturnPoliciesAsync(request);
