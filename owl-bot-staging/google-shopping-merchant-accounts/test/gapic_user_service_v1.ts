...
describe('v1.UserServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath = userserviceModule.v1.UserServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint = userserviceModule.v1.UserServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new userserviceModule.v1.UserServiceClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = userserviceModule.v1.UserServiceClient.port;
      assert(port);
  ...
  describe('getUser', () => {
    it('invokes getUser without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.shopping.merchant.accounts.v1.GetUserRequest(),
      );
    ...
    it('invokes getUser without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getUser(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1.IUser | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createUser', () => {
    it('invokes createUser without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.shopping.merchant.accounts.v1.CreateUserRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('deleteUser', () => {
    it('invokes deleteUser without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.shopping.merchant.accounts.v1.DeleteUserRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.shopping.merchant.accounts.v1.DeleteUserRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('updateUser', () => {
    it('invokes updateUser without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.shopping.merchant.accounts.v1.UpdateUserRequest(),
      );
      request.user ??= {};
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('verifySelf', () => {
    it('invokes verifySelf without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.verifySelf as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.verifySelf as SinonStub
    ...
    it('invokes verifySelf without error using callback', async () => {
      ...
      client.innerApiCalls.verifySelf =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.verifySelf(
          request,
    ...
    it('invokes verifySelf with error', async () => {
      ...
      const expectedHeaderRequestParams = `account=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.verifySelf = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listUsers', () => {
    it('invokes listUsers without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.shopping.merchant.accounts.v1.ListUsersRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
    ...
    it('invokes listUsersStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.shopping.merchant.accounts.v1.User[] =
          [];
        stream.on(
          'data',
          (response: protos.google.shopping.merchant.accounts.v1.User) => {
    ...
    it('uses async iteration with listUsers without error', async () => {
      ...
      const responses: protos.google.shopping.merchant.accounts.v1.IUser[] = [];
