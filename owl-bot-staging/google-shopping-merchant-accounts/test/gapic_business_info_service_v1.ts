...
describe('v1.BusinessInfoServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new businessinfoserviceModule.v1.BusinessInfoServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          businessinfoserviceModule.v1.BusinessInfoServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          businessinfoserviceModule.v1.BusinessInfoServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port = businessinfoserviceModule.v1.BusinessInfoServiceClient.port;
      assert(port);
  ...
  describe('getBusinessInfo', () => {
    it('invokes getBusinessInfo without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.shopping.merchant.accounts.v1.GetBusinessInfoRequest(),
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.shopping.merchant.accounts.v1.BusinessInfo(),
      );
      client.innerApiCalls.getBusinessInfo = stubSimpleCall(expectedResponse);
      const [response] = await client.getBusinessInfo(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getBusinessInfo as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getBusinessInfo without error using callback', async () => {
      ...
      client.innerApiCalls.getBusinessInfo =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getBusinessInfo(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1.IBusinessInfo | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('updateBusinessInfo', () => {
    it('invokes updateBusinessInfo without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.shopping.merchant.accounts.v1.UpdateBusinessInfoRequest(),
      );
      ...
      client.innerApiCalls.updateBusinessInfo =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateBusinessInfo(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateBusinessInfo as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateBusinessInfo as SinonStub
