...
describe('v1.OmnichannelSettingsServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new omnichannelsettingsserviceModule.v1.OmnichannelSettingsServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = omnichannelsettingsserviceModule.v1.OmnichannelSettingsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = omnichannelsettingsserviceModule.v1.OmnichannelSettingsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new omnichannelsettingsserviceModule.v1.OmnichannelSettingsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new omnichannelsettingsserviceModule.v1.OmnichannelSettingsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new omnichannelsettingsserviceModule.v1.OmnichannelSettingsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new omnichannelsettingsserviceModule.v1.OmnichannelSettingsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = omnichannelsettingsserviceModule.v1.OmnichannelSettingsServiceClient.port;
            assert(port);
    ...
    describe('getOmnichannelSetting', () => {
        it('invokes getOmnichannelSetting without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.GetOmnichannelSettingRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.GetOmnichannelSettingRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.OmnichannelSetting()
            );
        ...
        it('invokes getOmnichannelSetting without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getOmnichannelSetting(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1.IOmnichannelSetting|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createOmnichannelSetting', () => {
        it('invokes createOmnichannelSetting without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.CreateOmnichannelSettingRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.CreateOmnichannelSettingRequest', ['parent']);
    ...
    describe('updateOmnichannelSetting', () => {
        it('invokes updateOmnichannelSetting without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.UpdateOmnichannelSettingRequest()
            );
            request.omnichannelSetting ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.UpdateOmnichannelSettingRequest', ['omnichannelSetting', 'name']);
    ...
    describe('requestInventoryVerification', () => {
        it('invokes requestInventoryVerification without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.RequestInventoryVerificationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.RequestInventoryVerificationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.RequestInventoryVerificationResponse()
            );
        ...
        it('invokes requestInventoryVerification without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.requestInventoryVerification(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1.IRequestInventoryVerificationResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listOmnichannelSettings', () => {
        it('invokes listOmnichannelSettings without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.ListOmnichannelSettingsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.ListOmnichannelSettingsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1.OmnichannelSetting()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1.OmnichannelSetting()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1.OmnichannelSetting()),
            ];
        ...
        it('invokes listOmnichannelSettingsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.shopping.merchant.accounts.v1.OmnichannelSetting[] = [];
                stream.on('data', (response: protos.google.shopping.merchant.accounts.v1.OmnichannelSetting) => {
        ...
        it('uses async iteration with listOmnichannelSettings without error', async () => {
            ...
            const responses: protos.google.shopping.merchant.accounts.v1.IOmnichannelSetting[] = [];
