  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          userserviceModule.v1beta.UserServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          userserviceModule.v1beta.UserServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new userserviceModule.v1beta.UserServiceClient({
          universe_domain: 'example.com',
    ...
    it('invokes getUser without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getUser(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1beta.IUser | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listUsers', () => {
    ...
    it('invokes listUsersStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.shopping.merchant.accounts.v1beta.User) => {
