...
describe('v1.EmailPreferencesServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new emailpreferencesserviceModule.v1.EmailPreferencesServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          emailpreferencesserviceModule.v1.EmailPreferencesServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        emailpreferencesserviceModule.v1.EmailPreferencesServiceClient.port;
      assert(port);
  ...
  describe('getEmailPreferences', () => {
    it('invokes getEmailPreferences without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getEmailPreferences as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getEmailPreferences without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getEmailPreferences(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1.IEmailPreferences | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('updateEmailPreferences', () => {
    it('invokes updateEmailPreferences without error', async () => {
      ...
      client.innerApiCalls.updateEmailPreferences =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateEmailPreferences(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateEmailPreferences as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateEmailPreferences as SinonStub
