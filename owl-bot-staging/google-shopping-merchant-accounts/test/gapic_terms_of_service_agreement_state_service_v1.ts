...
describe('v1.TermsOfServiceAgreementStateServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new termsofserviceagreementstateserviceModule.v1.TermsOfServiceAgreementStateServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = termsofserviceagreementstateserviceModule.v1.TermsOfServiceAgreementStateServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = termsofserviceagreementstateserviceModule.v1.TermsOfServiceAgreementStateServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new termsofserviceagreementstateserviceModule.v1.TermsOfServiceAgreementStateServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new termsofserviceagreementstateserviceModule.v1.TermsOfServiceAgreementStateServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new termsofserviceagreementstateserviceModule.v1.TermsOfServiceAgreementStateServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new termsofserviceagreementstateserviceModule.v1.TermsOfServiceAgreementStateServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = termsofserviceagreementstateserviceModule.v1.TermsOfServiceAgreementStateServiceClient.port;
            assert(port);
    ...
    describe('getTermsOfServiceAgreementState', () => {
        it('invokes getTermsOfServiceAgreementState without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.GetTermsOfServiceAgreementStateRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.GetTermsOfServiceAgreementStateRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.TermsOfServiceAgreementState()
            );
        ...
        it('invokes getTermsOfServiceAgreementState without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getTermsOfServiceAgreementState(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1.ITermsOfServiceAgreementState|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('retrieveForApplicationTermsOfServiceAgreementState', () => {
        it('invokes retrieveForApplicationTermsOfServiceAgreementState without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.RetrieveForApplicationTermsOfServiceAgreementStateRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.RetrieveForApplicationTermsOfServiceAgreementStateRequest', ['parent']);
