...
export class BackupDRClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const setInternalStatusResponse = protoFilesRoot.lookup(
      '.google.cloud.backupdr.v1.SetInternalStatusResponse') as gax.protobuf.Type;
 ...
 */
  initiateBackup(
      ...
      Promise<[
        ...
        protos.google.cloud.backupdr.v1.IInitiateBackupRequest|undefined, {}|undefined
      ]>;
  initiateBackup(
      request: protos.google.cloud.backupdr.v1.IInitiateBackupRequest,
      options: CallOptions,
 ...
 */
  fetchAccessToken(
      ...
      Promise<[
        ...
        protos.google.cloud.backupdr.v1.IFetchAccessTokenRequest|undefined, {}|undefined
      ]>;
  fetchAccessToken(
      request: protos.google.cloud.backupdr.v1.IFetchAccessTokenRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.backupdr.v1.IFetchAccessTokenResponse,
          protos.google.cloud.backupdr.v1.IFetchAccessTokenRequest|null|undefined,
          {}|null|undefined>): void;
  fetchAccessToken(
      request: protos.google.cloud.backupdr.v1.IFetchAccessTokenRequest,
      callback: Callback<
 ...
 * region_tag:backupdr_v1_generated_BackupDR_RemoveDataSource_async
 */
  async checkRemoveDataSourceProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.backupdr.v1.OperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.removeDataSource, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.protobuf.Empty, protos.google.cloud.backupdr.v1.OperationMetadata>;
  }
/**
 ...
 */
  setInternalStatus(
      ...
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.backupdr.v1.ISetInternalStatusResponse, protos.google.cloud.backupdr.v1.IOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
      ]>;
  setInternalStatus(
      request: protos.google.cloud.backupdr.v1.ISetInternalStatusRequest,
 ...
 * region_tag:backupdr_v1_generated_BackupDR_SetInternalStatus_async
 */
  async checkSetInternalStatusProgress(name: string): Promise<LROperation<protos.google.cloud.backupdr.v1.SetInternalStatusResponse, protos.google.cloud.backupdr.v1.OperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.setInternalStatus, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.backupdr.v1.SetInternalStatusResponse, protos.google.cloud.backupdr.v1.OperationMetadata>;
  }
/**
 * Internal only.
 * Abandons a backup.
 ...
 * region_tag:backupdr_v1_generated_BackupDR_AbandonBackup_async
 */
  async checkAbandonBackupProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.backupdr.v1.OperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.abandonBackup, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.protobuf.Empty, protos.google.cloud.backupdr.v1.OperationMetadata>;
  }
/**
 * Internal only.
 ...
 * region_tag:backupdr_v1_generated_BackupDR_FinalizeBackup_async
 */
  async checkFinalizeBackupProgress(name: string): Promise<LROperation<protos.google.cloud.backupdr.v1.Backup, protos.google.cloud.backupdr.v1.OperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.finalizeBackup, this._gaxModule.createDefaultBackoffSettings());
