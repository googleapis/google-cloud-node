...
describe('v1.BackupDRClient', () => {
    ...
    describe('initiateBackup', () => {
        it('invokes initiateBackup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.backupdr.v1.InitiateBackupRequest', ['dataSource']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.initiateBackup as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.initiateBackup as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes initiateBackup without error using callback', async () => {
            ...
            client.innerApiCalls.initiateBackup = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.initiateBackup(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.backupdr.v1.IInitiateBackupResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes initiateBackup with error', async () => {
            ...
            const expectedHeaderRequestParams = `data_source=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.initiateBackup = stubSimpleCall(undefined, expectedError);
    ...
    describe('fetchAccessToken', () => {
        it('invokes fetchAccessToken without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.backupdr.v1.FetchAccessTokenRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes fetchAccessToken without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.fetchAccessToken(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.backupdr.v1.IFetchAccessTokenResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('removeDataSource', () => {
        it('invokes removeDataSource without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.backupdr.v1.RemoveDataSourceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.removeDataSource = stubLongRunningCall(expectedResponse);
            const [operation] = await client.removeDataSource(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.removeDataSource as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.removeDataSource as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes removeDataSource without error using callback', async () => {
            ...
            client.innerApiCalls.removeDataSource = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes removeDataSource with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.removeDataSource = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes removeDataSource with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.removeDataSource = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.removeDataSource(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.removeDataSource as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkRemoveDataSourceProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkRemoveDataSourceProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkRemoveDataSourceProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkRemoveDataSourceProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('setInternalStatus', () => {
        it('invokes setInternalStatus without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.backupdr.v1.SetInternalStatusRequest', ['dataSource']);
            request.dataSource = defaultValue1;
            const expectedHeaderRequestParams = `data_source=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.setInternalStatus = stubLongRunningCall(expectedResponse);
            const [operation] = await client.setInternalStatus(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.setInternalStatus as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.setInternalStatus as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes setInternalStatus without error using callback', async () => {
            ...
            client.innerApiCalls.setInternalStatus = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.setInternalStatus(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.backupdr.v1.ISetInternalStatusResponse, protos.google.cloud.backupdr.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.backupdr.v1.ISetInternalStatusResponse, protos.google.cloud.backupdr.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.setInternalStatus as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes setInternalStatus with call error', async () => {
            ...
            const expectedHeaderRequestParams = `data_source=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.setInternalStatus = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes setInternalStatus with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `data_source=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.setInternalStatus = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.setInternalStatus(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.setInternalStatus as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkSetInternalStatusProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkSetInternalStatusProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkSetInternalStatusProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkSetInternalStatusProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('abandonBackup', () => {
        it('invokes abandonBackup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.backupdr.v1.AbandonBackupRequest', ['dataSource']);
            request.dataSource = defaultValue1;
            const expectedHeaderRequestParams = `data_source=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.abandonBackup = stubLongRunningCall(expectedResponse);
            const [operation] = await client.abandonBackup(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.abandonBackup as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.abandonBackup as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes abandonBackup without error using callback', async () => {
            ...
            client.innerApiCalls.abandonBackup = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes abandonBackup with call error', async () => {
            ...
            const expectedHeaderRequestParams = `data_source=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.abandonBackup = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes abandonBackup with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `data_source=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.abandonBackup = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.abandonBackup(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.abandonBackup as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkAbandonBackupProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkAbandonBackupProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkAbandonBackupProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkAbandonBackupProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('finalizeBackup', () => {
        it('invokes finalizeBackup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.backupdr.v1.FinalizeBackupRequest', ['dataSource']);
            request.dataSource = defaultValue1;
            const expectedHeaderRequestParams = `data_source=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.finalizeBackup = stubLongRunningCall(expectedResponse);
            const [operation] = await client.finalizeBackup(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.finalizeBackup as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.finalizeBackup as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes finalizeBackup without error using callback', async () => {
            ...
            client.innerApiCalls.finalizeBackup = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes finalizeBackup with call error', async () => {
            ...
            const expectedHeaderRequestParams = `data_source=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.finalizeBackup = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes finalizeBackup with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `data_source=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.finalizeBackup = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.finalizeBackup(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.finalizeBackup as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkFinalizeBackupProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkFinalizeBackupProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkFinalizeBackupProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkFinalizeBackupProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
