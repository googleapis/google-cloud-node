...
export class NetworkEdgeSecurityServicesClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof NetworkEdgeSecurityServicesClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.compute.v1.NetworkEdgeSecurityServices', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.networkEdgeSecurityServicesStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.compute.v1.NetworkEdgeSecurityServices') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.compute.v1.NetworkEdgeSecurityServices,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const networkEdgeSecurityServicesStubMethods =
        ['aggregatedList', 'delete', 'get', 'insert', 'patch'];
 ...
 */
  ...
  delete(
      ...
      callback: Callback<
          ...
          protos.google.cloud.compute.v1.IDeleteNetworkEdgeSecurityServiceRequest|null|undefined,
          {}|null|undefined>): void;
  delete(
      request: protos.google.cloud.compute.v1.IDeleteNetworkEdgeSecurityServiceRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link google.cloud.compute.v1.NetworkEdgeSecurityService | NetworkEdgeSecurityService}.
 *   Please see the
 ...
 */
  get(
      ...
      Promise<[
        ...
        protos.google.cloud.compute.v1.IGetNetworkEdgeSecurityServiceRequest|undefined, {}|undefined
      ]>;
  get(
      request: protos.google.cloud.compute.v1.IGetNetworkEdgeSecurityServiceRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.compute.v1.INetworkEdgeSecurityService,
          protos.google.cloud.compute.v1.IGetNetworkEdgeSecurityServiceRequest|null|undefined,
          {}|null|undefined>): void;
  get(
      request: protos.google.cloud.compute.v1.IGetNetworkEdgeSecurityServiceRequest,
      callback: Callback<
 ...
 */
  ...
  insert(
      ...
      callback: Callback<
          protos.google.cloud.compute.v1.IOperation,
          protos.google.cloud.compute.v1.IInsertNetworkEdgeSecurityServiceRequest|null|undefined,
          {}|null|undefined>): void;
  insert(
      request: protos.google.cloud.compute.v1.IInsertNetworkEdgeSecurityServiceRequest,
      callback: Callback<
 ...
 */
  ...
  patch(
      ...
      callback: Callback<
          protos.google.cloud.compute.v1.IOperation,
          protos.google.cloud.compute.v1.IPatchNetworkEdgeSecurityServiceRequest|null|undefined,
          {}|null|undefined>): void;
  patch(
      request: protos.google.cloud.compute.v1.IPatchNetworkEdgeSecurityServiceRequest,
      callback: Callback<
 ...
 *   as tuple [string, {@link google.cloud.compute.v1.NetworkEdgeSecurityServicesScopedList | NetworkEdgeSecurityServicesScopedList}]. The API will be called under the hood as needed, once per the page,
 ...
 */
  aggregatedListAsync(
      ...
      options?: CallOptions):
    AsyncIterable<[string, protos.google.cloud.compute.v1.INetworkEdgeSecurityServicesScopedList]>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.aggregatedList.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<[string, protos.google.cloud.compute.v1.INetworkEdgeSecurityServicesScopedList]>;
  }
