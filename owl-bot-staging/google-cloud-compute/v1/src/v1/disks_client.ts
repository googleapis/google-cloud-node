...
export class DisksClient {
  ...
  initialize() {
    ...
    const disksStubMethods =
        ['addResourcePolicies', 'aggregatedList', 'createSnapshot', 'delete', 'get', 'getIamPolicy', 'insert', 'list', 'removeResourcePolicies', 'resize', 'setIamPolicy', 'setLabels', 'testIamPermissions', 'update'];
