 ...
 */
  ...
  startAsyncReplication(
    ...
    this.initialize();
    return this.innerApiCalls.startAsyncReplication(request, options, callback)
    .then(([response, operation, rawResponse]: [protos.google.cloud.compute.v1.IOperation, protos.google.cloud.compute.v1.IOperation, protos.google.cloud.compute.v1.IOperation]) => {
      return [
          { latestResponse: response, done: false, name: response.id, metadata: null, result: {}},
          operation,
 ...
 */
  ...
  stopAsyncReplication(
    ...
    this.initialize();
    return this.innerApiCalls.stopAsyncReplication(request, options, callback)
    .then(([response, operation, rawResponse]: [protos.google.cloud.compute.v1.IOperation, protos.google.cloud.compute.v1.IOperation, protos.google.cloud.compute.v1.IOperation]) => {
      return [
          { latestResponse: response, done: false, name: response.id, metadata: null, result: {}},
          operation,
 ...
 */
  ...
  stopGroupAsyncReplication(
    ...
    this.initialize();
    return this.innerApiCalls.stopGroupAsyncReplication(request, options, callback)
    .then(([response, operation, rawResponse]: [protos.google.cloud.compute.v1.IOperation, protos.google.cloud.compute.v1.IOperation, protos.google.cloud.compute.v1.IOperation]) => {
      return [
          { latestResponse: response, done: false, name: response.id, metadata: null, result: {}},
          operation,
