...
describe('v1.PublicAdvertisedPrefixesClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new publicadvertisedprefixesModule.v1.PublicAdvertisedPrefixesClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = publicadvertisedprefixesModule.v1.PublicAdvertisedPrefixesClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = publicadvertisedprefixesModule.v1.PublicAdvertisedPrefixesClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new publicadvertisedprefixesModule.v1.PublicAdvertisedPrefixesClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'compute.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new publicadvertisedprefixesModule.v1.PublicAdvertisedPrefixesClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'compute.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new publicadvertisedprefixesModule.v1.PublicAdvertisedPrefixesClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new publicadvertisedprefixesModule.v1.PublicAdvertisedPrefixesClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = publicadvertisedprefixesModule.v1.PublicAdvertisedPrefixesClient.port;
            assert(port);
    ...
    describe('announce', () => {
        it('invokes announce without error', async () => {
            const client = new publicadvertisedprefixesModule.v1.PublicAdvertisedPrefixesClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1.AnnouncePublicAdvertisedPrefixeRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.AnnouncePublicAdvertisedPrefixeRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.AnnouncePublicAdvertisedPrefixeRequest', ['publicAdvertisedPrefix']);
            ...
            client.innerApiCalls.announce = stubSimpleCall(expectedResponse);
            const [response] = await client.announce(request);
            assert.deepStrictEqual(response.latestResponse, expectedResponse);
            const actualRequest = (client.innerApiCalls.announce as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.announce as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes announce without error using callback', async () => {
            const client = new publicadvertisedprefixesModule.v1.PublicAdvertisedPrefixesClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.announce = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.announce(
                    request,
        ...
        it('invokes announce with error', async () => {
            const client = new publicadvertisedprefixesModule.v1.PublicAdvertisedPrefixesClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
        ...
        it('invokes announce with closed client', async () => {
            const client = new publicadvertisedprefixesModule.v1.PublicAdvertisedPrefixesClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.DeletePublicAdvertisedPrefixeRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.DeletePublicAdvertisedPrefixeRequest', ['publicAdvertisedPrefix']);
            request.publicAdvertisedPrefix = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&public_advertised_prefix=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetPublicAdvertisedPrefixeRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetPublicAdvertisedPrefixeRequest', ['publicAdvertisedPrefix']);
            request.publicAdvertisedPrefix = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&public_advertised_prefix=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes get without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.get(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.IPublicAdvertisedPrefix|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.InsertPublicAdvertisedPrefixeRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.PatchPublicAdvertisedPrefixeRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.PatchPublicAdvertisedPrefixeRequest', ['publicAdvertisedPrefix']);
            request.publicAdvertisedPrefix = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&public_advertised_prefix=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('withdraw', () => {
        it('invokes withdraw without error', async () => {
            const client = new publicadvertisedprefixesModule.v1.PublicAdvertisedPrefixesClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1.WithdrawPublicAdvertisedPrefixeRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.WithdrawPublicAdvertisedPrefixeRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.WithdrawPublicAdvertisedPrefixeRequest', ['publicAdvertisedPrefix']);
            request.publicAdvertisedPrefix = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&public_advertised_prefix=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
            );
            client.innerApiCalls.withdraw = stubSimpleCall(expectedResponse);
            const [response] = await client.withdraw(request);
            assert.deepStrictEqual(response.latestResponse, expectedResponse);
            const actualRequest = (client.innerApiCalls.withdraw as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.withdraw as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes withdraw without error using callback', async () => {
            const client = new publicadvertisedprefixesModule.v1.PublicAdvertisedPrefixesClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.withdraw = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.withdraw(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.IOperation|null) => {
        ...
        it('invokes withdraw with error', async () => {
            const client = new publicadvertisedprefixesModule.v1.PublicAdvertisedPrefixesClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
        ...
        it('invokes withdraw with closed client', async () => {
            const client = new publicadvertisedprefixesModule.v1.PublicAdvertisedPrefixesClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.ListPublicAdvertisedPrefixesRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.compute.v1.PublicAdvertisedPrefix()),
              generateSampleMessage(new protos.google.cloud.compute.v1.PublicAdvertisedPrefix()),
              generateSampleMessage(new protos.google.cloud.compute.v1.PublicAdvertisedPrefix()),
            ];
        ...
        it('invokes listStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.compute.v1.PublicAdvertisedPrefix[] = [];
                stream.on('data', (response: protos.google.cloud.compute.v1.PublicAdvertisedPrefix) => {
        ...
        it('uses async iteration with list without error', async () => {
            ...
            const responses: protos.google.cloud.compute.v1.IPublicAdvertisedPrefix[] = [];
