...
describe('v1.InstantSnapshotsClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new instantsnapshotsModule.v1.InstantSnapshotsClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = instantsnapshotsModule.v1.InstantSnapshotsClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = instantsnapshotsModule.v1.InstantSnapshotsClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new instantsnapshotsModule.v1.InstantSnapshotsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'compute.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new instantsnapshotsModule.v1.InstantSnapshotsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'compute.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new instantsnapshotsModule.v1.InstantSnapshotsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new instantsnapshotsModule.v1.InstantSnapshotsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = instantsnapshotsModule.v1.InstantSnapshotsClient.port;
            assert(port);
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1.DeleteInstantSnapshotRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.DeleteInstantSnapshotRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.DeleteInstantSnapshotRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.DeleteInstantSnapshotRequest', ['instantSnapshot']);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1.GetInstantSnapshotRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetInstantSnapshotRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetInstantSnapshotRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetInstantSnapshotRequest', ['instantSnapshot']);
            request.instantSnapshot = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&zone=${defaultValue2 ?? '' }&instant_snapshot=${defaultValue3 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getIamPolicy', () => {
        it('invokes getIamPolicy without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1.GetIamPolicyInstantSnapshotRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetIamPolicyInstantSnapshotRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetIamPolicyInstantSnapshotRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetIamPolicyInstantSnapshotRequest', ['resource']);
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1.InsertInstantSnapshotRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.InsertInstantSnapshotRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.InsertInstantSnapshotRequest', ['zone']);
            request.zone = defaultValue2;
    ...
    describe('setIamPolicy', () => {
        it('invokes setIamPolicy without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1.SetIamPolicyInstantSnapshotRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.SetIamPolicyInstantSnapshotRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.SetIamPolicyInstantSnapshotRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.SetIamPolicyInstantSnapshotRequest', ['resource']);
            request.resource = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&zone=${defaultValue2 ?? '' }&resource=${defaultValue3 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Policy()
    ...
    describe('setLabels', () => {
        it('invokes setLabels without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1.SetLabelsInstantSnapshotRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.SetLabelsInstantSnapshotRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.SetLabelsInstantSnapshotRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.SetLabelsInstantSnapshotRequest', ['resource']);
            request.resource = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&zone=${defaultValue2 ?? '' }&resource=${defaultValue3 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('testIamPermissions', () => {
        it('invokes testIamPermissions without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1.TestIamPermissionsInstantSnapshotRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.TestIamPermissionsInstantSnapshotRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.TestIamPermissionsInstantSnapshotRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.TestIamPermissionsInstantSnapshotRequest', ['resource']);
            request.resource = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&zone=${defaultValue2 ?? '' }&resource=${defaultValue3 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('aggregatedList', () => {
        ...
        it('uses async iteration with aggregatedList without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1.AggregatedListInstantSnapshotsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.AggregatedListInstantSnapshotsRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }`;
            const expectedResponse = [
              ['tuple_key_1', generateSampleMessage(new protos.google.cloud.compute.v1.InstantSnapshotsScopedList())],
              ['tuple_key_2', generateSampleMessage(new protos.google.cloud.compute.v1.InstantSnapshotsScopedList())],
              ['tuple_key_3', generateSampleMessage(new protos.google.cloud.compute.v1.InstantSnapshotsScopedList())],
            ];
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1.ListInstantSnapshotsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.ListInstantSnapshotsRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.ListInstantSnapshotsRequest', ['zone']);
            request.zone = defaultValue2;
