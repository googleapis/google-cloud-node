  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = globalnetworkendpointgroupsModule.v1.GlobalNetworkEndpointGroupsClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = globalnetworkendpointgroupsModule.v1.GlobalNetworkEndpointGroupsClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new globalnetworkendpointgroupsModule.v1.GlobalNetworkEndpointGroupsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'compute.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new globalnetworkendpointgroupsModule.v1.GlobalNetworkEndpointGroupsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'compute.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new globalnetworkendpointgroupsModule.v1.GlobalNetworkEndpointGroupsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new globalnetworkendpointgroupsModule.v1.GlobalNetworkEndpointGroupsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = globalnetworkendpointgroupsModule.v1.GlobalNetworkEndpointGroupsClient.port;
            assert(port);
    ...
    describe('attachNetworkEndpoints', () => {
        it('invokes attachNetworkEndpoints without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.AttachNetworkEndpointsGlobalNetworkEndpointGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.AttachNetworkEndpointsGlobalNetworkEndpointGroupRequest', ['networkEndpointGroup']);
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.DeleteGlobalNetworkEndpointGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.DeleteGlobalNetworkEndpointGroupRequest', ['networkEndpointGroup']);
            request.networkEndpointGroup = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&network_endpoint_group=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('detachNetworkEndpoints', () => {
        it('invokes detachNetworkEndpoints without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.DetachNetworkEndpointsGlobalNetworkEndpointGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.DetachNetworkEndpointsGlobalNetworkEndpointGroupRequest', ['networkEndpointGroup']);
            request.networkEndpointGroup = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&network_endpoint_group=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetGlobalNetworkEndpointGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetGlobalNetworkEndpointGroupRequest', ['networkEndpointGroup']);
            request.networkEndpointGroup = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&network_endpoint_group=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.InsertGlobalNetworkEndpointGroupRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.ListGlobalNetworkEndpointGroupsRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.compute.v1.NetworkEndpointGroup()),
              generateSampleMessage(new protos.google.cloud.compute.v1.NetworkEndpointGroup()),
              generateSampleMessage(new protos.google.cloud.compute.v1.NetworkEndpointGroup()),
            ];
        ...
        it('invokes listStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.compute.v1.NetworkEndpointGroup) => {
    ...
    describe('listNetworkEndpoints', () => {
        it('invokes listNetworkEndpoints without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.ListNetworkEndpointsGlobalNetworkEndpointGroupsRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.ListNetworkEndpointsGlobalNetworkEndpointGroupsRequest', ['networkEndpointGroup']);
            request.networkEndpointGroup = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&network_endpoint_group=${defaultValue2 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.compute.v1.NetworkEndpointWithHealthStatus()),
              generateSampleMessage(new protos.google.cloud.compute.v1.NetworkEndpointWithHealthStatus()),
              generateSampleMessage(new protos.google.cloud.compute.v1.NetworkEndpointWithHealthStatus()),
            ];
        ...
        it('invokes listNetworkEndpoints without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listNetworkEndpoints(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.INetworkEndpointWithHealthStatus[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listNetworkEndpointsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.compute.v1.NetworkEndpointWithHealthStatus) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
