...
[![npm version](https://img.shields.io/npm/v/@google-cloud/compute-small.svg)](https://www.npmjs.org/package/@google-cloud/compute-small)
...
```bash
npm install @google-cloud/compute-small
```
...
For example, `npm install @google-cloud/compute-small@legacy-8` installs client libraries
