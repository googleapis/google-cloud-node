...
function doStuffWithDiskSettingsServiceClient(client: DiskSettingsServiceClient) {
  client.close();
}
...
function doStuffWithOrganizationSecurityPoliciesClient(client: OrganizationSecurityPoliciesClient) {
  client.close();
}
...
function doStuffWithRegionDiskSettingsClient(client: RegionDiskSettingsClient) {
  client.close();
}
...
function doStuffWithRegionInstanceGroupManagerResizeRequestsClient(client: RegionInstanceGroupManagerResizeRequestsClient) {
  client.close();
}
...
function doStuffWithRegionMultiMigsClient(client: RegionMultiMigsClient) {
  client.close();
}
...
function doStuffWithRegionSnapshotSettingsClient(client: RegionSnapshotSettingsClient) {
  client.close();
}
...
function main() {
  ...
  // check that the client instance can be created
  const diskSettingsServiceClient = new DiskSettingsServiceClient();
  doStuffWithDiskSettingsServiceClient(diskSettingsServiceClient);
  // check that the client instance can be created
  ...
  // check that the client instance can be created
  const organizationSecurityPoliciesClient = new OrganizationSecurityPoliciesClient();
  doStuffWithOrganizationSecurityPoliciesClient(organizationSecurityPoliciesClient);
  // check that the client instance can be created
  ...
  // check that the client instance can be created
  const regionDiskSettingsClient = new RegionDiskSettingsClient();
  doStuffWithRegionDiskSettingsClient(regionDiskSettingsClient);
  // check that the client instance can be created
  ...
  // check that the client instance can be created
  const regionInstanceGroupManagerResizeRequestsClient = new RegionInstanceGroupManagerResizeRequestsClient();
  doStuffWithRegionInstanceGroupManagerResizeRequestsClient(regionInstanceGroupManagerResizeRequestsClient);
  // check that the client instance can be created
  ...
  // check that the client instance can be created
  const regionMultiMigsClient = new RegionMultiMigsClient();
  doStuffWithRegionMultiMigsClient(regionMultiMigsClient);
  // check that the client instance can be created
