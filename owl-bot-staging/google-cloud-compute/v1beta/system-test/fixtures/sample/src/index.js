...
function main() {
  ...
  const adviceClient = new compute.AdviceClient();
  ...
  const crossSiteNetworksClient = new compute.CrossSiteNetworksClient();
  const disksClient = new compute.DisksClient();
  const diskSettingsServiceClient = new compute.DiskSettingsServiceClient();
  ...
  const organizationSecurityPoliciesClient = new compute.OrganizationSecurityPoliciesClient();
  ...
  const regionDiskSettingsClient = new compute.RegionDiskSettingsClient();
  ...
  const regionInstanceGroupManagerResizeRequestsClient = new compute.RegionInstanceGroupManagerResizeRequestsClient();
  ...
  const regionMultiMigsClient = new compute.RegionMultiMigsClient();
  ...
  const regionSnapshotsClient = new compute.RegionSnapshotsClient();
  const regionSnapshotSettingsClient = new compute.RegionSnapshotSettingsClient();
  ...
  const wireGroupsClient = new compute.WireGroupsClient();
