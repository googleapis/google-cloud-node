...
function main(project) {
  // [START compute_v1beta_generated_DiskTypes_AggregatedList_async]
  /**
  ...
  const {DiskTypesClient} = require('@google-cloud/compute').v1beta;
  ...
  callAggregatedList();
  // [END compute_v1beta_generated_DiskTypes_AggregatedList_async]
}
