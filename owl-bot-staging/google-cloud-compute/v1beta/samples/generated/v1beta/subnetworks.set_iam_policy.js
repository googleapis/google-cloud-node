...
function main(project, region, regionSetPolicyRequestResource, resource) {
  // [START compute_v1beta_generated_Subnetworks_SetIamPolicy_async]
  /**
  ...
  const {SubnetworksClient} = require('@google-cloud/compute').v1beta;
  ...
  callSetIamPolicy();
  // [END compute_v1beta_generated_Subnetworks_SetIamPolicy_async]
}
