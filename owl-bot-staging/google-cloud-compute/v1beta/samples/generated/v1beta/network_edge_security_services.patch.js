...
function main(networkEdgeSecurityService, networkEdgeSecurityServiceResource, project, region) {
  // [START compute_v1beta_generated_NetworkEdgeSecurityServices_Patch_async]
  /**
  ...
  const {NetworkEdgeSecurityServicesClient} = require('@google-cloud/compute').v1beta;
  ...
  callPatch();
  // [END compute_v1beta_generated_NetworkEdgeSecurityServices_Patch_async]
}
