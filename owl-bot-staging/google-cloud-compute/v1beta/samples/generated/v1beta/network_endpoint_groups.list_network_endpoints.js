...
function main(networkEndpointGroup, networkEndpointGroupsListEndpointsRequestResource, project, zone) {
  // [START compute_v1beta_generated_NetworkEndpointGroups_ListNetworkEndpoints_async]
  /**
  ...
  const {NetworkEndpointGroupsClient} = require('@google-cloud/compute').v1beta;
  ...
  // [END compute_v1beta_generated_NetworkEndpointGroups_ListNetworkEndpoints_async]
}
