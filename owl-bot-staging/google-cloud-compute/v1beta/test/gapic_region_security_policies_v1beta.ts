...
describe('v1beta.RegionSecurityPoliciesClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new regionsecuritypoliciesModule.v1beta.RegionSecurityPoliciesClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = regionsecuritypoliciesModule.v1beta.RegionSecurityPoliciesClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = regionsecuritypoliciesModule.v1beta.RegionSecurityPoliciesClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new regionsecuritypoliciesModule.v1beta.RegionSecurityPoliciesClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'compute.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new regionsecuritypoliciesModule.v1beta.RegionSecurityPoliciesClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'compute.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new regionsecuritypoliciesModule.v1beta.RegionSecurityPoliciesClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new regionsecuritypoliciesModule.v1beta.RegionSecurityPoliciesClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = regionsecuritypoliciesModule.v1beta.RegionSecurityPoliciesClient.port;
            assert(port);
    ...
    describe('addRule', () => {
        it('invokes addRule without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.AddRuleRegionSecurityPolicyRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.AddRuleRegionSecurityPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.AddRuleRegionSecurityPolicyRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.AddRuleRegionSecurityPolicyRequest', ['securityPolicy']);
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.DeleteRegionSecurityPolicyRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.DeleteRegionSecurityPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.DeleteRegionSecurityPolicyRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.DeleteRegionSecurityPolicyRequest', ['securityPolicy']);
            request.securityPolicy = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&region=${defaultValue2 ?? '' }&security_policy=${defaultValue3 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.Operation()
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.GetRegionSecurityPolicyRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.GetRegionSecurityPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.GetRegionSecurityPolicyRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.GetRegionSecurityPolicyRequest', ['securityPolicy']);
            request.securityPolicy = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&region=${defaultValue2 ?? '' }&security_policy=${defaultValue3 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getRule', () => {
        it('invokes getRule without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.GetRuleRegionSecurityPolicyRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.GetRuleRegionSecurityPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.GetRuleRegionSecurityPolicyRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.GetRuleRegionSecurityPolicyRequest', ['securityPolicy']);
            request.securityPolicy = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&region=${defaultValue2 ?? '' }&security_policy=${defaultValue3 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.InsertRegionSecurityPolicyRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.InsertRegionSecurityPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.InsertRegionSecurityPolicyRequest', ['region']);
            request.region = defaultValue2;
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.PatchRegionSecurityPolicyRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.PatchRegionSecurityPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.PatchRegionSecurityPolicyRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.PatchRegionSecurityPolicyRequest', ['securityPolicy']);
            request.securityPolicy = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&region=${defaultValue2 ?? '' }&security_policy=${defaultValue3 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.Operation()
    ...
    describe('patchRule', () => {
        it('invokes patchRule without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.PatchRuleRegionSecurityPolicyRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.PatchRuleRegionSecurityPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.PatchRuleRegionSecurityPolicyRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.PatchRuleRegionSecurityPolicyRequest', ['securityPolicy']);
            request.securityPolicy = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&region=${defaultValue2 ?? '' }&security_policy=${defaultValue3 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.Operation()
    ...
    describe('removeRule', () => {
        it('invokes removeRule without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.RemoveRuleRegionSecurityPolicyRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.RemoveRuleRegionSecurityPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.RemoveRuleRegionSecurityPolicyRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.RemoveRuleRegionSecurityPolicyRequest', ['securityPolicy']);
            request.securityPolicy = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&region=${defaultValue2 ?? '' }&security_policy=${defaultValue3 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.Operation()
    ...
    describe('setLabels', () => {
        it('invokes setLabels without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.SetLabelsRegionSecurityPolicyRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.SetLabelsRegionSecurityPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.SetLabelsRegionSecurityPolicyRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.SetLabelsRegionSecurityPolicyRequest', ['resource']);
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.ListRegionSecurityPoliciesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.ListRegionSecurityPoliciesRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.ListRegionSecurityPoliciesRequest', ['region']);
            request.region = defaultValue2;
