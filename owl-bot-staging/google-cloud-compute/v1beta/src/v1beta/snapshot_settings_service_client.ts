...
export class SnapshotSettingsServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof SnapshotSettingsServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.compute.v1beta.SnapshotSettingsService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.snapshotSettingsServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.compute.v1beta.SnapshotSettingsService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.compute.v1beta.SnapshotSettingsService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const snapshotSettingsServiceStubMethods =
        ['get', 'patch'];
 ...
 */
  get(
      ...
      Promise<[
        ...
        protos.google.cloud.compute.v1beta.IGetSnapshotSettingRequest|undefined, {}|undefined
      ]>;
  get(
      request: protos.google.cloud.compute.v1beta.IGetSnapshotSettingRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.compute.v1beta.ISnapshotSettings,
          protos.google.cloud.compute.v1beta.IGetSnapshotSettingRequest|null|undefined,
          {}|null|undefined>): void;
  get(
      request: protos.google.cloud.compute.v1beta.IGetSnapshotSettingRequest,
      callback: Callback<
 ...
 */
  ...
  patch(
      ...
      callback: Callback<
          ...
          protos.google.cloud.compute.v1beta.IPatchSnapshotSettingRequest|null|undefined,
          {}|null|undefined>): void;
  patch(
      request: protos.google.cloud.compute.v1beta.IPatchSnapshotSettingRequest,
      callback: Callback<
