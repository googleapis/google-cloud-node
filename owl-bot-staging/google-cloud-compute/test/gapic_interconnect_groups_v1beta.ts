...
describe('v1beta.InterconnectGroupsClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          interconnectgroupsModule.v1beta.InterconnectGroupsClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          interconnectgroupsModule.v1beta.InterconnectGroupsClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        interconnectgroupsModule.v1beta.InterconnectGroupsClient.port;
      assert(port);
  ...
  describe('createMembers', () => {
    it('invokes createMembers without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.createMembers as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes createMembers without error using callback', async () => {
      ...
      client.innerApiCalls.createMembers =
    ...
    it('invokes createMembers with error', async () => {
      ...
      client.innerApiCalls.createMembers = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('delete', () => {
    it('invokes delete without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.DeleteInterconnectGroupRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('get', () => {
    it('invokes get without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetInterconnectGroupRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IInterconnectGroup | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getOperationalStatus', () => {
    it('invokes getOperationalStatus without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetOperationalStatusInterconnectGroupRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      client.innerApiCalls.getOperationalStatus =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getOperationalStatus(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getOperationalStatus as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getOperationalStatus as SinonStub
    ...
    it('invokes getOperationalStatus without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getOperationalStatus(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IInterconnectGroupsGetOperationalStatusResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getOperationalStatus with error', async () => {
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&interconnect_group=${defaultValue2 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getOperationalStatus = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('insert', () => {
    it('invokes insert without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.InsertInterconnectGroupRequest',
        ['project'],
      );
      request.project = defaultValue1;
  ...
  describe('patch', () => {
    it('invokes patch without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.PatchInterconnectGroupRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('setIamPolicy', () => {
    it('invokes setIamPolicy without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetIamPolicyInterconnectGroupRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('testIamPermissions', () => {
    it('invokes testIamPermissions without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.TestIamPermissionsInterconnectGroupRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ListInterconnectGroupsRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}`;
    ...
    it('invokes listStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1beta.InterconnectGroup) => {
