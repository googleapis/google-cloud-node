...
describe('v1beta.RoutersClient', () => {
  ...
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new routersModule.v1beta.RoutersClient({
          universe_domain: 'example.com',
  ...
  describe('delete', () => {
    it('invokes delete without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.DeleteRouterRequest',
        ['project'],
      );
  ...
  describe('deleteNamedSet', () => {
    it('invokes deleteNamedSet without error', async () => {
      ...
      assert.deepStrictEqual(response.latestResponse, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteNamedSet as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteNamedSet as SinonStub
    ...
    it('invokes deleteNamedSet without error using callback', async () => {
      ...
      client.innerApiCalls.deleteNamedSet =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes deleteNamedSet with error', async () => {
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&region=${defaultValue2 ?? ''}&router=${defaultValue3 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteNamedSet = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteRoutePolicy', () => {
    it('invokes deleteRoutePolicy without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.DeleteRoutePolicyRouterRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('get', () => {
    it('invokes get without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetRouterRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IRouter | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getNamedSet', () => {
    it('invokes getNamedSet without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetNamedSetRouterRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getNamedSet as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getNamedSet as SinonStub
    ...
    it('invokes getNamedSet without error using callback', async () => {
      ...
      client.innerApiCalls.getNamedSet =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getNamedSet(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IRoutersGetNamedSetResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getNamedSet with error', async () => {
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&region=${defaultValue2 ?? ''}&router=${defaultValue3 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getNamedSet = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getNatIpInfo', () => {
    it('invokes getNatIpInfo without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetNatIpInfoRouterRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
    ...
    it('invokes getNatIpInfo without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getNatIpInfo(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.INatIpInfoResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getRoutePolicy', () => {
    it('invokes getRoutePolicy without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetRoutePolicyRouterRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
    ...
    it('invokes getRoutePolicy without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getRoutePolicy(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IRoutersGetRoutePolicyResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getRouterStatus', () => {
    it('invokes getRouterStatus without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetRouterStatusRouterRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
    ...
    it('invokes getRouterStatus without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getRouterStatus(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IRouterStatusResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('insert', () => {
    it('invokes insert without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.InsertRouterRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('patch', () => {
    it('invokes patch without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.PatchRouterRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('patchNamedSet', () => {
    it('invokes patchNamedSet without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.PatchNamedSetRouterRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response.latestResponse, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.patchNamedSet as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.patchNamedSet as SinonStub
    ...
    it('invokes patchNamedSet without error using callback', async () => {
      ...
      client.innerApiCalls.patchNamedSet =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes patchNamedSet with error', async () => {
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&region=${defaultValue2 ?? ''}&router=${defaultValue3 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.patchNamedSet = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('patchRoutePolicy', () => {
    it('invokes patchRoutePolicy without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.PatchRoutePolicyRouterRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('preview', () => {
    it('invokes preview without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.PreviewRouterRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
    ...
    it('invokes preview without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.preview(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IRoutersPreviewResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('testIamPermissions', () => {
    it('invokes testIamPermissions without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.TestIamPermissionsRouterRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('updateNamedSet', () => {
    it('invokes updateNamedSet without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.UpdateNamedSetRouterRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response.latestResponse, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateNamedSet as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateNamedSet as SinonStub
    ...
    it('invokes updateNamedSet without error using callback', async () => {
      ...
      client.innerApiCalls.updateNamedSet =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes updateNamedSet with error', async () => {
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&region=${defaultValue2 ?? ''}&router=${defaultValue3 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateNamedSet = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateRoutePolicy', () => {
    it('invokes updateRoutePolicy without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.UpdateRoutePolicyRouterRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('aggregatedList', () => {
    it('uses async iteration with aggregatedList without error', async () => {
      ...
      const expectedResponse = [
        [
          ...
          generateSampleMessage(
            new protos.google.cloud.compute.v1beta.RoutersScopedList(),
          ),
        ],
        [
          'tuple_key_2',
      ...
      const responses: Array<
        [string, protos.google.cloud.compute.v1beta.IRoutersScopedList]
      > = [];
  ...
  describe('getNatMappingInfo', () => {
    it('invokes getNatMappingInfo without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetNatMappingInfoRoutersRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.compute.v1beta.VmEndpointNatMappings(),
        ),
        generateSampleMessage(
          new protos.google.cloud.compute.v1beta.VmEndpointNatMappings(),
        ),
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getNatMappingInfo as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getNatMappingInfo as SinonStub
    ...
    it('invokes getNatMappingInfo with error', async () => {
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&region=${defaultValue2 ?? ''}&router=${defaultValue3 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getNatMappingInfo = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes getNatMappingInfoStream without error', async () => {
      ...
      client.descriptors.page.getNatMappingInfo.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.compute.v1beta.VmEndpointNatMappings,
          ) => {
      ...
      assert(
        (client.descriptors.page.getNatMappingInfo.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.getNatMappingInfo, request),
      );
      assert(
        (client.descriptors.page.getNatMappingInfo.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with getNatMappingInfo without error', async () => {
      ...
      client.descriptors.page.getNatMappingInfo.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ListRoutersRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
    ...
    it('invokes listStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1beta.Router) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listBgpRoutes', () => {
    it('invokes listBgpRoutes without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ListBgpRoutesRoutersRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.compute.v1beta.BgpRoute(),
        ),
        generateSampleMessage(
          new protos.google.cloud.compute.v1beta.BgpRoute(),
        ),
    ...
    it('invokes listBgpRoutes without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listBgpRoutes(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IBgpRoute[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listBgpRoutesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1beta.BgpRoute) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listNamedSets', () => {
    it('invokes listNamedSets without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listNamedSets as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listNamedSets as SinonStub
    ...
    it('invokes listNamedSets without error using callback', async () => {
      ...
      client.innerApiCalls.listNamedSets =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listNamedSets(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.INamedSet[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listNamedSets with error', async () => {
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&region=${defaultValue2 ?? ''}&router=${defaultValue3 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listNamedSets = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listNamedSetsStream without error', async () => {
      ...
      client.descriptors.page.listNamedSets.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1beta.NamedSet) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listNamedSets.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listNamedSets, request),
      );
      assert(
        (client.descriptors.page.listNamedSets.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listNamedSets without error', async () => {
      ...
      client.descriptors.page.listNamedSets.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listRoutePolicies', () => {
    it('invokes listRoutePolicies without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ListRoutePoliciesRoutersRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.compute.v1beta.RoutePolicy(),
        ),
        generateSampleMessage(
          new protos.google.cloud.compute.v1beta.RoutePolicy(),
        ),
    ...
    it('invokes listRoutePolicies without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listRoutePolicies(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IRoutePolicy[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listRoutePoliciesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1beta.RoutePolicy) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
