...
describe('v1.ImagesClient', () => {
  ...
  describe('deprecate', () => {
    ...
    it('invokes deprecate without error using callback', async () => {
      ...
      client.innerApiCalls.deprecate =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.deprecate(
          request,
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IImage | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getFromFamily', () => {
    it('invokes getFromFamily without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getFromFamily as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getFromFamily as SinonStub
    ...
    it('invokes getFromFamily without error using callback', async () => {
      ...
      client.innerApiCalls.getFromFamily =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes getFromFamily with error', async () => {
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&family=${defaultValue2 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getFromFamily = stubSimpleCall(
        undefined,
        expectedError,
      );
