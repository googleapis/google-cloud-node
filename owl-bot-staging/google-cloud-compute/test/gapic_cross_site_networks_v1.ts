...
describe('v1.CrossSiteNetworksClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client = new crosssitenetworksModule.v1.CrossSiteNetworksClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          crosssitenetworksModule.v1.CrossSiteNetworksClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          crosssitenetworksModule.v1.CrossSiteNetworksClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new crosssitenetworksModule.v1.CrossSiteNetworksClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'compute.example.com');
          if (saved) {
    ...
    it('has port', () => {
      const port = crosssitenetworksModule.v1.CrossSiteNetworksClient.port;
      assert(port);
  ...
  describe('delete', () => {
    it('invokes delete without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1.DeleteCrossSiteNetworkRequest(),
      );
  ...
  describe('get', () => {
    it('invokes get without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1.GetCrossSiteNetworkRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&cross_site_network=${defaultValue2 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.compute.v1.CrossSiteNetwork(),
      );
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.ICrossSiteNetwork | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('insert', () => {
    it('invokes insert without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1.InsertCrossSiteNetworkRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('patch', () => {
    it('invokes patch without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1.PatchCrossSiteNetworkRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1.PatchCrossSiteNetworkRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1.ListCrossSiteNetworksRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1.ListCrossSiteNetworksRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}`;
    ...
    it('invokes listStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.compute.v1.CrossSiteNetwork[] = [];
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1.CrossSiteNetwork) => {
    ...
    it('uses async iteration with list without error', async () => {
      ...
      const responses: protos.google.cloud.compute.v1.ICrossSiteNetwork[] = [];
