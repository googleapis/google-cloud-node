...
describe('v1.LicenseCodesClient', () => {
  ...
  describe('getIamPolicy', () => {
    it('invokes getIamPolicy without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1.GetIamPolicyLicenseCodeRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1.GetIamPolicyLicenseCodeRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('setIamPolicy', () => {
    it('invokes setIamPolicy without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1.SetIamPolicyLicenseCodeRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1.SetIamPolicyLicenseCodeRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
