...
function main(project, resource, testPermissionsRequestResource) {
  // [START compute_v1beta_generated_GlobalAddresses_TestIamPermissions_async]
  /**
  ...
  const {GlobalAddressesClient} = require('@google-cloud/compute').v1beta;
  ...
  // [END compute_v1beta_generated_GlobalAddresses_TestIamPermissions_async]
}
