...
function main(project, resource, testPermissionsRequestResource, zone) {
  // [START compute_v1beta_generated_InstanceGroups_TestIamPermissions_async]
  /**
  ...
  const {InstanceGroupsClient} = require('@google-cloud/compute').v1beta;
  ...
  // [END compute_v1beta_generated_InstanceGroups_TestIamPermissions_async]
}
