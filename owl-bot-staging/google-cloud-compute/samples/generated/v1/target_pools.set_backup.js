...
function main(project, region, targetPool, targetReferenceResource) {
  ...
  async function callSetBackup() {
    ...
    // Run request
    const response = await computeClient.setBackup(request);
