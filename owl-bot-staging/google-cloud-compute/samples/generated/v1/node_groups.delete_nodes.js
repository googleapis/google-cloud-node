...
function main(nodeGroup, nodeGroupsDeleteNodesRequestResource, project, zone) {
   ...
   */
  // const nodeGroupsDeleteNodesRequestResource = {}
  /**
  ...
  async function callDeleteNodes() {
    // Construct request
    const request = {
      nodeGroup,
    ...
    // Run request
    const response = await computeClient.deleteNodes(request);
