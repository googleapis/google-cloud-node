...
export class AddressesClient {
  ...
  setLabels(
    ...
    callback: Callback<
      protos.google.cloud.compute.v1.IOperation,
      | protos.google.cloud.compute.v1.ISetLabelsAddressRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  testIamPermissions(
    ...
    [
      ...
      (
        | protos.google.cloud.compute.v1.ITestIamPermissionsAddressRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  aggregatedListAsync(
    ...
    [string, protos.google.cloud.compute.v1.IAddressesScopedList]
  > {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
