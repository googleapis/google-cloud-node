...
export class GlobalVmExtensionPoliciesClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof GlobalVmExtensionPoliciesClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.compute.v1beta.GlobalVmExtensionPolicies', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.globalVmExtensionPoliciesStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.compute.v1beta.GlobalVmExtensionPolicies') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.compute.v1beta.GlobalVmExtensionPolicies,
 ...
 */
  get(
      ...
      Promise<[
        ...
        protos.google.cloud.compute.v1beta.IGetGlobalVmExtensionPolicyRequest|undefined, {}|undefined
      ]>;
  get(
      request: protos.google.cloud.compute.v1beta.IGetGlobalVmExtensionPolicyRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.compute.v1beta.IGlobalVmExtensionPolicy,
          protos.google.cloud.compute.v1beta.IGetGlobalVmExtensionPolicyRequest|null|undefined,
          {}|null|undefined>): void;
  get(
      request: protos.google.cloud.compute.v1beta.IGetGlobalVmExtensionPolicyRequest,
      callback: Callback<
 ...
 */
  aggregatedListAsync(
      ...
      options?: CallOptions):
    AsyncIterable<[string, protos.google.cloud.compute.v1beta.IVmExtensionPoliciesScopedList]>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
