...
function main(nodeTemplate, project, region) {
  // [START compute_v1beta_generated_NodeTemplates_Delete_async]
  /**
  ...
  const {NodeTemplatesClient} = require('@google-cloud/compute').v1beta;
  ...
  callDelete();
  // [END compute_v1beta_generated_NodeTemplates_Delete_async]
}
