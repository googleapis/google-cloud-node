...
export class RecaptchaEnterpriseServiceClient {
  ...
  initialize() {
    ...
    const recaptchaEnterpriseServiceStubMethods =
        ['createAssessment', 'annotateAssessment', 'createKey', 'listKeys', 'retrieveLegacySecretKey', 'getKey', 'updateKey', 'deleteKey', 'migrateKey', 'getMetrics', 'listRelatedAccountGroups', 'listRelatedAccountGroupMemberships', 'searchRelatedAccountGroupMemberships'];
