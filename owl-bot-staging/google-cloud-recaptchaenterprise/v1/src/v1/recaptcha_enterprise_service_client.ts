...
export class RecaptchaEnterpriseServiceClient {
  ...
  initialize() {
    ...
    const recaptchaEnterpriseServiceStubMethods =
        ['createAssessment', 'annotateAssessment', 'createKey', 'listKeys', 'retrieveLegacySecretKey', 'getKey', 'updateKey', 'deleteKey', 'migrateKey', 'addIpOverride', 'getMetrics', 'createFirewallPolicy', 'listFirewallPolicies', 'getFirewallPolicy', 'updateFirewallPolicy', 'deleteFirewallPolicy', 'reorderFirewallPolicies', 'listRelatedAccountGroups', 'listRelatedAccountGroupMemberships', 'searchRelatedAccountGroupMemberships'];
 ...
 */
  ...
  reorderFirewallPolicies(
    ...
    this.initialize();
    return this.innerApiCalls.reorderFirewallPolicies(request, options, callback);
  }
