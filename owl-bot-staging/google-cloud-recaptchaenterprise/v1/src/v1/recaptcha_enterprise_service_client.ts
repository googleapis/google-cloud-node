...
export class RecaptchaEnterpriseServiceClient {
  ...
  initialize() {
    ...
    const recaptchaEnterpriseServiceStubMethods =
        ['createAssessment', 'annotateAssessment', 'createKey', 'listKeys', 'retrieveLegacySecretKey', 'getKey', 'updateKey', 'deleteKey', 'migrateKey', 'getMetrics', 'createFirewallPolicy', 'listFirewallPolicies', 'getFirewallPolicy', 'updateFirewallPolicy', 'deleteFirewallPolicy', 'listRelatedAccountGroups', 'listRelatedAccountGroupMemberships', 'searchRelatedAccountGroupMemberships'];
