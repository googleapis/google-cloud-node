...
function main(parent, frameworkDeployment) {
  ...
  async function callCreateFrameworkDeployment() {
    // Construct request
    const request = {
      parent,
      frameworkDeployment,
    ...
    // Run request
    const [operation] = await cloudsecuritycomplianceClient.createFrameworkDeployment(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callCreateFrameworkDeployment();
