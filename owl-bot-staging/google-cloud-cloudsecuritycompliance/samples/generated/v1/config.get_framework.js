...
function main(name) {
  // [START cloudsecuritycompliance_v1_generated_Config_GetFramework_async]
  /**
  ...
  async function callGetFramework() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await cloudsecuritycomplianceClient.getFramework(request);
