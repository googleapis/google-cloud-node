...
function main(parent) {
  ...
  async function callListControlComplianceSummaries() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = cloudsecuritycomplianceClient.listControlComplianceSummariesAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListControlComplianceSummaries();
  // [END cloudsecuritycompliance_v1_generated_Monitoring_ListControlComplianceSummaries_async]
}
