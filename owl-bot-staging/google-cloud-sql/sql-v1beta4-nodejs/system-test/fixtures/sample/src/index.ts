...
import {SqlBackupRunsServiceClient, SqlConnectServiceClient, SqlDatabasesServiceClient, SqlFlagsServiceClient, SqlIamPoliciesServiceClient, SqlInstancesServiceClient, SqlOperationsServiceClient, SqlSslCertsServiceClient, SqlTiersServiceClient, SqlUsersServiceClient} from '@google-cloud/sql';
...
function doStuffWithSqlIamPoliciesServiceClient(client: SqlIamPoliciesServiceClient) {
  client.close();
}
