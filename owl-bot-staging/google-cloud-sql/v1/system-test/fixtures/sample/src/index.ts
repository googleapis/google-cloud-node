...
import {SqlAvailableDatabaseVersionsServiceClient, SqlBackupRunsServiceClient, SqlConnectServiceClient, SqlDatabasesServiceClient, SqlEventsServiceClient, SqlFlagsServiceClient, SqlIamPoliciesServiceClient, SqlInstanceNamesServiceClient, SqlInstancesServiceClient, SqlOperationsServiceClient, SqlRegionsServiceClient, SqlSslCertsServiceClient, SqlTiersServiceClient, SqlUsersServiceClient} from '@google-cloud/sql';

// check that the client class type name can be used
function doStuffWithSqlAvailableDatabaseVersionsServiceClient(client: SqlAvailableDatabaseVersionsServiceClient) {
  client.close();
}
...
function main() {
  ...
  const sqlAvailableDatabaseVersionsServiceClient = new SqlAvailableDatabaseVersionsServiceClient();
  doStuffWithSqlAvailableDatabaseVersionsServiceClient(sqlAvailableDatabaseVersionsServiceClient);
  // check that the client instance can be created
