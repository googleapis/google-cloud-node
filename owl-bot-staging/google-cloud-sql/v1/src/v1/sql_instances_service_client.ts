...
export class SqlInstancesServiceClient {
  ...
  initialize() {
    ...
    const sqlInstancesServiceStubMethods =
        ['addServerCa', 'clone', 'delete', 'demoteMaster', 'export', 'failover', 'reencrypt', 'get', 'import', 'insert', 'list', 'listServerCas', 'patch', 'promoteReplica', 'resetSslConfig', 'restart', 'restoreBackup', 'rotateServerCa', 'startReplica', 'stopReplica', 'truncateLog', 'update', 'createEphemeral', 'rescheduleMaintenance', 'verifyExternalSyncSettings', 'startExternalSync', 'performDiskShrink', 'getDiskShrinkConfig', 'resetReplicaSize'];
