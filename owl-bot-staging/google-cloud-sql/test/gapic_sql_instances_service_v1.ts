...
describe('v1.SqlInstancesServiceClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new sqlinstancesserviceModule.v1.SqlInstancesServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'sqladmin.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new sqlinstancesserviceModule.v1.SqlInstancesServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'sqladmin.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new sqlinstancesserviceModule.v1.SqlInstancesServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new sqlinstancesserviceModule.v1.SqlInstancesServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('addServerCertificate', () => {
        it('invokes addServerCertificate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesAddServerCertificateRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesAddServerCertificateRequest', ['instance']);
            request.instance = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&instance=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.sql.v1.Operation()
    ...
    describe('addEntraIdCertificate', () => {
        it('invokes addEntraIdCertificate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesAddEntraIdCertificateRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesAddEntraIdCertificateRequest', ['instance']);
            request.instance = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&instance=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.sql.v1.Operation()
    ...
    describe('demote', () => {
        it('invokes demote without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesDemoteRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesDemoteRequest', ['instance']);
            request.instance = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&instance=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.sql.v1.Operation()
    ...
    describe('reencrypt', () => {
        it('invokes reencrypt without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesReencryptRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesReencryptRequest', ['instance']);
            request.instance = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&instance=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.sql.v1.Operation()
    ...
    describe('listServerCertificates', () => {
        it('invokes listServerCertificates without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesListServerCertificatesRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesListServerCertificatesRequest', ['instance']);
            request.instance = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&instance=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes listServerCertificates without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listServerCertificates(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.sql.v1.IInstancesListServerCertificatesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listEntraIdCertificates', () => {
        it('invokes listEntraIdCertificates without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesListEntraIdCertificatesRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesListEntraIdCertificatesRequest', ['instance']);
            request.instance = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&instance=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes listEntraIdCertificates without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listEntraIdCertificates(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.sql.v1.IInstancesListEntraIdCertificatesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('switchover', () => {
        it('invokes switchover without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesSwitchoverRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesSwitchoverRequest', ['instance']);
            request.instance = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&instance=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.sql.v1.Operation()
    ...
    describe('rotateServerCertificate', () => {
        it('invokes rotateServerCertificate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesRotateServerCertificateRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesRotateServerCertificateRequest', ['instance']);
            request.instance = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&instance=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.sql.v1.Operation()
    ...
    describe('rotateEntraIdCertificate', () => {
        it('invokes rotateEntraIdCertificate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesRotateEntraIdCertificateRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesRotateEntraIdCertificateRequest', ['instance']);
            request.instance = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&instance=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.sql.v1.Operation()
    ...
    describe('performDiskShrink', () => {
        it('invokes performDiskShrink without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesPerformDiskShrinkRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesPerformDiskShrinkRequest', ['instance']);
            request.instance = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&instance=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.sql.v1.Operation()
    ...
    describe('getDiskShrinkConfig', () => {
        it('invokes getDiskShrinkConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesGetDiskShrinkConfigRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesGetDiskShrinkConfigRequest', ['instance']);
            request.instance = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&instance=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getDiskShrinkConfig without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getDiskShrinkConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.sql.v1.ISqlInstancesGetDiskShrinkConfigResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('resetReplicaSize', () => {
        it('invokes resetReplicaSize without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesResetReplicaSizeRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesResetReplicaSizeRequest', ['instance']);
            request.instance = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&instance=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.sql.v1.Operation()
    ...
    describe('getLatestRecoveryTime', () => {
        it('invokes getLatestRecoveryTime without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesGetLatestRecoveryTimeRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesGetLatestRecoveryTimeRequest', ['instance']);
            request.instance = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&instance=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getLatestRecoveryTime without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getLatestRecoveryTime(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.sql.v1.ISqlInstancesGetLatestRecoveryTimeResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('executeSql', () => {
        it('invokes executeSql without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesExecuteSqlRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesExecuteSqlRequest', ['instance']);
            request.instance = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&instance=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes executeSql without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.executeSql(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.sql.v1.ISqlInstancesExecuteSqlResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('acquireSsrsLease', () => {
        it('invokes acquireSsrsLease without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesAcquireSsrsLeaseRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesAcquireSsrsLeaseRequest', ['instance']);
            request.instance = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&instance=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes acquireSsrsLease without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.acquireSsrsLease(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.sql.v1.ISqlInstancesAcquireSsrsLeaseResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('releaseSsrsLease', () => {
        it('invokes releaseSsrsLease without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesReleaseSsrsLeaseRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesReleaseSsrsLeaseRequest', ['instance']);
            request.instance = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&instance=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes releaseSsrsLease without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.releaseSsrsLease(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.sql.v1.ISqlInstancesReleaseSsrsLeaseResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('preCheckMajorVersionUpgrade', () => {
        it('invokes preCheckMajorVersionUpgrade without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesPreCheckMajorVersionUpgradeRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesPreCheckMajorVersionUpgradeRequest', ['instance']);
            request.instance = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&instance=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.sql.v1.Operation()
    ...
    describe('pointInTimeRestore', () => {
        it('invokes pointInTimeRestore without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlInstancesPointInTimeRestoreRequest', ['parent']);
