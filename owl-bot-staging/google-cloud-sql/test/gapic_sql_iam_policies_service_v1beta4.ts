...
describe('v1beta4.SqlIamPoliciesServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new sqliampoliciesserviceModule.v1beta4.SqlIamPoliciesServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          sqliampoliciesserviceModule.v1beta4.SqlIamPoliciesServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        sqliampoliciesserviceModule.v1beta4.SqlIamPoliciesServiceClient.port;
      assert(port);
