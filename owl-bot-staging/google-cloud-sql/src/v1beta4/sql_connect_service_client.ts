...
export class SqlConnectServiceClient {
   ...
   *   The first element of the array is an object representing {@link protos.google.cloud.sql.v1beta4.ConnectSettings|ConnectSettings}.
  ...
  getConnectSettings(
    ...
    [
      ...
      protos.google.cloud.sql.v1beta4.IGetConnectSettingsRequest | undefined,
      {} | undefined,
    ]
  >;
  getConnectSettings(
    ...
    callback: Callback<
      protos.google.cloud.sql.v1beta4.IConnectSettings,
      | protos.google.cloud.sql.v1beta4.IGetConnectSettingsRequest
      | null
      | undefined,
      {} | null | undefined
    >,
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta4/sql_connect_service.resolve_connect_settings.js</caption>
   * region_tag:sqladmin_v1beta4_generated_SqlConnectService_ResolveConnectSettings_async
   */
  resolveConnectSettings(
    request?: protos.google.cloud.sql.v1beta4.IResolveConnectSettingsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.sql.v1beta4.IConnectSettings,
      (
        | protos.google.cloud.sql.v1beta4.IResolveConnectSettingsRequest
        | undefined
      ),
      {} | undefined,
    ]
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.cloud.sql.v1beta4.GenerateEphemeralCertResponse|GenerateEphemeralCertResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
  ...
  generateEphemeralCert(
    ...
    [
      ...
      protos.google.cloud.sql.v1beta4.IGenerateEphemeralCertRequest | undefined,
      {} | undefined,
    ]
  >;
  generateEphemeralCert(
    ...
    callback: Callback<
      protos.google.cloud.sql.v1beta4.IGenerateEphemeralCertResponse,
      | protos.google.cloud.sql.v1beta4.IGenerateEphemeralCertRequest
      | null
      | undefined,
      {} | null | undefined
    >,
