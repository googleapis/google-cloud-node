 ...
 * `src/v1/sql_feature_eligibility_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './sql_feature_eligibility_service_client_config.json';
 ...
 * @memberof v1
 */
export class SqlFeatureEligibilityServiceClient {
  ...
  initialize() {
    ...
    if (this.sqlFeatureEligibilityServiceStub) {
