...
describe('v1alpha.MapsPlatformDatasetsV1AlphaClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new mapsplatformdatasetsv1alphaModule.v1alpha.MapsPlatformDatasetsV1AlphaClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = mapsplatformdatasetsv1alphaModule.v1alpha.MapsPlatformDatasetsV1AlphaClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = mapsplatformdatasetsv1alphaModule.v1alpha.MapsPlatformDatasetsV1AlphaClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'mapsplatformdatasets.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new mapsplatformdatasetsv1alphaModule.v1alpha.MapsPlatformDatasetsV1AlphaClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'mapsplatformdatasets.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new mapsplatformdatasetsv1alphaModule.v1alpha.MapsPlatformDatasetsV1AlphaClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'mapsplatformdatasets.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new mapsplatformdatasetsv1alphaModule.v1alpha.MapsPlatformDatasetsV1AlphaClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new mapsplatformdatasetsv1alphaModule.v1alpha.MapsPlatformDatasetsV1AlphaClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = mapsplatformdatasetsv1alphaModule.v1alpha.MapsPlatformDatasetsV1AlphaClient.port;
            assert(port);
    ...
    describe('createDataset', () => {
        it('invokes createDataset without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.maps.mapsplatformdatasets.v1alpha.CreateDatasetRequest', ['parent']);
        ...
        it('invokes createDataset without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createDataset(
                    request,
                    (err?: Error|null, result?: protos.google.maps.mapsplatformdatasets.v1alpha.IDataset|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateDatasetMetadata', () => {
        it('invokes updateDatasetMetadata without error', async () => {
            ...
            request.dataset ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.maps.mapsplatformdatasets.v1alpha.UpdateDatasetMetadataRequest', ['dataset', 'name']);
    ...
    describe('getDataset', () => {
        it('invokes getDataset without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.maps.mapsplatformdatasets.v1alpha.GetDatasetRequest', ['name']);
    ...
    describe('deleteDataset', () => {
        it('invokes deleteDataset without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.maps.mapsplatformdatasets.v1alpha.DeleteDatasetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('deleteDatasetVersion', () => {
        it('invokes deleteDatasetVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.maps.mapsplatformdatasets.v1alpha.DeleteDatasetVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteDatasetVersion = stubSimpleCall(expectedResponse);
        ...
        it('invokes deleteDatasetVersion without error using callback', async () => {
            ...
            client.innerApiCalls.deleteDatasetVersion = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteDatasetVersion with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteDatasetVersion = stubSimpleCall(undefined, expectedError);
    ...
    describe('listDatasetVersions', () => {
        it('invokes listDatasetVersions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.maps.mapsplatformdatasets.v1alpha.ListDatasetVersionsRequest', ['name']);
            request.name = defaultValue1;
    ...
    describe('listDatasets', () => {
        it('invokes listDatasets without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.maps.mapsplatformdatasets.v1alpha.ListDatasetsRequest', ['parent']);
            request.parent = defaultValue1;
