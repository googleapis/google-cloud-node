...
# [Connection: Nodejs Client][homepage]

[//]: # "releaseLevel"

[![npm version](https://img.shields.io/npm/v/connection.svg)](https://www.npmjs.org/package/connection)

Connection client for Node.js
...
* [Connection Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/connection/latest)
...
1.  [Enable the Connection API][enable_api].
...
For example, `npm install connection@legacy-8` installs client libraries
