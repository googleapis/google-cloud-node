...
# [Gateway: Nodejs Client][homepage]
...
* [Gateway Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/gateway/latest)
* [Gateway Documentation](https://cloud.google.com/kubernetes-engine/enterprise/multicluster-management/gateway)
...
1.  [Enable the Gateway API][enable_api].
