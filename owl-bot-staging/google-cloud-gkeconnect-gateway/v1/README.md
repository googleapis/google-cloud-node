...
[![npm version](https://img.shields.io/npm/v/@google-cloud/gateway.svg)](https://www.npmjs.org/package/@google-cloud/gateway)
...
```bash
npm install @google-cloud/gateway
```
...
For example, `npm install @google-cloud/gateway@legacy-8` installs client libraries
