...
describe('v1.SqlDatabasesServiceClient', () => {
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlDatabasesDeleteRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlDatabasesDeleteRequest', ['instance']);
            request.instance = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlDatabasesDeleteRequest', ['database']);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlDatabasesGetRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlDatabasesGetRequest', ['instance']);
            request.instance = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlDatabasesGetRequest', ['database']);
            request.database = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&instance=${defaultValue2}&database=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlDatabasesInsertRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlDatabasesInsertRequest', ['instance']);
            request.instance = defaultValue2;
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlDatabasesListRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlDatabasesListRequest', ['instance']);
            request.instance = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&instance=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlDatabasesUpdateRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlDatabasesUpdateRequest', ['instance']);
            request.instance = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.sql.v1.SqlDatabasesUpdateRequest', ['database']);
            request.database = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&instance=${defaultValue2}&database=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.sql.v1.Operation()
