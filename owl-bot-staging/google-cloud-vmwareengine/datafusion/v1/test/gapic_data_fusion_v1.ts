...
describe('v1.DataFusionClient', () => {
    ...
    describe('getInstance', () => {
        it('invokes getInstance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datafusion.v1.GetInstanceRequest', ['name']);
    ...
    describe('createInstance', () => {
        it('invokes createInstance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datafusion.v1.CreateInstanceRequest', ['parent']);
    ...
    describe('deleteInstance', () => {
        it('invokes deleteInstance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datafusion.v1.DeleteInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('updateInstance', () => {
        it('invokes updateInstance without error', async () => {
            ...
            request.instance ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datafusion.v1.UpdateInstanceRequest', ['instance', 'name']);
    ...
    describe('restartInstance', () => {
        it('invokes restartInstance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datafusion.v1.RestartInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listAvailableVersions', () => {
        it('invokes listAvailableVersions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datafusion.v1.ListAvailableVersionsRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listInstances', () => {
        it('invokes listInstances without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datafusion.v1.ListInstancesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
