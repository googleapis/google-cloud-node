...
describe('v1beta.AgentEndpointServiceClient', () => {
    ...
    describe('startNextTask', () => {
        it('invokes startNextTask without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.osconfig.agentendpoint.v1beta.StartNextTaskRequest()
            );
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.osconfig.agentendpoint.v1beta.StartNextTaskResponse()
            );
    ...
    describe('reportTaskProgress', () => {
        it('invokes reportTaskProgress without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.osconfig.agentendpoint.v1beta.ReportTaskProgressRequest()
            );
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.osconfig.agentendpoint.v1beta.ReportTaskProgressResponse()
            );
    ...
    describe('reportTaskComplete', () => {
        it('invokes reportTaskComplete without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.osconfig.agentendpoint.v1beta.ReportTaskCompleteRequest()
            );
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.osconfig.agentendpoint.v1beta.ReportTaskCompleteResponse()
            );
    ...
    describe('lookupEffectiveGuestPolicy', () => {
        it('invokes lookupEffectiveGuestPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.osconfig.agentendpoint.v1beta.LookupEffectiveGuestPolicyRequest()
            );
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.osconfig.agentendpoint.v1beta.EffectiveGuestPolicy()
            );
    ...
    describe('registerAgent', () => {
        it('invokes registerAgent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.osconfig.agentendpoint.v1beta.RegisterAgentRequest()
            );
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.osconfig.agentendpoint.v1beta.RegisterAgentResponse()
            );
    ...
    describe('receiveTaskNotification', () => {
        it('invokes receiveTaskNotification without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.osconfig.agentendpoint.v1beta.ReceiveTaskNotificationRequest()
            );
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.osconfig.agentendpoint.v1beta.ReceiveTaskNotificationResponse()
            );
