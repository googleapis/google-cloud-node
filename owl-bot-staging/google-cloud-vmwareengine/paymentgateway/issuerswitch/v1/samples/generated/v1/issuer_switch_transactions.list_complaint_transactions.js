...
function main(parent) {
  // [START issuerswitch_v1_generated_IssuerSwitchTransactions_ListComplaintTransactions_async]
  /**
  ...
  async function callListComplaintTransactions() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = await issuerswitchClient.listComplaintTransactionsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListComplaintTransactions();
  // [END issuerswitch_v1_generated_IssuerSwitchTransactions_ListComplaintTransactions_async]
}
