...
function main(parent, dataset) {
  // [START timeseriesinsights_v1_generated_TimeseriesInsightsController_CreateDataSet_async]
  /**
  ...
  async function callCreateDataSet() {
    ...
    // Run request
    const response = await timeseriesinsightsClient.createDataSet(request);
    console.log(response);
  }

  callCreateDataSet();
  // [END timeseriesinsights_v1_generated_TimeseriesInsightsController_CreateDataSet_async]
}
