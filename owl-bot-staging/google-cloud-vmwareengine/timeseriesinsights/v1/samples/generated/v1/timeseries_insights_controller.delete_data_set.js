...
function main(name) {
  // [START timeseriesinsights_v1_generated_TimeseriesInsightsController_DeleteDataSet_async]
  /**
  ...
  async function callDeleteDataSet() {
    ...
    // Run request
    const response = await timeseriesinsightsClient.deleteDataSet(request);
    console.log(response);
  }

  callDeleteDataSet();
  // [END timeseriesinsights_v1_generated_TimeseriesInsightsController_DeleteDataSet_async]
}
