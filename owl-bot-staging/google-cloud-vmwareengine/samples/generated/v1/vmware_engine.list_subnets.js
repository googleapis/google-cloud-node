...
function main(parent) {
  // [START vmwareengine_v1_generated_VmwareEngine_ListSubnets_async]
  /**
  ...
  async function callListSubnets() {
    ...
    // Run request
    const iterable = vmwareengineClient.listSubnetsAsync(request);
  ...
  callListSubnets();
  // [END vmwareengine_v1_generated_VmwareEngine_ListSubnets_async]
}
