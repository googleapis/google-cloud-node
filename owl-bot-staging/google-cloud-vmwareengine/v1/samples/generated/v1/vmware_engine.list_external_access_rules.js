...
function main(parent) {
  // [START vmwareengine_v1_generated_VmwareEngine_ListExternalAccessRules_async]
  /**
  ...
  async function callListExternalAccessRules() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = await vmwareengineClient.listExternalAccessRulesAsync(request);
