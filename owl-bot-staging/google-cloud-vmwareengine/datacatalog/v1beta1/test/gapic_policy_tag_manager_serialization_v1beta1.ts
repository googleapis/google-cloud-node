...
describe('v1beta1.PolicyTagManagerSerializationClient', () => {
    ...
    describe('importTaxonomies', () => {
        it('invokes importTaxonomies without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.ImportTaxonomiesRequest', ['parent']);
            ...
            const actualRequest = (client.innerApiCalls.importTaxonomies as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.importTaxonomies as SinonStub)
        ...
        it('invokes importTaxonomies without error using callback', async () => {
            ...
            client.innerApiCalls.importTaxonomies = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.importTaxonomies(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datacatalog.v1beta1.IImportTaxonomiesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes importTaxonomies with error', async () => {
            ...
            client.innerApiCalls.importTaxonomies = stubSimpleCall(undefined, expectedError);
    ...
    describe('exportTaxonomies', () => {
        it('invokes exportTaxonomies without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.ExportTaxonomiesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportTaxonomies as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.exportTaxonomies as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes exportTaxonomies without error using callback', async () => {
            ...
            client.innerApiCalls.exportTaxonomies = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.exportTaxonomies(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datacatalog.v1beta1.IExportTaxonomiesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes exportTaxonomies with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.exportTaxonomies = stubSimpleCall(undefined, expectedError);
