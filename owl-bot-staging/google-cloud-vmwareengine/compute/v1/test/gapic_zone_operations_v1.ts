...
import * as zoneoperationsModule from '../src';
...
describe('v1.ZoneOperationsClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = zoneoperationsModule.v1.ZoneOperationsClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = zoneoperationsModule.v1.ZoneOperationsClient.apiEndpoint;
            assert(apiEndpoint);
        });

        it('has port', () => {
            const port = zoneoperationsModule.v1.ZoneOperationsClient.port;
            assert(port);
            assert(typeof port === 'number');
        });

        it('should create a client with no option', () => {
            const client = new zoneoperationsModule.v1.ZoneOperationsClient();
            assert(client);
        });
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.zoneOperationsStub, undefined);
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.DeleteZoneOperationRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.DeleteZoneOperationRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.DeleteZoneOperationRequest', ['operation']);
            ...
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.DeleteZoneOperationResponse()
            );
        ...
        it('invokes delete without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.delete(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.IDeleteZoneOperationResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetZoneOperationRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetZoneOperationRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetZoneOperationRequest', ['operation']);
            request.operation = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&zone=${defaultValue2}&operation=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('wait', () => {
        it('invokes wait without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.WaitZoneOperationRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.WaitZoneOperationRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.WaitZoneOperationRequest', ['operation']);
            request.operation = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&zone=${defaultValue2}&operation=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.ListZoneOperationsRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.ListZoneOperationsRequest', ['zone']);
            request.zone = defaultValue2;
