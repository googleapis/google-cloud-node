...
export class PredictionServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.recommendationengine.v1beta1.PredictionService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.predictionServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.recommendationengine.v1beta1.PredictionService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.recommendationengine.v1beta1.PredictionService,
   ...
   */
  placementPath(project:string,location:string,catalog:string,eventStore:string,placement:string) {
  ...
  /**
   * Parse the project from Placement resource.
   *
   * @param {string} placementName
   *   A fully-qualified path representing Placement resource.
   * @returns {string} A string representing the project.
   */
  matchProjectFromPlacementName(placementName: string) {
    return this.pathTemplates.placementPathTemplate.match(placementName).project;
  }

  /**
   * Parse the location from Placement resource.
   *
   * @param {string} placementName
   *   A fully-qualified path representing Placement resource.
   * @returns {string} A string representing the location.
   */
  matchLocationFromPlacementName(placementName: string) {
    return this.pathTemplates.placementPathTemplate.match(placementName).location;
  }

  /**
   * Parse the catalog from Placement resource.
   *
   * @param {string} placementName
   *   A fully-qualified path representing Placement resource.
   * @returns {string} A string representing the catalog.
   */
  matchCatalogFromPlacementName(placementName: string) {
    return this.pathTemplates.placementPathTemplate.match(placementName).catalog;
  }

  /**
   * Parse the event_store from Placement resource.
   *
   * @param {string} placementName
   *   A fully-qualified path representing Placement resource.
   * @returns {string} A string representing the event_store.
   */
  matchEventStoreFromPlacementName(placementName: string) {
    return this.pathTemplates.placementPathTemplate.match(placementName).event_store;
  }
