    ...
    describe('createStudy', () => {
        ...
        it('invokes createStudy without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createStudy(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IStudy|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createTrial', () => {
        ...
        it('invokes createTrial without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createTrial(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.ITrial|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listOptimalTrials without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listOptimalTrials(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IListOptimalTrialsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes suggestTrials without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.suggestTrials(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.ISuggestTrialsResponse, protos.google.cloud.aiplatform.v1.ISuggestTrialsMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.ISuggestTrialsResponse, protos.google.cloud.aiplatform.v1.ISuggestTrialsMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.suggestTrials as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkTrialEarlyStoppingState without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.checkTrialEarlyStoppingState(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.ICheckTrialEarlyStoppingStateResponse, protos.google.cloud.aiplatform.v1.ICheckTrialEarlyStoppingStateMetatdata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.ICheckTrialEarlyStoppingStateResponse, protos.google.cloud.aiplatform.v1.ICheckTrialEarlyStoppingStateMetatdata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.checkTrialEarlyStoppingState as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listStudies', () => {
        ...
        it('invokes listStudiesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.Study) => {
    ...
    describe('listTrials', () => {
        ...
        it('invokes listTrialsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.Trial) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
