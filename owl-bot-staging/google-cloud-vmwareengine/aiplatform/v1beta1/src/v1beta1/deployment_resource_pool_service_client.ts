...
export class DeploymentResourcePoolServiceClient {
   ...
   *     const client = new DeploymentResourcePoolServiceClient({fallback: 'rest'}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof DeploymentResourcePoolServiceClient;
    ...
    this.descriptors.page = {
      listDeploymentResourcePools:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'deploymentResourcePools'),
      queryDeployedModels:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'deployedModels')
    };
    ...
    const createDeploymentResourcePoolResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.DeploymentResourcePool') as gax.protobuf.Type;
    const createDeploymentResourcePoolMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.CreateDeploymentResourcePoolOperationMetadata') as gax.protobuf.Type;
    ...
    this.descriptors.longrunning = {
      createDeploymentResourcePool: new this._gaxModule.LongrunningDescriptor(
        ...
        createDeploymentResourcePoolResponse.decode.bind(createDeploymentResourcePoolResponse),
        createDeploymentResourcePoolMetadata.decode.bind(createDeploymentResourcePoolMetadata)),
      deleteDeploymentResourcePool: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        deleteDeploymentResourcePoolResponse.decode.bind(deleteDeploymentResourcePoolResponse),
        deleteDeploymentResourcePoolMetadata.decode.bind(deleteDeploymentResourcePoolMetadata))
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.aiplatform.v1beta1.DeploymentResourcePoolService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.deploymentResourcePoolServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.aiplatform.v1beta1.DeploymentResourcePoolService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.aiplatform.v1beta1.DeploymentResourcePoolService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const deploymentResourcePoolServiceStubMethods =
        ['createDeploymentResourcePool', 'getDeploymentResourcePool', 'listDeploymentResourcePools', 'deleteDeploymentResourcePool', 'queryDeployedModels'];
 ...
 *   The first element of the array is an object representing [DeploymentResourcePool]{@link google.cloud.aiplatform.v1beta1.DeploymentResourcePool}.
 *   Please see the
 ...
 */
  getDeploymentResourcePool(
      ...
      Promise<[
        ...
        protos.google.cloud.aiplatform.v1beta1.IGetDeploymentResourcePoolRequest|undefined, {}|undefined
      ]>;
  getDeploymentResourcePool(
      request: protos.google.cloud.aiplatform.v1beta1.IGetDeploymentResourcePoolRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1beta1.IDeploymentResourcePool,
          protos.google.cloud.aiplatform.v1beta1.IGetDeploymentResourcePoolRequest|null|undefined,
          {}|null|undefined>): void;
  getDeploymentResourcePool(
      request: protos.google.cloud.aiplatform.v1beta1.IGetDeploymentResourcePoolRequest,
      callback: Callback<
 ...
 */
  createDeploymentResourcePool(
      request?: protos.google.cloud.aiplatform.v1beta1.ICreateDeploymentResourcePoolRequest,
      options?: CallOptions):
      Promise<[
 ...
 * region_tag:aiplatform_v1beta1_generated_DeploymentResourcePoolService_CreateDeploymentResourcePool_async
 */
  async checkCreateDeploymentResourcePoolProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1beta1.DeploymentResourcePool, protos.google.cloud.aiplatform.v1beta1.CreateDeploymentResourcePoolOperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1beta1.DeploymentResourcePool, protos.google.cloud.aiplatform.v1beta1.CreateDeploymentResourcePoolOperationMetadata>;
  }
/**
 ...
 */
  deleteDeploymentResourcePool(
      request?: protos.google.cloud.aiplatform.v1beta1.IDeleteDeploymentResourcePoolRequest,
      options?: CallOptions):
      Promise<[
 ...
 * region_tag:aiplatform_v1beta1_generated_DeploymentResourcePoolService_DeleteDeploymentResourcePool_async
 */
  async checkDeleteDeploymentResourcePoolProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [DeploymentResourcePool]{@link google.cloud.aiplatform.v1beta1.DeploymentResourcePool}.
 ...
 */
  ...
  listDeploymentResourcePools(
      ...
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1beta1.IListDeploymentResourcePoolsRequest,
          protos.google.cloud.aiplatform.v1beta1.IListDeploymentResourcePoolsResponse|null|undefined,
          protos.google.cloud.aiplatform.v1beta1.IDeploymentResourcePool>): void;
  listDeploymentResourcePools(
      request: protos.google.cloud.aiplatform.v1beta1.IListDeploymentResourcePoolsRequest,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1beta1.IListDeploymentResourcePoolsRequest,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [DeploymentResourcePool]{@link google.cloud.aiplatform.v1beta1.DeploymentResourcePool} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   [DeploymentResourcePool]{@link google.cloud.aiplatform.v1beta1.DeploymentResourcePool}. The API will be called under the hood as needed, once per the page,
 ...
 */
  listDeploymentResourcePoolsAsync(
      request?: protos.google.cloud.aiplatform.v1beta1.IListDeploymentResourcePoolsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.aiplatform.v1beta1.IDeploymentResourcePool>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listDeploymentResourcePools.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.aiplatform.v1beta1.IDeploymentResourcePool>;
  }
 /**
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [DeployedModel]{@link google.cloud.aiplatform.v1beta1.DeployedModel}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 ...
 */
  ...
  queryDeployedModels(
      ...
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1beta1.IQueryDeployedModelsRequest,
          protos.google.cloud.aiplatform.v1beta1.IQueryDeployedModelsResponse|null|undefined,
          protos.google.cloud.aiplatform.v1beta1.IDeployedModel>): void;
  queryDeployedModels(
      request: protos.google.cloud.aiplatform.v1beta1.IQueryDeployedModelsRequest,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1beta1.IQueryDeployedModelsRequest,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [DeployedModel]{@link google.cloud.aiplatform.v1beta1.DeployedModel} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed. Note that it can affect your quota.
 *   We recommend using `queryDeployedModelsAsync()`
 *   method described below for async iteration which you can stop as needed.
 ...
 *   An iterable Object that allows [async iteration](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols).
 *   When you iterate the returned iterable, each element will be an object representing
 *   [DeployedModel]{@link google.cloud.aiplatform.v1beta1.DeployedModel}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination)
 *   for more details and examples.
 ...
 */
  queryDeployedModelsAsync(
      request?: protos.google.cloud.aiplatform.v1beta1.IQueryDeployedModelsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.aiplatform.v1beta1.IDeployedModel>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.queryDeployedModels.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.aiplatform.v1beta1.IDeployedModel>;
  }
/**
