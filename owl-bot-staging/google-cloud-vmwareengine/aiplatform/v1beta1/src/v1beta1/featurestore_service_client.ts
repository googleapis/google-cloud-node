...
export class FeaturestoreServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const createFeaturestoreResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.Featurestore') as gax.protobuf.Type;
    const createFeaturestoreMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.CreateFeaturestoreOperationMetadata') as gax.protobuf.Type;
    const updateFeaturestoreResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.Featurestore') as gax.protobuf.Type;
    const updateFeaturestoreMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.UpdateFeaturestoreOperationMetadata') as gax.protobuf.Type;
    ...
    const createEntityTypeResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.EntityType') as gax.protobuf.Type;
    const createEntityTypeMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.CreateEntityTypeOperationMetadata') as gax.protobuf.Type;
    ...
    const importFeatureValuesResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.ImportFeatureValuesResponse') as gax.protobuf.Type;
    const importFeatureValuesMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.ImportFeatureValuesOperationMetadata') as gax.protobuf.Type;
    const batchReadFeatureValuesResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.BatchReadFeatureValuesResponse') as gax.protobuf.Type;
    const batchReadFeatureValuesMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.BatchReadFeatureValuesOperationMetadata') as gax.protobuf.Type;
    const exportFeatureValuesResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.ExportFeatureValuesResponse') as gax.protobuf.Type;
    const exportFeatureValuesMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.ExportFeatureValuesOperationMetadata') as gax.protobuf.Type;
    const deleteFeatureValuesResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.DeleteFeatureValuesResponse') as gax.protobuf.Type;
    const deleteFeatureValuesMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.DeleteFeatureValuesOperationMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.aiplatform.v1beta1.FeaturestoreService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.featurestoreServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.aiplatform.v1beta1.FeaturestoreService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.aiplatform.v1beta1.FeaturestoreService,
 ...
 */
  getFeaturestore(
      ...
      Promise<[
        ...
        protos.google.cloud.aiplatform.v1beta1.IGetFeaturestoreRequest|undefined, {}|undefined
      ]>;
  getFeaturestore(
      request: protos.google.cloud.aiplatform.v1beta1.IGetFeaturestoreRequest,
      options: CallOptions,
 ...
 */
  getEntityType(
      ...
      Promise<[
        ...
        protos.google.cloud.aiplatform.v1beta1.IGetEntityTypeRequest|undefined, {}|undefined
      ]>;
  getEntityType(
      request: protos.google.cloud.aiplatform.v1beta1.IGetEntityTypeRequest,
      options: CallOptions,
 ...
 */
  updateEntityType(
      ...
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.IEntityType,
        protos.google.cloud.aiplatform.v1beta1.IUpdateEntityTypeRequest|undefined, {}|undefined
      ]>;
  updateEntityType(
      request: protos.google.cloud.aiplatform.v1beta1.IUpdateEntityTypeRequest,
      options: CallOptions,
 ...
 */
  updateFeature(
      ...
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.IFeature,
        protos.google.cloud.aiplatform.v1beta1.IUpdateFeatureRequest|undefined, {}|undefined
      ]>;
  updateFeature(
      request: protos.google.cloud.aiplatform.v1beta1.IUpdateFeatureRequest,
      options: CallOptions,
 ...
 * region_tag:aiplatform_v1beta1_generated_FeaturestoreService_DeleteFeatureValues_async
 */
  async checkDeleteFeatureValuesProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1beta1.DeleteFeatureValuesResponse, protos.google.cloud.aiplatform.v1beta1.DeleteFeatureValuesOperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    ...
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1beta1.DeleteFeatureValuesResponse, protos.google.cloud.aiplatform.v1beta1.DeleteFeatureValuesOperationMetadata>;
  }
 /**
 ...
 */
  ...
  listFeaturestores(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.aiplatform.v1beta1.IFeaturestore>): void;
  listFeaturestores(
      request: protos.google.cloud.aiplatform.v1beta1.IListFeaturestoresRequest,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1beta1.IListFeaturestoresRequest,
 ...
 */
  ...
  listEntityTypes(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.aiplatform.v1beta1.IEntityType>): void;
  listEntityTypes(
      request: protos.google.cloud.aiplatform.v1beta1.IListEntityTypesRequest,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1beta1.IListEntityTypesRequest,
