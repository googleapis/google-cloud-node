...
describe('v1.DocumentServiceClient', () => {
    ...
    describe('createDocument', () => {
        it('invokes createDocument without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contentwarehouse.v1.CreateDocumentRequest', ['parent']);
        ...
        it('invokes createDocument without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createDocument(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.contentwarehouse.v1.ICreateDocumentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getDocument', () => {
        it('invokes getDocument without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contentwarehouse.v1.GetDocumentRequest', ['name']);
        ...
        it('invokes getDocument without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getDocument(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.contentwarehouse.v1.IDocument|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateDocument', () => {
        it('invokes updateDocument without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contentwarehouse.v1.UpdateDocumentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes updateDocument without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updateDocument(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.contentwarehouse.v1.IUpdateDocumentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deleteDocument', () => {
        it('invokes deleteDocument without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contentwarehouse.v1.DeleteDocumentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('lockDocument', () => {
        it('invokes lockDocument without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contentwarehouse.v1.LockDocumentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.contentwarehouse.v1.Document()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.lockDocument as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.lockDocument as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes lockDocument without error using callback', async () => {
            ...
            client.innerApiCalls.lockDocument = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.lockDocument(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.contentwarehouse.v1.IDocument|null) => {
        ...
        it('invokes lockDocument with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.lockDocument = stubSimpleCall(undefined, expectedError);
    ...
    describe('fetchAcl', () => {
        it('invokes fetchAcl without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contentwarehouse.v1.FetchAclRequest', ['resource']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.fetchAcl as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.fetchAcl as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes fetchAcl without error using callback', async () => {
            ...
            client.innerApiCalls.fetchAcl = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.fetchAcl(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.contentwarehouse.v1.IFetchAclResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('setAcl', () => {
        it('invokes setAcl without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contentwarehouse.v1.SetAclRequest', ['resource']);
            request.resource = defaultValue1;
            const expectedHeaderRequestParams = `resource=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.setAcl as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.setAcl as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes setAcl without error using callback', async () => {
            ...
            client.innerApiCalls.setAcl = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.setAcl(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.contentwarehouse.v1.ISetAclResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('searchDocuments', () => {
        it('invokes searchDocuments without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contentwarehouse.v1.SearchDocumentsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.contentwarehouse.v1.SearchDocumentsResponse.MatchingDocument()),
              generateSampleMessage(new protos.google.cloud.contentwarehouse.v1.SearchDocumentsResponse.MatchingDocument()),
              generateSampleMessage(new protos.google.cloud.contentwarehouse.v1.SearchDocumentsResponse.MatchingDocument()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.searchDocuments as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.searchDocuments as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes searchDocuments without error using callback', async () => {
            ...
            client.innerApiCalls.searchDocuments = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.searchDocuments(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.contentwarehouse.v1.SearchDocumentsResponse.IMatchingDocument[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes searchDocuments with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.searchDocuments = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes searchDocumentsStream without error', async () => {
            ...
            client.descriptors.page.searchDocuments.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.contentwarehouse.v1.SearchDocumentsResponse.MatchingDocument) => {
            ...
            assert((client.descriptors.page.searchDocuments.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.searchDocuments, request));
            assert(
        ...
        it('invokes searchDocumentsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.searchDocuments.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.searchDocumentsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.contentwarehouse.v1.SearchDocumentsResponse.MatchingDocument[] = [];
                stream.on('data', (response: protos.google.cloud.contentwarehouse.v1.SearchDocumentsResponse.MatchingDocument) => {
        ...
        it('uses async iteration with searchDocuments without error', async () => {
            ...
            client.descriptors.page.searchDocuments.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with searchDocuments with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.searchDocuments.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.searchDocumentsAsync(request);
