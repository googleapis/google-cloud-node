 ...
 * `src/v1/rule_set_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './rule_set_service_client_config.json';
 ...
 * @memberof v1
 */
export class RuleSetServiceClient {
   ...
   *     const client = new RuleSetServiceClient({fallback: 'rest'}, gax);
   *     ```
   */
  ...
  initialize() {
    ...
    if (this.ruleSetServiceStub) {
      return this.ruleSetServiceStub;
    }
    ...
    const ruleSetServiceStubMethods =
        ['createRuleSet', 'getRuleSet', 'updateRuleSet', 'deleteRuleSet', 'listRuleSets', 'processAsyncRuleSets'];
 ...
 *   The first element of the array is an object representing [RuleSet]{@link google.cloud.contentwarehouse.v1.RuleSet}.
 *   Please see the
 ...
 * @param {google.cloud.contentwarehouse.v1.Schedule} request.schedule
 *   Required. The frequency category of async rules to process.
 * @param {google.protobuf.Timestamp} [request.executionTime]
 *   Optional. Timestamp to override inferred execution time.
 * @param {string[]} [request.documentNames]
 *   Optional. Document name filter to process only a subset of Documents.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [ProcessAsyncRuleSetsResponse]{@link google.cloud.contentwarehouse.v1.ProcessAsyncRuleSetsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/rule_set_service.process_async_rule_sets.js</caption>
 * region_tag:contentwarehouse_v1_generated_RuleSetService_ProcessAsyncRuleSets_async
 */
  processAsyncRuleSets(
      request?: protos.google.cloud.contentwarehouse.v1.IProcessAsyncRuleSetsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.contentwarehouse.v1.IProcessAsyncRuleSetsResponse,
        protos.google.cloud.contentwarehouse.v1.IProcessAsyncRuleSetsRequest|undefined, {}|undefined
      ]>;
  processAsyncRuleSets(
      request: protos.google.cloud.contentwarehouse.v1.IProcessAsyncRuleSetsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.contentwarehouse.v1.IProcessAsyncRuleSetsResponse,
          protos.google.cloud.contentwarehouse.v1.IProcessAsyncRuleSetsRequest|null|undefined,
          {}|null|undefined>): void;
  processAsyncRuleSets(
      request: protos.google.cloud.contentwarehouse.v1.IProcessAsyncRuleSetsRequest,
      callback: Callback<
  ...
  processAsyncRuleSets(
    ...
    this.initialize();
    return this.innerApiCalls.processAsyncRuleSets(request, options, callback);
  }
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [RuleSet]{@link google.cloud.contentwarehouse.v1.RuleSet}.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [RuleSet]{@link google.cloud.contentwarehouse.v1.RuleSet} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   [RuleSet]{@link google.cloud.contentwarehouse.v1.RuleSet}. The API will be called under the hood as needed, once per the page,
