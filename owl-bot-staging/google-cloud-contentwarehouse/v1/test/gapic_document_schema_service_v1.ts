...
describe('v1.DocumentSchemaServiceClient', () => {
    ...
    describe('createDocumentSchema', () => {
        it('invokes createDocumentSchema without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateDocumentSchemaRequest', ['parent']);
    ...
    describe('updateDocumentSchema', () => {
        it('invokes updateDocumentSchema without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UpdateDocumentSchemaRequest', ['name']);
    ...
    describe('getDocumentSchema', () => {
        it('invokes getDocumentSchema without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetDocumentSchemaRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.contentwarehouse.v1.DocumentSchema()
    ...
    describe('deleteDocumentSchema', () => {
        it('invokes deleteDocumentSchema without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteDocumentSchemaRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listDocumentSchemas', () => {
        it('invokes listDocumentSchemas without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListDocumentSchemasRequest', ['parent']);
            request.parent = defaultValue1;
