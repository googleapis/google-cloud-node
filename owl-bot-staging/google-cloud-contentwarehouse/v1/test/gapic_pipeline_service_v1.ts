...
describe('v1.PipelineServiceClient', () => {
    ...
    describe('runPipeline', () => {
        it('invokes runPipeline without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contentwarehouse.v1.RunPipelineRequest', ['name']);
        ...
        it('invokes runPipeline without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.runPipeline(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.contentwarehouse.v1.IRunPipelineResponse, protos.google.cloud.contentwarehouse.v1.IRunPipelineMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.contentwarehouse.v1.IRunPipelineResponse, protos.google.cloud.contentwarehouse.v1.IRunPipelineMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.runPipeline as SinonStub)
                .getCall(0).args[0];
