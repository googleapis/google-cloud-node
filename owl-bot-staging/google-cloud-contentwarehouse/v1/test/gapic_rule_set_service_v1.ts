...
describe('v1.RuleSetServiceClient', () => {
    ...
    describe('createRuleSet', () => {
        it('invokes createRuleSet without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateRuleSetRequest', ['parent']);
    ...
    describe('getRuleSet', () => {
        it('invokes getRuleSet without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetRuleSetRequest', ['name']);
    ...
    describe('updateRuleSet', () => {
        it('invokes updateRuleSet without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UpdateRuleSetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.contentwarehouse.v1.RuleSet()
    ...
    describe('deleteRuleSet', () => {
        it('invokes deleteRuleSet without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteRuleSetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('processAsyncRuleSets', () => {
        it('invokes processAsyncRuleSets without error', async () => {
            const client = new rulesetserviceModule.v1.RuleSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.contentwarehouse.v1.ProcessAsyncRuleSetsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('ProcessAsyncRuleSetsRequest', ['location']);
            request.location = defaultValue1;
            const expectedHeaderRequestParams = `location=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.contentwarehouse.v1.ProcessAsyncRuleSetsResponse()
            );
            client.innerApiCalls.processAsyncRuleSets = stubSimpleCall(expectedResponse);
            const [response] = await client.processAsyncRuleSets(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.processAsyncRuleSets as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.processAsyncRuleSets as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes processAsyncRuleSets without error using callback', async () => {
            const client = new rulesetserviceModule.v1.RuleSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.processAsyncRuleSets = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.processAsyncRuleSets(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.contentwarehouse.v1.IProcessAsyncRuleSetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes processAsyncRuleSets with error', async () => {
            const client = new rulesetserviceModule.v1.RuleSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `location=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.processAsyncRuleSets = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.processAsyncRuleSets(request), expectedError);
            const actualRequest = (client.innerApiCalls.processAsyncRuleSets as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.processAsyncRuleSets as SinonStub)
        ...
        it('invokes processAsyncRuleSets with closed client', async () => {
            const client = new rulesetserviceModule.v1.RuleSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('listRuleSets', () => {
        it('invokes listRuleSets without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListRuleSetsRequest', ['parent']);
            request.parent = defaultValue1;
