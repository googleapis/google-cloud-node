...
describe('v1.ArtifactRegistryClient', () => {
    ...
    describe('exportArtifact', () => {
        it('invokes exportArtifact without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.devtools.artifactregistry.v1.ExportArtifactRequest', ['repository']);
            request.repository = defaultValue1;
            const expectedHeaderRequestParams = `repository=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.exportArtifact = stubLongRunningCall(expectedResponse);
            const [operation] = await client.exportArtifact(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportArtifact as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.exportArtifact as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes exportArtifact without error using callback', async () => {
            ...
            client.innerApiCalls.exportArtifact = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.exportArtifact(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.devtools.artifactregistry.v1.IExportArtifactResponse, protos.google.devtools.artifactregistry.v1.IExportArtifactMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.devtools.artifactregistry.v1.IExportArtifactResponse, protos.google.devtools.artifactregistry.v1.IExportArtifactMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportArtifact as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes exportArtifact with call error', async () => {
            ...
            const expectedHeaderRequestParams = `repository=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.exportArtifact = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes exportArtifact with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `repository=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.exportArtifact = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.exportArtifact(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.exportArtifact as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkExportArtifactProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkExportArtifactProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkExportArtifactProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkExportArtifactProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
