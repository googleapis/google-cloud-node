...
function main(name) {
  ...
  async function callDeleteReportingDataAnnotation() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await adminClient.deleteReportingDataAnnotation(request);
    console.log(response);
  }

  callDeleteReportingDataAnnotation();
