...
function main(name) {
  // [START analyticsadmin_v1alpha_generated_AnalyticsAdminService_SubmitUserDeletion_async]
  /**
  ...
  async function callSubmitUserDeletion() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await adminClient.submitUserDeletion(request);
    console.log(response);
  }

  callSubmitUserDeletion();
  // [END analyticsadmin_v1alpha_generated_AnalyticsAdminService_SubmitUserDeletion_async]
}
