...
describe('v1alpha.AnalyticsAdminServiceClient', () => {
    ...
    describe('getSKAdNetworkConversionValueSchema', () => {
        it('invokes getSKAdNetworkConversionValueSchema without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.GetSKAdNetworkConversionValueSchemaRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.SKAdNetworkConversionValueSchema()
            );
            client.innerApiCalls.getSkAdNetworkConversionValueSchema = stubSimpleCall(expectedResponse);
            const [response] = await client.getSKAdNetworkConversionValueSchema(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getSkAdNetworkConversionValueSchema as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getSkAdNetworkConversionValueSchema as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getSKAdNetworkConversionValueSchema without error using callback', async () => {
            ...
            client.innerApiCalls.getSkAdNetworkConversionValueSchema = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getSKAdNetworkConversionValueSchema(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.ISKAdNetworkConversionValueSchema|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getSKAdNetworkConversionValueSchema with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getSkAdNetworkConversionValueSchema = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getSKAdNetworkConversionValueSchema(request), expectedError);
            const actualRequest = (client.innerApiCalls.getSkAdNetworkConversionValueSchema as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getSkAdNetworkConversionValueSchema as SinonStub)
    ...
    describe('createSKAdNetworkConversionValueSchema', () => {
        it('invokes createSKAdNetworkConversionValueSchema without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.CreateSKAdNetworkConversionValueSchemaRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.SKAdNetworkConversionValueSchema()
            );
            client.innerApiCalls.createSkAdNetworkConversionValueSchema = stubSimpleCall(expectedResponse);
            const [response] = await client.createSKAdNetworkConversionValueSchema(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createSkAdNetworkConversionValueSchema as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createSkAdNetworkConversionValueSchema as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createSKAdNetworkConversionValueSchema without error using callback', async () => {
            ...
            client.innerApiCalls.createSkAdNetworkConversionValueSchema = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createSKAdNetworkConversionValueSchema with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createSkAdNetworkConversionValueSchema = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createSKAdNetworkConversionValueSchema(request), expectedError);
            const actualRequest = (client.innerApiCalls.createSkAdNetworkConversionValueSchema as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createSkAdNetworkConversionValueSchema as SinonStub)
    ...
    describe('deleteSKAdNetworkConversionValueSchema', () => {
        it('invokes deleteSKAdNetworkConversionValueSchema without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.DeleteSKAdNetworkConversionValueSchemaRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteSkAdNetworkConversionValueSchema = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteSKAdNetworkConversionValueSchema(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteSkAdNetworkConversionValueSchema as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteSkAdNetworkConversionValueSchema as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteSKAdNetworkConversionValueSchema without error using callback', async () => {
            ...
            client.innerApiCalls.deleteSkAdNetworkConversionValueSchema = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteSKAdNetworkConversionValueSchema with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteSkAdNetworkConversionValueSchema = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.deleteSKAdNetworkConversionValueSchema(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteSkAdNetworkConversionValueSchema as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteSkAdNetworkConversionValueSchema as SinonStub)
    ...
    describe('updateSKAdNetworkConversionValueSchema', () => {
        it('invokes updateSKAdNetworkConversionValueSchema without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.UpdateSKAdNetworkConversionValueSchemaRequest', ['skadnetworkConversionValueSchema', 'name']);
            ...
            client.innerApiCalls.updateSkAdNetworkConversionValueSchema = stubSimpleCall(expectedResponse);
            const [response] = await client.updateSKAdNetworkConversionValueSchema(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateSkAdNetworkConversionValueSchema as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateSkAdNetworkConversionValueSchema as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateSKAdNetworkConversionValueSchema without error using callback', async () => {
            ...
            client.innerApiCalls.updateSkAdNetworkConversionValueSchema = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateSKAdNetworkConversionValueSchema with error', async () => {
            ...
            const expectedHeaderRequestParams = `skadnetwork_conversion_value_schema.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateSkAdNetworkConversionValueSchema = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateSKAdNetworkConversionValueSchema(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateSkAdNetworkConversionValueSchema as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateSkAdNetworkConversionValueSchema as SinonStub)
    ...
    describe('updateConversionEvent', () => {
        it('invokes updateConversionEvent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.UpdateConversionEventRequest', ['conversionEvent', 'name']);
            request.conversionEvent.name = defaultValue1;
            const expectedHeaderRequestParams = `conversion_event.name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.ConversionEvent()
            );
            client.innerApiCalls.updateConversionEvent = stubSimpleCall(expectedResponse);
            const [response] = await client.updateConversionEvent(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateConversionEvent as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateConversionEvent as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateConversionEvent without error using callback', async () => {
            ...
            client.innerApiCalls.updateConversionEvent = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateConversionEvent with error', async () => {
            ...
            const expectedHeaderRequestParams = `conversion_event.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateConversionEvent = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateConversionEvent(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateConversionEvent as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateConversionEvent as SinonStub)
    ...
    describe('getSearchAds360Link', () => {
        it('invokes getSearchAds360Link without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.GetSearchAds360LinkRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.SearchAds360Link()
            );
            client.innerApiCalls.getSearchAds360Link = stubSimpleCall(expectedResponse);
            const [response] = await client.getSearchAds360Link(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getSearchAds360Link as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getSearchAds360Link as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getSearchAds360Link without error using callback', async () => {
            ...
            client.innerApiCalls.getSearchAds360Link = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getSearchAds360Link(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.ISearchAds360Link|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getSearchAds360Link with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getSearchAds360Link = stubSimpleCall(undefined, expectedError);
    ...
    describe('createSearchAds360Link', () => {
        it('invokes createSearchAds360Link without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.CreateSearchAds360LinkRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.SearchAds360Link()
            );
            client.innerApiCalls.createSearchAds360Link = stubSimpleCall(expectedResponse);
            const [response] = await client.createSearchAds360Link(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createSearchAds360Link as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createSearchAds360Link as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createSearchAds360Link without error using callback', async () => {
            ...
            client.innerApiCalls.createSearchAds360Link = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createSearchAds360Link with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createSearchAds360Link = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createSearchAds360Link(request), expectedError);
            const actualRequest = (client.innerApiCalls.createSearchAds360Link as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createSearchAds360Link as SinonStub)
    ...
    describe('deleteSearchAds360Link', () => {
        it('invokes deleteSearchAds360Link without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.DeleteSearchAds360LinkRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteSearchAds360Link = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteSearchAds360Link(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteSearchAds360Link as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteSearchAds360Link as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteSearchAds360Link without error using callback', async () => {
            ...
            client.innerApiCalls.deleteSearchAds360Link = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteSearchAds360Link with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteSearchAds360Link = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.deleteSearchAds360Link(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteSearchAds360Link as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteSearchAds360Link as SinonStub)
    ...
    describe('updateSearchAds360Link', () => {
        it('invokes updateSearchAds360Link without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.UpdateSearchAds360LinkRequest', ['searchAds_360Link', 'name']);
            request.searchAds_360Link.name = defaultValue1;
            const expectedHeaderRequestParams = `search_ads_360_link.name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.SearchAds360Link()
            );
            client.innerApiCalls.updateSearchAds360Link = stubSimpleCall(expectedResponse);
            const [response] = await client.updateSearchAds360Link(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateSearchAds360Link as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateSearchAds360Link as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateSearchAds360Link without error using callback', async () => {
            ...
            client.innerApiCalls.updateSearchAds360Link = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateSearchAds360Link with error', async () => {
            ...
            const expectedHeaderRequestParams = `search_ads_360_link.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateSearchAds360Link = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateSearchAds360Link(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateSearchAds360Link as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateSearchAds360Link as SinonStub)
    ...
    describe('createAccessBinding', () => {
        it('invokes createAccessBinding without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.CreateAccessBindingRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.AccessBinding()
            );
            client.innerApiCalls.createAccessBinding = stubSimpleCall(expectedResponse);
            const [response] = await client.createAccessBinding(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createAccessBinding as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createAccessBinding as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createAccessBinding without error using callback', async () => {
            ...
            client.innerApiCalls.createAccessBinding = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createAccessBinding(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.IAccessBinding|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createAccessBinding with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createAccessBinding = stubSimpleCall(undefined, expectedError);
    ...
    describe('getAccessBinding', () => {
        it('invokes getAccessBinding without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.GetAccessBindingRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.AccessBinding()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getAccessBinding as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getAccessBinding as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getAccessBinding without error using callback', async () => {
            ...
            client.innerApiCalls.getAccessBinding = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getAccessBinding with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getAccessBinding = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateAccessBinding', () => {
        it('invokes updateAccessBinding without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.UpdateAccessBindingRequest', ['accessBinding', 'name']);
            request.accessBinding.name = defaultValue1;
            const expectedHeaderRequestParams = `access_binding.name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.AccessBinding()
            );
            client.innerApiCalls.updateAccessBinding = stubSimpleCall(expectedResponse);
            const [response] = await client.updateAccessBinding(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateAccessBinding as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateAccessBinding as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateAccessBinding without error using callback', async () => {
            ...
            client.innerApiCalls.updateAccessBinding = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateAccessBinding with error', async () => {
            ...
            const expectedHeaderRequestParams = `access_binding.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateAccessBinding = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteAccessBinding', () => {
        it('invokes deleteAccessBinding without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.DeleteAccessBindingRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteAccessBinding = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteAccessBinding(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteAccessBinding as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteAccessBinding as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteAccessBinding without error using callback', async () => {
            ...
            client.innerApiCalls.deleteAccessBinding = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteAccessBinding with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteAccessBinding = stubSimpleCall(undefined, expectedError);
    ...
    describe('batchCreateAccessBindings', () => {
        it('invokes batchCreateAccessBindings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.BatchCreateAccessBindingsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.BatchCreateAccessBindingsResponse()
            );
            client.innerApiCalls.batchCreateAccessBindings = stubSimpleCall(expectedResponse);
            const [response] = await client.batchCreateAccessBindings(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchCreateAccessBindings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchCreateAccessBindings as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes batchCreateAccessBindings without error using callback', async () => {
            ...
            client.innerApiCalls.batchCreateAccessBindings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchCreateAccessBindings(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.IBatchCreateAccessBindingsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchCreateAccessBindings with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchCreateAccessBindings = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.batchCreateAccessBindings(request), expectedError);
            const actualRequest = (client.innerApiCalls.batchCreateAccessBindings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchCreateAccessBindings as SinonStub)
    ...
    describe('batchGetAccessBindings', () => {
        it('invokes batchGetAccessBindings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.BatchGetAccessBindingsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.BatchGetAccessBindingsResponse()
            );
            client.innerApiCalls.batchGetAccessBindings = stubSimpleCall(expectedResponse);
            const [response] = await client.batchGetAccessBindings(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchGetAccessBindings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchGetAccessBindings as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes batchGetAccessBindings without error using callback', async () => {
            ...
            client.innerApiCalls.batchGetAccessBindings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchGetAccessBindings(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.IBatchGetAccessBindingsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchGetAccessBindings with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchGetAccessBindings = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.batchGetAccessBindings(request), expectedError);
            const actualRequest = (client.innerApiCalls.batchGetAccessBindings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchGetAccessBindings as SinonStub)
    ...
    describe('batchUpdateAccessBindings', () => {
        it('invokes batchUpdateAccessBindings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.BatchUpdateAccessBindingsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.BatchUpdateAccessBindingsResponse()
            );
            client.innerApiCalls.batchUpdateAccessBindings = stubSimpleCall(expectedResponse);
            const [response] = await client.batchUpdateAccessBindings(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchUpdateAccessBindings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchUpdateAccessBindings as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes batchUpdateAccessBindings without error using callback', async () => {
            ...
            client.innerApiCalls.batchUpdateAccessBindings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchUpdateAccessBindings(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.IBatchUpdateAccessBindingsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchUpdateAccessBindings with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchUpdateAccessBindings = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.batchUpdateAccessBindings(request), expectedError);
            const actualRequest = (client.innerApiCalls.batchUpdateAccessBindings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchUpdateAccessBindings as SinonStub)
    ...
    describe('batchDeleteAccessBindings', () => {
        it('invokes batchDeleteAccessBindings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.BatchDeleteAccessBindingsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.batchDeleteAccessBindings = stubSimpleCall(expectedResponse);
            const [response] = await client.batchDeleteAccessBindings(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchDeleteAccessBindings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchDeleteAccessBindings as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes batchDeleteAccessBindings without error using callback', async () => {
            ...
            client.innerApiCalls.batchDeleteAccessBindings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes batchDeleteAccessBindings with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchDeleteAccessBindings = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.batchDeleteAccessBindings(request), expectedError);
            const actualRequest = (client.innerApiCalls.batchDeleteAccessBindings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchDeleteAccessBindings as SinonStub)
    ...
    describe('getExpandedDataSet', () => {
        it('invokes getExpandedDataSet without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.GetExpandedDataSetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.ExpandedDataSet()
            );
            client.innerApiCalls.getExpandedDataSet = stubSimpleCall(expectedResponse);
            const [response] = await client.getExpandedDataSet(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getExpandedDataSet as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getExpandedDataSet as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getExpandedDataSet without error using callback', async () => {
            ...
            client.innerApiCalls.getExpandedDataSet = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getExpandedDataSet(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.IExpandedDataSet|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getExpandedDataSet with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getExpandedDataSet = stubSimpleCall(undefined, expectedError);
    ...
    describe('createExpandedDataSet', () => {
        it('invokes createExpandedDataSet without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.CreateExpandedDataSetRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.ExpandedDataSet()
            );
            client.innerApiCalls.createExpandedDataSet = stubSimpleCall(expectedResponse);
            const [response] = await client.createExpandedDataSet(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createExpandedDataSet as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createExpandedDataSet as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createExpandedDataSet without error using callback', async () => {
            ...
            client.innerApiCalls.createExpandedDataSet = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createExpandedDataSet with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createExpandedDataSet = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createExpandedDataSet(request), expectedError);
            const actualRequest = (client.innerApiCalls.createExpandedDataSet as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createExpandedDataSet as SinonStub)
    ...
    describe('updateExpandedDataSet', () => {
        it('invokes updateExpandedDataSet without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.UpdateExpandedDataSetRequest', ['expandedDataSet', 'name']);
            request.expandedDataSet.name = defaultValue1;
            const expectedHeaderRequestParams = `expanded_data_set.name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.ExpandedDataSet()
            );
            client.innerApiCalls.updateExpandedDataSet = stubSimpleCall(expectedResponse);
            const [response] = await client.updateExpandedDataSet(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateExpandedDataSet as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateExpandedDataSet as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateExpandedDataSet without error using callback', async () => {
            ...
            client.innerApiCalls.updateExpandedDataSet = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateExpandedDataSet with error', async () => {
            ...
            const expectedHeaderRequestParams = `expanded_data_set.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateExpandedDataSet = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateExpandedDataSet(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateExpandedDataSet as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateExpandedDataSet as SinonStub)
    ...
    describe('deleteExpandedDataSet', () => {
        it('invokes deleteExpandedDataSet without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.DeleteExpandedDataSetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteExpandedDataSet = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteExpandedDataSet(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteExpandedDataSet as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteExpandedDataSet as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteExpandedDataSet without error using callback', async () => {
            ...
            client.innerApiCalls.deleteExpandedDataSet = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteExpandedDataSet with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteExpandedDataSet = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.deleteExpandedDataSet(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteExpandedDataSet as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteExpandedDataSet as SinonStub)
    ...
    describe('getChannelGroup', () => {
        it('invokes getChannelGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.GetChannelGroupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getChannelGroup as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getChannelGroup as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getChannelGroup without error using callback', async () => {
            ...
            client.innerApiCalls.getChannelGroup = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getChannelGroup(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.IChannelGroup|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getChannelGroup with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getChannelGroup = stubSimpleCall(undefined, expectedError);
    ...
    describe('createChannelGroup', () => {
        it('invokes createChannelGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.CreateChannelGroupRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.ChannelGroup()
            );
            client.innerApiCalls.createChannelGroup = stubSimpleCall(expectedResponse);
            const [response] = await client.createChannelGroup(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createChannelGroup as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createChannelGroup as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createChannelGroup without error using callback', async () => {
            ...
            client.innerApiCalls.createChannelGroup = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createChannelGroup with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createChannelGroup = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateChannelGroup', () => {
        it('invokes updateChannelGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.UpdateChannelGroupRequest', ['channelGroup', 'name']);
            request.channelGroup.name = defaultValue1;
            const expectedHeaderRequestParams = `channel_group.name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.ChannelGroup()
            );
            client.innerApiCalls.updateChannelGroup = stubSimpleCall(expectedResponse);
            const [response] = await client.updateChannelGroup(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateChannelGroup as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateChannelGroup as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateChannelGroup without error using callback', async () => {
            ...
            client.innerApiCalls.updateChannelGroup = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateChannelGroup with error', async () => {
            ...
            const expectedHeaderRequestParams = `channel_group.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateChannelGroup = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteChannelGroup', () => {
        it('invokes deleteChannelGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.DeleteChannelGroupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteChannelGroup = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteChannelGroup(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteChannelGroup as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteChannelGroup as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteChannelGroup without error using callback', async () => {
            ...
            client.innerApiCalls.deleteChannelGroup = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteChannelGroup with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteChannelGroup = stubSimpleCall(undefined, expectedError);
    ...
    describe('getBigQueryLink', () => {
        it('invokes getBigQueryLink without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.GetBigQueryLinkRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getBigQueryLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getBigQueryLink as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getBigQueryLink without error using callback', async () => {
            ...
            client.innerApiCalls.getBigQueryLink = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getBigQueryLink(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.IBigQueryLink|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getBigQueryLink with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getBigQueryLink = stubSimpleCall(undefined, expectedError);
    ...
    describe('getEnhancedMeasurementSettings', () => {
        it('invokes getEnhancedMeasurementSettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.GetEnhancedMeasurementSettingsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getEnhancedMeasurementSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getEnhancedMeasurementSettings as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('updateEnhancedMeasurementSettings', () => {
        it('invokes updateEnhancedMeasurementSettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.UpdateEnhancedMeasurementSettingsRequest', ['enhancedMeasurementSettings', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateEnhancedMeasurementSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateEnhancedMeasurementSettings as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('getAdSenseLink', () => {
        it('invokes getAdSenseLink without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.GetAdSenseLinkRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getAdSenseLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getAdSenseLink as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getAdSenseLink without error using callback', async () => {
            ...
            client.innerApiCalls.getAdSenseLink = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAdSenseLink(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.IAdSenseLink|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAdSenseLink with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getAdSenseLink = stubSimpleCall(undefined, expectedError);
    ...
    describe('createAdSenseLink', () => {
        it('invokes createAdSenseLink without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.CreateAdSenseLinkRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.AdSenseLink()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createAdSenseLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createAdSenseLink as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createAdSenseLink without error using callback', async () => {
            ...
            client.innerApiCalls.createAdSenseLink = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createAdSenseLink with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createAdSenseLink = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteAdSenseLink', () => {
        it('invokes deleteAdSenseLink without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.DeleteAdSenseLinkRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteAdSenseLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteAdSenseLink as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteAdSenseLink without error using callback', async () => {
            ...
            client.innerApiCalls.deleteAdSenseLink = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteAdSenseLink with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteAdSenseLink = stubSimpleCall(undefined, expectedError);
    ...
    describe('getEventCreateRule', () => {
        it('invokes getEventCreateRule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.GetEventCreateRuleRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.EventCreateRule()
            );
            client.innerApiCalls.getEventCreateRule = stubSimpleCall(expectedResponse);
            const [response] = await client.getEventCreateRule(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getEventCreateRule as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getEventCreateRule as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getEventCreateRule without error using callback', async () => {
            ...
            client.innerApiCalls.getEventCreateRule = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getEventCreateRule(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.IEventCreateRule|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getEventCreateRule with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getEventCreateRule = stubSimpleCall(undefined, expectedError);
    ...
    describe('createEventCreateRule', () => {
        it('invokes createEventCreateRule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.CreateEventCreateRuleRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.EventCreateRule()
            );
            client.innerApiCalls.createEventCreateRule = stubSimpleCall(expectedResponse);
            const [response] = await client.createEventCreateRule(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createEventCreateRule as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createEventCreateRule as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createEventCreateRule without error using callback', async () => {
            ...
            client.innerApiCalls.createEventCreateRule = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createEventCreateRule with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createEventCreateRule = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createEventCreateRule(request), expectedError);
            const actualRequest = (client.innerApiCalls.createEventCreateRule as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createEventCreateRule as SinonStub)
    ...
    describe('updateEventCreateRule', () => {
        it('invokes updateEventCreateRule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.UpdateEventCreateRuleRequest', ['eventCreateRule', 'name']);
            request.eventCreateRule.name = defaultValue1;
            const expectedHeaderRequestParams = `event_create_rule.name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.EventCreateRule()
            );
            client.innerApiCalls.updateEventCreateRule = stubSimpleCall(expectedResponse);
            const [response] = await client.updateEventCreateRule(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateEventCreateRule as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateEventCreateRule as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateEventCreateRule without error using callback', async () => {
            ...
            client.innerApiCalls.updateEventCreateRule = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateEventCreateRule with error', async () => {
            ...
            const expectedHeaderRequestParams = `event_create_rule.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateEventCreateRule = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateEventCreateRule(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateEventCreateRule as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateEventCreateRule as SinonStub)
    ...
    describe('deleteEventCreateRule', () => {
        it('invokes deleteEventCreateRule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.DeleteEventCreateRuleRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteEventCreateRule = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteEventCreateRule(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteEventCreateRule as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteEventCreateRule as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteEventCreateRule without error using callback', async () => {
            ...
            client.innerApiCalls.deleteEventCreateRule = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteEventCreateRule with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteEventCreateRule = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.deleteEventCreateRule(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteEventCreateRule as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteEventCreateRule as SinonStub)
    ...
    describe('updateDataRedactionSettings', () => {
        it('invokes updateDataRedactionSettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.UpdateDataRedactionSettingsRequest', ['dataRedactionSettings', 'name']);
            ...
            client.innerApiCalls.updateDataRedactionSettings = stubSimpleCall(expectedResponse);
            const [response] = await client.updateDataRedactionSettings(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateDataRedactionSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateDataRedactionSettings as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateDataRedactionSettings without error using callback', async () => {
            ...
            client.innerApiCalls.updateDataRedactionSettings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateDataRedactionSettings(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.IDataRedactionSettings|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes updateDataRedactionSettings with error', async () => {
            ...
            const expectedHeaderRequestParams = `data_redaction_settings.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateDataRedactionSettings = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateDataRedactionSettings(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateDataRedactionSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateDataRedactionSettings as SinonStub)
    ...
    describe('getDataRedactionSettings', () => {
        it('invokes getDataRedactionSettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.GetDataRedactionSettingsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.DataRedactionSettings()
            );
            client.innerApiCalls.getDataRedactionSettings = stubSimpleCall(expectedResponse);
            const [response] = await client.getDataRedactionSettings(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getDataRedactionSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDataRedactionSettings as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getDataRedactionSettings without error using callback', async () => {
            ...
            client.innerApiCalls.getDataRedactionSettings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getDataRedactionSettings with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getDataRedactionSettings = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getDataRedactionSettings(request), expectedError);
            const actualRequest = (client.innerApiCalls.getDataRedactionSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDataRedactionSettings as SinonStub)
    ...
    describe('createRollupProperty', () => {
        it('invokes createRollupProperty without error', async () => {
            ...
            client.innerApiCalls.createRollupProperty = stubSimpleCall(expectedResponse);
        ...
        it('invokes createRollupProperty without error using callback', async () => {
            ...
            client.innerApiCalls.createRollupProperty = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createRollupProperty(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.ICreateRollupPropertyResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createRollupProperty with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.createRollupProperty = stubSimpleCall(undefined, expectedError);
    ...
    describe('getRollupPropertySourceLink', () => {
        it('invokes getRollupPropertySourceLink without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.GetRollupPropertySourceLinkRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.RollupPropertySourceLink()
            );
            client.innerApiCalls.getRollupPropertySourceLink = stubSimpleCall(expectedResponse);
            const [response] = await client.getRollupPropertySourceLink(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getRollupPropertySourceLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getRollupPropertySourceLink as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getRollupPropertySourceLink without error using callback', async () => {
            ...
            client.innerApiCalls.getRollupPropertySourceLink = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getRollupPropertySourceLink(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.IRollupPropertySourceLink|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getRollupPropertySourceLink with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getRollupPropertySourceLink = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getRollupPropertySourceLink(request), expectedError);
            const actualRequest = (client.innerApiCalls.getRollupPropertySourceLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getRollupPropertySourceLink as SinonStub)
    ...
    describe('createRollupPropertySourceLink', () => {
        it('invokes createRollupPropertySourceLink without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.CreateRollupPropertySourceLinkRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.RollupPropertySourceLink()
            );
            client.innerApiCalls.createRollupPropertySourceLink = stubSimpleCall(expectedResponse);
            const [response] = await client.createRollupPropertySourceLink(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createRollupPropertySourceLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createRollupPropertySourceLink as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createRollupPropertySourceLink without error using callback', async () => {
            ...
            client.innerApiCalls.createRollupPropertySourceLink = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createRollupPropertySourceLink with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createRollupPropertySourceLink = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createRollupPropertySourceLink(request), expectedError);
            const actualRequest = (client.innerApiCalls.createRollupPropertySourceLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createRollupPropertySourceLink as SinonStub)
    ...
    describe('deleteRollupPropertySourceLink', () => {
        it('invokes deleteRollupPropertySourceLink without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.DeleteRollupPropertySourceLinkRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteRollupPropertySourceLink = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteRollupPropertySourceLink(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteRollupPropertySourceLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteRollupPropertySourceLink as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteRollupPropertySourceLink without error using callback', async () => {
            ...
            client.innerApiCalls.deleteRollupPropertySourceLink = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteRollupPropertySourceLink with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteRollupPropertySourceLink = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.deleteRollupPropertySourceLink(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteRollupPropertySourceLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteRollupPropertySourceLink as SinonStub)
    ...
    describe('createSubproperty', () => {
        ...
        it('invokes createSubproperty without error using callback', async () => {
            ...
            client.innerApiCalls.createSubproperty = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createSubproperty(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.ICreateSubpropertyResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createSubproperty with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.createSubproperty = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteSubpropertyEventFilter', () => {
        it('invokes deleteSubpropertyEventFilter without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.DeleteSubpropertyEventFilterRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteSubpropertyEventFilter = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteSubpropertyEventFilter(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteSubpropertyEventFilter as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteSubpropertyEventFilter as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteSubpropertyEventFilter without error using callback', async () => {
            ...
            client.innerApiCalls.deleteSubpropertyEventFilter = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteSubpropertyEventFilter with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteSubpropertyEventFilter = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.deleteSubpropertyEventFilter(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteSubpropertyEventFilter as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteSubpropertyEventFilter as SinonStub)
    ...
    describe('createSubpropertyEventFilter', () => {
        it('invokes createSubpropertyEventFilter without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.CreateSubpropertyEventFilterRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.SubpropertyEventFilter()
            );
            client.innerApiCalls.createSubpropertyEventFilter = stubSimpleCall(expectedResponse);
            const [response] = await client.createSubpropertyEventFilter(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createSubpropertyEventFilter as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createSubpropertyEventFilter as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createSubpropertyEventFilter without error using callback', async () => {
            ...
            client.innerApiCalls.createSubpropertyEventFilter = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createSubpropertyEventFilter(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.ISubpropertyEventFilter|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createSubpropertyEventFilter with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createSubpropertyEventFilter = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createSubpropertyEventFilter(request), expectedError);
            const actualRequest = (client.innerApiCalls.createSubpropertyEventFilter as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createSubpropertyEventFilter as SinonStub)
    ...
    describe('listSKAdNetworkConversionValueSchemas', () => {
        it('invokes listSKAdNetworkConversionValueSchemas without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.ListSKAdNetworkConversionValueSchemasRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.SKAdNetworkConversionValueSchema()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.SKAdNetworkConversionValueSchema()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.SKAdNetworkConversionValueSchema()),
            ];
            client.innerApiCalls.listSkAdNetworkConversionValueSchemas = stubSimpleCall(expectedResponse);
            const [response] = await client.listSKAdNetworkConversionValueSchemas(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listSkAdNetworkConversionValueSchemas as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listSkAdNetworkConversionValueSchemas as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listSKAdNetworkConversionValueSchemas without error using callback', async () => {
            ...
            client.innerApiCalls.listSkAdNetworkConversionValueSchemas = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listSKAdNetworkConversionValueSchemas with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listSkAdNetworkConversionValueSchemas = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listSKAdNetworkConversionValueSchemas(request), expectedError);
            const actualRequest = (client.innerApiCalls.listSkAdNetworkConversionValueSchemas as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listSkAdNetworkConversionValueSchemas as SinonStub)
        ...
        it('invokes listSKAdNetworkConversionValueSchemasStream without error', async () => {
            ...
            client.descriptors.page.listSKAdNetworkConversionValueSchemas.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listSKAdNetworkConversionValueSchemasStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.analytics.admin.v1alpha.SKAdNetworkConversionValueSchema[] = [];
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.SKAdNetworkConversionValueSchema) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listSKAdNetworkConversionValueSchemas.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listSkAdNetworkConversionValueSchemas, request));
            assert(
                (client.descriptors.page.listSKAdNetworkConversionValueSchemas.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listSKAdNetworkConversionValueSchemasStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listSKAdNetworkConversionValueSchemas.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listSKAdNetworkConversionValueSchemasStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.analytics.admin.v1alpha.SKAdNetworkConversionValueSchema[] = [];
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.SKAdNetworkConversionValueSchema) => {
        ...
        it('uses async iteration with listSKAdNetworkConversionValueSchemas without error', async () => {
            ...
            client.descriptors.page.listSKAdNetworkConversionValueSchemas.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.analytics.admin.v1alpha.ISKAdNetworkConversionValueSchema[] = [];
            const iterable = client.listSKAdNetworkConversionValueSchemasAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listSKAdNetworkConversionValueSchemas.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listSKAdNetworkConversionValueSchemas.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listSKAdNetworkConversionValueSchemas with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listSKAdNetworkConversionValueSchemas.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listSKAdNetworkConversionValueSchemasAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.analytics.admin.v1alpha.ISKAdNetworkConversionValueSchema[] = [];
                for await (const resource of iterable) {
    ...
    describe('listSearchAds360Links', () => {
        it('invokes listSearchAds360Links without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.ListSearchAds360LinksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.SearchAds360Link()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.SearchAds360Link()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.SearchAds360Link()),
            ];
            client.innerApiCalls.listSearchAds360Links = stubSimpleCall(expectedResponse);
            const [response] = await client.listSearchAds360Links(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listSearchAds360Links as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listSearchAds360Links as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listSearchAds360Links without error using callback', async () => {
            ...
            client.innerApiCalls.listSearchAds360Links = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listSearchAds360Links with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listSearchAds360Links = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listSearchAds360Links(request), expectedError);
            const actualRequest = (client.innerApiCalls.listSearchAds360Links as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listSearchAds360Links as SinonStub)
        ...
        it('invokes listSearchAds360LinksStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.SearchAds360Link) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listSearchAds360Links.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listSearchAds360Links, request));
            assert(
                (client.descriptors.page.listSearchAds360Links.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listSearchAds360LinksStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listSearchAds360Links.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listSearchAds360LinksStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.analytics.admin.v1alpha.SearchAds360Link[] = [];
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.SearchAds360Link) => {
        ...
        it('uses async iteration with listSearchAds360Links without error', async () => {
            ...
            client.descriptors.page.listSearchAds360Links.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listSearchAds360Links.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listSearchAds360Links.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listSearchAds360Links with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listSearchAds360Links.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listSearchAds360LinksAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.analytics.admin.v1alpha.ISearchAds360Link[] = [];
                for await (const resource of iterable) {
    ...
    describe('listAccessBindings', () => {
        it('invokes listAccessBindings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.ListAccessBindingsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.AccessBinding()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.AccessBinding()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.AccessBinding()),
            ];
            client.innerApiCalls.listAccessBindings = stubSimpleCall(expectedResponse);
            const [response] = await client.listAccessBindings(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listAccessBindings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAccessBindings as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listAccessBindings without error using callback', async () => {
            ...
            client.innerApiCalls.listAccessBindings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listAccessBindings with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listAccessBindings = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listAccessBindingsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.AccessBinding) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listAccessBindings.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listAccessBindings, request));
            assert(
        ...
        it('invokes listAccessBindingsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAccessBindings.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listAccessBindingsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.analytics.admin.v1alpha.AccessBinding[] = [];
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.AccessBinding) => {
        ...
        it('uses async iteration with listAccessBindings without error', async () => {
            ...
            client.descriptors.page.listAccessBindings.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listAccessBindings with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAccessBindings.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listAccessBindingsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.analytics.admin.v1alpha.IAccessBinding[] = [];
                for await (const resource of iterable) {
    ...
    describe('listExpandedDataSets', () => {
        it('invokes listExpandedDataSets without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.ListExpandedDataSetsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.ExpandedDataSet()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.ExpandedDataSet()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.ExpandedDataSet()),
            ];
            client.innerApiCalls.listExpandedDataSets = stubSimpleCall(expectedResponse);
            const [response] = await client.listExpandedDataSets(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listExpandedDataSets as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listExpandedDataSets as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listExpandedDataSets without error using callback', async () => {
            ...
            client.innerApiCalls.listExpandedDataSets = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listExpandedDataSets with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listExpandedDataSets = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listExpandedDataSetsStream without error', async () => {
            ...
            client.descriptors.page.listExpandedDataSets.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.ExpandedDataSet) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listExpandedDataSets.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listExpandedDataSets, request));
            assert(
        ...
        it('invokes listExpandedDataSetsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listExpandedDataSets.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listExpandedDataSetsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.analytics.admin.v1alpha.ExpandedDataSet[] = [];
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.ExpandedDataSet) => {
        ...
        it('uses async iteration with listExpandedDataSets without error', async () => {
            ...
            client.descriptors.page.listExpandedDataSets.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listExpandedDataSets with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listExpandedDataSets.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listExpandedDataSetsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.analytics.admin.v1alpha.IExpandedDataSet[] = [];
                for await (const resource of iterable) {
    ...
    describe('listChannelGroups', () => {
        it('invokes listChannelGroups without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.ListChannelGroupsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.ChannelGroup()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.ChannelGroup()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.ChannelGroup()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listChannelGroups as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listChannelGroups as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listChannelGroups without error using callback', async () => {
            ...
            client.innerApiCalls.listChannelGroups = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listChannelGroups with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listChannelGroups = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listChannelGroupsStream without error', async () => {
            ...
            client.descriptors.page.listChannelGroups.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listChannelGroupsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.analytics.admin.v1alpha.ChannelGroup[] = [];
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.ChannelGroup) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listChannelGroups.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listChannelGroups, request));
            assert(
        ...
        it('invokes listChannelGroupsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listChannelGroups.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listChannelGroupsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.analytics.admin.v1alpha.ChannelGroup[] = [];
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.ChannelGroup) => {
        ...
        it('uses async iteration with listChannelGroups without error', async () => {
            ...
            client.descriptors.page.listChannelGroups.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listChannelGroups with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listChannelGroups.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listChannelGroupsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.analytics.admin.v1alpha.IChannelGroup[] = [];
                for await (const resource of iterable) {
    ...
    describe('listBigQueryLinks', () => {
        it('invokes listBigQueryLinks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.ListBigQueryLinksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.BigQueryLink()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.BigQueryLink()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.BigQueryLink()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listBigQueryLinks as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listBigQueryLinks as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listBigQueryLinks without error using callback', async () => {
            ...
            client.innerApiCalls.listBigQueryLinks = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listBigQueryLinks with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listBigQueryLinks = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listBigQueryLinksStream without error', async () => {
            ...
            client.descriptors.page.listBigQueryLinks.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listBigQueryLinksStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.analytics.admin.v1alpha.BigQueryLink[] = [];
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.BigQueryLink) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listBigQueryLinks.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listBigQueryLinks, request));
            assert(
        ...
        it('invokes listBigQueryLinksStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listBigQueryLinks.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listBigQueryLinksStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.analytics.admin.v1alpha.BigQueryLink[] = [];
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.BigQueryLink) => {
        ...
        it('uses async iteration with listBigQueryLinks without error', async () => {
            ...
            client.descriptors.page.listBigQueryLinks.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listBigQueryLinks with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listBigQueryLinks.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listBigQueryLinksAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.analytics.admin.v1alpha.IBigQueryLink[] = [];
                for await (const resource of iterable) {
    ...
    describe('listAdSenseLinks', () => {
        it('invokes listAdSenseLinks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.ListAdSenseLinksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.AdSenseLink()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.AdSenseLink()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.AdSenseLink()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listAdSenseLinks as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAdSenseLinks as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listAdSenseLinks without error using callback', async () => {
            ...
            client.innerApiCalls.listAdSenseLinks = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listAdSenseLinks with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listAdSenseLinks = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listAdSenseLinksStream without error', async () => {
            ...
            client.descriptors.page.listAdSenseLinks.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listAdSenseLinksStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.analytics.admin.v1alpha.AdSenseLink[] = [];
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.AdSenseLink) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listAdSenseLinks.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listAdSenseLinks, request));
            assert(
        ...
        it('invokes listAdSenseLinksStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAdSenseLinks.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listAdSenseLinksStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.analytics.admin.v1alpha.AdSenseLink[] = [];
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.AdSenseLink) => {
        ...
        it('uses async iteration with listAdSenseLinks without error', async () => {
            ...
            client.descriptors.page.listAdSenseLinks.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listAdSenseLinks with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAdSenseLinks.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listAdSenseLinksAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.analytics.admin.v1alpha.IAdSenseLink[] = [];
                for await (const resource of iterable) {
    ...
    describe('listEventCreateRules', () => {
        it('invokes listEventCreateRules without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.ListEventCreateRulesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.EventCreateRule()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.EventCreateRule()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.EventCreateRule()),
            ];
            client.innerApiCalls.listEventCreateRules = stubSimpleCall(expectedResponse);
            const [response] = await client.listEventCreateRules(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listEventCreateRules as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listEventCreateRules as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listEventCreateRules without error using callback', async () => {
            ...
            client.innerApiCalls.listEventCreateRules = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listEventCreateRules with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listEventCreateRules = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listEventCreateRulesStream without error', async () => {
            ...
            client.descriptors.page.listEventCreateRules.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.EventCreateRule) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listEventCreateRules.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listEventCreateRules, request));
            assert(
        ...
        it('invokes listEventCreateRulesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listEventCreateRules.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listEventCreateRulesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.analytics.admin.v1alpha.EventCreateRule[] = [];
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.EventCreateRule) => {
        ...
        it('uses async iteration with listEventCreateRules without error', async () => {
            ...
            client.descriptors.page.listEventCreateRules.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listEventCreateRules with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listEventCreateRules.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listEventCreateRulesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.analytics.admin.v1alpha.IEventCreateRule[] = [];
                for await (const resource of iterable) {
    ...
    describe('listRollupPropertySourceLinks', () => {
        it('invokes listRollupPropertySourceLinks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.ListRollupPropertySourceLinksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.RollupPropertySourceLink()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.RollupPropertySourceLink()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.RollupPropertySourceLink()),
            ];
            client.innerApiCalls.listRollupPropertySourceLinks = stubSimpleCall(expectedResponse);
            const [response] = await client.listRollupPropertySourceLinks(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listRollupPropertySourceLinks as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listRollupPropertySourceLinks as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listRollupPropertySourceLinks without error using callback', async () => {
            ...
            client.innerApiCalls.listRollupPropertySourceLinks = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listRollupPropertySourceLinks with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listRollupPropertySourceLinks = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listRollupPropertySourceLinks(request), expectedError);
            const actualRequest = (client.innerApiCalls.listRollupPropertySourceLinks as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listRollupPropertySourceLinks as SinonStub)
        ...
        it('invokes listRollupPropertySourceLinksStream without error', async () => {
            ...
            client.descriptors.page.listRollupPropertySourceLinks.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.RollupPropertySourceLink) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listRollupPropertySourceLinks.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listRollupPropertySourceLinks, request));
            assert(
                (client.descriptors.page.listRollupPropertySourceLinks.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listRollupPropertySourceLinksStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listRollupPropertySourceLinks.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listRollupPropertySourceLinksStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.analytics.admin.v1alpha.RollupPropertySourceLink[] = [];
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.RollupPropertySourceLink) => {
        ...
        it('uses async iteration with listRollupPropertySourceLinks without error', async () => {
            ...
            client.descriptors.page.listRollupPropertySourceLinks.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listRollupPropertySourceLinks.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listRollupPropertySourceLinks.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listRollupPropertySourceLinks with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listRollupPropertySourceLinks.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listRollupPropertySourceLinksAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.analytics.admin.v1alpha.IRollupPropertySourceLink[] = [];
                for await (const resource of iterable) {
    ...
    describe('Path templates', () => {
        ...
        describe('accountAccessBinding', () => {
            ...
            client.initialize();
            client.pathTemplates.accountAccessBindingPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.accountAccessBindingPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('accountAccessBindingPath', () => {
                const result = client.accountAccessBindingPath("accountValue", "accessBindingValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.accountAccessBindingPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchAccountFromAccountAccessBindingName', () => {
                const result = client.matchAccountFromAccountAccessBindingName(fakePath);
                assert.strictEqual(result, "accountValue");
                assert((client.pathTemplates.accountAccessBindingPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchAccessBindingFromAccountAccessBindingName', () => {
                const result = client.matchAccessBindingFromAccountAccessBindingName(fakePath);
        ...
        describe('adSenseLink', () => {
            ...
            client.initialize();
            client.pathTemplates.adSenseLinkPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.adSenseLinkPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('adSenseLinkPath', () => {
                const result = client.adSenseLinkPath("propertyValue", "adsenseLinkValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.adSenseLinkPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchPropertyFromAdSenseLinkName', () => {
                ...
                assert((client.pathTemplates.adSenseLinkPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('bigQueryLink', () => {
            ...
            client.initialize();
            client.pathTemplates.bigQueryLinkPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.bigQueryLinkPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('bigQueryLinkPath', () => {
                const result = client.bigQueryLinkPath("propertyValue", "bigqueryLinkValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.bigQueryLinkPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchPropertyFromBigQueryLinkName', () => {
                ...
                assert.strictEqual(result, "propertyValue");
                assert((client.pathTemplates.bigQueryLinkPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('channelGroup', () => {
            ...
            client.initialize();
            client.pathTemplates.channelGroupPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.channelGroupPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('channelGroupPath', () => {
                const result = client.channelGroupPath("propertyValue", "channelGroupValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.channelGroupPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchPropertyFromChannelGroupName', () => {
                ...
                assert.strictEqual(result, "propertyValue");
                assert((client.pathTemplates.channelGroupPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('dataRedactionSettings', () => {
            ...
            client.initialize();
            client.pathTemplates.dataRedactionSettingsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.dataRedactionSettingsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('dataRedactionSettingsPath', () => {
                const result = client.dataRedactionSettingsPath("propertyValue", "dataStreamValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.dataRedactionSettingsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchPropertyFromDataRedactionSettingsName', () => {
                const result = client.matchPropertyFromDataRedactionSettingsName(fakePath);
                assert.strictEqual(result, "propertyValue");
                assert((client.pathTemplates.dataRedactionSettingsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchDataStreamFromDataRedactionSettingsName', () => {
                const result = client.matchDataStreamFromDataRedactionSettingsName(fakePath);
        ...
        describe('enhancedMeasurementSettings', () => {
            ...
            it('matchDataStreamFromEnhancedMeasurementSettingsName', () => {
                const result = client.matchDataStreamFromEnhancedMeasurementSettingsName(fakePath);
                assert.strictEqual(result, "dataStreamValue");
                assert((client.pathTemplates.enhancedMeasurementSettingsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('eventCreateRule', () => {
            ...
            client.initialize();
            client.pathTemplates.eventCreateRulePathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.eventCreateRulePathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('eventCreateRulePath', () => {
                const result = client.eventCreateRulePath("propertyValue", "dataStreamValue", "eventCreateRuleValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.eventCreateRulePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchPropertyFromEventCreateRuleName', () => {
                ...
                assert.strictEqual(result, "propertyValue");
                assert((client.pathTemplates.eventCreateRulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchEventCreateRuleFromEventCreateRuleName', () => {
                const result = client.matchEventCreateRuleFromEventCreateRuleName(fakePath);
        ...
        describe('expandedDataSet', () => {
            ...
            client.initialize();
            client.pathTemplates.expandedDataSetPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.expandedDataSetPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('expandedDataSetPath', () => {
                const result = client.expandedDataSetPath("propertyValue", "expandedDataSetValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.expandedDataSetPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchPropertyFromExpandedDataSetName', () => {
                ...
                assert.strictEqual(result, "propertyValue");
                assert((client.pathTemplates.expandedDataSetPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchExpandedDataSetFromExpandedDataSetName', () => {
                const result = client.matchExpandedDataSetFromExpandedDataSetName(fakePath);
        ...
        describe('propertyAccessBinding', () => {
            ...
            client.initialize();
            client.pathTemplates.propertyAccessBindingPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.propertyAccessBindingPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('propertyAccessBindingPath', () => {
                const result = client.propertyAccessBindingPath("propertyValue", "accessBindingValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.propertyAccessBindingPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchPropertyFromPropertyAccessBindingName', () => {
                const result = client.matchPropertyFromPropertyAccessBindingName(fakePath);
                assert.strictEqual(result, "propertyValue");
                assert((client.pathTemplates.propertyAccessBindingPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchAccessBindingFromPropertyAccessBindingName', () => {
                const result = client.matchAccessBindingFromPropertyAccessBindingName(fakePath);
                assert.strictEqual(result, "accessBindingValue");
                assert((client.pathTemplates.propertyAccessBindingPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('rollupPropertySourceLink', () => {
            ...
            client.initialize();
            client.pathTemplates.rollupPropertySourceLinkPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.rollupPropertySourceLinkPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('rollupPropertySourceLinkPath', () => {
                const result = client.rollupPropertySourceLinkPath("propertyValue", "rollupPropertySourceLinkValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.rollupPropertySourceLinkPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchPropertyFromRollupPropertySourceLinkName', () => {
                const result = client.matchPropertyFromRollupPropertySourceLinkName(fakePath);
                assert.strictEqual(result, "propertyValue");
                assert((client.pathTemplates.rollupPropertySourceLinkPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchRollupPropertySourceLinkFromRollupPropertySourceLinkName', () => {
                const result = client.matchRollupPropertySourceLinkFromRollupPropertySourceLinkName(fakePath);
        ...
        describe('sKAdNetworkConversionValueSchema', () => {
            ...
            const expectedParameters = {
                property: "propertyValue",
                data_stream: "dataStreamValue",
                skadnetwork_conversion_value_schema: "skadnetworkConversionValueSchemaValue",
            };
            const client = new analyticsadminserviceModule.v1alpha.AnalyticsAdminServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            ...
            it('sKAdNetworkConversionValueSchemaPath', () => {
                const result = client.sKAdNetworkConversionValueSchemaPath("propertyValue", "dataStreamValue", "skadnetworkConversionValueSchemaValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.sKAdNetworkConversionValueSchemaPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchPropertyFromSKAdNetworkConversionValueSchemaName', () => {
                const result = client.matchPropertyFromSKAdNetworkConversionValueSchemaName(fakePath);
                assert.strictEqual(result, "propertyValue");
                assert((client.pathTemplates.sKAdNetworkConversionValueSchemaPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchDataStreamFromSKAdNetworkConversionValueSchemaName', () => {
                const result = client.matchDataStreamFromSKAdNetworkConversionValueSchemaName(fakePath);
                assert.strictEqual(result, "dataStreamValue");
                assert((client.pathTemplates.sKAdNetworkConversionValueSchemaPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchSkadnetworkConversionValueSchemaFromSKAdNetworkConversionValueSchemaName', () => {
                const result = client.matchSkadnetworkConversionValueSchemaFromSKAdNetworkConversionValueSchemaName(fakePath);
        ...
        describe('searchAds360Link', () => {
            ...
            client.initialize();
            client.pathTemplates.searchAds360LinkPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.searchAds360LinkPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('searchAds360LinkPath', () => {
                const result = client.searchAds360LinkPath("propertyValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.searchAds360LinkPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchPropertyFromSearchAds360LinkName', () => {
                ...
                assert.strictEqual(result, "propertyValue");
                assert((client.pathTemplates.searchAds360LinkPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
        ...
        describe('subpropertyEventFilter', () => {
            ...
            client.initialize();
            client.pathTemplates.subpropertyEventFilterPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.subpropertyEventFilterPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('subpropertyEventFilterPath', () => {
                const result = client.subpropertyEventFilterPath("propertyValue", "subPropertyEventFilterValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.subpropertyEventFilterPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchPropertyFromSubpropertyEventFilterName', () => {
                const result = client.matchPropertyFromSubpropertyEventFilterName(fakePath);
                assert.strictEqual(result, "propertyValue");
                assert((client.pathTemplates.subpropertyEventFilterPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchSubPropertyEventFilterFromSubpropertyEventFilterName', () => {
                const result = client.matchSubPropertyEventFilterFromSubpropertyEventFilterName(fakePath);
