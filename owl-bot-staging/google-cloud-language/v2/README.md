...
* [Language Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/language/latest)
* [Language Documentation](https://cloud.google.com/natural-language/docs)
