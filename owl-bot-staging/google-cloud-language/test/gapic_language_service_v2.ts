...
describe('v2.LanguageServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = languageserviceModule.v2.LanguageServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = languageserviceModule.v2.LanguageServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'language.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new languageserviceModule.v2.LanguageServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'language.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new languageserviceModule.v2.LanguageServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'language.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new languageserviceModule.v2.LanguageServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new languageserviceModule.v2.LanguageServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
        ...
        it('invokes analyzeSentiment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.analyzeSentiment(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.language.v2.IAnalyzeSentimentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes analyzeEntities without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.analyzeEntities(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.language.v2.IAnalyzeEntitiesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('classifyText', () => {
        ...
        it('invokes classifyText without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.classifyText(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.language.v2.IClassifyTextResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('moderateText', () => {
        ...
        it('invokes moderateText without error using callback', async () => {
            ...
            client.innerApiCalls.moderateText = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.moderateText(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.language.v2.IModerateTextResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes moderateText with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.moderateText = stubSimpleCall(undefined, expectedError);
    ...
    describe('annotateText', () => {
        ...
        it('invokes annotateText without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.annotateText(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.language.v2.IAnnotateTextResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
