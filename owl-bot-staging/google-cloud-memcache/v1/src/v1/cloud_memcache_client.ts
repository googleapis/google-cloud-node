...
export class CloudMemcacheClient {
   ...
   *     const client = new CloudMemcacheClient({fallback: 'rest'}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const createInstanceResponse = protoFilesRoot.lookup(
      '.google.cloud.memcache.v1.Instance') as gax.protobuf.Type;
    const createInstanceMetadata = protoFilesRoot.lookup(
      '.google.cloud.memcache.v1.OperationMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.memcache.v1.CloudMemcache', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.cloudMemcacheStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.memcache.v1.CloudMemcache') :
    ...
    const cloudMemcacheStubMethods =
        ['listInstances', 'getInstance', 'createInstance', 'updateInstance', 'updateParameters', 'deleteInstance', 'applyParameters', 'rescheduleMaintenance'];
 ...
 *   The first element of the array is an object representing {@link google.cloud.memcache.v1.Instance | Instance}.
 *   Please see the
 ...
 */
  getInstance(
      ...
      Promise<[
        ...
        protos.google.cloud.memcache.v1.IGetInstanceRequest|undefined, {}|undefined
      ]>;
  getInstance(
      request: protos.google.cloud.memcache.v1.IGetInstanceRequest,
      options: CallOptions,
 ...
 */
  async checkCreateInstanceProgress(name: string): Promise<LROperation<protos.google.cloud.memcache.v1.Instance, protos.google.cloud.memcache.v1.OperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.memcache.v1.Instance, protos.google.cloud.memcache.v1.OperationMetadata>;
  }
/**
 ...
 */
  async checkUpdateParametersProgress(name: string): Promise<LROperation<protos.google.cloud.memcache.v1.Instance, protos.google.cloud.memcache.v1.OperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.updateParameters, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.memcache.v1.Instance, protos.google.cloud.memcache.v1.OperationMetadata>;
  }
/**
 ...
 */
  async checkDeleteInstanceProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.memcache.v1.OperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.protobuf.Empty, protos.google.cloud.memcache.v1.OperationMetadata>;
  }
/**
 ...
 */
  async checkApplyParametersProgress(name: string): Promise<LROperation<protos.google.cloud.memcache.v1.Instance, protos.google.cloud.memcache.v1.OperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.applyParameters, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.memcache.v1.Instance, protos.google.cloud.memcache.v1.OperationMetadata>;
  }
/**
 ...
 * region_tag:memcache_v1_generated_CloudMemcache_RescheduleMaintenance_async
 */
  async checkRescheduleMaintenanceProgress(name: string): Promise<LROperation<protos.google.cloud.memcache.v1.Instance, protos.google.cloud.memcache.v1.OperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link google.cloud.memcache.v1.Instance | Instance}.
 ...
 */
  ...
  listInstances(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.memcache.v1.IInstance>): void;
  listInstances(
      request: protos.google.cloud.memcache.v1.IListInstancesRequest,
      callback: PaginationCallback<
          protos.google.cloud.memcache.v1.IListInstancesRequest,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link google.cloud.memcache.v1.Instance | Instance} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   {@link google.cloud.memcache.v1.Instance | Instance}. The API will be called under the hood as needed, once per the page,
