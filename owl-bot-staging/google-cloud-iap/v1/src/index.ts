...
export {v1, IdentityAwareProxyAdminServiceClient, IdentityAwareProxyOAuthServiceClient};
export default {v1, IdentityAwareProxyAdminServiceClient, IdentityAwareProxyOAuthServiceClient};
