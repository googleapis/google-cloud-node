...
function main(parent) {
  // [START admanager_v1_generated_OrderService_ListOrders_async]
  /**
  ...
  async function callListOrders() {
    ...
    // Run request
    const iterable = admanagerClient.listOrdersAsync(request);
  ...
  callListOrders();
  // [END admanager_v1_generated_OrderService_ListOrders_async]
}
