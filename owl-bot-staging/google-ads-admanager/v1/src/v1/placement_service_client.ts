 ...
 * `src/v1/placement_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './placement_service_client_config.json';
...
export class PlacementServiceClient {
  ...
  initialize() {
    ...
    if (this.placementServiceStub) {
      return this.placementServiceStub;
    }
 ...
 */
  listPlacementsAsync(
    ...
    return this.descriptors.page.listPlacements.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.ads.admanager.v1.IPlacement>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
