 ...
 * `src/v1/role_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './role_service_client_config.json';
...
export class RoleServiceClient {
  ...
  roleServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of RoleServiceClient.
   *
  ...
  initialize() {
    ...
    if (this.roleServiceStub) {
      return this.roleServiceStub;
    }
 ...
 */
  listRolesAsync(
    ...
    return this.descriptors.page.listRoles.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.ads.admanager.v1.IRole>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
