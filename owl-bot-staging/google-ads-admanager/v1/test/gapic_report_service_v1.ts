  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = reportserviceModule.v1.ReportServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = reportserviceModule.v1.ReportServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new reportserviceModule.v1.ReportServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new reportserviceModule.v1.ReportServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new reportserviceModule.v1.ReportServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new reportserviceModule.v1.ReportServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getReport', () => {
        it('invokes getReport without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetReportRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getReport as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getReport as SinonStub)
        ...
        it('invokes getReport without error using callback', async () => {
            ...
            client.innerApiCalls.getReport = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getReport(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IReport|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createReport', () => {
        it('invokes createReport without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.CreateReportRequest', ['parent']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createReport as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createReport as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createReport without error using callback', async () => {
            ...
            client.innerApiCalls.createReport = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createReport(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IReport|null) => {
        ...
        it('invokes createReport with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createReport = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateReport', () => {
        it('invokes updateReport without error', async () => {
            ...
            request.report ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.UpdateReportRequest', ['report', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateReport as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateReport as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateReport without error using callback', async () => {
            ...
            client.innerApiCalls.updateReport = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateReport(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IReport|null) => {
        ...
        it('invokes updateReport with error', async () => {
            ...
            const expectedHeaderRequestParams = `report.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateReport = stubSimpleCall(undefined, expectedError);
    ...
    describe('runReport', () => {
        it('invokes runReport without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.RunReportRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes runReport without error using callback', async () => {
            ...
            client.innerApiCalls.runReport = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.runReport(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.ads.admanager.v1.IRunReportResponse, protos.google.ads.admanager.v1.IRunReportMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.ads.admanager.v1.IRunReportResponse, protos.google.ads.admanager.v1.IRunReportMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.runReport as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes runReport with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.runReport = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes runReport with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.runReport = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.runReport(request);
        ...
        it('invokes checkRunReportProgress without error', async () => {
            ...
            const decodedOperation = await client.checkRunReportProgress(expectedResponse.name);
    ...
    describe('listReports', () => {
        it('invokes listReports without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListReportsRequest', ['parent']);
            request.parent = defaultValue1;
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listReports as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listReports as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listReports without error using callback', async () => {
            ...
            client.innerApiCalls.listReports = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listReports(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IReport[]|null) => {
        ...
        it('invokes listReports with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listReports = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listReportsStream without error', async () => {
            ...
            client.descriptors.page.listReports.createStream = stubPageStreamingCall(expectedResponse);
            ...
            assert((client.descriptors.page.listReports.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listReports, request));
            assert(
        ...
        it('invokes listReportsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listReports.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listReportsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.Report[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.Report) => {
        ...
        it('uses async iteration with listReports without error', async () => {
            ...
            client.descriptors.page.listReports.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listReports with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listReports.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listReportsAsync(request);
    ...
    describe('fetchReportResultRows', () => {
        it('invokes fetchReportResultRows without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.FetchReportResultRowsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.Report.DataTable.Row()),
              generateSampleMessage(new protos.google.ads.admanager.v1.Report.DataTable.Row()),
              generateSampleMessage(new protos.google.ads.admanager.v1.Report.DataTable.Row()),
            ];
            client.innerApiCalls.fetchReportResultRows = stubSimpleCall(expectedResponse);
            const [response] = await client.fetchReportResultRows(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.fetchReportResultRows as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.fetchReportResultRows as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes fetchReportResultRows without error using callback', async () => {
            ...
            client.innerApiCalls.fetchReportResultRows = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.fetchReportResultRows(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.Report.DataTable.IRow[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes fetchReportResultRows with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.fetchReportResultRows = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.fetchReportResultRows(request), expectedError);
            const actualRequest = (client.innerApiCalls.fetchReportResultRows as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.fetchReportResultRows as SinonStub)
        ...
        it('invokes fetchReportResultRowsStream without error', async () => {
            ...
            client.descriptors.page.fetchReportResultRows.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.ads.admanager.v1.Report.DataTable.Row) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.fetchReportResultRows.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.fetchReportResultRows, request));
            assert(
                (client.descriptors.page.fetchReportResultRows.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes fetchReportResultRowsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.fetchReportResultRows.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.fetchReportResultRowsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.Report.DataTable.Row[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.Report.DataTable.Row) => {
        ...
        it('uses async iteration with fetchReportResultRows without error', async () => {
            ...
            client.descriptors.page.fetchReportResultRows.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.fetchReportResultRows.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.fetchReportResultRows.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with fetchReportResultRows with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.fetchReportResultRows.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.fetchReportResultRowsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.ads.admanager.v1.Report.DataTable.IRow[] = [];
                for await (const resource of iterable) {
