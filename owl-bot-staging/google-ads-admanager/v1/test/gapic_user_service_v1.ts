    ...
    describe('getUser', () => {
        it('invokes getUser without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.GetUserRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetUserRequest', ['name']);
        ...
        it('invokes getUser without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getUser(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IUser|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
