...
import * as adunitserviceModule from '../src';
...
describe('v1.AdUnitServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = adunitserviceModule.v1.AdUnitServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = adunitserviceModule.v1.AdUnitServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new adunitserviceModule.v1.AdUnitServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new adunitserviceModule.v1.AdUnitServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new adunitserviceModule.v1.AdUnitServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new adunitserviceModule.v1.AdUnitServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = adunitserviceModule.v1.AdUnitServiceClient.port;
            assert(port);
    ...
    describe('getAdUnit', () => {
        it('invokes getAdUnit without error', async () => {
            const client = new adunitserviceModule.v1.AdUnitServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetAdUnitRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.AdUnit()
            );
            client.innerApiCalls.getAdUnit = stubSimpleCall(expectedResponse);
            const [response] = await client.getAdUnit(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getAdUnit as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getAdUnit as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getAdUnit without error using callback', async () => {
            const client = new adunitserviceModule.v1.AdUnitServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getAdUnit = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAdUnit(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IAdUnit|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAdUnit with error', async () => {
            const client = new adunitserviceModule.v1.AdUnitServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
        ...
        it('invokes getAdUnit with closed client', async () => {
            const client = new adunitserviceModule.v1.AdUnitServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('listAdUnits', () => {
        it('invokes listAdUnits without error', async () => {
            const client = new adunitserviceModule.v1.AdUnitServiceClient({
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListAdUnitsRequest', ['parent']);
            ...
            client.innerApiCalls.listAdUnits = stubSimpleCall(expectedResponse);
            const [response] = await client.listAdUnits(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listAdUnits as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAdUnits as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes listAdUnits without error using callback', async () => {
            const client = new adunitserviceModule.v1.AdUnitServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listAdUnits = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listAdUnits(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IAdUnit[]|null) => {
        ...
        it('invokes listAdUnits with error', async () => {
            const client = new adunitserviceModule.v1.AdUnitServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listAdUnits = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listAdUnits(request), expectedError);
            const actualRequest = (client.innerApiCalls.listAdUnits as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAdUnits as SinonStub)
        ...
        it('invokes listAdUnitsStream without error', async () => {
            const client = new adunitserviceModule.v1.AdUnitServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listAdUnits.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listAdUnitsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.AdUnit[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.AdUnit) => {
            ...
            assert((client.descriptors.page.listAdUnits.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listAdUnits, request));
            assert(
                (client.descriptors.page.listAdUnits.createStream as SinonStub)
        ...
        it('invokes listAdUnitsStream with error', async () => {
            const client = new adunitserviceModule.v1.AdUnitServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAdUnits.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listAdUnitsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.AdUnit[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.AdUnit) => {
        ...
        it('uses async iteration with listAdUnits without error', async () => {
            const client = new adunitserviceModule.v1.AdUnitServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listAdUnits.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.admanager.v1.IAdUnit[] = [];
            const iterable = client.listAdUnitsAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listAdUnits.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listAdUnits with error', async () => {
            const client = new adunitserviceModule.v1.AdUnitServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAdUnits.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listAdUnitsAsync(request);
    ...
    describe('listAdUnitSizes', () => {
        it('invokes listAdUnitSizes without error', async () => {
            const client = new adunitserviceModule.v1.AdUnitServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListAdUnitSizesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
            ...
            client.innerApiCalls.listAdUnitSizes = stubSimpleCall(expectedResponse);
            const [response] = await client.listAdUnitSizes(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listAdUnitSizes as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAdUnitSizes as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes listAdUnitSizes without error using callback', async () => {
            const client = new adunitserviceModule.v1.AdUnitServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listAdUnitSizes = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listAdUnitSizes(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IAdUnitSize[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listAdUnitSizes with error', async () => {
            const client = new adunitserviceModule.v1.AdUnitServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listAdUnitSizes = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listAdUnitSizes(request), expectedError);
            const actualRequest = (client.innerApiCalls.listAdUnitSizes as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAdUnitSizes as SinonStub)
        ...
        it('invokes listAdUnitSizesStream without error', async () => {
            const client = new adunitserviceModule.v1.AdUnitServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listAdUnitSizes.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listAdUnitSizesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.AdUnitSize[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.AdUnitSize) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listAdUnitSizes.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listAdUnitSizes, request));
            assert(
                (client.descriptors.page.listAdUnitSizes.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listAdUnitSizesStream with error', async () => {
            const client = new adunitserviceModule.v1.AdUnitServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAdUnitSizes.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listAdUnitSizesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.AdUnitSize[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.AdUnitSize) => {
        ...
        it('uses async iteration with listAdUnitSizes without error', async () => {
            const client = new adunitserviceModule.v1.AdUnitServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listAdUnitSizes.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.admanager.v1.IAdUnitSize[] = [];
            const iterable = client.listAdUnitSizesAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listAdUnitSizes.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listAdUnitSizes.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listAdUnitSizes with error', async () => {
            const client = new adunitserviceModule.v1.AdUnitServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAdUnitSizes.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listAdUnitSizesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.ads.admanager.v1.IAdUnitSize[] = [];
                for await (const resource of iterable) {
