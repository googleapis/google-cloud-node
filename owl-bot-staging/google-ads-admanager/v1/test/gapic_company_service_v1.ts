...
describe('v1.CompanyServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = companyserviceModule.v1.CompanyServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = companyserviceModule.v1.CompanyServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new companyserviceModule.v1.CompanyServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new companyserviceModule.v1.CompanyServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new companyserviceModule.v1.CompanyServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new companyserviceModule.v1.CompanyServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = companyserviceModule.v1.CompanyServiceClient.port;
            assert(port);
    ...
    describe('getCompany', () => {
        it('invokes getCompany without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.GetCompanyRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetCompanyRequest', ['name']);
        ...
        it('invokes getCompany without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCompany(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.ICompany|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listCompanies', () => {
        it('invokes listCompanies without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.ListCompaniesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListCompaniesRequest', ['parent']);
        ...
        it('invokes listCompaniesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.Company[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.Company) => {
        ...
        it('uses async iteration with listCompanies without error', async () => {
            ...
            const responses: protos.google.ads.admanager.v1.ICompany[] = [];
