  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = customfieldserviceModule.v1.CustomFieldServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = customfieldserviceModule.v1.CustomFieldServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new customfieldserviceModule.v1.CustomFieldServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new customfieldserviceModule.v1.CustomFieldServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new customfieldserviceModule.v1.CustomFieldServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new customfieldserviceModule.v1.CustomFieldServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getCustomField', () => {
        it('invokes getCustomField without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetCustomFieldRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getCustomField as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getCustomField as SinonStub)
        ...
        it('invokes getCustomField without error using callback', async () => {
            ...
            client.innerApiCalls.getCustomField = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getCustomField with error', async () => {
            ...
            client.innerApiCalls.getCustomField = stubSimpleCall(undefined, expectedError);
    ...
    describe('listCustomFields', () => {
        it('invokes listCustomFields without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListCustomFieldsRequest', ['parent']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listCustomFields as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listCustomFields as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listCustomFields without error using callback', async () => {
            ...
            client.innerApiCalls.listCustomFields = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listCustomFields with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listCustomFields = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listCustomFieldsStream without error', async () => {
            ...
            client.descriptors.page.listCustomFields.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listCustomFieldsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.CustomField[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.CustomField) => {
            ...
            assert((client.descriptors.page.listCustomFields.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listCustomFields, request));
            assert(
        ...
        it('invokes listCustomFieldsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listCustomFields.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listCustomFieldsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.CustomField[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.CustomField) => {
        ...
        it('uses async iteration with listCustomFields without error', async () => {
            ...
            client.descriptors.page.listCustomFields.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listCustomFields with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listCustomFields.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listCustomFieldsAsync(request);
