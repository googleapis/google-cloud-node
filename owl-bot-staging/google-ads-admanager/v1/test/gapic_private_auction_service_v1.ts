...
describe('v1.PrivateAuctionServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new privateauctionserviceModule.v1.PrivateAuctionServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = privateauctionserviceModule.v1.PrivateAuctionServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = privateauctionserviceModule.v1.PrivateAuctionServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new privateauctionserviceModule.v1.PrivateAuctionServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new privateauctionserviceModule.v1.PrivateAuctionServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new privateauctionserviceModule.v1.PrivateAuctionServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new privateauctionserviceModule.v1.PrivateAuctionServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = privateauctionserviceModule.v1.PrivateAuctionServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.privateAuctionServiceStub, undefined);
    ...
    describe('getPrivateAuction', () => {
        it('invokes getPrivateAuction without error', async () => {
            const client = new privateauctionserviceModule.v1.PrivateAuctionServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.GetPrivateAuctionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetPrivateAuctionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.PrivateAuction()
            );
            client.innerApiCalls.getPrivateAuction = stubSimpleCall(expectedResponse);
            const [response] = await client.getPrivateAuction(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getPrivateAuction as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getPrivateAuction as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getPrivateAuction without error using callback', async () => {
            const client = new privateauctionserviceModule.v1.PrivateAuctionServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getPrivateAuction = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getPrivateAuction(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IPrivateAuction|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getPrivateAuction with error', async () => {
            const client = new privateauctionserviceModule.v1.PrivateAuctionServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getPrivateAuction = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes getPrivateAuction with closed client', async () => {
            const client = new privateauctionserviceModule.v1.PrivateAuctionServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('createPrivateAuction', () => {
        it('invokes createPrivateAuction without error', async () => {
            const client = new privateauctionserviceModule.v1.PrivateAuctionServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.CreatePrivateAuctionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.CreatePrivateAuctionRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.PrivateAuction()
            );
            client.innerApiCalls.createPrivateAuction = stubSimpleCall(expectedResponse);
            const [response] = await client.createPrivateAuction(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createPrivateAuction as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createPrivateAuction as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes createPrivateAuction without error using callback', async () => {
            const client = new privateauctionserviceModule.v1.PrivateAuctionServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.createPrivateAuction = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createPrivateAuction(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IPrivateAuction|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes createPrivateAuction with error', async () => {
            const client = new privateauctionserviceModule.v1.PrivateAuctionServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createPrivateAuction = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes createPrivateAuction with closed client', async () => {
            const client = new privateauctionserviceModule.v1.PrivateAuctionServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('updatePrivateAuction', () => {
        it('invokes updatePrivateAuction without error', async () => {
            const client = new privateauctionserviceModule.v1.PrivateAuctionServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.UpdatePrivateAuctionRequest()
            );
            request.privateAuction ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.UpdatePrivateAuctionRequest', ['privateAuction', 'name']);
            request.privateAuction.name = defaultValue1;
            const expectedHeaderRequestParams = `private_auction.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.PrivateAuction()
            );
            client.innerApiCalls.updatePrivateAuction = stubSimpleCall(expectedResponse);
            const [response] = await client.updatePrivateAuction(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updatePrivateAuction as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updatePrivateAuction as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes updatePrivateAuction without error using callback', async () => {
            const client = new privateauctionserviceModule.v1.PrivateAuctionServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.updatePrivateAuction = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updatePrivateAuction(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IPrivateAuction|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes updatePrivateAuction with error', async () => {
            const client = new privateauctionserviceModule.v1.PrivateAuctionServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `private_auction.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updatePrivateAuction = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes updatePrivateAuction with closed client', async () => {
            const client = new privateauctionserviceModule.v1.PrivateAuctionServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('listPrivateAuctions', () => {
        it('invokes listPrivateAuctions without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.ListPrivateAuctionsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListPrivateAuctionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.PrivateAuction()),
              generateSampleMessage(new protos.google.ads.admanager.v1.PrivateAuction()),
              generateSampleMessage(new protos.google.ads.admanager.v1.PrivateAuction()),
            ];
            client.innerApiCalls.listPrivateAuctions = stubSimpleCall(expectedResponse);
            const [response] = await client.listPrivateAuctions(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listPrivateAuctions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listPrivateAuctions as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listPrivateAuctions without error using callback', async () => {
            ...
            client.innerApiCalls.listPrivateAuctions = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listPrivateAuctions(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IPrivateAuction[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listPrivateAuctions with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listPrivateAuctions = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listPrivateAuctions(request), expectedError);
            const actualRequest = (client.innerApiCalls.listPrivateAuctions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listPrivateAuctions as SinonStub)
        ...
        it('invokes listPrivateAuctionsStream without error', async () => {
            ...
            client.descriptors.page.listPrivateAuctions.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listPrivateAuctionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.PrivateAuction[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.PrivateAuction) => {
            ...
            assert((client.descriptors.page.listPrivateAuctions.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listPrivateAuctions, request));
            assert(
        ...
        it('invokes listPrivateAuctionsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listPrivateAuctions.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listPrivateAuctionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.PrivateAuction[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.PrivateAuction) => {
        ...
        it('uses async iteration with listPrivateAuctions without error', async () => {
            const client = new privateauctionserviceModule.v1.PrivateAuctionServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listPrivateAuctions.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.admanager.v1.IPrivateAuction[] = [];
            const iterable = client.listPrivateAuctionsAsync(request);
        ...
        it('uses async iteration with listPrivateAuctions with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listPrivateAuctions.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listPrivateAuctionsAsync(request);
