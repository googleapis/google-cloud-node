...
describe('v1.PlacementServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = placementserviceModule.v1.PlacementServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = placementserviceModule.v1.PlacementServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new placementserviceModule.v1.PlacementServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new placementserviceModule.v1.PlacementServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new placementserviceModule.v1.PlacementServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new placementserviceModule.v1.PlacementServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = placementserviceModule.v1.PlacementServiceClient.port;
            assert(port);
    ...
    describe('getPlacement', () => {
        it('invokes getPlacement without error', async () => {
            const client = new placementserviceModule.v1.PlacementServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.GetPlacementRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetPlacementRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.Placement()
            );
            client.innerApiCalls.getPlacement = stubSimpleCall(expectedResponse);
            const [response] = await client.getPlacement(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getPlacement as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getPlacement as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getPlacement without error using callback', async () => {
            const client = new placementserviceModule.v1.PlacementServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getPlacement = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getPlacement(
                    request,
        ...
        it('invokes getPlacement with error', async () => {
            const client = new placementserviceModule.v1.PlacementServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getPlacement = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes getPlacement with closed client', async () => {
            const client = new placementserviceModule.v1.PlacementServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('listPlacements', () => {
        it('invokes listPlacements without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.ListPlacementsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListPlacementsRequest', ['parent']);
            ...
            client.innerApiCalls.listPlacements = stubSimpleCall(expectedResponse);
            const [response] = await client.listPlacements(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listPlacements as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listPlacements as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listPlacements without error using callback', async () => {
            ...
            client.innerApiCalls.listPlacements = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listPlacements with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listPlacements = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listPlacements(request), expectedError);
            const actualRequest = (client.innerApiCalls.listPlacements as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listPlacements as SinonStub)
        ...
        it('invokes listPlacementsStream without error', async () => {
            ...
            client.descriptors.page.listPlacements.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listPlacementsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.Placement[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.Placement) => {
            ...
            assert((client.descriptors.page.listPlacements.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listPlacements, request));
            assert(
        ...
        it('invokes listPlacementsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listPlacements.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listPlacementsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.Placement[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.Placement) => {
        ...
        it('uses async iteration with listPlacements without error', async () => {
            const client = new placementserviceModule.v1.PlacementServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listPlacements.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.admanager.v1.IPlacement[] = [];
            const iterable = client.listPlacementsAsync(request);
        ...
        it('uses async iteration with listPlacements with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listPlacements.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listPlacementsAsync(request);
