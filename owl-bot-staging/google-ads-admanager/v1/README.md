...
* [Admanager Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/admanager/latest)
* [Admanager Documentation](https://developers.google.com/ad-manager/api/beta)
...
1.  [Enable the Admanager API][enable_api].
