...
describe('v1.OrderServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          orderserviceModule.v1.OrderServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          orderserviceModule.v1.OrderServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new orderserviceModule.v1.OrderServiceClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = orderserviceModule.v1.OrderServiceClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.orderServiceStub, undefined);
  ...
  describe('getOrder', () => {
    it('invokes getOrder without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.GetOrderRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.GetOrderRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.Order(),
      );
    ...
    it('invokes getOrder without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getOrder(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IOrder | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listOrders', () => {
    it('invokes listOrders without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.ListOrdersRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedResponse = [
        generateSampleMessage(new protos.google.ads.admanager.v1.Order()),
        generateSampleMessage(new protos.google.ads.admanager.v1.Order()),
        generateSampleMessage(new protos.google.ads.admanager.v1.Order()),
      ];
    ...
    it('invokes listOrdersStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.ads.admanager.v1.Order[] = [];
        stream.on('data', (response: protos.google.ads.admanager.v1.Order) => {
    ...
    it('uses async iteration with listOrders without error', async () => {
      ...
      const responses: protos.google.ads.admanager.v1.IOrder[] = [];
