...
describe('v1.DeviceManufacturerServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          devicemanufacturerserviceModule.v1.DeviceManufacturerServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        devicemanufacturerserviceModule.v1.DeviceManufacturerServiceClient.port;
      assert(port);
  ...
  describe('getDeviceManufacturer', () => {
    it('invokes getDeviceManufacturer without error', async () => {
      ...
      client.innerApiCalls.getDeviceManufacturer =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getDeviceManufacturer(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getDeviceManufacturer as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getDeviceManufacturer without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDeviceManufacturer(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IDeviceManufacturer | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getDeviceManufacturer with error', async () => {
      ...
      client.innerApiCalls.getDeviceManufacturer = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getDeviceManufacturer(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getDeviceManufacturer as SinonStub
  ...
  describe('listDeviceManufacturers', () => {
    it('invokes listDeviceManufacturers without error', async () => {
      ...
      client.innerApiCalls.listDeviceManufacturers =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listDeviceManufacturers(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listDeviceManufacturers as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listDeviceManufacturers as SinonStub
    ...
    it('invokes listDeviceManufacturers with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listDeviceManufacturers = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listDeviceManufacturers(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listDeviceManufacturers as SinonStub
    ...
    it('invokes listDeviceManufacturersStream without error', async () => {
      ...
      client.descriptors.page.listDeviceManufacturers.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.DeviceManufacturer) => {
      ...
      assert(
        (
          client.descriptors.page.listDeviceManufacturers
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listDeviceManufacturers, request),
      );
      assert(
        (
          client.descriptors.page.listDeviceManufacturers
    ...
    it('uses async iteration with listDeviceManufacturers without error', async () => {
      ...
      client.descriptors.page.listDeviceManufacturers.asyncIterate =
