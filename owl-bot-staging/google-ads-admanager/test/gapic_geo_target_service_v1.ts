...
describe('v1.GeoTargetServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          geotargetserviceModule.v1.GeoTargetServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          geotargetserviceModule.v1.GeoTargetServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new geotargetserviceModule.v1.GeoTargetServiceClient({
          universe_domain: 'example.com',
  ...
  describe('getGeoTarget', () => {
    it('invokes getGeoTarget without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.GetGeoTargetRequest',
        ['name'],
      );
      ...
      const actualRequest = (
        client.innerApiCalls.getGeoTarget as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getGeoTarget without error using callback', async () => {
      ...
      client.innerApiCalls.getGeoTarget =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getGeoTarget(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IGeoTarget | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getGeoTarget with error', async () => {
      ...
      client.innerApiCalls.getGeoTarget = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listGeoTargets', () => {
    it('invokes listGeoTargets without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.ListGeoTargetsRequest',
        ['parent'],
      );
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listGeoTargets as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listGeoTargets as SinonStub
    ...
    it('invokes listGeoTargets without error using callback', async () => {
      ...
      client.innerApiCalls.listGeoTargets =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listGeoTargets with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listGeoTargets = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listGeoTargetsStream without error', async () => {
      ...
      client.descriptors.page.listGeoTargets.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.GeoTarget) => {
      ...
      assert(
        (client.descriptors.page.listGeoTargets.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listGeoTargets, request),
      );
      assert(
        (client.descriptors.page.listGeoTargets.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listGeoTargets without error', async () => {
      ...
      client.descriptors.page.listGeoTargets.asyncIterate =
