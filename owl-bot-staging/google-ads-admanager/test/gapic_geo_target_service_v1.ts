...
import * as geotargetserviceModule from '../src';
...
describe('v1.GeoTargetServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new geotargetserviceModule.v1.GeoTargetServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = geotargetserviceModule.v1.GeoTargetServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = geotargetserviceModule.v1.GeoTargetServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new geotargetserviceModule.v1.GeoTargetServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new geotargetserviceModule.v1.GeoTargetServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new geotargetserviceModule.v1.GeoTargetServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new geotargetserviceModule.v1.GeoTargetServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = geotargetserviceModule.v1.GeoTargetServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.geoTargetServiceStub, undefined);
            await client.initialize();
            assert(client.geoTargetServiceStub);
        });
    ...
    describe('getGeoTarget', () => {
        it('invokes getGeoTarget without error', async () => {
            const client = new geotargetserviceModule.v1.GeoTargetServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.GetGeoTargetRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetGeoTargetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.GeoTarget()
            );
            client.innerApiCalls.getGeoTarget = stubSimpleCall(expectedResponse);
            const [response] = await client.getGeoTarget(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getGeoTarget as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getGeoTarget as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getGeoTarget without error using callback', async () => {
            const client = new geotargetserviceModule.v1.GeoTargetServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getGeoTarget = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getGeoTarget(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IGeoTarget|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getGeoTarget with error', async () => {
            const client = new geotargetserviceModule.v1.GeoTargetServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getGeoTarget = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getGeoTarget(request), expectedError);
            const actualRequest = (client.innerApiCalls.getGeoTarget as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getGeoTarget as SinonStub)
        ...
        it('invokes getGeoTarget with closed client', async () => {
            const client = new geotargetserviceModule.v1.GeoTargetServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('listGeoTargets', () => {
        it('invokes listGeoTargets without error', async () => {
            const client = new geotargetserviceModule.v1.GeoTargetServiceClient({
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.ListGeoTargetsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListGeoTargetsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.GeoTarget()),
              generateSampleMessage(new protos.google.ads.admanager.v1.GeoTarget()),
              generateSampleMessage(new protos.google.ads.admanager.v1.GeoTarget()),
            ];
            client.innerApiCalls.listGeoTargets = stubSimpleCall(expectedResponse);
            const [response] = await client.listGeoTargets(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listGeoTargets as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listGeoTargets as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes listGeoTargets without error using callback', async () => {
            const client = new geotargetserviceModule.v1.GeoTargetServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listGeoTargets = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listGeoTargets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IGeoTarget[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listGeoTargets with error', async () => {
            const client = new geotargetserviceModule.v1.GeoTargetServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listGeoTargets = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listGeoTargets(request), expectedError);
            const actualRequest = (client.innerApiCalls.listGeoTargets as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listGeoTargets as SinonStub)
        ...
        it('invokes listGeoTargetsStream without error', async () => {
            const client = new geotargetserviceModule.v1.GeoTargetServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listGeoTargets.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listGeoTargetsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.GeoTarget[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.GeoTarget) => {
            ...
            assert((client.descriptors.page.listGeoTargets.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listGeoTargets, request));
            assert(
                (client.descriptors.page.listGeoTargets.createStream as SinonStub)
        ...
        it('invokes listGeoTargetsStream with error', async () => {
            const client = new geotargetserviceModule.v1.GeoTargetServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listGeoTargets.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listGeoTargetsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.GeoTarget[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.GeoTarget) => {
        ...
        it('uses async iteration with listGeoTargets without error', async () => {
            const client = new geotargetserviceModule.v1.GeoTargetServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listGeoTargets.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.admanager.v1.IGeoTarget[] = [];
            const iterable = client.listGeoTargetsAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listGeoTargets.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listGeoTargets with error', async () => {
            const client = new geotargetserviceModule.v1.GeoTargetServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listGeoTargets.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listGeoTargetsAsync(request);
