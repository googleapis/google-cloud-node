...
import * as contentbundleserviceModule from '../src';
...
describe('v1.ContentBundleServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new contentbundleserviceModule.v1.ContentBundleServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = contentbundleserviceModule.v1.ContentBundleServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = contentbundleserviceModule.v1.ContentBundleServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new contentbundleserviceModule.v1.ContentBundleServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new contentbundleserviceModule.v1.ContentBundleServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new contentbundleserviceModule.v1.ContentBundleServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new contentbundleserviceModule.v1.ContentBundleServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = contentbundleserviceModule.v1.ContentBundleServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.contentBundleServiceStub, undefined);
            await client.initialize();
            assert(client.contentBundleServiceStub);
        });
    ...
    describe('getContentBundle', () => {
        it('invokes getContentBundle without error', async () => {
            const client = new contentbundleserviceModule.v1.ContentBundleServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.GetContentBundleRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetContentBundleRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.ContentBundle()
            );
            client.innerApiCalls.getContentBundle = stubSimpleCall(expectedResponse);
            const [response] = await client.getContentBundle(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getContentBundle as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getContentBundle as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getContentBundle without error using callback', async () => {
            const client = new contentbundleserviceModule.v1.ContentBundleServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getContentBundle = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getContentBundle(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IContentBundle|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getContentBundle with error', async () => {
            const client = new contentbundleserviceModule.v1.ContentBundleServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getContentBundle = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getContentBundle(request), expectedError);
            const actualRequest = (client.innerApiCalls.getContentBundle as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getContentBundle as SinonStub)
        ...
        it('invokes getContentBundle with closed client', async () => {
            const client = new contentbundleserviceModule.v1.ContentBundleServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('listContentBundles', () => {
        it('invokes listContentBundles without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.ListContentBundlesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListContentBundlesRequest', ['parent']);
            ...
            client.innerApiCalls.listContentBundles = stubSimpleCall(expectedResponse);
            const [response] = await client.listContentBundles(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listContentBundles as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listContentBundles as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes listContentBundles without error using callback', async () => {
            const client = new contentbundleserviceModule.v1.ContentBundleServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listContentBundles = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listContentBundles(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IContentBundle[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listContentBundles with error', async () => {
            const client = new contentbundleserviceModule.v1.ContentBundleServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listContentBundles = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listContentBundles(request), expectedError);
            const actualRequest = (client.innerApiCalls.listContentBundles as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listContentBundles as SinonStub)
        ...
        it('invokes listContentBundlesStream without error', async () => {
            const client = new contentbundleserviceModule.v1.ContentBundleServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listContentBundles.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listContentBundlesStream(request);
            const promise = new Promise((resolve, reject) => {
            ...
            assert((client.descriptors.page.listContentBundles.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listContentBundles, request));
            assert(
                (client.descriptors.page.listContentBundles.createStream as SinonStub)
        ...
        it('invokes listContentBundlesStream with error', async () => {
            const client = new contentbundleserviceModule.v1.ContentBundleServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listContentBundles.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listContentBundlesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.ContentBundle[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.ContentBundle) => {
        ...
        it('uses async iteration with listContentBundles without error', async () => {
            const client = new contentbundleserviceModule.v1.ContentBundleServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listContentBundles.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.admanager.v1.IContentBundle[] = [];
            const iterable = client.listContentBundlesAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listContentBundles.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listContentBundles with error', async () => {
            const client = new contentbundleserviceModule.v1.ContentBundleServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listContentBundles.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listContentBundlesAsync(request);
