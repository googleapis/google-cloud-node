...
import * as creativetemplateserviceModule from '../src';
...
describe('v1.CreativeTemplateServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new creativetemplateserviceModule.v1.CreativeTemplateServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = creativetemplateserviceModule.v1.CreativeTemplateServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = creativetemplateserviceModule.v1.CreativeTemplateServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new creativetemplateserviceModule.v1.CreativeTemplateServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new creativetemplateserviceModule.v1.CreativeTemplateServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new creativetemplateserviceModule.v1.CreativeTemplateServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new creativetemplateserviceModule.v1.CreativeTemplateServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = creativetemplateserviceModule.v1.CreativeTemplateServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.creativeTemplateServiceStub, undefined);
            await client.initialize();
            assert(client.creativeTemplateServiceStub);
        });
    ...
    describe('getCreativeTemplate', () => {
        it('invokes getCreativeTemplate without error', async () => {
            const client = new creativetemplateserviceModule.v1.CreativeTemplateServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.GetCreativeTemplateRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetCreativeTemplateRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.CreativeTemplate()
            );
            client.innerApiCalls.getCreativeTemplate = stubSimpleCall(expectedResponse);
            const [response] = await client.getCreativeTemplate(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getCreativeTemplate as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getCreativeTemplate as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getCreativeTemplate without error using callback', async () => {
            const client = new creativetemplateserviceModule.v1.CreativeTemplateServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getCreativeTemplate = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCreativeTemplate(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.ICreativeTemplate|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCreativeTemplate with error', async () => {
            const client = new creativetemplateserviceModule.v1.CreativeTemplateServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getCreativeTemplate = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCreativeTemplate(request), expectedError);
            const actualRequest = (client.innerApiCalls.getCreativeTemplate as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getCreativeTemplate as SinonStub)
        ...
        it('invokes getCreativeTemplate with closed client', async () => {
            const client = new creativetemplateserviceModule.v1.CreativeTemplateServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('listCreativeTemplates', () => {
        it('invokes listCreativeTemplates without error', async () => {
            const client = new creativetemplateserviceModule.v1.CreativeTemplateServiceClient({
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.ListCreativeTemplatesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListCreativeTemplatesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.CreativeTemplate()),
              generateSampleMessage(new protos.google.ads.admanager.v1.CreativeTemplate()),
              generateSampleMessage(new protos.google.ads.admanager.v1.CreativeTemplate()),
            ];
            client.innerApiCalls.listCreativeTemplates = stubSimpleCall(expectedResponse);
            const [response] = await client.listCreativeTemplates(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listCreativeTemplates as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listCreativeTemplates as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes listCreativeTemplates without error using callback', async () => {
            const client = new creativetemplateserviceModule.v1.CreativeTemplateServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listCreativeTemplates = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listCreativeTemplates(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.ICreativeTemplate[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listCreativeTemplates with error', async () => {
            const client = new creativetemplateserviceModule.v1.CreativeTemplateServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listCreativeTemplates = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listCreativeTemplates(request), expectedError);
            const actualRequest = (client.innerApiCalls.listCreativeTemplates as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listCreativeTemplates as SinonStub)
        ...
        it('invokes listCreativeTemplatesStream without error', async () => {
            const client = new creativetemplateserviceModule.v1.CreativeTemplateServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listCreativeTemplates.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listCreativeTemplatesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.CreativeTemplate[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.CreativeTemplate) => {
            ...
            assert((client.descriptors.page.listCreativeTemplates.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listCreativeTemplates, request));
            assert(
                (client.descriptors.page.listCreativeTemplates.createStream as SinonStub)
        ...
        it('invokes listCreativeTemplatesStream with error', async () => {
            const client = new creativetemplateserviceModule.v1.CreativeTemplateServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listCreativeTemplates.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listCreativeTemplatesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.CreativeTemplate[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.CreativeTemplate) => {
        ...
        it('uses async iteration with listCreativeTemplates without error', async () => {
            const client = new creativetemplateserviceModule.v1.CreativeTemplateServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listCreativeTemplates.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.admanager.v1.ICreativeTemplate[] = [];
            const iterable = client.listCreativeTemplatesAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listCreativeTemplates.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listCreativeTemplates with error', async () => {
            const client = new creativetemplateserviceModule.v1.CreativeTemplateServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listCreativeTemplates.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listCreativeTemplatesAsync(request);
