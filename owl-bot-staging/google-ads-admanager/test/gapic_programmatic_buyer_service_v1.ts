...
describe('v1.ProgrammaticBuyerServiceClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new programmaticbuyerserviceModule.v1.ProgrammaticBuyerServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          programmaticbuyerserviceModule.v1.ProgrammaticBuyerServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        programmaticbuyerserviceModule.v1.ProgrammaticBuyerServiceClient.port;
      assert(port);
  ...
  describe('getProgrammaticBuyer', () => {
    it('invokes getProgrammaticBuyer without error', async () => {
      ...
      client.innerApiCalls.getProgrammaticBuyer =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getProgrammaticBuyer(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getProgrammaticBuyer as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getProgrammaticBuyer without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getProgrammaticBuyer(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IProgrammaticBuyer | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getProgrammaticBuyer with error', async () => {
      ...
      client.innerApiCalls.getProgrammaticBuyer = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listProgrammaticBuyers', () => {
    it('invokes listProgrammaticBuyers without error', async () => {
      ...
      client.innerApiCalls.listProgrammaticBuyers =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listProgrammaticBuyers(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listProgrammaticBuyers as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listProgrammaticBuyers as SinonStub
    ...
    it('invokes listProgrammaticBuyers with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listProgrammaticBuyers = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listProgrammaticBuyers(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listProgrammaticBuyers as SinonStub
    ...
    it('invokes listProgrammaticBuyersStream without error', async () => {
      ...
      client.descriptors.page.listProgrammaticBuyers.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.ProgrammaticBuyer) => {
      ...
      assert(
        (
          client.descriptors.page.listProgrammaticBuyers
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listProgrammaticBuyers, request),
      );
      assert(
        (
          client.descriptors.page.listProgrammaticBuyers
    ...
    it('uses async iteration with listProgrammaticBuyers without error', async () => {
      ...
      client.descriptors.page.listProgrammaticBuyers.asyncIterate =
