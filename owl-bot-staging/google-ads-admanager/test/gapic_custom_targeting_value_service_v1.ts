  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = customtargetingvalueserviceModule.v1.CustomTargetingValueServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = customtargetingvalueserviceModule.v1.CustomTargetingValueServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new customtargetingvalueserviceModule.v1.CustomTargetingValueServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new customtargetingvalueserviceModule.v1.CustomTargetingValueServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new customtargetingvalueserviceModule.v1.CustomTargetingValueServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new customtargetingvalueserviceModule.v1.CustomTargetingValueServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = customtargetingvalueserviceModule.v1.CustomTargetingValueServiceClient.port;
            assert(port);
    ...
    describe('getCustomTargetingValue', () => {
        it('invokes getCustomTargetingValue without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetCustomTargetingValueRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.CustomTargetingValue()
            );
            client.innerApiCalls.getCustomTargetingValue = stubSimpleCall(expectedResponse);
            const [response] = await client.getCustomTargetingValue(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getCustomTargetingValue as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getCustomTargetingValue as SinonStub)
        ...
        it('invokes getCustomTargetingValue without error using callback', async () => {
            ...
            client.innerApiCalls.getCustomTargetingValue = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCustomTargetingValue(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.ICustomTargetingValue|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCustomTargetingValue with error', async () => {
            ...
            client.innerApiCalls.getCustomTargetingValue = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCustomTargetingValue(request), expectedError);
            const actualRequest = (client.innerApiCalls.getCustomTargetingValue as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getCustomTargetingValue as SinonStub)
    ...
    describe('listCustomTargetingValues', () => {
        it('invokes listCustomTargetingValues without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListCustomTargetingValuesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.CustomTargetingValue()),
              generateSampleMessage(new protos.google.ads.admanager.v1.CustomTargetingValue()),
              generateSampleMessage(new protos.google.ads.admanager.v1.CustomTargetingValue()),
            ];
            client.innerApiCalls.listCustomTargetingValues = stubSimpleCall(expectedResponse);
            const [response] = await client.listCustomTargetingValues(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listCustomTargetingValues as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listCustomTargetingValues as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listCustomTargetingValues without error using callback', async () => {
            ...
            client.innerApiCalls.listCustomTargetingValues = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listCustomTargetingValues with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listCustomTargetingValues = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listCustomTargetingValues(request), expectedError);
            const actualRequest = (client.innerApiCalls.listCustomTargetingValues as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listCustomTargetingValues as SinonStub)
        ...
        it('invokes listCustomTargetingValuesStream without error', async () => {
            ...
            client.descriptors.page.listCustomTargetingValues.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.ads.admanager.v1.CustomTargetingValue) => {
            ...
            assert((client.descriptors.page.listCustomTargetingValues.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listCustomTargetingValues, request));
            assert(
                (client.descriptors.page.listCustomTargetingValues.createStream as SinonStub)
        ...
        it('invokes listCustomTargetingValuesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listCustomTargetingValues.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listCustomTargetingValuesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.CustomTargetingValue[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.CustomTargetingValue) => {
        ...
        it('uses async iteration with listCustomTargetingValues without error', async () => {
            ...
            client.descriptors.page.listCustomTargetingValues.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(
                (client.descriptors.page.listCustomTargetingValues.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listCustomTargetingValues with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listCustomTargetingValues.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listCustomTargetingValuesAsync(request);
