...
describe('v1.OperatingSystemVersionServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new operatingsystemversionserviceModule.v1.OperatingSystemVersionServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = operatingsystemversionserviceModule.v1.OperatingSystemVersionServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = operatingsystemversionserviceModule.v1.OperatingSystemVersionServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new operatingsystemversionserviceModule.v1.OperatingSystemVersionServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new operatingsystemversionserviceModule.v1.OperatingSystemVersionServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new operatingsystemversionserviceModule.v1.OperatingSystemVersionServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new operatingsystemversionserviceModule.v1.OperatingSystemVersionServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = operatingsystemversionserviceModule.v1.OperatingSystemVersionServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.operatingSystemVersionServiceStub, undefined);
    ...
    describe('getOperatingSystemVersion', () => {
        it('invokes getOperatingSystemVersion without error', async () => {
            const client = new operatingsystemversionserviceModule.v1.OperatingSystemVersionServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.GetOperatingSystemVersionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetOperatingSystemVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.OperatingSystemVersion()
            );
            client.innerApiCalls.getOperatingSystemVersion = stubSimpleCall(expectedResponse);
            const [response] = await client.getOperatingSystemVersion(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getOperatingSystemVersion as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getOperatingSystemVersion as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getOperatingSystemVersion without error using callback', async () => {
            const client = new operatingsystemversionserviceModule.v1.OperatingSystemVersionServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getOperatingSystemVersion = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getOperatingSystemVersion(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IOperatingSystemVersion|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getOperatingSystemVersion with error', async () => {
            const client = new operatingsystemversionserviceModule.v1.OperatingSystemVersionServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getOperatingSystemVersion = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getOperatingSystemVersion(request), expectedError);
            const actualRequest = (client.innerApiCalls.getOperatingSystemVersion as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getOperatingSystemVersion as SinonStub)
        ...
        it('invokes getOperatingSystemVersion with closed client', async () => {
            const client = new operatingsystemversionserviceModule.v1.OperatingSystemVersionServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('listOperatingSystemVersions', () => {
        it('invokes listOperatingSystemVersions without error', async () => {
            const client = new operatingsystemversionserviceModule.v1.OperatingSystemVersionServiceClient({
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.ListOperatingSystemVersionsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListOperatingSystemVersionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.OperatingSystemVersion()),
              generateSampleMessage(new protos.google.ads.admanager.v1.OperatingSystemVersion()),
              generateSampleMessage(new protos.google.ads.admanager.v1.OperatingSystemVersion()),
            ];
            client.innerApiCalls.listOperatingSystemVersions = stubSimpleCall(expectedResponse);
            const [response] = await client.listOperatingSystemVersions(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listOperatingSystemVersions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listOperatingSystemVersions as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes listOperatingSystemVersions without error using callback', async () => {
            const client = new operatingsystemversionserviceModule.v1.OperatingSystemVersionServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listOperatingSystemVersions = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listOperatingSystemVersions(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IOperatingSystemVersion[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listOperatingSystemVersions with error', async () => {
            const client = new operatingsystemversionserviceModule.v1.OperatingSystemVersionServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listOperatingSystemVersions = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listOperatingSystemVersions(request), expectedError);
            const actualRequest = (client.innerApiCalls.listOperatingSystemVersions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listOperatingSystemVersions as SinonStub)
        ...
        it('invokes listOperatingSystemVersionsStream without error', async () => {
            const client = new operatingsystemversionserviceModule.v1.OperatingSystemVersionServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listOperatingSystemVersions.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listOperatingSystemVersionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.OperatingSystemVersion[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.OperatingSystemVersion) => {
            ...
            assert((client.descriptors.page.listOperatingSystemVersions.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listOperatingSystemVersions, request));
            assert(
                (client.descriptors.page.listOperatingSystemVersions.createStream as SinonStub)
        ...
        it('invokes listOperatingSystemVersionsStream with error', async () => {
            const client = new operatingsystemversionserviceModule.v1.OperatingSystemVersionServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listOperatingSystemVersions.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listOperatingSystemVersionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.OperatingSystemVersion[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.OperatingSystemVersion) => {
        ...
        it('uses async iteration with listOperatingSystemVersions without error', async () => {
            const client = new operatingsystemversionserviceModule.v1.OperatingSystemVersionServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listOperatingSystemVersions.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.admanager.v1.IOperatingSystemVersion[] = [];
            const iterable = client.listOperatingSystemVersionsAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listOperatingSystemVersions.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listOperatingSystemVersions with error', async () => {
            const client = new operatingsystemversionserviceModule.v1.OperatingSystemVersionServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listOperatingSystemVersions.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listOperatingSystemVersionsAsync(request);
