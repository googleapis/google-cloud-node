...
describe('v1.RichMediaAdsCompanyServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new richmediaadscompanyserviceModule.v1.RichMediaAdsCompanyServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = richmediaadscompanyserviceModule.v1.RichMediaAdsCompanyServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = richmediaadscompanyserviceModule.v1.RichMediaAdsCompanyServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new richmediaadscompanyserviceModule.v1.RichMediaAdsCompanyServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new richmediaadscompanyserviceModule.v1.RichMediaAdsCompanyServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new richmediaadscompanyserviceModule.v1.RichMediaAdsCompanyServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new richmediaadscompanyserviceModule.v1.RichMediaAdsCompanyServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = richmediaadscompanyserviceModule.v1.RichMediaAdsCompanyServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.richMediaAdsCompanyServiceStub, undefined);
    ...
    describe('getRichMediaAdsCompany', () => {
        it('invokes getRichMediaAdsCompany without error', async () => {
            const client = new richmediaadscompanyserviceModule.v1.RichMediaAdsCompanyServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.GetRichMediaAdsCompanyRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetRichMediaAdsCompanyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.RichMediaAdsCompany()
            );
            client.innerApiCalls.getRichMediaAdsCompany = stubSimpleCall(expectedResponse);
            const [response] = await client.getRichMediaAdsCompany(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getRichMediaAdsCompany as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getRichMediaAdsCompany as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getRichMediaAdsCompany without error using callback', async () => {
            const client = new richmediaadscompanyserviceModule.v1.RichMediaAdsCompanyServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getRichMediaAdsCompany = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getRichMediaAdsCompany(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IRichMediaAdsCompany|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getRichMediaAdsCompany with error', async () => {
            const client = new richmediaadscompanyserviceModule.v1.RichMediaAdsCompanyServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getRichMediaAdsCompany = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getRichMediaAdsCompany(request), expectedError);
            const actualRequest = (client.innerApiCalls.getRichMediaAdsCompany as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getRichMediaAdsCompany as SinonStub)
        ...
        it('invokes getRichMediaAdsCompany with closed client', async () => {
            const client = new richmediaadscompanyserviceModule.v1.RichMediaAdsCompanyServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('listRichMediaAdsCompanies', () => {
        it('invokes listRichMediaAdsCompanies without error', async () => {
            const client = new richmediaadscompanyserviceModule.v1.RichMediaAdsCompanyServiceClient({
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.ListRichMediaAdsCompaniesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListRichMediaAdsCompaniesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.RichMediaAdsCompany()),
              generateSampleMessage(new protos.google.ads.admanager.v1.RichMediaAdsCompany()),
              generateSampleMessage(new protos.google.ads.admanager.v1.RichMediaAdsCompany()),
            ];
            client.innerApiCalls.listRichMediaAdsCompanies = stubSimpleCall(expectedResponse);
            const [response] = await client.listRichMediaAdsCompanies(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listRichMediaAdsCompanies as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listRichMediaAdsCompanies as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes listRichMediaAdsCompanies without error using callback', async () => {
            const client = new richmediaadscompanyserviceModule.v1.RichMediaAdsCompanyServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listRichMediaAdsCompanies = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listRichMediaAdsCompanies(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IRichMediaAdsCompany[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listRichMediaAdsCompanies with error', async () => {
            const client = new richmediaadscompanyserviceModule.v1.RichMediaAdsCompanyServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listRichMediaAdsCompanies = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listRichMediaAdsCompanies(request), expectedError);
            const actualRequest = (client.innerApiCalls.listRichMediaAdsCompanies as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listRichMediaAdsCompanies as SinonStub)
        ...
        it('invokes listRichMediaAdsCompaniesStream without error', async () => {
            const client = new richmediaadscompanyserviceModule.v1.RichMediaAdsCompanyServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listRichMediaAdsCompanies.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listRichMediaAdsCompaniesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.RichMediaAdsCompany[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.RichMediaAdsCompany) => {
            ...
            assert((client.descriptors.page.listRichMediaAdsCompanies.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listRichMediaAdsCompanies, request));
            assert(
                (client.descriptors.page.listRichMediaAdsCompanies.createStream as SinonStub)
        ...
        it('invokes listRichMediaAdsCompaniesStream with error', async () => {
            const client = new richmediaadscompanyserviceModule.v1.RichMediaAdsCompanyServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listRichMediaAdsCompanies.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listRichMediaAdsCompaniesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.RichMediaAdsCompany[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.RichMediaAdsCompany) => {
        ...
        it('uses async iteration with listRichMediaAdsCompanies without error', async () => {
            const client = new richmediaadscompanyserviceModule.v1.RichMediaAdsCompanyServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listRichMediaAdsCompanies.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.admanager.v1.IRichMediaAdsCompany[] = [];
            const iterable = client.listRichMediaAdsCompaniesAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listRichMediaAdsCompanies.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listRichMediaAdsCompanies with error', async () => {
            const client = new richmediaadscompanyserviceModule.v1.RichMediaAdsCompanyServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listRichMediaAdsCompanies.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listRichMediaAdsCompaniesAsync(request);
