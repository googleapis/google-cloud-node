  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = siteserviceModule.v1.SiteServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = siteserviceModule.v1.SiteServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new siteserviceModule.v1.SiteServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new siteserviceModule.v1.SiteServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new siteserviceModule.v1.SiteServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new siteserviceModule.v1.SiteServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = siteserviceModule.v1.SiteServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.siteServiceStub, undefined);
    ...
    describe('getSite', () => {
        it('invokes getSite without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.GetSiteRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetSiteRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.Site()
            );
        ...
        it('invokes getSite without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getSite(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.ISite|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createSite', () => {
        it('invokes createSite without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.CreateSiteRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.CreateSiteRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.Site()
            );
            client.innerApiCalls.createSite = stubSimpleCall(expectedResponse);
            const [response] = await client.createSite(request);
            assert.deepStrictEqual(response, expectedResponse);
        ...
        it('invokes createSite without error using callback', async () => {
            ...
            client.innerApiCalls.createSite = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createSite(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.ISite|null) => {
        ...
        it('invokes createSite with error', async () => {
            const client = new siteserviceModule.v1.SiteServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createSite = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes createSite with closed client', async () => {
            const client = new siteserviceModule.v1.SiteServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('batchCreateSites', () => {
        it('invokes batchCreateSites without error', async () => {
            const client = new siteserviceModule.v1.SiteServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.BatchCreateSitesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.BatchCreateSitesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.BatchCreateSitesResponse()
            );
            client.innerApiCalls.batchCreateSites = stubSimpleCall(expectedResponse);
            const [response] = await client.batchCreateSites(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchCreateSites as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchCreateSites as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes batchCreateSites without error using callback', async () => {
            const client = new siteserviceModule.v1.SiteServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.batchCreateSites = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchCreateSites(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IBatchCreateSitesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchCreateSites with error', async () => {
            const client = new siteserviceModule.v1.SiteServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchCreateSites = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes batchCreateSites with closed client', async () => {
            const client = new siteserviceModule.v1.SiteServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('updateSite', () => {
        it('invokes updateSite without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.UpdateSiteRequest()
            );
            request.site ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.UpdateSiteRequest', ['site', 'name']);
            request.site.name = defaultValue1;
            const expectedHeaderRequestParams = `site.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.Site()
            );
            client.innerApiCalls.updateSite = stubSimpleCall(expectedResponse);
            const [response] = await client.updateSite(request);
            assert.deepStrictEqual(response, expectedResponse);
        ...
        it('invokes updateSite without error using callback', async () => {
            ...
            client.innerApiCalls.updateSite = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateSite(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.ISite|null) => {
        ...
        it('invokes updateSite with error', async () => {
            const client = new siteserviceModule.v1.SiteServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `site.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateSite = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes updateSite with closed client', async () => {
            const client = new siteserviceModule.v1.SiteServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('batchUpdateSites', () => {
        it('invokes batchUpdateSites without error', async () => {
            const client = new siteserviceModule.v1.SiteServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.BatchUpdateSitesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.BatchUpdateSitesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.BatchUpdateSitesResponse()
            );
            client.innerApiCalls.batchUpdateSites = stubSimpleCall(expectedResponse);
            const [response] = await client.batchUpdateSites(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchUpdateSites as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchUpdateSites as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes batchUpdateSites without error using callback', async () => {
            const client = new siteserviceModule.v1.SiteServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.batchUpdateSites = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchUpdateSites(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IBatchUpdateSitesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchUpdateSites with error', async () => {
            const client = new siteserviceModule.v1.SiteServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchUpdateSites = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes batchUpdateSites with closed client', async () => {
            const client = new siteserviceModule.v1.SiteServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('batchDeactivateSites', () => {
        it('invokes batchDeactivateSites without error', async () => {
            const client = new siteserviceModule.v1.SiteServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.BatchDeactivateSitesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.BatchDeactivateSitesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.BatchDeactivateSitesResponse()
            );
            client.innerApiCalls.batchDeactivateSites = stubSimpleCall(expectedResponse);
            const [response] = await client.batchDeactivateSites(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchDeactivateSites as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchDeactivateSites as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes batchDeactivateSites without error using callback', async () => {
            const client = new siteserviceModule.v1.SiteServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.batchDeactivateSites = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchDeactivateSites(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IBatchDeactivateSitesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchDeactivateSites with error', async () => {
            const client = new siteserviceModule.v1.SiteServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchDeactivateSites = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes batchDeactivateSites with closed client', async () => {
            const client = new siteserviceModule.v1.SiteServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('batchSubmitSitesForApproval', () => {
        it('invokes batchSubmitSitesForApproval without error', async () => {
            const client = new siteserviceModule.v1.SiteServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.BatchSubmitSitesForApprovalRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.BatchSubmitSitesForApprovalRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.BatchSubmitSitesForApprovalResponse()
            );
            client.innerApiCalls.batchSubmitSitesForApproval = stubSimpleCall(expectedResponse);
            const [response] = await client.batchSubmitSitesForApproval(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchSubmitSitesForApproval as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchSubmitSitesForApproval as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes batchSubmitSitesForApproval without error using callback', async () => {
            const client = new siteserviceModule.v1.SiteServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.batchSubmitSitesForApproval = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchSubmitSitesForApproval(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IBatchSubmitSitesForApprovalResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchSubmitSitesForApproval with error', async () => {
            const client = new siteserviceModule.v1.SiteServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchSubmitSitesForApproval = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.batchSubmitSitesForApproval(request), expectedError);
            const actualRequest = (client.innerApiCalls.batchSubmitSitesForApproval as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchSubmitSitesForApproval as SinonStub)
        ...
        it('invokes batchSubmitSitesForApproval with closed client', async () => {
            const client = new siteserviceModule.v1.SiteServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('listSites', () => {
        it('invokes listSites without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.ListSitesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListSitesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.Site()),
              generateSampleMessage(new protos.google.ads.admanager.v1.Site()),
              generateSampleMessage(new protos.google.ads.admanager.v1.Site()),
            ];
        ...
        it('invokes listSitesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.Site[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.Site) => {
        ...
        it('uses async iteration with listSites without error', async () => {
            ...
            const responses: protos.google.ads.admanager.v1.ISite[] = [];
