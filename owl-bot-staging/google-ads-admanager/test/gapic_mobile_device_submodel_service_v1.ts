...
import * as mobiledevicesubmodelserviceModule from '../src';
...
describe('v1.MobileDeviceSubmodelServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new mobiledevicesubmodelserviceModule.v1.MobileDeviceSubmodelServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = mobiledevicesubmodelserviceModule.v1.MobileDeviceSubmodelServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = mobiledevicesubmodelserviceModule.v1.MobileDeviceSubmodelServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new mobiledevicesubmodelserviceModule.v1.MobileDeviceSubmodelServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new mobiledevicesubmodelserviceModule.v1.MobileDeviceSubmodelServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new mobiledevicesubmodelserviceModule.v1.MobileDeviceSubmodelServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new mobiledevicesubmodelserviceModule.v1.MobileDeviceSubmodelServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = mobiledevicesubmodelserviceModule.v1.MobileDeviceSubmodelServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.mobileDeviceSubmodelServiceStub, undefined);
            await client.initialize();
            assert(client.mobileDeviceSubmodelServiceStub);
        });
    ...
    describe('getMobileDeviceSubmodel', () => {
        it('invokes getMobileDeviceSubmodel without error', async () => {
            const client = new mobiledevicesubmodelserviceModule.v1.MobileDeviceSubmodelServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.GetMobileDeviceSubmodelRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetMobileDeviceSubmodelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.MobileDeviceSubmodel()
            );
            client.innerApiCalls.getMobileDeviceSubmodel = stubSimpleCall(expectedResponse);
            const [response] = await client.getMobileDeviceSubmodel(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getMobileDeviceSubmodel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getMobileDeviceSubmodel as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getMobileDeviceSubmodel without error using callback', async () => {
            const client = new mobiledevicesubmodelserviceModule.v1.MobileDeviceSubmodelServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getMobileDeviceSubmodel = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getMobileDeviceSubmodel(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IMobileDeviceSubmodel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getMobileDeviceSubmodel with error', async () => {
            const client = new mobiledevicesubmodelserviceModule.v1.MobileDeviceSubmodelServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getMobileDeviceSubmodel = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getMobileDeviceSubmodel(request), expectedError);
            const actualRequest = (client.innerApiCalls.getMobileDeviceSubmodel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getMobileDeviceSubmodel as SinonStub)
        ...
        it('invokes getMobileDeviceSubmodel with closed client', async () => {
            const client = new mobiledevicesubmodelserviceModule.v1.MobileDeviceSubmodelServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('listMobileDeviceSubmodels', () => {
        it('invokes listMobileDeviceSubmodels without error', async () => {
            const client = new mobiledevicesubmodelserviceModule.v1.MobileDeviceSubmodelServiceClient({
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.ListMobileDeviceSubmodelsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListMobileDeviceSubmodelsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.MobileDeviceSubmodel()),
              generateSampleMessage(new protos.google.ads.admanager.v1.MobileDeviceSubmodel()),
              generateSampleMessage(new protos.google.ads.admanager.v1.MobileDeviceSubmodel()),
            ];
            client.innerApiCalls.listMobileDeviceSubmodels = stubSimpleCall(expectedResponse);
            const [response] = await client.listMobileDeviceSubmodels(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listMobileDeviceSubmodels as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listMobileDeviceSubmodels as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes listMobileDeviceSubmodels without error using callback', async () => {
            const client = new mobiledevicesubmodelserviceModule.v1.MobileDeviceSubmodelServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listMobileDeviceSubmodels = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listMobileDeviceSubmodels(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IMobileDeviceSubmodel[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listMobileDeviceSubmodels with error', async () => {
            const client = new mobiledevicesubmodelserviceModule.v1.MobileDeviceSubmodelServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listMobileDeviceSubmodels = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listMobileDeviceSubmodels(request), expectedError);
            const actualRequest = (client.innerApiCalls.listMobileDeviceSubmodels as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listMobileDeviceSubmodels as SinonStub)
        ...
        it('invokes listMobileDeviceSubmodelsStream without error', async () => {
            const client = new mobiledevicesubmodelserviceModule.v1.MobileDeviceSubmodelServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listMobileDeviceSubmodels.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listMobileDeviceSubmodelsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.MobileDeviceSubmodel[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.MobileDeviceSubmodel) => {
            ...
            assert((client.descriptors.page.listMobileDeviceSubmodels.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listMobileDeviceSubmodels, request));
            assert(
                (client.descriptors.page.listMobileDeviceSubmodels.createStream as SinonStub)
        ...
        it('invokes listMobileDeviceSubmodelsStream with error', async () => {
            const client = new mobiledevicesubmodelserviceModule.v1.MobileDeviceSubmodelServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listMobileDeviceSubmodels.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listMobileDeviceSubmodelsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.MobileDeviceSubmodel[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.MobileDeviceSubmodel) => {
        ...
        it('uses async iteration with listMobileDeviceSubmodels without error', async () => {
            const client = new mobiledevicesubmodelserviceModule.v1.MobileDeviceSubmodelServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listMobileDeviceSubmodels.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.admanager.v1.IMobileDeviceSubmodel[] = [];
            const iterable = client.listMobileDeviceSubmodelsAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listMobileDeviceSubmodels.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listMobileDeviceSubmodels with error', async () => {
            const client = new mobiledevicesubmodelserviceModule.v1.MobileDeviceSubmodelServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listMobileDeviceSubmodels.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listMobileDeviceSubmodelsAsync(request);
