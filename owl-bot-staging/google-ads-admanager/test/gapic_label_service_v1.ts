  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = labelserviceModule.v1.LabelServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = labelserviceModule.v1.LabelServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new labelserviceModule.v1.LabelServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new labelserviceModule.v1.LabelServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new labelserviceModule.v1.LabelServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new labelserviceModule.v1.LabelServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getLabel', () => {
        it('invokes getLabel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetLabelRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getLabel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getLabel as SinonStub)
        ...
        it('invokes getLabel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getLabel(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.ILabel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createLabel', () => {
        it('invokes createLabel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.CreateLabelRequest', ['parent']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createLabel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createLabel as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createLabel without error using callback', async () => {
            ...
            client.innerApiCalls.createLabel = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createLabel(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.ILabel|null) => {
        ...
        it('invokes createLabel with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createLabel = stubSimpleCall(undefined, expectedError);
    ...
    describe('batchCreateLabels', () => {
        it('invokes batchCreateLabels without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.BatchCreateLabelsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchCreateLabels as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchCreateLabels as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes batchCreateLabels without error using callback', async () => {
            ...
            client.innerApiCalls.batchCreateLabels = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchCreateLabels(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IBatchCreateLabelsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchCreateLabels with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchCreateLabels = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateLabel', () => {
        it('invokes updateLabel without error', async () => {
            ...
            request.label ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.UpdateLabelRequest', ['label', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateLabel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateLabel as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateLabel without error using callback', async () => {
            ...
            client.innerApiCalls.updateLabel = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateLabel(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.ILabel|null) => {
        ...
        it('invokes updateLabel with error', async () => {
            ...
            const expectedHeaderRequestParams = `label.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateLabel = stubSimpleCall(undefined, expectedError);
    ...
    describe('batchUpdateLabels', () => {
        it('invokes batchUpdateLabels without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.BatchUpdateLabelsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchUpdateLabels as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchUpdateLabels as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes batchUpdateLabels without error using callback', async () => {
            ...
            client.innerApiCalls.batchUpdateLabels = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchUpdateLabels(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IBatchUpdateLabelsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchUpdateLabels with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchUpdateLabels = stubSimpleCall(undefined, expectedError);
    ...
    describe('batchActivateLabels', () => {
        it('invokes batchActivateLabels without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.BatchActivateLabelsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.BatchActivateLabelsResponse()
            );
            client.innerApiCalls.batchActivateLabels = stubSimpleCall(expectedResponse);
            const [response] = await client.batchActivateLabels(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchActivateLabels as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchActivateLabels as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes batchActivateLabels without error using callback', async () => {
            ...
            client.innerApiCalls.batchActivateLabels = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchActivateLabels(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IBatchActivateLabelsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchActivateLabels with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchActivateLabels = stubSimpleCall(undefined, expectedError);
    ...
    describe('batchDeactivateLabels', () => {
        it('invokes batchDeactivateLabels without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.BatchDeactivateLabelsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.BatchDeactivateLabelsResponse()
            );
            client.innerApiCalls.batchDeactivateLabels = stubSimpleCall(expectedResponse);
            const [response] = await client.batchDeactivateLabels(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchDeactivateLabels as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchDeactivateLabels as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes batchDeactivateLabels without error using callback', async () => {
            ...
            client.innerApiCalls.batchDeactivateLabels = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchDeactivateLabels(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IBatchDeactivateLabelsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchDeactivateLabels with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchDeactivateLabels = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.batchDeactivateLabels(request), expectedError);
            const actualRequest = (client.innerApiCalls.batchDeactivateLabels as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchDeactivateLabels as SinonStub)
    ...
    describe('listLabels', () => {
        it('invokes listLabels without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListLabelsRequest', ['parent']);
            request.parent = defaultValue1;
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listLabels as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listLabels as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listLabels without error using callback', async () => {
            ...
            client.innerApiCalls.listLabels = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listLabels(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.ILabel[]|null) => {
        ...
        it('invokes listLabels with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listLabels = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listLabelsStream without error', async () => {
            ...
            client.descriptors.page.listLabels.createStream = stubPageStreamingCall(expectedResponse);
            ...
            assert((client.descriptors.page.listLabels.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listLabels, request));
            assert(
        ...
        it('invokes listLabelsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listLabels.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listLabelsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.Label[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.Label) => {
        ...
        it('uses async iteration with listLabels without error', async () => {
            ...
            client.descriptors.page.listLabels.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listLabels with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listLabels.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listLabelsAsync(request);
