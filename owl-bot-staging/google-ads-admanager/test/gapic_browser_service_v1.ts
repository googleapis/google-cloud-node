...
describe('v1.BrowserServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = browserserviceModule.v1.BrowserServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = browserserviceModule.v1.BrowserServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new browserserviceModule.v1.BrowserServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new browserserviceModule.v1.BrowserServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new browserserviceModule.v1.BrowserServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new browserserviceModule.v1.BrowserServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = browserserviceModule.v1.BrowserServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.browserServiceStub, undefined);
    ...
    describe('getBrowser', () => {
        it('invokes getBrowser without error', async () => {
            const client = new browserserviceModule.v1.BrowserServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.GetBrowserRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetBrowserRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.Browser()
            );
            client.innerApiCalls.getBrowser = stubSimpleCall(expectedResponse);
            const [response] = await client.getBrowser(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getBrowser as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getBrowser as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getBrowser without error using callback', async () => {
            const client = new browserserviceModule.v1.BrowserServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getBrowser = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getBrowser(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IBrowser|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getBrowser with error', async () => {
            const client = new browserserviceModule.v1.BrowserServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getBrowser = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes getBrowser with closed client', async () => {
            const client = new browserserviceModule.v1.BrowserServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('listBrowsers', () => {
        it('invokes listBrowsers without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.ListBrowsersRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListBrowsersRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.Browser()),
              generateSampleMessage(new protos.google.ads.admanager.v1.Browser()),
              generateSampleMessage(new protos.google.ads.admanager.v1.Browser()),
            ];
            client.innerApiCalls.listBrowsers = stubSimpleCall(expectedResponse);
            const [response] = await client.listBrowsers(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listBrowsers as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listBrowsers as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listBrowsers without error using callback', async () => {
            ...
            client.innerApiCalls.listBrowsers = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listBrowsers(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IBrowser[]|null) => {
        ...
        it('invokes listBrowsers with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listBrowsers = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listBrowsers(request), expectedError);
            const actualRequest = (client.innerApiCalls.listBrowsers as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listBrowsers as SinonStub)
        ...
        it('invokes listBrowsersStream without error', async () => {
            ...
            client.descriptors.page.listBrowsers.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listBrowsersStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.Browser[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.Browser) => {
            ...
            assert((client.descriptors.page.listBrowsers.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listBrowsers, request));
            assert(
        ...
        it('invokes listBrowsersStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listBrowsers.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listBrowsersStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.Browser[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.Browser) => {
        ...
        it('uses async iteration with listBrowsers without error', async () => {
            const client = new browserserviceModule.v1.BrowserServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listBrowsers.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.admanager.v1.IBrowser[] = [];
            const iterable = client.listBrowsersAsync(request);
        ...
        it('uses async iteration with listBrowsers with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listBrowsers.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listBrowsersAsync(request);
