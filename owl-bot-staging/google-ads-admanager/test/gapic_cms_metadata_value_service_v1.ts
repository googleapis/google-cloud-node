...
describe('v1.CmsMetadataValueServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new cmsmetadatavalueserviceModule.v1.CmsMetadataValueServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = cmsmetadatavalueserviceModule.v1.CmsMetadataValueServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = cmsmetadatavalueserviceModule.v1.CmsMetadataValueServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new cmsmetadatavalueserviceModule.v1.CmsMetadataValueServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new cmsmetadatavalueserviceModule.v1.CmsMetadataValueServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new cmsmetadatavalueserviceModule.v1.CmsMetadataValueServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new cmsmetadatavalueserviceModule.v1.CmsMetadataValueServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = cmsmetadatavalueserviceModule.v1.CmsMetadataValueServiceClient.port;
            assert(port);
    ...
    describe('getCmsMetadataValue', () => {
        it('invokes getCmsMetadataValue without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetCmsMetadataValueRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.CmsMetadataValue()
            );
            client.innerApiCalls.getCmsMetadataValue = stubSimpleCall(expectedResponse);
            const [response] = await client.getCmsMetadataValue(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getCmsMetadataValue as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getCmsMetadataValue as SinonStub)
        ...
        it('invokes getCmsMetadataValue without error using callback', async () => {
            ...
            client.innerApiCalls.getCmsMetadataValue = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCmsMetadataValue(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.ICmsMetadataValue|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCmsMetadataValue with error', async () => {
            ...
            client.innerApiCalls.getCmsMetadataValue = stubSimpleCall(undefined, expectedError);
    ...
    describe('batchActivateCmsMetadataValues', () => {
        it('invokes batchActivateCmsMetadataValues without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.BatchActivateCmsMetadataValuesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.BatchActivateCmsMetadataValuesResponse()
            );
            client.innerApiCalls.batchActivateCmsMetadataValues = stubSimpleCall(expectedResponse);
            const [response] = await client.batchActivateCmsMetadataValues(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchActivateCmsMetadataValues as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchActivateCmsMetadataValues as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes batchActivateCmsMetadataValues without error using callback', async () => {
            ...
            client.innerApiCalls.batchActivateCmsMetadataValues = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchActivateCmsMetadataValues(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IBatchActivateCmsMetadataValuesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchActivateCmsMetadataValues with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchActivateCmsMetadataValues = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.batchActivateCmsMetadataValues(request), expectedError);
            const actualRequest = (client.innerApiCalls.batchActivateCmsMetadataValues as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchActivateCmsMetadataValues as SinonStub)
    ...
    describe('batchDeactivateCmsMetadataValues', () => {
        it('invokes batchDeactivateCmsMetadataValues without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.BatchDeactivateCmsMetadataValuesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.BatchDeactivateCmsMetadataValuesResponse()
            );
            client.innerApiCalls.batchDeactivateCmsMetadataValues = stubSimpleCall(expectedResponse);
            const [response] = await client.batchDeactivateCmsMetadataValues(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchDeactivateCmsMetadataValues as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchDeactivateCmsMetadataValues as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes batchDeactivateCmsMetadataValues without error using callback', async () => {
            ...
            client.innerApiCalls.batchDeactivateCmsMetadataValues = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchDeactivateCmsMetadataValues(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IBatchDeactivateCmsMetadataValuesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchDeactivateCmsMetadataValues with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchDeactivateCmsMetadataValues = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.batchDeactivateCmsMetadataValues(request), expectedError);
            const actualRequest = (client.innerApiCalls.batchDeactivateCmsMetadataValues as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchDeactivateCmsMetadataValues as SinonStub)
    ...
    describe('listCmsMetadataValues', () => {
        it('invokes listCmsMetadataValues without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListCmsMetadataValuesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.CmsMetadataValue()),
              generateSampleMessage(new protos.google.ads.admanager.v1.CmsMetadataValue()),
              generateSampleMessage(new protos.google.ads.admanager.v1.CmsMetadataValue()),
            ];
            client.innerApiCalls.listCmsMetadataValues = stubSimpleCall(expectedResponse);
            const [response] = await client.listCmsMetadataValues(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listCmsMetadataValues as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listCmsMetadataValues as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listCmsMetadataValues without error using callback', async () => {
            ...
            client.innerApiCalls.listCmsMetadataValues = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listCmsMetadataValues with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listCmsMetadataValues = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listCmsMetadataValues(request), expectedError);
            const actualRequest = (client.innerApiCalls.listCmsMetadataValues as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listCmsMetadataValues as SinonStub)
        ...
        it('invokes listCmsMetadataValuesStream without error', async () => {
            ...
            client.descriptors.page.listCmsMetadataValues.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listCmsMetadataValuesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.CmsMetadataValue[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.CmsMetadataValue) => {
            ...
            assert((client.descriptors.page.listCmsMetadataValues.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listCmsMetadataValues, request));
            assert(
                (client.descriptors.page.listCmsMetadataValues.createStream as SinonStub)
        ...
        it('invokes listCmsMetadataValuesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listCmsMetadataValues.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listCmsMetadataValuesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.CmsMetadataValue[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.CmsMetadataValue) => {
        ...
        it('uses async iteration with listCmsMetadataValues without error', async () => {
            ...
            client.descriptors.page.listCmsMetadataValues.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(
                (client.descriptors.page.listCmsMetadataValues.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listCmsMetadataValues with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listCmsMetadataValues.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listCmsMetadataValuesAsync(request);
