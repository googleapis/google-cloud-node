...
describe('v1.CustomTargetingKeyServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = customtargetingkeyserviceModule.v1.CustomTargetingKeyServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = customtargetingkeyserviceModule.v1.CustomTargetingKeyServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new customtargetingkeyserviceModule.v1.CustomTargetingKeyServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new customtargetingkeyserviceModule.v1.CustomTargetingKeyServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new customtargetingkeyserviceModule.v1.CustomTargetingKeyServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new customtargetingkeyserviceModule.v1.CustomTargetingKeyServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = customtargetingkeyserviceModule.v1.CustomTargetingKeyServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.customTargetingKeyServiceStub, undefined);
    ...
    describe('getCustomTargetingKey', () => {
        it('invokes getCustomTargetingKey without error', async () => {
            const client = new customtargetingkeyserviceModule.v1.CustomTargetingKeyServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetCustomTargetingKeyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.CustomTargetingKey()
            );
            client.innerApiCalls.getCustomTargetingKey = stubSimpleCall(expectedResponse);
            const [response] = await client.getCustomTargetingKey(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getCustomTargetingKey as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getCustomTargetingKey as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getCustomTargetingKey without error using callback', async () => {
            const client = new customtargetingkeyserviceModule.v1.CustomTargetingKeyServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getCustomTargetingKey = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCustomTargetingKey(
                    request,
        ...
        it('invokes getCustomTargetingKey with error', async () => {
            const client = new customtargetingkeyserviceModule.v1.CustomTargetingKeyServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getCustomTargetingKey = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCustomTargetingKey(request), expectedError);
            const actualRequest = (client.innerApiCalls.getCustomTargetingKey as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getCustomTargetingKey as SinonStub)
        ...
        it('invokes getCustomTargetingKey with closed client', async () => {
            const client = new customtargetingkeyserviceModule.v1.CustomTargetingKeyServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('listCustomTargetingKeys', () => {
        it('invokes listCustomTargetingKeys without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListCustomTargetingKeysRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.CustomTargetingKey()),
              generateSampleMessage(new protos.google.ads.admanager.v1.CustomTargetingKey()),
              generateSampleMessage(new protos.google.ads.admanager.v1.CustomTargetingKey()),
            ];
            client.innerApiCalls.listCustomTargetingKeys = stubSimpleCall(expectedResponse);
            const [response] = await client.listCustomTargetingKeys(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listCustomTargetingKeys as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listCustomTargetingKeys as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listCustomTargetingKeys without error using callback', async () => {
            ...
            client.innerApiCalls.listCustomTargetingKeys = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listCustomTargetingKeys(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.ICustomTargetingKey[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listCustomTargetingKeys with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listCustomTargetingKeys = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listCustomTargetingKeys(request), expectedError);
            const actualRequest = (client.innerApiCalls.listCustomTargetingKeys as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listCustomTargetingKeys as SinonStub)
        ...
        it('invokes listCustomTargetingKeysStream without error', async () => {
            ...
            client.descriptors.page.listCustomTargetingKeys.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listCustomTargetingKeysStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.CustomTargetingKey[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.CustomTargetingKey) => {
            ...
            assert((client.descriptors.page.listCustomTargetingKeys.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listCustomTargetingKeys, request));
            assert(
                (client.descriptors.page.listCustomTargetingKeys.createStream as SinonStub)
        ...
        it('invokes listCustomTargetingKeysStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listCustomTargetingKeys.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listCustomTargetingKeysStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.CustomTargetingKey[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.CustomTargetingKey) => {
        ...
        it('uses async iteration with listCustomTargetingKeys without error', async () => {
            const client = new customtargetingkeyserviceModule.v1.CustomTargetingKeyServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listCustomTargetingKeys.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.admanager.v1.ICustomTargetingKey[] = [];
            const iterable = client.listCustomTargetingKeysAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listCustomTargetingKeys.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listCustomTargetingKeys with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listCustomTargetingKeys.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listCustomTargetingKeysAsync(request);
