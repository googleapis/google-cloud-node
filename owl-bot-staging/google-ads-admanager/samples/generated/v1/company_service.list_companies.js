...
function main(parent) {
  // [START admanager_v1_generated_CompanyService_ListCompanies_async]
  /**
  ...
  const {CompanyServiceClient} = require('@google-ads/admanager').v1;

  // Instantiates a client
  const admanagerClient = new CompanyServiceClient();
  ...
  async function callListCompanies() {
    ...
    // Run request
    const iterable = admanagerClient.listCompaniesAsync(request);
  ...
  callListCompanies();
  // [END admanager_v1_generated_CompanyService_ListCompanies_async]
}
