...
function main(parent, names) {
  ...
  async function callBatchAllowAdReviewCenterAds() {
    // Construct request
    const request = {
      parent,
      names,
    ...
    // Run request
    const [operation] = await admanagerClient.batchAllowAdReviewCenterAds(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callBatchAllowAdReviewCenterAds();
