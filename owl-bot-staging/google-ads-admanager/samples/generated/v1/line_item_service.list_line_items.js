...
function main(parent) {
  // [START admanager_v1_generated_LineItemService_ListLineItems_async]
  /**
  ...
  async function callListLineItems() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = admanagerClient.listLineItemsAsync(request);
  ...
  callListLineItems();
  // [END admanager_v1_generated_LineItemService_ListLineItems_async]
}
