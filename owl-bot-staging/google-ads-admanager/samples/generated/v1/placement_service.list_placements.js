...
function main(parent) {
  // [START admanager_v1_generated_PlacementService_ListPlacements_async]
  /**
  ...
  async function callListPlacements() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = admanagerClient.listPlacementsAsync(request);
  ...
  callListPlacements();
  // [END admanager_v1_generated_PlacementService_ListPlacements_async]
}
