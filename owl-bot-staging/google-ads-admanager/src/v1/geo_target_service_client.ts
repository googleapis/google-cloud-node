 ...
 * `src/v1/geo_target_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './geo_target_service_client_config.json';
 ...
 * @memberof v1
 */
export class GeoTargetServiceClient {
  ...
  geoTargetServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of GeoTargetServiceClient.
   *
   ...
   *     const client = new GeoTargetServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof GeoTargetServiceClient;
    ...
    this.descriptors.page = {
      listGeoTargets:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'geoTargets')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.admanager.v1.GeoTargetService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.geoTargetServiceStub) {
      return this.geoTargetServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.GeoTargetService.
    this.geoTargetServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.admanager.v1.GeoTargetService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.GeoTargetService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const geoTargetServiceStubMethods =
        ['getGeoTarget', 'listGeoTargets'];
    for (const methodName of geoTargetServiceStubMethods) {
      const callPromise = this.geoTargetServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.GeoTarget|GeoTarget}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/geo_target_service.get_geo_target.js</caption>
 * region_tag:admanager_v1_generated_GeoTargetService_GetGeoTarget_async
 */
  getGeoTarget(
      request?: protos.google.ads.admanager.v1.IGetGeoTargetRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IGeoTarget,
        protos.google.ads.admanager.v1.IGetGeoTargetRequest|undefined, {}|undefined
      ]>;
  getGeoTarget(
      request: protos.google.ads.admanager.v1.IGetGeoTargetRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IGeoTarget,
          protos.google.ads.admanager.v1.IGetGeoTargetRequest|null|undefined,
          {}|null|undefined>): void;
  getGeoTarget(
      request: protos.google.ads.admanager.v1.IGetGeoTargetRequest,
      callback: Callback<
  ...
  getGeoTarget(
    ...
    this._log.info('getGeoTarget request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IGeoTarget,
        protos.google.ads.admanager.v1.IGetGeoTargetRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('getGeoTarget response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.getGeoTarget(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IGeoTarget,
        protos.google.ads.admanager.v1.IGetGeoTargetRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getGeoTarget response %j', response);
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.GeoTarget|GeoTarget}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listGeoTargetsAsync()`
 *   method described below for async iteration which you can stop as needed.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 */
  listGeoTargets(
      request?: protos.google.ads.admanager.v1.IListGeoTargetsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IGeoTarget[],
        protos.google.ads.admanager.v1.IListGeoTargetsRequest|null,
        protos.google.ads.admanager.v1.IListGeoTargetsResponse
      ]>;
  listGeoTargets(
      request: protos.google.ads.admanager.v1.IListGeoTargetsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListGeoTargetsRequest,
          protos.google.ads.admanager.v1.IListGeoTargetsResponse|null|undefined,
          protos.google.ads.admanager.v1.IGeoTarget>): void;
  listGeoTargets(
      request: protos.google.ads.admanager.v1.IListGeoTargetsRequest,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListGeoTargetsRequest,
  ...
  listGeoTargets(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.ads.admanager.v1.IListGeoTargetsRequest,
      protos.google.ads.admanager.v1.IListGeoTargetsResponse|null|undefined,
      protos.google.ads.admanager.v1.IGeoTarget>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listGeoTargets values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listGeoTargets request %j', request);
    return this.innerApiCalls
      .listGeoTargets(request, options, wrappedCallback)
      ?.then(([response, input, output]: [
        protos.google.ads.admanager.v1.IGeoTarget[],
        protos.google.ads.admanager.v1.IListGeoTargetsRequest|null,
        protos.google.ads.admanager.v1.IListGeoTargetsResponse
      ]) => {
        this._log.info('listGeoTargets values %j', response);
        return [response, input, output];
      });
  }

/**
 * Equivalent to `listGeoTargets`, but returns a NodeJS Stream object.
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 *   Required. The parent, which owns this collection of GeoTargets.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.GeoTarget|GeoTarget} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 */
  listGeoTargetsStream(
    ...
    const defaultCallSettings = this._defaults['listGeoTargets'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listGeoTargets stream %j', request);
    return this.descriptors.page.listGeoTargets.createStream(
      this.innerApiCalls.listGeoTargets as GaxCall,
      request,
      callSettings
    );
  }
...
/**
 * Equivalent to `listGeoTargets`, but returns an iterable object.
 *
 ...
 *   {@link protos.google.ads.admanager.v1.GeoTarget|GeoTarget}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/geo_target_service.list_geo_targets.js</caption>
 * region_tag:admanager_v1_generated_GeoTargetService_ListGeoTargets_async
 */
  listGeoTargetsAsync(
      request?: protos.google.ads.admanager.v1.IListGeoTargetsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.admanager.v1.IGeoTarget>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listGeoTargets iterate %j', request);
    return this.descriptors.page.listGeoTargets.asyncIterate(
      this.innerApiCalls['listGeoTargets'] as GaxCall,
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.ads.admanager.v1.IGeoTarget>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.geoTargetServiceStub && !this._terminated) {
      return this.geoTargetServiceStub.then(stub => {
