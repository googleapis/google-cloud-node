...
export class GeoTargetServiceClient {
  ...
  constructor(
    ...
    this.descriptors.page = {
      listGeoTargets: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'geoTargets',
      ),
  ...
  initialize() {
    ...
    const geoTargetServiceStubMethods = ['getGeoTarget', 'listGeoTargets'];
  ...
  getGeoTarget(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.ads.admanager.v1.IGeoTarget,
          | protos.google.ads.admanager.v1.IGetGeoTargetRequest
          | null
          | undefined,
          {} | null | undefined
        >,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .getGeoTarget(request, options, wrappedCallback)
      ?.then(
