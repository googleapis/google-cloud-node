...
export class MobileDeviceSubmodelServiceClient {
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof MobileDeviceSubmodelServiceClient;
    if (
    ...
    this.descriptors.page = {
      listMobileDeviceSubmodels: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
  ...
  getMobileDeviceSubmodel(
    ...
    [
      ...
      (
        | protos.google.ads.admanager.v1.IGetMobileDeviceSubmodelRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    return this.innerApiCalls
      .getMobileDeviceSubmodel(request, options, wrappedCallback)
      ?.then(
