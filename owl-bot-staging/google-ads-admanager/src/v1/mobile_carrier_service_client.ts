 ...
 * `src/v1/mobile_carrier_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './mobile_carrier_service_client_config.json';
 ...
 * @memberof v1
 */
export class MobileCarrierServiceClient {
  ...
  mobileCarrierServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of MobileCarrierServiceClient.
   *
   ...
   *     const client = new MobileCarrierServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof MobileCarrierServiceClient;
    ...
    this.descriptors.page = {
      listMobileCarriers:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'mobileCarriers')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.admanager.v1.MobileCarrierService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.mobileCarrierServiceStub) {
      return this.mobileCarrierServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.MobileCarrierService.
    this.mobileCarrierServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.admanager.v1.MobileCarrierService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.MobileCarrierService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const mobileCarrierServiceStubMethods =
        ['getMobileCarrier', 'listMobileCarriers'];
    for (const methodName of mobileCarrierServiceStubMethods) {
      const callPromise = this.mobileCarrierServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.MobileCarrier|MobileCarrier}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/mobile_carrier_service.get_mobile_carrier.js</caption>
 * region_tag:admanager_v1_generated_MobileCarrierService_GetMobileCarrier_async
 */
  getMobileCarrier(
      request?: protos.google.ads.admanager.v1.IGetMobileCarrierRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IMobileCarrier,
        protos.google.ads.admanager.v1.IGetMobileCarrierRequest|undefined, {}|undefined
      ]>;
  getMobileCarrier(
      request: protos.google.ads.admanager.v1.IGetMobileCarrierRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IMobileCarrier,
          protos.google.ads.admanager.v1.IGetMobileCarrierRequest|null|undefined,
          {}|null|undefined>): void;
  getMobileCarrier(
      request: protos.google.ads.admanager.v1.IGetMobileCarrierRequest,
      callback: Callback<
  ...
  getMobileCarrier(
    ...
    this._log.info('getMobileCarrier request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IMobileCarrier,
        protos.google.ads.admanager.v1.IGetMobileCarrierRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('getMobileCarrier response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.getMobileCarrier(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IMobileCarrier,
        protos.google.ads.admanager.v1.IGetMobileCarrierRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getMobileCarrier response %j', response);
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.MobileCarrier|MobileCarrier}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listMobileCarriersAsync()`
 *   method described below for async iteration which you can stop as needed.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 */
  listMobileCarriers(
      request?: protos.google.ads.admanager.v1.IListMobileCarriersRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IMobileCarrier[],
        protos.google.ads.admanager.v1.IListMobileCarriersRequest|null,
        protos.google.ads.admanager.v1.IListMobileCarriersResponse
      ]>;
  listMobileCarriers(
      request: protos.google.ads.admanager.v1.IListMobileCarriersRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListMobileCarriersRequest,
          protos.google.ads.admanager.v1.IListMobileCarriersResponse|null|undefined,
          protos.google.ads.admanager.v1.IMobileCarrier>): void;
  listMobileCarriers(
      request: protos.google.ads.admanager.v1.IListMobileCarriersRequest,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListMobileCarriersRequest,
  ...
  listMobileCarriers(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.ads.admanager.v1.IListMobileCarriersRequest,
      protos.google.ads.admanager.v1.IListMobileCarriersResponse|null|undefined,
      protos.google.ads.admanager.v1.IMobileCarrier>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listMobileCarriers values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listMobileCarriers request %j', request);
    return this.innerApiCalls
      .listMobileCarriers(request, options, wrappedCallback)
      ?.then(([response, input, output]: [
        protos.google.ads.admanager.v1.IMobileCarrier[],
        protos.google.ads.admanager.v1.IListMobileCarriersRequest|null,
        protos.google.ads.admanager.v1.IListMobileCarriersResponse
      ]) => {
        this._log.info('listMobileCarriers values %j', response);
        return [response, input, output];
      });
  }

/**
 * Equivalent to `listMobileCarriers`, but returns a NodeJS Stream object.
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 *   Required. The parent, which owns this collection of MobileCarriers.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.MobileCarrier|MobileCarrier} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 */
  listMobileCarriersStream(
    ...
    const defaultCallSettings = this._defaults['listMobileCarriers'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listMobileCarriers stream %j', request);
    return this.descriptors.page.listMobileCarriers.createStream(
      this.innerApiCalls.listMobileCarriers as GaxCall,
      request,
      callSettings
    );
  }
...
/**
 * Equivalent to `listMobileCarriers`, but returns an iterable object.
 *
 ...
 *   {@link protos.google.ads.admanager.v1.MobileCarrier|MobileCarrier}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/mobile_carrier_service.list_mobile_carriers.js</caption>
 * region_tag:admanager_v1_generated_MobileCarrierService_ListMobileCarriers_async
 */
  listMobileCarriersAsync(
      request?: protos.google.ads.admanager.v1.IListMobileCarriersRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.admanager.v1.IMobileCarrier>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listMobileCarriers iterate %j', request);
    return this.descriptors.page.listMobileCarriers.asyncIterate(
      this.innerApiCalls['listMobileCarriers'] as GaxCall,
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.ads.admanager.v1.IMobileCarrier>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.mobileCarrierServiceStub && !this._terminated) {
      return this.mobileCarrierServiceStub.then(stub => {
