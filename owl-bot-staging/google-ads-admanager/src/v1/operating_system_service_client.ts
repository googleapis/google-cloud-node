 ...
 * `src/v1/operating_system_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './operating_system_service_client_config.json';
 ...
 * @memberof v1
 */
export class OperatingSystemServiceClient {
  ...
  operatingSystemServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of OperatingSystemServiceClient.
   *
   ...
   *     const client = new OperatingSystemServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof OperatingSystemServiceClient;
    ...
    this.descriptors.page = {
      listOperatingSystems:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'operatingSystems')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.admanager.v1.OperatingSystemService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.operatingSystemServiceStub) {
      return this.operatingSystemServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.OperatingSystemService.
    this.operatingSystemServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.admanager.v1.OperatingSystemService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.OperatingSystemService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const operatingSystemServiceStubMethods =
        ['getOperatingSystem', 'listOperatingSystems'];
    for (const methodName of operatingSystemServiceStubMethods) {
      const callPromise = this.operatingSystemServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.OperatingSystem|OperatingSystem}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/operating_system_service.get_operating_system.js</caption>
 * region_tag:admanager_v1_generated_OperatingSystemService_GetOperatingSystem_async
 */
  getOperatingSystem(
      request?: protos.google.ads.admanager.v1.IGetOperatingSystemRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IOperatingSystem,
        protos.google.ads.admanager.v1.IGetOperatingSystemRequest|undefined, {}|undefined
      ]>;
  getOperatingSystem(
      request: protos.google.ads.admanager.v1.IGetOperatingSystemRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IOperatingSystem,
          protos.google.ads.admanager.v1.IGetOperatingSystemRequest|null|undefined,
          {}|null|undefined>): void;
  getOperatingSystem(
      request: protos.google.ads.admanager.v1.IGetOperatingSystemRequest,
      callback: Callback<
  ...
  getOperatingSystem(
    ...
    this._log.info('getOperatingSystem request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IOperatingSystem,
        protos.google.ads.admanager.v1.IGetOperatingSystemRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('getOperatingSystem response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.getOperatingSystem(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IOperatingSystem,
        protos.google.ads.admanager.v1.IGetOperatingSystemRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getOperatingSystem response %j', response);
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.OperatingSystem|OperatingSystem}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listOperatingSystemsAsync()`
 *   method described below for async iteration which you can stop as needed.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 */
  listOperatingSystems(
      request?: protos.google.ads.admanager.v1.IListOperatingSystemsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IOperatingSystem[],
        protos.google.ads.admanager.v1.IListOperatingSystemsRequest|null,
        protos.google.ads.admanager.v1.IListOperatingSystemsResponse
      ]>;
  listOperatingSystems(
      request: protos.google.ads.admanager.v1.IListOperatingSystemsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListOperatingSystemsRequest,
          protos.google.ads.admanager.v1.IListOperatingSystemsResponse|null|undefined,
          protos.google.ads.admanager.v1.IOperatingSystem>): void;
  listOperatingSystems(
      request: protos.google.ads.admanager.v1.IListOperatingSystemsRequest,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListOperatingSystemsRequest,
  ...
  listOperatingSystems(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.ads.admanager.v1.IListOperatingSystemsRequest,
      protos.google.ads.admanager.v1.IListOperatingSystemsResponse|null|undefined,
      protos.google.ads.admanager.v1.IOperatingSystem>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listOperatingSystems values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listOperatingSystems request %j', request);
    return this.innerApiCalls
      .listOperatingSystems(request, options, wrappedCallback)
      ?.then(([response, input, output]: [
        protos.google.ads.admanager.v1.IOperatingSystem[],
        protos.google.ads.admanager.v1.IListOperatingSystemsRequest|null,
        protos.google.ads.admanager.v1.IListOperatingSystemsResponse
      ]) => {
        this._log.info('listOperatingSystems values %j', response);
        return [response, input, output];
      });
  }

/**
 * Equivalent to `listOperatingSystems`, but returns a NodeJS Stream object.
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 *   Required. The parent, which owns this collection of OperatingSystems.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.OperatingSystem|OperatingSystem} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 */
  listOperatingSystemsStream(
    ...
    const defaultCallSettings = this._defaults['listOperatingSystems'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listOperatingSystems stream %j', request);
    return this.descriptors.page.listOperatingSystems.createStream(
      this.innerApiCalls.listOperatingSystems as GaxCall,
      request,
      callSettings
    );
  }
...
/**
 * Equivalent to `listOperatingSystems`, but returns an iterable object.
 *
 ...
 *   {@link protos.google.ads.admanager.v1.OperatingSystem|OperatingSystem}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/operating_system_service.list_operating_systems.js</caption>
 * region_tag:admanager_v1_generated_OperatingSystemService_ListOperatingSystems_async
 */
  listOperatingSystemsAsync(
      request?: protos.google.ads.admanager.v1.IListOperatingSystemsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.admanager.v1.IOperatingSystem>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listOperatingSystems iterate %j', request);
    return this.descriptors.page.listOperatingSystems.asyncIterate(
      this.innerApiCalls['listOperatingSystems'] as GaxCall,
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.ads.admanager.v1.IOperatingSystem>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.operatingSystemServiceStub && !this._terminated) {
      return this.operatingSystemServiceStub.then(stub => {
