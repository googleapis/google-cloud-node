 ...
 * `src/v1/content_label_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './content_label_service_client_config.json';
 ...
 * @memberof v1
 */
export class ContentLabelServiceClient {
  ...
  contentLabelServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of ContentLabelServiceClient.
   *
   ...
   *     const client = new ContentLabelServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof ContentLabelServiceClient;
    ...
    this.descriptors.page = {
      listContentLabels:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'contentLabels')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.admanager.v1.ContentLabelService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.contentLabelServiceStub) {
      return this.contentLabelServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.ContentLabelService.
    this.contentLabelServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.admanager.v1.ContentLabelService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.ContentLabelService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const contentLabelServiceStubMethods =
        ['getContentLabel', 'listContentLabels'];
    for (const methodName of contentLabelServiceStubMethods) {
      const callPromise = this.contentLabelServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.ContentLabel|ContentLabel}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/content_label_service.get_content_label.js</caption>
 * region_tag:admanager_v1_generated_ContentLabelService_GetContentLabel_async
 */
  getContentLabel(
      request?: protos.google.ads.admanager.v1.IGetContentLabelRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IContentLabel,
        protos.google.ads.admanager.v1.IGetContentLabelRequest|undefined, {}|undefined
      ]>;
  getContentLabel(
      request: protos.google.ads.admanager.v1.IGetContentLabelRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IContentLabel,
          protos.google.ads.admanager.v1.IGetContentLabelRequest|null|undefined,
          {}|null|undefined>): void;
  getContentLabel(
      request: protos.google.ads.admanager.v1.IGetContentLabelRequest,
      callback: Callback<
  ...
  getContentLabel(
    ...
    this._log.info('getContentLabel request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IContentLabel,
        protos.google.ads.admanager.v1.IGetContentLabelRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('getContentLabel response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.getContentLabel(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IContentLabel,
        protos.google.ads.admanager.v1.IGetContentLabelRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getContentLabel response %j', response);
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.ContentLabel|ContentLabel}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listContentLabelsAsync()`
 *   method described below for async iteration which you can stop as needed.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 */
  listContentLabels(
      request?: protos.google.ads.admanager.v1.IListContentLabelsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IContentLabel[],
        protos.google.ads.admanager.v1.IListContentLabelsRequest|null,
        protos.google.ads.admanager.v1.IListContentLabelsResponse
      ]>;
  listContentLabels(
      request: protos.google.ads.admanager.v1.IListContentLabelsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListContentLabelsRequest,
          protos.google.ads.admanager.v1.IListContentLabelsResponse|null|undefined,
          protos.google.ads.admanager.v1.IContentLabel>): void;
  listContentLabels(
      request: protos.google.ads.admanager.v1.IListContentLabelsRequest,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListContentLabelsRequest,
  ...
  listContentLabels(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.ads.admanager.v1.IListContentLabelsRequest,
      protos.google.ads.admanager.v1.IListContentLabelsResponse|null|undefined,
      protos.google.ads.admanager.v1.IContentLabel>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listContentLabels values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listContentLabels request %j', request);
    return this.innerApiCalls
      .listContentLabels(request, options, wrappedCallback)
      ?.then(([response, input, output]: [
        protos.google.ads.admanager.v1.IContentLabel[],
        protos.google.ads.admanager.v1.IListContentLabelsRequest|null,
        protos.google.ads.admanager.v1.IListContentLabelsResponse
      ]) => {
        this._log.info('listContentLabels values %j', response);
        return [response, input, output];
      });
  }

/**
 * Equivalent to `listContentLabels`, but returns a NodeJS Stream object.
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 *   Required. The parent, which owns this collection of ContentLabels.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.ContentLabel|ContentLabel} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 */
  listContentLabelsStream(
    ...
    const defaultCallSettings = this._defaults['listContentLabels'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listContentLabels stream %j', request);
    return this.descriptors.page.listContentLabels.createStream(
      this.innerApiCalls.listContentLabels as GaxCall,
      request,
      callSettings
    );
  }
...
/**
 * Equivalent to `listContentLabels`, but returns an iterable object.
 *
 ...
 *   {@link protos.google.ads.admanager.v1.ContentLabel|ContentLabel}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/content_label_service.list_content_labels.js</caption>
 * region_tag:admanager_v1_generated_ContentLabelService_ListContentLabels_async
 */
  listContentLabelsAsync(
      request?: protos.google.ads.admanager.v1.IListContentLabelsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.admanager.v1.IContentLabel>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listContentLabels iterate %j', request);
    return this.descriptors.page.listContentLabels.asyncIterate(
      this.innerApiCalls['listContentLabels'] as GaxCall,
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.ads.admanager.v1.IContentLabel>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.contentLabelServiceStub && !this._terminated) {
      return this.contentLabelServiceStub.then(stub => {
