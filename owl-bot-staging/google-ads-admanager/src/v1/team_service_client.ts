 ...
 * `src/v1/team_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './team_service_client_config.json';
...
export class TeamServiceClient {
  ...
  teamServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of TeamServiceClient.
   *
   ...
   *     const client = new TeamServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof TeamServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.admanager.v1.TeamService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.teamServiceStub) {
      return this.teamServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.TeamService.
    this.teamServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.admanager.v1.TeamService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.TeamService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const teamServiceStubMethods =
        ['getTeam', 'listTeams', 'createTeam', 'batchCreateTeams', 'updateTeam', 'batchUpdateTeams', 'batchActivateTeams', 'batchDeactivateTeams'];
    for (const methodName of teamServiceStubMethods) {
      const callPromise = this.teamServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.Team|Team}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/team_service.get_team.js</caption>
 * region_tag:admanager_v1_generated_TeamService_GetTeam_async
 */
  getTeam(
      request?: protos.google.ads.admanager.v1.IGetTeamRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.ITeam,
        protos.google.ads.admanager.v1.IGetTeamRequest|undefined, {}|undefined
      ]>;
  getTeam(
      request: protos.google.ads.admanager.v1.IGetTeamRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.ITeam,
          protos.google.ads.admanager.v1.IGetTeamRequest|null|undefined,
          {}|null|undefined>): void;
  getTeam(
      request: protos.google.ads.admanager.v1.IGetTeamRequest,
      callback: Callback<
  ...
  getTeam(
    ...
    this._log.info('getTeam request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.ITeam,
        protos.google.ads.admanager.v1.IGetTeamRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('getTeam response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.getTeam(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.ITeam,
        protos.google.ads.admanager.v1.IGetTeamRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getTeam response %j', response);
 ...
 * @param {google.ads.admanager.v1.Team} request.team
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/team_service.create_team.js</caption>
 * region_tag:admanager_v1_generated_TeamService_CreateTeam_async
 */
  createTeam(
      request?: protos.google.ads.admanager.v1.ICreateTeamRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.ITeam,
        protos.google.ads.admanager.v1.ICreateTeamRequest|undefined, {}|undefined
      ]>;
  createTeam(
      request: protos.google.ads.admanager.v1.ICreateTeamRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.ITeam,
          protos.google.ads.admanager.v1.ICreateTeamRequest|null|undefined,
          {}|null|undefined>): void;
  createTeam(
      request: protos.google.ads.admanager.v1.ICreateTeamRequest,
      callback: Callback<
  ...
  createTeam(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('createTeam request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.ITeam,
        protos.google.ads.admanager.v1.ICreateTeamRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('createTeam response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.createTeam(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.ITeam,
        protos.google.ads.admanager.v1.ICreateTeamRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('createTeam response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchCreateTeamsResponse|BatchCreateTeamsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/team_service.batch_create_teams.js</caption>
 * region_tag:admanager_v1_generated_TeamService_BatchCreateTeams_async
 */
  batchCreateTeams(
      request?: protos.google.ads.admanager.v1.IBatchCreateTeamsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IBatchCreateTeamsResponse,
        protos.google.ads.admanager.v1.IBatchCreateTeamsRequest|undefined, {}|undefined
      ]>;
  batchCreateTeams(
      request: protos.google.ads.admanager.v1.IBatchCreateTeamsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IBatchCreateTeamsResponse,
          protos.google.ads.admanager.v1.IBatchCreateTeamsRequest|null|undefined,
          {}|null|undefined>): void;
  batchCreateTeams(
      request: protos.google.ads.admanager.v1.IBatchCreateTeamsRequest,
      callback: Callback<
  ...
  batchCreateTeams(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('batchCreateTeams request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IBatchCreateTeamsResponse,
        protos.google.ads.admanager.v1.IBatchCreateTeamsRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchCreateTeams response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.batchCreateTeams(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IBatchCreateTeamsResponse,
        protos.google.ads.admanager.v1.IBatchCreateTeamsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('batchCreateTeams response %j', response);
        return [response, options, rawResponse];
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/team_service.update_team.js</caption>
 * region_tag:admanager_v1_generated_TeamService_UpdateTeam_async
 */
  updateTeam(
      request?: protos.google.ads.admanager.v1.IUpdateTeamRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.ITeam,
        protos.google.ads.admanager.v1.IUpdateTeamRequest|undefined, {}|undefined
      ]>;
  updateTeam(
      request: protos.google.ads.admanager.v1.IUpdateTeamRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.ITeam,
          protos.google.ads.admanager.v1.IUpdateTeamRequest|null|undefined,
          {}|null|undefined>): void;
  updateTeam(
      request: protos.google.ads.admanager.v1.IUpdateTeamRequest,
      callback: Callback<
  ...
  updateTeam(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('updateTeam request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.ITeam,
        protos.google.ads.admanager.v1.IUpdateTeamRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('updateTeam response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.updateTeam(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.ITeam,
        protos.google.ads.admanager.v1.IUpdateTeamRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('updateTeam response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchUpdateTeamsResponse|BatchUpdateTeamsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/team_service.batch_update_teams.js</caption>
 * region_tag:admanager_v1_generated_TeamService_BatchUpdateTeams_async
 */
  batchUpdateTeams(
      request?: protos.google.ads.admanager.v1.IBatchUpdateTeamsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IBatchUpdateTeamsResponse,
        protos.google.ads.admanager.v1.IBatchUpdateTeamsRequest|undefined, {}|undefined
      ]>;
  batchUpdateTeams(
      request: protos.google.ads.admanager.v1.IBatchUpdateTeamsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IBatchUpdateTeamsResponse,
          protos.google.ads.admanager.v1.IBatchUpdateTeamsRequest|null|undefined,
          {}|null|undefined>): void;
  batchUpdateTeams(
      request: protos.google.ads.admanager.v1.IBatchUpdateTeamsRequest,
      callback: Callback<
  ...
  batchUpdateTeams(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('batchUpdateTeams request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IBatchUpdateTeamsResponse,
        protos.google.ads.admanager.v1.IBatchUpdateTeamsRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchUpdateTeams response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.batchUpdateTeams(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IBatchUpdateTeamsResponse,
        protos.google.ads.admanager.v1.IBatchUpdateTeamsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('batchUpdateTeams response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchActivateTeamsResponse|BatchActivateTeamsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/team_service.batch_activate_teams.js</caption>
 * region_tag:admanager_v1_generated_TeamService_BatchActivateTeams_async
 */
  batchActivateTeams(
      request?: protos.google.ads.admanager.v1.IBatchActivateTeamsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IBatchActivateTeamsResponse,
        protos.google.ads.admanager.v1.IBatchActivateTeamsRequest|undefined, {}|undefined
      ]>;
  batchActivateTeams(
      request: protos.google.ads.admanager.v1.IBatchActivateTeamsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IBatchActivateTeamsResponse,
          protos.google.ads.admanager.v1.IBatchActivateTeamsRequest|null|undefined,
          {}|null|undefined>): void;
  batchActivateTeams(
      request: protos.google.ads.admanager.v1.IBatchActivateTeamsRequest,
      callback: Callback<
  ...
  batchActivateTeams(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('batchActivateTeams request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IBatchActivateTeamsResponse,
        protos.google.ads.admanager.v1.IBatchActivateTeamsRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchActivateTeams response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.batchActivateTeams(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IBatchActivateTeamsResponse,
        protos.google.ads.admanager.v1.IBatchActivateTeamsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('batchActivateTeams response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchDeactivateTeamsResponse|BatchDeactivateTeamsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/team_service.batch_deactivate_teams.js</caption>
 * region_tag:admanager_v1_generated_TeamService_BatchDeactivateTeams_async
 */
  batchDeactivateTeams(
      request?: protos.google.ads.admanager.v1.IBatchDeactivateTeamsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IBatchDeactivateTeamsResponse,
        protos.google.ads.admanager.v1.IBatchDeactivateTeamsRequest|undefined, {}|undefined
      ]>;
  batchDeactivateTeams(
      request: protos.google.ads.admanager.v1.IBatchDeactivateTeamsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IBatchDeactivateTeamsResponse,
          protos.google.ads.admanager.v1.IBatchDeactivateTeamsRequest|null|undefined,
          {}|null|undefined>): void;
  batchDeactivateTeams(
      request: protos.google.ads.admanager.v1.IBatchDeactivateTeamsRequest,
      callback: Callback<
  ...
  batchDeactivateTeams(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('batchDeactivateTeams request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IBatchDeactivateTeamsResponse,
        protos.google.ads.admanager.v1.IBatchDeactivateTeamsRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchDeactivateTeams response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.batchDeactivateTeams(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IBatchDeactivateTeamsResponse,
        protos.google.ads.admanager.v1.IBatchDeactivateTeamsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('batchDeactivateTeams response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.Team|Team}.
 ...
 */
  listTeams(
      request?: protos.google.ads.admanager.v1.IListTeamsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.ITeam[],
        protos.google.ads.admanager.v1.IListTeamsRequest|null,
        protos.google.ads.admanager.v1.IListTeamsResponse
      ]>;
  listTeams(
      request: protos.google.ads.admanager.v1.IListTeamsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListTeamsRequest,
          protos.google.ads.admanager.v1.IListTeamsResponse|null|undefined,
          protos.google.ads.admanager.v1.ITeam>): void;
  listTeams(
      request: protos.google.ads.admanager.v1.IListTeamsRequest,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListTeamsRequest,
  ...
  listTeams(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.ads.admanager.v1.IListTeamsRequest,
      protos.google.ads.admanager.v1.IListTeamsResponse|null|undefined,
      protos.google.ads.admanager.v1.ITeam>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listTeams values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listTeams request %j', request);
    return this.innerApiCalls
      .listTeams(request, options, wrappedCallback)
      ?.then(([response, input, output]: [
        protos.google.ads.admanager.v1.ITeam[],
        protos.google.ads.admanager.v1.IListTeamsRequest|null,
        protos.google.ads.admanager.v1.IListTeamsResponse
      ]) => {
        this._log.info('listTeams values %j', response);
        return [response, input, output];
      });
  }

/**
 * Equivalent to `listTeams`, but returns a NodeJS Stream object.
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 *   Required. The parent, which owns this collection of Teams.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.Team|Team} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 */
  listTeamsStream(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('listTeams stream %j', request);
 ...
 *   {@link protos.google.ads.admanager.v1.Team|Team}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/team_service.list_teams.js</caption>
 * region_tag:admanager_v1_generated_TeamService_ListTeams_async
 */
  listTeamsAsync(
      request?: protos.google.ads.admanager.v1.IListTeamsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.admanager.v1.ITeam>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listTeams iterate %j', request);
    return this.descriptors.page.listTeams.asyncIterate(
      this.innerApiCalls['listTeams'] as GaxCall,
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.ads.admanager.v1.ITeam>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.teamServiceStub && !this._terminated) {
      return this.teamServiceStub.then(stub => {
