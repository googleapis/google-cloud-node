 ...
 * `src/v1/content_bundle_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './content_bundle_service_client_config.json';
 ...
 * @memberof v1
 */
export class ContentBundleServiceClient {
  ...
  contentBundleServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of ContentBundleServiceClient.
   *
   ...
   *     const client = new ContentBundleServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof ContentBundleServiceClient;
    ...
    this.descriptors.page = {
      listContentBundles:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'contentBundles')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.admanager.v1.ContentBundleService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.contentBundleServiceStub) {
      return this.contentBundleServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.ContentBundleService.
    this.contentBundleServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.admanager.v1.ContentBundleService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.ContentBundleService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const contentBundleServiceStubMethods =
        ['getContentBundle', 'listContentBundles'];
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.ContentBundle|ContentBundle}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/content_bundle_service.get_content_bundle.js</caption>
 * region_tag:admanager_v1_generated_ContentBundleService_GetContentBundle_async
 */
  getContentBundle(
      request?: protos.google.ads.admanager.v1.IGetContentBundleRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IContentBundle,
        protos.google.ads.admanager.v1.IGetContentBundleRequest|undefined, {}|undefined
      ]>;
  getContentBundle(
      request: protos.google.ads.admanager.v1.IGetContentBundleRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IContentBundle,
          protos.google.ads.admanager.v1.IGetContentBundleRequest|null|undefined,
          {}|null|undefined>): void;
  getContentBundle(
      request: protos.google.ads.admanager.v1.IGetContentBundleRequest,
      callback: Callback<
  ...
  getContentBundle(
    ...
    this._log.info('getContentBundle request %j', request);
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getContentBundle(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IContentBundle,
        protos.google.ads.admanager.v1.IGetContentBundleRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getContentBundle response %j', response);
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.ContentBundle|ContentBundle}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listContentBundlesAsync()`
 ...
 */
  listContentBundles(
      ...
      Promise<[
        protos.google.ads.admanager.v1.IContentBundle[],
        protos.google.ads.admanager.v1.IListContentBundlesRequest|null,
        protos.google.ads.admanager.v1.IListContentBundlesResponse
      ]>;
  listContentBundles(
      request: protos.google.ads.admanager.v1.IListContentBundlesRequest,
      options: CallOptions,
      callback: PaginationCallback<
          ...
          protos.google.ads.admanager.v1.IListContentBundlesResponse|null|undefined,
          protos.google.ads.admanager.v1.IContentBundle>): void;
  listContentBundles(
      request: protos.google.ads.admanager.v1.IListContentBundlesRequest,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListContentBundlesRequest,
  ...
  listContentBundles(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.ads.admanager.v1.IListContentBundlesRequest,
      protos.google.ads.admanager.v1.IListContentBundlesResponse|null|undefined,
      protos.google.ads.admanager.v1.IContentBundle>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listContentBundles values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listContentBundles request %j', request);
    return this.innerApiCalls
      .listContentBundles(request, options, wrappedCallback)
      ?.then(([response, input, output]: [
        protos.google.ads.admanager.v1.IContentBundle[],
        protos.google.ads.admanager.v1.IListContentBundlesRequest|null,
        protos.google.ads.admanager.v1.IListContentBundlesResponse
      ]) => {
        this._log.info('listContentBundles values %j', response);
        return [response, input, output];
      });
  }

/**
 * Equivalent to `listContentBundles`, but returns a NodeJS Stream object.
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 *   Required. The parent, which owns this collection of ContentBundles.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.ContentBundle|ContentBundle} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 */
  listContentBundlesStream(
    ...
    const defaultCallSettings = this._defaults['listContentBundles'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listContentBundles stream %j', request);
    return this.descriptors.page.listContentBundles.createStream(
      this.innerApiCalls.listContentBundles as GaxCall,
      request,
      callSettings
    );
  }
...
/**
 * Equivalent to `listContentBundles`, but returns an iterable object.
 *
 ...
 *   {@link protos.google.ads.admanager.v1.ContentBundle|ContentBundle}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/content_bundle_service.list_content_bundles.js</caption>
 * region_tag:admanager_v1_generated_ContentBundleService_ListContentBundles_async
 */
  listContentBundlesAsync(
      request?: protos.google.ads.admanager.v1.IListContentBundlesRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.admanager.v1.IContentBundle>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listContentBundles iterate %j', request);
    return this.descriptors.page.listContentBundles.asyncIterate(
      this.innerApiCalls['listContentBundles'] as GaxCall,
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.ads.admanager.v1.IContentBundle>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.contentBundleServiceStub && !this._terminated) {
      return this.contentBundleServiceStub.then(stub => {
