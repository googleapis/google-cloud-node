 ...
 * `src/v1/browser_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './browser_service_client_config.json';
...
export class BrowserServiceClient {
  ...
  browserServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of BrowserServiceClient.
   *
   ...
   *     const client = new BrowserServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof BrowserServiceClient;
    ...
    this.descriptors.page = {
      listBrowsers:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'browsers')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.admanager.v1.BrowserService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.browserServiceStub) {
      return this.browserServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.BrowserService.
    this.browserServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.admanager.v1.BrowserService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.BrowserService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const browserServiceStubMethods =
        ['getBrowser', 'listBrowsers'];
    for (const methodName of browserServiceStubMethods) {
      const callPromise = this.browserServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.Browser|Browser}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/browser_service.get_browser.js</caption>
 * region_tag:admanager_v1_generated_BrowserService_GetBrowser_async
 */
  getBrowser(
      request?: protos.google.ads.admanager.v1.IGetBrowserRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IBrowser,
        protos.google.ads.admanager.v1.IGetBrowserRequest|undefined, {}|undefined
      ]>;
  getBrowser(
      request: protos.google.ads.admanager.v1.IGetBrowserRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IBrowser,
          protos.google.ads.admanager.v1.IGetBrowserRequest|null|undefined,
          {}|null|undefined>): void;
  getBrowser(
      request: protos.google.ads.admanager.v1.IGetBrowserRequest,
      callback: Callback<
  ...
  getBrowser(
    ...
    this._log.info('getBrowser request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IBrowser,
        protos.google.ads.admanager.v1.IGetBrowserRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('getBrowser response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.getBrowser(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IBrowser,
        protos.google.ads.admanager.v1.IGetBrowserRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getBrowser response %j', response);
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.Browser|Browser}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listBrowsersAsync()`
 *   method described below for async iteration which you can stop as needed.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 */
  listBrowsers(
      request?: protos.google.ads.admanager.v1.IListBrowsersRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IBrowser[],
        protos.google.ads.admanager.v1.IListBrowsersRequest|null,
        protos.google.ads.admanager.v1.IListBrowsersResponse
      ]>;
  listBrowsers(
      request: protos.google.ads.admanager.v1.IListBrowsersRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListBrowsersRequest,
          protos.google.ads.admanager.v1.IListBrowsersResponse|null|undefined,
          protos.google.ads.admanager.v1.IBrowser>): void;
  listBrowsers(
      request: protos.google.ads.admanager.v1.IListBrowsersRequest,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListBrowsersRequest,
  ...
  listBrowsers(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.ads.admanager.v1.IListBrowsersRequest,
      protos.google.ads.admanager.v1.IListBrowsersResponse|null|undefined,
      protos.google.ads.admanager.v1.IBrowser>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listBrowsers values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listBrowsers request %j', request);
    return this.innerApiCalls
      .listBrowsers(request, options, wrappedCallback)
      ?.then(([response, input, output]: [
        protos.google.ads.admanager.v1.IBrowser[],
        protos.google.ads.admanager.v1.IListBrowsersRequest|null,
        protos.google.ads.admanager.v1.IListBrowsersResponse
      ]) => {
        this._log.info('listBrowsers values %j', response);
        return [response, input, output];
      });
  }

/**
 * Equivalent to `listBrowsers`, but returns a NodeJS Stream object.
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 *   Required. The parent, which owns this collection of Browsers.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.Browser|Browser} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 */
  listBrowsersStream(
    ...
    const defaultCallSettings = this._defaults['listBrowsers'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listBrowsers stream %j', request);
    return this.descriptors.page.listBrowsers.createStream(
      this.innerApiCalls.listBrowsers as GaxCall,
      request,
      callSettings
    );
  }
...
/**
 * Equivalent to `listBrowsers`, but returns an iterable object.
 *
 ...
 *   {@link protos.google.ads.admanager.v1.Browser|Browser}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/browser_service.list_browsers.js</caption>
 * region_tag:admanager_v1_generated_BrowserService_ListBrowsers_async
 */
  listBrowsersAsync(
      request?: protos.google.ads.admanager.v1.IListBrowsersRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.admanager.v1.IBrowser>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listBrowsers iterate %j', request);
    return this.descriptors.page.listBrowsers.asyncIterate(
      this.innerApiCalls['listBrowsers'] as GaxCall,
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.ads.admanager.v1.IBrowser>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.browserServiceStub && !this._terminated) {
      return this.browserServiceStub.then(stub => {
