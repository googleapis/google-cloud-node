 ...
 * `src/v1/custom_field_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './custom_field_service_client_config.json';
 ...
 * @memberof v1
 */
export class CustomFieldServiceClient {
  ...
  customFieldServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of CustomFieldServiceClient.
   *
   ...
   *     const client = new CustomFieldServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof CustomFieldServiceClient;
    ...
    this.descriptors.page = {
      listCustomFields:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'customFields')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.admanager.v1.CustomFieldService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.customFieldServiceStub) {
      return this.customFieldServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.CustomFieldService.
    this.customFieldServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.admanager.v1.CustomFieldService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.CustomFieldService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const customFieldServiceStubMethods =
        ['getCustomField', 'listCustomFields', 'createCustomField', 'batchCreateCustomFields', 'updateCustomField', 'batchUpdateCustomFields', 'batchActivateCustomFields', 'batchDeactivateCustomFields'];
    for (const methodName of customFieldServiceStubMethods) {
      const callPromise = this.customFieldServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.CustomField|CustomField}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/custom_field_service.get_custom_field.js</caption>
 * region_tag:admanager_v1_generated_CustomFieldService_GetCustomField_async
 */
  getCustomField(
      request?: protos.google.ads.admanager.v1.IGetCustomFieldRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.ICustomField,
        protos.google.ads.admanager.v1.IGetCustomFieldRequest|undefined, {}|undefined
      ]>;
  getCustomField(
      request: protos.google.ads.admanager.v1.IGetCustomFieldRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.ICustomField,
          protos.google.ads.admanager.v1.IGetCustomFieldRequest|null|undefined,
          {}|null|undefined>): void;
  getCustomField(
      request: protos.google.ads.admanager.v1.IGetCustomFieldRequest,
      callback: Callback<
  ...
  getCustomField(
    ...
    const wrappedCallback: Callback<
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('getCustomField response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.getCustomField(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.ICustomField,
        protos.google.ads.admanager.v1.IGetCustomFieldRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getCustomField response %j', response);
 ...
 * @param {google.ads.admanager.v1.CustomField} request.customField
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/custom_field_service.create_custom_field.js</caption>
 * region_tag:admanager_v1_generated_CustomFieldService_CreateCustomField_async
 */
  createCustomField(
      request?: protos.google.ads.admanager.v1.ICreateCustomFieldRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.ICustomField,
        protos.google.ads.admanager.v1.ICreateCustomFieldRequest|undefined, {}|undefined
      ]>;
  createCustomField(
      request: protos.google.ads.admanager.v1.ICreateCustomFieldRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.ICustomField,
          protos.google.ads.admanager.v1.ICreateCustomFieldRequest|null|undefined,
          {}|null|undefined>): void;
  createCustomField(
      request: protos.google.ads.admanager.v1.ICreateCustomFieldRequest,
      callback: Callback<
  ...
  createCustomField(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('createCustomField request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.ICustomField,
        protos.google.ads.admanager.v1.ICreateCustomFieldRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('createCustomField response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.createCustomField(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.ICustomField,
        protos.google.ads.admanager.v1.ICreateCustomFieldRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('createCustomField response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchCreateCustomFieldsResponse|BatchCreateCustomFieldsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/custom_field_service.batch_create_custom_fields.js</caption>
 * region_tag:admanager_v1_generated_CustomFieldService_BatchCreateCustomFields_async
 */
  batchCreateCustomFields(
      request?: protos.google.ads.admanager.v1.IBatchCreateCustomFieldsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IBatchCreateCustomFieldsResponse,
        protos.google.ads.admanager.v1.IBatchCreateCustomFieldsRequest|undefined, {}|undefined
      ]>;
  batchCreateCustomFields(
      request: protos.google.ads.admanager.v1.IBatchCreateCustomFieldsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IBatchCreateCustomFieldsResponse,
          protos.google.ads.admanager.v1.IBatchCreateCustomFieldsRequest|null|undefined,
          {}|null|undefined>): void;
  batchCreateCustomFields(
      request: protos.google.ads.admanager.v1.IBatchCreateCustomFieldsRequest,
      callback: Callback<
  ...
  batchCreateCustomFields(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('batchCreateCustomFields request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IBatchCreateCustomFieldsResponse,
        protos.google.ads.admanager.v1.IBatchCreateCustomFieldsRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchCreateCustomFields response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.batchCreateCustomFields(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IBatchCreateCustomFieldsResponse,
        protos.google.ads.admanager.v1.IBatchCreateCustomFieldsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('batchCreateCustomFields response %j', response);
        return [response, options, rawResponse];
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/custom_field_service.update_custom_field.js</caption>
 * region_tag:admanager_v1_generated_CustomFieldService_UpdateCustomField_async
 */
  updateCustomField(
      request?: protos.google.ads.admanager.v1.IUpdateCustomFieldRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.ICustomField,
        protos.google.ads.admanager.v1.IUpdateCustomFieldRequest|undefined, {}|undefined
      ]>;
  updateCustomField(
      request: protos.google.ads.admanager.v1.IUpdateCustomFieldRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.ICustomField,
          protos.google.ads.admanager.v1.IUpdateCustomFieldRequest|null|undefined,
          {}|null|undefined>): void;
  updateCustomField(
      request: protos.google.ads.admanager.v1.IUpdateCustomFieldRequest,
      callback: Callback<
  ...
  updateCustomField(
    ...
    options.otherArgs.headers[
      ...
      'custom_field.name': request.customField!.name ?? '',
    });
    this.initialize().catch(err => {throw err});
    this._log.info('updateCustomField request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.ICustomField,
        protos.google.ads.admanager.v1.IUpdateCustomFieldRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('updateCustomField response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.updateCustomField(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.ICustomField,
        protos.google.ads.admanager.v1.IUpdateCustomFieldRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('updateCustomField response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchUpdateCustomFieldsResponse|BatchUpdateCustomFieldsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/custom_field_service.batch_update_custom_fields.js</caption>
 * region_tag:admanager_v1_generated_CustomFieldService_BatchUpdateCustomFields_async
 */
  batchUpdateCustomFields(
      request?: protos.google.ads.admanager.v1.IBatchUpdateCustomFieldsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IBatchUpdateCustomFieldsResponse,
        protos.google.ads.admanager.v1.IBatchUpdateCustomFieldsRequest|undefined, {}|undefined
      ]>;
  batchUpdateCustomFields(
      request: protos.google.ads.admanager.v1.IBatchUpdateCustomFieldsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IBatchUpdateCustomFieldsResponse,
          protos.google.ads.admanager.v1.IBatchUpdateCustomFieldsRequest|null|undefined,
          {}|null|undefined>): void;
  batchUpdateCustomFields(
      request: protos.google.ads.admanager.v1.IBatchUpdateCustomFieldsRequest,
      callback: Callback<
  ...
  batchUpdateCustomFields(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('batchUpdateCustomFields request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IBatchUpdateCustomFieldsResponse,
        protos.google.ads.admanager.v1.IBatchUpdateCustomFieldsRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchUpdateCustomFields response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.batchUpdateCustomFields(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IBatchUpdateCustomFieldsResponse,
        protos.google.ads.admanager.v1.IBatchUpdateCustomFieldsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('batchUpdateCustomFields response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchActivateCustomFieldsResponse|BatchActivateCustomFieldsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/custom_field_service.batch_activate_custom_fields.js</caption>
 * region_tag:admanager_v1_generated_CustomFieldService_BatchActivateCustomFields_async
 */
  batchActivateCustomFields(
      request?: protos.google.ads.admanager.v1.IBatchActivateCustomFieldsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IBatchActivateCustomFieldsResponse,
        protos.google.ads.admanager.v1.IBatchActivateCustomFieldsRequest|undefined, {}|undefined
      ]>;
  batchActivateCustomFields(
      request: protos.google.ads.admanager.v1.IBatchActivateCustomFieldsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IBatchActivateCustomFieldsResponse,
          protos.google.ads.admanager.v1.IBatchActivateCustomFieldsRequest|null|undefined,
          {}|null|undefined>): void;
  batchActivateCustomFields(
      request: protos.google.ads.admanager.v1.IBatchActivateCustomFieldsRequest,
      callback: Callback<
  ...
  batchActivateCustomFields(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('batchActivateCustomFields request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IBatchActivateCustomFieldsResponse,
        protos.google.ads.admanager.v1.IBatchActivateCustomFieldsRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchActivateCustomFields response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.batchActivateCustomFields(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IBatchActivateCustomFieldsResponse,
        protos.google.ads.admanager.v1.IBatchActivateCustomFieldsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('batchActivateCustomFields response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchDeactivateCustomFieldsResponse|BatchDeactivateCustomFieldsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/custom_field_service.batch_deactivate_custom_fields.js</caption>
 * region_tag:admanager_v1_generated_CustomFieldService_BatchDeactivateCustomFields_async
 */
  batchDeactivateCustomFields(
      request?: protos.google.ads.admanager.v1.IBatchDeactivateCustomFieldsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IBatchDeactivateCustomFieldsResponse,
        protos.google.ads.admanager.v1.IBatchDeactivateCustomFieldsRequest|undefined, {}|undefined
      ]>;
  batchDeactivateCustomFields(
      request: protos.google.ads.admanager.v1.IBatchDeactivateCustomFieldsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IBatchDeactivateCustomFieldsResponse,
          protos.google.ads.admanager.v1.IBatchDeactivateCustomFieldsRequest|null|undefined,
          {}|null|undefined>): void;
  batchDeactivateCustomFields(
      request: protos.google.ads.admanager.v1.IBatchDeactivateCustomFieldsRequest,
      callback: Callback<
  ...
  batchDeactivateCustomFields(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('batchDeactivateCustomFields request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IBatchDeactivateCustomFieldsResponse,
        protos.google.ads.admanager.v1.IBatchDeactivateCustomFieldsRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchDeactivateCustomFields response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.batchDeactivateCustomFields(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IBatchDeactivateCustomFieldsResponse,
        protos.google.ads.admanager.v1.IBatchDeactivateCustomFieldsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('batchDeactivateCustomFields response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.CustomField|CustomField}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listCustomFieldsAsync()`
 *   method described below for async iteration which you can stop as needed.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 */
  listCustomFields(
      request?: protos.google.ads.admanager.v1.IListCustomFieldsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.ICustomField[],
        protos.google.ads.admanager.v1.IListCustomFieldsRequest|null,
        protos.google.ads.admanager.v1.IListCustomFieldsResponse
      ]>;
  listCustomFields(
      request: protos.google.ads.admanager.v1.IListCustomFieldsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          ...
          protos.google.ads.admanager.v1.IListCustomFieldsResponse|null|undefined,
          protos.google.ads.admanager.v1.ICustomField>): void;
  listCustomFields(
      request: protos.google.ads.admanager.v1.IListCustomFieldsRequest,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListCustomFieldsRequest,
  ...
  listCustomFields(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.ads.admanager.v1.IListCustomFieldsRequest,
      protos.google.ads.admanager.v1.IListCustomFieldsResponse|null|undefined,
      protos.google.ads.admanager.v1.ICustomField>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listCustomFields values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listCustomFields request %j', request);
    return this.innerApiCalls
      .listCustomFields(request, options, wrappedCallback)
      ?.then(([response, input, output]: [
        protos.google.ads.admanager.v1.ICustomField[],
        protos.google.ads.admanager.v1.IListCustomFieldsRequest|null,
        protos.google.ads.admanager.v1.IListCustomFieldsResponse
      ]) => {
        this._log.info('listCustomFields values %j', response);
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.CustomField|CustomField} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
...
/**
 * Equivalent to `listCustomFields`, but returns an iterable object.
 *
 ...
 *   {@link protos.google.ads.admanager.v1.CustomField|CustomField}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/custom_field_service.list_custom_fields.js</caption>
 * region_tag:admanager_v1_generated_CustomFieldService_ListCustomFields_async
 */
  listCustomFieldsAsync(
      request?: protos.google.ads.admanager.v1.IListCustomFieldsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.admanager.v1.ICustomField>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listCustomFields.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.ads.admanager.v1.ICustomField>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.customFieldServiceStub && !this._terminated) {
      return this.customFieldServiceStub.then(stub => {
