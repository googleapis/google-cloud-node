...
export class DeviceCategoryServiceClient {
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof DeviceCategoryServiceClient;
    if (
    ...
    this.descriptors.page = {
      listDeviceCategories: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'deviceCategories',
      ),
  ...
  getDeviceCategory(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IDeviceCategory,
      | protos.google.ads.admanager.v1.IGetDeviceCategoryRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .getDeviceCategory(request, options, wrappedCallback)
      ?.then(
