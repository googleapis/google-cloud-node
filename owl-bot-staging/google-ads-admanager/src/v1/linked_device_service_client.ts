...
export class LinkedDeviceServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this.descriptors.page = {
      listLinkedDevices:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'linkedDevices')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.admanager.v1.LinkedDeviceService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.linkedDeviceServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.admanager.v1.LinkedDeviceService') :
    ...
    const linkedDeviceServiceStubMethods =
        ['getLinkedDevice', 'listLinkedDevices'];
 ...
 */
  getLinkedDevice(
      ...
      Promise<[
        ...
        protos.google.ads.admanager.v1.IGetLinkedDeviceRequest|undefined, {}|undefined
      ]>;
  getLinkedDevice(
      request: protos.google.ads.admanager.v1.IGetLinkedDeviceRequest,
      options: CallOptions,
  ...
  getLinkedDevice(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getLinkedDevice(request, options, wrappedCallback)
 ...
 */
  ...
  listLinkedDevices(
      ...
      callback: PaginationCallback<
          ...
          protos.google.ads.admanager.v1.IListLinkedDevicesResponse|null|undefined,
          protos.google.ads.admanager.v1.ILinkedDevice>): void;
  listLinkedDevices(
      request: protos.google.ads.admanager.v1.IListLinkedDevicesRequest,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListLinkedDevicesRequest,
  ...
  listLinkedDevices(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.ads.admanager.v1.IListLinkedDevicesRequest,
      protos.google.ads.admanager.v1.IListLinkedDevicesResponse|null|undefined,
      protos.google.ads.admanager.v1.ILinkedDevice>|undefined = callback
