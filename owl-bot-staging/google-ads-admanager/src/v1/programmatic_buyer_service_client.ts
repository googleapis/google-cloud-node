...
export class ProgrammaticBuyerServiceClient {
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof ProgrammaticBuyerServiceClient;
    if (
    ...
    this.descriptors.page = {
      listProgrammaticBuyers: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'programmaticBuyers',
      ),
  ...
  getProgrammaticBuyer(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IProgrammaticBuyer,
      | protos.google.ads.admanager.v1.IGetProgrammaticBuyerRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .getProgrammaticBuyer(request, options, wrappedCallback)
      ?.then(
