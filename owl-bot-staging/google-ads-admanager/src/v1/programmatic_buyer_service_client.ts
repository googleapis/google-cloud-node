 ...
 * `src/v1/programmatic_buyer_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './programmatic_buyer_service_client_config.json';
 ...
 * @memberof v1
 */
export class ProgrammaticBuyerServiceClient {
  ...
  programmaticBuyerServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of ProgrammaticBuyerServiceClient.
   *
   ...
   *     const client = new ProgrammaticBuyerServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof ProgrammaticBuyerServiceClient;
    ...
    this.descriptors.page = {
      listProgrammaticBuyers:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'programmaticBuyers')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.admanager.v1.ProgrammaticBuyerService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.programmaticBuyerServiceStub) {
      return this.programmaticBuyerServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.ProgrammaticBuyerService.
    this.programmaticBuyerServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.admanager.v1.ProgrammaticBuyerService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.ProgrammaticBuyerService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const programmaticBuyerServiceStubMethods =
        ['getProgrammaticBuyer', 'listProgrammaticBuyers'];
    for (const methodName of programmaticBuyerServiceStubMethods) {
      const callPromise = this.programmaticBuyerServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.ProgrammaticBuyer|ProgrammaticBuyer}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/programmatic_buyer_service.get_programmatic_buyer.js</caption>
 * region_tag:admanager_v1_generated_ProgrammaticBuyerService_GetProgrammaticBuyer_async
 */
  getProgrammaticBuyer(
      request?: protos.google.ads.admanager.v1.IGetProgrammaticBuyerRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IProgrammaticBuyer,
        protos.google.ads.admanager.v1.IGetProgrammaticBuyerRequest|undefined, {}|undefined
      ]>;
  getProgrammaticBuyer(
      request: protos.google.ads.admanager.v1.IGetProgrammaticBuyerRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IProgrammaticBuyer,
          protos.google.ads.admanager.v1.IGetProgrammaticBuyerRequest|null|undefined,
          {}|null|undefined>): void;
  getProgrammaticBuyer(
      request: protos.google.ads.admanager.v1.IGetProgrammaticBuyerRequest,
      callback: Callback<
  ...
  getProgrammaticBuyer(
    ...
    this._log.info('getProgrammaticBuyer request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IProgrammaticBuyer,
        protos.google.ads.admanager.v1.IGetProgrammaticBuyerRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('getProgrammaticBuyer response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.getProgrammaticBuyer(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IProgrammaticBuyer,
        protos.google.ads.admanager.v1.IGetProgrammaticBuyerRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getProgrammaticBuyer response %j', response);
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.ProgrammaticBuyer|ProgrammaticBuyer}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listProgrammaticBuyersAsync()`
 *   method described below for async iteration which you can stop as needed.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 */
  listProgrammaticBuyers(
      request?: protos.google.ads.admanager.v1.IListProgrammaticBuyersRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IProgrammaticBuyer[],
        protos.google.ads.admanager.v1.IListProgrammaticBuyersRequest|null,
        protos.google.ads.admanager.v1.IListProgrammaticBuyersResponse
      ]>;
  listProgrammaticBuyers(
      request: protos.google.ads.admanager.v1.IListProgrammaticBuyersRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListProgrammaticBuyersRequest,
          protos.google.ads.admanager.v1.IListProgrammaticBuyersResponse|null|undefined,
          protos.google.ads.admanager.v1.IProgrammaticBuyer>): void;
  listProgrammaticBuyers(
      request: protos.google.ads.admanager.v1.IListProgrammaticBuyersRequest,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListProgrammaticBuyersRequest,
  ...
  listProgrammaticBuyers(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.ads.admanager.v1.IListProgrammaticBuyersRequest,
      protos.google.ads.admanager.v1.IListProgrammaticBuyersResponse|null|undefined,
      protos.google.ads.admanager.v1.IProgrammaticBuyer>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listProgrammaticBuyers values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listProgrammaticBuyers request %j', request);
    return this.innerApiCalls
      .listProgrammaticBuyers(request, options, wrappedCallback)
      ?.then(([response, input, output]: [
        protos.google.ads.admanager.v1.IProgrammaticBuyer[],
        protos.google.ads.admanager.v1.IListProgrammaticBuyersRequest|null,
        protos.google.ads.admanager.v1.IListProgrammaticBuyersResponse
      ]) => {
        this._log.info('listProgrammaticBuyers values %j', response);
        return [response, input, output];
      });
  }

/**
 * Equivalent to `listProgrammaticBuyers`, but returns a NodeJS Stream object.
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 *   Required. The parent, which owns this collection of ProgrammaticBuyers.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.ProgrammaticBuyer|ProgrammaticBuyer} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 */
  listProgrammaticBuyersStream(
    ...
    const defaultCallSettings = this._defaults['listProgrammaticBuyers'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listProgrammaticBuyers stream %j', request);
    return this.descriptors.page.listProgrammaticBuyers.createStream(
      this.innerApiCalls.listProgrammaticBuyers as GaxCall,
      request,
      callSettings
    );
  }
...
/**
 * Equivalent to `listProgrammaticBuyers`, but returns an iterable object.
 *
 ...
 *   {@link protos.google.ads.admanager.v1.ProgrammaticBuyer|ProgrammaticBuyer}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/programmatic_buyer_service.list_programmatic_buyers.js</caption>
 * region_tag:admanager_v1_generated_ProgrammaticBuyerService_ListProgrammaticBuyers_async
 */
  listProgrammaticBuyersAsync(
      request?: protos.google.ads.admanager.v1.IListProgrammaticBuyersRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.admanager.v1.IProgrammaticBuyer>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listProgrammaticBuyers iterate %j', request);
    return this.descriptors.page.listProgrammaticBuyers.asyncIterate(
      this.innerApiCalls['listProgrammaticBuyers'] as GaxCall,
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.ads.admanager.v1.IProgrammaticBuyer>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.programmaticBuyerServiceStub && !this._terminated) {
      return this.programmaticBuyerServiceStub.then(stub => {
