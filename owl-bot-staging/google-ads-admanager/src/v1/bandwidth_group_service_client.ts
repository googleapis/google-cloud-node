 ...
 * `src/v1/bandwidth_group_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './bandwidth_group_service_client_config.json';
 ...
 * @memberof v1
 */
export class BandwidthGroupServiceClient {
  ...
  bandwidthGroupServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of BandwidthGroupServiceClient.
   *
   ...
   *     const client = new BandwidthGroupServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof BandwidthGroupServiceClient;
    ...
    this.descriptors.page = {
      listBandwidthGroups:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'bandwidthGroups')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.admanager.v1.BandwidthGroupService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.bandwidthGroupServiceStub) {
      return this.bandwidthGroupServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.BandwidthGroupService.
    this.bandwidthGroupServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.admanager.v1.BandwidthGroupService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.BandwidthGroupService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const bandwidthGroupServiceStubMethods =
        ['getBandwidthGroup', 'listBandwidthGroups'];
    for (const methodName of bandwidthGroupServiceStubMethods) {
      const callPromise = this.bandwidthGroupServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BandwidthGroup|BandwidthGroup}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/bandwidth_group_service.get_bandwidth_group.js</caption>
 * region_tag:admanager_v1_generated_BandwidthGroupService_GetBandwidthGroup_async
 */
  getBandwidthGroup(
      request?: protos.google.ads.admanager.v1.IGetBandwidthGroupRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IBandwidthGroup,
        protos.google.ads.admanager.v1.IGetBandwidthGroupRequest|undefined, {}|undefined
      ]>;
  getBandwidthGroup(
      request: protos.google.ads.admanager.v1.IGetBandwidthGroupRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IBandwidthGroup,
          protos.google.ads.admanager.v1.IGetBandwidthGroupRequest|null|undefined,
          {}|null|undefined>): void;
  getBandwidthGroup(
      request: protos.google.ads.admanager.v1.IGetBandwidthGroupRequest,
      callback: Callback<
  ...
  getBandwidthGroup(
    ...
    this._log.info('getBandwidthGroup request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IBandwidthGroup,
        protos.google.ads.admanager.v1.IGetBandwidthGroupRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('getBandwidthGroup response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.getBandwidthGroup(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IBandwidthGroup,
        protos.google.ads.admanager.v1.IGetBandwidthGroupRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getBandwidthGroup response %j', response);
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.BandwidthGroup|BandwidthGroup}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listBandwidthGroupsAsync()`
 *   method described below for async iteration which you can stop as needed.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 */
  listBandwidthGroups(
      request?: protos.google.ads.admanager.v1.IListBandwidthGroupsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IBandwidthGroup[],
        protos.google.ads.admanager.v1.IListBandwidthGroupsRequest|null,
        protos.google.ads.admanager.v1.IListBandwidthGroupsResponse
      ]>;
  listBandwidthGroups(
      request: protos.google.ads.admanager.v1.IListBandwidthGroupsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListBandwidthGroupsRequest,
          protos.google.ads.admanager.v1.IListBandwidthGroupsResponse|null|undefined,
          protos.google.ads.admanager.v1.IBandwidthGroup>): void;
  listBandwidthGroups(
      request: protos.google.ads.admanager.v1.IListBandwidthGroupsRequest,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListBandwidthGroupsRequest,
  ...
  listBandwidthGroups(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.ads.admanager.v1.IListBandwidthGroupsRequest,
      protos.google.ads.admanager.v1.IListBandwidthGroupsResponse|null|undefined,
      protos.google.ads.admanager.v1.IBandwidthGroup>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listBandwidthGroups values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listBandwidthGroups request %j', request);
    return this.innerApiCalls
      .listBandwidthGroups(request, options, wrappedCallback)
      ?.then(([response, input, output]: [
        protos.google.ads.admanager.v1.IBandwidthGroup[],
        protos.google.ads.admanager.v1.IListBandwidthGroupsRequest|null,
        protos.google.ads.admanager.v1.IListBandwidthGroupsResponse
      ]) => {
        this._log.info('listBandwidthGroups values %j', response);
        return [response, input, output];
      });
  }

/**
 * Equivalent to `listBandwidthGroups`, but returns a NodeJS Stream object.
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 *   Required. The parent, which owns this collection of BandwidthGroups.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.BandwidthGroup|BandwidthGroup} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 */
  listBandwidthGroupsStream(
    ...
    const defaultCallSettings = this._defaults['listBandwidthGroups'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listBandwidthGroups stream %j', request);
    return this.descriptors.page.listBandwidthGroups.createStream(
      this.innerApiCalls.listBandwidthGroups as GaxCall,
      request,
      callSettings
    );
  }
...
/**
 * Equivalent to `listBandwidthGroups`, but returns an iterable object.
 *
 ...
 *   {@link protos.google.ads.admanager.v1.BandwidthGroup|BandwidthGroup}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/bandwidth_group_service.list_bandwidth_groups.js</caption>
 * region_tag:admanager_v1_generated_BandwidthGroupService_ListBandwidthGroups_async
 */
  listBandwidthGroupsAsync(
      request?: protos.google.ads.admanager.v1.IListBandwidthGroupsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.admanager.v1.IBandwidthGroup>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listBandwidthGroups iterate %j', request);
    return this.descriptors.page.listBandwidthGroups.asyncIterate(
      this.innerApiCalls['listBandwidthGroups'] as GaxCall,
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.ads.admanager.v1.IBandwidthGroup>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.bandwidthGroupServiceStub && !this._terminated) {
      return this.bandwidthGroupServiceStub.then(stub => {
