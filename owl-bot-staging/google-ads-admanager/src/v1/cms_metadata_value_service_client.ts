 ...
 * `src/v1/cms_metadata_value_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './cms_metadata_value_service_client_config.json';
 ...
 * @memberof v1
 */
export class CmsMetadataValueServiceClient {
  ...
  cmsMetadataValueServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of CmsMetadataValueServiceClient.
   *
   ...
   *     const client = new CmsMetadataValueServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof CmsMetadataValueServiceClient;
    ...
    this.descriptors.page = {
      listCmsMetadataValues:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'cmsMetadataValues')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.admanager.v1.CmsMetadataValueService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.cmsMetadataValueServiceStub) {
      return this.cmsMetadataValueServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.CmsMetadataValueService.
    this.cmsMetadataValueServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.admanager.v1.CmsMetadataValueService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.CmsMetadataValueService,
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.CmsMetadataValue|CmsMetadataValue}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/cms_metadata_value_service.get_cms_metadata_value.js</caption>
 * region_tag:admanager_v1_generated_CmsMetadataValueService_GetCmsMetadataValue_async
 */
  getCmsMetadataValue(
      request?: protos.google.ads.admanager.v1.IGetCmsMetadataValueRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.ICmsMetadataValue,
        protos.google.ads.admanager.v1.IGetCmsMetadataValueRequest|undefined, {}|undefined
      ]>;
  getCmsMetadataValue(
      request: protos.google.ads.admanager.v1.IGetCmsMetadataValueRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.ICmsMetadataValue,
          protos.google.ads.admanager.v1.IGetCmsMetadataValueRequest|null|undefined,
          {}|null|undefined>): void;
  getCmsMetadataValue(
      request: protos.google.ads.admanager.v1.IGetCmsMetadataValueRequest,
      callback: Callback<
  ...
  getCmsMetadataValue(
    ...
    this._log.info('getCmsMetadataValue request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.ICmsMetadataValue,
        protos.google.ads.admanager.v1.IGetCmsMetadataValueRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('getCmsMetadataValue response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.getCmsMetadataValue(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.ICmsMetadataValue,
        protos.google.ads.admanager.v1.IGetCmsMetadataValueRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getCmsMetadataValue response %j', response);
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.CmsMetadataValue|CmsMetadataValue}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listCmsMetadataValuesAsync()`
 *   method described below for async iteration which you can stop as needed.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 */
  listCmsMetadataValues(
      request?: protos.google.ads.admanager.v1.IListCmsMetadataValuesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.ICmsMetadataValue[],
        protos.google.ads.admanager.v1.IListCmsMetadataValuesRequest|null,
        protos.google.ads.admanager.v1.IListCmsMetadataValuesResponse
      ]>;
  listCmsMetadataValues(
      request: protos.google.ads.admanager.v1.IListCmsMetadataValuesRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListCmsMetadataValuesRequest,
          protos.google.ads.admanager.v1.IListCmsMetadataValuesResponse|null|undefined,
          protos.google.ads.admanager.v1.ICmsMetadataValue>): void;
  listCmsMetadataValues(
      request: protos.google.ads.admanager.v1.IListCmsMetadataValuesRequest,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListCmsMetadataValuesRequest,
  ...
  listCmsMetadataValues(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.ads.admanager.v1.IListCmsMetadataValuesRequest,
      protos.google.ads.admanager.v1.IListCmsMetadataValuesResponse|null|undefined,
      protos.google.ads.admanager.v1.ICmsMetadataValue>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listCmsMetadataValues values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listCmsMetadataValues request %j', request);
    return this.innerApiCalls
      .listCmsMetadataValues(request, options, wrappedCallback)
      ?.then(([response, input, output]: [
        protos.google.ads.admanager.v1.ICmsMetadataValue[],
        protos.google.ads.admanager.v1.IListCmsMetadataValuesRequest|null,
        protos.google.ads.admanager.v1.IListCmsMetadataValuesResponse
      ]) => {
        this._log.info('listCmsMetadataValues values %j', response);
        return [response, input, output];
      });
  }

/**
 * Equivalent to `listCmsMetadataValues`, but returns a NodeJS Stream object.
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 *   Required. The parent, which owns this collection of CmsMetadataValues.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.CmsMetadataValue|CmsMetadataValue} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 */
  listCmsMetadataValuesStream(
    ...
    const defaultCallSettings = this._defaults['listCmsMetadataValues'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listCmsMetadataValues stream %j', request);
    return this.descriptors.page.listCmsMetadataValues.createStream(
      this.innerApiCalls.listCmsMetadataValues as GaxCall,
      request,
      callSettings
    );
  }
...
/**
 * Equivalent to `listCmsMetadataValues`, but returns an iterable object.
 *
 ...
 *   {@link protos.google.ads.admanager.v1.CmsMetadataValue|CmsMetadataValue}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/cms_metadata_value_service.list_cms_metadata_values.js</caption>
 * region_tag:admanager_v1_generated_CmsMetadataValueService_ListCmsMetadataValues_async
 */
  listCmsMetadataValuesAsync(
      request?: protos.google.ads.admanager.v1.IListCmsMetadataValuesRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.admanager.v1.ICmsMetadataValue>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listCmsMetadataValues iterate %j', request);
    return this.descriptors.page.listCmsMetadataValues.asyncIterate(
      this.innerApiCalls['listCmsMetadataValues'] as GaxCall,
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.ads.admanager.v1.ICmsMetadataValue>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.cmsMetadataValueServiceStub && !this._terminated) {
      return this.cmsMetadataValueServiceStub.then(stub => {
