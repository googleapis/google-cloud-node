...
export class CloudRedisClusterClient {
  ...
  private _log = logging.log('redis-cluster');
 ...
 */
  ...
  listClusters(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.redis.cluster.v1.IListClustersRequest,
      protos.google.cloud.redis.cluster.v1.IListClustersResponse|null|undefined,
      protos.google.cloud.redis.cluster.v1.ICluster>|undefined = callback
 ...
 */
  ...
  listBackupCollections(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.redis.cluster.v1.IListBackupCollectionsRequest,
      protos.google.cloud.redis.cluster.v1.IListBackupCollectionsResponse|null|undefined,
      protos.google.cloud.redis.cluster.v1.IBackupCollection>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
 ...
 */
  ...
  listBackups(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.redis.cluster.v1.IListBackupsRequest,
      protos.google.cloud.redis.cluster.v1.IListBackupsResponse|null|undefined,
      protos.google.cloud.redis.cluster.v1.IBackup>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
