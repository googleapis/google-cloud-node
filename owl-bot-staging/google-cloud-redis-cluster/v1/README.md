...
# [Cluster: Nodejs Client][homepage]
...
* [Cluster Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/cluster/latest)
* [Cluster Documentation](https://cloud.google.com/memorystore/docs/redis)
...
1.  [Enable the Cluster API][enable_api].
