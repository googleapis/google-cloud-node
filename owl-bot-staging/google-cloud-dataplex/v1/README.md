...
# [Dataplex: Nodejs Client][homepage]
...
* [Dataplex Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/dataplex/latest)
* [Dataplex Documentation](https://cloud.google.com/dataplex/docs/overview)
