...
import * as cmekserviceModule from '../src';
...
describe('v1.CmekServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = cmekserviceModule.v1.CmekServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = cmekserviceModule.v1.CmekServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'dataplex.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dataplex.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dataplex.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new cmekserviceModule.v1.CmekServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new cmekserviceModule.v1.CmekServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = cmekserviceModule.v1.CmekServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.cmekServiceStub, undefined);
            await client.initialize();
            assert(client.cmekServiceStub);
        });
    ...
    describe('getEncryptionConfig', () => {
        it('invokes getEncryptionConfig without error', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.dataplex.v1.GetEncryptionConfigRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataplex.v1.GetEncryptionConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataplex.v1.EncryptionConfig()
            );
            client.innerApiCalls.getEncryptionConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.getEncryptionConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getEncryptionConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getEncryptionConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getEncryptionConfig without error using callback', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getEncryptionConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getEncryptionConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataplex.v1.IEncryptionConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getEncryptionConfig with error', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getEncryptionConfig = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getEncryptionConfig(request), expectedError);
            const actualRequest = (client.innerApiCalls.getEncryptionConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getEncryptionConfig as SinonStub)
        ...
        it('invokes getEncryptionConfig with closed client', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('createEncryptionConfig', () => {
        it('invokes createEncryptionConfig without error', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataplex.v1.CreateEncryptionConfigRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataplex.v1.CreateEncryptionConfigRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createEncryptionConfig = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createEncryptionConfig(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createEncryptionConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createEncryptionConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes createEncryptionConfig without error using callback', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.createEncryptionConfig = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createEncryptionConfig(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dataplex.v1.IEncryptionConfig, protos.google.cloud.dataplex.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dataplex.v1.IEncryptionConfig, protos.google.cloud.dataplex.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createEncryptionConfig as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createEncryptionConfig with call error', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createEncryptionConfig = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createEncryptionConfig(request), expectedError);
            const actualRequest = (client.innerApiCalls.createEncryptionConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createEncryptionConfig as SinonStub)
        ...
        it('invokes createEncryptionConfig with LRO error', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createEncryptionConfig = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createEncryptionConfig(request);
        ...
        it('invokes checkCreateEncryptionConfigProgress without error', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const decodedOperation = await client.checkCreateEncryptionConfigProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkCreateEncryptionConfigProgress with error', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            await assert.rejects(client.checkCreateEncryptionConfigProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('updateEncryptionConfig', () => {
        it('invokes updateEncryptionConfig without error', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataplex.v1.UpdateEncryptionConfigRequest()
            );
            request.encryptionConfig ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataplex.v1.UpdateEncryptionConfigRequest', ['encryptionConfig', 'name']);
            request.encryptionConfig.name = defaultValue1;
            const expectedHeaderRequestParams = `encryption_config.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updateEncryptionConfig = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateEncryptionConfig(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateEncryptionConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateEncryptionConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes updateEncryptionConfig without error using callback', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.updateEncryptionConfig = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateEncryptionConfig(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dataplex.v1.IEncryptionConfig, protos.google.cloud.dataplex.v1.IOperationMetadata>|null
                    ) => {
        ...
        it('invokes updateEncryptionConfig with call error', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `encryption_config.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateEncryptionConfig = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.updateEncryptionConfig(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateEncryptionConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateEncryptionConfig as SinonStub)
        ...
        it('invokes updateEncryptionConfig with LRO error', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `encryption_config.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateEncryptionConfig = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateEncryptionConfig(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateEncryptionConfig as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateEncryptionConfigProgress without error', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateEncryptionConfigProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkUpdateEncryptionConfigProgress with error', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateEncryptionConfigProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteEncryptionConfig', () => {
        it('invokes deleteEncryptionConfig without error', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataplex.v1.DeleteEncryptionConfigRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataplex.v1.DeleteEncryptionConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteEncryptionConfig = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteEncryptionConfig(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteEncryptionConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteEncryptionConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes deleteEncryptionConfig without error using callback', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.deleteEncryptionConfig = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteEncryptionConfig(
                    request,
                    (err?: Error|null,
        ...
        it('invokes deleteEncryptionConfig with call error', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteEncryptionConfig = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteEncryptionConfig(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteEncryptionConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteEncryptionConfig as SinonStub)
        ...
        it('invokes deleteEncryptionConfig with LRO error', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteEncryptionConfig = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteEncryptionConfig(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteEncryptionConfig as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteEncryptionConfigProgress without error', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteEncryptionConfigProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkDeleteEncryptionConfigProgress with error', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteEncryptionConfigProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listEncryptionConfigs', () => {
        it('invokes listEncryptionConfigs without error', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataplex.v1.ListEncryptionConfigsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataplex.v1.ListEncryptionConfigsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataplex.v1.EncryptionConfig()),
              generateSampleMessage(new protos.google.cloud.dataplex.v1.EncryptionConfig()),
              generateSampleMessage(new protos.google.cloud.dataplex.v1.EncryptionConfig()),
            ];
            client.innerApiCalls.listEncryptionConfigs = stubSimpleCall(expectedResponse);
            const [response] = await client.listEncryptionConfigs(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listEncryptionConfigs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listEncryptionConfigs as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes listEncryptionConfigs without error using callback', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listEncryptionConfigs = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listEncryptionConfigs(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataplex.v1.IEncryptionConfig[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listEncryptionConfigs with error', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listEncryptionConfigs = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listEncryptionConfigs(request), expectedError);
            const actualRequest = (client.innerApiCalls.listEncryptionConfigs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listEncryptionConfigs as SinonStub)
        ...
        it('invokes listEncryptionConfigsStream without error', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listEncryptionConfigs.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listEncryptionConfigsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataplex.v1.EncryptionConfig[] = [];
                stream.on('data', (response: protos.google.cloud.dataplex.v1.EncryptionConfig) => {
            ...
            assert((client.descriptors.page.listEncryptionConfigs.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listEncryptionConfigs, request));
            assert(
                (client.descriptors.page.listEncryptionConfigs.createStream as SinonStub)
        ...
        it('invokes listEncryptionConfigsStream with error', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listEncryptionConfigs.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listEncryptionConfigsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataplex.v1.EncryptionConfig[] = [];
                stream.on('data', (response: protos.google.cloud.dataplex.v1.EncryptionConfig) => {
        ...
        it('uses async iteration with listEncryptionConfigs without error', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listEncryptionConfigs.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.dataplex.v1.IEncryptionConfig[] = [];
            const iterable = client.listEncryptionConfigsAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listEncryptionConfigs.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listEncryptionConfigs with error', async () => {
            const client = new cmekserviceModule.v1.CmekServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listEncryptionConfigs.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listEncryptionConfigsAsync(request);
