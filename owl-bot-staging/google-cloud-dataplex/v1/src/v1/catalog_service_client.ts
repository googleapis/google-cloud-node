...
export class CatalogServiceClient {
  ...
  initialize() {
    ...
    const catalogServiceStubMethods =
        ['createEntryType', 'updateEntryType', 'deleteEntryType', 'listEntryTypes', 'getEntryType', 'createAspectType', 'updateAspectType', 'deleteAspectType', 'listAspectTypes', 'getAspectType', 'createEntryGroup', 'updateEntryGroup', 'deleteEntryGroup', 'listEntryGroups', 'getEntryGroup', 'createEntry', 'updateEntry', 'deleteEntry', 'listEntries', 'getEntry', 'lookupEntry', 'searchEntries'];
