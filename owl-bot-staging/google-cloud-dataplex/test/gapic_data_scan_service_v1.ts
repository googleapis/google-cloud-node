...
describe('v1.DataScanServiceClient', () => {
  ...
  describe('Path templates', () => {
    ...
    describe('dataAsset', async () => {
      ...
      await client.initialize();
      client.pathTemplates.dataAssetPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.dataAssetPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('dataAssetPath', () => {
        const result = client.dataAssetPath(
          'projectValue',
          'locationValue',
          'dataProductValue',
          'dataAssetValue',
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.dataAssetPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromDataAssetName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.dataAssetPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('dataProduct', async () => {
      ...
      await client.initialize();
      client.pathTemplates.dataProductPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.dataProductPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('dataProductPath', () => {
        const result = client.dataProductPath(
          'projectValue',
          'locationValue',
          'dataProductValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.dataProductPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromDataProductName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.dataProductPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('entryLink', async () => {
      ...
      await client.initialize();
      client.pathTemplates.entryLinkPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.entryLinkPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('entryLinkPath', () => {
        const result = client.entryLinkPath(
          'projectValue',
          'locationValue',
          'entryGroupValue',
          'entryLinkValue',
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.entryLinkPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromEntryLinkName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.entryLinkPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('glossaryCategory', async () => {
      ...
      await client.initialize();
      client.pathTemplates.glossaryCategoryPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.glossaryCategoryPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('glossaryCategoryPath', () => {
        const result = client.glossaryCategoryPath(
          'projectValue',
          'locationValue',
          'glossaryValue',
          'glossaryCategoryValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.glossaryCategoryPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromGlossaryCategoryName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.glossaryCategoryPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchGlossaryCategoryFromGlossaryCategoryName', () => {
        const result =
          client.matchGlossaryCategoryFromGlossaryCategoryName(fakePath);
    ...
    describe('glossaryTerm', async () => {
      ...
      await client.initialize();
      client.pathTemplates.glossaryTermPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.glossaryTermPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('glossaryTermPath', () => {
        const result = client.glossaryTermPath(
          'projectValue',
          'locationValue',
          'glossaryValue',
          'glossaryTermValue',
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.glossaryTermPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromGlossaryTermName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.glossaryTermPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('metadataFeed', async () => {
      ...
      await client.initialize();
      client.pathTemplates.metadataFeedPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.metadataFeedPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('metadataFeedPath', () => {
        const result = client.metadataFeedPath(
          'projectValue',
          'locationValue',
          'metadataFeedValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.metadataFeedPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromMetadataFeedName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.metadataFeedPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
