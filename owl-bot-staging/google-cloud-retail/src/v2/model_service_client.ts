...
export class ModelServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const createModelResponse = protoFilesRoot.lookup(
      '.google.cloud.retail.v2.Model') as gax.protobuf.Type;
    const createModelMetadata = protoFilesRoot.lookup(
      '.google.cloud.retail.v2.CreateModelMetadata') as gax.protobuf.Type;
    const tuneModelResponse = protoFilesRoot.lookup(
      '.google.cloud.retail.v2.TuneModelResponse') as gax.protobuf.Type;
    const tuneModelMetadata = protoFilesRoot.lookup(
      '.google.cloud.retail.v2.TuneModelMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.retail.v2.ModelService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.modelServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.retail.v2.ModelService') :
    ...
    const modelServiceStubMethods =
        ['createModel', 'getModel', 'pauseModel', 'resumeModel', 'deleteModel', 'listModels', 'updateModel', 'tuneModel'];
 ...
 */
  getModel(
      ...
      Promise<[
        ...
        protos.google.cloud.retail.v2.IGetModelRequest|undefined, {}|undefined
      ]>;
  getModel(
      request: protos.google.cloud.retail.v2.IGetModelRequest,
      options: CallOptions,
 ...
 */
  pauseModel(
      ...
      Promise<[
        protos.google.cloud.retail.v2.IModel,
        protos.google.cloud.retail.v2.IPauseModelRequest|undefined, {}|undefined
      ]>;
  pauseModel(
      request: protos.google.cloud.retail.v2.IPauseModelRequest,
      options: CallOptions,
  ...
  pauseModel(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.pauseModel(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.retail.v2.IModel,
 ...
 */
  resumeModel(
      ...
      Promise<[
        protos.google.cloud.retail.v2.IModel,
        protos.google.cloud.retail.v2.IResumeModelRequest|undefined, {}|undefined
      ]>;
  resumeModel(
      request: protos.google.cloud.retail.v2.IResumeModelRequest,
      options: CallOptions,
  ...
  resumeModel(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.resumeModel(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.retail.v2.IModel,
 ...
 */
  deleteModel(
      ...
      Promise<[
        ...
        protos.google.cloud.retail.v2.IDeleteModelRequest|undefined, {}|undefined
      ]>;
  deleteModel(
      request: protos.google.cloud.retail.v2.IDeleteModelRequest,
      options: CallOptions,
 ...
 */
  updateModel(
      ...
      Promise<[
        protos.google.cloud.retail.v2.IModel,
        protos.google.cloud.retail.v2.IUpdateModelRequest|undefined, {}|undefined
      ]>;
  updateModel(
      request: protos.google.cloud.retail.v2.IUpdateModelRequest,
      options: CallOptions,
 ...
 */
  createModel(
      ...
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.retail.v2.IModel, protos.google.cloud.retail.v2.ICreateModelMetadata>,
 ...
 * region_tag:retail_v2_generated_ModelService_CreateModel_async
 */
  async checkCreateModelProgress(name: string): Promise<LROperation<protos.google.cloud.retail.v2.Model, protos.google.cloud.retail.v2.CreateModelMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.retail.v2.Model, protos.google.cloud.retail.v2.CreateModelMetadata>;
  }
/**
 ...
 */
  tuneModel(
      ...
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.retail.v2.ITuneModelResponse, protos.google.cloud.retail.v2.ITuneModelMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
      ]>;
  tuneModel(
      request: protos.google.cloud.retail.v2.ITuneModelRequest,
  ...
  tuneModel(
    ...
    return this.innerApiCalls.tuneModel(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.retail.v2.ITuneModelResponse, protos.google.cloud.retail.v2.ITuneModelMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:retail_v2_generated_ModelService_TuneModel_async
 */
  async checkTuneModelProgress(name: string): Promise<LROperation<protos.google.cloud.retail.v2.TuneModelResponse, protos.google.cloud.retail.v2.TuneModelMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.retail.v2.TuneModelResponse, protos.google.cloud.retail.v2.TuneModelMetadata>;
  }
 /**
 ...
 */
  ...
  listModels(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.retail.v2.IModel>): void;
  listModels(
      request: protos.google.cloud.retail.v2.IListModelsRequest,
      callback: PaginationCallback<
          protos.google.cloud.retail.v2.IListModelsRequest,
  ...
  listModels(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.retail.v2.IListModelsRequest,
      protos.google.cloud.retail.v2.IListModelsResponse|null|undefined,
      protos.google.cloud.retail.v2.IModel>|undefined = callback
