...
export class AnalyticsServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const exportAnalyticsMetricsResponse = protoFilesRoot.lookup(
      '.google.cloud.retail.v2alpha.ExportAnalyticsMetricsResponse') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.retail.v2alpha.AnalyticsService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.analyticsServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.retail.v2alpha.AnalyticsService') :
 ...
 */
  exportAnalyticsMetrics(
      ...
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.retail.v2alpha.IExportAnalyticsMetricsResponse, protos.google.cloud.retail.v2alpha.IExportMetadata>,
 ...
 * region_tag:retail_v2alpha_generated_AnalyticsService_ExportAnalyticsMetrics_async
 */
  async checkExportAnalyticsMetricsProgress(name: string): Promise<LROperation<protos.google.cloud.retail.v2alpha.ExportAnalyticsMetricsResponse, protos.google.cloud.retail.v2alpha.ExportMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.retail.v2alpha.ExportAnalyticsMetricsResponse, protos.google.cloud.retail.v2alpha.ExportMetadata>;
  }
/**
