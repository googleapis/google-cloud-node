...
describe('v2alpha.GenerativeQuestionServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new generativequestionserviceModule.v2alpha.GenerativeQuestionServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = generativequestionserviceModule.v2alpha.GenerativeQuestionServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = generativequestionserviceModule.v2alpha.GenerativeQuestionServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'retail.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new generativequestionserviceModule.v2alpha.GenerativeQuestionServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new generativequestionserviceModule.v2alpha.GenerativeQuestionServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new generativequestionserviceModule.v2alpha.GenerativeQuestionServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new generativequestionserviceModule.v2alpha.GenerativeQuestionServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = generativequestionserviceModule.v2alpha.GenerativeQuestionServiceClient.port;
            assert(port);
    ...
    describe('updateGenerativeQuestionsFeatureConfig', () => {
        it('invokes updateGenerativeQuestionsFeatureConfig without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.retail.v2alpha.UpdateGenerativeQuestionsFeatureConfigRequest()
            );
            request.generativeQuestionsFeatureConfig ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.UpdateGenerativeQuestionsFeatureConfigRequest', ['generativeQuestionsFeatureConfig', 'catalog']);
            ...
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2alpha.GenerativeQuestionsFeatureConfig()
            );
        ...
        it('invokes updateGenerativeQuestionsFeatureConfig without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updateGenerativeQuestionsFeatureConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2alpha.IGenerativeQuestionsFeatureConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getGenerativeQuestionsFeatureConfig', () => {
        it('invokes getGenerativeQuestionsFeatureConfig without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.retail.v2alpha.GetGenerativeQuestionsFeatureConfigRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.GetGenerativeQuestionsFeatureConfigRequest', ['catalog']);
    ...
    describe('listGenerativeQuestionConfigs', () => {
        it('invokes listGenerativeQuestionConfigs without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.retail.v2alpha.ListGenerativeQuestionConfigsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.ListGenerativeQuestionConfigsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2alpha.ListGenerativeQuestionConfigsResponse()
            );
        ...
        it('invokes listGenerativeQuestionConfigs without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listGenerativeQuestionConfigs(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2alpha.IListGenerativeQuestionConfigsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateGenerativeQuestionConfig', () => {
        it('invokes updateGenerativeQuestionConfig without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.retail.v2alpha.UpdateGenerativeQuestionConfigRequest()
            );
            request.generativeQuestionConfig ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.UpdateGenerativeQuestionConfigRequest', ['generativeQuestionConfig', 'catalog']);
            ...
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2alpha.GenerativeQuestionConfig()
            );
        ...
        it('invokes updateGenerativeQuestionConfig without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updateGenerativeQuestionConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2alpha.IGenerativeQuestionConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('batchUpdateGenerativeQuestionConfigs', () => {
        it('invokes batchUpdateGenerativeQuestionConfigs without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.retail.v2alpha.BatchUpdateGenerativeQuestionConfigsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.BatchUpdateGenerativeQuestionConfigsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2alpha.BatchUpdateGenerativeQuestionConfigsResponse()
            );
        ...
        it('invokes batchUpdateGenerativeQuestionConfigs without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchUpdateGenerativeQuestionConfigs(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2alpha.IBatchUpdateGenerativeQuestionConfigsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
