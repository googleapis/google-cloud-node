...
describe('v2alpha.MerchantCenterAccountLinkServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new merchantcenteraccountlinkserviceModule.v2alpha.MerchantCenterAccountLinkServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = merchantcenteraccountlinkserviceModule.v2alpha.MerchantCenterAccountLinkServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = merchantcenteraccountlinkserviceModule.v2alpha.MerchantCenterAccountLinkServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'retail.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new merchantcenteraccountlinkserviceModule.v2alpha.MerchantCenterAccountLinkServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new merchantcenteraccountlinkserviceModule.v2alpha.MerchantCenterAccountLinkServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new merchantcenteraccountlinkserviceModule.v2alpha.MerchantCenterAccountLinkServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new merchantcenteraccountlinkserviceModule.v2alpha.MerchantCenterAccountLinkServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = merchantcenteraccountlinkserviceModule.v2alpha.MerchantCenterAccountLinkServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.merchantCenterAccountLinkServiceStub, undefined);
    ...
    describe('listMerchantCenterAccountLinks', () => {
        it('invokes listMerchantCenterAccountLinks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.ListMerchantCenterAccountLinksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2alpha.ListMerchantCenterAccountLinksResponse()
            );
            client.innerApiCalls.listMerchantCenterAccountLinks = stubSimpleCall(expectedResponse);
            const [response] = await client.listMerchantCenterAccountLinks(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listMerchantCenterAccountLinks as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listMerchantCenterAccountLinks as SinonStub)
        ...
        it('invokes listMerchantCenterAccountLinks without error using callback', async () => {
            ...
            client.innerApiCalls.listMerchantCenterAccountLinks = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listMerchantCenterAccountLinks(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2alpha.IListMerchantCenterAccountLinksResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listMerchantCenterAccountLinks with error', async () => {
            ...
            client.innerApiCalls.listMerchantCenterAccountLinks = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listMerchantCenterAccountLinks(request), expectedError);
            const actualRequest = (client.innerApiCalls.listMerchantCenterAccountLinks as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listMerchantCenterAccountLinks as SinonStub)
    ...
    describe('deleteMerchantCenterAccountLink', () => {
        it('invokes deleteMerchantCenterAccountLink without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.DeleteMerchantCenterAccountLinkRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteMerchantCenterAccountLink = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteMerchantCenterAccountLink(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteMerchantCenterAccountLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteMerchantCenterAccountLink as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteMerchantCenterAccountLink without error using callback', async () => {
            ...
            client.innerApiCalls.deleteMerchantCenterAccountLink = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteMerchantCenterAccountLink with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteMerchantCenterAccountLink = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.deleteMerchantCenterAccountLink(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteMerchantCenterAccountLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteMerchantCenterAccountLink as SinonStub)
    ...
    describe('createMerchantCenterAccountLink', () => {
        it('invokes createMerchantCenterAccountLink without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.CreateMerchantCenterAccountLinkRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createMerchantCenterAccountLink = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createMerchantCenterAccountLink(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createMerchantCenterAccountLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createMerchantCenterAccountLink as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createMerchantCenterAccountLink without error using callback', async () => {
            ...
            client.innerApiCalls.createMerchantCenterAccountLink = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createMerchantCenterAccountLink(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.retail.v2alpha.IMerchantCenterAccountLink, protos.google.cloud.retail.v2alpha.ICreateMerchantCenterAccountLinkMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.retail.v2alpha.IMerchantCenterAccountLink, protos.google.cloud.retail.v2alpha.ICreateMerchantCenterAccountLinkMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createMerchantCenterAccountLink as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createMerchantCenterAccountLink with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createMerchantCenterAccountLink = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createMerchantCenterAccountLink(request), expectedError);
            const actualRequest = (client.innerApiCalls.createMerchantCenterAccountLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createMerchantCenterAccountLink as SinonStub)
        ...
        it('invokes createMerchantCenterAccountLink with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createMerchantCenterAccountLink = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createMerchantCenterAccountLink(request);
        ...
        it('invokes checkCreateMerchantCenterAccountLinkProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateMerchantCenterAccountLinkProgress(expectedResponse.name);
        ...
        it('invokes checkCreateMerchantCenterAccountLinkProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreateMerchantCenterAccountLinkProgress(''), expectedError);
