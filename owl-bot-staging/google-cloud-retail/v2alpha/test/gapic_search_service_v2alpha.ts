...
describe('v2alpha.SearchServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = searchserviceModule.v2alpha.SearchServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = searchserviceModule.v2alpha.SearchServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'retail.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new searchserviceModule.v2alpha.SearchServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new searchserviceModule.v2alpha.SearchServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new searchserviceModule.v2alpha.SearchServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new searchserviceModule.v2alpha.SearchServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('search', () => {
        it('invokes search without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.SearchRequest', ['placement']);
            request.placement = defaultValue1;
            const expectedHeaderRequestParams = `placement=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.retail.v2alpha.SearchResponse.SearchResult()),
              generateSampleMessage(new protos.google.cloud.retail.v2alpha.SearchResponse.SearchResult()),
              generateSampleMessage(new protos.google.cloud.retail.v2alpha.SearchResponse.SearchResult()),
            ];
        ...
        it('invokes search without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.search(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2alpha.SearchResponse.ISearchResult[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes searchStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.retail.v2alpha.SearchResponse.SearchResult) => {
    ...
    describe('Path templates', () => {
        ...
        describe('experiment', async () => {
            ...
            it('experimentPath', () => {
                const result = client.experimentPath("projectValue", "locationValue", "catalogValue", "experimentValue");
                assert.strictEqual(result, fakePath);
