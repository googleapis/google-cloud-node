...
describe('v2alpha.ServingConfigServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new servingconfigserviceModule.v2alpha.ServingConfigServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = servingconfigserviceModule.v2alpha.ServingConfigServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = servingconfigserviceModule.v2alpha.ServingConfigServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'retail.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new servingconfigserviceModule.v2alpha.ServingConfigServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new servingconfigserviceModule.v2alpha.ServingConfigServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new servingconfigserviceModule.v2alpha.ServingConfigServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new servingconfigserviceModule.v2alpha.ServingConfigServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = servingconfigserviceModule.v2alpha.ServingConfigServiceClient.port;
            assert(port);
    ...
    describe('createServingConfig', () => {
        it('invokes createServingConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.CreateServingConfigRequest', ['parent']);
        ...
        it('invokes createServingConfig without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createServingConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2alpha.IServingConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deleteServingConfig', () => {
        it('invokes deleteServingConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.DeleteServingConfigRequest', ['name']);
    ...
    describe('updateServingConfig', () => {
        it('invokes updateServingConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.UpdateServingConfigRequest', ['servingConfig', 'name']);
    ...
    describe('getServingConfig', () => {
        it('invokes getServingConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.GetServingConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2alpha.ServingConfig()
    ...
    describe('addControl', () => {
        it('invokes addControl without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.AddControlRequest', ['servingConfig']);
    ...
    describe('removeControl', () => {
        it('invokes removeControl without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.RemoveControlRequest', ['servingConfig']);
            request.servingConfig = defaultValue1;
            const expectedHeaderRequestParams = `serving_config=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2alpha.ServingConfig()
    ...
    describe('listServingConfigs', () => {
        it('invokes listServingConfigs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.ListServingConfigsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.retail.v2alpha.ServingConfig()),
              generateSampleMessage(new protos.google.cloud.retail.v2alpha.ServingConfig()),
              generateSampleMessage(new protos.google.cloud.retail.v2alpha.ServingConfig()),
            ];
        ...
        it('invokes listServingConfigsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.retail.v2alpha.ServingConfig) => {
