...
describe('v2alpha.BranchServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = branchserviceModule.v2alpha.BranchServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = branchserviceModule.v2alpha.BranchServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'retail.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new branchserviceModule.v2alpha.BranchServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new branchserviceModule.v2alpha.BranchServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new branchserviceModule.v2alpha.BranchServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new branchserviceModule.v2alpha.BranchServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = branchserviceModule.v2alpha.BranchServiceClient.port;
            assert(port);
    ...
    describe('listBranches', () => {
        it('invokes listBranches without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.retail.v2alpha.ListBranchesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.ListBranchesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2alpha.ListBranchesResponse()
            );
            client.innerApiCalls.listBranches = stubSimpleCall(expectedResponse);
            const [response] = await client.listBranches(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listBranches as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listBranches as SinonStub)
        ...
        it('invokes listBranches without error using callback', async () => {
            ...
            client.innerApiCalls.listBranches = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listBranches(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2alpha.IListBranchesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listBranches with error', async () => {
            ...
            client.innerApiCalls.listBranches = stubSimpleCall(undefined, expectedError);
    ...
    describe('getBranch', () => {
        it('invokes getBranch without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.retail.v2alpha.GetBranchRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.GetBranchRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2alpha.Branch()
            );
            client.innerApiCalls.getBranch = stubSimpleCall(expectedResponse);
            const [response] = await client.getBranch(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getBranch as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getBranch as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getBranch without error using callback', async () => {
            ...
            client.innerApiCalls.getBranch = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getBranch(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2alpha.IBranch|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getBranch with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getBranch = stubSimpleCall(undefined, expectedError);
