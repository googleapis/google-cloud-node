...
describe('v2alpha.ProjectServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = projectserviceModule.v2alpha.ProjectServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = projectserviceModule.v2alpha.ProjectServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'retail.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new projectserviceModule.v2alpha.ProjectServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new projectserviceModule.v2alpha.ProjectServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new projectserviceModule.v2alpha.ProjectServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new projectserviceModule.v2alpha.ProjectServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getProject', () => {
        it('invokes getProject without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.GetProjectRequest', ['name']);
        ...
        it('invokes getProject without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getProject(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2alpha.IProject|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('acceptTerms', () => {
        it('invokes acceptTerms without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.AcceptTermsRequest', ['project']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.acceptTerms as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.acceptTerms as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes acceptTerms without error using callback', async () => {
            ...
            client.innerApiCalls.acceptTerms = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.acceptTerms(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2alpha.IProject|null) => {
        ...
        it('invokes acceptTerms with error', async () => {
            ...
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.acceptTerms = stubSimpleCall(undefined, expectedError);
    ...
    describe('listEnrolledSolutions', () => {
        it('invokes listEnrolledSolutions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.ListEnrolledSolutionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2alpha.ListEnrolledSolutionsResponse()
            );
            client.innerApiCalls.listEnrolledSolutions = stubSimpleCall(expectedResponse);
            const [response] = await client.listEnrolledSolutions(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listEnrolledSolutions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listEnrolledSolutions as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listEnrolledSolutions without error using callback', async () => {
            ...
            client.innerApiCalls.listEnrolledSolutions = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listEnrolledSolutions(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2alpha.IListEnrolledSolutionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listEnrolledSolutions with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listEnrolledSolutions = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listEnrolledSolutions(request), expectedError);
            const actualRequest = (client.innerApiCalls.listEnrolledSolutions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listEnrolledSolutions as SinonStub)
    ...
    describe('getLoggingConfig', () => {
        it('invokes getLoggingConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.GetLoggingConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getLoggingConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getLoggingConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getLoggingConfig without error using callback', async () => {
            ...
            client.innerApiCalls.getLoggingConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getLoggingConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2alpha.ILoggingConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getLoggingConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getLoggingConfig = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateLoggingConfig', () => {
        it('invokes updateLoggingConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.UpdateLoggingConfigRequest', ['loggingConfig', 'name']);
            request.loggingConfig.name = defaultValue1;
            const expectedHeaderRequestParams = `logging_config.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2alpha.LoggingConfig()
            );
            client.innerApiCalls.updateLoggingConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.updateLoggingConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateLoggingConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateLoggingConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateLoggingConfig without error using callback', async () => {
            ...
            client.innerApiCalls.updateLoggingConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateLoggingConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `logging_config.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateLoggingConfig = stubSimpleCall(undefined, expectedError);
    ...
    describe('getAlertConfig', () => {
        it('invokes getAlertConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.GetAlertConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getAlertConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getAlertConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getAlertConfig without error using callback', async () => {
            ...
            client.innerApiCalls.getAlertConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAlertConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2alpha.IAlertConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAlertConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getAlertConfig = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateAlertConfig', () => {
        it('invokes updateAlertConfig without error', async () => {
            ...
            request.alertConfig ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.UpdateAlertConfigRequest', ['alertConfig', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateAlertConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateAlertConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateAlertConfig without error using callback', async () => {
            ...
            client.innerApiCalls.updateAlertConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateAlertConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `alert_config.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateAlertConfig = stubSimpleCall(undefined, expectedError);
    ...
    describe('enrollSolution', () => {
        it('invokes enrollSolution without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.EnrollSolutionRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.enrollSolution = stubLongRunningCall(expectedResponse);
            const [operation] = await client.enrollSolution(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.enrollSolution as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.enrollSolution as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes enrollSolution without error using callback', async () => {
            ...
            client.innerApiCalls.enrollSolution = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.enrollSolution(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.retail.v2alpha.IEnrollSolutionResponse, protos.google.cloud.retail.v2alpha.IEnrollSolutionMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.retail.v2alpha.IEnrollSolutionResponse, protos.google.cloud.retail.v2alpha.IEnrollSolutionMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.enrollSolution as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes enrollSolution with call error', async () => {
            ...
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.enrollSolution = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes enrollSolution with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.enrollSolution = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.enrollSolution(request);
        ...
        it('invokes checkEnrollSolutionProgress without error', async () => {
            ...
            const decodedOperation = await client.checkEnrollSolutionProgress(expectedResponse.name);
        ...
        it('invokes checkEnrollSolutionProgress with error', async () => {
            ...
            await assert.rejects(client.checkEnrollSolutionProgress(''), expectedError);
