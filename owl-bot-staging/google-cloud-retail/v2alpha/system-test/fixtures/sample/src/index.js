...
function main() {
  ...
  const branchServiceClient = new retail.BranchServiceClient();
  ...
  const merchantCenterAccountLinkServiceClient = new retail.MerchantCenterAccountLinkServiceClient();
