 ...
 * `src/v2alpha/control_service_client_config.json`.
 ...
 * Creates a Control.
 *
 * If the {@link google.cloud.retail.v2alpha.Control|Control} to create already
 ...
 *   The first element of the array is an object representing [Control]{@link google.cloud.retail.v2alpha.Control}.
 *   Please see the
 ...
 * Deletes a Control.
 *
 * If the {@link google.cloud.retail.v2alpha.Control|Control} to delete does not
 ...
 *   {@link google.cloud.retail.v2alpha.Control|Control} to update. The following are
 *   NOT supported:
 *
 *   * {@link google.cloud.retail.v2alpha.Control.name|Control.name}
 *
 ...
 *   {@link google.cloud.retail.v2alpha.ListControlsRequest.filter|filter} is unset.
 *   * List controls that are used in a single ServingConfig:
 *       'serving_config = "boosted_home_page_cvr"'
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [Control]{@link google.cloud.retail.v2alpha.Control}.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [Control]{@link google.cloud.retail.v2alpha.Control} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   [Control]{@link google.cloud.retail.v2alpha.Control}. The API will be called under the hood as needed, once per the page,
