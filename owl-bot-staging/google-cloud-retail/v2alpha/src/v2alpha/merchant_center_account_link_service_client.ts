 ...
 */
  ...
  listMerchantCenterAccountLinks(
    ...
    this.initialize();
    return this.innerApiCalls.listMerchantCenterAccountLinks(request, options, callback);
  }
/**
 ...
 */
  ...
  deleteMerchantCenterAccountLink(
    ...
    this.initialize();
    return this.innerApiCalls.deleteMerchantCenterAccountLink(request, options, callback);
  }
 ...
 */
  ...
  createMerchantCenterAccountLink(
    ...
    options.otherArgs.headers[
      ...
      'merchant_center_account_link.name': request.merchantCenterAccountLink!.name ?? '',
    });
    this.initialize();
    return this.innerApiCalls.createMerchantCenterAccountLink(request, options, callback);
  }
/**
