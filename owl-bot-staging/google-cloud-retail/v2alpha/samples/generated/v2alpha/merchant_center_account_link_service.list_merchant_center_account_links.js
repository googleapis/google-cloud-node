...
function main(parent) {
  ...
  async function callListMerchantCenterAccountLinks() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const response = await retailClient.listMerchantCenterAccountLinks(request);
    console.log(response);
  }

  callListMerchantCenterAccountLinks();
