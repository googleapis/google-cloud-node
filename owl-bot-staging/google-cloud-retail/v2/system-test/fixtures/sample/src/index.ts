...
import {CatalogServiceClient, CompletionServiceClient, ControlServiceClient, ModelServiceClient, PredictionServiceClient, ProductServiceClient, SearchServiceClient, ServingConfigServiceClient, UserEventServiceClient} from '@google-cloud/retail';
