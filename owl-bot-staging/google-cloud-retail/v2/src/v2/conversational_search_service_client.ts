 ...
 * `src/v2/conversational_search_service_client_config.json`.
...
export class ConversationalSearchServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.retail.v2.ConversationalSearchService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.conversationalSearchServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.retail.v2.ConversationalSearchService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.retail.v2.ConversationalSearchService,
 ...
 *   {@link protos.google.cloud.retail.v2.ConversationalSearchResponse.conversation_id|ConversationalSearchResponse.conversation_id}.
 *   For the initial request, this should be empty.
 * @param {google.cloud.retail.v2.ConversationalSearchRequest.SearchParams} [request.searchParams]
 ...
 * @param {google.cloud.retail.v2.ConversationalSearchRequest.ConversationalFilteringSpec} [request.conversationalFilteringSpec]
 ...
 * @returns {Stream}
 *   An object stream which emits {@link protos.google.cloud.retail.v2.ConversationalSearchResponse|ConversationalSearchResponse} on 'data' event.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#server-streaming | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v2/conversational_search_service.conversational_search.js</caption>
 * region_tag:retail_v2_generated_ConversationalSearchService_ConversationalSearch_async
 */
  conversationalSearch(
      request?: protos.google.cloud.retail.v2.IConversationalSearchRequest,
      options?: CallOptions):
