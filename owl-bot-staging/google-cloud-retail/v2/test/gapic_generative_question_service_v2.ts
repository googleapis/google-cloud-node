...
describe('v2.GenerativeQuestionServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new generativequestionserviceModule.v2.GenerativeQuestionServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = generativequestionserviceModule.v2.GenerativeQuestionServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = generativequestionserviceModule.v2.GenerativeQuestionServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'retail.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new generativequestionserviceModule.v2.GenerativeQuestionServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new generativequestionserviceModule.v2.GenerativeQuestionServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new generativequestionserviceModule.v2.GenerativeQuestionServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new generativequestionserviceModule.v2.GenerativeQuestionServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = generativequestionserviceModule.v2.GenerativeQuestionServiceClient.port;
            assert(port);
    ...
    describe('updateGenerativeQuestionsFeatureConfig', () => {
        it('invokes updateGenerativeQuestionsFeatureConfig without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.retail.v2.UpdateGenerativeQuestionsFeatureConfigRequest()
            );
            request.generativeQuestionsFeatureConfig ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.UpdateGenerativeQuestionsFeatureConfigRequest', ['generativeQuestionsFeatureConfig', 'catalog']);
            ...
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2.GenerativeQuestionsFeatureConfig()
            );
            client.innerApiCalls.updateGenerativeQuestionsFeatureConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.updateGenerativeQuestionsFeatureConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateGenerativeQuestionsFeatureConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateGenerativeQuestionsFeatureConfig as SinonStub)
        ...
        it('invokes updateGenerativeQuestionsFeatureConfig without error using callback', async () => {
            ...
            client.innerApiCalls.updateGenerativeQuestionsFeatureConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateGenerativeQuestionsFeatureConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2.IGenerativeQuestionsFeatureConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes updateGenerativeQuestionsFeatureConfig with error', async () => {
            ...
            client.innerApiCalls.updateGenerativeQuestionsFeatureConfig = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateGenerativeQuestionsFeatureConfig(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateGenerativeQuestionsFeatureConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateGenerativeQuestionsFeatureConfig as SinonStub)
    ...
    describe('getGenerativeQuestionsFeatureConfig', () => {
        it('invokes getGenerativeQuestionsFeatureConfig without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.retail.v2.GetGenerativeQuestionsFeatureConfigRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.GetGenerativeQuestionsFeatureConfigRequest', ['catalog']);
            request.catalog = defaultValue1;
            const expectedHeaderRequestParams = `catalog=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2.GenerativeQuestionsFeatureConfig()
            );
            client.innerApiCalls.getGenerativeQuestionsFeatureConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.getGenerativeQuestionsFeatureConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getGenerativeQuestionsFeatureConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getGenerativeQuestionsFeatureConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getGenerativeQuestionsFeatureConfig without error using callback', async () => {
            ...
            client.innerApiCalls.getGenerativeQuestionsFeatureConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getGenerativeQuestionsFeatureConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2.IGenerativeQuestionsFeatureConfig|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes getGenerativeQuestionsFeatureConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `catalog=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getGenerativeQuestionsFeatureConfig = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getGenerativeQuestionsFeatureConfig(request), expectedError);
            const actualRequest = (client.innerApiCalls.getGenerativeQuestionsFeatureConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getGenerativeQuestionsFeatureConfig as SinonStub)
    ...
    describe('listGenerativeQuestionConfigs', () => {
        it('invokes listGenerativeQuestionConfigs without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.retail.v2.ListGenerativeQuestionConfigsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.ListGenerativeQuestionConfigsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2.ListGenerativeQuestionConfigsResponse()
            );
            client.innerApiCalls.listGenerativeQuestionConfigs = stubSimpleCall(expectedResponse);
            const [response] = await client.listGenerativeQuestionConfigs(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listGenerativeQuestionConfigs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listGenerativeQuestionConfigs as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listGenerativeQuestionConfigs without error using callback', async () => {
            ...
            client.innerApiCalls.listGenerativeQuestionConfigs = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listGenerativeQuestionConfigs(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2.IListGenerativeQuestionConfigsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listGenerativeQuestionConfigs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listGenerativeQuestionConfigs = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listGenerativeQuestionConfigs(request), expectedError);
            const actualRequest = (client.innerApiCalls.listGenerativeQuestionConfigs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listGenerativeQuestionConfigs as SinonStub)
    ...
    describe('updateGenerativeQuestionConfig', () => {
        it('invokes updateGenerativeQuestionConfig without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.retail.v2.UpdateGenerativeQuestionConfigRequest()
            );
            request.generativeQuestionConfig ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.UpdateGenerativeQuestionConfigRequest', ['generativeQuestionConfig', 'catalog']);
            ...
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2.GenerativeQuestionConfig()
            );
            client.innerApiCalls.updateGenerativeQuestionConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.updateGenerativeQuestionConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateGenerativeQuestionConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateGenerativeQuestionConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateGenerativeQuestionConfig without error using callback', async () => {
            ...
            client.innerApiCalls.updateGenerativeQuestionConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateGenerativeQuestionConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2.IGenerativeQuestionConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes updateGenerativeQuestionConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `generative_question_config.catalog=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateGenerativeQuestionConfig = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateGenerativeQuestionConfig(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateGenerativeQuestionConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateGenerativeQuestionConfig as SinonStub)
    ...
    describe('batchUpdateGenerativeQuestionConfigs', () => {
        it('invokes batchUpdateGenerativeQuestionConfigs without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.retail.v2.BatchUpdateGenerativeQuestionConfigsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.BatchUpdateGenerativeQuestionConfigsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2.BatchUpdateGenerativeQuestionConfigsResponse()
            );
            client.innerApiCalls.batchUpdateGenerativeQuestionConfigs = stubSimpleCall(expectedResponse);
            const [response] = await client.batchUpdateGenerativeQuestionConfigs(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchUpdateGenerativeQuestionConfigs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchUpdateGenerativeQuestionConfigs as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes batchUpdateGenerativeQuestionConfigs without error using callback', async () => {
            ...
            client.innerApiCalls.batchUpdateGenerativeQuestionConfigs = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchUpdateGenerativeQuestionConfigs(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2.IBatchUpdateGenerativeQuestionConfigsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchUpdateGenerativeQuestionConfigs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchUpdateGenerativeQuestionConfigs = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.batchUpdateGenerativeQuestionConfigs(request), expectedError);
            const actualRequest = (client.innerApiCalls.batchUpdateGenerativeQuestionConfigs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchUpdateGenerativeQuestionConfigs as SinonStub)
