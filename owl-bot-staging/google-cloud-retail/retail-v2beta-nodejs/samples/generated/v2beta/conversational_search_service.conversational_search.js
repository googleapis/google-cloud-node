...
function main(placement, branch, visitorId) {
  // [START retail_v2beta_generated_ConversationalSearchService_ConversationalSearch_async]
  /**
  ...
  const {ConversationalSearchServiceClient} = require('@google-cloud/retail').v2beta;
