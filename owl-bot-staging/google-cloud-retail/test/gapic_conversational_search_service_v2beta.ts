  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          conversationalsearchserviceModule.v2beta
            .ConversationalSearchServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        ...
        const apiEndpoint =
          conversationalsearchserviceModule.v2beta
            .ConversationalSearchServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'retail.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        conversationalsearchserviceModule.v2beta
          .ConversationalSearchServiceClient.port;
      assert(port);
    ...
    it('invokes conversationalSearch without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        stream.on(
          'data',
          (
            response: protos.google.cloud.retail.v2beta.ConversationalSearchResponse,
          ) => {
            resolve(response);
          },
        );
