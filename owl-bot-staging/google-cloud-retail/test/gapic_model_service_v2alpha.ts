...
describe('v2alpha.ModelServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = modelserviceModule.v2alpha.ModelServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = modelserviceModule.v2alpha.ModelServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'retail.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new modelserviceModule.v2alpha.ModelServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new modelserviceModule.v2alpha.ModelServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new modelserviceModule.v2alpha.ModelServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new modelserviceModule.v2alpha.ModelServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getModel', () => {
        it('invokes getModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.GetModelRequest', ['name']);
        ...
        it('invokes getModel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getModel(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2alpha.IModel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('pauseModel', () => {
        it('invokes pauseModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.PauseModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2alpha.Model()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.pauseModel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.pauseModel as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes pauseModel without error using callback', async () => {
            ...
            client.innerApiCalls.pauseModel = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.pauseModel(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2alpha.IModel|null) => {
        ...
        it('invokes pauseModel with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.pauseModel = stubSimpleCall(undefined, expectedError);
    ...
    describe('resumeModel', () => {
        it('invokes resumeModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.ResumeModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2alpha.Model()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.resumeModel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.resumeModel as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes resumeModel without error using callback', async () => {
            ...
            client.innerApiCalls.resumeModel = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.resumeModel(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2alpha.IModel|null) => {
        ...
        it('invokes resumeModel with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.resumeModel = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteModel', () => {
        it('invokes deleteModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.DeleteModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateModel', () => {
        it('invokes updateModel without error', async () => {
            ...
            request.model ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.UpdateModelRequest', ['model', 'name']);
    ...
    describe('createModel', () => {
        it('invokes createModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.CreateModelRequest', ['parent']);
        ...
        it('invokes createModel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.retail.v2alpha.IModel, protos.google.cloud.retail.v2alpha.ICreateModelMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.retail.v2alpha.IModel, protos.google.cloud.retail.v2alpha.ICreateModelMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createModel as SinonStub)
                .getCall(0).args[0];
    ...
    describe('tuneModel', () => {
        it('invokes tuneModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.TuneModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.tuneModel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.tuneModel as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes tuneModel without error using callback', async () => {
            ...
            client.innerApiCalls.tuneModel = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.tuneModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.retail.v2alpha.ITuneModelResponse, protos.google.cloud.retail.v2alpha.ITuneModelMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.retail.v2alpha.ITuneModelResponse, protos.google.cloud.retail.v2alpha.ITuneModelMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.tuneModel as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes tuneModel with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.tuneModel = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes tuneModel with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.tuneModel = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.tuneModel(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.tuneModel as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkTuneModelProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkTuneModelProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('listModels', () => {
        it('invokes listModels without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.ListModelsRequest', ['parent']);
            request.parent = defaultValue1;
        ...
        it('invokes listModelsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.retail.v2alpha.Model) => {
