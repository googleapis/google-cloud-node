...
export {v2beta, CatalogServiceClient, CompletionServiceClient, ControlServiceClient, ModelServiceClient, PredictionServiceClient, ProductServiceClient, SearchServiceClient, ServingConfigServiceClient, UserEventServiceClient};
export default {v2beta, CatalogServiceClient, CompletionServiceClient, ControlServiceClient, ModelServiceClient, PredictionServiceClient, ProductServiceClient, SearchServiceClient, ServingConfigServiceClient, UserEventServiceClient};
