...
export class ProductServiceClient {
  ...
  initialize() {
    ...
    const productServiceStubMethods =
        ['createProduct', 'getProduct', 'listProducts', 'updateProduct', 'deleteProduct', 'importProducts', 'setInventory', 'addFulfillmentPlaces', 'removeFulfillmentPlaces', 'addLocalInventories', 'removeLocalInventories'];
