...
describe('v2beta.AnalyticsServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = analyticsserviceModule.v2beta.AnalyticsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = analyticsserviceModule.v2beta.AnalyticsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'retail.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new analyticsserviceModule.v2beta.AnalyticsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new analyticsserviceModule.v2beta.AnalyticsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new analyticsserviceModule.v2beta.AnalyticsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new analyticsserviceModule.v2beta.AnalyticsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('exportAnalyticsMetrics', () => {
        it('invokes exportAnalyticsMetrics without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.ExportAnalyticsMetricsRequest', ['catalog']);
            request.catalog = defaultValue1;
            const expectedHeaderRequestParams = `catalog=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.exportAnalyticsMetrics = stubLongRunningCall(expectedResponse);
            const [operation] = await client.exportAnalyticsMetrics(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportAnalyticsMetrics as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.exportAnalyticsMetrics as SinonStub)
        ...
        it('invokes exportAnalyticsMetrics without error using callback', async () => {
            ...
            client.innerApiCalls.exportAnalyticsMetrics = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.exportAnalyticsMetrics(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.retail.v2beta.IExportAnalyticsMetricsResponse, protos.google.cloud.retail.v2beta.IExportMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.retail.v2beta.IExportAnalyticsMetricsResponse, protos.google.cloud.retail.v2beta.IExportMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportAnalyticsMetrics as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes exportAnalyticsMetrics with call error', async () => {
            ...
            client.innerApiCalls.exportAnalyticsMetrics = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.exportAnalyticsMetrics(request), expectedError);
            const actualRequest = (client.innerApiCalls.exportAnalyticsMetrics as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.exportAnalyticsMetrics as SinonStub)
        ...
        it('invokes exportAnalyticsMetrics with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `catalog=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.exportAnalyticsMetrics = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.exportAnalyticsMetrics(request);
        ...
        it('invokes checkExportAnalyticsMetricsProgress without error', async () => {
            ...
            const decodedOperation = await client.checkExportAnalyticsMetricsProgress(expectedResponse.name);
        ...
        it('invokes checkExportAnalyticsMetricsProgress with error', async () => {
            ...
            await assert.rejects(client.checkExportAnalyticsMetricsProgress(''), expectedError);
