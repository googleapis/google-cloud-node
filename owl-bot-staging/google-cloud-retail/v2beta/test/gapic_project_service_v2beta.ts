...
describe('v2beta.ProjectServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new projectserviceModule.v2beta.ProjectServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = projectserviceModule.v2beta.ProjectServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = projectserviceModule.v2beta.ProjectServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'retail.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new projectserviceModule.v2beta.ProjectServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new projectserviceModule.v2beta.ProjectServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new projectserviceModule.v2beta.ProjectServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new projectserviceModule.v2beta.ProjectServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = projectserviceModule.v2beta.ProjectServiceClient.port;
            assert(port);
    ...
    describe('getAlertConfig', () => {
        it('invokes getAlertConfig without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.retail.v2beta.GetAlertConfigRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.GetAlertConfigRequest', ['name']);
        ...
        it('invokes getAlertConfig without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAlertConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2beta.IAlertConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateAlertConfig', () => {
        it('invokes updateAlertConfig without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.retail.v2beta.UpdateAlertConfigRequest()
            );
            request.alertConfig ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.UpdateAlertConfigRequest', ['alertConfig', 'name']);
