...
describe('v2beta.GenerativeQuestionServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new generativequestionserviceModule.v2beta.GenerativeQuestionServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = generativequestionserviceModule.v2beta.GenerativeQuestionServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = generativequestionserviceModule.v2beta.GenerativeQuestionServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'retail.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new generativequestionserviceModule.v2beta.GenerativeQuestionServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new generativequestionserviceModule.v2beta.GenerativeQuestionServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new generativequestionserviceModule.v2beta.GenerativeQuestionServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new generativequestionserviceModule.v2beta.GenerativeQuestionServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = generativequestionserviceModule.v2beta.GenerativeQuestionServiceClient.port;
            assert(port);
    ...
    describe('updateGenerativeQuestionsFeatureConfig', () => {
        it('invokes updateGenerativeQuestionsFeatureConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.UpdateGenerativeQuestionsFeatureConfigRequest', ['generativeQuestionsFeatureConfig', 'catalog']);
        ...
        it('invokes updateGenerativeQuestionsFeatureConfig without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updateGenerativeQuestionsFeatureConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2beta.IGenerativeQuestionsFeatureConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getGenerativeQuestionsFeatureConfig', () => {
        it('invokes getGenerativeQuestionsFeatureConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.GetGenerativeQuestionsFeatureConfigRequest', ['catalog']);
    ...
    describe('listGenerativeQuestionConfigs', () => {
        it('invokes listGenerativeQuestionConfigs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.ListGenerativeQuestionConfigsRequest', ['parent']);
        ...
        it('invokes listGenerativeQuestionConfigs without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listGenerativeQuestionConfigs(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2beta.IListGenerativeQuestionConfigsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateGenerativeQuestionConfig', () => {
        it('invokes updateGenerativeQuestionConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.UpdateGenerativeQuestionConfigRequest', ['generativeQuestionConfig', 'catalog']);
        ...
        it('invokes updateGenerativeQuestionConfig without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updateGenerativeQuestionConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2beta.IGenerativeQuestionConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('batchUpdateGenerativeQuestionConfigs', () => {
        it('invokes batchUpdateGenerativeQuestionConfigs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.BatchUpdateGenerativeQuestionConfigsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes batchUpdateGenerativeQuestionConfigs without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchUpdateGenerativeQuestionConfigs(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2beta.IBatchUpdateGenerativeQuestionConfigsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
