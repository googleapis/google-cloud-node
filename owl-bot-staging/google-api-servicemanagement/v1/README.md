...
# [Servicemanagement: Nodejs Client][homepage]
...
* [Servicemanagement Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/servicemanagement/latest)
...
1.  [Enable the Servicemanagement API][enable_api].
