...
describe('v1.ManagedSchemaRegistryClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          managedschemaregistryModule.v1.ManagedSchemaRegistryClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        managedschemaregistryModule.v1.ManagedSchemaRegistryClient.port;
      assert(port);
  ...
  describe('getSchemaRegistry', () => {
    it('invokes getSchemaRegistry without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getSchemaRegistry as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getSchemaRegistry without error using callback', async () => {
      ...
      client.innerApiCalls.getSchemaRegistry =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getSchemaRegistry(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.managedkafka.schemaregistry.v1.ISchemaRegistry | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getSchemaRegistry with error', async () => {
      ...
      client.innerApiCalls.getSchemaRegistry = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listSchemaRegistries', () => {
    it('invokes listSchemaRegistries without error', async () => {
      ...
      client.innerApiCalls.listSchemaRegistries =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listSchemaRegistries(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listSchemaRegistries as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listSchemaRegistries as SinonStub
    ...
    it('invokes listSchemaRegistries without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listSchemaRegistries(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.managedkafka.schemaregistry.v1.IListSchemaRegistriesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listSchemaRegistries with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listSchemaRegistries = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createSchemaRegistry', () => {
    it('invokes createSchemaRegistry without error', async () => {
      ...
      client.innerApiCalls.createSchemaRegistry =
        stubSimpleCall(expectedResponse);
      const [response] = await client.createSchemaRegistry(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createSchemaRegistry as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createSchemaRegistry as SinonStub
    ...
    it('invokes createSchemaRegistry with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createSchemaRegistry = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteSchemaRegistry', () => {
    it('invokes deleteSchemaRegistry without error', async () => {
      ...
      client.innerApiCalls.deleteSchemaRegistry =
        stubSimpleCall(expectedResponse);
      const [response] = await client.deleteSchemaRegistry(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteSchemaRegistry as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteSchemaRegistry as SinonStub
    ...
    it('invokes deleteSchemaRegistry with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteSchemaRegistry = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes getContext without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getContext(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.managedkafka.schemaregistry.v1.IContext | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getSchema without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getSchema(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.managedkafka.schemaregistry.v1.ISchema | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getRawSchema', () => {
    it('invokes getRawSchema without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getRawSchema as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getRawSchema as SinonStub
    ...
    it('invokes getRawSchema with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getRawSchema = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listSchemaVersions', () => {
    it('invokes listSchemaVersions without error', async () => {
      ...
      client.innerApiCalls.listSchemaVersions =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listSchemaVersions(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listSchemaVersions as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listSchemaVersions as SinonStub
    ...
    it('invokes listSchemaVersions with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listSchemaVersions = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listSchemaTypes', () => {
    it('invokes listSchemaTypes without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listSchemaTypes as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listSchemaTypes as SinonStub
    ...
    it('invokes listSchemaTypes without error using callback', async () => {
      ...
      client.innerApiCalls.listSchemaTypes =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listSchemaTypes with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listSchemaTypes = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listSubjects', () => {
    it('invokes listSubjects without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listSubjects as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listSubjects as SinonStub
    ...
    it('invokes listSubjects with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listSubjects = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listSubjectsBySchemaId', () => {
    it('invokes listSubjectsBySchemaId without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listSubjectsBySchemaId as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listSubjectsBySchemaId as SinonStub
    ...
    it('invokes listSubjectsBySchemaId with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listSubjectsBySchemaId = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listSubjectsBySchemaId(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listSubjectsBySchemaId as SinonStub
  ...
  describe('deleteSubject', () => {
    it('invokes deleteSubject without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteSubject as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteSubject as SinonStub
    ...
    it('invokes deleteSubject without error using callback', async () => {
      ...
      client.innerApiCalls.deleteSubject =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes deleteSubject with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteSubject = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('lookupVersion', () => {
    it('invokes lookupVersion without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.lookupVersion as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.lookupVersion as SinonStub
    ...
    it('invokes lookupVersion without error using callback', async () => {
      ...
      client.innerApiCalls.lookupVersion =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.lookupVersion(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.managedkafka.schemaregistry.v1.ISchemaVersion | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes lookupVersion with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.lookupVersion = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getRawSchemaVersion', () => {
    it('invokes getRawSchemaVersion without error', async () => {
      ...
      client.innerApiCalls.getRawSchemaVersion =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getRawSchemaVersion(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getRawSchemaVersion as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getRawSchemaVersion as SinonStub
    ...
    it('invokes getRawSchemaVersion with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getRawSchemaVersion = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes createVersion without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createVersion(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.managedkafka.schemaregistry.v1.ICreateVersionResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listReferencedSchemas', () => {
    it('invokes listReferencedSchemas without error', async () => {
      ...
      client.innerApiCalls.listReferencedSchemas =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listReferencedSchemas(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listReferencedSchemas as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listReferencedSchemas as SinonStub
    ...
    it('invokes listReferencedSchemas with error', async () => {
      ...
      await assert.rejects(
        client.listReferencedSchemas(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listReferencedSchemas as SinonStub
    ...
    it('invokes checkCompatibility without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.checkCompatibility(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.managedkafka.schemaregistry.v1.ICheckCompatibilityResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getSchemaConfig', () => {
    it('invokes getSchemaConfig without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getSchemaConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getSchemaConfig as SinonStub
    ...
    it('invokes getSchemaConfig without error using callback', async () => {
      ...
      client.innerApiCalls.getSchemaConfig =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getSchemaConfig(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.managedkafka.schemaregistry.v1.ISchemaConfig | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getSchemaConfig with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getSchemaConfig = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateSchemaConfig', () => {
    it('invokes updateSchemaConfig without error', async () => {
      ...
      client.innerApiCalls.updateSchemaConfig =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateSchemaConfig(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateSchemaConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateSchemaConfig as SinonStub
    ...
    it('invokes updateSchemaConfig with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateSchemaConfig = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteSchemaConfig', () => {
    it('invokes deleteSchemaConfig without error', async () => {
      ...
      client.innerApiCalls.deleteSchemaConfig =
        stubSimpleCall(expectedResponse);
      const [response] = await client.deleteSchemaConfig(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteSchemaConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteSchemaConfig as SinonStub
    ...
    it('invokes deleteSchemaConfig with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteSchemaConfig = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getSchemaMode', () => {
    it('invokes getSchemaMode without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getSchemaMode as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getSchemaMode as SinonStub
    ...
    it('invokes getSchemaMode without error using callback', async () => {
      ...
      client.innerApiCalls.getSchemaMode =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getSchemaMode(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.managedkafka.schemaregistry.v1.ISchemaMode | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getSchemaMode with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getSchemaMode = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateSchemaMode', () => {
    it('invokes updateSchemaMode without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateSchemaMode as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateSchemaMode as SinonStub
    ...
    it('invokes updateSchemaMode with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateSchemaMode = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteSchemaMode', () => {
    it('invokes deleteSchemaMode without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteSchemaMode as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteSchemaMode as SinonStub
    ...
    it('invokes deleteSchemaMode without error using callback', async () => {
      ...
      client.innerApiCalls.deleteSchemaMode =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes deleteSchemaMode with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteSchemaMode = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('Path templates', () => {
    describe('projectLocationSchemaRegistryCompatibilitySubjectVersions', async () => {
      const fakePath =
        '/rendered/path/projectLocationSchemaRegistryCompatibilitySubjectVersions';
      ...
      it('projectLocationSchemaRegistryCompatibilitySubjectVersionsPath', () => {
        const result =
          client.projectLocationSchemaRegistryCompatibilitySubjectVersionsPath(
            'projectValue',
            'locationValue',
            'schemaRegistryValue',
            'subjectValue',
      ...
      it('matchProjectFromProjectLocationSchemaRegistryCompatibilitySubjectVersionsName', () => {
        const result =
          client.matchProjectFromProjectLocationSchemaRegistryCompatibilitySubjectVersionsName(
            fakePath,
          );
      ...
      it('matchLocationFromProjectLocationSchemaRegistryCompatibilitySubjectVersionsName', () => {
        const result =
          client.matchLocationFromProjectLocationSchemaRegistryCompatibilitySubjectVersionsName(
            fakePath,
          );
      ...
      it('matchSchemaRegistryFromProjectLocationSchemaRegistryCompatibilitySubjectVersionsName', () => {
        const result =
          client.matchSchemaRegistryFromProjectLocationSchemaRegistryCompatibilitySubjectVersionsName(
            fakePath,
          );
      ...
      it('matchSubjectFromProjectLocationSchemaRegistryCompatibilitySubjectVersionsName', () => {
        const result =
          client.matchSubjectFromProjectLocationSchemaRegistryCompatibilitySubjectVersionsName(
            fakePath,
          );
      ...
      it('matchVersionFromProjectLocationSchemaRegistryCompatibilitySubjectVersionsName', () => {
        const result =
          client.matchVersionFromProjectLocationSchemaRegistryCompatibilitySubjectVersionsName(
            fakePath,
          );
    ...
    describe('projectLocationSchemaRegistryConfig', async () => {
      ...
      it('projectLocationSchemaRegistryConfigPath', () => {
        const result = client.projectLocationSchemaRegistryConfigPath(
          'projectValue',
          'locationValue',
          'schemaRegistryValue',
        );
      ...
      it('matchProjectFromProjectLocationSchemaRegistryConfigName', () => {
        const result =
          client.matchProjectFromProjectLocationSchemaRegistryConfigName(
            fakePath,
          );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromProjectLocationSchemaRegistryConfigName', () => {
        const result =
          client.matchLocationFromProjectLocationSchemaRegistryConfigName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchSchemaRegistryFromProjectLocationSchemaRegistryConfigName', () => {
        const result =
          client.matchSchemaRegistryFromProjectLocationSchemaRegistryConfigName(
            fakePath,
          );
        assert.strictEqual(result, 'schemaRegistryValue');
        assert(
    ...
    describe('projectLocationSchemaRegistryContextCompatibilitySubjectVersions', async () => {
      const fakePath =
        '/rendered/path/projectLocationSchemaRegistryContextCompatibilitySubjectVersions';
      const expectedParameters = {
        project: 'projectValue',
        location: 'locationValue',
        schema_registry: 'schemaRegistryValue',
      ...
      it('projectLocationSchemaRegistryContextCompatibilitySubjectVersionsPath', () => {
        const result =
          client.projectLocationSchemaRegistryContextCompatibilitySubjectVersionsPath(
            'projectValue',
            'locationValue',
            'schemaRegistryValue',
            'contextValue',
      ...
      it('matchProjectFromProjectLocationSchemaRegistryContextCompatibilitySubjectVersionsName', () => {
        const result =
          client.matchProjectFromProjectLocationSchemaRegistryContextCompatibilitySubjectVersionsName(
            fakePath,
          );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromProjectLocationSchemaRegistryContextCompatibilitySubjectVersionsName', () => {
        const result =
          client.matchLocationFromProjectLocationSchemaRegistryContextCompatibilitySubjectVersionsName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchSchemaRegistryFromProjectLocationSchemaRegistryContextCompatibilitySubjectVersionsName', () => {
        const result =
          client.matchSchemaRegistryFromProjectLocationSchemaRegistryContextCompatibilitySubjectVersionsName(
            fakePath,
          );
        assert.strictEqual(result, 'schemaRegistryValue');
        assert(
      ...
      it('matchContextFromProjectLocationSchemaRegistryContextCompatibilitySubjectVersionsName', () => {
        const result =
          client.matchContextFromProjectLocationSchemaRegistryContextCompatibilitySubjectVersionsName(
            fakePath,
          );
      ...
      it('matchSubjectFromProjectLocationSchemaRegistryContextCompatibilitySubjectVersionsName', () => {
        const result =
          client.matchSubjectFromProjectLocationSchemaRegistryContextCompatibilitySubjectVersionsName(
            fakePath,
          );
        assert.strictEqual(result, 'subjectValue');
        assert(
      ...
      it('matchVersionFromProjectLocationSchemaRegistryContextCompatibilitySubjectVersionsName', () => {
        const result =
          client.matchVersionFromProjectLocationSchemaRegistryContextCompatibilitySubjectVersionsName(
            fakePath,
          );
        assert.strictEqual(result, 'versionValue');
        assert(
    ...
    describe('projectLocationSchemaRegistryContextConfig', async () => {
      const fakePath =
        '/rendered/path/projectLocationSchemaRegistryContextConfig';
      const expectedParameters = {
        project: 'projectValue',
        location: 'locationValue',
        schema_registry: 'schemaRegistryValue',
      ...
      it('projectLocationSchemaRegistryContextConfigPath', () => {
        const result = client.projectLocationSchemaRegistryContextConfigPath(
          'projectValue',
          'locationValue',
          'schemaRegistryValue',
          'contextValue',
      ...
      it('matchProjectFromProjectLocationSchemaRegistryContextConfigName', () => {
        const result =
          client.matchProjectFromProjectLocationSchemaRegistryContextConfigName(
            fakePath,
          );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromProjectLocationSchemaRegistryContextConfigName', () => {
        const result =
          client.matchLocationFromProjectLocationSchemaRegistryContextConfigName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchSchemaRegistryFromProjectLocationSchemaRegistryContextConfigName', () => {
        const result =
          client.matchSchemaRegistryFromProjectLocationSchemaRegistryContextConfigName(
            fakePath,
          );
        assert.strictEqual(result, 'schemaRegistryValue');
        assert(
      ...
      it('matchContextFromProjectLocationSchemaRegistryContextConfigName', () => {
        const result =
          client.matchContextFromProjectLocationSchemaRegistryContextConfigName(
            fakePath,
          );
        assert.strictEqual(result, 'contextValue');
        assert(
    ...
    describe('projectLocationSchemaRegistryContextMode', async () => {
      const fakePath =
        '/rendered/path/projectLocationSchemaRegistryContextMode';
      const expectedParameters = {
        project: 'projectValue',
        location: 'locationValue',
        schema_registry: 'schemaRegistryValue',
      ...
      it('projectLocationSchemaRegistryContextModePath', () => {
        const result = client.projectLocationSchemaRegistryContextModePath(
          'projectValue',
          'locationValue',
          'schemaRegistryValue',
          'contextValue',
      ...
      it('matchProjectFromProjectLocationSchemaRegistryContextModeName', () => {
        const result =
          client.matchProjectFromProjectLocationSchemaRegistryContextModeName(
            fakePath,
          );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromProjectLocationSchemaRegistryContextModeName', () => {
        const result =
          client.matchLocationFromProjectLocationSchemaRegistryContextModeName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchSchemaRegistryFromProjectLocationSchemaRegistryContextModeName', () => {
        const result =
          client.matchSchemaRegistryFromProjectLocationSchemaRegistryContextModeName(
            fakePath,
          );
        assert.strictEqual(result, 'schemaRegistryValue');
        assert(
      ...
      it('matchContextFromProjectLocationSchemaRegistryContextModeName', () => {
        const result =
          client.matchContextFromProjectLocationSchemaRegistryContextModeName(
            fakePath,
          );
        assert.strictEqual(result, 'contextValue');
        assert(
    ...
    describe('projectLocationSchemaRegistryContextSchemas', async () => {
      const fakePath =
        '/rendered/path/projectLocationSchemaRegistryContextSchemas';
      const expectedParameters = {
        project: 'projectValue',
        location: 'locationValue',
        schema_registry: 'schemaRegistryValue',
      ...
      it('matchProjectFromProjectLocationSchemaRegistryContextSchemasName', () => {
        const result =
          client.matchProjectFromProjectLocationSchemaRegistryContextSchemasName(
            fakePath,
          );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromProjectLocationSchemaRegistryContextSchemasName', () => {
        const result =
          client.matchLocationFromProjectLocationSchemaRegistryContextSchemasName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchSchemaRegistryFromProjectLocationSchemaRegistryContextSchemasName', () => {
        const result =
          client.matchSchemaRegistryFromProjectLocationSchemaRegistryContextSchemasName(
            fakePath,
          );
        assert.strictEqual(result, 'schemaRegistryValue');
        assert(
      ...
      it('matchContextFromProjectLocationSchemaRegistryContextSchemasName', () => {
        const result =
          client.matchContextFromProjectLocationSchemaRegistryContextSchemasName(
            fakePath,
          );
        assert.strictEqual(result, 'contextValue');
        assert(
      ...
      it('matchSchemaFromProjectLocationSchemaRegistryContextSchemasName', () => {
        const result =
          client.matchSchemaFromProjectLocationSchemaRegistryContextSchemasName(
            fakePath,
          );
    ...
    describe('projectLocationSchemaRegistryContextSubject', async () => {
      const fakePath =
        '/rendered/path/projectLocationSchemaRegistryContextSubject';
      const expectedParameters = {
        project: 'projectValue',
        location: 'locationValue',
        schema_registry: 'schemaRegistryValue',
      ...
      it('projectLocationSchemaRegistryContextSubjectPath', () => {
        const result = client.projectLocationSchemaRegistryContextSubjectPath(
          'projectValue',
          'locationValue',
          'schemaRegistryValue',
          'contextValue',
      ...
      it('matchProjectFromProjectLocationSchemaRegistryContextSubjectName', () => {
        const result =
          client.matchProjectFromProjectLocationSchemaRegistryContextSubjectName(
            fakePath,
          );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromProjectLocationSchemaRegistryContextSubjectName', () => {
        const result =
          client.matchLocationFromProjectLocationSchemaRegistryContextSubjectName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchSchemaRegistryFromProjectLocationSchemaRegistryContextSubjectName', () => {
        const result =
          client.matchSchemaRegistryFromProjectLocationSchemaRegistryContextSubjectName(
            fakePath,
          );
        assert.strictEqual(result, 'schemaRegistryValue');
        assert(
      ...
      it('matchContextFromProjectLocationSchemaRegistryContextSubjectName', () => {
        const result =
          client.matchContextFromProjectLocationSchemaRegistryContextSubjectName(
            fakePath,
          );
        assert.strictEqual(result, 'contextValue');
        assert(
      ...
      it('matchSubjectFromProjectLocationSchemaRegistryContextSubjectName', () => {
        const result =
          client.matchSubjectFromProjectLocationSchemaRegistryContextSubjectName(
            fakePath,
          );
        assert.strictEqual(result, 'subjectValue');
        assert(
    ...
    describe('projectLocationSchemaRegistryContextSubjectVersions', async () => {
      const fakePath =
        '/rendered/path/projectLocationSchemaRegistryContextSubjectVersions';
      const expectedParameters = {
        project: 'projectValue',
        location: 'locationValue',
        schema_registry: 'schemaRegistryValue',
      ...
      it('projectLocationSchemaRegistryContextSubjectVersionsPath', () => {
        const result =
          client.projectLocationSchemaRegistryContextSubjectVersionsPath(
            'projectValue',
            'locationValue',
            'schemaRegistryValue',
            'contextValue',
      ...
      it('matchProjectFromProjectLocationSchemaRegistryContextSubjectVersionsName', () => {
        const result =
          client.matchProjectFromProjectLocationSchemaRegistryContextSubjectVersionsName(
            fakePath,
          );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromProjectLocationSchemaRegistryContextSubjectVersionsName', () => {
        const result =
          client.matchLocationFromProjectLocationSchemaRegistryContextSubjectVersionsName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchSchemaRegistryFromProjectLocationSchemaRegistryContextSubjectVersionsName', () => {
        const result =
          client.matchSchemaRegistryFromProjectLocationSchemaRegistryContextSubjectVersionsName(
            fakePath,
          );
        assert.strictEqual(result, 'schemaRegistryValue');
        assert(
      ...
      it('matchContextFromProjectLocationSchemaRegistryContextSubjectVersionsName', () => {
        const result =
          client.matchContextFromProjectLocationSchemaRegistryContextSubjectVersionsName(
            fakePath,
          );
        assert.strictEqual(result, 'contextValue');
        assert(
      ...
      it('matchSubjectFromProjectLocationSchemaRegistryContextSubjectVersionsName', () => {
        const result =
          client.matchSubjectFromProjectLocationSchemaRegistryContextSubjectVersionsName(
            fakePath,
          );
        assert.strictEqual(result, 'subjectValue');
        assert(
      ...
      it('matchVersionFromProjectLocationSchemaRegistryContextSubjectVersionsName', () => {
        const result =
          client.matchVersionFromProjectLocationSchemaRegistryContextSubjectVersionsName(
            fakePath,
          );
        assert.strictEqual(result, 'versionValue');
        assert(
    ...
    describe('projectLocationSchemaRegistryContextSubjects', async () => {
      const fakePath =
        '/rendered/path/projectLocationSchemaRegistryContextSubjects';
      const expectedParameters = {
        project: 'projectValue',
        location: 'locationValue',
        schema_registry: 'schemaRegistryValue',
      ...
      it('projectLocationSchemaRegistryContextSubjectsPath', () => {
        const result = client.projectLocationSchemaRegistryContextSubjectsPath(
          'projectValue',
          'locationValue',
          'schemaRegistryValue',
          'contextValue',
      ...
      it('matchProjectFromProjectLocationSchemaRegistryContextSubjectsName', () => {
        const result =
          client.matchProjectFromProjectLocationSchemaRegistryContextSubjectsName(
            fakePath,
          );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromProjectLocationSchemaRegistryContextSubjectsName', () => {
        const result =
          client.matchLocationFromProjectLocationSchemaRegistryContextSubjectsName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchSchemaRegistryFromProjectLocationSchemaRegistryContextSubjectsName', () => {
        const result =
          client.matchSchemaRegistryFromProjectLocationSchemaRegistryContextSubjectsName(
            fakePath,
          );
        assert.strictEqual(result, 'schemaRegistryValue');
        assert(
      ...
      it('matchContextFromProjectLocationSchemaRegistryContextSubjectsName', () => {
        const result =
          client.matchContextFromProjectLocationSchemaRegistryContextSubjectsName(
            fakePath,
          );
        assert.strictEqual(result, 'contextValue');
        assert(
      ...
      it('matchSubjectFromProjectLocationSchemaRegistryContextSubjectsName', () => {
        const result =
          client.matchSubjectFromProjectLocationSchemaRegistryContextSubjectsName(
            fakePath,
          );
        assert.strictEqual(result, 'subjectValue');
        assert(
    ...
    describe('projectLocationSchemaRegistryMode', async () => {
      ...
      it('projectLocationSchemaRegistryModePath', () => {
        const result = client.projectLocationSchemaRegistryModePath(
          'projectValue',
          'locationValue',
          'schemaRegistryValue',
        );
        ...
        assert(
          (
            client.pathTemplates.projectLocationSchemaRegistryModePathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromProjectLocationSchemaRegistryModeName', () => {
        const result =
          client.matchProjectFromProjectLocationSchemaRegistryModeName(
            fakePath,
          );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromProjectLocationSchemaRegistryModeName', () => {
        const result =
          client.matchLocationFromProjectLocationSchemaRegistryModeName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchSchemaRegistryFromProjectLocationSchemaRegistryModeName', () => {
        const result =
          client.matchSchemaRegistryFromProjectLocationSchemaRegistryModeName(
            fakePath,
          );
        assert.strictEqual(result, 'schemaRegistryValue');
        assert(
    ...
    describe('projectLocationSchemaRegistrySchemas', async () => {
      ...
      it('projectLocationSchemaRegistrySchemasPath', () => {
        const result = client.projectLocationSchemaRegistrySchemasPath(
          'projectValue',
          'locationValue',
          'schemaRegistryValue',
          'schemaValue',
      ...
      it('matchProjectFromProjectLocationSchemaRegistrySchemasName', () => {
        const result =
          client.matchProjectFromProjectLocationSchemaRegistrySchemasName(
            fakePath,
          );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromProjectLocationSchemaRegistrySchemasName', () => {
        const result =
          client.matchLocationFromProjectLocationSchemaRegistrySchemasName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchSchemaRegistryFromProjectLocationSchemaRegistrySchemasName', () => {
        const result =
          client.matchSchemaRegistryFromProjectLocationSchemaRegistrySchemasName(
            fakePath,
          );
        assert.strictEqual(result, 'schemaRegistryValue');
        assert(
      ...
      it('matchSchemaFromProjectLocationSchemaRegistrySchemasName', () => {
        const result =
          client.matchSchemaFromProjectLocationSchemaRegistrySchemasName(
            fakePath,
          );
        assert.strictEqual(result, 'schemaValue');
        assert(
    ...
    describe('projectLocationSchemaRegistrySubject', async () => {
      ...
      it('projectLocationSchemaRegistrySubjectPath', () => {
        const result = client.projectLocationSchemaRegistrySubjectPath(
          'projectValue',
          'locationValue',
          'schemaRegistryValue',
          'subjectValue',
      ...
      it('matchProjectFromProjectLocationSchemaRegistrySubjectName', () => {
        const result =
          client.matchProjectFromProjectLocationSchemaRegistrySubjectName(
            fakePath,
          );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromProjectLocationSchemaRegistrySubjectName', () => {
        const result =
          client.matchLocationFromProjectLocationSchemaRegistrySubjectName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchSchemaRegistryFromProjectLocationSchemaRegistrySubjectName', () => {
        const result =
          client.matchSchemaRegistryFromProjectLocationSchemaRegistrySubjectName(
            fakePath,
          );
        assert.strictEqual(result, 'schemaRegistryValue');
        assert(
      ...
      it('matchSubjectFromProjectLocationSchemaRegistrySubjectName', () => {
        const result =
          client.matchSubjectFromProjectLocationSchemaRegistrySubjectName(
            fakePath,
          );
        assert.strictEqual(result, 'subjectValue');
        assert(
    ...
    describe('projectLocationSchemaRegistrySubjectVersions', async () => {
      const fakePath =
        '/rendered/path/projectLocationSchemaRegistrySubjectVersions';
      const expectedParameters = {
        project: 'projectValue',
        location: 'locationValue',
        schema_registry: 'schemaRegistryValue',
      ...
      it('projectLocationSchemaRegistrySubjectVersionsPath', () => {
        const result = client.projectLocationSchemaRegistrySubjectVersionsPath(
          'projectValue',
          'locationValue',
          'schemaRegistryValue',
          'subjectValue',
      ...
      it('matchProjectFromProjectLocationSchemaRegistrySubjectVersionsName', () => {
        const result =
          client.matchProjectFromProjectLocationSchemaRegistrySubjectVersionsName(
            fakePath,
          );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromProjectLocationSchemaRegistrySubjectVersionsName', () => {
        const result =
          client.matchLocationFromProjectLocationSchemaRegistrySubjectVersionsName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchSchemaRegistryFromProjectLocationSchemaRegistrySubjectVersionsName', () => {
        const result =
          client.matchSchemaRegistryFromProjectLocationSchemaRegistrySubjectVersionsName(
            fakePath,
          );
        assert.strictEqual(result, 'schemaRegistryValue');
        assert(
      ...
      it('matchSubjectFromProjectLocationSchemaRegistrySubjectVersionsName', () => {
        const result =
          client.matchSubjectFromProjectLocationSchemaRegistrySubjectVersionsName(
            fakePath,
          );
        assert.strictEqual(result, 'subjectValue');
        assert(
      ...
      it('matchVersionFromProjectLocationSchemaRegistrySubjectVersionsName', () => {
        const result =
          client.matchVersionFromProjectLocationSchemaRegistrySubjectVersionsName(
            fakePath,
          );
        assert.strictEqual(result, 'versionValue');
        assert(
    ...
    describe('projectLocationSchemaRegistrySubjects', async () => {
      ...
      it('projectLocationSchemaRegistrySubjectsPath', () => {
        const result = client.projectLocationSchemaRegistrySubjectsPath(
          'projectValue',
          'locationValue',
          'schemaRegistryValue',
          'subjectValue',
      ...
      it('matchProjectFromProjectLocationSchemaRegistrySubjectsName', () => {
        const result =
          client.matchProjectFromProjectLocationSchemaRegistrySubjectsName(
            fakePath,
          );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromProjectLocationSchemaRegistrySubjectsName', () => {
        const result =
          client.matchLocationFromProjectLocationSchemaRegistrySubjectsName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchSchemaRegistryFromProjectLocationSchemaRegistrySubjectsName', () => {
        const result =
          client.matchSchemaRegistryFromProjectLocationSchemaRegistrySubjectsName(
            fakePath,
          );
        assert.strictEqual(result, 'schemaRegistryValue');
        assert(
      ...
      it('matchSubjectFromProjectLocationSchemaRegistrySubjectsName', () => {
        const result =
          client.matchSubjectFromProjectLocationSchemaRegistrySubjectsName(
            fakePath,
          );
        assert.strictEqual(result, 'subjectValue');
        assert(
    ...
    describe('schemaContext', async () => {
      ...
      await client.initialize();
      client.pathTemplates.schemaContextPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.schemaContextPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('schemaContextPath', () => {
        const result = client.schemaContextPath(
          'projectValue',
          'locationValue',
          'schemaRegistryValue',
          'contextValue',
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.schemaContextPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromSchemaContextName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.schemaContextPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchSchemaRegistryFromSchemaContextName', () => {
        const result =
          client.matchSchemaRegistryFromSchemaContextName(fakePath);
        assert.strictEqual(result, 'schemaRegistryValue');
        assert(
          (client.pathTemplates.schemaContextPathTemplate.match as SinonStub)
            .getCall(-1)
    ...
    describe('schemaRegistry', async () => {
      ...
      await client.initialize();
      client.pathTemplates.schemaRegistryPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.schemaRegistryPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('schemaRegistryPath', () => {
        const result = client.schemaRegistryPath(
          'projectValue',
          'locationValue',
          'schemaRegistryValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.schemaRegistryPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromSchemaRegistryName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.schemaRegistryPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchSchemaRegistryFromSchemaRegistryName', () => {
        const result =
          client.matchSchemaRegistryFromSchemaRegistryName(fakePath);
        assert.strictEqual(result, 'schemaRegistryValue');
        assert(
          (client.pathTemplates.schemaRegistryPathTemplate.match as SinonStub)
            .getCall(-1)
