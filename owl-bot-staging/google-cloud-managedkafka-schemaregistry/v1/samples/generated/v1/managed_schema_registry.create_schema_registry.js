...
function main(parent, schemaRegistryId, schemaRegistry) {
  // [START managedkafka_v1_generated_ManagedSchemaRegistry_CreateSchemaRegistry_async]
  /**
  ...
  async function callCreateSchemaRegistry() {
    ...
    // Run request
    const response = await schemaregistryClient.createSchemaRegistry(request);
    console.log(response);
  }

  callCreateSchemaRegistry();
