 ...
 *   The first element of the array is Array of {@link google.cloud.orchestration.airflow.service.v1.ImageVersion | ImageVersion}.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link google.cloud.orchestration.airflow.service.v1.ImageVersion | ImageVersion} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   {@link google.cloud.orchestration.airflow.service.v1.ImageVersion | ImageVersion}. The API will be called under the hood as needed, once per the page,
