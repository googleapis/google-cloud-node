...
export class EnvironmentsClient {
  ...
  initialize() {
    ...
    const environmentsStubMethods =
        ['createEnvironment', 'getEnvironment', 'listEnvironments', 'updateEnvironment', 'deleteEnvironment', 'executeAirflowCommand', 'stopAirflowCommand', 'pollAirflowCommand', 'saveSnapshot', 'loadSnapshot', 'databaseFailover', 'fetchDatabaseProperties'];
