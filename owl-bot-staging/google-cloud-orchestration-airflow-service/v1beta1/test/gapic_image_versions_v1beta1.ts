...
describe('v1beta1.ImageVersionsClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = imageversionsModule.v1beta1.ImageVersionsClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = imageversionsModule.v1beta1.ImageVersionsClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'composer.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new imageversionsModule.v1beta1.ImageVersionsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'composer.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new imageversionsModule.v1beta1.ImageVersionsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'composer.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new imageversionsModule.v1beta1.ImageVersionsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new imageversionsModule.v1beta1.ImageVersionsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('listImageVersions', () => {
        it('invokes listImageVersions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.orchestration.airflow.service.v1beta1.ListImageVersionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.orchestration.airflow.service.v1beta1.ImageVersion()),
              generateSampleMessage(new protos.google.cloud.orchestration.airflow.service.v1beta1.ImageVersion()),
              generateSampleMessage(new protos.google.cloud.orchestration.airflow.service.v1beta1.ImageVersion()),
            ];
        ...
        it('invokes listImageVersions without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listImageVersions(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.orchestration.airflow.service.v1beta1.IImageVersion[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listImageVersionsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.orchestration.airflow.service.v1beta1.ImageVersion) => {
