...
function main(name) {
  // [START eventarc_v1_generated_Eventarc_GetChannelConnection_async]
  /**
  ...
  async function callGetChannelConnection() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await eventarcClient.getChannelConnection(request);
