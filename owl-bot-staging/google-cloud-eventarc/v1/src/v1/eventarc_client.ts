...
export class EventarcClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    if (opts.fallback === 'rest') {
      ...
      lroOptions.httpRules = [{selector: 'google.cloud.location.Locations.GetLocation',get: '/v1/{name=projects/*/locations/*}',},{selector: 'google.cloud.location.Locations.ListLocations',get: '/v1/{name=projects/*}/locations',},{selector: 'google.iam.v1.IAMPolicy.GetIamPolicy',get: '/v1/{resource=projects/*/locations/*/triggers/*}:getIamPolicy',additional_bindings: [{get: '/v1/{resource=projects/*/locations/*/channels/*}:getIamPolicy',},{get: '/v1/{resource=projects/*/locations/*/channelConnections/*}:getIamPolicy',}],
      },{selector: 'google.iam.v1.IAMPolicy.SetIamPolicy',post: '/v1/{resource=projects/*/locations/*/triggers/*}:setIamPolicy',body: '*',additional_bindings: [{post: '/v1/{resource=projects/*/locations/*/channels/*}:setIamPolicy',body: '*',},{post: '/v1/{resource=projects/*/locations/*/channelConnections/*}:setIamPolicy',body: '*',}],
      },{selector: 'google.iam.v1.IAMPolicy.TestIamPermissions',post: '/v1/{resource=projects/*/locations/*/triggers/*}:testIamPermissions',body: '*',additional_bindings: [{post: '/v1/{resource=projects/*/locations/*/channels/*}:testIamPermissions',body: '*',},{post: '/v1/{resource=projects/*/locations/*/channelConnections/*}:testIamPermissions',body: '*',}],
  ...
  initialize() {
    ...
    const eventarcStubMethods =
        ['getTrigger', 'listTriggers', 'createTrigger', 'updateTrigger', 'deleteTrigger', 'getChannel', 'listChannels', 'createChannel', 'updateChannel', 'deleteChannel', 'getProvider', 'listProviders', 'getChannelConnection', 'listChannelConnections', 'createChannelConnection', 'deleteChannelConnection', 'getGoogleChannelConfig', 'updateGoogleChannelConfig'];
 ...
 */
  ...
  getGoogleChannelConfig(
    ...
    this.initialize();
    return this.innerApiCalls.getGoogleChannelConfig(request, options, callback);
  }
/**
 ...
 */
  ...
  updateGoogleChannelConfig(
    ...
    this.initialize();
    return this.innerApiCalls.updateGoogleChannelConfig(request, options, callback);
  }
 ...
 */
  ...
  createChannelConnection(
    ...
    this.initialize();
    return this.innerApiCalls.createChannelConnection(request, options, callback);
  }
/**
 ...
 */
  ...
  deleteChannelConnection(
    ...
    this.initialize();
    return this.innerApiCalls.deleteChannelConnection(request, options, callback);
  }
/**
 ...
 */
  ...
  listChannelConnections(
    ...
    this.initialize();
    return this.innerApiCalls.listChannelConnections(request, options, callback);
  }
