...
describe('v1beta1.ContainerAnalysisV1Beta1Client', () => {
    ...
    describe('getScanConfig', () => {
        it('invokes getScanConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.devtools.containeranalysis.v1beta1.GetScanConfigRequest', ['name']);
        ...
        it('invokes getScanConfig without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getScanConfig(
                    request,
                    (err?: Error|null, result?: protos.google.devtools.containeranalysis.v1beta1.IScanConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateScanConfig', () => {
        it('invokes updateScanConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.devtools.containeranalysis.v1beta1.UpdateScanConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.devtools.containeranalysis.v1beta1.ScanConfig()
    ...
    describe('listScanConfigs', () => {
        it('invokes listScanConfigs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.devtools.containeranalysis.v1beta1.ListScanConfigsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.devtools.containeranalysis.v1beta1.ScanConfig()),
              generateSampleMessage(new protos.google.devtools.containeranalysis.v1beta1.ScanConfig()),
              generateSampleMessage(new protos.google.devtools.containeranalysis.v1beta1.ScanConfig()),
            ];
        ...
        it('invokes listScanConfigsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.devtools.containeranalysis.v1beta1.ScanConfig) => {
