...
function main(name) {
  // [START merchantapi_v1beta_generated_LfpStoreService_DeleteLfpStore_async]
  /**
  ...
  async function callDeleteLfpStore() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await lfpClient.deleteLfpStore(request);
    console.log(response);
  }

  callDeleteLfpStore();
  // [END merchantapi_v1beta_generated_LfpStoreService_DeleteLfpStore_async]
}
