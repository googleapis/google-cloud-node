...
function main(parent, lfpSale) {
  ...
  const {LfpSaleServiceClient} = require('@google-shopping/lfp').v1beta;

  // Instantiates a client
  const lfpClient = new LfpSaleServiceClient();

  async function callInsertLfpSale() {
    // Construct request
    const request = {
      parent,
      lfpSale,
    ...
    // Run request
    const response = await lfpClient.insertLfpSale(request);
