...
describe('v1.LfpInventoryServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new lfpinventoryserviceModule.v1.LfpInventoryServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          lfpinventoryserviceModule.v1.LfpInventoryServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          lfpinventoryserviceModule.v1.LfpInventoryServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port = lfpinventoryserviceModule.v1.LfpInventoryServiceClient.port;
      assert(port);
  ...
  describe('insertLfpInventory', () => {
    it('invokes insertLfpInventory without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.shopping.merchant.lfp.v1.InsertLfpInventoryRequest(),
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.shopping.merchant.lfp.v1.LfpInventory(),
      );
    ...
    it('invokes insertLfpInventory without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.insertLfpInventory(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.lfp.v1.ILfpInventory | null,
          ) => {
            if (err) {
              reject(err);
            } else {
