...
* [Lfp Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/lfp/latest)
* [Lfp Documentation](https://developers.google.com/merchant/api)
