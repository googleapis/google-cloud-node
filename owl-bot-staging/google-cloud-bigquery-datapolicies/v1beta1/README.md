...
# [Datapolicies: Nodejs Client][homepage]
...
Datapolicies client for Node.js
...
* [Datapolicies Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/datapolicies/latest)
