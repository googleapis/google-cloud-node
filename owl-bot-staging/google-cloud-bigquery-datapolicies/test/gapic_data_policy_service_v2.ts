...
describe('v2.DataPolicyServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          datapolicyserviceModule.v2.DataPolicyServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          datapolicyserviceModule.v2.DataPolicyServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'bigquerydatapolicy.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new datapolicyserviceModule.v2.DataPolicyServiceClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'bigquerydatapolicy.example.com');
          if (saved) {
    ...
    it('has port', () => {
      const port = datapolicyserviceModule.v2.DataPolicyServiceClient.port;
      assert(port);
  ...
  describe('createDataPolicy', () => {
    it('invokes createDataPolicy without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.bigquery.datapolicies.v2.CreateDataPolicyRequest(),
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.bigquery.datapolicies.v2.DataPolicy(),
      );
    ...
    it('invokes createDataPolicy without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createDataPolicy(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.bigquery.datapolicies.v2.IDataPolicy | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('addGrantees', () => {
    it('invokes addGrantees without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.bigquery.datapolicies.v2.AddGranteesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('removeGrantees', () => {
    it('invokes removeGrantees without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.bigquery.datapolicies.v2.RemoveGranteesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('updateDataPolicy', () => {
    it('invokes updateDataPolicy without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.bigquery.datapolicies.v2.UpdateDataPolicyRequest(),
      );
      request.dataPolicy ??= {};
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('deleteDataPolicy', () => {
    it('invokes deleteDataPolicy without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.bigquery.datapolicies.v2.DeleteDataPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('getDataPolicy', () => {
    it('invokes getDataPolicy without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.bigquery.datapolicies.v2.GetDataPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('listDataPolicies', () => {
    it('invokes listDataPolicies without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.bigquery.datapolicies.v2.ListDataPoliciesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
    ...
    it('invokes listDataPoliciesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.bigquery.datapolicies.v2.DataPolicy[] =
          [];
        stream.on(
          'data',
          (
            response: protos.google.cloud.bigquery.datapolicies.v2.DataPolicy,
          ) => {
    ...
    it('uses async iteration with listDataPolicies without error', async () => {
      ...
      const responses: protos.google.cloud.bigquery.datapolicies.v2.IDataPolicy[] =
        [];
  ...
  describe('Path templates', () => {
    ...
    describe('routine', async () => {
      const fakePath = '/rendered/path/routine';
      const expectedParameters = {
        project: 'projectValue',
      ...
      await client.initialize();
      client.pathTemplates.routinePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.routinePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('routinePath', () => {
        const result = client.routinePath(
          'projectValue',
          'datasetValue',
          'routineValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.routinePathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });

      it('matchProjectFromRoutineName', () => {
        const result = client.matchProjectFromRoutineName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.routinePathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });

      it('matchDatasetFromRoutineName', () => {
        const result = client.matchDatasetFromRoutineName(fakePath);
      ...
      it('matchRoutineFromRoutineName', () => {
        const result = client.matchRoutineFromRoutineName(fakePath);
        assert.strictEqual(result, 'routineValue');
        assert(
          (client.pathTemplates.routinePathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
