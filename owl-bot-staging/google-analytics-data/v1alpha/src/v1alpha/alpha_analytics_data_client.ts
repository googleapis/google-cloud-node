...
export class AlphaAnalyticsDataClient {
  ...
  initialize() {
    ...
    const alphaAnalyticsDataStubMethods =
        ['runFunnelReport', 'createAudienceList', 'queryAudienceList', 'getAudienceList', 'listAudienceLists'];
 ...
 */
  ...
  matchPropertyIdFromAudienceListName(audienceListName: string) {
    return this.pathTemplates.audienceListPathTemplate.match(audienceListName).propertyId;
  }
  ...
  matchAudienceListIdFromAudienceListName(audienceListName: string) {
    return this.pathTemplates.audienceListPathTemplate.match(audienceListName).audienceListId;
  }
  ...
  matchPropertyIdFromPropertyName(propertyName: string) {
    return this.pathTemplates.propertyPathTemplate.match(propertyName).propertyId;
  }
