...
export class AlphaAnalyticsDataClient {
  ...
  initialize() {
    ...
    const alphaAnalyticsDataStubMethods =
        ['runFunnelReport', 'createAudienceList', 'queryAudienceList', 'sheetExportAudienceList', 'getAudienceList', 'listAudienceLists', 'createRecurringAudienceList', 'getRecurringAudienceList', 'listRecurringAudienceLists', 'createReportTask', 'queryReportTask', 'getReportTask', 'listReportTasks'];
