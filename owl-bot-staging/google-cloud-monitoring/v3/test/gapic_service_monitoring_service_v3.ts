...
describe('v3.ServiceMonitoringServiceClient', () => {
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new servicemonitoringserviceModule.v3.ServiceMonitoringServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('invokes createService without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createService(
                    request,
                    (err?: Error|null, result?: protos.google.monitoring.v3.IService|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createServiceLevelObjective without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createServiceLevelObjective(
                    request,
                    (err?: Error|null, result?: protos.google.monitoring.v3.IServiceLevelObjective|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listServiceLevelObjectives', () => {
        ...
        it('invokes listServiceLevelObjectives without error using callback', async () => {
            ...
            client.innerApiCalls.listServiceLevelObjectives = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listServiceLevelObjectivesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.monitoring.v3.ServiceLevelObjective) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listServiceLevelObjectives without error', async () => {
            ...
            client.descriptors.page.listServiceLevelObjectives.asyncIterate = stubAsyncIterationCall(expectedResponse);
