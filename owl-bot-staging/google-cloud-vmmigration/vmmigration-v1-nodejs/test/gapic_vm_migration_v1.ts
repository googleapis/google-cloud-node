...
describe('v1.VmMigrationClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new vmmigrationModule.v1.VmMigrationClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'vmmigration.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new vmmigrationModule.v1.VmMigrationClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'vmmigration.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new vmmigrationModule.v1.VmMigrationClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new vmmigrationModule.v1.VmMigrationClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getSource', () => {
        it('invokes getSource without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.GetSourceRequest', ['name']);
        ...
        it('invokes getSource without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getSource(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.vmmigration.v1.ISource|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('fetchInventory', () => {
        it('invokes fetchInventory without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.FetchInventoryRequest', ['source']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.fetchInventory as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.fetchInventory as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes fetchInventory without error using callback', async () => {
            ...
            client.innerApiCalls.fetchInventory = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.fetchInventory(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.vmmigration.v1.IFetchInventoryResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes fetchInventory with error', async () => {
            ...
            const expectedHeaderRequestParams = `source=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.fetchInventory = stubSimpleCall(undefined, expectedError);
    ...
    describe('getUtilizationReport', () => {
        it('invokes getUtilizationReport without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.GetUtilizationReportRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.vmmigration.v1.UtilizationReport()
            );
            client.innerApiCalls.getUtilizationReport = stubSimpleCall(expectedResponse);
            const [response] = await client.getUtilizationReport(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getUtilizationReport as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getUtilizationReport as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getUtilizationReport without error using callback', async () => {
            ...
            client.innerApiCalls.getUtilizationReport = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getUtilizationReport(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.vmmigration.v1.IUtilizationReport|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getUtilizationReport with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getUtilizationReport = stubSimpleCall(undefined, expectedError);
    ...
    describe('getDatacenterConnector', () => {
        it('invokes getDatacenterConnector without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.GetDatacenterConnectorRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.vmmigration.v1.DatacenterConnector()
            );
            client.innerApiCalls.getDatacenterConnector = stubSimpleCall(expectedResponse);
            const [response] = await client.getDatacenterConnector(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getDatacenterConnector as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDatacenterConnector as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getDatacenterConnector without error using callback', async () => {
            ...
            client.innerApiCalls.getDatacenterConnector = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getDatacenterConnector(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.vmmigration.v1.IDatacenterConnector|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getDatacenterConnector with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getDatacenterConnector = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getDatacenterConnector(request), expectedError);
            const actualRequest = (client.innerApiCalls.getDatacenterConnector as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDatacenterConnector as SinonStub)
    ...
    describe('getMigratingVm', () => {
        it('invokes getMigratingVm without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.GetMigratingVmRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getMigratingVm as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getMigratingVm as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getMigratingVm without error using callback', async () => {
            ...
            client.innerApiCalls.getMigratingVm = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getMigratingVm(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.vmmigration.v1.IMigratingVm|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getMigratingVm with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getMigratingVm = stubSimpleCall(undefined, expectedError);
    ...
    describe('getCloneJob', () => {
        it('invokes getCloneJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.GetCloneJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getCloneJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getCloneJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getCloneJob without error using callback', async () => {
            ...
            client.innerApiCalls.getCloneJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCloneJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.vmmigration.v1.ICloneJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCloneJob with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getCloneJob = stubSimpleCall(undefined, expectedError);
    ...
    describe('getCutoverJob', () => {
        it('invokes getCutoverJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.GetCutoverJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getCutoverJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getCutoverJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getCutoverJob without error using callback', async () => {
            ...
            client.innerApiCalls.getCutoverJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCutoverJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.vmmigration.v1.ICutoverJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCutoverJob with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getCutoverJob = stubSimpleCall(undefined, expectedError);
    ...
    describe('getGroup', () => {
        it('invokes getGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.GetGroupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getGroup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getGroup(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.vmmigration.v1.IGroup|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getTargetProject', () => {
        it('invokes getTargetProject without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.GetTargetProjectRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getTargetProject as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getTargetProject as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getTargetProject without error using callback', async () => {
            ...
            client.innerApiCalls.getTargetProject = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getTargetProject(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.vmmigration.v1.ITargetProject|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getTargetProject with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getTargetProject = stubSimpleCall(undefined, expectedError);
    ...
    describe('getReplicationCycle', () => {
        it('invokes getReplicationCycle without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.GetReplicationCycleRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.vmmigration.v1.ReplicationCycle()
            );
            client.innerApiCalls.getReplicationCycle = stubSimpleCall(expectedResponse);
            const [response] = await client.getReplicationCycle(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getReplicationCycle as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getReplicationCycle as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getReplicationCycle without error using callback', async () => {
            ...
            client.innerApiCalls.getReplicationCycle = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getReplicationCycle(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.vmmigration.v1.IReplicationCycle|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getReplicationCycle with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getReplicationCycle = stubSimpleCall(undefined, expectedError);
    ...
    describe('createSource', () => {
        it('invokes createSource without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.CreateSourceRequest', ['parent']);
        ...
        it('invokes createSource without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createSource(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.vmmigration.v1.ISource, protos.google.cloud.vmmigration.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.vmmigration.v1.ISource, protos.google.cloud.vmmigration.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createSource as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateSource', () => {
        it('invokes updateSource without error', async () => {
            ...
            request.source ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.UpdateSourceRequest', ['source', 'name']);
    ...
    describe('deleteSource', () => {
        it('invokes deleteSource without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.DeleteSourceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createUtilizationReport', () => {
        it('invokes createUtilizationReport without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.CreateUtilizationReportRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createUtilizationReport = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createUtilizationReport(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createUtilizationReport as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createUtilizationReport as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createUtilizationReport without error using callback', async () => {
            ...
            client.innerApiCalls.createUtilizationReport = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createUtilizationReport(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.vmmigration.v1.IUtilizationReport, protos.google.cloud.vmmigration.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.vmmigration.v1.IUtilizationReport, protos.google.cloud.vmmigration.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createUtilizationReport as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createUtilizationReport with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createUtilizationReport = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createUtilizationReport(request), expectedError);
            const actualRequest = (client.innerApiCalls.createUtilizationReport as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createUtilizationReport as SinonStub)
        ...
        it('invokes createUtilizationReport with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createUtilizationReport = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createUtilizationReport(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.createUtilizationReport as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkCreateUtilizationReportProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkCreateUtilizationReportProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkCreateUtilizationReportProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkCreateUtilizationReportProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteUtilizationReport', () => {
        it('invokes deleteUtilizationReport without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.DeleteUtilizationReportRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteUtilizationReport = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteUtilizationReport(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteUtilizationReport as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteUtilizationReport as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteUtilizationReport without error using callback', async () => {
            ...
            client.innerApiCalls.deleteUtilizationReport = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteUtilizationReport with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteUtilizationReport = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteUtilizationReport(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteUtilizationReport as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteUtilizationReport as SinonStub)
        ...
        it('invokes deleteUtilizationReport with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteUtilizationReport = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteUtilizationReport(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteUtilizationReport as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteUtilizationReportProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteUtilizationReportProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteUtilizationReportProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteUtilizationReportProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('createDatacenterConnector', () => {
        it('invokes createDatacenterConnector without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.CreateDatacenterConnectorRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createDatacenterConnector = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createDatacenterConnector(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createDatacenterConnector as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createDatacenterConnector as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createDatacenterConnector without error using callback', async () => {
            ...
            client.innerApiCalls.createDatacenterConnector = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createDatacenterConnector(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.vmmigration.v1.IDatacenterConnector, protos.google.cloud.vmmigration.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.vmmigration.v1.IDatacenterConnector, protos.google.cloud.vmmigration.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createDatacenterConnector as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createDatacenterConnector with call error', async () => {
            ...
            await assert.rejects(client.createDatacenterConnector(request), expectedError);
            const actualRequest = (client.innerApiCalls.createDatacenterConnector as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createDatacenterConnector as SinonStub)
        ...
        it('invokes createDatacenterConnector with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createDatacenterConnector = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createDatacenterConnector(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.createDatacenterConnector as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkCreateDatacenterConnectorProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkCreateDatacenterConnectorProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkCreateDatacenterConnectorProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkCreateDatacenterConnectorProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteDatacenterConnector', () => {
        it('invokes deleteDatacenterConnector without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.DeleteDatacenterConnectorRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteDatacenterConnector = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteDatacenterConnector(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteDatacenterConnector as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteDatacenterConnector as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteDatacenterConnector without error using callback', async () => {
            ...
            client.innerApiCalls.deleteDatacenterConnector = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteDatacenterConnector with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteDatacenterConnector = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteDatacenterConnector(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteDatacenterConnector as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteDatacenterConnector as SinonStub)
        ...
        it('invokes deleteDatacenterConnector with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteDatacenterConnector = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteDatacenterConnector(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteDatacenterConnector as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteDatacenterConnectorProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteDatacenterConnectorProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteDatacenterConnectorProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteDatacenterConnectorProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('upgradeAppliance', () => {
        it('invokes upgradeAppliance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.UpgradeApplianceRequest', ['datacenterConnector']);
            request.datacenterConnector = defaultValue1;
            const expectedHeaderRequestParams = `datacenter_connector=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.upgradeAppliance = stubLongRunningCall(expectedResponse);
            const [operation] = await client.upgradeAppliance(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.upgradeAppliance as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.upgradeAppliance as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes upgradeAppliance without error using callback', async () => {
            ...
            client.innerApiCalls.upgradeAppliance = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.upgradeAppliance(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.vmmigration.v1.IUpgradeApplianceResponse, protos.google.cloud.vmmigration.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.vmmigration.v1.IUpgradeApplianceResponse, protos.google.cloud.vmmigration.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.upgradeAppliance as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes upgradeAppliance with call error', async () => {
            ...
            const expectedHeaderRequestParams = `datacenter_connector=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.upgradeAppliance = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes upgradeAppliance with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `datacenter_connector=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.upgradeAppliance = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.upgradeAppliance(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.upgradeAppliance as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpgradeApplianceProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpgradeApplianceProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpgradeApplianceProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpgradeApplianceProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('createMigratingVm', () => {
        it('invokes createMigratingVm without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.CreateMigratingVmRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createMigratingVm = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createMigratingVm(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createMigratingVm as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createMigratingVm as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createMigratingVm without error using callback', async () => {
            ...
            client.innerApiCalls.createMigratingVm = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createMigratingVm(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.vmmigration.v1.IMigratingVm, protos.google.cloud.vmmigration.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.vmmigration.v1.IMigratingVm, protos.google.cloud.vmmigration.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createMigratingVm as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createMigratingVm with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createMigratingVm = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes createMigratingVm with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createMigratingVm = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createMigratingVm(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.createMigratingVm as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkCreateMigratingVmProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkCreateMigratingVmProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkCreateMigratingVmProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkCreateMigratingVmProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('updateMigratingVm', () => {
        it('invokes updateMigratingVm without error', async () => {
            ...
            request.migratingVm ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.UpdateMigratingVmRequest', ['migratingVm', 'name']);
            request.migratingVm.name = defaultValue1;
            const expectedHeaderRequestParams = `migrating_vm.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updateMigratingVm = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateMigratingVm(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateMigratingVm as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateMigratingVm as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateMigratingVm without error using callback', async () => {
            ...
            client.innerApiCalls.updateMigratingVm = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateMigratingVm with call error', async () => {
            ...
            const expectedHeaderRequestParams = `migrating_vm.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateMigratingVm = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes updateMigratingVm with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `migrating_vm.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateMigratingVm = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateMigratingVm(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateMigratingVm as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateMigratingVmProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateMigratingVmProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateMigratingVmProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateMigratingVmProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteMigratingVm', () => {
        it('invokes deleteMigratingVm without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.DeleteMigratingVmRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteMigratingVm = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteMigratingVm(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteMigratingVm as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteMigratingVm as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteMigratingVm without error using callback', async () => {
            ...
            client.innerApiCalls.deleteMigratingVm = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteMigratingVm with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteMigratingVm = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes deleteMigratingVm with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteMigratingVm = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteMigratingVm(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteMigratingVm as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteMigratingVmProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteMigratingVmProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteMigratingVmProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteMigratingVmProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('startMigration', () => {
        it('invokes startMigration without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.StartMigrationRequest', ['migratingVm']);
            request.migratingVm = defaultValue1;
            const expectedHeaderRequestParams = `migrating_vm=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.startMigration = stubLongRunningCall(expectedResponse);
            const [operation] = await client.startMigration(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.startMigration as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.startMigration as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes startMigration without error using callback', async () => {
            ...
            client.innerApiCalls.startMigration = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.startMigration(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.vmmigration.v1.IStartMigrationResponse, protos.google.cloud.vmmigration.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.vmmigration.v1.IStartMigrationResponse, protos.google.cloud.vmmigration.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.startMigration as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes startMigration with call error', async () => {
            ...
            const expectedHeaderRequestParams = `migrating_vm=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.startMigration = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes startMigration with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `migrating_vm=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.startMigration = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.startMigration(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.startMigration as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkStartMigrationProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkStartMigrationProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkStartMigrationProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkStartMigrationProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('resumeMigration', () => {
        it('invokes resumeMigration without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.ResumeMigrationRequest', ['migratingVm']);
            request.migratingVm = defaultValue1;
            const expectedHeaderRequestParams = `migrating_vm=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.resumeMigration = stubLongRunningCall(expectedResponse);
            const [operation] = await client.resumeMigration(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.resumeMigration as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.resumeMigration as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes resumeMigration without error using callback', async () => {
            ...
            client.innerApiCalls.resumeMigration = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.resumeMigration(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.vmmigration.v1.IResumeMigrationResponse, protos.google.cloud.vmmigration.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.vmmigration.v1.IResumeMigrationResponse, protos.google.cloud.vmmigration.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.resumeMigration as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes resumeMigration with call error', async () => {
            ...
            const expectedHeaderRequestParams = `migrating_vm=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.resumeMigration = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes resumeMigration with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `migrating_vm=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.resumeMigration = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.resumeMigration(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.resumeMigration as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkResumeMigrationProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkResumeMigrationProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkResumeMigrationProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkResumeMigrationProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('pauseMigration', () => {
        it('invokes pauseMigration without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.PauseMigrationRequest', ['migratingVm']);
            request.migratingVm = defaultValue1;
            const expectedHeaderRequestParams = `migrating_vm=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.pauseMigration = stubLongRunningCall(expectedResponse);
            const [operation] = await client.pauseMigration(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.pauseMigration as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.pauseMigration as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes pauseMigration without error using callback', async () => {
            ...
            client.innerApiCalls.pauseMigration = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.pauseMigration(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.vmmigration.v1.IPauseMigrationResponse, protos.google.cloud.vmmigration.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.vmmigration.v1.IPauseMigrationResponse, protos.google.cloud.vmmigration.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.pauseMigration as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes pauseMigration with call error', async () => {
            ...
            const expectedHeaderRequestParams = `migrating_vm=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.pauseMigration = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes pauseMigration with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `migrating_vm=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.pauseMigration = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.pauseMigration(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.pauseMigration as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkPauseMigrationProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkPauseMigrationProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkPauseMigrationProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkPauseMigrationProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('finalizeMigration', () => {
        it('invokes finalizeMigration without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.FinalizeMigrationRequest', ['migratingVm']);
            request.migratingVm = defaultValue1;
            const expectedHeaderRequestParams = `migrating_vm=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.finalizeMigration = stubLongRunningCall(expectedResponse);
            const [operation] = await client.finalizeMigration(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.finalizeMigration as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.finalizeMigration as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes finalizeMigration without error using callback', async () => {
            ...
            client.innerApiCalls.finalizeMigration = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.finalizeMigration(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.vmmigration.v1.IFinalizeMigrationResponse, protos.google.cloud.vmmigration.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.vmmigration.v1.IFinalizeMigrationResponse, protos.google.cloud.vmmigration.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.finalizeMigration as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes finalizeMigration with call error', async () => {
            ...
            const expectedHeaderRequestParams = `migrating_vm=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.finalizeMigration = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes finalizeMigration with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `migrating_vm=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.finalizeMigration = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.finalizeMigration(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.finalizeMigration as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkFinalizeMigrationProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkFinalizeMigrationProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkFinalizeMigrationProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkFinalizeMigrationProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('createCloneJob', () => {
        it('invokes createCloneJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.CreateCloneJobRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createCloneJob = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createCloneJob(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createCloneJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createCloneJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createCloneJob without error using callback', async () => {
            ...
            client.innerApiCalls.createCloneJob = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createCloneJob(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.vmmigration.v1.ICloneJob, protos.google.cloud.vmmigration.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.vmmigration.v1.ICloneJob, protos.google.cloud.vmmigration.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createCloneJob as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createCloneJob with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createCloneJob = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes createCloneJob with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createCloneJob = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createCloneJob(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.createCloneJob as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkCreateCloneJobProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkCreateCloneJobProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkCreateCloneJobProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkCreateCloneJobProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('cancelCloneJob', () => {
        it('invokes cancelCloneJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.CancelCloneJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.cancelCloneJob = stubLongRunningCall(expectedResponse);
            const [operation] = await client.cancelCloneJob(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.cancelCloneJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.cancelCloneJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes cancelCloneJob without error using callback', async () => {
            ...
            client.innerApiCalls.cancelCloneJob = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.cancelCloneJob(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.vmmigration.v1.ICancelCloneJobResponse, protos.google.cloud.vmmigration.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.vmmigration.v1.ICancelCloneJobResponse, protos.google.cloud.vmmigration.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.cancelCloneJob as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes cancelCloneJob with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.cancelCloneJob = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes cancelCloneJob with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.cancelCloneJob = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.cancelCloneJob(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.cancelCloneJob as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkCancelCloneJobProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkCancelCloneJobProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkCancelCloneJobProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkCancelCloneJobProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('createCutoverJob', () => {
        it('invokes createCutoverJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.CreateCutoverJobRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createCutoverJob = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createCutoverJob(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createCutoverJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createCutoverJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createCutoverJob without error using callback', async () => {
            ...
            client.innerApiCalls.createCutoverJob = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createCutoverJob(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.vmmigration.v1.ICutoverJob, protos.google.cloud.vmmigration.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.vmmigration.v1.ICutoverJob, protos.google.cloud.vmmigration.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createCutoverJob as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createCutoverJob with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createCutoverJob = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes createCutoverJob with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createCutoverJob = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createCutoverJob(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.createCutoverJob as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkCreateCutoverJobProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkCreateCutoverJobProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkCreateCutoverJobProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkCreateCutoverJobProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('cancelCutoverJob', () => {
        it('invokes cancelCutoverJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.CancelCutoverJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.cancelCutoverJob = stubLongRunningCall(expectedResponse);
            const [operation] = await client.cancelCutoverJob(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.cancelCutoverJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.cancelCutoverJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes cancelCutoverJob without error using callback', async () => {
            ...
            client.innerApiCalls.cancelCutoverJob = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.cancelCutoverJob(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.vmmigration.v1.ICancelCutoverJobResponse, protos.google.cloud.vmmigration.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.vmmigration.v1.ICancelCutoverJobResponse, protos.google.cloud.vmmigration.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.cancelCutoverJob as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes cancelCutoverJob with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.cancelCutoverJob = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes cancelCutoverJob with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.cancelCutoverJob = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.cancelCutoverJob(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.cancelCutoverJob as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkCancelCutoverJobProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkCancelCutoverJobProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkCancelCutoverJobProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkCancelCutoverJobProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('createGroup', () => {
        it('invokes createGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.CreateGroupRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createGroup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createGroup(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.vmmigration.v1.IGroup, protos.google.cloud.vmmigration.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.vmmigration.v1.IGroup, protos.google.cloud.vmmigration.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createGroup as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateGroup', () => {
        it('invokes updateGroup without error', async () => {
            ...
            request.group ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.UpdateGroupRequest', ['group', 'name']);
    ...
    describe('deleteGroup', () => {
        it('invokes deleteGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.DeleteGroupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('addGroupMigration', () => {
        it('invokes addGroupMigration without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.AddGroupMigrationRequest', ['group']);
            request.group = defaultValue1;
            const expectedHeaderRequestParams = `group=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.addGroupMigration = stubLongRunningCall(expectedResponse);
            const [operation] = await client.addGroupMigration(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.addGroupMigration as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.addGroupMigration as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes addGroupMigration without error using callback', async () => {
            ...
            client.innerApiCalls.addGroupMigration = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.addGroupMigration(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.vmmigration.v1.IAddGroupMigrationResponse, protos.google.cloud.vmmigration.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.vmmigration.v1.IAddGroupMigrationResponse, protos.google.cloud.vmmigration.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.addGroupMigration as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes addGroupMigration with call error', async () => {
            ...
            const expectedHeaderRequestParams = `group=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.addGroupMigration = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes addGroupMigration with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `group=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.addGroupMigration = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.addGroupMigration(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.addGroupMigration as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkAddGroupMigrationProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkAddGroupMigrationProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkAddGroupMigrationProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkAddGroupMigrationProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('removeGroupMigration', () => {
        it('invokes removeGroupMigration without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.RemoveGroupMigrationRequest', ['group']);
            request.group = defaultValue1;
            const expectedHeaderRequestParams = `group=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.removeGroupMigration = stubLongRunningCall(expectedResponse);
            const [operation] = await client.removeGroupMigration(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.removeGroupMigration as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.removeGroupMigration as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes removeGroupMigration without error using callback', async () => {
            ...
            client.innerApiCalls.removeGroupMigration = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.removeGroupMigration(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.vmmigration.v1.IRemoveGroupMigrationResponse, protos.google.cloud.vmmigration.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.vmmigration.v1.IRemoveGroupMigrationResponse, protos.google.cloud.vmmigration.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.removeGroupMigration as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes removeGroupMigration with call error', async () => {
            ...
            const expectedHeaderRequestParams = `group=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.removeGroupMigration = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes removeGroupMigration with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `group=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.removeGroupMigration = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.removeGroupMigration(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.removeGroupMigration as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkRemoveGroupMigrationProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkRemoveGroupMigrationProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkRemoveGroupMigrationProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkRemoveGroupMigrationProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('createTargetProject', () => {
        it('invokes createTargetProject without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.CreateTargetProjectRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createTargetProject = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createTargetProject(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createTargetProject as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createTargetProject as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createTargetProject without error using callback', async () => {
            ...
            client.innerApiCalls.createTargetProject = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createTargetProject(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.vmmigration.v1.ITargetProject, protos.google.cloud.vmmigration.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.vmmigration.v1.ITargetProject, protos.google.cloud.vmmigration.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createTargetProject as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createTargetProject with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createTargetProject = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes createTargetProject with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createTargetProject = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createTargetProject(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.createTargetProject as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkCreateTargetProjectProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkCreateTargetProjectProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkCreateTargetProjectProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkCreateTargetProjectProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('updateTargetProject', () => {
        it('invokes updateTargetProject without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.UpdateTargetProjectRequest', ['targetProject', 'name']);
            request.targetProject.name = defaultValue1;
            const expectedHeaderRequestParams = `target_project.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updateTargetProject = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateTargetProject(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateTargetProject as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateTargetProject as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateTargetProject without error using callback', async () => {
            ...
            client.innerApiCalls.updateTargetProject = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateTargetProject with call error', async () => {
            ...
            const expectedHeaderRequestParams = `target_project.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateTargetProject = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes updateTargetProject with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `target_project.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateTargetProject = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateTargetProject(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateTargetProject as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateTargetProjectProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateTargetProjectProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateTargetProjectProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateTargetProjectProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteTargetProject', () => {
        it('invokes deleteTargetProject without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.DeleteTargetProjectRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteTargetProject = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteTargetProject(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteTargetProject as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteTargetProject as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteTargetProject without error using callback', async () => {
            ...
            client.innerApiCalls.deleteTargetProject = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteTargetProject with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteTargetProject = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes deleteTargetProject with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteTargetProject = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteTargetProject(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteTargetProject as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteTargetProjectProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteTargetProjectProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteTargetProjectProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteTargetProjectProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listSources', () => {
        it('invokes listSources without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.ListSourcesRequest', ['parent']);
            request.parent = defaultValue1;
        ...
        it('invokes listSourcesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.vmmigration.v1.Source) => {
    ...
    describe('listUtilizationReports', () => {
        it('invokes listUtilizationReports without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.ListUtilizationReportsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
            ...
            client.innerApiCalls.listUtilizationReports = stubSimpleCall(expectedResponse);
            const [response] = await client.listUtilizationReports(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listUtilizationReports as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listUtilizationReports as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listUtilizationReports without error using callback', async () => {
            ...
            client.innerApiCalls.listUtilizationReports = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listUtilizationReports with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listUtilizationReports = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listUtilizationReports(request), expectedError);
            const actualRequest = (client.innerApiCalls.listUtilizationReports as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listUtilizationReports as SinonStub)
        ...
        it('invokes listUtilizationReportsStream without error', async () => {
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listUtilizationReports.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listUtilizationReports, request));
            assert(
                (client.descriptors.page.listUtilizationReports.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listUtilizationReportsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listUtilizationReports.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listUtilizationReportsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.vmmigration.v1.UtilizationReport[] = [];
                stream.on('data', (response: protos.google.cloud.vmmigration.v1.UtilizationReport) => {
        ...
        it('uses async iteration with listUtilizationReports without error', async () => {
            ...
            client.descriptors.page.listUtilizationReports.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listUtilizationReports.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listUtilizationReports.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listUtilizationReports with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listUtilizationReports.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listUtilizationReportsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.vmmigration.v1.IUtilizationReport[] = [];
                for await (const resource of iterable) {
    ...
    describe('listDatacenterConnectors', () => {
        it('invokes listDatacenterConnectors without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.ListDatacenterConnectorsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.vmmigration.v1.DatacenterConnector()),
              generateSampleMessage(new protos.google.cloud.vmmigration.v1.DatacenterConnector()),
              generateSampleMessage(new protos.google.cloud.vmmigration.v1.DatacenterConnector()),
            ];
            client.innerApiCalls.listDatacenterConnectors = stubSimpleCall(expectedResponse);
            const [response] = await client.listDatacenterConnectors(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listDatacenterConnectors as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listDatacenterConnectors as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listDatacenterConnectors without error using callback', async () => {
            ...
            client.innerApiCalls.listDatacenterConnectors = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listDatacenterConnectors with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listDatacenterConnectors = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listDatacenterConnectors(request), expectedError);
            const actualRequest = (client.innerApiCalls.listDatacenterConnectors as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listDatacenterConnectors as SinonStub)
        ...
        it('invokes listDatacenterConnectorsStream without error', async () => {
            ...
            client.descriptors.page.listDatacenterConnectors.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.vmmigration.v1.DatacenterConnector) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listDatacenterConnectors.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listDatacenterConnectors, request));
            assert(
                (client.descriptors.page.listDatacenterConnectors.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listDatacenterConnectorsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDatacenterConnectors.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listDatacenterConnectorsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.vmmigration.v1.DatacenterConnector[] = [];
                stream.on('data', (response: protos.google.cloud.vmmigration.v1.DatacenterConnector) => {
        ...
        it('uses async iteration with listDatacenterConnectors without error', async () => {
            ...
            client.descriptors.page.listDatacenterConnectors.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listDatacenterConnectors.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listDatacenterConnectors.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listDatacenterConnectors with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDatacenterConnectors.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listDatacenterConnectorsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.vmmigration.v1.IDatacenterConnector[] = [];
                for await (const resource of iterable) {
    ...
    describe('listMigratingVms', () => {
        it('invokes listMigratingVms without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.ListMigratingVmsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.vmmigration.v1.MigratingVm()),
              generateSampleMessage(new protos.google.cloud.vmmigration.v1.MigratingVm()),
              generateSampleMessage(new protos.google.cloud.vmmigration.v1.MigratingVm()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listMigratingVms as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listMigratingVms as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listMigratingVms without error using callback', async () => {
            ...
            client.innerApiCalls.listMigratingVms = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listMigratingVms with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listMigratingVms = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listMigratingVmsStream without error', async () => {
            ...
            client.descriptors.page.listMigratingVms.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listMigratingVmsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.vmmigration.v1.MigratingVm[] = [];
                stream.on('data', (response: protos.google.cloud.vmmigration.v1.MigratingVm) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listMigratingVms.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listMigratingVms, request));
            assert(
        ...
        it('invokes listMigratingVmsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listMigratingVms.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listMigratingVmsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.vmmigration.v1.MigratingVm[] = [];
                stream.on('data', (response: protos.google.cloud.vmmigration.v1.MigratingVm) => {
        ...
        it('uses async iteration with listMigratingVms without error', async () => {
            ...
            client.descriptors.page.listMigratingVms.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listMigratingVms with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listMigratingVms.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listMigratingVmsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.vmmigration.v1.IMigratingVm[] = [];
                for await (const resource of iterable) {
    ...
    describe('listCloneJobs', () => {
        it('invokes listCloneJobs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.ListCloneJobsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listCloneJobs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listCloneJobs as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listCloneJobs without error using callback', async () => {
            ...
            client.innerApiCalls.listCloneJobs = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listCloneJobs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listCloneJobs = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listCloneJobsStream without error', async () => {
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listCloneJobs.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listCloneJobs, request));
            assert(
        ...
        it('invokes listCloneJobsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listCloneJobs.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listCloneJobsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.vmmigration.v1.CloneJob[] = [];
                stream.on('data', (response: protos.google.cloud.vmmigration.v1.CloneJob) => {
        ...
        it('uses async iteration with listCloneJobs without error', async () => {
            ...
            client.descriptors.page.listCloneJobs.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listCloneJobs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listCloneJobs.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listCloneJobsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.vmmigration.v1.ICloneJob[] = [];
                for await (const resource of iterable) {
    ...
    describe('listCutoverJobs', () => {
        it('invokes listCutoverJobs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.ListCutoverJobsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.vmmigration.v1.CutoverJob()),
              generateSampleMessage(new protos.google.cloud.vmmigration.v1.CutoverJob()),
              generateSampleMessage(new protos.google.cloud.vmmigration.v1.CutoverJob()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listCutoverJobs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listCutoverJobs as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listCutoverJobs without error using callback', async () => {
            ...
            client.innerApiCalls.listCutoverJobs = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listCutoverJobs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listCutoverJobs = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listCutoverJobsStream without error', async () => {
            ...
            client.descriptors.page.listCutoverJobs.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listCutoverJobsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.vmmigration.v1.CutoverJob[] = [];
                stream.on('data', (response: protos.google.cloud.vmmigration.v1.CutoverJob) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listCutoverJobs.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listCutoverJobs, request));
            assert(
        ...
        it('invokes listCutoverJobsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listCutoverJobs.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listCutoverJobsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.vmmigration.v1.CutoverJob[] = [];
                stream.on('data', (response: protos.google.cloud.vmmigration.v1.CutoverJob) => {
        ...
        it('uses async iteration with listCutoverJobs without error', async () => {
            ...
            client.descriptors.page.listCutoverJobs.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listCutoverJobs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listCutoverJobs.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listCutoverJobsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.vmmigration.v1.ICutoverJob[] = [];
                for await (const resource of iterable) {
    ...
    describe('listGroups', () => {
        it('invokes listGroups without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.ListGroupsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
        ...
        it('invokes listGroupsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.vmmigration.v1.Group) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listTargetProjects', () => {
        it('invokes listTargetProjects without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.ListTargetProjectsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.vmmigration.v1.TargetProject()),
              generateSampleMessage(new protos.google.cloud.vmmigration.v1.TargetProject()),
              generateSampleMessage(new protos.google.cloud.vmmigration.v1.TargetProject()),
            ];
            client.innerApiCalls.listTargetProjects = stubSimpleCall(expectedResponse);
            const [response] = await client.listTargetProjects(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listTargetProjects as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listTargetProjects as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listTargetProjects without error using callback', async () => {
            ...
            client.innerApiCalls.listTargetProjects = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listTargetProjects with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listTargetProjects = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listTargetProjectsStream without error', async () => {
            ...
            client.descriptors.page.listTargetProjects.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listTargetProjectsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.vmmigration.v1.TargetProject[] = [];
                stream.on('data', (response: protos.google.cloud.vmmigration.v1.TargetProject) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listTargetProjects.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listTargetProjects, request));
            assert(
        ...
        it('invokes listTargetProjectsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listTargetProjects.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listTargetProjectsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.vmmigration.v1.TargetProject[] = [];
                stream.on('data', (response: protos.google.cloud.vmmigration.v1.TargetProject) => {
        ...
        it('uses async iteration with listTargetProjects without error', async () => {
            ...
            client.descriptors.page.listTargetProjects.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listTargetProjects with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listTargetProjects.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listTargetProjectsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.vmmigration.v1.ITargetProject[] = [];
                for await (const resource of iterable) {
    ...
    describe('listReplicationCycles', () => {
        it('invokes listReplicationCycles without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vmmigration.v1.ListReplicationCyclesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.vmmigration.v1.ReplicationCycle()),
              generateSampleMessage(new protos.google.cloud.vmmigration.v1.ReplicationCycle()),
              generateSampleMessage(new protos.google.cloud.vmmigration.v1.ReplicationCycle()),
            ];
            client.innerApiCalls.listReplicationCycles = stubSimpleCall(expectedResponse);
            const [response] = await client.listReplicationCycles(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listReplicationCycles as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listReplicationCycles as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listReplicationCycles without error using callback', async () => {
            ...
            client.innerApiCalls.listReplicationCycles = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listReplicationCycles with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listReplicationCycles = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listReplicationCycles(request), expectedError);
            const actualRequest = (client.innerApiCalls.listReplicationCycles as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listReplicationCycles as SinonStub)
        ...
        it('invokes listReplicationCyclesStream without error', async () => {
            ...
            client.descriptors.page.listReplicationCycles.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.vmmigration.v1.ReplicationCycle) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listReplicationCycles.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listReplicationCycles, request));
            assert(
                (client.descriptors.page.listReplicationCycles.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listReplicationCyclesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listReplicationCycles.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listReplicationCyclesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.vmmigration.v1.ReplicationCycle[] = [];
                stream.on('data', (response: protos.google.cloud.vmmigration.v1.ReplicationCycle) => {
        ...
        it('uses async iteration with listReplicationCycles without error', async () => {
            ...
            client.descriptors.page.listReplicationCycles.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listReplicationCycles.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listReplicationCycles.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listReplicationCycles with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listReplicationCycles.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listReplicationCyclesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.vmmigration.v1.IReplicationCycle[] = [];
                for await (const resource of iterable) {
    ...
    describe('Path templates', () => {
        ...
        describe('cloneJob', async () => {
            ...
            await client.initialize();
            client.pathTemplates.cloneJobPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.cloneJobPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('cloneJobPath', () => {
                const result = client.cloneJobPath("projectValue", "locationValue", "sourceValue", "migratingVmValue", "cloneJobValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.cloneJobPathTemplate.render as SinonStub)
            ...
            it('matchProjectFromCloneJobName', () => {
                ...
                assert((client.pathTemplates.cloneJobPathTemplate.match as SinonStub)
        ...
        describe('cutoverJob', async () => {
            ...
            await client.initialize();
            client.pathTemplates.cutoverJobPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.cutoverJobPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('cutoverJobPath', () => {
                const result = client.cutoverJobPath("projectValue", "locationValue", "sourceValue", "migratingVmValue", "cutoverJobValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.cutoverJobPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromCutoverJobName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.cutoverJobPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('datacenterConnector', async () => {
            ...
            await client.initialize();
            client.pathTemplates.datacenterConnectorPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.datacenterConnectorPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('datacenterConnectorPath', () => {
                const result = client.datacenterConnectorPath("projectValue", "locationValue", "sourceValue", "datacenterConnectorValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.datacenterConnectorPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromDatacenterConnectorName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.datacenterConnectorPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromDatacenterConnectorName', () => {
                const result = client.matchLocationFromDatacenterConnectorName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.datacenterConnectorPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchDatacenterConnectorFromDatacenterConnectorName', () => {
                const result = client.matchDatacenterConnectorFromDatacenterConnectorName(fakePath);
        ...
        describe('migratingVm', async () => {
            ...
            await client.initialize();
            client.pathTemplates.migratingVmPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.migratingVmPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('migratingVmPath', () => {
                const result = client.migratingVmPath("projectValue", "locationValue", "sourceValue", "migratingVmValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.migratingVmPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromMigratingVmName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.migratingVmPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('replicationCycle', async () => {
            ...
            await client.initialize();
            client.pathTemplates.replicationCyclePathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.replicationCyclePathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('replicationCyclePath', () => {
                const result = client.replicationCyclePath("projectValue", "locationValue", "sourceValue", "migratingVmValue", "replicationCycleValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.replicationCyclePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchMigratingVmFromReplicationCycleName', () => {
                const result = client.matchMigratingVmFromReplicationCycleName(fakePath);
                assert.strictEqual(result, "migratingVmValue");
                assert((client.pathTemplates.replicationCyclePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('targetProject', async () => {
            ...
            await client.initialize();
            client.pathTemplates.targetProjectPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.targetProjectPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('targetProjectPath', () => {
                const result = client.targetProjectPath("projectValue", "locationValue", "targetProjectValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.targetProjectPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromTargetProjectName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.targetProjectPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('utilizationReport', async () => {
            ...
            await client.initialize();
            client.pathTemplates.utilizationReportPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.utilizationReportPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('utilizationReportPath', () => {
                const result = client.utilizationReportPath("projectValue", "locationValue", "sourceValue", "utilizationReportValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.utilizationReportPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromUtilizationReportName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.utilizationReportPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchUtilizationReportFromUtilizationReportName', () => {
                const result = client.matchUtilizationReportFromUtilizationReportName(fakePath);
