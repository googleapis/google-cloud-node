...
function main(parent) {
  ...
  async function callRetrieveBigQueryTableContextsFromRecentTables() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const response = await geminidataanalyticsClient.retrieveBigQueryTableContextsFromRecentTables(request);
    console.log(response);
  }

  callRetrieveBigQueryTableContextsFromRecentTables();
