...
function main(parent) {
  // [START connectors_v1_generated_Connectors_ListConnections_async]
  /**
  ...
  async function callListConnections() {
    ...
    // Run request
    const iterable = connectorsClient.listConnectionsAsync(request);
  ...
  callListConnections();
  // [END connectors_v1_generated_Connectors_ListConnections_async]
}
