...
describe('v1.StreamingServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          streamingserviceModule.v1.StreamingServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          streamingserviceModule.v1.StreamingServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'warehouse-visionai.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        ...
        it('value configured in code has priority over environment variable', () => {
          ...
          assert.strictEqual(
            servicePath,
            'warehouse-visionai.configured.example.com',
          );
          if (saved) {
            process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = saved;
          } else {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new streamingserviceModule.v1.StreamingServiceClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = streamingserviceModule.v1.StreamingServiceClient.port;
      assert(port);
  ...
  describe('acquireLease', () => {
    it('invokes acquireLease without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.visionai.v1.AcquireLeaseRequest(),
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.visionai.v1.Lease(),
      );
      ...
      const actualRequest = (
        client.innerApiCalls.acquireLease as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes acquireLease without error using callback', async () => {
      ...
      client.innerApiCalls.acquireLease =
      ...
      const promise = new Promise((resolve, reject) => {
        client.acquireLease(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1.ILease | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes acquireLease with error', async () => {
      ...
      client.innerApiCalls.acquireLease = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('renewLease', () => {
    it('invokes renewLease without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.visionai.v1.RenewLeaseRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('releaseLease', () => {
    it('invokes releaseLease without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.visionai.v1.ReleaseLeaseRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
    ...
    it('invokes releaseLease without error using callback', async () => {
      ...
      client.innerApiCalls.releaseLease =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.releaseLease(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1.IReleaseLeaseResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes releaseLease with error', async () => {
      ...
      const expectedHeaderRequestParams = `series=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.releaseLease = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('sendPackets', () => {
    it('invokes sendPackets without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.visionai.v1.SendPacketsRequest(),
      );

      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.visionai.v1.SendPacketsResponse(),
      );
      client.innerApiCalls.sendPackets =
        stubBidiStreamingCall(expectedResponse);
      const stream = client.sendPackets();
      const promise = new Promise((resolve, reject) => {
        stream.on(
          'data',
          (response: protos.google.cloud.visionai.v1.SendPacketsResponse) => {
            resolve(response);
          },
        );
      ...
      assert.deepStrictEqual(response, expectedResponse);
      assert(
        (client.innerApiCalls.sendPackets as SinonStub)
          .getCall(0)
          .calledWith(null),
      );
    ...
    it('invokes sendPackets with error', async () => {
      ...
      const expectedError = new Error('expected');
      client.innerApiCalls.sendPackets = stubBidiStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.sendPackets();
  ...
  describe('receivePackets', () => {
    it('invokes receivePackets without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.visionai.v1.ReceivePacketsRequest(),
      );

      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.visionai.v1.ReceivePacketsResponse(),
      );
      client.innerApiCalls.receivePackets =
        stubBidiStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        stream.on(
          'data',
          (
            response: protos.google.cloud.visionai.v1.ReceivePacketsResponse,
          ) => {
            resolve(response);
          },
        );
      ...
      assert.deepStrictEqual(response, expectedResponse);
      assert(
        (client.innerApiCalls.receivePackets as SinonStub)
          .getCall(0)
          .calledWith(null),
      );
      assert.deepStrictEqual(
    ...
    it('invokes receivePackets with error', async () => {
      ...
      const expectedError = new Error('expected');
      client.innerApiCalls.receivePackets = stubBidiStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.receivePackets();
  ...
  describe('receiveEvents', () => {
    it('invokes receiveEvents without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.visionai.v1.ReceiveEventsRequest(),
      );

      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.visionai.v1.ReceiveEventsResponse(),
      );
      client.innerApiCalls.receiveEvents =
        stubBidiStreamingCall(expectedResponse);
      const stream = client.receiveEvents();
      const promise = new Promise((resolve, reject) => {
        stream.on(
          'data',
          (response: protos.google.cloud.visionai.v1.ReceiveEventsResponse) => {
            resolve(response);
          },
        );
        stream.on('error', (err: Error) => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      assert(
        (client.innerApiCalls.receiveEvents as SinonStub)
          .getCall(0)
          .calledWith(null),
      );
      assert.deepStrictEqual(
    ...
    it('invokes receiveEvents with error', async () => {
      ...
      const expectedError = new Error('expected');
      client.innerApiCalls.receiveEvents = stubBidiStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.receiveEvents();
  ...
  describe('Path templates', () => {
    ...
    describe('operator', async () => {
      ...
      await client.initialize();
      client.pathTemplates.operatorPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.operatorPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('operatorPath', () => {
        const result = client.operatorPath(
          'projectValue',
          'locationValue',
          'operatorValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.operatorPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromOperatorName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.operatorPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('searchHypernym', async () => {
      ...
      await client.initialize();
      client.pathTemplates.searchHypernymPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.searchHypernymPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('searchHypernymPath', () => {
        const result = client.searchHypernymPath(
          'projectNumberValue',
          'locationValue',
          'corpusValue',
          'searchHypernymValue',
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.searchHypernymPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectNumberFromSearchHypernymName', () => {
        const result =
          client.matchProjectNumberFromSearchHypernymName(fakePath);
        assert.strictEqual(result, 'projectNumberValue');
        assert(
          (client.pathTemplates.searchHypernymPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchSearchHypernymFromSearchHypernymName', () => {
        const result =
          client.matchSearchHypernymFromSearchHypernymName(fakePath);
