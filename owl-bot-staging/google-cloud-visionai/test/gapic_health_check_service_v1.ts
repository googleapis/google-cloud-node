...
describe('v1.HealthCheckServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = healthcheckserviceModule.v1.HealthCheckServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = healthcheckserviceModule.v1.HealthCheckServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'warehouse-visionai.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new healthcheckserviceModule.v1.HealthCheckServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'warehouse-visionai.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new healthcheckserviceModule.v1.HealthCheckServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'warehouse-visionai.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new healthcheckserviceModule.v1.HealthCheckServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new healthcheckserviceModule.v1.HealthCheckServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('healthCheck', () => {
        it('invokes healthCheck without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.HealthCheckRequest', ['cluster']);
            ...
            const actualRequest = (client.innerApiCalls.healthCheck as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.healthCheck as SinonStub)
        ...
        it('invokes healthCheck without error using callback', async () => {
            ...
            client.innerApiCalls.healthCheck = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.healthCheck(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.visionai.v1.IHealthCheckResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes healthCheck with error', async () => {
            ...
            client.innerApiCalls.healthCheck = stubSimpleCall(undefined, expectedError);
