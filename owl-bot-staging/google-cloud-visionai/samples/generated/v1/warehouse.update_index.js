...
function main(index, updateMask) {
  // [START warehouse-visionai_v1_generated_Warehouse_UpdateIndex_async]
  /**
  ...
  async function callUpdateIndex() {
    ...
    // Run request
    const [operation] = await visionaiClient.updateIndex(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callUpdateIndex();
  // [END warehouse-visionai_v1_generated_Warehouse_UpdateIndex_async]
}
