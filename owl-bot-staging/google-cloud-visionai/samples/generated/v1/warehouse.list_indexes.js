...
function main(parent) {
  // [START warehouse-visionai_v1_generated_Warehouse_ListIndexes_async]
  /**
  ...
  async function callListIndexes() {
    ...
    // Run request
    const iterable = visionaiClient.listIndexesAsync(request);
  ...
  callListIndexes();
  // [END warehouse-visionai_v1_generated_Warehouse_ListIndexes_async]
}
