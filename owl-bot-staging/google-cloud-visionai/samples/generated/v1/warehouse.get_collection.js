...
function main(name) {
  // [START warehouse-visionai_v1_generated_Warehouse_GetCollection_async]
  /**
  ...
  async function callGetCollection() {
    ...
    // Run request
    const response = await visionaiClient.getCollection(request);
    console.log(response);
  }

  callGetCollection();
  // [END warehouse-visionai_v1_generated_Warehouse_GetCollection_async]
}
