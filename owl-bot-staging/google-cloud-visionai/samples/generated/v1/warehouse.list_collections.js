...
function main(parent) {
  // [START warehouse-visionai_v1_generated_Warehouse_ListCollections_async]
  /**
  ...
  async function callListCollections() {
    ...
    // Run request
    const iterable = visionaiClient.listCollectionsAsync(request);
  ...
  callListCollections();
  // [END warehouse-visionai_v1_generated_Warehouse_ListCollections_async]
}
