...
function main(parent) {
  // [START warehouse-visionai_v1_generated_Warehouse_ListCorpora_async]
  /**
  ...
  async function callListCorpora() {
    ...
    // Run request
    const iterable = visionaiClient.listCorporaAsync(request);
  ...
  callListCorpora();
  // [END warehouse-visionai_v1_generated_Warehouse_ListCorpora_async]
}
