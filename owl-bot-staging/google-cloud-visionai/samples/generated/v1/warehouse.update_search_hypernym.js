...
function main(searchHypernym) {
  // [START warehouse-visionai_v1_generated_Warehouse_UpdateSearchHypernym_async]
  /**
  ...
  async function callUpdateSearchHypernym() {
    // Construct request
    const request = {
      searchHypernym,
    };
    ...
    // Run request
    const response = await visionaiClient.updateSearchHypernym(request);
    console.log(response);
  }

  callUpdateSearchHypernym();
  // [END warehouse-visionai_v1_generated_Warehouse_UpdateSearchHypernym_async]
}
