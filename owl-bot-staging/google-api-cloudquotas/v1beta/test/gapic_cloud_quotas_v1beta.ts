...
describe('v1beta.CloudQuotasClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = cloudquotasModule.v1beta.CloudQuotasClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = cloudquotasModule.v1beta.CloudQuotasClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'cloudquotas.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new cloudquotasModule.v1beta.CloudQuotasClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'cloudquotas.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new cloudquotasModule.v1beta.CloudQuotasClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'cloudquotas.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new cloudquotasModule.v1beta.CloudQuotasClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new cloudquotasModule.v1beta.CloudQuotasClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getQuotaInfo', () => {
        it('invokes getQuotaInfo without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.api.cloudquotas.v1beta.GetQuotaInfoRequest', ['name']);
        ...
        it('invokes getQuotaInfo without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getQuotaInfo(
                    request,
                    (err?: Error|null, result?: protos.google.api.cloudquotas.v1beta.IQuotaInfo|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getQuotaPreference', () => {
        it('invokes getQuotaPreference without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.api.cloudquotas.v1beta.GetQuotaPreferenceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getQuotaPreference without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getQuotaPreference(
                    request,
                    (err?: Error|null, result?: protos.google.api.cloudquotas.v1beta.IQuotaPreference|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createQuotaPreference', () => {
        it('invokes createQuotaPreference without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.api.cloudquotas.v1beta.CreateQuotaPreferenceRequest', ['parent']);
    ...
    describe('updateQuotaPreference', () => {
        it('invokes updateQuotaPreference without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.api.cloudquotas.v1beta.UpdateQuotaPreferenceRequest', ['quotaPreference', 'name']);
    ...
    describe('listQuotaInfos', () => {
        it('invokes listQuotaInfos without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.api.cloudquotas.v1beta.ListQuotaInfosRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.api.cloudquotas.v1beta.QuotaInfo()),
              generateSampleMessage(new protos.google.api.cloudquotas.v1beta.QuotaInfo()),
              generateSampleMessage(new protos.google.api.cloudquotas.v1beta.QuotaInfo()),
            ];
        ...
        it('invokes listQuotaInfosStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.api.cloudquotas.v1beta.QuotaInfo) => {
    ...
    describe('listQuotaPreferences', () => {
        it('invokes listQuotaPreferences without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.api.cloudquotas.v1beta.ListQuotaPreferencesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
