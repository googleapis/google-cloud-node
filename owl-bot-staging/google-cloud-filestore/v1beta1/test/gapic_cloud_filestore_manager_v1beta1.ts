...
describe('v1beta1.CloudFilestoreManagerClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'file.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'file.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getSnapshot', () => {
        it('invokes getSnapshot without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.filestore.v1beta1.GetSnapshotRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.filestore.v1beta1.GetSnapshotRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.filestore.v1beta1.Snapshot()
            );
        ...
        it('invokes getSnapshot without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getSnapshot(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.filestore.v1beta1.ISnapshot|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getShare', () => {
        it('invokes getShare without error', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.filestore.v1beta1.GetShareRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.filestore.v1beta1.GetShareRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.filestore.v1beta1.Share()
            );
            client.innerApiCalls.getShare = stubSimpleCall(expectedResponse);
            const [response] = await client.getShare(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getShare as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getShare as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getShare without error using callback', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getShare = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getShare(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.filestore.v1beta1.IShare|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getShare with error', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getShare = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getShare(request), expectedError);
            const actualRequest = (client.innerApiCalls.getShare as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getShare as SinonStub)
        ...
        it('invokes getShare with closed client', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('revertInstance', () => {
        it('invokes revertInstance without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.filestore.v1beta1.RevertInstanceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.filestore.v1beta1.RevertInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('promoteReplica', () => {
        it('invokes promoteReplica without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.filestore.v1beta1.PromoteReplicaRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createSnapshot', () => {
        it('invokes createSnapshot without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.filestore.v1beta1.CreateSnapshotRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.filestore.v1beta1.CreateSnapshotRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createSnapshot without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createSnapshot(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.filestore.v1beta1.ISnapshot, protos.google.cloud.common.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.filestore.v1beta1.ISnapshot, protos.google.cloud.common.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createSnapshot as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteSnapshot', () => {
        it('invokes deleteSnapshot without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.filestore.v1beta1.DeleteSnapshotRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.filestore.v1beta1.DeleteSnapshotRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('updateSnapshot', () => {
        it('invokes updateSnapshot without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.filestore.v1beta1.UpdateSnapshotRequest()
            );
            request.snapshot ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.filestore.v1beta1.UpdateSnapshotRequest', ['snapshot', 'name']);
    ...
    describe('createShare', () => {
        it('invokes createShare without error', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.filestore.v1beta1.CreateShareRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.filestore.v1beta1.CreateShareRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createShare = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createShare(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createShare as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createShare as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes createShare without error using callback', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.createShare = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createShare(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.filestore.v1beta1.IShare, protos.google.cloud.common.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.filestore.v1beta1.IShare, protos.google.cloud.common.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createShare as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createShare with call error', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createShare = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createShare(request), expectedError);
            const actualRequest = (client.innerApiCalls.createShare as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createShare as SinonStub)
        ...
        it('invokes createShare with LRO error', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createShare = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createShare(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.createShare as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkCreateShareProgress without error', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkCreateShareProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkCreateShareProgress with error', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkCreateShareProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteShare', () => {
        it('invokes deleteShare without error', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.filestore.v1beta1.DeleteShareRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.filestore.v1beta1.DeleteShareRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteShare = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteShare(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteShare as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteShare as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes deleteShare without error using callback', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.deleteShare = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteShare(
                    request,
                    (err?: Error|null,
        ...
        it('invokes deleteShare with call error', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteShare = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteShare(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteShare as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteShare as SinonStub)
        ...
        it('invokes deleteShare with LRO error', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteShare = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteShare(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteShare as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteShareProgress without error', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteShareProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkDeleteShareProgress with error', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteShareProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('updateShare', () => {
        it('invokes updateShare without error', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.filestore.v1beta1.UpdateShareRequest()
            );
            request.share ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.filestore.v1beta1.UpdateShareRequest', ['share', 'name']);
            request.share.name = defaultValue1;
            const expectedHeaderRequestParams = `share.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updateShare = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateShare(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateShare as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateShare as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes updateShare without error using callback', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.updateShare = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateShare(
                    request,
                    (err?: Error|null,
        ...
        it('invokes updateShare with call error', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `share.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateShare = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.updateShare(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateShare as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateShare as SinonStub)
        ...
        it('invokes updateShare with LRO error', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `share.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateShare = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateShare(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateShare as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateShareProgress without error', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateShareProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkUpdateShareProgress with error', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateShareProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listSnapshots', () => {
        it('invokes listSnapshots without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.filestore.v1beta1.ListSnapshotsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.filestore.v1beta1.ListSnapshotsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.filestore.v1beta1.Snapshot()),
              generateSampleMessage(new protos.google.cloud.filestore.v1beta1.Snapshot()),
              generateSampleMessage(new protos.google.cloud.filestore.v1beta1.Snapshot()),
            ];
        ...
        it('invokes listSnapshotsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.filestore.v1beta1.Snapshot[] = [];
                stream.on('data', (response: protos.google.cloud.filestore.v1beta1.Snapshot) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listSnapshots without error', async () => {
            ...
            const responses: protos.google.cloud.filestore.v1beta1.ISnapshot[] = [];
    ...
    describe('listShares', () => {
        it('invokes listShares without error', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.filestore.v1beta1.ListSharesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.filestore.v1beta1.ListSharesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.filestore.v1beta1.Share()),
              generateSampleMessage(new protos.google.cloud.filestore.v1beta1.Share()),
              generateSampleMessage(new protos.google.cloud.filestore.v1beta1.Share()),
            ];
            client.innerApiCalls.listShares = stubSimpleCall(expectedResponse);
            const [response] = await client.listShares(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listShares as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listShares as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes listShares without error using callback', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listShares = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listShares(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.filestore.v1beta1.IShare[]|null) => {
        ...
        it('invokes listShares with error', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listShares = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listShares(request), expectedError);
            const actualRequest = (client.innerApiCalls.listShares as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listShares as SinonStub)
        ...
        it('invokes listSharesStream without error', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listShares.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listSharesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.filestore.v1beta1.Share[] = [];
                stream.on('data', (response: protos.google.cloud.filestore.v1beta1.Share) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listShares.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listShares, request));
            assert(
                (client.descriptors.page.listShares.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listSharesStream with error', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listShares.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listSharesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.filestore.v1beta1.Share[] = [];
                stream.on('data', (response: protos.google.cloud.filestore.v1beta1.Share) => {
        ...
        it('uses async iteration with listShares without error', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listShares.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.filestore.v1beta1.IShare[] = [];
            const iterable = client.listSharesAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listShares.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listShares.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listShares with error', async () => {
            const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listShares.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listSharesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.filestore.v1beta1.IShare[] = [];
                for await (const resource of iterable) {
    ...
    describe('Path templates', () => {
        ...
        describe('share', async () => {
            const fakePath = "/rendered/path/share";
            const expectedParameters = {
                project: "projectValue",
                location: "locationValue",
                instance: "instanceValue",
            ...
            await client.initialize();
            client.pathTemplates.sharePathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.sharePathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('sharePath', () => {
                const result = client.sharePath("projectValue", "locationValue", "instanceValue", "shareValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.sharePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromShareName', () => {
                const result = client.matchProjectFromShareName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.sharePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromShareName', () => {
                const result = client.matchLocationFromShareName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.sharePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchInstanceFromShareName', () => {
                const result = client.matchInstanceFromShareName(fakePath);
                assert.strictEqual(result, "instanceValue");
                assert((client.pathTemplates.sharePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchShareFromShareName', () => {
                const result = client.matchShareFromShareName(fakePath);
                assert.strictEqual(result, "shareValue");
                assert((client.pathTemplates.sharePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
