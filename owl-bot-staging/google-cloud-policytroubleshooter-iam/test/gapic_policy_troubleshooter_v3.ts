...
describe('v3.PolicyTroubleshooterClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new policytroubleshooterModule.v3.PolicyTroubleshooterClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = policytroubleshooterModule.v3.PolicyTroubleshooterClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = policytroubleshooterModule.v3.PolicyTroubleshooterClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'policytroubleshooter.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new policytroubleshooterModule.v3.PolicyTroubleshooterClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'policytroubleshooter.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new policytroubleshooterModule.v3.PolicyTroubleshooterClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'policytroubleshooter.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new policytroubleshooterModule.v3.PolicyTroubleshooterClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new policytroubleshooterModule.v3.PolicyTroubleshooterClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = policytroubleshooterModule.v3.PolicyTroubleshooterClient.port;
            assert(port);
        ...
        it('invokes troubleshootIamPolicy without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.troubleshootIamPolicy(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.policytroubleshooter.iam.v3.ITroubleshootIamPolicyResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
