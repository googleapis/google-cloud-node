...
describe('v3beta.PolicyTroubleshooterClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new policytroubleshooterModule.v3beta.PolicyTroubleshooterClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          policytroubleshooterModule.v3beta.PolicyTroubleshooterClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        policytroubleshooterModule.v3beta.PolicyTroubleshooterClient.port;
      assert(port);
    ...
    it('invokes troubleshootIamPolicy without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.troubleshootIamPolicy(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.policytroubleshooter.iam.v3beta.ITroubleshootIamPolicyResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
