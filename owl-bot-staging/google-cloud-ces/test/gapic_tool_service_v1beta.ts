...
describe('v1beta.ToolServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = toolserviceModule.v1beta.ToolServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = toolserviceModule.v1beta.ToolServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'ces.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new toolserviceModule.v1beta.ToolServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'ces.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new toolserviceModule.v1beta.ToolServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'ces.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new toolserviceModule.v1beta.ToolServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new toolserviceModule.v1beta.ToolServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('executeTool', () => {
        it('invokes executeTool without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1beta.ExecuteToolRequest', ['parent']);
        ...
        it('invokes executeTool without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.executeTool(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.ces.v1beta.IExecuteToolResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('retrieveToolSchema', () => {
        it('invokes retrieveToolSchema without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1beta.RetrieveToolSchemaRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes retrieveToolSchema without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.retrieveToolSchema(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.ces.v1beta.IRetrieveToolSchemaResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('retrieveTools', () => {
        it('invokes retrieveTools without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1beta.RetrieveToolsRequest', ['toolset']);
        ...
        it('invokes retrieveTools without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.retrieveTools(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.ces.v1beta.IRetrieveToolsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
