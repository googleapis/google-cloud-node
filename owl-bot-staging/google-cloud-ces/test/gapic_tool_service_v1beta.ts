...
describe('v1beta.ToolServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          toolserviceModule.v1beta.ToolServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          toolserviceModule.v1beta.ToolServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'ces.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new toolserviceModule.v1beta.ToolServiceClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = toolserviceModule.v1beta.ToolServiceClient.port;
      assert(port);
  ...
  describe('executeTool', () => {
    it('invokes executeTool without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1beta.ExecuteToolRequest(),
      );
    ...
    it('invokes executeTool without error using callback', async () => {
      ...
      client.innerApiCalls.executeTool =
      ...
      const promise = new Promise((resolve, reject) => {
        client.executeTool(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1beta.IExecuteToolResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes executeTool with error', async () => {
      ...
      client.innerApiCalls.executeTool = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('retrieveToolSchema', () => {
    it('invokes retrieveToolSchema without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1beta.RetrieveToolSchemaRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.RetrieveToolSchemaRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.ces.v1beta.RetrieveToolSchemaResponse(),
      );
      client.innerApiCalls.retrieveToolSchema =
        stubSimpleCall(expectedResponse);
      const [response] = await client.retrieveToolSchema(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.retrieveToolSchema as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.retrieveToolSchema as SinonStub
    ...
    it('invokes retrieveToolSchema without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.retrieveToolSchema(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1beta.IRetrieveToolSchemaResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes retrieveToolSchema with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.retrieveToolSchema = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('retrieveTools', () => {
    it('invokes retrieveTools without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1beta.RetrieveToolsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
    ...
    it('invokes retrieveTools without error using callback', async () => {
      ...
      client.innerApiCalls.retrieveTools =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.retrieveTools(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1beta.IRetrieveToolsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes retrieveTools with error', async () => {
      ...
      const expectedHeaderRequestParams = `toolset=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.retrieveTools = stubSimpleCall(
        undefined,
        expectedError,
      );
