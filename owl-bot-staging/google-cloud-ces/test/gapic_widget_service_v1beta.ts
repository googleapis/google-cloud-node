...
describe('v1beta.WidgetServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          widgetserviceModule.v1beta.WidgetServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          widgetserviceModule.v1beta.WidgetServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'ces.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new widgetserviceModule.v1beta.WidgetServiceClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = widgetserviceModule.v1beta.WidgetServiceClient.port;
      assert(port);
  ...
  describe('generateChatToken', () => {
    it('invokes generateChatToken without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1beta.GenerateChatTokenRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.GenerateChatTokenRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.ces.v1beta.GenerateChatTokenResponse(),
      );
    ...
    it('invokes generateChatToken without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.generateChatToken(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1beta.IGenerateChatTokenResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
