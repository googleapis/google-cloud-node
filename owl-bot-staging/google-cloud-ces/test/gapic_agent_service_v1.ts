...
describe('v1.AgentServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = agentserviceModule.v1.AgentServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = agentserviceModule.v1.AgentServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'ces.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new agentserviceModule.v1.AgentServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'ces.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new agentserviceModule.v1.AgentServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'ces.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new agentserviceModule.v1.AgentServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new agentserviceModule.v1.AgentServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getApp', () => {
        it('invokes getApp without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.GetAppRequest', ['name']);
        ...
        it('invokes getApp without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getApp(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.ces.v1.IApp|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateApp', () => {
        it('invokes updateApp without error', async () => {
            ...
            request.app ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.UpdateAppRequest', ['app', 'name']);
    ...
    describe('getAgent', () => {
        it('invokes getAgent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.GetAgentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getAgent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAgent(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.ces.v1.IAgent|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createAgent', () => {
        it('invokes createAgent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.CreateAgentRequest', ['parent']);
    ...
    describe('updateAgent', () => {
        it('invokes updateAgent without error', async () => {
            ...
            request.agent ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.UpdateAgentRequest', ['agent', 'name']);
    ...
    describe('deleteAgent', () => {
        it('invokes deleteAgent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.DeleteAgentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getExample', () => {
        it('invokes getExample without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.GetExampleRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getExample without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getExample(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.ces.v1.IExample|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createExample', () => {
        it('invokes createExample without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.CreateExampleRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.ces.v1.Example()
    ...
    describe('updateExample', () => {
        it('invokes updateExample without error', async () => {
            ...
            request.example ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.UpdateExampleRequest', ['example', 'name']);
    ...
    describe('deleteExample', () => {
        it('invokes deleteExample without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.DeleteExampleRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('getTool', () => {
        it('invokes getTool without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.GetToolRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getTool without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getTool(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.ces.v1.ITool|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getConversation', () => {
        it('invokes getConversation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.GetConversationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getConversation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getConversation(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.ces.v1.IConversation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deleteConversation', () => {
        it('invokes deleteConversation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.DeleteConversationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('createTool', () => {
        it('invokes createTool without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.CreateToolRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.ces.v1.Tool()
    ...
    describe('updateTool', () => {
        it('invokes updateTool without error', async () => {
            ...
            request.tool ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.UpdateToolRequest', ['tool', 'name']);
    ...
    describe('deleteTool', () => {
        it('invokes deleteTool without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.DeleteToolRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('getGuardrail', () => {
        it('invokes getGuardrail without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.GetGuardrailRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getGuardrail without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getGuardrail(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.ces.v1.IGuardrail|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createGuardrail', () => {
        it('invokes createGuardrail without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.CreateGuardrailRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.ces.v1.Guardrail()
    ...
    describe('updateGuardrail', () => {
        it('invokes updateGuardrail without error', async () => {
            ...
            request.guardrail ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.UpdateGuardrailRequest', ['guardrail', 'name']);
    ...
    describe('deleteGuardrail', () => {
        it('invokes deleteGuardrail without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.DeleteGuardrailRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('getDeployment', () => {
        it('invokes getDeployment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.GetDeploymentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getDeployment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getDeployment(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.ces.v1.IDeployment|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createDeployment', () => {
        it('invokes createDeployment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.CreateDeploymentRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.ces.v1.Deployment()
    ...
    describe('updateDeployment', () => {
        it('invokes updateDeployment without error', async () => {
            ...
            request.deployment ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.UpdateDeploymentRequest', ['deployment', 'name']);
    ...
    describe('deleteDeployment', () => {
        it('invokes deleteDeployment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.DeleteDeploymentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('getToolset', () => {
        it('invokes getToolset without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.GetToolsetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getToolset without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getToolset(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.ces.v1.IToolset|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createToolset', () => {
        it('invokes createToolset without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.CreateToolsetRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.ces.v1.Toolset()
    ...
    describe('updateToolset', () => {
        it('invokes updateToolset without error', async () => {
            ...
            request.toolset ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.UpdateToolsetRequest', ['toolset', 'name']);
    ...
    describe('deleteToolset', () => {
        it('invokes deleteToolset without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.DeleteToolsetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('getAppVersion', () => {
        it('invokes getAppVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.GetAppVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getAppVersion without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAppVersion(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.ces.v1.IAppVersion|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createAppVersion', () => {
        it('invokes createAppVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.CreateAppVersionRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.ces.v1.AppVersion()
    ...
    describe('deleteAppVersion', () => {
        it('invokes deleteAppVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.DeleteAppVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('getChangelog', () => {
        it('invokes getChangelog without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.GetChangelogRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getChangelog without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getChangelog(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.ces.v1.IChangelog|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createApp', () => {
        it('invokes createApp without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.CreateAppRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes createApp without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createApp(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.ces.v1.IApp, protos.google.cloud.ces.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.ces.v1.IApp, protos.google.cloud.ces.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createApp as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteApp', () => {
        it('invokes deleteApp without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.DeleteAppRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes deleteApp without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deleteApp(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.ces.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.ces.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteApp as SinonStub)
                .getCall(0).args[0];
    ...
    describe('exportApp', () => {
        it('invokes exportApp without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.ExportAppRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes exportApp without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.exportApp(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.ces.v1.IExportAppResponse, protos.google.cloud.ces.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.ces.v1.IExportAppResponse, protos.google.cloud.ces.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportApp as SinonStub)
                .getCall(0).args[0];
    ...
    describe('importApp', () => {
        it('invokes importApp without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.ImportAppRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes importApp without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.importApp(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.ces.v1.IImportAppResponse, protos.google.cloud.ces.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.ces.v1.IImportAppResponse, protos.google.cloud.ces.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importApp as SinonStub)
                .getCall(0).args[0];
    ...
    describe('batchDeleteConversations', () => {
        it('invokes batchDeleteConversations without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.BatchDeleteConversationsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes batchDeleteConversations without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchDeleteConversations(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.ces.v1.IBatchDeleteConversationsResponse, protos.google.cloud.ces.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.ces.v1.IBatchDeleteConversationsResponse, protos.google.cloud.ces.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchDeleteConversations as SinonStub)
                .getCall(0).args[0];
    ...
    describe('restoreAppVersion', () => {
        it('invokes restoreAppVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.RestoreAppVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes restoreAppVersion without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.restoreAppVersion(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.ces.v1.IRestoreAppVersionResponse, protos.google.cloud.ces.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.ces.v1.IRestoreAppVersionResponse, protos.google.cloud.ces.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.restoreAppVersion as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listApps', () => {
        it('invokes listApps without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.ListAppsRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listAgents', () => {
        it('invokes listAgents without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.ListAgentsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
    ...
    describe('listExamples', () => {
        it('invokes listExamples without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.ListExamplesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
    ...
    describe('listTools', () => {
        it('invokes listTools without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.ListToolsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
    ...
    describe('listConversations', () => {
        it('invokes listConversations without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.ListConversationsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
        ...
        it('invokes listConversationsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.ces.v1.Conversation) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listGuardrails', () => {
        it('invokes listGuardrails without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.ListGuardrailsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
    ...
    describe('listDeployments', () => {
        it('invokes listDeployments without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.ListDeploymentsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
    ...
    describe('listToolsets', () => {
        it('invokes listToolsets without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.ListToolsetsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
    ...
    describe('listAppVersions', () => {
        it('invokes listAppVersions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.ListAppVersionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
    ...
    describe('listChangelogs', () => {
        it('invokes listChangelogs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.ces.v1.ListChangelogsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
