...
describe('v1.WidgetServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          widgetserviceModule.v1.WidgetServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          widgetserviceModule.v1.WidgetServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'ces.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new widgetserviceModule.v1.WidgetServiceClient({
          universe_domain: 'example.com',
  ...
  describe('generateChatToken', () => {
    it('invokes generateChatToken without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.generateChatToken as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes generateChatToken without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.generateChatToken(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1.IGenerateChatTokenResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes generateChatToken with error', async () => {
      ...
      client.innerApiCalls.generateChatToken = stubSimpleCall(
        undefined,
        expectedError,
      );
