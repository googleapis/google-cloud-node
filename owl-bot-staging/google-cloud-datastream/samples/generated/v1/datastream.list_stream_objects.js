...
function main(parent) {
  // [START datastream_v1_generated_Datastream_ListStreamObjects_async]
  /**
  ...
  async function callListStreamObjects() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = datastreamClient.listStreamObjectsAsync(request);
  ...
  // [END datastream_v1_generated_Datastream_ListStreamObjects_async]
}
