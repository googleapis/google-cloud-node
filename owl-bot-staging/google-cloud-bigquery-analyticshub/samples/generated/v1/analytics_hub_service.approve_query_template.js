...
function main(name) {
  // [START analyticshub_v1_generated_AnalyticsHubService_ApproveQueryTemplate_async]
  /**
  ...
  async function callApproveQueryTemplate() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await analyticshubClient.approveQueryTemplate(request);
    console.log(response);
  }

  callApproveQueryTemplate();
