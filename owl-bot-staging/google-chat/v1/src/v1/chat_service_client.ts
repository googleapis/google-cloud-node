 ...
 */
  ...
  getSpaceNotificationSetting(
    ...
    this.initialize();
    return this.innerApiCalls.getSpaceNotificationSetting(request, options, callback);
  }
/**
 ...
 */
  ...
  updateSpaceNotificationSetting(
    ...
    this.initialize();
    return this.innerApiCalls.updateSpaceNotificationSetting(request, options, callback);
  }
