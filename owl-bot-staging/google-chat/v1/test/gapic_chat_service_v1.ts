...
describe('v1.ChatServiceClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new chatserviceModule.v1.ChatServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'chat.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new chatserviceModule.v1.ChatServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'chat.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new chatserviceModule.v1.ChatServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new chatserviceModule.v1.ChatServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createMessage', () => {
        it('invokes createMessage without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.chat.v1.CreateMessageRequest', ['parent']);
            ...
            const actualRequest = (client.innerApiCalls.createMessage as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createMessage as SinonStub)
        ...
        it('invokes createMessage without error using callback', async () => {
            ...
            client.innerApiCalls.createMessage = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createMessage(
                    request,
                    (err?: Error|null, result?: protos.google.chat.v1.IMessage|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createMessage with error', async () => {
            ...
            client.innerApiCalls.createMessage = stubSimpleCall(undefined, expectedError);
    ...
    describe('getMembership', () => {
        it('invokes getMembership without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.chat.v1.GetMembershipRequest', ['name']);
        ...
        it('invokes getMembership without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getMembership(
                    request,
                    (err?: Error|null, result?: protos.google.chat.v1.IMembership|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getMessage', () => {
        it('invokes getMessage without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.chat.v1.GetMessageRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.chat.v1.Message()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getMessage as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getMessage as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getMessage without error using callback', async () => {
            ...
            client.innerApiCalls.getMessage = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getMessage(
                    request,
                    (err?: Error|null, result?: protos.google.chat.v1.IMessage|null) => {
        ...
        it('invokes getMessage with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getMessage = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateMessage', () => {
        it('invokes updateMessage without error', async () => {
            ...
            request.message ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.chat.v1.UpdateMessageRequest', ['message', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateMessage as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateMessage as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateMessage without error using callback', async () => {
            ...
            client.innerApiCalls.updateMessage = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateMessage with error', async () => {
            ...
            const expectedHeaderRequestParams = `message.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateMessage = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteMessage', () => {
        it('invokes deleteMessage without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.chat.v1.DeleteMessageRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteMessage as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteMessage as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteMessage without error using callback', async () => {
            ...
            client.innerApiCalls.deleteMessage = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteMessage with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteMessage = stubSimpleCall(undefined, expectedError);
    ...
    describe('getAttachment', () => {
        it('invokes getAttachment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.chat.v1.GetAttachmentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getAttachment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAttachment(
                    request,
                    (err?: Error|null, result?: protos.google.chat.v1.IAttachment|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('uploadAttachment', () => {
        it('invokes uploadAttachment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.chat.v1.UploadAttachmentRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.uploadAttachment as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.uploadAttachment as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes uploadAttachment without error using callback', async () => {
            ...
            client.innerApiCalls.uploadAttachment = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.uploadAttachment(
                    request,
                    (err?: Error|null, result?: protos.google.chat.v1.IUploadAttachmentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes uploadAttachment with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.uploadAttachment = stubSimpleCall(undefined, expectedError);
    ...
    describe('getSpace', () => {
        it('invokes getSpace without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.chat.v1.GetSpaceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('setUpSpace', () => {
        ...
        it('invokes setUpSpace without error using callback', async () => {
            ...
            client.innerApiCalls.setUpSpace = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.setUpSpace(
                    request,
                    (err?: Error|null, result?: protos.google.chat.v1.ISpace|null) => {
        ...
        it('invokes setUpSpace with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.setUpSpace = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateSpace', () => {
        it('invokes updateSpace without error', async () => {
            ...
            request.space ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.chat.v1.UpdateSpaceRequest', ['space', 'name']);
    ...
    describe('deleteSpace', () => {
        it('invokes deleteSpace without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.chat.v1.DeleteSpaceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteSpace as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteSpace as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteSpace without error using callback', async () => {
            ...
            client.innerApiCalls.deleteSpace = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteSpace(
                    request,
                    (err?: Error|null, result?: protos.google.protobuf.IEmpty|null) => {
        ...
        it('invokes deleteSpace with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteSpace = stubSimpleCall(undefined, expectedError);
    ...
    describe('completeImportSpace', () => {
        it('invokes completeImportSpace without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.chat.v1.CompleteImportSpaceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.chat.v1.CompleteImportSpaceResponse()
            );
            client.innerApiCalls.completeImportSpace = stubSimpleCall(expectedResponse);
            const [response] = await client.completeImportSpace(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.completeImportSpace as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.completeImportSpace as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes completeImportSpace without error using callback', async () => {
            ...
            client.innerApiCalls.completeImportSpace = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.completeImportSpace(
                    request,
                    (err?: Error|null, result?: protos.google.chat.v1.ICompleteImportSpaceResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes completeImportSpace with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.completeImportSpace = stubSimpleCall(undefined, expectedError);
    ...
    describe('findDirectMessage', () => {
        ...
        it('invokes findDirectMessage without error using callback', async () => {
            ...
            client.innerApiCalls.findDirectMessage = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes findDirectMessage with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.findDirectMessage = stubSimpleCall(undefined, expectedError);
    ...
    describe('createMembership', () => {
        it('invokes createMembership without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.chat.v1.CreateMembershipRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.chat.v1.Membership()
        ...
        it('invokes createMembership without error using callback', async () => {
            ...
            client.innerApiCalls.createMembership = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createMembership with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createMembership = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateMembership', () => {
        it('invokes updateMembership without error', async () => {
            ...
            request.membership ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.chat.v1.UpdateMembershipRequest', ['membership', 'name']);
        ...
        it('invokes updateMembership without error using callback', async () => {
            ...
            client.innerApiCalls.updateMembership = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateMembership with error', async () => {
            ...
            const expectedHeaderRequestParams = `membership.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateMembership = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteMembership', () => {
        it('invokes deleteMembership without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.chat.v1.DeleteMembershipRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.chat.v1.Membership()
        ...
        it('invokes deleteMembership without error using callback', async () => {
            ...
            client.innerApiCalls.deleteMembership = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteMembership with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteMembership = stubSimpleCall(undefined, expectedError);
    ...
    describe('createReaction', () => {
        it('invokes createReaction without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.chat.v1.CreateReactionRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createReaction as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createReaction as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createReaction without error using callback', async () => {
            ...
            client.innerApiCalls.createReaction = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createReaction(
                    request,
                    (err?: Error|null, result?: protos.google.chat.v1.IReaction|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createReaction with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createReaction = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteReaction', () => {
        it('invokes deleteReaction without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.chat.v1.DeleteReactionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteReaction as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteReaction as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteReaction without error using callback', async () => {
            ...
            client.innerApiCalls.deleteReaction = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteReaction with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteReaction = stubSimpleCall(undefined, expectedError);
    ...
    describe('getSpaceReadState', () => {
        it('invokes getSpaceReadState without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.chat.v1.GetSpaceReadStateRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getSpaceReadState as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getSpaceReadState as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getSpaceReadState without error using callback', async () => {
            ...
            client.innerApiCalls.getSpaceReadState = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getSpaceReadState(
                    request,
                    (err?: Error|null, result?: protos.google.chat.v1.ISpaceReadState|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getSpaceReadState with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getSpaceReadState = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateSpaceReadState', () => {
        it('invokes updateSpaceReadState without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.chat.v1.UpdateSpaceReadStateRequest', ['spaceReadState', 'name']);
            request.spaceReadState.name = defaultValue1;
            const expectedHeaderRequestParams = `space_read_state.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.chat.v1.SpaceReadState()
            );
            client.innerApiCalls.updateSpaceReadState = stubSimpleCall(expectedResponse);
            const [response] = await client.updateSpaceReadState(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateSpaceReadState as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateSpaceReadState as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateSpaceReadState without error using callback', async () => {
            ...
            client.innerApiCalls.updateSpaceReadState = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateSpaceReadState with error', async () => {
            ...
            const expectedHeaderRequestParams = `space_read_state.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateSpaceReadState = stubSimpleCall(undefined, expectedError);
    ...
    describe('getThreadReadState', () => {
        it('invokes getThreadReadState without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.chat.v1.GetThreadReadStateRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.chat.v1.ThreadReadState()
            );
            client.innerApiCalls.getThreadReadState = stubSimpleCall(expectedResponse);
            const [response] = await client.getThreadReadState(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getThreadReadState as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getThreadReadState as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getThreadReadState without error using callback', async () => {
            ...
            client.innerApiCalls.getThreadReadState = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getThreadReadState(
                    request,
                    (err?: Error|null, result?: protos.google.chat.v1.IThreadReadState|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getThreadReadState with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getThreadReadState = stubSimpleCall(undefined, expectedError);
    ...
    describe('getSpaceEvent', () => {
        it('invokes getSpaceEvent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.chat.v1.GetSpaceEventRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getSpaceEvent as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getSpaceEvent as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getSpaceEvent without error using callback', async () => {
            ...
            client.innerApiCalls.getSpaceEvent = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getSpaceEvent(
                    request,
                    (err?: Error|null, result?: protos.google.chat.v1.ISpaceEvent|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getSpaceEvent with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getSpaceEvent = stubSimpleCall(undefined, expectedError);
    ...
    describe('getSpaceNotificationSetting', () => {
        it('invokes getSpaceNotificationSetting without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.chat.v1.GetSpaceNotificationSettingRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.chat.v1.SpaceNotificationSetting()
            );
            client.innerApiCalls.getSpaceNotificationSetting = stubSimpleCall(expectedResponse);
            const [response] = await client.getSpaceNotificationSetting(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getSpaceNotificationSetting as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getSpaceNotificationSetting as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getSpaceNotificationSetting without error using callback', async () => {
            ...
            client.innerApiCalls.getSpaceNotificationSetting = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getSpaceNotificationSetting(
                    request,
                    (err?: Error|null, result?: protos.google.chat.v1.ISpaceNotificationSetting|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getSpaceNotificationSetting with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getSpaceNotificationSetting = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getSpaceNotificationSetting(request), expectedError);
            const actualRequest = (client.innerApiCalls.getSpaceNotificationSetting as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getSpaceNotificationSetting as SinonStub)
    ...
    describe('updateSpaceNotificationSetting', () => {
        it('invokes updateSpaceNotificationSetting without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.chat.v1.UpdateSpaceNotificationSettingRequest', ['spaceNotificationSetting', 'name']);
            ...
            client.innerApiCalls.updateSpaceNotificationSetting = stubSimpleCall(expectedResponse);
            const [response] = await client.updateSpaceNotificationSetting(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateSpaceNotificationSetting as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateSpaceNotificationSetting as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateSpaceNotificationSetting without error using callback', async () => {
            ...
            client.innerApiCalls.updateSpaceNotificationSetting = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateSpaceNotificationSetting with error', async () => {
            ...
            const expectedHeaderRequestParams = `space_notification_setting.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateSpaceNotificationSetting = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateSpaceNotificationSetting(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateSpaceNotificationSetting as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateSpaceNotificationSetting as SinonStub)
    ...
    describe('listMessages', () => {
        it('invokes listMessages without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.chat.v1.ListMessagesRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listMemberships', () => {
        it('invokes listMemberships without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.chat.v1.ListMembershipsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
    ...
    describe('listSpaces', () => {
        ...
        it('invokes listSpaces without error using callback', async () => {
            ...
            client.innerApiCalls.listSpaces = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listSpaces(
                    request,
                    (err?: Error|null, result?: protos.google.chat.v1.ISpace[]|null) => {
        ...
        it('invokes listSpaces with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listSpaces = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listSpacesStream without error', async () => {
            ...
            client.descriptors.page.listSpaces.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listSpaces.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listSpaces, request));
        });
        ...
        it('invokes listSpacesStream with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.descriptors.page.listSpaces.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listSpacesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.chat.v1.Space[] = [];
                stream.on('data', (response: protos.google.chat.v1.Space) => {
        ...
        it('uses async iteration with listSpaces without error', async () => {
            ...
            client.descriptors.page.listSpaces.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listSpaces.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
        });
        ...
        it('uses async iteration with listSpaces with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.descriptors.page.listSpaces.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listSpacesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.chat.v1.ISpace[] = [];
                for await (const resource of iterable) {
    ...
    describe('searchSpaces', () => {
        ...
        it('invokes searchSpaces without error using callback', async () => {
            ...
            client.innerApiCalls.searchSpaces = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.searchSpaces(
                    request,
                    (err?: Error|null, result?: protos.google.chat.v1.ISpace[]|null) => {
        ...
        it('invokes searchSpaces with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.searchSpaces = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes searchSpacesStream without error', async () => {
            ...
            client.descriptors.page.searchSpaces.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.searchSpaces.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.searchSpaces, request));
        });
        ...
        it('invokes searchSpacesStream with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.descriptors.page.searchSpaces.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.searchSpacesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.chat.v1.Space[] = [];
                stream.on('data', (response: protos.google.chat.v1.Space) => {
        ...
        it('uses async iteration with searchSpaces without error', async () => {
            ...
            client.descriptors.page.searchSpaces.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.chat.v1.ISpace[] = [];
        ...
        it('uses async iteration with searchSpaces with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.descriptors.page.searchSpaces.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.searchSpacesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.chat.v1.ISpace[] = [];
                for await (const resource of iterable) {
    ...
    describe('listReactions', () => {
        it('invokes listReactions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.chat.v1.ListReactionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listReactions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listReactions as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listReactions without error using callback', async () => {
            ...
            client.innerApiCalls.listReactions = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listReactions with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listReactions = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listReactionsStream without error', async () => {
            ...
            client.descriptors.page.listReactions.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listReactions.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listReactions, request));
            assert(
        ...
        it('invokes listReactionsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listReactions.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listReactionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.chat.v1.Reaction[] = [];
                stream.on('data', (response: protos.google.chat.v1.Reaction) => {
        ...
        it('uses async iteration with listReactions without error', async () => {
            ...
            client.descriptors.page.listReactions.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listReactions with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listReactions.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listReactionsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.chat.v1.IReaction[] = [];
                for await (const resource of iterable) {
    ...
    describe('listSpaceEvents', () => {
        it('invokes listSpaceEvents without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.chat.v1.ListSpaceEventsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listSpaceEvents as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listSpaceEvents as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listSpaceEvents without error using callback', async () => {
            ...
            client.innerApiCalls.listSpaceEvents = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listSpaceEvents with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listSpaceEvents = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listSpaceEventsStream without error', async () => {
            ...
            client.descriptors.page.listSpaceEvents.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listSpaceEvents.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listSpaceEvents, request));
            assert(
        ...
        it('invokes listSpaceEventsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listSpaceEvents.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listSpaceEventsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.chat.v1.SpaceEvent[] = [];
                stream.on('data', (response: protos.google.chat.v1.SpaceEvent) => {
        ...
        it('uses async iteration with listSpaceEvents without error', async () => {
            ...
            client.descriptors.page.listSpaceEvents.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listSpaceEvents with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listSpaceEvents.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listSpaceEventsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.chat.v1.ISpaceEvent[] = [];
                for await (const resource of iterable) {
    ...
    describe('Path templates', () => {
        ...
        describe('attachment', async () => {
            ...
            await client.initialize();
            client.pathTemplates.attachmentPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.attachmentPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('attachmentPath', () => {
                const result = client.attachmentPath("spaceValue", "messageValue", "attachmentValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.attachmentPathTemplate.render as SinonStub)
            ...
            it('matchSpaceFromAttachmentName', () => {
                ...
                assert((client.pathTemplates.attachmentPathTemplate.match as SinonStub)
        ...
        describe('message', async () => {
            ...
            await client.initialize();
            client.pathTemplates.messagePathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.messagePathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('messagePath', () => {
                const result = client.messagePath("spaceValue", "messageValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.messagePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchSpaceFromMessageName', () => {
                ...
                assert.strictEqual(result, "spaceValue");
                assert((client.pathTemplates.messagePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('quotedMessageMetadata', async () => {
            ...
            await client.initialize();
            client.pathTemplates.quotedMessageMetadataPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.quotedMessageMetadataPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('quotedMessageMetadataPath', () => {
                const result = client.quotedMessageMetadataPath("spaceValue", "messageValue", "quotedMessageMetadataValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.quotedMessageMetadataPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchSpaceFromQuotedMessageMetadataName', () => {
                ...
                assert.strictEqual(result, "spaceValue");
                assert((client.pathTemplates.quotedMessageMetadataPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchMessageFromQuotedMessageMetadataName', () => {
                const result = client.matchMessageFromQuotedMessageMetadataName(fakePath);
                assert.strictEqual(result, "messageValue");
                assert((client.pathTemplates.quotedMessageMetadataPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchQuotedMessageMetadataFromQuotedMessageMetadataName', () => {
                const result = client.matchQuotedMessageMetadataFromQuotedMessageMetadataName(fakePath);
        ...
        describe('reaction', async () => {
            ...
            await client.initialize();
            client.pathTemplates.reactionPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.reactionPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('reactionPath', () => {
                const result = client.reactionPath("spaceValue", "messageValue", "reactionValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.reactionPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
        ...
        describe('spaceEvent', async () => {
            ...
            await client.initialize();
            client.pathTemplates.spaceEventPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.spaceEventPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('spaceEventPath', () => {
                const result = client.spaceEventPath("spaceValue", "spaceEventValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.spaceEventPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchSpaceFromSpaceEventName', () => {
                ...
                assert.strictEqual(result, "spaceValue");
                assert((client.pathTemplates.spaceEventPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('spaceNotificationSetting', async () => {
            ...
            await client.initialize();
            client.pathTemplates.spaceNotificationSettingPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.spaceNotificationSettingPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('spaceNotificationSettingPath', () => {
                const result = client.spaceNotificationSettingPath("userValue", "spaceValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.spaceNotificationSettingPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchUserFromSpaceNotificationSettingName', () => {
                const result = client.matchUserFromSpaceNotificationSettingName(fakePath);
                assert.strictEqual(result, "userValue");
                assert((client.pathTemplates.spaceNotificationSettingPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchSpaceFromSpaceNotificationSettingName', () => {
                const result = client.matchSpaceFromSpaceNotificationSettingName(fakePath);
                assert.strictEqual(result, "spaceValue");
                assert((client.pathTemplates.spaceNotificationSettingPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('spaceReadState', async () => {
            ...
            await client.initialize();
            client.pathTemplates.spaceReadStatePathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.spaceReadStatePathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('spaceReadStatePath', () => {
                const result = client.spaceReadStatePath("userValue", "spaceValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.spaceReadStatePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchUserFromSpaceReadStateName', () => {
                ...
                assert.strictEqual(result, "userValue");
                assert((client.pathTemplates.spaceReadStatePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('thread', async () => {
            ...
            await client.initialize();
            client.pathTemplates.threadPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.threadPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('threadPath', () => {
                const result = client.threadPath("spaceValue", "threadValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.threadPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchSpaceFromThreadName', () => {
                ...
                assert.strictEqual(result, "spaceValue");
                assert((client.pathTemplates.threadPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('threadReadState', async () => {
            ...
            await client.initialize();
            client.pathTemplates.threadReadStatePathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.threadReadStatePathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('threadReadStatePath', () => {
                const result = client.threadReadStatePath("userValue", "spaceValue", "threadValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.threadReadStatePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchUserFromThreadReadStateName', () => {
                ...
                assert.strictEqual(result, "userValue");
                assert((client.pathTemplates.threadReadStatePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
