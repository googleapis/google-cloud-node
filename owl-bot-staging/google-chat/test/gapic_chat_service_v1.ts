...
describe('v1.ChatServiceClient', () => {
  ...
  describe('createSection', () => {
    it('invokes createSection without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.chat.v1.CreateSectionRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createSection as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createSection as SinonStub
    ...
    it('invokes createSection without error using callback', async () => {
      ...
      client.innerApiCalls.createSection =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createSection(
          ...
          (
            err?: Error | null,
            result?: protos.google.chat.v1.ISection | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createSection with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createSection = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteSection', () => {
    it('invokes deleteSection without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.chat.v1.DeleteSectionRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteSection as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteSection as SinonStub
    ...
    it('invokes deleteSection without error using callback', async () => {
      ...
      client.innerApiCalls.deleteSection =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes deleteSection with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteSection = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateSection', () => {
    it('invokes updateSection without error', async () => {
      ...
      request.section ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.chat.v1.UpdateSectionRequest',
        ['section', 'name'],
      );
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateSection as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateSection as SinonStub
    ...
    it('invokes updateSection with error', async () => {
      ...
      const expectedHeaderRequestParams = `section.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateSection = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('positionSection', () => {
    it('invokes positionSection without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.positionSection as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.positionSection as SinonStub
    ...
    it('invokes positionSection without error using callback', async () => {
      ...
      client.innerApiCalls.positionSection =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.positionSection(
          ...
          (
            err?: Error | null,
            result?: protos.google.chat.v1.IPositionSectionResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes positionSection with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.positionSection = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('moveSectionItem', () => {
    it('invokes moveSectionItem without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.chat.v1.MoveSectionItemRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.moveSectionItem as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.moveSectionItem as SinonStub
    ...
    it('invokes moveSectionItem without error using callback', async () => {
      ...
      client.innerApiCalls.moveSectionItem =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.moveSectionItem(
          ...
          (
            err?: Error | null,
            result?: protos.google.chat.v1.IMoveSectionItemResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes moveSectionItem with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.moveSectionItem = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('findGroupChats', () => {
    ...
    it('invokes findGroupChats without error using callback', async () => {
      ...
      client.innerApiCalls.findGroupChats =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes findGroupChats with error', async () => {
      ...
      const expectedError = new Error('expected');
      client.innerApiCalls.findGroupChats = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes findGroupChatsStream without error', async () => {
      ...
      client.descriptors.page.findGroupChats.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      assert.deepStrictEqual(responses, expectedResponse);
      assert(
        (client.descriptors.page.findGroupChats.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.findGroupChats, request),
      );
    });
    ...
    it('uses async iteration with findGroupChats without error', async () => {
      ...
      client.descriptors.page.findGroupChats.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.chat.v1.ISpace[] = [];
  ...
  describe('listSections', () => {
    it('invokes listSections without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.chat.v1.ListSectionsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listSections as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listSections as SinonStub
    ...
    it('invokes listSections without error using callback', async () => {
      ...
      client.innerApiCalls.listSections =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listSections(
          request,
    ...
    it('invokes listSections with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listSections = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listSectionsStream without error', async () => {
      ...
      client.descriptors.page.listSections.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      assert(
        (client.descriptors.page.listSections.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listSections, request),
      );
      assert(
        (client.descriptors.page.listSections.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listSectionsStream with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listSections.createStream = stubPageStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.listSectionsStream(request);
    ...
    it('uses async iteration with listSections without error', async () => {
      ...
      client.descriptors.page.listSections.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listSectionItems', () => {
    it('invokes listSectionItems without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.chat.v1.ListSectionItemsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listSectionItems as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listSectionItems as SinonStub
    ...
    it('invokes listSectionItems without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listSectionItems(
          ...
          (
            err?: Error | null,
            result?: protos.google.chat.v1.ISectionItem[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listSectionItems with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listSectionItems = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listSectionItemsStream without error', async () => {
      ...
      client.descriptors.page.listSectionItems.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      assert(
        (client.descriptors.page.listSectionItems.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listSectionItems, request),
      );
      assert(
        (client.descriptors.page.listSectionItems.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listSectionItems without error', async () => {
      ...
      client.descriptors.page.listSectionItems.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('Path templates', () => {
    ...
    describe('section', async () => {
      ...
      await client.initialize();
      client.pathTemplates.sectionPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.sectionPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);
      ...
      it('sectionPath', () => {
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.sectionPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchUserFromSectionName', () => {
        ...
        assert(
          (client.pathTemplates.sectionPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('sectionItem', async () => {
      ...
      await client.initialize();
      client.pathTemplates.sectionItemPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.sectionItemPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('sectionItemPath', () => {
        const result = client.sectionItemPath(
          'userValue',
          'sectionValue',
          'itemValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.sectionItemPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchUserFromSectionItemName', () => {
        ...
        assert.strictEqual(result, 'userValue');
        assert(
          (client.pathTemplates.sectionItemPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
