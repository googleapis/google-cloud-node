...
export class CloudDeployClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    if (opts.fallback) {
      ...
      },{selector: 'google.iam.v1.IAMPolicy.SetIamPolicy',post: '/v1/{resource=projects/*/locations/*/deliveryPipelines/*}:setIamPolicy',body: '*',additional_bindings: [{post: '/v1/{resource=projects/*/locations/*/targets/*}:setIamPolicy',body: '*',},{post: '/v1/{resource=projects/*/locations/*/customTargetTypes/*}:setIamPolicy',body: '*',}],
