...
# [Certificatemanager: Nodejs Client][homepage]
...
* [Certificatemanager Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/certificatemanager/latest)
...
1.  [Enable the Certificatemanager API][enable_api].
