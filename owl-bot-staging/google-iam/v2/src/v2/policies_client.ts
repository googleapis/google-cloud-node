...
export class PoliciesClient {
  ...
  initialize() {
    ...
    const policiesStubMethods =
        ['listPolicies', 'getPolicy', 'createPolicy', 'updatePolicy', 'deletePolicy', 'listApplicablePolicies'];
 ...
 */
  ...
  listApplicablePolicies(
    ...
    this.initialize();
    return this.innerApiCalls.listApplicablePolicies(request, options, callback);
  }
