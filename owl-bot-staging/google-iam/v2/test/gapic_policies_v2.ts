...
describe('v2.PoliciesClient', () => {
    ...
    describe('getPolicy', () => {
        it('invokes getPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.iam.v2.GetPolicyRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.iam.v2.Policy());
    ...
    describe('createPolicy', () => {
        it('invokes createPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.iam.v2.CreatePolicyRequest());
            request.parent = '';
    ...
    describe('updatePolicy', () => {
        it('invokes updatePolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.iam.v2.UpdatePolicyRequest());
            request.policy = {};
            request.policy.name = '';
    ...
    describe('deletePolicy', () => {
        it('invokes deletePolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.iam.v2.DeletePolicyRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listPolicies', () => {
        it('invokes listPolicies without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.iam.v2.ListPoliciesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listApplicablePolicies', () => {
        it('invokes listApplicablePolicies without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.iam.v2.ListApplicablePoliciesRequest());
            ...
            client.innerApiCalls.listApplicablePolicies = stubSimpleCall(expectedResponse);
            const [response] = await client.listApplicablePolicies(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listApplicablePolicies as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listApplicablePolicies without error using callback', async () => {
            ...
            client.innerApiCalls.listApplicablePolicies = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listApplicablePolicies with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listApplicablePolicies = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listApplicablePolicies(request), expectedError);
            assert((client.innerApiCalls.listApplicablePolicies as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listApplicablePoliciesStream without error', async () => {
            ...
            client.descriptors.page.listApplicablePolicies.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listApplicablePolicies.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listApplicablePolicies, request));
            assert.strictEqual(
                (client.descriptors.page.listApplicablePolicies.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'],
                expectedHeaderRequestParams
            );
        });
        ...
        it('invokes listApplicablePoliciesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = "attachment_point=";
            const expectedError = new Error('expected');
            client.descriptors.page.listApplicablePolicies.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listApplicablePoliciesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.iam.v2.Policy[] = [];
                stream.on('data', (response: protos.google.iam.v2.Policy) => {
        ...
        it('uses async iteration with listApplicablePolicies without error', async () => {
            ...
            client.descriptors.page.listApplicablePolicies.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.iam.v2.IPolicy[] = [];
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listApplicablePolicies.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert.strictEqual(
                (client.descriptors.page.listApplicablePolicies.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'],
        ...
        it('uses async iteration with listApplicablePolicies with error', async () => {
            ...
            const request = generateSampleMessage(new protos.google.iam.v2.ListApplicablePoliciesRequest());
            request.attachmentPoint = '';
            const expectedHeaderRequestParams = "attachment_point=";const expectedError = new Error('expected');
            client.descriptors.page.listApplicablePolicies.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listApplicablePoliciesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.iam.v2.IPolicy[] = [];
                for await (const resource of iterable) {
