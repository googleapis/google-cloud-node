...
[![npm version](https://img.shields.io/npm/v/@google-cloud/products.svg)](https://www.npmjs.org/package/@google-cloud/products)
...
```bash
npm install @google-cloud/products
```
...
For example, `npm install @google-cloud/products@legacy-8` installs client libraries
