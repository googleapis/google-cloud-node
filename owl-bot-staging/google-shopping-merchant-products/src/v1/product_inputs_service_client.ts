 ...
 * `src/v1/product_inputs_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './product_inputs_service_client_config.json';
 ...
 * @memberof v1
 */
export class ProductInputsServiceClient {
  ...
  productInputsServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.shopping.merchant.products.v1.ProductInputsService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.productInputsServiceStub) {
      return this.productInputsServiceStub;
    }
    ...
    this.productInputsServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.shopping.merchant.products.v1.ProductInputsService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.shopping.merchant.products.v1.ProductInputsService,
 ...
 *   The first element of the array is an object representing {@link protos.google.shopping.merchant.products.v1.ProductInput|ProductInput}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/product_inputs_service.insert_product_input.js</caption>
 * region_tag:merchantapi_v1_generated_ProductInputsService_InsertProductInput_async
 */
  insertProductInput(
      request?: protos.google.shopping.merchant.products.v1.IInsertProductInputRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.products.v1.IProductInput,
        protos.google.shopping.merchant.products.v1.IInsertProductInputRequest|undefined, {}|undefined
      ]>;
  insertProductInput(
      request: protos.google.shopping.merchant.products.v1.IInsertProductInputRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.products.v1.IProductInput,
          protos.google.shopping.merchant.products.v1.IInsertProductInputRequest|null|undefined,
          {}|null|undefined>): void;
  insertProductInput(
      request: protos.google.shopping.merchant.products.v1.IInsertProductInputRequest,
      callback: Callback<
  ...
  insertProductInput(
    ...
    return this.innerApiCalls.insertProductInput(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.products.v1.IProductInput,
        protos.google.shopping.merchant.products.v1.IInsertProductInputRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('insertProductInput response %j', response);
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/product_inputs_service.update_product_input.js</caption>
 * region_tag:merchantapi_v1_generated_ProductInputsService_UpdateProductInput_async
 */
  updateProductInput(
      request?: protos.google.shopping.merchant.products.v1.IUpdateProductInputRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.products.v1.IProductInput,
        protos.google.shopping.merchant.products.v1.IUpdateProductInputRequest|undefined, {}|undefined
      ]>;
  updateProductInput(
      request: protos.google.shopping.merchant.products.v1.IUpdateProductInputRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.products.v1.IProductInput,
          protos.google.shopping.merchant.products.v1.IUpdateProductInputRequest|null|undefined,
          {}|null|undefined>): void;
  updateProductInput(
      request: protos.google.shopping.merchant.products.v1.IUpdateProductInputRequest,
      callback: Callback<
  ...
  updateProductInput(
    ...
    return this.innerApiCalls.updateProductInput(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.products.v1.IProductInput,
        protos.google.shopping.merchant.products.v1.IUpdateProductInputRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('updateProductInput response %j', response);
        return [response, options, rawResponse];
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/product_inputs_service.delete_product_input.js</caption>
 * region_tag:merchantapi_v1_generated_ProductInputsService_DeleteProductInput_async
 */
  deleteProductInput(
      ...
      Promise<[
        ...
        protos.google.shopping.merchant.products.v1.IDeleteProductInputRequest|undefined, {}|undefined
      ]>;
  deleteProductInput(
      request: protos.google.shopping.merchant.products.v1.IDeleteProductInputRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.protobuf.IEmpty,
          protos.google.shopping.merchant.products.v1.IDeleteProductInputRequest|null|undefined,
          {}|null|undefined>): void;
  deleteProductInput(
      request: protos.google.shopping.merchant.products.v1.IDeleteProductInputRequest,
      callback: Callback<
  ...
  deleteProductInput(
    ...
    return this.innerApiCalls.deleteProductInput(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.protobuf.IEmpty,
        protos.google.shopping.merchant.products.v1.IDeleteProductInputRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('deleteProductInput response %j', response);
        return [response, options, rawResponse];
