...
describe('v1beta1.PublicCertificateAuthorityServiceClient', () => {
    ...
    describe('createExternalAccountKey', () => {
        it('invokes createExternalAccountKey without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.security.publicca.v1beta1.ExternalAccountKey());
            ...
            assert((client.innerApiCalls.createExternalAccountKey as SinonStub)
