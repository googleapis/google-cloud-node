...
[![npm version](https://img.shields.io/npm/v/@google-cloud/servicecontrol.svg)](https://www.npmjs.org/package/@google-cloud/servicecontrol)
...
```bash
npm install @google-cloud/servicecontrol
```
...
For example, `npm install @google-cloud/servicecontrol@legacy-8` installs client libraries
