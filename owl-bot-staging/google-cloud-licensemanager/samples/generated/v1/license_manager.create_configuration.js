...
function main(parent, configurationId, configuration) {
  ...
  async function callCreateConfiguration() {
    // Construct request
    const request = {
      parent,
      configurationId,
    ...
    // Run request
    const [operation] = await licensemanagerClient.createConfiguration(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callCreateConfiguration();
