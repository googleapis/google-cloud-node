...
function main(parent) {
  // [START licensemanager_v1_generated_LicenseManager_ListProducts_async]
  /**
  ...
  async function callListProducts() {
    ...
    // Run request
    const iterable = licensemanagerClient.listProductsAsync(request);
  ...
  callListProducts();
  // [END licensemanager_v1_generated_LicenseManager_ListProducts_async]
}
