...
export class PolicyBasedRoutingServiceClient {
   ...
   *     const client = new PolicyBasedRoutingServiceClient({fallback: 'rest'}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    if (opts.fallback === 'rest') {
      ...
      lroOptions.httpRules = [{selector: 'google.cloud.location.Locations.GetLocation',get: '/v1/{name=projects/*/locations/*}',},{selector: 'google.cloud.location.Locations.ListLocations',get: '/v1/{name=projects/*}/locations',},{selector: 'google.iam.v1.IAMPolicy.GetIamPolicy',get: '/v1/{resource=projects/*/locations/global/hubs/*}:getIamPolicy',additional_bindings: [{get: '/v1/{resource=projects/*/locations/*/spokes/*}:getIamPolicy',},{get: '/v1/{resource=projects/*/locations/global/policyBasedRoutes/*}:getIamPolicy',},{get: '/v1/{resource=projects/*/locations/*/serviceConnectionMaps/*}:getIamPolicy',},{get: '/v1/{resource=projects/*/locations/*/serviceConnectionPolicies/*}:getIamPolicy',},{get: '/v1/{resource=projects/*/locations/*/serviceClasses/*}:getIamPolicy',}],
 ...
 *   The first element of the array is an object representing [PolicyBasedRoute]{@link google.cloud.networkconnectivity.v1.PolicyBasedRoute}.
 *   Please see the
 ...
 */
  ...
  createPolicyBasedRoute(
    ...
    this.initialize();
    return this.innerApiCalls.createPolicyBasedRoute(request, options, callback);
  }
/**
 ...
 */
  ...
  deletePolicyBasedRoute(
    ...
    this.initialize();
    return this.innerApiCalls.deletePolicyBasedRoute(request, options, callback);
  }
/**
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [PolicyBasedRoute]{@link google.cloud.networkconnectivity.v1.PolicyBasedRoute}.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [PolicyBasedRoute]{@link google.cloud.networkconnectivity.v1.PolicyBasedRoute} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   [PolicyBasedRoute]{@link google.cloud.networkconnectivity.v1.PolicyBasedRoute}. The API will be called under the hood as needed, once per the page,
...
/**
   ...
   * @returns {string} Resource name string.
   */
  policyBasedRoutePath(project:string,location:string,policyBasedRoute:string) {
  ...
  matchLocationFromPolicyBasedRouteName(policyBasedRouteName: string) {
    return this.pathTemplates.policyBasedRoutePathTemplate.match(policyBasedRouteName).location;
  }
