...
export class HubServiceClient {
  ...
  initialize() {
    ...
    const hubServiceStubMethods =
        ['listHubs', 'getHub', 'createHub', 'updateHub', 'deleteHub', 'listHubSpokes', 'queryHubStatus', 'listSpokes', 'getSpoke', 'createSpoke', 'updateSpoke', 'rejectHubSpoke', 'acceptHubSpoke', 'deleteSpoke', 'getRouteTable', 'getRoute', 'listRoutes', 'listRouteTables', 'getGroup', 'listGroups', 'updateGroup'];
