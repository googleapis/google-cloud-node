...
export {v1, CrossNetworkAutomationServiceClient, HubServiceClient, PolicyBasedRoutingServiceClient};
export default {v1, CrossNetworkAutomationServiceClient, HubServiceClient, PolicyBasedRoutingServiceClient};
