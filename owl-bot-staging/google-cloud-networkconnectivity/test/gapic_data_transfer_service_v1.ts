...
describe('v1.DataTransferServiceClient', () => {
  ...
  describe('getMulticloudDataTransferConfig', () => {
    it('invokes getMulticloudDataTransferConfig without error', async () => {
      ...
      client.innerApiCalls.getMulticloudDataTransferConfig =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getMulticloudDataTransferConfig(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getMulticloudDataTransferConfig as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getMulticloudDataTransferConfig without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getMulticloudDataTransferConfig(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networkconnectivity.v1.IMulticloudDataTransferConfig | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getMulticloudDataTransferConfig with error', async () => {
      ...
      client.innerApiCalls.getMulticloudDataTransferConfig = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getMulticloudDataTransferConfig(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getMulticloudDataTransferConfig as SinonStub
  ...
  describe('getDestination', () => {
    it('invokes getDestination without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getDestination as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getDestination as SinonStub
    ...
    it('invokes getDestination without error using callback', async () => {
      ...
      client.innerApiCalls.getDestination =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getDestination(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networkconnectivity.v1.IDestination | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getDestination with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getDestination = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getMulticloudDataTransferSupportedService', () => {
    it('invokes getMulticloudDataTransferSupportedService without error', async () => {
      ...
      client.innerApiCalls.getMulticloudDataTransferSupportedService =
        stubSimpleCall(expectedResponse);
      const [response] =
        await client.getMulticloudDataTransferSupportedService(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls
          .getMulticloudDataTransferSupportedService as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls
    ...
    it('invokes getMulticloudDataTransferSupportedService without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getMulticloudDataTransferSupportedService(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networkconnectivity.v1.IMulticloudDataTransferSupportedService | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getMulticloudDataTransferSupportedService with error', async () => {
      ...
      await assert.rejects(
        client.getMulticloudDataTransferSupportedService(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls
  ...
  describe('createMulticloudDataTransferConfig', () => {
    it('invokes createMulticloudDataTransferConfig without error', async () => {
      ...
      const [operation] =
        await client.createMulticloudDataTransferConfig(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createMulticloudDataTransferConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createMulticloudDataTransferConfig as SinonStub
    ...
    it('invokes createMulticloudDataTransferConfig with call error', async () => {
      ...
      await assert.rejects(
        client.createMulticloudDataTransferConfig(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createMulticloudDataTransferConfig as SinonStub
    ...
    it('invokes checkCreateMulticloudDataTransferConfigProgress without error', async () => {
      ...
      const decodedOperation =
        await client.checkCreateMulticloudDataTransferConfigProgress(
  ...
  describe('updateMulticloudDataTransferConfig', () => {
    it('invokes updateMulticloudDataTransferConfig without error', async () => {
      ...
      client.innerApiCalls.updateMulticloudDataTransferConfig =
        stubLongRunningCall(expectedResponse);
      const [operation] =
        await client.updateMulticloudDataTransferConfig(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateMulticloudDataTransferConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateMulticloudDataTransferConfig as SinonStub
    ...
    it('invokes checkUpdateMulticloudDataTransferConfigProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkUpdateMulticloudDataTransferConfigProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkUpdateMulticloudDataTransferConfigProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateMulticloudDataTransferConfigProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteMulticloudDataTransferConfig', () => {
    it('invokes deleteMulticloudDataTransferConfig without error', async () => {
      ...
      client.innerApiCalls.deleteMulticloudDataTransferConfig =
        stubLongRunningCall(expectedResponse);
      const [operation] =
        await client.deleteMulticloudDataTransferConfig(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteMulticloudDataTransferConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteMulticloudDataTransferConfig as SinonStub
    ...
    it('invokes deleteMulticloudDataTransferConfig with call error', async () => {
      ...
      client.innerApiCalls.deleteMulticloudDataTransferConfig =
        stubLongRunningCall(undefined, expectedError);
      await assert.rejects(
        client.deleteMulticloudDataTransferConfig(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteMulticloudDataTransferConfig as SinonStub
    ...
    it('invokes checkDeleteMulticloudDataTransferConfigProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkDeleteMulticloudDataTransferConfigProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('createDestination', () => {
    it('invokes createDestination without error', async () => {
      ...
      client.innerApiCalls.createDestination =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createDestination(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createDestination as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createDestination as SinonStub
    ...
    it('invokes createDestination with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createDestination = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkCreateDestinationProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateDestinationProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateDestination', () => {
    it('invokes updateDestination without error', async () => {
      ...
      client.innerApiCalls.updateDestination =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateDestination(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateDestination as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateDestination as SinonStub
    ...
    it('invokes updateDestination with call error', async () => {
      ...
      const expectedHeaderRequestParams = `destination.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateDestination = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkUpdateDestinationProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateDestinationProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteDestination', () => {
    it('invokes deleteDestination without error', async () => {
      ...
      client.innerApiCalls.deleteDestination =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteDestination(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteDestination as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteDestination as SinonStub
    ...
    it('invokes deleteDestination with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteDestination = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkDeleteDestinationProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteDestinationProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listMulticloudDataTransferConfigs', () => {
    it('invokes listMulticloudDataTransferConfigs without error', async () => {
      ...
      client.innerApiCalls.listMulticloudDataTransferConfigs =
        stubSimpleCall(expectedResponse);
      const [response] =
        await client.listMulticloudDataTransferConfigs(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listMulticloudDataTransferConfigs as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listMulticloudDataTransferConfigs as SinonStub
    ...
    it('invokes listMulticloudDataTransferConfigs with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listMulticloudDataTransferConfigs = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listMulticloudDataTransferConfigs(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listMulticloudDataTransferConfigs as SinonStub
    ...
    it('invokes listMulticloudDataTransferConfigsStream without error', async () => {
      ...
      client.descriptors.page.listMulticloudDataTransferConfigs.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networkconnectivity.v1.MulticloudDataTransferConfig,
          ) => {
      ...
      assert(
        (
          client.descriptors.page.listMulticloudDataTransferConfigs
    ...
    it('uses async iteration with listMulticloudDataTransferConfigs without error', async () => {
      ...
      client.descriptors.page.listMulticloudDataTransferConfigs.asyncIterate =
  ...
  describe('listDestinations', () => {
    it('invokes listDestinations without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listDestinations as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listDestinations as SinonStub
    ...
    it('invokes listDestinations without error using callback', async () => {
      ...
      client.innerApiCalls.listDestinations =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listDestinations with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listDestinations = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listDestinationsStream without error', async () => {
      ...
      client.descriptors.page.listDestinations.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networkconnectivity.v1.Destination,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (client.descriptors.page.listDestinations.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listDestinations, request),
      );
      assert(
        (client.descriptors.page.listDestinations.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listDestinations without error', async () => {
      ...
      client.descriptors.page.listDestinations.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listMulticloudDataTransferSupportedServices', () => {
    it('invokes listMulticloudDataTransferSupportedServices without error', async () => {
      ...
      client.innerApiCalls.listMulticloudDataTransferSupportedServices =
        stubSimpleCall(expectedResponse);
      const [response] =
        await client.listMulticloudDataTransferSupportedServices(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls
          .listMulticloudDataTransferSupportedServices as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls
    ...
    it('invokes listMulticloudDataTransferSupportedServices with error', async () => {
      ...
      client.innerApiCalls.listMulticloudDataTransferSupportedServices =
        stubSimpleCall(undefined, expectedError);
      await assert.rejects(
        client.listMulticloudDataTransferSupportedServices(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls
    ...
    it('invokes listMulticloudDataTransferSupportedServicesStream without error', async () => {
      ...
      client.descriptors.page.listMulticloudDataTransferSupportedServices.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream =
        client.listMulticloudDataTransferSupportedServicesStream(request);
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networkconnectivity.v1.MulticloudDataTransferSupportedService,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (
          client.descriptors.page.listMulticloudDataTransferSupportedServices
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(
    ...
    it('uses async iteration with listMulticloudDataTransferSupportedServices without error', async () => {
      ...
      client.descriptors.page.listMulticloudDataTransferSupportedServices.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.networkconnectivity.v1.IMulticloudDataTransferSupportedService[] =
        [];
      const iterable =
        client.listMulticloudDataTransferSupportedServicesAsync(request);
      for await (const resource of iterable) {
        responses.push(resource!);
      }
      assert.deepStrictEqual(responses, expectedResponse);
  ...
  describe('Path templates', () => {
    describe('destination', async () => {
      ...
      await client.initialize();
      client.pathTemplates.destinationPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.destinationPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('destinationPath', () => {
        const result = client.destinationPath(
          'projectValue',
          'locationValue',
        ...
        assert(
          (client.pathTemplates.destinationPathTemplate.render as SinonStub)
            .getCall(-1)
      ...
      it('matchProjectFromDestinationName', () => {
        ...
        assert(
          (client.pathTemplates.destinationPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchMulticloudDataTransferConfigFromDestinationName', () => {
        const result =
          client.matchMulticloudDataTransferConfigFromDestinationName(fakePath);
    ...
    describe('internalRange', async () => {
      ...
      await client.initialize();
      client.pathTemplates.internalRangePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.internalRangePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('internalRangePath', () => {
        const result = client.internalRangePath(
          'projectValue',
          'locationValue',
          'internalRangeValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.internalRangePathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromInternalRangeName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.internalRangePathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('multicloudDataTransferConfig', async () => {
      ...
      it('multicloudDataTransferConfigPath', () => {
        const result = client.multicloudDataTransferConfigPath(
          'projectValue',
          'locationValue',
          'multicloudDataTransferConfigValue',
        );
        ...
        assert(
          (
            client.pathTemplates.multicloudDataTransferConfigPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromMulticloudDataTransferConfigName', () => {
        const result =
          client.matchProjectFromMulticloudDataTransferConfigName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.multicloudDataTransferConfigPathTemplate
      ...
      it('matchLocationFromMulticloudDataTransferConfigName', () => {
        const result =
          client.matchLocationFromMulticloudDataTransferConfigName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.multicloudDataTransferConfigPathTemplate
      ...
      it('matchMulticloudDataTransferConfigFromMulticloudDataTransferConfigName', () => {
        const result =
          client.matchMulticloudDataTransferConfigFromMulticloudDataTransferConfigName(
            fakePath,
          );
        assert.strictEqual(result, 'multicloudDataTransferConfigValue');
        assert(
    ...
    describe('multicloudDataTransferSupportedService', async () => {
      ...
      it('multicloudDataTransferSupportedServicePath', () => {
        const result = client.multicloudDataTransferSupportedServicePath(
          'projectValue',
          'locationValue',
          'multicloudDataTransferSupportedServiceValue',
        );
      ...
      it('matchProjectFromMulticloudDataTransferSupportedServiceName', () => {
        const result =
          client.matchProjectFromMulticloudDataTransferSupportedServiceName(
            fakePath,
          );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromMulticloudDataTransferSupportedServiceName', () => {
        const result =
          client.matchLocationFromMulticloudDataTransferSupportedServiceName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchMulticloudDataTransferSupportedServiceFromMulticloudDataTransferSupportedServiceName', () => {
        const result =
          client.matchMulticloudDataTransferSupportedServiceFromMulticloudDataTransferSupportedServiceName(
            fakePath,
          );
        assert.strictEqual(
          result,
