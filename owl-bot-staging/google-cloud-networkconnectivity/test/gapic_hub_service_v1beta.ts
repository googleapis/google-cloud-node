...
describe('v1beta.HubServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client = new hubserviceModule.v1beta.HubServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          hubserviceModule.v1beta.HubServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          hubserviceModule.v1beta.HubServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'networkconnectivity.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new hubserviceModule.v1beta.HubServiceClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = hubserviceModule.v1beta.HubServiceClient.port;
      assert(port);
  ...
  describe('getHub', () => {
    it('invokes getHub without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.GetHubRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.GetHubRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.Hub(),
      );
    ...
    it('invokes getHub without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getHub(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networkconnectivity.v1beta.IHub | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getSpoke', () => {
    it('invokes getSpoke without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.GetSpokeRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.GetSpokeRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.Spoke(),
      );
    ...
    it('invokes getSpoke without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getSpoke(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networkconnectivity.v1beta.ISpoke | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getRouteTable', () => {
    it('invokes getRouteTable without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.GetRouteTableRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.RouteTable(),
      );
    ...
    it('invokes getRouteTable without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getRouteTable(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networkconnectivity.v1beta.IRouteTable | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getRoute', () => {
    it('invokes getRoute without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.GetRouteRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.Route(),
      );
    ...
    it('invokes getRoute without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getRoute(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networkconnectivity.v1beta.IRoute | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getGroup', () => {
    it('invokes getGroup without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.GetGroupRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.GetGroupRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.Group(),
      );
    ...
    it('invokes getGroup without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getGroup(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networkconnectivity.v1beta.IGroup | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getGatewayAdvertisedRoute', () => {
    it('invokes getGatewayAdvertisedRoute without error', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.GetGatewayAdvertisedRouteRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.GetGatewayAdvertisedRouteRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.GatewayAdvertisedRoute(),
      );
      client.innerApiCalls.getGatewayAdvertisedRoute =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getGatewayAdvertisedRoute(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getGatewayAdvertisedRoute as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getGatewayAdvertisedRoute as SinonStub
    ...
    it('invokes getGatewayAdvertisedRoute without error using callback', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.getGatewayAdvertisedRoute =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getGatewayAdvertisedRoute(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.networkconnectivity.v1beta.IGatewayAdvertisedRoute | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getGatewayAdvertisedRoute with error', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getGatewayAdvertisedRoute = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes getGatewayAdvertisedRoute with closed client', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
  ...
  describe('createHub', () => {
    it('invokes createHub without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.CreateHubRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.CreateHubRequest',
        ['parent'],
      );
  ...
  describe('updateHub', () => {
    it('invokes updateHub without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.UpdateHubRequest(),
      );
      request.hub ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.UpdateHubRequest',
        ['hub', 'name'],
      );
  ...
  describe('deleteHub', () => {
    it('invokes deleteHub without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.DeleteHubRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.DeleteHubRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('createSpoke', () => {
    it('invokes createSpoke without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.CreateSpokeRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.CreateSpokeRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
  ...
  describe('updateSpoke', () => {
    it('invokes updateSpoke without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.UpdateSpokeRequest(),
      );
      request.spoke ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.UpdateSpokeRequest',
        ['spoke', 'name'],
      );
  ...
  describe('rejectHubSpoke', () => {
    it('invokes rejectHubSpoke without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.RejectHubSpokeRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.RejectHubSpokeRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('acceptHubSpoke', () => {
    it('invokes acceptHubSpoke without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.AcceptHubSpokeRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.AcceptHubSpokeRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('acceptSpokeUpdate', () => {
    it('invokes acceptSpokeUpdate without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.AcceptSpokeUpdateRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.AcceptSpokeUpdateRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('rejectSpokeUpdate', () => {
    it('invokes rejectSpokeUpdate without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.RejectSpokeUpdateRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.RejectSpokeUpdateRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('deleteSpoke', () => {
    it('invokes deleteSpoke without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.DeleteSpokeRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.DeleteSpokeRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('updateGroup', () => {
    it('invokes updateGroup without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.UpdateGroupRequest(),
      );
      request.group ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.UpdateGroupRequest',
        ['group', 'name'],
      );
  ...
  describe('createGatewayAdvertisedRoute', () => {
    it('invokes createGatewayAdvertisedRoute without error', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.CreateGatewayAdvertisedRouteRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.CreateGatewayAdvertisedRouteRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.createGatewayAdvertisedRoute =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createGatewayAdvertisedRoute(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createGatewayAdvertisedRoute as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createGatewayAdvertisedRoute as SinonStub
    ...
    it('invokes createGatewayAdvertisedRoute without error using callback', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.createGatewayAdvertisedRoute =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createGatewayAdvertisedRoute(
          request,
          (
            err?: Error | null,
            result?: LROperation<
    ...
    it('invokes createGatewayAdvertisedRoute with call error', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createGatewayAdvertisedRoute = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createGatewayAdvertisedRoute(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createGatewayAdvertisedRoute as SinonStub
    ...
    it('invokes createGatewayAdvertisedRoute with LRO error', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
    ...
    it('invokes checkCreateGatewayAdvertisedRouteProgress without error', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      const decodedOperation =
        await client.checkCreateGatewayAdvertisedRouteProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkCreateGatewayAdvertisedRouteProgress with error', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
  ...
  describe('updateGatewayAdvertisedRoute', () => {
    it('invokes updateGatewayAdvertisedRoute without error', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.UpdateGatewayAdvertisedRouteRequest(),
      );
      request.gatewayAdvertisedRoute ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.UpdateGatewayAdvertisedRouteRequest',
        ['gatewayAdvertisedRoute', 'name'],
      );
      request.gatewayAdvertisedRoute.name = defaultValue1;
      const expectedHeaderRequestParams = `gateway_advertised_route.name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.longrunning.Operation(),
      );
      client.innerApiCalls.updateGatewayAdvertisedRoute =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateGatewayAdvertisedRoute(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateGatewayAdvertisedRoute as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateGatewayAdvertisedRoute as SinonStub
    ...
    it('invokes updateGatewayAdvertisedRoute without error using callback', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
    ...
    it('invokes updateGatewayAdvertisedRoute with call error', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `gateway_advertised_route.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateGatewayAdvertisedRoute = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateGatewayAdvertisedRoute(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateGatewayAdvertisedRoute as SinonStub
    ...
    it('invokes updateGatewayAdvertisedRoute with LRO error', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
    ...
    it('invokes checkUpdateGatewayAdvertisedRouteProgress without error', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkUpdateGatewayAdvertisedRouteProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkUpdateGatewayAdvertisedRouteProgress with error', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
  ...
  describe('deleteGatewayAdvertisedRoute', () => {
    it('invokes deleteGatewayAdvertisedRoute without error', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.DeleteGatewayAdvertisedRouteRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.deleteGatewayAdvertisedRoute =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteGatewayAdvertisedRoute(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteGatewayAdvertisedRoute as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteGatewayAdvertisedRoute as SinonStub
    ...
    it('invokes deleteGatewayAdvertisedRoute without error using callback', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.deleteGatewayAdvertisedRoute =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.deleteGatewayAdvertisedRoute(
          request,
          (
            err?: Error | null,
            result?: LROperation<
    ...
    it('invokes deleteGatewayAdvertisedRoute with call error', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteGatewayAdvertisedRoute = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteGatewayAdvertisedRoute(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteGatewayAdvertisedRoute as SinonStub
    ...
    it('invokes deleteGatewayAdvertisedRoute with LRO error', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
    ...
    it('invokes checkDeleteGatewayAdvertisedRouteProgress without error', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkDeleteGatewayAdvertisedRouteProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkDeleteGatewayAdvertisedRouteProgress with error', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      await assert.rejects(
        client.checkDeleteGatewayAdvertisedRouteProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listHubs', () => {
    it('invokes listHubs without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.ListHubsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.ListHubsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
    ...
    it('invokes listHubsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.networkconnectivity.v1beta.Hub[] =
          [];
        stream.on(
          'data',
          (response: protos.google.cloud.networkconnectivity.v1beta.Hub) => {
    ...
    it('uses async iteration with listHubs without error', async () => {
      ...
      const responses: protos.google.cloud.networkconnectivity.v1beta.IHub[] =
        [];
  ...
  describe('listHubSpokes', () => {
    it('invokes listHubSpokes without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.ListHubSpokesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.ListHubSpokesRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
    ...
    it('invokes listHubSpokesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.networkconnectivity.v1beta.Spoke[] =
          [];
        stream.on(
          'data',
          (response: protos.google.cloud.networkconnectivity.v1beta.Spoke) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
    ...
    it('uses async iteration with listHubSpokes without error', async () => {
      ...
      client.descriptors.page.listHubSpokes.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.networkconnectivity.v1beta.ISpoke[] =
        [];
  ...
  describe('queryHubStatus', () => {
    it('invokes queryHubStatus without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.QueryHubStatusRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.QueryHubStatusRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.networkconnectivity.v1beta.HubStatusEntry(),
        ),
        generateSampleMessage(
          new protos.google.cloud.networkconnectivity.v1beta.HubStatusEntry(),
        ),
    ...
    it('invokes queryHubStatusStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.networkconnectivity.v1beta.HubStatusEntry[] =
          [];
        stream.on(
          'data',
          (
            response: protos.google.cloud.networkconnectivity.v1beta.HubStatusEntry,
          ) => {
            responses.push(response);
          },
        );
    ...
    it('uses async iteration with queryHubStatus without error', async () => {
      ...
      client.descriptors.page.queryHubStatus.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.networkconnectivity.v1beta.IHubStatusEntry[] =
        [];
  ...
  describe('listSpokes', () => {
    it('invokes listSpokes without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.ListSpokesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.ListSpokesRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
  ...
  describe('listRoutes', () => {
    it('invokes listRoutes without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.ListRoutesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
    ...
    it('invokes listRoutesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.networkconnectivity.v1beta.Route[] =
          [];
        stream.on(
          'data',
          (response: protos.google.cloud.networkconnectivity.v1beta.Route) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
    ...
    it('uses async iteration with listRoutes without error', async () => {
      ...
      client.descriptors.page.listRoutes.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.networkconnectivity.v1beta.IRoute[] =
        [];
  ...
  describe('listRouteTables', () => {
    it('invokes listRouteTables without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.ListRouteTablesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.ListRouteTablesRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
    ...
    it('invokes listRouteTablesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.networkconnectivity.v1beta.RouteTable[] =
          [];
        stream.on(
          'data',
          (
            response: protos.google.cloud.networkconnectivity.v1beta.RouteTable,
          ) => {
            responses.push(response);
          },
        );
    ...
    it('uses async iteration with listRouteTables without error', async () => {
      ...
      client.descriptors.page.listRouteTables.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.networkconnectivity.v1beta.IRouteTable[] =
        [];
  ...
  describe('listGroups', () => {
    it('invokes listGroups without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.ListGroupsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.ListGroupsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
    ...
    it('invokes listGroupsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.networkconnectivity.v1beta.Group[] =
          [];
        stream.on(
          'data',
          (response: protos.google.cloud.networkconnectivity.v1beta.Group) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
    ...
    it('uses async iteration with listGroups without error', async () => {
      ...
      client.descriptors.page.listGroups.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.networkconnectivity.v1beta.IGroup[] =
        [];
  ...
  describe('listGatewayAdvertisedRoutes', () => {
    it('invokes listGatewayAdvertisedRoutes without error', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.ListGatewayAdvertisedRoutesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.listGatewayAdvertisedRoutes =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listGatewayAdvertisedRoutes(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listGatewayAdvertisedRoutes as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listGatewayAdvertisedRoutes as SinonStub
    ...
    it('invokes listGatewayAdvertisedRoutes without error using callback', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.listGatewayAdvertisedRoutes =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listGatewayAdvertisedRoutes(
          request,
          (
            err?: Error | null,
            result?:
    ...
    it('invokes listGatewayAdvertisedRoutes with error', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listGatewayAdvertisedRoutes = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listGatewayAdvertisedRoutes(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listGatewayAdvertisedRoutes as SinonStub
    ...
    it('invokes listGatewayAdvertisedRoutesStream without error', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      client.descriptors.page.listGatewayAdvertisedRoutes.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listGatewayAdvertisedRoutesStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.networkconnectivity.v1beta.GatewayAdvertisedRoute[] =
          [];
        stream.on(
          'data',
          (
            response: protos.google.cloud.networkconnectivity.v1beta.GatewayAdvertisedRoute,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (
          client.descriptors.page.listGatewayAdvertisedRoutes
    ...
    it('invokes listGatewayAdvertisedRoutesStream with error', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
    ...
    it('uses async iteration with listGatewayAdvertisedRoutes without error', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      client.descriptors.page.listGatewayAdvertisedRoutes.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.networkconnectivity.v1beta.IGatewayAdvertisedRoute[] =
        [];
      const iterable = client.listGatewayAdvertisedRoutesAsync(request);
      for await (const resource of iterable) {
        responses.push(resource!);
      }
      assert.deepStrictEqual(responses, expectedResponse);
    ...
    it('uses async iteration with listGatewayAdvertisedRoutes with error', async () => {
      const client = new hubserviceModule.v1beta.HubServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
