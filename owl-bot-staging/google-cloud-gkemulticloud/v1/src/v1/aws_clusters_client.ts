...
export class AwsClustersClient {
  ...
  initialize() {
    ...
    const awsClustersStubMethods =
        ['createAwsCluster', 'updateAwsCluster', 'getAwsCluster', 'listAwsClusters', 'deleteAwsCluster', 'generateAwsAccessToken', 'createAwsNodePool', 'updateAwsNodePool', 'getAwsNodePool', 'listAwsNodePools', 'deleteAwsNodePool', 'getAwsServerConfig'];
 ...
 *   The first element of the array is an object representing [AwsCluster]{@link google.cloud.gkemulticloud.v1.AwsCluster}.
 *   Please see the
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [GenerateAwsAccessTokenResponse]{@link google.cloud.gkemulticloud.v1.GenerateAwsAccessTokenResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 ...
 */
  ...
  generateAwsAccessToken(
    ...
    this.initialize();
    return this.innerApiCalls.generateAwsAccessToken(request, options, callback);
  }
/**
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [AwsNodePool]{@link google.cloud.gkemulticloud.v1.AwsNodePool}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [AwsServerConfig]{@link google.cloud.gkemulticloud.v1.AwsServerConfig}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 ...
 */
  async checkCreateAwsClusterProgress(name: string): Promise<LROperation<protos.google.cloud.gkemulticloud.v1.AwsCluster, protos.google.cloud.gkemulticloud.v1.OperationMetadata>>{
    ...
    const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.createAwsCluster, this._gaxModule.createDefaultBackoffSettings());
 ...
 */
  async checkUpdateAwsClusterProgress(name: string): Promise<LROperation<protos.google.cloud.gkemulticloud.v1.AwsCluster, protos.google.cloud.gkemulticloud.v1.OperationMetadata>>{
    const request = new operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.updateAwsCluster, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.gkemulticloud.v1.AwsCluster, protos.google.cloud.gkemulticloud.v1.OperationMetadata>;
  }
/**
 ...
 */
  async checkDeleteAwsClusterProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.gkemulticloud.v1.OperationMetadata>>{
    const request = new operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.deleteAwsCluster, this._gaxModule.createDefaultBackoffSettings());
 ...
 */
  async checkCreateAwsNodePoolProgress(name: string): Promise<LROperation<protos.google.cloud.gkemulticloud.v1.AwsNodePool, protos.google.cloud.gkemulticloud.v1.OperationMetadata>>{
    const request = new operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.createAwsNodePool, this._gaxModule.createDefaultBackoffSettings());
 ...
 */
  async checkUpdateAwsNodePoolProgress(name: string): Promise<LROperation<protos.google.cloud.gkemulticloud.v1.AwsNodePool, protos.google.cloud.gkemulticloud.v1.OperationMetadata>>{
    const request = new operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.updateAwsNodePool, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.gkemulticloud.v1.AwsNodePool, protos.google.cloud.gkemulticloud.v1.OperationMetadata>;
  }
/**
 ...
 */
  async checkDeleteAwsNodePoolProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.gkemulticloud.v1.OperationMetadata>>{
    const request = new operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.deleteAwsNodePool, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.protobuf.Empty, protos.google.cloud.gkemulticloud.v1.OperationMetadata>;
  }
 /**
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [AwsCluster]{@link google.cloud.gkemulticloud.v1.AwsCluster}.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [AwsCluster]{@link google.cloud.gkemulticloud.v1.AwsCluster} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   [AwsCluster]{@link google.cloud.gkemulticloud.v1.AwsCluster}. The API will be called under the hood as needed, once per the page,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [AwsNodePool]{@link google.cloud.gkemulticloud.v1.AwsNodePool}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [AwsNodePool]{@link google.cloud.gkemulticloud.v1.AwsNodePool} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed. Note that it can affect your quota.
 *   We recommend using `listAwsNodePoolsAsync()`
 *   method described below for async iteration which you can stop as needed.
 ...
 *   An iterable Object that allows [async iteration](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols).
 *   When you iterate the returned iterable, each element will be an object representing
 *   [AwsNodePool]{@link google.cloud.gkemulticloud.v1.AwsNodePool}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination)
 *   for more details and examples.
