...
export class AttachedClustersClient {
  ...
  initialize() {
    ...
    const attachedClustersStubMethods =
        ['createAttachedCluster', 'updateAttachedCluster', 'importAttachedCluster', 'getAttachedCluster', 'listAttachedClusters', 'deleteAttachedCluster', 'getAttachedServerConfig', 'generateAttachedClusterInstallManifest'];
 ...
 */
  ...
  getAttachedServerConfig(
    ...
    this.initialize();
    return this.innerApiCalls.getAttachedServerConfig(request, options, callback);
  }
/**
 ...
 */
  ...
  generateAttachedClusterInstallManifest(
    ...
    this.initialize();
    return this.innerApiCalls.generateAttachedClusterInstallManifest(request, options, callback);
  }
