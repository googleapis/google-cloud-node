...
describe('v1.AwsClustersClient', () => {
    ...
    describe('getAwsCluster', () => {
        it('invokes getAwsCluster without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.gkemulticloud.v1.GetAwsClusterRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.gkemulticloud.v1.AwsCluster());
            ...
            assert((client.innerApiCalls.getAwsCluster as SinonStub)
    ...
    describe('generateAwsAccessToken', () => {
        it('invokes generateAwsAccessToken without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.gkemulticloud.v1.GenerateAwsAccessTokenRequest());
            request.awsCluster = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.gkemulticloud.v1.GenerateAwsAccessTokenResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.generateAwsAccessToken as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('getAwsNodePool', () => {
        it('invokes getAwsNodePool without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.gkemulticloud.v1.GetAwsNodePoolRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.gkemulticloud.v1.AwsNodePool());
            client.innerApiCalls.getAwsNodePool = stubSimpleCall(expectedResponse);
            const [response] = await client.getAwsNodePool(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAwsNodePool as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('getAwsServerConfig', () => {
        it('invokes getAwsServerConfig without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.gkemulticloud.v1.AwsServerConfig());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAwsServerConfig as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('createAwsCluster', () => {
        it('invokes createAwsCluster without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.gkemulticloud.v1.CreateAwsClusterRequest());
            request.parent = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createAwsCluster as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateAwsCluster', () => {
        it('invokes updateAwsCluster without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.gkemulticloud.v1.UpdateAwsClusterRequest());
            request.awsCluster = {};
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateAwsCluster as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteAwsCluster', () => {
        it('invokes deleteAwsCluster without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.gkemulticloud.v1.DeleteAwsClusterRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteAwsCluster as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('createAwsNodePool', () => {
        it('invokes createAwsNodePool without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.gkemulticloud.v1.CreateAwsNodePoolRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createAwsNodePool as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateAwsNodePool', () => {
        it('invokes updateAwsNodePool without error', async () => {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateAwsNodePool as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteAwsNodePool', () => {
        it('invokes deleteAwsNodePool without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.gkemulticloud.v1.DeleteAwsNodePoolRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteAwsNodePool as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listAwsClusters', () => {
        it('invokes listAwsClusters without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listAwsClusters as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listAwsNodePools', () => {
        it('invokes listAwsNodePools without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.gkemulticloud.v1.ListAwsNodePoolsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listAwsNodePools as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
