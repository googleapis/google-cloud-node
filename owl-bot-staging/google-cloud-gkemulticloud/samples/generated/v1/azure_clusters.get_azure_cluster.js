...
function main(name) {
  // [START gkemulticloud_v1_generated_AzureClusters_GetAzureCluster_async]
  /**
  ...
  async function callGetAzureCluster() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await gkemulticloudClient.getAzureCluster(request);
