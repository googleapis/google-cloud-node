...
describe('v1.WorkflowsClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new workflowsModule.v1.WorkflowsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'workflows.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new workflowsModule.v1.WorkflowsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'workflows.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new workflowsModule.v1.WorkflowsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new workflowsModule.v1.WorkflowsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getWorkflow', () => {
        it('invokes getWorkflow without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.workflows.v1.GetWorkflowRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getWorkflow as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getWorkflow as SinonStub)
        ...
        it('invokes getWorkflow without error using callback', async () => {
            ...
            client.innerApiCalls.getWorkflow = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getWorkflow(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.workflows.v1.IWorkflow|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getWorkflow with error', async () => {
            ...
            client.innerApiCalls.getWorkflow = stubSimpleCall(undefined, expectedError);
    ...
    describe('createWorkflow', () => {
        it('invokes createWorkflow without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.workflows.v1.CreateWorkflowRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createWorkflow = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createWorkflow(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createWorkflow as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createWorkflow as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createWorkflow without error using callback', async () => {
            ...
            client.innerApiCalls.createWorkflow = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createWorkflow(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.workflows.v1.IWorkflow, protos.google.cloud.workflows.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.workflows.v1.IWorkflow, protos.google.cloud.workflows.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createWorkflow as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createWorkflow with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createWorkflow = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes createWorkflow with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createWorkflow = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createWorkflow(request);
        ...
        it('invokes checkCreateWorkflowProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateWorkflowProgress(expectedResponse.name);
        ...
        it('invokes checkCreateWorkflowProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreateWorkflowProgress(''), expectedError);
    ...
    describe('deleteWorkflow', () => {
        it('invokes deleteWorkflow without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.workflows.v1.DeleteWorkflowRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteWorkflow = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteWorkflow(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteWorkflow as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteWorkflow as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteWorkflow without error using callback', async () => {
            ...
            client.innerApiCalls.deleteWorkflow = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteWorkflow(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.workflows.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.workflows.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteWorkflow as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes deleteWorkflow with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteWorkflow = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes deleteWorkflow with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteWorkflow = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteWorkflow(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteWorkflow as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteWorkflowProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteWorkflowProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteWorkflowProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteWorkflowProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('updateWorkflow', () => {
        it('invokes updateWorkflow without error', async () => {
            ...
            request.workflow ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.workflows.v1.UpdateWorkflowRequest', ['workflow', 'name']);
            request.workflow.name = defaultValue1;
            const expectedHeaderRequestParams = `workflow.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updateWorkflow = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateWorkflow(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateWorkflow as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateWorkflow as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateWorkflow without error using callback', async () => {
            ...
            client.innerApiCalls.updateWorkflow = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateWorkflow with call error', async () => {
            ...
            const expectedHeaderRequestParams = `workflow.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateWorkflow = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes updateWorkflow with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `workflow.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateWorkflow = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateWorkflow(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateWorkflow as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateWorkflowProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateWorkflowProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateWorkflowProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateWorkflowProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listWorkflows', () => {
        it('invokes listWorkflows without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.workflows.v1.ListWorkflowsRequest', ['parent']);
            request.parent = defaultValue1;
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listWorkflows as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listWorkflows as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listWorkflows without error using callback', async () => {
            ...
            client.innerApiCalls.listWorkflows = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listWorkflows with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listWorkflows = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listWorkflowsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.workflows.v1.Workflow) => {
            ...
            assert((client.descriptors.page.listWorkflows.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listWorkflows, request));
            assert(
        ...
        it('invokes listWorkflowsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listWorkflows.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listWorkflowsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.workflows.v1.Workflow[] = [];
                stream.on('data', (response: protos.google.cloud.workflows.v1.Workflow) => {
        ...
        it('uses async iteration with listWorkflows without error', async () => {
            ...
            client.descriptors.page.listWorkflows.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listWorkflows with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listWorkflows.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listWorkflowsAsync(request);
    ...
    describe('listWorkflowRevisions', () => {
        it('invokes listWorkflowRevisions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.workflows.v1.ListWorkflowRevisionsRequest', ['name']);
            request.name = defaultValue1;
            ...
            client.innerApiCalls.listWorkflowRevisions = stubSimpleCall(expectedResponse);
            const [response] = await client.listWorkflowRevisions(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listWorkflowRevisions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listWorkflowRevisions as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listWorkflowRevisions without error using callback', async () => {
            ...
            client.innerApiCalls.listWorkflowRevisions = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listWorkflowRevisions with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listWorkflowRevisions = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listWorkflowRevisions(request), expectedError);
            const actualRequest = (client.innerApiCalls.listWorkflowRevisions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listWorkflowRevisions as SinonStub)
        ...
        it('invokes listWorkflowRevisionsStream without error', async () => {
            ...
            client.descriptors.page.listWorkflowRevisions.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listWorkflowRevisions.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listWorkflowRevisions, request));
            assert(
                (client.descriptors.page.listWorkflowRevisions.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listWorkflowRevisionsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listWorkflowRevisions.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listWorkflowRevisionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.workflows.v1.Workflow[] = [];
                stream.on('data', (response: protos.google.cloud.workflows.v1.Workflow) => {
        ...
        it('uses async iteration with listWorkflowRevisions without error', async () => {
            ...
            client.descriptors.page.listWorkflowRevisions.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.workflows.v1.IWorkflow[] = [];
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listWorkflowRevisions.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listWorkflowRevisions.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listWorkflowRevisions with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listWorkflowRevisions.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listWorkflowRevisionsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.workflows.v1.IWorkflow[] = [];
                for await (const resource of iterable) {
