...
export class ManagedKafkaClient {
  ...
  initialize() {
    ...
    const managedKafkaStubMethods =
        ['listClusters', 'getCluster', 'createCluster', 'updateCluster', 'deleteCluster', 'listTopics', 'getTopic', 'createTopic', 'updateTopic', 'deleteTopic', 'listConsumerGroups', 'getConsumerGroup', 'updateConsumerGroup', 'deleteConsumerGroup'];
