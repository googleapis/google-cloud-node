...
function main(acl, aclEntry) {
  // [START managedkafka_v1_generated_ManagedKafka_RemoveAclEntry_async]
  /**
  ...
  async function callRemoveAclEntry() {
    // Construct request
    const request = {
      acl,
      aclEntry,
    ...
    // Run request
    const response = await managedkafkaClient.removeAclEntry(request);
