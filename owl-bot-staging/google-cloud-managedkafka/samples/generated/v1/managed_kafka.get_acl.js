...
function main(name) {
  // [START managedkafka_v1_generated_ManagedKafka_GetAcl_async]
  /**
  ...
  async function callGetAcl() {
    ...
    // Run request
    const response = await managedkafkaClient.getAcl(request);
    console.log(response);
  }

  callGetAcl();
  // [END managedkafka_v1_generated_ManagedKafka_GetAcl_async]
}
