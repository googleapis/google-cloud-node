...
describe('v1.ManagedKafkaConnectClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = managedkafkaconnectModule.v1.ManagedKafkaConnectClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = managedkafkaconnectModule.v1.ManagedKafkaConnectClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'managedkafka.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new managedkafkaconnectModule.v1.ManagedKafkaConnectClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'managedkafka.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new managedkafkaconnectModule.v1.ManagedKafkaConnectClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'managedkafka.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new managedkafkaconnectModule.v1.ManagedKafkaConnectClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new managedkafkaconnectModule.v1.ManagedKafkaConnectClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getConnectCluster', () => {
        it('invokes getConnectCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.managedkafka.v1.GetConnectClusterRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getConnectCluster as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getConnectCluster as SinonStub)
        ...
        it('invokes getConnectCluster without error using callback', async () => {
            ...
            client.innerApiCalls.getConnectCluster = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getConnectCluster(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.managedkafka.v1.IConnectCluster|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getConnectCluster with error', async () => {
            ...
            client.innerApiCalls.getConnectCluster = stubSimpleCall(undefined, expectedError);
    ...
    describe('getConnector', () => {
        it('invokes getConnector without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.managedkafka.v1.GetConnectorRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getConnector without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getConnector(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.managedkafka.v1.IConnector|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createConnector', () => {
        it('invokes createConnector without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.managedkafka.v1.CreateConnectorRequest', ['parent']);
        ...
        it('invokes createConnector without error using callback', async () => {
            ...
            client.innerApiCalls.createConnector = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createConnector with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createConnector = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateConnector', () => {
        it('invokes updateConnector without error', async () => {
            ...
            request.connector ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.managedkafka.v1.UpdateConnectorRequest', ['connector', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateConnector as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateConnector as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateConnector without error using callback', async () => {
            ...
            client.innerApiCalls.updateConnector = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateConnector with error', async () => {
            ...
            const expectedHeaderRequestParams = `connector.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateConnector = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteConnector', () => {
        it('invokes deleteConnector without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.managedkafka.v1.DeleteConnectorRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes deleteConnector without error using callback', async () => {
            ...
            client.innerApiCalls.deleteConnector = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteConnector with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteConnector = stubSimpleCall(undefined, expectedError);
    ...
    describe('pauseConnector', () => {
        it('invokes pauseConnector without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.managedkafka.v1.PauseConnectorRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.pauseConnector as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.pauseConnector as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes pauseConnector without error using callback', async () => {
            ...
            client.innerApiCalls.pauseConnector = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.pauseConnector(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.managedkafka.v1.IPauseConnectorResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes pauseConnector with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.pauseConnector = stubSimpleCall(undefined, expectedError);
    ...
    describe('resumeConnector', () => {
        it('invokes resumeConnector without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.managedkafka.v1.ResumeConnectorRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.resumeConnector as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.resumeConnector as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes resumeConnector without error using callback', async () => {
            ...
            client.innerApiCalls.resumeConnector = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.resumeConnector(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.managedkafka.v1.IResumeConnectorResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes resumeConnector with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.resumeConnector = stubSimpleCall(undefined, expectedError);
    ...
    describe('restartConnector', () => {
        it('invokes restartConnector without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.managedkafka.v1.RestartConnectorRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.restartConnector as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.restartConnector as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes restartConnector without error using callback', async () => {
            ...
            client.innerApiCalls.restartConnector = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.restartConnector(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.managedkafka.v1.IRestartConnectorResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes restartConnector with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.restartConnector = stubSimpleCall(undefined, expectedError);
    ...
    describe('stopConnector', () => {
        it('invokes stopConnector without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.managedkafka.v1.StopConnectorRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.stopConnector as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.stopConnector as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes stopConnector without error using callback', async () => {
            ...
            client.innerApiCalls.stopConnector = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.stopConnector(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.managedkafka.v1.IStopConnectorResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes stopConnector with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.stopConnector = stubSimpleCall(undefined, expectedError);
    ...
    describe('createConnectCluster', () => {
        it('invokes createConnectCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.managedkafka.v1.CreateConnectClusterRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createConnectCluster = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createConnectCluster(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createConnectCluster as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createConnectCluster as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createConnectCluster without error using callback', async () => {
            ...
            client.innerApiCalls.createConnectCluster = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createConnectCluster(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.managedkafka.v1.IConnectCluster, protos.google.cloud.managedkafka.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.managedkafka.v1.IConnectCluster, protos.google.cloud.managedkafka.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createConnectCluster as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createConnectCluster with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createConnectCluster = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes createConnectCluster with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createConnectCluster = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createConnectCluster(request);
        ...
        it('invokes checkCreateConnectClusterProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateConnectClusterProgress(expectedResponse.name);
        ...
        it('invokes checkCreateConnectClusterProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreateConnectClusterProgress(''), expectedError);
    ...
    describe('updateConnectCluster', () => {
        it('invokes updateConnectCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.managedkafka.v1.UpdateConnectClusterRequest', ['connectCluster', 'name']);
            request.connectCluster.name = defaultValue1;
            const expectedHeaderRequestParams = `connect_cluster.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updateConnectCluster = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateConnectCluster(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateConnectCluster as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateConnectCluster as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateConnectCluster without error using callback', async () => {
            ...
            client.innerApiCalls.updateConnectCluster = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateConnectCluster with call error', async () => {
            ...
            const expectedHeaderRequestParams = `connect_cluster.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateConnectCluster = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes updateConnectCluster with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `connect_cluster.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateConnectCluster = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateConnectCluster(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateConnectCluster as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateConnectClusterProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateConnectClusterProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateConnectClusterProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateConnectClusterProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteConnectCluster', () => {
        it('invokes deleteConnectCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.managedkafka.v1.DeleteConnectClusterRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteConnectCluster = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteConnectCluster(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteConnectCluster as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteConnectCluster as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteConnectCluster without error using callback', async () => {
            ...
            client.innerApiCalls.deleteConnectCluster = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteConnectCluster with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteConnectCluster = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes deleteConnectCluster with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteConnectCluster = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteConnectCluster(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteConnectCluster as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteConnectClusterProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteConnectClusterProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteConnectClusterProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteConnectClusterProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listConnectClusters', () => {
        it('invokes listConnectClusters without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.managedkafka.v1.ListConnectClustersRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.managedkafka.v1.ConnectCluster()),
              generateSampleMessage(new protos.google.cloud.managedkafka.v1.ConnectCluster()),
              generateSampleMessage(new protos.google.cloud.managedkafka.v1.ConnectCluster()),
            ];
            client.innerApiCalls.listConnectClusters = stubSimpleCall(expectedResponse);
            const [response] = await client.listConnectClusters(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listConnectClusters as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listConnectClusters as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listConnectClusters without error using callback', async () => {
            ...
            client.innerApiCalls.listConnectClusters = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listConnectClusters with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listConnectClusters = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listConnectClustersStream without error', async () => {
            ...
            client.descriptors.page.listConnectClusters.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listConnectClustersStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.managedkafka.v1.ConnectCluster[] = [];
                stream.on('data', (response: protos.google.cloud.managedkafka.v1.ConnectCluster) => {
            ...
            assert((client.descriptors.page.listConnectClusters.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listConnectClusters, request));
            assert(
        ...
        it('invokes listConnectClustersStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listConnectClusters.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listConnectClustersStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.managedkafka.v1.ConnectCluster[] = [];
                stream.on('data', (response: protos.google.cloud.managedkafka.v1.ConnectCluster) => {
        ...
        it('uses async iteration with listConnectClusters without error', async () => {
            ...
            client.descriptors.page.listConnectClusters.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listConnectClusters with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listConnectClusters.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listConnectClustersAsync(request);
    ...
    describe('listConnectors', () => {
        it('invokes listConnectors without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.managedkafka.v1.ListConnectorsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.managedkafka.v1.Connector()),
              generateSampleMessage(new protos.google.cloud.managedkafka.v1.Connector()),
              generateSampleMessage(new protos.google.cloud.managedkafka.v1.Connector()),
            ];
        ...
        it('invokes listConnectorsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.managedkafka.v1.Connector) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
