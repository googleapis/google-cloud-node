...
function main(name) {
  // [START managedkafka_v1_generated_ManagedSchemaRegistry_DeleteSchemaMode_async]
  /**
  ...
  async function callDeleteSchemaMode() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await schemaregistryClient.deleteSchemaMode(request);
    console.log(response);
  }

  callDeleteSchemaMode();
  // [END managedkafka_v1_generated_ManagedSchemaRegistry_DeleteSchemaMode_async]
}
