...
describe('v1.BudgetServiceClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new budgetserviceModule.v1.BudgetServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'billingbudgets.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new budgetserviceModule.v1.BudgetServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'billingbudgets.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new budgetserviceModule.v1.BudgetServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new budgetserviceModule.v1.BudgetServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createBudget', () => {
        it('invokes createBudget without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.billing.budgets.v1.CreateBudgetRequest', ['parent']);
    ...
    describe('updateBudget', () => {
        it('invokes updateBudget without error', async () => {
            ...
            request.budget ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.billing.budgets.v1.UpdateBudgetRequest', ['budget', 'name']);
    ...
    describe('getBudget', () => {
        it('invokes getBudget without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.billing.budgets.v1.GetBudgetRequest', ['name']);
    ...
    describe('deleteBudget', () => {
        it('invokes deleteBudget without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.billing.budgets.v1.DeleteBudgetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listBudgets', () => {
        it('invokes listBudgets without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.billing.budgets.v1.ListBudgetsRequest', ['parent']);
            request.parent = defaultValue1;
