...
export class BudgetServiceClient {
  ...
  private _log = logging.log('billing-budgets');
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._servicePath = 'billingbudgets.' + this._universeDomain;
 ...
 *   The first element of the array is an object representing {@link protos.google.cloud.billing.budgets.v1.Budget|Budget}.
  ...
  createBudget(
    ...
    const wrappedCallback: Callback<
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('createBudget response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.createBudget(request, options, wrappedCallback)
 ...
 */
  ...
  updateBudget(
    ...
    const wrappedCallback: Callback<
        ...
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('updateBudget response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.updateBudget(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.billing.budgets.v1.IBudget,
 ...
 */
  ...
  getBudget(
    ...
    const wrappedCallback: Callback<
        ...
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('getBudget response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.getBudget(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.billing.budgets.v1.IBudget,
 ...
 */
  ...
  deleteBudget(
    ...
    const wrappedCallback: Callback<
        ...
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('deleteBudget response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.deleteBudget(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.protobuf.IEmpty,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.cloud.billing.budgets.v1.Budget|Budget}.
 ...
 */
  ...
  listBudgets(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.billing.budgets.v1.IListBudgetsRequest,
      protos.google.cloud.billing.budgets.v1.IListBudgetsResponse|null|undefined,
      protos.google.cloud.billing.budgets.v1.IBudget>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listBudgets values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listBudgets request %j', request);
    return this.innerApiCalls
      .listBudgets(request, options, wrappedCallback)
      ?.then(([response, input, output]: [
        protos.google.cloud.billing.budgets.v1.IBudget[],
        protos.google.cloud.billing.budgets.v1.IListBudgetsRequest|null,
        protos.google.cloud.billing.budgets.v1.IListBudgetsResponse
      ]) => {
        this._log.info('listBudgets values %j', response);
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.cloud.billing.budgets.v1.Budget|Budget} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   {@link protos.google.cloud.billing.budgets.v1.Budget|Budget}. The API will be called under the hood as needed, once per the page,
