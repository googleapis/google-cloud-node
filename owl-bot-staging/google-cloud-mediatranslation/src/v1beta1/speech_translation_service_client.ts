...
export class SpeechTranslationServiceClient {
  ...
  private _log = logging.log('media-translation');
   ...
   *     const client = new SpeechTranslationServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(
    opts?: ClientOptions,
    ...
    this._universeDomain =
      ...
      'googleapis.com';
    this._servicePath = 'mediatranslation.' + this._universeDomain;
    const servicePath =
   ...
   */
  close(): Promise<void> {
    if (this.speechTranslationServiceStub && !this._terminated) {
