...
describe('v1.BinauthzManagementServiceV1Client', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new binauthzmanagementservicev1Module.v1.BinauthzManagementServiceV1Client();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = binauthzmanagementservicev1Module.v1.BinauthzManagementServiceV1Client.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = binauthzmanagementservicev1Module.v1.BinauthzManagementServiceV1Client.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'binaryauthorization.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new binauthzmanagementservicev1Module.v1.BinauthzManagementServiceV1Client({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'binaryauthorization.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new binauthzmanagementservicev1Module.v1.BinauthzManagementServiceV1Client({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'binaryauthorization.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new binauthzmanagementservicev1Module.v1.BinauthzManagementServiceV1Client({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
                    assert.strictEqual(servicePath, 'binaryauthorization.configured.example.com');
                    if (saved) {
                        process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = saved;
                    } else {
                        delete process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new binauthzmanagementservicev1Module.v1.BinauthzManagementServiceV1Client({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = binauthzmanagementservicev1Module.v1.BinauthzManagementServiceV1Client.port;
            assert(port);
    ...
    describe('getPolicy', () => {
        it('invokes getPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.binaryauthorization.v1.GetPolicyRequest', ['name']);
        ...
        it('invokes getPolicy without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getPolicy(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.binaryauthorization.v1.IPolicy|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updatePolicy', () => {
        it('invokes updatePolicy without error', async () => {
            ...
            request.policy ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.binaryauthorization.v1.UpdatePolicyRequest', ['policy', 'name']);
    ...
    describe('createAttestor', () => {
        it('invokes createAttestor without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.binaryauthorization.v1.CreateAttestorRequest', ['parent']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createAttestor as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createAttestor as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createAttestor without error using callback', async () => {
            ...
            client.innerApiCalls.createAttestor = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createAttestor(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.binaryauthorization.v1.IAttestor|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createAttestor with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createAttestor = stubSimpleCall(undefined, expectedError);
    ...
    describe('getAttestor', () => {
        it('invokes getAttestor without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.binaryauthorization.v1.GetAttestorRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.binaryauthorization.v1.Attestor()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getAttestor as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getAttestor as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getAttestor without error using callback', async () => {
            ...
            client.innerApiCalls.getAttestor = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAttestor(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.binaryauthorization.v1.IAttestor|null) => {
        ...
        it('invokes getAttestor with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getAttestor = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateAttestor', () => {
        it('invokes updateAttestor without error', async () => {
            ...
            request.attestor ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.binaryauthorization.v1.UpdateAttestorRequest', ['attestor', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateAttestor as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateAttestor as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateAttestor without error using callback', async () => {
            ...
            client.innerApiCalls.updateAttestor = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateAttestor with error', async () => {
            ...
            const expectedHeaderRequestParams = `attestor.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateAttestor = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteAttestor', () => {
        it('invokes deleteAttestor without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.binaryauthorization.v1.DeleteAttestorRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteAttestor as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteAttestor as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteAttestor without error using callback', async () => {
            ...
            client.innerApiCalls.deleteAttestor = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteAttestor with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteAttestor = stubSimpleCall(undefined, expectedError);
    ...
    describe('listAttestors', () => {
        it('invokes listAttestors without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.binaryauthorization.v1.ListAttestorsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.binaryauthorization.v1.Attestor()),
              generateSampleMessage(new protos.google.cloud.binaryauthorization.v1.Attestor()),
              generateSampleMessage(new protos.google.cloud.binaryauthorization.v1.Attestor()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listAttestors as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAttestors as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listAttestors without error using callback', async () => {
            ...
            client.innerApiCalls.listAttestors = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listAttestors with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listAttestors = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listAttestorsStream without error', async () => {
            ...
            client.descriptors.page.listAttestors.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listAttestorsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.binaryauthorization.v1.Attestor[] = [];
                stream.on('data', (response: protos.google.cloud.binaryauthorization.v1.Attestor) => {
            ...
            assert((client.descriptors.page.listAttestors.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listAttestors, request));
            assert(
        ...
        it('invokes listAttestorsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAttestors.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listAttestorsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.binaryauthorization.v1.Attestor[] = [];
                stream.on('data', (response: protos.google.cloud.binaryauthorization.v1.Attestor) => {
        ...
        it('uses async iteration with listAttestors without error', async () => {
            ...
            client.descriptors.page.listAttestors.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listAttestors with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAttestors.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listAttestorsAsync(request);
    ...
    describe('Path templates', () => {
        ...
        describe('attestor', () => {
            ...
            client.initialize();
            client.pathTemplates.attestorPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.attestorPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('attestorPath', () => {
                const result = client.attestorPath("projectValue", "attestorValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.attestorPathTemplate.render as SinonStub)
            ...
            it('matchProjectFromAttestorName', () => {
                ...
                assert((client.pathTemplates.attestorPathTemplate.match as SinonStub)
        ...
        describe('locationPolicy', () => {
            ...
            client.initialize();
            client.pathTemplates.locationPolicyPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.locationPolicyPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('locationPolicyPath', () => {
                const result = client.locationPolicyPath("locationValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.locationPolicyPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchLocationFromLocationPolicyName', () => {
                ...
                assert((client.pathTemplates.locationPolicyPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
