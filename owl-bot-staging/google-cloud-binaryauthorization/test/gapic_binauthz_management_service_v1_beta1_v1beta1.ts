...
describe('v1beta1.BinauthzManagementServiceV1Beta1Client', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = binauthzmanagementservicev1beta1Module.v1beta1.BinauthzManagementServiceV1Beta1Client.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = binauthzmanagementservicev1beta1Module.v1beta1.BinauthzManagementServiceV1Beta1Client.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'binaryauthorization.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new binauthzmanagementservicev1beta1Module.v1beta1.BinauthzManagementServiceV1Beta1Client({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'binaryauthorization.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new binauthzmanagementservicev1beta1Module.v1beta1.BinauthzManagementServiceV1Beta1Client({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'binaryauthorization.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new binauthzmanagementservicev1beta1Module.v1beta1.BinauthzManagementServiceV1Beta1Client({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new binauthzmanagementservicev1beta1Module.v1beta1.BinauthzManagementServiceV1Beta1Client({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = binauthzmanagementservicev1beta1Module.v1beta1.BinauthzManagementServiceV1Beta1Client.port;
            assert(port);
    ...
    describe('getPolicy', () => {
        it('invokes getPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.binaryauthorization.v1beta1.GetPolicyRequest', ['name']);
        ...
        it('invokes getPolicy without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getPolicy(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.binaryauthorization.v1beta1.IPolicy|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updatePolicy', () => {
        it('invokes updatePolicy without error', async () => {
            ...
            request.policy ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.binaryauthorization.v1beta1.UpdatePolicyRequest', ['policy', 'name']);
    ...
    describe('createAttestor', () => {
        it('invokes createAttestor without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.binaryauthorization.v1beta1.CreateAttestorRequest', ['parent']);
        ...
        it('invokes createAttestor without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createAttestor(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.binaryauthorization.v1beta1.IAttestor|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getAttestor', () => {
        it('invokes getAttestor without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.binaryauthorization.v1beta1.GetAttestorRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.binaryauthorization.v1beta1.Attestor()
    ...
    describe('updateAttestor', () => {
        it('invokes updateAttestor without error', async () => {
            ...
            request.attestor ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.binaryauthorization.v1beta1.UpdateAttestorRequest', ['attestor', 'name']);
    ...
    describe('deleteAttestor', () => {
        it('invokes deleteAttestor without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.binaryauthorization.v1beta1.DeleteAttestorRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listAttestors', () => {
        it('invokes listAttestors without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.binaryauthorization.v1beta1.ListAttestorsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.binaryauthorization.v1beta1.Attestor()),
              generateSampleMessage(new protos.google.cloud.binaryauthorization.v1beta1.Attestor()),
              generateSampleMessage(new protos.google.cloud.binaryauthorization.v1beta1.Attestor()),
            ];
        ...
        it('invokes listAttestorsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.binaryauthorization.v1beta1.Attestor) => {
