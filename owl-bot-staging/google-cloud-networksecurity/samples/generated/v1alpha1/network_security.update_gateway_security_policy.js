...
function main(gatewaySecurityPolicy) {
  ...
  async function callUpdateGatewaySecurityPolicy() {
    // Construct request
    const request = {
    ...
    // Run request
    const [operation] = await networksecurityClient.updateGatewaySecurityPolicy(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callUpdateGatewaySecurityPolicy();
  // [END networksecurity_v1alpha1_generated_NetworkSecurity_UpdateGatewaySecurityPolicy_async]
}
