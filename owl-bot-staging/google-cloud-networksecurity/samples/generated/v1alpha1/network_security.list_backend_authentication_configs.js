...
function main(parent) {
  ...
  async function callListBackendAuthenticationConfigs() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = networksecurityClient.listBackendAuthenticationConfigsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListBackendAuthenticationConfigs();
  // [END networksecurity_v1alpha1_generated_NetworkSecurity_ListBackendAuthenticationConfigs_async]
}
