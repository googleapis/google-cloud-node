...
function main(parent) {
  ...
  async function callListGatewaySecurityPolicyRules() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = networksecurityClient.listGatewaySecurityPolicyRulesAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListGatewaySecurityPolicyRules();
  // [END networksecurity_v1alpha1_generated_NetworkSecurity_ListGatewaySecurityPolicyRules_async]
}
