...
function main(name) {
  // [START networksecurity_v1alpha1_generated_NetworkSecurity_DeleteTlsInspectionPolicy_async]
  /**
  ...
  async function callDeleteTlsInspectionPolicy() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const [operation] = await networksecurityClient.deleteTlsInspectionPolicy(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callDeleteTlsInspectionPolicy();
  // [END networksecurity_v1alpha1_generated_NetworkSecurity_DeleteTlsInspectionPolicy_async]
}
