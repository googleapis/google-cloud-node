...
function main(parent) {
  // [START networksecurity_v1alpha1_generated_NetworkSecurity_ListClientTlsPolicies_async]
  /**
  ...
  async function callListClientTlsPolicies() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = networksecurityClient.listClientTlsPoliciesAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListClientTlsPolicies();
  // [END networksecurity_v1alpha1_generated_NetworkSecurity_ListClientTlsPolicies_async]
}
