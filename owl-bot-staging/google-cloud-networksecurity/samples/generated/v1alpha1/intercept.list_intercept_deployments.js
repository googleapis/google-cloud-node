...
function main(parent) {
  ...
  async function callListInterceptDeployments() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = networksecurityClient.listInterceptDeploymentsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListInterceptDeployments();
  // [END networksecurity_v1alpha1_generated_Intercept_ListInterceptDeployments_async]
}
