...
function main(name) {
  ...
  async function callDeleteAuthzPolicy() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const [operation] = await networksecurityClient.deleteAuthzPolicy(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callDeleteAuthzPolicy();
  // [END networksecurity_v1alpha1_generated_NetworkSecurity_DeleteAuthzPolicy_async]
}
