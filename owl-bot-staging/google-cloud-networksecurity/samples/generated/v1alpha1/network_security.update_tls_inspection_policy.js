...
function main(tlsInspectionPolicy) {
  ...
  async function callUpdateTlsInspectionPolicy() {
    // Construct request
    const request = {
      tlsInspectionPolicy,
    };
    ...
    // Run request
    const [operation] = await networksecurityClient.updateTlsInspectionPolicy(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callUpdateTlsInspectionPolicy();
