...
function main(parent, interceptEndpointGroupAssociation) {
   ...
   */
  // const interceptEndpointGroupAssociationId = 'abc123'
  /**
  ...
  async function callCreateInterceptEndpointGroupAssociation() {
    // Construct request
    const request = {
      parent,
    ...
    // Run request
    const [operation] = await networksecurityClient.createInterceptEndpointGroupAssociation(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callCreateInterceptEndpointGroupAssociation();
  // [END networksecurity_v1alpha1_generated_Intercept_CreateInterceptEndpointGroupAssociation_async]
}
