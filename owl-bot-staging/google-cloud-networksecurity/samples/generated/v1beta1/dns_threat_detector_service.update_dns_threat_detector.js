...
function main(dnsThreatDetector) {
  ...
  const {DnsThreatDetectorServiceClient} = require('@google-cloud/network-security').v1beta1;
  ...
  // [END networksecurity_v1beta1_generated_DnsThreatDetectorService_UpdateDnsThreatDetector_async]
}
