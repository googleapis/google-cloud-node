...
describe('v1.OrganizationSecurityProfileGroupServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new organizationsecurityprofilegroupserviceModule.v1.OrganizationSecurityProfileGroupServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          organizationsecurityprofilegroupserviceModule.v1
            .OrganizationSecurityProfileGroupServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        ...
        const apiEndpoint =
          organizationsecurityprofilegroupserviceModule.v1
            .OrganizationSecurityProfileGroupServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'networksecurity.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        organizationsecurityprofilegroupserviceModule.v1
          .OrganizationSecurityProfileGroupServiceClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(
        client.organizationSecurityProfileGroupServiceStub,
        undefined,
      );
  ...
  describe('getSecurityProfileGroup', () => {
    it('invokes getSecurityProfileGroup without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.GetSecurityProfileGroupRequest(),
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.SecurityProfileGroup(),
      );
      ...
      const actualRequest = (
        client.innerApiCalls.getSecurityProfileGroup as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getSecurityProfileGroup without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getSecurityProfileGroup(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1.ISecurityProfileGroup | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getSecurityProfileGroup with error', async () => {
      ...
      client.innerApiCalls.getSecurityProfileGroup = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getSecurityProfileGroup(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getSecurityProfileGroup as SinonStub
  ...
  describe('getSecurityProfile', () => {
    it('invokes getSecurityProfile without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.GetSecurityProfileRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.SecurityProfile(),
      );
      client.innerApiCalls.getSecurityProfile =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getSecurityProfile(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getSecurityProfile as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getSecurityProfile as SinonStub
    ...
    it('invokes getSecurityProfile without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getSecurityProfile(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1.ISecurityProfile | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getSecurityProfile with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getSecurityProfile = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createSecurityProfileGroup', () => {
    it('invokes createSecurityProfileGroup without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.CreateSecurityProfileGroupRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.createSecurityProfileGroup =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createSecurityProfileGroup(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createSecurityProfileGroup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createSecurityProfileGroup as SinonStub
    ...
    it('invokes createSecurityProfileGroup with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createSecurityProfileGroup = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createSecurityProfileGroup(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createSecurityProfileGroup as SinonStub
    ...
    it('invokes checkCreateSecurityProfileGroupProgress without error', async () => {
      ...
      const decodedOperation =
        await client.checkCreateSecurityProfileGroupProgress(
    ...
    it('invokes checkCreateSecurityProfileGroupProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateSecurityProfileGroupProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateSecurityProfileGroup', () => {
    it('invokes updateSecurityProfileGroup without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.UpdateSecurityProfileGroupRequest(),
      );
      ...
      client.innerApiCalls.updateSecurityProfileGroup =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateSecurityProfileGroup(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateSecurityProfileGroup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateSecurityProfileGroup as SinonStub
    ...
    it('invokes updateSecurityProfileGroup with call error', async () => {
      ...
      const expectedHeaderRequestParams = `security_profile_group.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateSecurityProfileGroup = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateSecurityProfileGroup(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateSecurityProfileGroup as SinonStub
    ...
    it('invokes checkUpdateSecurityProfileGroupProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkUpdateSecurityProfileGroupProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('deleteSecurityProfileGroup', () => {
    it('invokes deleteSecurityProfileGroup without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.DeleteSecurityProfileGroupRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.deleteSecurityProfileGroup =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteSecurityProfileGroup(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteSecurityProfileGroup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteSecurityProfileGroup as SinonStub
    ...
    it('invokes deleteSecurityProfileGroup with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteSecurityProfileGroup = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteSecurityProfileGroup(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteSecurityProfileGroup as SinonStub
    ...
    it('invokes checkDeleteSecurityProfileGroupProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkDeleteSecurityProfileGroupProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkDeleteSecurityProfileGroupProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteSecurityProfileGroupProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createSecurityProfile', () => {
    it('invokes createSecurityProfile without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.CreateSecurityProfileRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.createSecurityProfile =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createSecurityProfile(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createSecurityProfile as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createSecurityProfile as SinonStub
    ...
    it('invokes createSecurityProfile with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createSecurityProfile = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createSecurityProfile(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createSecurityProfile as SinonStub
    ...
    it('invokes checkCreateSecurityProfileProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateSecurityProfileProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateSecurityProfile', () => {
    it('invokes updateSecurityProfile without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.UpdateSecurityProfileRequest(),
      );
      ...
      client.innerApiCalls.updateSecurityProfile =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateSecurityProfile(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateSecurityProfile as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateSecurityProfile as SinonStub
    ...
    it('invokes updateSecurityProfile with call error', async () => {
      ...
      const expectedHeaderRequestParams = `security_profile.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateSecurityProfile = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateSecurityProfile(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateSecurityProfile as SinonStub
    ...
    it('invokes checkUpdateSecurityProfileProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateSecurityProfileProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteSecurityProfile', () => {
    it('invokes deleteSecurityProfile without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.DeleteSecurityProfileRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.deleteSecurityProfile =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteSecurityProfile(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteSecurityProfile as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteSecurityProfile as SinonStub
    ...
    it('invokes deleteSecurityProfile with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteSecurityProfile = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteSecurityProfile(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteSecurityProfile as SinonStub
    ...
    it('invokes checkDeleteSecurityProfileProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteSecurityProfileProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listSecurityProfileGroups', () => {
    it('invokes listSecurityProfileGroups without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.ListSecurityProfileGroupsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.listSecurityProfileGroups =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listSecurityProfileGroups(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listSecurityProfileGroups as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listSecurityProfileGroups as SinonStub
    ...
    it('invokes listSecurityProfileGroups with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listSecurityProfileGroups = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listSecurityProfileGroups(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listSecurityProfileGroups as SinonStub
    ...
    it('invokes listSecurityProfileGroupsStream without error', async () => {
      ...
      client.descriptors.page.listSecurityProfileGroups.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listSecurityProfileGroupsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.networksecurity.v1.SecurityProfileGroup[] =
          [];
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1.SecurityProfileGroup,
          ) => {
      ...
      assert(
        (
          client.descriptors.page.listSecurityProfileGroups
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listSecurityProfileGroups, request),
      );
      assert(
        (
          client.descriptors.page.listSecurityProfileGroups
    ...
    it('uses async iteration with listSecurityProfileGroups without error', async () => {
      ...
      client.descriptors.page.listSecurityProfileGroups.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.networksecurity.v1.ISecurityProfileGroup[] =
        [];
  ...
  describe('listSecurityProfiles', () => {
    it('invokes listSecurityProfiles without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.ListSecurityProfilesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listSecurityProfiles as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listSecurityProfiles as SinonStub
    ...
    it('invokes listSecurityProfiles with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listSecurityProfiles = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listSecurityProfilesStream without error', async () => {
      ...
      client.descriptors.page.listSecurityProfiles.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listSecurityProfilesStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.networksecurity.v1.SecurityProfile[] =
          [];
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1.SecurityProfile,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (client.descriptors.page.listSecurityProfiles.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listSecurityProfiles, request),
      );
      assert(
        (client.descriptors.page.listSecurityProfiles.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listSecurityProfiles without error', async () => {
      ...
      client.descriptors.page.listSecurityProfiles.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.networksecurity.v1.ISecurityProfile[] =
        [];
