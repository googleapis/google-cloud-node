...
describe('v1.NetworkSecurityClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = networksecurityModule.v1.NetworkSecurityClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = networksecurityModule.v1.NetworkSecurityClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'networksecurity.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new networksecurityModule.v1.NetworkSecurityClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networksecurity.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new networksecurityModule.v1.NetworkSecurityClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networksecurity.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new networksecurityModule.v1.NetworkSecurityClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new networksecurityModule.v1.NetworkSecurityClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getAuthorizationPolicy', () => {
        it('invokes getAuthorizationPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.GetAuthorizationPolicyRequest', ['name']);
        ...
        it('invokes getAuthorizationPolicy without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAuthorizationPolicy(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1.IAuthorizationPolicy|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getBackendAuthenticationConfig', () => {
        it('invokes getBackendAuthenticationConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.GetBackendAuthenticationConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getBackendAuthenticationConfig without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getBackendAuthenticationConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1.IBackendAuthenticationConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getServerTlsPolicy', () => {
        it('invokes getServerTlsPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.GetServerTlsPolicyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getServerTlsPolicy without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getServerTlsPolicy(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1.IServerTlsPolicy|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getClientTlsPolicy', () => {
        it('invokes getClientTlsPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.GetClientTlsPolicyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getClientTlsPolicy without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getClientTlsPolicy(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1.IClientTlsPolicy|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getGatewaySecurityPolicy', () => {
        it('invokes getGatewaySecurityPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.GetGatewaySecurityPolicyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getGatewaySecurityPolicy without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getGatewaySecurityPolicy(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1.IGatewaySecurityPolicy|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getGatewaySecurityPolicyRule', () => {
        it('invokes getGatewaySecurityPolicyRule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.GetGatewaySecurityPolicyRuleRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getGatewaySecurityPolicyRule without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getGatewaySecurityPolicyRule(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1.IGatewaySecurityPolicyRule|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getUrlList', () => {
        it('invokes getUrlList without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.GetUrlListRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getUrlList without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getUrlList(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1.IUrlList|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getTlsInspectionPolicy', () => {
        it('invokes getTlsInspectionPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.GetTlsInspectionPolicyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getTlsInspectionPolicy without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getTlsInspectionPolicy(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1.ITlsInspectionPolicy|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getAuthzPolicy', () => {
        it('invokes getAuthzPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.GetAuthzPolicyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getAuthzPolicy without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAuthzPolicy(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1.IAuthzPolicy|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createAuthorizationPolicy', () => {
        it('invokes createAuthorizationPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.CreateAuthorizationPolicyRequest', ['parent']);
        ...
        it('invokes createAuthorizationPolicy without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createAuthorizationPolicy(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networksecurity.v1.IAuthorizationPolicy, protos.google.cloud.networksecurity.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networksecurity.v1.IAuthorizationPolicy, protos.google.cloud.networksecurity.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createAuthorizationPolicy as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateAuthorizationPolicy', () => {
        it('invokes updateAuthorizationPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.UpdateAuthorizationPolicyRequest', ['authorizationPolicy', 'name']);
    ...
    describe('deleteAuthorizationPolicy', () => {
        it('invokes deleteAuthorizationPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.DeleteAuthorizationPolicyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createBackendAuthenticationConfig', () => {
        it('invokes createBackendAuthenticationConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.CreateBackendAuthenticationConfigRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createBackendAuthenticationConfig without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createBackendAuthenticationConfig(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networksecurity.v1.IBackendAuthenticationConfig, protos.google.cloud.networksecurity.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networksecurity.v1.IBackendAuthenticationConfig, protos.google.cloud.networksecurity.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createBackendAuthenticationConfig as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateBackendAuthenticationConfig', () => {
        it('invokes updateBackendAuthenticationConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.UpdateBackendAuthenticationConfigRequest', ['backendAuthenticationConfig', 'name']);
    ...
    describe('deleteBackendAuthenticationConfig', () => {
        it('invokes deleteBackendAuthenticationConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.DeleteBackendAuthenticationConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createServerTlsPolicy', () => {
        it('invokes createServerTlsPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.CreateServerTlsPolicyRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createServerTlsPolicy without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createServerTlsPolicy(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networksecurity.v1.IServerTlsPolicy, protos.google.cloud.networksecurity.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networksecurity.v1.IServerTlsPolicy, protos.google.cloud.networksecurity.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createServerTlsPolicy as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateServerTlsPolicy', () => {
        it('invokes updateServerTlsPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.UpdateServerTlsPolicyRequest', ['serverTlsPolicy', 'name']);
    ...
    describe('deleteServerTlsPolicy', () => {
        it('invokes deleteServerTlsPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.DeleteServerTlsPolicyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createClientTlsPolicy', () => {
        it('invokes createClientTlsPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.CreateClientTlsPolicyRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createClientTlsPolicy without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createClientTlsPolicy(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networksecurity.v1.IClientTlsPolicy, protos.google.cloud.networksecurity.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networksecurity.v1.IClientTlsPolicy, protos.google.cloud.networksecurity.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createClientTlsPolicy as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateClientTlsPolicy', () => {
        it('invokes updateClientTlsPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.UpdateClientTlsPolicyRequest', ['clientTlsPolicy', 'name']);
    ...
    describe('deleteClientTlsPolicy', () => {
        it('invokes deleteClientTlsPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.DeleteClientTlsPolicyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createGatewaySecurityPolicy', () => {
        it('invokes createGatewaySecurityPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.CreateGatewaySecurityPolicyRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createGatewaySecurityPolicy without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createGatewaySecurityPolicy(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networksecurity.v1.IGatewaySecurityPolicy, protos.google.cloud.networksecurity.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networksecurity.v1.IGatewaySecurityPolicy, protos.google.cloud.networksecurity.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createGatewaySecurityPolicy as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateGatewaySecurityPolicy', () => {
        it('invokes updateGatewaySecurityPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.UpdateGatewaySecurityPolicyRequest', ['gatewaySecurityPolicy', 'name']);
    ...
    describe('deleteGatewaySecurityPolicy', () => {
        it('invokes deleteGatewaySecurityPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.DeleteGatewaySecurityPolicyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createGatewaySecurityPolicyRule', () => {
        it('invokes createGatewaySecurityPolicyRule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.CreateGatewaySecurityPolicyRuleRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createGatewaySecurityPolicyRule without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createGatewaySecurityPolicyRule(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networksecurity.v1.IGatewaySecurityPolicyRule, protos.google.cloud.networksecurity.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networksecurity.v1.IGatewaySecurityPolicyRule, protos.google.cloud.networksecurity.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createGatewaySecurityPolicyRule as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateGatewaySecurityPolicyRule', () => {
        it('invokes updateGatewaySecurityPolicyRule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.UpdateGatewaySecurityPolicyRuleRequest', ['gatewaySecurityPolicyRule', 'name']);
    ...
    describe('deleteGatewaySecurityPolicyRule', () => {
        it('invokes deleteGatewaySecurityPolicyRule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.DeleteGatewaySecurityPolicyRuleRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createUrlList', () => {
        it('invokes createUrlList without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.CreateUrlListRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createUrlList without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createUrlList(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networksecurity.v1.IUrlList, protos.google.cloud.networksecurity.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networksecurity.v1.IUrlList, protos.google.cloud.networksecurity.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createUrlList as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateUrlList', () => {
        it('invokes updateUrlList without error', async () => {
            ...
            request.urlList ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.UpdateUrlListRequest', ['urlList', 'name']);
    ...
    describe('deleteUrlList', () => {
        it('invokes deleteUrlList without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.DeleteUrlListRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createTlsInspectionPolicy', () => {
        it('invokes createTlsInspectionPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.CreateTlsInspectionPolicyRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createTlsInspectionPolicy without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createTlsInspectionPolicy(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networksecurity.v1.ITlsInspectionPolicy, protos.google.cloud.networksecurity.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networksecurity.v1.ITlsInspectionPolicy, protos.google.cloud.networksecurity.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createTlsInspectionPolicy as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateTlsInspectionPolicy', () => {
        it('invokes updateTlsInspectionPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.UpdateTlsInspectionPolicyRequest', ['tlsInspectionPolicy', 'name']);
    ...
    describe('deleteTlsInspectionPolicy', () => {
        it('invokes deleteTlsInspectionPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.DeleteTlsInspectionPolicyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createAuthzPolicy', () => {
        it('invokes createAuthzPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.CreateAuthzPolicyRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createAuthzPolicy without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createAuthzPolicy(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networksecurity.v1.IAuthzPolicy, protos.google.cloud.networksecurity.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networksecurity.v1.IAuthzPolicy, protos.google.cloud.networksecurity.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createAuthzPolicy as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateAuthzPolicy', () => {
        it('invokes updateAuthzPolicy without error', async () => {
            ...
            request.authzPolicy ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.UpdateAuthzPolicyRequest', ['authzPolicy', 'name']);
    ...
    describe('deleteAuthzPolicy', () => {
        it('invokes deleteAuthzPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.DeleteAuthzPolicyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listAuthorizationPolicies', () => {
        it('invokes listAuthorizationPolicies without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.ListAuthorizationPoliciesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.AuthorizationPolicy()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.AuthorizationPolicy()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.AuthorizationPolicy()),
            ];
    ...
    describe('listBackendAuthenticationConfigs', () => {
        it('invokes listBackendAuthenticationConfigs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.ListBackendAuthenticationConfigsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.BackendAuthenticationConfig()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.BackendAuthenticationConfig()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.BackendAuthenticationConfig()),
            ];
        ...
        it('invokes listBackendAuthenticationConfigsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networksecurity.v1.BackendAuthenticationConfig) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listServerTlsPolicies', () => {
        it('invokes listServerTlsPolicies without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.ListServerTlsPoliciesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.ServerTlsPolicy()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.ServerTlsPolicy()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.ServerTlsPolicy()),
            ];
        ...
        it('invokes listServerTlsPoliciesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networksecurity.v1.ServerTlsPolicy) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listClientTlsPolicies', () => {
        it('invokes listClientTlsPolicies without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.ListClientTlsPoliciesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.ClientTlsPolicy()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.ClientTlsPolicy()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.ClientTlsPolicy()),
            ];
        ...
        it('invokes listClientTlsPoliciesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networksecurity.v1.ClientTlsPolicy) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listGatewaySecurityPolicies', () => {
        it('invokes listGatewaySecurityPolicies without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.ListGatewaySecurityPoliciesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.GatewaySecurityPolicy()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.GatewaySecurityPolicy()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.GatewaySecurityPolicy()),
            ];
        ...
        it('invokes listGatewaySecurityPoliciesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networksecurity.v1.GatewaySecurityPolicy) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listGatewaySecurityPolicyRules', () => {
        it('invokes listGatewaySecurityPolicyRules without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.ListGatewaySecurityPolicyRulesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.GatewaySecurityPolicyRule()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.GatewaySecurityPolicyRule()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.GatewaySecurityPolicyRule()),
            ];
        ...
        it('invokes listGatewaySecurityPolicyRulesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networksecurity.v1.GatewaySecurityPolicyRule) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listUrlLists', () => {
        it('invokes listUrlLists without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.ListUrlListsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.UrlList()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.UrlList()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.UrlList()),
            ];
        ...
        it('invokes listUrlListsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networksecurity.v1.UrlList) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listTlsInspectionPolicies', () => {
        it('invokes listTlsInspectionPolicies without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.ListTlsInspectionPoliciesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.TlsInspectionPolicy()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.TlsInspectionPolicy()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.TlsInspectionPolicy()),
            ];
        ...
        it('invokes listTlsInspectionPoliciesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networksecurity.v1.TlsInspectionPolicy) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listAuthzPolicies', () => {
        it('invokes listAuthzPolicies without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.ListAuthzPoliciesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.AuthzPolicy()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.AuthzPolicy()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.AuthzPolicy()),
            ];
        ...
        it('invokes listAuthzPoliciesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networksecurity.v1.AuthzPolicy) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
