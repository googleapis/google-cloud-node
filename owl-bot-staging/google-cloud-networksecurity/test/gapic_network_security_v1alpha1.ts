  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          networksecurityModule.v1alpha1.NetworkSecurityClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          networksecurityModule.v1alpha1.NetworkSecurityClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'networksecurity.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new networksecurityModule.v1alpha1.NetworkSecurityClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'networksecurity.example.com');
          if (saved) {
    ...
    it('invokes getAuthorizationPolicy without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getAuthorizationPolicy(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1alpha1.IAuthorizationPolicy | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getBackendAuthenticationConfig without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getBackendAuthenticationConfig(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1alpha1.IBackendAuthenticationConfig | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getServerTlsPolicy without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getServerTlsPolicy(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1alpha1.IServerTlsPolicy | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getClientTlsPolicy without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getClientTlsPolicy(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1alpha1.IClientTlsPolicy | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getGatewaySecurityPolicy without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getGatewaySecurityPolicy(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1alpha1.IGatewaySecurityPolicy | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getGatewaySecurityPolicyRule without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getGatewaySecurityPolicyRule(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1alpha1.IGatewaySecurityPolicyRule | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getUrlList without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getUrlList(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1alpha1.IUrlList | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getTlsInspectionPolicy without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getTlsInspectionPolicy(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1alpha1.ITlsInspectionPolicy | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getAuthzPolicy without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getAuthzPolicy(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1alpha1.IAuthzPolicy | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listAuthorizationPoliciesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1alpha1.AuthorizationPolicy,
          ) => {
    ...
    it('invokes listBackendAuthenticationConfigsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1alpha1.BackendAuthenticationConfig,
          ) => {
            responses.push(response);
          },
        );
    ...
    it('invokes listServerTlsPoliciesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1alpha1.ServerTlsPolicy,
          ) => {
            responses.push(response);
          },
        );
    ...
    it('invokes listClientTlsPoliciesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1alpha1.ClientTlsPolicy,
          ) => {
            responses.push(response);
          },
        );
    ...
    it('invokes listGatewaySecurityPoliciesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1alpha1.GatewaySecurityPolicy,
          ) => {
            responses.push(response);
          },
        );
    ...
    it('invokes listGatewaySecurityPolicyRulesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1alpha1.GatewaySecurityPolicyRule,
          ) => {
            responses.push(response);
          },
        );
  ...
  describe('listUrlLists', () => {
    ...
    it('invokes listUrlListsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.networksecurity.v1alpha1.UrlList) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
    ...
    it('invokes listTlsInspectionPoliciesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1alpha1.TlsInspectionPolicy,
          ) => {
            responses.push(response);
          },
        );
    ...
    it('invokes listAuthzPoliciesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1alpha1.AuthzPolicy,
          ) => {
            responses.push(response);
          },
        );
