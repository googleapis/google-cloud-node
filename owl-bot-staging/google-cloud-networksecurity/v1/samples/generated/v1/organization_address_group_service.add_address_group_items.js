...
function main(addressGroup, items) {
  ...
  async function callAddAddressGroupItems() {
    // Construct request
    const request = {
      addressGroup,
      items,
    ...
    // Run request
    const [operation] = await networksecurityClient.addAddressGroupItems(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callAddAddressGroupItems();
  // [END networksecurity_v1_generated_OrganizationAddressGroupService_AddAddressGroupItems_async]
}
