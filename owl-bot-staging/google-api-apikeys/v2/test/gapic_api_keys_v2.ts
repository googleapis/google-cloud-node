...
describe('v2.ApiKeysClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new apikeysModule.v2.ApiKeysClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'apikeys.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new apikeysModule.v2.ApiKeysClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'apikeys.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new apikeysModule.v2.ApiKeysClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new apikeysModule.v2.ApiKeysClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getKey', () => {
        it('invokes getKey without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.api.apikeys.v2.GetKeyRequest', ['name']);
        ...
        it('invokes getKey without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getKey(
                    request,
                    (err?: Error|null, result?: protos.google.api.apikeys.v2.IKey|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getKeyString', () => {
        it('invokes getKeyString without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.api.apikeys.v2.GetKeyStringRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getKeyString as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getKeyString as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getKeyString without error using callback', async () => {
            ...
            client.innerApiCalls.getKeyString = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getKeyString(
                    request,
                    (err?: Error|null, result?: protos.google.api.apikeys.v2.IGetKeyStringResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getKeyString with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getKeyString = stubSimpleCall(undefined, expectedError);
    ...
    describe('lookupKey', () => {
        ...
        it('invokes lookupKey without error using callback', async () => {
            ...
            client.innerApiCalls.lookupKey = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.lookupKey(
                    request,
                    (err?: Error|null, result?: protos.google.api.apikeys.v2.ILookupKeyResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createKey', () => {
        it('invokes createKey without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.api.apikeys.v2.CreateKeyRequest', ['parent']);
        ...
        it('invokes createKey without error using callback', async () => {
            ...
            client.innerApiCalls.createKey = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createKey(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.api.apikeys.v2.IKey, protos.google.protobuf.IEmpty>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.api.apikeys.v2.IKey, protos.google.protobuf.IEmpty>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createKey as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createKey with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createKey = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes createKey with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createKey = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createKey(request);
        ...
        it('invokes checkCreateKeyProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateKeyProgress(expectedResponse.name);
    ...
    describe('updateKey', () => {
        it('invokes updateKey without error', async () => {
            ...
            request.key ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.api.apikeys.v2.UpdateKeyRequest', ['key', 'name']);
        ...
        it('invokes updateKey without error using callback', async () => {
            ...
            client.innerApiCalls.updateKey = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateKey(
                    request,
                    (err?: Error|null,
        ...
        it('invokes updateKey with call error', async () => {
            ...
            const expectedHeaderRequestParams = `key.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateKey = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes updateKey with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `key.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateKey = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateKey(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateKey as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateKeyProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateKeyProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('deleteKey', () => {
        it('invokes deleteKey without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.api.apikeys.v2.DeleteKeyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes deleteKey without error using callback', async () => {
            ...
            client.innerApiCalls.deleteKey = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteKey(
                    request,
                    (err?: Error|null,
        ...
        it('invokes deleteKey with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteKey = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes deleteKey with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteKey = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteKey(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteKey as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteKeyProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteKeyProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('undeleteKey', () => {
        it('invokes undeleteKey without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.api.apikeys.v2.UndeleteKeyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.undeleteKey as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.undeleteKey as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes undeleteKey without error using callback', async () => {
            ...
            client.innerApiCalls.undeleteKey = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.undeleteKey(
                    request,
                    (err?: Error|null,
        ...
        it('invokes undeleteKey with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.undeleteKey = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes undeleteKey with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.undeleteKey = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.undeleteKey(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.undeleteKey as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUndeleteKeyProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUndeleteKeyProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('listKeys', () => {
        it('invokes listKeys without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.api.apikeys.v2.ListKeysRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('Path templates', () => {
        ...
        describe('key', async () => {
            ...
            it('keyPath', () => {
                const result = client.keyPath("projectValue", "locationValue", "keyValue");
