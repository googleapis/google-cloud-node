...
describe('v2.ApiKeysClient', () => {
    ...
    describe('getKey', () => {
        it('invokes getKey without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.api.apikeys.v2.GetKeyRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.api.apikeys.v2.Key());
    ...
    describe('getKeyString', () => {
        it('invokes getKeyString without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.api.apikeys.v2.GetKeyStringRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.api.apikeys.v2.GetKeyStringResponse());
            client.innerApiCalls.getKeyString = stubSimpleCall(expectedResponse);
            const [response] = await client.getKeyString(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getKeyString as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('lookupKey', () => {
        it('invokes lookupKey without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.api.apikeys.v2.LookupKeyResponse());
            client.innerApiCalls.lookupKey = stubSimpleCall(expectedResponse);
            const [response] = await client.lookupKey(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.lookupKey as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('createKey', () => {
        it('invokes createKey without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.api.apikeys.v2.CreateKeyRequest());
            request.parent = '';
    ...
    describe('updateKey', () => {
        it('invokes updateKey without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.api.apikeys.v2.UpdateKeyRequest());
            request.key = {};
            request.key.name = '';
    ...
    describe('deleteKey', () => {
        it('invokes deleteKey without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.api.apikeys.v2.DeleteKeyRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('undeleteKey', () => {
        it('invokes undeleteKey without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.api.apikeys.v2.UndeleteKeyRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.undeleteKey as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listKeys', () => {
        it('invokes listKeys without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.api.apikeys.v2.ListKeysRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
