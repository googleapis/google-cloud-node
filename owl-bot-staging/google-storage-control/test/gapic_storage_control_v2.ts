...
describe('v2.StorageControlClient', () => {
    ...
    describe('deleteFolderRecursive', () => {
        it('invokes deleteFolderRecursive without error', async () => {
            ...
            client.innerApiCalls.deleteFolderRecursive = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteFolderRecursive(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteFolderRecursive as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteFolderRecursive as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));    
            assert.match((client.innerApiCalls.deleteFolderRecursive as SinonStub)
                .getCall(0).args[0].requestId, /[a-z0-9-]{36}/)
        });
        ...
        it('invokes deleteFolderRecursive without error using callback', async () => {
            ...
            client.innerApiCalls.deleteFolderRecursive = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteFolderRecursive(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.storage.control.v2.IDeleteFolderRecursiveMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.storage.control.v2.IDeleteFolderRecursiveMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteFolderRecursive as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes deleteFolderRecursive with call error', async () => {
            ...
            const expectedHeaderRequestParams = 'bucket=projects%2Fvalue%2Fbuckets%2Fvalue';
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteFolderRecursive = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteFolderRecursive(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteFolderRecursive as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteFolderRecursive as SinonStub)
        ...
        it('invokes deleteFolderRecursive with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = 'bucket=projects%2Fvalue%2Fbuckets%2Fvalue';
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteFolderRecursive = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteFolderRecursive(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteFolderRecursive as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteFolderRecursiveProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteFolderRecursiveProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteFolderRecursiveProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteFolderRecursiveProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
