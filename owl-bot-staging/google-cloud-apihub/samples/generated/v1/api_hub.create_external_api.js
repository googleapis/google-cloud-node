...
function main(parent, externalApi) {
  // [START apihub_v1_generated_ApiHub_CreateExternalApi_async]
  /**
  ...
  async function callCreateExternalApi() {
    // Construct request
    const request = {
      parent,
      externalApi,
    ...
    // Run request
    const response = await apihubClient.createExternalApi(request);
    console.log(response);
  }

  callCreateExternalApi();
