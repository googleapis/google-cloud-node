...
function main(parent, apiOperation) {
  ...
  async function callCreateApiOperation() {
    // Construct request
    const request = {
      parent,
      apiOperation,
    ...
    // Run request
    const response = await apihubClient.createApiOperation(request);
    console.log(response);
  }

  callCreateApiOperation();
