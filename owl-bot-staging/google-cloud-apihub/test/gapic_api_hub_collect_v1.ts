...
describe('v1.ApiHubCollectClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          apihubcollectModule.v1.ApiHubCollectClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          apihubcollectModule.v1.ApiHubCollectClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'apihub.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new apihubcollectModule.v1.ApiHubCollectClient({
          universe_domain: 'example.com',
  ...
  describe('collectApiData', () => {
    it('invokes collectApiData without error', async () => {
      ...
      client.innerApiCalls.collectApiData =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.collectApiData(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.collectApiData as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes collectApiData with call error', async () => {
      ...
      client.innerApiCalls.collectApiData = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkCollectApiDataProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCollectApiDataProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
