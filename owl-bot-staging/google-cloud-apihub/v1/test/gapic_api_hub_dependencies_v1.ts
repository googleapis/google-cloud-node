...
describe('v1.ApiHubDependenciesClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = apihubdependenciesModule.v1.ApiHubDependenciesClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = apihubdependenciesModule.v1.ApiHubDependenciesClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'apihub.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new apihubdependenciesModule.v1.ApiHubDependenciesClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'apihub.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new apihubdependenciesModule.v1.ApiHubDependenciesClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'apihub.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new apihubdependenciesModule.v1.ApiHubDependenciesClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new apihubdependenciesModule.v1.ApiHubDependenciesClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createDependency', () => {
        it('invokes createDependency without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.apihub.v1.CreateDependencyRequest', ['parent']);
            ...
            const actualRequest = (client.innerApiCalls.createDependency as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createDependency as SinonStub)
        ...
        it('invokes createDependency without error using callback', async () => {
            ...
            client.innerApiCalls.createDependency = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createDependency(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.apihub.v1.IDependency|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createDependency with error', async () => {
            ...
            client.innerApiCalls.createDependency = stubSimpleCall(undefined, expectedError);
    ...
    describe('getDependency', () => {
        it('invokes getDependency without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.apihub.v1.GetDependencyRequest', ['name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getDependency as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDependency as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getDependency without error using callback', async () => {
            ...
            client.innerApiCalls.getDependency = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getDependency with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getDependency = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateDependency', () => {
        it('invokes updateDependency without error', async () => {
            ...
            request.dependency ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.apihub.v1.UpdateDependencyRequest', ['dependency', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateDependency as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateDependency as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateDependency without error using callback', async () => {
            ...
            client.innerApiCalls.updateDependency = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateDependency with error', async () => {
            ...
            const expectedHeaderRequestParams = `dependency.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateDependency = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteDependency', () => {
        it('invokes deleteDependency without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.apihub.v1.DeleteDependencyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteDependency as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteDependency as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteDependency without error using callback', async () => {
            ...
            client.innerApiCalls.deleteDependency = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteDependency with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteDependency = stubSimpleCall(undefined, expectedError);
    ...
    describe('listDependencies', () => {
        it('invokes listDependencies without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.apihub.v1.ListDependenciesRequest', ['parent']);
            request.parent = defaultValue1;
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listDependencies as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listDependencies as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listDependencies without error using callback', async () => {
            ...
            client.innerApiCalls.listDependencies = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listDependencies with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listDependencies = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listDependenciesStream without error', async () => {
            ...
            client.descriptors.page.listDependencies.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listDependenciesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.apihub.v1.Dependency[] = [];
                stream.on('data', (response: protos.google.cloud.apihub.v1.Dependency) => {
            ...
            assert((client.descriptors.page.listDependencies.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listDependencies, request));
            assert(
        ...
        it('invokes listDependenciesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDependencies.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listDependenciesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.apihub.v1.Dependency[] = [];
                stream.on('data', (response: protos.google.cloud.apihub.v1.Dependency) => {
        ...
        it('uses async iteration with listDependencies without error', async () => {
            ...
            client.descriptors.page.listDependencies.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listDependencies with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDependencies.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listDependenciesAsync(request);
