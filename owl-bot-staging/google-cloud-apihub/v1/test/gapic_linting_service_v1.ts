  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = lintingserviceModule.v1.LintingServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = lintingserviceModule.v1.LintingServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'apihub.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new lintingserviceModule.v1.LintingServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'apihub.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new lintingserviceModule.v1.LintingServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'apihub.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new lintingserviceModule.v1.LintingServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new lintingserviceModule.v1.LintingServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getStyleGuide', () => {
        it('invokes getStyleGuide without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.apihub.v1.GetStyleGuideRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getStyleGuide as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getStyleGuide as SinonStub)
        ...
        it('invokes getStyleGuide without error using callback', async () => {
            ...
            client.innerApiCalls.getStyleGuide = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getStyleGuide(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.apihub.v1.IStyleGuide|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getStyleGuide with error', async () => {
            ...
            client.innerApiCalls.getStyleGuide = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateStyleGuide', () => {
        it('invokes updateStyleGuide without error', async () => {
            ...
            request.styleGuide ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.apihub.v1.UpdateStyleGuideRequest', ['styleGuide', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateStyleGuide as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateStyleGuide as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateStyleGuide without error using callback', async () => {
            ...
            client.innerApiCalls.updateStyleGuide = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateStyleGuide with error', async () => {
            ...
            const expectedHeaderRequestParams = `style_guide.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateStyleGuide = stubSimpleCall(undefined, expectedError);
    ...
    describe('getStyleGuideContents', () => {
        it('invokes getStyleGuideContents without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.apihub.v1.GetStyleGuideContentsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.apihub.v1.StyleGuideContents()
            );
            client.innerApiCalls.getStyleGuideContents = stubSimpleCall(expectedResponse);
            const [response] = await client.getStyleGuideContents(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getStyleGuideContents as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getStyleGuideContents as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getStyleGuideContents without error using callback', async () => {
            ...
            client.innerApiCalls.getStyleGuideContents = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getStyleGuideContents(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.apihub.v1.IStyleGuideContents|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getStyleGuideContents with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getStyleGuideContents = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getStyleGuideContents(request), expectedError);
            const actualRequest = (client.innerApiCalls.getStyleGuideContents as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getStyleGuideContents as SinonStub)
    ...
    describe('lintSpec', () => {
        it('invokes lintSpec without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.apihub.v1.LintSpecRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.lintSpec as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.lintSpec as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes lintSpec without error using callback', async () => {
            ...
            client.innerApiCalls.lintSpec = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.lintSpec(
                    request,
