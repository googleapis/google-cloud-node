...
describe('v1.RuntimeProjectAttachmentServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'apihub.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'apihub.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'apihub.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient.port;
            assert(port);
    ...
    describe('createRuntimeProjectAttachment', () => {
        it('invokes createRuntimeProjectAttachment without error', async () => {
            const client = new runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.apihub.v1.CreateRuntimeProjectAttachmentRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.apihub.v1.RuntimeProjectAttachment()
            );
            client.innerApiCalls.createRuntimeProjectAttachment = stubSimpleCall(expectedResponse);
            const [response] = await client.createRuntimeProjectAttachment(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createRuntimeProjectAttachment as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createRuntimeProjectAttachment as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes createRuntimeProjectAttachment without error using callback', async () => {
            const client = new runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.createRuntimeProjectAttachment = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createRuntimeProjectAttachment(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.apihub.v1.IRuntimeProjectAttachment|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createRuntimeProjectAttachment with error', async () => {
            const client = new runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.createRuntimeProjectAttachment = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createRuntimeProjectAttachment(request), expectedError);
            const actualRequest = (client.innerApiCalls.createRuntimeProjectAttachment as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createRuntimeProjectAttachment as SinonStub)
        ...
        it('invokes createRuntimeProjectAttachment with closed client', async () => {
            const client = new runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('getRuntimeProjectAttachment', () => {
        it('invokes getRuntimeProjectAttachment without error', async () => {
            const client = new runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.apihub.v1.GetRuntimeProjectAttachmentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.apihub.v1.RuntimeProjectAttachment()
            );
            client.innerApiCalls.getRuntimeProjectAttachment = stubSimpleCall(expectedResponse);
            const [response] = await client.getRuntimeProjectAttachment(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getRuntimeProjectAttachment as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getRuntimeProjectAttachment as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getRuntimeProjectAttachment without error using callback', async () => {
            const client = new runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getRuntimeProjectAttachment = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getRuntimeProjectAttachment(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.apihub.v1.IRuntimeProjectAttachment|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes getRuntimeProjectAttachment with error', async () => {
            const client = new runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getRuntimeProjectAttachment = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getRuntimeProjectAttachment(request), expectedError);
            const actualRequest = (client.innerApiCalls.getRuntimeProjectAttachment as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getRuntimeProjectAttachment as SinonStub)
        ...
        it('invokes getRuntimeProjectAttachment with closed client', async () => {
            const client = new runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('deleteRuntimeProjectAttachment', () => {
        it('invokes deleteRuntimeProjectAttachment without error', async () => {
            const client = new runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.apihub.v1.DeleteRuntimeProjectAttachmentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteRuntimeProjectAttachment = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteRuntimeProjectAttachment(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteRuntimeProjectAttachment as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteRuntimeProjectAttachment as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes deleteRuntimeProjectAttachment without error using callback', async () => {
            const client = new runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.deleteRuntimeProjectAttachment = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteRuntimeProjectAttachment(
                    request,
        ...
        it('invokes deleteRuntimeProjectAttachment with error', async () => {
            const client = new runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteRuntimeProjectAttachment = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.deleteRuntimeProjectAttachment(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteRuntimeProjectAttachment as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteRuntimeProjectAttachment as SinonStub)
        ...
        it('invokes deleteRuntimeProjectAttachment with closed client', async () => {
            const client = new runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('lookupRuntimeProjectAttachment', () => {
        it('invokes lookupRuntimeProjectAttachment without error', async () => {
            const client = new runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.apihub.v1.LookupRuntimeProjectAttachmentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.apihub.v1.LookupRuntimeProjectAttachmentResponse()
            );
            client.innerApiCalls.lookupRuntimeProjectAttachment = stubSimpleCall(expectedResponse);
            const [response] = await client.lookupRuntimeProjectAttachment(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.lookupRuntimeProjectAttachment as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.lookupRuntimeProjectAttachment as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes lookupRuntimeProjectAttachment without error using callback', async () => {
            const client = new runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.lookupRuntimeProjectAttachment = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.lookupRuntimeProjectAttachment(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.apihub.v1.ILookupRuntimeProjectAttachmentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes lookupRuntimeProjectAttachment with error', async () => {
            const client = new runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.lookupRuntimeProjectAttachment = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.lookupRuntimeProjectAttachment(request), expectedError);
            const actualRequest = (client.innerApiCalls.lookupRuntimeProjectAttachment as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.lookupRuntimeProjectAttachment as SinonStub)
        ...
        it('invokes lookupRuntimeProjectAttachment with closed client', async () => {
            const client = new runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('listRuntimeProjectAttachments', () => {
        it('invokes listRuntimeProjectAttachments without error', async () => {
            const client = new runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient({
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.apihub.v1.ListRuntimeProjectAttachmentsRequest', ['parent']);
            request.parent = defaultValue1;
            ...
            client.innerApiCalls.listRuntimeProjectAttachments = stubSimpleCall(expectedResponse);
            const [response] = await client.listRuntimeProjectAttachments(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listRuntimeProjectAttachments as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listRuntimeProjectAttachments as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes listRuntimeProjectAttachments without error using callback', async () => {
            const client = new runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listRuntimeProjectAttachments = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listRuntimeProjectAttachments with error', async () => {
            const client = new runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listRuntimeProjectAttachments = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listRuntimeProjectAttachments(request), expectedError);
            const actualRequest = (client.innerApiCalls.listRuntimeProjectAttachments as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listRuntimeProjectAttachments as SinonStub)
        ...
        it('invokes listRuntimeProjectAttachmentsStream without error', async () => {
            const client = new runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listRuntimeProjectAttachments.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listRuntimeProjectAttachmentsStream(request);
            const promise = new Promise((resolve, reject) => {
            ...
            assert((client.descriptors.page.listRuntimeProjectAttachments.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listRuntimeProjectAttachments, request));
            assert(
                (client.descriptors.page.listRuntimeProjectAttachments.createStream as SinonStub)
        ...
        it('invokes listRuntimeProjectAttachmentsStream with error', async () => {
            const client = new runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listRuntimeProjectAttachments.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listRuntimeProjectAttachmentsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.apihub.v1.RuntimeProjectAttachment[] = [];
                stream.on('data', (response: protos.google.cloud.apihub.v1.RuntimeProjectAttachment) => {
        ...
        it('uses async iteration with listRuntimeProjectAttachments without error', async () => {
            const client = new runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listRuntimeProjectAttachments.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.apihub.v1.IRuntimeProjectAttachment[] = [];
            const iterable = client.listRuntimeProjectAttachmentsAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listRuntimeProjectAttachments.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listRuntimeProjectAttachments with error', async () => {
            const client = new runtimeprojectattachmentserviceModule.v1.RuntimeProjectAttachmentServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listRuntimeProjectAttachments.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listRuntimeProjectAttachmentsAsync(request);
