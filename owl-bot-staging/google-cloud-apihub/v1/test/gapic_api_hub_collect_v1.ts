...
describe('v1.ApiHubCollectClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = apihubcollectModule.v1.ApiHubCollectClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = apihubcollectModule.v1.ApiHubCollectClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'apihub.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new apihubcollectModule.v1.ApiHubCollectClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'apihub.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new apihubcollectModule.v1.ApiHubCollectClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'apihub.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new apihubcollectModule.v1.ApiHubCollectClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new apihubcollectModule.v1.ApiHubCollectClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = apihubcollectModule.v1.ApiHubCollectClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.apiHubCollectStub, undefined);
    ...
    describe('collectApiData', () => {
        it('invokes collectApiData without error', async () => {
            const client = new apihubcollectModule.v1.ApiHubCollectClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.apihub.v1.CollectApiDataRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.apihub.v1.CollectApiDataRequest', ['location']);
            request.location = defaultValue1;
            const expectedHeaderRequestParams = `location=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.collectApiData = stubLongRunningCall(expectedResponse);
            const [operation] = await client.collectApiData(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.collectApiData as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.collectApiData as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes collectApiData without error using callback', async () => {
            const client = new apihubcollectModule.v1.ApiHubCollectClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.collectApiData = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.collectApiData(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.apihub.v1.ICollectApiDataResponse, protos.google.cloud.apihub.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.apihub.v1.ICollectApiDataResponse, protos.google.cloud.apihub.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.collectApiData as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes collectApiData with call error', async () => {
            const client = new apihubcollectModule.v1.ApiHubCollectClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.collectApiData = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.collectApiData(request), expectedError);
            const actualRequest = (client.innerApiCalls.collectApiData as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.collectApiData as SinonStub)
        ...
        it('invokes collectApiData with LRO error', async () => {
            const client = new apihubcollectModule.v1.ApiHubCollectClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `location=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.collectApiData = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.collectApiData(request);
        ...
        it('invokes checkCollectApiDataProgress without error', async () => {
            const client = new apihubcollectModule.v1.ApiHubCollectClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const decodedOperation = await client.checkCollectApiDataProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkCollectApiDataProgress with error', async () => {
            const client = new apihubcollectModule.v1.ApiHubCollectClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            await assert.rejects(client.checkCollectApiDataProgress(''), expectedError);
