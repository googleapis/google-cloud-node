...
function main(name) {
  // [START apihub_v1_generated_ApiHub_GetDeployment_async]
  /**
  ...
  async function callGetDeployment() {
    ...
    // Run request
    const response = await apihubClient.getDeployment(request);
    console.log(response);
  }

  callGetDeployment();
  // [END apihub_v1_generated_ApiHub_GetDeployment_async]
}
