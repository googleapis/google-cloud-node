...
function main(name) {
  ...
  async function callLookupRuntimeProjectAttachment() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await apihubClient.lookupRuntimeProjectAttachment(request);
    console.log(response);
  }

  callLookupRuntimeProjectAttachment();
