...
function main(spec, updateMask) {
  // [START apihub_v1_generated_ApiHub_UpdateSpec_async]
  /**
  ...
  async function callUpdateSpec() {
    ...
    // Run request
    const response = await apihubClient.updateSpec(request);
