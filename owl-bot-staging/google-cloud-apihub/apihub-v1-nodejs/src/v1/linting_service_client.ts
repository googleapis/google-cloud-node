 ...
 * `src/v1/linting_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './linting_service_client_config.json';
 ...
 * @memberof v1
 */
export class LintingServiceClient {
  ...
  lintingServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of LintingServiceClient.
   *
  ...
  initialize() {
    ...
    if (this.lintingServiceStub) {
      return this.lintingServiceStub;
    }
