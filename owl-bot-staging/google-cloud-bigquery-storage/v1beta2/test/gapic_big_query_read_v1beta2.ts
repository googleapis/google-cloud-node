...
describe('v1beta2.BigQueryReadClient', () => {
    ...
    describe('createReadSession', () => {
        it('invokes createReadSession without error', async () => {
            ...
            request.readSession ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.storage.v1beta2.CreateReadSessionRequest', ['readSession', 'table']);
    ...
    describe('splitReadStream', () => {
        it('invokes splitReadStream without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.storage.v1beta2.SplitReadStreamRequest', ['name']);
    ...
    describe('readRows', () => {
        it('invokes readRows without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.storage.v1beta2.ReadRowsRequest', ['readStream']);
