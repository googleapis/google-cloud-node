 ...
 * `src/v1/featured_content_native_dashboard_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './featured_content_native_dashboard_service_client_config.json';
 ...
 * @memberof v1
 */
export class FeaturedContentNativeDashboardServiceClient {
  ...
  initialize() {
    ...
    if (this.featuredContentNativeDashboardServiceStub) {
      return this.featuredContentNativeDashboardServiceStub;
    }
 ...
 */
  ...
  /**
   * Return a fully-qualified contentHub resource name string.
   *
  ...
  /**
   * Parse the project from ContentHub resource.
   *
   * @param {string} contentHubName
   *   A fully-qualified path representing ContentHub resource.
  ...
  /**
   * Parse the location from ContentHub resource.
   *
   * @param {string} contentHubName
   *   A fully-qualified path representing ContentHub resource.
  ...
  /**
   * Parse the instance from ContentHub resource.
   *
   * @param {string} contentHubName
   *   A fully-qualified path representing ContentHub resource.
