 ...
 * `src/v1/dashboard_chart_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './dashboard_chart_service_client_config.json';
 ...
 * @memberof v1
 */
export class DashboardChartServiceClient {
  ...
  initialize() {
    ...
    if (this.dashboardChartServiceStub) {
      return this.dashboardChartServiceStub;
    }
