...
function main(parent, retrohunt) {
  // [START chronicle_v1_generated_RuleService_CreateRetrohunt_async]
  /**
  ...
  async function callCreateRetrohunt() {
    // Construct request
    const request = {
      parent,
      retrohunt,
    ...
    // Run request
    const [operation] = await chronicleClient.createRetrohunt(request);
