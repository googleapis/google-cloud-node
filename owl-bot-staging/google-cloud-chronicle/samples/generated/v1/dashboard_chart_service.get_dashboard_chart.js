...
function main(name) {
  ...
  const {DashboardChartServiceClient} = require('@google-cloud/chronicle').v1;

  // Instantiates a client
  const chronicleClient = new DashboardChartServiceClient();

  async function callGetDashboardChart() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await chronicleClient.getDashboardChart(request);
    console.log(response);
  }

  callGetDashboardChart();
