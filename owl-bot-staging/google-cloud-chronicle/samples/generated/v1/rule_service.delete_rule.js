...
function main(name) {
  // [START chronicle_v1_generated_RuleService_DeleteRule_async]
  /**
  ...
  async function callDeleteRule() {
    ...
    // Run request
    const response = await chronicleClient.deleteRule(request);
    console.log(response);
  }

  callDeleteRule();
  // [END chronicle_v1_generated_RuleService_DeleteRule_async]
}
