...
function main(referenceList) {
  ...
  async function callUpdateReferenceList() {
    // Construct request
    const request = {
      referenceList,
    };
    ...
    // Run request
    const response = await chronicleClient.updateReferenceList(request);
    console.log(response);
  }

  callUpdateReferenceList();
