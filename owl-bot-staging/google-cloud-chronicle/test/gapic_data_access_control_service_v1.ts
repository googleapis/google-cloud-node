...
describe('v1.DataAccessControlServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          dataaccesscontrolserviceModule.v1.DataAccessControlServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        dataaccesscontrolserviceModule.v1.DataAccessControlServiceClient.port;
      assert(port);
  ...
  describe('createDataAccessLabel', () => {
    it('invokes createDataAccessLabel without error', async () => {
      ...
      client.innerApiCalls.createDataAccessLabel =
        stubSimpleCall(expectedResponse);
      const [response] = await client.createDataAccessLabel(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createDataAccessLabel as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes createDataAccessLabel without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createDataAccessLabel(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.chronicle.v1.IDataAccessLabel | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createDataAccessLabel with error', async () => {
      ...
      client.innerApiCalls.createDataAccessLabel = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createDataAccessLabel(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createDataAccessLabel as SinonStub
  ...
  describe('getDataAccessLabel', () => {
    it('invokes getDataAccessLabel without error', async () => {
      ...
      client.innerApiCalls.getDataAccessLabel =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getDataAccessLabel(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getDataAccessLabel as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getDataAccessLabel as SinonStub
    ...
    it('invokes getDataAccessLabel with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getDataAccessLabel = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateDataAccessLabel', () => {
    it('invokes updateDataAccessLabel without error', async () => {
      ...
      client.innerApiCalls.updateDataAccessLabel =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateDataAccessLabel(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateDataAccessLabel as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateDataAccessLabel as SinonStub
    ...
    it('invokes updateDataAccessLabel with error', async () => {
      ...
      const expectedHeaderRequestParams = `data_access_label.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateDataAccessLabel = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateDataAccessLabel(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateDataAccessLabel as SinonStub
  ...
  describe('deleteDataAccessLabel', () => {
    it('invokes deleteDataAccessLabel without error', async () => {
      ...
      client.innerApiCalls.deleteDataAccessLabel =
        stubSimpleCall(expectedResponse);
      const [response] = await client.deleteDataAccessLabel(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteDataAccessLabel as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteDataAccessLabel as SinonStub
    ...
    it('invokes deleteDataAccessLabel with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteDataAccessLabel = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteDataAccessLabel(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteDataAccessLabel as SinonStub
  ...
  describe('createDataAccessScope', () => {
    it('invokes createDataAccessScope without error', async () => {
      ...
      client.innerApiCalls.createDataAccessScope =
        stubSimpleCall(expectedResponse);
      const [response] = await client.createDataAccessScope(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createDataAccessScope as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createDataAccessScope as SinonStub
    ...
    it('invokes createDataAccessScope without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createDataAccessScope(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.chronicle.v1.IDataAccessScope | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createDataAccessScope with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createDataAccessScope = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createDataAccessScope(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createDataAccessScope as SinonStub
  ...
  describe('getDataAccessScope', () => {
    it('invokes getDataAccessScope without error', async () => {
      ...
      client.innerApiCalls.getDataAccessScope =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getDataAccessScope(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getDataAccessScope as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getDataAccessScope as SinonStub
    ...
    it('invokes getDataAccessScope with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getDataAccessScope = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateDataAccessScope', () => {
    it('invokes updateDataAccessScope without error', async () => {
      ...
      client.innerApiCalls.updateDataAccessScope =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateDataAccessScope(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateDataAccessScope as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateDataAccessScope as SinonStub
    ...
    it('invokes updateDataAccessScope with error', async () => {
      ...
      const expectedHeaderRequestParams = `data_access_scope.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateDataAccessScope = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateDataAccessScope(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateDataAccessScope as SinonStub
  ...
  describe('deleteDataAccessScope', () => {
    it('invokes deleteDataAccessScope without error', async () => {
      ...
      client.innerApiCalls.deleteDataAccessScope =
        stubSimpleCall(expectedResponse);
      const [response] = await client.deleteDataAccessScope(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteDataAccessScope as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteDataAccessScope as SinonStub
    ...
    it('invokes deleteDataAccessScope with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteDataAccessScope = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteDataAccessScope(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteDataAccessScope as SinonStub
  ...
  describe('listDataAccessLabels', () => {
    it('invokes listDataAccessLabels without error', async () => {
      ...
      client.innerApiCalls.listDataAccessLabels =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listDataAccessLabels(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listDataAccessLabels as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listDataAccessLabels as SinonStub
    ...
    it('invokes listDataAccessLabels with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listDataAccessLabels = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listDataAccessLabelsStream without error', async () => {
      ...
      client.descriptors.page.listDataAccessLabels.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.chronicle.v1.DataAccessLabel) => {
      ...
      assert(
        (client.descriptors.page.listDataAccessLabels.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listDataAccessLabels, request),
      );
      assert(
        (client.descriptors.page.listDataAccessLabels.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listDataAccessLabels without error', async () => {
      ...
      client.descriptors.page.listDataAccessLabels.asyncIterate =
  ...
  describe('listDataAccessScopes', () => {
    it('invokes listDataAccessScopes without error', async () => {
      ...
      client.innerApiCalls.listDataAccessScopes =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listDataAccessScopes(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listDataAccessScopes as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listDataAccessScopes as SinonStub
    ...
    it('invokes listDataAccessScopes with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listDataAccessScopes = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listDataAccessScopesStream without error', async () => {
      ...
      client.descriptors.page.listDataAccessScopes.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.chronicle.v1.DataAccessScope) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listDataAccessScopes.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listDataAccessScopes, request),
      );
      assert(
        (client.descriptors.page.listDataAccessScopes.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listDataAccessScopes without error', async () => {
      ...
      client.descriptors.page.listDataAccessScopes.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
