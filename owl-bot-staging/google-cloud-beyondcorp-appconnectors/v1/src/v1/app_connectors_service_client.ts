 ...
 */
  async checkCreateAppConnectorProgress(name: string): Promise<LROperation<protos.google.cloud.beyondcorp.appconnectors.v1.AppConnector, protos.google.cloud.beyondcorp.appconnectors.v1.AppConnectorOperationMetadata>>{
    ...
    const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.createAppConnector, gax.createDefaultBackoffSettings());
 ...
 */
  async checkUpdateAppConnectorProgress(name: string): Promise<LROperation<protos.google.cloud.beyondcorp.appconnectors.v1.AppConnector, protos.google.cloud.beyondcorp.appconnectors.v1.AppConnectorOperationMetadata>>{
    const request = new operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.updateAppConnector, gax.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.beyondcorp.appconnectors.v1.AppConnector, protos.google.cloud.beyondcorp.appconnectors.v1.AppConnectorOperationMetadata>;
  }
/**
 ...
 */
  async checkDeleteAppConnectorProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.beyondcorp.appconnectors.v1.AppConnectorOperationMetadata>>{
    const request = new operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.deleteAppConnector, gax.createDefaultBackoffSettings());
 ...
 */
  async checkReportStatusProgress(name: string): Promise<LROperation<protos.google.cloud.beyondcorp.appconnectors.v1.AppConnector, protos.google.cloud.beyondcorp.appconnectors.v1.AppConnectorOperationMetadata>>{
    const request = new operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.reportStatus, gax.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.beyondcorp.appconnectors.v1.AppConnector, protos.google.cloud.beyondcorp.appconnectors.v1.AppConnectorOperationMetadata>;
  }
 /**
