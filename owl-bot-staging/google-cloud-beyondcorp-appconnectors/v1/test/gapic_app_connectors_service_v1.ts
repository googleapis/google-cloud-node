...
describe('v1.AppConnectorsServiceClient', () => {
    ...
    describe('getAppConnector', () => {
        it('invokes getAppConnector without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.beyondcorp.appconnectors.v1.AppConnector());
            ...
            assert((client.innerApiCalls.getAppConnector as SinonStub)
    ...
    describe('createAppConnector', () => {
        it('invokes createAppConnector without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createAppConnector as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateAppConnector', () => {
        it('invokes updateAppConnector without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.beyondcorp.appconnectors.v1.UpdateAppConnectorRequest());
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateAppConnector as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteAppConnector', () => {
        it('invokes deleteAppConnector without error', async () => {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteAppConnector as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('reportStatus', () => {
        it('invokes reportStatus without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.beyondcorp.appconnectors.v1.ReportStatusRequest());
            request.appConnector = '';
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.reportStatus as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listAppConnectors', () => {
        it('invokes listAppConnectors without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.beyondcorp.appconnectors.v1.ListAppConnectorsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listAppConnectors as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
