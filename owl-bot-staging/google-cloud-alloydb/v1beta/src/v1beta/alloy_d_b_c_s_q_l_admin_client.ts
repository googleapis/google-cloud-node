 ...
 * `src/v1beta/alloy_d_b_c_s_q_l_admin_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './alloy_d_b_c_s_q_l_admin_client_config.json';
 ...
 * @memberof v1beta
 */
export class AlloyDBCSQLAdminClient {
  ...
  alloyDBCSQLAdminStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of AlloyDBCSQLAdminClient.
   *
   ...
   *     const client = new AlloyDBCSQLAdminClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof AlloyDBCSQLAdminClient;
    ...
    const restoreFromCloudSQLResponse = protoFilesRoot.lookup(
      '.google.cloud.alloydb.v1beta.Cluster') as gax.protobuf.Type;
    const restoreFromCloudSQLMetadata = protoFilesRoot.lookup(
      '.google.cloud.alloydb.v1beta.OperationMetadata') as gax.protobuf.Type;

    this.descriptors.longrunning = {
      restoreFromCloudSQL: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        restoreFromCloudSQLResponse.decode.bind(restoreFromCloudSQLResponse),
        restoreFromCloudSQLMetadata.decode.bind(restoreFromCloudSQLMetadata))
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.alloydb.v1beta.AlloyDBCSQLAdmin', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.alloyDBCSQLAdminStub) {
      return this.alloyDBCSQLAdminStub;
    }

    // Put together the "service stub" for
    // google.cloud.alloydb.v1beta.AlloyDBCSQLAdmin.
    this.alloyDBCSQLAdminStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.alloydb.v1beta.AlloyDBCSQLAdmin') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.alloydb.v1beta.AlloyDBCSQLAdmin,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const alloyDBCSQLAdminStubMethods =
        ['restoreFromCloudSqL'];
    for (const methodName of alloyDBCSQLAdminStubMethods) {
      const callPromise = this.alloyDBCSQLAdminStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 * @param {google.cloud.alloydb.v1beta.CloudSQLBackupRunSource} request.cloudsqlBackupRunSource
 ...
 * @example <caption>include:samples/generated/v1beta/alloy_d_b_c_s_q_l_admin.restore_from_cloud_s_q_l.js</caption>
 * region_tag:alloydb_v1beta_generated_AlloyDBCSQLAdmin_RestoreFromCloudSQL_async
 */
  restoreFromCloudSQL(
      request?: protos.google.cloud.alloydb.v1beta.IRestoreFromCloudSQLRequest,
      options?: CallOptions):
      Promise<[
  ...
  restoreFromCloudSQL(
    ...
    const wrappedCallback: Callback<
      ...
      ? (error, response, rawResponse, _) => {
          this._log.info('restoreFromCloudSQL response %j', rawResponse);
          callback!(error, response, rawResponse, _); // We verified callback above.
        }
      : undefined;
    this._log.info('restoreFromCloudSQL request %j', request);
    return this.innerApiCalls.restoreFromCloudSqL(request, options, wrappedCallback)
...
/**
 * Check the status of the long running operation returned by `restoreFromCloudSQL()`.
 * @param {String} name
 ...
 * region_tag:alloydb_v1beta_generated_AlloyDBCSQLAdmin_RestoreFromCloudSQL_async
 */
  async checkRestoreFromCloudSQLProgress(name: string): Promise<LROperation<protos.google.cloud.alloydb.v1beta.Cluster, protos.google.cloud.alloydb.v1beta.OperationMetadata>>{
    this._log.info('restoreFromCloudSQL long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.restoreFromCloudSQL, this._gaxModule.createDefaultBackoffSettings());
...
/**
   ...
   */
  close(): Promise<void> {
    if (this.alloyDBCSQLAdminStub && !this._terminated) {
      return this.alloyDBCSQLAdminStub.then(stub => {
