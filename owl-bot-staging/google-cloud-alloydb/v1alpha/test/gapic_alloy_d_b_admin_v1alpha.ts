...
describe('v1alpha.AlloyDBAdminClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = alloydbadminModule.v1alpha.AlloyDBAdminClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = alloydbadminModule.v1alpha.AlloyDBAdminClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'alloydb.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new alloydbadminModule.v1alpha.AlloyDBAdminClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'alloydb.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new alloydbadminModule.v1alpha.AlloyDBAdminClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'alloydb.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new alloydbadminModule.v1alpha.AlloyDBAdminClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new alloydbadminModule.v1alpha.AlloyDBAdminClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getCluster', () => {
        it('invokes getCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.GetClusterRequest', ['name']);
        ...
        it('invokes getCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCluster(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.alloydb.v1alpha.ICluster|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getInstance', () => {
        it('invokes getInstance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.GetInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getInstance without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getInstance(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.alloydb.v1alpha.IInstance|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('executeSql', () => {
        it('invokes executeSql without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.alloydb.v1alpha.ExecuteSqlRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.ExecuteSqlRequest', ['instance']);
            request.instance = defaultValue1;
            const expectedHeaderRequestParams = `instance=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.alloydb.v1alpha.ExecuteSqlResponse()
            );
        ...
        it('invokes executeSql without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.executeSql(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.alloydb.v1alpha.IExecuteSqlResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getBackup', () => {
        it('invokes getBackup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.GetBackupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getBackup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getBackup(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.alloydb.v1alpha.IBackup|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateClientCertificate', () => {
        it('invokes generateClientCertificate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.GenerateClientCertificateRequest', ['parent']);
        ...
        it('invokes generateClientCertificate without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateClientCertificate(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.alloydb.v1alpha.IGenerateClientCertificateResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getConnectionInfo', () => {
        it('invokes getConnectionInfo without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.GetConnectionInfoRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getConnectionInfo without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getConnectionInfo(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.alloydb.v1alpha.IConnectionInfo|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getUser', () => {
        it('invokes getUser without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.GetUserRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getUser without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getUser(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.alloydb.v1alpha.IUser|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createUser', () => {
        it('invokes createUser without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.CreateUserRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.alloydb.v1alpha.User()
    ...
    describe('updateUser', () => {
        it('invokes updateUser without error', async () => {
            ...
            request.user ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.UpdateUserRequest', ['user', 'name']);
    ...
    describe('deleteUser', () => {
        it('invokes deleteUser without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.DeleteUserRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createCluster', () => {
        it('invokes createCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.CreateClusterRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes createCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createCluster(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.alloydb.v1alpha.ICluster, protos.google.cloud.alloydb.v1alpha.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.alloydb.v1alpha.ICluster, protos.google.cloud.alloydb.v1alpha.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createCluster as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateCluster', () => {
        it('invokes updateCluster without error', async () => {
            ...
            request.cluster ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.UpdateClusterRequest', ['cluster', 'name']);
    ...
    describe('upgradeCluster', () => {
        it('invokes upgradeCluster without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.alloydb.v1alpha.UpgradeClusterRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.UpgradeClusterRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes upgradeCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.upgradeCluster(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.alloydb.v1alpha.IUpgradeClusterResponse, protos.google.cloud.alloydb.v1alpha.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.alloydb.v1alpha.IUpgradeClusterResponse, protos.google.cloud.alloydb.v1alpha.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.upgradeCluster as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteCluster', () => {
        it('invokes deleteCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.DeleteClusterRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes deleteCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deleteCluster(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.alloydb.v1alpha.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.alloydb.v1alpha.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteCluster as SinonStub)
                .getCall(0).args[0];
    ...
    describe('promoteCluster', () => {
        it('invokes promoteCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.PromoteClusterRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('switchoverCluster', () => {
        it('invokes switchoverCluster without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.alloydb.v1alpha.SwitchoverClusterRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.SwitchoverClusterRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('restoreCluster', () => {
        it('invokes restoreCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.RestoreClusterRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createSecondaryCluster', () => {
        it('invokes createSecondaryCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.CreateSecondaryClusterRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createInstance', () => {
        it('invokes createInstance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.CreateInstanceRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createInstance without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createInstance(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.alloydb.v1alpha.IInstance, protos.google.cloud.alloydb.v1alpha.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.alloydb.v1alpha.IInstance, protos.google.cloud.alloydb.v1alpha.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createInstance as SinonStub)
                .getCall(0).args[0];
    ...
    describe('createSecondaryInstance', () => {
        it('invokes createSecondaryInstance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.CreateSecondaryInstanceRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('batchCreateInstances', () => {
        it('invokes batchCreateInstances without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.BatchCreateInstancesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes batchCreateInstances without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchCreateInstances(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.alloydb.v1alpha.IBatchCreateInstancesResponse, protos.google.cloud.alloydb.v1alpha.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.alloydb.v1alpha.IBatchCreateInstancesResponse, protos.google.cloud.alloydb.v1alpha.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchCreateInstances as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateInstance', () => {
        it('invokes updateInstance without error', async () => {
            ...
            request.instance ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.UpdateInstanceRequest', ['instance', 'name']);
    ...
    describe('deleteInstance', () => {
        it('invokes deleteInstance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.DeleteInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('failoverInstance', () => {
        it('invokes failoverInstance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.FailoverInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('injectFault', () => {
        it('invokes injectFault without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.InjectFaultRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('restartInstance', () => {
        it('invokes restartInstance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.RestartInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createBackup', () => {
        it('invokes createBackup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.CreateBackupRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createBackup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createBackup(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.alloydb.v1alpha.IBackup, protos.google.cloud.alloydb.v1alpha.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.alloydb.v1alpha.IBackup, protos.google.cloud.alloydb.v1alpha.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createBackup as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateBackup', () => {
        it('invokes updateBackup without error', async () => {
            ...
            request.backup ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.UpdateBackupRequest', ['backup', 'name']);
    ...
    describe('deleteBackup', () => {
        it('invokes deleteBackup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.DeleteBackupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listClusters', () => {
        it('invokes listClusters without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.ListClustersRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.alloydb.v1alpha.Cluster()),
              generateSampleMessage(new protos.google.cloud.alloydb.v1alpha.Cluster()),
              generateSampleMessage(new protos.google.cloud.alloydb.v1alpha.Cluster()),
            ];
        ...
        it('invokes listClustersStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.alloydb.v1alpha.Cluster) => {
    ...
    describe('listInstances', () => {
        it('invokes listInstances without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.ListInstancesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.alloydb.v1alpha.Instance()),
              generateSampleMessage(new protos.google.cloud.alloydb.v1alpha.Instance()),
              generateSampleMessage(new protos.google.cloud.alloydb.v1alpha.Instance()),
            ];
        ...
        it('invokes listInstancesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.alloydb.v1alpha.Instance) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listBackups', () => {
        it('invokes listBackups without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.ListBackupsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
        ...
        it('invokes listBackupsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.alloydb.v1alpha.Backup) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listSupportedDatabaseFlags', () => {
        it('invokes listSupportedDatabaseFlags without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.ListSupportedDatabaseFlagsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.alloydb.v1alpha.SupportedDatabaseFlag()),
              generateSampleMessage(new protos.google.cloud.alloydb.v1alpha.SupportedDatabaseFlag()),
              generateSampleMessage(new protos.google.cloud.alloydb.v1alpha.SupportedDatabaseFlag()),
            ];
        ...
        it('invokes listSupportedDatabaseFlags without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listSupportedDatabaseFlags(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.alloydb.v1alpha.ISupportedDatabaseFlag[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listSupportedDatabaseFlagsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.alloydb.v1alpha.SupportedDatabaseFlag) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listUsers', () => {
        it('invokes listUsers without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.ListUsersRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
        ...
        it('invokes listUsersStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.alloydb.v1alpha.User) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listDatabases', () => {
        it('invokes listDatabases without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.ListDatabasesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.alloydb.v1alpha.Database()),
              generateSampleMessage(new protos.google.cloud.alloydb.v1alpha.Database()),
              generateSampleMessage(new protos.google.cloud.alloydb.v1alpha.Database()),
            ];
        ...
        it('invokes listDatabases without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listDatabases(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.alloydb.v1alpha.IDatabase[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listDatabasesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.alloydb.v1alpha.Database) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
