...
export class AlloyDBAdminClient {
  ...
  initialize() {
    ...
    const alloyDBAdminStubMethods =
        ['listClusters', 'getCluster', 'createCluster', 'updateCluster', 'deleteCluster', 'promoteCluster', 'restoreCluster', 'createSecondaryCluster', 'listInstances', 'getInstance', 'createInstance', 'createSecondaryInstance', 'batchCreateInstances', 'updateInstance', 'deleteInstance', 'failoverInstance', 'injectFault', 'restartInstance', 'listBackups', 'getBackup', 'createBackup', 'updateBackup', 'deleteBackup', 'listSupportedDatabaseFlags', 'generateClientCertificate', 'getConnectionInfo', 'listUsers', 'getUser', 'createUser', 'updateUser', 'deleteUser', 'listDatabases'];
