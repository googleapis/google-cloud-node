 ...
 * `src/v1/game_server_configs_service_client_config.json`.
...
export class GameServerConfigsServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this.descriptors.page = {
      listGameServerConfigs:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'gameServerConfigs')
    };
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.gaming.v1.GameServerConfigsService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.gameServerConfigsServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.gaming.v1.GameServerConfigsService') :
 ...
 *   The first element of the array is an object representing {@link protos.google.cloud.gaming.v1.GameServerConfig|GameServerConfig}.
 ...
 */
  getGameServerConfig(
      ...
      Promise<[
        ...
        protos.google.cloud.gaming.v1.IGetGameServerConfigRequest|undefined, {}|undefined
      ]>;
  getGameServerConfig(
      request: protos.google.cloud.gaming.v1.IGetGameServerConfigRequest,
      options: CallOptions,
 ...
 */
  async checkCreateGameServerConfigProgress(name: string): Promise<LROperation<protos.google.cloud.gaming.v1.GameServerConfig, protos.google.cloud.gaming.v1.OperationMetadata>>{
    ...
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.createGameServerConfig, this._gaxModule.createDefaultBackoffSettings());
 ...
 */
  async checkDeleteGameServerConfigProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.gaming.v1.OperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.deleteGameServerConfig, this._gaxModule.createDefaultBackoffSettings());
 ...
 *   {@link protos.google.cloud.gaming.v1.ListGameServerConfigsResponse.next_page_token|next_page_token} to
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.cloud.gaming.v1.GameServerConfig|GameServerConfig}.
 ...
 */
  ...
  listGameServerConfigs(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.gaming.v1.IGameServerConfig>): void;
  listGameServerConfigs(
      request: protos.google.cloud.gaming.v1.IListGameServerConfigsRequest,
      callback: PaginationCallback<
          protos.google.cloud.gaming.v1.IListGameServerConfigsRequest,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.cloud.gaming.v1.GameServerConfig|GameServerConfig} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   {@link protos.google.cloud.gaming.v1.GameServerConfig|GameServerConfig}. The API will be called under the hood as needed, once per the page,
