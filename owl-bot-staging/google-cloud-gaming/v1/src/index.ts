...
const GameServerDeploymentsServiceClient = v1.GameServerDeploymentsServiceClient;
...
export {v1, GameServerClustersServiceClient, GameServerConfigsServiceClient, GameServerDeploymentsServiceClient, RealmsServiceClient};
export default {v1, GameServerClustersServiceClient, GameServerConfigsServiceClient, GameServerDeploymentsServiceClient, RealmsServiceClient};
