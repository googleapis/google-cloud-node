...
describe('v1.GameServerDeploymentsServiceClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = gameserverdeploymentsserviceModule.v1.GameServerDeploymentsServiceClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = gameserverdeploymentsserviceModule.v1.GameServerDeploymentsServiceClient.apiEndpoint;
            assert(apiEndpoint);
        });

        it('has port', () => {
            const port = gameserverdeploymentsserviceModule.v1.GameServerDeploymentsServiceClient.port;
            assert(port);
            assert(typeof port === 'number');
        });

        it('should create a client with no option', () => {
            const client = new gameserverdeploymentsserviceModule.v1.GameServerDeploymentsServiceClient();
            assert(client);
        });
    ...
    describe('getGameServerDeployment', () => {
        it('invokes getGameServerDeployment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1.GetGameServerDeploymentRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getGameServerDeployment as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getGameServerDeployment as SinonStub)
        ...
        it('invokes getGameServerDeployment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getGameServerDeployment(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.gaming.v1.IGameServerDeployment|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getGameServerDeployment with error', async () => {
            ...
            await assert.rejects(client.getGameServerDeployment(request), expectedError);
            const actualRequest = (client.innerApiCalls.getGameServerDeployment as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getGameServerDeployment as SinonStub)
    ...
    describe('getGameServerDeploymentRollout', () => {
        it('invokes getGameServerDeploymentRollout without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1.GetGameServerDeploymentRolloutRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getGameServerDeploymentRollout as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getGameServerDeploymentRollout as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getGameServerDeploymentRollout without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getGameServerDeploymentRollout(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.gaming.v1.IGameServerDeploymentRollout|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getGameServerDeploymentRollout with error', async () => {
            ...
            await assert.rejects(client.getGameServerDeploymentRollout(request), expectedError);
            const actualRequest = (client.innerApiCalls.getGameServerDeploymentRollout as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getGameServerDeploymentRollout as SinonStub)
    ...
    describe('previewGameServerDeploymentRollout', () => {
        it('invokes previewGameServerDeploymentRollout without error', async () => {
            ...
            request.rollout ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1.PreviewGameServerDeploymentRolloutRequest', ['rollout', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.previewGameServerDeploymentRollout as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.previewGameServerDeploymentRollout as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes previewGameServerDeploymentRollout without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.previewGameServerDeploymentRollout(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.gaming.v1.IPreviewGameServerDeploymentRolloutResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes previewGameServerDeploymentRollout with error', async () => {
            ...
            await assert.rejects(client.previewGameServerDeploymentRollout(request), expectedError);
            const actualRequest = (client.innerApiCalls.previewGameServerDeploymentRollout as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.previewGameServerDeploymentRollout as SinonStub)
    ...
    describe('fetchDeploymentState', () => {
        it('invokes fetchDeploymentState without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1.FetchDeploymentStateRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.fetchDeploymentState as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.fetchDeploymentState as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes fetchDeploymentState without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.fetchDeploymentState(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.gaming.v1.IFetchDeploymentStateResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createGameServerDeployment', () => {
        it('invokes createGameServerDeployment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1.CreateGameServerDeploymentRequest', ['parent']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createGameServerDeployment as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createGameServerDeployment as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createGameServerDeployment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createGameServerDeployment(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.gaming.v1.IGameServerDeployment, protos.google.cloud.gaming.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.gaming.v1.IGameServerDeployment, protos.google.cloud.gaming.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createGameServerDeployment as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createGameServerDeployment with call error', async () => {
            ...
            await assert.rejects(client.createGameServerDeployment(request), expectedError);
            const actualRequest = (client.innerApiCalls.createGameServerDeployment as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createGameServerDeployment as SinonStub)
        ...
        it('invokes checkCreateGameServerDeploymentProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateGameServerDeploymentProgress(expectedResponse.name);
        ...
        it('invokes checkCreateGameServerDeploymentProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreateGameServerDeploymentProgress(''), expectedError);
    ...
    describe('deleteGameServerDeployment', () => {
        it('invokes deleteGameServerDeployment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1.DeleteGameServerDeploymentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteGameServerDeployment as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteGameServerDeployment as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteGameServerDeployment with call error', async () => {
            ...
            await assert.rejects(client.deleteGameServerDeployment(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteGameServerDeployment as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteGameServerDeployment as SinonStub)
        ...
        it('invokes checkDeleteGameServerDeploymentProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteGameServerDeploymentProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteGameServerDeploymentProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteGameServerDeploymentProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('updateGameServerDeployment', () => {
        it('invokes updateGameServerDeployment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1.UpdateGameServerDeploymentRequest', ['gameServerDeployment', 'name']);
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateGameServerDeployment as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateGameServerDeployment as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateGameServerDeployment with call error', async () => {
            ...
            await assert.rejects(client.updateGameServerDeployment(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateGameServerDeployment as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateGameServerDeployment as SinonStub)
        ...
        it('invokes checkUpdateGameServerDeploymentProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateGameServerDeploymentProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateGameServerDeploymentProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateGameServerDeploymentProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('updateGameServerDeploymentRollout', () => {
        it('invokes updateGameServerDeploymentRollout without error', async () => {
            ...
            request.rollout ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1.UpdateGameServerDeploymentRolloutRequest', ['rollout', 'name']);
            request.rollout.name = defaultValue1;
            const expectedHeaderRequestParams = `rollout.name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateGameServerDeploymentRollout as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateGameServerDeploymentRollout as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateGameServerDeploymentRollout with call error', async () => {
            ...
            await assert.rejects(client.updateGameServerDeploymentRollout(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateGameServerDeploymentRollout as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateGameServerDeploymentRollout as SinonStub)
        ...
        it('invokes checkUpdateGameServerDeploymentRolloutProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateGameServerDeploymentRolloutProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateGameServerDeploymentRolloutProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateGameServerDeploymentRolloutProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listGameServerDeployments', () => {
        it('invokes listGameServerDeployments without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1.ListGameServerDeploymentsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.gaming.v1.GameServerDeployment()),
              generateSampleMessage(new protos.google.cloud.gaming.v1.GameServerDeployment()),
              generateSampleMessage(new protos.google.cloud.gaming.v1.GameServerDeployment()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listGameServerDeployments as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listGameServerDeployments as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listGameServerDeployments with error', async () => {
            ...
            await assert.rejects(client.listGameServerDeployments(request), expectedError);
            const actualRequest = (client.innerApiCalls.listGameServerDeployments as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listGameServerDeployments as SinonStub)
        ...
        it('invokes listGameServerDeploymentsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.gaming.v1.GameServerDeployment) => {
