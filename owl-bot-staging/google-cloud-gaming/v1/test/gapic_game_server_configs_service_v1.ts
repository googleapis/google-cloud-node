...
describe('v1.GameServerConfigsServiceClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = gameserverconfigsserviceModule.v1.GameServerConfigsServiceClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = gameserverconfigsserviceModule.v1.GameServerConfigsServiceClient.apiEndpoint;
            assert(apiEndpoint);
        });

        it('has port', () => {
            const port = gameserverconfigsserviceModule.v1.GameServerConfigsServiceClient.port;
            assert(port);
    ...
    describe('getGameServerConfig', () => {
        it('invokes getGameServerConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1.GetGameServerConfigRequest', ['name']);
        ...
        it('invokes getGameServerConfig without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getGameServerConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.gaming.v1.IGameServerConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createGameServerConfig', () => {
        it('invokes createGameServerConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1.CreateGameServerConfigRequest', ['parent']);
        ...
        it('invokes createGameServerConfig without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createGameServerConfig(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.gaming.v1.IGameServerConfig, protos.google.cloud.gaming.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.gaming.v1.IGameServerConfig, protos.google.cloud.gaming.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createGameServerConfig as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteGameServerConfig', () => {
        it('invokes deleteGameServerConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1.DeleteGameServerConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listGameServerConfigs', () => {
        it('invokes listGameServerConfigs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1.ListGameServerConfigsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.gaming.v1.GameServerConfig()),
              generateSampleMessage(new protos.google.cloud.gaming.v1.GameServerConfig()),
              generateSampleMessage(new protos.google.cloud.gaming.v1.GameServerConfig()),
            ];
        ...
        it('invokes listGameServerConfigsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.gaming.v1.GameServerConfig) => {
