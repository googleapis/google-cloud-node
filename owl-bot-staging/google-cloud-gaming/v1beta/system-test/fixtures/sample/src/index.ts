...
function doStuffWithGameServerClustersServiceClient(client: GameServerClustersServiceClient) {
  client.close();
}
function doStuffWithGameServerConfigsServiceClient(client: GameServerConfigsServiceClient) {
  client.close();
}
function doStuffWithGameServerDeploymentsServiceClient(client: GameServerDeploymentsServiceClient) {
  client.close();
}
...
function main() {
  ...
  doStuffWithGameServerDeploymentsServiceClient(gameServerDeploymentsServiceClient);
  // check that the client instance can be created
