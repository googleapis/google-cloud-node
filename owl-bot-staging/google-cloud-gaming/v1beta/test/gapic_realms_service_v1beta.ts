...
describe('v1beta.RealmsServiceClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = realmsserviceModule.v1beta.RealmsServiceClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = realmsserviceModule.v1beta.RealmsServiceClient.apiEndpoint;
            assert(apiEndpoint);
        });
    ...
    describe('getRealm', () => {
        it('invokes getRealm without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1beta.GetRealmRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.gaming.v1beta.Realm()
            );
        ...
        it('invokes getRealm without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getRealm(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.gaming.v1beta.IRealm|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('previewRealmUpdate', () => {
        it('invokes previewRealmUpdate without error', async () => {
            ...
            request.realm ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1beta.PreviewRealmUpdateRequest', ['realm', 'name']);
            request.realm.name = defaultValue1;
            const expectedHeaderRequestParams = `realm.name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.gaming.v1beta.PreviewRealmUpdateResponse()
            );
        ...
        it('invokes previewRealmUpdate without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.previewRealmUpdate(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.gaming.v1beta.IPreviewRealmUpdateResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createRealm', () => {
        it('invokes createRealm without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1beta.CreateRealmRequest', ['parent']);
        ...
        it('invokes createRealm without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createRealm(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.gaming.v1beta.IRealm, protos.google.cloud.gaming.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.gaming.v1beta.IRealm, protos.google.cloud.gaming.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createRealm as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteRealm', () => {
        it('invokes deleteRealm without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1beta.DeleteRealmRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('updateRealm', () => {
        it('invokes updateRealm without error', async () => {
            ...
            request.realm ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1beta.UpdateRealmRequest', ['realm', 'name']);
            request.realm.name = defaultValue1;
            const expectedHeaderRequestParams = `realm.name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listRealms', () => {
        it('invokes listRealms without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1beta.ListRealmsRequest', ['parent']);
            request.parent = defaultValue1;
        ...
        it('invokes listRealmsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.gaming.v1beta.Realm) => {
