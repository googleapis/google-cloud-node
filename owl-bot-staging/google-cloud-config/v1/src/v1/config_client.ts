...
export class ConfigClient {
  ...
  initialize() {
    ...
    const configStubMethods =
        ['listDeployments', 'getDeployment', 'createDeployment', 'updateDeployment', 'deleteDeployment', 'listRevisions', 'getRevision', 'getResource', 'listResources', 'exportDeploymentStatefile', 'exportRevisionStatefile', 'importStatefile', 'deleteStatefile', 'lockDeployment', 'unlockDeployment', 'exportLockInfo'];
 ...
 */
  ...
  exportDeploymentStatefile(
    ...
    this.initialize();
    return this.innerApiCalls.exportDeploymentStatefile(request, options, callback);
  }
/**
 ...
 */
  ...
  exportRevisionStatefile(
    ...
    this.initialize();
    return this.innerApiCalls.exportRevisionStatefile(request, options, callback);
  }
/**
