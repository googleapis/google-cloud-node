 ...
 * `src/v1/area_insights_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './area_insights_client_config.json';
 ...
 * @memberof v1
 */
export class AreaInsightsClient {
  ...
  areaInsightsStub?: Promise<{[name: string]: Function}>;
  ...
  initialize() {
    ...
    if (this.areaInsightsStub) {
      return this.areaInsightsStub;
    }
 ...
 */
  ...
  computeInsights(
    ...
    this.initialize();
    return this.innerApiCalls.computeInsights(request, options, callback);
  }
   ...
   */
  close(): Promise<void> {
    if (this.areaInsightsStub && !this._terminated) {
      return this.areaInsightsStub.then(stub => {
