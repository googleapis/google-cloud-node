    ...
    describe('Path templates', () => {
        ...
        describe('folderLocationEffectiveEventThreatDetectionCustomModule', () => {
            ...
            it('folderLocationEffectiveEventThreatDetectionCustomModulePath', () => {
                const result = client.folderLocationEffectiveEventThreatDetectionCustomModulePath("folderValue", "locationValue", "effectiveEventThreatDetectionCustomModuleValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.folderLocationEffectiveEventThreatDetectionCustomModulePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchFolderFromFolderLocationEffectiveEventThreatDetectionCustomModuleName', () => {
                const result = client.matchFolderFromFolderLocationEffectiveEventThreatDetectionCustomModuleName(fakePath);
                assert.strictEqual(result, "folderValue");
                assert((client.pathTemplates.folderLocationEffectiveEventThreatDetectionCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromFolderLocationEffectiveEventThreatDetectionCustomModuleName', () => {
                const result = client.matchLocationFromFolderLocationEffectiveEventThreatDetectionCustomModuleName(fakePath);
            ...
            it('matchEffectiveEventThreatDetectionCustomModuleFromFolderLocationEffectiveEventThreatDetectionCustomModuleName', () => {
                const result = client.matchEffectiveEventThreatDetectionCustomModuleFromFolderLocationEffectiveEventThreatDetectionCustomModuleName(fakePath);
        ...
        describe('folderLocationEffectiveSecurityHealthAnalyticsCustomModule', () => {
            ...
            it('folderLocationEffectiveSecurityHealthAnalyticsCustomModulePath', () => {
                const result = client.folderLocationEffectiveSecurityHealthAnalyticsCustomModulePath("folderValue", "locationValue", "effectiveSecurityHealthAnalyticsCustomModuleValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.folderLocationEffectiveSecurityHealthAnalyticsCustomModulePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchFolderFromFolderLocationEffectiveSecurityHealthAnalyticsCustomModuleName', () => {
                const result = client.matchFolderFromFolderLocationEffectiveSecurityHealthAnalyticsCustomModuleName(fakePath);
                assert.strictEqual(result, "folderValue");
                assert((client.pathTemplates.folderLocationEffectiveSecurityHealthAnalyticsCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromFolderLocationEffectiveSecurityHealthAnalyticsCustomModuleName', () => {
                const result = client.matchLocationFromFolderLocationEffectiveSecurityHealthAnalyticsCustomModuleName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.folderLocationEffectiveSecurityHealthAnalyticsCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchEffectiveSecurityHealthAnalyticsCustomModuleFromFolderLocationEffectiveSecurityHealthAnalyticsCustomModuleName', () => {
                const result = client.matchEffectiveSecurityHealthAnalyticsCustomModuleFromFolderLocationEffectiveSecurityHealthAnalyticsCustomModuleName(fakePath);
        ...
        describe('folderLocationEventThreatDetectionCustomModule', () => {
            const fakePath = "/rendered/path/folderLocationEventThreatDetectionCustomModule";
            const expectedParameters = {
                folder: "folderValue",
                location: "locationValue",
            ...
            it('folderLocationEventThreatDetectionCustomModulePath', () => {
                const result = client.folderLocationEventThreatDetectionCustomModulePath("folderValue", "locationValue", "eventThreatDetectionCustomModuleValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.folderLocationEventThreatDetectionCustomModulePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchFolderFromFolderLocationEventThreatDetectionCustomModuleName', () => {
                const result = client.matchFolderFromFolderLocationEventThreatDetectionCustomModuleName(fakePath);
                assert.strictEqual(result, "folderValue");
                assert((client.pathTemplates.folderLocationEventThreatDetectionCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchEventThreatDetectionCustomModuleFromFolderLocationEventThreatDetectionCustomModuleName', () => {
                const result = client.matchEventThreatDetectionCustomModuleFromFolderLocationEventThreatDetectionCustomModuleName(fakePath);
        ...
        describe('folderLocationSecurityHealthAnalyticsCustomModule', () => {
            const fakePath = "/rendered/path/folderLocationSecurityHealthAnalyticsCustomModule";
            const expectedParameters = {
                folder: "folderValue",
                location: "locationValue",
            ...
            it('folderLocationSecurityHealthAnalyticsCustomModulePath', () => {
                const result = client.folderLocationSecurityHealthAnalyticsCustomModulePath("folderValue", "locationValue", "securityHealthAnalyticsCustomModuleValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.folderLocationSecurityHealthAnalyticsCustomModulePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchFolderFromFolderLocationSecurityHealthAnalyticsCustomModuleName', () => {
                const result = client.matchFolderFromFolderLocationSecurityHealthAnalyticsCustomModuleName(fakePath);
                assert.strictEqual(result, "folderValue");
                assert((client.pathTemplates.folderLocationSecurityHealthAnalyticsCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromFolderLocationSecurityHealthAnalyticsCustomModuleName', () => {
                const result = client.matchLocationFromFolderLocationSecurityHealthAnalyticsCustomModuleName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.folderLocationSecurityHealthAnalyticsCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchSecurityHealthAnalyticsCustomModuleFromFolderLocationSecurityHealthAnalyticsCustomModuleName', () => {
                const result = client.matchSecurityHealthAnalyticsCustomModuleFromFolderLocationSecurityHealthAnalyticsCustomModuleName(fakePath);
        ...
        describe('folderLocationService', () => {
            ...
            client.initialize();
            client.pathTemplates.folderLocationServicePathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.folderLocationServicePathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('folderLocationServicePath', () => {
                const result = client.folderLocationServicePath("folderValue", "locationValue", "serviceValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.folderLocationServicePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchFolderFromFolderLocationServiceName', () => {
                const result = client.matchFolderFromFolderLocationServiceName(fakePath);
                assert.strictEqual(result, "folderValue");
                assert((client.pathTemplates.folderLocationServicePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromFolderLocationServiceName', () => {
                const result = client.matchLocationFromFolderLocationServiceName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.folderLocationServicePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchServiceFromFolderLocationServiceName', () => {
                const result = client.matchServiceFromFolderLocationServiceName(fakePath);
        ...
        describe('organizationLocationEffectiveEventThreatDetectionCustomModule', () => {
            const fakePath = "/rendered/path/organizationLocationEffectiveEventThreatDetectionCustomModule";
            const expectedParameters = {
                organization: "organizationValue",
                location: "locationValue",
                effective_event_threat_detection_custom_module: "effectiveEventThreatDetectionCustomModuleValue",
            ...
            it('organizationLocationEffectiveEventThreatDetectionCustomModulePath', () => {
                const result = client.organizationLocationEffectiveEventThreatDetectionCustomModulePath("organizationValue", "locationValue", "effectiveEventThreatDetectionCustomModuleValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationLocationEffectiveEventThreatDetectionCustomModulePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationLocationEffectiveEventThreatDetectionCustomModuleName', () => {
                const result = client.matchOrganizationFromOrganizationLocationEffectiveEventThreatDetectionCustomModuleName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationLocationEffectiveEventThreatDetectionCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromOrganizationLocationEffectiveEventThreatDetectionCustomModuleName', () => {
                const result = client.matchLocationFromOrganizationLocationEffectiveEventThreatDetectionCustomModuleName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.organizationLocationEffectiveEventThreatDetectionCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchEffectiveEventThreatDetectionCustomModuleFromOrganizationLocationEffectiveEventThreatDetectionCustomModuleName', () => {
                const result = client.matchEffectiveEventThreatDetectionCustomModuleFromOrganizationLocationEffectiveEventThreatDetectionCustomModuleName(fakePath);
                assert.strictEqual(result, "effectiveEventThreatDetectionCustomModuleValue");
                assert((client.pathTemplates.organizationLocationEffectiveEventThreatDetectionCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('organizationLocationEffectiveSecurityHealthAnalyticsCustomModule', () => {
            const fakePath = "/rendered/path/organizationLocationEffectiveSecurityHealthAnalyticsCustomModule";
            const expectedParameters = {
                organization: "organizationValue",
                location: "locationValue",
                effective_security_health_analytics_custom_module: "effectiveSecurityHealthAnalyticsCustomModuleValue",
            ...
            it('organizationLocationEffectiveSecurityHealthAnalyticsCustomModulePath', () => {
                const result = client.organizationLocationEffectiveSecurityHealthAnalyticsCustomModulePath("organizationValue", "locationValue", "effectiveSecurityHealthAnalyticsCustomModuleValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationLocationEffectiveSecurityHealthAnalyticsCustomModulePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationLocationEffectiveSecurityHealthAnalyticsCustomModuleName', () => {
                const result = client.matchOrganizationFromOrganizationLocationEffectiveSecurityHealthAnalyticsCustomModuleName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationLocationEffectiveSecurityHealthAnalyticsCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromOrganizationLocationEffectiveSecurityHealthAnalyticsCustomModuleName', () => {
                const result = client.matchLocationFromOrganizationLocationEffectiveSecurityHealthAnalyticsCustomModuleName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.organizationLocationEffectiveSecurityHealthAnalyticsCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchEffectiveSecurityHealthAnalyticsCustomModuleFromOrganizationLocationEffectiveSecurityHealthAnalyticsCustomModuleName', () => {
                const result = client.matchEffectiveSecurityHealthAnalyticsCustomModuleFromOrganizationLocationEffectiveSecurityHealthAnalyticsCustomModuleName(fakePath);
                assert.strictEqual(result, "effectiveSecurityHealthAnalyticsCustomModuleValue");
                assert((client.pathTemplates.organizationLocationEffectiveSecurityHealthAnalyticsCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('organizationLocationEventThreatDetectionCustomModule', () => {
            const fakePath = "/rendered/path/organizationLocationEventThreatDetectionCustomModule";
            const expectedParameters = {
                organization: "organizationValue",
                location: "locationValue",
                event_threat_detection_custom_module: "eventThreatDetectionCustomModuleValue",
            ...
            it('organizationLocationEventThreatDetectionCustomModulePath', () => {
                const result = client.organizationLocationEventThreatDetectionCustomModulePath("organizationValue", "locationValue", "eventThreatDetectionCustomModuleValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationLocationEventThreatDetectionCustomModulePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationLocationEventThreatDetectionCustomModuleName', () => {
                const result = client.matchOrganizationFromOrganizationLocationEventThreatDetectionCustomModuleName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationLocationEventThreatDetectionCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromOrganizationLocationEventThreatDetectionCustomModuleName', () => {
                const result = client.matchLocationFromOrganizationLocationEventThreatDetectionCustomModuleName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.organizationLocationEventThreatDetectionCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchEventThreatDetectionCustomModuleFromOrganizationLocationEventThreatDetectionCustomModuleName', () => {
                const result = client.matchEventThreatDetectionCustomModuleFromOrganizationLocationEventThreatDetectionCustomModuleName(fakePath);
                assert.strictEqual(result, "eventThreatDetectionCustomModuleValue");
                assert((client.pathTemplates.organizationLocationEventThreatDetectionCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('organizationLocationSecurityHealthAnalyticsCustomModule', () => {
            const fakePath = "/rendered/path/organizationLocationSecurityHealthAnalyticsCustomModule";
            const expectedParameters = {
                organization: "organizationValue",
                location: "locationValue",
                security_health_analytics_custom_module: "securityHealthAnalyticsCustomModuleValue",
            ...
            it('organizationLocationSecurityHealthAnalyticsCustomModulePath', () => {
                const result = client.organizationLocationSecurityHealthAnalyticsCustomModulePath("organizationValue", "locationValue", "securityHealthAnalyticsCustomModuleValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationLocationSecurityHealthAnalyticsCustomModulePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationLocationSecurityHealthAnalyticsCustomModuleName', () => {
                const result = client.matchOrganizationFromOrganizationLocationSecurityHealthAnalyticsCustomModuleName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationLocationSecurityHealthAnalyticsCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromOrganizationLocationSecurityHealthAnalyticsCustomModuleName', () => {
                const result = client.matchLocationFromOrganizationLocationSecurityHealthAnalyticsCustomModuleName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.organizationLocationSecurityHealthAnalyticsCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchSecurityHealthAnalyticsCustomModuleFromOrganizationLocationSecurityHealthAnalyticsCustomModuleName', () => {
                const result = client.matchSecurityHealthAnalyticsCustomModuleFromOrganizationLocationSecurityHealthAnalyticsCustomModuleName(fakePath);
                assert.strictEqual(result, "securityHealthAnalyticsCustomModuleValue");
                assert((client.pathTemplates.organizationLocationSecurityHealthAnalyticsCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('organizationLocationService', () => {
            ...
            client.pathTemplates.organizationLocationServicePathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.organizationLocationServicePathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('organizationLocationServicePath', () => {
                const result = client.organizationLocationServicePath("organizationValue", "locationValue", "serviceValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationLocationServicePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationLocationServiceName', () => {
                const result = client.matchOrganizationFromOrganizationLocationServiceName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationLocationServicePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromOrganizationLocationServiceName', () => {
                const result = client.matchLocationFromOrganizationLocationServiceName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.organizationLocationServicePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchServiceFromOrganizationLocationServiceName', () => {
                const result = client.matchServiceFromOrganizationLocationServiceName(fakePath);
                assert.strictEqual(result, "serviceValue");
                assert((client.pathTemplates.organizationLocationServicePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('projectLocationEffectiveEventThreatDetectionCustomModule', () => {
            const fakePath = "/rendered/path/projectLocationEffectiveEventThreatDetectionCustomModule";
            const expectedParameters = {
                project: "projectValue",
                location: "locationValue",
                effective_event_threat_detection_custom_module: "effectiveEventThreatDetectionCustomModuleValue",
            ...
            it('projectLocationEffectiveEventThreatDetectionCustomModulePath', () => {
                const result = client.projectLocationEffectiveEventThreatDetectionCustomModulePath("projectValue", "locationValue", "effectiveEventThreatDetectionCustomModuleValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectLocationEffectiveEventThreatDetectionCustomModulePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectLocationEffectiveEventThreatDetectionCustomModuleName', () => {
                const result = client.matchProjectFromProjectLocationEffectiveEventThreatDetectionCustomModuleName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectLocationEffectiveEventThreatDetectionCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromProjectLocationEffectiveEventThreatDetectionCustomModuleName', () => {
                const result = client.matchLocationFromProjectLocationEffectiveEventThreatDetectionCustomModuleName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.projectLocationEffectiveEventThreatDetectionCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchEffectiveEventThreatDetectionCustomModuleFromProjectLocationEffectiveEventThreatDetectionCustomModuleName', () => {
                const result = client.matchEffectiveEventThreatDetectionCustomModuleFromProjectLocationEffectiveEventThreatDetectionCustomModuleName(fakePath);
                assert.strictEqual(result, "effectiveEventThreatDetectionCustomModuleValue");
                assert((client.pathTemplates.projectLocationEffectiveEventThreatDetectionCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('projectLocationEffectiveSecurityHealthAnalyticsCustomModule', () => {
            const fakePath = "/rendered/path/projectLocationEffectiveSecurityHealthAnalyticsCustomModule";
            const expectedParameters = {
                project: "projectValue",
                location: "locationValue",
                effective_security_health_analytics_custom_module: "effectiveSecurityHealthAnalyticsCustomModuleValue",
            ...
            it('projectLocationEffectiveSecurityHealthAnalyticsCustomModulePath', () => {
                const result = client.projectLocationEffectiveSecurityHealthAnalyticsCustomModulePath("projectValue", "locationValue", "effectiveSecurityHealthAnalyticsCustomModuleValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectLocationEffectiveSecurityHealthAnalyticsCustomModulePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectLocationEffectiveSecurityHealthAnalyticsCustomModuleName', () => {
                const result = client.matchProjectFromProjectLocationEffectiveSecurityHealthAnalyticsCustomModuleName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectLocationEffectiveSecurityHealthAnalyticsCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromProjectLocationEffectiveSecurityHealthAnalyticsCustomModuleName', () => {
                const result = client.matchLocationFromProjectLocationEffectiveSecurityHealthAnalyticsCustomModuleName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.projectLocationEffectiveSecurityHealthAnalyticsCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchEffectiveSecurityHealthAnalyticsCustomModuleFromProjectLocationEffectiveSecurityHealthAnalyticsCustomModuleName', () => {
                const result = client.matchEffectiveSecurityHealthAnalyticsCustomModuleFromProjectLocationEffectiveSecurityHealthAnalyticsCustomModuleName(fakePath);
                assert.strictEqual(result, "effectiveSecurityHealthAnalyticsCustomModuleValue");
                assert((client.pathTemplates.projectLocationEffectiveSecurityHealthAnalyticsCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('projectLocationEventThreatDetectionCustomModule', () => {
            const fakePath = "/rendered/path/projectLocationEventThreatDetectionCustomModule";
            const expectedParameters = {
                project: "projectValue",
                location: "locationValue",
                event_threat_detection_custom_module: "eventThreatDetectionCustomModuleValue",
            ...
            it('projectLocationEventThreatDetectionCustomModulePath', () => {
                const result = client.projectLocationEventThreatDetectionCustomModulePath("projectValue", "locationValue", "eventThreatDetectionCustomModuleValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectLocationEventThreatDetectionCustomModulePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectLocationEventThreatDetectionCustomModuleName', () => {
                const result = client.matchProjectFromProjectLocationEventThreatDetectionCustomModuleName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectLocationEventThreatDetectionCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromProjectLocationEventThreatDetectionCustomModuleName', () => {
                const result = client.matchLocationFromProjectLocationEventThreatDetectionCustomModuleName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.projectLocationEventThreatDetectionCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchEventThreatDetectionCustomModuleFromProjectLocationEventThreatDetectionCustomModuleName', () => {
                const result = client.matchEventThreatDetectionCustomModuleFromProjectLocationEventThreatDetectionCustomModuleName(fakePath);
                assert.strictEqual(result, "eventThreatDetectionCustomModuleValue");
                assert((client.pathTemplates.projectLocationEventThreatDetectionCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('projectLocationSecurityHealthAnalyticsCustomModule', () => {
            const fakePath = "/rendered/path/projectLocationSecurityHealthAnalyticsCustomModule";
            const expectedParameters = {
                project: "projectValue",
                location: "locationValue",
                security_health_analytics_custom_module: "securityHealthAnalyticsCustomModuleValue",
            ...
            it('projectLocationSecurityHealthAnalyticsCustomModulePath', () => {
                const result = client.projectLocationSecurityHealthAnalyticsCustomModulePath("projectValue", "locationValue", "securityHealthAnalyticsCustomModuleValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectLocationSecurityHealthAnalyticsCustomModulePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectLocationSecurityHealthAnalyticsCustomModuleName', () => {
                const result = client.matchProjectFromProjectLocationSecurityHealthAnalyticsCustomModuleName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectLocationSecurityHealthAnalyticsCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromProjectLocationSecurityHealthAnalyticsCustomModuleName', () => {
                const result = client.matchLocationFromProjectLocationSecurityHealthAnalyticsCustomModuleName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.projectLocationSecurityHealthAnalyticsCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchSecurityHealthAnalyticsCustomModuleFromProjectLocationSecurityHealthAnalyticsCustomModuleName', () => {
                const result = client.matchSecurityHealthAnalyticsCustomModuleFromProjectLocationSecurityHealthAnalyticsCustomModuleName(fakePath);
                assert.strictEqual(result, "securityHealthAnalyticsCustomModuleValue");
                assert((client.pathTemplates.projectLocationSecurityHealthAnalyticsCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
