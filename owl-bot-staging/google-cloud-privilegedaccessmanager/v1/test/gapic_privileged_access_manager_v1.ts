...
describe('v1.PrivilegedAccessManagerClient', () => {
    ...
    describe('Path templates', () => {
        ...
        describe('folderLocationEntitlement', () => {
            ...
            client.initialize();
            client.pathTemplates.folderLocationEntitlementPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.folderLocationEntitlementPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('folderLocationEntitlementPath', () => {
                const result = client.folderLocationEntitlementPath("folderValue", "locationValue", "entitlementValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.folderLocationEntitlementPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchFolderFromFolderLocationEntitlementName', () => {
                const result = client.matchFolderFromFolderLocationEntitlementName(fakePath);
                assert.strictEqual(result, "folderValue");
                assert((client.pathTemplates.folderLocationEntitlementPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromFolderLocationEntitlementName', () => {
                const result = client.matchLocationFromFolderLocationEntitlementName(fakePath);
            ...
            it('matchEntitlementFromFolderLocationEntitlementName', () => {
                const result = client.matchEntitlementFromFolderLocationEntitlementName(fakePath);
        ...
        describe('folderLocationEntitlementGrant', () => {
            ...
            it('folderLocationEntitlementGrantPath', () => {
                const result = client.folderLocationEntitlementGrantPath("folderValue", "locationValue", "entitlementValue", "grantValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.folderLocationEntitlementGrantPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchFolderFromFolderLocationEntitlementGrantName', () => {
                const result = client.matchFolderFromFolderLocationEntitlementGrantName(fakePath);
                assert.strictEqual(result, "folderValue");
                assert((client.pathTemplates.folderLocationEntitlementGrantPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromFolderLocationEntitlementGrantName', () => {
                const result = client.matchLocationFromFolderLocationEntitlementGrantName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.folderLocationEntitlementGrantPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchEntitlementFromFolderLocationEntitlementGrantName', () => {
                const result = client.matchEntitlementFromFolderLocationEntitlementGrantName(fakePath);
                assert.strictEqual(result, "entitlementValue");
                assert((client.pathTemplates.folderLocationEntitlementGrantPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchGrantFromFolderLocationEntitlementGrantName', () => {
                const result = client.matchGrantFromFolderLocationEntitlementGrantName(fakePath);
        ...
        describe('organizationLocationEntitlement', () => {
            ...
            it('organizationLocationEntitlementPath', () => {
                const result = client.organizationLocationEntitlementPath("organizationValue", "locationValue", "entitlementValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationLocationEntitlementPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationLocationEntitlementName', () => {
                const result = client.matchOrganizationFromOrganizationLocationEntitlementName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationLocationEntitlementPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromOrganizationLocationEntitlementName', () => {
                const result = client.matchLocationFromOrganizationLocationEntitlementName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.organizationLocationEntitlementPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchEntitlementFromOrganizationLocationEntitlementName', () => {
                const result = client.matchEntitlementFromOrganizationLocationEntitlementName(fakePath);
                assert.strictEqual(result, "entitlementValue");
                assert((client.pathTemplates.organizationLocationEntitlementPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('organizationLocationEntitlementGrant', () => {
            ...
            it('organizationLocationEntitlementGrantPath', () => {
                const result = client.organizationLocationEntitlementGrantPath("organizationValue", "locationValue", "entitlementValue", "grantValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationLocationEntitlementGrantPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationLocationEntitlementGrantName', () => {
                const result = client.matchOrganizationFromOrganizationLocationEntitlementGrantName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationLocationEntitlementGrantPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromOrganizationLocationEntitlementGrantName', () => {
                const result = client.matchLocationFromOrganizationLocationEntitlementGrantName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.organizationLocationEntitlementGrantPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchGrantFromOrganizationLocationEntitlementGrantName', () => {
                const result = client.matchGrantFromOrganizationLocationEntitlementGrantName(fakePath);
                assert.strictEqual(result, "grantValue");
                assert((client.pathTemplates.organizationLocationEntitlementGrantPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('projectLocationEntitlement', () => {
            ...
            client.pathTemplates.projectLocationEntitlementPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.projectLocationEntitlementPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('projectLocationEntitlementPath', () => {
                const result = client.projectLocationEntitlementPath("projectValue", "locationValue", "entitlementValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectLocationEntitlementPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectLocationEntitlementName', () => {
                const result = client.matchProjectFromProjectLocationEntitlementName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectLocationEntitlementPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromProjectLocationEntitlementName', () => {
                const result = client.matchLocationFromProjectLocationEntitlementName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.projectLocationEntitlementPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchEntitlementFromProjectLocationEntitlementName', () => {
                const result = client.matchEntitlementFromProjectLocationEntitlementName(fakePath);
                assert.strictEqual(result, "entitlementValue");
                assert((client.pathTemplates.projectLocationEntitlementPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('projectLocationEntitlementGrant', () => {
            ...
            it('projectLocationEntitlementGrantPath', () => {
                const result = client.projectLocationEntitlementGrantPath("projectValue", "locationValue", "entitlementValue", "grantValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectLocationEntitlementGrantPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectLocationEntitlementGrantName', () => {
                const result = client.matchProjectFromProjectLocationEntitlementGrantName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectLocationEntitlementGrantPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromProjectLocationEntitlementGrantName', () => {
                const result = client.matchLocationFromProjectLocationEntitlementGrantName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.projectLocationEntitlementGrantPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchEntitlementFromProjectLocationEntitlementGrantName', () => {
                const result = client.matchEntitlementFromProjectLocationEntitlementGrantName(fakePath);
                assert.strictEqual(result, "entitlementValue");
                assert((client.pathTemplates.projectLocationEntitlementGrantPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchGrantFromProjectLocationEntitlementGrantName', () => {
                const result = client.matchGrantFromProjectLocationEntitlementGrantName(fakePath);
                assert.strictEqual(result, "grantValue");
                assert((client.pathTemplates.projectLocationEntitlementGrantPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
