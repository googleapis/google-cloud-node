...
describe('v1.ContactCenterInsightsClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new contactcenterinsightsModule.v1.ContactCenterInsightsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'contactcenterinsights.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new contactcenterinsightsModule.v1.ContactCenterInsightsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'contactcenterinsights.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new contactcenterinsightsModule.v1.ContactCenterInsightsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
                    assert.strictEqual(servicePath, 'contactcenterinsights.configured.example.com');
                    if (saved) {
                        process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = saved;
                    } else {
                        delete process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new contactcenterinsightsModule.v1.ContactCenterInsightsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createAnalysisRule', () => {
        it('invokes createAnalysisRule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.CreateAnalysisRuleRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.contactcenterinsights.v1.AnalysisRule()
            );
            client.innerApiCalls.createAnalysisRule = stubSimpleCall(expectedResponse);
            const [response] = await client.createAnalysisRule(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createAnalysisRule as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createAnalysisRule as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createAnalysisRule without error using callback', async () => {
            ...
            client.innerApiCalls.createAnalysisRule = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createAnalysisRule(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.contactcenterinsights.v1.IAnalysisRule|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createAnalysisRule with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createAnalysisRule = stubSimpleCall(undefined, expectedError);
    ...
    describe('getAnalysisRule', () => {
        it('invokes getAnalysisRule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.GetAnalysisRuleRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.contactcenterinsights.v1.AnalysisRule()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getAnalysisRule as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getAnalysisRule as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getAnalysisRule without error using callback', async () => {
            ...
            client.innerApiCalls.getAnalysisRule = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getAnalysisRule with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getAnalysisRule = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateAnalysisRule', () => {
        it('invokes updateAnalysisRule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.UpdateAnalysisRuleRequest', ['analysisRule', 'name']);
            request.analysisRule.name = defaultValue1;
            const expectedHeaderRequestParams = `analysis_rule.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.contactcenterinsights.v1.AnalysisRule()
            );
            client.innerApiCalls.updateAnalysisRule = stubSimpleCall(expectedResponse);
            const [response] = await client.updateAnalysisRule(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateAnalysisRule as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateAnalysisRule as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateAnalysisRule without error using callback', async () => {
            ...
            client.innerApiCalls.updateAnalysisRule = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateAnalysisRule with error', async () => {
            ...
            const expectedHeaderRequestParams = `analysis_rule.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateAnalysisRule = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteAnalysisRule', () => {
        it('invokes deleteAnalysisRule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.DeleteAnalysisRuleRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteAnalysisRule = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteAnalysisRule(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteAnalysisRule as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteAnalysisRule as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteAnalysisRule without error using callback', async () => {
            ...
            client.innerApiCalls.deleteAnalysisRule = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteAnalysisRule with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteAnalysisRule = stubSimpleCall(undefined, expectedError);
    ...
    describe('getEncryptionSpec', () => {
        it('invokes getEncryptionSpec without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.GetEncryptionSpecRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getEncryptionSpec as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getEncryptionSpec as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getEncryptionSpec without error using callback', async () => {
            ...
            client.innerApiCalls.getEncryptionSpec = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getEncryptionSpec(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.contactcenterinsights.v1.IEncryptionSpec|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getEncryptionSpec with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getEncryptionSpec = stubSimpleCall(undefined, expectedError);
    ...
    describe('createQaQuestion', () => {
        it('invokes createQaQuestion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.CreateQaQuestionRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createQaQuestion as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createQaQuestion as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createQaQuestion without error using callback', async () => {
            ...
            client.innerApiCalls.createQaQuestion = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createQaQuestion(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.contactcenterinsights.v1.IQaQuestion|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createQaQuestion with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createQaQuestion = stubSimpleCall(undefined, expectedError);
    ...
    describe('getQaQuestion', () => {
        it('invokes getQaQuestion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.GetQaQuestionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.contactcenterinsights.v1.QaQuestion()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getQaQuestion as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getQaQuestion as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getQaQuestion without error using callback', async () => {
            ...
            client.innerApiCalls.getQaQuestion = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getQaQuestion with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getQaQuestion = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateQaQuestion', () => {
        it('invokes updateQaQuestion without error', async () => {
            ...
            request.qaQuestion ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.UpdateQaQuestionRequest', ['qaQuestion', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateQaQuestion as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateQaQuestion as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateQaQuestion without error using callback', async () => {
            ...
            client.innerApiCalls.updateQaQuestion = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateQaQuestion with error', async () => {
            ...
            const expectedHeaderRequestParams = `qa_question.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateQaQuestion = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteQaQuestion', () => {
        it('invokes deleteQaQuestion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.DeleteQaQuestionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteQaQuestion as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteQaQuestion as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteQaQuestion without error using callback', async () => {
            ...
            client.innerApiCalls.deleteQaQuestion = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteQaQuestion with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteQaQuestion = stubSimpleCall(undefined, expectedError);
    ...
    describe('createQaScorecard', () => {
        it('invokes createQaScorecard without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.CreateQaScorecardRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createQaScorecard as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createQaScorecard as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createQaScorecard without error using callback', async () => {
            ...
            client.innerApiCalls.createQaScorecard = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createQaScorecard(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.contactcenterinsights.v1.IQaScorecard|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createQaScorecard with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createQaScorecard = stubSimpleCall(undefined, expectedError);
    ...
    describe('getQaScorecard', () => {
        it('invokes getQaScorecard without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.GetQaScorecardRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.contactcenterinsights.v1.QaScorecard()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getQaScorecard as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getQaScorecard as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getQaScorecard without error using callback', async () => {
            ...
            client.innerApiCalls.getQaScorecard = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getQaScorecard with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getQaScorecard = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateQaScorecard', () => {
        it('invokes updateQaScorecard without error', async () => {
            ...
            request.qaScorecard ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.UpdateQaScorecardRequest', ['qaScorecard', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateQaScorecard as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateQaScorecard as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateQaScorecard without error using callback', async () => {
            ...
            client.innerApiCalls.updateQaScorecard = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateQaScorecard with error', async () => {
            ...
            const expectedHeaderRequestParams = `qa_scorecard.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateQaScorecard = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteQaScorecard', () => {
        it('invokes deleteQaScorecard without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.DeleteQaScorecardRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteQaScorecard as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteQaScorecard as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteQaScorecard without error using callback', async () => {
            ...
            client.innerApiCalls.deleteQaScorecard = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteQaScorecard with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteQaScorecard = stubSimpleCall(undefined, expectedError);
    ...
    describe('createQaScorecardRevision', () => {
        it('invokes createQaScorecardRevision without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.CreateQaScorecardRevisionRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.contactcenterinsights.v1.QaScorecardRevision()
            );
            client.innerApiCalls.createQaScorecardRevision = stubSimpleCall(expectedResponse);
            const [response] = await client.createQaScorecardRevision(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createQaScorecardRevision as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createQaScorecardRevision as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createQaScorecardRevision without error using callback', async () => {
            ...
            client.innerApiCalls.createQaScorecardRevision = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createQaScorecardRevision(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.contactcenterinsights.v1.IQaScorecardRevision|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createQaScorecardRevision with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createQaScorecardRevision = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createQaScorecardRevision(request), expectedError);
            const actualRequest = (client.innerApiCalls.createQaScorecardRevision as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createQaScorecardRevision as SinonStub)
    ...
    describe('getQaScorecardRevision', () => {
        it('invokes getQaScorecardRevision without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.GetQaScorecardRevisionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.contactcenterinsights.v1.QaScorecardRevision()
            );
            client.innerApiCalls.getQaScorecardRevision = stubSimpleCall(expectedResponse);
            const [response] = await client.getQaScorecardRevision(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getQaScorecardRevision as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getQaScorecardRevision as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getQaScorecardRevision without error using callback', async () => {
            ...
            client.innerApiCalls.getQaScorecardRevision = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getQaScorecardRevision with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getQaScorecardRevision = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getQaScorecardRevision(request), expectedError);
            const actualRequest = (client.innerApiCalls.getQaScorecardRevision as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getQaScorecardRevision as SinonStub)
    ...
    describe('deployQaScorecardRevision', () => {
        it('invokes deployQaScorecardRevision without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.DeployQaScorecardRevisionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.contactcenterinsights.v1.QaScorecardRevision()
            );
            client.innerApiCalls.deployQaScorecardRevision = stubSimpleCall(expectedResponse);
            const [response] = await client.deployQaScorecardRevision(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deployQaScorecardRevision as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deployQaScorecardRevision as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deployQaScorecardRevision without error using callback', async () => {
            ...
            client.innerApiCalls.deployQaScorecardRevision = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deployQaScorecardRevision with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deployQaScorecardRevision = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.deployQaScorecardRevision(request), expectedError);
            const actualRequest = (client.innerApiCalls.deployQaScorecardRevision as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deployQaScorecardRevision as SinonStub)
    ...
    describe('undeployQaScorecardRevision', () => {
        it('invokes undeployQaScorecardRevision without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.UndeployQaScorecardRevisionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.contactcenterinsights.v1.QaScorecardRevision()
            );
            client.innerApiCalls.undeployQaScorecardRevision = stubSimpleCall(expectedResponse);
            const [response] = await client.undeployQaScorecardRevision(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.undeployQaScorecardRevision as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.undeployQaScorecardRevision as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes undeployQaScorecardRevision without error using callback', async () => {
            ...
            client.innerApiCalls.undeployQaScorecardRevision = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes undeployQaScorecardRevision with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.undeployQaScorecardRevision = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.undeployQaScorecardRevision(request), expectedError);
            const actualRequest = (client.innerApiCalls.undeployQaScorecardRevision as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.undeployQaScorecardRevision as SinonStub)
    ...
    describe('deleteQaScorecardRevision', () => {
        it('invokes deleteQaScorecardRevision without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.DeleteQaScorecardRevisionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteQaScorecardRevision = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteQaScorecardRevision(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteQaScorecardRevision as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteQaScorecardRevision as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteQaScorecardRevision without error using callback', async () => {
            ...
            client.innerApiCalls.deleteQaScorecardRevision = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteQaScorecardRevision with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteQaScorecardRevision = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.deleteQaScorecardRevision(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteQaScorecardRevision as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteQaScorecardRevision as SinonStub)
    ...
    describe('createFeedbackLabel', () => {
        it('invokes createFeedbackLabel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.CreateFeedbackLabelRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.contactcenterinsights.v1.FeedbackLabel()
            );
            client.innerApiCalls.createFeedbackLabel = stubSimpleCall(expectedResponse);
            const [response] = await client.createFeedbackLabel(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createFeedbackLabel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createFeedbackLabel as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createFeedbackLabel without error using callback', async () => {
            ...
            client.innerApiCalls.createFeedbackLabel = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createFeedbackLabel(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.contactcenterinsights.v1.IFeedbackLabel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createFeedbackLabel with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createFeedbackLabel = stubSimpleCall(undefined, expectedError);
    ...
    describe('getFeedbackLabel', () => {
        it('invokes getFeedbackLabel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.GetFeedbackLabelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.contactcenterinsights.v1.FeedbackLabel()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getFeedbackLabel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getFeedbackLabel as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getFeedbackLabel without error using callback', async () => {
            ...
            client.innerApiCalls.getFeedbackLabel = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getFeedbackLabel with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getFeedbackLabel = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateFeedbackLabel', () => {
        it('invokes updateFeedbackLabel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.UpdateFeedbackLabelRequest', ['feedbackLabel', 'name']);
            request.feedbackLabel.name = defaultValue1;
            const expectedHeaderRequestParams = `feedback_label.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.contactcenterinsights.v1.FeedbackLabel()
            );
            client.innerApiCalls.updateFeedbackLabel = stubSimpleCall(expectedResponse);
            const [response] = await client.updateFeedbackLabel(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateFeedbackLabel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateFeedbackLabel as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateFeedbackLabel without error using callback', async () => {
            ...
            client.innerApiCalls.updateFeedbackLabel = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateFeedbackLabel with error', async () => {
            ...
            const expectedHeaderRequestParams = `feedback_label.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateFeedbackLabel = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteFeedbackLabel', () => {
        it('invokes deleteFeedbackLabel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.DeleteFeedbackLabelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteFeedbackLabel = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteFeedbackLabel(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteFeedbackLabel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteFeedbackLabel as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteFeedbackLabel without error using callback', async () => {
            ...
            client.innerApiCalls.deleteFeedbackLabel = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteFeedbackLabel with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteFeedbackLabel = stubSimpleCall(undefined, expectedError);
    ...
    describe('uploadConversation', () => {
        it('invokes uploadConversation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.UploadConversationRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.uploadConversation = stubLongRunningCall(expectedResponse);
            const [operation] = await client.uploadConversation(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.uploadConversation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.uploadConversation as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes uploadConversation without error using callback', async () => {
            ...
            client.innerApiCalls.uploadConversation = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.uploadConversation(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.contactcenterinsights.v1.IConversation, protos.google.cloud.contactcenterinsights.v1.IUploadConversationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.contactcenterinsights.v1.IConversation, protos.google.cloud.contactcenterinsights.v1.IUploadConversationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.uploadConversation as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes uploadConversation with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.uploadConversation = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes uploadConversation with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.uploadConversation = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.uploadConversation(request);
        ...
        it('invokes checkUploadConversationProgress without error', async () => {
            ...
            const decodedOperation = await client.checkUploadConversationProgress(expectedResponse.name);
        ...
        it('invokes checkUploadConversationProgress with error', async () => {
            ...
            await assert.rejects(client.checkUploadConversationProgress(''), expectedError);
    ...
    describe('bulkDeleteConversations', () => {
        it('invokes bulkDeleteConversations without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.BulkDeleteConversationsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.bulkDeleteConversations = stubLongRunningCall(expectedResponse);
            const [operation] = await client.bulkDeleteConversations(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.bulkDeleteConversations as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.bulkDeleteConversations as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes bulkDeleteConversations without error using callback', async () => {
            ...
            client.innerApiCalls.bulkDeleteConversations = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.bulkDeleteConversations(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.contactcenterinsights.v1.IBulkDeleteConversationsResponse, protos.google.cloud.contactcenterinsights.v1.IBulkDeleteConversationsMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.contactcenterinsights.v1.IBulkDeleteConversationsResponse, protos.google.cloud.contactcenterinsights.v1.IBulkDeleteConversationsMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.bulkDeleteConversations as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes bulkDeleteConversations with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.bulkDeleteConversations = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.bulkDeleteConversations(request), expectedError);
            const actualRequest = (client.innerApiCalls.bulkDeleteConversations as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.bulkDeleteConversations as SinonStub)
        ...
        it('invokes bulkDeleteConversations with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.bulkDeleteConversations = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.bulkDeleteConversations(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.bulkDeleteConversations as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkBulkDeleteConversationsProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkBulkDeleteConversationsProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkBulkDeleteConversationsProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkBulkDeleteConversationsProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('exportIssueModel', () => {
        it('invokes exportIssueModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.ExportIssueModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.exportIssueModel = stubLongRunningCall(expectedResponse);
            const [operation] = await client.exportIssueModel(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportIssueModel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.exportIssueModel as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes exportIssueModel without error using callback', async () => {
            ...
            client.innerApiCalls.exportIssueModel = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.exportIssueModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.contactcenterinsights.v1.IExportIssueModelResponse, protos.google.cloud.contactcenterinsights.v1.IExportIssueModelMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.contactcenterinsights.v1.IExportIssueModelResponse, protos.google.cloud.contactcenterinsights.v1.IExportIssueModelMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportIssueModel as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes exportIssueModel with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.exportIssueModel = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes exportIssueModel with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.exportIssueModel = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.exportIssueModel(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.exportIssueModel as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkExportIssueModelProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkExportIssueModelProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkExportIssueModelProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkExportIssueModelProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('importIssueModel', () => {
        it('invokes importIssueModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.ImportIssueModelRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.importIssueModel = stubLongRunningCall(expectedResponse);
            const [operation] = await client.importIssueModel(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importIssueModel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.importIssueModel as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes importIssueModel without error using callback', async () => {
            ...
            client.innerApiCalls.importIssueModel = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.importIssueModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.contactcenterinsights.v1.IImportIssueModelResponse, protos.google.cloud.contactcenterinsights.v1.IImportIssueModelMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.contactcenterinsights.v1.IImportIssueModelResponse, protos.google.cloud.contactcenterinsights.v1.IImportIssueModelMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importIssueModel as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes importIssueModel with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.importIssueModel = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes importIssueModel with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.importIssueModel = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.importIssueModel(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.importIssueModel as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkImportIssueModelProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkImportIssueModelProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkImportIssueModelProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkImportIssueModelProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('initializeEncryptionSpec', () => {
        it('invokes initializeEncryptionSpec without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.InitializeEncryptionSpecRequest', ['encryptionSpec', 'name']);
            request.encryptionSpec.name = defaultValue1;
            const expectedHeaderRequestParams = `encryption_spec.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.initializeEncryptionSpec = stubLongRunningCall(expectedResponse);
            const [operation] = await client.initializeEncryptionSpec(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.initializeEncryptionSpec as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.initializeEncryptionSpec as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes initializeEncryptionSpec without error using callback', async () => {
            ...
            client.innerApiCalls.initializeEncryptionSpec = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.initializeEncryptionSpec(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.contactcenterinsights.v1.IInitializeEncryptionSpecResponse, protos.google.cloud.contactcenterinsights.v1.IInitializeEncryptionSpecMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.contactcenterinsights.v1.IInitializeEncryptionSpecResponse, protos.google.cloud.contactcenterinsights.v1.IInitializeEncryptionSpecMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.initializeEncryptionSpec as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes initializeEncryptionSpec with call error', async () => {
            ...
            const expectedHeaderRequestParams = `encryption_spec.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.initializeEncryptionSpec = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.initializeEncryptionSpec(request), expectedError);
            const actualRequest = (client.innerApiCalls.initializeEncryptionSpec as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.initializeEncryptionSpec as SinonStub)
        ...
        it('invokes initializeEncryptionSpec with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `encryption_spec.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.initializeEncryptionSpec = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.initializeEncryptionSpec(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.initializeEncryptionSpec as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkInitializeEncryptionSpecProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkInitializeEncryptionSpecProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkInitializeEncryptionSpecProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkInitializeEncryptionSpecProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('queryMetrics', () => {
        it('invokes queryMetrics without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.QueryMetricsRequest', ['location']);
            request.location = defaultValue1;
            const expectedHeaderRequestParams = `location=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.queryMetrics as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.queryMetrics as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes queryMetrics without error using callback', async () => {
            ...
            client.innerApiCalls.queryMetrics = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.queryMetrics(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.contactcenterinsights.v1.IQueryMetricsResponse, protos.google.cloud.contactcenterinsights.v1.IQueryMetricsMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.contactcenterinsights.v1.IQueryMetricsResponse, protos.google.cloud.contactcenterinsights.v1.IQueryMetricsMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.queryMetrics as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes queryMetrics with call error', async () => {
            ...
            const expectedHeaderRequestParams = `location=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.queryMetrics = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes queryMetrics with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `location=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.queryMetrics = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.queryMetrics(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.queryMetrics as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkQueryMetricsProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkQueryMetricsProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('tuneQaScorecardRevision', () => {
        it('invokes tuneQaScorecardRevision without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.TuneQaScorecardRevisionRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.tuneQaScorecardRevision = stubLongRunningCall(expectedResponse);
            const [operation] = await client.tuneQaScorecardRevision(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.tuneQaScorecardRevision as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.tuneQaScorecardRevision as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes tuneQaScorecardRevision without error using callback', async () => {
            ...
            client.innerApiCalls.tuneQaScorecardRevision = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.tuneQaScorecardRevision(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.contactcenterinsights.v1.ITuneQaScorecardRevisionResponse, protos.google.cloud.contactcenterinsights.v1.ITuneQaScorecardRevisionMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.contactcenterinsights.v1.ITuneQaScorecardRevisionResponse, protos.google.cloud.contactcenterinsights.v1.ITuneQaScorecardRevisionMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.tuneQaScorecardRevision as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes tuneQaScorecardRevision with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.tuneQaScorecardRevision = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.tuneQaScorecardRevision(request), expectedError);
            const actualRequest = (client.innerApiCalls.tuneQaScorecardRevision as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.tuneQaScorecardRevision as SinonStub)
        ...
        it('invokes tuneQaScorecardRevision with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.tuneQaScorecardRevision = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.tuneQaScorecardRevision(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.tuneQaScorecardRevision as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkTuneQaScorecardRevisionProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkTuneQaScorecardRevisionProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkTuneQaScorecardRevisionProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkTuneQaScorecardRevisionProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('bulkUploadFeedbackLabels', () => {
        it('invokes bulkUploadFeedbackLabels without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.BulkUploadFeedbackLabelsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.bulkUploadFeedbackLabels = stubLongRunningCall(expectedResponse);
            const [operation] = await client.bulkUploadFeedbackLabels(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.bulkUploadFeedbackLabels as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.bulkUploadFeedbackLabels as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes bulkUploadFeedbackLabels without error using callback', async () => {
            ...
            client.innerApiCalls.bulkUploadFeedbackLabels = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.bulkUploadFeedbackLabels(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.contactcenterinsights.v1.IBulkUploadFeedbackLabelsResponse, protos.google.cloud.contactcenterinsights.v1.IBulkUploadFeedbackLabelsMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.contactcenterinsights.v1.IBulkUploadFeedbackLabelsResponse, protos.google.cloud.contactcenterinsights.v1.IBulkUploadFeedbackLabelsMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.bulkUploadFeedbackLabels as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes bulkUploadFeedbackLabels with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.bulkUploadFeedbackLabels = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.bulkUploadFeedbackLabels(request), expectedError);
            const actualRequest = (client.innerApiCalls.bulkUploadFeedbackLabels as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.bulkUploadFeedbackLabels as SinonStub)
        ...
        it('invokes bulkUploadFeedbackLabels with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.bulkUploadFeedbackLabels = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.bulkUploadFeedbackLabels(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.bulkUploadFeedbackLabels as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkBulkUploadFeedbackLabelsProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkBulkUploadFeedbackLabelsProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkBulkUploadFeedbackLabelsProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkBulkUploadFeedbackLabelsProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('bulkDownloadFeedbackLabels', () => {
        it('invokes bulkDownloadFeedbackLabels without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.BulkDownloadFeedbackLabelsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.bulkDownloadFeedbackLabels = stubLongRunningCall(expectedResponse);
            const [operation] = await client.bulkDownloadFeedbackLabels(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.bulkDownloadFeedbackLabels as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.bulkDownloadFeedbackLabels as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes bulkDownloadFeedbackLabels without error using callback', async () => {
            ...
            client.innerApiCalls.bulkDownloadFeedbackLabels = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.bulkDownloadFeedbackLabels(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.contactcenterinsights.v1.IBulkDownloadFeedbackLabelsResponse, protos.google.cloud.contactcenterinsights.v1.IBulkDownloadFeedbackLabelsMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.contactcenterinsights.v1.IBulkDownloadFeedbackLabelsResponse, protos.google.cloud.contactcenterinsights.v1.IBulkDownloadFeedbackLabelsMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.bulkDownloadFeedbackLabels as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes bulkDownloadFeedbackLabels with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.bulkDownloadFeedbackLabels = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.bulkDownloadFeedbackLabels(request), expectedError);
            const actualRequest = (client.innerApiCalls.bulkDownloadFeedbackLabels as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.bulkDownloadFeedbackLabels as SinonStub)
        ...
        it('invokes bulkDownloadFeedbackLabels with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.bulkDownloadFeedbackLabels = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.bulkDownloadFeedbackLabels(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.bulkDownloadFeedbackLabels as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkBulkDownloadFeedbackLabelsProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkBulkDownloadFeedbackLabelsProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkBulkDownloadFeedbackLabelsProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkBulkDownloadFeedbackLabelsProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listAnalysisRules', () => {
        it('invokes listAnalysisRules without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.ListAnalysisRulesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.contactcenterinsights.v1.AnalysisRule()),
              generateSampleMessage(new protos.google.cloud.contactcenterinsights.v1.AnalysisRule()),
              generateSampleMessage(new protos.google.cloud.contactcenterinsights.v1.AnalysisRule()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listAnalysisRules as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAnalysisRules as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listAnalysisRules without error using callback', async () => {
            ...
            client.innerApiCalls.listAnalysisRules = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listAnalysisRules with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listAnalysisRules = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listAnalysisRulesStream without error', async () => {
            ...
            client.descriptors.page.listAnalysisRules.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.contactcenterinsights.v1.AnalysisRule) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listAnalysisRules.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listAnalysisRules, request));
            assert(
        ...
        it('invokes listAnalysisRulesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAnalysisRules.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listAnalysisRulesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.contactcenterinsights.v1.AnalysisRule[] = [];
                stream.on('data', (response: protos.google.cloud.contactcenterinsights.v1.AnalysisRule) => {
        ...
        it('uses async iteration with listAnalysisRules without error', async () => {
            ...
            client.descriptors.page.listAnalysisRules.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listAnalysisRules with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAnalysisRules.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listAnalysisRulesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.contactcenterinsights.v1.IAnalysisRule[] = [];
                for await (const resource of iterable) {
    ...
    describe('listQaQuestions', () => {
        it('invokes listQaQuestions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.ListQaQuestionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.contactcenterinsights.v1.QaQuestion()),
              generateSampleMessage(new protos.google.cloud.contactcenterinsights.v1.QaQuestion()),
              generateSampleMessage(new protos.google.cloud.contactcenterinsights.v1.QaQuestion()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listQaQuestions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listQaQuestions as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listQaQuestions without error using callback', async () => {
            ...
            client.innerApiCalls.listQaQuestions = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listQaQuestions with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listQaQuestions = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listQaQuestionsStream without error', async () => {
            ...
            client.descriptors.page.listQaQuestions.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listQaQuestionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.contactcenterinsights.v1.QaQuestion[] = [];
                stream.on('data', (response: protos.google.cloud.contactcenterinsights.v1.QaQuestion) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listQaQuestions.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listQaQuestions, request));
            assert(
        ...
        it('invokes listQaQuestionsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listQaQuestions.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listQaQuestionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.contactcenterinsights.v1.QaQuestion[] = [];
                stream.on('data', (response: protos.google.cloud.contactcenterinsights.v1.QaQuestion) => {
        ...
        it('uses async iteration with listQaQuestions without error', async () => {
            ...
            client.descriptors.page.listQaQuestions.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listQaQuestions with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listQaQuestions.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listQaQuestionsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.contactcenterinsights.v1.IQaQuestion[] = [];
                for await (const resource of iterable) {
    ...
    describe('listQaScorecards', () => {
        it('invokes listQaScorecards without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.ListQaScorecardsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.contactcenterinsights.v1.QaScorecard()),
              generateSampleMessage(new protos.google.cloud.contactcenterinsights.v1.QaScorecard()),
              generateSampleMessage(new protos.google.cloud.contactcenterinsights.v1.QaScorecard()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listQaScorecards as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listQaScorecards as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listQaScorecards without error using callback', async () => {
            ...
            client.innerApiCalls.listQaScorecards = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listQaScorecards with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listQaScorecards = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listQaScorecardsStream without error', async () => {
            ...
            client.descriptors.page.listQaScorecards.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.contactcenterinsights.v1.QaScorecard) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listQaScorecards.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listQaScorecards, request));
            assert(
        ...
        it('invokes listQaScorecardsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listQaScorecards.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listQaScorecardsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.contactcenterinsights.v1.QaScorecard[] = [];
                stream.on('data', (response: protos.google.cloud.contactcenterinsights.v1.QaScorecard) => {
        ...
        it('uses async iteration with listQaScorecards without error', async () => {
            ...
            client.descriptors.page.listQaScorecards.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listQaScorecards with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listQaScorecards.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listQaScorecardsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.contactcenterinsights.v1.IQaScorecard[] = [];
                for await (const resource of iterable) {
    ...
    describe('listQaScorecardRevisions', () => {
        it('invokes listQaScorecardRevisions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.ListQaScorecardRevisionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.contactcenterinsights.v1.QaScorecardRevision()),
              generateSampleMessage(new protos.google.cloud.contactcenterinsights.v1.QaScorecardRevision()),
              generateSampleMessage(new protos.google.cloud.contactcenterinsights.v1.QaScorecardRevision()),
            ];
            client.innerApiCalls.listQaScorecardRevisions = stubSimpleCall(expectedResponse);
            const [response] = await client.listQaScorecardRevisions(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listQaScorecardRevisions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listQaScorecardRevisions as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listQaScorecardRevisions without error using callback', async () => {
            ...
            client.innerApiCalls.listQaScorecardRevisions = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listQaScorecardRevisions with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listQaScorecardRevisions = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listQaScorecardRevisions(request), expectedError);
            const actualRequest = (client.innerApiCalls.listQaScorecardRevisions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listQaScorecardRevisions as SinonStub)
        ...
        it('invokes listQaScorecardRevisionsStream without error', async () => {
            ...
            client.descriptors.page.listQaScorecardRevisions.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.contactcenterinsights.v1.QaScorecardRevision) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listQaScorecardRevisions.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listQaScorecardRevisions, request));
            assert(
                (client.descriptors.page.listQaScorecardRevisions.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listQaScorecardRevisionsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listQaScorecardRevisions.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listQaScorecardRevisionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.contactcenterinsights.v1.QaScorecardRevision[] = [];
                stream.on('data', (response: protos.google.cloud.contactcenterinsights.v1.QaScorecardRevision) => {
        ...
        it('uses async iteration with listQaScorecardRevisions without error', async () => {
            ...
            client.descriptors.page.listQaScorecardRevisions.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listQaScorecardRevisions.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listQaScorecardRevisions.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listQaScorecardRevisions with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listQaScorecardRevisions.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listQaScorecardRevisionsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.contactcenterinsights.v1.IQaScorecardRevision[] = [];
                for await (const resource of iterable) {
    ...
    describe('listFeedbackLabels', () => {
        it('invokes listFeedbackLabels without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.ListFeedbackLabelsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.contactcenterinsights.v1.FeedbackLabel()),
              generateSampleMessage(new protos.google.cloud.contactcenterinsights.v1.FeedbackLabel()),
              generateSampleMessage(new protos.google.cloud.contactcenterinsights.v1.FeedbackLabel()),
            ];
            client.innerApiCalls.listFeedbackLabels = stubSimpleCall(expectedResponse);
            const [response] = await client.listFeedbackLabels(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listFeedbackLabels as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listFeedbackLabels as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listFeedbackLabels without error using callback', async () => {
            ...
            client.innerApiCalls.listFeedbackLabels = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listFeedbackLabels with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listFeedbackLabels = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listFeedbackLabelsStream without error', async () => {
            ...
            client.descriptors.page.listFeedbackLabels.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.contactcenterinsights.v1.FeedbackLabel) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listFeedbackLabels.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listFeedbackLabels, request));
            assert(
        ...
        it('invokes listFeedbackLabelsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listFeedbackLabels.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listFeedbackLabelsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.contactcenterinsights.v1.FeedbackLabel[] = [];
                stream.on('data', (response: protos.google.cloud.contactcenterinsights.v1.FeedbackLabel) => {
        ...
        it('uses async iteration with listFeedbackLabels without error', async () => {
            ...
            client.descriptors.page.listFeedbackLabels.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listFeedbackLabels with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listFeedbackLabels.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listFeedbackLabelsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.contactcenterinsights.v1.IFeedbackLabel[] = [];
                for await (const resource of iterable) {
    ...
    describe('listAllFeedbackLabels', () => {
        it('invokes listAllFeedbackLabels without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.ListAllFeedbackLabelsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.contactcenterinsights.v1.FeedbackLabel()),
              generateSampleMessage(new protos.google.cloud.contactcenterinsights.v1.FeedbackLabel()),
            ...
            client.innerApiCalls.listAllFeedbackLabels = stubSimpleCall(expectedResponse);
            const [response] = await client.listAllFeedbackLabels(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listAllFeedbackLabels as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAllFeedbackLabels as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listAllFeedbackLabels without error using callback', async () => {
            ...
            client.innerApiCalls.listAllFeedbackLabels = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listAllFeedbackLabels with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listAllFeedbackLabels = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listAllFeedbackLabels(request), expectedError);
            const actualRequest = (client.innerApiCalls.listAllFeedbackLabels as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAllFeedbackLabels as SinonStub)
        ...
        it('invokes listAllFeedbackLabelsStream without error', async () => {
            ...
            client.descriptors.page.listAllFeedbackLabels.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listAllFeedbackLabels.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listAllFeedbackLabels, request));
            assert(
                (client.descriptors.page.listAllFeedbackLabels.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listAllFeedbackLabelsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAllFeedbackLabels.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listAllFeedbackLabelsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.contactcenterinsights.v1.FeedbackLabel[] = [];
                stream.on('data', (response: protos.google.cloud.contactcenterinsights.v1.FeedbackLabel) => {
        ...
        it('uses async iteration with listAllFeedbackLabels without error', async () => {
            ...
            client.descriptors.page.listAllFeedbackLabels.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.contactcenterinsights.v1.IFeedbackLabel[] = [];
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listAllFeedbackLabels.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listAllFeedbackLabels.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listAllFeedbackLabels with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAllFeedbackLabels.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listAllFeedbackLabelsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.contactcenterinsights.v1.IFeedbackLabel[] = [];
                for await (const resource of iterable) {
    ...
    describe('Path templates', () => {
        ...
        describe('analysisRule', async () => {
            ...
            await client.initialize();
            client.pathTemplates.analysisRulePathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.analysisRulePathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('analysisRulePath', () => {
                const result = client.analysisRulePath("projectValue", "locationValue", "analysisRuleValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.analysisRulePathTemplate.render as SinonStub)
            ...
            it('matchProjectFromAnalysisRuleName', () => {
                ...
                assert((client.pathTemplates.analysisRulePathTemplate.match as SinonStub)
        ...
        describe('projectLocationAuthorizedViewSetAuthorizedViewConversationAnalyses', async () => {
            const fakePath = "/rendered/path/projectLocationAuthorizedViewSetAuthorizedViewConversationAnalyses";
            const expectedParameters = {
                project: "projectValue",
                location: "locationValue",
            ...
            await client.initialize();
            client.pathTemplates.projectLocationAuthorizedViewSetAuthorizedViewConversationAnalysesPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.projectLocationAuthorizedViewSetAuthorizedViewConversationAnalysesPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('projectLocationAuthorizedViewSetAuthorizedViewConversationAnalysesPath', () => {
                const result = client.projectLocationAuthorizedViewSetAuthorizedViewConversationAnalysesPath("projectValue", "locationValue", "authorizedViewSetValue", "authorizedViewValue", "conversationValue", "analysisValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectLocationAuthorizedViewSetAuthorizedViewConversationAnalysesPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectLocationAuthorizedViewSetAuthorizedViewConversationAnalysesName', () => {
                const result = client.matchProjectFromProjectLocationAuthorizedViewSetAuthorizedViewConversationAnalysesName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectLocationAuthorizedViewSetAuthorizedViewConversationAnalysesPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromProjectLocationAuthorizedViewSetAuthorizedViewConversationAnalysesName', () => {
                const result = client.matchLocationFromProjectLocationAuthorizedViewSetAuthorizedViewConversationAnalysesName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.projectLocationAuthorizedViewSetAuthorizedViewConversationAnalysesPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchAuthorizedViewSetFromProjectLocationAuthorizedViewSetAuthorizedViewConversationAnalysesName', () => {
                const result = client.matchAuthorizedViewSetFromProjectLocationAuthorizedViewSetAuthorizedViewConversationAnalysesName(fakePath);
                assert.strictEqual(result, "authorizedViewSetValue");
                assert((client.pathTemplates.projectLocationAuthorizedViewSetAuthorizedViewConversationAnalysesPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchAuthorizedViewFromProjectLocationAuthorizedViewSetAuthorizedViewConversationAnalysesName', () => {
                const result = client.matchAuthorizedViewFromProjectLocationAuthorizedViewSetAuthorizedViewConversationAnalysesName(fakePath);
                assert.strictEqual(result, "authorizedViewValue");
                assert((client.pathTemplates.projectLocationAuthorizedViewSetAuthorizedViewConversationAnalysesPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchConversationFromProjectLocationAuthorizedViewSetAuthorizedViewConversationAnalysesName', () => {
                const result = client.matchConversationFromProjectLocationAuthorizedViewSetAuthorizedViewConversationAnalysesName(fakePath);
                assert.strictEqual(result, "conversationValue");
                assert((client.pathTemplates.projectLocationAuthorizedViewSetAuthorizedViewConversationAnalysesPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchAnalysisFromProjectLocationAuthorizedViewSetAuthorizedViewConversationAnalysesName', () => {
                const result = client.matchAnalysisFromProjectLocationAuthorizedViewSetAuthorizedViewConversationAnalysesName(fakePath);
        ...
        describe('projectLocationAuthorizedViewSetAuthorizedViewConversationFeedbackLabels', async () => {
            const fakePath = "/rendered/path/projectLocationAuthorizedViewSetAuthorizedViewConversationFeedbackLabels";
            const expectedParameters = {
                project: "projectValue",
                location: "locationValue",
                authorized_view_set: "authorizedViewSetValue",
            ...
            await client.initialize();
            client.pathTemplates.projectLocationAuthorizedViewSetAuthorizedViewConversationFeedbackLabelsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.projectLocationAuthorizedViewSetAuthorizedViewConversationFeedbackLabelsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('projectLocationAuthorizedViewSetAuthorizedViewConversationFeedbackLabelsPath', () => {
                const result = client.projectLocationAuthorizedViewSetAuthorizedViewConversationFeedbackLabelsPath("projectValue", "locationValue", "authorizedViewSetValue", "authorizedViewValue", "conversationValue", "feedbackLabelValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectLocationAuthorizedViewSetAuthorizedViewConversationFeedbackLabelsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectLocationAuthorizedViewSetAuthorizedViewConversationFeedbackLabelsName', () => {
                const result = client.matchProjectFromProjectLocationAuthorizedViewSetAuthorizedViewConversationFeedbackLabelsName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectLocationAuthorizedViewSetAuthorizedViewConversationFeedbackLabelsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromProjectLocationAuthorizedViewSetAuthorizedViewConversationFeedbackLabelsName', () => {
                const result = client.matchLocationFromProjectLocationAuthorizedViewSetAuthorizedViewConversationFeedbackLabelsName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.projectLocationAuthorizedViewSetAuthorizedViewConversationFeedbackLabelsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchAuthorizedViewSetFromProjectLocationAuthorizedViewSetAuthorizedViewConversationFeedbackLabelsName', () => {
                const result = client.matchAuthorizedViewSetFromProjectLocationAuthorizedViewSetAuthorizedViewConversationFeedbackLabelsName(fakePath);
                assert.strictEqual(result, "authorizedViewSetValue");
                assert((client.pathTemplates.projectLocationAuthorizedViewSetAuthorizedViewConversationFeedbackLabelsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchAuthorizedViewFromProjectLocationAuthorizedViewSetAuthorizedViewConversationFeedbackLabelsName', () => {
                const result = client.matchAuthorizedViewFromProjectLocationAuthorizedViewSetAuthorizedViewConversationFeedbackLabelsName(fakePath);
                assert.strictEqual(result, "authorizedViewValue");
                assert((client.pathTemplates.projectLocationAuthorizedViewSetAuthorizedViewConversationFeedbackLabelsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchConversationFromProjectLocationAuthorizedViewSetAuthorizedViewConversationFeedbackLabelsName', () => {
                const result = client.matchConversationFromProjectLocationAuthorizedViewSetAuthorizedViewConversationFeedbackLabelsName(fakePath);
                assert.strictEqual(result, "conversationValue");
                assert((client.pathTemplates.projectLocationAuthorizedViewSetAuthorizedViewConversationFeedbackLabelsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchFeedbackLabelFromProjectLocationAuthorizedViewSetAuthorizedViewConversationFeedbackLabelsName', () => {
                const result = client.matchFeedbackLabelFromProjectLocationAuthorizedViewSetAuthorizedViewConversationFeedbackLabelsName(fakePath);
        ...
        describe('projectLocationAuthorizedViewSetAuthorizedViewConversations', async () => {
            const fakePath = "/rendered/path/projectLocationAuthorizedViewSetAuthorizedViewConversations";
            const expectedParameters = {
                project: "projectValue",
                location: "locationValue",
                authorized_view_set: "authorizedViewSetValue",
            ...
            await client.initialize();
            client.pathTemplates.projectLocationAuthorizedViewSetAuthorizedViewConversationsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.projectLocationAuthorizedViewSetAuthorizedViewConversationsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('projectLocationAuthorizedViewSetAuthorizedViewConversationsPath', () => {
                const result = client.projectLocationAuthorizedViewSetAuthorizedViewConversationsPath("projectValue", "locationValue", "authorizedViewSetValue", "authorizedViewValue", "conversationValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectLocationAuthorizedViewSetAuthorizedViewConversationsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectLocationAuthorizedViewSetAuthorizedViewConversationsName', () => {
                const result = client.matchProjectFromProjectLocationAuthorizedViewSetAuthorizedViewConversationsName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectLocationAuthorizedViewSetAuthorizedViewConversationsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromProjectLocationAuthorizedViewSetAuthorizedViewConversationsName', () => {
                const result = client.matchLocationFromProjectLocationAuthorizedViewSetAuthorizedViewConversationsName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.projectLocationAuthorizedViewSetAuthorizedViewConversationsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchAuthorizedViewSetFromProjectLocationAuthorizedViewSetAuthorizedViewConversationsName', () => {
                const result = client.matchAuthorizedViewSetFromProjectLocationAuthorizedViewSetAuthorizedViewConversationsName(fakePath);
                assert.strictEqual(result, "authorizedViewSetValue");
                assert((client.pathTemplates.projectLocationAuthorizedViewSetAuthorizedViewConversationsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchAuthorizedViewFromProjectLocationAuthorizedViewSetAuthorizedViewConversationsName', () => {
                const result = client.matchAuthorizedViewFromProjectLocationAuthorizedViewSetAuthorizedViewConversationsName(fakePath);
                assert.strictEqual(result, "authorizedViewValue");
                assert((client.pathTemplates.projectLocationAuthorizedViewSetAuthorizedViewConversationsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchConversationFromProjectLocationAuthorizedViewSetAuthorizedViewConversationsName', () => {
                const result = client.matchConversationFromProjectLocationAuthorizedViewSetAuthorizedViewConversationsName(fakePath);
                assert.strictEqual(result, "conversationValue");
                assert((client.pathTemplates.projectLocationAuthorizedViewSetAuthorizedViewConversationsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('projectLocationConversationAnalyses', async () => {
            const fakePath = "/rendered/path/projectLocationConversationAnalyses";
            const expectedParameters = {
                project: "projectValue",
                location: "locationValue",
                conversation: "conversationValue",
            ...
            await client.initialize();
            client.pathTemplates.projectLocationConversationAnalysesPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.projectLocationConversationAnalysesPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('projectLocationConversationAnalysesPath', () => {
                const result = client.projectLocationConversationAnalysesPath("projectValue", "locationValue", "conversationValue", "analysisValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectLocationConversationAnalysesPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectLocationConversationAnalysesName', () => {
                const result = client.matchProjectFromProjectLocationConversationAnalysesName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectLocationConversationAnalysesPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromProjectLocationConversationAnalysesName', () => {
                const result = client.matchLocationFromProjectLocationConversationAnalysesName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.projectLocationConversationAnalysesPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchConversationFromProjectLocationConversationAnalysesName', () => {
                const result = client.matchConversationFromProjectLocationConversationAnalysesName(fakePath);
                assert.strictEqual(result, "conversationValue");
                assert((client.pathTemplates.projectLocationConversationAnalysesPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchAnalysisFromProjectLocationConversationAnalysesName', () => {
                const result = client.matchAnalysisFromProjectLocationConversationAnalysesName(fakePath);
                assert.strictEqual(result, "analysisValue");
                assert((client.pathTemplates.projectLocationConversationAnalysesPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('projectLocationConversationFeedbackLabels', async () => {
            const fakePath = "/rendered/path/projectLocationConversationFeedbackLabels";
            const expectedParameters = {
                project: "projectValue",
                location: "locationValue",
                conversation: "conversationValue",
            ...
            await client.initialize();
            client.pathTemplates.projectLocationConversationFeedbackLabelsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.projectLocationConversationFeedbackLabelsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('projectLocationConversationFeedbackLabelsPath', () => {
                const result = client.projectLocationConversationFeedbackLabelsPath("projectValue", "locationValue", "conversationValue", "feedbackLabelValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectLocationConversationFeedbackLabelsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectLocationConversationFeedbackLabelsName', () => {
                const result = client.matchProjectFromProjectLocationConversationFeedbackLabelsName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectLocationConversationFeedbackLabelsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromProjectLocationConversationFeedbackLabelsName', () => {
                const result = client.matchLocationFromProjectLocationConversationFeedbackLabelsName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.projectLocationConversationFeedbackLabelsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchConversationFromProjectLocationConversationFeedbackLabelsName', () => {
                const result = client.matchConversationFromProjectLocationConversationFeedbackLabelsName(fakePath);
                assert.strictEqual(result, "conversationValue");
                assert((client.pathTemplates.projectLocationConversationFeedbackLabelsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchFeedbackLabelFromProjectLocationConversationFeedbackLabelsName', () => {
                const result = client.matchFeedbackLabelFromProjectLocationConversationFeedbackLabelsName(fakePath);
                assert.strictEqual(result, "feedbackLabelValue");
                assert((client.pathTemplates.projectLocationConversationFeedbackLabelsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('qaQuestion', async () => {
            ...
            await client.initialize();
            client.pathTemplates.qaQuestionPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.qaQuestionPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('qaQuestionPath', () => {
                const result = client.qaQuestionPath("projectValue", "locationValue", "qaScorecardValue", "revisionValue", "qaQuestionValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.qaQuestionPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromQaQuestionName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.qaQuestionPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('qaScorecard', async () => {
            ...
            await client.initialize();
            client.pathTemplates.qaScorecardPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.qaScorecardPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('qaScorecardPath', () => {
                const result = client.qaScorecardPath("projectValue", "locationValue", "qaScorecardValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.qaScorecardPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromQaScorecardName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.qaScorecardPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('qaScorecardResult', async () => {
            ...
            await client.initialize();
            client.pathTemplates.qaScorecardResultPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.qaScorecardResultPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('qaScorecardResultPath', () => {
                const result = client.qaScorecardResultPath("projectValue", "locationValue", "qaScorecardResultValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.qaScorecardResultPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromQaScorecardResultName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.qaScorecardResultPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('qaScorecardRevision', async () => {
            ...
            await client.initialize();
            client.pathTemplates.qaScorecardRevisionPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.qaScorecardRevisionPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('qaScorecardRevisionPath', () => {
                const result = client.qaScorecardRevisionPath("projectValue", "locationValue", "qaScorecardValue", "revisionValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.qaScorecardRevisionPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromQaScorecardRevisionName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.qaScorecardRevisionPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromQaScorecardRevisionName', () => {
                const result = client.matchLocationFromQaScorecardRevisionName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.qaScorecardRevisionPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchQaScorecardFromQaScorecardRevisionName', () => {
                const result = client.matchQaScorecardFromQaScorecardRevisionName(fakePath);
                assert.strictEqual(result, "qaScorecardValue");
                assert((client.pathTemplates.qaScorecardRevisionPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchRevisionFromQaScorecardRevisionName', () => {
                const result = client.matchRevisionFromQaScorecardRevisionName(fakePath);
                assert.strictEqual(result, "revisionValue");
                assert((client.pathTemplates.qaScorecardRevisionPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
