...
export class ContactCenterInsightsClient {
  ...
  initialize() {
    ...
    const contactCenterInsightsStubMethods =
        ['createConversation', 'uploadConversation', 'updateConversation', 'getConversation', 'listConversations', 'deleteConversation', 'createAnalysis', 'getAnalysis', 'listAnalyses', 'deleteAnalysis', 'bulkAnalyzeConversations', 'ingestConversations', 'exportInsightsData', 'createIssueModel', 'updateIssueModel', 'getIssueModel', 'listIssueModels', 'deleteIssueModel', 'deployIssueModel', 'undeployIssueModel', 'getIssue', 'listIssues', 'updateIssue', 'deleteIssue', 'calculateIssueModelStats', 'createPhraseMatcher', 'getPhraseMatcher', 'listPhraseMatchers', 'deletePhraseMatcher', 'updatePhraseMatcher', 'calculateStats', 'getSettings', 'updateSettings', 'createView', 'getView', 'listViews', 'updateView', 'deleteView'];
