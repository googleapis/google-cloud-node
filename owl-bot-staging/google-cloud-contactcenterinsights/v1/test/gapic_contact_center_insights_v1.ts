...
describe('v1.ContactCenterInsightsClient', () => {
    ...
    describe('Path templates', () => {
        ...
        describe('feedbackLabel', () => {
            ...
            client.initialize();
            client.pathTemplates.feedbackLabelPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.feedbackLabelPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('feedbackLabelPath', () => {
                const result = client.feedbackLabelPath("projectValue", "locationValue", "conversationValue", "feedbackLabelValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.feedbackLabelPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromFeedbackLabelName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.feedbackLabelPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
