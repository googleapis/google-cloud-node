...
function main(rolloutKind) {
  ...
  async function callUpdateRolloutKind() {
    // Construct request
    const request = {
      rolloutKind,
    };
    ...
    // Run request
    const response = await saasservicemgmtClient.updateRolloutKind(request);
    console.log(response);
  }

  callUpdateRolloutKind();
