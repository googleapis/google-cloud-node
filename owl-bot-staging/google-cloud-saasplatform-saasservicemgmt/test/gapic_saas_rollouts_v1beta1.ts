...
describe('v1beta1.SaasRolloutsClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          saasrolloutsModule.v1beta1.SaasRolloutsClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          saasrolloutsModule.v1beta1.SaasRolloutsClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'saasservicemgmt.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        ...
        it('value configured in code has priority over environment variable', () => {
          ...
          assert.strictEqual(
            servicePath,
            'saasservicemgmt.configured.example.com',
          );
          if (saved) {
            process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = saved;
          } else {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new saasrolloutsModule.v1beta1.SaasRolloutsClient({
          universe_domain: 'example.com',
    ...
    it('invokes getRollout without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getRollout(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.saasplatform.saasservicemgmt.v1beta1.IRollout | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createRollout', () => {
    ...
    it('invokes createRollout with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createRollout = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateRollout', () => {
    it('invokes updateRollout without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateRollout as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateRollout as SinonStub
    ...
    it('invokes updateRollout without error using callback', async () => {
      ...
      client.innerApiCalls.updateRollout =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes updateRollout with error', async () => {
      ...
      const expectedHeaderRequestParams = `rollout.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateRollout = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteRollout', () => {
    it('invokes deleteRollout without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteRollout as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteRollout as SinonStub
    ...
    it('invokes deleteRollout without error using callback', async () => {
      ...
      client.innerApiCalls.deleteRollout =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes deleteRollout with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteRollout = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getRolloutKind', () => {
    it('invokes getRolloutKind without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getRolloutKind as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getRolloutKind as SinonStub
    ...
    it('invokes getRolloutKind without error using callback', async () => {
      ...
      client.innerApiCalls.getRolloutKind =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getRolloutKind(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.saasplatform.saasservicemgmt.v1beta1.IRolloutKind | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getRolloutKind with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getRolloutKind = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createRolloutKind', () => {
    it('invokes createRolloutKind without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createRolloutKind as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createRolloutKind as SinonStub
    ...
    it('invokes createRolloutKind without error using callback', async () => {
      ...
      client.innerApiCalls.createRolloutKind =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes createRolloutKind with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createRolloutKind = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateRolloutKind', () => {
    it('invokes updateRolloutKind without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateRolloutKind as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateRolloutKind as SinonStub
    ...
    it('invokes updateRolloutKind without error using callback', async () => {
      ...
      client.innerApiCalls.updateRolloutKind =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes updateRolloutKind with error', async () => {
      ...
      const expectedHeaderRequestParams = `rollout_kind.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateRolloutKind = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteRolloutKind', () => {
    it('invokes deleteRolloutKind without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteRolloutKind as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteRolloutKind as SinonStub
    ...
    it('invokes deleteRolloutKind without error using callback', async () => {
      ...
      client.innerApiCalls.deleteRolloutKind =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes deleteRolloutKind with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteRolloutKind = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listRolloutsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.saasplatform.saasservicemgmt.v1beta1.Rollout,
          ) => {
  ...
  describe('listRolloutKinds', () => {
    it('invokes listRolloutKinds without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listRolloutKinds as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listRolloutKinds as SinonStub
    ...
    it('invokes listRolloutKinds without error using callback', async () => {
      ...
      client.innerApiCalls.listRolloutKinds =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listRolloutKinds with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listRolloutKinds = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listRolloutKindsStream without error', async () => {
      ...
      client.descriptors.page.listRolloutKinds.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.saasplatform.saasservicemgmt.v1beta1.RolloutKind,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (client.descriptors.page.listRolloutKinds.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listRolloutKinds, request),
      );
      assert(
        (client.descriptors.page.listRolloutKinds.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listRolloutKinds without error', async () => {
      ...
      client.descriptors.page.listRolloutKinds.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('Path templates', () => {
    ...
    describe('rolloutKind', async () => {
      ...
      await client.initialize();
      client.pathTemplates.rolloutKindPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.rolloutKindPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('rolloutKindPath', () => {
        const result = client.rolloutKindPath(
          'projectValue',
          'locationValue',
          'rolloutKindIdValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.rolloutKindPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromRolloutKindName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.rolloutKindPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('saas', async () => {
      ...
      await client.initialize();
      client.pathTemplates.saasPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.saasPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('saasPath', () => {
        const result = client.saasPath(
          'projectValue',
          'locationValue',
          'saasValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.saasPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromSaasName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.saasPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('tenant', async () => {
      ...
      it('tenantPath', () => {
        const result = client.tenantPath(
          'projectValue',
          'locationValue',
          'tenantValue',
        );
    ...
    describe('unit', async () => {
      ...
      await client.initialize();
      client.pathTemplates.unitPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.unitPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('unitPath', () => {
        const result = client.unitPath(
          'projectValue',
          'locationValue',
          'unitValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.unitPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromUnitName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.unitPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('unitKind', async () => {
      ...
      await client.initialize();
      client.pathTemplates.unitKindPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.unitKindPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('unitKindPath', () => {
        const result = client.unitKindPath(
          'projectValue',
          'locationValue',
          'unitKindValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.unitKindPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromUnitKindName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.unitKindPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('unitOperation', async () => {
      ...
      await client.initialize();
      client.pathTemplates.unitOperationPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.unitOperationPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('unitOperationPath', () => {
        const result = client.unitOperationPath(
          'projectValue',
          'locationValue',
          'unitOperationValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.unitOperationPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromUnitOperationName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.unitOperationPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
