...
describe('v1beta1.SaasDeploymentsClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          saasdeploymentsModule.v1beta1.SaasDeploymentsClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          saasdeploymentsModule.v1beta1.SaasDeploymentsClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'saasservicemgmt.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new saasdeploymentsModule.v1beta1.SaasDeploymentsClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'saasservicemgmt.example.com');
          if (saved) {
  ...
  describe('getSaas', () => {
    it('invokes getSaas without error', async () => {
      ...
      const actualRequest = (client.innerApiCalls.getSaas as SinonStub).getCall(
        0,
      ).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getSaas as SinonStub
    ...
    it('invokes getSaas without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getSaas(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.saasplatform.saasservicemgmt.v1beta1.ISaas | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createSaas', () => {
    it('invokes createSaas without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createSaas as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createSaas as SinonStub
    ...
    it('invokes createSaas without error using callback', async () => {
      ...
      client.innerApiCalls.createSaas =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createSaas(
          request,
    ...
    it('invokes createSaas with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createSaas = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateSaas', () => {
    it('invokes updateSaas without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateSaas as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateSaas as SinonStub
    ...
    it('invokes updateSaas without error using callback', async () => {
      ...
      client.innerApiCalls.updateSaas =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.updateSaas(
          request,
    ...
    it('invokes updateSaas with error', async () => {
      ...
      const expectedHeaderRequestParams = `saas.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateSaas = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteSaas', () => {
    it('invokes deleteSaas without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteSaas as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteSaas as SinonStub
    ...
    it('invokes deleteSaas without error using callback', async () => {
      ...
      client.innerApiCalls.deleteSaas =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.deleteSaas(
          request,
    ...
    it('invokes deleteSaas with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteSaas = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes getTenant without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getTenant(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.saasplatform.saasservicemgmt.v1beta1.ITenant | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getUnitKind', () => {
    it('invokes getUnitKind without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getUnitKind as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getUnitKind as SinonStub
    ...
    it('invokes getUnitKind without error using callback', async () => {
      ...
      client.innerApiCalls.getUnitKind =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getUnitKind(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.saasplatform.saasservicemgmt.v1beta1.IUnitKind | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getUnitKind with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getUnitKind = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createUnitKind', () => {
    it('invokes createUnitKind without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createUnitKind as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createUnitKind as SinonStub
    ...
    it('invokes createUnitKind without error using callback', async () => {
      ...
      client.innerApiCalls.createUnitKind =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes createUnitKind with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createUnitKind = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateUnitKind', () => {
    it('invokes updateUnitKind without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateUnitKind as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateUnitKind as SinonStub
    ...
    it('invokes updateUnitKind without error using callback', async () => {
      ...
      client.innerApiCalls.updateUnitKind =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes updateUnitKind with error', async () => {
      ...
      const expectedHeaderRequestParams = `unit_kind.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateUnitKind = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteUnitKind', () => {
    it('invokes deleteUnitKind without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteUnitKind as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteUnitKind as SinonStub
    ...
    it('invokes deleteUnitKind without error using callback', async () => {
      ...
      client.innerApiCalls.deleteUnitKind =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes deleteUnitKind with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteUnitKind = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getUnit', () => {
    it('invokes getUnit without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (client.innerApiCalls.getUnit as SinonStub).getCall(
        0,
      ).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getUnit as SinonStub
      ).getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
      assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
    });
    ...
    it('invokes getUnit without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getUnit(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.saasplatform.saasservicemgmt.v1beta1.IUnit | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createUnit', () => {
    it('invokes createUnit without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createUnit as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createUnit as SinonStub
    ...
    it('invokes createUnit without error using callback', async () => {
      ...
      client.innerApiCalls.createUnit =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createUnit(
          request,
    ...
    it('invokes createUnit with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createUnit = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateUnit', () => {
    it('invokes updateUnit without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateUnit as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateUnit as SinonStub
    ...
    it('invokes updateUnit without error using callback', async () => {
      ...
      client.innerApiCalls.updateUnit =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.updateUnit(
          request,
    ...
    it('invokes updateUnit with error', async () => {
      ...
      const expectedHeaderRequestParams = `unit.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateUnit = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteUnit', () => {
    it('invokes deleteUnit without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteUnit as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteUnit as SinonStub
    ...
    it('invokes deleteUnit without error using callback', async () => {
      ...
      client.innerApiCalls.deleteUnit =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.deleteUnit(
          request,
    ...
    it('invokes deleteUnit with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteUnit = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getUnitOperation', () => {
    it('invokes getUnitOperation without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getUnitOperation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getUnitOperation as SinonStub
    ...
    it('invokes getUnitOperation without error using callback', async () => {
      ...
      client.innerApiCalls.getUnitOperation =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getUnitOperation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.saasplatform.saasservicemgmt.v1beta1.IUnitOperation | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getUnitOperation with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getUnitOperation = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createUnitOperation', () => {
    it('invokes createUnitOperation without error', async () => {
      ...
      client.innerApiCalls.createUnitOperation =
        stubSimpleCall(expectedResponse);
      const [response] = await client.createUnitOperation(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createUnitOperation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createUnitOperation as SinonStub
    ...
    it('invokes createUnitOperation with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createUnitOperation = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateUnitOperation', () => {
    it('invokes updateUnitOperation without error', async () => {
      ...
      client.innerApiCalls.updateUnitOperation =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateUnitOperation(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateUnitOperation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateUnitOperation as SinonStub
    ...
    it('invokes updateUnitOperation with error', async () => {
      ...
      const expectedHeaderRequestParams = `unit_operation.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateUnitOperation = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteUnitOperation', () => {
    it('invokes deleteUnitOperation without error', async () => {
      ...
      client.innerApiCalls.deleteUnitOperation =
        stubSimpleCall(expectedResponse);
      const [response] = await client.deleteUnitOperation(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteUnitOperation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteUnitOperation as SinonStub
    ...
    it('invokes deleteUnitOperation with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteUnitOperation = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes getRelease without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getRelease(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.saasplatform.saasservicemgmt.v1beta1.IRelease | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createRelease', () => {
    ...
    it('invokes createRelease with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createRelease = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateRelease', () => {
    ...
    it('invokes updateRelease with error', async () => {
      ...
      const expectedHeaderRequestParams = `release.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateRelease = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteRelease', () => {
    ...
    it('invokes deleteRelease with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteRelease = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listSaas', () => {
    it('invokes listSaas without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listSaas as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listSaas as SinonStub
    ...
    it('invokes listSaasStream without error', async () => {
      ...
      client.descriptors.page.listSaas.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.saasplatform.saasservicemgmt.v1beta1.Saas,
          ) => {
      ...
      assert(
        (client.descriptors.page.listSaas.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listSaas, request),
      );
      assert(
        (client.descriptors.page.listSaas.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listSaasStream with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listSaas.createStream = stubPageStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.listSaasStream(request);
    ...
    it('uses async iteration with listSaas without error', async () => {
      ...
      client.descriptors.page.listSaas.asyncIterate =
      ...
      assert.deepStrictEqual(
        (client.descriptors.page.listSaas.asyncIterate as SinonStub).getCall(0)
          .args[1],
        request,
      );
      assert(
    ...
    it('uses async iteration with listSaas with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listSaas.asyncIterate = stubAsyncIterationCall(
        undefined,
        expectedError,
      );
      const iterable = client.listSaasAsync(request);
    ...
    it('invokes listTenantsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.saasplatform.saasservicemgmt.v1beta1.Tenant,
          ) => {
            responses.push(response);
          },
        );
  ...
  describe('listUnitKinds', () => {
    it('invokes listUnitKinds without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listUnitKinds as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listUnitKinds as SinonStub
    ...
    it('invokes listUnitKinds without error using callback', async () => {
      ...
      client.innerApiCalls.listUnitKinds =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listUnitKinds with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listUnitKinds = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listUnitKindsStream without error', async () => {
      ...
      client.descriptors.page.listUnitKinds.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.saasplatform.saasservicemgmt.v1beta1.UnitKind,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (client.descriptors.page.listUnitKinds.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listUnitKinds, request),
      );
      assert(
        (client.descriptors.page.listUnitKinds.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listUnitKinds without error', async () => {
      ...
      client.descriptors.page.listUnitKinds.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listUnits', () => {
    it('invokes listUnits without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listUnits as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listUnits as SinonStub
    ...
    it('invokes listUnits without error using callback', async () => {
      ...
      client.innerApiCalls.listUnits =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listUnits(
          request,
    ...
    it('invokes listUnitsStream without error', async () => {
      ...
      client.descriptors.page.listUnits.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.saasplatform.saasservicemgmt.v1beta1.Unit,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (client.descriptors.page.listUnits.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listUnits, request),
      );
      assert(
        (client.descriptors.page.listUnits.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listUnitsStream with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listUnits.createStream = stubPageStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.listUnitsStream(request);
    ...
    it('uses async iteration with listUnits without error', async () => {
      ...
      client.descriptors.page.listUnits.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      ...
      assert.deepStrictEqual(responses, expectedResponse);
      assert.deepStrictEqual(
        (client.descriptors.page.listUnits.asyncIterate as SinonStub).getCall(0)
          .args[1],
        request,
      );
      assert(
    ...
    it('uses async iteration with listUnits with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listUnits.asyncIterate = stubAsyncIterationCall(
        undefined,
        expectedError,
      );
      const iterable = client.listUnitsAsync(request);
  ...
  describe('listUnitOperations', () => {
    it('invokes listUnitOperations without error', async () => {
      ...
      client.innerApiCalls.listUnitOperations =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listUnitOperations(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listUnitOperations as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listUnitOperations as SinonStub
    ...
    it('invokes listUnitOperations with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listUnitOperations = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listUnitOperationsStream without error', async () => {
      ...
      client.descriptors.page.listUnitOperations.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.saasplatform.saasservicemgmt.v1beta1.UnitOperation,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (client.descriptors.page.listUnitOperations.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listUnitOperations, request),
      );
      assert(
        (client.descriptors.page.listUnitOperations.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listUnitOperations without error', async () => {
      ...
      client.descriptors.page.listUnitOperations.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
    ...
    it('invokes listReleasesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.saasplatform.saasservicemgmt.v1beta1.Release,
          ) => {
            responses.push(response);
          },
        );
