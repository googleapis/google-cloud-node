...
function main(parent, rolloutKindId, rolloutKind) {
  ...
  async function callCreateRolloutKind() {
    // Construct request
    const request = {
      parent,
      rolloutKindId,
    ...
    // Run request
    const response = await saasservicemgmtClient.createRolloutKind(request);
    console.log(response);
  }

  callCreateRolloutKind();
