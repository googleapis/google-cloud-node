...
function main(rollout) {
  // [START saasservicemgmt_v1beta1_generated_SaasRollouts_UpdateRollout_async]
  /**
  ...
  async function callUpdateRollout() {
    // Construct request
    const request = {
      rollout,
    };
    ...
    // Run request
    const response = await saasservicemgmtClient.updateRollout(request);
    console.log(response);
  }

  callUpdateRollout();
  // [END saasservicemgmt_v1beta1_generated_SaasRollouts_UpdateRollout_async]
}
