...
function main(tenant) {
  // [START saasservicemgmt_v1beta1_generated_SaasDeployments_UpdateTenant_async]
  /**
  ...
  async function callUpdateTenant() {
    ...
    // Run request
    const response = await saasservicemgmtClient.updateTenant(request);
    console.log(response);
  }

  callUpdateTenant();
  // [END saasservicemgmt_v1beta1_generated_SaasDeployments_UpdateTenant_async]
}
