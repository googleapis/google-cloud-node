...
function main(unitOperation) {
  ...
  async function callUpdateUnitOperation() {
    // Construct request
    const request = {
      unitOperation,
    };
    ...
    // Run request
    const response = await saasservicemgmtClient.updateUnitOperation(request);
    console.log(response);
  }

  callUpdateUnitOperation();
