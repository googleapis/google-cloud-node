...
describe('v1.DepServiceClient', () => {
  ...
  describe('getLbEdgeExtension', () => {
    it('invokes getLbEdgeExtension without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkservices.v1.GetLbEdgeExtensionRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getLbEdgeExtension as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getLbEdgeExtension as SinonStub
    ...
    it('invokes getLbEdgeExtension without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getLbEdgeExtension(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networkservices.v1.ILbEdgeExtension | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getLbEdgeExtension with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getLbEdgeExtension = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getAuthzExtension', () => {
    it('invokes getAuthzExtension without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getAuthzExtension as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getAuthzExtension as SinonStub
    ...
    it('invokes getAuthzExtension without error using callback', async () => {
      ...
      client.innerApiCalls.getAuthzExtension =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getAuthzExtension(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networkservices.v1.IAuthzExtension | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getAuthzExtension with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getAuthzExtension = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createLbEdgeExtension', () => {
    it('invokes createLbEdgeExtension without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createLbEdgeExtension as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createLbEdgeExtension as SinonStub
    ...
    it('invokes createLbEdgeExtension with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createLbEdgeExtension = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createLbEdgeExtension(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createLbEdgeExtension as SinonStub
    ...
    it('invokes checkCreateLbEdgeExtensionProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateLbEdgeExtensionProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateLbEdgeExtension', () => {
    it('invokes updateLbEdgeExtension without error', async () => {
      ...
      client.innerApiCalls.updateLbEdgeExtension =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateLbEdgeExtension(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateLbEdgeExtension as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateLbEdgeExtension as SinonStub
    ...
    it('invokes updateLbEdgeExtension with call error', async () => {
      ...
      const expectedHeaderRequestParams = `lb_edge_extension.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateLbEdgeExtension = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateLbEdgeExtension(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateLbEdgeExtension as SinonStub
  ...
  describe('deleteLbEdgeExtension', () => {
    it('invokes deleteLbEdgeExtension without error', async () => {
      ...
      client.innerApiCalls.deleteLbEdgeExtension =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteLbEdgeExtension(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteLbEdgeExtension as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteLbEdgeExtension as SinonStub
    ...
    it('invokes deleteLbEdgeExtension with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteLbEdgeExtension = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteLbEdgeExtension(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteLbEdgeExtension as SinonStub
    ...
    it('invokes checkDeleteLbEdgeExtensionProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteLbEdgeExtensionProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createAuthzExtension', () => {
    it('invokes createAuthzExtension without error', async () => {
      ...
      client.innerApiCalls.createAuthzExtension =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createAuthzExtension(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createAuthzExtension as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createAuthzExtension as SinonStub
    ...
    it('invokes createAuthzExtension with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createAuthzExtension = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkCreateAuthzExtensionProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateAuthzExtensionProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateAuthzExtension', () => {
    it('invokes updateAuthzExtension without error', async () => {
      ...
      client.innerApiCalls.updateAuthzExtension =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateAuthzExtension(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateAuthzExtension as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateAuthzExtension as SinonStub
    ...
    it('invokes updateAuthzExtension with call error', async () => {
      ...
      const expectedHeaderRequestParams = `authz_extension.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateAuthzExtension = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkUpdateAuthzExtensionProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateAuthzExtensionProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteAuthzExtension', () => {
    it('invokes deleteAuthzExtension without error', async () => {
      ...
      client.innerApiCalls.deleteAuthzExtension =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteAuthzExtension(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteAuthzExtension as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteAuthzExtension as SinonStub
    ...
    it('invokes deleteAuthzExtension with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteAuthzExtension = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkDeleteAuthzExtensionProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteAuthzExtensionProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listLbEdgeExtensions', () => {
    it('invokes listLbEdgeExtensions without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listLbEdgeExtensions as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listLbEdgeExtensions as SinonStub
    ...
    it('invokes listLbEdgeExtensions with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listLbEdgeExtensions = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listLbEdgeExtensionsStream without error', async () => {
      ...
      client.descriptors.page.listLbEdgeExtensions.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networkservices.v1.LbEdgeExtension,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (client.descriptors.page.listLbEdgeExtensions.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listLbEdgeExtensions, request),
      );
      assert(
        (client.descriptors.page.listLbEdgeExtensions.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listLbEdgeExtensions without error', async () => {
      ...
      client.descriptors.page.listLbEdgeExtensions.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listAuthzExtensions', () => {
    it('invokes listAuthzExtensions without error', async () => {
      ...
      client.innerApiCalls.listAuthzExtensions =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listAuthzExtensions(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listAuthzExtensions as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listAuthzExtensions as SinonStub
    ...
    it('invokes listAuthzExtensions with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listAuthzExtensions = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listAuthzExtensionsStream without error', async () => {
      ...
      client.descriptors.page.listAuthzExtensions.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.networkservices.v1.AuthzExtension) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listAuthzExtensions.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listAuthzExtensions, request),
      );
      assert(
        (client.descriptors.page.listAuthzExtensions.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listAuthzExtensions without error', async () => {
      ...
      client.descriptors.page.listAuthzExtensions.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
