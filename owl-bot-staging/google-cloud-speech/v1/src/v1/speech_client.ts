...
export class SpeechClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this.descriptors.stream = {
      streamingRecognize: new this._gaxModule.StreamDescriptor(this._gaxModule.StreamType.BIDI_STREAMING, !!opts.fallback, /* gaxStreamingRetries: */ true)
    };
    ...
    const longRunningRecognizeResponse = protoFilesRoot.lookup(
      '.google.cloud.speech.v1.LongRunningRecognizeResponse') as gax.protobuf.Type;
    const longRunningRecognizeMetadata = protoFilesRoot.lookup(
      '.google.cloud.speech.v1.LongRunningRecognizeMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.speech.v1.Speech', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.speechStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.speech.v1.Speech') :
 ...
 */
  recognize(
      ...
      Promise<[
        ...
        protos.google.cloud.speech.v1.IRecognizeRequest|undefined, {}|undefined
      ]>;
  recognize(
      request: protos.google.cloud.speech.v1.IRecognizeRequest,
      options: CallOptions,
 ...
 */
  async checkLongRunningRecognizeProgress(name: string): Promise<LROperation<protos.google.cloud.speech.v1.LongRunningRecognizeResponse, protos.google.cloud.speech.v1.LongRunningRecognizeMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.speech.v1.LongRunningRecognizeResponse, protos.google.cloud.speech.v1.LongRunningRecognizeMetadata>;
  }
/**
