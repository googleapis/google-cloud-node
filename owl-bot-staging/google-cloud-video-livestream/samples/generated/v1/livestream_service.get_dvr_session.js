...
function main(name) {
  // [START livestream_v1_generated_LivestreamService_GetDvrSession_async]
  /**
  ...
  async function callGetDvrSession() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await livestreamClient.getDvrSession(request);
