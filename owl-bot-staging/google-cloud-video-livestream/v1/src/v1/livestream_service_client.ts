...
export class LivestreamServiceClient {
  ...
  initialize() {
    ...
    const livestreamServiceStubMethods =
        ['createChannel', 'listChannels', 'getChannel', 'deleteChannel', 'updateChannel', 'startChannel', 'stopChannel', 'createInput', 'listInputs', 'getInput', 'deleteInput', 'updateInput', 'createEvent', 'listEvents', 'getEvent', 'deleteEvent', 'listClips', 'getClip', 'createClip', 'deleteClip', 'createAsset', 'deleteAsset', 'getAsset', 'listAssets', 'getPool', 'updatePool'];
