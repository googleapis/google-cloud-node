...
export class LivestreamServiceClient {
  ...
  initialize() {
    ...
    const livestreamServiceStubMethods =
        ['createChannel', 'listChannels', 'getChannel', 'deleteChannel', 'updateChannel', 'startChannel', 'stopChannel', 'createInput', 'listInputs', 'getInput', 'deleteInput', 'updateInput', 'createEvent', 'listEvents', 'getEvent', 'deleteEvent', 'createAsset', 'deleteAsset', 'getAsset', 'listAssets', 'getPool', 'updatePool'];
