...
export class CloudTasksClient {
  ...
  initialize() {
    ...
    const cloudTasksStubMethods =
        ['listQueues', 'getQueue', 'createQueue', 'updateQueue', 'deleteQueue', 'purgeQueue', 'pauseQueue', 'resumeQueue', 'getIamPolicy', 'setIamPolicy', 'testIamPermissions', 'listTasks', 'getTask', 'createTask', 'deleteTask', 'runTask', 'bufferTask'];
 ...
 */
  bufferTask(
      ...
      Promise<[
        ...
        protos.google.cloud.tasks.v2beta3.IBufferTaskRequest|undefined, {}|undefined
      ]>;
  bufferTask(
      request: protos.google.cloud.tasks.v2beta3.IBufferTaskRequest,
      options: CallOptions,
