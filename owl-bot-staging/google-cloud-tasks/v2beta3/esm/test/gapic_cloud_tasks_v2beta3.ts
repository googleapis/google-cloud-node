...
describe('v2beta3.CloudTasksClient', () => {
    ...
    describe('getQueue', () => {
        it('invokes getQueue without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.tasks.v2beta3.GetQueueRequest', ['name']);
        ...
        it('invokes getQueue without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getQueue(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.tasks.v2beta3.IQueue|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createQueue', () => {
        it('invokes createQueue without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.tasks.v2beta3.CreateQueueRequest', ['parent']);
    ...
    describe('updateQueue', () => {
        it('invokes updateQueue without error', async () => {
            ...
            request.queue ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.tasks.v2beta3.UpdateQueueRequest', ['queue', 'name']);
    ...
    describe('deleteQueue', () => {
        it('invokes deleteQueue without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.tasks.v2beta3.DeleteQueueRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('purgeQueue', () => {
        it('invokes purgeQueue without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.tasks.v2beta3.PurgeQueueRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.tasks.v2beta3.Queue()
    ...
    describe('pauseQueue', () => {
        it('invokes pauseQueue without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.tasks.v2beta3.PauseQueueRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.tasks.v2beta3.Queue()
    ...
    describe('resumeQueue', () => {
        it('invokes resumeQueue without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.tasks.v2beta3.ResumeQueueRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.tasks.v2beta3.Queue()
    ...
    describe('getTask', () => {
        it('invokes getTask without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.tasks.v2beta3.GetTaskRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getTask without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getTask(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.tasks.v2beta3.ITask|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createTask', () => {
        it('invokes createTask without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.tasks.v2beta3.CreateTaskRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.tasks.v2beta3.Task()
    ...
    describe('deleteTask', () => {
        it('invokes deleteTask without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.tasks.v2beta3.DeleteTaskRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('runTask', () => {
        it('invokes runTask without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.tasks.v2beta3.RunTaskRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.tasks.v2beta3.Task()
    ...
    describe('bufferTask', () => {
        it('invokes bufferTask without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.tasks.v2beta3.BufferTaskRequest', ['queue']);
            request.queue = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.tasks.v2beta3.BufferTaskRequest', ['taskId']);
        ...
        it('invokes bufferTask without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.bufferTask(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.tasks.v2beta3.IBufferTaskResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listQueues', () => {
        it('invokes listQueues without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.tasks.v2beta3.ListQueuesRequest', ['parent']);
            request.parent = defaultValue1;
        ...
        it('invokes listQueuesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.tasks.v2beta3.Queue) => {
    ...
    describe('listTasks', () => {
        it('invokes listTasks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.tasks.v2beta3.ListTasksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
        ...
        it('invokes listTasksStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.tasks.v2beta3.Task) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
