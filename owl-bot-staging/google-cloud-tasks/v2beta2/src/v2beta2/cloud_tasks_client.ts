...
export class CloudTasksClient {
  ...
  initialize() {
    ...
    const cloudTasksStubMethods =
        ['listQueues', 'getQueue', 'createQueue', 'updateQueue', 'deleteQueue', 'purgeQueue', 'pauseQueue', 'resumeQueue', 'uploadQueueYaml', 'getIamPolicy', 'setIamPolicy', 'testIamPermissions', 'listTasks', 'getTask', 'createTask', 'deleteTask', 'leaseTasks', 'acknowledgeTask', 'renewLease', 'cancelLease', 'runTask', 'bufferTask'];
 ...
 */
  bufferTask(
      ...
      Promise<[
        ...
        protos.google.cloud.tasks.v2beta2.IBufferTaskRequest|undefined, {}|undefined
      ]>;
  bufferTask(
      request: protos.google.cloud.tasks.v2beta2.IBufferTaskRequest,
      options: CallOptions,
