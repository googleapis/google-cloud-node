...
export class TranslationServiceClient {
  ...
  initialize() {
    ...
    const translationServiceStubMethods =
        ['translateText', 'detectLanguage', 'getSupportedLanguages', 'translateDocument', 'batchTranslateText', 'batchTranslateDocument', 'createGlossary', 'listGlossaries', 'getGlossary', 'deleteGlossary', 'createAdaptiveMtDataset', 'deleteAdaptiveMtDataset', 'getAdaptiveMtDataset', 'listAdaptiveMtDatasets', 'adaptiveMtTranslate', 'getAdaptiveMtFile', 'deleteAdaptiveMtFile', 'importAdaptiveMtFile', 'listAdaptiveMtFiles', 'listAdaptiveMtSentences'];
