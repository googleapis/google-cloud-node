...
describe('v3.TranslationServiceClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new translationserviceModule.v3.TranslationServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'translate.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new translationserviceModule.v3.TranslationServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'translate.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new translationserviceModule.v3.TranslationServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new translationserviceModule.v3.TranslationServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('translateText', () => {
        it('invokes translateText without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.TranslateTextRequest', ['parent']);
    ...
    describe('romanizeText', () => {
        it('invokes romanizeText without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.RomanizeTextRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.romanizeText as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.romanizeText as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes romanizeText without error using callback', async () => {
            ...
            client.innerApiCalls.romanizeText = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.romanizeText(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.translation.v3.IRomanizeTextResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes romanizeText with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.romanizeText = stubSimpleCall(undefined, expectedError);
    ...
    describe('detectLanguage', () => {
        it('invokes detectLanguage without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.DetectLanguageRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getSupportedLanguages', () => {
        it('invokes getSupportedLanguages without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.GetSupportedLanguagesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('translateDocument', () => {
        it('invokes translateDocument without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.TranslateDocumentRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes translateDocument without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.translateDocument(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.translation.v3.ITranslateDocumentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getGlossary', () => {
        it('invokes getGlossary without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.GetGlossaryRequest', ['name']);
    ...
    describe('getGlossaryEntry', () => {
        it('invokes getGlossaryEntry without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.GetGlossaryEntryRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getGlossaryEntry as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getGlossaryEntry as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getGlossaryEntry without error using callback', async () => {
            ...
            client.innerApiCalls.getGlossaryEntry = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getGlossaryEntry(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.translation.v3.IGlossaryEntry|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getGlossaryEntry with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getGlossaryEntry = stubSimpleCall(undefined, expectedError);
    ...
    describe('createGlossaryEntry', () => {
        it('invokes createGlossaryEntry without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.CreateGlossaryEntryRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.translation.v3.GlossaryEntry()
            );
            client.innerApiCalls.createGlossaryEntry = stubSimpleCall(expectedResponse);
            const [response] = await client.createGlossaryEntry(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createGlossaryEntry as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createGlossaryEntry as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createGlossaryEntry without error using callback', async () => {
            ...
            client.innerApiCalls.createGlossaryEntry = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createGlossaryEntry with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createGlossaryEntry = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateGlossaryEntry', () => {
        it('invokes updateGlossaryEntry without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.UpdateGlossaryEntryRequest', ['glossaryEntry', 'name']);
            request.glossaryEntry.name = defaultValue1;
            const expectedHeaderRequestParams = `glossary_entry.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.translation.v3.GlossaryEntry()
            );
            client.innerApiCalls.updateGlossaryEntry = stubSimpleCall(expectedResponse);
            const [response] = await client.updateGlossaryEntry(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateGlossaryEntry as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateGlossaryEntry as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateGlossaryEntry without error using callback', async () => {
            ...
            client.innerApiCalls.updateGlossaryEntry = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateGlossaryEntry with error', async () => {
            ...
            const expectedHeaderRequestParams = `glossary_entry.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateGlossaryEntry = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteGlossaryEntry', () => {
        it('invokes deleteGlossaryEntry without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.DeleteGlossaryEntryRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteGlossaryEntry = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteGlossaryEntry(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteGlossaryEntry as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteGlossaryEntry as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteGlossaryEntry without error using callback', async () => {
            ...
            client.innerApiCalls.deleteGlossaryEntry = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteGlossaryEntry with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteGlossaryEntry = stubSimpleCall(undefined, expectedError);
    ...
    describe('getDataset', () => {
        it('invokes getDataset without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.GetDatasetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getDataset without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getDataset(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.translation.v3.IDataset|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createAdaptiveMtDataset', () => {
        it('invokes createAdaptiveMtDataset without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.CreateAdaptiveMtDatasetRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.translation.v3.AdaptiveMtDataset()
            );
            client.innerApiCalls.createAdaptiveMtDataset = stubSimpleCall(expectedResponse);
            const [response] = await client.createAdaptiveMtDataset(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createAdaptiveMtDataset as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createAdaptiveMtDataset as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createAdaptiveMtDataset without error using callback', async () => {
            ...
            client.innerApiCalls.createAdaptiveMtDataset = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createAdaptiveMtDataset(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.translation.v3.IAdaptiveMtDataset|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createAdaptiveMtDataset with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createAdaptiveMtDataset = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createAdaptiveMtDataset(request), expectedError);
            const actualRequest = (client.innerApiCalls.createAdaptiveMtDataset as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createAdaptiveMtDataset as SinonStub)
    ...
    describe('deleteAdaptiveMtDataset', () => {
        it('invokes deleteAdaptiveMtDataset without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.DeleteAdaptiveMtDatasetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteAdaptiveMtDataset = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteAdaptiveMtDataset(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteAdaptiveMtDataset as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteAdaptiveMtDataset as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteAdaptiveMtDataset without error using callback', async () => {
            ...
            client.innerApiCalls.deleteAdaptiveMtDataset = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteAdaptiveMtDataset with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteAdaptiveMtDataset = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.deleteAdaptiveMtDataset(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteAdaptiveMtDataset as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteAdaptiveMtDataset as SinonStub)
    ...
    describe('getAdaptiveMtDataset', () => {
        it('invokes getAdaptiveMtDataset without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.GetAdaptiveMtDatasetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.translation.v3.AdaptiveMtDataset()
            );
            client.innerApiCalls.getAdaptiveMtDataset = stubSimpleCall(expectedResponse);
            const [response] = await client.getAdaptiveMtDataset(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getAdaptiveMtDataset as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getAdaptiveMtDataset as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getAdaptiveMtDataset without error using callback', async () => {
            ...
            client.innerApiCalls.getAdaptiveMtDataset = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getAdaptiveMtDataset with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getAdaptiveMtDataset = stubSimpleCall(undefined, expectedError);
    ...
    describe('adaptiveMtTranslate', () => {
        it('invokes adaptiveMtTranslate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.AdaptiveMtTranslateRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.translation.v3.AdaptiveMtTranslateResponse()
            );
            client.innerApiCalls.adaptiveMtTranslate = stubSimpleCall(expectedResponse);
            const [response] = await client.adaptiveMtTranslate(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.adaptiveMtTranslate as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.adaptiveMtTranslate as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes adaptiveMtTranslate without error using callback', async () => {
            ...
            client.innerApiCalls.adaptiveMtTranslate = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.adaptiveMtTranslate(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.translation.v3.IAdaptiveMtTranslateResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes adaptiveMtTranslate with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.adaptiveMtTranslate = stubSimpleCall(undefined, expectedError);
    ...
    describe('getAdaptiveMtFile', () => {
        it('invokes getAdaptiveMtFile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.GetAdaptiveMtFileRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getAdaptiveMtFile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getAdaptiveMtFile as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getAdaptiveMtFile without error using callback', async () => {
            ...
            client.innerApiCalls.getAdaptiveMtFile = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAdaptiveMtFile(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.translation.v3.IAdaptiveMtFile|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAdaptiveMtFile with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getAdaptiveMtFile = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteAdaptiveMtFile', () => {
        it('invokes deleteAdaptiveMtFile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.DeleteAdaptiveMtFileRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteAdaptiveMtFile = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteAdaptiveMtFile(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteAdaptiveMtFile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteAdaptiveMtFile as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteAdaptiveMtFile without error using callback', async () => {
            ...
            client.innerApiCalls.deleteAdaptiveMtFile = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteAdaptiveMtFile with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteAdaptiveMtFile = stubSimpleCall(undefined, expectedError);
    ...
    describe('importAdaptiveMtFile', () => {
        it('invokes importAdaptiveMtFile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.ImportAdaptiveMtFileRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.translation.v3.ImportAdaptiveMtFileResponse()
            );
            client.innerApiCalls.importAdaptiveMtFile = stubSimpleCall(expectedResponse);
            const [response] = await client.importAdaptiveMtFile(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importAdaptiveMtFile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.importAdaptiveMtFile as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes importAdaptiveMtFile without error using callback', async () => {
            ...
            client.innerApiCalls.importAdaptiveMtFile = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.importAdaptiveMtFile(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.translation.v3.IImportAdaptiveMtFileResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes importAdaptiveMtFile with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.importAdaptiveMtFile = stubSimpleCall(undefined, expectedError);
    ...
    describe('getModel', () => {
        it('invokes getModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.GetModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getModel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getModel(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.translation.v3.IModel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('batchTranslateText', () => {
        it('invokes batchTranslateText without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.BatchTranslateTextRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('batchTranslateDocument', () => {
        it('invokes batchTranslateDocument without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.BatchTranslateDocumentRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes batchTranslateDocument without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchTranslateDocument(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.translation.v3.IBatchTranslateDocumentResponse, protos.google.cloud.translation.v3.IBatchTranslateDocumentMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.translation.v3.IBatchTranslateDocumentResponse, protos.google.cloud.translation.v3.IBatchTranslateDocumentMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchTranslateDocument as SinonStub)
                .getCall(0).args[0];
    ...
    describe('createGlossary', () => {
        it('invokes createGlossary without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.CreateGlossaryRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('updateGlossary', () => {
        it('invokes updateGlossary without error', async () => {
            ...
            request.glossary ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.UpdateGlossaryRequest', ['glossary', 'name']);
        ...
        it('invokes updateGlossary without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updateGlossary(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.translation.v3.IGlossary, protos.google.cloud.translation.v3.IUpdateGlossaryMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.translation.v3.IGlossary, protos.google.cloud.translation.v3.IUpdateGlossaryMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateGlossary as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteGlossary', () => {
        it('invokes deleteGlossary without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.DeleteGlossaryRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createDataset', () => {
        it('invokes createDataset without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.CreateDatasetRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createDataset without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createDataset(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.translation.v3.IDataset, protos.google.cloud.translation.v3.ICreateDatasetMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.translation.v3.IDataset, protos.google.cloud.translation.v3.ICreateDatasetMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createDataset as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteDataset', () => {
        it('invokes deleteDataset without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.DeleteDatasetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes deleteDataset without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deleteDataset(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.translation.v3.IDeleteDatasetMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.translation.v3.IDeleteDatasetMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteDataset as SinonStub)
                .getCall(0).args[0];
    ...
    describe('importData', () => {
        it('invokes importData without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.ImportDataRequest', ['dataset']);
        ...
        it('invokes importData without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.importData(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.translation.v3.IImportDataMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.translation.v3.IImportDataMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importData as SinonStub)
                .getCall(0).args[0];
    ...
    describe('exportData', () => {
        it('invokes exportData without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.ExportDataRequest', ['dataset']);
            request.dataset = defaultValue1;
            const expectedHeaderRequestParams = `dataset=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes exportData without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.exportData(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.translation.v3.IExportDataMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.translation.v3.IExportDataMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportData as SinonStub)
                .getCall(0).args[0];
    ...
    describe('createModel', () => {
        it('invokes createModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.CreateModelRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createModel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.translation.v3.IModel, protos.google.cloud.translation.v3.ICreateModelMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.translation.v3.IModel, protos.google.cloud.translation.v3.ICreateModelMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createModel as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteModel', () => {
        it('invokes deleteModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.DeleteModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes deleteModel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deleteModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.translation.v3.IDeleteModelMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.translation.v3.IDeleteModelMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteModel as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listGlossaries', () => {
        it('invokes listGlossaries without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.ListGlossariesRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listGlossaryEntries', () => {
        it('invokes listGlossaryEntries without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.ListGlossaryEntriesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.translation.v3.GlossaryEntry()),
              generateSampleMessage(new protos.google.cloud.translation.v3.GlossaryEntry()),
              generateSampleMessage(new protos.google.cloud.translation.v3.GlossaryEntry()),
            ];
            client.innerApiCalls.listGlossaryEntries = stubSimpleCall(expectedResponse);
            const [response] = await client.listGlossaryEntries(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listGlossaryEntries as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listGlossaryEntries as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listGlossaryEntries without error using callback', async () => {
            ...
            client.innerApiCalls.listGlossaryEntries = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listGlossaryEntries with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listGlossaryEntries = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listGlossaryEntriesStream without error', async () => {
            ...
            client.descriptors.page.listGlossaryEntries.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listGlossaryEntriesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.translation.v3.GlossaryEntry[] = [];
                stream.on('data', (response: protos.google.cloud.translation.v3.GlossaryEntry) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listGlossaryEntries.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listGlossaryEntries, request));
            assert(
        ...
        it('invokes listGlossaryEntriesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listGlossaryEntries.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listGlossaryEntriesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.translation.v3.GlossaryEntry[] = [];
                stream.on('data', (response: protos.google.cloud.translation.v3.GlossaryEntry) => {
        ...
        it('uses async iteration with listGlossaryEntries without error', async () => {
            ...
            client.descriptors.page.listGlossaryEntries.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listGlossaryEntries with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listGlossaryEntries.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listGlossaryEntriesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.translation.v3.IGlossaryEntry[] = [];
                for await (const resource of iterable) {
    ...
    describe('listDatasets', () => {
        it('invokes listDatasets without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.ListDatasetsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
        ...
        it('invokes listDatasetsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.translation.v3.Dataset) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listAdaptiveMtDatasets', () => {
        it('invokes listAdaptiveMtDatasets without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.ListAdaptiveMtDatasetsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.translation.v3.AdaptiveMtDataset()),
              generateSampleMessage(new protos.google.cloud.translation.v3.AdaptiveMtDataset()),
              generateSampleMessage(new protos.google.cloud.translation.v3.AdaptiveMtDataset()),
            ];
            client.innerApiCalls.listAdaptiveMtDatasets = stubSimpleCall(expectedResponse);
            const [response] = await client.listAdaptiveMtDatasets(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listAdaptiveMtDatasets as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAdaptiveMtDatasets as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listAdaptiveMtDatasets without error using callback', async () => {
            ...
            client.innerApiCalls.listAdaptiveMtDatasets = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listAdaptiveMtDatasets with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listAdaptiveMtDatasets = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listAdaptiveMtDatasets(request), expectedError);
            const actualRequest = (client.innerApiCalls.listAdaptiveMtDatasets as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAdaptiveMtDatasets as SinonStub)
        ...
        it('invokes listAdaptiveMtDatasetsStream without error', async () => {
            ...
            client.descriptors.page.listAdaptiveMtDatasets.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.translation.v3.AdaptiveMtDataset) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listAdaptiveMtDatasets.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listAdaptiveMtDatasets, request));
            assert(
                (client.descriptors.page.listAdaptiveMtDatasets.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listAdaptiveMtDatasetsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAdaptiveMtDatasets.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listAdaptiveMtDatasetsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.translation.v3.AdaptiveMtDataset[] = [];
                stream.on('data', (response: protos.google.cloud.translation.v3.AdaptiveMtDataset) => {
        ...
        it('uses async iteration with listAdaptiveMtDatasets without error', async () => {
            ...
            client.descriptors.page.listAdaptiveMtDatasets.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listAdaptiveMtDatasets.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listAdaptiveMtDatasets.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listAdaptiveMtDatasets with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAdaptiveMtDatasets.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listAdaptiveMtDatasetsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.translation.v3.IAdaptiveMtDataset[] = [];
                for await (const resource of iterable) {
    ...
    describe('listAdaptiveMtFiles', () => {
        it('invokes listAdaptiveMtFiles without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.ListAdaptiveMtFilesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.translation.v3.AdaptiveMtFile()),
              generateSampleMessage(new protos.google.cloud.translation.v3.AdaptiveMtFile()),
              generateSampleMessage(new protos.google.cloud.translation.v3.AdaptiveMtFile()),
            ];
            client.innerApiCalls.listAdaptiveMtFiles = stubSimpleCall(expectedResponse);
            const [response] = await client.listAdaptiveMtFiles(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listAdaptiveMtFiles as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAdaptiveMtFiles as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listAdaptiveMtFiles without error using callback', async () => {
            ...
            client.innerApiCalls.listAdaptiveMtFiles = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listAdaptiveMtFiles with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listAdaptiveMtFiles = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listAdaptiveMtFilesStream without error', async () => {
            ...
            client.descriptors.page.listAdaptiveMtFiles.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listAdaptiveMtFilesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.translation.v3.AdaptiveMtFile[] = [];
                stream.on('data', (response: protos.google.cloud.translation.v3.AdaptiveMtFile) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listAdaptiveMtFiles.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listAdaptiveMtFiles, request));
            assert(
        ...
        it('invokes listAdaptiveMtFilesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAdaptiveMtFiles.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listAdaptiveMtFilesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.translation.v3.AdaptiveMtFile[] = [];
                stream.on('data', (response: protos.google.cloud.translation.v3.AdaptiveMtFile) => {
        ...
        it('uses async iteration with listAdaptiveMtFiles without error', async () => {
            ...
            client.descriptors.page.listAdaptiveMtFiles.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listAdaptiveMtFiles with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAdaptiveMtFiles.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listAdaptiveMtFilesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.translation.v3.IAdaptiveMtFile[] = [];
                for await (const resource of iterable) {
    ...
    describe('listAdaptiveMtSentences', () => {
        it('invokes listAdaptiveMtSentences without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.ListAdaptiveMtSentencesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.translation.v3.AdaptiveMtSentence()),
              generateSampleMessage(new protos.google.cloud.translation.v3.AdaptiveMtSentence()),
              generateSampleMessage(new protos.google.cloud.translation.v3.AdaptiveMtSentence()),
            ];
            client.innerApiCalls.listAdaptiveMtSentences = stubSimpleCall(expectedResponse);
            const [response] = await client.listAdaptiveMtSentences(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listAdaptiveMtSentences as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAdaptiveMtSentences as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listAdaptiveMtSentences without error using callback', async () => {
            ...
            client.innerApiCalls.listAdaptiveMtSentences = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listAdaptiveMtSentences(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.translation.v3.IAdaptiveMtSentence[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listAdaptiveMtSentences with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listAdaptiveMtSentences = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listAdaptiveMtSentences(request), expectedError);
            const actualRequest = (client.innerApiCalls.listAdaptiveMtSentences as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAdaptiveMtSentences as SinonStub)
        ...
        it('invokes listAdaptiveMtSentencesStream without error', async () => {
            ...
            client.descriptors.page.listAdaptiveMtSentences.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.translation.v3.AdaptiveMtSentence) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listAdaptiveMtSentences.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listAdaptiveMtSentences, request));
            assert(
                (client.descriptors.page.listAdaptiveMtSentences.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listAdaptiveMtSentencesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAdaptiveMtSentences.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listAdaptiveMtSentencesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.translation.v3.AdaptiveMtSentence[] = [];
                stream.on('data', (response: protos.google.cloud.translation.v3.AdaptiveMtSentence) => {
        ...
        it('uses async iteration with listAdaptiveMtSentences without error', async () => {
            ...
            client.descriptors.page.listAdaptiveMtSentences.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listAdaptiveMtSentences.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listAdaptiveMtSentences.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listAdaptiveMtSentences with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAdaptiveMtSentences.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listAdaptiveMtSentencesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.translation.v3.IAdaptiveMtSentence[] = [];
                for await (const resource of iterable) {
    ...
    describe('listExamples', () => {
        it('invokes listExamples without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.ListExamplesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
        ...
        it('invokes listExamples without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listExamples(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.translation.v3.IExample[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listExamplesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.translation.v3.Example) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listModels', () => {
        it('invokes listModels without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.translation.v3.ListModelsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
        ...
        it('invokes listModelsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.translation.v3.Model) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('Path templates', () => {
        ...
        describe('adaptiveMtDataset', async () => {
            ...
            await client.initialize();
            client.pathTemplates.adaptiveMtDatasetPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.adaptiveMtDatasetPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('adaptiveMtDatasetPath', () => {
                const result = client.adaptiveMtDatasetPath("projectValue", "locationValue", "datasetValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.adaptiveMtDatasetPathTemplate.render as SinonStub)
            ...
            it('matchProjectFromAdaptiveMtDatasetName', () => {
                ...
                assert((client.pathTemplates.adaptiveMtDatasetPathTemplate.match as SinonStub)
        ...
        describe('adaptiveMtFile', async () => {
            ...
            await client.initialize();
            client.pathTemplates.adaptiveMtFilePathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.adaptiveMtFilePathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('adaptiveMtFilePath', () => {
                const result = client.adaptiveMtFilePath("projectValue", "locationValue", "datasetValue", "fileValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.adaptiveMtFilePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromAdaptiveMtFileName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.adaptiveMtFilePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('adaptiveMtSentence', async () => {
            ...
            await client.initialize();
            client.pathTemplates.adaptiveMtSentencePathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.adaptiveMtSentencePathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('adaptiveMtSentencePath', () => {
                const result = client.adaptiveMtSentencePath("projectValue", "locationValue", "datasetValue", "fileValue", "sentenceValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.adaptiveMtSentencePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromAdaptiveMtSentenceName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.adaptiveMtSentencePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('example', async () => {
            ...
            it('examplePath', () => {
                const result = client.examplePath("projectValue", "locationValue", "datasetValue", "exampleValue");
                assert.strictEqual(result, fakePath);
        ...
        describe('glossaryEntry', async () => {
            ...
            await client.initialize();
            client.pathTemplates.glossaryEntryPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.glossaryEntryPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('glossaryEntryPath', () => {
                const result = client.glossaryEntryPath("projectValue", "locationValue", "glossaryValue", "glossaryEntryValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.glossaryEntryPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromGlossaryEntryName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.glossaryEntryPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
