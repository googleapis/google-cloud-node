...
function main(parent, clientConnectorService) {
   ...
   */
  // const clientConnectorServiceId = 'abc123'
  /**
  ...
  async function callCreateClientConnectorService() {
    // Construct request
    const request = {
      parent,
    ...
    // Run request
    const [operation] = await clientconnectorservicesClient.createClientConnectorService(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callCreateClientConnectorService();
