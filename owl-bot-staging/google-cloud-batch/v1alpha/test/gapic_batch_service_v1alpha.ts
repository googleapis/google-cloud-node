...
describe('v1alpha.BatchServiceClient', () => {
    ...
    describe('createJob', () => {
        it('invokes createJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.batch.v1alpha.CreateJobRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.batch.v1alpha.Job());
    ...
    describe('getJob', () => {
        it('invokes getJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.batch.v1alpha.GetJobRequest());
            request.name = '';
    ...
    describe('getTask', () => {
        it('invokes getTask without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.batch.v1alpha.GetTaskRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.batch.v1alpha.Task());
    ...
    describe('deleteJob', () => {
        it('invokes deleteJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.batch.v1alpha.DeleteJobRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listJobs', () => {
        it('invokes listJobs without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.batch.v1alpha.ListJobsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
