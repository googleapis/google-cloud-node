...
export class BatchServiceClient {
  ...
  initialize() {
    ...
    const batchServiceStubMethods =
        ['createJob', 'getJob', 'deleteJob', 'updateJob', 'listJobs', 'getTask', 'listTasks', 'createResourceAllowance', 'getResourceAllowance', 'deleteResourceAllowance', 'listResourceAllowances', 'updateResourceAllowance'];
