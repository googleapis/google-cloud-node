...
describe('v1.BatchServiceClient', () => {
    ...
    describe('createJob', () => {
        it('invokes createJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateJobRequest', ['parent']);
    ...
    describe('getJob', () => {
        it('invokes getJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetJobRequest', ['name']);
    ...
    describe('deleteJob', () => {
        it('invokes deleteJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listJobs', () => {
        it('invokes listJobs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListJobsRequest', ['parent']);
            request.parent = defaultValue1;
