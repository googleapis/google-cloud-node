...
describe('v1.BatchServiceClient', () => {
    ...
    describe('createJob', () => {
        it('invokes createJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.batch.v1.CreateJobRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.batch.v1.Job());
    ...
    describe('getJob', () => {
        it('invokes getJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.batch.v1.GetJobRequest());
            request.name = '';
    ...
    describe('getTask', () => {
        it('invokes getTask without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.batch.v1.GetTaskRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.batch.v1.Task());
    ...
    describe('listJobs', () => {
        it('invokes listJobs without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.batch.v1.ListJobsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
