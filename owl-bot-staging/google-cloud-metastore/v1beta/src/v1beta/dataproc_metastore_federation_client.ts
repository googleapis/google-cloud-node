...
export class DataprocMetastoreFederationClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.metastore.v1beta.DataprocMetastoreFederation', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.dataprocMetastoreFederationStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.metastore.v1beta.DataprocMetastoreFederation') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.metastore.v1beta.DataprocMetastoreFederation,
 ...
 *   The first element of the array is an object representing [Federation]{@link google.cloud.metastore.v1beta.Federation}.
 *   Please see the
 ...
 */
  getFederation(
      ...
      Promise<[
        ...
        protos.google.cloud.metastore.v1beta.IGetFederationRequest|undefined, {}|undefined
      ]>;
  getFederation(
      request: protos.google.cloud.metastore.v1beta.IGetFederationRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.metastore.v1beta.IFederation,
          protos.google.cloud.metastore.v1beta.IGetFederationRequest|null|undefined,
          {}|null|undefined>): void;
  getFederation(
      request: protos.google.cloud.metastore.v1beta.IGetFederationRequest,
      callback: Callback<
 ...
 * region_tag:metastore_v1beta_generated_DataprocMetastoreFederation_CreateFederation_async
 */
  async checkCreateFederationProgress(name: string): Promise<LROperation<protos.google.cloud.metastore.v1beta.Federation, protos.google.cloud.metastore.v1beta.OperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.metastore.v1beta.Federation, protos.google.cloud.metastore.v1beta.OperationMetadata>;
  }
/**
 ...
 * region_tag:metastore_v1beta_generated_DataprocMetastoreFederation_UpdateFederation_async
 */
  async checkUpdateFederationProgress(name: string): Promise<LROperation<protos.google.cloud.metastore.v1beta.Federation, protos.google.cloud.metastore.v1beta.OperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
 ...
 * region_tag:metastore_v1beta_generated_DataprocMetastoreFederation_DeleteFederation_async
 */
  async checkDeleteFederationProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.metastore.v1beta.OperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [Federation]{@link google.cloud.metastore.v1beta.Federation}.
 ...
 */
  ...
  listFederations(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.metastore.v1beta.IListFederationsResponse|null|undefined,
          protos.google.cloud.metastore.v1beta.IFederation>): void;
  listFederations(
      request: protos.google.cloud.metastore.v1beta.IListFederationsRequest,
      callback: PaginationCallback<
          protos.google.cloud.metastore.v1beta.IListFederationsRequest,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [Federation]{@link google.cloud.metastore.v1beta.Federation} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   [Federation]{@link google.cloud.metastore.v1beta.Federation}. The API will be called under the hood as needed, once per the page,
