...
describe('v1alpha.DataprocMetastoreFederationClient', () => {
    ...
    it('invokes getFederation without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getFederation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.metastore.v1alpha.IFederation | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listFederations', () => {
    ...
    it('invokes listFederationsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.metastore.v1alpha.Federation[] =
          [];
        stream.on(
          'data',
          (response: protos.google.cloud.metastore.v1alpha.Federation) => {
    ...
    it('uses async iteration with listFederations without error', async () => {
      ...
      const responses: protos.google.cloud.metastore.v1alpha.IFederation[] = [];
