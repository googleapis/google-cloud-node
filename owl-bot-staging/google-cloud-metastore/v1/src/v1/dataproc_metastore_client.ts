...
export class DataprocMetastoreClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const createServiceResponse = protoFilesRoot.lookup(
      '.google.cloud.metastore.v1.Service') as gax.protobuf.Type;
    ...
    const createMetadataImportResponse = protoFilesRoot.lookup(
      '.google.cloud.metastore.v1.MetadataImport') as gax.protobuf.Type;
    ...
    const queryMetadataResponse = protoFilesRoot.lookup(
      '.google.cloud.metastore.v1.QueryMetadataResponse') as gax.protobuf.Type;
    const queryMetadataMetadata = protoFilesRoot.lookup(
      '.google.cloud.metastore.v1.OperationMetadata') as gax.protobuf.Type;
    const moveTableToDatabaseResponse = protoFilesRoot.lookup(
      '.google.cloud.metastore.v1.MoveTableToDatabaseResponse') as gax.protobuf.Type;
    const moveTableToDatabaseMetadata = protoFilesRoot.lookup(
      '.google.cloud.metastore.v1.OperationMetadata') as gax.protobuf.Type;
    const alterMetadataResourceLocationResponse = protoFilesRoot.lookup(
      '.google.cloud.metastore.v1.AlterMetadataResourceLocationResponse') as gax.protobuf.Type;
    ...
    this.descriptors.longrunning = {
      ...
      alterMetadataResourceLocation: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        alterMetadataResourceLocationResponse.decode.bind(alterMetadataResourceLocationResponse),
        alterMetadataResourceLocationMetadata.decode.bind(alterMetadataResourceLocationMetadata))
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.metastore.v1.DataprocMetastore', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.dataprocMetastoreStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.metastore.v1.DataprocMetastore') :
    ...
    const dataprocMetastoreStubMethods =
        ['listServices', 'getService', 'createService', 'updateService', 'deleteService', 'listMetadataImports', 'getMetadataImport', 'createMetadataImport', 'updateMetadataImport', 'exportMetadata', 'restoreService', 'listBackups', 'getBackup', 'createBackup', 'deleteBackup', 'queryMetadata', 'moveTableToDatabase', 'alterMetadataResourceLocation'];
 ...
 *   The first element of the array is an object representing {@link protos.google.cloud.metastore.v1.Service|Service}.
 ...
 */
  getService(
      ...
      Promise<[
        ...
        protos.google.cloud.metastore.v1.IGetServiceRequest|undefined, {}|undefined
      ]>;
  getService(
      request: protos.google.cloud.metastore.v1.IGetServiceRequest,
      options: CallOptions,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.cloud.metastore.v1.MetadataImport|MetadataImport}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 ...
 */
  getMetadataImport(
      ...
      Promise<[
        ...
        protos.google.cloud.metastore.v1.IGetMetadataImportRequest|undefined, {}|undefined
      ]>;
  getMetadataImport(
      request: protos.google.cloud.metastore.v1.IGetMetadataImportRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.metastore.v1.IMetadataImport,
          protos.google.cloud.metastore.v1.IGetMetadataImportRequest|null|undefined,
          {}|null|undefined>): void;
  getMetadataImport(
      request: protos.google.cloud.metastore.v1.IGetMetadataImportRequest,
      callback: Callback<
  ...
  getMetadataImport(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getMetadataImport(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.metastore.v1.IMetadataImport,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.cloud.metastore.v1.Backup|Backup}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 ...
 */
  getBackup(
      ...
      Promise<[
        ...
        protos.google.cloud.metastore.v1.IGetBackupRequest|undefined, {}|undefined
      ]>;
  getBackup(
      request: protos.google.cloud.metastore.v1.IGetBackupRequest,
      options: CallOptions,
 ...
 */
  createService(
      ...
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.metastore.v1.IService, protos.google.cloud.metastore.v1.IOperationMetadata>,
 ...
 * region_tag:metastore_v1_generated_DataprocMetastore_CreateService_async
 */
  async checkCreateServiceProgress(name: string): Promise<LROperation<protos.google.cloud.metastore.v1.Service, protos.google.cloud.metastore.v1.OperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.metastore.v1.Service, protos.google.cloud.metastore.v1.OperationMetadata>;
  }
/**
 ...
 * region_tag:metastore_v1_generated_DataprocMetastore_UpdateService_async
 */
  async checkUpdateServiceProgress(name: string): Promise<LROperation<protos.google.cloud.metastore.v1.Service, protos.google.cloud.metastore.v1.OperationMetadata>>{
 ...
 * region_tag:metastore_v1_generated_DataprocMetastore_DeleteService_async
 */
  async checkDeleteServiceProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.metastore.v1.OperationMetadata>>{
 ...
 */
  createMetadataImport(
      ...
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.metastore.v1.IMetadataImport, protos.google.cloud.metastore.v1.IOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
      ]>;
  createMetadataImport(
      request: protos.google.cloud.metastore.v1.ICreateMetadataImportRequest,
  ...
  createMetadataImport(
    ...
    return this.innerApiCalls.createMetadataImport(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.metastore.v1.IMetadataImport, protos.google.cloud.metastore.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:metastore_v1_generated_DataprocMetastore_CreateMetadataImport_async
 */
  async checkCreateMetadataImportProgress(name: string): Promise<LROperation<protos.google.cloud.metastore.v1.MetadataImport, protos.google.cloud.metastore.v1.OperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.metastore.v1.MetadataImport, protos.google.cloud.metastore.v1.OperationMetadata>;
  }
/**
 ...
 */
  ...
  updateMetadataImport(
    ...
    return this.innerApiCalls.updateMetadataImport(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.metastore.v1.IMetadataImport, protos.google.cloud.metastore.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:metastore_v1_generated_DataprocMetastore_UpdateMetadataImport_async
 */
  async checkUpdateMetadataImportProgress(name: string): Promise<LROperation<protos.google.cloud.metastore.v1.MetadataImport, protos.google.cloud.metastore.v1.OperationMetadata>>{
 ...
 */
  exportMetadata(
      ...
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.metastore.v1.IMetadataExport, protos.google.cloud.metastore.v1.IOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
      ]>;
  exportMetadata(
      request: protos.google.cloud.metastore.v1.IExportMetadataRequest,
  ...
  exportMetadata(
    ...
    return this.innerApiCalls.exportMetadata(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.metastore.v1.IMetadataExport, protos.google.cloud.metastore.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:metastore_v1_generated_DataprocMetastore_ExportMetadata_async
 */
  async checkExportMetadataProgress(name: string): Promise<LROperation<protos.google.cloud.metastore.v1.MetadataExport, protos.google.cloud.metastore.v1.OperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.metastore.v1.MetadataExport, protos.google.cloud.metastore.v1.OperationMetadata>;
  }
/**
 ...
 */
  restoreService(
      ...
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.metastore.v1.IRestore, protos.google.cloud.metastore.v1.IOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
      ]>;
  restoreService(
      request: protos.google.cloud.metastore.v1.IRestoreServiceRequest,
  ...
  restoreService(
    ...
    return this.innerApiCalls.restoreService(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.metastore.v1.IRestore, protos.google.cloud.metastore.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:metastore_v1_generated_DataprocMetastore_RestoreService_async
 */
  async checkRestoreServiceProgress(name: string): Promise<LROperation<protos.google.cloud.metastore.v1.Restore, protos.google.cloud.metastore.v1.OperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.metastore.v1.Restore, protos.google.cloud.metastore.v1.OperationMetadata>;
  }
/**
 ...
 */
  createBackup(
      ...
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.metastore.v1.IBackup, protos.google.cloud.metastore.v1.IOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
      ]>;
  createBackup(
      request: protos.google.cloud.metastore.v1.ICreateBackupRequest,
 ...
 * region_tag:metastore_v1_generated_DataprocMetastore_CreateBackup_async
 */
  async checkCreateBackupProgress(name: string): Promise<LROperation<protos.google.cloud.metastore.v1.Backup, protos.google.cloud.metastore.v1.OperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.metastore.v1.Backup, protos.google.cloud.metastore.v1.OperationMetadata>;
  }
/**
 ...
 * region_tag:metastore_v1_generated_DataprocMetastore_DeleteBackup_async
 */
  async checkDeleteBackupProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.metastore.v1.OperationMetadata>>{
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/dataproc_metastore.query_metadata.js</caption>
 * region_tag:metastore_v1_generated_DataprocMetastore_QueryMetadata_async
 */
  queryMetadata(
      request?: protos.google.cloud.metastore.v1.IQueryMetadataRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.metastore.v1.IQueryMetadataResponse, protos.google.cloud.metastore.v1.IOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
      ]>;
  queryMetadata(
      request: protos.google.cloud.metastore.v1.IQueryMetadataRequest,
  ...
  queryMetadata(
    ...
    return this.innerApiCalls.queryMetadata(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.metastore.v1.IQueryMetadataResponse, protos.google.cloud.metastore.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:metastore_v1_generated_DataprocMetastore_QueryMetadata_async
 */
  async checkQueryMetadataProgress(name: string): Promise<LROperation<protos.google.cloud.metastore.v1.QueryMetadataResponse, protos.google.cloud.metastore.v1.OperationMetadata>>{
    this._log.info('queryMetadata long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.queryMetadata, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.metastore.v1.QueryMetadataResponse, protos.google.cloud.metastore.v1.OperationMetadata>;
  }
/**
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/dataproc_metastore.move_table_to_database.js</caption>
 * region_tag:metastore_v1_generated_DataprocMetastore_MoveTableToDatabase_async
 */
  moveTableToDatabase(
      request?: protos.google.cloud.metastore.v1.IMoveTableToDatabaseRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.metastore.v1.IMoveTableToDatabaseResponse, protos.google.cloud.metastore.v1.IOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
      ]>;
  moveTableToDatabase(
      request: protos.google.cloud.metastore.v1.IMoveTableToDatabaseRequest,
  ...
  moveTableToDatabase(
    ...
    return this.innerApiCalls.moveTableToDatabase(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.metastore.v1.IMoveTableToDatabaseResponse, protos.google.cloud.metastore.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:metastore_v1_generated_DataprocMetastore_MoveTableToDatabase_async
 */
  async checkMoveTableToDatabaseProgress(name: string): Promise<LROperation<protos.google.cloud.metastore.v1.MoveTableToDatabaseResponse, protos.google.cloud.metastore.v1.OperationMetadata>>{
    this._log.info('moveTableToDatabase long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.moveTableToDatabase, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.metastore.v1.MoveTableToDatabaseResponse, protos.google.cloud.metastore.v1.OperationMetadata>;
  }
/**
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/dataproc_metastore.alter_metadata_resource_location.js</caption>
 * region_tag:metastore_v1_generated_DataprocMetastore_AlterMetadataResourceLocation_async
 */
  alterMetadataResourceLocation(
      request?: protos.google.cloud.metastore.v1.IAlterMetadataResourceLocationRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.metastore.v1.IAlterMetadataResourceLocationResponse, protos.google.cloud.metastore.v1.IOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
      ]>;
  alterMetadataResourceLocation(
      request: protos.google.cloud.metastore.v1.IAlterMetadataResourceLocationRequest,
  ...
  alterMetadataResourceLocation(
    ...
    const wrappedCallback: Callback<
          ...
          {}|null|undefined>|undefined = callback
      ? (error, response, rawResponse, _) => {
          this._log.info('alterMetadataResourceLocation response %j', rawResponse);
          callback!(error, response, rawResponse, _); // We verified callback above.
        }
      : undefined;
    this._log.info('alterMetadataResourceLocation request %j', request);
    return this.innerApiCalls.alterMetadataResourceLocation(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.metastore.v1.IAlterMetadataResourceLocationResponse, protos.google.cloud.metastore.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:metastore_v1_generated_DataprocMetastore_AlterMetadataResourceLocation_async
 */
  async checkAlterMetadataResourceLocationProgress(name: string): Promise<LROperation<protos.google.cloud.metastore.v1.AlterMetadataResourceLocationResponse, protos.google.cloud.metastore.v1.OperationMetadata>>{
    this._log.info('alterMetadataResourceLocation long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.alterMetadataResourceLocation, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.metastore.v1.AlterMetadataResourceLocationResponse, protos.google.cloud.metastore.v1.OperationMetadata>;
  }
 /**
 ...
 *   {@link protos.google.cloud.metastore.v1.DataprocMetastore.ListServices|DataprocMetastore.ListServices}
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.cloud.metastore.v1.Service|Service}.
 ...
 */
  ...
  listServices(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.metastore.v1.IService>): void;
  listServices(
      request: protos.google.cloud.metastore.v1.IListServicesRequest,
      callback: PaginationCallback<
          protos.google.cloud.metastore.v1.IListServicesRequest,
  ...
  listServices(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.metastore.v1.IListServicesRequest,
      protos.google.cloud.metastore.v1.IListServicesResponse|null|undefined,
      protos.google.cloud.metastore.v1.IService>|undefined = callback
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.cloud.metastore.v1.Service|Service} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   {@link protos.google.cloud.metastore.v1.Service|Service}. The API will be called under the hood as needed, once per the page,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.cloud.metastore.v1.MetadataImport|MetadataImport}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 ...
 */
  ...
  listMetadataImports(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.metastore.v1.IListMetadataImportsResponse|null|undefined,
          protos.google.cloud.metastore.v1.IMetadataImport>): void;
  listMetadataImports(
      request: protos.google.cloud.metastore.v1.IListMetadataImportsRequest,
      callback: PaginationCallback<
          protos.google.cloud.metastore.v1.IListMetadataImportsRequest,
  ...
  listMetadataImports(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.metastore.v1.IListMetadataImportsRequest,
      protos.google.cloud.metastore.v1.IListMetadataImportsResponse|null|undefined,
      protos.google.cloud.metastore.v1.IMetadataImport>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.cloud.metastore.v1.MetadataImport|MetadataImport} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed. Note that it can affect your quota.
 *   We recommend using `listMetadataImportsAsync()`
 *   method described below for async iteration which you can stop as needed.
 ...
 *   An iterable Object that allows {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols | async iteration }.
 *   When you iterate the returned iterable, each element will be an object representing
 *   {@link protos.google.cloud.metastore.v1.MetadataImport|MetadataImport}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 ...
 * @param {string} [request.pageToken]
 *   Optional. A page token, received from a previous
 *   {@link protos.google.cloud.metastore.v1.DataprocMetastore.ListBackups|DataprocMetastore.ListBackups}
 *   call. Provide this token to retrieve the subsequent page.
 *
 *   To retrieve the first page, supply an empty page token.
 *
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.cloud.metastore.v1.Backup|Backup}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 ...
 */
  ...
  listBackups(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.metastore.v1.IBackup>): void;
  listBackups(
      request: protos.google.cloud.metastore.v1.IListBackupsRequest,
      callback: PaginationCallback<
          protos.google.cloud.metastore.v1.IListBackupsRequest,
  ...
  listBackups(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.metastore.v1.IListBackupsRequest,
      protos.google.cloud.metastore.v1.IListBackupsResponse|null|undefined,
      protos.google.cloud.metastore.v1.IBackup>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.cloud.metastore.v1.Backup|Backup} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed. Note that it can affect your quota.
 *   We recommend using `listBackupsAsync()`
 *   method described below for async iteration which you can stop as needed.
 ...
 *   An iterable Object that allows {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols | async iteration }.
 *   When you iterate the returned iterable, each element will be an object representing
 *   {@link protos.google.cloud.metastore.v1.Backup|Backup}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
