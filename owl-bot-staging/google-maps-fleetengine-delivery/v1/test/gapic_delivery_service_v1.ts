...
describe('v1.DeliveryServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = deliveryserviceModule.v1.DeliveryServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = deliveryserviceModule.v1.DeliveryServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'fleetengine.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new deliveryserviceModule.v1.DeliveryServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'fleetengine.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new deliveryserviceModule.v1.DeliveryServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'fleetengine.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new deliveryserviceModule.v1.DeliveryServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new deliveryserviceModule.v1.DeliveryServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createDeliveryVehicle', () => {
        it('invokes createDeliveryVehicle without error', async () => {
            ...
            client.innerApiCalls.createDeliveryVehicle = stubSimpleCall(expectedResponse);
            const [response] = await client.createDeliveryVehicle(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createDeliveryVehicle as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createDeliveryVehicle as SinonStub)
        ...
        it('invokes createDeliveryVehicle without error using callback', async () => {
            ...
            client.innerApiCalls.createDeliveryVehicle = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createDeliveryVehicle(
                    request,
                    (err?: Error|null, result?: protos.maps.fleetengine.delivery.v1.IDeliveryVehicle|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createDeliveryVehicle with error', async () => {
            ...
            client.innerApiCalls.createDeliveryVehicle = stubSimpleCall(undefined, expectedError);
    ...
    describe('getDeliveryVehicle', () => {
        it('invokes getDeliveryVehicle without error', async () => {
            ...
            client.innerApiCalls.getDeliveryVehicle = stubSimpleCall(expectedResponse);
            const [response] = await client.getDeliveryVehicle(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getDeliveryVehicle as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDeliveryVehicle as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getDeliveryVehicle without error using callback', async () => {
            ...
            client.innerApiCalls.getDeliveryVehicle = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getDeliveryVehicle with error', async () => {
            ...
            const expectedHeaderRequestParams = 'provider_id=providers%2Fvalue';
            const expectedError = new Error('expected');
            client.innerApiCalls.getDeliveryVehicle = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateDeliveryVehicle', () => {
        it('invokes updateDeliveryVehicle without error', async () => {
            ...
            client.innerApiCalls.updateDeliveryVehicle = stubSimpleCall(expectedResponse);
            const [response] = await client.updateDeliveryVehicle(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateDeliveryVehicle as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateDeliveryVehicle as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateDeliveryVehicle without error using callback', async () => {
            ...
            client.innerApiCalls.updateDeliveryVehicle = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateDeliveryVehicle with error', async () => {
            ...
            const expectedHeaderRequestParams = 'provider_id=providers%2Fvalue';
            const expectedError = new Error('expected');
            client.innerApiCalls.updateDeliveryVehicle = stubSimpleCall(undefined, expectedError);
    ...
    describe('batchCreateTasks', () => {
        it('invokes batchCreateTasks without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchCreateTasks as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchCreateTasks as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes batchCreateTasks without error using callback', async () => {
            ...
            client.innerApiCalls.batchCreateTasks = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchCreateTasks(
                    request,
                    (err?: Error|null, result?: protos.maps.fleetengine.delivery.v1.IBatchCreateTasksResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchCreateTasks with error', async () => {
            ...
            const expectedHeaderRequestParams = 'provider_id=providers%2Fvalue';
            const expectedError = new Error('expected');
            client.innerApiCalls.batchCreateTasks = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateTask', () => {
        ...
        it('invokes updateTask without error using callback', async () => {
            ...
            client.innerApiCalls.updateTask = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateTask(
                    request,
                    (err?: Error|null, result?: protos.maps.fleetengine.delivery.v1.ITask|null) => {
        ...
        it('invokes updateTask with error', async () => {
            ...
            const expectedHeaderRequestParams = 'provider_id=providers%2Fvalue';
            const expectedError = new Error('expected');
            client.innerApiCalls.updateTask = stubSimpleCall(undefined, expectedError);
    ...
    describe('getTaskTrackingInfo', () => {
        it('invokes getTaskTrackingInfo without error', async () => {
            ...
            client.innerApiCalls.getTaskTrackingInfo = stubSimpleCall(expectedResponse);
            const [response] = await client.getTaskTrackingInfo(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getTaskTrackingInfo as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getTaskTrackingInfo as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getTaskTrackingInfo without error using callback', async () => {
            ...
            client.innerApiCalls.getTaskTrackingInfo = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getTaskTrackingInfo(
                    request,
                    (err?: Error|null, result?: protos.maps.fleetengine.delivery.v1.ITaskTrackingInfo|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getTaskTrackingInfo with error', async () => {
            ...
            const expectedHeaderRequestParams = 'provider_id=providers%2Fvalue';
            const expectedError = new Error('expected');
            client.innerApiCalls.getTaskTrackingInfo = stubSimpleCall(undefined, expectedError);
    ...
    describe('listDeliveryVehicles', () => {
        it('invokes listDeliveryVehicles without error', async () => {
            ...
            request.parent = 'providers/value';
            const expectedHeaderRequestParams = 'provider_id=providers%2Fvalue';const expectedResponse = [
              generateSampleMessage(new protos.maps.fleetengine.delivery.v1.DeliveryVehicle()),
              generateSampleMessage(new protos.maps.fleetengine.delivery.v1.DeliveryVehicle()),
              generateSampleMessage(new protos.maps.fleetengine.delivery.v1.DeliveryVehicle()),
            ];
            client.innerApiCalls.listDeliveryVehicles = stubSimpleCall(expectedResponse);
            const [response] = await client.listDeliveryVehicles(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listDeliveryVehicles as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listDeliveryVehicles as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listDeliveryVehicles without error using callback', async () => {
            ...
            client.innerApiCalls.listDeliveryVehicles = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listDeliveryVehicles with error', async () => {
            ...
            const expectedHeaderRequestParams = 'provider_id=providers%2Fvalue';
            const expectedError = new Error('expected');
            client.innerApiCalls.listDeliveryVehicles = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listDeliveryVehiclesStream without error', async () => {
            ...
            client.descriptors.page.listDeliveryVehicles.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.maps.fleetengine.delivery.v1.DeliveryVehicle) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listDeliveryVehicles.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listDeliveryVehicles, request));
            assert(
        ...
        it('invokes listDeliveryVehiclesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = 'provider_id=providers%2Fvalue';
            const expectedError = new Error('expected');
            client.descriptors.page.listDeliveryVehicles.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listDeliveryVehiclesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.maps.fleetengine.delivery.v1.DeliveryVehicle[] = [];
                stream.on('data', (response: protos.maps.fleetengine.delivery.v1.DeliveryVehicle) => {
        ...
        it('uses async iteration with listDeliveryVehicles without error', async () => {
            ...
            client.descriptors.page.listDeliveryVehicles.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listDeliveryVehicles with error', async () => {
            ...
            const expectedHeaderRequestParams = 'provider_id=providers%2Fvalue';
            const expectedError = new Error('expected');
            client.descriptors.page.listDeliveryVehicles.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listDeliveryVehiclesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.maps.fleetengine.delivery.v1.IDeliveryVehicle[] = [];
                for await (const resource of iterable) {
    ...
    describe('Path templates', () => {
        ...
        describe('deliveryVehicle', () => {
            ...
            it('deliveryVehiclePath', () => {
                const result = client.deliveryVehiclePath("providerValue", "vehicleValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.deliveryVehiclePathTemplate.render as SinonStub)
            ...
            it('matchProviderFromDeliveryVehicleName', () => {
                ...
                assert((client.pathTemplates.deliveryVehiclePathTemplate.match as SinonStub)
        ...
        describe('taskTrackingInfo', () => {
            ...
            it('taskTrackingInfoPath', () => {
                const result = client.taskTrackingInfoPath("providerValue", "trackingValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.taskTrackingInfoPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProviderFromTaskTrackingInfoName', () => {
                ...
                assert.strictEqual(result, "providerValue");
                assert((client.pathTemplates.taskTrackingInfoPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
