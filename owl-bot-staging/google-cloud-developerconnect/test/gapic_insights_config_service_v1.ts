...
describe('v1.InsightsConfigServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          insightsconfigserviceModule.v1.InsightsConfigServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        insightsconfigserviceModule.v1.InsightsConfigServiceClient.port;
      assert(port);
  ...
  describe('getInsightsConfig', () => {
    it('invokes getInsightsConfig without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getInsightsConfig as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getInsightsConfig without error using callback', async () => {
      ...
      client.innerApiCalls.getInsightsConfig =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getInsightsConfig(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.developerconnect.v1.IInsightsConfig | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getInsightsConfig with error', async () => {
      ...
      client.innerApiCalls.getInsightsConfig = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getDeploymentEvent', () => {
    it('invokes getDeploymentEvent without error', async () => {
      ...
      client.innerApiCalls.getDeploymentEvent =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getDeploymentEvent(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getDeploymentEvent as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getDeploymentEvent as SinonStub
    ...
    it('invokes getDeploymentEvent without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDeploymentEvent(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.developerconnect.v1.IDeploymentEvent | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getDeploymentEvent with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getDeploymentEvent = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createInsightsConfig', () => {
    it('invokes createInsightsConfig without error', async () => {
      ...
      client.innerApiCalls.createInsightsConfig =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createInsightsConfig(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createInsightsConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createInsightsConfig as SinonStub
    ...
    it('invokes createInsightsConfig with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createInsightsConfig = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkCreateInsightsConfigProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateInsightsConfigProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateInsightsConfig', () => {
    it('invokes updateInsightsConfig without error', async () => {
      ...
      client.innerApiCalls.updateInsightsConfig =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateInsightsConfig(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateInsightsConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateInsightsConfig as SinonStub
    ...
    it('invokes updateInsightsConfig with call error', async () => {
      ...
      const expectedHeaderRequestParams = `insights_config.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateInsightsConfig = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkUpdateInsightsConfigProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateInsightsConfigProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteInsightsConfig', () => {
    it('invokes deleteInsightsConfig without error', async () => {
      ...
      client.innerApiCalls.deleteInsightsConfig =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteInsightsConfig(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteInsightsConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteInsightsConfig as SinonStub
    ...
    it('invokes deleteInsightsConfig with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteInsightsConfig = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('listInsightsConfigs', () => {
    it('invokes listInsightsConfigs without error', async () => {
      ...
      client.innerApiCalls.listInsightsConfigs =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listInsightsConfigs(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listInsightsConfigs as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listInsightsConfigs as SinonStub
    ...
    it('invokes listInsightsConfigs with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listInsightsConfigs = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listInsightsConfigsStream without error', async () => {
      ...
      client.descriptors.page.listInsightsConfigs.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.developerconnect.v1.InsightsConfig,
          ) => {
      ...
      assert(
        (client.descriptors.page.listInsightsConfigs.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listInsightsConfigs, request),
      );
      assert(
        (client.descriptors.page.listInsightsConfigs.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listInsightsConfigs without error', async () => {
      ...
      client.descriptors.page.listInsightsConfigs.asyncIterate =
  ...
  describe('listDeploymentEvents', () => {
    it('invokes listDeploymentEvents without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listDeploymentEvents as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listDeploymentEvents as SinonStub
    ...
    it('invokes listDeploymentEvents with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listDeploymentEvents = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listDeploymentEventsStream without error', async () => {
      ...
      client.descriptors.page.listDeploymentEvents.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.developerconnect.v1.DeploymentEvent,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (client.descriptors.page.listDeploymentEvents.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listDeploymentEvents, request),
      );
      assert(
        (client.descriptors.page.listDeploymentEvents.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listDeploymentEvents without error', async () => {
      ...
      client.descriptors.page.listDeploymentEvents.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
