...
function main(parent, accountConnectorId, accountConnector) {
  // [START developerconnect_v1_generated_DeveloperConnect_CreateAccountConnector_async]
  /**
   ...
   */
  // const accountConnectorId = 'abc123'
  /**
  ...
  async function callCreateAccountConnector() {
    // Construct request
    const request = {
      parent,
      accountConnectorId,
    ...
    // Run request
    const [operation] = await developerconnectClient.createAccountConnector(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callCreateAccountConnector();
