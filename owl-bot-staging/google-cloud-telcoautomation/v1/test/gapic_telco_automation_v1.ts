...
describe('v1.TelcoAutomationClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new telcoautomationModule.v1.TelcoAutomationClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = telcoautomationModule.v1.TelcoAutomationClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = telcoautomationModule.v1.TelcoAutomationClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'telcoautomation.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new telcoautomationModule.v1.TelcoAutomationClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'telcoautomation.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new telcoautomationModule.v1.TelcoAutomationClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'telcoautomation.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new telcoautomationModule.v1.TelcoAutomationClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new telcoautomationModule.v1.TelcoAutomationClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = telcoautomationModule.v1.TelcoAutomationClient.port;
            assert(port);
    ...
    describe('getOrchestrationCluster', () => {
        it('invokes getOrchestrationCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.GetOrchestrationClusterRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.telcoautomation.v1.OrchestrationCluster()
            );
        ...
        it('invokes getOrchestrationCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getOrchestrationCluster(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.telcoautomation.v1.IOrchestrationCluster|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getEdgeSlm', () => {
        it('invokes getEdgeSlm without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.GetEdgeSlmRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.telcoautomation.v1.EdgeSlm()
            );
        ...
        it('invokes getEdgeSlm without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getEdgeSlm(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.telcoautomation.v1.IEdgeSlm|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createBlueprint', () => {
        it('invokes createBlueprint without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.CreateBlueprintRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.telcoautomation.v1.Blueprint()
            );
        ...
        it('invokes createBlueprint without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createBlueprint(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.telcoautomation.v1.IBlueprint|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateBlueprint', () => {
        it('invokes updateBlueprint without error', async () => {
            ...
            request.blueprint ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.UpdateBlueprintRequest', ['blueprint', 'name']);
    ...
    describe('getBlueprint', () => {
        it('invokes getBlueprint without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.GetBlueprintRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.telcoautomation.v1.Blueprint()
    ...
    describe('deleteBlueprint', () => {
        it('invokes deleteBlueprint without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.DeleteBlueprintRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('approveBlueprint', () => {
        it('invokes approveBlueprint without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.ApproveBlueprintRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.telcoautomation.v1.Blueprint()
    ...
    describe('proposeBlueprint', () => {
        it('invokes proposeBlueprint without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.ProposeBlueprintRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.telcoautomation.v1.Blueprint()
    ...
    describe('rejectBlueprint', () => {
        it('invokes rejectBlueprint without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.RejectBlueprintRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.telcoautomation.v1.Blueprint()
    ...
    describe('discardBlueprintChanges', () => {
        it('invokes discardBlueprintChanges without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.DiscardBlueprintChangesRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.telcoautomation.v1.DiscardBlueprintChangesResponse()
            );
        ...
        it('invokes discardBlueprintChanges without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.discardBlueprintChanges(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.telcoautomation.v1.IDiscardBlueprintChangesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getPublicBlueprint', () => {
        it('invokes getPublicBlueprint without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.GetPublicBlueprintRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.telcoautomation.v1.PublicBlueprint()
            );
        ...
        it('invokes getPublicBlueprint without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getPublicBlueprint(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.telcoautomation.v1.IPublicBlueprint|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createDeployment', () => {
        it('invokes createDeployment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.CreateDeploymentRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.telcoautomation.v1.Deployment()
            );
        ...
        it('invokes createDeployment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createDeployment(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.telcoautomation.v1.IDeployment|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateDeployment', () => {
        it('invokes updateDeployment without error', async () => {
            ...
            request.deployment ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.UpdateDeploymentRequest', ['deployment', 'name']);
    ...
    describe('getDeployment', () => {
        it('invokes getDeployment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.GetDeploymentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.telcoautomation.v1.Deployment()
    ...
    describe('removeDeployment', () => {
        it('invokes removeDeployment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.RemoveDeploymentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('discardDeploymentChanges', () => {
        it('invokes discardDeploymentChanges without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.DiscardDeploymentChangesRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.telcoautomation.v1.DiscardDeploymentChangesResponse()
            );
        ...
        it('invokes discardDeploymentChanges without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.discardDeploymentChanges(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.telcoautomation.v1.IDiscardDeploymentChangesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('applyDeployment', () => {
        it('invokes applyDeployment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.ApplyDeploymentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.telcoautomation.v1.Deployment()
    ...
    describe('computeDeploymentStatus', () => {
        it('invokes computeDeploymentStatus without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.ComputeDeploymentStatusRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.telcoautomation.v1.ComputeDeploymentStatusResponse()
            );
        ...
        it('invokes computeDeploymentStatus without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.computeDeploymentStatus(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.telcoautomation.v1.IComputeDeploymentStatusResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('rollbackDeployment', () => {
        it('invokes rollbackDeployment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.RollbackDeploymentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.telcoautomation.v1.Deployment()
    ...
    describe('getHydratedDeployment', () => {
        it('invokes getHydratedDeployment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.GetHydratedDeploymentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.telcoautomation.v1.HydratedDeployment()
            );
        ...
        it('invokes getHydratedDeployment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getHydratedDeployment(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.telcoautomation.v1.IHydratedDeployment|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateHydratedDeployment', () => {
        it('invokes updateHydratedDeployment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.UpdateHydratedDeploymentRequest', ['hydratedDeployment', 'name']);
    ...
    describe('applyHydratedDeployment', () => {
        it('invokes applyHydratedDeployment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.ApplyHydratedDeploymentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.telcoautomation.v1.HydratedDeployment()
    ...
    describe('createOrchestrationCluster', () => {
        it('invokes createOrchestrationCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.CreateOrchestrationClusterRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes createOrchestrationCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createOrchestrationCluster(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.telcoautomation.v1.IOrchestrationCluster, protos.google.cloud.telcoautomation.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.telcoautomation.v1.IOrchestrationCluster, protos.google.cloud.telcoautomation.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createOrchestrationCluster as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteOrchestrationCluster', () => {
        it('invokes deleteOrchestrationCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.DeleteOrchestrationClusterRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes deleteOrchestrationCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deleteOrchestrationCluster(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.telcoautomation.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.telcoautomation.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteOrchestrationCluster as SinonStub)
                .getCall(0).args[0];
    ...
    describe('createEdgeSlm', () => {
        it('invokes createEdgeSlm without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.CreateEdgeSlmRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createEdgeSlm without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createEdgeSlm(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.telcoautomation.v1.IEdgeSlm, protos.google.cloud.telcoautomation.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.telcoautomation.v1.IEdgeSlm, protos.google.cloud.telcoautomation.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createEdgeSlm as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteEdgeSlm', () => {
        it('invokes deleteEdgeSlm without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.DeleteEdgeSlmRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listOrchestrationClusters', () => {
        it('invokes listOrchestrationClusters without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.ListOrchestrationClustersRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.telcoautomation.v1.OrchestrationCluster()),
              generateSampleMessage(new protos.google.cloud.telcoautomation.v1.OrchestrationCluster()),
              generateSampleMessage(new protos.google.cloud.telcoautomation.v1.OrchestrationCluster()),
            ];
        ...
        it('invokes listOrchestrationClustersStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.telcoautomation.v1.OrchestrationCluster[] = [];
                stream.on('data', (response: protos.google.cloud.telcoautomation.v1.OrchestrationCluster) => {
        ...
        it('uses async iteration with listOrchestrationClusters without error', async () => {
            ...
            const responses: protos.google.cloud.telcoautomation.v1.IOrchestrationCluster[] = [];
    ...
    describe('listEdgeSlms', () => {
        it('invokes listEdgeSlms without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.ListEdgeSlmsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.telcoautomation.v1.EdgeSlm()),
              generateSampleMessage(new protos.google.cloud.telcoautomation.v1.EdgeSlm()),
              generateSampleMessage(new protos.google.cloud.telcoautomation.v1.EdgeSlm()),
            ];
        ...
        it('invokes listEdgeSlmsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.telcoautomation.v1.EdgeSlm[] = [];
                stream.on('data', (response: protos.google.cloud.telcoautomation.v1.EdgeSlm) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listEdgeSlms without error', async () => {
            ...
            const responses: protos.google.cloud.telcoautomation.v1.IEdgeSlm[] = [];
    ...
    describe('listBlueprints', () => {
        it('invokes listBlueprints without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.ListBlueprintsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.telcoautomation.v1.Blueprint()),
              generateSampleMessage(new protos.google.cloud.telcoautomation.v1.Blueprint()),
              generateSampleMessage(new protos.google.cloud.telcoautomation.v1.Blueprint()),
            ];
        ...
        it('invokes listBlueprintsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.telcoautomation.v1.Blueprint[] = [];
                stream.on('data', (response: protos.google.cloud.telcoautomation.v1.Blueprint) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listBlueprints without error', async () => {
            ...
            const responses: protos.google.cloud.telcoautomation.v1.IBlueprint[] = [];
    ...
    describe('listBlueprintRevisions', () => {
        it('invokes listBlueprintRevisions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.ListBlueprintRevisionsRequest', ['name']);
            request.name = defaultValue1;
    ...
    describe('searchBlueprintRevisions', () => {
        it('invokes searchBlueprintRevisions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.SearchBlueprintRevisionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.telcoautomation.v1.Blueprint()),
              generateSampleMessage(new protos.google.cloud.telcoautomation.v1.Blueprint()),
    ...
    describe('searchDeploymentRevisions', () => {
        it('invokes searchDeploymentRevisions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.SearchDeploymentRevisionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.telcoautomation.v1.Deployment()),
              generateSampleMessage(new protos.google.cloud.telcoautomation.v1.Deployment()),
              generateSampleMessage(new protos.google.cloud.telcoautomation.v1.Deployment()),
            ];
        ...
        it('invokes searchDeploymentRevisionsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.telcoautomation.v1.Deployment[] = [];
                stream.on('data', (response: protos.google.cloud.telcoautomation.v1.Deployment) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with searchDeploymentRevisions without error', async () => {
            ...
            const responses: protos.google.cloud.telcoautomation.v1.IDeployment[] = [];
    ...
    describe('listPublicBlueprints', () => {
        it('invokes listPublicBlueprints without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.ListPublicBlueprintsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.telcoautomation.v1.PublicBlueprint()),
              generateSampleMessage(new protos.google.cloud.telcoautomation.v1.PublicBlueprint()),
              generateSampleMessage(new protos.google.cloud.telcoautomation.v1.PublicBlueprint()),
            ];
        ...
        it('invokes listPublicBlueprintsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.telcoautomation.v1.PublicBlueprint[] = [];
                stream.on('data', (response: protos.google.cloud.telcoautomation.v1.PublicBlueprint) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listPublicBlueprints without error', async () => {
            ...
            const responses: protos.google.cloud.telcoautomation.v1.IPublicBlueprint[] = [];
    ...
    describe('listDeployments', () => {
        it('invokes listDeployments without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.ListDeploymentsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.telcoautomation.v1.Deployment()),
              generateSampleMessage(new protos.google.cloud.telcoautomation.v1.Deployment()),
    ...
    describe('listDeploymentRevisions', () => {
        it('invokes listDeploymentRevisions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.ListDeploymentRevisionsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.telcoautomation.v1.Deployment()),
              generateSampleMessage(new protos.google.cloud.telcoautomation.v1.Deployment()),
    ...
    describe('listHydratedDeployments', () => {
        it('invokes listHydratedDeployments without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.telcoautomation.v1.ListHydratedDeploymentsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.telcoautomation.v1.HydratedDeployment()),
              generateSampleMessage(new protos.google.cloud.telcoautomation.v1.HydratedDeployment()),
              generateSampleMessage(new protos.google.cloud.telcoautomation.v1.HydratedDeployment()),
            ];
        ...
        it('invokes listHydratedDeploymentsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.telcoautomation.v1.HydratedDeployment[] = [];
                stream.on('data', (response: protos.google.cloud.telcoautomation.v1.HydratedDeployment) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listHydratedDeployments without error', async () => {
            ...
            const responses: protos.google.cloud.telcoautomation.v1.IHydratedDeployment[] = [];
