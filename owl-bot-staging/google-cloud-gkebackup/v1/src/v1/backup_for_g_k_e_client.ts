...
export class BackupForGKEClient {
  ...
  initialize() {
    ...
    const backupForGKEStubMethods =
        ['createBackupPlan', 'listBackupPlans', 'getBackupPlan', 'updateBackupPlan', 'deleteBackupPlan', 'createBackup', 'listBackups', 'getBackup', 'updateBackup', 'deleteBackup', 'listVolumeBackups', 'getVolumeBackup', 'createRestorePlan', 'listRestorePlans', 'getRestorePlan', 'updateRestorePlan', 'deleteRestorePlan', 'createRestore', 'listRestores', 'getRestore', 'updateRestore', 'deleteRestore', 'listVolumeRestores', 'getVolumeRestore', 'getBackupIndexDownloadUrl'];
 ...
 */
  ...
  getBackupIndexDownloadUrl(
    ...
    this.initialize();
    return this.innerApiCalls.getBackupIndexDownloadUrl(request, options, callback);
  }
