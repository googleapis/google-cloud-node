...
describe('v1.BatchControllerClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = batchcontrollerModule.v1.BatchControllerClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = batchcontrollerModule.v1.BatchControllerClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'dataproc.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new batchcontrollerModule.v1.BatchControllerClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dataproc.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new batchcontrollerModule.v1.BatchControllerClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dataproc.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new batchcontrollerModule.v1.BatchControllerClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new batchcontrollerModule.v1.BatchControllerClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getBatch', () => {
        it('invokes getBatch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.GetBatchRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getBatch as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getBatch as SinonStub)
        ...
        it('invokes getBatch without error using callback', async () => {
            ...
            client.innerApiCalls.getBatch = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getBatch(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataproc.v1.IBatch|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deleteBatch', () => {
        it('invokes deleteBatch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.DeleteBatchRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteBatch as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteBatch as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteBatch without error using callback', async () => {
            ...
            client.innerApiCalls.deleteBatch = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteBatch(
                    request,
        ...
        it('invokes deleteBatch with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteBatch = stubSimpleCall(undefined, expectedError);
    ...
    describe('createBatch', () => {
        it('invokes createBatch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.CreateBatchRequest', ['parent']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createBatch as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createBatch as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createBatch without error using callback', async () => {
            ...
            client.innerApiCalls.createBatch = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createBatch(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dataproc.v1.IBatch, protos.google.cloud.dataproc.v1.IBatchOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dataproc.v1.IBatch, protos.google.cloud.dataproc.v1.IBatchOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createBatch as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createBatch with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createBatch = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes createBatch with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createBatch = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createBatch(request);
        ...
        it('invokes checkCreateBatchProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateBatchProgress(expectedResponse.name);
    ...
    describe('listBatches', () => {
        it('invokes listBatches without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.ListBatchesRequest', ['parent']);
            request.parent = defaultValue1;
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listBatches as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listBatches as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listBatches without error using callback', async () => {
            ...
            client.innerApiCalls.listBatches = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listBatches(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataproc.v1.IBatch[]|null) => {
        ...
        it('invokes listBatches with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listBatches = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listBatchesStream without error', async () => {
            ...
            client.descriptors.page.listBatches.createStream = stubPageStreamingCall(expectedResponse);
            ...
            assert((client.descriptors.page.listBatches.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listBatches, request));
            assert(
        ...
        it('invokes listBatchesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listBatches.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listBatchesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataproc.v1.Batch[] = [];
                stream.on('data', (response: protos.google.cloud.dataproc.v1.Batch) => {
        ...
        it('uses async iteration with listBatches without error', async () => {
            ...
            client.descriptors.page.listBatches.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listBatches with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listBatches.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listBatchesAsync(request);
