...
import type {Callback, CallOptions, Descriptors, ClientOptions, GrpcClientOptions, LROperation, IamClient, IamProtos} from 'google-gax';
 ...
 */
  ...
  getNodeGroup(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getNodeGroup(request, options, wrappedCallback)
 ...
 */
  ...
  createNodeGroup(
    ...
    return this.innerApiCalls.createNodeGroup(request, options, wrappedCallback)
 ...
 */
  ...
  resizeNodeGroup(
    ...
    return this.innerApiCalls.resizeNodeGroup(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.dataproc.v1.INodeGroup, protos.google.cloud.dataproc.v1.INodeGroupOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
