 ...
 */
  ...
  createAutoscalingPolicy(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.createAutoscalingPolicy(request, options, wrappedCallback)
 ...
 */
  updateAutoscalingPolicy(
      ...
      Promise<[
        protos.google.cloud.dataproc.v1.IAutoscalingPolicy,
        protos.google.cloud.dataproc.v1.IUpdateAutoscalingPolicyRequest|undefined, {}|undefined
      ]>;
  updateAutoscalingPolicy(
      request: protos.google.cloud.dataproc.v1.IUpdateAutoscalingPolicyRequest,
      options: CallOptions,
  ...
  updateAutoscalingPolicy(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.updateAutoscalingPolicy(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.dataproc.v1.IAutoscalingPolicy,
 ...
 */
  ...
  getAutoscalingPolicy(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getAutoscalingPolicy(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.dataproc.v1.IAutoscalingPolicy,
 ...
 */
  ...
  deleteAutoscalingPolicy(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.deleteAutoscalingPolicy(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.protobuf.IEmpty,
 ...
 */
  ...
  listAutoscalingPolicies(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.dataproc.v1.IListAutoscalingPoliciesRequest,
      protos.google.cloud.dataproc.v1.IListAutoscalingPoliciesResponse|null|undefined,
      protos.google.cloud.dataproc.v1.IAutoscalingPolicy>|undefined = callback
