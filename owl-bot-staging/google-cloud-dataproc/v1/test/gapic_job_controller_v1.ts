...
describe('v1.JobControllerClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new jobcontrollerModule.v1.JobControllerClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dataproc.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new jobcontrollerModule.v1.JobControllerClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dataproc.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new jobcontrollerModule.v1.JobControllerClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new jobcontrollerModule.v1.JobControllerClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('submitJob', () => {
        it('invokes submitJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.SubmitJobRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.SubmitJobRequest', ['region']);
            ...
            const actualRequest = (client.innerApiCalls.submitJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.submitJob as SinonStub)
        ...
        it('invokes submitJob without error using callback', async () => {
            ...
            client.innerApiCalls.submitJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.submitJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataproc.v1.IJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getJob', () => {
        it('invokes getJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.GetJobRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.GetJobRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.GetJobRequest', ['jobId']);
    ...
    describe('updateJob', () => {
        it('invokes updateJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.UpdateJobRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.UpdateJobRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.UpdateJobRequest', ['jobId']);
            request.jobId = defaultValue3;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&region=${defaultValue2}&job_id=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataproc.v1.Job()
    ...
    describe('cancelJob', () => {
        it('invokes cancelJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.CancelJobRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.CancelJobRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.CancelJobRequest', ['jobId']);
            request.jobId = defaultValue3;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&region=${defaultValue2}&job_id=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataproc.v1.Job()
    ...
    describe('deleteJob', () => {
        it('invokes deleteJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.DeleteJobRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.DeleteJobRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.DeleteJobRequest', ['jobId']);
            request.jobId = defaultValue3;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&region=${defaultValue2}&job_id=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('submitJobAsOperation', () => {
        it('invokes submitJobAsOperation without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.submitJobAsOperation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.submitJobAsOperation as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes submitJobAsOperation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.submitJobAsOperation(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dataproc.v1.IJob, protos.google.cloud.dataproc.v1.IJobMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dataproc.v1.IJob, protos.google.cloud.dataproc.v1.IJobMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.submitJobAsOperation as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkSubmitJobAsOperationProgress without error', async () => {
            ...
            const decodedOperation = await client.checkSubmitJobAsOperationProgress(expectedResponse.name);
        ...
        it('invokes checkSubmitJobAsOperationProgress with error', async () => {
            ...
            await assert.rejects(client.checkSubmitJobAsOperationProgress(''), expectedError);
    ...
    describe('listJobs', () => {
        it('invokes listJobs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.ListJobsRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.ListJobsRequest', ['region']);
            request.region = defaultValue2;
