 ...
 * `src/v1beta4/sql_users_service_client_config.json`.
...
export class SqlUsersServiceClient {
   ...
   *     const client = new SqlUsersServiceClient({fallback: 'rest'}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.sql.v1beta4.SqlUsersService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.sqlUsersServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.sql.v1beta4.SqlUsersService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.sql.v1beta4.SqlUsersService,
 ...
 */
  insert(
      ...
      Promise<[
        protos.google.cloud.sql.v1beta4.IOperation,
        protos.google.cloud.sql.v1beta4.ISqlUsersInsertRequest|undefined, {}|undefined
      ]>;
  insert(
      request: protos.google.cloud.sql.v1beta4.ISqlUsersInsertRequest,
      options: CallOptions,
 ...
 */
  list(
      ...
      Promise<[
        ...
        protos.google.cloud.sql.v1beta4.ISqlUsersListRequest|undefined, {}|undefined
      ]>;
  list(
      request: protos.google.cloud.sql.v1beta4.ISqlUsersListRequest,
      options: CallOptions,
