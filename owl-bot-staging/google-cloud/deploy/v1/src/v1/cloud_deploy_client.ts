...
export class CloudDeployClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this.descriptors.page = {
      ...
      listJobRuns:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'jobRuns')
    };
    ...
    if (opts.fallback === 'rest') {
      ...
      lroOptions.httpRules = [{selector: 'google.cloud.location.Locations.GetLocation',get: '/v1/{name=projects/*/locations/*}',},{selector: 'google.cloud.location.Locations.ListLocations',get: '/v1/{name=projects/*}/locations',},{selector: 'google.iam.v1.IAMPolicy.GetIamPolicy',get: '/v1/{resource=projects/*/locations/*/deliveryPipelines/*}:getIamPolicy',additional_bindings: [{get: '/v1/{resource=projects/*/locations/*/targets/*}:getIamPolicy',}],
      },{selector: 'google.iam.v1.IAMPolicy.SetIamPolicy',post: '/v1/{resource=projects/*/locations/*/deliveryPipelines/*}:setIamPolicy',body: '*',additional_bindings: [{post: '/v1/{resource=projects/*/locations/*/targets/*}:setIamPolicy',body: '*',}],
      },{selector: 'google.iam.v1.IAMPolicy.TestIamPermissions',post: '/v1/{resource=projects/*/locations/*/deliveryPipelines/*}:testIamPermissions',body: '*',additional_bindings: [{post: '/v1/{resource=projects/*/locations/*/targets/*}:testIamPermissions',body: '*',}],
  ...
  initialize() {
    ...
    const cloudDeployStubMethods =
        ['listDeliveryPipelines', 'getDeliveryPipeline', 'createDeliveryPipeline', 'updateDeliveryPipeline', 'deleteDeliveryPipeline', 'listTargets', 'getTarget', 'createTarget', 'updateTarget', 'deleteTarget', 'listReleases', 'getRelease', 'createRelease', 'abandonRelease', 'approveRollout', 'listRollouts', 'getRollout', 'createRollout', 'retryJob', 'listJobRuns', 'getJobRun', 'getConfig'];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [AbandonReleaseResponse]{@link google.cloud.deploy.v1.AbandonReleaseResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 ...
 */
  abandonRelease(
      ...
      Promise<[
        ...
        protos.google.cloud.deploy.v1.IAbandonReleaseRequest|undefined, {}|undefined
      ]>;
  abandonRelease(
      request: protos.google.cloud.deploy.v1.IAbandonReleaseRequest,
      options: CallOptions,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [RetryJobResponse]{@link google.cloud.deploy.v1.RetryJobResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 ...
 */
  retryJob(
      ...
      Promise<[
        ...
        protos.google.cloud.deploy.v1.IRetryJobRequest|undefined, {}|undefined
      ]>;
  retryJob(
      request: protos.google.cloud.deploy.v1.IRetryJobRequest,
      options: CallOptions,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [JobRun]{@link google.cloud.deploy.v1.JobRun}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 ...
 */
  getJobRun(
      ...
      Promise<[
        ...
        protos.google.cloud.deploy.v1.IGetJobRunRequest|undefined, {}|undefined
      ]>;
  getJobRun(
      request: protos.google.cloud.deploy.v1.IGetJobRunRequest,
      options: CallOptions,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [JobRun]{@link google.cloud.deploy.v1.JobRun}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 ...
 */
  ...
  listJobRuns(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.deploy.v1.IJobRun>): void;
  listJobRuns(
      request: protos.google.cloud.deploy.v1.IListJobRunsRequest,
      callback: PaginationCallback<
          protos.google.cloud.deploy.v1.IListJobRunsRequest,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [JobRun]{@link google.cloud.deploy.v1.JobRun} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed. Note that it can affect your quota.
 *   We recommend using `listJobRunsAsync()`
 *   method described below for async iteration which you can stop as needed.
 ...
 *   An iterable Object that allows [async iteration](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols).
 *   When you iterate the returned iterable, each element will be an object representing
 *   [JobRun]{@link google.cloud.deploy.v1.JobRun}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination)
 *   for more details and examples.
...
/**
   ...
   * @returns {string} Resource name string.
   */
  jobRunPath(project:string,location:string,deliveryPipeline:string,release:string,rollout:string,jobRun:string) {
  ...
  matchDeliveryPipelineFromJobRunName(jobRunName: string) {
    return this.pathTemplates.jobRunPathTemplate.match(jobRunName).delivery_pipeline;
  }
