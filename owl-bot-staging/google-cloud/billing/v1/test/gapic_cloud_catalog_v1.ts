...
describe('v1.CloudCatalogClient', () => {
    ...
    describe('listServices', () => {
        ...
        it('invokes listServices without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listServices(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.billing.v1.IService[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listServicesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.billing.v1.Service) => {
    ...
    describe('listSkus', () => {
        it('invokes listSkus without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.billing.v1.ListSkusRequest', ['parent']);
        ...
        it('invokes listSkus without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listSkus(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.billing.v1.ISku[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
