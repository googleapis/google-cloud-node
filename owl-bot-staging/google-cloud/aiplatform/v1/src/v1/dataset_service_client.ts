 ...
 *   Mask specifying which fields of {@link google.cloud.aiplatform.v1.DataItemView|DataItemView} to read.
 ...
 *   {@link google.cloud.aiplatform.v1.SearchDataItemsResponse.next_page_token|SearchDataItemsResponse.next_page_token} of the previous
 *   {@link google.cloud.aiplatform.v1.DatasetService.SearchDataItems|DatasetService.SearchDataItems} call.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
