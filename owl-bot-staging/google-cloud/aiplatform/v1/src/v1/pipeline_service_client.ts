...
export class PipelineServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.aiplatform.v1.PipelineService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.pipelineServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.aiplatform.v1.PipelineService') :
    ...
    const pipelineServiceStubMethods =
        ['createTrainingPipeline', 'getTrainingPipeline', 'listTrainingPipelines', 'deleteTrainingPipeline', 'cancelTrainingPipeline', 'createPipelineJob', 'getPipelineJob', 'listPipelineJobs', 'deletePipelineJob', 'cancelPipelineJob'];
 ...
 */
  createTrainingPipeline(
      ...
      Promise<[
        ...
        protos.google.cloud.aiplatform.v1.ICreateTrainingPipelineRequest|undefined, {}|undefined
      ]>;
  createTrainingPipeline(
      request: protos.google.cloud.aiplatform.v1.ICreateTrainingPipelineRequest,
      options: CallOptions,
 ...
 */
  getTrainingPipeline(
      ...
      Promise<[
        protos.google.cloud.aiplatform.v1.ITrainingPipeline,
        protos.google.cloud.aiplatform.v1.IGetTrainingPipelineRequest|undefined, {}|undefined
      ]>;
  getTrainingPipeline(
      request: protos.google.cloud.aiplatform.v1.IGetTrainingPipelineRequest,
      options: CallOptions,
 ...
 * guaranteed. Clients can use {@link google.cloud.aiplatform.v1.PipelineService.GetTrainingPipeline|PipelineService.GetTrainingPipeline} or
 * other methods to check whether the cancellation succeeded or whether the
 * pipeline completed despite cancellation. On successful cancellation,
 * the TrainingPipeline is not deleted; instead it becomes a pipeline with
 * a {@link google.cloud.aiplatform.v1.TrainingPipeline.error|TrainingPipeline.error} value with a {@link google.rpc.Status.code|google.rpc.Status.code} of 1,
 * corresponding to `Code.CANCELLED`, and {@link google.cloud.aiplatform.v1.TrainingPipeline.state|TrainingPipeline.state} is set to
 * `CANCELLED`.
 *
 * @param {Object} request
 *   The request object that will be sent.
 ...
 */
  getPipelineJob(
      ...
      Promise<[
        protos.google.cloud.aiplatform.v1.IPipelineJob,
        protos.google.cloud.aiplatform.v1.IGetPipelineJobRequest|undefined, {}|undefined
      ]>;
  getPipelineJob(
      request: protos.google.cloud.aiplatform.v1.IGetPipelineJobRequest,
      options: CallOptions,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [TrainingPipeline]{@link google.cloud.aiplatform.v1.TrainingPipeline}.
 ...
 */
  listTrainingPipelinesAsync(
      request?: protos.google.cloud.aiplatform.v1.IListTrainingPipelinesRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.aiplatform.v1.ITrainingPipeline>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
