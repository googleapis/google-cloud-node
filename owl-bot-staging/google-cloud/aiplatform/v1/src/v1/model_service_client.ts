...
export class ModelServiceClient {
  ...
  initialize() {
    ...
    const modelServiceStubMethods =
        ['uploadModel', 'getModel', 'listModels', 'listModelVersions', 'updateModel', 'deleteModel', 'deleteModelVersion', 'mergeVersionAliases', 'exportModel', 'importModelEvaluation', 'batchImportModelEvaluationSlices', 'getModelEvaluation', 'listModelEvaluations', 'getModelEvaluationSlice', 'listModelEvaluationSlices'];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [BatchImportModelEvaluationSlicesResponse]{@link google.cloud.aiplatform.v1.BatchImportModelEvaluationSlicesResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
