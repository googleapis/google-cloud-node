...
describe('v1.IndexEndpointServiceClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = indexendpointserviceModule.v1.IndexEndpointServiceClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = indexendpointserviceModule.v1.IndexEndpointServiceClient.apiEndpoint;
            assert(apiEndpoint);
        });
        ...
        it('invokes getIndexEndpoint without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getIndexEndpoint(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IIndexEndpoint|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createIndexEndpoint', () => {
        it('invokes createIndexEndpoint without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.CreateIndexEndpointRequest', ['parent']);
        ...
        it('invokes createIndexEndpoint without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createIndexEndpoint(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IIndexEndpoint, protos.google.cloud.aiplatform.v1.ICreateIndexEndpointOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IIndexEndpoint, protos.google.cloud.aiplatform.v1.ICreateIndexEndpointOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createIndexEndpoint as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteIndexEndpoint', () => {
        it('invokes deleteIndexEndpoint without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeleteIndexEndpointRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('deployIndex', () => {
        it('invokes deployIndex without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeployIndexRequest', ['indexEndpoint']);
        ...
        it('invokes deployIndex without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deployIndex(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IDeployIndexResponse, protos.google.cloud.aiplatform.v1.IDeployIndexOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IDeployIndexResponse, protos.google.cloud.aiplatform.v1.IDeployIndexOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deployIndex as SinonStub)
                .getCall(0).args[0];
    ...
    describe('undeployIndex', () => {
        it('invokes undeployIndex without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.UndeployIndexRequest', ['indexEndpoint']);
            request.indexEndpoint = defaultValue1;
            const expectedHeaderRequestParams = `index_endpoint=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes undeployIndex without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.undeployIndex(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IUndeployIndexResponse, protos.google.cloud.aiplatform.v1.IUndeployIndexOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IUndeployIndexResponse, protos.google.cloud.aiplatform.v1.IUndeployIndexOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.undeployIndex as SinonStub)
                .getCall(0).args[0];
    ...
    describe('mutateDeployedIndex', () => {
        it('invokes mutateDeployedIndex without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.MutateDeployedIndexRequest', ['indexEndpoint']);
            request.indexEndpoint = defaultValue1;
            const expectedHeaderRequestParams = `index_endpoint=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes mutateDeployedIndex without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateDeployedIndex(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IMutateDeployedIndexResponse, protos.google.cloud.aiplatform.v1.IMutateDeployedIndexOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IMutateDeployedIndexResponse, protos.google.cloud.aiplatform.v1.IMutateDeployedIndexOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.mutateDeployedIndex as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listIndexEndpoints', () => {
        it('invokes listIndexEndpoints without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListIndexEndpointsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.IndexEndpoint()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.IndexEndpoint()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.IndexEndpoint()),
            ];
        ...
        it('invokes listIndexEndpointsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.IndexEndpoint[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.IndexEndpoint) => {
        ...
        it('uses async iteration with listIndexEndpoints without error', async () => {
            ...
            const responses: protos.google.cloud.aiplatform.v1.IIndexEndpoint[] = [];
