...
describe('v1.PredictionServiceClient', () => {
    ...
    describe('predict', () => {
        it('invokes predict without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.PredictRequest', ['endpoint']);
        ...
        it('invokes predict without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.predict(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IPredictResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('rawPredict', () => {
        it('invokes rawPredict without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.RawPredictRequest', ['endpoint']);
            request.endpoint = defaultValue1;
            const expectedHeaderRequestParams = `endpoint=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.rawPredict as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.rawPredict as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes rawPredict without error using callback', async () => {
            ...
            client.innerApiCalls.rawPredict = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.rawPredict(
                    request,
    ...
    describe('explain', () => {
        it('invokes explain without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ExplainRequest', ['endpoint']);
            request.endpoint = defaultValue1;
            const expectedHeaderRequestParams = `endpoint=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.explain as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.explain as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes explain without error using callback', async () => {
            ...
            client.innerApiCalls.explain = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.explain(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IExplainResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
