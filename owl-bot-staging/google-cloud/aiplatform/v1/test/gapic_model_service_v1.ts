...
describe('v1.ModelServiceClient', () => {
    ...
    describe('getModel', () => {
        ...
        it('invokes getModel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getModel(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IModel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes importModelEvaluation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.importModelEvaluation(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IModelEvaluation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchImportModelEvaluationSlices without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchImportModelEvaluationSlices(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IBatchImportModelEvaluationSlicesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getModelEvaluationSlice without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getModelEvaluationSlice(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IModelEvaluationSlice|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('uploadModel', () => {
        it('invokes uploadModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.UploadModelRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes uploadModel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.uploadModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IUploadModelResponse, protos.google.cloud.aiplatform.v1.IUploadModelOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IUploadModelResponse, protos.google.cloud.aiplatform.v1.IUploadModelOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.uploadModel as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteModel', () => {
        it('invokes deleteModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeleteModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('deleteModelVersion', () => {
        it('invokes deleteModelVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeleteModelVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('exportModel', () => {
        it('invokes exportModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ExportModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes exportModel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.exportModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IExportModelResponse, protos.google.cloud.aiplatform.v1.IExportModelOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IExportModelResponse, protos.google.cloud.aiplatform.v1.IExportModelOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportModel as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listModels', () => {
        it('invokes listModels without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListModelsRequest', ['parent']);
            request.parent = defaultValue1;
        ...
        it('invokes listModelsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.Model) => {
    ...
    describe('listModelVersions', () => {
        it('invokes listModelVersions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListModelVersionsRequest', ['name']);
            request.name = defaultValue1;
    ...
    describe('listModelEvaluations', () => {
        it('invokes listModelEvaluations without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListModelEvaluationsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
        ...
        it('invokes listModelEvaluationsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.ModelEvaluation) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listModelEvaluationSlices', () => {
        it('invokes listModelEvaluationSlices without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListModelEvaluationSlicesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
        ...
        it('invokes listModelEvaluationSlicesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.ModelEvaluationSlice) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
