...
describe('v1.MetadataServiceClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = metadataserviceModule.v1.MetadataServiceClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = metadataserviceModule.v1.MetadataServiceClient.apiEndpoint;
            assert(apiEndpoint);
        });
    ...
    describe('getMetadataStore', () => {
        it('invokes getMetadataStore without error', async () => {
            ...
            const actualRequest = (client.innerApiCalls.getMetadataStore as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getMetadataStore as SinonStub)
        ...
        it('invokes getMetadataStore without error using callback', async () => {
            ...
            client.innerApiCalls.getMetadataStore = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getMetadataStore(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IMetadataStore|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createArtifact without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createArtifact(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IArtifact|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateArtifact', () => {
        it('invokes updateArtifact without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateArtifact as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateArtifact as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateArtifact without error using callback', async () => {
            ...
            client.innerApiCalls.updateArtifact = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
    ...
    describe('createContext', () => {
        it('invokes createContext without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createContext as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createContext as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createContext without error using callback', async () => {
            ...
            client.innerApiCalls.createContext = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createContext(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IContext|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateContext', () => {
        it('invokes updateContext without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateContext as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateContext as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateContext without error using callback', async () => {
            ...
            client.innerApiCalls.updateContext = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
    ...
    describe('addContextArtifactsAndExecutions', () => {
        it('invokes addContextArtifactsAndExecutions without error', async () => {
            ...
            client.innerApiCalls.addContextArtifactsAndExecutions = stubSimpleCall(expectedResponse);
            const [response] = await client.addContextArtifactsAndExecutions(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.addContextArtifactsAndExecutions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.addContextArtifactsAndExecutions as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes addContextArtifactsAndExecutions without error using callback', async () => {
            ...
            client.innerApiCalls.addContextArtifactsAndExecutions = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.addContextArtifactsAndExecutions(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IAddContextArtifactsAndExecutionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('addContextChildren', () => {
        it('invokes addContextChildren without error', async () => {
            ...
            client.innerApiCalls.addContextChildren = stubSimpleCall(expectedResponse);
            const [response] = await client.addContextChildren(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.addContextChildren as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.addContextChildren as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes addContextChildren without error using callback', async () => {
            ...
            client.innerApiCalls.addContextChildren = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.addContextChildren(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IAddContextChildrenResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('removeContextChildren', () => {
        it('invokes removeContextChildren without error', async () => {
            ...
            client.innerApiCalls.removeContextChildren = stubSimpleCall(expectedResponse);
            const [response] = await client.removeContextChildren(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.removeContextChildren as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.removeContextChildren as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes removeContextChildren without error using callback', async () => {
            ...
            client.innerApiCalls.removeContextChildren = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.removeContextChildren(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IRemoveContextChildrenResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('queryContextLineageSubgraph', () => {
        it('invokes queryContextLineageSubgraph without error', async () => {
            ...
            client.innerApiCalls.queryContextLineageSubgraph = stubSimpleCall(expectedResponse);
            const [response] = await client.queryContextLineageSubgraph(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.queryContextLineageSubgraph as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.queryContextLineageSubgraph as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes queryContextLineageSubgraph without error using callback', async () => {
            ...
            client.innerApiCalls.queryContextLineageSubgraph = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.queryContextLineageSubgraph(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.ILineageSubgraph|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createExecution', () => {
        it('invokes createExecution without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createExecution as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createExecution as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createExecution without error using callback', async () => {
            ...
            client.innerApiCalls.createExecution = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createExecution(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IExecution|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateExecution', () => {
        it('invokes updateExecution without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateExecution as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateExecution as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateExecution without error using callback', async () => {
            ...
            client.innerApiCalls.updateExecution = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
    ...
    describe('addExecutionEvents', () => {
        it('invokes addExecutionEvents without error', async () => {
            ...
            client.innerApiCalls.addExecutionEvents = stubSimpleCall(expectedResponse);
            const [response] = await client.addExecutionEvents(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.addExecutionEvents as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.addExecutionEvents as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes addExecutionEvents without error using callback', async () => {
            ...
            client.innerApiCalls.addExecutionEvents = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.addExecutionEvents(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IAddExecutionEventsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('queryExecutionInputsAndOutputs', () => {
        it('invokes queryExecutionInputsAndOutputs without error', async () => {
            ...
            client.innerApiCalls.queryExecutionInputsAndOutputs = stubSimpleCall(expectedResponse);
            const [response] = await client.queryExecutionInputsAndOutputs(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.queryExecutionInputsAndOutputs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.queryExecutionInputsAndOutputs as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes queryExecutionInputsAndOutputs without error using callback', async () => {
            ...
            client.innerApiCalls.queryExecutionInputsAndOutputs = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
    ...
    describe('createMetadataSchema', () => {
        it('invokes createMetadataSchema without error', async () => {
            ...
            client.innerApiCalls.createMetadataSchema = stubSimpleCall(expectedResponse);
            const [response] = await client.createMetadataSchema(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createMetadataSchema as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createMetadataSchema as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createMetadataSchema without error using callback', async () => {
            ...
            client.innerApiCalls.createMetadataSchema = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createMetadataSchema(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IMetadataSchema|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getMetadataSchema', () => {
        it('invokes getMetadataSchema without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getMetadataSchema as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getMetadataSchema as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getMetadataSchema without error using callback', async () => {
            ...
            client.innerApiCalls.getMetadataSchema = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
    ...
    describe('queryArtifactLineageSubgraph', () => {
        it('invokes queryArtifactLineageSubgraph without error', async () => {
            ...
            client.innerApiCalls.queryArtifactLineageSubgraph = stubSimpleCall(expectedResponse);
            const [response] = await client.queryArtifactLineageSubgraph(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.queryArtifactLineageSubgraph as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.queryArtifactLineageSubgraph as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes queryArtifactLineageSubgraph without error using callback', async () => {
            ...
            client.innerApiCalls.queryArtifactLineageSubgraph = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
    ...
    describe('createMetadataStore', () => {
        it('invokes createMetadataStore without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.CreateMetadataStoreRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createMetadataStore = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createMetadataStore(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createMetadataStore as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createMetadataStore as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createMetadataStore without error using callback', async () => {
            ...
            client.innerApiCalls.createMetadataStore = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createMetadataStore(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IMetadataStore, protos.google.cloud.aiplatform.v1.ICreateMetadataStoreOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IMetadataStore, protos.google.cloud.aiplatform.v1.ICreateMetadataStoreOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createMetadataStore as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkCreateMetadataStoreProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateMetadataStoreProgress(expectedResponse.name);
        ...
        it('invokes checkCreateMetadataStoreProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreateMetadataStoreProgress(''), expectedError);
    ...
    describe('deleteMetadataStore', () => {
        it('invokes deleteMetadataStore without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeleteMetadataStoreRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteMetadataStore = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteMetadataStore(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteMetadataStore as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteMetadataStore as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteMetadataStore without error using callback', async () => {
            ...
            client.innerApiCalls.deleteMetadataStore = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteMetadataStore(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.aiplatform.v1.IDeleteMetadataStoreOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.aiplatform.v1.IDeleteMetadataStoreOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteMetadataStore as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteMetadataStoreProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteMetadataStoreProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteMetadataStoreProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteMetadataStoreProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteArtifact', () => {
        it('invokes deleteArtifact without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeleteArtifactRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteArtifact = stubLongRunningCall(expectedResponse);
        ...
        it('invokes deleteArtifact without error using callback', async () => {
            ...
            client.innerApiCalls.deleteArtifact = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes checkDeleteArtifactProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteArtifactProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteArtifactProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteArtifactProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('purgeArtifacts', () => {
        it('invokes purgeArtifacts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.PurgeArtifactsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.purgeArtifacts = stubLongRunningCall(expectedResponse);
            const [operation] = await client.purgeArtifacts(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.purgeArtifacts as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.purgeArtifacts as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes purgeArtifacts without error using callback', async () => {
            ...
            client.innerApiCalls.purgeArtifacts = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.purgeArtifacts(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IPurgeArtifactsResponse, protos.google.cloud.aiplatform.v1.IPurgeArtifactsMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IPurgeArtifactsResponse, protos.google.cloud.aiplatform.v1.IPurgeArtifactsMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.purgeArtifacts as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkPurgeArtifactsProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkPurgeArtifactsProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkPurgeArtifactsProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkPurgeArtifactsProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteContext', () => {
        it('invokes deleteContext without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeleteContextRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteContext = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteContext(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteContext as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteContext as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteContext without error using callback', async () => {
            ...
            client.innerApiCalls.deleteContext = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes checkDeleteContextProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteContextProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteContextProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteContextProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('purgeContexts', () => {
        it('invokes purgeContexts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.PurgeContextsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.purgeContexts = stubLongRunningCall(expectedResponse);
            const [operation] = await client.purgeContexts(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.purgeContexts as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.purgeContexts as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes purgeContexts without error using callback', async () => {
            ...
            client.innerApiCalls.purgeContexts = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.purgeContexts(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IPurgeContextsResponse, protos.google.cloud.aiplatform.v1.IPurgeContextsMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IPurgeContextsResponse, protos.google.cloud.aiplatform.v1.IPurgeContextsMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.purgeContexts as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkPurgeContextsProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkPurgeContextsProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkPurgeContextsProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkPurgeContextsProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteExecution', () => {
        it('invokes deleteExecution without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeleteExecutionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('purgeExecutions', () => {
        it('invokes purgeExecutions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.PurgeExecutionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.purgeExecutions = stubLongRunningCall(expectedResponse);
            const [operation] = await client.purgeExecutions(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.purgeExecutions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.purgeExecutions as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes purgeExecutions without error using callback', async () => {
            ...
            client.innerApiCalls.purgeExecutions = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.purgeExecutions(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IPurgeExecutionsResponse, protos.google.cloud.aiplatform.v1.IPurgeExecutionsMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IPurgeExecutionsResponse, protos.google.cloud.aiplatform.v1.IPurgeExecutionsMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.purgeExecutions as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkPurgeExecutionsProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkPurgeExecutionsProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkPurgeExecutionsProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkPurgeExecutionsProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listMetadataStores', () => {
        it('invokes listMetadataStores without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListMetadataStoresRequest', ['parent']);
            request.parent = defaultValue1;
            ...
            client.innerApiCalls.listMetadataStores = stubSimpleCall(expectedResponse);
            const [response] = await client.listMetadataStores(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listMetadataStores as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listMetadataStores as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listMetadataStores without error using callback', async () => {
            ...
            client.innerApiCalls.listMetadataStores = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listMetadataStoresStream without error', async () => {
            ...
            assert((client.descriptors.page.listMetadataStores.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listMetadataStores, request));
            assert(
        ...
        it('uses async iteration with listMetadataStores without error', async () => {
            ...
            client.descriptors.page.listMetadataStores.asyncIterate = stubAsyncIterationCall(expectedResponse);
    ...
    describe('listArtifacts', () => {
        it('invokes listArtifacts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListArtifactsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
        ...
        it('invokes listArtifactsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.Artifact) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listContexts', () => {
        it('invokes listContexts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListContextsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
        ...
        it('invokes listContextsStream without error', async () => {
            ...
            client.descriptors.page.listContexts.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listContextsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.Context[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.Context) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listContexts.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listContexts, request));
            assert(
        ...
        it('uses async iteration with listContexts without error', async () => {
            ...
            client.descriptors.page.listContexts.asyncIterate = stubAsyncIterationCall(expectedResponse);
    ...
    describe('listExecutions', () => {
        it('invokes listExecutions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListExecutionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.Execution()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.Execution()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.Execution()),
            ];
        ...
        it('invokes listExecutionsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.Execution) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listMetadataSchemas', () => {
        it('invokes listMetadataSchemas without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListMetadataSchemasRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.MetadataSchema()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.MetadataSchema()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.MetadataSchema()),
            ];
            client.innerApiCalls.listMetadataSchemas = stubSimpleCall(expectedResponse);
            const [response] = await client.listMetadataSchemas(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listMetadataSchemas as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listMetadataSchemas as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listMetadataSchemas without error using callback', async () => {
            ...
            client.innerApiCalls.listMetadataSchemas = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listMetadataSchemasStream without error', async () => {
            ...
            client.descriptors.page.listMetadataSchemas.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listMetadataSchemasStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.MetadataSchema[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.MetadataSchema) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listMetadataSchemas.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listMetadataSchemas, request));
            assert(
        ...
        it('uses async iteration with listMetadataSchemas without error', async () => {
            ...
            client.descriptors.page.listMetadataSchemas.asyncIterate = stubAsyncIterationCall(expectedResponse);
