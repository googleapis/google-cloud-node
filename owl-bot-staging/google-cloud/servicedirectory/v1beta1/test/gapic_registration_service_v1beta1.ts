...
describe('v1beta1.RegistrationServiceClient', () => {
    ...
    describe('createNamespace', () => {
        it('invokes createNamespace without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.servicedirectory.v1beta1.CreateNamespaceRequest', ['parent']);
    ...
    describe('getNamespace', () => {
        it('invokes getNamespace without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.servicedirectory.v1beta1.GetNamespaceRequest', ['name']);
    ...
    describe('updateNamespace', () => {
        it('invokes updateNamespace without error', async () => {
            ...
            request.namespace ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.servicedirectory.v1beta1.UpdateNamespaceRequest', ['namespace', 'name']);
    ...
    describe('deleteNamespace', () => {
        it('invokes deleteNamespace without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.servicedirectory.v1beta1.DeleteNamespaceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createService', () => {
        it('invokes createService without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.servicedirectory.v1beta1.CreateServiceRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getService', () => {
        it('invokes getService without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.servicedirectory.v1beta1.GetServiceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.servicedirectory.v1beta1.Service()
    ...
    describe('updateService', () => {
        it('invokes updateService without error', async () => {
            ...
            request.service ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.servicedirectory.v1beta1.UpdateServiceRequest', ['service', 'name']);
    ...
    describe('deleteService', () => {
        it('invokes deleteService without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.servicedirectory.v1beta1.DeleteServiceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('createEndpoint', () => {
        it('invokes createEndpoint without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.servicedirectory.v1beta1.CreateEndpointRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getEndpoint', () => {
        it('invokes getEndpoint without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.servicedirectory.v1beta1.GetEndpointRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.servicedirectory.v1beta1.Endpoint()
    ...
    describe('updateEndpoint', () => {
        it('invokes updateEndpoint without error', async () => {
            ...
            request.endpoint ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.servicedirectory.v1beta1.UpdateEndpointRequest', ['endpoint', 'name']);
    ...
    describe('deleteEndpoint', () => {
        it('invokes deleteEndpoint without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.servicedirectory.v1beta1.DeleteEndpointRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('listNamespaces', () => {
        it('invokes listNamespaces without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.servicedirectory.v1beta1.ListNamespacesRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listServices', () => {
        it('invokes listServices without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.servicedirectory.v1beta1.ListServicesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('listEndpoints', () => {
        it('invokes listEndpoints without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.servicedirectory.v1beta1.ListEndpointsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
