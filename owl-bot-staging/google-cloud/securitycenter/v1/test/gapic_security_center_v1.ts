...
describe('v1.SecurityCenterClient', () => {
    ...
    describe('Path templates', () => {
        ...
        describe('folderExport', () => {
            ...
            client.initialize();
            client.pathTemplates.folderExportPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.folderExportPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('folderExportPath', () => {
                const result = client.folderExportPath("folderValue", "exportValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.folderExportPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchFolderFromFolderExportName', () => {
                ...
                assert.strictEqual(result, "folderValue");
                assert((client.pathTemplates.folderExportPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('folderNotificationConfig', () => {
            ...
            client.initialize();
            client.pathTemplates.folderNotificationConfigPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.folderNotificationConfigPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('folderNotificationConfigPath', () => {
                const result = client.folderNotificationConfigPath("folderValue", "notificationConfigValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.folderNotificationConfigPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchFolderFromFolderNotificationConfigName', () => {
                const result = client.matchFolderFromFolderNotificationConfigName(fakePath);
                assert.strictEqual(result, "folderValue");
                assert((client.pathTemplates.folderNotificationConfigPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchNotificationConfigFromFolderNotificationConfigName', () => {
                const result = client.matchNotificationConfigFromFolderNotificationConfigName(fakePath);
        ...
        describe('organizationExport', () => {
            ...
            client.initialize();
            client.pathTemplates.organizationExportPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.organizationExportPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('organizationExportPath', () => {
                const result = client.organizationExportPath("organizationValue", "exportValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationExportPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationExportName', () => {
                const result = client.matchOrganizationFromOrganizationExportName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationExportPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('organizationNotificationConfig', () => {
            ...
            it('organizationNotificationConfigPath', () => {
                const result = client.organizationNotificationConfigPath("organizationValue", "notificationConfigValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationNotificationConfigPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationNotificationConfigName', () => {
                const result = client.matchOrganizationFromOrganizationNotificationConfigName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationNotificationConfigPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchNotificationConfigFromOrganizationNotificationConfigName', () => {
                const result = client.matchNotificationConfigFromOrganizationNotificationConfigName(fakePath);
                assert.strictEqual(result, "notificationConfigValue");
                assert((client.pathTemplates.organizationNotificationConfigPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('projectNotificationConfig', () => {
            ...
            client.initialize();
            client.pathTemplates.projectNotificationConfigPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.projectNotificationConfigPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('projectNotificationConfigPath', () => {
                const result = client.projectNotificationConfigPath("projectValue", "notificationConfigValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectNotificationConfigPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectNotificationConfigName', () => {
                const result = client.matchProjectFromProjectNotificationConfigName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectNotificationConfigPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchNotificationConfigFromProjectNotificationConfigName', () => {
                const result = client.matchNotificationConfigFromProjectNotificationConfigName(fakePath);
                assert.strictEqual(result, "notificationConfigValue");
                assert((client.pathTemplates.projectNotificationConfigPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
