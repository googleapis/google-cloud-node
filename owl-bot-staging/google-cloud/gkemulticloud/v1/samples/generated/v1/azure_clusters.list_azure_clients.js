...
function main(parent) {
  // [START gkemulticloud_v1_generated_AzureClusters_ListAzureClients_async]
  /**
  ...
  async function callListAzureClients() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = await gkemulticloudClient.listAzureClientsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListAzureClients();
