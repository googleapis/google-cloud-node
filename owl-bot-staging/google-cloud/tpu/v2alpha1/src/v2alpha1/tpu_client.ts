...
export class TpuClient {
  ...
  initialize() {
    ...
    const tpuStubMethods =
        ['listNodes', 'getNode', 'createNode', 'deleteNode', 'stopNode', 'startNode', 'updateNode', 'listQueuedResources', 'getQueuedResource', 'createQueuedResource', 'deleteQueuedResource', 'generateServiceIdentity', 'listAcceleratorTypes', 'getAcceleratorType', 'listRuntimeVersions', 'getRuntimeVersion', 'getGuestAttributes', 'simulateMaintenanceEvent'];
