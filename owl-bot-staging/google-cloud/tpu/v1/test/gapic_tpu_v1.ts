...
describe('v1.TpuClient', () => {
    ...
    describe('getNode', () => {
        it('invokes getNode without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.tpu.v1.GetNodeRequest', ['name']);
        ...
        it('invokes getNode without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getNode(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.tpu.v1.INode|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getTensorFlowVersion', () => {
        it('invokes getTensorFlowVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.tpu.v1.GetTensorFlowVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.tpu.v1.TensorFlowVersion()
            );
            client.innerApiCalls.getTensorFlowVersion = stubSimpleCall(expectedResponse);
            const [response] = await client.getTensorFlowVersion(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getTensorFlowVersion as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getTensorFlowVersion as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getTensorFlowVersion without error using callback', async () => {
            ...
            client.innerApiCalls.getTensorFlowVersion = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getTensorFlowVersion(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.tpu.v1.ITensorFlowVersion|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getTensorFlowVersion with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getTensorFlowVersion = stubSimpleCall(undefined, expectedError);
    ...
    describe('getAcceleratorType', () => {
        it('invokes getAcceleratorType without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.tpu.v1.GetAcceleratorTypeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.tpu.v1.AcceleratorType()
            );
            client.innerApiCalls.getAcceleratorType = stubSimpleCall(expectedResponse);
            const [response] = await client.getAcceleratorType(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getAcceleratorType as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getAcceleratorType as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getAcceleratorType without error using callback', async () => {
            ...
            client.innerApiCalls.getAcceleratorType = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAcceleratorType(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.tpu.v1.IAcceleratorType|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAcceleratorType with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getAcceleratorType = stubSimpleCall(undefined, expectedError);
    ...
    describe('createNode', () => {
        it('invokes createNode without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.tpu.v1.CreateNodeRequest', ['parent']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createNode as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createNode as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createNode without error using callback', async () => {
            ...
            client.innerApiCalls.createNode = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createNode(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.tpu.v1.INode, protos.google.cloud.tpu.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.tpu.v1.INode, protos.google.cloud.tpu.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createNode as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createNode with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createNode = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes createNode with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createNode = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createNode(request);
        ...
        it('invokes checkCreateNodeProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateNodeProgress(expectedResponse.name);
    ...
    describe('deleteNode', () => {
        it('invokes deleteNode without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.tpu.v1.DeleteNodeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteNode as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteNode as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteNode without error using callback', async () => {
            ...
            client.innerApiCalls.deleteNode = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteNode(
                    request,
                    (err?: Error|null,
        ...
        it('invokes deleteNode with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteNode = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes deleteNode with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteNode = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteNode(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteNode as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteNodeProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteNodeProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('reimageNode', () => {
        it('invokes reimageNode without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.tpu.v1.ReimageNodeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.reimageNode as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.reimageNode as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes reimageNode without error using callback', async () => {
            ...
            client.innerApiCalls.reimageNode = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.reimageNode(
                    request,
                    (err?: Error|null,
        ...
        it('invokes reimageNode with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.reimageNode = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes reimageNode with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.reimageNode = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.reimageNode(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.reimageNode as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkReimageNodeProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkReimageNodeProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('stopNode', () => {
        it('invokes stopNode without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.tpu.v1.StopNodeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.stopNode as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.stopNode as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes stopNode without error using callback', async () => {
            ...
            client.innerApiCalls.stopNode = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.stopNode(
                    request,
                    (err?: Error|null,
        ...
        it('invokes stopNode with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.stopNode = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes stopNode with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.stopNode = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.stopNode(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.stopNode as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkStopNodeProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkStopNodeProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('startNode', () => {
        it('invokes startNode without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.tpu.v1.StartNodeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.startNode as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.startNode as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes startNode without error using callback', async () => {
            ...
            client.innerApiCalls.startNode = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.startNode(
                    request,
                    (err?: Error|null,
        ...
        it('invokes startNode with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.startNode = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes startNode with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.startNode = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.startNode(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.startNode as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkStartNodeProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkStartNodeProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('listNodes', () => {
        it('invokes listNodes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.tpu.v1.ListNodesRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listTensorFlowVersions', () => {
        it('invokes listTensorFlowVersions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.tpu.v1.ListTensorFlowVersionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
            ...
            client.innerApiCalls.listTensorFlowVersions = stubSimpleCall(expectedResponse);
            const [response] = await client.listTensorFlowVersions(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listTensorFlowVersions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listTensorFlowVersions as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listTensorFlowVersions without error using callback', async () => {
            ...
            client.innerApiCalls.listTensorFlowVersions = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listTensorFlowVersions with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listTensorFlowVersions = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listTensorFlowVersions(request), expectedError);
            const actualRequest = (client.innerApiCalls.listTensorFlowVersions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listTensorFlowVersions as SinonStub)
        ...
        it('invokes listTensorFlowVersionsStream without error', async () => {
            ...
            client.descriptors.page.listTensorFlowVersions.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listTensorFlowVersionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.tpu.v1.TensorFlowVersion[] = [];
                stream.on('data', (response: protos.google.cloud.tpu.v1.TensorFlowVersion) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listTensorFlowVersions.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listTensorFlowVersions, request));
            assert(
                (client.descriptors.page.listTensorFlowVersions.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listTensorFlowVersionsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listTensorFlowVersions.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listTensorFlowVersionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.tpu.v1.TensorFlowVersion[] = [];
                stream.on('data', (response: protos.google.cloud.tpu.v1.TensorFlowVersion) => {
        ...
        it('uses async iteration with listTensorFlowVersions without error', async () => {
            ...
            client.descriptors.page.listTensorFlowVersions.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listTensorFlowVersions.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listTensorFlowVersions.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listTensorFlowVersions with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listTensorFlowVersions.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listTensorFlowVersionsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.tpu.v1.ITensorFlowVersion[] = [];
                for await (const resource of iterable) {
    ...
    describe('listAcceleratorTypes', () => {
        it('invokes listAcceleratorTypes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.tpu.v1.ListAcceleratorTypesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
            ...
            client.innerApiCalls.listAcceleratorTypes = stubSimpleCall(expectedResponse);
            const [response] = await client.listAcceleratorTypes(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listAcceleratorTypes as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAcceleratorTypes as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listAcceleratorTypes without error using callback', async () => {
            ...
            client.innerApiCalls.listAcceleratorTypes = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listAcceleratorTypes with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listAcceleratorTypes = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listAcceleratorTypesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.tpu.v1.AcceleratorType) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listAcceleratorTypes.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listAcceleratorTypes, request));
            assert(
        ...
        it('invokes listAcceleratorTypesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAcceleratorTypes.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listAcceleratorTypesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.tpu.v1.AcceleratorType[] = [];
                stream.on('data', (response: protos.google.cloud.tpu.v1.AcceleratorType) => {
        ...
        it('uses async iteration with listAcceleratorTypes without error', async () => {
            ...
            client.descriptors.page.listAcceleratorTypes.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listAcceleratorTypes with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAcceleratorTypes.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listAcceleratorTypesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.tpu.v1.IAcceleratorType[] = [];
                for await (const resource of iterable) {
    ...
    describe('Path templates', () => {
        ...
        describe('acceleratorType', () => {
            ...
            client.initialize();
            client.pathTemplates.acceleratorTypePathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.acceleratorTypePathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('acceleratorTypePath', () => {
                const result = client.acceleratorTypePath("projectValue", "locationValue", "acceleratorTypeValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.acceleratorTypePathTemplate.render as SinonStub)
            ...
            it('matchProjectFromAcceleratorTypeName', () => {
                ...
                assert((client.pathTemplates.acceleratorTypePathTemplate.match as SinonStub)
            ...
            it('matchAcceleratorTypeFromAcceleratorTypeName', () => {
                const result = client.matchAcceleratorTypeFromAcceleratorTypeName(fakePath);
        ...
        describe('node', () => {
            ...
            it('nodePath', () => {
                const result = client.nodePath("projectValue", "locationValue", "nodeValue");
                assert.strictEqual(result, fakePath);
        ...
        describe('tensorFlowVersion', () => {
            ...
            client.initialize();
            client.pathTemplates.tensorFlowVersionPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.tensorFlowVersionPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('tensorFlowVersionPath', () => {
                const result = client.tensorFlowVersionPath("projectValue", "locationValue", "tensorFlowVersionValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.tensorFlowVersionPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromTensorFlowVersionName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.tensorFlowVersionPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchTensorFlowVersionFromTensorFlowVersionName', () => {
                const result = client.matchTensorFlowVersionFromTensorFlowVersionName(fakePath);
