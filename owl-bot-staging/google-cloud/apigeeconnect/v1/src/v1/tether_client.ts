 ...
 * `src/v1/tether_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './tether_client_config.json';
...
export class TetherClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof TetherClient;
    ...
    this.descriptors.stream = {
      egress: new this._gaxModule.StreamDescriptor(this._gaxModule.StreamType.BIDI_STREAMING, opts.fallback === 'rest')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.apigeeconnect.v1.Tether', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.tetherStub) {
      return this.tetherStub;
    }

    // Put together the "service stub" for
    // google.cloud.apigeeconnect.v1.Tether.
    this.tetherStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.apigeeconnect.v1.Tether') :
 ...
 *   representing [EgressResponse]{@link google.cloud.apigeeconnect.v1.EgressResponse} for write() method, and
 *   will emit objects representing [EgressRequest]{@link google.cloud.apigeeconnect.v1.EgressRequest} on 'data' event asynchronously.
 *   Please see the
