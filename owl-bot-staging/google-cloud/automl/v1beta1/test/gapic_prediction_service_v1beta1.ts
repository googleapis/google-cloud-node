...
describe('v1beta1.PredictionServiceClient', () => {
    ...
    describe('predict', () => {
        it('invokes predict without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.automl.v1beta1.PredictRequest', ['name']);
        ...
        it('invokes predict without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.predict(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.automl.v1beta1.IPredictResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('batchPredict', () => {
        it('invokes batchPredict without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.automl.v1beta1.BatchPredictRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes batchPredict without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchPredict(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.automl.v1beta1.IBatchPredictResult, protos.google.cloud.automl.v1beta1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.automl.v1beta1.IBatchPredictResult, protos.google.cloud.automl.v1beta1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchPredict as SinonStub)
                .getCall(0).args[0];
