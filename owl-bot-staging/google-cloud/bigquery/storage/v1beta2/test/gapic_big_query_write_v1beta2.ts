...
describe('v1beta2.BigQueryWriteClient', () => {
    ...
    describe('createWriteStream', () => {
        it('invokes createWriteStream without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.storage.v1beta2.CreateWriteStreamRequest', ['parent']);
    ...
    describe('getWriteStream', () => {
        it('invokes getWriteStream without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.storage.v1beta2.GetWriteStreamRequest', ['name']);
    ...
    describe('finalizeWriteStream', () => {
        it('invokes finalizeWriteStream without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.storage.v1beta2.FinalizeWriteStreamRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('batchCommitWriteStreams', () => {
        it('invokes batchCommitWriteStreams without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.storage.v1beta2.BatchCommitWriteStreamsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('flushRows', () => {
        it('invokes flushRows without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.storage.v1beta2.FlushRowsRequest', ['writeStream']);
