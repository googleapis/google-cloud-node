...
function main(name, credential) {
  // [START bigqueryconnection_v1beta1_generated_ConnectionService_UpdateConnectionCredential_async]
  /**
  ...
  async function callUpdateConnectionCredential() {
    ...
    // Run request
    const response = await connectionClient.updateConnectionCredential(request);
