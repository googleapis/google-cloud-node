...
describe('v1beta1.CloudSchedulerClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = cloudschedulerModule.v1beta1.CloudSchedulerClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = cloudschedulerModule.v1beta1.CloudSchedulerClient.apiEndpoint;
            assert(apiEndpoint);
        });
    ...
    describe('getJob', () => {
        it('invokes getJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.scheduler.v1beta1.GetJobRequest', ['name']);
        ...
        it('invokes getJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.scheduler.v1beta1.IJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createJob', () => {
        it('invokes createJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.scheduler.v1beta1.CreateJobRequest', ['parent']);
    ...
    describe('updateJob', () => {
        it('invokes updateJob without error', async () => {
            ...
            request.job ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.scheduler.v1beta1.UpdateJobRequest', ['job', 'name']);
    ...
    describe('deleteJob', () => {
        it('invokes deleteJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.scheduler.v1beta1.DeleteJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('pauseJob', () => {
        it('invokes pauseJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.scheduler.v1beta1.PauseJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.scheduler.v1beta1.Job()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.pauseJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.pauseJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes pauseJob without error using callback', async () => {
            ...
            client.innerApiCalls.pauseJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.pauseJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.scheduler.v1beta1.IJob|null) => {
    ...
    describe('resumeJob', () => {
        it('invokes resumeJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.scheduler.v1beta1.ResumeJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.scheduler.v1beta1.Job()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.resumeJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.resumeJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes resumeJob without error using callback', async () => {
            ...
            client.innerApiCalls.resumeJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.resumeJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.scheduler.v1beta1.IJob|null) => {
    ...
    describe('runJob', () => {
        it('invokes runJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.scheduler.v1beta1.RunJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.scheduler.v1beta1.Job()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.runJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.runJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes runJob without error using callback', async () => {
            ...
            client.innerApiCalls.runJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.runJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.scheduler.v1beta1.IJob|null) => {
    ...
    describe('listJobs', () => {
        it('invokes listJobs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.scheduler.v1beta1.ListJobsRequest', ['parent']);
            request.parent = defaultValue1;
        ...
        it('invokes listJobsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.scheduler.v1beta1.Job) => {
