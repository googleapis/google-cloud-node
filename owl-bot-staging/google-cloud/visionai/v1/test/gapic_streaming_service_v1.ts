...
describe('v1.StreamingServiceClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = streamingserviceModule.v1.StreamingServiceClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = streamingserviceModule.v1.StreamingServiceClient.apiEndpoint;
            assert(apiEndpoint);
        });
    ...
    describe('acquireLease', () => {
        it('invokes acquireLease without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.AcquireLeaseRequest', ['series']);
        ...
        it('invokes acquireLease without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.acquireLease(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.visionai.v1.ILease|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('renewLease', () => {
        it('invokes renewLease without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.RenewLeaseRequest', ['series']);
            request.series = defaultValue1;
            const expectedHeaderRequestParams = `series=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.visionai.v1.Lease()
    ...
    describe('releaseLease', () => {
        it('invokes releaseLease without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.ReleaseLeaseRequest', ['series']);
            request.series = defaultValue1;
            const expectedHeaderRequestParams = `series=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes releaseLease without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.releaseLease(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.visionai.v1.IReleaseLeaseResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('receivePackets', () => {
        it('invokes receivePackets without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.visionai.v1.ReceivePacketsResponse) => {
                    resolve(response);
                });
                stream.on('error', (err: Error) => {
                    reject(err);
    ...
    describe('receiveEvents', () => {
        it('invokes receiveEvents without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.visionai.v1.ReceiveEventsResponse) => {
                    resolve(response);
                });
                stream.on('error', (err: Error) => {
                    reject(err);
