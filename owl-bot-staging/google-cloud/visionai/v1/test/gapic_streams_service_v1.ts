...
describe('v1.StreamsServiceClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = streamsserviceModule.v1.StreamsServiceClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = streamsserviceModule.v1.StreamsServiceClient.apiEndpoint;
            assert(apiEndpoint);
        });

        it('has port', () => {
            const port = streamsserviceModule.v1.StreamsServiceClient.port;
            assert(port);
    ...
    describe('getCluster', () => {
        it('invokes getCluster without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.GetClusterRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.GetClusterRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.visionai.v1.Cluster()
            );
        ...
        it('invokes getCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCluster(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.visionai.v1.ICluster|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getStream', () => {
        it('invokes getStream without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.GetStreamRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.GetStreamRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.visionai.v1.Stream()
            );
        ...
        it('invokes getStream without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getStream(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.visionai.v1.IStream|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateStreamHlsToken', () => {
        it('invokes generateStreamHlsToken without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.GenerateStreamHlsTokenRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.GenerateStreamHlsTokenRequest', ['stream']);
            request.stream = defaultValue1;
            const expectedHeaderRequestParams = `stream=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.visionai.v1.GenerateStreamHlsTokenResponse()
            );
        ...
        it('invokes generateStreamHlsToken without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateStreamHlsToken(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.visionai.v1.IGenerateStreamHlsTokenResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getEvent', () => {
        it('invokes getEvent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.GetEventRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.GetEventRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.visionai.v1.Event()
            );
        ...
        it('invokes getEvent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getEvent(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.visionai.v1.IEvent|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getSeries', () => {
        it('invokes getSeries without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.GetSeriesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.GetSeriesRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.visionai.v1.Series()
            );
        ...
        it('invokes getSeries without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getSeries(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.visionai.v1.ISeries|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createCluster', () => {
        it('invokes createCluster without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.CreateClusterRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.CreateClusterRequest', ['parent']);
        ...
        it('invokes createCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createCluster(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.visionai.v1.ICluster, protos.google.cloud.visionai.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.visionai.v1.ICluster, protos.google.cloud.visionai.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createCluster as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateCluster', () => {
        it('invokes updateCluster without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.UpdateClusterRequest()
            );
            request.cluster ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.UpdateClusterRequest', ['cluster', 'name']);
    ...
    describe('deleteCluster', () => {
        it('invokes deleteCluster without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.DeleteClusterRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.DeleteClusterRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createStream', () => {
        it('invokes createStream without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.CreateStreamRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.CreateStreamRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createStream without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createStream(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.visionai.v1.IStream, protos.google.cloud.visionai.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.visionai.v1.IStream, protos.google.cloud.visionai.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createStream as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateStream', () => {
        it('invokes updateStream without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.UpdateStreamRequest()
            );
            request.stream ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.UpdateStreamRequest', ['stream', 'name']);
    ...
    describe('deleteStream', () => {
        it('invokes deleteStream without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.DeleteStreamRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.DeleteStreamRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('getStreamThumbnail', () => {
        it('invokes getStreamThumbnail without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.GetStreamThumbnailRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.GetStreamThumbnailRequest', ['stream']);
            request.stream = defaultValue1;
            const expectedHeaderRequestParams = `stream=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.getStreamThumbnail = stubLongRunningCall(expectedResponse);
            const [operation] = await client.getStreamThumbnail(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getStreamThumbnail as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getStreamThumbnail as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getStreamThumbnail without error using callback', async () => {
            ...
            client.innerApiCalls.getStreamThumbnail = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getStreamThumbnail(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.visionai.v1.IGetStreamThumbnailResponse, protos.google.cloud.visionai.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.visionai.v1.IGetStreamThumbnailResponse, protos.google.cloud.visionai.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getStreamThumbnail as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes getStreamThumbnail with call error', async () => {
            ...
            const expectedHeaderRequestParams = `stream=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getStreamThumbnail = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.getStreamThumbnail(request), expectedError);
            const actualRequest = (client.innerApiCalls.getStreamThumbnail as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getStreamThumbnail as SinonStub)
        ...
        it('invokes getStreamThumbnail with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `stream=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getStreamThumbnail = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.getStreamThumbnail(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.getStreamThumbnail as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkGetStreamThumbnailProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkGetStreamThumbnailProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkGetStreamThumbnailProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkGetStreamThumbnailProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('createEvent', () => {
        it('invokes createEvent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.CreateEventRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.CreateEventRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createEvent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createEvent(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.visionai.v1.IEvent, protos.google.cloud.visionai.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.visionai.v1.IEvent, protos.google.cloud.visionai.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createEvent as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateEvent', () => {
        it('invokes updateEvent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.UpdateEventRequest()
            );
            request.event ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.UpdateEventRequest', ['event', 'name']);
    ...
    describe('deleteEvent', () => {
        it('invokes deleteEvent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.DeleteEventRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.DeleteEventRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createSeries', () => {
        it('invokes createSeries without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.CreateSeriesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.CreateSeriesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createSeries without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createSeries(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.visionai.v1.ISeries, protos.google.cloud.visionai.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.visionai.v1.ISeries, protos.google.cloud.visionai.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createSeries as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateSeries', () => {
        it('invokes updateSeries without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.UpdateSeriesRequest()
            );
            request.series ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.UpdateSeriesRequest', ['series', 'name']);
    ...
    describe('deleteSeries', () => {
        it('invokes deleteSeries without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.DeleteSeriesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.DeleteSeriesRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('materializeChannel', () => {
        it('invokes materializeChannel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.MaterializeChannelRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.MaterializeChannelRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes materializeChannel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.materializeChannel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.visionai.v1.IChannel, protos.google.cloud.visionai.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.visionai.v1.IChannel, protos.google.cloud.visionai.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.materializeChannel as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listClusters', () => {
        it('invokes listClusters without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.ListClustersRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.ListClustersRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.visionai.v1.Cluster()),
              generateSampleMessage(new protos.google.cloud.visionai.v1.Cluster()),
              generateSampleMessage(new protos.google.cloud.visionai.v1.Cluster()),
            ];
        ...
        it('invokes listClustersStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.visionai.v1.Cluster[] = [];
                stream.on('data', (response: protos.google.cloud.visionai.v1.Cluster) => {
        ...
        it('uses async iteration with listClusters without error', async () => {
            ...
            const responses: protos.google.cloud.visionai.v1.ICluster[] = [];
    ...
    describe('listStreams', () => {
        it('invokes listStreams without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.ListStreamsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.ListStreamsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.visionai.v1.Stream()),
              generateSampleMessage(new protos.google.cloud.visionai.v1.Stream()),
              generateSampleMessage(new protos.google.cloud.visionai.v1.Stream()),
            ];
        ...
        it('invokes listStreamsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.visionai.v1.Stream[] = [];
                stream.on('data', (response: protos.google.cloud.visionai.v1.Stream) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listStreams without error', async () => {
            ...
            const responses: protos.google.cloud.visionai.v1.IStream[] = [];
    ...
    describe('listEvents', () => {
        it('invokes listEvents without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.ListEventsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.ListEventsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.visionai.v1.Event()),
              generateSampleMessage(new protos.google.cloud.visionai.v1.Event()),
              generateSampleMessage(new protos.google.cloud.visionai.v1.Event()),
            ];
        ...
        it('invokes listEventsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.visionai.v1.Event[] = [];
                stream.on('data', (response: protos.google.cloud.visionai.v1.Event) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listEvents without error', async () => {
            ...
            const responses: protos.google.cloud.visionai.v1.IEvent[] = [];
    ...
    describe('listSeries', () => {
        it('invokes listSeries without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.ListSeriesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.ListSeriesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.visionai.v1.Series()),
              generateSampleMessage(new protos.google.cloud.visionai.v1.Series()),
              generateSampleMessage(new protos.google.cloud.visionai.v1.Series()),
            ];
        ...
        it('invokes listSeriesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.visionai.v1.Series[] = [];
                stream.on('data', (response: protos.google.cloud.visionai.v1.Series) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listSeries without error', async () => {
            ...
            const responses: protos.google.cloud.visionai.v1.ISeries[] = [];
