...
function main(parent, corpus) {
  // [START visionai_v1_generated_Warehouse_CreateCorpus_async]
  /**
  ...
  async function callCreateCorpus() {
    ...
    // Run request
    const [operation] = await visionaiClient.createCorpus(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callCreateCorpus();
  // [END visionai_v1_generated_Warehouse_CreateCorpus_async]
}
