...
describe('v1alpha1.LiveVideoAnalyticsClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = livevideoanalyticsModule.v1alpha1.LiveVideoAnalyticsClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = livevideoanalyticsModule.v1alpha1.LiveVideoAnalyticsClient.apiEndpoint;
            assert(apiEndpoint);
        });

        it('has port', () => {
            const port = livevideoanalyticsModule.v1alpha1.LiveVideoAnalyticsClient.port;
            assert(port);
            assert(typeof port === 'number');
        });

        it('should create a client with no option', () => {
            const client = new livevideoanalyticsModule.v1alpha1.LiveVideoAnalyticsClient();
            assert(client);
        });
    ...
    describe('getAnalysis', () => {
        it('invokes getAnalysis without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1alpha1.GetAnalysisRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1alpha1.GetAnalysisRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.visionai.v1alpha1.Analysis()
            );
        ...
        it('invokes getAnalysis without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAnalysis(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.visionai.v1alpha1.IAnalysis|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createAnalysis', () => {
        it('invokes createAnalysis without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1alpha1.CreateAnalysisRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1alpha1.CreateAnalysisRequest', ['parent']);
        ...
        it('invokes createAnalysis without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createAnalysis(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.visionai.v1alpha1.IAnalysis, protos.google.cloud.visionai.v1alpha1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.visionai.v1alpha1.IAnalysis, protos.google.cloud.visionai.v1alpha1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createAnalysis as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateAnalysis', () => {
        it('invokes updateAnalysis without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1alpha1.UpdateAnalysisRequest()
            );
            request.analysis ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1alpha1.UpdateAnalysisRequest', ['analysis', 'name']);
    ...
    describe('deleteAnalysis', () => {
        it('invokes deleteAnalysis without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1alpha1.DeleteAnalysisRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1alpha1.DeleteAnalysisRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listAnalyses', () => {
        it('invokes listAnalyses without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1alpha1.ListAnalysesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1alpha1.ListAnalysesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.visionai.v1alpha1.Analysis()),
              generateSampleMessage(new protos.google.cloud.visionai.v1alpha1.Analysis()),
              generateSampleMessage(new protos.google.cloud.visionai.v1alpha1.Analysis()),
            ];
        ...
        it('invokes listAnalysesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.visionai.v1alpha1.Analysis[] = [];
                stream.on('data', (response: protos.google.cloud.visionai.v1alpha1.Analysis) => {
        ...
        it('uses async iteration with listAnalyses without error', async () => {
            ...
            const responses: protos.google.cloud.visionai.v1alpha1.IAnalysis[] = [];
