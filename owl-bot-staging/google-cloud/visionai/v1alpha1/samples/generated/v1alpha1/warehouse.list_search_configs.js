...
function main(parent) {
  // [START visionai_v1alpha1_generated_Warehouse_ListSearchConfigs_async]
  /**
  ...
  async function callListSearchConfigs() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = await visionaiClient.listSearchConfigsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListSearchConfigs();
  // [END visionai_v1alpha1_generated_Warehouse_ListSearchConfigs_async]
}
