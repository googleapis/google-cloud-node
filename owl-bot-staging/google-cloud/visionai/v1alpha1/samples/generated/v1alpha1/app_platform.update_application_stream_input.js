...
function main(name) {
  // [START visionai_v1alpha1_generated_AppPlatform_UpdateApplicationStreamInput_async]
  /**
   ...
   */
  // const applicationStreamInputs = 1234
  /**
  ...
  async function callUpdateApplicationStreamInput() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const [operation] = await visionaiClient.updateApplicationStreamInput(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callUpdateApplicationStreamInput();
