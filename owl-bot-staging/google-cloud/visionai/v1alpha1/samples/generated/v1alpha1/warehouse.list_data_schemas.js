...
function main(parent) {
  // [START visionai_v1alpha1_generated_Warehouse_ListDataSchemas_async]
  /**
  ...
  async function callListDataSchemas() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = await visionaiClient.listDataSchemasAsync(request);
  ...
  callListDataSchemas();
  // [END visionai_v1alpha1_generated_Warehouse_ListDataSchemas_async]
}
