...
function main(instanceIdToken, agentVersion) {
  // [START osconfig_v1beta_generated_AgentEndpointService_ReceiveTaskNotification_async]
  /**
  ...
  async function callReceiveTaskNotification() {
    ...
    // Run request
    const stream = await agentendpointClient.receiveTaskNotification(request);
  ...
  // [END osconfig_v1beta_generated_AgentEndpointService_ReceiveTaskNotification_async]
}
