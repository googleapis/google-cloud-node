...
describe('v1.FleetRoutingClient', () => {
    ...
    describe('optimizeTours', () => {
        it('invokes optimizeTours without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.optimization.v1.OptimizeToursRequest', ['parent']);
        ...
        it('invokes optimizeTours without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.optimizeTours(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.optimization.v1.IOptimizeToursResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('batchOptimizeTours', () => {
        it('invokes batchOptimizeTours without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.optimization.v1.BatchOptimizeToursRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes batchOptimizeTours without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchOptimizeTours(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.optimization.v1.IBatchOptimizeToursResponse, protos.google.cloud.optimization.v1.IAsyncModelMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.optimization.v1.IBatchOptimizeToursResponse, protos.google.cloud.optimization.v1.IAsyncModelMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchOptimizeTours as SinonStub)
                .getCall(0).args[0];
