...
export class RecommendationServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.discoveryengine.v1beta.RecommendationService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.recommendationServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.discoveryengine.v1beta.RecommendationService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.discoveryengine.v1beta.RecommendationService,
 ...
 */
  recommend(
      ...
      Promise<[
        ...
        protos.google.cloud.discoveryengine.v1beta.IRecommendRequest|undefined, {}|undefined
      ]>;
  recommend(
      request: protos.google.cloud.discoveryengine.v1beta.IRecommendRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.discoveryengine.v1beta.IRecommendResponse,
          protos.google.cloud.discoveryengine.v1beta.IRecommendRequest|null|undefined,
          {}|null|undefined>): void;
  recommend(
      request: protos.google.cloud.discoveryengine.v1beta.IRecommendRequest,
      callback: Callback<
   ...
   */
  documentPath(project:string,location:string,dataStore:string,branch:string,document:string) {
  ...
  matchDataStoreFromDocumentName(documentName: string) {
    return this.pathTemplates.documentPathTemplate.match(documentName).data_store;
  }
   ...
   * @returns {string} Resource name string.
   */
  servingConfigPath(project:string,location:string,dataStore:string,servingConfig:string) {
  ...
  matchDataStoreFromServingConfigName(servingConfigName: string) {
    return this.pathTemplates.servingConfigPathTemplate.match(servingConfigName).data_store;
  }
