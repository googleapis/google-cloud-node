...
function main(parent) {
  // [START connectors_v1_generated_Connectors_ListConnectors_async]
  /**
  ...
  async function callListConnectors() {
    ...
    // Run request
    const iterable = await connectorsClient.listConnectorsAsync(request);
  ...
  callListConnectors();
  // [END connectors_v1_generated_Connectors_ListConnectors_async]
}
