...
function main(name) {
  // [START connectors_v1_generated_Connectors_GetConnection_async]
  /**
  ...
  async function callGetConnection() {
    ...
    // Run request
    const response = await connectorsClient.getConnection(request);
    console.log(response);
  }

  callGetConnection();
  // [END connectors_v1_generated_Connectors_GetConnection_async]
}
