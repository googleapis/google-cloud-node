...
describe('v1.WorkflowTemplateServiceClient', () => {
    ...
    describe('createWorkflowTemplate', () => {
        it('invokes createWorkflowTemplate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.CreateWorkflowTemplateRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataproc.v1.WorkflowTemplate()
            );
            client.innerApiCalls.createWorkflowTemplate = stubSimpleCall(expectedResponse);
            const [response] = await client.createWorkflowTemplate(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createWorkflowTemplate as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createWorkflowTemplate as SinonStub)
        ...
        it('invokes createWorkflowTemplate without error using callback', async () => {
            ...
            client.innerApiCalls.createWorkflowTemplate = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createWorkflowTemplate(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataproc.v1.IWorkflowTemplate|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createWorkflowTemplate with error', async () => {
            ...
            await assert.rejects(client.createWorkflowTemplate(request), expectedError);
            const actualRequest = (client.innerApiCalls.createWorkflowTemplate as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createWorkflowTemplate as SinonStub)
    ...
    describe('getWorkflowTemplate', () => {
        it('invokes getWorkflowTemplate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.GetWorkflowTemplateRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataproc.v1.WorkflowTemplate()
            );
            client.innerApiCalls.getWorkflowTemplate = stubSimpleCall(expectedResponse);
            const [response] = await client.getWorkflowTemplate(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getWorkflowTemplate as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getWorkflowTemplate as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getWorkflowTemplate without error using callback', async () => {
            ...
            client.innerApiCalls.getWorkflowTemplate = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
    ...
    describe('updateWorkflowTemplate', () => {
        it('invokes updateWorkflowTemplate without error', async () => {
            ...
            request.template ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.UpdateWorkflowTemplateRequest', ['template', 'name']);
            request.template.name = defaultValue1;
            const expectedHeaderRequestParams = `template.name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataproc.v1.WorkflowTemplate()
            );
            client.innerApiCalls.updateWorkflowTemplate = stubSimpleCall(expectedResponse);
            const [response] = await client.updateWorkflowTemplate(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateWorkflowTemplate as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateWorkflowTemplate as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateWorkflowTemplate without error using callback', async () => {
            ...
            client.innerApiCalls.updateWorkflowTemplate = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateWorkflowTemplate with error', async () => {
            ...
            await assert.rejects(client.updateWorkflowTemplate(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateWorkflowTemplate as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateWorkflowTemplate as SinonStub)
    ...
    describe('deleteWorkflowTemplate', () => {
        it('invokes deleteWorkflowTemplate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.DeleteWorkflowTemplateRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteWorkflowTemplate = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteWorkflowTemplate(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteWorkflowTemplate as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteWorkflowTemplate as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteWorkflowTemplate without error using callback', async () => {
            ...
            client.innerApiCalls.deleteWorkflowTemplate = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteWorkflowTemplate with error', async () => {
            ...
            await assert.rejects(client.deleteWorkflowTemplate(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteWorkflowTemplate as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteWorkflowTemplate as SinonStub)
    ...
    describe('instantiateWorkflowTemplate', () => {
        it('invokes instantiateWorkflowTemplate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.InstantiateWorkflowTemplateRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.instantiateWorkflowTemplate = stubLongRunningCall(expectedResponse);
            const [operation] = await client.instantiateWorkflowTemplate(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.instantiateWorkflowTemplate as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.instantiateWorkflowTemplate as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes instantiateWorkflowTemplate without error using callback', async () => {
            ...
            client.innerApiCalls.instantiateWorkflowTemplate = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.instantiateWorkflowTemplate(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.dataproc.v1.IWorkflowMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.dataproc.v1.IWorkflowMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.instantiateWorkflowTemplate as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes instantiateWorkflowTemplate with call error', async () => {
            ...
            await assert.rejects(client.instantiateWorkflowTemplate(request), expectedError);
            const actualRequest = (client.innerApiCalls.instantiateWorkflowTemplate as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.instantiateWorkflowTemplate as SinonStub)
        ...
        it('invokes checkInstantiateWorkflowTemplateProgress without error', async () => {
            ...
            const decodedOperation = await client.checkInstantiateWorkflowTemplateProgress(expectedResponse.name);
        ...
        it('invokes checkInstantiateWorkflowTemplateProgress with error', async () => {
            ...
            await assert.rejects(client.checkInstantiateWorkflowTemplateProgress(''), expectedError);
    ...
    describe('instantiateInlineWorkflowTemplate', () => {
        it('invokes instantiateInlineWorkflowTemplate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.InstantiateInlineWorkflowTemplateRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.instantiateInlineWorkflowTemplate = stubLongRunningCall(expectedResponse);
            const [operation] = await client.instantiateInlineWorkflowTemplate(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.instantiateInlineWorkflowTemplate as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.instantiateInlineWorkflowTemplate as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes instantiateInlineWorkflowTemplate without error using callback', async () => {
            ...
            client.innerApiCalls.instantiateInlineWorkflowTemplate = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes instantiateInlineWorkflowTemplate with call error', async () => {
            ...
            await assert.rejects(client.instantiateInlineWorkflowTemplate(request), expectedError);
            const actualRequest = (client.innerApiCalls.instantiateInlineWorkflowTemplate as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.instantiateInlineWorkflowTemplate as SinonStub)
        ...
        it('invokes checkInstantiateInlineWorkflowTemplateProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkInstantiateInlineWorkflowTemplateProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkInstantiateInlineWorkflowTemplateProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkInstantiateInlineWorkflowTemplateProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listWorkflowTemplates', () => {
        it('invokes listWorkflowTemplates without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.ListWorkflowTemplatesRequest', ['parent']);
            request.parent = defaultValue1;
            ...
            client.innerApiCalls.listWorkflowTemplates = stubSimpleCall(expectedResponse);
            const [response] = await client.listWorkflowTemplates(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listWorkflowTemplates as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listWorkflowTemplates as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listWorkflowTemplates without error using callback', async () => {
            ...
            client.innerApiCalls.listWorkflowTemplates = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listWorkflowTemplates with error', async () => {
            ...
            await assert.rejects(client.listWorkflowTemplates(request), expectedError);
            const actualRequest = (client.innerApiCalls.listWorkflowTemplates as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listWorkflowTemplates as SinonStub)
        ...
        it('invokes listWorkflowTemplatesStream without error', async () => {
            ...
            assert(
                (client.descriptors.page.listWorkflowTemplates.createStream as SinonStub)
        ...
        it('invokes listWorkflowTemplatesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listWorkflowTemplates.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listWorkflowTemplatesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataproc.v1.WorkflowTemplate[] = [];
                stream.on('data', (response: protos.google.cloud.dataproc.v1.WorkflowTemplate) => {
        ...
        it('uses async iteration with listWorkflowTemplates without error', async () => {
            ...
            client.descriptors.page.listWorkflowTemplates.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(
                (client.descriptors.page.listWorkflowTemplates.asyncIterate as SinonStub)
