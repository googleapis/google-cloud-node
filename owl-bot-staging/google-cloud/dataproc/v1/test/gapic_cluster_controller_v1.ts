...
describe('v1.ClusterControllerClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = clustercontrollerModule.v1.ClusterControllerClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = clustercontrollerModule.v1.ClusterControllerClient.apiEndpoint;
            assert(apiEndpoint);
        });
    ...
    describe('getCluster', () => {
        it('invokes getCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.GetClusterRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.GetClusterRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.GetClusterRequest', ['clusterName']);
        ...
        it('invokes getCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCluster(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataproc.v1.ICluster|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createCluster', () => {
        it('invokes createCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.CreateClusterRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.CreateClusterRequest', ['region']);
            request.region = defaultValue2;
        ...
        it('invokes createCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createCluster(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dataproc.v1.ICluster, protos.google.cloud.dataproc.v1.IClusterOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dataproc.v1.ICluster, protos.google.cloud.dataproc.v1.IClusterOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createCluster as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateCluster', () => {
        it('invokes updateCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.UpdateClusterRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.UpdateClusterRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.UpdateClusterRequest', ['clusterName']);
            request.clusterName = defaultValue3;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&region=${defaultValue2}&cluster_name=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('stopCluster', () => {
        it('invokes stopCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.StopClusterRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.StopClusterRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.StopClusterRequest', ['clusterName']);
            request.clusterName = defaultValue3;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&region=${defaultValue2}&cluster_name=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.stopCluster as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.stopCluster as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes stopCluster without error using callback', async () => {
            ...
            client.innerApiCalls.stopCluster = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.stopCluster(
                    request,
                    (err?: Error|null,
        ...
        it('invokes stopCluster with call error', async () => {
            ...
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&region=${defaultValue2}&cluster_name=${defaultValue3}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.stopCluster = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes stopCluster with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&region=${defaultValue2}&cluster_name=${defaultValue3}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.stopCluster = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.stopCluster(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.stopCluster as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkStopClusterProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkStopClusterProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('startCluster', () => {
        it('invokes startCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.StartClusterRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.StartClusterRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.StartClusterRequest', ['clusterName']);
            request.clusterName = defaultValue3;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&region=${defaultValue2}&cluster_name=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.startCluster as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.startCluster as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes startCluster without error using callback', async () => {
            ...
            client.innerApiCalls.startCluster = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.startCluster(
                    request,
                    (err?: Error|null,
        ...
        it('invokes startCluster with call error', async () => {
            ...
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&region=${defaultValue2}&cluster_name=${defaultValue3}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.startCluster = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes startCluster with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&region=${defaultValue2}&cluster_name=${defaultValue3}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.startCluster = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.startCluster(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.startCluster as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkStartClusterProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkStartClusterProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('deleteCluster', () => {
        it('invokes deleteCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.DeleteClusterRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.DeleteClusterRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.DeleteClusterRequest', ['clusterName']);
            request.clusterName = defaultValue3;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&region=${defaultValue2}&cluster_name=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes deleteCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deleteCluster(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.dataproc.v1.IClusterOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.dataproc.v1.IClusterOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteCluster as SinonStub)
                .getCall(0).args[0];
    ...
    describe('diagnoseCluster', () => {
        it('invokes diagnoseCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.DiagnoseClusterRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.DiagnoseClusterRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.DiagnoseClusterRequest', ['clusterName']);
            request.clusterName = defaultValue3;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&region=${defaultValue2}&cluster_name=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.diagnoseCluster = stubLongRunningCall(expectedResponse);
            const [operation] = await client.diagnoseCluster(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.diagnoseCluster as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.diagnoseCluster as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes diagnoseCluster without error using callback', async () => {
            ...
            client.innerApiCalls.diagnoseCluster = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.diagnoseCluster(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dataproc.v1.IDiagnoseClusterResults, protos.google.cloud.dataproc.v1.IClusterOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dataproc.v1.IDiagnoseClusterResults, protos.google.cloud.dataproc.v1.IClusterOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.diagnoseCluster as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDiagnoseClusterProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDiagnoseClusterProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDiagnoseClusterProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDiagnoseClusterProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listClusters', () => {
        it('invokes listClusters without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.ListClustersRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.dataproc.v1.ListClustersRequest', ['region']);
            request.region = defaultValue2;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&region=${defaultValue2}`;const expectedResponse = [
        ...
        it('invokes listClustersStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.dataproc.v1.Cluster) => {
