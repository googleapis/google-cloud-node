...
describe('v1.WebSecurityScannerClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = websecurityscannerModule.v1.WebSecurityScannerClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = websecurityscannerModule.v1.WebSecurityScannerClient.apiEndpoint;
            assert(apiEndpoint);
        });
    ...
    describe('createScanConfig', () => {
        it('invokes createScanConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.websecurityscanner.v1.CreateScanConfigRequest', ['parent']);
        ...
        it('invokes createScanConfig without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createScanConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.websecurityscanner.v1.IScanConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deleteScanConfig', () => {
        it('invokes deleteScanConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.websecurityscanner.v1.DeleteScanConfigRequest', ['name']);
    ...
    describe('getScanConfig', () => {
        it('invokes getScanConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.websecurityscanner.v1.GetScanConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.websecurityscanner.v1.ScanConfig()
    ...
    describe('updateScanConfig', () => {
        it('invokes updateScanConfig without error', async () => {
            ...
            request.scanConfig ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.websecurityscanner.v1.UpdateScanConfigRequest', ['scanConfig', 'name']);
    ...
    describe('startScanRun', () => {
        it('invokes startScanRun without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.websecurityscanner.v1.StartScanRunRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes startScanRun without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.startScanRun(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.websecurityscanner.v1.IScanRun|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getScanRun', () => {
        it('invokes getScanRun without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.websecurityscanner.v1.GetScanRunRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.websecurityscanner.v1.ScanRun()
    ...
    describe('stopScanRun', () => {
        it('invokes stopScanRun without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.websecurityscanner.v1.StopScanRunRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.websecurityscanner.v1.ScanRun()
    ...
    describe('getFinding', () => {
        it('invokes getFinding without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.websecurityscanner.v1.GetFindingRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getFinding without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getFinding(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.websecurityscanner.v1.IFinding|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listFindingTypeStats', () => {
        it('invokes listFindingTypeStats without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.websecurityscanner.v1.ListFindingTypeStatsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes listFindingTypeStats without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listFindingTypeStats(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.websecurityscanner.v1.IListFindingTypeStatsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listScanConfigs', () => {
        it('invokes listScanConfigs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.websecurityscanner.v1.ListScanConfigsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.websecurityscanner.v1.ScanConfig()),
              generateSampleMessage(new protos.google.cloud.websecurityscanner.v1.ScanConfig()),
              generateSampleMessage(new protos.google.cloud.websecurityscanner.v1.ScanConfig()),
            ];
        ...
        it('invokes listScanConfigsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.websecurityscanner.v1.ScanConfig) => {
    ...
    describe('listScanRuns', () => {
        it('invokes listScanRuns without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.websecurityscanner.v1.ListScanRunsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.websecurityscanner.v1.ScanRun()),
              generateSampleMessage(new protos.google.cloud.websecurityscanner.v1.ScanRun()),
              generateSampleMessage(new protos.google.cloud.websecurityscanner.v1.ScanRun()),
            ];
        ...
        it('invokes listScanRunsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.websecurityscanner.v1.ScanRun) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listCrawledUrls', () => {
        it('invokes listCrawledUrls without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.websecurityscanner.v1.ListCrawledUrlsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.websecurityscanner.v1.CrawledUrl()),
              generateSampleMessage(new protos.google.cloud.websecurityscanner.v1.CrawledUrl()),
              generateSampleMessage(new protos.google.cloud.websecurityscanner.v1.CrawledUrl()),
            ];
        ...
        it('invokes listCrawledUrls without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listCrawledUrls(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.websecurityscanner.v1.ICrawledUrl[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listCrawledUrlsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.websecurityscanner.v1.CrawledUrl) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listFindings', () => {
        it('invokes listFindings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.websecurityscanner.v1.ListFindingsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.websecurityscanner.v1.Finding()),
              generateSampleMessage(new protos.google.cloud.websecurityscanner.v1.Finding()),
              generateSampleMessage(new protos.google.cloud.websecurityscanner.v1.Finding()),
            ];
        ...
        it('invokes listFindingsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.websecurityscanner.v1.Finding) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
