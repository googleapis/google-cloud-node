 ...
 * `src/v2/function_service_client_config.json`.
...
export class FunctionServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    if (opts.fallback === 'rest') {
      ...
      lroOptions.httpRules = [{selector: 'google.cloud.location.Locations.ListLocations',get: '/v2/{name=projects/*}/locations',},{selector: 'google.iam.v1.IAMPolicy.GetIamPolicy',get: '/v2/{resource=projects/*/locations/*/functions/*}:getIamPolicy',},{selector: 'google.iam.v1.IAMPolicy.SetIamPolicy',post: '/v2/{resource=projects/*/locations/*/functions/*}:setIamPolicy',body: '*',},{selector: 'google.iam.v1.IAMPolicy.TestIamPermissions',post: '/v2/{resource=projects/*/locations/*/functions/*}:testIamPermissions',body: '*',},{selector: 'google.longrunning.Operations.GetOperation',get: '/v2/{name=projects/*/locations/*/operations/*}',},{selector: 'google.longrunning.Operations.ListOperations',get: '/v2/{name=projects/*/locations/*}/operations',}];
    }
    this.operationsClient = this._gaxModule.lro(lroOptions).operationsClient(opts);
    const createFunctionResponse = protoFilesRoot.lookup(
      '.google.cloud.functions.v2.Function') as gax.protobuf.Type;
    const createFunctionMetadata = protoFilesRoot.lookup(
      '.google.cloud.functions.v2.OperationMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.functions.v2.FunctionService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.functionServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.functions.v2.FunctionService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.functions.v2.FunctionService,
 ...
 *   The first element of the array is an object representing [Function]{@link google.cloud.functions.v2.Function}.
 *   Please see the
 ...
 */
  getFunction(
      request?: protos.google.cloud.functions.v2.IGetFunctionRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.functions.v2.IFunction,
        protos.google.cloud.functions.v2.IGetFunctionRequest|undefined, {}|undefined
      ]>;
  getFunction(
      request: protos.google.cloud.functions.v2.IGetFunctionRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.functions.v2.IFunction,
          protos.google.cloud.functions.v2.IGetFunctionRequest|null|undefined,
          {}|null|undefined>): void;
  getFunction(
      request: protos.google.cloud.functions.v2.IGetFunctionRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [GenerateUploadUrlResponse]{@link google.cloud.functions.v2.GenerateUploadUrlResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 ...
 */
  generateUploadUrl(
      request?: protos.google.cloud.functions.v2.IGenerateUploadUrlRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.functions.v2.IGenerateUploadUrlResponse,
        protos.google.cloud.functions.v2.IGenerateUploadUrlRequest|undefined, {}|undefined
      ]>;
  generateUploadUrl(
      request: protos.google.cloud.functions.v2.IGenerateUploadUrlRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.functions.v2.IGenerateUploadUrlResponse,
          protos.google.cloud.functions.v2.IGenerateUploadUrlRequest|null|undefined,
          {}|null|undefined>): void;
  generateUploadUrl(
      request: protos.google.cloud.functions.v2.IGenerateUploadUrlRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [GenerateDownloadUrlResponse]{@link google.cloud.functions.v2.GenerateDownloadUrlResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 ...
 */
  generateDownloadUrl(
      request?: protos.google.cloud.functions.v2.IGenerateDownloadUrlRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.functions.v2.IGenerateDownloadUrlResponse,
        protos.google.cloud.functions.v2.IGenerateDownloadUrlRequest|undefined, {}|undefined
      ]>;
  generateDownloadUrl(
      request: protos.google.cloud.functions.v2.IGenerateDownloadUrlRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.functions.v2.IGenerateDownloadUrlResponse,
          protos.google.cloud.functions.v2.IGenerateDownloadUrlRequest|null|undefined,
          {}|null|undefined>): void;
  generateDownloadUrl(
      request: protos.google.cloud.functions.v2.IGenerateDownloadUrlRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [ListRuntimesResponse]{@link google.cloud.functions.v2.ListRuntimesResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 ...
 */
  listRuntimes(
      request?: protos.google.cloud.functions.v2.IListRuntimesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.functions.v2.IListRuntimesResponse,
        protos.google.cloud.functions.v2.IListRuntimesRequest|undefined, {}|undefined
      ]>;
  listRuntimes(
      request: protos.google.cloud.functions.v2.IListRuntimesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.functions.v2.IListRuntimesResponse,
          protos.google.cloud.functions.v2.IListRuntimesRequest|null|undefined,
          {}|null|undefined>): void;
  listRuntimes(
      request: protos.google.cloud.functions.v2.IListRuntimesRequest,
      callback: Callback<
 ...
 */
  createFunction(
      request?: protos.google.cloud.functions.v2.ICreateFunctionRequest,
      options?: CallOptions):
      Promise<[
 ...
 * region_tag:cloudfunctions_v2_generated_FunctionService_CreateFunction_async
 */
  async checkCreateFunctionProgress(name: string): Promise<LROperation<protos.google.cloud.functions.v2.Function, protos.google.cloud.functions.v2.OperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.functions.v2.Function, protos.google.cloud.functions.v2.OperationMetadata>;
  }
/**
 ...
 */
  updateFunction(
      request?: protos.google.cloud.functions.v2.IUpdateFunctionRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.functions.v2.IFunction, protos.google.cloud.functions.v2.IOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
 ...
 * region_tag:cloudfunctions_v2_generated_FunctionService_UpdateFunction_async
 */
  async checkUpdateFunctionProgress(name: string): Promise<LROperation<protos.google.cloud.functions.v2.Function, protos.google.cloud.functions.v2.OperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
 ...
 */
  deleteFunction(
      request?: protos.google.cloud.functions.v2.IDeleteFunctionRequest,
      options?: CallOptions):
      Promise<[
 ...
 * region_tag:cloudfunctions_v2_generated_FunctionService_DeleteFunction_async
 */
  async checkDeleteFunctionProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.functions.v2.OperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    ...
    return decodeOperation as LROperation<protos.google.protobuf.Empty, protos.google.cloud.functions.v2.OperationMetadata>;
  }
 /**
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [Function]{@link google.cloud.functions.v2.Function}.
 ...
 */
  listFunctions(
      request?: protos.google.cloud.functions.v2.IListFunctionsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.functions.v2.IFunction[],
  ...
  listFunctions(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.functions.v2.IListFunctionsResponse|null|undefined,
          protos.google.cloud.functions.v2.IFunction>): void;
  listFunctions(
      request: protos.google.cloud.functions.v2.IListFunctionsRequest,
      callback: PaginationCallback<
          protos.google.cloud.functions.v2.IListFunctionsRequest,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [Function]{@link google.cloud.functions.v2.Function} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   [Function]{@link google.cloud.functions.v2.Function}. The API will be called under the hood as needed, once per the page,
 ...
 */
  listFunctionsAsync(
    ...
    return this.descriptors.page.listFunctions.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.functions.v2.IFunction>;
  }
/**
