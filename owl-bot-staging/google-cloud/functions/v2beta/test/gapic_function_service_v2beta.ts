...
describe('v2beta.FunctionServiceClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = functionserviceModule.v2beta.FunctionServiceClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = functionserviceModule.v2beta.FunctionServiceClient.apiEndpoint;
            assert(apiEndpoint);
        });

        it('has port', () => {
            const port = functionserviceModule.v2beta.FunctionServiceClient.port;
            assert(port);
            assert(typeof port === 'number');
        });

        it('should create a client with no option', () => {
            const client = new functionserviceModule.v2beta.FunctionServiceClient();
            assert(client);
        });
    ...
    describe('getFunction', () => {
        it('invokes getFunction without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.functions.v2beta.GetFunctionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.functions.v2beta.GetFunctionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.functions.v2beta.Function()
            );
        ...
        it('invokes getFunction without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getFunction(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.functions.v2beta.IFunction|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateUploadUrl', () => {
        it('invokes generateUploadUrl without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.functions.v2beta.GenerateUploadUrlRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.functions.v2beta.GenerateUploadUrlRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.functions.v2beta.GenerateUploadUrlResponse()
            );
        ...
        it('invokes generateUploadUrl without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateUploadUrl(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.functions.v2beta.IGenerateUploadUrlResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateDownloadUrl', () => {
        it('invokes generateDownloadUrl without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.functions.v2beta.GenerateDownloadUrlRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.functions.v2beta.GenerateDownloadUrlRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.functions.v2beta.GenerateDownloadUrlResponse()
            );
        ...
        it('invokes generateDownloadUrl without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateDownloadUrl(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.functions.v2beta.IGenerateDownloadUrlResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listRuntimes', () => {
        it('invokes listRuntimes without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.functions.v2beta.ListRuntimesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.functions.v2beta.ListRuntimesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.functions.v2beta.ListRuntimesResponse()
            );
            client.innerApiCalls.listRuntimes = stubSimpleCall(expectedResponse);
            const [response] = await client.listRuntimes(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listRuntimes as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listRuntimes as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listRuntimes without error using callback', async () => {
            ...
            client.innerApiCalls.listRuntimes = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listRuntimes(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.functions.v2beta.IListRuntimesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listRuntimes with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listRuntimes = stubSimpleCall(undefined, expectedError);
    ...
    describe('createFunction', () => {
        it('invokes createFunction without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.functions.v2beta.CreateFunctionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.functions.v2beta.CreateFunctionRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes createFunction without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createFunction(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.functions.v2beta.IFunction, protos.google.cloud.functions.v2beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.functions.v2beta.IFunction, protos.google.cloud.functions.v2beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createFunction as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateFunction', () => {
        it('invokes updateFunction without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.functions.v2beta.UpdateFunctionRequest()
            );
            request.function ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.functions.v2beta.UpdateFunctionRequest', ['function', 'name']);
    ...
    describe('deleteFunction', () => {
        it('invokes deleteFunction without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.functions.v2beta.DeleteFunctionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.functions.v2beta.DeleteFunctionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes deleteFunction without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deleteFunction(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.functions.v2beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.functions.v2beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteFunction as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listFunctions', () => {
        it('invokes listFunctions without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.functions.v2beta.ListFunctionsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.functions.v2beta.ListFunctionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.functions.v2beta.Function()),
              generateSampleMessage(new protos.google.cloud.functions.v2beta.Function()),
              generateSampleMessage(new protos.google.cloud.functions.v2beta.Function()),
            ];
        ...
        it('invokes listFunctionsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.functions.v2beta.Function[] = [];
                stream.on('data', (response: protos.google.cloud.functions.v2beta.Function) => {
    ...
    describe('Path templates', () => {
        ...
        describe('function', () => {
            ...
            client.initialize();
            client.pathTemplates.functionPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.functionPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('functionPath', () => {
                const result = client.functionPath("projectValue", "locationValue", "functionValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.functionPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromFunctionName', () => {
                const result = client.matchProjectFromFunctionName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.functionPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromFunctionName', () => {
                const result = client.matchLocationFromFunctionName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.functionPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchFunctionFromFunctionName', () => {
                const result = client.matchFunctionFromFunctionName(fakePath);
