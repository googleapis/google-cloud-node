...
describe('v2.KnowledgeBasesClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = knowledgebasesModule.v2.KnowledgeBasesClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = knowledgebasesModule.v2.KnowledgeBasesClient.apiEndpoint;
            assert(apiEndpoint);
        });

        it('has port', () => {
            const port = knowledgebasesModule.v2.KnowledgeBasesClient.port;
            assert(port);
    ...
    describe('getKnowledgeBase', () => {
        it('invokes getKnowledgeBase without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.GetKnowledgeBaseRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getKnowledgeBase as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getKnowledgeBase as SinonStub)
        ...
        it('invokes getKnowledgeBase without error using callback', async () => {
            ...
            client.innerApiCalls.getKnowledgeBase = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getKnowledgeBase(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.IKnowledgeBase|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getKnowledgeBase with error', async () => {
            ...
            client.innerApiCalls.getKnowledgeBase = stubSimpleCall(undefined, expectedError);
    ...
    describe('createKnowledgeBase', () => {
        it('invokes createKnowledgeBase without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.CreateKnowledgeBaseRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.KnowledgeBase()
            );
            client.innerApiCalls.createKnowledgeBase = stubSimpleCall(expectedResponse);
            const [response] = await client.createKnowledgeBase(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createKnowledgeBase as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createKnowledgeBase as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createKnowledgeBase without error using callback', async () => {
            ...
            client.innerApiCalls.createKnowledgeBase = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createKnowledgeBase with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createKnowledgeBase = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteKnowledgeBase', () => {
        it('invokes deleteKnowledgeBase without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.DeleteKnowledgeBaseRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteKnowledgeBase = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteKnowledgeBase(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteKnowledgeBase as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteKnowledgeBase as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteKnowledgeBase without error using callback', async () => {
            ...
            client.innerApiCalls.deleteKnowledgeBase = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteKnowledgeBase with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteKnowledgeBase = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateKnowledgeBase', () => {
        it('invokes updateKnowledgeBase without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.UpdateKnowledgeBaseRequest()
            );
            request.knowledgeBase ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.UpdateKnowledgeBaseRequest', ['knowledgeBase', 'name']);
            request.knowledgeBase.name = defaultValue1;
            const expectedHeaderRequestParams = `knowledge_base.name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.KnowledgeBase()
            );
            client.innerApiCalls.updateKnowledgeBase = stubSimpleCall(expectedResponse);
            const [response] = await client.updateKnowledgeBase(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateKnowledgeBase as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateKnowledgeBase as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateKnowledgeBase without error using callback', async () => {
            ...
            client.innerApiCalls.updateKnowledgeBase = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateKnowledgeBase with error', async () => {
            ...
            const expectedHeaderRequestParams = `knowledge_base.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateKnowledgeBase = stubSimpleCall(undefined, expectedError);
    ...
    describe('listKnowledgeBases', () => {
        it('invokes listKnowledgeBases without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.ListKnowledgeBasesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.ListKnowledgeBasesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.KnowledgeBase()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.KnowledgeBase()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.KnowledgeBase()),
            ];
            client.innerApiCalls.listKnowledgeBases = stubSimpleCall(expectedResponse);
            const [response] = await client.listKnowledgeBases(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listKnowledgeBases as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listKnowledgeBases as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listKnowledgeBases without error using callback', async () => {
            ...
            client.innerApiCalls.listKnowledgeBases = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listKnowledgeBases with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listKnowledgeBases = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listKnowledgeBases(request), expectedError);
            const actualRequest = (client.innerApiCalls.listKnowledgeBases as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listKnowledgeBases as SinonStub)
        ...
        it('invokes listKnowledgeBasesStream without error', async () => {
            ...
            client.descriptors.page.listKnowledgeBases.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listKnowledgeBasesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2.KnowledgeBase[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2.KnowledgeBase) => {
            ...
            assert((client.descriptors.page.listKnowledgeBases.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listKnowledgeBases, request));
            assert(
        ...
        it('invokes listKnowledgeBasesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listKnowledgeBases.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listKnowledgeBasesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2.KnowledgeBase[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2.KnowledgeBase) => {
        ...
        it('uses async iteration with listKnowledgeBases without error', async () => {
            ...
            client.descriptors.page.listKnowledgeBases.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.dialogflow.v2.IKnowledgeBase[] = [];
        ...
        it('uses async iteration with listKnowledgeBases with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listKnowledgeBases.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listKnowledgeBasesAsync(request);
