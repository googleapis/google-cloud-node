...
describe('v2.ConversationProfilesClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = conversationprofilesModule.v2.ConversationProfilesClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = conversationprofilesModule.v2.ConversationProfilesClient.apiEndpoint;
            assert(apiEndpoint);
        });

        it('has port', () => {
            const port = conversationprofilesModule.v2.ConversationProfilesClient.port;
            assert(port);
    ...
    describe('getConversationProfile', () => {
        it('invokes getConversationProfile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.GetConversationProfileRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.ConversationProfile()
            );
            client.innerApiCalls.getConversationProfile = stubSimpleCall(expectedResponse);
            const [response] = await client.getConversationProfile(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getConversationProfile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getConversationProfile as SinonStub)
        ...
        it('invokes getConversationProfile without error using callback', async () => {
            ...
            client.innerApiCalls.getConversationProfile = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getConversationProfile(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.IConversationProfile|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getConversationProfile with error', async () => {
            ...
            client.innerApiCalls.getConversationProfile = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getConversationProfile(request), expectedError);
            const actualRequest = (client.innerApiCalls.getConversationProfile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getConversationProfile as SinonStub)
    ...
    describe('createConversationProfile', () => {
        it('invokes createConversationProfile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.CreateConversationProfileRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.ConversationProfile()
            );
            client.innerApiCalls.createConversationProfile = stubSimpleCall(expectedResponse);
            const [response] = await client.createConversationProfile(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createConversationProfile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createConversationProfile as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createConversationProfile without error using callback', async () => {
            ...
            client.innerApiCalls.createConversationProfile = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createConversationProfile with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createConversationProfile = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createConversationProfile(request), expectedError);
            const actualRequest = (client.innerApiCalls.createConversationProfile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createConversationProfile as SinonStub)
    ...
    describe('updateConversationProfile', () => {
        it('invokes updateConversationProfile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.UpdateConversationProfileRequest', ['conversationProfile', 'name']);
            request.conversationProfile.name = defaultValue1;
            const expectedHeaderRequestParams = `conversation_profile.name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.ConversationProfile()
            );
            client.innerApiCalls.updateConversationProfile = stubSimpleCall(expectedResponse);
            const [response] = await client.updateConversationProfile(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateConversationProfile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateConversationProfile as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateConversationProfile without error using callback', async () => {
            ...
            client.innerApiCalls.updateConversationProfile = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateConversationProfile with error', async () => {
            ...
            const expectedHeaderRequestParams = `conversation_profile.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateConversationProfile = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateConversationProfile(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateConversationProfile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateConversationProfile as SinonStub)
    ...
    describe('deleteConversationProfile', () => {
        it('invokes deleteConversationProfile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.DeleteConversationProfileRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteConversationProfile = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteConversationProfile(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteConversationProfile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteConversationProfile as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteConversationProfile without error using callback', async () => {
            ...
            client.innerApiCalls.deleteConversationProfile = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteConversationProfile with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteConversationProfile = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.deleteConversationProfile(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteConversationProfile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteConversationProfile as SinonStub)
    ...
    describe('setSuggestionFeatureConfig', () => {
        it('invokes setSuggestionFeatureConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.SetSuggestionFeatureConfigRequest', ['conversationProfile']);
            request.conversationProfile = defaultValue1;
            const expectedHeaderRequestParams = `conversation_profile=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.setSuggestionFeatureConfig = stubLongRunningCall(expectedResponse);
            const [operation] = await client.setSuggestionFeatureConfig(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.setSuggestionFeatureConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.setSuggestionFeatureConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes setSuggestionFeatureConfig without error using callback', async () => {
            ...
            client.innerApiCalls.setSuggestionFeatureConfig = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.setSuggestionFeatureConfig(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dialogflow.v2.IConversationProfile, protos.google.cloud.dialogflow.v2.ISetSuggestionFeatureConfigOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dialogflow.v2.IConversationProfile, protos.google.cloud.dialogflow.v2.ISetSuggestionFeatureConfigOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.setSuggestionFeatureConfig as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes setSuggestionFeatureConfig with call error', async () => {
            ...
            const expectedHeaderRequestParams = `conversation_profile=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.setSuggestionFeatureConfig = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.setSuggestionFeatureConfig(request), expectedError);
            const actualRequest = (client.innerApiCalls.setSuggestionFeatureConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.setSuggestionFeatureConfig as SinonStub)
        ...
        it('invokes setSuggestionFeatureConfig with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `conversation_profile=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.setSuggestionFeatureConfig = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.setSuggestionFeatureConfig(request);
        ...
        it('invokes checkSetSuggestionFeatureConfigProgress without error', async () => {
            ...
            const decodedOperation = await client.checkSetSuggestionFeatureConfigProgress(expectedResponse.name);
        ...
        it('invokes checkSetSuggestionFeatureConfigProgress with error', async () => {
            ...
            await assert.rejects(client.checkSetSuggestionFeatureConfigProgress(''), expectedError);
    ...
    describe('clearSuggestionFeatureConfig', () => {
        it('invokes clearSuggestionFeatureConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.ClearSuggestionFeatureConfigRequest', ['conversationProfile']);
            request.conversationProfile = defaultValue1;
            const expectedHeaderRequestParams = `conversation_profile=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.clearSuggestionFeatureConfig = stubLongRunningCall(expectedResponse);
            const [operation] = await client.clearSuggestionFeatureConfig(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.clearSuggestionFeatureConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.clearSuggestionFeatureConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes clearSuggestionFeatureConfig without error using callback', async () => {
            ...
            client.innerApiCalls.clearSuggestionFeatureConfig = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.clearSuggestionFeatureConfig(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dialogflow.v2.IConversationProfile, protos.google.cloud.dialogflow.v2.IClearSuggestionFeatureConfigOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dialogflow.v2.IConversationProfile, protos.google.cloud.dialogflow.v2.IClearSuggestionFeatureConfigOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.clearSuggestionFeatureConfig as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes clearSuggestionFeatureConfig with call error', async () => {
            ...
            const expectedHeaderRequestParams = `conversation_profile=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.clearSuggestionFeatureConfig = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.clearSuggestionFeatureConfig(request), expectedError);
            const actualRequest = (client.innerApiCalls.clearSuggestionFeatureConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.clearSuggestionFeatureConfig as SinonStub)
        ...
        it('invokes clearSuggestionFeatureConfig with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `conversation_profile=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.clearSuggestionFeatureConfig = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.clearSuggestionFeatureConfig(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.clearSuggestionFeatureConfig as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkClearSuggestionFeatureConfigProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkClearSuggestionFeatureConfigProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkClearSuggestionFeatureConfigProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkClearSuggestionFeatureConfigProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listConversationProfiles', () => {
        it('invokes listConversationProfiles without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.ListConversationProfilesRequest', ['parent']);
            request.parent = defaultValue1;
            ...
            client.innerApiCalls.listConversationProfiles = stubSimpleCall(expectedResponse);
            const [response] = await client.listConversationProfiles(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listConversationProfiles as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listConversationProfiles as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listConversationProfiles without error using callback', async () => {
            ...
            client.innerApiCalls.listConversationProfiles = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listConversationProfiles with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listConversationProfiles = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listConversationProfiles(request), expectedError);
            const actualRequest = (client.innerApiCalls.listConversationProfiles as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listConversationProfiles as SinonStub)
        ...
        it('invokes listConversationProfilesStream without error', async () => {
            ...
            const stream = client.listConversationProfilesStream(request);
            const promise = new Promise((resolve, reject) => {
            ...
            assert((client.descriptors.page.listConversationProfiles.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listConversationProfiles, request));
            assert(
                (client.descriptors.page.listConversationProfiles.createStream as SinonStub)
        ...
        it('invokes listConversationProfilesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listConversationProfiles.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listConversationProfilesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2.ConversationProfile[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2.ConversationProfile) => {
        ...
        it('uses async iteration with listConversationProfiles without error', async () => {
            ...
            client.descriptors.page.listConversationProfiles.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(
                (client.descriptors.page.listConversationProfiles.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listConversationProfiles with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listConversationProfiles.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listConversationProfilesAsync(request);
    ...
    describe('Path templates', () => {
        ...
        describe('cXSecuritySettings', () => {
            ...
            client.initialize();
            client.pathTemplates.cXSecuritySettingsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.cXSecuritySettingsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('cXSecuritySettingsPath', () => {
                const result = client.cXSecuritySettingsPath("projectValue", "locationValue", "securitySettingsValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.cXSecuritySettingsPathTemplate.render as SinonStub)
            ...
            it('matchProjectFromCXSecuritySettingsName', () => {
                ...
                assert((client.pathTemplates.cXSecuritySettingsPathTemplate.match as SinonStub)
            ...
            it('matchSecuritySettingsFromCXSecuritySettingsName', () => {
                const result = client.matchSecuritySettingsFromCXSecuritySettingsName(fakePath);
