...
describe('v2.AnswerRecordsClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = answerrecordsModule.v2.AnswerRecordsClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = answerrecordsModule.v2.AnswerRecordsClient.apiEndpoint;
            assert(apiEndpoint);
        });

        it('has port', () => {
            const port = answerrecordsModule.v2.AnswerRecordsClient.port;
            assert(port);
    ...
    describe('updateAnswerRecord', () => {
        it('invokes updateAnswerRecord without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.UpdateAnswerRecordRequest()
            );
            request.answerRecord ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.UpdateAnswerRecordRequest', ['answerRecord', 'name']);
            ...
            client.innerApiCalls.updateAnswerRecord = stubSimpleCall(expectedResponse);
            const [response] = await client.updateAnswerRecord(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateAnswerRecord as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateAnswerRecord as SinonStub)
        ...
        it('invokes updateAnswerRecord without error using callback', async () => {
            ...
            client.innerApiCalls.updateAnswerRecord = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateAnswerRecord(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.IAnswerRecord|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes updateAnswerRecord with error', async () => {
            ...
            client.innerApiCalls.updateAnswerRecord = stubSimpleCall(undefined, expectedError);
    ...
    describe('listAnswerRecords', () => {
        it('invokes listAnswerRecords without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.ListAnswerRecordsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.ListAnswerRecordsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.AnswerRecord()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.AnswerRecord()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.AnswerRecord()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listAnswerRecords as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAnswerRecords as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listAnswerRecords without error using callback', async () => {
            ...
            client.innerApiCalls.listAnswerRecords = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listAnswerRecords with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listAnswerRecords = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listAnswerRecordsStream without error', async () => {
            ...
            client.descriptors.page.listAnswerRecords.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listAnswerRecordsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2.AnswerRecord[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2.AnswerRecord) => {
            ...
            assert((client.descriptors.page.listAnswerRecords.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listAnswerRecords, request));
            assert(
        ...
        it('invokes listAnswerRecordsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAnswerRecords.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listAnswerRecordsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2.AnswerRecord[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2.AnswerRecord) => {
        ...
        it('uses async iteration with listAnswerRecords without error', async () => {
            ...
            client.descriptors.page.listAnswerRecords.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.dialogflow.v2.IAnswerRecord[] = [];
        ...
        it('uses async iteration with listAnswerRecords with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAnswerRecords.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listAnswerRecordsAsync(request);
