...
describe('v2.ParticipantsClient', () => {
    ...
    describe('createParticipant', () => {
        it('invokes createParticipant without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.CreateParticipantRequest', ['parent']);
            ...
            const actualRequest = (client.innerApiCalls.createParticipant as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createParticipant as SinonStub)
    ...
    describe('getParticipant', () => {
        it('invokes getParticipant without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.GetParticipantRequest', ['name']);
    ...
    describe('updateParticipant', () => {
        it('invokes updateParticipant without error', async () => {
            ...
            request.participant ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.UpdateParticipantRequest', ['participant', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateParticipant as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateParticipant as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('analyzeContent', () => {
        it('invokes analyzeContent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.AnalyzeContentRequest', ['participant']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.analyzeContent as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.analyzeContent as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('suggestArticles', () => {
        it('invokes suggestArticles without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.SuggestArticlesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.suggestArticles as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.suggestArticles as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('suggestFaqAnswers', () => {
        it('invokes suggestFaqAnswers without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.SuggestFaqAnswersRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.suggestFaqAnswers as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.suggestFaqAnswers as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('suggestSmartReplies', () => {
        it('invokes suggestSmartReplies without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.SuggestSmartRepliesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.SuggestSmartRepliesResponse()
            );
            client.innerApiCalls.suggestSmartReplies = stubSimpleCall(expectedResponse);
            const [response] = await client.suggestSmartReplies(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.suggestSmartReplies as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.suggestSmartReplies as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes suggestSmartReplies without error using callback', async () => {
            ...
            client.innerApiCalls.suggestSmartReplies = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.suggestSmartReplies(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.ISuggestSmartRepliesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes suggestSmartReplies with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.suggestSmartReplies = stubSimpleCall(undefined, expectedError);
    ...
    describe('streamingAnalyzeContent', () => {
        it('invokes streamingAnalyzeContent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest()
            );
            
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse()
            );
            client.innerApiCalls.streamingAnalyzeContent = stubBidiStreamingCall(expectedResponse);
            ...
            const response = await promise;
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.streamingAnalyzeContent as SinonStub)
        ...
        it('invokes streamingAnalyzeContent with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.streamingAnalyzeContent = stubBidiStreamingCall(undefined, expectedError);
            const stream = client.streamingAnalyzeContent();
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse) => {
                    resolve(response);
    ...
    describe('listParticipants', () => {
        it('invokes listParticipants without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.ListParticipantsRequest', ['parent']);
            request.parent = defaultValue1;
