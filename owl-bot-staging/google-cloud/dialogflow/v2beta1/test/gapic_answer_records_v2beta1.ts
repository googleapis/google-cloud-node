...
describe('v2beta1.AnswerRecordsClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = answerrecordsModule.v2beta1.AnswerRecordsClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = answerrecordsModule.v2beta1.AnswerRecordsClient.apiEndpoint;
            assert(apiEndpoint);
        });
    ...
    describe('getAnswerRecord', () => {
        it('invokes getAnswerRecord without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.GetAnswerRecordRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getAnswerRecord as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getAnswerRecord as SinonStub)
        ...
        it('invokes getAnswerRecord without error using callback', async () => {
            ...
            client.innerApiCalls.getAnswerRecord = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAnswerRecord(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2beta1.IAnswerRecord|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateAnswerRecord', () => {
        it('invokes updateAnswerRecord without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.UpdateAnswerRecordRequest', ['answerRecord', 'name']);
    ...
    describe('listAnswerRecords', () => {
        it('invokes listAnswerRecords without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.ListAnswerRecordsRequest', ['parent']);
        ...
        it('invokes listAnswerRecordsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.dialogflow.v2beta1.AnswerRecord) => {
