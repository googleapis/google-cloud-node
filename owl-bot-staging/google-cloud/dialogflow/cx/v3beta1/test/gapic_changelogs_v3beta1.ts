...
describe('v3beta1.ChangelogsClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = changelogsModule.v3beta1.ChangelogsClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = changelogsModule.v3beta1.ChangelogsClient.apiEndpoint;
            assert(apiEndpoint);
        });

        it('has port', () => {
            const port = changelogsModule.v3beta1.ChangelogsClient.port;
            assert(port);
            assert(typeof port === 'number');
        });

        it('should create a client with no option', () => {
            const client = new changelogsModule.v3beta1.ChangelogsClient();
            assert(client);
        });
    ...
    describe('getChangelog', () => {
        it('invokes getChangelog without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.GetChangelogRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.Changelog()
            );
        ...
        it('invokes getChangelog without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getChangelog(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3beta1.IChangelog|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listChangelogs', () => {
        it('invokes listChangelogs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.ListChangelogsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.Changelog()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.Changelog()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.Changelog()),
            ];
        ...
        it('invokes listChangelogsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.cx.v3beta1.Changelog[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3beta1.Changelog) => {
        ...
        it('uses async iteration with listChangelogs without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.cx.v3beta1.IChangelog[] = [];
