...
describe('v3.EnvironmentsClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = environmentsModule.v3.EnvironmentsClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = environmentsModule.v3.EnvironmentsClient.apiEndpoint;
            assert(apiEndpoint);
        });

        it('has port', () => {
            const port = environmentsModule.v3.EnvironmentsClient.port;
            assert(port);
    ...
    describe('getEnvironment', () => {
        it('invokes getEnvironment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.GetEnvironmentRequest', ['name']);
        ...
        it('invokes getEnvironment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getEnvironment(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3.IEnvironment|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deleteEnvironment', () => {
        it('invokes deleteEnvironment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.DeleteEnvironmentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createEnvironment', () => {
        it('invokes createEnvironment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.CreateEnvironmentRequest', ['parent']);
        ...
        it('invokes createEnvironment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createEnvironment(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dialogflow.cx.v3.IEnvironment, protos.google.protobuf.IStruct>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dialogflow.cx.v3.IEnvironment, protos.google.protobuf.IStruct>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createEnvironment as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateEnvironment', () => {
        it('invokes updateEnvironment without error', async () => {
            ...
            request.environment ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.UpdateEnvironmentRequest', ['environment', 'name']);
    ...
    describe('runContinuousTest', () => {
        it('invokes runContinuousTest without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.RunContinuousTestRequest', ['environment']);
        ...
        it('invokes runContinuousTest without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.runContinuousTest(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dialogflow.cx.v3.IRunContinuousTestResponse, protos.google.cloud.dialogflow.cx.v3.IRunContinuousTestMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dialogflow.cx.v3.IRunContinuousTestResponse, protos.google.cloud.dialogflow.cx.v3.IRunContinuousTestMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.runContinuousTest as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deployFlow', () => {
        it('invokes deployFlow without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.DeployFlowRequest', ['environment']);
            request.environment = defaultValue1;
            const expectedHeaderRequestParams = `environment=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes deployFlow without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deployFlow(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dialogflow.cx.v3.IDeployFlowResponse, protos.google.cloud.dialogflow.cx.v3.IDeployFlowMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dialogflow.cx.v3.IDeployFlowResponse, protos.google.cloud.dialogflow.cx.v3.IDeployFlowMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deployFlow as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listEnvironments', () => {
        it('invokes listEnvironments without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.ListEnvironmentsRequest', ['parent']);
            request.parent = defaultValue1;
        ...
        it('invokes listEnvironmentsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.cx.v3.Environment[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3.Environment) => {
        ...
        it('uses async iteration with listEnvironments without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.cx.v3.IEnvironment[] = [];
    ...
    describe('lookupEnvironmentHistory', () => {
        it('invokes lookupEnvironmentHistory without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.LookupEnvironmentHistoryRequest', ['name']);
            request.name = defaultValue1;
    ...
    describe('listContinuousTestResults', () => {
        it('invokes listContinuousTestResults without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.ListContinuousTestResultsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
        ...
        it('invokes listContinuousTestResults without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listContinuousTestResults(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3.IContinuousTestResult[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listContinuousTestResultsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.cx.v3.ContinuousTestResult[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3.ContinuousTestResult) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listContinuousTestResults without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.cx.v3.IContinuousTestResult[] = [];
