...
import * as regioninstancegroupsModule from '../src';
...
describe('v1.RegionInstanceGroupsClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = regioninstancegroupsModule.v1.RegionInstanceGroupsClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = regioninstancegroupsModule.v1.RegionInstanceGroupsClient.apiEndpoint;
            assert(apiEndpoint);
        });

        it('has port', () => {
            const port = regioninstancegroupsModule.v1.RegionInstanceGroupsClient.port;
            assert(port);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetRegionInstanceGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetRegionInstanceGroupRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetRegionInstanceGroupRequest', ['instanceGroup']);
            request.instanceGroup = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&instance_group=${defaultValue3}`;
    ...
    describe('setNamedPorts', () => {
        it('invokes setNamedPorts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.SetNamedPortsRegionInstanceGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.SetNamedPortsRegionInstanceGroupRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.SetNamedPortsRegionInstanceGroupRequest', ['instanceGroup']);
            request.instanceGroup = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&instance_group=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.ListRegionInstanceGroupsRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.ListRegionInstanceGroupsRequest', ['region']);
            request.region = defaultValue2;
    ...
    describe('listInstances', () => {
        it('invokes listInstances without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.ListInstancesRegionInstanceGroupsRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.ListInstancesRegionInstanceGroupsRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.ListInstancesRegionInstanceGroupsRequest', ['instanceGroup']);
            request.instanceGroup = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&instance_group=${defaultValue3}`;const expectedResponse = [
