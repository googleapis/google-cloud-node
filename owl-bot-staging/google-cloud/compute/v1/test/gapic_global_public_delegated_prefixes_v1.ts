...
describe('v1.GlobalPublicDelegatedPrefixesClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = globalpublicdelegatedprefixesModule.v1.GlobalPublicDelegatedPrefixesClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = globalpublicdelegatedprefixesModule.v1.GlobalPublicDelegatedPrefixesClient.apiEndpoint;
            assert(apiEndpoint);
        });

        it('has port', () => {
            const port = globalpublicdelegatedprefixesModule.v1.GlobalPublicDelegatedPrefixesClient.port;
            assert(port);
            assert(typeof port === 'number');
        });

        it('should create a client with no option', () => {
            const client = new globalpublicdelegatedprefixesModule.v1.GlobalPublicDelegatedPrefixesClient();
            assert(client);
        });
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.DeleteGlobalPublicDelegatedPrefixeRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.DeleteGlobalPublicDelegatedPrefixeRequest', ['publicDelegatedPrefix']);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetGlobalPublicDelegatedPrefixeRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetGlobalPublicDelegatedPrefixeRequest', ['publicDelegatedPrefix']);
            request.publicDelegatedPrefix = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&public_delegated_prefix=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes get without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.get(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.IPublicDelegatedPrefix|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.InsertGlobalPublicDelegatedPrefixeRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.PatchGlobalPublicDelegatedPrefixeRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.PatchGlobalPublicDelegatedPrefixeRequest', ['publicDelegatedPrefix']);
            request.publicDelegatedPrefix = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&public_delegated_prefix=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.ListGlobalPublicDelegatedPrefixesRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.compute.v1.PublicDelegatedPrefix()),
              generateSampleMessage(new protos.google.cloud.compute.v1.PublicDelegatedPrefix()),
              generateSampleMessage(new protos.google.cloud.compute.v1.PublicDelegatedPrefix()),
            ];
        ...
        it('invokes listStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.compute.v1.PublicDelegatedPrefix) => {
