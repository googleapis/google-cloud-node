...
describe('v1.InterconnectLocationsClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = interconnectlocationsModule.v1.InterconnectLocationsClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = interconnectlocationsModule.v1.InterconnectLocationsClient.apiEndpoint;
            assert(apiEndpoint);
        });

        it('has port', () => {
            const port = interconnectlocationsModule.v1.InterconnectLocationsClient.port;
            assert(port);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetInterconnectLocationRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetInterconnectLocationRequest', ['interconnectLocation']);
            request.interconnectLocation = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&interconnect_location=${defaultValue2}`;
        ...
        it('invokes get without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.get(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.IInterconnectLocation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.ListInterconnectLocationsRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.compute.v1.InterconnectLocation()),
              generateSampleMessage(new protos.google.cloud.compute.v1.InterconnectLocation()),
              generateSampleMessage(new protos.google.cloud.compute.v1.InterconnectLocation()),
            ];
        ...
        it('invokes listStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.compute.v1.InterconnectLocation) => {
