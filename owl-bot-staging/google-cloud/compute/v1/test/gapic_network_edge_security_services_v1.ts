...
import * as networkedgesecurityservicesModule from '../src';
...
describe('v1.NetworkEdgeSecurityServicesClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = networkedgesecurityservicesModule.v1.NetworkEdgeSecurityServicesClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = networkedgesecurityservicesModule.v1.NetworkEdgeSecurityServicesClient.apiEndpoint;
            assert(apiEndpoint);
        });

        it('has port', () => {
            const port = networkedgesecurityservicesModule.v1.NetworkEdgeSecurityServicesClient.port;
            assert(port);
            assert(typeof port === 'number');
        });

        it('should create a client with no option', () => {
            const client = new networkedgesecurityservicesModule.v1.NetworkEdgeSecurityServicesClient();
            assert(client);
        });
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.DeleteNetworkEdgeSecurityServiceRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.DeleteNetworkEdgeSecurityServiceRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.DeleteNetworkEdgeSecurityServiceRequest', ['networkEdgeSecurityService']);
            request.networkEdgeSecurityService = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&network_edge_security_service=${defaultValue3}`;
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetNetworkEdgeSecurityServiceRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetNetworkEdgeSecurityServiceRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetNetworkEdgeSecurityServiceRequest', ['networkEdgeSecurityService']);
            request.networkEdgeSecurityService = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&network_edge_security_service=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.NetworkEdgeSecurityService()
            );
        ...
        it('invokes get without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.get(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.INetworkEdgeSecurityService|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.InsertNetworkEdgeSecurityServiceRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.InsertNetworkEdgeSecurityServiceRequest', ['region']);
            request.region = defaultValue2;
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.PatchNetworkEdgeSecurityServiceRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.PatchNetworkEdgeSecurityServiceRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.PatchNetworkEdgeSecurityServiceRequest', ['networkEdgeSecurityService']);
            request.networkEdgeSecurityService = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&network_edge_security_service=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('aggregatedList', () => {
        ...
        it('uses async iteration with aggregatedList without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.AggregatedListNetworkEdgeSecurityServicesRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1}`;
            const expectedResponse = [
              ['tuple_key_1', generateSampleMessage(new protos.google.cloud.compute.v1.NetworkEdgeSecurityServicesScopedList())],
              ['tuple_key_2', generateSampleMessage(new protos.google.cloud.compute.v1.NetworkEdgeSecurityServicesScopedList())],
              ['tuple_key_3', generateSampleMessage(new protos.google.cloud.compute.v1.NetworkEdgeSecurityServicesScopedList())],
            ];
            client.descriptors.page.aggregatedList.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: Array<[string, protos.google.cloud.compute.v1.INetworkEdgeSecurityServicesScopedList]> = [];
