...
describe('v1.ExternalVpnGatewaysClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = externalvpngatewaysModule.v1.ExternalVpnGatewaysClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = externalvpngatewaysModule.v1.ExternalVpnGatewaysClient.apiEndpoint;
            assert(apiEndpoint);
        });
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.DeleteExternalVpnGatewayRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.DeleteExternalVpnGatewayRequest', ['externalVpnGateway']);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetExternalVpnGatewayRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetExternalVpnGatewayRequest', ['externalVpnGateway']);
            request.externalVpnGateway = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&external_vpn_gateway=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes get without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.get(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.IExternalVpnGateway|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.InsertExternalVpnGatewayRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('setLabels', () => {
        it('invokes setLabels without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.SetLabelsExternalVpnGatewayRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.SetLabelsExternalVpnGatewayRequest', ['resource']);
    ...
    describe('testIamPermissions', () => {
        it('invokes testIamPermissions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.TestIamPermissionsExternalVpnGatewayRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.TestIamPermissionsExternalVpnGatewayRequest', ['resource']);
            request.resource = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&resource=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.ListExternalVpnGatewaysRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.compute.v1.ExternalVpnGateway()),
              generateSampleMessage(new protos.google.cloud.compute.v1.ExternalVpnGateway()),
              generateSampleMessage(new protos.google.cloud.compute.v1.ExternalVpnGateway()),
            ];
        ...
        it('invokes listStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.compute.v1.ExternalVpnGateway[] = [];
                stream.on('data', (response: protos.google.cloud.compute.v1.ExternalVpnGateway) => {
        ...
        it('uses async iteration with list without error', async () => {
            ...
            const responses: protos.google.cloud.compute.v1.IExternalVpnGateway[] = [];
