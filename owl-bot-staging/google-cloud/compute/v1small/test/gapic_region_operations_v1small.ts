...
import * as regionoperationsModule from '../src';
...
describe('v1small.RegionOperationsClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = regionoperationsModule.v1small.RegionOperationsClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = regionoperationsModule.v1small.RegionOperationsClient.apiEndpoint;
            assert(apiEndpoint);
        });

        it('has port', () => {
            const port = regionoperationsModule.v1small.RegionOperationsClient.port;
            assert(port);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1small.GetRegionOperationRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1small.GetRegionOperationRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1small.GetRegionOperationRequest', ['operation']);
    ...
    describe('wait', () => {
        it('invokes wait without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1small.WaitRegionOperationRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1small.WaitRegionOperationRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1small.WaitRegionOperationRequest', ['operation']);
            request.operation = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&operation=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1small.Operation()
