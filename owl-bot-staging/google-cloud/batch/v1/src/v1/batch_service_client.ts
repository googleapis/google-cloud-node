...
export class BatchServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    if (opts.fallback === 'rest') {
      ...
      lroOptions.httpRules = [{selector: 'google.cloud.location.Locations.GetLocation',get: '/v1/{name=projects/*/locations/*}',},{selector: 'google.cloud.location.Locations.ListLocations',get: '/v1/{name=projects/*}/locations',},{selector: 'google.iam.v1.IAMPolicy.GetIamPolicy',get: '/v1/{resource=projects/*/locations/*/jobs/*}:getIamPolicy',additional_bindings: [{get: '/v1/{resource=projects/*/locations/*/tasks/*}:getIamPolicy',},{get: '/v1/{resource=projects/*/locations/*/nodes/*}:getIamPolicy',}],
      },{selector: 'google.iam.v1.IAMPolicy.SetIamPolicy',post: '/v1/{resource=projects/*/locations/*/jobs/*}:setIamPolicy',body: '*',additional_bindings: [{post: '/v1/{resource=projects/*/locations/*/tasks/*}:setIamPolicy',body: '*',},{post: '/v1/{resource=projects/*/locations/*/nodes/*}:setIamPolicy',body: '*',}],
      },{selector: 'google.iam.v1.IAMPolicy.TestIamPermissions',post: '/v1/{resource=projects/*/locations/*/jobs/*}:testIamPermissions',body: '*',additional_bindings: [{post: '/v1/{resource=projects/*/locations/*/tasks/*}:testIamPermissions',body: '*',},{post: '/v1/{resource=projects/*/locations/*/nodes/*}:testIamPermissions',body: '*',}],
    ...
    const deleteJobMetadata = protoFilesRoot.lookup(
      '.google.cloud.batch.v1.OperationMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.batch.v1.BatchService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.batchServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.batch.v1.BatchService') :
 ...
 */
  createJob(
      ...
      Promise<[
        ...
        protos.google.cloud.batch.v1.ICreateJobRequest|undefined, {}|undefined
      ]>;
  createJob(
      request: protos.google.cloud.batch.v1.ICreateJobRequest,
      options: CallOptions,
 ...
 */
  getJob(
      ...
      Promise<[
        protos.google.cloud.batch.v1.IJob,
        protos.google.cloud.batch.v1.IGetJobRequest|undefined, {}|undefined
      ]>;
  getJob(
      request: protos.google.cloud.batch.v1.IGetJobRequest,
      options: CallOptions,
 ...
 */
  getTask(
      ...
      Promise<[
        ...
        protos.google.cloud.batch.v1.IGetTaskRequest|undefined, {}|undefined
      ]>;
  getTask(
      request: protos.google.cloud.batch.v1.IGetTaskRequest,
      options: CallOptions,
 ...
 * region_tag:batch_v1_generated_BatchService_DeleteJob_async
 */
  async checkDeleteJobProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.batch.v1.OperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.protobuf.Empty, protos.google.cloud.batch.v1.OperationMetadata>;
  }
 /**
 ...
 */
  ...
  listJobs(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.batch.v1.IJob>): void;
  listJobs(
      request: protos.google.cloud.batch.v1.IListJobsRequest,
      callback: PaginationCallback<
          protos.google.cloud.batch.v1.IListJobsRequest,
 ...
 */
  ...
  listTasks(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.batch.v1.ITask>): void;
  listTasks(
      request: protos.google.cloud.batch.v1.IListTasksRequest,
      callback: PaginationCallback<
          protos.google.cloud.batch.v1.IListTasksRequest,
