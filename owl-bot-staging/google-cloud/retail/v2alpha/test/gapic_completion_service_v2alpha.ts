...
describe('v2alpha.CompletionServiceClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = completionserviceModule.v2alpha.CompletionServiceClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = completionserviceModule.v2alpha.CompletionServiceClient.apiEndpoint;
            assert(apiEndpoint);
        });
    ...
    describe('completeQuery', () => {
        it('invokes completeQuery without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.CompleteQueryRequest', ['catalog']);
        ...
        it('invokes completeQuery without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.completeQuery(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2alpha.ICompleteQueryResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('importCompletionData', () => {
        it('invokes importCompletionData without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.ImportCompletionDataRequest', ['parent']);
        ...
        it('invokes importCompletionData without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.importCompletionData(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.retail.v2alpha.IImportCompletionDataResponse, protos.google.cloud.retail.v2alpha.IImportMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.retail.v2alpha.IImportCompletionDataResponse, protos.google.cloud.retail.v2alpha.IImportMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importCompletionData as SinonStub)
                .getCall(0).args[0];
