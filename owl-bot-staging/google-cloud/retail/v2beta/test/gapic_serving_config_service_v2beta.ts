...
describe('v2beta.ServingConfigServiceClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = servingconfigserviceModule.v2beta.ServingConfigServiceClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = servingconfigserviceModule.v2beta.ServingConfigServiceClient.apiEndpoint;
            assert(apiEndpoint);
        });

        it('has port', () => {
            const port = servingconfigserviceModule.v2beta.ServingConfigServiceClient.port;
            assert(port);
            assert(typeof port === 'number');
        });

        it('should create a client with no option', () => {
            const client = new servingconfigserviceModule.v2beta.ServingConfigServiceClient();
            assert(client);
        });
    ...
    describe('createServingConfig', () => {
        it('invokes createServingConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.CreateServingConfigRequest', ['parent']);
        ...
        it('invokes createServingConfig without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createServingConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2beta.IServingConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deleteServingConfig', () => {
        it('invokes deleteServingConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.DeleteServingConfigRequest', ['name']);
    ...
    describe('updateServingConfig', () => {
        it('invokes updateServingConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.UpdateServingConfigRequest', ['servingConfig', 'name']);
    ...
    describe('getServingConfig', () => {
        it('invokes getServingConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.GetServingConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2beta.ServingConfig()
    ...
    describe('addControl', () => {
        it('invokes addControl without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.AddControlRequest', ['servingConfig']);
    ...
    describe('removeControl', () => {
        it('invokes removeControl without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.RemoveControlRequest', ['servingConfig']);
            request.servingConfig = defaultValue1;
            const expectedHeaderRequestParams = `serving_config=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2beta.ServingConfig()
    ...
    describe('listServingConfigs', () => {
        it('invokes listServingConfigs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.ListServingConfigsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.retail.v2beta.ServingConfig()),
              generateSampleMessage(new protos.google.cloud.retail.v2beta.ServingConfig()),
              generateSampleMessage(new protos.google.cloud.retail.v2beta.ServingConfig()),
            ];
        ...
        it('invokes listServingConfigsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.retail.v2beta.ServingConfig[] = [];
                stream.on('data', (response: protos.google.cloud.retail.v2beta.ServingConfig) => {
        ...
        it('uses async iteration with listServingConfigs without error', async () => {
            ...
            const responses: protos.google.cloud.retail.v2beta.IServingConfig[] = [];
