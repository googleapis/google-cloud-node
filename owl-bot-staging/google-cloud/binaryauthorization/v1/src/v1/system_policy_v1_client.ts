 ...
 * `src/v1/system_policy_v1_client_config.json`.
 ...
 * @memberof v1
 */
export class SystemPolicyV1Client {
  ...
  systemPolicyV1Stub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.binaryauthorization.v1.SystemPolicyV1', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.systemPolicyV1Stub) {
      return this.systemPolicyV1Stub;
    }

    // Put together the "service stub" for
    // google.cloud.binaryauthorization.v1.SystemPolicyV1.
    this.systemPolicyV1Stub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.binaryauthorization.v1.SystemPolicyV1') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.binaryauthorization.v1.SystemPolicyV1,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const systemPolicyV1StubMethods =
        ['getSystemPolicy'];
    for (const methodName of systemPolicyV1StubMethods) {
      const callPromise = this.systemPolicyV1Stub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 */
  getSystemPolicy(
      ...
      Promise<[
        ...
        protos.google.cloud.binaryauthorization.v1.IGetSystemPolicyRequest|undefined, {}|undefined
      ]>;
  getSystemPolicy(
      request: protos.google.cloud.binaryauthorization.v1.IGetSystemPolicyRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.binaryauthorization.v1.IPolicy,
          protos.google.cloud.binaryauthorization.v1.IGetSystemPolicyRequest|null|undefined,
          {}|null|undefined>): void;
  getSystemPolicy(
      request: protos.google.cloud.binaryauthorization.v1.IGetSystemPolicyRequest,
      callback: Callback<
   ...
   */
  close(): Promise<void> {
    if (this.systemPolicyV1Stub && !this._terminated) {
      return this.systemPolicyV1Stub.then(stub => {
