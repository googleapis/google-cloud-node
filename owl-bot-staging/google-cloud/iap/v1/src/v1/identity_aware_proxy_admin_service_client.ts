...
export class IdentityAwareProxyAdminServiceClient {
  ...
  initialize() {
    ...
    const identityAwareProxyAdminServiceStubMethods =
        ['setIamPolicy', 'getIamPolicy', 'testIamPermissions', 'getIapSettings', 'updateIapSettings', 'listTunnelDestGroups', 'createTunnelDestGroup', 'getTunnelDestGroup', 'deleteTunnelDestGroup', 'updateTunnelDestGroup'];
