...
function main(parent) {
  // [START timeseriesinsights_v1_generated_TimeseriesInsightsController_ListDataSets_async]
  /**
  ...
  async function callListDataSets() {
    ...
    // Run request
    const iterable = await timeseriesinsightsClient.listDataSetsAsync(request);
  ...
  callListDataSets();
  // [END timeseriesinsights_v1_generated_TimeseriesInsightsController_ListDataSets_async]
}
