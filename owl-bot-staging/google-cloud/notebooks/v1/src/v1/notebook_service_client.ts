...
export class NotebookServiceClient {
  ...
  initialize() {
    ...
    const notebookServiceStubMethods =
        ['listInstances', 'getInstance', 'createInstance', 'registerInstance', 'setInstanceAccelerator', 'setInstanceMachineType', 'updateInstanceConfig', 'updateShieldedInstanceConfig', 'setInstanceLabels', 'updateInstanceMetadataItems', 'deleteInstance', 'startInstance', 'stopInstance', 'resetInstance', 'reportInstanceInfo', 'isInstanceUpgradeable', 'getInstanceHealth', 'upgradeInstance', 'rollbackInstance', 'upgradeInstanceInternal', 'listEnvironments', 'getEnvironment', 'createEnvironment', 'deleteEnvironment', 'listSchedules', 'getSchedule', 'deleteSchedule', 'createSchedule', 'triggerSchedule', 'listExecutions', 'getExecution', 'deleteExecution', 'createExecution'];
