...
export class ManagedNotebookServiceClient {
  ...
  initialize() {
    ...
    const managedNotebookServiceStubMethods =
        ['listRuntimes', 'getRuntime', 'createRuntime', 'deleteRuntime', 'startRuntime', 'stopRuntime', 'switchRuntime', 'resetRuntime', 'reportRuntimeEvent', 'refreshRuntimeTokenInternal'];
