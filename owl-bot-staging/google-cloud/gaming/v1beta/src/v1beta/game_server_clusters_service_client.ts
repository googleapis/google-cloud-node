...
export class GameServerClustersServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof GameServerClustersServiceClient;
    ...
    this.descriptors.page = {
      listGameServerClusters:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'gameServerClusters')
    };
    ...
    this.descriptors.longrunning = {
      createGameServerCluster: new this._gaxModule.LongrunningDescriptor(
        ...
        createGameServerClusterResponse.decode.bind(createGameServerClusterResponse),
        createGameServerClusterMetadata.decode.bind(createGameServerClusterMetadata)),
      deleteGameServerCluster: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        deleteGameServerClusterResponse.decode.bind(deleteGameServerClusterResponse),
        deleteGameServerClusterMetadata.decode.bind(deleteGameServerClusterMetadata)),
      updateGameServerCluster: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        updateGameServerClusterResponse.decode.bind(updateGameServerClusterResponse),
        updateGameServerClusterMetadata.decode.bind(updateGameServerClusterMetadata))
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.gaming.v1beta.GameServerClustersService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.gameServerClustersServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.gaming.v1beta.GameServerClustersService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.gaming.v1beta.GameServerClustersService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const gameServerClustersServiceStubMethods =
        ['listGameServerClusters', 'getGameServerCluster', 'createGameServerCluster', 'previewCreateGameServerCluster', 'deleteGameServerCluster', 'previewDeleteGameServerCluster', 'updateGameServerCluster', 'previewUpdateGameServerCluster'];
 ...
 */
  getGameServerCluster(
      ...
      Promise<[
        ...
        protos.google.cloud.gaming.v1beta.IGetGameServerClusterRequest|undefined, {}|undefined
      ]>;
  getGameServerCluster(
      request: protos.google.cloud.gaming.v1beta.IGetGameServerClusterRequest,
      options: CallOptions,
 ...
 */
  previewDeleteGameServerCluster(
      ...
      Promise<[
        ...
        protos.google.cloud.gaming.v1beta.IPreviewDeleteGameServerClusterRequest|undefined, {}|undefined
      ]>;
  previewDeleteGameServerCluster(
      request: protos.google.cloud.gaming.v1beta.IPreviewDeleteGameServerClusterRequest,
      options: CallOptions,
 ...
 */
  async checkCreateGameServerClusterProgress(name: string): Promise<LROperation<protos.google.cloud.gaming.v1beta.GameServerCluster, protos.google.cloud.gaming.v1beta.OperationMetadata>>{
    ...
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.createGameServerCluster, this._gaxModule.createDefaultBackoffSettings());
 ...
 */
  ...
  deleteGameServerCluster(
    ...
    this.initialize();
    return this.innerApiCalls.deleteGameServerCluster(request, options, callback);
  }
/**
 ...
 */
  async checkDeleteGameServerClusterProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.gaming.v1beta.OperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.deleteGameServerCluster, this._gaxModule.createDefaultBackoffSettings());
 ...
 */
  async checkUpdateGameServerClusterProgress(name: string): Promise<LROperation<protos.google.cloud.gaming.v1beta.GameServerCluster, protos.google.cloud.gaming.v1beta.OperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.updateGameServerCluster, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.gaming.v1beta.GameServerCluster, protos.google.cloud.gaming.v1beta.OperationMetadata>;
  }
 /**
 ...
 */
  ...
  listGameServerClusters(
    ...
    this.initialize();
    return this.innerApiCalls.listGameServerClusters(request, options, callback);
  }
