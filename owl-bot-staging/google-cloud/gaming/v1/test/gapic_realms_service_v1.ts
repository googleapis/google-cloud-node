...
describe('v1.RealmsServiceClient', () => {
    ...
    describe('getRealm', () => {
        it('invokes getRealm without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1.GetRealmRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getRealm as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getRealm as SinonStub)
        ...
        it('invokes getRealm without error using callback', async () => {
            ...
            client.innerApiCalls.getRealm = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getRealm(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.gaming.v1.IRealm|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('previewRealmUpdate', () => {
        it('invokes previewRealmUpdate without error', async () => {
            ...
            request.realm ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1.PreviewRealmUpdateRequest', ['realm', 'name']);
            ...
            client.innerApiCalls.previewRealmUpdate = stubSimpleCall(expectedResponse);
            const [response] = await client.previewRealmUpdate(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.previewRealmUpdate as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.previewRealmUpdate as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes previewRealmUpdate without error using callback', async () => {
            ...
            client.innerApiCalls.previewRealmUpdate = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.previewRealmUpdate(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.gaming.v1.IPreviewRealmUpdateResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes previewRealmUpdate with error', async () => {
            ...
            const expectedHeaderRequestParams = `realm.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.previewRealmUpdate = stubSimpleCall(undefined, expectedError);
    ...
    describe('createRealm', () => {
        it('invokes createRealm without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1.CreateRealmRequest', ['parent']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createRealm as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createRealm as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createRealm without error using callback', async () => {
            ...
            client.innerApiCalls.createRealm = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createRealm(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.gaming.v1.IRealm, protos.google.cloud.gaming.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.gaming.v1.IRealm, protos.google.cloud.gaming.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createRealm as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createRealm with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createRealm = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes createRealm with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createRealm = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createRealm(request);
        ...
        it('invokes checkCreateRealmProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateRealmProgress(expectedResponse.name);
    ...
    describe('deleteRealm', () => {
        it('invokes deleteRealm without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1.DeleteRealmRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteRealm as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteRealm as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteRealm without error using callback', async () => {
            ...
            client.innerApiCalls.deleteRealm = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteRealm(
                    request,
                    (err?: Error|null,
        ...
        it('invokes deleteRealm with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteRealm = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes deleteRealm with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteRealm = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteRealm(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteRealm as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteRealmProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteRealmProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('updateRealm', () => {
        it('invokes updateRealm without error', async () => {
            ...
            request.realm ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1.UpdateRealmRequest', ['realm', 'name']);
            request.realm.name = defaultValue1;
            const expectedHeaderRequestParams = `realm.name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateRealm as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateRealm as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateRealm without error using callback', async () => {
            ...
            client.innerApiCalls.updateRealm = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateRealm(
                    request,
                    (err?: Error|null,
        ...
        it('invokes updateRealm with call error', async () => {
            ...
            const expectedHeaderRequestParams = `realm.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateRealm = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes updateRealm with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `realm.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateRealm = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateRealm(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateRealm as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateRealmProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateRealmProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('listRealms', () => {
        it('invokes listRealms without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1.ListRealmsRequest', ['parent']);
            request.parent = defaultValue1;
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listRealms as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listRealms as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listRealms without error using callback', async () => {
            ...
            client.innerApiCalls.listRealms = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listRealms(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.gaming.v1.IRealm[]|null) => {
        ...
        it('invokes listRealms with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listRealms = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listRealmsStream without error', async () => {
            ...
            assert((client.descriptors.page.listRealms.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listRealms, request));
            assert(
        ...
        it('invokes listRealmsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listRealms.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listRealmsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.gaming.v1.Realm[] = [];
                stream.on('data', (response: protos.google.cloud.gaming.v1.Realm) => {
        ...
        it('uses async iteration with listRealms without error', async () => {
            ...
            client.descriptors.page.listRealms.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listRealms with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listRealms.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listRealmsAsync(request);
