...
describe('v1.GameServerClustersServiceClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = gameserverclustersserviceModule.v1.GameServerClustersServiceClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = gameserverclustersserviceModule.v1.GameServerClustersServiceClient.apiEndpoint;
            assert(apiEndpoint);
        });

        it('has port', () => {
            const port = gameserverclustersserviceModule.v1.GameServerClustersServiceClient.port;
            assert(port);
            assert(typeof port === 'number');
        });

        it('should create a client with no option', () => {
            const client = new gameserverclustersserviceModule.v1.GameServerClustersServiceClient();
            assert(client);
        });
    ...
    describe('getGameServerCluster', () => {
        it('invokes getGameServerCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1.GetGameServerClusterRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.gaming.v1.GameServerCluster()
            );
            client.innerApiCalls.getGameServerCluster = stubSimpleCall(expectedResponse);
            const [response] = await client.getGameServerCluster(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getGameServerCluster as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getGameServerCluster as SinonStub)
        ...
        it('invokes getGameServerCluster without error using callback', async () => {
            ...
            client.innerApiCalls.getGameServerCluster = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getGameServerCluster(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.gaming.v1.IGameServerCluster|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getGameServerCluster with error', async () => {
            ...
            client.innerApiCalls.getGameServerCluster = stubSimpleCall(undefined, expectedError);
    ...
    describe('previewCreateGameServerCluster', () => {
        it('invokes previewCreateGameServerCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1.PreviewCreateGameServerClusterRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.gaming.v1.PreviewCreateGameServerClusterResponse()
            );
            client.innerApiCalls.previewCreateGameServerCluster = stubSimpleCall(expectedResponse);
            const [response] = await client.previewCreateGameServerCluster(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.previewCreateGameServerCluster as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.previewCreateGameServerCluster as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes previewCreateGameServerCluster without error using callback', async () => {
            ...
            client.innerApiCalls.previewCreateGameServerCluster = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.previewCreateGameServerCluster(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.gaming.v1.IPreviewCreateGameServerClusterResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes previewCreateGameServerCluster with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.previewCreateGameServerCluster = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.previewCreateGameServerCluster(request), expectedError);
            const actualRequest = (client.innerApiCalls.previewCreateGameServerCluster as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.previewCreateGameServerCluster as SinonStub)
    ...
    describe('previewDeleteGameServerCluster', () => {
        it('invokes previewDeleteGameServerCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1.PreviewDeleteGameServerClusterRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.gaming.v1.PreviewDeleteGameServerClusterResponse()
            );
            client.innerApiCalls.previewDeleteGameServerCluster = stubSimpleCall(expectedResponse);
            const [response] = await client.previewDeleteGameServerCluster(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.previewDeleteGameServerCluster as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.previewDeleteGameServerCluster as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes previewDeleteGameServerCluster without error using callback', async () => {
            ...
            client.innerApiCalls.previewDeleteGameServerCluster = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.previewDeleteGameServerCluster(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.gaming.v1.IPreviewDeleteGameServerClusterResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes previewDeleteGameServerCluster with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.previewDeleteGameServerCluster = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.previewDeleteGameServerCluster(request), expectedError);
            const actualRequest = (client.innerApiCalls.previewDeleteGameServerCluster as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.previewDeleteGameServerCluster as SinonStub)
    ...
    describe('previewUpdateGameServerCluster', () => {
        it('invokes previewUpdateGameServerCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1.PreviewUpdateGameServerClusterRequest', ['gameServerCluster', 'name']);
            request.gameServerCluster.name = defaultValue1;
            const expectedHeaderRequestParams = `game_server_cluster.name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.gaming.v1.PreviewUpdateGameServerClusterResponse()
            );
            client.innerApiCalls.previewUpdateGameServerCluster = stubSimpleCall(expectedResponse);
            const [response] = await client.previewUpdateGameServerCluster(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.previewUpdateGameServerCluster as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.previewUpdateGameServerCluster as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes previewUpdateGameServerCluster without error using callback', async () => {
            ...
            client.innerApiCalls.previewUpdateGameServerCluster = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.previewUpdateGameServerCluster(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.gaming.v1.IPreviewUpdateGameServerClusterResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes previewUpdateGameServerCluster with error', async () => {
            ...
            const expectedHeaderRequestParams = `game_server_cluster.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.previewUpdateGameServerCluster = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.previewUpdateGameServerCluster(request), expectedError);
            const actualRequest = (client.innerApiCalls.previewUpdateGameServerCluster as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.previewUpdateGameServerCluster as SinonStub)
    ...
    describe('createGameServerCluster', () => {
        it('invokes createGameServerCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1.CreateGameServerClusterRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createGameServerCluster = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createGameServerCluster(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createGameServerCluster as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createGameServerCluster as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createGameServerCluster without error using callback', async () => {
            ...
            client.innerApiCalls.createGameServerCluster = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createGameServerCluster(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.gaming.v1.IGameServerCluster, protos.google.cloud.gaming.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.gaming.v1.IGameServerCluster, protos.google.cloud.gaming.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createGameServerCluster as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createGameServerCluster with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createGameServerCluster = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createGameServerCluster(request), expectedError);
            const actualRequest = (client.innerApiCalls.createGameServerCluster as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createGameServerCluster as SinonStub)
        ...
        it('invokes createGameServerCluster with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createGameServerCluster = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createGameServerCluster(request);
        ...
        it('invokes checkCreateGameServerClusterProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateGameServerClusterProgress(expectedResponse.name);
        ...
        it('invokes checkCreateGameServerClusterProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreateGameServerClusterProgress(''), expectedError);
    ...
    describe('deleteGameServerCluster', () => {
        it('invokes deleteGameServerCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1.DeleteGameServerClusterRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteGameServerCluster = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteGameServerCluster(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteGameServerCluster as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteGameServerCluster as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteGameServerCluster without error using callback', async () => {
            ...
            client.innerApiCalls.deleteGameServerCluster = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteGameServerCluster(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.gaming.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.gaming.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteGameServerCluster as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes deleteGameServerCluster with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteGameServerCluster = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteGameServerCluster(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteGameServerCluster as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteGameServerCluster as SinonStub)
        ...
        it('invokes deleteGameServerCluster with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteGameServerCluster = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteGameServerCluster(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteGameServerCluster as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteGameServerClusterProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteGameServerClusterProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteGameServerClusterProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteGameServerClusterProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('updateGameServerCluster', () => {
        it('invokes updateGameServerCluster without error', async () => {
            ...
            request.gameServerCluster ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1.UpdateGameServerClusterRequest', ['gameServerCluster', 'name']);
            request.gameServerCluster.name = defaultValue1;
            const expectedHeaderRequestParams = `game_server_cluster.name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updateGameServerCluster = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateGameServerCluster(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateGameServerCluster as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateGameServerCluster as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateGameServerCluster without error using callback', async () => {
            ...
            client.innerApiCalls.updateGameServerCluster = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateGameServerCluster with call error', async () => {
            ...
            const expectedHeaderRequestParams = `game_server_cluster.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateGameServerCluster = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.updateGameServerCluster(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateGameServerCluster as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateGameServerCluster as SinonStub)
        ...
        it('invokes updateGameServerCluster with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `game_server_cluster.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateGameServerCluster = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateGameServerCluster(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateGameServerCluster as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateGameServerClusterProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateGameServerClusterProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateGameServerClusterProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateGameServerClusterProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listGameServerClusters', () => {
        it('invokes listGameServerClusters without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.gaming.v1.ListGameServerClustersRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.gaming.v1.GameServerCluster()),
              generateSampleMessage(new protos.google.cloud.gaming.v1.GameServerCluster()),
              generateSampleMessage(new protos.google.cloud.gaming.v1.GameServerCluster()),
            ];
            client.innerApiCalls.listGameServerClusters = stubSimpleCall(expectedResponse);
            const [response] = await client.listGameServerClusters(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listGameServerClusters as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listGameServerClusters as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listGameServerClusters without error using callback', async () => {
            ...
            client.innerApiCalls.listGameServerClusters = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listGameServerClusters with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listGameServerClusters = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listGameServerClusters(request), expectedError);
            const actualRequest = (client.innerApiCalls.listGameServerClusters as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listGameServerClusters as SinonStub)
        ...
        it('invokes listGameServerClustersStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.gaming.v1.GameServerCluster) => {
            ...
            assert((client.descriptors.page.listGameServerClusters.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listGameServerClusters, request));
            assert(
                (client.descriptors.page.listGameServerClusters.createStream as SinonStub)
        ...
        it('invokes listGameServerClustersStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listGameServerClusters.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listGameServerClustersStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.gaming.v1.GameServerCluster[] = [];
                stream.on('data', (response: protos.google.cloud.gaming.v1.GameServerCluster) => {
        ...
        it('uses async iteration with listGameServerClusters without error', async () => {
            ...
            client.descriptors.page.listGameServerClusters.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(
                (client.descriptors.page.listGameServerClusters.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listGameServerClusters with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listGameServerClusters.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listGameServerClustersAsync(request);
