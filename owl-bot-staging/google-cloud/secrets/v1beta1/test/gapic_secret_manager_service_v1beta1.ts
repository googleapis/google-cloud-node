...
describe('v1beta1.SecretManagerServiceClient', () => {
    ...
    describe('createSecret', () => {
        it('invokes createSecret without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.secrets.v1beta1.CreateSecretRequest', ['parent']);
    ...
    describe('addSecretVersion', () => {
        it('invokes addSecretVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.secrets.v1beta1.AddSecretVersionRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getSecret', () => {
        it('invokes getSecret without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.secrets.v1beta1.GetSecretRequest', ['name']);
    ...
    describe('updateSecret', () => {
        it('invokes updateSecret without error', async () => {
            ...
            request.secret ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.secrets.v1beta1.UpdateSecretRequest', ['secret', 'name']);
    ...
    describe('deleteSecret', () => {
        it('invokes deleteSecret without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.secrets.v1beta1.DeleteSecretRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getSecretVersion', () => {
        it('invokes getSecretVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.secrets.v1beta1.GetSecretVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.secrets.v1beta1.SecretVersion()
    ...
    describe('accessSecretVersion', () => {
        it('invokes accessSecretVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.secrets.v1beta1.AccessSecretVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('disableSecretVersion', () => {
        it('invokes disableSecretVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.secrets.v1beta1.DisableSecretVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.secrets.v1beta1.SecretVersion()
    ...
    describe('enableSecretVersion', () => {
        it('invokes enableSecretVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.secrets.v1beta1.EnableSecretVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.secrets.v1beta1.SecretVersion()
    ...
    describe('destroySecretVersion', () => {
        it('invokes destroySecretVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.secrets.v1beta1.DestroySecretVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.secrets.v1beta1.SecretVersion()
    ...
    describe('listSecrets', () => {
        it('invokes listSecrets without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.secrets.v1beta1.ListSecretsRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listSecretVersions', () => {
        it('invokes listSecretVersions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.secrets.v1beta1.ListSecretVersionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
