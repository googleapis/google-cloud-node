...
function main(name) {
  // [START pubsublite_v1_generated_AdminService_GetReservation_async]
  /**
  ...
  async function callGetReservation() {
    ...
    // Run request
    const response = await pubsubliteClient.getReservation(request);
    console.log(response);
  }

  callGetReservation();
  // [END pubsublite_v1_generated_AdminService_GetReservation_async]
}
