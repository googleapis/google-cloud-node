...
export class SubscriberServiceClient {
   ...
   *     const client = new SubscriberServiceClient({fallback: 'rest'}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this.descriptors.stream = {
      subscribe: new this._gaxModule.StreamDescriptor(this._gaxModule.StreamType.BIDI_STREAMING, opts.fallback === 'rest')
    };
 ...
 */
  subscribe(
    ...
    this.initialize();
    return this.innerApiCalls.subscribe(null, options);
  }
   ...
   */
  close(): Promise<void> {
    if (this.subscriberServiceStub && !this._terminated) {
