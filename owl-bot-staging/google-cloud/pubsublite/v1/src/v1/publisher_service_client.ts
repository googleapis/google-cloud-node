 ...
 * `src/v1/publisher_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './publisher_service_client_config.json';
 ...
 * @memberof v1
 */
export class PublisherServiceClient {
  ...
  publisherServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of PublisherServiceClient.
   *
   ...
   *     const client = new PublisherServiceClient({fallback: 'rest'}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof PublisherServiceClient;
    ...
    this.descriptors.stream = {
      publish: new this._gaxModule.StreamDescriptor(this._gaxModule.StreamType.BIDI_STREAMING, opts.fallback === 'rest')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.pubsublite.v1.PublisherService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.publisherServiceStub) {
      return this.publisherServiceStub;
    }

    // Put together the "service stub" for
    // google.cloud.pubsublite.v1.PublisherService.
    this.publisherServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.pubsublite.v1.PublisherService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.pubsublite.v1.PublisherService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const publisherServiceStubMethods =
        ['publish'];
    for (const methodName of publisherServiceStubMethods) {
      const callPromise = this.publisherServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   representing [PublishRequest]{@link google.cloud.pubsublite.v1.PublishRequest} for write() method, and
 *   will emit objects representing [PublishResponse]{@link google.cloud.pubsublite.v1.PublishResponse} on 'data' event asynchronously.
 *   Please see the
 ...
 */
  publish(
    ...
    this.initialize();
    return this.innerApiCalls.publish(null, options);
  }
   ...
   */
  close(): Promise<void> {
    if (this.publisherServiceStub && !this._terminated) {
      return this.publisherServiceStub.then(stub => {
