    ...
    describe('queryDirectoryContents', () => {
        it('invokes queryDirectoryContents without error', async () => {
            ...
            const expectedHeaderRequestParams = `workspace=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.QueryDirectoryContentsResponse.DirectoryEntry()),
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.QueryDirectoryContentsResponse.DirectoryEntry()),
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.QueryDirectoryContentsResponse.DirectoryEntry()),
            ];
        ...
        it('invokes queryDirectoryContents without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.queryDirectoryContents(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.QueryDirectoryContentsResponse.IDirectoryEntry[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes queryDirectoryContentsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataform.v1beta1.QueryDirectoryContentsResponse.DirectoryEntry[] = [];
                stream.on('data', (response: protos.google.cloud.dataform.v1beta1.QueryDirectoryContentsResponse.DirectoryEntry) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with queryDirectoryContents without error', async () => {
            ...
            const responses: protos.google.cloud.dataform.v1beta1.QueryDirectoryContentsResponse.IDirectoryEntry[] = [];
