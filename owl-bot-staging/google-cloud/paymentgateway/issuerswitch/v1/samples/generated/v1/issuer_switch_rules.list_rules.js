...
function main(parent) {
  // [START issuerswitch_v1_generated_IssuerSwitchRules_ListRules_async]
  /**
  ...
  async function callListRules() {
    ...
    // Run request
    const iterable = await issuerswitchClient.listRulesAsync(request);
  ...
  callListRules();
  // [END issuerswitch_v1_generated_IssuerSwitchRules_ListRules_async]
}
