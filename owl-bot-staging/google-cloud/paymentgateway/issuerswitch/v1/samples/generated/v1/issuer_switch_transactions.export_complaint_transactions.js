...
function main(parent) {
  // [START issuerswitch_v1_generated_IssuerSwitchTransactions_ExportComplaintTransactions_async]
  /**
  ...
  async function callExportComplaintTransactions() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const [operation] = await issuerswitchClient.exportComplaintTransactions(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callExportComplaintTransactions();
  // [END issuerswitch_v1_generated_IssuerSwitchTransactions_ExportComplaintTransactions_async]
}
