...
function main(parent) {
  // [START issuerswitch_v1_generated_IssuerSwitchRules_ListRuleMetadataValues_async]
  /**
  ...
  async function callListRuleMetadataValues() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = await issuerswitchClient.listRuleMetadataValuesAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListRuleMetadataValues();
  // [END issuerswitch_v1_generated_IssuerSwitchRules_ListRuleMetadataValues_async]
}
