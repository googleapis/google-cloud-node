...
function main(parent) {
  // [START issuerswitch_v1_generated_IssuerSwitchTransactions_ExportFinancialTransactions_async]
  /**
  ...
  async function callExportFinancialTransactions() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const [operation] = await issuerswitchClient.exportFinancialTransactions(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callExportFinancialTransactions();
  // [END issuerswitch_v1_generated_IssuerSwitchTransactions_ExportFinancialTransactions_async]
}
