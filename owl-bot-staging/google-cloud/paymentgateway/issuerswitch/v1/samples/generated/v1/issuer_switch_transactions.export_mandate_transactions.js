...
function main(parent) {
  // [START issuerswitch_v1_generated_IssuerSwitchTransactions_ExportMandateTransactions_async]
  /**
  ...
  async function callExportMandateTransactions() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const [operation] = await issuerswitchClient.exportMandateTransactions(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callExportMandateTransactions();
  // [END issuerswitch_v1_generated_IssuerSwitchTransactions_ExportMandateTransactions_async]
}
