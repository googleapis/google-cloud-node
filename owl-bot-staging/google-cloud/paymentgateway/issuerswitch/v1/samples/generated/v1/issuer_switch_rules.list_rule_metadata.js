...
function main(parent) {
  // [START issuerswitch_v1_generated_IssuerSwitchRules_ListRuleMetadata_async]
  /**
  ...
  async function callListRuleMetadata() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = await issuerswitchClient.listRuleMetadataAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListRuleMetadata();
  // [END issuerswitch_v1_generated_IssuerSwitchRules_ListRuleMetadata_async]
}
