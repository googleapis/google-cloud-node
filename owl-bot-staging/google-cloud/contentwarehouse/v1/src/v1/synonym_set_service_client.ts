 ...
 * `src/v1/synonym_set_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './synonym_set_service_client_config.json';
 ...
 * @memberof v1
 */
export class SynonymSetServiceClient {
 ...
 *   The first element of the array is an object representing [SynonymSet]{@link google.cloud.contentwarehouse.v1.SynonymSet}.
 *   Please see the
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [SynonymSet]{@link google.cloud.contentwarehouse.v1.SynonymSet}.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [SynonymSet]{@link google.cloud.contentwarehouse.v1.SynonymSet} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   [SynonymSet]{@link google.cloud.contentwarehouse.v1.SynonymSet}. The API will be called under the hood as needed, once per the page,
