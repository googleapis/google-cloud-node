...
describe('v1.ContactCenterInsightsClient', () => {
    ...
    describe('createConversation', () => {
        it('invokes createConversation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.CreateConversationRequest', ['parent']);
    ...
    describe('updateConversation', () => {
        it('invokes updateConversation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.UpdateConversationRequest', ['conversation', 'name']);
    ...
    describe('getConversation', () => {
        it('invokes getConversation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.GetConversationRequest', ['name']);
    ...
    describe('deleteConversation', () => {
        it('invokes deleteConversation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.DeleteConversationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getAnalysis', () => {
        it('invokes getAnalysis without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.GetAnalysisRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('deleteAnalysis', () => {
        it('invokes deleteAnalysis without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.DeleteAnalysisRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('updateIssueModel', () => {
        it('invokes updateIssueModel without error', async () => {
            ...
            request.issueModel ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.UpdateIssueModelRequest', ['issueModel', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateIssueModel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateIssueModel as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateIssueModel without error using callback', async () => {
            ...
            client.innerApiCalls.updateIssueModel = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateIssueModel with error', async () => {
            ...
            const expectedHeaderRequestParams = `issue_model.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateIssueModel = stubSimpleCall(undefined, expectedError);
    ...
    describe('getIssueModel', () => {
        it('invokes getIssueModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.GetIssueModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.contactcenterinsights.v1.IssueModel()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getIssueModel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getIssueModel as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('listIssueModels', () => {
        it('invokes listIssueModels without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.ListIssueModelsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listIssueModels as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listIssueModels as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('getIssue', () => {
        it('invokes getIssue without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.GetIssueRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listIssues', () => {
        it('invokes listIssues without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.ListIssuesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateIssue', () => {
        it('invokes updateIssue without error', async () => {
            ...
            request.issue ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.UpdateIssueRequest', ['issue', 'name']);
        ...
        it('invokes updateIssue without error using callback', async () => {
            ...
            client.innerApiCalls.updateIssue = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateIssue(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.contactcenterinsights.v1.IIssue|null) => {
        ...
        it('invokes updateIssue with error', async () => {
            ...
            const expectedHeaderRequestParams = `issue.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateIssue = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteIssue', () => {
        it('invokes deleteIssue without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.DeleteIssueRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
        ...
        it('invokes deleteIssue without error using callback', async () => {
            ...
            client.innerApiCalls.deleteIssue = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteIssue(
                    request,
                    (err?: Error|null, result?: protos.google.protobuf.IEmpty|null) => {
        ...
        it('invokes deleteIssue with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteIssue = stubSimpleCall(undefined, expectedError);
    ...
    describe('calculateIssueModelStats', () => {
        it('invokes calculateIssueModelStats without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.CalculateIssueModelStatsRequest', ['issueModel']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.calculateIssueModelStats as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.calculateIssueModelStats as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('createPhraseMatcher', () => {
        it('invokes createPhraseMatcher without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.CreatePhraseMatcherRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createPhraseMatcher as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createPhraseMatcher as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('getPhraseMatcher', () => {
        it('invokes getPhraseMatcher without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.GetPhraseMatcherRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.contactcenterinsights.v1.PhraseMatcher()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getPhraseMatcher as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getPhraseMatcher as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('deletePhraseMatcher', () => {
        it('invokes deletePhraseMatcher without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.DeletePhraseMatcherRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deletePhraseMatcher as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deletePhraseMatcher as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('updatePhraseMatcher', () => {
        it('invokes updatePhraseMatcher without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.UpdatePhraseMatcherRequest', ['phraseMatcher', 'name']);
            request.phraseMatcher.name = defaultValue1;
            const expectedHeaderRequestParams = `phrase_matcher.name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.contactcenterinsights.v1.PhraseMatcher()
            );
            client.innerApiCalls.updatePhraseMatcher = stubSimpleCall(expectedResponse);
            const [response] = await client.updatePhraseMatcher(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updatePhraseMatcher as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updatePhraseMatcher as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updatePhraseMatcher without error using callback', async () => {
            ...
            client.innerApiCalls.updatePhraseMatcher = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updatePhraseMatcher with error', async () => {
            ...
            const expectedHeaderRequestParams = `phrase_matcher.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updatePhraseMatcher = stubSimpleCall(undefined, expectedError);
    ...
    describe('calculateStats', () => {
        it('invokes calculateStats without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.CalculateStatsRequest', ['location']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.calculateStats as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.calculateStats as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('getSettings', () => {
        it('invokes getSettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.GetSettingsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateSettings', () => {
        it('invokes updateSettings without error', async () => {
            ...
            request.settings ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.UpdateSettingsRequest', ['settings', 'name']);
    ...
    describe('createView', () => {
        it('invokes createView without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.CreateViewRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes createView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createView(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.contactcenterinsights.v1.IView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getView', () => {
        it('invokes getView without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.GetViewRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.contactcenterinsights.v1.View()
    ...
    describe('updateView', () => {
        it('invokes updateView without error', async () => {
            ...
            request.view ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.UpdateViewRequest', ['view', 'name']);
    ...
    describe('deleteView', () => {
        it('invokes deleteView without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.DeleteViewRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('createAnalysis', () => {
        it('invokes createAnalysis without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.CreateAnalysisRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('bulkAnalyzeConversations', () => {
        it('invokes bulkAnalyzeConversations without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.BulkAnalyzeConversationsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.bulkAnalyzeConversations = stubLongRunningCall(expectedResponse);
            const [operation] = await client.bulkAnalyzeConversations(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.bulkAnalyzeConversations as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.bulkAnalyzeConversations as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes bulkAnalyzeConversations without error using callback', async () => {
            ...
            client.innerApiCalls.bulkAnalyzeConversations = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.bulkAnalyzeConversations(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.contactcenterinsights.v1.IBulkAnalyzeConversationsResponse, protos.google.cloud.contactcenterinsights.v1.IBulkAnalyzeConversationsMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.contactcenterinsights.v1.IBulkAnalyzeConversationsResponse, protos.google.cloud.contactcenterinsights.v1.IBulkAnalyzeConversationsMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.bulkAnalyzeConversations as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes bulkAnalyzeConversations with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.bulkAnalyzeConversations = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.bulkAnalyzeConversations(request), expectedError);
            const actualRequest = (client.innerApiCalls.bulkAnalyzeConversations as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.bulkAnalyzeConversations as SinonStub)
        ...
        it('invokes bulkAnalyzeConversations with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.bulkAnalyzeConversations = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.bulkAnalyzeConversations(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.bulkAnalyzeConversations as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkBulkAnalyzeConversationsProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkBulkAnalyzeConversationsProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkBulkAnalyzeConversationsProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkBulkAnalyzeConversationsProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('ingestConversations', () => {
        it('invokes ingestConversations without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.IngestConversationsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.ingestConversations = stubLongRunningCall(expectedResponse);
            const [operation] = await client.ingestConversations(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.ingestConversations as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.ingestConversations as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes ingestConversations without error using callback', async () => {
            ...
            client.innerApiCalls.ingestConversations = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.ingestConversations(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.contactcenterinsights.v1.IIngestConversationsResponse, protos.google.cloud.contactcenterinsights.v1.IIngestConversationsMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.contactcenterinsights.v1.IIngestConversationsResponse, protos.google.cloud.contactcenterinsights.v1.IIngestConversationsMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.ingestConversations as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes ingestConversations with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.ingestConversations = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes ingestConversations with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.ingestConversations = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.ingestConversations(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.ingestConversations as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkIngestConversationsProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkIngestConversationsProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkIngestConversationsProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkIngestConversationsProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('exportInsightsData', () => {
        it('invokes exportInsightsData without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.ExportInsightsDataRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportInsightsData as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.exportInsightsData as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('createIssueModel', () => {
        it('invokes createIssueModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.CreateIssueModelRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createIssueModel = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createIssueModel(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createIssueModel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createIssueModel as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createIssueModel without error using callback', async () => {
            ...
            client.innerApiCalls.createIssueModel = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createIssueModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.contactcenterinsights.v1.IIssueModel, protos.google.cloud.contactcenterinsights.v1.ICreateIssueModelMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.contactcenterinsights.v1.IIssueModel, protos.google.cloud.contactcenterinsights.v1.ICreateIssueModelMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createIssueModel as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createIssueModel with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createIssueModel = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes createIssueModel with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createIssueModel = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createIssueModel(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.createIssueModel as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkCreateIssueModelProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkCreateIssueModelProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkCreateIssueModelProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkCreateIssueModelProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteIssueModel', () => {
        it('invokes deleteIssueModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.DeleteIssueModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteIssueModel = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteIssueModel(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteIssueModel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteIssueModel as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteIssueModel without error using callback', async () => {
            ...
            client.innerApiCalls.deleteIssueModel = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteIssueModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.contactcenterinsights.v1.IDeleteIssueModelMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.contactcenterinsights.v1.IDeleteIssueModelMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteIssueModel as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes deleteIssueModel with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteIssueModel = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes deleteIssueModel with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteIssueModel = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteIssueModel(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteIssueModel as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteIssueModelProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteIssueModelProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteIssueModelProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteIssueModelProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deployIssueModel', () => {
        it('invokes deployIssueModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.DeployIssueModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deployIssueModel = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deployIssueModel(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deployIssueModel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deployIssueModel as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deployIssueModel without error using callback', async () => {
            ...
            client.innerApiCalls.deployIssueModel = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deployIssueModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.contactcenterinsights.v1.IDeployIssueModelResponse, protos.google.cloud.contactcenterinsights.v1.IDeployIssueModelMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.contactcenterinsights.v1.IDeployIssueModelResponse, protos.google.cloud.contactcenterinsights.v1.IDeployIssueModelMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deployIssueModel as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes deployIssueModel with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deployIssueModel = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes deployIssueModel with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deployIssueModel = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deployIssueModel(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deployIssueModel as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeployIssueModelProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeployIssueModelProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeployIssueModelProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeployIssueModelProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('undeployIssueModel', () => {
        it('invokes undeployIssueModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.UndeployIssueModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.undeployIssueModel = stubLongRunningCall(expectedResponse);
            const [operation] = await client.undeployIssueModel(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.undeployIssueModel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.undeployIssueModel as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes undeployIssueModel without error using callback', async () => {
            ...
            client.innerApiCalls.undeployIssueModel = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.undeployIssueModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.contactcenterinsights.v1.IUndeployIssueModelResponse, protos.google.cloud.contactcenterinsights.v1.IUndeployIssueModelMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.contactcenterinsights.v1.IUndeployIssueModelResponse, protos.google.cloud.contactcenterinsights.v1.IUndeployIssueModelMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.undeployIssueModel as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes undeployIssueModel with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.undeployIssueModel = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes undeployIssueModel with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.undeployIssueModel = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.undeployIssueModel(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.undeployIssueModel as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUndeployIssueModelProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUndeployIssueModelProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUndeployIssueModelProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUndeployIssueModelProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listConversations', () => {
        it('invokes listConversations without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.ListConversationsRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listAnalyses', () => {
        it('invokes listAnalyses without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.ListAnalysesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('listPhraseMatchers', () => {
        it('invokes listPhraseMatchers without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.ListPhraseMatchersRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listPhraseMatchers as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listPhraseMatchers as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('listViews', () => {
        it('invokes listViews without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.contactcenterinsights.v1.ListViewsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.contactcenterinsights.v1.View()),
              generateSampleMessage(new protos.google.cloud.contactcenterinsights.v1.View()),
              generateSampleMessage(new protos.google.cloud.contactcenterinsights.v1.View()),
            ];
        ...
        it('invokes listViewsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.contactcenterinsights.v1.View) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('Path templates', () => {
        ...
        describe('view', () => {
            ...
            client.initialize();
            client.pathTemplates.viewPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.viewPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('viewPath', () => {
                const result = client.viewPath("projectValue", "locationValue", "viewValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.viewPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromViewName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.viewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
