...
export class DocumentUnderstandingServiceClient {
   ...
   *     const client = new DocumentUnderstandingServiceClient({fallback: 'rest'}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    if (opts.fallback === 'rest') {
      ...
      lroOptions.httpRules = [{selector: 'google.cloud.location.Locations.GetLocation',get: '/uiv1beta3/{name=projects/*/locations/*}',},{selector: 'google.cloud.location.Locations.ListLocations',get: '/uiv1beta3/{name=projects/*}/locations',},{selector: 'google.longrunning.Operations.CancelOperation',post: '/uiv1beta3/{name=projects/*/locations/*/operations/*}:cancel',},{selector: 'google.longrunning.Operations.GetOperation',get: '/v1beta2/{name=projects/*/operations/*}',additional_bindings: [{get: '/v1beta2/{name=projects/*/locations/*/operations/*}',},{get: '/uiv1beta3/{name=projects/*/locations/*/operations/*}',}],
 ...
 *   The first element of the array is an object representing {@link protos.google.cloud.documentai.v1beta2.Document|Document}.
