...
describe('v1.EkmServiceClient', () => {
    ...
    describe('getEkmConnection', () => {
        it('invokes getEkmConnection without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.kms.v1.EkmConnection());
            ...
            assert((client.innerApiCalls.getEkmConnection as SinonStub)
    ...
    describe('createEkmConnection', () => {
        it('invokes createEkmConnection without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.kms.v1.CreateEkmConnectionRequest());
            request.parent = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createEkmConnection as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateEkmConnection', () => {
        it('invokes updateEkmConnection without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.kms.v1.UpdateEkmConnectionRequest());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateEkmConnection as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listEkmConnections', () => {
        it('invokes listEkmConnections without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.kms.v1.ListEkmConnectionsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listEkmConnections as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
