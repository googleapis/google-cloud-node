...
describe('v1.KeyManagementServiceClient', () => {
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new keymanagementserviceModule.v1.KeyManagementServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
    ...
    describe('rawEncrypt', () => {
        it('invokes rawEncrypt without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.kms.v1.RawEncryptRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.rawEncrypt as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.rawEncrypt as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes rawEncrypt without error using callback', async () => {
            ...
            client.innerApiCalls.rawEncrypt = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.rawEncrypt(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.kms.v1.IRawEncryptResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes rawEncrypt with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.rawEncrypt = stubSimpleCall(undefined, expectedError);
    ...
    describe('rawDecrypt', () => {
        it('invokes rawDecrypt without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.kms.v1.RawDecryptRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.rawDecrypt as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.rawDecrypt as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes rawDecrypt without error using callback', async () => {
            ...
            client.innerApiCalls.rawDecrypt = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.rawDecrypt(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.kms.v1.IRawDecryptResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes rawDecrypt with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.rawDecrypt = stubSimpleCall(undefined, expectedError);
    ...
    describe('macSign', () => {
        it('invokes macSign without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.kms.v1.MacSignRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.macSign as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.macSign as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes macSign without error using callback', async () => {
            ...
            client.innerApiCalls.macSign = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.macSign(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.kms.v1.IMacSignResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('macVerify', () => {
        it('invokes macVerify without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.kms.v1.MacVerifyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.macVerify as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.macVerify as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes macVerify without error using callback', async () => {
            ...
            client.innerApiCalls.macVerify = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.macVerify(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.kms.v1.IMacVerifyResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateRandomBytes', () => {
        it('invokes generateRandomBytes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.kms.v1.GenerateRandomBytesRequest', ['location']);
            ...
            client.innerApiCalls.generateRandomBytes = stubSimpleCall(expectedResponse);
            const [response] = await client.generateRandomBytes(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.generateRandomBytes as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateRandomBytes as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes generateRandomBytes without error using callback', async () => {
            ...
            client.innerApiCalls.generateRandomBytes = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.generateRandomBytes(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.kms.v1.IGenerateRandomBytesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes generateRandomBytes with error', async () => {
            ...
            const expectedHeaderRequestParams = `location=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.generateRandomBytes = stubSimpleCall(undefined, expectedError);
