...
describe('v1.KeyManagementServiceClient', () => {
    ...
    describe('macSign', () => {
        it('invokes macSign without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.kms.v1.MacSignRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.kms.v1.MacSignResponse());
            client.innerApiCalls.macSign = stubSimpleCall(expectedResponse);
            const [response] = await client.macSign(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.macSign as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('macVerify', () => {
        it('invokes macVerify without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.kms.v1.MacVerifyRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.kms.v1.MacVerifyResponse());
            client.innerApiCalls.macVerify = stubSimpleCall(expectedResponse);
            const [response] = await client.macVerify(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.macVerify as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('generateRandomBytes', () => {
        it('invokes generateRandomBytes without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.kms.v1.GenerateRandomBytesRequest());
            request.location = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.kms.v1.GenerateRandomBytesResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.generateRandomBytes as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
