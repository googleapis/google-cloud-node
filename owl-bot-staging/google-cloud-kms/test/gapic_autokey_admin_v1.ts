...
describe('v1.AutokeyAdminClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = autokeyadminModule.v1.AutokeyAdminClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = autokeyadminModule.v1.AutokeyAdminClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'cloudkms.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new autokeyadminModule.v1.AutokeyAdminClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'cloudkms.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new autokeyadminModule.v1.AutokeyAdminClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'cloudkms.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new autokeyadminModule.v1.AutokeyAdminClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new autokeyadminModule.v1.AutokeyAdminClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('updateAutokeyConfig', () => {
        it('invokes updateAutokeyConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.kms.v1.UpdateAutokeyConfigRequest', ['autokeyConfig', 'name']);
            ...
            client.innerApiCalls.updateAutokeyConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.updateAutokeyConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateAutokeyConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateAutokeyConfig as SinonStub)
        ...
        it('invokes updateAutokeyConfig without error using callback', async () => {
            ...
            client.innerApiCalls.updateAutokeyConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateAutokeyConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.kms.v1.IAutokeyConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes updateAutokeyConfig with error', async () => {
            ...
            client.innerApiCalls.updateAutokeyConfig = stubSimpleCall(undefined, expectedError);
    ...
    describe('getAutokeyConfig', () => {
        it('invokes getAutokeyConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.kms.v1.GetAutokeyConfigRequest', ['name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getAutokeyConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getAutokeyConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getAutokeyConfig without error using callback', async () => {
            ...
            client.innerApiCalls.getAutokeyConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getAutokeyConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getAutokeyConfig = stubSimpleCall(undefined, expectedError);
    ...
    describe('showEffectiveAutokeyConfig', () => {
        it('invokes showEffectiveAutokeyConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.kms.v1.ShowEffectiveAutokeyConfigRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.kms.v1.ShowEffectiveAutokeyConfigResponse()
            );
            client.innerApiCalls.showEffectiveAutokeyConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.showEffectiveAutokeyConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.showEffectiveAutokeyConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.showEffectiveAutokeyConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes showEffectiveAutokeyConfig without error using callback', async () => {
            ...
            client.innerApiCalls.showEffectiveAutokeyConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.showEffectiveAutokeyConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.kms.v1.IShowEffectiveAutokeyConfigResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes showEffectiveAutokeyConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.showEffectiveAutokeyConfig = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.showEffectiveAutokeyConfig(request), expectedError);
            const actualRequest = (client.innerApiCalls.showEffectiveAutokeyConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.showEffectiveAutokeyConfig as SinonStub)
