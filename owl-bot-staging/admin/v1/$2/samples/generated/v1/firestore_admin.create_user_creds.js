...
function main(parent, userCreds, userCredsId) {
  ...
  async function callCreateUserCreds() {
    // Construct request
    const request = {
      parent,
      userCreds,
    ...
    // Run request
    const response = await adminClient.createUserCreds(request);
