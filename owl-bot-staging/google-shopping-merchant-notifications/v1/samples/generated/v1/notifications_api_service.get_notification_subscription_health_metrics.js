...
function main(name) {
  ...
  async function callGetNotificationSubscriptionHealthMetrics() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await notificationsClient.getNotificationSubscriptionHealthMetrics(request);
    console.log(response);
  }

  callGetNotificationSubscriptionHealthMetrics();
