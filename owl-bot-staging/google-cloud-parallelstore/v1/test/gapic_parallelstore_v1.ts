...
describe('v1.ParallelstoreClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new parallelstoreModule.v1.ParallelstoreClient();
            const apiEndpoint = client.apiEndpoint;
            assert.strictEqual(apiEndpoint, 'parallelstore.googleapis.com');
        });
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = parallelstoreModule.v1.ParallelstoreClient.servicePath;
                assert.strictEqual(servicePath, 'parallelstore.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = parallelstoreModule.v1.ParallelstoreClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'parallelstore.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new parallelstoreModule.v1.ParallelstoreClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'parallelstore.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new parallelstoreModule.v1.ParallelstoreClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'parallelstore.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new parallelstoreModule.v1.ParallelstoreClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
                    assert.strictEqual(servicePath, 'parallelstore.configured.example.com');
                    if (saved) {
                        process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = saved;
                    } else {
                        delete process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new parallelstoreModule.v1.ParallelstoreClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = parallelstoreModule.v1.ParallelstoreClient.port;
            assert(port);
    ...
    describe('getInstance', () => {
        it('invokes getInstance without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.parallelstore.v1.GetInstanceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.parallelstore.v1.GetInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.parallelstore.v1.Instance()
            );
        ...
        it('invokes getInstance without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getInstance(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.parallelstore.v1.IInstance|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createInstance', () => {
        it('invokes createInstance without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.parallelstore.v1.CreateInstanceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.parallelstore.v1.CreateInstanceRequest', ['parent']);
        ...
        it('invokes createInstance without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createInstance(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.parallelstore.v1.IInstance, protos.google.cloud.parallelstore.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.parallelstore.v1.IInstance, protos.google.cloud.parallelstore.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createInstance as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateInstance', () => {
        it('invokes updateInstance without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.parallelstore.v1.UpdateInstanceRequest()
            );
            request.instance ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.parallelstore.v1.UpdateInstanceRequest', ['instance', 'name']);
    ...
    describe('deleteInstance', () => {
        it('invokes deleteInstance without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.parallelstore.v1.DeleteInstanceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.parallelstore.v1.DeleteInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes deleteInstance without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deleteInstance(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.parallelstore.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.parallelstore.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteInstance as SinonStub)
                .getCall(0).args[0];
    ...
    describe('importData', () => {
        it('invokes importData without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.parallelstore.v1.ImportDataRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.parallelstore.v1.ImportDataRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes importData without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.importData(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.parallelstore.v1.IImportDataResponse, protos.google.cloud.parallelstore.v1.IImportDataMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.parallelstore.v1.IImportDataResponse, protos.google.cloud.parallelstore.v1.IImportDataMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importData as SinonStub)
                .getCall(0).args[0];
    ...
    describe('exportData', () => {
        it('invokes exportData without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.parallelstore.v1.ExportDataRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.parallelstore.v1.ExportDataRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes exportData without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.exportData(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.parallelstore.v1.IExportDataResponse, protos.google.cloud.parallelstore.v1.IExportDataMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.parallelstore.v1.IExportDataResponse, protos.google.cloud.parallelstore.v1.IExportDataMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportData as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listInstances', () => {
        it('invokes listInstances without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.parallelstore.v1.ListInstancesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.parallelstore.v1.ListInstancesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.parallelstore.v1.Instance()),
              generateSampleMessage(new protos.google.cloud.parallelstore.v1.Instance()),
              generateSampleMessage(new protos.google.cloud.parallelstore.v1.Instance()),
            ];
        ...
        it('invokes listInstancesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.parallelstore.v1.Instance[] = [];
                stream.on('data', (response: protos.google.cloud.parallelstore.v1.Instance) => {
    ...
    describe('Path templates', () => {
        ...
        describe('address', () => {
            ...
            client.initialize();
            client.pathTemplates.addressPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.addressPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('addressPath', () => {
                const result = client.addressPath("projectValue", "regionValue", "addressValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.addressPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromAddressName', () => {
                const result = client.matchProjectFromAddressName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.addressPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchRegionFromAddressName', () => {
                const result = client.matchRegionFromAddressName(fakePath);
                assert.strictEqual(result, "regionValue");
                assert((client.pathTemplates.addressPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchAddressFromAddressName', () => {
                const result = client.matchAddressFromAddressName(fakePath);
                assert.strictEqual(result, "addressValue");
                assert((client.pathTemplates.addressPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
