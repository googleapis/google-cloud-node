...
# [Datasources: Nodejs Client][homepage]
...
Datasources client for Node.js
...
* [Datasources Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/datasources/latest)
* [Datasources Documentation](https://developers.google.com/merchant/api)
...
1.  [Enable the Datasources API][enable_api].
