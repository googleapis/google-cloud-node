...
describe('v1beta.FileUploadsServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new fileuploadsserviceModule.v1beta.FileUploadsServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = fileuploadsserviceModule.v1beta.FileUploadsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = fileuploadsserviceModule.v1beta.FileUploadsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new fileuploadsserviceModule.v1beta.FileUploadsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new fileuploadsserviceModule.v1beta.FileUploadsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new fileuploadsserviceModule.v1beta.FileUploadsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new fileuploadsserviceModule.v1beta.FileUploadsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = fileuploadsserviceModule.v1beta.FileUploadsServiceClient.port;
            assert(port);
    ...
    describe('getFileUpload', () => {
        it('invokes getFileUpload without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.datasources.v1beta.GetFileUploadRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getFileUpload as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getFileUpload as SinonStub)
        ...
        it('invokes getFileUpload without error using callback', async () => {
            ...
            client.innerApiCalls.getFileUpload = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getFileUpload(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.datasources.v1beta.IFileUpload|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getFileUpload with error', async () => {
            ...
            client.innerApiCalls.getFileUpload = stubSimpleCall(undefined, expectedError);
