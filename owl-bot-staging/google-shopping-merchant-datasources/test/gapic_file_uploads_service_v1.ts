...
describe('v1.FileUploadsServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          fileuploadsserviceModule.v1.FileUploadsServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          fileuploadsserviceModule.v1.FileUploadsServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new fileuploadsserviceModule.v1.FileUploadsServiceClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'merchantapi.example.com');
          if (saved) {
    ...
    it('has port', () => {
      const port = fileuploadsserviceModule.v1.FileUploadsServiceClient.port;
      assert(port);
  ...
  describe('getFileUpload', () => {
    it('invokes getFileUpload without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.shopping.merchant.datasources.v1.GetFileUploadRequest(),
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.shopping.merchant.datasources.v1.FileUpload(),
      );
    ...
    it('invokes getFileUpload without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getFileUpload(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.datasources.v1.IFileUpload | null,
          ) => {
            if (err) {
              reject(err);
            } else {
