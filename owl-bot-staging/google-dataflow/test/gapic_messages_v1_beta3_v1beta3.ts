...
describe('v1beta3.MessagesV1Beta3Client', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new messagesv1beta3Module.v1beta3.MessagesV1Beta3Client({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dataflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new messagesv1beta3Module.v1beta3.MessagesV1Beta3Client({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dataflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new messagesv1beta3Module.v1beta3.MessagesV1Beta3Client({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new messagesv1beta3Module.v1beta3.MessagesV1Beta3Client({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('listJobMessages', () => {
        it('invokes listJobMessages without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.dataflow.v1beta3.ListJobMessagesRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.dataflow.v1beta3.ListJobMessagesRequest', ['location']);
            request.location = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.dataflow.v1beta3.ListJobMessagesRequest', ['jobId']);
            ...
            const actualRequest = (client.innerApiCalls.listJobMessages as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listJobMessages as SinonStub)
