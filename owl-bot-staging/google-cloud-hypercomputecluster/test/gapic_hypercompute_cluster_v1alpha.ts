...
describe('v1alpha.HypercomputeClusterClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = hypercomputeclusterModule.v1alpha.HypercomputeClusterClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = hypercomputeclusterModule.v1alpha.HypercomputeClusterClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'hypercomputecluster.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new hypercomputeclusterModule.v1alpha.HypercomputeClusterClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'hypercomputecluster.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new hypercomputeclusterModule.v1alpha.HypercomputeClusterClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'hypercomputecluster.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new hypercomputeclusterModule.v1alpha.HypercomputeClusterClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new hypercomputeclusterModule.v1alpha.HypercomputeClusterClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = hypercomputeclusterModule.v1alpha.HypercomputeClusterClient.port;
            assert(port);
    ...
    describe('getCluster', () => {
        it('invokes getCluster without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.hypercomputecluster.v1alpha.GetClusterRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.hypercomputecluster.v1alpha.GetClusterRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.hypercomputecluster.v1alpha.Cluster()
            );
        ...
        it('invokes getCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCluster(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.hypercomputecluster.v1alpha.ICluster|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createCluster', () => {
        it('invokes createCluster without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.hypercomputecluster.v1alpha.CreateClusterRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.hypercomputecluster.v1alpha.CreateClusterRequest', ['parent']);
        ...
        it('invokes createCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createCluster(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.hypercomputecluster.v1alpha.ICluster, protos.google.cloud.hypercomputecluster.v1alpha.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.hypercomputecluster.v1alpha.ICluster, protos.google.cloud.hypercomputecluster.v1alpha.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createCluster as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateCluster', () => {
        it('invokes updateCluster without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.hypercomputecluster.v1alpha.UpdateClusterRequest()
            );
            request.cluster ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.hypercomputecluster.v1alpha.UpdateClusterRequest', ['cluster', 'name']);
    ...
    describe('deleteCluster', () => {
        it('invokes deleteCluster without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.hypercomputecluster.v1alpha.DeleteClusterRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.hypercomputecluster.v1alpha.DeleteClusterRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listClusters', () => {
        it('invokes listClusters without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.hypercomputecluster.v1alpha.ListClustersRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.hypercomputecluster.v1alpha.ListClustersRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.hypercomputecluster.v1alpha.Cluster()),
              generateSampleMessage(new protos.google.cloud.hypercomputecluster.v1alpha.Cluster()),
              generateSampleMessage(new protos.google.cloud.hypercomputecluster.v1alpha.Cluster()),
            ];
        ...
        it('invokes listClustersStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.hypercomputecluster.v1alpha.Cluster[] = [];
                stream.on('data', (response: protos.google.cloud.hypercomputecluster.v1alpha.Cluster) => {
        ...
        it('uses async iteration with listClusters without error', async () => {
            ...
            const responses: protos.google.cloud.hypercomputecluster.v1alpha.ICluster[] = [];
    ...
    describe('Path templates', () => {
        ...
        describe('image', async () => {
            const fakePath = "/rendered/path/image";
            const expectedParameters = {
                project: "projectValue",
                image: "imageValue",
            };
            ...
            await client.initialize();
            client.pathTemplates.imagePathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.imagePathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('imagePath', () => {
                const result = client.imagePath("projectValue", "imageValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.imagePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromImageName', () => {
                const result = client.matchProjectFromImageName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.imagePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchImageFromImageName', () => {
                const result = client.matchImageFromImageName(fakePath);
                assert.strictEqual(result, "imageValue");
                assert((client.pathTemplates.imagePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
