...
describe('v1.HypercomputeClusterClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = hypercomputeclusterModule.v1.HypercomputeClusterClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = hypercomputeclusterModule.v1.HypercomputeClusterClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'hypercomputecluster.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new hypercomputeclusterModule.v1.HypercomputeClusterClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'hypercomputecluster.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new hypercomputeclusterModule.v1.HypercomputeClusterClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'hypercomputecluster.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new hypercomputeclusterModule.v1.HypercomputeClusterClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new hypercomputeclusterModule.v1.HypercomputeClusterClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getCluster', () => {
        it('invokes getCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.hypercomputecluster.v1.GetClusterRequest', ['name']);
        ...
        it('invokes getCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCluster(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.hypercomputecluster.v1.ICluster|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createCluster', () => {
        it('invokes createCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.hypercomputecluster.v1.CreateClusterRequest', ['parent']);
        ...
        it('invokes createCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createCluster(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.hypercomputecluster.v1.ICluster, protos.google.cloud.hypercomputecluster.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.hypercomputecluster.v1.ICluster, protos.google.cloud.hypercomputecluster.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createCluster as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateCluster', () => {
        it('invokes updateCluster without error', async () => {
            ...
            request.cluster ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.hypercomputecluster.v1.UpdateClusterRequest', ['cluster', 'name']);
    ...
    describe('deleteCluster', () => {
        it('invokes deleteCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.hypercomputecluster.v1.DeleteClusterRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes deleteCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deleteCluster(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.hypercomputecluster.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.hypercomputecluster.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteCluster as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listClusters', () => {
        it('invokes listClusters without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.hypercomputecluster.v1.ListClustersRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.hypercomputecluster.v1.Cluster()),
              generateSampleMessage(new protos.google.cloud.hypercomputecluster.v1.Cluster()),
              generateSampleMessage(new protos.google.cloud.hypercomputecluster.v1.Cluster()),
            ];
        ...
        it('invokes listClustersStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.hypercomputecluster.v1.Cluster) => {
    ...
    describe('Path templates', () => {
        ...
        describe('fileInstance', async () => {
            ...
            await client.initialize();
            client.pathTemplates.fileInstancePathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.fileInstancePathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('fileInstancePath', () => {
                const result = client.fileInstancePath("projectValue", "locationValue", "instanceValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.fileInstancePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromFileInstanceName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.fileInstancePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
