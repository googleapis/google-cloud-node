...
function main(parent) {
  // [START hypercomputecluster_v1beta_generated_HypercomputeCluster_ListClusters_async]
  /**
  ...
  const {HypercomputeClusterClient} = require('@google-cloud/hypercomputecluster').v1beta;
  ...
  callListClusters();
  // [END hypercomputecluster_v1beta_generated_HypercomputeCluster_ListClusters_async]
}
