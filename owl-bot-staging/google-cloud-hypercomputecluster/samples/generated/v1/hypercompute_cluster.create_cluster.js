...
function main(parent, clusterId, cluster) {
  // [START hypercomputecluster_v1_generated_HypercomputeCluster_CreateCluster_async]
  /**
  ...
  const {HypercomputeClusterClient} = require('@google-cloud/hypercomputecluster').v1;
  ...
  callCreateCluster();
  // [END hypercomputecluster_v1_generated_HypercomputeCluster_CreateCluster_async]
}
