...
function main(parent, odbNetworkId, odbNetwork) {
  // [START oracledatabase_v1_generated_OracleDatabase_CreateOdbNetwork_async]
  /**
  ...
  async function callCreateOdbNetwork() {
    // Construct request
    const request = {
      parent,
      odbNetworkId,
    ...
    // Run request
    const [operation] = await oracledatabaseClient.createOdbNetwork(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callCreateOdbNetwork();
  // [END oracledatabase_v1_generated_OracleDatabase_CreateOdbNetwork_async]
}
