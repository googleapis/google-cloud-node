...
function main(name) {
  // [START oracledatabase_v1_generated_OracleDatabase_StopAutonomousDatabase_async]
  /**
  ...
  async function callStopAutonomousDatabase() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const [operation] = await oracledatabaseClient.stopAutonomousDatabase(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callStopAutonomousDatabase();
