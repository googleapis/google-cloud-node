...
function main(parent) {
  // [START oracledatabase_v1_generated_OracleDatabase_ListDbVersions_async]
  /**
  ...
  async function callListDbVersions() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = oracledatabaseClient.listDbVersionsAsync(request);
  ...
  callListDbVersions();
  // [END oracledatabase_v1_generated_OracleDatabase_ListDbVersions_async]
}
