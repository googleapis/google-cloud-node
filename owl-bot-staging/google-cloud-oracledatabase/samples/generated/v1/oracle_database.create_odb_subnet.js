...
function main(parent, odbSubnetId, odbSubnet) {
  // [START oracledatabase_v1_generated_OracleDatabase_CreateOdbSubnet_async]
  /**
  ...
  async function callCreateOdbSubnet() {
    // Construct request
    const request = {
      parent,
      odbSubnetId,
    ...
    // Run request
    const [operation] = await oracledatabaseClient.createOdbSubnet(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callCreateOdbSubnet();
  // [END oracledatabase_v1_generated_OracleDatabase_CreateOdbSubnet_async]
}
