...
describe('v1.AdvisoryNotificationsServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new advisorynotificationsserviceModule.v1.AdvisoryNotificationsServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = advisorynotificationsserviceModule.v1.AdvisoryNotificationsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = advisorynotificationsserviceModule.v1.AdvisoryNotificationsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'advisorynotifications.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new advisorynotificationsserviceModule.v1.AdvisoryNotificationsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'advisorynotifications.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new advisorynotificationsserviceModule.v1.AdvisoryNotificationsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'advisorynotifications.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new advisorynotificationsserviceModule.v1.AdvisoryNotificationsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
                    assert.strictEqual(servicePath, 'advisorynotifications.configured.example.com');
                    if (saved) {
                        process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = saved;
                    } else {
                        delete process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new advisorynotificationsserviceModule.v1.AdvisoryNotificationsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = advisorynotificationsserviceModule.v1.AdvisoryNotificationsServiceClient.port;
            assert(port);
    ...
    describe('getNotification', () => {
        it('invokes getNotification without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.advisorynotifications.v1.GetNotificationRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getNotification as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getNotification as SinonStub)
        ...
        it('invokes getNotification without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getNotification(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.advisorynotifications.v1.INotification|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getSettings', () => {
        it('invokes getSettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.advisorynotifications.v1.GetSettingsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getSettings without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getSettings(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.advisorynotifications.v1.ISettings|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateSettings', () => {
        it('invokes updateSettings without error', async () => {
            ...
            request.settings ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.advisorynotifications.v1.UpdateSettingsRequest', ['settings', 'name']);
    ...
    describe('listNotifications', () => {
        it('invokes listNotifications without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.advisorynotifications.v1.ListNotificationsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.advisorynotifications.v1.Notification()),
              generateSampleMessage(new protos.google.cloud.advisorynotifications.v1.Notification()),
              generateSampleMessage(new protos.google.cloud.advisorynotifications.v1.Notification()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listNotifications as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listNotifications as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listNotificationsStream without error', async () => {
            ...
            client.descriptors.page.listNotifications.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.advisorynotifications.v1.Notification) => {
            ...
            assert((client.descriptors.page.listNotifications.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listNotifications, request));
            assert(
        ...
        it('invokes listNotificationsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listNotifications.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listNotificationsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.advisorynotifications.v1.Notification[] = [];
                stream.on('data', (response: protos.google.cloud.advisorynotifications.v1.Notification) => {
        ...
        it('uses async iteration with listNotifications without error', async () => {
            ...
            client.descriptors.page.listNotifications.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listNotifications with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listNotifications.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listNotificationsAsync(request);
    ...
    describe('Path templates', () => {
        ...
        describe('organizationLocationNotification', () => {
            ...
            it('organizationLocationNotificationPath', () => {
                const result = client.organizationLocationNotificationPath("organizationValue", "locationValue", "notificationValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationLocationNotificationPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationLocationNotificationName', () => {
                const result = client.matchOrganizationFromOrganizationLocationNotificationName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationLocationNotificationPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromOrganizationLocationNotificationName', () => {
                const result = client.matchLocationFromOrganizationLocationNotificationName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.organizationLocationNotificationPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchNotificationFromOrganizationLocationNotificationName', () => {
                const result = client.matchNotificationFromOrganizationLocationNotificationName(fakePath);
        ...
        describe('organizationLocationSettings', () => {
            ...
            it('organizationLocationSettingsPath', () => {
                const result = client.organizationLocationSettingsPath("organizationValue", "locationValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationLocationSettingsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationLocationSettingsName', () => {
                const result = client.matchOrganizationFromOrganizationLocationSettingsName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationLocationSettingsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromOrganizationLocationSettingsName', () => {
                const result = client.matchLocationFromOrganizationLocationSettingsName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.organizationLocationSettingsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('projectLocationNotification', () => {
            ...
            client.pathTemplates.projectLocationNotificationPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.projectLocationNotificationPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('projectLocationNotificationPath', () => {
                const result = client.projectLocationNotificationPath("projectValue", "locationValue", "notificationValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectLocationNotificationPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectLocationNotificationName', () => {
                const result = client.matchProjectFromProjectLocationNotificationName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectLocationNotificationPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromProjectLocationNotificationName', () => {
                const result = client.matchLocationFromProjectLocationNotificationName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.projectLocationNotificationPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchNotificationFromProjectLocationNotificationName', () => {
                const result = client.matchNotificationFromProjectLocationNotificationName(fakePath);
                assert.strictEqual(result, "notificationValue");
                assert((client.pathTemplates.projectLocationNotificationPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('projectLocationSettings', () => {
            ...
            client.initialize();
            client.pathTemplates.projectLocationSettingsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.projectLocationSettingsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('projectLocationSettingsPath', () => {
                const result = client.projectLocationSettingsPath("projectValue", "locationValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectLocationSettingsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectLocationSettingsName', () => {
                const result = client.matchProjectFromProjectLocationSettingsName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectLocationSettingsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromProjectLocationSettingsName', () => {
                const result = client.matchLocationFromProjectLocationSettingsName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.projectLocationSettingsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
