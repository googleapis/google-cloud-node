...
describe('v1.AdvisoryNotificationsServiceClient', () => {
    ...
    describe('Path templates', () => {
        ...
        describe('notification', () => {
            ...
            client.initialize();
            client.pathTemplates.notificationPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.notificationPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('notificationPath', () => {
                const result = client.notificationPath("organizationValue", "locationValue", "notificationValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.notificationPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchOrganizationFromNotificationName', () => {
                ...
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.notificationPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
