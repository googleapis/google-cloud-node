...
# [Notebooks: Nodejs Client][homepage]
...
* [Notebooks Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/notebooks/latest)
...
1.  [Enable the Notebooks API][enable_api].
