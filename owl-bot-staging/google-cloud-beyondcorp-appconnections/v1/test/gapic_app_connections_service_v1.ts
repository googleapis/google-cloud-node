...
describe('v1.AppConnectionsServiceClient', () => {
    ...
    describe('getAppConnection', () => {
        it('invokes getAppConnection without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.beyondcorp.appconnections.v1.GetAppConnectionRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.beyondcorp.appconnections.v1.AppConnection());
            ...
            assert((client.innerApiCalls.getAppConnection as SinonStub)
    ...
    describe('createAppConnection', () => {
        it('invokes createAppConnection without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.beyondcorp.appconnections.v1.CreateAppConnectionRequest());
            request.parent = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createAppConnection as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateAppConnection', () => {
        it('invokes updateAppConnection without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.beyondcorp.appconnections.v1.UpdateAppConnectionRequest());
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateAppConnection as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteAppConnection', () => {
        it('invokes deleteAppConnection without error', async () => {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteAppConnection as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listAppConnections', () => {
        it('invokes listAppConnections without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listAppConnections as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('resolveAppConnections', () => {
        it('invokes resolveAppConnections without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.beyondcorp.appconnections.v1.ResolveAppConnectionsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.resolveAppConnections as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
