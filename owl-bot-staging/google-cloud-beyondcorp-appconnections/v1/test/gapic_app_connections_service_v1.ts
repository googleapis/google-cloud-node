...
describe('v1.AppConnectionsServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new appconnectionsserviceModule.v1.AppConnectionsServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = appconnectionsserviceModule.v1.AppConnectionsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = appconnectionsserviceModule.v1.AppConnectionsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'beyondcorp.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new appconnectionsserviceModule.v1.AppConnectionsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'beyondcorp.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new appconnectionsserviceModule.v1.AppConnectionsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'beyondcorp.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new appconnectionsserviceModule.v1.AppConnectionsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new appconnectionsserviceModule.v1.AppConnectionsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = appconnectionsserviceModule.v1.AppConnectionsServiceClient.port;
            assert(port);
    ...
    describe('getAppConnection', () => {
        it('invokes getAppConnection without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.beyondcorp.appconnections.v1.GetAppConnectionRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getAppConnection as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getAppConnection as SinonStub)
        ...
        it('invokes getAppConnection without error using callback', async () => {
            ...
            client.innerApiCalls.getAppConnection = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAppConnection(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.beyondcorp.appconnections.v1.IAppConnection|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAppConnection with error', async () => {
            ...
            client.innerApiCalls.getAppConnection = stubSimpleCall(undefined, expectedError);
    ...
    describe('createAppConnection', () => {
        it('invokes createAppConnection without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.beyondcorp.appconnections.v1.CreateAppConnectionRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createAppConnection = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createAppConnection(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createAppConnection as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createAppConnection as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createAppConnection without error using callback', async () => {
            ...
            client.innerApiCalls.createAppConnection = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createAppConnection(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.beyondcorp.appconnections.v1.IAppConnection, protos.google.cloud.beyondcorp.appconnections.v1.IAppConnectionOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.beyondcorp.appconnections.v1.IAppConnection, protos.google.cloud.beyondcorp.appconnections.v1.IAppConnectionOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createAppConnection as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createAppConnection with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createAppConnection = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes createAppConnection with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createAppConnection = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createAppConnection(request);
        ...
        it('invokes checkCreateAppConnectionProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateAppConnectionProgress(expectedResponse.name);
        ...
        it('invokes checkCreateAppConnectionProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreateAppConnectionProgress(''), expectedError);
    ...
    describe('updateAppConnection', () => {
        it('invokes updateAppConnection without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.beyondcorp.appconnections.v1.UpdateAppConnectionRequest', ['appConnection', 'name']);
            request.appConnection.name = defaultValue1;
            const expectedHeaderRequestParams = `app_connection.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updateAppConnection = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateAppConnection(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateAppConnection as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateAppConnection as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateAppConnection without error using callback', async () => {
            ...
            client.innerApiCalls.updateAppConnection = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateAppConnection with call error', async () => {
            ...
            const expectedHeaderRequestParams = `app_connection.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateAppConnection = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes updateAppConnection with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `app_connection.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateAppConnection = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateAppConnection(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateAppConnection as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateAppConnectionProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateAppConnectionProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateAppConnectionProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateAppConnectionProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteAppConnection', () => {
        it('invokes deleteAppConnection without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.beyondcorp.appconnections.v1.DeleteAppConnectionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteAppConnection = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteAppConnection(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteAppConnection as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteAppConnection as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteAppConnection without error using callback', async () => {
            ...
            client.innerApiCalls.deleteAppConnection = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteAppConnection(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.beyondcorp.appconnections.v1.IAppConnectionOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.beyondcorp.appconnections.v1.IAppConnectionOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteAppConnection as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes deleteAppConnection with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteAppConnection = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes deleteAppConnection with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteAppConnection = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteAppConnection(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteAppConnection as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteAppConnectionProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteAppConnectionProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteAppConnectionProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteAppConnectionProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listAppConnections', () => {
        it('invokes listAppConnections without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.beyondcorp.appconnections.v1.ListAppConnectionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.beyondcorp.appconnections.v1.AppConnection()),
              generateSampleMessage(new protos.google.cloud.beyondcorp.appconnections.v1.AppConnection()),
              generateSampleMessage(new protos.google.cloud.beyondcorp.appconnections.v1.AppConnection()),
            ];
            client.innerApiCalls.listAppConnections = stubSimpleCall(expectedResponse);
            const [response] = await client.listAppConnections(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listAppConnections as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAppConnections as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listAppConnections without error using callback', async () => {
            ...
            client.innerApiCalls.listAppConnections = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listAppConnections with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listAppConnections = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listAppConnectionsStream without error', async () => {
            ...
            client.descriptors.page.listAppConnections.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.beyondcorp.appconnections.v1.AppConnection) => {
            ...
            assert((client.descriptors.page.listAppConnections.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listAppConnections, request));
            assert(
        ...
        it('invokes listAppConnectionsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAppConnections.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listAppConnectionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.beyondcorp.appconnections.v1.AppConnection[] = [];
                stream.on('data', (response: protos.google.cloud.beyondcorp.appconnections.v1.AppConnection) => {
        ...
        it('uses async iteration with listAppConnections without error', async () => {
            ...
            client.descriptors.page.listAppConnections.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listAppConnections with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAppConnections.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listAppConnectionsAsync(request);
    ...
    describe('resolveAppConnections', () => {
        it('invokes resolveAppConnections without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.beyondcorp.appconnections.v1.ResolveAppConnectionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.beyondcorp.appconnections.v1.ResolveAppConnectionsResponse.AppConnectionDetails()),
              generateSampleMessage(new protos.google.cloud.beyondcorp.appconnections.v1.ResolveAppConnectionsResponse.AppConnectionDetails()),
              generateSampleMessage(new protos.google.cloud.beyondcorp.appconnections.v1.ResolveAppConnectionsResponse.AppConnectionDetails()),
            ];
            client.innerApiCalls.resolveAppConnections = stubSimpleCall(expectedResponse);
            const [response] = await client.resolveAppConnections(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.resolveAppConnections as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.resolveAppConnections as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes resolveAppConnections without error using callback', async () => {
            ...
            client.innerApiCalls.resolveAppConnections = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.resolveAppConnections(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.beyondcorp.appconnections.v1.ResolveAppConnectionsResponse.IAppConnectionDetails[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes resolveAppConnections with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.resolveAppConnections = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.resolveAppConnections(request), expectedError);
            const actualRequest = (client.innerApiCalls.resolveAppConnections as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.resolveAppConnections as SinonStub)
        ...
        it('invokes resolveAppConnectionsStream without error', async () => {
            ...
            client.descriptors.page.resolveAppConnections.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.beyondcorp.appconnections.v1.ResolveAppConnectionsResponse.AppConnectionDetails) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.resolveAppConnections.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.resolveAppConnections, request));
            assert(
                (client.descriptors.page.resolveAppConnections.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes resolveAppConnectionsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.resolveAppConnections.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.resolveAppConnectionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.beyondcorp.appconnections.v1.ResolveAppConnectionsResponse.AppConnectionDetails[] = [];
                stream.on('data', (response: protos.google.cloud.beyondcorp.appconnections.v1.ResolveAppConnectionsResponse.AppConnectionDetails) => {
        ...
        it('uses async iteration with resolveAppConnections without error', async () => {
            ...
            client.descriptors.page.resolveAppConnections.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.resolveAppConnections.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.resolveAppConnections.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with resolveAppConnections with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.resolveAppConnections.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.resolveAppConnectionsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.beyondcorp.appconnections.v1.ResolveAppConnectionsResponse.IAppConnectionDetails[] = [];
                for await (const resource of iterable) {
    ...
    describe('Path templates', () => {
        ...
        describe('appConnection', async () => {
            ...
            client.pathTemplates.appConnectionPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('appConnectionPath', () => {
                const result = client.appConnectionPath("projectValue", "locationValue", "appConnectionValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.appConnectionPathTemplate.render as SinonStub)
            ...
            it('matchProjectFromAppConnectionName', () => {
                ...
                assert((client.pathTemplates.appConnectionPathTemplate.match as SinonStub)
        ...
        describe('appConnector', async () => {
            ...
            await client.initialize();
            client.pathTemplates.appConnectorPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.appConnectorPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('appConnectorPath', () => {
                const result = client.appConnectorPath("projectValue", "locationValue", "appConnectorValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.appConnectorPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromAppConnectorName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.appConnectorPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
