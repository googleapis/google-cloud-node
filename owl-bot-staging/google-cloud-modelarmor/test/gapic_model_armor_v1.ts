...
describe('v1.ModelArmorClient', () => {
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new modelarmorModule.v1.ModelArmorClient({
          universe_domain: 'example.com',
    ...
    it('invokes getTemplate without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getTemplate(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.modelarmor.v1.ITemplate | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('deleteTemplate', () => {
    it('invokes deleteTemplate without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.modelarmor.v1.DeleteTemplateRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
    ...
    it('invokes getFloorSetting without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getFloorSetting(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.modelarmor.v1.IFloorSetting | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes sanitizeUserPrompt without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.sanitizeUserPrompt(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.modelarmor.v1.ISanitizeUserPromptResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes sanitizeModelResponse without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.sanitizeModelResponse(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.modelarmor.v1.ISanitizeModelResponseResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listTemplates', () => {
    ...
    it('invokes listTemplatesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.modelarmor.v1.Template) => {
