...
# [Osconfig: Nodejs Client][homepage]

[//]: # "releaseLevel"

[![npm version](https://img.shields.io/npm/v/@google-cloud/osconfig.svg)](https://www.npmjs.org/package/@google-cloud/osconfig)
...
* [Osconfig Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/osconfig/latest)
...
1.  [Enable the Osconfig API][enable_api].
1.  [Set up authentication][auth] so you can access the
    API from your local workstation.
### Installing the client library

```bash
npm install @google-cloud/osconfig
```
...
For example, `npm install @google-cloud/osconfig@legacy-8` installs client libraries
