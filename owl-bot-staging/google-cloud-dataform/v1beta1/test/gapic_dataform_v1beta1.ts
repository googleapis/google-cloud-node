...
describe('v1beta1.DataformClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new dataformModule.v1beta1.DataformClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dataform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new dataformModule.v1beta1.DataformClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dataform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new dataformModule.v1beta1.DataformClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new dataformModule.v1beta1.DataformClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getRepository', () => {
        it('invokes getRepository without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.GetRepositoryRequest', ['name']);
        ...
        it('invokes getRepository without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getRepository(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.IRepository|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createRepository', () => {
        it('invokes createRepository without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.CreateRepositoryRequest', ['parent']);
    ...
    describe('updateRepository', () => {
        it('invokes updateRepository without error', async () => {
            ...
            request.repository ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.UpdateRepositoryRequest', ['repository', 'name']);
    ...
    describe('deleteRepository', () => {
        it('invokes deleteRepository without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.DeleteRepositoryRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('commitRepositoryChanges', () => {
        it('invokes commitRepositoryChanges without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.CommitRepositoryChangesRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1beta1.CommitRepositoryChangesResponse()
            );
            client.innerApiCalls.commitRepositoryChanges = stubSimpleCall(expectedResponse);
            const [response] = await client.commitRepositoryChanges(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.commitRepositoryChanges as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.commitRepositoryChanges as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes commitRepositoryChanges without error using callback', async () => {
            ...
            client.innerApiCalls.commitRepositoryChanges = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.commitRepositoryChanges(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.ICommitRepositoryChangesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes commitRepositoryChanges with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.commitRepositoryChanges = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.commitRepositoryChanges(request), expectedError);
            const actualRequest = (client.innerApiCalls.commitRepositoryChanges as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.commitRepositoryChanges as SinonStub)
    ...
    describe('readRepositoryFile', () => {
        it('invokes readRepositoryFile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.ReadRepositoryFileRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1beta1.ReadRepositoryFileResponse()
            );
            client.innerApiCalls.readRepositoryFile = stubSimpleCall(expectedResponse);
            const [response] = await client.readRepositoryFile(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.readRepositoryFile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.readRepositoryFile as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes readRepositoryFile without error using callback', async () => {
            ...
            client.innerApiCalls.readRepositoryFile = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.readRepositoryFile(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.IReadRepositoryFileResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes readRepositoryFile with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.readRepositoryFile = stubSimpleCall(undefined, expectedError);
    ...
    describe('computeRepositoryAccessTokenStatus', () => {
        it('invokes computeRepositoryAccessTokenStatus without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.ComputeRepositoryAccessTokenStatusRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1beta1.ComputeRepositoryAccessTokenStatusResponse()
            );
            client.innerApiCalls.computeRepositoryAccessTokenStatus = stubSimpleCall(expectedResponse);
            const [response] = await client.computeRepositoryAccessTokenStatus(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.computeRepositoryAccessTokenStatus as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.computeRepositoryAccessTokenStatus as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes computeRepositoryAccessTokenStatus without error using callback', async () => {
            ...
            client.innerApiCalls.computeRepositoryAccessTokenStatus = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.computeRepositoryAccessTokenStatus(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.IComputeRepositoryAccessTokenStatusResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes computeRepositoryAccessTokenStatus with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.computeRepositoryAccessTokenStatus = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.computeRepositoryAccessTokenStatus(request), expectedError);
            const actualRequest = (client.innerApiCalls.computeRepositoryAccessTokenStatus as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.computeRepositoryAccessTokenStatus as SinonStub)
    ...
    describe('fetchRemoteBranches', () => {
        it('invokes fetchRemoteBranches without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.FetchRemoteBranchesRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes fetchRemoteBranches without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.fetchRemoteBranches(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.IFetchRemoteBranchesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getWorkspace', () => {
        it('invokes getWorkspace without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.GetWorkspaceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getWorkspace without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getWorkspace(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.IWorkspace|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createWorkspace', () => {
        it('invokes createWorkspace without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.CreateWorkspaceRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1beta1.Workspace()
    ...
    describe('deleteWorkspace', () => {
        it('invokes deleteWorkspace without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.DeleteWorkspaceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('installNpmPackages', () => {
        it('invokes installNpmPackages without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.InstallNpmPackagesRequest', ['workspace']);
        ...
        it('invokes installNpmPackages without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.installNpmPackages(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.IInstallNpmPackagesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('pullGitCommits', () => {
        it('invokes pullGitCommits without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.PullGitCommitsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes pullGitCommits without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.pullGitCommits(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.IPullGitCommitsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('pushGitCommits', () => {
        it('invokes pushGitCommits without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.PushGitCommitsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes pushGitCommits without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.pushGitCommits(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.IPushGitCommitsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('fetchFileGitStatuses', () => {
        it('invokes fetchFileGitStatuses without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.FetchFileGitStatusesRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes fetchFileGitStatuses without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.fetchFileGitStatuses(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.IFetchFileGitStatusesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('fetchGitAheadBehind', () => {
        it('invokes fetchGitAheadBehind without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.FetchGitAheadBehindRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes fetchGitAheadBehind without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.fetchGitAheadBehind(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.IFetchGitAheadBehindResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('commitWorkspaceChanges', () => {
        it('invokes commitWorkspaceChanges without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.CommitWorkspaceChangesRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes commitWorkspaceChanges without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.commitWorkspaceChanges(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.ICommitWorkspaceChangesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('resetWorkspaceChanges', () => {
        it('invokes resetWorkspaceChanges without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.ResetWorkspaceChangesRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes resetWorkspaceChanges without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.resetWorkspaceChanges(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.IResetWorkspaceChangesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('fetchFileDiff', () => {
        it('invokes fetchFileDiff without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.FetchFileDiffRequest', ['workspace']);
            request.workspace = defaultValue1;
            const expectedHeaderRequestParams = `workspace=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes fetchFileDiff without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.fetchFileDiff(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.IFetchFileDiffResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('makeDirectory', () => {
        it('invokes makeDirectory without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.MakeDirectoryRequest', ['workspace']);
            request.workspace = defaultValue1;
            const expectedHeaderRequestParams = `workspace=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes makeDirectory without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.makeDirectory(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.IMakeDirectoryResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('removeDirectory', () => {
        it('invokes removeDirectory without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.RemoveDirectoryRequest', ['workspace']);
            request.workspace = defaultValue1;
            const expectedHeaderRequestParams = `workspace=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes removeDirectory without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.removeDirectory(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.IRemoveDirectoryResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('moveDirectory', () => {
        it('invokes moveDirectory without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.MoveDirectoryRequest', ['workspace']);
            request.workspace = defaultValue1;
            const expectedHeaderRequestParams = `workspace=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes moveDirectory without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.moveDirectory(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.IMoveDirectoryResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('readFile', () => {
        it('invokes readFile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.ReadFileRequest', ['workspace']);
            request.workspace = defaultValue1;
            const expectedHeaderRequestParams = `workspace=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes readFile without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.readFile(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.IReadFileResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('removeFile', () => {
        it('invokes removeFile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.RemoveFileRequest', ['workspace']);
            request.workspace = defaultValue1;
            const expectedHeaderRequestParams = `workspace=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes removeFile without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.removeFile(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.IRemoveFileResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('moveFile', () => {
        it('invokes moveFile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.MoveFileRequest', ['workspace']);
            request.workspace = defaultValue1;
            const expectedHeaderRequestParams = `workspace=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes moveFile without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.moveFile(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.IMoveFileResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('writeFile', () => {
        it('invokes writeFile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.WriteFileRequest', ['workspace']);
            request.workspace = defaultValue1;
            const expectedHeaderRequestParams = `workspace=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes writeFile without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.writeFile(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.IWriteFileResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getReleaseConfig', () => {
        it('invokes getReleaseConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.GetReleaseConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getReleaseConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getReleaseConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getReleaseConfig without error using callback', async () => {
            ...
            client.innerApiCalls.getReleaseConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getReleaseConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.IReleaseConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getReleaseConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getReleaseConfig = stubSimpleCall(undefined, expectedError);
    ...
    describe('createReleaseConfig', () => {
        it('invokes createReleaseConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.CreateReleaseConfigRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1beta1.ReleaseConfig()
            );
            client.innerApiCalls.createReleaseConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.createReleaseConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createReleaseConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createReleaseConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createReleaseConfig without error using callback', async () => {
            ...
            client.innerApiCalls.createReleaseConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createReleaseConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createReleaseConfig = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateReleaseConfig', () => {
        it('invokes updateReleaseConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.UpdateReleaseConfigRequest', ['releaseConfig', 'name']);
            request.releaseConfig.name = defaultValue1;
            const expectedHeaderRequestParams = `release_config.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1beta1.ReleaseConfig()
            );
            client.innerApiCalls.updateReleaseConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.updateReleaseConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateReleaseConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateReleaseConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateReleaseConfig without error using callback', async () => {
            ...
            client.innerApiCalls.updateReleaseConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateReleaseConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `release_config.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateReleaseConfig = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteReleaseConfig', () => {
        it('invokes deleteReleaseConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.DeleteReleaseConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteReleaseConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteReleaseConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteReleaseConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteReleaseConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteReleaseConfig without error using callback', async () => {
            ...
            client.innerApiCalls.deleteReleaseConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteReleaseConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteReleaseConfig = stubSimpleCall(undefined, expectedError);
    ...
    describe('getCompilationResult', () => {
        it('invokes getCompilationResult without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.GetCompilationResultRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getCompilationResult without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCompilationResult(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.ICompilationResult|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createCompilationResult', () => {
        it('invokes createCompilationResult without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.CreateCompilationResultRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1beta1.CompilationResult()
    ...
    describe('getWorkflowConfig', () => {
        it('invokes getWorkflowConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.GetWorkflowConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getWorkflowConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getWorkflowConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getWorkflowConfig without error using callback', async () => {
            ...
            client.innerApiCalls.getWorkflowConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getWorkflowConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.IWorkflowConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getWorkflowConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getWorkflowConfig = stubSimpleCall(undefined, expectedError);
    ...
    describe('createWorkflowConfig', () => {
        it('invokes createWorkflowConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.CreateWorkflowConfigRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1beta1.WorkflowConfig()
            );
            client.innerApiCalls.createWorkflowConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.createWorkflowConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createWorkflowConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createWorkflowConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createWorkflowConfig without error using callback', async () => {
            ...
            client.innerApiCalls.createWorkflowConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createWorkflowConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createWorkflowConfig = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateWorkflowConfig', () => {
        it('invokes updateWorkflowConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.UpdateWorkflowConfigRequest', ['workflowConfig', 'name']);
            request.workflowConfig.name = defaultValue1;
            const expectedHeaderRequestParams = `workflow_config.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1beta1.WorkflowConfig()
            );
            client.innerApiCalls.updateWorkflowConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.updateWorkflowConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateWorkflowConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateWorkflowConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateWorkflowConfig without error using callback', async () => {
            ...
            client.innerApiCalls.updateWorkflowConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateWorkflowConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `workflow_config.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateWorkflowConfig = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteWorkflowConfig', () => {
        it('invokes deleteWorkflowConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.DeleteWorkflowConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteWorkflowConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteWorkflowConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteWorkflowConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteWorkflowConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteWorkflowConfig without error using callback', async () => {
            ...
            client.innerApiCalls.deleteWorkflowConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteWorkflowConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteWorkflowConfig = stubSimpleCall(undefined, expectedError);
    ...
    describe('getWorkflowInvocation', () => {
        it('invokes getWorkflowInvocation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.GetWorkflowInvocationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getWorkflowInvocation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getWorkflowInvocation(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.IWorkflowInvocation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createWorkflowInvocation', () => {
        it('invokes createWorkflowInvocation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.CreateWorkflowInvocationRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataform.v1beta1.WorkflowInvocation()
    ...
    describe('deleteWorkflowInvocation', () => {
        it('invokes deleteWorkflowInvocation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.DeleteWorkflowInvocationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('cancelWorkflowInvocation', () => {
        it('invokes cancelWorkflowInvocation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.CancelWorkflowInvocationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes cancelWorkflowInvocation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.cancelWorkflowInvocation(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.ICancelWorkflowInvocationResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getConfig', () => {
        it('invokes getConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.GetConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getConfig without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.IConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateConfig', () => {
        it('invokes updateConfig without error', async () => {
            ...
            request.config ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.UpdateConfigRequest', ['config', 'name']);
    ...
    describe('listRepositories', () => {
        it('invokes listRepositories without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.ListRepositoriesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.Repository()),
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.Repository()),
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.Repository()),
            ];
        ...
        it('invokes listRepositoriesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.dataform.v1beta1.Repository) => {
    ...
    describe('queryRepositoryDirectoryContents', () => {
        it('invokes queryRepositoryDirectoryContents without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.QueryRepositoryDirectoryContentsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.DirectoryEntry()),
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.DirectoryEntry()),
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.DirectoryEntry()),
            ];
            client.innerApiCalls.queryRepositoryDirectoryContents = stubSimpleCall(expectedResponse);
            const [response] = await client.queryRepositoryDirectoryContents(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.queryRepositoryDirectoryContents as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.queryRepositoryDirectoryContents as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes queryRepositoryDirectoryContents without error using callback', async () => {
            ...
            client.innerApiCalls.queryRepositoryDirectoryContents = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.queryRepositoryDirectoryContents(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.IDirectoryEntry[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes queryRepositoryDirectoryContents with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.queryRepositoryDirectoryContents = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.queryRepositoryDirectoryContents(request), expectedError);
            const actualRequest = (client.innerApiCalls.queryRepositoryDirectoryContents as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.queryRepositoryDirectoryContents as SinonStub)
        ...
        it('invokes queryRepositoryDirectoryContentsStream without error', async () => {
            ...
            client.descriptors.page.queryRepositoryDirectoryContents.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.dataform.v1beta1.DirectoryEntry) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.queryRepositoryDirectoryContents.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.queryRepositoryDirectoryContents, request));
            assert(
                (client.descriptors.page.queryRepositoryDirectoryContents.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes queryRepositoryDirectoryContentsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.queryRepositoryDirectoryContents.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.queryRepositoryDirectoryContentsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataform.v1beta1.DirectoryEntry[] = [];
                stream.on('data', (response: protos.google.cloud.dataform.v1beta1.DirectoryEntry) => {
        ...
        it('uses async iteration with queryRepositoryDirectoryContents without error', async () => {
            ...
            client.descriptors.page.queryRepositoryDirectoryContents.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.queryRepositoryDirectoryContents.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.queryRepositoryDirectoryContents.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with queryRepositoryDirectoryContents with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.queryRepositoryDirectoryContents.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.queryRepositoryDirectoryContentsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.dataform.v1beta1.IDirectoryEntry[] = [];
                for await (const resource of iterable) {
    ...
    describe('fetchRepositoryHistory', () => {
        it('invokes fetchRepositoryHistory without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.FetchRepositoryHistoryRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.CommitLogEntry()),
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.CommitLogEntry()),
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.CommitLogEntry()),
            ];
            client.innerApiCalls.fetchRepositoryHistory = stubSimpleCall(expectedResponse);
            const [response] = await client.fetchRepositoryHistory(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.fetchRepositoryHistory as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.fetchRepositoryHistory as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes fetchRepositoryHistory without error using callback', async () => {
            ...
            client.innerApiCalls.fetchRepositoryHistory = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.fetchRepositoryHistory(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.ICommitLogEntry[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes fetchRepositoryHistory with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.fetchRepositoryHistory = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.fetchRepositoryHistory(request), expectedError);
            const actualRequest = (client.innerApiCalls.fetchRepositoryHistory as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.fetchRepositoryHistory as SinonStub)
        ...
        it('invokes fetchRepositoryHistoryStream without error', async () => {
            ...
            client.descriptors.page.fetchRepositoryHistory.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.dataform.v1beta1.CommitLogEntry) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.fetchRepositoryHistory.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.fetchRepositoryHistory, request));
            assert(
                (client.descriptors.page.fetchRepositoryHistory.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes fetchRepositoryHistoryStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.fetchRepositoryHistory.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.fetchRepositoryHistoryStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataform.v1beta1.CommitLogEntry[] = [];
                stream.on('data', (response: protos.google.cloud.dataform.v1beta1.CommitLogEntry) => {
        ...
        it('uses async iteration with fetchRepositoryHistory without error', async () => {
            ...
            client.descriptors.page.fetchRepositoryHistory.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.fetchRepositoryHistory.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.fetchRepositoryHistory.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with fetchRepositoryHistory with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.fetchRepositoryHistory.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.fetchRepositoryHistoryAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.dataform.v1beta1.ICommitLogEntry[] = [];
                for await (const resource of iterable) {
    ...
    describe('listWorkspaces', () => {
        it('invokes listWorkspaces without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.ListWorkspacesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.Workspace()),
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.Workspace()),
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.Workspace()),
            ];
        ...
        it('invokes listWorkspacesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.dataform.v1beta1.Workspace) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('queryDirectoryContents', () => {
        it('invokes queryDirectoryContents without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.QueryDirectoryContentsRequest', ['workspace']);
            request.workspace = defaultValue1;
    ...
    describe('searchFiles', () => {
        it('invokes searchFiles without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.SearchFilesRequest', ['workspace']);
            request.workspace = defaultValue1;
            const expectedHeaderRequestParams = `workspace=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.SearchResult()),
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.SearchResult()),
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.SearchResult()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.searchFiles as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.searchFiles as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes searchFiles without error using callback', async () => {
            ...
            client.innerApiCalls.searchFiles = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.searchFiles(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.ISearchResult[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes searchFiles with error', async () => {
            ...
            const expectedHeaderRequestParams = `workspace=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.searchFiles = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes searchFilesStream without error', async () => {
            ...
            client.descriptors.page.searchFiles.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.searchFilesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataform.v1beta1.SearchResult[] = [];
                stream.on('data', (response: protos.google.cloud.dataform.v1beta1.SearchResult) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.searchFiles.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.searchFiles, request));
            assert(
        ...
        it('invokes searchFilesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `workspace=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.searchFiles.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.searchFilesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataform.v1beta1.SearchResult[] = [];
                stream.on('data', (response: protos.google.cloud.dataform.v1beta1.SearchResult) => {
        ...
        it('uses async iteration with searchFiles without error', async () => {
            ...
            client.descriptors.page.searchFiles.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with searchFiles with error', async () => {
            ...
            const expectedHeaderRequestParams = `workspace=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.searchFiles.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.searchFilesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.dataform.v1beta1.ISearchResult[] = [];
                for await (const resource of iterable) {
    ...
    describe('listReleaseConfigs', () => {
        it('invokes listReleaseConfigs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.ListReleaseConfigsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.ReleaseConfig()),
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.ReleaseConfig()),
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.ReleaseConfig()),
            ];
            client.innerApiCalls.listReleaseConfigs = stubSimpleCall(expectedResponse);
            const [response] = await client.listReleaseConfigs(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listReleaseConfigs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listReleaseConfigs as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listReleaseConfigs without error using callback', async () => {
            ...
            client.innerApiCalls.listReleaseConfigs = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listReleaseConfigs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listReleaseConfigs = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listReleaseConfigsStream without error', async () => {
            ...
            client.descriptors.page.listReleaseConfigs.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listReleaseConfigsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataform.v1beta1.ReleaseConfig[] = [];
                stream.on('data', (response: protos.google.cloud.dataform.v1beta1.ReleaseConfig) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listReleaseConfigs.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listReleaseConfigs, request));
            assert(
        ...
        it('invokes listReleaseConfigsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listReleaseConfigs.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listReleaseConfigsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataform.v1beta1.ReleaseConfig[] = [];
                stream.on('data', (response: protos.google.cloud.dataform.v1beta1.ReleaseConfig) => {
        ...
        it('uses async iteration with listReleaseConfigs without error', async () => {
            ...
            client.descriptors.page.listReleaseConfigs.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listReleaseConfigs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listReleaseConfigs.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listReleaseConfigsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.dataform.v1beta1.IReleaseConfig[] = [];
                for await (const resource of iterable) {
    ...
    describe('listCompilationResults', () => {
        it('invokes listCompilationResults without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.ListCompilationResultsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.CompilationResult()),
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.CompilationResult()),
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.CompilationResult()),
            ];
        ...
        it('invokes listCompilationResultsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.dataform.v1beta1.CompilationResult) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('queryCompilationResultActions', () => {
        it('invokes queryCompilationResultActions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.QueryCompilationResultActionsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.CompilationResultAction()),
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.CompilationResultAction()),
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.CompilationResultAction()),
            ];
        ...
        it('invokes queryCompilationResultActions without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.queryCompilationResultActions(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.ICompilationResultAction[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes queryCompilationResultActionsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.dataform.v1beta1.CompilationResultAction) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listWorkflowConfigs', () => {
        it('invokes listWorkflowConfigs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.ListWorkflowConfigsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.WorkflowConfig()),
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.WorkflowConfig()),
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.WorkflowConfig()),
            ];
            client.innerApiCalls.listWorkflowConfigs = stubSimpleCall(expectedResponse);
            const [response] = await client.listWorkflowConfigs(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listWorkflowConfigs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listWorkflowConfigs as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listWorkflowConfigs without error using callback', async () => {
            ...
            client.innerApiCalls.listWorkflowConfigs = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listWorkflowConfigs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listWorkflowConfigs = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listWorkflowConfigsStream without error', async () => {
            ...
            client.descriptors.page.listWorkflowConfigs.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listWorkflowConfigsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataform.v1beta1.WorkflowConfig[] = [];
                stream.on('data', (response: protos.google.cloud.dataform.v1beta1.WorkflowConfig) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listWorkflowConfigs.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listWorkflowConfigs, request));
            assert(
        ...
        it('invokes listWorkflowConfigsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listWorkflowConfigs.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listWorkflowConfigsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataform.v1beta1.WorkflowConfig[] = [];
                stream.on('data', (response: protos.google.cloud.dataform.v1beta1.WorkflowConfig) => {
        ...
        it('uses async iteration with listWorkflowConfigs without error', async () => {
            ...
            client.descriptors.page.listWorkflowConfigs.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listWorkflowConfigs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listWorkflowConfigs.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listWorkflowConfigsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.dataform.v1beta1.IWorkflowConfig[] = [];
                for await (const resource of iterable) {
    ...
    describe('listWorkflowInvocations', () => {
        it('invokes listWorkflowInvocations without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.ListWorkflowInvocationsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.WorkflowInvocation()),
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.WorkflowInvocation()),
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.WorkflowInvocation()),
            ];
        ...
        it('invokes listWorkflowInvocationsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.dataform.v1beta1.WorkflowInvocation) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('queryWorkflowInvocationActions', () => {
        it('invokes queryWorkflowInvocationActions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataform.v1beta1.QueryWorkflowInvocationActionsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.WorkflowInvocationAction()),
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.WorkflowInvocationAction()),
              generateSampleMessage(new protos.google.cloud.dataform.v1beta1.WorkflowInvocationAction()),
            ];
        ...
        it('invokes queryWorkflowInvocationActions without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.queryWorkflowInvocationActions(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataform.v1beta1.IWorkflowInvocationAction[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes queryWorkflowInvocationActionsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.dataform.v1beta1.WorkflowInvocationAction) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('Path templates', () => {
        ...
        describe('releaseConfig', () => {
            ...
            client.initialize();
            client.pathTemplates.releaseConfigPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.releaseConfigPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('releaseConfigPath', () => {
                const result = client.releaseConfigPath("projectValue", "locationValue", "repositoryValue", "releaseConfigValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.releaseConfigPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromReleaseConfigName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.releaseConfigPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('workflowConfig', () => {
            ...
            client.initialize();
            client.pathTemplates.workflowConfigPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.workflowConfigPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('workflowConfigPath', () => {
                const result = client.workflowConfigPath("projectValue", "locationValue", "repositoryValue", "workflowConfigValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.workflowConfigPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromWorkflowConfigName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.workflowConfigPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchWorkflowConfigFromWorkflowConfigName', () => {
                const result = client.matchWorkflowConfigFromWorkflowConfigName(fakePath);
