...
describe('v1beta1.DataformClient', () => {
  ...
  describe('getTeamFolder', () => {
    it('invokes getTeamFolder without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getTeamFolder as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getTeamFolder without error using callback', async () => {
      ...
      client.innerApiCalls.getTeamFolder =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getTeamFolder(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dataform.v1beta1.ITeamFolder | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getTeamFolder with error', async () => {
      ...
      client.innerApiCalls.getTeamFolder = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createTeamFolder', () => {
    it('invokes createTeamFolder without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createTeamFolder as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createTeamFolder as SinonStub
    ...
    it('invokes createTeamFolder without error using callback', async () => {
      ...
      client.innerApiCalls.createTeamFolder =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes createTeamFolder with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createTeamFolder = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateTeamFolder', () => {
    it('invokes updateTeamFolder without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateTeamFolder as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateTeamFolder as SinonStub
    ...
    it('invokes updateTeamFolder without error using callback', async () => {
      ...
      client.innerApiCalls.updateTeamFolder =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes updateTeamFolder with error', async () => {
      ...
      const expectedHeaderRequestParams = `team_folder.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateTeamFolder = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteTeamFolder', () => {
    it('invokes deleteTeamFolder without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteTeamFolder as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteTeamFolder as SinonStub
    ...
    it('invokes deleteTeamFolder without error using callback', async () => {
      ...
      client.innerApiCalls.deleteTeamFolder =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes deleteTeamFolder with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteTeamFolder = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes getFolder without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getFolder(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dataform.v1beta1.IFolder | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('updateFolder', () => {
    ...
    it('invokes updateFolder with error', async () => {
      ...
      const expectedHeaderRequestParams = `folder.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateFolder = stubSimpleCall(
        undefined,
        expectedError,
      );
        ...
        client.moveFolder(
          ...
          (
            ...
            result?: LROperation<
              ...
              protos.google.cloud.dataform.v1beta1.IMoveFolderMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
  ...
  describe('moveRepository', () => {
    it('invokes moveRepository without error', async () => {
      ...
      client.innerApiCalls.moveRepository =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.moveRepository(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.moveRepository as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.moveRepository as SinonStub
      ...
      const promise = new Promise((resolve, reject) => {
        client.moveRepository(
          ...
          (
            ...
            result?: LROperation<
              protos.google.protobuf.IEmpty,
              protos.google.cloud.dataform.v1beta1.IMoveRepositoryMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
    ...
    it('invokes moveRepository with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.moveRepository = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkMoveRepositoryProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkMoveRepositoryProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('queryTeamFolderContents', () => {
    it('invokes queryTeamFolderContents without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.dataform.v1beta1.QueryTeamFolderContentsResponse.TeamFolderContentsEntry(),
        ),
        generateSampleMessage(
          new protos.google.cloud.dataform.v1beta1.QueryTeamFolderContentsResponse.TeamFolderContentsEntry(),
        ),
      ...
      client.innerApiCalls.queryTeamFolderContents =
        stubSimpleCall(expectedResponse);
      const [response] = await client.queryTeamFolderContents(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.queryTeamFolderContents as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.queryTeamFolderContents as SinonStub
    ...
    it('invokes queryTeamFolderContents with error', async () => {
      ...
      const expectedHeaderRequestParams = `team_folder=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.queryTeamFolderContents = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.queryTeamFolderContents(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.queryTeamFolderContents as SinonStub
    ...
    it('invokes queryTeamFolderContentsStream without error', async () => {
      ...
      client.descriptors.page.queryTeamFolderContents.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.dataform.v1beta1.QueryTeamFolderContentsResponse.TeamFolderContentsEntry,
          ) => {
      ...
      assert(
        (
          client.descriptors.page.queryTeamFolderContents
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.queryTeamFolderContents, request),
      );
      assert(
        (
          client.descriptors.page.queryTeamFolderContents
    ...
    it('uses async iteration with queryTeamFolderContents without error', async () => {
      ...
      client.descriptors.page.queryTeamFolderContents.asyncIterate =
  ...
  describe('searchTeamFolders', () => {
    it('invokes searchTeamFolders without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.dataform.v1beta1.SearchTeamFoldersResponse.TeamFolderSearchResult(),
        ),
        generateSampleMessage(
          new protos.google.cloud.dataform.v1beta1.SearchTeamFoldersResponse.TeamFolderSearchResult(),
        ),
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.searchTeamFolders as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.searchTeamFolders as SinonStub
    ...
    it('invokes searchTeamFolders without error using callback', async () => {
      ...
      client.innerApiCalls.searchTeamFolders =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes searchTeamFolders with error', async () => {
      ...
      const expectedHeaderRequestParams = `location=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.searchTeamFolders = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes searchTeamFoldersStream without error', async () => {
      ...
      client.descriptors.page.searchTeamFolders.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.dataform.v1beta1.SearchTeamFoldersResponse.TeamFolderSearchResult,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (client.descriptors.page.searchTeamFolders.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.searchTeamFolders, request),
      );
      assert(
        (client.descriptors.page.searchTeamFolders.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with searchTeamFolders without error', async () => {
      ...
      client.descriptors.page.searchTeamFolders.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('queryFolderContents', () => {
    it('invokes queryFolderContents without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.dataform.v1beta1.QueryFolderContentsResponse.FolderContentsEntry(),
        ),
        generateSampleMessage(
          new protos.google.cloud.dataform.v1beta1.QueryFolderContentsResponse.FolderContentsEntry(),
        ),
      ...
      client.innerApiCalls.queryFolderContents =
        stubSimpleCall(expectedResponse);
      const [response] = await client.queryFolderContents(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.queryFolderContents as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.queryFolderContents as SinonStub
    ...
    it('invokes queryFolderContents with error', async () => {
      ...
      const expectedHeaderRequestParams = `folder=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.queryFolderContents = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes queryFolderContentsStream without error', async () => {
      ...
      client.descriptors.page.queryFolderContents.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.dataform.v1beta1.QueryFolderContentsResponse.FolderContentsEntry,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (client.descriptors.page.queryFolderContents.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.queryFolderContents, request),
      );
      assert(
        (client.descriptors.page.queryFolderContents.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with queryFolderContents without error', async () => {
      ...
      client.descriptors.page.queryFolderContents.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('queryUserRootContents', () => {
    it('invokes queryUserRootContents without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.dataform.v1beta1.QueryUserRootContentsResponse.RootContentsEntry(),
        ),
        generateSampleMessage(
          new protos.google.cloud.dataform.v1beta1.QueryUserRootContentsResponse.RootContentsEntry(),
        ),
      ...
      client.innerApiCalls.queryUserRootContents =
        stubSimpleCall(expectedResponse);
      const [response] = await client.queryUserRootContents(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.queryUserRootContents as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.queryUserRootContents as SinonStub
    ...
    it('invokes queryUserRootContents with error', async () => {
      ...
      const expectedHeaderRequestParams = `location=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.queryUserRootContents = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.queryUserRootContents(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.queryUserRootContents as SinonStub
    ...
    it('invokes queryUserRootContentsStream without error', async () => {
      ...
      client.descriptors.page.queryUserRootContents.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.dataform.v1beta1.QueryUserRootContentsResponse.RootContentsEntry,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (
          client.descriptors.page.queryUserRootContents
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.queryUserRootContents, request),
      );
      assert(
        (
          client.descriptors.page.queryUserRootContents
    ...
    it('uses async iteration with queryUserRootContents without error', async () => {
      ...
      client.descriptors.page.queryUserRootContents.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('Path templates', () => {
    ...
    describe('teamFolder', async () => {
      ...
      await client.initialize();
      client.pathTemplates.teamFolderPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.teamFolderPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('teamFolderPath', () => {
        const result = client.teamFolderPath(
          'projectValue',
          'locationValue',
          'teamFolderValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.teamFolderPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromTeamFolderName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.teamFolderPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
