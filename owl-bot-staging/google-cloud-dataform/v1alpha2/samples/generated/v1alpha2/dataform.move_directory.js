...
function main(workspace, path, newPath) {
  // [START dataform_v1alpha2_generated_Dataform_MoveDirectory_async]
  /**
  ...
  callMoveDirectory();
  // [END dataform_v1alpha2_generated_Dataform_MoveDirectory_async]
}
