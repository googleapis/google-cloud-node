...
describe('v1.CloudCatalogClient', () => {
    ...
    describe('Path templates', () => {
        ...
        describe('organizationBillingAccount', () => {
            ...
            client.initialize();
            client.pathTemplates.organizationBillingAccountPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.organizationBillingAccountPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('organizationBillingAccountPath', () => {
                const result = client.organizationBillingAccountPath("organizationValue", "billingAccountValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationBillingAccountPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationBillingAccountName', () => {
                const result = client.matchOrganizationFromOrganizationBillingAccountName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationBillingAccountPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchBillingAccountFromOrganizationBillingAccountName', () => {
                const result = client.matchBillingAccountFromOrganizationBillingAccountName(fakePath);
                assert.strictEqual(result, "billingAccountValue");
                assert((client.pathTemplates.organizationBillingAccountPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
