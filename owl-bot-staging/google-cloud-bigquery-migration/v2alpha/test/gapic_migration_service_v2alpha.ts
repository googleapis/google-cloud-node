...
describe('v2alpha.MigrationServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = migrationserviceModule.v2alpha.MigrationServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = migrationserviceModule.v2alpha.MigrationServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'bigquerymigration.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new migrationserviceModule.v2alpha.MigrationServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'bigquerymigration.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new migrationserviceModule.v2alpha.MigrationServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'bigquerymigration.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new migrationserviceModule.v2alpha.MigrationServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new migrationserviceModule.v2alpha.MigrationServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createMigrationWorkflow', () => {
        it('invokes createMigrationWorkflow without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.migration.v2alpha.CreateMigrationWorkflowRequest', ['parent']);
        ...
        it('invokes createMigrationWorkflow without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createMigrationWorkflow(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.bigquery.migration.v2alpha.IMigrationWorkflow|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getMigrationWorkflow', () => {
        it('invokes getMigrationWorkflow without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.migration.v2alpha.GetMigrationWorkflowRequest', ['name']);
    ...
    describe('deleteMigrationWorkflow', () => {
        it('invokes deleteMigrationWorkflow without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.migration.v2alpha.DeleteMigrationWorkflowRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('startMigrationWorkflow', () => {
        it('invokes startMigrationWorkflow without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.migration.v2alpha.StartMigrationWorkflowRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('getMigrationSubtask', () => {
        it('invokes getMigrationSubtask without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.migration.v2alpha.GetMigrationSubtaskRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getMigrationSubtask without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getMigrationSubtask(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.bigquery.migration.v2alpha.IMigrationSubtask|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listMigrationWorkflows', () => {
        it('invokes listMigrationWorkflows without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.migration.v2alpha.ListMigrationWorkflowsRequest', ['parent']);
            request.parent = defaultValue1;
        ...
        it('invokes listMigrationWorkflowsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.bigquery.migration.v2alpha.MigrationWorkflow) => {
    ...
    describe('listMigrationSubtasks', () => {
        it('invokes listMigrationSubtasks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.migration.v2alpha.ListMigrationSubtasksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
        ...
        it('invokes listMigrationSubtasksStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.bigquery.migration.v2alpha.MigrationSubtask) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
