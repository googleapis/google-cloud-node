...
describe('v1beta1.SecurityCenterClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = securitycenterModule.v1beta1.SecurityCenterClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = securitycenterModule.v1beta1.SecurityCenterClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'securitycenter.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new securitycenterModule.v1beta1.SecurityCenterClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'securitycenter.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new securitycenterModule.v1beta1.SecurityCenterClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'securitycenter.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new securitycenterModule.v1beta1.SecurityCenterClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new securitycenterModule.v1beta1.SecurityCenterClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createSource', () => {
        it('invokes createSource without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1beta1.CreateSourceRequest', ['parent']);
        ...
        it('invokes createSource without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createSource(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.securitycenter.v1beta1.ISource|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createFinding', () => {
        it('invokes createFinding without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1beta1.CreateFindingRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes createFinding without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createFinding(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.securitycenter.v1beta1.IFinding|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getOrganizationSettings', () => {
        it('invokes getOrganizationSettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1beta1.GetOrganizationSettingsRequest', ['name']);
        ...
        it('invokes getOrganizationSettings without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getOrganizationSettings(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.securitycenter.v1beta1.IOrganizationSettings|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getSource', () => {
        it('invokes getSource without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1beta1.GetSourceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.securitycenter.v1beta1.Source()
    ...
    describe('setFindingState', () => {
        it('invokes setFindingState without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1beta1.SetFindingStateRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.securitycenter.v1beta1.Finding()
    ...
    describe('updateFinding', () => {
        it('invokes updateFinding without error', async () => {
            ...
            request.finding ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1beta1.UpdateFindingRequest', ['finding', 'name']);
    ...
    describe('updateOrganizationSettings', () => {
        it('invokes updateOrganizationSettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1beta1.UpdateOrganizationSettingsRequest', ['organizationSettings', 'name']);
    ...
    describe('updateSource', () => {
        it('invokes updateSource without error', async () => {
            ...
            request.source ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1beta1.UpdateSourceRequest', ['source', 'name']);
    ...
    describe('updateSecurityMarks', () => {
        it('invokes updateSecurityMarks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1beta1.UpdateSecurityMarksRequest', ['securityMarks', 'name']);
        ...
        it('invokes updateSecurityMarks without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updateSecurityMarks(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.securitycenter.v1beta1.ISecurityMarks|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('runAssetDiscovery', () => {
        it('invokes runAssetDiscovery without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1beta1.RunAssetDiscoveryRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('groupAssets', () => {
        it('invokes groupAssets without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1beta1.GroupAssetsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.securitycenter.v1beta1.GroupResult()),
              generateSampleMessage(new protos.google.cloud.securitycenter.v1beta1.GroupResult()),
              generateSampleMessage(new protos.google.cloud.securitycenter.v1beta1.GroupResult()),
            ];
        ...
        it('invokes groupAssets without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.groupAssets(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.securitycenter.v1beta1.IGroupResult[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes groupAssetsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.securitycenter.v1beta1.GroupResult) => {
    ...
    describe('groupFindings', () => {
        it('invokes groupFindings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1beta1.GroupFindingsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.securitycenter.v1beta1.GroupResult()),
              generateSampleMessage(new protos.google.cloud.securitycenter.v1beta1.GroupResult()),
    ...
    describe('listAssets', () => {
        it('invokes listAssets without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1beta1.ListAssetsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.securitycenter.v1beta1.ListAssetsResponse.ListAssetsResult()),
              generateSampleMessage(new protos.google.cloud.securitycenter.v1beta1.ListAssetsResponse.ListAssetsResult()),
              generateSampleMessage(new protos.google.cloud.securitycenter.v1beta1.ListAssetsResponse.ListAssetsResult()),
            ];
        ...
        it('invokes listAssets without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listAssets(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.securitycenter.v1beta1.ListAssetsResponse.IListAssetsResult[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listAssetsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.securitycenter.v1beta1.ListAssetsResponse.ListAssetsResult) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listFindings', () => {
        it('invokes listFindings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1beta1.ListFindingsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
    ...
    describe('listSources', () => {
        it('invokes listSources without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1beta1.ListSourcesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.securitycenter.v1beta1.Source()),
              generateSampleMessage(new protos.google.cloud.securitycenter.v1beta1.Source()),
              generateSampleMessage(new protos.google.cloud.securitycenter.v1beta1.Source()),
            ];
        ...
        it('invokes listSourcesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.securitycenter.v1beta1.Source) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('Path templates', () => {
        ...
        describe('finding', async () => {
            ...
            it('findingPath', () => {
                const result = client.findingPath("organizationValue", "sourceValue", "findingValue");
                assert.strictEqual(result, fakePath);
