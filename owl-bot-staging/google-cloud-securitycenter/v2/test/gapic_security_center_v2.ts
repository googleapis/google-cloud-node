...
describe('v2.SecurityCenterClient', () => {
    ...
    describe('Path templates', () => {
        ...
        describe('attackPath', () => {
            ...
            client.initialize();
            client.pathTemplates.attackPathPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.attackPathPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('attackPathPath', () => {
                const result = client.attackPathPath("organizationValue", "simulationValue", "valuedResourceValue", "attackPathValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.attackPathPathTemplate.render as SinonStub)
            ...
            it('matchOrganizationFromAttackPathName', () => {
                ...
                assert((client.pathTemplates.attackPathPathTemplate.match as SinonStub)
        ...
        describe('resourceValueConfig', () => {
            ...
            client.pathTemplates.resourceValueConfigPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.resourceValueConfigPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('resourceValueConfigPath', () => {
                const result = client.resourceValueConfigPath("organizationValue", "resourceValueConfigValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.resourceValueConfigPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromResourceValueConfigName', () => {
                const result = client.matchOrganizationFromResourceValueConfigName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.resourceValueConfigPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchResourceValueConfigFromResourceValueConfigName', () => {
                const result = client.matchResourceValueConfigFromResourceValueConfigName(fakePath);
        ...
        describe('simulation', () => {
            ...
            client.initialize();
            client.pathTemplates.simulationPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.simulationPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('simulationPath', () => {
                const result = client.simulationPath("organizationValue", "simulationValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.simulationPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchOrganizationFromSimulationName', () => {
                ...
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.simulationPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('valuedResource', () => {
            ...
            client.initialize();
            client.pathTemplates.valuedResourcePathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.valuedResourcePathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('valuedResourcePath', () => {
                const result = client.valuedResourcePath("organizationValue", "simulationValue", "valuedResourceValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.valuedResourcePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchOrganizationFromValuedResourceName', () => {
                ...
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.valuedResourcePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchValuedResourceFromValuedResourceName', () => {
                const result = client.matchValuedResourceFromValuedResourceName(fakePath);
                assert.strictEqual(result, "valuedResourceValue");
                assert((client.pathTemplates.valuedResourcePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
