...
# [Securitycenter: Nodejs Client][homepage]

[//]: # "releaseLevel"

[![npm version](https://img.shields.io/npm/v/@google-cloud/securitycenter.svg)](https://www.npmjs.org/package/@google-cloud/securitycenter)

Securitycenter client for Node.js
...
* [Securitycenter Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/securitycenter/latest)
* [Securitycenter Documentation](https://cloud.google.com/security-command-center/docs/reference/rest)
...
1.  [Enable the Securitycenter API][enable_api].
1.  [Set up authentication][auth] so you can access the
    API from your local workstation.
### Installing the client library

```bash
npm install @google-cloud/securitycenter
```
...
For example, `npm install @google-cloud/securitycenter@legacy-8` installs client libraries
