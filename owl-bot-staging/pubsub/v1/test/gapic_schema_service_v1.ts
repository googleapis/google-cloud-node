...
describe('v1.SchemaServiceClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new schemaserviceModule.v1.SchemaServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'pubsub.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new schemaserviceModule.v1.SchemaServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'pubsub.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new schemaserviceModule.v1.SchemaServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new schemaserviceModule.v1.SchemaServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createSchema', () => {
        it('invokes createSchema without error', async () => {
            ...
            const actualRequest = (client.innerApiCalls.createSchema as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createSchema as SinonStub)
        ...
        it('invokes createSchema without error using callback', async () => {
            ...
            client.innerApiCalls.createSchema = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createSchema(
                    request,
                    (err?: Error|null, result?: protos.google.pubsub.v1.ISchema|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('commitSchema', () => {
        it('invokes commitSchema without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.commitSchema as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.commitSchema as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes commitSchema without error using callback', async () => {
            ...
            client.innerApiCalls.commitSchema = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.commitSchema(
                    request,
                    (err?: Error|null, result?: protos.google.pubsub.v1.ISchema|null) => {
        ...
        it('invokes commitSchema with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.commitSchema = stubSimpleCall(undefined, expectedError);
    ...
    describe('rollbackSchema', () => {
        it('invokes rollbackSchema without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.rollbackSchema as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.rollbackSchema as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes rollbackSchema without error using callback', async () => {
            ...
            client.innerApiCalls.rollbackSchema = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes rollbackSchema with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.rollbackSchema = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteSchemaRevision', () => {
        it('invokes deleteSchemaRevision without error', async () => {
            ...
            client.innerApiCalls.deleteSchemaRevision = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteSchemaRevision(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteSchemaRevision as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteSchemaRevision as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteSchemaRevision without error using callback', async () => {
            ...
            client.innerApiCalls.deleteSchemaRevision = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteSchemaRevision with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteSchemaRevision = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteSchema', () => {
        it('invokes deleteSchema without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteSchema as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteSchema as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteSchema without error using callback', async () => {
            ...
            client.innerApiCalls.deleteSchema = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteSchema(
                    request,
    ...
    describe('validateSchema', () => {
        it('invokes validateSchema without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.validateSchema as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.validateSchema as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes validateSchema without error using callback', async () => {
            ...
            client.innerApiCalls.validateSchema = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.validateSchema(
                    request,
                    (err?: Error|null, result?: protos.google.pubsub.v1.IValidateSchemaResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('validateMessage', () => {
        it('invokes validateMessage without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.validateMessage as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.validateMessage as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes validateMessage without error using callback', async () => {
            ...
            client.innerApiCalls.validateMessage = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.validateMessage(
                    request,
                    (err?: Error|null, result?: protos.google.pubsub.v1.IValidateMessageResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listSchemas', () => {
        it('invokes listSchemas without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.pubsub.v1.ListSchemasRequest', ['parent']);
            request.parent = defaultValue1;
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listSchemas as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listSchemas as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listSchemas without error using callback', async () => {
            ...
            client.innerApiCalls.listSchemas = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listSchemas(
                    request,
                    (err?: Error|null, result?: protos.google.pubsub.v1.ISchema[]|null) => {
        ...
        it('invokes listSchemasStream without error', async () => {
            ...
            assert((client.descriptors.page.listSchemas.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listSchemas, request));
            assert(
        ...
        it('uses async iteration with listSchemas without error', async () => {
            ...
            client.descriptors.page.listSchemas.asyncIterate = stubAsyncIterationCall(expectedResponse);
    ...
    describe('listSchemaRevisions', () => {
        it('invokes listSchemaRevisions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.pubsub.v1.ListSchemaRevisionsRequest', ['name']);
            request.name = defaultValue1;
            ...
            client.innerApiCalls.listSchemaRevisions = stubSimpleCall(expectedResponse);
            const [response] = await client.listSchemaRevisions(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listSchemaRevisions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listSchemaRevisions as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listSchemaRevisions without error using callback', async () => {
            ...
            client.innerApiCalls.listSchemaRevisions = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listSchemaRevisions with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listSchemaRevisions = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listSchemaRevisionsStream without error', async () => {
            ...
            client.descriptors.page.listSchemaRevisions.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listSchemaRevisions.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listSchemaRevisions, request));
            assert(
        ...
        it('invokes listSchemaRevisionsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listSchemaRevisions.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listSchemaRevisionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.pubsub.v1.Schema[] = [];
                stream.on('data', (response: protos.google.pubsub.v1.Schema) => {
        ...
        it('uses async iteration with listSchemaRevisions without error', async () => {
            ...
            client.descriptors.page.listSchemaRevisions.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.pubsub.v1.ISchema[] = [];
        ...
        it('uses async iteration with listSchemaRevisions with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listSchemaRevisions.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listSchemaRevisionsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.pubsub.v1.ISchema[] = [];
                for await (const resource of iterable) {
