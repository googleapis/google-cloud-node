...
[![npm version](https://img.shields.io/npm/v/@google-cloud/datastore-admin.svg)](https://www.npmjs.org/package/@google-cloud/datastore-admin)
...
* [Cloud Datastore API Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/admin/latest)
...
```bash
npm install @google-cloud/datastore-admin
```
...
For example, `npm install @google-cloud/datastore-admin@legacy-8` installs client libraries
