...
describe('v1.IAMCredentialsClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = iamcredentialsModule.v1.IAMCredentialsClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = iamcredentialsModule.v1.IAMCredentialsClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'iamcredentials.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new iamcredentialsModule.v1.IAMCredentialsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'iamcredentials.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new iamcredentialsModule.v1.IAMCredentialsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'iamcredentials.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new iamcredentialsModule.v1.IAMCredentialsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
                    assert.strictEqual(servicePath, 'iamcredentials.configured.example.com');
                    if (saved) {
                        process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = saved;
                    } else {
                        delete process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new iamcredentialsModule.v1.IAMCredentialsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('generateAccessToken', () => {
        it('invokes generateAccessToken without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.iam.credentials.v1.GenerateAccessTokenRequest', ['name']);
        ...
        it('invokes generateAccessToken without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateAccessToken(
                    request,
                    (err?: Error|null, result?: protos.google.iam.credentials.v1.IGenerateAccessTokenResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateIdToken', () => {
        it('invokes generateIdToken without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.iam.credentials.v1.GenerateIdTokenRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.generateIdToken as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateIdToken as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes generateIdToken without error using callback', async () => {
            ...
            client.innerApiCalls.generateIdToken = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.generateIdToken(
                    request,
                    (err?: Error|null, result?: protos.google.iam.credentials.v1.IGenerateIdTokenResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes generateIdToken with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.generateIdToken = stubSimpleCall(undefined, expectedError);
    ...
    describe('signBlob', () => {
        it('invokes signBlob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.iam.credentials.v1.SignBlobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.signBlob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.signBlob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes signBlob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.signBlob(
                    request,
                    (err?: Error|null, result?: protos.google.iam.credentials.v1.ISignBlobResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('signJwt', () => {
        it('invokes signJwt without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.iam.credentials.v1.SignJwtRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.signJwt as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.signJwt as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes signJwt without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.signJwt(
                    request,
                    (err?: Error|null, result?: protos.google.iam.credentials.v1.ISignJwtResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
