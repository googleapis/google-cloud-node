...
describe('v1.CloudChannelServiceClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new cloudchannelserviceModule.v1.CloudChannelServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'cloudchannel.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new cloudchannelserviceModule.v1.CloudChannelServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'cloudchannel.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new cloudchannelserviceModule.v1.CloudChannelServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
                    assert.strictEqual(servicePath, 'cloudchannel.configured.example.com');
                    if (saved) {
                        process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = saved;
                    } else {
                        delete process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new cloudchannelserviceModule.v1.CloudChannelServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getCustomer', () => {
        it('invokes getCustomer without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.GetCustomerRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getCustomer as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getCustomer as SinonStub)
    ...
    describe('checkCloudIdentityAccountsExist', () => {
        it('invokes checkCloudIdentityAccountsExist without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.CheckCloudIdentityAccountsExistRequest', ['parent']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.checkCloudIdentityAccountsExist as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.checkCloudIdentityAccountsExist as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('createCustomer', () => {
        it('invokes createCustomer without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.CreateCustomerRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.channel.v1.Customer()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createCustomer as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createCustomer as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('updateCustomer', () => {
        it('invokes updateCustomer without error', async () => {
            ...
            request.customer ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.UpdateCustomerRequest', ['customer', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateCustomer as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateCustomer as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('deleteCustomer', () => {
        it('invokes deleteCustomer without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.DeleteCustomerRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteCustomer as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteCustomer as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('importCustomer', () => {
        it('invokes importCustomer without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.ImportCustomerRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.channel.v1.Customer()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importCustomer as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.importCustomer as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes importCustomer without error using callback', async () => {
            ...
            client.innerApiCalls.importCustomer = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes importCustomer with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.importCustomer = stubSimpleCall(undefined, expectedError);
    ...
    describe('getEntitlement', () => {
        it('invokes getEntitlement without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.GetEntitlementRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getChannelPartnerLink', () => {
        it('invokes getChannelPartnerLink without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.GetChannelPartnerLinkRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getChannelPartnerLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getChannelPartnerLink as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('createChannelPartnerLink', () => {
        it('invokes createChannelPartnerLink without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.CreateChannelPartnerLinkRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.channel.v1.ChannelPartnerLink()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createChannelPartnerLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createChannelPartnerLink as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('updateChannelPartnerLink', () => {
        it('invokes updateChannelPartnerLink without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.UpdateChannelPartnerLinkRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.channel.v1.ChannelPartnerLink()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateChannelPartnerLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateChannelPartnerLink as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('getCustomerRepricingConfig', () => {
        it('invokes getCustomerRepricingConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.GetCustomerRepricingConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.channel.v1.CustomerRepricingConfig()
            );
            client.innerApiCalls.getCustomerRepricingConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.getCustomerRepricingConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getCustomerRepricingConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getCustomerRepricingConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getCustomerRepricingConfig without error using callback', async () => {
            ...
            client.innerApiCalls.getCustomerRepricingConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerRepricingConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.channel.v1.ICustomerRepricingConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCustomerRepricingConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getCustomerRepricingConfig = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCustomerRepricingConfig(request), expectedError);
            const actualRequest = (client.innerApiCalls.getCustomerRepricingConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getCustomerRepricingConfig as SinonStub)
    ...
    describe('createCustomerRepricingConfig', () => {
        it('invokes createCustomerRepricingConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.CreateCustomerRepricingConfigRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.channel.v1.CustomerRepricingConfig()
            );
            client.innerApiCalls.createCustomerRepricingConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.createCustomerRepricingConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createCustomerRepricingConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createCustomerRepricingConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createCustomerRepricingConfig without error using callback', async () => {
            ...
            client.innerApiCalls.createCustomerRepricingConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createCustomerRepricingConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createCustomerRepricingConfig = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createCustomerRepricingConfig(request), expectedError);
            const actualRequest = (client.innerApiCalls.createCustomerRepricingConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createCustomerRepricingConfig as SinonStub)
    ...
    describe('updateCustomerRepricingConfig', () => {
        it('invokes updateCustomerRepricingConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.UpdateCustomerRepricingConfigRequest', ['customerRepricingConfig', 'name']);
            ...
            client.innerApiCalls.updateCustomerRepricingConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.updateCustomerRepricingConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateCustomerRepricingConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateCustomerRepricingConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateCustomerRepricingConfig without error using callback', async () => {
            ...
            client.innerApiCalls.updateCustomerRepricingConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateCustomerRepricingConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `customer_repricing_config.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateCustomerRepricingConfig = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateCustomerRepricingConfig(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateCustomerRepricingConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateCustomerRepricingConfig as SinonStub)
    ...
    describe('deleteCustomerRepricingConfig', () => {
        it('invokes deleteCustomerRepricingConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.DeleteCustomerRepricingConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteCustomerRepricingConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteCustomerRepricingConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteCustomerRepricingConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteCustomerRepricingConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteCustomerRepricingConfig without error using callback', async () => {
            ...
            client.innerApiCalls.deleteCustomerRepricingConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteCustomerRepricingConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteCustomerRepricingConfig = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.deleteCustomerRepricingConfig(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteCustomerRepricingConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteCustomerRepricingConfig as SinonStub)
    ...
    describe('getChannelPartnerRepricingConfig', () => {
        it('invokes getChannelPartnerRepricingConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.GetChannelPartnerRepricingConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.channel.v1.ChannelPartnerRepricingConfig()
            );
            client.innerApiCalls.getChannelPartnerRepricingConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.getChannelPartnerRepricingConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getChannelPartnerRepricingConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getChannelPartnerRepricingConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getChannelPartnerRepricingConfig without error using callback', async () => {
            ...
            client.innerApiCalls.getChannelPartnerRepricingConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getChannelPartnerRepricingConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.channel.v1.IChannelPartnerRepricingConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getChannelPartnerRepricingConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getChannelPartnerRepricingConfig = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getChannelPartnerRepricingConfig(request), expectedError);
            const actualRequest = (client.innerApiCalls.getChannelPartnerRepricingConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getChannelPartnerRepricingConfig as SinonStub)
    ...
    describe('createChannelPartnerRepricingConfig', () => {
        it('invokes createChannelPartnerRepricingConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.CreateChannelPartnerRepricingConfigRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.channel.v1.ChannelPartnerRepricingConfig()
            );
            client.innerApiCalls.createChannelPartnerRepricingConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.createChannelPartnerRepricingConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createChannelPartnerRepricingConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createChannelPartnerRepricingConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createChannelPartnerRepricingConfig without error using callback', async () => {
            ...
            client.innerApiCalls.createChannelPartnerRepricingConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createChannelPartnerRepricingConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createChannelPartnerRepricingConfig = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createChannelPartnerRepricingConfig(request), expectedError);
            const actualRequest = (client.innerApiCalls.createChannelPartnerRepricingConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createChannelPartnerRepricingConfig as SinonStub)
    ...
    describe('updateChannelPartnerRepricingConfig', () => {
        it('invokes updateChannelPartnerRepricingConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.UpdateChannelPartnerRepricingConfigRequest', ['channelPartnerRepricingConfig', 'name']);
            ...
            client.innerApiCalls.updateChannelPartnerRepricingConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.updateChannelPartnerRepricingConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateChannelPartnerRepricingConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateChannelPartnerRepricingConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateChannelPartnerRepricingConfig without error using callback', async () => {
            ...
            client.innerApiCalls.updateChannelPartnerRepricingConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateChannelPartnerRepricingConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `channel_partner_repricing_config.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateChannelPartnerRepricingConfig = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateChannelPartnerRepricingConfig(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateChannelPartnerRepricingConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateChannelPartnerRepricingConfig as SinonStub)
    ...
    describe('deleteChannelPartnerRepricingConfig', () => {
        it('invokes deleteChannelPartnerRepricingConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.DeleteChannelPartnerRepricingConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteChannelPartnerRepricingConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteChannelPartnerRepricingConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteChannelPartnerRepricingConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteChannelPartnerRepricingConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteChannelPartnerRepricingConfig without error using callback', async () => {
            ...
            client.innerApiCalls.deleteChannelPartnerRepricingConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteChannelPartnerRepricingConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteChannelPartnerRepricingConfig = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.deleteChannelPartnerRepricingConfig(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteChannelPartnerRepricingConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteChannelPartnerRepricingConfig as SinonStub)
    ...
    describe('lookupOffer', () => {
        it('invokes lookupOffer without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.LookupOfferRequest', ['entitlement']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.lookupOffer as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.lookupOffer as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('queryEligibleBillingAccounts', () => {
        it('invokes queryEligibleBillingAccounts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.QueryEligibleBillingAccountsRequest', ['customer']);
            ...
            client.innerApiCalls.queryEligibleBillingAccounts = stubSimpleCall(expectedResponse);
            const [response] = await client.queryEligibleBillingAccounts(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.queryEligibleBillingAccounts as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.queryEligibleBillingAccounts as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes queryEligibleBillingAccounts without error using callback', async () => {
            ...
            client.innerApiCalls.queryEligibleBillingAccounts = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.queryEligibleBillingAccounts(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.channel.v1.IQueryEligibleBillingAccountsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes queryEligibleBillingAccounts with error', async () => {
            ...
            const expectedHeaderRequestParams = `customer=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.queryEligibleBillingAccounts = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.queryEligibleBillingAccounts(request), expectedError);
            const actualRequest = (client.innerApiCalls.queryEligibleBillingAccounts as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.queryEligibleBillingAccounts as SinonStub)
    ...
    describe('registerSubscriber', () => {
        it('invokes registerSubscriber without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.RegisterSubscriberRequest', ['account']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.registerSubscriber as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.registerSubscriber as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('unregisterSubscriber', () => {
        it('invokes unregisterSubscriber without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.UnregisterSubscriberRequest', ['account']);
            request.account = defaultValue1;
            const expectedHeaderRequestParams = `account=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.unregisterSubscriber as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.unregisterSubscriber as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('provisionCloudIdentity', () => {
        it('invokes provisionCloudIdentity without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.ProvisionCloudIdentityRequest', ['customer']);
            request.customer = defaultValue1;
            const expectedHeaderRequestParams = `customer=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.provisionCloudIdentity as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.provisionCloudIdentity as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('createEntitlement', () => {
        it('invokes createEntitlement without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.CreateEntitlementRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('changeParameters', () => {
        it('invokes changeParameters without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.ChangeParametersRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.changeParameters as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.changeParameters as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('changeRenewalSettings', () => {
        it('invokes changeRenewalSettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.ChangeRenewalSettingsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.changeRenewalSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.changeRenewalSettings as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('changeOffer', () => {
        it('invokes changeOffer without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.ChangeOfferRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.changeOffer as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.changeOffer as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('startPaidService', () => {
        it('invokes startPaidService without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.StartPaidServiceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.startPaidService as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.startPaidService as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('suspendEntitlement', () => {
        it('invokes suspendEntitlement without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.SuspendEntitlementRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.suspendEntitlement as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.suspendEntitlement as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('cancelEntitlement', () => {
        it('invokes cancelEntitlement without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.CancelEntitlementRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.cancelEntitlement as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.cancelEntitlement as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('activateEntitlement', () => {
        it('invokes activateEntitlement without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.ActivateEntitlementRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.activateEntitlement as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.activateEntitlement as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('transferEntitlements', () => {
        it('invokes transferEntitlements without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.TransferEntitlementsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.transferEntitlements as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.transferEntitlements as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('transferEntitlementsToGoogle', () => {
        it('invokes transferEntitlementsToGoogle without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.TransferEntitlementsToGoogleRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.transferEntitlementsToGoogle as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.transferEntitlementsToGoogle as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('listCustomers', () => {
        it('invokes listCustomers without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.ListCustomersRequest', ['parent']);
            request.parent = defaultValue1;
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listCustomers as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listCustomers as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('listEntitlements', () => {
        it('invokes listEntitlements without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.ListEntitlementsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
    ...
    describe('listTransferableSkus', () => {
        it('invokes listTransferableSkus without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.ListTransferableSkusRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listTransferableSkus as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listTransferableSkus as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('listTransferableOffers', () => {
        it('invokes listTransferableOffers without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.ListTransferableOffersRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listTransferableOffers as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listTransferableOffers as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('listChannelPartnerLinks', () => {
        it('invokes listChannelPartnerLinks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.ListChannelPartnerLinksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listChannelPartnerLinks as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listChannelPartnerLinks as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('listCustomerRepricingConfigs', () => {
        it('invokes listCustomerRepricingConfigs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.ListCustomerRepricingConfigsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.channel.v1.CustomerRepricingConfig()),
              generateSampleMessage(new protos.google.cloud.channel.v1.CustomerRepricingConfig()),
              generateSampleMessage(new protos.google.cloud.channel.v1.CustomerRepricingConfig()),
            ];
            client.innerApiCalls.listCustomerRepricingConfigs = stubSimpleCall(expectedResponse);
            const [response] = await client.listCustomerRepricingConfigs(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listCustomerRepricingConfigs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listCustomerRepricingConfigs as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listCustomerRepricingConfigs without error using callback', async () => {
            ...
            client.innerApiCalls.listCustomerRepricingConfigs = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listCustomerRepricingConfigs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listCustomerRepricingConfigs = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listCustomerRepricingConfigs(request), expectedError);
            const actualRequest = (client.innerApiCalls.listCustomerRepricingConfigs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listCustomerRepricingConfigs as SinonStub)
        ...
        it('invokes listCustomerRepricingConfigsStream without error', async () => {
            ...
            client.descriptors.page.listCustomerRepricingConfigs.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.channel.v1.CustomerRepricingConfig) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listCustomerRepricingConfigs.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listCustomerRepricingConfigs, request));
            assert(
                (client.descriptors.page.listCustomerRepricingConfigs.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listCustomerRepricingConfigsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listCustomerRepricingConfigs.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listCustomerRepricingConfigsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.channel.v1.CustomerRepricingConfig[] = [];
                stream.on('data', (response: protos.google.cloud.channel.v1.CustomerRepricingConfig) => {
        ...
        it('uses async iteration with listCustomerRepricingConfigs without error', async () => {
            ...
            client.descriptors.page.listCustomerRepricingConfigs.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listCustomerRepricingConfigs.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listCustomerRepricingConfigs.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listCustomerRepricingConfigs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listCustomerRepricingConfigs.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listCustomerRepricingConfigsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.channel.v1.ICustomerRepricingConfig[] = [];
                for await (const resource of iterable) {
    ...
    describe('listChannelPartnerRepricingConfigs', () => {
        it('invokes listChannelPartnerRepricingConfigs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.ListChannelPartnerRepricingConfigsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.channel.v1.ChannelPartnerRepricingConfig()),
              generateSampleMessage(new protos.google.cloud.channel.v1.ChannelPartnerRepricingConfig()),
              generateSampleMessage(new protos.google.cloud.channel.v1.ChannelPartnerRepricingConfig()),
            ];
            client.innerApiCalls.listChannelPartnerRepricingConfigs = stubSimpleCall(expectedResponse);
            const [response] = await client.listChannelPartnerRepricingConfigs(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listChannelPartnerRepricingConfigs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listChannelPartnerRepricingConfigs as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listChannelPartnerRepricingConfigs without error using callback', async () => {
            ...
            client.innerApiCalls.listChannelPartnerRepricingConfigs = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listChannelPartnerRepricingConfigs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listChannelPartnerRepricingConfigs = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listChannelPartnerRepricingConfigs(request), expectedError);
            const actualRequest = (client.innerApiCalls.listChannelPartnerRepricingConfigs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listChannelPartnerRepricingConfigs as SinonStub)
        ...
        it('invokes listChannelPartnerRepricingConfigsStream without error', async () => {
            ...
            client.descriptors.page.listChannelPartnerRepricingConfigs.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.channel.v1.ChannelPartnerRepricingConfig) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listChannelPartnerRepricingConfigs.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listChannelPartnerRepricingConfigs, request));
            assert(
                (client.descriptors.page.listChannelPartnerRepricingConfigs.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listChannelPartnerRepricingConfigsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listChannelPartnerRepricingConfigs.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listChannelPartnerRepricingConfigsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.channel.v1.ChannelPartnerRepricingConfig[] = [];
                stream.on('data', (response: protos.google.cloud.channel.v1.ChannelPartnerRepricingConfig) => {
        ...
        it('uses async iteration with listChannelPartnerRepricingConfigs without error', async () => {
            ...
            client.descriptors.page.listChannelPartnerRepricingConfigs.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listChannelPartnerRepricingConfigs.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listChannelPartnerRepricingConfigs.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listChannelPartnerRepricingConfigs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listChannelPartnerRepricingConfigs.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listChannelPartnerRepricingConfigsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.channel.v1.IChannelPartnerRepricingConfig[] = [];
                for await (const resource of iterable) {
    ...
    describe('listSkuGroups', () => {
        it('invokes listSkuGroups without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.ListSkuGroupsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listSkuGroups as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listSkuGroups as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listSkuGroups without error using callback', async () => {
            ...
            client.innerApiCalls.listSkuGroups = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listSkuGroups(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.channel.v1.ISkuGroup[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listSkuGroups with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listSkuGroups = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listSkuGroupsStream without error', async () => {
            ...
            client.descriptors.page.listSkuGroups.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listSkuGroupsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.channel.v1.SkuGroup[] = [];
                stream.on('data', (response: protos.google.cloud.channel.v1.SkuGroup) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listSkuGroups.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listSkuGroups, request));
            assert(
        ...
        it('invokes listSkuGroupsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listSkuGroups.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listSkuGroupsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.channel.v1.SkuGroup[] = [];
                stream.on('data', (response: protos.google.cloud.channel.v1.SkuGroup) => {
        ...
        it('uses async iteration with listSkuGroups without error', async () => {
            ...
            client.descriptors.page.listSkuGroups.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listSkuGroups with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listSkuGroups.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listSkuGroupsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.channel.v1.ISkuGroup[] = [];
                for await (const resource of iterable) {
    ...
    describe('listSkuGroupBillableSkus', () => {
        it('invokes listSkuGroupBillableSkus without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.ListSkuGroupBillableSkusRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
            ...
            client.innerApiCalls.listSkuGroupBillableSkus = stubSimpleCall(expectedResponse);
            const [response] = await client.listSkuGroupBillableSkus(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listSkuGroupBillableSkus as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listSkuGroupBillableSkus as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listSkuGroupBillableSkus without error using callback', async () => {
            ...
            client.innerApiCalls.listSkuGroupBillableSkus = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listSkuGroupBillableSkus(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.channel.v1.IBillableSku[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listSkuGroupBillableSkus with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listSkuGroupBillableSkus = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listSkuGroupBillableSkus(request), expectedError);
            const actualRequest = (client.innerApiCalls.listSkuGroupBillableSkus as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listSkuGroupBillableSkus as SinonStub)
        ...
        it('invokes listSkuGroupBillableSkusStream without error', async () => {
            ...
            client.descriptors.page.listSkuGroupBillableSkus.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listSkuGroupBillableSkusStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.channel.v1.BillableSku[] = [];
                stream.on('data', (response: protos.google.cloud.channel.v1.BillableSku) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listSkuGroupBillableSkus.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listSkuGroupBillableSkus, request));
            assert(
                (client.descriptors.page.listSkuGroupBillableSkus.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listSkuGroupBillableSkusStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listSkuGroupBillableSkus.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listSkuGroupBillableSkusStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.channel.v1.BillableSku[] = [];
                stream.on('data', (response: protos.google.cloud.channel.v1.BillableSku) => {
        ...
        it('uses async iteration with listSkuGroupBillableSkus without error', async () => {
            ...
            client.descriptors.page.listSkuGroupBillableSkus.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listSkuGroupBillableSkus.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listSkuGroupBillableSkus.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listSkuGroupBillableSkus with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listSkuGroupBillableSkus.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listSkuGroupBillableSkusAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.channel.v1.IBillableSku[] = [];
                for await (const resource of iterable) {
    ...
    describe('listSkus', () => {
        it('invokes listSkus without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.ListSkusRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
    ...
    describe('listOffers', () => {
        it('invokes listOffers without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.ListOffersRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listOffers as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listOffers as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('listPurchasableSkus', () => {
        it('invokes listPurchasableSkus without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.ListPurchasableSkusRequest', ['customer']);
            request.customer = defaultValue1;
            const expectedHeaderRequestParams = `customer=${defaultValue1 ?? '' }`;const expectedResponse = [
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listPurchasableSkus as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listPurchasableSkus as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('listPurchasableOffers', () => {
        it('invokes listPurchasableOffers without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.ListPurchasableOffersRequest', ['customer']);
            request.customer = defaultValue1;
            const expectedHeaderRequestParams = `customer=${defaultValue1 ?? '' }`;const expectedResponse = [
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listPurchasableOffers as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listPurchasableOffers as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('listSubscribers', () => {
        it('invokes listSubscribers without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.ListSubscribersRequest', ['account']);
            request.account = defaultValue1;
            const expectedHeaderRequestParams = `account=${defaultValue1 ?? '' }`;const expectedResponse = [new String(), new String(), new String()];
            client.innerApiCalls.listSubscribers = stubSimpleCall(expectedResponse);
            const [response] = await client.listSubscribers(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listSubscribers as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listSubscribers as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('listEntitlementChanges', () => {
        it('invokes listEntitlementChanges without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.channel.v1.ListEntitlementChangesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.channel.v1.EntitlementChange()),
              generateSampleMessage(new protos.google.cloud.channel.v1.EntitlementChange()),
              generateSampleMessage(new protos.google.cloud.channel.v1.EntitlementChange()),
            ];
            client.innerApiCalls.listEntitlementChanges = stubSimpleCall(expectedResponse);
            const [response] = await client.listEntitlementChanges(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listEntitlementChanges as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listEntitlementChanges as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listEntitlementChanges without error using callback', async () => {
            ...
            client.innerApiCalls.listEntitlementChanges = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listEntitlementChanges(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.channel.v1.IEntitlementChange[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listEntitlementChanges with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listEntitlementChanges = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listEntitlementChanges(request), expectedError);
            const actualRequest = (client.innerApiCalls.listEntitlementChanges as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listEntitlementChanges as SinonStub)
        ...
        it('invokes listEntitlementChangesStream without error', async () => {
            ...
            client.descriptors.page.listEntitlementChanges.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listEntitlementChangesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.channel.v1.EntitlementChange[] = [];
                stream.on('data', (response: protos.google.cloud.channel.v1.EntitlementChange) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listEntitlementChanges.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listEntitlementChanges, request));
            assert(
                (client.descriptors.page.listEntitlementChanges.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listEntitlementChangesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listEntitlementChanges.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listEntitlementChangesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.channel.v1.EntitlementChange[] = [];
                stream.on('data', (response: protos.google.cloud.channel.v1.EntitlementChange) => {
        ...
        it('uses async iteration with listEntitlementChanges without error', async () => {
            ...
            client.descriptors.page.listEntitlementChanges.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listEntitlementChanges.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listEntitlementChanges.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listEntitlementChanges with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listEntitlementChanges.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listEntitlementChangesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.channel.v1.IEntitlementChange[] = [];
                for await (const resource of iterable) {
    ...
    describe('Path templates', () => {
        ...
        describe('billingAccount', async () => {
            ...
            await client.initialize();
            client.pathTemplates.billingAccountPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.billingAccountPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('billingAccountPath', () => {
                const result = client.billingAccountPath("accountValue", "billingAccountValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.billingAccountPathTemplate.render as SinonStub)
            ...
            it('matchAccountFromBillingAccountName', () => {
                ...
                assert((client.pathTemplates.billingAccountPathTemplate.match as SinonStub)
        ...
        describe('channelPartnerLink', async () => {
            ...
            await client.initialize();
            client.pathTemplates.channelPartnerLinkPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.channelPartnerLinkPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('channelPartnerLinkPath', () => {
                const result = client.channelPartnerLinkPath("accountValue", "channelPartnerLinkValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.channelPartnerLinkPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchAccountFromChannelPartnerLinkName', () => {
                ...
                assert.strictEqual(result, "accountValue");
                assert((client.pathTemplates.channelPartnerLinkPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchChannelPartnerLinkFromChannelPartnerLinkName', () => {
                const result = client.matchChannelPartnerLinkFromChannelPartnerLinkName(fakePath);
        ...
        describe('channelPartnerRepricingConfig', async () => {
            ...
            it('channelPartnerRepricingConfigPath', () => {
                ...
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.channelPartnerRepricingConfigPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchAccountFromChannelPartnerRepricingConfigName', () => {
                const result = client.matchAccountFromChannelPartnerRepricingConfigName(fakePath);
                assert.strictEqual(result, "accountValue");
                assert((client.pathTemplates.channelPartnerRepricingConfigPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchChannelPartnerFromChannelPartnerRepricingConfigName', () => {
                const result = client.matchChannelPartnerFromChannelPartnerRepricingConfigName(fakePath);
            ...
            it('matchChannelPartnerRepricingConfigFromChannelPartnerRepricingConfigName', () => {
                const result = client.matchChannelPartnerRepricingConfigFromChannelPartnerRepricingConfigName(fakePath);
        ...
        describe('customerRepricingConfig', async () => {
            ...
            await client.initialize();
            client.pathTemplates.customerRepricingConfigPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.customerRepricingConfigPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('customerRepricingConfigPath', () => {
                const result = client.customerRepricingConfigPath("accountValue", "customerValue", "customerRepricingConfigValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.customerRepricingConfigPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchAccountFromCustomerRepricingConfigName', () => {
                const result = client.matchAccountFromCustomerRepricingConfigName(fakePath);
                assert.strictEqual(result, "accountValue");
                assert((client.pathTemplates.customerRepricingConfigPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchCustomerFromCustomerRepricingConfigName', () => {
                const result = client.matchCustomerFromCustomerRepricingConfigName(fakePath);
                assert.strictEqual(result, "customerValue");
                assert((client.pathTemplates.customerRepricingConfigPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchCustomerRepricingConfigFromCustomerRepricingConfigName', () => {
                const result = client.matchCustomerRepricingConfigFromCustomerRepricingConfigName(fakePath);
        ...
        describe('reportJob', async () => {
            ...
            await client.initialize();
            client.pathTemplates.reportJobPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.reportJobPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('reportJobPath', () => {
                const result = client.reportJobPath("accountValue", "reportJobValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.reportJobPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchAccountFromReportJobName', () => {
                ...
                assert.strictEqual(result, "accountValue");
                assert((client.pathTemplates.reportJobPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('skuGroup', async () => {
            ...
            await client.initialize();
            client.pathTemplates.skuGroupPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.skuGroupPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('skuGroupPath', () => {
                const result = client.skuGroupPath("accountValue", "skuGroupValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.skuGroupPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchAccountFromSkuGroupName', () => {
                ...
                assert.strictEqual(result, "accountValue");
                assert((client.pathTemplates.skuGroupPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
