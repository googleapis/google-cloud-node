...
# [Issueresolution: Nodejs Client][homepage]
...
Issueresolution client for Node.js
...
* [Issueresolution Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/issueresolution/latest)
* [Issueresolution Documentation](https://developers.google.com/merchant/api)
...
1.  [Enable the Issueresolution API][enable_api].
