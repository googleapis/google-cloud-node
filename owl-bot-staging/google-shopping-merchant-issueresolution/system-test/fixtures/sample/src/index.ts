...
} from '@google-shopping/issueresolution';

// check that the client class type name can be used
function doStuffWithAggregateProductStatusesServiceClient(
...
function main() {
  ...
  const aggregateProductStatusesServiceClient =
    new AggregateProductStatusesServiceClient();
  doStuffWithAggregateProductStatusesServiceClient(
    aggregateProductStatusesServiceClient,
  );
  // check that the client instance can be created
