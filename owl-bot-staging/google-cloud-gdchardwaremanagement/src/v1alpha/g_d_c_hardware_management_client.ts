...
export class GDCHardwareManagementClient {
  ...
  constructor(
    ...
    this.descriptors.longrunning = {
      ...
      requestOrderDateChange: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        requestOrderDateChangeResponse.decode.bind(
          requestOrderDateChangeResponse,
        ),
        requestOrderDateChangeMetadata.decode.bind(
          requestOrderDateChangeMetadata,
        ),
      ),
    };
  ...
  > | void {
    ...
    return this.innerApiCalls
      .requestOrderDateChange(request, options, wrappedCallback)
      ?.then(
        ([response, rawResponse, _]: [
          LROperation<
            protos.google.cloud.gdchardwaremanagement.v1alpha.IOrder,
   ...
   * region_tag:gdchardwaremanagement_v1alpha_generated_GDCHardwareManagement_RequestOrderDateChange_async
   */
  async checkRequestOrderDateChangeProgress(
    name: string,
  ): Promise<
    LROperation<
      protos.google.cloud.gdchardwaremanagement.v1alpha.Order,
  ...
  > {
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.requestOrderDateChange,
      this._gaxModule.createDefaultBackoffSettings(),
    );
    return decodeOperation as LROperation<
      protos.google.cloud.gdchardwaremanagement.v1alpha.Order,
