...
export class GDCHardwareManagementClient {
  ...
  initialize() {
    ...
    const gDCHardwareManagementStubMethods =
        ['listOrders', 'getOrder', 'createOrder', 'updateOrder', 'deleteOrder', 'submitOrder', 'listSites', 'getSite', 'createSite', 'updateSite', 'listHardwareGroups', 'getHardwareGroup', 'createHardwareGroup', 'updateHardwareGroup', 'deleteHardwareGroup', 'listHardware', 'getHardware', 'createHardware', 'updateHardware', 'deleteHardware', 'listComments', 'getComment', 'createComment', 'listChangeLogEntries', 'getChangeLogEntry', 'listSkus', 'getSku', 'listZones', 'getZone', 'createZone', 'updateZone', 'deleteZone', 'signalZoneState'];
