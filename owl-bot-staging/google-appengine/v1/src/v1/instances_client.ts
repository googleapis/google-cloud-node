...
export class InstancesClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const debugInstanceResponse = protoFilesRoot.lookup(
      '.google.appengine.v1.Instance') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.appengine.v1.Instances', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.instancesStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.appengine.v1.Instances') :
    ...
    const instancesStubMethods =
        ['listInstances', 'getInstance', 'deleteInstance', 'debugInstance'];
 ...
 *   The first element of the array is an object representing {@link google.appengine.v1.Instance | Instance}.
 *   Please see the
 ...
 */
  getInstance(
      ...
      Promise<[
        ...
        protos.google.appengine.v1.IGetInstanceRequest|undefined, {}|undefined
      ]>;
  getInstance(
      request: protos.google.appengine.v1.IGetInstanceRequest,
      options: CallOptions,
 ...
 */
  async checkDebugInstanceProgress(name: string): Promise<LROperation<protos.google.appengine.v1.Instance, protos.google.appengine.v1.OperationMetadataV1>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.debugInstance, this._gaxModule.createDefaultBackoffSettings());
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link google.appengine.v1.Instance | Instance}.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link google.appengine.v1.Instance | Instance} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   {@link google.appengine.v1.Instance | Instance}. The API will be called under the hood as needed, once per the page,
