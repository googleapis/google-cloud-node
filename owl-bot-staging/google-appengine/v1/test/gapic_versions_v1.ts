...
describe('v1.VersionsClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new versionsModule.v1.VersionsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'appengine.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new versionsModule.v1.VersionsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'appengine.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new versionsModule.v1.VersionsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new versionsModule.v1.VersionsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getVersion', () => {
        it('invokes getVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.appengine.v1.GetVersionRequest', ['name']);
        ...
        it('invokes getVersion without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getVersion(
                    request,
                    (err?: Error|null, result?: protos.google.appengine.v1.IVersion|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createVersion', () => {
        it('invokes createVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.appengine.v1.CreateVersionRequest', ['parent']);
        ...
        it('invokes createVersion without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createVersion(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.appengine.v1.IVersion, protos.google.appengine.v1.ICreateVersionMetadataV1>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.appengine.v1.IVersion, protos.google.appengine.v1.ICreateVersionMetadataV1>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createVersion as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateVersion', () => {
        it('invokes updateVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.appengine.v1.UpdateVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updateVersion = stubLongRunningCall(expectedResponse);
        ...
        it('invokes updateVersion without error using callback', async () => {
            ...
            client.innerApiCalls.updateVersion = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateVersion(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.appengine.v1.IVersion, protos.google.appengine.v1.IOperationMetadataV1>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.appengine.v1.IVersion, protos.google.appengine.v1.IOperationMetadataV1>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateVersion as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes updateVersion with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateVersion = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes updateVersion with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateVersion = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateVersion(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateVersion as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateVersionProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateVersionProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateVersionProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateVersionProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteVersion', () => {
        it('invokes deleteVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.appengine.v1.DeleteVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listVersions', () => {
        it('invokes listVersions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.appengine.v1.ListVersionsRequest', ['parent']);
            request.parent = defaultValue1;
