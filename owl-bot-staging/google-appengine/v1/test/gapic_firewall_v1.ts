...
describe('v1.FirewallClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new firewallModule.v1.FirewallClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'appengine.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new firewallModule.v1.FirewallClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'appengine.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new firewallModule.v1.FirewallClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new firewallModule.v1.FirewallClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('batchUpdateIngressRules', () => {
        it('invokes batchUpdateIngressRules without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.appengine.v1.BatchUpdateIngressRulesRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.appengine.v1.BatchUpdateIngressRulesResponse()
            );
            client.innerApiCalls.batchUpdateIngressRules = stubSimpleCall(expectedResponse);
            const [response] = await client.batchUpdateIngressRules(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchUpdateIngressRules as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchUpdateIngressRules as SinonStub)
        ...
        it('invokes batchUpdateIngressRules without error using callback', async () => {
            ...
            client.innerApiCalls.batchUpdateIngressRules = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchUpdateIngressRules(
                    request,
                    (err?: Error|null, result?: protos.google.appengine.v1.IBatchUpdateIngressRulesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchUpdateIngressRules with error', async () => {
            ...
            client.innerApiCalls.batchUpdateIngressRules = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.batchUpdateIngressRules(request), expectedError);
            const actualRequest = (client.innerApiCalls.batchUpdateIngressRules as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchUpdateIngressRules as SinonStub)
    ...
    describe('createIngressRule', () => {
        it('invokes createIngressRule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.appengine.v1.CreateIngressRuleRequest', ['parent']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createIngressRule as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createIngressRule as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createIngressRule without error using callback', async () => {
            ...
            client.innerApiCalls.createIngressRule = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createIngressRule(
                    request,
                    (err?: Error|null, result?: protos.google.appengine.v1.IFirewallRule|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createIngressRule with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createIngressRule = stubSimpleCall(undefined, expectedError);
    ...
    describe('getIngressRule', () => {
        it('invokes getIngressRule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.appengine.v1.GetIngressRuleRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.appengine.v1.FirewallRule()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getIngressRule as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getIngressRule as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getIngressRule without error using callback', async () => {
            ...
            client.innerApiCalls.getIngressRule = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getIngressRule with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getIngressRule = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateIngressRule', () => {
        it('invokes updateIngressRule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.appengine.v1.UpdateIngressRuleRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.appengine.v1.FirewallRule()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateIngressRule as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateIngressRule as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateIngressRule without error using callback', async () => {
            ...
            client.innerApiCalls.updateIngressRule = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateIngressRule with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateIngressRule = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteIngressRule', () => {
        it('invokes deleteIngressRule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.appengine.v1.DeleteIngressRuleRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteIngressRule as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteIngressRule as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteIngressRule without error using callback', async () => {
            ...
            client.innerApiCalls.deleteIngressRule = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteIngressRule with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteIngressRule = stubSimpleCall(undefined, expectedError);
    ...
    describe('listIngressRules', () => {
        it('invokes listIngressRules without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.appengine.v1.ListIngressRulesRequest', ['parent']);
            request.parent = defaultValue1;
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listIngressRules as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listIngressRules as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listIngressRules without error using callback', async () => {
            ...
            client.innerApiCalls.listIngressRules = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listIngressRules with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listIngressRules = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listIngressRulesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.appengine.v1.FirewallRule) => {
            ...
            assert((client.descriptors.page.listIngressRules.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listIngressRules, request));
            assert(
        ...
        it('invokes listIngressRulesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listIngressRules.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listIngressRulesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.appengine.v1.FirewallRule[] = [];
                stream.on('data', (response: protos.google.appengine.v1.FirewallRule) => {
        ...
        it('uses async iteration with listIngressRules without error', async () => {
            ...
            client.descriptors.page.listIngressRules.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listIngressRules with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listIngressRules.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listIngressRulesAsync(request);
