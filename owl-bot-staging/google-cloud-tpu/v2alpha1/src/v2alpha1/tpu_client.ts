...
export class TpuClient {
  ...
  initialize() {
    ...
    const tpuStubMethods =
        ['listNodes', 'getNode', 'createNode', 'deleteNode', 'stopNode', 'startNode', 'updateNode', 'listQueuedResources', 'getQueuedResource', 'createQueuedResource', 'deleteQueuedResource', 'resetQueuedResource', 'generateServiceIdentity', 'listAcceleratorTypes', 'getAcceleratorType', 'listRuntimeVersions', 'getRuntimeVersion', 'getGuestAttributes', 'simulateMaintenanceEvent'];
