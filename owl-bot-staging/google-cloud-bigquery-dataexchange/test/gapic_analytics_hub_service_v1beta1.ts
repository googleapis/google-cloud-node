...
describe('v1beta1.AnalyticsHubServiceClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new analyticshubserviceModule.v1beta1.AnalyticsHubServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'analyticshub.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new analyticshubserviceModule.v1beta1.AnalyticsHubServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'analyticshub.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new analyticshubserviceModule.v1beta1.AnalyticsHubServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new analyticshubserviceModule.v1beta1.AnalyticsHubServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getDataExchange', () => {
        it('invokes getDataExchange without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.dataexchange.v1beta1.GetDataExchangeRequest', ['name']);
    ...
    describe('createDataExchange', () => {
        it('invokes createDataExchange without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.dataexchange.v1beta1.CreateDataExchangeRequest', ['parent']);
    ...
    describe('updateDataExchange', () => {
        it('invokes updateDataExchange without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.dataexchange.v1beta1.UpdateDataExchangeRequest', ['dataExchange', 'name']);
    ...
    describe('deleteDataExchange', () => {
        it('invokes deleteDataExchange without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.dataexchange.v1beta1.DeleteDataExchangeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getListing', () => {
        it('invokes getListing without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.dataexchange.v1beta1.GetListingRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createListing', () => {
        it('invokes createListing without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.dataexchange.v1beta1.CreateListingRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.bigquery.dataexchange.v1beta1.Listing()
    ...
    describe('updateListing', () => {
        it('invokes updateListing without error', async () => {
            ...
            request.listing ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.dataexchange.v1beta1.UpdateListingRequest', ['listing', 'name']);
    ...
    describe('deleteListing', () => {
        it('invokes deleteListing without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.dataexchange.v1beta1.DeleteListingRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('subscribeListing', () => {
        it('invokes subscribeListing without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.dataexchange.v1beta1.SubscribeListingRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listDataExchanges', () => {
        it('invokes listDataExchanges without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.dataexchange.v1beta1.ListDataExchangesRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listOrgDataExchanges', () => {
        it('invokes listOrgDataExchanges without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.dataexchange.v1beta1.ListOrgDataExchangesRequest', ['organization']);
    ...
    describe('listListings', () => {
        it('invokes listListings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.dataexchange.v1beta1.ListListingsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
