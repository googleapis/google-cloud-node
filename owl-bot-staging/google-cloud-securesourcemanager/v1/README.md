...
# [Securesourcemanager: Nodejs Client][homepage]
...
Securesourcemanager client for Node.js
...
* [Securesourcemanager Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/securesourcemanager/latest)
* [Securesourcemanager Documentation](https://cloud.google.com/secure-source-manager/docs/overview)
...
1.  [Enable the Securesourcemanager API][enable_api].
