...
export class SecureSourceManagerClient {
  ...
  initialize() {
    ...
    const secureSourceManagerStubMethods =
        ['listInstances', 'getInstance', 'createInstance', 'deleteInstance', 'listRepositories', 'getRepository', 'createRepository', 'deleteRepository', 'getIamPolicyRepo', 'setIamPolicyRepo', 'testIamPermissionsRepo'];
 ...
 */
  ...
  testIamPermissionsRepo(
    ...
    this.initialize();
    return this.innerApiCalls.testIamPermissionsRepo(request, options, callback);
  }
