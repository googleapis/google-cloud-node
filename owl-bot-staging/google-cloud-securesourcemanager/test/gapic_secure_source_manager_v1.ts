...
describe('v1.SecureSourceManagerClient', () => {
  ...
  describe('getHook', () => {
    it('invokes getHook without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (client.innerApiCalls.getHook as SinonStub).getCall(
        0,
      ).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getHook as SinonStub
      ).getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
      assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
    });
    ...
    it('invokes getHook without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getHook(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.securesourcemanager.v1.IHook | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getPullRequest', () => {
    it('invokes getPullRequest without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getPullRequest as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getPullRequest as SinonStub
    ...
    it('invokes getPullRequest without error using callback', async () => {
      ...
      client.innerApiCalls.getPullRequest =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getPullRequest(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.securesourcemanager.v1.IPullRequest | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getPullRequest with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getPullRequest = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('fetchBlob', () => {
    it('invokes fetchBlob without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.fetchBlob as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.fetchBlob as SinonStub
    ...
    it('invokes fetchBlob without error using callback', async () => {
      ...
      client.innerApiCalls.fetchBlob =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.fetchBlob(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.securesourcemanager.v1.IFetchBlobResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getIssue without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getIssue(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.securesourcemanager.v1.IIssue | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getPullRequestComment', () => {
    it('invokes getPullRequestComment without error', async () => {
      ...
      client.innerApiCalls.getPullRequestComment =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getPullRequestComment(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getPullRequestComment as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getPullRequestComment as SinonStub
    ...
    it('invokes getPullRequestComment without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getPullRequestComment(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.securesourcemanager.v1.IPullRequestComment | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getPullRequestComment with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getPullRequestComment = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getPullRequestComment(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getPullRequestComment as SinonStub
  ...
  describe('getIssueComment', () => {
    it('invokes getIssueComment without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getIssueComment as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getIssueComment as SinonStub
    ...
    it('invokes getIssueComment without error using callback', async () => {
      ...
      client.innerApiCalls.getIssueComment =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getIssueComment(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.securesourcemanager.v1.IIssueComment | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getIssueComment with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getIssueComment = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateRepository', () => {
    ...
    it('invokes updateRepository with call error', async () => {
      ...
      const expectedHeaderRequestParams = `repository.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateRepository = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkUpdateRepositoryProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateRepositoryProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createHook', () => {
    it('invokes createHook without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createHook as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createHook as SinonStub
    ...
    it('invokes createHook without error using callback', async () => {
      ...
      client.innerApiCalls.createHook =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createHook(
          request,
    ...
    it('invokes createHook with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createHook = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateHook', () => {
    it('invokes updateHook without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateHook as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateHook as SinonStub
    ...
    it('invokes updateHook without error using callback', async () => {
      ...
      client.innerApiCalls.updateHook =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.updateHook(
          request,
    ...
    it('invokes updateHook with call error', async () => {
      ...
      const expectedHeaderRequestParams = `hook.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateHook = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteHook', () => {
    it('invokes deleteHook without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteHook as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteHook as SinonStub
    ...
    it('invokes deleteHook without error using callback', async () => {
      ...
      client.innerApiCalls.deleteHook =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.deleteHook(
          request,
    ...
    it('invokes deleteHook with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteHook = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('createPullRequest', () => {
    it('invokes createPullRequest without error', async () => {
      ...
      client.innerApiCalls.createPullRequest =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createPullRequest(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createPullRequest as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createPullRequest as SinonStub
    ...
    it('invokes createPullRequest with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createPullRequest = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkCreatePullRequestProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreatePullRequestProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updatePullRequest', () => {
    it('invokes updatePullRequest without error', async () => {
      ...
      client.innerApiCalls.updatePullRequest =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updatePullRequest(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updatePullRequest as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updatePullRequest as SinonStub
    ...
    it('invokes updatePullRequest with call error', async () => {
      ...
      const expectedHeaderRequestParams = `pull_request.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updatePullRequest = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkUpdatePullRequestProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdatePullRequestProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('mergePullRequest', () => {
    it('invokes mergePullRequest without error', async () => {
      ...
      client.innerApiCalls.mergePullRequest =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.mergePullRequest(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.mergePullRequest as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.mergePullRequest as SinonStub
    ...
    it('invokes mergePullRequest with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.mergePullRequest = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkMergePullRequestProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkMergePullRequestProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('openPullRequest', () => {
    it('invokes openPullRequest without error', async () => {
      ...
      client.innerApiCalls.openPullRequest =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.openPullRequest(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.openPullRequest as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.openPullRequest as SinonStub
    ...
    it('invokes openPullRequest with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.openPullRequest = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkOpenPullRequestProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkOpenPullRequestProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('closePullRequest', () => {
    it('invokes closePullRequest without error', async () => {
      ...
      client.innerApiCalls.closePullRequest =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.closePullRequest(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.closePullRequest as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.closePullRequest as SinonStub
    ...
    it('invokes closePullRequest with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.closePullRequest = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkClosePullRequestProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkClosePullRequestProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createIssue', () => {
    it('invokes createIssue without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createIssue as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createIssue as SinonStub
    ...
    it('invokes createIssue without error using callback', async () => {
      ...
      client.innerApiCalls.createIssue =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createIssue(
          request,
    ...
    it('invokes createIssue with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createIssue = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateIssue', () => {
    ...
    it('invokes updateIssue with call error', async () => {
      ...
      const expectedHeaderRequestParams = `issue.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateIssue = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteIssue', () => {
    ...
    it('invokes deleteIssue with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteIssue = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('openIssue', () => {
    it('invokes openIssue without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.openIssue as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.openIssue as SinonStub
    ...
    it('invokes openIssue without error using callback', async () => {
      ...
      client.innerApiCalls.openIssue =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.openIssue(
          request,
    ...
    it('invokes openIssue with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.openIssue = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('closeIssue', () => {
    it('invokes closeIssue without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.closeIssue as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.closeIssue as SinonStub
    ...
    it('invokes closeIssue without error using callback', async () => {
      ...
      client.innerApiCalls.closeIssue =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.closeIssue(
          request,
    ...
    it('invokes closeIssue with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.closeIssue = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('createPullRequestComment', () => {
    it('invokes createPullRequestComment without error', async () => {
      ...
      client.innerApiCalls.createPullRequestComment =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createPullRequestComment(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createPullRequestComment as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createPullRequestComment as SinonStub
    ...
    it('invokes createPullRequestComment with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createPullRequestComment = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createPullRequestComment(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createPullRequestComment as SinonStub
    ...
    it('invokes checkCreatePullRequestCommentProgress without error', async () => {
      ...
      const decodedOperation =
        await client.checkCreatePullRequestCommentProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkCreatePullRequestCommentProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreatePullRequestCommentProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updatePullRequestComment', () => {
    it('invokes updatePullRequestComment without error', async () => {
      ...
      client.innerApiCalls.updatePullRequestComment =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updatePullRequestComment(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updatePullRequestComment as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updatePullRequestComment as SinonStub
    ...
    it('invokes updatePullRequestComment with call error', async () => {
      ...
      const expectedHeaderRequestParams = `pull_request_comment.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updatePullRequestComment = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updatePullRequestComment(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updatePullRequestComment as SinonStub
    ...
    it('invokes checkUpdatePullRequestCommentProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkUpdatePullRequestCommentProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkUpdatePullRequestCommentProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdatePullRequestCommentProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deletePullRequestComment', () => {
    it('invokes deletePullRequestComment without error', async () => {
      ...
      client.innerApiCalls.deletePullRequestComment =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deletePullRequestComment(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deletePullRequestComment as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deletePullRequestComment as SinonStub
    ...
    it('invokes deletePullRequestComment with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deletePullRequestComment = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deletePullRequestComment(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deletePullRequestComment as SinonStub
    ...
    it('invokes checkDeletePullRequestCommentProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkDeletePullRequestCommentProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkDeletePullRequestCommentProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeletePullRequestCommentProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('batchCreatePullRequestComments', () => {
    it('invokes batchCreatePullRequestComments without error', async () => {
      ...
      client.innerApiCalls.batchCreatePullRequestComments =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.batchCreatePullRequestComments(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchCreatePullRequestComments as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchCreatePullRequestComments as SinonStub
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchCreatePullRequestComments(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.securesourcemanager.v1.IBatchCreatePullRequestCommentsResponse,
              protos.google.cloud.securesourcemanager.v1.IOperationMetadata
            > | null,
          ) => {
            if (err) {
    ...
    it('invokes batchCreatePullRequestComments with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchCreatePullRequestComments = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchCreatePullRequestComments(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchCreatePullRequestComments as SinonStub
    ...
    it('invokes checkBatchCreatePullRequestCommentsProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkBatchCreatePullRequestCommentsProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkBatchCreatePullRequestCommentsProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkBatchCreatePullRequestCommentsProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('resolvePullRequestComments', () => {
    it('invokes resolvePullRequestComments without error', async () => {
      ...
      client.innerApiCalls.resolvePullRequestComments =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.resolvePullRequestComments(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.resolvePullRequestComments as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.resolvePullRequestComments as SinonStub
      ...
      const promise = new Promise((resolve, reject) => {
        client.resolvePullRequestComments(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.securesourcemanager.v1.IResolvePullRequestCommentsResponse,
              protos.google.cloud.securesourcemanager.v1.IOperationMetadata
            > | null,
          ) => {
            if (err) {
    ...
    it('invokes resolvePullRequestComments with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.resolvePullRequestComments = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.resolvePullRequestComments(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.resolvePullRequestComments as SinonStub
    ...
    it('invokes checkResolvePullRequestCommentsProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkResolvePullRequestCommentsProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkResolvePullRequestCommentsProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkResolvePullRequestCommentsProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('unresolvePullRequestComments', () => {
    it('invokes unresolvePullRequestComments without error', async () => {
      ...
      client.innerApiCalls.unresolvePullRequestComments =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.unresolvePullRequestComments(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.unresolvePullRequestComments as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.unresolvePullRequestComments as SinonStub
      ...
      const promise = new Promise((resolve, reject) => {
        client.unresolvePullRequestComments(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.securesourcemanager.v1.IUnresolvePullRequestCommentsResponse,
              protos.google.cloud.securesourcemanager.v1.IOperationMetadata
            > | null,
          ) => {
            if (err) {
    ...
    it('invokes unresolvePullRequestComments with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.unresolvePullRequestComments = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.unresolvePullRequestComments(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.unresolvePullRequestComments as SinonStub
    ...
    it('invokes checkUnresolvePullRequestCommentsProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkUnresolvePullRequestCommentsProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkUnresolvePullRequestCommentsProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUnresolvePullRequestCommentsProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createIssueComment', () => {
    it('invokes createIssueComment without error', async () => {
      ...
      client.innerApiCalls.createIssueComment =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createIssueComment(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createIssueComment as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createIssueComment as SinonStub
    ...
    it('invokes createIssueComment with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createIssueComment = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkCreateIssueCommentProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateIssueCommentProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateIssueComment', () => {
    it('invokes updateIssueComment without error', async () => {
      ...
      client.innerApiCalls.updateIssueComment =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateIssueComment(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateIssueComment as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateIssueComment as SinonStub
    ...
    it('invokes updateIssueComment with call error', async () => {
      ...
      const expectedHeaderRequestParams = `issue_comment.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateIssueComment = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkUpdateIssueCommentProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateIssueCommentProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteIssueComment', () => {
    it('invokes deleteIssueComment without error', async () => {
      ...
      client.innerApiCalls.deleteIssueComment =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteIssueComment(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteIssueComment as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteIssueComment as SinonStub
    ...
    it('invokes deleteIssueComment with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteIssueComment = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkDeleteIssueCommentProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteIssueCommentProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listHooks', () => {
    it('invokes listHooks without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listHooks as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listHooks as SinonStub
    ...
    it('invokes listHooks without error using callback', async () => {
      ...
      client.innerApiCalls.listHooks =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listHooks(
          request,
    ...
    it('invokes listHooksStream without error', async () => {
      ...
      client.descriptors.page.listHooks.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.securesourcemanager.v1.Hook) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listHooks.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listHooks, request),
      );
      assert(
        (client.descriptors.page.listHooks.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listHooksStream with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listHooks.createStream = stubPageStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.listHooksStream(request);
    ...
    it('uses async iteration with listHooks without error', async () => {
      ...
      client.descriptors.page.listHooks.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      ...
      assert.deepStrictEqual(responses, expectedResponse);
      assert.deepStrictEqual(
        (client.descriptors.page.listHooks.asyncIterate as SinonStub).getCall(0)
          .args[1],
        request,
      );
      assert(
    ...
    it('uses async iteration with listHooks with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listHooks.asyncIterate = stubAsyncIterationCall(
        undefined,
        expectedError,
      );
      const iterable = client.listHooksAsync(request);
  ...
  describe('listPullRequests', () => {
    it('invokes listPullRequests without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listPullRequests as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listPullRequests as SinonStub
    ...
    it('invokes listPullRequests without error using callback', async () => {
      ...
      client.innerApiCalls.listPullRequests =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listPullRequests with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listPullRequests = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listPullRequestsStream without error', async () => {
      ...
      client.descriptors.page.listPullRequests.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.securesourcemanager.v1.PullRequest,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (client.descriptors.page.listPullRequests.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listPullRequests, request),
      );
      assert(
        (client.descriptors.page.listPullRequests.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listPullRequests without error', async () => {
      ...
      client.descriptors.page.listPullRequests.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listPullRequestFileDiffs', () => {
    it('invokes listPullRequestFileDiffs without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.securesourcemanager.v1.FileDiff(),
        ),
        generateSampleMessage(
          new protos.google.cloud.securesourcemanager.v1.FileDiff(),
        ),
      ...
      client.innerApiCalls.listPullRequestFileDiffs =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listPullRequestFileDiffs(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listPullRequestFileDiffs as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listPullRequestFileDiffs as SinonStub
    ...
    it('invokes listPullRequestFileDiffs with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listPullRequestFileDiffs = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listPullRequestFileDiffs(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listPullRequestFileDiffs as SinonStub
    ...
    it('invokes listPullRequestFileDiffsStream without error', async () => {
      ...
      client.descriptors.page.listPullRequestFileDiffs.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.securesourcemanager.v1.FileDiff) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (
          client.descriptors.page.listPullRequestFileDiffs
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listPullRequestFileDiffs, request),
      );
      assert(
        (
          client.descriptors.page.listPullRequestFileDiffs
    ...
    it('uses async iteration with listPullRequestFileDiffs without error', async () => {
      ...
      client.descriptors.page.listPullRequestFileDiffs.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('fetchTree', () => {
    it('invokes fetchTree without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.securesourcemanager.v1.TreeEntry(),
        ),
        generateSampleMessage(
          new protos.google.cloud.securesourcemanager.v1.TreeEntry(),
        ),
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.fetchTree as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.fetchTree as SinonStub
    ...
    it('invokes fetchTree without error using callback', async () => {
      ...
      client.innerApiCalls.fetchTree =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.fetchTree(
          request,
    ...
    it('invokes fetchTreeStream without error', async () => {
      ...
      client.descriptors.page.fetchTree.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.securesourcemanager.v1.TreeEntry) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.fetchTree.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.fetchTree, request),
      );
      assert(
        (client.descriptors.page.fetchTree.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes fetchTreeStream with error', async () => {
      ...
      const expectedHeaderRequestParams = `repository=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.fetchTree.createStream = stubPageStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.fetchTreeStream(request);
    ...
    it('uses async iteration with fetchTree without error', async () => {
      ...
      client.descriptors.page.fetchTree.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      ...
      assert.deepStrictEqual(responses, expectedResponse);
      assert.deepStrictEqual(
        (client.descriptors.page.fetchTree.asyncIterate as SinonStub).getCall(0)
          .args[1],
        request,
      );
      assert(
    ...
    it('uses async iteration with fetchTree with error', async () => {
      ...
      const expectedHeaderRequestParams = `repository=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.fetchTree.asyncIterate = stubAsyncIterationCall(
        undefined,
        expectedError,
      );
      const iterable = client.fetchTreeAsync(request);
  ...
  describe('listIssues', () => {
    ...
    it('invokes listIssuesStream without error', async () => {
      ...
      client.descriptors.page.listIssues.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.securesourcemanager.v1.Issue) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listIssues.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listIssues, request),
      );
      assert(
        (client.descriptors.page.listIssues.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listIssuesStream with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listIssues.createStream = stubPageStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.listIssuesStream(request);
    ...
    it('uses async iteration with listIssues without error', async () => {
      ...
      client.descriptors.page.listIssues.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      ...
      assert.deepStrictEqual(responses, expectedResponse);
      assert.deepStrictEqual(
        (client.descriptors.page.listIssues.asyncIterate as SinonStub).getCall(
          0,
        ).args[1],
        request,
      );
    ...
    it('uses async iteration with listIssues with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listIssues.asyncIterate = stubAsyncIterationCall(
        undefined,
        expectedError,
      );
      const iterable = client.listIssuesAsync(request);
  ...
  describe('listPullRequestComments', () => {
    it('invokes listPullRequestComments without error', async () => {
      ...
      client.innerApiCalls.listPullRequestComments =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listPullRequestComments(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listPullRequestComments as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listPullRequestComments as SinonStub
    ...
    it('invokes listPullRequestComments with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listPullRequestComments = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listPullRequestComments(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listPullRequestComments as SinonStub
    ...
    it('invokes listPullRequestCommentsStream without error', async () => {
      ...
      client.descriptors.page.listPullRequestComments.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.securesourcemanager.v1.PullRequestComment,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (
          client.descriptors.page.listPullRequestComments
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listPullRequestComments, request),
      );
      assert(
        (
          client.descriptors.page.listPullRequestComments
    ...
    it('uses async iteration with listPullRequestComments without error', async () => {
      ...
      client.descriptors.page.listPullRequestComments.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listIssueComments', () => {
    it('invokes listIssueComments without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listIssueComments as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listIssueComments as SinonStub
    ...
    it('invokes listIssueComments without error using callback', async () => {
      ...
      client.innerApiCalls.listIssueComments =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listIssueComments with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listIssueComments = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listIssueCommentsStream without error', async () => {
      ...
      client.descriptors.page.listIssueComments.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.securesourcemanager.v1.IssueComment,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (client.descriptors.page.listIssueComments.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listIssueComments, request),
      );
      assert(
        (client.descriptors.page.listIssueComments.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listIssueComments without error', async () => {
      ...
      client.descriptors.page.listIssueComments.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('Path templates', () => {
    ...
    describe('hook', async () => {
      ...
      await client.initialize();
      client.pathTemplates.hookPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.hookPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('hookPath', () => {
        const result = client.hookPath(
          'projectValue',
          'locationValue',
          'repositoryValue',
          'hookValue',
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.hookPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromHookName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.hookPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('issueComment', async () => {
      ...
      await client.initialize();
      client.pathTemplates.issueCommentPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.issueCommentPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('issueCommentPath', () => {
        const result = client.issueCommentPath(
          'projectValue',
          'locationValue',
          'repositoryValue',
          'issueValue',
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.issueCommentPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromIssueCommentName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.issueCommentPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('pullRequest', async () => {
      ...
      await client.initialize();
      client.pathTemplates.pullRequestPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.pullRequestPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('pullRequestPath', () => {
        const result = client.pullRequestPath(
          'projectValue',
          'locationValue',
          'repositoryValue',
          'pullRequestValue',
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.pullRequestPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromPullRequestName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.pullRequestPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('pullRequestComment', async () => {
      ...
      await client.initialize();
      client.pathTemplates.pullRequestCommentPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.pullRequestCommentPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('pullRequestCommentPath', () => {
        const result = client.pullRequestCommentPath(
          'projectValue',
          'locationValue',
          'repositoryValue',
          'pullRequestValue',
        ...
        assert(
          (
            client.pathTemplates.pullRequestCommentPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchRepositoryFromPullRequestCommentName', () => {
        const result =
          client.matchRepositoryFromPullRequestCommentName(fakePath);
        assert.strictEqual(result, 'repositoryValue');
        assert(
          (
            client.pathTemplates.pullRequestCommentPathTemplate
      ...
      it('matchPullRequestFromPullRequestCommentName', () => {
        const result =
          client.matchPullRequestFromPullRequestCommentName(fakePath);
        assert.strictEqual(result, 'pullRequestValue');
        assert(
          (
            client.pathTemplates.pullRequestCommentPathTemplate
