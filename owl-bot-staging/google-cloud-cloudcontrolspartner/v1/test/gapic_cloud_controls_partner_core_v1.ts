...
describe('v1.CloudControlsPartnerCoreClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new cloudcontrolspartnercoreModule.v1.CloudControlsPartnerCoreClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = cloudcontrolspartnercoreModule.v1.CloudControlsPartnerCoreClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = cloudcontrolspartnercoreModule.v1.CloudControlsPartnerCoreClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'cloudcontrolspartner.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new cloudcontrolspartnercoreModule.v1.CloudControlsPartnerCoreClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'cloudcontrolspartner.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new cloudcontrolspartnercoreModule.v1.CloudControlsPartnerCoreClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'cloudcontrolspartner.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new cloudcontrolspartnercoreModule.v1.CloudControlsPartnerCoreClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new cloudcontrolspartnercoreModule.v1.CloudControlsPartnerCoreClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = cloudcontrolspartnercoreModule.v1.CloudControlsPartnerCoreClient.port;
            assert(port);
    ...
    describe('getWorkload', () => {
        it('invokes getWorkload without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.cloudcontrolspartner.v1.GetWorkloadRequest', ['name']);
        ...
        it('invokes getWorkload without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getWorkload(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.cloudcontrolspartner.v1.IWorkload|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getCustomer', () => {
        it('invokes getCustomer without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.cloudcontrolspartner.v1.GetCustomerRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getCustomer without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCustomer(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.cloudcontrolspartner.v1.ICustomer|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getEkmConnections', () => {
        it('invokes getEkmConnections without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.cloudcontrolspartner.v1.GetEkmConnectionsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getEkmConnections without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getEkmConnections(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.cloudcontrolspartner.v1.IEkmConnections|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getPartnerPermissions', () => {
        it('invokes getPartnerPermissions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.cloudcontrolspartner.v1.GetPartnerPermissionsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getPartnerPermissions without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getPartnerPermissions(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.cloudcontrolspartner.v1.IPartnerPermissions|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getPartner', () => {
        it('invokes getPartner without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.cloudcontrolspartner.v1.GetPartnerRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getPartner without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getPartner(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.cloudcontrolspartner.v1.IPartner|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createCustomer', () => {
        it('invokes createCustomer without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.cloudcontrolspartner.v1.CreateCustomerRequest', ['parent']);
    ...
    describe('updateCustomer', () => {
        it('invokes updateCustomer without error', async () => {
            ...
            request.customer ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.cloudcontrolspartner.v1.UpdateCustomerRequest', ['customer', 'name']);
    ...
    describe('deleteCustomer', () => {
        it('invokes deleteCustomer without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.cloudcontrolspartner.v1.DeleteCustomerRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listWorkloads', () => {
        it('invokes listWorkloads without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.cloudcontrolspartner.v1.ListWorkloadsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.cloudcontrolspartner.v1.Workload()),
              generateSampleMessage(new protos.google.cloud.cloudcontrolspartner.v1.Workload()),
              generateSampleMessage(new protos.google.cloud.cloudcontrolspartner.v1.Workload()),
            ];
        ...
        it('invokes listWorkloadsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.cloudcontrolspartner.v1.Workload) => {
    ...
    describe('listCustomers', () => {
        it('invokes listCustomers without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.cloudcontrolspartner.v1.ListCustomersRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.cloudcontrolspartner.v1.Customer()),
              generateSampleMessage(new protos.google.cloud.cloudcontrolspartner.v1.Customer()),
              generateSampleMessage(new protos.google.cloud.cloudcontrolspartner.v1.Customer()),
            ];
        ...
        it('invokes listCustomersStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.cloudcontrolspartner.v1.Customer) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listAccessApprovalRequests', () => {
        it('invokes listAccessApprovalRequests without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.cloudcontrolspartner.v1.ListAccessApprovalRequestsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
        ...
        it('invokes listAccessApprovalRequests without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listAccessApprovalRequests(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.cloudcontrolspartner.v1.IAccessApprovalRequest[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
