...
export {v1, CloudControlsPartnerCoreClient, CloudControlsPartnerMonitoringClient};
export default {v1, CloudControlsPartnerCoreClient, CloudControlsPartnerMonitoringClient};
