...
export class CloudControlsPartnerCoreClient {
  ...
  initialize() {
    ...
    const cloudControlsPartnerCoreStubMethods =
        ['getWorkload', 'listWorkloads', 'getCustomer', 'listCustomers', 'getEkmConnections', 'getPartnerPermissions', 'listAccessApprovalRequests', 'getPartner'];
 ...
 */
  ...
  listAccessApprovalRequests(
    ...
    return this.innerApiCalls.listAccessApprovalRequests(request, options, callback);
  }
