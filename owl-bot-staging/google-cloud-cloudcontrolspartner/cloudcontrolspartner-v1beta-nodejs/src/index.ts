...
export {v1beta, CloudControlsPartnerCoreClient, CloudControlsPartnerMonitoringClient};
export default {v1beta, CloudControlsPartnerCoreClient, CloudControlsPartnerMonitoringClient};
