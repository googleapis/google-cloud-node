...
describe('v1.ManagedNotebookServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new managednotebookserviceModule.v1.ManagedNotebookServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = managednotebookserviceModule.v1.ManagedNotebookServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = managednotebookserviceModule.v1.ManagedNotebookServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'notebooks.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new managednotebookserviceModule.v1.ManagedNotebookServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'notebooks.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new managednotebookserviceModule.v1.ManagedNotebookServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'notebooks.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new managednotebookserviceModule.v1.ManagedNotebookServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new managednotebookserviceModule.v1.ManagedNotebookServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = managednotebookserviceModule.v1.ManagedNotebookServiceClient.port;
            assert(port);
    ...
    describe('getRuntime', () => {
        it('invokes getRuntime without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.notebooks.v1.GetRuntimeRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getRuntime as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getRuntime as SinonStub)
        ...
        it('invokes getRuntime without error using callback', async () => {
            ...
            client.innerApiCalls.getRuntime = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getRuntime(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.notebooks.v1.IRuntime|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getRuntime with error', async () => {
            ...
            client.innerApiCalls.getRuntime = stubSimpleCall(undefined, expectedError);
    ...
    describe('refreshRuntimeTokenInternal', () => {
        it('invokes refreshRuntimeTokenInternal without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.notebooks.v1.RefreshRuntimeTokenInternalRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.notebooks.v1.RefreshRuntimeTokenInternalResponse()
            );
            client.innerApiCalls.refreshRuntimeTokenInternal = stubSimpleCall(expectedResponse);
            const [response] = await client.refreshRuntimeTokenInternal(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.refreshRuntimeTokenInternal as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.refreshRuntimeTokenInternal as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes refreshRuntimeTokenInternal without error using callback', async () => {
            ...
            client.innerApiCalls.refreshRuntimeTokenInternal = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.refreshRuntimeTokenInternal(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.notebooks.v1.IRefreshRuntimeTokenInternalResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes refreshRuntimeTokenInternal with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.refreshRuntimeTokenInternal = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.refreshRuntimeTokenInternal(request), expectedError);
            const actualRequest = (client.innerApiCalls.refreshRuntimeTokenInternal as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.refreshRuntimeTokenInternal as SinonStub)
    ...
    describe('createRuntime', () => {
        it('invokes createRuntime without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.notebooks.v1.CreateRuntimeRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createRuntime = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createRuntime(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createRuntime as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createRuntime as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createRuntime without error using callback', async () => {
            ...
            client.innerApiCalls.createRuntime = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createRuntime(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.notebooks.v1.IRuntime, protos.google.cloud.notebooks.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.notebooks.v1.IRuntime, protos.google.cloud.notebooks.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createRuntime as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createRuntime with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createRuntime = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes createRuntime with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createRuntime = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createRuntime(request);
        ...
        it('invokes checkCreateRuntimeProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateRuntimeProgress(expectedResponse.name);
        ...
        it('invokes checkCreateRuntimeProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreateRuntimeProgress(''), expectedError);
    ...
    describe('updateRuntime', () => {
        it('invokes updateRuntime without error', async () => {
            ...
            request.runtime ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.notebooks.v1.UpdateRuntimeRequest', ['runtime', 'name']);
            request.runtime.name = defaultValue1;
            const expectedHeaderRequestParams = `runtime.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updateRuntime = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateRuntime(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateRuntime as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateRuntime as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateRuntime without error using callback', async () => {
            ...
            client.innerApiCalls.updateRuntime = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateRuntime with call error', async () => {
            ...
            const expectedHeaderRequestParams = `runtime.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateRuntime = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes updateRuntime with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `runtime.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateRuntime = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateRuntime(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateRuntime as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateRuntimeProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateRuntimeProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateRuntimeProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateRuntimeProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteRuntime', () => {
        it('invokes deleteRuntime without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.notebooks.v1.DeleteRuntimeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteRuntime = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteRuntime(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteRuntime as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteRuntime as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteRuntime without error using callback', async () => {
            ...
            client.innerApiCalls.deleteRuntime = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteRuntime with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteRuntime = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes deleteRuntime with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteRuntime = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteRuntime(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteRuntime as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteRuntimeProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteRuntimeProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteRuntimeProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteRuntimeProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('startRuntime', () => {
        it('invokes startRuntime without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.notebooks.v1.StartRuntimeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.startRuntime as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.startRuntime as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes startRuntime without error using callback', async () => {
            ...
            client.innerApiCalls.startRuntime = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.startRuntime(
                    request,
                    (err?: Error|null,
        ...
        it('invokes startRuntime with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.startRuntime = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes startRuntime with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.startRuntime = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.startRuntime(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.startRuntime as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkStartRuntimeProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkStartRuntimeProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('stopRuntime', () => {
        it('invokes stopRuntime without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.notebooks.v1.StopRuntimeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.stopRuntime as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.stopRuntime as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes stopRuntime without error using callback', async () => {
            ...
            client.innerApiCalls.stopRuntime = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.stopRuntime(
                    request,
                    (err?: Error|null,
        ...
        it('invokes stopRuntime with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.stopRuntime = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes stopRuntime with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.stopRuntime = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.stopRuntime(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.stopRuntime as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkStopRuntimeProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkStopRuntimeProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('switchRuntime', () => {
        it('invokes switchRuntime without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.notebooks.v1.SwitchRuntimeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.switchRuntime = stubLongRunningCall(expectedResponse);
            const [operation] = await client.switchRuntime(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.switchRuntime as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.switchRuntime as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes switchRuntime without error using callback', async () => {
            ...
            client.innerApiCalls.switchRuntime = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes switchRuntime with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.switchRuntime = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes switchRuntime with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.switchRuntime = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.switchRuntime(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.switchRuntime as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkSwitchRuntimeProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkSwitchRuntimeProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkSwitchRuntimeProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkSwitchRuntimeProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('resetRuntime', () => {
        it('invokes resetRuntime without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.notebooks.v1.ResetRuntimeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.resetRuntime as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.resetRuntime as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes resetRuntime without error using callback', async () => {
            ...
            client.innerApiCalls.resetRuntime = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.resetRuntime(
                    request,
                    (err?: Error|null,
        ...
        it('invokes resetRuntime with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.resetRuntime = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes resetRuntime with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.resetRuntime = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.resetRuntime(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.resetRuntime as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkResetRuntimeProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkResetRuntimeProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('upgradeRuntime', () => {
        it('invokes upgradeRuntime without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.notebooks.v1.UpgradeRuntimeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.upgradeRuntime = stubLongRunningCall(expectedResponse);
            const [operation] = await client.upgradeRuntime(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.upgradeRuntime as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.upgradeRuntime as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes upgradeRuntime without error using callback', async () => {
            ...
            client.innerApiCalls.upgradeRuntime = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes upgradeRuntime with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.upgradeRuntime = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes upgradeRuntime with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.upgradeRuntime = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.upgradeRuntime(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.upgradeRuntime as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpgradeRuntimeProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpgradeRuntimeProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpgradeRuntimeProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpgradeRuntimeProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('reportRuntimeEvent', () => {
        it('invokes reportRuntimeEvent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.notebooks.v1.ReportRuntimeEventRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.reportRuntimeEvent = stubLongRunningCall(expectedResponse);
            const [operation] = await client.reportRuntimeEvent(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.reportRuntimeEvent as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.reportRuntimeEvent as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes reportRuntimeEvent without error using callback', async () => {
            ...
            client.innerApiCalls.reportRuntimeEvent = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes reportRuntimeEvent with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.reportRuntimeEvent = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes reportRuntimeEvent with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.reportRuntimeEvent = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.reportRuntimeEvent(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.reportRuntimeEvent as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkReportRuntimeEventProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkReportRuntimeEventProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkReportRuntimeEventProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkReportRuntimeEventProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('diagnoseRuntime', () => {
        it('invokes diagnoseRuntime without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.notebooks.v1.DiagnoseRuntimeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.diagnoseRuntime = stubLongRunningCall(expectedResponse);
            const [operation] = await client.diagnoseRuntime(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.diagnoseRuntime as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.diagnoseRuntime as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes diagnoseRuntime without error using callback', async () => {
            ...
            client.innerApiCalls.diagnoseRuntime = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes diagnoseRuntime with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.diagnoseRuntime = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes diagnoseRuntime with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.diagnoseRuntime = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.diagnoseRuntime(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.diagnoseRuntime as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDiagnoseRuntimeProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDiagnoseRuntimeProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDiagnoseRuntimeProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDiagnoseRuntimeProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listRuntimes', () => {
        it('invokes listRuntimes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.notebooks.v1.ListRuntimesRequest', ['parent']);
            request.parent = defaultValue1;
        ...
        it('invokes listRuntimesStream without error', async () => {
            ...
            client.descriptors.page.listRuntimes.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listRuntimesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.notebooks.v1.Runtime[] = [];
                stream.on('data', (response: protos.google.cloud.notebooks.v1.Runtime) => {
            ...
            assert((client.descriptors.page.listRuntimes.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listRuntimes, request));
            assert(
        ...
        it('invokes listRuntimesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listRuntimes.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listRuntimesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.notebooks.v1.Runtime[] = [];
                stream.on('data', (response: protos.google.cloud.notebooks.v1.Runtime) => {
        ...
        it('uses async iteration with listRuntimes without error', async () => {
            ...
            client.descriptors.page.listRuntimes.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listRuntimes with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listRuntimes.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listRuntimesAsync(request);
