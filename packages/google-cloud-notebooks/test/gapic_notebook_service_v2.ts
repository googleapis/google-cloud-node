...
describe('v2.NotebookServiceClient', () => {
    ...
    it('invokes getInstance without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getInstance(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.notebooks.v2.IInstance | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('checkInstanceUpgradability', () => {
    it('invokes checkInstanceUpgradability without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.checkInstanceUpgradability as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.checkInstanceUpgradability as SinonStub
    ...
    it('invokes checkInstanceUpgradability without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.checkInstanceUpgradability(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.notebooks.v2.ICheckInstanceUpgradabilityResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes checkInstanceUpgradability with error', async () => {
      ...
      const expectedHeaderRequestParams = `notebook_instance=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.checkInstanceUpgradability = stubSimpleCall(
        undefined,
        expectedError
      );
  ...
  describe('listInstances', () => {
    ...
    it('invokes listInstancesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.notebooks.v2.Instance) => {
