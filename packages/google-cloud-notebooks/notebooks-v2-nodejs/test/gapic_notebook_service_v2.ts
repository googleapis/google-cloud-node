...
describe('v2.NotebookServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = notebookserviceModule.v2.NotebookServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = notebookserviceModule.v2.NotebookServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'notebooks.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new notebookserviceModule.v2.NotebookServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'notebooks.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new notebookserviceModule.v2.NotebookServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'notebooks.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new notebookserviceModule.v2.NotebookServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new notebookserviceModule.v2.NotebookServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = notebookserviceModule.v2.NotebookServiceClient.port;
            assert(port);
    ...
    describe('getInstance', () => {
        it('invokes getInstance without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.notebooks.v2.GetInstanceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.notebooks.v2.GetInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.notebooks.v2.Instance()
            );
        ...
        it('invokes getInstance without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getInstance(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.notebooks.v2.IInstance|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('checkInstanceUpgradability', () => {
        it('invokes checkInstanceUpgradability without error', async () => {
            const client = new notebookserviceModule.v2.NotebookServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.notebooks.v2.CheckInstanceUpgradabilityRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.notebooks.v2.CheckInstanceUpgradabilityRequest', ['notebookInstance']);
            request.notebookInstance = defaultValue1;
            const expectedHeaderRequestParams = `notebook_instance=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.notebooks.v2.CheckInstanceUpgradabilityResponse()
            );
            client.innerApiCalls.checkInstanceUpgradability = stubSimpleCall(expectedResponse);
            const [response] = await client.checkInstanceUpgradability(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.checkInstanceUpgradability as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.checkInstanceUpgradability as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes checkInstanceUpgradability without error using callback', async () => {
            const client = new notebookserviceModule.v2.NotebookServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.checkInstanceUpgradability = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.checkInstanceUpgradability(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.notebooks.v2.ICheckInstanceUpgradabilityResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes checkInstanceUpgradability with error', async () => {
            const client = new notebookserviceModule.v2.NotebookServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `notebook_instance=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.checkInstanceUpgradability = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkInstanceUpgradability(request), expectedError);
            const actualRequest = (client.innerApiCalls.checkInstanceUpgradability as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.checkInstanceUpgradability as SinonStub)
        ...
        it('invokes checkInstanceUpgradability with closed client', async () => {
            const client = new notebookserviceModule.v2.NotebookServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('createInstance', () => {
        it('invokes createInstance without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.notebooks.v2.CreateInstanceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.notebooks.v2.CreateInstanceRequest', ['parent']);
        ...
        it('invokes createInstance without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createInstance(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.notebooks.v2.IInstance, protos.google.cloud.notebooks.v2.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.notebooks.v2.IInstance, protos.google.cloud.notebooks.v2.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createInstance as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateInstance', () => {
        it('invokes updateInstance without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.notebooks.v2.UpdateInstanceRequest()
            );
            request.instance ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.notebooks.v2.UpdateInstanceRequest', ['instance', 'name']);
    ...
    describe('deleteInstance', () => {
        it('invokes deleteInstance without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.notebooks.v2.DeleteInstanceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.notebooks.v2.DeleteInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes deleteInstance without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deleteInstance(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.notebooks.v2.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.notebooks.v2.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteInstance as SinonStub)
                .getCall(0).args[0];
    ...
    describe('startInstance', () => {
        it('invokes startInstance without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.notebooks.v2.StartInstanceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.notebooks.v2.StartInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('stopInstance', () => {
        it('invokes stopInstance without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.notebooks.v2.StopInstanceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.notebooks.v2.StopInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('resetInstance', () => {
        it('invokes resetInstance without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.notebooks.v2.ResetInstanceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.notebooks.v2.ResetInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('upgradeInstance', () => {
        it('invokes upgradeInstance without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.notebooks.v2.UpgradeInstanceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.notebooks.v2.UpgradeInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('rollbackInstance', () => {
        it('invokes rollbackInstance without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.notebooks.v2.RollbackInstanceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.notebooks.v2.RollbackInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('diagnoseInstance', () => {
        it('invokes diagnoseInstance without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.notebooks.v2.DiagnoseInstanceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.notebooks.v2.DiagnoseInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listInstances', () => {
        it('invokes listInstances without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.notebooks.v2.ListInstancesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.notebooks.v2.ListInstancesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.notebooks.v2.Instance()),
              generateSampleMessage(new protos.google.cloud.notebooks.v2.Instance()),
              generateSampleMessage(new protos.google.cloud.notebooks.v2.Instance()),
            ];
        ...
        it('invokes listInstancesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.notebooks.v2.Instance[] = [];
                stream.on('data', (response: protos.google.cloud.notebooks.v2.Instance) => {
        ...
        it('uses async iteration with listInstances without error', async () => {
            ...
            const responses: protos.google.cloud.notebooks.v2.IInstance[] = [];
