...
[the CHANGELOG](https://github.com/googleapis/nodejs-notebooks/blob/master/CHANGELOG.md).
...
Samples are in the [`samples/`](https://github.com/googleapis/nodejs-notebooks/tree/master/samples) directory. Each sample's `README.md` has instructions for running its sample.
...
Contributions welcome! See the [Contributing Guide](https://github.com/googleapis/nodejs-notebooks/blob/master/CONTRIBUTING.md).
...
See [LICENSE](https://github.com/googleapis/nodejs-notebooks/blob/master/LICENSE)

[client-docs]: https://googleapis.dev/nodejs/notebooks/latest
