...
describe('v1p1beta1.VideoIntelligenceServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = videointelligenceserviceModule.v1p1beta1.VideoIntelligenceServiceClient.servicePath;
        assert(servicePath);
    });
    it('has apiEndpoint', () => {
        const apiEndpoint = videointelligenceserviceModule.v1p1beta1.VideoIntelligenceServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });
    it('has port', () => {
        const port = videointelligenceserviceModule.v1p1beta1.VideoIntelligenceServiceClient.port;
        assert(port);
