...
describe('v1.GkeHubClient', () => {
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new gkehubModule.v1.GkeHubClient({
          universe_domain: 'example.com',
  ...
  describe('getFleet', () => {
    it('invokes getFleet without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getFleet as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getFleet as SinonStub
    ...
    it('invokes getFleet without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getFleet(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.gkehub.v1.IFleet | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getScopeNamespace', () => {
    it('invokes getScopeNamespace without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getScopeNamespace as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getScopeNamespace as SinonStub
    ...
    it('invokes getScopeNamespace without error using callback', async () => {
      ...
      client.innerApiCalls.getScopeNamespace =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getScopeNamespace(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.gkehub.v1.INamespace | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getScopeNamespace with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getScopeNamespace = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getScopeRBACRoleBinding', () => {
    it('invokes getScopeRBACRoleBinding without error', async () => {
      ...
      client.innerApiCalls.getScopeRbacRoleBinding =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getScopeRBACRoleBinding(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getScopeRbacRoleBinding as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getScopeRbacRoleBinding as SinonStub
    ...
    it('invokes getScopeRBACRoleBinding without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getScopeRBACRoleBinding(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.gkehub.v1.IRBACRoleBinding | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getScopeRBACRoleBinding with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getScopeRbacRoleBinding = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getScopeRBACRoleBinding(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getScopeRbacRoleBinding as SinonStub
  ...
  describe('getScope', () => {
    it('invokes getScope without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getScope as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getScope as SinonStub
    ...
    it('invokes getScope without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getScope(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.gkehub.v1.IScope | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getMembershipBinding', () => {
    it('invokes getMembershipBinding without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getMembershipBinding as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getMembershipBinding as SinonStub
    ...
    it('invokes getMembershipBinding without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getMembershipBinding(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.gkehub.v1.IMembershipBinding | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getMembershipBinding with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getMembershipBinding = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getMembershipRBACRoleBinding', () => {
    it('invokes getMembershipRBACRoleBinding without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getMembershipRbacRoleBinding as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getMembershipRbacRoleBinding as SinonStub
    ...
    it('invokes getMembershipRBACRoleBinding with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getMembershipRbacRoleBinding = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getMembershipRBACRoleBinding(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getMembershipRbacRoleBinding as SinonStub
  ...
  describe('generateMembershipRBACRoleBindingYAML', () => {
    it('invokes generateMembershipRBACRoleBindingYAML without error', async () => {
      ...
      client.innerApiCalls.generateMembershipRbacRoleBindingYamL =
        stubSimpleCall(expectedResponse);
      const [response] =
        await client.generateMembershipRBACRoleBindingYAML(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.generateMembershipRbacRoleBindingYamL as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.generateMembershipRbacRoleBindingYamL as SinonStub
    ...
    it('invokes generateMembershipRBACRoleBindingYAML without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.generateMembershipRBACRoleBindingYAML(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.gkehub.v1.IGenerateMembershipRBACRoleBindingYAMLResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createFleet', () => {
    it('invokes createFleet without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createFleet as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createFleet as SinonStub
    ...
    it('invokes createFleet without error using callback', async () => {
      ...
      client.innerApiCalls.createFleet =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createFleet(
          request,
    ...
    it('invokes createFleet with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createFleet = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateFleet', () => {
    it('invokes updateFleet without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateFleet as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateFleet as SinonStub
    ...
    it('invokes updateFleet without error using callback', async () => {
      ...
      client.innerApiCalls.updateFleet =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.updateFleet(
          request,
    ...
    it('invokes updateFleet with call error', async () => {
      ...
      const expectedHeaderRequestParams = `fleet.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateFleet = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteFleet', () => {
    it('invokes deleteFleet without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteFleet as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteFleet as SinonStub
    ...
    it('invokes deleteFleet without error using callback', async () => {
      ...
      client.innerApiCalls.deleteFleet =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.deleteFleet(
          request,
    ...
    it('invokes deleteFleet with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteFleet = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('createScopeNamespace', () => {
    it('invokes createScopeNamespace without error', async () => {
      ...
      client.innerApiCalls.createScopeNamespace =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createScopeNamespace(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createScopeNamespace as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createScopeNamespace as SinonStub
    ...
    it('invokes createScopeNamespace with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createScopeNamespace = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateScopeNamespace', () => {
    it('invokes updateScopeNamespace without error', async () => {
      ...
      client.innerApiCalls.updateScopeNamespace =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateScopeNamespace(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateScopeNamespace as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateScopeNamespace as SinonStub
    ...
    it('invokes updateScopeNamespace with call error', async () => {
      ...
      const expectedHeaderRequestParams = `scope_namespace.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateScopeNamespace = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteScopeNamespace', () => {
    it('invokes deleteScopeNamespace without error', async () => {
      ...
      client.innerApiCalls.deleteScopeNamespace =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteScopeNamespace(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteScopeNamespace as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteScopeNamespace as SinonStub
    ...
    it('invokes deleteScopeNamespace with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteScopeNamespace = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkDeleteScopeNamespaceProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteScopeNamespaceProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createScopeRBACRoleBinding', () => {
    it('invokes createScopeRBACRoleBinding without error', async () => {
      ...
      client.innerApiCalls.createScopeRbacRoleBinding =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createScopeRBACRoleBinding(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createScopeRbacRoleBinding as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createScopeRbacRoleBinding as SinonStub
    ...
    it('invokes createScopeRBACRoleBinding with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createScopeRbacRoleBinding = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createScopeRBACRoleBinding(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createScopeRbacRoleBinding as SinonStub
    ...
    it('invokes checkCreateScopeRBACRoleBindingProgress without error', async () => {
      ...
      const decodedOperation =
        await client.checkCreateScopeRBACRoleBindingProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('updateScopeRBACRoleBinding', () => {
    it('invokes updateScopeRBACRoleBinding without error', async () => {
      ...
      client.innerApiCalls.updateScopeRbacRoleBinding =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateScopeRBACRoleBinding(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateScopeRbacRoleBinding as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateScopeRbacRoleBinding as SinonStub
    ...
    it('invokes updateScopeRBACRoleBinding with call error', async () => {
      ...
      const expectedHeaderRequestParams = `rbacrolebinding.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateScopeRbacRoleBinding = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateScopeRBACRoleBinding(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateScopeRbacRoleBinding as SinonStub
    ...
    it('invokes checkUpdateScopeRBACRoleBindingProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkUpdateScopeRBACRoleBindingProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('deleteScopeRBACRoleBinding', () => {
    it('invokes deleteScopeRBACRoleBinding without error', async () => {
      ...
      client.innerApiCalls.deleteScopeRbacRoleBinding =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteScopeRBACRoleBinding(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteScopeRbacRoleBinding as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteScopeRbacRoleBinding as SinonStub
    ...
    it('invokes deleteScopeRBACRoleBinding with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteScopeRbacRoleBinding = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteScopeRBACRoleBinding(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteScopeRbacRoleBinding as SinonStub
    ...
    it('invokes checkDeleteScopeRBACRoleBindingProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkDeleteScopeRBACRoleBindingProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkDeleteScopeRBACRoleBindingProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteScopeRBACRoleBindingProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createScope', () => {
    it('invokes createScope without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createScope as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createScope as SinonStub
    ...
    it('invokes createScope without error using callback', async () => {
      ...
      client.innerApiCalls.createScope =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createScope(
          request,
    ...
    it('invokes createScope with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createScope = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateScope', () => {
    it('invokes updateScope without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateScope as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateScope as SinonStub
    ...
    it('invokes updateScope without error using callback', async () => {
      ...
      client.innerApiCalls.updateScope =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.updateScope(
          request,
    ...
    it('invokes updateScope with call error', async () => {
      ...
      const expectedHeaderRequestParams = `scope.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateScope = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteScope', () => {
    it('invokes deleteScope without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteScope as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteScope as SinonStub
    ...
    it('invokes deleteScope with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteScope = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('createMembershipBinding', () => {
    it('invokes createMembershipBinding without error', async () => {
      ...
      client.innerApiCalls.createMembershipBinding =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createMembershipBinding(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createMembershipBinding as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createMembershipBinding as SinonStub
    ...
    it('invokes createMembershipBinding with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createMembershipBinding = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createMembershipBinding(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createMembershipBinding as SinonStub
    ...
    it('invokes checkCreateMembershipBindingProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkCreateMembershipBindingProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkCreateMembershipBindingProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateMembershipBindingProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateMembershipBinding', () => {
    it('invokes updateMembershipBinding without error', async () => {
      ...
      client.innerApiCalls.updateMembershipBinding =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateMembershipBinding(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateMembershipBinding as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateMembershipBinding as SinonStub
    ...
    it('invokes updateMembershipBinding with call error', async () => {
      ...
      const expectedHeaderRequestParams = `membership_binding.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateMembershipBinding = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateMembershipBinding(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateMembershipBinding as SinonStub
    ...
    it('invokes checkUpdateMembershipBindingProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkUpdateMembershipBindingProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkUpdateMembershipBindingProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateMembershipBindingProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteMembershipBinding', () => {
    it('invokes deleteMembershipBinding without error', async () => {
      ...
      client.innerApiCalls.deleteMembershipBinding =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteMembershipBinding(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteMembershipBinding as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteMembershipBinding as SinonStub
    ...
    it('invokes deleteMembershipBinding with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteMembershipBinding = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteMembershipBinding(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteMembershipBinding as SinonStub
    ...
    it('invokes checkDeleteMembershipBindingProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkDeleteMembershipBindingProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkDeleteMembershipBindingProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteMembershipBindingProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createMembershipRBACRoleBinding', () => {
    it('invokes createMembershipRBACRoleBinding without error', async () => {
      ...
      client.innerApiCalls.createMembershipRbacRoleBinding =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createMembershipRBACRoleBinding(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createMembershipRbacRoleBinding as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createMembershipRbacRoleBinding as SinonStub
    ...
    it('invokes createMembershipRBACRoleBinding with call error', async () => {
      ...
      await assert.rejects(
        client.createMembershipRBACRoleBinding(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createMembershipRbacRoleBinding as SinonStub
    ...
    it('invokes checkCreateMembershipRBACRoleBindingProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkCreateMembershipRBACRoleBindingProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('updateMembershipRBACRoleBinding', () => {
    it('invokes updateMembershipRBACRoleBinding without error', async () => {
      ...
      client.innerApiCalls.updateMembershipRbacRoleBinding =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateMembershipRBACRoleBinding(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateMembershipRbacRoleBinding as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateMembershipRbacRoleBinding as SinonStub
    ...
    it('invokes updateMembershipRBACRoleBinding with call error', async () => {
      ...
      client.innerApiCalls.updateMembershipRbacRoleBinding =
        stubLongRunningCall(undefined, expectedError);
      await assert.rejects(
        client.updateMembershipRBACRoleBinding(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateMembershipRbacRoleBinding as SinonStub
    ...
    it('invokes checkUpdateMembershipRBACRoleBindingProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkUpdateMembershipRBACRoleBindingProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkUpdateMembershipRBACRoleBindingProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateMembershipRBACRoleBindingProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteMembershipRBACRoleBinding', () => {
    it('invokes deleteMembershipRBACRoleBinding without error', async () => {
      ...
      client.innerApiCalls.deleteMembershipRbacRoleBinding =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteMembershipRBACRoleBinding(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteMembershipRbacRoleBinding as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteMembershipRbacRoleBinding as SinonStub
    ...
    it('invokes deleteMembershipRBACRoleBinding with call error', async () => {
      ...
      client.innerApiCalls.deleteMembershipRbacRoleBinding =
        stubLongRunningCall(undefined, expectedError);
      await assert.rejects(
        client.deleteMembershipRBACRoleBinding(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteMembershipRbacRoleBinding as SinonStub
    ...
    it('invokes checkDeleteMembershipRBACRoleBindingProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkDeleteMembershipRBACRoleBindingProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('listBoundMemberships', () => {
    it('invokes listBoundMemberships without error', async () => {
      ...
      client.innerApiCalls.listBoundMemberships =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listBoundMemberships(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listBoundMemberships as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listBoundMemberships as SinonStub
    ...
    it('invokes listBoundMemberships with error', async () => {
      ...
      const expectedHeaderRequestParams = `scope_name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listBoundMemberships = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listBoundMembershipsStream without error', async () => {
      ...
      client.descriptors.page.listBoundMemberships.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      assert(
        (client.descriptors.page.listBoundMemberships.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listBoundMemberships, request),
      );
      assert(
        (client.descriptors.page.listBoundMemberships.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listBoundMemberships without error', async () => {
      ...
      client.descriptors.page.listBoundMemberships.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.gkehub.v1.IMembership[] = [];
  ...
  describe('listFleets', () => {
    it('invokes listFleets without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listFleets as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listFleets as SinonStub
    ...
    it('invokes listFleets without error using callback', async () => {
      ...
      client.innerApiCalls.listFleets =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listFleets(
          request,
    ...
    it('invokes listFleets with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listFleets = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listFleetsStream without error', async () => {
      ...
      client.descriptors.page.listFleets.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      assert(
        (client.descriptors.page.listFleets.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listFleets, request),
      );
      assert(
        (client.descriptors.page.listFleets.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listFleetsStream with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listFleets.createStream = stubPageStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.listFleetsStream(request);
    ...
    it('uses async iteration with listFleets without error', async () => {
      ...
      client.descriptors.page.listFleets.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      ...
      assert.deepStrictEqual(responses, expectedResponse);
      assert.deepStrictEqual(
        (client.descriptors.page.listFleets.asyncIterate as SinonStub).getCall(
          0,
        ).args[1],
        request,
      );
    ...
    it('uses async iteration with listFleets with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listFleets.asyncIterate = stubAsyncIterationCall(
        undefined,
        expectedError,
      );
      const iterable = client.listFleetsAsync(request);
  ...
  describe('listScopeNamespaces', () => {
    it('invokes listScopeNamespaces without error', async () => {
      ...
      client.innerApiCalls.listScopeNamespaces =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listScopeNamespaces(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listScopeNamespaces as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listScopeNamespaces as SinonStub
    ...
    it('invokes listScopeNamespaces with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listScopeNamespaces = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listScopeNamespacesStream without error', async () => {
      ...
      client.descriptors.page.listScopeNamespaces.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.gkehub.v1.Namespace) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listScopeNamespaces.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listScopeNamespaces, request),
      );
      assert(
        (client.descriptors.page.listScopeNamespaces.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listScopeNamespaces without error', async () => {
      ...
      client.descriptors.page.listScopeNamespaces.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listScopeRBACRoleBindings', () => {
    it('invokes listScopeRBACRoleBindings without error', async () => {
      ...
      client.innerApiCalls.listScopeRbacRoleBindings =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listScopeRBACRoleBindings(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listScopeRbacRoleBindings as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listScopeRbacRoleBindings as SinonStub
    ...
    it('invokes listScopeRBACRoleBindings with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listScopeRbacRoleBindings = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listScopeRBACRoleBindings(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listScopeRbacRoleBindings as SinonStub
    ...
    it('invokes listScopeRBACRoleBindingsStream without error', async () => {
      ...
      client.descriptors.page.listScopeRBACRoleBindings.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.gkehub.v1.RBACRoleBinding) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (
          client.descriptors.page.listScopeRBACRoleBindings
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listScopeRbacRoleBindings, request),
      );
      assert(
        (
          client.descriptors.page.listScopeRBACRoleBindings
    ...
    it('uses async iteration with listScopeRBACRoleBindings without error', async () => {
      ...
      client.descriptors.page.listScopeRBACRoleBindings.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listScopes', () => {
    it('invokes listScopes without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listScopes as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listScopes as SinonStub
    ...
    it('invokes listScopes without error using callback', async () => {
      ...
      client.innerApiCalls.listScopes =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listScopes(
          request,
    ...
    it('invokes listScopes with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listScopes = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listScopesStream without error', async () => {
      ...
      client.descriptors.page.listScopes.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      assert(
        (client.descriptors.page.listScopes.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listScopes, request),
      );
      assert(
        (client.descriptors.page.listScopes.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listScopesStream with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listScopes.createStream = stubPageStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.listScopesStream(request);
    ...
    it('uses async iteration with listScopes without error', async () => {
      ...
      client.descriptors.page.listScopes.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      ...
      assert.deepStrictEqual(responses, expectedResponse);
      assert.deepStrictEqual(
        (client.descriptors.page.listScopes.asyncIterate as SinonStub).getCall(
          0,
        ).args[1],
        request,
      );
    ...
    it('uses async iteration with listScopes with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listScopes.asyncIterate = stubAsyncIterationCall(
        undefined,
        expectedError,
      );
      const iterable = client.listScopesAsync(request);
  ...
  describe('listPermittedScopes', () => {
    it('invokes listPermittedScopes without error', async () => {
      ...
      client.innerApiCalls.listPermittedScopes =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listPermittedScopes(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listPermittedScopes as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listPermittedScopes as SinonStub
    ...
    it('invokes listPermittedScopes with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listPermittedScopes = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listPermittedScopesStream without error', async () => {
      ...
      client.descriptors.page.listPermittedScopes.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      assert(
        (client.descriptors.page.listPermittedScopes.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listPermittedScopes, request),
      );
      assert(
        (client.descriptors.page.listPermittedScopes.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listPermittedScopes without error', async () => {
      ...
      client.descriptors.page.listPermittedScopes.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.gkehub.v1.IScope[] = [];
  ...
  describe('listMembershipBindings', () => {
    it('invokes listMembershipBindings without error', async () => {
      ...
      client.innerApiCalls.listMembershipBindings =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listMembershipBindings(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listMembershipBindings as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listMembershipBindings as SinonStub
    ...
    it('invokes listMembershipBindings with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listMembershipBindings = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listMembershipBindings(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listMembershipBindings as SinonStub
    ...
    it('invokes listMembershipBindingsStream without error', async () => {
      ...
      client.descriptors.page.listMembershipBindings.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.gkehub.v1.MembershipBinding) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (
          client.descriptors.page.listMembershipBindings
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listMembershipBindings, request),
      );
      assert(
        (
          client.descriptors.page.listMembershipBindings
    ...
    it('uses async iteration with listMembershipBindings without error', async () => {
      ...
      client.descriptors.page.listMembershipBindings.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listMembershipRBACRoleBindings', () => {
    it('invokes listMembershipRBACRoleBindings without error', async () => {
      ...
      client.innerApiCalls.listMembershipRbacRoleBindings =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listMembershipRBACRoleBindings(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listMembershipRbacRoleBindings as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listMembershipRbacRoleBindings as SinonStub
    ...
    it('invokes listMembershipRBACRoleBindings with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listMembershipRbacRoleBindings = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
    ...
    it('invokes listMembershipRBACRoleBindingsStream without error', async () => {
      ...
      client.descriptors.page.listMembershipRBACRoleBindings.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      assert(
        (
          client.descriptors.page.listMembershipRBACRoleBindings
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(
    ...
    it('uses async iteration with listMembershipRBACRoleBindings without error', async () => {
      ...
      client.descriptors.page.listMembershipRBACRoleBindings.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.gkehub.v1.IRBACRoleBinding[] = [];
  ...
  describe('Path templates', () => {
    ...
    describe('membershipBinding', async () => {
      ...
      await client.initialize();
      client.pathTemplates.membershipBindingPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.membershipBindingPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('membershipBindingPath', () => {
        const result = client.membershipBindingPath(
          'projectValue',
          'locationValue',
          'membershipValue',
          'membershipbindingValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.membershipBindingPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchMembershipFromMembershipBindingName', () => {
        const result =
          client.matchMembershipFromMembershipBindingName(fakePath);
        assert.strictEqual(result, 'membershipValue');
        assert(
          (
            client.pathTemplates.membershipBindingPathTemplate
      ...
      it('matchMembershipbindingFromMembershipBindingName', () => {
        const result =
          client.matchMembershipbindingFromMembershipBindingName(fakePath);
    ...
    describe('organizationLocationFleet', async () => {
      ...
      await client.initialize();
      client.pathTemplates.organizationLocationFleetPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.organizationLocationFleetPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);
      ...
      it('organizationLocationFleetPath', () => {
        ...
        assert(
          (
            client.pathTemplates.organizationLocationFleetPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchOrganizationFromOrganizationLocationFleetName', () => {
        const result =
          client.matchOrganizationFromOrganizationLocationFleetName(fakePath);
      ...
      it('matchLocationFromOrganizationLocationFleetName', () => {
        const result =
          client.matchLocationFromOrganizationLocationFleetName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.organizationLocationFleetPathTemplate
      ...
      it('matchFleetFromOrganizationLocationFleetName', () => {
        const result =
          client.matchFleetFromOrganizationLocationFleetName(fakePath);
    ...
    describe('projectLocationFleet', async () => {
      ...
      await client.initialize();
      client.pathTemplates.projectLocationFleetPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.projectLocationFleetPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('projectLocationFleetPath', () => {
        const result = client.projectLocationFleetPath(
          'projectValue',
          'locationValue',
          'fleetValue',
        );
        ...
        assert(
          (
            client.pathTemplates.projectLocationFleetPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromProjectLocationFleetName', () => {
        const result =
          client.matchProjectFromProjectLocationFleetName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.projectLocationFleetPathTemplate
      ...
      it('matchLocationFromProjectLocationFleetName', () => {
        const result =
          client.matchLocationFromProjectLocationFleetName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.projectLocationFleetPathTemplate
    ...
    describe('projectLocationMembershipRbacrolebinding', async () => {
      const fakePath =
        '/rendered/path/projectLocationMembershipRbacrolebinding';
      const expectedParameters = {
        project: 'projectValue',
        location: 'locationValue',
        membership: 'membershipValue',
      ...
      it('projectLocationMembershipRbacrolebindingPath', () => {
        const result = client.projectLocationMembershipRbacrolebindingPath(
          'projectValue',
          'locationValue',
          'membershipValue',
          'rbacrolebindingValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
      ...
      it('matchProjectFromProjectLocationMembershipRbacrolebindingName', () => {
        const result =
          client.matchProjectFromProjectLocationMembershipRbacrolebindingName(
            fakePath,
          );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromProjectLocationMembershipRbacrolebindingName', () => {
        const result =
          client.matchLocationFromProjectLocationMembershipRbacrolebindingName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchMembershipFromProjectLocationMembershipRbacrolebindingName', () => {
        const result =
          client.matchMembershipFromProjectLocationMembershipRbacrolebindingName(
            fakePath,
          );
        assert.strictEqual(result, 'membershipValue');
        assert(
      ...
      it('matchRbacrolebindingFromProjectLocationMembershipRbacrolebindingName', () => {
        const result =
          client.matchRbacrolebindingFromProjectLocationMembershipRbacrolebindingName(
            fakePath,
          );
    ...
    describe('projectLocationScopeRbacrolebinding', async () => {
      ...
      it('projectLocationScopeRbacrolebindingPath', () => {
        const result = client.projectLocationScopeRbacrolebindingPath(
          'projectValue',
          'locationValue',
          'scopeValue',
          'rbacrolebindingValue',
      ...
      it('matchProjectFromProjectLocationScopeRbacrolebindingName', () => {
        const result =
          client.matchProjectFromProjectLocationScopeRbacrolebindingName(
            fakePath,
          );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromProjectLocationScopeRbacrolebindingName', () => {
        const result =
          client.matchLocationFromProjectLocationScopeRbacrolebindingName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchScopeFromProjectLocationScopeRbacrolebindingName', () => {
        const result =
          client.matchScopeFromProjectLocationScopeRbacrolebindingName(
            fakePath,
          );
        assert.strictEqual(result, 'scopeValue');
        assert(
      ...
      it('matchRbacrolebindingFromProjectLocationScopeRbacrolebindingName', () => {
        const result =
          client.matchRbacrolebindingFromProjectLocationScopeRbacrolebindingName(
            fakePath,
          );
        assert.strictEqual(result, 'rbacrolebindingValue');
        assert(
    ...
    describe('scope', async () => {
      ...
      await client.initialize();
      client.pathTemplates.scopePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.scopePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('scopePath', () => {
        const result = client.scopePath(
          'projectValue',
          'locationValue',
          'scopeValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.scopePathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromScopeName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.scopePathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
