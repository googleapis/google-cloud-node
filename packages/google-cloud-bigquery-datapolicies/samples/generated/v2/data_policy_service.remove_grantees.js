...
function main(dataPolicy, grantees) {
  // [START bigquerydatapolicy_v2_generated_DataPolicyService_RemoveGrantees_async]
  /**
  ...
  async function callRemoveGrantees() {
    // Construct request
    const request = {
      dataPolicy,
      grantees,
    ...
    // Run request
    const response = await datapoliciesClient.removeGrantees(request);
    console.log(response);
  }

  callRemoveGrantees();
  // [END bigquerydatapolicy_v2_generated_DataPolicyService_RemoveGrantees_async]
}
