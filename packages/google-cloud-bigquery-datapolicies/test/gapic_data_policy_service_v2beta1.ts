...
describe('v2beta1.DataPolicyServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new datapolicyserviceModule.v2beta1.DataPolicyServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          datapolicyserviceModule.v2beta1.DataPolicyServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          datapolicyserviceModule.v2beta1.DataPolicyServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'bigquerydatapolicy.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('invokes createDataPolicy without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createDataPolicy(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.bigquery.datapolicies.v2beta1.IDataPolicy | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('addGrantees', () => {
    it('invokes addGrantees without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.addGrantees as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.addGrantees as SinonStub
    ...
    it('invokes addGrantees without error using callback', async () => {
      ...
      client.innerApiCalls.addGrantees =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.addGrantees(
          request,
    ...
    it('invokes addGrantees with error', async () => {
      ...
      const expectedHeaderRequestParams = `data_policy=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.addGrantees = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('removeGrantees', () => {
    it('invokes removeGrantees without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.removeGrantees as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.removeGrantees as SinonStub
    ...
    it('invokes removeGrantees without error using callback', async () => {
      ...
      client.innerApiCalls.removeGrantees =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes removeGrantees with error', async () => {
      ...
      const expectedHeaderRequestParams = `data_policy=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.removeGrantees = stubSimpleCall(
        undefined,
        expectedError,
      );
      ...
      const promise = new Promise((resolve, reject) => {
        client.listDataPolicies(
          ...
          (
            err?: Error | null,
            result?:
              | protos.google.cloud.bigquery.datapolicies.v2beta1.IDataPolicy[]
              | null,
          ) => {
            if (err) {
              reject(err);
    ...
    it('invokes listDataPoliciesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.bigquery.datapolicies.v2beta1.DataPolicy,
          ) => {
