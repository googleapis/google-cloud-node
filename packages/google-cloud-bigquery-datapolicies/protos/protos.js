                        ...
                        v1beta1.DataPolicy = (function() {
                            ...
                            DataPolicy.toObject = function toObject(message, options) {
                                ...
                                if (message.name != null && message.hasOwnProperty("name"))
                                    object.name = message.name;
                                if (message.dataPolicyType != null && message.hasOwnProperty("dataPolicyType"))
                                    object.dataPolicyType = options.enums === String ? $root.google.cloud.bigquery.datapolicies.v1beta1.DataPolicy.DataPolicyType[message.dataPolicyType] === undefined ? message.dataPolicyType : $root.google.cloud.bigquery.datapolicies.v1beta1.DataPolicy.DataPolicyType[message.dataPolicyType] : message.dataPolicyType;
                                if (message.dataPolicyId != null && message.hasOwnProperty("dataPolicyId"))
