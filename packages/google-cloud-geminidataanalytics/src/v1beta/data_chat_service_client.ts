 ...
 * `src/v1beta/data_chat_service_client_config.json`.
...
export class DataChatServiceClient {
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/data_chat_service.update_conversation.js</caption>
   * region_tag:geminidataanalytics_v1beta_generated_DataChatService_UpdateConversation_async
   */
  updateConversation(
    request?: protos.google.cloud.geminidataanalytics.v1beta.IUpdateConversationRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.geminidataanalytics.v1beta.IConversation,
      (
        | protos.google.cloud.geminidataanalytics.v1beta.IUpdateConversationRequest
        | undefined
      ),
      {} | undefined,
    ]
