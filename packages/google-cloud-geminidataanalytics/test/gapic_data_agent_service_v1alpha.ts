...
describe('v1alpha.DataAgentServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new dataagentserviceModule.v1alpha.DataAgentServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          dataagentserviceModule.v1alpha.DataAgentServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          dataagentserviceModule.v1alpha.DataAgentServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'geminidataanalytics.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('invokes getDataAgent without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDataAgent(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.geminidataanalytics.v1alpha.IDataAgent | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('retrieveAgentOpsObservability', () => {
    it('invokes retrieveAgentOpsObservability without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.geminidataanalytics.v1alpha.RetrieveAgentOpsObservabilityRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.geminidataanalytics.v1alpha.RetrieveAgentOpsObservabilityRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.geminidataanalytics.v1alpha.RetrieveAgentOpsObservabilityResponse(),
      );
    ...
    it('invokes retrieveAgentOpsObservability without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.retrieveAgentOpsObservability(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.geminidataanalytics.v1alpha.IRetrieveAgentOpsObservabilityResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('setAgentOpsObservability', () => {
    it('invokes setAgentOpsObservability without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.geminidataanalytics.v1alpha.SetAgentOpsObservabilityRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.geminidataanalytics.v1alpha.SetAgentOpsObservabilityRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
    ...
    it('invokes listDataAgentsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.geminidataanalytics.v1alpha.DataAgent,
          ) => {
