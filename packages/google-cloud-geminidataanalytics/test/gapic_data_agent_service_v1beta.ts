...
describe('v1beta.DataAgentServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          dataagentserviceModule.v1beta.DataAgentServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          dataagentserviceModule.v1beta.DataAgentServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'geminidataanalytics.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new dataagentserviceModule.v1beta.DataAgentServiceClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'geminidataanalytics.example.com');
          if (saved) {
  ...
  describe('getDataAgent', () => {
    it('invokes getDataAgent without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getDataAgent as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getDataAgent without error using callback', async () => {
      ...
      client.innerApiCalls.getDataAgent =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDataAgent(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.geminidataanalytics.v1beta.IDataAgent | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getDataAgent with error', async () => {
      ...
      client.innerApiCalls.getDataAgent = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createDataAgentSync', () => {
    it('invokes createDataAgentSync without error', async () => {
      ...
      client.innerApiCalls.createDataAgentSync =
        stubSimpleCall(expectedResponse);
      const [response] = await client.createDataAgentSync(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createDataAgentSync as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createDataAgentSync as SinonStub
    ...
    it('invokes createDataAgentSync with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createDataAgentSync = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateDataAgentSync', () => {
    it('invokes updateDataAgentSync without error', async () => {
      ...
      client.innerApiCalls.updateDataAgentSync =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateDataAgentSync(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateDataAgentSync as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateDataAgentSync as SinonStub
    ...
    it('invokes updateDataAgentSync with error', async () => {
      ...
      const expectedHeaderRequestParams = `data_agent.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateDataAgentSync = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteDataAgentSync', () => {
    it('invokes deleteDataAgentSync without error', async () => {
      ...
      client.innerApiCalls.deleteDataAgentSync =
        stubSimpleCall(expectedResponse);
      const [response] = await client.deleteDataAgentSync(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteDataAgentSync as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteDataAgentSync as SinonStub
    ...
    it('invokes deleteDataAgentSync with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteDataAgentSync = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('retrieveAgentOpsObservability', () => {
    it('invokes retrieveAgentOpsObservability without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.geminidataanalytics.v1beta.RetrieveAgentOpsObservabilityRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.geminidataanalytics.v1beta.RetrieveAgentOpsObservabilityResponse(),
      );
    ...
    it('invokes retrieveAgentOpsObservability without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.retrieveAgentOpsObservability(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.geminidataanalytics.v1beta.IRetrieveAgentOpsObservabilityResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createDataAgent', () => {
    it('invokes createDataAgent without error', async () => {
      ...
      client.innerApiCalls.createDataAgent =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createDataAgent(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createDataAgent as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createDataAgent as SinonStub
        ...
        client.createDataAgent(
          ...
          (
            ...
            result?: LROperation<
              ...
              protos.google.cloud.geminidataanalytics.v1beta.IOperationMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
    ...
    it('invokes createDataAgent with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createDataAgent = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkCreateDataAgentProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateDataAgentProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateDataAgent', () => {
    it('invokes updateDataAgent without error', async () => {
      ...
      client.innerApiCalls.updateDataAgent =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateDataAgent(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateDataAgent as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateDataAgent as SinonStub
    ...
    it('invokes updateDataAgent with call error', async () => {
      ...
      const expectedHeaderRequestParams = `data_agent.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateDataAgent = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkUpdateDataAgentProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateDataAgentProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteDataAgent', () => {
    it('invokes deleteDataAgent without error', async () => {
      ...
      client.innerApiCalls.deleteDataAgent =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteDataAgent(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteDataAgent as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteDataAgent as SinonStub
    ...
    it('invokes deleteDataAgent with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteDataAgent = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('setAgentOpsObservability', () => {
    it('invokes setAgentOpsObservability without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.geminidataanalytics.v1beta.SetAgentOpsObservabilityRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.geminidataanalytics.v1beta.SetAgentOpsObservabilityRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      const promise = new Promise((resolve, reject) => {
        client.setAgentOpsObservability(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.geminidataanalytics.v1beta.ISetAgentOpsObservabilityResponse,
              protos.google.cloud.geminidataanalytics.v1beta.ISetAgentOpsObservabilityMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
  ...
  describe('listDataAgents', () => {
    it('invokes listDataAgents without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listDataAgents as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listDataAgents as SinonStub
    ...
    it('invokes listDataAgents without error using callback', async () => {
      ...
      client.innerApiCalls.listDataAgents =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listDataAgents with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listDataAgents = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listDataAgentsStream without error', async () => {
      ...
      client.descriptors.page.listDataAgents.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.geminidataanalytics.v1beta.DataAgent,
          ) => {
      ...
      assert(
        (client.descriptors.page.listDataAgents.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listDataAgents, request),
      );
      assert(
        (client.descriptors.page.listDataAgents.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listDataAgents without error', async () => {
      ...
      client.descriptors.page.listDataAgents.asyncIterate =
  ...
  describe('listAccessibleDataAgents', () => {
    it('invokes listAccessibleDataAgents without error', async () => {
      ...
      client.innerApiCalls.listAccessibleDataAgents =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listAccessibleDataAgents(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listAccessibleDataAgents as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listAccessibleDataAgents as SinonStub
    ...
    it('invokes listAccessibleDataAgents with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listAccessibleDataAgents = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listAccessibleDataAgents(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listAccessibleDataAgents as SinonStub
    ...
    it('invokes listAccessibleDataAgentsStream without error', async () => {
      ...
      client.descriptors.page.listAccessibleDataAgents.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      assert(
        (
          client.descriptors.page.listAccessibleDataAgents
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listAccessibleDataAgents, request),
      );
      assert(
        (
          client.descriptors.page.listAccessibleDataAgents
    ...
    it('uses async iteration with listAccessibleDataAgents without error', async () => {
      ...
      client.descriptors.page.listAccessibleDataAgents.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.geminidataanalytics.v1beta.IDataAgent[] =
        [];
