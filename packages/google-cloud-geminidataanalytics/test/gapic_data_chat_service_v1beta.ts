...
describe('v1beta.DataChatServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          datachatserviceModule.v1beta.DataChatServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          datachatserviceModule.v1beta.DataChatServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'geminidataanalytics.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new datachatserviceModule.v1beta.DataChatServiceClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'geminidataanalytics.example.com');
          if (saved) {
    ...
    it('invokes createConversation without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createConversation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.geminidataanalytics.v1beta.IConversation | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('deleteConversation', () => {
    it('invokes deleteConversation without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.geminidataanalytics.v1beta.DeleteConversationRequest',
        ['name'],
      );
  ...
  describe('updateConversation', () => {
    it('invokes updateConversation without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.geminidataanalytics.v1beta.UpdateConversationRequest(),
      );
      request.conversation ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.geminidataanalytics.v1beta.UpdateConversationRequest',
        ['conversation', 'name'],
      );
  ...
  describe('queryData', () => {
    it('invokes queryData without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.geminidataanalytics.v1beta.QueryDataRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.queryData as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.queryData as SinonStub
    ...
    it('invokes queryData without error using callback', async () => {
      ...
      client.innerApiCalls.queryData =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.queryData(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.geminidataanalytics.v1beta.IQueryDataResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('chat', () => {
    it('invokes chat without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        stream.on(
          'data',
          (
            response: protos.google.cloud.geminidataanalytics.v1beta.Message,
          ) => {
            resolve(response);
          },
        );
    ...
    it('invokes chat with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.chat = stubServerStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.chat(request);
    ...
    it('invokes listConversationsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.geminidataanalytics.v1beta.Conversation,
          ) => {
  ...
  describe('listMessages', () => {
    it('invokes listMessages without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.geminidataanalytics.v1beta.StorageMessage(),
        ),
        generateSampleMessage(
          new protos.google.cloud.geminidataanalytics.v1beta.StorageMessage(),
        ),
    ...
    it('invokes listMessagesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.geminidataanalytics.v1beta.StorageMessage,
          ) => {
            responses.push(response);
          },
        );
