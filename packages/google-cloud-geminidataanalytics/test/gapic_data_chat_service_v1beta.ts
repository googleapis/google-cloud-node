...
describe('v1beta.DataChatServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = datachatserviceModule.v1beta.DataChatServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = datachatserviceModule.v1beta.DataChatServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'geminidataanalytics.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new datachatserviceModule.v1beta.DataChatServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'geminidataanalytics.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new datachatserviceModule.v1beta.DataChatServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'geminidataanalytics.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new datachatserviceModule.v1beta.DataChatServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new datachatserviceModule.v1beta.DataChatServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = datachatserviceModule.v1beta.DataChatServiceClient.port;
            assert(port);
    ...
    describe('createConversation', () => {
        it('invokes createConversation without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.geminidataanalytics.v1beta.CreateConversationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.geminidataanalytics.v1beta.CreateConversationRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.geminidataanalytics.v1beta.Conversation()
            );
        ...
        it('invokes createConversation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createConversation(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.geminidataanalytics.v1beta.IConversation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deleteConversation', () => {
        it('invokes deleteConversation without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.geminidataanalytics.v1beta.DeleteConversationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.geminidataanalytics.v1beta.DeleteConversationRequest', ['name']);
    ...
    describe('getConversation', () => {
        it('invokes getConversation without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.geminidataanalytics.v1beta.GetConversationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.geminidataanalytics.v1beta.GetConversationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.geminidataanalytics.v1beta.Conversation()
    ...
    describe('chat', () => {
        it('invokes chat without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.geminidataanalytics.v1beta.ChatRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.geminidataanalytics.v1beta.ChatRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.geminidataanalytics.v1beta.Message()
            );
            client.innerApiCalls.chat = stubServerStreamingCall(expectedResponse);
            const stream = client.chat(request);
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.geminidataanalytics.v1beta.Message) => {
                    resolve(response);
                });
    ...
    describe('listConversations', () => {
        it('invokes listConversations without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.geminidataanalytics.v1beta.ListConversationsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.geminidataanalytics.v1beta.ListConversationsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.geminidataanalytics.v1beta.Conversation()),
              generateSampleMessage(new protos.google.cloud.geminidataanalytics.v1beta.Conversation()),
              generateSampleMessage(new protos.google.cloud.geminidataanalytics.v1beta.Conversation()),
            ];
        ...
        it('invokes listConversationsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.geminidataanalytics.v1beta.Conversation[] = [];
                stream.on('data', (response: protos.google.cloud.geminidataanalytics.v1beta.Conversation) => {
        ...
        it('uses async iteration with listConversations without error', async () => {
            ...
            const responses: protos.google.cloud.geminidataanalytics.v1beta.IConversation[] = [];
    ...
    describe('listMessages', () => {
        it('invokes listMessages without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.geminidataanalytics.v1beta.ListMessagesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.geminidataanalytics.v1beta.ListMessagesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.geminidataanalytics.v1beta.StorageMessage()),
              generateSampleMessage(new protos.google.cloud.geminidataanalytics.v1beta.StorageMessage()),
              generateSampleMessage(new protos.google.cloud.geminidataanalytics.v1beta.StorageMessage()),
            ];
        ...
        it('invokes listMessages without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listMessages(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.geminidataanalytics.v1beta.IStorageMessage[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listMessagesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.geminidataanalytics.v1beta.StorageMessage[] = [];
                stream.on('data', (response: protos.google.cloud.geminidataanalytics.v1beta.StorageMessage) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listMessages without error', async () => {
            ...
            const responses: protos.google.cloud.geminidataanalytics.v1beta.IStorageMessage[] = [];
