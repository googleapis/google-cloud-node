...
describe('v1alpha.DataChatServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          datachatserviceModule.v1alpha.DataChatServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          datachatserviceModule.v1alpha.DataChatServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'geminidataanalytics.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new datachatserviceModule.v1alpha.DataChatServiceClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'geminidataanalytics.example.com');
          if (saved) {
    ...
    it('invokes createConversation without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createConversation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.geminidataanalytics.v1alpha.IConversation | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('updateConversation', () => {
    it('invokes updateConversation without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.geminidataanalytics.v1alpha.UpdateConversationRequest(),
      );
    ...
    it('invokes queryData without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.queryData(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.geminidataanalytics.v1alpha.IQueryDataResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes chat without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        stream.on(
          'data',
          (
            response: protos.google.cloud.geminidataanalytics.v1alpha.Message,
          ) => {
            resolve(response);
          },
        );
    ...
    it('invokes listConversationsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.geminidataanalytics.v1alpha.Conversation,
          ) => {
  ...
  describe('listMessages', () => {
    it('invokes listMessages without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.geminidataanalytics.v1alpha.StorageMessage(),
        ),
        generateSampleMessage(
          new protos.google.cloud.geminidataanalytics.v1alpha.StorageMessage(),
        ),
    ...
    it('invokes listMessagesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.geminidataanalytics.v1alpha.StorageMessage,
          ) => {
            responses.push(response);
          },
        );
