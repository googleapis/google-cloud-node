...
describe('v1.DataChatServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          datachatserviceModule.v1.DataChatServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          datachatserviceModule.v1.DataChatServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'geminidataanalytics.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new datachatserviceModule.v1.DataChatServiceClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = datachatserviceModule.v1.DataChatServiceClient.port;
      assert(port);
  ...
  describe('createConversation', () => {
    it('invokes createConversation without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.geminidataanalytics.v1.CreateConversationRequest(),
      );
  ...
  describe('deleteConversation', () => {
    it('invokes deleteConversation without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.geminidataanalytics.v1.DeleteConversationRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('getConversation', () => {
    it('invokes getConversation without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.geminidataanalytics.v1.GetConversationRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('chat', () => {
    it('invokes chat without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.geminidataanalytics.v1.ChatRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.geminidataanalytics.v1.Message(),
      );
      ...
      const promise = new Promise((resolve, reject) => {
        stream.on(
          'data',
          (response: protos.google.cloud.geminidataanalytics.v1.Message) => {
            resolve(response);
          },
        );
  ...
  describe('listConversations', () => {
    it('invokes listConversations without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.geminidataanalytics.v1.ListConversationsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const promise = new Promise((resolve, reject) => {
        client.listConversations(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.geminidataanalytics.v1.IConversation[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listConversationsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.geminidataanalytics.v1.Conversation[] =
          [];
        stream.on(
          'data',
          (
            response: protos.google.cloud.geminidataanalytics.v1.Conversation,
          ) => {
    ...
    it('uses async iteration with listConversations without error', async () => {
      ...
      const responses: protos.google.cloud.geminidataanalytics.v1.IConversation[] =
        [];
  ...
  describe('listMessages', () => {
    it('invokes listMessages without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.geminidataanalytics.v1.ListMessagesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.geminidataanalytics.v1.StorageMessage(),
        ),
        generateSampleMessage(
          new protos.google.cloud.geminidataanalytics.v1.StorageMessage(),
        ),
    ...
    it('invokes listMessagesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.geminidataanalytics.v1.StorageMessage[] =
          [];
        stream.on(
          'data',
          (
            response: protos.google.cloud.geminidataanalytics.v1.StorageMessage,
          ) => {
            responses.push(response);
          },
        );
    ...
    it('uses async iteration with listMessages without error', async () => {
      ...
      client.descriptors.page.listMessages.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.geminidataanalytics.v1.IStorageMessage[] =
        [];
