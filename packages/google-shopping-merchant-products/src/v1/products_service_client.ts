 ...
 * `src/v1/products_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './products_service_client_config.json';
...
export class ProductsServiceClient {
  ...
  productsServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of ProductsServiceClient.
   *
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this.pathTemplates = {
      ...
      productInputPathTemplate: new this._gaxModule.PathTemplate(
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.shopping.merchant.products.v1.ProductsService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.productsServiceStub) {
      return this.productsServiceStub;
    }

    // Put together the "service stub" for
    // google.shopping.merchant.products.v1.ProductsService.
    this.productsServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.shopping.merchant.products.v1.ProductsService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.shopping.merchant.products.v1.ProductsService,
 ...
 *   The first element of the array is an object representing {@link protos.google.shopping.merchant.products.v1.Product|Product}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/products_service.get_product.js</caption>
 * region_tag:merchantapi_v1_generated_ProductsService_GetProduct_async
 */
  getProduct(
      request?: protos.google.shopping.merchant.products.v1.IGetProductRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.products.v1.IProduct,
        protos.google.shopping.merchant.products.v1.IGetProductRequest|undefined, {}|undefined
      ]>;
  getProduct(
      request: protos.google.shopping.merchant.products.v1.IGetProductRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.products.v1.IProduct,
          protos.google.shopping.merchant.products.v1.IGetProductRequest|null|undefined,
          {}|null|undefined>): void;
  getProduct(
      request: protos.google.shopping.merchant.products.v1.IGetProductRequest,
      callback: Callback<
  ...
  getProduct(
    ...
    return this.innerApiCalls.getProduct(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.products.v1.IProduct,
        protos.google.shopping.merchant.products.v1.IGetProductRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getProduct response %j', response);
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.shopping.merchant.products.v1.Product|Product}.
 ...
 */
  listProducts(
      request?: protos.google.shopping.merchant.products.v1.IListProductsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.products.v1.IProduct[],
        protos.google.shopping.merchant.products.v1.IListProductsRequest|null,
        protos.google.shopping.merchant.products.v1.IListProductsResponse
      ]>;
  listProducts(
      request: protos.google.shopping.merchant.products.v1.IListProductsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          ...
          protos.google.shopping.merchant.products.v1.IListProductsResponse|null|undefined,
          protos.google.shopping.merchant.products.v1.IProduct>): void;
  listProducts(
      request: protos.google.shopping.merchant.products.v1.IListProductsRequest,
      callback: PaginationCallback<
          protos.google.shopping.merchant.products.v1.IListProductsRequest,
  ...
  listProducts(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.shopping.merchant.products.v1.IListProductsRequest,
      protos.google.shopping.merchant.products.v1.IListProductsResponse|null|undefined,
      protos.google.shopping.merchant.products.v1.IProduct>|undefined = callback
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.shopping.merchant.products.v1.Product|Product} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   {@link protos.google.shopping.merchant.products.v1.Product|Product}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/products_service.list_products.js</caption>
 * region_tag:merchantapi_v1_generated_ProductsService_ListProducts_async
 */
  listProductsAsync(
      request?: protos.google.shopping.merchant.products.v1.IListProductsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.shopping.merchant.products.v1.IProduct>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listProducts.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.shopping.merchant.products.v1.IProduct>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
