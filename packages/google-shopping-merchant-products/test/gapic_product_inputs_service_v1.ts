...
describe('v1.ProductInputsServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new productinputsserviceModule.v1.ProductInputsServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = productinputsserviceModule.v1.ProductInputsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = productinputsserviceModule.v1.ProductInputsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new productinputsserviceModule.v1.ProductInputsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new productinputsserviceModule.v1.ProductInputsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new productinputsserviceModule.v1.ProductInputsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new productinputsserviceModule.v1.ProductInputsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = productinputsserviceModule.v1.ProductInputsServiceClient.port;
            assert(port);
    ...
    describe('insertProductInput', () => {
        it('invokes insertProductInput without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.products.v1.InsertProductInputRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.products.v1.InsertProductInputRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.products.v1.ProductInput()
            );
        ...
        it('invokes insertProductInput without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.insertProductInput(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.products.v1.IProductInput|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateProductInput', () => {
        it('invokes updateProductInput without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.products.v1.UpdateProductInputRequest()
            );
            request.productInput ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.products.v1.UpdateProductInputRequest', ['productInput', 'name']);
    ...
    describe('deleteProductInput', () => {
        it('invokes deleteProductInput without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.products.v1.DeleteProductInputRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.products.v1.DeleteProductInputRequest', ['name']);
