  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          productinputsserviceModule.v1.ProductInputsServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          productinputsserviceModule.v1.ProductInputsServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        productinputsserviceModule.v1.ProductInputsServiceClient.port;
      assert(port);
    ...
    it('invokes insertProductInput without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.insertProductInput(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.products.v1.IProductInput | null,
          ) => {
            if (err) {
              reject(err);
            } else {
