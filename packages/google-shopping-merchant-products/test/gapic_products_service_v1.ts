  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          productsserviceModule.v1.ProductsServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          productsserviceModule.v1.ProductsServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new productsserviceModule.v1.ProductsServiceClient({
          universe_domain: 'example.com',
    ...
    it('invokes getProduct without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getProduct(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.products.v1.IProduct | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listProducts', () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listProducts(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.shopping.merchant.products.v1.IProduct[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listProductsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.shopping.merchant.products.v1.Product) => {
