...
function main(parent, addressGroupId, addressGroup) {
  ...
  async function callCreateAddressGroup() {
    // Construct request
    const request = {
      parent,
      addressGroupId,
    ...
    // Run request
    const [operation] = await networksecurityClient.createAddressGroup(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callCreateAddressGroup();
  // [END networksecurity_v1_generated_OrganizationAddressGroupService_CreateAddressGroup_async]
}
