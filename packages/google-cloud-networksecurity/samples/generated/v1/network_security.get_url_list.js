...
function main(name) {
  // [START networksecurity_v1_generated_NetworkSecurity_GetUrlList_async]
  /**
  ...
  async function callGetUrlList() {
    ...
    // Run request
    const response = await networksecurityClient.getUrlList(request);
    console.log(response);
  }

  callGetUrlList();
  // [END networksecurity_v1_generated_NetworkSecurity_GetUrlList_async]
}
