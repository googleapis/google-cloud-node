...
function main(parent) {
  ...
  async function callListGatewaySecurityPolicies() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = networksecurityClient.listGatewaySecurityPoliciesAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListGatewaySecurityPolicies();
