...
function main(name) {
  ...
  async function callDeleteSecurityProfileGroup() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const [operation] = await networksecurityClient.deleteSecurityProfileGroup(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callDeleteSecurityProfileGroup();
