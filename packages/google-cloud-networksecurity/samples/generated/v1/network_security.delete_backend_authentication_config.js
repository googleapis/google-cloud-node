...
function main(name) {
  // [START networksecurity_v1_generated_NetworkSecurity_DeleteBackendAuthenticationConfig_async]
  /**
  ...
  async function callDeleteBackendAuthenticationConfig() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const [operation] = await networksecurityClient.deleteBackendAuthenticationConfig(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callDeleteBackendAuthenticationConfig();
