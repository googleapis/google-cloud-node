...
function main(addressGroup, sourceAddressGroup) {
   ...
   */
  // const sourceAddressGroup = 'abc123'
  /**
  ...
  async function callCloneAddressGroupItems() {
    // Construct request
    const request = {
      addressGroup,
      sourceAddressGroup,
    ...
    // Run request
    const [operation] = await networksecurityClient.cloneAddressGroupItems(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callCloneAddressGroupItems();
