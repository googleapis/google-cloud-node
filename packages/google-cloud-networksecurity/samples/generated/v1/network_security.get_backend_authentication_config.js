...
function main(name) {
  ...
  async function callGetBackendAuthenticationConfig() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await networksecurityClient.getBackendAuthenticationConfig(request);
    console.log(response);
  }

  callGetBackendAuthenticationConfig();
