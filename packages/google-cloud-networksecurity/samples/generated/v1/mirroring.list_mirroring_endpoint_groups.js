...
function main(parent) {
  ...
  async function callListMirroringEndpointGroups() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = networksecurityClient.listMirroringEndpointGroupsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListMirroringEndpointGroups();
