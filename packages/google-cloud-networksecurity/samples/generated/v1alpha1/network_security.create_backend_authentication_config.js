...
function main(parent, backendAuthenticationConfigId, backendAuthenticationConfig) {
  // [START networksecurity_v1alpha1_generated_NetworkSecurity_CreateBackendAuthenticationConfig_async]
  /**
   ...
   */
  // const backendAuthenticationConfigId = 'abc123'
  /**
   *  Required. BackendAuthenticationConfig resource to be created.
   */
  // const backendAuthenticationConfig = {}
  ...
  async function callCreateBackendAuthenticationConfig() {
    // Construct request
    const request = {
      parent,
    ...
    // Run request
    const [operation] = await networksecurityClient.createBackendAuthenticationConfig(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callCreateBackendAuthenticationConfig();
  // [END networksecurity_v1alpha1_generated_NetworkSecurity_CreateBackendAuthenticationConfig_async]
}
