...
function main(name) {
  ...
  async function callGetGatewaySecurityPolicyRule() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await networksecurityClient.getGatewaySecurityPolicyRule(request);
    console.log(response);
  }

  callGetGatewaySecurityPolicyRule();
  // [END networksecurity_v1alpha1_generated_NetworkSecurity_GetGatewaySecurityPolicyRule_async]
}
