...
function main(parent) {
  // [START networksecurity_v1alpha1_generated_Mirroring_ListMirroringDeployments_async]
  /**
  ...
  async function callListMirroringDeployments() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = networksecurityClient.listMirroringDeploymentsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListMirroringDeployments();
  // [END networksecurity_v1alpha1_generated_Mirroring_ListMirroringDeployments_async]
}
