...
function main(parent, tlsInspectionPolicyId, tlsInspectionPolicy) {
  // [START networksecurity_v1alpha1_generated_NetworkSecurity_CreateTlsInspectionPolicy_async]
  /**
   ...
   */
  // const tlsInspectionPolicyId = 'abc123'
  /**
  ...
  async function callCreateTlsInspectionPolicy() {
    // Construct request
    const request = {
      parent,
    ...
    // Run request
    const [operation] = await networksecurityClient.createTlsInspectionPolicy(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callCreateTlsInspectionPolicy();
  // [END networksecurity_v1alpha1_generated_NetworkSecurity_CreateTlsInspectionPolicy_async]
}
