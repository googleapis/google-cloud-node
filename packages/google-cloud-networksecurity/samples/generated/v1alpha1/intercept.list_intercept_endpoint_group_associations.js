...
function main(parent) {
  ...
  async function callListInterceptEndpointGroupAssociations() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = networksecurityClient.listInterceptEndpointGroupAssociationsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListInterceptEndpointGroupAssociations();
  // [END networksecurity_v1alpha1_generated_Intercept_ListInterceptEndpointGroupAssociations_async]
}
