...
function main(parent) {
  // [START networksecurity_v1alpha1_generated_NetworkSecurity_ListUrlLists_async]
  /**
  ...
  async function callListUrlLists() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = networksecurityClient.listUrlListsAsync(request);
  ...
  callListUrlLists();
  // [END networksecurity_v1alpha1_generated_NetworkSecurity_ListUrlLists_async]
}
