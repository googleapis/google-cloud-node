...
function main(parent) {
  ...
  async function callListInterceptDeploymentGroups() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = networksecurityClient.listInterceptDeploymentGroupsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListInterceptDeploymentGroups();
