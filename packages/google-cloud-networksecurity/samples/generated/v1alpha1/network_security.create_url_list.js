...
function main(parent, urlListId, urlList) {
  ...
  async function callCreateUrlList() {
    // Construct request
    const request = {
      parent,
      urlListId,
    ...
    // Run request
    const [operation] = await networksecurityClient.createUrlList(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callCreateUrlList();
  // [END networksecurity_v1alpha1_generated_NetworkSecurity_CreateUrlList_async]
}
