...
function main(name) {
  ...
  async function callDeleteGatewaySecurityPolicy() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const [operation] = await networksecurityClient.deleteGatewaySecurityPolicy(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callDeleteGatewaySecurityPolicy();
  // [END networksecurity_v1alpha1_generated_NetworkSecurity_DeleteGatewaySecurityPolicy_async]
}
