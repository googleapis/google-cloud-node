...
function main(updateMask, authzPolicy) {
  ...
  async function callUpdateAuthzPolicy() {
    // Construct request
    const request = {
      updateMask,
      authzPolicy,
    ...
    // Run request
    const [operation] = await networksecurityClient.updateAuthzPolicy(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callUpdateAuthzPolicy();
  // [END networksecurity_v1alpha1_generated_NetworkSecurity_UpdateAuthzPolicy_async]
}
