...
function main(gatewaySecurityPolicyRule) {
  ...
  async function callUpdateGatewaySecurityPolicyRule() {
    // Construct request
    const request = {
    ...
    // Run request
    const [operation] = await networksecurityClient.updateGatewaySecurityPolicyRule(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callUpdateGatewaySecurityPolicyRule();
  // [END networksecurity_v1alpha1_generated_NetworkSecurity_UpdateGatewaySecurityPolicyRule_async]
}
