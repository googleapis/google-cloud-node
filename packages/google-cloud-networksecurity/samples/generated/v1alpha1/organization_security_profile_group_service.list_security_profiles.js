...
function main(parent) {
  ...
  async function callListSecurityProfiles() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = networksecurityClient.listSecurityProfilesAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListSecurityProfiles();
  // [END networksecurity_v1alpha1_generated_OrganizationSecurityProfileGroupService_ListSecurityProfiles_async]
}
