...
function main(parent) {
  // [START networksecurity_v1alpha1_generated_Intercept_ListInterceptEndpointGroups_async]
  /**
  ...
  async function callListInterceptEndpointGroups() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = networksecurityClient.listInterceptEndpointGroupsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListInterceptEndpointGroups();
  // [END networksecurity_v1alpha1_generated_Intercept_ListInterceptEndpointGroups_async]
}
