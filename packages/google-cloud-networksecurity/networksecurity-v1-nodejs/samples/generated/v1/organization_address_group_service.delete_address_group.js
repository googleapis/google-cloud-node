...
function main(name) {
  // [START networksecurity_v1_generated_OrganizationAddressGroupService_DeleteAddressGroup_async]
  /**
  ...
  async function callDeleteAddressGroup() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const [operation] = await networksecurityClient.deleteAddressGroup(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callDeleteAddressGroup();
