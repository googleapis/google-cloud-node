...
function main(addressGroup) {
  ...
  async function callUpdateAddressGroup() {
    // Construct request
    const request = {
      addressGroup,
    };
    ...
    // Run request
    const [operation] = await networksecurityClient.updateAddressGroup(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callUpdateAddressGroup();
  // [END networksecurity_v1_generated_AddressGroupService_UpdateAddressGroup_async]
}
