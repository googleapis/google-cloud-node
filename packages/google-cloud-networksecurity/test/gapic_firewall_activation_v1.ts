...
describe('v1.FirewallActivationClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new firewallactivationModule.v1.FirewallActivationClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = firewallactivationModule.v1.FirewallActivationClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = firewallactivationModule.v1.FirewallActivationClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'networksecurity.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new firewallactivationModule.v1.FirewallActivationClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networksecurity.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new firewallactivationModule.v1.FirewallActivationClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networksecurity.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new firewallactivationModule.v1.FirewallActivationClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new firewallactivationModule.v1.FirewallActivationClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = firewallactivationModule.v1.FirewallActivationClient.port;
            assert(port);
    ...
    describe('getFirewallEndpoint', () => {
        it('invokes getFirewallEndpoint without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1.GetFirewallEndpointRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.GetFirewallEndpointRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1.FirewallEndpoint()
            );
            client.innerApiCalls.getFirewallEndpoint = stubSimpleCall(expectedResponse);
            const [response] = await client.getFirewallEndpoint(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getFirewallEndpoint as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getFirewallEndpoint as SinonStub)
        ...
        it('invokes getFirewallEndpoint without error using callback', async () => {
            ...
            client.innerApiCalls.getFirewallEndpoint = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getFirewallEndpoint(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1.IFirewallEndpoint|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getFirewallEndpoint with error', async () => {
            ...
            client.innerApiCalls.getFirewallEndpoint = stubSimpleCall(undefined, expectedError);
    ...
    describe('getFirewallEndpointAssociation', () => {
        it('invokes getFirewallEndpointAssociation without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1.GetFirewallEndpointAssociationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.GetFirewallEndpointAssociationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1.FirewallEndpointAssociation()
            );
            client.innerApiCalls.getFirewallEndpointAssociation = stubSimpleCall(expectedResponse);
            const [response] = await client.getFirewallEndpointAssociation(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getFirewallEndpointAssociation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getFirewallEndpointAssociation as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getFirewallEndpointAssociation without error using callback', async () => {
            ...
            client.innerApiCalls.getFirewallEndpointAssociation = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getFirewallEndpointAssociation(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1.IFirewallEndpointAssociation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getFirewallEndpointAssociation with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getFirewallEndpointAssociation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getFirewallEndpointAssociation(request), expectedError);
            const actualRequest = (client.innerApiCalls.getFirewallEndpointAssociation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getFirewallEndpointAssociation as SinonStub)
    ...
    describe('createFirewallEndpoint', () => {
        it('invokes createFirewallEndpoint without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1.CreateFirewallEndpointRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.CreateFirewallEndpointRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createFirewallEndpoint = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createFirewallEndpoint(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createFirewallEndpoint as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createFirewallEndpoint as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createFirewallEndpoint without error using callback', async () => {
            ...
            client.innerApiCalls.createFirewallEndpoint = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createFirewallEndpoint(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networksecurity.v1.IFirewallEndpoint, protos.google.cloud.networksecurity.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networksecurity.v1.IFirewallEndpoint, protos.google.cloud.networksecurity.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createFirewallEndpoint as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createFirewallEndpoint with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createFirewallEndpoint = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createFirewallEndpoint(request), expectedError);
            const actualRequest = (client.innerApiCalls.createFirewallEndpoint as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createFirewallEndpoint as SinonStub)
        ...
        it('invokes createFirewallEndpoint with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createFirewallEndpoint = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createFirewallEndpoint(request);
        ...
        it('invokes checkCreateFirewallEndpointProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateFirewallEndpointProgress(expectedResponse.name);
        ...
        it('invokes checkCreateFirewallEndpointProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreateFirewallEndpointProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('deleteFirewallEndpoint', () => {
        it('invokes deleteFirewallEndpoint without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1.DeleteFirewallEndpointRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.DeleteFirewallEndpointRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteFirewallEndpoint = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteFirewallEndpoint(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteFirewallEndpoint as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteFirewallEndpoint as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteFirewallEndpoint without error using callback', async () => {
            ...
            client.innerApiCalls.deleteFirewallEndpoint = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteFirewallEndpoint with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteFirewallEndpoint = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteFirewallEndpoint(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteFirewallEndpoint as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteFirewallEndpoint as SinonStub)
        ...
        it('invokes deleteFirewallEndpoint with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteFirewallEndpoint = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteFirewallEndpoint(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteFirewallEndpoint as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteFirewallEndpointProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteFirewallEndpointProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteFirewallEndpointProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteFirewallEndpointProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('updateFirewallEndpoint', () => {
        it('invokes updateFirewallEndpoint without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1.UpdateFirewallEndpointRequest()
            );
            request.firewallEndpoint ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.UpdateFirewallEndpointRequest', ['firewallEndpoint', 'name']);
            request.firewallEndpoint.name = defaultValue1;
            const expectedHeaderRequestParams = `firewall_endpoint.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updateFirewallEndpoint = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateFirewallEndpoint(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateFirewallEndpoint as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateFirewallEndpoint as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateFirewallEndpoint without error using callback', async () => {
            ...
            client.innerApiCalls.updateFirewallEndpoint = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateFirewallEndpoint(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networksecurity.v1.IFirewallEndpoint, protos.google.cloud.networksecurity.v1.IOperationMetadata>|null
                    ) => {
        ...
        it('invokes updateFirewallEndpoint with call error', async () => {
            ...
            const expectedHeaderRequestParams = `firewall_endpoint.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateFirewallEndpoint = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.updateFirewallEndpoint(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateFirewallEndpoint as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateFirewallEndpoint as SinonStub)
        ...
        it('invokes updateFirewallEndpoint with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `firewall_endpoint.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateFirewallEndpoint = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateFirewallEndpoint(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateFirewallEndpoint as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateFirewallEndpointProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateFirewallEndpointProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateFirewallEndpointProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateFirewallEndpointProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('createFirewallEndpointAssociation', () => {
        it('invokes createFirewallEndpointAssociation without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1.CreateFirewallEndpointAssociationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.CreateFirewallEndpointAssociationRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createFirewallEndpointAssociation = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createFirewallEndpointAssociation(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createFirewallEndpointAssociation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createFirewallEndpointAssociation as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createFirewallEndpointAssociation without error using callback', async () => {
            ...
            client.innerApiCalls.createFirewallEndpointAssociation = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createFirewallEndpointAssociation(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networksecurity.v1.IFirewallEndpointAssociation, protos.google.cloud.networksecurity.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networksecurity.v1.IFirewallEndpointAssociation, protos.google.cloud.networksecurity.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createFirewallEndpointAssociation as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createFirewallEndpointAssociation with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createFirewallEndpointAssociation = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createFirewallEndpointAssociation(request), expectedError);
            const actualRequest = (client.innerApiCalls.createFirewallEndpointAssociation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createFirewallEndpointAssociation as SinonStub)
        ...
        it('invokes createFirewallEndpointAssociation with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createFirewallEndpointAssociation = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createFirewallEndpointAssociation(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.createFirewallEndpointAssociation as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkCreateFirewallEndpointAssociationProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkCreateFirewallEndpointAssociationProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkCreateFirewallEndpointAssociationProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkCreateFirewallEndpointAssociationProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('deleteFirewallEndpointAssociation', () => {
        it('invokes deleteFirewallEndpointAssociation without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1.DeleteFirewallEndpointAssociationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.DeleteFirewallEndpointAssociationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteFirewallEndpointAssociation = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteFirewallEndpointAssociation(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteFirewallEndpointAssociation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteFirewallEndpointAssociation as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteFirewallEndpointAssociation without error using callback', async () => {
            ...
            client.innerApiCalls.deleteFirewallEndpointAssociation = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteFirewallEndpointAssociation(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.networksecurity.v1.IOperationMetadata>|null
                    ) => {
        ...
        it('invokes deleteFirewallEndpointAssociation with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteFirewallEndpointAssociation = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteFirewallEndpointAssociation(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteFirewallEndpointAssociation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteFirewallEndpointAssociation as SinonStub)
        ...
        it('invokes deleteFirewallEndpointAssociation with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteFirewallEndpointAssociation = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteFirewallEndpointAssociation(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteFirewallEndpointAssociation as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteFirewallEndpointAssociationProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteFirewallEndpointAssociationProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteFirewallEndpointAssociationProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteFirewallEndpointAssociationProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('updateFirewallEndpointAssociation', () => {
        it('invokes updateFirewallEndpointAssociation without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1.UpdateFirewallEndpointAssociationRequest()
            );
            request.firewallEndpointAssociation ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.UpdateFirewallEndpointAssociationRequest', ['firewallEndpointAssociation', 'name']);
            request.firewallEndpointAssociation.name = defaultValue1;
            const expectedHeaderRequestParams = `firewall_endpoint_association.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updateFirewallEndpointAssociation = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateFirewallEndpointAssociation(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateFirewallEndpointAssociation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateFirewallEndpointAssociation as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateFirewallEndpointAssociation without error using callback', async () => {
            ...
            client.innerApiCalls.updateFirewallEndpointAssociation = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateFirewallEndpointAssociation(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networksecurity.v1.IFirewallEndpointAssociation, protos.google.cloud.networksecurity.v1.IOperationMetadata>|null
                    ) => {
        ...
        it('invokes updateFirewallEndpointAssociation with call error', async () => {
            ...
            const expectedHeaderRequestParams = `firewall_endpoint_association.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateFirewallEndpointAssociation = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.updateFirewallEndpointAssociation(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateFirewallEndpointAssociation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateFirewallEndpointAssociation as SinonStub)
        ...
        it('invokes updateFirewallEndpointAssociation with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `firewall_endpoint_association.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateFirewallEndpointAssociation = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateFirewallEndpointAssociation(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateFirewallEndpointAssociation as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateFirewallEndpointAssociationProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateFirewallEndpointAssociationProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateFirewallEndpointAssociationProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateFirewallEndpointAssociationProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('listFirewallEndpoints', () => {
        it('invokes listFirewallEndpoints without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1.ListFirewallEndpointsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.ListFirewallEndpointsRequest', ['parent']);
            request.parent = defaultValue1;
            ...
            client.innerApiCalls.listFirewallEndpoints = stubSimpleCall(expectedResponse);
            const [response] = await client.listFirewallEndpoints(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listFirewallEndpoints as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listFirewallEndpoints as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listFirewallEndpoints without error using callback', async () => {
            ...
            client.innerApiCalls.listFirewallEndpoints = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listFirewallEndpoints(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1.IFirewallEndpoint[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listFirewallEndpoints with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listFirewallEndpoints = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listFirewallEndpoints(request), expectedError);
            const actualRequest = (client.innerApiCalls.listFirewallEndpoints as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listFirewallEndpoints as SinonStub)
        ...
        it('invokes listFirewallEndpointsStream without error', async () => {
            ...
            const stream = client.listFirewallEndpointsStream(request);
            const promise = new Promise((resolve, reject) => {
            ...
            assert((client.descriptors.page.listFirewallEndpoints.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listFirewallEndpoints, request));
            assert(
                (client.descriptors.page.listFirewallEndpoints.createStream as SinonStub)
        ...
        it('invokes listFirewallEndpointsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listFirewallEndpoints.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listFirewallEndpointsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.networksecurity.v1.FirewallEndpoint[] = [];
                stream.on('data', (response: protos.google.cloud.networksecurity.v1.FirewallEndpoint) => {
        ...
        it('uses async iteration with listFirewallEndpoints without error', async () => {
            ...
            client.descriptors.page.listFirewallEndpoints.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.networksecurity.v1.IFirewallEndpoint[] = [];
            const iterable = client.listFirewallEndpointsAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listFirewallEndpoints.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listFirewallEndpoints with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listFirewallEndpoints.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listFirewallEndpointsAsync(request);
    ...
    describe('listFirewallEndpointAssociations', () => {
        it('invokes listFirewallEndpointAssociations without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1.ListFirewallEndpointAssociationsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.ListFirewallEndpointAssociationsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.FirewallEndpointAssociation()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.FirewallEndpointAssociation()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.FirewallEndpointAssociation()),
            ];
            client.innerApiCalls.listFirewallEndpointAssociations = stubSimpleCall(expectedResponse);
            const [response] = await client.listFirewallEndpointAssociations(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listFirewallEndpointAssociations as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listFirewallEndpointAssociations as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listFirewallEndpointAssociations without error using callback', async () => {
            ...
            client.innerApiCalls.listFirewallEndpointAssociations = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listFirewallEndpointAssociations(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1.IFirewallEndpointAssociation[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listFirewallEndpointAssociations with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listFirewallEndpointAssociations = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listFirewallEndpointAssociations(request), expectedError);
            const actualRequest = (client.innerApiCalls.listFirewallEndpointAssociations as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listFirewallEndpointAssociations as SinonStub)
        ...
        it('invokes listFirewallEndpointAssociationsStream without error', async () => {
            ...
            const stream = client.listFirewallEndpointAssociationsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.networksecurity.v1.FirewallEndpointAssociation[] = [];
                stream.on('data', (response: protos.google.cloud.networksecurity.v1.FirewallEndpointAssociation) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listFirewallEndpointAssociations.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listFirewallEndpointAssociations, request));
            assert(
                (client.descriptors.page.listFirewallEndpointAssociations.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listFirewallEndpointAssociationsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listFirewallEndpointAssociations.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listFirewallEndpointAssociationsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.networksecurity.v1.FirewallEndpointAssociation[] = [];
                stream.on('data', (response: protos.google.cloud.networksecurity.v1.FirewallEndpointAssociation) => {
        ...
        it('uses async iteration with listFirewallEndpointAssociations without error', async () => {
            ...
            client.descriptors.page.listFirewallEndpointAssociations.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.networksecurity.v1.IFirewallEndpointAssociation[] = [];
            const iterable = client.listFirewallEndpointAssociationsAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listFirewallEndpointAssociations.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listFirewallEndpointAssociations.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listFirewallEndpointAssociations with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listFirewallEndpointAssociations.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listFirewallEndpointAssociationsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.networksecurity.v1.IFirewallEndpointAssociation[] = [];
                for await (const resource of iterable) {
