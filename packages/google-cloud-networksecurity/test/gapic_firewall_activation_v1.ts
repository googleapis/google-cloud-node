...
describe('v1.FirewallActivationClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          firewallactivationModule.v1.FirewallActivationClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          firewallactivationModule.v1.FirewallActivationClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'networksecurity.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new firewallactivationModule.v1.FirewallActivationClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'networksecurity.example.com');
          if (saved) {
  ...
  describe('getFirewallEndpoint', () => {
    it('invokes getFirewallEndpoint without error', async () => {
      ...
      client.innerApiCalls.getFirewallEndpoint =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getFirewallEndpoint(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getFirewallEndpoint as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getFirewallEndpoint without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getFirewallEndpoint(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1.IFirewallEndpoint | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getFirewallEndpoint with error', async () => {
      ...
      client.innerApiCalls.getFirewallEndpoint = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getProjectFirewallEndpoint', () => {
    it('invokes getProjectFirewallEndpoint without error', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.getProjectFirewallEndpoint =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getProjectFirewallEndpoint(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getProjectFirewallEndpoint as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getProjectFirewallEndpoint as SinonStub
    ...
    it('invokes getProjectFirewallEndpoint without error using callback', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.getProjectFirewallEndpoint =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getProjectFirewallEndpoint(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1.IFirewallEndpoint | null,
    ...
    it('invokes getProjectFirewallEndpoint with error', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getProjectFirewallEndpoint = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getProjectFirewallEndpoint(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getProjectFirewallEndpoint as SinonStub
    ...
    it('invokes getProjectFirewallEndpoint with closed client', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
  ...
  describe('getFirewallEndpointAssociation', () => {
    it('invokes getFirewallEndpointAssociation without error', async () => {
      ...
      client.innerApiCalls.getFirewallEndpointAssociation =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getFirewallEndpointAssociation(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getFirewallEndpointAssociation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getFirewallEndpointAssociation as SinonStub
    ...
    it('invokes getFirewallEndpointAssociation without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getFirewallEndpointAssociation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1.IFirewallEndpointAssociation | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getFirewallEndpointAssociation with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getFirewallEndpointAssociation = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getFirewallEndpointAssociation(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getFirewallEndpointAssociation as SinonStub
  ...
  describe('createFirewallEndpoint', () => {
    it('invokes createFirewallEndpoint without error', async () => {
      ...
      client.innerApiCalls.createFirewallEndpoint =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createFirewallEndpoint(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createFirewallEndpoint as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createFirewallEndpoint as SinonStub
    ...
    it('invokes createFirewallEndpoint with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createFirewallEndpoint = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createFirewallEndpoint(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createFirewallEndpoint as SinonStub
    ...
    it('invokes checkCreateFirewallEndpointProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateFirewallEndpointProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createProjectFirewallEndpoint', () => {
    it('invokes createProjectFirewallEndpoint without error', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.createProjectFirewallEndpoint =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createProjectFirewallEndpoint(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createProjectFirewallEndpoint as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createProjectFirewallEndpoint as SinonStub
    ...
    it('invokes createProjectFirewallEndpoint without error using callback', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.createProjectFirewallEndpoint =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createProjectFirewallEndpoint(
          request,
          (
            err?: Error | null,
            result?: LROperation<
    ...
    it('invokes createProjectFirewallEndpoint with call error', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createProjectFirewallEndpoint = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createProjectFirewallEndpoint(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createProjectFirewallEndpoint as SinonStub
    ...
    it('invokes createProjectFirewallEndpoint with LRO error', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
    ...
    it('invokes checkCreateProjectFirewallEndpointProgress without error', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      const decodedOperation =
        await client.checkCreateProjectFirewallEndpointProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkCreateProjectFirewallEndpointProgress with error', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
  ...
  describe('deleteFirewallEndpoint', () => {
    it('invokes deleteFirewallEndpoint without error', async () => {
      ...
      client.innerApiCalls.deleteFirewallEndpoint =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteFirewallEndpoint(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteFirewallEndpoint as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteFirewallEndpoint as SinonStub
    ...
    it('invokes deleteFirewallEndpoint with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteFirewallEndpoint = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteFirewallEndpoint(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteFirewallEndpoint as SinonStub
    ...
    it('invokes checkDeleteFirewallEndpointProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteFirewallEndpointProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteProjectFirewallEndpoint', () => {
    it('invokes deleteProjectFirewallEndpoint without error', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.deleteProjectFirewallEndpoint =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteProjectFirewallEndpoint(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteProjectFirewallEndpoint as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteProjectFirewallEndpoint as SinonStub
    ...
    it('invokes deleteProjectFirewallEndpoint without error using callback', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.deleteProjectFirewallEndpoint =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.deleteProjectFirewallEndpoint(
          request,
          (
            err?: Error | null,
            result?: LROperation<
    ...
    it('invokes deleteProjectFirewallEndpoint with call error', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteProjectFirewallEndpoint = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteProjectFirewallEndpoint(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteProjectFirewallEndpoint as SinonStub
    ...
    it('invokes deleteProjectFirewallEndpoint with LRO error', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
    ...
    it('invokes checkDeleteProjectFirewallEndpointProgress without error', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkDeleteProjectFirewallEndpointProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkDeleteProjectFirewallEndpointProgress with error', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      await assert.rejects(
        client.checkDeleteProjectFirewallEndpointProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateFirewallEndpoint', () => {
    it('invokes updateFirewallEndpoint without error', async () => {
      ...
      client.innerApiCalls.updateFirewallEndpoint =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateFirewallEndpoint(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateFirewallEndpoint as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateFirewallEndpoint as SinonStub
    ...
    it('invokes updateFirewallEndpoint with call error', async () => {
      ...
      const expectedHeaderRequestParams = `firewall_endpoint.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateFirewallEndpoint = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateFirewallEndpoint(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateFirewallEndpoint as SinonStub
    ...
    it('invokes checkUpdateFirewallEndpointProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateFirewallEndpointProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateProjectFirewallEndpoint', () => {
    it('invokes updateProjectFirewallEndpoint without error', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.updateProjectFirewallEndpoint =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateProjectFirewallEndpoint(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateProjectFirewallEndpoint as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateProjectFirewallEndpoint as SinonStub
    ...
    it('invokes updateProjectFirewallEndpoint without error using callback', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
    ...
    it('invokes updateProjectFirewallEndpoint with call error', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `firewall_endpoint.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateProjectFirewallEndpoint = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateProjectFirewallEndpoint(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateProjectFirewallEndpoint as SinonStub
    ...
    it('invokes updateProjectFirewallEndpoint with LRO error', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
    ...
    it('invokes checkUpdateProjectFirewallEndpointProgress without error', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkUpdateProjectFirewallEndpointProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkUpdateProjectFirewallEndpointProgress with error', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      await assert.rejects(
        client.checkUpdateProjectFirewallEndpointProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createFirewallEndpointAssociation', () => {
    it('invokes createFirewallEndpointAssociation without error', async () => {
      ...
      client.innerApiCalls.createFirewallEndpointAssociation =
        stubLongRunningCall(expectedResponse);
      const [operation] =
        await client.createFirewallEndpointAssociation(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createFirewallEndpointAssociation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createFirewallEndpointAssociation as SinonStub
    ...
    it('invokes createFirewallEndpointAssociation with call error', async () => {
      ...
      await assert.rejects(
        client.createFirewallEndpointAssociation(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createFirewallEndpointAssociation as SinonStub
    ...
    it('invokes checkCreateFirewallEndpointAssociationProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkCreateFirewallEndpointAssociationProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkCreateFirewallEndpointAssociationProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateFirewallEndpointAssociationProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteFirewallEndpointAssociation', () => {
    it('invokes deleteFirewallEndpointAssociation without error', async () => {
      ...
      client.innerApiCalls.deleteFirewallEndpointAssociation =
        stubLongRunningCall(expectedResponse);
      const [operation] =
        await client.deleteFirewallEndpointAssociation(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteFirewallEndpointAssociation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteFirewallEndpointAssociation as SinonStub
    ...
    it('invokes deleteFirewallEndpointAssociation with call error', async () => {
      ...
      client.innerApiCalls.deleteFirewallEndpointAssociation =
        stubLongRunningCall(undefined, expectedError);
      await assert.rejects(
        client.deleteFirewallEndpointAssociation(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteFirewallEndpointAssociation as SinonStub
    ...
    it('invokes checkDeleteFirewallEndpointAssociationProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkDeleteFirewallEndpointAssociationProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkDeleteFirewallEndpointAssociationProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteFirewallEndpointAssociationProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateFirewallEndpointAssociation', () => {
    it('invokes updateFirewallEndpointAssociation without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        ...
        ['firewallEndpointAssociation', 'name'],
      );
      ...
      client.innerApiCalls.updateFirewallEndpointAssociation =
        stubLongRunningCall(expectedResponse);
      const [operation] =
        await client.updateFirewallEndpointAssociation(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateFirewallEndpointAssociation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateFirewallEndpointAssociation as SinonStub
    ...
    it('invokes updateFirewallEndpointAssociation with call error', async () => {
      ...
      client.innerApiCalls.updateFirewallEndpointAssociation =
        stubLongRunningCall(undefined, expectedError);
      await assert.rejects(
        client.updateFirewallEndpointAssociation(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateFirewallEndpointAssociation as SinonStub
    ...
    it('invokes checkUpdateFirewallEndpointAssociationProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkUpdateFirewallEndpointAssociationProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkUpdateFirewallEndpointAssociationProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateFirewallEndpointAssociationProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listFirewallEndpoints', () => {
    it('invokes listFirewallEndpoints without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listFirewallEndpoints as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listFirewallEndpoints as SinonStub
    ...
    it('invokes listFirewallEndpoints with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listFirewallEndpoints = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listFirewallEndpoints(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listFirewallEndpoints as SinonStub
    ...
    it('invokes listFirewallEndpointsStream without error', async () => {
      ...
      client.descriptors.page.listFirewallEndpoints.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1.FirewallEndpoint,
          ) => {
      ...
      assert(
        (
          client.descriptors.page.listFirewallEndpoints
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listFirewallEndpoints, request),
      );
      assert(
        (
          client.descriptors.page.listFirewallEndpoints
    ...
    it('uses async iteration with listFirewallEndpoints without error', async () => {
      ...
      client.descriptors.page.listFirewallEndpoints.asyncIterate =
  ...
  describe('listProjectFirewallEndpoints', () => {
    it('invokes listProjectFirewallEndpoints without error', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.listProjectFirewallEndpoints =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listProjectFirewallEndpoints(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listProjectFirewallEndpoints as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listProjectFirewallEndpoints as SinonStub
    ...
    it('invokes listProjectFirewallEndpoints without error using callback', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.listProjectFirewallEndpoints =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listProjectFirewallEndpoints(
          request,
          (
            err?: Error | null,
            result?:
    ...
    it('invokes listProjectFirewallEndpoints with error', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      await assert.rejects(
        client.listProjectFirewallEndpoints(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listProjectFirewallEndpoints as SinonStub
    ...
    it('invokes listProjectFirewallEndpointsStream without error', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      client.descriptors.page.listProjectFirewallEndpoints.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listProjectFirewallEndpointsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.networksecurity.v1.FirewallEndpoint[] =
          [];
        stream.on(
      ...
      assert(
        (
          client.descriptors.page.listProjectFirewallEndpoints
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(
    ...
    it('invokes listProjectFirewallEndpointsStream with error', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
    ...
    it('uses async iteration with listProjectFirewallEndpoints without error', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      client.descriptors.page.listProjectFirewallEndpoints.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.networksecurity.v1.IFirewallEndpoint[] =
        [];
      const iterable = client.listProjectFirewallEndpointsAsync(request);
      for await (const resource of iterable) {
        responses.push(resource!);
      }
      assert.deepStrictEqual(responses, expectedResponse);
    ...
    it('uses async iteration with listProjectFirewallEndpoints with error', async () => {
      const client = new firewallactivationModule.v1.FirewallActivationClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
  ...
  describe('listFirewallEndpointAssociations', () => {
    it('invokes listFirewallEndpointAssociations without error', async () => {
      ...
      client.innerApiCalls.listFirewallEndpointAssociations =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listFirewallEndpointAssociations(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listFirewallEndpointAssociations as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listFirewallEndpointAssociations as SinonStub
    ...
    it('invokes listFirewallEndpointAssociations with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listFirewallEndpointAssociations = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listFirewallEndpointAssociations(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listFirewallEndpointAssociations as SinonStub
    ...
    it('invokes listFirewallEndpointAssociationsStream without error', async () => {
      ...
      client.descriptors.page.listFirewallEndpointAssociations.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1.FirewallEndpointAssociation,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (
          client.descriptors.page.listFirewallEndpointAssociations
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(
    ...
    it('uses async iteration with listFirewallEndpointAssociations without error', async () => {
      ...
      client.descriptors.page.listFirewallEndpointAssociations.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
