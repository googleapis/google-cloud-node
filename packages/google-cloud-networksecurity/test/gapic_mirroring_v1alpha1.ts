  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          mirroringModule.v1alpha1.MirroringClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          mirroringModule.v1alpha1.MirroringClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'networksecurity.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new mirroringModule.v1alpha1.MirroringClient({
          universe_domain: 'example.com',
    ...
    it('invokes getMirroringEndpointGroup without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getMirroringEndpointGroup(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1alpha1.IMirroringEndpointGroup | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getMirroringEndpointGroupAssociation without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getMirroringEndpointGroupAssociation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1alpha1.IMirroringEndpointGroupAssociation | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getMirroringDeploymentGroup without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getMirroringDeploymentGroup(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1alpha1.IMirroringDeploymentGroup | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getMirroringDeployment without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getMirroringDeployment(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1alpha1.IMirroringDeployment | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listMirroringEndpointGroupsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1alpha1.MirroringEndpointGroup,
          ) => {
    ...
    it('invokes listMirroringEndpointGroupAssociationsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1alpha1.MirroringEndpointGroupAssociation,
          ) => {
            responses.push(response);
          },
        );
    ...
    it('invokes listMirroringDeploymentGroupsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1alpha1.MirroringDeploymentGroup,
          ) => {
            responses.push(response);
          },
        );
    ...
    it('invokes listMirroringDeploymentsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1alpha1.MirroringDeployment,
          ) => {
            responses.push(response);
          },
        );
