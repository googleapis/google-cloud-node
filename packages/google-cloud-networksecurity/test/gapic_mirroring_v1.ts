...
describe('v1.MirroringClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new mirroringModule.v1.MirroringClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networksecurity.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new mirroringModule.v1.MirroringClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networksecurity.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new mirroringModule.v1.MirroringClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new mirroringModule.v1.MirroringClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getMirroringEndpointGroup', () => {
        it('invokes getMirroringEndpointGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.GetMirroringEndpointGroupRequest', ['name']);
        ...
        it('invokes getMirroringEndpointGroup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getMirroringEndpointGroup(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1.IMirroringEndpointGroup|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getMirroringEndpointGroupAssociation', () => {
        it('invokes getMirroringEndpointGroupAssociation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.GetMirroringEndpointGroupAssociationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getMirroringEndpointGroupAssociation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getMirroringEndpointGroupAssociation(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1.IMirroringEndpointGroupAssociation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getMirroringDeploymentGroup', () => {
        it('invokes getMirroringDeploymentGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.GetMirroringDeploymentGroupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getMirroringDeploymentGroup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getMirroringDeploymentGroup(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1.IMirroringDeploymentGroup|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getMirroringDeployment', () => {
        it('invokes getMirroringDeployment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.GetMirroringDeploymentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getMirroringDeployment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getMirroringDeployment(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1.IMirroringDeployment|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createMirroringEndpointGroup', () => {
        it('invokes createMirroringEndpointGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.CreateMirroringEndpointGroupRequest', ['parent']);
        ...
        it('invokes createMirroringEndpointGroup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createMirroringEndpointGroup(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networksecurity.v1.IMirroringEndpointGroup, protos.google.cloud.networksecurity.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networksecurity.v1.IMirroringEndpointGroup, protos.google.cloud.networksecurity.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createMirroringEndpointGroup as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateMirroringEndpointGroup', () => {
        it('invokes updateMirroringEndpointGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.UpdateMirroringEndpointGroupRequest', ['mirroringEndpointGroup', 'name']);
    ...
    describe('deleteMirroringEndpointGroup', () => {
        it('invokes deleteMirroringEndpointGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.DeleteMirroringEndpointGroupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createMirroringEndpointGroupAssociation', () => {
        it('invokes createMirroringEndpointGroupAssociation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.CreateMirroringEndpointGroupAssociationRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createMirroringEndpointGroupAssociation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createMirroringEndpointGroupAssociation(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networksecurity.v1.IMirroringEndpointGroupAssociation, protos.google.cloud.networksecurity.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networksecurity.v1.IMirroringEndpointGroupAssociation, protos.google.cloud.networksecurity.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createMirroringEndpointGroupAssociation as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateMirroringEndpointGroupAssociation', () => {
        it('invokes updateMirroringEndpointGroupAssociation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.UpdateMirroringEndpointGroupAssociationRequest', ['mirroringEndpointGroupAssociation', 'name']);
    ...
    describe('deleteMirroringEndpointGroupAssociation', () => {
        it('invokes deleteMirroringEndpointGroupAssociation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.DeleteMirroringEndpointGroupAssociationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createMirroringDeploymentGroup', () => {
        it('invokes createMirroringDeploymentGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.CreateMirroringDeploymentGroupRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createMirroringDeploymentGroup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createMirroringDeploymentGroup(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networksecurity.v1.IMirroringDeploymentGroup, protos.google.cloud.networksecurity.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networksecurity.v1.IMirroringDeploymentGroup, protos.google.cloud.networksecurity.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createMirroringDeploymentGroup as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateMirroringDeploymentGroup', () => {
        it('invokes updateMirroringDeploymentGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.UpdateMirroringDeploymentGroupRequest', ['mirroringDeploymentGroup', 'name']);
    ...
    describe('deleteMirroringDeploymentGroup', () => {
        it('invokes deleteMirroringDeploymentGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.DeleteMirroringDeploymentGroupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createMirroringDeployment', () => {
        it('invokes createMirroringDeployment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.CreateMirroringDeploymentRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createMirroringDeployment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createMirroringDeployment(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networksecurity.v1.IMirroringDeployment, protos.google.cloud.networksecurity.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networksecurity.v1.IMirroringDeployment, protos.google.cloud.networksecurity.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createMirroringDeployment as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateMirroringDeployment', () => {
        it('invokes updateMirroringDeployment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.UpdateMirroringDeploymentRequest', ['mirroringDeployment', 'name']);
    ...
    describe('deleteMirroringDeployment', () => {
        it('invokes deleteMirroringDeployment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.DeleteMirroringDeploymentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listMirroringEndpointGroups', () => {
        it('invokes listMirroringEndpointGroups without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.ListMirroringEndpointGroupsRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listMirroringEndpointGroupAssociations', () => {
        it('invokes listMirroringEndpointGroupAssociations without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.ListMirroringEndpointGroupAssociationsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.MirroringEndpointGroupAssociation()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.MirroringEndpointGroupAssociation()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.MirroringEndpointGroupAssociation()),
            ];
        ...
        it('invokes listMirroringEndpointGroupAssociationsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networksecurity.v1.MirroringEndpointGroupAssociation) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listMirroringDeploymentGroups', () => {
        it('invokes listMirroringDeploymentGroups without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.ListMirroringDeploymentGroupsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
    ...
    describe('listMirroringDeployments', () => {
        it('invokes listMirroringDeployments without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.ListMirroringDeploymentsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.MirroringDeployment()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.MirroringDeployment()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.MirroringDeployment()),
            ];
        ...
        it('invokes listMirroringDeploymentsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networksecurity.v1.MirroringDeployment) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
