...
describe('v1.InterceptClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new interceptModule.v1.InterceptClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networksecurity.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new interceptModule.v1.InterceptClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networksecurity.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new interceptModule.v1.InterceptClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new interceptModule.v1.InterceptClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getInterceptEndpointGroup', () => {
        it('invokes getInterceptEndpointGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.GetInterceptEndpointGroupRequest', ['name']);
        ...
        it('invokes getInterceptEndpointGroup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getInterceptEndpointGroup(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1.IInterceptEndpointGroup|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getInterceptEndpointGroupAssociation', () => {
        it('invokes getInterceptEndpointGroupAssociation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.GetInterceptEndpointGroupAssociationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getInterceptEndpointGroupAssociation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getInterceptEndpointGroupAssociation(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1.IInterceptEndpointGroupAssociation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getInterceptDeploymentGroup', () => {
        it('invokes getInterceptDeploymentGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.GetInterceptDeploymentGroupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getInterceptDeploymentGroup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getInterceptDeploymentGroup(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1.IInterceptDeploymentGroup|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getInterceptDeployment', () => {
        it('invokes getInterceptDeployment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.GetInterceptDeploymentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getInterceptDeployment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getInterceptDeployment(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1.IInterceptDeployment|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createInterceptEndpointGroup', () => {
        it('invokes createInterceptEndpointGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.CreateInterceptEndpointGroupRequest', ['parent']);
        ...
        it('invokes createInterceptEndpointGroup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createInterceptEndpointGroup(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networksecurity.v1.IInterceptEndpointGroup, protos.google.cloud.networksecurity.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networksecurity.v1.IInterceptEndpointGroup, protos.google.cloud.networksecurity.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createInterceptEndpointGroup as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateInterceptEndpointGroup', () => {
        it('invokes updateInterceptEndpointGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.UpdateInterceptEndpointGroupRequest', ['interceptEndpointGroup', 'name']);
    ...
    describe('deleteInterceptEndpointGroup', () => {
        it('invokes deleteInterceptEndpointGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.DeleteInterceptEndpointGroupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createInterceptEndpointGroupAssociation', () => {
        it('invokes createInterceptEndpointGroupAssociation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.CreateInterceptEndpointGroupAssociationRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createInterceptEndpointGroupAssociation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createInterceptEndpointGroupAssociation(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networksecurity.v1.IInterceptEndpointGroupAssociation, protos.google.cloud.networksecurity.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networksecurity.v1.IInterceptEndpointGroupAssociation, protos.google.cloud.networksecurity.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createInterceptEndpointGroupAssociation as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateInterceptEndpointGroupAssociation', () => {
        it('invokes updateInterceptEndpointGroupAssociation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.UpdateInterceptEndpointGroupAssociationRequest', ['interceptEndpointGroupAssociation', 'name']);
    ...
    describe('deleteInterceptEndpointGroupAssociation', () => {
        it('invokes deleteInterceptEndpointGroupAssociation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.DeleteInterceptEndpointGroupAssociationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createInterceptDeploymentGroup', () => {
        it('invokes createInterceptDeploymentGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.CreateInterceptDeploymentGroupRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createInterceptDeploymentGroup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createInterceptDeploymentGroup(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networksecurity.v1.IInterceptDeploymentGroup, protos.google.cloud.networksecurity.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networksecurity.v1.IInterceptDeploymentGroup, protos.google.cloud.networksecurity.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createInterceptDeploymentGroup as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateInterceptDeploymentGroup', () => {
        it('invokes updateInterceptDeploymentGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.UpdateInterceptDeploymentGroupRequest', ['interceptDeploymentGroup', 'name']);
    ...
    describe('deleteInterceptDeploymentGroup', () => {
        it('invokes deleteInterceptDeploymentGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.DeleteInterceptDeploymentGroupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createInterceptDeployment', () => {
        it('invokes createInterceptDeployment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.CreateInterceptDeploymentRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createInterceptDeployment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createInterceptDeployment(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networksecurity.v1.IInterceptDeployment, protos.google.cloud.networksecurity.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networksecurity.v1.IInterceptDeployment, protos.google.cloud.networksecurity.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createInterceptDeployment as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateInterceptDeployment', () => {
        it('invokes updateInterceptDeployment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.UpdateInterceptDeploymentRequest', ['interceptDeployment', 'name']);
    ...
    describe('deleteInterceptDeployment', () => {
        it('invokes deleteInterceptDeployment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.DeleteInterceptDeploymentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listInterceptEndpointGroups', () => {
        it('invokes listInterceptEndpointGroups without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.ListInterceptEndpointGroupsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.InterceptEndpointGroup()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.InterceptEndpointGroup()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.InterceptEndpointGroup()),
            ];
        ...
        it('invokes listInterceptEndpointGroupsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networksecurity.v1.InterceptEndpointGroup) => {
    ...
    describe('listInterceptEndpointGroupAssociations', () => {
        it('invokes listInterceptEndpointGroupAssociations without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.ListInterceptEndpointGroupAssociationsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
    ...
    describe('listInterceptDeploymentGroups', () => {
        it('invokes listInterceptDeploymentGroups without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.ListInterceptDeploymentGroupsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
    ...
    describe('listInterceptDeployments', () => {
        it('invokes listInterceptDeployments without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.ListInterceptDeploymentsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
