...
describe('v1alpha1.InterceptClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          interceptModule.v1alpha1.InterceptClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          interceptModule.v1alpha1.InterceptClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'networksecurity.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new interceptModule.v1alpha1.InterceptClient({
          universe_domain: 'example.com',
    ...
    it('invokes getInterceptEndpointGroup without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getInterceptEndpointGroup(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1alpha1.IInterceptEndpointGroup | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getInterceptEndpointGroupAssociation without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getInterceptEndpointGroupAssociation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1alpha1.IInterceptEndpointGroupAssociation | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getInterceptDeploymentGroup without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getInterceptDeploymentGroup(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1alpha1.IInterceptDeploymentGroup | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getInterceptDeployment without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getInterceptDeployment(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1alpha1.IInterceptDeployment | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listInterceptEndpointGroupsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1alpha1.InterceptEndpointGroup,
          ) => {
    ...
    it('invokes listInterceptEndpointGroupAssociationsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1alpha1.InterceptEndpointGroupAssociation,
          ) => {
            responses.push(response);
          },
        );
    ...
    it('invokes listInterceptDeploymentGroupsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1alpha1.InterceptDeploymentGroup,
          ) => {
            responses.push(response);
          },
        );
    ...
    it('invokes listInterceptDeploymentsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1alpha1.InterceptDeployment,
          ) => {
            responses.push(response);
          },
        );
  ...
  describe('Path templates', () => {
    ...
    describe('partnerSSEGateway', async () => {
      ...
      await client.initialize();
      client.pathTemplates.partnerSSEGatewayPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.partnerSSEGatewayPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('partnerSSEGatewayPath', () => {
        const result = client.partnerSSEGatewayPath(
          'projectValue',
          'locationValue',
          'partnerSseGatewayValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.partnerSSEGatewayPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchPartnerSseGatewayFromPartnerSSEGatewayName', () => {
        const result =
          client.matchPartnerSseGatewayFromPartnerSSEGatewayName(fakePath);
    ...
    describe('partnerSSERealm', async () => {
      ...
      await client.initialize();
      client.pathTemplates.partnerSSERealmPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.partnerSSERealmPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('partnerSSERealmPath', () => {
        const result = client.partnerSSERealmPath(
          'projectValue',
          'locationValue',
          'partnerSseRealmValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.partnerSSERealmPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromPartnerSSERealmName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.partnerSSERealmPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchPartnerSseRealmFromPartnerSSERealmName', () => {
        const result =
          client.matchPartnerSseRealmFromPartnerSSERealmName(fakePath);
    ...
    describe('sSEGatewayReference', async () => {
      ...
      await client.initialize();
      client.pathTemplates.sSEGatewayReferencePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.sSEGatewayReferencePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('sSEGatewayReferencePath', () => {
        const result = client.sSEGatewayReferencePath(
          'projectValue',
          'locationValue',
          'sseGatewayReferenceValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.sSEGatewayReferencePathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchLocationFromSSEGatewayReferenceName', () => {
        const result =
          client.matchLocationFromSSEGatewayReferenceName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.sSEGatewayReferencePathTemplate
      ...
      it('matchSseGatewayReferenceFromSSEGatewayReferenceName', () => {
        const result =
          client.matchSseGatewayReferenceFromSSEGatewayReferenceName(fakePath);
