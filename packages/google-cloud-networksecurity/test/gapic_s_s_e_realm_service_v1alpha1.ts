...
describe('v1alpha1.SSERealmServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          sserealmserviceModule.v1alpha1.SSERealmServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          sserealmserviceModule.v1alpha1.SSERealmServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'networksecurity.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new sserealmserviceModule.v1alpha1.SSERealmServiceClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'networksecurity.example.com');
          if (saved) {
  ...
  describe('getSACRealm', () => {
    it('invokes getSACRealm without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getSacRealm as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getSACRealm without error using callback', async () => {
      ...
      client.innerApiCalls.getSacRealm =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getSACRealm(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1alpha1.ISACRealm | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getSACRealm with error', async () => {
      ...
      client.innerApiCalls.getSacRealm = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getSACAttachment', () => {
    it('invokes getSACAttachment without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getSacAttachment as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getSacAttachment as SinonStub
    ...
    it('invokes getSACAttachment without error using callback', async () => {
      ...
      client.innerApiCalls.getSacAttachment =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getSACAttachment(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1alpha1.ISACAttachment | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getSACAttachment with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getSacAttachment = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getPartnerSSERealm', () => {
    it('invokes getPartnerSSERealm without error', async () => {
      ...
      client.innerApiCalls.getPartnerSseRealm =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getPartnerSSERealm(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getPartnerSseRealm as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getPartnerSseRealm as SinonStub
    ...
    it('invokes getPartnerSSERealm without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getPartnerSSERealm(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1alpha1.IPartnerSSERealm | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getPartnerSSERealm with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getPartnerSseRealm = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createSACRealm', () => {
    it('invokes createSACRealm without error', async () => {
      ...
      client.innerApiCalls.createSacRealm =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createSACRealm(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createSacRealm as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createSacRealm as SinonStub
    ...
    it('invokes createSACRealm with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createSacRealm = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteSACRealm', () => {
    it('invokes deleteSACRealm without error', async () => {
      ...
      client.innerApiCalls.deleteSacRealm =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteSACRealm(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteSacRealm as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteSacRealm as SinonStub
    ...
    it('invokes deleteSACRealm with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteSacRealm = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkDeleteSACRealmProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteSACRealmProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createSACAttachment', () => {
    it('invokes createSACAttachment without error', async () => {
      ...
      client.innerApiCalls.createSacAttachment =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createSACAttachment(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createSacAttachment as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createSacAttachment as SinonStub
    ...
    it('invokes createSACAttachment with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createSacAttachment = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteSACAttachment', () => {
    it('invokes deleteSACAttachment without error', async () => {
      ...
      client.innerApiCalls.deleteSacAttachment =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteSACAttachment(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteSacAttachment as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteSacAttachment as SinonStub
    ...
    it('invokes deleteSACAttachment with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteSacAttachment = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkDeleteSACAttachmentProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteSACAttachmentProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createPartnerSSERealm', () => {
    it('invokes createPartnerSSERealm without error', async () => {
      ...
      client.innerApiCalls.createPartnerSseRealm =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createPartnerSSERealm(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createPartnerSseRealm as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createPartnerSseRealm as SinonStub
    ...
    it('invokes createPartnerSSERealm with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createPartnerSseRealm = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createPartnerSSERealm(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createPartnerSseRealm as SinonStub
    ...
    it('invokes checkCreatePartnerSSERealmProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreatePartnerSSERealmProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deletePartnerSSERealm', () => {
    it('invokes deletePartnerSSERealm without error', async () => {
      ...
      client.innerApiCalls.deletePartnerSseRealm =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deletePartnerSSERealm(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deletePartnerSseRealm as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deletePartnerSseRealm as SinonStub
    ...
    it('invokes deletePartnerSSERealm with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deletePartnerSseRealm = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deletePartnerSSERealm(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deletePartnerSseRealm as SinonStub
  ...
  describe('listSACRealms', () => {
    it('invokes listSACRealms without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listSacRealms as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listSacRealms as SinonStub
    ...
    it('invokes listSACRealms without error using callback', async () => {
      ...
      client.innerApiCalls.listSacRealms =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listSACRealms with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listSacRealms = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listSACRealmsStream without error', async () => {
      ...
      client.descriptors.page.listSACRealms.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.networksecurity.v1alpha1.SACRealm) => {
      ...
      assert(
        (client.descriptors.page.listSACRealms.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listSacRealms, request),
      );
      assert(
        (client.descriptors.page.listSACRealms.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listSACRealms without error', async () => {
      ...
      client.descriptors.page.listSACRealms.asyncIterate =
  ...
  describe('listSACAttachments', () => {
    it('invokes listSACAttachments without error', async () => {
      ...
      client.innerApiCalls.listSacAttachments =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listSACAttachments(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listSacAttachments as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listSacAttachments as SinonStub
    ...
    it('invokes listSACAttachments with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listSacAttachments = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listSACAttachmentsStream without error', async () => {
      ...
      client.descriptors.page.listSACAttachments.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1alpha1.SACAttachment,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (client.descriptors.page.listSACAttachments.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listSacAttachments, request),
      );
      assert(
        (client.descriptors.page.listSACAttachments.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listSACAttachments without error', async () => {
      ...
      client.descriptors.page.listSACAttachments.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listPartnerSSERealms', () => {
    it('invokes listPartnerSSERealms without error', async () => {
      ...
      client.innerApiCalls.listPartnerSseRealms =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listPartnerSSERealms(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listPartnerSseRealms as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listPartnerSseRealms as SinonStub
    ...
    it('invokes listPartnerSSERealms with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listPartnerSseRealms = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listPartnerSSERealmsStream without error', async () => {
      ...
      client.descriptors.page.listPartnerSSERealms.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1alpha1.PartnerSSERealm,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (client.descriptors.page.listPartnerSSERealms.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listPartnerSseRealms, request),
      );
      assert(
        (client.descriptors.page.listPartnerSSERealms.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listPartnerSSERealms without error', async () => {
      ...
      client.descriptors.page.listPartnerSSERealms.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
