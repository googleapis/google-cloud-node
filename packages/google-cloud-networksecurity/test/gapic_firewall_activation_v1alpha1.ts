  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          firewallactivationModule.v1alpha1.FirewallActivationClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        firewallactivationModule.v1alpha1.FirewallActivationClient.port;
      assert(port);
    ...
    it('invokes getFirewallEndpoint without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getFirewallEndpoint(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1alpha1.IFirewallEndpoint | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getFirewallEndpointAssociation without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getFirewallEndpointAssociation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1alpha1.IFirewallEndpointAssociation | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listFirewallEndpointsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1alpha1.FirewallEndpoint,
          ) => {
    ...
    it('invokes listFirewallEndpointAssociationsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1alpha1.FirewallEndpointAssociation,
          ) => {
            responses.push(response);
          },
        );
