...
describe('v1alpha1.FirewallActivationClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new firewallactivationModule.v1alpha1.FirewallActivationClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = firewallactivationModule.v1alpha1.FirewallActivationClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = firewallactivationModule.v1alpha1.FirewallActivationClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'networksecurity.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new firewallactivationModule.v1alpha1.FirewallActivationClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networksecurity.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new firewallactivationModule.v1alpha1.FirewallActivationClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networksecurity.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new firewallactivationModule.v1alpha1.FirewallActivationClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new firewallactivationModule.v1alpha1.FirewallActivationClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = firewallactivationModule.v1alpha1.FirewallActivationClient.port;
            assert(port);
    ...
    describe('getFirewallEndpoint', () => {
        it('invokes getFirewallEndpoint without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1alpha1.GetFirewallEndpointRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1alpha1.GetFirewallEndpointRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1alpha1.FirewallEndpoint()
            );
        ...
        it('invokes getFirewallEndpoint without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getFirewallEndpoint(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1alpha1.IFirewallEndpoint|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getFirewallEndpointAssociation', () => {
        it('invokes getFirewallEndpointAssociation without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1alpha1.GetFirewallEndpointAssociationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1alpha1.GetFirewallEndpointAssociationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1alpha1.FirewallEndpointAssociation()
            );
        ...
        it('invokes getFirewallEndpointAssociation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getFirewallEndpointAssociation(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1alpha1.IFirewallEndpointAssociation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createFirewallEndpoint', () => {
        it('invokes createFirewallEndpoint without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1alpha1.CreateFirewallEndpointRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1alpha1.CreateFirewallEndpointRequest', ['parent']);
        ...
        it('invokes createFirewallEndpoint without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createFirewallEndpoint(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networksecurity.v1alpha1.IFirewallEndpoint, protos.google.cloud.networksecurity.v1alpha1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networksecurity.v1alpha1.IFirewallEndpoint, protos.google.cloud.networksecurity.v1alpha1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createFirewallEndpoint as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteFirewallEndpoint', () => {
        it('invokes deleteFirewallEndpoint without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1alpha1.DeleteFirewallEndpointRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1alpha1.DeleteFirewallEndpointRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('updateFirewallEndpoint', () => {
        it('invokes updateFirewallEndpoint without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1alpha1.UpdateFirewallEndpointRequest()
            );
            request.firewallEndpoint ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1alpha1.UpdateFirewallEndpointRequest', ['firewallEndpoint', 'name']);
    ...
    describe('createFirewallEndpointAssociation', () => {
        it('invokes createFirewallEndpointAssociation without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1alpha1.CreateFirewallEndpointAssociationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1alpha1.CreateFirewallEndpointAssociationRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createFirewallEndpointAssociation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createFirewallEndpointAssociation(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networksecurity.v1alpha1.IFirewallEndpointAssociation, protos.google.cloud.networksecurity.v1alpha1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networksecurity.v1alpha1.IFirewallEndpointAssociation, protos.google.cloud.networksecurity.v1alpha1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createFirewallEndpointAssociation as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteFirewallEndpointAssociation', () => {
        it('invokes deleteFirewallEndpointAssociation without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1alpha1.DeleteFirewallEndpointAssociationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1alpha1.DeleteFirewallEndpointAssociationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('updateFirewallEndpointAssociation', () => {
        it('invokes updateFirewallEndpointAssociation without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1alpha1.UpdateFirewallEndpointAssociationRequest()
            );
            request.firewallEndpointAssociation ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1alpha1.UpdateFirewallEndpointAssociationRequest', ['firewallEndpointAssociation', 'name']);
    ...
    describe('listFirewallEndpoints', () => {
        it('invokes listFirewallEndpoints without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1alpha1.ListFirewallEndpointsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1alpha1.ListFirewallEndpointsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networksecurity.v1alpha1.FirewallEndpoint()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1alpha1.FirewallEndpoint()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1alpha1.FirewallEndpoint()),
            ];
        ...
        it('invokes listFirewallEndpointsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.networksecurity.v1alpha1.FirewallEndpoint[] = [];
                stream.on('data', (response: protos.google.cloud.networksecurity.v1alpha1.FirewallEndpoint) => {
        ...
        it('uses async iteration with listFirewallEndpoints without error', async () => {
            ...
            const responses: protos.google.cloud.networksecurity.v1alpha1.IFirewallEndpoint[] = [];
    ...
    describe('listFirewallEndpointAssociations', () => {
        it('invokes listFirewallEndpointAssociations without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1alpha1.ListFirewallEndpointAssociationsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1alpha1.ListFirewallEndpointAssociationsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
        ...
        it('uses async iteration with listFirewallEndpointAssociations without error', async () => {
            ...
            const responses: protos.google.cloud.networksecurity.v1alpha1.IFirewallEndpointAssociation[] = [];
