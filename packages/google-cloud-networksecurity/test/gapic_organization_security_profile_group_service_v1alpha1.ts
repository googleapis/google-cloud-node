  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          organizationsecurityprofilegroupserviceModule.v1alpha1
    ...
    it('invokes getSecurityProfileGroup without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getSecurityProfileGroup(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1alpha1.ISecurityProfileGroup | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getSecurityProfile without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getSecurityProfile(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1alpha1.ISecurityProfile | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listSecurityProfileGroupsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1alpha1.SecurityProfileGroup,
          ) => {
    ...
    it('invokes listSecurityProfilesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1alpha1.SecurityProfile,
          ) => {
            responses.push(response);
          },
        );
