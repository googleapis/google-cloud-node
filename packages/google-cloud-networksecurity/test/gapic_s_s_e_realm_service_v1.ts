...
describe('v1.SSERealmServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client = new sserealmserviceModule.v1.SSERealmServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          sserealmserviceModule.v1.SSERealmServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          sserealmserviceModule.v1.SSERealmServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'networksecurity.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new sserealmserviceModule.v1.SSERealmServiceClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = sserealmserviceModule.v1.SSERealmServiceClient.port;
      assert(port);
  ...
  describe('getSACRealm', () => {
    it('invokes getSACRealm without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.GetSACRealmRequest(),
      );
    ...
    it('invokes getSACRealm without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getSACRealm(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1.ISACRealm | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getSACAttachment', () => {
    it('invokes getSACAttachment without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.GetSACAttachmentRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.SACAttachment(),
      );
    ...
    it('invokes getSACAttachment without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getSACAttachment(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1.ISACAttachment | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createSACRealm', () => {
    it('invokes createSACRealm without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.CreateSACRealmRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('deleteSACRealm', () => {
    it('invokes deleteSACRealm without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.DeleteSACRealmRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('createSACAttachment', () => {
    it('invokes createSACAttachment without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.CreateSACAttachmentRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('deleteSACAttachment', () => {
    it('invokes deleteSACAttachment without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.DeleteSACAttachmentRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('listSACRealms', () => {
    it('invokes listSACRealms without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.ListSACRealmsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
    ...
    it('invokes listSACRealmsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.networksecurity.v1.SACRealm) => {
    ...
    it('uses async iteration with listSACRealms without error', async () => {
      ...
      const responses: protos.google.cloud.networksecurity.v1.ISACRealm[] = [];
  ...
  describe('listSACAttachments', () => {
    it('invokes listSACAttachments without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.ListSACAttachmentsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
    ...
    it('invokes listSACAttachmentsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.networksecurity.v1.SACAttachment[] =
          [];
        stream.on(
          'data',
          (response: protos.google.cloud.networksecurity.v1.SACAttachment) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
    ...
    it('uses async iteration with listSACAttachments without error', async () => {
      ...
      client.descriptors.page.listSACAttachments.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.networksecurity.v1.ISACAttachment[] =
        [];
