...
describe('v1beta1.NetworkSecurityClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new networksecurityModule.v1beta1.NetworkSecurityClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networksecurity.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new networksecurityModule.v1beta1.NetworkSecurityClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networksecurity.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new networksecurityModule.v1beta1.NetworkSecurityClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new networksecurityModule.v1beta1.NetworkSecurityClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getAuthorizationPolicy', () => {
        it('invokes getAuthorizationPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1beta1.GetAuthorizationPolicyRequest', ['name']);
    ...
    describe('getServerTlsPolicy', () => {
        it('invokes getServerTlsPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1beta1.GetServerTlsPolicyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getClientTlsPolicy', () => {
        it('invokes getClientTlsPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1beta1.GetClientTlsPolicyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createAuthorizationPolicy', () => {
        it('invokes createAuthorizationPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1beta1.CreateAuthorizationPolicyRequest', ['parent']);
    ...
    describe('updateAuthorizationPolicy', () => {
        it('invokes updateAuthorizationPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1beta1.UpdateAuthorizationPolicyRequest', ['authorizationPolicy', 'name']);
    ...
    describe('deleteAuthorizationPolicy', () => {
        it('invokes deleteAuthorizationPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1beta1.DeleteAuthorizationPolicyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createServerTlsPolicy', () => {
        it('invokes createServerTlsPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1beta1.CreateServerTlsPolicyRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('updateServerTlsPolicy', () => {
        it('invokes updateServerTlsPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1beta1.UpdateServerTlsPolicyRequest', ['serverTlsPolicy', 'name']);
    ...
    describe('deleteServerTlsPolicy', () => {
        it('invokes deleteServerTlsPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1beta1.DeleteServerTlsPolicyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createClientTlsPolicy', () => {
        it('invokes createClientTlsPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1beta1.CreateClientTlsPolicyRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('updateClientTlsPolicy', () => {
        it('invokes updateClientTlsPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1beta1.UpdateClientTlsPolicyRequest', ['clientTlsPolicy', 'name']);
    ...
    describe('deleteClientTlsPolicy', () => {
        it('invokes deleteClientTlsPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1beta1.DeleteClientTlsPolicyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listAuthorizationPolicies', () => {
        it('invokes listAuthorizationPolicies without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1beta1.ListAuthorizationPoliciesRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listServerTlsPolicies', () => {
        it('invokes listServerTlsPolicies without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1beta1.ListServerTlsPoliciesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
    ...
    describe('listClientTlsPolicies', () => {
        it('invokes listClientTlsPolicies without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1beta1.ListClientTlsPoliciesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
