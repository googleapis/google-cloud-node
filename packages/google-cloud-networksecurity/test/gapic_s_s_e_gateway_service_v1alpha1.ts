...
describe('v1alpha1.SSEGatewayServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new ssegatewayserviceModule.v1alpha1.SSEGatewayServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = ssegatewayserviceModule.v1alpha1.SSEGatewayServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = ssegatewayserviceModule.v1alpha1.SSEGatewayServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'networksecurity.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new ssegatewayserviceModule.v1alpha1.SSEGatewayServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networksecurity.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new ssegatewayserviceModule.v1alpha1.SSEGatewayServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networksecurity.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new ssegatewayserviceModule.v1alpha1.SSEGatewayServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new ssegatewayserviceModule.v1alpha1.SSEGatewayServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = ssegatewayserviceModule.v1alpha1.SSEGatewayServiceClient.port;
            assert(port);
    ...
    describe('getPartnerSSEGateway', () => {
        it('invokes getPartnerSSEGateway without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1alpha1.GetPartnerSSEGatewayRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1alpha1.GetPartnerSSEGatewayRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1alpha1.PartnerSSEGateway()
            );
            client.innerApiCalls.getPartnerSseGateway = stubSimpleCall(expectedResponse);
            const [response] = await client.getPartnerSSEGateway(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getPartnerSseGateway as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getPartnerSseGateway as SinonStub)
        ...
        it('invokes getPartnerSSEGateway without error using callback', async () => {
            ...
            client.innerApiCalls.getPartnerSseGateway = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getPartnerSSEGateway(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1alpha1.IPartnerSSEGateway|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getPartnerSSEGateway with error', async () => {
            ...
            client.innerApiCalls.getPartnerSseGateway = stubSimpleCall(undefined, expectedError);
    ...
    describe('getSSEGatewayReference', () => {
        it('invokes getSSEGatewayReference without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1alpha1.GetSSEGatewayReferenceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1alpha1.GetSSEGatewayReferenceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1alpha1.SSEGatewayReference()
            );
            client.innerApiCalls.getSseGatewayReference = stubSimpleCall(expectedResponse);
            const [response] = await client.getSSEGatewayReference(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getSseGatewayReference as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getSseGatewayReference as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getSSEGatewayReference without error using callback', async () => {
            ...
            client.innerApiCalls.getSseGatewayReference = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getSSEGatewayReference(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1alpha1.ISSEGatewayReference|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getSSEGatewayReference with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getSseGatewayReference = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getSSEGatewayReference(request), expectedError);
            const actualRequest = (client.innerApiCalls.getSseGatewayReference as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getSseGatewayReference as SinonStub)
    ...
    describe('createPartnerSSEGateway', () => {
        it('invokes createPartnerSSEGateway without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1alpha1.CreatePartnerSSEGatewayRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1alpha1.CreatePartnerSSEGatewayRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createPartnerSseGateway = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createPartnerSSEGateway(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createPartnerSseGateway as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createPartnerSseGateway as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createPartnerSSEGateway without error using callback', async () => {
            ...
            client.innerApiCalls.createPartnerSseGateway = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createPartnerSSEGateway(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networksecurity.v1alpha1.IPartnerSSEGateway, protos.google.cloud.networksecurity.v1alpha1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networksecurity.v1alpha1.IPartnerSSEGateway, protos.google.cloud.networksecurity.v1alpha1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createPartnerSseGateway as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createPartnerSSEGateway with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createPartnerSseGateway = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createPartnerSSEGateway(request), expectedError);
            const actualRequest = (client.innerApiCalls.createPartnerSseGateway as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createPartnerSseGateway as SinonStub)
        ...
        it('invokes createPartnerSSEGateway with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createPartnerSseGateway = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createPartnerSSEGateway(request);
        ...
        it('invokes checkCreatePartnerSSEGatewayProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreatePartnerSSEGatewayProgress(expectedResponse.name);
        ...
        it('invokes checkCreatePartnerSSEGatewayProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreatePartnerSSEGatewayProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('deletePartnerSSEGateway', () => {
        it('invokes deletePartnerSSEGateway without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1alpha1.DeletePartnerSSEGatewayRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1alpha1.DeletePartnerSSEGatewayRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deletePartnerSseGateway = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deletePartnerSSEGateway(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deletePartnerSseGateway as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deletePartnerSseGateway as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deletePartnerSSEGateway without error using callback', async () => {
            ...
            client.innerApiCalls.deletePartnerSseGateway = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deletePartnerSSEGateway(
                    request,
                    (err?: Error|null,
        ...
        it('invokes deletePartnerSSEGateway with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deletePartnerSseGateway = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deletePartnerSSEGateway(request), expectedError);
            const actualRequest = (client.innerApiCalls.deletePartnerSseGateway as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deletePartnerSseGateway as SinonStub)
        ...
        it('invokes deletePartnerSSEGateway with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deletePartnerSseGateway = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deletePartnerSSEGateway(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deletePartnerSseGateway as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeletePartnerSSEGatewayProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeletePartnerSSEGatewayProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeletePartnerSSEGatewayProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeletePartnerSSEGatewayProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('updatePartnerSSEGateway', () => {
        it('invokes updatePartnerSSEGateway without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1alpha1.UpdatePartnerSSEGatewayRequest()
            );
            request.partnerSseGateway ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1alpha1.UpdatePartnerSSEGatewayRequest', ['partnerSseGateway', 'name']);
            request.partnerSseGateway.name = defaultValue1;
            const expectedHeaderRequestParams = `partner_sse_gateway.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updatePartnerSseGateway = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updatePartnerSSEGateway(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updatePartnerSseGateway as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updatePartnerSseGateway as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updatePartnerSSEGateway without error using callback', async () => {
            ...
            client.innerApiCalls.updatePartnerSseGateway = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updatePartnerSSEGateway(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networksecurity.v1alpha1.IPartnerSSEGateway, protos.google.cloud.networksecurity.v1alpha1.IOperationMetadata>|null
                    ) => {
        ...
        it('invokes updatePartnerSSEGateway with call error', async () => {
            ...
            const expectedHeaderRequestParams = `partner_sse_gateway.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updatePartnerSseGateway = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.updatePartnerSSEGateway(request), expectedError);
            const actualRequest = (client.innerApiCalls.updatePartnerSseGateway as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updatePartnerSseGateway as SinonStub)
        ...
        it('invokes updatePartnerSSEGateway with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `partner_sse_gateway.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updatePartnerSseGateway = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updatePartnerSSEGateway(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updatePartnerSseGateway as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdatePartnerSSEGatewayProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdatePartnerSSEGatewayProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdatePartnerSSEGatewayProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdatePartnerSSEGatewayProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('listPartnerSSEGateways', () => {
        it('invokes listPartnerSSEGateways without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1alpha1.ListPartnerSSEGatewaysRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1alpha1.ListPartnerSSEGatewaysRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networksecurity.v1alpha1.PartnerSSEGateway()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1alpha1.PartnerSSEGateway()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1alpha1.PartnerSSEGateway()),
            ];
            client.innerApiCalls.listPartnerSseGateways = stubSimpleCall(expectedResponse);
            const [response] = await client.listPartnerSSEGateways(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listPartnerSseGateways as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listPartnerSseGateways as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listPartnerSSEGateways without error using callback', async () => {
            ...
            client.innerApiCalls.listPartnerSseGateways = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listPartnerSSEGateways(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1alpha1.IPartnerSSEGateway[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listPartnerSSEGateways with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listPartnerSseGateways = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listPartnerSSEGateways(request), expectedError);
            const actualRequest = (client.innerApiCalls.listPartnerSseGateways as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listPartnerSseGateways as SinonStub)
        ...
        it('invokes listPartnerSSEGatewaysStream without error', async () => {
            ...
            client.descriptors.page.listPartnerSSEGateways.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listPartnerSSEGatewaysStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.networksecurity.v1alpha1.PartnerSSEGateway[] = [];
                stream.on('data', (response: protos.google.cloud.networksecurity.v1alpha1.PartnerSSEGateway) => {
            ...
            assert((client.descriptors.page.listPartnerSSEGateways.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listPartnerSseGateways, request));
            assert(
                (client.descriptors.page.listPartnerSSEGateways.createStream as SinonStub)
        ...
        it('invokes listPartnerSSEGatewaysStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listPartnerSSEGateways.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listPartnerSSEGatewaysStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.networksecurity.v1alpha1.PartnerSSEGateway[] = [];
                stream.on('data', (response: protos.google.cloud.networksecurity.v1alpha1.PartnerSSEGateway) => {
        ...
        it('uses async iteration with listPartnerSSEGateways without error', async () => {
            ...
            client.descriptors.page.listPartnerSSEGateways.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.networksecurity.v1alpha1.IPartnerSSEGateway[] = [];
            const iterable = client.listPartnerSSEGatewaysAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listPartnerSSEGateways.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listPartnerSSEGateways with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listPartnerSSEGateways.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listPartnerSSEGatewaysAsync(request);
    ...
    describe('listSSEGatewayReferences', () => {
        it('invokes listSSEGatewayReferences without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networksecurity.v1alpha1.ListSSEGatewayReferencesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1alpha1.ListSSEGatewayReferencesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networksecurity.v1alpha1.SSEGatewayReference()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1alpha1.SSEGatewayReference()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1alpha1.SSEGatewayReference()),
            ];
            client.innerApiCalls.listSseGatewayReferences = stubSimpleCall(expectedResponse);
            const [response] = await client.listSSEGatewayReferences(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listSseGatewayReferences as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listSseGatewayReferences as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listSSEGatewayReferences without error using callback', async () => {
            ...
            client.innerApiCalls.listSseGatewayReferences = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listSSEGatewayReferences with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listSseGatewayReferences = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listSSEGatewayReferences(request), expectedError);
            const actualRequest = (client.innerApiCalls.listSseGatewayReferences as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listSseGatewayReferences as SinonStub)
        ...
        it('invokes listSSEGatewayReferencesStream without error', async () => {
            ...
            client.descriptors.page.listSSEGatewayReferences.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listSSEGatewayReferencesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.networksecurity.v1alpha1.SSEGatewayReference[] = [];
                stream.on('data', (response: protos.google.cloud.networksecurity.v1alpha1.SSEGatewayReference) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listSSEGatewayReferences.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listSseGatewayReferences, request));
            assert(
                (client.descriptors.page.listSSEGatewayReferences.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listSSEGatewayReferencesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listSSEGatewayReferences.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listSSEGatewayReferencesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.networksecurity.v1alpha1.SSEGatewayReference[] = [];
                stream.on('data', (response: protos.google.cloud.networksecurity.v1alpha1.SSEGatewayReference) => {
        ...
        it('uses async iteration with listSSEGatewayReferences without error', async () => {
            ...
            client.descriptors.page.listSSEGatewayReferences.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.networksecurity.v1alpha1.ISSEGatewayReference[] = [];
            const iterable = client.listSSEGatewayReferencesAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listSSEGatewayReferences.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listSSEGatewayReferences.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listSSEGatewayReferences with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listSSEGatewayReferences.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listSSEGatewayReferencesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.networksecurity.v1alpha1.ISSEGatewayReference[] = [];
                for await (const resource of iterable) {
