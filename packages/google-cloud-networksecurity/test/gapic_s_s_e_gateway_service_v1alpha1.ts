...
describe('v1alpha1.SSEGatewayServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          ssegatewayserviceModule.v1alpha1.SSEGatewayServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          ssegatewayserviceModule.v1alpha1.SSEGatewayServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'networksecurity.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        ssegatewayserviceModule.v1alpha1.SSEGatewayServiceClient.port;
      assert(port);
  ...
  describe('getPartnerSSEGateway', () => {
    it('invokes getPartnerSSEGateway without error', async () => {
      ...
      client.innerApiCalls.getPartnerSseGateway =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getPartnerSSEGateway(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getPartnerSseGateway as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getPartnerSSEGateway without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getPartnerSSEGateway(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1alpha1.IPartnerSSEGateway | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getPartnerSSEGateway with error', async () => {
      ...
      client.innerApiCalls.getPartnerSseGateway = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getSSEGatewayReference', () => {
    it('invokes getSSEGatewayReference without error', async () => {
      ...
      client.innerApiCalls.getSseGatewayReference =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getSSEGatewayReference(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getSseGatewayReference as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getSseGatewayReference as SinonStub
    ...
    it('invokes getSSEGatewayReference without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getSSEGatewayReference(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1alpha1.ISSEGatewayReference | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getSSEGatewayReference with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getSseGatewayReference = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getSSEGatewayReference(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getSseGatewayReference as SinonStub
  ...
  describe('createPartnerSSEGateway', () => {
    it('invokes createPartnerSSEGateway without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createPartnerSseGateway as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createPartnerSseGateway as SinonStub
    ...
    it('invokes createPartnerSSEGateway with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createPartnerSseGateway = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createPartnerSSEGateway(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createPartnerSseGateway as SinonStub
    ...
    it('invokes checkCreatePartnerSSEGatewayProgress without error', async () => {
      ...
      const decodedOperation =
        await client.checkCreatePartnerSSEGatewayProgress(
  ...
  describe('deletePartnerSSEGateway', () => {
    it('invokes deletePartnerSSEGateway without error', async () => {
      ...
      client.innerApiCalls.deletePartnerSseGateway =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deletePartnerSSEGateway(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deletePartnerSseGateway as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deletePartnerSseGateway as SinonStub
    ...
    it('invokes deletePartnerSSEGateway with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deletePartnerSseGateway = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deletePartnerSSEGateway(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deletePartnerSseGateway as SinonStub
    ...
    it('invokes checkDeletePartnerSSEGatewayProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkDeletePartnerSSEGatewayProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('updatePartnerSSEGateway', () => {
    it('invokes updatePartnerSSEGateway without error', async () => {
      ...
      client.innerApiCalls.updatePartnerSseGateway =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updatePartnerSSEGateway(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updatePartnerSseGateway as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updatePartnerSseGateway as SinonStub
    ...
    it('invokes updatePartnerSSEGateway with call error', async () => {
      ...
      const expectedHeaderRequestParams = `partner_sse_gateway.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updatePartnerSseGateway = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updatePartnerSSEGateway(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updatePartnerSseGateway as SinonStub
    ...
    it('invokes checkUpdatePartnerSSEGatewayProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkUpdatePartnerSSEGatewayProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkUpdatePartnerSSEGatewayProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdatePartnerSSEGatewayProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listPartnerSSEGateways', () => {
    it('invokes listPartnerSSEGateways without error', async () => {
      ...
      client.innerApiCalls.listPartnerSseGateways =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listPartnerSSEGateways(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listPartnerSseGateways as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listPartnerSseGateways as SinonStub
    ...
    it('invokes listPartnerSSEGateways with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listPartnerSseGateways = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listPartnerSSEGateways(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listPartnerSseGateways as SinonStub
    ...
    it('invokes listPartnerSSEGatewaysStream without error', async () => {
      ...
      client.descriptors.page.listPartnerSSEGateways.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1alpha1.PartnerSSEGateway,
          ) => {
      ...
      assert(
        (
          client.descriptors.page.listPartnerSSEGateways
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listPartnerSseGateways, request),
      );
      assert(
        (
          client.descriptors.page.listPartnerSSEGateways
    ...
    it('uses async iteration with listPartnerSSEGateways without error', async () => {
      ...
      client.descriptors.page.listPartnerSSEGateways.asyncIterate =
  ...
  describe('listSSEGatewayReferences', () => {
    it('invokes listSSEGatewayReferences without error', async () => {
      ...
      client.innerApiCalls.listSseGatewayReferences =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listSSEGatewayReferences(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listSseGatewayReferences as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listSseGatewayReferences as SinonStub
    ...
    it('invokes listSSEGatewayReferences with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listSseGatewayReferences = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listSSEGatewayReferences(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listSseGatewayReferences as SinonStub
    ...
    it('invokes listSSEGatewayReferencesStream without error', async () => {
      ...
      client.descriptors.page.listSSEGatewayReferences.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1alpha1.SSEGatewayReference,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (
          client.descriptors.page.listSSEGatewayReferences
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listSseGatewayReferences, request),
      );
      assert(
        (
          client.descriptors.page.listSSEGatewayReferences
    ...
    it('uses async iteration with listSSEGatewayReferences without error', async () => {
      ...
      client.descriptors.page.listSSEGatewayReferences.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
