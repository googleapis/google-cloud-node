...
describe('v1beta1.DnsThreatDetectorServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new dnsthreatdetectorserviceModule.v1beta1.DnsThreatDetectorServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          dnsthreatdetectorserviceModule.v1beta1.DnsThreatDetectorServiceClient
            .servicePath;
    ...
    it('invokes getDnsThreatDetector without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDnsThreatDetector(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1beta1.IDnsThreatDetector | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listDnsThreatDetectorsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1beta1.DnsThreatDetector,
          ) => {
