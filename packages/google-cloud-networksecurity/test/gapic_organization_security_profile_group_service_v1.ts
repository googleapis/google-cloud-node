...
describe('v1.OrganizationSecurityProfileGroupServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new organizationsecurityprofilegroupserviceModule.v1.OrganizationSecurityProfileGroupServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = organizationsecurityprofilegroupserviceModule.v1.OrganizationSecurityProfileGroupServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = organizationsecurityprofilegroupserviceModule.v1.OrganizationSecurityProfileGroupServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'networksecurity.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new organizationsecurityprofilegroupserviceModule.v1.OrganizationSecurityProfileGroupServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networksecurity.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new organizationsecurityprofilegroupserviceModule.v1.OrganizationSecurityProfileGroupServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networksecurity.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new organizationsecurityprofilegroupserviceModule.v1.OrganizationSecurityProfileGroupServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new organizationsecurityprofilegroupserviceModule.v1.OrganizationSecurityProfileGroupServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = organizationsecurityprofilegroupserviceModule.v1.OrganizationSecurityProfileGroupServiceClient.port;
            assert(port);
    ...
    describe('getSecurityProfileGroup', () => {
        it('invokes getSecurityProfileGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.GetSecurityProfileGroupRequest', ['name']);
        ...
        it('invokes getSecurityProfileGroup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getSecurityProfileGroup(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1.ISecurityProfileGroup|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getSecurityProfile', () => {
        it('invokes getSecurityProfile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.GetSecurityProfileRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getSecurityProfile without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getSecurityProfile(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1.ISecurityProfile|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createSecurityProfileGroup', () => {
        it('invokes createSecurityProfileGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.CreateSecurityProfileGroupRequest', ['parent']);
        ...
        it('invokes createSecurityProfileGroup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createSecurityProfileGroup(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networksecurity.v1.ISecurityProfileGroup, protos.google.cloud.networksecurity.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networksecurity.v1.ISecurityProfileGroup, protos.google.cloud.networksecurity.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createSecurityProfileGroup as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateSecurityProfileGroup', () => {
        it('invokes updateSecurityProfileGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.UpdateSecurityProfileGroupRequest', ['securityProfileGroup', 'name']);
    ...
    describe('deleteSecurityProfileGroup', () => {
        it('invokes deleteSecurityProfileGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.DeleteSecurityProfileGroupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createSecurityProfile', () => {
        it('invokes createSecurityProfile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.CreateSecurityProfileRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createSecurityProfile without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createSecurityProfile(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networksecurity.v1.ISecurityProfile, protos.google.cloud.networksecurity.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networksecurity.v1.ISecurityProfile, protos.google.cloud.networksecurity.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createSecurityProfile as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateSecurityProfile', () => {
        it('invokes updateSecurityProfile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.UpdateSecurityProfileRequest', ['securityProfile', 'name']);
    ...
    describe('deleteSecurityProfile', () => {
        it('invokes deleteSecurityProfile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.DeleteSecurityProfileRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listSecurityProfileGroups', () => {
        it('invokes listSecurityProfileGroups without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.ListSecurityProfileGroupsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.SecurityProfileGroup()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.SecurityProfileGroup()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.SecurityProfileGroup()),
            ];
        ...
        it('invokes listSecurityProfileGroupsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networksecurity.v1.SecurityProfileGroup) => {
    ...
    describe('listSecurityProfiles', () => {
        it('invokes listSecurityProfiles without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.ListSecurityProfilesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.SecurityProfile()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.SecurityProfile()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.SecurityProfile()),
            ];
        ...
        it('invokes listSecurityProfilesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networksecurity.v1.SecurityProfile) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
