...
describe('v1.DnsThreatDetectorServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = dnsthreatdetectorserviceModule.v1.DnsThreatDetectorServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = dnsthreatdetectorserviceModule.v1.DnsThreatDetectorServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'networksecurity.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new dnsthreatdetectorserviceModule.v1.DnsThreatDetectorServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networksecurity.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new dnsthreatdetectorserviceModule.v1.DnsThreatDetectorServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networksecurity.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new dnsthreatdetectorserviceModule.v1.DnsThreatDetectorServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new dnsthreatdetectorserviceModule.v1.DnsThreatDetectorServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = dnsthreatdetectorserviceModule.v1.DnsThreatDetectorServiceClient.port;
            assert(port);
    ...
    describe('getDnsThreatDetector', () => {
        it('invokes getDnsThreatDetector without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.GetDnsThreatDetectorRequest', ['name']);
        ...
        it('invokes getDnsThreatDetector without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getDnsThreatDetector(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networksecurity.v1.IDnsThreatDetector|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createDnsThreatDetector', () => {
        it('invokes createDnsThreatDetector without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.CreateDnsThreatDetectorRequest', ['parent']);
    ...
    describe('updateDnsThreatDetector', () => {
        it('invokes updateDnsThreatDetector without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.UpdateDnsThreatDetectorRequest', ['dnsThreatDetector', 'name']);
    ...
    describe('deleteDnsThreatDetector', () => {
        it('invokes deleteDnsThreatDetector without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.DeleteDnsThreatDetectorRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listDnsThreatDetectors', () => {
        it('invokes listDnsThreatDetectors without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networksecurity.v1.ListDnsThreatDetectorsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.DnsThreatDetector()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.DnsThreatDetector()),
              generateSampleMessage(new protos.google.cloud.networksecurity.v1.DnsThreatDetector()),
            ];
        ...
        it('invokes listDnsThreatDetectorsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networksecurity.v1.DnsThreatDetector) => {
