...
export class FirewallActivationClient {
  ...
  constructor(
    ...
    this.descriptors.page = {
      ...
      listProjectFirewallEndpoints: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'firewallEndpoints',
      ),
    ...
    const createProjectFirewallEndpointResponse = protoFilesRoot.lookup(
      '.google.cloud.networksecurity.v1.FirewallEndpoint',
    ) as gax.protobuf.Type;
    const createProjectFirewallEndpointMetadata = protoFilesRoot.lookup(
      '.google.cloud.networksecurity.v1.OperationMetadata',
    ) as gax.protobuf.Type;
    ...
    const deleteProjectFirewallEndpointResponse = protoFilesRoot.lookup(
      '.google.protobuf.Empty',
    ) as gax.protobuf.Type;
    const deleteProjectFirewallEndpointMetadata = protoFilesRoot.lookup(
      '.google.cloud.networksecurity.v1.OperationMetadata',
    ) as gax.protobuf.Type;
    ...
    const updateProjectFirewallEndpointResponse = protoFilesRoot.lookup(
      '.google.cloud.networksecurity.v1.FirewallEndpoint',
    ) as gax.protobuf.Type;
    const updateProjectFirewallEndpointMetadata = protoFilesRoot.lookup(
      '.google.cloud.networksecurity.v1.OperationMetadata',
    ) as gax.protobuf.Type;
    ...
    this.descriptors.longrunning = {
      ...
      createProjectFirewallEndpoint: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        createProjectFirewallEndpointResponse.decode.bind(
          createProjectFirewallEndpointResponse,
        ),
        createProjectFirewallEndpointMetadata.decode.bind(
          createProjectFirewallEndpointMetadata,
        ),
      ),
      ...
      deleteProjectFirewallEndpoint: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        deleteProjectFirewallEndpointResponse.decode.bind(
          deleteProjectFirewallEndpointResponse,
        ),
        deleteProjectFirewallEndpointMetadata.decode.bind(
          deleteProjectFirewallEndpointMetadata,
        ),
      ),
      ...
      updateProjectFirewallEndpoint: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        updateProjectFirewallEndpointResponse.decode.bind(
          updateProjectFirewallEndpointResponse,
        ),
        updateProjectFirewallEndpointMetadata.decode.bind(
          updateProjectFirewallEndpointMetadata,
        ),
      ),
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/firewall_activation.get_project_firewall_endpoint.js</caption>
   * region_tag:networksecurity_v1_generated_FirewallActivation_GetProjectFirewallEndpoint_async
   */
  getProjectFirewallEndpoint(
    request?: protos.google.cloud.networksecurity.v1.IGetFirewallEndpointRequest,
    options?: CallOptions,
  ...
  > | void {
    ...
    this._log.info('getProjectFirewallEndpoint request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.cloud.networksecurity.v1.IFirewallEndpoint,
          | protos.google.cloud.networksecurity.v1.IGetFirewallEndpointRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('getProjectFirewallEndpoint response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .getProjectFirewallEndpoint(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.cloud.networksecurity.v1.IFirewallEndpoint,
          (
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/firewall_activation.create_project_firewall_endpoint.js</caption>
   * region_tag:networksecurity_v1_generated_FirewallActivation_CreateProjectFirewallEndpoint_async
   */
  createProjectFirewallEndpoint(
    request?: protos.google.cloud.networksecurity.v1.ICreateFirewallEndpointRequest,
    options?: CallOptions,
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, rawResponse, _) => {
          this._log.info(
            'createProjectFirewallEndpoint response %j',
            rawResponse,
          );
          callback!(error, response, rawResponse, _); // We verified callback above.
        }
      : undefined;
    this._log.info('createProjectFirewallEndpoint request %j', request);
    return this.innerApiCalls
      .createProjectFirewallEndpoint(request, options, wrappedCallback)
      ?.then(
        ([response, rawResponse, _]: [
          LROperation<
            protos.google.cloud.networksecurity.v1.IFirewallEndpoint,
   ...
   * region_tag:networksecurity_v1_generated_FirewallActivation_CreateProjectFirewallEndpoint_async
   */
  async checkCreateProjectFirewallEndpointProgress(
    name: string,
  ): Promise<
    LROperation<
      protos.google.cloud.networksecurity.v1.FirewallEndpoint,
    ...
    >
  > {
    this._log.info('createProjectFirewallEndpoint long-running');
    const request =
      new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest(
        {name},
      );
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.createProjectFirewallEndpoint,
      this._gaxModule.createDefaultBackoffSettings(),
    );
    return decodeOperation as LROperation<
      protos.google.cloud.networksecurity.v1.FirewallEndpoint,
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/firewall_activation.delete_project_firewall_endpoint.js</caption>
   * region_tag:networksecurity_v1_generated_FirewallActivation_DeleteProjectFirewallEndpoint_async
   */
  deleteProjectFirewallEndpoint(
    request?: protos.google.cloud.networksecurity.v1.IDeleteFirewallEndpointRequest,
    options?: CallOptions,
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, rawResponse, _) => {
          this._log.info(
            'deleteProjectFirewallEndpoint response %j',
            rawResponse,
          );
          callback!(error, response, rawResponse, _); // We verified callback above.
        }
      : undefined;
    this._log.info('deleteProjectFirewallEndpoint request %j', request);
    return this.innerApiCalls
      .deleteProjectFirewallEndpoint(request, options, wrappedCallback)
      ?.then(
        ([response, rawResponse, _]: [
          LROperation<
            protos.google.protobuf.IEmpty,
   ...
   * region_tag:networksecurity_v1_generated_FirewallActivation_DeleteProjectFirewallEndpoint_async
   */
  async checkDeleteProjectFirewallEndpointProgress(
    name: string,
  ): Promise<
    LROperation<
      protos.google.protobuf.Empty,
    ...
    >
  > {
    this._log.info('deleteProjectFirewallEndpoint long-running');
    const request =
      new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest(
        {name},
      );
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.deleteProjectFirewallEndpoint,
      this._gaxModule.createDefaultBackoffSettings(),
    );
    return decodeOperation as LROperation<
      protos.google.protobuf.Empty,
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/firewall_activation.update_project_firewall_endpoint.js</caption>
   * region_tag:networksecurity_v1_generated_FirewallActivation_UpdateProjectFirewallEndpoint_async
   */
  updateProjectFirewallEndpoint(
    request?: protos.google.cloud.networksecurity.v1.IUpdateFirewallEndpointRequest,
    options?: CallOptions,
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, rawResponse, _) => {
          this._log.info(
            'updateProjectFirewallEndpoint response %j',
            rawResponse,
          );
          callback!(error, response, rawResponse, _); // We verified callback above.
        }
      : undefined;
    this._log.info('updateProjectFirewallEndpoint request %j', request);
    return this.innerApiCalls
      .updateProjectFirewallEndpoint(request, options, wrappedCallback)
      ?.then(
        ([response, rawResponse, _]: [
          LROperation<
            protos.google.cloud.networksecurity.v1.IFirewallEndpoint,
   ...
   * region_tag:networksecurity_v1_generated_FirewallActivation_UpdateProjectFirewallEndpoint_async
   */
  async checkUpdateProjectFirewallEndpointProgress(
    name: string,
  ): Promise<
    LROperation<
      protos.google.cloud.networksecurity.v1.FirewallEndpoint,
    ...
    >
  > {
    this._log.info('updateProjectFirewallEndpoint long-running');
    const request =
      new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest(
        {name},
      );
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.updateProjectFirewallEndpoint,
      this._gaxModule.createDefaultBackoffSettings(),
    );
    return decodeOperation as LROperation<
      protos.google.cloud.networksecurity.v1.FirewallEndpoint,
   ...
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   *   We recommend using `listProjectFirewallEndpointsAsync()`
   *   method described below for async iteration which you can stop as needed.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   */
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      | undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listProjectFirewallEndpoints values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listProjectFirewallEndpoints request %j', request);
    return this.innerApiCalls
      .listProjectFirewallEndpoints(request, options, wrappedCallback)
      ?.then(
        ([response, input, output]: [
          protos.google.cloud.networksecurity.v1.IFirewallEndpoint[],
          protos.google.cloud.networksecurity.v1.IListFirewallEndpointsRequest | null,
          ...
          this._log.info('listProjectFirewallEndpoints values %j', response);
          return [response, input, output];
        },
      );
  }
   ...
   *   for more details and examples.
   */
  listProjectFirewallEndpointsStream(
    request?: protos.google.cloud.networksecurity.v1.IListFirewallEndpointsRequest,
    options?: CallOptions,
  ): Transform {
    request = request || {};
    ...
    const defaultCallSettings = this._defaults['listProjectFirewallEndpoints'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {
      throw err;
    });
    this._log.info('listProjectFirewallEndpoints stream %j', request);
    return this.descriptors.page.listProjectFirewallEndpoints.createStream(
      this.innerApiCalls.listProjectFirewallEndpoints as GaxCall,
      request,
      callSettings,
    );
  }
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/firewall_activation.list_project_firewall_endpoints.js</caption>
   * region_tag:networksecurity_v1_generated_FirewallActivation_ListProjectFirewallEndpoints_async
   */
  listProjectFirewallEndpointsAsync(
    ...
    this._log.info('listProjectFirewallEndpoints iterate %j', request);
    return this.descriptors.page.listProjectFirewallEndpoints.asyncIterate(
      this.innerApiCalls['listProjectFirewallEndpoints'] as GaxCall,
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.cloud.networksecurity.v1.IFirewallEndpoint>;
