 ...
 * `src/v1/s_s_e_realm_service_client_config.json`.
...
export class SSERealmServiceClient {
   ...
   *   The first element of the array is an object representing {@link protos.google.cloud.networksecurity.v1.SACRealm|SACRealm}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/s_s_e_realm_service.get_s_a_c_realm.js</caption>
   * region_tag:networksecurity_v1_generated_SSERealmService_GetSACRealm_async
   */
  getSACRealm(
    request?: protos.google.cloud.networksecurity.v1.IGetSACRealmRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.networksecurity.v1.ISACRealm,
      protos.google.cloud.networksecurity.v1.IGetSACRealmRequest | undefined,
      {} | undefined,
    ]
  >;
  getSACRealm(
    ...
    callback: Callback<
      protos.google.cloud.networksecurity.v1.ISACRealm,
      | protos.google.cloud.networksecurity.v1.IGetSACRealmRequest
      | null
      | undefined,
      {} | null | undefined
    >,
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.cloud.networksecurity.v1.SACAttachment|SACAttachment}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/s_s_e_realm_service.get_s_a_c_attachment.js</caption>
   * region_tag:networksecurity_v1_generated_SSERealmService_GetSACAttachment_async
   */
  getSACAttachment(
    request?: protos.google.cloud.networksecurity.v1.IGetSACAttachmentRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.networksecurity.v1.ISACAttachment,
      (
        | protos.google.cloud.networksecurity.v1.IGetSACAttachmentRequest
        | undefined
      ),
      {} | undefined,
    ]
   ...
   * @param {google.cloud.networksecurity.v1.SACRealm} request.sacRealm
   ...
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/s_s_e_realm_service.create_s_a_c_realm.js</caption>
   * region_tag:networksecurity_v1_generated_SSERealmService_CreateSACRealm_async
   */
  createSACRealm(
    request?: protos.google.cloud.networksecurity.v1.ICreateSACRealmRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/s_s_e_realm_service.delete_s_a_c_realm.js</caption>
   * region_tag:networksecurity_v1_generated_SSERealmService_DeleteSACRealm_async
   */
  deleteSACRealm(
   ...
   *   following characters must be a dash, lowercase letter, or digit, except
   *   the last character, which cannot be a dash.
   * @param {google.cloud.networksecurity.v1.SACAttachment} request.sacAttachment
   *   Required. The resource being created.
   * @param {string} [request.requestId]
   *   Optional. An optional request ID to identify requests. Specify a unique
   *   request ID so that if you must retry your request, the server will know to
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/s_s_e_realm_service.create_s_a_c_attachment.js</caption>
   * region_tag:networksecurity_v1_generated_SSERealmService_CreateSACAttachment_async
   */
  createSACAttachment(
    request?: protos.google.cloud.networksecurity.v1.ICreateSACAttachmentRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<
  ...
  async checkCreateSACAttachmentProgress(
    ...
    LROperation<
      protos.google.cloud.networksecurity.v1.SACAttachment,
      protos.google.cloud.networksecurity.v1.OperationMetadata
    >
  > {
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/s_s_e_realm_service.delete_s_a_c_attachment.js</caption>
   * region_tag:networksecurity_v1_generated_SSERealmService_DeleteSACAttachment_async
   */
  deleteSACAttachment(
    request?: protos.google.cloud.networksecurity.v1.IDeleteSACAttachmentRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.cloud.networksecurity.v1.SACRealm|SACRealm}.
   ...
   */
  listSACRealms(
    request?: protos.google.cloud.networksecurity.v1.IListSACRealmsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.networksecurity.v1.ISACRealm[],
      protos.google.cloud.networksecurity.v1.IListSACRealmsRequest | null,
      protos.google.cloud.networksecurity.v1.IListSACRealmsResponse,
    ]
  >;
  listSACRealms(
    request: protos.google.cloud.networksecurity.v1.IListSACRealmsRequest,
    ...
    callback: PaginationCallback<
      protos.google.cloud.networksecurity.v1.IListSACRealmsRequest,
      | protos.google.cloud.networksecurity.v1.IListSACRealmsResponse
      | null
      | undefined,
      protos.google.cloud.networksecurity.v1.ISACRealm
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.cloud.networksecurity.v1.SACRealm|SACRealm} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
   ...
   *   {@link protos.google.cloud.networksecurity.v1.SACRealm|SACRealm}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/s_s_e_realm_service.list_s_a_c_realms.js</caption>
   * region_tag:networksecurity_v1_generated_SSERealmService_ListSACRealms_async
   */
  listSACRealmsAsync(
    request?: protos.google.cloud.networksecurity.v1.IListSACRealmsRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.cloud.networksecurity.v1.ISACRealm> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listSACRealms.asyncIterate(
      ...
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.cloud.networksecurity.v1.ISACRealm>;
  }
  /**
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.cloud.networksecurity.v1.SACAttachment|SACAttachment}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   ...
   */
  listSACAttachments(
    request?: protos.google.cloud.networksecurity.v1.IListSACAttachmentsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.networksecurity.v1.ISACAttachment[],
      protos.google.cloud.networksecurity.v1.IListSACAttachmentsRequest | null,
      protos.google.cloud.networksecurity.v1.IListSACAttachmentsResponse,
    ]
  >;
  listSACAttachments(
    request: protos.google.cloud.networksecurity.v1.IListSACAttachmentsRequest,
    options: CallOptions,
    callback: PaginationCallback<
      protos.google.cloud.networksecurity.v1.IListSACAttachmentsRequest,
      | protos.google.cloud.networksecurity.v1.IListSACAttachmentsResponse
      | null
      | undefined,
      protos.google.cloud.networksecurity.v1.ISACAttachment
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.cloud.networksecurity.v1.SACAttachment|SACAttachment} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed. Note that it can affect your quota.
   *   We recommend using `listSACAttachmentsAsync()`
   *   method described below for async iteration which you can stop as needed.
   ...
   *   An iterable Object that allows {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols | async iteration }.
   *   When you iterate the returned iterable, each element will be an object representing
   *   {@link protos.google.cloud.networksecurity.v1.SACAttachment|SACAttachment}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/s_s_e_realm_service.list_s_a_c_attachments.js</caption>
   * region_tag:networksecurity_v1_generated_SSERealmService_ListSACAttachments_async
   */
  listSACAttachmentsAsync(
    request?: protos.google.cloud.networksecurity.v1.IListSACAttachmentsRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.cloud.networksecurity.v1.ISACAttachment> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listSACAttachments.asyncIterate(
      ...
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.cloud.networksecurity.v1.ISACAttachment>;
  }
  /**
