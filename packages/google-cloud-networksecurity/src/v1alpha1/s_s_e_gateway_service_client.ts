 ...
 * `src/v1alpha1/s_s_e_gateway_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './s_s_e_gateway_service_client_config.json';
 ...
 * @memberof v1alpha1
 */
export class SSEGatewayServiceClient {
  ...
  initialize() {
    ...
    if (this.sSEGatewayServiceStub) {
      return this.sSEGatewayServiceStub;
    }
