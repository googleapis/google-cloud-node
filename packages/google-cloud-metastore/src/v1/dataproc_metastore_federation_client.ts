...
export class DataprocMetastoreFederationClient {
    ...
    this.dataprocMetastoreFederationStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ...
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.metastore.v1
   ...
   *   The first element of the array is an object representing {@link protos.google.cloud.metastore.v1.Federation|Federation}.
  ...
  getFederation(
    ...
    [
      ...
      protos.google.cloud.metastore.v1.IGetFederationRequest | undefined,
      {} | undefined,
    ]
  >;
  getFederation(
  ...
  getFederation(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.cloud.metastore.v1.IFederation,
          | protos.google.cloud.metastore.v1.IGetFederationRequest
          | null
          | undefined,
          {} | null | undefined
        >,
  ...
  async checkCreateFederationProgress(
    ...
    LROperation<
      protos.google.cloud.metastore.v1.Federation,
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.cloud.metastore.v1.Federation|Federation}.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.cloud.metastore.v1.Federation|Federation} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
   ...
   *   {@link protos.google.cloud.metastore.v1.Federation|Federation}. The API will be called under the hood as needed, once per the page,
