...
export {v1, v1beta, v1alpha, DataprocMetastoreClient, DataprocMetastoreFederationClient};
export default {v1, v1beta, v1alpha, DataprocMetastoreClient, DataprocMetastoreFederationClient};
