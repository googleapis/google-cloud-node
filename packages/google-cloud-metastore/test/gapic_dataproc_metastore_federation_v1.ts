...
describe('v1.DataprocMetastoreFederationClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new dataprocmetastorefederationModule.v1.DataprocMetastoreFederationClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          dataprocmetastorefederationModule.v1.DataprocMetastoreFederationClient
            .servicePath;
    ...
    it('invokes getFederation without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getFederation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.metastore.v1.IFederation | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listFederations', () => {
    ...
    it('invokes listFederationsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.metastore.v1.Federation) => {
