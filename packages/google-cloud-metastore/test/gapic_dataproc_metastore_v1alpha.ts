    ...
    it('invokes getService without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getService(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.metastore.v1alpha.IService | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getMetadataImport without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getMetadataImport(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.metastore.v1alpha.IMetadataImport | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getBackup without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getBackup(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.metastore.v1alpha.IBackup | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes removeIamPolicy without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.removeIamPolicy(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.metastore.v1alpha.IRemoveIamPolicyResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listServices', () => {
    ...
    it('invokes listServicesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.metastore.v1alpha.Service) => {
  ...
  describe('listMetadataImports', () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listMetadataImports(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.metastore.v1alpha.IMetadataImport[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listMetadataImportsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.metastore.v1alpha.MetadataImport) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listBackups', () => {
    ...
    it('invokes listBackupsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.metastore.v1alpha.Backup) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
