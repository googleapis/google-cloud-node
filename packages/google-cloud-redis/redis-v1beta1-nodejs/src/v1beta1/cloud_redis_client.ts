...
export class CloudRedisClient {
  ...
  initialize() {
    ...
    this.cloudRedisStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.redis.v1beta1.CloudRedis') :
 ...
 */
  getInstanceAuthString(
      ...
      Promise<[
        ...
        protos.google.cloud.redis.v1beta1.IGetInstanceAuthStringRequest|undefined, {}|undefined
      ]>;
  getInstanceAuthString(
      request: protos.google.cloud.redis.v1beta1.IGetInstanceAuthStringRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.redis.v1beta1.IInstanceAuthString,
          protos.google.cloud.redis.v1beta1.IGetInstanceAuthStringRequest|null|undefined,
          {}|null|undefined>): void;
  getInstanceAuthString(
      request: protos.google.cloud.redis.v1beta1.IGetInstanceAuthStringRequest,
      callback: Callback<
 ...
 * region_tag:redis_v1beta1_generated_CloudRedis_RescheduleMaintenance_async
 */
  async checkRescheduleMaintenanceProgress(name: string): Promise<LROperation<protos.google.cloud.redis.v1beta1.Instance, protos.google.protobuf.Any>>{
 ...
 */
  ...
  listInstances(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.redis.v1beta1.IListInstancesRequest,
      protos.google.cloud.redis.v1beta1.IListInstancesResponse|null|undefined,
      protos.google.cloud.redis.v1beta1.IInstance>|undefined = callback
