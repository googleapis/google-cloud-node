...
function main(parent) {
  ...
  async function callListCloudControlDeployments() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = cloudsecuritycomplianceClient.listCloudControlDeploymentsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListCloudControlDeployments();
