...
function main(query) {
  // [START developerknowledge_v1_generated_DeveloperKnowledge_AnswerQuery_async]
  /**
  ...
  async function callAnswerQuery() {
    ...
    // Run request
    const response = await knowledgeClient.answerQuery(request);
    console.log(response);
  }

  callAnswerQuery();
  // [END developerknowledge_v1_generated_DeveloperKnowledge_AnswerQuery_async]
}
