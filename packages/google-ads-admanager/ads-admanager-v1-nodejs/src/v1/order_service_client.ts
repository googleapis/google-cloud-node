 ...
 * `src/v1/order_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './order_service_client_config.json';
...
export class OrderServiceClient {
  ...
  orderServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of OrderServiceClient.
   *
 ...
 */
  listOrdersAsync(
    ...
    return this.descriptors.page.listOrders.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.ads.admanager.v1.IOrder>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.orderServiceStub && !this._terminated) {
      return this.orderServiceStub.then(stub => {
