 ...
 * `src/v1/private_auction_deal_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './private_auction_deal_service_client_config.json';
 ...
 * @memberof v1
 */
export class PrivateAuctionDealServiceClient {
  ...
  privateAuctionDealServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of PrivateAuctionDealServiceClient.
   *
   ...
   *     const client = new PrivateAuctionDealServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof PrivateAuctionDealServiceClient;
    ...
    this.descriptors.page = {
      listPrivateAuctionDeals:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'privateAuctionDeals')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.admanager.v1.PrivateAuctionDealService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.privateAuctionDealServiceStub) {
      return this.privateAuctionDealServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.PrivateAuctionDealService.
    this.privateAuctionDealServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.admanager.v1.PrivateAuctionDealService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.PrivateAuctionDealService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const privateAuctionDealServiceStubMethods =
        ['getPrivateAuctionDeal', 'listPrivateAuctionDeals', 'createPrivateAuctionDeal', 'updatePrivateAuctionDeal'];
    for (const methodName of privateAuctionDealServiceStubMethods) {
      const callPromise = this.privateAuctionDealServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.PrivateAuctionDeal|PrivateAuctionDeal}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/private_auction_deal_service.get_private_auction_deal.js</caption>
 * region_tag:admanager_v1_generated_PrivateAuctionDealService_GetPrivateAuctionDeal_async
 */
  getPrivateAuctionDeal(
      request?: protos.google.ads.admanager.v1.IGetPrivateAuctionDealRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IPrivateAuctionDeal,
        protos.google.ads.admanager.v1.IGetPrivateAuctionDealRequest|undefined, {}|undefined
      ]>;
  getPrivateAuctionDeal(
      request: protos.google.ads.admanager.v1.IGetPrivateAuctionDealRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IPrivateAuctionDeal,
          protos.google.ads.admanager.v1.IGetPrivateAuctionDealRequest|null|undefined,
          {}|null|undefined>): void;
  getPrivateAuctionDeal(
      request: protos.google.ads.admanager.v1.IGetPrivateAuctionDealRequest,
      callback: Callback<
  ...
  getPrivateAuctionDeal(
    ...
    this._log.info('getPrivateAuctionDeal request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IPrivateAuctionDeal,
        protos.google.ads.admanager.v1.IGetPrivateAuctionDealRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('getPrivateAuctionDeal response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.getPrivateAuctionDeal(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IPrivateAuctionDeal,
        protos.google.ads.admanager.v1.IGetPrivateAuctionDealRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getPrivateAuctionDeal response %j', response);
 ...
 * @param {google.ads.admanager.v1.PrivateAuctionDeal} request.privateAuctionDeal
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/private_auction_deal_service.create_private_auction_deal.js</caption>
 * region_tag:admanager_v1_generated_PrivateAuctionDealService_CreatePrivateAuctionDeal_async
 */
  createPrivateAuctionDeal(
      request?: protos.google.ads.admanager.v1.ICreatePrivateAuctionDealRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IPrivateAuctionDeal,
        protos.google.ads.admanager.v1.ICreatePrivateAuctionDealRequest|undefined, {}|undefined
      ]>;
  createPrivateAuctionDeal(
      request: protos.google.ads.admanager.v1.ICreatePrivateAuctionDealRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IPrivateAuctionDeal,
          protos.google.ads.admanager.v1.ICreatePrivateAuctionDealRequest|null|undefined,
          {}|null|undefined>): void;
  createPrivateAuctionDeal(
      request: protos.google.ads.admanager.v1.ICreatePrivateAuctionDealRequest,
      callback: Callback<
  ...
  createPrivateAuctionDeal(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('createPrivateAuctionDeal request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IPrivateAuctionDeal,
        protos.google.ads.admanager.v1.ICreatePrivateAuctionDealRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('createPrivateAuctionDeal response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.createPrivateAuctionDeal(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IPrivateAuctionDeal,
        protos.google.ads.admanager.v1.ICreatePrivateAuctionDealRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('createPrivateAuctionDeal response %j', response);
        return [response, options, rawResponse];
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/private_auction_deal_service.update_private_auction_deal.js</caption>
 * region_tag:admanager_v1_generated_PrivateAuctionDealService_UpdatePrivateAuctionDeal_async
 */
  updatePrivateAuctionDeal(
      request?: protos.google.ads.admanager.v1.IUpdatePrivateAuctionDealRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IPrivateAuctionDeal,
        protos.google.ads.admanager.v1.IUpdatePrivateAuctionDealRequest|undefined, {}|undefined
      ]>;
  updatePrivateAuctionDeal(
      request: protos.google.ads.admanager.v1.IUpdatePrivateAuctionDealRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IPrivateAuctionDeal,
          protos.google.ads.admanager.v1.IUpdatePrivateAuctionDealRequest|null|undefined,
          {}|null|undefined>): void;
  updatePrivateAuctionDeal(
      request: protos.google.ads.admanager.v1.IUpdatePrivateAuctionDealRequest,
      callback: Callback<
  ...
  updatePrivateAuctionDeal(
    ...
    options.otherArgs.headers[
      ...
      'private_auction_deal.name': request.privateAuctionDeal!.name ?? '',
    });
    this.initialize().catch(err => {throw err});
    this._log.info('updatePrivateAuctionDeal request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IPrivateAuctionDeal,
        protos.google.ads.admanager.v1.IUpdatePrivateAuctionDealRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('updatePrivateAuctionDeal response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.updatePrivateAuctionDeal(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IPrivateAuctionDeal,
        protos.google.ads.admanager.v1.IUpdatePrivateAuctionDealRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('updatePrivateAuctionDeal response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.PrivateAuctionDeal|PrivateAuctionDeal}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listPrivateAuctionDealsAsync()`
 *   method described below for async iteration which you can stop as needed.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 */
  listPrivateAuctionDeals(
      request?: protos.google.ads.admanager.v1.IListPrivateAuctionDealsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IPrivateAuctionDeal[],
        protos.google.ads.admanager.v1.IListPrivateAuctionDealsRequest|null,
        protos.google.ads.admanager.v1.IListPrivateAuctionDealsResponse
      ]>;
  listPrivateAuctionDeals(
      request: protos.google.ads.admanager.v1.IListPrivateAuctionDealsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListPrivateAuctionDealsRequest,
          protos.google.ads.admanager.v1.IListPrivateAuctionDealsResponse|null|undefined,
          protos.google.ads.admanager.v1.IPrivateAuctionDeal>): void;
  listPrivateAuctionDeals(
      request: protos.google.ads.admanager.v1.IListPrivateAuctionDealsRequest,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListPrivateAuctionDealsRequest,
  ...
  listPrivateAuctionDeals(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.ads.admanager.v1.IListPrivateAuctionDealsRequest,
      protos.google.ads.admanager.v1.IListPrivateAuctionDealsResponse|null|undefined,
      protos.google.ads.admanager.v1.IPrivateAuctionDeal>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listPrivateAuctionDeals values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listPrivateAuctionDeals request %j', request);
    return this.innerApiCalls
      .listPrivateAuctionDeals(request, options, wrappedCallback)
      ?.then(([response, input, output]: [
        protos.google.ads.admanager.v1.IPrivateAuctionDeal[],
        protos.google.ads.admanager.v1.IListPrivateAuctionDealsRequest|null,
        protos.google.ads.admanager.v1.IListPrivateAuctionDealsResponse
      ]) => {
        this._log.info('listPrivateAuctionDeals values %j', response);
        return [response, input, output];
      });
  }

/**
 * Equivalent to `listPrivateAuctionDeals`, but returns a NodeJS Stream object.
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 *   Required. The parent, which owns this collection of PrivateAuctionDeals.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.PrivateAuctionDeal|PrivateAuctionDeal} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 */
  listPrivateAuctionDealsStream(
    ...
    const defaultCallSettings = this._defaults['listPrivateAuctionDeals'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listPrivateAuctionDeals stream %j', request);
    return this.descriptors.page.listPrivateAuctionDeals.createStream(
      this.innerApiCalls.listPrivateAuctionDeals as GaxCall,
      request,
      callSettings
    );
  }
...
/**
 * Equivalent to `listPrivateAuctionDeals`, but returns an iterable object.
 *
 ...
 *   {@link protos.google.ads.admanager.v1.PrivateAuctionDeal|PrivateAuctionDeal}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/private_auction_deal_service.list_private_auction_deals.js</caption>
 * region_tag:admanager_v1_generated_PrivateAuctionDealService_ListPrivateAuctionDeals_async
 */
  listPrivateAuctionDealsAsync(
      request?: protos.google.ads.admanager.v1.IListPrivateAuctionDealsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.admanager.v1.IPrivateAuctionDeal>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listPrivateAuctionDeals iterate %j', request);
    return this.descriptors.page.listPrivateAuctionDeals.asyncIterate(
      this.innerApiCalls['listPrivateAuctionDeals'] as GaxCall,
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.ads.admanager.v1.IPrivateAuctionDeal>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.privateAuctionDealServiceStub && !this._terminated) {
      return this.privateAuctionDealServiceStub.then(stub => {
