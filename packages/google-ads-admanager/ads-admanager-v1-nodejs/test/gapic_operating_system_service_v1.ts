...
describe('v1.OperatingSystemServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new operatingsystemserviceModule.v1.OperatingSystemServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = operatingsystemserviceModule.v1.OperatingSystemServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = operatingsystemserviceModule.v1.OperatingSystemServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new operatingsystemserviceModule.v1.OperatingSystemServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new operatingsystemserviceModule.v1.OperatingSystemServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new operatingsystemserviceModule.v1.OperatingSystemServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new operatingsystemserviceModule.v1.OperatingSystemServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = operatingsystemserviceModule.v1.OperatingSystemServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.operatingSystemServiceStub, undefined);
    ...
    describe('getOperatingSystem', () => {
        it('invokes getOperatingSystem without error', async () => {
            const client = new operatingsystemserviceModule.v1.OperatingSystemServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.GetOperatingSystemRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetOperatingSystemRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.OperatingSystem()
            );
            client.innerApiCalls.getOperatingSystem = stubSimpleCall(expectedResponse);
            const [response] = await client.getOperatingSystem(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getOperatingSystem as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getOperatingSystem as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getOperatingSystem without error using callback', async () => {
            const client = new operatingsystemserviceModule.v1.OperatingSystemServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getOperatingSystem = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getOperatingSystem(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IOperatingSystem|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getOperatingSystem with error', async () => {
            const client = new operatingsystemserviceModule.v1.OperatingSystemServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getOperatingSystem = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes getOperatingSystem with closed client', async () => {
            const client = new operatingsystemserviceModule.v1.OperatingSystemServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('listOperatingSystems', () => {
        it('invokes listOperatingSystems without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.ListOperatingSystemsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListOperatingSystemsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.OperatingSystem()),
              generateSampleMessage(new protos.google.ads.admanager.v1.OperatingSystem()),
              generateSampleMessage(new protos.google.ads.admanager.v1.OperatingSystem()),
            ];
            client.innerApiCalls.listOperatingSystems = stubSimpleCall(expectedResponse);
            const [response] = await client.listOperatingSystems(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listOperatingSystems as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listOperatingSystems as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listOperatingSystems without error using callback', async () => {
            ...
            client.innerApiCalls.listOperatingSystems = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listOperatingSystems with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listOperatingSystems = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listOperatingSystems(request), expectedError);
            const actualRequest = (client.innerApiCalls.listOperatingSystems as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listOperatingSystems as SinonStub)
        ...
        it('invokes listOperatingSystemsStream without error', async () => {
            ...
            client.descriptors.page.listOperatingSystems.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listOperatingSystemsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.OperatingSystem[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.OperatingSystem) => {
            ...
            assert((client.descriptors.page.listOperatingSystems.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listOperatingSystems, request));
            assert(
        ...
        it('invokes listOperatingSystemsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listOperatingSystems.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listOperatingSystemsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.OperatingSystem[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.OperatingSystem) => {
        ...
        it('uses async iteration with listOperatingSystems without error', async () => {
            const client = new operatingsystemserviceModule.v1.OperatingSystemServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listOperatingSystems.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.admanager.v1.IOperatingSystem[] = [];
            const iterable = client.listOperatingSystemsAsync(request);
        ...
        it('uses async iteration with listOperatingSystems with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listOperatingSystems.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listOperatingSystemsAsync(request);
