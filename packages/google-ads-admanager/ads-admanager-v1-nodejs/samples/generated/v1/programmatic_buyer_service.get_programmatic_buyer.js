...
function main(name) {
  ...
  const {ProgrammaticBuyerServiceClient} = require('@google-ads/admanager').v1;

  // Instantiates a client
  const admanagerClient = new ProgrammaticBuyerServiceClient();

  async function callGetProgrammaticBuyer() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await admanagerClient.getProgrammaticBuyer(request);
    console.log(response);
  }

  callGetProgrammaticBuyer();
