...
describe('v1.RoleServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new roleserviceModule.v1.RoleServiceClient({
          universe_domain: 'example.com',
  ...
  describe('getRole', () => {
    it('invokes getRole without error', async () => {
      ...
      const actualRequest = (client.innerApiCalls.getRole as SinonStub).getCall(
        0
      ).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getRole as SinonStub
    ...
    it('invokes getRole without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getRole(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IRole | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listRoles', () => {
    it('invokes listRoles without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listRoles as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listRoles as SinonStub
    ...
    it('invokes listRoles without error using callback', async () => {
      ...
      client.innerApiCalls.listRoles =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listRoles(
          request,
    ...
    it('invokes listRolesStream without error', async () => {
      ...
      client.descriptors.page.listRoles.createStream =
      ...
      assert(
        (client.descriptors.page.listRoles.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listRoles, request)
      );
      assert(
        (client.descriptors.page.listRoles.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listRoles without error', async () => {
      ...
      client.descriptors.page.listRoles.asyncIterate =
      ...
      assert.deepStrictEqual(
        (client.descriptors.page.listRoles.asyncIterate as SinonStub).getCall(0)
          .args[1],
        request
      );
      assert(
