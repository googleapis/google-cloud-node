...
describe('v1.TargetingPresetServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          targetingpresetserviceModule.v1.TargetingPresetServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        targetingpresetserviceModule.v1.TargetingPresetServiceClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.targetingPresetServiceStub, undefined);
  ...
  describe('getTargetingPreset', () => {
    it('invokes getTargetingPreset without error', async () => {
      const client =
        new targetingpresetserviceModule.v1.TargetingPresetServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.GetTargetingPresetRequest(),
      );
      ...
      client.innerApiCalls.getTargetingPreset =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getTargetingPreset(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getTargetingPreset as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getTargetingPreset without error using callback', async () => {
      const client =
        new targetingpresetserviceModule.v1.TargetingPresetServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
    ...
    it('invokes getTargetingPreset with error', async () => {
      const client =
        new targetingpresetserviceModule.v1.TargetingPresetServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.getTargetingPreset = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes getTargetingPreset with closed client', async () => {
      const client =
        new targetingpresetserviceModule.v1.TargetingPresetServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('createTargetingPreset', () => {
    it('invokes createTargetingPreset without error', async () => {
      const client =
        new targetingpresetserviceModule.v1.TargetingPresetServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.CreateTargetingPresetRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.createTargetingPreset =
        stubSimpleCall(expectedResponse);
      const [response] = await client.createTargetingPreset(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createTargetingPreset as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createTargetingPreset as SinonStub
    ...
    it('invokes createTargetingPreset without error using callback', async () => {
      const client =
        new targetingpresetserviceModule.v1.TargetingPresetServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
    ...
    it('invokes createTargetingPreset with error', async () => {
      const client =
        new targetingpresetserviceModule.v1.TargetingPresetServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createTargetingPreset = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createTargetingPreset(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createTargetingPreset as SinonStub
    ...
    it('invokes createTargetingPreset with closed client', async () => {
      const client =
        new targetingpresetserviceModule.v1.TargetingPresetServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('batchCreateTargetingPresets', () => {
    it('invokes batchCreateTargetingPresets without error', async () => {
      const client =
        new targetingpresetserviceModule.v1.TargetingPresetServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchCreateTargetingPresetsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchCreateTargetingPresetsResponse(),
      );
      client.innerApiCalls.batchCreateTargetingPresets =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchCreateTargetingPresets(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchCreateTargetingPresets as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchCreateTargetingPresets as SinonStub
    ...
    it('invokes batchCreateTargetingPresets without error using callback', async () => {
      const client =
        new targetingpresetserviceModule.v1.TargetingPresetServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.batchCreateTargetingPresets =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchCreateTargetingPresets(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchCreateTargetingPresetsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchCreateTargetingPresets with error', async () => {
      const client =
        new targetingpresetserviceModule.v1.TargetingPresetServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchCreateTargetingPresets = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchCreateTargetingPresets(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchCreateTargetingPresets as SinonStub
    ...
    it('invokes batchCreateTargetingPresets with closed client', async () => {
      const client =
        new targetingpresetserviceModule.v1.TargetingPresetServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('batchDeactivateTargetingPresets', () => {
    it('invokes batchDeactivateTargetingPresets without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchDeactivateTargetingPresetsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchDeactivateTargetingPresetsResponse(),
      );
      client.innerApiCalls.batchDeactivateTargetingPresets =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchDeactivateTargetingPresets(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchDeactivateTargetingPresets as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchDeactivateTargetingPresets as SinonStub
    ...
    it('invokes batchDeactivateTargetingPresets without error using callback', async () => {
      const client =
        new targetingpresetserviceModule.v1.TargetingPresetServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.batchDeactivateTargetingPresets =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchDeactivateTargetingPresets(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchDeactivateTargetingPresetsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchDeactivateTargetingPresets with error', async () => {
      const client =
        new targetingpresetserviceModule.v1.TargetingPresetServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchDeactivateTargetingPresets = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchDeactivateTargetingPresets(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchDeactivateTargetingPresets as SinonStub
    ...
    it('invokes batchDeactivateTargetingPresets with closed client', async () => {
      const client =
        new targetingpresetserviceModule.v1.TargetingPresetServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('listTargetingPresets', () => {
    it('invokes listTargetingPresets without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.ListTargetingPresetsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.listTargetingPresets =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listTargetingPresets(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listTargetingPresets as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listTargetingPresets as SinonStub
    ...
    it('invokes listTargetingPresets with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listTargetingPresets = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.listTargetingPresets(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.listTargetingPresets as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes listTargetingPresetsStream without error', async () => {
      ...
      client.descriptors.page.listTargetingPresets.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listTargetingPresetsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.ads.admanager.v1.TargetingPreset[] = [];
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.TargetingPreset) => {
      ...
      assert(
        (client.descriptors.page.listTargetingPresets.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listTargetingPresets, request),
      );
      assert(
        (client.descriptors.page.listTargetingPresets.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listTargetingPresets without error', async () => {
      const client =
        new targetingpresetserviceModule.v1.TargetingPresetServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.descriptors.page.listTargetingPresets.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.ads.admanager.v1.ITargetingPreset[] = [];
      const iterable = client.listTargetingPresetsAsync(request);
