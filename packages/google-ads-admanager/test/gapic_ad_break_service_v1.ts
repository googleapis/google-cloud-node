...
describe('v1.AdBreakServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = adbreakserviceModule.v1.AdBreakServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = adbreakserviceModule.v1.AdBreakServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new adbreakserviceModule.v1.AdBreakServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new adbreakserviceModule.v1.AdBreakServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new adbreakserviceModule.v1.AdBreakServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new adbreakserviceModule.v1.AdBreakServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = adbreakserviceModule.v1.AdBreakServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.adBreakServiceStub, undefined);
    ...
    describe('getAdBreak', () => {
        it('invokes getAdBreak without error', async () => {
            const client = new adbreakserviceModule.v1.AdBreakServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.GetAdBreakRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetAdBreakRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.AdBreak()
            );
            client.innerApiCalls.getAdBreak = stubSimpleCall(expectedResponse);
            const [response] = await client.getAdBreak(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getAdBreak as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getAdBreak as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getAdBreak without error using callback', async () => {
            const client = new adbreakserviceModule.v1.AdBreakServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getAdBreak = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAdBreak(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IAdBreak|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAdBreak with error', async () => {
            const client = new adbreakserviceModule.v1.AdBreakServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getAdBreak = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes getAdBreak with closed client', async () => {
            const client = new adbreakserviceModule.v1.AdBreakServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('createAdBreak', () => {
        it('invokes createAdBreak without error', async () => {
            const client = new adbreakserviceModule.v1.AdBreakServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.CreateAdBreakRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.CreateAdBreakRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.AdBreak()
            );
            client.innerApiCalls.createAdBreak = stubSimpleCall(expectedResponse);
            const [response] = await client.createAdBreak(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createAdBreak as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createAdBreak as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes createAdBreak without error using callback', async () => {
            const client = new adbreakserviceModule.v1.AdBreakServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.createAdBreak = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createAdBreak with error', async () => {
            const client = new adbreakserviceModule.v1.AdBreakServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createAdBreak = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes createAdBreak with closed client', async () => {
            const client = new adbreakserviceModule.v1.AdBreakServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('updateAdBreak', () => {
        it('invokes updateAdBreak without error', async () => {
            const client = new adbreakserviceModule.v1.AdBreakServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.UpdateAdBreakRequest()
            );
            request.adBreak ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.UpdateAdBreakRequest', ['adBreak', 'name']);
            request.adBreak.name = defaultValue1;
            const expectedHeaderRequestParams = `ad_break.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.AdBreak()
            );
            client.innerApiCalls.updateAdBreak = stubSimpleCall(expectedResponse);
            const [response] = await client.updateAdBreak(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateAdBreak as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateAdBreak as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes updateAdBreak without error using callback', async () => {
            const client = new adbreakserviceModule.v1.AdBreakServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.updateAdBreak = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateAdBreak(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IAdBreak|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes updateAdBreak with error', async () => {
            const client = new adbreakserviceModule.v1.AdBreakServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `ad_break.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateAdBreak = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes updateAdBreak with closed client', async () => {
            const client = new adbreakserviceModule.v1.AdBreakServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('deleteAdBreak', () => {
        it('invokes deleteAdBreak without error', async () => {
            const client = new adbreakserviceModule.v1.AdBreakServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.DeleteAdBreakRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.DeleteAdBreakRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteAdBreak = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteAdBreak(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteAdBreak as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteAdBreak as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes deleteAdBreak without error using callback', async () => {
            const client = new adbreakserviceModule.v1.AdBreakServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.deleteAdBreak = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteAdBreak(
                    request,
        ...
        it('invokes deleteAdBreak with error', async () => {
            const client = new adbreakserviceModule.v1.AdBreakServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteAdBreak = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes deleteAdBreak with closed client', async () => {
            const client = new adbreakserviceModule.v1.AdBreakServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('listAdBreaks', () => {
        it('invokes listAdBreaks without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.ListAdBreaksRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListAdBreaksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.AdBreak()),
              generateSampleMessage(new protos.google.ads.admanager.v1.AdBreak()),
              generateSampleMessage(new protos.google.ads.admanager.v1.AdBreak()),
            ];
            client.innerApiCalls.listAdBreaks = stubSimpleCall(expectedResponse);
            const [response] = await client.listAdBreaks(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listAdBreaks as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAdBreaks as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listAdBreaks without error using callback', async () => {
            ...
            client.innerApiCalls.listAdBreaks = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listAdBreaks(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IAdBreak[]|null) => {
        ...
        it('invokes listAdBreaks with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listAdBreaks = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listAdBreaks(request), expectedError);
            const actualRequest = (client.innerApiCalls.listAdBreaks as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAdBreaks as SinonStub)
        ...
        it('invokes listAdBreaksStream without error', async () => {
            ...
            client.descriptors.page.listAdBreaks.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listAdBreaksStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.AdBreak[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.AdBreak) => {
            ...
            assert((client.descriptors.page.listAdBreaks.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listAdBreaks, request));
            assert(
        ...
        it('invokes listAdBreaksStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAdBreaks.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listAdBreaksStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.AdBreak[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.AdBreak) => {
        ...
        it('uses async iteration with listAdBreaks without error', async () => {
            const client = new adbreakserviceModule.v1.AdBreakServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listAdBreaks.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.admanager.v1.IAdBreak[] = [];
            const iterable = client.listAdBreaksAsync(request);
        ...
        it('uses async iteration with listAdBreaks with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAdBreaks.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listAdBreaksAsync(request);
