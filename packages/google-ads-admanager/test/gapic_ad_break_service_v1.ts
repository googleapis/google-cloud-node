...
describe('v1.AdBreakServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          adbreakserviceModule.v1.AdBreakServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          adbreakserviceModule.v1.AdBreakServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new adbreakserviceModule.v1.AdBreakServiceClient({
          universe_domain: 'example.com',
  ...
  describe('getAdBreak', () => {
    it('invokes getAdBreak without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.GetAdBreakRequest',
        ['name'],
      );
      ...
      const actualRequest = (
        client.innerApiCalls.getAdBreak as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getAdBreak without error using callback', async () => {
      ...
      client.innerApiCalls.getAdBreak =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getAdBreak(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IAdBreak | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getAdBreak with error', async () => {
      ...
      client.innerApiCalls.getAdBreak = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createAdBreak', () => {
    it('invokes createAdBreak without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createAdBreak as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createAdBreak as SinonStub
    ...
    it('invokes createAdBreak without error using callback', async () => {
      ...
      client.innerApiCalls.createAdBreak =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes createAdBreak with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createAdBreak = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateAdBreak', () => {
    it('invokes updateAdBreak without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateAdBreak as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateAdBreak as SinonStub
    ...
    it('invokes updateAdBreak without error using callback', async () => {
      ...
      client.innerApiCalls.updateAdBreak =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes updateAdBreak with error', async () => {
      ...
      const expectedHeaderRequestParams = `ad_break.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateAdBreak = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteAdBreak', () => {
    it('invokes deleteAdBreak without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.DeleteAdBreakRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteAdBreak as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteAdBreak as SinonStub
    ...
    it('invokes deleteAdBreak without error using callback', async () => {
      ...
      client.innerApiCalls.deleteAdBreak =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes deleteAdBreak with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteAdBreak = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listAdBreaks', () => {
    it('invokes listAdBreaks without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listAdBreaks as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listAdBreaks as SinonStub
    ...
    it('invokes listAdBreaks without error using callback', async () => {
      ...
      client.innerApiCalls.listAdBreaks =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listAdBreaks(
          request,
    ...
    it('invokes listAdBreaks with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listAdBreaks = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listAdBreaksStream without error', async () => {
      ...
      client.descriptors.page.listAdBreaks.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.AdBreak) => {
      ...
      assert(
        (client.descriptors.page.listAdBreaks.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listAdBreaks, request),
      );
      assert(
        (client.descriptors.page.listAdBreaks.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listAdBreaksStream with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listAdBreaks.createStream = stubPageStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.listAdBreaksStream(request);
    ...
    it('uses async iteration with listAdBreaks without error', async () => {
      ...
      client.descriptors.page.listAdBreaks.asyncIterate =
