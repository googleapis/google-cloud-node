...
describe('v1.ThirdPartyCompanyServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          thirdpartycompanyserviceModule.v1.ThirdPartyCompanyServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        thirdpartycompanyserviceModule.v1.ThirdPartyCompanyServiceClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.thirdPartyCompanyServiceStub, undefined);
  ...
  describe('getThirdPartyCompany', () => {
    it('invokes getThirdPartyCompany without error', async () => {
      const client =
        new thirdpartycompanyserviceModule.v1.ThirdPartyCompanyServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.GetThirdPartyCompanyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.GetThirdPartyCompanyRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.ThirdPartyCompany(),
      );
      client.innerApiCalls.getThirdPartyCompany =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getThirdPartyCompany(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getThirdPartyCompany as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getThirdPartyCompany without error using callback', async () => {
      const client =
        new thirdpartycompanyserviceModule.v1.ThirdPartyCompanyServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const promise = new Promise((resolve, reject) => {
        client.getThirdPartyCompany(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IThirdPartyCompany | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getThirdPartyCompany with error', async () => {
      const client =
        new thirdpartycompanyserviceModule.v1.ThirdPartyCompanyServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.getThirdPartyCompany = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes getThirdPartyCompany with closed client', async () => {
      const client =
        new thirdpartycompanyserviceModule.v1.ThirdPartyCompanyServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('listThirdPartyCompanies', () => {
    it('invokes listThirdPartyCompanies without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.ListThirdPartyCompaniesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.ListThirdPartyCompaniesRequest',
        ['parent'],
      );
      ...
      client.innerApiCalls.listThirdPartyCompanies =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listThirdPartyCompanies(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listThirdPartyCompanies as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listThirdPartyCompanies as SinonStub
    ...
    it('invokes listThirdPartyCompanies without error using callback', async () => {
      ...
      client.innerApiCalls.listThirdPartyCompanies =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listThirdPartyCompanies(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IThirdPartyCompany[] | null,
    ...
    it('invokes listThirdPartyCompanies with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listThirdPartyCompanies = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listThirdPartyCompanies(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listThirdPartyCompanies as SinonStub
    ...
    it('invokes listThirdPartyCompaniesStream without error', async () => {
      ...
      client.descriptors.page.listThirdPartyCompanies.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listThirdPartyCompaniesStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.ads.admanager.v1.ThirdPartyCompany[] =
          [];
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.ThirdPartyCompany) => {
      ...
      assert(
        (
          client.descriptors.page.listThirdPartyCompanies
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listThirdPartyCompanies, request),
      );
      assert(
        (
          client.descriptors.page.listThirdPartyCompanies
    ...
    it('uses async iteration with listThirdPartyCompanies without error', async () => {
      const client =
        new thirdpartycompanyserviceModule.v1.ThirdPartyCompanyServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.descriptors.page.listThirdPartyCompanies.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.ads.admanager.v1.IThirdPartyCompany[] = [];
      const iterable = client.listThirdPartyCompaniesAsync(request);
