...
describe('v1.CustomFieldServiceClient', () => {
  ...
  describe('createCustomField', () => {
    it('invokes createCustomField without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createCustomField as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createCustomField as SinonStub
    ...
    it('invokes createCustomField without error using callback', async () => {
      ...
      client.innerApiCalls.createCustomField =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes createCustomField with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createCustomField = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('batchCreateCustomFields', () => {
    it('invokes batchCreateCustomFields without error', async () => {
      ...
      client.innerApiCalls.batchCreateCustomFields =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchCreateCustomFields(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchCreateCustomFields as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchCreateCustomFields as SinonStub
    ...
    it('invokes batchCreateCustomFields without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchCreateCustomFields(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchCreateCustomFieldsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchCreateCustomFields with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchCreateCustomFields = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchCreateCustomFields(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchCreateCustomFields as SinonStub
  ...
  describe('updateCustomField', () => {
    it('invokes updateCustomField without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateCustomField as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateCustomField as SinonStub
    ...
    it('invokes updateCustomField without error using callback', async () => {
      ...
      client.innerApiCalls.updateCustomField =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes updateCustomField with error', async () => {
      ...
      const expectedHeaderRequestParams = `custom_field.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateCustomField = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('batchUpdateCustomFields', () => {
    it('invokes batchUpdateCustomFields without error', async () => {
      ...
      client.innerApiCalls.batchUpdateCustomFields =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchUpdateCustomFields(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchUpdateCustomFields as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchUpdateCustomFields as SinonStub
    ...
    it('invokes batchUpdateCustomFields without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchUpdateCustomFields(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchUpdateCustomFieldsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchUpdateCustomFields with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchUpdateCustomFields = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
  ...
  describe('batchActivateCustomFields', () => {
    it('invokes batchActivateCustomFields without error', async () => {
      ...
      client.innerApiCalls.batchActivateCustomFields =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchActivateCustomFields(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchActivateCustomFields as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchActivateCustomFields as SinonStub
    ...
    it('invokes batchActivateCustomFields without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchActivateCustomFields(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchActivateCustomFieldsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchActivateCustomFields with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchActivateCustomFields = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchActivateCustomFields(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchActivateCustomFields as SinonStub
  ...
  describe('batchDeactivateCustomFields', () => {
    it('invokes batchDeactivateCustomFields without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchDeactivateCustomFields as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchDeactivateCustomFields as SinonStub
    ...
    it('invokes batchDeactivateCustomFields without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchDeactivateCustomFields(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchDeactivateCustomFieldsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchDeactivateCustomFields with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchDeactivateCustomFields = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchDeactivateCustomFields(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchDeactivateCustomFields as SinonStub
