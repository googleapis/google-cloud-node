...
describe('v1.ContentBundleServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          contentbundleserviceModule.v1.ContentBundleServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          contentbundleserviceModule.v1.ContentBundleServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        contentbundleserviceModule.v1.ContentBundleServiceClient.port;
      assert(port);
  ...
  describe('getContentBundle', () => {
    it('invokes getContentBundle without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getContentBundle as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getContentBundle without error using callback', async () => {
      ...
      client.innerApiCalls.getContentBundle =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getContentBundle(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IContentBundle | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getContentBundle with error', async () => {
      ...
      client.innerApiCalls.getContentBundle = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listContentBundles', () => {
    it('invokes listContentBundles without error', async () => {
      ...
      client.innerApiCalls.listContentBundles =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listContentBundles(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listContentBundles as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listContentBundles as SinonStub
    ...
    it('invokes listContentBundles with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listContentBundles = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listContentBundlesStream without error', async () => {
      ...
      client.descriptors.page.listContentBundles.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.ContentBundle) => {
      ...
      assert(
        (client.descriptors.page.listContentBundles.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listContentBundles, request),
      );
      assert(
        (client.descriptors.page.listContentBundles.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listContentBundles without error', async () => {
      ...
      client.descriptors.page.listContentBundles.asyncIterate =
