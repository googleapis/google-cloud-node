...
import * as linkeddeviceserviceModule from '../src';
...
describe('v1.LinkedDeviceServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new linkeddeviceserviceModule.v1.LinkedDeviceServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = linkeddeviceserviceModule.v1.LinkedDeviceServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = linkeddeviceserviceModule.v1.LinkedDeviceServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new linkeddeviceserviceModule.v1.LinkedDeviceServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new linkeddeviceserviceModule.v1.LinkedDeviceServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new linkeddeviceserviceModule.v1.LinkedDeviceServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new linkeddeviceserviceModule.v1.LinkedDeviceServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = linkeddeviceserviceModule.v1.LinkedDeviceServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.linkedDeviceServiceStub, undefined);
            await client.initialize();
            assert(client.linkedDeviceServiceStub);
        });
    ...
    describe('getLinkedDevice', () => {
        it('invokes getLinkedDevice without error', async () => {
            const client = new linkeddeviceserviceModule.v1.LinkedDeviceServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.GetLinkedDeviceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetLinkedDeviceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.LinkedDevice()
            );
            client.innerApiCalls.getLinkedDevice = stubSimpleCall(expectedResponse);
            const [response] = await client.getLinkedDevice(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getLinkedDevice as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getLinkedDevice as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getLinkedDevice without error using callback', async () => {
            const client = new linkeddeviceserviceModule.v1.LinkedDeviceServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getLinkedDevice = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getLinkedDevice(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.ILinkedDevice|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getLinkedDevice with error', async () => {
            const client = new linkeddeviceserviceModule.v1.LinkedDeviceServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getLinkedDevice = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getLinkedDevice(request), expectedError);
            const actualRequest = (client.innerApiCalls.getLinkedDevice as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getLinkedDevice as SinonStub)
        ...
        it('invokes getLinkedDevice with closed client', async () => {
            const client = new linkeddeviceserviceModule.v1.LinkedDeviceServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('listLinkedDevices', () => {
        it('invokes listLinkedDevices without error', async () => {
            const client = new linkeddeviceserviceModule.v1.LinkedDeviceServiceClient({
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.ListLinkedDevicesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListLinkedDevicesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.LinkedDevice()),
              generateSampleMessage(new protos.google.ads.admanager.v1.LinkedDevice()),
              generateSampleMessage(new protos.google.ads.admanager.v1.LinkedDevice()),
            ];
            client.innerApiCalls.listLinkedDevices = stubSimpleCall(expectedResponse);
            const [response] = await client.listLinkedDevices(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listLinkedDevices as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listLinkedDevices as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes listLinkedDevices without error using callback', async () => {
            const client = new linkeddeviceserviceModule.v1.LinkedDeviceServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listLinkedDevices = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listLinkedDevices(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.ILinkedDevice[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listLinkedDevices with error', async () => {
            const client = new linkeddeviceserviceModule.v1.LinkedDeviceServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listLinkedDevices = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listLinkedDevices(request), expectedError);
            const actualRequest = (client.innerApiCalls.listLinkedDevices as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listLinkedDevices as SinonStub)
        ...
        it('invokes listLinkedDevicesStream without error', async () => {
            const client = new linkeddeviceserviceModule.v1.LinkedDeviceServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listLinkedDevices.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listLinkedDevicesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.LinkedDevice[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.LinkedDevice) => {
            ...
            assert((client.descriptors.page.listLinkedDevices.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listLinkedDevices, request));
            assert(
                (client.descriptors.page.listLinkedDevices.createStream as SinonStub)
        ...
        it('invokes listLinkedDevicesStream with error', async () => {
            const client = new linkeddeviceserviceModule.v1.LinkedDeviceServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listLinkedDevices.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listLinkedDevicesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.LinkedDevice[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.LinkedDevice) => {
        ...
        it('uses async iteration with listLinkedDevices without error', async () => {
            const client = new linkeddeviceserviceModule.v1.LinkedDeviceServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listLinkedDevices.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.admanager.v1.ILinkedDevice[] = [];
            const iterable = client.listLinkedDevicesAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listLinkedDevices.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listLinkedDevices with error', async () => {
            const client = new linkeddeviceserviceModule.v1.LinkedDeviceServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listLinkedDevices.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listLinkedDevicesAsync(request);
