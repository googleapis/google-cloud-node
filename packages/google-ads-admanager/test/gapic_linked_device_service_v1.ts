...
describe('v1.LinkedDeviceServiceClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new linkeddeviceserviceModule.v1.LinkedDeviceServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          linkeddeviceserviceModule.v1.LinkedDeviceServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          linkeddeviceserviceModule.v1.LinkedDeviceServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
  ...
  describe('getLinkedDevice', () => {
    it('invokes getLinkedDevice without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.GetLinkedDeviceRequest',
        ['name'],
      );
      ...
      const actualRequest = (
        client.innerApiCalls.getLinkedDevice as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getLinkedDevice without error using callback', async () => {
      ...
      client.innerApiCalls.getLinkedDevice =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getLinkedDevice(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.ILinkedDevice | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getLinkedDevice with error', async () => {
      ...
      client.innerApiCalls.getLinkedDevice = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listLinkedDevices', () => {
    it('invokes listLinkedDevices without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.ListLinkedDevicesRequest',
        ['parent'],
      );
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listLinkedDevices as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listLinkedDevices as SinonStub
    ...
    it('invokes listLinkedDevices without error using callback', async () => {
      ...
      client.innerApiCalls.listLinkedDevices =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listLinkedDevices with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listLinkedDevices = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listLinkedDevicesStream without error', async () => {
      ...
      client.descriptors.page.listLinkedDevices.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.LinkedDevice) => {
      ...
      assert(
        (client.descriptors.page.listLinkedDevices.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listLinkedDevices, request),
      );
      assert(
        (client.descriptors.page.listLinkedDevices.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listLinkedDevices without error', async () => {
      ...
      client.descriptors.page.listLinkedDevices.asyncIterate =
