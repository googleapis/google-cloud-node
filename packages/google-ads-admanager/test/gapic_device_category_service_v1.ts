...
import * as devicecategoryserviceModule from '../src';
...
describe('v1.DeviceCategoryServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = devicecategoryserviceModule.v1.DeviceCategoryServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = devicecategoryserviceModule.v1.DeviceCategoryServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new devicecategoryserviceModule.v1.DeviceCategoryServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new devicecategoryserviceModule.v1.DeviceCategoryServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new devicecategoryserviceModule.v1.DeviceCategoryServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new devicecategoryserviceModule.v1.DeviceCategoryServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = devicecategoryserviceModule.v1.DeviceCategoryServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.deviceCategoryServiceStub, undefined);
            await client.initialize();
            assert(client.deviceCategoryServiceStub);
        });
    ...
    describe('getDeviceCategory', () => {
        it('invokes getDeviceCategory without error', async () => {
            const client = new devicecategoryserviceModule.v1.DeviceCategoryServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.GetDeviceCategoryRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetDeviceCategoryRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.DeviceCategory()
            );
            client.innerApiCalls.getDeviceCategory = stubSimpleCall(expectedResponse);
            const [response] = await client.getDeviceCategory(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getDeviceCategory as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDeviceCategory as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getDeviceCategory without error using callback', async () => {
            const client = new devicecategoryserviceModule.v1.DeviceCategoryServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getDeviceCategory = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getDeviceCategory(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IDeviceCategory|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getDeviceCategory with error', async () => {
            const client = new devicecategoryserviceModule.v1.DeviceCategoryServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getDeviceCategory = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getDeviceCategory(request), expectedError);
            const actualRequest = (client.innerApiCalls.getDeviceCategory as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDeviceCategory as SinonStub)
        ...
        it('invokes getDeviceCategory with closed client', async () => {
            const client = new devicecategoryserviceModule.v1.DeviceCategoryServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('listDeviceCategories', () => {
        it('invokes listDeviceCategories without error', async () => {
            const client = new devicecategoryserviceModule.v1.DeviceCategoryServiceClient({
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.ListDeviceCategoriesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListDeviceCategoriesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.DeviceCategory()),
              generateSampleMessage(new protos.google.ads.admanager.v1.DeviceCategory()),
              generateSampleMessage(new protos.google.ads.admanager.v1.DeviceCategory()),
            ];
            client.innerApiCalls.listDeviceCategories = stubSimpleCall(expectedResponse);
            const [response] = await client.listDeviceCategories(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listDeviceCategories as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listDeviceCategories as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes listDeviceCategories without error using callback', async () => {
            const client = new devicecategoryserviceModule.v1.DeviceCategoryServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listDeviceCategories = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listDeviceCategories(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IDeviceCategory[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listDeviceCategories with error', async () => {
            const client = new devicecategoryserviceModule.v1.DeviceCategoryServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listDeviceCategories = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listDeviceCategories(request), expectedError);
            const actualRequest = (client.innerApiCalls.listDeviceCategories as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listDeviceCategories as SinonStub)
        ...
        it('invokes listDeviceCategoriesStream without error', async () => {
            const client = new devicecategoryserviceModule.v1.DeviceCategoryServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listDeviceCategories.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listDeviceCategoriesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.DeviceCategory[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.DeviceCategory) => {
            ...
            assert((client.descriptors.page.listDeviceCategories.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listDeviceCategories, request));
            assert(
        ...
        it('invokes listDeviceCategoriesStream with error', async () => {
            const client = new devicecategoryserviceModule.v1.DeviceCategoryServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDeviceCategories.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listDeviceCategoriesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.DeviceCategory[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.DeviceCategory) => {
        ...
        it('uses async iteration with listDeviceCategories without error', async () => {
            const client = new devicecategoryserviceModule.v1.DeviceCategoryServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listDeviceCategories.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.admanager.v1.IDeviceCategory[] = [];
            const iterable = client.listDeviceCategoriesAsync(request);
        ...
        it('uses async iteration with listDeviceCategories with error', async () => {
            const client = new devicecategoryserviceModule.v1.DeviceCategoryServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDeviceCategories.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listDeviceCategoriesAsync(request);
