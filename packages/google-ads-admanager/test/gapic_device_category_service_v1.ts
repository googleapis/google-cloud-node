...
describe('v1.DeviceCategoryServiceClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new devicecategoryserviceModule.v1.DeviceCategoryServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          devicecategoryserviceModule.v1.DeviceCategoryServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        devicecategoryserviceModule.v1.DeviceCategoryServiceClient.port;
      assert(port);
  ...
  describe('getDeviceCategory', () => {
    it('invokes getDeviceCategory without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getDeviceCategory as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getDeviceCategory without error using callback', async () => {
      ...
      client.innerApiCalls.getDeviceCategory =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDeviceCategory(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IDeviceCategory | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getDeviceCategory with error', async () => {
      ...
      client.innerApiCalls.getDeviceCategory = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listDeviceCategories', () => {
    it('invokes listDeviceCategories without error', async () => {
      ...
      client.innerApiCalls.listDeviceCategories =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listDeviceCategories(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listDeviceCategories as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listDeviceCategories as SinonStub
    ...
    it('invokes listDeviceCategories with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listDeviceCategories = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listDeviceCategoriesStream without error', async () => {
      ...
      client.descriptors.page.listDeviceCategories.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.DeviceCategory) => {
      ...
      assert(
        (client.descriptors.page.listDeviceCategories.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listDeviceCategories, request),
      );
      assert(
        (client.descriptors.page.listDeviceCategories.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listDeviceCategories without error', async () => {
      ...
      client.descriptors.page.listDeviceCategories.asyncIterate =
