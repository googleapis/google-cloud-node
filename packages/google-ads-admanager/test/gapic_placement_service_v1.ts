...
describe('v1.PlacementServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          placementserviceModule.v1.PlacementServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          placementserviceModule.v1.PlacementServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new placementserviceModule.v1.PlacementServiceClient({
          universe_domain: 'example.com',
  ...
  describe('getPlacement', () => {
    it('invokes getPlacement without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getPlacement as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getPlacement without error using callback', async () => {
      ...
      client.innerApiCalls.getPlacement =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getPlacement(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IPlacement | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createPlacement', () => {
    it('invokes createPlacement without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createPlacement as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createPlacement as SinonStub
    ...
    it('invokes createPlacement without error using callback', async () => {
      ...
      client.innerApiCalls.createPlacement =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes createPlacement with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createPlacement = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updatePlacement', () => {
    it('invokes updatePlacement without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updatePlacement as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updatePlacement as SinonStub
    ...
    it('invokes updatePlacement without error using callback', async () => {
      ...
      client.innerApiCalls.updatePlacement =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes updatePlacement with error', async () => {
      ...
      const expectedHeaderRequestParams = `placement.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updatePlacement = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('batchCreatePlacements', () => {
    it('invokes batchCreatePlacements without error', async () => {
      ...
      client.innerApiCalls.batchCreatePlacements =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchCreatePlacements(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchCreatePlacements as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchCreatePlacements as SinonStub
    ...
    it('invokes batchCreatePlacements without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchCreatePlacements(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchCreatePlacementsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchCreatePlacements with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchCreatePlacements = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchCreatePlacements(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchCreatePlacements as SinonStub
  ...
  describe('batchUpdatePlacements', () => {
    it('invokes batchUpdatePlacements without error', async () => {
      ...
      client.innerApiCalls.batchUpdatePlacements =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchUpdatePlacements(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchUpdatePlacements as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchUpdatePlacements as SinonStub
    ...
    it('invokes batchUpdatePlacements without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchUpdatePlacements(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchUpdatePlacementsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchUpdatePlacements with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchUpdatePlacements = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchUpdatePlacements(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchUpdatePlacements as SinonStub
  ...
  describe('batchActivatePlacements', () => {
    it('invokes batchActivatePlacements without error', async () => {
      ...
      client.innerApiCalls.batchActivatePlacements =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchActivatePlacements(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchActivatePlacements as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchActivatePlacements as SinonStub
    ...
    it('invokes batchActivatePlacements without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchActivatePlacements(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchActivatePlacementsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchActivatePlacements with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchActivatePlacements = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchActivatePlacements(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchActivatePlacements as SinonStub
  ...
  describe('batchDeactivatePlacements', () => {
    it('invokes batchDeactivatePlacements without error', async () => {
      ...
      client.innerApiCalls.batchDeactivatePlacements =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchDeactivatePlacements(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchDeactivatePlacements as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchDeactivatePlacements as SinonStub
    ...
    it('invokes batchDeactivatePlacements without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchDeactivatePlacements(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchDeactivatePlacementsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchDeactivatePlacements with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchDeactivatePlacements = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchDeactivatePlacements(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchDeactivatePlacements as SinonStub
  ...
  describe('batchArchivePlacements', () => {
    it('invokes batchArchivePlacements without error', async () => {
      ...
      client.innerApiCalls.batchArchivePlacements =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchArchivePlacements(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchArchivePlacements as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchArchivePlacements as SinonStub
    ...
    it('invokes batchArchivePlacements without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchArchivePlacements(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchArchivePlacementsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchArchivePlacements with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchArchivePlacements = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchArchivePlacements(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchArchivePlacements as SinonStub
  ...
  describe('listPlacements', () => {
    it('invokes listPlacements without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listPlacements as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listPlacements as SinonStub
    ...
    it('invokes listPlacements without error using callback', async () => {
      ...
      client.innerApiCalls.listPlacements =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listPlacementsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.Placement) => {
      ...
      assert(
        (client.descriptors.page.listPlacements.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listPlacements, request),
      );
      assert(
        (client.descriptors.page.listPlacements.createStream as SinonStub)
          .getCall(0)
