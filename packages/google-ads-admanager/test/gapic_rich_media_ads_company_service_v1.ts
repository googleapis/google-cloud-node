...
describe('v1.RichMediaAdsCompanyServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          richmediaadscompanyserviceModule.v1.RichMediaAdsCompanyServiceClient
            .servicePath;
  ...
  describe('getRichMediaAdsCompany', () => {
    it('invokes getRichMediaAdsCompany without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.GetRichMediaAdsCompanyRequest',
        ['name'],
      );
      ...
      client.innerApiCalls.getRichMediaAdsCompany =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getRichMediaAdsCompany(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getRichMediaAdsCompany as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getRichMediaAdsCompany without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getRichMediaAdsCompany(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IRichMediaAdsCompany | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getRichMediaAdsCompany with error', async () => {
      ...
      client.innerApiCalls.getRichMediaAdsCompany = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getRichMediaAdsCompany(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getRichMediaAdsCompany as SinonStub
  ...
  describe('listRichMediaAdsCompanies', () => {
    it('invokes listRichMediaAdsCompanies without error', async () => {
      ...
      client.innerApiCalls.listRichMediaAdsCompanies =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listRichMediaAdsCompanies(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listRichMediaAdsCompanies as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listRichMediaAdsCompanies as SinonStub
    ...
    it('invokes listRichMediaAdsCompanies with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listRichMediaAdsCompanies = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listRichMediaAdsCompanies(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listRichMediaAdsCompanies as SinonStub
    ...
    it('invokes listRichMediaAdsCompaniesStream without error', async () => {
      ...
      client.descriptors.page.listRichMediaAdsCompanies.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.RichMediaAdsCompany) => {
      ...
      assert(
        (
          client.descriptors.page.listRichMediaAdsCompanies
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listRichMediaAdsCompanies, request),
      );
      assert(
        (
          client.descriptors.page.listRichMediaAdsCompanies
    ...
    it('uses async iteration with listRichMediaAdsCompanies without error', async () => {
      ...
      client.descriptors.page.listRichMediaAdsCompanies.asyncIterate =
