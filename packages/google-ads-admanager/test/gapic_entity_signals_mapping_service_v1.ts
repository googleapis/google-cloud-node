...
describe('v1.EntitySignalsMappingServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient.port;
            assert(port);
    ...
    describe('getEntitySignalsMapping', () => {
        it('invokes getEntitySignalsMapping without error', async () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetEntitySignalsMappingRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.EntitySignalsMapping()
            );
            client.innerApiCalls.getEntitySignalsMapping = stubSimpleCall(expectedResponse);
            const [response] = await client.getEntitySignalsMapping(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getEntitySignalsMapping as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getEntitySignalsMapping as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getEntitySignalsMapping without error using callback', async () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getEntitySignalsMapping = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getEntitySignalsMapping(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IEntitySignalsMapping|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getEntitySignalsMapping with error', async () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getEntitySignalsMapping = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getEntitySignalsMapping(request), expectedError);
            const actualRequest = (client.innerApiCalls.getEntitySignalsMapping as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getEntitySignalsMapping as SinonStub)
        ...
        it('invokes getEntitySignalsMapping with closed client', async () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('createEntitySignalsMapping', () => {
        it('invokes createEntitySignalsMapping without error', async () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.CreateEntitySignalsMappingRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.EntitySignalsMapping()
            );
            client.innerApiCalls.createEntitySignalsMapping = stubSimpleCall(expectedResponse);
            const [response] = await client.createEntitySignalsMapping(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createEntitySignalsMapping as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createEntitySignalsMapping as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes createEntitySignalsMapping without error using callback', async () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.createEntitySignalsMapping = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createEntitySignalsMapping(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IEntitySignalsMapping|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes createEntitySignalsMapping with error', async () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createEntitySignalsMapping = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createEntitySignalsMapping(request), expectedError);
            const actualRequest = (client.innerApiCalls.createEntitySignalsMapping as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createEntitySignalsMapping as SinonStub)
        ...
        it('invokes createEntitySignalsMapping with closed client', async () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('updateEntitySignalsMapping', () => {
        it('invokes updateEntitySignalsMapping without error', async () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            request.entitySignalsMapping ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.UpdateEntitySignalsMappingRequest', ['entitySignalsMapping', 'name']);
            ...
            client.innerApiCalls.updateEntitySignalsMapping = stubSimpleCall(expectedResponse);
            const [response] = await client.updateEntitySignalsMapping(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateEntitySignalsMapping as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateEntitySignalsMapping as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes updateEntitySignalsMapping without error using callback', async () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.updateEntitySignalsMapping = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateEntitySignalsMapping(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IEntitySignalsMapping|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes updateEntitySignalsMapping with error', async () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `entity_signals_mapping.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateEntitySignalsMapping = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateEntitySignalsMapping(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateEntitySignalsMapping as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateEntitySignalsMapping as SinonStub)
        ...
        it('invokes updateEntitySignalsMapping with closed client', async () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('batchCreateEntitySignalsMappings', () => {
        it('invokes batchCreateEntitySignalsMappings without error', async () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.BatchCreateEntitySignalsMappingsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.BatchCreateEntitySignalsMappingsResponse()
            );
            client.innerApiCalls.batchCreateEntitySignalsMappings = stubSimpleCall(expectedResponse);
            const [response] = await client.batchCreateEntitySignalsMappings(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchCreateEntitySignalsMappings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchCreateEntitySignalsMappings as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes batchCreateEntitySignalsMappings without error using callback', async () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.batchCreateEntitySignalsMappings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchCreateEntitySignalsMappings(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IBatchCreateEntitySignalsMappingsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchCreateEntitySignalsMappings with error', async () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchCreateEntitySignalsMappings = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.batchCreateEntitySignalsMappings(request), expectedError);
            const actualRequest = (client.innerApiCalls.batchCreateEntitySignalsMappings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchCreateEntitySignalsMappings as SinonStub)
        ...
        it('invokes batchCreateEntitySignalsMappings with closed client', async () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('batchUpdateEntitySignalsMappings', () => {
        it('invokes batchUpdateEntitySignalsMappings without error', async () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.BatchUpdateEntitySignalsMappingsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.BatchUpdateEntitySignalsMappingsResponse()
            );
            client.innerApiCalls.batchUpdateEntitySignalsMappings = stubSimpleCall(expectedResponse);
            const [response] = await client.batchUpdateEntitySignalsMappings(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchUpdateEntitySignalsMappings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchUpdateEntitySignalsMappings as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes batchUpdateEntitySignalsMappings without error using callback', async () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.batchUpdateEntitySignalsMappings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchUpdateEntitySignalsMappings(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IBatchUpdateEntitySignalsMappingsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchUpdateEntitySignalsMappings with error', async () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchUpdateEntitySignalsMappings = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.batchUpdateEntitySignalsMappings(request), expectedError);
            const actualRequest = (client.innerApiCalls.batchUpdateEntitySignalsMappings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchUpdateEntitySignalsMappings as SinonStub)
        ...
        it('invokes batchUpdateEntitySignalsMappings with closed client', async () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('listEntitySignalsMappings', () => {
        it('invokes listEntitySignalsMappings without error', async () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListEntitySignalsMappingsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.EntitySignalsMapping()),
              generateSampleMessage(new protos.google.ads.admanager.v1.EntitySignalsMapping()),
              generateSampleMessage(new protos.google.ads.admanager.v1.EntitySignalsMapping()),
            ];
            client.innerApiCalls.listEntitySignalsMappings = stubSimpleCall(expectedResponse);
            const [response] = await client.listEntitySignalsMappings(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listEntitySignalsMappings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listEntitySignalsMappings as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes listEntitySignalsMappings without error using callback', async () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listEntitySignalsMappings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listEntitySignalsMappings(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IEntitySignalsMapping[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listEntitySignalsMappings with error', async () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listEntitySignalsMappings = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listEntitySignalsMappings(request), expectedError);
            const actualRequest = (client.innerApiCalls.listEntitySignalsMappings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listEntitySignalsMappings as SinonStub)
        ...
        it('invokes listEntitySignalsMappingsStream without error', async () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listEntitySignalsMappings.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listEntitySignalsMappingsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.EntitySignalsMapping[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.EntitySignalsMapping) => {
            ...
            assert((client.descriptors.page.listEntitySignalsMappings.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listEntitySignalsMappings, request));
            assert(
                (client.descriptors.page.listEntitySignalsMappings.createStream as SinonStub)
        ...
        it('invokes listEntitySignalsMappingsStream with error', async () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listEntitySignalsMappings.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listEntitySignalsMappingsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.EntitySignalsMapping[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.EntitySignalsMapping) => {
        ...
        it('uses async iteration with listEntitySignalsMappings without error', async () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listEntitySignalsMappings.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.admanager.v1.IEntitySignalsMapping[] = [];
            const iterable = client.listEntitySignalsMappingsAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listEntitySignalsMappings.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listEntitySignalsMappings with error', async () => {
            const client = new entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listEntitySignalsMappings.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listEntitySignalsMappingsAsync(request);
