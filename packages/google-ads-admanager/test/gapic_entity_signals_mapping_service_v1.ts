...
describe('v1.EntitySignalsMappingServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          entitysignalsmappingserviceModule.v1.EntitySignalsMappingServiceClient
            .servicePath;
  ...
  describe('getEntitySignalsMapping', () => {
    it('invokes getEntitySignalsMapping without error', async () => {
      ...
      client.innerApiCalls.getEntitySignalsMapping =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getEntitySignalsMapping(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getEntitySignalsMapping as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getEntitySignalsMapping without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getEntitySignalsMapping(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IEntitySignalsMapping | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createEntitySignalsMapping', () => {
    it('invokes createEntitySignalsMapping without error', async () => {
      ...
      client.innerApiCalls.createEntitySignalsMapping =
        stubSimpleCall(expectedResponse);
      const [response] = await client.createEntitySignalsMapping(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createEntitySignalsMapping as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createEntitySignalsMapping as SinonStub
  ...
  describe('updateEntitySignalsMapping', () => {
    it('invokes updateEntitySignalsMapping without error', async () => {
      ...
      client.innerApiCalls.updateEntitySignalsMapping =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateEntitySignalsMapping(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateEntitySignalsMapping as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateEntitySignalsMapping as SinonStub
  ...
  describe('batchCreateEntitySignalsMappings', () => {
    it('invokes batchCreateEntitySignalsMappings without error', async () => {
      ...
      client.innerApiCalls.batchCreateEntitySignalsMappings =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchCreateEntitySignalsMappings(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchCreateEntitySignalsMappings as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchCreateEntitySignalsMappings as SinonStub
    ...
    it('invokes batchCreateEntitySignalsMappings without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchCreateEntitySignalsMappings(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchCreateEntitySignalsMappingsResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('batchUpdateEntitySignalsMappings', () => {
    it('invokes batchUpdateEntitySignalsMappings without error', async () => {
      ...
      client.innerApiCalls.batchUpdateEntitySignalsMappings =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchUpdateEntitySignalsMappings(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchUpdateEntitySignalsMappings as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchUpdateEntitySignalsMappings as SinonStub
    ...
    it('invokes batchUpdateEntitySignalsMappings without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchUpdateEntitySignalsMappings(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchUpdateEntitySignalsMappingsResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listEntitySignalsMappings', () => {
    it('invokes listEntitySignalsMappings without error', async () => {
      ...
      client.innerApiCalls.listEntitySignalsMappings =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listEntitySignalsMappings(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listEntitySignalsMappings as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listEntitySignalsMappings as SinonStub
    ...
    it('invokes listEntitySignalsMappings with error', async () => {
      ...
      await assert.rejects(
        client.listEntitySignalsMappings(request),
        expectedError
      );
      const actualRequest = (
        client.innerApiCalls.listEntitySignalsMappings as SinonStub
    ...
    it('invokes listEntitySignalsMappingsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.EntitySignalsMapping) => {
      ...
      assert(
        (
          client.descriptors.page.listEntitySignalsMappings
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listEntitySignalsMappings, request)
      );
      assert(
        (
          client.descriptors.page.listEntitySignalsMappings
