...
describe('v1.OperatingSystemServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          operatingsystemserviceModule.v1.OperatingSystemServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        operatingsystemserviceModule.v1.OperatingSystemServiceClient.port;
      assert(port);
  ...
  describe('getOperatingSystem', () => {
    it('invokes getOperatingSystem without error', async () => {
      ...
      client.innerApiCalls.getOperatingSystem =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getOperatingSystem(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getOperatingSystem as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getOperatingSystem without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getOperatingSystem(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IOperatingSystem | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getOperatingSystem with error', async () => {
      ...
      client.innerApiCalls.getOperatingSystem = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listOperatingSystems', () => {
    it('invokes listOperatingSystems without error', async () => {
      ...
      client.innerApiCalls.listOperatingSystems =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listOperatingSystems(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listOperatingSystems as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listOperatingSystems as SinonStub
    ...
    it('invokes listOperatingSystems with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listOperatingSystems = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listOperatingSystemsStream without error', async () => {
      ...
      client.descriptors.page.listOperatingSystems.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.OperatingSystem) => {
      ...
      assert(
        (client.descriptors.page.listOperatingSystems.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listOperatingSystems, request),
      );
      assert(
        (client.descriptors.page.listOperatingSystems.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listOperatingSystems without error', async () => {
      ...
      client.descriptors.page.listOperatingSystems.asyncIterate =
