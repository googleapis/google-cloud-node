...
describe('v1.PartnerServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          partnerserviceModule.v1.PartnerServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          partnerserviceModule.v1.PartnerServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new partnerserviceModule.v1.PartnerServiceClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = partnerserviceModule.v1.PartnerServiceClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.partnerServiceStub, undefined);
  ...
  describe('getPartner', () => {
    it('invokes getPartner without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.GetPartnerRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.GetPartnerRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.Partner(),
      );
    ...
    it('invokes getPartner without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getPartner(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IPartner | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('updatePartner', () => {
    it('invokes updatePartner without error', async () => {
      const client = new partnerserviceModule.v1.PartnerServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.UpdatePartnerRequest(),
      );
      request.partner ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.UpdatePartnerRequest',
        ['partner', 'name'],
      );
      request.partner.name = defaultValue1;
      const expectedHeaderRequestParams = `partner.name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.Partner(),
      );
      client.innerApiCalls.updatePartner = stubSimpleCall(expectedResponse);
      const [response] = await client.updatePartner(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updatePartner as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updatePartner as SinonStub
    ...
    it('invokes updatePartner without error using callback', async () => {
      const client = new partnerserviceModule.v1.PartnerServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.updatePartner =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.updatePartner(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IPartner | null,
    ...
    it('invokes updatePartner with error', async () => {
      const client = new partnerserviceModule.v1.PartnerServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `partner.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updatePartner = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes updatePartner with closed client', async () => {
      const client = new partnerserviceModule.v1.PartnerServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchUpdatePartners', () => {
    it('invokes batchUpdatePartners without error', async () => {
      const client = new partnerserviceModule.v1.PartnerServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUpdatePartnersRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUpdatePartnersResponse(),
      );
      client.innerApiCalls.batchUpdatePartners =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchUpdatePartners(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchUpdatePartners as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchUpdatePartners as SinonStub
    ...
    it('invokes batchUpdatePartners without error using callback', async () => {
      const client = new partnerserviceModule.v1.PartnerServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchUpdatePartners =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchUpdatePartners(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchUpdatePartnersResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchUpdatePartners with error', async () => {
      const client = new partnerserviceModule.v1.PartnerServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchUpdatePartners = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes batchUpdatePartners with closed client', async () => {
      const client = new partnerserviceModule.v1.PartnerServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('listPartners', () => {
    it('invokes listPartners without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.ListPartnersRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.ListPartnersRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = [
        generateSampleMessage(new protos.google.ads.admanager.v1.Partner()),
        generateSampleMessage(new protos.google.ads.admanager.v1.Partner()),
        generateSampleMessage(new protos.google.ads.admanager.v1.Partner()),
      ];
      client.innerApiCalls.listPartners = stubSimpleCall(expectedResponse);
      const [response] = await client.listPartners(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listPartners as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listPartners as SinonStub
    ...
    it('invokes listPartners without error using callback', async () => {
      ...
      client.innerApiCalls.listPartners =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listPartners(
          request,
    ...
    it('invokes listPartners with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listPartners = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.listPartners(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.listPartners as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes listPartnersStream without error', async () => {
      ...
      client.descriptors.page.listPartners.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listPartnersStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.ads.admanager.v1.Partner[] = [];
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.Partner) => {
      ...
      assert(
        (client.descriptors.page.listPartners.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listPartners, request),
      );
      assert(
        (client.descriptors.page.listPartners.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listPartnersStream with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listPartners.createStream = stubPageStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.listPartnersStream(request);
    ...
    it('uses async iteration with listPartners without error', async () => {
      const client = new partnerserviceModule.v1.PartnerServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.descriptors.page.listPartners.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.ads.admanager.v1.IPartner[] = [];
      const iterable = client.listPartnersAsync(request);
