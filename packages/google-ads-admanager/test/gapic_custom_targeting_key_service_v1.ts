...
describe('v1.CustomTargetingKeyServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          customtargetingkeyserviceModule.v1.CustomTargetingKeyServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        customtargetingkeyserviceModule.v1.CustomTargetingKeyServiceClient.port;
      assert(port);
  ...
  describe('getCustomTargetingKey', () => {
    it('invokes getCustomTargetingKey without error', async () => {
      ...
      client.innerApiCalls.getCustomTargetingKey =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getCustomTargetingKey(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getCustomTargetingKey as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getCustomTargetingKey without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getCustomTargetingKey(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.ICustomTargetingKey | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getCustomTargetingKey with error', async () => {
      ...
      await assert.rejects(
        client.getCustomTargetingKey(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getCustomTargetingKey as SinonStub
  ...
  describe('createCustomTargetingKey', () => {
    it('invokes createCustomTargetingKey without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createCustomTargetingKey as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createCustomTargetingKey as SinonStub
    ...
    it('invokes createCustomTargetingKey with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createCustomTargetingKey = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createCustomTargetingKey(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createCustomTargetingKey as SinonStub
  ...
  describe('batchCreateCustomTargetingKeys', () => {
    it('invokes batchCreateCustomTargetingKeys without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchCreateCustomTargetingKeys as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchCreateCustomTargetingKeys as SinonStub
    ...
    it('invokes batchCreateCustomTargetingKeys without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchCreateCustomTargetingKeys(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchCreateCustomTargetingKeysResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchCreateCustomTargetingKeys with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchCreateCustomTargetingKeys = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchCreateCustomTargetingKeys(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchCreateCustomTargetingKeys as SinonStub
  ...
  describe('updateCustomTargetingKey', () => {
    it('invokes updateCustomTargetingKey without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateCustomTargetingKey as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateCustomTargetingKey as SinonStub
    ...
    it('invokes updateCustomTargetingKey with error', async () => {
      ...
      const expectedHeaderRequestParams = `custom_targeting_key.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateCustomTargetingKey = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateCustomTargetingKey(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateCustomTargetingKey as SinonStub
  ...
  describe('batchUpdateCustomTargetingKeys', () => {
    it('invokes batchUpdateCustomTargetingKeys without error', async () => {
      ...
      client.innerApiCalls.batchUpdateCustomTargetingKeys =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchUpdateCustomTargetingKeys(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchUpdateCustomTargetingKeys as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchUpdateCustomTargetingKeys as SinonStub
    ...
    it('invokes batchUpdateCustomTargetingKeys without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchUpdateCustomTargetingKeys(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchUpdateCustomTargetingKeysResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchUpdateCustomTargetingKeys with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchUpdateCustomTargetingKeys = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchUpdateCustomTargetingKeys(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchUpdateCustomTargetingKeys as SinonStub
  ...
  describe('batchActivateCustomTargetingKeys', () => {
    it('invokes batchActivateCustomTargetingKeys without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchActivateCustomTargetingKeys as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchActivateCustomTargetingKeys as SinonStub
    ...
    it('invokes batchActivateCustomTargetingKeys without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchActivateCustomTargetingKeys(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchActivateCustomTargetingKeysResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchActivateCustomTargetingKeys with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchActivateCustomTargetingKeys = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchActivateCustomTargetingKeys(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchActivateCustomTargetingKeys as SinonStub
  ...
  describe('batchDeactivateCustomTargetingKeys', () => {
    it('invokes batchDeactivateCustomTargetingKeys without error', async () => {
      ...
      client.innerApiCalls.batchDeactivateCustomTargetingKeys =
        stubSimpleCall(expectedResponse);
      const [response] =
        await client.batchDeactivateCustomTargetingKeys(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchDeactivateCustomTargetingKeys as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchDeactivateCustomTargetingKeys as SinonStub
    ...
    it('invokes batchDeactivateCustomTargetingKeys without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchDeactivateCustomTargetingKeys(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchDeactivateCustomTargetingKeysResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchDeactivateCustomTargetingKeys with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchDeactivateCustomTargetingKeys = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
  ...
  describe('listCustomTargetingKeys', () => {
    it('invokes listCustomTargetingKeys without error', async () => {
      ...
      client.innerApiCalls.listCustomTargetingKeys =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listCustomTargetingKeys(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listCustomTargetingKeys as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listCustomTargetingKeys as SinonStub
    ...
    it('invokes listCustomTargetingKeys with error', async () => {
      ...
      await assert.rejects(
        client.listCustomTargetingKeys(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listCustomTargetingKeys as SinonStub
    ...
    it('invokes listCustomTargetingKeysStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.CustomTargetingKey) => {
      ...
      assert(
        (
          client.descriptors.page.listCustomTargetingKeys
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listCustomTargetingKeys, request),
      );
      assert(
        (
          client.descriptors.page.listCustomTargetingKeys
