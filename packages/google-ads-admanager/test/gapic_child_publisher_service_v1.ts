...
describe('v1.ChildPublisherServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          childpublisherserviceModule.v1.ChildPublisherServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        childpublisherserviceModule.v1.ChildPublisherServiceClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.childPublisherServiceStub, undefined);
  ...
  describe('getChildPublisher', () => {
    it('invokes getChildPublisher without error', async () => {
      const client =
        new childpublisherserviceModule.v1.ChildPublisherServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.GetChildPublisherRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.GetChildPublisherRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.ChildPublisher(),
      );
      client.innerApiCalls.getChildPublisher = stubSimpleCall(expectedResponse);
      const [response] = await client.getChildPublisher(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getChildPublisher as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getChildPublisher without error using callback', async () => {
      const client =
        new childpublisherserviceModule.v1.ChildPublisherServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.getChildPublisher =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getChildPublisher(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IChildPublisher | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getChildPublisher with error', async () => {
      const client =
        new childpublisherserviceModule.v1.ChildPublisherServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.getChildPublisher = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes getChildPublisher with closed client', async () => {
      const client =
        new childpublisherserviceModule.v1.ChildPublisherServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('createChildPublisher', () => {
    it('invokes createChildPublisher without error', async () => {
      const client =
        new childpublisherserviceModule.v1.ChildPublisherServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.CreateChildPublisherRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.CreateChildPublisherRequest',
        ['parent'],
      );
      ...
      client.innerApiCalls.createChildPublisher =
        stubSimpleCall(expectedResponse);
      const [response] = await client.createChildPublisher(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createChildPublisher as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createChildPublisher as SinonStub
    ...
    it('invokes createChildPublisher without error using callback', async () => {
      const client =
        new childpublisherserviceModule.v1.ChildPublisherServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
    ...
    it('invokes createChildPublisher with error', async () => {
      const client =
        new childpublisherserviceModule.v1.ChildPublisherServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createChildPublisher = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes createChildPublisher with closed client', async () => {
      const client =
        new childpublisherserviceModule.v1.ChildPublisherServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('batchCreateChildPublishers', () => {
    it('invokes batchCreateChildPublishers without error', async () => {
      const client =
        new childpublisherserviceModule.v1.ChildPublisherServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchCreateChildPublishersRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchCreateChildPublishersRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchCreateChildPublishersResponse(),
      );
      client.innerApiCalls.batchCreateChildPublishers =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchCreateChildPublishers(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchCreateChildPublishers as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchCreateChildPublishers as SinonStub
    ...
    it('invokes batchCreateChildPublishers without error using callback', async () => {
      const client =
        new childpublisherserviceModule.v1.ChildPublisherServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.batchCreateChildPublishers =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchCreateChildPublishers(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchCreateChildPublishersResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchCreateChildPublishers with error', async () => {
      const client =
        new childpublisherserviceModule.v1.ChildPublisherServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchCreateChildPublishers = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchCreateChildPublishers(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchCreateChildPublishers as SinonStub
    ...
    it('invokes batchCreateChildPublishers with closed client', async () => {
      const client =
        new childpublisherserviceModule.v1.ChildPublisherServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('updateChildPublisher', () => {
    it('invokes updateChildPublisher without error', async () => {
      const client =
        new childpublisherserviceModule.v1.ChildPublisherServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.UpdateChildPublisherRequest(),
      );
      request.childPublisher ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.UpdateChildPublisherRequest',
        ['childPublisher', 'name'],
      );
      request.childPublisher.name = defaultValue1;
      const expectedHeaderRequestParams = `child_publisher.name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.ChildPublisher(),
      );
      client.innerApiCalls.updateChildPublisher =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateChildPublisher(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateChildPublisher as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateChildPublisher as SinonStub
    ...
    it('invokes updateChildPublisher without error using callback', async () => {
      const client =
        new childpublisherserviceModule.v1.ChildPublisherServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
    ...
    it('invokes updateChildPublisher with error', async () => {
      const client =
        new childpublisherserviceModule.v1.ChildPublisherServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `child_publisher.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateChildPublisher = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes updateChildPublisher with closed client', async () => {
      const client =
        new childpublisherserviceModule.v1.ChildPublisherServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('batchUpdateChildPublishers', () => {
    it('invokes batchUpdateChildPublishers without error', async () => {
      const client =
        new childpublisherserviceModule.v1.ChildPublisherServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUpdateChildPublishersRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchUpdateChildPublishersRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUpdateChildPublishersResponse(),
      );
      client.innerApiCalls.batchUpdateChildPublishers =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchUpdateChildPublishers(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchUpdateChildPublishers as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchUpdateChildPublishers as SinonStub
    ...
    it('invokes batchUpdateChildPublishers without error using callback', async () => {
      const client =
        new childpublisherserviceModule.v1.ChildPublisherServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.batchUpdateChildPublishers =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchUpdateChildPublishers(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchUpdateChildPublishersResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchUpdateChildPublishers with error', async () => {
      const client =
        new childpublisherserviceModule.v1.ChildPublisherServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchUpdateChildPublishers = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchUpdateChildPublishers(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchUpdateChildPublishers as SinonStub
    ...
    it('invokes batchUpdateChildPublishers with closed client', async () => {
      const client =
        new childpublisherserviceModule.v1.ChildPublisherServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('listChildPublishers', () => {
    it('invokes listChildPublishers without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.ListChildPublishersRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.ListChildPublishersRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.listChildPublishers =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listChildPublishers(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listChildPublishers as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listChildPublishers as SinonStub
    ...
    it('invokes listChildPublishers with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listChildPublishers = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.listChildPublishers(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.listChildPublishers as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes listChildPublishersStream without error', async () => {
      ...
      client.descriptors.page.listChildPublishers.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listChildPublishersStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.ads.admanager.v1.ChildPublisher[] = [];
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.ChildPublisher) => {
      ...
      assert(
        (client.descriptors.page.listChildPublishers.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listChildPublishers, request),
      );
      assert(
        (client.descriptors.page.listChildPublishers.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listChildPublishers without error', async () => {
      const client =
        new childpublisherserviceModule.v1.ChildPublisherServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.descriptors.page.listChildPublishers.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.ads.admanager.v1.IChildPublisher[] = [];
      const iterable = client.listChildPublishersAsync(request);
