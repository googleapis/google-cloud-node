...
describe('v1.MobileDeviceSubmodelServiceClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new mobiledevicesubmodelserviceModule.v1.MobileDeviceSubmodelServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          mobiledevicesubmodelserviceModule.v1.MobileDeviceSubmodelServiceClient
            .servicePath;
  ...
  describe('getMobileDeviceSubmodel', () => {
    it('invokes getMobileDeviceSubmodel without error', async () => {
      ...
      client.innerApiCalls.getMobileDeviceSubmodel =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getMobileDeviceSubmodel(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getMobileDeviceSubmodel as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getMobileDeviceSubmodel without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getMobileDeviceSubmodel(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IMobileDeviceSubmodel | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getMobileDeviceSubmodel with error', async () => {
      ...
      client.innerApiCalls.getMobileDeviceSubmodel = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getMobileDeviceSubmodel(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getMobileDeviceSubmodel as SinonStub
  ...
  describe('listMobileDeviceSubmodels', () => {
    it('invokes listMobileDeviceSubmodels without error', async () => {
      ...
      client.innerApiCalls.listMobileDeviceSubmodels =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listMobileDeviceSubmodels(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listMobileDeviceSubmodels as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listMobileDeviceSubmodels as SinonStub
    ...
    it('invokes listMobileDeviceSubmodels with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listMobileDeviceSubmodels = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listMobileDeviceSubmodels(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listMobileDeviceSubmodels as SinonStub
    ...
    it('invokes listMobileDeviceSubmodelsStream without error', async () => {
      ...
      client.descriptors.page.listMobileDeviceSubmodels.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.MobileDeviceSubmodel) => {
      ...
      assert(
        (
          client.descriptors.page.listMobileDeviceSubmodels
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listMobileDeviceSubmodels, request),
      );
      assert(
        (
          client.descriptors.page.listMobileDeviceSubmodels
    ...
    it('uses async iteration with listMobileDeviceSubmodels without error', async () => {
      ...
      client.descriptors.page.listMobileDeviceSubmodels.asyncIterate =
