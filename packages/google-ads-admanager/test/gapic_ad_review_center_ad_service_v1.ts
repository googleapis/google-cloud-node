...
describe('v1.AdReviewCenterAdServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new adreviewcenteradserviceModule.v1.AdReviewCenterAdServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = adreviewcenteradserviceModule.v1.AdReviewCenterAdServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = adreviewcenteradserviceModule.v1.AdReviewCenterAdServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new adreviewcenteradserviceModule.v1.AdReviewCenterAdServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new adreviewcenteradserviceModule.v1.AdReviewCenterAdServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new adreviewcenteradserviceModule.v1.AdReviewCenterAdServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new adreviewcenteradserviceModule.v1.AdReviewCenterAdServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = adreviewcenteradserviceModule.v1.AdReviewCenterAdServiceClient.port;
            assert(port);
    ...
    describe('batchAllowAdReviewCenterAds', () => {
        it('invokes batchAllowAdReviewCenterAds without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.BatchAllowAdReviewCenterAdsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.batchAllowAdReviewCenterAds = stubLongRunningCall(expectedResponse);
            const [operation] = await client.batchAllowAdReviewCenterAds(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchAllowAdReviewCenterAds as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchAllowAdReviewCenterAds as SinonStub)
        ...
        it('invokes batchAllowAdReviewCenterAds without error using callback', async () => {
            ...
            client.innerApiCalls.batchAllowAdReviewCenterAds = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchAllowAdReviewCenterAds(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.ads.admanager.v1.IBatchAllowAdReviewCenterAdsResponse, protos.google.ads.admanager.v1.IBatchAdReviewCenterAdsOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.ads.admanager.v1.IBatchAllowAdReviewCenterAdsResponse, protos.google.ads.admanager.v1.IBatchAdReviewCenterAdsOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchAllowAdReviewCenterAds as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes batchAllowAdReviewCenterAds with call error', async () => {
            ...
            client.innerApiCalls.batchAllowAdReviewCenterAds = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.batchAllowAdReviewCenterAds(request), expectedError);
            const actualRequest = (client.innerApiCalls.batchAllowAdReviewCenterAds as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchAllowAdReviewCenterAds as SinonStub)
        ...
        it('invokes batchAllowAdReviewCenterAds with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchAllowAdReviewCenterAds = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.batchAllowAdReviewCenterAds(request);
        ...
        it('invokes checkBatchAllowAdReviewCenterAdsProgress without error', async () => {
            ...
            const decodedOperation = await client.checkBatchAllowAdReviewCenterAdsProgress(expectedResponse.name);
        ...
        it('invokes checkBatchAllowAdReviewCenterAdsProgress with error', async () => {
            ...
            await assert.rejects(client.checkBatchAllowAdReviewCenterAdsProgress(''), expectedError);
    ...
    describe('batchBlockAdReviewCenterAds', () => {
        it('invokes batchBlockAdReviewCenterAds without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.BatchBlockAdReviewCenterAdsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.batchBlockAdReviewCenterAds = stubLongRunningCall(expectedResponse);
            const [operation] = await client.batchBlockAdReviewCenterAds(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchBlockAdReviewCenterAds as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchBlockAdReviewCenterAds as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes batchBlockAdReviewCenterAds without error using callback', async () => {
            ...
            client.innerApiCalls.batchBlockAdReviewCenterAds = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchBlockAdReviewCenterAds(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.ads.admanager.v1.IBatchBlockAdReviewCenterAdsResponse, protos.google.ads.admanager.v1.IBatchAdReviewCenterAdsOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.ads.admanager.v1.IBatchBlockAdReviewCenterAdsResponse, protos.google.ads.admanager.v1.IBatchAdReviewCenterAdsOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchBlockAdReviewCenterAds as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes batchBlockAdReviewCenterAds with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchBlockAdReviewCenterAds = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.batchBlockAdReviewCenterAds(request), expectedError);
            const actualRequest = (client.innerApiCalls.batchBlockAdReviewCenterAds as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchBlockAdReviewCenterAds as SinonStub)
        ...
        it('invokes batchBlockAdReviewCenterAds with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchBlockAdReviewCenterAds = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.batchBlockAdReviewCenterAds(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.batchBlockAdReviewCenterAds as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkBatchBlockAdReviewCenterAdsProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkBatchBlockAdReviewCenterAdsProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkBatchBlockAdReviewCenterAdsProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkBatchBlockAdReviewCenterAdsProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('searchAdReviewCenterAds', () => {
        it('invokes searchAdReviewCenterAds without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.SearchAdReviewCenterAdsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.AdReviewCenterAd()),
              generateSampleMessage(new protos.google.ads.admanager.v1.AdReviewCenterAd()),
              generateSampleMessage(new protos.google.ads.admanager.v1.AdReviewCenterAd()),
            ];
            client.innerApiCalls.searchAdReviewCenterAds = stubSimpleCall(expectedResponse);
            const [response] = await client.searchAdReviewCenterAds(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.searchAdReviewCenterAds as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.searchAdReviewCenterAds as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes searchAdReviewCenterAds without error using callback', async () => {
            ...
            client.innerApiCalls.searchAdReviewCenterAds = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.searchAdReviewCenterAds(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IAdReviewCenterAd[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes searchAdReviewCenterAds with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.searchAdReviewCenterAds = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.searchAdReviewCenterAds(request), expectedError);
            const actualRequest = (client.innerApiCalls.searchAdReviewCenterAds as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.searchAdReviewCenterAds as SinonStub)
        ...
        it('invokes searchAdReviewCenterAdsStream without error', async () => {
            ...
            client.descriptors.page.searchAdReviewCenterAds.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.searchAdReviewCenterAdsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.AdReviewCenterAd[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.AdReviewCenterAd) => {
            ...
            assert((client.descriptors.page.searchAdReviewCenterAds.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.searchAdReviewCenterAds, request));
            assert(
                (client.descriptors.page.searchAdReviewCenterAds.createStream as SinonStub)
        ...
        it('invokes searchAdReviewCenterAdsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.searchAdReviewCenterAds.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.searchAdReviewCenterAdsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.AdReviewCenterAd[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.AdReviewCenterAd) => {
        ...
        it('uses async iteration with searchAdReviewCenterAds without error', async () => {
            ...
            client.descriptors.page.searchAdReviewCenterAds.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(
                (client.descriptors.page.searchAdReviewCenterAds.asyncIterate as SinonStub)
        ...
        it('uses async iteration with searchAdReviewCenterAds with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.searchAdReviewCenterAds.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.searchAdReviewCenterAdsAsync(request);
