...
describe('v1.AdReviewCenterAdServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          adreviewcenteradserviceModule.v1.AdReviewCenterAdServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        adreviewcenteradserviceModule.v1.AdReviewCenterAdServiceClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.adReviewCenterAdServiceStub, undefined);
  ...
  describe('batchAllowAdReviewCenterAds', () => {
    it('invokes batchAllowAdReviewCenterAds without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchAllowAdReviewCenterAdsRequest(),
      );
      ...
      client.innerApiCalls.batchAllowAdReviewCenterAds =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.batchAllowAdReviewCenterAds(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchAllowAdReviewCenterAds as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes batchAllowAdReviewCenterAds without error using callback', async () => {
      const client =
        new adreviewcenteradserviceModule.v1.AdReviewCenterAdServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchAllowAdReviewCenterAds(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.ads.admanager.v1.IBatchAllowAdReviewCenterAdsResponse,
              protos.google.ads.admanager.v1.IBatchAdReviewCenterAdsOperationMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
    ...
    it('invokes batchAllowAdReviewCenterAds with call error', async () => {
      const client =
        new adreviewcenteradserviceModule.v1.AdReviewCenterAdServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.batchAllowAdReviewCenterAds = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchAllowAdReviewCenterAds(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchAllowAdReviewCenterAds as SinonStub
    ...
    it('invokes batchAllowAdReviewCenterAds with LRO error', async () => {
      const client =
        new adreviewcenteradserviceModule.v1.AdReviewCenterAdServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
    ...
    it('invokes checkBatchAllowAdReviewCenterAdsProgress without error', async () => {
      const client =
        new adreviewcenteradserviceModule.v1.AdReviewCenterAdServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const decodedOperation =
        await client.checkBatchAllowAdReviewCenterAdsProgress(
    ...
    it('invokes checkBatchAllowAdReviewCenterAdsProgress with error', async () => {
      const client =
        new adreviewcenteradserviceModule.v1.AdReviewCenterAdServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await assert.rejects(
        client.checkBatchAllowAdReviewCenterAdsProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('batchBlockAdReviewCenterAds', () => {
    it('invokes batchBlockAdReviewCenterAds without error', async () => {
      const client =
        new adreviewcenteradserviceModule.v1.AdReviewCenterAdServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchBlockAdReviewCenterAdsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.batchBlockAdReviewCenterAds =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.batchBlockAdReviewCenterAds(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchBlockAdReviewCenterAds as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchBlockAdReviewCenterAds as SinonStub
    ...
    it('invokes batchBlockAdReviewCenterAds without error using callback', async () => {
      const client =
        new adreviewcenteradserviceModule.v1.AdReviewCenterAdServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchBlockAdReviewCenterAds(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.ads.admanager.v1.IBatchBlockAdReviewCenterAdsResponse,
              protos.google.ads.admanager.v1.IBatchAdReviewCenterAdsOperationMetadata
            > | null,
          ) => {
            if (err) {
    ...
    it('invokes batchBlockAdReviewCenterAds with call error', async () => {
      const client =
        new adreviewcenteradserviceModule.v1.AdReviewCenterAdServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchBlockAdReviewCenterAds = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchBlockAdReviewCenterAds(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchBlockAdReviewCenterAds as SinonStub
    ...
    it('invokes batchBlockAdReviewCenterAds with LRO error', async () => {
      const client =
        new adreviewcenteradserviceModule.v1.AdReviewCenterAdServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
    ...
    it('invokes checkBatchBlockAdReviewCenterAdsProgress without error', async () => {
      const client =
        new adreviewcenteradserviceModule.v1.AdReviewCenterAdServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkBatchBlockAdReviewCenterAdsProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkBatchBlockAdReviewCenterAdsProgress with error', async () => {
      const client =
        new adreviewcenteradserviceModule.v1.AdReviewCenterAdServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await assert.rejects(
        client.checkBatchBlockAdReviewCenterAdsProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('searchAdReviewCenterAds', () => {
    it('invokes searchAdReviewCenterAds without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.SearchAdReviewCenterAdsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.ads.admanager.v1.AdReviewCenterAd(),
        ),
        generateSampleMessage(
          new protos.google.ads.admanager.v1.AdReviewCenterAd(),
        ),
      ...
      client.innerApiCalls.searchAdReviewCenterAds =
        stubSimpleCall(expectedResponse);
      const [response] = await client.searchAdReviewCenterAds(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.searchAdReviewCenterAds as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.searchAdReviewCenterAds as SinonStub
    ...
    it('invokes searchAdReviewCenterAds without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.searchAdReviewCenterAds(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IAdReviewCenterAd[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes searchAdReviewCenterAds with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.searchAdReviewCenterAds = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.searchAdReviewCenterAds(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.searchAdReviewCenterAds as SinonStub
    ...
    it('invokes searchAdReviewCenterAdsStream without error', async () => {
      ...
      client.descriptors.page.searchAdReviewCenterAds.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.searchAdReviewCenterAdsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.ads.admanager.v1.AdReviewCenterAd[] = [];
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.AdReviewCenterAd) => {
      ...
      assert(
        (
          client.descriptors.page.searchAdReviewCenterAds
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.searchAdReviewCenterAds, request),
      );
      assert(
        (
          client.descriptors.page.searchAdReviewCenterAds
    ...
    it('uses async iteration with searchAdReviewCenterAds without error', async () => {
      const client =
        new adreviewcenteradserviceModule.v1.AdReviewCenterAdServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.descriptors.page.searchAdReviewCenterAds.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.ads.admanager.v1.IAdReviewCenterAd[] = [];
      const iterable = client.searchAdReviewCenterAdsAsync(request);
