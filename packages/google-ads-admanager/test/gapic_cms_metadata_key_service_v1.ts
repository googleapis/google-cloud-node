...
describe('v1.CmsMetadataKeyServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          cmsmetadatakeyserviceModule.v1.CmsMetadataKeyServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        cmsmetadatakeyserviceModule.v1.CmsMetadataKeyServiceClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.cmsMetadataKeyServiceStub, undefined);
  ...
  describe('getCmsMetadataKey', () => {
    it('invokes getCmsMetadataKey without error', async () => {
      const client =
        new cmsmetadatakeyserviceModule.v1.CmsMetadataKeyServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.GetCmsMetadataKeyRequest(),
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.CmsMetadataKey(),
      );
      client.innerApiCalls.getCmsMetadataKey = stubSimpleCall(expectedResponse);
      const [response] = await client.getCmsMetadataKey(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getCmsMetadataKey as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getCmsMetadataKey without error using callback', async () => {
      const client =
        new cmsmetadatakeyserviceModule.v1.CmsMetadataKeyServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.getCmsMetadataKey =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getCmsMetadataKey(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.ICmsMetadataKey | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getCmsMetadataKey with error', async () => {
      const client =
        new cmsmetadatakeyserviceModule.v1.CmsMetadataKeyServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.getCmsMetadataKey = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes getCmsMetadataKey with closed client', async () => {
      const client =
        new cmsmetadatakeyserviceModule.v1.CmsMetadataKeyServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('batchActivateCmsMetadataKeys', () => {
    it('invokes batchActivateCmsMetadataKeys without error', async () => {
      ...
      client.innerApiCalls.batchActivateCmsMetadataKeys =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchActivateCmsMetadataKeys(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchActivateCmsMetadataKeys as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchActivateCmsMetadataKeys as SinonStub
    ...
    it('invokes batchActivateCmsMetadataKeys without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchActivateCmsMetadataKeys(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchActivateCmsMetadataKeysResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchActivateCmsMetadataKeys with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchActivateCmsMetadataKeys = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchActivateCmsMetadataKeys(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchActivateCmsMetadataKeys as SinonStub
  ...
  describe('batchDeactivateCmsMetadataKeys', () => {
    it('invokes batchDeactivateCmsMetadataKeys without error', async () => {
      ...
      client.innerApiCalls.batchDeactivateCmsMetadataKeys =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchDeactivateCmsMetadataKeys(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchDeactivateCmsMetadataKeys as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchDeactivateCmsMetadataKeys as SinonStub
    ...
    it('invokes batchDeactivateCmsMetadataKeys without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchDeactivateCmsMetadataKeys(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchDeactivateCmsMetadataKeysResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchDeactivateCmsMetadataKeys with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchDeactivateCmsMetadataKeys = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchDeactivateCmsMetadataKeys(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchDeactivateCmsMetadataKeys as SinonStub
  ...
  describe('listCmsMetadataKeys', () => {
    it('invokes listCmsMetadataKeys without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.ListCmsMetadataKeysRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.listCmsMetadataKeys =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listCmsMetadataKeys(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listCmsMetadataKeys as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listCmsMetadataKeys as SinonStub
    ...
    it('invokes listCmsMetadataKeys with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listCmsMetadataKeys = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.listCmsMetadataKeys(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.listCmsMetadataKeys as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes listCmsMetadataKeysStream without error', async () => {
      ...
      client.descriptors.page.listCmsMetadataKeys.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listCmsMetadataKeysStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.ads.admanager.v1.CmsMetadataKey[] = [];
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.CmsMetadataKey) => {
      ...
      assert(
        (client.descriptors.page.listCmsMetadataKeys.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listCmsMetadataKeys, request),
      );
      assert(
        (client.descriptors.page.listCmsMetadataKeys.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listCmsMetadataKeys without error', async () => {
      const client =
        new cmsmetadatakeyserviceModule.v1.CmsMetadataKeyServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.descriptors.page.listCmsMetadataKeys.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.ads.admanager.v1.ICmsMetadataKey[] = [];
      const iterable = client.listCmsMetadataKeysAsync(request);
