  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = cmsmetadatakeyserviceModule.v1.CmsMetadataKeyServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = cmsmetadatakeyserviceModule.v1.CmsMetadataKeyServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new cmsmetadatakeyserviceModule.v1.CmsMetadataKeyServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new cmsmetadatakeyserviceModule.v1.CmsMetadataKeyServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new cmsmetadatakeyserviceModule.v1.CmsMetadataKeyServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new cmsmetadatakeyserviceModule.v1.CmsMetadataKeyServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = cmsmetadatakeyserviceModule.v1.CmsMetadataKeyServiceClient.port;
            assert(port);
    ...
    describe('getCmsMetadataKey', () => {
        it('invokes getCmsMetadataKey without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetCmsMetadataKeyRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getCmsMetadataKey as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getCmsMetadataKey as SinonStub)
        ...
        it('invokes getCmsMetadataKey without error using callback', async () => {
            ...
            client.innerApiCalls.getCmsMetadataKey = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCmsMetadataKey(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.ICmsMetadataKey|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCmsMetadataKey with error', async () => {
            ...
            client.innerApiCalls.getCmsMetadataKey = stubSimpleCall(undefined, expectedError);
    ...
    describe('listCmsMetadataKeys', () => {
        it('invokes listCmsMetadataKeys without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListCmsMetadataKeysRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.CmsMetadataKey()),
              generateSampleMessage(new protos.google.ads.admanager.v1.CmsMetadataKey()),
              generateSampleMessage(new protos.google.ads.admanager.v1.CmsMetadataKey()),
            ];
            client.innerApiCalls.listCmsMetadataKeys = stubSimpleCall(expectedResponse);
            const [response] = await client.listCmsMetadataKeys(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listCmsMetadataKeys as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listCmsMetadataKeys as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listCmsMetadataKeys without error using callback', async () => {
            ...
            client.innerApiCalls.listCmsMetadataKeys = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listCmsMetadataKeys with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listCmsMetadataKeys = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listCmsMetadataKeysStream without error', async () => {
            ...
            client.descriptors.page.listCmsMetadataKeys.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listCmsMetadataKeysStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.CmsMetadataKey[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.CmsMetadataKey) => {
            ...
            assert((client.descriptors.page.listCmsMetadataKeys.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listCmsMetadataKeys, request));
            assert(
        ...
        it('invokes listCmsMetadataKeysStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listCmsMetadataKeys.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listCmsMetadataKeysStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.CmsMetadataKey[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.CmsMetadataKey) => {
        ...
        it('uses async iteration with listCmsMetadataKeys without error', async () => {
            ...
            client.descriptors.page.listCmsMetadataKeys.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listCmsMetadataKeys with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listCmsMetadataKeys.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listCmsMetadataKeysAsync(request);
