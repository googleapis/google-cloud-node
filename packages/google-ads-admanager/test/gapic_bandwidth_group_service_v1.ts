...
describe('v1.BandwidthGroupServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new bandwidthgroupserviceModule.v1.BandwidthGroupServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = bandwidthgroupserviceModule.v1.BandwidthGroupServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = bandwidthgroupserviceModule.v1.BandwidthGroupServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new bandwidthgroupserviceModule.v1.BandwidthGroupServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new bandwidthgroupserviceModule.v1.BandwidthGroupServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new bandwidthgroupserviceModule.v1.BandwidthGroupServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new bandwidthgroupserviceModule.v1.BandwidthGroupServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = bandwidthgroupserviceModule.v1.BandwidthGroupServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.bandwidthGroupServiceStub, undefined);
    ...
    describe('getBandwidthGroup', () => {
        it('invokes getBandwidthGroup without error', async () => {
            const client = new bandwidthgroupserviceModule.v1.BandwidthGroupServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.GetBandwidthGroupRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetBandwidthGroupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.BandwidthGroup()
            );
            client.innerApiCalls.getBandwidthGroup = stubSimpleCall(expectedResponse);
            const [response] = await client.getBandwidthGroup(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getBandwidthGroup as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getBandwidthGroup as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getBandwidthGroup without error using callback', async () => {
            const client = new bandwidthgroupserviceModule.v1.BandwidthGroupServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getBandwidthGroup = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getBandwidthGroup(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IBandwidthGroup|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getBandwidthGroup with error', async () => {
            const client = new bandwidthgroupserviceModule.v1.BandwidthGroupServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getBandwidthGroup = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes getBandwidthGroup with closed client', async () => {
            const client = new bandwidthgroupserviceModule.v1.BandwidthGroupServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('listBandwidthGroups', () => {
        it('invokes listBandwidthGroups without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.ListBandwidthGroupsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListBandwidthGroupsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.BandwidthGroup()),
              generateSampleMessage(new protos.google.ads.admanager.v1.BandwidthGroup()),
              generateSampleMessage(new protos.google.ads.admanager.v1.BandwidthGroup()),
            ];
            client.innerApiCalls.listBandwidthGroups = stubSimpleCall(expectedResponse);
            const [response] = await client.listBandwidthGroups(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listBandwidthGroups as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listBandwidthGroups as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listBandwidthGroups without error using callback', async () => {
            ...
            client.innerApiCalls.listBandwidthGroups = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listBandwidthGroups(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IBandwidthGroup[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listBandwidthGroups with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listBandwidthGroups = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listBandwidthGroups(request), expectedError);
            const actualRequest = (client.innerApiCalls.listBandwidthGroups as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listBandwidthGroups as SinonStub)
        ...
        it('invokes listBandwidthGroupsStream without error', async () => {
            ...
            client.descriptors.page.listBandwidthGroups.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listBandwidthGroupsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.BandwidthGroup[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.BandwidthGroup) => {
            ...
            assert((client.descriptors.page.listBandwidthGroups.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listBandwidthGroups, request));
            assert(
        ...
        it('invokes listBandwidthGroupsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listBandwidthGroups.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listBandwidthGroupsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.BandwidthGroup[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.BandwidthGroup) => {
        ...
        it('uses async iteration with listBandwidthGroups without error', async () => {
            const client = new bandwidthgroupserviceModule.v1.BandwidthGroupServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listBandwidthGroups.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.admanager.v1.IBandwidthGroup[] = [];
            const iterable = client.listBandwidthGroupsAsync(request);
        ...
        it('uses async iteration with listBandwidthGroups with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listBandwidthGroups.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listBandwidthGroupsAsync(request);
