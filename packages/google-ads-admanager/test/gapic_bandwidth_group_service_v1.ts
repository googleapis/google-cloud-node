...
describe('v1.BandwidthGroupServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          bandwidthgroupserviceModule.v1.BandwidthGroupServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        bandwidthgroupserviceModule.v1.BandwidthGroupServiceClient.port;
      assert(port);
  ...
  describe('getBandwidthGroup', () => {
    it('invokes getBandwidthGroup without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getBandwidthGroup as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getBandwidthGroup without error using callback', async () => {
      ...
      client.innerApiCalls.getBandwidthGroup =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getBandwidthGroup(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBandwidthGroup | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getBandwidthGroup with error', async () => {
      ...
      client.innerApiCalls.getBandwidthGroup = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listBandwidthGroups', () => {
    it('invokes listBandwidthGroups without error', async () => {
      ...
      client.innerApiCalls.listBandwidthGroups =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listBandwidthGroups(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listBandwidthGroups as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listBandwidthGroups as SinonStub
    ...
    it('invokes listBandwidthGroups with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listBandwidthGroups = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listBandwidthGroupsStream without error', async () => {
      ...
      client.descriptors.page.listBandwidthGroups.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.BandwidthGroup) => {
      ...
      assert(
        (client.descriptors.page.listBandwidthGroups.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listBandwidthGroups, request),
      );
      assert(
        (client.descriptors.page.listBandwidthGroups.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listBandwidthGroups without error', async () => {
      ...
      client.descriptors.page.listBandwidthGroups.asyncIterate =
