...
describe('v1.MobileDeviceServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = mobiledeviceserviceModule.v1.MobileDeviceServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = mobiledeviceserviceModule.v1.MobileDeviceServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new mobiledeviceserviceModule.v1.MobileDeviceServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new mobiledeviceserviceModule.v1.MobileDeviceServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new mobiledeviceserviceModule.v1.MobileDeviceServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new mobiledeviceserviceModule.v1.MobileDeviceServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = mobiledeviceserviceModule.v1.MobileDeviceServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.mobileDeviceServiceStub, undefined);
    ...
    describe('getMobileDevice', () => {
        it('invokes getMobileDevice without error', async () => {
            const client = new mobiledeviceserviceModule.v1.MobileDeviceServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.GetMobileDeviceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetMobileDeviceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.MobileDevice()
            );
            client.innerApiCalls.getMobileDevice = stubSimpleCall(expectedResponse);
            const [response] = await client.getMobileDevice(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getMobileDevice as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getMobileDevice as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getMobileDevice without error using callback', async () => {
            const client = new mobiledeviceserviceModule.v1.MobileDeviceServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getMobileDevice = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getMobileDevice(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IMobileDevice|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getMobileDevice with error', async () => {
            const client = new mobiledeviceserviceModule.v1.MobileDeviceServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getMobileDevice = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes getMobileDevice with closed client', async () => {
            const client = new mobiledeviceserviceModule.v1.MobileDeviceServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('listMobileDevices', () => {
        it('invokes listMobileDevices without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.ListMobileDevicesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListMobileDevicesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.MobileDevice()),
              generateSampleMessage(new protos.google.ads.admanager.v1.MobileDevice()),
              generateSampleMessage(new protos.google.ads.admanager.v1.MobileDevice()),
            ];
            client.innerApiCalls.listMobileDevices = stubSimpleCall(expectedResponse);
            const [response] = await client.listMobileDevices(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listMobileDevices as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listMobileDevices as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listMobileDevices without error using callback', async () => {
            ...
            client.innerApiCalls.listMobileDevices = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listMobileDevices(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IMobileDevice[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listMobileDevices with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listMobileDevices = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listMobileDevices(request), expectedError);
            const actualRequest = (client.innerApiCalls.listMobileDevices as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listMobileDevices as SinonStub)
        ...
        it('invokes listMobileDevicesStream without error', async () => {
            ...
            client.descriptors.page.listMobileDevices.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listMobileDevicesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.MobileDevice[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.MobileDevice) => {
            ...
            assert((client.descriptors.page.listMobileDevices.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listMobileDevices, request));
            assert(
        ...
        it('invokes listMobileDevicesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listMobileDevices.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listMobileDevicesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.MobileDevice[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.MobileDevice) => {
        ...
        it('uses async iteration with listMobileDevices without error', async () => {
            const client = new mobiledeviceserviceModule.v1.MobileDeviceServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listMobileDevices.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.admanager.v1.IMobileDevice[] = [];
            const iterable = client.listMobileDevicesAsync(request);
        ...
        it('uses async iteration with listMobileDevices with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listMobileDevices.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listMobileDevicesAsync(request);
