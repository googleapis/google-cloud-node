...
describe('v1.MobileDeviceServiceClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new mobiledeviceserviceModule.v1.MobileDeviceServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          mobiledeviceserviceModule.v1.MobileDeviceServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          mobiledeviceserviceModule.v1.MobileDeviceServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
  ...
  describe('getMobileDevice', () => {
    it('invokes getMobileDevice without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getMobileDevice as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getMobileDevice without error using callback', async () => {
      ...
      client.innerApiCalls.getMobileDevice =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getMobileDevice(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IMobileDevice | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getMobileDevice with error', async () => {
      ...
      client.innerApiCalls.getMobileDevice = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listMobileDevices', () => {
    it('invokes listMobileDevices without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listMobileDevices as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listMobileDevices as SinonStub
    ...
    it('invokes listMobileDevices without error using callback', async () => {
      ...
      client.innerApiCalls.listMobileDevices =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listMobileDevices with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listMobileDevices = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listMobileDevicesStream without error', async () => {
      ...
      client.descriptors.page.listMobileDevices.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.MobileDevice) => {
      ...
      assert(
        (client.descriptors.page.listMobileDevices.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listMobileDevices, request),
      );
      assert(
        (client.descriptors.page.listMobileDevices.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listMobileDevices without error', async () => {
      ...
      client.descriptors.page.listMobileDevices.asyncIterate =
