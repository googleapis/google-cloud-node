    ...
    describe('fetchReportResultRows', () => {
        it('invokes fetchReportResultRows without error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.ReportDataTable.Row()),
              generateSampleMessage(new protos.google.ads.admanager.v1.ReportDataTable.Row()),
              generateSampleMessage(new protos.google.ads.admanager.v1.ReportDataTable.Row()),
            ];
        ...
        it('invokes fetchReportResultRows without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.fetchReportResultRows(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.ReportDataTable.IRow[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes fetchReportResultRowsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.ReportDataTable.Row[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.ReportDataTable.Row) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with fetchReportResultRows without error', async () => {
            ...
            const responses: protos.google.ads.admanager.v1.ReportDataTable.IRow[] = [];
