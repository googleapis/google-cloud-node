...
describe('v1.LabelServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          labelserviceModule.v1.LabelServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          labelserviceModule.v1.LabelServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new labelserviceModule.v1.LabelServiceClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = labelserviceModule.v1.LabelServiceClient.port;
      assert(port);
  ...
  describe('getLabel', () => {
    it('invokes getLabel without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.GetLabelRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.GetLabelRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.Label(),
      );
      client.innerApiCalls.getLabel = stubSimpleCall(expectedResponse);
      const [response] = await client.getLabel(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getLabel as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getLabel without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getLabel(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.ILabel | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getLabel with closed client', async () => {
      const client = new labelserviceModule.v1.LabelServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('createLabel', () => {
    it('invokes createLabel without error', async () => {
      const client = new labelserviceModule.v1.LabelServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.CreateLabelRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.createLabel = stubSimpleCall(expectedResponse);
      const [response] = await client.createLabel(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createLabel as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createLabel as SinonStub
    ...
    it('invokes createLabel without error using callback', async () => {
      const client = new labelserviceModule.v1.LabelServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.createLabel =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createLabel(
          request,
    ...
    it('invokes createLabel with error', async () => {
      const client = new labelserviceModule.v1.LabelServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createLabel = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes createLabel with closed client', async () => {
      const client = new labelserviceModule.v1.LabelServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchCreateLabels', () => {
    it('invokes batchCreateLabels without error', async () => {
      const client = new labelserviceModule.v1.LabelServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchCreateLabelsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchCreateLabelsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchCreateLabelsResponse(),
      );
      client.innerApiCalls.batchCreateLabels = stubSimpleCall(expectedResponse);
      const [response] = await client.batchCreateLabels(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchCreateLabels as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchCreateLabels as SinonStub
    ...
    it('invokes batchCreateLabels without error using callback', async () => {
      const client = new labelserviceModule.v1.LabelServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchCreateLabels =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchCreateLabels(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchCreateLabelsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchCreateLabels with error', async () => {
      const client = new labelserviceModule.v1.LabelServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchCreateLabels = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes batchCreateLabels with closed client', async () => {
      const client = new labelserviceModule.v1.LabelServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('updateLabel', () => {
    it('invokes updateLabel without error', async () => {
      const client = new labelserviceModule.v1.LabelServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.UpdateLabelRequest(),
      );
      request.label ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.UpdateLabelRequest',
        ['label', 'name'],
      );
      request.label.name = defaultValue1;
      const expectedHeaderRequestParams = `label.name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.Label(),
      );
      client.innerApiCalls.updateLabel = stubSimpleCall(expectedResponse);
      const [response] = await client.updateLabel(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateLabel as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateLabel as SinonStub
    ...
    it('invokes updateLabel without error using callback', async () => {
      const client = new labelserviceModule.v1.LabelServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.updateLabel =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.updateLabel(
          request,
    ...
    it('invokes updateLabel with error', async () => {
      const client = new labelserviceModule.v1.LabelServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `label.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateLabel = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes updateLabel with closed client', async () => {
      const client = new labelserviceModule.v1.LabelServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchUpdateLabels', () => {
    it('invokes batchUpdateLabels without error', async () => {
      const client = new labelserviceModule.v1.LabelServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUpdateLabelsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUpdateLabelsResponse(),
      );
      client.innerApiCalls.batchUpdateLabels = stubSimpleCall(expectedResponse);
      const [response] = await client.batchUpdateLabels(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchUpdateLabels as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchUpdateLabels as SinonStub
    ...
    it('invokes batchUpdateLabels without error using callback', async () => {
      const client = new labelserviceModule.v1.LabelServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchUpdateLabels =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchUpdateLabels(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchUpdateLabelsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchUpdateLabels with error', async () => {
      const client = new labelserviceModule.v1.LabelServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchUpdateLabels = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes batchUpdateLabels with closed client', async () => {
      const client = new labelserviceModule.v1.LabelServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchActivateLabels', () => {
    it('invokes batchActivateLabels without error', async () => {
      const client = new labelserviceModule.v1.LabelServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchActivateLabelsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchActivateLabelsResponse(),
      );
      client.innerApiCalls.batchActivateLabels =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchActivateLabels(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchActivateLabels as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchActivateLabels as SinonStub
    ...
    it('invokes batchActivateLabels without error using callback', async () => {
      const client = new labelserviceModule.v1.LabelServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchActivateLabels =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchActivateLabels(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchActivateLabelsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchActivateLabels with error', async () => {
      const client = new labelserviceModule.v1.LabelServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchActivateLabels = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes batchActivateLabels with closed client', async () => {
      const client = new labelserviceModule.v1.LabelServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchDeactivateLabels', () => {
    it('invokes batchDeactivateLabels without error', async () => {
      const client = new labelserviceModule.v1.LabelServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchDeactivateLabelsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchDeactivateLabelsResponse(),
      );
      client.innerApiCalls.batchDeactivateLabels =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchDeactivateLabels(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchDeactivateLabels as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchDeactivateLabels as SinonStub
    ...
    it('invokes batchDeactivateLabels without error using callback', async () => {
      const client = new labelserviceModule.v1.LabelServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchDeactivateLabels =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchDeactivateLabels(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchDeactivateLabelsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchDeactivateLabels with error', async () => {
      const client = new labelserviceModule.v1.LabelServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchDeactivateLabels = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchDeactivateLabels(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchDeactivateLabels as SinonStub
    ...
    it('invokes batchDeactivateLabels with closed client', async () => {
      const client = new labelserviceModule.v1.LabelServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('listLabels', () => {
    it('invokes listLabels without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.ListLabelsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedResponse = [
        generateSampleMessage(new protos.google.ads.admanager.v1.Label()),
        generateSampleMessage(new protos.google.ads.admanager.v1.Label()),
        generateSampleMessage(new protos.google.ads.admanager.v1.Label()),
      ];
      client.innerApiCalls.listLabels = stubSimpleCall(expectedResponse);
      const [response] = await client.listLabels(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listLabels as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listLabels as SinonStub
    ...
    it('invokes listLabels without error using callback', async () => {
      ...
      client.innerApiCalls.listLabels =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listLabels(
          request,
    ...
    it('invokes listLabels with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listLabels = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.listLabels(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.listLabels as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes listLabelsStream without error', async () => {
      ...
      client.descriptors.page.listLabels.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listLabelsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.ads.admanager.v1.Label[] = [];
        stream.on('data', (response: protos.google.ads.admanager.v1.Label) => {
      ...
      assert(
        (client.descriptors.page.listLabels.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listLabels, request),
      );
      assert(
        (client.descriptors.page.listLabels.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listLabelsStream with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listLabels.createStream = stubPageStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.listLabelsStream(request);
    ...
    it('uses async iteration with listLabels without error', async () => {
      const client = new labelserviceModule.v1.LabelServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.descriptors.page.listLabels.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.ads.admanager.v1.ILabel[] = [];
      const iterable = client.listLabelsAsync(request);
      for await (const resource of iterable) {
        responses.push(resource!);
      }
      assert.deepStrictEqual(responses, expectedResponse);
      assert.deepStrictEqual(
        (client.descriptors.page.listLabels.asyncIterate as SinonStub).getCall(
          0,
        ).args[1],
        request,
      );
    ...
    it('uses async iteration with listLabels with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listLabels.asyncIterate = stubAsyncIterationCall(
        undefined,
        expectedError,
      );
      const iterable = client.listLabelsAsync(request);
