...
describe('v1.LineItemServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = lineitemserviceModule.v1.LineItemServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = lineitemserviceModule.v1.LineItemServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new lineitemserviceModule.v1.LineItemServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new lineitemserviceModule.v1.LineItemServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new lineitemserviceModule.v1.LineItemServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new lineitemserviceModule.v1.LineItemServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = lineitemserviceModule.v1.LineItemServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.lineItemServiceStub, undefined);
    ...
    describe('getLineItem', () => {
        it('invokes getLineItem without error', async () => {
            const client = new lineitemserviceModule.v1.LineItemServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.GetLineItemRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetLineItemRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.LineItem()
            );
            client.innerApiCalls.getLineItem = stubSimpleCall(expectedResponse);
            const [response] = await client.getLineItem(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getLineItem as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getLineItem as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getLineItem without error using callback', async () => {
            const client = new lineitemserviceModule.v1.LineItemServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getLineItem = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getLineItem(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.ILineItem|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getLineItem with error', async () => {
            const client = new lineitemserviceModule.v1.LineItemServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getLineItem = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes getLineItem with closed client', async () => {
            const client = new lineitemserviceModule.v1.LineItemServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('listLineItems', () => {
        it('invokes listLineItems without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.ListLineItemsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListLineItemsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.LineItem()),
              generateSampleMessage(new protos.google.ads.admanager.v1.LineItem()),
              generateSampleMessage(new protos.google.ads.admanager.v1.LineItem()),
            ];
            client.innerApiCalls.listLineItems = stubSimpleCall(expectedResponse);
            const [response] = await client.listLineItems(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listLineItems as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listLineItems as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listLineItems without error using callback', async () => {
            ...
            client.innerApiCalls.listLineItems = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listLineItems with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listLineItems = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listLineItems(request), expectedError);
            const actualRequest = (client.innerApiCalls.listLineItems as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listLineItems as SinonStub)
        ...
        it('invokes listLineItemsStream without error', async () => {
            ...
            client.descriptors.page.listLineItems.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listLineItemsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.LineItem[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.LineItem) => {
            ...
            assert((client.descriptors.page.listLineItems.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listLineItems, request));
            assert(
        ...
        it('invokes listLineItemsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listLineItems.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listLineItemsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.LineItem[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.LineItem) => {
        ...
        it('uses async iteration with listLineItems without error', async () => {
            const client = new lineitemserviceModule.v1.LineItemServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listLineItems.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.admanager.v1.ILineItem[] = [];
            const iterable = client.listLineItemsAsync(request);
        ...
        it('uses async iteration with listLineItems with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listLineItems.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listLineItemsAsync(request);
