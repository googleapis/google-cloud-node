...
describe('v1.LineItemServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          lineitemserviceModule.v1.LineItemServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          lineitemserviceModule.v1.LineItemServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new lineitemserviceModule.v1.LineItemServiceClient({
          universe_domain: 'example.com',
  ...
  describe('getLineItem', () => {
    it('invokes getLineItem without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getLineItem as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getLineItem without error using callback', async () => {
      ...
      client.innerApiCalls.getLineItem =
    ...
    it('invokes getLineItem with error', async () => {
      ...
      client.innerApiCalls.getLineItem = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listLineItems', () => {
    it('invokes listLineItems without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listLineItems as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listLineItems as SinonStub
    ...
    it('invokes listLineItems with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listLineItems = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listLineItemsStream without error', async () => {
      ...
      client.descriptors.page.listLineItems.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.LineItem) => {
      ...
      assert(
        (client.descriptors.page.listLineItems.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listLineItems, request),
      );
      assert(
        (client.descriptors.page.listLineItems.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listLineItems without error', async () => {
      ...
      client.descriptors.page.listLineItems.asyncIterate =
