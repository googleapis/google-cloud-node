...
describe('v1.ContentServiceClient', () => {
  ...
  describe('getContent', () => {
    it('invokes getContent without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.GetContentRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.GetContentRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.Content(),
      );
    ...
    it('invokes getContent without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getContent(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IContent | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listContent', () => {
    it('invokes listContent without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.ListContentRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedResponse = [
        generateSampleMessage(new protos.google.ads.admanager.v1.Content()),
        generateSampleMessage(new protos.google.ads.admanager.v1.Content()),
        generateSampleMessage(new protos.google.ads.admanager.v1.Content()),
      ];
    ...
    it('invokes listContentStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.ads.admanager.v1.Content[] = [];
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.Content) => {
    ...
    it('uses async iteration with listContent without error', async () => {
      ...
      const responses: protos.google.ads.admanager.v1.IContent[] = [];
