...
describe('v1.OperatingSystemVersionServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          operatingsystemversionserviceModule.v1
            .OperatingSystemVersionServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        ...
        const apiEndpoint =
          operatingsystemversionserviceModule.v1
            .OperatingSystemVersionServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        operatingsystemversionserviceModule.v1
          .OperatingSystemVersionServiceClient.port;
      assert(port);
  ...
  describe('getOperatingSystemVersion', () => {
    it('invokes getOperatingSystemVersion without error', async () => {
      ...
      client.innerApiCalls.getOperatingSystemVersion =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getOperatingSystemVersion(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getOperatingSystemVersion as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getOperatingSystemVersion without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getOperatingSystemVersion(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IOperatingSystemVersion | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getOperatingSystemVersion with error', async () => {
      ...
      client.innerApiCalls.getOperatingSystemVersion = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getOperatingSystemVersion(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getOperatingSystemVersion as SinonStub
  ...
  describe('listOperatingSystemVersions', () => {
    it('invokes listOperatingSystemVersions without error', async () => {
      ...
      client.innerApiCalls.listOperatingSystemVersions =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listOperatingSystemVersions(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listOperatingSystemVersions as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listOperatingSystemVersions as SinonStub
    ...
    it('invokes listOperatingSystemVersions with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listOperatingSystemVersions = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listOperatingSystemVersions(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listOperatingSystemVersions as SinonStub
    ...
    it('invokes listOperatingSystemVersionsStream without error', async () => {
      ...
      client.descriptors.page.listOperatingSystemVersions.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.OperatingSystemVersion) => {
      ...
      assert(
        (
          client.descriptors.page.listOperatingSystemVersions
    ...
    it('uses async iteration with listOperatingSystemVersions without error', async () => {
      ...
      client.descriptors.page.listOperatingSystemVersions.asyncIterate =
