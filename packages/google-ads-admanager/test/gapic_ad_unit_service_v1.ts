...
describe('v1.AdUnitServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          adunitserviceModule.v1.AdUnitServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          adunitserviceModule.v1.AdUnitServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new adunitserviceModule.v1.AdUnitServiceClient({
          universe_domain: 'example.com',
  ...
  describe('getAdUnit', () => {
    it('invokes getAdUnit without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getAdUnit as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getAdUnit without error using callback', async () => {
      ...
      client.innerApiCalls.getAdUnit =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getAdUnit(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IAdUnit | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createAdUnit', () => {
    it('invokes createAdUnit without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.CreateAdUnitRequest',
        ['parent'],
      );
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createAdUnit as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createAdUnit as SinonStub
    ...
    it('invokes createAdUnit without error using callback', async () => {
      ...
      client.innerApiCalls.createAdUnit =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createAdUnit(
          request,
    ...
    it('invokes createAdUnit with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createAdUnit = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateAdUnit', () => {
    it('invokes updateAdUnit without error', async () => {
      ...
      request.adUnit ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.UpdateAdUnitRequest',
        ['adUnit', 'name'],
      );
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateAdUnit as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateAdUnit as SinonStub
    ...
    it('invokes updateAdUnit without error using callback', async () => {
      ...
      client.innerApiCalls.updateAdUnit =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.updateAdUnit(
          request,
    ...
    it('invokes updateAdUnit with error', async () => {
      ...
      const expectedHeaderRequestParams = `ad_unit.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateAdUnit = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('batchCreateAdUnits', () => {
    it('invokes batchCreateAdUnits without error', async () => {
      ...
      client.innerApiCalls.batchCreateAdUnits =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchCreateAdUnits(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchCreateAdUnits as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchCreateAdUnits as SinonStub
    ...
    it('invokes batchCreateAdUnits without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchCreateAdUnits(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchCreateAdUnitsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchCreateAdUnits with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchCreateAdUnits = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('batchUpdateAdUnits', () => {
    it('invokes batchUpdateAdUnits without error', async () => {
      ...
      client.innerApiCalls.batchUpdateAdUnits =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchUpdateAdUnits(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchUpdateAdUnits as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchUpdateAdUnits as SinonStub
    ...
    it('invokes batchUpdateAdUnits without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchUpdateAdUnits(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchUpdateAdUnitsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchUpdateAdUnits with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchUpdateAdUnits = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('batchActivateAdUnits', () => {
    it('invokes batchActivateAdUnits without error', async () => {
      ...
      client.innerApiCalls.batchActivateAdUnits =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchActivateAdUnits(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchActivateAdUnits as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchActivateAdUnits as SinonStub
    ...
    it('invokes batchActivateAdUnits without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchActivateAdUnits(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchActivateAdUnitsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchActivateAdUnits with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchActivateAdUnits = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('batchDeactivateAdUnits', () => {
    it('invokes batchDeactivateAdUnits without error', async () => {
      ...
      client.innerApiCalls.batchDeactivateAdUnits =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchDeactivateAdUnits(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchDeactivateAdUnits as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchDeactivateAdUnits as SinonStub
    ...
    it('invokes batchDeactivateAdUnits without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchDeactivateAdUnits(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchDeactivateAdUnitsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchDeactivateAdUnits with error', async () => {
      ...
      await assert.rejects(
        client.batchDeactivateAdUnits(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchDeactivateAdUnits as SinonStub
  ...
  describe('batchArchiveAdUnits', () => {
    it('invokes batchArchiveAdUnits without error', async () => {
      ...
      client.innerApiCalls.batchArchiveAdUnits =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchArchiveAdUnits(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchArchiveAdUnits as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchArchiveAdUnits as SinonStub
    ...
    it('invokes batchArchiveAdUnits without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchArchiveAdUnits(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchArchiveAdUnitsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchArchiveAdUnits with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchArchiveAdUnits = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listAdUnits', () => {
    it('invokes listAdUnits without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listAdUnits as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listAdUnits as SinonStub
    ...
    it('invokes listAdUnits without error using callback', async () => {
      ...
      client.innerApiCalls.listAdUnits =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listAdUnits(
          request,
    ...
    it('invokes listAdUnitsStream without error', async () => {
      ...
      client.descriptors.page.listAdUnits.createStream =
      ...
      assert(
        (client.descriptors.page.listAdUnits.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listAdUnits, request),
      );
      assert(
        (client.descriptors.page.listAdUnits.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listAdUnits without error', async () => {
      ...
      client.descriptors.page.listAdUnits.asyncIterate =
      ...
      assert.deepStrictEqual(
        (client.descriptors.page.listAdUnits.asyncIterate as SinonStub).getCall(
          0,
        ).args[1],
        request,
      );
  ...
  describe('listAdUnitSizes', () => {
    it('invokes listAdUnitSizes without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listAdUnitSizes as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listAdUnitSizes as SinonStub
    ...
    it('invokes listAdUnitSizes without error using callback', async () => {
      ...
      client.innerApiCalls.listAdUnitSizes =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listAdUnitSizes(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IAdUnitSize[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listAdUnitSizesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.AdUnitSize) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listAdUnitSizes.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listAdUnitSizes, request),
      );
      assert(
        (client.descriptors.page.listAdUnitSizes.createStream as SinonStub)
          .getCall(0)
