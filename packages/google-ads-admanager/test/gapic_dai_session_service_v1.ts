...
import * as daisessionserviceModule from '../src';
...
describe('v1.DaiSessionServiceClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client = new daisessionserviceModule.v1.DaiSessionServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          daisessionserviceModule.v1.DaiSessionServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          daisessionserviceModule.v1.DaiSessionServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new daisessionserviceModule.v1.DaiSessionServiceClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'admanager.example.com');
          if (saved) {
    ...
    it('has port', () => {
      const port = daisessionserviceModule.v1.DaiSessionServiceClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.daiSessionServiceStub, undefined);
      await client.initialize();
      assert(client.daiSessionServiceStub);
    });
  ...
  describe('getDaiSession', () => {
    it('invokes getDaiSession without error', async () => {
      const client = new daisessionserviceModule.v1.DaiSessionServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.GetDaiSessionRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.GetDaiSessionRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.DaiSession(),
      );
      client.innerApiCalls.getDaiSession = stubSimpleCall(expectedResponse);
      const [response] = await client.getDaiSession(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getDaiSession as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getDaiSession without error using callback', async () => {
      const client = new daisessionserviceModule.v1.DaiSessionServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.getDaiSession =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getDaiSession(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IDaiSession | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getDaiSession with error', async () => {
      const client = new daisessionserviceModule.v1.DaiSessionServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.getDaiSession = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.getDaiSession(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.getDaiSession as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes getDaiSession with closed client', async () => {
      const client = new daisessionserviceModule.v1.DaiSessionServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
