...
import * as privateauctiondealserviceModule from '../src';
...
describe('v1.PrivateAuctionDealServiceClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.privateAuctionDealServiceStub, undefined);
      await client.initialize();
      assert(client.privateAuctionDealServiceStub);
    });
  ...
  describe('getPrivateAuctionDeal', () => {
    it('invokes getPrivateAuctionDeal without error', async () => {
      const client =
        new privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.GetPrivateAuctionDealRequest(),
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.PrivateAuctionDeal(),
      );
      client.innerApiCalls.getPrivateAuctionDeal =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getPrivateAuctionDeal(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getPrivateAuctionDeal as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getPrivateAuctionDeal without error using callback', async () => {
      const client =
        new privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const promise = new Promise((resolve, reject) => {
        client.getPrivateAuctionDeal(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IPrivateAuctionDeal | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getPrivateAuctionDeal with error', async () => {
      const client =
        new privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.getPrivateAuctionDeal = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getPrivateAuctionDeal(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getPrivateAuctionDeal as SinonStub
    ...
    it('invokes getPrivateAuctionDeal with closed client', async () => {
      const client =
        new privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('createPrivateAuctionDeal', () => {
    it('invokes createPrivateAuctionDeal without error', async () => {
      const client =
        new privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.CreatePrivateAuctionDealRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.createPrivateAuctionDeal =
        stubSimpleCall(expectedResponse);
      const [response] = await client.createPrivateAuctionDeal(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createPrivateAuctionDeal as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createPrivateAuctionDeal as SinonStub
    ...
    it('invokes createPrivateAuctionDeal without error using callback', async () => {
      const client =
        new privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.createPrivateAuctionDeal =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createPrivateAuctionDeal(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IPrivateAuctionDeal | null,
    ...
    it('invokes createPrivateAuctionDeal with error', async () => {
      const client =
        new privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createPrivateAuctionDeal = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createPrivateAuctionDeal(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createPrivateAuctionDeal as SinonStub
    ...
    it('invokes createPrivateAuctionDeal with closed client', async () => {
      const client =
        new privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('updatePrivateAuctionDeal', () => {
    it('invokes updatePrivateAuctionDeal without error', async () => {
      const client =
        new privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.UpdatePrivateAuctionDealRequest(),
      );
      request.privateAuctionDeal ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.UpdatePrivateAuctionDealRequest',
        ['privateAuctionDeal', 'name'],
      );
      request.privateAuctionDeal.name = defaultValue1;
      const expectedHeaderRequestParams = `private_auction_deal.name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.PrivateAuctionDeal(),
      );
      client.innerApiCalls.updatePrivateAuctionDeal =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updatePrivateAuctionDeal(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updatePrivateAuctionDeal as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updatePrivateAuctionDeal as SinonStub
    ...
    it('invokes updatePrivateAuctionDeal without error using callback', async () => {
      const client =
        new privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.updatePrivateAuctionDeal =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.updatePrivateAuctionDeal(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IPrivateAuctionDeal | null,
    ...
    it('invokes updatePrivateAuctionDeal with error', async () => {
      const client =
        new privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `private_auction_deal.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updatePrivateAuctionDeal = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updatePrivateAuctionDeal(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updatePrivateAuctionDeal as SinonStub
    ...
    it('invokes updatePrivateAuctionDeal with closed client', async () => {
      const client =
        new privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('listPrivateAuctionDeals', () => {
    it('invokes listPrivateAuctionDeals without error', async () => {
      const client =
        new privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient({
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.ListPrivateAuctionDealsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.listPrivateAuctionDeals =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listPrivateAuctionDeals(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listPrivateAuctionDeals as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listPrivateAuctionDeals as SinonStub
    ...
    it('invokes listPrivateAuctionDeals without error using callback', async () => {
      const client =
        new privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient({
          credentials: { client_email: 'bogus', private_key: 'bogus' },
          projectId: 'bogus',
      ...
      client.innerApiCalls.listPrivateAuctionDeals =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listPrivateAuctionDeals(
          request,
          (
            err?: Error | null,
            result?:
    ...
    it('invokes listPrivateAuctionDeals with error', async () => {
      const client =
        new privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient({
          credentials: { client_email: 'bogus', private_key: 'bogus' },
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listPrivateAuctionDeals = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listPrivateAuctionDeals(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listPrivateAuctionDeals as SinonStub
    ...
    it('invokes listPrivateAuctionDealsStream without error', async () => {
      const client =
        new privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient({
          credentials: { client_email: 'bogus', private_key: 'bogus' },
          projectId: 'bogus',
      ...
      client.descriptors.page.listPrivateAuctionDeals.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listPrivateAuctionDealsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.ads.admanager.v1.PrivateAuctionDeal[] =
          [];
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.PrivateAuctionDeal) => {
      ...
      assert(
        (
          client.descriptors.page.listPrivateAuctionDeals
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listPrivateAuctionDeals, request),
      );
      assert(
        (
          client.descriptors.page.listPrivateAuctionDeals
    ...
    it('invokes listPrivateAuctionDealsStream with error', async () => {
      const client =
        new privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient({
          credentials: { client_email: 'bogus', private_key: 'bogus' },
          projectId: 'bogus',
    ...
    it('uses async iteration with listPrivateAuctionDeals without error', async () => {
      const client =
        new privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.descriptors.page.listPrivateAuctionDeals.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.ads.admanager.v1.IPrivateAuctionDeal[] =
        [];
      const iterable = client.listPrivateAuctionDealsAsync(request);
    ...
    it('uses async iteration with listPrivateAuctionDeals with error', async () => {
      const client =
        new privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient({
          credentials: { client_email: 'bogus', private_key: 'bogus' },
          projectId: 'bogus',
