  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = privateauctiondealserviceModule.v1.PrivateAuctionDealServiceClient.port;
            assert(port);
    ...
    describe('getPrivateAuctionDeal', () => {
        it('invokes getPrivateAuctionDeal without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetPrivateAuctionDealRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.PrivateAuctionDeal()
            );
            client.innerApiCalls.getPrivateAuctionDeal = stubSimpleCall(expectedResponse);
            const [response] = await client.getPrivateAuctionDeal(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getPrivateAuctionDeal as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getPrivateAuctionDeal as SinonStub)
        ...
        it('invokes getPrivateAuctionDeal without error using callback', async () => {
            ...
            client.innerApiCalls.getPrivateAuctionDeal = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getPrivateAuctionDeal(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IPrivateAuctionDeal|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getPrivateAuctionDeal with error', async () => {
            ...
            client.innerApiCalls.getPrivateAuctionDeal = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getPrivateAuctionDeal(request), expectedError);
            const actualRequest = (client.innerApiCalls.getPrivateAuctionDeal as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getPrivateAuctionDeal as SinonStub)
    ...
    describe('createPrivateAuctionDeal', () => {
        it('invokes createPrivateAuctionDeal without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.CreatePrivateAuctionDealRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.PrivateAuctionDeal()
            );
            client.innerApiCalls.createPrivateAuctionDeal = stubSimpleCall(expectedResponse);
            const [response] = await client.createPrivateAuctionDeal(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createPrivateAuctionDeal as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createPrivateAuctionDeal as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createPrivateAuctionDeal without error using callback', async () => {
            ...
            client.innerApiCalls.createPrivateAuctionDeal = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createPrivateAuctionDeal with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createPrivateAuctionDeal = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createPrivateAuctionDeal(request), expectedError);
            const actualRequest = (client.innerApiCalls.createPrivateAuctionDeal as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createPrivateAuctionDeal as SinonStub)
    ...
    describe('updatePrivateAuctionDeal', () => {
        it('invokes updatePrivateAuctionDeal without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.UpdatePrivateAuctionDealRequest', ['privateAuctionDeal', 'name']);
            request.privateAuctionDeal.name = defaultValue1;
            const expectedHeaderRequestParams = `private_auction_deal.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.PrivateAuctionDeal()
            );
            client.innerApiCalls.updatePrivateAuctionDeal = stubSimpleCall(expectedResponse);
            const [response] = await client.updatePrivateAuctionDeal(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updatePrivateAuctionDeal as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updatePrivateAuctionDeal as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updatePrivateAuctionDeal without error using callback', async () => {
            ...
            client.innerApiCalls.updatePrivateAuctionDeal = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updatePrivateAuctionDeal with error', async () => {
            ...
            const expectedHeaderRequestParams = `private_auction_deal.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updatePrivateAuctionDeal = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updatePrivateAuctionDeal(request), expectedError);
            const actualRequest = (client.innerApiCalls.updatePrivateAuctionDeal as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updatePrivateAuctionDeal as SinonStub)
    ...
    describe('listPrivateAuctionDeals', () => {
        it('invokes listPrivateAuctionDeals without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListPrivateAuctionDealsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.PrivateAuctionDeal()),
              generateSampleMessage(new protos.google.ads.admanager.v1.PrivateAuctionDeal()),
              generateSampleMessage(new protos.google.ads.admanager.v1.PrivateAuctionDeal()),
            ];
            client.innerApiCalls.listPrivateAuctionDeals = stubSimpleCall(expectedResponse);
            const [response] = await client.listPrivateAuctionDeals(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listPrivateAuctionDeals as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listPrivateAuctionDeals as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listPrivateAuctionDeals without error using callback', async () => {
            ...
            client.innerApiCalls.listPrivateAuctionDeals = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listPrivateAuctionDeals with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listPrivateAuctionDeals = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listPrivateAuctionDeals(request), expectedError);
            const actualRequest = (client.innerApiCalls.listPrivateAuctionDeals as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listPrivateAuctionDeals as SinonStub)
        ...
        it('invokes listPrivateAuctionDealsStream without error', async () => {
            ...
            client.descriptors.page.listPrivateAuctionDeals.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.ads.admanager.v1.PrivateAuctionDeal) => {
            ...
            assert((client.descriptors.page.listPrivateAuctionDeals.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listPrivateAuctionDeals, request));
            assert(
                (client.descriptors.page.listPrivateAuctionDeals.createStream as SinonStub)
        ...
        it('invokes listPrivateAuctionDealsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listPrivateAuctionDeals.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listPrivateAuctionDealsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.PrivateAuctionDeal[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.PrivateAuctionDeal) => {
        ...
        it('uses async iteration with listPrivateAuctionDeals without error', async () => {
            ...
            client.descriptors.page.listPrivateAuctionDeals.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(
                (client.descriptors.page.listPrivateAuctionDeals.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listPrivateAuctionDeals with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listPrivateAuctionDeals.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listPrivateAuctionDealsAsync(request);
