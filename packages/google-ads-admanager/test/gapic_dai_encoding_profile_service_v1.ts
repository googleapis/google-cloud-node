...
describe('v1.DaiEncodingProfileServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.daiEncodingProfileServiceStub, undefined);
  ...
  describe('getDaiEncodingProfile', () => {
    it('invokes getDaiEncodingProfile without error', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.GetDaiEncodingProfileRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.GetDaiEncodingProfileRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.DaiEncodingProfile(),
      );
      client.innerApiCalls.getDaiEncodingProfile =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getDaiEncodingProfile(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getDaiEncodingProfile as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getDaiEncodingProfile without error using callback', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDaiEncodingProfile(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IDaiEncodingProfile | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getDaiEncodingProfile with error', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.getDaiEncodingProfile = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getDaiEncodingProfile(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getDaiEncodingProfile as SinonStub
    ...
    it('invokes getDaiEncodingProfile with closed client', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('createDaiEncodingProfile', () => {
    it('invokes createDaiEncodingProfile without error', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.CreateDaiEncodingProfileRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.CreateDaiEncodingProfileRequest',
        ['parent'],
      );
      ...
      client.innerApiCalls.createDaiEncodingProfile =
        stubSimpleCall(expectedResponse);
      const [response] = await client.createDaiEncodingProfile(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createDaiEncodingProfile as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createDaiEncodingProfile as SinonStub
    ...
    it('invokes createDaiEncodingProfile without error using callback', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.createDaiEncodingProfile =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createDaiEncodingProfile(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IDaiEncodingProfile | null,
    ...
    it('invokes createDaiEncodingProfile with error', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createDaiEncodingProfile = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createDaiEncodingProfile(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createDaiEncodingProfile as SinonStub
    ...
    it('invokes createDaiEncodingProfile with closed client', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('batchCreateDaiEncodingProfiles', () => {
    it('invokes batchCreateDaiEncodingProfiles without error', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchCreateDaiEncodingProfilesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchCreateDaiEncodingProfilesRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchCreateDaiEncodingProfilesResponse(),
      );
      client.innerApiCalls.batchCreateDaiEncodingProfiles =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchCreateDaiEncodingProfiles(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchCreateDaiEncodingProfiles as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchCreateDaiEncodingProfiles as SinonStub
    ...
    it('invokes batchCreateDaiEncodingProfiles without error using callback', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.batchCreateDaiEncodingProfiles =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchCreateDaiEncodingProfiles(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchCreateDaiEncodingProfilesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchCreateDaiEncodingProfiles with error', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchCreateDaiEncodingProfiles = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchCreateDaiEncodingProfiles(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchCreateDaiEncodingProfiles as SinonStub
    ...
    it('invokes batchCreateDaiEncodingProfiles with closed client', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('updateDaiEncodingProfile', () => {
    it('invokes updateDaiEncodingProfile without error', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.UpdateDaiEncodingProfileRequest(),
      );
      request.daiEncodingProfile ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.UpdateDaiEncodingProfileRequest',
        ['daiEncodingProfile', 'name'],
      );
      request.daiEncodingProfile.name = defaultValue1;
      const expectedHeaderRequestParams = `dai_encoding_profile.name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.DaiEncodingProfile(),
      );
      client.innerApiCalls.updateDaiEncodingProfile =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateDaiEncodingProfile(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateDaiEncodingProfile as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateDaiEncodingProfile as SinonStub
    ...
    it('invokes updateDaiEncodingProfile without error using callback', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.updateDaiEncodingProfile =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.updateDaiEncodingProfile(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IDaiEncodingProfile | null,
    ...
    it('invokes updateDaiEncodingProfile with error', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `dai_encoding_profile.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateDaiEncodingProfile = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateDaiEncodingProfile(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateDaiEncodingProfile as SinonStub
    ...
    it('invokes updateDaiEncodingProfile with closed client', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('batchUpdateDaiEncodingProfiles', () => {
    it('invokes batchUpdateDaiEncodingProfiles without error', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUpdateDaiEncodingProfilesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchUpdateDaiEncodingProfilesRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUpdateDaiEncodingProfilesResponse(),
      );
      client.innerApiCalls.batchUpdateDaiEncodingProfiles =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchUpdateDaiEncodingProfiles(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchUpdateDaiEncodingProfiles as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchUpdateDaiEncodingProfiles as SinonStub
    ...
    it('invokes batchUpdateDaiEncodingProfiles without error using callback', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.batchUpdateDaiEncodingProfiles =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchUpdateDaiEncodingProfiles(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchUpdateDaiEncodingProfilesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchUpdateDaiEncodingProfiles with error', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchUpdateDaiEncodingProfiles = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchUpdateDaiEncodingProfiles(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchUpdateDaiEncodingProfiles as SinonStub
    ...
    it('invokes batchUpdateDaiEncodingProfiles with closed client', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('batchActivateDaiEncodingProfiles', () => {
    it('invokes batchActivateDaiEncodingProfiles without error', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchActivateDaiEncodingProfilesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchActivateDaiEncodingProfilesRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchActivateDaiEncodingProfilesResponse(),
      );
      client.innerApiCalls.batchActivateDaiEncodingProfiles =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchActivateDaiEncodingProfiles(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchActivateDaiEncodingProfiles as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchActivateDaiEncodingProfiles as SinonStub
    ...
    it('invokes batchActivateDaiEncodingProfiles without error using callback', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.batchActivateDaiEncodingProfiles =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchActivateDaiEncodingProfiles(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchActivateDaiEncodingProfilesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchActivateDaiEncodingProfiles with error', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchActivateDaiEncodingProfiles = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchActivateDaiEncodingProfiles(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchActivateDaiEncodingProfiles as SinonStub
    ...
    it('invokes batchActivateDaiEncodingProfiles with closed client', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('batchArchiveDaiEncodingProfiles', () => {
    it('invokes batchArchiveDaiEncodingProfiles without error', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchArchiveDaiEncodingProfilesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchArchiveDaiEncodingProfilesRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchArchiveDaiEncodingProfilesResponse(),
      );
      client.innerApiCalls.batchArchiveDaiEncodingProfiles =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchArchiveDaiEncodingProfiles(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchArchiveDaiEncodingProfiles as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchArchiveDaiEncodingProfiles as SinonStub
    ...
    it('invokes batchArchiveDaiEncodingProfiles without error using callback', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.batchArchiveDaiEncodingProfiles =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchArchiveDaiEncodingProfiles(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchArchiveDaiEncodingProfilesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchArchiveDaiEncodingProfiles with error', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchArchiveDaiEncodingProfiles = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchArchiveDaiEncodingProfiles(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchArchiveDaiEncodingProfiles as SinonStub
    ...
    it('invokes batchArchiveDaiEncodingProfiles with closed client', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('listDaiEncodingProfiles', () => {
    it('invokes listDaiEncodingProfiles without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.ListDaiEncodingProfilesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.ListDaiEncodingProfilesRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.listDaiEncodingProfiles =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listDaiEncodingProfiles(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listDaiEncodingProfiles as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listDaiEncodingProfiles as SinonStub
    ...
    it('invokes listDaiEncodingProfiles without error using callback', async () => {
      ...
      client.innerApiCalls.listDaiEncodingProfiles =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listDaiEncodingProfiles(
          request,
          (
            err?: Error | null,
            result?:
    ...
    it('invokes listDaiEncodingProfiles with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listDaiEncodingProfiles = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listDaiEncodingProfiles(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listDaiEncodingProfiles as SinonStub
    ...
    it('invokes listDaiEncodingProfilesStream without error', async () => {
      ...
      client.descriptors.page.listDaiEncodingProfiles.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listDaiEncodingProfilesStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.ads.admanager.v1.DaiEncodingProfile[] =
          [];
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.DaiEncodingProfile) => {
      ...
      assert(
        (
          client.descriptors.page.listDaiEncodingProfiles
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listDaiEncodingProfiles, request),
      );
      assert(
        (
          client.descriptors.page.listDaiEncodingProfiles
    ...
    it('uses async iteration with listDaiEncodingProfiles without error', async () => {
      const client =
        new daiencodingprofileserviceModule.v1.DaiEncodingProfileServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.descriptors.page.listDaiEncodingProfiles.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.ads.admanager.v1.IDaiEncodingProfile[] =
        [];
      const iterable = client.listDaiEncodingProfilesAsync(request);
