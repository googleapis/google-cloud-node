...
describe('v1.McmEarningsServiceClient', () => {
    ...
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = mcmearningsserviceModule.v1.McmEarningsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = mcmearningsserviceModule.v1.McmEarningsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new mcmearningsserviceModule.v1.McmEarningsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new mcmearningsserviceModule.v1.McmEarningsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new mcmearningsserviceModule.v1.McmEarningsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new mcmearningsserviceModule.v1.McmEarningsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = mcmearningsserviceModule.v1.McmEarningsServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.mcmEarningsServiceStub, undefined);
    ...
    describe('fetchMcmEarnings', () => {
        it('invokes fetchMcmEarnings without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.FetchMcmEarningsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.FetchMcmEarningsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.McmEarnings()),
              generateSampleMessage(new protos.google.ads.admanager.v1.McmEarnings()),
              generateSampleMessage(new protos.google.ads.admanager.v1.McmEarnings()),
            ];
            client.innerApiCalls.fetchMcmEarnings = stubSimpleCall(expectedResponse);
            const [response] = await client.fetchMcmEarnings(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.fetchMcmEarnings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.fetchMcmEarnings as SinonStub)
        ...
        it('invokes fetchMcmEarnings without error using callback', async () => {
            ...
            client.innerApiCalls.fetchMcmEarnings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.fetchMcmEarnings(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IMcmEarnings[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes fetchMcmEarnings with error', async () => {
            ...
            client.innerApiCalls.fetchMcmEarnings = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.fetchMcmEarnings(request), expectedError);
            const actualRequest = (client.innerApiCalls.fetchMcmEarnings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.fetchMcmEarnings as SinonStub)
        ...
        it('invokes fetchMcmEarningsStream without error', async () => {
            ...
            client.descriptors.page.fetchMcmEarnings.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.fetchMcmEarningsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.McmEarnings[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.McmEarnings) => {
            ...
            assert((client.descriptors.page.fetchMcmEarnings.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.fetchMcmEarnings, request));
            assert(
        ...
        it('invokes fetchMcmEarningsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.fetchMcmEarnings.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.fetchMcmEarningsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.McmEarnings[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.McmEarnings) => {
        ...
        it('uses async iteration with fetchMcmEarnings without error', async () => {
            const client = new mcmearningsserviceModule.v1.McmEarningsServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.fetchMcmEarnings.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.admanager.v1.IMcmEarnings[] = [];
            const iterable = client.fetchMcmEarningsAsync(request);
        ...
        it('uses async iteration with fetchMcmEarnings with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.fetchMcmEarnings.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.fetchMcmEarningsAsync(request);
