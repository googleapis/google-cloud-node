  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          mcmearningsserviceModule.v1.McmEarningsServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          mcmearningsserviceModule.v1.McmEarningsServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new mcmearningsserviceModule.v1.McmEarningsServiceClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'admanager.example.com');
          if (saved) {
  ...
  describe('fetchMcmEarnings', () => {
    it('invokes fetchMcmEarnings without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.FetchMcmEarningsRequest',
        ['parent'],
      );
      ...
      const actualRequest = (
        client.innerApiCalls.fetchMcmEarnings as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes fetchMcmEarnings without error using callback', async () => {
      ...
      client.innerApiCalls.fetchMcmEarnings =
      ...
      const promise = new Promise((resolve, reject) => {
        client.fetchMcmEarnings(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IMcmEarnings[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes fetchMcmEarnings with error', async () => {
      ...
      client.innerApiCalls.fetchMcmEarnings = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes fetchMcmEarningsStream without error', async () => {
      ...
      client.descriptors.page.fetchMcmEarnings.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.McmEarnings) => {
      ...
      assert(
        (client.descriptors.page.fetchMcmEarnings.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.fetchMcmEarnings, request),
      );
      assert(
        (client.descriptors.page.fetchMcmEarnings.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with fetchMcmEarnings without error', async () => {
      ...
      client.descriptors.page.fetchMcmEarnings.asyncIterate =
