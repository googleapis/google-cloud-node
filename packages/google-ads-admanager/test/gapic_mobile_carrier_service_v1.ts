...
describe('v1.MobileCarrierServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          mobilecarrierserviceModule.v1.MobileCarrierServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          mobilecarrierserviceModule.v1.MobileCarrierServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        mobilecarrierserviceModule.v1.MobileCarrierServiceClient.port;
      assert(port);
  ...
  describe('getMobileCarrier', () => {
    it('invokes getMobileCarrier without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.GetMobileCarrierRequest',
        ['name'],
      );
      ...
      const actualRequest = (
        client.innerApiCalls.getMobileCarrier as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getMobileCarrier without error using callback', async () => {
      ...
      client.innerApiCalls.getMobileCarrier =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getMobileCarrier(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IMobileCarrier | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getMobileCarrier with error', async () => {
      ...
      client.innerApiCalls.getMobileCarrier = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listMobileCarriers', () => {
    it('invokes listMobileCarriers without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.ListMobileCarriersRequest',
        ['parent'],
      );
      ...
      client.innerApiCalls.listMobileCarriers =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listMobileCarriers(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listMobileCarriers as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listMobileCarriers as SinonStub
    ...
    it('invokes listMobileCarriers with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listMobileCarriers = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listMobileCarriersStream without error', async () => {
      ...
      client.descriptors.page.listMobileCarriers.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.MobileCarrier) => {
      ...
      assert(
        (client.descriptors.page.listMobileCarriers.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listMobileCarriers, request),
      );
      assert(
        (client.descriptors.page.listMobileCarriers.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listMobileCarriers without error', async () => {
      ...
      client.descriptors.page.listMobileCarriers.asyncIterate =
