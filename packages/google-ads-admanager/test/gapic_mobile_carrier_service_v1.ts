...
describe('v1.MobileCarrierServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new mobilecarrierserviceModule.v1.MobileCarrierServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = mobilecarrierserviceModule.v1.MobileCarrierServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = mobilecarrierserviceModule.v1.MobileCarrierServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new mobilecarrierserviceModule.v1.MobileCarrierServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new mobilecarrierserviceModule.v1.MobileCarrierServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new mobilecarrierserviceModule.v1.MobileCarrierServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new mobilecarrierserviceModule.v1.MobileCarrierServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = mobilecarrierserviceModule.v1.MobileCarrierServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.mobileCarrierServiceStub, undefined);
    ...
    describe('getMobileCarrier', () => {
        it('invokes getMobileCarrier without error', async () => {
            const client = new mobilecarrierserviceModule.v1.MobileCarrierServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.GetMobileCarrierRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetMobileCarrierRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.MobileCarrier()
            );
            client.innerApiCalls.getMobileCarrier = stubSimpleCall(expectedResponse);
            const [response] = await client.getMobileCarrier(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getMobileCarrier as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getMobileCarrier as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getMobileCarrier without error using callback', async () => {
            const client = new mobilecarrierserviceModule.v1.MobileCarrierServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getMobileCarrier = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getMobileCarrier(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IMobileCarrier|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getMobileCarrier with error', async () => {
            const client = new mobilecarrierserviceModule.v1.MobileCarrierServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getMobileCarrier = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes getMobileCarrier with closed client', async () => {
            const client = new mobilecarrierserviceModule.v1.MobileCarrierServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('listMobileCarriers', () => {
        it('invokes listMobileCarriers without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.ListMobileCarriersRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListMobileCarriersRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.MobileCarrier()),
              generateSampleMessage(new protos.google.ads.admanager.v1.MobileCarrier()),
              generateSampleMessage(new protos.google.ads.admanager.v1.MobileCarrier()),
            ];
            client.innerApiCalls.listMobileCarriers = stubSimpleCall(expectedResponse);
            const [response] = await client.listMobileCarriers(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listMobileCarriers as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listMobileCarriers as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listMobileCarriers without error using callback', async () => {
            ...
            client.innerApiCalls.listMobileCarriers = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listMobileCarriers(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IMobileCarrier[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listMobileCarriers with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listMobileCarriers = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listMobileCarriers(request), expectedError);
            const actualRequest = (client.innerApiCalls.listMobileCarriers as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listMobileCarriers as SinonStub)
        ...
        it('invokes listMobileCarriersStream without error', async () => {
            ...
            client.descriptors.page.listMobileCarriers.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listMobileCarriersStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.MobileCarrier[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.MobileCarrier) => {
            ...
            assert((client.descriptors.page.listMobileCarriers.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listMobileCarriers, request));
            assert(
        ...
        it('invokes listMobileCarriersStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listMobileCarriers.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listMobileCarriersStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.MobileCarrier[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.MobileCarrier) => {
        ...
        it('uses async iteration with listMobileCarriers without error', async () => {
            const client = new mobilecarrierserviceModule.v1.MobileCarrierServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listMobileCarriers.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.admanager.v1.IMobileCarrier[] = [];
            const iterable = client.listMobileCarriersAsync(request);
        ...
        it('uses async iteration with listMobileCarriers with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listMobileCarriers.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listMobileCarriersAsync(request);
