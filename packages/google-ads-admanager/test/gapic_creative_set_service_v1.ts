...
describe('v1.CreativeSetServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          creativesetserviceModule.v1.CreativeSetServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          creativesetserviceModule.v1.CreativeSetServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new creativesetserviceModule.v1.CreativeSetServiceClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'admanager.example.com');
          if (saved) {
    ...
    it('has port', () => {
      const port = creativesetserviceModule.v1.CreativeSetServiceClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.creativeSetServiceStub, undefined);
  ...
  describe('getCreativeSet', () => {
    it('invokes getCreativeSet without error', async () => {
      const client = new creativesetserviceModule.v1.CreativeSetServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.GetCreativeSetRequest(),
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.CreativeSet(),
      );
      client.innerApiCalls.getCreativeSet = stubSimpleCall(expectedResponse);
      const [response] = await client.getCreativeSet(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getCreativeSet as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getCreativeSet without error using callback', async () => {
      const client = new creativesetserviceModule.v1.CreativeSetServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.getCreativeSet =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getCreativeSet(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.ICreativeSet | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getCreativeSet with error', async () => {
      const client = new creativesetserviceModule.v1.CreativeSetServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.getCreativeSet = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes getCreativeSet with closed client', async () => {
      const client = new creativesetserviceModule.v1.CreativeSetServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('createCreativeSet', () => {
    it('invokes createCreativeSet without error', async () => {
      const client = new creativesetserviceModule.v1.CreativeSetServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.CreateCreativeSetRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.CreateCreativeSetRequest',
        ['parent'],
      );
      ...
      client.innerApiCalls.createCreativeSet = stubSimpleCall(expectedResponse);
      const [response] = await client.createCreativeSet(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createCreativeSet as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createCreativeSet as SinonStub
    ...
    it('invokes createCreativeSet without error using callback', async () => {
      const client = new creativesetserviceModule.v1.CreativeSetServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.createCreativeSet =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createCreativeSet(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.ICreativeSet | null,
    ...
    it('invokes createCreativeSet with error', async () => {
      const client = new creativesetserviceModule.v1.CreativeSetServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createCreativeSet = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes createCreativeSet with closed client', async () => {
      const client = new creativesetserviceModule.v1.CreativeSetServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('updateCreativeSet', () => {
    it('invokes updateCreativeSet without error', async () => {
      const client = new creativesetserviceModule.v1.CreativeSetServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.UpdateCreativeSetRequest(),
      );
      request.creativeSet ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.UpdateCreativeSetRequest',
        ['creativeSet', 'name'],
      );
      request.creativeSet.name = defaultValue1;
      const expectedHeaderRequestParams = `creative_set.name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.CreativeSet(),
      );
      client.innerApiCalls.updateCreativeSet = stubSimpleCall(expectedResponse);
      const [response] = await client.updateCreativeSet(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateCreativeSet as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateCreativeSet as SinonStub
    ...
    it('invokes updateCreativeSet without error using callback', async () => {
      const client = new creativesetserviceModule.v1.CreativeSetServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.updateCreativeSet =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.updateCreativeSet(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.ICreativeSet | null,
    ...
    it('invokes updateCreativeSet with error', async () => {
      const client = new creativesetserviceModule.v1.CreativeSetServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `creative_set.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateCreativeSet = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes updateCreativeSet with closed client', async () => {
      const client = new creativesetserviceModule.v1.CreativeSetServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('listCreativeSets', () => {
    it('invokes listCreativeSets without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.ListCreativeSetsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.ListCreativeSetsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = [
        generateSampleMessage(new protos.google.ads.admanager.v1.CreativeSet()),
        generateSampleMessage(new protos.google.ads.admanager.v1.CreativeSet()),
        generateSampleMessage(new protos.google.ads.admanager.v1.CreativeSet()),
      ];
      client.innerApiCalls.listCreativeSets = stubSimpleCall(expectedResponse);
      const [response] = await client.listCreativeSets(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listCreativeSets as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listCreativeSets as SinonStub
    ...
    it('invokes listCreativeSets without error using callback', async () => {
      ...
      client.innerApiCalls.listCreativeSets =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listCreativeSets(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.ICreativeSet[] | null,
    ...
    it('invokes listCreativeSets with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listCreativeSets = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.listCreativeSets(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.listCreativeSets as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes listCreativeSetsStream without error', async () => {
      ...
      client.descriptors.page.listCreativeSets.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listCreativeSetsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.ads.admanager.v1.CreativeSet[] = [];
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.CreativeSet) => {
      ...
      assert(
        (client.descriptors.page.listCreativeSets.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listCreativeSets, request),
      );
      assert(
        (client.descriptors.page.listCreativeSets.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listCreativeSets without error', async () => {
      const client = new creativesetserviceModule.v1.CreativeSetServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.descriptors.page.listCreativeSets.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.ads.admanager.v1.ICreativeSet[] = [];
      const iterable = client.listCreativeSetsAsync(request);
