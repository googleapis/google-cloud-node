...
describe('v1.DeviceManufacturerServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new devicemanufacturerserviceModule.v1.DeviceManufacturerServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = devicemanufacturerserviceModule.v1.DeviceManufacturerServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = devicemanufacturerserviceModule.v1.DeviceManufacturerServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new devicemanufacturerserviceModule.v1.DeviceManufacturerServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new devicemanufacturerserviceModule.v1.DeviceManufacturerServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new devicemanufacturerserviceModule.v1.DeviceManufacturerServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new devicemanufacturerserviceModule.v1.DeviceManufacturerServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = devicemanufacturerserviceModule.v1.DeviceManufacturerServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.deviceManufacturerServiceStub, undefined);
    ...
    describe('getDeviceManufacturer', () => {
        it('invokes getDeviceManufacturer without error', async () => {
            const client = new devicemanufacturerserviceModule.v1.DeviceManufacturerServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.GetDeviceManufacturerRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetDeviceManufacturerRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.DeviceManufacturer()
            );
            client.innerApiCalls.getDeviceManufacturer = stubSimpleCall(expectedResponse);
            const [response] = await client.getDeviceManufacturer(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getDeviceManufacturer as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDeviceManufacturer as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getDeviceManufacturer without error using callback', async () => {
            const client = new devicemanufacturerserviceModule.v1.DeviceManufacturerServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getDeviceManufacturer = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getDeviceManufacturer(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IDeviceManufacturer|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getDeviceManufacturer with error', async () => {
            const client = new devicemanufacturerserviceModule.v1.DeviceManufacturerServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getDeviceManufacturer = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getDeviceManufacturer(request), expectedError);
            const actualRequest = (client.innerApiCalls.getDeviceManufacturer as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDeviceManufacturer as SinonStub)
        ...
        it('invokes getDeviceManufacturer with closed client', async () => {
            const client = new devicemanufacturerserviceModule.v1.DeviceManufacturerServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('listDeviceManufacturers', () => {
        it('invokes listDeviceManufacturers without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.ListDeviceManufacturersRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListDeviceManufacturersRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.DeviceManufacturer()),
              generateSampleMessage(new protos.google.ads.admanager.v1.DeviceManufacturer()),
              generateSampleMessage(new protos.google.ads.admanager.v1.DeviceManufacturer()),
            ];
            client.innerApiCalls.listDeviceManufacturers = stubSimpleCall(expectedResponse);
            const [response] = await client.listDeviceManufacturers(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listDeviceManufacturers as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listDeviceManufacturers as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listDeviceManufacturers without error using callback', async () => {
            ...
            client.innerApiCalls.listDeviceManufacturers = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listDeviceManufacturers(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IDeviceManufacturer[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listDeviceManufacturers with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listDeviceManufacturers = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listDeviceManufacturers(request), expectedError);
            const actualRequest = (client.innerApiCalls.listDeviceManufacturers as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listDeviceManufacturers as SinonStub)
        ...
        it('invokes listDeviceManufacturersStream without error', async () => {
            ...
            client.descriptors.page.listDeviceManufacturers.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listDeviceManufacturersStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.DeviceManufacturer[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.DeviceManufacturer) => {
            ...
            assert((client.descriptors.page.listDeviceManufacturers.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listDeviceManufacturers, request));
            assert(
                (client.descriptors.page.listDeviceManufacturers.createStream as SinonStub)
        ...
        it('invokes listDeviceManufacturersStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDeviceManufacturers.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listDeviceManufacturersStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.DeviceManufacturer[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.DeviceManufacturer) => {
        ...
        it('uses async iteration with listDeviceManufacturers without error', async () => {
            const client = new devicemanufacturerserviceModule.v1.DeviceManufacturerServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listDeviceManufacturers.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.admanager.v1.IDeviceManufacturer[] = [];
            const iterable = client.listDeviceManufacturersAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listDeviceManufacturers.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listDeviceManufacturers with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDeviceManufacturers.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listDeviceManufacturersAsync(request);
