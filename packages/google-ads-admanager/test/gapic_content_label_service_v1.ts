...
import * as contentlabelserviceModule from '../src';
...
describe('v1.ContentLabelServiceClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new contentlabelserviceModule.v1.ContentLabelServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          contentlabelserviceModule.v1.ContentLabelServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          contentlabelserviceModule.v1.ContentLabelServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('sets apiEndpoint according to universe domain camelCase', () => {
      const client = new contentlabelserviceModule.v1.ContentLabelServiceClient(
    ...
    it('has port', () => {
      const port = contentlabelserviceModule.v1.ContentLabelServiceClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.contentLabelServiceStub, undefined);
      await client.initialize();
      assert(client.contentLabelServiceStub);
    });
  ...
  describe('getContentLabel', () => {
    it('invokes getContentLabel without error', async () => {
      const client = new contentlabelserviceModule.v1.ContentLabelServiceClient(
        {
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.GetContentLabelRequest(),
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.ContentLabel(),
      );
      client.innerApiCalls.getContentLabel = stubSimpleCall(expectedResponse);
      const [response] = await client.getContentLabel(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getContentLabel as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getContentLabel without error using callback', async () => {
      const client = new contentlabelserviceModule.v1.ContentLabelServiceClient(
        {
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.getContentLabel =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getContentLabel(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IContentLabel | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getContentLabel with error', async () => {
      const client = new contentlabelserviceModule.v1.ContentLabelServiceClient(
        {
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.getContentLabel = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.getContentLabel(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.getContentLabel as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes getContentLabel with closed client', async () => {
      const client = new contentlabelserviceModule.v1.ContentLabelServiceClient(
        {
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('listContentLabels', () => {
    it('invokes listContentLabels without error', async () => {
      const client = new contentlabelserviceModule.v1.ContentLabelServiceClient(
        {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.ListContentLabelsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.listContentLabels = stubSimpleCall(expectedResponse);
      const [response] = await client.listContentLabels(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listContentLabels as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listContentLabels as SinonStub
    ...
    it('invokes listContentLabels without error using callback', async () => {
      const client = new contentlabelserviceModule.v1.ContentLabelServiceClient(
        {
          credentials: { client_email: 'bogus', private_key: 'bogus' },
          projectId: 'bogus',
      ...
      client.innerApiCalls.listContentLabels =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listContentLabels(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IContentLabel[] | null,
    ...
    it('invokes listContentLabels with error', async () => {
      const client = new contentlabelserviceModule.v1.ContentLabelServiceClient(
        {
          credentials: { client_email: 'bogus', private_key: 'bogus' },
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listContentLabels = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.listContentLabels(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.listContentLabels as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes listContentLabelsStream without error', async () => {
      const client = new contentlabelserviceModule.v1.ContentLabelServiceClient(
        {
          credentials: { client_email: 'bogus', private_key: 'bogus' },
          projectId: 'bogus',
      ...
      client.descriptors.page.listContentLabels.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listContentLabelsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.ads.admanager.v1.ContentLabel[] = [];
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.ContentLabel) => {
      ...
      assert(
        (client.descriptors.page.listContentLabels.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listContentLabels, request),
      );
      assert(
        (client.descriptors.page.listContentLabels.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listContentLabelsStream with error', async () => {
      const client = new contentlabelserviceModule.v1.ContentLabelServiceClient(
        {
          credentials: { client_email: 'bogus', private_key: 'bogus' },
          projectId: 'bogus',
    ...
    it('uses async iteration with listContentLabels without error', async () => {
      const client = new contentlabelserviceModule.v1.ContentLabelServiceClient(
        {
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.descriptors.page.listContentLabels.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.ads.admanager.v1.IContentLabel[] = [];
      const iterable = client.listContentLabelsAsync(request);
      ...
      assert.deepStrictEqual(
        (
          client.descriptors.page.listContentLabels.asyncIterate as SinonStub
        ).getCall(0).args[1],
        request,
      );
      assert(
    ...
    it('uses async iteration with listContentLabels with error', async () => {
      const client = new contentlabelserviceModule.v1.ContentLabelServiceClient(
        {
          credentials: { client_email: 'bogus', private_key: 'bogus' },
          projectId: 'bogus',
