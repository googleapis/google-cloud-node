  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = contentlabelserviceModule.v1.ContentLabelServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = contentlabelserviceModule.v1.ContentLabelServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new contentlabelserviceModule.v1.ContentLabelServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new contentlabelserviceModule.v1.ContentLabelServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new contentlabelserviceModule.v1.ContentLabelServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new contentlabelserviceModule.v1.ContentLabelServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getContentLabel', () => {
        it('invokes getContentLabel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetContentLabelRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getContentLabel as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getContentLabel as SinonStub)
        ...
        it('invokes getContentLabel without error using callback', async () => {
            ...
            client.innerApiCalls.getContentLabel = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getContentLabel(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IContentLabel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getContentLabel with error', async () => {
            ...
            client.innerApiCalls.getContentLabel = stubSimpleCall(undefined, expectedError);
    ...
    describe('listContentLabels', () => {
        it('invokes listContentLabels without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListContentLabelsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.ContentLabel()),
              generateSampleMessage(new protos.google.ads.admanager.v1.ContentLabel()),
              generateSampleMessage(new protos.google.ads.admanager.v1.ContentLabel()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listContentLabels as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listContentLabels as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listContentLabels without error using callback', async () => {
            ...
            client.innerApiCalls.listContentLabels = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listContentLabels with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listContentLabels = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listContentLabelsStream without error', async () => {
            ...
            client.descriptors.page.listContentLabels.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listContentLabelsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.ContentLabel[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.ContentLabel) => {
            ...
            assert((client.descriptors.page.listContentLabels.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listContentLabels, request));
            assert(
        ...
        it('invokes listContentLabelsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listContentLabels.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listContentLabelsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.ContentLabel[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.ContentLabel) => {
        ...
        it('uses async iteration with listContentLabels without error', async () => {
            ...
            client.descriptors.page.listContentLabels.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listContentLabels with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listContentLabels.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listContentLabelsAsync(request);
