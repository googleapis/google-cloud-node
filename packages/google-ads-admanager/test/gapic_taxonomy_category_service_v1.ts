  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = taxonomycategoryserviceModule.v1.TaxonomyCategoryServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = taxonomycategoryserviceModule.v1.TaxonomyCategoryServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new taxonomycategoryserviceModule.v1.TaxonomyCategoryServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new taxonomycategoryserviceModule.v1.TaxonomyCategoryServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new taxonomycategoryserviceModule.v1.TaxonomyCategoryServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new taxonomycategoryserviceModule.v1.TaxonomyCategoryServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = taxonomycategoryserviceModule.v1.TaxonomyCategoryServiceClient.port;
            assert(port);
    ...
    describe('getTaxonomyCategory', () => {
        it('invokes getTaxonomyCategory without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetTaxonomyCategoryRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.TaxonomyCategory()
            );
            client.innerApiCalls.getTaxonomyCategory = stubSimpleCall(expectedResponse);
            const [response] = await client.getTaxonomyCategory(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getTaxonomyCategory as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getTaxonomyCategory as SinonStub)
        ...
        it('invokes getTaxonomyCategory without error using callback', async () => {
            ...
            client.innerApiCalls.getTaxonomyCategory = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getTaxonomyCategory(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.ITaxonomyCategory|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getTaxonomyCategory with error', async () => {
            ...
            client.innerApiCalls.getTaxonomyCategory = stubSimpleCall(undefined, expectedError);
    ...
    describe('listTaxonomyCategories', () => {
        it('invokes listTaxonomyCategories without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListTaxonomyCategoriesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.TaxonomyCategory()),
              generateSampleMessage(new protos.google.ads.admanager.v1.TaxonomyCategory()),
              generateSampleMessage(new protos.google.ads.admanager.v1.TaxonomyCategory()),
            ];
            client.innerApiCalls.listTaxonomyCategories = stubSimpleCall(expectedResponse);
            const [response] = await client.listTaxonomyCategories(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listTaxonomyCategories as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listTaxonomyCategories as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listTaxonomyCategories without error using callback', async () => {
            ...
            client.innerApiCalls.listTaxonomyCategories = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listTaxonomyCategories with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listTaxonomyCategories = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listTaxonomyCategories(request), expectedError);
            const actualRequest = (client.innerApiCalls.listTaxonomyCategories as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listTaxonomyCategories as SinonStub)
        ...
        it('invokes listTaxonomyCategoriesStream without error', async () => {
            ...
            client.descriptors.page.listTaxonomyCategories.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listTaxonomyCategoriesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.TaxonomyCategory[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.TaxonomyCategory) => {
            ...
            assert((client.descriptors.page.listTaxonomyCategories.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listTaxonomyCategories, request));
            assert(
                (client.descriptors.page.listTaxonomyCategories.createStream as SinonStub)
        ...
        it('invokes listTaxonomyCategoriesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listTaxonomyCategories.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listTaxonomyCategoriesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.TaxonomyCategory[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.TaxonomyCategory) => {
        ...
        it('uses async iteration with listTaxonomyCategories without error', async () => {
            ...
            client.descriptors.page.listTaxonomyCategories.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(
                (client.descriptors.page.listTaxonomyCategories.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listTaxonomyCategories with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listTaxonomyCategories.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listTaxonomyCategoriesAsync(request);
