...
describe('v1.TaxonomyCategoryServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          taxonomycategoryserviceModule.v1.TaxonomyCategoryServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        taxonomycategoryserviceModule.v1.TaxonomyCategoryServiceClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.taxonomyCategoryServiceStub, undefined);
  ...
  describe('getTaxonomyCategory', () => {
    it('invokes getTaxonomyCategory without error', async () => {
      const client =
        new taxonomycategoryserviceModule.v1.TaxonomyCategoryServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.getTaxonomyCategory =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getTaxonomyCategory(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getTaxonomyCategory as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getTaxonomyCategory without error using callback', async () => {
      const client =
        new taxonomycategoryserviceModule.v1.TaxonomyCategoryServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const promise = new Promise((resolve, reject) => {
        client.getTaxonomyCategory(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.ITaxonomyCategory | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getTaxonomyCategory with error', async () => {
      const client =
        new taxonomycategoryserviceModule.v1.TaxonomyCategoryServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
    ...
    it('invokes getTaxonomyCategory with closed client', async () => {
      const client =
        new taxonomycategoryserviceModule.v1.TaxonomyCategoryServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('listTaxonomyCategories', () => {
    it('invokes listTaxonomyCategories without error', async () => {
      ...
      client.innerApiCalls.listTaxonomyCategories =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listTaxonomyCategories(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listTaxonomyCategories as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listTaxonomyCategories as SinonStub
    ...
    it('invokes listTaxonomyCategories with error', async () => {
      ...
      await assert.rejects(
        client.listTaxonomyCategories(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listTaxonomyCategories as SinonStub
    ...
    it('invokes listTaxonomyCategoriesStream without error', async () => {
      ...
      const stream = client.listTaxonomyCategoriesStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.ads.admanager.v1.TaxonomyCategory[] = [];
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.TaxonomyCategory) => {
      ...
      assert(
        (
          client.descriptors.page.listTaxonomyCategories
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listTaxonomyCategories, request),
      );
      assert(
        (
          client.descriptors.page.listTaxonomyCategories
    ...
    it('uses async iteration with listTaxonomyCategories without error', async () => {
      const client =
        new taxonomycategoryserviceModule.v1.TaxonomyCategoryServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const responses: protos.google.ads.admanager.v1.ITaxonomyCategory[] = [];
      const iterable = client.listTaxonomyCategoriesAsync(request);
