...
describe('v1.BrowserServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          browserserviceModule.v1.BrowserServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          browserserviceModule.v1.BrowserServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new browserserviceModule.v1.BrowserServiceClient({
          universe_domain: 'example.com',
  ...
  describe('getBrowser', () => {
    it('invokes getBrowser without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.GetBrowserRequest',
        ['name'],
      );
      ...
      const actualRequest = (
        client.innerApiCalls.getBrowser as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getBrowser without error using callback', async () => {
      ...
      client.innerApiCalls.getBrowser =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getBrowser(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBrowser | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getBrowser with error', async () => {
      ...
      client.innerApiCalls.getBrowser = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listBrowsers', () => {
    it('invokes listBrowsers without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listBrowsers as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listBrowsers as SinonStub
    ...
    it('invokes listBrowsers without error using callback', async () => {
      ...
      client.innerApiCalls.listBrowsers =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listBrowsers(
          request,
    ...
    it('invokes listBrowsers with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listBrowsers = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listBrowsersStream without error', async () => {
      ...
      client.descriptors.page.listBrowsers.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.Browser) => {
      ...
      assert(
        (client.descriptors.page.listBrowsers.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listBrowsers, request),
      );
      assert(
        (client.descriptors.page.listBrowsers.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listBrowsersStream with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listBrowsers.createStream = stubPageStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.listBrowsersStream(request);
    ...
    it('uses async iteration with listBrowsers without error', async () => {
      ...
      client.descriptors.page.listBrowsers.asyncIterate =
