...
describe('v1.DeviceCapabilityServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new devicecapabilityserviceModule.v1.DeviceCapabilityServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = devicecapabilityserviceModule.v1.DeviceCapabilityServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = devicecapabilityserviceModule.v1.DeviceCapabilityServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new devicecapabilityserviceModule.v1.DeviceCapabilityServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new devicecapabilityserviceModule.v1.DeviceCapabilityServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new devicecapabilityserviceModule.v1.DeviceCapabilityServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new devicecapabilityserviceModule.v1.DeviceCapabilityServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = devicecapabilityserviceModule.v1.DeviceCapabilityServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.deviceCapabilityServiceStub, undefined);
    ...
    describe('getDeviceCapability', () => {
        it('invokes getDeviceCapability without error', async () => {
            const client = new devicecapabilityserviceModule.v1.DeviceCapabilityServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.GetDeviceCapabilityRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetDeviceCapabilityRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.DeviceCapability()
            );
            client.innerApiCalls.getDeviceCapability = stubSimpleCall(expectedResponse);
            const [response] = await client.getDeviceCapability(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getDeviceCapability as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDeviceCapability as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getDeviceCapability without error using callback', async () => {
            const client = new devicecapabilityserviceModule.v1.DeviceCapabilityServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getDeviceCapability = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getDeviceCapability(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IDeviceCapability|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getDeviceCapability with error', async () => {
            const client = new devicecapabilityserviceModule.v1.DeviceCapabilityServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getDeviceCapability = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes getDeviceCapability with closed client', async () => {
            const client = new devicecapabilityserviceModule.v1.DeviceCapabilityServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('listDeviceCapabilities', () => {
        it('invokes listDeviceCapabilities without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.ListDeviceCapabilitiesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListDeviceCapabilitiesRequest', ['parent']);
            ...
            client.innerApiCalls.listDeviceCapabilities = stubSimpleCall(expectedResponse);
            const [response] = await client.listDeviceCapabilities(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listDeviceCapabilities as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listDeviceCapabilities as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listDeviceCapabilities without error using callback', async () => {
            ...
            client.innerApiCalls.listDeviceCapabilities = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listDeviceCapabilities(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IDeviceCapability[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listDeviceCapabilities with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listDeviceCapabilities = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listDeviceCapabilities(request), expectedError);
            const actualRequest = (client.innerApiCalls.listDeviceCapabilities as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listDeviceCapabilities as SinonStub)
        ...
        it('invokes listDeviceCapabilitiesStream without error', async () => {
            ...
            client.descriptors.page.listDeviceCapabilities.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listDeviceCapabilitiesStream(request);
            const promise = new Promise((resolve, reject) => {
            ...
            assert((client.descriptors.page.listDeviceCapabilities.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listDeviceCapabilities, request));
            assert(
                (client.descriptors.page.listDeviceCapabilities.createStream as SinonStub)
        ...
        it('invokes listDeviceCapabilitiesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDeviceCapabilities.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listDeviceCapabilitiesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.DeviceCapability[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.DeviceCapability) => {
        ...
        it('uses async iteration with listDeviceCapabilities without error', async () => {
            const client = new devicecapabilityserviceModule.v1.DeviceCapabilityServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listDeviceCapabilities.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.admanager.v1.IDeviceCapability[] = [];
            const iterable = client.listDeviceCapabilitiesAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listDeviceCapabilities.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listDeviceCapabilities with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDeviceCapabilities.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listDeviceCapabilitiesAsync(request);
