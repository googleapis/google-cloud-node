...
describe('v1.DeviceCapabilityServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          devicecapabilityserviceModule.v1.DeviceCapabilityServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        devicecapabilityserviceModule.v1.DeviceCapabilityServiceClient.port;
      assert(port);
  ...
  describe('getDeviceCapability', () => {
    it('invokes getDeviceCapability without error', async () => {
      ...
      client.innerApiCalls.getDeviceCapability =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getDeviceCapability(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getDeviceCapability as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getDeviceCapability without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDeviceCapability(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IDeviceCapability | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getDeviceCapability with error', async () => {
      ...
      client.innerApiCalls.getDeviceCapability = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listDeviceCapabilities', () => {
    it('invokes listDeviceCapabilities without error', async () => {
      ...
      client.innerApiCalls.listDeviceCapabilities =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listDeviceCapabilities(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listDeviceCapabilities as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listDeviceCapabilities as SinonStub
    ...
    it('invokes listDeviceCapabilities with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listDeviceCapabilities = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listDeviceCapabilities(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listDeviceCapabilities as SinonStub
    ...
    it('invokes listDeviceCapabilitiesStream without error', async () => {
      ...
      client.descriptors.page.listDeviceCapabilities.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.DeviceCapability) => {
      ...
      assert(
        (
          client.descriptors.page.listDeviceCapabilities
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listDeviceCapabilities, request),
      );
      assert(
        (
          client.descriptors.page.listDeviceCapabilities
    ...
    it('uses async iteration with listDeviceCapabilities without error', async () => {
      ...
      client.descriptors.page.listDeviceCapabilities.asyncIterate =
