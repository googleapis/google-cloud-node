...
describe('v1.DaiAuthenticationKeyServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient
            .servicePath;
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.daiAuthenticationKeyServiceStub, undefined);
  ...
  describe('getDaiAuthenticationKey', () => {
    it('invokes getDaiAuthenticationKey without error', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
      ...
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.GetDaiAuthenticationKeyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.GetDaiAuthenticationKeyRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.DaiAuthenticationKey(),
      );
      client.innerApiCalls.getDaiAuthenticationKey =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getDaiAuthenticationKey(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getDaiAuthenticationKey as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getDaiAuthenticationKey without error using callback', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDaiAuthenticationKey(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IDaiAuthenticationKey | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getDaiAuthenticationKey with error', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
      ...
      client.innerApiCalls.getDaiAuthenticationKey = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getDaiAuthenticationKey(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getDaiAuthenticationKey as SinonStub
    ...
    it('invokes getDaiAuthenticationKey with closed client', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
  ...
  describe('createDaiAuthenticationKey', () => {
    it('invokes createDaiAuthenticationKey without error', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.CreateDaiAuthenticationKeyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.CreateDaiAuthenticationKeyRequest',
        ['parent'],
      );
      ...
      client.innerApiCalls.createDaiAuthenticationKey =
        stubSimpleCall(expectedResponse);
      const [response] = await client.createDaiAuthenticationKey(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createDaiAuthenticationKey as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createDaiAuthenticationKey as SinonStub
    ...
    it('invokes createDaiAuthenticationKey without error using callback', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
      ...
      client.innerApiCalls.createDaiAuthenticationKey =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createDaiAuthenticationKey(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IDaiAuthenticationKey | null,
    ...
    it('invokes createDaiAuthenticationKey with error', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createDaiAuthenticationKey = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createDaiAuthenticationKey(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createDaiAuthenticationKey as SinonStub
    ...
    it('invokes createDaiAuthenticationKey with closed client', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
  ...
  describe('batchCreateDaiAuthenticationKeys', () => {
    it('invokes batchCreateDaiAuthenticationKeys without error', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchCreateDaiAuthenticationKeysRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchCreateDaiAuthenticationKeysResponse(),
      );
      client.innerApiCalls.batchCreateDaiAuthenticationKeys =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchCreateDaiAuthenticationKeys(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchCreateDaiAuthenticationKeys as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchCreateDaiAuthenticationKeys as SinonStub
    ...
    it('invokes batchCreateDaiAuthenticationKeys without error using callback', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
      ...
      client.innerApiCalls.batchCreateDaiAuthenticationKeys =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchCreateDaiAuthenticationKeys(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchCreateDaiAuthenticationKeysResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchCreateDaiAuthenticationKeys with error', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchCreateDaiAuthenticationKeys = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchCreateDaiAuthenticationKeys(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchCreateDaiAuthenticationKeys as SinonStub
    ...
    it('invokes batchCreateDaiAuthenticationKeys with closed client', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
  ...
  describe('updateDaiAuthenticationKey', () => {
    it('invokes updateDaiAuthenticationKey without error', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.UpdateDaiAuthenticationKeyRequest(),
      );
      request.daiAuthenticationKey ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.UpdateDaiAuthenticationKeyRequest',
        ['daiAuthenticationKey', 'name'],
      );
      request.daiAuthenticationKey.name = defaultValue1;
      const expectedHeaderRequestParams = `dai_authentication_key.name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.DaiAuthenticationKey(),
      );
      client.innerApiCalls.updateDaiAuthenticationKey =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateDaiAuthenticationKey(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateDaiAuthenticationKey as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateDaiAuthenticationKey as SinonStub
    ...
    it('invokes updateDaiAuthenticationKey without error using callback', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
      ...
      client.innerApiCalls.updateDaiAuthenticationKey =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.updateDaiAuthenticationKey(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IDaiAuthenticationKey | null,
    ...
    it('invokes updateDaiAuthenticationKey with error', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
      ...
      const expectedHeaderRequestParams = `dai_authentication_key.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateDaiAuthenticationKey = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateDaiAuthenticationKey(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateDaiAuthenticationKey as SinonStub
    ...
    it('invokes updateDaiAuthenticationKey with closed client', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
  ...
  describe('batchUpdateDaiAuthenticationKeys', () => {
    it('invokes batchUpdateDaiAuthenticationKeys without error', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUpdateDaiAuthenticationKeysRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchUpdateDaiAuthenticationKeysRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUpdateDaiAuthenticationKeysResponse(),
      );
      client.innerApiCalls.batchUpdateDaiAuthenticationKeys =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchUpdateDaiAuthenticationKeys(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchUpdateDaiAuthenticationKeys as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchUpdateDaiAuthenticationKeys as SinonStub
    ...
    it('invokes batchUpdateDaiAuthenticationKeys without error using callback', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
      ...
      client.innerApiCalls.batchUpdateDaiAuthenticationKeys =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchUpdateDaiAuthenticationKeys(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchUpdateDaiAuthenticationKeysResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchUpdateDaiAuthenticationKeys with error', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchUpdateDaiAuthenticationKeys = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchUpdateDaiAuthenticationKeys(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchUpdateDaiAuthenticationKeys as SinonStub
    ...
    it('invokes batchUpdateDaiAuthenticationKeys with closed client', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
  ...
  describe('batchActivateDaiAuthenticationKeys', () => {
    it('invokes batchActivateDaiAuthenticationKeys without error', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchActivateDaiAuthenticationKeysRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchActivateDaiAuthenticationKeysRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchActivateDaiAuthenticationKeysResponse(),
      );
      client.innerApiCalls.batchActivateDaiAuthenticationKeys =
        stubSimpleCall(expectedResponse);
      const [response] =
        await client.batchActivateDaiAuthenticationKeys(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchActivateDaiAuthenticationKeys as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchActivateDaiAuthenticationKeys as SinonStub
    ...
    it('invokes batchActivateDaiAuthenticationKeys without error using callback', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
      ...
      client.innerApiCalls.batchActivateDaiAuthenticationKeys =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchActivateDaiAuthenticationKeys(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchActivateDaiAuthenticationKeysResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchActivateDaiAuthenticationKeys with error', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchActivateDaiAuthenticationKeys = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchActivateDaiAuthenticationKeys(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchActivateDaiAuthenticationKeys as SinonStub
    ...
    it('invokes batchActivateDaiAuthenticationKeys with closed client', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
  ...
  describe('batchDeactivateDaiAuthenticationKeys', () => {
    it('invokes batchDeactivateDaiAuthenticationKeys without error', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchDeactivateDaiAuthenticationKeysRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchDeactivateDaiAuthenticationKeysRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchDeactivateDaiAuthenticationKeysResponse(),
      );
      client.innerApiCalls.batchDeactivateDaiAuthenticationKeys =
        stubSimpleCall(expectedResponse);
      const [response] =
        await client.batchDeactivateDaiAuthenticationKeys(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchDeactivateDaiAuthenticationKeys as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchDeactivateDaiAuthenticationKeys as SinonStub
    ...
    it('invokes batchDeactivateDaiAuthenticationKeys without error using callback', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
      ...
      client.innerApiCalls.batchDeactivateDaiAuthenticationKeys =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchDeactivateDaiAuthenticationKeys(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchDeactivateDaiAuthenticationKeysResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchDeactivateDaiAuthenticationKeys with error', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
      ...
      await assert.rejects(
        client.batchDeactivateDaiAuthenticationKeys(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchDeactivateDaiAuthenticationKeys as SinonStub
    ...
    it('invokes batchDeactivateDaiAuthenticationKeys with closed client', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
  ...
  describe('listDaiAuthenticationKeys', () => {
    it('invokes listDaiAuthenticationKeys without error', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.ListDaiAuthenticationKeysRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.ListDaiAuthenticationKeysRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.listDaiAuthenticationKeys =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listDaiAuthenticationKeys(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listDaiAuthenticationKeys as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listDaiAuthenticationKeys as SinonStub
    ...
    it('invokes listDaiAuthenticationKeys without error using callback', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            credentials: { client_email: 'bogus', private_key: 'bogus' },
      ...
      client.innerApiCalls.listDaiAuthenticationKeys =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listDaiAuthenticationKeys(
          request,
          (
            err?: Error | null,
            result?:
    ...
    it('invokes listDaiAuthenticationKeys with error', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            credentials: { client_email: 'bogus', private_key: 'bogus' },
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listDaiAuthenticationKeys = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listDaiAuthenticationKeys(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listDaiAuthenticationKeys as SinonStub
    ...
    it('invokes listDaiAuthenticationKeysStream without error', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            credentials: { client_email: 'bogus', private_key: 'bogus' },
      ...
      client.descriptors.page.listDaiAuthenticationKeys.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listDaiAuthenticationKeysStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.ads.admanager.v1.DaiAuthenticationKey[] =
          [];
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.DaiAuthenticationKey) => {
      ...
      assert(
        (
          client.descriptors.page.listDaiAuthenticationKeys
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listDaiAuthenticationKeys, request),
      );
      assert(
        (
          client.descriptors.page.listDaiAuthenticationKeys
    ...
    it('invokes listDaiAuthenticationKeysStream with error', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            credentials: { client_email: 'bogus', private_key: 'bogus' },
    ...
    it('uses async iteration with listDaiAuthenticationKeys without error', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            auth: googleAuth,
      ...
      client.descriptors.page.listDaiAuthenticationKeys.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.ads.admanager.v1.IDaiAuthenticationKey[] =
        [];
      const iterable = client.listDaiAuthenticationKeysAsync(request);
    ...
    it('uses async iteration with listDaiAuthenticationKeys with error', async () => {
      const client =
        new daiauthenticationkeyserviceModule.v1.DaiAuthenticationKeyServiceClient(
          {
            credentials: { client_email: 'bogus', private_key: 'bogus' },
