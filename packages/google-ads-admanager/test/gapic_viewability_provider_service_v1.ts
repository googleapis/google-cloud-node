...
import * as viewabilityproviderserviceModule from '../src';
...
describe('v1.ViewabilityProviderServiceClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient
            .servicePath;
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.viewabilityProviderServiceStub, undefined);
      await client.initialize();
      assert(client.viewabilityProviderServiceStub);
    });
  ...
  describe('getViewabilityProvider', () => {
    it('invokes getViewabilityProvider without error', async () => {
      const client =
        new viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient(
          {
            auth: googleAuth,
      ...
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.GetViewabilityProviderRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.GetViewabilityProviderRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.ViewabilityProvider(),
      );
      client.innerApiCalls.getViewabilityProvider =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getViewabilityProvider(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getViewabilityProvider as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getViewabilityProvider without error using callback', async () => {
      const client =
        new viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient(
          {
            auth: googleAuth,
      ...
      const promise = new Promise((resolve, reject) => {
        client.getViewabilityProvider(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IViewabilityProvider | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getViewabilityProvider with error', async () => {
      const client =
        new viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient(
          {
            auth: googleAuth,
      ...
      client.innerApiCalls.getViewabilityProvider = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getViewabilityProvider(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getViewabilityProvider as SinonStub
    ...
    it('invokes getViewabilityProvider with closed client', async () => {
      const client =
        new viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient(
          {
            auth: googleAuth,
  ...
  describe('createViewabilityProvider', () => {
    it('invokes createViewabilityProvider without error', async () => {
      const client =
        new viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient(
          {
            auth: googleAuth,
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.CreateViewabilityProviderRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.CreateViewabilityProviderRequest',
        ['parent'],
      );
      ...
      client.innerApiCalls.createViewabilityProvider =
        stubSimpleCall(expectedResponse);
      const [response] = await client.createViewabilityProvider(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createViewabilityProvider as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createViewabilityProvider as SinonStub
    ...
    it('invokes createViewabilityProvider without error using callback', async () => {
      const client =
        new viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient(
          {
            auth: googleAuth,
      ...
      client.innerApiCalls.createViewabilityProvider =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createViewabilityProvider(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IViewabilityProvider | null,
    ...
    it('invokes createViewabilityProvider with error', async () => {
      const client =
        new viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient(
          {
            auth: googleAuth,
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createViewabilityProvider = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createViewabilityProvider(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createViewabilityProvider as SinonStub
    ...
    it('invokes createViewabilityProvider with closed client', async () => {
      const client =
        new viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient(
          {
            auth: googleAuth,
  ...
  describe('batchCreateViewabilityProviders', () => {
    it('invokes batchCreateViewabilityProviders without error', async () => {
      const client =
        new viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient(
          {
            auth: googleAuth,
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchCreateViewabilityProvidersRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchCreateViewabilityProvidersResponse(),
      );
      client.innerApiCalls.batchCreateViewabilityProviders =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchCreateViewabilityProviders(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchCreateViewabilityProviders as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchCreateViewabilityProviders as SinonStub
    ...
    it('invokes batchCreateViewabilityProviders without error using callback', async () => {
      const client =
        new viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient(
          {
            auth: googleAuth,
      ...
      client.innerApiCalls.batchCreateViewabilityProviders =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchCreateViewabilityProviders(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchCreateViewabilityProvidersResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchCreateViewabilityProviders with error', async () => {
      const client =
        new viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient(
          {
            auth: googleAuth,
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchCreateViewabilityProviders = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchCreateViewabilityProviders(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchCreateViewabilityProviders as SinonStub
    ...
    it('invokes batchCreateViewabilityProviders with closed client', async () => {
      const client =
        new viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient(
          {
            auth: googleAuth,
  ...
  describe('updateViewabilityProvider', () => {
    it('invokes updateViewabilityProvider without error', async () => {
      const client =
        new viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient(
          {
            auth: googleAuth,
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.UpdateViewabilityProviderRequest(),
      );
      request.viewabilityProvider ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.UpdateViewabilityProviderRequest',
        ['viewabilityProvider', 'name'],
      );
      request.viewabilityProvider.name = defaultValue1;
      const expectedHeaderRequestParams = `viewability_provider.name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.ViewabilityProvider(),
      );
      client.innerApiCalls.updateViewabilityProvider =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateViewabilityProvider(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateViewabilityProvider as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateViewabilityProvider as SinonStub
    ...
    it('invokes updateViewabilityProvider without error using callback', async () => {
      const client =
        new viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient(
          {
            auth: googleAuth,
      ...
      client.innerApiCalls.updateViewabilityProvider =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.updateViewabilityProvider(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IViewabilityProvider | null,
    ...
    it('invokes updateViewabilityProvider with error', async () => {
      const client =
        new viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient(
          {
            auth: googleAuth,
      ...
      const expectedHeaderRequestParams = `viewability_provider.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateViewabilityProvider = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateViewabilityProvider(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateViewabilityProvider as SinonStub
    ...
    it('invokes updateViewabilityProvider with closed client', async () => {
      const client =
        new viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient(
          {
            auth: googleAuth,
  ...
  describe('batchUpdateViewabilityProviders', () => {
    it('invokes batchUpdateViewabilityProviders without error', async () => {
      const client =
        new viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient(
          {
            auth: googleAuth,
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUpdateViewabilityProvidersRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchUpdateViewabilityProvidersRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUpdateViewabilityProvidersResponse(),
      );
      client.innerApiCalls.batchUpdateViewabilityProviders =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchUpdateViewabilityProviders(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchUpdateViewabilityProviders as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchUpdateViewabilityProviders as SinonStub
    ...
    it('invokes batchUpdateViewabilityProviders without error using callback', async () => {
      const client =
        new viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient(
          {
            auth: googleAuth,
      ...
      client.innerApiCalls.batchUpdateViewabilityProviders =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchUpdateViewabilityProviders(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchUpdateViewabilityProvidersResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchUpdateViewabilityProviders with error', async () => {
      const client =
        new viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient(
          {
            auth: googleAuth,
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchUpdateViewabilityProviders = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchUpdateViewabilityProviders(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchUpdateViewabilityProviders as SinonStub
    ...
    it('invokes batchUpdateViewabilityProviders with closed client', async () => {
      const client =
        new viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient(
          {
            auth: googleAuth,
  ...
  describe('listViewabilityProviders', () => {
    it('invokes listViewabilityProviders without error', async () => {
      const client =
        new viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient(
          {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.ListViewabilityProvidersRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.ListViewabilityProvidersRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.listViewabilityProviders =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listViewabilityProviders(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listViewabilityProviders as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listViewabilityProviders as SinonStub
    ...
    it('invokes listViewabilityProviders without error using callback', async () => {
      const client =
        new viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient(
          {
            credentials: {client_email: 'bogus', private_key: 'bogus'},
      ...
      client.innerApiCalls.listViewabilityProviders =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listViewabilityProviders(
          request,
          (
            err?: Error | null,
            result?:
              protos.google.ads.admanager.v1.IViewabilityProvider[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listViewabilityProviders with error', async () => {
      const client =
        new viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient(
          {
            credentials: {client_email: 'bogus', private_key: 'bogus'},
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listViewabilityProviders = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listViewabilityProviders(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listViewabilityProviders as SinonStub
    ...
    it('invokes listViewabilityProvidersStream without error', async () => {
      const client =
        new viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient(
          {
            credentials: {client_email: 'bogus', private_key: 'bogus'},
      ...
      client.descriptors.page.listViewabilityProviders.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listViewabilityProvidersStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.ads.admanager.v1.ViewabilityProvider[] =
          [];
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.ViewabilityProvider) => {
      ...
      assert(
        (
          client.descriptors.page.listViewabilityProviders
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listViewabilityProviders, request),
      );
      assert(
        (
          client.descriptors.page.listViewabilityProviders
    ...
    it('invokes listViewabilityProvidersStream with error', async () => {
      const client =
        new viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient(
          {
            credentials: {client_email: 'bogus', private_key: 'bogus'},
    ...
    it('uses async iteration with listViewabilityProviders without error', async () => {
      const client =
        new viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient(
          {
            auth: googleAuth,
      ...
      client.descriptors.page.listViewabilityProviders.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.ads.admanager.v1.IViewabilityProvider[] =
        [];
      const iterable = client.listViewabilityProvidersAsync(request);
    ...
    it('uses async iteration with listViewabilityProviders with error', async () => {
      const client =
        new viewabilityproviderserviceModule.v1.ViewabilityProviderServiceClient(
          {
            credentials: {client_email: 'bogus', private_key: 'bogus'},
