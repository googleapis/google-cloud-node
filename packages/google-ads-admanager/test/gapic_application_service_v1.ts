...
describe('v1.ApplicationServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          applicationserviceModule.v1.ApplicationServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          applicationserviceModule.v1.ApplicationServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new applicationserviceModule.v1.ApplicationServiceClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'admanager.example.com');
          if (saved) {
    ...
    it('has port', () => {
      const port = applicationserviceModule.v1.ApplicationServiceClient.port;
      assert(port);
  ...
  describe('getApplication', () => {
    it('invokes getApplication without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.GetApplicationRequest(),
      );
    ...
    it('invokes getApplication without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getApplication(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IApplication | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('batchCreateApplications', () => {
    it('invokes batchCreateApplications without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchCreateApplicationsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.batchCreateApplications =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchCreateApplications(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchCreateApplications as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchCreateApplications as SinonStub
    ...
    it('invokes batchCreateApplications without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchCreateApplications(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchCreateApplicationsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchCreateApplications with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchCreateApplications = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchCreateApplications(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchCreateApplications as SinonStub
  ...
  describe('batchUpdateApplications', () => {
    it('invokes batchUpdateApplications without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchUpdateApplicationsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.batchUpdateApplications =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchUpdateApplications(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchUpdateApplications as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchUpdateApplications as SinonStub
    ...
    it('invokes batchUpdateApplications without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchUpdateApplications(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchUpdateApplicationsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchUpdateApplications with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchUpdateApplications = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchUpdateApplications(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchUpdateApplications as SinonStub
  ...
  describe('batchArchiveApplications', () => {
    it('invokes batchArchiveApplications without error', async () => {
      ...
      client.innerApiCalls.batchArchiveApplications =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchArchiveApplications(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchArchiveApplications as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchArchiveApplications as SinonStub
    ...
    it('invokes batchArchiveApplications without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchArchiveApplications(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchArchiveApplicationsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchArchiveApplications with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchArchiveApplications = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchArchiveApplications(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchArchiveApplications as SinonStub
  ...
  describe('batchUnarchiveApplications', () => {
    it('invokes batchUnarchiveApplications without error', async () => {
      ...
      client.innerApiCalls.batchUnarchiveApplications =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchUnarchiveApplications(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchUnarchiveApplications as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchUnarchiveApplications as SinonStub
    ...
    it('invokes batchUnarchiveApplications without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchUnarchiveApplications(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchUnarchiveApplicationsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchUnarchiveApplications with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchUnarchiveApplications = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchUnarchiveApplications(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchUnarchiveApplications as SinonStub
  ...
  describe('listApplications', () => {
    it('invokes listApplications without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.ListApplicationsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedResponse = [
        generateSampleMessage(new protos.google.ads.admanager.v1.Application()),
        generateSampleMessage(new protos.google.ads.admanager.v1.Application()),
        generateSampleMessage(new protos.google.ads.admanager.v1.Application()),
      ];
    ...
    it('invokes listApplicationsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.ads.admanager.v1.Application[] = [];
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.Application) => {
    ...
    it('uses async iteration with listApplications without error', async () => {
      ...
      const responses: protos.google.ads.admanager.v1.IApplication[] = [];
