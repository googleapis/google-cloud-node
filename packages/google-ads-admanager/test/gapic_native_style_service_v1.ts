...
describe('v1.NativeStyleServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          nativestyleserviceModule.v1.NativeStyleServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          nativestyleserviceModule.v1.NativeStyleServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new nativestyleserviceModule.v1.NativeStyleServiceClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'admanager.example.com');
          if (saved) {
    ...
    it('has port', () => {
      const port = nativestyleserviceModule.v1.NativeStyleServiceClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.nativeStyleServiceStub, undefined);
  ...
  describe('getNativeStyle', () => {
    it('invokes getNativeStyle without error', async () => {
      const client = new nativestyleserviceModule.v1.NativeStyleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.GetNativeStyleRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.GetNativeStyleRequest',
        ['name'],
      );
      ...
      client.innerApiCalls.getNativeStyle = stubSimpleCall(expectedResponse);
      const [response] = await client.getNativeStyle(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getNativeStyle as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getNativeStyle without error using callback', async () => {
      const client = new nativestyleserviceModule.v1.NativeStyleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.getNativeStyle =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getNativeStyle(
          request,
          (
            err?: Error | null,
    ...
    it('invokes getNativeStyle with error', async () => {
      const client = new nativestyleserviceModule.v1.NativeStyleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.getNativeStyle = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes getNativeStyle with closed client', async () => {
      const client = new nativestyleserviceModule.v1.NativeStyleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchCreateNativeStyles', () => {
    it('invokes batchCreateNativeStyles without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchCreateNativeStylesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchCreateNativeStylesRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchCreateNativeStylesResponse(),
      );
      client.innerApiCalls.batchCreateNativeStyles =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchCreateNativeStyles(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchCreateNativeStyles as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchCreateNativeStyles as SinonStub
    ...
    it('invokes batchCreateNativeStyles without error using callback', async () => {
      const client = new nativestyleserviceModule.v1.NativeStyleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchCreateNativeStyles =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchCreateNativeStyles(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchCreateNativeStylesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchCreateNativeStyles with error', async () => {
      const client = new nativestyleserviceModule.v1.NativeStyleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchCreateNativeStyles = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes batchCreateNativeStyles with closed client', async () => {
      const client = new nativestyleserviceModule.v1.NativeStyleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchUpdateNativeStyles', () => {
    it('invokes batchUpdateNativeStyles without error', async () => {
      const client = new nativestyleserviceModule.v1.NativeStyleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUpdateNativeStylesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchUpdateNativeStylesRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUpdateNativeStylesResponse(),
      );
      client.innerApiCalls.batchUpdateNativeStyles =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchUpdateNativeStyles(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchUpdateNativeStyles as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchUpdateNativeStyles as SinonStub
    ...
    it('invokes batchUpdateNativeStyles without error using callback', async () => {
      const client = new nativestyleserviceModule.v1.NativeStyleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchUpdateNativeStyles =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchUpdateNativeStyles(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchUpdateNativeStylesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchUpdateNativeStyles with error', async () => {
      const client = new nativestyleserviceModule.v1.NativeStyleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchUpdateNativeStyles = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchUpdateNativeStyles(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchUpdateNativeStyles as SinonStub
    ...
    it('invokes batchUpdateNativeStyles with closed client', async () => {
      const client = new nativestyleserviceModule.v1.NativeStyleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchActivateNativeStyles', () => {
    it('invokes batchActivateNativeStyles without error', async () => {
      const client = new nativestyleserviceModule.v1.NativeStyleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchActivateNativeStylesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchActivateNativeStylesRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchActivateNativeStylesResponse(),
      );
      client.innerApiCalls.batchActivateNativeStyles =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchActivateNativeStyles(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchActivateNativeStyles as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchActivateNativeStyles as SinonStub
    ...
    it('invokes batchActivateNativeStyles without error using callback', async () => {
      const client = new nativestyleserviceModule.v1.NativeStyleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchActivateNativeStyles =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchActivateNativeStyles(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchActivateNativeStylesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchActivateNativeStyles with error', async () => {
      const client = new nativestyleserviceModule.v1.NativeStyleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchActivateNativeStyles = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchActivateNativeStyles(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchActivateNativeStyles as SinonStub
    ...
    it('invokes batchActivateNativeStyles with closed client', async () => {
      const client = new nativestyleserviceModule.v1.NativeStyleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchDeactivateNativeStyles', () => {
    it('invokes batchDeactivateNativeStyles without error', async () => {
      const client = new nativestyleserviceModule.v1.NativeStyleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchDeactivateNativeStylesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchDeactivateNativeStylesResponse(),
      );
      client.innerApiCalls.batchDeactivateNativeStyles =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchDeactivateNativeStyles(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchDeactivateNativeStyles as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchDeactivateNativeStyles as SinonStub
    ...
    it('invokes batchDeactivateNativeStyles without error using callback', async () => {
      const client = new nativestyleserviceModule.v1.NativeStyleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchDeactivateNativeStyles =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchDeactivateNativeStyles(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchDeactivateNativeStylesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchDeactivateNativeStyles with error', async () => {
      const client = new nativestyleserviceModule.v1.NativeStyleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchDeactivateNativeStyles = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchDeactivateNativeStyles(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchDeactivateNativeStyles as SinonStub
    ...
    it('invokes batchDeactivateNativeStyles with closed client', async () => {
      const client = new nativestyleserviceModule.v1.NativeStyleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchArchiveNativeStyles', () => {
    it('invokes batchArchiveNativeStyles without error', async () => {
      const client = new nativestyleserviceModule.v1.NativeStyleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchArchiveNativeStylesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchArchiveNativeStylesRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchArchiveNativeStylesResponse(),
      );
      client.innerApiCalls.batchArchiveNativeStyles =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchArchiveNativeStyles(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchArchiveNativeStyles as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchArchiveNativeStyles as SinonStub
    ...
    it('invokes batchArchiveNativeStyles without error using callback', async () => {
      const client = new nativestyleserviceModule.v1.NativeStyleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchArchiveNativeStyles =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchArchiveNativeStyles(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchArchiveNativeStylesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchArchiveNativeStyles with error', async () => {
      const client = new nativestyleserviceModule.v1.NativeStyleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchArchiveNativeStyles = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchArchiveNativeStyles(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchArchiveNativeStyles as SinonStub
    ...
    it('invokes batchArchiveNativeStyles with closed client', async () => {
      const client = new nativestyleserviceModule.v1.NativeStyleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('listNativeStyles', () => {
    it('invokes listNativeStyles without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.ListNativeStylesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.ListNativeStylesRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = [
        generateSampleMessage(new protos.google.ads.admanager.v1.NativeStyle()),
        generateSampleMessage(new protos.google.ads.admanager.v1.NativeStyle()),
        generateSampleMessage(new protos.google.ads.admanager.v1.NativeStyle()),
      ];
      client.innerApiCalls.listNativeStyles = stubSimpleCall(expectedResponse);
      const [response] = await client.listNativeStyles(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listNativeStyles as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listNativeStyles as SinonStub
    ...
    it('invokes listNativeStyles without error using callback', async () => {
      ...
      client.innerApiCalls.listNativeStyles =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listNativeStyles(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.INativeStyle[] | null,
    ...
    it('invokes listNativeStyles with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listNativeStyles = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.listNativeStyles(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.listNativeStyles as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes listNativeStylesStream without error', async () => {
      ...
      client.descriptors.page.listNativeStyles.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listNativeStylesStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.ads.admanager.v1.NativeStyle[] = [];
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.NativeStyle) => {
      ...
      assert(
        (client.descriptors.page.listNativeStyles.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listNativeStyles, request),
      );
      assert(
        (client.descriptors.page.listNativeStyles.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listNativeStyles without error', async () => {
      const client = new nativestyleserviceModule.v1.NativeStyleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.descriptors.page.listNativeStyles.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.ads.admanager.v1.INativeStyle[] = [];
      const iterable = client.listNativeStylesAsync(request);
  ...
  describe('Path templates', () => {
    describe('adBreak', async () => {
      ...
      await client.initialize();
      client.pathTemplates.adBreakPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.adBreakPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('adBreakPath', () => {
        const result = client.adBreakPath(
          'networkCodeValue',
          'assetKeyValue',
          'adBreakValue',
        );
        ...
        assert(
          (client.pathTemplates.adBreakPathTemplate.render as SinonStub)
            .getCall(-1)
      ...
      it('matchNetworkCodeFromAdBreakName', () => {
        ...
        assert(
          (client.pathTemplates.adBreakPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('adReviewCenterAd', async () => {
      ...
      await client.initialize();
      client.pathTemplates.adReviewCenterAdPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.adReviewCenterAdPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('adReviewCenterAdPath', () => {
        const result = client.adReviewCenterAdPath(
          'networkCodeValue',
          'webPropertyCodeValue',
          'adReviewCenterAdValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.adReviewCenterAdPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchNetworkCodeFromAdReviewCenterAdName', () => {
        const result =
          client.matchNetworkCodeFromAdReviewCenterAdName(fakePath);
        assert.strictEqual(result, 'networkCodeValue');
        assert(
          (client.pathTemplates.adReviewCenterAdPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchWebPropertyCodeFromAdReviewCenterAdName', () => {
        const result =
          client.matchWebPropertyCodeFromAdReviewCenterAdName(fakePath);
      ...
      it('matchAdReviewCenterAdFromAdReviewCenterAdName', () => {
        const result =
          client.matchAdReviewCenterAdFromAdReviewCenterAdName(fakePath);
    ...
    describe('audienceSegment', async () => {
      ...
      await client.initialize();
      client.pathTemplates.audienceSegmentPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.audienceSegmentPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('audienceSegmentPath', () => {
        const result = client.audienceSegmentPath(
          'networkCodeValue',
          'audienceSegmentValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.audienceSegmentPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchNetworkCodeFromAudienceSegmentName', () => {
        ...
        assert.strictEqual(result, 'networkCodeValue');
        assert(
          (client.pathTemplates.audienceSegmentPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchAudienceSegmentFromAudienceSegmentName', () => {
        const result =
          client.matchAudienceSegmentFromAudienceSegmentName(fakePath);
    ...
    describe('bandwidthGroup', async () => {
      ...
      await client.initialize();
      client.pathTemplates.bandwidthGroupPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.bandwidthGroupPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('bandwidthGroupPath', () => {
        const result = client.bandwidthGroupPath(
          'networkCodeValue',
          'bandwidthGroupValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.bandwidthGroupPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchNetworkCodeFromBandwidthGroupName', () => {
        ...
        assert.strictEqual(result, 'networkCodeValue');
        assert(
          (client.pathTemplates.bandwidthGroupPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchBandwidthGroupFromBandwidthGroupName', () => {
        const result =
          client.matchBandwidthGroupFromBandwidthGroupName(fakePath);
    ...
    describe('browser', async () => {
      ...
      await client.initialize();
      client.pathTemplates.browserPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.browserPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);
      ...
      it('browserPath', () => {
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.browserPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchNetworkCodeFromBrowserName', () => {
        ...
        assert.strictEqual(result, 'networkCodeValue');
        assert(
          (client.pathTemplates.browserPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('browserLanguage', async () => {
      ...
      await client.initialize();
      client.pathTemplates.browserLanguagePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.browserLanguagePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('browserLanguagePath', () => {
        const result = client.browserLanguagePath(
          'networkCodeValue',
          'browserLanguageValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.browserLanguagePathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchBrowserLanguageFromBrowserLanguageName', () => {
        const result =
          client.matchBrowserLanguageFromBrowserLanguageName(fakePath);
    ...
    describe('childPublisher', async () => {
      ...
      await client.initialize();
      client.pathTemplates.childPublisherPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.childPublisherPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('childPublisherPath', () => {
        const result = client.childPublisherPath(
          'networkCodeValue',
          'childPublisherValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.childPublisherPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchNetworkCodeFromChildPublisherName', () => {
        ...
        assert.strictEqual(result, 'networkCodeValue');
        assert(
          (client.pathTemplates.childPublisherPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchChildPublisherFromChildPublisherName', () => {
        const result =
          client.matchChildPublisherFromChildPublisherName(fakePath);
    ...
    describe('cmsMetadataKey', async () => {
      ...
      await client.initialize();
      client.pathTemplates.cmsMetadataKeyPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.cmsMetadataKeyPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('cmsMetadataKeyPath', () => {
        const result = client.cmsMetadataKeyPath(
          'networkCodeValue',
          'cmsMetadataKeyValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.cmsMetadataKeyPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchNetworkCodeFromCmsMetadataKeyName', () => {
        ...
        assert.strictEqual(result, 'networkCodeValue');
        assert(
          (client.pathTemplates.cmsMetadataKeyPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchCmsMetadataKeyFromCmsMetadataKeyName', () => {
        const result =
          client.matchCmsMetadataKeyFromCmsMetadataKeyName(fakePath);
    ...
    describe('cmsMetadataValue', async () => {
      ...
      await client.initialize();
      client.pathTemplates.cmsMetadataValuePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.cmsMetadataValuePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('cmsMetadataValuePath', () => {
        const result = client.cmsMetadataValuePath(
          'networkCodeValue',
          'cmsMetadataValueValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.cmsMetadataValuePathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchNetworkCodeFromCmsMetadataValueName', () => {
        const result =
          client.matchNetworkCodeFromCmsMetadataValueName(fakePath);
        assert.strictEqual(result, 'networkCodeValue');
        assert(
          (client.pathTemplates.cmsMetadataValuePathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchCmsMetadataValueFromCmsMetadataValueName', () => {
        const result =
          client.matchCmsMetadataValueFromCmsMetadataValueName(fakePath);
    ...
    describe('contentBundle', async () => {
      ...
      await client.initialize();
      client.pathTemplates.contentBundlePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.contentBundlePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('contentBundlePath', () => {
        const result = client.contentBundlePath(
          'networkCodeValue',
          'contentBundleValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.contentBundlePathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchNetworkCodeFromContentBundleName', () => {
        ...
        assert.strictEqual(result, 'networkCodeValue');
        assert(
          (client.pathTemplates.contentBundlePathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('contentLabel', async () => {
      ...
      await client.initialize();
      client.pathTemplates.contentLabelPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.contentLabelPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('contentLabelPath', () => {
        const result = client.contentLabelPath(
          'networkCodeValue',
          'contentLabelValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.contentLabelPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
    ...
    describe('creativeTemplate', async () => {
      ...
      await client.initialize();
      client.pathTemplates.creativeTemplatePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.creativeTemplatePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('creativeTemplatePath', () => {
        const result = client.creativeTemplatePath(
          'networkCodeValue',
          'creativeTemplateValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.creativeTemplatePathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchNetworkCodeFromCreativeTemplateName', () => {
        const result =
          client.matchNetworkCodeFromCreativeTemplateName(fakePath);
        assert.strictEqual(result, 'networkCodeValue');
        assert(
      ...
      it('matchCreativeTemplateFromCreativeTemplateName', () => {
        const result =
          client.matchCreativeTemplateFromCreativeTemplateName(fakePath);
    ...
    describe('deviceCapability', async () => {
      ...
      await client.initialize();
      client.pathTemplates.deviceCapabilityPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.deviceCapabilityPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('deviceCapabilityPath', () => {
        const result = client.deviceCapabilityPath(
          'networkCodeValue',
        ...
        assert(
          (
            client.pathTemplates.deviceCapabilityPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchNetworkCodeFromDeviceCapabilityName', () => {
        const result =
          client.matchNetworkCodeFromDeviceCapabilityName(fakePath);
        assert.strictEqual(result, 'networkCodeValue');
        assert(
          (client.pathTemplates.deviceCapabilityPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchDeviceCapabilityFromDeviceCapabilityName', () => {
        const result =
          client.matchDeviceCapabilityFromDeviceCapabilityName(fakePath);
    ...
    describe('deviceCategory', async () => {
      ...
      await client.initialize();
      client.pathTemplates.deviceCategoryPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.deviceCategoryPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('deviceCategoryPath', () => {
        const result = client.deviceCategoryPath(
          'networkCodeValue',
          'deviceCategoryValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.deviceCategoryPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchNetworkCodeFromDeviceCategoryName', () => {
        ...
        assert.strictEqual(result, 'networkCodeValue');
        assert(
          (client.pathTemplates.deviceCategoryPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchDeviceCategoryFromDeviceCategoryName', () => {
        const result =
          client.matchDeviceCategoryFromDeviceCategoryName(fakePath);
    ...
    describe('deviceManufacturer', async () => {
      ...
      await client.initialize();
      client.pathTemplates.deviceManufacturerPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.deviceManufacturerPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('deviceManufacturerPath', () => {
        const result = client.deviceManufacturerPath(
          'networkCodeValue',
      ...
      it('matchNetworkCodeFromDeviceManufacturerName', () => {
        const result =
          client.matchNetworkCodeFromDeviceManufacturerName(fakePath);
        assert.strictEqual(result, 'networkCodeValue');
        assert(
          (
            client.pathTemplates.deviceManufacturerPathTemplate
      ...
      it('matchDeviceManufacturerFromDeviceManufacturerName', () => {
        const result =
          client.matchDeviceManufacturerFromDeviceManufacturerName(fakePath);
    ...
    describe('geoTarget', async () => {
      ...
      await client.initialize();
      client.pathTemplates.geoTargetPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.geoTargetPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('geoTargetPath', () => {
        const result = client.geoTargetPath(
          'networkCodeValue',
          'geoTargetValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.geoTargetPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchNetworkCodeFromGeoTargetName', () => {
        ...
        assert.strictEqual(result, 'networkCodeValue');
        assert(
          (client.pathTemplates.geoTargetPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('lineItem', async () => {
      ...
      await client.initialize();
      client.pathTemplates.lineItemPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.lineItemPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);
      ...
      it('lineItemPath', () => {
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.lineItemPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
    ...
    describe('linkedDevice', async () => {
      ...
      await client.initialize();
      client.pathTemplates.linkedDevicePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.linkedDevicePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('linkedDevicePath', () => {
        const result = client.linkedDevicePath(
          'networkCodeValue',
          'linkedDeviceValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.linkedDevicePathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
    ...
    describe('liveStreamEvent', async () => {
      ...
      await client.initialize();
      client.pathTemplates.liveStreamEventPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.liveStreamEventPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('liveStreamEventPath', () => {
        const result = client.liveStreamEventPath(
          'networkCodeValue',
          'liveStreamEventValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.liveStreamEventPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchNetworkCodeFromLiveStreamEventName', () => {
        ...
        assert.strictEqual(result, 'networkCodeValue');
        assert(
          (client.pathTemplates.liveStreamEventPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchLiveStreamEventFromLiveStreamEventName', () => {
        const result =
          client.matchLiveStreamEventFromLiveStreamEventName(fakePath);
    ...
    describe('mobileCarrier', async () => {
      ...
      await client.initialize();
      client.pathTemplates.mobileCarrierPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.mobileCarrierPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('mobileCarrierPath', () => {
        const result = client.mobileCarrierPath(
          'networkCodeValue',
          'mobileCarrierValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.mobileCarrierPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchNetworkCodeFromMobileCarrierName', () => {
        ...
        assert.strictEqual(result, 'networkCodeValue');
        assert(
          (client.pathTemplates.mobileCarrierPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('mobileDevice', async () => {
      ...
      await client.initialize();
      client.pathTemplates.mobileDevicePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.mobileDevicePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('mobileDevicePath', () => {
        const result = client.mobileDevicePath(
          'networkCodeValue',
          'mobileDeviceValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.mobileDevicePathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchNetworkCodeFromMobileDeviceName', () => {
        ...
        assert.strictEqual(result, 'networkCodeValue');
        assert(
          (client.pathTemplates.mobileDevicePathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('mobileDeviceSubmodel', async () => {
      ...
      await client.initialize();
      client.pathTemplates.mobileDeviceSubmodelPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.mobileDeviceSubmodelPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('mobileDeviceSubmodelPath', () => {
        const result = client.mobileDeviceSubmodelPath(
          'networkCodeValue',
          'mobileDeviceSubmodelValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
      ...
      it('matchNetworkCodeFromMobileDeviceSubmodelName', () => {
        const result =
          client.matchNetworkCodeFromMobileDeviceSubmodelName(fakePath);
        assert.strictEqual(result, 'networkCodeValue');
        assert(
          (
            client.pathTemplates.mobileDeviceSubmodelPathTemplate
      ...
      it('matchMobileDeviceSubmodelFromMobileDeviceSubmodelName', () => {
        const result =
          client.matchMobileDeviceSubmodelFromMobileDeviceSubmodelName(
            fakePath,
          );
    ...
    describe('operatingSystem', async () => {
      ...
      await client.initialize();
      client.pathTemplates.operatingSystemPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.operatingSystemPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('operatingSystemPath', () => {
        const result = client.operatingSystemPath(
          'networkCodeValue',
          'operatingSystemValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.operatingSystemPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchNetworkCodeFromOperatingSystemName', () => {
        ...
        assert.strictEqual(result, 'networkCodeValue');
        assert(
          (client.pathTemplates.operatingSystemPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchOperatingSystemFromOperatingSystemName', () => {
        const result =
          client.matchOperatingSystemFromOperatingSystemName(fakePath);
    ...
    describe('operatingSystemVersion', async () => {
      ...
      await client.initialize();
      client.pathTemplates.operatingSystemVersionPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.operatingSystemVersionPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('operatingSystemVersionPath', () => {
        const result = client.operatingSystemVersionPath(
          'networkCodeValue',
        ...
        assert(
          (
            client.pathTemplates.operatingSystemVersionPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchNetworkCodeFromOperatingSystemVersionName', () => {
        const result =
          client.matchNetworkCodeFromOperatingSystemVersionName(fakePath);
        assert.strictEqual(result, 'networkCodeValue');
        assert(
          (
            client.pathTemplates.operatingSystemVersionPathTemplate
      ...
      it('matchOperatingSystemVersionFromOperatingSystemVersionName', () => {
        const result =
          client.matchOperatingSystemVersionFromOperatingSystemVersionName(
            fakePath,
          );
    ...
    describe('privateAuction', async () => {
      ...
      await client.initialize();
      client.pathTemplates.privateAuctionPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.privateAuctionPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('privateAuctionPath', () => {
        const result = client.privateAuctionPath(
          'networkCodeValue',
          'privateAuctionValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.privateAuctionPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchNetworkCodeFromPrivateAuctionName', () => {
        ...
        assert.strictEqual(result, 'networkCodeValue');
        assert(
          (client.pathTemplates.privateAuctionPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchPrivateAuctionFromPrivateAuctionName', () => {
        const result =
          client.matchPrivateAuctionFromPrivateAuctionName(fakePath);
    ...
    describe('privateAuctionDeal', async () => {
      ...
      await client.initialize();
      client.pathTemplates.privateAuctionDealPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.privateAuctionDealPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('privateAuctionDealPath', () => {
        const result = client.privateAuctionDealPath(
          'networkCodeValue',
          'privateAuctionDealValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.privateAuctionDealPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchNetworkCodeFromPrivateAuctionDealName', () => {
        const result =
          client.matchNetworkCodeFromPrivateAuctionDealName(fakePath);
        assert.strictEqual(result, 'networkCodeValue');
        assert(
          (
            client.pathTemplates.privateAuctionDealPathTemplate
      ...
      it('matchPrivateAuctionDealFromPrivateAuctionDealName', () => {
        const result =
          client.matchPrivateAuctionDealFromPrivateAuctionDealName(fakePath);
    ...
    describe('programmaticBuyer', async () => {
      ...
      await client.initialize();
      client.pathTemplates.programmaticBuyerPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.programmaticBuyerPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('programmaticBuyerPath', () => {
        const result = client.programmaticBuyerPath(
          'networkCodeValue',
          'programmaticBuyerValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.programmaticBuyerPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchNetworkCodeFromProgrammaticBuyerName', () => {
        const result =
          client.matchNetworkCodeFromProgrammaticBuyerName(fakePath);
        assert.strictEqual(result, 'networkCodeValue');
        assert(
          (
            client.pathTemplates.programmaticBuyerPathTemplate
      ...
      it('matchProgrammaticBuyerFromProgrammaticBuyerName', () => {
        const result =
          client.matchProgrammaticBuyerFromProgrammaticBuyerName(fakePath);
    ...
    describe('richMediaAdsCompany', async () => {
      ...
      await client.initialize();
      client.pathTemplates.richMediaAdsCompanyPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.richMediaAdsCompanyPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('richMediaAdsCompanyPath', () => {
        const result = client.richMediaAdsCompanyPath(
          'networkCodeValue',
          'richMediaAdsCompanyValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.richMediaAdsCompanyPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchNetworkCodeFromRichMediaAdsCompanyName', () => {
        const result =
          client.matchNetworkCodeFromRichMediaAdsCompanyName(fakePath);
        assert.strictEqual(result, 'networkCodeValue');
        assert(
          (
            client.pathTemplates.richMediaAdsCompanyPathTemplate
      ...
      it('matchRichMediaAdsCompanyFromRichMediaAdsCompanyName', () => {
        const result =
          client.matchRichMediaAdsCompanyFromRichMediaAdsCompanyName(fakePath);
    ...
    describe('webProperty', async () => {
      ...
      await client.initialize();
      client.pathTemplates.webPropertyPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.webPropertyPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('webPropertyPath', () => {
        const result = client.webPropertyPath(
          'networkCodeValue',
          'webPropertyValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.webPropertyPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchNetworkCodeFromWebPropertyName', () => {
        ...
        assert.strictEqual(result, 'networkCodeValue');
        assert(
          (client.pathTemplates.webPropertyPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
