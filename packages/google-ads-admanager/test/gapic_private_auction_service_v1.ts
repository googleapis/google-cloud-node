...
describe('v1.PrivateAuctionServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          privateauctionserviceModule.v1.PrivateAuctionServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        privateauctionserviceModule.v1.PrivateAuctionServiceClient.port;
      assert(port);
  ...
  describe('getPrivateAuction', () => {
    it('invokes getPrivateAuction without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getPrivateAuction as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getPrivateAuction without error using callback', async () => {
      ...
      client.innerApiCalls.getPrivateAuction =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getPrivateAuction(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IPrivateAuction | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getPrivateAuction with error', async () => {
      ...
      client.innerApiCalls.getPrivateAuction = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createPrivateAuction', () => {
    it('invokes createPrivateAuction without error', async () => {
      ...
      client.innerApiCalls.createPrivateAuction =
        stubSimpleCall(expectedResponse);
      const [response] = await client.createPrivateAuction(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createPrivateAuction as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createPrivateAuction as SinonStub
    ...
    it('invokes createPrivateAuction with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createPrivateAuction = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updatePrivateAuction', () => {
    it('invokes updatePrivateAuction without error', async () => {
      ...
      client.innerApiCalls.updatePrivateAuction =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updatePrivateAuction(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updatePrivateAuction as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updatePrivateAuction as SinonStub
    ...
    it('invokes updatePrivateAuction with error', async () => {
      ...
      const expectedHeaderRequestParams = `private_auction.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updatePrivateAuction = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listPrivateAuctions', () => {
    it('invokes listPrivateAuctions without error', async () => {
      ...
      client.innerApiCalls.listPrivateAuctions =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listPrivateAuctions(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listPrivateAuctions as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listPrivateAuctions as SinonStub
    ...
    it('invokes listPrivateAuctions with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listPrivateAuctions = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listPrivateAuctionsStream without error', async () => {
      ...
      client.descriptors.page.listPrivateAuctions.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.PrivateAuction) => {
      ...
      assert(
        (client.descriptors.page.listPrivateAuctions.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listPrivateAuctions, request),
      );
      assert(
        (client.descriptors.page.listPrivateAuctions.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listPrivateAuctions without error', async () => {
      ...
      client.descriptors.page.listPrivateAuctions.asyncIterate =
