...
describe('v1.LiveStreamServiceClient', () => {
  ...
  describe('getLiveStream', () => {
    it('invokes getLiveStream without error', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.GetLiveStreamRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.GetLiveStreamRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.LiveStream(),
      );
      client.innerApiCalls.getLiveStream = stubSimpleCall(expectedResponse);
      const [response] = await client.getLiveStream(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getLiveStream as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getLiveStream without error using callback', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.getLiveStream =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getLiveStream(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.ILiveStream | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getLiveStream with error', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.getLiveStream = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes getLiveStream with closed client', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('createLiveStream', () => {
    it('invokes createLiveStream without error', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.CreateLiveStreamRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.createLiveStream = stubSimpleCall(expectedResponse);
      const [response] = await client.createLiveStream(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createLiveStream as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createLiveStream as SinonStub
    ...
    it('invokes createLiveStream without error using callback', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.createLiveStream =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createLiveStream(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.ILiveStream | null,
    ...
    it('invokes createLiveStream with error', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createLiveStream = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes createLiveStream with closed client', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchCreateLiveStreams', () => {
    it('invokes batchCreateLiveStreams without error', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchCreateLiveStreamsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchCreateLiveStreamsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchCreateLiveStreamsResponse(),
      );
      client.innerApiCalls.batchCreateLiveStreams =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchCreateLiveStreams(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchCreateLiveStreams as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchCreateLiveStreams as SinonStub
    ...
    it('invokes batchCreateLiveStreams without error using callback', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchCreateLiveStreams =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchCreateLiveStreams(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchCreateLiveStreamsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchCreateLiveStreams with error', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchCreateLiveStreams = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchCreateLiveStreams(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchCreateLiveStreams as SinonStub
    ...
    it('invokes batchCreateLiveStreams with closed client', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('updateLiveStream', () => {
    it('invokes updateLiveStream without error', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.UpdateLiveStreamRequest(),
      );
      request.liveStream ??= {};
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `live_stream.name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.LiveStream(),
      );
      client.innerApiCalls.updateLiveStream = stubSimpleCall(expectedResponse);
      const [response] = await client.updateLiveStream(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateLiveStream as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateLiveStream as SinonStub
    ...
    it('invokes updateLiveStream without error using callback', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.updateLiveStream =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.updateLiveStream(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.ILiveStream | null,
    ...
    it('invokes updateLiveStream with error', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `live_stream.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateLiveStream = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes updateLiveStream with closed client', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchUpdateLiveStreams', () => {
    it('invokes batchUpdateLiveStreams without error', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUpdateLiveStreamsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchUpdateLiveStreamsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUpdateLiveStreamsResponse(),
      );
      client.innerApiCalls.batchUpdateLiveStreams =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchUpdateLiveStreams(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchUpdateLiveStreams as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchUpdateLiveStreams as SinonStub
    ...
    it('invokes batchUpdateLiveStreams without error using callback', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchUpdateLiveStreams =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchUpdateLiveStreams(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchUpdateLiveStreamsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchUpdateLiveStreams with error', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchUpdateLiveStreams = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchUpdateLiveStreams(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchUpdateLiveStreams as SinonStub
    ...
    it('invokes batchUpdateLiveStreams with closed client', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchActivateLiveStreams', () => {
    it('invokes batchActivateLiveStreams without error', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchActivateLiveStreamsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchActivateLiveStreamsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchActivateLiveStreamsResponse(),
      );
      client.innerApiCalls.batchActivateLiveStreams =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchActivateLiveStreams(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchActivateLiveStreams as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchActivateLiveStreams as SinonStub
    ...
    it('invokes batchActivateLiveStreams without error using callback', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchActivateLiveStreams =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchActivateLiveStreams(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchActivateLiveStreamsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchActivateLiveStreams with error', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchActivateLiveStreams = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchActivateLiveStreams(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchActivateLiveStreams as SinonStub
    ...
    it('invokes batchActivateLiveStreams with closed client', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchPauseLiveStreams', () => {
    it('invokes batchPauseLiveStreams without error', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchPauseLiveStreamsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchPauseLiveStreamsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchPauseLiveStreamsResponse(),
      );
      client.innerApiCalls.batchPauseLiveStreams =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchPauseLiveStreams(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchPauseLiveStreams as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchPauseLiveStreams as SinonStub
    ...
    it('invokes batchPauseLiveStreams without error using callback', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchPauseLiveStreams =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchPauseLiveStreams(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchPauseLiveStreamsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchPauseLiveStreams with error', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchPauseLiveStreams = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchPauseLiveStreams(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchPauseLiveStreams as SinonStub
    ...
    it('invokes batchPauseLiveStreams with closed client', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchArchiveLiveStreams', () => {
    it('invokes batchArchiveLiveStreams without error', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchArchiveLiveStreamsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchArchiveLiveStreamsResponse(),
      );
      client.innerApiCalls.batchArchiveLiveStreams =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchArchiveLiveStreams(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchArchiveLiveStreams as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchArchiveLiveStreams as SinonStub
    ...
    it('invokes batchArchiveLiveStreams without error using callback', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchArchiveLiveStreams =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchArchiveLiveStreams(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchArchiveLiveStreamsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchArchiveLiveStreams with error', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchArchiveLiveStreams = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchArchiveLiveStreams(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchArchiveLiveStreams as SinonStub
    ...
    it('invokes batchArchiveLiveStreams with closed client', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchPauseAdsLiveStreams', () => {
    it('invokes batchPauseAdsLiveStreams without error', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchPauseAdsLiveStreamsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchPauseAdsLiveStreamsResponse(),
      );
      client.innerApiCalls.batchPauseAdsLiveStreams =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchPauseAdsLiveStreams(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchPauseAdsLiveStreams as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchPauseAdsLiveStreams as SinonStub
    ...
    it('invokes batchPauseAdsLiveStreams without error using callback', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchPauseAdsLiveStreams =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchPauseAdsLiveStreams(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchPauseAdsLiveStreamsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchPauseAdsLiveStreams with error', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchPauseAdsLiveStreams = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchPauseAdsLiveStreams(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchPauseAdsLiveStreams as SinonStub
    ...
    it('invokes batchPauseAdsLiveStreams with closed client', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchRefreshMasterPlaylists', () => {
    it('invokes batchRefreshMasterPlaylists without error', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchRefreshMasterPlaylistsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchRefreshMasterPlaylistsResponse(),
      );
      client.innerApiCalls.batchRefreshMasterPlaylists =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchRefreshMasterPlaylists(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchRefreshMasterPlaylists as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchRefreshMasterPlaylists as SinonStub
    ...
    it('invokes batchRefreshMasterPlaylists without error using callback', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchRefreshMasterPlaylists =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchRefreshMasterPlaylists(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchRefreshMasterPlaylistsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchRefreshMasterPlaylists with error', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchRefreshMasterPlaylists = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchRefreshMasterPlaylists(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchRefreshMasterPlaylists as SinonStub
    ...
    it('invokes batchRefreshMasterPlaylists with closed client', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('listLiveStreams', () => {
    it('invokes listLiveStreams without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.ListLiveStreamsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.ListLiveStreamsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = [
        generateSampleMessage(new protos.google.ads.admanager.v1.LiveStream()),
        generateSampleMessage(new protos.google.ads.admanager.v1.LiveStream()),
        generateSampleMessage(new protos.google.ads.admanager.v1.LiveStream()),
      ];
      client.innerApiCalls.listLiveStreams = stubSimpleCall(expectedResponse);
      const [response] = await client.listLiveStreams(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listLiveStreams as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listLiveStreams as SinonStub
    ...
    it('invokes listLiveStreams without error using callback', async () => {
      ...
      client.innerApiCalls.listLiveStreams =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listLiveStreams(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.ILiveStream[] | null,
    ...
    it('invokes listLiveStreams with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listLiveStreams = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.listLiveStreams(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.listLiveStreams as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes listLiveStreamsStream without error', async () => {
      ...
      client.descriptors.page.listLiveStreams.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listLiveStreamsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.ads.admanager.v1.LiveStream[] = [];
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.LiveStream) => {
      ...
      assert(
        (client.descriptors.page.listLiveStreams.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listLiveStreams, request),
      );
      assert(
        (client.descriptors.page.listLiveStreams.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listLiveStreams without error', async () => {
      const client = new livestreamserviceModule.v1.LiveStreamServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.descriptors.page.listLiveStreams.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.ads.admanager.v1.ILiveStream[] = [];
      const iterable = client.listLiveStreamsAsync(request);
