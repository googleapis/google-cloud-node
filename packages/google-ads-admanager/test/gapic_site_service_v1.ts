...
describe('v1.SiteServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new siteserviceModule.v1.SiteServiceClient({
          universe_domain: 'example.com',
  ...
  describe('getSite', () => {
    it('invokes getSite without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.GetSiteRequest',
        ['name'],
      );
    ...
    it('invokes getSite without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getSite(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.ISite | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createSite', () => {
    it('invokes createSite without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.CreateSiteRequest',
        ['parent'],
      );
    ...
    it('invokes createSite with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createSite = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('batchCreateSites', () => {
    it('invokes batchCreateSites without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchCreateSites as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchCreateSites as SinonStub
    ...
    it('invokes batchCreateSites without error using callback', async () => {
      ...
      client.innerApiCalls.batchCreateSites =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchCreateSites(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchCreateSitesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchCreateSites with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchCreateSites = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateSite', () => {
    it('invokes updateSite without error', async () => {
      ...
      request.site ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.UpdateSiteRequest',
        ['site', 'name'],
      );
    ...
    it('invokes updateSite with error', async () => {
      ...
      const expectedHeaderRequestParams = `site.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateSite = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('batchUpdateSites', () => {
    it('invokes batchUpdateSites without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchUpdateSites as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchUpdateSites as SinonStub
    ...
    it('invokes batchUpdateSites without error using callback', async () => {
      ...
      client.innerApiCalls.batchUpdateSites =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchUpdateSites(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchUpdateSitesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchUpdateSites with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchUpdateSites = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('batchDeactivateSites', () => {
    it('invokes batchDeactivateSites without error', async () => {
      ...
      client.innerApiCalls.batchDeactivateSites =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchDeactivateSites(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchDeactivateSites as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchDeactivateSites as SinonStub
    ...
    it('invokes batchDeactivateSites without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchDeactivateSites(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchDeactivateSitesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('batchSubmitSitesForApproval', () => {
    it('invokes batchSubmitSitesForApproval without error', async () => {
      ...
      client.innerApiCalls.batchSubmitSitesForApproval =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchSubmitSitesForApproval(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchSubmitSitesForApproval as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchSubmitSitesForApproval as SinonStub
    ...
    it('invokes batchSubmitSitesForApproval without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchSubmitSitesForApproval(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchSubmitSitesForApprovalResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchSubmitSitesForApproval with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchSubmitSitesForApproval = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchSubmitSitesForApproval(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchSubmitSitesForApproval as SinonStub
