...
import * as breaktemplateserviceModule from '../src';
...
describe('v1.BreakTemplateServiceClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new breaktemplateserviceModule.v1.BreakTemplateServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          breaktemplateserviceModule.v1.BreakTemplateServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          breaktemplateserviceModule.v1.BreakTemplateServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        breaktemplateserviceModule.v1.BreakTemplateServiceClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.breakTemplateServiceStub, undefined);
      await client.initialize();
      assert(client.breakTemplateServiceStub);
    });
  ...
  describe('getBreakTemplate', () => {
    it('invokes getBreakTemplate without error', async () => {
      const client =
        new breaktemplateserviceModule.v1.BreakTemplateServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.GetBreakTemplateRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.GetBreakTemplateRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BreakTemplate(),
      );
      client.innerApiCalls.getBreakTemplate = stubSimpleCall(expectedResponse);
      const [response] = await client.getBreakTemplate(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getBreakTemplate as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getBreakTemplate without error using callback', async () => {
      const client =
        new breaktemplateserviceModule.v1.BreakTemplateServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.getBreakTemplate =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getBreakTemplate(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBreakTemplate | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getBreakTemplate with error', async () => {
      const client =
        new breaktemplateserviceModule.v1.BreakTemplateServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.getBreakTemplate = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.getBreakTemplate(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.getBreakTemplate as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes getBreakTemplate with closed client', async () => {
      const client =
        new breaktemplateserviceModule.v1.BreakTemplateServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('createBreakTemplate', () => {
    it('invokes createBreakTemplate without error', async () => {
      const client =
        new breaktemplateserviceModule.v1.BreakTemplateServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.CreateBreakTemplateRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.CreateBreakTemplateRequest',
        ['parent'],
      );
      ...
      client.innerApiCalls.createBreakTemplate =
        stubSimpleCall(expectedResponse);
      const [response] = await client.createBreakTemplate(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createBreakTemplate as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createBreakTemplate as SinonStub
    ...
    it('invokes createBreakTemplate without error using callback', async () => {
      const client =
        new breaktemplateserviceModule.v1.BreakTemplateServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
    ...
    it('invokes createBreakTemplate with error', async () => {
      const client =
        new breaktemplateserviceModule.v1.BreakTemplateServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createBreakTemplate = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.createBreakTemplate(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.createBreakTemplate as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes createBreakTemplate with closed client', async () => {
      const client =
        new breaktemplateserviceModule.v1.BreakTemplateServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('batchCreateBreakTemplates', () => {
    it('invokes batchCreateBreakTemplates without error', async () => {
      const client =
        new breaktemplateserviceModule.v1.BreakTemplateServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchCreateBreakTemplatesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchCreateBreakTemplatesRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchCreateBreakTemplatesResponse(),
      );
      client.innerApiCalls.batchCreateBreakTemplates =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchCreateBreakTemplates(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchCreateBreakTemplates as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchCreateBreakTemplates as SinonStub
    ...
    it('invokes batchCreateBreakTemplates without error using callback', async () => {
      const client =
        new breaktemplateserviceModule.v1.BreakTemplateServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.batchCreateBreakTemplates =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchCreateBreakTemplates(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchCreateBreakTemplatesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchCreateBreakTemplates with error', async () => {
      const client =
        new breaktemplateserviceModule.v1.BreakTemplateServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchCreateBreakTemplates = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchCreateBreakTemplates(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchCreateBreakTemplates as SinonStub
    ...
    it('invokes batchCreateBreakTemplates with closed client', async () => {
      const client =
        new breaktemplateserviceModule.v1.BreakTemplateServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('updateBreakTemplate', () => {
    it('invokes updateBreakTemplate without error', async () => {
      const client =
        new breaktemplateserviceModule.v1.BreakTemplateServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.UpdateBreakTemplateRequest(),
      );
      request.breakTemplate ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.UpdateBreakTemplateRequest',
        ['breakTemplate', 'name'],
      );
      request.breakTemplate.name = defaultValue1;
      const expectedHeaderRequestParams = `break_template.name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BreakTemplate(),
      );
      client.innerApiCalls.updateBreakTemplate =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateBreakTemplate(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateBreakTemplate as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateBreakTemplate as SinonStub
    ...
    it('invokes updateBreakTemplate without error using callback', async () => {
      const client =
        new breaktemplateserviceModule.v1.BreakTemplateServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
    ...
    it('invokes updateBreakTemplate with error', async () => {
      const client =
        new breaktemplateserviceModule.v1.BreakTemplateServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `break_template.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateBreakTemplate = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.updateBreakTemplate(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.updateBreakTemplate as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes updateBreakTemplate with closed client', async () => {
      const client =
        new breaktemplateserviceModule.v1.BreakTemplateServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('batchUpdateBreakTemplates', () => {
    it('invokes batchUpdateBreakTemplates without error', async () => {
      const client =
        new breaktemplateserviceModule.v1.BreakTemplateServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUpdateBreakTemplatesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchUpdateBreakTemplatesRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUpdateBreakTemplatesResponse(),
      );
      client.innerApiCalls.batchUpdateBreakTemplates =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchUpdateBreakTemplates(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchUpdateBreakTemplates as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchUpdateBreakTemplates as SinonStub
    ...
    it('invokes batchUpdateBreakTemplates without error using callback', async () => {
      const client =
        new breaktemplateserviceModule.v1.BreakTemplateServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.batchUpdateBreakTemplates =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchUpdateBreakTemplates(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchUpdateBreakTemplatesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchUpdateBreakTemplates with error', async () => {
      const client =
        new breaktemplateserviceModule.v1.BreakTemplateServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchUpdateBreakTemplates = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchUpdateBreakTemplates(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchUpdateBreakTemplates as SinonStub
    ...
    it('invokes batchUpdateBreakTemplates with closed client', async () => {
      const client =
        new breaktemplateserviceModule.v1.BreakTemplateServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('listBreakTemplates', () => {
    it('invokes listBreakTemplates without error', async () => {
      const client =
        new breaktemplateserviceModule.v1.BreakTemplateServiceClient({
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.ListBreakTemplatesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.ListBreakTemplatesRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.listBreakTemplates =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listBreakTemplates(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listBreakTemplates as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listBreakTemplates as SinonStub
    ...
    it('invokes listBreakTemplates without error using callback', async () => {
      const client =
        new breaktemplateserviceModule.v1.BreakTemplateServiceClient({
          credentials: {client_email: 'bogus', private_key: 'bogus'},
          projectId: 'bogus',
    ...
    it('invokes listBreakTemplates with error', async () => {
      const client =
        new breaktemplateserviceModule.v1.BreakTemplateServiceClient({
          credentials: {client_email: 'bogus', private_key: 'bogus'},
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listBreakTemplates = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.listBreakTemplates(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.listBreakTemplates as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes listBreakTemplatesStream without error', async () => {
      const client =
        new breaktemplateserviceModule.v1.BreakTemplateServiceClient({
          credentials: {client_email: 'bogus', private_key: 'bogus'},
          projectId: 'bogus',
      ...
      client.descriptors.page.listBreakTemplates.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listBreakTemplatesStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.ads.admanager.v1.BreakTemplate[] = [];
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.BreakTemplate) => {
      ...
      assert(
        (client.descriptors.page.listBreakTemplates.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listBreakTemplates, request),
      );
      assert(
        (client.descriptors.page.listBreakTemplates.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listBreakTemplatesStream with error', async () => {
      const client =
        new breaktemplateserviceModule.v1.BreakTemplateServiceClient({
          credentials: {client_email: 'bogus', private_key: 'bogus'},
          projectId: 'bogus',
    ...
    it('uses async iteration with listBreakTemplates without error', async () => {
      const client =
        new breaktemplateserviceModule.v1.BreakTemplateServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.descriptors.page.listBreakTemplates.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.ads.admanager.v1.IBreakTemplate[] = [];
      const iterable = client.listBreakTemplatesAsync(request);
      ...
      assert.deepStrictEqual(
        (
          client.descriptors.page.listBreakTemplates.asyncIterate as SinonStub
        ).getCall(0).args[1],
        request,
      );
      assert(
    ...
    it('uses async iteration with listBreakTemplates with error', async () => {
      const client =
        new breaktemplateserviceModule.v1.BreakTemplateServiceClient({
          credentials: {client_email: 'bogus', private_key: 'bogus'},
          projectId: 'bogus',
