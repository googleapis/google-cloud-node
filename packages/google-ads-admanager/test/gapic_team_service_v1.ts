  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = teamserviceModule.v1.TeamServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = teamserviceModule.v1.TeamServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new teamserviceModule.v1.TeamServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new teamserviceModule.v1.TeamServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new teamserviceModule.v1.TeamServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new teamserviceModule.v1.TeamServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = teamserviceModule.v1.TeamServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.teamServiceStub, undefined);
    ...
    describe('getTeam', () => {
        it('invokes getTeam without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.GetTeamRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetTeamRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.Team()
            );
        ...
        it('invokes getTeam without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getTeam(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.ITeam|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createTeam', () => {
        it('invokes createTeam without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.CreateTeamRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.CreateTeamRequest', ['parent']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createTeam as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createTeam as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('batchCreateTeams', () => {
        it('invokes batchCreateTeams without error', async () => {
            const client = new teamserviceModule.v1.TeamServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.BatchCreateTeamsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.BatchCreateTeamsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.BatchCreateTeamsResponse()
            );
            client.innerApiCalls.batchCreateTeams = stubSimpleCall(expectedResponse);
            const [response] = await client.batchCreateTeams(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchCreateTeams as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchCreateTeams as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes batchCreateTeams without error using callback', async () => {
            const client = new teamserviceModule.v1.TeamServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.batchCreateTeams = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchCreateTeams(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IBatchCreateTeamsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchCreateTeams with error', async () => {
            const client = new teamserviceModule.v1.TeamServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchCreateTeams = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes batchCreateTeams with closed client', async () => {
            const client = new teamserviceModule.v1.TeamServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('updateTeam', () => {
        it('invokes updateTeam without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.UpdateTeamRequest()
            );
            request.team ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.UpdateTeamRequest', ['team', 'name']);
    ...
    describe('batchUpdateTeams', () => {
        it('invokes batchUpdateTeams without error', async () => {
            const client = new teamserviceModule.v1.TeamServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.BatchUpdateTeamsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.BatchUpdateTeamsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.BatchUpdateTeamsResponse()
            );
            client.innerApiCalls.batchUpdateTeams = stubSimpleCall(expectedResponse);
            const [response] = await client.batchUpdateTeams(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchUpdateTeams as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchUpdateTeams as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes batchUpdateTeams without error using callback', async () => {
            const client = new teamserviceModule.v1.TeamServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.batchUpdateTeams = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchUpdateTeams(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IBatchUpdateTeamsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchUpdateTeams with error', async () => {
            const client = new teamserviceModule.v1.TeamServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchUpdateTeams = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes batchUpdateTeams with closed client', async () => {
            const client = new teamserviceModule.v1.TeamServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('batchActivateTeams', () => {
        it('invokes batchActivateTeams without error', async () => {
            const client = new teamserviceModule.v1.TeamServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.BatchActivateTeamsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.BatchActivateTeamsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.BatchActivateTeamsResponse()
            );
            client.innerApiCalls.batchActivateTeams = stubSimpleCall(expectedResponse);
            const [response] = await client.batchActivateTeams(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchActivateTeams as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchActivateTeams as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes batchActivateTeams without error using callback', async () => {
            const client = new teamserviceModule.v1.TeamServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.batchActivateTeams = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchActivateTeams(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IBatchActivateTeamsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchActivateTeams with error', async () => {
            const client = new teamserviceModule.v1.TeamServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchActivateTeams = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes batchActivateTeams with closed client', async () => {
            const client = new teamserviceModule.v1.TeamServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('batchDeactivateTeams', () => {
        it('invokes batchDeactivateTeams without error', async () => {
            const client = new teamserviceModule.v1.TeamServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.BatchDeactivateTeamsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.BatchDeactivateTeamsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.BatchDeactivateTeamsResponse()
            );
            client.innerApiCalls.batchDeactivateTeams = stubSimpleCall(expectedResponse);
            const [response] = await client.batchDeactivateTeams(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchDeactivateTeams as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchDeactivateTeams as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes batchDeactivateTeams without error using callback', async () => {
            const client = new teamserviceModule.v1.TeamServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.batchDeactivateTeams = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchDeactivateTeams(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IBatchDeactivateTeamsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchDeactivateTeams with error', async () => {
            const client = new teamserviceModule.v1.TeamServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchDeactivateTeams = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes batchDeactivateTeams with closed client', async () => {
            const client = new teamserviceModule.v1.TeamServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('listTeams', () => {
        it('invokes listTeams without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.ListTeamsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListTeamsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.Team()),
              generateSampleMessage(new protos.google.ads.admanager.v1.Team()),
              generateSampleMessage(new protos.google.ads.admanager.v1.Team()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listTeams as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listTeams as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listTeamsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.Team[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.Team) => {
        ...
        it('uses async iteration with listTeams without error', async () => {
            ...
            const responses: protos.google.ads.admanager.v1.ITeam[] = [];
