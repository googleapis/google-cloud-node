...
describe('v1.TeamServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new teamserviceModule.v1.TeamServiceClient({
          universe_domain: 'example.com',
  ...
  describe('getTeam', () => {
    it('invokes getTeam without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.GetTeamRequest',
        ['name'],
      );
      ...
      const actualRequest = (client.innerApiCalls.getTeam as SinonStub).getCall(
        0,
      ).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getTeam as SinonStub
    ...
    it('invokes getTeam without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getTeam(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.ITeam | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createTeam', () => {
    it('invokes createTeam without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.CreateTeamRequest',
        ['parent'],
      );
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createTeam as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createTeam as SinonStub
    ...
    it('invokes createTeam without error using callback', async () => {
      ...
      client.innerApiCalls.createTeam =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createTeam(
          request,
    ...
    it('invokes createTeam with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createTeam = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('batchCreateTeams', () => {
    it('invokes batchCreateTeams without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchCreateTeams as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchCreateTeams as SinonStub
    ...
    it('invokes batchCreateTeams without error using callback', async () => {
      ...
      client.innerApiCalls.batchCreateTeams =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchCreateTeams(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchCreateTeamsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchCreateTeams with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchCreateTeams = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateTeam', () => {
    it('invokes updateTeam without error', async () => {
      ...
      request.team ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.UpdateTeamRequest',
        ['team', 'name'],
      );
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateTeam as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateTeam as SinonStub
    ...
    it('invokes updateTeam without error using callback', async () => {
      ...
      client.innerApiCalls.updateTeam =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.updateTeam(
          request,
    ...
    it('invokes updateTeam with error', async () => {
      ...
      const expectedHeaderRequestParams = `team.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateTeam = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('batchUpdateTeams', () => {
    it('invokes batchUpdateTeams without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchUpdateTeams as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchUpdateTeams as SinonStub
    ...
    it('invokes batchUpdateTeams without error using callback', async () => {
      ...
      client.innerApiCalls.batchUpdateTeams =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchUpdateTeams(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchUpdateTeamsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchUpdateTeams with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchUpdateTeams = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('batchActivateTeams', () => {
    it('invokes batchActivateTeams without error', async () => {
      ...
      client.innerApiCalls.batchActivateTeams =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchActivateTeams(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchActivateTeams as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchActivateTeams as SinonStub
    ...
    it('invokes batchActivateTeams without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchActivateTeams(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchActivateTeamsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchActivateTeams with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchActivateTeams = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('batchDeactivateTeams', () => {
    it('invokes batchDeactivateTeams without error', async () => {
      ...
      client.innerApiCalls.batchDeactivateTeams =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchDeactivateTeams(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchDeactivateTeams as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchDeactivateTeams as SinonStub
    ...
    it('invokes batchDeactivateTeams without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchDeactivateTeams(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchDeactivateTeamsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchDeactivateTeams with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchDeactivateTeams = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listTeams', () => {
    it('invokes listTeams without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listTeams as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listTeams as SinonStub
    ...
    it('invokes listTeams without error using callback', async () => {
      ...
      client.innerApiCalls.listTeams =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listTeams(
          request,
    ...
    it('invokes listTeamsStream without error', async () => {
      ...
      client.descriptors.page.listTeams.createStream =
      ...
      assert(
        (client.descriptors.page.listTeams.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listTeams, request),
      );
      assert(
        (client.descriptors.page.listTeams.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listTeamsStream with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listTeams.createStream = stubPageStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.listTeamsStream(request);
    ...
    it('uses async iteration with listTeams without error', async () => {
      ...
      client.descriptors.page.listTeams.asyncIterate =
      ...
      assert.deepStrictEqual(
        (client.descriptors.page.listTeams.asyncIterate as SinonStub).getCall(0)
          .args[1],
        request,
      );
      assert(
    ...
    it('uses async iteration with listTeams with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listTeams.asyncIterate = stubAsyncIterationCall(
        undefined,
        expectedError,
      );
      const iterable = client.listTeamsAsync(request);
