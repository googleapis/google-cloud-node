...
import * as programmaticbuyerserviceModule from '../src';
...
describe('v1.ProgrammaticBuyerServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new programmaticbuyerserviceModule.v1.ProgrammaticBuyerServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = programmaticbuyerserviceModule.v1.ProgrammaticBuyerServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = programmaticbuyerserviceModule.v1.ProgrammaticBuyerServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new programmaticbuyerserviceModule.v1.ProgrammaticBuyerServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new programmaticbuyerserviceModule.v1.ProgrammaticBuyerServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new programmaticbuyerserviceModule.v1.ProgrammaticBuyerServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new programmaticbuyerserviceModule.v1.ProgrammaticBuyerServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = programmaticbuyerserviceModule.v1.ProgrammaticBuyerServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.programmaticBuyerServiceStub, undefined);
            await client.initialize();
            assert(client.programmaticBuyerServiceStub);
        });
    ...
    describe('getProgrammaticBuyer', () => {
        it('invokes getProgrammaticBuyer without error', async () => {
            const client = new programmaticbuyerserviceModule.v1.ProgrammaticBuyerServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.GetProgrammaticBuyerRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetProgrammaticBuyerRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.ProgrammaticBuyer()
            );
            client.innerApiCalls.getProgrammaticBuyer = stubSimpleCall(expectedResponse);
            const [response] = await client.getProgrammaticBuyer(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getProgrammaticBuyer as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getProgrammaticBuyer as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getProgrammaticBuyer without error using callback', async () => {
            const client = new programmaticbuyerserviceModule.v1.ProgrammaticBuyerServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getProgrammaticBuyer = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getProgrammaticBuyer(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IProgrammaticBuyer|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getProgrammaticBuyer with error', async () => {
            const client = new programmaticbuyerserviceModule.v1.ProgrammaticBuyerServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getProgrammaticBuyer = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getProgrammaticBuyer(request), expectedError);
            const actualRequest = (client.innerApiCalls.getProgrammaticBuyer as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getProgrammaticBuyer as SinonStub)
        ...
        it('invokes getProgrammaticBuyer with closed client', async () => {
            const client = new programmaticbuyerserviceModule.v1.ProgrammaticBuyerServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('listProgrammaticBuyers', () => {
        it('invokes listProgrammaticBuyers without error', async () => {
            const client = new programmaticbuyerserviceModule.v1.ProgrammaticBuyerServiceClient({
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.ListProgrammaticBuyersRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListProgrammaticBuyersRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.ProgrammaticBuyer()),
              generateSampleMessage(new protos.google.ads.admanager.v1.ProgrammaticBuyer()),
              generateSampleMessage(new protos.google.ads.admanager.v1.ProgrammaticBuyer()),
            ];
            client.innerApiCalls.listProgrammaticBuyers = stubSimpleCall(expectedResponse);
            const [response] = await client.listProgrammaticBuyers(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listProgrammaticBuyers as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listProgrammaticBuyers as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes listProgrammaticBuyers without error using callback', async () => {
            const client = new programmaticbuyerserviceModule.v1.ProgrammaticBuyerServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listProgrammaticBuyers = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listProgrammaticBuyers(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IProgrammaticBuyer[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listProgrammaticBuyers with error', async () => {
            const client = new programmaticbuyerserviceModule.v1.ProgrammaticBuyerServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listProgrammaticBuyers = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listProgrammaticBuyers(request), expectedError);
            const actualRequest = (client.innerApiCalls.listProgrammaticBuyers as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listProgrammaticBuyers as SinonStub)
        ...
        it('invokes listProgrammaticBuyersStream without error', async () => {
            const client = new programmaticbuyerserviceModule.v1.ProgrammaticBuyerServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listProgrammaticBuyers.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listProgrammaticBuyersStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.ProgrammaticBuyer[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.ProgrammaticBuyer) => {
            ...
            assert((client.descriptors.page.listProgrammaticBuyers.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listProgrammaticBuyers, request));
            assert(
                (client.descriptors.page.listProgrammaticBuyers.createStream as SinonStub)
        ...
        it('invokes listProgrammaticBuyersStream with error', async () => {
            const client = new programmaticbuyerserviceModule.v1.ProgrammaticBuyerServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listProgrammaticBuyers.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listProgrammaticBuyersStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.ProgrammaticBuyer[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.ProgrammaticBuyer) => {
        ...
        it('uses async iteration with listProgrammaticBuyers without error', async () => {
            const client = new programmaticbuyerserviceModule.v1.ProgrammaticBuyerServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listProgrammaticBuyers.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.admanager.v1.IProgrammaticBuyer[] = [];
            const iterable = client.listProgrammaticBuyersAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listProgrammaticBuyers.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listProgrammaticBuyers with error', async () => {
            const client = new programmaticbuyerserviceModule.v1.ProgrammaticBuyerServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listProgrammaticBuyers.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listProgrammaticBuyersAsync(request);
