...
describe('v1.CdnConfigServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          cdnconfigserviceModule.v1.CdnConfigServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          cdnconfigserviceModule.v1.CdnConfigServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new cdnconfigserviceModule.v1.CdnConfigServiceClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = cdnconfigserviceModule.v1.CdnConfigServiceClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.cdnConfigServiceStub, undefined);
  ...
  describe('getCdnConfig', () => {
    it('invokes getCdnConfig without error', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.GetCdnConfigRequest(),
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.CdnConfig(),
      );
      client.innerApiCalls.getCdnConfig = stubSimpleCall(expectedResponse);
      const [response] = await client.getCdnConfig(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getCdnConfig as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getCdnConfig without error using callback', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.getCdnConfig =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getCdnConfig(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.ICdnConfig | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getCdnConfig with error', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.getCdnConfig = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes getCdnConfig with closed client', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('createCdnConfig', () => {
    it('invokes createCdnConfig without error', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.CreateCdnConfigRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.createCdnConfig = stubSimpleCall(expectedResponse);
      const [response] = await client.createCdnConfig(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createCdnConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createCdnConfig as SinonStub
    ...
    it('invokes createCdnConfig without error using callback', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.createCdnConfig =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createCdnConfig(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.ICdnConfig | null,
    ...
    it('invokes createCdnConfig with error', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createCdnConfig = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes createCdnConfig with closed client', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchCreateCdnConfigs', () => {
    it('invokes batchCreateCdnConfigs without error', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchCreateCdnConfigsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchCreateCdnConfigsResponse(),
      );
      client.innerApiCalls.batchCreateCdnConfigs =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchCreateCdnConfigs(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchCreateCdnConfigs as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchCreateCdnConfigs as SinonStub
    ...
    it('invokes batchCreateCdnConfigs without error using callback', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchCreateCdnConfigs =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchCreateCdnConfigs(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchCreateCdnConfigsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchCreateCdnConfigs with error', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchCreateCdnConfigs = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchCreateCdnConfigs(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchCreateCdnConfigs as SinonStub
    ...
    it('invokes batchCreateCdnConfigs with closed client', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('updateCdnConfig', () => {
    it('invokes updateCdnConfig without error', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.UpdateCdnConfigRequest(),
      );
      request.cdnConfig ??= {};
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `cdn_config.name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.CdnConfig(),
      );
      client.innerApiCalls.updateCdnConfig = stubSimpleCall(expectedResponse);
      const [response] = await client.updateCdnConfig(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateCdnConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateCdnConfig as SinonStub
    ...
    it('invokes updateCdnConfig without error using callback', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.updateCdnConfig =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.updateCdnConfig(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.ICdnConfig | null,
    ...
    it('invokes updateCdnConfig with error', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `cdn_config.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateCdnConfig = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes updateCdnConfig with closed client', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchUpdateCdnConfigs', () => {
    it('invokes batchUpdateCdnConfigs without error', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUpdateCdnConfigsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUpdateCdnConfigsResponse(),
      );
      client.innerApiCalls.batchUpdateCdnConfigs =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchUpdateCdnConfigs(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchUpdateCdnConfigs as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchUpdateCdnConfigs as SinonStub
    ...
    it('invokes batchUpdateCdnConfigs without error using callback', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchUpdateCdnConfigs =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchUpdateCdnConfigs(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchUpdateCdnConfigsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchUpdateCdnConfigs with error', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchUpdateCdnConfigs = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchUpdateCdnConfigs(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchUpdateCdnConfigs as SinonStub
    ...
    it('invokes batchUpdateCdnConfigs with closed client', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchActivateCdnConfigs', () => {
    it('invokes batchActivateCdnConfigs without error', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchActivateCdnConfigsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchActivateCdnConfigsResponse(),
      );
      client.innerApiCalls.batchActivateCdnConfigs =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchActivateCdnConfigs(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchActivateCdnConfigs as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchActivateCdnConfigs as SinonStub
    ...
    it('invokes batchActivateCdnConfigs without error using callback', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchActivateCdnConfigs =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchActivateCdnConfigs(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchActivateCdnConfigsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchActivateCdnConfigs with error', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchActivateCdnConfigs = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchActivateCdnConfigs(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchActivateCdnConfigs as SinonStub
    ...
    it('invokes batchActivateCdnConfigs with closed client', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchArchiveCdnConfigs', () => {
    it('invokes batchArchiveCdnConfigs without error', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchArchiveCdnConfigsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchArchiveCdnConfigsResponse(),
      );
      client.innerApiCalls.batchArchiveCdnConfigs =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchArchiveCdnConfigs(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchArchiveCdnConfigs as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchArchiveCdnConfigs as SinonStub
    ...
    it('invokes batchArchiveCdnConfigs without error using callback', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchArchiveCdnConfigs =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchArchiveCdnConfigs(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchArchiveCdnConfigsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchArchiveCdnConfigs with error', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchArchiveCdnConfigs = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchArchiveCdnConfigs(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchArchiveCdnConfigs as SinonStub
    ...
    it('invokes batchArchiveCdnConfigs with closed client', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('listCdnConfigs', () => {
    it('invokes listCdnConfigs without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.ListCdnConfigsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedResponse = [
        generateSampleMessage(new protos.google.ads.admanager.v1.CdnConfig()),
        generateSampleMessage(new protos.google.ads.admanager.v1.CdnConfig()),
        generateSampleMessage(new protos.google.ads.admanager.v1.CdnConfig()),
      ];
      client.innerApiCalls.listCdnConfigs = stubSimpleCall(expectedResponse);
      const [response] = await client.listCdnConfigs(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listCdnConfigs as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listCdnConfigs as SinonStub
    ...
    it('invokes listCdnConfigs without error using callback', async () => {
      ...
      client.innerApiCalls.listCdnConfigs =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listCdnConfigs(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.ICdnConfig[] | null,
    ...
    it('invokes listCdnConfigs with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listCdnConfigs = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.listCdnConfigs(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.listCdnConfigs as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes listCdnConfigsStream without error', async () => {
      ...
      client.descriptors.page.listCdnConfigs.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listCdnConfigsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.ads.admanager.v1.CdnConfig[] = [];
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.CdnConfig) => {
      ...
      assert(
        (client.descriptors.page.listCdnConfigs.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listCdnConfigs, request),
      );
      assert(
        (client.descriptors.page.listCdnConfigs.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listCdnConfigs without error', async () => {
      const client = new cdnconfigserviceModule.v1.CdnConfigServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.descriptors.page.listCdnConfigs.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.ads.admanager.v1.ICdnConfig[] = [];
      const iterable = client.listCdnConfigsAsync(request);
