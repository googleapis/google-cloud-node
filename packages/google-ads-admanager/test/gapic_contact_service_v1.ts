...
import * as contactserviceModule from '../src';
...
describe('v1.ContactServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = contactserviceModule.v1.ContactServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = contactserviceModule.v1.ContactServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new contactserviceModule.v1.ContactServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new contactserviceModule.v1.ContactServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new contactserviceModule.v1.ContactServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new contactserviceModule.v1.ContactServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = contactserviceModule.v1.ContactServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.contactServiceStub, undefined);
    ...
    describe('getContact', () => {
        it('invokes getContact without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.GetContactRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetContactRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.Contact()
            );
        ...
        it('invokes getContact without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getContact(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IContact|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createContact', () => {
        it('invokes createContact without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.CreateContactRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.CreateContactRequest', ['parent']);
    ...
    describe('batchCreateContacts', () => {
        it('invokes batchCreateContacts without error', async () => {
            const client = new contactserviceModule.v1.ContactServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.BatchCreateContactsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.BatchCreateContactsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.BatchCreateContactsResponse()
            );
            client.innerApiCalls.batchCreateContacts = stubSimpleCall(expectedResponse);
            const [response] = await client.batchCreateContacts(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchCreateContacts as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchCreateContacts as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes batchCreateContacts without error using callback', async () => {
            const client = new contactserviceModule.v1.ContactServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.batchCreateContacts = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchCreateContacts(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IBatchCreateContactsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchCreateContacts with error', async () => {
            const client = new contactserviceModule.v1.ContactServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchCreateContacts = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.batchCreateContacts(request), expectedError);
            const actualRequest = (client.innerApiCalls.batchCreateContacts as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchCreateContacts as SinonStub)
        ...
        it('invokes batchCreateContacts with closed client', async () => {
            const client = new contactserviceModule.v1.ContactServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('updateContact', () => {
        it('invokes updateContact without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.UpdateContactRequest()
            );
            request.contact ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.UpdateContactRequest', ['contact', 'name']);
    ...
    describe('batchUpdateContacts', () => {
        it('invokes batchUpdateContacts without error', async () => {
            const client = new contactserviceModule.v1.ContactServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.BatchUpdateContactsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.BatchUpdateContactsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.BatchUpdateContactsResponse()
            );
            client.innerApiCalls.batchUpdateContacts = stubSimpleCall(expectedResponse);
            const [response] = await client.batchUpdateContacts(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchUpdateContacts as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchUpdateContacts as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes batchUpdateContacts without error using callback', async () => {
            const client = new contactserviceModule.v1.ContactServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.batchUpdateContacts = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchUpdateContacts(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IBatchUpdateContactsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchUpdateContacts with error', async () => {
            const client = new contactserviceModule.v1.ContactServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchUpdateContacts = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.batchUpdateContacts(request), expectedError);
            const actualRequest = (client.innerApiCalls.batchUpdateContacts as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchUpdateContacts as SinonStub)
        ...
        it('invokes batchUpdateContacts with closed client', async () => {
            const client = new contactserviceModule.v1.ContactServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('listContacts', () => {
        it('invokes listContacts without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.ListContactsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListContactsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.Contact()),
              generateSampleMessage(new protos.google.ads.admanager.v1.Contact()),
              generateSampleMessage(new protos.google.ads.admanager.v1.Contact()),
            ];
        ...
        it('invokes listContactsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.Contact[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.Contact) => {
        ...
        it('uses async iteration with listContacts without error', async () => {
            ...
            const responses: protos.google.ads.admanager.v1.IContact[] = [];
