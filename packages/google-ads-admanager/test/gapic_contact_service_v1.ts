...
describe('v1.ContactServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          contactserviceModule.v1.ContactServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          contactserviceModule.v1.ContactServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new contactserviceModule.v1.ContactServiceClient({
          universe_domain: 'example.com',
  ...
  describe('getContact', () => {
    it('invokes getContact without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.GetContactRequest',
        ['name'],
      );
    ...
    it('invokes getContact without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getContact(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IContact | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('batchCreateContacts', () => {
    it('invokes batchCreateContacts without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchCreateContacts as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchCreateContacts as SinonStub
    ...
    it('invokes batchCreateContacts without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchCreateContacts(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchCreateContactsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchCreateContacts with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchCreateContacts = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('batchUpdateContacts', () => {
    it('invokes batchUpdateContacts without error', async () => {
      ...
      client.innerApiCalls.batchUpdateContacts =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchUpdateContacts(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchUpdateContacts as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchUpdateContacts as SinonStub
    ...
    it('invokes batchUpdateContacts without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchUpdateContacts(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchUpdateContactsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchUpdateContacts with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchUpdateContacts = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listContacts', () => {
    ...
    it('invokes listContactsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.Contact) => {
