...
describe('v1.AdSpotServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          adspotserviceModule.v1.AdSpotServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          adspotserviceModule.v1.AdSpotServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new adspotserviceModule.v1.AdSpotServiceClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = adspotserviceModule.v1.AdSpotServiceClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.adSpotServiceStub, undefined);
  ...
  describe('getAdSpot', () => {
    it('invokes getAdSpot without error', async () => {
      const client = new adspotserviceModule.v1.AdSpotServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.GetAdSpotRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.GetAdSpotRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.AdSpot(),
      );
      client.innerApiCalls.getAdSpot = stubSimpleCall(expectedResponse);
      const [response] = await client.getAdSpot(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getAdSpot as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getAdSpot without error using callback', async () => {
      const client = new adspotserviceModule.v1.AdSpotServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.getAdSpot =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getAdSpot(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IAdSpot | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getAdSpot with error', async () => {
      const client = new adspotserviceModule.v1.AdSpotServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.getAdSpot = stubSimpleCall(undefined, expectedError);
    ...
    it('invokes getAdSpot with closed client', async () => {
      const client = new adspotserviceModule.v1.AdSpotServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('createAdSpot', () => {
    it('invokes createAdSpot without error', async () => {
      const client = new adspotserviceModule.v1.AdSpotServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.CreateAdSpotRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.CreateAdSpotRequest',
        ['parent'],
      );
      ...
      client.innerApiCalls.createAdSpot = stubSimpleCall(expectedResponse);
      const [response] = await client.createAdSpot(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createAdSpot as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createAdSpot as SinonStub
    ...
    it('invokes createAdSpot without error using callback', async () => {
      const client = new adspotserviceModule.v1.AdSpotServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.createAdSpot =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createAdSpot(
          request,
    ...
    it('invokes createAdSpot with error', async () => {
      const client = new adspotserviceModule.v1.AdSpotServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createAdSpot = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes createAdSpot with closed client', async () => {
      const client = new adspotserviceModule.v1.AdSpotServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchCreateAdSpots', () => {
    it('invokes batchCreateAdSpots without error', async () => {
      const client = new adspotserviceModule.v1.AdSpotServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchCreateAdSpotsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchCreateAdSpotsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchCreateAdSpotsResponse(),
      );
      client.innerApiCalls.batchCreateAdSpots =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchCreateAdSpots(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchCreateAdSpots as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchCreateAdSpots as SinonStub
    ...
    it('invokes batchCreateAdSpots without error using callback', async () => {
      const client = new adspotserviceModule.v1.AdSpotServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchCreateAdSpots =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchCreateAdSpots(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchCreateAdSpotsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchCreateAdSpots with error', async () => {
      const client = new adspotserviceModule.v1.AdSpotServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchCreateAdSpots = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes batchCreateAdSpots with closed client', async () => {
      const client = new adspotserviceModule.v1.AdSpotServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('updateAdSpot', () => {
    it('invokes updateAdSpot without error', async () => {
      const client = new adspotserviceModule.v1.AdSpotServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.UpdateAdSpotRequest(),
      );
      request.adSpot ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.UpdateAdSpotRequest',
        ['adSpot', 'name'],
      );
      request.adSpot.name = defaultValue1;
      const expectedHeaderRequestParams = `ad_spot.name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.AdSpot(),
      );
      client.innerApiCalls.updateAdSpot = stubSimpleCall(expectedResponse);
      const [response] = await client.updateAdSpot(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateAdSpot as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateAdSpot as SinonStub
    ...
    it('invokes updateAdSpot without error using callback', async () => {
      const client = new adspotserviceModule.v1.AdSpotServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.updateAdSpot =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.updateAdSpot(
          request,
    ...
    it('invokes updateAdSpot with error', async () => {
      const client = new adspotserviceModule.v1.AdSpotServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `ad_spot.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateAdSpot = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes updateAdSpot with closed client', async () => {
      const client = new adspotserviceModule.v1.AdSpotServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchUpdateAdSpots', () => {
    it('invokes batchUpdateAdSpots without error', async () => {
      const client = new adspotserviceModule.v1.AdSpotServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUpdateAdSpotsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchUpdateAdSpotsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUpdateAdSpotsResponse(),
      );
      client.innerApiCalls.batchUpdateAdSpots =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchUpdateAdSpots(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchUpdateAdSpots as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchUpdateAdSpots as SinonStub
    ...
    it('invokes batchUpdateAdSpots without error using callback', async () => {
      const client = new adspotserviceModule.v1.AdSpotServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchUpdateAdSpots =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchUpdateAdSpots(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchUpdateAdSpotsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchUpdateAdSpots with error', async () => {
      const client = new adspotserviceModule.v1.AdSpotServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchUpdateAdSpots = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes batchUpdateAdSpots with closed client', async () => {
      const client = new adspotserviceModule.v1.AdSpotServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('listAdSpots', () => {
    it('invokes listAdSpots without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.ListAdSpotsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.ListAdSpotsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = [
        generateSampleMessage(new protos.google.ads.admanager.v1.AdSpot()),
        generateSampleMessage(new protos.google.ads.admanager.v1.AdSpot()),
        generateSampleMessage(new protos.google.ads.admanager.v1.AdSpot()),
      ];
      client.innerApiCalls.listAdSpots = stubSimpleCall(expectedResponse);
      const [response] = await client.listAdSpots(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listAdSpots as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listAdSpots as SinonStub
    ...
    it('invokes listAdSpots without error using callback', async () => {
      ...
      client.innerApiCalls.listAdSpots =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listAdSpots(
          request,
    ...
    it('invokes listAdSpots with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listAdSpots = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.listAdSpots(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.listAdSpots as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes listAdSpotsStream without error', async () => {
      ...
      client.descriptors.page.listAdSpots.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listAdSpotsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.ads.admanager.v1.AdSpot[] = [];
        stream.on('data', (response: protos.google.ads.admanager.v1.AdSpot) => {
      ...
      assert(
        (client.descriptors.page.listAdSpots.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listAdSpots, request),
      );
      assert(
        (client.descriptors.page.listAdSpots.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listAdSpotsStream with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listAdSpots.createStream = stubPageStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.listAdSpotsStream(request);
    ...
    it('uses async iteration with listAdSpots without error', async () => {
      const client = new adspotserviceModule.v1.AdSpotServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.descriptors.page.listAdSpots.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.ads.admanager.v1.IAdSpot[] = [];
      const iterable = client.listAdSpotsAsync(request);
      for await (const resource of iterable) {
        responses.push(resource!);
      }
      assert.deepStrictEqual(responses, expectedResponse);
      assert.deepStrictEqual(
        (client.descriptors.page.listAdSpots.asyncIterate as SinonStub).getCall(
          0,
        ).args[1],
        request,
      );
    ...
    it('uses async iteration with listAdSpots with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listAdSpots.asyncIterate = stubAsyncIterationCall(
        undefined,
        expectedError,
      );
      const iterable = client.listAdSpotsAsync(request);
