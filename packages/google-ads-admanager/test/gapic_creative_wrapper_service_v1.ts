...
describe('v1.CreativeWrapperServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          creativewrapperserviceModule.v1.CreativeWrapperServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        creativewrapperserviceModule.v1.CreativeWrapperServiceClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.creativeWrapperServiceStub, undefined);
  ...
  describe('getCreativeWrapper', () => {
    it('invokes getCreativeWrapper without error', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.GetCreativeWrapperRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.GetCreativeWrapperRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.CreativeWrapper(),
      );
      client.innerApiCalls.getCreativeWrapper =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getCreativeWrapper(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getCreativeWrapper as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getCreativeWrapper without error using callback', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const promise = new Promise((resolve, reject) => {
        client.getCreativeWrapper(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.ICreativeWrapper | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getCreativeWrapper with error', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.getCreativeWrapper = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes getCreativeWrapper with closed client', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('createCreativeWrapper', () => {
    it('invokes createCreativeWrapper without error', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.CreateCreativeWrapperRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.CreateCreativeWrapperRequest',
        ['parent'],
      );
      ...
      client.innerApiCalls.createCreativeWrapper =
        stubSimpleCall(expectedResponse);
      const [response] = await client.createCreativeWrapper(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createCreativeWrapper as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createCreativeWrapper as SinonStub
    ...
    it('invokes createCreativeWrapper without error using callback', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
    ...
    it('invokes createCreativeWrapper with error', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createCreativeWrapper = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createCreativeWrapper(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createCreativeWrapper as SinonStub
    ...
    it('invokes createCreativeWrapper with closed client', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('batchCreateCreativeWrappers', () => {
    it('invokes batchCreateCreativeWrappers without error', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchCreateCreativeWrappersRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchCreateCreativeWrappersRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchCreateCreativeWrappersResponse(),
      );
      client.innerApiCalls.batchCreateCreativeWrappers =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchCreateCreativeWrappers(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchCreateCreativeWrappers as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchCreateCreativeWrappers as SinonStub
    ...
    it('invokes batchCreateCreativeWrappers without error using callback', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.batchCreateCreativeWrappers =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchCreateCreativeWrappers(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchCreateCreativeWrappersResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchCreateCreativeWrappers with error', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchCreateCreativeWrappers = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchCreateCreativeWrappers(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchCreateCreativeWrappers as SinonStub
    ...
    it('invokes batchCreateCreativeWrappers with closed client', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('updateCreativeWrapper', () => {
    it('invokes updateCreativeWrapper without error', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.UpdateCreativeWrapperRequest(),
      );
      request.creativeWrapper ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.UpdateCreativeWrapperRequest',
        ['creativeWrapper', 'name'],
      );
      request.creativeWrapper.name = defaultValue1;
      const expectedHeaderRequestParams = `creative_wrapper.name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.CreativeWrapper(),
      );
      client.innerApiCalls.updateCreativeWrapper =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateCreativeWrapper(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateCreativeWrapper as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateCreativeWrapper as SinonStub
    ...
    it('invokes updateCreativeWrapper without error using callback', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
    ...
    it('invokes updateCreativeWrapper with error', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `creative_wrapper.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateCreativeWrapper = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateCreativeWrapper(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateCreativeWrapper as SinonStub
    ...
    it('invokes updateCreativeWrapper with closed client', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('batchUpdateCreativeWrappers', () => {
    it('invokes batchUpdateCreativeWrappers without error', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUpdateCreativeWrappersRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUpdateCreativeWrappersResponse(),
      );
      client.innerApiCalls.batchUpdateCreativeWrappers =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchUpdateCreativeWrappers(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchUpdateCreativeWrappers as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchUpdateCreativeWrappers as SinonStub
    ...
    it('invokes batchUpdateCreativeWrappers without error using callback', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.batchUpdateCreativeWrappers =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchUpdateCreativeWrappers(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchUpdateCreativeWrappersResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchUpdateCreativeWrappers with error', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchUpdateCreativeWrappers = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchUpdateCreativeWrappers(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchUpdateCreativeWrappers as SinonStub
    ...
    it('invokes batchUpdateCreativeWrappers with closed client', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('batchActivateCreativeWrappers', () => {
    it('invokes batchActivateCreativeWrappers without error', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchActivateCreativeWrappersRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchActivateCreativeWrappersRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchActivateCreativeWrappersResponse(),
      );
      client.innerApiCalls.batchActivateCreativeWrappers =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchActivateCreativeWrappers(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchActivateCreativeWrappers as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchActivateCreativeWrappers as SinonStub
    ...
    it('invokes batchActivateCreativeWrappers without error using callback', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.batchActivateCreativeWrappers =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchActivateCreativeWrappers(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchActivateCreativeWrappersResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchActivateCreativeWrappers with error', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchActivateCreativeWrappers = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchActivateCreativeWrappers(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchActivateCreativeWrappers as SinonStub
    ...
    it('invokes batchActivateCreativeWrappers with closed client', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('batchDeactivateCreativeWrappers', () => {
    it('invokes batchDeactivateCreativeWrappers without error', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchDeactivateCreativeWrappersRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchDeactivateCreativeWrappersRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchDeactivateCreativeWrappersResponse(),
      );
      client.innerApiCalls.batchDeactivateCreativeWrappers =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchDeactivateCreativeWrappers(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchDeactivateCreativeWrappers as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchDeactivateCreativeWrappers as SinonStub
    ...
    it('invokes batchDeactivateCreativeWrappers without error using callback', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.batchDeactivateCreativeWrappers =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchDeactivateCreativeWrappers(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchDeactivateCreativeWrappersResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchDeactivateCreativeWrappers with error', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchDeactivateCreativeWrappers = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchDeactivateCreativeWrappers(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchDeactivateCreativeWrappers as SinonStub
    ...
    it('invokes batchDeactivateCreativeWrappers with closed client', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('listCreativeWrappers', () => {
    it('invokes listCreativeWrappers without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.ListCreativeWrappersRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.ListCreativeWrappersRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.listCreativeWrappers =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listCreativeWrappers(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listCreativeWrappers as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listCreativeWrappers as SinonStub
    ...
    it('invokes listCreativeWrappers with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listCreativeWrappers = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.listCreativeWrappers(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.listCreativeWrappers as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes listCreativeWrappersStream without error', async () => {
      ...
      client.descriptors.page.listCreativeWrappers.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listCreativeWrappersStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.ads.admanager.v1.CreativeWrapper[] = [];
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.CreativeWrapper) => {
      ...
      assert(
        (client.descriptors.page.listCreativeWrappers.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listCreativeWrappers, request),
      );
      assert(
        (client.descriptors.page.listCreativeWrappers.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listCreativeWrappers without error', async () => {
      const client =
        new creativewrapperserviceModule.v1.CreativeWrapperServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.descriptors.page.listCreativeWrappers.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.ads.admanager.v1.ICreativeWrapper[] = [];
      const iterable = client.listCreativeWrappersAsync(request);
