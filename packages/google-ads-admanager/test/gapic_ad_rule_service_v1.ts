...
describe('v1.AdRuleServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          adruleserviceModule.v1.AdRuleServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          adruleserviceModule.v1.AdRuleServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new adruleserviceModule.v1.AdRuleServiceClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = adruleserviceModule.v1.AdRuleServiceClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.adRuleServiceStub, undefined);
  ...
  describe('getAdRule', () => {
    it('invokes getAdRule without error', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.GetAdRuleRequest(),
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.AdRule(),
      );
      client.innerApiCalls.getAdRule = stubSimpleCall(expectedResponse);
      const [response] = await client.getAdRule(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getAdRule as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getAdRule without error using callback', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.getAdRule =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getAdRule(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IAdRule | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getAdRule with error', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.getAdRule = stubSimpleCall(undefined, expectedError);
    ...
    it('invokes getAdRule with closed client', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('createAdRule', () => {
    it('invokes createAdRule without error', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.CreateAdRuleRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.createAdRule = stubSimpleCall(expectedResponse);
      const [response] = await client.createAdRule(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createAdRule as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createAdRule as SinonStub
    ...
    it('invokes createAdRule without error using callback', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.createAdRule =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createAdRule(
          request,
    ...
    it('invokes createAdRule with error', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createAdRule = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes createAdRule with closed client', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchCreateAdRules', () => {
    it('invokes batchCreateAdRules without error', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchCreateAdRulesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchCreateAdRulesResponse(),
      );
      client.innerApiCalls.batchCreateAdRules =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchCreateAdRules(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchCreateAdRules as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchCreateAdRules as SinonStub
    ...
    it('invokes batchCreateAdRules without error using callback', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchCreateAdRules =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchCreateAdRules(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchCreateAdRulesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchCreateAdRules with error', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchCreateAdRules = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes batchCreateAdRules with closed client', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('updateAdRule', () => {
    it('invokes updateAdRule without error', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.UpdateAdRuleRequest(),
      );
      request.adRule ??= {};
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `ad_rule.name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.AdRule(),
      );
      client.innerApiCalls.updateAdRule = stubSimpleCall(expectedResponse);
      const [response] = await client.updateAdRule(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateAdRule as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateAdRule as SinonStub
    ...
    it('invokes updateAdRule without error using callback', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.updateAdRule =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.updateAdRule(
          request,
    ...
    it('invokes updateAdRule with error', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `ad_rule.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateAdRule = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes updateAdRule with closed client', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchUpdateAdRules', () => {
    it('invokes batchUpdateAdRules without error', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUpdateAdRulesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUpdateAdRulesResponse(),
      );
      client.innerApiCalls.batchUpdateAdRules =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchUpdateAdRules(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchUpdateAdRules as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchUpdateAdRules as SinonStub
    ...
    it('invokes batchUpdateAdRules without error using callback', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchUpdateAdRules =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchUpdateAdRules(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchUpdateAdRulesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchUpdateAdRules with error', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchUpdateAdRules = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes batchUpdateAdRules with closed client', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchActivateAdRules', () => {
    it('invokes batchActivateAdRules without error', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchActivateAdRulesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchActivateAdRulesResponse(),
      );
      client.innerApiCalls.batchActivateAdRules =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchActivateAdRules(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchActivateAdRules as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchActivateAdRules as SinonStub
    ...
    it('invokes batchActivateAdRules without error using callback', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchActivateAdRules =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchActivateAdRules(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchActivateAdRulesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchActivateAdRules with error', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchActivateAdRules = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes batchActivateAdRules with closed client', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchDeactivateAdRules', () => {
    it('invokes batchDeactivateAdRules without error', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchDeactivateAdRulesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchDeactivateAdRulesResponse(),
      );
      client.innerApiCalls.batchDeactivateAdRules =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchDeactivateAdRules(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchDeactivateAdRules as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchDeactivateAdRules as SinonStub
    ...
    it('invokes batchDeactivateAdRules without error using callback', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchDeactivateAdRules =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchDeactivateAdRules(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchDeactivateAdRulesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchDeactivateAdRules with error', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchDeactivateAdRules = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchDeactivateAdRules(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchDeactivateAdRules as SinonStub
    ...
    it('invokes batchDeactivateAdRules with closed client', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchDeleteAdRules', () => {
    it('invokes batchDeleteAdRules without error', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchDeleteAdRulesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.batchDeleteAdRules =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchDeleteAdRules(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchDeleteAdRules as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchDeleteAdRules as SinonStub
    ...
    it('invokes batchDeleteAdRules without error using callback', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
    ...
    it('invokes batchDeleteAdRules with error', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchDeleteAdRules = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes batchDeleteAdRules with closed client', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('listAdRules', () => {
    it('invokes listAdRules without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.ListAdRulesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedResponse = [
        generateSampleMessage(new protos.google.ads.admanager.v1.AdRule()),
        generateSampleMessage(new protos.google.ads.admanager.v1.AdRule()),
        generateSampleMessage(new protos.google.ads.admanager.v1.AdRule()),
      ];
      client.innerApiCalls.listAdRules = stubSimpleCall(expectedResponse);
      const [response] = await client.listAdRules(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listAdRules as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listAdRules as SinonStub
    ...
    it('invokes listAdRules without error using callback', async () => {
      ...
      client.innerApiCalls.listAdRules =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listAdRules(
          request,
    ...
    it('invokes listAdRules with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listAdRules = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.listAdRules(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.listAdRules as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes listAdRulesStream without error', async () => {
      ...
      client.descriptors.page.listAdRules.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listAdRulesStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.ads.admanager.v1.AdRule[] = [];
        stream.on('data', (response: protos.google.ads.admanager.v1.AdRule) => {
      ...
      assert(
        (client.descriptors.page.listAdRules.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listAdRules, request),
      );
      assert(
        (client.descriptors.page.listAdRules.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listAdRulesStream with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listAdRules.createStream = stubPageStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.listAdRulesStream(request);
    ...
    it('uses async iteration with listAdRules without error', async () => {
      const client = new adruleserviceModule.v1.AdRuleServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.descriptors.page.listAdRules.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.ads.admanager.v1.IAdRule[] = [];
      const iterable = client.listAdRulesAsync(request);
      for await (const resource of iterable) {
        responses.push(resource!);
      }
      assert.deepStrictEqual(responses, expectedResponse);
      assert.deepStrictEqual(
        (client.descriptors.page.listAdRules.asyncIterate as SinonStub).getCall(
          0,
        ).args[1],
        request,
      );
    ...
    it('uses async iteration with listAdRules with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listAdRules.asyncIterate = stubAsyncIterationCall(
        undefined,
        expectedError,
      );
      const iterable = client.listAdRulesAsync(request);
