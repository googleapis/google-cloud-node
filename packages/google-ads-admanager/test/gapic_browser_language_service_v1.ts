...
describe('v1.BrowserLanguageServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          browserlanguageserviceModule.v1.BrowserLanguageServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        browserlanguageserviceModule.v1.BrowserLanguageServiceClient.port;
      assert(port);
  ...
  describe('getBrowserLanguage', () => {
    it('invokes getBrowserLanguage without error', async () => {
      ...
      client.innerApiCalls.getBrowserLanguage =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getBrowserLanguage(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getBrowserLanguage as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getBrowserLanguage without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getBrowserLanguage(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBrowserLanguage | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getBrowserLanguage with error', async () => {
      ...
      client.innerApiCalls.getBrowserLanguage = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listBrowserLanguages', () => {
    it('invokes listBrowserLanguages without error', async () => {
      ...
      client.innerApiCalls.listBrowserLanguages =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listBrowserLanguages(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listBrowserLanguages as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listBrowserLanguages as SinonStub
    ...
    it('invokes listBrowserLanguages with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listBrowserLanguages = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listBrowserLanguagesStream without error', async () => {
      ...
      client.descriptors.page.listBrowserLanguages.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.BrowserLanguage) => {
      ...
      assert(
        (client.descriptors.page.listBrowserLanguages.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listBrowserLanguages, request),
      );
      assert(
        (client.descriptors.page.listBrowserLanguages.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listBrowserLanguages without error', async () => {
      ...
      client.descriptors.page.listBrowserLanguages.asyncIterate =
