...
describe('v1.BrowserLanguageServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = browserlanguageserviceModule.v1.BrowserLanguageServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = browserlanguageserviceModule.v1.BrowserLanguageServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new browserlanguageserviceModule.v1.BrowserLanguageServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new browserlanguageserviceModule.v1.BrowserLanguageServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'admanager.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new browserlanguageserviceModule.v1.BrowserLanguageServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new browserlanguageserviceModule.v1.BrowserLanguageServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = browserlanguageserviceModule.v1.BrowserLanguageServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.browserLanguageServiceStub, undefined);
    ...
    describe('getBrowserLanguage', () => {
        it('invokes getBrowserLanguage without error', async () => {
            const client = new browserlanguageserviceModule.v1.BrowserLanguageServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.GetBrowserLanguageRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.GetBrowserLanguageRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ads.admanager.v1.BrowserLanguage()
            );
            client.innerApiCalls.getBrowserLanguage = stubSimpleCall(expectedResponse);
            const [response] = await client.getBrowserLanguage(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getBrowserLanguage as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getBrowserLanguage as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getBrowserLanguage without error using callback', async () => {
            const client = new browserlanguageserviceModule.v1.BrowserLanguageServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getBrowserLanguage = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getBrowserLanguage(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IBrowserLanguage|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getBrowserLanguage with error', async () => {
            const client = new browserlanguageserviceModule.v1.BrowserLanguageServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getBrowserLanguage = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes getBrowserLanguage with closed client', async () => {
            const client = new browserlanguageserviceModule.v1.BrowserLanguageServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
    ...
    describe('listBrowserLanguages', () => {
        it('invokes listBrowserLanguages without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ads.admanager.v1.ListBrowserLanguagesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ads.admanager.v1.ListBrowserLanguagesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ads.admanager.v1.BrowserLanguage()),
              generateSampleMessage(new protos.google.ads.admanager.v1.BrowserLanguage()),
              generateSampleMessage(new protos.google.ads.admanager.v1.BrowserLanguage()),
            ];
            client.innerApiCalls.listBrowserLanguages = stubSimpleCall(expectedResponse);
            const [response] = await client.listBrowserLanguages(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listBrowserLanguages as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listBrowserLanguages as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listBrowserLanguages without error using callback', async () => {
            ...
            client.innerApiCalls.listBrowserLanguages = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listBrowserLanguages(
                    request,
                    (err?: Error|null, result?: protos.google.ads.admanager.v1.IBrowserLanguage[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listBrowserLanguages with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listBrowserLanguages = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listBrowserLanguages(request), expectedError);
            const actualRequest = (client.innerApiCalls.listBrowserLanguages as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listBrowserLanguages as SinonStub)
        ...
        it('invokes listBrowserLanguagesStream without error', async () => {
            ...
            client.descriptors.page.listBrowserLanguages.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listBrowserLanguagesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.BrowserLanguage[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.BrowserLanguage) => {
            ...
            assert((client.descriptors.page.listBrowserLanguages.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listBrowserLanguages, request));
            assert(
        ...
        it('invokes listBrowserLanguagesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listBrowserLanguages.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listBrowserLanguagesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.admanager.v1.BrowserLanguage[] = [];
                stream.on('data', (response: protos.google.ads.admanager.v1.BrowserLanguage) => {
        ...
        it('uses async iteration with listBrowserLanguages without error', async () => {
            const client = new browserlanguageserviceModule.v1.BrowserLanguageServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listBrowserLanguages.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.admanager.v1.IBrowserLanguage[] = [];
            const iterable = client.listBrowserLanguagesAsync(request);
        ...
        it('uses async iteration with listBrowserLanguages with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listBrowserLanguages.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listBrowserLanguagesAsync(request);
