...
describe('v1.SuggestedAdUnitServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          suggestedadunitserviceModule.v1.SuggestedAdUnitServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        suggestedadunitserviceModule.v1.SuggestedAdUnitServiceClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.suggestedAdUnitServiceStub, undefined);
  ...
  describe('getSuggestedAdUnit', () => {
    it('invokes getSuggestedAdUnit without error', async () => {
      const client =
        new suggestedadunitserviceModule.v1.SuggestedAdUnitServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.GetSuggestedAdUnitRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.GetSuggestedAdUnitRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.SuggestedAdUnit(),
      );
      client.innerApiCalls.getSuggestedAdUnit =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getSuggestedAdUnit(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getSuggestedAdUnit as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getSuggestedAdUnit without error using callback', async () => {
      const client =
        new suggestedadunitserviceModule.v1.SuggestedAdUnitServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const promise = new Promise((resolve, reject) => {
        client.getSuggestedAdUnit(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.ISuggestedAdUnit | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getSuggestedAdUnit with error', async () => {
      const client =
        new suggestedadunitserviceModule.v1.SuggestedAdUnitServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.getSuggestedAdUnit = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes getSuggestedAdUnit with closed client', async () => {
      const client =
        new suggestedadunitserviceModule.v1.SuggestedAdUnitServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('batchApproveSuggestedAdUnits', () => {
    it('invokes batchApproveSuggestedAdUnits without error', async () => {
      const client =
        new suggestedadunitserviceModule.v1.SuggestedAdUnitServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchApproveSuggestedAdUnitsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchApproveSuggestedAdUnitsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchApproveSuggestedAdUnitsResponse(),
      );
      client.innerApiCalls.batchApproveSuggestedAdUnits =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchApproveSuggestedAdUnits(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchApproveSuggestedAdUnits as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchApproveSuggestedAdUnits as SinonStub
    ...
    it('invokes batchApproveSuggestedAdUnits without error using callback', async () => {
      const client =
        new suggestedadunitserviceModule.v1.SuggestedAdUnitServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.batchApproveSuggestedAdUnits =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchApproveSuggestedAdUnits(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchApproveSuggestedAdUnitsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchApproveSuggestedAdUnits with error', async () => {
      const client =
        new suggestedadunitserviceModule.v1.SuggestedAdUnitServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchApproveSuggestedAdUnits = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchApproveSuggestedAdUnits(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchApproveSuggestedAdUnits as SinonStub
    ...
    it('invokes batchApproveSuggestedAdUnits with closed client', async () => {
      const client =
        new suggestedadunitserviceModule.v1.SuggestedAdUnitServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('listSuggestedAdUnits', () => {
    it('invokes listSuggestedAdUnits without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.ListSuggestedAdUnitsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.ListSuggestedAdUnitsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.listSuggestedAdUnits =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listSuggestedAdUnits(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listSuggestedAdUnits as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listSuggestedAdUnits as SinonStub
    ...
    it('invokes listSuggestedAdUnits with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listSuggestedAdUnits = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.listSuggestedAdUnits(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.listSuggestedAdUnits as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes listSuggestedAdUnitsStream without error', async () => {
      ...
      client.descriptors.page.listSuggestedAdUnits.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listSuggestedAdUnitsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.ads.admanager.v1.SuggestedAdUnit[] = [];
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.SuggestedAdUnit) => {
      ...
      assert(
        (client.descriptors.page.listSuggestedAdUnits.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listSuggestedAdUnits, request),
      );
      assert(
        (client.descriptors.page.listSuggestedAdUnits.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listSuggestedAdUnits without error', async () => {
      const client =
        new suggestedadunitserviceModule.v1.SuggestedAdUnitServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.descriptors.page.listSuggestedAdUnits.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.ads.admanager.v1.ISuggestedAdUnit[] = [];
      const iterable = client.listSuggestedAdUnitsAsync(request);
