...
describe('v1.CreativeTemplateServiceClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new creativetemplateserviceModule.v1.CreativeTemplateServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          creativetemplateserviceModule.v1.CreativeTemplateServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        creativetemplateserviceModule.v1.CreativeTemplateServiceClient.port;
      assert(port);
  ...
  describe('getCreativeTemplate', () => {
    it('invokes getCreativeTemplate without error', async () => {
      ...
      client.innerApiCalls.getCreativeTemplate =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getCreativeTemplate(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getCreativeTemplate as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getCreativeTemplate without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getCreativeTemplate(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.ICreativeTemplate | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getCreativeTemplate with error', async () => {
      ...
      client.innerApiCalls.getCreativeTemplate = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listCreativeTemplates', () => {
    it('invokes listCreativeTemplates without error', async () => {
      ...
      client.innerApiCalls.listCreativeTemplates =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listCreativeTemplates(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listCreativeTemplates as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listCreativeTemplates as SinonStub
    ...
    it('invokes listCreativeTemplates with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listCreativeTemplates = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listCreativeTemplates(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listCreativeTemplates as SinonStub
    ...
    it('invokes listCreativeTemplatesStream without error', async () => {
      ...
      client.descriptors.page.listCreativeTemplates.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.CreativeTemplate) => {
      ...
      assert(
        (
          client.descriptors.page.listCreativeTemplates
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listCreativeTemplates, request),
      );
      assert(
        (
          client.descriptors.page.listCreativeTemplates
    ...
    it('uses async iteration with listCreativeTemplates without error', async () => {
      ...
      client.descriptors.page.listCreativeTemplates.asyncIterate =
