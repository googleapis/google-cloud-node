...
describe('v1.CustomTargetingValueServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          customtargetingvalueserviceModule.v1.CustomTargetingValueServiceClient
            .servicePath;
  ...
  describe('getCustomTargetingValue', () => {
    it('invokes getCustomTargetingValue without error', async () => {
      const client =
        new customtargetingvalueserviceModule.v1.CustomTargetingValueServiceClient(
          {
            auth: googleAuth,
      ...
      client.innerApiCalls.getCustomTargetingValue =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getCustomTargetingValue(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getCustomTargetingValue as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getCustomTargetingValue without error using callback', async () => {
      const client =
        new customtargetingvalueserviceModule.v1.CustomTargetingValueServiceClient(
          {
            auth: googleAuth,
    ...
    it('invokes getCustomTargetingValue with error', async () => {
      const client =
        new customtargetingvalueserviceModule.v1.CustomTargetingValueServiceClient(
          {
            auth: googleAuth,
      ...
      client.innerApiCalls.getCustomTargetingValue = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes getCustomTargetingValue with closed client', async () => {
      const client =
        new customtargetingvalueserviceModule.v1.CustomTargetingValueServiceClient(
          {
            auth: googleAuth,
  ...
  describe('listCustomTargetingValues', () => {
    it('invokes listCustomTargetingValues without error', async () => {
      ...
      client.innerApiCalls.listCustomTargetingValues =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listCustomTargetingValues(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listCustomTargetingValues as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listCustomTargetingValues as SinonStub
    ...
    it('invokes listCustomTargetingValues without error using callback', async () => {
      const client =
        new customtargetingvalueserviceModule.v1.CustomTargetingValueServiceClient(
          {
            credentials: { client_email: 'bogus', private_key: 'bogus' },
      ...
      client.innerApiCalls.listCustomTargetingValues =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listCustomTargetingValues(
          request,
          (
            err?: Error | null,
            result?:
    ...
    it('invokes listCustomTargetingValues with error', async () => {
      const client =
        new customtargetingvalueserviceModule.v1.CustomTargetingValueServiceClient(
          {
            credentials: { client_email: 'bogus', private_key: 'bogus' },
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listCustomTargetingValues = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listCustomTargetingValues(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listCustomTargetingValues as SinonStub
    ...
    it('invokes listCustomTargetingValuesStream without error', async () => {
      const client =
        new customtargetingvalueserviceModule.v1.CustomTargetingValueServiceClient(
          {
            credentials: { client_email: 'bogus', private_key: 'bogus' },
      ...
      client.descriptors.page.listCustomTargetingValues.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listCustomTargetingValuesStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.ads.admanager.v1.CustomTargetingValue[] =
          [];
        stream.on(
          'data',
          (response: protos.google.ads.admanager.v1.CustomTargetingValue) => {
      ...
      assert(
        (
          client.descriptors.page.listCustomTargetingValues
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listCustomTargetingValues, request),
      );
      assert(
        (
          client.descriptors.page.listCustomTargetingValues
    ...
    it('invokes listCustomTargetingValuesStream with error', async () => {
      const client =
        new customtargetingvalueserviceModule.v1.CustomTargetingValueServiceClient(
          {
            credentials: { client_email: 'bogus', private_key: 'bogus' },
    ...
    it('uses async iteration with listCustomTargetingValues without error', async () => {
      const client =
        new customtargetingvalueserviceModule.v1.CustomTargetingValueServiceClient(
          {
            auth: googleAuth,
      ...
      client.descriptors.page.listCustomTargetingValues.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.ads.admanager.v1.ICustomTargetingValue[] =
        [];
      const iterable = client.listCustomTargetingValuesAsync(request);
    ...
    it('uses async iteration with listCustomTargetingValues with error', async () => {
      const client =
        new customtargetingvalueserviceModule.v1.CustomTargetingValueServiceClient(
          {
            credentials: { client_email: 'bogus', private_key: 'bogus' },
