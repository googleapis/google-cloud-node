...
describe('v1.SlateServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          slateserviceModule.v1.SlateServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          slateserviceModule.v1.SlateServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'admanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new slateserviceModule.v1.SlateServiceClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = slateserviceModule.v1.SlateServiceClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.slateServiceStub, undefined);
  ...
  describe('getSlate', () => {
    it('invokes getSlate without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.GetSlateRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.GetSlateRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.Slate(),
      );
    ...
    it('invokes getSlate without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getSlate(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.ISlate | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createSlate', () => {
    it('invokes createSlate without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.CreateSlateRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.CreateSlateRequest',
        ['parent'],
      );
  ...
  describe('batchCreateSlates', () => {
    it('invokes batchCreateSlates without error', async () => {
      const client = new slateserviceModule.v1.SlateServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchCreateSlatesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchCreateSlatesRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchCreateSlatesResponse(),
      );
      client.innerApiCalls.batchCreateSlates = stubSimpleCall(expectedResponse);
      const [response] = await client.batchCreateSlates(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchCreateSlates as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchCreateSlates as SinonStub
    ...
    it('invokes batchCreateSlates without error using callback', async () => {
      const client = new slateserviceModule.v1.SlateServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchCreateSlates =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchCreateSlates(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchCreateSlatesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchCreateSlates with error', async () => {
      const client = new slateserviceModule.v1.SlateServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchCreateSlates = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes batchCreateSlates with closed client', async () => {
      const client = new slateserviceModule.v1.SlateServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('updateSlate', () => {
    it('invokes updateSlate without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.UpdateSlateRequest(),
      );
      request.slate ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.UpdateSlateRequest',
        ['slate', 'name'],
      );
  ...
  describe('batchUpdateSlates', () => {
    it('invokes batchUpdateSlates without error', async () => {
      const client = new slateserviceModule.v1.SlateServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUpdateSlatesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchUpdateSlatesRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUpdateSlatesResponse(),
      );
      client.innerApiCalls.batchUpdateSlates = stubSimpleCall(expectedResponse);
      const [response] = await client.batchUpdateSlates(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchUpdateSlates as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchUpdateSlates as SinonStub
    ...
    it('invokes batchUpdateSlates without error using callback', async () => {
      const client = new slateserviceModule.v1.SlateServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchUpdateSlates =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchUpdateSlates(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchUpdateSlatesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchUpdateSlates with error', async () => {
      const client = new slateserviceModule.v1.SlateServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchUpdateSlates = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes batchUpdateSlates with closed client', async () => {
      const client = new slateserviceModule.v1.SlateServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchArchiveSlates', () => {
    it('invokes batchArchiveSlates without error', async () => {
      const client = new slateserviceModule.v1.SlateServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchArchiveSlatesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchArchiveSlatesResponse(),
      );
      client.innerApiCalls.batchArchiveSlates =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchArchiveSlates(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchArchiveSlates as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchArchiveSlates as SinonStub
    ...
    it('invokes batchArchiveSlates without error using callback', async () => {
      const client = new slateserviceModule.v1.SlateServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchArchiveSlates =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchArchiveSlates(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchArchiveSlatesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchArchiveSlates with error', async () => {
      const client = new slateserviceModule.v1.SlateServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchArchiveSlates = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes batchArchiveSlates with closed client', async () => {
      const client = new slateserviceModule.v1.SlateServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('batchUnarchiveSlates', () => {
    it('invokes batchUnarchiveSlates without error', async () => {
      const client = new slateserviceModule.v1.SlateServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUnarchiveSlatesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.BatchUnarchiveSlatesRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.ads.admanager.v1.BatchUnarchiveSlatesResponse(),
      );
      client.innerApiCalls.batchUnarchiveSlates =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchUnarchiveSlates(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchUnarchiveSlates as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchUnarchiveSlates as SinonStub
    ...
    it('invokes batchUnarchiveSlates without error using callback', async () => {
      const client = new slateserviceModule.v1.SlateServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.batchUnarchiveSlates =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.batchUnarchiveSlates(
          request,
          (
            err?: Error | null,
            result?: protos.google.ads.admanager.v1.IBatchUnarchiveSlatesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchUnarchiveSlates with error', async () => {
      const client = new slateserviceModule.v1.SlateServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchUnarchiveSlates = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes batchUnarchiveSlates with closed client', async () => {
      const client = new slateserviceModule.v1.SlateServiceClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('listSlates', () => {
    it('invokes listSlates without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.ads.admanager.v1.ListSlatesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.admanager.v1.ListSlatesRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = [
        generateSampleMessage(new protos.google.ads.admanager.v1.Slate()),
        generateSampleMessage(new protos.google.ads.admanager.v1.Slate()),
        generateSampleMessage(new protos.google.ads.admanager.v1.Slate()),
      ];
    ...
    it('invokes listSlatesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.ads.admanager.v1.Slate[] = [];
        stream.on('data', (response: protos.google.ads.admanager.v1.Slate) => {
    ...
    it('uses async iteration with listSlates without error', async () => {
      ...
      const responses: protos.google.ads.admanager.v1.ISlate[] = [];
