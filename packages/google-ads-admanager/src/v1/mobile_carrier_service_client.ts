...
export class MobileCarrierServiceClient {
  ...
  constructor(
    ...
    this.descriptors.page = {
      listMobileCarriers: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'mobileCarriers',
      ),
  ...
  getMobileCarrier(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IMobileCarrier,
      | protos.google.ads.admanager.v1.IGetMobileCarrierRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .getMobileCarrier(request, options, wrappedCallback)
      ?.then(
