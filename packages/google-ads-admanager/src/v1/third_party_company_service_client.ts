 ...
 * `src/v1/third_party_company_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './third_party_company_service_client_config.json';
 ...
 * @memberof v1
 */
export class ThirdPartyCompanyServiceClient {
   ...
   *     const client = new ThirdPartyCompanyServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(
    opts?: ClientOptions,
    ...
    const staticMembers = this
      .constructor as typeof ThirdPartyCompanyServiceClient;
    if (
    ...
    this.descriptors.page = {
      listThirdPartyCompanies: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'thirdPartyCompanies',
      ),
  ...
  initialize() {
    ...
    if (this.thirdPartyCompanyServiceStub) {
      return this.thirdPartyCompanyServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.ThirdPartyCompanyService.
    this.thirdPartyCompanyServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
    ...
    const thirdPartyCompanyServiceStubMethods = [
   ...
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.ThirdPartyCompany|ThirdPartyCompany}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/third_party_company_service.get_third_party_company.js</caption>
   * region_tag:admanager_v1_generated_ThirdPartyCompanyService_GetThirdPartyCompany_async
   */
  getThirdPartyCompany(
    request?: protos.google.ads.admanager.v1.IGetThirdPartyCompanyRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IThirdPartyCompany,
      protos.google.ads.admanager.v1.IGetThirdPartyCompanyRequest | undefined,
      {} | undefined,
    ]
  >;
  getThirdPartyCompany(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IThirdPartyCompany,
      | protos.google.ads.admanager.v1.IGetThirdPartyCompanyRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('getThirdPartyCompany response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .getThirdPartyCompany(request, options, wrappedCallback)
      ?.then(
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.ThirdPartyCompany|ThirdPartyCompany}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   *   We recommend using `listThirdPartyCompaniesAsync()`
   *   method described below for async iteration which you can stop as needed.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   */
  listThirdPartyCompanies(
    request?: protos.google.ads.admanager.v1.IListThirdPartyCompaniesRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IThirdPartyCompany[],
      protos.google.ads.admanager.v1.IListThirdPartyCompaniesRequest | null,
      protos.google.ads.admanager.v1.IListThirdPartyCompaniesResponse,
    ]
  >;
  listThirdPartyCompanies(
    request: protos.google.ads.admanager.v1.IListThirdPartyCompaniesRequest,
    ...
    callback: PaginationCallback<
      protos.google.ads.admanager.v1.IListThirdPartyCompaniesRequest,
      | protos.google.ads.admanager.v1.IListThirdPartyCompaniesResponse
      | null
      | undefined,
      protos.google.ads.admanager.v1.IThirdPartyCompany
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listThirdPartyCompanies values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listThirdPartyCompanies request %j', request);
    return this.innerApiCalls
      .listThirdPartyCompanies(request, options, wrappedCallback)
      ?.then(
        ([response, input, output]: [
          ...
          this._log.info('listThirdPartyCompanies values %j', response);
  ...
  /**
   * Equivalent to `listThirdPartyCompanies`, but returns a NodeJS Stream object.
   * @param {Object} request
   *   The request object that will be sent.
   * @param {string} request.parent
   *   Required. The parent, which owns this collection of ThirdPartyCompanies.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.ThirdPartyCompany|ThirdPartyCompany} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
  ...
  listThirdPartyCompaniesStream(
    ...
    return this.descriptors.page.listThirdPartyCompanies.createStream(
      this.innerApiCalls.listThirdPartyCompanies as GaxCall,
      request,
      callSettings,
    );
  }
  ...
  /**
   * Equivalent to `listThirdPartyCompanies`, but returns an iterable object.
   *
   ...
   *   {@link protos.google.ads.admanager.v1.ThirdPartyCompany|ThirdPartyCompany}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/third_party_company_service.list_third_party_companies.js</caption>
   * region_tag:admanager_v1_generated_ThirdPartyCompanyService_ListThirdPartyCompanies_async
   */
  listThirdPartyCompaniesAsync(
    request?: protos.google.ads.admanager.v1.IListThirdPartyCompaniesRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.ads.admanager.v1.IThirdPartyCompany> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listThirdPartyCompanies.asyncIterate(
      this.innerApiCalls['listThirdPartyCompanies'] as GaxCall,
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.ads.admanager.v1.IThirdPartyCompany>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
