 ...
 * `src/v1/linked_device_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './linked_device_service_client_config.json';
 ...
 * @memberof v1
 */
export class LinkedDeviceServiceClient {
   ...
   *     const client = new LinkedDeviceServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(
    opts?: ClientOptions,
    ...
    const staticMembers = this.constructor as typeof LinkedDeviceServiceClient;
    if (
    ...
    this.descriptors.page = {
      listLinkedDevices: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'linkedDevices',
      ),
  ...
  initialize() {
    ...
    if (this.linkedDeviceServiceStub) {
      return this.linkedDeviceServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.LinkedDeviceService.
    this.linkedDeviceServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
    ...
    const linkedDeviceServiceStubMethods = [
      'getLinkedDevice',
      'listLinkedDevices',
    ];
   ...
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.LinkedDevice|LinkedDevice}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/linked_device_service.get_linked_device.js</caption>
   * region_tag:admanager_v1_generated_LinkedDeviceService_GetLinkedDevice_async
   */
  getLinkedDevice(
    request?: protos.google.ads.admanager.v1.IGetLinkedDeviceRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.ILinkedDevice,
      protos.google.ads.admanager.v1.IGetLinkedDeviceRequest | undefined,
      {} | undefined,
    ]
  >;
  getLinkedDevice(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.ILinkedDevice,
      protos.google.ads.admanager.v1.IGetLinkedDeviceRequest | null | undefined,
      {} | null | undefined
    >,
  ): void;
  getLinkedDevice(
  ...
  getLinkedDevice(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.ads.admanager.v1.ILinkedDevice,
          | protos.google.ads.admanager.v1.IGetLinkedDeviceRequest
          | null
          | undefined,
          {} | null | undefined
        >,
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('getLinkedDevice response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .getLinkedDevice(request, options, wrappedCallback)
      ?.then(
   ...
   *   Required. The parent, which owns this collection of LinkedDevices.
   *   Format: `networks/{network_code}`
   * @param {number} [request.pageSize]
   *   Optional. The maximum number of `LinkedDevices` to return. The service may
   *   return fewer than this value. If unspecified, at most 50 `LinkedDevices`
   *   will be returned. The maximum value is 1000; values greater than 1000 will
   *   be coerced to 1000.
   * @param {string} [request.pageToken]
   *   Optional. A page token, received from a previous `ListLinkedDevices` call.
   *   Provide this to retrieve the subsequent page.
   *
   *   When paginating, all other parameters provided to `ListLinkedDevices` must
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.LinkedDevice|LinkedDevice}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   *   We recommend using `listLinkedDevicesAsync()`
   *   method described below for async iteration which you can stop as needed.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   */
  listLinkedDevices(
    request?: protos.google.ads.admanager.v1.IListLinkedDevicesRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.ILinkedDevice[],
      protos.google.ads.admanager.v1.IListLinkedDevicesRequest | null,
      protos.google.ads.admanager.v1.IListLinkedDevicesResponse,
    ]
  >;
  listLinkedDevices(
    request: protos.google.ads.admanager.v1.IListLinkedDevicesRequest,
    ...
    callback: PaginationCallback<
      protos.google.ads.admanager.v1.IListLinkedDevicesRequest,
      | protos.google.ads.admanager.v1.IListLinkedDevicesResponse
      | null
      | undefined,
      protos.google.ads.admanager.v1.ILinkedDevice
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listLinkedDevices values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listLinkedDevices request %j', request);
    return this.innerApiCalls
      .listLinkedDevices(request, options, wrappedCallback)
      ?.then(
        ([response, input, output]: [
          ...
          this._log.info('listLinkedDevices values %j', response);
  ...
  /**
   * Equivalent to `listLinkedDevices`, but returns a NodeJS Stream object.
   * @param {Object} request
   *   The request object that will be sent.
   * @param {string} request.parent
   *   Required. The parent, which owns this collection of LinkedDevices.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.LinkedDevice|LinkedDevice} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
  ...
  listLinkedDevicesStream(
    ...
    return this.descriptors.page.listLinkedDevices.createStream(
      this.innerApiCalls.listLinkedDevices as GaxCall,
      request,
      callSettings,
    );
  }
  ...
  /**
   * Equivalent to `listLinkedDevices`, but returns an iterable object.
   *
   ...
   *   {@link protos.google.ads.admanager.v1.LinkedDevice|LinkedDevice}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/linked_device_service.list_linked_devices.js</caption>
   * region_tag:admanager_v1_generated_LinkedDeviceService_ListLinkedDevices_async
   */
  listLinkedDevicesAsync(
    request?: protos.google.ads.admanager.v1.IListLinkedDevicesRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.ads.admanager.v1.ILinkedDevice> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listLinkedDevices.asyncIterate(
      this.innerApiCalls['listLinkedDevices'] as GaxCall,
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.ads.admanager.v1.ILinkedDevice>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
