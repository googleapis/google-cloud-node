...
export class PrivateAuctionDealServiceClient {
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof PrivateAuctionDealServiceClient;
    if (
    ...
    this.descriptors.page = {
      listPrivateAuctionDeals: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'privateAuctionDeals',
      ),
  ...
  getPrivateAuctionDeal(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IPrivateAuctionDeal,
      | protos.google.ads.admanager.v1.IGetPrivateAuctionDealRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .getPrivateAuctionDeal(request, options, wrappedCallback)
      ?.then(
  ...
  createPrivateAuctionDeal(
    ...
    [
      protos.google.ads.admanager.v1.IPrivateAuctionDeal,
      (
        | protos.google.ads.admanager.v1.ICreatePrivateAuctionDealRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .createPrivateAuctionDeal(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IPrivateAuctionDeal,
          (
  ...
  updatePrivateAuctionDeal(
    ...
    [
      protos.google.ads.admanager.v1.IPrivateAuctionDeal,
      (
        | protos.google.ads.admanager.v1.IUpdatePrivateAuctionDealRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .updatePrivateAuctionDeal(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IPrivateAuctionDeal,
          (
