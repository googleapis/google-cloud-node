...
export class ContentLabelServiceClient {
  ...
  constructor(
    ...
    this.descriptors.page = {
      listContentLabels: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'contentLabels',
      ),
  ...
  getContentLabel(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.ads.admanager.v1.IContentLabel,
          | protos.google.ads.admanager.v1.IGetContentLabelRequest
          | null
          | undefined,
          {} | null | undefined
        >,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .getContentLabel(request, options, wrappedCallback)
      ?.then(
