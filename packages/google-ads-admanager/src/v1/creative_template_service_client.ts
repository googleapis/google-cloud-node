...
export class CreativeTemplateServiceClient {
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof CreativeTemplateServiceClient;
    if (
    ...
    this.descriptors.page = {
      listCreativeTemplates: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'creativeTemplates',
      ),
  ...
  getCreativeTemplate(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.ICreativeTemplate,
      | protos.google.ads.admanager.v1.IGetCreativeTemplateRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .getCreativeTemplate(request, options, wrappedCallback)
      ?.then(
