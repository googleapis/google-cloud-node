 ...
 * `src/v1/ad_spot_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './ad_spot_service_client_config.json';
 ...
 * @memberof v1
 */
export class AdSpotServiceClient {
  ...
  adSpotServiceStub?: Promise<{ [name: string]: Function }>;

  /**
   * Construct an instance of AdSpotServiceClient.
   *
   ...
   *     const client = new AdSpotServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(
    opts?: ClientOptions,
    ...
    const staticMembers = this.constructor as typeof AdSpotServiceClient;
    if (
    ...
    this.descriptors.page = {
      listAdSpots: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'adSpots',
      ),
  ...
  initialize() {
    ...
    if (this.adSpotServiceStub) {
      return this.adSpotServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.AdSpotService.
    this.adSpotServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ? (this._protos as protobuf.Root).lookupService(
            'google.ads.admanager.v1.AdSpotService',
          )
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.AdSpotService,
      this._opts,
      this._providedCustomServicePath,
    ...
    const adSpotServiceStubMethods = [
      'getAdSpot',
      'listAdSpots',
      'createAdSpot',
      'batchCreateAdSpots',
    ...
    for (const methodName of adSpotServiceStubMethods) {
      const callPromise = this.adSpotServiceStub.then(
        (stub) =>
          (...args: Array<{}>) => {
            if (this._terminated) {
   ...
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.AdSpot|AdSpot}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/ad_spot_service.get_ad_spot.js</caption>
   * region_tag:admanager_v1_generated_AdSpotService_GetAdSpot_async
   */
  getAdSpot(
    request?: protos.google.ads.admanager.v1.IGetAdSpotRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IAdSpot,
      protos.google.ads.admanager.v1.IGetAdSpotRequest | undefined,
      {} | undefined,
    ]
  >;
  getAdSpot(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IAdSpot,
      protos.google.ads.admanager.v1.IGetAdSpotRequest | null | undefined,
      {} | null | undefined
    >,
  ): void;
  getAdSpot(
  ...
  > | void {
    ...
    this._log.info('getAdSpot request %j', request);
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('getAdSpot response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .getAdSpot(request, options, wrappedCallback)
      ?.then(
   ...
   * @param {google.ads.admanager.v1.AdSpot} request.adSpot
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/ad_spot_service.create_ad_spot.js</caption>
   * region_tag:admanager_v1_generated_AdSpotService_CreateAdSpot_async
   */
  createAdSpot(
    request?: protos.google.ads.admanager.v1.ICreateAdSpotRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IAdSpot,
      protos.google.ads.admanager.v1.ICreateAdSpotRequest | undefined,
      {} | undefined,
    ]
  >;
  createAdSpot(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IAdSpot,
      protos.google.ads.admanager.v1.ICreateAdSpotRequest | null | undefined,
      {} | null | undefined
    >,
  ): void;
  createAdSpot(
  ...
  createAdSpot(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.ads.admanager.v1.IAdSpot,
          | protos.google.ads.admanager.v1.ICreateAdSpotRequest
          | null
          | undefined,
          {} | null | undefined
        >,
  ...
  > | void {
    ...
    this._log.info('createAdSpot request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.ads.admanager.v1.IAdSpot,
          | protos.google.ads.admanager.v1.ICreateAdSpotRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('createAdSpot response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .createAdSpot(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IAdSpot,
          protos.google.ads.admanager.v1.ICreateAdSpotRequest | undefined,
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchCreateAdSpotsResponse|BatchCreateAdSpotsResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/ad_spot_service.batch_create_ad_spots.js</caption>
   * region_tag:admanager_v1_generated_AdSpotService_BatchCreateAdSpots_async
   */
  batchCreateAdSpots(
    request?: protos.google.ads.admanager.v1.IBatchCreateAdSpotsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchCreateAdSpotsResponse,
      protos.google.ads.admanager.v1.IBatchCreateAdSpotsRequest | undefined,
      {} | undefined,
    ]
  >;
  batchCreateAdSpots(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IBatchCreateAdSpotsResponse,
      | protos.google.ads.admanager.v1.IBatchCreateAdSpotsRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    this._log.info('batchCreateAdSpots request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.ads.admanager.v1.IBatchCreateAdSpotsResponse,
          | protos.google.ads.admanager.v1.IBatchCreateAdSpotsRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchCreateAdSpots response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchCreateAdSpots(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchCreateAdSpotsResponse,
          protos.google.ads.admanager.v1.IBatchCreateAdSpotsRequest | undefined,
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/ad_spot_service.update_ad_spot.js</caption>
   * region_tag:admanager_v1_generated_AdSpotService_UpdateAdSpot_async
   */
  updateAdSpot(
    request?: protos.google.ads.admanager.v1.IUpdateAdSpotRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IAdSpot,
      protos.google.ads.admanager.v1.IUpdateAdSpotRequest | undefined,
      {} | undefined,
    ]
  >;
  updateAdSpot(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IAdSpot,
      protos.google.ads.admanager.v1.IUpdateAdSpotRequest | null | undefined,
      {} | null | undefined
    >,
  ): void;
  updateAdSpot(
  ...
  updateAdSpot(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.ads.admanager.v1.IAdSpot,
          | protos.google.ads.admanager.v1.IUpdateAdSpotRequest
          | null
          | undefined,
          {} | null | undefined
        >,
  ...
  > | void {
    ...
    options.otherArgs.headers['x-goog-request-params'] =
      this._gaxModule.routingHeader.fromParams({
        'ad_spot.name': request.adSpot!.name ?? '',
      });
    this.initialize().catch((err) => {
      throw err;
    });
    this._log.info('updateAdSpot request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.ads.admanager.v1.IAdSpot,
          | protos.google.ads.admanager.v1.IUpdateAdSpotRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('updateAdSpot response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .updateAdSpot(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IAdSpot,
          protos.google.ads.admanager.v1.IUpdateAdSpotRequest | undefined,
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchUpdateAdSpotsResponse|BatchUpdateAdSpotsResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/ad_spot_service.batch_update_ad_spots.js</caption>
   * region_tag:admanager_v1_generated_AdSpotService_BatchUpdateAdSpots_async
   */
  batchUpdateAdSpots(
    request?: protos.google.ads.admanager.v1.IBatchUpdateAdSpotsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchUpdateAdSpotsResponse,
      protos.google.ads.admanager.v1.IBatchUpdateAdSpotsRequest | undefined,
      {} | undefined,
    ]
  >;
  batchUpdateAdSpots(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IBatchUpdateAdSpotsResponse,
      | protos.google.ads.admanager.v1.IBatchUpdateAdSpotsRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    this._log.info('batchUpdateAdSpots request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.ads.admanager.v1.IBatchUpdateAdSpotsResponse,
          | protos.google.ads.admanager.v1.IBatchUpdateAdSpotsRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchUpdateAdSpots response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchUpdateAdSpots(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchUpdateAdSpotsResponse,
          protos.google.ads.admanager.v1.IBatchUpdateAdSpotsRequest | undefined,
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.AdSpot|AdSpot}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   *   We recommend using `listAdSpotsAsync()`
   *   method described below for async iteration which you can stop as needed.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   */
  listAdSpots(
    request?: protos.google.ads.admanager.v1.IListAdSpotsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IAdSpot[],
      protos.google.ads.admanager.v1.IListAdSpotsRequest | null,
      protos.google.ads.admanager.v1.IListAdSpotsResponse,
    ]
  >;
  listAdSpots(
    request: protos.google.ads.admanager.v1.IListAdSpotsRequest,
    ...
    callback: PaginationCallback<
      protos.google.ads.admanager.v1.IListAdSpotsRequest,
      protos.google.ads.admanager.v1.IListAdSpotsResponse | null | undefined,
      protos.google.ads.admanager.v1.IAdSpot
    >,
  ): void;
  listAdSpots(
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listAdSpots values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listAdSpots request %j', request);
    return this.innerApiCalls
      .listAdSpots(request, options, wrappedCallback)
      ?.then(
        ([response, input, output]: [
          ...
          this._log.info('listAdSpots values %j', response);
  ...
  /**
   * Equivalent to `listAdSpots`, but returns a NodeJS Stream object.
   * @param {Object} request
   *   The request object that will be sent.
   * @param {string} request.parent
   *   Required. The parent, which owns this collection of AdSpots.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.AdSpot|AdSpot} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
  ...
  listAdSpotsStream(
    ...
    const defaultCallSettings = this._defaults['listAdSpots'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch((err) => {
      throw err;
    });
    this._log.info('listAdSpots stream %j', request);
    return this.descriptors.page.listAdSpots.createStream(
      this.innerApiCalls.listAdSpots as GaxCall,
      request,
      callSettings,
    );
  }
  ...
  /**
   * Equivalent to `listAdSpots`, but returns an iterable object.
   *
   ...
   *   {@link protos.google.ads.admanager.v1.AdSpot|AdSpot}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/ad_spot_service.list_ad_spots.js</caption>
   * region_tag:admanager_v1_generated_AdSpotService_ListAdSpots_async
   */
  listAdSpotsAsync(
    request?: protos.google.ads.admanager.v1.IListAdSpotsRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.ads.admanager.v1.IAdSpot> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    this._log.info('listAdSpots iterate %j', request);
    return this.descriptors.page.listAdSpots.asyncIterate(
      this.innerApiCalls['listAdSpots'] as GaxCall,
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.ads.admanager.v1.IAdSpot>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.adSpotServiceStub && !this._terminated) {
      return this.adSpotServiceStub.then((stub) => {
