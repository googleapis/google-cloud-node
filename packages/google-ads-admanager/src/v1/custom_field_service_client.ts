...
export class CustomFieldServiceClient {
  ...
  constructor(
    ...
    this.descriptors.page = {
      listCustomFields: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'customFields',
      ),
  ...
  getCustomField(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.ads.admanager.v1.ICustomField,
          | protos.google.ads.admanager.v1.IGetCustomFieldRequest
          | null
          | undefined,
          {} | null | undefined
        >,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .getCustomField(request, options, wrappedCallback)
      ?.then(
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .createCustomField(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.ICustomField,
          protos.google.ads.admanager.v1.ICreateCustomFieldRequest | undefined,
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .batchCreateCustomFields(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchCreateCustomFieldsResponse,
          (
  ...
  updateCustomField(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.ICustomField,
      | protos.google.ads.admanager.v1.IUpdateCustomFieldRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .updateCustomField(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.ICustomField,
          protos.google.ads.admanager.v1.IUpdateCustomFieldRequest | undefined,
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .batchUpdateCustomFields(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchUpdateCustomFieldsResponse,
          (
  ...
  batchActivateCustomFields(
    ...
    [
      ...
      (
        | protos.google.ads.admanager.v1.IBatchActivateCustomFieldsRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .batchActivateCustomFields(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchActivateCustomFieldsResponse,
          (
  ...
  batchDeactivateCustomFields(
    ...
    [
      ...
      (
        | protos.google.ads.admanager.v1.IBatchDeactivateCustomFieldsRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .batchDeactivateCustomFields(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchDeactivateCustomFieldsResponse,
          (
