...
export class ContactServiceClient {
  ...
  createContact(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.ads.admanager.v1.IContact,
          | protos.google.ads.admanager.v1.ICreateContactRequest
          | null
          | undefined,
          {} | null | undefined
        >,
  ...
  batchCreateContacts(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IBatchCreateContactsResponse,
      | protos.google.ads.admanager.v1.IBatchCreateContactsRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .batchCreateContacts(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchCreateContactsResponse,
          (
  ...
  updateContact(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.ads.admanager.v1.IContact,
          | protos.google.ads.admanager.v1.IUpdateContactRequest
          | null
          | undefined,
          {} | null | undefined
        >,
  ...
  batchUpdateContacts(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IBatchUpdateContactsResponse,
      | protos.google.ads.admanager.v1.IBatchUpdateContactsRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .batchUpdateContacts(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchUpdateContactsResponse,
          (
