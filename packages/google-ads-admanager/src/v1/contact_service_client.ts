 ...
 * `src/v1/contact_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './contact_service_client_config.json';
...
export class ContactServiceClient {
  ...
  contactServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of ContactServiceClient.
   *
   ...
   *     const client = new ContactServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof ContactServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.admanager.v1.ContactService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.contactServiceStub) {
      return this.contactServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.ContactService.
    this.contactServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.admanager.v1.ContactService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.ContactService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const contactServiceStubMethods =
        ['getContact', 'listContacts', 'createContact', 'batchCreateContacts', 'updateContact', 'batchUpdateContacts'];
    for (const methodName of contactServiceStubMethods) {
      const callPromise = this.contactServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.Contact|Contact}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/contact_service.get_contact.js</caption>
 * region_tag:admanager_v1_generated_ContactService_GetContact_async
 */
  getContact(
      request?: protos.google.ads.admanager.v1.IGetContactRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IContact,
        protos.google.ads.admanager.v1.IGetContactRequest|undefined, {}|undefined
      ]>;
  getContact(
      request: protos.google.ads.admanager.v1.IGetContactRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IContact,
          protos.google.ads.admanager.v1.IGetContactRequest|null|undefined,
          {}|null|undefined>): void;
  getContact(
      request: protos.google.ads.admanager.v1.IGetContactRequest,
      callback: Callback<
  ...
  getContact(
    ...
    return this.innerApiCalls.getContact(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IContact,
        protos.google.ads.admanager.v1.IGetContactRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getContact response %j', response);
 ...
 * @param {google.ads.admanager.v1.Contact} request.contact
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/contact_service.create_contact.js</caption>
 * region_tag:admanager_v1_generated_ContactService_CreateContact_async
 */
  createContact(
      request?: protos.google.ads.admanager.v1.ICreateContactRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IContact,
        protos.google.ads.admanager.v1.ICreateContactRequest|undefined, {}|undefined
      ]>;
  createContact(
      request: protos.google.ads.admanager.v1.ICreateContactRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IContact,
          protos.google.ads.admanager.v1.ICreateContactRequest|null|undefined,
          {}|null|undefined>): void;
  createContact(
      request: protos.google.ads.admanager.v1.ICreateContactRequest,
      callback: Callback<
  ...
  createContact(
    ...
    return this.innerApiCalls.createContact(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IContact,
        protos.google.ads.admanager.v1.ICreateContactRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('createContact response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchCreateContactsResponse|BatchCreateContactsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/contact_service.batch_create_contacts.js</caption>
 * region_tag:admanager_v1_generated_ContactService_BatchCreateContacts_async
 */
  batchCreateContacts(
      request?: protos.google.ads.admanager.v1.IBatchCreateContactsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IBatchCreateContactsResponse,
        protos.google.ads.admanager.v1.IBatchCreateContactsRequest|undefined, {}|undefined
      ]>;
  batchCreateContacts(
      request: protos.google.ads.admanager.v1.IBatchCreateContactsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IBatchCreateContactsResponse,
          protos.google.ads.admanager.v1.IBatchCreateContactsRequest|null|undefined,
          {}|null|undefined>): void;
  batchCreateContacts(
      request: protos.google.ads.admanager.v1.IBatchCreateContactsRequest,
      callback: Callback<
  ...
  batchCreateContacts(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('batchCreateContacts request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IBatchCreateContactsResponse,
        protos.google.ads.admanager.v1.IBatchCreateContactsRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchCreateContacts response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.batchCreateContacts(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IBatchCreateContactsResponse,
        protos.google.ads.admanager.v1.IBatchCreateContactsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('batchCreateContacts response %j', response);
        return [response, options, rawResponse];
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/contact_service.update_contact.js</caption>
 * region_tag:admanager_v1_generated_ContactService_UpdateContact_async
 */
  updateContact(
      request?: protos.google.ads.admanager.v1.IUpdateContactRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IContact,
        protos.google.ads.admanager.v1.IUpdateContactRequest|undefined, {}|undefined
      ]>;
  updateContact(
      request: protos.google.ads.admanager.v1.IUpdateContactRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IContact,
          protos.google.ads.admanager.v1.IUpdateContactRequest|null|undefined,
          {}|null|undefined>): void;
  updateContact(
      request: protos.google.ads.admanager.v1.IUpdateContactRequest,
      callback: Callback<
  ...
  updateContact(
    ...
    return this.innerApiCalls.updateContact(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IContact,
        protos.google.ads.admanager.v1.IUpdateContactRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('updateContact response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchUpdateContactsResponse|BatchUpdateContactsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/contact_service.batch_update_contacts.js</caption>
 * region_tag:admanager_v1_generated_ContactService_BatchUpdateContacts_async
 */
  batchUpdateContacts(
      request?: protos.google.ads.admanager.v1.IBatchUpdateContactsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IBatchUpdateContactsResponse,
        protos.google.ads.admanager.v1.IBatchUpdateContactsRequest|undefined, {}|undefined
      ]>;
  batchUpdateContacts(
      request: protos.google.ads.admanager.v1.IBatchUpdateContactsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IBatchUpdateContactsResponse,
          protos.google.ads.admanager.v1.IBatchUpdateContactsRequest|null|undefined,
          {}|null|undefined>): void;
  batchUpdateContacts(
      request: protos.google.ads.admanager.v1.IBatchUpdateContactsRequest,
      callback: Callback<
  ...
  batchUpdateContacts(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('batchUpdateContacts request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IBatchUpdateContactsResponse,
        protos.google.ads.admanager.v1.IBatchUpdateContactsRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchUpdateContacts response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.batchUpdateContacts(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IBatchUpdateContactsResponse,
        protos.google.ads.admanager.v1.IBatchUpdateContactsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('batchUpdateContacts response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.Contact|Contact}.
 ...
 */
  listContacts(
      request?: protos.google.ads.admanager.v1.IListContactsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IContact[],
        protos.google.ads.admanager.v1.IListContactsRequest|null,
        protos.google.ads.admanager.v1.IListContactsResponse
      ]>;
  listContacts(
      request: protos.google.ads.admanager.v1.IListContactsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListContactsRequest,
          protos.google.ads.admanager.v1.IListContactsResponse|null|undefined,
          protos.google.ads.admanager.v1.IContact>): void;
  listContacts(
      request: protos.google.ads.admanager.v1.IListContactsRequest,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListContactsRequest,
  ...
  listContacts(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.ads.admanager.v1.IListContactsRequest,
      protos.google.ads.admanager.v1.IListContactsResponse|null|undefined,
      protos.google.ads.admanager.v1.IContact>|undefined = callback
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.Contact|Contact} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   {@link protos.google.ads.admanager.v1.Contact|Contact}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/contact_service.list_contacts.js</caption>
 * region_tag:admanager_v1_generated_ContactService_ListContacts_async
 */
  listContactsAsync(
      request?: protos.google.ads.admanager.v1.IListContactsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.admanager.v1.IContact>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listContacts.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.ads.admanager.v1.IContact>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.contactServiceStub && !this._terminated) {
      return this.contactServiceStub.then(stub => {
