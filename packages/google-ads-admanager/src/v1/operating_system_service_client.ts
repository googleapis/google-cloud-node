...
export class OperatingSystemServiceClient {
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof OperatingSystemServiceClient;
    if (
    ...
    this.descriptors.page = {
      listOperatingSystems: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'operatingSystems',
      ),
  ...
  getOperatingSystem(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IOperatingSystem,
      | protos.google.ads.admanager.v1.IGetOperatingSystemRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .getOperatingSystem(request, options, wrappedCallback)
      ?.then(
