 ...
 */
  ...
  fetchReportResultRows(
      ...
      callback: PaginationCallback<
          ...
          protos.google.ads.admanager.v1.ReportDataTable.IRow>): void;
  fetchReportResultRows(
      request: protos.google.ads.admanager.v1.IFetchReportResultRowsRequest,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IFetchReportResultRowsRequest,
  ...
  fetchReportResultRows(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.ads.admanager.v1.IFetchReportResultRowsRequest,
      protos.google.ads.admanager.v1.IFetchReportResultRowsResponse|null|undefined,
      protos.google.ads.admanager.v1.ReportDataTable.IRow>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
 ...
 */
  fetchReportResultRowsAsync(
      request?: protos.google.ads.admanager.v1.IFetchReportResultRowsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.admanager.v1.ReportDataTable.IRow>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.fetchReportResultRows.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.ads.admanager.v1.ReportDataTable.IRow>;
  }
/**
