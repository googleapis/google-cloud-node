 ...
 * `src/v1/ad_break_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './ad_break_service_client_config.json';
 ...
 * @memberof v1
 */
export class AdBreakServiceClient {
  ...
  adBreakServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of AdBreakServiceClient.
   *
   ...
   *     const client = new AdBreakServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof AdBreakServiceClient;
    ...
    this.descriptors.page = {
      listAdBreaks:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'adBreaks')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.admanager.v1.AdBreakService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.adBreakServiceStub) {
      return this.adBreakServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.AdBreakService.
    this.adBreakServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.admanager.v1.AdBreakService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.AdBreakService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const adBreakServiceStubMethods =
        ['getAdBreak', 'listAdBreaks', 'createAdBreak', 'updateAdBreak', 'deleteAdBreak'];
    for (const methodName of adBreakServiceStubMethods) {
      const callPromise = this.adBreakServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.AdBreak|AdBreak}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/ad_break_service.get_ad_break.js</caption>
 * region_tag:admanager_v1_generated_AdBreakService_GetAdBreak_async
 */
  getAdBreak(
      request?: protos.google.ads.admanager.v1.IGetAdBreakRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IAdBreak,
        protos.google.ads.admanager.v1.IGetAdBreakRequest|undefined, {}|undefined
      ]>;
  getAdBreak(
      request: protos.google.ads.admanager.v1.IGetAdBreakRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IAdBreak,
          protos.google.ads.admanager.v1.IGetAdBreakRequest|null|undefined,
          {}|null|undefined>): void;
  getAdBreak(
      request: protos.google.ads.admanager.v1.IGetAdBreakRequest,
      callback: Callback<
  ...
  getAdBreak(
    ...
    this._log.info('getAdBreak request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IAdBreak,
        protos.google.ads.admanager.v1.IGetAdBreakRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('getAdBreak response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.getAdBreak(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IAdBreak,
        protos.google.ads.admanager.v1.IGetAdBreakRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getAdBreak response %j', response);
 ...
 * {@link protos.google.ads.admanager.v1.AdBreakStateEnum.AdBreakState.COMPLETE|`COMPLETE`},
 ...
 * @param {google.ads.admanager.v1.AdBreak} request.adBreak
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/ad_break_service.create_ad_break.js</caption>
 * region_tag:admanager_v1_generated_AdBreakService_CreateAdBreak_async
 */
  createAdBreak(
      request?: protos.google.ads.admanager.v1.ICreateAdBreakRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IAdBreak,
        protos.google.ads.admanager.v1.ICreateAdBreakRequest|undefined, {}|undefined
      ]>;
  createAdBreak(
      request: protos.google.ads.admanager.v1.ICreateAdBreakRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IAdBreak,
          protos.google.ads.admanager.v1.ICreateAdBreakRequest|null|undefined,
          {}|null|undefined>): void;
  createAdBreak(
      request: protos.google.ads.admanager.v1.ICreateAdBreakRequest,
      callback: Callback<
  ...
  createAdBreak(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('createAdBreak request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IAdBreak,
        protos.google.ads.admanager.v1.ICreateAdBreakRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('createAdBreak response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.createAdBreak(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IAdBreak,
        protos.google.ads.admanager.v1.ICreateAdBreakRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('createAdBreak response %j', response);
        return [response, options, rawResponse];
 ...
 * {@link protos.google.ads.admanager.v1.AdBreakStateEnum.AdBreakState.SCHEDULED|`SCHEDULED`}.
 *
 * @param {Object} request
 *   The request object that will be sent.
 * @param {google.ads.admanager.v1.AdBreak} request.adBreak
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/ad_break_service.update_ad_break.js</caption>
 * region_tag:admanager_v1_generated_AdBreakService_UpdateAdBreak_async
 */
  updateAdBreak(
      request?: protos.google.ads.admanager.v1.IUpdateAdBreakRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IAdBreak,
        protos.google.ads.admanager.v1.IUpdateAdBreakRequest|undefined, {}|undefined
      ]>;
  updateAdBreak(
      request: protos.google.ads.admanager.v1.IUpdateAdBreakRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IAdBreak,
          protos.google.ads.admanager.v1.IUpdateAdBreakRequest|null|undefined,
          {}|null|undefined>): void;
  updateAdBreak(
      request: protos.google.ads.admanager.v1.IUpdateAdBreakRequest,
      callback: Callback<
  ...
  updateAdBreak(
    ...
    options.otherArgs.headers[
      ...
      'ad_break.name': request.adBreak!.name ?? '',
    });
    this.initialize().catch(err => {throw err});
    this._log.info('updateAdBreak request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IAdBreak,
        protos.google.ads.admanager.v1.IUpdateAdBreakRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('updateAdBreak response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.updateAdBreak(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IAdBreak,
        protos.google.ads.admanager.v1.IUpdateAdBreakRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('updateAdBreak response %j', response);
        return [response, options, rawResponse];
 ...
 * {@link protos.google.ads.admanager.v1.AdBreakStateEnum.AdBreakState.SCHEDULED|`SCHEDULED`}
 * or
 * {@link protos.google.ads.admanager.v1.AdBreakStateEnum.AdBreakState.DECISIONED|`DECISIONED`}.
 *
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.name
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/ad_break_service.delete_ad_break.js</caption>
 * region_tag:admanager_v1_generated_AdBreakService_DeleteAdBreak_async
 */
  deleteAdBreak(
      request?: protos.google.ads.admanager.v1.IDeleteAdBreakRequest,
      options?: CallOptions):
      Promise<[
        protos.google.protobuf.IEmpty,
        protos.google.ads.admanager.v1.IDeleteAdBreakRequest|undefined, {}|undefined
      ]>;
  deleteAdBreak(
      request: protos.google.ads.admanager.v1.IDeleteAdBreakRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.protobuf.IEmpty,
          protos.google.ads.admanager.v1.IDeleteAdBreakRequest|null|undefined,
          {}|null|undefined>): void;
  deleteAdBreak(
      request: protos.google.ads.admanager.v1.IDeleteAdBreakRequest,
      callback: Callback<
  ...
  deleteAdBreak(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('deleteAdBreak request %j', request);
    const wrappedCallback: Callback<
        protos.google.protobuf.IEmpty,
        protos.google.ads.admanager.v1.IDeleteAdBreakRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('deleteAdBreak response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.deleteAdBreak(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.protobuf.IEmpty,
        protos.google.ads.admanager.v1.IDeleteAdBreakRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('deleteAdBreak response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.AdBreak|AdBreak}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listAdBreaksAsync()`
 *   method described below for async iteration which you can stop as needed.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 */
  listAdBreaks(
      request?: protos.google.ads.admanager.v1.IListAdBreaksRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IAdBreak[],
        protos.google.ads.admanager.v1.IListAdBreaksRequest|null,
        protos.google.ads.admanager.v1.IListAdBreaksResponse
      ]>;
  listAdBreaks(
      request: protos.google.ads.admanager.v1.IListAdBreaksRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListAdBreaksRequest,
          protos.google.ads.admanager.v1.IListAdBreaksResponse|null|undefined,
          protos.google.ads.admanager.v1.IAdBreak>): void;
  listAdBreaks(
      request: protos.google.ads.admanager.v1.IListAdBreaksRequest,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListAdBreaksRequest,
  ...
  listAdBreaks(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.ads.admanager.v1.IListAdBreaksRequest,
      protos.google.ads.admanager.v1.IListAdBreaksResponse|null|undefined,
      protos.google.ads.admanager.v1.IAdBreak>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listAdBreaks values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listAdBreaks request %j', request);
    return this.innerApiCalls
      .listAdBreaks(request, options, wrappedCallback)
      ?.then(([response, input, output]: [
        protos.google.ads.admanager.v1.IAdBreak[],
        protos.google.ads.admanager.v1.IListAdBreaksRequest|null,
        protos.google.ads.admanager.v1.IListAdBreaksResponse
      ]) => {
        this._log.info('listAdBreaks values %j', response);
        return [response, input, output];
      });
  }

/**
 * Equivalent to `listAdBreaks`, but returns a NodeJS Stream object.
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 *   Required. The parent, which owns this collection of AdBreaks.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.AdBreak|AdBreak} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 */
  listAdBreaksStream(
    ...
    const defaultCallSettings = this._defaults['listAdBreaks'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listAdBreaks stream %j', request);
    return this.descriptors.page.listAdBreaks.createStream(
      this.innerApiCalls.listAdBreaks as GaxCall,
      request,
      callSettings
    );
  }
...
/**
 * Equivalent to `listAdBreaks`, but returns an iterable object.
 *
 ...
 *   {@link protos.google.ads.admanager.v1.AdBreak|AdBreak}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/ad_break_service.list_ad_breaks.js</caption>
 * region_tag:admanager_v1_generated_AdBreakService_ListAdBreaks_async
 */
  listAdBreaksAsync(
      request?: protos.google.ads.admanager.v1.IListAdBreaksRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.admanager.v1.IAdBreak>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listAdBreaks iterate %j', request);
    return this.descriptors.page.listAdBreaks.asyncIterate(
      this.innerApiCalls['listAdBreaks'] as GaxCall,
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.ads.admanager.v1.IAdBreak>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.adBreakServiceStub && !this._terminated) {
      return this.adBreakServiceStub.then(stub => {
