...
export class BrowserLanguageServiceClient {
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof BrowserLanguageServiceClient;
    if (
    ...
    this.descriptors.page = {
      listBrowserLanguages: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'browserLanguages',
      ),
  ...
  getBrowserLanguage(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IBrowserLanguage,
      | protos.google.ads.admanager.v1.IGetBrowserLanguageRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .getBrowserLanguage(request, options, wrappedCallback)
      ?.then(
