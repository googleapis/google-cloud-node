 ...
 * `src/v1/browser_language_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './browser_language_service_client_config.json';
 ...
 * @memberof v1
 */
export class BrowserLanguageServiceClient {
  ...
  browserLanguageServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of BrowserLanguageServiceClient.
   *
   ...
   *     const client = new BrowserLanguageServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof BrowserLanguageServiceClient;
    ...
    this.descriptors.page = {
      listBrowserLanguages:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'browserLanguages')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.admanager.v1.BrowserLanguageService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.browserLanguageServiceStub) {
      return this.browserLanguageServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.BrowserLanguageService.
    this.browserLanguageServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.admanager.v1.BrowserLanguageService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.BrowserLanguageService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const browserLanguageServiceStubMethods =
        ['getBrowserLanguage', 'listBrowserLanguages'];
    for (const methodName of browserLanguageServiceStubMethods) {
      const callPromise = this.browserLanguageServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BrowserLanguage|BrowserLanguage}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/browser_language_service.get_browser_language.js</caption>
 * region_tag:admanager_v1_generated_BrowserLanguageService_GetBrowserLanguage_async
 */
  getBrowserLanguage(
      request?: protos.google.ads.admanager.v1.IGetBrowserLanguageRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IBrowserLanguage,
        protos.google.ads.admanager.v1.IGetBrowserLanguageRequest|undefined, {}|undefined
      ]>;
  getBrowserLanguage(
      request: protos.google.ads.admanager.v1.IGetBrowserLanguageRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IBrowserLanguage,
          protos.google.ads.admanager.v1.IGetBrowserLanguageRequest|null|undefined,
          {}|null|undefined>): void;
  getBrowserLanguage(
      request: protos.google.ads.admanager.v1.IGetBrowserLanguageRequest,
      callback: Callback<
  ...
  getBrowserLanguage(
    ...
    this._log.info('getBrowserLanguage request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IBrowserLanguage,
        protos.google.ads.admanager.v1.IGetBrowserLanguageRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('getBrowserLanguage response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.getBrowserLanguage(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IBrowserLanguage,
        protos.google.ads.admanager.v1.IGetBrowserLanguageRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getBrowserLanguage response %j', response);
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.BrowserLanguage|BrowserLanguage}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listBrowserLanguagesAsync()`
 *   method described below for async iteration which you can stop as needed.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 */
  listBrowserLanguages(
      request?: protos.google.ads.admanager.v1.IListBrowserLanguagesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IBrowserLanguage[],
        protos.google.ads.admanager.v1.IListBrowserLanguagesRequest|null,
        protos.google.ads.admanager.v1.IListBrowserLanguagesResponse
      ]>;
  listBrowserLanguages(
      request: protos.google.ads.admanager.v1.IListBrowserLanguagesRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListBrowserLanguagesRequest,
          protos.google.ads.admanager.v1.IListBrowserLanguagesResponse|null|undefined,
          protos.google.ads.admanager.v1.IBrowserLanguage>): void;
  listBrowserLanguages(
      request: protos.google.ads.admanager.v1.IListBrowserLanguagesRequest,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListBrowserLanguagesRequest,
  ...
  listBrowserLanguages(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.ads.admanager.v1.IListBrowserLanguagesRequest,
      protos.google.ads.admanager.v1.IListBrowserLanguagesResponse|null|undefined,
      protos.google.ads.admanager.v1.IBrowserLanguage>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listBrowserLanguages values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listBrowserLanguages request %j', request);
    return this.innerApiCalls
      .listBrowserLanguages(request, options, wrappedCallback)
      ?.then(([response, input, output]: [
        protos.google.ads.admanager.v1.IBrowserLanguage[],
        protos.google.ads.admanager.v1.IListBrowserLanguagesRequest|null,
        protos.google.ads.admanager.v1.IListBrowserLanguagesResponse
      ]) => {
        this._log.info('listBrowserLanguages values %j', response);
        return [response, input, output];
      });
  }

/**
 * Equivalent to `listBrowserLanguages`, but returns a NodeJS Stream object.
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 *   Required. The parent, which owns this collection of BrowserLanguages.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.BrowserLanguage|BrowserLanguage} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 */
  listBrowserLanguagesStream(
    ...
    const defaultCallSettings = this._defaults['listBrowserLanguages'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listBrowserLanguages stream %j', request);
    return this.descriptors.page.listBrowserLanguages.createStream(
      this.innerApiCalls.listBrowserLanguages as GaxCall,
      request,
      callSettings
    );
  }
...
/**
 * Equivalent to `listBrowserLanguages`, but returns an iterable object.
 *
 ...
 *   {@link protos.google.ads.admanager.v1.BrowserLanguage|BrowserLanguage}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/browser_language_service.list_browser_languages.js</caption>
 * region_tag:admanager_v1_generated_BrowserLanguageService_ListBrowserLanguages_async
 */
  listBrowserLanguagesAsync(
      request?: protos.google.ads.admanager.v1.IListBrowserLanguagesRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.admanager.v1.IBrowserLanguage>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listBrowserLanguages iterate %j', request);
    return this.descriptors.page.listBrowserLanguages.asyncIterate(
      this.innerApiCalls['listBrowserLanguages'] as GaxCall,
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.ads.admanager.v1.IBrowserLanguage>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.browserLanguageServiceStub && !this._terminated) {
      return this.browserLanguageServiceStub.then(stub => {
