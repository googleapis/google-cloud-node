 ...
 * `src/v1/dai_session_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './dai_session_service_client_config.json';
 ...
 * @memberof v1
 */
export class DaiSessionServiceClient {
  ...
  daiSessionServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of DaiSessionServiceClient.
   *
   ...
   *     const client = new DaiSessionServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(
    opts?: ClientOptions,
    ...
    const staticMembers = this.constructor as typeof DaiSessionServiceClient;
    if (
    ...
    this._defaults = this._gaxGrpc.constructSettings(
      'google.ads.admanager.v1.DaiSessionService',
  ...
  initialize() {
    ...
    if (this.daiSessionServiceStub) {
      return this.daiSessionServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.DaiSessionService.
    this.daiSessionServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ? (this._protos as protobuf.Root).lookupService(
            'google.ads.admanager.v1.DaiSessionService',
          )
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.DaiSessionService,
      this._opts,
      this._providedCustomServicePath,
    ...
    const daiSessionServiceStubMethods = ['getDaiSession'];
    for (const methodName of daiSessionServiceStubMethods) {
      const callPromise = this.daiSessionServiceStub.then(
        stub =>
          (...args: Array<{}>) => {
            if (this._terminated) {
   ...
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.DaiSession|DaiSession}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/dai_session_service.get_dai_session.js</caption>
   * region_tag:admanager_v1_generated_DaiSessionService_GetDaiSession_async
   */
  getDaiSession(
    request?: protos.google.ads.admanager.v1.IGetDaiSessionRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IDaiSession,
      protos.google.ads.admanager.v1.IGetDaiSessionRequest | undefined,
      {} | undefined,
    ]
  >;
  getDaiSession(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IDaiSession,
      protos.google.ads.admanager.v1.IGetDaiSessionRequest | null | undefined,
      {} | null | undefined
    >,
  ): void;
  getDaiSession(
  ...
  getDaiSession(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.ads.admanager.v1.IDaiSession,
          | protos.google.ads.admanager.v1.IGetDaiSessionRequest
          | null
          | undefined,
          {} | null | undefined
        >,
  ...
  > | void {
    ...
    this._log.info('getDaiSession request %j', request);
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('getDaiSession response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .getDaiSession(request, options, wrappedCallback)
      ?.then(
   ...
   */
  close(): Promise<void> {
    if (this.daiSessionServiceStub && !this._terminated) {
      return this.daiSessionServiceStub.then(stub => {
