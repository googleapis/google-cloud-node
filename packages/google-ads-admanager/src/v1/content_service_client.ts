...
export class ContentServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.admanager.v1.ContentService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.contentServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.admanager.v1.ContentService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.ContentService,
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.Content|Content}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/content_service.get_content.js</caption>
 * region_tag:admanager_v1_generated_ContentService_GetContent_async
 */
  getContent(
      request?: protos.google.ads.admanager.v1.IGetContentRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IContent,
        protos.google.ads.admanager.v1.IGetContentRequest|undefined, {}|undefined
      ]>;
  getContent(
      request: protos.google.ads.admanager.v1.IGetContentRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IContent,
          protos.google.ads.admanager.v1.IGetContentRequest|null|undefined,
          {}|null|undefined>): void;
  getContent(
      request: protos.google.ads.admanager.v1.IGetContentRequest,
      callback: Callback<
  ...
  getContent(
    ...
    return this.innerApiCalls.getContent(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IContent,
        protos.google.ads.admanager.v1.IGetContentRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getContent response %j', response);
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.Content|Content}.
 ...
 */
  listContent(
      request?: protos.google.ads.admanager.v1.IListContentRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IContent[],
        protos.google.ads.admanager.v1.IListContentRequest|null,
        protos.google.ads.admanager.v1.IListContentResponse
      ]>;
  listContent(
      request: protos.google.ads.admanager.v1.IListContentRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListContentRequest,
          protos.google.ads.admanager.v1.IListContentResponse|null|undefined,
          protos.google.ads.admanager.v1.IContent>): void;
  listContent(
      request: protos.google.ads.admanager.v1.IListContentRequest,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListContentRequest,
  ...
  listContent(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.ads.admanager.v1.IListContentRequest,
      protos.google.ads.admanager.v1.IListContentResponse|null|undefined,
      protos.google.ads.admanager.v1.IContent>|undefined = callback
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.Content|Content} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   {@link protos.google.ads.admanager.v1.Content|Content}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/content_service.list_content.js</caption>
 * region_tag:admanager_v1_generated_ContentService_ListContent_async
 */
  listContentAsync(
      request?: protos.google.ads.admanager.v1.IListContentRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.admanager.v1.IContent>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listContent.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.ads.admanager.v1.IContent>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
