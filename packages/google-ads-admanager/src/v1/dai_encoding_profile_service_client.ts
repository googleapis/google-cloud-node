 ...
 * `src/v1/dai_encoding_profile_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './dai_encoding_profile_service_client_config.json';
 ...
 * @memberof v1
 */
export class DaiEncodingProfileServiceClient {
   ...
   *     const client = new DaiEncodingProfileServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(
    opts?: ClientOptions,
    ...
    const staticMembers = this
      .constructor as typeof DaiEncodingProfileServiceClient;
    if (
    ...
    this.descriptors.page = {
      listDaiEncodingProfiles: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'daiEncodingProfiles',
      ),
  ...
  initialize() {
    ...
    if (this.daiEncodingProfileServiceStub) {
      return this.daiEncodingProfileServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.DaiEncodingProfileService.
    this.daiEncodingProfileServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
    ...
    const daiEncodingProfileServiceStubMethods = [
   ...
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.DaiEncodingProfile|DaiEncodingProfile}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/dai_encoding_profile_service.get_dai_encoding_profile.js</caption>
   * region_tag:admanager_v1_generated_DaiEncodingProfileService_GetDaiEncodingProfile_async
   */
  getDaiEncodingProfile(
    request?: protos.google.ads.admanager.v1.IGetDaiEncodingProfileRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IDaiEncodingProfile,
      protos.google.ads.admanager.v1.IGetDaiEncodingProfileRequest | undefined,
      {} | undefined,
    ]
  >;
  getDaiEncodingProfile(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IDaiEncodingProfile,
      | protos.google.ads.admanager.v1.IGetDaiEncodingProfileRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('getDaiEncodingProfile response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .getDaiEncodingProfile(request, options, wrappedCallback)
      ?.then(
   ...
   * @param {google.ads.admanager.v1.DaiEncodingProfile} request.daiEncodingProfile
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/dai_encoding_profile_service.create_dai_encoding_profile.js</caption>
   * region_tag:admanager_v1_generated_DaiEncodingProfileService_CreateDaiEncodingProfile_async
   */
  createDaiEncodingProfile(
    request?: protos.google.ads.admanager.v1.ICreateDaiEncodingProfileRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IDaiEncodingProfile,
      (
        | protos.google.ads.admanager.v1.ICreateDaiEncodingProfileRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('createDaiEncodingProfile response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .createDaiEncodingProfile(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IDaiEncodingProfile,
          (
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchCreateDaiEncodingProfilesResponse|BatchCreateDaiEncodingProfilesResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/dai_encoding_profile_service.batch_create_dai_encoding_profiles.js</caption>
   * region_tag:admanager_v1_generated_DaiEncodingProfileService_BatchCreateDaiEncodingProfiles_async
   */
  batchCreateDaiEncodingProfiles(
    request?: protos.google.ads.admanager.v1.IBatchCreateDaiEncodingProfilesRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchCreateDaiEncodingProfilesResponse,
      (
        | protos.google.ads.admanager.v1.IBatchCreateDaiEncodingProfilesRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'batchCreateDaiEncodingProfiles response %j',
            response,
          );
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchCreateDaiEncodingProfiles(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchCreateDaiEncodingProfilesResponse,
          (
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/dai_encoding_profile_service.update_dai_encoding_profile.js</caption>
   * region_tag:admanager_v1_generated_DaiEncodingProfileService_UpdateDaiEncodingProfile_async
   */
  updateDaiEncodingProfile(
    request?: protos.google.ads.admanager.v1.IUpdateDaiEncodingProfileRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IDaiEncodingProfile,
      (
        | protos.google.ads.admanager.v1.IUpdateDaiEncodingProfileRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('updateDaiEncodingProfile response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .updateDaiEncodingProfile(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IDaiEncodingProfile,
          (
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchUpdateDaiEncodingProfilesResponse|BatchUpdateDaiEncodingProfilesResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/dai_encoding_profile_service.batch_update_dai_encoding_profiles.js</caption>
   * region_tag:admanager_v1_generated_DaiEncodingProfileService_BatchUpdateDaiEncodingProfiles_async
   */
  batchUpdateDaiEncodingProfiles(
    request?: protos.google.ads.admanager.v1.IBatchUpdateDaiEncodingProfilesRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchUpdateDaiEncodingProfilesResponse,
      (
        | protos.google.ads.admanager.v1.IBatchUpdateDaiEncodingProfilesRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'batchUpdateDaiEncodingProfiles response %j',
            response,
          );
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchUpdateDaiEncodingProfiles(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchUpdateDaiEncodingProfilesResponse,
          (
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchActivateDaiEncodingProfilesResponse|BatchActivateDaiEncodingProfilesResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/dai_encoding_profile_service.batch_activate_dai_encoding_profiles.js</caption>
   * region_tag:admanager_v1_generated_DaiEncodingProfileService_BatchActivateDaiEncodingProfiles_async
   */
  batchActivateDaiEncodingProfiles(
    request?: protos.google.ads.admanager.v1.IBatchActivateDaiEncodingProfilesRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchActivateDaiEncodingProfilesResponse,
      (
        | protos.google.ads.admanager.v1.IBatchActivateDaiEncodingProfilesRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'batchActivateDaiEncodingProfiles response %j',
            response,
          );
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchActivateDaiEncodingProfiles(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchActivateDaiEncodingProfilesResponse,
          (
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchArchiveDaiEncodingProfilesResponse|BatchArchiveDaiEncodingProfilesResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/dai_encoding_profile_service.batch_archive_dai_encoding_profiles.js</caption>
   * region_tag:admanager_v1_generated_DaiEncodingProfileService_BatchArchiveDaiEncodingProfiles_async
   */
  batchArchiveDaiEncodingProfiles(
    request?: protos.google.ads.admanager.v1.IBatchArchiveDaiEncodingProfilesRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchArchiveDaiEncodingProfilesResponse,
      (
        | protos.google.ads.admanager.v1.IBatchArchiveDaiEncodingProfilesRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'batchArchiveDaiEncodingProfiles response %j',
            response,
          );
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchArchiveDaiEncodingProfiles(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchArchiveDaiEncodingProfilesResponse,
          (
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.DaiEncodingProfile|DaiEncodingProfile}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   *   We recommend using `listDaiEncodingProfilesAsync()`
   *   method described below for async iteration which you can stop as needed.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   */
  listDaiEncodingProfiles(
    request?: protos.google.ads.admanager.v1.IListDaiEncodingProfilesRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IDaiEncodingProfile[],
      protos.google.ads.admanager.v1.IListDaiEncodingProfilesRequest | null,
      protos.google.ads.admanager.v1.IListDaiEncodingProfilesResponse,
    ]
  >;
  listDaiEncodingProfiles(
    request: protos.google.ads.admanager.v1.IListDaiEncodingProfilesRequest,
    ...
    callback: PaginationCallback<
      protos.google.ads.admanager.v1.IListDaiEncodingProfilesRequest,
      | protos.google.ads.admanager.v1.IListDaiEncodingProfilesResponse
      | null
      | undefined,
      protos.google.ads.admanager.v1.IDaiEncodingProfile
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listDaiEncodingProfiles values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listDaiEncodingProfiles request %j', request);
    return this.innerApiCalls
      .listDaiEncodingProfiles(request, options, wrappedCallback)
      ?.then(
        ([response, input, output]: [
          ...
          this._log.info('listDaiEncodingProfiles values %j', response);
  ...
  /**
   * Equivalent to `listDaiEncodingProfiles`, but returns a NodeJS Stream object.
   * @param {Object} request
   *   The request object that will be sent.
   * @param {string} request.parent
   *   Required. The parent, which owns this collection of DaiEncodingProfiles.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.DaiEncodingProfile|DaiEncodingProfile} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
  ...
  listDaiEncodingProfilesStream(
    ...
    return this.descriptors.page.listDaiEncodingProfiles.createStream(
      this.innerApiCalls.listDaiEncodingProfiles as GaxCall,
      request,
      callSettings,
    );
  }
  ...
  /**
   * Equivalent to `listDaiEncodingProfiles`, but returns an iterable object.
   *
   ...
   *   {@link protos.google.ads.admanager.v1.DaiEncodingProfile|DaiEncodingProfile}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/dai_encoding_profile_service.list_dai_encoding_profiles.js</caption>
   * region_tag:admanager_v1_generated_DaiEncodingProfileService_ListDaiEncodingProfiles_async
   */
  listDaiEncodingProfilesAsync(
    request?: protos.google.ads.admanager.v1.IListDaiEncodingProfilesRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.ads.admanager.v1.IDaiEncodingProfile> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listDaiEncodingProfiles.asyncIterate(
      this.innerApiCalls['listDaiEncodingProfiles'] as GaxCall,
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.ads.admanager.v1.IDaiEncodingProfile>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
