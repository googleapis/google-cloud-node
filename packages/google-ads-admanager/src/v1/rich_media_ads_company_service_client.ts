 ...
 * `src/v1/rich_media_ads_company_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './rich_media_ads_company_service_client_config.json';
 ...
 * @memberof v1
 */
export class RichMediaAdsCompanyServiceClient {
  ...
  richMediaAdsCompanyServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of RichMediaAdsCompanyServiceClient.
   *
   ...
   *     const client = new RichMediaAdsCompanyServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof RichMediaAdsCompanyServiceClient;
    ...
    this.descriptors.page = {
      listRichMediaAdsCompanies:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'richMediaAdsCompanies')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.admanager.v1.RichMediaAdsCompanyService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.richMediaAdsCompanyServiceStub) {
      return this.richMediaAdsCompanyServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.RichMediaAdsCompanyService.
    this.richMediaAdsCompanyServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.admanager.v1.RichMediaAdsCompanyService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.RichMediaAdsCompanyService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const richMediaAdsCompanyServiceStubMethods =
        ['getRichMediaAdsCompany', 'listRichMediaAdsCompanies'];
    for (const methodName of richMediaAdsCompanyServiceStubMethods) {
      const callPromise = this.richMediaAdsCompanyServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.RichMediaAdsCompany|RichMediaAdsCompany}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/rich_media_ads_company_service.get_rich_media_ads_company.js</caption>
 * region_tag:admanager_v1_generated_RichMediaAdsCompanyService_GetRichMediaAdsCompany_async
 */
  getRichMediaAdsCompany(
      request?: protos.google.ads.admanager.v1.IGetRichMediaAdsCompanyRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IRichMediaAdsCompany,
        protos.google.ads.admanager.v1.IGetRichMediaAdsCompanyRequest|undefined, {}|undefined
      ]>;
  getRichMediaAdsCompany(
      request: protos.google.ads.admanager.v1.IGetRichMediaAdsCompanyRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IRichMediaAdsCompany,
          protos.google.ads.admanager.v1.IGetRichMediaAdsCompanyRequest|null|undefined,
          {}|null|undefined>): void;
  getRichMediaAdsCompany(
      request: protos.google.ads.admanager.v1.IGetRichMediaAdsCompanyRequest,
      callback: Callback<
  ...
  getRichMediaAdsCompany(
    ...
    this._log.info('getRichMediaAdsCompany request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IRichMediaAdsCompany,
        protos.google.ads.admanager.v1.IGetRichMediaAdsCompanyRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('getRichMediaAdsCompany response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.getRichMediaAdsCompany(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IRichMediaAdsCompany,
        protos.google.ads.admanager.v1.IGetRichMediaAdsCompanyRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getRichMediaAdsCompany response %j', response);
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.RichMediaAdsCompany|RichMediaAdsCompany}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listRichMediaAdsCompaniesAsync()`
 *   method described below for async iteration which you can stop as needed.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 */
  listRichMediaAdsCompanies(
      request?: protos.google.ads.admanager.v1.IListRichMediaAdsCompaniesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IRichMediaAdsCompany[],
        protos.google.ads.admanager.v1.IListRichMediaAdsCompaniesRequest|null,
        protos.google.ads.admanager.v1.IListRichMediaAdsCompaniesResponse
      ]>;
  listRichMediaAdsCompanies(
      request: protos.google.ads.admanager.v1.IListRichMediaAdsCompaniesRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListRichMediaAdsCompaniesRequest,
          protos.google.ads.admanager.v1.IListRichMediaAdsCompaniesResponse|null|undefined,
          protos.google.ads.admanager.v1.IRichMediaAdsCompany>): void;
  listRichMediaAdsCompanies(
      request: protos.google.ads.admanager.v1.IListRichMediaAdsCompaniesRequest,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListRichMediaAdsCompaniesRequest,
  ...
  listRichMediaAdsCompanies(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.ads.admanager.v1.IListRichMediaAdsCompaniesRequest,
      protos.google.ads.admanager.v1.IListRichMediaAdsCompaniesResponse|null|undefined,
      protos.google.ads.admanager.v1.IRichMediaAdsCompany>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listRichMediaAdsCompanies values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listRichMediaAdsCompanies request %j', request);
    return this.innerApiCalls
      .listRichMediaAdsCompanies(request, options, wrappedCallback)
      ?.then(([response, input, output]: [
        protos.google.ads.admanager.v1.IRichMediaAdsCompany[],
        protos.google.ads.admanager.v1.IListRichMediaAdsCompaniesRequest|null,
        protos.google.ads.admanager.v1.IListRichMediaAdsCompaniesResponse
      ]) => {
        this._log.info('listRichMediaAdsCompanies values %j', response);
        return [response, input, output];
      });
  }

/**
 * Equivalent to `listRichMediaAdsCompanies`, but returns a NodeJS Stream object.
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 *   Required. The parent, which owns this collection of RichMediaAdsCompanies.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.RichMediaAdsCompany|RichMediaAdsCompany} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   for more details and examples.
 */
  listRichMediaAdsCompaniesStream(
      request?: protos.google.ads.admanager.v1.IListRichMediaAdsCompaniesRequest,
      options?: CallOptions):
    Transform{
    request = request || {};
    ...
    const defaultCallSettings = this._defaults['listRichMediaAdsCompanies'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listRichMediaAdsCompanies stream %j', request);
    return this.descriptors.page.listRichMediaAdsCompanies.createStream(
      this.innerApiCalls.listRichMediaAdsCompanies as GaxCall,
      request,
      callSettings
    );
  }
...
/**
 * Equivalent to `listRichMediaAdsCompanies`, but returns an iterable object.
 *
 ...
 *   {@link protos.google.ads.admanager.v1.RichMediaAdsCompany|RichMediaAdsCompany}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/rich_media_ads_company_service.list_rich_media_ads_companies.js</caption>
 * region_tag:admanager_v1_generated_RichMediaAdsCompanyService_ListRichMediaAdsCompanies_async
 */
  listRichMediaAdsCompaniesAsync(
      request?: protos.google.ads.admanager.v1.IListRichMediaAdsCompaniesRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.admanager.v1.IRichMediaAdsCompany>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listRichMediaAdsCompanies iterate %j', request);
    return this.descriptors.page.listRichMediaAdsCompanies.asyncIterate(
      this.innerApiCalls['listRichMediaAdsCompanies'] as GaxCall,
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.ads.admanager.v1.IRichMediaAdsCompany>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.richMediaAdsCompanyServiceStub && !this._terminated) {
      return this.richMediaAdsCompanyServiceStub.then(stub => {
