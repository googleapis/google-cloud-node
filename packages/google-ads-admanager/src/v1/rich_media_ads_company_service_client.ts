...
export class RichMediaAdsCompanyServiceClient {
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof RichMediaAdsCompanyServiceClient;
    if (
    ...
    this.descriptors.page = {
      listRichMediaAdsCompanies: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
  ...
  getRichMediaAdsCompany(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IRichMediaAdsCompany,
      | protos.google.ads.admanager.v1.IGetRichMediaAdsCompanyRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .getRichMediaAdsCompany(request, options, wrappedCallback)
      ?.then(
