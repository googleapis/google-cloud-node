 ...
 * `src/v1/dai_authentication_key_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './dai_authentication_key_service_client_config.json';
 ...
 * @memberof v1
 */
export class DaiAuthenticationKeyServiceClient {
   ...
   *     const client = new DaiAuthenticationKeyServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(
    opts?: ClientOptions,
    ...
    const staticMembers = this
      .constructor as typeof DaiAuthenticationKeyServiceClient;
    if (
    ...
    this.descriptors.page = {
      listDaiAuthenticationKeys: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
  ...
  initialize() {
    ...
    if (this.daiAuthenticationKeyServiceStub) {
      return this.daiAuthenticationKeyServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.DaiAuthenticationKeyService.
    this.daiAuthenticationKeyServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
    ...
    const daiAuthenticationKeyServiceStubMethods = [
   ...
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.DaiAuthenticationKey|DaiAuthenticationKey}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/dai_authentication_key_service.get_dai_authentication_key.js</caption>
   * region_tag:admanager_v1_generated_DaiAuthenticationKeyService_GetDaiAuthenticationKey_async
   */
  getDaiAuthenticationKey(
    request?: protos.google.ads.admanager.v1.IGetDaiAuthenticationKeyRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IDaiAuthenticationKey,
      (
        | protos.google.ads.admanager.v1.IGetDaiAuthenticationKeyRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('getDaiAuthenticationKey response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .getDaiAuthenticationKey(request, options, wrappedCallback)
      ?.then(
   ...
   * @param {google.ads.admanager.v1.DaiAuthenticationKey} request.daiAuthenticationKey
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/dai_authentication_key_service.create_dai_authentication_key.js</caption>
   * region_tag:admanager_v1_generated_DaiAuthenticationKeyService_CreateDaiAuthenticationKey_async
   */
  createDaiAuthenticationKey(
    request?: protos.google.ads.admanager.v1.ICreateDaiAuthenticationKeyRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IDaiAuthenticationKey,
      (
        | protos.google.ads.admanager.v1.ICreateDaiAuthenticationKeyRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('createDaiAuthenticationKey response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .createDaiAuthenticationKey(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IDaiAuthenticationKey,
          (
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchCreateDaiAuthenticationKeysResponse|BatchCreateDaiAuthenticationKeysResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/dai_authentication_key_service.batch_create_dai_authentication_keys.js</caption>
   * region_tag:admanager_v1_generated_DaiAuthenticationKeyService_BatchCreateDaiAuthenticationKeys_async
   */
  batchCreateDaiAuthenticationKeys(
    request?: protos.google.ads.admanager.v1.IBatchCreateDaiAuthenticationKeysRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchCreateDaiAuthenticationKeysResponse,
      (
        | protos.google.ads.admanager.v1.IBatchCreateDaiAuthenticationKeysRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'batchCreateDaiAuthenticationKeys response %j',
            response,
          );
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchCreateDaiAuthenticationKeys(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchCreateDaiAuthenticationKeysResponse,
          (
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/dai_authentication_key_service.update_dai_authentication_key.js</caption>
   * region_tag:admanager_v1_generated_DaiAuthenticationKeyService_UpdateDaiAuthenticationKey_async
   */
  updateDaiAuthenticationKey(
    request?: protos.google.ads.admanager.v1.IUpdateDaiAuthenticationKeyRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IDaiAuthenticationKey,
      (
        | protos.google.ads.admanager.v1.IUpdateDaiAuthenticationKeyRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('updateDaiAuthenticationKey response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .updateDaiAuthenticationKey(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IDaiAuthenticationKey,
          (
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchUpdateDaiAuthenticationKeysResponse|BatchUpdateDaiAuthenticationKeysResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/dai_authentication_key_service.batch_update_dai_authentication_keys.js</caption>
   * region_tag:admanager_v1_generated_DaiAuthenticationKeyService_BatchUpdateDaiAuthenticationKeys_async
   */
  batchUpdateDaiAuthenticationKeys(
    request?: protos.google.ads.admanager.v1.IBatchUpdateDaiAuthenticationKeysRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchUpdateDaiAuthenticationKeysResponse,
      (
        | protos.google.ads.admanager.v1.IBatchUpdateDaiAuthenticationKeysRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'batchUpdateDaiAuthenticationKeys response %j',
            response,
          );
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchUpdateDaiAuthenticationKeys(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchUpdateDaiAuthenticationKeysResponse,
          (
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchActivateDaiAuthenticationKeysResponse|BatchActivateDaiAuthenticationKeysResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/dai_authentication_key_service.batch_activate_dai_authentication_keys.js</caption>
   * region_tag:admanager_v1_generated_DaiAuthenticationKeyService_BatchActivateDaiAuthenticationKeys_async
   */
  batchActivateDaiAuthenticationKeys(
    request?: protos.google.ads.admanager.v1.IBatchActivateDaiAuthenticationKeysRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchActivateDaiAuthenticationKeysResponse,
      (
        | protos.google.ads.admanager.v1.IBatchActivateDaiAuthenticationKeysRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'batchActivateDaiAuthenticationKeys response %j',
            response,
          );
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchActivateDaiAuthenticationKeys(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchActivateDaiAuthenticationKeysResponse,
          (
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchDeactivateDaiAuthenticationKeysResponse|BatchDeactivateDaiAuthenticationKeysResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/dai_authentication_key_service.batch_deactivate_dai_authentication_keys.js</caption>
   * region_tag:admanager_v1_generated_DaiAuthenticationKeyService_BatchDeactivateDaiAuthenticationKeys_async
   */
  batchDeactivateDaiAuthenticationKeys(
    request?: protos.google.ads.admanager.v1.IBatchDeactivateDaiAuthenticationKeysRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchDeactivateDaiAuthenticationKeysResponse,
      (
        | protos.google.ads.admanager.v1.IBatchDeactivateDaiAuthenticationKeysRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'batchDeactivateDaiAuthenticationKeys response %j',
            response,
          );
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchDeactivateDaiAuthenticationKeys(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchDeactivateDaiAuthenticationKeysResponse,
          (
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.DaiAuthenticationKey|DaiAuthenticationKey}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   *   We recommend using `listDaiAuthenticationKeysAsync()`
   *   method described below for async iteration which you can stop as needed.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   */
  listDaiAuthenticationKeys(
    request?: protos.google.ads.admanager.v1.IListDaiAuthenticationKeysRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IDaiAuthenticationKey[],
      protos.google.ads.admanager.v1.IListDaiAuthenticationKeysRequest | null,
      protos.google.ads.admanager.v1.IListDaiAuthenticationKeysResponse,
    ]
  >;
  listDaiAuthenticationKeys(
    request: protos.google.ads.admanager.v1.IListDaiAuthenticationKeysRequest,
    ...
    callback: PaginationCallback<
      protos.google.ads.admanager.v1.IListDaiAuthenticationKeysRequest,
      | protos.google.ads.admanager.v1.IListDaiAuthenticationKeysResponse
      | null
      | undefined,
      protos.google.ads.admanager.v1.IDaiAuthenticationKey
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listDaiAuthenticationKeys values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listDaiAuthenticationKeys request %j', request);
    return this.innerApiCalls
      .listDaiAuthenticationKeys(request, options, wrappedCallback)
      ?.then(
        ([response, input, output]: [
          ...
          this._log.info('listDaiAuthenticationKeys values %j', response);
  ...
  /**
   * Equivalent to `listDaiAuthenticationKeys`, but returns a NodeJS Stream object.
   * @param {Object} request
   *   The request object that will be sent.
   * @param {string} request.parent
   *   Required. The parent, which owns this collection of DaiAuthenticationKeys.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.DaiAuthenticationKey|DaiAuthenticationKey} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
   ...
   *   for more details and examples.
   */
  listDaiAuthenticationKeysStream(
    request?: protos.google.ads.admanager.v1.IListDaiAuthenticationKeysRequest,
    options?: CallOptions,
  ): Transform {
    request = request || {};
    ...
    return this.descriptors.page.listDaiAuthenticationKeys.createStream(
      this.innerApiCalls.listDaiAuthenticationKeys as GaxCall,
      request,
      callSettings,
    );
  }
  ...
  /**
   * Equivalent to `listDaiAuthenticationKeys`, but returns an iterable object.
   *
   ...
   *   {@link protos.google.ads.admanager.v1.DaiAuthenticationKey|DaiAuthenticationKey}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/dai_authentication_key_service.list_dai_authentication_keys.js</caption>
   * region_tag:admanager_v1_generated_DaiAuthenticationKeyService_ListDaiAuthenticationKeys_async
   */
  listDaiAuthenticationKeysAsync(
    request?: protos.google.ads.admanager.v1.IListDaiAuthenticationKeysRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.ads.admanager.v1.IDaiAuthenticationKey> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listDaiAuthenticationKeys.asyncIterate(
      this.innerApiCalls['listDaiAuthenticationKeys'] as GaxCall,
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.ads.admanager.v1.IDaiAuthenticationKey>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
