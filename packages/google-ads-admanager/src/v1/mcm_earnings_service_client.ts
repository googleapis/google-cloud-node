 ...
 * `src/v1/mcm_earnings_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './mcm_earnings_service_client_config.json';
 ...
 * @memberof v1
 */
export class McmEarningsServiceClient {
  ...
  mcmEarningsServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of McmEarningsServiceClient.
   *
   ...
   *     const client = new McmEarningsServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof McmEarningsServiceClient;
    ...
    this.descriptors.page = {
      fetchMcmEarnings:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'mcmEarnings')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.admanager.v1.McmEarningsService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.mcmEarningsServiceStub) {
      return this.mcmEarningsServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.McmEarningsService.
    this.mcmEarningsServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.admanager.v1.McmEarningsService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.McmEarningsService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const mcmEarningsServiceStubMethods =
        ['fetchMcmEarnings'];
    for (const methodName of mcmEarningsServiceStubMethods) {
      const callPromise = this.mcmEarningsServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 * @param {google.type.Date} request.month
 *   Required. The month to fetch earnings for. The date will be specified as
 *   the first of the month.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.McmEarnings|McmEarnings}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `fetchMcmEarningsAsync()`
 *   method described below for async iteration which you can stop as needed.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 */
  fetchMcmEarnings(
      request?: protos.google.ads.admanager.v1.IFetchMcmEarningsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IMcmEarnings[],
        protos.google.ads.admanager.v1.IFetchMcmEarningsRequest|null,
        protos.google.ads.admanager.v1.IFetchMcmEarningsResponse
      ]>;
  fetchMcmEarnings(
      request: protos.google.ads.admanager.v1.IFetchMcmEarningsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IFetchMcmEarningsRequest,
          protos.google.ads.admanager.v1.IFetchMcmEarningsResponse|null|undefined,
          protos.google.ads.admanager.v1.IMcmEarnings>): void;
  fetchMcmEarnings(
      request: protos.google.ads.admanager.v1.IFetchMcmEarningsRequest,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IFetchMcmEarningsRequest,
  ...
  fetchMcmEarnings(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.ads.admanager.v1.IFetchMcmEarningsRequest,
      protos.google.ads.admanager.v1.IFetchMcmEarningsResponse|null|undefined,
      protos.google.ads.admanager.v1.IMcmEarnings>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('fetchMcmEarnings values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('fetchMcmEarnings request %j', request);
    return this.innerApiCalls
      .fetchMcmEarnings(request, options, wrappedCallback)
      ?.then(([response, input, output]: [
        protos.google.ads.admanager.v1.IMcmEarnings[],
        protos.google.ads.admanager.v1.IFetchMcmEarningsRequest|null,
        protos.google.ads.admanager.v1.IFetchMcmEarningsResponse
      ]) => {
        this._log.info('fetchMcmEarnings values %j', response);
        return [response, input, output];
      });
  }

/**
 * Equivalent to `fetchMcmEarnings`, but returns a NodeJS Stream object.
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 *   Required. The parent, which owns this collection of McmEarnings.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.McmEarnings|McmEarnings} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 */
  fetchMcmEarningsStream(
    ...
    const defaultCallSettings = this._defaults['fetchMcmEarnings'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('fetchMcmEarnings stream %j', request);
    return this.descriptors.page.fetchMcmEarnings.createStream(
      this.innerApiCalls.fetchMcmEarnings as GaxCall,
      request,
      callSettings
    );
  }
...
/**
 * Equivalent to `fetchMcmEarnings`, but returns an iterable object.
 *
 ...
 *   {@link protos.google.ads.admanager.v1.McmEarnings|McmEarnings}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/mcm_earnings_service.fetch_mcm_earnings.js</caption>
 * region_tag:admanager_v1_generated_McmEarningsService_FetchMcmEarnings_async
 */
  fetchMcmEarningsAsync(
      request?: protos.google.ads.admanager.v1.IFetchMcmEarningsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.admanager.v1.IMcmEarnings>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('fetchMcmEarnings iterate %j', request);
    return this.descriptors.page.fetchMcmEarnings.asyncIterate(
      this.innerApiCalls['fetchMcmEarnings'] as GaxCall,
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.ads.admanager.v1.IMcmEarnings>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.mcmEarningsServiceStub && !this._terminated) {
      return this.mcmEarningsServiceStub.then(stub => {
