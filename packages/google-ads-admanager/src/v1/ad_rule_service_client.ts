 ...
 * `src/v1/ad_rule_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './ad_rule_service_client_config.json';
 ...
 * @memberof v1
 */
export class AdRuleServiceClient {
   ...
   *     const client = new AdRuleServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(
    opts?: ClientOptions,
    ...
    const staticMembers = this.constructor as typeof AdRuleServiceClient;
    if (
    ...
    this.descriptors.page = {
      listAdRules: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'adRules',
      ),
  ...
  initialize() {
    ...
    if (this.adRuleServiceStub) {
      return this.adRuleServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.AdRuleService.
    this.adRuleServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
    ...
    const adRuleServiceStubMethods = [
      'getAdRule',
      'listAdRules',
      'createAdRule',
      'batchCreateAdRules',
   ...
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.AdRule|AdRule}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/ad_rule_service.get_ad_rule.js</caption>
   * region_tag:admanager_v1_generated_AdRuleService_GetAdRule_async
   */
  getAdRule(
    request?: protos.google.ads.admanager.v1.IGetAdRuleRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IAdRule,
      protos.google.ads.admanager.v1.IGetAdRuleRequest | undefined,
      {} | undefined,
    ]
  >;
  getAdRule(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IAdRule,
      protos.google.ads.admanager.v1.IGetAdRuleRequest | null | undefined,
      {} | null | undefined
    >,
  ): void;
  getAdRule(
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('getAdRule response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .getAdRule(request, options, wrappedCallback)
      ?.then(
   ...
   * @param {google.ads.admanager.v1.AdRule} request.adRule
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/ad_rule_service.create_ad_rule.js</caption>
   * region_tag:admanager_v1_generated_AdRuleService_CreateAdRule_async
   */
  createAdRule(
    request?: protos.google.ads.admanager.v1.ICreateAdRuleRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IAdRule,
      protos.google.ads.admanager.v1.ICreateAdRuleRequest | undefined,
      {} | undefined,
    ]
  >;
  createAdRule(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IAdRule,
      protos.google.ads.admanager.v1.ICreateAdRuleRequest | null | undefined,
      {} | null | undefined
    >,
  ): void;
  createAdRule(
  ...
  createAdRule(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.ads.admanager.v1.IAdRule,
          | protos.google.ads.admanager.v1.ICreateAdRuleRequest
          | null
          | undefined,
          {} | null | undefined
        >,
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('createAdRule response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .createAdRule(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IAdRule,
          protos.google.ads.admanager.v1.ICreateAdRuleRequest | undefined,
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchCreateAdRulesResponse|BatchCreateAdRulesResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/ad_rule_service.batch_create_ad_rules.js</caption>
   * region_tag:admanager_v1_generated_AdRuleService_BatchCreateAdRules_async
   */
  batchCreateAdRules(
    request?: protos.google.ads.admanager.v1.IBatchCreateAdRulesRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchCreateAdRulesResponse,
      protos.google.ads.admanager.v1.IBatchCreateAdRulesRequest | undefined,
      {} | undefined,
    ]
  >;
  batchCreateAdRules(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IBatchCreateAdRulesResponse,
      | protos.google.ads.admanager.v1.IBatchCreateAdRulesRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchCreateAdRules response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchCreateAdRules(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchCreateAdRulesResponse,
          protos.google.ads.admanager.v1.IBatchCreateAdRulesRequest | undefined,
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/ad_rule_service.update_ad_rule.js</caption>
   * region_tag:admanager_v1_generated_AdRuleService_UpdateAdRule_async
   */
  updateAdRule(
    request?: protos.google.ads.admanager.v1.IUpdateAdRuleRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IAdRule,
      protos.google.ads.admanager.v1.IUpdateAdRuleRequest | undefined,
      {} | undefined,
    ]
  >;
  updateAdRule(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IAdRule,
      protos.google.ads.admanager.v1.IUpdateAdRuleRequest | null | undefined,
      {} | null | undefined
    >,
  ): void;
  updateAdRule(
  ...
  updateAdRule(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.ads.admanager.v1.IAdRule,
          | protos.google.ads.admanager.v1.IUpdateAdRuleRequest
          | null
          | undefined,
          {} | null | undefined
        >,
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('updateAdRule response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .updateAdRule(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IAdRule,
          protos.google.ads.admanager.v1.IUpdateAdRuleRequest | undefined,
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchUpdateAdRulesResponse|BatchUpdateAdRulesResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/ad_rule_service.batch_update_ad_rules.js</caption>
   * region_tag:admanager_v1_generated_AdRuleService_BatchUpdateAdRules_async
   */
  batchUpdateAdRules(
    request?: protos.google.ads.admanager.v1.IBatchUpdateAdRulesRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchUpdateAdRulesResponse,
      protos.google.ads.admanager.v1.IBatchUpdateAdRulesRequest | undefined,
      {} | undefined,
    ]
  >;
  batchUpdateAdRules(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IBatchUpdateAdRulesResponse,
      | protos.google.ads.admanager.v1.IBatchUpdateAdRulesRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchUpdateAdRules response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchUpdateAdRules(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchUpdateAdRulesResponse,
          protos.google.ads.admanager.v1.IBatchUpdateAdRulesRequest | undefined,
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchActivateAdRulesResponse|BatchActivateAdRulesResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/ad_rule_service.batch_activate_ad_rules.js</caption>
   * region_tag:admanager_v1_generated_AdRuleService_BatchActivateAdRules_async
   */
  batchActivateAdRules(
    request?: protos.google.ads.admanager.v1.IBatchActivateAdRulesRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchActivateAdRulesResponse,
      protos.google.ads.admanager.v1.IBatchActivateAdRulesRequest | undefined,
      {} | undefined,
    ]
  >;
  batchActivateAdRules(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IBatchActivateAdRulesResponse,
      | protos.google.ads.admanager.v1.IBatchActivateAdRulesRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchActivateAdRules response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchActivateAdRules(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchActivateAdRulesResponse,
          (
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchDeactivateAdRulesResponse|BatchDeactivateAdRulesResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/ad_rule_service.batch_deactivate_ad_rules.js</caption>
   * region_tag:admanager_v1_generated_AdRuleService_BatchDeactivateAdRules_async
   */
  batchDeactivateAdRules(
    request?: protos.google.ads.admanager.v1.IBatchDeactivateAdRulesRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchDeactivateAdRulesResponse,
      protos.google.ads.admanager.v1.IBatchDeactivateAdRulesRequest | undefined,
      {} | undefined,
    ]
  >;
  batchDeactivateAdRules(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IBatchDeactivateAdRulesResponse,
      | protos.google.ads.admanager.v1.IBatchDeactivateAdRulesRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchDeactivateAdRules response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchDeactivateAdRules(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchDeactivateAdRulesResponse,
          (
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/ad_rule_service.batch_delete_ad_rules.js</caption>
   * region_tag:admanager_v1_generated_AdRuleService_BatchDeleteAdRules_async
   */
  batchDeleteAdRules(
    request?: protos.google.ads.admanager.v1.IBatchDeleteAdRulesRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.protobuf.IEmpty,
      protos.google.ads.admanager.v1.IBatchDeleteAdRulesRequest | undefined,
      {} | undefined,
    ]
  >;
  batchDeleteAdRules(
    ...
    callback: Callback<
      protos.google.protobuf.IEmpty,
      | protos.google.ads.admanager.v1.IBatchDeleteAdRulesRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchDeleteAdRules response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchDeleteAdRules(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.protobuf.IEmpty,
          protos.google.ads.admanager.v1.IBatchDeleteAdRulesRequest | undefined,
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.AdRule|AdRule}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   *   We recommend using `listAdRulesAsync()`
   *   method described below for async iteration which you can stop as needed.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   */
  listAdRules(
    request?: protos.google.ads.admanager.v1.IListAdRulesRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IAdRule[],
      protos.google.ads.admanager.v1.IListAdRulesRequest | null,
      protos.google.ads.admanager.v1.IListAdRulesResponse,
    ]
  >;
  listAdRules(
    request: protos.google.ads.admanager.v1.IListAdRulesRequest,
    ...
    callback: PaginationCallback<
      protos.google.ads.admanager.v1.IListAdRulesRequest,
      protos.google.ads.admanager.v1.IListAdRulesResponse | null | undefined,
      protos.google.ads.admanager.v1.IAdRule
    >,
  ): void;
  listAdRules(
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listAdRules values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listAdRules request %j', request);
    return this.innerApiCalls
      .listAdRules(request, options, wrappedCallback)
      ?.then(
        ([response, input, output]: [
          ...
          this._log.info('listAdRules values %j', response);
  ...
  /**
   * Equivalent to `listAdRules`, but returns a NodeJS Stream object.
   * @param {Object} request
   *   The request object that will be sent.
   * @param {string} request.parent
   *   Required. The parent, which owns this collection of AdRules.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.AdRule|AdRule} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
  ...
  listAdRulesStream(
    ...
    return this.descriptors.page.listAdRules.createStream(
      this.innerApiCalls.listAdRules as GaxCall,
      request,
      callSettings,
    );
  }
  ...
  /**
   * Equivalent to `listAdRules`, but returns an iterable object.
   *
   ...
   *   {@link protos.google.ads.admanager.v1.AdRule|AdRule}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/ad_rule_service.list_ad_rules.js</caption>
   * region_tag:admanager_v1_generated_AdRuleService_ListAdRules_async
   */
  listAdRulesAsync(
    request?: protos.google.ads.admanager.v1.IListAdRulesRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.ads.admanager.v1.IAdRule> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listAdRules.asyncIterate(
      this.innerApiCalls['listAdRules'] as GaxCall,
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.ads.admanager.v1.IAdRule>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
