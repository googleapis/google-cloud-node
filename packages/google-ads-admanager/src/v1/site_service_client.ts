 ...
 * `src/v1/site_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './site_service_client_config.json';
...
export class SiteServiceClient {
  ...
  siteServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of SiteServiceClient.
   *
   ...
   *     const client = new SiteServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof SiteServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.admanager.v1.SiteService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.siteServiceStub) {
      return this.siteServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.SiteService.
    this.siteServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.admanager.v1.SiteService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.SiteService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const siteServiceStubMethods =
        ['getSite', 'listSites', 'createSite', 'batchCreateSites', 'updateSite', 'batchUpdateSites', 'batchDeactivateSites', 'batchSubmitSitesForApproval'];
    for (const methodName of siteServiceStubMethods) {
      const callPromise = this.siteServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.Site|Site}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/site_service.get_site.js</caption>
 * region_tag:admanager_v1_generated_SiteService_GetSite_async
 */
  getSite(
      request?: protos.google.ads.admanager.v1.IGetSiteRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.ISite,
        protos.google.ads.admanager.v1.IGetSiteRequest|undefined, {}|undefined
      ]>;
  getSite(
      request: protos.google.ads.admanager.v1.IGetSiteRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.ISite,
          protos.google.ads.admanager.v1.IGetSiteRequest|null|undefined,
          {}|null|undefined>): void;
  getSite(
      request: protos.google.ads.admanager.v1.IGetSiteRequest,
      callback: Callback<
  ...
  getSite(
    ...
    return this.innerApiCalls.getSite(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.ISite,
        protos.google.ads.admanager.v1.IGetSiteRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getSite response %j', response);
 ...
 * @param {google.ads.admanager.v1.Site} request.site
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/site_service.create_site.js</caption>
 * region_tag:admanager_v1_generated_SiteService_CreateSite_async
 */
  createSite(
      request?: protos.google.ads.admanager.v1.ICreateSiteRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.ISite,
        protos.google.ads.admanager.v1.ICreateSiteRequest|undefined, {}|undefined
      ]>;
  createSite(
      request: protos.google.ads.admanager.v1.ICreateSiteRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.ISite,
          protos.google.ads.admanager.v1.ICreateSiteRequest|null|undefined,
          {}|null|undefined>): void;
  createSite(
      request: protos.google.ads.admanager.v1.ICreateSiteRequest,
      callback: Callback<
  ...
  createSite(
    ...
    const wrappedCallback: Callback<
        ...
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('createSite response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.createSite(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.ISite,
        protos.google.ads.admanager.v1.ICreateSiteRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('createSite response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchCreateSitesResponse|BatchCreateSitesResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/site_service.batch_create_sites.js</caption>
 * region_tag:admanager_v1_generated_SiteService_BatchCreateSites_async
 */
  batchCreateSites(
      request?: protos.google.ads.admanager.v1.IBatchCreateSitesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IBatchCreateSitesResponse,
        protos.google.ads.admanager.v1.IBatchCreateSitesRequest|undefined, {}|undefined
      ]>;
  batchCreateSites(
      request: protos.google.ads.admanager.v1.IBatchCreateSitesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IBatchCreateSitesResponse,
          protos.google.ads.admanager.v1.IBatchCreateSitesRequest|null|undefined,
          {}|null|undefined>): void;
  batchCreateSites(
      request: protos.google.ads.admanager.v1.IBatchCreateSitesRequest,
      callback: Callback<
  ...
  batchCreateSites(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('batchCreateSites request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IBatchCreateSitesResponse,
        protos.google.ads.admanager.v1.IBatchCreateSitesRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchCreateSites response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.batchCreateSites(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IBatchCreateSitesResponse,
        protos.google.ads.admanager.v1.IBatchCreateSitesRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('batchCreateSites response %j', response);
        return [response, options, rawResponse];
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/site_service.update_site.js</caption>
 * region_tag:admanager_v1_generated_SiteService_UpdateSite_async
 */
  updateSite(
      request?: protos.google.ads.admanager.v1.IUpdateSiteRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.ISite,
        protos.google.ads.admanager.v1.IUpdateSiteRequest|undefined, {}|undefined
      ]>;
  updateSite(
      request: protos.google.ads.admanager.v1.IUpdateSiteRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.ISite,
          protos.google.ads.admanager.v1.IUpdateSiteRequest|null|undefined,
          {}|null|undefined>): void;
  updateSite(
      request: protos.google.ads.admanager.v1.IUpdateSiteRequest,
      callback: Callback<
  ...
  updateSite(
    ...
    const wrappedCallback: Callback<
        ...
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('updateSite response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.updateSite(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.ISite,
        protos.google.ads.admanager.v1.IUpdateSiteRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('updateSite response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchUpdateSitesResponse|BatchUpdateSitesResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/site_service.batch_update_sites.js</caption>
 * region_tag:admanager_v1_generated_SiteService_BatchUpdateSites_async
 */
  batchUpdateSites(
      request?: protos.google.ads.admanager.v1.IBatchUpdateSitesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IBatchUpdateSitesResponse,
        protos.google.ads.admanager.v1.IBatchUpdateSitesRequest|undefined, {}|undefined
      ]>;
  batchUpdateSites(
      request: protos.google.ads.admanager.v1.IBatchUpdateSitesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IBatchUpdateSitesResponse,
          protos.google.ads.admanager.v1.IBatchUpdateSitesRequest|null|undefined,
          {}|null|undefined>): void;
  batchUpdateSites(
      request: protos.google.ads.admanager.v1.IBatchUpdateSitesRequest,
      callback: Callback<
  ...
  batchUpdateSites(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('batchUpdateSites request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IBatchUpdateSitesResponse,
        protos.google.ads.admanager.v1.IBatchUpdateSitesRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchUpdateSites response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.batchUpdateSites(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IBatchUpdateSitesResponse,
        protos.google.ads.admanager.v1.IBatchUpdateSitesRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('batchUpdateSites response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchDeactivateSitesResponse|BatchDeactivateSitesResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/site_service.batch_deactivate_sites.js</caption>
 * region_tag:admanager_v1_generated_SiteService_BatchDeactivateSites_async
 */
  batchDeactivateSites(
      request?: protos.google.ads.admanager.v1.IBatchDeactivateSitesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IBatchDeactivateSitesResponse,
        protos.google.ads.admanager.v1.IBatchDeactivateSitesRequest|undefined, {}|undefined
      ]>;
  batchDeactivateSites(
      request: protos.google.ads.admanager.v1.IBatchDeactivateSitesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IBatchDeactivateSitesResponse,
          protos.google.ads.admanager.v1.IBatchDeactivateSitesRequest|null|undefined,
          {}|null|undefined>): void;
  batchDeactivateSites(
      request: protos.google.ads.admanager.v1.IBatchDeactivateSitesRequest,
      callback: Callback<
  ...
  batchDeactivateSites(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('batchDeactivateSites request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IBatchDeactivateSitesResponse,
        protos.google.ads.admanager.v1.IBatchDeactivateSitesRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchDeactivateSites response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.batchDeactivateSites(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IBatchDeactivateSitesResponse,
        protos.google.ads.admanager.v1.IBatchDeactivateSitesRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('batchDeactivateSites response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchSubmitSitesForApprovalResponse|BatchSubmitSitesForApprovalResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/site_service.batch_submit_sites_for_approval.js</caption>
 * region_tag:admanager_v1_generated_SiteService_BatchSubmitSitesForApproval_async
 */
  batchSubmitSitesForApproval(
      request?: protos.google.ads.admanager.v1.IBatchSubmitSitesForApprovalRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IBatchSubmitSitesForApprovalResponse,
        protos.google.ads.admanager.v1.IBatchSubmitSitesForApprovalRequest|undefined, {}|undefined
      ]>;
  batchSubmitSitesForApproval(
      request: protos.google.ads.admanager.v1.IBatchSubmitSitesForApprovalRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IBatchSubmitSitesForApprovalResponse,
          protos.google.ads.admanager.v1.IBatchSubmitSitesForApprovalRequest|null|undefined,
          {}|null|undefined>): void;
  batchSubmitSitesForApproval(
      request: protos.google.ads.admanager.v1.IBatchSubmitSitesForApprovalRequest,
      callback: Callback<
  ...
  batchSubmitSitesForApproval(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('batchSubmitSitesForApproval request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IBatchSubmitSitesForApprovalResponse,
        protos.google.ads.admanager.v1.IBatchSubmitSitesForApprovalRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchSubmitSitesForApproval response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.batchSubmitSitesForApproval(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IBatchSubmitSitesForApprovalResponse,
        protos.google.ads.admanager.v1.IBatchSubmitSitesForApprovalRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('batchSubmitSitesForApproval response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.Site|Site}.
 ...
 */
  listSites(
      request?: protos.google.ads.admanager.v1.IListSitesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.ISite[],
        protos.google.ads.admanager.v1.IListSitesRequest|null,
        protos.google.ads.admanager.v1.IListSitesResponse
      ]>;
  listSites(
      request: protos.google.ads.admanager.v1.IListSitesRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListSitesRequest,
          protos.google.ads.admanager.v1.IListSitesResponse|null|undefined,
          protos.google.ads.admanager.v1.ISite>): void;
  listSites(
      request: protos.google.ads.admanager.v1.IListSitesRequest,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListSitesRequest,
  ...
  listSites(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.ads.admanager.v1.IListSitesRequest,
      protos.google.ads.admanager.v1.IListSitesResponse|null|undefined,
      protos.google.ads.admanager.v1.ISite>|undefined = callback
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.Site|Site} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   {@link protos.google.ads.admanager.v1.Site|Site}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/site_service.list_sites.js</caption>
 * region_tag:admanager_v1_generated_SiteService_ListSites_async
 */
  listSitesAsync(
      request?: protos.google.ads.admanager.v1.IListSitesRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.admanager.v1.ISite>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listSites.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.ads.admanager.v1.ISite>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.siteServiceStub && !this._terminated) {
      return this.siteServiceStub.then(stub => {
