...
export class CmsMetadataValueServiceClient {
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof CmsMetadataValueServiceClient;
    if (
    ...
    this.descriptors.page = {
      listCmsMetadataValues: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'cmsMetadataValues',
      ),
  ...
  getCmsMetadataValue(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.ICmsMetadataValue,
      | protos.google.ads.admanager.v1.IGetCmsMetadataValueRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .getCmsMetadataValue(request, options, wrappedCallback)
      ?.then(
  ...
  batchActivateCmsMetadataValues(
    ...
    [
      ...
      (
        | protos.google.ads.admanager.v1.IBatchActivateCmsMetadataValuesRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'batchActivateCmsMetadataValues response %j',
            response,
          );
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchActivateCmsMetadataValues(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchActivateCmsMetadataValuesResponse,
          (
  ...
  batchDeactivateCmsMetadataValues(
    ...
    [
      ...
      (
        | protos.google.ads.admanager.v1.IBatchDeactivateCmsMetadataValuesRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'batchDeactivateCmsMetadataValues response %j',
            response,
          );
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchDeactivateCmsMetadataValues(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchDeactivateCmsMetadataValuesResponse,
          (
