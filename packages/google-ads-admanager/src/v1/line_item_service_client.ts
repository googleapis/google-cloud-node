 ...
 * `src/v1/line_item_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './line_item_service_client_config.json';
 ...
 * @memberof v1
 */
export class LineItemServiceClient {
  ...
  lineItemServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of LineItemServiceClient.
   *
   ...
   *     const client = new LineItemServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof LineItemServiceClient;
    ...
    this.descriptors.page = {
      listLineItems:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'lineItems')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.admanager.v1.LineItemService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.lineItemServiceStub) {
      return this.lineItemServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.LineItemService.
    this.lineItemServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.admanager.v1.LineItemService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.LineItemService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const lineItemServiceStubMethods =
        ['getLineItem', 'listLineItems'];
 ...
 * @example <caption>include:samples/generated/v1/line_item_service.get_line_item.js</caption>
 * region_tag:admanager_v1_generated_LineItemService_GetLineItem_async
 */
  getLineItem(
      request?: protos.google.ads.admanager.v1.IGetLineItemRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.ILineItem,
        protos.google.ads.admanager.v1.IGetLineItemRequest|undefined, {}|undefined
      ]>;
  getLineItem(
      request: protos.google.ads.admanager.v1.IGetLineItemRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.ILineItem,
          protos.google.ads.admanager.v1.IGetLineItemRequest|null|undefined,
          {}|null|undefined>): void;
  getLineItem(
      request: protos.google.ads.admanager.v1.IGetLineItemRequest,
      callback: Callback<
  ...
  getLineItem(
    ...
    this._log.info('getLineItem request %j', request);
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getLineItem(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.ILineItem,
        protos.google.ads.admanager.v1.IGetLineItemRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getLineItem response %j', response);
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.LineItem|LineItem}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listLineItemsAsync()`
 *   method described below for async iteration which you can stop as needed.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 */
  listLineItems(
      request?: protos.google.ads.admanager.v1.IListLineItemsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.ILineItem[],
        protos.google.ads.admanager.v1.IListLineItemsRequest|null,
        protos.google.ads.admanager.v1.IListLineItemsResponse
      ]>;
  listLineItems(
      request: protos.google.ads.admanager.v1.IListLineItemsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListLineItemsRequest,
          protos.google.ads.admanager.v1.IListLineItemsResponse|null|undefined,
          protos.google.ads.admanager.v1.ILineItem>): void;
  listLineItems(
      request: protos.google.ads.admanager.v1.IListLineItemsRequest,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListLineItemsRequest,
  ...
  listLineItems(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.ads.admanager.v1.IListLineItemsRequest,
      protos.google.ads.admanager.v1.IListLineItemsResponse|null|undefined,
      protos.google.ads.admanager.v1.ILineItem>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listLineItems values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listLineItems request %j', request);
    return this.innerApiCalls
      .listLineItems(request, options, wrappedCallback)
      ?.then(([response, input, output]: [
        protos.google.ads.admanager.v1.ILineItem[],
        protos.google.ads.admanager.v1.IListLineItemsRequest|null,
        protos.google.ads.admanager.v1.IListLineItemsResponse
      ]) => {
        this._log.info('listLineItems values %j', response);
        return [response, input, output];
      });
  }

/**
 * Equivalent to `listLineItems`, but returns a NodeJS Stream object.
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 *   Required. The parent, which owns this collection of LineItems.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.LineItem|LineItem} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 */
  listLineItemsStream(
    ...
    const defaultCallSettings = this._defaults['listLineItems'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listLineItems stream %j', request);
    return this.descriptors.page.listLineItems.createStream(
      this.innerApiCalls.listLineItems as GaxCall,
      request,
      callSettings
    );
  }
...
/**
 * Equivalent to `listLineItems`, but returns an iterable object.
 *
 ...
 *   {@link protos.google.ads.admanager.v1.LineItem|LineItem}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/line_item_service.list_line_items.js</caption>
 * region_tag:admanager_v1_generated_LineItemService_ListLineItems_async
 */
  listLineItemsAsync(
      request?: protos.google.ads.admanager.v1.IListLineItemsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.admanager.v1.ILineItem>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listLineItems iterate %j', request);
    return this.descriptors.page.listLineItems.asyncIterate(
      this.innerApiCalls['listLineItems'] as GaxCall,
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.ads.admanager.v1.ILineItem>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.lineItemServiceStub && !this._terminated) {
      return this.lineItemServiceStub.then(stub => {
