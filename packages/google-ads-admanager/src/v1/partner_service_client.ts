 ...
 * `src/v1/partner_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './partner_service_client_config.json';
const version = require('../../../package.json').version;

/**
 *  Provides methods for handling {@link protos.google.ads.admanager.v1.Partner|Partner}
 *  objects.
 * @class
 * @memberof v1
 */
export class PartnerServiceClient {
  ...
  partnerServiceStub?: Promise<{ [name: string]: Function }>;

  /**
   * Construct an instance of PartnerServiceClient.
   *
   ...
   *     const client = new PartnerServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(
    opts?: ClientOptions,
    ...
    const staticMembers = this.constructor as typeof PartnerServiceClient;
    if (
    ...
    this.descriptors.page = {
      listPartners: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'partners',
      ),
  ...
  initialize() {
    ...
    if (this.partnerServiceStub) {
      return this.partnerServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.PartnerService.
    this.partnerServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ? (this._protos as protobuf.Root).lookupService(
            'google.ads.admanager.v1.PartnerService',
          )
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.PartnerService,
      this._opts,
      this._providedCustomServicePath,
    ...
    const partnerServiceStubMethods = [
      'getPartner',
      'listPartners',
      'updatePartner',
      'batchUpdatePartners',
    ];
    for (const methodName of partnerServiceStubMethods) {
      const callPromise = this.partnerServiceStub.then(
        (stub) =>
          (...args: Array<{}>) => {
            if (this._terminated) {
  ...
  // -------------------
  /**
   * Retrieves a {@link protos.google.ads.admanager.v1.Partner|Partner} object.
   *
   * @param {Object} request
   *   The request object that will be sent.
   * @param {string} request.name
   *   Required. The resource name of the
   *   {@link protos.google.ads.admanager.v1.Partner|Partner}. Format:
   *   `networks/{network_code}/partners/{partner_id}`
   * @param {object} [options]
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.Partner|Partner}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/partner_service.get_partner.js</caption>
   * region_tag:admanager_v1_generated_PartnerService_GetPartner_async
   */
  getPartner(
    request?: protos.google.ads.admanager.v1.IGetPartnerRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IPartner,
      protos.google.ads.admanager.v1.IGetPartnerRequest | undefined,
      {} | undefined,
    ]
  >;
  getPartner(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IPartner,
      protos.google.ads.admanager.v1.IGetPartnerRequest | null | undefined,
      {} | null | undefined
    >,
  ): void;
  getPartner(
  ...
  /**
   * Updates a {@link protos.google.ads.admanager.v1.Partner|Partner} object.
   *
   * @param {Object} request
   *   The request object that will be sent.
   * @param {google.ads.admanager.v1.Partner} request.partner
   *   Required. The {@link protos.google.ads.admanager.v1.Partner|Partner} to update.
   *
   *   The {@link protos.google.ads.admanager.v1.Partner|Partner}'s `name` is used to identify
   *   the {@link protos.google.ads.admanager.v1.Partner|Partner} to update.
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/partner_service.update_partner.js</caption>
   * region_tag:admanager_v1_generated_PartnerService_UpdatePartner_async
   */
  updatePartner(
    request?: protos.google.ads.admanager.v1.IUpdatePartnerRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IPartner,
      protos.google.ads.admanager.v1.IUpdatePartnerRequest | undefined,
      {} | undefined,
    ]
  >;
  updatePartner(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IPartner,
      protos.google.ads.admanager.v1.IUpdatePartnerRequest | null | undefined,
      {} | null | undefined
    >,
  ): void;
  updatePartner(
  ...
  updatePartner(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.ads.admanager.v1.IPartner,
          | protos.google.ads.admanager.v1.IUpdatePartnerRequest
          | null
          | undefined,
          {} | null | undefined
        >,
  ...
  > | void {
    ...
    this._log.info('updatePartner request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.ads.admanager.v1.IPartner,
          | protos.google.ads.admanager.v1.IUpdatePartnerRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('updatePartner response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .updatePartner(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IPartner,
          protos.google.ads.admanager.v1.IUpdatePartnerRequest | undefined,
  ...
  /**
   * Batch updates {@link protos.google.ads.admanager.v1.Partner|Partner} objects.
   *
   * @param {Object} request
   *   The request object that will be sent.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchUpdatePartnersResponse|BatchUpdatePartnersResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/partner_service.batch_update_partners.js</caption>
   * region_tag:admanager_v1_generated_PartnerService_BatchUpdatePartners_async
   */
  batchUpdatePartners(
    request?: protos.google.ads.admanager.v1.IBatchUpdatePartnersRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchUpdatePartnersResponse,
      protos.google.ads.admanager.v1.IBatchUpdatePartnersRequest | undefined,
      {} | undefined,
    ]
  >;
  batchUpdatePartners(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IBatchUpdatePartnersResponse,
      | protos.google.ads.admanager.v1.IBatchUpdatePartnersRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    this._log.info('batchUpdatePartners request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.ads.admanager.v1.IBatchUpdatePartnersResponse,
          | protos.google.ads.admanager.v1.IBatchUpdatePartnersRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchUpdatePartners response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchUpdatePartners(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchUpdatePartnersResponse,
          (
  ...
  /**
   * Lists {@link protos.google.ads.admanager.v1.Partner|Partner} objects.
   *
   * @param {Object} request
   *   The request object that will be sent.
   * @param {string} request.parent
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.Partner|Partner}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   *   We recommend using `listPartnersAsync()`
   *   method described below for async iteration which you can stop as needed.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   */
  listPartners(
    request?: protos.google.ads.admanager.v1.IListPartnersRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IPartner[],
      protos.google.ads.admanager.v1.IListPartnersRequest | null,
      protos.google.ads.admanager.v1.IListPartnersResponse,
    ]
  >;
  listPartners(
    request: protos.google.ads.admanager.v1.IListPartnersRequest,
    ...
    callback: PaginationCallback<
      protos.google.ads.admanager.v1.IListPartnersRequest,
      protos.google.ads.admanager.v1.IListPartnersResponse | null | undefined,
      protos.google.ads.admanager.v1.IPartner
    >,
  ): void;
  listPartners(
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listPartners values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listPartners request %j', request);
    return this.innerApiCalls
      .listPartners(request, options, wrappedCallback)
      ?.then(
        ([response, input, output]: [
          ...
          this._log.info('listPartners values %j', response);
  ...
  /**
   * Equivalent to `listPartners`, but returns a NodeJS Stream object.
   * @param {Object} request
   *   The request object that will be sent.
   * @param {string} request.parent
   *   Required. The parent, which owns this collection of
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.Partner|Partner} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
  ...
  listPartnersStream(
    ...
    const defaultCallSettings = this._defaults['listPartners'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch((err) => {
      throw err;
    });
    this._log.info('listPartners stream %j', request);
    return this.descriptors.page.listPartners.createStream(
      this.innerApiCalls.listPartners as GaxCall,
      request,
      callSettings,
    );
  }
  ...
  /**
   * Equivalent to `listPartners`, but returns an iterable object.
   *
   ...
   *   {@link protos.google.ads.admanager.v1.Partner|Partner}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/partner_service.list_partners.js</caption>
   * region_tag:admanager_v1_generated_PartnerService_ListPartners_async
   */
  listPartnersAsync(
    request?: protos.google.ads.admanager.v1.IListPartnersRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.ads.admanager.v1.IPartner> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    this._log.info('listPartners iterate %j', request);
    return this.descriptors.page.listPartners.asyncIterate(
      this.innerApiCalls['listPartners'] as GaxCall,
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.ads.admanager.v1.IPartner>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.partnerServiceStub && !this._terminated) {
      return this.partnerServiceStub.then((stub) => {
