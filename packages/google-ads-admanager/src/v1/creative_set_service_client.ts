 ...
 * `src/v1/creative_set_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './creative_set_service_client_config.json';
 ...
 * @memberof v1
 */
export class CreativeSetServiceClient {
  ...
  creativeSetServiceStub?: Promise<{ [name: string]: Function }>;

  /**
   * Construct an instance of CreativeSetServiceClient.
   *
   ...
   *     const client = new CreativeSetServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(
    opts?: ClientOptions,
    ...
    const staticMembers = this.constructor as typeof CreativeSetServiceClient;
    if (
    ...
    this.descriptors.page = {
      listCreativeSets: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'creativeSets',
      ),
  ...
  initialize() {
    ...
    if (this.creativeSetServiceStub) {
      return this.creativeSetServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.CreativeSetService.
    this.creativeSetServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ? (this._protos as protobuf.Root).lookupService(
            'google.ads.admanager.v1.CreativeSetService',
          )
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.CreativeSetService,
      this._opts,
      this._providedCustomServicePath,
    ...
    const creativeSetServiceStubMethods = [
      'getCreativeSet',
      'listCreativeSets',
      'createCreativeSet',
      'updateCreativeSet',
    ];
    for (const methodName of creativeSetServiceStubMethods) {
      const callPromise = this.creativeSetServiceStub.then(
        (stub) =>
          (...args: Array<{}>) => {
            if (this._terminated) {
   ...
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.CreativeSet|CreativeSet}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/creative_set_service.get_creative_set.js</caption>
   * region_tag:admanager_v1_generated_CreativeSetService_GetCreativeSet_async
   */
  getCreativeSet(
    request?: protos.google.ads.admanager.v1.IGetCreativeSetRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.ICreativeSet,
      protos.google.ads.admanager.v1.IGetCreativeSetRequest | undefined,
      {} | undefined,
    ]
  >;
  getCreativeSet(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.ICreativeSet,
      protos.google.ads.admanager.v1.IGetCreativeSetRequest | null | undefined,
      {} | null | undefined
    >,
  ): void;
  getCreativeSet(
  ...
  getCreativeSet(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.ads.admanager.v1.ICreativeSet,
          | protos.google.ads.admanager.v1.IGetCreativeSetRequest
          | null
          | undefined,
          {} | null | undefined
        >,
  ...
  > | void {
    ...
    this._log.info('getCreativeSet request %j', request);
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('getCreativeSet response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .getCreativeSet(request, options, wrappedCallback)
      ?.then(
   ...
   * @param {google.ads.admanager.v1.CreativeSet} request.creativeSet
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/creative_set_service.create_creative_set.js</caption>
   * region_tag:admanager_v1_generated_CreativeSetService_CreateCreativeSet_async
   */
  createCreativeSet(
    request?: protos.google.ads.admanager.v1.ICreateCreativeSetRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.ICreativeSet,
      protos.google.ads.admanager.v1.ICreateCreativeSetRequest | undefined,
      {} | undefined,
    ]
  >;
  createCreativeSet(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.ICreativeSet,
      | protos.google.ads.admanager.v1.ICreateCreativeSetRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    this._log.info('createCreativeSet request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.ads.admanager.v1.ICreativeSet,
          | protos.google.ads.admanager.v1.ICreateCreativeSetRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('createCreativeSet response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .createCreativeSet(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.ICreativeSet,
          protos.google.ads.admanager.v1.ICreateCreativeSetRequest | undefined,
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/creative_set_service.update_creative_set.js</caption>
   * region_tag:admanager_v1_generated_CreativeSetService_UpdateCreativeSet_async
   */
  updateCreativeSet(
    request?: protos.google.ads.admanager.v1.IUpdateCreativeSetRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.ICreativeSet,
      protos.google.ads.admanager.v1.IUpdateCreativeSetRequest | undefined,
      {} | undefined,
    ]
  >;
  updateCreativeSet(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.ICreativeSet,
      | protos.google.ads.admanager.v1.IUpdateCreativeSetRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    options.otherArgs.headers['x-goog-request-params'] =
      this._gaxModule.routingHeader.fromParams({
        'creative_set.name': request.creativeSet!.name ?? '',
      });
    this.initialize().catch((err) => {
      throw err;
    });
    this._log.info('updateCreativeSet request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.ads.admanager.v1.ICreativeSet,
          | protos.google.ads.admanager.v1.IUpdateCreativeSetRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('updateCreativeSet response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .updateCreativeSet(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.ICreativeSet,
          protos.google.ads.admanager.v1.IUpdateCreativeSetRequest | undefined,
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.CreativeSet|CreativeSet}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   *   We recommend using `listCreativeSetsAsync()`
   *   method described below for async iteration which you can stop as needed.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   */
  listCreativeSets(
    request?: protos.google.ads.admanager.v1.IListCreativeSetsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.ICreativeSet[],
      protos.google.ads.admanager.v1.IListCreativeSetsRequest | null,
      protos.google.ads.admanager.v1.IListCreativeSetsResponse,
    ]
  >;
  listCreativeSets(
    request: protos.google.ads.admanager.v1.IListCreativeSetsRequest,
    ...
    callback: PaginationCallback<
      protos.google.ads.admanager.v1.IListCreativeSetsRequest,
      | protos.google.ads.admanager.v1.IListCreativeSetsResponse
      | null
      | undefined,
      protos.google.ads.admanager.v1.ICreativeSet
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listCreativeSets values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listCreativeSets request %j', request);
    return this.innerApiCalls
      .listCreativeSets(request, options, wrappedCallback)
      ?.then(
        ([response, input, output]: [
          ...
          this._log.info('listCreativeSets values %j', response);
  ...
  /**
   * Equivalent to `listCreativeSets`, but returns a NodeJS Stream object.
   * @param {Object} request
   *   The request object that will be sent.
   * @param {string} request.parent
   *   Required. The parent, which owns this collection of CreativeSets.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.CreativeSet|CreativeSet} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
  ...
  listCreativeSetsStream(
    ...
    const defaultCallSettings = this._defaults['listCreativeSets'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch((err) => {
      throw err;
    });
    this._log.info('listCreativeSets stream %j', request);
    return this.descriptors.page.listCreativeSets.createStream(
      this.innerApiCalls.listCreativeSets as GaxCall,
      request,
      callSettings,
    );
  }
  ...
  /**
   * Equivalent to `listCreativeSets`, but returns an iterable object.
   *
   ...
   *   {@link protos.google.ads.admanager.v1.CreativeSet|CreativeSet}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/creative_set_service.list_creative_sets.js</caption>
   * region_tag:admanager_v1_generated_CreativeSetService_ListCreativeSets_async
   */
  listCreativeSetsAsync(
    request?: protos.google.ads.admanager.v1.IListCreativeSetsRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.ads.admanager.v1.ICreativeSet> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    this._log.info('listCreativeSets iterate %j', request);
    return this.descriptors.page.listCreativeSets.asyncIterate(
      this.innerApiCalls['listCreativeSets'] as GaxCall,
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.ads.admanager.v1.ICreativeSet>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.creativeSetServiceStub && !this._terminated) {
      return this.creativeSetServiceStub.then((stub) => {
