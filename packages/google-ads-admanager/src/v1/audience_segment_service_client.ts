 ...
 * `src/v1/audience_segment_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './audience_segment_service_client_config.json';
 ...
 * @memberof v1
 */
export class AudienceSegmentServiceClient {
  ...
  audienceSegmentServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of AudienceSegmentServiceClient.
   *
   ...
   *     const client = new AudienceSegmentServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(
    opts?: ClientOptions,
    ...
    const staticMembers = this
      .constructor as typeof AudienceSegmentServiceClient;
    if (
    ...
    this.descriptors.page = {
      listAudienceSegments: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'audienceSegments',
      ),
  ...
  initialize() {
    ...
    if (this.audienceSegmentServiceStub) {
      return this.audienceSegmentServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.AudienceSegmentService.
    this.audienceSegmentServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ? (this._protos as protobuf.Root).lookupService(
            'google.ads.admanager.v1.AudienceSegmentService',
          )
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.AudienceSegmentService,
      this._opts,
      this._providedCustomServicePath,
   ...
   * @example <caption>include:samples/generated/v1/audience_segment_service.get_audience_segment.js</caption>
   * region_tag:admanager_v1_generated_AudienceSegmentService_GetAudienceSegment_async
   */
  getAudienceSegment(
    request?: protos.google.ads.admanager.v1.IGetAudienceSegmentRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IAudienceSegment,
      protos.google.ads.admanager.v1.IGetAudienceSegmentRequest | undefined,
      {} | undefined,
    ]
  >;
  getAudienceSegment(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IAudienceSegment,
      | protos.google.ads.admanager.v1.IGetAudienceSegmentRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    this._log.info('getAudienceSegment request %j', request);
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('getAudienceSegment response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .getAudienceSegment(request, options, wrappedCallback)
      ?.then(
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/audience_segment_service.create_audience_segment.js</caption>
   * region_tag:admanager_v1_generated_AudienceSegmentService_CreateAudienceSegment_async
   */
  createAudienceSegment(
    request?: protos.google.ads.admanager.v1.ICreateAudienceSegmentRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IAudienceSegment,
      protos.google.ads.admanager.v1.ICreateAudienceSegmentRequest | undefined,
      {} | undefined,
    ]
  >;
  createAudienceSegment(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IAudienceSegment,
      | protos.google.ads.admanager.v1.ICreateAudienceSegmentRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    this._log.info('createAudienceSegment request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.ads.admanager.v1.IAudienceSegment,
          | protos.google.ads.admanager.v1.ICreateAudienceSegmentRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('createAudienceSegment response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .createAudienceSegment(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IAudienceSegment,
          (
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchCreateAudienceSegmentsResponse|BatchCreateAudienceSegmentsResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/audience_segment_service.batch_create_audience_segments.js</caption>
   * region_tag:admanager_v1_generated_AudienceSegmentService_BatchCreateAudienceSegments_async
   */
  batchCreateAudienceSegments(
    request?: protos.google.ads.admanager.v1.IBatchCreateAudienceSegmentsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchCreateAudienceSegmentsResponse,
      (
        | protos.google.ads.admanager.v1.IBatchCreateAudienceSegmentsRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    this._log.info('batchCreateAudienceSegments request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.ads.admanager.v1.IBatchCreateAudienceSegmentsResponse,
          | protos.google.ads.admanager.v1.IBatchCreateAudienceSegmentsRequest
      ...
      : undefined;
    return this.innerApiCalls
      .batchCreateAudienceSegments(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchCreateAudienceSegmentsResponse,
          (
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.AudienceSegment|AudienceSegment}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   *   We recommend using `listAudienceSegmentsAsync()`
   *   method described below for async iteration which you can stop as needed.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   */
  listAudienceSegments(
    request?: protos.google.ads.admanager.v1.IListAudienceSegmentsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IAudienceSegment[],
      protos.google.ads.admanager.v1.IListAudienceSegmentsRequest | null,
      protos.google.ads.admanager.v1.IListAudienceSegmentsResponse,
    ]
  >;
  listAudienceSegments(
    request: protos.google.ads.admanager.v1.IListAudienceSegmentsRequest,
    ...
    callback: PaginationCallback<
      protos.google.ads.admanager.v1.IListAudienceSegmentsRequest,
      | protos.google.ads.admanager.v1.IListAudienceSegmentsResponse
      | null
      | undefined,
      protos.google.ads.admanager.v1.IAudienceSegment
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listAudienceSegments values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listAudienceSegments request %j', request);
    return this.innerApiCalls
      .listAudienceSegments(request, options, wrappedCallback)
      ?.then(
        ([response, input, output]: [
          ...
          this._log.info('listAudienceSegments values %j', response);
  ...
  /**
   * Equivalent to `listAudienceSegments`, but returns a NodeJS Stream object.
   * @param {Object} request
   *   The request object that will be sent.
   * @param {string} request.parent
   *   Required. The parent publisher network associated with these audience
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.AudienceSegment|AudienceSegment} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
  ...
  listAudienceSegmentsStream(
    ...
    const defaultCallSettings = this._defaults['listAudienceSegments'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {
      throw err;
    });
    this._log.info('listAudienceSegments stream %j', request);
    return this.descriptors.page.listAudienceSegments.createStream(
      this.innerApiCalls.listAudienceSegments as GaxCall,
      request,
      callSettings,
    );
  }
  ...
  /**
   * Equivalent to `listAudienceSegments`, but returns an iterable object.
   *
   ...
   *   {@link protos.google.ads.admanager.v1.AudienceSegment|AudienceSegment}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/audience_segment_service.list_audience_segments.js</caption>
   * region_tag:admanager_v1_generated_AudienceSegmentService_ListAudienceSegments_async
   */
  listAudienceSegmentsAsync(
    request?: protos.google.ads.admanager.v1.IListAudienceSegmentsRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.ads.admanager.v1.IAudienceSegment> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    this._log.info('listAudienceSegments iterate %j', request);
    return this.descriptors.page.listAudienceSegments.asyncIterate(
      this.innerApiCalls['listAudienceSegments'] as GaxCall,
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.ads.admanager.v1.IAudienceSegment>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.audienceSegmentServiceStub && !this._terminated) {
      return this.audienceSegmentServiceStub.then(stub => {
