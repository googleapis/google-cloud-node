 ...
 * `src/v1/suggested_ad_unit_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './suggested_ad_unit_service_client_config.json';
 ...
 * @memberof v1
 */
export class SuggestedAdUnitServiceClient {
  ...
  suggestedAdUnitServiceStub?: Promise<{ [name: string]: Function }>;

  /**
   * Construct an instance of SuggestedAdUnitServiceClient.
   *
   ...
   *     const client = new SuggestedAdUnitServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(
    opts?: ClientOptions,
    ...
    const staticMembers = this
      .constructor as typeof SuggestedAdUnitServiceClient;
    if (
    ...
    this.descriptors.page = {
      listSuggestedAdUnits: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'suggestedAdUnits',
      ),
  ...
  initialize() {
    ...
    if (this.suggestedAdUnitServiceStub) {
      return this.suggestedAdUnitServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.SuggestedAdUnitService.
    this.suggestedAdUnitServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ? (this._protos as protobuf.Root).lookupService(
            'google.ads.admanager.v1.SuggestedAdUnitService',
          )
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.SuggestedAdUnitService,
      this._opts,
      this._providedCustomServicePath,
    ...
    const suggestedAdUnitServiceStubMethods = [
      'getSuggestedAdUnit',
      'listSuggestedAdUnits',
      'batchApproveSuggestedAdUnits',
    ];
    for (const methodName of suggestedAdUnitServiceStubMethods) {
      const callPromise = this.suggestedAdUnitServiceStub.then(
        (stub) =>
          (...args: Array<{}>) => {
            if (this._terminated) {
   ...
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.SuggestedAdUnit|SuggestedAdUnit}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/suggested_ad_unit_service.get_suggested_ad_unit.js</caption>
   * region_tag:admanager_v1_generated_SuggestedAdUnitService_GetSuggestedAdUnit_async
   */
  getSuggestedAdUnit(
    request?: protos.google.ads.admanager.v1.IGetSuggestedAdUnitRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.ISuggestedAdUnit,
      protos.google.ads.admanager.v1.IGetSuggestedAdUnitRequest | undefined,
      {} | undefined,
    ]
  >;
  getSuggestedAdUnit(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.ISuggestedAdUnit,
      | protos.google.ads.admanager.v1.IGetSuggestedAdUnitRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    this._log.info('getSuggestedAdUnit request %j', request);
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('getSuggestedAdUnit response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .getSuggestedAdUnit(request, options, wrappedCallback)
      ?.then(
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchApproveSuggestedAdUnitsResponse|BatchApproveSuggestedAdUnitsResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/suggested_ad_unit_service.batch_approve_suggested_ad_units.js</caption>
   * region_tag:admanager_v1_generated_SuggestedAdUnitService_BatchApproveSuggestedAdUnits_async
   */
  batchApproveSuggestedAdUnits(
    request?: protos.google.ads.admanager.v1.IBatchApproveSuggestedAdUnitsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchApproveSuggestedAdUnitsResponse,
      (
        | protos.google.ads.admanager.v1.IBatchApproveSuggestedAdUnitsRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    this._log.info('batchApproveSuggestedAdUnits request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.ads.admanager.v1.IBatchApproveSuggestedAdUnitsResponse,
          | protos.google.ads.admanager.v1.IBatchApproveSuggestedAdUnitsRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchApproveSuggestedAdUnits response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchApproveSuggestedAdUnits(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchApproveSuggestedAdUnitsResponse,
          (
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.SuggestedAdUnit|SuggestedAdUnit}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   *   We recommend using `listSuggestedAdUnitsAsync()`
   *   method described below for async iteration which you can stop as needed.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   */
  listSuggestedAdUnits(
    request?: protos.google.ads.admanager.v1.IListSuggestedAdUnitsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.ISuggestedAdUnit[],
      protos.google.ads.admanager.v1.IListSuggestedAdUnitsRequest | null,
      protos.google.ads.admanager.v1.IListSuggestedAdUnitsResponse,
    ]
  >;
  listSuggestedAdUnits(
    request: protos.google.ads.admanager.v1.IListSuggestedAdUnitsRequest,
    ...
    callback: PaginationCallback<
      protos.google.ads.admanager.v1.IListSuggestedAdUnitsRequest,
      | protos.google.ads.admanager.v1.IListSuggestedAdUnitsResponse
      | null
      | undefined,
      protos.google.ads.admanager.v1.ISuggestedAdUnit
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listSuggestedAdUnits values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listSuggestedAdUnits request %j', request);
    return this.innerApiCalls
      .listSuggestedAdUnits(request, options, wrappedCallback)
      ?.then(
        ([response, input, output]: [
          ...
          this._log.info('listSuggestedAdUnits values %j', response);
  ...
  /**
   * Equivalent to `listSuggestedAdUnits`, but returns a NodeJS Stream object.
   * @param {Object} request
   *   The request object that will be sent.
   * @param {string} request.parent
   *   Required. The parent, which owns this collection of SuggestedAdUnits.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.SuggestedAdUnit|SuggestedAdUnit} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
  ...
  listSuggestedAdUnitsStream(
    ...
    const defaultCallSettings = this._defaults['listSuggestedAdUnits'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch((err) => {
      throw err;
    });
    this._log.info('listSuggestedAdUnits stream %j', request);
    return this.descriptors.page.listSuggestedAdUnits.createStream(
      this.innerApiCalls.listSuggestedAdUnits as GaxCall,
      request,
      callSettings,
    );
  }
  ...
  /**
   * Equivalent to `listSuggestedAdUnits`, but returns an iterable object.
   *
   ...
   *   {@link protos.google.ads.admanager.v1.SuggestedAdUnit|SuggestedAdUnit}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/suggested_ad_unit_service.list_suggested_ad_units.js</caption>
   * region_tag:admanager_v1_generated_SuggestedAdUnitService_ListSuggestedAdUnits_async
   */
  listSuggestedAdUnitsAsync(
    request?: protos.google.ads.admanager.v1.IListSuggestedAdUnitsRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.ads.admanager.v1.ISuggestedAdUnit> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    this._log.info('listSuggestedAdUnits iterate %j', request);
    return this.descriptors.page.listSuggestedAdUnits.asyncIterate(
      this.innerApiCalls['listSuggestedAdUnits'] as GaxCall,
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.ads.admanager.v1.ISuggestedAdUnit>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.suggestedAdUnitServiceStub && !this._terminated) {
      return this.suggestedAdUnitServiceStub.then((stub) => {
