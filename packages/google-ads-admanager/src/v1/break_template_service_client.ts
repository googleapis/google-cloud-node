 ...
 * `src/v1/break_template_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './break_template_service_client_config.json';
 ...
 * @memberof v1
 */
export class BreakTemplateServiceClient {
  ...
  breakTemplateServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of BreakTemplateServiceClient.
   *
   ...
   *     const client = new BreakTemplateServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(
    opts?: ClientOptions,
    ...
    const staticMembers = this.constructor as typeof BreakTemplateServiceClient;
    if (
    ...
    this.descriptors.page = {
      listBreakTemplates: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'breakTemplates',
      ),
  ...
  initialize() {
    ...
    if (this.breakTemplateServiceStub) {
      return this.breakTemplateServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.BreakTemplateService.
    this.breakTemplateServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ? (this._protos as protobuf.Root).lookupService(
            'google.ads.admanager.v1.BreakTemplateService',
          )
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.BreakTemplateService,
      this._opts,
      this._providedCustomServicePath,
    ...
    const breakTemplateServiceStubMethods = [
      'getBreakTemplate',
      'listBreakTemplates',
      'createBreakTemplate',
    ...
    for (const methodName of breakTemplateServiceStubMethods) {
      const callPromise = this.breakTemplateServiceStub.then(
        stub =>
          (...args: Array<{}>) => {
            if (this._terminated) {
   ...
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BreakTemplate|BreakTemplate}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/break_template_service.get_break_template.js</caption>
   * region_tag:admanager_v1_generated_BreakTemplateService_GetBreakTemplate_async
   */
  getBreakTemplate(
    request?: protos.google.ads.admanager.v1.IGetBreakTemplateRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBreakTemplate,
      protos.google.ads.admanager.v1.IGetBreakTemplateRequest | undefined,
      {} | undefined,
    ]
  >;
  getBreakTemplate(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IBreakTemplate,
      | protos.google.ads.admanager.v1.IGetBreakTemplateRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    this._log.info('getBreakTemplate request %j', request);
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('getBreakTemplate response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .getBreakTemplate(request, options, wrappedCallback)
      ?.then(
   ...
   * @param {google.ads.admanager.v1.BreakTemplate} request.breakTemplate
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/break_template_service.create_break_template.js</caption>
   * region_tag:admanager_v1_generated_BreakTemplateService_CreateBreakTemplate_async
   */
  createBreakTemplate(
    request?: protos.google.ads.admanager.v1.ICreateBreakTemplateRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBreakTemplate,
      protos.google.ads.admanager.v1.ICreateBreakTemplateRequest | undefined,
      {} | undefined,
    ]
  >;
  createBreakTemplate(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IBreakTemplate,
      | protos.google.ads.admanager.v1.ICreateBreakTemplateRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    this._log.info('createBreakTemplate request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.ads.admanager.v1.IBreakTemplate,
          | protos.google.ads.admanager.v1.ICreateBreakTemplateRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('createBreakTemplate response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .createBreakTemplate(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBreakTemplate,
          (
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchCreateBreakTemplatesResponse|BatchCreateBreakTemplatesResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/break_template_service.batch_create_break_templates.js</caption>
   * region_tag:admanager_v1_generated_BreakTemplateService_BatchCreateBreakTemplates_async
   */
  batchCreateBreakTemplates(
    request?: protos.google.ads.admanager.v1.IBatchCreateBreakTemplatesRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchCreateBreakTemplatesResponse,
      (
        | protos.google.ads.admanager.v1.IBatchCreateBreakTemplatesRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    this._log.info('batchCreateBreakTemplates request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.ads.admanager.v1.IBatchCreateBreakTemplatesResponse,
          | protos.google.ads.admanager.v1.IBatchCreateBreakTemplatesRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchCreateBreakTemplates response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchCreateBreakTemplates(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchCreateBreakTemplatesResponse,
          (
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/break_template_service.update_break_template.js</caption>
   * region_tag:admanager_v1_generated_BreakTemplateService_UpdateBreakTemplate_async
   */
  updateBreakTemplate(
    request?: protos.google.ads.admanager.v1.IUpdateBreakTemplateRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBreakTemplate,
      protos.google.ads.admanager.v1.IUpdateBreakTemplateRequest | undefined,
      {} | undefined,
    ]
  >;
  updateBreakTemplate(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IBreakTemplate,
      | protos.google.ads.admanager.v1.IUpdateBreakTemplateRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    options.otherArgs.headers['x-goog-request-params'] =
      this._gaxModule.routingHeader.fromParams({
        'break_template.name': request.breakTemplate!.name ?? '',
      });
    this.initialize().catch(err => {
      throw err;
    });
    this._log.info('updateBreakTemplate request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.ads.admanager.v1.IBreakTemplate,
          | protos.google.ads.admanager.v1.IUpdateBreakTemplateRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('updateBreakTemplate response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .updateBreakTemplate(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBreakTemplate,
          (
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchUpdateBreakTemplatesResponse|BatchUpdateBreakTemplatesResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/break_template_service.batch_update_break_templates.js</caption>
   * region_tag:admanager_v1_generated_BreakTemplateService_BatchUpdateBreakTemplates_async
   */
  batchUpdateBreakTemplates(
    request?: protos.google.ads.admanager.v1.IBatchUpdateBreakTemplatesRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchUpdateBreakTemplatesResponse,
      (
        | protos.google.ads.admanager.v1.IBatchUpdateBreakTemplatesRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    this._log.info('batchUpdateBreakTemplates request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.ads.admanager.v1.IBatchUpdateBreakTemplatesResponse,
          | protos.google.ads.admanager.v1.IBatchUpdateBreakTemplatesRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchUpdateBreakTemplates response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchUpdateBreakTemplates(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchUpdateBreakTemplatesResponse,
          (
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.BreakTemplate|BreakTemplate}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   *   We recommend using `listBreakTemplatesAsync()`
   *   method described below for async iteration which you can stop as needed.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   */
  listBreakTemplates(
    request?: protos.google.ads.admanager.v1.IListBreakTemplatesRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBreakTemplate[],
      protos.google.ads.admanager.v1.IListBreakTemplatesRequest | null,
      protos.google.ads.admanager.v1.IListBreakTemplatesResponse,
    ]
  >;
  listBreakTemplates(
    request: protos.google.ads.admanager.v1.IListBreakTemplatesRequest,
    ...
    callback: PaginationCallback<
      protos.google.ads.admanager.v1.IListBreakTemplatesRequest,
      | protos.google.ads.admanager.v1.IListBreakTemplatesResponse
      | null
      | undefined,
      protos.google.ads.admanager.v1.IBreakTemplate
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listBreakTemplates values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listBreakTemplates request %j', request);
    return this.innerApiCalls
      .listBreakTemplates(request, options, wrappedCallback)
      ?.then(
        ([response, input, output]: [
          ...
          this._log.info('listBreakTemplates values %j', response);
  ...
  /**
   * Equivalent to `listBreakTemplates`, but returns a NodeJS Stream object.
   * @param {Object} request
   *   The request object that will be sent.
   * @param {string} request.parent
   *   Required. The parent, which owns this collection of `BreakTemplates`.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.BreakTemplate|BreakTemplate} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
  ...
  listBreakTemplatesStream(
    ...
    const defaultCallSettings = this._defaults['listBreakTemplates'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {
      throw err;
    });
    this._log.info('listBreakTemplates stream %j', request);
    return this.descriptors.page.listBreakTemplates.createStream(
      this.innerApiCalls.listBreakTemplates as GaxCall,
      request,
      callSettings,
    );
  }
  ...
  /**
   * Equivalent to `listBreakTemplates`, but returns an iterable object.
   *
   ...
   *   {@link protos.google.ads.admanager.v1.BreakTemplate|BreakTemplate}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/break_template_service.list_break_templates.js</caption>
   * region_tag:admanager_v1_generated_BreakTemplateService_ListBreakTemplates_async
   */
  listBreakTemplatesAsync(
    request?: protos.google.ads.admanager.v1.IListBreakTemplatesRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.ads.admanager.v1.IBreakTemplate> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    this._log.info('listBreakTemplates iterate %j', request);
    return this.descriptors.page.listBreakTemplates.asyncIterate(
      this.innerApiCalls['listBreakTemplates'] as GaxCall,
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.ads.admanager.v1.IBreakTemplate>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.breakTemplateServiceStub && !this._terminated) {
      return this.breakTemplateServiceStub.then(stub => {
