 ...
 * `src/v1/viewability_provider_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './viewability_provider_service_client_config.json';
const version = require('../../../package.json').version;

/**
 *  Provides methods for handling
 *  {@link protos.google.ads.admanager.v1.ViewabilityProvider|ViewabilityProvider} objects.
 * @class
 * @memberof v1
 */
export class ViewabilityProviderServiceClient {
  ...
  viewabilityProviderServiceStub?: Promise<{ [name: string]: Function }>;

  /**
   * Construct an instance of ViewabilityProviderServiceClient.
   *
   ...
   *     const client = new ViewabilityProviderServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(
    opts?: ClientOptions,
    ...
    const staticMembers = this
      .constructor as typeof ViewabilityProviderServiceClient;
    if (
    ...
    this.descriptors.page = {
      listViewabilityProviders: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
  ...
  initialize() {
    ...
    if (this.viewabilityProviderServiceStub) {
      return this.viewabilityProviderServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.ViewabilityProviderService.
    this.viewabilityProviderServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
    ...
    const viewabilityProviderServiceStubMethods = [
    ...
    for (const methodName of viewabilityProviderServiceStubMethods) {
      const callPromise = this.viewabilityProviderServiceStub.then(
        (stub) =>
          (...args: Array<{}>) => {
            if (this._terminated) {
  ...
  /**
   * Retrieves a
   * {@link protos.google.ads.admanager.v1.ViewabilityProvider|ViewabilityProvider} object.
   *
   * @param {Object} request
   *   The request object that will be sent.
   * @param {string} request.name
   *   Required. The resource name of the
   *   {@link protos.google.ads.admanager.v1.ViewabilityProvider|ViewabilityProvider}. Format:
   *   `networks/{network_code}/viewabilityProviders/{viewability_provider}`
   * @param {object} [options]
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.ViewabilityProvider|ViewabilityProvider}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/viewability_provider_service.get_viewability_provider.js</caption>
   * region_tag:admanager_v1_generated_ViewabilityProviderService_GetViewabilityProvider_async
   */
  getViewabilityProvider(
    request?: protos.google.ads.admanager.v1.IGetViewabilityProviderRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IViewabilityProvider,
      protos.google.ads.admanager.v1.IGetViewabilityProviderRequest | undefined,
      {} | undefined,
    ]
  >;
  getViewabilityProvider(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IViewabilityProvider,
      | protos.google.ads.admanager.v1.IGetViewabilityProviderRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    this._log.info('getViewabilityProvider request %j', request);
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('getViewabilityProvider response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .getViewabilityProvider(request, options, wrappedCallback)
      ?.then(
   ...
   *   {@link protos.google.ads.admanager.v1.ViewabilityProvider|ViewabilityProvider} will be
   *   created. Format: `networks/{network_code}`
   * @param {google.ads.admanager.v1.ViewabilityProvider} request.viewabilityProvider
   *   Required. The
   *   {@link protos.google.ads.admanager.v1.ViewabilityProvider|ViewabilityProvider} to
   *   create.
   * @param {object} [options]
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/viewability_provider_service.create_viewability_provider.js</caption>
   * region_tag:admanager_v1_generated_ViewabilityProviderService_CreateViewabilityProvider_async
   */
  createViewabilityProvider(
    request?: protos.google.ads.admanager.v1.ICreateViewabilityProviderRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IViewabilityProvider,
      (
        | protos.google.ads.admanager.v1.ICreateViewabilityProviderRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    this._log.info('createViewabilityProvider request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.ads.admanager.v1.IViewabilityProvider,
          | protos.google.ads.admanager.v1.ICreateViewabilityProviderRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('createViewabilityProvider response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .createViewabilityProvider(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IViewabilityProvider,
          (
  ...
  /**
   * Creates {@link protos.google.ads.admanager.v1.ViewabilityProvider|ViewabilityProvider}
   * objects.
   *
   * @param {Object} request
   *   The request object that will be sent.
   ...
   *   {@link protos.google.ads.admanager.v1.ViewabilityProvider|ViewabilityProvider}s will be
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchCreateViewabilityProvidersResponse|BatchCreateViewabilityProvidersResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/viewability_provider_service.batch_create_viewability_providers.js</caption>
   * region_tag:admanager_v1_generated_ViewabilityProviderService_BatchCreateViewabilityProviders_async
   */
  batchCreateViewabilityProviders(
    request?: protos.google.ads.admanager.v1.IBatchCreateViewabilityProvidersRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchCreateViewabilityProvidersResponse,
      (
        | protos.google.ads.admanager.v1.IBatchCreateViewabilityProvidersRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    this._log.info('batchCreateViewabilityProviders request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.ads.admanager.v1.IBatchCreateViewabilityProvidersResponse,
          | protos.google.ads.admanager.v1.IBatchCreateViewabilityProvidersRequest
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'batchCreateViewabilityProviders response %j',
            response,
          );
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchCreateViewabilityProviders(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchCreateViewabilityProvidersResponse,
          (
   ...
   *   update.
   *
   *   The {@link protos.google.ads.admanager.v1.ViewabilityProvider|ViewabilityProvider}'s
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/viewability_provider_service.update_viewability_provider.js</caption>
   * region_tag:admanager_v1_generated_ViewabilityProviderService_UpdateViewabilityProvider_async
   */
  updateViewabilityProvider(
    request?: protos.google.ads.admanager.v1.IUpdateViewabilityProviderRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IViewabilityProvider,
      (
        | protos.google.ads.admanager.v1.IUpdateViewabilityProviderRequest
        | undefined
      ),
      {} | undefined,
    ]
    ...
    options.otherArgs.headers['x-goog-request-params'] =
      this._gaxModule.routingHeader.fromParams({
        'viewability_provider.name':
          request.viewabilityProvider!.name?.toString() ?? '',
      });
    this.initialize().catch((err) => {
      throw err;
    });
    this._log.info('updateViewabilityProvider request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.ads.admanager.v1.IViewabilityProvider,
          | protos.google.ads.admanager.v1.IUpdateViewabilityProviderRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('updateViewabilityProvider response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .updateViewabilityProvider(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IViewabilityProvider,
          (
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchUpdateViewabilityProvidersResponse|BatchUpdateViewabilityProvidersResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/viewability_provider_service.batch_update_viewability_providers.js</caption>
   * region_tag:admanager_v1_generated_ViewabilityProviderService_BatchUpdateViewabilityProviders_async
   */
  batchUpdateViewabilityProviders(
    request?: protos.google.ads.admanager.v1.IBatchUpdateViewabilityProvidersRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchUpdateViewabilityProvidersResponse,
      (
        | protos.google.ads.admanager.v1.IBatchUpdateViewabilityProvidersRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    this._log.info('batchUpdateViewabilityProviders request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.ads.admanager.v1.IBatchUpdateViewabilityProvidersResponse,
          | protos.google.ads.admanager.v1.IBatchUpdateViewabilityProvidersRequest
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'batchUpdateViewabilityProviders response %j',
            response,
          );
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchUpdateViewabilityProviders(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchUpdateViewabilityProvidersResponse,
          (
  ...
  /**
   * Lists {@link protos.google.ads.admanager.v1.ViewabilityProvider|ViewabilityProvider}
   * objects.
   *
   * @param {Object} request
   *   The request object that will be sent.
   ...
   *   {@link protos.google.ads.admanager.v1.ViewabilityProvider|ViewabilityProvider}s.
   *   Format: `networks/{network_code}`
   * @param {number} [request.pageSize]
   *   Optional. The maximum number of
   *   {@link protos.google.ads.admanager.v1.ViewabilityProvider|ViewabilityProvider}s to
   *   return. The service may return fewer than this value. If unspecified, at
   *   most 50 {@link protos.google.ads.admanager.v1.ViewabilityProvider|ViewabilityProvider}s
   *   will be returned. The maximum value is 1000; values above 1000 will be
   *   coerced to 1000.
   * @param {string} [request.pageToken]
   *   Optional. A page token, received from a previous
   *   {@link protos.|ListViewabilityProviders} call. Provide this to retrieve the subsequent
   *   page.
   *
   *   When paginating, all other parameters provided to
   *   {@link protos.|ListViewabilityProviders} must match the call that provided the page
   *   token.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.ViewabilityProvider|ViewabilityProvider}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   *   We recommend using `listViewabilityProvidersAsync()`
   *   method described below for async iteration which you can stop as needed.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   */
  listViewabilityProviders(
    request?: protos.google.ads.admanager.v1.IListViewabilityProvidersRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IViewabilityProvider[],
      protos.google.ads.admanager.v1.IListViewabilityProvidersRequest | null,
      protos.google.ads.admanager.v1.IListViewabilityProvidersResponse,
    ]
  >;
  listViewabilityProviders(
    request: protos.google.ads.admanager.v1.IListViewabilityProvidersRequest,
    ...
    callback: PaginationCallback<
      protos.google.ads.admanager.v1.IListViewabilityProvidersRequest,
      | protos.google.ads.admanager.v1.IListViewabilityProvidersResponse
      | null
      | undefined,
      protos.google.ads.admanager.v1.IViewabilityProvider
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listViewabilityProviders values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listViewabilityProviders request %j', request);
    return this.innerApiCalls
      .listViewabilityProviders(request, options, wrappedCallback)
      ?.then(
        ([response, input, output]: [
          ...
          this._log.info('listViewabilityProviders values %j', response);
  ...
  /**
   * Equivalent to `listViewabilityProviders`, but returns a NodeJS Stream object.
   * @param {Object} request
   *   The request object that will be sent.
   * @param {string} request.parent
   *   Required. The parent, which owns this collection of
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.ViewabilityProvider|ViewabilityProvider} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
   ...
   *   for more details and examples.
   */
  listViewabilityProvidersStream(
    request?: protos.google.ads.admanager.v1.IListViewabilityProvidersRequest,
    options?: CallOptions,
  ): Transform {
    request = request || {};
    ...
    const defaultCallSettings = this._defaults['listViewabilityProviders'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch((err) => {
      throw err;
    });
    this._log.info('listViewabilityProviders stream %j', request);
    return this.descriptors.page.listViewabilityProviders.createStream(
      this.innerApiCalls.listViewabilityProviders as GaxCall,
      request,
      callSettings,
    );
  }
  ...
  /**
   * Equivalent to `listViewabilityProviders`, but returns an iterable object.
   *
   ...
   *   {@link protos.google.ads.admanager.v1.ViewabilityProvider|ViewabilityProvider}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/viewability_provider_service.list_viewability_providers.js</caption>
   * region_tag:admanager_v1_generated_ViewabilityProviderService_ListViewabilityProviders_async
   */
  listViewabilityProvidersAsync(
    request?: protos.google.ads.admanager.v1.IListViewabilityProvidersRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.ads.admanager.v1.IViewabilityProvider> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    this._log.info('listViewabilityProviders iterate %j', request);
    return this.descriptors.page.listViewabilityProviders.asyncIterate(
      this.innerApiCalls['listViewabilityProviders'] as GaxCall,
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.ads.admanager.v1.IViewabilityProvider>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.viewabilityProviderServiceStub && !this._terminated) {
      return this.viewabilityProviderServiceStub.then((stub) => {
