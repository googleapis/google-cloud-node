...
export class BandwidthGroupServiceClient {
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof BandwidthGroupServiceClient;
    if (
    ...
    this.descriptors.page = {
      listBandwidthGroups: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'bandwidthGroups',
      ),
  ...
  getBandwidthGroup(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IBandwidthGroup,
      | protos.google.ads.admanager.v1.IGetBandwidthGroupRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .getBandwidthGroup(request, options, wrappedCallback)
      ?.then(
