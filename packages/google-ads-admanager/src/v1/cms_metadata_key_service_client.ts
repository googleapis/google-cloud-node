 ...
 * `src/v1/cms_metadata_key_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './cms_metadata_key_service_client_config.json';
 ...
 * @memberof v1
 */
export class CmsMetadataKeyServiceClient {
  ...
  cmsMetadataKeyServiceStub?: Promise<{ [name: string]: Function }>;

  /**
   * Construct an instance of CmsMetadataKeyServiceClient.
   *
   ...
   *     const client = new CmsMetadataKeyServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(
    opts?: ClientOptions,
    ...
    const staticMembers = this
      .constructor as typeof CmsMetadataKeyServiceClient;
    if (
    ...
    this.descriptors.page = {
      listCmsMetadataKeys: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'cmsMetadataKeys',
      ),
  ...
  initialize() {
    ...
    if (this.cmsMetadataKeyServiceStub) {
      return this.cmsMetadataKeyServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.CmsMetadataKeyService.
    this.cmsMetadataKeyServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ? (this._protos as protobuf.Root).lookupService(
            'google.ads.admanager.v1.CmsMetadataKeyService',
          )
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.CmsMetadataKeyService,
      this._opts,
      this._providedCustomServicePath,
    ...
    for (const methodName of cmsMetadataKeyServiceStubMethods) {
      const callPromise = this.cmsMetadataKeyServiceStub.then(
        (stub) =>
          (...args: Array<{}>) => {
            if (this._terminated) {
   ...
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.CmsMetadataKey|CmsMetadataKey}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/cms_metadata_key_service.get_cms_metadata_key.js</caption>
   * region_tag:admanager_v1_generated_CmsMetadataKeyService_GetCmsMetadataKey_async
   */
  getCmsMetadataKey(
    request?: protos.google.ads.admanager.v1.IGetCmsMetadataKeyRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.ICmsMetadataKey,
      protos.google.ads.admanager.v1.IGetCmsMetadataKeyRequest | undefined,
      {} | undefined,
    ]
  >;
  getCmsMetadataKey(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.ICmsMetadataKey,
      | protos.google.ads.admanager.v1.IGetCmsMetadataKeyRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    this._log.info('getCmsMetadataKey request %j', request);
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('getCmsMetadataKey response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .getCmsMetadataKey(request, options, wrappedCallback)
      ?.then(
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchActivateCmsMetadataKeysResponse|BatchActivateCmsMetadataKeysResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/cms_metadata_key_service.batch_activate_cms_metadata_keys.js</caption>
   * region_tag:admanager_v1_generated_CmsMetadataKeyService_BatchActivateCmsMetadataKeys_async
   */
  batchActivateCmsMetadataKeys(
    request?: protos.google.ads.admanager.v1.IBatchActivateCmsMetadataKeysRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchActivateCmsMetadataKeysResponse,
      (
        | protos.google.ads.admanager.v1.IBatchActivateCmsMetadataKeysRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    this._log.info('batchActivateCmsMetadataKeys request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.ads.admanager.v1.IBatchActivateCmsMetadataKeysResponse,
          | protos.google.ads.admanager.v1.IBatchActivateCmsMetadataKeysRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchActivateCmsMetadataKeys response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchActivateCmsMetadataKeys(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchActivateCmsMetadataKeysResponse,
          (
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchDeactivateCmsMetadataKeysResponse|BatchDeactivateCmsMetadataKeysResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/cms_metadata_key_service.batch_deactivate_cms_metadata_keys.js</caption>
   * region_tag:admanager_v1_generated_CmsMetadataKeyService_BatchDeactivateCmsMetadataKeys_async
   */
  batchDeactivateCmsMetadataKeys(
    request?: protos.google.ads.admanager.v1.IBatchDeactivateCmsMetadataKeysRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchDeactivateCmsMetadataKeysResponse,
      (
        | protos.google.ads.admanager.v1.IBatchDeactivateCmsMetadataKeysRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    this._log.info('batchDeactivateCmsMetadataKeys request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.ads.admanager.v1.IBatchDeactivateCmsMetadataKeysResponse,
          | protos.google.ads.admanager.v1.IBatchDeactivateCmsMetadataKeysRequest
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'batchDeactivateCmsMetadataKeys response %j',
            response,
          );
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchDeactivateCmsMetadataKeys(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchDeactivateCmsMetadataKeysResponse,
          (
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.CmsMetadataKey|CmsMetadataKey}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   *   We recommend using `listCmsMetadataKeysAsync()`
   *   method described below for async iteration which you can stop as needed.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   */
  listCmsMetadataKeys(
    request?: protos.google.ads.admanager.v1.IListCmsMetadataKeysRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.ICmsMetadataKey[],
      protos.google.ads.admanager.v1.IListCmsMetadataKeysRequest | null,
      protos.google.ads.admanager.v1.IListCmsMetadataKeysResponse,
    ]
  >;
  listCmsMetadataKeys(
    request: protos.google.ads.admanager.v1.IListCmsMetadataKeysRequest,
    ...
    callback: PaginationCallback<
      protos.google.ads.admanager.v1.IListCmsMetadataKeysRequest,
      | protos.google.ads.admanager.v1.IListCmsMetadataKeysResponse
      | null
      | undefined,
      protos.google.ads.admanager.v1.ICmsMetadataKey
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listCmsMetadataKeys values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listCmsMetadataKeys request %j', request);
    return this.innerApiCalls
      .listCmsMetadataKeys(request, options, wrappedCallback)
      ?.then(
        ([response, input, output]: [
          ...
          this._log.info('listCmsMetadataKeys values %j', response);
  ...
  /**
   * Equivalent to `listCmsMetadataKeys`, but returns a NodeJS Stream object.
   * @param {Object} request
   *   The request object that will be sent.
   * @param {string} request.parent
   *   Required. The parent, which owns this collection of CmsMetadataKeys.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.CmsMetadataKey|CmsMetadataKey} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
  ...
  listCmsMetadataKeysStream(
    ...
    const defaultCallSettings = this._defaults['listCmsMetadataKeys'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch((err) => {
      throw err;
    });
    this._log.info('listCmsMetadataKeys stream %j', request);
    return this.descriptors.page.listCmsMetadataKeys.createStream(
      this.innerApiCalls.listCmsMetadataKeys as GaxCall,
      request,
      callSettings,
    );
  }
  ...
  /**
   * Equivalent to `listCmsMetadataKeys`, but returns an iterable object.
   *
   ...
   *   {@link protos.google.ads.admanager.v1.CmsMetadataKey|CmsMetadataKey}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/cms_metadata_key_service.list_cms_metadata_keys.js</caption>
   * region_tag:admanager_v1_generated_CmsMetadataKeyService_ListCmsMetadataKeys_async
   */
  listCmsMetadataKeysAsync(
    request?: protos.google.ads.admanager.v1.IListCmsMetadataKeysRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.ads.admanager.v1.ICmsMetadataKey> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    this._log.info('listCmsMetadataKeys iterate %j', request);
    return this.descriptors.page.listCmsMetadataKeys.asyncIterate(
      this.innerApiCalls['listCmsMetadataKeys'] as GaxCall,
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.ads.admanager.v1.ICmsMetadataKey>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.cmsMetadataKeyServiceStub && !this._terminated) {
      return this.cmsMetadataKeyServiceStub.then((stub) => {
