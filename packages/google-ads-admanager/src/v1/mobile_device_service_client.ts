 ...
 * `src/v1/mobile_device_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './mobile_device_service_client_config.json';
 ...
 * @memberof v1
 */
export class MobileDeviceServiceClient {
  ...
  mobileDeviceServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of MobileDeviceServiceClient.
   *
   ...
   *     const client = new MobileDeviceServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof MobileDeviceServiceClient;
    ...
    this.descriptors.page = {
      listMobileDevices:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'mobileDevices')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.admanager.v1.MobileDeviceService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.mobileDeviceServiceStub) {
      return this.mobileDeviceServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.MobileDeviceService.
    this.mobileDeviceServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.admanager.v1.MobileDeviceService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.MobileDeviceService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const mobileDeviceServiceStubMethods =
        ['getMobileDevice', 'listMobileDevices'];
    for (const methodName of mobileDeviceServiceStubMethods) {
      const callPromise = this.mobileDeviceServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.MobileDevice|MobileDevice}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/mobile_device_service.get_mobile_device.js</caption>
 * region_tag:admanager_v1_generated_MobileDeviceService_GetMobileDevice_async
 */
  getMobileDevice(
      request?: protos.google.ads.admanager.v1.IGetMobileDeviceRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IMobileDevice,
        protos.google.ads.admanager.v1.IGetMobileDeviceRequest|undefined, {}|undefined
      ]>;
  getMobileDevice(
      request: protos.google.ads.admanager.v1.IGetMobileDeviceRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IMobileDevice,
          protos.google.ads.admanager.v1.IGetMobileDeviceRequest|null|undefined,
          {}|null|undefined>): void;
  getMobileDevice(
      request: protos.google.ads.admanager.v1.IGetMobileDeviceRequest,
      callback: Callback<
  ...
  getMobileDevice(
    ...
    this._log.info('getMobileDevice request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IMobileDevice,
        protos.google.ads.admanager.v1.IGetMobileDeviceRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('getMobileDevice response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.getMobileDevice(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IMobileDevice,
        protos.google.ads.admanager.v1.IGetMobileDeviceRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getMobileDevice response %j', response);
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.MobileDevice|MobileDevice}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listMobileDevicesAsync()`
 *   method described below for async iteration which you can stop as needed.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 */
  listMobileDevices(
      request?: protos.google.ads.admanager.v1.IListMobileDevicesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IMobileDevice[],
        protos.google.ads.admanager.v1.IListMobileDevicesRequest|null,
  ...
  listMobileDevices(
      ...
      callback: PaginationCallback<
          ...
          protos.google.ads.admanager.v1.IListMobileDevicesResponse|null|undefined,
          protos.google.ads.admanager.v1.IMobileDevice>): void;
  listMobileDevices(
      request: protos.google.ads.admanager.v1.IListMobileDevicesRequest,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListMobileDevicesRequest,
  ...
  listMobileDevices(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.ads.admanager.v1.IListMobileDevicesRequest,
      protos.google.ads.admanager.v1.IListMobileDevicesResponse|null|undefined,
      protos.google.ads.admanager.v1.IMobileDevice>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listMobileDevices values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listMobileDevices request %j', request);
    return this.innerApiCalls
      .listMobileDevices(request, options, wrappedCallback)
      ?.then(([response, input, output]: [
        protos.google.ads.admanager.v1.IMobileDevice[],
        protos.google.ads.admanager.v1.IListMobileDevicesRequest|null,
        protos.google.ads.admanager.v1.IListMobileDevicesResponse
      ]) => {
        this._log.info('listMobileDevices values %j', response);
        return [response, input, output];
      });
  }

/**
 * Equivalent to `listMobileDevices`, but returns a NodeJS Stream object.
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 *   Required. The parent, which owns this collection of MobileDevices.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.MobileDevice|MobileDevice} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 */
  listMobileDevicesStream(
    ...
    const defaultCallSettings = this._defaults['listMobileDevices'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listMobileDevices stream %j', request);
    return this.descriptors.page.listMobileDevices.createStream(
      this.innerApiCalls.listMobileDevices as GaxCall,
      request,
      callSettings
    );
  }
...
/**
 * Equivalent to `listMobileDevices`, but returns an iterable object.
 *
 ...
 *   {@link protos.google.ads.admanager.v1.MobileDevice|MobileDevice}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/mobile_device_service.list_mobile_devices.js</caption>
 * region_tag:admanager_v1_generated_MobileDeviceService_ListMobileDevices_async
 */
  listMobileDevicesAsync(
      request?: protos.google.ads.admanager.v1.IListMobileDevicesRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.admanager.v1.IMobileDevice>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listMobileDevices iterate %j', request);
    return this.descriptors.page.listMobileDevices.asyncIterate(
      this.innerApiCalls['listMobileDevices'] as GaxCall,
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.ads.admanager.v1.IMobileDevice>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.mobileDeviceServiceStub && !this._terminated) {
      return this.mobileDeviceServiceStub.then(stub => {
