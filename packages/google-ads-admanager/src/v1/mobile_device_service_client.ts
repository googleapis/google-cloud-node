...
export class MobileDeviceServiceClient {
  ...
  constructor(
    ...
    this.descriptors.page = {
      listMobileDevices: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'mobileDevices',
      ),
  ...
  getMobileDevice(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.ads.admanager.v1.IMobileDevice,
          | protos.google.ads.admanager.v1.IGetMobileDeviceRequest
          | null
          | undefined,
          {} | null | undefined
        >,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .getMobileDevice(request, options, wrappedCallback)
      ?.then(
