 ...
 * `src/v1/mobile_device_submodel_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './mobile_device_submodel_service_client_config.json';
 ...
 * @memberof v1
 */
export class MobileDeviceSubmodelServiceClient {
   ...
   *     const client = new MobileDeviceSubmodelServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof MobileDeviceSubmodelServiceClient;
    ...
    this.descriptors.page = {
      listMobileDeviceSubmodels:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'mobileDeviceSubmodels')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.admanager.v1.MobileDeviceSubmodelService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.mobileDeviceSubmodelServiceStub) {
      return this.mobileDeviceSubmodelServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.MobileDeviceSubmodelService.
    this.mobileDeviceSubmodelServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.admanager.v1.MobileDeviceSubmodelService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.MobileDeviceSubmodelService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const mobileDeviceSubmodelServiceStubMethods =
        ['getMobileDeviceSubmodel', 'listMobileDeviceSubmodels'];
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.MobileDeviceSubmodel|MobileDeviceSubmodel}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/mobile_device_submodel_service.get_mobile_device_submodel.js</caption>
 * region_tag:admanager_v1_generated_MobileDeviceSubmodelService_GetMobileDeviceSubmodel_async
 */
  getMobileDeviceSubmodel(
      request?: protos.google.ads.admanager.v1.IGetMobileDeviceSubmodelRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IMobileDeviceSubmodel,
        protos.google.ads.admanager.v1.IGetMobileDeviceSubmodelRequest|undefined, {}|undefined
      ]>;
  getMobileDeviceSubmodel(
      request: protos.google.ads.admanager.v1.IGetMobileDeviceSubmodelRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IMobileDeviceSubmodel,
          protos.google.ads.admanager.v1.IGetMobileDeviceSubmodelRequest|null|undefined,
          {}|null|undefined>): void;
  getMobileDeviceSubmodel(
      request: protos.google.ads.admanager.v1.IGetMobileDeviceSubmodelRequest,
      callback: Callback<
  ...
  getMobileDeviceSubmodel(
    ...
    const wrappedCallback: Callback<
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('getMobileDeviceSubmodel response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.getMobileDeviceSubmodel(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ads.admanager.v1.IMobileDeviceSubmodel,
        protos.google.ads.admanager.v1.IGetMobileDeviceSubmodelRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getMobileDeviceSubmodel response %j', response);
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.MobileDeviceSubmodel|MobileDeviceSubmodel}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listMobileDeviceSubmodelsAsync()`
 *   method described below for async iteration which you can stop as needed.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 */
  listMobileDeviceSubmodels(
      request?: protos.google.ads.admanager.v1.IListMobileDeviceSubmodelsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IMobileDeviceSubmodel[],
        protos.google.ads.admanager.v1.IListMobileDeviceSubmodelsRequest|null,
        protos.google.ads.admanager.v1.IListMobileDeviceSubmodelsResponse
      ]>;
  listMobileDeviceSubmodels(
      request: protos.google.ads.admanager.v1.IListMobileDeviceSubmodelsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListMobileDeviceSubmodelsRequest,
          protos.google.ads.admanager.v1.IListMobileDeviceSubmodelsResponse|null|undefined,
          protos.google.ads.admanager.v1.IMobileDeviceSubmodel>): void;
  listMobileDeviceSubmodels(
      request: protos.google.ads.admanager.v1.IListMobileDeviceSubmodelsRequest,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListMobileDeviceSubmodelsRequest,
  ...
  listMobileDeviceSubmodels(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.ads.admanager.v1.IListMobileDeviceSubmodelsRequest,
      protos.google.ads.admanager.v1.IListMobileDeviceSubmodelsResponse|null|undefined,
      protos.google.ads.admanager.v1.IMobileDeviceSubmodel>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listMobileDeviceSubmodels values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listMobileDeviceSubmodels request %j', request);
    return this.innerApiCalls
      .listMobileDeviceSubmodels(request, options, wrappedCallback)
      ?.then(([response, input, output]: [
        protos.google.ads.admanager.v1.IMobileDeviceSubmodel[],
        protos.google.ads.admanager.v1.IListMobileDeviceSubmodelsRequest|null,
        protos.google.ads.admanager.v1.IListMobileDeviceSubmodelsResponse
      ]) => {
        this._log.info('listMobileDeviceSubmodels values %j', response);
        return [response, input, output];
      });
  }

/**
 * Equivalent to `listMobileDeviceSubmodels`, but returns a NodeJS Stream object.
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 *   Required. The parent, which owns this collection of MobileDeviceSubmodels.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.MobileDeviceSubmodel|MobileDeviceSubmodel} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   for more details and examples.
 */
  listMobileDeviceSubmodelsStream(
      request?: protos.google.ads.admanager.v1.IListMobileDeviceSubmodelsRequest,
      options?: CallOptions):
    Transform{
    request = request || {};
    ...
    return this.descriptors.page.listMobileDeviceSubmodels.createStream(
      this.innerApiCalls.listMobileDeviceSubmodels as GaxCall,
      request,
      callSettings
    );
  }
...
/**
 * Equivalent to `listMobileDeviceSubmodels`, but returns an iterable object.
 *
 ...
 *   {@link protos.google.ads.admanager.v1.MobileDeviceSubmodel|MobileDeviceSubmodel}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/mobile_device_submodel_service.list_mobile_device_submodels.js</caption>
 * region_tag:admanager_v1_generated_MobileDeviceSubmodelService_ListMobileDeviceSubmodels_async
 */
  listMobileDeviceSubmodelsAsync(
      request?: protos.google.ads.admanager.v1.IListMobileDeviceSubmodelsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.admanager.v1.IMobileDeviceSubmodel>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listMobileDeviceSubmodels.asyncIterate(
      this.innerApiCalls['listMobileDeviceSubmodels'] as GaxCall,
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.ads.admanager.v1.IMobileDeviceSubmodel>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
