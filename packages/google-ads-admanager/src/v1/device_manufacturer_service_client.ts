 ...
 * `src/v1/device_manufacturer_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './device_manufacturer_service_client_config.json';
 ...
 * @memberof v1
 */
export class DeviceManufacturerServiceClient {
  ...
  deviceManufacturerServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of DeviceManufacturerServiceClient.
   *
   ...
   *     const client = new DeviceManufacturerServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof DeviceManufacturerServiceClient;
    ...
    this.descriptors.page = {
      listDeviceManufacturers:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'deviceManufacturers')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.admanager.v1.DeviceManufacturerService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.deviceManufacturerServiceStub) {
      return this.deviceManufacturerServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.DeviceManufacturerService.
    this.deviceManufacturerServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.admanager.v1.DeviceManufacturerService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.DeviceManufacturerService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const deviceManufacturerServiceStubMethods =
        ['getDeviceManufacturer', 'listDeviceManufacturers'];
    for (const methodName of deviceManufacturerServiceStubMethods) {
      const callPromise = this.deviceManufacturerServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.DeviceManufacturer|DeviceManufacturer}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/device_manufacturer_service.get_device_manufacturer.js</caption>
 * region_tag:admanager_v1_generated_DeviceManufacturerService_GetDeviceManufacturer_async
 */
  getDeviceManufacturer(
      request?: protos.google.ads.admanager.v1.IGetDeviceManufacturerRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IDeviceManufacturer,
        protos.google.ads.admanager.v1.IGetDeviceManufacturerRequest|undefined, {}|undefined
      ]>;
  getDeviceManufacturer(
      request: protos.google.ads.admanager.v1.IGetDeviceManufacturerRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.admanager.v1.IDeviceManufacturer,
          protos.google.ads.admanager.v1.IGetDeviceManufacturerRequest|null|undefined,
          {}|null|undefined>): void;
  getDeviceManufacturer(
      request: protos.google.ads.admanager.v1.IGetDeviceManufacturerRequest,
      callback: Callback<
  ...
  getDeviceManufacturer(
    ...
    this._log.info('getDeviceManufacturer request %j', request);
    const wrappedCallback: Callback<
        protos.google.ads.admanager.v1.IDeviceManufacturer,
        protos.google.ads.admanager.v1.IGetDeviceManufacturerRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('getDeviceManufacturer response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.getDeviceManufacturer(request, options, wrappedCallback)
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.DeviceManufacturer|DeviceManufacturer}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listDeviceManufacturersAsync()`
 *   method described below for async iteration which you can stop as needed.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 */
  listDeviceManufacturers(
      request?: protos.google.ads.admanager.v1.IListDeviceManufacturersRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.admanager.v1.IDeviceManufacturer[],
        protos.google.ads.admanager.v1.IListDeviceManufacturersRequest|null,
        protos.google.ads.admanager.v1.IListDeviceManufacturersResponse
      ]>;
  listDeviceManufacturers(
      request: protos.google.ads.admanager.v1.IListDeviceManufacturersRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListDeviceManufacturersRequest,
          protos.google.ads.admanager.v1.IListDeviceManufacturersResponse|null|undefined,
          protos.google.ads.admanager.v1.IDeviceManufacturer>): void;
  listDeviceManufacturers(
      request: protos.google.ads.admanager.v1.IListDeviceManufacturersRequest,
      callback: PaginationCallback<
          protos.google.ads.admanager.v1.IListDeviceManufacturersRequest,
  ...
  listDeviceManufacturers(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.ads.admanager.v1.IListDeviceManufacturersRequest,
      protos.google.ads.admanager.v1.IListDeviceManufacturersResponse|null|undefined,
      protos.google.ads.admanager.v1.IDeviceManufacturer>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listDeviceManufacturers values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listDeviceManufacturers request %j', request);
    return this.innerApiCalls
      .listDeviceManufacturers(request, options, wrappedCallback)
      ?.then(([response, input, output]: [
        protos.google.ads.admanager.v1.IDeviceManufacturer[],
        protos.google.ads.admanager.v1.IListDeviceManufacturersRequest|null,
        protos.google.ads.admanager.v1.IListDeviceManufacturersResponse
      ]) => {
        this._log.info('listDeviceManufacturers values %j', response);
        return [response, input, output];
      });
  }

/**
 * Equivalent to `listDeviceManufacturers`, but returns a NodeJS Stream object.
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 *   Required. The parent, which owns this collection of DeviceManufacturers.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.DeviceManufacturer|DeviceManufacturer} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 */
  listDeviceManufacturersStream(
    ...
    const defaultCallSettings = this._defaults['listDeviceManufacturers'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listDeviceManufacturers stream %j', request);
    return this.descriptors.page.listDeviceManufacturers.createStream(
      this.innerApiCalls.listDeviceManufacturers as GaxCall,
      request,
      callSettings
    );
  }
...
/**
 * Equivalent to `listDeviceManufacturers`, but returns an iterable object.
 *
 ...
 *   {@link protos.google.ads.admanager.v1.DeviceManufacturer|DeviceManufacturer}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/device_manufacturer_service.list_device_manufacturers.js</caption>
 * region_tag:admanager_v1_generated_DeviceManufacturerService_ListDeviceManufacturers_async
 */
  listDeviceManufacturersAsync(
      request?: protos.google.ads.admanager.v1.IListDeviceManufacturersRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.admanager.v1.IDeviceManufacturer>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listDeviceManufacturers iterate %j', request);
    return this.descriptors.page.listDeviceManufacturers.asyncIterate(
      this.innerApiCalls['listDeviceManufacturers'] as GaxCall,
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.ads.admanager.v1.IDeviceManufacturer>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.deviceManufacturerServiceStub && !this._terminated) {
      return this.deviceManufacturerServiceStub.then(stub => {
