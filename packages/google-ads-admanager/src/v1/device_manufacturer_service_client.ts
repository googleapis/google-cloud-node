...
export class DeviceManufacturerServiceClient {
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof DeviceManufacturerServiceClient;
    if (
    ...
    this.descriptors.page = {
      listDeviceManufacturers: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'deviceManufacturers',
      ),
  ...
  getDeviceManufacturer(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IDeviceManufacturer,
      | protos.google.ads.admanager.v1.IGetDeviceManufacturerRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .getDeviceManufacturer(request, options, wrappedCallback)
      ?.then(
