 ...
 * `src/v1/network_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './network_service_client_config.json';
...
export class NetworkServiceClient {
  ...
  networkServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of NetworkServiceClient.
   *
  ...
  initialize() {
    ...
    if (this.networkServiceStub) {
      return this.networkServiceStub;
    }
