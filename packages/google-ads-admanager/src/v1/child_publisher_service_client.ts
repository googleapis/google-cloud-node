 ...
 * `src/v1/child_publisher_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './child_publisher_service_client_config.json';
const version = require('../../../package.json').version;

/**
 *  Provides methods for handling
 *  {@link protos.google.ads.admanager.v1.ChildPublisher|ChildPublisher} objects.
 * @class
 * @memberof v1
 */
export class ChildPublisherServiceClient {
   ...
   *     const client = new ChildPublisherServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(
    opts?: ClientOptions,
    ...
    const staticMembers = this
      .constructor as typeof ChildPublisherServiceClient;
    if (
    ...
    this.descriptors.page = {
      listChildPublishers: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'childPublishers',
      ),
  ...
  initialize() {
    ...
    if (this.childPublisherServiceStub) {
      return this.childPublisherServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.ChildPublisherService.
    this.childPublisherServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
    ...
    const childPublisherServiceStubMethods = [
      'getChildPublisher',
      'listChildPublishers',
  ...
  // -------------------
  /**
   * Retrieves a {@link protos.google.ads.admanager.v1.ChildPublisher|ChildPublisher}
   * object.
   *
   ...
   *   {@link protos.google.ads.admanager.v1.ChildPublisher|ChildPublisher}. Format:
   *   `networks/{network_code}/childPublishers/{child_publisher_id}`
   * @param {object} [options]
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.ChildPublisher|ChildPublisher}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/child_publisher_service.get_child_publisher.js</caption>
   * region_tag:admanager_v1_generated_ChildPublisherService_GetChildPublisher_async
   */
  getChildPublisher(
    request?: protos.google.ads.admanager.v1.IGetChildPublisherRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IChildPublisher,
      protos.google.ads.admanager.v1.IGetChildPublisherRequest | undefined,
      {} | undefined,
    ]
  >;
  getChildPublisher(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IChildPublisher,
      | protos.google.ads.admanager.v1.IGetChildPublisherRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('getChildPublisher response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .getChildPublisher(request, options, wrappedCallback)
      ?.then(
  ...
  /**
   * Creates a {@link protos.google.ads.admanager.v1.ChildPublisher|ChildPublisher} object.
   *
   * @param {Object} request
   *   The request object that will be sent.
   * @param {string} request.parent
   *   Required. The parent resource where this
   *   {@link protos.google.ads.admanager.v1.ChildPublisher|ChildPublisher} will be created.
   *   Format: `networks/{network_code}`
   * @param {google.ads.admanager.v1.ChildPublisher} request.childPublisher
   *   Required. The {@link protos.google.ads.admanager.v1.ChildPublisher|ChildPublisher} to
   *   create.
   * @param {object} [options]
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/child_publisher_service.create_child_publisher.js</caption>
   * region_tag:admanager_v1_generated_ChildPublisherService_CreateChildPublisher_async
   */
  createChildPublisher(
    request?: protos.google.ads.admanager.v1.ICreateChildPublisherRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IChildPublisher,
      protos.google.ads.admanager.v1.ICreateChildPublisherRequest | undefined,
      {} | undefined,
    ]
  >;
  createChildPublisher(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IChildPublisher,
      | protos.google.ads.admanager.v1.ICreateChildPublisherRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('createChildPublisher response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .createChildPublisher(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IChildPublisher,
          (
  ...
  /**
   * Creates {@link protos.google.ads.admanager.v1.ChildPublisher|ChildPublisher} objects.
   *
   * @param {Object} request
   *   The request object that will be sent.
   * @param {string} request.parent
   *   Required. The parent resource where
   *   {@link protos.google.ads.admanager.v1.ChildPublisher|ChildPublisher}s will be created.
   *   Format: `networks/{network_code}`
   *   The parent field in the CreateChildPublisherRequest must match this
   *   field.
   * @param {number[]} request.requests
   *   Required. The {@link protos.google.ads.admanager.v1.ChildPublisher|ChildPublisher}
   *   objects to create. A maximum of 100 objects can be created in a batch.
   * @param {object} [options]
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchCreateChildPublishersResponse|BatchCreateChildPublishersResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/child_publisher_service.batch_create_child_publishers.js</caption>
   * region_tag:admanager_v1_generated_ChildPublisherService_BatchCreateChildPublishers_async
   */
  batchCreateChildPublishers(
    request?: protos.google.ads.admanager.v1.IBatchCreateChildPublishersRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchCreateChildPublishersResponse,
      (
        | protos.google.ads.admanager.v1.IBatchCreateChildPublishersRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchCreateChildPublishers response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchCreateChildPublishers(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchCreateChildPublishersResponse,
          (
  ...
  /**
   * Updates a {@link protos.google.ads.admanager.v1.ChildPublisher|ChildPublisher} object.
   *
   * @param {Object} request
   *   The request object that will be sent.
   * @param {google.ads.admanager.v1.ChildPublisher} request.childPublisher
   ...
   *   update.
   *
   *   The {@link protos.google.ads.admanager.v1.ChildPublisher|ChildPublisher}'s `name` is
   *   used to identify the
   *   {@link protos.google.ads.admanager.v1.ChildPublisher|ChildPublisher} to update.
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/child_publisher_service.update_child_publisher.js</caption>
   * region_tag:admanager_v1_generated_ChildPublisherService_UpdateChildPublisher_async
   */
  updateChildPublisher(
    request?: protos.google.ads.admanager.v1.IUpdateChildPublisherRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IChildPublisher,
      protos.google.ads.admanager.v1.IUpdateChildPublisherRequest | undefined,
      {} | undefined,
    ]
  >;
  updateChildPublisher(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IChildPublisher,
      | protos.google.ads.admanager.v1.IUpdateChildPublisherRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('updateChildPublisher response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .updateChildPublisher(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IChildPublisher,
          (
  ...
  /**
   * Batch updates {@link protos.google.ads.admanager.v1.ChildPublisher|ChildPublisher}
   * objects.
   *
   * @param {Object} request
   *   The request object that will be sent.
   * @param {string} request.parent
   *   Required. The parent resource where
   *   {@link protos.google.ads.admanager.v1.ChildPublisher|ChildPublisher}s will be updated.
   *   Format: `networks/{network_code}`
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchUpdateChildPublishersResponse|BatchUpdateChildPublishersResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/child_publisher_service.batch_update_child_publishers.js</caption>
   * region_tag:admanager_v1_generated_ChildPublisherService_BatchUpdateChildPublishers_async
   */
  batchUpdateChildPublishers(
    request?: protos.google.ads.admanager.v1.IBatchUpdateChildPublishersRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchUpdateChildPublishersResponse,
      (
        | protos.google.ads.admanager.v1.IBatchUpdateChildPublishersRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .batchUpdateChildPublishers(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchUpdateChildPublishersResponse,
          (
  ...
  /**
   * Lists {@link protos.google.ads.admanager.v1.ChildPublisher|ChildPublisher} objects.
   *
   * @param {Object} request
   *   The request object that will be sent.
   * @param {string} request.parent
   *   Required. The parent, which owns this collection of
   *   {@link protos.google.ads.admanager.v1.ChildPublisher|ChildPublisher}s. Format:
   *   `networks/{network_code}`
   * @param {number} [request.pageSize]
   *   Optional. The maximum number of
   *   {@link protos.google.ads.admanager.v1.ChildPublisher|ChildPublisher}s to return. The
   *   service may return fewer than this value. If unspecified, at most 50
   *   {@link protos.google.ads.admanager.v1.ChildPublisher|ChildPublisher}s will be returned.
   *   The maximum value is 1000; values greater than 1000 will be coerced to
   *   1000.
   * @param {string} [request.pageToken]
   *   Optional. A page token, received from a previous {@link protos.|ListChildPublishers}
   *   call. Provide this to retrieve the subsequent page.
   *
   *   When paginating, all other parameters provided to {@link protos.|ListChildPublishers}
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.ChildPublisher|ChildPublisher}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   *   We recommend using `listChildPublishersAsync()`
   *   method described below for async iteration which you can stop as needed.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   */
  listChildPublishers(
    request?: protos.google.ads.admanager.v1.IListChildPublishersRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IChildPublisher[],
      protos.google.ads.admanager.v1.IListChildPublishersRequest | null,
      protos.google.ads.admanager.v1.IListChildPublishersResponse,
    ]
  >;
  listChildPublishers(
    request: protos.google.ads.admanager.v1.IListChildPublishersRequest,
    ...
    callback: PaginationCallback<
      protos.google.ads.admanager.v1.IListChildPublishersRequest,
      | protos.google.ads.admanager.v1.IListChildPublishersResponse
      | null
      | undefined,
      protos.google.ads.admanager.v1.IChildPublisher
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listChildPublishers values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listChildPublishers request %j', request);
    return this.innerApiCalls
      .listChildPublishers(request, options, wrappedCallback)
      ?.then(
        ([response, input, output]: [
          ...
          this._log.info('listChildPublishers values %j', response);
  ...
  /**
   * Equivalent to `listChildPublishers`, but returns a NodeJS Stream object.
   * @param {Object} request
   *   The request object that will be sent.
   * @param {string} request.parent
   *   Required. The parent, which owns this collection of
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.ChildPublisher|ChildPublisher} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
  ...
  listChildPublishersStream(
    ...
    return this.descriptors.page.listChildPublishers.createStream(
      this.innerApiCalls.listChildPublishers as GaxCall,
      request,
      callSettings,
    );
  }
  ...
  /**
   * Equivalent to `listChildPublishers`, but returns an iterable object.
   *
   ...
   *   {@link protos.google.ads.admanager.v1.ChildPublisher|ChildPublisher}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/child_publisher_service.list_child_publishers.js</caption>
   * region_tag:admanager_v1_generated_ChildPublisherService_ListChildPublishers_async
   */
  listChildPublishersAsync(
    request?: protos.google.ads.admanager.v1.IListChildPublishersRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.ads.admanager.v1.IChildPublisher> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listChildPublishers.asyncIterate(
      this.innerApiCalls['listChildPublishers'] as GaxCall,
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.ads.admanager.v1.IChildPublisher>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
