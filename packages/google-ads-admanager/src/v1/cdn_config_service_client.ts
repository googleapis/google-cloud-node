 ...
 * `src/v1/cdn_config_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './cdn_config_service_client_config.json';
 ...
 * @memberof v1
 */
export class CdnConfigServiceClient {
  ...
  cdnConfigServiceStub?: Promise<{ [name: string]: Function }>;

  /**
   * Construct an instance of CdnConfigServiceClient.
   *
   ...
   *     const client = new CdnConfigServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(
    opts?: ClientOptions,
    ...
    const staticMembers = this.constructor as typeof CdnConfigServiceClient;
    if (
    ...
    this.descriptors.page = {
      listCdnConfigs: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'cdnConfigs',
      ),
  ...
  initialize() {
    ...
    if (this.cdnConfigServiceStub) {
      return this.cdnConfigServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.admanager.v1.CdnConfigService.
    this.cdnConfigServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ? (this._protos as protobuf.Root).lookupService(
            'google.ads.admanager.v1.CdnConfigService',
          )
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.admanager.v1.CdnConfigService,
      this._opts,
      this._providedCustomServicePath,
    ...
    const cdnConfigServiceStubMethods = [
      'getCdnConfig',
      'listCdnConfigs',
      'createCdnConfig',
    ...
    for (const methodName of cdnConfigServiceStubMethods) {
      const callPromise = this.cdnConfigServiceStub.then(
        (stub) =>
          (...args: Array<{}>) => {
            if (this._terminated) {
   ...
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.CdnConfig|CdnConfig}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/cdn_config_service.get_cdn_config.js</caption>
   * region_tag:admanager_v1_generated_CdnConfigService_GetCdnConfig_async
   */
  getCdnConfig(
    request?: protos.google.ads.admanager.v1.IGetCdnConfigRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.ICdnConfig,
      protos.google.ads.admanager.v1.IGetCdnConfigRequest | undefined,
      {} | undefined,
    ]
  >;
  getCdnConfig(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.ICdnConfig,
      protos.google.ads.admanager.v1.IGetCdnConfigRequest | null | undefined,
      {} | null | undefined
    >,
  ): void;
  getCdnConfig(
  ...
  getCdnConfig(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.ads.admanager.v1.ICdnConfig,
          | protos.google.ads.admanager.v1.IGetCdnConfigRequest
          | null
          | undefined,
          {} | null | undefined
        >,
  ...
  > | void {
    ...
    this._log.info('getCdnConfig request %j', request);
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('getCdnConfig response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .getCdnConfig(request, options, wrappedCallback)
      ?.then(
   ...
   * @param {google.ads.admanager.v1.CdnConfig} request.cdnConfig
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/cdn_config_service.create_cdn_config.js</caption>
   * region_tag:admanager_v1_generated_CdnConfigService_CreateCdnConfig_async
   */
  createCdnConfig(
    request?: protos.google.ads.admanager.v1.ICreateCdnConfigRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.ICdnConfig,
      protos.google.ads.admanager.v1.ICreateCdnConfigRequest | undefined,
      {} | undefined,
    ]
  >;
  createCdnConfig(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.ICdnConfig,
      protos.google.ads.admanager.v1.ICreateCdnConfigRequest | null | undefined,
      {} | null | undefined
    >,
  ): void;
  createCdnConfig(
  ...
  createCdnConfig(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.ads.admanager.v1.ICdnConfig,
          | protos.google.ads.admanager.v1.ICreateCdnConfigRequest
          | null
          | undefined,
          {} | null | undefined
        >,
  ...
  > | void {
    ...
    this._log.info('createCdnConfig request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.ads.admanager.v1.ICdnConfig,
          | protos.google.ads.admanager.v1.ICreateCdnConfigRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('createCdnConfig response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .createCdnConfig(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.ICdnConfig,
          protos.google.ads.admanager.v1.ICreateCdnConfigRequest | undefined,
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchCreateCdnConfigsResponse|BatchCreateCdnConfigsResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/cdn_config_service.batch_create_cdn_configs.js</caption>
   * region_tag:admanager_v1_generated_CdnConfigService_BatchCreateCdnConfigs_async
   */
  batchCreateCdnConfigs(
    request?: protos.google.ads.admanager.v1.IBatchCreateCdnConfigsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchCreateCdnConfigsResponse,
      protos.google.ads.admanager.v1.IBatchCreateCdnConfigsRequest | undefined,
      {} | undefined,
    ]
  >;
  batchCreateCdnConfigs(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IBatchCreateCdnConfigsResponse,
      | protos.google.ads.admanager.v1.IBatchCreateCdnConfigsRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    this._log.info('batchCreateCdnConfigs request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.ads.admanager.v1.IBatchCreateCdnConfigsResponse,
          | protos.google.ads.admanager.v1.IBatchCreateCdnConfigsRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchCreateCdnConfigs response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchCreateCdnConfigs(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchCreateCdnConfigsResponse,
          (
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/cdn_config_service.update_cdn_config.js</caption>
   * region_tag:admanager_v1_generated_CdnConfigService_UpdateCdnConfig_async
   */
  updateCdnConfig(
    request?: protos.google.ads.admanager.v1.IUpdateCdnConfigRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.ICdnConfig,
      protos.google.ads.admanager.v1.IUpdateCdnConfigRequest | undefined,
      {} | undefined,
    ]
  >;
  updateCdnConfig(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.ICdnConfig,
      protos.google.ads.admanager.v1.IUpdateCdnConfigRequest | null | undefined,
      {} | null | undefined
    >,
  ): void;
  updateCdnConfig(
  ...
  updateCdnConfig(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.ads.admanager.v1.ICdnConfig,
          | protos.google.ads.admanager.v1.IUpdateCdnConfigRequest
          | null
          | undefined,
          {} | null | undefined
        >,
  ...
  > | void {
    ...
    options.otherArgs.headers['x-goog-request-params'] =
      this._gaxModule.routingHeader.fromParams({
        'cdn_config.name': request.cdnConfig!.name ?? '',
      });
    this.initialize().catch((err) => {
      throw err;
    });
    this._log.info('updateCdnConfig request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.ads.admanager.v1.ICdnConfig,
          | protos.google.ads.admanager.v1.IUpdateCdnConfigRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('updateCdnConfig response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .updateCdnConfig(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.ICdnConfig,
          protos.google.ads.admanager.v1.IUpdateCdnConfigRequest | undefined,
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchUpdateCdnConfigsResponse|BatchUpdateCdnConfigsResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/cdn_config_service.batch_update_cdn_configs.js</caption>
   * region_tag:admanager_v1_generated_CdnConfigService_BatchUpdateCdnConfigs_async
   */
  batchUpdateCdnConfigs(
    request?: protos.google.ads.admanager.v1.IBatchUpdateCdnConfigsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchUpdateCdnConfigsResponse,
      protos.google.ads.admanager.v1.IBatchUpdateCdnConfigsRequest | undefined,
      {} | undefined,
    ]
  >;
  batchUpdateCdnConfigs(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IBatchUpdateCdnConfigsResponse,
      | protos.google.ads.admanager.v1.IBatchUpdateCdnConfigsRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    this._log.info('batchUpdateCdnConfigs request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.ads.admanager.v1.IBatchUpdateCdnConfigsResponse,
          | protos.google.ads.admanager.v1.IBatchUpdateCdnConfigsRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchUpdateCdnConfigs response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchUpdateCdnConfigs(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchUpdateCdnConfigsResponse,
          (
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchActivateCdnConfigsResponse|BatchActivateCdnConfigsResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/cdn_config_service.batch_activate_cdn_configs.js</caption>
   * region_tag:admanager_v1_generated_CdnConfigService_BatchActivateCdnConfigs_async
   */
  batchActivateCdnConfigs(
    request?: protos.google.ads.admanager.v1.IBatchActivateCdnConfigsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchActivateCdnConfigsResponse,
      (
        | protos.google.ads.admanager.v1.IBatchActivateCdnConfigsRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    this._log.info('batchActivateCdnConfigs request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.ads.admanager.v1.IBatchActivateCdnConfigsResponse,
          | protos.google.ads.admanager.v1.IBatchActivateCdnConfigsRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchActivateCdnConfigs response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchActivateCdnConfigs(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchActivateCdnConfigsResponse,
          (
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.ads.admanager.v1.BatchArchiveCdnConfigsResponse|BatchArchiveCdnConfigsResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/cdn_config_service.batch_archive_cdn_configs.js</caption>
   * region_tag:admanager_v1_generated_CdnConfigService_BatchArchiveCdnConfigs_async
   */
  batchArchiveCdnConfigs(
    request?: protos.google.ads.admanager.v1.IBatchArchiveCdnConfigsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.IBatchArchiveCdnConfigsResponse,
      protos.google.ads.admanager.v1.IBatchArchiveCdnConfigsRequest | undefined,
      {} | undefined,
    ]
  >;
  batchArchiveCdnConfigs(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IBatchArchiveCdnConfigsResponse,
      | protos.google.ads.admanager.v1.IBatchArchiveCdnConfigsRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    this._log.info('batchArchiveCdnConfigs request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.ads.admanager.v1.IBatchArchiveCdnConfigsResponse,
          | protos.google.ads.admanager.v1.IBatchArchiveCdnConfigsRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchArchiveCdnConfigs response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchArchiveCdnConfigs(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.ads.admanager.v1.IBatchArchiveCdnConfigsResponse,
          (
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.ads.admanager.v1.CdnConfig|CdnConfig}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   *   We recommend using `listCdnConfigsAsync()`
   *   method described below for async iteration which you can stop as needed.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   */
  listCdnConfigs(
    request?: protos.google.ads.admanager.v1.IListCdnConfigsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.ads.admanager.v1.ICdnConfig[],
      protos.google.ads.admanager.v1.IListCdnConfigsRequest | null,
      protos.google.ads.admanager.v1.IListCdnConfigsResponse,
    ]
  >;
  listCdnConfigs(
    request: protos.google.ads.admanager.v1.IListCdnConfigsRequest,
    ...
    callback: PaginationCallback<
      protos.google.ads.admanager.v1.IListCdnConfigsRequest,
      protos.google.ads.admanager.v1.IListCdnConfigsResponse | null | undefined,
      protos.google.ads.admanager.v1.ICdnConfig
    >,
  ): void;
  listCdnConfigs(
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listCdnConfigs values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listCdnConfigs request %j', request);
    return this.innerApiCalls
      .listCdnConfigs(request, options, wrappedCallback)
      ?.then(
        ([response, input, output]: [
          ...
          this._log.info('listCdnConfigs values %j', response);
  ...
  /**
   * Equivalent to `listCdnConfigs`, but returns a NodeJS Stream object.
   * @param {Object} request
   *   The request object that will be sent.
   * @param {string} request.parent
   *   Required. The parent, which owns this collection of CdnConfigs.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.ads.admanager.v1.CdnConfig|CdnConfig} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
  ...
  listCdnConfigsStream(
    ...
    const defaultCallSettings = this._defaults['listCdnConfigs'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch((err) => {
      throw err;
    });
    this._log.info('listCdnConfigs stream %j', request);
    return this.descriptors.page.listCdnConfigs.createStream(
      this.innerApiCalls.listCdnConfigs as GaxCall,
      request,
      callSettings,
    );
  }
  ...
  /**
   * Equivalent to `listCdnConfigs`, but returns an iterable object.
   *
   ...
   *   {@link protos.google.ads.admanager.v1.CdnConfig|CdnConfig}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/cdn_config_service.list_cdn_configs.js</caption>
   * region_tag:admanager_v1_generated_CdnConfigService_ListCdnConfigs_async
   */
  listCdnConfigsAsync(
    request?: protos.google.ads.admanager.v1.IListCdnConfigsRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.ads.admanager.v1.ICdnConfig> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    this._log.info('listCdnConfigs iterate %j', request);
    return this.descriptors.page.listCdnConfigs.asyncIterate(
      this.innerApiCalls['listCdnConfigs'] as GaxCall,
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.ads.admanager.v1.ICdnConfig>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
  ...
  matchNetworkCodeFromChildPublisherName(childPublisherName: string) {
    return this.pathTemplates.childPublisherPathTemplate.match(
      childPublisherName,
    ).network_code;
  }
  ...
  matchNetworkCodeFromRichMediaAdsCompanyName(richMediaAdsCompanyName: string) {
    return this.pathTemplates.richMediaAdsCompanyPathTemplate.match(
   ...
   */
  matchRichMediaAdsCompanyFromRichMediaAdsCompanyName(
    richMediaAdsCompanyName: string,
  ) {
    return this.pathTemplates.richMediaAdsCompanyPathTemplate.match(
      richMediaAdsCompanyName,
    ).rich_media_ads_company;
  }
   ...
   */
  close(): Promise<void> {
    if (this.cdnConfigServiceStub && !this._terminated) {
      return this.cdnConfigServiceStub.then((stub) => {
