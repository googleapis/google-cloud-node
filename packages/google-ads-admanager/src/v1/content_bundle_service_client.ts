...
export class ContentBundleServiceClient {
  ...
  constructor(
    ...
    this.descriptors.page = {
      listContentBundles: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'contentBundles',
      ),
  ...
  getContentBundle(
    ...
    callback: Callback<
      protos.google.ads.admanager.v1.IContentBundle,
      | protos.google.ads.admanager.v1.IGetContentBundleRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .getContentBundle(request, options, wrappedCallback)
      ?.then(
