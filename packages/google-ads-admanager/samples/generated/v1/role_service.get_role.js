...
function main(name) {
  ...
  const {RoleServiceClient} = require('@google-ads/admanager').v1;

  // Instantiates a client
  const admanagerClient = new RoleServiceClient();

  async function callGetRole() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await admanagerClient.getRole(request);
