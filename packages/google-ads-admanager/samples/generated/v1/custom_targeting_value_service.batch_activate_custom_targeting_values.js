...
function main(parent, requests) {
  ...
  async function callBatchActivateCustomTargetingValues() {
    // Construct request
    const request = {
      parent,
      requests,
    ...
    // Run request
    const response = await admanagerClient.batchActivateCustomTargetingValues(request);
    console.log(response);
  }

  callBatchActivateCustomTargetingValues();
