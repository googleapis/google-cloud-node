...
function main(name) {
  ...
  const {ThirdPartyCompanyServiceClient} = require('@google-ads/admanager').v1;

  // Instantiates a client
  const admanagerClient = new ThirdPartyCompanyServiceClient();

  async function callGetThirdPartyCompany() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await admanagerClient.getThirdPartyCompany(request);
    console.log(response);
  }

  callGetThirdPartyCompany();
