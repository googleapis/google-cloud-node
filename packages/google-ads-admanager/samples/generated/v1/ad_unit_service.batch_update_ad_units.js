...
function main(parent, requests) {
  // [START admanager_v1_generated_AdUnitService_BatchUpdateAdUnits_async]
  /**
  ...
  async function callBatchUpdateAdUnits() {
    // Construct request
    const request = {
      parent,
      requests,
    ...
    // Run request
    const response = await admanagerClient.batchUpdateAdUnits(request);
    console.log(response);
  }

  callBatchUpdateAdUnits();
  // [END admanager_v1_generated_AdUnitService_BatchUpdateAdUnits_async]
}
