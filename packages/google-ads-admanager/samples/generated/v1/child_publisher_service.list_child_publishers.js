...
function main(parent) {
  // [START admanager_v1_generated_ChildPublisherService_ListChildPublishers_async]
  /**
  ...
  async function callListChildPublishers() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = admanagerClient.listChildPublishersAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListChildPublishers();
  // [END admanager_v1_generated_ChildPublisherService_ListChildPublishers_async]
}
