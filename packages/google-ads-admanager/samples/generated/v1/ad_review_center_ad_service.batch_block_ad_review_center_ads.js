...
function main(parent, names) {
  ...
  async function callBatchBlockAdReviewCenterAds() {
    // Construct request
    const request = {
      parent,
      names,
    ...
    // Run request
    const [operation] = await admanagerClient.batchBlockAdReviewCenterAds(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callBatchBlockAdReviewCenterAds();
