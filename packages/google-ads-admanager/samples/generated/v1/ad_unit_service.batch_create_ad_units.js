...
function main(parent, requests) {
  // [START admanager_v1_generated_AdUnitService_BatchCreateAdUnits_async]
  /**
  ...
  async function callBatchCreateAdUnits() {
    // Construct request
    const request = {
      parent,
      requests,
    ...
    // Run request
    const response = await admanagerClient.batchCreateAdUnits(request);
    console.log(response);
  }

  callBatchCreateAdUnits();
