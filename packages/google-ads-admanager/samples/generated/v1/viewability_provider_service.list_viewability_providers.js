...
function main(parent) {
  // [START admanager_v1_generated_ViewabilityProviderService_ListViewabilityProviders_async]
  /**
  ...
  const {ViewabilityProviderServiceClient} = require('@google-ads/admanager').v1;

  // Instantiates a client
  const admanagerClient = new ViewabilityProviderServiceClient();

  async function callListViewabilityProviders() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = admanagerClient.listViewabilityProvidersAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListViewabilityProviders();
  // [END admanager_v1_generated_ViewabilityProviderService_ListViewabilityProviders_async]
}
