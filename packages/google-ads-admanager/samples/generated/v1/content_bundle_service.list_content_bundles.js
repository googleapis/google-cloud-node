...
function main(parent) {
  // [START admanager_v1_generated_ContentBundleService_ListContentBundles_async]
  /**
  ...
  async function callListContentBundles() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = admanagerClient.listContentBundlesAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListContentBundles();
