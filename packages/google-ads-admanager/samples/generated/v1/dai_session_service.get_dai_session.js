...
function main(name) {
  ...
  const {DaiSessionServiceClient} = require('@google-ads/admanager').v1;

  // Instantiates a client
  const admanagerClient = new DaiSessionServiceClient();

  async function callGetDaiSession() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await admanagerClient.getDaiSession(request);
