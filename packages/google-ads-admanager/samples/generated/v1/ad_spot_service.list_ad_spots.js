...
function main(parent) {
  ...
  const {AdSpotServiceClient} = require('@google-ads/admanager').v1;

  // Instantiates a client
  const admanagerClient = new AdSpotServiceClient();

  async function callListAdSpots() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = admanagerClient.listAdSpotsAsync(request);
