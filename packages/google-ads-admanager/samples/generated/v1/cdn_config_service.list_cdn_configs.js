...
function main(parent) {
  // [START admanager_v1_generated_CdnConfigService_ListCdnConfigs_async]
  /**
  ...
  async function callListCdnConfigs() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = admanagerClient.listCdnConfigsAsync(request);
  ...
  callListCdnConfigs();
  // [END admanager_v1_generated_CdnConfigService_ListCdnConfigs_async]
}
