...
function main(parent) {
  // [START admanager_v1_generated_AdUnitService_ListAdUnits_async]
  /**
  ...
  async function callListAdUnits() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = admanagerClient.listAdUnitsAsync(request);
  ...
  callListAdUnits();
  // [END admanager_v1_generated_AdUnitService_ListAdUnits_async]
}
