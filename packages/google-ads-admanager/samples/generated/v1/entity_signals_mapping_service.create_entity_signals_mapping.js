...
function main(parent, entitySignalsMapping) {
  ...
  async function callCreateEntitySignalsMapping() {
    // Construct request
    const request = {
      parent,
    ...
    // Run request
    const response = await admanagerClient.createEntitySignalsMapping(request);
    console.log(response);
  }

  callCreateEntitySignalsMapping();
