...
function main(parent) {
  // [START admanager_v1_generated_GeoTargetService_ListGeoTargets_async]
  /**
  ...
  async function callListGeoTargets() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = admanagerClient.listGeoTargetsAsync(request);
  ...
  callListGeoTargets();
  // [END admanager_v1_generated_GeoTargetService_ListGeoTargets_async]
}
