...
function main(parent, requests) {
  ...
  async function callBatchUpdateEntitySignalsMappings() {
    // Construct request
    const request = {
      parent,
      requests,
    ...
    // Run request
    const response = await admanagerClient.batchUpdateEntitySignalsMappings(request);
    console.log(response);
  }

  callBatchUpdateEntitySignalsMappings();
