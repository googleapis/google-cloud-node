...
function main(parent) {
  // [START admanager_v1_generated_AdRuleService_ListAdRules_async]
  /**
  ...
  async function callListAdRules() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = admanagerClient.listAdRulesAsync(request);
  ...
  callListAdRules();
  // [END admanager_v1_generated_AdRuleService_ListAdRules_async]
}
