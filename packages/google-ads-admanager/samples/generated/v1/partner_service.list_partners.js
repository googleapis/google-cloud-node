...
function main(parent) {
  // [START admanager_v1_generated_PartnerService_ListPartners_async]
  /**
  ...
  async function callListPartners() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = admanagerClient.listPartnersAsync(request);
  ...
  callListPartners();
  // [END admanager_v1_generated_PartnerService_ListPartners_async]
}
