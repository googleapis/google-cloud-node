...
function main(parent) {
  // [START admanager_v1_generated_ReportService_ListReports_async]
  /**
  ...
  async function callListReports() {
    ...
    // Run request
    const iterable = admanagerClient.listReportsAsync(request);
  ...
  callListReports();
  // [END admanager_v1_generated_ReportService_ListReports_async]
}
