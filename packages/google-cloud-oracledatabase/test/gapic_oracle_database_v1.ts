...
describe('v1.OracleDatabaseClient', () => {
  ...
  describe('configureExascaleCloudExadataInfrastructure', () => {
    it('invokes configureExascaleCloudExadataInfrastructure without error', async () => {
      const client = new oracledatabaseModule.v1.OracleDatabaseClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.oracledatabase.v1.ConfigureExascaleCloudExadataInfrastructureRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.configureExascaleCloudExadataInfrastructure =
        stubLongRunningCall(expectedResponse);
      const [operation] =
        await client.configureExascaleCloudExadataInfrastructure(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls
          .configureExascaleCloudExadataInfrastructure as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls
    ...
    it('invokes configureExascaleCloudExadataInfrastructure without error using callback', async () => {
      const client = new oracledatabaseModule.v1.OracleDatabaseClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.configureExascaleCloudExadataInfrastructure =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.configureExascaleCloudExadataInfrastructure(
          request,
          (
            err?: Error | null,
            result?: LROperation<
    ...
    it('invokes configureExascaleCloudExadataInfrastructure with call error', async () => {
      const client = new oracledatabaseModule.v1.OracleDatabaseClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.configureExascaleCloudExadataInfrastructure =
        stubLongRunningCall(undefined, expectedError);
      await assert.rejects(
        client.configureExascaleCloudExadataInfrastructure(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls
    ...
    it('invokes configureExascaleCloudExadataInfrastructure with LRO error', async () => {
      const client = new oracledatabaseModule.v1.OracleDatabaseClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
    ...
    it('invokes checkConfigureExascaleCloudExadataInfrastructureProgress without error', async () => {
      const client = new oracledatabaseModule.v1.OracleDatabaseClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkConfigureExascaleCloudExadataInfrastructureProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkConfigureExascaleCloudExadataInfrastructureProgress with error', async () => {
      const client = new oracledatabaseModule.v1.OracleDatabaseClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      await assert.rejects(
        client.checkConfigureExascaleCloudExadataInfrastructureProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
