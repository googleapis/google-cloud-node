...
function main(name, refreshCutoffTime) {
  ...
  async function callRefreshAutonomousDatabase() {
    // Construct request
    const request = {
      name,
      refreshCutoffTime,
    ...
    // Run request
    const [operation] = await oracledatabaseClient.refreshAutonomousDatabase(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callRefreshAutonomousDatabase();
