...
function main(name) {
  // [START oracledatabase_v1_generated_OracleDatabase_GetGoldengateDeployment_async]
  /**
  ...
  async function callGetGoldengateDeployment() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await oracledatabaseClient.getGoldengateDeployment(request);
    console.log(response);
  }

  callGetGoldengateDeployment();
  // [END oracledatabase_v1_generated_OracleDatabase_GetGoldengateDeployment_async]
}
