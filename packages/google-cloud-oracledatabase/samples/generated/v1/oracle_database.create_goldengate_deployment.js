...
function main(parent, goldengateDeploymentId, goldengateDeployment) {
   ...
   *  letter or a number.
   */
  // const goldengateDeploymentId = 'abc123'
  /**
   *  Required. The resource being created.
   */
  // const goldengateDeployment = {}
  /**
  ...
  async function callCreateGoldengateDeployment() {
    // Construct request
    const request = {
      parent,
    ...
    // Run request
    const [operation] = await oracledatabaseClient.createGoldengateDeployment(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callCreateGoldengateDeployment();
