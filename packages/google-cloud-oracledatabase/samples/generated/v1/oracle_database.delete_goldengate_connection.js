...
function main(name) {
  ...
  async function callDeleteGoldengateConnection() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const [operation] = await oracledatabaseClient.deleteGoldengateConnection(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callDeleteGoldengateConnection();
