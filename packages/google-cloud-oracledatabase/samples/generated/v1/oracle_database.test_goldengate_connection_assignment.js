...
function main(name) {
  ...
  async function callTestGoldengateConnectionAssignment() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await oracledatabaseClient.testGoldengateConnectionAssignment(request);
    console.log(response);
  }

  callTestGoldengateConnectionAssignment();
