...
function main(parent) {
  // [START oracledatabase_v1_generated_OracleDatabase_ListDbSystems_async]
  /**
  ...
  async function callListDbSystems() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = oracledatabaseClient.listDbSystemsAsync(request);
  ...
  callListDbSystems();
  // [END oracledatabase_v1_generated_OracleDatabase_ListDbSystems_async]
}
