...
function main(parent) {
  // [START oracledatabase_v1_generated_OracleDatabase_ListGoldengateDeployments_async]
  /**
  ...
  async function callListGoldengateDeployments() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = oracledatabaseClient.listGoldengateDeploymentsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListGoldengateDeployments();
  // [END oracledatabase_v1_generated_OracleDatabase_ListGoldengateDeployments_async]
}
