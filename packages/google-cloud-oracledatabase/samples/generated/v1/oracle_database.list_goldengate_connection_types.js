...
function main(parent) {
  // [START oracledatabase_v1_generated_OracleDatabase_ListGoldengateConnectionTypes_async]
  /**
  ...
  async function callListGoldengateConnectionTypes() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = oracledatabaseClient.listGoldengateConnectionTypesAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListGoldengateConnectionTypes();
  // [END oracledatabase_v1_generated_OracleDatabase_ListGoldengateConnectionTypes_async]
}
