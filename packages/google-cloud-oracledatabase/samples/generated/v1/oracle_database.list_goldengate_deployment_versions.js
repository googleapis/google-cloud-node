...
function main(parent) {
  // [START oracledatabase_v1_generated_OracleDatabase_ListGoldengateDeploymentVersions_async]
  /**
  ...
  async function callListGoldengateDeploymentVersions() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = oracledatabaseClient.listGoldengateDeploymentVersionsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListGoldengateDeploymentVersions();
  // [END oracledatabase_v1_generated_OracleDatabase_ListGoldengateDeploymentVersions_async]
}
