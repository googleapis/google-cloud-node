...
function main(parent) {
  // [START oracledatabase_v1_generated_OracleDatabase_ListExascaleDbStorageVaults_async]
  /**
  ...
  async function callListExascaleDbStorageVaults() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = oracledatabaseClient.listExascaleDbStorageVaultsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListExascaleDbStorageVaults();
  // [END oracledatabase_v1_generated_OracleDatabase_ListExascaleDbStorageVaults_async]
}
