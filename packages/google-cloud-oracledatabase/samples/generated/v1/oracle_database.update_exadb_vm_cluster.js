...
function main(exadbVmCluster) {
  ...
  async function callUpdateExadbVmCluster() {
    // Construct request
    const request = {
      exadbVmCluster,
    };
    ...
    // Run request
    const [operation] = await oracledatabaseClient.updateExadbVmCluster(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callUpdateExadbVmCluster();
