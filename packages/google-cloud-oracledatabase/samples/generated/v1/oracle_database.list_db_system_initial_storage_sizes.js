...
function main(parent) {
  ...
  async function callListDbSystemInitialStorageSizes() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = oracledatabaseClient.listDbSystemInitialStorageSizesAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListDbSystemInitialStorageSizes();
