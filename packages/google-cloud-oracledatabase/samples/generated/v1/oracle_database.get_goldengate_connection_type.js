...
function main(name) {
  ...
  async function callGetGoldengateConnectionType() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await oracledatabaseClient.getGoldengateConnectionType(request);
    console.log(response);
  }

  callGetGoldengateConnectionType();
