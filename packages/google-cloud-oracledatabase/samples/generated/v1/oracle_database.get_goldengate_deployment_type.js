...
function main(name) {
  ...
  async function callGetGoldengateDeploymentType() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await oracledatabaseClient.getGoldengateDeploymentType(request);
    console.log(response);
  }

  callGetGoldengateDeploymentType();
  // [END oracledatabase_v1_generated_OracleDatabase_GetGoldengateDeploymentType_async]
}
