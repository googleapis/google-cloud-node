...
function main(parent) {
  // [START oracledatabase_v1_generated_OracleDatabase_ListExadbVmClusters_async]
  /**
  ...
  async function callListExadbVmClusters() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = oracledatabaseClient.listExadbVmClustersAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListExadbVmClusters();
  // [END oracledatabase_v1_generated_OracleDatabase_ListExadbVmClusters_async]
}
