...
function main(name, peerAutonomousDatabase) {
  ...
  async function callFailoverAutonomousDatabase() {
    // Construct request
    const request = {
      name,
    ...
    // Run request
    const [operation] = await oracledatabaseClient.failoverAutonomousDatabase(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callFailoverAutonomousDatabase();
