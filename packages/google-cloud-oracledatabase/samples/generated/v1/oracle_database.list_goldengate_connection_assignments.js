...
function main(parent) {
  ...
  async function callListGoldengateConnectionAssignments() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = oracledatabaseClient.listGoldengateConnectionAssignmentsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListGoldengateConnectionAssignments();
