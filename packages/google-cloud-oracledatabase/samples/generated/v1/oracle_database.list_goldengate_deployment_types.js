...
function main(parent) {
  // [START oracledatabase_v1_generated_OracleDatabase_ListGoldengateDeploymentTypes_async]
  /**
  ...
  async function callListGoldengateDeploymentTypes() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = oracledatabaseClient.listGoldengateDeploymentTypesAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListGoldengateDeploymentTypes();
  // [END oracledatabase_v1_generated_OracleDatabase_ListGoldengateDeploymentTypes_async]
}
