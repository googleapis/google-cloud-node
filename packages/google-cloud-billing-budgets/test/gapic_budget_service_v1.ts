  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          budgetserviceModule.v1.BudgetServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          budgetserviceModule.v1.BudgetServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'billingbudgets.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new budgetserviceModule.v1.BudgetServiceClient({
          universe_domain: 'example.com',
