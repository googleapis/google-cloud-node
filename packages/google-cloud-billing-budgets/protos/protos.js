...
(function(global, factory) { /* global define, require, module */
    ...
    var $root = $protobuf.roots._google_cloud_billing_budgets_1_3_0_protos || ($protobuf.roots._google_cloud_billing_budgets_1_3_0_protos = {});
    ...
    $root.google = (function() {
        ...
        google.cloud = (function() {
            ...
            cloud.billing = (function() {
                ...
                billing.budgets = (function() {
    
                    /**
                     * Namespace budgets.
                     * @memberof google.cloud.billing
                     * @namespace
                     */
                    var budgets = {};
                    ...
                    budgets.v1beta1 = (function() {
                        ...
                        v1beta1.Budget = (function() {
                             ...
                             */
                            Budget.decode = function decode(reader, length) {
                        ...
                        v1beta1.BudgetAmount = (function() {
                             ...
                             * @throws {$protobuf.util.ProtocolError} If required fields are missing
                             */
                            BudgetAmount.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                        ...
                        v1beta1.LastPeriodAmount = (function() {
                             ...
                             * @throws {$protobuf.util.ProtocolError} If required fields are missing
                             */
                            LastPeriodAmount.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                        ...
                        v1beta1.ThresholdRule = (function() {
                             ...
                             * @throws {$protobuf.util.ProtocolError} If required fields are missing
                             */
                            ThresholdRule.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                        ...
                        v1beta1.AllUpdatesRule = (function() {
                             ...
                             * @throws {$protobuf.util.ProtocolError} If required fields are missing
                             */
                            AllUpdatesRule.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                        ...
                        v1beta1.Filter = (function() {
                            ...
                            Filter.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.google.cloud.billing.budgets.v1beta1.Filter(), key;
                                while (reader.pos < end) {
                                    var tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                                    ...
                                    case 6:
                                        ...
                                        key = reader.string();
                                        reader.pos++;
                                        message.labels[key] = $root.google.protobuf.ListValue.decode(reader, reader.uint32());
                                        break;
                                    default:
                                        reader.skipType(tag & 7);
                                        break;
                        ...
                        v1beta1.CreateBudgetRequest = (function() {
                             ...
                             * @throws {$protobuf.util.ProtocolError} If required fields are missing
                             */
                            CreateBudgetRequest.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                        ...
                        v1beta1.UpdateBudgetRequest = (function() {
                             ...
                             * @throws {$protobuf.util.ProtocolError} If required fields are missing
                             */
                            UpdateBudgetRequest.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                        ...
                        v1beta1.GetBudgetRequest = (function() {
                             ...
                             * @throws {$protobuf.util.ProtocolError} If required fields are missing
                             */
                            GetBudgetRequest.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                        ...
                        v1beta1.ListBudgetsRequest = (function() {
                             ...
                             * @throws {$protobuf.util.ProtocolError} If required fields are missing
                             */
                            ListBudgetsRequest.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                        ...
                        v1beta1.ListBudgetsResponse = (function() {
                             ...
                             * @throws {$protobuf.util.ProtocolError} If required fields are missing
                             */
                            ListBudgetsResponse.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                        ...
                        v1beta1.DeleteBudgetRequest = (function() {
                             ...
                             * @throws {$protobuf.util.ProtocolError} If required fields are missing
                             */
                            DeleteBudgetRequest.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
