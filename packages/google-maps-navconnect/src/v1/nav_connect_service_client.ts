 ...
 * `src/v1/nav_connect_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './nav_connect_service_client_config.json';
 ...
 * @memberof v1
 */
export class NavConnectServiceClient {
 ...
 */
  ...
  /**
   * Parse the project from Trip resource.
   *
   * @param {string} tripName
   *   A fully-qualified path representing Trip resource.
   * @returns {string} A string representing the project.
   */
  matchProjectFromTripName(tripName: string) {
    return this.pathTemplates.tripPathTemplate.match(tripName).project;
  }
