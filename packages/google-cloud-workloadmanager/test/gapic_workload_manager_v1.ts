...
describe('v1.WorkloadManagerClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          workloadmanagerModule.v1.WorkloadManagerClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          workloadmanagerModule.v1.WorkloadManagerClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'workloadmanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        ...
        it('value configured in code has priority over environment variable', () => {
          ...
          assert.strictEqual(
            servicePath,
            'workloadmanager.configured.example.com',
          );
          if (saved) {
            process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = saved;
          } else {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new workloadmanagerModule.v1.WorkloadManagerClient({
          universe_domain: 'example.com',
    ...
    it('invokes getEvaluation without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getEvaluation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.workloadmanager.v1.IEvaluation | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getExecution without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getExecution(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.workloadmanager.v1.IExecution | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listRules without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listRules(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.workloadmanager.v1.IListRulesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('updateEvaluation', () => {
    it('invokes updateEvaluation without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateEvaluation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateEvaluation as SinonStub
    ...
    it('invokes updateEvaluation with call error', async () => {
      ...
      const expectedHeaderRequestParams = `evaluation.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateEvaluation = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkUpdateEvaluationProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateEvaluationProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteEvaluation', () => {
    it('invokes deleteEvaluation without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteEvaluation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteEvaluation as SinonStub
    ...
    it('invokes deleteEvaluation with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteEvaluation = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkDeleteEvaluationProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteEvaluationProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('runEvaluation', () => {
    it('invokes runEvaluation without error', async () => {
      ...
      client.innerApiCalls.runEvaluation =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.runEvaluation(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.runEvaluation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.runEvaluation as SinonStub
    ...
    it('invokes runEvaluation with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.runEvaluation = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkRunEvaluationProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkRunEvaluationProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listEvaluations', () => {
    ...
    it('invokes listEvaluationsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.workloadmanager.v1.Evaluation) => {
  ...
  describe('listExecutions', () => {
    ...
    it('invokes listExecutionsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.workloadmanager.v1.Execution) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listExecutionResults', () => {
    it('invokes listExecutionResults without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.workloadmanager.v1.ExecutionResult(),
        ),
        generateSampleMessage(
          new protos.google.cloud.workloadmanager.v1.ExecutionResult(),
        ),
      ...
      client.innerApiCalls.listExecutionResults =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listExecutionResults(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listExecutionResults as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listExecutionResults as SinonStub
    ...
    it('invokes listExecutionResults with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listExecutionResults = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listExecutionResultsStream without error', async () => {
      ...
      client.descriptors.page.listExecutionResults.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.workloadmanager.v1.ExecutionResult,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (client.descriptors.page.listExecutionResults.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listExecutionResults, request),
      );
      assert(
        (client.descriptors.page.listExecutionResults.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listExecutionResults without error', async () => {
      ...
      client.descriptors.page.listExecutionResults.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listScannedResources', () => {
    it('invokes listScannedResources without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.workloadmanager.v1.ScannedResource(),
        ),
        generateSampleMessage(
          new protos.google.cloud.workloadmanager.v1.ScannedResource(),
        ),
      ...
      client.innerApiCalls.listScannedResources =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listScannedResources(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listScannedResources as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listScannedResources as SinonStub
    ...
    it('invokes listScannedResources with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listScannedResources = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listScannedResourcesStream without error', async () => {
      ...
      client.descriptors.page.listScannedResources.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.workloadmanager.v1.ScannedResource,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (client.descriptors.page.listScannedResources.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listScannedResources, request),
      );
      assert(
        (client.descriptors.page.listScannedResources.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listScannedResources without error', async () => {
      ...
      client.descriptors.page.listScannedResources.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
