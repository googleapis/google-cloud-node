...
function main(name) {
  // [START health_v4_generated_HealthProfileService_GetIrnProfile_async]
  /**
  ...
  async function callGetIrnProfile() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await healthClient.getIrnProfile(request);
    console.log(response);
  }

  callGetIrnProfile();
  // [END health_v4_generated_HealthProfileService_GetIrnProfile_async]
}
