...
function main(parent) {
  // [START health_v4_generated_HealthProfileService_ListPairedDevices_async]
  /**
  ...
  const {HealthProfileServiceClient} = require('@google-cloud/health').v4;

  // Instantiates a client
  const healthClient = new HealthProfileServiceClient();

  async function callListPairedDevices() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = healthClient.listPairedDevicesAsync(request);
  ...
  // [END health_v4_generated_HealthProfileService_ListPairedDevices_async]
}
