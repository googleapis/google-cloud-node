...
function main(parent, range) {
  ...
  async function callDailyRollUpDataPoints() {
    // Construct request
    const request = {
      parent,
      range,
    ...
    // Run request
    const response = await healthClient.dailyRollUpDataPoints(request);
    console.log(response);
  }

  callDailyRollUpDataPoints();
