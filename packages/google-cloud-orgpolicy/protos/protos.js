                ...
                orgpolicy.v2 = (function() {
                    ...
                    v2.Constraint = (function() {
                        ...
                        Constraint.toObject = function toObject(message, options) {
                            ...
                            if (message.constraintDefault != null && message.hasOwnProperty("constraintDefault"))
                                object.constraintDefault = options.enums === String ? $root.google.cloud.orgpolicy.v2.Constraint.ConstraintDefault[message.constraintDefault] : message.constraintDefault;
                            if (message.listConstraint != null && message.hasOwnProperty("listConstraint")) {
