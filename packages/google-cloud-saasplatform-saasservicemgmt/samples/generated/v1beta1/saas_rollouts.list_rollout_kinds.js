...
function main(parent) {
  // [START saasservicemgmt_v1beta1_generated_SaasRollouts_ListRolloutKinds_async]
  /**
  ...
  async function callListRolloutKinds() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = saasservicemgmtClient.listRolloutKindsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListRolloutKinds();
