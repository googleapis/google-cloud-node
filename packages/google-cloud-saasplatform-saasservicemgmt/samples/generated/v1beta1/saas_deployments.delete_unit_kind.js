...
function main(name) {
  // [START saasservicemgmt_v1beta1_generated_SaasDeployments_DeleteUnitKind_async]
  /**
  ...
  async function callDeleteUnitKind() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await saasservicemgmtClient.deleteUnitKind(request);
    console.log(response);
  }

  callDeleteUnitKind();
  // [END saasservicemgmt_v1beta1_generated_SaasDeployments_DeleteUnitKind_async]
}
