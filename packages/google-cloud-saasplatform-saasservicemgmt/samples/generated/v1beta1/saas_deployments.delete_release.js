...
function main(name) {
  // [START saasservicemgmt_v1beta1_generated_SaasDeployments_DeleteRelease_async]
  /**
  ...
  async function callDeleteRelease() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await saasservicemgmtClient.deleteRelease(request);
    console.log(response);
  }

  callDeleteRelease();
  // [END saasservicemgmt_v1beta1_generated_SaasDeployments_DeleteRelease_async]
}
