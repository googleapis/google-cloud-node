...
function main(parent, rolloutId, rollout) {
  // [START saasservicemgmt_v1beta1_generated_SaasRollouts_CreateRollout_async]
  /**
  ...
  async function callCreateRollout() {
    ...
    // Run request
    const response = await saasservicemgmtClient.createRollout(request);
    console.log(response);
  }

  callCreateRollout();
  // [END saasservicemgmt_v1beta1_generated_SaasRollouts_CreateRollout_async]
}
