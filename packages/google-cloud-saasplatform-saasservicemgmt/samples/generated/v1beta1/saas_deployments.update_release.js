...
function main(release) {
  // [START saasservicemgmt_v1beta1_generated_SaasDeployments_UpdateRelease_async]
  /**
  ...
  async function callUpdateRelease() {
    ...
    // Run request
    const response = await saasservicemgmtClient.updateRelease(request);
    console.log(response);
  }

  callUpdateRelease();
  // [END saasservicemgmt_v1beta1_generated_SaasDeployments_UpdateRelease_async]
}
