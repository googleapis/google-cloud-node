...
function main(name) {
  // [START saasservicemgmt_v1beta1_generated_SaasRollouts_GetRolloutKind_async]
  /**
  ...
  async function callGetRolloutKind() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await saasservicemgmtClient.getRolloutKind(request);
