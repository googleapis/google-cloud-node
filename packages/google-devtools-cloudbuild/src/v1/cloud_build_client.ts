...
export class CloudBuildClient {
    ...
    let routingParameter = {};
    {
      ...
      if (fieldValue !== undefined && fieldValue !== null) {
        const match = fieldValue
          ...
          .match(
            RegExp(
              'projects/[^/]+/locations/(?<location>[^/]+)/triggers/[^/]+',
            ),
          );
        if (match) {
          const parameterValue = match.groups?.['location'] ?? fieldValue;
  ...
  getDefaultServiceAccount(
    ...
    [
      ...
      (
        | protos.google.devtools.cloudbuild.v1.IGetDefaultServiceAccountRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    let routingParameter = {};
    {
      ...
      if (fieldValue !== undefined && fieldValue !== null) {
        const match = fieldValue
          ...
          .match(
            RegExp(
              'projects/[^/]+/locations/(?<location>[^/]+)/defaultServiceAccount',
            ),
          );
        if (match) {
          const parameterValue = match.groups?.['location'] ?? fieldValue;
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .getDefaultServiceAccount(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.devtools.cloudbuild.v1.IDefaultServiceAccount,
          (
  ...
  matchProjectFromDefaultServiceAccountName(defaultServiceAccountName: string) {
    return this.pathTemplates.defaultServiceAccountPathTemplate.match(
   ...
   * @returns {string} A string representing the location.
   */
  matchLocationFromDefaultServiceAccountName(
  ...
  matchProjectFromProjectBuildsName(projectBuildsName: string) {
    return this.pathTemplates.projectBuildsPathTemplate.match(projectBuildsName)
      .project;
  }
  ...
  matchProjectFromProjectLocationBuildsName(projectLocationBuildsName: string) {
    return this.pathTemplates.projectLocationBuildsPathTemplate.match(
      projectLocationBuildsName,
    ).project;
  }
   ...
   * @returns {string} A string representing the location.
   */
  matchLocationFromProjectLocationBuildsName(
    projectLocationBuildsName: string,
  ) {
    return this.pathTemplates.projectLocationBuildsPathTemplate.match(
      projectLocationBuildsName,
    ).location;
   ...
   * @returns {string} A string representing the project.
   */
  matchProjectFromProjectLocationTriggersName(
    projectLocationTriggersName: string,
  ) {
    return this.pathTemplates.projectLocationTriggersPathTemplate.match(
      projectLocationTriggersName,
    ).project;
  }
   ...
   * @returns {string} A string representing the location.
   */
  matchLocationFromProjectLocationTriggersName(
    projectLocationTriggersName: string,
  ) {
    return this.pathTemplates.projectLocationTriggersPathTemplate.match(
      projectLocationTriggersName,
   ...
   */
  matchTriggerFromProjectLocationTriggersName(
    projectLocationTriggersName: string,
  ) {
    return this.pathTemplates.projectLocationTriggersPathTemplate.match(
      projectLocationTriggersName,
  ...
  matchProjectFromProjectTriggersName(projectTriggersName: string) {
    return this.pathTemplates.projectTriggersPathTemplate.match(
      projectTriggersName,
    ).project;
  }
