...
describe('v1.CloudBuildClient', () => {
  ...
  describe('getDefaultServiceAccount', () => {
    it('invokes getDefaultServiceAccount without error', async () => {
      ...
      client.innerApiCalls.getDefaultServiceAccount =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getDefaultServiceAccount(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getDefaultServiceAccount as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getDefaultServiceAccount as SinonStub
    ...
    it('invokes getDefaultServiceAccount without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDefaultServiceAccount(
          ...
          (
            err?: Error | null,
            result?: protos.google.devtools.cloudbuild.v1.IDefaultServiceAccount | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getDefaultServiceAccount with error', async () => {
      ...
      const expectedHeaderRequestParams = 'location=value';
      const expectedError = new Error('expected');
      client.innerApiCalls.getDefaultServiceAccount = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getDefaultServiceAccount(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getDefaultServiceAccount as SinonStub
  ...
  describe('Path templates', () => {
    ...
    describe('defaultServiceAccount', async () => {
      ...
      await client.initialize();
      client.pathTemplates.defaultServiceAccountPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.defaultServiceAccountPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('defaultServiceAccountPath', () => {
        const result = client.defaultServiceAccountPath(
          'projectValue',
          'locationValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.defaultServiceAccountPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromDefaultServiceAccountName', () => {
        const result =
          client.matchProjectFromDefaultServiceAccountName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.defaultServiceAccountPathTemplate
      ...
      it('matchLocationFromDefaultServiceAccountName', () => {
        const result =
          client.matchLocationFromDefaultServiceAccountName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.defaultServiceAccountPathTemplate
    ...
    describe('projectBuilds', async () => {
      ...
      await client.initialize();
      client.pathTemplates.projectBuildsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.projectBuildsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);
      ...
      it('projectBuildsPath', () => {
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.projectBuildsPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromProjectBuildsName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.projectBuildsPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('projectLocationBuilds', async () => {
      ...
      await client.initialize();
      client.pathTemplates.projectLocationBuildsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.projectLocationBuildsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('projectLocationBuildsPath', () => {
        const result = client.projectLocationBuildsPath(
          'projectValue',
          'locationValue',
          'buildValue',
        );
        ...
        assert(
          (
            client.pathTemplates.projectLocationBuildsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromProjectLocationBuildsName', () => {
        const result =
          client.matchProjectFromProjectLocationBuildsName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.projectLocationBuildsPathTemplate
      ...
      it('matchLocationFromProjectLocationBuildsName', () => {
        const result =
          client.matchLocationFromProjectLocationBuildsName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.projectLocationBuildsPathTemplate
    ...
    describe('projectLocationTriggers', async () => {
      ...
      await client.initialize();
      client.pathTemplates.projectLocationTriggersPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.projectLocationTriggersPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('projectLocationTriggersPath', () => {
        const result = client.projectLocationTriggersPath(
          'projectValue',
          'locationValue',
          'triggerValue',
        );
        ...
        assert(
          (
            client.pathTemplates.projectLocationTriggersPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromProjectLocationTriggersName', () => {
        const result =
          client.matchProjectFromProjectLocationTriggersName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.projectLocationTriggersPathTemplate
      ...
      it('matchLocationFromProjectLocationTriggersName', () => {
        const result =
          client.matchLocationFromProjectLocationTriggersName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.projectLocationTriggersPathTemplate
      ...
      it('matchTriggerFromProjectLocationTriggersName', () => {
        const result =
          client.matchTriggerFromProjectLocationTriggersName(fakePath);
    ...
    describe('projectTriggers', async () => {
      ...
      await client.initialize();
      client.pathTemplates.projectTriggersPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.projectTriggersPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('projectTriggersPath', () => {
        const result = client.projectTriggersPath(
          'projectValue',
          'triggerValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.projectTriggersPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromProjectTriggersName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.projectTriggersPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
