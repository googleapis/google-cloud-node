...
export class JobServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    // pass `{fallback: true}` to the JobServiceClient constructor.
  ...
  /**
   * Check the status of the long running operation returned by the batchCreateJobs() method.
   * @param {String} name
  ...
  /**
   * Check the status of the long running operation returned by the batchUpdateJobs() method.
   * @param {String} name
   *   The operation name that will be passed.
   * @returns {Promise} - The promise which resolves to an object.
   *   The decoded operation object has result and metadata field to get information from.
