 ...
 *   application.
 *
 *   This object should have the same structure as [ApplicationLastStageFilter]{@link google.cloud.talent.v4beta1.ApplicationLastStageFilter}
 *
 ...
 *
 * @property {Object[]} applicationStatusFilters
 *   Optional.
 *
 *   The application status filters specify the status of job application.
 *
 *   This object should have the same structure as [ApplicationStatusFilter]{@link google.cloud.talent.v4beta1.ApplicationStatusFilter}
 *
 * @property {string} customFieldFilter
 *   Optional.
 *
 *   This filter specifies a structured syntax to match against the
 ...
 *   JobApplication.last_stage in profiles.
 *
 * @property {boolean} negated
 *   Optional.
 *   If true, The API excludes all candidates with any
 ...
 * @memberof google.cloud.talent.v4beta1
 * @see [google.cloud.talent.v4beta1.ApplicationLastStageFilter definition in proto format]{@link https://github.com/googleapis/googleapis/blob/master/google/cloud/talent/v4beta1/filters.proto}
 */
const ApplicationLastStageFilter = {
  // This is for documentation. Actual contents will be loaded by gRPC.
};
 ...
 *   the Job.name of JobApplication.job in profiles.
 *
 * @property {string} jobRequisitionId
 *   Optional.
 *
 *   The job requisition id in the application. The API does an exact match on
 *   the Job.requisistion_id of JobApplication.job in profiles.
 *
 * @property {string} jobTitle
 *   Optional.
 *
 *   The job title in the application. The API does an exact match on the
 *   Job.title of JobApplication.job in profiles.
 *
 * @property {boolean} negated
 *   Optional.
 *
 *   If true, the API excludes all profiles with any JobApplication.job
 ...
 * @memberof google.cloud.talent.v4beta1
 * @see [google.cloud.talent.v4beta1.ApplicationStatusFilter definition in proto format]{@link https://github.com/googleapis/googleapis/blob/master/google/cloud/talent/v4beta1/filters.proto}
 */
