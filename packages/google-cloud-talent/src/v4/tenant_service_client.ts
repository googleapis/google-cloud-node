...
export class TenantServiceClient {
   ...
   *   The first element is Array of [Tenant]{@link google.cloud.talent.v4.Tenant} that corresponds to
   *   the one page received from the API server.
   *   If the second element is not null it contains the request object of type [ListTenantsRequest]{@link google.cloud.talent.v4.ListTenantsRequest}
   *   that can be used to obtain the next page of the results.
   *   If it is null, the next page does not exist.
   *   The third element contains the raw response received from the API server. Its type is
   *   [ListTenantsResponse]{@link google.cloud.talent.v4.ListTenantsResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   */
  listTenants(
