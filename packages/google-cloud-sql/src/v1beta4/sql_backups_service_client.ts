 ...
 * `src/v1beta4/sql_backups_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './sql_backups_service_client_config.json';
 ...
 * @memberof v1beta4
 */
export class SqlBackupsServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.sql.v1beta4.SqlBackupsService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.sqlBackupsServiceStub) {
      return this.sqlBackupsServiceStub;
    }
    ...
    this.sqlBackupsServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.sql.v1beta4.SqlBackupsService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.sql.v1beta4.SqlBackupsService,
 ...
 */
  createBackup(
      request?: protos.google.cloud.sql.v1beta4.ICreateBackupRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.sql.v1beta4.IOperation,
        protos.google.cloud.sql.v1beta4.ICreateBackupRequest|undefined, {}|undefined
      ]>;
  createBackup(
      request: protos.google.cloud.sql.v1beta4.ICreateBackupRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.sql.v1beta4.IOperation,
          protos.google.cloud.sql.v1beta4.ICreateBackupRequest|null|undefined,
          {}|null|undefined>): void;
  createBackup(
      request: protos.google.cloud.sql.v1beta4.ICreateBackupRequest,
      callback: Callback<
 ...
 */
  getBackup(
      request?: protos.google.cloud.sql.v1beta4.IGetBackupRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.sql.v1beta4.IBackup,
        protos.google.cloud.sql.v1beta4.IGetBackupRequest|undefined, {}|undefined
      ]>;
  getBackup(
      request: protos.google.cloud.sql.v1beta4.IGetBackupRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.sql.v1beta4.IBackup,
          protos.google.cloud.sql.v1beta4.IGetBackupRequest|null|undefined,
          {}|null|undefined>): void;
  getBackup(
      request: protos.google.cloud.sql.v1beta4.IGetBackupRequest,
      callback: Callback<
 ...
 */
  updateBackup(
      request?: protos.google.cloud.sql.v1beta4.IUpdateBackupRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.sql.v1beta4.IOperation,
        protos.google.cloud.sql.v1beta4.IUpdateBackupRequest|undefined, {}|undefined
      ]>;
  updateBackup(
      request: protos.google.cloud.sql.v1beta4.IUpdateBackupRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.sql.v1beta4.IOperation,
          protos.google.cloud.sql.v1beta4.IUpdateBackupRequest|null|undefined,
          {}|null|undefined>): void;
  updateBackup(
      request: protos.google.cloud.sql.v1beta4.IUpdateBackupRequest,
      callback: Callback<
 ...
 */
  deleteBackup(
      request?: protos.google.cloud.sql.v1beta4.IDeleteBackupRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.sql.v1beta4.IOperation,
        protos.google.cloud.sql.v1beta4.IDeleteBackupRequest|undefined, {}|undefined
      ]>;
  deleteBackup(
      request: protos.google.cloud.sql.v1beta4.IDeleteBackupRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.sql.v1beta4.IOperation,
          protos.google.cloud.sql.v1beta4.IDeleteBackupRequest|null|undefined,
          {}|null|undefined>): void;
  deleteBackup(
      request: protos.google.cloud.sql.v1beta4.IDeleteBackupRequest,
      callback: Callback<
 ...
 */
  listBackups(
      request?: protos.google.cloud.sql.v1beta4.IListBackupsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.sql.v1beta4.IBackup[],
  ...
  listBackups(
      ...
      callback: PaginationCallback<
          protos.google.cloud.sql.v1beta4.IListBackupsRequest,
          protos.google.cloud.sql.v1beta4.IListBackupsResponse|null|undefined,
          protos.google.cloud.sql.v1beta4.IBackup>): void;
  listBackups(
      request: protos.google.cloud.sql.v1beta4.IListBackupsRequest,
      callback: PaginationCallback<
          protos.google.cloud.sql.v1beta4.IListBackupsRequest,
  ...
  listBackups(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.sql.v1beta4.IListBackupsRequest,
      protos.google.cloud.sql.v1beta4.IListBackupsResponse|null|undefined,
      protos.google.cloud.sql.v1beta4.IBackup>|undefined = callback
 ...
 */
  listBackupsAsync(
      request?: protos.google.cloud.sql.v1beta4.IListBackupsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.sql.v1beta4.IBackup>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listBackups.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.sql.v1beta4.IBackup>;
  }
/**
