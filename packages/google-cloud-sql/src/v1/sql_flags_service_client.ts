 ...
 * `src/v1/sql_flags_service_client_config.json`.
...
export class SqlFlagsServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.sql.v1.SqlFlagsService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.sqlFlagsServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.sql.v1.SqlFlagsService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.sql.v1.SqlFlagsService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const sqlFlagsServiceStubMethods =
        ['list'];
 ...
 * @param {google.cloud.sql.v1.SqlFlagScope} [request.flagScope]
 ...
 *   The first element of the array is an object representing {@link protos.google.cloud.sql.v1.FlagsListResponse|FlagsListResponse}.
 ...
 */
  list(
      ...
      Promise<[
        ...
        protos.google.cloud.sql.v1.ISqlFlagsListRequest|undefined, {}|undefined
      ]>;
  list(
      request: protos.google.cloud.sql.v1.ISqlFlagsListRequest,
      options: CallOptions,
  ...
  list(
    ...
    return this.innerApiCalls.list(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.sql.v1.IFlagsListResponse,
        protos.google.cloud.sql.v1.ISqlFlagsListRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('list response %j', response);
