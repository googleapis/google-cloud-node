...
export {v1, v1beta4, SqlAvailableDatabaseVersionsServiceClient, SqlBackupRunsServiceClient, SqlBackupsServiceClient, SqlConnectServiceClient, SqlDatabasesServiceClient, SqlEventsServiceClient, SqlFeatureEligibilityServiceClient, SqlFlagsServiceClient, SqlIamPoliciesServiceClient, SqlInstanceNamesServiceClient, SqlInstancesServiceClient, SqlOperationsServiceClient, SqlRegionsServiceClient, SqlSslCertsServiceClient, SqlTiersServiceClient, SqlUsersServiceClient};
export default {v1, v1beta4, SqlAvailableDatabaseVersionsServiceClient, SqlBackupRunsServiceClient, SqlBackupsServiceClient, SqlConnectServiceClient, SqlDatabasesServiceClient, SqlEventsServiceClient, SqlFeatureEligibilityServiceClient, SqlFlagsServiceClient, SqlIamPoliciesServiceClient, SqlInstanceNamesServiceClient, SqlInstancesServiceClient, SqlOperationsServiceClient, SqlRegionsServiceClient, SqlSslCertsServiceClient, SqlTiersServiceClient, SqlUsersServiceClient};
