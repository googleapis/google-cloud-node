...
export {v1, v1beta4, SqlAvailableDatabaseVersionsServiceClient, SqlBackupRunsServiceClient, SqlConnectServiceClient, SqlDatabasesServiceClient, SqlEventsServiceClient, SqlFlagsServiceClient, SqlIamPoliciesServiceClient, SqlInstanceNamesServiceClient, SqlInstancesServiceClient, SqlOperationsServiceClient, SqlRegionsServiceClient, SqlSslCertsServiceClient, SqlTiersServiceClient, SqlUsersServiceClient};
export default {v1, v1beta4, SqlAvailableDatabaseVersionsServiceClient, SqlBackupRunsServiceClient, SqlConnectServiceClient, SqlDatabasesServiceClient, SqlEventsServiceClient, SqlFlagsServiceClient, SqlIamPoliciesServiceClient, SqlInstanceNamesServiceClient, SqlInstancesServiceClient, SqlOperationsServiceClient, SqlRegionsServiceClient, SqlSslCertsServiceClient, SqlTiersServiceClient, SqlUsersServiceClient};
