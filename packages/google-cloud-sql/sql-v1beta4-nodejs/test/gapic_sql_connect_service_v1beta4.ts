...
describe('v1beta4.SqlConnectServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new sqlconnectserviceModule.v1beta4.SqlConnectServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = sqlconnectserviceModule.v1beta4.SqlConnectServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = sqlconnectserviceModule.v1beta4.SqlConnectServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'sqladmin.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new sqlconnectserviceModule.v1beta4.SqlConnectServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'sqladmin.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new sqlconnectserviceModule.v1beta4.SqlConnectServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'sqladmin.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new sqlconnectserviceModule.v1beta4.SqlConnectServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new sqlconnectserviceModule.v1beta4.SqlConnectServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getConnectSettings', () => {
        it('invokes getConnectSettings without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.sql.v1beta4.GetConnectSettingsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1beta4.GetConnectSettingsRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.sql.v1beta4.GetConnectSettingsRequest', ['instance']);
        ...
        it('invokes getConnectSettings without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getConnectSettings(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.sql.v1beta4.IConnectSettings|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateEphemeralCert', () => {
        it('invokes generateEphemeralCert without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.sql.v1beta4.GenerateEphemeralCertRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1beta4.GenerateEphemeralCertRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.sql.v1beta4.GenerateEphemeralCertRequest', ['instance']);
            request.instance = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&instance=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes generateEphemeralCert without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateEphemeralCert(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.sql.v1beta4.IGenerateEphemeralCertResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
