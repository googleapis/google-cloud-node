...
describe('v1.SqlBackupsServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          sqlbackupsserviceModule.v1.SqlBackupsServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          sqlbackupsserviceModule.v1.SqlBackupsServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'sqladmin.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new sqlbackupsserviceModule.v1.SqlBackupsServiceClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'sqladmin.example.com');
          if (saved) {
  ...
  describe('createBackup', () => {
    ...
    it('invokes createBackup with error', async () => {
      ...
      client.innerApiCalls.createBackup = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes getBackup without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getBackup(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.sql.v1.IBackup | null,
          ) => {
            if (err) {
              reject(err);
            } else {
