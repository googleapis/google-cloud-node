...
describe('v1.SqlBackupsServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = sqlbackupsserviceModule.v1.SqlBackupsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = sqlbackupsserviceModule.v1.SqlBackupsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'sqladmin.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new sqlbackupsserviceModule.v1.SqlBackupsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'sqladmin.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new sqlbackupsserviceModule.v1.SqlBackupsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'sqladmin.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new sqlbackupsserviceModule.v1.SqlBackupsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new sqlbackupsserviceModule.v1.SqlBackupsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = sqlbackupsserviceModule.v1.SqlBackupsServiceClient.port;
            assert(port);
    ...
    describe('createBackup', () => {
        it('invokes createBackup without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.sql.v1.CreateBackupRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1.CreateBackupRequest', ['parent']);
    ...
    describe('getBackup', () => {
        it('invokes getBackup without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.sql.v1.GetBackupRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1.GetBackupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.sql.v1.Backup()
            );
        ...
        it('invokes getBackup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getBackup(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.sql.v1.IBackup|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateBackup', () => {
        it('invokes updateBackup without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.sql.v1.UpdateBackupRequest()
            );
            request.backup ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1.UpdateBackupRequest', ['backup', 'name']);
    ...
    describe('deleteBackup', () => {
        it('invokes deleteBackup without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.sql.v1.DeleteBackupRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1.DeleteBackupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.sql.v1.Operation()
    ...
    describe('listBackups', () => {
        it('invokes listBackups without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.sql.v1.ListBackupsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.sql.v1.ListBackupsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.sql.v1.Backup()),
              generateSampleMessage(new protos.google.cloud.sql.v1.Backup()),
              generateSampleMessage(new protos.google.cloud.sql.v1.Backup()),
            ];
        ...
        it('invokes listBackupsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.sql.v1.Backup[] = [];
                stream.on('data', (response: protos.google.cloud.sql.v1.Backup) => {
        ...
        it('uses async iteration with listBackups without error', async () => {
            ...
            const responses: protos.google.cloud.sql.v1.IBackup[] = [];
