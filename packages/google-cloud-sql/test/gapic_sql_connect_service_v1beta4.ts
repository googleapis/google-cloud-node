...
describe('v1beta4.SqlConnectServiceClient', () => {
    ...
    it('invokes getConnectSettings without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getConnectSettings(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.sql.v1beta4.IConnectSettings | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('resolveConnectSettings', () => {
    it('invokes resolveConnectSettings without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.sql.v1beta4.ResolveConnectSettingsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.sql.v1beta4.ResolveConnectSettingsRequest',
        ['location'],
      );
    ...
    it('invokes generateEphemeralCert without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.generateEphemeralCert(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.sql.v1beta4.IGenerateEphemeralCertResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
