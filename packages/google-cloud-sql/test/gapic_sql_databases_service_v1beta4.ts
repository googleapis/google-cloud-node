...
describe('v1beta4.SqlDatabasesServiceClient', () => {
  describe('Common methods', () => {
    it('has servicePath', () => {
      const servicePath =
        sqldatabasesserviceModule.v1beta4.SqlDatabasesServiceClient.servicePath;
      assert(servicePath);
    });

    it('has apiEndpoint', () => {
      const apiEndpoint =
        sqldatabasesserviceModule.v1beta4.SqlDatabasesServiceClient.apiEndpoint;
      assert(apiEndpoint);
    });

    it('has port', () => {
      const port =
        sqldatabasesserviceModule.v1beta4.SqlDatabasesServiceClient.port;
      assert(port);
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.sql.v1beta4.IDatabase | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes list without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.list(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.sql.v1beta4.IDatabasesListResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
