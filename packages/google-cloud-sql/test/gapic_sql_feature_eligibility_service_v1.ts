  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          sqlfeatureeligibilityserviceModule.v1
            .SqlFeatureEligibilityServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        ...
        const apiEndpoint =
          sqlfeatureeligibilityserviceModule.v1
            .SqlFeatureEligibilityServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'sqladmin.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        sqlfeatureeligibilityserviceModule.v1.SqlFeatureEligibilityServiceClient
          .port;
      assert(port);
