...
function main(name) {
  // [START sqladmin_v1beta4_generated_SqlBackupsService_DeleteBackup_async]
  /**
  ...
  const {SqlBackupsServiceClient} = require('@google-cloud/sql').v1beta4;
  ...
  callDeleteBackup();
  // [END sqladmin_v1beta4_generated_SqlBackupsService_DeleteBackup_async]
}
