...
function main(name) {
  // [START merchantapi_v1_generated_LfpMerchantStateService_GetLfpMerchantState_async]
  /**
  ...
  async function callGetLfpMerchantState() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await lfpClient.getLfpMerchantState(request);
    console.log(response);
  }

  callGetLfpMerchantState();
  // [END merchantapi_v1_generated_LfpMerchantStateService_GetLfpMerchantState_async]
}
