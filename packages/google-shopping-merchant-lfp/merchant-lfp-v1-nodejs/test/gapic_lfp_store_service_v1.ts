...
describe('v1.LfpStoreServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new lfpstoreserviceModule.v1.LfpStoreServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = lfpstoreserviceModule.v1.LfpStoreServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = lfpstoreserviceModule.v1.LfpStoreServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new lfpstoreserviceModule.v1.LfpStoreServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new lfpstoreserviceModule.v1.LfpStoreServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new lfpstoreserviceModule.v1.LfpStoreServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new lfpstoreserviceModule.v1.LfpStoreServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = lfpstoreserviceModule.v1.LfpStoreServiceClient.port;
            assert(port);
    ...
    describe('getLfpStore', () => {
        it('invokes getLfpStore without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.lfp.v1.GetLfpStoreRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.lfp.v1.GetLfpStoreRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.lfp.v1.LfpStore()
            );
        ...
        it('invokes getLfpStore without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getLfpStore(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.lfp.v1.ILfpStore|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('insertLfpStore', () => {
        it('invokes insertLfpStore without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.lfp.v1.InsertLfpStoreRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.lfp.v1.InsertLfpStoreRequest', ['parent']);
    ...
    describe('deleteLfpStore', () => {
        it('invokes deleteLfpStore without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.lfp.v1.DeleteLfpStoreRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.lfp.v1.DeleteLfpStoreRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listLfpStores', () => {
        it('invokes listLfpStores without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.lfp.v1.ListLfpStoresRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.lfp.v1.ListLfpStoresRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.shopping.merchant.lfp.v1.LfpStore()),
              generateSampleMessage(new protos.google.shopping.merchant.lfp.v1.LfpStore()),
              generateSampleMessage(new protos.google.shopping.merchant.lfp.v1.LfpStore()),
            ];
        ...
        it('invokes listLfpStoresStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.shopping.merchant.lfp.v1.LfpStore[] = [];
                stream.on('data', (response: protos.google.shopping.merchant.lfp.v1.LfpStore) => {
        ...
        it('uses async iteration with listLfpStores without error', async () => {
            ...
            const responses: protos.google.shopping.merchant.lfp.v1.ILfpStore[] = [];
