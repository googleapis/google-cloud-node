 ...
 * `src/v1/lfp_sale_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './lfp_sale_service_client_config.json';
 ...
 * @memberof v1
 */
export class LfpSaleServiceClient {
  ...
  lfpSaleServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof LfpSaleServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.shopping.merchant.lfp.v1.LfpSaleService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    // google.shopping.merchant.lfp.v1.LfpSaleService.
    this.lfpSaleServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.shopping.merchant.lfp.v1.LfpSaleService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.shopping.merchant.lfp.v1.LfpSaleService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const lfpSaleServiceStubMethods =
        ['insertLfpSale'];
    for (const methodName of lfpSaleServiceStubMethods) {
      const callPromise = this.lfpSaleServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 */
  insertLfpSale(
      request?: protos.google.shopping.merchant.lfp.v1.IInsertLfpSaleRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.lfp.v1.ILfpSale,
        protos.google.shopping.merchant.lfp.v1.IInsertLfpSaleRequest|undefined, {}|undefined
      ]>;
  insertLfpSale(
      request: protos.google.shopping.merchant.lfp.v1.IInsertLfpSaleRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.lfp.v1.ILfpSale,
          protos.google.shopping.merchant.lfp.v1.IInsertLfpSaleRequest|null|undefined,
          {}|null|undefined>): void;
  insertLfpSale(
      request: protos.google.shopping.merchant.lfp.v1.IInsertLfpSaleRequest,
      callback: Callback<
  ...
  insertLfpSale(
    ...
    const wrappedCallback: Callback<
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('insertLfpSale response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.insertLfpSale(request, options, wrappedCallback)
