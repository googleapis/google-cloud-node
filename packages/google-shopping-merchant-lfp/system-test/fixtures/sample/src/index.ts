...
function doStuffWithLfpStoreServiceClient(client: LfpStoreServiceClient) {
  client.close();
}
...
function main() {
  ...
  // check that the client instance can be created
  const lfpStoreServiceClient = new LfpStoreServiceClient();
  doStuffWithLfpStoreServiceClient(lfpStoreServiceClient);
}
