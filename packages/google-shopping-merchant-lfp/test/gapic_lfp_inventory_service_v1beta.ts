...
describe('v1beta.LfpInventoryServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new lfpinventoryserviceModule.v1beta.LfpInventoryServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = lfpinventoryserviceModule.v1beta.LfpInventoryServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = lfpinventoryserviceModule.v1beta.LfpInventoryServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new lfpinventoryserviceModule.v1beta.LfpInventoryServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new lfpinventoryserviceModule.v1beta.LfpInventoryServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new lfpinventoryserviceModule.v1beta.LfpInventoryServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new lfpinventoryserviceModule.v1beta.LfpInventoryServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = lfpinventoryserviceModule.v1beta.LfpInventoryServiceClient.port;
            assert(port);
    ...
    describe('insertLfpInventory', () => {
        it('invokes insertLfpInventory without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.lfp.v1beta.InsertLfpInventoryRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.lfp.v1beta.LfpInventory()
            );
            client.innerApiCalls.insertLfpInventory = stubSimpleCall(expectedResponse);
            const [response] = await client.insertLfpInventory(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.insertLfpInventory as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.insertLfpInventory as SinonStub)
        ...
        it('invokes insertLfpInventory without error using callback', async () => {
            ...
            client.innerApiCalls.insertLfpInventory = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.insertLfpInventory(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.lfp.v1beta.ILfpInventory|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes insertLfpInventory with error', async () => {
            ...
            client.innerApiCalls.insertLfpInventory = stubSimpleCall(undefined, expectedError);
