  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          lfpsaleserviceModule.v1.LfpSaleServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          lfpsaleserviceModule.v1.LfpSaleServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new lfpsaleserviceModule.v1.LfpSaleServiceClient({
          universe_domain: 'example.com',
  ...
  describe('insertLfpSale', () => {
    it('invokes insertLfpSale without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.shopping.merchant.lfp.v1.InsertLfpSaleRequest',
        ['parent'],
      );
    ...
    it('invokes insertLfpSale without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.insertLfpSale(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.lfp.v1.ILfpSale | null,
          ) => {
            if (err) {
              reject(err);
            } else {
