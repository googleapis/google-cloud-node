...
describe('v1.LfpSaleServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new lfpsaleserviceModule.v1.LfpSaleServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = lfpsaleserviceModule.v1.LfpSaleServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = lfpsaleserviceModule.v1.LfpSaleServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new lfpsaleserviceModule.v1.LfpSaleServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new lfpsaleserviceModule.v1.LfpSaleServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new lfpsaleserviceModule.v1.LfpSaleServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new lfpsaleserviceModule.v1.LfpSaleServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = lfpsaleserviceModule.v1.LfpSaleServiceClient.port;
            assert(port);
    ...
    describe('insertLfpSale', () => {
        it('invokes insertLfpSale without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.lfp.v1.InsertLfpSaleRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.lfp.v1.InsertLfpSaleRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.lfp.v1.LfpSale()
            );
            ...
            const actualRequest = (client.innerApiCalls.insertLfpSale as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.insertLfpSale as SinonStub)
        ...
        it('invokes insertLfpSale without error using callback', async () => {
            ...
            client.innerApiCalls.insertLfpSale = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.insertLfpSale(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.lfp.v1.ILfpSale|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes insertLfpSale with error', async () => {
            ...
            client.innerApiCalls.insertLfpSale = stubSimpleCall(undefined, expectedError);
