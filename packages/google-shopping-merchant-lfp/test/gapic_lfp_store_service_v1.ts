  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          lfpstoreserviceModule.v1.LfpStoreServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          lfpstoreserviceModule.v1.LfpStoreServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new lfpstoreserviceModule.v1.LfpStoreServiceClient({
          universe_domain: 'example.com',
    ...
    it('invokes getLfpStore without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getLfpStore(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.lfp.v1.ILfpStore | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listLfpStores', () => {
    ...
    it('invokes listLfpStoresStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.shopping.merchant.lfp.v1.LfpStore) => {
