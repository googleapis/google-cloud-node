  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          lfpmerchantstateserviceModule.v1.LfpMerchantStateServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        lfpmerchantstateserviceModule.v1.LfpMerchantStateServiceClient.port;
      assert(port);
  ...
  describe('getLfpMerchantState', () => {
    it('invokes getLfpMerchantState without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.shopping.merchant.lfp.v1.GetLfpMerchantStateRequest',
        ['name'],
      );
    ...
    it('invokes getLfpMerchantState without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getLfpMerchantState(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.lfp.v1.ILfpMerchantState | null,
          ) => {
            if (err) {
              reject(err);
            } else {
