...
describe('v1.LfpMerchantStateServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new lfpmerchantstateserviceModule.v1.LfpMerchantStateServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = lfpmerchantstateserviceModule.v1.LfpMerchantStateServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = lfpmerchantstateserviceModule.v1.LfpMerchantStateServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new lfpmerchantstateserviceModule.v1.LfpMerchantStateServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new lfpmerchantstateserviceModule.v1.LfpMerchantStateServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new lfpmerchantstateserviceModule.v1.LfpMerchantStateServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new lfpmerchantstateserviceModule.v1.LfpMerchantStateServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = lfpmerchantstateserviceModule.v1.LfpMerchantStateServiceClient.port;
            assert(port);
    ...
    describe('getLfpMerchantState', () => {
        it('invokes getLfpMerchantState without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.lfp.v1.GetLfpMerchantStateRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.lfp.v1.GetLfpMerchantStateRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.lfp.v1.LfpMerchantState()
            );
        ...
        it('invokes getLfpMerchantState without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getLfpMerchantState(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.lfp.v1.ILfpMerchantState|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
