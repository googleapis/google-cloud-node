...
[![npm version](https://img.shields.io/npm/v/@google-cloud/api.svg)](https://www.npmjs.org/package/@google-cloud/api)
...
For example, `npm install @google-cloud/api@legacy-8` installs client libraries
