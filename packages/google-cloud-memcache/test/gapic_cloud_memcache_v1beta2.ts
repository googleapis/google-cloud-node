...
describe('v1beta2.CloudMemcacheClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new cloudmemcacheModule.v1beta2.CloudMemcacheClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'memcache.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new cloudmemcacheModule.v1beta2.CloudMemcacheClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'memcache.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new cloudmemcacheModule.v1beta2.CloudMemcacheClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new cloudmemcacheModule.v1beta2.CloudMemcacheClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getInstance', () => {
        it('invokes getInstance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.memcache.v1beta2.GetInstanceRequest', ['name']);
    ...
    describe('createInstance', () => {
        it('invokes createInstance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.memcache.v1beta2.CreateInstanceRequest', ['parent']);
    ...
    describe('updateInstance', () => {
        it('invokes updateInstance without error', async () => {
            ...
            request.resource ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.memcache.v1beta2.UpdateInstanceRequest', ['resource', 'name']);
    ...
    describe('updateParameters', () => {
        it('invokes updateParameters without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.memcache.v1beta2.UpdateParametersRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('deleteInstance', () => {
        it('invokes deleteInstance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.memcache.v1beta2.DeleteInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('applyParameters', () => {
        it('invokes applyParameters without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.memcache.v1beta2.ApplyParametersRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('applySoftwareUpdate', () => {
        it('invokes applySoftwareUpdate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.memcache.v1beta2.ApplySoftwareUpdateRequest', ['instance']);
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.applySoftwareUpdate as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.applySoftwareUpdate as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('rescheduleMaintenance', () => {
        it('invokes rescheduleMaintenance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.memcache.v1beta2.RescheduleMaintenanceRequest', ['instance']);
            request.instance = defaultValue1;
            const expectedHeaderRequestParams = `instance=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listInstances', () => {
        it('invokes listInstances without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.memcache.v1beta2.ListInstancesRequest', ['parent']);
            request.parent = defaultValue1;
