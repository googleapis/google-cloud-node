...
export class CloudTasksClient {
  ...
  constructor(
    ...
    const batchCreateTasksMetadata = protoFilesRoot.lookup(
      '.google.cloud.tasks.v2.BatchCreateTasksMetadata',
    ) as gax.protobuf.Type;
   ...
   * @param {Object} request
   *   The request object that will be sent.
   * @param {google.cloud.tasks.v2.CmekConfig} request.cmekConfig
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.cloud.tasks.v2.CmekConfig|CmekConfig}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v2/cloud_tasks.update_cmek_config.js</caption>
   * region_tag:cloudtasks_v2_generated_CloudTasks_UpdateCmekConfig_async
   */
  updateCmekConfig(
    request?: protos.google.cloud.tasks.v2.IUpdateCmekConfigRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.tasks.v2.ICmekConfig,
      protos.google.cloud.tasks.v2.IUpdateCmekConfigRequest | undefined,
      {} | undefined,
    ]
  >;
  updateCmekConfig(
    ...
    callback: Callback<
      protos.google.cloud.tasks.v2.ICmekConfig,
      protos.google.cloud.tasks.v2.IUpdateCmekConfigRequest | null | undefined,
      {} | null | undefined
    >,
  ): void;
  updateCmekConfig(
  ...
  updateCmekConfig(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.cloud.tasks.v2.ICmekConfig,
          | protos.google.cloud.tasks.v2.IUpdateCmekConfigRequest
          | null
          | undefined,
          {} | null | undefined
        >,
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v2/cloud_tasks.get_cmek_config.js</caption>
   * region_tag:cloudtasks_v2_generated_CloudTasks_GetCmekConfig_async
   */
  getCmekConfig(
    request?: protos.google.cloud.tasks.v2.IGetCmekConfigRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.tasks.v2.ICmekConfig,
      protos.google.cloud.tasks.v2.IGetCmekConfigRequest | undefined,
      {} | undefined,
    ]
  >;
  getCmekConfig(
    ...
    callback: Callback<
      protos.google.cloud.tasks.v2.ICmekConfig,
      protos.google.cloud.tasks.v2.IGetCmekConfigRequest | null | undefined,
      {} | null | undefined
    >,
  ): void;
  getCmekConfig(
   ...
   *   for more details and examples.
   * @example <caption>include:samples/generated/v2/cloud_tasks.batch_create_tasks.js</caption>
   * region_tag:cloudtasks_v2_generated_CloudTasks_BatchCreateTasks_async
   */
  batchCreateTasks(
    request?: protos.google.cloud.tasks.v2.IBatchCreateTasksRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<
        protos.google.cloud.tasks.v2.IBatchCreateTasksResponse,
        protos.google.cloud.tasks.v2.IBatchCreateTasksMetadata
      >,
  ...
  async checkBatchCreateTasksProgress(
    ...
    LROperation<
      protos.google.cloud.tasks.v2.BatchCreateTasksResponse,
      protos.google.cloud.tasks.v2.BatchCreateTasksMetadata
    >
  > {
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v2/cloud_tasks.batch_delete_tasks.js</caption>
   * region_tag:cloudtasks_v2_generated_CloudTasks_BatchDeleteTasks_async
   */
  batchDeleteTasks(
    request?: protos.google.cloud.tasks.v2.IBatchDeleteTasksRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<
        protos.google.protobuf.IEmpty,
        protos.google.cloud.tasks.v2.IBatchDeleteTasksMetadata
      >,
      protos.google.longrunning.IOperation | undefined,
      {} | undefined,
    ]
  ...
  async checkBatchDeleteTasksProgress(
    ...
    LROperation<
      ...
      protos.google.cloud.tasks.v2.BatchDeleteTasksMetadata
    >
  > {
