...
function main(parent, names) {
  // [START cloudtasks_v2_generated_CloudTasks_BatchDeleteTasks_async]
  /**
  ...
  async function callBatchDeleteTasks() {
    // Construct request
    const request = {
      parent,
      names,
    ...
    // Run request
    const [operation] = await tasksClient.batchDeleteTasks(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callBatchDeleteTasks();
  // [END cloudtasks_v2_generated_CloudTasks_BatchDeleteTasks_async]
}
