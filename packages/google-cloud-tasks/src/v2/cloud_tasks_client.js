...
class CloudTasksClient {
  ...
  constructor(opts) {
    ...
    const cloudTasksStub = gaxGrpc.createStub(
      opts.fallback
        ...
        : protos.google.cloud.tasks.v2.CloudTasks,
      opts
    );
   ...
   *
   *   The second parameter to the callback is Array of [Queue]{@link google.cloud.tasks.v2.Queue}.
   *
   *   When autoPaginate: false is specified through options, it contains the result
   *   in a single response. If the response indicates the next page exists, the third
   *   parameter is set to be used for the next request object. The fourth parameter keeps
   *   the raw response object of an object representing [ListQueuesResponse]{@link google.cloud.tasks.v2.ListQueuesResponse}.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of [Queue]{@link google.cloud.tasks.v2.Queue}.
   *
   *   When autoPaginate: false is specified through options, the array has three elements.
   *   The first element is Array of [Queue]{@link google.cloud.tasks.v2.Queue} in a single response.
   *   The second element is the next request object if the response
   *   indicates the next page exists, or null. The third element is
   *   an object representing [ListQueuesResponse]{@link google.cloud.tasks.v2.ListQueuesResponse}.
   *
   ...
   *   The function which will be called with the result of the API call.
   *
   *   The second parameter to the callback is an object representing [Queue]{@link google.cloud.tasks.v2.Queue}.
   * @returns {Promise} - The promise which resolves to an array.
   ...
   *   The function which will be called with the result of the API call.
   *
   *   The second parameter to the callback is Array of [Task]{@link google.cloud.tasks.v2.Task}.
   *
   *   When autoPaginate: false is specified through options, it contains the result
   *   in a single response. If the response indicates the next page exists, the third
   *   parameter is set to be used for the next request object. The fourth parameter keeps
   *   the raw response object of an object representing [ListTasksResponse]{@link google.cloud.tasks.v2.ListTasksResponse}.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of [Task]{@link google.cloud.tasks.v2.Task}.
   *
   *   When autoPaginate: false is specified through options, the array has three elements.
   *   The first element is Array of [Task]{@link google.cloud.tasks.v2.Task} in a single response.
   *   The second element is the next request object if the response
   *   indicates the next page exists, or null. The third element is
   *   an object representing [ListTasksResponse]{@link google.cloud.tasks.v2.ListTasksResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   *
   * @example
   ...
   *   The function which will be called with the result of the API call.
   *
   *   The second parameter to the callback is an object representing [Task]{@link google.cloud.tasks.v2.Task}.
   * @returns {Promise} - The promise which resolves to an array.
