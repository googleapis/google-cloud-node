 ...
 *
 *   This object should have the same structure as [RateLimits]{@link google.cloud.tasks.v2.RateLimits}
 *
 ...
 *
 *   This object should have the same structure as [RetryConfig]{@link google.cloud.tasks.v2.RetryConfig}
 *
 ...
 *
 *   The number should be among the values of [State]{@link google.cloud.tasks.v2.State}
 *
 ...
 * @see [google.cloud.tasks.v2.Queue definition in proto format]{@link https://github.com/googleapis/googleapis/blob/master/google/cloud/tasks/v2/queue.proto}
 */
const Queue = {
 ...
 * @typedef RateLimits
 * @memberof google.cloud.tasks.v2
 * @see [google.cloud.tasks.v2.RateLimits definition in proto format]{@link https://github.com/googleapis/googleapis/blob/master/google/cloud/tasks/v2/queue.proto}
 */
const RateLimits = {
  // This is for documentation. Actual contents will be loaded by gRPC.
};
 ...
 * @typedef RetryConfig
 * @memberof google.cloud.tasks.v2
 * @see [google.cloud.tasks.v2.RetryConfig definition in proto format]{@link https://github.com/googleapis/googleapis/blob/master/google/cloud/tasks/v2/queue.proto}
 */
const RetryConfig = {
  // This is for documentation. Actual contents will be loaded by gRPC.
};