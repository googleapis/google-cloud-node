 ...
 *
 *   This object should have the same structure as [Attempt]{@link google.cloud.tasks.v2.Attempt}
 *
 ...
 * @see [google.cloud.tasks.v2.Task definition in proto format]{@link https://github.com/googleapis/googleapis/blob/master/google/cloud/tasks/v2/task.proto}
 */
const Task = {
 ...
 * @typedef Attempt
 * @memberof google.cloud.tasks.v2
 * @see [google.cloud.tasks.v2.Attempt definition in proto format]{@link https://github.com/googleapis/googleapis/blob/master/google/cloud/tasks/v2/task.proto}
 */
const Attempt = {
  // This is for documentation. Actual contents will be loaded by gRPC.
};