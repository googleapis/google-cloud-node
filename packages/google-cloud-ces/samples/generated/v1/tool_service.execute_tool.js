...
function main(parent) {
  // [START ces_v1_generated_ToolService_ExecuteTool_async]
  /**
  ...
  async function callExecuteTool() {
    ...
    // Run request
    const response = await cesClient.executeTool(request);
    console.log(response);
  }

  callExecuteTool();
  // [END ces_v1_generated_ToolService_ExecuteTool_async]
}
