...
function main(app, personaId, text) {
  ...
  async function callTestPersonaVoice() {
    // Construct request
    const request = {
      app,
      personaId,
    ...
    // Run request
    const response = await cesClient.testPersonaVoice(request);
    console.log(response);
  }

  callTestPersonaVoice();
