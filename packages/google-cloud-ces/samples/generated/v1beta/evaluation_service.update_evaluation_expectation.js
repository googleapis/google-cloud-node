...
function main(evaluationExpectation) {
  ...
  async function callUpdateEvaluationExpectation() {
    // Construct request
    const request = {
    ...
    // Run request
    const response = await cesClient.updateEvaluationExpectation(request);
    console.log(response);
  }

  callUpdateEvaluationExpectation();
