...
describe('v1beta.AgentServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          agentserviceModule.v1beta.AgentServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          agentserviceModule.v1beta.AgentServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'ces.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new agentserviceModule.v1beta.AgentServiceClient({
          universe_domain: 'example.com',
  ...
  describe('getApp', () => {
    it('invokes getApp without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.GetAppRequest',
        ['name'],
      );
    ...
    it('invokes getApp without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getApp(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1beta.IApp | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getSecuritySettings without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getSecuritySettings(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1beta.ISecuritySettings | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getAgent', () => {
    it('invokes getAgent without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.GetAgentRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
    ...
    it('invokes getAgent without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getAgent(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1beta.IAgent | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('updateAgent', () => {
    it('invokes updateAgent without error', async () => {
      ...
      request.agent ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.UpdateAgentRequest',
        ['agent', 'name'],
      );
  ...
  describe('deleteAgent', () => {
    it('invokes deleteAgent without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.DeleteAgentRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('getExample', () => {
    it('invokes getExample without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.GetExampleRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
    ...
    it('invokes getExample without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getExample(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1beta.IExample | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createExample', () => {
    it('invokes createExample without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.CreateExampleRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
  ...
  describe('updateExample', () => {
    it('invokes updateExample without error', async () => {
      ...
      request.example ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.UpdateExampleRequest',
        ['example', 'name'],
      );
  ...
  describe('deleteExample', () => {
    it('invokes deleteExample without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.DeleteExampleRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('getTool', () => {
    it('invokes getTool without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.GetToolRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
    ...
    it('invokes getTool without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getTool(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1beta.ITool | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getConversation without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getConversation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1beta.IConversation | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('deleteConversation', () => {
    it('invokes deleteConversation without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.DeleteConversationRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('createTool', () => {
    it('invokes createTool without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.CreateToolRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
  ...
  describe('deleteTool', () => {
    it('invokes deleteTool without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.DeleteToolRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('getGuardrail', () => {
    it('invokes getGuardrail without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.GetGuardrailRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
    ...
    it('invokes getGuardrail without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getGuardrail(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1beta.IGuardrail | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createGuardrail', () => {
    it('invokes createGuardrail without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.CreateGuardrailRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
  ...
  describe('updateGuardrail', () => {
    it('invokes updateGuardrail without error', async () => {
      ...
      request.guardrail ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.UpdateGuardrailRequest',
        ['guardrail', 'name'],
      );
  ...
  describe('deleteGuardrail', () => {
    it('invokes deleteGuardrail without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.DeleteGuardrailRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
    ...
    it('invokes getDeployment without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDeployment(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1beta.IDeployment | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('updateDeployment', () => {
    it('invokes updateDeployment without error', async () => {
      ...
      request.deployment ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.UpdateDeploymentRequest',
        ['deployment', 'name'],
      );
  ...
  describe('getToolset', () => {
    it('invokes getToolset without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.GetToolsetRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
    ...
    it('invokes getToolset without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getToolset(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1beta.IToolset | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('updateToolset', () => {
    it('invokes updateToolset without error', async () => {
      ...
      request.toolset ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.UpdateToolsetRequest',
        ['toolset', 'name'],
      );
  ...
  describe('deleteToolset', () => {
    it('invokes deleteToolset without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.DeleteToolsetRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('getAppVersion', () => {
    it('invokes getAppVersion without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.GetAppVersionRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
    ...
    it('invokes getAppVersion without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getAppVersion(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1beta.IAppVersion | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('deleteAppVersion', () => {
    it('invokes deleteAppVersion without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.DeleteAppVersionRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('getChangelog', () => {
    it('invokes getChangelog without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.GetChangelogRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
    ...
    it('invokes getChangelog without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getChangelog(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1beta.IChangelog | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('deleteApp', () => {
    it('invokes deleteApp without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.DeleteAppRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('exportApp', () => {
    it('invokes exportApp without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.ExportAppRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('importApp', () => {
    it('invokes importApp without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.ImportAppRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
  ...
  describe('batchDeleteConversations', () => {
    it('invokes batchDeleteConversations without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.BatchDeleteConversationsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
  ...
  describe('restoreAppVersion', () => {
    it('invokes restoreAppVersion without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.RestoreAppVersionRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('generateAppResource', () => {
    it('invokes generateAppResource without error', async () => {
      ...
      client.innerApiCalls.generateAppResource =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.generateAppResource(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.generateAppResource as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.generateAppResource as SinonStub
    ...
    it('invokes generateAppResource with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.generateAppResource = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkGenerateAppResourceProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkGenerateAppResourceProgress(
        expectedResponse.name,
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkGenerateAppResourceProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkGenerateAppResourceProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listApps', () => {
    it('invokes listApps without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.ListAppsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
  ...
  describe('listAgents', () => {
    it('invokes listAgents without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.ListAgentsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
  ...
  describe('listExamples', () => {
    it('invokes listExamples without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.ListExamplesRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
    ...
    it('invokes listExamplesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.ces.v1beta.Example) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listTools', () => {
    it('invokes listTools without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.ListToolsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
  ...
  describe('listConversations', () => {
    it('invokes listConversations without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.ListConversationsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
    ...
    it('invokes listConversationsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.ces.v1beta.Conversation) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listGuardrails', () => {
    it('invokes listGuardrails without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.ListGuardrailsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
    ...
    it('invokes listGuardrailsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.ces.v1beta.Guardrail) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listDeployments', () => {
    it('invokes listDeployments without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.ListDeploymentsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
    ...
    it('invokes listDeploymentsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.ces.v1beta.Deployment) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listToolsets', () => {
    it('invokes listToolsets without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.ListToolsetsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
    ...
    it('invokes listToolsetsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.ces.v1beta.Toolset) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listAppVersions', () => {
    it('invokes listAppVersions without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.ListAppVersionsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
    ...
    it('invokes listAppVersionsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.ces.v1beta.AppVersion) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listChangelogs', () => {
    ...
    it('invokes listChangelogsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.ces.v1beta.Changelog) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
