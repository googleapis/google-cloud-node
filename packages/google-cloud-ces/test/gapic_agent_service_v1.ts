...
describe('v1.AgentServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          agentserviceModule.v1.AgentServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          agentserviceModule.v1.AgentServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'ces.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new agentserviceModule.v1.AgentServiceClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = agentserviceModule.v1.AgentServiceClient.port;
      assert(port);
  ...
  describe('getApp', () => {
    it('invokes getApp without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.GetAppRequest(),
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.ces.v1.App(),
      );
      client.innerApiCalls.getApp = stubSimpleCall(expectedResponse);
      const [response] = await client.getApp(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (client.innerApiCalls.getApp as SinonStub).getCall(
        0,
      ).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getApp as SinonStub
    ...
    it('invokes getApp without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getApp(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1.IApp | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('updateApp', () => {
    it('invokes updateApp without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.UpdateAppRequest(),
      );
      request.app ??= {};
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateApp as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateApp as SinonStub
    ...
    it('invokes updateApp without error using callback', async () => {
      ...
      client.innerApiCalls.updateApp =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.updateApp(
          request,
  ...
  describe('getAgent', () => {
    it('invokes getAgent without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.GetAgentRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.ces.v1.Agent(),
      );
    ...
    it('invokes getAgent without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getAgent(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1.IAgent | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createAgent', () => {
    it('invokes createAgent without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.CreateAgentRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createAgent as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createAgent as SinonStub
    ...
    it('invokes createAgent without error using callback', async () => {
      ...
      client.innerApiCalls.createAgent =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createAgent(
          request,
  ...
  describe('updateAgent', () => {
    it('invokes updateAgent without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.UpdateAgentRequest(),
      );
      request.agent ??= {};
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateAgent as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateAgent as SinonStub
    ...
    it('invokes updateAgent without error using callback', async () => {
      ...
      client.innerApiCalls.updateAgent =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.updateAgent(
          request,
  ...
  describe('deleteAgent', () => {
    it('invokes deleteAgent without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.DeleteAgentRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
    ...
    it('invokes deleteAgent without error using callback', async () => {
      ...
      client.innerApiCalls.deleteAgent =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.deleteAgent(
          request,
  ...
  describe('getExample', () => {
    it('invokes getExample without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.GetExampleRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.ces.v1.Example(),
      );
    ...
    it('invokes getExample without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getExample(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1.IExample | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createExample', () => {
    it('invokes createExample without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.CreateExampleRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('updateExample', () => {
    it('invokes updateExample without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.UpdateExampleRequest(),
      );
      request.example ??= {};
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('deleteExample', () => {
    it('invokes deleteExample without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.DeleteExampleRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('getTool', () => {
    it('invokes getTool without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.GetToolRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.ces.v1.Tool(),
      );
      client.innerApiCalls.getTool = stubSimpleCall(expectedResponse);
      const [response] = await client.getTool(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (client.innerApiCalls.getTool as SinonStub).getCall(
        0,
      ).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getTool as SinonStub
      ).getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
      assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
    });
    ...
    it('invokes getTool without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getTool(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1.ITool | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getConversation', () => {
    it('invokes getConversation without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.GetConversationRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.ces.v1.Conversation(),
      );
    ...
    it('invokes getConversation without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getConversation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1.IConversation | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('deleteConversation', () => {
    it('invokes deleteConversation without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.DeleteConversationRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('createTool', () => {
    it('invokes createTool without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.CreateToolRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createTool as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createTool as SinonStub
    ...
    it('invokes createTool without error using callback', async () => {
      ...
      client.innerApiCalls.createTool =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createTool(
          request,
    ...
    it('invokes createTool with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createTool = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateTool', () => {
    it('invokes updateTool without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.UpdateToolRequest(),
      );
      request.tool ??= {};
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateTool as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateTool as SinonStub
    ...
    it('invokes updateTool without error using callback', async () => {
      ...
      client.innerApiCalls.updateTool =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.updateTool(
          request,
    ...
    it('invokes updateTool with error', async () => {
      ...
      const expectedHeaderRequestParams = `tool.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateTool = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteTool', () => {
    it('invokes deleteTool without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.DeleteToolRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteTool as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteTool as SinonStub
    ...
    it('invokes deleteTool without error using callback', async () => {
      ...
      client.innerApiCalls.deleteTool =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.deleteTool(
          request,
    ...
    it('invokes deleteTool with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteTool = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getGuardrail', () => {
    it('invokes getGuardrail without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.GetGuardrailRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
    ...
    it('invokes getGuardrail without error using callback', async () => {
      ...
      client.innerApiCalls.getGuardrail =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getGuardrail(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1.IGuardrail | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getGuardrail with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getGuardrail = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createGuardrail', () => {
    it('invokes createGuardrail without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.CreateGuardrailRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createGuardrail as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createGuardrail as SinonStub
    ...
    it('invokes createGuardrail without error using callback', async () => {
      ...
      client.innerApiCalls.createGuardrail =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes createGuardrail with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createGuardrail = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateGuardrail', () => {
    it('invokes updateGuardrail without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.UpdateGuardrailRequest(),
      );
      request.guardrail ??= {};
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateGuardrail as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateGuardrail as SinonStub
    ...
    it('invokes updateGuardrail without error using callback', async () => {
      ...
      client.innerApiCalls.updateGuardrail =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes updateGuardrail with error', async () => {
      ...
      const expectedHeaderRequestParams = `guardrail.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateGuardrail = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteGuardrail', () => {
    it('invokes deleteGuardrail without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.DeleteGuardrailRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteGuardrail as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteGuardrail as SinonStub
    ...
    it('invokes deleteGuardrail without error using callback', async () => {
      ...
      client.innerApiCalls.deleteGuardrail =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes deleteGuardrail with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteGuardrail = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getDeployment', () => {
    it('invokes getDeployment without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.GetDeploymentRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.ces.v1.Deployment(),
      );
    ...
    it('invokes getDeployment without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDeployment(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1.IDeployment | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createDeployment', () => {
    it('invokes createDeployment without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.CreateDeploymentRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('updateDeployment', () => {
    it('invokes updateDeployment without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.UpdateDeploymentRequest(),
      );
      request.deployment ??= {};
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('deleteDeployment', () => {
    it('invokes deleteDeployment without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.DeleteDeploymentRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('getToolset', () => {
    it('invokes getToolset without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.GetToolsetRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
    ...
    it('invokes getToolset without error using callback', async () => {
      ...
      client.innerApiCalls.getToolset =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getToolset(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1.IToolset | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getToolset with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getToolset = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createToolset', () => {
    it('invokes createToolset without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.CreateToolsetRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createToolset as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createToolset as SinonStub
    ...
    it('invokes createToolset without error using callback', async () => {
      ...
      client.innerApiCalls.createToolset =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes createToolset with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createToolset = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateToolset', () => {
    it('invokes updateToolset without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.UpdateToolsetRequest(),
      );
      request.toolset ??= {};
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateToolset as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateToolset as SinonStub
    ...
    it('invokes updateToolset without error using callback', async () => {
      ...
      client.innerApiCalls.updateToolset =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes updateToolset with error', async () => {
      ...
      const expectedHeaderRequestParams = `toolset.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateToolset = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteToolset', () => {
    it('invokes deleteToolset without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.DeleteToolsetRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteToolset as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteToolset as SinonStub
    ...
    it('invokes deleteToolset without error using callback', async () => {
      ...
      client.innerApiCalls.deleteToolset =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes deleteToolset with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteToolset = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getAppVersion', () => {
    it('invokes getAppVersion without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.GetAppVersionRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
    ...
    it('invokes getAppVersion without error using callback', async () => {
      ...
      client.innerApiCalls.getAppVersion =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getAppVersion(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1.IAppVersion | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getAppVersion with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getAppVersion = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createAppVersion', () => {
    it('invokes createAppVersion without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.CreateAppVersionRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createAppVersion as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createAppVersion as SinonStub
    ...
    it('invokes createAppVersion with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createAppVersion = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteAppVersion', () => {
    it('invokes deleteAppVersion without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.DeleteAppVersionRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteAppVersion as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteAppVersion as SinonStub
    ...
    it('invokes deleteAppVersion without error using callback', async () => {
      ...
      client.innerApiCalls.deleteAppVersion =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes deleteAppVersion with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteAppVersion = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getChangelog', () => {
    it('invokes getChangelog without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.GetChangelogRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
    ...
    it('invokes getChangelog without error using callback', async () => {
      ...
      client.innerApiCalls.getChangelog =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getChangelog(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1.IChangelog | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getChangelog with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getChangelog = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createApp', () => {
    it('invokes createApp without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.CreateAppRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createApp as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createApp as SinonStub
    ...
    it('invokes createApp without error using callback', async () => {
      ...
      client.innerApiCalls.createApp =
    ...
    it('invokes createApp with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createApp = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteApp', () => {
    it('invokes deleteApp without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.DeleteAppRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteApp as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteApp as SinonStub
    ...
    it('invokes deleteApp without error using callback', async () => {
      ...
      client.innerApiCalls.deleteApp =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.deleteApp(
          request,
    ...
    it('invokes deleteApp with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteApp = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('exportApp', () => {
    it('invokes exportApp without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.ExportAppRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.exportApp as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.exportApp as SinonStub
    ...
    it('invokes exportApp without error using callback', async () => {
      ...
      client.innerApiCalls.exportApp =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.exportApp(
          request,
    ...
    it('invokes exportApp with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.exportApp = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('importApp', () => {
    it('invokes importApp without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.ImportAppRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.importApp as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.importApp as SinonStub
    ...
    it('invokes importApp without error using callback', async () => {
      ...
      client.innerApiCalls.importApp =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.importApp(
          request,
    ...
    it('invokes importApp with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.importApp = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('batchDeleteConversations', () => {
    it('invokes batchDeleteConversations without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.BatchDeleteConversationsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.batchDeleteConversations =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.batchDeleteConversations(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchDeleteConversations as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchDeleteConversations as SinonStub
    ...
    it('invokes batchDeleteConversations with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchDeleteConversations = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchDeleteConversations(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchDeleteConversations as SinonStub
    ...
    it('invokes checkBatchDeleteConversationsProgress without error', async () => {
      ...
      const decodedOperation =
        await client.checkBatchDeleteConversationsProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkBatchDeleteConversationsProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkBatchDeleteConversationsProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('restoreAppVersion', () => {
    it('invokes restoreAppVersion without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.RestoreAppVersionRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.restoreAppVersion =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.restoreAppVersion(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.restoreAppVersion as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.restoreAppVersion as SinonStub
    ...
    it('invokes restoreAppVersion with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.restoreAppVersion = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkRestoreAppVersionProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkRestoreAppVersionProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listApps', () => {
    it('invokes listApps without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.ListAppsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedResponse = [
        generateSampleMessage(new protos.google.cloud.ces.v1.App()),
        generateSampleMessage(new protos.google.cloud.ces.v1.App()),
        generateSampleMessage(new protos.google.cloud.ces.v1.App()),
      ];
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listApps as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listApps as SinonStub
    ...
    it('invokes listAppsStream without error', async () => {
      ...
      client.descriptors.page.listApps.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listAppsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.ces.v1.App[] = [];
        stream.on('data', (response: protos.google.cloud.ces.v1.App) => {
      ...
      assert(
        (client.descriptors.page.listApps.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listApps, request),
      );
      assert(
        (client.descriptors.page.listApps.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listAppsStream with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listApps.createStream = stubPageStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.listAppsStream(request);
    ...
    it('uses async iteration with listApps without error', async () => {
      ...
      client.descriptors.page.listApps.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.ces.v1.IApp[] = [];
      ...
      assert.deepStrictEqual(
        (client.descriptors.page.listApps.asyncIterate as SinonStub).getCall(0)
          .args[1],
        request,
      );
      assert(
    ...
    it('uses async iteration with listApps with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listApps.asyncIterate = stubAsyncIterationCall(
        undefined,
        expectedError,
      );
      const iterable = client.listAppsAsync(request);
  ...
  describe('listAgents', () => {
    it('invokes listAgents without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.ListAgentsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
    ...
    it('uses async iteration with listAgents without error', async () => {
      ...
      client.descriptors.page.listAgents.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.ces.v1.IAgent[] = [];
  ...
  describe('listExamples', () => {
    it('invokes listExamples without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.ListExamplesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = [
        generateSampleMessage(new protos.google.cloud.ces.v1.Example()),
        generateSampleMessage(new protos.google.cloud.ces.v1.Example()),
        generateSampleMessage(new protos.google.cloud.ces.v1.Example()),
      ];
    ...
    it('invokes listExamplesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.ces.v1.Example[] = [];
        stream.on('data', (response: protos.google.cloud.ces.v1.Example) => {
          responses.push(response);
        });
        stream.on('end', () => {
          resolve(responses);
  ...
  describe('listTools', () => {
    it('invokes listTools without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.ListToolsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = [
        generateSampleMessage(new protos.google.cloud.ces.v1.Tool()),
        generateSampleMessage(new protos.google.cloud.ces.v1.Tool()),
        generateSampleMessage(new protos.google.cloud.ces.v1.Tool()),
      ];
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listTools as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listTools as SinonStub
    ...
    it('invokes listTools without error using callback', async () => {
      ...
      client.innerApiCalls.listTools =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listTools(
          request,
    ...
    it('invokes listToolsStream without error', async () => {
      ...
      client.descriptors.page.listTools.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listToolsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.ces.v1.Tool[] = [];
        stream.on('data', (response: protos.google.cloud.ces.v1.Tool) => {
          responses.push(response);
        });
        stream.on('end', () => {
          resolve(responses);
      ...
      assert(
        (client.descriptors.page.listTools.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listTools, request),
      );
      assert(
        (client.descriptors.page.listTools.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listToolsStream with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listTools.createStream = stubPageStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.listToolsStream(request);
    ...
    it('uses async iteration with listTools without error', async () => {
      ...
      client.descriptors.page.listTools.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.ces.v1.ITool[] = [];
      ...
      assert.deepStrictEqual(responses, expectedResponse);
      assert.deepStrictEqual(
        (client.descriptors.page.listTools.asyncIterate as SinonStub).getCall(0)
          .args[1],
        request,
      );
      assert(
    ...
    it('uses async iteration with listTools with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listTools.asyncIterate = stubAsyncIterationCall(
        undefined,
        expectedError,
      );
      const iterable = client.listToolsAsync(request);
  ...
  describe('listConversations', () => {
    it('invokes listConversations without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.ListConversationsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = [
        generateSampleMessage(new protos.google.cloud.ces.v1.Conversation()),
        generateSampleMessage(new protos.google.cloud.ces.v1.Conversation()),
        generateSampleMessage(new protos.google.cloud.ces.v1.Conversation()),
      ];
    ...
    it('invokes listConversationsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.ces.v1.Conversation[] = [];
        stream.on(
          'data',
          (response: protos.google.cloud.ces.v1.Conversation) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
    ...
    it('uses async iteration with listConversations without error', async () => {
      ...
      client.descriptors.page.listConversations.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.ces.v1.IConversation[] = [];
  ...
  describe('listGuardrails', () => {
    it('invokes listGuardrails without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.ListGuardrailsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = [
        generateSampleMessage(new protos.google.cloud.ces.v1.Guardrail()),
        generateSampleMessage(new protos.google.cloud.ces.v1.Guardrail()),
        generateSampleMessage(new protos.google.cloud.ces.v1.Guardrail()),
      ];
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listGuardrails as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listGuardrails as SinonStub
    ...
    it('invokes listGuardrails without error using callback', async () => {
      ...
      client.innerApiCalls.listGuardrails =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listGuardrails with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listGuardrails = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listGuardrailsStream without error', async () => {
      ...
      client.descriptors.page.listGuardrails.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listGuardrailsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.ces.v1.Guardrail[] = [];
        stream.on('data', (response: protos.google.cloud.ces.v1.Guardrail) => {
          responses.push(response);
        });
        stream.on('end', () => {
          resolve(responses);
      ...
      assert(
        (client.descriptors.page.listGuardrails.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listGuardrails, request),
      );
      assert(
        (client.descriptors.page.listGuardrails.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listGuardrails without error', async () => {
      ...
      client.descriptors.page.listGuardrails.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.ces.v1.IGuardrail[] = [];
  ...
  describe('listDeployments', () => {
    it('invokes listDeployments without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.ListDeploymentsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = [
        generateSampleMessage(new protos.google.cloud.ces.v1.Deployment()),
        generateSampleMessage(new protos.google.cloud.ces.v1.Deployment()),
        generateSampleMessage(new protos.google.cloud.ces.v1.Deployment()),
      ];
    ...
    it('invokes listDeploymentsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.ces.v1.Deployment[] = [];
        stream.on('data', (response: protos.google.cloud.ces.v1.Deployment) => {
          responses.push(response);
        });
        stream.on('end', () => {
          resolve(responses);
    ...
    it('uses async iteration with listDeployments without error', async () => {
      ...
      client.descriptors.page.listDeployments.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.ces.v1.IDeployment[] = [];
  ...
  describe('listToolsets', () => {
    it('invokes listToolsets without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.ListToolsetsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = [
        generateSampleMessage(new protos.google.cloud.ces.v1.Toolset()),
        generateSampleMessage(new protos.google.cloud.ces.v1.Toolset()),
        generateSampleMessage(new protos.google.cloud.ces.v1.Toolset()),
      ];
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listToolsets as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listToolsets as SinonStub
    ...
    it('invokes listToolsets without error using callback', async () => {
      ...
      client.innerApiCalls.listToolsets =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listToolsets(
          request,
    ...
    it('invokes listToolsets with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listToolsets = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listToolsetsStream without error', async () => {
      ...
      client.descriptors.page.listToolsets.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listToolsetsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.ces.v1.Toolset[] = [];
        stream.on('data', (response: protos.google.cloud.ces.v1.Toolset) => {
          responses.push(response);
        });
        stream.on('end', () => {
          resolve(responses);
      ...
      assert(
        (client.descriptors.page.listToolsets.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listToolsets, request),
      );
      assert(
        (client.descriptors.page.listToolsets.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listToolsetsStream with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listToolsets.createStream = stubPageStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.listToolsetsStream(request);
    ...
    it('uses async iteration with listToolsets without error', async () => {
      ...
      client.descriptors.page.listToolsets.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.ces.v1.IToolset[] = [];
  ...
  describe('listAppVersions', () => {
    it('invokes listAppVersions without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.ListAppVersionsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = [
        generateSampleMessage(new protos.google.cloud.ces.v1.AppVersion()),
        generateSampleMessage(new protos.google.cloud.ces.v1.AppVersion()),
        generateSampleMessage(new protos.google.cloud.ces.v1.AppVersion()),
      ];
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listAppVersions as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listAppVersions as SinonStub
    ...
    it('invokes listAppVersions without error using callback', async () => {
      ...
      client.innerApiCalls.listAppVersions =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listAppVersions with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listAppVersions = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listAppVersionsStream without error', async () => {
      ...
      client.descriptors.page.listAppVersions.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listAppVersionsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.ces.v1.AppVersion[] = [];
        stream.on('data', (response: protos.google.cloud.ces.v1.AppVersion) => {
          responses.push(response);
        });
        stream.on('end', () => {
          resolve(responses);
      ...
      assert(
        (client.descriptors.page.listAppVersions.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listAppVersions, request),
      );
      assert(
        (client.descriptors.page.listAppVersions.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listAppVersions without error', async () => {
      ...
      client.descriptors.page.listAppVersions.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.ces.v1.IAppVersion[] = [];
  ...
  describe('listChangelogs', () => {
    it('invokes listChangelogs without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1.ListChangelogsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = [
        generateSampleMessage(new protos.google.cloud.ces.v1.Changelog()),
        generateSampleMessage(new protos.google.cloud.ces.v1.Changelog()),
        generateSampleMessage(new protos.google.cloud.ces.v1.Changelog()),
      ];
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listChangelogs as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listChangelogs as SinonStub
    ...
    it('invokes listChangelogs without error using callback', async () => {
      ...
      client.innerApiCalls.listChangelogs =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listChangelogs with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listChangelogs = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listChangelogsStream without error', async () => {
      ...
      client.descriptors.page.listChangelogs.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listChangelogsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.ces.v1.Changelog[] = [];
        stream.on('data', (response: protos.google.cloud.ces.v1.Changelog) => {
          responses.push(response);
        });
        stream.on('end', () => {
          resolve(responses);
      ...
      assert(
        (client.descriptors.page.listChangelogs.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listChangelogs, request),
      );
      assert(
        (client.descriptors.page.listChangelogs.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listChangelogs without error', async () => {
      ...
      client.descriptors.page.listChangelogs.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.ces.v1.IChangelog[] = [];
  ...
  describe('Path templates', () => {
    ...
    describe('app', async () => {
      ...
      await client.initialize();
      client.pathTemplates.appPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.appPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('appPath', () => {
        const result = client.appPath(
          'projectValue',
          'locationValue',
          'appValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.appPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromAppName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.appPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('appVersion', async () => {
      ...
      await client.initialize();
      client.pathTemplates.appVersionPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.appVersionPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('appVersionPath', () => {
        const result = client.appVersionPath(
          'projectValue',
          'locationValue',
          'appValue',
          'versionValue',
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.appVersionPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromAppVersionName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.appVersionPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('guardrail', async () => {
      ...
      await client.initialize();
      client.pathTemplates.guardrailPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.guardrailPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('guardrailPath', () => {
        const result = client.guardrailPath(
          'projectValue',
          'locationValue',
          'appValue',
          'guardrailValue',
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.guardrailPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromGuardrailName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.guardrailPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('omnichannel', async () => {
      ...
      await client.initialize();
      client.pathTemplates.omnichannelPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.omnichannelPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('omnichannelPath', () => {
        const result = client.omnichannelPath(
          'projectValue',
          'locationValue',
          'omnichannelValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.omnichannelPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromOmnichannelName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.omnichannelPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('toolset', async () => {
      ...
      await client.initialize();
      client.pathTemplates.toolsetPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.toolsetPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('toolsetPath', () => {
        const result = client.toolsetPath(
          'projectValue',
          'locationValue',
          'appValue',
          'toolsetValue',
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.toolsetPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromToolsetName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.toolsetPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
