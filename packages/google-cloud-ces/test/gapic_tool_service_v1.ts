...
describe('v1.ToolServiceClient', () => {
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new toolserviceModule.v1.ToolServiceClient({
          universe_domain: 'example.com',
    ...
    it('invokes executeTool without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.executeTool(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1.IExecuteToolResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes retrieveToolSchema without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.retrieveToolSchema(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1.IRetrieveToolSchemaResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes retrieveTools without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.retrieveTools(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1.IRetrieveToolsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
