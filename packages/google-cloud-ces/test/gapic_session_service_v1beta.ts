...
describe('v1beta.SessionServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          sessionserviceModule.v1beta.SessionServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          sessionserviceModule.v1beta.SessionServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'ces.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new sessionserviceModule.v1beta.SessionServiceClient({
          universe_domain: 'example.com',
  ...
  describe('runSession', () => {
    it('invokes runSession without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.RunSessionRequest',
        ['config', 'session'],
      );
      ...
      const actualRequest = (
        client.innerApiCalls.runSession as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes runSession without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.runSession(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1beta.IRunSessionResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes runSession with error', async () => {
      ...
      client.innerApiCalls.runSession = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('streamRunSession', () => {
    it('invokes streamRunSession without error', async () => {
      ...
      client.innerApiCalls.streamRunSession =
        stubServerStreamingCall(expectedResponse);
      const stream = client.streamRunSession(request);
      const promise = new Promise((resolve, reject) => {
        stream.on(
          'data',
          (response: protos.google.cloud.ces.v1beta.RunSessionResponse) => {
            resolve(response);
          },
        );
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.streamRunSession as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.streamRunSession as SinonStub
    ...
    it('invokes streamRunSession with error', async () => {
      ...
      const expectedHeaderRequestParams = `config.session=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.streamRunSession = stubServerStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.streamRunSession(request);
  ...
  describe('bidiRunSession', () => {
    it('invokes bidiRunSession without error', async () => {
      ...
      client.innerApiCalls.bidiRunSession =
      ...
      const promise = new Promise((resolve, reject) => {
        stream.on(
          'data',
          (
            response: protos.google.cloud.ces.v1beta.BidiSessionServerMessage,
          ) => {
            resolve(response);
          },
        );
      ...
      assert.deepStrictEqual(response, expectedResponse);
      assert(
        (client.innerApiCalls.bidiRunSession as SinonStub)
          .getCall(0)
          .calledWith(null),
      );
    ...
    it('invokes bidiRunSession with error', async () => {
      ...
      const expectedError = new Error('expected');
      client.innerApiCalls.bidiRunSession = stubBidiStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.bidiRunSession();
  ...
  describe('Path templates', () => {
    ...
    describe('evaluationDataset', async () => {
      ...
      await client.initialize();
      client.pathTemplates.evaluationDatasetPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.evaluationDatasetPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('evaluationDatasetPath', () => {
        const result = client.evaluationDatasetPath(
          'projectValue',
          'locationValue',
          'appValue',
          'evaluationDatasetValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.evaluationDatasetPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchEvaluationDatasetFromEvaluationDatasetName', () => {
        const result =
          client.matchEvaluationDatasetFromEvaluationDatasetName(fakePath);
    ...
    describe('evaluationExpectation', async () => {
      ...
      await client.initialize();
      client.pathTemplates.evaluationExpectationPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.evaluationExpectationPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('evaluationExpectationPath', () => {
        const result = client.evaluationExpectationPath(
          'projectValue',
          'locationValue',
          'appValue',
        ...
        assert(
          (
            client.pathTemplates.evaluationExpectationPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromEvaluationExpectationName', () => {
        const result =
          client.matchProjectFromEvaluationExpectationName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.evaluationExpectationPathTemplate
      ...
      it('matchLocationFromEvaluationExpectationName', () => {
        const result =
          client.matchLocationFromEvaluationExpectationName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.evaluationExpectationPathTemplate
      ...
      it('matchEvaluationExpectationFromEvaluationExpectationName', () => {
        const result =
          client.matchEvaluationExpectationFromEvaluationExpectationName(
            fakePath,
          );
    ...
    describe('evaluationResult', async () => {
      ...
      await client.initialize();
      client.pathTemplates.evaluationResultPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.evaluationResultPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);
      ...
      it('evaluationResultPath', () => {
        ...
        assert(
          (
            client.pathTemplates.evaluationResultPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromEvaluationResultName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.evaluationResultPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchEvaluationResultFromEvaluationResultName', () => {
        const result =
          client.matchEvaluationResultFromEvaluationResultName(fakePath);
    ...
    describe('evaluationRun', async () => {
      ...
      await client.initialize();
      client.pathTemplates.evaluationRunPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.evaluationRunPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('evaluationRunPath', () => {
        const result = client.evaluationRunPath(
          'projectValue',
          'locationValue',
          'appValue',
          'evaluationRunValue',
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.evaluationRunPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromEvaluationRunName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.evaluationRunPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('scheduledEvaluationRun', async () => {
      ...
      await client.initialize();
      client.pathTemplates.scheduledEvaluationRunPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.scheduledEvaluationRunPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('scheduledEvaluationRunPath', () => {
        const result = client.scheduledEvaluationRunPath(
          'projectValue',
          'locationValue',
          'appValue',
          'scheduledEvaluationRunValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.scheduledEvaluationRunPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromScheduledEvaluationRunName', () => {
        const result =
          client.matchProjectFromScheduledEvaluationRunName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.scheduledEvaluationRunPathTemplate
      ...
      it('matchLocationFromScheduledEvaluationRunName', () => {
        const result =
          client.matchLocationFromScheduledEvaluationRunName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.scheduledEvaluationRunPathTemplate
      ...
      it('matchScheduledEvaluationRunFromScheduledEvaluationRunName', () => {
        const result =
          client.matchScheduledEvaluationRunFromScheduledEvaluationRunName(
            fakePath,
          );
