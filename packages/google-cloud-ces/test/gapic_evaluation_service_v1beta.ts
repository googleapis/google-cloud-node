...
describe('v1beta.EvaluationServiceClient', () => {
  ...
  describe('uploadEvaluationAudio', () => {
    it('invokes uploadEvaluationAudio without error', async () => {
      ...
      client.innerApiCalls.uploadEvaluationAudio =
        stubSimpleCall(expectedResponse);
      const [response] = await client.uploadEvaluationAudio(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.uploadEvaluationAudio as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes uploadEvaluationAudio without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.uploadEvaluationAudio(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1beta.IUploadEvaluationAudioResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes uploadEvaluationAudio with error', async () => {
      ...
      client.innerApiCalls.uploadEvaluationAudio = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.uploadEvaluationAudio(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.uploadEvaluationAudio as SinonStub
  ...
  describe('createEvaluation', () => {
    ...
    it('invokes createEvaluation without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createEvaluation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1beta.IEvaluation | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createEvaluation with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createEvaluation = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createEvaluationDataset', () => {
    it('invokes createEvaluationDataset without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.CreateEvaluationDatasetRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.createEvaluationDataset =
        stubSimpleCall(expectedResponse);
      const [response] = await client.createEvaluationDataset(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createEvaluationDataset as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createEvaluationDataset as SinonStub
    ...
    it('invokes createEvaluationDataset without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createEvaluationDataset(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1beta.IEvaluationDataset | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createEvaluationDataset with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createEvaluationDataset = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createEvaluationDataset(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createEvaluationDataset as SinonStub
  ...
  describe('updateEvaluation', () => {
    it('invokes updateEvaluation without error', async () => {
      ...
      request.evaluation ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.UpdateEvaluationRequest',
        ['evaluation', 'name'],
      );
    ...
    it('invokes updateEvaluation with error', async () => {
      ...
      const expectedHeaderRequestParams = `evaluation.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateEvaluation = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateEvaluationDataset', () => {
    it('invokes updateEvaluationDataset without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.UpdateEvaluationDatasetRequest',
      ...
      client.innerApiCalls.updateEvaluationDataset =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateEvaluationDataset(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateEvaluationDataset as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateEvaluationDataset as SinonStub
    ...
    it('invokes updateEvaluationDataset with error', async () => {
      ...
      const expectedHeaderRequestParams = `evaluation_dataset.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateEvaluationDataset = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateEvaluationDataset(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateEvaluationDataset as SinonStub
  ...
  describe('deleteEvaluation', () => {
    ...
    it('invokes deleteEvaluation with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteEvaluation = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteEvaluationResult', () => {
    it('invokes deleteEvaluationResult without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.DeleteEvaluationResultRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.deleteEvaluationResult =
        stubSimpleCall(expectedResponse);
      const [response] = await client.deleteEvaluationResult(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteEvaluationResult as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteEvaluationResult as SinonStub
    ...
    it('invokes deleteEvaluationResult with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteEvaluationResult = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteEvaluationResult(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteEvaluationResult as SinonStub
  ...
  describe('deleteEvaluationDataset', () => {
    it('invokes deleteEvaluationDataset without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.DeleteEvaluationDatasetRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.deleteEvaluationDataset =
        stubSimpleCall(expectedResponse);
      const [response] = await client.deleteEvaluationDataset(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteEvaluationDataset as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteEvaluationDataset as SinonStub
    ...
    it('invokes deleteEvaluationDataset with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteEvaluationDataset = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteEvaluationDataset(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteEvaluationDataset as SinonStub
  ...
  describe('getEvaluation', () => {
    it('invokes getEvaluation without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.GetEvaluationRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('getEvaluationResult', () => {
    it('invokes getEvaluationResult without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.GetEvaluationResultRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.getEvaluationResult =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getEvaluationResult(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getEvaluationResult as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getEvaluationResult as SinonStub
    ...
    it('invokes getEvaluationResult without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getEvaluationResult(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1beta.IEvaluationResult | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getEvaluationResult with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getEvaluationResult = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getEvaluationDataset', () => {
    it('invokes getEvaluationDataset without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.GetEvaluationDatasetRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.getEvaluationDataset =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getEvaluationDataset(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getEvaluationDataset as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getEvaluationDataset as SinonStub
    ...
    it('invokes getEvaluationDataset with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getEvaluationDataset = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getEvaluationRun', () => {
    it('invokes getEvaluationRun without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.GetEvaluationRunRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getEvaluationRun as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getEvaluationRun as SinonStub
    ...
    it('invokes getEvaluationRun without error using callback', async () => {
      ...
      client.innerApiCalls.getEvaluationRun =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getEvaluationRun(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1beta.IEvaluationRun | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getEvaluationRun with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getEvaluationRun = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getEvaluationExpectation', () => {
    it('invokes getEvaluationExpectation without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.GetEvaluationExpectationRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.getEvaluationExpectation =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getEvaluationExpectation(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getEvaluationExpectation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getEvaluationExpectation as SinonStub
    ...
    it('invokes getEvaluationExpectation without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getEvaluationExpectation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1beta.IEvaluationExpectation | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getEvaluationExpectation with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getEvaluationExpectation = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getEvaluationExpectation(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getEvaluationExpectation as SinonStub
  ...
  describe('createEvaluationExpectation', () => {
    it('invokes createEvaluationExpectation without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.CreateEvaluationExpectationRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createEvaluationExpectation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createEvaluationExpectation as SinonStub
    ...
    it('invokes createEvaluationExpectation with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createEvaluationExpectation = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createEvaluationExpectation(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createEvaluationExpectation as SinonStub
  ...
  describe('updateEvaluationExpectation', () => {
    it('invokes updateEvaluationExpectation without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.UpdateEvaluationExpectationRequest',
      ...
      client.innerApiCalls.updateEvaluationExpectation =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateEvaluationExpectation(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateEvaluationExpectation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateEvaluationExpectation as SinonStub
    ...
    it('invokes updateEvaluationExpectation with error', async () => {
      ...
      const expectedHeaderRequestParams = `evaluation_expectation.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateEvaluationExpectation = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateEvaluationExpectation(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateEvaluationExpectation as SinonStub
  ...
  describe('deleteEvaluationExpectation', () => {
    it('invokes deleteEvaluationExpectation without error', async () => {
      ...
      client.innerApiCalls.deleteEvaluationExpectation =
        stubSimpleCall(expectedResponse);
      const [response] = await client.deleteEvaluationExpectation(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteEvaluationExpectation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteEvaluationExpectation as SinonStub
    ...
    it('invokes deleteEvaluationExpectation with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteEvaluationExpectation = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteEvaluationExpectation(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteEvaluationExpectation as SinonStub
  ...
  describe('createScheduledEvaluationRun', () => {
    it('invokes createScheduledEvaluationRun without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createScheduledEvaluationRun as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createScheduledEvaluationRun as SinonStub
    ...
    it('invokes createScheduledEvaluationRun without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createScheduledEvaluationRun(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1beta.IScheduledEvaluationRun | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createScheduledEvaluationRun with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createScheduledEvaluationRun = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createScheduledEvaluationRun(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createScheduledEvaluationRun as SinonStub
  ...
  describe('getScheduledEvaluationRun', () => {
    it('invokes getScheduledEvaluationRun without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getScheduledEvaluationRun as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getScheduledEvaluationRun as SinonStub
    ...
    it('invokes getScheduledEvaluationRun with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getScheduledEvaluationRun = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getScheduledEvaluationRun(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getScheduledEvaluationRun as SinonStub
  ...
  describe('updateScheduledEvaluationRun', () => {
    it('invokes updateScheduledEvaluationRun without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.UpdateScheduledEvaluationRunRequest',
      ...
      client.innerApiCalls.updateScheduledEvaluationRun =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateScheduledEvaluationRun(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateScheduledEvaluationRun as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateScheduledEvaluationRun as SinonStub
    ...
    it('invokes updateScheduledEvaluationRun with error', async () => {
      ...
      const expectedHeaderRequestParams = `scheduled_evaluation_run.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateScheduledEvaluationRun = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateScheduledEvaluationRun(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateScheduledEvaluationRun as SinonStub
  ...
  describe('deleteScheduledEvaluationRun', () => {
    it('invokes deleteScheduledEvaluationRun without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.DeleteScheduledEvaluationRunRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.deleteScheduledEvaluationRun =
        stubSimpleCall(expectedResponse);
      const [response] = await client.deleteScheduledEvaluationRun(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteScheduledEvaluationRun as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteScheduledEvaluationRun as SinonStub
    ...
    it('invokes deleteScheduledEvaluationRun with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteScheduledEvaluationRun = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteScheduledEvaluationRun(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteScheduledEvaluationRun as SinonStub
  ...
  describe('testPersonaVoice', () => {
    it('invokes testPersonaVoice without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.testPersonaVoice as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.testPersonaVoice as SinonStub
    ...
    it('invokes testPersonaVoice without error using callback', async () => {
      ...
      client.innerApiCalls.testPersonaVoice =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.testPersonaVoice(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1beta.ITestPersonaVoiceResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes testPersonaVoice with error', async () => {
      ...
      const expectedHeaderRequestParams = `app=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.testPersonaVoice = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('generateEvaluation', () => {
    it('invokes generateEvaluation without error', async () => {
      ...
      client.innerApiCalls.generateEvaluation =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.generateEvaluation(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.generateEvaluation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.generateEvaluation as SinonStub
    ...
    it('invokes generateEvaluation with call error', async () => {
      ...
      const expectedHeaderRequestParams = `conversation=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.generateEvaluation = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkGenerateEvaluationProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkGenerateEvaluationProgress(
        expectedResponse.name,
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkGenerateEvaluationProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkGenerateEvaluationProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('importEvaluations', () => {
    it('invokes importEvaluations without error', async () => {
      ...
      client.innerApiCalls.importEvaluations =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.importEvaluations(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.importEvaluations as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.importEvaluations as SinonStub
    ...
    it('invokes importEvaluations with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.importEvaluations = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkImportEvaluationsProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkImportEvaluationsProgress(
        expectedResponse.name,
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('deleteEvaluationRun', () => {
    it('invokes deleteEvaluationRun without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.DeleteEvaluationRunRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteEvaluationRun as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteEvaluationRun as SinonStub
    ...
    it('invokes deleteEvaluationRun with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteEvaluationRun = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkDeleteEvaluationRunProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkDeleteEvaluationRunProgress(
        expectedResponse.name,
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkDeleteEvaluationRunProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteEvaluationRunProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('exportEvaluations', () => {
    it('invokes exportEvaluations without error', async () => {
      const client = new evaluationserviceModule.v1beta.EvaluationServiceClient(
        {
          credentials: { client_email: 'bogus', private_key: 'bogus' },
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.ces.v1beta.ExportEvaluationsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.ExportEvaluationsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.exportEvaluations =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.exportEvaluations(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.exportEvaluations as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.exportEvaluations as SinonStub
    ...
    it('invokes exportEvaluations without error using callback', async () => {
      const client = new evaluationserviceModule.v1beta.EvaluationServiceClient(
        {
          credentials: { client_email: 'bogus', private_key: 'bogus' },
          projectId: 'bogus',
    ...
    it('invokes exportEvaluations with call error', async () => {
      const client = new evaluationserviceModule.v1beta.EvaluationServiceClient(
        {
          credentials: { client_email: 'bogus', private_key: 'bogus' },
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.exportEvaluations = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.exportEvaluations(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.exportEvaluations as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes exportEvaluations with LRO error', async () => {
      const client = new evaluationserviceModule.v1beta.EvaluationServiceClient(
        {
          credentials: { client_email: 'bogus', private_key: 'bogus' },
          projectId: 'bogus',
    ...
    it('invokes checkExportEvaluationsProgress without error', async () => {
      const client = new evaluationserviceModule.v1beta.EvaluationServiceClient(
        {
          credentials: { client_email: 'bogus', private_key: 'bogus' },
          projectId: 'bogus',
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkExportEvaluationsProgress(
        expectedResponse.name,
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkExportEvaluationsProgress with error', async () => {
      const client = new evaluationserviceModule.v1beta.EvaluationServiceClient(
        {
          credentials: { client_email: 'bogus', private_key: 'bogus' },
          projectId: 'bogus',
      ...
      await assert.rejects(
        client.checkExportEvaluationsProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listEvaluations', () => {
    it('invokes listEvaluations without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.ListEvaluationsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
    ...
    it('invokes listEvaluationsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.ces.v1beta.Evaluation) => {
  ...
  describe('listEvaluationResults', () => {
    it('invokes listEvaluationResults without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.ListEvaluationResultsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
    ...
    it('invokes listEvaluationResultsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.ces.v1beta.EvaluationResult) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listEvaluationDatasets', () => {
    it('invokes listEvaluationDatasets without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listEvaluationDatasets as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listEvaluationDatasets as SinonStub
    ...
    it('invokes listEvaluationDatasets with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listEvaluationDatasets = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listEvaluationDatasets(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listEvaluationDatasets as SinonStub
    ...
    it('invokes listEvaluationDatasetsStream without error', async () => {
      ...
      client.descriptors.page.listEvaluationDatasets.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.ces.v1beta.EvaluationDataset) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (
          client.descriptors.page.listEvaluationDatasets
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listEvaluationDatasets, request),
      );
      assert(
        (
          client.descriptors.page.listEvaluationDatasets
    ...
    it('uses async iteration with listEvaluationDatasets without error', async () => {
      ...
      client.descriptors.page.listEvaluationDatasets.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listEvaluationRuns', () => {
    it('invokes listEvaluationRuns without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.ListEvaluationRunsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.listEvaluationRuns =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listEvaluationRuns(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listEvaluationRuns as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listEvaluationRuns as SinonStub
    ...
    it('invokes listEvaluationRuns with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listEvaluationRuns = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listEvaluationRunsStream without error', async () => {
      ...
      client.descriptors.page.listEvaluationRuns.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.ces.v1beta.EvaluationRun) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listEvaluationRuns.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listEvaluationRuns, request),
      );
      assert(
        (client.descriptors.page.listEvaluationRuns.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listEvaluationRuns without error', async () => {
      ...
      client.descriptors.page.listEvaluationRuns.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listEvaluationExpectations', () => {
    it('invokes listEvaluationExpectations without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.ListEvaluationExpectationsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.listEvaluationExpectations =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listEvaluationExpectations(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listEvaluationExpectations as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listEvaluationExpectations as SinonStub
    ...
    it('invokes listEvaluationExpectations with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listEvaluationExpectations = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listEvaluationExpectations(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listEvaluationExpectations as SinonStub
    ...
    it('invokes listEvaluationExpectationsStream without error', async () => {
      ...
      client.descriptors.page.listEvaluationExpectations.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.ces.v1beta.EvaluationExpectation) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (
          client.descriptors.page.listEvaluationExpectations
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listEvaluationExpectations, request),
      );
      assert(
        (
          client.descriptors.page.listEvaluationExpectations
    ...
    it('uses async iteration with listEvaluationExpectations without error', async () => {
      ...
      client.descriptors.page.listEvaluationExpectations.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listScheduledEvaluationRuns', () => {
    it('invokes listScheduledEvaluationRuns without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.ces.v1beta.ListScheduledEvaluationRunsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.listScheduledEvaluationRuns =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listScheduledEvaluationRuns(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listScheduledEvaluationRuns as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listScheduledEvaluationRuns as SinonStub
    ...
    it('invokes listScheduledEvaluationRuns with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listScheduledEvaluationRuns = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listScheduledEvaluationRuns(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listScheduledEvaluationRuns as SinonStub
    ...
    it('invokes listScheduledEvaluationRunsStream without error', async () => {
      ...
      client.descriptors.page.listScheduledEvaluationRuns.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.ces.v1beta.ScheduledEvaluationRun) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
    ...
    it('uses async iteration with listScheduledEvaluationRuns without error', async () => {
      ...
      client.descriptors.page.listScheduledEvaluationRuns.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
