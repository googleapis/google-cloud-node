    ...
    it('invokes runSession without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.runSession(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.ces.v1.IRunSessionResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('streamRunSession', () => {
    it('invokes streamRunSession without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        stream.on(
          'data',
          (response: protos.google.cloud.ces.v1.RunSessionResponse) => {
            resolve(response);
          },
        );
  ...
  describe('bidiRunSession', () => {
    it('invokes bidiRunSession without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        stream.on(
          'data',
          (response: protos.google.cloud.ces.v1.BidiSessionServerMessage) => {
            resolve(response);
          },
        );
        stream.on('error', (err: Error) => {
