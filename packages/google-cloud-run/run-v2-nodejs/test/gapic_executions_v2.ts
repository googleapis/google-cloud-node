...
describe('v2.ExecutionsClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = executionsModule.v2.ExecutionsClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = executionsModule.v2.ExecutionsClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'run.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new executionsModule.v2.ExecutionsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'run.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new executionsModule.v2.ExecutionsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'run.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new executionsModule.v2.ExecutionsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new executionsModule.v2.ExecutionsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = executionsModule.v2.ExecutionsClient.port;
            assert(port);
    ...
    describe('getExecution', () => {
        it('invokes getExecution without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.run.v2.GetExecutionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.run.v2.GetExecutionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.run.v2.Execution()
            );
        ...
        it('invokes getExecution without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getExecution(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.run.v2.IExecution|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deleteExecution', () => {
        it('invokes deleteExecution without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.run.v2.DeleteExecutionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.run.v2.DeleteExecutionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes deleteExecution without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deleteExecution(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.run.v2.IExecution, protos.google.cloud.run.v2.IExecution>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.run.v2.IExecution, protos.google.cloud.run.v2.IExecution>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteExecution as SinonStub)
                .getCall(0).args[0];
    ...
    describe('cancelExecution', () => {
        it('invokes cancelExecution without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.run.v2.CancelExecutionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.run.v2.CancelExecutionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.cancelExecution = stubLongRunningCall(expectedResponse);
            const [operation] = await client.cancelExecution(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.cancelExecution as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.cancelExecution as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes cancelExecution without error using callback', async () => {
            ...
            client.innerApiCalls.cancelExecution = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes cancelExecution with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.cancelExecution = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes cancelExecution with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.cancelExecution = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.cancelExecution(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.cancelExecution as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkCancelExecutionProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkCancelExecutionProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkCancelExecutionProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkCancelExecutionProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listExecutions', () => {
        it('invokes listExecutions without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.run.v2.ListExecutionsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.run.v2.ListExecutionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.run.v2.Execution()),
              generateSampleMessage(new protos.google.cloud.run.v2.Execution()),
              generateSampleMessage(new protos.google.cloud.run.v2.Execution()),
            ];
        ...
        it('invokes listExecutionsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.run.v2.Execution[] = [];
                stream.on('data', (response: protos.google.cloud.run.v2.Execution) => {
        ...
        it('uses async iteration with listExecutions without error', async () => {
            ...
            const responses: protos.google.cloud.run.v2.IExecution[] = [];
    ...
    describe('Path templates', () => {
        ...
        describe('execution', async () => {
            ...
            it('executionPath', () => {
                const result = client.executionPath("projectValue", "locationValue", "jobValue", "executionValue");
        ...
        describe('task', async () => {
            ...
            it('taskPath', () => {
                const result = client.taskPath("projectValue", "locationValue", "jobValue", "executionValue", "taskValue");
                assert.strictEqual(result, fakePath);
