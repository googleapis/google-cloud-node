...
describe('v2.BuildsClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new buildsModule.v2.BuildsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'run.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new buildsModule.v2.BuildsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'run.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new buildsModule.v2.BuildsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new buildsModule.v2.BuildsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('submitBuild', () => {
        it('invokes submitBuild without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.run.v2.SubmitBuildRequest', ['parent']);
            ...
            const actualRequest = (client.innerApiCalls.submitBuild as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.submitBuild as SinonStub)
        ...
        it('invokes submitBuild without error using callback', async () => {
            ...
            client.innerApiCalls.submitBuild = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.submitBuild(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.run.v2.ISubmitBuildResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes submitBuild with error', async () => {
            ...
            client.innerApiCalls.submitBuild = stubSimpleCall(undefined, expectedError);
