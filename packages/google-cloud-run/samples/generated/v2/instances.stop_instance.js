...
function main(name) {
  // [START run_v2_generated_Instances_StopInstance_async]
  /**
  ...
  async function callStopInstance() {
    ...
    // Run request
    const [operation] = await runClient.stopInstance(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callStopInstance();
  // [END run_v2_generated_Instances_StopInstance_async]
}
