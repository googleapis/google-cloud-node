...
function main(parent, instance, instanceId) {
  // [START run_v2_generated_Instances_CreateInstance_async]
  /**
  ...
  async function callCreateInstance() {
    ...
    // Run request
    const [operation] = await runClient.createInstance(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callCreateInstance();
  // [END run_v2_generated_Instances_CreateInstance_async]
}
