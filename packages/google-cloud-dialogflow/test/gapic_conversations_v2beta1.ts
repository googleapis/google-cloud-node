...
describe('v2beta1.ConversationsClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          conversationsModule.v2beta1.ConversationsClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          conversationsModule.v2beta1.ConversationsClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new conversationsModule.v2beta1.ConversationsClient({
          universe_domain: 'example.com',
    ...
    it('invokes createConversation without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createConversation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2beta1.IConversation | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes ingestContextReferences without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.ingestContextReferences(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2beta1.IIngestContextReferencesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('batchCreateMessages', () => {
    it('invokes batchCreateMessages without error', async () => {
      ...
      client.innerApiCalls.batchCreateMessages =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchCreateMessages(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchCreateMessages as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchCreateMessages as SinonStub
    ...
    it('invokes batchCreateMessages without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchCreateMessages(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2beta1.IBatchCreateMessagesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchCreateMessages with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchCreateMessages = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes generateStatelessSummary without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.generateStatelessSummary(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2beta1.IGenerateStatelessSummaryResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes generateStatelessSuggestion without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.generateStatelessSuggestion(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2beta1.IGenerateStatelessSuggestionResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes searchKnowledge without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.searchKnowledge(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2beta1.ISearchKnowledgeResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes generateSuggestions without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.generateSuggestions(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2beta1.IGenerateSuggestionsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listConversations', () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listConversations(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.dialogflow.v2beta1.IConversation[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listConversationsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.v2beta1.Conversation) => {
  ...
  describe('listMessages', () => {
    it('invokes listMessages without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.dialogflow.v2beta1.Message(),
        ),
        generateSampleMessage(
          new protos.google.cloud.dialogflow.v2beta1.Message(),
        ),
    ...
    it('invokes listMessages without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listMessages(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2beta1.IMessage[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listMessagesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.v2beta1.Message) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
