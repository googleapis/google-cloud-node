...
describe('v2beta1.ParticipantsClient', () => {
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new participantsModule.v2beta1.ParticipantsClient({
          universe_domain: 'example.com',
  ...
  describe('createParticipant', () => {
    ...
    it('invokes createParticipant without error using callback', async () => {
      ...
      client.innerApiCalls.createParticipant =
  ...
  describe('updateParticipant', () => {
    ...
    it('invokes updateParticipant without error using callback', async () => {
      ...
      client.innerApiCalls.updateParticipant =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
  ...
  describe('suggestArticles', () => {
    ...
    it('invokes suggestArticles without error using callback', async () => {
      ...
      client.innerApiCalls.suggestArticles =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
  ...
  describe('suggestFaqAnswers', () => {
    ...
    it('invokes suggestFaqAnswers without error using callback', async () => {
      ...
      client.innerApiCalls.suggestFaqAnswers =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
  ...
  describe('suggestSmartReplies', () => {
    it('invokes suggestSmartReplies without error', async () => {
      ...
      client.innerApiCalls.suggestSmartReplies =
  ...
  describe('suggestKnowledgeAssist', () => {
    it('invokes suggestKnowledgeAssist without error', async () => {
      ...
      client.innerApiCalls.suggestKnowledgeAssist =
        stubSimpleCall(expectedResponse);
      const [response] = await client.suggestKnowledgeAssist(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.suggestKnowledgeAssist as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.suggestKnowledgeAssist as SinonStub
    ...
    it('invokes suggestKnowledgeAssist without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.suggestKnowledgeAssist(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2beta1.ISuggestKnowledgeAssistResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('compileSuggestion', () => {
    ...
    it('invokes compileSuggestion without error using callback', async () => {
      ...
      client.innerApiCalls.compileSuggestion =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes bidiStreamingAnalyzeContent without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        stream.on(
          'data',
          (
            response: protos.google.cloud.dialogflow.v2beta1.BidiStreamingAnalyzeContentResponse,
          ) => {
            resolve(response);
          },
        );
  ...
  describe('listSuggestions', () => {
    ...
    it('invokes listSuggestions without error using callback', async () => {
      ...
      client.innerApiCalls.listSuggestions =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listSuggestionsStream without error', async () => {
      ...
      client.descriptors.page.listSuggestions.createStream =
        stubPageStreamingCall(expectedResponse);
    ...
    it('uses async iteration with listSuggestions without error', async () => {
      ...
      client.descriptors.page.listSuggestions.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
