...
describe('v2beta1.ParticipantsClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = participantsModule.v2beta1.ParticipantsClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = participantsModule.v2beta1.ParticipantsClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new participantsModule.v2beta1.ParticipantsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new participantsModule.v2beta1.ParticipantsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new participantsModule.v2beta1.ParticipantsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new participantsModule.v2beta1.ParticipantsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = participantsModule.v2beta1.ParticipantsClient.port;
            assert(port);
    ...
    describe('createParticipant', () => {
        it('invokes createParticipant without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.CreateParticipantRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.Participant()
            );
        ...
        it('invokes createParticipant without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createParticipant(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2beta1.IParticipant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getParticipant', () => {
        it('invokes getParticipant without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.GetParticipantRequest', ['name']);
    ...
    describe('updateParticipant', () => {
        it('invokes updateParticipant without error', async () => {
            ...
            request.participant ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.UpdateParticipantRequest', ['participant', 'name']);
    ...
    describe('analyzeContent', () => {
        it('invokes analyzeContent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.AnalyzeContentRequest', ['participant']);
            request.participant = defaultValue1;
            const expectedHeaderRequestParams = `participant=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.AnalyzeContentResponse()
            );
        ...
        it('invokes analyzeContent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.analyzeContent(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2beta1.IAnalyzeContentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('suggestArticles', () => {
        it('invokes suggestArticles without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.SuggestArticlesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.SuggestArticlesResponse()
            );
        ...
        it('invokes suggestArticles without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.suggestArticles(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2beta1.ISuggestArticlesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('suggestFaqAnswers', () => {
        it('invokes suggestFaqAnswers without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.SuggestFaqAnswersRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.SuggestFaqAnswersResponse()
            );
        ...
        it('invokes suggestFaqAnswers without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.suggestFaqAnswers(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2beta1.ISuggestFaqAnswersResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('suggestSmartReplies', () => {
        it('invokes suggestSmartReplies without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.SuggestSmartRepliesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.SuggestSmartRepliesResponse()
            );
        ...
        it('invokes suggestSmartReplies without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.suggestSmartReplies(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2beta1.ISuggestSmartRepliesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('suggestKnowledgeAssist', () => {
        it('invokes suggestKnowledgeAssist without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.SuggestKnowledgeAssistRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.SuggestKnowledgeAssistRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.SuggestKnowledgeAssistResponse()
            );
            client.innerApiCalls.suggestKnowledgeAssist = stubSimpleCall(expectedResponse);
            const [response] = await client.suggestKnowledgeAssist(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.suggestKnowledgeAssist as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.suggestKnowledgeAssist as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes suggestKnowledgeAssist without error using callback', async () => {
            ...
            client.innerApiCalls.suggestKnowledgeAssist = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.suggestKnowledgeAssist(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2beta1.ISuggestKnowledgeAssistResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes suggestKnowledgeAssist with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.suggestKnowledgeAssist = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.suggestKnowledgeAssist(request), expectedError);
            const actualRequest = (client.innerApiCalls.suggestKnowledgeAssist as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.suggestKnowledgeAssist as SinonStub)
    ...
    describe('compileSuggestion', () => {
        it('invokes compileSuggestion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.CompileSuggestionRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.CompileSuggestionResponse()
            );
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.compileSuggestion as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.compileSuggestion as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes compileSuggestion without error using callback', async () => {
            ...
            client.innerApiCalls.compileSuggestion = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.compileSuggestion(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2beta1.ICompileSuggestionResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes compileSuggestion with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.compileSuggestion = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes compileSuggestion with closed client', async () => {
            const client = new participantsModule.v2beta1.ParticipantsClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('streamingAnalyzeContent', () => {
        it('invokes streamingAnalyzeContent without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.dialogflow.v2beta1.StreamingAnalyzeContentResponse) => {
                    resolve(response);
                });
    ...
    describe('listParticipants', () => {
        it('invokes listParticipants without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.ListParticipantsRequest', ['parent']);
            request.parent = defaultValue1;
        ...
        it('invokes listParticipantsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2beta1.Participant[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2beta1.Participant) => {
        ...
        it('uses async iteration with listParticipants without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.v2beta1.IParticipant[] = [];
    ...
    describe('listSuggestions', () => {
        it('invokes listSuggestions without error', async () => {
            const client = new participantsModule.v2beta1.ParticipantsClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.ListSuggestionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
            ...
            assert(stub.calledOnce);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listSuggestions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listSuggestions as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes listSuggestions without error using callback', async () => {
            const client = new participantsModule.v2beta1.ParticipantsClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listSuggestions = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listSuggestions(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2beta1.ISuggestion[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listSuggestions with error', async () => {
            const client = new participantsModule.v2beta1.ParticipantsClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listSuggestions = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listSuggestionsStream without error', async () => {
            const client = new participantsModule.v2beta1.ParticipantsClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listSuggestions.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listSuggestionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2beta1.Suggestion[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2beta1.Suggestion) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            assert(stub.calledOnce);
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listSuggestions.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listSuggestions, request));
            assert(
        ...
        it('invokes listSuggestionsStream with error', async () => {
            const client = new participantsModule.v2beta1.ParticipantsClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listSuggestions.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listSuggestionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2beta1.Suggestion[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2beta1.Suggestion) => {
        ...
        it('uses async iteration with listSuggestions without error', async () => {
            ...
            client.descriptors.page.listSuggestions.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.dialogflow.v2beta1.ISuggestion[] = [];
        ...
        it('uses async iteration with listSuggestions with error', async () => {
            const client = new participantsModule.v2beta1.ParticipantsClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listSuggestions.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listSuggestionsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.dialogflow.v2beta1.ISuggestion[] = [];
                for await (const resource of iterable) {
