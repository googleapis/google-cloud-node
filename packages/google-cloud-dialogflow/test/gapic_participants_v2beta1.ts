...
describe('v2beta1.ParticipantsClient', () => {
  it('has servicePath', () => {
    const servicePath =
      participantsModule.v2beta1.ParticipantsClient.servicePath;
    assert(servicePath);
  });

  it('has apiEndpoint', () => {
    const apiEndpoint =
      participantsModule.v2beta1.ParticipantsClient.apiEndpoint;
    assert(apiEndpoint);
  });
  ...
  describe('createParticipant', () => {
    ...
    it('invokes createParticipant without error using callback', async () => {
      ...
      client.innerApiCalls.createParticipant = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.createParticipant(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2beta1.IParticipant | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getParticipant', () => {
    ...
    it('invokes getParticipant without error using callback', async () => {
      ...
      client.innerApiCalls.getParticipant = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('updateParticipant', () => {
    ...
    it('invokes updateParticipant without error using callback', async () => {
      ...
      client.innerApiCalls.updateParticipant = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('analyzeContent', () => {
    ...
    it('invokes analyzeContent without error using callback', async () => {
      ...
      client.innerApiCalls.analyzeContent = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.analyzeContent(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2beta1.IAnalyzeContentResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('suggestArticles', () => {
    ...
    it('invokes suggestArticles without error using callback', async () => {
      ...
      client.innerApiCalls.suggestArticles = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.suggestArticles(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2beta1.ISuggestArticlesResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('suggestFaqAnswers', () => {
    ...
    it('invokes suggestFaqAnswers without error using callback', async () => {
      ...
      client.innerApiCalls.suggestFaqAnswers = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.suggestFaqAnswers(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2beta1.ISuggestFaqAnswersResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes suggestSmartReplies without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.suggestSmartReplies(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2beta1.ISuggestSmartRepliesResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('compileSuggestion', () => {
    ...
    it('invokes compileSuggestion without error using callback', async () => {
      ...
      client.innerApiCalls.compileSuggestion = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.compileSuggestion(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2beta1.ICompileSuggestionResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes compileSuggestion with error', async () => {
      ...
      const expectedError = new Error('expected');
      client.innerApiCalls.compileSuggestion = stubSimpleCall(
        undefined,
        expectedError
      );
  ...
  describe('listParticipants', () => {
    ...
    it('invokes listParticipants without error using callback', async () => {
      ...
      client.innerApiCalls.listParticipants = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listParticipantsStream without error', async () => {
      ...
      client.descriptors.page.listParticipants.createStream = stubPageStreamingCall(
        expectedResponse
      );
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.v2beta1.Participant) => {
      ...
      assert.strictEqual(
        (client.descriptors.page.listParticipants
    ...
    it('uses async iteration with listParticipants without error', async () => {
      ...
      client.descriptors.page.listParticipants.asyncIterate = stubAsyncIterationCall(
        expectedResponse
      );
  ...
  describe('listSuggestions', () => {
    it('invokes listSuggestions without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.dialogflow.v2beta1.Suggestion()
        ),
        generateSampleMessage(
          new protos.google.cloud.dialogflow.v2beta1.Suggestion()
        ),
    ...
    it('invokes listSuggestions without error using callback', async () => {
      ...
      client.innerApiCalls.listSuggestions = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.listSuggestions(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2beta1.ISuggestion[] | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listSuggestions with error', async () => {
      ...
      const expectedError = new Error('expected');
      client.innerApiCalls.listSuggestions = stubSimpleCall(
        undefined,
        expectedError
      );
    ...
    it('invokes listSuggestionsStream without error', async () => {
      ...
      client.descriptors.page.listSuggestions.createStream = stubPageStreamingCall(
        expectedResponse
      );
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.v2beta1.Suggestion) => {
            responses.push(response);
          }
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listSuggestions.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listSuggestions, request)
      );
      assert.strictEqual(
        (client.descriptors.page.listSuggestions
          .createStream as SinonStub).getCall(0).args[2].otherArgs.headers[
          'x-goog-request-params'
        ],
        expectedHeaderRequestParams
    ...
    it('uses async iteration with listSuggestions without error', async () => {
      ...
      client.descriptors.page.listSuggestions.asyncIterate = stubAsyncIterationCall(
        expectedResponse
      );
