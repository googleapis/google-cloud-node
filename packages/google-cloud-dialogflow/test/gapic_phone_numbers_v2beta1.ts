...
describe('v2beta1.PhoneNumbersClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          phonenumbersModule.v2beta1.PhoneNumbersClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          phonenumbersModule.v2beta1.PhoneNumbersClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new phonenumbersModule.v2beta1.PhoneNumbersClient({
          universe_domain: 'example.com',
  ...
  describe('updatePhoneNumber', () => {
    it('invokes updatePhoneNumber without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.updatePhoneNumber as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes updatePhoneNumber without error using callback', async () => {
      ...
      client.innerApiCalls.updatePhoneNumber =
      ...
      const promise = new Promise((resolve, reject) => {
        client.updatePhoneNumber(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2beta1.IPhoneNumber | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes updatePhoneNumber with error', async () => {
      ...
      client.innerApiCalls.updatePhoneNumber = stubSimpleCall(
        undefined,
        expectedError
      );
  ...
  describe('deletePhoneNumber', () => {
    it('invokes deletePhoneNumber without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deletePhoneNumber as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deletePhoneNumber as SinonStub
    ...
    it('invokes deletePhoneNumber without error using callback', async () => {
      ...
      client.innerApiCalls.deletePhoneNumber =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes deletePhoneNumber with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deletePhoneNumber = stubSimpleCall(
        undefined,
        expectedError
      );
  ...
  describe('undeletePhoneNumber', () => {
    it('invokes undeletePhoneNumber without error', async () => {
      ...
      client.innerApiCalls.undeletePhoneNumber =
        stubSimpleCall(expectedResponse);
      const [response] = await client.undeletePhoneNumber(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.undeletePhoneNumber as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.undeletePhoneNumber as SinonStub
    ...
    it('invokes undeletePhoneNumber with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.undeletePhoneNumber = stubSimpleCall(
        undefined,
        expectedError
      );
  ...
  describe('listPhoneNumbers', () => {
    it('invokes listPhoneNumbers without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listPhoneNumbers as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listPhoneNumbers as SinonStub
    ...
    it('invokes listPhoneNumbers without error using callback', async () => {
      ...
      client.innerApiCalls.listPhoneNumbers =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listPhoneNumbers with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listPhoneNumbers = stubSimpleCall(
        undefined,
        expectedError
      );
    ...
    it('invokes listPhoneNumbersStream without error', async () => {
      ...
      client.descriptors.page.listPhoneNumbers.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.v2beta1.PhoneNumber) => {
      ...
      assert(
        (client.descriptors.page.listPhoneNumbers.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listPhoneNumbers, request)
      );
      assert(
        (client.descriptors.page.listPhoneNumbers.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listPhoneNumbers without error', async () => {
      ...
      client.descriptors.page.listPhoneNumbers.asyncIterate =
