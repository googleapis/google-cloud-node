...
describe('v2beta1.AnswerRecordsClient', () => {
  ...
  describe('getAnswerRecord', () => {
    it('invokes getAnswerRecord without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('GetAnswerRecordRequest', [
        'name',
      ]);
  ...
  describe('updateAnswerRecord', () => {
    it('invokes updateAnswerRecord without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('UpdateAnswerRecordRequest', [
        'answerRecord',
        'name',
      ]);
  ...
  describe('listAnswerRecords', () => {
    it('invokes listAnswerRecords without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('ListAnswerRecordsRequest', [
        'parent',
      ]);
