...
describe('v2beta1.AnswerRecordsClient', () => {
  ...
  describe('getAnswerRecord', () => {
    ...
    it('invokes getAnswerRecord without error using callback', async () => {
      ...
      client.innerApiCalls.getAnswerRecord = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('updateAnswerRecord', () => {
    ...
    it('invokes updateAnswerRecord without error using callback', async () => {
      ...
      client.innerApiCalls.updateAnswerRecord = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('listAnswerRecords', () => {
    ...
    it('invokes listAnswerRecords without error using callback', async () => {
      ...
      client.innerApiCalls.listAnswerRecords = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listAnswerRecordsStream without error', async () => {
      ...
      client.descriptors.page.listAnswerRecords.createStream = stubPageStreamingCall(
        expectedResponse
      );
      ...
      assert.strictEqual(
        (client.descriptors.page.listAnswerRecords
    ...
    it('uses async iteration with listAnswerRecords without error', async () => {
      ...
      client.descriptors.page.listAnswerRecords.asyncIterate = stubAsyncIterationCall(
        expectedResponse
      );
