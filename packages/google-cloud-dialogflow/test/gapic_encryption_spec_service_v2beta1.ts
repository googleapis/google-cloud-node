...
describe('v2beta1.EncryptionSpecServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new encryptionspecserviceModule.v2beta1.EncryptionSpecServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          encryptionspecserviceModule.v2beta1.EncryptionSpecServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        encryptionspecserviceModule.v2beta1.EncryptionSpecServiceClient.port;
      assert(port);
    ...
    it('invokes getEncryptionSpec without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getEncryptionSpec(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2beta1.IEncryptionSpec | null
          ) => {
            if (err) {
              reject(err);
            } else {
