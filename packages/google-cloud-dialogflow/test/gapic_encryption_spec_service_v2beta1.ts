...
describe('v2beta1.EncryptionSpecServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new encryptionspecserviceModule.v2beta1.EncryptionSpecServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = encryptionspecserviceModule.v2beta1.EncryptionSpecServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = encryptionspecserviceModule.v2beta1.EncryptionSpecServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new encryptionspecserviceModule.v2beta1.EncryptionSpecServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new encryptionspecserviceModule.v2beta1.EncryptionSpecServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new encryptionspecserviceModule.v2beta1.EncryptionSpecServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new encryptionspecserviceModule.v2beta1.EncryptionSpecServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = encryptionspecserviceModule.v2beta1.EncryptionSpecServiceClient.port;
            assert(port);
    ...
    describe('getEncryptionSpec', () => {
        it('invokes getEncryptionSpec without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.GetEncryptionSpecRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.GetEncryptionSpecRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.EncryptionSpec()
            );
        ...
        it('invokes getEncryptionSpec without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getEncryptionSpec(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2beta1.IEncryptionSpec|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('initializeEncryptionSpec', () => {
        it('invokes initializeEncryptionSpec without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.InitializeEncryptionSpecRequest()
            );
            request.encryptionSpec ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.InitializeEncryptionSpecRequest', ['encryptionSpec', 'name']);
        ...
        it('invokes initializeEncryptionSpec without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.initializeEncryptionSpec(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dialogflow.v2beta1.IInitializeEncryptionSpecResponse, protos.google.cloud.dialogflow.v2beta1.IInitializeEncryptionSpecMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dialogflow.v2beta1.IInitializeEncryptionSpecResponse, protos.google.cloud.dialogflow.v2beta1.IInitializeEncryptionSpecMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.initializeEncryptionSpec as SinonStub)
                .getCall(0).args[0];
