...
describe('v2beta1.KnowledgeBasesClient', () => {
    ...
    describe('getKnowledgeBase', () => {
        ...
        it('invokes getKnowledgeBase with error', async () => {
            ...
            await assert.rejects(async () => { await client.getKnowledgeBase(request); }, expectedError);
            assert((client.innerApiCalls.getKnowledgeBase as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createKnowledgeBase', () => {
        ...
        it('invokes createKnowledgeBase with error', async () => {
            ...
            await assert.rejects(async () => { await client.createKnowledgeBase(request); }, expectedError);
            assert((client.innerApiCalls.createKnowledgeBase as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deleteKnowledgeBase', () => {
        ...
        it('invokes deleteKnowledgeBase with error', async () => {
            ...
            await assert.rejects(async () => { await client.deleteKnowledgeBase(request); }, expectedError);
            assert((client.innerApiCalls.deleteKnowledgeBase as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateKnowledgeBase', () => {
        ...
        it('invokes updateKnowledgeBase with error', async () => {
            ...
            await assert.rejects(async () => { await client.updateKnowledgeBase(request); }, expectedError);
            assert((client.innerApiCalls.updateKnowledgeBase as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('listKnowledgeBases', () => {
        ...
        it('invokes listKnowledgeBases with error', async () => {
            ...
            await assert.rejects(async () => { await client.listKnowledgeBases(request); }, expectedError);
            assert((client.innerApiCalls.listKnowledgeBases as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
