...
describe('v2beta1.KnowledgeBasesClient', () => {
  ...
  describe('getKnowledgeBase', () => {
    it('invokes getKnowledgeBase without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('GetKnowledgeBaseRequest', [
        'name',
      ]);
    ...
    it('invokes getKnowledgeBase without error using callback', async () => {
      ...
      client.innerApiCalls.getKnowledgeBase =
  ...
  describe('createKnowledgeBase', () => {
    it('invokes createKnowledgeBase without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('CreateKnowledgeBaseRequest', [
        'parent',
      ]);
      ...
      client.innerApiCalls.createKnowledgeBase =
  ...
  describe('deleteKnowledgeBase', () => {
    it('invokes deleteKnowledgeBase without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('DeleteKnowledgeBaseRequest', [
        'name',
      ]);
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1}`;
      ...
      client.innerApiCalls.deleteKnowledgeBase =
        stubSimpleCall(expectedResponse);
  ...
  describe('updateKnowledgeBase', () => {
    it('invokes updateKnowledgeBase without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('UpdateKnowledgeBaseRequest', [
        'knowledgeBase',
        'name',
      ]);
      ...
      client.innerApiCalls.updateKnowledgeBase =
        stubSimpleCall(expectedResponse);
  ...
  describe('listKnowledgeBases', () => {
    it('invokes listKnowledgeBases without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('ListKnowledgeBasesRequest', [
        'parent',
      ]);
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1}`;
      ...
      client.innerApiCalls.listKnowledgeBases =
        stubSimpleCall(expectedResponse);
