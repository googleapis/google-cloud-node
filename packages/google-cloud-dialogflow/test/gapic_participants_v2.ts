  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          participantsModule.v2.ParticipantsClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          participantsModule.v2.ParticipantsClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new participantsModule.v2.ParticipantsClient({
          universe_domain: 'example.com',
    ...
    it('invokes suggestKnowledgeAssist without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.suggestKnowledgeAssist(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2.ISuggestKnowledgeAssistResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes streamingAnalyzeContent without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        stream.on(
          'data',
          (
            response: protos.google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse
          ) => {
            resolve(response);
          }
        );
