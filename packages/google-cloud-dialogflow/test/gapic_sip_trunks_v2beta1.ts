...
describe('v2beta1.SipTrunksClient', () => {
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new siptrunksModule.v2beta1.SipTrunksClient({
          universe_domain: 'example.com',
    ...
    it('invokes createSipTrunk without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createSipTrunk(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2beta1.ISipTrunk | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listSipTrunks', () => {
    ...
    it('invokes listSipTrunksStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.v2beta1.SipTrunk) => {
