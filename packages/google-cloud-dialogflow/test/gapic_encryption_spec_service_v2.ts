  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          encryptionspecserviceModule.v2.EncryptionSpecServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        encryptionspecserviceModule.v2.EncryptionSpecServiceClient.port;
      assert(port);
    ...
    it('invokes getEncryptionSpec without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getEncryptionSpec(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2.IEncryptionSpec | null
          ) => {
            if (err) {
              reject(err);
            } else {
