...
describe('v2.ToolsClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client = new toolsModule.v2.ToolsClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath = toolsModule.v2.ToolsClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint = toolsModule.v2.ToolsClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new toolsModule.v2.ToolsClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = toolsModule.v2.ToolsClient.port;
      assert(port);
  ...
  describe('createTool', () => {
    it('invokes createTool without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.dialogflow.v2.CreateToolRequest(),
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.dialogflow.v2.Tool(),
      );
    ...
    it('invokes createTool without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createTool(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2.ITool | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getTool', () => {
    it('invokes getTool without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.dialogflow.v2.GetToolRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('deleteTool', () => {
    it('invokes deleteTool without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.dialogflow.v2.DeleteToolRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('updateTool', () => {
    it('invokes updateTool without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.dialogflow.v2.UpdateToolRequest(),
      );
      request.tool ??= {};
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('listTools', () => {
    it('invokes listTools without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.dialogflow.v2.ListToolsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedResponse = [
        generateSampleMessage(new protos.google.cloud.dialogflow.v2.Tool()),
        generateSampleMessage(new protos.google.cloud.dialogflow.v2.Tool()),
        generateSampleMessage(new protos.google.cloud.dialogflow.v2.Tool()),
      ];
    ...
    it('invokes listToolsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.dialogflow.v2.Tool[] = [];
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.v2.Tool) => {
    ...
    it('uses async iteration with listTools without error', async () => {
      ...
      const responses: protos.google.cloud.dialogflow.v2.ITool[] = [];
