...
describe('v2.ToolsClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new toolsModule.v2.ToolsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new toolsModule.v2.ToolsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new toolsModule.v2.ToolsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new toolsModule.v2.ToolsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createTool', () => {
        it('invokes createTool without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.CreateToolRequest', ['parent']);
        ...
        it('invokes createTool without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createTool(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.ITool|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getTool', () => {
        it('invokes getTool without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.GetToolRequest', ['name']);
    ...
    describe('deleteTool', () => {
        it('invokes deleteTool without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.DeleteToolRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateTool', () => {
        it('invokes updateTool without error', async () => {
            ...
            request.tool ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.UpdateToolRequest', ['tool', 'name']);
    ...
    describe('listTools', () => {
        it('invokes listTools without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.ListToolsRequest', ['parent']);
            request.parent = defaultValue1;
        ...
        it('invokes listToolsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.dialogflow.v2.Tool) => {
