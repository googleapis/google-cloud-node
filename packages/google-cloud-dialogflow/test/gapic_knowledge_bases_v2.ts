  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          knowledgebasesModule.v2.KnowledgeBasesClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          knowledgebasesModule.v2.KnowledgeBasesClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new knowledgebasesModule.v2.KnowledgeBasesClient({
          universe_domain: 'example.com',
    ...
    it('invokes getKnowledgeBase without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getKnowledgeBase(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2.IKnowledgeBase | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listKnowledgeBases', () => {
    ...
    it('invokes listKnowledgeBasesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.v2.KnowledgeBase) => {
