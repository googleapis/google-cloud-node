...
describe('v2.ConversationsClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          conversationsModule.v2.ConversationsClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          conversationsModule.v2.ConversationsClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new conversationsModule.v2.ConversationsClient({
          universe_domain: 'example.com',
    ...
    it('invokes suggestConversationSummary without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.suggestConversationSummary(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2.ISuggestConversationSummaryResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('generateStatelessSummary', () => {
    it('invokes generateStatelessSummary without error', async () => {
      ...
      client.innerApiCalls.generateStatelessSummary =
        stubSimpleCall(expectedResponse);
      const [response] = await client.generateStatelessSummary(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.generateStatelessSummary as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.generateStatelessSummary as SinonStub
    ...
    it('invokes generateStatelessSummary without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.generateStatelessSummary(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2.IGenerateStatelessSummaryResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes generateStatelessSummary with error', async () => {
      ...
      const expectedHeaderRequestParams = `stateless_conversation.parent=${defaultValue1}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.generateStatelessSummary = stubSimpleCall(
        undefined,
        expectedError
      );
      await assert.rejects(
  ...
  describe('generateStatelessSuggestion', () => {
    it('invokes generateStatelessSuggestion without error', async () => {
      ...
      client.innerApiCalls.generateStatelessSuggestion =
        stubSimpleCall(expectedResponse);
      const [response] = await client.generateStatelessSuggestion(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.generateStatelessSuggestion as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.generateStatelessSuggestion as SinonStub
    ...
    it('invokes generateStatelessSuggestion without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.generateStatelessSuggestion(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2.IGenerateStatelessSuggestionResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes generateStatelessSuggestion with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.generateStatelessSuggestion = stubSimpleCall(
        undefined,
        expectedError
      );
      await assert.rejects(
