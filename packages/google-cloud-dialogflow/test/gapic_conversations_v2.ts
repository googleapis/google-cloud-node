...
describe('v2.ConversationsClient', () => {
  ...
  describe('createConversation', () => {
    ...
    it('invokes createConversation without error using callback', async () => {
      ...
      client.innerApiCalls.createConversation = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('getConversation', () => {
    ...
    it('invokes getConversation without error using callback', async () => {
      ...
      client.innerApiCalls.getConversation = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('completeConversation', () => {
    ...
    it('invokes completeConversation without error using callback', async () => {
      ...
      client.innerApiCalls.completeConversation = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('createCallMatcher', () => {
    it('invokes createCallMatcher without error', async () => {
      const client = new conversationsModule.v2.ConversationsClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.dialogflow.v2.CreateCallMatcherRequest()
      );
      request.parent = '';
      const expectedHeaderRequestParams = 'parent=';
      const expectedOptions = {
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.dialogflow.v2.CallMatcher()
      );
      client.innerApiCalls.createCallMatcher = stubSimpleCall(expectedResponse);
      const [response] = await client.createCallMatcher(request);
      assert.deepStrictEqual(response, expectedResponse);
      assert(
        (client.innerApiCalls.createCallMatcher as SinonStub)
          .getCall(0)
          .calledWith(request, expectedOptions, undefined)
      );
    });

    it('invokes createCallMatcher without error using callback', async () => {
      const client = new conversationsModule.v2.ConversationsClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.createCallMatcher = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.createCallMatcher(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2.ICallMatcher | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createCallMatcher with error', async () => {
      const client = new conversationsModule.v2.ConversationsClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      const expectedError = new Error('expected');
      client.innerApiCalls.createCallMatcher = stubSimpleCall(
        undefined,
        expectedError
      );
      await assert.rejects(client.createCallMatcher(request), expectedError);
      assert(
        (client.innerApiCalls.createCallMatcher as SinonStub)
          .getCall(0)
          .calledWith(request, expectedOptions, undefined)
  ...
  describe('deleteCallMatcher', () => {
    it('invokes deleteCallMatcher without error', async () => {
      const client = new conversationsModule.v2.ConversationsClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.dialogflow.v2.DeleteCallMatcherRequest()
      );
      request.name = '';
      const expectedHeaderRequestParams = 'name=';
      const expectedOptions = {
      ...
      client.innerApiCalls.deleteCallMatcher = stubSimpleCall(expectedResponse);
      const [response] = await client.deleteCallMatcher(request);
      assert.deepStrictEqual(response, expectedResponse);
      assert(
        (client.innerApiCalls.deleteCallMatcher as SinonStub)
          .getCall(0)
          .calledWith(request, expectedOptions, undefined)
      );
    });

    it('invokes deleteCallMatcher without error using callback', async () => {
      const client = new conversationsModule.v2.ConversationsClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.deleteCallMatcher = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.deleteCallMatcher(
          request,
          (
            err?: Error | null,
    ...
    it('invokes deleteCallMatcher with error', async () => {
      const client = new conversationsModule.v2.ConversationsClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteCallMatcher = stubSimpleCall(
        undefined,
        expectedError
      );
      await assert.rejects(client.deleteCallMatcher(request), expectedError);
      assert(
        (client.innerApiCalls.deleteCallMatcher as SinonStub)
          .getCall(0)
          .calledWith(request, expectedOptions, undefined)
  ...
  describe('listConversations', () => {
    ...
    it('invokes listConversations without error using callback', async () => {
      ...
      client.innerApiCalls.listConversations = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listConversationsStream without error', async () => {
      ...
      client.descriptors.page.listConversations.createStream = stubPageStreamingCall(
        expectedResponse
      );
      ...
      assert.strictEqual(
        (client.descriptors.page.listConversations
    ...
    it('uses async iteration with listConversations without error', async () => {
      ...
      client.descriptors.page.listConversations.asyncIterate = stubAsyncIterationCall(
        expectedResponse
      );
  ...
  describe('listCallMatchers', () => {
    it('invokes listCallMatchers without error', async () => {
      const client = new conversationsModule.v2.ConversationsClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.dialogflow.v2.ListCallMatchersRequest()
      );
      request.parent = '';
      const expectedHeaderRequestParams = 'parent=';
      const expectedOptions = {
      ...
      client.innerApiCalls.listCallMatchers = stubSimpleCall(expectedResponse);
      const [response] = await client.listCallMatchers(request);
      assert.deepStrictEqual(response, expectedResponse);
      assert(
        (client.innerApiCalls.listCallMatchers as SinonStub)
          .getCall(0)
          .calledWith(request, expectedOptions, undefined)
      );
    });

    it('invokes listCallMatchers without error using callback', async () => {
      const client = new conversationsModule.v2.ConversationsClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.listCallMatchers = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.listCallMatchers(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2.ICallMatcher[] | null
    ...
    it('invokes listCallMatchers with error', async () => {
      const client = new conversationsModule.v2.ConversationsClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      const expectedError = new Error('expected');
      client.innerApiCalls.listCallMatchers = stubSimpleCall(
        undefined,
        expectedError
      );
      await assert.rejects(client.listCallMatchers(request), expectedError);
      assert(
        (client.innerApiCalls.listCallMatchers as SinonStub)
          .getCall(0)
          .calledWith(request, expectedOptions, undefined)
    ...
    it('invokes listCallMatchersStream without error', async () => {
      const client = new conversationsModule.v2.ConversationsClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.descriptors.page.listCallMatchers.createStream = stubPageStreamingCall(
        expectedResponse
      );
      const stream = client.listCallMatchersStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.dialogflow.v2.CallMatcher[] = [];
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.v2.CallMatcher) => {
            responses.push(response);
          }
        );
        stream.on('end', () => {
      ...
      assert.deepStrictEqual(responses, expectedResponse);
      assert(
        (client.descriptors.page.listCallMatchers.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listCallMatchers, request)
      );
      assert.strictEqual(
        (client.descriptors.page.listCallMatchers
          .createStream as SinonStub).getCall(0).args[2].otherArgs.headers[
          'x-goog-request-params'
        ],
        expectedHeaderRequestParams
    ...
    it('invokes listCallMatchersStream with error', async () => {
      const client = new conversationsModule.v2.ConversationsClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
    ...
    it('uses async iteration with listCallMatchers without error', async () => {
      const client = new conversationsModule.v2.ConversationsClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.descriptors.page.listCallMatchers.asyncIterate = stubAsyncIterationCall(
        expectedResponse
      );
      const responses: protos.google.cloud.dialogflow.v2.ICallMatcher[] = [];
    ...
    it('uses async iteration with listCallMatchers with error', async () => {
      const client = new conversationsModule.v2.ConversationsClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
