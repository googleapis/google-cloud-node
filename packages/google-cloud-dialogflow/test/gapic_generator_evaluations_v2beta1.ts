...
describe('v2beta1.GeneratorEvaluationsClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          generatorevaluationsModule.v2beta1.GeneratorEvaluationsClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        generatorevaluationsModule.v2beta1.GeneratorEvaluationsClient.port;
      assert(port);
  ...
  describe('getGeneratorEvaluation', () => {
    it('invokes getGeneratorEvaluation without error', async () => {
      ...
      client.innerApiCalls.getGeneratorEvaluation =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getGeneratorEvaluation(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getGeneratorEvaluation as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getGeneratorEvaluation without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getGeneratorEvaluation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2beta1.IGeneratorEvaluation | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getGeneratorEvaluation with error', async () => {
      ...
      client.innerApiCalls.getGeneratorEvaluation = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getGeneratorEvaluation(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getGeneratorEvaluation as SinonStub
  ...
  describe('deleteGeneratorEvaluation', () => {
    it('invokes deleteGeneratorEvaluation without error', async () => {
      ...
      client.innerApiCalls.deleteGeneratorEvaluation =
        stubSimpleCall(expectedResponse);
      const [response] = await client.deleteGeneratorEvaluation(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteGeneratorEvaluation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteGeneratorEvaluation as SinonStub
    ...
    it('invokes deleteGeneratorEvaluation with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteGeneratorEvaluation = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteGeneratorEvaluation(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteGeneratorEvaluation as SinonStub
  ...
  describe('createGeneratorEvaluation', () => {
    it('invokes createGeneratorEvaluation without error', async () => {
      ...
      client.innerApiCalls.createGeneratorEvaluation =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createGeneratorEvaluation(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createGeneratorEvaluation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createGeneratorEvaluation as SinonStub
      ...
      const promise = new Promise((resolve, reject) => {
        client.createGeneratorEvaluation(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.dialogflow.v2beta1.IGeneratorEvaluation,
              protos.google.cloud.dialogflow.v2beta1.IGeneratorEvaluationOperationMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
    ...
    it('invokes createGeneratorEvaluation with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createGeneratorEvaluation = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createGeneratorEvaluation(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createGeneratorEvaluation as SinonStub
    ...
    it('invokes checkCreateGeneratorEvaluationProgress without error', async () => {
      ...
      const decodedOperation =
        await client.checkCreateGeneratorEvaluationProgress(
    ...
    it('invokes checkCreateGeneratorEvaluationProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateGeneratorEvaluationProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listGeneratorEvaluations', () => {
    it('invokes listGeneratorEvaluations without error', async () => {
      ...
      client.innerApiCalls.listGeneratorEvaluations =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listGeneratorEvaluations(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listGeneratorEvaluations as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listGeneratorEvaluations as SinonStub
    ...
    it('invokes listGeneratorEvaluations with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listGeneratorEvaluations = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listGeneratorEvaluations(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listGeneratorEvaluations as SinonStub
    ...
    it('invokes listGeneratorEvaluationsStream without error', async () => {
      ...
      client.descriptors.page.listGeneratorEvaluations.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.dialogflow.v2beta1.GeneratorEvaluation,
          ) => {
      ...
      assert(
        (
          client.descriptors.page.listGeneratorEvaluations
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listGeneratorEvaluations, request),
      );
      assert(
        (
          client.descriptors.page.listGeneratorEvaluations
    ...
    it('uses async iteration with listGeneratorEvaluations without error', async () => {
      ...
      client.descriptors.page.listGeneratorEvaluations.asyncIterate =
  ...
  describe('Path templates', () => {
    ...
    describe('generatorEvaluation', async () => {
      ...
      await client.initialize();
      client.pathTemplates.generatorEvaluationPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.generatorEvaluationPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('generatorEvaluationPath', () => {
        const result = client.generatorEvaluationPath(
          'projectValue',
          'locationValue',
          'generatorValue',
          'evaluationValue',
        ...
        assert(
          (
            client.pathTemplates.generatorEvaluationPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchLocationFromGeneratorEvaluationName', () => {
        const result =
          client.matchLocationFromGeneratorEvaluationName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.generatorEvaluationPathTemplate
      ...
      it('matchGeneratorFromGeneratorEvaluationName', () => {
        const result =
          client.matchGeneratorFromGeneratorEvaluationName(fakePath);
        assert.strictEqual(result, 'generatorValue');
        assert(
          (
            client.pathTemplates.generatorEvaluationPathTemplate
      ...
      it('matchEvaluationFromGeneratorEvaluationName', () => {
        const result =
          client.matchEvaluationFromGeneratorEvaluationName(fakePath);
    ...
    describe('projectConversations', async () => {
      ...
      await client.initialize();
      client.pathTemplates.projectConversationsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.projectConversationsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('projectConversationsPath', () => {
        const result = client.projectConversationsPath(
          'projectValue',
          'conversationValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.projectConversationsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromProjectConversationsName', () => {
        const result =
          client.matchProjectFromProjectConversationsName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.projectConversationsPathTemplate
      ...
      it('matchConversationFromProjectConversationsName', () => {
        const result =
          client.matchConversationFromProjectConversationsName(fakePath);
        assert.strictEqual(result, 'conversationValue');
        assert(
          (
            client.pathTemplates.projectConversationsPathTemplate
    ...
    describe('projectLocationConversations', async () => {
      ...
      it('projectLocationConversationsPath', () => {
        const result = client.projectLocationConversationsPath(
          'projectValue',
          'locationValue',
          'conversationValue',
        );
        ...
        assert(
          (
            client.pathTemplates.projectLocationConversationsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromProjectLocationConversationsName', () => {
        const result =
          client.matchProjectFromProjectLocationConversationsName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.projectLocationConversationsPathTemplate
      ...
      it('matchLocationFromProjectLocationConversationsName', () => {
        const result =
          client.matchLocationFromProjectLocationConversationsName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.projectLocationConversationsPathTemplate
      ...
      it('matchConversationFromProjectLocationConversationsName', () => {
        const result =
          client.matchConversationFromProjectLocationConversationsName(
            fakePath,
          );
        assert.strictEqual(result, 'conversationValue');
        assert(
