...
describe('v2beta1.GeneratorEvaluationsClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new generatorevaluationsModule.v2beta1.GeneratorEvaluationsClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = generatorevaluationsModule.v2beta1.GeneratorEvaluationsClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = generatorevaluationsModule.v2beta1.GeneratorEvaluationsClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new generatorevaluationsModule.v2beta1.GeneratorEvaluationsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new generatorevaluationsModule.v2beta1.GeneratorEvaluationsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new generatorevaluationsModule.v2beta1.GeneratorEvaluationsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new generatorevaluationsModule.v2beta1.GeneratorEvaluationsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = generatorevaluationsModule.v2beta1.GeneratorEvaluationsClient.port;
            assert(port);
    ...
    describe('getGeneratorEvaluation', () => {
        it('invokes getGeneratorEvaluation without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.GetGeneratorEvaluationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.GetGeneratorEvaluationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.GeneratorEvaluation()
            );
            client.innerApiCalls.getGeneratorEvaluation = stubSimpleCall(expectedResponse);
            const [response] = await client.getGeneratorEvaluation(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getGeneratorEvaluation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getGeneratorEvaluation as SinonStub)
        ...
        it('invokes getGeneratorEvaluation without error using callback', async () => {
            ...
            client.innerApiCalls.getGeneratorEvaluation = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getGeneratorEvaluation(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2beta1.IGeneratorEvaluation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getGeneratorEvaluation with error', async () => {
            ...
            client.innerApiCalls.getGeneratorEvaluation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getGeneratorEvaluation(request), expectedError);
            const actualRequest = (client.innerApiCalls.getGeneratorEvaluation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getGeneratorEvaluation as SinonStub)
    ...
    describe('deleteGeneratorEvaluation', () => {
        it('invokes deleteGeneratorEvaluation without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.DeleteGeneratorEvaluationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.DeleteGeneratorEvaluationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteGeneratorEvaluation = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteGeneratorEvaluation(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteGeneratorEvaluation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteGeneratorEvaluation as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteGeneratorEvaluation without error using callback', async () => {
            ...
            client.innerApiCalls.deleteGeneratorEvaluation = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteGeneratorEvaluation(
                    request,
        ...
        it('invokes deleteGeneratorEvaluation with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteGeneratorEvaluation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.deleteGeneratorEvaluation(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteGeneratorEvaluation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteGeneratorEvaluation as SinonStub)
    ...
    describe('createGeneratorEvaluation', () => {
        it('invokes createGeneratorEvaluation without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.CreateGeneratorEvaluationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.CreateGeneratorEvaluationRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createGeneratorEvaluation = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createGeneratorEvaluation(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createGeneratorEvaluation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createGeneratorEvaluation as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createGeneratorEvaluation without error using callback', async () => {
            ...
            client.innerApiCalls.createGeneratorEvaluation = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createGeneratorEvaluation(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dialogflow.v2beta1.IGeneratorEvaluation, protos.google.cloud.dialogflow.v2beta1.IGeneratorEvaluationOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dialogflow.v2beta1.IGeneratorEvaluation, protos.google.cloud.dialogflow.v2beta1.IGeneratorEvaluationOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createGeneratorEvaluation as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createGeneratorEvaluation with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createGeneratorEvaluation = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createGeneratorEvaluation(request), expectedError);
            const actualRequest = (client.innerApiCalls.createGeneratorEvaluation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createGeneratorEvaluation as SinonStub)
        ...
        it('invokes createGeneratorEvaluation with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createGeneratorEvaluation = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createGeneratorEvaluation(request);
        ...
        it('invokes checkCreateGeneratorEvaluationProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateGeneratorEvaluationProgress(expectedResponse.name);
        ...
        it('invokes checkCreateGeneratorEvaluationProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreateGeneratorEvaluationProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('listGeneratorEvaluations', () => {
        it('invokes listGeneratorEvaluations without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.ListGeneratorEvaluationsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.ListGeneratorEvaluationsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.GeneratorEvaluation()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.GeneratorEvaluation()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.GeneratorEvaluation()),
            ];
            client.innerApiCalls.listGeneratorEvaluations = stubSimpleCall(expectedResponse);
            const [response] = await client.listGeneratorEvaluations(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listGeneratorEvaluations as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listGeneratorEvaluations as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listGeneratorEvaluations without error using callback', async () => {
            ...
            client.innerApiCalls.listGeneratorEvaluations = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listGeneratorEvaluations(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2beta1.IGeneratorEvaluation[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listGeneratorEvaluations with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listGeneratorEvaluations = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listGeneratorEvaluations(request), expectedError);
            const actualRequest = (client.innerApiCalls.listGeneratorEvaluations as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listGeneratorEvaluations as SinonStub)
        ...
        it('invokes listGeneratorEvaluationsStream without error', async () => {
            ...
            client.descriptors.page.listGeneratorEvaluations.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listGeneratorEvaluationsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2beta1.GeneratorEvaluation[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2beta1.GeneratorEvaluation) => {
            ...
            assert((client.descriptors.page.listGeneratorEvaluations.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listGeneratorEvaluations, request));
            assert(
                (client.descriptors.page.listGeneratorEvaluations.createStream as SinonStub)
        ...
        it('invokes listGeneratorEvaluationsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listGeneratorEvaluations.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listGeneratorEvaluationsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2beta1.GeneratorEvaluation[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2beta1.GeneratorEvaluation) => {
        ...
        it('uses async iteration with listGeneratorEvaluations without error', async () => {
            ...
            client.descriptors.page.listGeneratorEvaluations.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.dialogflow.v2beta1.IGeneratorEvaluation[] = [];
            const iterable = client.listGeneratorEvaluationsAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listGeneratorEvaluations.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listGeneratorEvaluations with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listGeneratorEvaluations.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listGeneratorEvaluationsAsync(request);
    ...
    describe('Path templates', () => {
        ...
        describe('projectConversations', async () => {
            const fakePath = "/rendered/path/projectConversations";
            const expectedParameters = {
                project: "projectValue",
                conversation: "conversationValue",
            };
            ...
            await client.initialize();
            client.pathTemplates.projectConversationsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.projectConversationsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('projectConversationsPath', () => {
                const result = client.projectConversationsPath("projectValue", "conversationValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectConversationsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectConversationsName', () => {
                const result = client.matchProjectFromProjectConversationsName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectConversationsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchConversationFromProjectConversationsName', () => {
                const result = client.matchConversationFromProjectConversationsName(fakePath);
                assert.strictEqual(result, "conversationValue");
                assert((client.pathTemplates.projectConversationsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('projectLocationConversations', async () => {
            const fakePath = "/rendered/path/projectLocationConversations";
            const expectedParameters = {
                project: "projectValue",
                location: "locationValue",
                conversation: "conversationValue",
            ...
            await client.initialize();
            client.pathTemplates.projectLocationConversationsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.projectLocationConversationsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('projectLocationConversationsPath', () => {
                const result = client.projectLocationConversationsPath("projectValue", "locationValue", "conversationValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectLocationConversationsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectLocationConversationsName', () => {
                const result = client.matchProjectFromProjectLocationConversationsName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectLocationConversationsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromProjectLocationConversationsName', () => {
                const result = client.matchLocationFromProjectLocationConversationsName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.projectLocationConversationsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchConversationFromProjectLocationConversationsName', () => {
                const result = client.matchConversationFromProjectLocationConversationsName(fakePath);
                assert.strictEqual(result, "conversationValue");
                assert((client.pathTemplates.projectLocationConversationsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
