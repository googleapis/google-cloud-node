  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          fulfillmentsModule.v2beta1.FulfillmentsClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          fulfillmentsModule.v2beta1.FulfillmentsClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new fulfillmentsModule.v2beta1.FulfillmentsClient({
          universe_domain: 'example.com',
    ...
    it('invokes getFulfillment without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getFulfillment(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2beta1.IFulfillment | null
          ) => {
            if (err) {
              reject(err);
            } else {
