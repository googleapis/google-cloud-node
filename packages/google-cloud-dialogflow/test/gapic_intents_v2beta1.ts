...
describe('v2beta1.IntentsClient', () => {
  ...
  describe('batchUpdateIntents', () => {
    it('invokes batchUpdateIntents without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('BatchUpdateIntentsRequest', [
        'parent',
      ]);
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1}`;
      ...
      client.innerApiCalls.batchUpdateIntents =
  ...
  describe('batchDeleteIntents', () => {
    it('invokes batchDeleteIntents without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('BatchDeleteIntentsRequest', [
        'parent',
      ]);
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1}`;
      ...
      client.innerApiCalls.batchDeleteIntents =
        stubLongRunningCall(expectedResponse);
