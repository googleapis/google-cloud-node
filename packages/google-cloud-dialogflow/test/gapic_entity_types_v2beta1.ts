  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          entitytypesModule.v2beta1.EntityTypesClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          entitytypesModule.v2beta1.EntityTypesClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new entitytypesModule.v2beta1.EntityTypesClient({
          universe_domain: 'example.com',
    ...
    it('invokes getEntityType without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getEntityType(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2beta1.IEntityType | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listEntityTypes', () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listEntityTypes(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.dialogflow.v2beta1.IEntityType[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listEntityTypesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.v2beta1.EntityType) => {
