...
describe('v2beta1.EnvironmentsClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = environmentsModule.v2beta1.EnvironmentsClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = environmentsModule.v2beta1.EnvironmentsClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new environmentsModule.v2beta1.EnvironmentsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new environmentsModule.v2beta1.EnvironmentsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new environmentsModule.v2beta1.EnvironmentsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new environmentsModule.v2beta1.EnvironmentsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = environmentsModule.v2beta1.EnvironmentsClient.port;
            assert(port);
    ...
    describe('getEnvironment', () => {
        it('invokes getEnvironment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.GetEnvironmentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.Environment()
            );
        ...
        it('invokes getEnvironment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getEnvironment(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2beta1.IEnvironment|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createEnvironment', () => {
        it('invokes createEnvironment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.CreateEnvironmentRequest', ['parent']);
        ...
        it('invokes createEnvironment without error using callback', async () => {
            ...
            client.innerApiCalls.createEnvironment = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createEnvironment with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createEnvironment = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateEnvironment', () => {
        it('invokes updateEnvironment without error', async () => {
            ...
            request.environment ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.UpdateEnvironmentRequest', ['environment', 'name']);
        ...
        it('invokes updateEnvironment without error using callback', async () => {
            ...
            client.innerApiCalls.updateEnvironment = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateEnvironment with error', async () => {
            ...
            const expectedHeaderRequestParams = `environment.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateEnvironment = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteEnvironment', () => {
        it('invokes deleteEnvironment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.DeleteEnvironmentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listEnvironments', () => {
        it('invokes listEnvironments without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.ListEnvironmentsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.ListEnvironmentsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.Environment()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.Environment()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.Environment()),
            ];
        ...
        it('invokes listEnvironmentsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2beta1.Environment[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2beta1.Environment) => {
        ...
        it('uses async iteration with listEnvironments without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.v2beta1.IEnvironment[] = [];
    ...
    describe('getEnvironmentHistory', () => {
        it('invokes getEnvironmentHistory without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2beta1.GetEnvironmentHistoryRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.GetEnvironmentHistoryRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.EnvironmentHistory.Entry()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.EnvironmentHistory.Entry()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.EnvironmentHistory.Entry()),
            ];
            client.innerApiCalls.getEnvironmentHistory = stubSimpleCall(expectedResponse);
            const [response] = await client.getEnvironmentHistory(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getEnvironmentHistory as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getEnvironmentHistory as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getEnvironmentHistory without error using callback', async () => {
            ...
            client.innerApiCalls.getEnvironmentHistory = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getEnvironmentHistory(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2beta1.EnvironmentHistory.IEntry[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getEnvironmentHistory with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getEnvironmentHistory = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getEnvironmentHistory(request), expectedError);
            const actualRequest = (client.innerApiCalls.getEnvironmentHistory as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getEnvironmentHistory as SinonStub)
        ...
        it('invokes getEnvironmentHistoryStream without error', async () => {
            ...
            client.descriptors.page.getEnvironmentHistory.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.getEnvironmentHistoryStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2beta1.EnvironmentHistory.Entry[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2beta1.EnvironmentHistory.Entry) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.getEnvironmentHistory.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.getEnvironmentHistory, request));
            assert(
                (client.descriptors.page.getEnvironmentHistory.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes getEnvironmentHistoryStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.getEnvironmentHistory.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.getEnvironmentHistoryStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2beta1.EnvironmentHistory.Entry[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2beta1.EnvironmentHistory.Entry) => {
        ...
        it('uses async iteration with getEnvironmentHistory without error', async () => {
            ...
            client.descriptors.page.getEnvironmentHistory.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.dialogflow.v2beta1.EnvironmentHistory.IEntry[] = [];
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.getEnvironmentHistory.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.getEnvironmentHistory.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with getEnvironmentHistory with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.getEnvironmentHistory.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.getEnvironmentHistoryAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.dialogflow.v2beta1.EnvironmentHistory.IEntry[] = [];
                for await (const resource of iterable) {
