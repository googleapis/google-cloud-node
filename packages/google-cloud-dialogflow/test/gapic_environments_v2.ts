...
describe('v2.EnvironmentsClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new environmentsModule.v2.EnvironmentsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new environmentsModule.v2.EnvironmentsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new environmentsModule.v2.EnvironmentsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new environmentsModule.v2.EnvironmentsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getEnvironment', () => {
        it('invokes getEnvironment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.GetEnvironmentRequest', ['name']);
        ...
        it('invokes getEnvironment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getEnvironment(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.IEnvironment|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createEnvironment', () => {
        it('invokes createEnvironment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.CreateEnvironmentRequest', ['parent']);
    ...
    describe('updateEnvironment', () => {
        it('invokes updateEnvironment without error', async () => {
            ...
            request.environment ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.UpdateEnvironmentRequest', ['environment', 'name']);
    ...
    describe('deleteEnvironment', () => {
        it('invokes deleteEnvironment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.DeleteEnvironmentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listEnvironments', () => {
        it('invokes listEnvironments without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.ListEnvironmentsRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('getEnvironmentHistory', () => {
        it('invokes getEnvironmentHistory without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.GetEnvironmentHistoryRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.EnvironmentHistory.Entry()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.EnvironmentHistory.Entry()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.EnvironmentHistory.Entry()),
            ];
        ...
        it('invokes getEnvironmentHistory without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getEnvironmentHistory(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.EnvironmentHistory.IEntry[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getEnvironmentHistoryStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.dialogflow.v2.EnvironmentHistory.Entry) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
