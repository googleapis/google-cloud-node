...
describe('v2.SipTrunksClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new siptrunksModule.v2.SipTrunksClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = siptrunksModule.v2.SipTrunksClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = siptrunksModule.v2.SipTrunksClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new siptrunksModule.v2.SipTrunksClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new siptrunksModule.v2.SipTrunksClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new siptrunksModule.v2.SipTrunksClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new siptrunksModule.v2.SipTrunksClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = siptrunksModule.v2.SipTrunksClient.port;
            assert(port);
    ...
    describe('createSipTrunk', () => {
        it('invokes createSipTrunk without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.CreateSipTrunkRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.CreateSipTrunkRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.SipTrunk()
            );
            client.innerApiCalls.createSipTrunk = stubSimpleCall(expectedResponse);
            const [response] = await client.createSipTrunk(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createSipTrunk as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createSipTrunk as SinonStub)
        ...
        it('invokes createSipTrunk without error using callback', async () => {
            ...
            client.innerApiCalls.createSipTrunk = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createSipTrunk(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.ISipTrunk|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createSipTrunk with error', async () => {
            ...
            client.innerApiCalls.createSipTrunk = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteSipTrunk', () => {
        it('invokes deleteSipTrunk without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.DeleteSipTrunkRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.DeleteSipTrunkRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteSipTrunk = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteSipTrunk(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteSipTrunk as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteSipTrunk as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteSipTrunk without error using callback', async () => {
            ...
            client.innerApiCalls.deleteSipTrunk = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteSipTrunk(
                    request,
        ...
        it('invokes deleteSipTrunk with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteSipTrunk = stubSimpleCall(undefined, expectedError);
    ...
    describe('getSipTrunk', () => {
        it('invokes getSipTrunk without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.GetSipTrunkRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.GetSipTrunkRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.SipTrunk()
            );
            client.innerApiCalls.getSipTrunk = stubSimpleCall(expectedResponse);
            const [response] = await client.getSipTrunk(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getSipTrunk as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getSipTrunk as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getSipTrunk without error using callback', async () => {
            ...
            client.innerApiCalls.getSipTrunk = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getSipTrunk(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.ISipTrunk|null) => {
        ...
        it('invokes getSipTrunk with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getSipTrunk = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateSipTrunk', () => {
        it('invokes updateSipTrunk without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.UpdateSipTrunkRequest()
            );
            request.sipTrunk ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.UpdateSipTrunkRequest', ['sipTrunk', 'name']);
            request.sipTrunk.name = defaultValue1;
            const expectedHeaderRequestParams = `sip_trunk.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.SipTrunk()
            );
            client.innerApiCalls.updateSipTrunk = stubSimpleCall(expectedResponse);
            const [response] = await client.updateSipTrunk(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateSipTrunk as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateSipTrunk as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateSipTrunk without error using callback', async () => {
            ...
            client.innerApiCalls.updateSipTrunk = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateSipTrunk(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.ISipTrunk|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes updateSipTrunk with error', async () => {
            ...
            const expectedHeaderRequestParams = `sip_trunk.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateSipTrunk = stubSimpleCall(undefined, expectedError);
    ...
    describe('listSipTrunks', () => {
        it('invokes listSipTrunks without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.v2.ListSipTrunksRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2.ListSipTrunksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.SipTrunk()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.SipTrunk()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.SipTrunk()),
            ];
            client.innerApiCalls.listSipTrunks = stubSimpleCall(expectedResponse);
            const [response] = await client.listSipTrunks(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listSipTrunks as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listSipTrunks as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listSipTrunks without error using callback', async () => {
            ...
            client.innerApiCalls.listSipTrunks = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listSipTrunks(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.ISipTrunk[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listSipTrunks with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listSipTrunks = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listSipTrunks(request), expectedError);
            const actualRequest = (client.innerApiCalls.listSipTrunks as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listSipTrunks as SinonStub)
        ...
        it('invokes listSipTrunksStream without error', async () => {
            ...
            client.descriptors.page.listSipTrunks.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listSipTrunksStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2.SipTrunk[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2.SipTrunk) => {
            ...
            assert((client.descriptors.page.listSipTrunks.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listSipTrunks, request));
            assert(
        ...
        it('invokes listSipTrunksStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listSipTrunks.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listSipTrunksStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2.SipTrunk[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2.SipTrunk) => {
        ...
        it('uses async iteration with listSipTrunks without error', async () => {
            ...
            client.descriptors.page.listSipTrunks.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.dialogflow.v2.ISipTrunk[] = [];
            const iterable = client.listSipTrunksAsync(request);
        ...
        it('uses async iteration with listSipTrunks with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listSipTrunks.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listSipTrunksAsync(request);
