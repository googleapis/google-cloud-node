...
describe('v2.SipTrunksClient', () => {
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new siptrunksModule.v2.SipTrunksClient({
          universe_domain: 'example.com',
  ...
  describe('createSipTrunk', () => {
    it('invokes createSipTrunk without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.createSipTrunk as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes createSipTrunk without error using callback', async () => {
      ...
      client.innerApiCalls.createSipTrunk =
      ...
      const promise = new Promise((resolve, reject) => {
        client.createSipTrunk(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2.ISipTrunk | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createSipTrunk with error', async () => {
      ...
      client.innerApiCalls.createSipTrunk = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteSipTrunk', () => {
    it('invokes deleteSipTrunk without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.dialogflow.v2.DeleteSipTrunkRequest',
        ['name'],
      );
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteSipTrunk as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteSipTrunk as SinonStub
    ...
    it('invokes deleteSipTrunk without error using callback', async () => {
      ...
      client.innerApiCalls.deleteSipTrunk =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes deleteSipTrunk with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteSipTrunk = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getSipTrunk', () => {
    it('invokes getSipTrunk without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getSipTrunk as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getSipTrunk as SinonStub
    ...
    it('invokes getSipTrunk without error using callback', async () => {
      ...
      client.innerApiCalls.getSipTrunk =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getSipTrunk(
          request,
    ...
    it('invokes getSipTrunk with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getSipTrunk = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateSipTrunk', () => {
    it('invokes updateSipTrunk without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateSipTrunk as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateSipTrunk as SinonStub
    ...
    it('invokes updateSipTrunk without error using callback', async () => {
      ...
      client.innerApiCalls.updateSipTrunk =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes updateSipTrunk with error', async () => {
      ...
      const expectedHeaderRequestParams = `sip_trunk.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateSipTrunk = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listSipTrunks', () => {
    it('invokes listSipTrunks without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.dialogflow.v2.ListSipTrunksRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listSipTrunks as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listSipTrunks as SinonStub
    ...
    it('invokes listSipTrunks without error using callback', async () => {
      ...
      client.innerApiCalls.listSipTrunks =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listSipTrunks with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listSipTrunks = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listSipTrunksStream without error', async () => {
      ...
      client.descriptors.page.listSipTrunks.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.v2.SipTrunk) => {
      ...
      assert(
        (client.descriptors.page.listSipTrunks.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listSipTrunks, request),
      );
      assert(
        (client.descriptors.page.listSipTrunks.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listSipTrunks without error', async () => {
      ...
      client.descriptors.page.listSipTrunks.asyncIterate =
