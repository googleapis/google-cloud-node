...
function main(name) {
  ...
  async function callGetConversationModelEvaluation() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await dialogflowClient.getConversationModelEvaluation(request);
    console.log(response);
  }

  callGetConversationModelEvaluation();
