...
const GeneratorEvaluationsClient = v2.GeneratorEvaluationsClient;
type GeneratorEvaluationsClient = v2.GeneratorEvaluationsClient;
...
const SipTrunksClient = v2.SipTrunksClient;
type SipTrunksClient = v2.SipTrunksClient;
const ToolsClient = v2.ToolsClient;
type ToolsClient = v2.ToolsClient;
