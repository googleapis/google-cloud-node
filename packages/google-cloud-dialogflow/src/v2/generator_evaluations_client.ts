...
export class GeneratorEvaluationsClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this.descriptors.page = {
      listGeneratorEvaluations:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'generatorEvaluations')
    };
    ...
    const createGeneratorEvaluationResponse = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.v2.GeneratorEvaluation') as gax.protobuf.Type;
    const createGeneratorEvaluationMetadata = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.v2.GeneratorEvaluationOperationMetadata') as gax.protobuf.Type;

    this.descriptors.longrunning = {
      createGeneratorEvaluation: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        createGeneratorEvaluationResponse.decode.bind(createGeneratorEvaluationResponse),
        createGeneratorEvaluationMetadata.decode.bind(createGeneratorEvaluationMetadata))
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.dialogflow.v2.GeneratorEvaluations', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.generatorEvaluationsStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.dialogflow.v2.GeneratorEvaluations') :
    ...
    const generatorEvaluationsStubMethods =
        ['createGeneratorEvaluation', 'getGeneratorEvaluation', 'listGeneratorEvaluations', 'deleteGeneratorEvaluation'];
 ...
 */
  getGeneratorEvaluation(
      ...
      Promise<[
        ...
        protos.google.cloud.dialogflow.v2.IGetGeneratorEvaluationRequest|undefined, {}|undefined
      ]>;
  getGeneratorEvaluation(
      request: protos.google.cloud.dialogflow.v2.IGetGeneratorEvaluationRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2.IGeneratorEvaluation,
          protos.google.cloud.dialogflow.v2.IGetGeneratorEvaluationRequest|null|undefined,
          {}|null|undefined>): void;
  getGeneratorEvaluation(
      request: protos.google.cloud.dialogflow.v2.IGetGeneratorEvaluationRequest,
      callback: Callback<
 ...
 */
  deleteGeneratorEvaluation(
      ...
      Promise<[
        ...
        protos.google.cloud.dialogflow.v2.IDeleteGeneratorEvaluationRequest|undefined, {}|undefined
      ]>;
  deleteGeneratorEvaluation(
      request: protos.google.cloud.dialogflow.v2.IDeleteGeneratorEvaluationRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.protobuf.IEmpty,
          protos.google.cloud.dialogflow.v2.IDeleteGeneratorEvaluationRequest|null|undefined,
          {}|null|undefined>): void;
  deleteGeneratorEvaluation(
      request: protos.google.cloud.dialogflow.v2.IDeleteGeneratorEvaluationRequest,
      callback: Callback<
 ...
 * region_tag:dialogflow_v2_generated_GeneratorEvaluations_CreateGeneratorEvaluation_async
 */
  async checkCreateGeneratorEvaluationProgress(name: string): Promise<LROperation<protos.google.cloud.dialogflow.v2.GeneratorEvaluation, protos.google.cloud.dialogflow.v2.GeneratorEvaluationOperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.dialogflow.v2.GeneratorEvaluation, protos.google.cloud.dialogflow.v2.GeneratorEvaluationOperationMetadata>;
  }
 /**
 ...
 */
  ...
  listGeneratorEvaluations(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.dialogflow.v2.IListGeneratorEvaluationsResponse|null|undefined,
          protos.google.cloud.dialogflow.v2.IGeneratorEvaluation>): void;
  listGeneratorEvaluations(
      request: protos.google.cloud.dialogflow.v2.IListGeneratorEvaluationsRequest,
      callback: PaginationCallback<
          protos.google.cloud.dialogflow.v2.IListGeneratorEvaluationsRequest,
  ...
  listGeneratorEvaluations(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.dialogflow.v2.IListGeneratorEvaluationsRequest,
      protos.google.cloud.dialogflow.v2.IListGeneratorEvaluationsResponse|null|undefined,
      protos.google.cloud.dialogflow.v2.IGeneratorEvaluation>|undefined = callback
