 ...
 * `src/v2/encryption_spec_service_client_config.json`.
...
export class EncryptionSpecServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const initializeEncryptionSpecResponse = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.v2.InitializeEncryptionSpecResponse') as gax.protobuf.Type;
    const initializeEncryptionSpecMetadata = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.v2.InitializeEncryptionSpecMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.dialogflow.v2.EncryptionSpecService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.encryptionSpecServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.dialogflow.v2.EncryptionSpecService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.dialogflow.v2.EncryptionSpecService,
 ...
 *   The first element of the array is an object representing {@link protos.google.cloud.dialogflow.v2.EncryptionSpec|EncryptionSpec}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v2/encryption_spec_service.get_encryption_spec.js</caption>
 * region_tag:dialogflow_v2_generated_EncryptionSpecService_GetEncryptionSpec_async
 */
  getEncryptionSpec(
      request?: protos.google.cloud.dialogflow.v2.IGetEncryptionSpecRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v2.IEncryptionSpec,
        protos.google.cloud.dialogflow.v2.IGetEncryptionSpecRequest|undefined, {}|undefined
      ]>;
  getEncryptionSpec(
      request: protos.google.cloud.dialogflow.v2.IGetEncryptionSpecRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2.IEncryptionSpec,
          protos.google.cloud.dialogflow.v2.IGetEncryptionSpecRequest|null|undefined,
          {}|null|undefined>): void;
  getEncryptionSpec(
      request: protos.google.cloud.dialogflow.v2.IGetEncryptionSpecRequest,
      callback: Callback<
  ...
  getEncryptionSpec(
    ...
    return this.innerApiCalls.getEncryptionSpec(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.dialogflow.v2.IEncryptionSpec,
        protos.google.cloud.dialogflow.v2.IGetEncryptionSpecRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getEncryptionSpec response %j', response);
 ...
 * @param {Object} request
 *   The request object that will be sent.
 * @param {google.cloud.dialogflow.v2.EncryptionSpec} request.encryptionSpec
 ...
 *   for more details and examples.
 * @example <caption>include:samples/generated/v2/encryption_spec_service.initialize_encryption_spec.js</caption>
 * region_tag:dialogflow_v2_generated_EncryptionSpecService_InitializeEncryptionSpec_async
 */
  initializeEncryptionSpec(
      request?: protos.google.cloud.dialogflow.v2.IInitializeEncryptionSpecRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.dialogflow.v2.IInitializeEncryptionSpecResponse, protos.google.cloud.dialogflow.v2.IInitializeEncryptionSpecMetadata>,
 ...
 * region_tag:dialogflow_v2_generated_EncryptionSpecService_InitializeEncryptionSpec_async
 */
  async checkInitializeEncryptionSpecProgress(name: string): Promise<LROperation<protos.google.cloud.dialogflow.v2.InitializeEncryptionSpecResponse, protos.google.cloud.dialogflow.v2.InitializeEncryptionSpecMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.dialogflow.v2.InitializeEncryptionSpecResponse, protos.google.cloud.dialogflow.v2.InitializeEncryptionSpecMetadata>;
  }
/**
