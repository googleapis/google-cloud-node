...
export class EncryptionSpecServiceClient {
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof EncryptionSpecServiceClient;
    if (
    ...
    this.encryptionSpecServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ...
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.dialogflow.v2
  ...
  async checkInitializeEncryptionSpecProgress(
    ...
    LROperation<
      protos.google.cloud.dialogflow.v2.InitializeEncryptionSpecResponse,
