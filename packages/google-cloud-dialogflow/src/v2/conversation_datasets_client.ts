...
export class ConversationDatasetsClient {
   ...
   *     const client = new ConversationDatasetsClient({fallback: true}, gax);
   *     ```
   */
 ...
 */
  ...
  getConversationDataset(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getConversationDataset(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.dialogflow.v2.IConversationDataset,
        protos.google.cloud.dialogflow.v2.IGetConversationDatasetRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getConversationDataset response %j', response);
 ...
 */
  ...
  createConversationDataset(
    ...
    return this.innerApiCalls.createConversationDataset(request, options, wrappedCallback)
 ...
 */
  ...
  deleteConversationDataset(
    ...
    return this.innerApiCalls.deleteConversationDataset(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.dialogflow.v2.IDeleteConversationDatasetOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 */
  ...
  importConversationData(
    ...
    return this.innerApiCalls.importConversationData(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.dialogflow.v2.IImportConversationDataOperationResponse, protos.google.cloud.dialogflow.v2.IImportConversationDataOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 */
  ...
  listConversationDatasets(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.dialogflow.v2.IListConversationDatasetsRequest,
      protos.google.cloud.dialogflow.v2.IListConversationDatasetsResponse|null|undefined,
      protos.google.cloud.dialogflow.v2.IConversationDataset>|undefined = callback
...
/**
 * Equivalent to `listConversationDatasets`, but returns a NodeJS Stream object.
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 *   Required. The project and location name to list all conversation datasets
