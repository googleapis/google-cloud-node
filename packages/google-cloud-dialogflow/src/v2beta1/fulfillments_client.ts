...
export class FulfillmentsClient {
   ...
   *   The first element of the array is an object representing {@link google.cloud.dialogflow.v2beta1.Fulfillment | Fulfillment}.
   *   Please see the
  ...
  getFulfillment(
    ...
    callback: Callback<
      protos.google.cloud.dialogflow.v2beta1.IFulfillment,
      | protos.google.cloud.dialogflow.v2beta1.IGetFulfillmentRequest
      | null
      | undefined,
      {} | null | undefined
    >
