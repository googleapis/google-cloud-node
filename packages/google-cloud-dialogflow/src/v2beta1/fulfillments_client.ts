...
export class FulfillmentsClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.dialogflow.v2beta1.Fulfillments', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.fulfillmentsStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.dialogflow.v2beta1.Fulfillments') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.dialogflow.v2beta1.Fulfillments,
 ...
 */
  getFulfillment(
      ...
      Promise<[
        ...
        protos.google.cloud.dialogflow.v2beta1.IGetFulfillmentRequest|undefined, {}|undefined
      ]>;
  getFulfillment(
      request: protos.google.cloud.dialogflow.v2beta1.IGetFulfillmentRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2beta1.IFulfillment,
          protos.google.cloud.dialogflow.v2beta1.IGetFulfillmentRequest|null|undefined,
          {}|null|undefined>): void;
  getFulfillment(
      request: protos.google.cloud.dialogflow.v2beta1.IGetFulfillmentRequest,
      callback: Callback<
 ...
 */
  updateFulfillment(
      ...
      Promise<[
        protos.google.cloud.dialogflow.v2beta1.IFulfillment,
        protos.google.cloud.dialogflow.v2beta1.IUpdateFulfillmentRequest|undefined, {}|undefined
      ]>;
  updateFulfillment(
      request: protos.google.cloud.dialogflow.v2beta1.IUpdateFulfillmentRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2beta1.IFulfillment,
          protos.google.cloud.dialogflow.v2beta1.IUpdateFulfillmentRequest|null|undefined,
          {}|null|undefined>): void;
  updateFulfillment(
      request: protos.google.cloud.dialogflow.v2beta1.IUpdateFulfillmentRequest,
      callback: Callback<
