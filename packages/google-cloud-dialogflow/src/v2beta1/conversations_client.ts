...
export class ConversationsClient {
  ...
  createCallMatcher(
    request: protos.google.cloud.dialogflow.v2beta1.ICreateCallMatcherRequest,
    options?: CallOptions
  ): Promise<
    [
      protos.google.cloud.dialogflow.v2beta1.ICallMatcher,
      (
        | protos.google.cloud.dialogflow.v2beta1.ICreateCallMatcherRequest
        | undefined
      ),
      {} | undefined
    ]
   ...
   *   Format: `projects/<Project ID>/locations/<Location
   *   ID>/conversations/<Conversation ID>`.
   * @param {google.cloud.dialogflow.v2beta1.CallMatcher} request.callMatcher
   *   Required. The call matcher to create.
   * @param {object} [options]
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing [CallMatcher]{@link google.cloud.dialogflow.v2beta1.CallMatcher}.
   *   Please see the
   *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
   *   for more details and examples.
   * @example
  ...
  deleteCallMatcher(
    request: protos.google.cloud.dialogflow.v2beta1.IDeleteCallMatcherRequest,
    options?: CallOptions
  ): Promise<
    [
      protos.google.protobuf.IEmpty,
      (
        | protos.google.cloud.dialogflow.v2beta1.IDeleteCallMatcherRequest
        | undefined
      ),
      {} | undefined
    ]
   ...
   *   The request object that will be sent.
   * @param {string} request.name
   *   Required. The unique identifier of the {@link google.cloud.dialogflow.v2beta1.CallMatcher|CallMatcher} to delete.
   *   Format: `projects/<Project ID>/locations/<Location
  ...
  listCallMatchers(
    request: protos.google.cloud.dialogflow.v2beta1.IListCallMatchersRequest,
    options?: CallOptions
  ): Promise<
    [
      protos.google.cloud.dialogflow.v2beta1.ICallMatcher[],
      protos.google.cloud.dialogflow.v2beta1.IListCallMatchersRequest | null,
      protos.google.cloud.dialogflow.v2beta1.IListCallMatchersResponse
    ]
  >;
  listCallMatchers(
    request: protos.google.cloud.dialogflow.v2beta1.IListCallMatchersRequest,
    options: CallOptions,
    callback: PaginationCallback<
      protos.google.cloud.dialogflow.v2beta1.IListCallMatchersRequest,
      | protos.google.cloud.dialogflow.v2beta1.IListCallMatchersResponse
      | null
      | undefined,
      protos.google.cloud.dialogflow.v2beta1.ICallMatcher
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of [CallMatcher]{@link google.cloud.dialogflow.v2beta1.CallMatcher}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing [CallMatcher]{@link google.cloud.dialogflow.v2beta1.CallMatcher} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed. Note that it can affect your quota.
   *   We recommend using `listCallMatchersAsync()`
   *   method described below for async iteration which you can stop as needed.
   ...
   *   An iterable Object that allows [async iteration](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols).
   *   When you iterate the returned iterable, each element will be an object representing
   *   [CallMatcher]{@link google.cloud.dialogflow.v2beta1.CallMatcher}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the
   *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination)
   *   for more details and examples.
  ...
  listCallMatchersAsync(
    request?: protos.google.cloud.dialogflow.v2beta1.IListCallMatchersRequest,
    options?: CallOptions
  ): AsyncIterable<protos.google.cloud.dialogflow.v2beta1.ICallMatcher> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listCallMatchers.asyncIterate(
      ...
      (request as unknown) as RequestType,
      callSettings
    ) as AsyncIterable<protos.google.cloud.dialogflow.v2beta1.ICallMatcher>;
  }
  listMessages(
