...
/**
 *  Service for managing {@link protos.google.cloud.dialogflow.v2beta1.Agent|Agents}.
 * @class
 * @memberof v2beta1
 */
export class AgentsClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const exportAgentResponse = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.v2beta1.ExportAgentResponse') as gax.protobuf.Type;
  ...
  initialize() {
    ...
    this.agentsStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.dialogflow.v2beta1.Agents') :
 ...
 *   The first element of the array is an object representing {@link protos.google.cloud.dialogflow.v2beta1.Agent|Agent}.
 ...
 */
  getAgent(
      ...
      Promise<[
        ...
        protos.google.cloud.dialogflow.v2beta1.IGetAgentRequest|undefined, {}|undefined
      ]>;
  getAgent(
      request: protos.google.cloud.dialogflow.v2beta1.IGetAgentRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2beta1.IAgent,
          protos.google.cloud.dialogflow.v2beta1.IGetAgentRequest|null|undefined,
          {}|null|undefined>): void;
  getAgent(
      request: protos.google.cloud.dialogflow.v2beta1.IGetAgentRequest,
      callback: Callback<
 ...
 */
  setAgent(
      ...
      Promise<[
        protos.google.cloud.dialogflow.v2beta1.IAgent,
        protos.google.cloud.dialogflow.v2beta1.ISetAgentRequest|undefined, {}|undefined
      ]>;
  setAgent(
      request: protos.google.cloud.dialogflow.v2beta1.ISetAgentRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2beta1.IAgent,
          protos.google.cloud.dialogflow.v2beta1.ISetAgentRequest|null|undefined,
          {}|null|undefined>): void;
  setAgent(
      request: protos.google.cloud.dialogflow.v2beta1.ISetAgentRequest,
      callback: Callback<
  ...
  setAgent(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.setAgent(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.dialogflow.v2beta1.IAgent,
 ...
 */
  deleteAgent(
      ...
      Promise<[
        ...
        protos.google.cloud.dialogflow.v2beta1.IDeleteAgentRequest|undefined, {}|undefined
      ]>;
  deleteAgent(
      request: protos.google.cloud.dialogflow.v2beta1.IDeleteAgentRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.protobuf.IEmpty,
          protos.google.cloud.dialogflow.v2beta1.IDeleteAgentRequest|null|undefined,
          {}|null|undefined>): void;
  deleteAgent(
      request: protos.google.cloud.dialogflow.v2beta1.IDeleteAgentRequest,
      callback: Callback<
  ...
  deleteAgent(
    ...
    return this.innerApiCalls.deleteAgent(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.protobuf.IEmpty,
        protos.google.cloud.dialogflow.v2beta1.IDeleteAgentRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('deleteAgent response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.cloud.dialogflow.v2beta1.ValidationResult|ValidationResult}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 ...
 */
  getValidationResult(
      ...
      Promise<[
        ...
        protos.google.cloud.dialogflow.v2beta1.IGetValidationResultRequest|undefined, {}|undefined
      ]>;
  getValidationResult(
      request: protos.google.cloud.dialogflow.v2beta1.IGetValidationResultRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2beta1.IValidationResult,
          protos.google.cloud.dialogflow.v2beta1.IGetValidationResultRequest|null|undefined,
          {}|null|undefined>): void;
  getValidationResult(
      request: protos.google.cloud.dialogflow.v2beta1.IGetValidationResultRequest,
      callback: Callback<
  ...
  getValidationResult(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getValidationResult(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.dialogflow.v2beta1.IValidationResult,
        protos.google.cloud.dialogflow.v2beta1.IGetValidationResultRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getValidationResult response %j', response);
        return [response, options, rawResponse];
 ...
 */
  ...
  trainAgent(
    ...
    return this.innerApiCalls.trainAgent(request, options, wrappedCallback)
 ...
 */
  async checkTrainAgentProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.protobuf.Struct>>{
    ...
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.trainAgent, this._gaxModule.createDefaultBackoffSettings());
 ...
 *   message](https://developers.google.com/protocol-buffers/docs/reference/google.protobuf#struct)
 * - `response`:
 * {@link protos.google.cloud.dialogflow.v2beta1.ExportAgentResponse|ExportAgentResponse}
 *
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 ...
 */
  exportAgent(
      ...
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.dialogflow.v2beta1.IExportAgentResponse, protos.google.protobuf.IStruct>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
      ]>;
  exportAgent(
      request: protos.google.cloud.dialogflow.v2beta1.IExportAgentRequest,
  ...
  exportAgent(
    ...
    return this.innerApiCalls.exportAgent(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.dialogflow.v2beta1.IExportAgentResponse, protos.google.protobuf.IStruct>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 */
  async checkExportAgentProgress(name: string): Promise<LROperation<protos.google.cloud.dialogflow.v2beta1.ExportAgentResponse, protos.google.protobuf.Struct>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.dialogflow.v2beta1.ExportAgentResponse, protos.google.protobuf.Struct>;
  }
/**
 ...
 * versions from
 * {@link protos.google.cloud.dialogflow.v2beta1.ImportAgentRequest|ImportAgentRequest}.
 ...
 * {@link protos.google.cloud.dialogflow.v2beta1.Agents.TrainAgent|TrainAgent} and wait
 ...
 */
  ...
  importAgent(
    ...
    return this.innerApiCalls.importAgent(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.protobuf.IEmpty, protos.google.protobuf.IStruct>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 */
  async checkImportAgentProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.protobuf.Struct>>{
    ...
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.importAgent, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.protobuf.Empty, protos.google.protobuf.Struct>;
  }
/**
 ...
 */
  ...
  restoreAgent(
    ...
    return this.innerApiCalls.restoreAgent(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.protobuf.IEmpty, protos.google.protobuf.IStruct>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.cloud.dialogflow.v2beta1.Agent|Agent}.
 ...
 */
  ...
  searchAgents(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.dialogflow.v2beta1.ISearchAgentsResponse|null|undefined,
          protos.google.cloud.dialogflow.v2beta1.IAgent>): void;
  searchAgents(
      request: protos.google.cloud.dialogflow.v2beta1.ISearchAgentsRequest,
      callback: PaginationCallback<
          protos.google.cloud.dialogflow.v2beta1.ISearchAgentsRequest,
  ...
  searchAgents(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.dialogflow.v2beta1.ISearchAgentsRequest,
      protos.google.cloud.dialogflow.v2beta1.ISearchAgentsResponse|null|undefined,
      protos.google.cloud.dialogflow.v2beta1.IAgent>|undefined = callback
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.cloud.dialogflow.v2beta1.Agent|Agent} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   {@link protos.google.cloud.dialogflow.v2beta1.Agent|Agent}. The API will be called under the hood as needed, once per the page,
