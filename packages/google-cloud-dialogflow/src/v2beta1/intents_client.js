...
class IntentsClient {
  ...
  constructor(opts) {
    ...
    const intentsStub = gaxGrpc.createStub(
      opts.fallback
        ? protos.lookupService('google.cloud.dialogflow.v2beta1.Intents')
   ...
   *
   *   The second parameter to the callback is Array of [Intent]{@link google.cloud.dialogflow.v2beta1.Intent}.
   *
   *   When autoPaginate: false is specified through options, it contains the result
   *   in a single response. If the response indicates the next page exists, the third
   *   parameter is set to be used for the next request object. The fourth parameter keeps
   *   the raw response object of an object representing [ListIntentsResponse]{@link google.cloud.dialogflow.v2beta1.ListIntentsResponse}.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of [Intent]{@link google.cloud.dialogflow.v2beta1.Intent}.
   *
   *   When autoPaginate: false is specified through options, the array has three elements.
   *   The first element is Array of [Intent]{@link google.cloud.dialogflow.v2beta1.Intent} in a single response.
   *   The second element is the next request object if the response
   *   indicates the next page exists, or null. The third element is
   *   an object representing [ListIntentsResponse]{@link google.cloud.dialogflow.v2beta1.ListIntentsResponse}.
   *
   ...
   *   The function which will be called with the result of the API call.
   *
   *   The second parameter to the callback is an object representing [Intent]{@link google.cloud.dialogflow.v2beta1.Intent}.
   * @returns {Promise} - The promise which resolves to an array.
