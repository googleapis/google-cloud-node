...
function main(parent) {
   ...
   */
  // const previousSuggestedQuery = 'abc123'
  ...
  async function callSuggestKnowledgeAssist() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const response = await dialogflowClient.suggestKnowledgeAssist(request);
    console.log(response);
  }

  callSuggestKnowledgeAssist();
