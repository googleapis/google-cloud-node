...
describe('v1.QuotaServiceClient', () => {
    ...
    describe('listQuotaGroups', () => {
        it('invokes listQuotaGroups without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.css.v1.ListQuotaGroupsRequest', ['parent']);
        ...
        it('invokes listQuotaGroups without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listQuotaGroups(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.css.v1.IQuotaGroup[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listQuotaGroupsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.shopping.css.v1.QuotaGroup) => {
