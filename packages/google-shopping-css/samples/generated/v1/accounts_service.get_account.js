...
function main(name) {
  // [START css_v1_generated_AccountsService_GetAccount_async]
  /**
  ...
  async function callGetAccount() {
    ...
    // Run request
    const response = await cssClient.getAccount(request);
    console.log(response);
  }

  callGetAccount();
  // [END css_v1_generated_AccountsService_GetAccount_async]
}
