 ...
 * `src/v1/promotions_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './promotions_service_client_config.json';
 ...
 * @memberof v1
 */
export class PromotionsServiceClient {
  ...
  private _log = logging.log('promotions');
  ...
  promotionsServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this.pathTemplates = {
      promotionPathTemplate: new this._gaxModule.PathTemplate(
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.shopping.merchant.promotions.v1.PromotionsService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.promotionsServiceStub) {
      return this.promotionsServiceStub;
    }
    ...
    this.promotionsServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.shopping.merchant.promotions.v1.PromotionsService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.shopping.merchant.promotions.v1.PromotionsService,
 ...
 * @param {google.shopping.merchant.promotions.v1.Promotion} request.promotion
 ...
 *   The first element of the array is an object representing {@link protos.google.shopping.merchant.promotions.v1.Promotion|Promotion}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/promotions_service.insert_promotion.js</caption>
 * region_tag:merchantapi_v1_generated_PromotionsService_InsertPromotion_async
 */
  insertPromotion(
      request?: protos.google.shopping.merchant.promotions.v1.IInsertPromotionRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.promotions.v1.IPromotion,
        protos.google.shopping.merchant.promotions.v1.IInsertPromotionRequest|undefined, {}|undefined
      ]>;
  insertPromotion(
      request: protos.google.shopping.merchant.promotions.v1.IInsertPromotionRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.promotions.v1.IPromotion,
          protos.google.shopping.merchant.promotions.v1.IInsertPromotionRequest|null|undefined,
          {}|null|undefined>): void;
  insertPromotion(
      request: protos.google.shopping.merchant.promotions.v1.IInsertPromotionRequest,
      callback: Callback<
  ...
  insertPromotion(
    ...
    return this.innerApiCalls.insertPromotion(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.promotions.v1.IPromotion,
        protos.google.shopping.merchant.promotions.v1.IInsertPromotionRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('insertPromotion response %j', response);
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/promotions_service.get_promotion.js</caption>
 * region_tag:merchantapi_v1_generated_PromotionsService_GetPromotion_async
 */
  getPromotion(
      request?: protos.google.shopping.merchant.promotions.v1.IGetPromotionRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.promotions.v1.IPromotion,
        protos.google.shopping.merchant.promotions.v1.IGetPromotionRequest|undefined, {}|undefined
      ]>;
  getPromotion(
      request: protos.google.shopping.merchant.promotions.v1.IGetPromotionRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.promotions.v1.IPromotion,
          protos.google.shopping.merchant.promotions.v1.IGetPromotionRequest|null|undefined,
          {}|null|undefined>): void;
  getPromotion(
      request: protos.google.shopping.merchant.promotions.v1.IGetPromotionRequest,
      callback: Callback<
  ...
  getPromotion(
    ...
    return this.innerApiCalls.getPromotion(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.promotions.v1.IPromotion,
        protos.google.shopping.merchant.promotions.v1.IGetPromotionRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getPromotion response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.shopping.merchant.promotions.v1.Promotion|Promotion}.
 ...
 */
  listPromotions(
      request?: protos.google.shopping.merchant.promotions.v1.IListPromotionsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.promotions.v1.IPromotion[],
        protos.google.shopping.merchant.promotions.v1.IListPromotionsRequest|null,
        protos.google.shopping.merchant.promotions.v1.IListPromotionsResponse
      ]>;
  listPromotions(
      request: protos.google.shopping.merchant.promotions.v1.IListPromotionsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.shopping.merchant.promotions.v1.IListPromotionsRequest,
          protos.google.shopping.merchant.promotions.v1.IListPromotionsResponse|null|undefined,
          protos.google.shopping.merchant.promotions.v1.IPromotion>): void;
  listPromotions(
      request: protos.google.shopping.merchant.promotions.v1.IListPromotionsRequest,
      callback: PaginationCallback<
          protos.google.shopping.merchant.promotions.v1.IListPromotionsRequest,
  ...
  listPromotions(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.shopping.merchant.promotions.v1.IListPromotionsRequest,
      protos.google.shopping.merchant.promotions.v1.IListPromotionsResponse|null|undefined,
      protos.google.shopping.merchant.promotions.v1.IPromotion>|undefined = callback
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.shopping.merchant.promotions.v1.Promotion|Promotion} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   {@link protos.google.shopping.merchant.promotions.v1.Promotion|Promotion}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/promotions_service.list_promotions.js</caption>
 * region_tag:merchantapi_v1_generated_PromotionsService_ListPromotions_async
 */
  listPromotionsAsync(
      request?: protos.google.shopping.merchant.promotions.v1.IListPromotionsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.shopping.merchant.promotions.v1.IPromotion>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listPromotions.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.shopping.merchant.promotions.v1.IPromotion>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.promotionsServiceStub && !this._terminated) {
      return this.promotionsServiceStub.then(stub => {
