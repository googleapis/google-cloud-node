 ...
 * `src/v1beta/promotions_service_client_config.json`.
...
export class PromotionsServiceClient {
  ...
  > | void {
    ...
    this.initialize();
    return this.innerApiCalls.insertPromotion(request, options, callback);
  }
  /**
  ...
  > | void {
    ...
    this.initialize();
    return this.innerApiCalls.getPromotion(request, options, callback);
  }
  ...
  > | void {
    ...
    this.initialize();
    return this.innerApiCalls.listPromotions(request, options, callback);
  }
  ...
  listPromotionsAsync(
    ...
    return this.descriptors.page.listPromotions.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.shopping.merchant.promotions.v1beta.IPromotion>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
