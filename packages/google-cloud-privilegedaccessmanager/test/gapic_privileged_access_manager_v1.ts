  ...
  describe('Path templates', () => {
    describe('folderLocationEntitlementGrants', async () => {
      ...
      it('folderLocationEntitlementGrantsPath', () => {
        const result = client.folderLocationEntitlementGrantsPath(
          'folderValue',
          'locationValue',
          'entitlementValue',
          'grantValue',
        ...
        assert(
          (
            client.pathTemplates.folderLocationEntitlementGrantsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
      ...
      it('matchFolderFromFolderLocationEntitlementGrantsName', () => {
        const result =
          client.matchFolderFromFolderLocationEntitlementGrantsName(fakePath);
      ...
      it('matchLocationFromFolderLocationEntitlementGrantsName', () => {
        const result =
          client.matchLocationFromFolderLocationEntitlementGrantsName(fakePath);
      ...
      it('matchEntitlementFromFolderLocationEntitlementGrantsName', () => {
        const result =
          client.matchEntitlementFromFolderLocationEntitlementGrantsName(
            fakePath,
          );
      ...
      it('matchGrantFromFolderLocationEntitlementGrantsName', () => {
        const result =
          client.matchGrantFromFolderLocationEntitlementGrantsName(fakePath);
    ...
    describe('folderLocationEntitlements', async () => {
      ...
      await client.initialize();
      client.pathTemplates.folderLocationEntitlementsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.folderLocationEntitlementsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('folderLocationEntitlementsPath', () => {
        const result = client.folderLocationEntitlementsPath(
          'folderValue',
          'locationValue',
          'entitlementValue',
        );
        ...
        assert(
          (
            client.pathTemplates.folderLocationEntitlementsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchFolderFromFolderLocationEntitlementsName', () => {
        const result =
          client.matchFolderFromFolderLocationEntitlementsName(fakePath);
        assert.strictEqual(result, 'folderValue');
        assert(
          (
            client.pathTemplates.folderLocationEntitlementsPathTemplate
      ...
      it('matchLocationFromFolderLocationEntitlementsName', () => {
        const result =
          client.matchLocationFromFolderLocationEntitlementsName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.folderLocationEntitlementsPathTemplate
      ...
      it('matchEntitlementFromFolderLocationEntitlementsName', () => {
        const result =
          client.matchEntitlementFromFolderLocationEntitlementsName(fakePath);
        assert.strictEqual(result, 'entitlementValue');
        assert(
          (
            client.pathTemplates.folderLocationEntitlementsPathTemplate
    ...
    describe('organizationLocationEntitlementGrants', async () => {
      ...
      it('organizationLocationEntitlementGrantsPath', () => {
        const result = client.organizationLocationEntitlementGrantsPath(
          'organizationValue',
          'locationValue',
          'entitlementValue',
          'grantValue',
      ...
      it('matchOrganizationFromOrganizationLocationEntitlementGrantsName', () => {
        const result =
          client.matchOrganizationFromOrganizationLocationEntitlementGrantsName(
            fakePath,
          );
      ...
      it('matchLocationFromOrganizationLocationEntitlementGrantsName', () => {
        const result =
          client.matchLocationFromOrganizationLocationEntitlementGrantsName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchEntitlementFromOrganizationLocationEntitlementGrantsName', () => {
        const result =
          client.matchEntitlementFromOrganizationLocationEntitlementGrantsName(
            fakePath,
          );
        assert.strictEqual(result, 'entitlementValue');
        assert(
      ...
      it('matchGrantFromOrganizationLocationEntitlementGrantsName', () => {
        const result =
          client.matchGrantFromOrganizationLocationEntitlementGrantsName(
            fakePath,
          );
        assert.strictEqual(result, 'grantValue');
        assert(
    ...
    describe('organizationLocationEntitlements', async () => {
      ...
      it('organizationLocationEntitlementsPath', () => {
        const result = client.organizationLocationEntitlementsPath(
          'organizationValue',
          'locationValue',
          'entitlementValue',
        );
        ...
        assert(
          (
            client.pathTemplates.organizationLocationEntitlementsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchOrganizationFromOrganizationLocationEntitlementsName', () => {
        const result =
          client.matchOrganizationFromOrganizationLocationEntitlementsName(
            fakePath,
          );
        assert.strictEqual(result, 'organizationValue');
        assert(
      ...
      it('matchLocationFromOrganizationLocationEntitlementsName', () => {
        const result =
          client.matchLocationFromOrganizationLocationEntitlementsName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchEntitlementFromOrganizationLocationEntitlementsName', () => {
        const result =
          client.matchEntitlementFromOrganizationLocationEntitlementsName(
            fakePath,
          );
        assert.strictEqual(result, 'entitlementValue');
        assert(
    ...
    describe('projectLocationEntitlementGrants', async () => {
      ...
      it('projectLocationEntitlementGrantsPath', () => {
        const result = client.projectLocationEntitlementGrantsPath(
          'projectValue',
          'locationValue',
          'entitlementValue',
          'grantValue',
        ...
        assert(
          (
            client.pathTemplates.projectLocationEntitlementGrantsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromProjectLocationEntitlementGrantsName', () => {
        const result =
          client.matchProjectFromProjectLocationEntitlementGrantsName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.projectLocationEntitlementGrantsPathTemplate
      ...
      it('matchLocationFromProjectLocationEntitlementGrantsName', () => {
        const result =
          client.matchLocationFromProjectLocationEntitlementGrantsName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchEntitlementFromProjectLocationEntitlementGrantsName', () => {
        const result =
          client.matchEntitlementFromProjectLocationEntitlementGrantsName(
            fakePath,
          );
        assert.strictEqual(result, 'entitlementValue');
        assert(
      ...
      it('matchGrantFromProjectLocationEntitlementGrantsName', () => {
        const result =
          client.matchGrantFromProjectLocationEntitlementGrantsName(fakePath);
        assert.strictEqual(result, 'grantValue');
        assert(
          (
            client.pathTemplates.projectLocationEntitlementGrantsPathTemplate
    ...
    describe('projectLocationEntitlements', async () => {
      ...
      client.pathTemplates.projectLocationEntitlementsPathTemplate.render =
        sinon.stub().returns(fakePath);
      client.pathTemplates.projectLocationEntitlementsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('projectLocationEntitlementsPath', () => {
        const result = client.projectLocationEntitlementsPath(
          'projectValue',
          'locationValue',
          'entitlementValue',
        );
        ...
        assert(
          (
            client.pathTemplates.projectLocationEntitlementsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromProjectLocationEntitlementsName', () => {
        const result =
          client.matchProjectFromProjectLocationEntitlementsName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.projectLocationEntitlementsPathTemplate
      ...
      it('matchLocationFromProjectLocationEntitlementsName', () => {
        const result =
          client.matchLocationFromProjectLocationEntitlementsName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.projectLocationEntitlementsPathTemplate
      ...
      it('matchEntitlementFromProjectLocationEntitlementsName', () => {
        const result =
          client.matchEntitlementFromProjectLocationEntitlementsName(fakePath);
        assert.strictEqual(result, 'entitlementValue');
        assert(
          (
            client.pathTemplates.projectLocationEntitlementsPathTemplate
