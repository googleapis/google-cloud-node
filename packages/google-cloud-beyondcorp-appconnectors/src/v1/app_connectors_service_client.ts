...
export class AppConnectorsServiceClient {
  ...
  constructor(
    ...
    this.descriptors.page = {
      listAppConnectors: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'appConnectors'
      ),
    ...
    this.appConnectorsServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ...
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.beyondcorp.appconnectors.v1
  ...
  > | void {
    ...
    return this.innerApiCalls
      .getAppConnector(request, options, wrappedCallback)
      ?.then(
  ...
  > | void {
    ...
    return this.innerApiCalls
      .createAppConnector(request, options, wrappedCallback)
      ?.then(
  ...
  > | void {
    ...
    return this.innerApiCalls
      .updateAppConnector(request, options, wrappedCallback)
      ?.then(
        ([response, rawResponse, _]: [
          LROperation<
            protos.google.cloud.beyondcorp.appconnectors.v1.IAppConnector,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .deleteAppConnector(request, options, wrappedCallback)
      ?.then(
        ([response, rawResponse, _]: [
          LROperation<
            protos.google.protobuf.IEmpty,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .reportStatus(request, options, wrappedCallback)
      ?.then(
        ([response, rawResponse, _]: [
          LROperation<
            protos.google.cloud.beyondcorp.appconnectors.v1.IAppConnector,
