...
describe('v1.AppConnectorsServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = appconnectorsserviceModule.v1.AppConnectorsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = appconnectorsserviceModule.v1.AppConnectorsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'beyondcorp.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new appconnectorsserviceModule.v1.AppConnectorsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'beyondcorp.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new appconnectorsserviceModule.v1.AppConnectorsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'beyondcorp.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new appconnectorsserviceModule.v1.AppConnectorsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new appconnectorsserviceModule.v1.AppConnectorsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getAppConnector', () => {
        it('invokes getAppConnector without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.beyondcorp.appconnectors.v1.GetAppConnectorRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getAppConnector as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getAppConnector as SinonStub)
        ...
        it('invokes getAppConnector without error using callback', async () => {
            ...
            client.innerApiCalls.getAppConnector = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAppConnector(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.beyondcorp.appconnectors.v1.IAppConnector|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAppConnector with error', async () => {
            ...
            client.innerApiCalls.getAppConnector = stubSimpleCall(undefined, expectedError);
    ...
    describe('createAppConnector', () => {
        it('invokes createAppConnector without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.beyondcorp.appconnectors.v1.CreateAppConnectorRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createAppConnector = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createAppConnector(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createAppConnector as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createAppConnector as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createAppConnector without error using callback', async () => {
            ...
            client.innerApiCalls.createAppConnector = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createAppConnector(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.beyondcorp.appconnectors.v1.IAppConnector, protos.google.cloud.beyondcorp.appconnectors.v1.IAppConnectorOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.beyondcorp.appconnectors.v1.IAppConnector, protos.google.cloud.beyondcorp.appconnectors.v1.IAppConnectorOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createAppConnector as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createAppConnector with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createAppConnector = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes createAppConnector with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createAppConnector = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createAppConnector(request);
        ...
        it('invokes checkCreateAppConnectorProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateAppConnectorProgress(expectedResponse.name);
        ...
        it('invokes checkCreateAppConnectorProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreateAppConnectorProgress(''), expectedError);
    ...
    describe('updateAppConnector', () => {
        it('invokes updateAppConnector without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.beyondcorp.appconnectors.v1.UpdateAppConnectorRequest', ['appConnector', 'name']);
            request.appConnector.name = defaultValue1;
            const expectedHeaderRequestParams = `app_connector.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updateAppConnector = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateAppConnector(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateAppConnector as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateAppConnector as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateAppConnector without error using callback', async () => {
            ...
            client.innerApiCalls.updateAppConnector = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateAppConnector with call error', async () => {
            ...
            const expectedHeaderRequestParams = `app_connector.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateAppConnector = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes updateAppConnector with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `app_connector.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateAppConnector = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateAppConnector(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateAppConnector as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateAppConnectorProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateAppConnectorProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateAppConnectorProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateAppConnectorProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteAppConnector', () => {
        it('invokes deleteAppConnector without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.beyondcorp.appconnectors.v1.DeleteAppConnectorRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteAppConnector = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteAppConnector(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteAppConnector as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteAppConnector as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteAppConnector without error using callback', async () => {
            ...
            client.innerApiCalls.deleteAppConnector = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteAppConnector(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.beyondcorp.appconnectors.v1.IAppConnectorOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.beyondcorp.appconnectors.v1.IAppConnectorOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteAppConnector as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes deleteAppConnector with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteAppConnector = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes deleteAppConnector with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteAppConnector = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteAppConnector(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteAppConnector as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteAppConnectorProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteAppConnectorProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteAppConnectorProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteAppConnectorProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('reportStatus', () => {
        it('invokes reportStatus without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.beyondcorp.appconnectors.v1.ReportStatusRequest', ['appConnector']);
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.reportStatus as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.reportStatus as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes reportStatus without error using callback', async () => {
            ...
            client.innerApiCalls.reportStatus = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.reportStatus(
                    request,
                    (err?: Error|null,
        ...
        it('invokes reportStatus with call error', async () => {
            ...
            const expectedHeaderRequestParams = `app_connector=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.reportStatus = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes reportStatus with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `app_connector=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.reportStatus = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.reportStatus(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.reportStatus as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkReportStatusProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkReportStatusProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('listAppConnectors', () => {
        it('invokes listAppConnectors without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.beyondcorp.appconnectors.v1.ListAppConnectorsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.beyondcorp.appconnectors.v1.AppConnector()),
              generateSampleMessage(new protos.google.cloud.beyondcorp.appconnectors.v1.AppConnector()),
              generateSampleMessage(new protos.google.cloud.beyondcorp.appconnectors.v1.AppConnector()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listAppConnectors as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAppConnectors as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listAppConnectors without error using callback', async () => {
            ...
            client.innerApiCalls.listAppConnectors = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listAppConnectors with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listAppConnectors = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listAppConnectorsStream without error', async () => {
            ...
            client.descriptors.page.listAppConnectors.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.beyondcorp.appconnectors.v1.AppConnector) => {
            ...
            assert((client.descriptors.page.listAppConnectors.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listAppConnectors, request));
            assert(
        ...
        it('invokes listAppConnectorsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAppConnectors.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listAppConnectorsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.beyondcorp.appconnectors.v1.AppConnector[] = [];
                stream.on('data', (response: protos.google.cloud.beyondcorp.appconnectors.v1.AppConnector) => {
        ...
        it('uses async iteration with listAppConnectors without error', async () => {
            ...
            client.descriptors.page.listAppConnectors.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listAppConnectors with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAppConnectors.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listAppConnectorsAsync(request);
