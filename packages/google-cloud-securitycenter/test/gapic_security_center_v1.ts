...
describe('v1.SecurityCenterClient', () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.groupAssets(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.securitycenter.v1.IGroupResult[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listBigQueryExports(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.securitycenter.v1.IBigQueryExport[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listValuedResources(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.securitycenter.v1.IValuedResource[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('Path templates', () => {
    ...
    describe('folderAssets', async () => {
      ...
      await client.initialize();
      client.pathTemplates.folderAssetsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.folderAssetsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);
      ...
      it('folderAssetsPath', () => {
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.folderAssetsPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchFolderFromFolderAssetsName', () => {
        ...
        assert.strictEqual(result, 'folderValue');
        assert(
          (client.pathTemplates.folderAssetsPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('folderBigQueryExports', async () => {
      ...
      await client.initialize();
      client.pathTemplates.folderBigQueryExportsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.folderBigQueryExportsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('folderBigQueryExportsPath', () => {
        const result = client.folderBigQueryExportsPath(
          'folderValue',
          'exportValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.folderBigQueryExportsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchFolderFromFolderBigQueryExportsName', () => {
        const result =
          client.matchFolderFromFolderBigQueryExportsName(fakePath);
        assert.strictEqual(result, 'folderValue');
        assert(
          (
            client.pathTemplates.folderBigQueryExportsPathTemplate
      ...
      it('matchExportFromFolderBigQueryExportsName', () => {
        const result =
          client.matchExportFromFolderBigQueryExportsName(fakePath);
    ...
    describe('folderLocationMuteConfigs', async () => {
      ...
      await client.initialize();
      client.pathTemplates.folderLocationMuteConfigsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.folderLocationMuteConfigsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('folderLocationMuteConfigsPath', () => {
        const result = client.folderLocationMuteConfigsPath(
          'folderValue',
          'locationValue',
          'muteConfigValue',
        );
        ...
        assert(
          (
            client.pathTemplates.folderLocationMuteConfigsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchFolderFromFolderLocationMuteConfigsName', () => {
        const result =
          client.matchFolderFromFolderLocationMuteConfigsName(fakePath);
        assert.strictEqual(result, 'folderValue');
        assert(
          (
            client.pathTemplates.folderLocationMuteConfigsPathTemplate
      ...
      it('matchLocationFromFolderLocationMuteConfigsName', () => {
        const result =
          client.matchLocationFromFolderLocationMuteConfigsName(fakePath);
      ...
      it('matchMuteConfigFromFolderLocationMuteConfigsName', () => {
        const result =
          client.matchMuteConfigFromFolderLocationMuteConfigsName(fakePath);
    ...
    describe('folderMuteConfigs', async () => {
      ...
      await client.initialize();
      client.pathTemplates.folderMuteConfigsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.folderMuteConfigsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('folderMuteConfigsPath', () => {
        const result = client.folderMuteConfigsPath(
          'folderValue',
          'muteConfigValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.folderMuteConfigsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchMuteConfigFromFolderMuteConfigsName', () => {
        const result =
          client.matchMuteConfigFromFolderMuteConfigsName(fakePath);
        assert.strictEqual(result, 'muteConfigValue');
        assert(
          (
            client.pathTemplates.folderMuteConfigsPathTemplate
    ...
    describe('folderNotificationConfigs', async () => {
      ...
      await client.initialize();
      client.pathTemplates.folderNotificationConfigsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.folderNotificationConfigsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('folderNotificationConfigsPath', () => {
        const result = client.folderNotificationConfigsPath(
          'folderValue',
        ...
        assert(
          (
            client.pathTemplates.folderNotificationConfigsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchFolderFromFolderNotificationConfigsName', () => {
        const result =
          client.matchFolderFromFolderNotificationConfigsName(fakePath);
        assert.strictEqual(result, 'folderValue');
        assert(
          (
            client.pathTemplates.folderNotificationConfigsPathTemplate
      ...
      it('matchNotificationConfigFromFolderNotificationConfigsName', () => {
        const result =
          client.matchNotificationConfigFromFolderNotificationConfigsName(
            fakePath,
          );
    ...
    describe('folderSourceFindingExternalSystems', async () => {
      ...
      it('folderSourceFindingExternalSystemsPath', () => {
        const result = client.folderSourceFindingExternalSystemsPath(
          'folderValue',
          'sourceValue',
          'findingValue',
          'externalsystemValue',
        ...
        assert(
          (
            client.pathTemplates.folderSourceFindingExternalSystemsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchFolderFromFolderSourceFindingExternalSystemsName', () => {
        const result =
          client.matchFolderFromFolderSourceFindingExternalSystemsName(
            fakePath,
          );
        assert.strictEqual(result, 'folderValue');
        assert(
      ...
      it('matchSourceFromFolderSourceFindingExternalSystemsName', () => {
        const result =
          client.matchSourceFromFolderSourceFindingExternalSystemsName(
            fakePath,
          );
        assert.strictEqual(result, 'sourceValue');
        assert(
      ...
      it('matchFindingFromFolderSourceFindingExternalSystemsName', () => {
        const result =
          client.matchFindingFromFolderSourceFindingExternalSystemsName(
            fakePath,
          );
      ...
      it('matchExternalsystemFromFolderSourceFindingExternalSystemsName', () => {
        const result =
          client.matchExternalsystemFromFolderSourceFindingExternalSystemsName(
            fakePath,
          );
    ...
    describe('organizationAssets', async () => {
      ...
      await client.initialize();
      client.pathTemplates.organizationAssetsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.organizationAssetsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('organizationAssetsPath', () => {
        const result = client.organizationAssetsPath(
          'organizationValue',
          'assetValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.organizationAssetsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchOrganizationFromOrganizationAssetsName', () => {
        const result =
          client.matchOrganizationFromOrganizationAssetsName(fakePath);
        assert.strictEqual(result, 'organizationValue');
        assert(
          (
            client.pathTemplates.organizationAssetsPathTemplate
    ...
    describe('organizationBigQueryExports', async () => {
      ...
      client.pathTemplates.organizationBigQueryExportsPathTemplate.render =
        sinon.stub().returns(fakePath);
      client.pathTemplates.organizationBigQueryExportsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('organizationBigQueryExportsPath', () => {
        const result = client.organizationBigQueryExportsPath(
          'organizationValue',
          'exportValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.organizationBigQueryExportsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchOrganizationFromOrganizationBigQueryExportsName', () => {
        const result =
          client.matchOrganizationFromOrganizationBigQueryExportsName(fakePath);
        assert.strictEqual(result, 'organizationValue');
        assert(
          (
            client.pathTemplates.organizationBigQueryExportsPathTemplate
      ...
      it('matchExportFromOrganizationBigQueryExportsName', () => {
        const result =
          client.matchExportFromOrganizationBigQueryExportsName(fakePath);
        assert.strictEqual(result, 'exportValue');
        assert(
          (
            client.pathTemplates.organizationBigQueryExportsPathTemplate
    ...
    describe('organizationLocationMuteConfigs', async () => {
      ...
      it('organizationLocationMuteConfigsPath', () => {
        const result = client.organizationLocationMuteConfigsPath(
          'organizationValue',
          'locationValue',
          'muteConfigValue',
        );
      ...
      it('matchOrganizationFromOrganizationLocationMuteConfigsName', () => {
        const result =
          client.matchOrganizationFromOrganizationLocationMuteConfigsName(
            fakePath,
          );
        assert.strictEqual(result, 'organizationValue');
        assert(
      ...
      it('matchLocationFromOrganizationLocationMuteConfigsName', () => {
        const result =
          client.matchLocationFromOrganizationLocationMuteConfigsName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.organizationLocationMuteConfigsPathTemplate
      ...
      it('matchMuteConfigFromOrganizationLocationMuteConfigsName', () => {
        const result =
          client.matchMuteConfigFromOrganizationLocationMuteConfigsName(
            fakePath,
          );
        assert.strictEqual(result, 'muteConfigValue');
        assert(
    ...
    describe('organizationMuteConfigs', async () => {
      ...
      await client.initialize();
      client.pathTemplates.organizationMuteConfigsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.organizationMuteConfigsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('organizationMuteConfigsPath', () => {
        const result = client.organizationMuteConfigsPath(
          'organizationValue',
          'muteConfigValue',
        );
        assert.strictEqual(result, fakePath);
      ...
      it('matchOrganizationFromOrganizationMuteConfigsName', () => {
        const result =
          client.matchOrganizationFromOrganizationMuteConfigsName(fakePath);
        assert.strictEqual(result, 'organizationValue');
        assert(
          (
            client.pathTemplates.organizationMuteConfigsPathTemplate
      ...
      it('matchMuteConfigFromOrganizationMuteConfigsName', () => {
        const result =
          client.matchMuteConfigFromOrganizationMuteConfigsName(fakePath);
        assert.strictEqual(result, 'muteConfigValue');
        assert(
          (
            client.pathTemplates.organizationMuteConfigsPathTemplate
    ...
    describe('organizationNotificationConfigs', async () => {
      ...
      it('organizationNotificationConfigsPath', () => {
        const result = client.organizationNotificationConfigsPath(
          'organizationValue',
          'notificationConfigValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.organizationNotificationConfigsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchOrganizationFromOrganizationNotificationConfigsName', () => {
        const result =
          client.matchOrganizationFromOrganizationNotificationConfigsName(
            fakePath,
          );
        assert.strictEqual(result, 'organizationValue');
        assert(
      ...
      it('matchNotificationConfigFromOrganizationNotificationConfigsName', () => {
        const result =
          client.matchNotificationConfigFromOrganizationNotificationConfigsName(
            fakePath,
          );
        assert.strictEqual(result, 'notificationConfigValue');
        assert(
    ...
    describe('organizationSourceFindingExternalSystems', async () => {
      const fakePath =
        '/rendered/path/organizationSourceFindingExternalSystems';
      const expectedParameters = {
        organization: 'organizationValue',
        source: 'sourceValue',
        finding: 'findingValue',
      ...
      it('organizationSourceFindingExternalSystemsPath', () => {
        const result = client.organizationSourceFindingExternalSystemsPath(
          'organizationValue',
          'sourceValue',
          'findingValue',
          'externalsystemValue',
        ...
        assert(
          (
            client.pathTemplates
              .organizationSourceFindingExternalSystemsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchOrganizationFromOrganizationSourceFindingExternalSystemsName', () => {
        const result =
          client.matchOrganizationFromOrganizationSourceFindingExternalSystemsName(
            fakePath,
          );
        assert.strictEqual(result, 'organizationValue');
        assert(
      ...
      it('matchSourceFromOrganizationSourceFindingExternalSystemsName', () => {
        const result =
          client.matchSourceFromOrganizationSourceFindingExternalSystemsName(
            fakePath,
          );
        assert.strictEqual(result, 'sourceValue');
        assert(
      ...
      it('matchFindingFromOrganizationSourceFindingExternalSystemsName', () => {
        const result =
          client.matchFindingFromOrganizationSourceFindingExternalSystemsName(
            fakePath,
          );
        assert.strictEqual(result, 'findingValue');
        assert(
      ...
      it('matchExternalsystemFromOrganizationSourceFindingExternalSystemsName', () => {
        const result =
          client.matchExternalsystemFromOrganizationSourceFindingExternalSystemsName(
            fakePath,
          );
        assert.strictEqual(result, 'externalsystemValue');
        assert(
    ...
    describe('projectAssets', async () => {
      ...
      await client.initialize();
      client.pathTemplates.projectAssetsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.projectAssetsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);
      ...
      it('projectAssetsPath', () => {
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.projectAssetsPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromProjectAssetsName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.projectAssetsPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('projectBigQueryExports', async () => {
      ...
      await client.initialize();
      client.pathTemplates.projectBigQueryExportsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.projectBigQueryExportsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);
      ...
      it('projectBigQueryExportsPath', () => {
        ...
        assert(
          (
            client.pathTemplates.projectBigQueryExportsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromProjectBigQueryExportsName', () => {
        const result =
          client.matchProjectFromProjectBigQueryExportsName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.projectBigQueryExportsPathTemplate
      ...
      it('matchExportFromProjectBigQueryExportsName', () => {
        const result =
          client.matchExportFromProjectBigQueryExportsName(fakePath);
        assert.strictEqual(result, 'exportValue');
        assert(
          (
            client.pathTemplates.projectBigQueryExportsPathTemplate
    ...
    describe('projectLocationMuteConfigs', async () => {
      ...
      await client.initialize();
      client.pathTemplates.projectLocationMuteConfigsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.projectLocationMuteConfigsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('projectLocationMuteConfigsPath', () => {
        const result = client.projectLocationMuteConfigsPath(
          'projectValue',
          'locationValue',
          'muteConfigValue',
        );
      ...
      it('matchProjectFromProjectLocationMuteConfigsName', () => {
        const result =
          client.matchProjectFromProjectLocationMuteConfigsName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.projectLocationMuteConfigsPathTemplate
      ...
      it('matchLocationFromProjectLocationMuteConfigsName', () => {
        const result =
          client.matchLocationFromProjectLocationMuteConfigsName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.projectLocationMuteConfigsPathTemplate
      ...
      it('matchMuteConfigFromProjectLocationMuteConfigsName', () => {
        const result =
          client.matchMuteConfigFromProjectLocationMuteConfigsName(fakePath);
        assert.strictEqual(result, 'muteConfigValue');
        assert(
          (
            client.pathTemplates.projectLocationMuteConfigsPathTemplate
    ...
    describe('projectMuteConfigs', async () => {
      ...
      await client.initialize();
      client.pathTemplates.projectMuteConfigsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.projectMuteConfigsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('projectMuteConfigsPath', () => {
        const result = client.projectMuteConfigsPath(
          'projectValue',
          'muteConfigValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.projectMuteConfigsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchMuteConfigFromProjectMuteConfigsName', () => {
        const result =
          client.matchMuteConfigFromProjectMuteConfigsName(fakePath);
        assert.strictEqual(result, 'muteConfigValue');
        assert(
          (
            client.pathTemplates.projectMuteConfigsPathTemplate
    ...
    describe('projectNotificationConfigs', async () => {
      ...
      await client.initialize();
      client.pathTemplates.projectNotificationConfigsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.projectNotificationConfigsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);
      ...
      it('projectNotificationConfigsPath', () => {
        ...
        assert(
          (
            client.pathTemplates.projectNotificationConfigsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromProjectNotificationConfigsName', () => {
        const result =
          client.matchProjectFromProjectNotificationConfigsName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.projectNotificationConfigsPathTemplate
      ...
      it('matchNotificationConfigFromProjectNotificationConfigsName', () => {
        const result =
          client.matchNotificationConfigFromProjectNotificationConfigsName(
            fakePath,
          );
        assert.strictEqual(result, 'notificationConfigValue');
        assert(
    ...
    describe('projectSourceFindingExternalSystems', async () => {
      ...
      it('projectSourceFindingExternalSystemsPath', () => {
        const result = client.projectSourceFindingExternalSystemsPath(
          'projectValue',
          'sourceValue',
          'findingValue',
          'externalsystemValue',
        ...
        assert(
          (
            client.pathTemplates.projectSourceFindingExternalSystemsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromProjectSourceFindingExternalSystemsName', () => {
        const result =
          client.matchProjectFromProjectSourceFindingExternalSystemsName(
            fakePath,
          );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchSourceFromProjectSourceFindingExternalSystemsName', () => {
        const result =
          client.matchSourceFromProjectSourceFindingExternalSystemsName(
            fakePath,
          );
        assert.strictEqual(result, 'sourceValue');
        assert(
      ...
      it('matchFindingFromProjectSourceFindingExternalSystemsName', () => {
        const result =
          client.matchFindingFromProjectSourceFindingExternalSystemsName(
            fakePath,
          );
        assert.strictEqual(result, 'findingValue');
        assert(
      ...
      it('matchExternalsystemFromProjectSourceFindingExternalSystemsName', () => {
        const result =
          client.matchExternalsystemFromProjectSourceFindingExternalSystemsName(
            fakePath,
          );
        assert.strictEqual(result, 'externalsystemValue');
        assert(
