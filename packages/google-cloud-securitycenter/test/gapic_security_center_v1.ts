...
describe('v1.SecurityCenterClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new securitycenterModule.v1.SecurityCenterClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'securitycenter.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new securitycenterModule.v1.SecurityCenterClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'securitycenter.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new securitycenterModule.v1.SecurityCenterClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new securitycenterModule.v1.SecurityCenterClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createSecurityHealthAnalyticsCustomModule', () => {
        it('invokes createSecurityHealthAnalyticsCustomModule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.CreateSecurityHealthAnalyticsCustomModuleRequest', ['parent']);
        ...
        it('invokes createSecurityHealthAnalyticsCustomModule without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createSecurityHealthAnalyticsCustomModule(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.securitycenter.v1.ISecurityHealthAnalyticsCustomModule|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createSource', () => {
        it('invokes createSource without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.CreateSourceRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createFinding', () => {
        it('invokes createFinding without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.CreateFindingRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createMuteConfig', () => {
        it('invokes createMuteConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.CreateMuteConfigRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createNotificationConfig', () => {
        it('invokes createNotificationConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.CreateNotificationConfigRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('deleteMuteConfig', () => {
        it('invokes deleteMuteConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.DeleteMuteConfigRequest', ['name']);
    ...
    describe('deleteNotificationConfig', () => {
        it('invokes deleteNotificationConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.DeleteNotificationConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('deleteSecurityHealthAnalyticsCustomModule', () => {
        it('invokes deleteSecurityHealthAnalyticsCustomModule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.DeleteSecurityHealthAnalyticsCustomModuleRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('getSimulation', () => {
        it('invokes getSimulation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.GetSimulationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getSimulation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getSimulation(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.securitycenter.v1.ISimulation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getValuedResource', () => {
        it('invokes getValuedResource without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.GetValuedResourceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getValuedResource without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getValuedResource(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.securitycenter.v1.IValuedResource|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getBigQueryExport', () => {
        it('invokes getBigQueryExport without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.GetBigQueryExportRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getBigQueryExport without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getBigQueryExport(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.securitycenter.v1.IBigQueryExport|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getMuteConfig', () => {
        it('invokes getMuteConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.GetMuteConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.securitycenter.v1.MuteConfig()
    ...
    describe('getNotificationConfig', () => {
        it('invokes getNotificationConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.GetNotificationConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.securitycenter.v1.NotificationConfig()
    ...
    describe('getOrganizationSettings', () => {
        it('invokes getOrganizationSettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.GetOrganizationSettingsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getEffectiveSecurityHealthAnalyticsCustomModule', () => {
        it('invokes getEffectiveSecurityHealthAnalyticsCustomModule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.GetEffectiveSecurityHealthAnalyticsCustomModuleRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getEffectiveSecurityHealthAnalyticsCustomModule without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getEffectiveSecurityHealthAnalyticsCustomModule(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.securitycenter.v1.IEffectiveSecurityHealthAnalyticsCustomModule|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getSecurityHealthAnalyticsCustomModule', () => {
        it('invokes getSecurityHealthAnalyticsCustomModule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.GetSecurityHealthAnalyticsCustomModuleRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.securitycenter.v1.SecurityHealthAnalyticsCustomModule()
    ...
    describe('getSource', () => {
        it('invokes getSource without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.GetSourceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.securitycenter.v1.Source()
    ...
    describe('setFindingState', () => {
        it('invokes setFindingState without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.SetFindingStateRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.securitycenter.v1.Finding()
    ...
    describe('setMute', () => {
        it('invokes setMute without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.SetMuteRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.securitycenter.v1.Finding()
    ...
    describe('simulateSecurityHealthAnalyticsCustomModule', () => {
        it('invokes simulateSecurityHealthAnalyticsCustomModule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.SimulateSecurityHealthAnalyticsCustomModuleRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes simulateSecurityHealthAnalyticsCustomModule without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.simulateSecurityHealthAnalyticsCustomModule(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.securitycenter.v1.ISimulateSecurityHealthAnalyticsCustomModuleResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateExternalSystem', () => {
        it('invokes updateExternalSystem without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.UpdateExternalSystemRequest', ['externalSystem', 'name']);
    ...
    describe('updateFinding', () => {
        it('invokes updateFinding without error', async () => {
            ...
            request.finding ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.UpdateFindingRequest', ['finding', 'name']);
    ...
    describe('updateMuteConfig', () => {
        it('invokes updateMuteConfig without error', async () => {
            ...
            request.muteConfig ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.UpdateMuteConfigRequest', ['muteConfig', 'name']);
    ...
    describe('updateNotificationConfig', () => {
        it('invokes updateNotificationConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.UpdateNotificationConfigRequest', ['notificationConfig', 'name']);
    ...
    describe('updateOrganizationSettings', () => {
        it('invokes updateOrganizationSettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.UpdateOrganizationSettingsRequest', ['organizationSettings', 'name']);
    ...
    describe('updateSecurityHealthAnalyticsCustomModule', () => {
        it('invokes updateSecurityHealthAnalyticsCustomModule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.UpdateSecurityHealthAnalyticsCustomModuleRequest', ['securityHealthAnalyticsCustomModule', 'name']);
    ...
    describe('updateSource', () => {
        it('invokes updateSource without error', async () => {
            ...
            request.source ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.UpdateSourceRequest', ['source', 'name']);
    ...
    describe('updateSecurityMarks', () => {
        it('invokes updateSecurityMarks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.UpdateSecurityMarksRequest', ['securityMarks', 'name']);
    ...
    describe('createBigQueryExport', () => {
        it('invokes createBigQueryExport without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.CreateBigQueryExportRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.securitycenter.v1.BigQueryExport()
    ...
    describe('deleteBigQueryExport', () => {
        it('invokes deleteBigQueryExport without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.DeleteBigQueryExportRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('updateBigQueryExport', () => {
        it('invokes updateBigQueryExport without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.UpdateBigQueryExportRequest', ['bigQueryExport', 'name']);
    ...
    describe('createEventThreatDetectionCustomModule', () => {
        it('invokes createEventThreatDetectionCustomModule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.CreateEventThreatDetectionCustomModuleRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes createEventThreatDetectionCustomModule without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createEventThreatDetectionCustomModule(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.securitycenter.v1.IEventThreatDetectionCustomModule|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deleteEventThreatDetectionCustomModule', () => {
        it('invokes deleteEventThreatDetectionCustomModule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.DeleteEventThreatDetectionCustomModuleRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('getEventThreatDetectionCustomModule', () => {
        it('invokes getEventThreatDetectionCustomModule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.GetEventThreatDetectionCustomModuleRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.securitycenter.v1.EventThreatDetectionCustomModule()
    ...
    describe('updateEventThreatDetectionCustomModule', () => {
        it('invokes updateEventThreatDetectionCustomModule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.UpdateEventThreatDetectionCustomModuleRequest', ['eventThreatDetectionCustomModule', 'name']);
    ...
    describe('validateEventThreatDetectionCustomModule', () => {
        it('invokes validateEventThreatDetectionCustomModule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.ValidateEventThreatDetectionCustomModuleRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes validateEventThreatDetectionCustomModule without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.validateEventThreatDetectionCustomModule(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.securitycenter.v1.IValidateEventThreatDetectionCustomModuleResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getEffectiveEventThreatDetectionCustomModule', () => {
        it('invokes getEffectiveEventThreatDetectionCustomModule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.GetEffectiveEventThreatDetectionCustomModuleRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getEffectiveEventThreatDetectionCustomModule without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getEffectiveEventThreatDetectionCustomModule(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.securitycenter.v1.IEffectiveEventThreatDetectionCustomModule|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('batchCreateResourceValueConfigs', () => {
        it('invokes batchCreateResourceValueConfigs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.BatchCreateResourceValueConfigsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes batchCreateResourceValueConfigs without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchCreateResourceValueConfigs(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.securitycenter.v1.IBatchCreateResourceValueConfigsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deleteResourceValueConfig', () => {
        it('invokes deleteResourceValueConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.DeleteResourceValueConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('getResourceValueConfig', () => {
        it('invokes getResourceValueConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.GetResourceValueConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getResourceValueConfig without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getResourceValueConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.securitycenter.v1.IResourceValueConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateResourceValueConfig', () => {
        it('invokes updateResourceValueConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.UpdateResourceValueConfigRequest', ['resourceValueConfig', 'name']);
    ...
    describe('bulkMuteFindings', () => {
        it('invokes bulkMuteFindings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.BulkMuteFindingsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('runAssetDiscovery', () => {
        it('invokes runAssetDiscovery without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.RunAssetDiscoveryRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('groupAssets', () => {
        it('invokes groupAssets without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.GroupAssetsRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('groupFindings', () => {
        it('invokes groupFindings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.GroupFindingsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.securitycenter.v1.GroupResult()),
              generateSampleMessage(new protos.google.cloud.securitycenter.v1.GroupResult()),
    ...
    describe('listAssets', () => {
        it('invokes listAssets without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.ListAssetsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
    ...
    describe('listDescendantSecurityHealthAnalyticsCustomModules', () => {
        it('invokes listDescendantSecurityHealthAnalyticsCustomModules without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.ListDescendantSecurityHealthAnalyticsCustomModulesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.securitycenter.v1.SecurityHealthAnalyticsCustomModule()),
              generateSampleMessage(new protos.google.cloud.securitycenter.v1.SecurityHealthAnalyticsCustomModule()),
              generateSampleMessage(new protos.google.cloud.securitycenter.v1.SecurityHealthAnalyticsCustomModule()),
            ];
        ...
        it('invokes listDescendantSecurityHealthAnalyticsCustomModulesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.securitycenter.v1.SecurityHealthAnalyticsCustomModule) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listFindings', () => {
        it('invokes listFindings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.ListFindingsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
    ...
    describe('listMuteConfigs', () => {
        it('invokes listMuteConfigs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.ListMuteConfigsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
    ...
    describe('listNotificationConfigs', () => {
        it('invokes listNotificationConfigs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.ListNotificationConfigsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
    ...
    describe('listEffectiveSecurityHealthAnalyticsCustomModules', () => {
        it('invokes listEffectiveSecurityHealthAnalyticsCustomModules without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.ListEffectiveSecurityHealthAnalyticsCustomModulesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.securitycenter.v1.EffectiveSecurityHealthAnalyticsCustomModule()),
              generateSampleMessage(new protos.google.cloud.securitycenter.v1.EffectiveSecurityHealthAnalyticsCustomModule()),
              generateSampleMessage(new protos.google.cloud.securitycenter.v1.EffectiveSecurityHealthAnalyticsCustomModule()),
            ];
        ...
        it('invokes listEffectiveSecurityHealthAnalyticsCustomModulesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.securitycenter.v1.EffectiveSecurityHealthAnalyticsCustomModule) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listSecurityHealthAnalyticsCustomModules', () => {
        it('invokes listSecurityHealthAnalyticsCustomModules without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.ListSecurityHealthAnalyticsCustomModulesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.securitycenter.v1.SecurityHealthAnalyticsCustomModule()),
              generateSampleMessage(new protos.google.cloud.securitycenter.v1.SecurityHealthAnalyticsCustomModule()),
    ...
    describe('listSources', () => {
        it('invokes listSources without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.ListSourcesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
    ...
    describe('listBigQueryExports', () => {
        it('invokes listBigQueryExports without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.ListBigQueryExportsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.securitycenter.v1.BigQueryExport()),
              generateSampleMessage(new protos.google.cloud.securitycenter.v1.BigQueryExport()),
              generateSampleMessage(new protos.google.cloud.securitycenter.v1.BigQueryExport()),
            ];
        ...
        it('invokes listBigQueryExportsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.securitycenter.v1.BigQueryExport) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listDescendantEventThreatDetectionCustomModules', () => {
        it('invokes listDescendantEventThreatDetectionCustomModules without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.ListDescendantEventThreatDetectionCustomModulesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.securitycenter.v1.EventThreatDetectionCustomModule()),
              generateSampleMessage(new protos.google.cloud.securitycenter.v1.EventThreatDetectionCustomModule()),
              generateSampleMessage(new protos.google.cloud.securitycenter.v1.EventThreatDetectionCustomModule()),
            ];
        ...
        it('invokes listDescendantEventThreatDetectionCustomModulesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.securitycenter.v1.EventThreatDetectionCustomModule) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listEventThreatDetectionCustomModules', () => {
        it('invokes listEventThreatDetectionCustomModules without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.ListEventThreatDetectionCustomModulesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.securitycenter.v1.EventThreatDetectionCustomModule()),
              generateSampleMessage(new protos.google.cloud.securitycenter.v1.EventThreatDetectionCustomModule()),
    ...
    describe('listEffectiveEventThreatDetectionCustomModules', () => {
        it('invokes listEffectiveEventThreatDetectionCustomModules without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.ListEffectiveEventThreatDetectionCustomModulesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
    ...
    describe('listResourceValueConfigs', () => {
        it('invokes listResourceValueConfigs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.ListResourceValueConfigsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.securitycenter.v1.ResourceValueConfig()),
              generateSampleMessage(new protos.google.cloud.securitycenter.v1.ResourceValueConfig()),
              generateSampleMessage(new protos.google.cloud.securitycenter.v1.ResourceValueConfig()),
            ];
        ...
        it('invokes listResourceValueConfigsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.securitycenter.v1.ResourceValueConfig) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listValuedResources', () => {
        it('invokes listValuedResources without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.ListValuedResourcesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
        ...
        it('invokes listValuedResourcesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.securitycenter.v1.ValuedResource) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listAttackPaths', () => {
        it('invokes listAttackPaths without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.securitycenter.v1.ListAttackPathsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.securitycenter.v1.AttackPath()),
              generateSampleMessage(new protos.google.cloud.securitycenter.v1.AttackPath()),
              generateSampleMessage(new protos.google.cloud.securitycenter.v1.AttackPath()),
            ];
        ...
        it('invokes listAttackPaths without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listAttackPaths(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.securitycenter.v1.IAttackPath[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listAttackPathsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.securitycenter.v1.AttackPath) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('Path templates', () => {
        ...
        describe('folderAssets', async () => {
            const fakePath = "/rendered/path/folderAssets";
            const expectedParameters = {
                folder: "folderValue",
                asset: "assetValue",
            };
            ...
            await client.initialize();
            client.pathTemplates.folderAssetsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.folderAssetsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('folderAssetsPath', () => {
                const result = client.folderAssetsPath("folderValue", "assetValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.folderAssetsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchFolderFromFolderAssetsName', () => {
                const result = client.matchFolderFromFolderAssetsName(fakePath);
                assert.strictEqual(result, "folderValue");
                assert((client.pathTemplates.folderAssetsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchAssetFromFolderAssetsName', () => {
                const result = client.matchAssetFromFolderAssetsName(fakePath);
                assert.strictEqual(result, "assetValue");
                assert((client.pathTemplates.folderAssetsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('folderBigQueryExports', async () => {
            const fakePath = "/rendered/path/folderBigQueryExports";
            const expectedParameters = {
                folder: "folderValue",
                export: "exportValue",
            };
            ...
            await client.initialize();
            client.pathTemplates.folderBigQueryExportsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.folderBigQueryExportsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('folderBigQueryExportsPath', () => {
                const result = client.folderBigQueryExportsPath("folderValue", "exportValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.folderBigQueryExportsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchFolderFromFolderBigQueryExportsName', () => {
                const result = client.matchFolderFromFolderBigQueryExportsName(fakePath);
                assert.strictEqual(result, "folderValue");
                assert((client.pathTemplates.folderBigQueryExportsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchExportFromFolderBigQueryExportsName', () => {
                const result = client.matchExportFromFolderBigQueryExportsName(fakePath);
        ...
        describe('folderEventThreatDetectionSettingsModule', async () => {
            const fakePath = "/rendered/path/folderEventThreatDetectionSettingsModule";
            const expectedParameters = {
                folder: "folderValue",
                module: "moduleValue",
            };
            ...
            it('folderEventThreatDetectionSettingsModulePath', () => {
                const result = client.folderEventThreatDetectionSettingsModulePath("folderValue", "moduleValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.folderEventThreatDetectionSettingsModulePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchFolderFromFolderEventThreatDetectionSettingsModuleName', () => {
                const result = client.matchFolderFromFolderEventThreatDetectionSettingsModuleName(fakePath);
                assert.strictEqual(result, "folderValue");
                assert((client.pathTemplates.folderEventThreatDetectionSettingsModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchModuleFromFolderEventThreatDetectionSettingsModuleName', () => {
                const result = client.matchModuleFromFolderEventThreatDetectionSettingsModuleName(fakePath);
        ...
        describe('folderLocationMuteConfigs', async () => {
            const fakePath = "/rendered/path/folderLocationMuteConfigs";
            const expectedParameters = {
                folder: "folderValue",
            ...
            await client.initialize();
            client.pathTemplates.folderLocationMuteConfigsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.folderLocationMuteConfigsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('folderLocationMuteConfigsPath', () => {
                const result = client.folderLocationMuteConfigsPath("folderValue", "locationValue", "muteConfigValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.folderLocationMuteConfigsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchFolderFromFolderLocationMuteConfigsName', () => {
                const result = client.matchFolderFromFolderLocationMuteConfigsName(fakePath);
                assert.strictEqual(result, "folderValue");
                assert((client.pathTemplates.folderLocationMuteConfigsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromFolderLocationMuteConfigsName', () => {
                const result = client.matchLocationFromFolderLocationMuteConfigsName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.folderLocationMuteConfigsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchMuteConfigFromFolderLocationMuteConfigsName', () => {
                const result = client.matchMuteConfigFromFolderLocationMuteConfigsName(fakePath);
        ...
        describe('folderMuteConfigs', async () => {
            const fakePath = "/rendered/path/folderMuteConfigs";
            const expectedParameters = {
                folder: "folderValue",
                mute_config: "muteConfigValue",
            };
            ...
            await client.initialize();
            client.pathTemplates.folderMuteConfigsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.folderMuteConfigsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('folderMuteConfigsPath', () => {
                const result = client.folderMuteConfigsPath("folderValue", "muteConfigValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.folderMuteConfigsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchFolderFromFolderMuteConfigsName', () => {
                const result = client.matchFolderFromFolderMuteConfigsName(fakePath);
                assert.strictEqual(result, "folderValue");
                assert((client.pathTemplates.folderMuteConfigsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchMuteConfigFromFolderMuteConfigsName', () => {
                const result = client.matchMuteConfigFromFolderMuteConfigsName(fakePath);
                assert.strictEqual(result, "muteConfigValue");
                assert((client.pathTemplates.folderMuteConfigsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('folderNotificationConfigs', async () => {
            const fakePath = "/rendered/path/folderNotificationConfigs";
            const expectedParameters = {
                folder: "folderValue",
            ...
            await client.initialize();
            client.pathTemplates.folderNotificationConfigsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.folderNotificationConfigsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('folderNotificationConfigsPath', () => {
                const result = client.folderNotificationConfigsPath("folderValue", "notificationConfigValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.folderNotificationConfigsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchFolderFromFolderNotificationConfigsName', () => {
                const result = client.matchFolderFromFolderNotificationConfigsName(fakePath);
                assert.strictEqual(result, "folderValue");
                assert((client.pathTemplates.folderNotificationConfigsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchNotificationConfigFromFolderNotificationConfigsName', () => {
                const result = client.matchNotificationConfigFromFolderNotificationConfigsName(fakePath);
        ...
        describe('folderSecurityHealthAnalyticsSettingsCustomModule', async () => {
            const fakePath = "/rendered/path/folderSecurityHealthAnalyticsSettingsCustomModule";
            const expectedParameters = {
                folder: "folderValue",
            ...
            it('folderSecurityHealthAnalyticsSettingsCustomModulePath', () => {
                const result = client.folderSecurityHealthAnalyticsSettingsCustomModulePath("folderValue", "customModuleValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.folderSecurityHealthAnalyticsSettingsCustomModulePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchFolderFromFolderSecurityHealthAnalyticsSettingsCustomModuleName', () => {
                const result = client.matchFolderFromFolderSecurityHealthAnalyticsSettingsCustomModuleName(fakePath);
                assert.strictEqual(result, "folderValue");
                assert((client.pathTemplates.folderSecurityHealthAnalyticsSettingsCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchCustomModuleFromFolderSecurityHealthAnalyticsSettingsCustomModuleName', () => {
                const result = client.matchCustomModuleFromFolderSecurityHealthAnalyticsSettingsCustomModuleName(fakePath);
        ...
        describe('folderSecurityHealthAnalyticsSettingsEffectiveCustomModule', async () => {
            const fakePath = "/rendered/path/folderSecurityHealthAnalyticsSettingsEffectiveCustomModule";
            const expectedParameters = {
                folder: "folderValue",
            ...
            it('folderSecurityHealthAnalyticsSettingsEffectiveCustomModulePath', () => {
                const result = client.folderSecurityHealthAnalyticsSettingsEffectiveCustomModulePath("folderValue", "effectiveCustomModuleValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.folderSecurityHealthAnalyticsSettingsEffectiveCustomModulePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchFolderFromFolderSecurityHealthAnalyticsSettingsEffectiveCustomModuleName', () => {
                const result = client.matchFolderFromFolderSecurityHealthAnalyticsSettingsEffectiveCustomModuleName(fakePath);
                assert.strictEqual(result, "folderValue");
                assert((client.pathTemplates.folderSecurityHealthAnalyticsSettingsEffectiveCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchEffectiveCustomModuleFromFolderSecurityHealthAnalyticsSettingsEffectiveCustomModuleName', () => {
                const result = client.matchEffectiveCustomModuleFromFolderSecurityHealthAnalyticsSettingsEffectiveCustomModuleName(fakePath);
        ...
        describe('folderSourceFindingExternalSystems', async () => {
            const fakePath = "/rendered/path/folderSourceFindingExternalSystems";
            const expectedParameters = {
                folder: "folderValue",
                source: "sourceValue",
            ...
            await client.initialize();
            client.pathTemplates.folderSourceFindingExternalSystemsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.folderSourceFindingExternalSystemsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('folderSourceFindingExternalSystemsPath', () => {
                const result = client.folderSourceFindingExternalSystemsPath("folderValue", "sourceValue", "findingValue", "externalsystemValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.folderSourceFindingExternalSystemsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchFolderFromFolderSourceFindingExternalSystemsName', () => {
                const result = client.matchFolderFromFolderSourceFindingExternalSystemsName(fakePath);
                assert.strictEqual(result, "folderValue");
                assert((client.pathTemplates.folderSourceFindingExternalSystemsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchSourceFromFolderSourceFindingExternalSystemsName', () => {
                const result = client.matchSourceFromFolderSourceFindingExternalSystemsName(fakePath);
                assert.strictEqual(result, "sourceValue");
                assert((client.pathTemplates.folderSourceFindingExternalSystemsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchFindingFromFolderSourceFindingExternalSystemsName', () => {
                const result = client.matchFindingFromFolderSourceFindingExternalSystemsName(fakePath);
                assert.strictEqual(result, "findingValue");
                assert((client.pathTemplates.folderSourceFindingExternalSystemsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchExternalsystemFromFolderSourceFindingExternalSystemsName', () => {
                const result = client.matchExternalsystemFromFolderSourceFindingExternalSystemsName(fakePath);
        ...
        describe('organizationAssets', async () => {
            const fakePath = "/rendered/path/organizationAssets";
            const expectedParameters = {
                organization: "organizationValue",
                asset: "assetValue",
            };
            ...
            await client.initialize();
            client.pathTemplates.organizationAssetsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.organizationAssetsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('organizationAssetsPath', () => {
                const result = client.organizationAssetsPath("organizationValue", "assetValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationAssetsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationAssetsName', () => {
                const result = client.matchOrganizationFromOrganizationAssetsName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationAssetsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchAssetFromOrganizationAssetsName', () => {
                const result = client.matchAssetFromOrganizationAssetsName(fakePath);
                assert.strictEqual(result, "assetValue");
                assert((client.pathTemplates.organizationAssetsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('organizationBigQueryExports', async () => {
            const fakePath = "/rendered/path/organizationBigQueryExports";
            const expectedParameters = {
                organization: "organizationValue",
                export: "exportValue",
            };
            ...
            await client.initialize();
            client.pathTemplates.organizationBigQueryExportsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.organizationBigQueryExportsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('organizationBigQueryExportsPath', () => {
                const result = client.organizationBigQueryExportsPath("organizationValue", "exportValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationBigQueryExportsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationBigQueryExportsName', () => {
                const result = client.matchOrganizationFromOrganizationBigQueryExportsName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationBigQueryExportsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchExportFromOrganizationBigQueryExportsName', () => {
                const result = client.matchExportFromOrganizationBigQueryExportsName(fakePath);
                assert.strictEqual(result, "exportValue");
                assert((client.pathTemplates.organizationBigQueryExportsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('organizationEventThreatDetectionSettings', async () => {
            const fakePath = "/rendered/path/organizationEventThreatDetectionSettings";
            const expectedParameters = {
                organization: "organizationValue",
            };
            const client = new securitycenterModule.v1.SecurityCenterClient({
            ...
            it('organizationEventThreatDetectionSettingsPath', () => {
                const result = client.organizationEventThreatDetectionSettingsPath("organizationValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationEventThreatDetectionSettingsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationEventThreatDetectionSettingsName', () => {
                const result = client.matchOrganizationFromOrganizationEventThreatDetectionSettingsName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationEventThreatDetectionSettingsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
        ...
        describe('organizationEventThreatDetectionSettingsModule', async () => {
            ...
            it('organizationEventThreatDetectionSettingsModulePath', () => {
                const result = client.organizationEventThreatDetectionSettingsModulePath("organizationValue", "moduleValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationEventThreatDetectionSettingsModulePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationEventThreatDetectionSettingsModuleName', () => {
                const result = client.matchOrganizationFromOrganizationEventThreatDetectionSettingsModuleName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationEventThreatDetectionSettingsModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchModuleFromOrganizationEventThreatDetectionSettingsModuleName', () => {
                const result = client.matchModuleFromOrganizationEventThreatDetectionSettingsModuleName(fakePath);
                assert.strictEqual(result, "moduleValue");
                assert((client.pathTemplates.organizationEventThreatDetectionSettingsModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('organizationLocationMuteConfigs', async () => {
            const fakePath = "/rendered/path/organizationLocationMuteConfigs";
            const expectedParameters = {
                organization: "organizationValue",
                location: "locationValue",
                mute_config: "muteConfigValue",
            ...
            await client.initialize();
            client.pathTemplates.organizationLocationMuteConfigsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.organizationLocationMuteConfigsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('organizationLocationMuteConfigsPath', () => {
                const result = client.organizationLocationMuteConfigsPath("organizationValue", "locationValue", "muteConfigValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationLocationMuteConfigsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationLocationMuteConfigsName', () => {
                const result = client.matchOrganizationFromOrganizationLocationMuteConfigsName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationLocationMuteConfigsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromOrganizationLocationMuteConfigsName', () => {
                const result = client.matchLocationFromOrganizationLocationMuteConfigsName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.organizationLocationMuteConfigsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchMuteConfigFromOrganizationLocationMuteConfigsName', () => {
                const result = client.matchMuteConfigFromOrganizationLocationMuteConfigsName(fakePath);
                assert.strictEqual(result, "muteConfigValue");
                assert((client.pathTemplates.organizationLocationMuteConfigsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('organizationMuteConfigs', async () => {
            const fakePath = "/rendered/path/organizationMuteConfigs";
            const expectedParameters = {
                organization: "organizationValue",
                mute_config: "muteConfigValue",
            };
            ...
            await client.initialize();
            client.pathTemplates.organizationMuteConfigsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.organizationMuteConfigsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('organizationMuteConfigsPath', () => {
                const result = client.organizationMuteConfigsPath("organizationValue", "muteConfigValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationMuteConfigsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationMuteConfigsName', () => {
                const result = client.matchOrganizationFromOrganizationMuteConfigsName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationMuteConfigsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchMuteConfigFromOrganizationMuteConfigsName', () => {
                const result = client.matchMuteConfigFromOrganizationMuteConfigsName(fakePath);
                assert.strictEqual(result, "muteConfigValue");
                assert((client.pathTemplates.organizationMuteConfigsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('organizationNotificationConfigs', async () => {
            const fakePath = "/rendered/path/organizationNotificationConfigs";
            const expectedParameters = {
                organization: "organizationValue",
                notification_config: "notificationConfigValue",
            };
            ...
            await client.initialize();
            client.pathTemplates.organizationNotificationConfigsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.organizationNotificationConfigsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('organizationNotificationConfigsPath', () => {
                const result = client.organizationNotificationConfigsPath("organizationValue", "notificationConfigValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationNotificationConfigsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationNotificationConfigsName', () => {
                const result = client.matchOrganizationFromOrganizationNotificationConfigsName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationNotificationConfigsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchNotificationConfigFromOrganizationNotificationConfigsName', () => {
                const result = client.matchNotificationConfigFromOrganizationNotificationConfigsName(fakePath);
                assert.strictEqual(result, "notificationConfigValue");
                assert((client.pathTemplates.organizationNotificationConfigsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('organizationSecurityHealthAnalyticsSettings', async () => {
            const fakePath = "/rendered/path/organizationSecurityHealthAnalyticsSettings";
            const expectedParameters = {
                organization: "organizationValue",
            };
            const client = new securitycenterModule.v1.SecurityCenterClient({
            ...
            it('organizationSecurityHealthAnalyticsSettingsPath', () => {
                const result = client.organizationSecurityHealthAnalyticsSettingsPath("organizationValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationSecurityHealthAnalyticsSettingsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationSecurityHealthAnalyticsSettingsName', () => {
                const result = client.matchOrganizationFromOrganizationSecurityHealthAnalyticsSettingsName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationSecurityHealthAnalyticsSettingsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });

        describe('organizationSecurityHealthAnalyticsSettingsCustomModule', async () => {
            const fakePath = "/rendered/path/organizationSecurityHealthAnalyticsSettingsCustomModule";
            const expectedParameters = {
                organization: "organizationValue",
                custom_module: "customModuleValue",
            };
            ...
            it('organizationSecurityHealthAnalyticsSettingsCustomModulePath', () => {
                const result = client.organizationSecurityHealthAnalyticsSettingsCustomModulePath("organizationValue", "customModuleValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationSecurityHealthAnalyticsSettingsCustomModulePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationSecurityHealthAnalyticsSettingsCustomModuleName', () => {
                const result = client.matchOrganizationFromOrganizationSecurityHealthAnalyticsSettingsCustomModuleName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationSecurityHealthAnalyticsSettingsCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchCustomModuleFromOrganizationSecurityHealthAnalyticsSettingsCustomModuleName', () => {
                const result = client.matchCustomModuleFromOrganizationSecurityHealthAnalyticsSettingsCustomModuleName(fakePath);
                assert.strictEqual(result, "customModuleValue");
                assert((client.pathTemplates.organizationSecurityHealthAnalyticsSettingsCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('organizationSecurityHealthAnalyticsSettingsEffectiveCustomModule', async () => {
            const fakePath = "/rendered/path/organizationSecurityHealthAnalyticsSettingsEffectiveCustomModule";
            const expectedParameters = {
                organization: "organizationValue",
                effective_custom_module: "effectiveCustomModuleValue",
            };
            ...
            it('organizationSecurityHealthAnalyticsSettingsEffectiveCustomModulePath', () => {
                const result = client.organizationSecurityHealthAnalyticsSettingsEffectiveCustomModulePath("organizationValue", "effectiveCustomModuleValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationSecurityHealthAnalyticsSettingsEffectiveCustomModulePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationSecurityHealthAnalyticsSettingsEffectiveCustomModuleName', () => {
                const result = client.matchOrganizationFromOrganizationSecurityHealthAnalyticsSettingsEffectiveCustomModuleName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationSecurityHealthAnalyticsSettingsEffectiveCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchEffectiveCustomModuleFromOrganizationSecurityHealthAnalyticsSettingsEffectiveCustomModuleName', () => {
                const result = client.matchEffectiveCustomModuleFromOrganizationSecurityHealthAnalyticsSettingsEffectiveCustomModuleName(fakePath);
                assert.strictEqual(result, "effectiveCustomModuleValue");
                assert((client.pathTemplates.organizationSecurityHealthAnalyticsSettingsEffectiveCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('organizationSourceFindingExternalSystems', async () => {
            const fakePath = "/rendered/path/organizationSourceFindingExternalSystems";
            const expectedParameters = {
                organization: "organizationValue",
                source: "sourceValue",
                finding: "findingValue",
            ...
            await client.initialize();
            client.pathTemplates.organizationSourceFindingExternalSystemsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.organizationSourceFindingExternalSystemsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('organizationSourceFindingExternalSystemsPath', () => {
                const result = client.organizationSourceFindingExternalSystemsPath("organizationValue", "sourceValue", "findingValue", "externalsystemValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationSourceFindingExternalSystemsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationSourceFindingExternalSystemsName', () => {
                const result = client.matchOrganizationFromOrganizationSourceFindingExternalSystemsName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationSourceFindingExternalSystemsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchSourceFromOrganizationSourceFindingExternalSystemsName', () => {
                const result = client.matchSourceFromOrganizationSourceFindingExternalSystemsName(fakePath);
                assert.strictEqual(result, "sourceValue");
                assert((client.pathTemplates.organizationSourceFindingExternalSystemsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchFindingFromOrganizationSourceFindingExternalSystemsName', () => {
                const result = client.matchFindingFromOrganizationSourceFindingExternalSystemsName(fakePath);
                assert.strictEqual(result, "findingValue");
                assert((client.pathTemplates.organizationSourceFindingExternalSystemsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchExternalsystemFromOrganizationSourceFindingExternalSystemsName', () => {
                const result = client.matchExternalsystemFromOrganizationSourceFindingExternalSystemsName(fakePath);
                assert.strictEqual(result, "externalsystemValue");
                assert((client.pathTemplates.organizationSourceFindingExternalSystemsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('projectAssets', async () => {
            const fakePath = "/rendered/path/projectAssets";
            const expectedParameters = {
                project: "projectValue",
                asset: "assetValue",
            };
            ...
            await client.initialize();
            client.pathTemplates.projectAssetsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.projectAssetsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('projectAssetsPath', () => {
                const result = client.projectAssetsPath("projectValue", "assetValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectAssetsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectAssetsName', () => {
                const result = client.matchProjectFromProjectAssetsName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectAssetsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchAssetFromProjectAssetsName', () => {
                const result = client.matchAssetFromProjectAssetsName(fakePath);
                assert.strictEqual(result, "assetValue");
                assert((client.pathTemplates.projectAssetsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('projectBigQueryExports', async () => {
            const fakePath = "/rendered/path/projectBigQueryExports";
            const expectedParameters = {
                project: "projectValue",
                export: "exportValue",
            };
            ...
            await client.initialize();
            client.pathTemplates.projectBigQueryExportsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.projectBigQueryExportsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('projectBigQueryExportsPath', () => {
                const result = client.projectBigQueryExportsPath("projectValue", "exportValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectBigQueryExportsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectBigQueryExportsName', () => {
                const result = client.matchProjectFromProjectBigQueryExportsName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectBigQueryExportsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchExportFromProjectBigQueryExportsName', () => {
                const result = client.matchExportFromProjectBigQueryExportsName(fakePath);
                assert.strictEqual(result, "exportValue");
                assert((client.pathTemplates.projectBigQueryExportsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('projectEventThreatDetectionSettingsModule', async () => {
            const fakePath = "/rendered/path/projectEventThreatDetectionSettingsModule";
            const expectedParameters = {
                project: "projectValue",
                module: "moduleValue",
            };
            ...
            it('projectEventThreatDetectionSettingsModulePath', () => {
                const result = client.projectEventThreatDetectionSettingsModulePath("projectValue", "moduleValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectEventThreatDetectionSettingsModulePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectEventThreatDetectionSettingsModuleName', () => {
                const result = client.matchProjectFromProjectEventThreatDetectionSettingsModuleName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectEventThreatDetectionSettingsModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchModuleFromProjectEventThreatDetectionSettingsModuleName', () => {
                const result = client.matchModuleFromProjectEventThreatDetectionSettingsModuleName(fakePath);
                assert.strictEqual(result, "moduleValue");
                assert((client.pathTemplates.projectEventThreatDetectionSettingsModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('projectLocationMuteConfigs', async () => {
            const fakePath = "/rendered/path/projectLocationMuteConfigs";
            const expectedParameters = {
                project: "projectValue",
                location: "locationValue",
                mute_config: "muteConfigValue",
            ...
            await client.initialize();
            client.pathTemplates.projectLocationMuteConfigsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.projectLocationMuteConfigsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('projectLocationMuteConfigsPath', () => {
                const result = client.projectLocationMuteConfigsPath("projectValue", "locationValue", "muteConfigValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectLocationMuteConfigsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectLocationMuteConfigsName', () => {
                const result = client.matchProjectFromProjectLocationMuteConfigsName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectLocationMuteConfigsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromProjectLocationMuteConfigsName', () => {
                const result = client.matchLocationFromProjectLocationMuteConfigsName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.projectLocationMuteConfigsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchMuteConfigFromProjectLocationMuteConfigsName', () => {
                const result = client.matchMuteConfigFromProjectLocationMuteConfigsName(fakePath);
                assert.strictEqual(result, "muteConfigValue");
                assert((client.pathTemplates.projectLocationMuteConfigsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('projectMuteConfigs', async () => {
            const fakePath = "/rendered/path/projectMuteConfigs";
            const expectedParameters = {
                project: "projectValue",
                mute_config: "muteConfigValue",
            };
            ...
            await client.initialize();
            client.pathTemplates.projectMuteConfigsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.projectMuteConfigsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('projectMuteConfigsPath', () => {
                const result = client.projectMuteConfigsPath("projectValue", "muteConfigValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectMuteConfigsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectMuteConfigsName', () => {
                const result = client.matchProjectFromProjectMuteConfigsName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectMuteConfigsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchMuteConfigFromProjectMuteConfigsName', () => {
                const result = client.matchMuteConfigFromProjectMuteConfigsName(fakePath);
                assert.strictEqual(result, "muteConfigValue");
                assert((client.pathTemplates.projectMuteConfigsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('projectNotificationConfigs', async () => {
            const fakePath = "/rendered/path/projectNotificationConfigs";
            const expectedParameters = {
                project: "projectValue",
                notification_config: "notificationConfigValue",
            };
            ...
            await client.initialize();
            client.pathTemplates.projectNotificationConfigsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.projectNotificationConfigsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('projectNotificationConfigsPath', () => {
                const result = client.projectNotificationConfigsPath("projectValue", "notificationConfigValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectNotificationConfigsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectNotificationConfigsName', () => {
                const result = client.matchProjectFromProjectNotificationConfigsName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectNotificationConfigsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchNotificationConfigFromProjectNotificationConfigsName', () => {
                const result = client.matchNotificationConfigFromProjectNotificationConfigsName(fakePath);
                assert.strictEqual(result, "notificationConfigValue");
                assert((client.pathTemplates.projectNotificationConfigsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('projectSecurityHealthAnalyticsSettingsCustomModule', async () => {
            const fakePath = "/rendered/path/projectSecurityHealthAnalyticsSettingsCustomModule";
            const expectedParameters = {
                project: "projectValue",
                custom_module: "customModuleValue",
            };
            ...
            it('projectSecurityHealthAnalyticsSettingsCustomModulePath', () => {
                const result = client.projectSecurityHealthAnalyticsSettingsCustomModulePath("projectValue", "customModuleValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectSecurityHealthAnalyticsSettingsCustomModulePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectSecurityHealthAnalyticsSettingsCustomModuleName', () => {
                const result = client.matchProjectFromProjectSecurityHealthAnalyticsSettingsCustomModuleName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectSecurityHealthAnalyticsSettingsCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchCustomModuleFromProjectSecurityHealthAnalyticsSettingsCustomModuleName', () => {
                const result = client.matchCustomModuleFromProjectSecurityHealthAnalyticsSettingsCustomModuleName(fakePath);
                assert.strictEqual(result, "customModuleValue");
                assert((client.pathTemplates.projectSecurityHealthAnalyticsSettingsCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('projectSecurityHealthAnalyticsSettingsEffectiveCustomModule', async () => {
            ...
            it('projectSecurityHealthAnalyticsSettingsEffectiveCustomModulePath', () => {
                const result = client.projectSecurityHealthAnalyticsSettingsEffectiveCustomModulePath("projectValue", "effectiveCustomModuleValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectSecurityHealthAnalyticsSettingsEffectiveCustomModulePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectSecurityHealthAnalyticsSettingsEffectiveCustomModuleName', () => {
                const result = client.matchProjectFromProjectSecurityHealthAnalyticsSettingsEffectiveCustomModuleName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectSecurityHealthAnalyticsSettingsEffectiveCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchEffectiveCustomModuleFromProjectSecurityHealthAnalyticsSettingsEffectiveCustomModuleName', () => {
                const result = client.matchEffectiveCustomModuleFromProjectSecurityHealthAnalyticsSettingsEffectiveCustomModuleName(fakePath);
                assert.strictEqual(result, "effectiveCustomModuleValue");
                assert((client.pathTemplates.projectSecurityHealthAnalyticsSettingsEffectiveCustomModulePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('projectSourceFindingExternalSystems', async () => {
            const fakePath = "/rendered/path/projectSourceFindingExternalSystems";
            const expectedParameters = {
                project: "projectValue",
                source: "sourceValue",
                finding: "findingValue",
            ...
            await client.initialize();
            client.pathTemplates.projectSourceFindingExternalSystemsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.projectSourceFindingExternalSystemsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('projectSourceFindingExternalSystemsPath', () => {
                const result = client.projectSourceFindingExternalSystemsPath("projectValue", "sourceValue", "findingValue", "externalsystemValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectSourceFindingExternalSystemsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectSourceFindingExternalSystemsName', () => {
                const result = client.matchProjectFromProjectSourceFindingExternalSystemsName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectSourceFindingExternalSystemsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchSourceFromProjectSourceFindingExternalSystemsName', () => {
                const result = client.matchSourceFromProjectSourceFindingExternalSystemsName(fakePath);
                assert.strictEqual(result, "sourceValue");
                assert((client.pathTemplates.projectSourceFindingExternalSystemsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchFindingFromProjectSourceFindingExternalSystemsName', () => {
                const result = client.matchFindingFromProjectSourceFindingExternalSystemsName(fakePath);
                assert.strictEqual(result, "findingValue");
                assert((client.pathTemplates.projectSourceFindingExternalSystemsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchExternalsystemFromProjectSourceFindingExternalSystemsName', () => {
                const result = client.matchExternalsystemFromProjectSourceFindingExternalSystemsName(fakePath);
                assert.strictEqual(result, "externalsystemValue");
                assert((client.pathTemplates.projectSourceFindingExternalSystemsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
