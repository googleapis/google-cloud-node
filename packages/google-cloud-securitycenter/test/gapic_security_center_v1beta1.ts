    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new securitycenterModule.v1beta1.SecurityCenterClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'securitycenter.example.com');
          if (saved) {
      ...
      const promise = new Promise((resolve, reject) => {
        client.groupAssets(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.securitycenter.v1beta1.IGroupResult[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listFindings(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.securitycenter.v1beta1.IFinding[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listSources(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.securitycenter.v1beta1.ISource[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
