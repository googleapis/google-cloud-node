  ...
  describe('Path templates', () => {
    ...
    describe('folderLocationBigQueryExports', async () => {
      ...
      it('folderLocationBigQueryExportsPath', () => {
        const result = client.folderLocationBigQueryExportsPath(
          'folderValue',
          'locationValue',
          'exportValue',
        );
        ...
        assert(
          (
            client.pathTemplates.folderLocationBigQueryExportsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchFolderFromFolderLocationBigQueryExportsName', () => {
        const result =
          client.matchFolderFromFolderLocationBigQueryExportsName(fakePath);
        assert.strictEqual(result, 'folderValue');
        assert(
          (
            client.pathTemplates.folderLocationBigQueryExportsPathTemplate
      ...
      it('matchLocationFromFolderLocationBigQueryExportsName', () => {
        const result =
          client.matchLocationFromFolderLocationBigQueryExportsName(fakePath);
      ...
      it('matchExportFromFolderLocationBigQueryExportsName', () => {
        const result =
          client.matchExportFromFolderLocationBigQueryExportsName(fakePath);
    ...
    describe('folderLocationNotificationConfigs', async () => {
      ...
      it('folderLocationNotificationConfigsPath', () => {
        const result = client.folderLocationNotificationConfigsPath(
          'folderValue',
          'locationValue',
      ...
      it('matchFolderFromFolderLocationNotificationConfigsName', () => {
        const result =
          client.matchFolderFromFolderLocationNotificationConfigsName(fakePath);
        assert.strictEqual(result, 'folderValue');
        assert(
          (
            client.pathTemplates.folderLocationNotificationConfigsPathTemplate
      ...
      it('matchLocationFromFolderLocationNotificationConfigsName', () => {
        const result =
          client.matchLocationFromFolderLocationNotificationConfigsName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchNotificationConfigFromFolderLocationNotificationConfigsName', () => {
        const result =
          client.matchNotificationConfigFromFolderLocationNotificationConfigsName(
            fakePath,
          );
    ...
    describe('folderSourceLocationFindings', async () => {
      ...
      it('folderSourceLocationFindingsPath', () => {
        const result = client.folderSourceLocationFindingsPath(
          'folderValue',
          'sourceValue',
          'locationValue',
          'findingValue',
        ...
        assert(
          (
            client.pathTemplates.folderSourceLocationFindingsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchFolderFromFolderSourceLocationFindingsName', () => {
        const result =
          client.matchFolderFromFolderSourceLocationFindingsName(fakePath);
        assert.strictEqual(result, 'folderValue');
        assert(
          (
            client.pathTemplates.folderSourceLocationFindingsPathTemplate
      ...
      it('matchSourceFromFolderSourceLocationFindingsName', () => {
        const result =
          client.matchSourceFromFolderSourceLocationFindingsName(fakePath);
        assert.strictEqual(result, 'sourceValue');
        assert(
          (
            client.pathTemplates.folderSourceLocationFindingsPathTemplate
      ...
      it('matchLocationFromFolderSourceLocationFindingsName', () => {
        const result =
          client.matchLocationFromFolderSourceLocationFindingsName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.folderSourceLocationFindingsPathTemplate
      ...
      it('matchFindingFromFolderSourceLocationFindingsName', () => {
        const result =
          client.matchFindingFromFolderSourceLocationFindingsName(fakePath);
        assert.strictEqual(result, 'findingValue');
        assert(
          (
            client.pathTemplates.folderSourceLocationFindingsPathTemplate
    ...
    describe('organizationLocationBigQueryExports', async () => {
      ...
      it('organizationLocationBigQueryExportsPath', () => {
        const result = client.organizationLocationBigQueryExportsPath(
          'organizationValue',
          'locationValue',
          'exportValue',
        );
      ...
      it('matchOrganizationFromOrganizationLocationBigQueryExportsName', () => {
        const result =
          client.matchOrganizationFromOrganizationLocationBigQueryExportsName(
            fakePath,
          );
        assert.strictEqual(result, 'organizationValue');
        assert(
      ...
      it('matchLocationFromOrganizationLocationBigQueryExportsName', () => {
        const result =
          client.matchLocationFromOrganizationLocationBigQueryExportsName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchExportFromOrganizationLocationBigQueryExportsName', () => {
        const result =
          client.matchExportFromOrganizationLocationBigQueryExportsName(
            fakePath,
          );
        assert.strictEqual(result, 'exportValue');
        assert(
    ...
    describe('organizationLocationNotificationConfigs', async () => {
      ...
      it('organizationLocationNotificationConfigsPath', () => {
        const result = client.organizationLocationNotificationConfigsPath(
          'organizationValue',
          'locationValue',
          'notificationConfigValue',
        );
      ...
      it('matchOrganizationFromOrganizationLocationNotificationConfigsName', () => {
        const result =
          client.matchOrganizationFromOrganizationLocationNotificationConfigsName(
            fakePath,
          );
        assert.strictEqual(result, 'organizationValue');
        assert(
      ...
      it('matchLocationFromOrganizationLocationNotificationConfigsName', () => {
        const result =
          client.matchLocationFromOrganizationLocationNotificationConfigsName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchNotificationConfigFromOrganizationLocationNotificationConfigsName', () => {
        const result =
          client.matchNotificationConfigFromOrganizationLocationNotificationConfigsName(
            fakePath,
          );
        assert.strictEqual(result, 'notificationConfigValue');
        assert(
    ...
    describe('organizationLocationResourceValueConfigs', async () => {
      const fakePath =
        '/rendered/path/organizationLocationResourceValueConfigs';
      const expectedParameters = {
        organization: 'organizationValue',
        location: 'locationValue',
      ...
      it('matchOrganizationFromOrganizationLocationResourceValueConfigsName', () => {
        const result =
          client.matchOrganizationFromOrganizationLocationResourceValueConfigsName(
            fakePath,
          );
        assert.strictEqual(result, 'organizationValue');
        assert(
      ...
      it('matchLocationFromOrganizationLocationResourceValueConfigsName', () => {
        const result =
          client.matchLocationFromOrganizationLocationResourceValueConfigsName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchResourceValueConfigFromOrganizationLocationResourceValueConfigsName', () => {
        const result =
          client.matchResourceValueConfigFromOrganizationLocationResourceValueConfigsName(
            fakePath,
          );
    ...
    describe('organizationLocationSimluationValuedResources', async () => {
      const fakePath =
        '/rendered/path/organizationLocationSimluationValuedResources';
      const expectedParameters = {
        organization: 'organizationValue',
        location: 'locationValue',
      ...
      it('organizationLocationSimluationValuedResourcesPath', () => {
        const result = client.organizationLocationSimluationValuedResourcesPath(
          'organizationValue',
          'locationValue',
          'simluationValue',
          'valuedResourceValue',
      ...
      it('matchOrganizationFromOrganizationLocationSimluationValuedResourcesName', () => {
        const result =
          client.matchOrganizationFromOrganizationLocationSimluationValuedResourcesName(
            fakePath,
          );
        assert.strictEqual(result, 'organizationValue');
        assert(
      ...
      it('matchLocationFromOrganizationLocationSimluationValuedResourcesName', () => {
        const result =
          client.matchLocationFromOrganizationLocationSimluationValuedResourcesName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchSimluationFromOrganizationLocationSimluationValuedResourcesName', () => {
        const result =
          client.matchSimluationFromOrganizationLocationSimluationValuedResourcesName(
            fakePath,
          );
      ...
      it('matchValuedResourceFromOrganizationLocationSimluationValuedResourcesName', () => {
        const result =
          client.matchValuedResourceFromOrganizationLocationSimluationValuedResourcesName(
            fakePath,
          );
    ...
    describe('organizationLocationSimulationValuedResourceAttackPaths', async () => {
      const fakePath =
        '/rendered/path/organizationLocationSimulationValuedResourceAttackPaths';
      const expectedParameters = {
        organization: 'organizationValue',
        location: 'locationValue',
      ...
      it('organizationLocationSimulationValuedResourceAttackPathsPath', () => {
        const result =
          client.organizationLocationSimulationValuedResourceAttackPathsPath(
            'organizationValue',
            'locationValue',
            'simulationValue',
            'valuedResourceValue',
      ...
      it('matchOrganizationFromOrganizationLocationSimulationValuedResourceAttackPathsName', () => {
        const result =
          client.matchOrganizationFromOrganizationLocationSimulationValuedResourceAttackPathsName(
            fakePath,
          );
        assert.strictEqual(result, 'organizationValue');
        assert(
      ...
      it('matchLocationFromOrganizationLocationSimulationValuedResourceAttackPathsName', () => {
        const result =
          client.matchLocationFromOrganizationLocationSimulationValuedResourceAttackPathsName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchSimulationFromOrganizationLocationSimulationValuedResourceAttackPathsName', () => {
        const result =
          client.matchSimulationFromOrganizationLocationSimulationValuedResourceAttackPathsName(
            fakePath,
          );
      ...
      it('matchValuedResourceFromOrganizationLocationSimulationValuedResourceAttackPathsName', () => {
        const result =
          client.matchValuedResourceFromOrganizationLocationSimulationValuedResourceAttackPathsName(
            fakePath,
          );
        assert.strictEqual(result, 'valuedResourceValue');
        assert(
      ...
      it('matchAttackPathFromOrganizationLocationSimulationValuedResourceAttackPathsName', () => {
        const result =
          client.matchAttackPathFromOrganizationLocationSimulationValuedResourceAttackPathsName(
            fakePath,
          );
    ...
    describe('organizationLocationSimulations', async () => {
      ...
      it('organizationLocationSimulationsPath', () => {
        const result = client.organizationLocationSimulationsPath(
          'organizationValue',
          'locationValue',
          'simluationValue',
        );
        ...
        assert(
          (
            client.pathTemplates.organizationLocationSimulationsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchOrganizationFromOrganizationLocationSimulationsName', () => {
        const result =
          client.matchOrganizationFromOrganizationLocationSimulationsName(
            fakePath,
          );
        assert.strictEqual(result, 'organizationValue');
        assert(
      ...
      it('matchLocationFromOrganizationLocationSimulationsName', () => {
        const result =
          client.matchLocationFromOrganizationLocationSimulationsName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.organizationLocationSimulationsPathTemplate
      ...
      it('matchSimluationFromOrganizationLocationSimulationsName', () => {
        const result =
          client.matchSimluationFromOrganizationLocationSimulationsName(
            fakePath,
          );
        assert.strictEqual(result, 'simluationValue');
        assert(
    ...
    describe('organizationResourceValueConfigs', async () => {
      ...
      it('organizationResourceValueConfigsPath', () => {
        const result = client.organizationResourceValueConfigsPath(
          'organizationValue',
          'resourceValueConfigValue',
        );
        assert.strictEqual(result, fakePath);
      ...
      it('matchOrganizationFromOrganizationResourceValueConfigsName', () => {
        const result =
          client.matchOrganizationFromOrganizationResourceValueConfigsName(
            fakePath,
          );
        assert.strictEqual(result, 'organizationValue');
        assert(
      ...
      it('matchResourceValueConfigFromOrganizationResourceValueConfigsName', () => {
        const result =
          client.matchResourceValueConfigFromOrganizationResourceValueConfigsName(
            fakePath,
          );
        assert.strictEqual(result, 'resourceValueConfigValue');
        assert(
    ...
    describe('organizationSimulationValuedResourceAttackPaths', async () => {
      const fakePath =
        '/rendered/path/organizationSimulationValuedResourceAttackPaths';
      const expectedParameters = {
        organization: 'organizationValue',
        simulation: 'simulationValue',
        valued_resource: 'valuedResourceValue',
      ...
      it('organizationSimulationValuedResourceAttackPathsPath', () => {
        const result =
          client.organizationSimulationValuedResourceAttackPathsPath(
            'organizationValue',
            'simulationValue',
            'valuedResourceValue',
            'attackPathValue',
      ...
      it('matchOrganizationFromOrganizationSimulationValuedResourceAttackPathsName', () => {
        const result =
          client.matchOrganizationFromOrganizationSimulationValuedResourceAttackPathsName(
            fakePath,
          );
        assert.strictEqual(result, 'organizationValue');
        assert(
      ...
      it('matchSimulationFromOrganizationSimulationValuedResourceAttackPathsName', () => {
        const result =
          client.matchSimulationFromOrganizationSimulationValuedResourceAttackPathsName(
            fakePath,
          );
        assert.strictEqual(result, 'simulationValue');
        assert(
      ...
      it('matchValuedResourceFromOrganizationSimulationValuedResourceAttackPathsName', () => {
        const result =
          client.matchValuedResourceFromOrganizationSimulationValuedResourceAttackPathsName(
            fakePath,
          );
        assert.strictEqual(result, 'valuedResourceValue');
        assert(
      ...
      it('matchAttackPathFromOrganizationSimulationValuedResourceAttackPathsName', () => {
        const result =
          client.matchAttackPathFromOrganizationSimulationValuedResourceAttackPathsName(
            fakePath,
          );
        assert.strictEqual(result, 'attackPathValue');
        assert(
    ...
    describe('organizationSimulationValuedResources', async () => {
      ...
      it('organizationSimulationValuedResourcesPath', () => {
        const result = client.organizationSimulationValuedResourcesPath(
          'organizationValue',
          'simulationValue',
          'valuedResourceValue',
        );
      ...
      it('matchOrganizationFromOrganizationSimulationValuedResourcesName', () => {
        const result =
          client.matchOrganizationFromOrganizationSimulationValuedResourcesName(
            fakePath,
          );
        assert.strictEqual(result, 'organizationValue');
        assert(
      ...
      it('matchSimulationFromOrganizationSimulationValuedResourcesName', () => {
        const result =
          client.matchSimulationFromOrganizationSimulationValuedResourcesName(
            fakePath,
          );
        assert.strictEqual(result, 'simulationValue');
        assert(
      ...
      it('matchValuedResourceFromOrganizationSimulationValuedResourcesName', () => {
        const result =
          client.matchValuedResourceFromOrganizationSimulationValuedResourcesName(
            fakePath,
          );
        assert.strictEqual(result, 'valuedResourceValue');
        assert(
    ...
    describe('organizationSimulations', async () => {
      ...
      await client.initialize();
      client.pathTemplates.organizationSimulationsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.organizationSimulationsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('organizationSimulationsPath', () => {
        const result = client.organizationSimulationsPath(
          'organizationValue',
          'simulationValue',
        );
        assert.strictEqual(result, fakePath);
      ...
      it('matchOrganizationFromOrganizationSimulationsName', () => {
        const result =
          client.matchOrganizationFromOrganizationSimulationsName(fakePath);
        assert.strictEqual(result, 'organizationValue');
        assert(
          (
            client.pathTemplates.organizationSimulationsPathTemplate
      ...
      it('matchSimulationFromOrganizationSimulationsName', () => {
        const result =
          client.matchSimulationFromOrganizationSimulationsName(fakePath);
        assert.strictEqual(result, 'simulationValue');
        assert(
          (
            client.pathTemplates.organizationSimulationsPathTemplate
    ...
    describe('organizationSourceLocationFindings', async () => {
      ...
      it('organizationSourceLocationFindingsPath', () => {
        const result = client.organizationSourceLocationFindingsPath(
          'organizationValue',
          'sourceValue',
          'locationValue',
          'findingValue',
        ...
        assert(
          (
            client.pathTemplates.organizationSourceLocationFindingsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchOrganizationFromOrganizationSourceLocationFindingsName', () => {
        const result =
          client.matchOrganizationFromOrganizationSourceLocationFindingsName(
            fakePath,
          );
        assert.strictEqual(result, 'organizationValue');
        assert(
      ...
      it('matchSourceFromOrganizationSourceLocationFindingsName', () => {
        const result =
          client.matchSourceFromOrganizationSourceLocationFindingsName(
            fakePath,
          );
        assert.strictEqual(result, 'sourceValue');
        assert(
      ...
      it('matchLocationFromOrganizationSourceLocationFindingsName', () => {
        const result =
          client.matchLocationFromOrganizationSourceLocationFindingsName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchFindingFromOrganizationSourceLocationFindingsName', () => {
        const result =
          client.matchFindingFromOrganizationSourceLocationFindingsName(
            fakePath,
          );
        assert.strictEqual(result, 'findingValue');
        assert(
    ...
    describe('projectLocationBigQueryExports', async () => {
      ...
      it('projectLocationBigQueryExportsPath', () => {
        const result = client.projectLocationBigQueryExportsPath(
          'projectValue',
          'locationValue',
          'exportValue',
        );
      ...
      it('matchProjectFromProjectLocationBigQueryExportsName', () => {
        const result =
          client.matchProjectFromProjectLocationBigQueryExportsName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.projectLocationBigQueryExportsPathTemplate
      ...
      it('matchLocationFromProjectLocationBigQueryExportsName', () => {
        const result =
          client.matchLocationFromProjectLocationBigQueryExportsName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.projectLocationBigQueryExportsPathTemplate
      ...
      it('matchExportFromProjectLocationBigQueryExportsName', () => {
        const result =
          client.matchExportFromProjectLocationBigQueryExportsName(fakePath);
        assert.strictEqual(result, 'exportValue');
        assert(
          (
            client.pathTemplates.projectLocationBigQueryExportsPathTemplate
    ...
    describe('projectLocationNotificationConfigs', async () => {
      ...
      it('projectLocationNotificationConfigsPath', () => {
        const result = client.projectLocationNotificationConfigsPath(
          'projectValue',
          'locationValue',
          'notificationConfigValue',
        );
      ...
      it('matchProjectFromProjectLocationNotificationConfigsName', () => {
        const result =
          client.matchProjectFromProjectLocationNotificationConfigsName(
            fakePath,
          );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromProjectLocationNotificationConfigsName', () => {
        const result =
          client.matchLocationFromProjectLocationNotificationConfigsName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchNotificationConfigFromProjectLocationNotificationConfigsName', () => {
        const result =
          client.matchNotificationConfigFromProjectLocationNotificationConfigsName(
            fakePath,
          );
        assert.strictEqual(result, 'notificationConfigValue');
        assert(
    ...
    describe('projectSourceLocationFindings', async () => {
      ...
      it('projectSourceLocationFindingsPath', () => {
        const result = client.projectSourceLocationFindingsPath(
          'projectValue',
          'sourceValue',
          'locationValue',
          'findingValue',
      ...
      it('matchProjectFromProjectSourceLocationFindingsName', () => {
        const result =
          client.matchProjectFromProjectSourceLocationFindingsName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.projectSourceLocationFindingsPathTemplate
      ...
      it('matchSourceFromProjectSourceLocationFindingsName', () => {
        const result =
          client.matchSourceFromProjectSourceLocationFindingsName(fakePath);
        assert.strictEqual(result, 'sourceValue');
        assert(
          (
            client.pathTemplates.projectSourceLocationFindingsPathTemplate
      ...
      it('matchLocationFromProjectSourceLocationFindingsName', () => {
        const result =
          client.matchLocationFromProjectSourceLocationFindingsName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.projectSourceLocationFindingsPathTemplate
      ...
      it('matchFindingFromProjectSourceLocationFindingsName', () => {
        const result =
          client.matchFindingFromProjectSourceLocationFindingsName(fakePath);
        assert.strictEqual(result, 'findingValue');
        assert(
          (
            client.pathTemplates.projectSourceLocationFindingsPathTemplate
