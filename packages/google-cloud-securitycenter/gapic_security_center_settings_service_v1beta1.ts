...
describe('v1beta1.SecurityCenterSettingsServiceClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new securitycentersettingsserviceModule.v1beta1.SecurityCenterSettingsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'securitycenter.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new securitycentersettingsserviceModule.v1beta1.SecurityCenterSettingsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'securitycenter.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new securitycentersettingsserviceModule.v1beta1.SecurityCenterSettingsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new securitycentersettingsserviceModule.v1beta1.SecurityCenterSettingsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('Path templates', () => {
        ...
        describe('folderComponentSettings', async () => {
        ...
        describe('organizationComponentSettings', async () => {
        ...
        describe('projectComponentSettings', async () => {
        ...
        describe('projectLocationClusterComponentSettings', async () => {
        ...
        describe('projectLocationClusterSettings', async () => {
        ...
        describe('projectRegionClusterComponentSettings', async () => {
        ...
        describe('projectRegionClusterSettings', async () => {
        ...
        describe('projectZoneClusterComponentSettings', async () => {
        ...
        describe('projectZoneClusterSettings', async () => {
