...
export class SecurityCenterSettingsServiceClient {
  ...
  private _log = logging.log('settings');
   ...
   *     const client = new SecurityCenterSettingsServiceClient({fallback: true}, gax);
   *     ```
   */
 ...
 *   The first element of the array is an object representing {@link protos.google.cloud.securitycenter.settings.v1beta1.ServiceAccount|ServiceAccount}.
 ...
 */
  ...
  getServiceAccount(
    ...
    this._log.info('getServiceAccount request %j', request);
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getServiceAccount(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.securitycenter.settings.v1beta1.IServiceAccount,
        protos.google.cloud.securitycenter.settings.v1beta1.IGetServiceAccountRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getServiceAccount response %j', response);
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.cloud.securitycenter.settings.v1beta1.Settings|Settings}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 ...
 */
  ...
  getSettings(
    ...
    return this.innerApiCalls.getSettings(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.securitycenter.settings.v1beta1.ISettings,
        protos.google.cloud.securitycenter.settings.v1beta1.IGetSettingsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getSettings response %j', response);
        return [response, options, rawResponse];
 ...
 */
  ...
  updateSettings(
    ...
    return this.innerApiCalls.updateSettings(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.securitycenter.settings.v1beta1.ISettings,
        protos.google.cloud.securitycenter.settings.v1beta1.IUpdateSettingsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('updateSettings response %j', response);
        return [response, options, rawResponse];
 ...
 */
  ...
  resetSettings(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('resetSettings request %j', request);
    const wrappedCallback: Callback<
        protos.google.protobuf.IEmpty,
        protos.google.cloud.securitycenter.settings.v1beta1.IResetSettingsRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('resetSettings response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.resetSettings(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.protobuf.IEmpty,
        protos.google.cloud.securitycenter.settings.v1beta1.IResetSettingsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('resetSettings response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.cloud.securitycenter.settings.v1beta1.BatchGetSettingsResponse|BatchGetSettingsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 ...
 */
  ...
  batchGetSettings(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('batchGetSettings request %j', request);
    const wrappedCallback: Callback<
        protos.google.cloud.securitycenter.settings.v1beta1.IBatchGetSettingsResponse,
        protos.google.cloud.securitycenter.settings.v1beta1.IBatchGetSettingsRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchGetSettings response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.batchGetSettings(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.securitycenter.settings.v1beta1.IBatchGetSettingsResponse,
        protos.google.cloud.securitycenter.settings.v1beta1.IBatchGetSettingsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('batchGetSettings response %j', response);
        return [response, options, rawResponse];
 ...
 */
  ...
  calculateEffectiveSettings(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('calculateEffectiveSettings request %j', request);
    const wrappedCallback: Callback<
        protos.google.cloud.securitycenter.settings.v1beta1.ISettings,
        protos.google.cloud.securitycenter.settings.v1beta1.ICalculateEffectiveSettingsRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('calculateEffectiveSettings response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.calculateEffectiveSettings(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.securitycenter.settings.v1beta1.ISettings,
        protos.google.cloud.securitycenter.settings.v1beta1.ICalculateEffectiveSettingsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('calculateEffectiveSettings response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.cloud.securitycenter.settings.v1beta1.BatchCalculateEffectiveSettingsResponse|BatchCalculateEffectiveSettingsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 ...
 */
  ...
  batchCalculateEffectiveSettings(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('batchCalculateEffectiveSettings request %j', request);
    const wrappedCallback: Callback<
        protos.google.cloud.securitycenter.settings.v1beta1.IBatchCalculateEffectiveSettingsResponse,
        protos.google.cloud.securitycenter.settings.v1beta1.IBatchCalculateEffectiveSettingsRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchCalculateEffectiveSettings response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.batchCalculateEffectiveSettings(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.securitycenter.settings.v1beta1.IBatchCalculateEffectiveSettingsResponse,
        protos.google.cloud.securitycenter.settings.v1beta1.IBatchCalculateEffectiveSettingsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('batchCalculateEffectiveSettings response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.cloud.securitycenter.settings.v1beta1.ComponentSettings|ComponentSettings}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 ...
 */
  ...
  getComponentSettings(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('getComponentSettings request %j', request);
    const wrappedCallback: Callback<
        protos.google.cloud.securitycenter.settings.v1beta1.IComponentSettings,
        protos.google.cloud.securitycenter.settings.v1beta1.IGetComponentSettingsRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('getComponentSettings response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.getComponentSettings(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.securitycenter.settings.v1beta1.IComponentSettings,
        protos.google.cloud.securitycenter.settings.v1beta1.IGetComponentSettingsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getComponentSettings response %j', response);
        return [response, options, rawResponse];
 ...
 */
  ...
  updateComponentSettings(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('updateComponentSettings request %j', request);
    const wrappedCallback: Callback<
        protos.google.cloud.securitycenter.settings.v1beta1.IComponentSettings,
        protos.google.cloud.securitycenter.settings.v1beta1.IUpdateComponentSettingsRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('updateComponentSettings response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.updateComponentSettings(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.securitycenter.settings.v1beta1.IComponentSettings,
        protos.google.cloud.securitycenter.settings.v1beta1.IUpdateComponentSettingsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('updateComponentSettings response %j', response);
        return [response, options, rawResponse];
 ...
 */
  ...
  resetComponentSettings(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('resetComponentSettings request %j', request);
    const wrappedCallback: Callback<
        protos.google.protobuf.IEmpty,
        protos.google.cloud.securitycenter.settings.v1beta1.IResetComponentSettingsRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('resetComponentSettings response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.resetComponentSettings(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.protobuf.IEmpty,
        protos.google.cloud.securitycenter.settings.v1beta1.IResetComponentSettingsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('resetComponentSettings response %j', response);
        return [response, options, rawResponse];
 ...
 */
  ...
  calculateEffectiveComponentSettings(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('calculateEffectiveComponentSettings request %j', request);
    const wrappedCallback: Callback<
        protos.google.cloud.securitycenter.settings.v1beta1.IComponentSettings,
        protos.google.cloud.securitycenter.settings.v1beta1.ICalculateEffectiveComponentSettingsRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('calculateEffectiveComponentSettings response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.calculateEffectiveComponentSettings(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.securitycenter.settings.v1beta1.IComponentSettings,
        protos.google.cloud.securitycenter.settings.v1beta1.ICalculateEffectiveComponentSettingsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('calculateEffectiveComponentSettings response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.cloud.securitycenter.settings.v1beta1.Detector|Detector}.
 ...
 */
  ...
  listDetectors(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.securitycenter.settings.v1beta1.IListDetectorsRequest,
      protos.google.cloud.securitycenter.settings.v1beta1.IListDetectorsResponse|null|undefined,
      protos.google.cloud.securitycenter.settings.v1beta1.IDetector>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listDetectors values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listDetectors request %j', request);
    return this.innerApiCalls
      .listDetectors(request, options, wrappedCallback)
      ?.then(([response, input, output]: [
        protos.google.cloud.securitycenter.settings.v1beta1.IDetector[],
        protos.google.cloud.securitycenter.settings.v1beta1.IListDetectorsRequest|null,
        protos.google.cloud.securitycenter.settings.v1beta1.IListDetectorsResponse
      ]) => {
        this._log.info('listDetectors values %j', response);
        return [response, input, output];
      });
  }

/**
 * Equivalent to `listDetectors`, but returns a NodeJS Stream object.
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 *   Required. The parent, which owns this collection of detectors.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.cloud.securitycenter.settings.v1beta1.Detector|Detector} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 */
  listDetectorsStream(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('listDetectors stream %j', request);
 ...
 *   {@link protos.google.cloud.securitycenter.settings.v1beta1.Detector|Detector}. The API will be called under the hood as needed, once per the page,
 ...
 */
  listDetectorsAsync(
    ...
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listDetectors iterate %j', request);
 ...
 */
  ...
  listComponents(
    ...
    const wrappedCallback: PaginationCallback<
      ...
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listComponents values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listComponents request %j', request);
    return this.innerApiCalls
      .listComponents(request, options, wrappedCallback)
      ?.then(([response, input, output]: [
        string[],
        protos.google.cloud.securitycenter.settings.v1beta1.IListComponentsRequest|null,
        protos.google.cloud.securitycenter.settings.v1beta1.IListComponentsResponse
      ]) => {
        this._log.info('listComponents values %j', response);
        return [response, input, output];
      });
  }

/**
 * Equivalent to `listComponents`, but returns a NodeJS Stream object.
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 *   Required. The parent, which owns this collection of components.
 ...
 */
  listComponentsStream(
    ...
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listComponents stream %j', request);
 ...
 */
  listComponentsAsync(
    ...
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listComponents iterate %j', request);
