...
describe('v1.EkmServiceClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new ekmserviceModule.v1.EkmServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'cloudkms.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new ekmserviceModule.v1.EkmServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'cloudkms.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new ekmserviceModule.v1.EkmServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new ekmserviceModule.v1.EkmServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getEkmConnection', () => {
        it('invokes getEkmConnection without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.kms.v1.GetEkmConnectionRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getEkmConnection as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getEkmConnection as SinonStub)
        ...
        it('invokes getEkmConnection without error using callback', async () => {
            ...
            client.innerApiCalls.getEkmConnection = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getEkmConnection(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.kms.v1.IEkmConnection|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getEkmConnection with error', async () => {
            ...
            client.innerApiCalls.getEkmConnection = stubSimpleCall(undefined, expectedError);
    ...
    describe('createEkmConnection', () => {
        it('invokes createEkmConnection without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.kms.v1.CreateEkmConnectionRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.kms.v1.EkmConnection()
            );
            client.innerApiCalls.createEkmConnection = stubSimpleCall(expectedResponse);
            const [response] = await client.createEkmConnection(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createEkmConnection as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createEkmConnection as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createEkmConnection without error using callback', async () => {
            ...
            client.innerApiCalls.createEkmConnection = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createEkmConnection with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createEkmConnection = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateEkmConnection', () => {
        it('invokes updateEkmConnection without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.kms.v1.UpdateEkmConnectionRequest', ['ekmConnection', 'name']);
            request.ekmConnection.name = defaultValue1;
            const expectedHeaderRequestParams = `ekm_connection.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.kms.v1.EkmConnection()
            );
            client.innerApiCalls.updateEkmConnection = stubSimpleCall(expectedResponse);
            const [response] = await client.updateEkmConnection(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateEkmConnection as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateEkmConnection as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateEkmConnection without error using callback', async () => {
            ...
            client.innerApiCalls.updateEkmConnection = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateEkmConnection with error', async () => {
            ...
            const expectedHeaderRequestParams = `ekm_connection.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateEkmConnection = stubSimpleCall(undefined, expectedError);
    ...
    describe('getEkmConfig', () => {
        it('invokes getEkmConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.kms.v1.GetEkmConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getEkmConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getEkmConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getEkmConfig without error using callback', async () => {
            ...
            client.innerApiCalls.getEkmConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getEkmConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.kms.v1.IEkmConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getEkmConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getEkmConfig = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateEkmConfig', () => {
        it('invokes updateEkmConfig without error', async () => {
            ...
            request.ekmConfig ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.kms.v1.UpdateEkmConfigRequest', ['ekmConfig', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateEkmConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateEkmConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateEkmConfig without error using callback', async () => {
            ...
            client.innerApiCalls.updateEkmConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateEkmConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `ekm_config.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateEkmConfig = stubSimpleCall(undefined, expectedError);
    ...
    describe('verifyConnectivity', () => {
        it('invokes verifyConnectivity without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.kms.v1.VerifyConnectivityRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.kms.v1.VerifyConnectivityResponse()
            );
            client.innerApiCalls.verifyConnectivity = stubSimpleCall(expectedResponse);
            const [response] = await client.verifyConnectivity(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.verifyConnectivity as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.verifyConnectivity as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes verifyConnectivity without error using callback', async () => {
            ...
            client.innerApiCalls.verifyConnectivity = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.verifyConnectivity(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.kms.v1.IVerifyConnectivityResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes verifyConnectivity with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.verifyConnectivity = stubSimpleCall(undefined, expectedError);
    ...
    describe('listEkmConnections', () => {
        it('invokes listEkmConnections without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.kms.v1.ListEkmConnectionsRequest', ['parent']);
            request.parent = defaultValue1;
            ...
            client.innerApiCalls.listEkmConnections = stubSimpleCall(expectedResponse);
            const [response] = await client.listEkmConnections(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listEkmConnections as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listEkmConnections as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listEkmConnections without error using callback', async () => {
            ...
            client.innerApiCalls.listEkmConnections = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listEkmConnections with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listEkmConnections = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listEkmConnectionsStream without error', async () => {
            ...
            client.descriptors.page.listEkmConnections.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listEkmConnectionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.kms.v1.EkmConnection[] = [];
                stream.on('data', (response: protos.google.cloud.kms.v1.EkmConnection) => {
            ...
            assert((client.descriptors.page.listEkmConnections.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listEkmConnections, request));
            assert(
        ...
        it('invokes listEkmConnectionsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listEkmConnections.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listEkmConnectionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.kms.v1.EkmConnection[] = [];
                stream.on('data', (response: protos.google.cloud.kms.v1.EkmConnection) => {
        ...
        it('uses async iteration with listEkmConnections without error', async () => {
            ...
            client.descriptors.page.listEkmConnections.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listEkmConnections with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listEkmConnections.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listEkmConnectionsAsync(request);
