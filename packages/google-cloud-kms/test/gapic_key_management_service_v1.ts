...
describe('v1.KeyManagementServiceClient', () => {
  ...
  describe('getRetiredResource', () => {
    it('invokes getRetiredResource without error', async () => {
      ...
      client.innerApiCalls.getRetiredResource =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getRetiredResource(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getRetiredResource as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getRetiredResource as SinonStub
    ...
    it('invokes getRetiredResource without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getRetiredResource(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.kms.v1.IRetiredResource | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getRetiredResource with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getRetiredResource = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('decapsulate', () => {
    it('invokes decapsulate without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.decapsulate as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.decapsulate as SinonStub
    ...
    it('invokes decapsulate without error using callback', async () => {
      ...
      client.innerApiCalls.decapsulate =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.decapsulate(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.kms.v1.IDecapsulateResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes decapsulate with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.decapsulate = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteCryptoKey', () => {
    it('invokes deleteCryptoKey without error', async () => {
      ...
      client.innerApiCalls.deleteCryptoKey =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteCryptoKey(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteCryptoKey as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteCryptoKey as SinonStub
        ...
        client.deleteCryptoKey(
          ...
          (
            ...
            result?: LROperation<
              ...
              protos.google.cloud.kms.v1.IDeleteCryptoKeyMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
    ...
    it('invokes deleteCryptoKey with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteCryptoKey = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkDeleteCryptoKeyProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteCryptoKeyProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteCryptoKeyVersion', () => {
    it('invokes deleteCryptoKeyVersion without error', async () => {
      ...
      client.innerApiCalls.deleteCryptoKeyVersion =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteCryptoKeyVersion(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteCryptoKeyVersion as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteCryptoKeyVersion as SinonStub
      ...
      const promise = new Promise((resolve, reject) => {
        client.deleteCryptoKeyVersion(
          ...
          (
            ...
            result?: LROperation<
              protos.google.protobuf.IEmpty,
              protos.google.cloud.kms.v1.IDeleteCryptoKeyVersionMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
    ...
    it('invokes deleteCryptoKeyVersion with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteCryptoKeyVersion = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
    ...
    it('invokes checkDeleteCryptoKeyVersionProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteCryptoKeyVersionProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listRetiredResources', () => {
    it('invokes listRetiredResources without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listRetiredResources as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listRetiredResources as SinonStub
    ...
    it('invokes listRetiredResources with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listRetiredResources = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listRetiredResourcesStream without error', async () => {
      ...
      client.descriptors.page.listRetiredResources.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.kms.v1.RetiredResource) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listRetiredResources.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listRetiredResources, request),
      );
      assert(
        (client.descriptors.page.listRetiredResources.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listRetiredResources without error', async () => {
      ...
      client.descriptors.page.listRetiredResources.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
