...
function main(name, wrappingKey) {
  ...
  async function callExportTrustedKeyWrappedCryptoKeyVersion() {
    // Construct request
    const request = {
      name,
      wrappingKey,
    ...
    // Run request
    const response = await kmsClient.exportTrustedKeyWrappedCryptoKeyVersion(request);
    console.log(response);
  }

  callExportTrustedKeyWrappedCryptoKeyVersion();
