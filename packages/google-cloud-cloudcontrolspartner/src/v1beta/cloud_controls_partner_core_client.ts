 ...
 * `src/v1beta/cloud_controls_partner_core_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './cloud_controls_partner_core_client_config.json';
 ...
 * @memberof v1beta
 */
export class CloudControlsPartnerCoreClient {
  ...
  cloudControlsPartnerCoreStub?: Promise<{[name: string]: Function}>;
  ...
  initialize() {
    ...
    if (this.cloudControlsPartnerCoreStub) {
      return this.cloudControlsPartnerCoreStub;
    }
  ...
  listAccessApprovalRequestsAsync(
    ...
    return this.descriptors.page.listAccessApprovalRequests.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.cloudcontrolspartner.v1beta.IAccessApprovalRequest>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
