  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          cloudcontrolspartnermonitoringModule.v1
    ...
    it('invokes getViolation without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getViolation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.cloudcontrolspartner.v1.IViolation | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listViolations', () => {
    ...
    it('invokes listViolationsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.cloudcontrolspartner.v1.Violation) => {
