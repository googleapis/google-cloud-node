 ...
 */
import * as gapicConfig from './table_service_client_config.json';
...
export class TableServiceClient {
  ...
  tableServiceStub?: Promise<{ [name: string]: Function }>;
  ...
  initialize() {
    ...
    for (const methodName of tableServiceStubMethods) {
      const callPromise = this.tableServiceStub.then(
        (stub) =>
          (...args: Array<{}>) => {
            if (this._terminated) {
