...
function main(projectId, datasetId) {
  // [START bigquery_v2_generated_RoutineService_ListRoutines_async]
  /**
  ...
  const {RoutineServiceClient} = require('@google-cloud/bigquery-api').v2;

  // Instantiates a client
  const bigqueryClient = new RoutineServiceClient();

  async function callListRoutines() {
    // Construct request
    const request = {
      projectId,
      datasetId,
    ...
    // Run request
    const iterable = bigqueryClient.listRoutinesAsync(request);
  ...
  callListRoutines();
  // [END bigquery_v2_generated_RoutineService_ListRoutines_async]
}
