...
function main(projectId, datasetId, tableId, policyIds) {
  // [START bigquery_v2_generated_RowAccessPolicyService_BatchDeleteRowAccessPolicies_async]
  /**
  ...
  async function callBatchDeleteRowAccessPolicies() {
    // Construct request
    const request = {
      projectId,
      datasetId,
    ...
    // Run request
    const response = await bigqueryClient.batchDeleteRowAccessPolicies(request);
    console.log(response);
  }

  callBatchDeleteRowAccessPolicies();
  // [END bigquery_v2_generated_RowAccessPolicyService_BatchDeleteRowAccessPolicies_async]
}
