...
export {v1, BusinessGlossaryServiceClient, CatalogServiceClient, CmekServiceClient, ContentServiceClient, DataProductServiceClient, DataScanServiceClient, DataTaxonomyServiceClient, DataplexServiceClient, MetadataServiceClient};
export default {v1, BusinessGlossaryServiceClient, CatalogServiceClient, CmekServiceClient, ContentServiceClient, DataProductServiceClient, DataScanServiceClient, DataTaxonomyServiceClient, DataplexServiceClient, MetadataServiceClient};
