...
function main(parent, entryLinkId, entryLink) {
  ...
  async function callCreateEntryLink() {
    // Construct request
    const request = {
      parent,
      entryLinkId,
    ...
    // Run request
    const response = await dataplexClient.createEntryLink(request);
