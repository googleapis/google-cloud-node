...
describe('v1.DataScanServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = datascanserviceModule.v1.DataScanServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = datascanserviceModule.v1.DataScanServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'dataplex.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new datascanserviceModule.v1.DataScanServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dataplex.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new datascanserviceModule.v1.DataScanServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dataplex.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new datascanserviceModule.v1.DataScanServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new datascanserviceModule.v1.DataScanServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getDataScan', () => {
        it('invokes getDataScan without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataplex.v1.GetDataScanRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getDataScan as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDataScan as SinonStub)
        ...
        it('invokes getDataScan without error using callback', async () => {
            ...
            client.innerApiCalls.getDataScan = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getDataScan(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataplex.v1.IDataScan|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getDataScan with error', async () => {
            ...
            client.innerApiCalls.getDataScan = stubSimpleCall(undefined, expectedError);
    ...
    describe('runDataScan', () => {
        it('invokes runDataScan without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataplex.v1.RunDataScanRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.runDataScan as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.runDataScan as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes runDataScan without error using callback', async () => {
            ...
            client.innerApiCalls.runDataScan = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.runDataScan(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataplex.v1.IRunDataScanResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes runDataScan with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.runDataScan = stubSimpleCall(undefined, expectedError);
    ...
    describe('getDataScanJob', () => {
        it('invokes getDataScanJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataplex.v1.GetDataScanJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getDataScanJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDataScanJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getDataScanJob without error using callback', async () => {
            ...
            client.innerApiCalls.getDataScanJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getDataScanJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataplex.v1.IDataScanJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getDataScanJob with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getDataScanJob = stubSimpleCall(undefined, expectedError);
    ...
    describe('generateDataQualityRules', () => {
        it('invokes generateDataQualityRules without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataplex.v1.GenerateDataQualityRulesRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataplex.v1.GenerateDataQualityRulesResponse()
            );
            client.innerApiCalls.generateDataQualityRules = stubSimpleCall(expectedResponse);
            const [response] = await client.generateDataQualityRules(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.generateDataQualityRules as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateDataQualityRules as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes generateDataQualityRules without error using callback', async () => {
            ...
            client.innerApiCalls.generateDataQualityRules = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.generateDataQualityRules(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataplex.v1.IGenerateDataQualityRulesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes generateDataQualityRules with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.generateDataQualityRules = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.generateDataQualityRules(request), expectedError);
            const actualRequest = (client.innerApiCalls.generateDataQualityRules as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateDataQualityRules as SinonStub)
    ...
    describe('createDataScan', () => {
        it('invokes createDataScan without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataplex.v1.CreateDataScanRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createDataScan = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createDataScan(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createDataScan as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createDataScan as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createDataScan without error using callback', async () => {
            ...
            client.innerApiCalls.createDataScan = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createDataScan(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dataplex.v1.IDataScan, protos.google.cloud.dataplex.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dataplex.v1.IDataScan, protos.google.cloud.dataplex.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createDataScan as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createDataScan with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createDataScan = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes createDataScan with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createDataScan = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createDataScan(request);
        ...
        it('invokes checkCreateDataScanProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateDataScanProgress(expectedResponse.name);
        ...
        it('invokes checkCreateDataScanProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreateDataScanProgress(''), expectedError);
    ...
    describe('updateDataScan', () => {
        it('invokes updateDataScan without error', async () => {
            ...
            request.dataScan ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataplex.v1.UpdateDataScanRequest', ['dataScan', 'name']);
            request.dataScan.name = defaultValue1;
            const expectedHeaderRequestParams = `data_scan.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updateDataScan = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateDataScan(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateDataScan as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateDataScan as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateDataScan without error using callback', async () => {
            ...
            client.innerApiCalls.updateDataScan = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateDataScan with call error', async () => {
            ...
            const expectedHeaderRequestParams = `data_scan.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateDataScan = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes updateDataScan with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `data_scan.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateDataScan = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateDataScan(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateDataScan as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateDataScanProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateDataScanProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateDataScanProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateDataScanProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteDataScan', () => {
        it('invokes deleteDataScan without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataplex.v1.DeleteDataScanRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteDataScan = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteDataScan(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteDataScan as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteDataScan as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteDataScan without error using callback', async () => {
            ...
            client.innerApiCalls.deleteDataScan = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteDataScan with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteDataScan = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes deleteDataScan with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteDataScan = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteDataScan(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteDataScan as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteDataScanProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteDataScanProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteDataScanProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteDataScanProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listDataScans', () => {
        it('invokes listDataScans without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataplex.v1.ListDataScansRequest', ['parent']);
            request.parent = defaultValue1;
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listDataScans as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listDataScans as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listDataScans without error using callback', async () => {
            ...
            client.innerApiCalls.listDataScans = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listDataScans with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listDataScans = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listDataScansStream without error', async () => {
            ...
            client.descriptors.page.listDataScans.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listDataScansStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataplex.v1.DataScan[] = [];
                stream.on('data', (response: protos.google.cloud.dataplex.v1.DataScan) => {
            ...
            assert((client.descriptors.page.listDataScans.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listDataScans, request));
            assert(
        ...
        it('invokes listDataScansStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDataScans.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listDataScansStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataplex.v1.DataScan[] = [];
                stream.on('data', (response: protos.google.cloud.dataplex.v1.DataScan) => {
        ...
        it('uses async iteration with listDataScans without error', async () => {
            ...
            client.descriptors.page.listDataScans.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listDataScans with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDataScans.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listDataScansAsync(request);
    ...
    describe('listDataScanJobs', () => {
        it('invokes listDataScanJobs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataplex.v1.ListDataScanJobsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataplex.v1.DataScanJob()),
              generateSampleMessage(new protos.google.cloud.dataplex.v1.DataScanJob()),
              generateSampleMessage(new protos.google.cloud.dataplex.v1.DataScanJob()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listDataScanJobs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listDataScanJobs as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listDataScanJobs without error using callback', async () => {
            ...
            client.innerApiCalls.listDataScanJobs = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listDataScanJobs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listDataScanJobs = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listDataScanJobsStream without error', async () => {
            ...
            client.descriptors.page.listDataScanJobs.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listDataScanJobsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataplex.v1.DataScanJob[] = [];
                stream.on('data', (response: protos.google.cloud.dataplex.v1.DataScanJob) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listDataScanJobs.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listDataScanJobs, request));
            assert(
        ...
        it('invokes listDataScanJobsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDataScanJobs.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listDataScanJobsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataplex.v1.DataScanJob[] = [];
                stream.on('data', (response: protos.google.cloud.dataplex.v1.DataScanJob) => {
        ...
        it('uses async iteration with listDataScanJobs without error', async () => {
            ...
            client.descriptors.page.listDataScanJobs.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listDataScanJobs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDataScanJobs.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listDataScanJobsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.dataplex.v1.IDataScanJob[] = [];
                for await (const resource of iterable) {
