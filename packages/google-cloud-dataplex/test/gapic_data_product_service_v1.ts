...
describe('v1.DataProductServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          dataproductserviceModule.v1.DataProductServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          dataproductserviceModule.v1.DataProductServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'dataplex.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new dataproductserviceModule.v1.DataProductServiceClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'dataplex.example.com');
          if (saved) {
  ...
  describe('getDataProduct', () => {
    it('invokes getDataProduct without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getDataProduct as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getDataProduct without error using callback', async () => {
      ...
      client.innerApiCalls.getDataProduct =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDataProduct(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dataplex.v1.IDataProduct | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getDataProduct with error', async () => {
      ...
      client.innerApiCalls.getDataProduct = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getDataAsset', () => {
    it('invokes getDataAsset without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getDataAsset as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getDataAsset as SinonStub
    ...
    it('invokes getDataAsset without error using callback', async () => {
      ...
      client.innerApiCalls.getDataAsset =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getDataAsset(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.dataplex.v1.IDataAsset | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getDataAsset with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getDataAsset = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createDataProduct', () => {
    it('invokes createDataProduct without error', async () => {
      ...
      client.innerApiCalls.createDataProduct =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createDataProduct(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createDataProduct as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createDataProduct as SinonStub
    ...
    it('invokes createDataProduct with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createDataProduct = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkCreateDataProductProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateDataProductProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteDataProduct', () => {
    it('invokes deleteDataProduct without error', async () => {
      ...
      client.innerApiCalls.deleteDataProduct =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteDataProduct(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteDataProduct as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteDataProduct as SinonStub
    ...
    it('invokes deleteDataProduct with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteDataProduct = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkDeleteDataProductProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteDataProductProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateDataProduct', () => {
    it('invokes updateDataProduct without error', async () => {
      ...
      client.innerApiCalls.updateDataProduct =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateDataProduct(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateDataProduct as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateDataProduct as SinonStub
    ...
    it('invokes updateDataProduct with call error', async () => {
      ...
      const expectedHeaderRequestParams = `data_product.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateDataProduct = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkUpdateDataProductProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateDataProductProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createDataAsset', () => {
    it('invokes createDataAsset without error', async () => {
      ...
      client.innerApiCalls.createDataAsset =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createDataAsset(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createDataAsset as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createDataAsset as SinonStub
    ...
    it('invokes createDataAsset with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createDataAsset = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkCreateDataAssetProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateDataAssetProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateDataAsset', () => {
    it('invokes updateDataAsset without error', async () => {
      ...
      client.innerApiCalls.updateDataAsset =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateDataAsset(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateDataAsset as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateDataAsset as SinonStub
    ...
    it('invokes updateDataAsset with call error', async () => {
      ...
      const expectedHeaderRequestParams = `data_asset.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateDataAsset = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkUpdateDataAssetProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateDataAssetProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteDataAsset', () => {
    it('invokes deleteDataAsset without error', async () => {
      ...
      client.innerApiCalls.deleteDataAsset =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteDataAsset(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteDataAsset as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteDataAsset as SinonStub
    ...
    it('invokes deleteDataAsset with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteDataAsset = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkDeleteDataAssetProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteDataAssetProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listDataProducts', () => {
    it('invokes listDataProducts without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listDataProducts as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listDataProducts as SinonStub
    ...
    it('invokes listDataProducts without error using callback', async () => {
      ...
      client.innerApiCalls.listDataProducts =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listDataProducts with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listDataProducts = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listDataProductsStream without error', async () => {
      ...
      client.descriptors.page.listDataProducts.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dataplex.v1.DataProduct) => {
      ...
      assert(
        (client.descriptors.page.listDataProducts.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listDataProducts, request),
      );
      assert(
        (client.descriptors.page.listDataProducts.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listDataProducts without error', async () => {
      ...
      client.descriptors.page.listDataProducts.asyncIterate =
  ...
  describe('listDataAssets', () => {
    it('invokes listDataAssets without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listDataAssets as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listDataAssets as SinonStub
    ...
    it('invokes listDataAssets without error using callback', async () => {
      ...
      client.innerApiCalls.listDataAssets =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listDataAssets with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listDataAssets = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listDataAssetsStream without error', async () => {
      ...
      client.descriptors.page.listDataAssets.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dataplex.v1.DataAsset) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listDataAssets.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listDataAssets, request),
      );
      assert(
        (client.descriptors.page.listDataAssets.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listDataAssets without error', async () => {
      ...
      client.descriptors.page.listDataAssets.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
