...
describe('v1.DataProductServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = dataproductserviceModule.v1.DataProductServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = dataproductserviceModule.v1.DataProductServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'dataplex.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new dataproductserviceModule.v1.DataProductServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dataplex.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new dataproductserviceModule.v1.DataProductServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dataplex.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new dataproductserviceModule.v1.DataProductServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new dataproductserviceModule.v1.DataProductServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = dataproductserviceModule.v1.DataProductServiceClient.port;
            assert(port);
    ...
    describe('getDataProduct', () => {
        it('invokes getDataProduct without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.dataplex.v1.GetDataProductRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataplex.v1.GetDataProductRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataplex.v1.DataProduct()
            );
            client.innerApiCalls.getDataProduct = stubSimpleCall(expectedResponse);
            const [response] = await client.getDataProduct(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getDataProduct as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDataProduct as SinonStub)
        ...
        it('invokes getDataProduct without error using callback', async () => {
            ...
            client.innerApiCalls.getDataProduct = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getDataProduct(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataplex.v1.IDataProduct|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getDataProduct with error', async () => {
            ...
            client.innerApiCalls.getDataProduct = stubSimpleCall(undefined, expectedError);
    ...
    describe('getDataAsset', () => {
        it('invokes getDataAsset without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataplex.v1.GetDataAssetRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataplex.v1.GetDataAssetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataplex.v1.DataAsset()
            );
            client.innerApiCalls.getDataAsset = stubSimpleCall(expectedResponse);
            const [response] = await client.getDataAsset(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getDataAsset as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDataAsset as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getDataAsset without error using callback', async () => {
            ...
            client.innerApiCalls.getDataAsset = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getDataAsset(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataplex.v1.IDataAsset|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getDataAsset with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getDataAsset = stubSimpleCall(undefined, expectedError);
    ...
    describe('createDataProduct', () => {
        it('invokes createDataProduct without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataplex.v1.CreateDataProductRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataplex.v1.CreateDataProductRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createDataProduct = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createDataProduct(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createDataProduct as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createDataProduct as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createDataProduct without error using callback', async () => {
            ...
            client.innerApiCalls.createDataProduct = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createDataProduct(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dataplex.v1.IDataProduct, protos.google.cloud.dataplex.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dataplex.v1.IDataProduct, protos.google.cloud.dataplex.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createDataProduct as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createDataProduct with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createDataProduct = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createDataProduct(request), expectedError);
            const actualRequest = (client.innerApiCalls.createDataProduct as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createDataProduct as SinonStub)
        ...
        it('invokes createDataProduct with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createDataProduct = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createDataProduct(request);
        ...
        it('invokes checkCreateDataProductProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateDataProductProgress(expectedResponse.name);
        ...
        it('invokes checkCreateDataProductProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreateDataProductProgress(''), expectedError);
    ...
    describe('deleteDataProduct', () => {
        it('invokes deleteDataProduct without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataplex.v1.DeleteDataProductRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataplex.v1.DeleteDataProductRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteDataProduct = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteDataProduct(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteDataProduct as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteDataProduct as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteDataProduct without error using callback', async () => {
            ...
            client.innerApiCalls.deleteDataProduct = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteDataProduct(
                    request,
                    (err?: Error|null,
        ...
        it('invokes deleteDataProduct with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteDataProduct = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteDataProduct(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteDataProduct as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteDataProduct as SinonStub)
        ...
        it('invokes deleteDataProduct with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteDataProduct = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteDataProduct(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteDataProduct as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteDataProductProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteDataProductProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteDataProductProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteDataProductProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('updateDataProduct', () => {
        it('invokes updateDataProduct without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataplex.v1.UpdateDataProductRequest()
            );
            request.dataProduct ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataplex.v1.UpdateDataProductRequest', ['dataProduct', 'name']);
            request.dataProduct.name = defaultValue1;
            const expectedHeaderRequestParams = `data_product.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updateDataProduct = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateDataProduct(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateDataProduct as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateDataProduct as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateDataProduct without error using callback', async () => {
            ...
            client.innerApiCalls.updateDataProduct = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateDataProduct(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dataplex.v1.IDataProduct, protos.google.cloud.dataplex.v1.IOperationMetadata>|null
                    ) => {
        ...
        it('invokes updateDataProduct with call error', async () => {
            ...
            const expectedHeaderRequestParams = `data_product.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateDataProduct = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.updateDataProduct(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateDataProduct as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateDataProduct as SinonStub)
        ...
        it('invokes updateDataProduct with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `data_product.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateDataProduct = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateDataProduct(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateDataProduct as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateDataProductProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateDataProductProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateDataProductProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateDataProductProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('createDataAsset', () => {
        it('invokes createDataAsset without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataplex.v1.CreateDataAssetRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataplex.v1.CreateDataAssetRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createDataAsset = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createDataAsset(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createDataAsset as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createDataAsset as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createDataAsset without error using callback', async () => {
            ...
            client.innerApiCalls.createDataAsset = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createDataAsset(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dataplex.v1.IDataAsset, protos.google.cloud.dataplex.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dataplex.v1.IDataAsset, protos.google.cloud.dataplex.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createDataAsset as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createDataAsset with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createDataAsset = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createDataAsset(request), expectedError);
            const actualRequest = (client.innerApiCalls.createDataAsset as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createDataAsset as SinonStub)
        ...
        it('invokes createDataAsset with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createDataAsset = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createDataAsset(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.createDataAsset as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkCreateDataAssetProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkCreateDataAssetProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkCreateDataAssetProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkCreateDataAssetProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('updateDataAsset', () => {
        it('invokes updateDataAsset without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataplex.v1.UpdateDataAssetRequest()
            );
            request.dataAsset ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataplex.v1.UpdateDataAssetRequest', ['dataAsset', 'name']);
            request.dataAsset.name = defaultValue1;
            const expectedHeaderRequestParams = `data_asset.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updateDataAsset = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateDataAsset(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateDataAsset as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateDataAsset as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateDataAsset without error using callback', async () => {
            ...
            client.innerApiCalls.updateDataAsset = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateDataAsset(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dataplex.v1.IDataAsset, protos.google.cloud.dataplex.v1.IOperationMetadata>|null
                    ) => {
        ...
        it('invokes updateDataAsset with call error', async () => {
            ...
            const expectedHeaderRequestParams = `data_asset.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateDataAsset = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.updateDataAsset(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateDataAsset as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateDataAsset as SinonStub)
        ...
        it('invokes updateDataAsset with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `data_asset.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateDataAsset = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateDataAsset(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateDataAsset as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateDataAssetProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateDataAssetProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateDataAssetProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateDataAssetProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteDataAsset', () => {
        it('invokes deleteDataAsset without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataplex.v1.DeleteDataAssetRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataplex.v1.DeleteDataAssetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteDataAsset = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteDataAsset(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteDataAsset as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteDataAsset as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteDataAsset without error using callback', async () => {
            ...
            client.innerApiCalls.deleteDataAsset = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteDataAsset(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.dataplex.v1.IOperationMetadata>|null
                    ) => {
        ...
        it('invokes deleteDataAsset with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteDataAsset = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteDataAsset(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteDataAsset as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteDataAsset as SinonStub)
        ...
        it('invokes deleteDataAsset with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteDataAsset = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteDataAsset(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteDataAsset as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteDataAssetProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteDataAssetProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteDataAssetProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteDataAssetProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listDataProducts', () => {
        it('invokes listDataProducts without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataplex.v1.ListDataProductsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataplex.v1.ListDataProductsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataplex.v1.DataProduct()),
              generateSampleMessage(new protos.google.cloud.dataplex.v1.DataProduct()),
              generateSampleMessage(new protos.google.cloud.dataplex.v1.DataProduct()),
            ];
            client.innerApiCalls.listDataProducts = stubSimpleCall(expectedResponse);
            const [response] = await client.listDataProducts(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listDataProducts as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listDataProducts as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listDataProducts without error using callback', async () => {
            ...
            client.innerApiCalls.listDataProducts = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listDataProducts(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataplex.v1.IDataProduct[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listDataProducts with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listDataProducts = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listDataProducts(request), expectedError);
            const actualRequest = (client.innerApiCalls.listDataProducts as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listDataProducts as SinonStub)
        ...
        it('invokes listDataProductsStream without error', async () => {
            ...
            client.descriptors.page.listDataProducts.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listDataProductsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataplex.v1.DataProduct[] = [];
                stream.on('data', (response: protos.google.cloud.dataplex.v1.DataProduct) => {
            ...
            assert((client.descriptors.page.listDataProducts.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listDataProducts, request));
            assert(
        ...
        it('invokes listDataProductsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDataProducts.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listDataProductsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataplex.v1.DataProduct[] = [];
                stream.on('data', (response: protos.google.cloud.dataplex.v1.DataProduct) => {
        ...
        it('uses async iteration with listDataProducts without error', async () => {
            ...
            client.descriptors.page.listDataProducts.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.dataplex.v1.IDataProduct[] = [];
            const iterable = client.listDataProductsAsync(request);
        ...
        it('uses async iteration with listDataProducts with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDataProducts.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listDataProductsAsync(request);
    ...
    describe('listDataAssets', () => {
        it('invokes listDataAssets without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dataplex.v1.ListDataAssetsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dataplex.v1.ListDataAssetsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataplex.v1.DataAsset()),
              generateSampleMessage(new protos.google.cloud.dataplex.v1.DataAsset()),
              generateSampleMessage(new protos.google.cloud.dataplex.v1.DataAsset()),
            ];
            client.innerApiCalls.listDataAssets = stubSimpleCall(expectedResponse);
            const [response] = await client.listDataAssets(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listDataAssets as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listDataAssets as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listDataAssets without error using callback', async () => {
            ...
            client.innerApiCalls.listDataAssets = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listDataAssets with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listDataAssets = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listDataAssets(request), expectedError);
            const actualRequest = (client.innerApiCalls.listDataAssets as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listDataAssets as SinonStub)
        ...
        it('invokes listDataAssetsStream without error', async () => {
            ...
            client.descriptors.page.listDataAssets.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listDataAssetsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataplex.v1.DataAsset[] = [];
                stream.on('data', (response: protos.google.cloud.dataplex.v1.DataAsset) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listDataAssets.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listDataAssets, request));
            assert(
        ...
        it('invokes listDataAssetsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDataAssets.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listDataAssetsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dataplex.v1.DataAsset[] = [];
                stream.on('data', (response: protos.google.cloud.dataplex.v1.DataAsset) => {
        ...
        it('uses async iteration with listDataAssets without error', async () => {
            ...
            client.descriptors.page.listDataAssets.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.dataplex.v1.IDataAsset[] = [];
            const iterable = client.listDataAssetsAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
        ...
        it('uses async iteration with listDataAssets with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDataAssets.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listDataAssetsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.dataplex.v1.IDataAsset[] = [];
                for await (const resource of iterable) {
