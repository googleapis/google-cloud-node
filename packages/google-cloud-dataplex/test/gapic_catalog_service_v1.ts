...
describe('v1.CatalogServiceClient', () => {
  ...
  describe('modifyEntry', () => {
    it('invokes modifyEntry without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.dataplex.v1.ModifyEntryRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.modifyEntry = stubSimpleCall(expectedResponse);
      const [response] = await client.modifyEntry(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.modifyEntry as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.modifyEntry as SinonStub
    ...
    it('invokes modifyEntry without error using callback', async () => {
      ...
      client.innerApiCalls.modifyEntry =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.modifyEntry(
          request,
    ...
    it('invokes modifyEntry with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.modifyEntry = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createEntryLink', () => {
    it('invokes createEntryLink without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createEntryLink as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createEntryLink as SinonStub
    ...
    it('invokes createEntryLink without error using callback', async () => {
      ...
      client.innerApiCalls.createEntryLink =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createEntryLink(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dataplex.v1.IEntryLink | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createEntryLink with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createEntryLink = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateEntryLink', () => {
    it('invokes updateEntryLink without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateEntryLink as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateEntryLink as SinonStub
    ...
    it('invokes updateEntryLink without error using callback', async () => {
      ...
      client.innerApiCalls.updateEntryLink =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes updateEntryLink with error', async () => {
      ...
      const expectedHeaderRequestParams = `entry_link.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateEntryLink = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteEntryLink', () => {
    it('invokes deleteEntryLink without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteEntryLink as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteEntryLink as SinonStub
    ...
    it('invokes deleteEntryLink without error using callback', async () => {
      ...
      client.innerApiCalls.deleteEntryLink =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes deleteEntryLink with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteEntryLink = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('lookupContext', () => {
    it('invokes lookupContext without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.lookupContext as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.lookupContext as SinonStub
    ...
    it('invokes lookupContext without error using callback', async () => {
      ...
      client.innerApiCalls.lookupContext =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.lookupContext(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dataplex.v1.ILookupContextResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes lookupContext with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.lookupContext = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getEntryLink', () => {
    it('invokes getEntryLink without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getEntryLink as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getEntryLink as SinonStub
    ...
    it('invokes getEntryLink without error using callback', async () => {
      ...
      client.innerApiCalls.getEntryLink =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getEntryLink(
          request,
    ...
    it('invokes getEntryLink with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getEntryLink = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getMetadataFeed', () => {
    it('invokes getMetadataFeed without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getMetadataFeed as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getMetadataFeed as SinonStub
    ...
    it('invokes getMetadataFeed without error using callback', async () => {
      ...
      client.innerApiCalls.getMetadataFeed =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getMetadataFeed(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dataplex.v1.IMetadataFeed | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getMetadataFeed with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getMetadataFeed = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createMetadataFeed', () => {
    it('invokes createMetadataFeed without error', async () => {
      ...
      client.innerApiCalls.createMetadataFeed =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createMetadataFeed(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createMetadataFeed as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createMetadataFeed as SinonStub
    ...
    it('invokes createMetadataFeed with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createMetadataFeed = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkCreateMetadataFeedProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateMetadataFeedProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteMetadataFeed', () => {
    it('invokes deleteMetadataFeed without error', async () => {
      ...
      client.innerApiCalls.deleteMetadataFeed =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteMetadataFeed(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteMetadataFeed as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteMetadataFeed as SinonStub
    ...
    it('invokes deleteMetadataFeed with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteMetadataFeed = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkDeleteMetadataFeedProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteMetadataFeedProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateMetadataFeed', () => {
    it('invokes updateMetadataFeed without error', async () => {
      ...
      client.innerApiCalls.updateMetadataFeed =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateMetadataFeed(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateMetadataFeed as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateMetadataFeed as SinonStub
    ...
    it('invokes updateMetadataFeed with call error', async () => {
      ...
      const expectedHeaderRequestParams = `metadata_feed.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateMetadataFeed = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkUpdateMetadataFeedProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateMetadataFeedProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('lookupEntryLinks', () => {
    it('invokes lookupEntryLinks without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.lookupEntryLinks as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.lookupEntryLinks as SinonStub
    ...
    it('invokes lookupEntryLinks without error using callback', async () => {
      ...
      client.innerApiCalls.lookupEntryLinks =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes lookupEntryLinks with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.lookupEntryLinks = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes lookupEntryLinksStream without error', async () => {
      ...
      client.descriptors.page.lookupEntryLinks.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dataplex.v1.EntryLink) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.lookupEntryLinks.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.lookupEntryLinks, request),
      );
      assert(
        (client.descriptors.page.lookupEntryLinks.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with lookupEntryLinks without error', async () => {
      ...
      client.descriptors.page.lookupEntryLinks.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listMetadataFeeds', () => {
    it('invokes listMetadataFeeds without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listMetadataFeeds as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listMetadataFeeds as SinonStub
    ...
    it('invokes listMetadataFeeds without error using callback', async () => {
      ...
      client.innerApiCalls.listMetadataFeeds =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listMetadataFeeds with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listMetadataFeeds = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listMetadataFeedsStream without error', async () => {
      ...
      client.descriptors.page.listMetadataFeeds.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dataplex.v1.MetadataFeed) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listMetadataFeeds.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listMetadataFeeds, request),
      );
      assert(
        (client.descriptors.page.listMetadataFeeds.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listMetadataFeeds without error', async () => {
      ...
      client.descriptors.page.listMetadataFeeds.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
