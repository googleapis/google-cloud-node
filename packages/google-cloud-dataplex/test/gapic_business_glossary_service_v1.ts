...
describe('v1.BusinessGlossaryServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          businessglossaryserviceModule.v1.BusinessGlossaryServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        businessglossaryserviceModule.v1.BusinessGlossaryServiceClient.port;
      assert(port);
    ...
    it('invokes getGlossary without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getGlossary(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dataplex.v1.IGlossary | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createGlossaryCategory', () => {
    it('invokes createGlossaryCategory without error', async () => {
      ...
      client.innerApiCalls.createGlossaryCategory =
        stubSimpleCall(expectedResponse);
      const [response] = await client.createGlossaryCategory(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createGlossaryCategory as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createGlossaryCategory as SinonStub
    ...
    it('invokes createGlossaryCategory without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createGlossaryCategory(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dataplex.v1.IGlossaryCategory | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createGlossaryCategory with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createGlossaryCategory = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createGlossaryCategory(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createGlossaryCategory as SinonStub
  ...
  describe('updateGlossaryCategory', () => {
    it('invokes updateGlossaryCategory without error', async () => {
      ...
      client.innerApiCalls.updateGlossaryCategory =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateGlossaryCategory(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateGlossaryCategory as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateGlossaryCategory as SinonStub
    ...
    it('invokes updateGlossaryCategory with error', async () => {
      ...
      const expectedHeaderRequestParams = `category.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateGlossaryCategory = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateGlossaryCategory(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateGlossaryCategory as SinonStub
  ...
  describe('deleteGlossaryCategory', () => {
    it('invokes deleteGlossaryCategory without error', async () => {
      ...
      client.innerApiCalls.deleteGlossaryCategory =
        stubSimpleCall(expectedResponse);
      const [response] = await client.deleteGlossaryCategory(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteGlossaryCategory as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteGlossaryCategory as SinonStub
    ...
    it('invokes deleteGlossaryCategory with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteGlossaryCategory = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteGlossaryCategory(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteGlossaryCategory as SinonStub
  ...
  describe('getGlossaryCategory', () => {
    it('invokes getGlossaryCategory without error', async () => {
      ...
      client.innerApiCalls.getGlossaryCategory =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getGlossaryCategory(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getGlossaryCategory as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getGlossaryCategory as SinonStub
    ...
    it('invokes getGlossaryCategory with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getGlossaryCategory = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createGlossaryTerm', () => {
    it('invokes createGlossaryTerm without error', async () => {
      ...
      client.innerApiCalls.createGlossaryTerm =
        stubSimpleCall(expectedResponse);
      const [response] = await client.createGlossaryTerm(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createGlossaryTerm as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createGlossaryTerm as SinonStub
    ...
    it('invokes createGlossaryTerm without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createGlossaryTerm(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dataplex.v1.IGlossaryTerm | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createGlossaryTerm with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createGlossaryTerm = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateGlossaryTerm', () => {
    it('invokes updateGlossaryTerm without error', async () => {
      ...
      client.innerApiCalls.updateGlossaryTerm =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateGlossaryTerm(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateGlossaryTerm as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateGlossaryTerm as SinonStub
    ...
    it('invokes updateGlossaryTerm with error', async () => {
      ...
      const expectedHeaderRequestParams = `term.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateGlossaryTerm = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteGlossaryTerm', () => {
    it('invokes deleteGlossaryTerm without error', async () => {
      ...
      client.innerApiCalls.deleteGlossaryTerm =
        stubSimpleCall(expectedResponse);
      const [response] = await client.deleteGlossaryTerm(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteGlossaryTerm as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteGlossaryTerm as SinonStub
    ...
    it('invokes deleteGlossaryTerm with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteGlossaryTerm = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getGlossaryTerm', () => {
    it('invokes getGlossaryTerm without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getGlossaryTerm as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getGlossaryTerm as SinonStub
    ...
    it('invokes getGlossaryTerm without error using callback', async () => {
      ...
      client.innerApiCalls.getGlossaryTerm =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes getGlossaryTerm with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getGlossaryTerm = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listGlossaries', () => {
    ...
    it('invokes listGlossariesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dataplex.v1.Glossary) => {
  ...
  describe('listGlossaryCategories', () => {
    it('invokes listGlossaryCategories without error', async () => {
      ...
      client.innerApiCalls.listGlossaryCategories =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listGlossaryCategories(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listGlossaryCategories as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listGlossaryCategories as SinonStub
    ...
    it('invokes listGlossaryCategories with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listGlossaryCategories = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listGlossaryCategories(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listGlossaryCategories as SinonStub
    ...
    it('invokes listGlossaryCategoriesStream without error', async () => {
      ...
      client.descriptors.page.listGlossaryCategories.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dataplex.v1.GlossaryCategory) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (
          client.descriptors.page.listGlossaryCategories
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listGlossaryCategories, request),
      );
      assert(
        (
          client.descriptors.page.listGlossaryCategories
    ...
    it('uses async iteration with listGlossaryCategories without error', async () => {
      ...
      client.descriptors.page.listGlossaryCategories.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listGlossaryTerms', () => {
    it('invokes listGlossaryTerms without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listGlossaryTerms as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listGlossaryTerms as SinonStub
    ...
    it('invokes listGlossaryTerms without error using callback', async () => {
      ...
      client.innerApiCalls.listGlossaryTerms =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listGlossaryTerms with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listGlossaryTerms = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listGlossaryTermsStream without error', async () => {
      ...
      client.descriptors.page.listGlossaryTerms.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dataplex.v1.GlossaryTerm) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listGlossaryTerms.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listGlossaryTerms, request),
      );
      assert(
        (client.descriptors.page.listGlossaryTerms.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listGlossaryTerms without error', async () => {
      ...
      client.descriptors.page.listGlossaryTerms.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
