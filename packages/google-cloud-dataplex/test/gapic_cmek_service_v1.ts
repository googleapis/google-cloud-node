...
describe('v1.CmekServiceClient', () => {
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new cmekserviceModule.v1.CmekServiceClient({
          universe_domain: 'example.com',
  ...
  describe('getEncryptionConfig', () => {
    it('invokes getEncryptionConfig without error', async () => {
      ...
      client.innerApiCalls.getEncryptionConfig =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getEncryptionConfig(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getEncryptionConfig as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getEncryptionConfig without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getEncryptionConfig(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dataplex.v1.IEncryptionConfig | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getEncryptionConfig with error', async () => {
      ...
      client.innerApiCalls.getEncryptionConfig = stubSimpleCall(
        undefined,
        expectedError
      );
  ...
  describe('createEncryptionConfig', () => {
    it('invokes createEncryptionConfig without error', async () => {
      ...
      client.innerApiCalls.createEncryptionConfig =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createEncryptionConfig(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createEncryptionConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createEncryptionConfig as SinonStub
    ...
    it('invokes createEncryptionConfig with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createEncryptionConfig = stubLongRunningCall(
        undefined,
        expectedError
      );
      await assert.rejects(
        client.createEncryptionConfig(request),
        expectedError
      );
      const actualRequest = (
        client.innerApiCalls.createEncryptionConfig as SinonStub
    ...
    it('invokes checkCreateEncryptionConfigProgress without error', async () => {
      ...
      const decodedOperation = await client.checkCreateEncryptionConfigProgress(
    ...
    it('invokes checkCreateEncryptionConfigProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateEncryptionConfigProgress(''),
        expectedError
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateEncryptionConfig', () => {
    it('invokes updateEncryptionConfig without error', async () => {
      ...
      client.innerApiCalls.updateEncryptionConfig =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateEncryptionConfig(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateEncryptionConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateEncryptionConfig as SinonStub
    ...
    it('invokes updateEncryptionConfig with call error', async () => {
      ...
      const expectedHeaderRequestParams = `encryption_config.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateEncryptionConfig = stubLongRunningCall(
        undefined,
        expectedError
      );
      await assert.rejects(
        client.updateEncryptionConfig(request),
        expectedError
      );
      const actualRequest = (
        client.innerApiCalls.updateEncryptionConfig as SinonStub
    ...
    it('invokes checkUpdateEncryptionConfigProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkUpdateEncryptionConfigProgress(
        expectedResponse.name
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkUpdateEncryptionConfigProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateEncryptionConfigProgress(''),
        expectedError
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteEncryptionConfig', () => {
    it('invokes deleteEncryptionConfig without error', async () => {
      ...
      client.innerApiCalls.deleteEncryptionConfig =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteEncryptionConfig(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteEncryptionConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteEncryptionConfig as SinonStub
    ...
    it('invokes deleteEncryptionConfig with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteEncryptionConfig = stubLongRunningCall(
        undefined,
        expectedError
      );
      await assert.rejects(
        client.deleteEncryptionConfig(request),
        expectedError
      );
      const actualRequest = (
        client.innerApiCalls.deleteEncryptionConfig as SinonStub
    ...
    it('invokes checkDeleteEncryptionConfigProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkDeleteEncryptionConfigProgress(
        expectedResponse.name
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkDeleteEncryptionConfigProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteEncryptionConfigProgress(''),
        expectedError
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listEncryptionConfigs', () => {
    it('invokes listEncryptionConfigs without error', async () => {
      ...
      client.innerApiCalls.listEncryptionConfigs =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listEncryptionConfigs(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listEncryptionConfigs as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listEncryptionConfigs as SinonStub
    ...
    it('invokes listEncryptionConfigs with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listEncryptionConfigs = stubSimpleCall(
        undefined,
        expectedError
      );
      await assert.rejects(
        client.listEncryptionConfigs(request),
        expectedError
      );
      const actualRequest = (
        client.innerApiCalls.listEncryptionConfigs as SinonStub
    ...
    it('invokes listEncryptionConfigsStream without error', async () => {
      ...
      client.descriptors.page.listEncryptionConfigs.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dataplex.v1.EncryptionConfig) => {
      ...
      assert(
        (
          client.descriptors.page.listEncryptionConfigs
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listEncryptionConfigs, request)
      );
      assert(
        (
          client.descriptors.page.listEncryptionConfigs
    ...
    it('uses async iteration with listEncryptionConfigs without error', async () => {
      ...
      client.descriptors.page.listEncryptionConfigs.asyncIterate =
