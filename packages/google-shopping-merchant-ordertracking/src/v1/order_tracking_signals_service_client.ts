 ...
 * `src/v1/order_tracking_signals_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './order_tracking_signals_service_client_config.json';
 ...
 * @memberof v1
 */
export class OrderTrackingSignalsServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.shopping.merchant.ordertracking.v1.OrderTrackingSignalsService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.orderTrackingSignalsServiceStub) {
      return this.orderTrackingSignalsServiceStub;
    }
    ...
    this.orderTrackingSignalsServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.shopping.merchant.ordertracking.v1.OrderTrackingSignalsService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.shopping.merchant.ordertracking.v1.OrderTrackingSignalsService,
 ...
 * @param {google.shopping.merchant.ordertracking.v1.OrderTrackingSignal} request.orderTrackingSignal
 *   Required. The order signal to be created.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.shopping.merchant.ordertracking.v1.OrderTrackingSignal|OrderTrackingSignal}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/order_tracking_signals_service.create_order_tracking_signal.js</caption>
 * region_tag:merchantapi_v1_generated_OrderTrackingSignalsService_CreateOrderTrackingSignal_async
 */
  createOrderTrackingSignal(
      request?: protos.google.shopping.merchant.ordertracking.v1.ICreateOrderTrackingSignalRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.ordertracking.v1.IOrderTrackingSignal,
        protos.google.shopping.merchant.ordertracking.v1.ICreateOrderTrackingSignalRequest|undefined, {}|undefined
      ]>;
  createOrderTrackingSignal(
      request: protos.google.shopping.merchant.ordertracking.v1.ICreateOrderTrackingSignalRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.ordertracking.v1.IOrderTrackingSignal,
          protos.google.shopping.merchant.ordertracking.v1.ICreateOrderTrackingSignalRequest|null|undefined,
          {}|null|undefined>): void;
  createOrderTrackingSignal(
      request: protos.google.shopping.merchant.ordertracking.v1.ICreateOrderTrackingSignalRequest,
      callback: Callback<
