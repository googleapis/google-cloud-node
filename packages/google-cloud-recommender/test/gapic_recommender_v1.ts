...
describe('v1.RecommenderClient', () => {
    ...
    describe('getRecommendation', () => {
        ...
        it('invokes getRecommendation with error', async () => {
            ...
            await assert.rejects(async () => { await client.getRecommendation(request); }, expectedError);
            assert((client.innerApiCalls.getRecommendation as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('markRecommendationClaimed', () => {
        ...
        it('invokes markRecommendationClaimed with error', async () => {
            ...
            await assert.rejects(async () => { await client.markRecommendationClaimed(request); }, expectedError);
            assert((client.innerApiCalls.markRecommendationClaimed as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('markRecommendationSucceeded', () => {
        ...
        it('invokes markRecommendationSucceeded with error', async () => {
            ...
            await assert.rejects(async () => { await client.markRecommendationSucceeded(request); }, expectedError);
            assert((client.innerApiCalls.markRecommendationSucceeded as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('markRecommendationFailed', () => {
        ...
        it('invokes markRecommendationFailed with error', async () => {
            ...
            await assert.rejects(async () => { await client.markRecommendationFailed(request); }, expectedError);
            assert((client.innerApiCalls.markRecommendationFailed as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('listRecommendations', () => {
        ...
        it('invokes listRecommendations with error', async () => {
            ...
            await assert.rejects(async () => { await client.listRecommendations(request); }, expectedError);
            assert((client.innerApiCalls.listRecommendations as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('Path templates', () => {
        ...
        describe('recommendation', () => {
            ...
            it('recommendationPath', () => {
                const result = client.recommendationPath("projectValue", "locationValue", "recommenderValue", "recommendationValue");
        ...
        describe('recommender', () => {
            ...
            it('recommenderPath', () => {
                const result = client.recommenderPath("projectValue", "locationValue", "recommenderValue");
                assert.strictEqual(result, fakePath);
