...
function main(subscription) {
  // [START workspaceevents_v1_generated_SubscriptionsService_CreateSubscription_async]
  /**
  ...
  async function callCreateSubscription() {
    ...
    // Run request
    const [operation] = await subscriptionsClient.createSubscription(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callCreateSubscription();
  // [END workspaceevents_v1_generated_SubscriptionsService_CreateSubscription_async]
}
