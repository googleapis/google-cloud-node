...
describe('v1beta.SubscriptionsServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new subscriptionsserviceModule.v1beta.SubscriptionsServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          subscriptionsserviceModule.v1beta.SubscriptionsServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        subscriptionsserviceModule.v1beta.SubscriptionsServiceClient.port;
      assert(port);
    ...
    it('invokes getSubscription without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getSubscription(
          ...
          (
            err?: Error | null,
            result?: protos.google.apps.events.subscriptions.v1beta.ISubscription | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listSubscriptionsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.apps.events.subscriptions.v1beta.Subscription
          ) => {
