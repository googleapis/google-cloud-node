...
describe('v1.DataSourcesServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = datasourcesserviceModule.v1.DataSourcesServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = datasourcesserviceModule.v1.DataSourcesServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new datasourcesserviceModule.v1.DataSourcesServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new datasourcesserviceModule.v1.DataSourcesServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new datasourcesserviceModule.v1.DataSourcesServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new datasourcesserviceModule.v1.DataSourcesServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = datasourcesserviceModule.v1.DataSourcesServiceClient.port;
            assert(port);
    ...
    describe('getDataSource', () => {
        it('invokes getDataSource without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.datasources.v1.GetDataSourceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.datasources.v1.GetDataSourceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.datasources.v1.DataSource()
            );
            ...
            const actualRequest = (client.innerApiCalls.getDataSource as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDataSource as SinonStub)
        ...
        it('invokes getDataSource without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getDataSource(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.datasources.v1.IDataSource|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createDataSource', () => {
        it('invokes createDataSource without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.datasources.v1.CreateDataSourceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.datasources.v1.CreateDataSourceRequest', ['parent']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createDataSource as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createDataSource as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createDataSource without error using callback', async () => {
            ...
            client.innerApiCalls.createDataSource = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createDataSource with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createDataSource = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateDataSource', () => {
        it('invokes updateDataSource without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.datasources.v1.UpdateDataSourceRequest()
            );
            request.dataSource ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.datasources.v1.UpdateDataSourceRequest', ['dataSource', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateDataSource as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateDataSource as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateDataSource without error using callback', async () => {
            ...
            client.innerApiCalls.updateDataSource = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateDataSource with error', async () => {
            ...
            const expectedHeaderRequestParams = `data_source.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateDataSource = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteDataSource', () => {
        it('invokes deleteDataSource without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.datasources.v1.DeleteDataSourceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.datasources.v1.DeleteDataSourceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteDataSource as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteDataSource as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteDataSource without error using callback', async () => {
            ...
            client.innerApiCalls.deleteDataSource = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteDataSource with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteDataSource = stubSimpleCall(undefined, expectedError);
    ...
    describe('fetchDataSource', () => {
        it('invokes fetchDataSource without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.datasources.v1.FetchDataSourceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.datasources.v1.FetchDataSourceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.fetchDataSource as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.fetchDataSource as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes fetchDataSource without error using callback', async () => {
            ...
            client.innerApiCalls.fetchDataSource = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes fetchDataSource with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.fetchDataSource = stubSimpleCall(undefined, expectedError);
    ...
    describe('listDataSources', () => {
        it('invokes listDataSources without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.datasources.v1.ListDataSourcesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.datasources.v1.ListDataSourcesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.shopping.merchant.datasources.v1.DataSource()),
              generateSampleMessage(new protos.google.shopping.merchant.datasources.v1.DataSource()),
              generateSampleMessage(new protos.google.shopping.merchant.datasources.v1.DataSource()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listDataSources as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listDataSources as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listDataSourcesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.shopping.merchant.datasources.v1.DataSource[] = [];
                stream.on('data', (response: protos.google.shopping.merchant.datasources.v1.DataSource) => {
        ...
        it('uses async iteration with listDataSources without error', async () => {
            ...
            const responses: protos.google.shopping.merchant.datasources.v1.IDataSource[] = [];
    ...
    describe('Path templates', () => {
        ...
        describe('fileUpload', async () => {
            ...
            await client.initialize();
            client.pathTemplates.fileUploadPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.fileUploadPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('fileUploadPath', () => {
                const result = client.fileUploadPath("accountValue", "datasourceValue", "fileuploadValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.fileUploadPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchAccountFromFileUploadName', () => {
                ...
                assert.strictEqual(result, "accountValue");
                assert((client.pathTemplates.fileUploadPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
