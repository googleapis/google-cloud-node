...
[![npm version](https://img.shields.io/npm/v/@google-shopping/datasourcescesces.svg)](https://www.npmjs.org/package/@google-shopping/datasourcescesces)
...
```bash
npm install @google-shopping/datasourcescesces
```
...
For example, `npm install @google-shopping/datasourcescesces@legacy-8` installs client libraries
