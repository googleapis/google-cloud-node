...
[![npm version](https://img.shields.io/npm/v/@google-shopping/datasouresource.svg)](https://www.npmjs.org/package/@google-shopping/datasouresource)
...
```bash
npm install @google-shopping/datasouresource
```
...
For example, `npm install @google-shopping/datasouresource@legacy-8` installs client libraries
