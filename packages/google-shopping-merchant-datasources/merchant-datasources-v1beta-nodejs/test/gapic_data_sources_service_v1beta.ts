...
describe('v1beta.DataSourcesServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new datasourcesserviceModule.v1beta.DataSourcesServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = datasourcesserviceModule.v1beta.DataSourcesServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = datasourcesserviceModule.v1beta.DataSourcesServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new datasourcesserviceModule.v1beta.DataSourcesServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new datasourcesserviceModule.v1beta.DataSourcesServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new datasourcesserviceModule.v1beta.DataSourcesServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new datasourcesserviceModule.v1beta.DataSourcesServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = datasourcesserviceModule.v1beta.DataSourcesServiceClient.port;
            assert(port);
    ...
    describe('getDataSource', () => {
        it('invokes getDataSource without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.datasources.v1beta.GetDataSourceRequest', ['name']);
        ...
        it('invokes getDataSource without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getDataSource(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.datasources.v1beta.IDataSource|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createDataSource', () => {
        it('invokes createDataSource without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.datasources.v1beta.CreateDataSourceRequest', ['parent']);
    ...
    describe('updateDataSource', () => {
        it('invokes updateDataSource without error', async () => {
            ...
            request.dataSource ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.datasources.v1beta.UpdateDataSourceRequest', ['dataSource', 'name']);
    ...
    describe('deleteDataSource', () => {
        it('invokes deleteDataSource without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.datasources.v1beta.DeleteDataSourceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('fetchDataSource', () => {
        it('invokes fetchDataSource without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.datasources.v1beta.FetchDataSourceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('listDataSources', () => {
        it('invokes listDataSources without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.datasources.v1beta.ListDataSourcesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.shopping.merchant.datasources.v1beta.DataSource()),
              generateSampleMessage(new protos.google.shopping.merchant.datasources.v1beta.DataSource()),
              generateSampleMessage(new protos.google.shopping.merchant.datasources.v1beta.DataSource()),
            ];
        ...
        it('invokes listDataSourcesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.shopping.merchant.datasources.v1beta.DataSource) => {
