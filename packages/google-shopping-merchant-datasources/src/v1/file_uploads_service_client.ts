 ...
 * `src/v1/file_uploads_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './file_uploads_service_client_config.json';
 ...
 * @memberof v1
 */
export class FileUploadsServiceClient {
  ...
  initialize() {
    ...
    if (this.fileUploadsServiceStub) {
      return this.fileUploadsServiceStub;
    }
