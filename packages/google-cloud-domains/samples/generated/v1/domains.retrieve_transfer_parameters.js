...
function main(domainName, location) {
  // [START domains_v1_generated_Domains_RetrieveTransferParameters_async]
  /**
  ...
  async function retrieveTransferParameters() {
    ...
    // Run request
    const response = await domainsClient.retrieveTransferParameters(request);
    console.log(response);
  }

  retrieveTransferParameters();
  // [END domains_v1_generated_Domains_RetrieveTransferParameters_async]
}
