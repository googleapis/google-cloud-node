...
describe('v1beta1.DomainsClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new domainsModule.v1beta1.DomainsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'domains.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new domainsModule.v1beta1.DomainsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'domains.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new domainsModule.v1beta1.DomainsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new domainsModule.v1beta1.DomainsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('searchDomains', () => {
        it('invokes searchDomains without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.domains.v1beta1.SearchDomainsRequest', ['location']);
        ...
        it('invokes searchDomains without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.searchDomains(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.domains.v1beta1.ISearchDomainsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('retrieveRegisterParameters', () => {
        it('invokes retrieveRegisterParameters without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.domains.v1beta1.RetrieveRegisterParametersRequest', ['location']);
            request.location = defaultValue1;
            const expectedHeaderRequestParams = `location=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes retrieveRegisterParameters without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.retrieveRegisterParameters(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.domains.v1beta1.IRetrieveRegisterParametersResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('retrieveTransferParameters', () => {
        it('invokes retrieveTransferParameters without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.domains.v1beta1.RetrieveTransferParametersRequest', ['location']);
            request.location = defaultValue1;
            const expectedHeaderRequestParams = `location=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes retrieveTransferParameters without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.retrieveTransferParameters(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.domains.v1beta1.IRetrieveTransferParametersResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getRegistration', () => {
        it('invokes getRegistration without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.domains.v1beta1.GetRegistrationRequest', ['name']);
        ...
        it('invokes getRegistration without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getRegistration(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.domains.v1beta1.IRegistration|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('retrieveAuthorizationCode', () => {
        it('invokes retrieveAuthorizationCode without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.domains.v1beta1.RetrieveAuthorizationCodeRequest', ['registration']);
        ...
        it('invokes retrieveAuthorizationCode without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.retrieveAuthorizationCode(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.domains.v1beta1.IAuthorizationCode|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('resetAuthorizationCode', () => {
        it('invokes resetAuthorizationCode without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.domains.v1beta1.ResetAuthorizationCodeRequest', ['registration']);
            request.registration = defaultValue1;
            const expectedHeaderRequestParams = `registration=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.domains.v1beta1.AuthorizationCode()
    ...
    describe('registerDomain', () => {
        it('invokes registerDomain without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.domains.v1beta1.RegisterDomainRequest', ['parent']);
        ...
        it('invokes registerDomain without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.registerDomain(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.domains.v1beta1.IRegistration, protos.google.cloud.domains.v1beta1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.domains.v1beta1.IRegistration, protos.google.cloud.domains.v1beta1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.registerDomain as SinonStub)
                .getCall(0).args[0];
    ...
    describe('transferDomain', () => {
        it('invokes transferDomain without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.domains.v1beta1.TransferDomainRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('updateRegistration', () => {
        it('invokes updateRegistration without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.domains.v1beta1.UpdateRegistrationRequest', ['registration', 'name']);
    ...
    describe('configureManagementSettings', () => {
        it('invokes configureManagementSettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.domains.v1beta1.ConfigureManagementSettingsRequest', ['registration']);
            request.registration = defaultValue1;
            const expectedHeaderRequestParams = `registration=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('configureDnsSettings', () => {
        it('invokes configureDnsSettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.domains.v1beta1.ConfigureDnsSettingsRequest', ['registration']);
            request.registration = defaultValue1;
            const expectedHeaderRequestParams = `registration=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('configureContactSettings', () => {
        it('invokes configureContactSettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.domains.v1beta1.ConfigureContactSettingsRequest', ['registration']);
            request.registration = defaultValue1;
            const expectedHeaderRequestParams = `registration=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('exportRegistration', () => {
        it('invokes exportRegistration without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.domains.v1beta1.ExportRegistrationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('deleteRegistration', () => {
        it('invokes deleteRegistration without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.domains.v1beta1.DeleteRegistrationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes deleteRegistration without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deleteRegistration(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.domains.v1beta1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.domains.v1beta1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteRegistration as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listRegistrations', () => {
        it('invokes listRegistrations without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.domains.v1beta1.ListRegistrationsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.domains.v1beta1.Registration()),
              generateSampleMessage(new protos.google.cloud.domains.v1beta1.Registration()),
              generateSampleMessage(new protos.google.cloud.domains.v1beta1.Registration()),
            ];
        ...
        it('invokes listRegistrationsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.domains.v1beta1.Registration) => {
