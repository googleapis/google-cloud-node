...
describe('v1.LanguageServiceClient', () => {
  ...
  describe('analyzeSentiment', () => {
    it('invokes analyzeSentiment without error', done => {
      ...
      client.initialize();
      // Mock request
      const request: protosTypes.google.cloud.language.v1.IAnalyzeSentimentRequest = {};
      // Mock response
  ...
  describe('analyzeEntities', () => {
    it('invokes analyzeEntities without error', done => {
      ...
      client.initialize();
      // Mock request
      const request: protosTypes.google.cloud.language.v1.IAnalyzeEntitiesRequest = {};
      // Mock response
      const expectedResponse = {};
      // Mock gRPC layer
  ...
  describe('analyzeEntitySentiment', () => {
    it('invokes analyzeEntitySentiment without error', done => {
      ...
      client.initialize();
      // Mock request
      const request: protosTypes.google.cloud.language.v1.IAnalyzeEntitySentimentRequest = {};
      // Mock response
      const expectedResponse = {};
      // Mock gRPC layer
  ...
  describe('analyzeSyntax', () => {
    it('invokes analyzeSyntax without error', done => {
      ...
      client.initialize();
      // Mock request
      const request: protosTypes.google.cloud.language.v1.IAnalyzeSyntaxRequest = {};
      // Mock response
      const expectedResponse = {};
      // Mock gRPC layer
  ...
  describe('classifyText', () => {
    it('invokes classifyText without error', done => {
      ...
      client.initialize();
      // Mock request
      const request: protosTypes.google.cloud.language.v1.IClassifyTextRequest = {};
      // Mock response
      const expectedResponse = {};
      // Mock gRPC layer
  ...
  describe('annotateText', () => {
    it('invokes annotateText without error', done => {
      ...
      client.initialize();
      // Mock request
      const request: protosTypes.google.cloud.language.v1.IAnnotateTextRequest = {};
      // Mock response
      const expectedResponse = {};
      // Mock gRPC layer
