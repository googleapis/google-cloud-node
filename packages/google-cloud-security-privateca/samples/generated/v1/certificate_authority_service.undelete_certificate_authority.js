...
function main(name) {
  // [START privateca_v1_generated_CertificateAuthorityService_UndeleteCertificateAuthority_async]
  /**
  ...
  async function undeleteCertificateAuthority() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const [operation] = await privatecaClient.undeleteCertificateAuthority(
      request
    );
  ...
  // [END privateca_v1_generated_CertificateAuthorityService_UndeleteCertificateAuthority_async]
}
