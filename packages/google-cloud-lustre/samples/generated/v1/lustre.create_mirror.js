...
function main(parent, mirrorId, mirror) {
  // [START lustre_v1_generated_Lustre_CreateMirror_async]
  /**
  ...
  async function callCreateMirror() {
    // Construct request
    const request = {
      parent,
      mirrorId,
    ...
    // Run request
    const [operation] = await lustreClient.createMirror(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callCreateMirror();
  // [END lustre_v1_generated_Lustre_CreateMirror_async]
}
