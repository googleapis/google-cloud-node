...
function main(name) {
  // [START lustre_v1_generated_Lustre_GetInstance_async]
  /**
  ...
  async function callGetInstance() {
    ...
    // Run request
    const response = await lustreClient.getInstance(request);
    console.log(response);
  }

  callGetInstance();
  // [END lustre_v1_generated_Lustre_GetInstance_async]
}
