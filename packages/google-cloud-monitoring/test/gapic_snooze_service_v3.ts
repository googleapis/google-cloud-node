...
describe('v3.SnoozeServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = snoozeserviceModule.v3.SnoozeServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = snoozeserviceModule.v3.SnoozeServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'monitoring.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new snoozeserviceModule.v3.SnoozeServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'monitoring.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new snoozeserviceModule.v3.SnoozeServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'monitoring.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new snoozeserviceModule.v3.SnoozeServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new snoozeserviceModule.v3.SnoozeServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createSnooze', () => {
        it('invokes createSnooze without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.monitoring.v3.CreateSnoozeRequest', ['parent']);
            ...
            const actualRequest = (client.innerApiCalls.createSnooze as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createSnooze as SinonStub)
        ...
        it('invokes createSnooze without error using callback', async () => {
            ...
            client.innerApiCalls.createSnooze = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createSnooze(
                    request,
                    (err?: Error|null, result?: protos.google.monitoring.v3.ISnooze|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createSnooze with error', async () => {
            ...
            client.innerApiCalls.createSnooze = stubSimpleCall(undefined, expectedError);
    ...
    describe('getSnooze', () => {
        it('invokes getSnooze without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.monitoring.v3.GetSnoozeRequest', ['name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getSnooze as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getSnooze as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getSnooze without error using callback', async () => {
            ...
            client.innerApiCalls.getSnooze = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getSnooze(
                    request,
                    (err?: Error|null, result?: protos.google.monitoring.v3.ISnooze|null) => {
    ...
    describe('updateSnooze', () => {
        it('invokes updateSnooze without error', async () => {
            ...
            request.snooze ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.monitoring.v3.UpdateSnoozeRequest', ['snooze', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateSnooze as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateSnooze as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateSnooze without error using callback', async () => {
            ...
            client.innerApiCalls.updateSnooze = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateSnooze(
                    request,
                    (err?: Error|null, result?: protos.google.monitoring.v3.ISnooze|null) => {
        ...
        it('invokes updateSnooze with error', async () => {
            ...
            const expectedHeaderRequestParams = `snooze.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateSnooze = stubSimpleCall(undefined, expectedError);
    ...
    describe('listSnoozes', () => {
        it('invokes listSnoozes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.monitoring.v3.ListSnoozesRequest', ['parent']);
            request.parent = defaultValue1;
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listSnoozes as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listSnoozes as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listSnoozes without error using callback', async () => {
            ...
            client.innerApiCalls.listSnoozes = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listSnoozes(
                    request,
                    (err?: Error|null, result?: protos.google.monitoring.v3.ISnooze[]|null) => {
        ...
        it('invokes listSnoozes with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listSnoozes = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listSnoozesStream without error', async () => {
            ...
            client.descriptors.page.listSnoozes.createStream = stubPageStreamingCall(expectedResponse);
            ...
            assert((client.descriptors.page.listSnoozes.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listSnoozes, request));
            assert(
        ...
        it('invokes listSnoozesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listSnoozes.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listSnoozesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.monitoring.v3.Snooze[] = [];
                stream.on('data', (response: protos.google.monitoring.v3.Snooze) => {
        ...
        it('uses async iteration with listSnoozes without error', async () => {
            ...
            client.descriptors.page.listSnoozes.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listSnoozes with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listSnoozes.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listSnoozesAsync(request);
