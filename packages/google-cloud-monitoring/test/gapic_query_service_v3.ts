...
describe('v3.QueryServiceClient', () => {
  ...
  describe('queryTimeSeries', () => {
    ...
    it('invokes queryTimeSeries without error using callback', async () => {
      ...
      client.innerApiCalls.queryTimeSeries = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes queryTimeSeriesStream without error', async () => {
      ...
      client.descriptors.page.queryTimeSeries.createStream = stubPageStreamingCall(
        expectedResponse
      );
      ...
      assert.strictEqual(
        (client.descriptors.page.queryTimeSeries
