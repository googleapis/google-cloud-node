...
describe('v1.StorageBatchOperationsClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          storagebatchoperationsModule.v1.StorageBatchOperationsClient
            .servicePath;
        assert.strictEqual(
          servicePath,
    ...
    it('has port', () => {
      const port =
        storagebatchoperationsModule.v1.StorageBatchOperationsClient.port;
      assert(port);
  ...
  describe('getBucketOperation', () => {
    it('invokes getBucketOperation without error', async () => {
      ...
      client.innerApiCalls.getBucketOperation =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getBucketOperation(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getBucketOperation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getBucketOperation as SinonStub
    ...
    it('invokes getBucketOperation without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getBucketOperation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.storagebatchoperations.v1.IBucketOperation | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getBucketOperation with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getBucketOperation = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listBucketOperations', () => {
    it('invokes listBucketOperations without error', async () => {
      ...
      client.innerApiCalls.listBucketOperations =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listBucketOperations(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listBucketOperations as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listBucketOperations as SinonStub
    ...
    it('invokes listBucketOperations with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listBucketOperations = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listBucketOperationsStream without error', async () => {
      ...
      client.descriptors.page.listBucketOperations.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.storagebatchoperations.v1.BucketOperation,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (client.descriptors.page.listBucketOperations.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listBucketOperations, request),
      );
      assert(
        (client.descriptors.page.listBucketOperations.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listBucketOperations without error', async () => {
      ...
      client.descriptors.page.listBucketOperations.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('Path templates', () => {
    describe('bucketOperation', async () => {
      ...
      await client.initialize();
      client.pathTemplates.bucketOperationPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.bucketOperationPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('bucketOperationPath', () => {
        const result = client.bucketOperationPath(
          'projectValue',
          'locationValue',
          'jobValue',
          'bucketOperationValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.bucketOperationPathTemplate.render as SinonStub)
            .getCall(-1)
      ...
      it('matchProjectFromBucketOperationName', () => {
        ...
        assert(
          (client.pathTemplates.bucketOperationPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchBucketOperationFromBucketOperationName', () => {
        const result =
          client.matchBucketOperationFromBucketOperationName(fakePath);
