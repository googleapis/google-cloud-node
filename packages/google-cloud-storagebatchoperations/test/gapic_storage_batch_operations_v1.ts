...
describe('v1.StorageBatchOperationsClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new storagebatchoperationsModule.v1.StorageBatchOperationsClient();
            const apiEndpoint = client.apiEndpoint;
            assert.strictEqual(apiEndpoint, 'storagebatchoperations.googleapis.com');
        });
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = storagebatchoperationsModule.v1.StorageBatchOperationsClient.servicePath;
                assert.strictEqual(servicePath, 'storagebatchoperations.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = storagebatchoperationsModule.v1.StorageBatchOperationsClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'storagebatchoperations.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new storagebatchoperationsModule.v1.StorageBatchOperationsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'storagebatchoperations.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new storagebatchoperationsModule.v1.StorageBatchOperationsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'storagebatchoperations.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new storagebatchoperationsModule.v1.StorageBatchOperationsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
                    assert.strictEqual(servicePath, 'storagebatchoperations.configured.example.com');
                    if (saved) {
                        process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = saved;
                    } else {
                        delete process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new storagebatchoperationsModule.v1.StorageBatchOperationsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = storagebatchoperationsModule.v1.StorageBatchOperationsClient.port;
            assert(port);
    ...
    describe('getJob', () => {
        it('invokes getJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.storagebatchoperations.v1.GetJobRequest', ['name']);
        ...
        it('invokes getJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.storagebatchoperations.v1.IJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deleteJob', () => {
        it('invokes deleteJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.storagebatchoperations.v1.DeleteJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('cancelJob', () => {
        it('invokes cancelJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.storagebatchoperations.v1.CancelJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes cancelJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.cancelJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.storagebatchoperations.v1.ICancelJobResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createJob', () => {
        it('invokes createJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.storagebatchoperations.v1.CreateJobRequest', ['parent']);
        ...
        it('invokes createJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createJob(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.storagebatchoperations.v1.IJob, protos.google.cloud.storagebatchoperations.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.storagebatchoperations.v1.IJob, protos.google.cloud.storagebatchoperations.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createJob as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listJobs', () => {
        it('invokes listJobs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.storagebatchoperations.v1.ListJobsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.storagebatchoperations.v1.Job()),
              generateSampleMessage(new protos.google.cloud.storagebatchoperations.v1.Job()),
              generateSampleMessage(new protos.google.cloud.storagebatchoperations.v1.Job()),
            ];
        ...
        it('invokes listJobsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.storagebatchoperations.v1.Job[] = [];
                stream.on('data', (response: protos.google.cloud.storagebatchoperations.v1.Job) => {
        ...
        it('uses async iteration with listJobs without error', async () => {
            ...
            const responses: protos.google.cloud.storagebatchoperations.v1.IJob[] = [];
