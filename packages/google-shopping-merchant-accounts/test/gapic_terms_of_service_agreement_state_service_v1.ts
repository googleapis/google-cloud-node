...
describe('v1.TermsOfServiceAgreementStateServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new termsofserviceagreementstateserviceModule.v1.TermsOfServiceAgreementStateServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          termsofserviceagreementstateserviceModule.v1
            .TermsOfServiceAgreementStateServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        ...
        const apiEndpoint =
          termsofserviceagreementstateserviceModule.v1
            .TermsOfServiceAgreementStateServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        termsofserviceagreementstateserviceModule.v1
          .TermsOfServiceAgreementStateServiceClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(
        client.termsOfServiceAgreementStateServiceStub,
        undefined,
      );
  ...
  describe('getTermsOfServiceAgreementState', () => {
    it('invokes getTermsOfServiceAgreementState without error', async () => {
      ...
      client.innerApiCalls.getTermsOfServiceAgreementState =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getTermsOfServiceAgreementState(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getTermsOfServiceAgreementState as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getTermsOfServiceAgreementState without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getTermsOfServiceAgreementState(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1.ITermsOfServiceAgreementState | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getTermsOfServiceAgreementState with error', async () => {
      ...
      client.innerApiCalls.getTermsOfServiceAgreementState = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getTermsOfServiceAgreementState(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getTermsOfServiceAgreementState as SinonStub
  ...
  describe('retrieveForApplicationTermsOfServiceAgreementState', () => {
    it('invokes retrieveForApplicationTermsOfServiceAgreementState without error', async () => {
      ...
      client.innerApiCalls.retrieveForApplicationTermsOfServiceAgreementState =
        stubSimpleCall(expectedResponse);
      const [response] =
        await client.retrieveForApplicationTermsOfServiceAgreementState(
          request,
        );
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls
          .retrieveForApplicationTermsOfServiceAgreementState as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls
    ...
    it('invokes retrieveForApplicationTermsOfServiceAgreementState with error', async () => {
      ...
      await assert.rejects(
        client.retrieveForApplicationTermsOfServiceAgreementState(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls
