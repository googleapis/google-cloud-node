...
describe('v1.TermsOfServiceServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new termsofserviceserviceModule.v1.TermsOfServiceServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          termsofserviceserviceModule.v1.TermsOfServiceServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        termsofserviceserviceModule.v1.TermsOfServiceServiceClient.port;
      assert(port);
  ...
  describe('getTermsOfService', () => {
    it('invokes getTermsOfService without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getTermsOfService as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getTermsOfService without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getTermsOfService(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1.ITermsOfService | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getTermsOfService with error', async () => {
      ...
      client.innerApiCalls.getTermsOfService = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('retrieveLatestTermsOfService', () => {
    it('invokes retrieveLatestTermsOfService without error', async () => {
      ...
      client.innerApiCalls.retrieveLatestTermsOfService =
    ...
    it('invokes retrieveLatestTermsOfService with error', async () => {
      ...
      const expectedError = new Error('expected');
      client.innerApiCalls.retrieveLatestTermsOfService = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('acceptTermsOfService', () => {
    it('invokes acceptTermsOfService without error', async () => {
      ...
      client.innerApiCalls.acceptTermsOfService =
        stubSimpleCall(expectedResponse);
      const [response] = await client.acceptTermsOfService(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.acceptTermsOfService as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.acceptTermsOfService as SinonStub
    ...
    it('invokes acceptTermsOfService without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.acceptTermsOfService(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1.IAcceptTermsOfServiceResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes acceptTermsOfService with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.acceptTermsOfService = stubSimpleCall(
        undefined,
        expectedError,
      );
