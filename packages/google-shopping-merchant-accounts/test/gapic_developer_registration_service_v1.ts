...
describe('v1.DeveloperRegistrationServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          developerregistrationserviceModule.v1
            .DeveloperRegistrationServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        ...
        const apiEndpoint =
          developerregistrationserviceModule.v1
            .DeveloperRegistrationServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        developerregistrationserviceModule.v1.DeveloperRegistrationServiceClient
          .port;
      assert(port);
  ...
  describe('registerGcp', () => {
    it('invokes registerGcp without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.registerGcp as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes registerGcp without error using callback', async () => {
      ...
      client.innerApiCalls.registerGcp =
      ...
      const promise = new Promise((resolve, reject) => {
        client.registerGcp(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1.IDeveloperRegistration | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes registerGcp with error', async () => {
      ...
      client.innerApiCalls.registerGcp = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getDeveloperRegistration', () => {
    it('invokes getDeveloperRegistration without error', async () => {
      ...
      client.innerApiCalls.getDeveloperRegistration =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getDeveloperRegistration(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getDeveloperRegistration as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getDeveloperRegistration as SinonStub
    ...
    it('invokes getDeveloperRegistration with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getDeveloperRegistration = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getDeveloperRegistration(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getDeveloperRegistration as SinonStub
  ...
  describe('unregisterGcp', () => {
    it('invokes unregisterGcp without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.unregisterGcp as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.unregisterGcp as SinonStub
    ...
    it('invokes unregisterGcp without error using callback', async () => {
      ...
      client.innerApiCalls.unregisterGcp =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes unregisterGcp with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.unregisterGcp = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getAccountForGcpRegistration', () => {
    it('invokes getAccountForGcpRegistration without error', async () => {
      ...
      client.innerApiCalls.getAccountForGcpRegistration =
        stubSimpleCall(expectedResponse);
    ...
    it('invokes getAccountForGcpRegistration without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getAccountForGcpRegistration(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1.IGetAccountForGcpRegistrationResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getAccountForGcpRegistration with error', async () => {
      ...
      const request = generateSampleMessage(new protos.google.protobuf.Empty());
      const expectedError = new Error('expected');
      client.innerApiCalls.getAccountForGcpRegistration = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
