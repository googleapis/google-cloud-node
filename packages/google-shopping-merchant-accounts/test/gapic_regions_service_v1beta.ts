...
describe('v1beta.RegionsServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          regionsserviceModule.v1beta.RegionsServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          regionsserviceModule.v1beta.RegionsServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new regionsserviceModule.v1beta.RegionsServiceClient({
          universe_domain: 'example.com',
  ...
  describe('getRegion', () => {
    it('invokes getRegion without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getRegion as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getRegion without error using callback', async () => {
      ...
      client.innerApiCalls.getRegion =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getRegion(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1beta.IRegion | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createRegion', () => {
    it('invokes createRegion without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createRegion as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createRegion as SinonStub
    ...
    it('invokes createRegion without error using callback', async () => {
      ...
      client.innerApiCalls.createRegion =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createRegion(
          request,
  ...
  describe('updateRegion', () => {
    it('invokes updateRegion without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateRegion as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateRegion as SinonStub
    ...
    it('invokes updateRegion without error using callback', async () => {
      ...
      client.innerApiCalls.updateRegion =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.updateRegion(
          request,
  ...
  describe('deleteRegion', () => {
    it('invokes deleteRegion without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteRegion as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteRegion as SinonStub
    ...
    it('invokes deleteRegion without error using callback', async () => {
      ...
      client.innerApiCalls.deleteRegion =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.deleteRegion(
          request,
  ...
  describe('listRegions', () => {
    it('invokes listRegions without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listRegions as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listRegions as SinonStub
    ...
    it('invokes listRegions without error using callback', async () => {
      ...
      client.innerApiCalls.listRegions =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listRegions(
          request,
    ...
    it('invokes listRegionsStream without error', async () => {
      ...
      client.descriptors.page.listRegions.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.shopping.merchant.accounts.v1beta.Region
          ) => {
      ...
      assert(
        (client.descriptors.page.listRegions.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listRegions, request)
      );
      assert(
        (client.descriptors.page.listRegions.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listRegions without error', async () => {
      ...
      client.descriptors.page.listRegions.asyncIterate =
      ...
      assert.deepStrictEqual(
        (client.descriptors.page.listRegions.asyncIterate as SinonStub).getCall(
          0
        ).args[1],
        request
      );
