...
describe('v1beta.RegionsServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = regionsserviceModule.v1beta.RegionsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = regionsserviceModule.v1beta.RegionsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new regionsserviceModule.v1beta.RegionsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new regionsserviceModule.v1beta.RegionsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new regionsserviceModule.v1beta.RegionsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new regionsserviceModule.v1beta.RegionsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = regionsserviceModule.v1beta.RegionsServiceClient.port;
            assert(port);
    ...
    describe('getRegion', () => {
        it('invokes getRegion without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.GetRegionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.GetRegionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.Region()
            );
            client.innerApiCalls.getRegion = stubSimpleCall(expectedResponse);
            const [response] = await client.getRegion(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getRegion as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getRegion as SinonStub)
        ...
        it('invokes getRegion without error using callback', async () => {
            ...
            client.innerApiCalls.getRegion = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getRegion(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1beta.IRegion|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createRegion', () => {
        it('invokes createRegion without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.CreateRegionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.CreateRegionRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.Region()
            );
            client.innerApiCalls.createRegion = stubSimpleCall(expectedResponse);
            const [response] = await client.createRegion(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createRegion as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createRegion as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createRegion without error using callback', async () => {
            ...
            client.innerApiCalls.createRegion = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createRegion(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1beta.IRegion|null) => {
        ...
        it('invokes createRegion with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createRegion = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateRegion', () => {
        it('invokes updateRegion without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.UpdateRegionRequest()
            );
            request.region ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.UpdateRegionRequest', ['region', 'name']);
            request.region.name = defaultValue1;
            const expectedHeaderRequestParams = `region.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.Region()
            );
            client.innerApiCalls.updateRegion = stubSimpleCall(expectedResponse);
            const [response] = await client.updateRegion(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateRegion as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateRegion as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateRegion without error using callback', async () => {
            ...
            client.innerApiCalls.updateRegion = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateRegion(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1beta.IRegion|null) => {
        ...
        it('invokes updateRegion with error', async () => {
            ...
            const expectedHeaderRequestParams = `region.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateRegion = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteRegion', () => {
        it('invokes deleteRegion without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.DeleteRegionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.DeleteRegionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteRegion = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteRegion(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteRegion as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteRegion as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteRegion without error using callback', async () => {
            ...
            client.innerApiCalls.deleteRegion = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteRegion(
                    request,
        ...
        it('invokes deleteRegion with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteRegion = stubSimpleCall(undefined, expectedError);
    ...
    describe('listRegions', () => {
        it('invokes listRegions without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.ListRegionsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.ListRegionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1beta.Region()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1beta.Region()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1beta.Region()),
            ];
            client.innerApiCalls.listRegions = stubSimpleCall(expectedResponse);
            const [response] = await client.listRegions(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listRegions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listRegions as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listRegions without error using callback', async () => {
            ...
            client.innerApiCalls.listRegions = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listRegions(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1beta.IRegion[]|null) => {
        ...
        it('invokes listRegions with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listRegions = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listRegions(request), expectedError);
            const actualRequest = (client.innerApiCalls.listRegions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listRegions as SinonStub)
        ...
        it('invokes listRegionsStream without error', async () => {
            ...
            client.descriptors.page.listRegions.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listRegionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.shopping.merchant.accounts.v1beta.Region[] = [];
                stream.on('data', (response: protos.google.shopping.merchant.accounts.v1beta.Region) => {
            ...
            assert((client.descriptors.page.listRegions.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listRegions, request));
            assert(
        ...
        it('invokes listRegionsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listRegions.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listRegionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.shopping.merchant.accounts.v1beta.Region[] = [];
                stream.on('data', (response: protos.google.shopping.merchant.accounts.v1beta.Region) => {
        ...
        it('uses async iteration with listRegions without error', async () => {
            ...
            client.descriptors.page.listRegions.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.shopping.merchant.accounts.v1beta.IRegion[] = [];
            const iterable = client.listRegionsAsync(request);
        ...
        it('uses async iteration with listRegions with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listRegions.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listRegionsAsync(request);
