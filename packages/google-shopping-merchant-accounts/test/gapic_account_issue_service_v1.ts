...
describe('v1.AccountIssueServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new accountissueserviceModule.v1.AccountIssueServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          accountissueserviceModule.v1.AccountIssueServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          accountissueserviceModule.v1.AccountIssueServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
  ...
  describe('listAccountIssues', () => {
    it('invokes listAccountIssues without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.shopping.merchant.accounts.v1.AccountIssue(),
        ),
        generateSampleMessage(
          new protos.google.shopping.merchant.accounts.v1.AccountIssue(),
        ),
      ...
      const actualRequest = (
        client.innerApiCalls.listAccountIssues as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes listAccountIssues without error using callback', async () => {
      ...
      client.innerApiCalls.listAccountIssues =
      ...
      const promise = new Promise((resolve, reject) => {
        client.listAccountIssues(
          ...
          (
            err?: Error | null,
            result?:
              | protos.google.shopping.merchant.accounts.v1.IAccountIssue[]
              | null,
          ) => {
            if (err) {
              reject(err);
    ...
    it('invokes listAccountIssues with error', async () => {
      ...
      client.innerApiCalls.listAccountIssues = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listAccountIssuesStream without error', async () => {
      ...
      client.descriptors.page.listAccountIssues.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.shopping.merchant.accounts.v1.AccountIssue,
          ) => {
      ...
      assert(
        (client.descriptors.page.listAccountIssues.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listAccountIssues, request),
      );
      assert(
        (client.descriptors.page.listAccountIssues.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listAccountIssues without error', async () => {
      ...
      client.descriptors.page.listAccountIssues.asyncIterate =
