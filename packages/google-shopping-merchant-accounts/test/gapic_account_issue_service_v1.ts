...
describe('v1.AccountIssueServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new accountissueserviceModule.v1.AccountIssueServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = accountissueserviceModule.v1.AccountIssueServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = accountissueserviceModule.v1.AccountIssueServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new accountissueserviceModule.v1.AccountIssueServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new accountissueserviceModule.v1.AccountIssueServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new accountissueserviceModule.v1.AccountIssueServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new accountissueserviceModule.v1.AccountIssueServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = accountissueserviceModule.v1.AccountIssueServiceClient.port;
            assert(port);
    ...
    describe('listAccountIssues', () => {
        it('invokes listAccountIssues without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.ListAccountIssuesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.ListAccountIssuesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1.AccountIssue()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1.AccountIssue()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1.AccountIssue()),
            ];
            client.innerApiCalls.listAccountIssues = stubSimpleCall(expectedResponse);
            const [response] = await client.listAccountIssues(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listAccountIssues as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAccountIssues as SinonStub)
        ...
        it('invokes listAccountIssues without error using callback', async () => {
            ...
            client.innerApiCalls.listAccountIssues = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listAccountIssues(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1.IAccountIssue[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listAccountIssues with error', async () => {
            ...
            client.innerApiCalls.listAccountIssues = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listAccountIssues(request), expectedError);
            const actualRequest = (client.innerApiCalls.listAccountIssues as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAccountIssues as SinonStub)
        ...
        it('invokes listAccountIssuesStream without error', async () => {
            ...
            client.descriptors.page.listAccountIssues.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listAccountIssuesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.shopping.merchant.accounts.v1.AccountIssue[] = [];
                stream.on('data', (response: protos.google.shopping.merchant.accounts.v1.AccountIssue) => {
            ...
            assert((client.descriptors.page.listAccountIssues.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listAccountIssues, request));
            assert(
        ...
        it('invokes listAccountIssuesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAccountIssues.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listAccountIssuesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.shopping.merchant.accounts.v1.AccountIssue[] = [];
                stream.on('data', (response: protos.google.shopping.merchant.accounts.v1.AccountIssue) => {
        ...
        it('uses async iteration with listAccountIssues without error', async () => {
            ...
            client.descriptors.page.listAccountIssues.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.shopping.merchant.accounts.v1.IAccountIssue[] = [];
            const iterable = client.listAccountIssuesAsync(request);
        ...
        it('uses async iteration with listAccountIssues with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAccountIssues.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listAccountIssuesAsync(request);
