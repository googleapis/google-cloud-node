...
describe('v1.CheckoutSettingsServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new checkoutsettingsserviceModule.v1.CheckoutSettingsServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = checkoutsettingsserviceModule.v1.CheckoutSettingsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = checkoutsettingsserviceModule.v1.CheckoutSettingsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new checkoutsettingsserviceModule.v1.CheckoutSettingsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new checkoutsettingsserviceModule.v1.CheckoutSettingsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new checkoutsettingsserviceModule.v1.CheckoutSettingsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new checkoutsettingsserviceModule.v1.CheckoutSettingsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = checkoutsettingsserviceModule.v1.CheckoutSettingsServiceClient.port;
            assert(port);
    ...
    describe('getCheckoutSettings', () => {
        it('invokes getCheckoutSettings without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.GetCheckoutSettingsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.GetCheckoutSettingsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.CheckoutSettings()
            );
        ...
        it('invokes getCheckoutSettings without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCheckoutSettings(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1.ICheckoutSettings|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createCheckoutSettings', () => {
        it('invokes createCheckoutSettings without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.CreateCheckoutSettingsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.CreateCheckoutSettingsRequest', ['parent']);
    ...
    describe('updateCheckoutSettings', () => {
        it('invokes updateCheckoutSettings without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.UpdateCheckoutSettingsRequest()
            );
            request.checkoutSettings ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.UpdateCheckoutSettingsRequest', ['checkoutSettings', 'name']);
    ...
    describe('deleteCheckoutSettings', () => {
        it('invokes deleteCheckoutSettings without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.DeleteCheckoutSettingsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.DeleteCheckoutSettingsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
