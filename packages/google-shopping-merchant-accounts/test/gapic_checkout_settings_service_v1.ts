...
describe('v1.CheckoutSettingsServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new checkoutsettingsserviceModule.v1.CheckoutSettingsServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          checkoutsettingsserviceModule.v1.CheckoutSettingsServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        checkoutsettingsserviceModule.v1.CheckoutSettingsServiceClient.port;
      assert(port);
    ...
    it('invokes getCheckoutSettings without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getCheckoutSettings(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1.ICheckoutSettings | null,
          ) => {
            if (err) {
              reject(err);
            } else {
