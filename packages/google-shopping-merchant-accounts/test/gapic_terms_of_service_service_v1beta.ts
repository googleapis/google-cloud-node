  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          termsofserviceserviceModule.v1beta.TermsOfServiceServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        termsofserviceserviceModule.v1beta.TermsOfServiceServiceClient.port;
      assert(port);
    ...
    it('invokes getTermsOfService without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getTermsOfService(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1beta.ITermsOfService | null
          ) => {
            if (err) {
              reject(err);
            } else {
