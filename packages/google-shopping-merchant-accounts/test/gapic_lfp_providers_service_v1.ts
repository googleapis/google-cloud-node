...
describe('v1.LfpProvidersServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = lfpprovidersserviceModule.v1.LfpProvidersServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = lfpprovidersserviceModule.v1.LfpProvidersServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new lfpprovidersserviceModule.v1.LfpProvidersServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new lfpprovidersserviceModule.v1.LfpProvidersServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new lfpprovidersserviceModule.v1.LfpProvidersServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new lfpprovidersserviceModule.v1.LfpProvidersServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = lfpprovidersserviceModule.v1.LfpProvidersServiceClient.port;
            assert(port);
    ...
    describe('linkLfpProvider', () => {
        it('invokes linkLfpProvider without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.LinkLfpProviderRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.LinkLfpProviderRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.LinkLfpProviderResponse()
            );
        ...
        it('invokes linkLfpProvider without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.linkLfpProvider(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1.ILinkLfpProviderResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('findLfpProviders', () => {
        it('invokes findLfpProviders without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.FindLfpProvidersRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.FindLfpProvidersRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1.LfpProvider()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1.LfpProvider()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1.LfpProvider()),
            ];
        ...
        it('invokes findLfpProviders without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.findLfpProviders(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1.ILfpProvider[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes findLfpProvidersStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.shopping.merchant.accounts.v1.LfpProvider[] = [];
                stream.on('data', (response: protos.google.shopping.merchant.accounts.v1.LfpProvider) => {
        ...
        it('uses async iteration with findLfpProviders without error', async () => {
            ...
            const responses: protos.google.shopping.merchant.accounts.v1.ILfpProvider[] = [];
