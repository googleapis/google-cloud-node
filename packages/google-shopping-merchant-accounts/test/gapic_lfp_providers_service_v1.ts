...
describe('v1.LfpProvidersServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new lfpprovidersserviceModule.v1.LfpProvidersServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          lfpprovidersserviceModule.v1.LfpProvidersServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          lfpprovidersserviceModule.v1.LfpProvidersServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('invokes linkLfpProvider without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.linkLfpProvider(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1.ILinkLfpProviderResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes findLfpProviders without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.shopping.merchant.accounts.v1.LfpProvider(),
        ),
        generateSampleMessage(
          new protos.google.shopping.merchant.accounts.v1.LfpProvider(),
        ),
    ...
    it('invokes findLfpProvidersStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.shopping.merchant.accounts.v1.LfpProvider,
          ) => {
