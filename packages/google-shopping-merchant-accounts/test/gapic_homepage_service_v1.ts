  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          homepageserviceModule.v1.HomepageServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          homepageserviceModule.v1.HomepageServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new homepageserviceModule.v1.HomepageServiceClient({
          universe_domain: 'example.com',
    ...
    it('invokes getHomepage without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getHomepage(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1.IHomepage | null,
          ) => {
            if (err) {
              reject(err);
            } else {
