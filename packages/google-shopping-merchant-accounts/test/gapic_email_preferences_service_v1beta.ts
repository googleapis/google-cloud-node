...
describe('v1beta.EmailPreferencesServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new emailpreferencesserviceModule.v1beta.EmailPreferencesServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          emailpreferencesserviceModule.v1beta.EmailPreferencesServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        emailpreferencesserviceModule.v1beta.EmailPreferencesServiceClient.port;
      assert(port);
    ...
    it('invokes getEmailPreferences without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getEmailPreferences(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1beta.IEmailPreferences | null
          ) => {
            if (err) {
              reject(err);
            } else {
