...
describe('v1.ShippingSettingsServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new shippingsettingsserviceModule.v1.ShippingSettingsServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          shippingsettingsserviceModule.v1.ShippingSettingsServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        shippingsettingsserviceModule.v1.ShippingSettingsServiceClient.port;
      assert(port);
    ...
    it('invokes getShippingSettings without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getShippingSettings(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1.IShippingSettings | null,
          ) => {
            if (err) {
              reject(err);
            } else {
