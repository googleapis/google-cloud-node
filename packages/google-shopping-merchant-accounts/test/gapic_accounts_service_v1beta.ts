...
describe('v1beta.AccountsServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = accountsserviceModule.v1beta.AccountsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = accountsserviceModule.v1beta.AccountsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new accountsserviceModule.v1beta.AccountsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new accountsserviceModule.v1beta.AccountsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new accountsserviceModule.v1beta.AccountsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new accountsserviceModule.v1beta.AccountsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getAccount', () => {
        it('invokes getAccount without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.GetAccountRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getAccount as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getAccount as SinonStub)
        ...
        it('invokes getAccount without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAccount(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1beta.IAccount|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createAndConfigureAccount', () => {
        it('invokes createAndConfigureAccount without error', async () => {
            ...
            client.innerApiCalls.createAndConfigureAccount = stubSimpleCall(expectedResponse);
        ...
        it('invokes createAndConfigureAccount without error using callback', async () => {
            ...
            client.innerApiCalls.createAndConfigureAccount = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createAndConfigureAccount with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.createAndConfigureAccount = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createAndConfigureAccount(request), expectedError);
        });
    ...
    describe('deleteAccount', () => {
        it('invokes deleteAccount without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.DeleteAccountRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteAccount as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteAccount as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('updateAccount', () => {
        it('invokes updateAccount without error', async () => {
            ...
            request.account ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.UpdateAccountRequest', ['account', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateAccount as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateAccount as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('listAccounts', () => {
        it('invokes listAccounts without error', async () => {
            ...
            const request = generateSampleMessage(
              ...
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1beta.Account()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1beta.Account()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1beta.Account()),
            ];
        ...
        it('invokes listAccountsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.shopping.merchant.accounts.v1beta.Account) => {
    ...
    describe('listSubAccounts', () => {
        it('invokes listSubAccounts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.ListSubAccountsRequest', ['provider']);
            request.provider = defaultValue1;
            const expectedHeaderRequestParams = `provider=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1beta.Account()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1beta.Account()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1beta.Account()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listSubAccounts as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listSubAccounts as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listSubAccounts without error using callback', async () => {
            ...
            client.innerApiCalls.listSubAccounts = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listSubAccounts with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listSubAccounts = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listSubAccountsStream without error', async () => {
            ...
            client.descriptors.page.listSubAccounts.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listSubAccounts.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listSubAccounts, request));
            assert(
        ...
        it('invokes listSubAccountsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `provider=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listSubAccounts.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listSubAccountsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.shopping.merchant.accounts.v1beta.Account[] = [];
                stream.on('data', (response: protos.google.shopping.merchant.accounts.v1beta.Account) => {
        ...
        it('uses async iteration with listSubAccounts without error', async () => {
            ...
            client.descriptors.page.listSubAccounts.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.shopping.merchant.accounts.v1beta.IAccount[] = [];
        ...
        it('uses async iteration with listSubAccounts with error', async () => {
            ...
            const expectedHeaderRequestParams = `provider=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listSubAccounts.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listSubAccountsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.shopping.merchant.accounts.v1beta.IAccount[] = [];
                for await (const resource of iterable) {
