...
describe('v1.RegionsServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          regionsserviceModule.v1.RegionsServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          regionsserviceModule.v1.RegionsServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new regionsserviceModule.v1.RegionsServiceClient({
          universe_domain: 'example.com',
    ...
    it('invokes getRegion without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getRegion(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1.IRegion | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('batchCreateRegions', () => {
    it('invokes batchCreateRegions without error', async () => {
      ...
      client.innerApiCalls.batchCreateRegions =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchCreateRegions(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchCreateRegions as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchCreateRegions as SinonStub
    ...
    it('invokes batchCreateRegions without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchCreateRegions(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1.IBatchCreateRegionsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchCreateRegions with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchCreateRegions = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('batchUpdateRegions', () => {
    it('invokes batchUpdateRegions without error', async () => {
      ...
      client.innerApiCalls.batchUpdateRegions =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchUpdateRegions(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchUpdateRegions as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchUpdateRegions as SinonStub
    ...
    it('invokes batchUpdateRegions without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchUpdateRegions(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1.IBatchUpdateRegionsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchUpdateRegions with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchUpdateRegions = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('batchDeleteRegions', () => {
    it('invokes batchDeleteRegions without error', async () => {
      ...
      client.innerApiCalls.batchDeleteRegions =
        stubSimpleCall(expectedResponse);
      const [response] = await client.batchDeleteRegions(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchDeleteRegions as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchDeleteRegions as SinonStub
    ...
    it('invokes batchDeleteRegions with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchDeleteRegions = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listRegions', () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listRegions(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.shopping.merchant.accounts.v1.IRegion[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listRegionsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.shopping.merchant.accounts.v1.Region) => {
