...
describe('v1beta.CheckoutSettingsServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          checkoutsettingsserviceModule.v1beta.CheckoutSettingsServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        checkoutsettingsserviceModule.v1beta.CheckoutSettingsServiceClient.port;
      assert(port);
  ...
  describe('getCheckoutSettings', () => {
    it('invokes getCheckoutSettings without error', async () => {
      ...
      client.innerApiCalls.getCheckoutSettings =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getCheckoutSettings(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getCheckoutSettings as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getCheckoutSettings without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getCheckoutSettings(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1beta.ICheckoutSettings | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getCheckoutSettings with error', async () => {
      ...
      client.innerApiCalls.getCheckoutSettings = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createCheckoutSettings', () => {
    it('invokes createCheckoutSettings without error', async () => {
      ...
      client.innerApiCalls.createCheckoutSettings =
        stubSimpleCall(expectedResponse);
      const [response] = await client.createCheckoutSettings(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createCheckoutSettings as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createCheckoutSettings as SinonStub
    ...
    it('invokes createCheckoutSettings with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createCheckoutSettings = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createCheckoutSettings(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createCheckoutSettings as SinonStub
  ...
  describe('updateCheckoutSettings', () => {
    it('invokes updateCheckoutSettings without error', async () => {
      ...
      client.innerApiCalls.updateCheckoutSettings =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateCheckoutSettings(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateCheckoutSettings as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateCheckoutSettings as SinonStub
    ...
    it('invokes updateCheckoutSettings with error', async () => {
      ...
      const expectedHeaderRequestParams = `checkout_settings.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateCheckoutSettings = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateCheckoutSettings(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateCheckoutSettings as SinonStub
  ...
  describe('deleteCheckoutSettings', () => {
    it('invokes deleteCheckoutSettings without error', async () => {
      ...
      client.innerApiCalls.deleteCheckoutSettings =
        stubSimpleCall(expectedResponse);
      const [response] = await client.deleteCheckoutSettings(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteCheckoutSettings as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteCheckoutSettings as SinonStub
    ...
    it('invokes deleteCheckoutSettings with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteCheckoutSettings = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteCheckoutSettings(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteCheckoutSettings as SinonStub
