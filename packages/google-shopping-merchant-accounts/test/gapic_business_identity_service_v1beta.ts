  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          businessidentityserviceModule.v1beta.BusinessIdentityServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        businessidentityserviceModule.v1beta.BusinessIdentityServiceClient.port;
      assert(port);
    ...
    it('invokes getBusinessIdentity without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getBusinessIdentity(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1beta.IBusinessIdentity | null
          ) => {
            if (err) {
              reject(err);
            } else {
