  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          accountissueserviceModule.v1beta.AccountIssueServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        accountissueserviceModule.v1beta.AccountIssueServiceClient.port;
      assert(port);
    ...
    it('invokes listAccountIssues without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.shopping.merchant.accounts.v1beta.AccountIssue()
        ),
        generateSampleMessage(
          new protos.google.shopping.merchant.accounts.v1beta.AccountIssue()
        ),
    ...
    it('invokes listAccountIssuesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.shopping.merchant.accounts.v1beta.AccountIssue
          ) => {
