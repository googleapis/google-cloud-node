...
describe('v1.BusinessIdentityServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new businessidentityserviceModule.v1.BusinessIdentityServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = businessidentityserviceModule.v1.BusinessIdentityServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = businessidentityserviceModule.v1.BusinessIdentityServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new businessidentityserviceModule.v1.BusinessIdentityServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new businessidentityserviceModule.v1.BusinessIdentityServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new businessidentityserviceModule.v1.BusinessIdentityServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new businessidentityserviceModule.v1.BusinessIdentityServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = businessidentityserviceModule.v1.BusinessIdentityServiceClient.port;
            assert(port);
    ...
    describe('getBusinessIdentity', () => {
        it('invokes getBusinessIdentity without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.GetBusinessIdentityRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.BusinessIdentity()
            );
            client.innerApiCalls.getBusinessIdentity = stubSimpleCall(expectedResponse);
            const [response] = await client.getBusinessIdentity(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getBusinessIdentity as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getBusinessIdentity as SinonStub)
        ...
        it('invokes getBusinessIdentity without error using callback', async () => {
            ...
            client.innerApiCalls.getBusinessIdentity = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getBusinessIdentity(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1.IBusinessIdentity|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getBusinessIdentity with error', async () => {
            ...
            client.innerApiCalls.getBusinessIdentity = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateBusinessIdentity', () => {
        it('invokes updateBusinessIdentity without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.UpdateBusinessIdentityRequest', ['businessIdentity', 'name']);
            request.businessIdentity.name = defaultValue1;
            const expectedHeaderRequestParams = `business_identity.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.BusinessIdentity()
            );
            client.innerApiCalls.updateBusinessIdentity = stubSimpleCall(expectedResponse);
            const [response] = await client.updateBusinessIdentity(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateBusinessIdentity as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateBusinessIdentity as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateBusinessIdentity without error using callback', async () => {
            ...
            client.innerApiCalls.updateBusinessIdentity = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateBusinessIdentity with error', async () => {
            ...
            const expectedHeaderRequestParams = `business_identity.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateBusinessIdentity = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateBusinessIdentity(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateBusinessIdentity as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateBusinessIdentity as SinonStub)
