  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          automaticimprovementsserviceModule.v1
    ...
    it('has port', () => {
      const port =
        automaticimprovementsserviceModule.v1.AutomaticImprovementsServiceClient
          .port;
      assert(port);
    ...
    it('invokes getAutomaticImprovements without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getAutomaticImprovements(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1.IAutomaticImprovements | null,
          ) => {
            if (err) {
              reject(err);
            } else {
