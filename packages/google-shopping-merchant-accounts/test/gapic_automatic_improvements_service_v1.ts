...
describe('v1.AutomaticImprovementsServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new automaticimprovementsserviceModule.v1.AutomaticImprovementsServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = automaticimprovementsserviceModule.v1.AutomaticImprovementsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = automaticimprovementsserviceModule.v1.AutomaticImprovementsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new automaticimprovementsserviceModule.v1.AutomaticImprovementsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new automaticimprovementsserviceModule.v1.AutomaticImprovementsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new automaticimprovementsserviceModule.v1.AutomaticImprovementsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new automaticimprovementsserviceModule.v1.AutomaticImprovementsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = automaticimprovementsserviceModule.v1.AutomaticImprovementsServiceClient.port;
            assert(port);
    ...
    describe('getAutomaticImprovements', () => {
        it('invokes getAutomaticImprovements without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.GetAutomaticImprovementsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.GetAutomaticImprovementsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.AutomaticImprovements()
            );
        ...
        it('invokes getAutomaticImprovements without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAutomaticImprovements(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1.IAutomaticImprovements|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateAutomaticImprovements', () => {
        it('invokes updateAutomaticImprovements without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.UpdateAutomaticImprovementsRequest()
            );
            request.automaticImprovements ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.UpdateAutomaticImprovementsRequest', ['automaticImprovements', 'name']);
