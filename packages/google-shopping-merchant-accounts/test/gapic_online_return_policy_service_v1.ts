...
describe('v1.OnlineReturnPolicyServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          onlinereturnpolicyserviceModule.v1.OnlineReturnPolicyServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        onlinereturnpolicyserviceModule.v1.OnlineReturnPolicyServiceClient.port;
      assert(port);
  ...
  describe('getOnlineReturnPolicy', () => {
    it('invokes getOnlineReturnPolicy without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.shopping.merchant.accounts.v1.GetOnlineReturnPolicyRequest',
        ['name'],
      );
    ...
    it('invokes getOnlineReturnPolicy without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getOnlineReturnPolicy(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1.IOnlineReturnPolicy | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listOnlineReturnPolicies', () => {
    it('invokes listOnlineReturnPolicies without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.shopping.merchant.accounts.v1.ListOnlineReturnPoliciesRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      const promise = new Promise((resolve, reject) => {
        client.listOnlineReturnPolicies(
          ...
          (
            err?: Error | null,
            result?:
              | protos.google.shopping.merchant.accounts.v1.IOnlineReturnPolicy[]
              | null,
          ) => {
            if (err) {
              reject(err);
    ...
    it('invokes listOnlineReturnPoliciesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.shopping.merchant.accounts.v1.OnlineReturnPolicy,
          ) => {
