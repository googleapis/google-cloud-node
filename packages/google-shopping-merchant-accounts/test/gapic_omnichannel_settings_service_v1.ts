  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          omnichannelsettingsserviceModule.v1.OmnichannelSettingsServiceClient
            .servicePath;
    ...
    it('invokes getOmnichannelSetting without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getOmnichannelSetting(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1.IOmnichannelSetting | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes requestInventoryVerification without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.requestInventoryVerification(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1.IRequestInventoryVerificationResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listOmnichannelSettingsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.shopping.merchant.accounts.v1.OmnichannelSetting,
          ) => {
