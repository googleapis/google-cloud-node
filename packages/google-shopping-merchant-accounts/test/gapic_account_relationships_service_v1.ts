...
describe('v1.AccountRelationshipsServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          accountrelationshipsserviceModule.v1.AccountRelationshipsServiceClient
            .servicePath;
  ...
  describe('getAccountRelationship', () => {
    it('invokes getAccountRelationship without error', async () => {
      ...
      client.innerApiCalls.getAccountRelationship =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getAccountRelationship(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getAccountRelationship as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getAccountRelationship without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getAccountRelationship(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1.IAccountRelationship | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getAccountRelationship with error', async () => {
      ...
      client.innerApiCalls.getAccountRelationship = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getAccountRelationship(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getAccountRelationship as SinonStub
  ...
  describe('updateAccountRelationship', () => {
    it('invokes updateAccountRelationship without error', async () => {
      ...
      client.innerApiCalls.updateAccountRelationship =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateAccountRelationship(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateAccountRelationship as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateAccountRelationship as SinonStub
    ...
    it('invokes updateAccountRelationship with error', async () => {
      ...
      const expectedHeaderRequestParams = `account_relationship.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateAccountRelationship = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateAccountRelationship(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateAccountRelationship as SinonStub
  ...
  describe('listAccountRelationships', () => {
    it('invokes listAccountRelationships without error', async () => {
      ...
      client.innerApiCalls.listAccountRelationships =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listAccountRelationships(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listAccountRelationships as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listAccountRelationships as SinonStub
    ...
    it('invokes listAccountRelationships with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listAccountRelationships = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listAccountRelationships(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listAccountRelationships as SinonStub
    ...
    it('invokes listAccountRelationshipsStream without error', async () => {
      ...
      client.descriptors.page.listAccountRelationships.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.shopping.merchant.accounts.v1.AccountRelationship,
          ) => {
      ...
      assert(
        (
          client.descriptors.page.listAccountRelationships
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listAccountRelationships, request),
      );
      assert(
        (
          client.descriptors.page.listAccountRelationships
    ...
    it('uses async iteration with listAccountRelationships without error', async () => {
      ...
      client.descriptors.page.listAccountRelationships.asyncIterate =
