...
describe('v1.ProgramsServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new programsserviceModule.v1.ProgramsServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = programsserviceModule.v1.ProgramsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = programsserviceModule.v1.ProgramsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new programsserviceModule.v1.ProgramsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new programsserviceModule.v1.ProgramsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new programsserviceModule.v1.ProgramsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new programsserviceModule.v1.ProgramsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = programsserviceModule.v1.ProgramsServiceClient.port;
            assert(port);
    ...
    describe('getProgram', () => {
        it('invokes getProgram without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.GetProgramRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.GetProgramRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.Program()
            );
        ...
        it('invokes getProgram without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getProgram(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1.IProgram|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('enableProgram', () => {
        it('invokes enableProgram without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.EnableProgramRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.EnableProgramRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.Program()
    ...
    describe('disableProgram', () => {
        it('invokes disableProgram without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.DisableProgramRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.DisableProgramRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.Program()
    ...
    describe('listPrograms', () => {
        it('invokes listPrograms without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.ListProgramsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.ListProgramsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1.Program()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1.Program()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1.Program()),
            ];
        ...
        it('invokes listProgramsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.shopping.merchant.accounts.v1.Program[] = [];
                stream.on('data', (response: protos.google.shopping.merchant.accounts.v1.Program) => {
        ...
        it('uses async iteration with listPrograms without error', async () => {
            ...
            const responses: protos.google.shopping.merchant.accounts.v1.IProgram[] = [];
