  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          programsserviceModule.v1.ProgramsServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          programsserviceModule.v1.ProgramsServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new programsserviceModule.v1.ProgramsServiceClient({
          universe_domain: 'example.com',
    ...
    it('invokes getProgram without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getProgram(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1.IProgram | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listPrograms', () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listPrograms(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.shopping.merchant.accounts.v1.IProgram[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listProgramsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.shopping.merchant.accounts.v1.Program) => {
