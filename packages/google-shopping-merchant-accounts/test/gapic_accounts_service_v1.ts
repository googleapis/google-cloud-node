...
describe('v1.AccountsServiceClient', () => {
    ...
    describe('getAccount', () => {
        it('invokes getAccount without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.GetAccountRequest', ['name']);
    ...
    describe('deleteAccount', () => {
        it('invokes deleteAccount without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.DeleteAccountRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateAccount', () => {
        it('invokes updateAccount without error', async () => {
            ...
            request.account ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.UpdateAccountRequest', ['account', 'name']);
    ...
    describe('listAccounts', () => {
        it('invokes listAccounts without error', async () => {
            ...
            const request = generateSampleMessage(
              ...
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1.Account()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1.Account()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1.Account()),
            ];
        ...
        it('invokes listAccountsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.shopping.merchant.accounts.v1.Account) => {
    ...
    describe('listSubAccounts', () => {
        it('invokes listSubAccounts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.ListSubAccountsRequest', ['provider']);
