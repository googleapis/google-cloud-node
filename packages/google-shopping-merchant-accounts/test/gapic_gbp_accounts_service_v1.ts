  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          gbpaccountsserviceModule.v1.GbpAccountsServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          gbpaccountsserviceModule.v1.GbpAccountsServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new gbpaccountsserviceModule.v1.GbpAccountsServiceClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'merchantapi.example.com');
          if (saved) {
    ...
    it('invokes linkGbpAccount without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.linkGbpAccount(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1.ILinkGbpAccountResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listGbpAccounts without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.shopping.merchant.accounts.v1.GbpAccount(),
        ),
        generateSampleMessage(
          new protos.google.shopping.merchant.accounts.v1.GbpAccount(),
        ),
    ...
    it('invokes listGbpAccountsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.shopping.merchant.accounts.v1.GbpAccount,
          ) => {
