...
describe('v1.AutofeedSettingsServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new autofeedsettingsserviceModule.v1.AutofeedSettingsServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          autofeedsettingsserviceModule.v1.AutofeedSettingsServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        autofeedsettingsserviceModule.v1.AutofeedSettingsServiceClient.port;
      assert(port);
    ...
    it('invokes getAutofeedSettings without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getAutofeedSettings(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1.IAutofeedSettings | null,
          ) => {
            if (err) {
              reject(err);
            } else {
