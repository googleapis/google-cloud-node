...
describe('v1beta.BusinessInfoServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new businessinfoserviceModule.v1beta.BusinessInfoServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = businessinfoserviceModule.v1beta.BusinessInfoServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = businessinfoserviceModule.v1beta.BusinessInfoServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new businessinfoserviceModule.v1beta.BusinessInfoServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new businessinfoserviceModule.v1beta.BusinessInfoServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new businessinfoserviceModule.v1beta.BusinessInfoServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new businessinfoserviceModule.v1beta.BusinessInfoServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = businessinfoserviceModule.v1beta.BusinessInfoServiceClient.port;
            assert(port);
    ...
    describe('getBusinessInfo', () => {
        it('invokes getBusinessInfo without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.GetBusinessInfoRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.GetBusinessInfoRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getBusinessInfo as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getBusinessInfo as SinonStub)
        ...
        it('invokes getBusinessInfo without error using callback', async () => {
            ...
            client.innerApiCalls.getBusinessInfo = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getBusinessInfo(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1beta.IBusinessInfo|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getBusinessInfo with error', async () => {
            ...
            client.innerApiCalls.getBusinessInfo = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateBusinessInfo', () => {
        it('invokes updateBusinessInfo without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.UpdateBusinessInfoRequest()
            );
            request.businessInfo ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.UpdateBusinessInfoRequest', ['businessInfo', 'name']);
            request.businessInfo.name = defaultValue1;
            const expectedHeaderRequestParams = `business_info.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.BusinessInfo()
            );
            client.innerApiCalls.updateBusinessInfo = stubSimpleCall(expectedResponse);
            const [response] = await client.updateBusinessInfo(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateBusinessInfo as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateBusinessInfo as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateBusinessInfo without error using callback', async () => {
            ...
            client.innerApiCalls.updateBusinessInfo = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateBusinessInfo with error', async () => {
            ...
            const expectedHeaderRequestParams = `business_info.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateBusinessInfo = stubSimpleCall(undefined, expectedError);
