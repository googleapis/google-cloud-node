  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          businessinfoserviceModule.v1beta.BusinessInfoServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        businessinfoserviceModule.v1beta.BusinessInfoServiceClient.port;
      assert(port);
    ...
    it('invokes getBusinessInfo without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getBusinessInfo(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.accounts.v1beta.IBusinessInfo | null
          ) => {
            if (err) {
              reject(err);
            } else {
