 ...
 * `src/v1/terms_of_service_agreement_state_service_client_config.json`.
...
export class TermsOfServiceAgreementStateServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.shopping.merchant.accounts.v1.TermsOfServiceAgreementStateService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.termsOfServiceAgreementStateServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.shopping.merchant.accounts.v1.TermsOfServiceAgreementStateService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.shopping.merchant.accounts.v1.TermsOfServiceAgreementStateService,
 ...
 *   The first element of the array is an object representing {@link protos.google.shopping.merchant.accounts.v1.TermsOfServiceAgreementState|TermsOfServiceAgreementState}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/terms_of_service_agreement_state_service.get_terms_of_service_agreement_state.js</caption>
 * region_tag:merchantapi_v1_generated_TermsOfServiceAgreementStateService_GetTermsOfServiceAgreementState_async
 */
  getTermsOfServiceAgreementState(
      request?: protos.google.shopping.merchant.accounts.v1.IGetTermsOfServiceAgreementStateRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.ITermsOfServiceAgreementState,
        protos.google.shopping.merchant.accounts.v1.IGetTermsOfServiceAgreementStateRequest|undefined, {}|undefined
      ]>;
  getTermsOfServiceAgreementState(
      request: protos.google.shopping.merchant.accounts.v1.IGetTermsOfServiceAgreementStateRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1.ITermsOfServiceAgreementState,
          protos.google.shopping.merchant.accounts.v1.IGetTermsOfServiceAgreementStateRequest|null|undefined,
          {}|null|undefined>): void;
  getTermsOfServiceAgreementState(
      request: protos.google.shopping.merchant.accounts.v1.IGetTermsOfServiceAgreementStateRequest,
      callback: Callback<
  ...
  getTermsOfServiceAgreementState(
    ...
    return this.innerApiCalls.getTermsOfServiceAgreementState(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1.ITermsOfServiceAgreementState,
        protos.google.shopping.merchant.accounts.v1.IGetTermsOfServiceAgreementStateRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getTermsOfServiceAgreementState response %j', response);
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/terms_of_service_agreement_state_service.retrieve_for_application_terms_of_service_agreement_state.js</caption>
 * region_tag:merchantapi_v1_generated_TermsOfServiceAgreementStateService_RetrieveForApplicationTermsOfServiceAgreementState_async
 */
  retrieveForApplicationTermsOfServiceAgreementState(
      request?: protos.google.shopping.merchant.accounts.v1.IRetrieveForApplicationTermsOfServiceAgreementStateRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.ITermsOfServiceAgreementState,
        protos.google.shopping.merchant.accounts.v1.IRetrieveForApplicationTermsOfServiceAgreementStateRequest|undefined, {}|undefined
      ]>;
  retrieveForApplicationTermsOfServiceAgreementState(
      request: protos.google.shopping.merchant.accounts.v1.IRetrieveForApplicationTermsOfServiceAgreementStateRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1.ITermsOfServiceAgreementState,
          protos.google.shopping.merchant.accounts.v1.IRetrieveForApplicationTermsOfServiceAgreementStateRequest|null|undefined,
          {}|null|undefined>): void;
  retrieveForApplicationTermsOfServiceAgreementState(
      request: protos.google.shopping.merchant.accounts.v1.IRetrieveForApplicationTermsOfServiceAgreementStateRequest,
      callback: Callback<
  ...
  retrieveForApplicationTermsOfServiceAgreementState(
    ...
    return this.innerApiCalls.retrieveForApplicationTermsOfServiceAgreementState(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1.ITermsOfServiceAgreementState,
        protos.google.shopping.merchant.accounts.v1.IRetrieveForApplicationTermsOfServiceAgreementStateRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('retrieveForApplicationTermsOfServiceAgreementState response %j', response);
        return [response, options, rawResponse];
