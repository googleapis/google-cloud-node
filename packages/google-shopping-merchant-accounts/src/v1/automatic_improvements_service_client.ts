 ...
 * `src/v1/automatic_improvements_service_client_config.json`.
...
export class AutomaticImprovementsServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof AutomaticImprovementsServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.shopping.merchant.accounts.v1.AutomaticImprovementsService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    // google.shopping.merchant.accounts.v1.AutomaticImprovementsService.
    this.automaticImprovementsServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.shopping.merchant.accounts.v1.AutomaticImprovementsService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.shopping.merchant.accounts.v1.AutomaticImprovementsService,
 ...
 *   The first element of the array is an object representing {@link protos.google.shopping.merchant.accounts.v1.AutomaticImprovements|AutomaticImprovements}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/automatic_improvements_service.get_automatic_improvements.js</caption>
 * region_tag:merchantapi_v1_generated_AutomaticImprovementsService_GetAutomaticImprovements_async
 */
  getAutomaticImprovements(
      request?: protos.google.shopping.merchant.accounts.v1.IGetAutomaticImprovementsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.IAutomaticImprovements,
        protos.google.shopping.merchant.accounts.v1.IGetAutomaticImprovementsRequest|undefined, {}|undefined
      ]>;
  getAutomaticImprovements(
      request: protos.google.shopping.merchant.accounts.v1.IGetAutomaticImprovementsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1.IAutomaticImprovements,
          protos.google.shopping.merchant.accounts.v1.IGetAutomaticImprovementsRequest|null|undefined,
          {}|null|undefined>): void;
  getAutomaticImprovements(
      request: protos.google.shopping.merchant.accounts.v1.IGetAutomaticImprovementsRequest,
      callback: Callback<
  ...
  getAutomaticImprovements(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getAutomaticImprovements(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1.IAutomaticImprovements,
        protos.google.shopping.merchant.accounts.v1.IGetAutomaticImprovementsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getAutomaticImprovements response %j', response);
 ...
 * @param {Object} request
 *   The request object that will be sent.
 * @param {google.shopping.merchant.accounts.v1.AutomaticImprovements} request.automaticImprovements
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/automatic_improvements_service.update_automatic_improvements.js</caption>
 * region_tag:merchantapi_v1_generated_AutomaticImprovementsService_UpdateAutomaticImprovements_async
 */
  updateAutomaticImprovements(
      request?: protos.google.shopping.merchant.accounts.v1.IUpdateAutomaticImprovementsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.IAutomaticImprovements,
        protos.google.shopping.merchant.accounts.v1.IUpdateAutomaticImprovementsRequest|undefined, {}|undefined
      ]>;
  updateAutomaticImprovements(
      request: protos.google.shopping.merchant.accounts.v1.IUpdateAutomaticImprovementsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1.IAutomaticImprovements,
          protos.google.shopping.merchant.accounts.v1.IUpdateAutomaticImprovementsRequest|null|undefined,
          {}|null|undefined>): void;
  updateAutomaticImprovements(
      request: protos.google.shopping.merchant.accounts.v1.IUpdateAutomaticImprovementsRequest,
      callback: Callback<
  ...
  updateAutomaticImprovements(
    ...
    options.otherArgs.headers[
      ...
      'automatic_improvements.name': request.automaticImprovements!.name ?? '',
    });
    this.initialize().catch(err => {throw err});
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.updateAutomaticImprovements(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1.IAutomaticImprovements,
        protos.google.shopping.merchant.accounts.v1.IUpdateAutomaticImprovementsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('updateAutomaticImprovements response %j', response);
        return [response, options, rawResponse];
