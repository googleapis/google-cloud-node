...
export class RegionsServiceClient {
  ...
  getRegion(
    ...
    callback: Callback<
      protos.google.shopping.merchant.accounts.v1.IRegion,
      | protos.google.shopping.merchant.accounts.v1.IGetRegionRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  createRegion(
    ...
    [
      protos.google.shopping.merchant.accounts.v1.IRegion,
      (
        | protos.google.shopping.merchant.accounts.v1.ICreateRegionRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  batchCreateRegions(
    ...
    [
      ...
      (
        | protos.google.shopping.merchant.accounts.v1.IBatchCreateRegionsRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .batchCreateRegions(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.shopping.merchant.accounts.v1.IBatchCreateRegionsResponse,
          (
  ...
  updateRegion(
    ...
    [
      protos.google.shopping.merchant.accounts.v1.IRegion,
      (
        | protos.google.shopping.merchant.accounts.v1.IUpdateRegionRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  batchUpdateRegions(
    ...
    [
      ...
      (
        | protos.google.shopping.merchant.accounts.v1.IBatchUpdateRegionsRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .batchUpdateRegions(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.shopping.merchant.accounts.v1.IBatchUpdateRegionsResponse,
          (
  ...
  deleteRegion(
    ...
    [
      ...
      (
        | protos.google.shopping.merchant.accounts.v1.IDeleteRegionRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  batchDeleteRegions(
    ...
    [
      protos.google.protobuf.IEmpty,
      (
        | protos.google.shopping.merchant.accounts.v1.IBatchDeleteRegionsRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .batchDeleteRegions(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.protobuf.IEmpty,
          (
