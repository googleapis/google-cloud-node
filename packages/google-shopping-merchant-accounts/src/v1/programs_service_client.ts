 ...
 * `src/v1/programs_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './programs_service_client_config.json';
 ...
 * @memberof v1
 */
export class ProgramsServiceClient {
  ...
  programsServiceStub?: Promise<{[name: string]: Function}>;
   ...
   *     const client = new ProgramsServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof ProgramsServiceClient;
    ...
    this.descriptors.page = {
      listPrograms:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'programs')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.shopping.merchant.accounts.v1.ProgramsService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.programsServiceStub) {
      return this.programsServiceStub;
    }

    // Put together the "service stub" for
    // google.shopping.merchant.accounts.v1.ProgramsService.
    this.programsServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.shopping.merchant.accounts.v1.ProgramsService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.shopping.merchant.accounts.v1.ProgramsService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const programsServiceStubMethods =
        ['getProgram', 'listPrograms', 'enableProgram', 'disableProgram'];
    for (const methodName of programsServiceStubMethods) {
      const callPromise = this.programsServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.shopping.merchant.accounts.v1.Program|Program}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/programs_service.get_program.js</caption>
 * region_tag:merchantapi_v1_generated_ProgramsService_GetProgram_async
 */
  getProgram(
      request?: protos.google.shopping.merchant.accounts.v1.IGetProgramRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.IProgram,
        protos.google.shopping.merchant.accounts.v1.IGetProgramRequest|undefined, {}|undefined
      ]>;
  getProgram(
      request: protos.google.shopping.merchant.accounts.v1.IGetProgramRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1.IProgram,
          protos.google.shopping.merchant.accounts.v1.IGetProgramRequest|null|undefined,
          {}|null|undefined>): void;
  getProgram(
      request: protos.google.shopping.merchant.accounts.v1.IGetProgramRequest,
      callback: Callback<
  ...
  getProgram(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getProgram(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1.IProgram,
        protos.google.shopping.merchant.accounts.v1.IGetProgramRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getProgram response %j', response);
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/programs_service.enable_program.js</caption>
 * region_tag:merchantapi_v1_generated_ProgramsService_EnableProgram_async
 */
  enableProgram(
      request?: protos.google.shopping.merchant.accounts.v1.IEnableProgramRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.IProgram,
        protos.google.shopping.merchant.accounts.v1.IEnableProgramRequest|undefined, {}|undefined
      ]>;
  enableProgram(
      request: protos.google.shopping.merchant.accounts.v1.IEnableProgramRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1.IProgram,
          protos.google.shopping.merchant.accounts.v1.IEnableProgramRequest|null|undefined,
          {}|null|undefined>): void;
  enableProgram(
      request: protos.google.shopping.merchant.accounts.v1.IEnableProgramRequest,
      callback: Callback<
  ...
  enableProgram(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.enableProgram(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1.IProgram,
        protos.google.shopping.merchant.accounts.v1.IEnableProgramRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('enableProgram response %j', response);
        return [response, options, rawResponse];
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/programs_service.disable_program.js</caption>
 * region_tag:merchantapi_v1_generated_ProgramsService_DisableProgram_async
 */
  disableProgram(
      request?: protos.google.shopping.merchant.accounts.v1.IDisableProgramRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.IProgram,
        protos.google.shopping.merchant.accounts.v1.IDisableProgramRequest|undefined, {}|undefined
      ]>;
  disableProgram(
      request: protos.google.shopping.merchant.accounts.v1.IDisableProgramRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1.IProgram,
          protos.google.shopping.merchant.accounts.v1.IDisableProgramRequest|null|undefined,
          {}|null|undefined>): void;
  disableProgram(
      request: protos.google.shopping.merchant.accounts.v1.IDisableProgramRequest,
      callback: Callback<
  ...
  disableProgram(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.disableProgram(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1.IProgram,
        protos.google.shopping.merchant.accounts.v1.IDisableProgramRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('disableProgram response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.shopping.merchant.accounts.v1.Program|Program}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listProgramsAsync()`
 *   method described below for async iteration which you can stop as needed.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 */
  listPrograms(
      request?: protos.google.shopping.merchant.accounts.v1.IListProgramsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.IProgram[],
        protos.google.shopping.merchant.accounts.v1.IListProgramsRequest|null,
        protos.google.shopping.merchant.accounts.v1.IListProgramsResponse
      ]>;
  listPrograms(
      request: protos.google.shopping.merchant.accounts.v1.IListProgramsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.shopping.merchant.accounts.v1.IListProgramsRequest,
          protos.google.shopping.merchant.accounts.v1.IListProgramsResponse|null|undefined,
          protos.google.shopping.merchant.accounts.v1.IProgram>): void;
  listPrograms(
      request: protos.google.shopping.merchant.accounts.v1.IListProgramsRequest,
      callback: PaginationCallback<
          protos.google.shopping.merchant.accounts.v1.IListProgramsRequest,
  ...
  listPrograms(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.shopping.merchant.accounts.v1.IListProgramsRequest,
      protos.google.shopping.merchant.accounts.v1.IListProgramsResponse|null|undefined,
      protos.google.shopping.merchant.accounts.v1.IProgram>|undefined = callback
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.shopping.merchant.accounts.v1.Program|Program} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
...
/**
 * Equivalent to `listPrograms`, but returns an iterable object.
 *
 ...
 *   {@link protos.google.shopping.merchant.accounts.v1.Program|Program}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/programs_service.list_programs.js</caption>
 * region_tag:merchantapi_v1_generated_ProgramsService_ListPrograms_async
 */
  listProgramsAsync(
      request?: protos.google.shopping.merchant.accounts.v1.IListProgramsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.shopping.merchant.accounts.v1.IProgram>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listPrograms.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.shopping.merchant.accounts.v1.IProgram>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
