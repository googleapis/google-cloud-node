...
export class AccountRelationshipsServiceClient {
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof AccountRelationshipsServiceClient;
    if (
    ...
    this.descriptors.page = {
      listAccountRelationships: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
  ...
  getAccountRelationship(
    ...
    [
      ...
      (
        | protos.google.shopping.merchant.accounts.v1.IGetAccountRelationshipRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    return this.innerApiCalls
      .getAccountRelationship(request, options, wrappedCallback)
      ?.then(
  ...
  updateAccountRelationship(
    ...
    [
      protos.google.shopping.merchant.accounts.v1.IAccountRelationship,
      (
        | protos.google.shopping.merchant.accounts.v1.IUpdateAccountRelationshipRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .updateAccountRelationship(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.shopping.merchant.accounts.v1.IAccountRelationship,
          (
