 ...
 * `src/v1/account_relationships_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './account_relationships_service_client_config.json';
 ...
 * @memberof v1
 */
export class AccountRelationshipsServiceClient {
  ...
  accountRelationshipsServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of AccountRelationshipsServiceClient.
   *
   ...
   *     const client = new AccountRelationshipsServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof AccountRelationshipsServiceClient;
    ...
    this.descriptors.page = {
      listAccountRelationships:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'accountRelationships')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.shopping.merchant.accounts.v1.AccountRelationshipsService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.accountRelationshipsServiceStub) {
      return this.accountRelationshipsServiceStub;
    }

    // Put together the "service stub" for
    // google.shopping.merchant.accounts.v1.AccountRelationshipsService.
    this.accountRelationshipsServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.shopping.merchant.accounts.v1.AccountRelationshipsService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.shopping.merchant.accounts.v1.AccountRelationshipsService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const accountRelationshipsServiceStubMethods =
        ['getAccountRelationship', 'updateAccountRelationship', 'listAccountRelationships'];
    for (const methodName of accountRelationshipsServiceStubMethods) {
      const callPromise = this.accountRelationshipsServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.shopping.merchant.accounts.v1.AccountRelationship|AccountRelationship}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/account_relationships_service.get_account_relationship.js</caption>
 * region_tag:merchantapi_v1_generated_AccountRelationshipsService_GetAccountRelationship_async
 */
  getAccountRelationship(
      request?: protos.google.shopping.merchant.accounts.v1.IGetAccountRelationshipRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.IAccountRelationship,
        protos.google.shopping.merchant.accounts.v1.IGetAccountRelationshipRequest|undefined, {}|undefined
      ]>;
  getAccountRelationship(
      request: protos.google.shopping.merchant.accounts.v1.IGetAccountRelationshipRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1.IAccountRelationship,
          protos.google.shopping.merchant.accounts.v1.IGetAccountRelationshipRequest|null|undefined,
          {}|null|undefined>): void;
  getAccountRelationship(
      request: protos.google.shopping.merchant.accounts.v1.IGetAccountRelationshipRequest,
      callback: Callback<
  ...
  getAccountRelationship(
    ...
    this._log.info('getAccountRelationship request %j', request);
    const wrappedCallback: Callback<
        protos.google.shopping.merchant.accounts.v1.IAccountRelationship,
        protos.google.shopping.merchant.accounts.v1.IGetAccountRelationshipRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('getAccountRelationship response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.getAccountRelationship(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1.IAccountRelationship,
        protos.google.shopping.merchant.accounts.v1.IGetAccountRelationshipRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getAccountRelationship response %j', response);
 ...
 * @param {Object} request
 *   The request object that will be sent.
 * @param {google.shopping.merchant.accounts.v1.AccountRelationship} request.accountRelationship
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/account_relationships_service.update_account_relationship.js</caption>
 * region_tag:merchantapi_v1_generated_AccountRelationshipsService_UpdateAccountRelationship_async
 */
  updateAccountRelationship(
      request?: protos.google.shopping.merchant.accounts.v1.IUpdateAccountRelationshipRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.IAccountRelationship,
        protos.google.shopping.merchant.accounts.v1.IUpdateAccountRelationshipRequest|undefined, {}|undefined
      ]>;
  updateAccountRelationship(
      request: protos.google.shopping.merchant.accounts.v1.IUpdateAccountRelationshipRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1.IAccountRelationship,
          protos.google.shopping.merchant.accounts.v1.IUpdateAccountRelationshipRequest|null|undefined,
          {}|null|undefined>): void;
  updateAccountRelationship(
      request: protos.google.shopping.merchant.accounts.v1.IUpdateAccountRelationshipRequest,
      callback: Callback<
  ...
  updateAccountRelationship(
    ...
    options.otherArgs.headers[
      ...
      'account_relationship.name': request.accountRelationship!.name ?? '',
    });
    this.initialize().catch(err => {throw err});
    this._log.info('updateAccountRelationship request %j', request);
    const wrappedCallback: Callback<
        protos.google.shopping.merchant.accounts.v1.IAccountRelationship,
        protos.google.shopping.merchant.accounts.v1.IUpdateAccountRelationshipRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('updateAccountRelationship response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.updateAccountRelationship(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1.IAccountRelationship,
        protos.google.shopping.merchant.accounts.v1.IUpdateAccountRelationshipRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('updateAccountRelationship response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.shopping.merchant.accounts.v1.AccountRelationship|AccountRelationship}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listAccountRelationshipsAsync()`
 *   method described below for async iteration which you can stop as needed.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 */
  listAccountRelationships(
      request?: protos.google.shopping.merchant.accounts.v1.IListAccountRelationshipsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.IAccountRelationship[],
        protos.google.shopping.merchant.accounts.v1.IListAccountRelationshipsRequest|null,
        protos.google.shopping.merchant.accounts.v1.IListAccountRelationshipsResponse
      ]>;
  listAccountRelationships(
      request: protos.google.shopping.merchant.accounts.v1.IListAccountRelationshipsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.shopping.merchant.accounts.v1.IListAccountRelationshipsRequest,
          protos.google.shopping.merchant.accounts.v1.IListAccountRelationshipsResponse|null|undefined,
          protos.google.shopping.merchant.accounts.v1.IAccountRelationship>): void;
  listAccountRelationships(
      request: protos.google.shopping.merchant.accounts.v1.IListAccountRelationshipsRequest,
      callback: PaginationCallback<
          protos.google.shopping.merchant.accounts.v1.IListAccountRelationshipsRequest,
  ...
  listAccountRelationships(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.shopping.merchant.accounts.v1.IListAccountRelationshipsRequest,
      protos.google.shopping.merchant.accounts.v1.IListAccountRelationshipsResponse|null|undefined,
      protos.google.shopping.merchant.accounts.v1.IAccountRelationship>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listAccountRelationships values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listAccountRelationships request %j', request);
    return this.innerApiCalls
      .listAccountRelationships(request, options, wrappedCallback)
      ?.then(([response, input, output]: [
        protos.google.shopping.merchant.accounts.v1.IAccountRelationship[],
        protos.google.shopping.merchant.accounts.v1.IListAccountRelationshipsRequest|null,
        protos.google.shopping.merchant.accounts.v1.IListAccountRelationshipsResponse
      ]) => {
        this._log.info('listAccountRelationships values %j', response);
        return [response, input, output];
      });
  }

/**
 * Equivalent to `listAccountRelationships`, but returns a NodeJS Stream object.
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 *   Required. The parent account of the account relationship to filter by.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.shopping.merchant.accounts.v1.AccountRelationship|AccountRelationship} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   for more details and examples.
 */
  listAccountRelationshipsStream(
      request?: protos.google.shopping.merchant.accounts.v1.IListAccountRelationshipsRequest,
      options?: CallOptions):
    Transform{
    request = request || {};
    ...
    const defaultCallSettings = this._defaults['listAccountRelationships'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listAccountRelationships stream %j', request);
    return this.descriptors.page.listAccountRelationships.createStream(
      this.innerApiCalls.listAccountRelationships as GaxCall,
      request,
      callSettings
    );
  }
...
/**
 * Equivalent to `listAccountRelationships`, but returns an iterable object.
 *
 ...
 *   {@link protos.google.shopping.merchant.accounts.v1.AccountRelationship|AccountRelationship}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/account_relationships_service.list_account_relationships.js</caption>
 * region_tag:merchantapi_v1_generated_AccountRelationshipsService_ListAccountRelationships_async
 */
  listAccountRelationshipsAsync(
      request?: protos.google.shopping.merchant.accounts.v1.IListAccountRelationshipsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.shopping.merchant.accounts.v1.IAccountRelationship>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listAccountRelationships iterate %j', request);
    return this.descriptors.page.listAccountRelationships.asyncIterate(
      this.innerApiCalls['listAccountRelationships'] as GaxCall,
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.shopping.merchant.accounts.v1.IAccountRelationship>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.accountRelationshipsServiceStub && !this._terminated) {
      return this.accountRelationshipsServiceStub.then(stub => {
