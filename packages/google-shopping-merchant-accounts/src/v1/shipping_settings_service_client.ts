...
export class ShippingSettingsServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.shopping.merchant.accounts.v1.ShippingSettingsService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.shippingSettingsServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.shopping.merchant.accounts.v1.ShippingSettingsService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.shopping.merchant.accounts.v1.ShippingSettingsService,
 ...
 */
  getShippingSettings(
      request?: protos.google.shopping.merchant.accounts.v1.IGetShippingSettingsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.IShippingSettings,
        protos.google.shopping.merchant.accounts.v1.IGetShippingSettingsRequest|undefined, {}|undefined
      ]>;
  getShippingSettings(
      request: protos.google.shopping.merchant.accounts.v1.IGetShippingSettingsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1.IShippingSettings,
          protos.google.shopping.merchant.accounts.v1.IGetShippingSettingsRequest|null|undefined,
          {}|null|undefined>): void;
  getShippingSettings(
      request: protos.google.shopping.merchant.accounts.v1.IGetShippingSettingsRequest,
      callback: Callback<
 ...
 */
  insertShippingSettings(
      request?: protos.google.shopping.merchant.accounts.v1.IInsertShippingSettingsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.IShippingSettings,
        protos.google.shopping.merchant.accounts.v1.IInsertShippingSettingsRequest|undefined, {}|undefined
      ]>;
  insertShippingSettings(
      request: protos.google.shopping.merchant.accounts.v1.IInsertShippingSettingsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1.IShippingSettings,
          protos.google.shopping.merchant.accounts.v1.IInsertShippingSettingsRequest|null|undefined,
          {}|null|undefined>): void;
  insertShippingSettings(
      request: protos.google.shopping.merchant.accounts.v1.IInsertShippingSettingsRequest,
      callback: Callback<
