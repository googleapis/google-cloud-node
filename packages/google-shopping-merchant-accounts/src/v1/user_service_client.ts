...
export class UserServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.shopping.merchant.accounts.v1.UserService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.userServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.shopping.merchant.accounts.v1.UserService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.shopping.merchant.accounts.v1.UserService,
 ...
 * region_tag:merchantapi_v1_generated_UserService_GetUser_async
 */
  getUser(
      request?: protos.google.shopping.merchant.accounts.v1.IGetUserRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.IUser,
        protos.google.shopping.merchant.accounts.v1.IGetUserRequest|undefined, {}|undefined
      ]>;
  getUser(
      request: protos.google.shopping.merchant.accounts.v1.IGetUserRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1.IUser,
          protos.google.shopping.merchant.accounts.v1.IGetUserRequest|null|undefined,
          {}|null|undefined>): void;
  getUser(
      request: protos.google.shopping.merchant.accounts.v1.IGetUserRequest,
      callback: Callback<
  ...
  getUser(
    ...
    return this.innerApiCalls.getUser(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1.IUser,
        protos.google.shopping.merchant.accounts.v1.IGetUserRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getUser response %j', response);
 ...
 *   `john.doe@gmail.com`).
 * @param {google.shopping.merchant.accounts.v1.User} [request.user]
 ...
 * region_tag:merchantapi_v1_generated_UserService_CreateUser_async
 */
  createUser(
      request?: protos.google.shopping.merchant.accounts.v1.ICreateUserRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.IUser,
        protos.google.shopping.merchant.accounts.v1.ICreateUserRequest|undefined, {}|undefined
      ]>;
  createUser(
      request: protos.google.shopping.merchant.accounts.v1.ICreateUserRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1.IUser,
          protos.google.shopping.merchant.accounts.v1.ICreateUserRequest|null|undefined,
          {}|null|undefined>): void;
  createUser(
      request: protos.google.shopping.merchant.accounts.v1.ICreateUserRequest,
      callback: Callback<
  ...
  createUser(
    ...
    return this.innerApiCalls.createUser(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1.IUser,
        protos.google.shopping.merchant.accounts.v1.ICreateUserRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('createUser response %j', response);
        return [response, options, rawResponse];
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/user_service.delete_user.js</caption>
 * region_tag:merchantapi_v1_generated_UserService_DeleteUser_async
 */
  deleteUser(
      request?: protos.google.shopping.merchant.accounts.v1.IDeleteUserRequest,
      options?: CallOptions):
      Promise<[
        protos.google.protobuf.IEmpty,
        protos.google.shopping.merchant.accounts.v1.IDeleteUserRequest|undefined, {}|undefined
      ]>;
  deleteUser(
      request: protos.google.shopping.merchant.accounts.v1.IDeleteUserRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.protobuf.IEmpty,
          protos.google.shopping.merchant.accounts.v1.IDeleteUserRequest|null|undefined,
          {}|null|undefined>): void;
  deleteUser(
      request: protos.google.shopping.merchant.accounts.v1.IDeleteUserRequest,
      callback: Callback<
  ...
  deleteUser(
    ...
    return this.innerApiCalls.deleteUser(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.protobuf.IEmpty,
        protos.google.shopping.merchant.accounts.v1.IDeleteUserRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('deleteUser response %j', response);
        return [response, options, rawResponse];
 ...
 * region_tag:merchantapi_v1_generated_UserService_UpdateUser_async
 */
  updateUser(
      request?: protos.google.shopping.merchant.accounts.v1.IUpdateUserRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.IUser,
        protos.google.shopping.merchant.accounts.v1.IUpdateUserRequest|undefined, {}|undefined
      ]>;
  updateUser(
      request: protos.google.shopping.merchant.accounts.v1.IUpdateUserRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1.IUser,
          protos.google.shopping.merchant.accounts.v1.IUpdateUserRequest|null|undefined,
          {}|null|undefined>): void;
  updateUser(
      request: protos.google.shopping.merchant.accounts.v1.IUpdateUserRequest,
      callback: Callback<
  ...
  updateUser(
    ...
    return this.innerApiCalls.updateUser(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1.IUser,
        protos.google.shopping.merchant.accounts.v1.IUpdateUserRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('updateUser response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.shopping.merchant.accounts.v1.User|User}.
 ...
 */
  listUsers(
      request?: protos.google.shopping.merchant.accounts.v1.IListUsersRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.IUser[],
        protos.google.shopping.merchant.accounts.v1.IListUsersRequest|null,
        protos.google.shopping.merchant.accounts.v1.IListUsersResponse
      ]>;
  listUsers(
      request: protos.google.shopping.merchant.accounts.v1.IListUsersRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.shopping.merchant.accounts.v1.IListUsersRequest,
          protos.google.shopping.merchant.accounts.v1.IListUsersResponse|null|undefined,
          protos.google.shopping.merchant.accounts.v1.IUser>): void;
  listUsers(
      request: protos.google.shopping.merchant.accounts.v1.IListUsersRequest,
      callback: PaginationCallback<
          protos.google.shopping.merchant.accounts.v1.IListUsersRequest,
  ...
  listUsers(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.shopping.merchant.accounts.v1.IListUsersRequest,
      protos.google.shopping.merchant.accounts.v1.IListUsersResponse|null|undefined,
      protos.google.shopping.merchant.accounts.v1.IUser>|undefined = callback
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.shopping.merchant.accounts.v1.User|User} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   {@link protos.google.shopping.merchant.accounts.v1.User|User}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/user_service.list_users.js</caption>
 * region_tag:merchantapi_v1_generated_UserService_ListUsers_async
 */
  listUsersAsync(
      request?: protos.google.shopping.merchant.accounts.v1.IListUsersRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.shopping.merchant.accounts.v1.IUser>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listUsers.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.shopping.merchant.accounts.v1.IUser>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
