...
export class CheckoutSettingsServiceClient {
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof CheckoutSettingsServiceClient;
    if (
  ...
  getCheckoutSettings(
    ...
    [
      ...
      (
        | protos.google.shopping.merchant.accounts.v1.IGetCheckoutSettingsRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    return this.innerApiCalls
      .getCheckoutSettings(request, options, wrappedCallback)
      ?.then(
  ...
  createCheckoutSettings(
    ...
    [
      protos.google.shopping.merchant.accounts.v1.ICheckoutSettings,
      (
        | protos.google.shopping.merchant.accounts.v1.ICreateCheckoutSettingsRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .createCheckoutSettings(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.shopping.merchant.accounts.v1.ICheckoutSettings,
          (
  ...
  updateCheckoutSettings(
    ...
    [
      protos.google.shopping.merchant.accounts.v1.ICheckoutSettings,
      (
        | protos.google.shopping.merchant.accounts.v1.IUpdateCheckoutSettingsRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .updateCheckoutSettings(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.shopping.merchant.accounts.v1.ICheckoutSettings,
          (
  ...
  deleteCheckoutSettings(
    ...
    [
      ...
      (
        | protos.google.shopping.merchant.accounts.v1.IDeleteCheckoutSettingsRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .deleteCheckoutSettings(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.protobuf.IEmpty,
          (
