 ...
 * `src/v1/checkout_settings_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './checkout_settings_service_client_config.json';
 ...
 * @memberof v1
 */
export class CheckoutSettingsServiceClient {
   ...
   *     const client = new CheckoutSettingsServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof CheckoutSettingsServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.shopping.merchant.accounts.v1.CheckoutSettingsService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.checkoutSettingsServiceStub) {
      return this.checkoutSettingsServiceStub;
    }

    // Put together the "service stub" for
    // google.shopping.merchant.accounts.v1.CheckoutSettingsService.
    this.checkoutSettingsServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.shopping.merchant.accounts.v1.CheckoutSettingsService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.shopping.merchant.accounts.v1.CheckoutSettingsService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const checkoutSettingsServiceStubMethods =
        ['getCheckoutSettings', 'createCheckoutSettings', 'updateCheckoutSettings', 'deleteCheckoutSettings'];
 ...
 *   The first element of the array is an object representing {@link protos.google.shopping.merchant.accounts.v1.CheckoutSettings|CheckoutSettings}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/checkout_settings_service.get_checkout_settings.js</caption>
 * region_tag:merchantapi_v1_generated_CheckoutSettingsService_GetCheckoutSettings_async
 */
  getCheckoutSettings(
      request?: protos.google.shopping.merchant.accounts.v1.IGetCheckoutSettingsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.ICheckoutSettings,
        protos.google.shopping.merchant.accounts.v1.IGetCheckoutSettingsRequest|undefined, {}|undefined
      ]>;
  getCheckoutSettings(
      request: protos.google.shopping.merchant.accounts.v1.IGetCheckoutSettingsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1.ICheckoutSettings,
          protos.google.shopping.merchant.accounts.v1.IGetCheckoutSettingsRequest|null|undefined,
          {}|null|undefined>): void;
  getCheckoutSettings(
      request: protos.google.shopping.merchant.accounts.v1.IGetCheckoutSettingsRequest,
      callback: Callback<
  ...
  getCheckoutSettings(
    ...
    const wrappedCallback: Callback<
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('getCheckoutSettings response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.getCheckoutSettings(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1.ICheckoutSettings,
        protos.google.shopping.merchant.accounts.v1.IGetCheckoutSettingsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getCheckoutSettings response %j', response);
 ...
 *   created.
 * @param {google.shopping.merchant.accounts.v1.CheckoutSettings} request.checkoutSettings
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/checkout_settings_service.create_checkout_settings.js</caption>
 * region_tag:merchantapi_v1_generated_CheckoutSettingsService_CreateCheckoutSettings_async
 */
  createCheckoutSettings(
      request?: protos.google.shopping.merchant.accounts.v1.ICreateCheckoutSettingsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.ICheckoutSettings,
        protos.google.shopping.merchant.accounts.v1.ICreateCheckoutSettingsRequest|undefined, {}|undefined
      ]>;
  createCheckoutSettings(
      request: protos.google.shopping.merchant.accounts.v1.ICreateCheckoutSettingsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1.ICheckoutSettings,
          protos.google.shopping.merchant.accounts.v1.ICreateCheckoutSettingsRequest|null|undefined,
          {}|null|undefined>): void;
  createCheckoutSettings(
      request: protos.google.shopping.merchant.accounts.v1.ICreateCheckoutSettingsRequest,
      callback: Callback<
  ...
  createCheckoutSettings(
    ...
    const wrappedCallback: Callback<
        ...
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('createCheckoutSettings response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.createCheckoutSettings(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1.ICheckoutSettings,
        protos.google.shopping.merchant.accounts.v1.ICreateCheckoutSettingsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('createCheckoutSettings response %j', response);
        return [response, options, rawResponse];
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/checkout_settings_service.update_checkout_settings.js</caption>
 * region_tag:merchantapi_v1_generated_CheckoutSettingsService_UpdateCheckoutSettings_async
 */
  updateCheckoutSettings(
      request?: protos.google.shopping.merchant.accounts.v1.IUpdateCheckoutSettingsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.ICheckoutSettings,
        protos.google.shopping.merchant.accounts.v1.IUpdateCheckoutSettingsRequest|undefined, {}|undefined
      ]>;
  updateCheckoutSettings(
      request: protos.google.shopping.merchant.accounts.v1.IUpdateCheckoutSettingsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1.ICheckoutSettings,
          protos.google.shopping.merchant.accounts.v1.IUpdateCheckoutSettingsRequest|null|undefined,
          {}|null|undefined>): void;
  updateCheckoutSettings(
      request: protos.google.shopping.merchant.accounts.v1.IUpdateCheckoutSettingsRequest,
      callback: Callback<
  ...
  updateCheckoutSettings(
    ...
    const wrappedCallback: Callback<
        ...
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('updateCheckoutSettings response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.updateCheckoutSettings(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1.ICheckoutSettings,
        protos.google.shopping.merchant.accounts.v1.IUpdateCheckoutSettingsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('updateCheckoutSettings response %j', response);
        return [response, options, rawResponse];
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/checkout_settings_service.delete_checkout_settings.js</caption>
 * region_tag:merchantapi_v1_generated_CheckoutSettingsService_DeleteCheckoutSettings_async
 */
  deleteCheckoutSettings(
      request?: protos.google.shopping.merchant.accounts.v1.IDeleteCheckoutSettingsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.protobuf.IEmpty,
        protos.google.shopping.merchant.accounts.v1.IDeleteCheckoutSettingsRequest|undefined, {}|undefined
      ]>;
  deleteCheckoutSettings(
      request: protos.google.shopping.merchant.accounts.v1.IDeleteCheckoutSettingsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.protobuf.IEmpty,
          protos.google.shopping.merchant.accounts.v1.IDeleteCheckoutSettingsRequest|null|undefined,
          {}|null|undefined>): void;
  deleteCheckoutSettings(
      request: protos.google.shopping.merchant.accounts.v1.IDeleteCheckoutSettingsRequest,
      callback: Callback<
  ...
  deleteCheckoutSettings(
    ...
    const wrappedCallback: Callback<
        ...
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('deleteCheckoutSettings response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.deleteCheckoutSettings(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.protobuf.IEmpty,
        protos.google.shopping.merchant.accounts.v1.IDeleteCheckoutSettingsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('deleteCheckoutSettings response %j', response);
        return [response, options, rawResponse];
