...
export class BusinessIdentityServiceClient {
  ...
  getBusinessIdentity(
    ...
    [
      ...
      (
        | protos.google.shopping.merchant.accounts.v1.IGetBusinessIdentityRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  updateBusinessIdentity(
    ...
    [
      protos.google.shopping.merchant.accounts.v1.IBusinessIdentity,
      (
        | protos.google.shopping.merchant.accounts.v1.IUpdateBusinessIdentityRequest
        | undefined
      ),
      {} | undefined,
    ]
    ...
    options.otherArgs.headers['x-goog-request-params'] =
      this._gaxModule.routingHeader.fromParams({
        'business_identity.name':
          request.businessIdentity!.name?.toString() ?? '',
      });
    this.initialize().catch((err) => {
      throw err;
    });
