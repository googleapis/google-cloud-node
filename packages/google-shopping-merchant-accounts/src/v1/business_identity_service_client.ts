 ...
 * `src/v1/business_identity_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './business_identity_service_client_config.json';
 ...
 * @memberof v1
 */
export class BusinessIdentityServiceClient {
  ...
  businessIdentityServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of BusinessIdentityServiceClient.
   *
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.shopping.merchant.accounts.v1.BusinessIdentityService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.businessIdentityServiceStub) {
      return this.businessIdentityServiceStub;
    }
    ...
    this.businessIdentityServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.shopping.merchant.accounts.v1.BusinessIdentityService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.shopping.merchant.accounts.v1.BusinessIdentityService,
 ...
 *   The first element of the array is an object representing {@link protos.google.shopping.merchant.accounts.v1.BusinessIdentity|BusinessIdentity}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/business_identity_service.get_business_identity.js</caption>
 * region_tag:merchantapi_v1_generated_BusinessIdentityService_GetBusinessIdentity_async
 */
  getBusinessIdentity(
      request?: protos.google.shopping.merchant.accounts.v1.IGetBusinessIdentityRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.IBusinessIdentity,
        protos.google.shopping.merchant.accounts.v1.IGetBusinessIdentityRequest|undefined, {}|undefined
      ]>;
  getBusinessIdentity(
      request: protos.google.shopping.merchant.accounts.v1.IGetBusinessIdentityRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1.IBusinessIdentity,
          protos.google.shopping.merchant.accounts.v1.IGetBusinessIdentityRequest|null|undefined,
          {}|null|undefined>): void;
  getBusinessIdentity(
      request: protos.google.shopping.merchant.accounts.v1.IGetBusinessIdentityRequest,
      callback: Callback<
  ...
  getBusinessIdentity(
    ...
    return this.innerApiCalls.getBusinessIdentity(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1.IBusinessIdentity,
        protos.google.shopping.merchant.accounts.v1.IGetBusinessIdentityRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getBusinessIdentity response %j', response);
 ...
 * @param {Object} request
 *   The request object that will be sent.
 * @param {google.shopping.merchant.accounts.v1.BusinessIdentity} request.businessIdentity
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/business_identity_service.update_business_identity.js</caption>
 * region_tag:merchantapi_v1_generated_BusinessIdentityService_UpdateBusinessIdentity_async
 */
  updateBusinessIdentity(
      request?: protos.google.shopping.merchant.accounts.v1.IUpdateBusinessIdentityRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.IBusinessIdentity,
        protos.google.shopping.merchant.accounts.v1.IUpdateBusinessIdentityRequest|undefined, {}|undefined
      ]>;
  updateBusinessIdentity(
      request: protos.google.shopping.merchant.accounts.v1.IUpdateBusinessIdentityRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1.IBusinessIdentity,
          protos.google.shopping.merchant.accounts.v1.IUpdateBusinessIdentityRequest|null|undefined,
          {}|null|undefined>): void;
  updateBusinessIdentity(
      request: protos.google.shopping.merchant.accounts.v1.IUpdateBusinessIdentityRequest,
      callback: Callback<
  ...
  updateBusinessIdentity(
    ...
    return this.innerApiCalls.updateBusinessIdentity(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1.IBusinessIdentity,
        protos.google.shopping.merchant.accounts.v1.IUpdateBusinessIdentityRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('updateBusinessIdentity response %j', response);
        return [response, options, rawResponse];
   ...
   */
  close(): Promise<void> {
    if (this.businessIdentityServiceStub && !this._terminated) {
      return this.businessIdentityServiceStub.then(stub => {
