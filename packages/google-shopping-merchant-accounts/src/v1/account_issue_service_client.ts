...
export class AccountIssueServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.shopping.merchant.accounts.v1.AccountIssueService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.accountIssueServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.shopping.merchant.accounts.v1.AccountIssueService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.shopping.merchant.accounts.v1.AccountIssueService,
 ...
 */
  ...
  listAccountIssues(
      ...
      callback: PaginationCallback<
          ...
          protos.google.shopping.merchant.accounts.v1.IListAccountIssuesResponse|null|undefined,
          protos.google.shopping.merchant.accounts.v1.IAccountIssue>): void;
  listAccountIssues(
      request: protos.google.shopping.merchant.accounts.v1.IListAccountIssuesRequest,
      callback: PaginationCallback<
          protos.google.shopping.merchant.accounts.v1.IListAccountIssuesRequest,
  ...
  listAccountIssues(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.shopping.merchant.accounts.v1.IListAccountIssuesRequest,
      protos.google.shopping.merchant.accounts.v1.IListAccountIssuesResponse|null|undefined,
      protos.google.shopping.merchant.accounts.v1.IAccountIssue>|undefined = callback
