...
export class AccountIssueServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this.descriptors.page = {
      listAccountIssues:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'accountIssues')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.shopping.merchant.accounts.v1beta.AccountIssueService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.accountIssueServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.shopping.merchant.accounts.v1beta.AccountIssueService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.shopping.merchant.accounts.v1beta.AccountIssueService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const accountIssueServiceStubMethods =
        ['listAccountIssues'];
 ...
 */
  ...
  listAccountIssues(
      ...
      callback: PaginationCallback<
          ...
          protos.google.shopping.merchant.accounts.v1beta.IListAccountIssuesResponse|null|undefined,
          protos.google.shopping.merchant.accounts.v1beta.IAccountIssue>): void;
  listAccountIssues(
      request: protos.google.shopping.merchant.accounts.v1beta.IListAccountIssuesRequest,
      callback: PaginationCallback<
          protos.google.shopping.merchant.accounts.v1beta.IListAccountIssuesRequest,
  ...
  listAccountIssues(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.shopping.merchant.accounts.v1beta.IListAccountIssuesRequest,
      protos.google.shopping.merchant.accounts.v1beta.IListAccountIssuesResponse|null|undefined,
      protos.google.shopping.merchant.accounts.v1beta.IAccountIssue>|undefined = callback
