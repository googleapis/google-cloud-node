...
export class BusinessInfoServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.shopping.merchant.accounts.v1beta.BusinessInfoService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.businessInfoServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.shopping.merchant.accounts.v1beta.BusinessInfoService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.shopping.merchant.accounts.v1beta.BusinessInfoService,
 ...
 */
  getBusinessInfo(
      ...
      Promise<[
        ...
        protos.google.shopping.merchant.accounts.v1beta.IGetBusinessInfoRequest|undefined, {}|undefined
      ]>;
  getBusinessInfo(
      request: protos.google.shopping.merchant.accounts.v1beta.IGetBusinessInfoRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1beta.IBusinessInfo,
          protos.google.shopping.merchant.accounts.v1beta.IGetBusinessInfoRequest|null|undefined,
          {}|null|undefined>): void;
  getBusinessInfo(
      request: protos.google.shopping.merchant.accounts.v1beta.IGetBusinessInfoRequest,
      callback: Callback<
  ...
  getBusinessInfo(
    ...
    return this.innerApiCalls.getBusinessInfo(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1beta.IBusinessInfo,
        protos.google.shopping.merchant.accounts.v1beta.IGetBusinessInfoRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getBusinessInfo response %j', response);
 ...
 */
  updateBusinessInfo(
      ...
      Promise<[
        protos.google.shopping.merchant.accounts.v1beta.IBusinessInfo,
        protos.google.shopping.merchant.accounts.v1beta.IUpdateBusinessInfoRequest|undefined, {}|undefined
      ]>;
  updateBusinessInfo(
      request: protos.google.shopping.merchant.accounts.v1beta.IUpdateBusinessInfoRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1beta.IBusinessInfo,
          protos.google.shopping.merchant.accounts.v1beta.IUpdateBusinessInfoRequest|null|undefined,
          {}|null|undefined>): void;
  updateBusinessInfo(
      request: protos.google.shopping.merchant.accounts.v1beta.IUpdateBusinessInfoRequest,
      callback: Callback<
  ...
  updateBusinessInfo(
    ...
    return this.innerApiCalls.updateBusinessInfo(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1beta.IBusinessInfo,
        protos.google.shopping.merchant.accounts.v1beta.IUpdateBusinessInfoRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('updateBusinessInfo response %j', response);
        return [response, options, rawResponse];
