 ...
 * `src/v1beta/business_identity_service_client_config.json`.
...
export class BusinessIdentityServiceClient {
  ...
  > | void {
    ...
    this.initialize();
    return this.innerApiCalls.getBusinessIdentity(request, options, callback);
  }
  /**
  ...
  > | void {
    ...
    this.initialize();
    return this.innerApiCalls.updateBusinessIdentity(
      request,
      options,
      callback
    );
