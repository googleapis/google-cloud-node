 ...
 */
  ...
  getShippingSettings(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getShippingSettings(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1beta.IShippingSettings,
        protos.google.shopping.merchant.accounts.v1beta.IGetShippingSettingsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getShippingSettings response %j', response);
 ...
 */
  ...
  insertShippingSettings(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.insertShippingSettings(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1beta.IShippingSettings,
        protos.google.shopping.merchant.accounts.v1beta.IInsertShippingSettingsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('insertShippingSettings response %j', response);
        return [response, options, rawResponse];
