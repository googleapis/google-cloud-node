 ...
 * `src/v1beta/user_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './user_service_client_config.json';
...
export class UserServiceClient {
  ...
  userServiceStub?: Promise<{[name: string]: Function}>;
  ...
  listUsersAsync(
    ...
    return this.descriptors.page.listUsers.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.shopping.merchant.accounts.v1beta.IUser>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
