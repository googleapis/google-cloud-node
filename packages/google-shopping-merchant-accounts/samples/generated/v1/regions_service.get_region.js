...
function main(name) {
  // [START merchantapi_v1_generated_RegionsService_GetRegion_async]
  /**
  ...
  async function callGetRegion() {
    ...
    // Run request
    const response = await accountsClient.getRegion(request);
    console.log(response);
  }

  callGetRegion();
  // [END merchantapi_v1_generated_RegionsService_GetRegion_async]
}
