...
function main(checkoutSettings, updateMask) {
  // [START merchantapi_v1_generated_CheckoutSettingsService_UpdateCheckoutSettings_async]
  /**
  ...
  async function callUpdateCheckoutSettings() {
    // Construct request
    const request = {
      checkoutSettings,
      updateMask,
    ...
    // Run request
    const response = await accountsClient.updateCheckoutSettings(request);
    console.log(response);
  }

  callUpdateCheckoutSettings();
