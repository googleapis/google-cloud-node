...
function main(name) {
  // [START merchantapi_v1_generated_HomepageService_ClaimHomepage_async]
  /**
  ...
  async function callClaimHomepage() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await accountsClient.claimHomepage(request);
