...
function main(name) {
  // [START merchantapi_v1_generated_AccountRelationshipsService_GetAccountRelationship_async]
  /**
  ...
  async function callGetAccountRelationship() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await accountsClient.getAccountRelationship(request);
    console.log(response);
  }

  callGetAccountRelationship();
  // [END merchantapi_v1_generated_AccountRelationshipsService_GetAccountRelationship_async]
}
