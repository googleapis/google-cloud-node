...
function main(parent, requests) {
  // [START merchantapi_v1_generated_RegionsService_BatchCreateRegions_async]
  /**
  ...
  async function callBatchCreateRegions() {
    // Construct request
    const request = {
      parent,
      requests,
    ...
    // Run request
    const response = await accountsClient.batchCreateRegions(request);
    console.log(response);
  }

  callBatchCreateRegions();
  // [END merchantapi_v1_generated_RegionsService_BatchCreateRegions_async]
}
