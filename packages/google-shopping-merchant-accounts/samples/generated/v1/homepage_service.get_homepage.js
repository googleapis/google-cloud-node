...
function main(name) {
  // [START merchantapi_v1_generated_HomepageService_GetHomepage_async]
  /**
  ...
  async function callGetHomepage() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await accountsClient.getHomepage(request);
    console.log(response);
  }

  callGetHomepage();
  // [END merchantapi_v1_generated_HomepageService_GetHomepage_async]
}
