...
function main(parent) {
  // [START merchantapi_v1beta_generated_OnlineReturnPolicyService_ListOnlineReturnPolicies_async]
  /**
  ...
  async function callListOnlineReturnPolicies() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = accountsClient.listOnlineReturnPoliciesAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListOnlineReturnPolicies();
  // [END merchantapi_v1beta_generated_OnlineReturnPolicyService_ListOnlineReturnPolicies_async]
}
