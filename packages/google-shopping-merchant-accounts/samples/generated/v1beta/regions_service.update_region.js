...
function main(region) {
  // [START merchantapi_v1beta_generated_RegionsService_UpdateRegion_async]
  /**
  ...
  async function callUpdateRegion() {
    // Construct request
    const request = {
      region,
    };
    ...
    // Run request
    const response = await accountsClient.updateRegion(request);
    console.log(response);
  }

  callUpdateRegion();
  // [END merchantapi_v1beta_generated_RegionsService_UpdateRegion_async]
}
