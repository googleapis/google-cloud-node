...
function main(parent) {
  // [START merchantapi_v1beta_generated_AccountIssueService_ListAccountIssues_async]
  /**
  ...
  async function callListAccountIssues() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = accountsClient.listAccountIssuesAsync(request);
  ...
  // [END merchantapi_v1beta_generated_AccountIssueService_ListAccountIssues_async]
}
