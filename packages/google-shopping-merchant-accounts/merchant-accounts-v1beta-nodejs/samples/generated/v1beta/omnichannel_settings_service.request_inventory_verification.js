...
function main(name) {
  ...
  async function callRequestInventoryVerification() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await accountsClient.requestInventoryVerification(request);
    console.log(response);
  }

  callRequestInventoryVerification();
