...
describe('v1beta.AccountIssueServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new accountissueserviceModule.v1beta.AccountIssueServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = accountissueserviceModule.v1beta.AccountIssueServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = accountissueserviceModule.v1beta.AccountIssueServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new accountissueserviceModule.v1beta.AccountIssueServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new accountissueserviceModule.v1beta.AccountIssueServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new accountissueserviceModule.v1beta.AccountIssueServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new accountissueserviceModule.v1beta.AccountIssueServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = accountissueserviceModule.v1beta.AccountIssueServiceClient.port;
            assert(port);
    ...
    describe('listAccountIssues', () => {
        it('invokes listAccountIssues without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.ListAccountIssuesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.ListAccountIssuesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1beta.AccountIssue()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1beta.AccountIssue()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1beta.AccountIssue()),
            ];
        ...
        it('invokes listAccountIssues without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listAccountIssues(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1beta.IAccountIssue[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listAccountIssuesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.shopping.merchant.accounts.v1beta.AccountIssue[] = [];
                stream.on('data', (response: protos.google.shopping.merchant.accounts.v1beta.AccountIssue) => {
        ...
        it('uses async iteration with listAccountIssues without error', async () => {
            ...
            const responses: protos.google.shopping.merchant.accounts.v1beta.IAccountIssue[] = [];
