...
describe('v1beta.AutofeedSettingsServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new autofeedsettingsserviceModule.v1beta.AutofeedSettingsServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = autofeedsettingsserviceModule.v1beta.AutofeedSettingsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = autofeedsettingsserviceModule.v1beta.AutofeedSettingsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new autofeedsettingsserviceModule.v1beta.AutofeedSettingsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new autofeedsettingsserviceModule.v1beta.AutofeedSettingsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new autofeedsettingsserviceModule.v1beta.AutofeedSettingsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new autofeedsettingsserviceModule.v1beta.AutofeedSettingsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = autofeedsettingsserviceModule.v1beta.AutofeedSettingsServiceClient.port;
            assert(port);
    ...
    describe('getAutofeedSettings', () => {
        it('invokes getAutofeedSettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.GetAutofeedSettingsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.AutofeedSettings()
            );
            client.innerApiCalls.getAutofeedSettings = stubSimpleCall(expectedResponse);
            const [response] = await client.getAutofeedSettings(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getAutofeedSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getAutofeedSettings as SinonStub)
        ...
        it('invokes getAutofeedSettings without error using callback', async () => {
            ...
            client.innerApiCalls.getAutofeedSettings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAutofeedSettings(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1beta.IAutofeedSettings|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAutofeedSettings with error', async () => {
            ...
            client.innerApiCalls.getAutofeedSettings = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateAutofeedSettings', () => {
        it('invokes updateAutofeedSettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.UpdateAutofeedSettingsRequest', ['autofeedSettings', 'name']);
            request.autofeedSettings.name = defaultValue1;
            const expectedHeaderRequestParams = `autofeed_settings.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1beta.AutofeedSettings()
            );
            client.innerApiCalls.updateAutofeedSettings = stubSimpleCall(expectedResponse);
            const [response] = await client.updateAutofeedSettings(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateAutofeedSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateAutofeedSettings as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateAutofeedSettings without error using callback', async () => {
            ...
            client.innerApiCalls.updateAutofeedSettings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateAutofeedSettings with error', async () => {
            ...
            const expectedHeaderRequestParams = `autofeed_settings.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateAutofeedSettings = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateAutofeedSettings(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateAutofeedSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateAutofeedSettings as SinonStub)
