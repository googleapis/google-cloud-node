...
describe('v1beta.GbpAccountsServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new gbpaccountsserviceModule.v1beta.GbpAccountsServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = gbpaccountsserviceModule.v1beta.GbpAccountsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = gbpaccountsserviceModule.v1beta.GbpAccountsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new gbpaccountsserviceModule.v1beta.GbpAccountsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new gbpaccountsserviceModule.v1beta.GbpAccountsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new gbpaccountsserviceModule.v1beta.GbpAccountsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new gbpaccountsserviceModule.v1beta.GbpAccountsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = gbpaccountsserviceModule.v1beta.GbpAccountsServiceClient.port;
            assert(port);
    ...
    describe('linkGbpAccount', () => {
        it('invokes linkGbpAccount without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.LinkGbpAccountRequest', ['parent']);
            ...
            const actualRequest = (client.innerApiCalls.linkGbpAccount as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.linkGbpAccount as SinonStub)
        ...
        it('invokes linkGbpAccount without error using callback', async () => {
            ...
            client.innerApiCalls.linkGbpAccount = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.linkGbpAccount(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1beta.ILinkGbpAccountResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes linkGbpAccount with error', async () => {
            ...
            client.innerApiCalls.linkGbpAccount = stubSimpleCall(undefined, expectedError);
    ...
    describe('listGbpAccounts', () => {
        it('invokes listGbpAccounts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1beta.ListGbpAccountsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1beta.GbpAccount()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1beta.GbpAccount()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1beta.GbpAccount()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listGbpAccounts as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listGbpAccounts as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listGbpAccounts without error using callback', async () => {
            ...
            client.innerApiCalls.listGbpAccounts = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listGbpAccounts(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1beta.IGbpAccount[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listGbpAccounts with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listGbpAccounts = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listGbpAccountsStream without error', async () => {
            ...
            client.descriptors.page.listGbpAccounts.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.shopping.merchant.accounts.v1beta.GbpAccount) => {
            ...
            assert((client.descriptors.page.listGbpAccounts.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listGbpAccounts, request));
            assert(
        ...
        it('invokes listGbpAccountsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listGbpAccounts.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listGbpAccountsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.shopping.merchant.accounts.v1beta.GbpAccount[] = [];
                stream.on('data', (response: protos.google.shopping.merchant.accounts.v1beta.GbpAccount) => {
        ...
        it('uses async iteration with listGbpAccounts without error', async () => {
            ...
            client.descriptors.page.listGbpAccounts.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listGbpAccounts with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listGbpAccounts.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listGbpAccountsAsync(request);
