...
function main(parent) {
  // [START merchantapi_v1_generated_OmnichannelSettingsService_ListOmnichannelSettings_async]
  /**
  ...
  async function callListOmnichannelSettings() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = accountsClient.listOmnichannelSettingsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListOmnichannelSettings();
  // [END merchantapi_v1_generated_OmnichannelSettingsService_ListOmnichannelSettings_async]
}
