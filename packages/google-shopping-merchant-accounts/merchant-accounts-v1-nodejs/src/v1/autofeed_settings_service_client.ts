 ...
 * `src/v1/autofeed_settings_service_client_config.json`.
...
export class AutofeedSettingsServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.shopping.merchant.accounts.v1.AutofeedSettingsService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.autofeedSettingsServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.shopping.merchant.accounts.v1.AutofeedSettingsService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.shopping.merchant.accounts.v1.AutofeedSettingsService,
 ...
 *   The first element of the array is an object representing {@link protos.google.shopping.merchant.accounts.v1.AutofeedSettings|AutofeedSettings}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/autofeed_settings_service.get_autofeed_settings.js</caption>
 * region_tag:merchantapi_v1_generated_AutofeedSettingsService_GetAutofeedSettings_async
 */
  getAutofeedSettings(
      request?: protos.google.shopping.merchant.accounts.v1.IGetAutofeedSettingsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.IAutofeedSettings,
        protos.google.shopping.merchant.accounts.v1.IGetAutofeedSettingsRequest|undefined, {}|undefined
      ]>;
  getAutofeedSettings(
      request: protos.google.shopping.merchant.accounts.v1.IGetAutofeedSettingsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1.IAutofeedSettings,
          protos.google.shopping.merchant.accounts.v1.IGetAutofeedSettingsRequest|null|undefined,
          {}|null|undefined>): void;
  getAutofeedSettings(
      request: protos.google.shopping.merchant.accounts.v1.IGetAutofeedSettingsRequest,
      callback: Callback<
  ...
  getAutofeedSettings(
    ...
    return this.innerApiCalls.getAutofeedSettings(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1.IAutofeedSettings,
        protos.google.shopping.merchant.accounts.v1.IGetAutofeedSettingsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getAutofeedSettings response %j', response);
 ...
 * @param {Object} request
 *   The request object that will be sent.
 * @param {google.shopping.merchant.accounts.v1.AutofeedSettings} request.autofeedSettings
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/autofeed_settings_service.update_autofeed_settings.js</caption>
 * region_tag:merchantapi_v1_generated_AutofeedSettingsService_UpdateAutofeedSettings_async
 */
  updateAutofeedSettings(
      request?: protos.google.shopping.merchant.accounts.v1.IUpdateAutofeedSettingsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.IAutofeedSettings,
        protos.google.shopping.merchant.accounts.v1.IUpdateAutofeedSettingsRequest|undefined, {}|undefined
      ]>;
  updateAutofeedSettings(
      request: protos.google.shopping.merchant.accounts.v1.IUpdateAutofeedSettingsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1.IAutofeedSettings,
          protos.google.shopping.merchant.accounts.v1.IUpdateAutofeedSettingsRequest|null|undefined,
          {}|null|undefined>): void;
  updateAutofeedSettings(
      request: protos.google.shopping.merchant.accounts.v1.IUpdateAutofeedSettingsRequest,
      callback: Callback<
  ...
  updateAutofeedSettings(
    ...
    return this.innerApiCalls.updateAutofeedSettings(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1.IAutofeedSettings,
        protos.google.shopping.merchant.accounts.v1.IUpdateAutofeedSettingsRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('updateAutofeedSettings response %j', response);
        return [response, options, rawResponse];
