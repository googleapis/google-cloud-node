 ...
 * `src/v1/business_info_service_client_config.json`.
...
export class BusinessInfoServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.shopping.merchant.accounts.v1.BusinessInfoService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.businessInfoServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.shopping.merchant.accounts.v1.BusinessInfoService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.shopping.merchant.accounts.v1.BusinessInfoService,
 ...
 *   The first element of the array is an object representing {@link protos.google.shopping.merchant.accounts.v1.BusinessInfo|BusinessInfo}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/business_info_service.get_business_info.js</caption>
 * region_tag:merchantapi_v1_generated_BusinessInfoService_GetBusinessInfo_async
 */
  getBusinessInfo(
      request?: protos.google.shopping.merchant.accounts.v1.IGetBusinessInfoRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.IBusinessInfo,
        protos.google.shopping.merchant.accounts.v1.IGetBusinessInfoRequest|undefined, {}|undefined
      ]>;
  getBusinessInfo(
      request: protos.google.shopping.merchant.accounts.v1.IGetBusinessInfoRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1.IBusinessInfo,
          protos.google.shopping.merchant.accounts.v1.IGetBusinessInfoRequest|null|undefined,
          {}|null|undefined>): void;
  getBusinessInfo(
      request: protos.google.shopping.merchant.accounts.v1.IGetBusinessInfoRequest,
      callback: Callback<
  ...
  getBusinessInfo(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getBusinessInfo(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1.IBusinessInfo,
        protos.google.shopping.merchant.accounts.v1.IGetBusinessInfoRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getBusinessInfo response %j', response);
 ...
 * @param {Object} request
 *   The request object that will be sent.
 * @param {google.shopping.merchant.accounts.v1.BusinessInfo} request.businessInfo
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/business_info_service.update_business_info.js</caption>
 * region_tag:merchantapi_v1_generated_BusinessInfoService_UpdateBusinessInfo_async
 */
  updateBusinessInfo(
      request?: protos.google.shopping.merchant.accounts.v1.IUpdateBusinessInfoRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.accounts.v1.IBusinessInfo,
        protos.google.shopping.merchant.accounts.v1.IUpdateBusinessInfoRequest|undefined, {}|undefined
      ]>;
  updateBusinessInfo(
      request: protos.google.shopping.merchant.accounts.v1.IUpdateBusinessInfoRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.accounts.v1.IBusinessInfo,
          protos.google.shopping.merchant.accounts.v1.IUpdateBusinessInfoRequest|null|undefined,
          {}|null|undefined>): void;
  updateBusinessInfo(
      request: protos.google.shopping.merchant.accounts.v1.IUpdateBusinessInfoRequest,
      callback: Callback<
  ...
  updateBusinessInfo(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.updateBusinessInfo(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.accounts.v1.IBusinessInfo,
        protos.google.shopping.merchant.accounts.v1.IUpdateBusinessInfoRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('updateBusinessInfo response %j', response);
        return [response, options, rawResponse];
