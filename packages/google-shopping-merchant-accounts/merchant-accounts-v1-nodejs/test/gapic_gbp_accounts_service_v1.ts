...
describe('v1.GbpAccountsServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = gbpaccountsserviceModule.v1.GbpAccountsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = gbpaccountsserviceModule.v1.GbpAccountsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new gbpaccountsserviceModule.v1.GbpAccountsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new gbpaccountsserviceModule.v1.GbpAccountsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new gbpaccountsserviceModule.v1.GbpAccountsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new gbpaccountsserviceModule.v1.GbpAccountsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = gbpaccountsserviceModule.v1.GbpAccountsServiceClient.port;
            assert(port);
    ...
    describe('linkGbpAccount', () => {
        it('invokes linkGbpAccount without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.LinkGbpAccountRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.LinkGbpAccountRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.LinkGbpAccountResponse()
            );
        ...
        it('invokes linkGbpAccount without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.linkGbpAccount(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1.ILinkGbpAccountResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listGbpAccounts', () => {
        it('invokes listGbpAccounts without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.accounts.v1.ListGbpAccountsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.accounts.v1.ListGbpAccountsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1.GbpAccount()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1.GbpAccount()),
              generateSampleMessage(new protos.google.shopping.merchant.accounts.v1.GbpAccount()),
            ];
        ...
        it('invokes listGbpAccounts without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listGbpAccounts(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.accounts.v1.IGbpAccount[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listGbpAccountsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.shopping.merchant.accounts.v1.GbpAccount[] = [];
                stream.on('data', (response: protos.google.shopping.merchant.accounts.v1.GbpAccount) => {
        ...
        it('uses async iteration with listGbpAccounts without error', async () => {
            ...
            const responses: protos.google.shopping.merchant.accounts.v1.IGbpAccount[] = [];
