 ...
 * `src/v1beta1/gateway_control_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './gateway_control_client_config.json';
...
export class GatewayControlClient {
  ...
  gatewayControlStub?: Promise<{[name: string]: Function}>;
  ...
  initialize() {
    ...
    if (this.gatewayControlStub) {
      return this.gatewayControlStub;
    }
