...
export class VmwareEngineClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this.descriptors.page = {
      listPrivateClouds:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'privateClouds'),
      listClusters:
      ...
      listExternalAddresses:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'externalAddresses'),
      ...
      listExternalAccessRules:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'externalAccessRules'),
      listLoggingServers:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'loggingServers'),
      listNodeTypes:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'nodeTypes'),
      listNetworkPeerings:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'networkPeerings'),
      listPeeringRoutes:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'peeringRoutes'),
      listHcxActivationKeys:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'hcxActivationKeys'),
      listNetworkPolicies:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'networkPolicies'),
      listManagementDnsZoneBindings:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'managementDnsZoneBindings'),
      listVmwareEngineNetworks:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'vmwareEngineNetworks'),
    ...
    if (opts.fallback) {
      ...
      lroOptions.httpRules = [{selector: 'google.cloud.location.Locations.GetLocation',get: '/v1/{name=projects/*/locations/*}',},{selector: 'google.cloud.location.Locations.ListLocations',get: '/v1/{name=projects/*}/locations',},{selector: 'google.iam.v1.IAMPolicy.GetIamPolicy',get: '/v1/{resource=projects/*/locations/*/privateClouds/*}:getIamPolicy',additional_bindings: [{get: '/v1/{resource=projects/*/locations/*/privateClouds/*/clusters/*}:getIamPolicy',},{get: '/v1/{resource=projects/*/locations/*/privateClouds/*/hcxActivationKeys/*}:getIamPolicy',}],
      },{selector: 'google.iam.v1.IAMPolicy.SetIamPolicy',post: '/v1/{resource=projects/*/locations/*/privateClouds/*}:setIamPolicy',body: '*',additional_bindings: [{post: '/v1/{resource=projects/*/locations/*/privateClouds/*/clusters/*}:setIamPolicy',body: '*',},{post: '/v1/{resource=projects/*/locations/*/privateClouds/*/hcxActivationKeys/*}:setIamPolicy',body: '*',}],
      },{selector: 'google.iam.v1.IAMPolicy.TestIamPermissions',post: '/v1/{resource=projects/*/locations/*/privateClouds/*}:testIamPermissions',body: '*',additional_bindings: [{post: '/v1/{resource=projects/*/locations/*/privateClouds/*/clusters/*}:testIamPermissions',body: '*',},{post: '/v1/{resource=projects/*/locations/*/privateClouds/*/hcxActivationKeys/*}:testIamPermissions',body: '*',}],
      },{selector: 'google.longrunning.Operations.DeleteOperation',delete: '/v1/{name=projects/*/locations/*/operations/*}',},{selector: 'google.longrunning.Operations.GetOperation',get: '/v1/{name=projects/*/locations/*/operations/*}',},{selector: 'google.longrunning.Operations.ListOperations',get: '/v1/{name=projects/*/locations/*}/operations',}];
    }
    this.operationsClient = this._gaxModule.lro(lroOptions).operationsClient(opts);
    const createPrivateCloudResponse = protoFilesRoot.lookup(
      '.google.cloud.vmwareengine.v1.PrivateCloud') as gax.protobuf.Type;
    const createPrivateCloudMetadata = protoFilesRoot.lookup(
      '.google.cloud.vmwareengine.v1.OperationMetadata') as gax.protobuf.Type;
    ...
    const createClusterResponse = protoFilesRoot.lookup(
      '.google.cloud.vmwareengine.v1.Cluster') as gax.protobuf.Type;
    ...
    const createExternalAddressResponse = protoFilesRoot.lookup(
      '.google.cloud.vmwareengine.v1.ExternalAddress') as gax.protobuf.Type;
    ...
    const updateSubnetResponse = protoFilesRoot.lookup(
      '.google.cloud.vmwareengine.v1.Subnet') as gax.protobuf.Type;
    const updateSubnetMetadata = protoFilesRoot.lookup(
      '.google.cloud.vmwareengine.v1.OperationMetadata') as gax.protobuf.Type;
    const createExternalAccessRuleResponse = protoFilesRoot.lookup(
      '.google.cloud.vmwareengine.v1.ExternalAccessRule') as gax.protobuf.Type;
    ...
    const createLoggingServerResponse = protoFilesRoot.lookup(
      '.google.cloud.vmwareengine.v1.LoggingServer') as gax.protobuf.Type;
    ...
    const updateDnsForwardingResponse = protoFilesRoot.lookup(
      '.google.cloud.vmwareengine.v1.DnsForwarding') as gax.protobuf.Type;
    const updateDnsForwardingMetadata = protoFilesRoot.lookup(
      '.google.cloud.vmwareengine.v1.OperationMetadata') as gax.protobuf.Type;
    const createNetworkPeeringResponse = protoFilesRoot.lookup(
      '.google.cloud.vmwareengine.v1.NetworkPeering') as gax.protobuf.Type;
    ...
    const createHcxActivationKeyResponse = protoFilesRoot.lookup(
      '.google.cloud.vmwareengine.v1.HcxActivationKey') as gax.protobuf.Type;
    const createHcxActivationKeyMetadata = protoFilesRoot.lookup(
      '.google.cloud.vmwareengine.v1.OperationMetadata') as gax.protobuf.Type;
    const createNetworkPolicyResponse = protoFilesRoot.lookup(
      '.google.cloud.vmwareengine.v1.NetworkPolicy') as gax.protobuf.Type;
    ...
    const createManagementDnsZoneBindingResponse = protoFilesRoot.lookup(
      '.google.cloud.vmwareengine.v1.ManagementDnsZoneBinding') as gax.protobuf.Type;
    ...
    const createVmwareEngineNetworkResponse = protoFilesRoot.lookup(
      '.google.cloud.vmwareengine.v1.VmwareEngineNetwork') as gax.protobuf.Type;
    ...
    const createPrivateConnectionResponse = protoFilesRoot.lookup(
      '.google.cloud.vmwareengine.v1.PrivateConnection') as gax.protobuf.Type;
    ...
    const grantDnsBindPermissionResponse = protoFilesRoot.lookup(
      '.google.cloud.vmwareengine.v1.DnsBindPermission') as gax.protobuf.Type;
    ...
    this.descriptors.longrunning = {
      ...
      createExternalAddress: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        createExternalAddressResponse.decode.bind(createExternalAddressResponse),
      ...
      updateExternalAddress: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        updateExternalAddressResponse.decode.bind(updateExternalAddressResponse),
      ...
      deleteExternalAddress: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        deleteExternalAddressResponse.decode.bind(deleteExternalAddressResponse),
      ...
      createExternalAccessRule: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        createExternalAccessRuleResponse.decode.bind(createExternalAccessRuleResponse),
        createExternalAccessRuleMetadata.decode.bind(createExternalAccessRuleMetadata)),
      updateExternalAccessRule: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        updateExternalAccessRuleResponse.decode.bind(updateExternalAccessRuleResponse),
        updateExternalAccessRuleMetadata.decode.bind(updateExternalAccessRuleMetadata)),
      deleteExternalAccessRule: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        deleteExternalAccessRuleResponse.decode.bind(deleteExternalAccessRuleResponse),
        deleteExternalAccessRuleMetadata.decode.bind(deleteExternalAccessRuleMetadata)),
      ...
      resetVcenterCredentials: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        resetVcenterCredentialsResponse.decode.bind(resetVcenterCredentialsResponse),
        resetVcenterCredentialsMetadata.decode.bind(resetVcenterCredentialsMetadata)),
      ...
      createHcxActivationKey: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        createHcxActivationKeyResponse.decode.bind(createHcxActivationKeyResponse),
        createHcxActivationKeyMetadata.decode.bind(createHcxActivationKeyMetadata)),
      ...
      createManagementDnsZoneBinding: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        createManagementDnsZoneBindingResponse.decode.bind(createManagementDnsZoneBindingResponse),
        createManagementDnsZoneBindingMetadata.decode.bind(createManagementDnsZoneBindingMetadata)),
      updateManagementDnsZoneBinding: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        updateManagementDnsZoneBindingResponse.decode.bind(updateManagementDnsZoneBindingResponse),
        updateManagementDnsZoneBindingMetadata.decode.bind(updateManagementDnsZoneBindingMetadata)),
      deleteManagementDnsZoneBinding: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        deleteManagementDnsZoneBindingResponse.decode.bind(deleteManagementDnsZoneBindingResponse),
        deleteManagementDnsZoneBindingMetadata.decode.bind(deleteManagementDnsZoneBindingMetadata)),
      repairManagementDnsZoneBinding: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        repairManagementDnsZoneBindingResponse.decode.bind(repairManagementDnsZoneBindingResponse),
        repairManagementDnsZoneBindingMetadata.decode.bind(repairManagementDnsZoneBindingMetadata)),
      createVmwareEngineNetwork: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        createVmwareEngineNetworkResponse.decode.bind(createVmwareEngineNetworkResponse),
        createVmwareEngineNetworkMetadata.decode.bind(createVmwareEngineNetworkMetadata)),
      updateVmwareEngineNetwork: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        updateVmwareEngineNetworkResponse.decode.bind(updateVmwareEngineNetworkResponse),
        updateVmwareEngineNetworkMetadata.decode.bind(updateVmwareEngineNetworkMetadata)),
      deleteVmwareEngineNetwork: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        deleteVmwareEngineNetworkResponse.decode.bind(deleteVmwareEngineNetworkResponse),
        deleteVmwareEngineNetworkMetadata.decode.bind(deleteVmwareEngineNetworkMetadata)),
      ...
      updatePrivateConnection: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        updatePrivateConnectionResponse.decode.bind(updatePrivateConnectionResponse),
      ...
      grantDnsBindPermission: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        grantDnsBindPermissionResponse.decode.bind(grantDnsBindPermissionResponse),
        grantDnsBindPermissionMetadata.decode.bind(grantDnsBindPermissionMetadata)),
      revokeDnsBindPermission: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        revokeDnsBindPermissionResponse.decode.bind(revokeDnsBindPermissionResponse),
        revokeDnsBindPermissionMetadata.decode.bind(revokeDnsBindPermissionMetadata))
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.vmwareengine.v1.VmwareEngine', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.vmwareEngineStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.vmwareengine.v1.VmwareEngine') :
 ...
 */
  getPrivateCloud(
      ...
      Promise<[
        ...
        protos.google.cloud.vmwareengine.v1.IGetPrivateCloudRequest|undefined, {}|undefined
      ]>;
  getPrivateCloud(
      request: protos.google.cloud.vmwareengine.v1.IGetPrivateCloudRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.vmwareengine.v1.IPrivateCloud,
          protos.google.cloud.vmwareengine.v1.IGetPrivateCloudRequest|null|undefined,
          {}|null|undefined>): void;
  getPrivateCloud(
      request: protos.google.cloud.vmwareengine.v1.IGetPrivateCloudRequest,
      callback: Callback<
  ...
  getPrivateCloud(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getPrivateCloud(request, options, wrappedCallback)
 ...
 */
  getCluster(
      ...
      Promise<[
        ...
        protos.google.cloud.vmwareengine.v1.IGetClusterRequest|undefined, {}|undefined
      ]>;
  getCluster(
      request: protos.google.cloud.vmwareengine.v1.IGetClusterRequest,
      options: CallOptions,
 ...
 */
  getNode(
      ...
      Promise<[
        ...
        protos.google.cloud.vmwareengine.v1.IGetNodeRequest|undefined, {}|undefined
      ]>;
  getNode(
      request: protos.google.cloud.vmwareengine.v1.IGetNodeRequest,
      options: CallOptions,
 ...
 */
  getExternalAddress(
      ...
      Promise<[
        ...
        protos.google.cloud.vmwareengine.v1.IGetExternalAddressRequest|undefined, {}|undefined
      ]>;
  getExternalAddress(
      request: protos.google.cloud.vmwareengine.v1.IGetExternalAddressRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.vmwareengine.v1.IExternalAddress,
          protos.google.cloud.vmwareengine.v1.IGetExternalAddressRequest|null|undefined,
          {}|null|undefined>): void;
  getExternalAddress(
      request: protos.google.cloud.vmwareengine.v1.IGetExternalAddressRequest,
      callback: Callback<
  ...
  getExternalAddress(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getExternalAddress(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.vmwareengine.v1.IExternalAddress,
 ...
 */
  getSubnet(
      ...
      Promise<[
        ...
        protos.google.cloud.vmwareengine.v1.IGetSubnetRequest|undefined, {}|undefined
      ]>;
  getSubnet(
      request: protos.google.cloud.vmwareengine.v1.IGetSubnetRequest,
      options: CallOptions,
 ...
 */
  getExternalAccessRule(
      ...
      Promise<[
        ...
        protos.google.cloud.vmwareengine.v1.IGetExternalAccessRuleRequest|undefined, {}|undefined
      ]>;
  getExternalAccessRule(
      request: protos.google.cloud.vmwareengine.v1.IGetExternalAccessRuleRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.vmwareengine.v1.IExternalAccessRule,
          protos.google.cloud.vmwareengine.v1.IGetExternalAccessRuleRequest|null|undefined,
          {}|null|undefined>): void;
  getExternalAccessRule(
      request: protos.google.cloud.vmwareengine.v1.IGetExternalAccessRuleRequest,
      callback: Callback<
  ...
  getExternalAccessRule(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getExternalAccessRule(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.vmwareengine.v1.IExternalAccessRule,
 ...
 */
  getLoggingServer(
      ...
      Promise<[
        ...
        protos.google.cloud.vmwareengine.v1.IGetLoggingServerRequest|undefined, {}|undefined
      ]>;
  getLoggingServer(
      request: protos.google.cloud.vmwareengine.v1.IGetLoggingServerRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.vmwareengine.v1.ILoggingServer,
          protos.google.cloud.vmwareengine.v1.IGetLoggingServerRequest|null|undefined,
          {}|null|undefined>): void;
  getLoggingServer(
      request: protos.google.cloud.vmwareengine.v1.IGetLoggingServerRequest,
      callback: Callback<
  ...
  getLoggingServer(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getLoggingServer(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.vmwareengine.v1.ILoggingServer,
 ...
 */
  getNodeType(
      ...
      Promise<[
        ...
        protos.google.cloud.vmwareengine.v1.IGetNodeTypeRequest|undefined, {}|undefined
      ]>;
  getNodeType(
      request: protos.google.cloud.vmwareengine.v1.IGetNodeTypeRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.vmwareengine.v1.INodeType,
          protos.google.cloud.vmwareengine.v1.IGetNodeTypeRequest|null|undefined,
          {}|null|undefined>): void;
  getNodeType(
      request: protos.google.cloud.vmwareengine.v1.IGetNodeTypeRequest,
      callback: Callback<
  ...
  getNodeType(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getNodeType(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.vmwareengine.v1.INodeType,
 ...
 */
  showNsxCredentials(
      ...
      Promise<[
        ...
        protos.google.cloud.vmwareengine.v1.IShowNsxCredentialsRequest|undefined, {}|undefined
      ]>;
  showNsxCredentials(
      request: protos.google.cloud.vmwareengine.v1.IShowNsxCredentialsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.vmwareengine.v1.ICredentials,
          protos.google.cloud.vmwareengine.v1.IShowNsxCredentialsRequest|null|undefined,
          {}|null|undefined>): void;
  showNsxCredentials(
      request: protos.google.cloud.vmwareengine.v1.IShowNsxCredentialsRequest,
      callback: Callback<
  ...
  showNsxCredentials(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.showNsxCredentials(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.vmwareengine.v1.ICredentials,
 ...
 */
  showVcenterCredentials(
      ...
      Promise<[
        protos.google.cloud.vmwareengine.v1.ICredentials,
        protos.google.cloud.vmwareengine.v1.IShowVcenterCredentialsRequest|undefined, {}|undefined
      ]>;
  showVcenterCredentials(
      request: protos.google.cloud.vmwareengine.v1.IShowVcenterCredentialsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.vmwareengine.v1.ICredentials,
          protos.google.cloud.vmwareengine.v1.IShowVcenterCredentialsRequest|null|undefined,
          {}|null|undefined>): void;
  showVcenterCredentials(
      request: protos.google.cloud.vmwareengine.v1.IShowVcenterCredentialsRequest,
      callback: Callback<
  ...
  showVcenterCredentials(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.showVcenterCredentials(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.vmwareengine.v1.ICredentials,
 ...
 */
  getDnsForwarding(
      ...
      Promise<[
        ...
        protos.google.cloud.vmwareengine.v1.IGetDnsForwardingRequest|undefined, {}|undefined
      ]>;
  getDnsForwarding(
      request: protos.google.cloud.vmwareengine.v1.IGetDnsForwardingRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.vmwareengine.v1.IDnsForwarding,
          protos.google.cloud.vmwareengine.v1.IGetDnsForwardingRequest|null|undefined,
          {}|null|undefined>): void;
  getDnsForwarding(
      request: protos.google.cloud.vmwareengine.v1.IGetDnsForwardingRequest,
      callback: Callback<
  ...
  getDnsForwarding(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getDnsForwarding(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.vmwareengine.v1.IDnsForwarding,
 ...
 */
  getNetworkPeering(
      ...
      Promise<[
        ...
        protos.google.cloud.vmwareengine.v1.IGetNetworkPeeringRequest|undefined, {}|undefined
      ]>;
  getNetworkPeering(
      request: protos.google.cloud.vmwareengine.v1.IGetNetworkPeeringRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.vmwareengine.v1.INetworkPeering,
          protos.google.cloud.vmwareengine.v1.IGetNetworkPeeringRequest|null|undefined,
          {}|null|undefined>): void;
  getNetworkPeering(
      request: protos.google.cloud.vmwareengine.v1.IGetNetworkPeeringRequest,
      callback: Callback<
  ...
  getNetworkPeering(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getNetworkPeering(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.vmwareengine.v1.INetworkPeering,
 ...
 */
  getHcxActivationKey(
      ...
      Promise<[
        ...
        protos.google.cloud.vmwareengine.v1.IGetHcxActivationKeyRequest|undefined, {}|undefined
      ]>;
  getHcxActivationKey(
      request: protos.google.cloud.vmwareengine.v1.IGetHcxActivationKeyRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.vmwareengine.v1.IHcxActivationKey,
          protos.google.cloud.vmwareengine.v1.IGetHcxActivationKeyRequest|null|undefined,
          {}|null|undefined>): void;
  getHcxActivationKey(
      request: protos.google.cloud.vmwareengine.v1.IGetHcxActivationKeyRequest,
      callback: Callback<
  ...
  getHcxActivationKey(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getHcxActivationKey(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.vmwareengine.v1.IHcxActivationKey,
 ...
 */
  getNetworkPolicy(
      ...
      Promise<[
        ...
        protos.google.cloud.vmwareengine.v1.IGetNetworkPolicyRequest|undefined, {}|undefined
      ]>;
  getNetworkPolicy(
      request: protos.google.cloud.vmwareengine.v1.IGetNetworkPolicyRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.vmwareengine.v1.INetworkPolicy,
          protos.google.cloud.vmwareengine.v1.IGetNetworkPolicyRequest|null|undefined,
          {}|null|undefined>): void;
  getNetworkPolicy(
      request: protos.google.cloud.vmwareengine.v1.IGetNetworkPolicyRequest,
      callback: Callback<
  ...
  getNetworkPolicy(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getNetworkPolicy(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.vmwareengine.v1.INetworkPolicy,
 ...
 */
  getManagementDnsZoneBinding(
      ...
      Promise<[
        ...
        protos.google.cloud.vmwareengine.v1.IGetManagementDnsZoneBindingRequest|undefined, {}|undefined
      ]>;
  getManagementDnsZoneBinding(
      request: protos.google.cloud.vmwareengine.v1.IGetManagementDnsZoneBindingRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.vmwareengine.v1.IManagementDnsZoneBinding,
          protos.google.cloud.vmwareengine.v1.IGetManagementDnsZoneBindingRequest|null|undefined,
          {}|null|undefined>): void;
  getManagementDnsZoneBinding(
      request: protos.google.cloud.vmwareengine.v1.IGetManagementDnsZoneBindingRequest,
      callback: Callback<
  ...
  getManagementDnsZoneBinding(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getManagementDnsZoneBinding(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.vmwareengine.v1.IManagementDnsZoneBinding,
 ...
 */
  getVmwareEngineNetwork(
      ...
      Promise<[
        ...
        protos.google.cloud.vmwareengine.v1.IGetVmwareEngineNetworkRequest|undefined, {}|undefined
      ]>;
  getVmwareEngineNetwork(
      request: protos.google.cloud.vmwareengine.v1.IGetVmwareEngineNetworkRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.vmwareengine.v1.IVmwareEngineNetwork,
          protos.google.cloud.vmwareengine.v1.IGetVmwareEngineNetworkRequest|null|undefined,
          {}|null|undefined>): void;
  getVmwareEngineNetwork(
      request: protos.google.cloud.vmwareengine.v1.IGetVmwareEngineNetworkRequest,
      callback: Callback<
  ...
  getVmwareEngineNetwork(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getVmwareEngineNetwork(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.vmwareengine.v1.IVmwareEngineNetwork,
 ...
 */
  getPrivateConnection(
      ...
      Promise<[
        ...
        protos.google.cloud.vmwareengine.v1.IGetPrivateConnectionRequest|undefined, {}|undefined
      ]>;
  getPrivateConnection(
      request: protos.google.cloud.vmwareengine.v1.IGetPrivateConnectionRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.vmwareengine.v1.IPrivateConnection,
          protos.google.cloud.vmwareengine.v1.IGetPrivateConnectionRequest|null|undefined,
          {}|null|undefined>): void;
  getPrivateConnection(
      request: protos.google.cloud.vmwareengine.v1.IGetPrivateConnectionRequest,
      callback: Callback<
 ...
 */
  getDnsBindPermission(
      ...
      Promise<[
        ...
        protos.google.cloud.vmwareengine.v1.IGetDnsBindPermissionRequest|undefined, {}|undefined
      ]>;
  getDnsBindPermission(
      request: protos.google.cloud.vmwareengine.v1.IGetDnsBindPermissionRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.vmwareengine.v1.IDnsBindPermission,
          protos.google.cloud.vmwareengine.v1.IGetDnsBindPermissionRequest|null|undefined,
          {}|null|undefined>): void;
  getDnsBindPermission(
      request: protos.google.cloud.vmwareengine.v1.IGetDnsBindPermissionRequest,
      callback: Callback<
  ...
  getDnsBindPermission(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getDnsBindPermission(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.vmwareengine.v1.IDnsBindPermission,
 ...
 */
  ...
  createPrivateCloud(
    ...
    return this.innerApiCalls.createPrivateCloud(request, options, wrappedCallback)
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_CreatePrivateCloud_async
 */
  async checkCreatePrivateCloudProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.PrivateCloud, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.vmwareengine.v1.PrivateCloud, protos.google.cloud.vmwareengine.v1.OperationMetadata>;
  }
/**
 ...
 */
  ...
  updatePrivateCloud(
    ...
    return this.innerApiCalls.updatePrivateCloud(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.vmwareengine.v1.IPrivateCloud, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_UpdatePrivateCloud_async
 */
  async checkUpdatePrivateCloudProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.PrivateCloud, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
 ...
 */
  ...
  deletePrivateCloud(
    ...
    return this.innerApiCalls.deletePrivateCloud(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.vmwareengine.v1.IPrivateCloud, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_DeletePrivateCloud_async
 */
  async checkDeletePrivateCloudProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.PrivateCloud, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
 ...
 */
  ...
  undeletePrivateCloud(
    ...
    return this.innerApiCalls.undeletePrivateCloud(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.vmwareengine.v1.IPrivateCloud, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_UndeletePrivateCloud_async
 */
  async checkUndeletePrivateCloudProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.PrivateCloud, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_CreateCluster_async
 */
  async checkCreateClusterProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.Cluster, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.vmwareengine.v1.Cluster, protos.google.cloud.vmwareengine.v1.OperationMetadata>;
  }
/**
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_UpdateCluster_async
 */
  async checkUpdateClusterProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.Cluster, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_DeleteCluster_async
 */
  async checkDeleteClusterProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.protobuf.Empty, protos.google.cloud.vmwareengine.v1.OperationMetadata>;
  }
/**
 ...
 */
  ...
  createExternalAddress(
    ...
    return this.innerApiCalls.createExternalAddress(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.vmwareengine.v1.IExternalAddress, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_CreateExternalAddress_async
 */
  async checkCreateExternalAddressProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.ExternalAddress, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
    this._log.info('createExternalAddress long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.createExternalAddress, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.vmwareengine.v1.ExternalAddress, protos.google.cloud.vmwareengine.v1.OperationMetadata>;
  }
/**
 ...
 */
  ...
  updateExternalAddress(
    ...
    return this.innerApiCalls.updateExternalAddress(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.vmwareengine.v1.IExternalAddress, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_UpdateExternalAddress_async
 */
  async checkUpdateExternalAddressProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.ExternalAddress, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
    this._log.info('updateExternalAddress long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.updateExternalAddress, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.vmwareengine.v1.ExternalAddress, protos.google.cloud.vmwareengine.v1.OperationMetadata>;
  }
/**
 ...
 */
  ...
  deleteExternalAddress(
    ...
    return this.innerApiCalls.deleteExternalAddress(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_DeleteExternalAddress_async
 */
  async checkDeleteExternalAddressProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
    this._log.info('deleteExternalAddress long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.deleteExternalAddress, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.protobuf.Empty, protos.google.cloud.vmwareengine.v1.OperationMetadata>;
  }
/**
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_UpdateSubnet_async
 */
  async checkUpdateSubnetProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.Subnet, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.vmwareengine.v1.Subnet, protos.google.cloud.vmwareengine.v1.OperationMetadata>;
  }
/**
 ...
 */
  ...
  createExternalAccessRule(
    ...
    return this.innerApiCalls.createExternalAccessRule(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.vmwareengine.v1.IExternalAccessRule, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_CreateExternalAccessRule_async
 */
  async checkCreateExternalAccessRuleProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.ExternalAccessRule, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
    this._log.info('createExternalAccessRule long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.createExternalAccessRule, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.vmwareengine.v1.ExternalAccessRule, protos.google.cloud.vmwareengine.v1.OperationMetadata>;
  }
/**
 ...
 */
  ...
  updateExternalAccessRule(
    ...
    return this.innerApiCalls.updateExternalAccessRule(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.vmwareengine.v1.IExternalAccessRule, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_UpdateExternalAccessRule_async
 */
  async checkUpdateExternalAccessRuleProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.ExternalAccessRule, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
    this._log.info('updateExternalAccessRule long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.updateExternalAccessRule, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.vmwareengine.v1.ExternalAccessRule, protos.google.cloud.vmwareengine.v1.OperationMetadata>;
  }
/**
 ...
 */
  ...
  deleteExternalAccessRule(
    ...
    return this.innerApiCalls.deleteExternalAccessRule(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_DeleteExternalAccessRule_async
 */
  async checkDeleteExternalAccessRuleProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
    this._log.info('deleteExternalAccessRule long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.deleteExternalAccessRule, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.protobuf.Empty, protos.google.cloud.vmwareengine.v1.OperationMetadata>;
  }
/**
 ...
 */
  ...
  createLoggingServer(
    ...
    return this.innerApiCalls.createLoggingServer(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.vmwareengine.v1.ILoggingServer, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_CreateLoggingServer_async
 */
  async checkCreateLoggingServerProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.LoggingServer, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
    this._log.info('createLoggingServer long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.createLoggingServer, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.vmwareengine.v1.LoggingServer, protos.google.cloud.vmwareengine.v1.OperationMetadata>;
  }
/**
 ...
 */
  ...
  updateLoggingServer(
    ...
    return this.innerApiCalls.updateLoggingServer(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.vmwareengine.v1.ILoggingServer, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_UpdateLoggingServer_async
 */
  async checkUpdateLoggingServerProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.LoggingServer, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
    this._log.info('updateLoggingServer long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.updateLoggingServer, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.vmwareengine.v1.LoggingServer, protos.google.cloud.vmwareengine.v1.OperationMetadata>;
  }
/**
 ...
 */
  ...
  deleteLoggingServer(
    ...
    return this.innerApiCalls.deleteLoggingServer(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_DeleteLoggingServer_async
 */
  async checkDeleteLoggingServerProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
    this._log.info('deleteLoggingServer long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.deleteLoggingServer, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.protobuf.Empty, protos.google.cloud.vmwareengine.v1.OperationMetadata>;
  }
/**
 ...
 */
  ...
  resetNsxCredentials(
    ...
    return this.innerApiCalls.resetNsxCredentials(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.vmwareengine.v1.IPrivateCloud, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_ResetNsxCredentials_async
 */
  async checkResetNsxCredentialsProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.PrivateCloud, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
 ...
 */
  ...
  resetVcenterCredentials(
    ...
    return this.innerApiCalls.resetVcenterCredentials(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.vmwareengine.v1.IPrivateCloud, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_ResetVcenterCredentials_async
 */
  async checkResetVcenterCredentialsProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.PrivateCloud, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
 ...
 */
  ...
  updateDnsForwarding(
    ...
    return this.innerApiCalls.updateDnsForwarding(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.vmwareengine.v1.IDnsForwarding, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_UpdateDnsForwarding_async
 */
  async checkUpdateDnsForwardingProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.DnsForwarding, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
    this._log.info('updateDnsForwarding long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.updateDnsForwarding, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.vmwareengine.v1.DnsForwarding, protos.google.cloud.vmwareengine.v1.OperationMetadata>;
  }
/**
 ...
 */
  ...
  createNetworkPeering(
    ...
    return this.innerApiCalls.createNetworkPeering(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.vmwareengine.v1.INetworkPeering, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_CreateNetworkPeering_async
 */
  async checkCreateNetworkPeeringProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.NetworkPeering, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
    this._log.info('createNetworkPeering long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.createNetworkPeering, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.vmwareengine.v1.NetworkPeering, protos.google.cloud.vmwareengine.v1.OperationMetadata>;
  }
/**
 ...
 */
  ...
  deleteNetworkPeering(
    ...
    return this.innerApiCalls.deleteNetworkPeering(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_DeleteNetworkPeering_async
 */
  async checkDeleteNetworkPeeringProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
    this._log.info('deleteNetworkPeering long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.deleteNetworkPeering, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.protobuf.Empty, protos.google.cloud.vmwareengine.v1.OperationMetadata>;
  }
/**
 ...
 */
  ...
  updateNetworkPeering(
    ...
    return this.innerApiCalls.updateNetworkPeering(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.vmwareengine.v1.INetworkPeering, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_UpdateNetworkPeering_async
 */
  async checkUpdateNetworkPeeringProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.NetworkPeering, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
    this._log.info('updateNetworkPeering long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.updateNetworkPeering, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.vmwareengine.v1.NetworkPeering, protos.google.cloud.vmwareengine.v1.OperationMetadata>;
  }
/**
 ...
 */
  ...
  createHcxActivationKey(
    ...
    return this.innerApiCalls.createHcxActivationKey(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.vmwareengine.v1.IHcxActivationKey, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_CreateHcxActivationKey_async
 */
  async checkCreateHcxActivationKeyProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.HcxActivationKey, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.vmwareengine.v1.HcxActivationKey, protos.google.cloud.vmwareengine.v1.OperationMetadata>;
  }
/**
 ...
 */
  ...
  createNetworkPolicy(
    ...
    return this.innerApiCalls.createNetworkPolicy(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.vmwareengine.v1.INetworkPolicy, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_CreateNetworkPolicy_async
 */
  async checkCreateNetworkPolicyProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.NetworkPolicy, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.vmwareengine.v1.NetworkPolicy, protos.google.cloud.vmwareengine.v1.OperationMetadata>;
  }
/**
 ...
 */
  ...
  updateNetworkPolicy(
    ...
    return this.innerApiCalls.updateNetworkPolicy(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.vmwareengine.v1.INetworkPolicy, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_UpdateNetworkPolicy_async
 */
  async checkUpdateNetworkPolicyProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.NetworkPolicy, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
 ...
 */
  ...
  deleteNetworkPolicy(
    ...
    return this.innerApiCalls.deleteNetworkPolicy(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_DeleteNetworkPolicy_async
 */
  async checkDeleteNetworkPolicyProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
 ...
 */
  ...
  createManagementDnsZoneBinding(
    ...
    const wrappedCallback: Callback<
          ...
          {}|null|undefined>|undefined = callback
      ? (error, response, rawResponse, _) => {
          this._log.info('createManagementDnsZoneBinding response %j', rawResponse);
          callback!(error, response, rawResponse, _); // We verified callback above.
        }
      : undefined;
    this._log.info('createManagementDnsZoneBinding request %j', request);
    return this.innerApiCalls.createManagementDnsZoneBinding(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.vmwareengine.v1.IManagementDnsZoneBinding, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_CreateManagementDnsZoneBinding_async
 */
  async checkCreateManagementDnsZoneBindingProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.ManagementDnsZoneBinding, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
    this._log.info('createManagementDnsZoneBinding long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.createManagementDnsZoneBinding, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.vmwareengine.v1.ManagementDnsZoneBinding, protos.google.cloud.vmwareengine.v1.OperationMetadata>;
  }
/**
 ...
 */
  ...
  updateManagementDnsZoneBinding(
    ...
    options.otherArgs.headers[
      ...
      'management_dns_zone_binding.name': request.managementDnsZoneBinding!.name ?? '',
    });
    this.initialize().catch(err => {throw err});
    const wrappedCallback: Callback<
          LROperation<protos.google.cloud.vmwareengine.v1.IManagementDnsZoneBinding, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
          ...
          {}|null|undefined>|undefined = callback
      ? (error, response, rawResponse, _) => {
          this._log.info('updateManagementDnsZoneBinding response %j', rawResponse);
          callback!(error, response, rawResponse, _); // We verified callback above.
        }
      : undefined;
    this._log.info('updateManagementDnsZoneBinding request %j', request);
    return this.innerApiCalls.updateManagementDnsZoneBinding(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.vmwareengine.v1.IManagementDnsZoneBinding, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_UpdateManagementDnsZoneBinding_async
 */
  async checkUpdateManagementDnsZoneBindingProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.ManagementDnsZoneBinding, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
    this._log.info('updateManagementDnsZoneBinding long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.updateManagementDnsZoneBinding, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.vmwareengine.v1.ManagementDnsZoneBinding, protos.google.cloud.vmwareengine.v1.OperationMetadata>;
  }
/**
 ...
 */
  ...
  deleteManagementDnsZoneBinding(
    ...
    const wrappedCallback: Callback<
          ...
          {}|null|undefined>|undefined = callback
      ? (error, response, rawResponse, _) => {
          this._log.info('deleteManagementDnsZoneBinding response %j', rawResponse);
          callback!(error, response, rawResponse, _); // We verified callback above.
        }
      : undefined;
    this._log.info('deleteManagementDnsZoneBinding request %j', request);
    return this.innerApiCalls.deleteManagementDnsZoneBinding(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_DeleteManagementDnsZoneBinding_async
 */
  async checkDeleteManagementDnsZoneBindingProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
    this._log.info('deleteManagementDnsZoneBinding long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.deleteManagementDnsZoneBinding, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.protobuf.Empty, protos.google.cloud.vmwareengine.v1.OperationMetadata>;
  }
/**
 ...
 */
  ...
  repairManagementDnsZoneBinding(
    ...
    const wrappedCallback: Callback<
          ...
          {}|null|undefined>|undefined = callback
      ? (error, response, rawResponse, _) => {
          this._log.info('repairManagementDnsZoneBinding response %j', rawResponse);
          callback!(error, response, rawResponse, _); // We verified callback above.
        }
      : undefined;
    this._log.info('repairManagementDnsZoneBinding request %j', request);
    return this.innerApiCalls.repairManagementDnsZoneBinding(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.vmwareengine.v1.IManagementDnsZoneBinding, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_RepairManagementDnsZoneBinding_async
 */
  async checkRepairManagementDnsZoneBindingProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.ManagementDnsZoneBinding, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
    this._log.info('repairManagementDnsZoneBinding long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.repairManagementDnsZoneBinding, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.vmwareengine.v1.ManagementDnsZoneBinding, protos.google.cloud.vmwareengine.v1.OperationMetadata>;
  }
/**
 ...
 */
  ...
  createVmwareEngineNetwork(
    ...
    return this.innerApiCalls.createVmwareEngineNetwork(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.vmwareengine.v1.IVmwareEngineNetwork, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_CreateVmwareEngineNetwork_async
 */
  async checkCreateVmwareEngineNetworkProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.VmwareEngineNetwork, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.vmwareengine.v1.VmwareEngineNetwork, protos.google.cloud.vmwareengine.v1.OperationMetadata>;
  }
/**
 ...
 */
  ...
  updateVmwareEngineNetwork(
    ...
    return this.innerApiCalls.updateVmwareEngineNetwork(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.vmwareengine.v1.IVmwareEngineNetwork, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_UpdateVmwareEngineNetwork_async
 */
  async checkUpdateVmwareEngineNetworkProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.VmwareEngineNetwork, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
 ...
 */
  ...
  deleteVmwareEngineNetwork(
    ...
    return this.innerApiCalls.deleteVmwareEngineNetwork(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_DeleteVmwareEngineNetwork_async
 */
  async checkDeleteVmwareEngineNetworkProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_CreatePrivateConnection_async
 */
  async checkCreatePrivateConnectionProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.PrivateConnection, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.vmwareengine.v1.PrivateConnection, protos.google.cloud.vmwareengine.v1.OperationMetadata>;
  }
/**
 ...
 */
  ...
  updatePrivateConnection(
    ...
    return this.innerApiCalls.updatePrivateConnection(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.vmwareengine.v1.IPrivateConnection, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_UpdatePrivateConnection_async
 */
  async checkUpdatePrivateConnectionProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.PrivateConnection, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_DeletePrivateConnection_async
 */
  async checkDeletePrivateConnectionProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
 ...
 */
  ...
  grantDnsBindPermission(
    ...
    return this.innerApiCalls.grantDnsBindPermission(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.vmwareengine.v1.IDnsBindPermission, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_GrantDnsBindPermission_async
 */
  async checkGrantDnsBindPermissionProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.DnsBindPermission, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
    this._log.info('grantDnsBindPermission long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.grantDnsBindPermission, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.vmwareengine.v1.DnsBindPermission, protos.google.cloud.vmwareengine.v1.OperationMetadata>;
  }
/**
 ...
 */
  ...
  revokeDnsBindPermission(
    ...
    return this.innerApiCalls.revokeDnsBindPermission(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.vmwareengine.v1.IDnsBindPermission, protos.google.cloud.vmwareengine.v1.IOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:vmwareengine_v1_generated_VmwareEngine_RevokeDnsBindPermission_async
 */
  async checkRevokeDnsBindPermissionProgress(name: string): Promise<LROperation<protos.google.cloud.vmwareengine.v1.DnsBindPermission, protos.google.cloud.vmwareengine.v1.OperationMetadata>>{
    this._log.info('revokeDnsBindPermission long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.revokeDnsBindPermission, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.vmwareengine.v1.DnsBindPermission, protos.google.cloud.vmwareengine.v1.OperationMetadata>;
  }
 /**
 ...
 */
  ...
  listPrivateClouds(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.vmwareengine.v1.IListPrivateCloudsResponse|null|undefined,
          protos.google.cloud.vmwareengine.v1.IPrivateCloud>): void;
  listPrivateClouds(
      request: protos.google.cloud.vmwareengine.v1.IListPrivateCloudsRequest,
      callback: PaginationCallback<
          protos.google.cloud.vmwareengine.v1.IListPrivateCloudsRequest,
  ...
  listPrivateClouds(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.vmwareengine.v1.IListPrivateCloudsRequest,
      protos.google.cloud.vmwareengine.v1.IListPrivateCloudsResponse|null|undefined,
      protos.google.cloud.vmwareengine.v1.IPrivateCloud>|undefined = callback
 ...
 */
  ...
  listClusters(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.vmwareengine.v1.IListClustersResponse|null|undefined,
          protos.google.cloud.vmwareengine.v1.ICluster>): void;
  listClusters(
      request: protos.google.cloud.vmwareengine.v1.IListClustersRequest,
      callback: PaginationCallback<
          protos.google.cloud.vmwareengine.v1.IListClustersRequest,
  ...
  listClusters(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.vmwareengine.v1.IListClustersRequest,
      protos.google.cloud.vmwareengine.v1.IListClustersResponse|null|undefined,
      protos.google.cloud.vmwareengine.v1.ICluster>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
 ...
 */
  ...
  listNodes(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.vmwareengine.v1.INode>): void;
  listNodes(
      request: protos.google.cloud.vmwareengine.v1.IListNodesRequest,
      callback: PaginationCallback<
          protos.google.cloud.vmwareengine.v1.IListNodesRequest,
  ...
  listNodes(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.vmwareengine.v1.IListNodesRequest,
      protos.google.cloud.vmwareengine.v1.IListNodesResponse|null|undefined,
      protos.google.cloud.vmwareengine.v1.INode>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
 ...
 */
  ...
  listExternalAddresses(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.vmwareengine.v1.IListExternalAddressesResponse|null|undefined,
          protos.google.cloud.vmwareengine.v1.IExternalAddress>): void;
  listExternalAddresses(
      request: protos.google.cloud.vmwareengine.v1.IListExternalAddressesRequest,
      callback: PaginationCallback<
          protos.google.cloud.vmwareengine.v1.IListExternalAddressesRequest,
  ...
  listExternalAddresses(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.vmwareengine.v1.IListExternalAddressesRequest,
      protos.google.cloud.vmwareengine.v1.IListExternalAddressesResponse|null|undefined,
      protos.google.cloud.vmwareengine.v1.IExternalAddress>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
 ...
 */
  ...
  fetchNetworkPolicyExternalAddresses(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.vmwareengine.v1.IFetchNetworkPolicyExternalAddressesResponse|null|undefined,
          protos.google.cloud.vmwareengine.v1.IExternalAddress>): void;
  fetchNetworkPolicyExternalAddresses(
      request: protos.google.cloud.vmwareengine.v1.IFetchNetworkPolicyExternalAddressesRequest,
      callback: PaginationCallback<
  ...
  fetchNetworkPolicyExternalAddresses(
    ...
    const wrappedCallback: PaginationCallback<
      ...
      protos.google.cloud.vmwareengine.v1.IExternalAddress>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('fetchNetworkPolicyExternalAddresses values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    ...
    return this.innerApiCalls
      ...
      ?.then(([response, input, output]: [
        ...
        this._log.info('fetchNetworkPolicyExternalAddresses values %j', response);
        return [response, input, output];
      });
  }
 ...
 */
  fetchNetworkPolicyExternalAddressesStream(
    ...
    const defaultCallSettings = this._defaults['fetchNetworkPolicyExternalAddresses'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
 ...
 */
  ...
  listSubnets(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.vmwareengine.v1.IListSubnetsResponse|null|undefined,
          protos.google.cloud.vmwareengine.v1.ISubnet>): void;
  listSubnets(
      request: protos.google.cloud.vmwareengine.v1.IListSubnetsRequest,
      callback: PaginationCallback<
          protos.google.cloud.vmwareengine.v1.IListSubnetsRequest,
  ...
  listSubnets(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.vmwareengine.v1.IListSubnetsRequest,
      protos.google.cloud.vmwareengine.v1.IListSubnetsResponse|null|undefined,
      protos.google.cloud.vmwareengine.v1.ISubnet>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
 ...
 */
  ...
  listExternalAccessRules(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.vmwareengine.v1.IListExternalAccessRulesResponse|null|undefined,
          protos.google.cloud.vmwareengine.v1.IExternalAccessRule>): void;
  listExternalAccessRules(
      request: protos.google.cloud.vmwareengine.v1.IListExternalAccessRulesRequest,
      callback: PaginationCallback<
          protos.google.cloud.vmwareengine.v1.IListExternalAccessRulesRequest,
  ...
  listExternalAccessRules(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.vmwareengine.v1.IListExternalAccessRulesRequest,
      protos.google.cloud.vmwareengine.v1.IListExternalAccessRulesResponse|null|undefined,
      protos.google.cloud.vmwareengine.v1.IExternalAccessRule>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
 ...
 */
  ...
  listLoggingServers(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.vmwareengine.v1.IListLoggingServersResponse|null|undefined,
          protos.google.cloud.vmwareengine.v1.ILoggingServer>): void;
  listLoggingServers(
      request: protos.google.cloud.vmwareengine.v1.IListLoggingServersRequest,
      callback: PaginationCallback<
          protos.google.cloud.vmwareengine.v1.IListLoggingServersRequest,
  ...
  listLoggingServers(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.vmwareengine.v1.IListLoggingServersRequest,
      protos.google.cloud.vmwareengine.v1.IListLoggingServersResponse|null|undefined,
      protos.google.cloud.vmwareengine.v1.ILoggingServer>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
 ...
 */
  ...
  listNodeTypes(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.vmwareengine.v1.IListNodeTypesResponse|null|undefined,
          protos.google.cloud.vmwareengine.v1.INodeType>): void;
  listNodeTypes(
      request: protos.google.cloud.vmwareengine.v1.IListNodeTypesRequest,
      callback: PaginationCallback<
          protos.google.cloud.vmwareengine.v1.IListNodeTypesRequest,
  ...
  listNodeTypes(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.vmwareengine.v1.IListNodeTypesRequest,
      protos.google.cloud.vmwareengine.v1.IListNodeTypesResponse|null|undefined,
      protos.google.cloud.vmwareengine.v1.INodeType>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
 ...
 */
  ...
  listNetworkPeerings(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.vmwareengine.v1.IListNetworkPeeringsResponse|null|undefined,
          protos.google.cloud.vmwareengine.v1.INetworkPeering>): void;
  listNetworkPeerings(
      request: protos.google.cloud.vmwareengine.v1.IListNetworkPeeringsRequest,
      callback: PaginationCallback<
          protos.google.cloud.vmwareengine.v1.IListNetworkPeeringsRequest,
  ...
  listNetworkPeerings(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.vmwareengine.v1.IListNetworkPeeringsRequest,
      protos.google.cloud.vmwareengine.v1.IListNetworkPeeringsResponse|null|undefined,
      protos.google.cloud.vmwareengine.v1.INetworkPeering>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
 ...
 */
  ...
  listPeeringRoutes(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.vmwareengine.v1.IListPeeringRoutesResponse|null|undefined,
          protos.google.cloud.vmwareengine.v1.IPeeringRoute>): void;
  listPeeringRoutes(
      request: protos.google.cloud.vmwareengine.v1.IListPeeringRoutesRequest,
      callback: PaginationCallback<
          protos.google.cloud.vmwareengine.v1.IListPeeringRoutesRequest,
  ...
  listPeeringRoutes(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.vmwareengine.v1.IListPeeringRoutesRequest,
      protos.google.cloud.vmwareengine.v1.IListPeeringRoutesResponse|null|undefined,
      protos.google.cloud.vmwareengine.v1.IPeeringRoute>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
 ...
 */
  ...
  listHcxActivationKeys(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.vmwareengine.v1.IListHcxActivationKeysResponse|null|undefined,
          protos.google.cloud.vmwareengine.v1.IHcxActivationKey>): void;
  listHcxActivationKeys(
      request: protos.google.cloud.vmwareengine.v1.IListHcxActivationKeysRequest,
      callback: PaginationCallback<
          protos.google.cloud.vmwareengine.v1.IListHcxActivationKeysRequest,
  ...
  listHcxActivationKeys(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.vmwareengine.v1.IListHcxActivationKeysRequest,
      protos.google.cloud.vmwareengine.v1.IListHcxActivationKeysResponse|null|undefined,
      protos.google.cloud.vmwareengine.v1.IHcxActivationKey>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
 ...
 */
  ...
  listNetworkPolicies(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.vmwareengine.v1.IListNetworkPoliciesResponse|null|undefined,
          protos.google.cloud.vmwareengine.v1.INetworkPolicy>): void;
  listNetworkPolicies(
      request: protos.google.cloud.vmwareengine.v1.IListNetworkPoliciesRequest,
      callback: PaginationCallback<
          protos.google.cloud.vmwareengine.v1.IListNetworkPoliciesRequest,
  ...
  listNetworkPolicies(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.vmwareengine.v1.IListNetworkPoliciesRequest,
      protos.google.cloud.vmwareengine.v1.IListNetworkPoliciesResponse|null|undefined,
      protos.google.cloud.vmwareengine.v1.INetworkPolicy>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
 ...
 */
  ...
  listManagementDnsZoneBindings(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.vmwareengine.v1.IListManagementDnsZoneBindingsResponse|null|undefined,
          protos.google.cloud.vmwareengine.v1.IManagementDnsZoneBinding>): void;
  listManagementDnsZoneBindings(
      request: protos.google.cloud.vmwareengine.v1.IListManagementDnsZoneBindingsRequest,
      callback: PaginationCallback<
          protos.google.cloud.vmwareengine.v1.IListManagementDnsZoneBindingsRequest,
  ...
  listManagementDnsZoneBindings(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.vmwareengine.v1.IListManagementDnsZoneBindingsRequest,
      protos.google.cloud.vmwareengine.v1.IListManagementDnsZoneBindingsResponse|null|undefined,
      protos.google.cloud.vmwareengine.v1.IManagementDnsZoneBinding>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
 ...
 */
  ...
  listVmwareEngineNetworks(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.vmwareengine.v1.IListVmwareEngineNetworksResponse|null|undefined,
          protos.google.cloud.vmwareengine.v1.IVmwareEngineNetwork>): void;
  listVmwareEngineNetworks(
      request: protos.google.cloud.vmwareengine.v1.IListVmwareEngineNetworksRequest,
      callback: PaginationCallback<
          protos.google.cloud.vmwareengine.v1.IListVmwareEngineNetworksRequest,
  ...
  listVmwareEngineNetworks(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.vmwareengine.v1.IListVmwareEngineNetworksRequest,
      protos.google.cloud.vmwareengine.v1.IListVmwareEngineNetworksResponse|null|undefined,
      protos.google.cloud.vmwareengine.v1.IVmwareEngineNetwork>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
 ...
 */
  ...
  listPrivateConnections(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.vmwareengine.v1.IListPrivateConnectionsResponse|null|undefined,
          protos.google.cloud.vmwareengine.v1.IPrivateConnection>): void;
  listPrivateConnections(
      request: protos.google.cloud.vmwareengine.v1.IListPrivateConnectionsRequest,
      callback: PaginationCallback<
          protos.google.cloud.vmwareengine.v1.IListPrivateConnectionsRequest,
  ...
  listPrivateConnections(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.vmwareengine.v1.IListPrivateConnectionsRequest,
      protos.google.cloud.vmwareengine.v1.IListPrivateConnectionsResponse|null|undefined,
      protos.google.cloud.vmwareengine.v1.IPrivateConnection>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
 ...
 */
  ...
  listPrivateConnectionPeeringRoutes(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.vmwareengine.v1.IListPrivateConnectionPeeringRoutesResponse|null|undefined,
          protos.google.cloud.vmwareengine.v1.IPeeringRoute>): void;
  listPrivateConnectionPeeringRoutes(
      request: protos.google.cloud.vmwareengine.v1.IListPrivateConnectionPeeringRoutesRequest,
      callback: PaginationCallback<
  ...
  listPrivateConnectionPeeringRoutes(
    ...
    const wrappedCallback: PaginationCallback<
      ...
      protos.google.cloud.vmwareengine.v1.IPeeringRoute>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listPrivateConnectionPeeringRoutes values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    ...
    return this.innerApiCalls
      ...
      ?.then(([response, input, output]: [
        ...
        this._log.info('listPrivateConnectionPeeringRoutes values %j', response);
        return [response, input, output];
      });
  }
...
/**
   ...
   */
  clusterPath(project:string,location:string,privateCloud:string,cluster:string) {
  ...
  matchPrivateCloudFromClusterName(clusterName: string) {
    return this.pathTemplates.clusterPathTemplate.match(clusterName).private_cloud;
  }
  ...
  matchProjectFromDnsBindPermissionName(dnsBindPermissionName: string) {
    return this.pathTemplates.dnsBindPermissionPathTemplate.match(dnsBindPermissionName).project;
  }
  ...
  matchLocationFromDnsBindPermissionName(dnsBindPermissionName: string) {
    return this.pathTemplates.dnsBindPermissionPathTemplate.match(dnsBindPermissionName).location;
  }
  ...
  matchProjectFromDnsForwardingName(dnsForwardingName: string) {
    return this.pathTemplates.dnsForwardingPathTemplate.match(dnsForwardingName).project;
  }
  ...
  matchLocationFromDnsForwardingName(dnsForwardingName: string) {
    return this.pathTemplates.dnsForwardingPathTemplate.match(dnsForwardingName).location;
  }
  ...
  matchPrivateCloudFromDnsForwardingName(dnsForwardingName: string) {
    return this.pathTemplates.dnsForwardingPathTemplate.match(dnsForwardingName).private_cloud;
  }
   ...
   * @returns {string} Resource name string.
   */
  externalAccessRulePath(project:string,location:string,networkPolicy:string,externalAccessRule:string) {
  ...
  matchProjectFromExternalAccessRuleName(externalAccessRuleName: string) {
    return this.pathTemplates.externalAccessRulePathTemplate.match(externalAccessRuleName).project;
  }
  ...
  matchLocationFromExternalAccessRuleName(externalAccessRuleName: string) {
    return this.pathTemplates.externalAccessRulePathTemplate.match(externalAccessRuleName).location;
  }
  ...
  matchNetworkPolicyFromExternalAccessRuleName(externalAccessRuleName: string) {
    return this.pathTemplates.externalAccessRulePathTemplate.match(externalAccessRuleName).network_policy;
  }
   ...
   */
  matchExternalAccessRuleFromExternalAccessRuleName(externalAccessRuleName: string) {
    return this.pathTemplates.externalAccessRulePathTemplate.match(externalAccessRuleName).external_access_rule;
  }
   ...
   * @returns {string} Resource name string.
   */
  externalAddressPath(project:string,location:string,privateCloud:string,externalAddress:string) {
  ...
  matchProjectFromExternalAddressName(externalAddressName: string) {
    return this.pathTemplates.externalAddressPathTemplate.match(externalAddressName).project;
  }
  ...
  matchLocationFromExternalAddressName(externalAddressName: string) {
    return this.pathTemplates.externalAddressPathTemplate.match(externalAddressName).location;
  }
  ...
  matchPrivateCloudFromExternalAddressName(externalAddressName: string) {
    return this.pathTemplates.externalAddressPathTemplate.match(externalAddressName).private_cloud;
  }
  ...
  matchExternalAddressFromExternalAddressName(externalAddressName: string) {
    return this.pathTemplates.externalAddressPathTemplate.match(externalAddressName).external_address;
  }
   ...
   * @returns {string} Resource name string.
   */
  hcxActivationKeyPath(project:string,location:string,privateCloud:string,hcxActivationKey:string) {
   ...
   * @returns {string} Resource name string.
   */
  loggingServerPath(project:string,location:string,privateCloud:string,loggingServer:string) {
  ...
  matchProjectFromLoggingServerName(loggingServerName: string) {
    return this.pathTemplates.loggingServerPathTemplate.match(loggingServerName).project;
  }
  ...
  matchLocationFromLoggingServerName(loggingServerName: string) {
    return this.pathTemplates.loggingServerPathTemplate.match(loggingServerName).location;
  }
  ...
  matchPrivateCloudFromLoggingServerName(loggingServerName: string) {
    return this.pathTemplates.loggingServerPathTemplate.match(loggingServerName).private_cloud;
  }
  ...
  matchLoggingServerFromLoggingServerName(loggingServerName: string) {
    return this.pathTemplates.loggingServerPathTemplate.match(loggingServerName).logging_server;
  }
   ...
   * @returns {string} Resource name string.
   */
  managementDnsZoneBindingPath(project:string,location:string,privateCloud:string,managementDnsZoneBinding:string) {
   ...
   * @returns {string} A string representing the project.
   */
  matchProjectFromManagementDnsZoneBindingName(managementDnsZoneBindingName: string) {
    return this.pathTemplates.managementDnsZoneBindingPathTemplate.match(managementDnsZoneBindingName).project;
  }
   ...
   * @returns {string} A string representing the location.
   */
  matchLocationFromManagementDnsZoneBindingName(managementDnsZoneBindingName: string) {
    return this.pathTemplates.managementDnsZoneBindingPathTemplate.match(managementDnsZoneBindingName).location;
  }
   ...
   * @returns {string} A string representing the private_cloud.
   */
  matchPrivateCloudFromManagementDnsZoneBindingName(managementDnsZoneBindingName: string) {
    return this.pathTemplates.managementDnsZoneBindingPathTemplate.match(managementDnsZoneBindingName).private_cloud;
  }
   ...
   */
  matchManagementDnsZoneBindingFromManagementDnsZoneBindingName(managementDnsZoneBindingName: string) {
    return this.pathTemplates.managementDnsZoneBindingPathTemplate.match(managementDnsZoneBindingName).management_dns_zone_binding;
  }
   ...
   * @returns {string} Resource name string.
   */
  networkPeeringPath(project:string,location:string,networkPeering:string) {
  ...
  matchProjectFromNetworkPeeringName(networkPeeringName: string) {
    return this.pathTemplates.networkPeeringPathTemplate.match(networkPeeringName).project;
  }
  ...
  matchLocationFromNetworkPeeringName(networkPeeringName: string) {
    return this.pathTemplates.networkPeeringPathTemplate.match(networkPeeringName).location;
  }
  ...
  matchNetworkPeeringFromNetworkPeeringName(networkPeeringName: string) {
    return this.pathTemplates.networkPeeringPathTemplate.match(networkPeeringName).network_peering;
  }
  ...
  matchProjectFromNetworkPolicyName(networkPolicyName: string) {
    return this.pathTemplates.networkPolicyPathTemplate.match(networkPolicyName).project;
  }
  ...
  matchLocationFromNetworkPolicyName(networkPolicyName: string) {
    return this.pathTemplates.networkPolicyPathTemplate.match(networkPolicyName).location;
  }
  ...
  matchNetworkPolicyFromNetworkPolicyName(networkPolicyName: string) {
    return this.pathTemplates.networkPolicyPathTemplate.match(networkPolicyName).network_policy;
  }
   ...
   * @returns {string} Resource name string.
   */
  nodePath(project:string,location:string,privateCloud:string,cluster:string,node:string) {
  ...
  matchNodeTypeFromNodeTypeName(nodeTypeName: string) {
    return this.pathTemplates.nodeTypePathTemplate.match(nodeTypeName).node_type;
  }
  ...
  matchProjectFromPrivateCloudName(privateCloudName: string) {
    return this.pathTemplates.privateCloudPathTemplate.match(privateCloudName).project;
  }
  ...
  matchLocationFromPrivateCloudName(privateCloudName: string) {
    return this.pathTemplates.privateCloudPathTemplate.match(privateCloudName).location;
  }
  ...
  matchPrivateCloudFromPrivateCloudName(privateCloudName: string) {
    return this.pathTemplates.privateCloudPathTemplate.match(privateCloudName).private_cloud;
  }
   ...
   * @returns {string} Resource name string.
   */
  subnetPath(project:string,location:string,privateCloud:string,subnet:string) {
  ...
  matchPrivateCloudFromSubnetName(subnetName: string) {
    return this.pathTemplates.subnetPathTemplate.match(subnetName).private_cloud;
  }
   ...
   * @returns {string} Resource name string.
   */
  vmwareEngineNetworkPath(project:string,location:string,vmwareEngineNetwork:string) {
   ...
   */
  matchVmwareEngineNetworkFromVmwareEngineNetworkName(vmwareEngineNetworkName: string) {
