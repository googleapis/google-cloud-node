...
describe('v1beta1.ConnectionServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = connectionserviceModule.v1beta1.ConnectionServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = connectionserviceModule.v1beta1.ConnectionServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'bigqueryconnection.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new connectionserviceModule.v1beta1.ConnectionServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'bigqueryconnection.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new connectionserviceModule.v1beta1.ConnectionServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'bigqueryconnection.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new connectionserviceModule.v1beta1.ConnectionServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
                    assert.strictEqual(servicePath, 'bigqueryconnection.configured.example.com');
                    if (saved) {
                        process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = saved;
                    } else {
                        delete process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new connectionserviceModule.v1beta1.ConnectionServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = connectionserviceModule.v1beta1.ConnectionServiceClient.port;
            assert(port);
    ...
    describe('createConnection', () => {
        it('invokes createConnection without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.bigquery.connection.v1beta1.CreateConnectionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.connection.v1beta1.CreateConnectionRequest', ['parent']);
        ...
        it('invokes createConnection without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createConnection(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.bigquery.connection.v1beta1.IConnection|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getConnection', () => {
        it('invokes getConnection without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.bigquery.connection.v1beta1.GetConnectionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.connection.v1beta1.GetConnectionRequest', ['name']);
    ...
    describe('listConnections', () => {
        it('invokes listConnections without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.bigquery.connection.v1beta1.ListConnectionsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.connection.v1beta1.ListConnectionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes listConnections without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listConnections(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.bigquery.connection.v1beta1.IListConnectionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateConnection', () => {
        it('invokes updateConnection without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.bigquery.connection.v1beta1.UpdateConnectionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.connection.v1beta1.UpdateConnectionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.bigquery.connection.v1beta1.Connection()
    ...
    describe('updateConnectionCredential', () => {
        it('invokes updateConnectionCredential without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.bigquery.connection.v1beta1.UpdateConnectionCredentialRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.connection.v1beta1.UpdateConnectionCredentialRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.updateConnectionCredential = stubSimpleCall(expectedResponse);
            const [response] = await client.updateConnectionCredential(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateConnectionCredential as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateConnectionCredential as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateConnectionCredential without error using callback', async () => {
            ...
            client.innerApiCalls.updateConnectionCredential = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateConnectionCredential(
                    request,
        ...
        it('invokes updateConnectionCredential with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateConnectionCredential = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateConnectionCredential(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateConnectionCredential as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateConnectionCredential as SinonStub)
    ...
    describe('deleteConnection', () => {
        it('invokes deleteConnection without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.bigquery.connection.v1beta1.DeleteConnectionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.bigquery.connection.v1beta1.DeleteConnectionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
