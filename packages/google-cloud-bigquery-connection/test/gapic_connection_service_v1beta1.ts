...
describe('v1beta1.ConnectionServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          connectionserviceModule.v1beta1.ConnectionServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          connectionserviceModule.v1beta1.ConnectionServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'bigqueryconnection.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('invokes createConnection without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createConnection(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.bigquery.connection.v1beta1.IConnection | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listConnections without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listConnections(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.bigquery.connection.v1beta1.IListConnectionsResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('updateConnectionCredential', () => {
    it('invokes updateConnectionCredential without error', async () => {
      ...
      client.innerApiCalls.updateConnectionCredential =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateConnectionCredential(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateConnectionCredential as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateConnectionCredential as SinonStub
