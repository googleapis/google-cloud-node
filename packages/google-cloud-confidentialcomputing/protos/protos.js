            ...
            cloud.confidentialcomputing = (function() {
                ...
                confidentialcomputing.v1 = (function() {
                    ...
                    v1.VerifyAttestationRequest = (function() {
                         ...
                         * @static
                         * @param {google.cloud.confidentialcomputing.v1.IVerifyAttestationRequest=} [properties] Properties to set
                         * @returns {google.cloud.confidentialcomputing.v1.VerifyAttestationRequest} VerifyAttestationRequest instance
                         */
                         ...
                         * @memberof google.cloud.confidentialcomputing.v1.VerifyAttestationRequest
                         * @static
                         * @param {google.cloud.confidentialcomputing.v1.IVerifyAttestationRequest} message VerifyAttestationRequest message or plain object to encode
                         * @param {$protobuf.Writer} [writer] Writer to encode to
                         * @returns {$protobuf.Writer} Writer
                         */
                         ...
                         * @throws {$protobuf.util.ProtocolError} If required fields are missing
                         */
                        VerifyAttestationRequest.decode = function decode(reader, length) {
                            if (!(reader instanceof $Reader))
                                reader = $Reader.create(reader);
                            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.google.cloud.confidentialcomputing.v1.VerifyAttestationRequest();
                            while (reader.pos < end) {
                                var tag = reader.uint32();
                                switch (tag >>> 3) {
                                case 1: {
                        ...
                        VerifyAttestationRequest.fromObject = function fromObject(object) {
                            ...
                            if (object.gcpCredentials != null) {
                                if (typeof object.gcpCredentials !== "object")
                                    throw TypeError(".google.cloud.confidentialcomputing.v1.VerifyAttestationRequest.gcpCredentials: object expected");
                         ...
                         * @memberof google.cloud.confidentialcomputing.v1.VerifyAttestationRequest
                         * @static
                         * @param {google.cloud.confidentialcomputing.v1.VerifyAttestationRequest} message VerifyAttestationRequest
                         * @param {$protobuf.IConversionOptions} [options] Conversion options
                         * @returns {Object.<string,*>} Plain object
                         */
                        ...
                        VerifyAttestationRequest.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                            ...
                            return typeUrlPrefix + "/google.cloud.confidentialcomputing.v1.VerifyAttestationRequest";
                        };
                    ...
                    v1.VerifyAttestationResponse = (function() {
                         ...
                         * @property {string|null} [oidcClaimsToken] VerifyAttestationResponse oidcClaimsToken
                         */
                         ...
                         * @constructor
                         * @param {google.cloud.confidentialcomputing.v1.IVerifyAttestationResponse=} [properties] Properties to set
                         */
                         ...
                         * @member {string} oidcClaimsToken
                         * @memberof google.cloud.confidentialcomputing.v1.VerifyAttestationResponse
                         * @instance
                         */
                        VerifyAttestationResponse.prototype.oidcClaimsToken = "";
                         ...
                         * @static
                         * @param {google.cloud.confidentialcomputing.v1.IVerifyAttestationResponse=} [properties] Properties to set
                         * @returns {google.cloud.confidentialcomputing.v1.VerifyAttestationResponse} VerifyAttestationResponse instance
                         */
                         ...
                         * @memberof google.cloud.confidentialcomputing.v1.VerifyAttestationResponse
                         * @static
                         * @param {google.cloud.confidentialcomputing.v1.IVerifyAttestationResponse} message VerifyAttestationResponse message or plain object to encode
                         * @param {$protobuf.Writer} [writer] Writer to encode to
                         * @returns {$protobuf.Writer} Writer
                         */
                        VerifyAttestationResponse.encode = function encode(message, writer) {
                            if (!writer)
                                writer = $Writer.create();
                            if (message.oidcClaimsToken != null && Object.hasOwnProperty.call(message, "oidcClaimsToken"))
                                writer.uint32(/* id 2, wireType 2 =*/18).string(message.oidcClaimsToken);
                            return writer;
                        };
                         ...
                         * @throws {$protobuf.util.ProtocolError} If required fields are missing
                         */
                        VerifyAttestationResponse.decode = function decode(reader, length) {
                            if (!(reader instanceof $Reader))
                                reader = $Reader.create(reader);
                            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.google.cloud.confidentialcomputing.v1.VerifyAttestationResponse();
                            while (reader.pos < end) {
                                var tag = reader.uint32();
                                switch (tag >>> 3) {
                                case 2: {
                        ...
                        VerifyAttestationResponse.verify = function verify(message) {
                            if (typeof message !== "object" || message === null)
                                return "object expected";
                            if (message.oidcClaimsToken != null && message.hasOwnProperty("oidcClaimsToken"))
                                if (!$util.isString(message.oidcClaimsToken))
                                    return "oidcClaimsToken: string expected";
                            return null;
                        };
                        ...
                        VerifyAttestationResponse.fromObject = function fromObject(object) {
                            if (object instanceof $root.google.cloud.confidentialcomputing.v1.VerifyAttestationResponse)
                                return object;
                            var message = new $root.google.cloud.confidentialcomputing.v1.VerifyAttestationResponse();
                            if (object.oidcClaimsToken != null)
                                message.oidcClaimsToken = String(object.oidcClaimsToken);
                            return message;
                        };
                         ...
                         * @memberof google.cloud.confidentialcomputing.v1.VerifyAttestationResponse
                         * @static
                         * @param {google.cloud.confidentialcomputing.v1.VerifyAttestationResponse} message VerifyAttestationResponse
                         * @param {$protobuf.IConversionOptions} [options] Conversion options
                         * @returns {Object.<string,*>} Plain object
                         */
                        VerifyAttestationResponse.toObject = function toObject(message, options) {
                            ...
                            var object = {};
                            if (options.defaults)
                                object.oidcClaimsToken = "";
                            if (message.oidcClaimsToken != null && message.hasOwnProperty("oidcClaimsToken"))
                                object.oidcClaimsToken = message.oidcClaimsToken;
                            return object;
                        };
                        ...
                        VerifyAttestationResponse.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                            ...
                            return typeUrlPrefix + "/google.cloud.confidentialcomputing.v1.VerifyAttestationResponse";
                        };
    
                        return VerifyAttestationResponse;
                    })();
    
                    v1.GcpCredentials = (function() {
    
                        /**
                         * Properties of a GcpCredentials.
                         * @memberof google.cloud.confidentialcomputing.v1
                         * @interface IGcpCredentials
                         * @property {Array.<string>|null} [serviceAccountIdTokens] GcpCredentials serviceAccountIdTokens
                         */
                         ...
                         * @constructor
                         * @param {google.cloud.confidentialcomputing.v1.IGcpCredentials=} [properties] Properties to set
                         */
                        function GcpCredentials(properties) {
                            this.serviceAccountIdTokens = [];
                            if (properties)
                                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                                    if (properties[keys[i]] != null)
                                        this[keys[i]] = properties[keys[i]];
                         ...
                         * @member {Array.<string>} serviceAccountIdTokens
                         * @memberof google.cloud.confidentialcomputing.v1.GcpCredentials
                         * @instance
                         */
                        GcpCredentials.prototype.serviceAccountIdTokens = $util.emptyArray;
                         ...
                         * @static
                         * @param {google.cloud.confidentialcomputing.v1.IGcpCredentials=} [properties] Properties to set
                         * @returns {google.cloud.confidentialcomputing.v1.GcpCredentials} GcpCredentials instance
                         */
                         ...
                         * @memberof google.cloud.confidentialcomputing.v1.GcpCredentials
                         * @static
                         * @param {google.cloud.confidentialcomputing.v1.IGcpCredentials} message GcpCredentials message or plain object to encode
                         * @param {$protobuf.Writer} [writer] Writer to encode to
                         * @returns {$protobuf.Writer} Writer
                         */
                        GcpCredentials.encode = function encode(message, writer) {
                            if (!writer)
                                writer = $Writer.create();
                            if (message.serviceAccountIdTokens != null && message.serviceAccountIdTokens.length)
                                for (var i = 0; i < message.serviceAccountIdTokens.length; ++i)
                                    writer.uint32(/* id 2, wireType 2 =*/18).string(message.serviceAccountIdTokens[i]);
                            return writer;
                        };
                         ...
                         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                         * @param {number} [length] Message length if known beforehand
                         * @returns {google.cloud.confidentialcomputing.v1.GcpCredentials} GcpCredentials
                         * @throws {Error} If the payload is not a reader or valid buffer
                         * @throws {$protobuf.util.ProtocolError} If required fields are missing
                         */
                        GcpCredentials.decode = function decode(reader, length) {
                            if (!(reader instanceof $Reader))
                                reader = $Reader.create(reader);
                            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.google.cloud.confidentialcomputing.v1.GcpCredentials();
                            while (reader.pos < end) {
                                var tag = reader.uint32();
                                switch (tag >>> 3) {
                                case 2: {
                                        if (!(message.serviceAccountIdTokens && message.serviceAccountIdTokens.length))
                                            message.serviceAccountIdTokens = [];
                        ...
                        GcpCredentials.verify = function verify(message) {
                            if (typeof message !== "object" || message === null)
                                return "object expected";
                            if (message.serviceAccountIdTokens != null && message.hasOwnProperty("serviceAccountIdTokens")) {
                                if (!Array.isArray(message.serviceAccountIdTokens))
                                    return "serviceAccountIdTokens: array expected";
                                for (var i = 0; i < message.serviceAccountIdTokens.length; ++i)
                                    if (!$util.isString(message.serviceAccountIdTokens[i]))
                                        return "serviceAccountIdTokens: string[] expected";
                            }
                            return null;
                        };
                        ...
                        GcpCredentials.fromObject = function fromObject(object) {
                            if (object instanceof $root.google.cloud.confidentialcomputing.v1.GcpCredentials)
                                return object;
                            var message = new $root.google.cloud.confidentialcomputing.v1.GcpCredentials();
                            if (object.serviceAccountIdTokens) {
                                if (!Array.isArray(object.serviceAccountIdTokens))
                                    throw TypeError(".google.cloud.confidentialcomputing.v1.GcpCredentials.serviceAccountIdTokens: array expected");
                                message.serviceAccountIdTokens = [];
                                for (var i = 0; i < object.serviceAccountIdTokens.length; ++i)
                                    message.serviceAccountIdTokens[i] = String(object.serviceAccountIdTokens[i]);
                            }
                            return message;
                        };
                         ...
                         * @memberof google.cloud.confidentialcomputing.v1.GcpCredentials
                         * @static
                         * @param {google.cloud.confidentialcomputing.v1.GcpCredentials} message GcpCredentials
                         * @param {$protobuf.IConversionOptions} [options] Conversion options
                         * @returns {Object.<string,*>} Plain object
                         */
                        GcpCredentials.toObject = function toObject(message, options) {
                            ...
                            if (options.arrays || options.defaults)
                                object.serviceAccountIdTokens = [];
                            if (message.serviceAccountIdTokens && message.serviceAccountIdTokens.length) {
                                object.serviceAccountIdTokens = [];
                                for (var j = 0; j < message.serviceAccountIdTokens.length; ++j)
                                    object.serviceAccountIdTokens[j] = message.serviceAccountIdTokens[j];
                            }
                            return object;
                        };
                        ...
                        GcpCredentials.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                            ...
                            return typeUrlPrefix + "/google.cloud.confidentialcomputing.v1.GcpCredentials";
                        };
                    ...
                    v1.TpmAttestation = (function() {
                         ...
                         * @property {Array.<google.cloud.confidentialcomputing.v1.TpmAttestation.IQuote>|null} [quotes] TpmAttestation quotes
                         ...
                         * @constructor
                         * @param {google.cloud.confidentialcomputing.v1.ITpmAttestation=} [properties] Properties to set
                         */
                         ...
                         * @member {Array.<google.cloud.confidentialcomputing.v1.TpmAttestation.IQuote>} quotes
                         ...
                         * @static
                         * @param {google.cloud.confidentialcomputing.v1.ITpmAttestation=} [properties] Properties to set
                         * @returns {google.cloud.confidentialcomputing.v1.TpmAttestation} TpmAttestation instance
                         */
                         ...
                         * @memberof google.cloud.confidentialcomputing.v1.TpmAttestation
                         * @static
                         * @param {google.cloud.confidentialcomputing.v1.ITpmAttestation} message TpmAttestation message or plain object to encode
                         * @param {$protobuf.Writer} [writer] Writer to encode to
                         * @returns {$protobuf.Writer} Writer
                         */
                        TpmAttestation.encode = function encode(message, writer) {
                            ...
                            if (message.quotes != null && message.quotes.length)
                                for (var i = 0; i < message.quotes.length; ++i)
                                    $root.google.cloud.confidentialcomputing.v1.TpmAttestation.Quote.encode(message.quotes[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
                         ...
                         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                         * @param {number} [length] Message length if known beforehand
                         * @returns {google.cloud.confidentialcomputing.v1.TpmAttestation} TpmAttestation
                         * @throws {Error} If the payload is not a reader or valid buffer
                         * @throws {$protobuf.util.ProtocolError} If required fields are missing
                         */
                        TpmAttestation.decode = function decode(reader, length) {
                            if (!(reader instanceof $Reader))
                                reader = $Reader.create(reader);
                            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.google.cloud.confidentialcomputing.v1.TpmAttestation();
                            while (reader.pos < end) {
                                var tag = reader.uint32();
                                switch (tag >>> 3) {
                                case 1: {
                                        if (!(message.quotes && message.quotes.length))
                                            message.quotes = [];
                                        message.quotes.push($root.google.cloud.confidentialcomputing.v1.TpmAttestation.Quote.decode(reader, reader.uint32()));
                                        break;
                                    }
                                case 2: {
                        ...
                        TpmAttestation.verify = function verify(message) {
                            ...
                            if (message.quotes != null && message.hasOwnProperty("quotes")) {
                                ...
                                for (var i = 0; i < message.quotes.length; ++i) {
                                    var error = $root.google.cloud.confidentialcomputing.v1.TpmAttestation.Quote.verify(message.quotes[i]);
                                    if (error)
                                        return "quotes." + error;
                                }
                            }
                        ...
                        TpmAttestation.fromObject = function fromObject(object) {
                            if (object instanceof $root.google.cloud.confidentialcomputing.v1.TpmAttestation)
                                return object;
                            var message = new $root.google.cloud.confidentialcomputing.v1.TpmAttestation();
                            if (object.quotes) {
                                if (!Array.isArray(object.quotes))
                                    throw TypeError(".google.cloud.confidentialcomputing.v1.TpmAttestation.quotes: array expected");
                                message.quotes = [];
                                for (var i = 0; i < object.quotes.length; ++i) {
                                    if (typeof object.quotes[i] !== "object")
                                        throw TypeError(".google.cloud.confidentialcomputing.v1.TpmAttestation.quotes: object expected");
                                    message.quotes[i] = $root.google.cloud.confidentialcomputing.v1.TpmAttestation.Quote.fromObject(object.quotes[i]);
                                }
                            }
                            ...
                            if (object.certChain) {
                                if (!Array.isArray(object.certChain))
                                    throw TypeError(".google.cloud.confidentialcomputing.v1.TpmAttestation.certChain: array expected");
                                message.certChain = [];
                         ...
                         * @memberof google.cloud.confidentialcomputing.v1.TpmAttestation
                         * @static
                         * @param {google.cloud.confidentialcomputing.v1.TpmAttestation} message TpmAttestation
                         * @param {$protobuf.IConversionOptions} [options] Conversion options
                         * @returns {Object.<string,*>} Plain object
                         */
                        TpmAttestation.toObject = function toObject(message, options) {
                            ...
                            if (message.quotes && message.quotes.length) {
                                ...
                                for (var j = 0; j < message.quotes.length; ++j)
                                    object.quotes[j] = $root.google.cloud.confidentialcomputing.v1.TpmAttestation.Quote.toObject(message.quotes[j], options);
                            }
                            if (message.tcgEventLog != null && message.hasOwnProperty("tcgEventLog"))
                        ...
                        TpmAttestation.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                            ...
                            return typeUrlPrefix + "/google.cloud.confidentialcomputing.v1.TpmAttestation";
                        };
                        ...
                        TpmAttestation.Quote = (function() {
                             ...
                             * @implements IQuote
                             * @constructor
                             * @param {google.cloud.confidentialcomputing.v1.TpmAttestation.IQuote=} [properties] Properties to set
                             */
                             ...
                             * @memberof google.cloud.confidentialcomputing.v1.TpmAttestation.Quote
                             * @instance
                             */
                             ...
                             * @static
                             * @param {google.cloud.confidentialcomputing.v1.TpmAttestation.IQuote=} [properties] Properties to set
                             * @returns {google.cloud.confidentialcomputing.v1.TpmAttestation.Quote} Quote instance
                             */
                             ...
                             * @memberof google.cloud.confidentialcomputing.v1.TpmAttestation.Quote
                             * @static
                             * @param {google.cloud.confidentialcomputing.v1.TpmAttestation.IQuote} message Quote message or plain object to encode
                             * @param {$protobuf.Writer} [writer] Writer to encode to
                             * @returns {$protobuf.Writer} Writer
                             */
                             ...
                             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                             * @param {number} [length] Message length if known beforehand
                             * @returns {google.cloud.confidentialcomputing.v1.TpmAttestation.Quote} Quote
                             * @throws {Error} If the payload is not a reader or valid buffer
                             * @throws {$protobuf.util.ProtocolError} If required fields are missing
                             */
                            Quote.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.google.cloud.confidentialcomputing.v1.TpmAttestation.Quote(), key, value;
                                while (reader.pos < end) {
                                    var tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1: {
                            ...
                            Quote.fromObject = function fromObject(object) {
                                if (object instanceof $root.google.cloud.confidentialcomputing.v1.TpmAttestation.Quote)
                                    return object;
                                var message = new $root.google.cloud.confidentialcomputing.v1.TpmAttestation.Quote();
                                if (object.hashAlgo != null)
                                    message.hashAlgo = object.hashAlgo | 0;
                                if (object.pcrValues) {
                                    if (typeof object.pcrValues !== "object")
                                        throw TypeError(".google.cloud.confidentialcomputing.v1.TpmAttestation.Quote.pcrValues: object expected");
                                    message.pcrValues = {};
                             ...
                             * @memberof google.cloud.confidentialcomputing.v1.TpmAttestation.Quote
                             * @static
                             * @param {google.cloud.confidentialcomputing.v1.TpmAttestation.Quote} message Quote
                             * @param {$protobuf.IConversionOptions} [options] Conversion options
                             * @returns {Object.<string,*>} Plain object
                             */
                            ...
                            Quote.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                                ...
                                return typeUrlPrefix + "/google.cloud.confidentialcomputing.v1.TpmAttestation.Quote";
                            };
