...
describe('v1.ConfidentialComputingClient', () => {
  ...
  describe('verifyConfidentialSpace', () => {
    it('invokes verifyConfidentialSpace without error', async () => {
      ...
      client.innerApiCalls.verifyConfidentialSpace =
        stubSimpleCall(expectedResponse);
      const [response] = await client.verifyConfidentialSpace(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.verifyConfidentialSpace as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.verifyConfidentialSpace as SinonStub
    ...
    it('invokes verifyConfidentialSpace without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.verifyConfidentialSpace(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.confidentialcomputing.v1.IVerifyConfidentialSpaceResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes verifyConfidentialSpace with error', async () => {
      ...
      const expectedHeaderRequestParams = `challenge=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.verifyConfidentialSpace = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('verifyConfidentialGke', () => {
    it('invokes verifyConfidentialGke without error', async () => {
      ...
      client.innerApiCalls.verifyConfidentialGke =
        stubSimpleCall(expectedResponse);
      const [response] = await client.verifyConfidentialGke(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.verifyConfidentialGke as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.verifyConfidentialGke as SinonStub
    ...
    it('invokes verifyConfidentialGke without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.verifyConfidentialGke(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.confidentialcomputing.v1.IVerifyConfidentialGkeResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes verifyConfidentialGke with error', async () => {
      ...
      const expectedHeaderRequestParams = `challenge=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.verifyConfidentialGke = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
