...
describe('v3beta1.SessionsClient', () => {
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new sessionsModule.v3beta1.SessionsClient({
          universe_domain: 'example.com',
    ...
    it('invokes detectIntent without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.detectIntent(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3beta1.IDetectIntentResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes matchIntent without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.matchIntent(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3beta1.IMatchIntentResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes fulfillIntent without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.fulfillIntent(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3beta1.IFulfillIntentResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes submitAnswerFeedback without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.submitAnswerFeedback(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3beta1.IAnswerFeedback | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes serverStreamingDetectIntent without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        stream.on(
          'data',
          (
            response: protos.google.cloud.dialogflow.cx.v3beta1.DetectIntentResponse
          ) => {
            resolve(response);
          }
        );
    ...
    it('invokes streamingDetectIntent without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        stream.on(
          'data',
          (
            response: protos.google.cloud.dialogflow.cx.v3beta1.StreamingDetectIntentResponse
          ) => {
            resolve(response);
          }
        );
