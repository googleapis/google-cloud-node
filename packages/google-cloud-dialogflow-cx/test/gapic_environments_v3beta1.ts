...
describe('v3beta1.EnvironmentsClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          environmentsModule.v3beta1.EnvironmentsClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          environmentsModule.v3beta1.EnvironmentsClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new environmentsModule.v3beta1.EnvironmentsClient({
          universe_domain: 'example.com',
    ...
    it('invokes getEnvironment without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getEnvironment(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3beta1.IEnvironment | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('deployFlow', () => {
    ...
    it('invokes deployFlow without error using callback', async () => {
      ...
      client.innerApiCalls.deployFlow =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.deployFlow(
          request,
    ...
    it('invokes checkDeployFlowProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkDeployFlowProgress(
        expectedResponse.name,
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('listEnvironments', () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listEnvironments(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.dialogflow.cx.v3beta1.IEnvironment[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listEnvironmentsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.cx.v3beta1.Environment) => {
