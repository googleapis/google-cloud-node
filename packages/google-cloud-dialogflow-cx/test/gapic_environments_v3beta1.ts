...
describe('v3beta1.EnvironmentsClient', () => {
  ...
  describe('deleteEnvironment', () => {
    ...
    it('invokes deleteEnvironment without error using callback', async () => {
      ...
      client.innerApiCalls.deleteEnvironment = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('updateEnvironment', () => {
    ...
    it('invokes updateEnvironment without error using callback', async () => {
      ...
      client.innerApiCalls.updateEnvironment = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('lookupEnvironmentHistory', () => {
    ...
    it('invokes lookupEnvironmentHistory without error using callback', async () => {
      ...
      client.innerApiCalls.lookupEnvironmentHistory = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes lookupEnvironmentHistoryStream without error', async () => {
      ...
      client.descriptors.page.lookupEnvironmentHistory.createStream = stubPageStreamingCall(
        expectedResponse
      );
    ...
    it('uses async iteration with lookupEnvironmentHistory without error', async () => {
      ...
      client.descriptors.page.lookupEnvironmentHistory.asyncIterate = stubAsyncIterationCall(
        expectedResponse
      );
      const responses: protos.google.cloud.dialogflow.cx.v3beta1.IEnvironment[] = [];
