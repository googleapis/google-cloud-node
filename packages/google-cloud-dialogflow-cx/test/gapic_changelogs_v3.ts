...
describe('v3.ChangelogsClient', () => {
  describe('Common methods', () => {
    ...
    it('has port', () => {
      const port = changelogsModule.v3.ChangelogsClient.port;
      assert(port);
  ...
  describe('getChangelog', () => {
    it('invokes getChangelog without error', async () => {
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.dialogflow.cx.v3.Changelog(),
      );
    ...
    it('invokes getChangelog without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getChangelog(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3.IChangelog | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listChangelogs', () => {
    it('invokes listChangelogs without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.dialogflow.cx.v3.ListChangelogsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
    ...
    it('invokes listChangelogsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.dialogflow.cx.v3.Changelog[] = [];
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.cx.v3.Changelog) => {
    ...
    it('uses async iteration with listChangelogs without error', async () => {
      ...
      const responses: protos.google.cloud.dialogflow.cx.v3.IChangelog[] = [];
