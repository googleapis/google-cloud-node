  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          environmentsModule.v3.EnvironmentsClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          environmentsModule.v3.EnvironmentsClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new environmentsModule.v3.EnvironmentsClient({
          universe_domain: 'example.com',
    ...
    it('invokes getEnvironment without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getEnvironment(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3.IEnvironment | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listEnvironments', () => {
    ...
    it('invokes listEnvironmentsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.cx.v3.Environment) => {
    ...
    it('invokes listContinuousTestResultsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.dialogflow.cx.v3.ContinuousTestResult
          ) => {
            responses.push(response);
          }
        );
