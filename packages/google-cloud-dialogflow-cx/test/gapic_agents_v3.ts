...
describe('v3.AgentsClient', () => {
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new agentsModule.v3.AgentsClient({
          universe_domain: 'example.com',
    ...
    it('invokes getAgent without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getAgent(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3.IAgent | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('validateAgent', () => {
    it('invokes validateAgent without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.validateAgent as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.validateAgent as SinonStub
    ...
    it('invokes validateAgent without error using callback', async () => {
      ...
      client.innerApiCalls.validateAgent =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.validateAgent(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3.IAgentValidationResult | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getAgentValidationResult', () => {
    it('invokes getAgentValidationResult without error', async () => {
      ...
      client.innerApiCalls.getAgentValidationResult =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getAgentValidationResult(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getAgentValidationResult as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getAgentValidationResult as SinonStub
  ...
  describe('getGenerativeSettings', () => {
    it('invokes getGenerativeSettings without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getGenerativeSettings as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getGenerativeSettings as SinonStub
    ...
    it('invokes getGenerativeSettings without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getGenerativeSettings(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3.IGenerativeSettings | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getGenerativeSettings with error', async () => {
      ...
      await assert.rejects(
        client.getGenerativeSettings(request),
        expectedError
      );
      const actualRequest = (
        client.innerApiCalls.getGenerativeSettings as SinonStub
  ...
  describe('updateGenerativeSettings', () => {
    it('invokes updateGenerativeSettings without error', async () => {
      ...
      client.innerApiCalls.updateGenerativeSettings =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateGenerativeSettings(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateGenerativeSettings as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateGenerativeSettings as SinonStub
  ...
  describe('exportAgent', () => {
    ...
    it('invokes exportAgent without error using callback', async () => {
      ...
      client.innerApiCalls.exportAgent =
      ...
      const promise = new Promise((resolve, reject) => {
        client.exportAgent(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.dialogflow.cx.v3.IExportAgentResponse,
  ...
  describe('restoreAgent', () => {
    ...
    it('invokes restoreAgent without error using callback', async () => {
      ...
      client.innerApiCalls.restoreAgent =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.restoreAgent(
          request,
  ...
  describe('listAgents', () => {
    ...
    it('invokes listAgentsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.cx.v3.Agent) => {
