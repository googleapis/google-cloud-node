...
describe('v3.AgentsClient', () => {
  ...
  describe('createAgent', () => {
    ...
    it('invokes createAgent without error using callback', async () => {
      ...
      client.innerApiCalls.createAgent = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.createAgent(
  ...
  describe('updateAgent', () => {
    ...
    it('invokes updateAgent without error using callback', async () => {
      ...
      client.innerApiCalls.updateAgent = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.updateAgent(
  ...
  describe('validateAgent', () => {
    ...
    it('invokes validateAgent without error using callback', async () => {
      ...
      client.innerApiCalls.validateAgent = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('getAgentValidationResult', () => {
    ...
    it('invokes getAgentValidationResult without error using callback', async () => {
      ...
      client.innerApiCalls.getAgentValidationResult = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('exportAgent', () => {
    ...
    it('invokes exportAgent without error using callback', async () => {
      ...
      client.innerApiCalls.exportAgent = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.exportAgent(
  ...
  describe('restoreAgent', () => {
    ...
    it('invokes restoreAgent without error using callback', async () => {
      ...
      client.innerApiCalls.restoreAgent = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.restoreAgent(
  ...
  describe('listAgents', () => {
    ...
    it('invokes listAgentsStream without error', async () => {
      ...
      assert.strictEqual(
        (client.descriptors.page.listAgents.createStream as SinonStub).getCall(
          0
