...
describe('v3beta1.ExperimentsClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = experimentsModule.v3beta1.ExperimentsClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = experimentsModule.v3beta1.ExperimentsClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new experimentsModule.v3beta1.ExperimentsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new experimentsModule.v3beta1.ExperimentsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new experimentsModule.v3beta1.ExperimentsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new experimentsModule.v3beta1.ExperimentsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = experimentsModule.v3beta1.ExperimentsClient.port;
            assert(port);
    ...
    describe('getExperiment', () => {
        it('invokes getExperiment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.GetExperimentRequest', ['name']);
        ...
        it('invokes getExperiment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getExperiment(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3beta1.IExperiment|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createExperiment', () => {
        it('invokes createExperiment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.CreateExperimentRequest', ['parent']);
    ...
    describe('updateExperiment', () => {
        it('invokes updateExperiment without error', async () => {
            ...
            request.experiment ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.UpdateExperimentRequest', ['experiment', 'name']);
    ...
    describe('deleteExperiment', () => {
        it('invokes deleteExperiment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.DeleteExperimentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('startExperiment', () => {
        it('invokes startExperiment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.StartExperimentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.Experiment()
    ...
    describe('stopExperiment', () => {
        it('invokes stopExperiment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.StopExperimentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.Experiment()
    ...
    describe('listExperiments', () => {
        it('invokes listExperiments without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.ListExperimentsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.Experiment()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.Experiment()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.Experiment()),
            ];
        ...
        it('invokes listExperimentsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.cx.v3beta1.Experiment[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3beta1.Experiment) => {
        ...
        it('uses async iteration with listExperiments without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.cx.v3beta1.IExperiment[] = [];
