...
describe('v3beta1.WebhooksClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new webhooksModule.v3beta1.WebhooksClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new webhooksModule.v3beta1.WebhooksClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new webhooksModule.v3beta1.WebhooksClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new webhooksModule.v3beta1.WebhooksClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getWebhook', () => {
        it('invokes getWebhook without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.GetWebhookRequest', ['name']);
        ...
        it('invokes getWebhook without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getWebhook(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3beta1.IWebhook|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createWebhook', () => {
        it('invokes createWebhook without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.CreateWebhookRequest', ['parent']);
    ...
    describe('updateWebhook', () => {
        it('invokes updateWebhook without error', async () => {
            ...
            request.webhook ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.UpdateWebhookRequest', ['webhook', 'name']);
    ...
    describe('deleteWebhook', () => {
        it('invokes deleteWebhook without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.DeleteWebhookRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listWebhooks', () => {
        it('invokes listWebhooks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.ListWebhooksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.Webhook()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.Webhook()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.Webhook()),
            ];
        ...
        it('invokes listWebhooksStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3beta1.Webhook) => {
