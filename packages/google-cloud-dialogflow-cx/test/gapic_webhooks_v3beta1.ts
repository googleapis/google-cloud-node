...
describe('v3beta1.WebhooksClient', () => {
  ...
  describe('getWebhook', () => {
    ...
    it('invokes getWebhook without error using callback', async () => {
      ...
      client.innerApiCalls.getWebhook = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.getWebhook(
  ...
  describe('createWebhook', () => {
    ...
    it('invokes createWebhook without error using callback', async () => {
      ...
      client.innerApiCalls.createWebhook = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('updateWebhook', () => {
    ...
    it('invokes updateWebhook without error using callback', async () => {
      ...
      client.innerApiCalls.updateWebhook = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('deleteWebhook', () => {
    ...
    it('invokes deleteWebhook without error using callback', async () => {
      ...
      client.innerApiCalls.deleteWebhook = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('listWebhooks', () => {
    ...
    it('invokes listWebhooks without error using callback', async () => {
      ...
      client.innerApiCalls.listWebhooks = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.listWebhooks(
    ...
    it('invokes listWebhooksStream without error', async () => {
      ...
      assert.strictEqual(
        (client.descriptors.page.listWebhooks
    ...
    it('uses async iteration with listWebhooks without error', async () => {
      ...
      client.descriptors.page.listWebhooks.asyncIterate = stubAsyncIterationCall(
        expectedResponse
      );
