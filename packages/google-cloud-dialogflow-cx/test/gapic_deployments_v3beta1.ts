...
describe('v3beta1.DeploymentsClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          deploymentsModule.v3beta1.DeploymentsClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          deploymentsModule.v3beta1.DeploymentsClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new deploymentsModule.v3beta1.DeploymentsClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = deploymentsModule.v3beta1.DeploymentsClient.port;
      assert(port);
  ...
  describe('getDeployment', () => {
    it('invokes getDeployment without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.dialogflow.cx.v3beta1.GetDeploymentRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.dialogflow.cx.v3beta1.Deployment(),
      );
    ...
    it('invokes getDeployment without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDeployment(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3beta1.IDeployment | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listDeployments', () => {
    it('invokes listDeployments without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.dialogflow.cx.v3beta1.ListDeploymentsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
    ...
    it('invokes listDeploymentsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.dialogflow.cx.v3beta1.Deployment[] =
          [];
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.cx.v3beta1.Deployment) => {
    ...
    it('uses async iteration with listDeployments without error', async () => {
      ...
      const responses: protos.google.cloud.dialogflow.cx.v3beta1.IDeployment[] =
        [];
