  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          sessionentitytypesModule.v3.SessionEntityTypesClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          sessionentitytypesModule.v3.SessionEntityTypesClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new sessionentitytypesModule.v3.SessionEntityTypesClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'dialogflow.example.com');
          if (saved) {
    ...
    it('invokes getSessionEntityType without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getSessionEntityType(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3.ISessionEntityType | null,
          ) => {
            if (err) {
              reject(err);
            } else {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listSessionEntityTypes(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.dialogflow.cx.v3.ISessionEntityType[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listSessionEntityTypesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.dialogflow.cx.v3.SessionEntityType,
          ) => {
