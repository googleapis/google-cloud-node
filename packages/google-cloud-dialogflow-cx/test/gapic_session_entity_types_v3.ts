...
describe('v3.SessionEntityTypesClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = sessionentitytypesModule.v3.SessionEntityTypesClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = sessionentitytypesModule.v3.SessionEntityTypesClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new sessionentitytypesModule.v3.SessionEntityTypesClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new sessionentitytypesModule.v3.SessionEntityTypesClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new sessionentitytypesModule.v3.SessionEntityTypesClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new sessionentitytypesModule.v3.SessionEntityTypesClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = sessionentitytypesModule.v3.SessionEntityTypesClient.port;
            assert(port);
    ...
    describe('getSessionEntityType', () => {
        it('invokes getSessionEntityType without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.GetSessionEntityTypeRequest', ['name']);
        ...
        it('invokes getSessionEntityType without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getSessionEntityType(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3.ISessionEntityType|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createSessionEntityType', () => {
        it('invokes createSessionEntityType without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.CreateSessionEntityTypeRequest', ['parent']);
    ...
    describe('updateSessionEntityType', () => {
        it('invokes updateSessionEntityType without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.UpdateSessionEntityTypeRequest', ['sessionEntityType', 'name']);
    ...
    describe('deleteSessionEntityType', () => {
        it('invokes deleteSessionEntityType without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.DeleteSessionEntityTypeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listSessionEntityTypes', () => {
        it('invokes listSessionEntityTypes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.ListSessionEntityTypesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.SessionEntityType()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.SessionEntityType()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.SessionEntityType()),
            ];
        ...
        it('invokes listSessionEntityTypesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.cx.v3.SessionEntityType[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3.SessionEntityType) => {
        ...
        it('uses async iteration with listSessionEntityTypes without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.cx.v3.ISessionEntityType[] = [];
