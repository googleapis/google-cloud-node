...
describe('v3beta1.TestCasesClient', () => {
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new testcasesModule.v3beta1.TestCasesClient({
          universe_domain: 'example.com',
    ...
    it('invokes getTestCase without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getTestCase(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3beta1.ITestCase | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes calculateCoverage without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.calculateCoverage(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3beta1.ICalculateCoverageResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listTestCases', () => {
    ...
    it('invokes listTestCasesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.cx.v3beta1.TestCase) => {
    ...
    it('invokes listTestCaseResultsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.dialogflow.cx.v3beta1.TestCaseResult
          ) => {
            responses.push(response);
          }
        );
