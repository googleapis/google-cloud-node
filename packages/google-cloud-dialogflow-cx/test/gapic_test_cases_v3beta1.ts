...
describe('v3beta1.TestCasesClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = testcasesModule.v3beta1.TestCasesClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = testcasesModule.v3beta1.TestCasesClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new testcasesModule.v3beta1.TestCasesClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new testcasesModule.v3beta1.TestCasesClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new testcasesModule.v3beta1.TestCasesClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new testcasesModule.v3beta1.TestCasesClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = testcasesModule.v3beta1.TestCasesClient.port;
            assert(port);
    ...
    describe('batchDeleteTestCases', () => {
        it('invokes batchDeleteTestCases without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.BatchDeleteTestCasesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.BatchDeleteTestCasesRequest', ['parent']);
    ...
    describe('getTestCase', () => {
        it('invokes getTestCase without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.GetTestCaseRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.GetTestCaseRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.TestCase()
            );
        ...
        it('invokes getTestCase without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getTestCase(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3beta1.ITestCase|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createTestCase', () => {
        it('invokes createTestCase without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.CreateTestCaseRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.CreateTestCaseRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.TestCase()
    ...
    describe('updateTestCase', () => {
        it('invokes updateTestCase without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.UpdateTestCaseRequest()
            );
            request.testCase ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.UpdateTestCaseRequest', ['testCase', 'name']);
    ...
    describe('calculateCoverage', () => {
        it('invokes calculateCoverage without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.CalculateCoverageRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.CalculateCoverageRequest', ['agent']);
            request.agent = defaultValue1;
            const expectedHeaderRequestParams = `agent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.CalculateCoverageResponse()
            );
        ...
        it('invokes calculateCoverage without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.calculateCoverage(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3beta1.ICalculateCoverageResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getTestCaseResult', () => {
        it('invokes getTestCaseResult without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.GetTestCaseResultRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getTestCaseResult without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getTestCaseResult(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3beta1.ITestCaseResult|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('runTestCase', () => {
        it('invokes runTestCase without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.RunTestCaseRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes runTestCase without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.runTestCase(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dialogflow.cx.v3beta1.IRunTestCaseResponse, protos.google.cloud.dialogflow.cx.v3beta1.IRunTestCaseMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dialogflow.cx.v3beta1.IRunTestCaseResponse, protos.google.cloud.dialogflow.cx.v3beta1.IRunTestCaseMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.runTestCase as SinonStub)
                .getCall(0).args[0];
    ...
    describe('batchRunTestCases', () => {
        it('invokes batchRunTestCases without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.BatchRunTestCasesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.BatchRunTestCasesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes batchRunTestCases without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchRunTestCases(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dialogflow.cx.v3beta1.IBatchRunTestCasesResponse, protos.google.cloud.dialogflow.cx.v3beta1.IBatchRunTestCasesMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dialogflow.cx.v3beta1.IBatchRunTestCasesResponse, protos.google.cloud.dialogflow.cx.v3beta1.IBatchRunTestCasesMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchRunTestCases as SinonStub)
                .getCall(0).args[0];
    ...
    describe('importTestCases', () => {
        it('invokes importTestCases without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.ImportTestCasesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.ImportTestCasesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes importTestCases without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.importTestCases(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dialogflow.cx.v3beta1.IImportTestCasesResponse, protos.google.cloud.dialogflow.cx.v3beta1.IImportTestCasesMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dialogflow.cx.v3beta1.IImportTestCasesResponse, protos.google.cloud.dialogflow.cx.v3beta1.IImportTestCasesMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importTestCases as SinonStub)
                .getCall(0).args[0];
    ...
    describe('exportTestCases', () => {
        it('invokes exportTestCases without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.ExportTestCasesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.ExportTestCasesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes exportTestCases without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.exportTestCases(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dialogflow.cx.v3beta1.IExportTestCasesResponse, protos.google.cloud.dialogflow.cx.v3beta1.IExportTestCasesMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dialogflow.cx.v3beta1.IExportTestCasesResponse, protos.google.cloud.dialogflow.cx.v3beta1.IExportTestCasesMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportTestCases as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listTestCases', () => {
        it('invokes listTestCases without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.ListTestCasesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.ListTestCasesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.TestCase()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.TestCase()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.TestCase()),
            ];
        ...
        it('invokes listTestCasesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.cx.v3beta1.TestCase[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3beta1.TestCase) => {
        ...
        it('uses async iteration with listTestCases without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.cx.v3beta1.ITestCase[] = [];
    ...
    describe('listTestCaseResults', () => {
        it('invokes listTestCaseResults without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.ListTestCaseResultsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.ListTestCaseResultsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.TestCaseResult()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.TestCaseResult()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.TestCaseResult()),
            ];
        ...
        it('invokes listTestCaseResultsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.cx.v3beta1.TestCaseResult[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3beta1.TestCaseResult) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listTestCaseResults without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.cx.v3beta1.ITestCaseResult[] = [];
