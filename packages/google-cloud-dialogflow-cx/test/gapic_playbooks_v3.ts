...
describe('v3.PlaybooksClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = playbooksModule.v3.PlaybooksClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = playbooksModule.v3.PlaybooksClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new playbooksModule.v3.PlaybooksClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new playbooksModule.v3.PlaybooksClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new playbooksModule.v3.PlaybooksClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new playbooksModule.v3.PlaybooksClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = playbooksModule.v3.PlaybooksClient.port;
            assert(port);
    ...
    describe('createPlaybook', () => {
        it('invokes createPlaybook without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.CreatePlaybookRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.CreatePlaybookRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.Playbook()
            );
        ...
        it('invokes createPlaybook without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createPlaybook(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3.IPlaybook|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deletePlaybook', () => {
        it('invokes deletePlaybook without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.DeletePlaybookRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.DeletePlaybookRequest', ['name']);
    ...
    describe('getPlaybook', () => {
        it('invokes getPlaybook without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.GetPlaybookRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.GetPlaybookRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.Playbook()
    ...
    describe('updatePlaybook', () => {
        it('invokes updatePlaybook without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.UpdatePlaybookRequest()
            );
            request.playbook ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.UpdatePlaybookRequest', ['playbook', 'name']);
    ...
    describe('createPlaybookVersion', () => {
        it('invokes createPlaybookVersion without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.CreatePlaybookVersionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.CreatePlaybookVersionRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.PlaybookVersion()
            );
        ...
        it('invokes createPlaybookVersion without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createPlaybookVersion(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3.IPlaybookVersion|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getPlaybookVersion', () => {
        it('invokes getPlaybookVersion without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.GetPlaybookVersionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.GetPlaybookVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.PlaybookVersion()
    ...
    describe('restorePlaybookVersion', () => {
        it('invokes restorePlaybookVersion without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.RestorePlaybookVersionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.RestorePlaybookVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.RestorePlaybookVersionResponse()
            );
            client.innerApiCalls.restorePlaybookVersion = stubSimpleCall(expectedResponse);
            const [response] = await client.restorePlaybookVersion(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.restorePlaybookVersion as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.restorePlaybookVersion as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes restorePlaybookVersion without error using callback', async () => {
            ...
            client.innerApiCalls.restorePlaybookVersion = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.restorePlaybookVersion(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3.IRestorePlaybookVersionResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes restorePlaybookVersion with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.restorePlaybookVersion = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.restorePlaybookVersion(request), expectedError);
            const actualRequest = (client.innerApiCalls.restorePlaybookVersion as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.restorePlaybookVersion as SinonStub)
    ...
    describe('deletePlaybookVersion', () => {
        it('invokes deletePlaybookVersion without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.DeletePlaybookVersionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.DeletePlaybookVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('exportPlaybook', () => {
        it('invokes exportPlaybook without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.ExportPlaybookRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.ExportPlaybookRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.exportPlaybook = stubLongRunningCall(expectedResponse);
            const [operation] = await client.exportPlaybook(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportPlaybook as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.exportPlaybook as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes exportPlaybook without error using callback', async () => {
            ...
            client.innerApiCalls.exportPlaybook = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.exportPlaybook(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dialogflow.cx.v3.IExportPlaybookResponse, protos.google.protobuf.IStruct>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dialogflow.cx.v3.IExportPlaybookResponse, protos.google.protobuf.IStruct>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportPlaybook as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes exportPlaybook with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.exportPlaybook = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.exportPlaybook(request), expectedError);
            const actualRequest = (client.innerApiCalls.exportPlaybook as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.exportPlaybook as SinonStub)
        ...
        it('invokes exportPlaybook with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.exportPlaybook = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.exportPlaybook(request);
        ...
        it('invokes checkExportPlaybookProgress without error', async () => {
            ...
            const decodedOperation = await client.checkExportPlaybookProgress(expectedResponse.name);
        ...
        it('invokes checkExportPlaybookProgress with error', async () => {
            ...
            await assert.rejects(client.checkExportPlaybookProgress(''), expectedError);
    ...
    describe('importPlaybook', () => {
        it('invokes importPlaybook without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.ImportPlaybookRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.ImportPlaybookRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.importPlaybook = stubLongRunningCall(expectedResponse);
            const [operation] = await client.importPlaybook(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importPlaybook as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.importPlaybook as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes importPlaybook without error using callback', async () => {
            ...
            client.innerApiCalls.importPlaybook = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.importPlaybook(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dialogflow.cx.v3.IImportPlaybookResponse, protos.google.protobuf.IStruct>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dialogflow.cx.v3.IImportPlaybookResponse, protos.google.protobuf.IStruct>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importPlaybook as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes importPlaybook with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.importPlaybook = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.importPlaybook(request), expectedError);
            const actualRequest = (client.innerApiCalls.importPlaybook as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.importPlaybook as SinonStub)
        ...
        it('invokes importPlaybook with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.importPlaybook = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.importPlaybook(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.importPlaybook as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkImportPlaybookProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkImportPlaybookProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkImportPlaybookProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkImportPlaybookProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listPlaybooks', () => {
        it('invokes listPlaybooks without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.ListPlaybooksRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.ListPlaybooksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.Playbook()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.Playbook()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.Playbook()),
            ];
        ...
        it('invokes listPlaybooksStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.cx.v3.Playbook[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3.Playbook) => {
        ...
        it('uses async iteration with listPlaybooks without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.cx.v3.IPlaybook[] = [];
    ...
    describe('listPlaybookVersions', () => {
        it('invokes listPlaybookVersions without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.ListPlaybookVersionsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.ListPlaybookVersionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.PlaybookVersion()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.PlaybookVersion()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.PlaybookVersion()),
            ];
        ...
        it('invokes listPlaybookVersionsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.cx.v3.PlaybookVersion[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3.PlaybookVersion) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listPlaybookVersions without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.cx.v3.IPlaybookVersion[] = [];
