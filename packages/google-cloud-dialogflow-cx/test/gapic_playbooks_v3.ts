...
describe('v3.PlaybooksClient', () => {
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new playbooksModule.v3.PlaybooksClient({
          universe_domain: 'example.com',
    ...
    it('invokes createPlaybook without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createPlaybook(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3.IPlaybook | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createPlaybookVersion without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createPlaybookVersion(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3.IPlaybookVersion | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('restorePlaybookVersion', () => {
    it('invokes restorePlaybookVersion without error', async () => {
      ...
      client.innerApiCalls.restorePlaybookVersion =
        stubSimpleCall(expectedResponse);
      const [response] = await client.restorePlaybookVersion(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.restorePlaybookVersion as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.restorePlaybookVersion as SinonStub
    ...
    it('invokes restorePlaybookVersion without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.restorePlaybookVersion(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3.IRestorePlaybookVersionResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes restorePlaybookVersion with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.restorePlaybookVersion = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.restorePlaybookVersion(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.restorePlaybookVersion as SinonStub
  ...
  describe('exportPlaybook', () => {
    it('invokes exportPlaybook without error', async () => {
      ...
      client.innerApiCalls.exportPlaybook =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.exportPlaybook(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.exportPlaybook as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.exportPlaybook as SinonStub
      ...
      const promise = new Promise((resolve, reject) => {
        client.exportPlaybook(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.dialogflow.cx.v3.IExportPlaybookResponse,
    ...
    it('invokes exportPlaybook with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.exportPlaybook = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkExportPlaybookProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkExportPlaybookProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('importPlaybook', () => {
    it('invokes importPlaybook without error', async () => {
      ...
      client.innerApiCalls.importPlaybook =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.importPlaybook(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.importPlaybook as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.importPlaybook as SinonStub
      ...
      const promise = new Promise((resolve, reject) => {
        client.importPlaybook(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.dialogflow.cx.v3.IImportPlaybookResponse,
              protos.google.protobuf.IStruct
            > | null,
          ) => {
            if (err) {
    ...
    it('invokes importPlaybook with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.importPlaybook = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('listPlaybooks', () => {
    ...
    it('invokes listPlaybooksStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.cx.v3.Playbook) => {
  ...
  describe('listPlaybookVersions', () => {
    ...
    it('invokes listPlaybookVersionsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.cx.v3.PlaybookVersion) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
