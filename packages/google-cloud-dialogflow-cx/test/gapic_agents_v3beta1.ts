    ...
    it('invokes getAgent without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getAgent(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3beta1.IAgent | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes validateAgent without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.validateAgent(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3beta1.IAgentValidationResult | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listAgents', () => {
    ...
    it('invokes listAgentsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.cx.v3beta1.Agent) => {
