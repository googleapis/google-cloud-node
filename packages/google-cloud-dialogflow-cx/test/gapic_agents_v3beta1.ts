...
describe('v3beta1.AgentsClient', () => {
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new agentsModule.v3beta1.AgentsClient({
          universe_domain: 'example.com',
  ...
  describe('deleteAgent', () => {
    it('invokes deleteAgent without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.dialogflow.cx.v3beta1.DeleteAgentRequest',
        ['name']
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1}`;
    ...
    it('invokes getGenerativeSettings without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getGenerativeSettings(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3beta1.IGenerativeSettings | null
          ) => {
            if (err) {
              reject(err);
            } else {
