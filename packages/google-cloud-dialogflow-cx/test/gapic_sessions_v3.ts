...
describe('v3.SessionsClient', () => {
  ...
  describe('matchIntent', () => {
    ...
    it('invokes matchIntent without error using callback', async () => {
      ...
      client.innerApiCalls.matchIntent = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.matchIntent(
  ...
  describe('fulfillIntent', () => {
    ...
    it('invokes fulfillIntent without error using callback', async () => {
      ...
      client.innerApiCalls.fulfillIntent = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('Path templates', () => {
    ...
    describe('projectLocationAgentEnvironmentSession', () => {
      ...
      client.initialize();
      client.pathTemplates.projectLocationAgentEnvironmentSessionPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.projectLocationAgentEnvironmentSessionPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);
      ...
      it('matchProjectFromProjectLocationAgentEnvironmentSessionName', () => {
        const result = client.matchProjectFromProjectLocationAgentEnvironmentSessionName(
          fakePath
        );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromProjectLocationAgentEnvironmentSessionName', () => {
        const result = client.matchLocationFromProjectLocationAgentEnvironmentSessionName(
          fakePath
        );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchAgentFromProjectLocationAgentEnvironmentSessionName', () => {
        const result = client.matchAgentFromProjectLocationAgentEnvironmentSessionName(
          fakePath
        );
        assert.strictEqual(result, 'agentValue');
        assert(
      ...
      it('matchSessionFromProjectLocationAgentEnvironmentSessionName', () => {
        const result = client.matchSessionFromProjectLocationAgentEnvironmentSessionName(
          fakePath
        );
