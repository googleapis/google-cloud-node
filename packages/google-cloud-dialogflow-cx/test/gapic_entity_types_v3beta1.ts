    ...
    it('invokes getEntityType without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getEntityType(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3beta1.IEntityType | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listEntityTypes', () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listEntityTypes(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.dialogflow.cx.v3beta1.IEntityType[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listEntityTypesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.cx.v3beta1.EntityType) => {
