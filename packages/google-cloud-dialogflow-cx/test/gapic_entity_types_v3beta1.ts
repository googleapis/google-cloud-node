...
describe('v3beta1.EntityTypesClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = entitytypesModule.v3beta1.EntityTypesClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = entitytypesModule.v3beta1.EntityTypesClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new entitytypesModule.v3beta1.EntityTypesClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new entitytypesModule.v3beta1.EntityTypesClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new entitytypesModule.v3beta1.EntityTypesClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new entitytypesModule.v3beta1.EntityTypesClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = entitytypesModule.v3beta1.EntityTypesClient.port;
            assert(port);
    ...
    describe('getEntityType', () => {
        it('invokes getEntityType without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.GetEntityTypeRequest', ['name']);
        ...
        it('invokes getEntityType without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getEntityType(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3beta1.IEntityType|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createEntityType', () => {
        it('invokes createEntityType without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.CreateEntityTypeRequest', ['parent']);
    ...
    describe('updateEntityType', () => {
        it('invokes updateEntityType without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.UpdateEntityTypeRequest()
            );
            request.entityType ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.UpdateEntityTypeRequest', ['entityType', 'name']);
    ...
    describe('deleteEntityType', () => {
        it('invokes deleteEntityType without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.DeleteEntityTypeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('exportEntityTypes', () => {
        it('invokes exportEntityTypes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.ExportEntityTypesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.exportEntityTypes = stubLongRunningCall(expectedResponse);
            const [operation] = await client.exportEntityTypes(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportEntityTypes as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.exportEntityTypes as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes exportEntityTypes without error using callback', async () => {
            ...
            client.innerApiCalls.exportEntityTypes = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.exportEntityTypes(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dialogflow.cx.v3beta1.IExportEntityTypesResponse, protos.google.cloud.dialogflow.cx.v3beta1.IExportEntityTypesMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dialogflow.cx.v3beta1.IExportEntityTypesResponse, protos.google.cloud.dialogflow.cx.v3beta1.IExportEntityTypesMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportEntityTypes as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes exportEntityTypes with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.exportEntityTypes = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes exportEntityTypes with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.exportEntityTypes = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.exportEntityTypes(request);
        ...
        it('invokes checkExportEntityTypesProgress without error', async () => {
            ...
            const decodedOperation = await client.checkExportEntityTypesProgress(expectedResponse.name);
        ...
        it('invokes checkExportEntityTypesProgress with error', async () => {
            ...
            await assert.rejects(client.checkExportEntityTypesProgress(''), expectedError);
    ...
    describe('importEntityTypes', () => {
        it('invokes importEntityTypes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.ImportEntityTypesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.importEntityTypes = stubLongRunningCall(expectedResponse);
            const [operation] = await client.importEntityTypes(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importEntityTypes as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.importEntityTypes as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes importEntityTypes without error using callback', async () => {
            ...
            client.innerApiCalls.importEntityTypes = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.importEntityTypes(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dialogflow.cx.v3beta1.IImportEntityTypesResponse, protos.google.cloud.dialogflow.cx.v3beta1.IImportEntityTypesMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dialogflow.cx.v3beta1.IImportEntityTypesResponse, protos.google.cloud.dialogflow.cx.v3beta1.IImportEntityTypesMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importEntityTypes as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes importEntityTypes with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.importEntityTypes = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes importEntityTypes with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.importEntityTypes = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.importEntityTypes(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.importEntityTypes as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkImportEntityTypesProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkImportEntityTypesProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkImportEntityTypesProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkImportEntityTypesProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listEntityTypes', () => {
        it('invokes listEntityTypes without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.ListEntityTypesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.ListEntityTypesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.EntityType()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.EntityType()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.EntityType()),
            ];
        ...
        it('invokes listEntityTypesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.cx.v3beta1.EntityType[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3beta1.EntityType) => {
        ...
        it('uses async iteration with listEntityTypes without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.cx.v3beta1.IEntityType[] = [];
