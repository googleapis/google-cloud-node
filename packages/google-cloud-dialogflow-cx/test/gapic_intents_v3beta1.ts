...
describe('v3beta1.IntentsClient', () => {
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new intentsModule.v3beta1.IntentsClient({
          universe_domain: 'example.com',
  ...
  describe('getIntent', () => {
    ...
    it('invokes getIntent without error using callback', async () => {
      ...
      client.innerApiCalls.getIntent =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getIntent(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3beta1.IIntent | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createIntent', () => {
    ...
    it('invokes createIntent without error using callback', async () => {
      ...
      client.innerApiCalls.createIntent =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createIntent(
          request,
  ...
  describe('updateIntent', () => {
    ...
    it('invokes updateIntent without error using callback', async () => {
      ...
      client.innerApiCalls.updateIntent =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.updateIntent(
          request,
  ...
  describe('deleteIntent', () => {
    ...
    it('invokes deleteIntent without error using callback', async () => {
      ...
      client.innerApiCalls.deleteIntent =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.deleteIntent(
          request,
  ...
  describe('listIntents', () => {
    ...
    it('invokes listIntents without error using callback', async () => {
      ...
      client.innerApiCalls.listIntents =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listIntents(
          request,
    ...
    it('invokes listIntentsStream without error', async () => {
      ...
      client.descriptors.page.listIntents.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.cx.v3beta1.Intent) => {
    ...
    it('uses async iteration with listIntents without error', async () => {
      ...
      client.descriptors.page.listIntents.asyncIterate =
