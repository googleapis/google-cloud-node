...
describe('v3.EntityTypesClient', () => {
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new entitytypesModule.v3.EntityTypesClient({
          universe_domain: 'example.com',
    ...
    it('invokes getEntityType without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getEntityType(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3.IEntityType | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listEntityTypes', () => {
    ...
    it('invokes listEntityTypesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.cx.v3.EntityType) => {
