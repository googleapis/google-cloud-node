...
describe('v3.IntentsClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new intentsModule.v3.IntentsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new intentsModule.v3.IntentsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new intentsModule.v3.IntentsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new intentsModule.v3.IntentsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = intentsModule.v3.IntentsClient.port;
            assert(port);
    ...
    describe('getIntent', () => {
        it('invokes getIntent without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.GetIntentRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.GetIntentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.Intent()
            );
        ...
        it('invokes getIntent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getIntent(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3.IIntent|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createIntent', () => {
        it('invokes createIntent without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.CreateIntentRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.CreateIntentRequest', ['parent']);
    ...
    describe('updateIntent', () => {
        it('invokes updateIntent without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.UpdateIntentRequest()
            );
            request.intent ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.UpdateIntentRequest', ['intent', 'name']);
    ...
    describe('deleteIntent', () => {
        it('invokes deleteIntent without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.DeleteIntentRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.DeleteIntentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('importIntents', () => {
        it('invokes importIntents without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.ImportIntentsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes importIntents without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.importIntents(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dialogflow.cx.v3.IImportIntentsResponse, protos.google.cloud.dialogflow.cx.v3.IImportIntentsMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dialogflow.cx.v3.IImportIntentsResponse, protos.google.cloud.dialogflow.cx.v3.IImportIntentsMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importIntents as SinonStub)
                .getCall(0).args[0];
    ...
    describe('exportIntents', () => {
        it('invokes exportIntents without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.ExportIntentsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes exportIntents without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.exportIntents(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dialogflow.cx.v3.IExportIntentsResponse, protos.google.cloud.dialogflow.cx.v3.IExportIntentsMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dialogflow.cx.v3.IExportIntentsResponse, protos.google.cloud.dialogflow.cx.v3.IExportIntentsMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportIntents as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listIntents', () => {
        it('invokes listIntents without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.ListIntentsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.ListIntentsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.Intent()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.Intent()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.Intent()),
            ];
        ...
        it('invokes listIntentsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.cx.v3.Intent[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3.Intent) => {
        ...
        it('uses async iteration with listIntents without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.cx.v3.IIntent[] = [];
