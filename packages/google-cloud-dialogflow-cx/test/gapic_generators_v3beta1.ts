  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          generatorsModule.v3beta1.GeneratorsClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          generatorsModule.v3beta1.GeneratorsClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new generatorsModule.v3beta1.GeneratorsClient({
          universe_domain: 'example.com',
    ...
    it('invokes getGenerator without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getGenerator(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3beta1.IGenerator | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listGenerators', () => {
    ...
    it('invokes listGeneratorsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.cx.v3beta1.Generator) => {
