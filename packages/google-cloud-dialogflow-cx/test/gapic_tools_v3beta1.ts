...
describe('v3beta1.ToolsClient', () => {
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new toolsModule.v3beta1.ToolsClient({
          universe_domain: 'example.com',
    ...
    it('invokes createTool without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createTool(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3beta1.ITool | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('deleteTool', () => {
    it('invokes deleteTool without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.dialogflow.cx.v3beta1.DeleteToolRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('createToolVersion', () => {
    it('invokes createToolVersion without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createToolVersion as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createToolVersion as SinonStub
    ...
    it('invokes createToolVersion without error using callback', async () => {
      ...
      client.innerApiCalls.createToolVersion =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createToolVersion(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3beta1.IToolVersion | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createToolVersion with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createToolVersion = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getToolVersion', () => {
    it('invokes getToolVersion without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getToolVersion as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getToolVersion as SinonStub
    ...
    it('invokes getToolVersion without error using callback', async () => {
      ...
      client.innerApiCalls.getToolVersion =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes getToolVersion with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getToolVersion = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteToolVersion', () => {
    it('invokes deleteToolVersion without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteToolVersion as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteToolVersion as SinonStub
    ...
    it('invokes deleteToolVersion without error using callback', async () => {
      ...
      client.innerApiCalls.deleteToolVersion =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes deleteToolVersion with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteToolVersion = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('restoreToolVersion', () => {
    it('invokes restoreToolVersion without error', async () => {
      ...
      client.innerApiCalls.restoreToolVersion =
        stubSimpleCall(expectedResponse);
      const [response] = await client.restoreToolVersion(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.restoreToolVersion as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.restoreToolVersion as SinonStub
    ...
    it('invokes restoreToolVersion without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.restoreToolVersion(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3beta1.IRestoreToolVersionResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes restoreToolVersion with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.restoreToolVersion = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('exportTools', () => {
    it('invokes exportTools without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.exportTools as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.exportTools as SinonStub
    ...
    it('invokes exportTools without error using callback', async () => {
      ...
      client.innerApiCalls.exportTools =
    ...
    it('invokes exportTools with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.exportTools = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkExportToolsProgress without error', async () => {
      ...
      const decodedOperation = await client.checkExportToolsProgress(
  ...
  describe('listTools', () => {
    ...
    it('invokes listToolsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.cx.v3beta1.Tool) => {
  ...
  describe('listToolVersions', () => {
    it('invokes listToolVersions without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listToolVersions as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listToolVersions as SinonStub
      ...
      const promise = new Promise((resolve, reject) => {
        client.listToolVersions(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.dialogflow.cx.v3beta1.IToolVersion[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listToolVersions with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listToolVersions = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listToolVersionsStream without error', async () => {
      ...
      client.descriptors.page.listToolVersions.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.cx.v3beta1.ToolVersion) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listToolVersions.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listToolVersions, request),
      );
      assert(
        (client.descriptors.page.listToolVersions.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listToolVersions without error', async () => {
      ...
      client.descriptors.page.listToolVersions.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('Path templates', () => {
    ...
    describe('projectLocationAgentFlowTransitionRouteGroups', async () => {
      const fakePath =
        '/rendered/path/projectLocationAgentFlowTransitionRouteGroups';
      const expectedParameters = {
        project: 'projectValue',
        location: 'locationValue',
        agent: 'agentValue',
      ...
      it('projectLocationAgentFlowTransitionRouteGroupsPath', () => {
        const result = client.projectLocationAgentFlowTransitionRouteGroupsPath(
          'projectValue',
          'locationValue',
          'agentValue',
          'flowValue',
      ...
      it('matchProjectFromProjectLocationAgentFlowTransitionRouteGroupsName', () => {
        const result =
          client.matchProjectFromProjectLocationAgentFlowTransitionRouteGroupsName(
            fakePath,
          );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromProjectLocationAgentFlowTransitionRouteGroupsName', () => {
        const result =
          client.matchLocationFromProjectLocationAgentFlowTransitionRouteGroupsName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchAgentFromProjectLocationAgentFlowTransitionRouteGroupsName', () => {
        const result =
          client.matchAgentFromProjectLocationAgentFlowTransitionRouteGroupsName(
            fakePath,
          );
        assert.strictEqual(result, 'agentValue');
        assert(
      ...
      it('matchFlowFromProjectLocationAgentFlowTransitionRouteGroupsName', () => {
        const result =
          client.matchFlowFromProjectLocationAgentFlowTransitionRouteGroupsName(
            fakePath,
          );
        assert.strictEqual(result, 'flowValue');
        assert(
      ...
      it('matchTransitionRouteGroupFromProjectLocationAgentFlowTransitionRouteGroupsName', () => {
        const result =
          client.matchTransitionRouteGroupFromProjectLocationAgentFlowTransitionRouteGroupsName(
            fakePath,
          );
    ...
    describe('projectLocationAgentTransitionRouteGroups', async () => {
      const fakePath =
        '/rendered/path/projectLocationAgentTransitionRouteGroups';
      const expectedParameters = {
        project: 'projectValue',
        location: 'locationValue',
        agent: 'agentValue',
      ...
      it('projectLocationAgentTransitionRouteGroupsPath', () => {
        const result = client.projectLocationAgentTransitionRouteGroupsPath(
          'projectValue',
          'locationValue',
          'agentValue',
          'transitionRouteGroupValue',
      ...
      it('matchProjectFromProjectLocationAgentTransitionRouteGroupsName', () => {
        const result =
          client.matchProjectFromProjectLocationAgentTransitionRouteGroupsName(
            fakePath,
          );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromProjectLocationAgentTransitionRouteGroupsName', () => {
        const result =
          client.matchLocationFromProjectLocationAgentTransitionRouteGroupsName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchAgentFromProjectLocationAgentTransitionRouteGroupsName', () => {
        const result =
          client.matchAgentFromProjectLocationAgentTransitionRouteGroupsName(
            fakePath,
          );
        assert.strictEqual(result, 'agentValue');
        assert(
      ...
      it('matchTransitionRouteGroupFromProjectLocationAgentTransitionRouteGroupsName', () => {
        const result =
          client.matchTransitionRouteGroupFromProjectLocationAgentTransitionRouteGroupsName(
            fakePath,
          );
        assert.strictEqual(result, 'transitionRouteGroupValue');
        assert(
