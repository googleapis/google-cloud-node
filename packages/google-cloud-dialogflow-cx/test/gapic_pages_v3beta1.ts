...
describe('v3beta1.PagesClient', () => {
  ...
  describe('getPage', () => {
    ...
    it('invokes getPage without error using callback', async () => {
      ...
      client.innerApiCalls.getPage = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.getPage(
  ...
  describe('createPage', () => {
    ...
    it('invokes createPage without error using callback', async () => {
      ...
      client.innerApiCalls.createPage = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.createPage(
  ...
  describe('updatePage', () => {
    ...
    it('invokes updatePage without error using callback', async () => {
      ...
      client.innerApiCalls.updatePage = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.updatePage(
  ...
  describe('deletePage', () => {
    ...
    it('invokes deletePage without error using callback', async () => {
      ...
      client.innerApiCalls.deletePage = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.deletePage(
  ...
  describe('listPages', () => {
    ...
    it('invokes listPages without error using callback', async () => {
      ...
      client.innerApiCalls.listPages = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.listPages(
