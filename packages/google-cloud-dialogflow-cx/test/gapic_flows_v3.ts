...
describe('v3.FlowsClient', () => {
    ...
    it('invokes createFlow without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createFlow(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3.IFlow | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('validateFlow', () => {
    ...
    it('invokes validateFlow without error using callback', async () => {
      ...
      client.innerApiCalls.validateFlow = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.validateFlow(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3.IFlowValidationResult | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getFlowValidationResult', () => {
    ...
    it('invokes getFlowValidationResult without error using callback', async () => {
      ...
      client.innerApiCalls.getFlowValidationResult = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('importFlow', () => {
    ...
    it('invokes importFlow without error using callback', async () => {
      ...
      client.innerApiCalls.importFlow = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.importFlow(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.dialogflow.cx.v3.IImportFlowResponse,
              protos.google.protobuf.IStruct
            > | null
          ) => {
            if (err) {
  ...
  describe('exportFlow', () => {
    ...
    it('invokes exportFlow without error using callback', async () => {
      ...
      client.innerApiCalls.exportFlow = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.exportFlow(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.dialogflow.cx.v3.IExportFlowResponse,
              protos.google.protobuf.IStruct
            > | null
          ) => {
            if (err) {
  ...
  describe('listFlows', () => {
    ...
    it('invokes listFlowsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.cx.v3.Flow) => {
