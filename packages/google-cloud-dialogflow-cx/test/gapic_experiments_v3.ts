...
describe('v3.ExperimentsClient', () => {
  ...
  describe('getExperiment', () => {
    ...
    it('invokes getExperiment without error using callback', async () => {
      ...
      client.innerApiCalls.getExperiment = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.getExperiment(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3.IExperiment | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createExperiment', () => {
    ...
    it('invokes createExperiment without error using callback', async () => {
      ...
      client.innerApiCalls.createExperiment = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('updateExperiment', () => {
    ...
    it('invokes updateExperiment without error using callback', async () => {
      ...
      client.innerApiCalls.updateExperiment = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('deleteExperiment', () => {
    ...
    it('invokes deleteExperiment without error using callback', async () => {
      ...
      client.innerApiCalls.deleteExperiment = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('startExperiment', () => {
    ...
    it('invokes startExperiment without error using callback', async () => {
      ...
      client.innerApiCalls.startExperiment = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('stopExperiment', () => {
    ...
    it('invokes stopExperiment without error using callback', async () => {
      ...
      client.innerApiCalls.stopExperiment = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('listExperiments', () => {
    ...
    it('invokes listExperiments without error using callback', async () => {
      ...
      client.innerApiCalls.listExperiments = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listExperimentsStream without error', async () => {
      ...
      client.descriptors.page.listExperiments.createStream = stubPageStreamingCall(
        expectedResponse
      );
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.cx.v3.Experiment) => {
      ...
      assert.strictEqual(
        (client.descriptors.page.listExperiments
    ...
    it('uses async iteration with listExperiments without error', async () => {
      ...
      client.descriptors.page.listExperiments.asyncIterate = stubAsyncIterationCall(
        expectedResponse
      );
