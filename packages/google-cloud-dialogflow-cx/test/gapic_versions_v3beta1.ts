...
describe('v3beta1.VersionsClient', () => {
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new versionsModule.v3beta1.VersionsClient({
          universe_domain: 'example.com',
    ...
    it('invokes getVersion without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getVersion(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3beta1.IVersion | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes compareVersions without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.compareVersions(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3beta1.ICompareVersionsResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('loadVersion', () => {
    it('invokes loadVersion without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.loadVersion as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.loadVersion as SinonStub
    ...
    it('invokes loadVersion without error using callback', async () => {
      ...
      client.innerApiCalls.loadVersion =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.loadVersion(
          request,
  ...
  describe('listVersions', () => {
    ...
    it('invokes listVersionsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.cx.v3beta1.Version) => {
