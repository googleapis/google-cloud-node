...
describe('v3.ToolsClient', () => {
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new toolsModule.v3.ToolsClient({
          universe_domain: 'example.com',
    ...
    it('invokes createTool without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createTool(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3.ITool | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createToolVersion without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createToolVersion(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3.IToolVersion | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('deleteToolVersion', () => {
    it('invokes deleteToolVersion without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.dialogflow.cx.v3.DeleteToolVersionRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('restoreToolVersion', () => {
    it('invokes restoreToolVersion without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.dialogflow.cx.v3.RestoreToolVersionRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
    ...
    it('invokes restoreToolVersion without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.restoreToolVersion(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3.IRestoreToolVersionResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listTools', () => {
    it('invokes listTools without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.dialogflow.cx.v3.ListToolsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
    ...
    it('invokes listToolsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.cx.v3.Tool) => {
  ...
  describe('listToolVersions', () => {
    it('invokes listToolVersions without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.dialogflow.cx.v3.ListToolVersionsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
    ...
    it('invokes listToolVersionsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.cx.v3.ToolVersion) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
