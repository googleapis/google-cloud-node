...
describe('v3.ToolsClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = toolsModule.v3.ToolsClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = toolsModule.v3.ToolsClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new toolsModule.v3.ToolsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new toolsModule.v3.ToolsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new toolsModule.v3.ToolsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new toolsModule.v3.ToolsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = toolsModule.v3.ToolsClient.port;
            assert(port);
    ...
    describe('createTool', () => {
        it('invokes createTool without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.CreateToolRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.CreateToolRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.Tool()
            );
        ...
        it('invokes createTool without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createTool(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3.ITool|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getTool', () => {
        it('invokes getTool without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.GetToolRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.GetToolRequest', ['name']);
    ...
    describe('updateTool', () => {
        it('invokes updateTool without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.UpdateToolRequest()
            );
            request.tool ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.UpdateToolRequest', ['tool', 'name']);
    ...
    describe('deleteTool', () => {
        it('invokes deleteTool without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.DeleteToolRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.DeleteToolRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createToolVersion', () => {
        it('invokes createToolVersion without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.CreateToolVersionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.CreateToolVersionRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.ToolVersion()
            );
        ...
        it('invokes createToolVersion without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createToolVersion(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3.IToolVersion|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getToolVersion', () => {
        it('invokes getToolVersion without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.GetToolVersionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.GetToolVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.ToolVersion()
    ...
    describe('deleteToolVersion', () => {
        it('invokes deleteToolVersion without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.DeleteToolVersionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.DeleteToolVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('restoreToolVersion', () => {
        it('invokes restoreToolVersion without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.RestoreToolVersionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.RestoreToolVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.RestoreToolVersionResponse()
            );
        ...
        it('invokes restoreToolVersion without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.restoreToolVersion(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3.IRestoreToolVersionResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listTools', () => {
        it('invokes listTools without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.ListToolsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.ListToolsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.Tool()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.Tool()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.Tool()),
            ];
        ...
        it('invokes listToolsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.cx.v3.Tool[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3.Tool) => {
        ...
        it('uses async iteration with listTools without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.cx.v3.ITool[] = [];
    ...
    describe('listToolVersions', () => {
        it('invokes listToolVersions without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3.ListToolVersionsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3.ListToolVersionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.ToolVersion()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.ToolVersion()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.ToolVersion()),
            ];
        ...
        it('invokes listToolVersionsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.cx.v3.ToolVersion[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3.ToolVersion) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listToolVersions without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.cx.v3.IToolVersion[] = [];
