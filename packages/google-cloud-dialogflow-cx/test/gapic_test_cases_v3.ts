...
describe('v3.TestCasesClient', () => {
  ...
  describe('batchDeleteTestCases', () => {
    ...
    it('invokes batchDeleteTestCases without error using callback', async () => {
      ...
      client.innerApiCalls.batchDeleteTestCases = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('getTestCase', () => {
    ...
    it('invokes getTestCase without error using callback', async () => {
      ...
      client.innerApiCalls.getTestCase = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.getTestCase(
  ...
  describe('createTestCase', () => {
    ...
    it('invokes createTestCase without error using callback', async () => {
      ...
      client.innerApiCalls.createTestCase = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('updateTestCase', () => {
    ...
    it('invokes updateTestCase without error using callback', async () => {
      ...
      client.innerApiCalls.updateTestCase = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('calculateCoverage', () => {
    ...
    it('invokes calculateCoverage without error using callback', async () => {
      ...
      client.innerApiCalls.calculateCoverage = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('runTestCase', () => {
    ...
    it('invokes runTestCase without error using callback', async () => {
      ...
      client.innerApiCalls.runTestCase = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.runTestCase(
  ...
  describe('batchRunTestCases', () => {
    ...
    it('invokes batchRunTestCases without error using callback', async () => {
      ...
      client.innerApiCalls.batchRunTestCases = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('importTestCases', () => {
    ...
    it('invokes importTestCases without error using callback', async () => {
      ...
      client.innerApiCalls.importTestCases = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('exportTestCases', () => {
    ...
    it('invokes exportTestCases without error using callback', async () => {
      ...
      client.innerApiCalls.exportTestCases = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('listTestCases', () => {
    ...
    it('invokes listTestCases without error using callback', async () => {
      ...
      client.innerApiCalls.listTestCases = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listTestCasesStream without error', async () => {
      ...
      client.descriptors.page.listTestCases.createStream = stubPageStreamingCall(
        expectedResponse
      );
      ...
      assert.strictEqual(
        (client.descriptors.page.listTestCases
    ...
    it('uses async iteration with listTestCases without error', async () => {
      ...
      client.descriptors.page.listTestCases.asyncIterate = stubAsyncIterationCall(
        expectedResponse
      );
  ...
  describe('listTestCaseResults', () => {
    ...
    it('invokes listTestCaseResults without error using callback', async () => {
      ...
      client.innerApiCalls.listTestCaseResults = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listTestCaseResultsStream without error', async () => {
      ...
      client.descriptors.page.listTestCaseResults.createStream = stubPageStreamingCall(
        expectedResponse
      );
      ...
      assert.strictEqual(
        (client.descriptors.page.listTestCaseResults
          .createStream as SinonStub).getCall(0).args[2].otherArgs.headers[
          'x-goog-request-params'
        ],
        expectedHeaderRequestParams
    ...
    it('uses async iteration with listTestCaseResults without error', async () => {
      ...
      client.descriptors.page.listTestCaseResults.asyncIterate = stubAsyncIterationCall(
        expectedResponse
      );
