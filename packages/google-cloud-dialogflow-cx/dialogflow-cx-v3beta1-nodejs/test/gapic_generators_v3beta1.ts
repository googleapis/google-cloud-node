...
describe('v3beta1.GeneratorsClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = generatorsModule.v3beta1.GeneratorsClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = generatorsModule.v3beta1.GeneratorsClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'dialogflow.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new generatorsModule.v3beta1.GeneratorsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new generatorsModule.v3beta1.GeneratorsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dialogflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new generatorsModule.v3beta1.GeneratorsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new generatorsModule.v3beta1.GeneratorsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = generatorsModule.v3beta1.GeneratorsClient.port;
            assert(port);
    ...
    describe('getGenerator', () => {
        it('invokes getGenerator without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.GetGeneratorRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.GetGeneratorRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.Generator()
            );
        ...
        it('invokes getGenerator without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getGenerator(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.cx.v3beta1.IGenerator|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createGenerator', () => {
        it('invokes createGenerator without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.CreateGeneratorRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.CreateGeneratorRequest', ['parent']);
    ...
    describe('updateGenerator', () => {
        it('invokes updateGenerator without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.UpdateGeneratorRequest()
            );
            request.generator ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.UpdateGeneratorRequest', ['generator', 'name']);
    ...
    describe('deleteGenerator', () => {
        it('invokes deleteGenerator without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.DeleteGeneratorRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.DeleteGeneratorRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listGenerators', () => {
        it('invokes listGenerators without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.ListGeneratorsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.cx.v3beta1.ListGeneratorsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.Generator()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.Generator()),
              generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.Generator()),
            ];
        ...
        it('invokes listGeneratorsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.cx.v3beta1.Generator[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.cx.v3beta1.Generator) => {
        ...
        it('uses async iteration with listGenerators without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.cx.v3beta1.IGenerator[] = [];
