...
function main(parent, tools) {
  // [START dialogflow_v3beta1_generated_Tools_ExportTools_async]
  /**
  ...
  async function callExportTools() {
    // Construct request
    const request = {
      parent,
      tools,
    ...
    // Run request
    const [operation] = await cxClient.exportTools(request);
