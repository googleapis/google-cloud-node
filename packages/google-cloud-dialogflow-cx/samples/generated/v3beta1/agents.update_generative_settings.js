...
function main(generativeSettings) {
  ...
  async function callUpdateGenerativeSettings() {
    // Construct request
    const request = {
      generativeSettings,
    };
    ...
    // Run request
    const response = await cxClient.updateGenerativeSettings(request);
    console.log(response);
  }

  callUpdateGenerativeSettings();
