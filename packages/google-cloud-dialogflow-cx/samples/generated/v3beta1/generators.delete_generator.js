...
function main(name) {
  // [START dialogflow_v3beta1_generated_Generators_DeleteGenerator_async]
  /**
  ...
  const {GeneratorsClient} = require('@google-cloud/dialogflow-cx').v3beta1;

  // Instantiates a client
  const cxClient = new GeneratorsClient();
  ...
  async function callDeleteGenerator() {
    ...
    // Run request
    const response = await cxClient.deleteGenerator(request);
    console.log(response);
  }

  callDeleteGenerator();
  // [END dialogflow_v3beta1_generated_Generators_DeleteGenerator_async]
}
