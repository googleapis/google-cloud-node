...
export class VersionsClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    // pass `{fallback: true}` to the VersionsClient constructor.
    this._gaxModule = opts.fallback ? gax.fallback : gax;

    // Create a `gaxGrpc` object, with any grpc-specific options
    // sent to the client.
    opts.scopes = (this.constructor as typeof VersionsClient).scopes;
  ...
  /**
   * Check the status of the long running operation returned by the createVersion() method.
   * @param {String} name
  ...
  /**
   * Check the status of the long running operation returned by the loadVersion() method.
   * @param {String} name
   *   The operation name that will be passed.
   * @returns {Promise} - The promise which resolves to an object.
   *   The decoded operation object has result and metadata field to get information from.
   ...
   *   The first element is Array of [Version]{@link google.cloud.dialogflow.cx.v3beta1.Version} that corresponds to
   *   the one page received from the API server.
   *   If the second element is not null it contains the request object of type [ListVersionsRequest]{@link google.cloud.dialogflow.cx.v3beta1.ListVersionsRequest}
   *   that can be used to obtain the next page of the results.
   *   If it is null, the next page does not exist.
   *   The third element contains the raw response received from the API server. Its type is
   *   [ListVersionsResponse]{@link google.cloud.dialogflow.cx.v3beta1.ListVersionsResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   */
  listVersions(
  ...
  /**
   * Equivalent to {@link listVersions}, but returns a NodeJS Stream object.
   *
   * This fetches the paged responses for {@link listVersions} continuously
  ...
  /**
   * Equivalent to {@link listVersions}, but returns an iterable object.
   *
