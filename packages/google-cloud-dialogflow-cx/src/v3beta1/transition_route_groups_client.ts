...
export class TransitionRouteGroupsClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    // pass `{fallback: true}` to the TransitionRouteGroupsClient constructor.
    this._gaxModule = opts.fallback ? gax.fallback : gax;

    // Create a `gaxGrpc` object, with any grpc-specific options
    // sent to the client.
    opts.scopes = (this
      .constructor as typeof TransitionRouteGroupsClient).scopes;
   ...
   *   The first element is Array of [TransitionRouteGroup]{@link google.cloud.dialogflow.cx.v3beta1.TransitionRouteGroup} that corresponds to
   *   the one page received from the API server.
   *   If the second element is not null it contains the request object of type [ListTransitionRouteGroupsRequest]{@link google.cloud.dialogflow.cx.v3beta1.ListTransitionRouteGroupsRequest}
   *   that can be used to obtain the next page of the results.
   *   If it is null, the next page does not exist.
   *   The third element contains the raw response received from the API server. Its type is
   *   [ListTransitionRouteGroupsResponse]{@link google.cloud.dialogflow.cx.v3beta1.ListTransitionRouteGroupsResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   */
  listTransitionRouteGroups(
  ...
  /**
   * Equivalent to {@link listTransitionRouteGroups}, but returns a NodeJS Stream object.
   *
   * This fetches the paged responses for {@link listTransitionRouteGroups} continuously
  ...
  /**
   * Equivalent to {@link listTransitionRouteGroups}, but returns an iterable object.
   *
