...
export class PlaybooksClient {
  ...
  constructor(
    ...
    this.descriptors.page = {
      listPlaybooks: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'playbooks',
      ),
      listPlaybookVersions: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'playbookVersions',
      ),
    ...
    const exportPlaybookResponse = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.cx.v3beta1.ExportPlaybookResponse',
    ) as gax.protobuf.Type;
    const exportPlaybookMetadata = protoFilesRoot.lookup(
      '.google.protobuf.Struct',
    ) as gax.protobuf.Type;
    const importPlaybookResponse = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.cx.v3beta1.ImportPlaybookResponse',
    ) as gax.protobuf.Type;
  ...
  restorePlaybookVersion(
    ...
    [
      ...
      (
        | protos.google.cloud.dialogflow.cx.v3beta1.IRestorePlaybookVersionRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .restorePlaybookVersion(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.cloud.dialogflow.cx.v3beta1.IRestorePlaybookVersionResponse,
          (
  ...
  exportPlaybook(
    ...
    [
      LROperation<
        protos.google.cloud.dialogflow.cx.v3beta1.IExportPlaybookResponse,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .exportPlaybook(request, options, wrappedCallback)
      ?.then(
  ...
  async checkExportPlaybookProgress(
    ...
    LROperation<
      protos.google.cloud.dialogflow.cx.v3beta1.ExportPlaybookResponse,
  ...
  > {
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.exportPlaybook,
  ...
  importPlaybook(
    ...
    [
      LROperation<
        protos.google.cloud.dialogflow.cx.v3beta1.IImportPlaybookResponse,
        protos.google.protobuf.IStruct
      >,
      protos.google.longrunning.IOperation | undefined,
      {} | undefined,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .importPlaybook(request, options, wrappedCallback)
      ?.then(
        ([response, rawResponse, _]: [
          LROperation<
            protos.google.cloud.dialogflow.cx.v3beta1.IImportPlaybookResponse,
  ...
  async checkImportPlaybookProgress(
    ...
    LROperation<
      protos.google.cloud.dialogflow.cx.v3beta1.ImportPlaybookResponse,
      protos.google.protobuf.Struct
    >
  > {
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.importPlaybook,
      this._gaxModule.createDefaultBackoffSettings(),
    );
    return decodeOperation as LROperation<
      protos.google.cloud.dialogflow.cx.v3beta1.ImportPlaybookResponse,
