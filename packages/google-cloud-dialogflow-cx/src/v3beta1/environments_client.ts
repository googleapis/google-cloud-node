...
export class EnvironmentsClient {
  ...
  /**
   * Check the status of the long running operation returned by the updateEnvironment() method.
   * @param {String} name
   *   The operation name that will be passed.
   * @returns {Promise} - The promise which resolves to an object.
   *   The decoded operation object has result and metadata field to get information from.
   ...
   *   The first element is Array of [Environment]{@link google.cloud.dialogflow.cx.v3beta1.Environment} that corresponds to
   *   the one page received from the API server.
   *   If the second element is not null it contains the request object of type [ListEnvironmentsRequest]{@link google.cloud.dialogflow.cx.v3beta1.ListEnvironmentsRequest}
   *   that can be used to obtain the next page of the results.
   *   If it is null, the next page does not exist.
   *   The third element contains the raw response received from the API server. Its type is
   *   [ListEnvironmentsResponse]{@link google.cloud.dialogflow.cx.v3beta1.ListEnvironmentsResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   */
  listEnvironments(
   ...
   *   The first element is Array of [Environment]{@link google.cloud.dialogflow.cx.v3beta1.Environment} that corresponds to
   *   the one page received from the API server.
   *   If the second element is not null it contains the request object of type [LookupEnvironmentHistoryRequest]{@link google.cloud.dialogflow.cx.v3beta1.LookupEnvironmentHistoryRequest}
   *   that can be used to obtain the next page of the results.
   *   If it is null, the next page does not exist.
   *   The third element contains the raw response received from the API server. Its type is
   *   [LookupEnvironmentHistoryResponse]{@link google.cloud.dialogflow.cx.v3beta1.LookupEnvironmentHistoryResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   */
  lookupEnvironmentHistory(
  ...
  /**
   * Equivalent to {@link lookupEnvironmentHistory}, but returns a NodeJS Stream object.
   *
   * This fetches the paged responses for {@link lookupEnvironmentHistory} continuously
   * and invokes the callback registered for 'data' event for each element in the
   * responses.
   *
   * The returned object has 'end' method when no more elements are required.
  ...
  /**
   * Equivalent to {@link lookupEnvironmentHistory}, but returns an iterable object.
   *
   * for-await-of syntax is used with the iterable to recursively get response element on-demand.
   *
   * @param {Object} request
