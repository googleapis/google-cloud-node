...
export class EnvironmentsClient {
  ...
  constructor(
    ...
    const runContinuousTestResponse = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.cx.v3beta1.RunContinuousTestResponse'
    ) as gax.protobuf.Type;
    const runContinuousTestMetadata = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.cx.v3beta1.RunContinuousTestMetadata'
    ) as gax.protobuf.Type;
    const deployFlowResponse = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.cx.v3beta1.DeployFlowResponse'
    ) as gax.protobuf.Type;
    const deployFlowMetadata = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.cx.v3beta1.DeployFlowMetadata'
    ) as gax.protobuf.Type;
    ...
    this.environmentsStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ...
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.dialogflow.cx.v3beta1.Environments,
      this._opts,
      this._providedCustomServicePath
   ...
   *   The first element of the array is an object representing {@link google.cloud.dialogflow.cx.v3beta1.Environment | Environment}.
   *   Please see the
   ...
   * - `response`: {@link google.cloud.dialogflow.cx.v3beta1.Environment|Environment}
   *
   * @param {Object} request
   *   The request object that will be sent.
  ...
  async checkRunContinuousTestProgress(
    ...
    LROperation<
      ...
      protos.google.cloud.dialogflow.cx.v3beta1.RunContinuousTestMetadata
    >
  > {
    const request =
      new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest(
  ...
  deployFlow(
    ...
    [
      LROperation<
        protos.google.cloud.dialogflow.cx.v3beta1.IDeployFlowResponse,
        protos.google.cloud.dialogflow.cx.v3beta1.IDeployFlowMetadata
      >,
      protos.google.longrunning.IOperation | undefined,
      {} | undefined
    ]
  ...
  async checkDeployFlowProgress(
    ...
    LROperation<
      ...
      protos.google.cloud.dialogflow.cx.v3beta1.DeployFlowMetadata
    >
  > {
    const request =
      new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest(
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link google.cloud.dialogflow.cx.v3beta1.Environment | Environment}.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link google.cloud.dialogflow.cx.v3beta1.Environment | Environment} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
   ...
   *   {@link google.cloud.dialogflow.cx.v3beta1.Environment | Environment}. The API will be called under the hood as needed, once per the page,
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link google.cloud.dialogflow.cx.v3beta1.ContinuousTestResult | ContinuousTestResult}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link google.cloud.dialogflow.cx.v3beta1.ContinuousTestResult | ContinuousTestResult} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed. Note that it can affect your quota.
   *   We recommend using `listContinuousTestResultsAsync()`
   *   method described below for async iteration which you can stop as needed.
   ...
   *   An iterable Object that allows [async iteration](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols).
   *   When you iterate the returned iterable, each element will be an object representing
   *   {@link google.cloud.dialogflow.cx.v3beta1.ContinuousTestResult | ContinuousTestResult}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the
   *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination)
   *   for more details and examples.
  ...
  listContinuousTestResultsAsync(
    request?: protos.google.cloud.dialogflow.cx.v3beta1.IListContinuousTestResultsRequest,
    options?: CallOptions
  ): AsyncIterable<protos.google.cloud.dialogflow.cx.v3beta1.IContinuousTestResult> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
