 ...
 */
import * as gapicConfig from './deployments_client_config.json';
...
export class DeploymentsClient {
   ...
   *     const client = new DeploymentsClient({fallback: 'rest'}, gax);
   *     ```
   */
  constructor(
    opts?: ClientOptions,
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing [Deployment]{@link google.cloud.dialogflow.cx.v3beta1.Deployment} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
   ...
   *   [Deployment]{@link google.cloud.dialogflow.cx.v3beta1.Deployment}. The API will be called under the hood as needed, once per the page,
