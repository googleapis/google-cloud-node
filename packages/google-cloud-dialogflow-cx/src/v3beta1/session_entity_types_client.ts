...
export class SessionEntityTypesClient {
   ...
   *   The first element is Array of [SessionEntityType]{@link google.cloud.dialogflow.cx.v3beta1.SessionEntityType} that corresponds to
   *   the one page received from the API server.
   *   If the second element is not null it contains the request object of type [ListSessionEntityTypesRequest]{@link google.cloud.dialogflow.cx.v3beta1.ListSessionEntityTypesRequest}
   *   that can be used to obtain the next page of the results.
   *   If it is null, the next page does not exist.
   *   The third element contains the raw response received from the API server. Its type is
   *   [ListSessionEntityTypesResponse]{@link google.cloud.dialogflow.cx.v3beta1.ListSessionEntityTypesResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   */
  listSessionEntityTypes(
