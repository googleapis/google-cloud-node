 ...
 */
import * as gapicConfig from './examples_client_config.json';
...
export class ExamplesClient {
  ...
  examplesStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof ExamplesClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.dialogflow.cx.v3beta1.Examples', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.examplesStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.dialogflow.cx.v3beta1.Examples') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.dialogflow.cx.v3beta1.Examples,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const examplesStubMethods =
        ['createExample', 'deleteExample', 'listExamples', 'getExample', 'updateExample'];
    for (const methodName of examplesStubMethods) {
      const callPromise = this.examplesStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 */
  createExample(
      request?: protos.google.cloud.dialogflow.cx.v3beta1.ICreateExampleRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.cx.v3beta1.IExample,
        protos.google.cloud.dialogflow.cx.v3beta1.ICreateExampleRequest|undefined, {}|undefined
      ]>;
  createExample(
      request: protos.google.cloud.dialogflow.cx.v3beta1.ICreateExampleRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.cx.v3beta1.IExample,
          protos.google.cloud.dialogflow.cx.v3beta1.ICreateExampleRequest|null|undefined,
          {}|null|undefined>): void;
  createExample(
      request: protos.google.cloud.dialogflow.cx.v3beta1.ICreateExampleRequest,
      callback: Callback<
 ...
 */
  deleteExample(
      request?: protos.google.cloud.dialogflow.cx.v3beta1.IDeleteExampleRequest,
      options?: CallOptions):
      Promise<[
        protos.google.protobuf.IEmpty,
        protos.google.cloud.dialogflow.cx.v3beta1.IDeleteExampleRequest|undefined, {}|undefined
      ]>;
  deleteExample(
      request: protos.google.cloud.dialogflow.cx.v3beta1.IDeleteExampleRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.protobuf.IEmpty,
          protos.google.cloud.dialogflow.cx.v3beta1.IDeleteExampleRequest|null|undefined,
          {}|null|undefined>): void;
  deleteExample(
      request: protos.google.cloud.dialogflow.cx.v3beta1.IDeleteExampleRequest,
      callback: Callback<
 ...
 */
  getExample(
      request?: protos.google.cloud.dialogflow.cx.v3beta1.IGetExampleRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.cx.v3beta1.IExample,
        protos.google.cloud.dialogflow.cx.v3beta1.IGetExampleRequest|undefined, {}|undefined
      ]>;
  getExample(
      request: protos.google.cloud.dialogflow.cx.v3beta1.IGetExampleRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.cx.v3beta1.IExample,
          protos.google.cloud.dialogflow.cx.v3beta1.IGetExampleRequest|null|undefined,
          {}|null|undefined>): void;
  getExample(
      request: protos.google.cloud.dialogflow.cx.v3beta1.IGetExampleRequest,
      callback: Callback<
 ...
 */
  updateExample(
      request?: protos.google.cloud.dialogflow.cx.v3beta1.IUpdateExampleRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.cx.v3beta1.IExample,
        protos.google.cloud.dialogflow.cx.v3beta1.IUpdateExampleRequest|undefined, {}|undefined
      ]>;
  updateExample(
      request: protos.google.cloud.dialogflow.cx.v3beta1.IUpdateExampleRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.cx.v3beta1.IExample,
          protos.google.cloud.dialogflow.cx.v3beta1.IUpdateExampleRequest|null|undefined,
          {}|null|undefined>): void;
  updateExample(
      request: protos.google.cloud.dialogflow.cx.v3beta1.IUpdateExampleRequest,
      callback: Callback<
 ...
 */
  listExamples(
      request?: protos.google.cloud.dialogflow.cx.v3beta1.IListExamplesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.cx.v3beta1.IExample[],
  ...
  listExamples(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.dialogflow.cx.v3beta1.IListExamplesResponse|null|undefined,
          protos.google.cloud.dialogflow.cx.v3beta1.IExample>): void;
  listExamples(
      request: protos.google.cloud.dialogflow.cx.v3beta1.IListExamplesRequest,
      callback: PaginationCallback<
          protos.google.cloud.dialogflow.cx.v3beta1.IListExamplesRequest,
  ...
  listExamples(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.dialogflow.cx.v3beta1.IListExamplesRequest,
      protos.google.cloud.dialogflow.cx.v3beta1.IListExamplesResponse|null|undefined,
      protos.google.cloud.dialogflow.cx.v3beta1.IExample>|undefined = callback
 ...
 */
  listExamplesAsync(
      request?: protos.google.cloud.dialogflow.cx.v3beta1.IListExamplesRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.dialogflow.cx.v3beta1.IExample>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listExamples.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.dialogflow.cx.v3beta1.IExample>;
  }
/**
