...
export class IntentsClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const importIntentsResponse = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.cx.v3.ImportIntentsResponse') as gax.protobuf.Type;
    const importIntentsMetadata = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.cx.v3.ImportIntentsMetadata') as gax.protobuf.Type;
    const exportIntentsResponse = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.cx.v3.ExportIntentsResponse') as gax.protobuf.Type;
    const exportIntentsMetadata = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.cx.v3.ExportIntentsMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.dialogflow.cx.v3.Intents', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.intentsStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.dialogflow.cx.v3.Intents') :
 ...
 */
  getIntent(
      ...
      Promise<[
        ...
        protos.google.cloud.dialogflow.cx.v3.IGetIntentRequest|undefined, {}|undefined
      ]>;
  getIntent(
      request: protos.google.cloud.dialogflow.cx.v3.IGetIntentRequest,
      options: CallOptions,
 ...
 */
  createIntent(
      ...
      Promise<[
        protos.google.cloud.dialogflow.cx.v3.IIntent,
        protos.google.cloud.dialogflow.cx.v3.ICreateIntentRequest|undefined, {}|undefined
      ]>;
  createIntent(
      request: protos.google.cloud.dialogflow.cx.v3.ICreateIntentRequest,
      options: CallOptions,
 ...
 */
  updateIntent(
      ...
      Promise<[
        protos.google.cloud.dialogflow.cx.v3.IIntent,
        protos.google.cloud.dialogflow.cx.v3.IUpdateIntentRequest|undefined, {}|undefined
      ]>;
  updateIntent(
      request: protos.google.cloud.dialogflow.cx.v3.IUpdateIntentRequest,
      options: CallOptions,
 ...
 */
  deleteIntent(
      ...
      Promise<[
        ...
        protos.google.cloud.dialogflow.cx.v3.IDeleteIntentRequest|undefined, {}|undefined
      ]>;
  deleteIntent(
      request: protos.google.cloud.dialogflow.cx.v3.IDeleteIntentRequest,
      options: CallOptions,
 ...
 * region_tag:dialogflow_v3_generated_Intents_ImportIntents_async
 */
  async checkImportIntentsProgress(name: string): Promise<LROperation<protos.google.cloud.dialogflow.cx.v3.ImportIntentsResponse, protos.google.cloud.dialogflow.cx.v3.ImportIntentsMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.dialogflow.cx.v3.ImportIntentsResponse, protos.google.cloud.dialogflow.cx.v3.ImportIntentsMetadata>;
  }
/**
 ...
 * region_tag:dialogflow_v3_generated_Intents_ExportIntents_async
 */
  async checkExportIntentsProgress(name: string): Promise<LROperation<protos.google.cloud.dialogflow.cx.v3.ExportIntentsResponse, protos.google.cloud.dialogflow.cx.v3.ExportIntentsMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.dialogflow.cx.v3.ExportIntentsResponse, protos.google.cloud.dialogflow.cx.v3.ExportIntentsMetadata>;
  }
 /**
 ...
 */
  ...
  listIntents(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.dialogflow.cx.v3.IIntent>): void;
  listIntents(
      request: protos.google.cloud.dialogflow.cx.v3.IListIntentsRequest,
      callback: PaginationCallback<
          protos.google.cloud.dialogflow.cx.v3.IListIntentsRequest,
  ...
  listIntents(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.dialogflow.cx.v3.IListIntentsRequest,
      protos.google.cloud.dialogflow.cx.v3.IListIntentsResponse|null|undefined,
      protos.google.cloud.dialogflow.cx.v3.IIntent>|undefined = callback
 ...
 */
  listIntentsAsync(
      request?: protos.google.cloud.dialogflow.cx.v3.IListIntentsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.dialogflow.cx.v3.IIntent>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listIntents.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.dialogflow.cx.v3.IIntent>;
  }
/**
