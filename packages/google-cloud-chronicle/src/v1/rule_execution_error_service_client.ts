 ...
 * `src/v1/rule_execution_error_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './rule_execution_error_service_client_config.json';
 ...
 * @memberof v1
 */
export class RuleExecutionErrorServiceClient {
   ...
   *     const client = new RuleExecutionErrorServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(
    opts?: ClientOptions,
    ...
    const staticMembers = this
      .constructor as typeof RuleExecutionErrorServiceClient;
    if (
    ...
    this.descriptors.page = {
      listRuleExecutionErrors: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'ruleExecutionErrors',
      ),
  ...
  initialize() {
    ...
    if (this.ruleExecutionErrorServiceStub) {
      return this.ruleExecutionErrorServiceStub;
    }

    // Put together the "service stub" for
    // google.cloud.chronicle.v1.RuleExecutionErrorService.
    this.ruleExecutionErrorServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
   ...
   *   The first element of the array is Array of {@link protos.google.cloud.chronicle.v1.RuleExecutionError|RuleExecutionError}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   *   We recommend using `listRuleExecutionErrorsAsync()`
   *   method described below for async iteration which you can stop as needed.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   */
  listRuleExecutionErrors(
    request?: protos.google.cloud.chronicle.v1.IListRuleExecutionErrorsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.chronicle.v1.IRuleExecutionError[],
      protos.google.cloud.chronicle.v1.IListRuleExecutionErrorsRequest | null,
      protos.google.cloud.chronicle.v1.IListRuleExecutionErrorsResponse,
    ]
  >;
  listRuleExecutionErrors(
    request: protos.google.cloud.chronicle.v1.IListRuleExecutionErrorsRequest,
    ...
    callback: PaginationCallback<
      protos.google.cloud.chronicle.v1.IListRuleExecutionErrorsRequest,
      | protos.google.cloud.chronicle.v1.IListRuleExecutionErrorsResponse
      | null
      | undefined,
      protos.google.cloud.chronicle.v1.IRuleExecutionError
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listRuleExecutionErrors values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listRuleExecutionErrors request %j', request);
    return this.innerApiCalls
      .listRuleExecutionErrors(request, options, wrappedCallback)
      ?.then(
        ([response, input, output]: [
          ...
          this._log.info('listRuleExecutionErrors values %j', response);
  ...
  /**
   * Equivalent to `listRuleExecutionErrors`, but returns a NodeJS Stream object.
   * @param {Object} request
   *   The request object that will be sent.
   * @param {string} request.parent
   *   Required. The instance to list rule execution errors from.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.cloud.chronicle.v1.RuleExecutionError|RuleExecutionError} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
  ...
  listRuleExecutionErrorsStream(
    ...
    return this.descriptors.page.listRuleExecutionErrors.createStream(
      this.innerApiCalls.listRuleExecutionErrors as GaxCall,
      request,
      callSettings,
    );
  }
  ...
  /**
   * Equivalent to `listRuleExecutionErrors`, but returns an iterable object.
   *
   ...
   *   {@link protos.google.cloud.chronicle.v1.RuleExecutionError|RuleExecutionError}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/rule_execution_error_service.list_rule_execution_errors.js</caption>
   * region_tag:chronicle_v1_generated_RuleExecutionErrorService_ListRuleExecutionErrors_async
   */
  listRuleExecutionErrorsAsync(
    request?: protos.google.cloud.chronicle.v1.IListRuleExecutionErrorsRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.cloud.chronicle.v1.IRuleExecutionError> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listRuleExecutionErrors.asyncIterate(
      this.innerApiCalls['listRuleExecutionErrors'] as GaxCall,
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.cloud.chronicle.v1.IRuleExecutionError>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
