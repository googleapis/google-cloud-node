 ...
 * `src/v1/dashboard_query_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './dashboard_query_service_client_config.json';
 ...
 * @memberof v1
 */
export class DashboardQueryServiceClient {
  ...
  dashboardQueryServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of DashboardQueryServiceClient.
   *
   ...
   *     const client = new DashboardQueryServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof DashboardQueryServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.chronicle.v1.DashboardQueryService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.dashboardQueryServiceStub) {
      return this.dashboardQueryServiceStub;
    }

    // Put together the "service stub" for
    // google.cloud.chronicle.v1.DashboardQueryService.
    this.dashboardQueryServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.chronicle.v1.DashboardQueryService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.chronicle.v1.DashboardQueryService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const dashboardQueryServiceStubMethods =
        ['getDashboardQuery', 'executeDashboardQuery'];
    for (const methodName of dashboardQueryServiceStubMethods) {
      const callPromise = this.dashboardQueryServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.cloud.chronicle.v1.DashboardQuery|DashboardQuery}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/dashboard_query_service.get_dashboard_query.js</caption>
 * region_tag:chronicle_v1_generated_DashboardQueryService_GetDashboardQuery_async
 */
  getDashboardQuery(
      request?: protos.google.cloud.chronicle.v1.IGetDashboardQueryRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.chronicle.v1.IDashboardQuery,
        protos.google.cloud.chronicle.v1.IGetDashboardQueryRequest|undefined, {}|undefined
      ]>;
  getDashboardQuery(
      request: protos.google.cloud.chronicle.v1.IGetDashboardQueryRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.chronicle.v1.IDashboardQuery,
          protos.google.cloud.chronicle.v1.IGetDashboardQueryRequest|null|undefined,
          {}|null|undefined>): void;
  getDashboardQuery(
      request: protos.google.cloud.chronicle.v1.IGetDashboardQueryRequest,
      callback: Callback<
  ...
  getDashboardQuery(
    ...
    this._log.info('getDashboardQuery request %j', request);
    const wrappedCallback: Callback<
        protos.google.cloud.chronicle.v1.IDashboardQuery,
        protos.google.cloud.chronicle.v1.IGetDashboardQueryRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('getDashboardQuery response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.getDashboardQuery(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.chronicle.v1.IDashboardQuery,
        protos.google.cloud.chronicle.v1.IGetDashboardQueryRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getDashboardQuery response %j', response);
 ...
 * @param {google.cloud.chronicle.v1.DashboardQuery} request.query
 ...
 *   query.
 * @param {number[]} [request.filters]
 *   Optional. Dashboard level filters other than query string.
 * @param {boolean} [request.clearCache]
 *   Optional. When true, the backend would read from the database, rather than
 *   fetching data directly from the cache.
 * @param {boolean} [request.usePreviousTimeRange]
 *   Optional. When true, the backend will execute the query against the
 *   previous time range of the query.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.cloud.chronicle.v1.ExecuteDashboardQueryResponse|ExecuteDashboardQueryResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/dashboard_query_service.execute_dashboard_query.js</caption>
 * region_tag:chronicle_v1_generated_DashboardQueryService_ExecuteDashboardQuery_async
 */
  executeDashboardQuery(
      request?: protos.google.cloud.chronicle.v1.IExecuteDashboardQueryRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.chronicle.v1.IExecuteDashboardQueryResponse,
        protos.google.cloud.chronicle.v1.IExecuteDashboardQueryRequest|undefined, {}|undefined
      ]>;
  executeDashboardQuery(
      request: protos.google.cloud.chronicle.v1.IExecuteDashboardQueryRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.chronicle.v1.IExecuteDashboardQueryResponse,
          protos.google.cloud.chronicle.v1.IExecuteDashboardQueryRequest|null|undefined,
          {}|null|undefined>): void;
  executeDashboardQuery(
      request: protos.google.cloud.chronicle.v1.IExecuteDashboardQueryRequest,
      callback: Callback<
  ...
  executeDashboardQuery(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('executeDashboardQuery request %j', request);
    const wrappedCallback: Callback<
        protos.google.cloud.chronicle.v1.IExecuteDashboardQueryResponse,
        protos.google.cloud.chronicle.v1.IExecuteDashboardQueryRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('executeDashboardQuery response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.executeDashboardQuery(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.chronicle.v1.IExecuteDashboardQueryResponse,
        protos.google.cloud.chronicle.v1.IExecuteDashboardQueryRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('executeDashboardQuery response %j', response);
        return [response, options, rawResponse];
   ...
   */
  close(): Promise<void> {
    if (this.dashboardQueryServiceStub && !this._terminated) {
      return this.dashboardQueryServiceStub.then(stub => {
