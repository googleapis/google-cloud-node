...
export class DashboardQueryServiceClient {
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof DashboardQueryServiceClient;
    if (
  ...
  getDashboardQuery(
    ...
    callback: Callback<
      protos.google.cloud.chronicle.v1.IDashboardQuery,
      | protos.google.cloud.chronicle.v1.IGetDashboardQueryRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .getDashboardQuery(request, options, wrappedCallback)
      ?.then(
  ...
  executeDashboardQuery(
    ...
    [
      ...
      (
        | protos.google.cloud.chronicle.v1.IExecuteDashboardQueryRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .executeDashboardQuery(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.cloud.chronicle.v1.IExecuteDashboardQueryResponse,
          (
