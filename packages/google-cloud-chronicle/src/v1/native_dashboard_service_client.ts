 ...
 * `src/v1/native_dashboard_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './native_dashboard_service_client_config.json';
 ...
 * @memberof v1
 */
export class NativeDashboardServiceClient {
  ...
  initialize() {
    ...
    if (this.nativeDashboardServiceStub) {
      return this.nativeDashboardServiceStub;
    }
