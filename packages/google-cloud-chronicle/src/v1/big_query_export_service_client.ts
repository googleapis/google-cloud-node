 ...
 * `src/v1/big_query_export_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './big_query_export_service_client_config.json';
 ...
 * @memberof v1
 */
export class BigQueryExportServiceClient {
  ...
  initialize() {
    ...
    if (this.bigQueryExportServiceStub) {
      return this.bigQueryExportServiceStub;
    }
