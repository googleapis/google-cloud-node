...
describe('v1.RuleServiceClient', () => {
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new ruleserviceModule.v1.RuleServiceClient({
          universe_domain: 'example.com',
    ...
    it('invokes createRule without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createRule(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.chronicle.v1.IRule | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getRetrohunt', () => {
    it('invokes getRetrohunt without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getRetrohunt as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getRetrohunt as SinonStub
    ...
    it('invokes getRetrohunt without error using callback', async () => {
      ...
      client.innerApiCalls.getRetrohunt =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getRetrohunt(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.chronicle.v1.IRetrohunt | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getRetrohunt with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getRetrohunt = stubSimpleCall(
        undefined,
        expectedError
      );
  ...
  describe('getRuleDeployment', () => {
    it('invokes getRuleDeployment without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getRuleDeployment as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getRuleDeployment as SinonStub
    ...
    it('invokes getRuleDeployment without error using callback', async () => {
      ...
      client.innerApiCalls.getRuleDeployment =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getRuleDeployment(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.chronicle.v1.IRuleDeployment | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getRuleDeployment with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getRuleDeployment = stubSimpleCall(
        undefined,
        expectedError
      );
  ...
  describe('updateRuleDeployment', () => {
    it('invokes updateRuleDeployment without error', async () => {
      ...
      client.innerApiCalls.updateRuleDeployment =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateRuleDeployment(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateRuleDeployment as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateRuleDeployment as SinonStub
    ...
    it('invokes updateRuleDeployment with error', async () => {
      ...
      const expectedHeaderRequestParams = `rule_deployment.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateRuleDeployment = stubSimpleCall(
        undefined,
        expectedError
      );
  ...
  describe('createRetrohunt', () => {
    it('invokes createRetrohunt without error', async () => {
      ...
      client.innerApiCalls.createRetrohunt =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createRetrohunt(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createRetrohunt as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createRetrohunt as SinonStub
    ...
    it('invokes createRetrohunt with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createRetrohunt = stubLongRunningCall(
        undefined,
        expectedError
      );
    ...
    it('invokes checkCreateRetrohuntProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateRetrohuntProgress(''),
        expectedError
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listRuleRevisions', () => {
    it('invokes listRuleRevisions without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listRuleRevisions as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listRuleRevisions as SinonStub
    ...
    it('invokes listRuleRevisions without error using callback', async () => {
      ...
      client.innerApiCalls.listRuleRevisions =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listRuleRevisions with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listRuleRevisions = stubSimpleCall(
        undefined,
        expectedError
      );
    ...
    it('invokes listRuleRevisionsStream without error', async () => {
      ...
      client.descriptors.page.listRuleRevisions.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      assert(
        (client.descriptors.page.listRuleRevisions.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listRuleRevisions, request)
      );
      assert(
        (client.descriptors.page.listRuleRevisions.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listRuleRevisions without error', async () => {
      ...
      client.descriptors.page.listRuleRevisions.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.chronicle.v1.IRule[] = [];
  ...
  describe('listRetrohunts', () => {
    it('invokes listRetrohunts without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listRetrohunts as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listRetrohunts as SinonStub
    ...
    it('invokes listRetrohunts without error using callback', async () => {
      ...
      client.innerApiCalls.listRetrohunts =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listRetrohunts with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listRetrohunts = stubSimpleCall(
        undefined,
        expectedError
      );
    ...
    it('invokes listRetrohuntsStream without error', async () => {
      ...
      client.descriptors.page.listRetrohunts.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.chronicle.v1.Retrohunt) => {
            responses.push(response);
          }
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listRetrohunts.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listRetrohunts, request)
      );
      assert(
        (client.descriptors.page.listRetrohunts.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listRetrohunts without error', async () => {
      ...
      client.descriptors.page.listRetrohunts.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listRuleDeployments', () => {
    it('invokes listRuleDeployments without error', async () => {
      ...
      client.innerApiCalls.listRuleDeployments =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listRuleDeployments(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listRuleDeployments as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listRuleDeployments as SinonStub
    ...
    it('invokes listRuleDeployments with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listRuleDeployments = stubSimpleCall(
        undefined,
        expectedError
      );
    ...
    it('invokes listRuleDeploymentsStream without error', async () => {
      ...
      client.descriptors.page.listRuleDeployments.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.chronicle.v1.RuleDeployment) => {
            responses.push(response);
          }
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listRuleDeployments.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listRuleDeployments, request)
      );
      assert(
        (client.descriptors.page.listRuleDeployments.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listRuleDeployments without error', async () => {
      ...
      client.descriptors.page.listRuleDeployments.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
