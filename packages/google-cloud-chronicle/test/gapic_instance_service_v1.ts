  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          instanceserviceModule.v1.InstanceServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          instanceserviceModule.v1.InstanceServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'chronicle.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new instanceserviceModule.v1.InstanceServiceClient({
          universe_domain: 'example.com',
    ...
    it('invokes getInstance without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getInstance(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.chronicle.v1.IInstance | null
          ) => {
            if (err) {
              reject(err);
            } else {
