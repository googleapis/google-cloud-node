...
import * as feedsserviceModule from '../src';
...
describe('v1.FeedsServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          feedsserviceModule.v1.FeedsServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          feedsserviceModule.v1.FeedsServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'chronicle.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new feedsserviceModule.v1.FeedsServiceClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = feedsserviceModule.v1.FeedsServiceClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.feedsServiceStub, undefined);
      await client.initialize();
      assert(client.feedsServiceStub);
    });
  ...
  describe('fetchServiceAccountForCustomer', () => {
    it('invokes fetchServiceAccountForCustomer without error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.chronicle.v1.FetchServiceAccountForCustomerRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.chronicle.v1.FetchServiceAccountForCustomerRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.chronicle.v1.FeedServiceAccount(),
      );
      client.innerApiCalls.fetchServiceAccountForCustomer =
        stubSimpleCall(expectedResponse);
      const [response] = await client.fetchServiceAccountForCustomer(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.fetchServiceAccountForCustomer as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes fetchServiceAccountForCustomer without error using callback', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      const promise = new Promise((resolve, reject) => {
        client.fetchServiceAccountForCustomer(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.chronicle.v1.IFeedServiceAccount | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes fetchServiceAccountForCustomer with error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.fetchServiceAccountForCustomer = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.fetchServiceAccountForCustomer(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.fetchServiceAccountForCustomer as SinonStub
    ...
    it('invokes fetchServiceAccountForCustomer with closed client', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
  ...
  describe('createFeed', () => {
    it('invokes createFeed without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.chronicle.v1.CreateFeedRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.chronicle.v1.CreateFeedRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.chronicle.v1.Feed(),
      );
    ...
    it('invokes createFeed without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createFeed(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.chronicle.v1.IFeed | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getFeed', () => {
    it('invokes getFeed without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.chronicle.v1.GetFeedRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.chronicle.v1.GetFeedRequest',
        ['name'],
      );
  ...
  describe('deleteFeed', () => {
    it('invokes deleteFeed without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.chronicle.v1.DeleteFeedRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.chronicle.v1.DeleteFeedRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('enableFeed', () => {
    it('invokes enableFeed without error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.chronicle.v1.EnableFeedRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.chronicle.v1.EnableFeedRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.enableFeed = stubSimpleCall(expectedResponse);
      const [response] = await client.enableFeed(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.enableFeed as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.enableFeed as SinonStub
    ...
    it('invokes enableFeed without error using callback', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.enableFeed =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.enableFeed(
          request,
    ...
    it('invokes enableFeed with error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.enableFeed = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.enableFeed(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.enableFeed as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes enableFeed with closed client', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
  ...
  describe('disableFeed', () => {
    it('invokes disableFeed without error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.chronicle.v1.DisableFeedRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.chronicle.v1.DisableFeedRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.disableFeed = stubSimpleCall(expectedResponse);
      const [response] = await client.disableFeed(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.disableFeed as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.disableFeed as SinonStub
    ...
    it('invokes disableFeed without error using callback', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.disableFeed =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.disableFeed(
          request,
    ...
    it('invokes disableFeed with error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.disableFeed = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.disableFeed(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.disableFeed as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes disableFeed with closed client', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
  ...
  describe('getFeedPack', () => {
    it('invokes getFeedPack without error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.chronicle.v1.GetFeedPackRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.chronicle.v1.GetFeedPackRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.chronicle.v1.FeedPack(),
      );
      client.innerApiCalls.getFeedPack = stubSimpleCall(expectedResponse);
      const [response] = await client.getFeedPack(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getFeedPack as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getFeedPack as SinonStub
    ...
    it('invokes getFeedPack without error using callback', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.getFeedPack =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getFeedPack(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.chronicle.v1.IFeedPack | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getFeedPack with error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getFeedPack = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.getFeedPack(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.getFeedPack as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes getFeedPack with closed client', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
  ...
  describe('updateFeed', () => {
    it('invokes updateFeed without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.chronicle.v1.UpdateFeedRequest(),
      );
      request.feed ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.chronicle.v1.UpdateFeedRequest',
        ['feed', 'name'],
      );
  ...
  describe('importPushLogs', () => {
    it('invokes importPushLogs without error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.chronicle.v1.ImportPushLogsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.importPushLogs = stubSimpleCall(expectedResponse);
      const [response] = await client.importPushLogs(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.importPushLogs as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.importPushLogs as SinonStub
    ...
    it('invokes importPushLogs without error using callback', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.importPushLogs =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.importPushLogs(
          request,
    ...
    it('invokes importPushLogs with error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.importPushLogs = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.importPushLogs(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.importPushLogs as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes importPushLogs with closed client', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
  ...
  describe('generateSecret', () => {
    it('invokes generateSecret without error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.chronicle.v1.GenerateSecretRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.chronicle.v1.GenerateSecretResponse(),
      );
      client.innerApiCalls.generateSecret = stubSimpleCall(expectedResponse);
      const [response] = await client.generateSecret(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.generateSecret as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.generateSecret as SinonStub
    ...
    it('invokes generateSecret without error using callback', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.generateSecret =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.generateSecret(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.chronicle.v1.IGenerateSecretResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes generateSecret with error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.generateSecret = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.generateSecret(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.generateSecret as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes generateSecret with closed client', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
  ...
  describe('listFeeds', () => {
    it('invokes listFeeds without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.chronicle.v1.ListFeedsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.chronicle.v1.ListFeedsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = [
        generateSampleMessage(new protos.google.cloud.chronicle.v1.Feed()),
        generateSampleMessage(new protos.google.cloud.chronicle.v1.Feed()),
        generateSampleMessage(new protos.google.cloud.chronicle.v1.Feed()),
      ];
    ...
    it('invokes listFeedsStream without error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.descriptors.page.listFeeds.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listFeedsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.chronicle.v1.Feed[] = [];
        stream.on('data', (response: protos.google.cloud.chronicle.v1.Feed) => {
      ...
      assert(
        (client.descriptors.page.listFeeds.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listFeeds, request),
      );
      assert(
        (client.descriptors.page.listFeeds.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listFeedsStream with error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listFeeds.createStream = stubPageStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.listFeedsStream(request);
    ...
    it('uses async iteration with listFeeds without error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.descriptors.page.listFeeds.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.chronicle.v1.IFeed[] = [];
      const iterable = client.listFeedsAsync(request);
      for await (const resource of iterable) {
        responses.push(resource!);
      }
      assert.deepStrictEqual(responses, expectedResponse);
      assert.deepStrictEqual(
        (client.descriptors.page.listFeeds.asyncIterate as SinonStub).getCall(0)
          .args[1],
        request,
      );
      assert(
        (client.descriptors.page.listFeeds.asyncIterate as SinonStub)
          .getCall(0)
          .args[2].otherArgs.headers['x-goog-request-params'].includes(
            expectedHeaderRequestParams,
          ),
    ...
    it('uses async iteration with listFeeds with error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listFeeds.asyncIterate = stubAsyncIterationCall(
        undefined,
        expectedError,
      );
      const iterable = client.listFeedsAsync(request);
  ...
  describe('listFeedPacks', () => {
    it('invokes listFeedPacks without error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.chronicle.v1.ListFeedPacksRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.chronicle.v1.ListFeedPacksRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = [
        generateSampleMessage(new protos.google.cloud.chronicle.v1.FeedPack()),
        generateSampleMessage(new protos.google.cloud.chronicle.v1.FeedPack()),
        generateSampleMessage(new protos.google.cloud.chronicle.v1.FeedPack()),
      ];
      client.innerApiCalls.listFeedPacks = stubSimpleCall(expectedResponse);
      const [response] = await client.listFeedPacks(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listFeedPacks as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listFeedPacks as SinonStub
    ...
    it('invokes listFeedPacks without error using callback', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.listFeedPacks =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listFeedPacks(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.chronicle.v1.IFeedPack[] | null,
    ...
    it('invokes listFeedPacks with error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listFeedPacks = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.listFeedPacks(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.listFeedPacks as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes listFeedPacksStream without error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.descriptors.page.listFeedPacks.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listFeedPacksStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.chronicle.v1.FeedPack[] = [];
        stream.on(
          'data',
          (response: protos.google.cloud.chronicle.v1.FeedPack) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert.deepStrictEqual(responses, expectedResponse);
      assert(
        (client.descriptors.page.listFeedPacks.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listFeedPacks, request),
      );
      assert(
        (client.descriptors.page.listFeedPacks.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listFeedPacksStream with error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
    ...
    it('uses async iteration with listFeedPacks without error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.descriptors.page.listFeedPacks.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.chronicle.v1.IFeedPack[] = [];
      const iterable = client.listFeedPacksAsync(request);
      for await (const resource of iterable) {
        responses.push(resource!);
      }
      assert.deepStrictEqual(responses, expectedResponse);
      assert.deepStrictEqual(
        (
          client.descriptors.page.listFeedPacks.asyncIterate as SinonStub
        ).getCall(0).args[1],
        request,
      );
      assert(
    ...
    it('uses async iteration with listFeedPacks with error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
  ...
  describe('listFeedSourceTypeSchemas', () => {
    it('invokes listFeedSourceTypeSchemas without error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.chronicle.v1.ListFeedSourceTypeSchemasRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.chronicle.v1.FeedSourceTypeSchema(),
        ),
        generateSampleMessage(
          new protos.google.cloud.chronicle.v1.FeedSourceTypeSchema(),
        ),
      ...
      client.innerApiCalls.listFeedSourceTypeSchemas =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listFeedSourceTypeSchemas(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listFeedSourceTypeSchemas as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listFeedSourceTypeSchemas as SinonStub
    ...
    it('invokes listFeedSourceTypeSchemas without error using callback', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.listFeedSourceTypeSchemas =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listFeedSourceTypeSchemas(
          request,
          (
            err?: Error | null,
            result?:
              protos.google.cloud.chronicle.v1.IFeedSourceTypeSchema[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listFeedSourceTypeSchemas with error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listFeedSourceTypeSchemas = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listFeedSourceTypeSchemas(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listFeedSourceTypeSchemas as SinonStub
    ...
    it('invokes listFeedSourceTypeSchemasStream without error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.descriptors.page.listFeedSourceTypeSchemas.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listFeedSourceTypeSchemasStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.chronicle.v1.FeedSourceTypeSchema[] =
          [];
        stream.on(
          'data',
          (response: protos.google.cloud.chronicle.v1.FeedSourceTypeSchema) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (
          client.descriptors.page.listFeedSourceTypeSchemas
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listFeedSourceTypeSchemas, request),
      );
      assert(
        (
          client.descriptors.page.listFeedSourceTypeSchemas
    ...
    it('invokes listFeedSourceTypeSchemasStream with error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
    ...
    it('uses async iteration with listFeedSourceTypeSchemas without error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.descriptors.page.listFeedSourceTypeSchemas.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.chronicle.v1.IFeedSourceTypeSchema[] =
        [];
      const iterable = client.listFeedSourceTypeSchemasAsync(request);
      for await (const resource of iterable) {
        responses.push(resource!);
      }
      assert.deepStrictEqual(responses, expectedResponse);
    ...
    it('uses async iteration with listFeedSourceTypeSchemas with error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
  ...
  describe('listLogTypeSchemas', () => {
    it('invokes listLogTypeSchemas without error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.chronicle.v1.ListLogTypeSchemasRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.chronicle.v1.ListLogTypeSchemasRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.chronicle.v1.LogTypeSchema(),
        ),
        generateSampleMessage(
          new protos.google.cloud.chronicle.v1.LogTypeSchema(),
        ),
      ...
      client.innerApiCalls.listLogTypeSchemas =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listLogTypeSchemas(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listLogTypeSchemas as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listLogTypeSchemas as SinonStub
    ...
    it('invokes listLogTypeSchemas without error using callback', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.listLogTypeSchemas =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listLogTypeSchemas(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.chronicle.v1.ILogTypeSchema[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listLogTypeSchemas with error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listLogTypeSchemas = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.listLogTypeSchemas(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.listLogTypeSchemas as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes listLogTypeSchemasStream without error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.descriptors.page.listLogTypeSchemas.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listLogTypeSchemasStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.chronicle.v1.LogTypeSchema[] = [];
        stream.on(
          'data',
          (response: protos.google.cloud.chronicle.v1.LogTypeSchema) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert.deepStrictEqual(responses, expectedResponse);
      assert(
        (client.descriptors.page.listLogTypeSchemas.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listLogTypeSchemas, request),
      );
      assert(
        (client.descriptors.page.listLogTypeSchemas.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listLogTypeSchemasStream with error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
    ...
    it('uses async iteration with listLogTypeSchemas without error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.descriptors.page.listLogTypeSchemas.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.chronicle.v1.ILogTypeSchema[] = [];
      const iterable = client.listLogTypeSchemasAsync(request);
      for await (const resource of iterable) {
        responses.push(resource!);
      }
      assert.deepStrictEqual(responses, expectedResponse);
      assert.deepStrictEqual(
        (
          client.descriptors.page.listLogTypeSchemas.asyncIterate as SinonStub
        ).getCall(0).args[1],
        request,
      );
      assert(
    ...
    it('uses async iteration with listLogTypeSchemas with error', async () => {
      const client = new feedsserviceModule.v1.FeedsServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
  ...
  describe('Path templates', () => {
    ...
    describe('logType', async () => {
      const fakePath = '/rendered/path/logType';
      const expectedParameters = {
        project: 'projectValue',
        location: 'locationValue',
        instance: 'instanceValue',
      ...
      await client.initialize();
      client.pathTemplates.logTypePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.logTypePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('logTypePath', () => {
        const result = client.logTypePath(
          'projectValue',
          'locationValue',
          'instanceValue',
          'logTypeValue',
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.logTypePathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });

      it('matchProjectFromLogTypeName', () => {
        const result = client.matchProjectFromLogTypeName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.logTypePathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });

      it('matchLocationFromLogTypeName', () => {
        const result = client.matchLocationFromLogTypeName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (client.pathTemplates.logTypePathTemplate.match as SinonStub)
            .getCall(-1)
      ...
      it('matchInstanceFromLogTypeName', () => {
        const result = client.matchInstanceFromLogTypeName(fakePath);
        assert.strictEqual(result, 'instanceValue');
        assert(
          (client.pathTemplates.logTypePathTemplate.match as SinonStub)
            .getCall(-1)
      ...
      it('matchLogTypeFromLogTypeName', () => {
        const result = client.matchLogTypeFromLogTypeName(fakePath);
