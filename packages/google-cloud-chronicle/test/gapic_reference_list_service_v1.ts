...
describe('v1.ReferenceListServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          referencelistserviceModule.v1.ReferenceListServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          referencelistserviceModule.v1.ReferenceListServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'chronicle.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        referencelistserviceModule.v1.ReferenceListServiceClient.port;
      assert(port);
  ...
  describe('getReferenceList', () => {
    it('invokes getReferenceList without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getReferenceList as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getReferenceList without error using callback', async () => {
      ...
      client.innerApiCalls.getReferenceList =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getReferenceList(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.chronicle.v1.IReferenceList | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getReferenceList with error', async () => {
      ...
      client.innerApiCalls.getReferenceList = stubSimpleCall(
        undefined,
        expectedError
      );
  ...
  describe('createReferenceList', () => {
    it('invokes createReferenceList without error', async () => {
      ...
      client.innerApiCalls.createReferenceList =
        stubSimpleCall(expectedResponse);
      const [response] = await client.createReferenceList(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createReferenceList as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createReferenceList as SinonStub
    ...
    it('invokes createReferenceList with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createReferenceList = stubSimpleCall(
        undefined,
        expectedError
      );
  ...
  describe('updateReferenceList', () => {
    it('invokes updateReferenceList without error', async () => {
      ...
      client.innerApiCalls.updateReferenceList =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateReferenceList(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateReferenceList as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateReferenceList as SinonStub
    ...
    it('invokes updateReferenceList with error', async () => {
      ...
      const expectedHeaderRequestParams = `reference_list.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateReferenceList = stubSimpleCall(
        undefined,
        expectedError
      );
  ...
  describe('listReferenceLists', () => {
    it('invokes listReferenceLists without error', async () => {
      ...
      client.innerApiCalls.listReferenceLists =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listReferenceLists(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listReferenceLists as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listReferenceLists as SinonStub
    ...
    it('invokes listReferenceLists with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listReferenceLists = stubSimpleCall(
        undefined,
        expectedError
      );
    ...
    it('invokes listReferenceListsStream without error', async () => {
      ...
      client.descriptors.page.listReferenceLists.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.chronicle.v1.ReferenceList) => {
      ...
      assert(
        (client.descriptors.page.listReferenceLists.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listReferenceLists, request)
      );
      assert(
        (client.descriptors.page.listReferenceLists.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listReferenceLists without error', async () => {
      ...
      client.descriptors.page.listReferenceLists.asyncIterate =
