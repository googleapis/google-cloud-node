...
describe('v1.RuleExecutionErrorServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          ruleexecutionerrorserviceModule.v1.RuleExecutionErrorServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        ruleexecutionerrorserviceModule.v1.RuleExecutionErrorServiceClient.port;
      assert(port);
  ...
  describe('listRuleExecutionErrors', () => {
    it('invokes listRuleExecutionErrors without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.chronicle.v1.ListRuleExecutionErrorsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.chronicle.v1.ListRuleExecutionErrorsRequest',
        ['parent'],
      );
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.chronicle.v1.RuleExecutionError(),
        ),
        generateSampleMessage(
          new protos.google.cloud.chronicle.v1.RuleExecutionError(),
        ),
      ...
      client.innerApiCalls.listRuleExecutionErrors =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listRuleExecutionErrors(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listRuleExecutionErrors as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes listRuleExecutionErrors without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listRuleExecutionErrors(
          request,
          (
            err?: Error | null,
            result?:
    ...
    it('invokes listRuleExecutionErrors with error', async () => {
      ...
      client.innerApiCalls.listRuleExecutionErrors = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listRuleExecutionErrors(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listRuleExecutionErrors as SinonStub
    ...
    it('invokes listRuleExecutionErrorsStream without error', async () => {
      ...
      client.descriptors.page.listRuleExecutionErrors.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listRuleExecutionErrorsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.chronicle.v1.RuleExecutionError[] =
          [];
        stream.on(
          'data',
          (response: protos.google.cloud.chronicle.v1.RuleExecutionError) => {
      ...
      assert(
        (
          client.descriptors.page.listRuleExecutionErrors
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listRuleExecutionErrors, request),
      );
      assert(
        (
          client.descriptors.page.listRuleExecutionErrors
    ...
    it('uses async iteration with listRuleExecutionErrors without error', async () => {
      ...
      client.descriptors.page.listRuleExecutionErrors.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.chronicle.v1.IRuleExecutionError[] =
        [];
      const iterable = client.listRuleExecutionErrorsAsync(request);
  ...
  describe('Path templates', () => {
    ...
    describe('curatedRule', async () => {
      const fakePath = '/rendered/path/curatedRule';
      const expectedParameters = {
        project: 'projectValue',
        location: 'locationValue',
        instance: 'instanceValue',
        curatedRule: 'curatedRuleValue',
      };
      const client =
        new ruleexecutionerrorserviceModule.v1.RuleExecutionErrorServiceClient({
          credentials: { client_email: 'bogus', private_key: 'bogus' },
      ...
      await client.initialize();
      client.pathTemplates.curatedRulePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.curatedRulePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('curatedRulePath', () => {
        const result = client.curatedRulePath(
          'projectValue',
          'locationValue',
          'instanceValue',
          'curatedRuleValue',
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.curatedRulePathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });

      it('matchProjectFromCuratedRuleName', () => {
        const result = client.matchProjectFromCuratedRuleName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.curatedRulePathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });

      it('matchLocationFromCuratedRuleName', () => {
        const result = client.matchLocationFromCuratedRuleName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (client.pathTemplates.curatedRulePathTemplate.match as SinonStub)
            .getCall(-1)
      ...
      it('matchInstanceFromCuratedRuleName', () => {
        const result = client.matchInstanceFromCuratedRuleName(fakePath);
        assert.strictEqual(result, 'instanceValue');
        assert(
          (client.pathTemplates.curatedRulePathTemplate.match as SinonStub)
            .getCall(-1)
      ...
      it('matchCuratedRuleFromCuratedRuleName', () => {
        const result = client.matchCuratedRuleFromCuratedRuleName(fakePath);
        assert.strictEqual(result, 'curatedRuleValue');
        assert(
          (client.pathTemplates.curatedRulePathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
