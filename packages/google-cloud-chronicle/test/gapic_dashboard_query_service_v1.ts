...
import * as dashboardqueryserviceModule from '../src';
...
describe('v1.DashboardQueryServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new dashboardqueryserviceModule.v1.DashboardQueryServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = dashboardqueryserviceModule.v1.DashboardQueryServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = dashboardqueryserviceModule.v1.DashboardQueryServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'chronicle.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new dashboardqueryserviceModule.v1.DashboardQueryServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'chronicle.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new dashboardqueryserviceModule.v1.DashboardQueryServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'chronicle.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new dashboardqueryserviceModule.v1.DashboardQueryServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new dashboardqueryserviceModule.v1.DashboardQueryServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = dashboardqueryserviceModule.v1.DashboardQueryServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.dashboardQueryServiceStub, undefined);
            await client.initialize();
            assert(client.dashboardQueryServiceStub);
        });
    ...
    describe('getDashboardQuery', () => {
        it('invokes getDashboardQuery without error', async () => {
            const client = new dashboardqueryserviceModule.v1.DashboardQueryServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.chronicle.v1.GetDashboardQueryRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.chronicle.v1.GetDashboardQueryRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.chronicle.v1.DashboardQuery()
            );
            client.innerApiCalls.getDashboardQuery = stubSimpleCall(expectedResponse);
            const [response] = await client.getDashboardQuery(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getDashboardQuery as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDashboardQuery as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getDashboardQuery without error using callback', async () => {
            const client = new dashboardqueryserviceModule.v1.DashboardQueryServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getDashboardQuery = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getDashboardQuery(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.chronicle.v1.IDashboardQuery|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getDashboardQuery with error', async () => {
            const client = new dashboardqueryserviceModule.v1.DashboardQueryServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getDashboardQuery = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getDashboardQuery(request), expectedError);
            const actualRequest = (client.innerApiCalls.getDashboardQuery as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDashboardQuery as SinonStub)
        ...
        it('invokes getDashboardQuery with closed client', async () => {
            const client = new dashboardqueryserviceModule.v1.DashboardQueryServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('executeDashboardQuery', () => {
        it('invokes executeDashboardQuery without error', async () => {
            const client = new dashboardqueryserviceModule.v1.DashboardQueryServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.chronicle.v1.ExecuteDashboardQueryRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.chronicle.v1.ExecuteDashboardQueryRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.chronicle.v1.ExecuteDashboardQueryResponse()
            );
            client.innerApiCalls.executeDashboardQuery = stubSimpleCall(expectedResponse);
            const [response] = await client.executeDashboardQuery(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.executeDashboardQuery as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.executeDashboardQuery as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes executeDashboardQuery without error using callback', async () => {
            const client = new dashboardqueryserviceModule.v1.DashboardQueryServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.executeDashboardQuery = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.executeDashboardQuery(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.chronicle.v1.IExecuteDashboardQueryResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes executeDashboardQuery with error', async () => {
            const client = new dashboardqueryserviceModule.v1.DashboardQueryServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.executeDashboardQuery = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.executeDashboardQuery(request), expectedError);
            const actualRequest = (client.innerApiCalls.executeDashboardQuery as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.executeDashboardQuery as SinonStub)
        ...
        it('invokes executeDashboardQuery with closed client', async () => {
            const client = new dashboardqueryserviceModule.v1.DashboardQueryServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
