...
describe('v1.DashboardQueryServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new dashboardqueryserviceModule.v1.DashboardQueryServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          dashboardqueryserviceModule.v1.DashboardQueryServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        dashboardqueryserviceModule.v1.DashboardQueryServiceClient.port;
      assert(port);
  ...
  describe('getDashboardQuery', () => {
    it('invokes getDashboardQuery without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getDashboardQuery as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getDashboardQuery without error using callback', async () => {
      ...
      client.innerApiCalls.getDashboardQuery =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDashboardQuery(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.chronicle.v1.IDashboardQuery | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getDashboardQuery with error', async () => {
      ...
      client.innerApiCalls.getDashboardQuery = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('executeDashboardQuery', () => {
    it('invokes executeDashboardQuery without error', async () => {
      ...
      client.innerApiCalls.executeDashboardQuery =
        stubSimpleCall(expectedResponse);
      const [response] = await client.executeDashboardQuery(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.executeDashboardQuery as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.executeDashboardQuery as SinonStub
    ...
    it('invokes executeDashboardQuery without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.executeDashboardQuery(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.chronicle.v1.IExecuteDashboardQueryResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes executeDashboardQuery with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.executeDashboardQuery = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.executeDashboardQuery(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.executeDashboardQuery as SinonStub
