...
describe('v1.DashboardChartServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new dashboardchartserviceModule.v1.DashboardChartServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = dashboardchartserviceModule.v1.DashboardChartServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = dashboardchartserviceModule.v1.DashboardChartServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'chronicle.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new dashboardchartserviceModule.v1.DashboardChartServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'chronicle.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new dashboardchartserviceModule.v1.DashboardChartServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'chronicle.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new dashboardchartserviceModule.v1.DashboardChartServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new dashboardchartserviceModule.v1.DashboardChartServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = dashboardchartserviceModule.v1.DashboardChartServiceClient.port;
            assert(port);
    ...
    describe('getDashboardChart', () => {
        it('invokes getDashboardChart without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.chronicle.v1.GetDashboardChartRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.getDashboardChart as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDashboardChart as SinonStub)
        ...
        it('invokes getDashboardChart without error using callback', async () => {
            ...
            client.innerApiCalls.getDashboardChart = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getDashboardChart(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.chronicle.v1.IDashboardChart|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getDashboardChart with error', async () => {
            ...
            client.innerApiCalls.getDashboardChart = stubSimpleCall(undefined, expectedError);
    ...
    describe('batchGetDashboardCharts', () => {
        it('invokes batchGetDashboardCharts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.chronicle.v1.BatchGetDashboardChartsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.chronicle.v1.BatchGetDashboardChartsResponse()
            );
            client.innerApiCalls.batchGetDashboardCharts = stubSimpleCall(expectedResponse);
            const [response] = await client.batchGetDashboardCharts(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchGetDashboardCharts as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchGetDashboardCharts as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes batchGetDashboardCharts without error using callback', async () => {
            ...
            client.innerApiCalls.batchGetDashboardCharts = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchGetDashboardCharts(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.chronicle.v1.IBatchGetDashboardChartsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchGetDashboardCharts with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchGetDashboardCharts = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.batchGetDashboardCharts(request), expectedError);
            const actualRequest = (client.innerApiCalls.batchGetDashboardCharts as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchGetDashboardCharts as SinonStub)
