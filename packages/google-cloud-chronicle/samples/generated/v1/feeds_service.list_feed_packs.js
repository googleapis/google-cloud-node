...
function main(parent) {
  // [START chronicle_v1_generated_FeedsService_ListFeedPacks_async]
  /**
  ...
  async function callListFeedPacks() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = chronicleClient.listFeedPacksAsync(request);
  ...
  callListFeedPacks();
  // [END chronicle_v1_generated_FeedsService_ListFeedPacks_async]
}
