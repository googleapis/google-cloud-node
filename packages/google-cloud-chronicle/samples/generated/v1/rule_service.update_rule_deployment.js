...
function main(ruleDeployment, updateMask) {
  ...
  async function callUpdateRuleDeployment() {
    // Construct request
    const request = {
      ruleDeployment,
      updateMask,
    ...
    // Run request
    const response = await chronicleClient.updateRuleDeployment(request);
    console.log(response);
  }

  callUpdateRuleDeployment();
