...
function main(parent) {
  // [START chronicle_v1_generated_FeedsService_ListFeeds_async]
  /**
  ...
  async function callListFeeds() {
    ...
    // Run request
    const iterable = chronicleClient.listFeedsAsync(request);
  ...
  callListFeeds();
  // [END chronicle_v1_generated_FeedsService_ListFeeds_async]
}
