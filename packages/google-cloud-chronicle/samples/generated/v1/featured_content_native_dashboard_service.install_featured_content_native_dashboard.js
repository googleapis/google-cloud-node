...
function main(name) {
   ...
   */
  // const featuredContentNativeDashboard = {}
  ...
  async function callInstallFeaturedContentNativeDashboard() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await chronicleClient.installFeaturedContentNativeDashboard(request);
    console.log(response);
  }

  callInstallFeaturedContentNativeDashboard();
