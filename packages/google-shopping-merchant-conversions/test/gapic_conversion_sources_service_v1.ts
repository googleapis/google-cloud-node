  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          conversionsourcesserviceModule.v1.ConversionSourcesServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        conversionsourcesserviceModule.v1.ConversionSourcesServiceClient.port;
      assert(port);
    ...
    it('invokes createConversionSource without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createConversionSource(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.conversions.v1.IConversionSource | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listConversionSourcesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.shopping.merchant.conversions.v1.ConversionSource,
          ) => {
