...
describe('v1beta1.PolicyTagManagerClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new policytagmanagerModule.v1beta1.PolicyTagManagerClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'datacatalog.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new policytagmanagerModule.v1beta1.PolicyTagManagerClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'datacatalog.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new policytagmanagerModule.v1beta1.PolicyTagManagerClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new policytagmanagerModule.v1beta1.PolicyTagManagerClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createTaxonomy', () => {
        it('invokes createTaxonomy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.CreateTaxonomyRequest', ['parent']);
        ...
        it('invokes createTaxonomy without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createTaxonomy(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datacatalog.v1beta1.ITaxonomy|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deleteTaxonomy', () => {
        it('invokes deleteTaxonomy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.DeleteTaxonomyRequest', ['name']);
    ...
    describe('updateTaxonomy', () => {
        it('invokes updateTaxonomy without error', async () => {
            ...
            request.taxonomy ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.UpdateTaxonomyRequest', ['taxonomy', 'name']);
    ...
    describe('getTaxonomy', () => {
        it('invokes getTaxonomy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.GetTaxonomyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.datacatalog.v1beta1.Taxonomy()
    ...
    describe('createPolicyTag', () => {
        it('invokes createPolicyTag without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.CreatePolicyTagRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes createPolicyTag without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createPolicyTag(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datacatalog.v1beta1.IPolicyTag|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deletePolicyTag', () => {
        it('invokes deletePolicyTag without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.DeletePolicyTagRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('updatePolicyTag', () => {
        it('invokes updatePolicyTag without error', async () => {
            ...
            request.policyTag ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.UpdatePolicyTagRequest', ['policyTag', 'name']);
    ...
    describe('getPolicyTag', () => {
        it('invokes getPolicyTag without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.GetPolicyTagRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.datacatalog.v1beta1.PolicyTag()
    ...
    describe('listTaxonomies', () => {
        it('invokes listTaxonomies without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.ListTaxonomiesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.datacatalog.v1beta1.Taxonomy()),
              generateSampleMessage(new protos.google.cloud.datacatalog.v1beta1.Taxonomy()),
              generateSampleMessage(new protos.google.cloud.datacatalog.v1beta1.Taxonomy()),
            ];
        ...
        it('invokes listTaxonomiesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.datacatalog.v1beta1.Taxonomy) => {
    ...
    describe('listPolicyTags', () => {
        it('invokes listPolicyTags without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.ListPolicyTagsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.datacatalog.v1beta1.PolicyTag()),
              generateSampleMessage(new protos.google.cloud.datacatalog.v1beta1.PolicyTag()),
              generateSampleMessage(new protos.google.cloud.datacatalog.v1beta1.PolicyTag()),
            ];
        ...
        it('invokes listPolicyTagsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.datacatalog.v1beta1.PolicyTag) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
