...
describe('v1.PolicyTagManagerSerializationClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = policytagmanagerserializationModule.v1.PolicyTagManagerSerializationClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = policytagmanagerserializationModule.v1.PolicyTagManagerSerializationClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'datacatalog.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new policytagmanagerserializationModule.v1.PolicyTagManagerSerializationClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'datacatalog.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new policytagmanagerserializationModule.v1.PolicyTagManagerSerializationClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'datacatalog.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new policytagmanagerserializationModule.v1.PolicyTagManagerSerializationClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new policytagmanagerserializationModule.v1.PolicyTagManagerSerializationClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = policytagmanagerserializationModule.v1.PolicyTagManagerSerializationClient.port;
            assert(port);
    ...
    describe('replaceTaxonomy', () => {
        it('invokes replaceTaxonomy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.ReplaceTaxonomyRequest', ['name']);
            ...
            const actualRequest = (client.innerApiCalls.replaceTaxonomy as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.replaceTaxonomy as SinonStub)
        ...
        it('invokes replaceTaxonomy without error using callback', async () => {
            ...
            client.innerApiCalls.replaceTaxonomy = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes replaceTaxonomy with error', async () => {
            ...
            client.innerApiCalls.replaceTaxonomy = stubSimpleCall(undefined, expectedError);
    ...
    describe('importTaxonomies', () => {
        it('invokes importTaxonomies without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.ImportTaxonomiesRequest', ['parent']);
        ...
        it('invokes importTaxonomies without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.importTaxonomies(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datacatalog.v1.IImportTaxonomiesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('exportTaxonomies', () => {
        it('invokes exportTaxonomies without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1.ExportTaxonomiesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes exportTaxonomies without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.exportTaxonomies(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datacatalog.v1.IExportTaxonomiesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
