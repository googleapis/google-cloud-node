...
export class LineageClient {
  ...
  initialize() {
    ...
    const lineageStubMethods =
        ['createProcess', 'updateProcess', 'getProcess', 'listProcesses', 'deleteProcess', 'createRun', 'updateRun', 'getRun', 'listRuns', 'deleteRun', 'createLineageEvent', 'getLineageEvent', 'listLineageEvents', 'deleteLineageEvent', 'searchLinks', 'batchSearchLinkProcesses'];
 ...
 */
  ...
  batchSearchLinkProcesses(
    ...
    this.initialize();
    return this.innerApiCalls.batchSearchLinkProcesses(request, options, callback);
  }
