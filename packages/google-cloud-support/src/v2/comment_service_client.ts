...
export class CommentServiceClient {
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v2/comment_service.get_comment.js</caption>
   * region_tag:cloudsupport_v2_generated_CommentService_GetComment_async
   */
  getComment(
    ...
    [
      protos.google.cloud.support.v2.IComment,
      protos.google.cloud.support.v2.IGetCommentRequest | undefined,
      {} | undefined,
    ]
  >;
  getComment(
    ...
    callback: Callback<
      protos.google.cloud.support.v2.IComment,
      protos.google.cloud.support.v2.IGetCommentRequest | null | undefined,
      {} | null | undefined
    >,
  ): void;
  getComment(
