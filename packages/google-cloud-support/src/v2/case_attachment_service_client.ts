...
export class CaseAttachmentServiceClient {
   ...
   *   The first element of the array is an object representing {@link protos.google.cloud.support.v2.Attachment|Attachment}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v2/case_attachment_service.get_attachment.js</caption>
   * region_tag:cloudsupport_v2_generated_CaseAttachmentService_GetAttachment_async
   */
  getAttachment(
    ...
    [
      ...
      protos.google.cloud.support.v2.IGetAttachmentRequest | undefined,
      {} | undefined,
    ]
  >;
  getAttachment(
    ...
    callback: Callback<
      protos.google.cloud.support.v2.IAttachment,
      protos.google.cloud.support.v2.IGetAttachmentRequest | null | undefined,
      {} | null | undefined
    >,
  ): void;
  getAttachment(
  ...
  getAttachment(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.cloud.support.v2.IAttachment,
          | protos.google.cloud.support.v2.IGetAttachmentRequest
          | null
          | undefined,
          {} | null | undefined
        >,
