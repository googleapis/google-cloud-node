...
function main(name) {
  // [START cloudsupport_v2_generated_CommentService_GetComment_async]
  /**
  ...
  async function callGetComment() {
    ...
    // Run request
    const response = await supportClient.getComment(request);
    console.log(response);
  }

  callGetComment();
  // [END cloudsupport_v2_generated_CommentService_GetComment_async]
}
