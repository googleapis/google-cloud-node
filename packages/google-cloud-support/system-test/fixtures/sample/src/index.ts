...
function main() {
  ...
  const caseAttachmentServiceClient = new CaseAttachmentServiceClient();
  doStuffWithCaseAttachmentServiceClient(caseAttachmentServiceClient);
  // check that the client instance can be created
  const caseServiceClient = new CaseServiceClient();
  doStuffWithCaseServiceClient(caseServiceClient);
  // check that the client instance can be created
