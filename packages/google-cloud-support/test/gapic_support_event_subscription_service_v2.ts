...
describe('v2.SupportEventSubscriptionServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          supporteventsubscriptionserviceModule.v2
  ...
  describe('createSupportEventSubscription', () => {
    it('invokes createSupportEventSubscription without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.support.v2.CreateSupportEventSubscriptionRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.support.v2.CreateSupportEventSubscriptionRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.support.v2.SupportEventSubscription(),
      );
    ...
    it('invokes createSupportEventSubscription without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createSupportEventSubscription(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.support.v2.ISupportEventSubscription | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getSupportEventSubscription', () => {
    it('invokes getSupportEventSubscription without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.support.v2.GetSupportEventSubscriptionRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.support.v2.GetSupportEventSubscriptionRequest',
        ['name'],
      );
  ...
  describe('updateSupportEventSubscription', () => {
    it('invokes updateSupportEventSubscription without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.support.v2.UpdateSupportEventSubscriptionRequest(),
      );
  ...
  describe('deleteSupportEventSubscription', () => {
    it('invokes deleteSupportEventSubscription without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.support.v2.DeleteSupportEventSubscriptionRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.support.v2.DeleteSupportEventSubscriptionRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('undeleteSupportEventSubscription', () => {
    it('invokes undeleteSupportEventSubscription without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.support.v2.UndeleteSupportEventSubscriptionRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.support.v2.UndeleteSupportEventSubscriptionRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('listSupportEventSubscriptions', () => {
    it('invokes listSupportEventSubscriptions without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.support.v2.ListSupportEventSubscriptionsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.support.v2.ListSupportEventSubscriptionsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      const promise = new Promise((resolve, reject) => {
        client.listSupportEventSubscriptions(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.support.v2.ISupportEventSubscription[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listSupportEventSubscriptionsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.support.v2.SupportEventSubscription[] =
          [];
        stream.on(
          'data',
          (
            response: protos.google.cloud.support.v2.SupportEventSubscription,
          ) => {
    ...
    it('uses async iteration with listSupportEventSubscriptions without error', async () => {
      ...
      const responses: protos.google.cloud.support.v2.ISupportEventSubscription[] =
        [];
