...
describe('v2beta.CommentServiceClient', () => {
  ...
  describe('getComment', () => {
    it('invokes getComment without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.support.v2beta.GetCommentRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('Path templates', () => {
    ...
    describe('organizationCaseEmailMessages', async () => {
      ...
      it('organizationCaseEmailMessagesPath', () => {
        const result = client.organizationCaseEmailMessagesPath(
          'organizationValue',
          'caseValue',
          'emailMessageValue',
        );
        ...
        assert(
          (
            client.pathTemplates.organizationCaseEmailMessagesPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchOrganizationFromOrganizationCaseEmailMessagesName', () => {
        const result =
          client.matchOrganizationFromOrganizationCaseEmailMessagesName(
            fakePath,
          );
        assert.strictEqual(result, 'organizationValue');
        assert(
      ...
      it('matchCaseFromOrganizationCaseEmailMessagesName', () => {
        const result =
          client.matchCaseFromOrganizationCaseEmailMessagesName(fakePath);
        assert.strictEqual(result, 'caseValue');
        assert(
          (
            client.pathTemplates.organizationCaseEmailMessagesPathTemplate
      ...
      it('matchEmailMessageFromOrganizationCaseEmailMessagesName', () => {
        const result =
          client.matchEmailMessageFromOrganizationCaseEmailMessagesName(
            fakePath,
          );
    ...
    describe('projectCaseEmailMessages', async () => {
      ...
      await client.initialize();
      client.pathTemplates.projectCaseEmailMessagesPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.projectCaseEmailMessagesPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);
      ...
      it('matchProjectFromProjectCaseEmailMessagesName', () => {
        const result =
          client.matchProjectFromProjectCaseEmailMessagesName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.projectCaseEmailMessagesPathTemplate
      ...
      it('matchCaseFromProjectCaseEmailMessagesName', () => {
        const result =
          client.matchCaseFromProjectCaseEmailMessagesName(fakePath);
        assert.strictEqual(result, 'caseValue');
        assert(
          (
            client.pathTemplates.projectCaseEmailMessagesPathTemplate
      ...
      it('matchEmailMessageFromProjectCaseEmailMessagesName', () => {
        const result =
          client.matchEmailMessageFromProjectCaseEmailMessagesName(fakePath);
        assert.strictEqual(result, 'emailMessageValue');
        assert(
          (
            client.pathTemplates.projectCaseEmailMessagesPathTemplate
