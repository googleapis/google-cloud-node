...
describe('v1.GrafeasClient', () => {
    ...
    describe('getOccurrence', () => {
        it('invokes getOccurrence without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.grafeas.v1.GetOccurrenceRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.grafeas.v1.Occurrence());
            ...
            assert((client.innerApiCalls.getOccurrence as SinonStub)
        ...
        it('invokes getOccurrence with error', async () => {
            ...
            await assert.rejects(async () => { await client.getOccurrence(request); }, expectedError);
            assert((client.innerApiCalls.getOccurrence as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deleteOccurrence', () => {
        it('invokes deleteOccurrence without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.grafeas.v1.DeleteOccurrenceRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteOccurrence as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes deleteOccurrence with error', async () => {
            ...
            await assert.rejects(async () => { await client.deleteOccurrence(request); }, expectedError);
            assert((client.innerApiCalls.deleteOccurrence as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createOccurrence', () => {
        it('invokes createOccurrence without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.grafeas.v1.CreateOccurrenceRequest());
            request.parent = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createOccurrence as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes createOccurrence with error', async () => {
            ...
            await assert.rejects(async () => { await client.createOccurrence(request); }, expectedError);
            assert((client.innerApiCalls.createOccurrence as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('batchCreateOccurrences', () => {
        it('invokes batchCreateOccurrences without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.grafeas.v1.BatchCreateOccurrencesResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.batchCreateOccurrences as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes batchCreateOccurrences without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchCreateOccurrences(
                    request,
                    (err?: Error|null, result?: protos.grafeas.v1.IBatchCreateOccurrencesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchCreateOccurrences with error', async () => {
            ...
            await assert.rejects(async () => { await client.batchCreateOccurrences(request); }, expectedError);
            assert((client.innerApiCalls.batchCreateOccurrences as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateOccurrence', () => {
        it('invokes updateOccurrence without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.grafeas.v1.UpdateOccurrenceRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateOccurrence as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes updateOccurrence with error', async () => {
            ...
            await assert.rejects(async () => { await client.updateOccurrence(request); }, expectedError);
            assert((client.innerApiCalls.updateOccurrence as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getOccurrenceNote', () => {
        it('invokes getOccurrenceNote without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.grafeas.v1.Note());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getOccurrenceNote as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes getOccurrenceNote with error', async () => {
            ...
            await assert.rejects(async () => { await client.getOccurrenceNote(request); }, expectedError);
            assert((client.innerApiCalls.getOccurrenceNote as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getNote', () => {
        it('invokes getNote without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.grafeas.v1.GetNoteRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getNote as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes getNote with error', async () => {
            ...
            await assert.rejects(async () => { await client.getNote(request); }, expectedError);
            assert((client.innerApiCalls.getNote as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deleteNote', () => {
        it('invokes deleteNote without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.grafeas.v1.DeleteNoteRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteNote as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes deleteNote with error', async () => {
            ...
            await assert.rejects(async () => { await client.deleteNote(request); }, expectedError);
            assert((client.innerApiCalls.deleteNote as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createNote', () => {
        it('invokes createNote without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.grafeas.v1.CreateNoteRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createNote as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes createNote with error', async () => {
            ...
            await assert.rejects(async () => { await client.createNote(request); }, expectedError);
            assert((client.innerApiCalls.createNote as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('batchCreateNotes', () => {
        it('invokes batchCreateNotes without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.grafeas.v1.BatchCreateNotesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.grafeas.v1.BatchCreateNotesResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.batchCreateNotes as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes batchCreateNotes without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchCreateNotes(
                    request,
                    (err?: Error|null, result?: protos.grafeas.v1.IBatchCreateNotesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchCreateNotes with error', async () => {
            ...
            await assert.rejects(async () => { await client.batchCreateNotes(request); }, expectedError);
            assert((client.innerApiCalls.batchCreateNotes as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateNote', () => {
        it('invokes updateNote without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.grafeas.v1.UpdateNoteRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateNote as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes updateNote with error', async () => {
            ...
            await assert.rejects(async () => { await client.updateNote(request); }, expectedError);
            assert((client.innerApiCalls.updateNote as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('listOccurrences', () => {
        it('invokes listOccurrences without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.grafeas.v1.ListOccurrencesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listOccurrences as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listOccurrences with error', async () => {
            ...
            await assert.rejects(async () => { await client.listOccurrences(request); }, expectedError);
            assert((client.innerApiCalls.listOccurrences as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listNotes', () => {
        it('invokes listNotes without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.grafeas.v1.ListNotesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listNotes as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listNotes with error', async () => {
            ...
            await assert.rejects(async () => { await client.listNotes(request); }, expectedError);
            assert((client.innerApiCalls.listNotes as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listNoteOccurrences', () => {
        it('invokes listNoteOccurrences without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.grafeas.v1.ListNoteOccurrencesRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listNoteOccurrences as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listNoteOccurrences with error', async () => {
            ...
            await assert.rejects(async () => { await client.listNoteOccurrences(request); }, expectedError);
            assert((client.innerApiCalls.listNoteOccurrences as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
