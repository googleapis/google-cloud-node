...
const gapicConfig = require('./grafeas_client_config.json');
...
class GrafeasClient {
  ...
  constructor(opts) {
    ...
    // grafeas.v1.Grafeas.
    const grafeasStub = gaxGrpc.createStub(protos.grafeas.v1.Grafeas, opts);
   ...
   *
   *   The second parameter to the callback is an object representing [Occurrence]{@link grafeas.v1.Occurrence}.
   ...
   *   The function which will be called with the result of the API call.
   *
   *   The second parameter to the callback is Array of [Occurrence]{@link grafeas.v1.Occurrence}.
   *
   *   When autoPaginate: false is specified through options, it contains the result
   *   in a single response. If the response indicates the next page exists, the third
   *   parameter is set to be used for the next request object. The fourth parameter keeps
   *   the raw response object of an object representing [ListOccurrencesResponse]{@link grafeas.v1.ListOccurrencesResponse}.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of [Occurrence]{@link grafeas.v1.Occurrence}.
   *
   *   When autoPaginate: false is specified through options, the array has three elements.
   *   The first element is Array of [Occurrence]{@link grafeas.v1.Occurrence} in a single response.
   *   The second element is the next request object if the response
   *   indicates the next page exists, or null. The third element is
   *   an object representing [ListOccurrencesResponse]{@link grafeas.v1.ListOccurrencesResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   *
   * @example
   ...
   *   The function which will be called with the result of the API call.
   *
   *   The second parameter to the callback is an object representing [BatchCreateOccurrencesResponse]{@link grafeas.v1.BatchCreateOccurrencesResponse}.
   * @returns {Promise} - The promise which resolves to an array.
   ...
   *   The function which will be called with the result of the API call.
   *
   *   The second parameter to the callback is an object representing [Note]{@link grafeas.v1.Note}.
   * @returns {Promise} - The promise which resolves to an array.
   ...
   *   The function which will be called with the result of the API call.
   *
   *   The second parameter to the callback is Array of [Note]{@link grafeas.v1.Note}.
   *
   *   When autoPaginate: false is specified through options, it contains the result
   *   in a single response. If the response indicates the next page exists, the third
   *   parameter is set to be used for the next request object. The fourth parameter keeps
   *   the raw response object of an object representing [ListNotesResponse]{@link grafeas.v1.ListNotesResponse}.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of [Note]{@link grafeas.v1.Note}.
   *
   *   When autoPaginate: false is specified through options, the array has three elements.
   *   The first element is Array of [Note]{@link grafeas.v1.Note} in a single response.
   *   The second element is the next request object if the response
   *   indicates the next page exists, or null. The third element is
   *   an object representing [ListNotesResponse]{@link grafeas.v1.ListNotesResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   *
   * @example
   ...
   *   The function which will be called with the result of the API call.
   *
   *   The second parameter to the callback is an object representing [BatchCreateNotesResponse]{@link grafeas.v1.BatchCreateNotesResponse}.
   * @returns {Promise} - The promise which resolves to an array.
   ...
   *   in a single response. If the response indicates the next page exists, the third
   *   parameter is set to be used for the next request object. The fourth parameter keeps
   *   the raw response object of an object representing [ListNoteOccurrencesResponse]{@link grafeas.v1.ListNoteOccurrencesResponse}.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of [Occurrence]{@link grafeas.v1.Occurrence}.
   *
   *   When autoPaginate: false is specified through options, the array has three elements.
   ...
   *   The second element is the next request object if the response
   *   indicates the next page exists, or null. The third element is
   *   an object representing [ListNoteOccurrencesResponse]{@link grafeas.v1.ListNoteOccurrencesResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   *
   * @example
