 ...
 * `src/v3/access_policies_client_config.json`.
...
export class AccessPoliciesClient {
    ...
    this.accessPoliciesStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ...
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.iam.v3.AccessPolicies,
      this._opts,
      this._providedCustomServicePath,
   ...
   *   The first element of the array is an object representing {@link protos.google.iam.v3.AccessPolicy|AccessPolicy}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v3/access_policies.get_access_policy.js</caption>
   * region_tag:iam_v3_generated_AccessPolicies_GetAccessPolicy_async
   */
  getAccessPolicy(
    request?: protos.google.iam.v3.IGetAccessPolicyRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.iam.v3.IAccessPolicy,
      protos.google.iam.v3.IGetAccessPolicyRequest | undefined,
      {} | undefined,
    ]
  >;
  getAccessPolicy(
    ...
    callback: Callback<
      protos.google.iam.v3.IAccessPolicy,
      protos.google.iam.v3.IGetAccessPolicyRequest | null | undefined,
      {} | null | undefined
    >,
  ): void;
  getAccessPolicy(
   ...
   * @param {google.iam.v3.AccessPolicy} request.accessPolicy
   ...
   *   for more details and examples.
   * @example <caption>include:samples/generated/v3/access_policies.create_access_policy.js</caption>
   * region_tag:iam_v3_generated_AccessPolicies_CreateAccessPolicy_async
   */
  createAccessPolicy(
    request?: protos.google.iam.v3.ICreateAccessPolicyRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<
  ...
  async checkCreateAccessPolicyProgress(
    ...
    LROperation<
      protos.google.iam.v3.AccessPolicy,
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v3/access_policies.update_access_policy.js</caption>
   * region_tag:iam_v3_generated_AccessPolicies_UpdateAccessPolicy_async
   */
  updateAccessPolicy(
    request?: protos.google.iam.v3.IUpdateAccessPolicyRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v3/access_policies.delete_access_policy.js</caption>
   * region_tag:iam_v3_generated_AccessPolicies_DeleteAccessPolicy_async
   */
  deleteAccessPolicy(
    request?: protos.google.iam.v3.IDeleteAccessPolicyRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.iam.v3.AccessPolicy|AccessPolicy}.
   ...
   */
  listAccessPolicies(
    request?: protos.google.iam.v3.IListAccessPoliciesRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.iam.v3.IAccessPolicy[],
      protos.google.iam.v3.IListAccessPoliciesRequest | null,
      protos.google.iam.v3.IListAccessPoliciesResponse,
    ]
  >;
  listAccessPolicies(
    request: protos.google.iam.v3.IListAccessPoliciesRequest,
    ...
    callback: PaginationCallback<
      protos.google.iam.v3.IListAccessPoliciesRequest,
      protos.google.iam.v3.IListAccessPoliciesResponse | null | undefined,
      protos.google.iam.v3.IAccessPolicy
    >,
  ): void;
  listAccessPolicies(
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.iam.v3.AccessPolicy|AccessPolicy} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
   ...
   *   {@link protos.google.iam.v3.AccessPolicy|AccessPolicy}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v3/access_policies.list_access_policies.js</caption>
   * region_tag:iam_v3_generated_AccessPolicies_ListAccessPolicies_async
   */
  listAccessPoliciesAsync(
    request?: protos.google.iam.v3.IListAccessPoliciesRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.iam.v3.IAccessPolicy> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listAccessPolicies.asyncIterate(
      ...
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.iam.v3.IAccessPolicy>;
  }
  /**
   ...
   */
  searchAccessPolicyBindings(
    request?: protos.google.iam.v3.ISearchAccessPolicyBindingsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.iam.v3.IPolicyBinding[],
      protos.google.iam.v3.ISearchAccessPolicyBindingsRequest | null,
      protos.google.iam.v3.ISearchAccessPolicyBindingsResponse,
    ]
  >;
  searchAccessPolicyBindings(
    request: protos.google.iam.v3.ISearchAccessPolicyBindingsRequest,
    options: CallOptions,
    callback: PaginationCallback<
      protos.google.iam.v3.ISearchAccessPolicyBindingsRequest,
      | protos.google.iam.v3.ISearchAccessPolicyBindingsResponse
      | null
      | undefined,
      protos.google.iam.v3.IPolicyBinding
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v3/access_policies.search_access_policy_bindings.js</caption>
   * region_tag:iam_v3_generated_AccessPolicies_SearchAccessPolicyBindings_async
   */
