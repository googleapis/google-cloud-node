...
describe('v3.PolicyBindingsClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = policybindingsModule.v3.PolicyBindingsClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = policybindingsModule.v3.PolicyBindingsClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'iam.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new policybindingsModule.v3.PolicyBindingsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'iam.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new policybindingsModule.v3.PolicyBindingsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'iam.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new policybindingsModule.v3.PolicyBindingsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new policybindingsModule.v3.PolicyBindingsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getPolicyBinding', () => {
        it('invokes getPolicyBinding without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.iam.v3.GetPolicyBindingRequest', ['name']);
    ...
    describe('createPolicyBinding', () => {
        it('invokes createPolicyBinding without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.iam.v3.CreatePolicyBindingRequest', ['parent']);
        ...
        it('invokes createPolicyBinding without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createPolicyBinding(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.iam.v3.IPolicyBinding, protos.google.iam.v3.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.iam.v3.IPolicyBinding, protos.google.iam.v3.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createPolicyBinding as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updatePolicyBinding', () => {
        it('invokes updatePolicyBinding without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.iam.v3.UpdatePolicyBindingRequest', ['policyBinding', 'name']);
    ...
    describe('deletePolicyBinding', () => {
        it('invokes deletePolicyBinding without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.iam.v3.DeletePolicyBindingRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listPolicyBindings', () => {
        it('invokes listPolicyBindings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.iam.v3.ListPolicyBindingsRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('searchTargetPolicyBindings', () => {
        it('invokes searchTargetPolicyBindings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.iam.v3.SearchTargetPolicyBindingsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.iam.v3.PolicyBinding()),
              generateSampleMessage(new protos.google.iam.v3.PolicyBinding()),
