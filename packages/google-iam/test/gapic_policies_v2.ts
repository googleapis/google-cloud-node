...
describe('v2.PoliciesClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new policiesModule.v2.PoliciesClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'iam.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new policiesModule.v2.PoliciesClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'iam.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new policiesModule.v2.PoliciesClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new policiesModule.v2.PoliciesClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getPolicy', () => {
        it('invokes getPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.iam.v2.GetPolicyRequest', ['name']);
        ...
        it('invokes getPolicy without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getPolicy(
                    request,
                    (err?: Error|null, result?: protos.google.iam.v2.IPolicy|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createPolicy', () => {
        it('invokes createPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.iam.v2.CreatePolicyRequest', ['parent']);
        ...
        it('invokes createPolicy without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createPolicy(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.iam.v2.IPolicy, protos.google.iam.v2.IPolicyOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.iam.v2.IPolicy, protos.google.iam.v2.IPolicyOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createPolicy as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updatePolicy', () => {
        it('invokes updatePolicy without error', async () => {
            ...
            request.policy ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.iam.v2.UpdatePolicyRequest', ['policy', 'name']);
    ...
    describe('deletePolicy', () => {
        it('invokes deletePolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.iam.v2.DeletePolicyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listPolicies', () => {
        it('invokes listPolicies without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.iam.v2.ListPoliciesRequest', ['parent']);
            request.parent = defaultValue1;
