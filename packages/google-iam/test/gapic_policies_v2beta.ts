...
describe('v2beta.PoliciesClient', () => {
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new policiesModule.v2beta.PoliciesClient({
          universe_domain: 'example.com',
  ...
  describe('getPolicy', () => {
    it('invokes getPolicy without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.iam.v2beta.GetPolicyRequest',
        ['name'],
      );
    ...
    it('invokes getPolicy without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getPolicy(
          ...
          (
            err?: Error | null,
            result?: protos.google.iam.v2beta.IPolicy | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createPolicy', () => {
    it('invokes createPolicy without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.iam.v2beta.CreatePolicyRequest',
        ['parent'],
      );
        ...
        client.createPolicy(
          ...
          (
            ...
            result?: LROperation<
              ...
              protos.google.iam.v2beta.IPolicyOperationMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
  ...
  describe('updatePolicy', () => {
    it('invokes updatePolicy without error', async () => {
      ...
      request.policy ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.iam.v2beta.UpdatePolicyRequest',
        ['policy', 'name'],
      );
  ...
  describe('deletePolicy', () => {
    it('invokes deletePolicy without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.iam.v2beta.DeletePolicyRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
