...
describe('v1beta.WorkloadIdentityPoolsClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          workloadidentitypoolsModule.v1beta.WorkloadIdentityPoolsClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        workloadidentitypoolsModule.v1beta.WorkloadIdentityPoolsClient.port;
      assert(port);
  ...
  describe('getWorkloadIdentityPool', () => {
    it('invokes getWorkloadIdentityPool without error', async () => {
      ...
      client.innerApiCalls.getWorkloadIdentityPool =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getWorkloadIdentityPool(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getWorkloadIdentityPool as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getWorkloadIdentityPool without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getWorkloadIdentityPool(
          ...
          (
            err?: Error | null,
            result?: protos.google.iam.v1beta.IWorkloadIdentityPool | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getWorkloadIdentityPool with error', async () => {
      ...
      client.innerApiCalls.getWorkloadIdentityPool = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getWorkloadIdentityPool(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getWorkloadIdentityPool as SinonStub
  ...
  describe('getWorkloadIdentityPoolProvider', () => {
    it('invokes getWorkloadIdentityPoolProvider without error', async () => {
      ...
      client.innerApiCalls.getWorkloadIdentityPoolProvider =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getWorkloadIdentityPoolProvider(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getWorkloadIdentityPoolProvider as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getWorkloadIdentityPoolProvider as SinonStub
    ...
    it('invokes getWorkloadIdentityPoolProvider without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getWorkloadIdentityPoolProvider(
          ...
          (
            err?: Error | null,
            result?: protos.google.iam.v1beta.IWorkloadIdentityPoolProvider | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getWorkloadIdentityPoolProvider with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getWorkloadIdentityPoolProvider = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getWorkloadIdentityPoolProvider(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getWorkloadIdentityPoolProvider as SinonStub
  ...
  describe('createWorkloadIdentityPool', () => {
    it('invokes createWorkloadIdentityPool without error', async () => {
      ...
      client.innerApiCalls.createWorkloadIdentityPool =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createWorkloadIdentityPool(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createWorkloadIdentityPool as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createWorkloadIdentityPool as SinonStub
        ...
        client.createWorkloadIdentityPool(
          ...
          (
            ...
            result?: LROperation<
              ...
              protos.google.iam.v1beta.IWorkloadIdentityPoolOperationMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
    ...
    it('invokes createWorkloadIdentityPool with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createWorkloadIdentityPool = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createWorkloadIdentityPool(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createWorkloadIdentityPool as SinonStub
    ...
    it('invokes checkCreateWorkloadIdentityPoolProgress without error', async () => {
      ...
      const decodedOperation =
        await client.checkCreateWorkloadIdentityPoolProgress(
    ...
    it('invokes checkCreateWorkloadIdentityPoolProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateWorkloadIdentityPoolProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateWorkloadIdentityPool', () => {
    it('invokes updateWorkloadIdentityPool without error', async () => {
      ...
      client.innerApiCalls.updateWorkloadIdentityPool =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateWorkloadIdentityPool(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateWorkloadIdentityPool as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateWorkloadIdentityPool as SinonStub
    ...
    it('invokes updateWorkloadIdentityPool with call error', async () => {
      ...
      const expectedHeaderRequestParams = `workload_identity_pool.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateWorkloadIdentityPool = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateWorkloadIdentityPool(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateWorkloadIdentityPool as SinonStub
    ...
    it('invokes checkUpdateWorkloadIdentityPoolProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkUpdateWorkloadIdentityPoolProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkUpdateWorkloadIdentityPoolProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateWorkloadIdentityPoolProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteWorkloadIdentityPool', () => {
    it('invokes deleteWorkloadIdentityPool without error', async () => {
      ...
      client.innerApiCalls.deleteWorkloadIdentityPool =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteWorkloadIdentityPool(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteWorkloadIdentityPool as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteWorkloadIdentityPool as SinonStub
    ...
    it('invokes deleteWorkloadIdentityPool with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteWorkloadIdentityPool = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteWorkloadIdentityPool(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteWorkloadIdentityPool as SinonStub
    ...
    it('invokes checkDeleteWorkloadIdentityPoolProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkDeleteWorkloadIdentityPoolProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkDeleteWorkloadIdentityPoolProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteWorkloadIdentityPoolProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('undeleteWorkloadIdentityPool', () => {
    it('invokes undeleteWorkloadIdentityPool without error', async () => {
      ...
      client.innerApiCalls.undeleteWorkloadIdentityPool =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.undeleteWorkloadIdentityPool(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.undeleteWorkloadIdentityPool as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.undeleteWorkloadIdentityPool as SinonStub
    ...
    it('invokes undeleteWorkloadIdentityPool with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.undeleteWorkloadIdentityPool = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.undeleteWorkloadIdentityPool(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.undeleteWorkloadIdentityPool as SinonStub
    ...
    it('invokes checkUndeleteWorkloadIdentityPoolProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkUndeleteWorkloadIdentityPoolProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkUndeleteWorkloadIdentityPoolProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUndeleteWorkloadIdentityPoolProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createWorkloadIdentityPoolProvider', () => {
    it('invokes createWorkloadIdentityPoolProvider without error', async () => {
      ...
      client.innerApiCalls.createWorkloadIdentityPoolProvider =
        stubLongRunningCall(expectedResponse);
      const [operation] =
        await client.createWorkloadIdentityPoolProvider(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createWorkloadIdentityPoolProvider as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createWorkloadIdentityPoolProvider as SinonStub
        ...
        client.createWorkloadIdentityPoolProvider(
          ...
          (
            ...
            result?: LROperation<
              ...
              protos.google.iam.v1beta.IWorkloadIdentityPoolProviderOperationMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
    ...
    it('invokes createWorkloadIdentityPoolProvider with call error', async () => {
      ...
      await assert.rejects(
        client.createWorkloadIdentityPoolProvider(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createWorkloadIdentityPoolProvider as SinonStub
    ...
    it('invokes checkCreateWorkloadIdentityPoolProviderProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkCreateWorkloadIdentityPoolProviderProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkCreateWorkloadIdentityPoolProviderProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateWorkloadIdentityPoolProviderProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateWorkloadIdentityPoolProvider', () => {
    it('invokes updateWorkloadIdentityPoolProvider without error', async () => {
      ...
      client.innerApiCalls.updateWorkloadIdentityPoolProvider =
        stubLongRunningCall(expectedResponse);
      const [operation] =
        await client.updateWorkloadIdentityPoolProvider(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateWorkloadIdentityPoolProvider as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateWorkloadIdentityPoolProvider as SinonStub
    ...
    it('invokes updateWorkloadIdentityPoolProvider with call error', async () => {
      ...
      client.innerApiCalls.updateWorkloadIdentityPoolProvider =
        stubLongRunningCall(undefined, expectedError);
      await assert.rejects(
        client.updateWorkloadIdentityPoolProvider(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateWorkloadIdentityPoolProvider as SinonStub
    ...
    it('invokes checkUpdateWorkloadIdentityPoolProviderProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkUpdateWorkloadIdentityPoolProviderProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkUpdateWorkloadIdentityPoolProviderProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateWorkloadIdentityPoolProviderProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteWorkloadIdentityPoolProvider', () => {
    it('invokes deleteWorkloadIdentityPoolProvider without error', async () => {
      ...
      client.innerApiCalls.deleteWorkloadIdentityPoolProvider =
        stubLongRunningCall(expectedResponse);
      const [operation] =
        await client.deleteWorkloadIdentityPoolProvider(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteWorkloadIdentityPoolProvider as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteWorkloadIdentityPoolProvider as SinonStub
    ...
    it('invokes deleteWorkloadIdentityPoolProvider with call error', async () => {
      ...
      client.innerApiCalls.deleteWorkloadIdentityPoolProvider =
        stubLongRunningCall(undefined, expectedError);
      await assert.rejects(
        client.deleteWorkloadIdentityPoolProvider(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteWorkloadIdentityPoolProvider as SinonStub
    ...
    it('invokes checkDeleteWorkloadIdentityPoolProviderProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkDeleteWorkloadIdentityPoolProviderProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkDeleteWorkloadIdentityPoolProviderProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteWorkloadIdentityPoolProviderProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('undeleteWorkloadIdentityPoolProvider', () => {
    it('invokes undeleteWorkloadIdentityPoolProvider without error', async () => {
      ...
      client.innerApiCalls.undeleteWorkloadIdentityPoolProvider =
        stubLongRunningCall(expectedResponse);
      const [operation] =
        await client.undeleteWorkloadIdentityPoolProvider(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.undeleteWorkloadIdentityPoolProvider as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.undeleteWorkloadIdentityPoolProvider as SinonStub
    ...
    it('invokes undeleteWorkloadIdentityPoolProvider with call error', async () => {
      ...
      client.innerApiCalls.undeleteWorkloadIdentityPoolProvider =
        stubLongRunningCall(undefined, expectedError);
      await assert.rejects(
        client.undeleteWorkloadIdentityPoolProvider(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.undeleteWorkloadIdentityPoolProvider as SinonStub
    ...
    it('invokes checkUndeleteWorkloadIdentityPoolProviderProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkUndeleteWorkloadIdentityPoolProviderProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkUndeleteWorkloadIdentityPoolProviderProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUndeleteWorkloadIdentityPoolProviderProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listWorkloadIdentityPools', () => {
    it('invokes listWorkloadIdentityPools without error', async () => {
      ...
      client.innerApiCalls.listWorkloadIdentityPools =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listWorkloadIdentityPools(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listWorkloadIdentityPools as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listWorkloadIdentityPools as SinonStub
    ...
    it('invokes listWorkloadIdentityPools with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listWorkloadIdentityPools = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listWorkloadIdentityPools(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listWorkloadIdentityPools as SinonStub
    ...
    it('invokes listWorkloadIdentityPoolsStream without error', async () => {
      ...
      client.descriptors.page.listWorkloadIdentityPools.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.iam.v1beta.WorkloadIdentityPool) => {
      ...
      assert(
        (
          client.descriptors.page.listWorkloadIdentityPools
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listWorkloadIdentityPools, request),
      );
      assert(
        (
          client.descriptors.page.listWorkloadIdentityPools
    ...
    it('uses async iteration with listWorkloadIdentityPools without error', async () => {
      ...
      client.descriptors.page.listWorkloadIdentityPools.asyncIterate =
  ...
  describe('listWorkloadIdentityPoolProviders', () => {
    it('invokes listWorkloadIdentityPoolProviders without error', async () => {
      ...
      client.innerApiCalls.listWorkloadIdentityPoolProviders =
        stubSimpleCall(expectedResponse);
      const [response] =
        await client.listWorkloadIdentityPoolProviders(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listWorkloadIdentityPoolProviders as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listWorkloadIdentityPoolProviders as SinonStub
    ...
    it('invokes listWorkloadIdentityPoolProviders with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listWorkloadIdentityPoolProviders = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listWorkloadIdentityPoolProviders(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listWorkloadIdentityPoolProviders as SinonStub
    ...
    it('invokes listWorkloadIdentityPoolProvidersStream without error', async () => {
      ...
      client.descriptors.page.listWorkloadIdentityPoolProviders.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.iam.v1beta.WorkloadIdentityPoolProvider) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (
          client.descriptors.page.listWorkloadIdentityPoolProviders
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(
    ...
    it('uses async iteration with listWorkloadIdentityPoolProviders without error', async () => {
      ...
      client.descriptors.page.listWorkloadIdentityPoolProviders.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('Path templates', () => {
    ...
    describe('workloadIdentityPool', async () => {
      ...
      await client.initialize();
      client.pathTemplates.workloadIdentityPoolPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.workloadIdentityPoolPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('workloadIdentityPoolPath', () => {
        const result = client.workloadIdentityPoolPath(
          'projectValue',
          'locationValue',
          'workloadIdentityPoolValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.workloadIdentityPoolPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromWorkloadIdentityPoolName', () => {
        const result =
          client.matchProjectFromWorkloadIdentityPoolName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.workloadIdentityPoolPathTemplate
      ...
      it('matchLocationFromWorkloadIdentityPoolName', () => {
        const result =
          client.matchLocationFromWorkloadIdentityPoolName(fakePath);
      ...
      it('matchWorkloadIdentityPoolFromWorkloadIdentityPoolName', () => {
        const result =
          client.matchWorkloadIdentityPoolFromWorkloadIdentityPoolName(
            fakePath,
          );
    ...
    describe('workloadIdentityPoolProvider', async () => {
      ...
      it('workloadIdentityPoolProviderPath', () => {
        const result = client.workloadIdentityPoolProviderPath(
          'projectValue',
          'locationValue',
          'workloadIdentityPoolValue',
          'workloadIdentityPoolProviderValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.workloadIdentityPoolProviderPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromWorkloadIdentityPoolProviderName', () => {
        const result =
          client.matchProjectFromWorkloadIdentityPoolProviderName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.workloadIdentityPoolProviderPathTemplate
      ...
      it('matchLocationFromWorkloadIdentityPoolProviderName', () => {
        const result =
          client.matchLocationFromWorkloadIdentityPoolProviderName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.workloadIdentityPoolProviderPathTemplate
      ...
      it('matchWorkloadIdentityPoolFromWorkloadIdentityPoolProviderName', () => {
        const result =
          client.matchWorkloadIdentityPoolFromWorkloadIdentityPoolProviderName(
            fakePath,
          );
        assert.strictEqual(result, 'workloadIdentityPoolValue');
        assert(
      ...
      it('matchWorkloadIdentityPoolProviderFromWorkloadIdentityPoolProviderName', () => {
        const result =
          client.matchWorkloadIdentityPoolProviderFromWorkloadIdentityPoolProviderName(
            fakePath,
          );
