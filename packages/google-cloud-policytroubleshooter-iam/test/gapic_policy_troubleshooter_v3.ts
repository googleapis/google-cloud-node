...
describe('v3.PolicyTroubleshooterClient', () => {
  describe('Common methods', () => {
    ...
    it('has port', () => {
      const port =
        policytroubleshooterModule.v3.PolicyTroubleshooterClient.port;
      assert(port);
  ...
  describe('troubleshootIamPolicy', () => {
    it('invokes troubleshootIamPolicy without error', async () => {
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.policytroubleshooter.iam.v3.TroubleshootIamPolicyResponse()
      );
    ...
    it('invokes troubleshootIamPolicy without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.troubleshootIamPolicy(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.policytroubleshooter.iam.v3.ITroubleshootIamPolicyResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
