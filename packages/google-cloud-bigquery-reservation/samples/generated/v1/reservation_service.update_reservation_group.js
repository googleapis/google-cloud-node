...
function main(reservationGroup) {
  ...
  async function callUpdateReservationGroup() {
    // Construct request
    const request = {
      reservationGroup,
    };
    ...
    // Run request
    const response = await reservationClient.updateReservationGroup(request);
    console.log(response);
  }

  callUpdateReservationGroup();
