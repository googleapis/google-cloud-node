...
export class ReservationServiceClient {
  ...
  constructor(
    ...
    this.descriptors.page = {
      ...
      listReservationGroups: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'reservationGroups',
      ),
  ...
  createReservationGroup(
    ...
    [
      ...
      (
        | protos.google.cloud.bigquery.reservation.v1.ICreateReservationGroupRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .createReservationGroup(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.cloud.bigquery.reservation.v1.IReservationGroup,
          (
  ...
  getReservationGroup(
    ...
    [
      protos.google.cloud.bigquery.reservation.v1.IReservationGroup,
      (
        | protos.google.cloud.bigquery.reservation.v1.IGetReservationGroupRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .getReservationGroup(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.cloud.bigquery.reservation.v1.IReservationGroup,
          (
  ...
  deleteReservationGroup(
    ...
    [
      protos.google.protobuf.IEmpty,
      (
        | protos.google.cloud.bigquery.reservation.v1.IDeleteReservationGroupRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .deleteReservationGroup(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.protobuf.IEmpty,
          (
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/reservation_service.update_reservation_group.js</caption>
   * region_tag:bigqueryreservation_v1_generated_ReservationService_UpdateReservationGroup_async
   */
  updateReservationGroup(
    request?: protos.google.cloud.bigquery.reservation.v1.IUpdateReservationGroupRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.bigquery.reservation.v1.IReservationGroup,
      (
        | protos.google.cloud.bigquery.reservation.v1.IUpdateReservationGroupRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    options.otherArgs.headers['x-goog-request-params'] =
      this._gaxModule.routingHeader.fromParams({
        'reservation_group.name': request.reservationGroup!.name ?? '',
      });
    this.initialize().catch(err => {
      throw err;
    });
    this._log.info('updateReservationGroup request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.cloud.bigquery.reservation.v1.IReservationGroup,
          | protos.google.cloud.bigquery.reservation.v1.IUpdateReservationGroupRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('updateReservationGroup response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .updateReservationGroup(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.cloud.bigquery.reservation.v1.IReservationGroup,
          (
  ...
  matchProjectFromReservationGroupName(reservationGroupName: string) {
    return this.pathTemplates.reservationGroupPathTemplate.match(
