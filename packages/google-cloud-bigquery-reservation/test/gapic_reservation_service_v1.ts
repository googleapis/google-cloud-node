...
describe('v1.ReservationServiceClient', () => {
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        ...
        it('value configured in code has priority over environment variable', () => {
          ...
          assert.strictEqual(
            servicePath,
            'bigqueryreservation.configured.example.com',
          );
          if (saved) {
            process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = saved;
          } else {
  ...
  describe('failoverReservation', () => {
    it('invokes failoverReservation without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.failoverReservation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.failoverReservation as SinonStub
  ...
  describe('createReservationGroup', () => {
    it('invokes createReservationGroup without error', async () => {
      ...
      client.innerApiCalls.createReservationGroup =
        stubSimpleCall(expectedResponse);
      const [response] = await client.createReservationGroup(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createReservationGroup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createReservationGroup as SinonStub
    ...
    it('invokes createReservationGroup with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createReservationGroup = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
  ...
  describe('getReservationGroup', () => {
    it('invokes getReservationGroup without error', async () => {
      ...
      client.innerApiCalls.getReservationGroup =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getReservationGroup(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getReservationGroup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getReservationGroup as SinonStub
    ...
    it('invokes getReservationGroup with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getReservationGroup = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteReservationGroup', () => {
    it('invokes deleteReservationGroup without error', async () => {
      ...
      client.innerApiCalls.deleteReservationGroup =
        stubSimpleCall(expectedResponse);
      const [response] = await client.deleteReservationGroup(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteReservationGroup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteReservationGroup as SinonStub
    ...
    it('invokes deleteReservationGroup with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteReservationGroup = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteReservationGroup(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteReservationGroup as SinonStub
  ...
  describe('listReservationGroups', () => {
    it('invokes listReservationGroups without error', async () => {
      ...
      client.innerApiCalls.listReservationGroups =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listReservationGroups(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listReservationGroups as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listReservationGroups as SinonStub
    ...
    it('invokes listReservationGroups with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listReservationGroups = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listReservationGroups(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listReservationGroups as SinonStub
    ...
    it('invokes listReservationGroupsStream without error', async () => {
      ...
      client.descriptors.page.listReservationGroups.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.bigquery.reservation.v1.ReservationGroup,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (
          client.descriptors.page.listReservationGroups
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listReservationGroups, request),
      );
      assert(
        (
          client.descriptors.page.listReservationGroups
    ...
    it('uses async iteration with listReservationGroups without error', async () => {
      ...
      client.descriptors.page.listReservationGroups.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('Path templates', () => {
    ...
    describe('reservationGroup', async () => {
      ...
      await client.initialize();
      client.pathTemplates.reservationGroupPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.reservationGroupPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('reservationGroupPath', () => {
        const result = client.reservationGroupPath(
          'projectValue',
          'locationValue',
        ...
        assert(
          (
            client.pathTemplates.reservationGroupPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromReservationGroupName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.reservationGroupPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchReservationGroupFromReservationGroupName', () => {
        const result =
          client.matchReservationGroupFromReservationGroupName(fakePath);
