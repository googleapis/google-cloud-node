...
(function(global, factory) { /* global define, require, module */
    ...
    var $root = $protobuf.roots._google_iam_credentials_protos || ($protobuf.roots._google_iam_credentials_protos = {});
            ...
            iam.credentials = (function() {
                ...
                credentials.v1 = (function() {
                    ...
                    v1.GenerateAccessTokenRequest = (function() {
                         ...
                         */
                        GenerateAccessTokenRequest.decode = function decode(reader, length) {
                    ...
                    v1.GenerateAccessTokenResponse = (function() {
                         ...
                         * @throws {$protobuf.util.ProtocolError} If required fields are missing
                         */
                        GenerateAccessTokenResponse.decode = function decode(reader, length) {
                            if (!(reader instanceof $Reader))
                                reader = $Reader.create(reader);
                    ...
                    v1.SignBlobRequest = (function() {
                         ...
                         * @throws {$protobuf.util.ProtocolError} If required fields are missing
                         */
                        SignBlobRequest.decode = function decode(reader, length) {
                            if (!(reader instanceof $Reader))
                                reader = $Reader.create(reader);
                    ...
                    v1.SignBlobResponse = (function() {
                         ...
                         * @throws {$protobuf.util.ProtocolError} If required fields are missing
                         */
                        SignBlobResponse.decode = function decode(reader, length) {
                            if (!(reader instanceof $Reader))
                                reader = $Reader.create(reader);
                        ...
                        SignBlobResponse.fromObject = function fromObject(object) {
                            ...
                            if (object.signedBlob != null)
                                ...
                                else if (object.signedBlob.length)
                    ...
                    v1.SignJwtRequest = (function() {
                         ...
                         * @throws {$protobuf.util.ProtocolError} If required fields are missing
                         */
                        SignJwtRequest.decode = function decode(reader, length) {
                            if (!(reader instanceof $Reader))
                                reader = $Reader.create(reader);
                    ...
                    v1.SignJwtResponse = (function() {
                         ...
                         * @throws {$protobuf.util.ProtocolError} If required fields are missing
                         */
                        SignJwtResponse.decode = function decode(reader, length) {
                            if (!(reader instanceof $Reader))
                                reader = $Reader.create(reader);
                    ...
                    v1.GenerateIdTokenRequest = (function() {
                         ...
                         * @throws {$protobuf.util.ProtocolError} If required fields are missing
                         */
                        GenerateIdTokenRequest.decode = function decode(reader, length) {
                            if (!(reader instanceof $Reader))
                                reader = $Reader.create(reader);
                    ...
                    v1.GenerateIdTokenResponse = (function() {
                         ...
                         * @throws {$protobuf.util.ProtocolError} If required fields are missing
                         */
                        GenerateIdTokenResponse.decode = function decode(reader, length) {
                            if (!(reader instanceof $Reader))
                                reader = $Reader.create(reader);
