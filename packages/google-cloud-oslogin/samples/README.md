...
View the [source code](https://github.com/googleapis/google-cloud-node/blob/master/packages/google-cloud-oslogin/samples/generated/v1beta/os_login_service.sign_ssh_public_key.js).
