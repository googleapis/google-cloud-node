...
describe('v1beta.OsLoginServiceClient', () => {
    ...
    describe('deletePosixAccount', () => {
        it('invokes deletePosixAccount without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.oslogin.v1beta.DeletePosixAccountRequest());
            request.name = '';
        ...
        it('invokes deletePosixAccount with error', async () => {
            ...
            await assert.rejects(async () => { await client.deletePosixAccount(request); }, expectedError);
            assert((client.innerApiCalls.deletePosixAccount as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deleteSshPublicKey', () => {
        it('invokes deleteSshPublicKey without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.oslogin.v1beta.DeleteSshPublicKeyRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes deleteSshPublicKey with error', async () => {
            ...
            await assert.rejects(async () => { await client.deleteSshPublicKey(request); }, expectedError);
            assert((client.innerApiCalls.deleteSshPublicKey as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getLoginProfile', () => {
        it('invokes getLoginProfile without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.oslogin.v1beta.LoginProfile());
        ...
        it('invokes getLoginProfile with error', async () => {
            ...
            await assert.rejects(async () => { await client.getLoginProfile(request); }, expectedError);
            assert((client.innerApiCalls.getLoginProfile as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getSshPublicKey', () => {
        it('invokes getSshPublicKey without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.oslogin.v1beta.GetSshPublicKeyRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes getSshPublicKey with error', async () => {
            ...
            await assert.rejects(async () => { await client.getSshPublicKey(request); }, expectedError);
            assert((client.innerApiCalls.getSshPublicKey as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('importSshPublicKey', () => {
        it('invokes importSshPublicKey without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.oslogin.v1beta.ImportSshPublicKeyResponse());
        ...
        it('invokes importSshPublicKey with error', async () => {
            ...
            await assert.rejects(async () => { await client.importSshPublicKey(request); }, expectedError);
            assert((client.innerApiCalls.importSshPublicKey as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateSshPublicKey', () => {
        it('invokes updateSshPublicKey without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.oslogin.v1beta.UpdateSshPublicKeyRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes updateSshPublicKey with error', async () => {
            ...
            await assert.rejects(async () => { await client.updateSshPublicKey(request); }, expectedError);
            assert((client.innerApiCalls.updateSshPublicKey as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
