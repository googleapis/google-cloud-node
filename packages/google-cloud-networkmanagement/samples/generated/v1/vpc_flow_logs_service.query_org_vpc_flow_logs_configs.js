...
function main(parent) {
  ...
  async function callQueryOrgVpcFlowLogsConfigs() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = networkmanagementClient.queryOrgVpcFlowLogsConfigsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callQueryOrgVpcFlowLogsConfigs();
