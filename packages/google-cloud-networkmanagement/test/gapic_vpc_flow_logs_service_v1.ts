...
describe('v1.VpcFlowLogsServiceClient', () => {
  ...
  describe('queryOrgVpcFlowLogsConfigs', () => {
    it('invokes queryOrgVpcFlowLogsConfigs without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.queryOrgVpcFlowLogsConfigs as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.queryOrgVpcFlowLogsConfigs as SinonStub
    ...
    it('invokes queryOrgVpcFlowLogsConfigs with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.queryOrgVpcFlowLogsConfigs = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
    ...
    it('invokes queryOrgVpcFlowLogsConfigsStream without error', async () => {
      ...
      client.descriptors.page.queryOrgVpcFlowLogsConfigs.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      assert(
        (
          client.descriptors.page.queryOrgVpcFlowLogsConfigs
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.queryOrgVpcFlowLogsConfigs, request),
      );
      assert(
        (
          client.descriptors.page.queryOrgVpcFlowLogsConfigs
    ...
    it('uses async iteration with queryOrgVpcFlowLogsConfigs without error', async () => {
      ...
      client.descriptors.page.queryOrgVpcFlowLogsConfigs.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.networkmanagement.v1.IVpcFlowLogsConfig[] =
        [];
  ...
  describe('showEffectiveFlowLogsConfigs', () => {
    it('invokes showEffectiveFlowLogsConfigs without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.networkmanagement.v1.EffectiveVpcFlowLogsConfig(),
        ),
        generateSampleMessage(
          new protos.google.cloud.networkmanagement.v1.EffectiveVpcFlowLogsConfig(),
        ),
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.showEffectiveFlowLogsConfigs as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.showEffectiveFlowLogsConfigs as SinonStub
    ...
    it('invokes showEffectiveFlowLogsConfigs with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.showEffectiveFlowLogsConfigs = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
    ...
    it('invokes showEffectiveFlowLogsConfigsStream without error', async () => {
      ...
      client.descriptors.page.showEffectiveFlowLogsConfigs.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networkmanagement.v1.EffectiveVpcFlowLogsConfig,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (
          client.descriptors.page.showEffectiveFlowLogsConfigs
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(
    ...
    it('uses async iteration with showEffectiveFlowLogsConfigs without error', async () => {
      ...
      client.descriptors.page.showEffectiveFlowLogsConfigs.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('Path templates', () => {
    ...
    describe('organizationLocationVpcFlowLogsConfigs', async () => {
      ...
      it('organizationLocationVpcFlowLogsConfigsPath', () => {
        const result = client.organizationLocationVpcFlowLogsConfigsPath(
          'organizationValue',
          'locationValue',
      ...
      it('matchOrganizationFromOrganizationLocationVpcFlowLogsConfigsName', () => {
        const result =
          client.matchOrganizationFromOrganizationLocationVpcFlowLogsConfigsName(
            fakePath,
          );
      ...
      it('matchLocationFromOrganizationLocationVpcFlowLogsConfigsName', () => {
        const result =
          client.matchLocationFromOrganizationLocationVpcFlowLogsConfigsName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchVpcFlowLogsConfigFromOrganizationLocationVpcFlowLogsConfigsName', () => {
        const result =
          client.matchVpcFlowLogsConfigFromOrganizationLocationVpcFlowLogsConfigsName(
            fakePath,
          );
    ...
    describe('projectLocationVpcFlowLogsConfigs', async () => {
      ...
      it('projectLocationVpcFlowLogsConfigsPath', () => {
        const result = client.projectLocationVpcFlowLogsConfigsPath(
          'projectValue',
          'locationValue',
          'vpcFlowLogsConfigValue',
        );
        ...
        assert(
          (
            client.pathTemplates.projectLocationVpcFlowLogsConfigsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromProjectLocationVpcFlowLogsConfigsName', () => {
        const result =
          client.matchProjectFromProjectLocationVpcFlowLogsConfigsName(
            fakePath,
          );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromProjectLocationVpcFlowLogsConfigsName', () => {
        const result =
          client.matchLocationFromProjectLocationVpcFlowLogsConfigsName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchVpcFlowLogsConfigFromProjectLocationVpcFlowLogsConfigsName', () => {
        const result =
          client.matchVpcFlowLogsConfigFromProjectLocationVpcFlowLogsConfigsName(
            fakePath,
          );
        assert.strictEqual(result, 'vpcFlowLogsConfigValue');
        assert(
