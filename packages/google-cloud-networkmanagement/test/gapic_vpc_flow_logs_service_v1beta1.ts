...
describe('v1beta1.VpcFlowLogsServiceClient', () => {
  ...
  describe('showEffectiveFlowLogsConfigs', () => {
    it('invokes showEffectiveFlowLogsConfigs without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkmanagement.v1beta1.ShowEffectiveFlowLogsConfigsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.networkmanagement.v1beta1.EffectiveVpcFlowLogsConfig(),
        ),
        generateSampleMessage(
          new protos.google.cloud.networkmanagement.v1beta1.EffectiveVpcFlowLogsConfig(),
        ),
    ...
    it('invokes showEffectiveFlowLogsConfigsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networkmanagement.v1beta1.EffectiveVpcFlowLogsConfig,
          ) => {
            responses.push(response);
          },
        );
