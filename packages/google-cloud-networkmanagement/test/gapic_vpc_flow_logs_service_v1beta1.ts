...
describe('v1beta1.VpcFlowLogsServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = vpcflowlogsserviceModule.v1beta1.VpcFlowLogsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = vpcflowlogsserviceModule.v1beta1.VpcFlowLogsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'networkmanagement.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new vpcflowlogsserviceModule.v1beta1.VpcFlowLogsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networkmanagement.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new vpcflowlogsserviceModule.v1beta1.VpcFlowLogsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networkmanagement.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new vpcflowlogsserviceModule.v1beta1.VpcFlowLogsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new vpcflowlogsserviceModule.v1beta1.VpcFlowLogsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = vpcflowlogsserviceModule.v1beta1.VpcFlowLogsServiceClient.port;
            assert(port);
    ...
    describe('getVpcFlowLogsConfig', () => {
        it('invokes getVpcFlowLogsConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkmanagement.v1beta1.GetVpcFlowLogsConfigRequest', ['name']);
        ...
        it('invokes getVpcFlowLogsConfig without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getVpcFlowLogsConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networkmanagement.v1beta1.IVpcFlowLogsConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createVpcFlowLogsConfig', () => {
        it('invokes createVpcFlowLogsConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkmanagement.v1beta1.CreateVpcFlowLogsConfigRequest', ['parent']);
        ...
        it('invokes createVpcFlowLogsConfig without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createVpcFlowLogsConfig(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networkmanagement.v1beta1.IVpcFlowLogsConfig, protos.google.cloud.networkmanagement.v1beta1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networkmanagement.v1beta1.IVpcFlowLogsConfig, protos.google.cloud.networkmanagement.v1beta1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createVpcFlowLogsConfig as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateVpcFlowLogsConfig', () => {
        it('invokes updateVpcFlowLogsConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkmanagement.v1beta1.UpdateVpcFlowLogsConfigRequest', ['vpcFlowLogsConfig', 'name']);
    ...
    describe('deleteVpcFlowLogsConfig', () => {
        it('invokes deleteVpcFlowLogsConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkmanagement.v1beta1.DeleteVpcFlowLogsConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listVpcFlowLogsConfigs', () => {
        it('invokes listVpcFlowLogsConfigs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkmanagement.v1beta1.ListVpcFlowLogsConfigsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networkmanagement.v1beta1.VpcFlowLogsConfig()),
              generateSampleMessage(new protos.google.cloud.networkmanagement.v1beta1.VpcFlowLogsConfig()),
              generateSampleMessage(new protos.google.cloud.networkmanagement.v1beta1.VpcFlowLogsConfig()),
            ];
        ...
        it('invokes listVpcFlowLogsConfigsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networkmanagement.v1beta1.VpcFlowLogsConfig) => {
    ...
    describe('queryOrgVpcFlowLogsConfigs', () => {
        it('invokes queryOrgVpcFlowLogsConfigs without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networkmanagement.v1beta1.QueryOrgVpcFlowLogsConfigsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkmanagement.v1beta1.QueryOrgVpcFlowLogsConfigsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networkmanagement.v1beta1.VpcFlowLogsConfig()),
              generateSampleMessage(new protos.google.cloud.networkmanagement.v1beta1.VpcFlowLogsConfig()),
