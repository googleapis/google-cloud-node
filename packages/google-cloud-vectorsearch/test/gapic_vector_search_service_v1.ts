...
describe('v1.VectorSearchServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new vectorsearchserviceModule.v1.VectorSearchServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          vectorsearchserviceModule.v1.VectorSearchServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          vectorsearchserviceModule.v1.VectorSearchServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'vectorsearch.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('invokes getCollection without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getCollection(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.vectorsearch.v1.ICollection | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getIndex without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getIndex(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.vectorsearch.v1.IIndex | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listCollections', () => {
    ...
    it('invokes listCollectionsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.vectorsearch.v1.Collection) => {
  ...
  describe('listIndexes', () => {
    ...
    it('invokes listIndexesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.vectorsearch.v1.Index) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
