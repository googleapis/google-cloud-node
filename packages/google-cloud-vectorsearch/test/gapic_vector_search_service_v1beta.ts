...
describe('v1beta.VectorSearchServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new vectorsearchserviceModule.v1beta.VectorSearchServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          vectorsearchserviceModule.v1beta.VectorSearchServiceClient
            .servicePath;
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        ...
        it('value configured in code has priority over environment variable', () => {
          ...
          assert.strictEqual(
            servicePath,
            'vectorsearch.configured.example.com',
          );
          if (saved) {
            process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = saved;
          } else {
    ...
    it('has port', () => {
      const port =
        vectorsearchserviceModule.v1beta.VectorSearchServiceClient.port;
      assert(port);
  ...
  describe('getCollection', () => {
    it('invokes getCollection without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getCollection as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getCollection without error using callback', async () => {
      ...
      client.innerApiCalls.getCollection =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getCollection(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.vectorsearch.v1beta.ICollection | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getCollection with error', async () => {
      ...
      client.innerApiCalls.getCollection = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes getIndex without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getIndex(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.vectorsearch.v1beta.IIndex | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createCollection', () => {
    it('invokes createCollection without error', async () => {
      ...
      client.innerApiCalls.createCollection =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createCollection(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createCollection as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createCollection as SinonStub
    ...
    it('invokes createCollection with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createCollection = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkCreateCollectionProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateCollectionProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateCollection', () => {
    it('invokes updateCollection without error', async () => {
      ...
      client.innerApiCalls.updateCollection =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateCollection(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateCollection as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateCollection as SinonStub
    ...
    it('invokes updateCollection with call error', async () => {
      ...
      const expectedHeaderRequestParams = `collection.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateCollection = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkUpdateCollectionProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateCollectionProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteCollection', () => {
    it('invokes deleteCollection without error', async () => {
      ...
      client.innerApiCalls.deleteCollection =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteCollection(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteCollection as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteCollection as SinonStub
    ...
    it('invokes deleteCollection with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteCollection = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkDeleteCollectionProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteCollectionProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateIndex', () => {
    it('invokes updateIndex without error', async () => {
      ...
      request.index ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.vectorsearch.v1beta.UpdateIndexRequest',
        ['index', 'name'],
      );
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateIndex as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateIndex as SinonStub
    ...
    it('invokes updateIndex with call error', async () => {
      ...
      const expectedHeaderRequestParams = `index.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateIndex = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('importDataObjects', () => {
    it('invokes importDataObjects without error', async () => {
      ...
      client.innerApiCalls.importDataObjects =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.importDataObjects(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.importDataObjects as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.importDataObjects as SinonStub
    ...
    it('invokes importDataObjects with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.importDataObjects = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkImportDataObjectsProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkImportDataObjectsProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('exportDataObjects', () => {
    it('invokes exportDataObjects without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.vectorsearch.v1beta.ExportDataObjectsRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.exportDataObjects as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.exportDataObjects as SinonStub
    ...
    it('invokes exportDataObjects with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.exportDataObjects = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkExportDataObjectsProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkExportDataObjectsProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listCollections', () => {
    it('invokes listCollections without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listCollections as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listCollections as SinonStub
    ...
    it('invokes listCollections without error using callback', async () => {
      ...
      client.innerApiCalls.listCollections =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listCollections(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.vectorsearch.v1beta.ICollection[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listCollections with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listCollections = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listCollectionsStream without error', async () => {
      ...
      client.descriptors.page.listCollections.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.vectorsearch.v1beta.Collection) => {
      ...
      assert(
        (client.descriptors.page.listCollections.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listCollections, request),
      );
      assert(
        (client.descriptors.page.listCollections.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listCollections without error', async () => {
      ...
      client.descriptors.page.listCollections.asyncIterate =
  ...
  describe('listIndexes', () => {
    ...
    it('invokes listIndexesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.vectorsearch.v1beta.Index) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('Path templates', () => {
    ...
    describe('dataObject', async () => {
      ...
      await client.initialize();
      client.pathTemplates.dataObjectPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.dataObjectPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('dataObjectPath', () => {
        const result = client.dataObjectPath(
          'projectValue',
          'locationValue',
          'collectionValue',
          'dataObjectValue',
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.dataObjectPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromDataObjectName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.dataObjectPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
