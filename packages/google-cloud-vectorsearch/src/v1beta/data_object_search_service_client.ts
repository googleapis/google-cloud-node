...
export class DataObjectSearchServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.vectorsearch.v1beta.DataObjectSearchService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.dataObjectSearchServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.vectorsearch.v1beta.DataObjectSearchService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.vectorsearch.v1beta.DataObjectSearchService,
 ...
 */
  aggregateDataObjects(
      request?: protos.google.cloud.vectorsearch.v1beta.IAggregateDataObjectsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.vectorsearch.v1beta.IAggregateDataObjectsResponse,
        protos.google.cloud.vectorsearch.v1beta.IAggregateDataObjectsRequest|undefined, {}|undefined
      ]>;
  aggregateDataObjects(
      request: protos.google.cloud.vectorsearch.v1beta.IAggregateDataObjectsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.vectorsearch.v1beta.IAggregateDataObjectsResponse,
          protos.google.cloud.vectorsearch.v1beta.IAggregateDataObjectsRequest|null|undefined,
          {}|null|undefined>): void;
  aggregateDataObjects(
      request: protos.google.cloud.vectorsearch.v1beta.IAggregateDataObjectsRequest,
      callback: Callback<
 ...
 */
  batchSearchDataObjects(
      request?: protos.google.cloud.vectorsearch.v1beta.IBatchSearchDataObjectsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.vectorsearch.v1beta.IBatchSearchDataObjectsResponse,
        protos.google.cloud.vectorsearch.v1beta.IBatchSearchDataObjectsRequest|undefined, {}|undefined
      ]>;
  batchSearchDataObjects(
      request: protos.google.cloud.vectorsearch.v1beta.IBatchSearchDataObjectsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.vectorsearch.v1beta.IBatchSearchDataObjectsResponse,
          protos.google.cloud.vectorsearch.v1beta.IBatchSearchDataObjectsRequest|null|undefined,
          {}|null|undefined>): void;
  batchSearchDataObjects(
      request: protos.google.cloud.vectorsearch.v1beta.IBatchSearchDataObjectsRequest,
      callback: Callback<
 ...
 */
  searchDataObjects(
      request?: protos.google.cloud.vectorsearch.v1beta.ISearchDataObjectsRequest,
      options?: CallOptions):
      Promise<[
  ...
  searchDataObjects(
      ...
      callback: PaginationCallback<
          protos.google.cloud.vectorsearch.v1beta.ISearchDataObjectsRequest,
          protos.google.cloud.vectorsearch.v1beta.ISearchDataObjectsResponse|null|undefined,
          protos.google.cloud.vectorsearch.v1beta.ISearchResult>): void;
  searchDataObjects(
      request: protos.google.cloud.vectorsearch.v1beta.ISearchDataObjectsRequest,
      callback: PaginationCallback<
          protos.google.cloud.vectorsearch.v1beta.ISearchDataObjectsRequest,
  ...
  searchDataObjects(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.vectorsearch.v1beta.ISearchDataObjectsRequest,
      protos.google.cloud.vectorsearch.v1beta.ISearchDataObjectsResponse|null|undefined,
      protos.google.cloud.vectorsearch.v1beta.ISearchResult>|undefined = callback
 ...
 */
  searchDataObjectsAsync(
      request?: protos.google.cloud.vectorsearch.v1beta.ISearchDataObjectsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.vectorsearch.v1beta.ISearchResult>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.searchDataObjects.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.vectorsearch.v1beta.ISearchResult>;
  }
 /**
 ...
 */
  queryDataObjects(
      request?: protos.google.cloud.vectorsearch.v1beta.IQueryDataObjectsRequest,
      options?: CallOptions):
      Promise<[
  ...
  queryDataObjects(
      ...
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.cloud.vectorsearch.v1beta.IQueryDataObjectsRequest,
          protos.google.cloud.vectorsearch.v1beta.IQueryDataObjectsResponse|null|undefined,
          protos.google.cloud.vectorsearch.v1beta.IDataObject>): void;
  queryDataObjects(
      request: protos.google.cloud.vectorsearch.v1beta.IQueryDataObjectsRequest,
      callback: PaginationCallback<
          protos.google.cloud.vectorsearch.v1beta.IQueryDataObjectsRequest,
  ...
  queryDataObjects(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.vectorsearch.v1beta.IQueryDataObjectsRequest,
      protos.google.cloud.vectorsearch.v1beta.IQueryDataObjectsResponse|null|undefined,
      protos.google.cloud.vectorsearch.v1beta.IDataObject>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
 ...
 */
  queryDataObjectsAsync(
      request?: protos.google.cloud.vectorsearch.v1beta.IQueryDataObjectsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.vectorsearch.v1beta.IDataObject>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.queryDataObjects.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.vectorsearch.v1beta.IDataObject>;
  }
/**
