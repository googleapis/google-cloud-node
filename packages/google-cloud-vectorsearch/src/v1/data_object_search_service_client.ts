 ...
 * `src/v1/data_object_search_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './data_object_search_service_client_config.json';
 ...
 * @memberof v1
 */
export class DataObjectSearchServiceClient {
