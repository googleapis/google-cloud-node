...
describe('v1beta.TransportManagerClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          transportmanagerModule.v1beta.TransportManagerClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          transportmanagerModule.v1beta.TransportManagerClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'networkconnectivity.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new transportmanagerModule.v1beta.TransportManagerClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'networkconnectivity.example.com');
          if (saved) {
  ...
  describe('getRemoteTransportProfile', () => {
    it('invokes getRemoteTransportProfile without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.GetRemoteTransportProfileRequest',
        ['name'],
      );
      ...
      client.innerApiCalls.getRemoteTransportProfile =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getRemoteTransportProfile(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getRemoteTransportProfile as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getRemoteTransportProfile without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getRemoteTransportProfile(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networkconnectivity.v1beta.IRemoteTransportProfile | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getRemoteTransportProfile with error', async () => {
      ...
      client.innerApiCalls.getRemoteTransportProfile = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('parseFromActivationKey', () => {
    it('invokes parseFromActivationKey without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.ParseFromActivationKeyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.networkconnectivity.v1beta.ParseFromActivationKeyResponse(),
      );
      client.innerApiCalls.parseFromActivationKey =
        stubSimpleCall(expectedResponse);
      const [response] = await client.parseFromActivationKey(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.parseFromActivationKey as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.parseFromActivationKey as SinonStub
    ...
    it('invokes parseFromActivationKey without error using callback', async () => {
      ...
      client.innerApiCalls.parseFromActivationKey =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.parseFromActivationKey(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.networkconnectivity.v1beta.IParseFromActivationKeyResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes parseFromActivationKey with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.parseFromActivationKey = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.parseFromActivationKey(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.parseFromActivationKey as SinonStub
  ...
  describe('getTransport', () => {
    it('invokes getTransport without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.GetTransportRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getTransport as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getTransport as SinonStub
    ...
    it('invokes getTransport without error using callback', async () => {
      ...
      client.innerApiCalls.getTransport =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getTransport(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.networkconnectivity.v1beta.ITransport | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getTransport with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getTransport = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getStatus', () => {
    it('invokes getStatus without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.GetStatusRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
    ...
    it('invokes getStatus without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getStatus(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networkconnectivity.v1beta.IGetStatusResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createTransport', () => {
    it('invokes createTransport without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.CreateTransportRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createTransport as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createTransport as SinonStub
    ...
    it('invokes createTransport with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createTransport = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkCreateTransportProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateTransportProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateTransport', () => {
    it('invokes updateTransport without error', async () => {
      ...
      request.transport ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.UpdateTransportRequest',
        ['transport', 'name'],
      );
      ...
      client.innerApiCalls.updateTransport =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateTransport(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateTransport as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateTransport as SinonStub
    ...
    it('invokes updateTransport with call error', async () => {
      ...
      const expectedHeaderRequestParams = `transport.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateTransport = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkUpdateTransportProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateTransportProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteTransport', () => {
    it('invokes deleteTransport without error', async () => {
      ...
      client.innerApiCalls.deleteTransport =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteTransport(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteTransport as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteTransport as SinonStub
    ...
    it('invokes deleteTransport with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteTransport = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkDeleteTransportProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteTransportProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listRemoteTransportProfiles', () => {
    it('invokes listRemoteTransportProfiles without error', async () => {
      ...
      client.innerApiCalls.listRemoteTransportProfiles =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listRemoteTransportProfiles(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listRemoteTransportProfiles as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listRemoteTransportProfiles as SinonStub
    ...
    it('invokes listRemoteTransportProfiles with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listRemoteTransportProfiles = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listRemoteTransportProfiles(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listRemoteTransportProfiles as SinonStub
    ...
    it('invokes listRemoteTransportProfilesStream without error', async () => {
      ...
      client.descriptors.page.listRemoteTransportProfiles.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networkconnectivity.v1beta.RemoteTransportProfile,
          ) => {
      ...
      assert(
        (
          client.descriptors.page.listRemoteTransportProfiles
    ...
    it('uses async iteration with listRemoteTransportProfiles without error', async () => {
      ...
      client.descriptors.page.listRemoteTransportProfiles.asyncIterate =
  ...
  describe('listTransports', () => {
    it('invokes listTransports without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.ListTransportsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listTransports as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listTransports as SinonStub
    ...
    it('invokes listTransports without error using callback', async () => {
      ...
      client.innerApiCalls.listTransports =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listTransports with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listTransports = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listTransportsStream without error', async () => {
      ...
      client.descriptors.page.listTransports.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networkconnectivity.v1beta.Transport,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (client.descriptors.page.listTransports.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listTransports, request),
      );
      assert(
        (client.descriptors.page.listTransports.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listTransports without error', async () => {
      ...
      client.descriptors.page.listTransports.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('Path templates', () => {
    ...
    describe('gatewayAdvertisedRoute', async () => {
      ...
      await client.initialize();
      client.pathTemplates.gatewayAdvertisedRoutePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.gatewayAdvertisedRoutePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('gatewayAdvertisedRoutePath', () => {
        const result = client.gatewayAdvertisedRoutePath(
          'projectValue',
          'locationValue',
          'spokeValue',
          'gatewayAdvertisedRouteValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.gatewayAdvertisedRoutePathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromGatewayAdvertisedRouteName', () => {
        const result =
          client.matchProjectFromGatewayAdvertisedRouteName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.gatewayAdvertisedRoutePathTemplate
      ...
      it('matchLocationFromGatewayAdvertisedRouteName', () => {
        const result =
          client.matchLocationFromGatewayAdvertisedRouteName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.gatewayAdvertisedRoutePathTemplate
      ...
      it('matchSpokeFromGatewayAdvertisedRouteName', () => {
        const result =
          client.matchSpokeFromGatewayAdvertisedRouteName(fakePath);
      ...
      it('matchGatewayAdvertisedRouteFromGatewayAdvertisedRouteName', () => {
        const result =
          client.matchGatewayAdvertisedRouteFromGatewayAdvertisedRouteName(
            fakePath,
          );
    ...
    describe('remoteTransportProfile', async () => {
      ...
      await client.initialize();
      client.pathTemplates.remoteTransportProfilePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.remoteTransportProfilePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('remoteTransportProfilePath', () => {
        const result = client.remoteTransportProfilePath(
          'projectValue',
          'locationValue',
          'remoteTransportProfileValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
      ...
      it('matchProjectFromRemoteTransportProfileName', () => {
        const result =
          client.matchProjectFromRemoteTransportProfileName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.remoteTransportProfilePathTemplate
      ...
      it('matchLocationFromRemoteTransportProfileName', () => {
        const result =
          client.matchLocationFromRemoteTransportProfileName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.remoteTransportProfilePathTemplate
      ...
      it('matchRemoteTransportProfileFromRemoteTransportProfileName', () => {
        const result =
          client.matchRemoteTransportProfileFromRemoteTransportProfileName(
            fakePath,
          );
    ...
    describe('transport', async () => {
      ...
      await client.initialize();
      client.pathTemplates.transportPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.transportPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('transportPath', () => {
        const result = client.transportPath(
          'projectValue',
          'locationValue',
          'transportValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.transportPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromTransportName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.transportPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
