...
describe('v1beta.HubServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = hubserviceModule.v1beta.HubServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = hubserviceModule.v1beta.HubServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'networkconnectivity.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new hubserviceModule.v1beta.HubServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networkconnectivity.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new hubserviceModule.v1beta.HubServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networkconnectivity.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new hubserviceModule.v1beta.HubServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new hubserviceModule.v1beta.HubServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getHub', () => {
        it('invokes getHub without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.GetHubRequest', ['name']);
        ...
        it('invokes getHub without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getHub(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networkconnectivity.v1beta.IHub|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getSpoke', () => {
        it('invokes getSpoke without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.GetSpokeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getSpoke without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getSpoke(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networkconnectivity.v1beta.ISpoke|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getRouteTable', () => {
        it('invokes getRouteTable without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.GetRouteTableRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getRouteTable without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getRouteTable(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networkconnectivity.v1beta.IRouteTable|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getRoute', () => {
        it('invokes getRoute without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.GetRouteRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getRoute without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getRoute(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networkconnectivity.v1beta.IRoute|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getGroup', () => {
        it('invokes getGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.GetGroupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getGroup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getGroup(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networkconnectivity.v1beta.IGroup|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getGatewayAdvertisedRoute', () => {
        it('invokes getGatewayAdvertisedRoute without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.GetGatewayAdvertisedRouteRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.networkconnectivity.v1beta.GatewayAdvertisedRoute()
            );
            client.innerApiCalls.getGatewayAdvertisedRoute = stubSimpleCall(expectedResponse);
            const [response] = await client.getGatewayAdvertisedRoute(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getGatewayAdvertisedRoute as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getGatewayAdvertisedRoute as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getGatewayAdvertisedRoute without error using callback', async () => {
            ...
            client.innerApiCalls.getGatewayAdvertisedRoute = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getGatewayAdvertisedRoute(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networkconnectivity.v1beta.IGatewayAdvertisedRoute|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getGatewayAdvertisedRoute with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getGatewayAdvertisedRoute = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getGatewayAdvertisedRoute(request), expectedError);
            const actualRequest = (client.innerApiCalls.getGatewayAdvertisedRoute as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getGatewayAdvertisedRoute as SinonStub)
    ...
    describe('createHub', () => {
        it('invokes createHub without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.CreateHubRequest', ['parent']);
        ...
        it('invokes createHub without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createHub(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networkconnectivity.v1beta.IHub, protos.google.cloud.networkconnectivity.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networkconnectivity.v1beta.IHub, protos.google.cloud.networkconnectivity.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createHub as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateHub', () => {
        it('invokes updateHub without error', async () => {
            ...
            request.hub ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.UpdateHubRequest', ['hub', 'name']);
    ...
    describe('deleteHub', () => {
        it('invokes deleteHub without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.DeleteHubRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createSpoke', () => {
        it('invokes createSpoke without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.CreateSpokeRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createSpoke without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createSpoke(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networkconnectivity.v1beta.ISpoke, protos.google.cloud.networkconnectivity.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networkconnectivity.v1beta.ISpoke, protos.google.cloud.networkconnectivity.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createSpoke as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateSpoke', () => {
        it('invokes updateSpoke without error', async () => {
            ...
            request.spoke ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.UpdateSpokeRequest', ['spoke', 'name']);
    ...
    describe('rejectHubSpoke', () => {
        it('invokes rejectHubSpoke without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.RejectHubSpokeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes rejectHubSpoke without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.rejectHubSpoke(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networkconnectivity.v1beta.IRejectHubSpokeResponse, protos.google.cloud.networkconnectivity.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networkconnectivity.v1beta.IRejectHubSpokeResponse, protos.google.cloud.networkconnectivity.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.rejectHubSpoke as SinonStub)
                .getCall(0).args[0];
    ...
    describe('acceptHubSpoke', () => {
        it('invokes acceptHubSpoke without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.AcceptHubSpokeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes acceptHubSpoke without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.acceptHubSpoke(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networkconnectivity.v1beta.IAcceptHubSpokeResponse, protos.google.cloud.networkconnectivity.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networkconnectivity.v1beta.IAcceptHubSpokeResponse, protos.google.cloud.networkconnectivity.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.acceptHubSpoke as SinonStub)
                .getCall(0).args[0];
    ...
    describe('acceptSpokeUpdate', () => {
        it('invokes acceptSpokeUpdate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.AcceptSpokeUpdateRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes acceptSpokeUpdate without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.acceptSpokeUpdate(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networkconnectivity.v1beta.IAcceptSpokeUpdateResponse, protos.google.cloud.networkconnectivity.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networkconnectivity.v1beta.IAcceptSpokeUpdateResponse, protos.google.cloud.networkconnectivity.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.acceptSpokeUpdate as SinonStub)
                .getCall(0).args[0];
    ...
    describe('rejectSpokeUpdate', () => {
        it('invokes rejectSpokeUpdate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.RejectSpokeUpdateRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes rejectSpokeUpdate without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.rejectSpokeUpdate(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networkconnectivity.v1beta.IRejectSpokeUpdateResponse, protos.google.cloud.networkconnectivity.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networkconnectivity.v1beta.IRejectSpokeUpdateResponse, protos.google.cloud.networkconnectivity.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.rejectSpokeUpdate as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteSpoke', () => {
        it('invokes deleteSpoke without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.DeleteSpokeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('updateGroup', () => {
        it('invokes updateGroup without error', async () => {
            ...
            request.group ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.UpdateGroupRequest', ['group', 'name']);
        ...
        it('invokes updateGroup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updateGroup(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networkconnectivity.v1beta.IGroup, protos.google.cloud.networkconnectivity.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networkconnectivity.v1beta.IGroup, protos.google.cloud.networkconnectivity.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateGroup as SinonStub)
                .getCall(0).args[0];
    ...
    describe('createGatewayAdvertisedRoute', () => {
        it('invokes createGatewayAdvertisedRoute without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.CreateGatewayAdvertisedRouteRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createGatewayAdvertisedRoute = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createGatewayAdvertisedRoute(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createGatewayAdvertisedRoute as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createGatewayAdvertisedRoute as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createGatewayAdvertisedRoute without error using callback', async () => {
            ...
            client.innerApiCalls.createGatewayAdvertisedRoute = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createGatewayAdvertisedRoute(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networkconnectivity.v1beta.IGatewayAdvertisedRoute, protos.google.cloud.networkconnectivity.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networkconnectivity.v1beta.IGatewayAdvertisedRoute, protos.google.cloud.networkconnectivity.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createGatewayAdvertisedRoute as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createGatewayAdvertisedRoute with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createGatewayAdvertisedRoute = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createGatewayAdvertisedRoute(request), expectedError);
            const actualRequest = (client.innerApiCalls.createGatewayAdvertisedRoute as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createGatewayAdvertisedRoute as SinonStub)
        ...
        it('invokes createGatewayAdvertisedRoute with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createGatewayAdvertisedRoute = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createGatewayAdvertisedRoute(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.createGatewayAdvertisedRoute as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkCreateGatewayAdvertisedRouteProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkCreateGatewayAdvertisedRouteProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkCreateGatewayAdvertisedRouteProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkCreateGatewayAdvertisedRouteProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('updateGatewayAdvertisedRoute', () => {
        it('invokes updateGatewayAdvertisedRoute without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.UpdateGatewayAdvertisedRouteRequest', ['gatewayAdvertisedRoute', 'name']);
            ...
            client.innerApiCalls.updateGatewayAdvertisedRoute = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateGatewayAdvertisedRoute(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateGatewayAdvertisedRoute as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateGatewayAdvertisedRoute as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateGatewayAdvertisedRoute without error using callback', async () => {
            ...
            client.innerApiCalls.updateGatewayAdvertisedRoute = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateGatewayAdvertisedRoute with call error', async () => {
            ...
            const expectedHeaderRequestParams = `gateway_advertised_route.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateGatewayAdvertisedRoute = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.updateGatewayAdvertisedRoute(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateGatewayAdvertisedRoute as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateGatewayAdvertisedRoute as SinonStub)
        ...
        it('invokes updateGatewayAdvertisedRoute with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `gateway_advertised_route.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateGatewayAdvertisedRoute = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateGatewayAdvertisedRoute(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateGatewayAdvertisedRoute as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateGatewayAdvertisedRouteProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateGatewayAdvertisedRouteProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateGatewayAdvertisedRouteProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateGatewayAdvertisedRouteProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteGatewayAdvertisedRoute', () => {
        it('invokes deleteGatewayAdvertisedRoute without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.DeleteGatewayAdvertisedRouteRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteGatewayAdvertisedRoute = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteGatewayAdvertisedRoute(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteGatewayAdvertisedRoute as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteGatewayAdvertisedRoute as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteGatewayAdvertisedRoute without error using callback', async () => {
            ...
            client.innerApiCalls.deleteGatewayAdvertisedRoute = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteGatewayAdvertisedRoute with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteGatewayAdvertisedRoute = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteGatewayAdvertisedRoute(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteGatewayAdvertisedRoute as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteGatewayAdvertisedRoute as SinonStub)
        ...
        it('invokes deleteGatewayAdvertisedRoute with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteGatewayAdvertisedRoute = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteGatewayAdvertisedRoute(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteGatewayAdvertisedRoute as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteGatewayAdvertisedRouteProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteGatewayAdvertisedRouteProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteGatewayAdvertisedRouteProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteGatewayAdvertisedRouteProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listHubs', () => {
        it('invokes listHubs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.ListHubsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.Hub()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.Hub()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.Hub()),
            ];
        ...
        it('invokes listHubsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networkconnectivity.v1beta.Hub) => {
    ...
    describe('listHubSpokes', () => {
        it('invokes listHubSpokes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.ListHubSpokesRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.Spoke()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.Spoke()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.Spoke()),
            ];
        ...
        it('invokes listHubSpokesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networkconnectivity.v1beta.Spoke) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('queryHubStatus', () => {
        it('invokes queryHubStatus without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.QueryHubStatusRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.HubStatusEntry()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.HubStatusEntry()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.HubStatusEntry()),
            ];
        ...
        it('invokes queryHubStatus without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.queryHubStatus(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networkconnectivity.v1beta.IHubStatusEntry[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes queryHubStatusStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networkconnectivity.v1beta.HubStatusEntry) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listSpokes', () => {
        it('invokes listSpokes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.ListSpokesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.Spoke()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.Spoke()),
    ...
    describe('listRoutes', () => {
        it('invokes listRoutes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.ListRoutesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.Route()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.Route()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.Route()),
            ];
        ...
        it('invokes listRoutesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networkconnectivity.v1beta.Route) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listRouteTables', () => {
        it('invokes listRouteTables without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.ListRouteTablesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.RouteTable()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.RouteTable()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.RouteTable()),
            ];
        ...
        it('invokes listRouteTablesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networkconnectivity.v1beta.RouteTable) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listGroups', () => {
        it('invokes listGroups without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.ListGroupsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.Group()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.Group()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.Group()),
            ];
        ...
        it('invokes listGroupsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networkconnectivity.v1beta.Group) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listGatewayAdvertisedRoutes', () => {
        it('invokes listGatewayAdvertisedRoutes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.ListGatewayAdvertisedRoutesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.GatewayAdvertisedRoute()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.GatewayAdvertisedRoute()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.GatewayAdvertisedRoute()),
            ];
            client.innerApiCalls.listGatewayAdvertisedRoutes = stubSimpleCall(expectedResponse);
            const [response] = await client.listGatewayAdvertisedRoutes(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listGatewayAdvertisedRoutes as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listGatewayAdvertisedRoutes as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listGatewayAdvertisedRoutes without error using callback', async () => {
            ...
            client.innerApiCalls.listGatewayAdvertisedRoutes = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listGatewayAdvertisedRoutes with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listGatewayAdvertisedRoutes = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listGatewayAdvertisedRoutes(request), expectedError);
            const actualRequest = (client.innerApiCalls.listGatewayAdvertisedRoutes as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listGatewayAdvertisedRoutes as SinonStub)
        ...
        it('invokes listGatewayAdvertisedRoutesStream without error', async () => {
            ...
            client.descriptors.page.listGatewayAdvertisedRoutes.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networkconnectivity.v1beta.GatewayAdvertisedRoute) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listGatewayAdvertisedRoutes.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listGatewayAdvertisedRoutes, request));
            assert(
                (client.descriptors.page.listGatewayAdvertisedRoutes.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listGatewayAdvertisedRoutesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listGatewayAdvertisedRoutes.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listGatewayAdvertisedRoutesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.networkconnectivity.v1beta.GatewayAdvertisedRoute[] = [];
                stream.on('data', (response: protos.google.cloud.networkconnectivity.v1beta.GatewayAdvertisedRoute) => {
        ...
        it('uses async iteration with listGatewayAdvertisedRoutes without error', async () => {
            ...
            client.descriptors.page.listGatewayAdvertisedRoutes.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listGatewayAdvertisedRoutes.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listGatewayAdvertisedRoutes.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listGatewayAdvertisedRoutes with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listGatewayAdvertisedRoutes.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listGatewayAdvertisedRoutesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.networkconnectivity.v1beta.IGatewayAdvertisedRoute[] = [];
                for await (const resource of iterable) {
