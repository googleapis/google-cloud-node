...
describe('v1beta.PolicyBasedRoutingServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new policybasedroutingserviceModule.v1beta.PolicyBasedRoutingServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = policybasedroutingserviceModule.v1beta.PolicyBasedRoutingServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = policybasedroutingserviceModule.v1beta.PolicyBasedRoutingServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'networkconnectivity.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new policybasedroutingserviceModule.v1beta.PolicyBasedRoutingServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networkconnectivity.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new policybasedroutingserviceModule.v1beta.PolicyBasedRoutingServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networkconnectivity.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new policybasedroutingserviceModule.v1beta.PolicyBasedRoutingServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new policybasedroutingserviceModule.v1beta.PolicyBasedRoutingServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = policybasedroutingserviceModule.v1beta.PolicyBasedRoutingServiceClient.port;
            assert(port);
    ...
    describe('getPolicyBasedRoute', () => {
        it('invokes getPolicyBasedRoute without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.networkconnectivity.v1beta.GetPolicyBasedRouteRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.GetPolicyBasedRouteRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.networkconnectivity.v1beta.PolicyBasedRoute()
            );
        ...
        it('invokes getPolicyBasedRoute without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getPolicyBasedRoute(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networkconnectivity.v1beta.IPolicyBasedRoute|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createPolicyBasedRoute', () => {
        it('invokes createPolicyBasedRoute without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networkconnectivity.v1beta.CreatePolicyBasedRouteRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.CreatePolicyBasedRouteRequest', ['parent']);
        ...
        it('invokes createPolicyBasedRoute without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createPolicyBasedRoute(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networkconnectivity.v1beta.IPolicyBasedRoute, protos.google.cloud.networkconnectivity.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networkconnectivity.v1beta.IPolicyBasedRoute, protos.google.cloud.networkconnectivity.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createPolicyBasedRoute as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deletePolicyBasedRoute', () => {
        it('invokes deletePolicyBasedRoute without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networkconnectivity.v1beta.DeletePolicyBasedRouteRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.DeletePolicyBasedRouteRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listPolicyBasedRoutes', () => {
        it('invokes listPolicyBasedRoutes without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networkconnectivity.v1beta.ListPolicyBasedRoutesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.ListPolicyBasedRoutesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.PolicyBasedRoute()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.PolicyBasedRoute()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.PolicyBasedRoute()),
            ];
        ...
        it('invokes listPolicyBasedRoutesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.networkconnectivity.v1beta.PolicyBasedRoute[] = [];
                stream.on('data', (response: protos.google.cloud.networkconnectivity.v1beta.PolicyBasedRoute) => {
        ...
        it('uses async iteration with listPolicyBasedRoutes without error', async () => {
            ...
            const responses: protos.google.cloud.networkconnectivity.v1beta.IPolicyBasedRoute[] = [];
