...
describe('v1beta.PolicyBasedRoutingServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          policybasedroutingserviceModule.v1beta.PolicyBasedRoutingServiceClient
            .servicePath;
    ...
    it('invokes getPolicyBasedRoute without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getPolicyBasedRoute(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networkconnectivity.v1beta.IPolicyBasedRoute | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createPolicyBasedRoute', () => {
    it('invokes createPolicyBasedRoute without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.CreatePolicyBasedRouteRequest',
        ['parent'],
      );
  ...
  describe('listPolicyBasedRoutes', () => {
    it('invokes listPolicyBasedRoutes without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.ListPolicyBasedRoutesRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
    ...
    it('invokes listPolicyBasedRoutesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networkconnectivity.v1beta.PolicyBasedRoute,
          ) => {
