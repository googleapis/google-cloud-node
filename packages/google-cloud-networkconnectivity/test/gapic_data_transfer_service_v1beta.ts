...
describe('v1beta.DataTransferServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new datatransferserviceModule.v1beta.DataTransferServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = datatransferserviceModule.v1beta.DataTransferServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = datatransferserviceModule.v1beta.DataTransferServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'networkconnectivity.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new datatransferserviceModule.v1beta.DataTransferServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networkconnectivity.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new datatransferserviceModule.v1beta.DataTransferServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networkconnectivity.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new datatransferserviceModule.v1beta.DataTransferServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new datatransferserviceModule.v1beta.DataTransferServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = datatransferserviceModule.v1beta.DataTransferServiceClient.port;
            assert(port);
    ...
    describe('getMulticloudDataTransferConfig', () => {
        it('invokes getMulticloudDataTransferConfig without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.networkconnectivity.v1beta.GetMulticloudDataTransferConfigRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.GetMulticloudDataTransferConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.networkconnectivity.v1beta.MulticloudDataTransferConfig()
            );
        ...
        it('invokes getMulticloudDataTransferConfig without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getMulticloudDataTransferConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networkconnectivity.v1beta.IMulticloudDataTransferConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getDestination', () => {
        it('invokes getDestination without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networkconnectivity.v1beta.GetDestinationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.GetDestinationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.networkconnectivity.v1beta.Destination()
            );
        ...
        it('invokes getDestination without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getDestination(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networkconnectivity.v1beta.IDestination|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getMulticloudDataTransferSupportedService', () => {
        it('invokes getMulticloudDataTransferSupportedService without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networkconnectivity.v1beta.GetMulticloudDataTransferSupportedServiceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.GetMulticloudDataTransferSupportedServiceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.networkconnectivity.v1beta.MulticloudDataTransferSupportedService()
            );
        ...
        it('invokes getMulticloudDataTransferSupportedService without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getMulticloudDataTransferSupportedService(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networkconnectivity.v1beta.IMulticloudDataTransferSupportedService|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createMulticloudDataTransferConfig', () => {
        it('invokes createMulticloudDataTransferConfig without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networkconnectivity.v1beta.CreateMulticloudDataTransferConfigRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.CreateMulticloudDataTransferConfigRequest', ['parent']);
        ...
        it('invokes createMulticloudDataTransferConfig without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createMulticloudDataTransferConfig(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networkconnectivity.v1beta.IMulticloudDataTransferConfig, protos.google.cloud.networkconnectivity.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networkconnectivity.v1beta.IMulticloudDataTransferConfig, protos.google.cloud.networkconnectivity.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createMulticloudDataTransferConfig as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateMulticloudDataTransferConfig', () => {
        it('invokes updateMulticloudDataTransferConfig without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networkconnectivity.v1beta.UpdateMulticloudDataTransferConfigRequest()
            );
            request.multicloudDataTransferConfig ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.UpdateMulticloudDataTransferConfigRequest', ['multicloudDataTransferConfig', 'name']);
    ...
    describe('deleteMulticloudDataTransferConfig', () => {
        it('invokes deleteMulticloudDataTransferConfig without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networkconnectivity.v1beta.DeleteMulticloudDataTransferConfigRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.DeleteMulticloudDataTransferConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createDestination', () => {
        it('invokes createDestination without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networkconnectivity.v1beta.CreateDestinationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.CreateDestinationRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createDestination without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createDestination(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networkconnectivity.v1beta.IDestination, protos.google.cloud.networkconnectivity.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networkconnectivity.v1beta.IDestination, protos.google.cloud.networkconnectivity.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createDestination as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateDestination', () => {
        it('invokes updateDestination without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networkconnectivity.v1beta.UpdateDestinationRequest()
            );
            request.destination ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.UpdateDestinationRequest', ['destination', 'name']);
    ...
    describe('deleteDestination', () => {
        it('invokes deleteDestination without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networkconnectivity.v1beta.DeleteDestinationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.DeleteDestinationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listMulticloudDataTransferConfigs', () => {
        it('invokes listMulticloudDataTransferConfigs without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networkconnectivity.v1beta.ListMulticloudDataTransferConfigsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.ListMulticloudDataTransferConfigsRequest', ['parent']);
            request.parent = defaultValue1;
        ...
        it('uses async iteration with listMulticloudDataTransferConfigs without error', async () => {
            ...
            const responses: protos.google.cloud.networkconnectivity.v1beta.IMulticloudDataTransferConfig[] = [];
    ...
    describe('listDestinations', () => {
        it('invokes listDestinations without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networkconnectivity.v1beta.ListDestinationsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.ListDestinationsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.Destination()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.Destination()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.Destination()),
            ];
        ...
        it('invokes listDestinationsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.networkconnectivity.v1beta.Destination[] = [];
                stream.on('data', (response: protos.google.cloud.networkconnectivity.v1beta.Destination) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listDestinations without error', async () => {
            ...
            const responses: protos.google.cloud.networkconnectivity.v1beta.IDestination[] = [];
    ...
    describe('listMulticloudDataTransferSupportedServices', () => {
        it('invokes listMulticloudDataTransferSupportedServices without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.networkconnectivity.v1beta.ListMulticloudDataTransferSupportedServicesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1beta.ListMulticloudDataTransferSupportedServicesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.MulticloudDataTransferSupportedService()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.MulticloudDataTransferSupportedService()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1beta.MulticloudDataTransferSupportedService()),
            ];
        ...
        it('invokes listMulticloudDataTransferSupportedServicesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.networkconnectivity.v1beta.MulticloudDataTransferSupportedService[] = [];
                stream.on('data', (response: protos.google.cloud.networkconnectivity.v1beta.MulticloudDataTransferSupportedService) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listMulticloudDataTransferSupportedServices without error', async () => {
            ...
            const responses: protos.google.cloud.networkconnectivity.v1beta.IMulticloudDataTransferSupportedService[] = [];
