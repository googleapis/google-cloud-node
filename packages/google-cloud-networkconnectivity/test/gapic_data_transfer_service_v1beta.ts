...
describe('v1beta.DataTransferServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          datatransferserviceModule.v1beta.DataTransferServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        datatransferserviceModule.v1beta.DataTransferServiceClient.port;
      assert(port);
    ...
    it('invokes getMulticloudDataTransferConfig without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getMulticloudDataTransferConfig(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networkconnectivity.v1beta.IMulticloudDataTransferConfig | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getDestination', () => {
    it('invokes getDestination without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.GetDestinationRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
    ...
    it('invokes getDestination without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDestination(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networkconnectivity.v1beta.IDestination | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getMulticloudDataTransferSupportedService without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getMulticloudDataTransferSupportedService(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networkconnectivity.v1beta.IMulticloudDataTransferSupportedService | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createMulticloudDataTransferConfig', () => {
    it('invokes createMulticloudDataTransferConfig without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.CreateMulticloudDataTransferConfigRequest',
        ['parent'],
      );
  ...
  describe('deleteMulticloudDataTransferConfig', () => {
    it('invokes deleteMulticloudDataTransferConfig without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.DeleteMulticloudDataTransferConfigRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('createDestination', () => {
    it('invokes createDestination without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.CreateDestinationRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
  ...
  describe('updateDestination', () => {
    it('invokes updateDestination without error', async () => {
      ...
      request.destination ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.UpdateDestinationRequest',
        ['destination', 'name'],
      );
    ...
    it('invokes listMulticloudDataTransferConfigsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networkconnectivity.v1beta.MulticloudDataTransferConfig,
          ) => {
    ...
    it('invokes listDestinationsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networkconnectivity.v1beta.Destination,
          ) => {
            responses.push(response);
          },
        );
  ...
  describe('listMulticloudDataTransferSupportedServices', () => {
    it('invokes listMulticloudDataTransferSupportedServices without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networkconnectivity.v1beta.ListMulticloudDataTransferSupportedServicesRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
    ...
    it('invokes listMulticloudDataTransferSupportedServicesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networkconnectivity.v1beta.MulticloudDataTransferSupportedService,
          ) => {
            responses.push(response);
          },
        );
