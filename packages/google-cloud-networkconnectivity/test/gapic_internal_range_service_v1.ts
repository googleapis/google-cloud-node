...
describe('v1.InternalRangeServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          internalrangeserviceModule.v1.InternalRangeServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          internalrangeserviceModule.v1.InternalRangeServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'networkconnectivity.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        internalrangeserviceModule.v1.InternalRangeServiceClient.port;
      assert(port);
  ...
  describe('getInternalRange', () => {
    it('invokes getInternalRange without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getInternalRange as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getInternalRange without error using callback', async () => {
      ...
      client.innerApiCalls.getInternalRange =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getInternalRange(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networkconnectivity.v1.IInternalRange | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getInternalRange with error', async () => {
      ...
      client.innerApiCalls.getInternalRange = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createInternalRange', () => {
    it('invokes createInternalRange without error', async () => {
      ...
      client.innerApiCalls.createInternalRange =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createInternalRange(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createInternalRange as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createInternalRange as SinonStub
    ...
    it('invokes createInternalRange with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createInternalRange = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkCreateInternalRangeProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateInternalRangeProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateInternalRange', () => {
    it('invokes updateInternalRange without error', async () => {
      ...
      client.innerApiCalls.updateInternalRange =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateInternalRange(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateInternalRange as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateInternalRange as SinonStub
    ...
    it('invokes updateInternalRange with call error', async () => {
      ...
      const expectedHeaderRequestParams = `internal_range.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateInternalRange = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkUpdateInternalRangeProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateInternalRangeProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteInternalRange', () => {
    it('invokes deleteInternalRange without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteInternalRange as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteInternalRange as SinonStub
    ...
    it('invokes deleteInternalRange with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteInternalRange = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('listInternalRanges', () => {
    it('invokes listInternalRanges without error', async () => {
      ...
      client.innerApiCalls.listInternalRanges =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listInternalRanges(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listInternalRanges as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listInternalRanges as SinonStub
    ...
    it('invokes listInternalRanges with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listInternalRanges = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listInternalRangesStream without error', async () => {
      ...
      client.descriptors.page.listInternalRanges.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networkconnectivity.v1.InternalRange,
          ) => {
      ...
      assert(
        (client.descriptors.page.listInternalRanges.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listInternalRanges, request),
      );
      assert(
        (client.descriptors.page.listInternalRanges.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listInternalRanges without error', async () => {
      ...
      client.descriptors.page.listInternalRanges.asyncIterate =
