...
describe('v1.CrossNetworkAutomationServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = crossnetworkautomationserviceModule.v1.CrossNetworkAutomationServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = crossnetworkautomationserviceModule.v1.CrossNetworkAutomationServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'networkconnectivity.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new crossnetworkautomationserviceModule.v1.CrossNetworkAutomationServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networkconnectivity.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new crossnetworkautomationserviceModule.v1.CrossNetworkAutomationServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'networkconnectivity.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new crossnetworkautomationserviceModule.v1.CrossNetworkAutomationServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new crossnetworkautomationserviceModule.v1.CrossNetworkAutomationServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = crossnetworkautomationserviceModule.v1.CrossNetworkAutomationServiceClient.port;
            assert(port);
    ...
    describe('getServiceConnectionMap', () => {
        it('invokes getServiceConnectionMap without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1.GetServiceConnectionMapRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.networkconnectivity.v1.ServiceConnectionMap()
            );
            client.innerApiCalls.getServiceConnectionMap = stubSimpleCall(expectedResponse);
            const [response] = await client.getServiceConnectionMap(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getServiceConnectionMap as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getServiceConnectionMap as SinonStub)
        ...
        it('invokes getServiceConnectionMap without error using callback', async () => {
            ...
            client.innerApiCalls.getServiceConnectionMap = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getServiceConnectionMap(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networkconnectivity.v1.IServiceConnectionMap|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getServiceConnectionMap with error', async () => {
            ...
            client.innerApiCalls.getServiceConnectionMap = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getServiceConnectionMap(request), expectedError);
            const actualRequest = (client.innerApiCalls.getServiceConnectionMap as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getServiceConnectionMap as SinonStub)
    ...
    describe('getServiceConnectionPolicy', () => {
        it('invokes getServiceConnectionPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1.GetServiceConnectionPolicyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.networkconnectivity.v1.ServiceConnectionPolicy()
            );
            client.innerApiCalls.getServiceConnectionPolicy = stubSimpleCall(expectedResponse);
            const [response] = await client.getServiceConnectionPolicy(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getServiceConnectionPolicy as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getServiceConnectionPolicy as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getServiceConnectionPolicy without error using callback', async () => {
            ...
            client.innerApiCalls.getServiceConnectionPolicy = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getServiceConnectionPolicy(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networkconnectivity.v1.IServiceConnectionPolicy|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getServiceConnectionPolicy with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getServiceConnectionPolicy = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getServiceConnectionPolicy(request), expectedError);
            const actualRequest = (client.innerApiCalls.getServiceConnectionPolicy as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getServiceConnectionPolicy as SinonStub)
    ...
    describe('getServiceClass', () => {
        it('invokes getServiceClass without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1.GetServiceClassRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getServiceClass as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getServiceClass as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getServiceClass without error using callback', async () => {
            ...
            client.innerApiCalls.getServiceClass = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getServiceClass(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networkconnectivity.v1.IServiceClass|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getServiceClass with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getServiceClass = stubSimpleCall(undefined, expectedError);
    ...
    describe('getServiceConnectionToken', () => {
        it('invokes getServiceConnectionToken without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1.GetServiceConnectionTokenRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.networkconnectivity.v1.ServiceConnectionToken()
            );
            client.innerApiCalls.getServiceConnectionToken = stubSimpleCall(expectedResponse);
            const [response] = await client.getServiceConnectionToken(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getServiceConnectionToken as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getServiceConnectionToken as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getServiceConnectionToken without error using callback', async () => {
            ...
            client.innerApiCalls.getServiceConnectionToken = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getServiceConnectionToken(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networkconnectivity.v1.IServiceConnectionToken|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getServiceConnectionToken with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getServiceConnectionToken = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getServiceConnectionToken(request), expectedError);
            const actualRequest = (client.innerApiCalls.getServiceConnectionToken as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getServiceConnectionToken as SinonStub)
    ...
    describe('createServiceConnectionMap', () => {
        it('invokes createServiceConnectionMap without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1.CreateServiceConnectionMapRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createServiceConnectionMap = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createServiceConnectionMap(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createServiceConnectionMap as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createServiceConnectionMap as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createServiceConnectionMap without error using callback', async () => {
            ...
            client.innerApiCalls.createServiceConnectionMap = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createServiceConnectionMap(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networkconnectivity.v1.IServiceConnectionMap, protos.google.cloud.networkconnectivity.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networkconnectivity.v1.IServiceConnectionMap, protos.google.cloud.networkconnectivity.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createServiceConnectionMap as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createServiceConnectionMap with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createServiceConnectionMap = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createServiceConnectionMap(request), expectedError);
            const actualRequest = (client.innerApiCalls.createServiceConnectionMap as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createServiceConnectionMap as SinonStub)
        ...
        it('invokes createServiceConnectionMap with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createServiceConnectionMap = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createServiceConnectionMap(request);
        ...
        it('invokes checkCreateServiceConnectionMapProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateServiceConnectionMapProgress(expectedResponse.name);
        ...
        it('invokes checkCreateServiceConnectionMapProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreateServiceConnectionMapProgress(''), expectedError);
    ...
    describe('updateServiceConnectionMap', () => {
        it('invokes updateServiceConnectionMap without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1.UpdateServiceConnectionMapRequest', ['serviceConnectionMap', 'name']);
            ...
            client.innerApiCalls.updateServiceConnectionMap = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateServiceConnectionMap(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateServiceConnectionMap as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateServiceConnectionMap as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateServiceConnectionMap without error using callback', async () => {
            ...
            client.innerApiCalls.updateServiceConnectionMap = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateServiceConnectionMap with call error', async () => {
            ...
            const expectedHeaderRequestParams = `service_connection_map.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateServiceConnectionMap = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.updateServiceConnectionMap(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateServiceConnectionMap as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateServiceConnectionMap as SinonStub)
        ...
        it('invokes updateServiceConnectionMap with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `service_connection_map.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateServiceConnectionMap = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateServiceConnectionMap(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateServiceConnectionMap as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateServiceConnectionMapProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateServiceConnectionMapProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateServiceConnectionMapProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateServiceConnectionMapProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteServiceConnectionMap', () => {
        it('invokes deleteServiceConnectionMap without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1.DeleteServiceConnectionMapRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteServiceConnectionMap = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteServiceConnectionMap(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteServiceConnectionMap as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteServiceConnectionMap as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteServiceConnectionMap without error using callback', async () => {
            ...
            client.innerApiCalls.deleteServiceConnectionMap = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteServiceConnectionMap with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteServiceConnectionMap = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteServiceConnectionMap(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteServiceConnectionMap as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteServiceConnectionMap as SinonStub)
        ...
        it('invokes deleteServiceConnectionMap with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteServiceConnectionMap = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteServiceConnectionMap(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteServiceConnectionMap as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteServiceConnectionMapProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteServiceConnectionMapProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteServiceConnectionMapProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteServiceConnectionMapProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('createServiceConnectionPolicy', () => {
        it('invokes createServiceConnectionPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1.CreateServiceConnectionPolicyRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createServiceConnectionPolicy = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createServiceConnectionPolicy(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createServiceConnectionPolicy as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createServiceConnectionPolicy as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createServiceConnectionPolicy without error using callback', async () => {
            ...
            client.innerApiCalls.createServiceConnectionPolicy = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createServiceConnectionPolicy(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networkconnectivity.v1.IServiceConnectionPolicy, protos.google.cloud.networkconnectivity.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networkconnectivity.v1.IServiceConnectionPolicy, protos.google.cloud.networkconnectivity.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createServiceConnectionPolicy as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createServiceConnectionPolicy with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createServiceConnectionPolicy = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createServiceConnectionPolicy(request), expectedError);
            const actualRequest = (client.innerApiCalls.createServiceConnectionPolicy as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createServiceConnectionPolicy as SinonStub)
        ...
        it('invokes createServiceConnectionPolicy with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createServiceConnectionPolicy = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createServiceConnectionPolicy(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.createServiceConnectionPolicy as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkCreateServiceConnectionPolicyProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkCreateServiceConnectionPolicyProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkCreateServiceConnectionPolicyProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkCreateServiceConnectionPolicyProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('updateServiceConnectionPolicy', () => {
        it('invokes updateServiceConnectionPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1.UpdateServiceConnectionPolicyRequest', ['serviceConnectionPolicy', 'name']);
            ...
            client.innerApiCalls.updateServiceConnectionPolicy = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateServiceConnectionPolicy(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateServiceConnectionPolicy as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateServiceConnectionPolicy as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateServiceConnectionPolicy without error using callback', async () => {
            ...
            client.innerApiCalls.updateServiceConnectionPolicy = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateServiceConnectionPolicy with call error', async () => {
            ...
            const expectedHeaderRequestParams = `service_connection_policy.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateServiceConnectionPolicy = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.updateServiceConnectionPolicy(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateServiceConnectionPolicy as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateServiceConnectionPolicy as SinonStub)
        ...
        it('invokes updateServiceConnectionPolicy with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `service_connection_policy.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateServiceConnectionPolicy = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateServiceConnectionPolicy(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateServiceConnectionPolicy as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateServiceConnectionPolicyProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateServiceConnectionPolicyProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateServiceConnectionPolicyProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateServiceConnectionPolicyProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteServiceConnectionPolicy', () => {
        it('invokes deleteServiceConnectionPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1.DeleteServiceConnectionPolicyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteServiceConnectionPolicy = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteServiceConnectionPolicy(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteServiceConnectionPolicy as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteServiceConnectionPolicy as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteServiceConnectionPolicy without error using callback', async () => {
            ...
            client.innerApiCalls.deleteServiceConnectionPolicy = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteServiceConnectionPolicy with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteServiceConnectionPolicy = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteServiceConnectionPolicy(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteServiceConnectionPolicy as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteServiceConnectionPolicy as SinonStub)
        ...
        it('invokes deleteServiceConnectionPolicy with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteServiceConnectionPolicy = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteServiceConnectionPolicy(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteServiceConnectionPolicy as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteServiceConnectionPolicyProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteServiceConnectionPolicyProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteServiceConnectionPolicyProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteServiceConnectionPolicyProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('updateServiceClass', () => {
        it('invokes updateServiceClass without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1.UpdateServiceClassRequest', ['serviceClass', 'name']);
            request.serviceClass.name = defaultValue1;
            const expectedHeaderRequestParams = `service_class.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updateServiceClass = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateServiceClass(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateServiceClass as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateServiceClass as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateServiceClass without error using callback', async () => {
            ...
            client.innerApiCalls.updateServiceClass = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateServiceClass(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networkconnectivity.v1.IServiceClass, protos.google.cloud.networkconnectivity.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networkconnectivity.v1.IServiceClass, protos.google.cloud.networkconnectivity.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateServiceClass as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes updateServiceClass with call error', async () => {
            ...
            const expectedHeaderRequestParams = `service_class.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateServiceClass = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes updateServiceClass with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `service_class.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateServiceClass = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateServiceClass(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateServiceClass as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateServiceClassProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateServiceClassProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateServiceClassProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateServiceClassProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteServiceClass', () => {
        it('invokes deleteServiceClass without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1.DeleteServiceClassRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteServiceClass = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteServiceClass(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteServiceClass as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteServiceClass as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteServiceClass without error using callback', async () => {
            ...
            client.innerApiCalls.deleteServiceClass = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteServiceClass with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteServiceClass = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes deleteServiceClass with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteServiceClass = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteServiceClass(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteServiceClass as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteServiceClassProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteServiceClassProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteServiceClassProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteServiceClassProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('createServiceConnectionToken', () => {
        it('invokes createServiceConnectionToken without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1.CreateServiceConnectionTokenRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createServiceConnectionToken = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createServiceConnectionToken(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createServiceConnectionToken as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createServiceConnectionToken as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createServiceConnectionToken without error using callback', async () => {
            ...
            client.innerApiCalls.createServiceConnectionToken = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createServiceConnectionToken(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networkconnectivity.v1.IServiceConnectionToken, protos.google.cloud.networkconnectivity.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networkconnectivity.v1.IServiceConnectionToken, protos.google.cloud.networkconnectivity.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createServiceConnectionToken as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createServiceConnectionToken with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createServiceConnectionToken = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createServiceConnectionToken(request), expectedError);
            const actualRequest = (client.innerApiCalls.createServiceConnectionToken as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createServiceConnectionToken as SinonStub)
        ...
        it('invokes createServiceConnectionToken with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createServiceConnectionToken = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createServiceConnectionToken(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.createServiceConnectionToken as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkCreateServiceConnectionTokenProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkCreateServiceConnectionTokenProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkCreateServiceConnectionTokenProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkCreateServiceConnectionTokenProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteServiceConnectionToken', () => {
        it('invokes deleteServiceConnectionToken without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1.DeleteServiceConnectionTokenRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteServiceConnectionToken = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteServiceConnectionToken(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteServiceConnectionToken as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteServiceConnectionToken as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteServiceConnectionToken without error using callback', async () => {
            ...
            client.innerApiCalls.deleteServiceConnectionToken = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteServiceConnectionToken with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteServiceConnectionToken = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteServiceConnectionToken(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteServiceConnectionToken as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteServiceConnectionToken as SinonStub)
        ...
        it('invokes deleteServiceConnectionToken with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteServiceConnectionToken = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteServiceConnectionToken(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteServiceConnectionToken as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteServiceConnectionTokenProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteServiceConnectionTokenProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteServiceConnectionTokenProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteServiceConnectionTokenProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listServiceConnectionMaps', () => {
        it('invokes listServiceConnectionMaps without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1.ListServiceConnectionMapsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.ServiceConnectionMap()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.ServiceConnectionMap()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.ServiceConnectionMap()),
            ];
            client.innerApiCalls.listServiceConnectionMaps = stubSimpleCall(expectedResponse);
            const [response] = await client.listServiceConnectionMaps(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listServiceConnectionMaps as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listServiceConnectionMaps as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listServiceConnectionMaps without error using callback', async () => {
            ...
            client.innerApiCalls.listServiceConnectionMaps = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listServiceConnectionMaps with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listServiceConnectionMaps = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listServiceConnectionMaps(request), expectedError);
            const actualRequest = (client.innerApiCalls.listServiceConnectionMaps as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listServiceConnectionMaps as SinonStub)
        ...
        it('invokes listServiceConnectionMapsStream without error', async () => {
            ...
            client.descriptors.page.listServiceConnectionMaps.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networkconnectivity.v1.ServiceConnectionMap) => {
            ...
            assert((client.descriptors.page.listServiceConnectionMaps.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listServiceConnectionMaps, request));
            assert(
                (client.descriptors.page.listServiceConnectionMaps.createStream as SinonStub)
        ...
        it('invokes listServiceConnectionMapsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listServiceConnectionMaps.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listServiceConnectionMapsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.networkconnectivity.v1.ServiceConnectionMap[] = [];
                stream.on('data', (response: protos.google.cloud.networkconnectivity.v1.ServiceConnectionMap) => {
        ...
        it('uses async iteration with listServiceConnectionMaps without error', async () => {
            ...
            client.descriptors.page.listServiceConnectionMaps.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(
                (client.descriptors.page.listServiceConnectionMaps.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listServiceConnectionMaps with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listServiceConnectionMaps.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listServiceConnectionMapsAsync(request);
    ...
    describe('listServiceConnectionPolicies', () => {
        it('invokes listServiceConnectionPolicies without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1.ListServiceConnectionPoliciesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.ServiceConnectionPolicy()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.ServiceConnectionPolicy()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.ServiceConnectionPolicy()),
            ];
            client.innerApiCalls.listServiceConnectionPolicies = stubSimpleCall(expectedResponse);
            const [response] = await client.listServiceConnectionPolicies(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listServiceConnectionPolicies as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listServiceConnectionPolicies as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listServiceConnectionPolicies without error using callback', async () => {
            ...
            client.innerApiCalls.listServiceConnectionPolicies = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listServiceConnectionPolicies with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listServiceConnectionPolicies = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listServiceConnectionPolicies(request), expectedError);
            const actualRequest = (client.innerApiCalls.listServiceConnectionPolicies as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listServiceConnectionPolicies as SinonStub)
        ...
        it('invokes listServiceConnectionPoliciesStream without error', async () => {
            ...
            client.descriptors.page.listServiceConnectionPolicies.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networkconnectivity.v1.ServiceConnectionPolicy) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listServiceConnectionPolicies.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listServiceConnectionPolicies, request));
            assert(
                (client.descriptors.page.listServiceConnectionPolicies.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listServiceConnectionPoliciesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listServiceConnectionPolicies.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listServiceConnectionPoliciesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.networkconnectivity.v1.ServiceConnectionPolicy[] = [];
                stream.on('data', (response: protos.google.cloud.networkconnectivity.v1.ServiceConnectionPolicy) => {
        ...
        it('uses async iteration with listServiceConnectionPolicies without error', async () => {
            ...
            client.descriptors.page.listServiceConnectionPolicies.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listServiceConnectionPolicies.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listServiceConnectionPolicies.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listServiceConnectionPolicies with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listServiceConnectionPolicies.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listServiceConnectionPoliciesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.networkconnectivity.v1.IServiceConnectionPolicy[] = [];
                for await (const resource of iterable) {
    ...
    describe('listServiceClasses', () => {
        it('invokes listServiceClasses without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1.ListServiceClassesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.ServiceClass()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.ServiceClass()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.ServiceClass()),
            ];
            client.innerApiCalls.listServiceClasses = stubSimpleCall(expectedResponse);
            const [response] = await client.listServiceClasses(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listServiceClasses as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listServiceClasses as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listServiceClasses without error using callback', async () => {
            ...
            client.innerApiCalls.listServiceClasses = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listServiceClasses with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listServiceClasses = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listServiceClassesStream without error', async () => {
            ...
            client.descriptors.page.listServiceClasses.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networkconnectivity.v1.ServiceClass) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listServiceClasses.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listServiceClasses, request));
            assert(
        ...
        it('invokes listServiceClassesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listServiceClasses.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listServiceClassesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.networkconnectivity.v1.ServiceClass[] = [];
                stream.on('data', (response: protos.google.cloud.networkconnectivity.v1.ServiceClass) => {
        ...
        it('uses async iteration with listServiceClasses without error', async () => {
            ...
            client.descriptors.page.listServiceClasses.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listServiceClasses with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listServiceClasses.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listServiceClassesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.networkconnectivity.v1.IServiceClass[] = [];
                for await (const resource of iterable) {
    ...
    describe('listServiceConnectionTokens', () => {
        it('invokes listServiceConnectionTokens without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.networkconnectivity.v1.ListServiceConnectionTokensRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.ServiceConnectionToken()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.ServiceConnectionToken()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.ServiceConnectionToken()),
            ];
            client.innerApiCalls.listServiceConnectionTokens = stubSimpleCall(expectedResponse);
            const [response] = await client.listServiceConnectionTokens(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listServiceConnectionTokens as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listServiceConnectionTokens as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listServiceConnectionTokens without error using callback', async () => {
            ...
            client.innerApiCalls.listServiceConnectionTokens = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listServiceConnectionTokens with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listServiceConnectionTokens = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listServiceConnectionTokens(request), expectedError);
            const actualRequest = (client.innerApiCalls.listServiceConnectionTokens as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listServiceConnectionTokens as SinonStub)
        ...
        it('invokes listServiceConnectionTokensStream without error', async () => {
            ...
            client.descriptors.page.listServiceConnectionTokens.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networkconnectivity.v1.ServiceConnectionToken) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listServiceConnectionTokens.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listServiceConnectionTokens, request));
            assert(
                (client.descriptors.page.listServiceConnectionTokens.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listServiceConnectionTokensStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listServiceConnectionTokens.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listServiceConnectionTokensStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.networkconnectivity.v1.ServiceConnectionToken[] = [];
                stream.on('data', (response: protos.google.cloud.networkconnectivity.v1.ServiceConnectionToken) => {
        ...
        it('uses async iteration with listServiceConnectionTokens without error', async () => {
            ...
            client.descriptors.page.listServiceConnectionTokens.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listServiceConnectionTokens.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listServiceConnectionTokens.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listServiceConnectionTokens with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listServiceConnectionTokens.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listServiceConnectionTokensAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.networkconnectivity.v1.IServiceConnectionToken[] = [];
                for await (const resource of iterable) {
