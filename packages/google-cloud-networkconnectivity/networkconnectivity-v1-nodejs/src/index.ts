...
export {v1, CrossNetworkAutomationServiceClient, DataTransferServiceClient, HubServiceClient, InternalRangeServiceClient, PolicyBasedRoutingServiceClient};
export default {v1, CrossNetworkAutomationServiceClient, DataTransferServiceClient, HubServiceClient, InternalRangeServiceClient, PolicyBasedRoutingServiceClient};
