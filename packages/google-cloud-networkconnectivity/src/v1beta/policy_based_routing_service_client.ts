...
export class PolicyBasedRoutingServiceClient {
  ...
  constructor(
    ...
    const createPolicyBasedRouteResponse = protoFilesRoot.lookup(
      '.google.cloud.networkconnectivity.v1beta.PolicyBasedRoute',
  ...
  getPolicyBasedRoute(
    ...
    [
      ...
      (
        | protos.google.cloud.networkconnectivity.v1beta.IGetPolicyBasedRouteRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  async checkCreatePolicyBasedRouteProgress(
    ...
    LROperation<
      protos.google.cloud.networkconnectivity.v1beta.PolicyBasedRoute,
