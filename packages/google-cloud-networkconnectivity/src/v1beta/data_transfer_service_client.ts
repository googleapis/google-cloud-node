 ...
 * `src/v1beta/data_transfer_service_client_config.json`.
...
export class DataTransferServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const createMulticloudDataTransferConfigResponse = protoFilesRoot.lookup(
      '.google.cloud.networkconnectivity.v1beta.MulticloudDataTransferConfig') as gax.protobuf.Type;
    ...
    const createDestinationResponse = protoFilesRoot.lookup(
      '.google.cloud.networkconnectivity.v1beta.Destination') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.networkconnectivity.v1beta.DataTransferService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.dataTransferServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.networkconnectivity.v1beta.DataTransferService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.networkconnectivity.v1beta.DataTransferService,
 ...
 *   The first element of the array is an object representing {@link protos.google.cloud.networkconnectivity.v1beta.MulticloudDataTransferConfig|MulticloudDataTransferConfig}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta/data_transfer_service.get_multicloud_data_transfer_config.js</caption>
 * region_tag:networkconnectivity_v1beta_generated_DataTransferService_GetMulticloudDataTransferConfig_async
 */
  getMulticloudDataTransferConfig(
      request?: protos.google.cloud.networkconnectivity.v1beta.IGetMulticloudDataTransferConfigRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.networkconnectivity.v1beta.IMulticloudDataTransferConfig,
        protos.google.cloud.networkconnectivity.v1beta.IGetMulticloudDataTransferConfigRequest|undefined, {}|undefined
      ]>;
  getMulticloudDataTransferConfig(
      request: protos.google.cloud.networkconnectivity.v1beta.IGetMulticloudDataTransferConfigRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.networkconnectivity.v1beta.IMulticloudDataTransferConfig,
          protos.google.cloud.networkconnectivity.v1beta.IGetMulticloudDataTransferConfigRequest|null|undefined,
          {}|null|undefined>): void;
  getMulticloudDataTransferConfig(
      request: protos.google.cloud.networkconnectivity.v1beta.IGetMulticloudDataTransferConfigRequest,
      callback: Callback<
  ...
  getMulticloudDataTransferConfig(
    ...
    return this.innerApiCalls.getMulticloudDataTransferConfig(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.networkconnectivity.v1beta.IMulticloudDataTransferConfig,
        protos.google.cloud.networkconnectivity.v1beta.IGetMulticloudDataTransferConfigRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getMulticloudDataTransferConfig response %j', response);
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.cloud.networkconnectivity.v1beta.Destination|Destination}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta/data_transfer_service.get_destination.js</caption>
 * region_tag:networkconnectivity_v1beta_generated_DataTransferService_GetDestination_async
 */
  getDestination(
      request?: protos.google.cloud.networkconnectivity.v1beta.IGetDestinationRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.networkconnectivity.v1beta.IDestination,
        protos.google.cloud.networkconnectivity.v1beta.IGetDestinationRequest|undefined, {}|undefined
      ]>;
  getDestination(
      request: protos.google.cloud.networkconnectivity.v1beta.IGetDestinationRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.networkconnectivity.v1beta.IDestination,
          protos.google.cloud.networkconnectivity.v1beta.IGetDestinationRequest|null|undefined,
          {}|null|undefined>): void;
  getDestination(
      request: protos.google.cloud.networkconnectivity.v1beta.IGetDestinationRequest,
      callback: Callback<
  ...
  getDestination(
    ...
    return this.innerApiCalls.getDestination(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.networkconnectivity.v1beta.IDestination,
        protos.google.cloud.networkconnectivity.v1beta.IGetDestinationRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getDestination response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.cloud.networkconnectivity.v1beta.MulticloudDataTransferSupportedService|MulticloudDataTransferSupportedService}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta/data_transfer_service.get_multicloud_data_transfer_supported_service.js</caption>
 * region_tag:networkconnectivity_v1beta_generated_DataTransferService_GetMulticloudDataTransferSupportedService_async
 */
  getMulticloudDataTransferSupportedService(
      ...
      options?: CallOptions):
      Promise<[
        protos.google.cloud.networkconnectivity.v1beta.IMulticloudDataTransferSupportedService,
        protos.google.cloud.networkconnectivity.v1beta.IGetMulticloudDataTransferSupportedServiceRequest|undefined, {}|undefined
      ]>;
  getMulticloudDataTransferSupportedService(
      request: protos.google.cloud.networkconnectivity.v1beta.IGetMulticloudDataTransferSupportedServiceRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.networkconnectivity.v1beta.IMulticloudDataTransferSupportedService,
          protos.google.cloud.networkconnectivity.v1beta.IGetMulticloudDataTransferSupportedServiceRequest|null|undefined,
          {}|null|undefined>): void;
  getMulticloudDataTransferSupportedService(
      request: protos.google.cloud.networkconnectivity.v1beta.IGetMulticloudDataTransferSupportedServiceRequest,
      callback: Callback<
  ...
  getMulticloudDataTransferSupportedService(
    ...
    return this.innerApiCalls.getMulticloudDataTransferSupportedService(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.networkconnectivity.v1beta.IMulticloudDataTransferSupportedService,
        protos.google.cloud.networkconnectivity.v1beta.IGetMulticloudDataTransferSupportedServiceRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getMulticloudDataTransferSupportedService response %j', response);
        return [response, options, rawResponse];
 ...
 *   resource name.
 * @param {google.cloud.networkconnectivity.v1beta.MulticloudDataTransferConfig} request.multicloudDataTransferConfig
 ...
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta/data_transfer_service.create_multicloud_data_transfer_config.js</caption>
 * region_tag:networkconnectivity_v1beta_generated_DataTransferService_CreateMulticloudDataTransferConfig_async
 */
  createMulticloudDataTransferConfig(
      request?: protos.google.cloud.networkconnectivity.v1beta.ICreateMulticloudDataTransferConfigRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.networkconnectivity.v1beta.IMulticloudDataTransferConfig, protos.google.cloud.networkconnectivity.v1beta.IOperationMetadata>,
 ...
 * region_tag:networkconnectivity_v1beta_generated_DataTransferService_CreateMulticloudDataTransferConfig_async
 */
  async checkCreateMulticloudDataTransferConfigProgress(name: string): Promise<LROperation<protos.google.cloud.networkconnectivity.v1beta.MulticloudDataTransferConfig, protos.google.cloud.networkconnectivity.v1beta.OperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.networkconnectivity.v1beta.MulticloudDataTransferConfig, protos.google.cloud.networkconnectivity.v1beta.OperationMetadata>;
  }
/**
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta/data_transfer_service.update_multicloud_data_transfer_config.js</caption>
 * region_tag:networkconnectivity_v1beta_generated_DataTransferService_UpdateMulticloudDataTransferConfig_async
 */
  updateMulticloudDataTransferConfig(
      request?: protos.google.cloud.networkconnectivity.v1beta.IUpdateMulticloudDataTransferConfigRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.networkconnectivity.v1beta.IMulticloudDataTransferConfig, protos.google.cloud.networkconnectivity.v1beta.IOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
 ...
 * region_tag:networkconnectivity_v1beta_generated_DataTransferService_UpdateMulticloudDataTransferConfig_async
 */
  async checkUpdateMulticloudDataTransferConfigProgress(name: string): Promise<LROperation<protos.google.cloud.networkconnectivity.v1beta.MulticloudDataTransferConfig, protos.google.cloud.networkconnectivity.v1beta.OperationMetadata>>{
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta/data_transfer_service.delete_multicloud_data_transfer_config.js</caption>
 * region_tag:networkconnectivity_v1beta_generated_DataTransferService_DeleteMulticloudDataTransferConfig_async
 */
  deleteMulticloudDataTransferConfig(
      request?: protos.google.cloud.networkconnectivity.v1beta.IDeleteMulticloudDataTransferConfigRequest,
      options?: CallOptions):
      Promise<[
 ...
 * region_tag:networkconnectivity_v1beta_generated_DataTransferService_DeleteMulticloudDataTransferConfig_async
 */
  async checkDeleteMulticloudDataTransferConfigProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.networkconnectivity.v1beta.OperationMetadata>>{
 ...
 * @param {google.cloud.networkconnectivity.v1beta.Destination} request.destination
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta/data_transfer_service.create_destination.js</caption>
 * region_tag:networkconnectivity_v1beta_generated_DataTransferService_CreateDestination_async
 */
  createDestination(
      request?: protos.google.cloud.networkconnectivity.v1beta.ICreateDestinationRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.networkconnectivity.v1beta.IDestination, protos.google.cloud.networkconnectivity.v1beta.IOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
      ]>;
  createDestination(
      request: protos.google.cloud.networkconnectivity.v1beta.ICreateDestinationRequest,
 ...
 * region_tag:networkconnectivity_v1beta_generated_DataTransferService_CreateDestination_async
 */
  async checkCreateDestinationProgress(name: string): Promise<LROperation<protos.google.cloud.networkconnectivity.v1beta.Destination, protos.google.cloud.networkconnectivity.v1beta.OperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.networkconnectivity.v1beta.Destination, protos.google.cloud.networkconnectivity.v1beta.OperationMetadata>;
  }
/**
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta/data_transfer_service.update_destination.js</caption>
 * region_tag:networkconnectivity_v1beta_generated_DataTransferService_UpdateDestination_async
 */
  updateDestination(
      request?: protos.google.cloud.networkconnectivity.v1beta.IUpdateDestinationRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.networkconnectivity.v1beta.IDestination, protos.google.cloud.networkconnectivity.v1beta.IOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
 ...
 * region_tag:networkconnectivity_v1beta_generated_DataTransferService_UpdateDestination_async
 */
  async checkUpdateDestinationProgress(name: string): Promise<LROperation<protos.google.cloud.networkconnectivity.v1beta.Destination, protos.google.cloud.networkconnectivity.v1beta.OperationMetadata>>{
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta/data_transfer_service.delete_destination.js</caption>
 * region_tag:networkconnectivity_v1beta_generated_DataTransferService_DeleteDestination_async
 */
  deleteDestination(
      request?: protos.google.cloud.networkconnectivity.v1beta.IDeleteDestinationRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.networkconnectivity.v1beta.IOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
 ...
 * region_tag:networkconnectivity_v1beta_generated_DataTransferService_DeleteDestination_async
 */
  async checkDeleteDestinationProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.networkconnectivity.v1beta.OperationMetadata>>{
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.cloud.networkconnectivity.v1beta.MulticloudDataTransferConfig|MulticloudDataTransferConfig}.
 ...
 */
  listMulticloudDataTransferConfigs(
      request?: protos.google.cloud.networkconnectivity.v1beta.IListMulticloudDataTransferConfigsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.networkconnectivity.v1beta.IMulticloudDataTransferConfig[],
        protos.google.cloud.networkconnectivity.v1beta.IListMulticloudDataTransferConfigsRequest|null,
        protos.google.cloud.networkconnectivity.v1beta.IListMulticloudDataTransferConfigsResponse
      ]>;
  listMulticloudDataTransferConfigs(
      request: protos.google.cloud.networkconnectivity.v1beta.IListMulticloudDataTransferConfigsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.cloud.networkconnectivity.v1beta.IListMulticloudDataTransferConfigsRequest,
          protos.google.cloud.networkconnectivity.v1beta.IListMulticloudDataTransferConfigsResponse|null|undefined,
          protos.google.cloud.networkconnectivity.v1beta.IMulticloudDataTransferConfig>): void;
  listMulticloudDataTransferConfigs(
      request: protos.google.cloud.networkconnectivity.v1beta.IListMulticloudDataTransferConfigsRequest,
      callback: PaginationCallback<
          protos.google.cloud.networkconnectivity.v1beta.IListMulticloudDataTransferConfigsRequest,
  ...
  listMulticloudDataTransferConfigs(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.networkconnectivity.v1beta.IListMulticloudDataTransferConfigsRequest,
      protos.google.cloud.networkconnectivity.v1beta.IListMulticloudDataTransferConfigsResponse|null|undefined,
      protos.google.cloud.networkconnectivity.v1beta.IMulticloudDataTransferConfig>|undefined = callback
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.cloud.networkconnectivity.v1beta.MulticloudDataTransferConfig|MulticloudDataTransferConfig} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   {@link protos.google.cloud.networkconnectivity.v1beta.MulticloudDataTransferConfig|MulticloudDataTransferConfig}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta/data_transfer_service.list_multicloud_data_transfer_configs.js</caption>
 * region_tag:networkconnectivity_v1beta_generated_DataTransferService_ListMulticloudDataTransferConfigs_async
 */
  listMulticloudDataTransferConfigsAsync(
      request?: protos.google.cloud.networkconnectivity.v1beta.IListMulticloudDataTransferConfigsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.networkconnectivity.v1beta.IMulticloudDataTransferConfig>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listMulticloudDataTransferConfigs.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.networkconnectivity.v1beta.IMulticloudDataTransferConfig>;
  }
 /**
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.cloud.networkconnectivity.v1beta.Destination|Destination}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 ...
 */
  listDestinations(
      request?: protos.google.cloud.networkconnectivity.v1beta.IListDestinationsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.networkconnectivity.v1beta.IDestination[],
        protos.google.cloud.networkconnectivity.v1beta.IListDestinationsRequest|null,
        protos.google.cloud.networkconnectivity.v1beta.IListDestinationsResponse
      ]>;
  listDestinations(
      request: protos.google.cloud.networkconnectivity.v1beta.IListDestinationsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.cloud.networkconnectivity.v1beta.IListDestinationsRequest,
          protos.google.cloud.networkconnectivity.v1beta.IListDestinationsResponse|null|undefined,
          protos.google.cloud.networkconnectivity.v1beta.IDestination>): void;
  listDestinations(
      request: protos.google.cloud.networkconnectivity.v1beta.IListDestinationsRequest,
      callback: PaginationCallback<
          protos.google.cloud.networkconnectivity.v1beta.IListDestinationsRequest,
  ...
  listDestinations(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.networkconnectivity.v1beta.IListDestinationsRequest,
      protos.google.cloud.networkconnectivity.v1beta.IListDestinationsResponse|null|undefined,
      protos.google.cloud.networkconnectivity.v1beta.IDestination>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.cloud.networkconnectivity.v1beta.Destination|Destination} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed. Note that it can affect your quota.
 *   We recommend using `listDestinationsAsync()`
 *   method described below for async iteration which you can stop as needed.
 ...
 *   An iterable Object that allows {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols | async iteration }.
 *   When you iterate the returned iterable, each element will be an object representing
 *   {@link protos.google.cloud.networkconnectivity.v1beta.Destination|Destination}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta/data_transfer_service.list_destinations.js</caption>
 * region_tag:networkconnectivity_v1beta_generated_DataTransferService_ListDestinations_async
 */
  listDestinationsAsync(
      request?: protos.google.cloud.networkconnectivity.v1beta.IListDestinationsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.networkconnectivity.v1beta.IDestination>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listDestinations.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.networkconnectivity.v1beta.IDestination>;
  }
 /**
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.cloud.networkconnectivity.v1beta.MulticloudDataTransferSupportedService|MulticloudDataTransferSupportedService}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 ...
 */
  listMulticloudDataTransferSupportedServices(
      ...
      Promise<[
        protos.google.cloud.networkconnectivity.v1beta.IMulticloudDataTransferSupportedService[],
        protos.google.cloud.networkconnectivity.v1beta.IListMulticloudDataTransferSupportedServicesRequest|null,
        protos.google.cloud.networkconnectivity.v1beta.IListMulticloudDataTransferSupportedServicesResponse
      ]>;
  listMulticloudDataTransferSupportedServices(
      request: protos.google.cloud.networkconnectivity.v1beta.IListMulticloudDataTransferSupportedServicesRequest,
      options: CallOptions,
      callback: PaginationCallback<
          ...
          protos.google.cloud.networkconnectivity.v1beta.IListMulticloudDataTransferSupportedServicesResponse|null|undefined,
          protos.google.cloud.networkconnectivity.v1beta.IMulticloudDataTransferSupportedService>): void;
  listMulticloudDataTransferSupportedServices(
      request: protos.google.cloud.networkconnectivity.v1beta.IListMulticloudDataTransferSupportedServicesRequest,
      callback: PaginationCallback<
          protos.google.cloud.networkconnectivity.v1beta.IListMulticloudDataTransferSupportedServicesRequest,
  ...
  listMulticloudDataTransferSupportedServices(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.networkconnectivity.v1beta.IListMulticloudDataTransferSupportedServicesRequest,
      protos.google.cloud.networkconnectivity.v1beta.IListMulticloudDataTransferSupportedServicesResponse|null|undefined,
      protos.google.cloud.networkconnectivity.v1beta.IMulticloudDataTransferSupportedService>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.cloud.networkconnectivity.v1beta.MulticloudDataTransferSupportedService|MulticloudDataTransferSupportedService} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed. Note that it can affect your quota.
 *   We recommend using `listMulticloudDataTransferSupportedServicesAsync()`
 *   method described below for async iteration which you can stop as needed.
 ...
 *   An iterable Object that allows {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols | async iteration }.
 *   When you iterate the returned iterable, each element will be an object representing
 *   {@link protos.google.cloud.networkconnectivity.v1beta.MulticloudDataTransferSupportedService|MulticloudDataTransferSupportedService}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta/data_transfer_service.list_multicloud_data_transfer_supported_services.js</caption>
 * region_tag:networkconnectivity_v1beta_generated_DataTransferService_ListMulticloudDataTransferSupportedServices_async
 */
  listMulticloudDataTransferSupportedServicesAsync(
      request?: protos.google.cloud.networkconnectivity.v1beta.IListMulticloudDataTransferSupportedServicesRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.networkconnectivity.v1beta.IMulticloudDataTransferSupportedService>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listMulticloudDataTransferSupportedServices.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.networkconnectivity.v1beta.IMulticloudDataTransferSupportedService>;
  }
/**
