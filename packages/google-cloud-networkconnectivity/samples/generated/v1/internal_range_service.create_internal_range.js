...
function main(parent, internalRange) {
  ...
  async function callCreateInternalRange() {
    // Construct request
    const request = {
      parent,
      internalRange,
    ...
    // Run request
    const [operation] = await networkconnectivityClient.createInternalRange(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callCreateInternalRange();
