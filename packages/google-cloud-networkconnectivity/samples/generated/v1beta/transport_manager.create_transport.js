...
function main(parent, transportId, transport) {
  ...
  async function callCreateTransport() {
    // Construct request
    const request = {
      parent,
      transportId,
    ...
    // Run request
    const [operation] = await networkconnectivityClient.createTransport(request);
