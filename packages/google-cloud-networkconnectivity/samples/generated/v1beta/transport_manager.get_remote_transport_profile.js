...
function main(name) {
  ...
  async function callGetRemoteTransportProfile() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await networkconnectivityClient.getRemoteTransportProfile(request);
    console.log(response);
  }

  callGetRemoteTransportProfile();
