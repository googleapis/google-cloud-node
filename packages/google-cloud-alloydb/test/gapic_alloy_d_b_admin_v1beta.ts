...
describe('v1beta.AlloyDBAdminClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = alloydbadminModule.v1beta.AlloyDBAdminClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = alloydbadminModule.v1beta.AlloyDBAdminClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'alloydb.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new alloydbadminModule.v1beta.AlloyDBAdminClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'alloydb.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new alloydbadminModule.v1beta.AlloyDBAdminClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'alloydb.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new alloydbadminModule.v1beta.AlloyDBAdminClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new alloydbadminModule.v1beta.AlloyDBAdminClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = alloydbadminModule.v1beta.AlloyDBAdminClient.port;
            assert(port);
    ...
    describe('getCluster', () => {
        it('invokes getCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.GetClusterRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.alloydb.v1beta.Cluster()
            );
        ...
        it('invokes getCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCluster(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.alloydb.v1beta.ICluster|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getInstance', () => {
        it('invokes getInstance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.GetInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.alloydb.v1beta.Instance()
            );
        ...
        it('invokes getInstance without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getInstance(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.alloydb.v1beta.IInstance|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('executeSql', () => {
        it('invokes executeSql without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.ExecuteSqlRequest', ['instance']);
            request.instance = defaultValue1;
            const expectedHeaderRequestParams = `instance=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.alloydb.v1beta.ExecuteSqlResponse()
            );
        ...
        it('invokes executeSql without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.executeSql(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.alloydb.v1beta.IExecuteSqlResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getBackup', () => {
        it('invokes getBackup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.GetBackupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.alloydb.v1beta.Backup()
            );
        ...
        it('invokes getBackup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getBackup(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.alloydb.v1beta.IBackup|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateClientCertificate', () => {
        it('invokes generateClientCertificate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.GenerateClientCertificateRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.alloydb.v1beta.GenerateClientCertificateResponse()
            );
        ...
        it('invokes generateClientCertificate without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateClientCertificate(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.alloydb.v1beta.IGenerateClientCertificateResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getConnectionInfo', () => {
        it('invokes getConnectionInfo without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.GetConnectionInfoRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.alloydb.v1beta.ConnectionInfo()
            );
        ...
        it('invokes getConnectionInfo without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getConnectionInfo(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.alloydb.v1beta.IConnectionInfo|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getUser', () => {
        it('invokes getUser without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.GetUserRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.alloydb.v1beta.User()
            );
        ...
        it('invokes getUser without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getUser(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.alloydb.v1beta.IUser|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createUser', () => {
        it('invokes createUser without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.CreateUserRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.alloydb.v1beta.User()
    ...
    describe('updateUser', () => {
        it('invokes updateUser without error', async () => {
            ...
            request.user ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.UpdateUserRequest', ['user', 'name']);
    ...
    describe('deleteUser', () => {
        it('invokes deleteUser without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.DeleteUserRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createDatabase', () => {
        it('invokes createDatabase without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.alloydb.v1beta.CreateDatabaseRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.CreateDatabaseRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.alloydb.v1beta.Database()
            );
            client.innerApiCalls.createDatabase = stubSimpleCall(expectedResponse);
            const [response] = await client.createDatabase(request);
            assert.deepStrictEqual(response, expectedResponse);
        ...
        it('invokes createDatabase without error using callback', async () => {
            ...
            client.innerApiCalls.createDatabase = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createDatabase(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.alloydb.v1beta.IDatabase|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createDatabase with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createDatabase = stubSimpleCall(undefined, expectedError);
    ...
    describe('createCluster', () => {
        it('invokes createCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.CreateClusterRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes createCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createCluster(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.alloydb.v1beta.ICluster, protos.google.cloud.alloydb.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.alloydb.v1beta.ICluster, protos.google.cloud.alloydb.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createCluster as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateCluster', () => {
        it('invokes updateCluster without error', async () => {
            ...
            request.cluster ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.UpdateClusterRequest', ['cluster', 'name']);
    ...
    describe('exportCluster', () => {
        it('invokes exportCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.ExportClusterRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes exportCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.exportCluster(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.alloydb.v1beta.IExportClusterResponse, protos.google.cloud.alloydb.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.alloydb.v1beta.IExportClusterResponse, protos.google.cloud.alloydb.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportCluster as SinonStub)
                .getCall(0).args[0];
    ...
    describe('importCluster', () => {
        it('invokes importCluster without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.alloydb.v1beta.ImportClusterRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.ImportClusterRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes importCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.importCluster(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.alloydb.v1beta.IImportClusterResponse, protos.google.cloud.alloydb.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.alloydb.v1beta.IImportClusterResponse, protos.google.cloud.alloydb.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importCluster as SinonStub)
                .getCall(0).args[0];
    ...
    describe('upgradeCluster', () => {
        it('invokes upgradeCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.UpgradeClusterRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes upgradeCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.upgradeCluster(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.alloydb.v1beta.IUpgradeClusterResponse, protos.google.cloud.alloydb.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.alloydb.v1beta.IUpgradeClusterResponse, protos.google.cloud.alloydb.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.upgradeCluster as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteCluster', () => {
        it('invokes deleteCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.DeleteClusterRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes deleteCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deleteCluster(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.alloydb.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.alloydb.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteCluster as SinonStub)
                .getCall(0).args[0];
    ...
    describe('promoteCluster', () => {
        it('invokes promoteCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.PromoteClusterRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('switchoverCluster', () => {
        it('invokes switchoverCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.SwitchoverClusterRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('restoreCluster', () => {
        it('invokes restoreCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.RestoreClusterRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createSecondaryCluster', () => {
        it('invokes createSecondaryCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.CreateSecondaryClusterRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createInstance', () => {
        it('invokes createInstance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.CreateInstanceRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createInstance without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createInstance(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.alloydb.v1beta.IInstance, protos.google.cloud.alloydb.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.alloydb.v1beta.IInstance, protos.google.cloud.alloydb.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createInstance as SinonStub)
                .getCall(0).args[0];
    ...
    describe('createSecondaryInstance', () => {
        it('invokes createSecondaryInstance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.CreateSecondaryInstanceRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('batchCreateInstances', () => {
        it('invokes batchCreateInstances without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.BatchCreateInstancesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes batchCreateInstances without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchCreateInstances(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.alloydb.v1beta.IBatchCreateInstancesResponse, protos.google.cloud.alloydb.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.alloydb.v1beta.IBatchCreateInstancesResponse, protos.google.cloud.alloydb.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchCreateInstances as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateInstance', () => {
        it('invokes updateInstance without error', async () => {
            ...
            request.instance ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.UpdateInstanceRequest', ['instance', 'name']);
    ...
    describe('deleteInstance', () => {
        it('invokes deleteInstance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.DeleteInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('failoverInstance', () => {
        it('invokes failoverInstance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.FailoverInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('injectFault', () => {
        it('invokes injectFault without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.InjectFaultRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('restartInstance', () => {
        it('invokes restartInstance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.RestartInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createBackup', () => {
        it('invokes createBackup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.CreateBackupRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createBackup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createBackup(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.alloydb.v1beta.IBackup, protos.google.cloud.alloydb.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.alloydb.v1beta.IBackup, protos.google.cloud.alloydb.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createBackup as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateBackup', () => {
        it('invokes updateBackup without error', async () => {
            ...
            request.backup ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.UpdateBackupRequest', ['backup', 'name']);
    ...
    describe('deleteBackup', () => {
        it('invokes deleteBackup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.DeleteBackupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listClusters', () => {
        it('invokes listClusters without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.ListClustersRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.alloydb.v1beta.Cluster()),
              generateSampleMessage(new protos.google.cloud.alloydb.v1beta.Cluster()),
              generateSampleMessage(new protos.google.cloud.alloydb.v1beta.Cluster()),
            ];
        ...
        it('invokes listClustersStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.alloydb.v1beta.Cluster[] = [];
                stream.on('data', (response: protos.google.cloud.alloydb.v1beta.Cluster) => {
        ...
        it('uses async iteration with listClusters without error', async () => {
            ...
            const responses: protos.google.cloud.alloydb.v1beta.ICluster[] = [];
    ...
    describe('listInstances', () => {
        it('invokes listInstances without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.ListInstancesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.alloydb.v1beta.Instance()),
              generateSampleMessage(new protos.google.cloud.alloydb.v1beta.Instance()),
              generateSampleMessage(new protos.google.cloud.alloydb.v1beta.Instance()),
            ];
        ...
        it('invokes listInstancesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.alloydb.v1beta.Instance[] = [];
                stream.on('data', (response: protos.google.cloud.alloydb.v1beta.Instance) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listInstances without error', async () => {
            ...
            const responses: protos.google.cloud.alloydb.v1beta.IInstance[] = [];
    ...
    describe('listBackups', () => {
        it('invokes listBackups without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.ListBackupsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.alloydb.v1beta.Backup()),
              generateSampleMessage(new protos.google.cloud.alloydb.v1beta.Backup()),
              generateSampleMessage(new protos.google.cloud.alloydb.v1beta.Backup()),
            ];
        ...
        it('invokes listBackupsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.alloydb.v1beta.Backup[] = [];
                stream.on('data', (response: protos.google.cloud.alloydb.v1beta.Backup) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listBackups without error', async () => {
            ...
            const responses: protos.google.cloud.alloydb.v1beta.IBackup[] = [];
    ...
    describe('listSupportedDatabaseFlags', () => {
        it('invokes listSupportedDatabaseFlags without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.ListSupportedDatabaseFlagsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.alloydb.v1beta.SupportedDatabaseFlag()),
              generateSampleMessage(new protos.google.cloud.alloydb.v1beta.SupportedDatabaseFlag()),
              generateSampleMessage(new protos.google.cloud.alloydb.v1beta.SupportedDatabaseFlag()),
            ];
        ...
        it('invokes listSupportedDatabaseFlags without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listSupportedDatabaseFlags(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.alloydb.v1beta.ISupportedDatabaseFlag[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listSupportedDatabaseFlagsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.alloydb.v1beta.SupportedDatabaseFlag[] = [];
                stream.on('data', (response: protos.google.cloud.alloydb.v1beta.SupportedDatabaseFlag) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listSupportedDatabaseFlags without error', async () => {
            ...
            const responses: protos.google.cloud.alloydb.v1beta.ISupportedDatabaseFlag[] = [];
    ...
    describe('listUsers', () => {
        it('invokes listUsers without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.ListUsersRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.alloydb.v1beta.User()),
              generateSampleMessage(new protos.google.cloud.alloydb.v1beta.User()),
              generateSampleMessage(new protos.google.cloud.alloydb.v1beta.User()),
            ];
        ...
        it('invokes listUsersStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.alloydb.v1beta.User[] = [];
                stream.on('data', (response: protos.google.cloud.alloydb.v1beta.User) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listUsers without error', async () => {
            ...
            const responses: protos.google.cloud.alloydb.v1beta.IUser[] = [];
    ...
    describe('listDatabases', () => {
        it('invokes listDatabases without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1beta.ListDatabasesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.alloydb.v1beta.Database()),
              generateSampleMessage(new protos.google.cloud.alloydb.v1beta.Database()),
              generateSampleMessage(new protos.google.cloud.alloydb.v1beta.Database()),
            ];
        ...
        it('invokes listDatabasesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.alloydb.v1beta.Database[] = [];
                stream.on('data', (response: protos.google.cloud.alloydb.v1beta.Database) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
