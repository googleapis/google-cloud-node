...
describe('v1beta.AlloyDBAdminClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          alloydbadminModule.v1beta.AlloyDBAdminClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          alloydbadminModule.v1beta.AlloyDBAdminClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'alloydb.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('invokes getCluster without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getCluster(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.alloydb.v1beta.ICluster | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getInstance without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getInstance(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.alloydb.v1beta.IInstance | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes executeSql without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.executeSql(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.alloydb.v1beta.IExecuteSqlResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getBackup', () => {
    it('invokes getBackup without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.alloydb.v1beta.GetBackupRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
    ...
    it('invokes getBackup without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getBackup(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.alloydb.v1beta.IBackup | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes generateClientCertificate without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.generateClientCertificate(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.alloydb.v1beta.IGenerateClientCertificateResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getConnectionInfo without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getConnectionInfo(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.alloydb.v1beta.IConnectionInfo | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getUser', () => {
    it('invokes getUser without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.alloydb.v1beta.GetUserRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
    ...
    it('invokes getUser without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getUser(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.alloydb.v1beta.IUser | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createUser', () => {
    it('invokes createUser without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.alloydb.v1beta.CreateUserRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
  ...
  describe('updateUser', () => {
    it('invokes updateUser without error', async () => {
      ...
      request.user ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.alloydb.v1beta.UpdateUserRequest',
        ['user', 'name'],
      );
  ...
  describe('deleteUser', () => {
    it('invokes deleteUser without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.alloydb.v1beta.DeleteUserRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('createDatabase', () => {
    it('invokes createDatabase without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.alloydb.v1beta.CreateDatabaseRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
    ...
    it('invokes createDatabase without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createDatabase(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.alloydb.v1beta.IDatabase | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createDatabase with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createDatabase = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('importCluster', () => {
    it('invokes importCluster without error', async () => {
      ...
      client.innerApiCalls.importCluster =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.importCluster(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.importCluster as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.importCluster as SinonStub
    ...
    it('invokes importCluster with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.importCluster = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkImportClusterProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkImportClusterProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchCreateInstances(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.alloydb.v1beta.IBatchCreateInstancesResponse,
              protos.google.cloud.alloydb.v1beta.IOperationMetadata
            > | null,
          ) => {
            if (err) {
  ...
  describe('createBackup', () => {
    it('invokes createBackup without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.alloydb.v1beta.CreateBackupRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
  ...
  describe('updateBackup', () => {
    it('invokes updateBackup without error', async () => {
      ...
      request.backup ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.alloydb.v1beta.UpdateBackupRequest',
        ['backup', 'name'],
      );
  ...
  describe('deleteBackup', () => {
    it('invokes deleteBackup without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.alloydb.v1beta.DeleteBackupRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('listClusters', () => {
    ...
    it('invokes listClustersStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.alloydb.v1beta.Cluster) => {
  ...
  describe('listInstances', () => {
    ...
    it('invokes listInstancesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.alloydb.v1beta.Instance) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listBackups', () => {
    ...
    it('invokes listBackupsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.alloydb.v1beta.Backup) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listSupportedDatabaseFlags', () => {
    it('invokes listSupportedDatabaseFlags without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.alloydb.v1beta.SupportedDatabaseFlag(),
        ),
        generateSampleMessage(
          new protos.google.cloud.alloydb.v1beta.SupportedDatabaseFlag(),
        ),
    ...
    it('invokes listSupportedDatabaseFlagsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.alloydb.v1beta.SupportedDatabaseFlag,
          ) => {
            responses.push(response);
          },
        );
  ...
  describe('listUsers', () => {
    ...
    it('invokes listUsersStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.alloydb.v1beta.User) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listDatabases', () => {
    ...
    it('invokes listDatabasesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.alloydb.v1beta.Database) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
