  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          alloydbcsqladminModule.v1beta.AlloyDBCSQLAdminClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          alloydbcsqladminModule.v1beta.AlloyDBCSQLAdminClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'alloydb.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new alloydbcsqladminModule.v1beta.AlloyDBCSQLAdminClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'alloydb.example.com');
          if (saved) {
