...
describe('v1alpha.AlloyDBAdminClient', () => {
    ...
    describe('createDatabase', () => {
        it('invokes createDatabase without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.alloydb.v1alpha.CreateDatabaseRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.CreateDatabaseRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('exportCluster', () => {
        it('invokes exportCluster without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.alloydb.v1alpha.ExportClusterRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.ExportClusterRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes exportCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.exportCluster(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.alloydb.v1alpha.IExportClusterResponse, protos.google.cloud.alloydb.v1alpha.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.alloydb.v1alpha.IExportClusterResponse, protos.google.cloud.alloydb.v1alpha.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportCluster as SinonStub)
                .getCall(0).args[0];
    ...
    describe('importCluster', () => {
        it('invokes importCluster without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.alloydb.v1alpha.ImportClusterRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.alloydb.v1alpha.ImportClusterRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes importCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.importCluster(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.alloydb.v1alpha.IImportClusterResponse, protos.google.cloud.alloydb.v1alpha.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.alloydb.v1alpha.IImportClusterResponse, protos.google.cloud.alloydb.v1alpha.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importCluster as SinonStub)
                .getCall(0).args[0];
