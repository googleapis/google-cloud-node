 ...
 * `src/v1/alloy_d_b_c_s_q_l_admin_client_config.json`.
...
export class AlloyDBCSQLAdminClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.alloydb.v1.AlloyDBCSQLAdmin', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.alloyDBCSQLAdminStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.alloydb.v1.AlloyDBCSQLAdmin') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.alloydb.v1.AlloyDBCSQLAdmin,
 ...
 * @param {google.cloud.alloydb.v1.CloudSQLBackupRunSource} request.cloudsqlBackupRunSource
 ...
 * @example <caption>include:samples/generated/v1/alloy_d_b_c_s_q_l_admin.restore_from_cloud_s_q_l.js</caption>
 * region_tag:alloydb_v1_generated_AlloyDBCSQLAdmin_RestoreFromCloudSQL_async
 */
  restoreFromCloudSQL(
      request?: protos.google.cloud.alloydb.v1.IRestoreFromCloudSQLRequest,
      options?: CallOptions):
      Promise<[
 ...
 * region_tag:alloydb_v1_generated_AlloyDBCSQLAdmin_RestoreFromCloudSQL_async
 */
  async checkRestoreFromCloudSQLProgress(name: string): Promise<LROperation<protos.google.cloud.alloydb.v1.Cluster, protos.google.cloud.alloydb.v1.OperationMetadata>>{
