 ...
 *   Required. ID of the requesting object.
 * @param {google.cloud.alloydb.v1alpha.Database} request.database
 *   Required. The resource being created.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.cloud.alloydb.v1alpha.Database|Database}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1alpha/alloy_d_b_admin.create_database.js</caption>
 * region_tag:alloydb_v1alpha_generated_AlloyDBAdmin_CreateDatabase_async
 */
  createDatabase(
      request?: protos.google.cloud.alloydb.v1alpha.ICreateDatabaseRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.alloydb.v1alpha.IDatabase,
        protos.google.cloud.alloydb.v1alpha.ICreateDatabaseRequest|undefined, {}|undefined
      ]>;
  createDatabase(
      request: protos.google.cloud.alloydb.v1alpha.ICreateDatabaseRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.alloydb.v1alpha.IDatabase,
          protos.google.cloud.alloydb.v1alpha.ICreateDatabaseRequest|null|undefined,
          {}|null|undefined>): void;
  createDatabase(
      request: protos.google.cloud.alloydb.v1alpha.ICreateDatabaseRequest,
      callback: Callback<
  ...
  createDatabase(
    ...
    return this.innerApiCalls.createDatabase(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.alloydb.v1alpha.IDatabase,
        protos.google.cloud.alloydb.v1alpha.ICreateDatabaseRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('createDatabase response %j', response);
        return [response, options, rawResponse];
