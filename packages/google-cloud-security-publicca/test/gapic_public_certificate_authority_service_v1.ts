...
describe('v1.PublicCertificateAuthorityServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new publiccertificateauthorityserviceModule.v1.PublicCertificateAuthorityServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = publiccertificateauthorityserviceModule.v1.PublicCertificateAuthorityServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = publiccertificateauthorityserviceModule.v1.PublicCertificateAuthorityServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'publicca.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new publiccertificateauthorityserviceModule.v1.PublicCertificateAuthorityServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'publicca.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new publiccertificateauthorityserviceModule.v1.PublicCertificateAuthorityServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'publicca.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new publiccertificateauthorityserviceModule.v1.PublicCertificateAuthorityServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new publiccertificateauthorityserviceModule.v1.PublicCertificateAuthorityServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = publiccertificateauthorityserviceModule.v1.PublicCertificateAuthorityServiceClient.port;
            assert(port);
    ...
    describe('createExternalAccountKey', () => {
        it('invokes createExternalAccountKey without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.security.publicca.v1.CreateExternalAccountKeyRequest', ['parent']);
        ...
        it('invokes createExternalAccountKey without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createExternalAccountKey(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.security.publicca.v1.IExternalAccountKey|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
