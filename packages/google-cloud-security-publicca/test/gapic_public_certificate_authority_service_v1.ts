...
describe('v1.PublicCertificateAuthorityServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new publiccertificateauthorityserviceModule.v1.PublicCertificateAuthorityServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          publiccertificateauthorityserviceModule.v1
    ...
    it('invokes createExternalAccountKey without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createExternalAccountKey(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.security.publicca.v1.IExternalAccountKey | null
          ) => {
            if (err) {
              reject(err);
            } else {
