...
function main(parent, azureCluster, azureClusterId) {
  ...
  async function callCreateAzureCluster() {
    // Construct request
    const request = {
      parent,
      azureCluster,
    ...
    // Run request
    const [operation] = await gkemulticloudClient.createAzureCluster(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callCreateAzureCluster();
