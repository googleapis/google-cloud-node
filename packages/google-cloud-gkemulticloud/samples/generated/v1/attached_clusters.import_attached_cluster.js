...
function main(parent, fleetMembership, platformVersion, distribution) {
  ...
  async function callImportAttachedCluster() {
    // Construct request
    const request = {
      parent,
      fleetMembership,
    ...
    // Run request
    const [operation] = await gkemulticloudClient.importAttachedCluster(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callImportAttachedCluster();
