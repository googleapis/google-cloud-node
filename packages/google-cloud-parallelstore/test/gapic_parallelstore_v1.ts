  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          parallelstoreModule.v1.ParallelstoreClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          parallelstoreModule.v1.ParallelstoreClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'parallelstore.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        ...
        it('value configured in code has priority over environment variable', () => {
          ...
          assert.strictEqual(
            servicePath,
            'parallelstore.configured.example.com'
          );
          if (saved) {
            process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = saved;
          } else {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new parallelstoreModule.v1.ParallelstoreClient({
          universe_domain: 'example.com',
    ...
    it('invokes getInstance without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getInstance(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.parallelstore.v1.IInstance | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listInstances', () => {
    ...
    it('invokes listInstancesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.parallelstore.v1.Instance) => {
  ...
  describe('Path templates', () => {
    describe('address', async () => {
      ...
      client.pathTemplates.addressPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.addressPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('addressPath', () => {
        const result = client.addressPath(
          'projectValue',
          'regionValue',
          'addressValue'
        );
        ...
        assert(
          (client.pathTemplates.addressPathTemplate.render as SinonStub)
            .getCall(-1)
      ...
      it('matchProjectFromAddressName', () => {
        ...
        assert(
          (client.pathTemplates.addressPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath)
        );
      });
