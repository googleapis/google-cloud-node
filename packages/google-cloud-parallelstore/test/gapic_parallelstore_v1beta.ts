...
describe('v1beta.ParallelstoreClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = parallelstoreModule.v1beta.ParallelstoreClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = parallelstoreModule.v1beta.ParallelstoreClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'parallelstore.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new parallelstoreModule.v1beta.ParallelstoreClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'parallelstore.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new parallelstoreModule.v1beta.ParallelstoreClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'parallelstore.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new parallelstoreModule.v1beta.ParallelstoreClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new parallelstoreModule.v1beta.ParallelstoreClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = parallelstoreModule.v1beta.ParallelstoreClient.port;
            assert(port);
    ...
    describe('getInstance', () => {
        it('invokes getInstance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.parallelstore.v1beta.GetInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.parallelstore.v1beta.Instance()
            );
        ...
        it('invokes getInstance without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getInstance(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.parallelstore.v1beta.IInstance|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createInstance', () => {
        it('invokes createInstance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.parallelstore.v1beta.CreateInstanceRequest', ['parent']);
        ...
        it('invokes createInstance without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createInstance(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.parallelstore.v1beta.IInstance, protos.google.cloud.parallelstore.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.parallelstore.v1beta.IInstance, protos.google.cloud.parallelstore.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createInstance as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateInstance', () => {
        it('invokes updateInstance without error', async () => {
            ...
            request.instance ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.parallelstore.v1beta.UpdateInstanceRequest', ['instance', 'name']);
    ...
    describe('deleteInstance', () => {
        it('invokes deleteInstance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.parallelstore.v1beta.DeleteInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes deleteInstance without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deleteInstance(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.parallelstore.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.parallelstore.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteInstance as SinonStub)
                .getCall(0).args[0];
    ...
    describe('importData', () => {
        it('invokes importData without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.parallelstore.v1beta.ImportDataRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes importData without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.importData(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.parallelstore.v1beta.IImportDataResponse, protos.google.cloud.parallelstore.v1beta.IImportDataMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.parallelstore.v1beta.IImportDataResponse, protos.google.cloud.parallelstore.v1beta.IImportDataMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importData as SinonStub)
                .getCall(0).args[0];
    ...
    describe('exportData', () => {
        it('invokes exportData without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.parallelstore.v1beta.ExportDataRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes exportData without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.exportData(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.parallelstore.v1beta.IExportDataResponse, protos.google.cloud.parallelstore.v1beta.IExportDataMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.parallelstore.v1beta.IExportDataResponse, protos.google.cloud.parallelstore.v1beta.IExportDataMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportData as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listInstances', () => {
        it('invokes listInstances without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.parallelstore.v1beta.ListInstancesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.parallelstore.v1beta.Instance()),
              generateSampleMessage(new protos.google.cloud.parallelstore.v1beta.Instance()),
              generateSampleMessage(new protos.google.cloud.parallelstore.v1beta.Instance()),
            ];
        ...
        it('invokes listInstancesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.parallelstore.v1beta.Instance[] = [];
                stream.on('data', (response: protos.google.cloud.parallelstore.v1beta.Instance) => {
        ...
        it('uses async iteration with listInstances without error', async () => {
            ...
            const responses: protos.google.cloud.parallelstore.v1beta.IInstance[] = [];
