  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          parallelstoreModule.v1beta.ParallelstoreClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          parallelstoreModule.v1beta.ParallelstoreClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'parallelstore.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new parallelstoreModule.v1beta.ParallelstoreClient({
          universe_domain: 'example.com',
    ...
    it('invokes getInstance without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getInstance(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.parallelstore.v1beta.IInstance | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listInstances', () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listInstances(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.parallelstore.v1beta.IInstance[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listInstancesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.parallelstore.v1beta.Instance) => {
