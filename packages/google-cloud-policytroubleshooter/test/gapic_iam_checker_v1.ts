...
describe('v1.IamCheckerClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new iamcheckerModule.v1.IamCheckerClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'policytroubleshooter.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new iamcheckerModule.v1.IamCheckerClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'policytroubleshooter.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new iamcheckerModule.v1.IamCheckerClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new iamcheckerModule.v1.IamCheckerClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
        ...
        it('invokes troubleshootIamPolicy without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.troubleshootIamPolicy(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.policytroubleshooter.v1.ITroubleshootIamPolicyResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
