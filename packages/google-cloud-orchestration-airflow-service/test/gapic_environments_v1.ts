  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          environmentsModule.v1.EnvironmentsClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          environmentsModule.v1.EnvironmentsClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'composer.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new environmentsModule.v1.EnvironmentsClient({
          universe_domain: 'example.com',
    ...
    it('invokes createUserWorkloadsSecret without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createUserWorkloadsSecret(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.orchestration.airflow.service.v1.IUserWorkloadsSecret | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createUserWorkloadsConfigMap without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createUserWorkloadsConfigMap(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.orchestration.airflow.service.v1.IUserWorkloadsConfigMap | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listWorkloadsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.orchestration.airflow.service.v1.ListWorkloadsResponse.ComposerWorkload
          ) => {
            responses.push(response);
          }
        );
    ...
    it('invokes listUserWorkloadsSecretsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.orchestration.airflow.service.v1.UserWorkloadsSecret
          ) => {
            responses.push(response);
          }
        );
    ...
    it('invokes listUserWorkloadsConfigMapsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.orchestration.airflow.service.v1.UserWorkloadsConfigMap
          ) => {
            responses.push(response);
          }
        );
