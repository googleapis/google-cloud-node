...
describe('v1alpha1.ConsumerProcurementServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = consumerprocurementserviceModule.v1alpha1.ConsumerProcurementServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = consumerprocurementserviceModule.v1alpha1.ConsumerProcurementServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'cloudcommerceconsumerprocurement.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new consumerprocurementserviceModule.v1alpha1.ConsumerProcurementServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'cloudcommerceconsumerprocurement.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new consumerprocurementserviceModule.v1alpha1.ConsumerProcurementServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'cloudcommerceconsumerprocurement.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new consumerprocurementserviceModule.v1alpha1.ConsumerProcurementServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new consumerprocurementserviceModule.v1alpha1.ConsumerProcurementServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = consumerprocurementserviceModule.v1alpha1.ConsumerProcurementServiceClient.port;
            assert(port);
    ...
    describe('getOrder', () => {
        it('invokes getOrder without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.commerce.consumer.procurement.v1alpha1.GetOrderRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.commerce.consumer.procurement.v1alpha1.Order()
            );
        ...
        it('invokes getOrder without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getOrder(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.commerce.consumer.procurement.v1alpha1.IOrder|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('placeOrder', () => {
        it('invokes placeOrder without error', async () => {
            const client = new consumerprocurementserviceModule.v1alpha1.ConsumerProcurementServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.commerce.consumer.procurement.v1alpha1.PlaceOrderRequest', ['parent']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.placeOrder as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.placeOrder as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes placeOrder without error using callback', async () => {
            const client = new consumerprocurementserviceModule.v1alpha1.ConsumerProcurementServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.placeOrder = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.placeOrder(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.commerce.consumer.procurement.v1alpha1.IOrder, protos.google.cloud.commerce.consumer.procurement.v1alpha1.IPlaceOrderMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.commerce.consumer.procurement.v1alpha1.IOrder, protos.google.cloud.commerce.consumer.procurement.v1alpha1.IPlaceOrderMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.placeOrder as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes placeOrder with call error', async () => {
            const client = new consumerprocurementserviceModule.v1alpha1.ConsumerProcurementServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
        ...
        it('invokes placeOrder with LRO error', async () => {
            const client = new consumerprocurementserviceModule.v1alpha1.ConsumerProcurementServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
        ...
        it('invokes checkPlaceOrderProgress without error', async () => {
            const client = new consumerprocurementserviceModule.v1alpha1.ConsumerProcurementServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
        ...
        it('invokes checkPlaceOrderProgress with error', async () => {
            const client = new consumerprocurementserviceModule.v1alpha1.ConsumerProcurementServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('listOrders', () => {
        it('invokes listOrders without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.commerce.consumer.procurement.v1alpha1.ListOrdersRequest', ['parent']);
            request.parent = defaultValue1;
        ...
        it('invokes listOrdersStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.commerce.consumer.procurement.v1alpha1.Order[] = [];
                stream.on('data', (response: protos.google.cloud.commerce.consumer.procurement.v1alpha1.Order) => {
        ...
        it('uses async iteration with listOrders without error', async () => {
            ...
            const responses: protos.google.cloud.commerce.consumer.procurement.v1alpha1.IOrder[] = [];
