...
export class ConsumerProcurementServiceClient {
  ...
  constructor(
    ...
    const placeOrderMetadata = protoFilesRoot.lookup(
      '.google.cloud.commerce.consumer.procurement.v1alpha1.PlaceOrderMetadata'
    ) as gax.protobuf.Type;
    ...
    this.consumerProcurementServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ...
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.commerce.consumer.procurement
            .v1alpha1.ConsumerProcurementService,
      this._opts,
      this._providedCustomServicePath
  ...
  async checkPlaceOrderProgress(
    ...
    LROperation<
      protos.google.cloud.commerce.consumer.procurement.v1alpha1.Order,
