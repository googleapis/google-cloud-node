...
(0, mocha_1.describe)('v1alpha1.ConsumerProcurementServiceClient', () => {
    (0, mocha_1.describe)('Common methods', () => {
        (0, mocha_1.it)('has servicePath', () => {
            const servicePath = consumerprocurementserviceModule.v1alpha1
                .ConsumerProcurementServiceClient.servicePath;
            assert(servicePath);
        });
        (0, mocha_1.it)('has apiEndpoint', () => {
            const apiEndpoint = consumerprocurementserviceModule.v1alpha1
                .ConsumerProcurementServiceClient.apiEndpoint;
            assert(apiEndpoint);
        });
        (0, mocha_1.it)('has port', () => {
            const port = consumerprocurementserviceModule.v1alpha1
                .ConsumerProcurementServiceClient.port;
            assert(port);
            assert(typeof port === 'number');
        });
        (0, mocha_1.it)('should create a client with no option', () => {
            const client = new consumerprocurementserviceModule.v1alpha1.ConsumerProcurementServiceClient();
            assert(client);
        });
    ...
    (0, mocha_1.describe)('getOrder', () => {
        (0, mocha_1.it)('invokes getOrder without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.commerce.consumer.procurement.v1alpha1.GetOrderRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.commerce.consumer.procurement.v1alpha1.GetOrderRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(new protos.google.cloud.commerce.consumer.procurement.v1alpha1.Order());
    ...
    (0, mocha_1.describe)('placeOrder', () => {
        (0, mocha_1.it)('invokes placeOrder without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.commerce.consumer.procurement.v1alpha1.PlaceOrderRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.commerce.consumer.procurement.v1alpha1.PlaceOrderRequest', ['parent']);
    ...
    (0, mocha_1.describe)('listOrders', () => {
        (0, mocha_1.it)('invokes listOrders without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.commerce.consumer.procurement.v1alpha1.ListOrdersRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.commerce.consumer.procurement.v1alpha1.ListOrdersRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = [
                generateSampleMessage(new protos.google.cloud.commerce.consumer.procurement.v1alpha1.Order()),
                generateSampleMessage(new protos.google.cloud.commerce.consumer.procurement.v1alpha1.Order()),
                generateSampleMessage(new protos.google.cloud.commerce.consumer.procurement.v1alpha1.Order()),
            ];
...
//# sourceMappingURL=gapic_consumer_procurement_service_v1alpha1.js.map