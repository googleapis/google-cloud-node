 ...
 */
const gapicConfig = require("./consumer_procurement_service_client_config.json");
...
class ConsumerProcurementServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            ...
            orderPathTemplate: new this._gaxModule.PathTemplate('billingAccounts/{billing_account}/orders/{order}'),
        };
        ...
        const placeOrderResponse = protoFilesRoot.lookup('.google.cloud.commerce.consumer.procurement.v1alpha1.Order');
        const placeOrderMetadata = protoFilesRoot.lookup('.google.cloud.commerce.consumer.procurement.v1alpha1.PlaceOrderMetadata');
        this.descriptors.longrunning = {
            placeOrder: new this._gaxModule.LongrunningDescriptor(this.operationsClient, placeOrderResponse.decode.bind(placeOrderResponse), placeOrderMetadata.decode.bind(placeOrderMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.commerce.consumer.procurement.v1alpha1.ConsumerProcurementService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.consumerProcurementServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.commerce.consumer.procurement.v1alpha1.ConsumerProcurementService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.commerce.consumer.procurement
                    .v1alpha1.ConsumerProcurementService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of consumerProcurementServiceStubMethods) {
            const callPromise = this.consumerProcurementServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getOrder(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    placeOrder(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkPlaceOrderProgress(name) {
    ...
    listOrders(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
...
//# sourceMappingURL=consumer_procurement_service_client.js.map