...
class ConsumerProcurementServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const placeOrderResponse = protoFilesRoot.lookup('.google.cloud.commerce.consumer.procurement.v1.Order');
        const placeOrderMetadata = protoFilesRoot.lookup('.google.cloud.commerce.consumer.procurement.v1.PlaceOrderMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.commerce.consumer.procurement.v1.ConsumerProcurementService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.consumerProcurementServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.commerce.consumer.procurement.v1.ConsumerProcurementService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.commerce.consumer.procurement.v1
                    .ConsumerProcurementService, this._opts, this._providedCustomServicePath);
