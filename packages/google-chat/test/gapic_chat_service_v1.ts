...
describe('v1.ChatServiceClient', () => {
    ...
    describe('createCustomEmoji', () => {
        ...
        it('invokes createCustomEmoji without error using callback', async () => {
            ...
            client.innerApiCalls.createCustomEmoji = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createCustomEmoji(
                    request,
                    (err?: Error|null, result?: protos.google.chat.v1.ICustomEmoji|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createCustomEmoji with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.createCustomEmoji = stubSimpleCall(undefined, expectedError);
    ...
    describe('getCustomEmoji', () => {
        it('invokes getCustomEmoji without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.chat.v1.GetCustomEmojiRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.chat.v1.CustomEmoji()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getCustomEmoji as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getCustomEmoji as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getCustomEmoji without error using callback', async () => {
            ...
            client.innerApiCalls.getCustomEmoji = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getCustomEmoji with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getCustomEmoji = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteCustomEmoji', () => {
        it('invokes deleteCustomEmoji without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.chat.v1.DeleteCustomEmojiRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteCustomEmoji as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteCustomEmoji as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteCustomEmoji without error using callback', async () => {
            ...
            client.innerApiCalls.deleteCustomEmoji = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteCustomEmoji with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteCustomEmoji = stubSimpleCall(undefined, expectedError);
    ...
    describe('listCustomEmojis', () => {
        ...
        it('invokes listCustomEmojis without error using callback', async () => {
            ...
            client.innerApiCalls.listCustomEmojis = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listCustomEmojis with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listCustomEmojis = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listCustomEmojisStream without error', async () => {
            ...
            client.descriptors.page.listCustomEmojis.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listCustomEmojis.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listCustomEmojis, request));
        });
        ...
        it('invokes listCustomEmojisStream with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.descriptors.page.listCustomEmojis.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listCustomEmojisStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.chat.v1.CustomEmoji[] = [];
                stream.on('data', (response: protos.google.chat.v1.CustomEmoji) => {
        ...
        it('uses async iteration with listCustomEmojis without error', async () => {
            ...
            client.descriptors.page.listCustomEmojis.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listCustomEmojis with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.descriptors.page.listCustomEmojis.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listCustomEmojisAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.chat.v1.ICustomEmoji[] = [];
                for await (const resource of iterable) {
    ...
    describe('Path templates', () => {
        ...
        describe('customEmoji', async () => {
            ...
            await client.initialize();
            client.pathTemplates.customEmojiPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.customEmojiPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('customEmojiPath', () => {
                const result = client.customEmojiPath("customEmojiValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.customEmojiPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchCustomEmojiFromCustomEmojiName', () => {
                ...
                assert((client.pathTemplates.customEmojiPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
