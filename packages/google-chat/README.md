...
[![npm version](https://img.shields.io/npm/v/@google-cloud/chat.svg)](https://www.npmjs.org/package/@google-cloud/chat)
...
For example, `npm install @google-cloud/chat@legacy-8` installs client libraries
