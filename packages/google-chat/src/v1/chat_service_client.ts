...
export class ChatServiceClient {
  ...
  constructor(
    ...
    this.descriptors.page = {
      ...
      searchSpaces: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'spaces',
      ),
      findGroupChats: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'spaces',
      ),
      ...
      listSections: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'sections',
      ),
      listSectionItems: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'sectionItems',
      ),
