...
function main(name) {
  // [START chat_v1_generated_ChatService_GetAvailability_async]
  /**
  ...
  async function callGetAvailability() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await chatClient.getAvailability(request);
    console.log(response);
  }

  callGetAvailability();
  // [END chat_v1_generated_ChatService_GetAvailability_async]
}
