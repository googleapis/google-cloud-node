...
function main(name) {
  // [START chat_v1_generated_ChatService_MarkAsAway_async]
  /**
  ...
  async function callMarkAsAway() {
    ...
    // Run request
    const response = await chatClient.markAsAway(request);
    console.log(response);
  }

  callMarkAsAway();
  // [END chat_v1_generated_ChatService_MarkAsAway_async]
}
