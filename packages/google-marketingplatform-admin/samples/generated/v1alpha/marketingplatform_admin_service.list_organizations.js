...
function main() {
  // [START marketingplatformadmin_v1alpha_generated_MarketingplatformAdminService_ListOrganizations_async]
  /**
  ...
  async function callListOrganizations() {
    // Construct request
    const request = {
    };

    // Run request
    const iterable = adminClient.listOrganizationsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListOrganizations();
  // [END marketingplatformadmin_v1alpha_generated_MarketingplatformAdminService_ListOrganizations_async]
}
