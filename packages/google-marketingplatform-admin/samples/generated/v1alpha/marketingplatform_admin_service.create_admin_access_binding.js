...
function main(parent, adminAccessBinding) {
  ...
  async function callCreateAdminAccessBinding() {
    // Construct request
    const request = {
      parent,
      adminAccessBinding,
    ...
    // Run request
    const response = await adminClient.createAdminAccessBinding(request);
    console.log(response);
  }

  callCreateAdminAccessBinding();
