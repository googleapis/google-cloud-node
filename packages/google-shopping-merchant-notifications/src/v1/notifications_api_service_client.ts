...
export class NotificationsApiServiceClient {
    ...
    this.notificationsApiServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ...
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.shopping.merchant.notifications.v1
  ...
  getNotificationSubscription(
    ...
    [
      ...
      (
        | protos.google.shopping.merchant.notifications.v1.IGetNotificationSubscriptionRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  createNotificationSubscription(
    ...
    [
      protos.google.shopping.merchant.notifications.v1.INotificationSubscription,
      (
        | protos.google.shopping.merchant.notifications.v1.ICreateNotificationSubscriptionRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  updateNotificationSubscription(
    ...
    [
      protos.google.shopping.merchant.notifications.v1.INotificationSubscription,
      (
        | protos.google.shopping.merchant.notifications.v1.IUpdateNotificationSubscriptionRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  deleteNotificationSubscription(
    ...
    [
      ...
      (
        | protos.google.shopping.merchant.notifications.v1.IDeleteNotificationSubscriptionRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  getNotificationSubscriptionHealthMetrics(
    ...
    [
      ...
      (
        | protos.google.shopping.merchant.notifications.v1.IGetNotificationSubscriptionHealthMetricsRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    this._log.info(
      'getNotificationSubscriptionHealthMetrics request %j',
      request,
    );
    const wrappedCallback:
      | Callback<
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'getNotificationSubscriptionHealthMetrics response %j',
            response,
          );
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
