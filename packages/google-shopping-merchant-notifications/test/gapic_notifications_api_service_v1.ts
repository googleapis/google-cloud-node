...
describe('v1.NotificationsApiServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new notificationsapiserviceModule.v1.NotificationsApiServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          notificationsapiserviceModule.v1.NotificationsApiServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        notificationsapiserviceModule.v1.NotificationsApiServiceClient.port;
      assert(port);
    ...
    it('invokes getNotificationSubscription without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getNotificationSubscription(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.notifications.v1.INotificationSubscription | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getNotificationSubscriptionHealthMetrics', () => {
    it('invokes getNotificationSubscriptionHealthMetrics without error', async () => {
      ...
      client.innerApiCalls.getNotificationSubscriptionHealthMetrics =
        stubSimpleCall(expectedResponse);
      const [response] =
        await client.getNotificationSubscriptionHealthMetrics(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls
          .getNotificationSubscriptionHealthMetrics as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls
    ...
    it('invokes getNotificationSubscriptionHealthMetrics without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getNotificationSubscriptionHealthMetrics(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.notifications.v1.INotificationSubscriptionHealthMetrics | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getNotificationSubscriptionHealthMetrics with error', async () => {
      ...
      await assert.rejects(
        client.getNotificationSubscriptionHealthMetrics(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls
    ...
    it('invokes listNotificationSubscriptionsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.shopping.merchant.notifications.v1.NotificationSubscription,
          ) => {
