...
describe('v1.LineageClient', () => {
  ...
  describe('processOpenLineageRunEvent', () => {
    it('invokes processOpenLineageRunEvent without error', async () => {
      ...
      assert.match(
        (client.innerApiCalls.processOpenLineageRunEvent as SinonStub).getCall(
          0,
        ).args[0].requestId,
        /[a-z0-9-]{36}/,
      );
  ...
  describe('createProcess', () => {
    it('invokes createProcess without error', async () => {
      ...
      assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
      assert.match(
        (client.innerApiCalls.createProcess as SinonStub).getCall(0).args[0]
          .requestId,
        /[a-z0-9-]{36}/,
      );
    });
  ...
  describe('updateProcess', () => {
    it('invokes updateProcess without error', async () => {
      ...
      assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
      assert.match(
        (client.innerApiCalls.updateProcess as SinonStub).getCall(0).args[0]
          .requestId,
        /[a-z0-9-]{36}/,
      );
    });
  ...
  describe('createRun', () => {
    it('invokes createRun without error', async () => {
      ...
      assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
      assert.match(
        (client.innerApiCalls.createRun as SinonStub).getCall(0).args[0]
          .requestId,
        /[a-z0-9-]{36}/,
      );
    });
  ...
  describe('createLineageEvent', () => {
    it('invokes createLineageEvent without error', async () => {
      ...
      assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
      assert.match(
        (client.innerApiCalls.createLineageEvent as SinonStub).getCall(0)
          .args[0].requestId,
        /[a-z0-9-]{36}/,
      );
    });
  ...
  describe('searchLineageStreaming', () => {
    it('invokes searchLineageStreaming without error', async () => {
      ...
      client.innerApiCalls.searchLineageStreaming =
      ...
      const promise = new Promise((resolve, reject) => {
        stream.on(
          'data',
          (
            response: protos.google.cloud.datacatalog.lineage.v1.SearchLineageStreamingResponse,
          ) => {
            resolve(response);
          },
        );
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.searchLineageStreaming as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.searchLineageStreaming as SinonStub
    ...
    it('invokes searchLineageStreaming with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.searchLineageStreaming = stubServerStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.searchLineageStreaming(request);
