    ...
    describe('search', () => {
        it('invokes search without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.shopping.merchant.reports.v1.SearchRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.reports.v1.SearchRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.shopping.merchant.reports.v1.ReportRow()),
              generateSampleMessage(new protos.google.shopping.merchant.reports.v1.ReportRow()),
              generateSampleMessage(new protos.google.shopping.merchant.reports.v1.ReportRow()),
            ];
        ...
        it('invokes search without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.search(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.reports.v1.IReportRow[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes searchStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.shopping.merchant.reports.v1.ReportRow[] = [];
                stream.on('data', (response: protos.google.shopping.merchant.reports.v1.ReportRow) => {
