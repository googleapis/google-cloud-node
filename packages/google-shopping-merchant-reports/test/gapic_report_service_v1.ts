  ...
  describe('search', () => {
    it('invokes search without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.shopping.merchant.reports.v1.ReportRow(),
        ),
        generateSampleMessage(
          new protos.google.shopping.merchant.reports.v1.ReportRow(),
        ),
      ...
      const promise = new Promise((resolve, reject) => {
        client.search(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.shopping.merchant.reports.v1.IReportRow[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes searchStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.shopping.merchant.reports.v1.ReportRow) => {
