  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          reportserviceModule.v1alpha.ReportServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          reportserviceModule.v1alpha.ReportServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new reportserviceModule.v1alpha.ReportServiceClient({
          universe_domain: 'example.com',
  ...
  describe('search', () => {
    it('invokes search without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.shopping.merchant.reports.v1alpha.SearchRequest',
        ['parent'],
      );
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.shopping.merchant.reports.v1alpha.ReportRow(),
        ),
        generateSampleMessage(
          new protos.google.shopping.merchant.reports.v1alpha.ReportRow(),
        ),
    ...
    it('invokes searchStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.shopping.merchant.reports.v1alpha.ReportRow,
          ) => {
