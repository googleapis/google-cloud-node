 ...
 * `src/v1beta/backup_dr_protection_summary_client_config.json`.
...
export class BackupDrProtectionSummaryClient {
    ...
    this.backupDrProtectionSummaryStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ...
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.backupdr.v1beta
   ...
   *   The first element of the array is Array of {@link protos.google.cloud.backupdr.v1beta.ResourceBackupConfig|ResourceBackupConfig}.
  ...
  listResourceBackupConfigs(
    request?: protos.google.cloud.backupdr.v1beta.IListResourceBackupConfigsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.backupdr.v1beta.IResourceBackupConfig[],
      protos.google.cloud.backupdr.v1beta.IListResourceBackupConfigsRequest | null,
      protos.google.cloud.backupdr.v1beta.IListResourceBackupConfigsResponse,
    ]
  >;
  listResourceBackupConfigs(
    request: protos.google.cloud.backupdr.v1beta.IListResourceBackupConfigsRequest,
    ...
    callback: PaginationCallback<
      protos.google.cloud.backupdr.v1beta.IListResourceBackupConfigsRequest,
      | protos.google.cloud.backupdr.v1beta.IListResourceBackupConfigsResponse
      | null
      | undefined,
      protos.google.cloud.backupdr.v1beta.IResourceBackupConfig
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.cloud.backupdr.v1beta.ResourceBackupConfig|ResourceBackupConfig} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
   ...
   *   {@link protos.google.cloud.backupdr.v1beta.ResourceBackupConfig|ResourceBackupConfig}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/backup_dr_protection_summary.list_resource_backup_configs.js</caption>
   * region_tag:backupdr_v1beta_generated_BackupDrProtectionSummary_ListResourceBackupConfigs_async
   */
  listResourceBackupConfigsAsync(
    request?: protos.google.cloud.backupdr.v1beta.IListResourceBackupConfigsRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.cloud.backupdr.v1beta.IResourceBackupConfig> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listResourceBackupConfigs.asyncIterate(
      ...
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.cloud.backupdr.v1beta.IResourceBackupConfig>;
  }
  /**
