...
describe('v1.BackupDRClient', () => {
  ...
  describe('getBackupPlanRevision', () => {
    it('invokes getBackupPlanRevision without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.backupdr.v1.GetBackupPlanRevisionRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.getBackupPlanRevision =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getBackupPlanRevision(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getBackupPlanRevision as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getBackupPlanRevision as SinonStub
    ...
    it('invokes getBackupPlanRevision without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getBackupPlanRevision(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.backupdr.v1.IBackupPlanRevision | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getBackupPlanRevision with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getBackupPlanRevision = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getBackupPlanRevision(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getBackupPlanRevision as SinonStub
  ...
  describe('getDataSourceReference', () => {
    it('invokes getDataSourceReference without error', async () => {
      ...
      client.innerApiCalls.getDataSourceReference =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getDataSourceReference(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getDataSourceReference as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getDataSourceReference as SinonStub
    ...
    it('invokes getDataSourceReference without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDataSourceReference(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.backupdr.v1.IDataSourceReference | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getDataSourceReference with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getDataSourceReference = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getDataSourceReference(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getDataSourceReference as SinonStub
  ...
  describe('updateBackupPlanAssociation', () => {
    it('invokes updateBackupPlanAssociation without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateBackupPlanAssociation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateBackupPlanAssociation as SinonStub
    ...
    it('invokes updateBackupPlanAssociation with call error', async () => {
      ...
      const expectedHeaderRequestParams = `backup_plan_association.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateBackupPlanAssociation = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateBackupPlanAssociation(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateBackupPlanAssociation as SinonStub
    ...
    it('invokes checkUpdateBackupPlanAssociationProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkUpdateBackupPlanAssociationProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('fetchBackupsForResourceType', () => {
    it('invokes fetchBackupsForResourceType without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.backupdr.v1.FetchBackupsForResourceTypeRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.fetchBackupsForResourceType =
        stubSimpleCall(expectedResponse);
      const [response] = await client.fetchBackupsForResourceType(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.fetchBackupsForResourceType as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.fetchBackupsForResourceType as SinonStub
    ...
    it('invokes fetchBackupsForResourceType with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.fetchBackupsForResourceType = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.fetchBackupsForResourceType(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.fetchBackupsForResourceType as SinonStub
    ...
    it('invokes fetchBackupsForResourceTypeStream without error', async () => {
      ...
      client.descriptors.page.fetchBackupsForResourceType.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      assert(
        (
          client.descriptors.page.fetchBackupsForResourceType
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(
    ...
    it('uses async iteration with fetchBackupsForResourceType without error', async () => {
      ...
      client.descriptors.page.fetchBackupsForResourceType.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.backupdr.v1.IBackup[] = [];
  ...
  describe('listBackupPlanRevisions', () => {
    it('invokes listBackupPlanRevisions without error', async () => {
      ...
      client.innerApiCalls.listBackupPlanRevisions =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listBackupPlanRevisions(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listBackupPlanRevisions as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listBackupPlanRevisions as SinonStub
    ...
    it('invokes listBackupPlanRevisions with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listBackupPlanRevisions = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listBackupPlanRevisions(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listBackupPlanRevisions as SinonStub
    ...
    it('invokes listBackupPlanRevisionsStream without error', async () => {
      ...
      client.descriptors.page.listBackupPlanRevisions.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.backupdr.v1.BackupPlanRevision) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (
          client.descriptors.page.listBackupPlanRevisions
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listBackupPlanRevisions, request),
      );
      assert(
        (
          client.descriptors.page.listBackupPlanRevisions
    ...
    it('uses async iteration with listBackupPlanRevisions without error', async () => {
      ...
      client.descriptors.page.listBackupPlanRevisions.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('fetchBackupPlanAssociationsForResourceType', () => {
    it('invokes fetchBackupPlanAssociationsForResourceType without error', async () => {
      ...
      client.innerApiCalls.fetchBackupPlanAssociationsForResourceType =
        stubSimpleCall(expectedResponse);
      const [response] =
        await client.fetchBackupPlanAssociationsForResourceType(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls
          .fetchBackupPlanAssociationsForResourceType as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls
    ...
    it('invokes fetchBackupPlanAssociationsForResourceType with error', async () => {
      ...
      await assert.rejects(
        client.fetchBackupPlanAssociationsForResourceType(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls
    ...
    it('invokes fetchBackupPlanAssociationsForResourceTypeStream without error', async () => {
      ...
      client.descriptors.page.fetchBackupPlanAssociationsForResourceType.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream =
        client.fetchBackupPlanAssociationsForResourceTypeStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.backupdr.v1.BackupPlanAssociation[] =
          [];
        stream.on(
      ...
      assert(
        (
          client.descriptors.page.fetchBackupPlanAssociationsForResourceType
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(
    ...
    it('uses async iteration with fetchBackupPlanAssociationsForResourceType without error', async () => {
      ...
      client.descriptors.page.fetchBackupPlanAssociationsForResourceType.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.backupdr.v1.IBackupPlanAssociation[] =
        [];
      const iterable =
        client.fetchBackupPlanAssociationsForResourceTypeAsync(request);
      for await (const resource of iterable) {
        responses.push(resource!);
      }
      assert.deepStrictEqual(responses, expectedResponse);
  ...
  describe('listDataSourceReferences', () => {
    it('invokes listDataSourceReferences without error', async () => {
      ...
      client.innerApiCalls.listDataSourceReferences =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listDataSourceReferences(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listDataSourceReferences as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listDataSourceReferences as SinonStub
    ...
    it('invokes listDataSourceReferences with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listDataSourceReferences = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listDataSourceReferences(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listDataSourceReferences as SinonStub
    ...
    it('invokes listDataSourceReferencesStream without error', async () => {
      ...
      client.descriptors.page.listDataSourceReferences.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.backupdr.v1.DataSourceReference) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (
          client.descriptors.page.listDataSourceReferences
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listDataSourceReferences, request),
      );
      assert(
        (
          client.descriptors.page.listDataSourceReferences
    ...
    it('uses async iteration with listDataSourceReferences without error', async () => {
      ...
      client.descriptors.page.listDataSourceReferences.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('fetchDataSourceReferencesForResourceType', () => {
    it('invokes fetchDataSourceReferencesForResourceType without error', async () => {
      ...
      client.innerApiCalls.fetchDataSourceReferencesForResourceType =
        stubSimpleCall(expectedResponse);
      const [response] =
        await client.fetchDataSourceReferencesForResourceType(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls
          .fetchDataSourceReferencesForResourceType as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls
    ...
    it('invokes fetchDataSourceReferencesForResourceType with error', async () => {
      ...
      client.innerApiCalls.fetchDataSourceReferencesForResourceType =
        stubSimpleCall(undefined, expectedError);
      await assert.rejects(
        client.fetchDataSourceReferencesForResourceType(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls
    ...
    it('invokes fetchDataSourceReferencesForResourceTypeStream without error', async () => {
      ...
      client.descriptors.page.fetchDataSourceReferencesForResourceType.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream =
        client.fetchDataSourceReferencesForResourceTypeStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.backupdr.v1.DataSourceReference[] =
          [];
        stream.on(
      ...
      assert(
        (
          client.descriptors.page.fetchDataSourceReferencesForResourceType
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(
    ...
    it('uses async iteration with fetchDataSourceReferencesForResourceType without error', async () => {
      ...
      client.descriptors.page.fetchDataSourceReferencesForResourceType.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.backupdr.v1.IDataSourceReference[] =
        [];
      const iterable =
        client.fetchDataSourceReferencesForResourceTypeAsync(request);
      for await (const resource of iterable) {
        responses.push(resource!);
      }
      assert.deepStrictEqual(responses, expectedResponse);
