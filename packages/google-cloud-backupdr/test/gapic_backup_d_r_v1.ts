...
describe('v1.BackupDRClient', () => {
  ...
  describe('initiateBackup', () => {
    it('invokes initiateBackup without error', async () => {
      const client = new backupdrModule.v1.BackupDRClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.backupdr.v1.InitiateBackupRequest()
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.backupdr.v1.InitiateBackupRequest',
        ['dataSource']
      );
      request.dataSource = defaultValue1;
      const expectedHeaderRequestParams = `data_source=${defaultValue1}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.backupdr.v1.InitiateBackupResponse()
      );
      client.innerApiCalls.initiateBackup = stubSimpleCall(expectedResponse);
      const [response] = await client.initiateBackup(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.initiateBackup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.initiateBackup as SinonStub
    ...
    it('invokes initiateBackup without error using callback', async () => {
      const client = new backupdrModule.v1.BackupDRClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.initiateBackup =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.initiateBackup(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.backupdr.v1.IInitiateBackupResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes initiateBackup with error', async () => {
      const client = new backupdrModule.v1.BackupDRClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `data_source=${defaultValue1}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.initiateBackup = stubSimpleCall(
        undefined,
        expectedError
      );
      await assert.rejects(client.initiateBackup(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.initiateBackup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes initiateBackup with closed client', async () => {
      const client = new backupdrModule.v1.BackupDRClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
  ...
  describe('fetchAccessToken', () => {
    it('invokes fetchAccessToken without error', async () => {
      ...
      client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.backupdr.v1.FetchAccessTokenRequest()
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.backupdr.v1.FetchAccessTokenResponse()
      );
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.fetchAccessToken as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.fetchAccessToken as SinonStub
    ...
    it('invokes fetchAccessToken without error using callback', async () => {
      ...
      client.innerApiCalls.fetchAccessToken =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.fetchAccessToken(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.backupdr.v1.IFetchAccessTokenResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes fetchAccessToken with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.fetchAccessToken = stubSimpleCall(
        undefined,
        expectedError
      );
  ...
  describe('removeDataSource', () => {
    it('invokes removeDataSource without error', async () => {
      const client = new backupdrModule.v1.BackupDRClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.backupdr.v1.RemoveDataSourceRequest()
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.removeDataSource =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.removeDataSource(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.removeDataSource as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.removeDataSource as SinonStub
    ...
    it('invokes removeDataSource without error using callback', async () => {
      const client = new backupdrModule.v1.BackupDRClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
    ...
    it('invokes removeDataSource with call error', async () => {
      const client = new backupdrModule.v1.BackupDRClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.removeDataSource = stubLongRunningCall(
        undefined,
        expectedError
      );
      await assert.rejects(client.removeDataSource(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.removeDataSource as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes removeDataSource with LRO error', async () => {
      const client = new backupdrModule.v1.BackupDRClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
    ...
    it('invokes checkRemoveDataSourceProgress without error', async () => {
      const client = new backupdrModule.v1.BackupDRClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkRemoveDataSourceProgress(
        expectedResponse.name
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkRemoveDataSourceProgress with error', async () => {
      const client = new backupdrModule.v1.BackupDRClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      await assert.rejects(
        client.checkRemoveDataSourceProgress(''),
        expectedError
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('setInternalStatus', () => {
    it('invokes setInternalStatus without error', async () => {
      const client = new backupdrModule.v1.BackupDRClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.backupdr.v1.SetInternalStatusRequest()
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.setInternalStatus =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.setInternalStatus(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.setInternalStatus as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.setInternalStatus as SinonStub
    ...
    it('invokes setInternalStatus without error using callback', async () => {
      const client = new backupdrModule.v1.BackupDRClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.setInternalStatus =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.setInternalStatus(
          request,
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.backupdr.v1.ISetInternalStatusResponse,
              protos.google.cloud.backupdr.v1.IOperationMetadata
            > | null
          ) => {
            if (err) {
    ...
    it('invokes setInternalStatus with call error', async () => {
      const client = new backupdrModule.v1.BackupDRClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `data_source=${defaultValue1}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.setInternalStatus = stubLongRunningCall(
        undefined,
        expectedError
      );
      await assert.rejects(client.setInternalStatus(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.setInternalStatus as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes setInternalStatus with LRO error', async () => {
      const client = new backupdrModule.v1.BackupDRClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
    ...
    it('invokes checkSetInternalStatusProgress without error', async () => {
      const client = new backupdrModule.v1.BackupDRClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkSetInternalStatusProgress(
        expectedResponse.name
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkSetInternalStatusProgress with error', async () => {
      const client = new backupdrModule.v1.BackupDRClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      await assert.rejects(
        client.checkSetInternalStatusProgress(''),
        expectedError
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('abandonBackup', () => {
    it('invokes abandonBackup without error', async () => {
      const client = new backupdrModule.v1.BackupDRClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.backupdr.v1.AbandonBackupRequest()
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.backupdr.v1.AbandonBackupRequest',
        ['dataSource']
      );
      request.dataSource = defaultValue1;
      const expectedHeaderRequestParams = `data_source=${defaultValue1}`;
      ...
      client.innerApiCalls.abandonBackup =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.abandonBackup(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.abandonBackup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.abandonBackup as SinonStub
    ...
    it('invokes abandonBackup without error using callback', async () => {
      const client = new backupdrModule.v1.BackupDRClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
    ...
    it('invokes abandonBackup with call error', async () => {
      const client = new backupdrModule.v1.BackupDRClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `data_source=${defaultValue1}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.abandonBackup = stubLongRunningCall(
        undefined,
        expectedError
      );
      await assert.rejects(client.abandonBackup(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.abandonBackup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes abandonBackup with LRO error', async () => {
      const client = new backupdrModule.v1.BackupDRClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
    ...
    it('invokes checkAbandonBackupProgress without error', async () => {
      const client = new backupdrModule.v1.BackupDRClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkAbandonBackupProgress(
        expectedResponse.name
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkAbandonBackupProgress with error', async () => {
      const client = new backupdrModule.v1.BackupDRClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      await assert.rejects(
        client.checkAbandonBackupProgress(''),
        expectedError
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('finalizeBackup', () => {
    it('invokes finalizeBackup without error', async () => {
      const client = new backupdrModule.v1.BackupDRClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.backupdr.v1.FinalizeBackupRequest()
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.finalizeBackup =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.finalizeBackup(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.finalizeBackup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.finalizeBackup as SinonStub
    ...
    it('invokes finalizeBackup without error using callback', async () => {
      const client = new backupdrModule.v1.BackupDRClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
    ...
    it('invokes finalizeBackup with call error', async () => {
      const client = new backupdrModule.v1.BackupDRClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `data_source=${defaultValue1}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.finalizeBackup = stubLongRunningCall(
        undefined,
        expectedError
      );
      await assert.rejects(client.finalizeBackup(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.finalizeBackup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes finalizeBackup with LRO error', async () => {
      const client = new backupdrModule.v1.BackupDRClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
    ...
    it('invokes checkFinalizeBackupProgress without error', async () => {
      const client = new backupdrModule.v1.BackupDRClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkFinalizeBackupProgress(
        expectedResponse.name
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkFinalizeBackupProgress with error', async () => {
      const client = new backupdrModule.v1.BackupDRClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      await assert.rejects(
        client.checkFinalizeBackupProgress(''),
        expectedError
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
