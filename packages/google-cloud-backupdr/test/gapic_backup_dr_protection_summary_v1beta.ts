...
describe('v1beta.BackupDrProtectionSummaryClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new backupdrprotectionsummaryModule.v1beta.BackupDrProtectionSummaryClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          backupdrprotectionsummaryModule.v1beta.BackupDrProtectionSummaryClient
            .servicePath;
  ...
  describe('listResourceBackupConfigs', () => {
    it('invokes listResourceBackupConfigs without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.backupdr.v1beta.ListResourceBackupConfigsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.backupdr.v1beta.ListResourceBackupConfigsRequest',
        ['parent'],
      );
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.backupdr.v1beta.ResourceBackupConfig(),
        ),
        generateSampleMessage(
          new protos.google.cloud.backupdr.v1beta.ResourceBackupConfig(),
        ),
      ...
      const actualRequest = (
        client.innerApiCalls.listResourceBackupConfigs as SinonStub
      ).getCall(0).args[0];
      ...
      const promise = new Promise((resolve, reject) => {
        client.listResourceBackupConfigs(
          ...
          (
            err?: Error | null,
            result?:
              | protos.google.cloud.backupdr.v1beta.IResourceBackupConfig[]
              | null,
          ) => {
            if (err) {
              reject(err);
    ...
    it('invokes listResourceBackupConfigs with error', async () => {
      ...
      client.innerApiCalls.listResourceBackupConfigs = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listResourceBackupConfigs(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listResourceBackupConfigs as SinonStub
    ...
    it('invokes listResourceBackupConfigsStream without error', async () => {
      ...
      client.descriptors.page.listResourceBackupConfigs.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listResourceBackupConfigsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.backupdr.v1beta.ResourceBackupConfig[] =
          [];
        stream.on(
          'data',
          (
            response: protos.google.cloud.backupdr.v1beta.ResourceBackupConfig,
          ) => {
      ...
      assert(
        (
          client.descriptors.page.listResourceBackupConfigs
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listResourceBackupConfigs, request),
      );
      assert(
        (
          client.descriptors.page.listResourceBackupConfigs
    ...
    it('uses async iteration with listResourceBackupConfigs without error', async () => {
      ...
      client.descriptors.page.listResourceBackupConfigs.asyncIterate =
  ...
  describe('Path templates', () => {
    describe('appliedAutoProtectionPolicy', async () => {
      const fakePath = '/rendered/path/appliedAutoProtectionPolicy';
      const expectedParameters = {
        project: 'projectValue',
        location: 'locationValue',
        applied_auto_protection_policy: 'appliedAutoProtectionPolicyValue',
      };
      const client =
        new backupdrprotectionsummaryModule.v1beta.BackupDrProtectionSummaryClient(
          {
      ...
      await client.initialize();
      client.pathTemplates.appliedAutoProtectionPolicyPathTemplate.render =
        sinon.stub().returns(fakePath);
      client.pathTemplates.appliedAutoProtectionPolicyPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('appliedAutoProtectionPolicyPath', () => {
        const result = client.appliedAutoProtectionPolicyPath(
          'projectValue',
          'locationValue',
          'appliedAutoProtectionPolicyValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.appliedAutoProtectionPolicyPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
      ...
      it('matchProjectFromAppliedAutoProtectionPolicyName', () => {
        const result =
          client.matchProjectFromAppliedAutoProtectionPolicyName(fakePath);
      ...
      it('matchLocationFromAppliedAutoProtectionPolicyName', () => {
        const result =
          client.matchLocationFromAppliedAutoProtectionPolicyName(fakePath);
      ...
      it('matchAppliedAutoProtectionPolicyFromAppliedAutoProtectionPolicyName', () => {
        const result =
          client.matchAppliedAutoProtectionPolicyFromAppliedAutoProtectionPolicyName(
            fakePath,
          );
        assert.strictEqual(result, 'appliedAutoProtectionPolicyValue');
        assert(
          (
            client.pathTemplates.appliedAutoProtectionPolicyPathTemplate
              .match as SinonStub
    ...
    describe('autoProtectionPolicy', async () => {
      const fakePath = '/rendered/path/autoProtectionPolicy';
      const expectedParameters = {
        project: 'projectValue',
        location: 'locationValue',
        auto_protection_policy: 'autoProtectionPolicyValue',
      };
      const client =
        new backupdrprotectionsummaryModule.v1beta.BackupDrProtectionSummaryClient(
          {
      ...
      await client.initialize();
      client.pathTemplates.autoProtectionPolicyPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.autoProtectionPolicyPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('autoProtectionPolicyPath', () => {
        const result = client.autoProtectionPolicyPath(
          'projectValue',
          'locationValue',
          'autoProtectionPolicyValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.autoProtectionPolicyPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromAutoProtectionPolicyName', () => {
        const result =
          client.matchProjectFromAutoProtectionPolicyName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.autoProtectionPolicyPathTemplate
      ...
      it('matchLocationFromAutoProtectionPolicyName', () => {
        const result =
          client.matchLocationFromAutoProtectionPolicyName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.autoProtectionPolicyPathTemplate
      ...
      it('matchAutoProtectionPolicyFromAutoProtectionPolicyName', () => {
        const result =
          client.matchAutoProtectionPolicyFromAutoProtectionPolicyName(
            fakePath,
          );
        assert.strictEqual(result, 'autoProtectionPolicyValue');
        assert(
          (
            client.pathTemplates.autoProtectionPolicyPathTemplate
              .match as SinonStub
    ...
    describe('autoProtectionPolicyBinding', async () => {
      const fakePath = '/rendered/path/autoProtectionPolicyBinding';
      const expectedParameters = {
        project: 'projectValue',
        location: 'locationValue',
        auto_protection_policy: 'autoProtectionPolicyValue',
      ...
      await client.initialize();
      client.pathTemplates.autoProtectionPolicyBindingPathTemplate.render =
        sinon.stub().returns(fakePath);
      client.pathTemplates.autoProtectionPolicyBindingPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('autoProtectionPolicyBindingPath', () => {
        const result = client.autoProtectionPolicyBindingPath(
          'projectValue',
          'locationValue',
          'autoProtectionPolicyValue',
          'bindingValue',
        ...
        assert(
          (
            client.pathTemplates.autoProtectionPolicyBindingPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromAutoProtectionPolicyBindingName', () => {
        const result =
          client.matchProjectFromAutoProtectionPolicyBindingName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.autoProtectionPolicyBindingPathTemplate
      ...
      it('matchLocationFromAutoProtectionPolicyBindingName', () => {
        const result =
          client.matchLocationFromAutoProtectionPolicyBindingName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.autoProtectionPolicyBindingPathTemplate
      ...
      it('matchAutoProtectionPolicyFromAutoProtectionPolicyBindingName', () => {
        const result =
          client.matchAutoProtectionPolicyFromAutoProtectionPolicyBindingName(
            fakePath,
          );
        assert.strictEqual(result, 'autoProtectionPolicyValue');
        assert(
      ...
      it('matchBindingFromAutoProtectionPolicyBindingName', () => {
        const result =
          client.matchBindingFromAutoProtectionPolicyBindingName(fakePath);
    ...
    describe('backupPlanRevision', async () => {
      ...
      await client.initialize();
      client.pathTemplates.backupPlanRevisionPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.backupPlanRevisionPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('backupPlanRevisionPath', () => {
        const result = client.backupPlanRevisionPath(
          'projectValue',
          'locationValue',
          'backupPlanValue',
          'revisionValue',
      ...
      it('matchBackupPlanFromBackupPlanRevisionName', () => {
        const result =
          client.matchBackupPlanFromBackupPlanRevisionName(fakePath);
        assert.strictEqual(result, 'backupPlanValue');
        assert(
          (
            client.pathTemplates.backupPlanRevisionPathTemplate
    ...
    describe('bindingMatchingResource', async () => {
      const fakePath = '/rendered/path/bindingMatchingResource';
      const expectedParameters = {
        project: 'projectValue',
        location: 'locationValue',
        auto_protection_policy: 'autoProtectionPolicyValue',
        binding: 'bindingValue',
        matching_resource: 'matchingResourceValue',
      };
      const client =
        new backupdrprotectionsummaryModule.v1beta.BackupDrProtectionSummaryClient(
          {
      ...
      await client.initialize();
      client.pathTemplates.bindingMatchingResourcePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.bindingMatchingResourcePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('bindingMatchingResourcePath', () => {
        const result = client.bindingMatchingResourcePath(
          'projectValue',
          'locationValue',
          'autoProtectionPolicyValue',
          'bindingValue',
          'matchingResourceValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.bindingMatchingResourcePathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromBindingMatchingResourceName', () => {
        const result =
          client.matchProjectFromBindingMatchingResourceName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.bindingMatchingResourcePathTemplate
      ...
      it('matchLocationFromBindingMatchingResourceName', () => {
        const result =
          client.matchLocationFromBindingMatchingResourceName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.bindingMatchingResourcePathTemplate
      ...
      it('matchAutoProtectionPolicyFromBindingMatchingResourceName', () => {
        const result =
          client.matchAutoProtectionPolicyFromBindingMatchingResourceName(
            fakePath,
          );
        assert.strictEqual(result, 'autoProtectionPolicyValue');
        assert(
      ...
      it('matchBindingFromBindingMatchingResourceName', () => {
        const result =
          client.matchBindingFromBindingMatchingResourceName(fakePath);
        assert.strictEqual(result, 'bindingValue');
        assert(
          (
            client.pathTemplates.bindingMatchingResourcePathTemplate
      ...
      it('matchMatchingResourceFromBindingMatchingResourceName', () => {
        const result =
          client.matchMatchingResourceFromBindingMatchingResourceName(fakePath);
        assert.strictEqual(result, 'matchingResourceValue');
        assert(
          (
            client.pathTemplates.bindingMatchingResourcePathTemplate
              .match as SinonStub
    ...
    describe('dataSourceReference', async () => {
      ...
      await client.initialize();
      client.pathTemplates.dataSourceReferencePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.dataSourceReferencePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('dataSourceReferencePath', () => {
        const result = client.dataSourceReferencePath(
          'projectValue',
          'locationValue',
        ...
        assert(
          (
            client.pathTemplates.dataSourceReferencePathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchLocationFromDataSourceReferenceName', () => {
        const result =
          client.matchLocationFromDataSourceReferenceName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.dataSourceReferencePathTemplate
      ...
      it('matchDataSourceReferenceFromDataSourceReferenceName', () => {
        const result =
          client.matchDataSourceReferenceFromDataSourceReferenceName(fakePath);
    ...
    describe('resourceBackupConfig', async () => {
      ...
      await client.initialize();
      client.pathTemplates.resourceBackupConfigPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.resourceBackupConfigPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('resourceBackupConfigPath', () => {
        const result = client.resourceBackupConfigPath(
          'projectValue',
          'locationValue',
          'resourceBackupConfigValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
      ...
      it('matchProjectFromResourceBackupConfigName', () => {
        const result =
          client.matchProjectFromResourceBackupConfigName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.resourceBackupConfigPathTemplate
      ...
      it('matchLocationFromResourceBackupConfigName', () => {
        const result =
          client.matchLocationFromResourceBackupConfigName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.resourceBackupConfigPathTemplate
      ...
      it('matchResourceBackupConfigFromResourceBackupConfigName', () => {
        const result =
          client.matchResourceBackupConfigFromResourceBackupConfigName(
            fakePath,
          );
