  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          backupdrprotectionsummaryModule.v1.BackupDrProtectionSummaryClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        backupdrprotectionsummaryModule.v1.BackupDrProtectionSummaryClient.port;
      assert(port);
  ...
  describe('listResourceBackupConfigs', () => {
    it('invokes listResourceBackupConfigs without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.backupdr.v1.ResourceBackupConfig(),
        ),
        generateSampleMessage(
          new protos.google.cloud.backupdr.v1.ResourceBackupConfig(),
        ),
    ...
    it('invokes listResourceBackupConfigsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.backupdr.v1.ResourceBackupConfig) => {
