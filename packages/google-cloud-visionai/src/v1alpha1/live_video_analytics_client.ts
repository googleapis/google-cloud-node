...
export class LiveVideoAnalyticsClient {
    ...
    this.liveVideoAnalyticsStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ...
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.visionai.v1alpha1
            .LiveVideoAnalytics,
      this._opts,
      this._providedCustomServicePath,
   ...
   *   The first element of the array is an object representing {@link protos.google.cloud.visionai.v1alpha1.Analysis|Analysis}.
  ...
  getAnalysis(
    ...
    [
      ...
      protos.google.cloud.visionai.v1alpha1.IGetAnalysisRequest | undefined,
      {} | undefined,
    ]
  >;
  getAnalysis(
    ...
    callback: Callback<
      protos.google.cloud.visionai.v1alpha1.IAnalysis,
      | protos.google.cloud.visionai.v1alpha1.IGetAnalysisRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  async checkCreateAnalysisProgress(
    ...
    LROperation<
      protos.google.cloud.visionai.v1alpha1.Analysis,
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.cloud.visionai.v1alpha1.Analysis|Analysis}.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.cloud.visionai.v1alpha1.Analysis|Analysis} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
   ...
   *   {@link protos.google.cloud.visionai.v1alpha1.Analysis|Analysis}. The API will be called under the hood as needed, once per the page,
