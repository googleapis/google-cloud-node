...
export class WarehouseClient {
  ...
  constructor(
    ...
    const deleteAssetMetadata = protoFilesRoot.lookup(
      '.google.cloud.visionai.v1alpha1.DeleteAssetMetadata',
    ) as gax.protobuf.Type;
    ...
    const createCorpusMetadata = protoFilesRoot.lookup(
      '.google.cloud.visionai.v1alpha1.CreateCorpusMetadata',
    ) as gax.protobuf.Type;
   ...
   *   The first element of the array is an object representing {@link protos.google.cloud.visionai.v1alpha1.Asset|Asset}.
  ...
  createAsset(
    ...
    [
      ...
      protos.google.cloud.visionai.v1alpha1.ICreateAssetRequest | undefined,
      {} | undefined,
    ]
  >;
  createAsset(
    ...
    callback: Callback<
      protos.google.cloud.visionai.v1alpha1.IAsset,
      | protos.google.cloud.visionai.v1alpha1.ICreateAssetRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  updateAsset(
    ...
    [
      protos.google.cloud.visionai.v1alpha1.IAsset,
      protos.google.cloud.visionai.v1alpha1.IUpdateAssetRequest | undefined,
      {} | undefined,
    ]
  >;
  updateAsset(
    ...
    callback: Callback<
      protos.google.cloud.visionai.v1alpha1.IAsset,
      | protos.google.cloud.visionai.v1alpha1.IUpdateAssetRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  getAsset(
    ...
    [
      protos.google.cloud.visionai.v1alpha1.IAsset,
      protos.google.cloud.visionai.v1alpha1.IGetAssetRequest | undefined,
      {} | undefined,
    ]
  >;
  getAsset(
  ...
  getAsset(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.cloud.visionai.v1alpha1.IAsset,
          | protos.google.cloud.visionai.v1alpha1.IGetAssetRequest
          | null
          | undefined,
          {} | null | undefined
        >,
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.cloud.visionai.v1alpha1.Corpus|Corpus}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
  ...
  getCorpus(
    ...
    [
      ...
      protos.google.cloud.visionai.v1alpha1.IGetCorpusRequest | undefined,
      {} | undefined,
    ]
  >;
  getCorpus(
    ...
    callback: Callback<
      protos.google.cloud.visionai.v1alpha1.ICorpus,
      | protos.google.cloud.visionai.v1alpha1.IGetCorpusRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  updateCorpus(
    ...
    [
      protos.google.cloud.visionai.v1alpha1.ICorpus,
      protos.google.cloud.visionai.v1alpha1.IUpdateCorpusRequest | undefined,
      {} | undefined,
    ]
  >;
  updateCorpus(
    ...
    callback: Callback<
      protos.google.cloud.visionai.v1alpha1.ICorpus,
      | protos.google.cloud.visionai.v1alpha1.IUpdateCorpusRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  deleteCorpus(
    ...
    [
      ...
      protos.google.cloud.visionai.v1alpha1.IDeleteCorpusRequest | undefined,
      {} | undefined,
    ]
  >;
  deleteCorpus(
    ...
    callback: Callback<
      protos.google.protobuf.IEmpty,
      | protos.google.cloud.visionai.v1alpha1.IDeleteCorpusRequest
      | null
      | undefined,
      {} | null | undefined
    >,
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.cloud.visionai.v1alpha1.DataSchema|DataSchema}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
  ...
  createDataSchema(
    ...
    [
      ...
      (
        | protos.google.cloud.visionai.v1alpha1.ICreateDataSchemaRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  updateDataSchema(
    ...
    [
      protos.google.cloud.visionai.v1alpha1.IDataSchema,
      (
        | protos.google.cloud.visionai.v1alpha1.IUpdateDataSchemaRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  getDataSchema(
    ...
    [
      protos.google.cloud.visionai.v1alpha1.IDataSchema,
      protos.google.cloud.visionai.v1alpha1.IGetDataSchemaRequest | undefined,
      {} | undefined,
    ]
  >;
  getDataSchema(
    ...
    callback: Callback<
      protos.google.cloud.visionai.v1alpha1.IDataSchema,
      | protos.google.cloud.visionai.v1alpha1.IGetDataSchemaRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  deleteDataSchema(
    ...
    [
      protos.google.protobuf.IEmpty,
      (
        | protos.google.cloud.visionai.v1alpha1.IDeleteDataSchemaRequest
        | undefined
      ),
      {} | undefined,
    ]
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.cloud.visionai.v1alpha1.Annotation|Annotation}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
  ...
  createAnnotation(
    ...
    [
      ...
      (
        | protos.google.cloud.visionai.v1alpha1.ICreateAnnotationRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  getAnnotation(
    ...
    [
      protos.google.cloud.visionai.v1alpha1.IAnnotation,
      protos.google.cloud.visionai.v1alpha1.IGetAnnotationRequest | undefined,
      {} | undefined,
    ]
  >;
  getAnnotation(
    ...
    callback: Callback<
      protos.google.cloud.visionai.v1alpha1.IAnnotation,
      | protos.google.cloud.visionai.v1alpha1.IGetAnnotationRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  updateAnnotation(
    ...
    [
      protos.google.cloud.visionai.v1alpha1.IAnnotation,
      (
        | protos.google.cloud.visionai.v1alpha1.IUpdateAnnotationRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  deleteAnnotation(
    ...
    [
      protos.google.protobuf.IEmpty,
      (
        | protos.google.cloud.visionai.v1alpha1.IDeleteAnnotationRequest
        | undefined
      ),
      {} | undefined,
    ]
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.cloud.visionai.v1alpha1.ClipAssetResponse|ClipAssetResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
  ...
  clipAsset(
    ...
    [
      ...
      protos.google.cloud.visionai.v1alpha1.IClipAssetRequest | undefined,
      {} | undefined,
    ]
  >;
  clipAsset(
    ...
    callback: Callback<
      protos.google.cloud.visionai.v1alpha1.IClipAssetResponse,
      | protos.google.cloud.visionai.v1alpha1.IClipAssetRequest
      | null
      | undefined,
      {} | null | undefined
    >,
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.cloud.visionai.v1alpha1.GenerateHlsUriResponse|GenerateHlsUriResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
  ...
  generateHlsUri(
    ...
    [
      ...
      protos.google.cloud.visionai.v1alpha1.IGenerateHlsUriRequest | undefined,
      {} | undefined,
    ]
  >;
  generateHlsUri(
    ...
    callback: Callback<
      protos.google.cloud.visionai.v1alpha1.IGenerateHlsUriResponse,
      | protos.google.cloud.visionai.v1alpha1.IGenerateHlsUriRequest
      | null
      | undefined,
      {} | null | undefined
    >,
   ...
   *   valid characters are /{@link protos.0-9|a-z}-_/. The first character must be a letter,
   *   the last could be a letter or a number.
   * @param {object} [options]
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.cloud.visionai.v1alpha1.SearchConfig|SearchConfig}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
  ...
  createSearchConfig(
    ...
    [
      ...
      (
        | protos.google.cloud.visionai.v1alpha1.ICreateSearchConfigRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  updateSearchConfig(
    ...
    [
      protos.google.cloud.visionai.v1alpha1.ISearchConfig,
      (
        | protos.google.cloud.visionai.v1alpha1.IUpdateSearchConfigRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  getSearchConfig(
    ...
    [
      protos.google.cloud.visionai.v1alpha1.ISearchConfig,
      protos.google.cloud.visionai.v1alpha1.IGetSearchConfigRequest | undefined,
      {} | undefined,
    ]
  >;
  getSearchConfig(
    ...
    callback: Callback<
      protos.google.cloud.visionai.v1alpha1.ISearchConfig,
      | protos.google.cloud.visionai.v1alpha1.IGetSearchConfigRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  deleteSearchConfig(
    ...
    [
      protos.google.protobuf.IEmpty,
      (
        | protos.google.cloud.visionai.v1alpha1.IDeleteSearchConfigRequest
        | undefined
      ),
      {} | undefined,
    ]
   ...
   *   representing {@link protos.google.cloud.visionai.v1alpha1.IngestAssetRequest|IngestAssetRequest} for write() method, and
   *   will emit objects representing {@link protos.google.cloud.visionai.v1alpha1.IngestAssetResponse|IngestAssetResponse} on 'data' event asynchronously.
  ...
  async checkDeleteAssetProgress(
    ...
    LROperation<
      ...
      protos.google.cloud.visionai.v1alpha1.DeleteAssetMetadata
    >
  > {
  ...
  async checkCreateCorpusProgress(
    ...
    LROperation<
      protos.google.cloud.visionai.v1alpha1.Corpus,
      protos.google.cloud.visionai.v1alpha1.CreateCorpusMetadata
    >
  > {
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.cloud.visionai.v1alpha1.Asset|Asset}.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.cloud.visionai.v1alpha1.Asset|Asset} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
   ...
   *   {@link protos.google.cloud.visionai.v1alpha1.Asset|Asset}. The API will be called under the hood as needed, once per the page,
   ...
   *   Typically obtained via {@link protos.|ListCorpora.next_page_token} of the previous
   *   {@link protos.google.cloud.visionai.v1alpha1.Warehouse.ListCorpora|Warehouse.ListCorpora} call.
   * @param {object} [options]
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.cloud.visionai.v1alpha1.Corpus|Corpus}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.cloud.visionai.v1alpha1.Corpus|Corpus} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed. Note that it can affect your quota.
   *   We recommend using `listCorporaAsync()`
   *   method described below for async iteration which you can stop as needed.
   ...
   *   An iterable Object that allows {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols | async iteration }.
   *   When you iterate the returned iterable, each element will be an object representing
   *   {@link protos.google.cloud.visionai.v1alpha1.Corpus|Corpus}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.cloud.visionai.v1alpha1.DataSchema|DataSchema}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.cloud.visionai.v1alpha1.DataSchema|DataSchema} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed. Note that it can affect your quota.
   *   We recommend using `listDataSchemasAsync()`
   *   method described below for async iteration which you can stop as needed.
   ...
   *   An iterable Object that allows {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols | async iteration }.
   *   When you iterate the returned iterable, each element will be an object representing
   *   {@link protos.google.cloud.visionai.v1alpha1.DataSchema|DataSchema}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.cloud.visionai.v1alpha1.Annotation|Annotation}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.cloud.visionai.v1alpha1.Annotation|Annotation} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed. Note that it can affect your quota.
   *   We recommend using `listAnnotationsAsync()`
   *   method described below for async iteration which you can stop as needed.
   ...
   *   An iterable Object that allows {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols | async iteration }.
   *   When you iterate the returned iterable, each element will be an object representing
   *   {@link protos.google.cloud.visionai.v1alpha1.Annotation|Annotation}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.cloud.visionai.v1alpha1.SearchConfig|SearchConfig}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.cloud.visionai.v1alpha1.SearchConfig|SearchConfig} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed. Note that it can affect your quota.
   *   We recommend using `listSearchConfigsAsync()`
   *   method described below for async iteration which you can stop as needed.
   ...
   *   An iterable Object that allows {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols | async iteration }.
   *   When you iterate the returned iterable, each element will be an object representing
   *   {@link protos.google.cloud.visionai.v1alpha1.SearchConfig|SearchConfig}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.cloud.visionai.v1alpha1.SearchResultItem|SearchResultItem}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.cloud.visionai.v1alpha1.SearchResultItem|SearchResultItem} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed. Note that it can affect your quota.
   *   We recommend using `searchAssetsAsync()`
   *   method described below for async iteration which you can stop as needed.
   ...
   *   An iterable Object that allows {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols | async iteration }.
   *   When you iterate the returned iterable, each element will be an object representing
   *   {@link protos.google.cloud.visionai.v1alpha1.SearchResultItem|SearchResultItem}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
