...
export class StreamingServiceClient {
   ...
   *     const client = new StreamingServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(
    opts?: ClientOptions,
    ...
    this.descriptors.stream = {
      sendPackets: new this._gaxModule.StreamDescriptor(
        this._gaxModule.StreamType.BIDI_STREAMING,
        !!opts.fallback,
        !!opts.gaxServerStreamingRetries,
      ),
      receivePackets: new this._gaxModule.StreamDescriptor(
        this._gaxModule.StreamType.BIDI_STREAMING,
        !!opts.fallback,
        !!opts.gaxServerStreamingRetries,
      ),
      receiveEvents: new this._gaxModule.StreamDescriptor(
        this._gaxModule.StreamType.BIDI_STREAMING,
        !!opts.fallback,
        !!opts.gaxServerStreamingRetries,
      ),
   ...
   *   The first element of the array is an object representing {@link protos.google.cloud.visionai.v1alpha1.Lease|Lease}.
  ...
  acquireLease(
    ...
    [
      ...
      protos.google.cloud.visionai.v1alpha1.IAcquireLeaseRequest | undefined,
      {} | undefined,
    ]
  >;
  acquireLease(
    ...
    callback: Callback<
      protos.google.cloud.visionai.v1alpha1.ILease,
      | protos.google.cloud.visionai.v1alpha1.IAcquireLeaseRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    this._log.info('acquireLease request %j', request);
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('acquireLease response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .acquireLease(request, options, wrappedCallback)
      ?.then(
  ...
  renewLease(
    ...
    [
      protos.google.cloud.visionai.v1alpha1.ILease,
      protos.google.cloud.visionai.v1alpha1.IRenewLeaseRequest | undefined,
      {} | undefined,
    ]
  >;
  renewLease(
    ...
    callback: Callback<
      protos.google.cloud.visionai.v1alpha1.ILease,
      | protos.google.cloud.visionai.v1alpha1.IRenewLeaseRequest
      | null
      | undefined,
      {} | null | undefined
    >,
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.cloud.visionai.v1alpha1.ReleaseLeaseResponse|ReleaseLeaseResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
  ...
  releaseLease(
    ...
    [
      ...
      protos.google.cloud.visionai.v1alpha1.IReleaseLeaseRequest | undefined,
      {} | undefined,
    ]
  >;
  releaseLease(
    ...
    callback: Callback<
      protos.google.cloud.visionai.v1alpha1.IReleaseLeaseResponse,
      | protos.google.cloud.visionai.v1alpha1.IReleaseLeaseRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    this._log.info('releaseLease request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.cloud.visionai.v1alpha1.IReleaseLeaseResponse,
          | protos.google.cloud.visionai.v1alpha1.IReleaseLeaseRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('releaseLease response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .releaseLease(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.cloud.visionai.v1alpha1.IReleaseLeaseResponse,
          (
   ...
   *   representing {@link protos.google.cloud.visionai.v1alpha1.SendPacketsRequest|SendPacketsRequest} for write() method, and
   *   will emit objects representing {@link protos.google.cloud.visionai.v1alpha1.SendPacketsResponse|SendPacketsResponse} on 'data' event asynchronously.
   ...
   */
  sendPackets(options?: CallOptions): gax.CancellableStream {
    this.initialize().catch((err) => {
      throw err;
    });
    this._log.info('sendPackets stream %j', options);
   ...
   * @returns {Stream}
   *   An object stream which is both readable and writable. It accepts objects
   *   representing {@link protos.google.cloud.visionai.v1alpha1.ReceivePacketsRequest|ReceivePacketsRequest} for write() method, and
   *   will emit objects representing {@link protos.google.cloud.visionai.v1alpha1.ReceivePacketsResponse|ReceivePacketsResponse} on 'data' event asynchronously.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#bi-directional-streaming | documentation }
   *   for more details and examples.
   ...
   */
  receivePackets(options?: CallOptions): gax.CancellableStream {
    this.initialize().catch((err) => {
      throw err;
    });
    this._log.info('receivePackets stream %j', options);
   ...
   * @returns {Stream}
   *   An object stream which is both readable and writable. It accepts objects
   *   representing {@link protos.google.cloud.visionai.v1alpha1.ReceiveEventsRequest|ReceiveEventsRequest} for write() method, and
   *   will emit objects representing {@link protos.google.cloud.visionai.v1alpha1.ReceiveEventsResponse|ReceiveEventsResponse} on 'data' event asynchronously.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#bi-directional-streaming | documentation }
   *   for more details and examples.
   ...
   */
  receiveEvents(options?: CallOptions): gax.CancellableStream {
    this.initialize().catch((err) => {
      throw err;
    });
    this._log.info('receiveEvents stream %j', options);
