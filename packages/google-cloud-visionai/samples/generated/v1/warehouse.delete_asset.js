...
function main(name) {
  // [START warehouse-visionai_v1_generated_Warehouse_DeleteAsset_async]
  /**
  ...
  async function callDeleteAsset() {
    ...
    // Run request
    const [operation] = await visionaiClient.deleteAsset(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callDeleteAsset();
  // [END warehouse-visionai_v1_generated_Warehouse_DeleteAsset_async]
}
