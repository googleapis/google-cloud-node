...
function main(name) {
  // [START warehouse-visionai_v1_generated_Warehouse_DeleteDataSchema_async]
  /**
  ...
  async function callDeleteDataSchema() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await visionaiClient.deleteDataSchema(request);
    console.log(response);
  }

  callDeleteDataSchema();
  // [END warehouse-visionai_v1_generated_Warehouse_DeleteDataSchema_async]
}
