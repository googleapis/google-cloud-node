...
function main(parent) {
  // [START warehouse-visionai_v1_generated_Warehouse_ListDataSchemas_async]
  /**
  ...
  async function callListDataSchemas() {
    ...
    // Run request
    const iterable = visionaiClient.listDataSchemasAsync(request);
  ...
  callListDataSchemas();
  // [END warehouse-visionai_v1_generated_Warehouse_ListDataSchemas_async]
}
