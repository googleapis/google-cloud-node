...
function main(parent) {
  // [START warehouse-visionai_v1_generated_Warehouse_ImportAssets_async]
  /**
  ...
  async function callImportAssets() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const [operation] = await visionaiClient.importAssets(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callImportAssets();
  // [END warehouse-visionai_v1_generated_Warehouse_ImportAssets_async]
}
