...
function main(name) {
  // [START warehouse-visionai_v1_generated_Warehouse_GetDataSchema_async]
  /**
  ...
  async function callGetDataSchema() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await visionaiClient.getDataSchema(request);
    console.log(response);
  }

  callGetDataSchema();
  // [END warehouse-visionai_v1_generated_Warehouse_GetDataSchema_async]
}
