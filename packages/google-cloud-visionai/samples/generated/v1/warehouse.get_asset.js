...
function main(name) {
  // [START warehouse-visionai_v1_generated_Warehouse_GetAsset_async]
  /**
  ...
  async function callGetAsset() {
    ...
    // Run request
    const response = await visionaiClient.getAsset(request);
    console.log(response);
  }

  callGetAsset();
  // [END warehouse-visionai_v1_generated_Warehouse_GetAsset_async]
}
