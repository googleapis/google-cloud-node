...
function main(indexEndpoint) {
  // [START warehouse-visionai_v1_generated_Warehouse_UndeployIndex_async]
  /**
  ...
  async function callUndeployIndex() {
    ...
    // Run request
    const [operation] = await visionaiClient.undeployIndex(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callUndeployIndex();
  // [END warehouse-visionai_v1_generated_Warehouse_UndeployIndex_async]
}
