...
function main(parent, searchConfig, searchConfigId) {
  // [START warehouse-visionai_v1_generated_Warehouse_CreateSearchConfig_async]
  /**
  ...
  async function callCreateSearchConfig() {
    // Construct request
    const request = {
      parent,
      searchConfig,
    ...
    // Run request
    const response = await visionaiClient.createSearchConfig(request);
    console.log(response);
  }

  callCreateSearchConfig();
  // [END warehouse-visionai_v1_generated_Warehouse_CreateSearchConfig_async]
}
