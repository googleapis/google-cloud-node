...
function main(parent) {
  // [START warehouse-visionai_v1_generated_Warehouse_ListSearchHypernyms_async]
  /**
  ...
  async function callListSearchHypernyms() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = visionaiClient.listSearchHypernymsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListSearchHypernyms();
  // [END warehouse-visionai_v1_generated_Warehouse_ListSearchHypernyms_async]
}
