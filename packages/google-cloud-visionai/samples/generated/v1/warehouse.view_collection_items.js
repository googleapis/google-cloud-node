...
function main(collection) {
  // [START warehouse-visionai_v1_generated_Warehouse_ViewCollectionItems_async]
  /**
  ...
  async function callViewCollectionItems() {
    // Construct request
    const request = {
      collection,
    };
    ...
    // Run request
    const iterable = visionaiClient.viewCollectionItemsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callViewCollectionItems();
  // [END warehouse-visionai_v1_generated_Warehouse_ViewCollectionItems_async]
}
