...
function main(parent) {
  // [START warehouse-visionai_v1_generated_Warehouse_ListAssets_async]
  /**
  ...
  async function callListAssets() {
    ...
    // Run request
    const iterable = visionaiClient.listAssetsAsync(request);
  ...
  callListAssets();
  // [END warehouse-visionai_v1_generated_Warehouse_ListAssets_async]
}
