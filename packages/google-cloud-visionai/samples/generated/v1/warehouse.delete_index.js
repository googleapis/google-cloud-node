...
function main(name) {
  // [START warehouse-visionai_v1_generated_Warehouse_DeleteIndex_async]
  /**
  ...
  async function callDeleteIndex() {
    ...
    // Run request
    const [operation] = await visionaiClient.deleteIndex(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callDeleteIndex();
  // [END warehouse-visionai_v1_generated_Warehouse_DeleteIndex_async]
}
