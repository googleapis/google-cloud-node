...
function main(indexEndpoint, updateMask) {
  // [START warehouse-visionai_v1_generated_Warehouse_UpdateIndexEndpoint_async]
  /**
  ...
  async function callUpdateIndexEndpoint() {
    ...
    // Run request
    const [operation] = await visionaiClient.updateIndexEndpoint(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callUpdateIndexEndpoint();
  // [END warehouse-visionai_v1_generated_Warehouse_UpdateIndexEndpoint_async]
}
