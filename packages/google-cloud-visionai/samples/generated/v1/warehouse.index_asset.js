...
function main(name) {
  // [START warehouse-visionai_v1_generated_Warehouse_IndexAsset_async]
  /**
  ...
  async function callIndexAsset() {
    ...
    // Run request
    const [operation] = await visionaiClient.indexAsset(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callIndexAsset();
  // [END warehouse-visionai_v1_generated_Warehouse_IndexAsset_async]
}
