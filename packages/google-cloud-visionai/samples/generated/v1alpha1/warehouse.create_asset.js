...
function main(parent, asset) {
  // [START visionai_v1alpha1_generated_Warehouse_CreateAsset_async]
  /**
  ...
  async function callCreateAsset() {
    ...
    // Run request
    const response = await visionaiClient.createAsset(request);
    console.log(response);
  }

  callCreateAsset();
  // [END visionai_v1alpha1_generated_Warehouse_CreateAsset_async]
}
