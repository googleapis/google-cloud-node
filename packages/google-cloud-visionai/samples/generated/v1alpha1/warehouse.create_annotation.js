...
function main(parent, annotation) {
  // [START visionai_v1alpha1_generated_Warehouse_CreateAnnotation_async]
  /**
  ...
  async function callCreateAnnotation() {
    // Construct request
    const request = {
      parent,
      annotation,
    ...
    // Run request
    const response = await visionaiClient.createAnnotation(request);
    console.log(response);
  }

  callCreateAnnotation();
  // [END visionai_v1alpha1_generated_Warehouse_CreateAnnotation_async]
}
