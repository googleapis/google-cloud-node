...
describe('v1alpha1.StreamingServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new streamingserviceModule.v1alpha1.StreamingServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          streamingserviceModule.v1alpha1.StreamingServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          streamingserviceModule.v1alpha1.StreamingServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'visionai.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('invokes acquireLease without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.acquireLease(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1alpha1.ILease | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes releaseLease without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.releaseLease(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1alpha1.IReleaseLeaseResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes sendPackets without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        stream.on(
          'data',
          (
            response: protos.google.cloud.visionai.v1alpha1.SendPacketsResponse,
          ) => {
            resolve(response);
          },
        );
    ...
    it('invokes receivePackets without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        stream.on(
          'data',
          (
            response: protos.google.cloud.visionai.v1alpha1.ReceivePacketsResponse,
          ) => {
            resolve(response);
          },
        );
    ...
    it('invokes receiveEvents without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        stream.on(
          'data',
          (
            response: protos.google.cloud.visionai.v1alpha1.ReceiveEventsResponse,
          ) => {
            resolve(response);
          },
        );
