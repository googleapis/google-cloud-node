...
describe('v1.LiveVideoAnalyticsClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new livevideoanalyticsModule.v1.LiveVideoAnalyticsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'warehouse-visionai.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new livevideoanalyticsModule.v1.LiveVideoAnalyticsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'warehouse-visionai.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new livevideoanalyticsModule.v1.LiveVideoAnalyticsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new livevideoanalyticsModule.v1.LiveVideoAnalyticsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('resolveOperatorInfo', () => {
        it('invokes resolveOperatorInfo without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.ResolveOperatorInfoRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.ResolveOperatorInfoRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.visionai.v1.ResolveOperatorInfoResponse()
            );
            client.innerApiCalls.resolveOperatorInfo = stubSimpleCall(expectedResponse);
            const [response] = await client.resolveOperatorInfo(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.resolveOperatorInfo as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.resolveOperatorInfo as SinonStub)
        ...
        it('invokes resolveOperatorInfo without error using callback', async () => {
            ...
            client.innerApiCalls.resolveOperatorInfo = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.resolveOperatorInfo(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.visionai.v1.IResolveOperatorInfoResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes resolveOperatorInfo with error', async () => {
            ...
            client.innerApiCalls.resolveOperatorInfo = stubSimpleCall(undefined, expectedError);
    ...
    describe('getOperator', () => {
        it('invokes getOperator without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.GetOperatorRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.GetOperatorRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.visionai.v1.Operator()
            );
            client.innerApiCalls.getOperator = stubSimpleCall(expectedResponse);
            const [response] = await client.getOperator(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getOperator as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getOperator as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getOperator without error using callback', async () => {
            ...
            client.innerApiCalls.getOperator = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getOperator(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.visionai.v1.IOperator|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getOperator with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getOperator = stubSimpleCall(undefined, expectedError);
    ...
    describe('getProcess', () => {
        it('invokes getProcess without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.GetProcessRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.GetProcessRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.visionai.v1.Process()
            );
        ...
        it('invokes getProcess without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getProcess(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.visionai.v1.IProcess|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createOperator', () => {
        it('invokes createOperator without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.CreateOperatorRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.CreateOperatorRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createOperator = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createOperator(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createOperator as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createOperator as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createOperator without error using callback', async () => {
            ...
            client.innerApiCalls.createOperator = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createOperator(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.visionai.v1.IOperator, protos.google.cloud.visionai.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.visionai.v1.IOperator, protos.google.cloud.visionai.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createOperator as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createOperator with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createOperator = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createOperator(request), expectedError);
            const actualRequest = (client.innerApiCalls.createOperator as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createOperator as SinonStub)
        ...
        it('invokes createOperator with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createOperator = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createOperator(request);
        ...
        it('invokes checkCreateOperatorProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateOperatorProgress(expectedResponse.name);
        ...
        it('invokes checkCreateOperatorProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreateOperatorProgress(''), expectedError);
    ...
    describe('updateOperator', () => {
        it('invokes updateOperator without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.UpdateOperatorRequest()
            );
            request.operator ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.UpdateOperatorRequest', ['operator', 'name']);
            request.operator.name = defaultValue1;
            const expectedHeaderRequestParams = `operator.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updateOperator = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateOperator(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateOperator as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateOperator as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateOperator without error using callback', async () => {
            ...
            client.innerApiCalls.updateOperator = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateOperator(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.visionai.v1.IOperator, protos.google.cloud.visionai.v1.IOperationMetadata>|null
                    ) => {
        ...
        it('invokes updateOperator with call error', async () => {
            ...
            const expectedHeaderRequestParams = `operator.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateOperator = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.updateOperator(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateOperator as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateOperator as SinonStub)
        ...
        it('invokes updateOperator with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `operator.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateOperator = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateOperator(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateOperator as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateOperatorProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateOperatorProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateOperatorProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateOperatorProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteOperator', () => {
        it('invokes deleteOperator without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.DeleteOperatorRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.DeleteOperatorRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteOperator = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteOperator(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteOperator as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteOperator as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteOperator without error using callback', async () => {
            ...
            client.innerApiCalls.deleteOperator = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteOperator with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteOperator = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteOperator(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteOperator as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteOperator as SinonStub)
        ...
        it('invokes deleteOperator with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteOperator = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteOperator(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteOperator as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteOperatorProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteOperatorProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteOperatorProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteOperatorProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('createProcess', () => {
        it('invokes createProcess without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.CreateProcessRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.CreateProcessRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createProcess = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createProcess(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
        ...
        it('invokes createProcess without error using callback', async () => {
            ...
            client.innerApiCalls.createProcess = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createProcess(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.visionai.v1.IProcess, protos.google.cloud.visionai.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.visionai.v1.IProcess, protos.google.cloud.visionai.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createProcess as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createProcess with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createProcess = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes createProcess with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createProcess = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createProcess(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.createProcess as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkCreateProcessProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkCreateProcessProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkCreateProcessProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkCreateProcessProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('updateProcess', () => {
        it('invokes updateProcess without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.UpdateProcessRequest()
            );
            request.process ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.UpdateProcessRequest', ['process', 'name']);
            request.process.name = defaultValue1;
            const expectedHeaderRequestParams = `process.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updateProcess = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateProcess(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
        ...
        it('invokes updateProcess without error using callback', async () => {
            ...
            client.innerApiCalls.updateProcess = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateProcess with call error', async () => {
            ...
            const expectedHeaderRequestParams = `process.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateProcess = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes updateProcess with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `process.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateProcess = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateProcess(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateProcess as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateProcessProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateProcessProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateProcessProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateProcessProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteProcess', () => {
        it('invokes deleteProcess without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.DeleteProcessRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.DeleteProcessRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('batchRunProcess', () => {
        it('invokes batchRunProcess without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.BatchRunProcessRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.BatchRunProcessRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.batchRunProcess = stubLongRunningCall(expectedResponse);
            const [operation] = await client.batchRunProcess(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchRunProcess as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchRunProcess as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes batchRunProcess without error using callback', async () => {
            ...
            client.innerApiCalls.batchRunProcess = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchRunProcess(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.visionai.v1.IBatchRunProcessResponse, protos.google.cloud.visionai.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.visionai.v1.IBatchRunProcessResponse, protos.google.cloud.visionai.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchRunProcess as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes batchRunProcess with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchRunProcess = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.batchRunProcess(request), expectedError);
            const actualRequest = (client.innerApiCalls.batchRunProcess as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchRunProcess as SinonStub)
        ...
        it('invokes batchRunProcess with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchRunProcess = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.batchRunProcess(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.batchRunProcess as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkBatchRunProcessProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkBatchRunProcessProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkBatchRunProcessProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkBatchRunProcessProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listPublicOperators', () => {
        it('invokes listPublicOperators without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.ListPublicOperatorsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.ListPublicOperatorsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.visionai.v1.Operator()),
              generateSampleMessage(new protos.google.cloud.visionai.v1.Operator()),
              generateSampleMessage(new protos.google.cloud.visionai.v1.Operator()),
            ];
            client.innerApiCalls.listPublicOperators = stubSimpleCall(expectedResponse);
            const [response] = await client.listPublicOperators(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listPublicOperators as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listPublicOperators as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listPublicOperators without error using callback', async () => {
            ...
            client.innerApiCalls.listPublicOperators = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listPublicOperators(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.visionai.v1.IOperator[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listPublicOperators with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listPublicOperators = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listPublicOperators(request), expectedError);
            const actualRequest = (client.innerApiCalls.listPublicOperators as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listPublicOperators as SinonStub)
        ...
        it('invokes listPublicOperatorsStream without error', async () => {
            ...
            client.descriptors.page.listPublicOperators.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listPublicOperatorsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.visionai.v1.Operator[] = [];
                stream.on('data', (response: protos.google.cloud.visionai.v1.Operator) => {
            ...
            assert((client.descriptors.page.listPublicOperators.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listPublicOperators, request));
            assert(
        ...
        it('invokes listPublicOperatorsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listPublicOperators.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listPublicOperatorsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.visionai.v1.Operator[] = [];
                stream.on('data', (response: protos.google.cloud.visionai.v1.Operator) => {
        ...
        it('uses async iteration with listPublicOperators without error', async () => {
            ...
            client.descriptors.page.listPublicOperators.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.visionai.v1.IOperator[] = [];
            const iterable = client.listPublicOperatorsAsync(request);
        ...
        it('uses async iteration with listPublicOperators with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listPublicOperators.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listPublicOperatorsAsync(request);
    ...
    describe('listOperators', () => {
        it('invokes listOperators without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.ListOperatorsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.ListOperatorsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.visionai.v1.Operator()),
              generateSampleMessage(new protos.google.cloud.visionai.v1.Operator()),
            ...
            client.innerApiCalls.listOperators = stubSimpleCall(expectedResponse);
            const [response] = await client.listOperators(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listOperators as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listOperators as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listOperators without error using callback', async () => {
            ...
            client.innerApiCalls.listOperators = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listOperators with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listOperators = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listOperators(request), expectedError);
            const actualRequest = (client.innerApiCalls.listOperators as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listOperators as SinonStub)
        ...
        it('invokes listOperatorsStream without error', async () => {
            ...
            client.descriptors.page.listOperators.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listOperatorsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.visionai.v1.Operator[] = [];
                stream.on('data', (response: protos.google.cloud.visionai.v1.Operator) => {
                    responses.push(response);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listOperators.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listOperators, request));
            assert(
        ...
        it('invokes listOperatorsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listOperators.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listOperatorsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.visionai.v1.Operator[] = [];
                stream.on('data', (response: protos.google.cloud.visionai.v1.Operator) => {
        ...
        it('uses async iteration with listOperators without error', async () => {
            ...
            client.descriptors.page.listOperators.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.visionai.v1.IOperator[] = [];
            const iterable = client.listOperatorsAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
        ...
        it('uses async iteration with listOperators with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listOperators.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listOperatorsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.visionai.v1.IOperator[] = [];
                for await (const resource of iterable) {
    ...
    describe('listProcesses', () => {
        it('invokes listProcesses without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.ListProcessesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.ListProcessesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.visionai.v1.Process()),
              generateSampleMessage(new protos.google.cloud.visionai.v1.Process()),
              generateSampleMessage(new protos.google.cloud.visionai.v1.Process()),
            ];
        ...
        it('invokes listProcessesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.visionai.v1.Process[] = [];
                stream.on('data', (response: protos.google.cloud.visionai.v1.Process) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listProcesses without error', async () => {
            ...
            const responses: protos.google.cloud.visionai.v1.IProcess[] = [];
