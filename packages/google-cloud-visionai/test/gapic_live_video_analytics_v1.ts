...
describe('v1.LiveVideoAnalyticsClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          livevideoanalyticsModule.v1.LiveVideoAnalyticsClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          livevideoanalyticsModule.v1.LiveVideoAnalyticsClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'warehouse-visionai.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new livevideoanalyticsModule.v1.LiveVideoAnalyticsClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'warehouse-visionai.example.com');
          if (saved) {
  ...
  describe('resolveOperatorInfo', () => {
    it('invokes resolveOperatorInfo without error', async () => {
      ...
      client.innerApiCalls.resolveOperatorInfo =
        stubSimpleCall(expectedResponse);
      const [response] = await client.resolveOperatorInfo(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.resolveOperatorInfo as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes resolveOperatorInfo without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.resolveOperatorInfo(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1.IResolveOperatorInfoResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes resolveOperatorInfo with error', async () => {
      ...
      client.innerApiCalls.resolveOperatorInfo = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getOperator', () => {
    it('invokes getOperator without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getOperator as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getOperator as SinonStub
    ...
    it('invokes getOperator without error using callback', async () => {
      ...
      client.innerApiCalls.getOperator =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getOperator(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1.IOperator | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getOperator with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getOperator = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes getAnalysis without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getAnalysis(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1.IAnalysis | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getProcess without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getProcess(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1.IProcess | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createOperator', () => {
    it('invokes createOperator without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createOperator as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createOperator as SinonStub
    ...
    it('invokes createOperator with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createOperator = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkCreateOperatorProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateOperatorProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateOperator', () => {
    it('invokes updateOperator without error', async () => {
      ...
      client.innerApiCalls.updateOperator =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateOperator(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateOperator as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateOperator as SinonStub
    ...
    it('invokes updateOperator with call error', async () => {
      ...
      const expectedHeaderRequestParams = `operator.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateOperator = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkUpdateOperatorProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateOperatorProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteOperator', () => {
    it('invokes deleteOperator without error', async () => {
      ...
      client.innerApiCalls.deleteOperator =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteOperator(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteOperator as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteOperator as SinonStub
    ...
    it('invokes deleteOperator with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteOperator = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkDeleteOperatorProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteOperatorProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateAnalysis', () => {
    it('invokes updateAnalysis without error', async () => {
      ...
      client.innerApiCalls.updateAnalysis =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateAnalysis(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateAnalysis as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateAnalysis as SinonStub
    ...
    it('invokes updateAnalysis with call error', async () => {
      ...
      const expectedHeaderRequestParams = `analysis.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateAnalysis = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteAnalysis', () => {
    ...
    it('invokes deleteAnalysis with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteAnalysis = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkDeleteAnalysisProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteAnalysisProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createProcess', () => {
    ...
    it('invokes createProcess with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createProcess = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkCreateProcessProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateProcessProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateProcess', () => {
    ...
    it('invokes updateProcess with call error', async () => {
      ...
      const expectedHeaderRequestParams = `process.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateProcess = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkUpdateProcessProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateProcessProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('batchRunProcess', () => {
    it('invokes batchRunProcess without error', async () => {
      ...
      client.innerApiCalls.batchRunProcess =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.batchRunProcess(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchRunProcess as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchRunProcess as SinonStub
    ...
    it('invokes batchRunProcess with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchRunProcess = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkBatchRunProcessProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkBatchRunProcessProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listPublicOperators', () => {
    it('invokes listPublicOperators without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listPublicOperators as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listPublicOperators as SinonStub
    ...
    it('invokes listPublicOperators with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listPublicOperators = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listPublicOperatorsStream without error', async () => {
      ...
      client.descriptors.page.listPublicOperators.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.visionai.v1.Operator) => {
      ...
      assert(
        (client.descriptors.page.listPublicOperators.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listPublicOperators, request),
      );
      assert(
        (client.descriptors.page.listPublicOperators.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listPublicOperators without error', async () => {
      ...
      client.descriptors.page.listPublicOperators.asyncIterate =
  ...
  describe('listOperators', () => {
    it('invokes listOperators without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listOperators as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listOperators as SinonStub
    ...
    it('invokes listOperators without error using callback', async () => {
      ...
      client.innerApiCalls.listOperators =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listOperators with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listOperators = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listOperatorsStream without error', async () => {
      ...
      client.descriptors.page.listOperators.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      assert(
        (client.descriptors.page.listOperators.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listOperators, request),
      );
      assert(
        (client.descriptors.page.listOperators.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listOperators without error', async () => {
      ...
      client.descriptors.page.listOperators.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.visionai.v1.IOperator[] = [];
  ...
  describe('listAnalyses', () => {
    ...
    it('invokes listAnalysesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.visionai.v1.Analysis) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listProcesses', () => {
    ...
    it('invokes listProcessesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.visionai.v1.Process) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
