...
describe('v1alpha1.StreamsServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      ...
      assert.strictEqual(apiEndpoint, 'visionai.googleapis.com');
    });
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          streamsserviceModule.v1alpha1.StreamsServiceClient.servicePath;
        assert.strictEqual(servicePath, 'visionai.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          streamsserviceModule.v1alpha1.StreamsServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'visionai.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('sets apiEndpoint according to universe domain camelCase', () => {
      ...
      assert.strictEqual(servicePath, 'visionai.example.com');
    });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new streamsserviceModule.v1alpha1.StreamsServiceClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'visionai.example.com');
          if (saved) {
        ...
        it('value configured in code has priority over environment variable', () => {
          ...
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'visionai.configured.example.com');
          if (saved) {
            process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = saved;
          } else {
            delete process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
    ...
    it('invokes getCluster without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getCluster(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1alpha1.ICluster | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getStream without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getStream(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1alpha1.IStream | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('generateStreamHlsToken', () => {
    it('invokes generateStreamHlsToken without error', async () => {
      ...
      client.innerApiCalls.generateStreamHlsToken =
        stubSimpleCall(expectedResponse);
      const [response] = await client.generateStreamHlsToken(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.generateStreamHlsToken as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.generateStreamHlsToken as SinonStub
    ...
    it('invokes generateStreamHlsToken without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.generateStreamHlsToken(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1alpha1.IGenerateStreamHlsTokenResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes generateStreamHlsToken with error', async () => {
      ...
      const expectedHeaderRequestParams = `stream=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.generateStreamHlsToken = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.generateStreamHlsToken(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.generateStreamHlsToken as SinonStub
    ...
    it('invokes getEvent without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getEvent(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1alpha1.IEvent | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getSeries', () => {
    it('invokes getSeries without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getSeries as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getSeries as SinonStub
    ...
    it('invokes getSeries without error using callback', async () => {
      ...
      client.innerApiCalls.getSeries =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getSeries(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1alpha1.ISeries | null,
          ) => {
            if (err) {
              reject(err);
            } else {
        ...
        client.createCluster(
          ...
          (
            ...
            result?: LROperation<
              ...
              protos.google.cloud.visionai.v1alpha1.IOperationMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
  ...
  describe('createEvent', () => {
    ...
    it('invokes createEvent with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createEvent = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateEvent', () => {
    it('invokes updateEvent without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateEvent as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateEvent as SinonStub
    ...
    it('invokes updateEvent without error using callback', async () => {
      ...
      client.innerApiCalls.updateEvent =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.updateEvent(
          request,
    ...
    it('invokes updateEvent with call error', async () => {
      ...
      const expectedHeaderRequestParams = `event.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateEvent = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteEvent', () => {
    ...
    it('invokes deleteEvent with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteEvent = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('createSeries', () => {
    it('invokes createSeries without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createSeries as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createSeries as SinonStub
    ...
    it('invokes createSeries without error using callback', async () => {
      ...
      client.innerApiCalls.createSeries =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createSeries(
          request,
    ...
    it('invokes createSeries with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createSeries = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateSeries', () => {
    it('invokes updateSeries without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateSeries as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateSeries as SinonStub
    ...
    it('invokes updateSeries without error using callback', async () => {
      ...
      client.innerApiCalls.updateSeries =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.updateSeries(
          request,
    ...
    it('invokes updateSeries with call error', async () => {
      ...
      const expectedHeaderRequestParams = `series.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateSeries = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteSeries', () => {
    it('invokes deleteSeries without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteSeries as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteSeries as SinonStub
    ...
    it('invokes deleteSeries without error using callback', async () => {
      ...
      client.innerApiCalls.deleteSeries =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.deleteSeries(
          request,
    ...
    it('invokes deleteSeries with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteSeries = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('materializeChannel', () => {
    it('invokes materializeChannel without error', async () => {
      ...
      client.innerApiCalls.materializeChannel =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.materializeChannel(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.materializeChannel as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.materializeChannel as SinonStub
      ...
      const promise = new Promise((resolve, reject) => {
        client.materializeChannel(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.visionai.v1alpha1.IChannel,
              protos.google.cloud.visionai.v1alpha1.IOperationMetadata
            > | null,
          ) => {
            if (err) {
    ...
    it('invokes materializeChannel with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.materializeChannel = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkMaterializeChannelProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkMaterializeChannelProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listClusters', () => {
    ...
    it('invokes listClustersStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.visionai.v1alpha1.Cluster) => {
  ...
  describe('listStreams', () => {
    ...
    it('invokes listStreamsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.visionai.v1alpha1.Stream) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listEvents', () => {
    ...
    it('invokes listEventsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.visionai.v1alpha1.Event) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listSeries', () => {
    it('invokes listSeries without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listSeries as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listSeries as SinonStub
    ...
    it('invokes listSeries without error using callback', async () => {
      ...
      client.innerApiCalls.listSeries =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listSeries(
          request,
    ...
    it('invokes listSeries with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listSeries = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listSeriesStream without error', async () => {
      ...
      client.descriptors.page.listSeries.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.visionai.v1alpha1.Series) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listSeries.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listSeries, request),
      );
      assert(
        (client.descriptors.page.listSeries.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listSeriesStream with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listSeries.createStream = stubPageStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.listSeriesStream(request);
    ...
    it('uses async iteration with listSeries without error', async () => {
      ...
      client.descriptors.page.listSeries.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      ...
      assert.deepStrictEqual(responses, expectedResponse);
      assert.deepStrictEqual(
        (client.descriptors.page.listSeries.asyncIterate as SinonStub).getCall(
          0,
        ).args[1],
        request,
      );
    ...
    it('uses async iteration with listSeries with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listSeries.asyncIterate = stubAsyncIterationCall(
        undefined,
        expectedError,
      );
      const iterable = client.listSeriesAsync(request);
  ...
  describe('Path templates', () => {
    ...
    describe('corpus', async () => {
      ...
      it('corpusPath', () => {
        const result = client.corpusPath(
          'projectNumberValue',
          'locationValue',
          'corpusValue',
        );
    ...
    describe('dataSchema', async () => {
      ...
      await client.initialize();
      client.pathTemplates.dataSchemaPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.dataSchemaPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('dataSchemaPath', () => {
        const result = client.dataSchemaPath(
          'projectNumberValue',
          'locationValue',
          'corpusValue',
          'dataSchemaValue',
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.dataSchemaPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectNumberFromDataSchemaName', () => {
        ...
        assert.strictEqual(result, 'projectNumberValue');
        assert(
          (client.pathTemplates.dataSchemaPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('draft', async () => {
      ...
      await client.initialize();
      client.pathTemplates.draftPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.draftPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('draftPath', () => {
        const result = client.draftPath(
          'projectValue',
          'locationValue',
          'applicationValue',
          'draftValue',
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.draftPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromDraftName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.draftPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('searchConfig', async () => {
      ...
      await client.initialize();
      client.pathTemplates.searchConfigPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.searchConfigPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('searchConfigPath', () => {
        const result = client.searchConfigPath(
          'projectNumberValue',
          'locationValue',
          'corpusValue',
          'searchConfigValue',
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.searchConfigPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectNumberFromSearchConfigName', () => {
        ...
        assert.strictEqual(result, 'projectNumberValue');
        assert(
          (client.pathTemplates.searchConfigPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('series', async () => {
      ...
      await client.initialize();
      client.pathTemplates.seriesPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.seriesPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('seriesPath', () => {
        const result = client.seriesPath(
          'projectValue',
          'locationValue',
          'clusterValue',
          'seriesValue',
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.seriesPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromSeriesName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.seriesPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
