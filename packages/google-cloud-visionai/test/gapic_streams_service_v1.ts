...
describe('v1.StreamsServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          streamsserviceModule.v1.StreamsServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          streamsserviceModule.v1.StreamsServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'warehouse-visionai.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new streamsserviceModule.v1.StreamsServiceClient({
          universe_domain: 'example.com',
    ...
    it('invokes getCluster without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getCluster(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1.ICluster | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getStream without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getStream(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1.IStream | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes generateStreamHlsToken without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.generateStreamHlsToken(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1.IGenerateStreamHlsTokenResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getEvent without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getEvent(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1.IEvent | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getSeries without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getSeries(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1.ISeries | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getStreamThumbnail', () => {
    it('invokes getStreamThumbnail without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getStreamThumbnail as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getStreamThumbnail as SinonStub
    ...
    it('invokes getStreamThumbnail with call error', async () => {
      ...
      const expectedHeaderRequestParams = `stream=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getStreamThumbnail = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkGetStreamThumbnailProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkGetStreamThumbnailProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listClusters', () => {
    ...
    it('invokes listClustersStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.visionai.v1.Cluster) => {
  ...
  describe('listStreams', () => {
    ...
    it('invokes listStreamsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.visionai.v1.Stream) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listSeries', () => {
    ...
    it('invokes listSeriesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.visionai.v1.Series) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
