...
describe('v1alpha1.LiveVideoAnalyticsClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new livevideoanalyticsModule.v1alpha1.LiveVideoAnalyticsClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          livevideoanalyticsModule.v1alpha1.LiveVideoAnalyticsClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        livevideoanalyticsModule.v1alpha1.LiveVideoAnalyticsClient.port;
      assert(port);
    ...
    it('invokes getAnalysis without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getAnalysis(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1alpha1.IAnalysis | null,
          ) => {
            if (err) {
              reject(err);
            } else {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createAnalysis(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.visionai.v1alpha1.IAnalysis,
  ...
  describe('listAnalyses', () => {
    ...
    it('invokes listAnalysesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.visionai.v1alpha1.Analysis) => {
