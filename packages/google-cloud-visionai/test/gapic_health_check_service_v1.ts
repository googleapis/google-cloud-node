...
describe('v1.HealthCheckServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          healthcheckserviceModule.v1.HealthCheckServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          healthcheckserviceModule.v1.HealthCheckServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'warehouse-visionai.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new healthcheckserviceModule.v1.HealthCheckServiceClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'warehouse-visionai.example.com');
          if (saved) {
    ...
    it('has port', () => {
      const port = healthcheckserviceModule.v1.HealthCheckServiceClient.port;
      assert(port);
  ...
  describe('healthCheck', () => {
    it('invokes healthCheck without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.visionai.v1.HealthCheckRequest(),
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.visionai.v1.HealthCheckResponse(),
      );
      client.innerApiCalls.healthCheck = stubSimpleCall(expectedResponse);
      const [response] = await client.healthCheck(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.healthCheck as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes healthCheck without error using callback', async () => {
      ...
      client.innerApiCalls.healthCheck =
      ...
      const promise = new Promise((resolve, reject) => {
        client.healthCheck(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1.IHealthCheckResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes healthCheck with error', async () => {
      ...
      client.innerApiCalls.healthCheck = stubSimpleCall(
        undefined,
        expectedError,
      );
