...
describe('v1alpha1.WarehouseClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          warehouseModule.v1alpha1.WarehouseClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          warehouseModule.v1alpha1.WarehouseClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'visionai.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new warehouseModule.v1alpha1.WarehouseClient({
          universe_domain: 'example.com',
    ...
    it('invokes createAsset without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createAsset(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1alpha1.IAsset | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getCorpus without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getCorpus(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1alpha1.ICorpus | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('deleteCorpus', () => {
    it('invokes deleteCorpus without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.visionai.v1alpha1.DeleteCorpusRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
    ...
    it('invokes createDataSchema without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createDataSchema(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1alpha1.IDataSchema | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createAnnotation without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createAnnotation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1alpha1.IAnnotation | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes clipAsset without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.clipAsset(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1alpha1.IClipAssetResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes generateHlsUri without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.generateHlsUri(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1alpha1.IGenerateHlsUriResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createSearchConfig without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createSearchConfig(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1alpha1.ISearchConfig | null,
          ) => {
            if (err) {
              reject(err);
            } else {
        ...
        client.deleteAsset(
          ...
          (
            ...
            result?: LROperation<
              ...
              protos.google.cloud.visionai.v1alpha1.IDeleteAssetMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
        ...
        client.createCorpus(
          ...
          (
            ...
            result?: LROperation<
              ...
              protos.google.cloud.visionai.v1alpha1.ICreateCorpusMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
    ...
    it('invokes ingestAsset without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        stream.on(
          'data',
          (
            response: protos.google.cloud.visionai.v1alpha1.IngestAssetResponse,
          ) => {
            resolve(response);
          },
        );
  ...
  describe('listAssets', () => {
    ...
    it('invokes listAssetsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.visionai.v1alpha1.Asset) => {
  ...
  describe('listCorpora', () => {
    ...
    it('invokes listCorporaStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.visionai.v1alpha1.Corpus) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listDataSchemas', () => {
    ...
    it('invokes listDataSchemasStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.visionai.v1alpha1.DataSchema) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listAnnotations', () => {
    ...
    it('invokes listAnnotationsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.visionai.v1alpha1.Annotation) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listSearchConfigs', () => {
    ...
    it('invokes listSearchConfigsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.visionai.v1alpha1.SearchConfig) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('searchAssets', () => {
    it('invokes searchAssets without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.visionai.v1alpha1.SearchResultItem(),
        ),
        generateSampleMessage(
          new protos.google.cloud.visionai.v1alpha1.SearchResultItem(),
        ),
    ...
    it('invokes searchAssetsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.visionai.v1alpha1.SearchResultItem,
          ) => {
            responses.push(response);
          },
        );
