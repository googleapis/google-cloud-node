  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          appplatformModule.v1alpha1.AppPlatformClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          appplatformModule.v1alpha1.AppPlatformClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'visionai.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new appplatformModule.v1alpha1.AppPlatformClient({
          universe_domain: 'example.com',
    ...
    it('invokes getApplication without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getApplication(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1alpha1.IApplication | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getInstance without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getInstance(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1alpha1.IInstance | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getDraft without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDraft(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1alpha1.IDraft | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listPrebuiltProcessors without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listPrebuiltProcessors(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1alpha1.IListPrebuiltProcessorsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getProcessor without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getProcessor(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1alpha1.IProcessor | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listApplications', () => {
    ...
    it('invokes listApplicationsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.visionai.v1alpha1.Application) => {
  ...
  describe('listInstances', () => {
    ...
    it('invokes listInstancesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.visionai.v1alpha1.Instance) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listDrafts', () => {
    ...
    it('invokes listDraftsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.visionai.v1alpha1.Draft) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listProcessors', () => {
    ...
    it('invokes listProcessorsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.visionai.v1alpha1.Processor) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
