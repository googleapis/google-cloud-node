...
describe('v1.AppPlatformClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = appplatformModule.v1.AppPlatformClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = appplatformModule.v1.AppPlatformClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'warehouse-visionai.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new appplatformModule.v1.AppPlatformClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'warehouse-visionai.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new appplatformModule.v1.AppPlatformClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'warehouse-visionai.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new appplatformModule.v1.AppPlatformClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new appplatformModule.v1.AppPlatformClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = appplatformModule.v1.AppPlatformClient.port;
            assert(port);
    ...
    describe('getApplication', () => {
        it('invokes getApplication without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.GetApplicationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.GetApplicationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.visionai.v1.Application()
            );
        ...
        it('invokes getApplication without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getApplication(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.visionai.v1.IApplication|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getInstance', () => {
        it('invokes getInstance without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.GetInstanceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.GetInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.visionai.v1.Instance()
            );
        ...
        it('invokes getInstance without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getInstance(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.visionai.v1.IInstance|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getDraft', () => {
        it('invokes getDraft without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.GetDraftRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.GetDraftRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.visionai.v1.Draft()
            );
        ...
        it('invokes getDraft without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getDraft(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.visionai.v1.IDraft|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listPrebuiltProcessors', () => {
        it('invokes listPrebuiltProcessors without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.ListPrebuiltProcessorsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.ListPrebuiltProcessorsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.visionai.v1.ListPrebuiltProcessorsResponse()
            );
        ...
        it('invokes listPrebuiltProcessors without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listPrebuiltProcessors(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.visionai.v1.IListPrebuiltProcessorsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getProcessor', () => {
        it('invokes getProcessor without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.GetProcessorRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.GetProcessorRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.visionai.v1.Processor()
            );
        ...
        it('invokes getProcessor without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getProcessor(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.visionai.v1.IProcessor|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createApplication', () => {
        it('invokes createApplication without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.CreateApplicationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.CreateApplicationRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes createApplication without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createApplication(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.visionai.v1.IApplication, protos.google.cloud.visionai.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.visionai.v1.IApplication, protos.google.cloud.visionai.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createApplication as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateApplication', () => {
        it('invokes updateApplication without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.UpdateApplicationRequest()
            );
            request.application ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.UpdateApplicationRequest', ['application', 'name']);
    ...
    describe('deleteApplication', () => {
        it('invokes deleteApplication without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.DeleteApplicationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.DeleteApplicationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('deployApplication', () => {
        it('invokes deployApplication without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.DeployApplicationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.DeployApplicationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes deployApplication without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deployApplication(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.visionai.v1.IDeployApplicationResponse, protos.google.cloud.visionai.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.visionai.v1.IDeployApplicationResponse, protos.google.cloud.visionai.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deployApplication as SinonStub)
                .getCall(0).args[0];
    ...
    describe('undeployApplication', () => {
        it('invokes undeployApplication without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.UndeployApplicationRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.UndeployApplicationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes undeployApplication without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.undeployApplication(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.visionai.v1.IUndeployApplicationResponse, protos.google.cloud.visionai.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.visionai.v1.IUndeployApplicationResponse, protos.google.cloud.visionai.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.undeployApplication as SinonStub)
                .getCall(0).args[0];
    ...
    describe('addApplicationStreamInput', () => {
        it('invokes addApplicationStreamInput without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.AddApplicationStreamInputRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.AddApplicationStreamInputRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes addApplicationStreamInput without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.addApplicationStreamInput(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.visionai.v1.IAddApplicationStreamInputResponse, protos.google.cloud.visionai.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.visionai.v1.IAddApplicationStreamInputResponse, protos.google.cloud.visionai.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.addApplicationStreamInput as SinonStub)
                .getCall(0).args[0];
    ...
    describe('removeApplicationStreamInput', () => {
        it('invokes removeApplicationStreamInput without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.RemoveApplicationStreamInputRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.RemoveApplicationStreamInputRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes removeApplicationStreamInput without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.removeApplicationStreamInput(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.visionai.v1.IRemoveApplicationStreamInputResponse, protos.google.cloud.visionai.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.visionai.v1.IRemoveApplicationStreamInputResponse, protos.google.cloud.visionai.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.removeApplicationStreamInput as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateApplicationStreamInput', () => {
        it('invokes updateApplicationStreamInput without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.UpdateApplicationStreamInputRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.UpdateApplicationStreamInputRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes updateApplicationStreamInput without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updateApplicationStreamInput(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.visionai.v1.IUpdateApplicationStreamInputResponse, protos.google.cloud.visionai.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.visionai.v1.IUpdateApplicationStreamInputResponse, protos.google.cloud.visionai.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateApplicationStreamInput as SinonStub)
                .getCall(0).args[0];
    ...
    describe('createApplicationInstances', () => {
        it('invokes createApplicationInstances without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.CreateApplicationInstancesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.CreateApplicationInstancesRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createApplicationInstances without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createApplicationInstances(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.visionai.v1.ICreateApplicationInstancesResponse, protos.google.cloud.visionai.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.visionai.v1.ICreateApplicationInstancesResponse, protos.google.cloud.visionai.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createApplicationInstances as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteApplicationInstances', () => {
        it('invokes deleteApplicationInstances without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.DeleteApplicationInstancesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.DeleteApplicationInstancesRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes deleteApplicationInstances without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deleteApplicationInstances(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.visionai.v1.IInstance, protos.google.cloud.visionai.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.visionai.v1.IInstance, protos.google.cloud.visionai.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteApplicationInstances as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateApplicationInstances', () => {
        it('invokes updateApplicationInstances without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.UpdateApplicationInstancesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.UpdateApplicationInstancesRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes updateApplicationInstances without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updateApplicationInstances(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.visionai.v1.IUpdateApplicationInstancesResponse, protos.google.cloud.visionai.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.visionai.v1.IUpdateApplicationInstancesResponse, protos.google.cloud.visionai.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateApplicationInstances as SinonStub)
                .getCall(0).args[0];
    ...
    describe('createDraft', () => {
        it('invokes createDraft without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.CreateDraftRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.CreateDraftRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createDraft without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createDraft(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.visionai.v1.IDraft, protos.google.cloud.visionai.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.visionai.v1.IDraft, protos.google.cloud.visionai.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createDraft as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateDraft', () => {
        it('invokes updateDraft without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.UpdateDraftRequest()
            );
            request.draft ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.UpdateDraftRequest', ['draft', 'name']);
    ...
    describe('deleteDraft', () => {
        it('invokes deleteDraft without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.DeleteDraftRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.DeleteDraftRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createProcessor', () => {
        it('invokes createProcessor without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.CreateProcessorRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.CreateProcessorRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createProcessor without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createProcessor(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.visionai.v1.IProcessor, protos.google.cloud.visionai.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.visionai.v1.IProcessor, protos.google.cloud.visionai.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createProcessor as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateProcessor', () => {
        it('invokes updateProcessor without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.UpdateProcessorRequest()
            );
            request.processor ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.UpdateProcessorRequest', ['processor', 'name']);
    ...
    describe('deleteProcessor', () => {
        it('invokes deleteProcessor without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.DeleteProcessorRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.DeleteProcessorRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listApplications', () => {
        it('invokes listApplications without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.ListApplicationsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.ListApplicationsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.visionai.v1.Application()),
              generateSampleMessage(new protos.google.cloud.visionai.v1.Application()),
              generateSampleMessage(new protos.google.cloud.visionai.v1.Application()),
            ];
        ...
        it('invokes listApplicationsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.visionai.v1.Application[] = [];
                stream.on('data', (response: protos.google.cloud.visionai.v1.Application) => {
        ...
        it('uses async iteration with listApplications without error', async () => {
            ...
            const responses: protos.google.cloud.visionai.v1.IApplication[] = [];
    ...
    describe('listInstances', () => {
        it('invokes listInstances without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.ListInstancesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.ListInstancesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.visionai.v1.Instance()),
              generateSampleMessage(new protos.google.cloud.visionai.v1.Instance()),
              generateSampleMessage(new protos.google.cloud.visionai.v1.Instance()),
            ];
        ...
        it('invokes listInstancesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.visionai.v1.Instance[] = [];
                stream.on('data', (response: protos.google.cloud.visionai.v1.Instance) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listDrafts', () => {
        it('invokes listDrafts without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.ListDraftsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.ListDraftsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.visionai.v1.Draft()),
              generateSampleMessage(new protos.google.cloud.visionai.v1.Draft()),
              generateSampleMessage(new protos.google.cloud.visionai.v1.Draft()),
            ];
        ...
        it('invokes listDraftsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.visionai.v1.Draft[] = [];
                stream.on('data', (response: protos.google.cloud.visionai.v1.Draft) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listDrafts without error', async () => {
            ...
            const responses: protos.google.cloud.visionai.v1.IDraft[] = [];
    ...
    describe('listProcessors', () => {
        it('invokes listProcessors without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.visionai.v1.ListProcessorsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.visionai.v1.ListProcessorsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.visionai.v1.Processor()),
              generateSampleMessage(new protos.google.cloud.visionai.v1.Processor()),
              generateSampleMessage(new protos.google.cloud.visionai.v1.Processor()),
            ];
        ...
        it('invokes listProcessorsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.visionai.v1.Processor[] = [];
                stream.on('data', (response: protos.google.cloud.visionai.v1.Processor) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listProcessors without error', async () => {
            ...
            const responses: protos.google.cloud.visionai.v1.IProcessor[] = [];
