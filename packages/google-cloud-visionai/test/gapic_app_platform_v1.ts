...
describe('v1.AppPlatformClient', () => {
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new appplatformModule.v1.AppPlatformClient({
          universe_domain: 'example.com',
    ...
    it('invokes getApplication without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getApplication(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1.IApplication | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getInstance without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getInstance(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1.IInstance | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getDraft', () => {
    it('invokes getDraft without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getDraft as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getDraft as SinonStub
    ...
    it('invokes getDraft without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDraft(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1.IDraft | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listPrebuiltProcessors', () => {
    it('invokes listPrebuiltProcessors without error', async () => {
      ...
      client.innerApiCalls.listPrebuiltProcessors =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listPrebuiltProcessors(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listPrebuiltProcessors as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listPrebuiltProcessors as SinonStub
    ...
    it('invokes listPrebuiltProcessors without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listPrebuiltProcessors(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1.IListPrebuiltProcessorsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listPrebuiltProcessors with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listPrebuiltProcessors = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listPrebuiltProcessors(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listPrebuiltProcessors as SinonStub
    ...
    it('invokes getProcessor without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getProcessor(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.visionai.v1.IProcessor | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('deployApplication', () => {
    it('invokes deployApplication without error', async () => {
      ...
      client.innerApiCalls.deployApplication =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deployApplication(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deployApplication as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deployApplication as SinonStub
    ...
    it('invokes deployApplication with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deployApplication = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkDeployApplicationProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeployApplicationProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('undeployApplication', () => {
    it('invokes undeployApplication without error', async () => {
      ...
      client.innerApiCalls.undeployApplication =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.undeployApplication(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.undeployApplication as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.undeployApplication as SinonStub
    ...
    it('invokes undeployApplication with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.undeployApplication = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('addApplicationStreamInput', () => {
    it('invokes addApplicationStreamInput without error', async () => {
      ...
      client.innerApiCalls.addApplicationStreamInput =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.addApplicationStreamInput(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.addApplicationStreamInput as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.addApplicationStreamInput as SinonStub
    ...
    it('invokes addApplicationStreamInput with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.addApplicationStreamInput = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.addApplicationStreamInput(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.addApplicationStreamInput as SinonStub
    ...
    it('invokes checkAddApplicationStreamInputProgress without error', async () => {
      ...
      const decodedOperation =
        await client.checkAddApplicationStreamInputProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkAddApplicationStreamInputProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkAddApplicationStreamInputProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('removeApplicationStreamInput', () => {
    it('invokes removeApplicationStreamInput without error', async () => {
      ...
      client.innerApiCalls.removeApplicationStreamInput =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.removeApplicationStreamInput(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.removeApplicationStreamInput as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.removeApplicationStreamInput as SinonStub
    ...
    it('invokes removeApplicationStreamInput with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.removeApplicationStreamInput = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.removeApplicationStreamInput(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.removeApplicationStreamInput as SinonStub
    ...
    it('invokes checkRemoveApplicationStreamInputProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkRemoveApplicationStreamInputProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('updateApplicationStreamInput', () => {
    it('invokes updateApplicationStreamInput without error', async () => {
      ...
      client.innerApiCalls.updateApplicationStreamInput =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateApplicationStreamInput(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateApplicationStreamInput as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateApplicationStreamInput as SinonStub
    ...
    it('invokes updateApplicationStreamInput with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateApplicationStreamInput = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateApplicationStreamInput(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateApplicationStreamInput as SinonStub
    ...
    it('invokes checkUpdateApplicationStreamInputProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkUpdateApplicationStreamInputProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkUpdateApplicationStreamInputProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateApplicationStreamInputProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createApplicationInstances', () => {
    it('invokes createApplicationInstances without error', async () => {
      ...
      client.innerApiCalls.createApplicationInstances =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createApplicationInstances(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createApplicationInstances as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createApplicationInstances as SinonStub
    ...
    it('invokes createApplicationInstances with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createApplicationInstances = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createApplicationInstances(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createApplicationInstances as SinonStub
    ...
    it('invokes checkCreateApplicationInstancesProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkCreateApplicationInstancesProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkCreateApplicationInstancesProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateApplicationInstancesProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteApplicationInstances', () => {
    it('invokes deleteApplicationInstances without error', async () => {
      ...
      client.innerApiCalls.deleteApplicationInstances =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteApplicationInstances(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteApplicationInstances as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteApplicationInstances as SinonStub
    ...
    it('invokes deleteApplicationInstances with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteApplicationInstances = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteApplicationInstances(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteApplicationInstances as SinonStub
    ...
    it('invokes checkDeleteApplicationInstancesProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkDeleteApplicationInstancesProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('updateApplicationInstances', () => {
    it('invokes updateApplicationInstances without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateApplicationInstances as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateApplicationInstances as SinonStub
    ...
    it('invokes updateApplicationInstances with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateApplicationInstances = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateApplicationInstances(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateApplicationInstances as SinonStub
    ...
    it('invokes checkUpdateApplicationInstancesProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkUpdateApplicationInstancesProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('createDraft', () => {
    it('invokes createDraft without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createDraft as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createDraft as SinonStub
    ...
    it('invokes createDraft with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createDraft = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateDraft', () => {
    it('invokes updateDraft without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateDraft as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateDraft as SinonStub
    ...
    it('invokes updateDraft with call error', async () => {
      ...
      const expectedHeaderRequestParams = `draft.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateDraft = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteDraft', () => {
    it('invokes deleteDraft without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteDraft as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteDraft as SinonStub
    ...
    it('invokes deleteDraft without error using callback', async () => {
      ...
      client.innerApiCalls.deleteDraft =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.deleteDraft(
          request,
    ...
    it('invokes deleteDraft with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteDraft = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('createProcessor', () => {
    ...
    it('invokes createProcessor with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createProcessor = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkCreateProcessorProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateProcessorProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateProcessor', () => {
    it('invokes updateProcessor without error', async () => {
      ...
      client.innerApiCalls.updateProcessor =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateProcessor(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateProcessor as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateProcessor as SinonStub
    ...
    it('invokes updateProcessor with call error', async () => {
      ...
      const expectedHeaderRequestParams = `processor.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateProcessor = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkUpdateProcessorProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateProcessorProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listApplications', () => {
    ...
    it('invokes listApplicationsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.visionai.v1.Application) => {
  ...
  describe('listInstances', () => {
    ...
    it('invokes listInstancesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.visionai.v1.Instance) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listDrafts', () => {
    it('invokes listDrafts without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listDrafts as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listDrafts as SinonStub
    ...
    it('invokes listDrafts without error using callback', async () => {
      ...
      client.innerApiCalls.listDrafts =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listDrafts(
          request,
    ...
    it('invokes listDrafts with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listDrafts = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listDraftsStream without error', async () => {
      ...
      client.descriptors.page.listDrafts.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      assert(
        (client.descriptors.page.listDrafts.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listDrafts, request),
      );
      assert(
        (client.descriptors.page.listDrafts.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listDraftsStream with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listDrafts.createStream = stubPageStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.listDraftsStream(request);
    ...
    it('uses async iteration with listDrafts without error', async () => {
      ...
      client.descriptors.page.listDrafts.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      ...
      assert.deepStrictEqual(responses, expectedResponse);
      assert.deepStrictEqual(
        (client.descriptors.page.listDrafts.asyncIterate as SinonStub).getCall(
          0,
        ).args[1],
        request,
      );
    ...
    it('uses async iteration with listDrafts with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listDrafts.asyncIterate = stubAsyncIterationCall(
        undefined,
        expectedError,
      );
      const iterable = client.listDraftsAsync(request);
  ...
  describe('listProcessors', () => {
    ...
    it('invokes listProcessorsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.visionai.v1.Processor) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
