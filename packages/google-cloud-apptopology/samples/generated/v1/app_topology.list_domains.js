...
function main(parent) {
  // [START apptopology_v1_generated_AppTopology_ListDomains_async]
  /**
  ...
  async function callListDomains() {
    ...
    // Run request
    const iterable = apptopologyClient.listDomainsAsync(request);
  ...
  callListDomains();
  // [END apptopology_v1_generated_AppTopology_ListDomains_async]
}
