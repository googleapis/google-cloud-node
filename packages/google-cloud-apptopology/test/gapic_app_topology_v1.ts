...
import * as apptopologyModule from '../src';
...
describe('v1.AppTopologyClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client = new apptopologyModule.v1.AppTopologyClient();
      const apiEndpoint = client.apiEndpoint;
      assert.strictEqual(apiEndpoint, 'apptopology.googleapis.com');
    });
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath = apptopologyModule.v1.AppTopologyClient.servicePath;
        assert.strictEqual(servicePath, 'apptopology.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint = apptopologyModule.v1.AppTopologyClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'apptopology.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('sets apiEndpoint according to universe domain camelCase', () => {
      ...
      assert.strictEqual(servicePath, 'apptopology.example.com');
    });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        ...
        it('value configured in code has priority over environment variable', () => {
          ...
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'apptopology.configured.example.com');
          if (saved) {
            process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = saved;
          } else {
            delete process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new apptopologyModule.v1.AppTopologyClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = apptopologyModule.v1.AppTopologyClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.appTopologyStub, undefined);
      await client.initialize();
      assert(client.appTopologyStub);
    });
  ...
  describe('generateDiscoveredResourcesTopology', () => {
    it('invokes generateDiscoveredResourcesTopology without error', async () => {
      const client = new apptopologyModule.v1.AppTopologyClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.apptopology.v1.GenerateDiscoveredResourcesTopologyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.apptopology.v1.GenerateDiscoveredResourcesTopologyRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.apptopology.v1.GenerateDiscoveredResourcesTopologyResponse(),
      );
      client.innerApiCalls.generateDiscoveredResourcesTopology =
        stubSimpleCall(expectedResponse);
      const [response] =
        await client.generateDiscoveredResourcesTopology(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.generateDiscoveredResourcesTopology as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes generateDiscoveredResourcesTopology without error using callback', async () => {
      const client = new apptopologyModule.v1.AppTopologyClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      const promise = new Promise((resolve, reject) => {
        client.generateDiscoveredResourcesTopology(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.apptopology.v1.IGenerateDiscoveredResourcesTopologyResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes generateDiscoveredResourcesTopology with error', async () => {
      const client = new apptopologyModule.v1.AppTopologyClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.generateDiscoveredResourcesTopology = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.generateDiscoveredResourcesTopology(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.generateDiscoveredResourcesTopology as SinonStub
    ...
    it('invokes generateDiscoveredResourcesTopology with closed client', async () => {
      const client = new apptopologyModule.v1.AppTopologyClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
  ...
  describe('getSchema', () => {
    it('invokes getSchema without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.apptopology.v1.GetSchemaRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.apptopology.v1.GetSchemaRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.apptopology.v1.Schema(),
      );
    ...
    it('invokes getSchema without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getSchema(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.apptopology.v1.ISchema | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getDomain', () => {
    it('invokes getDomain without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.apptopology.v1.GetDomainRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.apptopology.v1.GetDomainRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.apptopology.v1.Domain(),
      );
    ...
    it('invokes getDomain without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDomain(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.apptopology.v1.IDomain | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listDomains', () => {
    it('invokes listDomains without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.apptopology.v1.ListDomainsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.apptopology.v1.ListDomainsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = [
        generateSampleMessage(new protos.google.cloud.apptopology.v1.Domain()),
        generateSampleMessage(new protos.google.cloud.apptopology.v1.Domain()),
        generateSampleMessage(new protos.google.cloud.apptopology.v1.Domain()),
      ];
    ...
    it('invokes listDomainsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.apptopology.v1.Domain[] = [];
        stream.on(
          'data',
          (response: protos.google.cloud.apptopology.v1.Domain) => {
    ...
    it('uses async iteration with listDomains without error', async () => {
      ...
      const responses: protos.google.cloud.apptopology.v1.IDomain[] = [];
  ...
  describe('Path templates', () => {
    describe('discoveredResourcesTopology', async () => {
      const fakePath = '/rendered/path/discoveredResourcesTopology';
      ...
      await client.initialize();
      client.pathTemplates.discoveredResourcesTopologyPathTemplate.render =
        sinon.stub().returns(fakePath);
      client.pathTemplates.discoveredResourcesTopologyPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('discoveredResourcesTopologyPath', () => {
        const result = client.discoveredResourcesTopologyPath(
          'projectValue',
          'locationValue',
        );
        ...
        assert(
          (
            client.pathTemplates.discoveredResourcesTopologyPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
      ...
      it('matchProjectFromDiscoveredResourcesTopologyName', () => {
        const result =
          client.matchProjectFromDiscoveredResourcesTopologyName(fakePath);
      ...
      it('matchLocationFromDiscoveredResourcesTopologyName', () => {
        const result =
          client.matchLocationFromDiscoveredResourcesTopologyName(fakePath);
    ...
    describe('schema', async () => {
      ...
      it('schemaPath', () => {
        const result = client.schemaPath(
          'projectValue',
          'locationValue',
          'domainValue',
        );
      ...
      it('matchLocationFromSchemaName', () => {
        const result = client.matchLocationFromSchemaName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (client.pathTemplates.schemaPathTemplate.match as SinonStub)
            .getCall(-1)
      ...
      it('matchDomainFromSchemaName', () => {
        const result = client.matchDomainFromSchemaName(fakePath);
        assert.strictEqual(result, 'domainValue');
        assert(
          (client.pathTemplates.schemaPathTemplate.match as SinonStub)
            .getCall(-1)
