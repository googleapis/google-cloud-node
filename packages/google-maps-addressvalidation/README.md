...
[![npm version](https://img.shields.io/npm/v/@google-maps/addressvalidation.svg)](https://www.npmjs.org/package/@google-maps/addressvalidation)
...
```bash
npm install @google-maps/addressvalidation
```
...
For example, `npm install @google-maps/addressvalidation@legacy-8` installs client libraries
