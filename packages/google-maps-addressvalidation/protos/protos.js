...
(function(global, factory) { /* global define, require, module */
    ...
    var $root = $protobuf.roots._googlemaps_addressvalidation_protos || ($protobuf.roots._googlemaps_addressvalidation_protos = {});
                ...
                addressvalidation.v1 = (function() {
                    ...
                    v1.AddressComponent = (function() {
                        ...
                        AddressComponent.fromObject = function fromObject(object) {
                            ...
                            default:
                                if (typeof object.confirmationLevel === "number") {
                                    message.confirmationLevel = object.confirmationLevel;
                                    break;
                                }
                                break;
                        ...
                        AddressComponent.toObject = function toObject(message, options) {
                            ...
                            if (message.confirmationLevel != null && message.hasOwnProperty("confirmationLevel"))
                                object.confirmationLevel = options.enums === String ? $root.google.maps.addressvalidation.v1.AddressComponent.ConfirmationLevel[message.confirmationLevel] === undefined ? message.confirmationLevel : $root.google.maps.addressvalidation.v1.AddressComponent.ConfirmationLevel[message.confirmationLevel] : message.confirmationLevel;
                            if (message.inferred != null && message.hasOwnProperty("inferred"))
                    ...
                    v1.ProvideValidationFeedbackRequest = (function() {
                        ...
                        ProvideValidationFeedbackRequest.fromObject = function fromObject(object) {
                            ...
                            default:
                                if (typeof object.conclusion === "number") {
                        ...
                        ProvideValidationFeedbackRequest.toObject = function toObject(message, options) {
                            ...
                            if (message.conclusion != null && message.hasOwnProperty("conclusion"))
                                object.conclusion = options.enums === String ? $root.google.maps.addressvalidation.v1.ProvideValidationFeedbackRequest.ValidationConclusion[message.conclusion] === undefined ? message.conclusion : $root.google.maps.addressvalidation.v1.ProvideValidationFeedbackRequest.ValidationConclusion[message.conclusion] : message.conclusion;
                            if (message.responseId != null && message.hasOwnProperty("responseId"))
                                object.responseId = message.responseId;
                            return object;
                        };
                    ...
                    v1.Verdict = (function() {
                        ...
                        Verdict.fromObject = function fromObject(object) {
                            ...
                            default:
                                if (typeof object.inputGranularity === "number") {
                                    message.inputGranularity = object.inputGranularity;
                                    break;
                                }
                                break;
                            ...
                            default:
                                if (typeof object.validationGranularity === "number") {
                                    message.validationGranularity = object.validationGranularity;
                                    break;
                                }
                                break;
                            case "GRANULARITY_UNSPECIFIED":
                            ...
                            default:
                                if (typeof object.geocodeGranularity === "number") {
                                    message.geocodeGranularity = object.geocodeGranularity;
                                    break;
                                }
                                break;
                            case "GRANULARITY_UNSPECIFIED":
                        ...
                        Verdict.toObject = function toObject(message, options) {
                            ...
                            if (message.validationGranularity != null && message.hasOwnProperty("validationGranularity"))
                                object.validationGranularity = options.enums === String ? $root.google.maps.addressvalidation.v1.Verdict.Granularity[message.validationGranularity] === undefined ? message.validationGranularity : $root.google.maps.addressvalidation.v1.Verdict.Granularity[message.validationGranularity] : message.validationGranularity;
                            if (message.geocodeGranularity != null && message.hasOwnProperty("geocodeGranularity"))
                                object.geocodeGranularity = options.enums === String ? $root.google.maps.addressvalidation.v1.Verdict.Granularity[message.geocodeGranularity] === undefined ? message.geocodeGranularity : $root.google.maps.addressvalidation.v1.Verdict.Granularity[message.geocodeGranularity] : message.geocodeGranularity;
                            if (message.addressComplete != null && message.hasOwnProperty("addressComplete"))
