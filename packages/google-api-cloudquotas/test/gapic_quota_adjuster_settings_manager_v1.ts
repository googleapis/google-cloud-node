...
describe('v1.QuotaAdjusterSettingsManagerClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new quotaadjustersettingsmanagerModule.v1.QuotaAdjusterSettingsManagerClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          quotaadjustersettingsmanagerModule.v1
    ...
    it('has port', () => {
      const port =
        quotaadjustersettingsmanagerModule.v1.QuotaAdjusterSettingsManagerClient
          .port;
      assert(port);
  ...
  describe('updateQuotaAdjusterSettings', () => {
    it('invokes updateQuotaAdjusterSettings without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.api.cloudquotas.v1.UpdateQuotaAdjusterSettingsRequest(),
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.api.cloudquotas.v1.QuotaAdjusterSettings(),
      );
    ...
    it('invokes updateQuotaAdjusterSettings without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.updateQuotaAdjusterSettings(
          ...
          (
            err?: Error | null,
            result?: protos.google.api.cloudquotas.v1.IQuotaAdjusterSettings | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getQuotaAdjusterSettings', () => {
    it('invokes getQuotaAdjusterSettings without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.api.cloudquotas.v1.GetQuotaAdjusterSettingsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
