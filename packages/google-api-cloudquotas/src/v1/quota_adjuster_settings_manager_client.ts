 ...
 * `src/v1/quota_adjuster_settings_manager_client_config.json`.
...
export class QuotaAdjusterSettingsManagerClient {
    ...
    this.quotaAdjusterSettingsManagerStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ...
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.api.cloudquotas.v1
   ...
   * @param {google.api.cloudquotas.v1.QuotaAdjusterSettings} request.quotaAdjusterSettings
   ...
   *   The first element of the array is an object representing {@link protos.google.api.cloudquotas.v1.QuotaAdjusterSettings|QuotaAdjusterSettings}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/quota_adjuster_settings_manager.update_quota_adjuster_settings.js</caption>
   * region_tag:cloudquotas_v1_generated_QuotaAdjusterSettingsManager_UpdateQuotaAdjusterSettings_async
   */
  updateQuotaAdjusterSettings(
    request?: protos.google.api.cloudquotas.v1.IUpdateQuotaAdjusterSettingsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.api.cloudquotas.v1.IQuotaAdjusterSettings,
      (
        | protos.google.api.cloudquotas.v1.IUpdateQuotaAdjusterSettingsRequest
        | undefined
      ),
      {} | undefined,
    ]
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/quota_adjuster_settings_manager.get_quota_adjuster_settings.js</caption>
   * region_tag:cloudquotas_v1_generated_QuotaAdjusterSettingsManager_GetQuotaAdjusterSettings_async
   */
  getQuotaAdjusterSettings(
    request?: protos.google.api.cloudquotas.v1.IGetQuotaAdjusterSettingsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.api.cloudquotas.v1.IQuotaAdjusterSettings,
      (
        | protos.google.api.cloudquotas.v1.IGetQuotaAdjusterSettingsRequest
        | undefined
      ),
      {} | undefined,
    ]
