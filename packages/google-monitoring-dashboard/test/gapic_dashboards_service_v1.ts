...
describe('v1.DashboardsServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = dashboardsserviceModule.v1.DashboardsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = dashboardsserviceModule.v1.DashboardsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'monitoring.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new dashboardsserviceModule.v1.DashboardsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'monitoring.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new dashboardsserviceModule.v1.DashboardsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'monitoring.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new dashboardsserviceModule.v1.DashboardsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new dashboardsserviceModule.v1.DashboardsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createDashboard', () => {
        it('invokes createDashboard without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.monitoring.dashboard.v1.CreateDashboardRequest', ['parent']);
            ...
            const actualRequest = (client.innerApiCalls.createDashboard as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createDashboard as SinonStub)
        ...
        it('invokes createDashboard without error using callback', async () => {
            ...
            client.innerApiCalls.createDashboard = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createDashboard(
                    request,
                    (err?: Error|null, result?: protos.google.monitoring.dashboard.v1.IDashboard|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createDashboard with error', async () => {
            ...
            client.innerApiCalls.createDashboard = stubSimpleCall(undefined, expectedError);
    ...
    describe('getDashboard', () => {
        it('invokes getDashboard without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.monitoring.dashboard.v1.GetDashboardRequest', ['name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getDashboard as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDashboard as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getDashboard without error using callback', async () => {
            ...
            client.innerApiCalls.getDashboard = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getDashboard(
                    request,
                    (err?: Error|null, result?: protos.google.monitoring.dashboard.v1.IDashboard|null) => {
        ...
        it('invokes getDashboard with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getDashboard = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteDashboard', () => {
        it('invokes deleteDashboard without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.monitoring.dashboard.v1.DeleteDashboardRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteDashboard as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteDashboard as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteDashboard without error using callback', async () => {
            ...
            client.innerApiCalls.deleteDashboard = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteDashboard with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteDashboard = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateDashboard', () => {
        it('invokes updateDashboard without error', async () => {
            ...
            request.dashboard ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.monitoring.dashboard.v1.UpdateDashboardRequest', ['dashboard', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateDashboard as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateDashboard as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateDashboard without error using callback', async () => {
            ...
            client.innerApiCalls.updateDashboard = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateDashboard with error', async () => {
            ...
            const expectedHeaderRequestParams = `dashboard.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateDashboard = stubSimpleCall(undefined, expectedError);
    ...
    describe('listDashboards', () => {
        it('invokes listDashboards without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.monitoring.dashboard.v1.ListDashboardsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.monitoring.dashboard.v1.Dashboard()),
              generateSampleMessage(new protos.google.monitoring.dashboard.v1.Dashboard()),
              generateSampleMessage(new protos.google.monitoring.dashboard.v1.Dashboard()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listDashboards as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listDashboards as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listDashboards without error using callback', async () => {
            ...
            client.innerApiCalls.listDashboards = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listDashboards with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listDashboards = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listDashboardsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.monitoring.dashboard.v1.Dashboard) => {
            ...
            assert((client.descriptors.page.listDashboards.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listDashboards, request));
            assert(
        ...
        it('invokes listDashboardsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDashboards.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listDashboardsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.monitoring.dashboard.v1.Dashboard[] = [];
                stream.on('data', (response: protos.google.monitoring.dashboard.v1.Dashboard) => {
        ...
        it('uses async iteration with listDashboards without error', async () => {
            ...
            client.descriptors.page.listDashboards.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listDashboards with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDashboards.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listDashboardsAsync(request);
    ...
    describe('Path templates', () => {
        ...
        describe('alertPolicy', async () => {
            ...
            await client.initialize();
            client.pathTemplates.alertPolicyPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.alertPolicyPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('alertPolicyPath', () => {
                const result = client.alertPolicyPath("projectValue", "alertPolicyValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.alertPolicyPathTemplate.render as SinonStub)
            ...
            it('matchProjectFromAlertPolicyName', () => {
                ...
                assert((client.pathTemplates.alertPolicyPathTemplate.match as SinonStub)
        ...
        describe('dashboard', async () => {
            ...
            await client.initialize();
            client.pathTemplates.dashboardPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.dashboardPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('dashboardPath', () => {
                const result = client.dashboardPath("projectValue", "dashboardValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.dashboardPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromDashboardName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.dashboardPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
