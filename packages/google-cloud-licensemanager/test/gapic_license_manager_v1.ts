...
describe('v1.LicenseManagerClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          licensemanagerModule.v1.LicenseManagerClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          licensemanagerModule.v1.LicenseManagerClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'licensemanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        ...
        it('value configured in code has priority over environment variable', () => {
          ...
          assert.strictEqual(
            servicePath,
            'licensemanager.configured.example.com',
          );
          if (saved) {
            process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = saved;
          } else {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new licensemanagerModule.v1.LicenseManagerClient({
          universe_domain: 'example.com',
  ...
  describe('getConfiguration', () => {
    it('invokes getConfiguration without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getConfiguration as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getConfiguration without error using callback', async () => {
      ...
      client.innerApiCalls.getConfiguration =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getConfiguration(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.licensemanager.v1.IConfiguration | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getConfiguration with error', async () => {
      ...
      client.innerApiCalls.getConfiguration = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes getInstance without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getInstance(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.licensemanager.v1.IInstance | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('queryConfigurationLicenseUsage', () => {
    it('invokes queryConfigurationLicenseUsage without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.queryConfigurationLicenseUsage as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.queryConfigurationLicenseUsage as SinonStub
    ...
    it('invokes queryConfigurationLicenseUsage without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.queryConfigurationLicenseUsage(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.licensemanager.v1.IQueryConfigurationLicenseUsageResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes queryConfigurationLicenseUsage with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.queryConfigurationLicenseUsage = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.queryConfigurationLicenseUsage(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.queryConfigurationLicenseUsage as SinonStub
    ...
    it('invokes getProduct without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getProduct(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.licensemanager.v1.IProduct | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createConfiguration', () => {
    it('invokes createConfiguration without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createConfiguration as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createConfiguration as SinonStub
    ...
    it('invokes createConfiguration with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createConfiguration = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkCreateConfigurationProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateConfigurationProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateConfiguration', () => {
    it('invokes updateConfiguration without error', async () => {
      ...
      client.innerApiCalls.updateConfiguration =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateConfiguration(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateConfiguration as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateConfiguration as SinonStub
    ...
    it('invokes updateConfiguration with call error', async () => {
      ...
      const expectedHeaderRequestParams = `configuration.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateConfiguration = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkUpdateConfigurationProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateConfigurationProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteConfiguration', () => {
    it('invokes deleteConfiguration without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteConfiguration as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteConfiguration as SinonStub
    ...
    it('invokes deleteConfiguration with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteConfiguration = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('deactivateConfiguration', () => {
    it('invokes deactivateConfiguration without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deactivateConfiguration as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deactivateConfiguration as SinonStub
    ...
    it('invokes deactivateConfiguration with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deactivateConfiguration = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deactivateConfiguration(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deactivateConfiguration as SinonStub
    ...
    it('invokes checkDeactivateConfigurationProgress without error', async () => {
      ...
      const decodedOperation =
        await client.checkDeactivateConfigurationProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkDeactivateConfigurationProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeactivateConfigurationProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('reactivateConfiguration', () => {
    it('invokes reactivateConfiguration without error', async () => {
      ...
      client.innerApiCalls.reactivateConfiguration =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.reactivateConfiguration(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.reactivateConfiguration as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.reactivateConfiguration as SinonStub
    ...
    it('invokes reactivateConfiguration with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.reactivateConfiguration = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.reactivateConfiguration(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.reactivateConfiguration as SinonStub
    ...
    it('invokes checkReactivateConfigurationProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkReactivateConfigurationProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkReactivateConfigurationProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkReactivateConfigurationProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listConfigurations', () => {
    it('invokes listConfigurations without error', async () => {
      ...
      client.innerApiCalls.listConfigurations =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listConfigurations(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listConfigurations as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listConfigurations as SinonStub
    ...
    it('invokes listConfigurations with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listConfigurations = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listConfigurationsStream without error', async () => {
      ...
      client.descriptors.page.listConfigurations.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.licensemanager.v1.Configuration) => {
      ...
      assert(
        (client.descriptors.page.listConfigurations.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listConfigurations, request),
      );
      assert(
        (client.descriptors.page.listConfigurations.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listConfigurations without error', async () => {
      ...
      client.descriptors.page.listConfigurations.asyncIterate =
  ...
  describe('listInstances', () => {
    ...
    it('invokes listInstancesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.licensemanager.v1.Instance) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('aggregateUsage', () => {
    it('invokes aggregateUsage without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.licensemanager.v1.Usage(),
        ),
        generateSampleMessage(
          new protos.google.cloud.licensemanager.v1.Usage(),
        ),
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.aggregateUsage as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.aggregateUsage as SinonStub
    ...
    it('invokes aggregateUsage without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.aggregateUsage(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.licensemanager.v1.IUsage[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes aggregateUsage with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.aggregateUsage = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes aggregateUsageStream without error', async () => {
      ...
      client.descriptors.page.aggregateUsage.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.licensemanager.v1.Usage) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.aggregateUsage.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.aggregateUsage, request),
      );
      assert(
        (client.descriptors.page.aggregateUsage.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with aggregateUsage without error', async () => {
      ...
      client.descriptors.page.aggregateUsage.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listProducts', () => {
    ...
    it('invokes listProductsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.licensemanager.v1.Product) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('Path templates', () => {
    describe('configuration', async () => {
      ...
      await client.initialize();
      client.pathTemplates.configurationPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.configurationPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('configurationPath', () => {
        const result = client.configurationPath(
          'projectValue',
          'locationValue',
          'configurationValue',
        );
        ...
        assert(
          (client.pathTemplates.configurationPathTemplate.render as SinonStub)
            .getCall(-1)
      ...
      it('matchProjectFromConfigurationName', () => {
        ...
        assert(
          (client.pathTemplates.configurationPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
