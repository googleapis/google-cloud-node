...
function main(parent, loyaltyCustomer) {
  ...
  async function callManageLoyaltyCustomerMatch() {
    // Construct request
    const request = {
      parent,
      loyaltyCustomer,
    ...
    // Run request
    const response = await loyaltycustomersClient.manageLoyaltyCustomerMatch(request);
    console.log(response);
  }

  callManageLoyaltyCustomerMatch();
