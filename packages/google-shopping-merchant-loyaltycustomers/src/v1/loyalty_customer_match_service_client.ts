 ...
 * `src/v1/loyalty_customer_match_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './loyalty_customer_match_service_client_config.json';
 ...
 * @memberof v1
 */
export class LoyaltyCustomerMatchServiceClient {
   ...
   *     const client = new LoyaltyCustomerMatchServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(
    opts?: ClientOptions,
    ...
    const staticMembers = this
      .constructor as typeof LoyaltyCustomerMatchServiceClient;
    if (
  ...
  initialize() {
    ...
    if (this.loyaltyCustomerMatchServiceStub) {
      return this.loyaltyCustomerMatchServiceStub;
    }

    // Put together the "service stub" for
    // google.shopping.merchant.loyaltycustomers.v1.LoyaltyCustomerMatchService.
    this.loyaltyCustomerMatchServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ? (this._protos as protobuf.Root).lookupService(
            'google.shopping.merchant.loyaltycustomers.v1.LoyaltyCustomerMatchService',
          )
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.shopping.merchant.loyaltycustomers.v1
    ...
    const loyaltyCustomerMatchServiceStubMethods = [
   ...
   * @param {google.shopping.merchant.loyaltycustomers.v1.LoyaltyCustomer} request.loyaltyCustomer
   *   Required. The loyalty customer to insert, update, or remove.
   * @param {object} [options]
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.shopping.merchant.loyaltycustomers.v1.ManageLoyaltyCustomerMatchResponse|ManageLoyaltyCustomerMatchResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/loyalty_customer_match_service.manage_loyalty_customer_match.js</caption>
   * region_tag:merchantapi_v1_generated_LoyaltyCustomerMatchService_ManageLoyaltyCustomerMatch_async
   */
  manageLoyaltyCustomerMatch(
    request?: protos.google.shopping.merchant.loyaltycustomers.v1.IManageLoyaltyCustomerMatchRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.shopping.merchant.loyaltycustomers.v1.IManageLoyaltyCustomerMatchResponse,
      (
        | protos.google.shopping.merchant.loyaltycustomers.v1.IManageLoyaltyCustomerMatchRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('manageLoyaltyCustomerMatch response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .manageLoyaltyCustomerMatch(request, options, wrappedCallback)
      ?.then(
