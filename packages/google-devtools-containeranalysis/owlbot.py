...
node.owlbot_main(relative_dir="packages/google-devtools-containeranalysis",templates_excludes=['packages/google-devtools-containeranalysis/src/v1/index.ts'],staging_excludes=[
