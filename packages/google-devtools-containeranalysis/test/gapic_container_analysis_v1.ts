...
describe('v1.ContainerAnalysisClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new containeranalysisModule.v1.ContainerAnalysisClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'containeranalysis.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new containeranalysisModule.v1.ContainerAnalysisClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'containeranalysis.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new containeranalysisModule.v1.ContainerAnalysisClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new containeranalysisModule.v1.ContainerAnalysisClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getVulnerabilityOccurrencesSummary', () => {
        it('invokes getVulnerabilityOccurrencesSummary without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.devtools.containeranalysis.v1.GetVulnerabilityOccurrencesSummaryRequest', ['parent']);
    ...
    describe('exportSBOM', () => {
        it('invokes exportSBOM without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.devtools.containeranalysis.v1.ExportSBOMRequest', ['name']);
        ...
        it('invokes exportSBOM without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.exportSBOM(
                    request,
                    (err?: Error|null, result?: protos.google.devtools.containeranalysis.v1.IExportSBOMResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
