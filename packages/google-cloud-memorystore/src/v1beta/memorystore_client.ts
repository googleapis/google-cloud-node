...
export class MemorystoreClient {
  ...
  constructor(
    ...
    const exportBackupResponse = protoFilesRoot.lookup(
      '.google.cloud.memorystore.v1beta.Backup',
    ) as gax.protobuf.Type;
    ...
    const addAuthTokenResponse = protoFilesRoot.lookup(
      '.google.cloud.memorystore.v1beta.TokenAuthUser',
    ) as gax.protobuf.Type;
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.cloud.memorystore.v1beta.BackupCollection|BackupCollection}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/memorystore.get_backup_collection.js</caption>
   * region_tag:memorystore_v1beta_generated_Memorystore_GetBackupCollection_async
   */
  getBackupCollection(
    request?: protos.google.cloud.memorystore.v1beta.IGetBackupCollectionRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.memorystore.v1beta.IBackupCollection,
      (
        | protos.google.cloud.memorystore.v1beta.IGetBackupCollectionRequest
        | undefined
      ),
      {} | undefined,
    ]
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.cloud.memorystore.v1beta.Backup|Backup}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/memorystore.get_backup.js</caption>
   * region_tag:memorystore_v1beta_generated_Memorystore_GetBackup_async
   */
  getBackup(
    request?: protos.google.cloud.memorystore.v1beta.IGetBackupRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.memorystore.v1beta.IBackup,
      protos.google.cloud.memorystore.v1beta.IGetBackupRequest | undefined,
      {} | undefined,
    ]
  >;
  getBackup(
    ...
    callback: Callback<
      protos.google.cloud.memorystore.v1beta.IBackup,
      | protos.google.cloud.memorystore.v1beta.IGetBackupRequest
      | null
      | undefined,
      {} | null | undefined
    >,
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.cloud.memorystore.v1beta.TokenAuthUser|TokenAuthUser}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/memorystore.get_token_auth_user.js</caption>
   * region_tag:memorystore_v1beta_generated_Memorystore_GetTokenAuthUser_async
   */
  getTokenAuthUser(
    request?: protos.google.cloud.memorystore.v1beta.IGetTokenAuthUserRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.memorystore.v1beta.ITokenAuthUser,
      (
        | protos.google.cloud.memorystore.v1beta.IGetTokenAuthUserRequest
        | undefined
      ),
      {} | undefined,
    ]
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.cloud.memorystore.v1beta.AuthToken|AuthToken}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/memorystore.get_auth_token.js</caption>
   * region_tag:memorystore_v1beta_generated_Memorystore_GetAuthToken_async
   */
  getAuthToken(
    request?: protos.google.cloud.memorystore.v1beta.IGetAuthTokenRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.memorystore.v1beta.IAuthToken,
      protos.google.cloud.memorystore.v1beta.IGetAuthTokenRequest | undefined,
      {} | undefined,
    ]
  >;
  getAuthToken(
    ...
    callback: Callback<
      protos.google.cloud.memorystore.v1beta.IAuthToken,
      | protos.google.cloud.memorystore.v1beta.IGetAuthTokenRequest
      | null
      | undefined,
      {} | null | undefined
    >,
   ...
   * @param {google.cloud.memorystore.v1beta.RescheduleMaintenanceRequest.RescheduleType} request.rescheduleType
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/memorystore.reschedule_maintenance.js</caption>
   * region_tag:memorystore_v1beta_generated_Memorystore_RescheduleMaintenance_async
   */
  rescheduleMaintenance(
    request?: protos.google.cloud.memorystore.v1beta.IRescheduleMaintenanceRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/memorystore.delete_backup.js</caption>
   * region_tag:memorystore_v1beta_generated_Memorystore_DeleteBackup_async
   */
  deleteBackup(
    request?: protos.google.cloud.memorystore.v1beta.IDeleteBackupRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/memorystore.export_backup.js</caption>
   * region_tag:memorystore_v1beta_generated_Memorystore_ExportBackup_async
   */
  exportBackup(
    request?: protos.google.cloud.memorystore.v1beta.IExportBackupRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<
  ...
  async checkExportBackupProgress(
    ...
    LROperation<
      protos.google.cloud.memorystore.v1beta.Backup,
      protos.google.cloud.memorystore.v1beta.OperationMetadata
    >
  > {
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/memorystore.backup_instance.js</caption>
   * region_tag:memorystore_v1beta_generated_Memorystore_BackupInstance_async
   */
  backupInstance(
    request?: protos.google.cloud.memorystore.v1beta.IBackupInstanceRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<
   ...
   * @param {Object} request
   *   The request object that will be sent.
   * @param {google.cloud.memorystore.v1beta.SelfManagedSource} request.selfManagedSource
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/memorystore.start_migration.js</caption>
   * region_tag:memorystore_v1beta_generated_Memorystore_StartMigration_async
   */
  startMigration(
    request?: protos.google.cloud.memorystore.v1beta.IStartMigrationRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/memorystore.finish_migration.js</caption>
   * region_tag:memorystore_v1beta_generated_Memorystore_FinishMigration_async
   */
  finishMigration(
    request?: protos.google.cloud.memorystore.v1beta.IFinishMigrationRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/memorystore.add_token_auth_user.js</caption>
   * region_tag:memorystore_v1beta_generated_Memorystore_AddTokenAuthUser_async
   */
  addTokenAuthUser(
    request?: protos.google.cloud.memorystore.v1beta.IAddTokenAuthUserRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/memorystore.delete_token_auth_user.js</caption>
   * region_tag:memorystore_v1beta_generated_Memorystore_DeleteTokenAuthUser_async
   */
  deleteTokenAuthUser(
    request?: protos.google.cloud.memorystore.v1beta.IDeleteTokenAuthUserRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<
   ...
   *   added for.
   * @param {google.cloud.memorystore.v1beta.AuthToken} request.authToken
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/memorystore.add_auth_token.js</caption>
   * region_tag:memorystore_v1beta_generated_Memorystore_AddAuthToken_async
   */
  addAuthToken(
    request?: protos.google.cloud.memorystore.v1beta.IAddAuthTokenRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<
  ...
  async checkAddAuthTokenProgress(
    ...
    LROperation<
      protos.google.cloud.memorystore.v1beta.TokenAuthUser,
      protos.google.cloud.memorystore.v1beta.OperationMetadata
    >
  > {
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/memorystore.delete_auth_token.js</caption>
   * region_tag:memorystore_v1beta_generated_Memorystore_DeleteAuthToken_async
   */
  deleteAuthToken(
    request?: protos.google.cloud.memorystore.v1beta.IDeleteAuthTokenRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.cloud.memorystore.v1beta.BackupCollection|BackupCollection}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   ...
   */
  listBackupCollections(
    request?: protos.google.cloud.memorystore.v1beta.IListBackupCollectionsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.memorystore.v1beta.IBackupCollection[],
      protos.google.cloud.memorystore.v1beta.IListBackupCollectionsRequest | null,
      protos.google.cloud.memorystore.v1beta.IListBackupCollectionsResponse,
    ]
  >;
  listBackupCollections(
    request: protos.google.cloud.memorystore.v1beta.IListBackupCollectionsRequest,
    options: CallOptions,
    callback: PaginationCallback<
      protos.google.cloud.memorystore.v1beta.IListBackupCollectionsRequest,
      | protos.google.cloud.memorystore.v1beta.IListBackupCollectionsResponse
      | null
      | undefined,
      protos.google.cloud.memorystore.v1beta.IBackupCollection
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.cloud.memorystore.v1beta.BackupCollection|BackupCollection} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed. Note that it can affect your quota.
   *   We recommend using `listBackupCollectionsAsync()`
   *   method described below for async iteration which you can stop as needed.
   ...
   *   An iterable Object that allows {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols | async iteration }.
   *   When you iterate the returned iterable, each element will be an object representing
   *   {@link protos.google.cloud.memorystore.v1beta.BackupCollection|BackupCollection}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/memorystore.list_backup_collections.js</caption>
   * region_tag:memorystore_v1beta_generated_Memorystore_ListBackupCollections_async
   */
  listBackupCollectionsAsync(
    request?: protos.google.cloud.memorystore.v1beta.IListBackupCollectionsRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.cloud.memorystore.v1beta.IBackupCollection> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listBackupCollections.asyncIterate(
      ...
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.cloud.memorystore.v1beta.IBackupCollection>;
  }
  /**
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.cloud.memorystore.v1beta.Backup|Backup}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   ...
   */
  listBackups(
    request?: protos.google.cloud.memorystore.v1beta.IListBackupsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.memorystore.v1beta.IBackup[],
      protos.google.cloud.memorystore.v1beta.IListBackupsRequest | null,
      protos.google.cloud.memorystore.v1beta.IListBackupsResponse,
    ]
  >;
  listBackups(
    request: protos.google.cloud.memorystore.v1beta.IListBackupsRequest,
    options: CallOptions,
    callback: PaginationCallback<
      protos.google.cloud.memorystore.v1beta.IListBackupsRequest,
      | protos.google.cloud.memorystore.v1beta.IListBackupsResponse
      | null
      | undefined,
      protos.google.cloud.memorystore.v1beta.IBackup
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.cloud.memorystore.v1beta.Backup|Backup} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed. Note that it can affect your quota.
   *   We recommend using `listBackupsAsync()`
   *   method described below for async iteration which you can stop as needed.
   ...
   *   An iterable Object that allows {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols | async iteration }.
   *   When you iterate the returned iterable, each element will be an object representing
   *   {@link protos.google.cloud.memorystore.v1beta.Backup|Backup}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/memorystore.list_backups.js</caption>
   * region_tag:memorystore_v1beta_generated_Memorystore_ListBackups_async
   */
  listBackupsAsync(
    request?: protos.google.cloud.memorystore.v1beta.IListBackupsRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.cloud.memorystore.v1beta.IBackup> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listBackups.asyncIterate(
      ...
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.cloud.memorystore.v1beta.IBackup>;
  }
  /**
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.cloud.memorystore.v1beta.TokenAuthUser|TokenAuthUser}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   ...
   */
  listTokenAuthUsers(
    request?: protos.google.cloud.memorystore.v1beta.IListTokenAuthUsersRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.memorystore.v1beta.ITokenAuthUser[],
      protos.google.cloud.memorystore.v1beta.IListTokenAuthUsersRequest | null,
      protos.google.cloud.memorystore.v1beta.IListTokenAuthUsersResponse,
    ]
  >;
  listTokenAuthUsers(
    request: protos.google.cloud.memorystore.v1beta.IListTokenAuthUsersRequest,
    options: CallOptions,
    callback: PaginationCallback<
      protos.google.cloud.memorystore.v1beta.IListTokenAuthUsersRequest,
      | protos.google.cloud.memorystore.v1beta.IListTokenAuthUsersResponse
      | null
      | undefined,
      protos.google.cloud.memorystore.v1beta.ITokenAuthUser
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.cloud.memorystore.v1beta.TokenAuthUser|TokenAuthUser} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed. Note that it can affect your quota.
   *   We recommend using `listTokenAuthUsersAsync()`
   *   method described below for async iteration which you can stop as needed.
   ...
   *   An iterable Object that allows {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols | async iteration }.
   *   When you iterate the returned iterable, each element will be an object representing
   *   {@link protos.google.cloud.memorystore.v1beta.TokenAuthUser|TokenAuthUser}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/memorystore.list_token_auth_users.js</caption>
   * region_tag:memorystore_v1beta_generated_Memorystore_ListTokenAuthUsers_async
   */
  listTokenAuthUsersAsync(
    request?: protos.google.cloud.memorystore.v1beta.IListTokenAuthUsersRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.cloud.memorystore.v1beta.ITokenAuthUser> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listTokenAuthUsers.asyncIterate(
      ...
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.cloud.memorystore.v1beta.ITokenAuthUser>;
  }
  /**
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.cloud.memorystore.v1beta.AuthToken|AuthToken}.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed and will merge results from all the pages into this array.
   *   Note that it can affect your quota.
   ...
   */
  listAuthTokens(
    request?: protos.google.cloud.memorystore.v1beta.IListAuthTokensRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.memorystore.v1beta.IAuthToken[],
      protos.google.cloud.memorystore.v1beta.IListAuthTokensRequest | null,
      protos.google.cloud.memorystore.v1beta.IListAuthTokensResponse,
    ]
  >;
  listAuthTokens(
    request: protos.google.cloud.memorystore.v1beta.IListAuthTokensRequest,
    options: CallOptions,
    callback: PaginationCallback<
      protos.google.cloud.memorystore.v1beta.IListAuthTokensRequest,
      | protos.google.cloud.memorystore.v1beta.IListAuthTokensResponse
      | null
      | undefined,
      protos.google.cloud.memorystore.v1beta.IAuthToken
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.cloud.memorystore.v1beta.AuthToken|AuthToken} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
   *   times as needed. Note that it can affect your quota.
   *   We recommend using `listAuthTokensAsync()`
   *   method described below for async iteration which you can stop as needed.
   ...
   *   An iterable Object that allows {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols | async iteration }.
   *   When you iterate the returned iterable, each element will be an object representing
   *   {@link protos.google.cloud.memorystore.v1beta.AuthToken|AuthToken}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/memorystore.list_auth_tokens.js</caption>
   * region_tag:memorystore_v1beta_generated_Memorystore_ListAuthTokens_async
   */
  listAuthTokensAsync(
    request?: protos.google.cloud.memorystore.v1beta.IListAuthTokensRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.cloud.memorystore.v1beta.IAuthToken> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listAuthTokens.asyncIterate(
      ...
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.cloud.memorystore.v1beta.IAuthToken>;
  }
