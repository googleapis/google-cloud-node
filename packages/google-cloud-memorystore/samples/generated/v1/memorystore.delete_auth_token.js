...
function main(name) {
  // [START memorystore_v1_generated_Memorystore_DeleteAuthToken_async]
  /**
  ...
  async function callDeleteAuthToken() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const [operation] = await memorystoreClient.deleteAuthToken(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callDeleteAuthToken();
  // [END memorystore_v1_generated_Memorystore_DeleteAuthToken_async]
}
