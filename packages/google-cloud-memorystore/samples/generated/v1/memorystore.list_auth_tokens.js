...
function main(parent) {
  // [START memorystore_v1_generated_Memorystore_ListAuthTokens_async]
  /**
  ...
  async function callListAuthTokens() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = memorystoreClient.listAuthTokensAsync(request);
  ...
  callListAuthTokens();
  // [END memorystore_v1_generated_Memorystore_ListAuthTokens_async]
}
