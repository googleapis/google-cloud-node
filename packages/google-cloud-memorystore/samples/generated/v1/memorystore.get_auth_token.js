...
function main(name) {
  // [START memorystore_v1_generated_Memorystore_GetAuthToken_async]
  /**
  ...
  async function callGetAuthToken() {
    ...
    // Run request
    const response = await memorystoreClient.getAuthToken(request);
    console.log(response);
  }

  callGetAuthToken();
  // [END memorystore_v1_generated_Memorystore_GetAuthToken_async]
}
