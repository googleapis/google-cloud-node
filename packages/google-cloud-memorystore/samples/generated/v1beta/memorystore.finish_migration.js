...
function main(name) {
  ...
  async function callFinishMigration() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const [operation] = await memorystoreClient.finishMigration(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callFinishMigration();
  // [END memorystore_v1beta_generated_Memorystore_FinishMigration_async]
}
