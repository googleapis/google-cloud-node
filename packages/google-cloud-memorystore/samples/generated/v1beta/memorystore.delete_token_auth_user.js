...
function main(name) {
  // [START memorystore_v1beta_generated_Memorystore_DeleteTokenAuthUser_async]
  /**
  ...
  async function callDeleteTokenAuthUser() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const [operation] = await memorystoreClient.deleteTokenAuthUser(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callDeleteTokenAuthUser();
  // [END memorystore_v1beta_generated_Memorystore_DeleteTokenAuthUser_async]
}
