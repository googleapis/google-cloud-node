...
function main(name) {
  // [START memorystore_v1beta_generated_Memorystore_ExportBackup_async]
  /**
  ...
  const {MemorystoreClient} = require('@google-cloud/memorystore').v1beta;
  ...
  callExportBackup();
  // [END memorystore_v1beta_generated_Memorystore_ExportBackup_async]
}
