...
describe('v1beta.AppOptimizeClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = appoptimizeModule.v1beta.AppOptimizeClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = appoptimizeModule.v1beta.AppOptimizeClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'appoptimize.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new appoptimizeModule.v1beta.AppOptimizeClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'appoptimize.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new appoptimizeModule.v1beta.AppOptimizeClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'appoptimize.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new appoptimizeModule.v1beta.AppOptimizeClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new appoptimizeModule.v1beta.AppOptimizeClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getReport', () => {
        it('invokes getReport without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.appoptimize.v1beta.GetReportRequest', ['name']);
        ...
        it('invokes getReport without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getReport(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.appoptimize.v1beta.IReport|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deleteReport', () => {
        it('invokes deleteReport without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.appoptimize.v1beta.DeleteReportRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes deleteReport without error using callback', async () => {
            ...
            client.innerApiCalls.deleteReport = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteReport(
                    request,
        ...
        it('invokes deleteReport with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteReport = stubSimpleCall(undefined, expectedError);
    ...
    describe('createReport', () => {
        it('invokes createReport without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.appoptimize.v1beta.CreateReportRequest', ['parent']);
        ...
        it('invokes createReport without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createReport(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.appoptimize.v1beta.IReport, protos.google.cloud.appoptimize.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.appoptimize.v1beta.IReport, protos.google.cloud.appoptimize.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createReport as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listReports', () => {
        it('invokes listReports without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.appoptimize.v1beta.ListReportsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.appoptimize.v1beta.Report()),
              generateSampleMessage(new protos.google.cloud.appoptimize.v1beta.Report()),
              generateSampleMessage(new protos.google.cloud.appoptimize.v1beta.Report()),
            ];
        ...
        it('invokes listReportsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.appoptimize.v1beta.Report) => {
    ...
    describe('readReport', () => {
        it('invokes readReport without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.appoptimize.v1beta.ReadReportRequest', ['name']);
            request.name = defaultValue1;
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.readReport as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.readReport as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes readReport without error using callback', async () => {
            ...
            client.innerApiCalls.readReport = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.readReport(
                    request,
                    (err?: Error|null, result?: protos.google.protobuf.IListValue[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes readReport with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.readReport = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes readReportStream without error', async () => {
            ...
            client.descriptors.page.readReport.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.readReport.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.readReport, request));
            assert(
        ...
        it('invokes readReportStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.readReport.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.readReportStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.protobuf.ListValue[] = [];
                stream.on('data', (response: protos.google.protobuf.ListValue) => {
        ...
        it('uses async iteration with readReport without error', async () => {
            ...
            client.descriptors.page.readReport.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with readReport with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.readReport.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.readReportAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.protobuf.IListValue[] = [];
                for await (const resource of iterable) {
    ...
    describe('Path templates', () => {
        ...
        describe('report', async () => {
            ...
            it('reportPath', () => {
                const result = client.reportPath("projectValue", "locationValue", "reportValue");
                assert.strictEqual(result, fakePath);
