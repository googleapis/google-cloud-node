 ...
 * `src/v1beta/app_optimize_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './app_optimize_client_config.json';
 ...
 * @memberof v1beta
 */
export class AppOptimizeClient {
  ...
  initialize() {
    ...
    if (this.appOptimizeStub) {
      return this.appOptimizeStub;
    }
