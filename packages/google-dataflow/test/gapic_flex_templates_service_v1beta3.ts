...
describe('v1beta3.FlexTemplatesServiceClient', () => {
  it('has servicePath', () => {
    const servicePath =
      flextemplatesserviceModule.v1beta3.FlexTemplatesServiceClient.servicePath;
    assert(servicePath);
  });

  it('has apiEndpoint', () => {
    const apiEndpoint =
      flextemplatesserviceModule.v1beta3.FlexTemplatesServiceClient.apiEndpoint;
    assert(apiEndpoint);
  });

  it('has port', () => {
    const port =
      flextemplatesserviceModule.v1beta3.FlexTemplatesServiceClient.port;
    assert(port);
  ...
  describe('launchFlexTemplate', () => {
    it('invokes launchFlexTemplate without error', async () => {
      ...
      client.innerApiCalls.launchFlexTemplate =
    ...
    it('invokes launchFlexTemplate without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.launchFlexTemplate(
          ...
          (
            err?: Error | null,
            result?: protos.google.dataflow.v1beta3.ILaunchFlexTemplateResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
