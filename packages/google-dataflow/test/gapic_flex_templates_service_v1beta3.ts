...
import * as flextemplatesserviceModule from '../src';
...
describe('v1beta3.FlexTemplatesServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = flextemplatesserviceModule.v1beta3.FlexTemplatesServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = flextemplatesserviceModule.v1beta3.FlexTemplatesServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'dataflow.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new flextemplatesserviceModule.v1beta3.FlexTemplatesServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dataflow.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new flextemplatesserviceModule.v1beta3.FlexTemplatesServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'dataflow.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new flextemplatesserviceModule.v1beta3.FlexTemplatesServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new flextemplatesserviceModule.v1beta3.FlexTemplatesServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = flextemplatesserviceModule.v1beta3.FlexTemplatesServiceClient.port;
            assert(port);
    ...
    describe('launchFlexTemplate', () => {
        it('invokes launchFlexTemplate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.dataflow.v1beta3.LaunchFlexTemplateRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.dataflow.v1beta3.LaunchFlexTemplateRequest', ['location']);
            ...
            const actualRequest = (client.innerApiCalls.launchFlexTemplate as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.launchFlexTemplate as SinonStub)
        ...
        it('invokes launchFlexTemplate without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.launchFlexTemplate(
                    request,
                    (err?: Error|null, result?: protos.google.dataflow.v1beta3.ILaunchFlexTemplateResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
