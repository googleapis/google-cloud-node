...
describe('v1.ManagedIdentitiesServiceClient', () => {
  it('has servicePath', () => {
    const servicePath =
      managedidentitiesserviceModule.v1.ManagedIdentitiesServiceClient
        .servicePath;
    assert(servicePath);
  });
  ...
  it('has port', () => {
    const port =
      managedidentitiesserviceModule.v1.ManagedIdentitiesServiceClient.port;
    assert(port);
    ...
    it('invokes resetAdminPassword without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.resetAdminPassword(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.managedidentities.v1.IResetAdminPasswordResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getDomain without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDomain(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.managedidentities.v1.IDomain | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listDomains', () => {
    ...
    it('invokes listDomainsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.managedidentities.v1.Domain) => {
