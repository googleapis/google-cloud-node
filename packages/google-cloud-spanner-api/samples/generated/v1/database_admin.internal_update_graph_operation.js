...
function main(database, operationId, vmIdentityToken) {
  ...
  async function callInternalUpdateGraphOperation() {
    // Construct request
    const request = {
      database,
      operationId,
    ...
    // Run request
    const response = await databaseClient.internalUpdateGraphOperation(request);
    console.log(response);
  }

  callInternalUpdateGraphOperation();
