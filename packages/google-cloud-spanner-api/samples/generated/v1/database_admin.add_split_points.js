...
function main(database, splitPoints) {
  ...
  async function callAddSplitPoints() {
    // Construct request
    const request = {
      database,
      splitPoints,
    ...
    // Run request
    const response = await databaseClient.addSplitPoints(request);
