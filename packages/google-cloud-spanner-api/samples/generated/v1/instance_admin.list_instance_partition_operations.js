...
function main(parent) {
  ...
  async function callListInstancePartitionOperations() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = instanceClient.listInstancePartitionOperationsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListInstancePartitionOperations();
