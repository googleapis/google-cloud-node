...
function main(queryTemplate) {
  ...
  async function callUpdateQueryTemplate() {
    // Construct request
    const request = {
      queryTemplate,
    };
    ...
    // Run request
    const response = await analyticshubClient.updateQueryTemplate(request);
    console.log(response);
  }

  callUpdateQueryTemplate();
