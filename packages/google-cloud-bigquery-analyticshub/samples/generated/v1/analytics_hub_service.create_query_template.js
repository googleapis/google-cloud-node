...
function main(parent, queryTemplateId, queryTemplate) {
  ...
  async function callCreateQueryTemplate() {
    // Construct request
    const request = {
      parent,
      queryTemplateId,
    ...
    // Run request
    const response = await analyticshubClient.createQueryTemplate(request);
    console.log(response);
  }

  callCreateQueryTemplate();
