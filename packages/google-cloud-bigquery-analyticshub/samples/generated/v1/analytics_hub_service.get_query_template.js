...
function main(name) {
  // [START analyticshub_v1_generated_AnalyticsHubService_GetQueryTemplate_async]
  /**
  ...
  async function callGetQueryTemplate() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await analyticshubClient.getQueryTemplate(request);
    console.log(response);
  }

  callGetQueryTemplate();
  // [END analyticshub_v1_generated_AnalyticsHubService_GetQueryTemplate_async]
}
