...
export class ServiceUsageClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    if (opts.fallback) {
      ...
      lroOptions.httpRules = [{selector: 'google.longrunning.Operations.GetOperation',get: '/v1/{name=operations/*}',},{selector: 'google.longrunning.Operations.ListOperations',get: '/v1/operations',}];
    }
    this.operationsClient = this._gaxModule.lro(lroOptions).operationsClient(opts);
    const enableServiceResponse = protoFilesRoot.lookup(
      '.google.api.serviceusage.v1.EnableServiceResponse') as gax.protobuf.Type;
    const enableServiceMetadata = protoFilesRoot.lookup(
      '.google.api.serviceusage.v1.OperationMetadata') as gax.protobuf.Type;
    const disableServiceResponse = protoFilesRoot.lookup(
      '.google.api.serviceusage.v1.DisableServiceResponse') as gax.protobuf.Type;
    const disableServiceMetadata = protoFilesRoot.lookup(
      '.google.api.serviceusage.v1.OperationMetadata') as gax.protobuf.Type;
    const batchEnableServicesResponse = protoFilesRoot.lookup(
      '.google.api.serviceusage.v1.BatchEnableServicesResponse') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.api.serviceusage.v1.ServiceUsage', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.serviceUsageStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.api.serviceusage.v1.ServiceUsage') :
    ...
    const serviceUsageStubMethods =
        ['enableService', 'disableService', 'getService', 'listServices', 'batchEnableServices', 'batchGetServices'];
 ...
 */
  getService(
      ...
      Promise<[
        ...
        protos.google.api.serviceusage.v1.IGetServiceRequest|undefined, {}|undefined
      ]>;
  getService(
      request: protos.google.api.serviceusage.v1.IGetServiceRequest,
      options: CallOptions,
 ...
 */
  batchGetServices(
      ...
      Promise<[
        ...
        protos.google.api.serviceusage.v1.IBatchGetServicesRequest|undefined, {}|undefined
      ]>;
  batchGetServices(
      request: protos.google.api.serviceusage.v1.IBatchGetServicesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.api.serviceusage.v1.IBatchGetServicesResponse,
          protos.google.api.serviceusage.v1.IBatchGetServicesRequest|null|undefined,
          {}|null|undefined>): void;
  batchGetServices(
      request: protos.google.api.serviceusage.v1.IBatchGetServicesRequest,
      callback: Callback<
  ...
  batchGetServices(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('batchGetServices request %j', request);
    const wrappedCallback: Callback<
        protos.google.api.serviceusage.v1.IBatchGetServicesResponse,
        protos.google.api.serviceusage.v1.IBatchGetServicesRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchGetServices response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.batchGetServices(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.api.serviceusage.v1.IBatchGetServicesResponse,
 ...
 */
  async checkEnableServiceProgress(name: string): Promise<LROperation<protos.google.api.serviceusage.v1.EnableServiceResponse, protos.google.api.serviceusage.v1.OperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.api.serviceusage.v1.EnableServiceResponse, protos.google.api.serviceusage.v1.OperationMetadata>;
  }
/**
 ...
 */
  async checkDisableServiceProgress(name: string): Promise<LROperation<protos.google.api.serviceusage.v1.DisableServiceResponse, protos.google.api.serviceusage.v1.OperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.api.serviceusage.v1.DisableServiceResponse, protos.google.api.serviceusage.v1.OperationMetadata>;
  }
/**
 ...
 */
  async checkBatchEnableServicesProgress(name: string): Promise<LROperation<protos.google.api.serviceusage.v1.BatchEnableServicesResponse, protos.google.api.serviceusage.v1.OperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.api.serviceusage.v1.BatchEnableServicesResponse, protos.google.api.serviceusage.v1.OperationMetadata>;
  }
 /**
 ...
 */
  ...
  listServices(
      ...
      callback: PaginationCallback<
          ...
          protos.google.api.serviceusage.v1.IListServicesResponse|null|undefined,
          protos.google.api.serviceusage.v1.IService>): void;
  listServices(
      request: protos.google.api.serviceusage.v1.IListServicesRequest,
      callback: PaginationCallback<
          protos.google.api.serviceusage.v1.IListServicesRequest,
  ...
  listServices(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.api.serviceusage.v1.IListServicesRequest,
      protos.google.api.serviceusage.v1.IListServicesResponse|null|undefined,
      protos.google.api.serviceusage.v1.IService>|undefined = callback
