...
describe('v1beta1.DepServiceClient', () => {
  ...
  describe('Path templates', () => {
    ...
    describe('projectGlobalForwardingRule', () => {
      ...
      client.pathTemplates.projectGlobalForwardingRulePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('projectGlobalForwardingRulePath', () => {
        const result = client.projectGlobalForwardingRulePath(
          'projectValue',
          'forwardingRuleValue'
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.projectGlobalForwardingRulePathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters)
      ...
      it('matchProjectFromProjectGlobalForwardingRuleName', () => {
        const result =
          client.matchProjectFromProjectGlobalForwardingRuleName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.projectGlobalForwardingRulePathTemplate
      ...
      it('matchForwardingRuleFromProjectGlobalForwardingRuleName', () => {
        const result =
          client.matchForwardingRuleFromProjectGlobalForwardingRuleName(
            fakePath
          );
    ...
    describe('projectRegionForwardingRule', () => {
      ...
      client.pathTemplates.projectRegionForwardingRulePathTemplate.render =
        sinon.stub().returns(fakePath);
      client.pathTemplates.projectRegionForwardingRulePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('projectRegionForwardingRulePath', () => {
        const result = client.projectRegionForwardingRulePath(
          'projectValue',
          'regionValue',
          'forwardingRuleValue'
        );
        ...
        assert(
          (
            client.pathTemplates.projectRegionForwardingRulePathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters)
      ...
      it('matchProjectFromProjectRegionForwardingRuleName', () => {
        const result =
          client.matchProjectFromProjectRegionForwardingRuleName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.projectRegionForwardingRulePathTemplate
      ...
      it('matchRegionFromProjectRegionForwardingRuleName', () => {
        const result =
          client.matchRegionFromProjectRegionForwardingRuleName(fakePath);
      ...
      it('matchForwardingRuleFromProjectRegionForwardingRuleName', () => {
        const result =
          client.matchForwardingRuleFromProjectRegionForwardingRuleName(
            fakePath
          );
        assert.strictEqual(result, 'forwardingRuleValue');
        assert(
