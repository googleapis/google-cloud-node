...
describe('v1.NetworkServicesClient', () => {
  ...
  describe('getWasmPluginVersion', () => {
    it('invokes getWasmPluginVersion without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getWasmPluginVersion as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getWasmPluginVersion as SinonStub
    ...
    it('invokes getWasmPluginVersion without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getWasmPluginVersion(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networkservices.v1.IWasmPluginVersion | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getWasmPluginVersion with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getWasmPluginVersion = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getWasmPlugin', () => {
    it('invokes getWasmPlugin without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getWasmPlugin as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getWasmPlugin as SinonStub
    ...
    it('invokes getWasmPlugin without error using callback', async () => {
      ...
      client.innerApiCalls.getWasmPlugin =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getWasmPlugin(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networkservices.v1.IWasmPlugin | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getWasmPlugin with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getWasmPlugin = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getServiceLbPolicy', () => {
    it('invokes getServiceLbPolicy without error', async () => {
      ...
      client.innerApiCalls.getServiceLbPolicy =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getServiceLbPolicy(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getServiceLbPolicy as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getServiceLbPolicy as SinonStub
    ...
    it('invokes getServiceLbPolicy without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getServiceLbPolicy(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networkservices.v1.IServiceLbPolicy | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getServiceLbPolicy with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getServiceLbPolicy = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getGatewayRouteView', () => {
    it('invokes getGatewayRouteView without error', async () => {
      ...
      client.innerApiCalls.getGatewayRouteView =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getGatewayRouteView(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getGatewayRouteView as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getGatewayRouteView as SinonStub
    ...
    it('invokes getGatewayRouteView without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getGatewayRouteView(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networkservices.v1.IGatewayRouteView | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getGatewayRouteView with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getGatewayRouteView = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getMeshRouteView', () => {
    it('invokes getMeshRouteView without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getMeshRouteView as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getMeshRouteView as SinonStub
    ...
    it('invokes getMeshRouteView without error using callback', async () => {
      ...
      client.innerApiCalls.getMeshRouteView =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getMeshRouteView(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networkservices.v1.IMeshRouteView | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getMeshRouteView with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getMeshRouteView = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createWasmPluginVersion', () => {
    it('invokes createWasmPluginVersion without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createWasmPluginVersion as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createWasmPluginVersion as SinonStub
    ...
    it('invokes createWasmPluginVersion with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createWasmPluginVersion = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createWasmPluginVersion(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createWasmPluginVersion as SinonStub
    ...
    it('invokes checkCreateWasmPluginVersionProgress without error', async () => {
      ...
      const decodedOperation =
        await client.checkCreateWasmPluginVersionProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkCreateWasmPluginVersionProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateWasmPluginVersionProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteWasmPluginVersion', () => {
    it('invokes deleteWasmPluginVersion without error', async () => {
      ...
      client.innerApiCalls.deleteWasmPluginVersion =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteWasmPluginVersion(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteWasmPluginVersion as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteWasmPluginVersion as SinonStub
    ...
    it('invokes deleteWasmPluginVersion with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteWasmPluginVersion = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteWasmPluginVersion(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteWasmPluginVersion as SinonStub
    ...
    it('invokes checkDeleteWasmPluginVersionProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkDeleteWasmPluginVersionProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkDeleteWasmPluginVersionProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteWasmPluginVersionProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createWasmPlugin', () => {
    it('invokes createWasmPlugin without error', async () => {
      ...
      client.innerApiCalls.createWasmPlugin =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createWasmPlugin(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createWasmPlugin as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createWasmPlugin as SinonStub
    ...
    it('invokes createWasmPlugin with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createWasmPlugin = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkCreateWasmPluginProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkCreateWasmPluginProgress(
        expectedResponse.name,
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkCreateWasmPluginProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateWasmPluginProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateWasmPlugin', () => {
    it('invokes updateWasmPlugin without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateWasmPlugin as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateWasmPlugin as SinonStub
    ...
    it('invokes updateWasmPlugin with call error', async () => {
      ...
      const expectedHeaderRequestParams = `wasm_plugin.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateWasmPlugin = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkUpdateWasmPluginProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkUpdateWasmPluginProgress(
        expectedResponse.name,
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('deleteWasmPlugin', () => {
    it('invokes deleteWasmPlugin without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteWasmPlugin as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteWasmPlugin as SinonStub
    ...
    it('invokes deleteWasmPlugin with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteWasmPlugin = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkDeleteWasmPluginProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkDeleteWasmPluginProgress(
        expectedResponse.name,
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkDeleteWasmPluginProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteWasmPluginProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateServiceBinding', () => {
    it('invokes updateServiceBinding without error', async () => {
      ...
      client.innerApiCalls.updateServiceBinding =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateServiceBinding(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateServiceBinding as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateServiceBinding as SinonStub
    ...
    it('invokes updateServiceBinding with call error', async () => {
      ...
      const expectedHeaderRequestParams = `service_binding.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateServiceBinding = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkUpdateServiceBindingProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkUpdateServiceBindingProgress(
        expectedResponse.name,
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkUpdateServiceBindingProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateServiceBindingProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createServiceLbPolicy', () => {
    it('invokes createServiceLbPolicy without error', async () => {
      ...
      client.innerApiCalls.createServiceLbPolicy =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createServiceLbPolicy(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createServiceLbPolicy as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createServiceLbPolicy as SinonStub
    ...
    it('invokes createServiceLbPolicy with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createServiceLbPolicy = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createServiceLbPolicy(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createServiceLbPolicy as SinonStub
    ...
    it('invokes checkCreateServiceLbPolicyProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkCreateServiceLbPolicyProgress(
        expectedResponse.name,
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('updateServiceLbPolicy', () => {
    it('invokes updateServiceLbPolicy without error', async () => {
      ...
      client.innerApiCalls.updateServiceLbPolicy =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateServiceLbPolicy(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateServiceLbPolicy as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateServiceLbPolicy as SinonStub
    ...
    it('invokes updateServiceLbPolicy with call error', async () => {
      ...
      const expectedHeaderRequestParams = `service_lb_policy.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateServiceLbPolicy = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateServiceLbPolicy(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateServiceLbPolicy as SinonStub
    ...
    it('invokes checkUpdateServiceLbPolicyProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkUpdateServiceLbPolicyProgress(
        expectedResponse.name,
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkUpdateServiceLbPolicyProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateServiceLbPolicyProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteServiceLbPolicy', () => {
    it('invokes deleteServiceLbPolicy without error', async () => {
      ...
      client.innerApiCalls.deleteServiceLbPolicy =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteServiceLbPolicy(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteServiceLbPolicy as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteServiceLbPolicy as SinonStub
    ...
    it('invokes deleteServiceLbPolicy with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteServiceLbPolicy = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteServiceLbPolicy(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteServiceLbPolicy as SinonStub
    ...
    it('invokes checkDeleteServiceLbPolicyProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkDeleteServiceLbPolicyProgress(
        expectedResponse.name,
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkDeleteServiceLbPolicyProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteServiceLbPolicyProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listWasmPluginVersions', () => {
    it('invokes listWasmPluginVersions without error', async () => {
      ...
      client.innerApiCalls.listWasmPluginVersions =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listWasmPluginVersions(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listWasmPluginVersions as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listWasmPluginVersions as SinonStub
    ...
    it('invokes listWasmPluginVersions with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listWasmPluginVersions = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listWasmPluginVersions(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listWasmPluginVersions as SinonStub
    ...
    it('invokes listWasmPluginVersionsStream without error', async () => {
      ...
      client.descriptors.page.listWasmPluginVersions.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networkservices.v1.WasmPluginVersion,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (
          client.descriptors.page.listWasmPluginVersions
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listWasmPluginVersions, request),
      );
      assert(
        (
          client.descriptors.page.listWasmPluginVersions
    ...
    it('uses async iteration with listWasmPluginVersions without error', async () => {
      ...
      client.descriptors.page.listWasmPluginVersions.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listWasmPlugins', () => {
    it('invokes listWasmPlugins without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listWasmPlugins as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listWasmPlugins as SinonStub
    ...
    it('invokes listWasmPlugins without error using callback', async () => {
      ...
      client.innerApiCalls.listWasmPlugins =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listWasmPlugins with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listWasmPlugins = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listWasmPluginsStream without error', async () => {
      ...
      client.descriptors.page.listWasmPlugins.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.networkservices.v1.WasmPlugin) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listWasmPlugins.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listWasmPlugins, request),
      );
      assert(
        (client.descriptors.page.listWasmPlugins.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listWasmPlugins without error', async () => {
      ...
      client.descriptors.page.listWasmPlugins.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listServiceLbPolicies', () => {
    it('invokes listServiceLbPolicies without error', async () => {
      ...
      client.innerApiCalls.listServiceLbPolicies =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listServiceLbPolicies(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listServiceLbPolicies as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listServiceLbPolicies as SinonStub
    ...
    it('invokes listServiceLbPolicies with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listServiceLbPolicies = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listServiceLbPolicies(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listServiceLbPolicies as SinonStub
    ...
    it('invokes listServiceLbPoliciesStream without error', async () => {
      ...
      client.descriptors.page.listServiceLbPolicies.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networkservices.v1.ServiceLbPolicy,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (
          client.descriptors.page.listServiceLbPolicies
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listServiceLbPolicies, request),
      );
      assert(
        (
          client.descriptors.page.listServiceLbPolicies
    ...
    it('uses async iteration with listServiceLbPolicies without error', async () => {
      ...
      client.descriptors.page.listServiceLbPolicies.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listGatewayRouteViews', () => {
    it('invokes listGatewayRouteViews without error', async () => {
      ...
      client.innerApiCalls.listGatewayRouteViews =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listGatewayRouteViews(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listGatewayRouteViews as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listGatewayRouteViews as SinonStub
    ...
    it('invokes listGatewayRouteViews with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listGatewayRouteViews = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listGatewayRouteViews(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listGatewayRouteViews as SinonStub
    ...
    it('invokes listGatewayRouteViewsStream without error', async () => {
      ...
      client.descriptors.page.listGatewayRouteViews.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networkservices.v1.GatewayRouteView,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (
          client.descriptors.page.listGatewayRouteViews
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listGatewayRouteViews, request),
      );
      assert(
        (
          client.descriptors.page.listGatewayRouteViews
    ...
    it('uses async iteration with listGatewayRouteViews without error', async () => {
      ...
      client.descriptors.page.listGatewayRouteViews.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listMeshRouteViews', () => {
    it('invokes listMeshRouteViews without error', async () => {
      ...
      client.innerApiCalls.listMeshRouteViews =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listMeshRouteViews(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listMeshRouteViews as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listMeshRouteViews as SinonStub
    ...
    it('invokes listMeshRouteViews with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listMeshRouteViews = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listMeshRouteViewsStream without error', async () => {
      ...
      client.descriptors.page.listMeshRouteViews.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.networkservices.v1.MeshRouteView) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listMeshRouteViews.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listMeshRouteViews, request),
      );
      assert(
        (client.descriptors.page.listMeshRouteViews.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listMeshRouteViews without error', async () => {
      ...
      client.descriptors.page.listMeshRouteViews.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('Path templates', () => {
    describe('authzExtension', async () => {
      ...
      await client.initialize();
      client.pathTemplates.authzExtensionPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.authzExtensionPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('authzExtensionPath', () => {
        const result = client.authzExtensionPath(
          'projectValue',
          'locationValue',
          'authzExtensionValue',
        );
        ...
        assert(
          (client.pathTemplates.authzExtensionPathTemplate.render as SinonStub)
            .getCall(-1)
      ...
      it('matchProjectFromAuthzExtensionName', () => {
        ...
        assert(
          (client.pathTemplates.authzExtensionPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchAuthzExtensionFromAuthzExtensionName', () => {
        const result =
          client.matchAuthzExtensionFromAuthzExtensionName(fakePath);
    ...
    describe('gatewayRouteView', async () => {
      ...
      await client.initialize();
      client.pathTemplates.gatewayRouteViewPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.gatewayRouteViewPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);
      ...
      it('gatewayRouteViewPath', () => {
        ...
        assert(
          (
            client.pathTemplates.gatewayRouteViewPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromGatewayRouteViewName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.gatewayRouteViewPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('lbEdgeExtension', async () => {
      ...
      await client.initialize();
      client.pathTemplates.lbEdgeExtensionPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.lbEdgeExtensionPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('lbEdgeExtensionPath', () => {
        const result = client.lbEdgeExtensionPath(
          'projectValue',
          'locationValue',
          'lbEdgeExtensionValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.lbEdgeExtensionPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromLbEdgeExtensionName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.lbEdgeExtensionPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchLbEdgeExtensionFromLbEdgeExtensionName', () => {
        const result =
          client.matchLbEdgeExtensionFromLbEdgeExtensionName(fakePath);
    ...
    describe('meshRouteView', async () => {
      ...
      await client.initialize();
      client.pathTemplates.meshRouteViewPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.meshRouteViewPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('meshRouteViewPath', () => {
        const result = client.meshRouteViewPath(
          'projectValue',
          'locationValue',
          'meshValue',
          'routeViewValue',
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.meshRouteViewPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromMeshRouteViewName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.meshRouteViewPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('serviceLbPolicy', async () => {
      ...
      await client.initialize();
      client.pathTemplates.serviceLbPolicyPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.serviceLbPolicyPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('serviceLbPolicyPath', () => {
        const result = client.serviceLbPolicyPath(
          'projectValue',
          'locationValue',
          'serviceLbPolicyValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.serviceLbPolicyPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromServiceLbPolicyName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.serviceLbPolicyPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchServiceLbPolicyFromServiceLbPolicyName', () => {
        const result =
          client.matchServiceLbPolicyFromServiceLbPolicyName(fakePath);
    ...
    describe('wasmPlugin', async () => {
      ...
      await client.initialize();
      client.pathTemplates.wasmPluginPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.wasmPluginPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('wasmPluginPath', () => {
        const result = client.wasmPluginPath(
          'projectValue',
          'locationValue',
          'wasmPluginValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.wasmPluginPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromWasmPluginName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.wasmPluginPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('wasmPluginVersion', async () => {
      ...
      await client.initialize();
      client.pathTemplates.wasmPluginVersionPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.wasmPluginVersionPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('wasmPluginVersionPath', () => {
        const result = client.wasmPluginVersionPath(
          'projectValue',
          'locationValue',
          'wasmPluginValue',
          'wasmPluginVersionValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.wasmPluginVersionPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchWasmPluginFromWasmPluginVersionName', () => {
        const result =
          client.matchWasmPluginFromWasmPluginVersionName(fakePath);
        assert.strictEqual(result, 'wasmPluginValue');
        assert(
          (
            client.pathTemplates.wasmPluginVersionPathTemplate
      ...
      it('matchWasmPluginVersionFromWasmPluginVersionName', () => {
        const result =
          client.matchWasmPluginVersionFromWasmPluginVersionName(fakePath);
