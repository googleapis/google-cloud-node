...
describe('v1.CloudCatalogClient', () => {
    ...
    describe('listServices', () => {
        ...
        it('invokes listServices with error', async () => {
            ...
            await assert.rejects(async () => { await client.listServices(request); }, expectedError);
            assert((client.innerApiCalls.listServices as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('uses async iteration with listServices without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.billing.v1.ListServicesRequest());const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.billing.v1.Service()),
              generateSampleMessage(new protos.google.cloud.billing.v1.Service()),
              generateSampleMessage(new protos.google.cloud.billing.v1.Service()),
            ];
        ...
        it('uses async iteration with listServices with error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.billing.v1.ListServicesRequest());const expectedError = new Error('expected');
    ...
    describe('listSkus', () => {
        it('invokes listSkus without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.billing.v1.ListSkusRequest());
            request.parent = '';
        ...
        it('invokes listSkus with error', async () => {
            ...
            await assert.rejects(async () => { await client.listSkus(request); }, expectedError);
            assert((client.innerApiCalls.listSkus as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
