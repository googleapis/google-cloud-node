...
import * as cloud_billing_client_config from './cloud_billing_client_config.json';
import fs from 'fs';
 ...
 */
const gapicConfig = JSON.parse(fs.readFileSync(path.join(dirname, 'cloud_billing_client_config.json'),'utf8'));
