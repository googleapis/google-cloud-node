...
export class BinauthzManagementServiceV1Beta1Client {
  ...
  // -------------------
  /**
   * A {@link protos.google.cloud.binaryauthorization.v1beta1.Policy|policy} specifies the
   * {@link protos.google.cloud.binaryauthorization.v1beta1.Attestor|attestors} that must
   * attest to a container image, before the project is allowed to deploy that
   * image. There is at most one policy per project. All image admission
   * requests are permitted if a project has no policy.
   *
   * Gets the {@link protos.google.cloud.binaryauthorization.v1beta1.Policy|policy} for this
   * project. Returns a default
   * {@link protos.google.cloud.binaryauthorization.v1beta1.Policy|policy} if the project
   * does not have one.
   *
   ...
   *   {@link protos.google.cloud.binaryauthorization.v1beta1.Policy|policy} to retrieve, in
   ...
   * {@link protos.google.cloud.binaryauthorization.v1beta1.Policy|policy}, and returns a
   * copy of the new {@link protos.google.cloud.binaryauthorization.v1beta1.Policy|policy}.
   ...
   *   {@link protos.google.cloud.binaryauthorization.v1beta1.Policy|policy} value. The
  ...
  /**
   * Creates an {@link protos.google.cloud.binaryauthorization.v1beta1.Attestor|attestor},
   * and returns a copy of the new
   * {@link protos.google.cloud.binaryauthorization.v1beta1.Attestor|attestor}. Returns
   * NOT_FOUND if the project does not exist, INVALID_ARGUMENT if the request is
   * malformed, ALREADY_EXISTS if the
   * {@link protos.google.cloud.binaryauthorization.v1beta1.Attestor|attestor} already
   * exists.
   *
   * @param {Object} request
   *   The request object that will be sent.
   ...
   *   Required. The
   *   {@link protos.google.cloud.binaryauthorization.v1beta1.Attestor|attestors} ID.
   * @param {google.cloud.binaryauthorization.v1beta1.Attestor} request.attestor
   *   Required. The initial
   *   {@link protos.google.cloud.binaryauthorization.v1beta1.Attestor|attestor} value. The
   ...
   * {@link protos.google.cloud.binaryauthorization.v1beta1.Attestor|attestor} does not
   * exist.
   *
   * @param {Object} request
   *   The request object that will be sent.
   ...
   *   {@link protos.google.cloud.binaryauthorization.v1beta1.Attestor|attestor} to retrieve,
  ...
  /**
   * Deletes an {@link protos.google.cloud.binaryauthorization.v1beta1.Attestor|attestor}.
   * Returns NOT_FOUND if the
   * {@link protos.google.cloud.binaryauthorization.v1beta1.Attestor|attestor} does not
   * exist.
   *
   ...
   * @param {string} request.name
   *   Required. The name of the
   *   {@link protos.google.cloud.binaryauthorization.v1beta1.Attestor|attestors} to delete,
   *   in the format `projects/* /attestors/*`.
   * @param {object} [options]
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   ...
   *   {@link protos.google.cloud.binaryauthorization.v1beta1.Attestor|attestors}, in the
   *   format `projects/*`.
   ...
   *   {@link protos.google.cloud.binaryauthorization.v1beta1.ListAttestorsResponse.next_page_token|ListAttestorsResponse.next_page_token}
