...
describe('v1.ValidationHelperV1Client', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = validationhelperv1Module.v1.ValidationHelperV1Client.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = validationhelperv1Module.v1.ValidationHelperV1Client.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'binaryauthorization.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new validationhelperv1Module.v1.ValidationHelperV1Client({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'binaryauthorization.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new validationhelperv1Module.v1.ValidationHelperV1Client({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'binaryauthorization.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new validationhelperv1Module.v1.ValidationHelperV1Client({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new validationhelperv1Module.v1.ValidationHelperV1Client({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('validateAttestationOccurrence', () => {
        it('invokes validateAttestationOccurrence without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.binaryauthorization.v1.ValidateAttestationOccurrenceRequest', ['attestor']);
            ...
            client.innerApiCalls.validateAttestationOccurrence = stubSimpleCall(expectedResponse);
            const [response] = await client.validateAttestationOccurrence(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.validateAttestationOccurrence as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.validateAttestationOccurrence as SinonStub)
        ...
        it('invokes validateAttestationOccurrence without error using callback', async () => {
            ...
            client.innerApiCalls.validateAttestationOccurrence = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.validateAttestationOccurrence(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.binaryauthorization.v1.IValidateAttestationOccurrenceResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes validateAttestationOccurrence with error', async () => {
            ...
            client.innerApiCalls.validateAttestationOccurrence = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.validateAttestationOccurrence(request), expectedError);
            const actualRequest = (client.innerApiCalls.validateAttestationOccurrence as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.validateAttestationOccurrence as SinonStub)
