  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          telcoautomationModule.v1.TelcoAutomationClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          telcoautomationModule.v1.TelcoAutomationClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'telcoautomation.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new telcoautomationModule.v1.TelcoAutomationClient({
          universe_domain: 'example.com',
    ...
    it('invokes getOrchestrationCluster without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getOrchestrationCluster(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.telcoautomation.v1.IOrchestrationCluster | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getEdgeSlm without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getEdgeSlm(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.telcoautomation.v1.IEdgeSlm | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createBlueprint without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createBlueprint(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.telcoautomation.v1.IBlueprint | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes discardBlueprintChanges without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.discardBlueprintChanges(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.telcoautomation.v1.IDiscardBlueprintChangesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getPublicBlueprint without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getPublicBlueprint(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.telcoautomation.v1.IPublicBlueprint | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createDeployment without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createDeployment(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.telcoautomation.v1.IDeployment | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes discardDeploymentChanges without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.discardDeploymentChanges(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.telcoautomation.v1.IDiscardDeploymentChangesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes computeDeploymentStatus without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.computeDeploymentStatus(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.telcoautomation.v1.IComputeDeploymentStatusResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getHydratedDeployment without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getHydratedDeployment(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.telcoautomation.v1.IHydratedDeployment | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listOrchestrationClustersStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.telcoautomation.v1.OrchestrationCluster,
          ) => {
  ...
  describe('listEdgeSlms', () => {
    ...
    it('invokes listEdgeSlmsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.telcoautomation.v1.EdgeSlm) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listBlueprints', () => {
    ...
    it('invokes listBlueprintsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.telcoautomation.v1.Blueprint) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('searchDeploymentRevisions', () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.searchDeploymentRevisions(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.telcoautomation.v1.IDeployment[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes searchDeploymentRevisionsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.telcoautomation.v1.Deployment) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listPublicBlueprints(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.telcoautomation.v1.IPublicBlueprint[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listPublicBlueprintsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.telcoautomation.v1.PublicBlueprint,
          ) => {
            responses.push(response);
          },
        );
    ...
    it('invokes listHydratedDeploymentsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.telcoautomation.v1.HydratedDeployment,
          ) => {
            responses.push(response);
          },
        );
