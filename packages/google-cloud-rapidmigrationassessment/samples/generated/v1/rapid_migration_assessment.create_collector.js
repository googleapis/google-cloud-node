...
function main(parent, collectorId, collector) {
  ...
  async function callCreateCollector() {
    // Construct request
    const request = {
      parent,
      collectorId,
    ...
    // Run request
    const [operation] = await rapidmigrationassessmentClient.createCollector(request);
