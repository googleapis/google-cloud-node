...
function main(name) {
  ...
  async function callGetAnnotation() {
    ...
    // Run request
    const response = await rapidmigrationassessmentClient.getAnnotation(request);
    console.log(response);
  }

  callGetAnnotation();
  // [END rapidmigrationassessment_v1_generated_RapidMigrationAssessment_GetAnnotation_async]
}
