...
function main(parent, annotation) {
  ...
  async function callCreateAnnotation() {
    ...
    // Run request
    const [operation] = await rapidmigrationassessmentClient.createAnnotation(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callCreateAnnotation();
  // [END rapidmigrationassessment_v1_generated_RapidMigrationAssessment_CreateAnnotation_async]
}
