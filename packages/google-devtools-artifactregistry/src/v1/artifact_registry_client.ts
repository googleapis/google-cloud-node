...
export class ArtifactRegistryClient {
  ...
  > | void {
    ...
    return this.innerApiCalls
      .exportArtifact(request, options, wrappedCallback)
      ?.then(
        ([response, rawResponse, _]: [
          LROperation<
            protos.google.devtools.artifactregistry.v1.IExportArtifactResponse,
   ...
   * region_tag:artifactregistry_v1_generated_ArtifactRegistry_ExportArtifact_async
   */
  async checkExportArtifactProgress(
    name: string,
  ): Promise<
    LROperation<
      protos.google.devtools.artifactregistry.v1.ExportArtifactResponse,
      protos.google.devtools.artifactregistry.v1.ExportArtifactMetadata
    >
  > {
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.exportArtifact,
      this._gaxModule.createDefaultBackoffSettings(),
    );
    return decodeOperation as LROperation<
      protos.google.devtools.artifactregistry.v1.ExportArtifactResponse,
