...
describe('v1.ArtifactRegistryClient', () => {
  ...
  describe('exportArtifact', () => {
    it('invokes exportArtifact without error', async () => {
      const client = new artifactregistryModule.v1.ArtifactRegistryClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.devtools.artifactregistry.v1.ExportArtifactRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.exportArtifact =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.exportArtifact(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.exportArtifact as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.exportArtifact as SinonStub
    ...
    it('invokes exportArtifact without error using callback', async () => {
      const client = new artifactregistryModule.v1.ArtifactRegistryClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.exportArtifact =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.exportArtifact(
          request,
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.devtools.artifactregistry.v1.IExportArtifactResponse,
              protos.google.devtools.artifactregistry.v1.IExportArtifactMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
    ...
    it('invokes exportArtifact with call error', async () => {
      const client = new artifactregistryModule.v1.ArtifactRegistryClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `repository=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.exportArtifact = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.exportArtifact(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.exportArtifact as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes exportArtifact with LRO error', async () => {
      const client = new artifactregistryModule.v1.ArtifactRegistryClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
    ...
    it('invokes checkExportArtifactProgress without error', async () => {
      const client = new artifactregistryModule.v1.ArtifactRegistryClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkExportArtifactProgress(
        expectedResponse.name,
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkExportArtifactProgress with error', async () => {
      const client = new artifactregistryModule.v1.ArtifactRegistryClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      await assert.rejects(
        client.checkExportArtifactProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
      ...
      const promise = new Promise((resolve, reject) => {
        client.listDockerImages(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.devtools.artifactregistry.v1.IDockerImage[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listNpmPackages(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.devtools.artifactregistry.v1.INpmPackage[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listRepositories(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.devtools.artifactregistry.v1.IRepository[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listPackages(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.devtools.artifactregistry.v1.IPackage[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listVersions(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.devtools.artifactregistry.v1.IVersion[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listAttachments(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.devtools.artifactregistry.v1.IAttachment[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
