      ...
      const promise = new Promise((resolve, reject) => {
        client.listAccountSummaries(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.analytics.admin.v1beta.IAccountSummary[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listFirebaseLinks(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.analytics.admin.v1beta.IFirebaseLink[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listGoogleAdsLinks(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.analytics.admin.v1beta.IGoogleAdsLink[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
      ...
      const promise = new Promise((resolve, reject) => {
        client.searchChangeHistoryEvents(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.analytics.admin.v1beta.IChangeHistoryEvent[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listConversionEvents(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.analytics.admin.v1beta.IConversionEvent[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listCustomDimensions(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.analytics.admin.v1beta.ICustomDimension[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listCustomMetrics(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.analytics.admin.v1beta.ICustomMetric[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
