...
describe('v1alpha.AnalyticsAdminServiceClient', () => {
    ...
    describe('getAccount', () => {
        it('invokes getAccount without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.GetAccountRequest', ['name']);
    ...
    describe('deleteAccount', () => {
        it('invokes deleteAccount without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.DeleteAccountRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateAccount', () => {
        it('invokes updateAccount without error', async () => {
            ...
            request.account ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.UpdateAccountRequest', ['account', 'name']);
    ...
    describe('getProperty', () => {
        it('invokes getProperty without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.GetPropertyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getProperty as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getProperty as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('deleteProperty', () => {
        it('invokes deleteProperty without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.DeletePropertyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.Property()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteProperty as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteProperty as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('updateProperty', () => {
        it('invokes updateProperty without error', async () => {
            ...
            request.property ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.UpdatePropertyRequest', ['property', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateProperty as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateProperty as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('getUserLink', () => {
        it('invokes getUserLink without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.GetUserLinkRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getUserLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getUserLink as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('batchGetUserLinks', () => {
        it('invokes batchGetUserLinks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.BatchGetUserLinksRequest', ['parent']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchGetUserLinks as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchGetUserLinks as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('createUserLink', () => {
        it('invokes createUserLink without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.CreateUserLinkRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.UserLink()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createUserLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createUserLink as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('batchCreateUserLinks', () => {
        it('invokes batchCreateUserLinks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.BatchCreateUserLinksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchCreateUserLinks as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchCreateUserLinks as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('updateUserLink', () => {
        it('invokes updateUserLink without error', async () => {
            ...
            request.userLink ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.UpdateUserLinkRequest', ['userLink', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateUserLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateUserLink as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('batchUpdateUserLinks', () => {
        it('invokes batchUpdateUserLinks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.BatchUpdateUserLinksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchUpdateUserLinks as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchUpdateUserLinks as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('deleteUserLink', () => {
        it('invokes deleteUserLink without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.DeleteUserLinkRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteUserLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteUserLink as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('batchDeleteUserLinks', () => {
        it('invokes batchDeleteUserLinks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.BatchDeleteUserLinksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchDeleteUserLinks as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchDeleteUserLinks as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('createFirebaseLink', () => {
        it('invokes createFirebaseLink without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.CreateFirebaseLinkRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createFirebaseLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createFirebaseLink as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('deleteFirebaseLink', () => {
        it('invokes deleteFirebaseLink without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.DeleteFirebaseLinkRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteFirebaseLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteFirebaseLink as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('getGlobalSiteTag', () => {
        it('invokes getGlobalSiteTag without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.GetGlobalSiteTagRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getGlobalSiteTag as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getGlobalSiteTag as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('createGoogleAdsLink', () => {
        it('invokes createGoogleAdsLink without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.CreateGoogleAdsLinkRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createGoogleAdsLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createGoogleAdsLink as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('updateGoogleAdsLink', () => {
        it('invokes updateGoogleAdsLink without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.UpdateGoogleAdsLinkRequest', ['googleAdsLink', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateGoogleAdsLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateGoogleAdsLink as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('deleteGoogleAdsLink', () => {
        it('invokes deleteGoogleAdsLink without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.DeleteGoogleAdsLinkRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteGoogleAdsLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteGoogleAdsLink as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('getDataSharingSettings', () => {
        it('invokes getDataSharingSettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.GetDataSharingSettingsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getDataSharingSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDataSharingSettings as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('getMeasurementProtocolSecret', () => {
        it('invokes getMeasurementProtocolSecret without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.GetMeasurementProtocolSecretRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.MeasurementProtocolSecret()
            );
            client.innerApiCalls.getMeasurementProtocolSecret = stubSimpleCall(expectedResponse);
            const [response] = await client.getMeasurementProtocolSecret(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getMeasurementProtocolSecret as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getMeasurementProtocolSecret as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getMeasurementProtocolSecret without error using callback', async () => {
            ...
            client.innerApiCalls.getMeasurementProtocolSecret = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getMeasurementProtocolSecret(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.IMeasurementProtocolSecret|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getMeasurementProtocolSecret with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getMeasurementProtocolSecret = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getMeasurementProtocolSecret(request), expectedError);
            const actualRequest = (client.innerApiCalls.getMeasurementProtocolSecret as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getMeasurementProtocolSecret as SinonStub)
    ...
    describe('createMeasurementProtocolSecret', () => {
        it('invokes createMeasurementProtocolSecret without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.CreateMeasurementProtocolSecretRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.MeasurementProtocolSecret()
            );
            client.innerApiCalls.createMeasurementProtocolSecret = stubSimpleCall(expectedResponse);
            const [response] = await client.createMeasurementProtocolSecret(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createMeasurementProtocolSecret as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createMeasurementProtocolSecret as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createMeasurementProtocolSecret without error using callback', async () => {
            ...
            client.innerApiCalls.createMeasurementProtocolSecret = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createMeasurementProtocolSecret with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createMeasurementProtocolSecret = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createMeasurementProtocolSecret(request), expectedError);
            const actualRequest = (client.innerApiCalls.createMeasurementProtocolSecret as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createMeasurementProtocolSecret as SinonStub)
    ...
    describe('deleteMeasurementProtocolSecret', () => {
        it('invokes deleteMeasurementProtocolSecret without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.DeleteMeasurementProtocolSecretRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteMeasurementProtocolSecret = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteMeasurementProtocolSecret(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteMeasurementProtocolSecret as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteMeasurementProtocolSecret as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteMeasurementProtocolSecret without error using callback', async () => {
            ...
            client.innerApiCalls.deleteMeasurementProtocolSecret = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteMeasurementProtocolSecret with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteMeasurementProtocolSecret = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.deleteMeasurementProtocolSecret(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteMeasurementProtocolSecret as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteMeasurementProtocolSecret as SinonStub)
    ...
    describe('updateMeasurementProtocolSecret', () => {
        it('invokes updateMeasurementProtocolSecret without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.UpdateMeasurementProtocolSecretRequest', ['measurementProtocolSecret', 'name']);
            ...
            client.innerApiCalls.updateMeasurementProtocolSecret = stubSimpleCall(expectedResponse);
            const [response] = await client.updateMeasurementProtocolSecret(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateMeasurementProtocolSecret as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateMeasurementProtocolSecret as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateMeasurementProtocolSecret without error using callback', async () => {
            ...
            client.innerApiCalls.updateMeasurementProtocolSecret = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateMeasurementProtocolSecret with error', async () => {
            ...
            const expectedHeaderRequestParams = `measurement_protocol_secret.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateMeasurementProtocolSecret = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateMeasurementProtocolSecret(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateMeasurementProtocolSecret as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateMeasurementProtocolSecret as SinonStub)
    ...
    describe('acknowledgeUserDataCollection', () => {
        it('invokes acknowledgeUserDataCollection without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.AcknowledgeUserDataCollectionRequest', ['property']);
            ...
            client.innerApiCalls.acknowledgeUserDataCollection = stubSimpleCall(expectedResponse);
            const [response] = await client.acknowledgeUserDataCollection(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.acknowledgeUserDataCollection as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.acknowledgeUserDataCollection as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes acknowledgeUserDataCollection without error using callback', async () => {
            ...
            client.innerApiCalls.acknowledgeUserDataCollection = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.acknowledgeUserDataCollection(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.IAcknowledgeUserDataCollectionResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes acknowledgeUserDataCollection with error', async () => {
            ...
            const expectedHeaderRequestParams = `property=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.acknowledgeUserDataCollection = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.acknowledgeUserDataCollection(request), expectedError);
            const actualRequest = (client.innerApiCalls.acknowledgeUserDataCollection as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.acknowledgeUserDataCollection as SinonStub)
    ...
    describe('getGoogleSignalsSettings', () => {
        it('invokes getGoogleSignalsSettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.GetGoogleSignalsSettingsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.GoogleSignalsSettings()
            );
            client.innerApiCalls.getGoogleSignalsSettings = stubSimpleCall(expectedResponse);
            const [response] = await client.getGoogleSignalsSettings(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getGoogleSignalsSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getGoogleSignalsSettings as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getGoogleSignalsSettings without error using callback', async () => {
            ...
            client.innerApiCalls.getGoogleSignalsSettings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getGoogleSignalsSettings(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.IGoogleSignalsSettings|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getGoogleSignalsSettings with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getGoogleSignalsSettings = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getGoogleSignalsSettings(request), expectedError);
            const actualRequest = (client.innerApiCalls.getGoogleSignalsSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getGoogleSignalsSettings as SinonStub)
    ...
    describe('updateGoogleSignalsSettings', () => {
        it('invokes updateGoogleSignalsSettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.UpdateGoogleSignalsSettingsRequest', ['googleSignalsSettings', 'name']);
            ...
            client.innerApiCalls.updateGoogleSignalsSettings = stubSimpleCall(expectedResponse);
            const [response] = await client.updateGoogleSignalsSettings(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateGoogleSignalsSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateGoogleSignalsSettings as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateGoogleSignalsSettings without error using callback', async () => {
            ...
            client.innerApiCalls.updateGoogleSignalsSettings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateGoogleSignalsSettings with error', async () => {
            ...
            const expectedHeaderRequestParams = `google_signals_settings.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateGoogleSignalsSettings = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateGoogleSignalsSettings(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateGoogleSignalsSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateGoogleSignalsSettings as SinonStub)
    ...
    describe('createConversionEvent', () => {
        it('invokes createConversionEvent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.CreateConversionEventRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.ConversionEvent()
            );
            client.innerApiCalls.createConversionEvent = stubSimpleCall(expectedResponse);
            const [response] = await client.createConversionEvent(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createConversionEvent as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createConversionEvent as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createConversionEvent without error using callback', async () => {
            ...
            client.innerApiCalls.createConversionEvent = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createConversionEvent(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.IConversionEvent|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createConversionEvent with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createConversionEvent = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createConversionEvent(request), expectedError);
            const actualRequest = (client.innerApiCalls.createConversionEvent as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createConversionEvent as SinonStub)
    ...
    describe('getConversionEvent', () => {
        it('invokes getConversionEvent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.GetConversionEventRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.ConversionEvent()
            );
            client.innerApiCalls.getConversionEvent = stubSimpleCall(expectedResponse);
            const [response] = await client.getConversionEvent(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getConversionEvent as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getConversionEvent as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getConversionEvent without error using callback', async () => {
            ...
            client.innerApiCalls.getConversionEvent = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getConversionEvent with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getConversionEvent = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteConversionEvent', () => {
        it('invokes deleteConversionEvent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.DeleteConversionEventRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteConversionEvent = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteConversionEvent(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteConversionEvent as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteConversionEvent as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteConversionEvent without error using callback', async () => {
            ...
            client.innerApiCalls.deleteConversionEvent = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteConversionEvent with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteConversionEvent = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.deleteConversionEvent(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteConversionEvent as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteConversionEvent as SinonStub)
    ...
    describe('getDisplayVideo360AdvertiserLink', () => {
        it('invokes getDisplayVideo360AdvertiserLink without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.GetDisplayVideo360AdvertiserLinkRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.DisplayVideo360AdvertiserLink()
            );
            client.innerApiCalls.getDisplayVideo360AdvertiserLink = stubSimpleCall(expectedResponse);
            const [response] = await client.getDisplayVideo360AdvertiserLink(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getDisplayVideo360AdvertiserLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDisplayVideo360AdvertiserLink as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getDisplayVideo360AdvertiserLink without error using callback', async () => {
            ...
            client.innerApiCalls.getDisplayVideo360AdvertiserLink = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getDisplayVideo360AdvertiserLink(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.IDisplayVideo360AdvertiserLink|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getDisplayVideo360AdvertiserLink with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getDisplayVideo360AdvertiserLink = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getDisplayVideo360AdvertiserLink(request), expectedError);
            const actualRequest = (client.innerApiCalls.getDisplayVideo360AdvertiserLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDisplayVideo360AdvertiserLink as SinonStub)
    ...
    describe('createDisplayVideo360AdvertiserLink', () => {
        it('invokes createDisplayVideo360AdvertiserLink without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.CreateDisplayVideo360AdvertiserLinkRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.DisplayVideo360AdvertiserLink()
            );
            client.innerApiCalls.createDisplayVideo360AdvertiserLink = stubSimpleCall(expectedResponse);
            const [response] = await client.createDisplayVideo360AdvertiserLink(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createDisplayVideo360AdvertiserLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createDisplayVideo360AdvertiserLink as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createDisplayVideo360AdvertiserLink without error using callback', async () => {
            ...
            client.innerApiCalls.createDisplayVideo360AdvertiserLink = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createDisplayVideo360AdvertiserLink with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createDisplayVideo360AdvertiserLink = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createDisplayVideo360AdvertiserLink(request), expectedError);
            const actualRequest = (client.innerApiCalls.createDisplayVideo360AdvertiserLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createDisplayVideo360AdvertiserLink as SinonStub)
    ...
    describe('deleteDisplayVideo360AdvertiserLink', () => {
        it('invokes deleteDisplayVideo360AdvertiserLink without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.DeleteDisplayVideo360AdvertiserLinkRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteDisplayVideo360AdvertiserLink = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteDisplayVideo360AdvertiserLink(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteDisplayVideo360AdvertiserLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteDisplayVideo360AdvertiserLink as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteDisplayVideo360AdvertiserLink without error using callback', async () => {
            ...
            client.innerApiCalls.deleteDisplayVideo360AdvertiserLink = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteDisplayVideo360AdvertiserLink with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteDisplayVideo360AdvertiserLink = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.deleteDisplayVideo360AdvertiserLink(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteDisplayVideo360AdvertiserLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteDisplayVideo360AdvertiserLink as SinonStub)
    ...
    describe('updateDisplayVideo360AdvertiserLink', () => {
        it('invokes updateDisplayVideo360AdvertiserLink without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.UpdateDisplayVideo360AdvertiserLinkRequest', ['displayVideo_360AdvertiserLink', 'name']);
            ...
            client.innerApiCalls.updateDisplayVideo360AdvertiserLink = stubSimpleCall(expectedResponse);
            const [response] = await client.updateDisplayVideo360AdvertiserLink(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateDisplayVideo360AdvertiserLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateDisplayVideo360AdvertiserLink as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateDisplayVideo360AdvertiserLink without error using callback', async () => {
            ...
            client.innerApiCalls.updateDisplayVideo360AdvertiserLink = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateDisplayVideo360AdvertiserLink with error', async () => {
            ...
            const expectedHeaderRequestParams = `display_video_360_advertiser_link.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateDisplayVideo360AdvertiserLink = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateDisplayVideo360AdvertiserLink(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateDisplayVideo360AdvertiserLink as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateDisplayVideo360AdvertiserLink as SinonStub)
    ...
    describe('getDisplayVideo360AdvertiserLinkProposal', () => {
        it('invokes getDisplayVideo360AdvertiserLinkProposal without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.GetDisplayVideo360AdvertiserLinkProposalRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.DisplayVideo360AdvertiserLinkProposal()
            );
            client.innerApiCalls.getDisplayVideo360AdvertiserLinkProposal = stubSimpleCall(expectedResponse);
            const [response] = await client.getDisplayVideo360AdvertiserLinkProposal(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getDisplayVideo360AdvertiserLinkProposal as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDisplayVideo360AdvertiserLinkProposal as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getDisplayVideo360AdvertiserLinkProposal without error using callback', async () => {
            ...
            client.innerApiCalls.getDisplayVideo360AdvertiserLinkProposal = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getDisplayVideo360AdvertiserLinkProposal(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.IDisplayVideo360AdvertiserLinkProposal|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getDisplayVideo360AdvertiserLinkProposal with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getDisplayVideo360AdvertiserLinkProposal = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getDisplayVideo360AdvertiserLinkProposal(request), expectedError);
            const actualRequest = (client.innerApiCalls.getDisplayVideo360AdvertiserLinkProposal as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDisplayVideo360AdvertiserLinkProposal as SinonStub)
    ...
    describe('createDisplayVideo360AdvertiserLinkProposal', () => {
        it('invokes createDisplayVideo360AdvertiserLinkProposal without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.CreateDisplayVideo360AdvertiserLinkProposalRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.DisplayVideo360AdvertiserLinkProposal()
            );
            client.innerApiCalls.createDisplayVideo360AdvertiserLinkProposal = stubSimpleCall(expectedResponse);
            const [response] = await client.createDisplayVideo360AdvertiserLinkProposal(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createDisplayVideo360AdvertiserLinkProposal as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createDisplayVideo360AdvertiserLinkProposal as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createDisplayVideo360AdvertiserLinkProposal without error using callback', async () => {
            ...
            client.innerApiCalls.createDisplayVideo360AdvertiserLinkProposal = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createDisplayVideo360AdvertiserLinkProposal with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createDisplayVideo360AdvertiserLinkProposal = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createDisplayVideo360AdvertiserLinkProposal(request), expectedError);
            const actualRequest = (client.innerApiCalls.createDisplayVideo360AdvertiserLinkProposal as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createDisplayVideo360AdvertiserLinkProposal as SinonStub)
    ...
    describe('deleteDisplayVideo360AdvertiserLinkProposal', () => {
        it('invokes deleteDisplayVideo360AdvertiserLinkProposal without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.DeleteDisplayVideo360AdvertiserLinkProposalRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteDisplayVideo360AdvertiserLinkProposal = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteDisplayVideo360AdvertiserLinkProposal(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteDisplayVideo360AdvertiserLinkProposal as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteDisplayVideo360AdvertiserLinkProposal as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteDisplayVideo360AdvertiserLinkProposal without error using callback', async () => {
            ...
            client.innerApiCalls.deleteDisplayVideo360AdvertiserLinkProposal = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteDisplayVideo360AdvertiserLinkProposal with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteDisplayVideo360AdvertiserLinkProposal = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.deleteDisplayVideo360AdvertiserLinkProposal(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteDisplayVideo360AdvertiserLinkProposal as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteDisplayVideo360AdvertiserLinkProposal as SinonStub)
    ...
    describe('approveDisplayVideo360AdvertiserLinkProposal', () => {
        it('invokes approveDisplayVideo360AdvertiserLinkProposal without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.ApproveDisplayVideo360AdvertiserLinkProposalRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.ApproveDisplayVideo360AdvertiserLinkProposalResponse()
            );
            client.innerApiCalls.approveDisplayVideo360AdvertiserLinkProposal = stubSimpleCall(expectedResponse);
            const [response] = await client.approveDisplayVideo360AdvertiserLinkProposal(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.approveDisplayVideo360AdvertiserLinkProposal as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.approveDisplayVideo360AdvertiserLinkProposal as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes approveDisplayVideo360AdvertiserLinkProposal without error using callback', async () => {
            ...
            client.innerApiCalls.approveDisplayVideo360AdvertiserLinkProposal = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.approveDisplayVideo360AdvertiserLinkProposal(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.IApproveDisplayVideo360AdvertiserLinkProposalResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes approveDisplayVideo360AdvertiserLinkProposal with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.approveDisplayVideo360AdvertiserLinkProposal = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.approveDisplayVideo360AdvertiserLinkProposal(request), expectedError);
            const actualRequest = (client.innerApiCalls.approveDisplayVideo360AdvertiserLinkProposal as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.approveDisplayVideo360AdvertiserLinkProposal as SinonStub)
    ...
    describe('cancelDisplayVideo360AdvertiserLinkProposal', () => {
        it('invokes cancelDisplayVideo360AdvertiserLinkProposal without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.CancelDisplayVideo360AdvertiserLinkProposalRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.DisplayVideo360AdvertiserLinkProposal()
            );
            client.innerApiCalls.cancelDisplayVideo360AdvertiserLinkProposal = stubSimpleCall(expectedResponse);
            const [response] = await client.cancelDisplayVideo360AdvertiserLinkProposal(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.cancelDisplayVideo360AdvertiserLinkProposal as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.cancelDisplayVideo360AdvertiserLinkProposal as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes cancelDisplayVideo360AdvertiserLinkProposal without error using callback', async () => {
            ...
            client.innerApiCalls.cancelDisplayVideo360AdvertiserLinkProposal = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes cancelDisplayVideo360AdvertiserLinkProposal with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.cancelDisplayVideo360AdvertiserLinkProposal = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.cancelDisplayVideo360AdvertiserLinkProposal(request), expectedError);
            const actualRequest = (client.innerApiCalls.cancelDisplayVideo360AdvertiserLinkProposal as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.cancelDisplayVideo360AdvertiserLinkProposal as SinonStub)
    ...
    describe('createCustomDimension', () => {
        it('invokes createCustomDimension without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.CreateCustomDimensionRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.CustomDimension()
            );
            client.innerApiCalls.createCustomDimension = stubSimpleCall(expectedResponse);
            const [response] = await client.createCustomDimension(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createCustomDimension as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createCustomDimension as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createCustomDimension without error using callback', async () => {
            ...
            client.innerApiCalls.createCustomDimension = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createCustomDimension(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.ICustomDimension|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createCustomDimension with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createCustomDimension = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createCustomDimension(request), expectedError);
            const actualRequest = (client.innerApiCalls.createCustomDimension as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createCustomDimension as SinonStub)
    ...
    describe('updateCustomDimension', () => {
        it('invokes updateCustomDimension without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.UpdateCustomDimensionRequest', ['customDimension', 'name']);
            request.customDimension.name = defaultValue1;
            const expectedHeaderRequestParams = `custom_dimension.name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.CustomDimension()
            );
            client.innerApiCalls.updateCustomDimension = stubSimpleCall(expectedResponse);
            const [response] = await client.updateCustomDimension(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateCustomDimension as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateCustomDimension as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateCustomDimension without error using callback', async () => {
            ...
            client.innerApiCalls.updateCustomDimension = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateCustomDimension with error', async () => {
            ...
            const expectedHeaderRequestParams = `custom_dimension.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateCustomDimension = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateCustomDimension(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateCustomDimension as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateCustomDimension as SinonStub)
    ...
    describe('archiveCustomDimension', () => {
        it('invokes archiveCustomDimension without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.ArchiveCustomDimensionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.archiveCustomDimension = stubSimpleCall(expectedResponse);
            const [response] = await client.archiveCustomDimension(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.archiveCustomDimension as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.archiveCustomDimension as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes archiveCustomDimension without error using callback', async () => {
            ...
            client.innerApiCalls.archiveCustomDimension = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes archiveCustomDimension with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.archiveCustomDimension = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.archiveCustomDimension(request), expectedError);
            const actualRequest = (client.innerApiCalls.archiveCustomDimension as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.archiveCustomDimension as SinonStub)
    ...
    describe('getCustomDimension', () => {
        it('invokes getCustomDimension without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.GetCustomDimensionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.CustomDimension()
            );
            client.innerApiCalls.getCustomDimension = stubSimpleCall(expectedResponse);
            const [response] = await client.getCustomDimension(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getCustomDimension as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getCustomDimension as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getCustomDimension without error using callback', async () => {
            ...
            client.innerApiCalls.getCustomDimension = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getCustomDimension with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getCustomDimension = stubSimpleCall(undefined, expectedError);
    ...
    describe('createCustomMetric', () => {
        it('invokes createCustomMetric without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.CreateCustomMetricRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.CustomMetric()
            );
            client.innerApiCalls.createCustomMetric = stubSimpleCall(expectedResponse);
            const [response] = await client.createCustomMetric(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createCustomMetric as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createCustomMetric as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createCustomMetric without error using callback', async () => {
            ...
            client.innerApiCalls.createCustomMetric = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createCustomMetric(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.ICustomMetric|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createCustomMetric with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createCustomMetric = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateCustomMetric', () => {
        it('invokes updateCustomMetric without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.UpdateCustomMetricRequest', ['customMetric', 'name']);
            request.customMetric.name = defaultValue1;
            const expectedHeaderRequestParams = `custom_metric.name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.CustomMetric()
            );
            client.innerApiCalls.updateCustomMetric = stubSimpleCall(expectedResponse);
            const [response] = await client.updateCustomMetric(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateCustomMetric as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateCustomMetric as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateCustomMetric without error using callback', async () => {
            ...
            client.innerApiCalls.updateCustomMetric = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateCustomMetric with error', async () => {
            ...
            const expectedHeaderRequestParams = `custom_metric.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateCustomMetric = stubSimpleCall(undefined, expectedError);
    ...
    describe('archiveCustomMetric', () => {
        it('invokes archiveCustomMetric without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.ArchiveCustomMetricRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.archiveCustomMetric = stubSimpleCall(expectedResponse);
            const [response] = await client.archiveCustomMetric(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.archiveCustomMetric as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.archiveCustomMetric as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes archiveCustomMetric without error using callback', async () => {
            ...
            client.innerApiCalls.archiveCustomMetric = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes archiveCustomMetric with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.archiveCustomMetric = stubSimpleCall(undefined, expectedError);
    ...
    describe('getCustomMetric', () => {
        it('invokes getCustomMetric without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.GetCustomMetricRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.CustomMetric()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getCustomMetric as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getCustomMetric as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getCustomMetric without error using callback', async () => {
            ...
            client.innerApiCalls.getCustomMetric = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getCustomMetric with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getCustomMetric = stubSimpleCall(undefined, expectedError);
    ...
    describe('getDataRetentionSettings', () => {
        it('invokes getDataRetentionSettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.GetDataRetentionSettingsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.DataRetentionSettings()
            );
            client.innerApiCalls.getDataRetentionSettings = stubSimpleCall(expectedResponse);
            const [response] = await client.getDataRetentionSettings(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getDataRetentionSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDataRetentionSettings as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getDataRetentionSettings without error using callback', async () => {
            ...
            client.innerApiCalls.getDataRetentionSettings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getDataRetentionSettings(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.IDataRetentionSettings|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getDataRetentionSettings with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getDataRetentionSettings = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getDataRetentionSettings(request), expectedError);
            const actualRequest = (client.innerApiCalls.getDataRetentionSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDataRetentionSettings as SinonStub)
    ...
    describe('updateDataRetentionSettings', () => {
        it('invokes updateDataRetentionSettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.UpdateDataRetentionSettingsRequest', ['dataRetentionSettings', 'name']);
            ...
            client.innerApiCalls.updateDataRetentionSettings = stubSimpleCall(expectedResponse);
            const [response] = await client.updateDataRetentionSettings(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateDataRetentionSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateDataRetentionSettings as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateDataRetentionSettings without error using callback', async () => {
            ...
            client.innerApiCalls.updateDataRetentionSettings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateDataRetentionSettings with error', async () => {
            ...
            const expectedHeaderRequestParams = `data_retention_settings.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateDataRetentionSettings = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateDataRetentionSettings(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateDataRetentionSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateDataRetentionSettings as SinonStub)
    ...
    describe('createDataStream', () => {
        it('invokes createDataStream without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.CreateDataStreamRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createDataStream as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createDataStream as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createDataStream without error using callback', async () => {
            ...
            client.innerApiCalls.createDataStream = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createDataStream(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.IDataStream|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createDataStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createDataStream = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteDataStream', () => {
        it('invokes deleteDataStream without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.DeleteDataStreamRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteDataStream as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteDataStream as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteDataStream without error using callback', async () => {
            ...
            client.innerApiCalls.deleteDataStream = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteDataStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteDataStream = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateDataStream', () => {
        it('invokes updateDataStream without error', async () => {
            ...
            request.dataStream ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.UpdateDataStreamRequest', ['dataStream', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateDataStream as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateDataStream as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateDataStream without error using callback', async () => {
            ...
            client.innerApiCalls.updateDataStream = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateDataStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `data_stream.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateDataStream = stubSimpleCall(undefined, expectedError);
    ...
    describe('getDataStream', () => {
        it('invokes getDataStream without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.GetDataStreamRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.DataStream()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getDataStream as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDataStream as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getDataStream without error using callback', async () => {
            ...
            client.innerApiCalls.getDataStream = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getDataStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getDataStream = stubSimpleCall(undefined, expectedError);
    ...
    describe('getAudience', () => {
        it('invokes getAudience without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.GetAudienceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getAudience as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getAudience as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getAudience without error using callback', async () => {
            ...
            client.innerApiCalls.getAudience = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAudience(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.IAudience|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAudience with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getAudience = stubSimpleCall(undefined, expectedError);
    ...
    describe('createAudience', () => {
        it('invokes createAudience without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.CreateAudienceRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.Audience()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createAudience as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createAudience as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createAudience without error using callback', async () => {
            ...
            client.innerApiCalls.createAudience = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createAudience with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createAudience = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateAudience', () => {
        it('invokes updateAudience without error', async () => {
            ...
            request.audience ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.UpdateAudienceRequest', ['audience', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateAudience as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateAudience as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateAudience without error using callback', async () => {
            ...
            client.innerApiCalls.updateAudience = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateAudience with error', async () => {
            ...
            const expectedHeaderRequestParams = `audience.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateAudience = stubSimpleCall(undefined, expectedError);
    ...
    describe('archiveAudience', () => {
        it('invokes archiveAudience without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.ArchiveAudienceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.archiveAudience as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.archiveAudience as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes archiveAudience without error using callback', async () => {
            ...
            client.innerApiCalls.archiveAudience = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes archiveAudience with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.archiveAudience = stubSimpleCall(undefined, expectedError);
    ...
    describe('getAttributionSettings', () => {
        it('invokes getAttributionSettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.GetAttributionSettingsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.AttributionSettings()
            );
            client.innerApiCalls.getAttributionSettings = stubSimpleCall(expectedResponse);
            const [response] = await client.getAttributionSettings(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getAttributionSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getAttributionSettings as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getAttributionSettings without error using callback', async () => {
            ...
            client.innerApiCalls.getAttributionSettings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAttributionSettings(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.IAttributionSettings|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAttributionSettings with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getAttributionSettings = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAttributionSettings(request), expectedError);
            const actualRequest = (client.innerApiCalls.getAttributionSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getAttributionSettings as SinonStub)
    ...
    describe('updateAttributionSettings', () => {
        it('invokes updateAttributionSettings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.UpdateAttributionSettingsRequest', ['attributionSettings', 'name']);
            request.attributionSettings.name = defaultValue1;
            const expectedHeaderRequestParams = `attribution_settings.name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.analytics.admin.v1alpha.AttributionSettings()
            );
            client.innerApiCalls.updateAttributionSettings = stubSimpleCall(expectedResponse);
            const [response] = await client.updateAttributionSettings(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateAttributionSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateAttributionSettings as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateAttributionSettings without error using callback', async () => {
            ...
            client.innerApiCalls.updateAttributionSettings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateAttributionSettings with error', async () => {
            ...
            const expectedHeaderRequestParams = `attribution_settings.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateAttributionSettings = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateAttributionSettings(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateAttributionSettings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateAttributionSettings as SinonStub)
    ...
    describe('runAccessReport', () => {
        it('invokes runAccessReport without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.RunAccessReportRequest', ['entity']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.runAccessReport as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.runAccessReport as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes runAccessReport without error using callback', async () => {
            ...
            client.innerApiCalls.runAccessReport = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.runAccessReport(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.IRunAccessReportResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes runAccessReport with error', async () => {
            ...
            const expectedHeaderRequestParams = `entity=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.runAccessReport = stubSimpleCall(undefined, expectedError);
    ...
    describe('listUserLinks', () => {
        it('invokes listUserLinks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.ListUserLinksRequest', ['parent']);
            request.parent = defaultValue1;
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listUserLinks as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listUserLinks as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('auditUserLinks', () => {
        it('invokes auditUserLinks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.AuditUserLinksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.auditUserLinks as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.auditUserLinks as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('listFirebaseLinks', () => {
        it('invokes listFirebaseLinks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.ListFirebaseLinksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listFirebaseLinks as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listFirebaseLinks as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('listGoogleAdsLinks', () => {
        it('invokes listGoogleAdsLinks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.ListGoogleAdsLinksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listGoogleAdsLinks as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listGoogleAdsLinks as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('listMeasurementProtocolSecrets', () => {
        it('invokes listMeasurementProtocolSecrets without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.ListMeasurementProtocolSecretsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.MeasurementProtocolSecret()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.MeasurementProtocolSecret()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.MeasurementProtocolSecret()),
            ];
            client.innerApiCalls.listMeasurementProtocolSecrets = stubSimpleCall(expectedResponse);
            const [response] = await client.listMeasurementProtocolSecrets(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listMeasurementProtocolSecrets as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listMeasurementProtocolSecrets as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listMeasurementProtocolSecrets without error using callback', async () => {
            ...
            client.innerApiCalls.listMeasurementProtocolSecrets = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listMeasurementProtocolSecrets with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listMeasurementProtocolSecrets = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listMeasurementProtocolSecrets(request), expectedError);
            const actualRequest = (client.innerApiCalls.listMeasurementProtocolSecrets as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listMeasurementProtocolSecrets as SinonStub)
        ...
        it('invokes listMeasurementProtocolSecretsStream without error', async () => {
            ...
            client.descriptors.page.listMeasurementProtocolSecrets.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.MeasurementProtocolSecret) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listMeasurementProtocolSecrets.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listMeasurementProtocolSecrets, request));
            assert(
                (client.descriptors.page.listMeasurementProtocolSecrets.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listMeasurementProtocolSecretsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listMeasurementProtocolSecrets.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listMeasurementProtocolSecretsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.analytics.admin.v1alpha.MeasurementProtocolSecret[] = [];
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.MeasurementProtocolSecret) => {
        ...
        it('uses async iteration with listMeasurementProtocolSecrets without error', async () => {
            ...
            client.descriptors.page.listMeasurementProtocolSecrets.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listMeasurementProtocolSecrets.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listMeasurementProtocolSecrets.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listMeasurementProtocolSecrets with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listMeasurementProtocolSecrets.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listMeasurementProtocolSecretsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.analytics.admin.v1alpha.IMeasurementProtocolSecret[] = [];
                for await (const resource of iterable) {
    ...
    describe('searchChangeHistoryEvents', () => {
        it('invokes searchChangeHistoryEvents without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.SearchChangeHistoryEventsRequest', ['account']);
            request.account = defaultValue1;
            const expectedHeaderRequestParams = `account=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.ChangeHistoryEvent()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.ChangeHistoryEvent()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.ChangeHistoryEvent()),
            ];
            client.innerApiCalls.searchChangeHistoryEvents = stubSimpleCall(expectedResponse);
            const [response] = await client.searchChangeHistoryEvents(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.searchChangeHistoryEvents as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.searchChangeHistoryEvents as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes searchChangeHistoryEvents without error using callback', async () => {
            ...
            client.innerApiCalls.searchChangeHistoryEvents = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.searchChangeHistoryEvents(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.admin.v1alpha.IChangeHistoryEvent[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes searchChangeHistoryEvents with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.searchChangeHistoryEvents = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.searchChangeHistoryEvents(request), expectedError);
            const actualRequest = (client.innerApiCalls.searchChangeHistoryEvents as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.searchChangeHistoryEvents as SinonStub)
        ...
        it('invokes searchChangeHistoryEventsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.ChangeHistoryEvent) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.searchChangeHistoryEvents.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.searchChangeHistoryEvents, request));
            assert(
                (client.descriptors.page.searchChangeHistoryEvents.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes searchChangeHistoryEventsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `account=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.searchChangeHistoryEvents.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.searchChangeHistoryEventsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.analytics.admin.v1alpha.ChangeHistoryEvent[] = [];
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.ChangeHistoryEvent) => {
        ...
        it('uses async iteration with searchChangeHistoryEvents without error', async () => {
            ...
            client.descriptors.page.searchChangeHistoryEvents.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.searchChangeHistoryEvents.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.searchChangeHistoryEvents.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with searchChangeHistoryEvents with error', async () => {
            ...
            const expectedHeaderRequestParams = `account=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.searchChangeHistoryEvents.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.searchChangeHistoryEventsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.analytics.admin.v1alpha.IChangeHistoryEvent[] = [];
                for await (const resource of iterable) {
    ...
    describe('listConversionEvents', () => {
        it('invokes listConversionEvents without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.ListConversionEventsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.ConversionEvent()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.ConversionEvent()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.ConversionEvent()),
            ];
            client.innerApiCalls.listConversionEvents = stubSimpleCall(expectedResponse);
            const [response] = await client.listConversionEvents(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listConversionEvents as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listConversionEvents as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listConversionEvents without error using callback', async () => {
            ...
            client.innerApiCalls.listConversionEvents = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listConversionEvents with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listConversionEvents = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listConversionEventsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.ConversionEvent) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listConversionEvents.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listConversionEvents, request));
            assert(
        ...
        it('invokes listConversionEventsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listConversionEvents.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listConversionEventsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.analytics.admin.v1alpha.ConversionEvent[] = [];
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.ConversionEvent) => {
        ...
        it('uses async iteration with listConversionEvents without error', async () => {
            ...
            client.descriptors.page.listConversionEvents.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listConversionEvents with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listConversionEvents.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listConversionEventsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.analytics.admin.v1alpha.IConversionEvent[] = [];
                for await (const resource of iterable) {
    ...
    describe('listDisplayVideo360AdvertiserLinks', () => {
        it('invokes listDisplayVideo360AdvertiserLinks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.ListDisplayVideo360AdvertiserLinksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.DisplayVideo360AdvertiserLink()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.DisplayVideo360AdvertiserLink()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.DisplayVideo360AdvertiserLink()),
            ];
            client.innerApiCalls.listDisplayVideo360AdvertiserLinks = stubSimpleCall(expectedResponse);
            const [response] = await client.listDisplayVideo360AdvertiserLinks(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listDisplayVideo360AdvertiserLinks as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listDisplayVideo360AdvertiserLinks as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listDisplayVideo360AdvertiserLinks without error using callback', async () => {
            ...
            client.innerApiCalls.listDisplayVideo360AdvertiserLinks = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listDisplayVideo360AdvertiserLinks with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listDisplayVideo360AdvertiserLinks = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listDisplayVideo360AdvertiserLinks(request), expectedError);
            const actualRequest = (client.innerApiCalls.listDisplayVideo360AdvertiserLinks as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listDisplayVideo360AdvertiserLinks as SinonStub)
        ...
        it('invokes listDisplayVideo360AdvertiserLinksStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.DisplayVideo360AdvertiserLink) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listDisplayVideo360AdvertiserLinks.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listDisplayVideo360AdvertiserLinks, request));
            assert(
                (client.descriptors.page.listDisplayVideo360AdvertiserLinks.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listDisplayVideo360AdvertiserLinksStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDisplayVideo360AdvertiserLinks.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listDisplayVideo360AdvertiserLinksStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.analytics.admin.v1alpha.DisplayVideo360AdvertiserLink[] = [];
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.DisplayVideo360AdvertiserLink) => {
        ...
        it('uses async iteration with listDisplayVideo360AdvertiserLinks without error', async () => {
            ...
            client.descriptors.page.listDisplayVideo360AdvertiserLinks.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listDisplayVideo360AdvertiserLinks.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listDisplayVideo360AdvertiserLinks.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listDisplayVideo360AdvertiserLinks with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDisplayVideo360AdvertiserLinks.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listDisplayVideo360AdvertiserLinksAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.analytics.admin.v1alpha.IDisplayVideo360AdvertiserLink[] = [];
                for await (const resource of iterable) {
    ...
    describe('listDisplayVideo360AdvertiserLinkProposals', () => {
        it('invokes listDisplayVideo360AdvertiserLinkProposals without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.ListDisplayVideo360AdvertiserLinkProposalsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
            ...
            client.innerApiCalls.listDisplayVideo360AdvertiserLinkProposals = stubSimpleCall(expectedResponse);
            const [response] = await client.listDisplayVideo360AdvertiserLinkProposals(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listDisplayVideo360AdvertiserLinkProposals as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listDisplayVideo360AdvertiserLinkProposals as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listDisplayVideo360AdvertiserLinkProposals without error using callback', async () => {
            ...
            client.innerApiCalls.listDisplayVideo360AdvertiserLinkProposals = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listDisplayVideo360AdvertiserLinkProposals with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listDisplayVideo360AdvertiserLinkProposals = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listDisplayVideo360AdvertiserLinkProposals(request), expectedError);
            const actualRequest = (client.innerApiCalls.listDisplayVideo360AdvertiserLinkProposals as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listDisplayVideo360AdvertiserLinkProposals as SinonStub)
        ...
        it('invokes listDisplayVideo360AdvertiserLinkProposalsStream without error', async () => {
            ...
            client.descriptors.page.listDisplayVideo360AdvertiserLinkProposals.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listDisplayVideo360AdvertiserLinkProposalsStream(request);
            const promise = new Promise((resolve, reject) => {
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listDisplayVideo360AdvertiserLinkProposals.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listDisplayVideo360AdvertiserLinkProposals, request));
            assert(
                (client.descriptors.page.listDisplayVideo360AdvertiserLinkProposals.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listDisplayVideo360AdvertiserLinkProposalsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDisplayVideo360AdvertiserLinkProposals.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listDisplayVideo360AdvertiserLinkProposalsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.analytics.admin.v1alpha.DisplayVideo360AdvertiserLinkProposal[] = [];
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.DisplayVideo360AdvertiserLinkProposal) => {
        ...
        it('uses async iteration with listDisplayVideo360AdvertiserLinkProposals without error', async () => {
            ...
            client.descriptors.page.listDisplayVideo360AdvertiserLinkProposals.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listDisplayVideo360AdvertiserLinkProposals.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listDisplayVideo360AdvertiserLinkProposals.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listDisplayVideo360AdvertiserLinkProposals with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDisplayVideo360AdvertiserLinkProposals.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listDisplayVideo360AdvertiserLinkProposalsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.analytics.admin.v1alpha.IDisplayVideo360AdvertiserLinkProposal[] = [];
                for await (const resource of iterable) {
    ...
    describe('listCustomDimensions', () => {
        it('invokes listCustomDimensions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.ListCustomDimensionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.CustomDimension()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.CustomDimension()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.CustomDimension()),
            ];
            client.innerApiCalls.listCustomDimensions = stubSimpleCall(expectedResponse);
            const [response] = await client.listCustomDimensions(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listCustomDimensions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listCustomDimensions as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listCustomDimensions without error using callback', async () => {
            ...
            client.innerApiCalls.listCustomDimensions = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listCustomDimensions with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listCustomDimensions = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listCustomDimensionsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.CustomDimension) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listCustomDimensions.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listCustomDimensions, request));
            assert(
        ...
        it('invokes listCustomDimensionsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listCustomDimensions.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listCustomDimensionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.analytics.admin.v1alpha.CustomDimension[] = [];
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.CustomDimension) => {
        ...
        it('uses async iteration with listCustomDimensions without error', async () => {
            ...
            client.descriptors.page.listCustomDimensions.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listCustomDimensions with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listCustomDimensions.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listCustomDimensionsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.analytics.admin.v1alpha.ICustomDimension[] = [];
                for await (const resource of iterable) {
    ...
    describe('listCustomMetrics', () => {
        it('invokes listCustomMetrics without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.ListCustomMetricsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.CustomMetric()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.CustomMetric()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.CustomMetric()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listCustomMetrics as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listCustomMetrics as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listCustomMetrics without error using callback', async () => {
            ...
            client.innerApiCalls.listCustomMetrics = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listCustomMetrics with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listCustomMetrics = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listCustomMetricsStream without error', async () => {
            ...
            client.descriptors.page.listCustomMetrics.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listCustomMetricsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.analytics.admin.v1alpha.CustomMetric[] = [];
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.CustomMetric) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listCustomMetrics.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listCustomMetrics, request));
            assert(
        ...
        it('invokes listCustomMetricsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listCustomMetrics.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listCustomMetricsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.analytics.admin.v1alpha.CustomMetric[] = [];
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.CustomMetric) => {
        ...
        it('uses async iteration with listCustomMetrics without error', async () => {
            ...
            client.descriptors.page.listCustomMetrics.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listCustomMetrics with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listCustomMetrics.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listCustomMetricsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.analytics.admin.v1alpha.ICustomMetric[] = [];
                for await (const resource of iterable) {
    ...
    describe('listDataStreams', () => {
        it('invokes listDataStreams without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.ListDataStreamsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.DataStream()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.DataStream()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.DataStream()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listDataStreams as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listDataStreams as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listDataStreams without error using callback', async () => {
            ...
            client.innerApiCalls.listDataStreams = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listDataStreams with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listDataStreams = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listDataStreamsStream without error', async () => {
            ...
            client.descriptors.page.listDataStreams.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listDataStreamsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.analytics.admin.v1alpha.DataStream[] = [];
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.DataStream) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listDataStreams.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listDataStreams, request));
            assert(
        ...
        it('invokes listDataStreamsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDataStreams.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listDataStreamsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.analytics.admin.v1alpha.DataStream[] = [];
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.DataStream) => {
        ...
        it('uses async iteration with listDataStreams without error', async () => {
            ...
            client.descriptors.page.listDataStreams.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listDataStreams with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDataStreams.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listDataStreamsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.analytics.admin.v1alpha.IDataStream[] = [];
                for await (const resource of iterable) {
    ...
    describe('listAudiences', () => {
        it('invokes listAudiences without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.analytics.admin.v1alpha.ListAudiencesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.Audience()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.Audience()),
              generateSampleMessage(new protos.google.analytics.admin.v1alpha.Audience()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listAudiences as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAudiences as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listAudiences without error using callback', async () => {
            ...
            client.innerApiCalls.listAudiences = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listAudiences with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listAudiences = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listAudiencesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.Audience) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listAudiences.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listAudiences, request));
            assert(
        ...
        it('invokes listAudiencesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAudiences.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listAudiencesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.analytics.admin.v1alpha.Audience[] = [];
                stream.on('data', (response: protos.google.analytics.admin.v1alpha.Audience) => {
        ...
        it('uses async iteration with listAudiences without error', async () => {
            ...
            client.descriptors.page.listAudiences.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listAudiences with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAudiences.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listAudiencesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.analytics.admin.v1alpha.IAudience[] = [];
                for await (const resource of iterable) {
    ...
    describe('Path templates', () => {
        ...
        describe('attributionSettings', () => {
            ...
            client.initialize();
            client.pathTemplates.attributionSettingsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.attributionSettingsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('attributionSettingsPath', () => {
                const result = client.attributionSettingsPath("propertyValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.attributionSettingsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchPropertyFromAttributionSettingsName', () => {
                const result = client.matchPropertyFromAttributionSettingsName(fakePath);
                assert.strictEqual(result, "propertyValue");
                assert((client.pathTemplates.attributionSettingsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
        ...
        describe('conversionEvent', () => {
            ...
            client.initialize();
            client.pathTemplates.conversionEventPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.conversionEventPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('conversionEventPath', () => {
                const result = client.conversionEventPath("propertyValue", "conversionEventValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.conversionEventPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchPropertyFromConversionEventName', () => {
                ...
                assert.strictEqual(result, "propertyValue");
                assert((client.pathTemplates.conversionEventPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchConversionEventFromConversionEventName', () => {
                const result = client.matchConversionEventFromConversionEventName(fakePath);
        ...
        describe('customDimension', () => {
            ...
            client.initialize();
            client.pathTemplates.customDimensionPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.customDimensionPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('customDimensionPath', () => {
                const result = client.customDimensionPath("propertyValue", "customDimensionValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.customDimensionPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchPropertyFromCustomDimensionName', () => {
                ...
                assert.strictEqual(result, "propertyValue");
                assert((client.pathTemplates.customDimensionPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('customMetric', () => {
            ...
            client.initialize();
            client.pathTemplates.customMetricPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.customMetricPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('customMetricPath', () => {
                const result = client.customMetricPath("propertyValue", "customMetricValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.customMetricPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchPropertyFromCustomMetricName', () => {
                ...
                assert.strictEqual(result, "propertyValue");
                assert((client.pathTemplates.customMetricPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('dataRetentionSettings', () => {
            ...
            client.initialize();
            client.pathTemplates.dataRetentionSettingsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.dataRetentionSettingsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('dataRetentionSettingsPath', () => {
                const result = client.dataRetentionSettingsPath("propertyValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.dataRetentionSettingsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchPropertyFromDataRetentionSettingsName', () => {
                const result = client.matchPropertyFromDataRetentionSettingsName(fakePath);
                assert.strictEqual(result, "propertyValue");
                assert((client.pathTemplates.dataRetentionSettingsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
        ...
        describe('dataStream', () => {
            ...
            client.initialize();
            client.pathTemplates.dataStreamPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.dataStreamPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('dataStreamPath', () => {
                const result = client.dataStreamPath("propertyValue", "dataStreamValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.dataStreamPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchPropertyFromDataStreamName', () => {
                ...
                assert.strictEqual(result, "propertyValue");
                assert((client.pathTemplates.dataStreamPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('displayVideo360AdvertiserLink', () => {
            ...
            it('displayVideo360AdvertiserLinkPath', () => {
                const result = client.displayVideo360AdvertiserLinkPath("propertyValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.displayVideo360AdvertiserLinkPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchPropertyFromDisplayVideo360AdvertiserLinkName', () => {
                const result = client.matchPropertyFromDisplayVideo360AdvertiserLinkName(fakePath);
                assert.strictEqual(result, "propertyValue");
                assert((client.pathTemplates.displayVideo360AdvertiserLinkPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
        ...
        describe('displayVideo360AdvertiserLinkProposal', () => {
            ...
            it('displayVideo360AdvertiserLinkProposalPath', () => {
                const result = client.displayVideo360AdvertiserLinkProposalPath("propertyValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.displayVideo360AdvertiserLinkProposalPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchPropertyFromDisplayVideo360AdvertiserLinkProposalName', () => {
                const result = client.matchPropertyFromDisplayVideo360AdvertiserLinkProposalName(fakePath);
                assert.strictEqual(result, "propertyValue");
                assert((client.pathTemplates.displayVideo360AdvertiserLinkProposalPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
        ...
        describe('globalSiteTag', () => {
            ...
            it('globalSiteTagPath', () => {
                const result = client.globalSiteTagPath("propertyValue", "dataStreamValue");
                assert.strictEqual(result, fakePath);
        ...
        describe('googleSignalsSettings', () => {
            ...
            client.initialize();
            client.pathTemplates.googleSignalsSettingsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.googleSignalsSettingsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('googleSignalsSettingsPath', () => {
                const result = client.googleSignalsSettingsPath("propertyValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.googleSignalsSettingsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchPropertyFromGoogleSignalsSettingsName', () => {
                const result = client.matchPropertyFromGoogleSignalsSettingsName(fakePath);
                assert.strictEqual(result, "propertyValue");
                assert((client.pathTemplates.googleSignalsSettingsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
        ...
        describe('measurementProtocolSecret', () => {
            ...
            client.initialize();
            client.pathTemplates.measurementProtocolSecretPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.measurementProtocolSecretPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('measurementProtocolSecretPath', () => {
                const result = client.measurementProtocolSecretPath("propertyValue", "dataStreamValue", "measurementProtocolSecretValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.measurementProtocolSecretPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchPropertyFromMeasurementProtocolSecretName', () => {
                const result = client.matchPropertyFromMeasurementProtocolSecretName(fakePath);
                assert.strictEqual(result, "propertyValue");
                assert((client.pathTemplates.measurementProtocolSecretPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchDataStreamFromMeasurementProtocolSecretName', () => {
                const result = client.matchDataStreamFromMeasurementProtocolSecretName(fakePath);
                assert.strictEqual(result, "dataStreamValue");
                assert((client.pathTemplates.measurementProtocolSecretPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchMeasurementProtocolSecretFromMeasurementProtocolSecretName', () => {
                const result = client.matchMeasurementProtocolSecretFromMeasurementProtocolSecretName(fakePath);
