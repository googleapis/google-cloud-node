...
function main(parent) {
  // [START analyticsadmin_v1alpha_generated_AnalyticsAdminService_ListDisplayVideo360AdvertiserLinkProposals_async]
  /**
  ...
  async function callListDisplayVideo360AdvertiserLinkProposals() {
    ...
    // Run request
    const iterable =
      await adminClient.listDisplayVideo360AdvertiserLinkProposalsAsync(
        request
      );
