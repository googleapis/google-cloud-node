...
function main(parent) {
  // [START analyticsadmin_v1alpha_generated_AnalyticsAdminService_ListIosAppDataStreams_async]
  /**
  ...
  async function callListIosAppDataStreams() {
    ...
    // Run request
    const iterable = await adminClient.listIosAppDataStreamsAsync(request);
