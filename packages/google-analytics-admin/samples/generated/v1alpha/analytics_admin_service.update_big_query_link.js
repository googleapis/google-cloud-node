...
function main(bigqueryLink, updateMask) {
  ...
  async function callUpdateBigQueryLink() {
    // Construct request
    const request = {
      bigqueryLink,
      updateMask,
    ...
    // Run request
    const response = await adminClient.updateBigQueryLink(request);
    console.log(response);
  }

  callUpdateBigQueryLink();
