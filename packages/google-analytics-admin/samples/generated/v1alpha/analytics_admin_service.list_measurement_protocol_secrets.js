...
function main(parent) {
  // [START analyticsadmin_v1alpha_generated_AnalyticsAdminService_ListMeasurementProtocolSecrets_async]
  /**
  ...
  async function callListMeasurementProtocolSecrets() {
    ...
    // Run request
    const iterable = await adminClient.listMeasurementProtocolSecretsAsync(
      request
    );
