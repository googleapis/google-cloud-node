...
describe('v1.ExecutionsClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new executionsModule.v1.ExecutionsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'workflowexecutions.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new executionsModule.v1.ExecutionsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'workflowexecutions.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new executionsModule.v1.ExecutionsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
                    assert.strictEqual(servicePath, 'workflowexecutions.configured.example.com');
                    if (saved) {
                        process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = saved;
                    } else {
                        delete process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new executionsModule.v1.ExecutionsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createExecution', () => {
        it('invokes createExecution without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.workflows.executions.v1.CreateExecutionRequest', ['parent']);
        ...
        it('invokes createExecution without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createExecution(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.workflows.executions.v1.IExecution|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getExecution', () => {
        it('invokes getExecution without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.workflows.executions.v1.GetExecutionRequest', ['name']);
    ...
    describe('cancelExecution', () => {
        it('invokes cancelExecution without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.workflows.executions.v1.CancelExecutionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.workflows.executions.v1.Execution()
        ...
        it('invokes cancelExecution without error using callback', async () => {
            ...
            client.innerApiCalls.cancelExecution = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes cancelExecution with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.cancelExecution = stubSimpleCall(undefined, expectedError);
    ...
    describe('listExecutions', () => {
        it('invokes listExecutions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.workflows.executions.v1.ListExecutionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.workflows.executions.v1.Execution()),
              generateSampleMessage(new protos.google.cloud.workflows.executions.v1.Execution()),
              generateSampleMessage(new protos.google.cloud.workflows.executions.v1.Execution()),
            ];
        ...
        it('invokes listExecutionsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.workflows.executions.v1.Execution) => {
    ...
    describe('Path templates', () => {
        ...
        describe('execution', async () => {
            ...
            it('executionPath', () => {
                const result = client.executionPath("projectValue", "locationValue", "workflowValue", "executionValue");
        ...
        describe('workflow', async () => {
            ...
            await client.initialize();
            client.pathTemplates.workflowPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.workflowPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('workflowPath', () => {
                const result = client.workflowPath("projectValue", "locationValue", "workflowValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.workflowPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromWorkflowName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.workflowPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
