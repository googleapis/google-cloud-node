...
export class FileServiceClient {
  ...
  initialize() {
    ...
    const fileServiceStubMethods =
        ['createFile', 'listFiles', 'getFile', 'deleteFile', 'downloadFile'];
 ...
 */
  ...
  createFile(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.createFile(request, options, wrappedCallback)
 ...
 */
  downloadFile(
      request?: protos.google.ai.generativelanguage.v1beta.IDownloadFileRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ai.generativelanguage.v1beta.IDownloadFileResponse,
        protos.google.ai.generativelanguage.v1beta.IDownloadFileRequest|undefined, {}|undefined
      ]>;
  downloadFile(
      request: protos.google.ai.generativelanguage.v1beta.IDownloadFileRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ai.generativelanguage.v1beta.IDownloadFileResponse,
          protos.google.ai.generativelanguage.v1beta.IDownloadFileRequest|null|undefined,
          {}|null|undefined>): void;
  downloadFile(
      request: protos.google.ai.generativelanguage.v1beta.IDownloadFileRequest,
      callback: Callback<
  ...
  downloadFile(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('downloadFile request %j', request);
    const wrappedCallback: Callback<
        protos.google.ai.generativelanguage.v1beta.IDownloadFileResponse,
        protos.google.ai.generativelanguage.v1beta.IDownloadFileRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('downloadFile response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.downloadFile(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.ai.generativelanguage.v1beta.IDownloadFileResponse,
 ...
 */
  ...
  listFiles(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.ai.generativelanguage.v1beta.IListFilesRequest,
      protos.google.ai.generativelanguage.v1beta.IListFilesResponse|null|undefined,
      protos.google.ai.generativelanguage.v1beta.IFile>|undefined = callback
