...
describe('v1.ModelServiceClient', () => {
    ...
    describe('getModel', () => {
        it('invokes getModel without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ai.generativelanguage.v1.GetModelRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1.GetModelRequest', ['name']);
        ...
        it('invokes getModel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getModel(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1.IModel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listModels', () => {
        it('invokes listModels without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ai.generativelanguage.v1.ListModelsRequest()
            );const expectedResponse = [
              generateSampleMessage(new protos.google.ai.generativelanguage.v1.Model()),
              generateSampleMessage(new protos.google.ai.generativelanguage.v1.Model()),
              generateSampleMessage(new protos.google.ai.generativelanguage.v1.Model()),
            ];
        ...
        it('invokes listModelsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ai.generativelanguage.v1.Model[] = [];
                stream.on('data', (response: protos.google.ai.generativelanguage.v1.Model) => {
        ...
        it('uses async iteration with listModels without error', async () => {
            ...
            const responses: protos.google.ai.generativelanguage.v1.IModel[] = [];
