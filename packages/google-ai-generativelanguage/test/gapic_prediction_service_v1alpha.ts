...
describe('v1alpha.PredictionServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new predictionserviceModule.v1alpha.PredictionServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          predictionserviceModule.v1alpha.PredictionServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          predictionserviceModule.v1alpha.PredictionServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'generativelanguage.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('invokes predict without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.predict(
          ...
          (
            err?: Error | null,
            result?: protos.google.ai.generativelanguage.v1alpha.IPredictResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
