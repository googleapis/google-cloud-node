...
describe('v1beta.GenerativeServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = generativeserviceModule.v1beta.GenerativeServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = generativeserviceModule.v1beta.GenerativeServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'generativelanguage.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new generativeserviceModule.v1beta.GenerativeServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'generativelanguage.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new generativeserviceModule.v1beta.GenerativeServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'generativelanguage.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new generativeserviceModule.v1beta.GenerativeServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new generativeserviceModule.v1beta.GenerativeServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('generateContent', () => {
        it('invokes generateContent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.GenerateContentRequest', ['model']);
        ...
        it('invokes generateContent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateContent(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1beta.IGenerateContentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateAnswer', () => {
        it('invokes generateAnswer without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.GenerateAnswerRequest', ['model']);
            request.model = defaultValue1;
            const expectedHeaderRequestParams = `model=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.generateAnswer as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateAnswer as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes generateAnswer without error using callback', async () => {
            ...
            client.innerApiCalls.generateAnswer = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.generateAnswer(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1beta.IGenerateAnswerResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes generateAnswer with error', async () => {
            ...
            const expectedHeaderRequestParams = `model=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.generateAnswer = stubSimpleCall(undefined, expectedError);
    ...
    describe('embedContent', () => {
        it('invokes embedContent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.EmbedContentRequest', ['model']);
            request.model = defaultValue1;
            const expectedHeaderRequestParams = `model=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes embedContent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.embedContent(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1beta.IEmbedContentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('batchEmbedContents', () => {
        it('invokes batchEmbedContents without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.BatchEmbedContentsRequest', ['model']);
            request.model = defaultValue1;
            const expectedHeaderRequestParams = `model=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes batchEmbedContents without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchEmbedContents(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1beta.IBatchEmbedContentsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('countTokens', () => {
        it('invokes countTokens without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.CountTokensRequest', ['model']);
            request.model = defaultValue1;
            const expectedHeaderRequestParams = `model=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes countTokens without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.countTokens(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1beta.ICountTokensResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('streamGenerateContent', () => {
        it('invokes streamGenerateContent without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.ai.generativelanguage.v1beta.GenerateContentResponse) => {
                    resolve(response);
                });
    ...
    describe('bidiGenerateContent', () => {
        it('invokes bidiGenerateContent without error', async () => {
            ...
            client.innerApiCalls.bidiGenerateContent = stubBidiStreamingCall(expectedResponse);
            ...
            const response = await promise;
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.bidiGenerateContent as SinonStub)
        ...
        it('invokes bidiGenerateContent with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.bidiGenerateContent = stubBidiStreamingCall(undefined, expectedError);
            const stream = client.bidiGenerateContent();
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.ai.generativelanguage.v1beta.BidiGenerateContentServerMessage) => {
                    resolve(response);
