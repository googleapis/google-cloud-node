...
describe('v1beta.CacheServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = cacheserviceModule.v1beta.CacheServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = cacheserviceModule.v1beta.CacheServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'generativelanguage.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new cacheserviceModule.v1beta.CacheServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'generativelanguage.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new cacheserviceModule.v1beta.CacheServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'generativelanguage.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new cacheserviceModule.v1beta.CacheServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new cacheserviceModule.v1beta.CacheServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
        ...
        it('invokes createCachedContent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createCachedContent(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1beta.ICachedContent|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getCachedContent', () => {
        it('invokes getCachedContent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.GetCachedContentRequest', ['name']);
    ...
    describe('updateCachedContent', () => {
        it('invokes updateCachedContent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.UpdateCachedContentRequest', ['cachedContent', 'name']);
    ...
    describe('deleteCachedContent', () => {
        it('invokes deleteCachedContent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.DeleteCachedContentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listCachedContents', () => {
        it('invokes listCachedContents without error', async () => {
            ...
            const request = generateSampleMessage(
              ...
              generateSampleMessage(new protos.google.ai.generativelanguage.v1beta.CachedContent()),
              generateSampleMessage(new protos.google.ai.generativelanguage.v1beta.CachedContent()),
              generateSampleMessage(new protos.google.ai.generativelanguage.v1beta.CachedContent()),
            ];
        ...
        it('invokes listCachedContentsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.ai.generativelanguage.v1beta.CachedContent) => {
