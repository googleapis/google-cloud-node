...
describe('v1beta.FileServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = fileserviceModule.v1beta.FileServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = fileserviceModule.v1beta.FileServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'generativelanguage.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new fileserviceModule.v1beta.FileServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'generativelanguage.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new fileserviceModule.v1beta.FileServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'generativelanguage.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new fileserviceModule.v1beta.FileServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new fileserviceModule.v1beta.FileServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createFile', () => {
        ...
        it('invokes createFile without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createFile(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1beta.ICreateFileResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getFile', () => {
        it('invokes getFile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.GetFileRequest', ['name']);
        ...
        it('invokes getFile without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getFile(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1beta.IFile|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deleteFile', () => {
        it('invokes deleteFile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.DeleteFileRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('downloadFile', () => {
        it('invokes downloadFile without error', async () => {
            const client = new fileserviceModule.v1beta.FileServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ai.generativelanguage.v1beta.DownloadFileRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.DownloadFileRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ai.generativelanguage.v1beta.DownloadFileResponse()
            );
            client.innerApiCalls.downloadFile = stubSimpleCall(expectedResponse);
            const [response] = await client.downloadFile(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.downloadFile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.downloadFile as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes downloadFile without error using callback', async () => {
            const client = new fileserviceModule.v1beta.FileServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.downloadFile = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.downloadFile(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1beta.IDownloadFileResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes downloadFile with error', async () => {
            const client = new fileserviceModule.v1beta.FileServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.downloadFile = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.downloadFile(request), expectedError);
            const actualRequest = (client.innerApiCalls.downloadFile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.downloadFile as SinonStub)
        ...
        it('invokes downloadFile with closed client', async () => {
            const client = new fileserviceModule.v1beta.FileServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('listFiles', () => {
        it('invokes listFiles without error', async () => {
            ...
            const request = generateSampleMessage(
              ...
              generateSampleMessage(new protos.google.ai.generativelanguage.v1beta.File()),
              generateSampleMessage(new protos.google.ai.generativelanguage.v1beta.File()),
              generateSampleMessage(new protos.google.ai.generativelanguage.v1beta.File()),
            ];
        ...
        it('invokes listFilesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.ai.generativelanguage.v1beta.File) => {
