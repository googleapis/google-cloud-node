...
describe('v1alpha.GenerativeServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new generativeserviceModule.v1alpha.GenerativeServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = generativeserviceModule.v1alpha.GenerativeServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = generativeserviceModule.v1alpha.GenerativeServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'generativelanguage.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new generativeserviceModule.v1alpha.GenerativeServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'generativelanguage.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new generativeserviceModule.v1alpha.GenerativeServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'generativelanguage.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new generativeserviceModule.v1alpha.GenerativeServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new generativeserviceModule.v1alpha.GenerativeServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('generateContent', () => {
        it('invokes generateContent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.GenerateContentRequest', ['model']);
        ...
        it('invokes generateContent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateContent(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1alpha.IGenerateContentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateAnswer', () => {
        it('invokes generateAnswer without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.GenerateAnswerRequest', ['model']);
            request.model = defaultValue1;
            const expectedHeaderRequestParams = `model=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes generateAnswer without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateAnswer(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1alpha.IGenerateAnswerResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('embedContent', () => {
        it('invokes embedContent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.EmbedContentRequest', ['model']);
            request.model = defaultValue1;
            const expectedHeaderRequestParams = `model=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes embedContent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.embedContent(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1alpha.IEmbedContentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('batchEmbedContents', () => {
        it('invokes batchEmbedContents without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.BatchEmbedContentsRequest', ['model']);
            request.model = defaultValue1;
            const expectedHeaderRequestParams = `model=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes batchEmbedContents without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchEmbedContents(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1alpha.IBatchEmbedContentsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('countTokens', () => {
        it('invokes countTokens without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.CountTokensRequest', ['model']);
            request.model = defaultValue1;
            const expectedHeaderRequestParams = `model=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes countTokens without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.countTokens(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1alpha.ICountTokensResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
