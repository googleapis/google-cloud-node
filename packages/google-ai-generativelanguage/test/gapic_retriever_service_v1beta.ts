...
describe('v1beta.RetrieverServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = retrieverserviceModule.v1beta.RetrieverServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = retrieverserviceModule.v1beta.RetrieverServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'generativelanguage.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new retrieverserviceModule.v1beta.RetrieverServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'generativelanguage.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new retrieverserviceModule.v1beta.RetrieverServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'generativelanguage.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new retrieverserviceModule.v1beta.RetrieverServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new retrieverserviceModule.v1beta.RetrieverServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createCorpus', () => {
        ...
        it('invokes createCorpus without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createCorpus(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1beta.ICorpus|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getCorpus', () => {
        it('invokes getCorpus without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.GetCorpusRequest', ['name']);
    ...
    describe('updateCorpus', () => {
        it('invokes updateCorpus without error', async () => {
            ...
            request.corpus ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.UpdateCorpusRequest', ['corpus', 'name']);
    ...
    describe('deleteCorpus', () => {
        it('invokes deleteCorpus without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.DeleteCorpusRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('queryCorpus', () => {
        it('invokes queryCorpus without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.QueryCorpusRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes queryCorpus without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.queryCorpus(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1beta.IQueryCorpusResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createDocument', () => {
        it('invokes createDocument without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.CreateDocumentRequest', ['parent']);
        ...
        it('invokes createDocument without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createDocument(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1beta.IDocument|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getDocument', () => {
        it('invokes getDocument without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.GetDocumentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ai.generativelanguage.v1beta.Document()
    ...
    describe('updateDocument', () => {
        it('invokes updateDocument without error', async () => {
            ...
            request.document ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.UpdateDocumentRequest', ['document', 'name']);
    ...
    describe('deleteDocument', () => {
        it('invokes deleteDocument without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.DeleteDocumentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('queryDocument', () => {
        it('invokes queryDocument without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.QueryDocumentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes queryDocument without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.queryDocument(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1beta.IQueryDocumentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createChunk', () => {
        it('invokes createChunk without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.CreateChunkRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes createChunk without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createChunk(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1beta.IChunk|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('batchCreateChunks', () => {
        it('invokes batchCreateChunks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.BatchCreateChunksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes batchCreateChunks without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchCreateChunks(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1beta.IBatchCreateChunksResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getChunk', () => {
        it('invokes getChunk without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.GetChunkRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ai.generativelanguage.v1beta.Chunk()
    ...
    describe('updateChunk', () => {
        it('invokes updateChunk without error', async () => {
            ...
            request.chunk ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.UpdateChunkRequest', ['chunk', 'name']);
    ...
    describe('batchUpdateChunks', () => {
        it('invokes batchUpdateChunks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.BatchUpdateChunksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes batchUpdateChunks without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchUpdateChunks(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1beta.IBatchUpdateChunksResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deleteChunk', () => {
        it('invokes deleteChunk without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.DeleteChunkRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('batchDeleteChunks', () => {
        it('invokes batchDeleteChunks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.BatchDeleteChunksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('listCorpora', () => {
        it('invokes listCorpora without error', async () => {
            ...
            const request = generateSampleMessage(
              ...
              generateSampleMessage(new protos.google.ai.generativelanguage.v1beta.Corpus()),
              generateSampleMessage(new protos.google.ai.generativelanguage.v1beta.Corpus()),
              generateSampleMessage(new protos.google.ai.generativelanguage.v1beta.Corpus()),
            ];
        ...
        it('invokes listCorporaStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.ai.generativelanguage.v1beta.Corpus) => {
    ...
    describe('listDocuments', () => {
        it('invokes listDocuments without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.ListDocumentsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ai.generativelanguage.v1beta.Document()),
              generateSampleMessage(new protos.google.ai.generativelanguage.v1beta.Document()),
              generateSampleMessage(new protos.google.ai.generativelanguage.v1beta.Document()),
            ];
        ...
        it('invokes listDocumentsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.ai.generativelanguage.v1beta.Document) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listChunks', () => {
        it('invokes listChunks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1beta.ListChunksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.ai.generativelanguage.v1beta.Chunk()),
              generateSampleMessage(new protos.google.ai.generativelanguage.v1beta.Chunk()),
              generateSampleMessage(new protos.google.ai.generativelanguage.v1beta.Chunk()),
            ];
        ...
        it('invokes listChunksStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.ai.generativelanguage.v1beta.Chunk) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
