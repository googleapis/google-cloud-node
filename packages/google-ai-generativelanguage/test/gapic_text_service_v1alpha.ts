  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          textserviceModule.v1alpha.TextServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          textserviceModule.v1alpha.TextServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'generativelanguage.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new textserviceModule.v1alpha.TextServiceClient({
          universe_domain: 'example.com',
    ...
    it('invokes generateText without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.generateText(
          ...
          (
            err?: Error | null,
            result?: protos.google.ai.generativelanguage.v1alpha.IGenerateTextResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes embedText without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.embedText(
          ...
          (
            err?: Error | null,
            result?: protos.google.ai.generativelanguage.v1alpha.IEmbedTextResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchEmbedText without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchEmbedText(
          ...
          (
            err?: Error | null,
            result?: protos.google.ai.generativelanguage.v1alpha.IBatchEmbedTextResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes countTextTokens without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.countTextTokens(
          ...
          (
            err?: Error | null,
            result?: protos.google.ai.generativelanguage.v1alpha.ICountTextTokensResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
