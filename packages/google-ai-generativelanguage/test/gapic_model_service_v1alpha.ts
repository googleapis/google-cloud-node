  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          modelserviceModule.v1alpha.ModelServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          modelserviceModule.v1alpha.ModelServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'generativelanguage.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new modelserviceModule.v1alpha.ModelServiceClient({
          universe_domain: 'example.com',
    ...
    it('invokes getModel without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getModel(
          ...
          (
            err?: Error | null,
            result?: protos.google.ai.generativelanguage.v1alpha.IModel | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getTunedModel without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getTunedModel(
          ...
          (
            err?: Error | null,
            result?: protos.google.ai.generativelanguage.v1alpha.ITunedModel | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listModels', () => {
    ...
    it('invokes listModelsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ai.generativelanguage.v1alpha.Model) => {
    ...
    it('invokes listTunedModelsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.ai.generativelanguage.v1alpha.TunedModel
          ) => {
            responses.push(response);
          }
        );
