...
describe('v1alpha.CacheServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          cacheserviceModule.v1alpha.CacheServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          cacheserviceModule.v1alpha.CacheServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'generativelanguage.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new cacheserviceModule.v1alpha.CacheServiceClient({
          universe_domain: 'example.com',
    ...
    it('invokes createCachedContent without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createCachedContent(
          ...
          (
            err?: Error | null,
            result?: protos.google.ai.generativelanguage.v1alpha.ICachedContent | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listCachedContentsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.ai.generativelanguage.v1alpha.CachedContent,
          ) => {
  ...
  describe('Path templates', () => {
    ...
    describe('corpusPermissions', async () => {
      ...
      await client.initialize();
      client.pathTemplates.corpusPermissionsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.corpusPermissionsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('corpusPermissionsPath', () => {
        const result = client.corpusPermissionsPath(
          'corpusValue',
          'permissionValue',
        );
        assert.strictEqual(result, fakePath);
      ...
      it('matchPermissionFromCorpusPermissionsName', () => {
        const result =
          client.matchPermissionFromCorpusPermissionsName(fakePath);
    ...
    describe('tunedModelPermissions', async () => {
      ...
      await client.initialize();
      client.pathTemplates.tunedModelPermissionsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.tunedModelPermissionsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('tunedModelPermissionsPath', () => {
        const result = client.tunedModelPermissionsPath(
          'tunedModelValue',
          'permissionValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.tunedModelPermissionsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchTunedModelFromTunedModelPermissionsName', () => {
        const result =
          client.matchTunedModelFromTunedModelPermissionsName(fakePath);
        assert.strictEqual(result, 'tunedModelValue');
        assert(
          (
            client.pathTemplates.tunedModelPermissionsPathTemplate
      ...
      it('matchPermissionFromTunedModelPermissionsName', () => {
        const result =
          client.matchPermissionFromTunedModelPermissionsName(fakePath);
        assert.strictEqual(result, 'permissionValue');
        assert(
          (
            client.pathTemplates.tunedModelPermissionsPathTemplate
