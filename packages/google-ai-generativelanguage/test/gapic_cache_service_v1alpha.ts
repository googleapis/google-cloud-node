...
describe('v1alpha.CacheServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new cacheserviceModule.v1alpha.CacheServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = cacheserviceModule.v1alpha.CacheServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = cacheserviceModule.v1alpha.CacheServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'generativelanguage.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new cacheserviceModule.v1alpha.CacheServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'generativelanguage.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new cacheserviceModule.v1alpha.CacheServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'generativelanguage.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new cacheserviceModule.v1alpha.CacheServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new cacheserviceModule.v1alpha.CacheServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = cacheserviceModule.v1alpha.CacheServiceClient.port;
            assert(port);
    ...
    describe('createCachedContent', () => {
        it('invokes createCachedContent without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.ai.generativelanguage.v1alpha.CreateCachedContentRequest()
            );
            const expectedResponse = generateSampleMessage(
              new protos.google.ai.generativelanguage.v1alpha.CachedContent()
            );
            client.innerApiCalls.createCachedContent = stubSimpleCall(expectedResponse);
        ...
        it('invokes createCachedContent without error using callback', async () => {
            ...
            client.innerApiCalls.createCachedContent = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createCachedContent(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1alpha.ICachedContent|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getCachedContent', () => {
        it('invokes getCachedContent without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ai.generativelanguage.v1alpha.GetCachedContentRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.GetCachedContentRequest', ['name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getCachedContent as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getCachedContent as SinonStub)
        ...
        it('invokes getCachedContent without error using callback', async () => {
            ...
            client.innerApiCalls.getCachedContent = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
    ...
    describe('updateCachedContent', () => {
        it('invokes updateCachedContent without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ai.generativelanguage.v1alpha.UpdateCachedContentRequest()
            );
            request.cachedContent ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.UpdateCachedContentRequest', ['cachedContent', 'name']);
            request.cachedContent.name = defaultValue1;
            const expectedHeaderRequestParams = `cached_content.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ai.generativelanguage.v1alpha.CachedContent()
            );
            client.innerApiCalls.updateCachedContent = stubSimpleCall(expectedResponse);
            const [response] = await client.updateCachedContent(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateCachedContent as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateCachedContent as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateCachedContent without error using callback', async () => {
            ...
            client.innerApiCalls.updateCachedContent = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
    ...
    describe('deleteCachedContent', () => {
        it('invokes deleteCachedContent without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ai.generativelanguage.v1alpha.DeleteCachedContentRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.DeleteCachedContentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteCachedContent = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteCachedContent(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteCachedContent as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteCachedContent as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteCachedContent without error using callback', async () => {
            ...
            client.innerApiCalls.deleteCachedContent = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
    ...
    describe('listCachedContents', () => {
        it('invokes listCachedContents without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.ai.generativelanguage.v1alpha.ListCachedContentsRequest()
            );const expectedResponse = [
              generateSampleMessage(new protos.google.ai.generativelanguage.v1alpha.CachedContent()),
              generateSampleMessage(new protos.google.ai.generativelanguage.v1alpha.CachedContent()),
              generateSampleMessage(new protos.google.ai.generativelanguage.v1alpha.CachedContent()),
            ];
            client.innerApiCalls.listCachedContents = stubSimpleCall(expectedResponse);
        ...
        it('invokes listCachedContents without error using callback', async () => {
            ...
            client.innerApiCalls.listCachedContents = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listCachedContentsStream without error', async () => {
            ...
            client.descriptors.page.listCachedContents.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listCachedContentsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ai.generativelanguage.v1alpha.CachedContent[] = [];
                stream.on('data', (response: protos.google.ai.generativelanguage.v1alpha.CachedContent) => {
            ...
            assert((client.descriptors.page.listCachedContents.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listCachedContents, request));
        });
        ...
        it('uses async iteration with listCachedContents without error', async () => {
            ...
            client.descriptors.page.listCachedContents.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ai.generativelanguage.v1alpha.ICachedContent[] = [];
