...
describe('v1beta2.TextServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          textserviceModule.v1beta2.TextServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          textserviceModule.v1beta2.TextServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'generativelanguage.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new textserviceModule.v1beta2.TextServiceClient({
          universe_domain: 'example.com',
  ...
  describe('generateText', () => {
    it('invokes generateText without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.generateText as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes generateText without error using callback', async () => {
      ...
      client.innerApiCalls.generateText =
      ...
      const promise = new Promise((resolve, reject) => {
        client.generateText(
          ...
          (
            err?: Error | null,
            result?: protos.google.ai.generativelanguage.v1beta2.IGenerateTextResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('embedText', () => {
    it('invokes embedText without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.embedText as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.embedText as SinonStub
    ...
    it('invokes embedText without error using callback', async () => {
      ...
      client.innerApiCalls.embedText =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.embedText(
          request,
          (
            err?: Error | null,
            result?: protos.google.ai.generativelanguage.v1beta2.IEmbedTextResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
