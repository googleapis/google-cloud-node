...
describe('v1alpha.FileServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          fileserviceModule.v1alpha.FileServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          fileserviceModule.v1alpha.FileServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'generativelanguage.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new fileserviceModule.v1alpha.FileServiceClient({
          universe_domain: 'example.com',
    ...
    it('invokes createFile without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createFile(
          ...
          (
            err?: Error | null,
            result?: protos.google.ai.generativelanguage.v1alpha.ICreateFileResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getFile without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getFile(
          ...
          (
            err?: Error | null,
            result?: protos.google.ai.generativelanguage.v1alpha.IFile | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('deleteFile', () => {
    it('invokes deleteFile without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.ai.generativelanguage.v1alpha.DeleteFileRequest',
        ['name']
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1}`;
  ...
  describe('listFiles', () => {
    ...
    it('invokes listFilesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ai.generativelanguage.v1alpha.File) => {
