...
describe('v1.GenerativeServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = generativeserviceModule.v1.GenerativeServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = generativeserviceModule.v1.GenerativeServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'generativelanguage.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new generativeserviceModule.v1.GenerativeServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'generativelanguage.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new generativeserviceModule.v1.GenerativeServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'generativelanguage.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new generativeserviceModule.v1.GenerativeServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new generativeserviceModule.v1.GenerativeServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('generateContent', () => {
        it('invokes generateContent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1.GenerateContentRequest', ['model']);
            ...
            const actualRequest = (client.innerApiCalls.generateContent as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateContent as SinonStub)
        ...
        it('invokes generateContent without error using callback', async () => {
            ...
            client.innerApiCalls.generateContent = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.generateContent(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1.IGenerateContentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('embedContent', () => {
        it('invokes embedContent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1.EmbedContentRequest', ['model']);
            request.model = defaultValue1;
            const expectedHeaderRequestParams = `model=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.embedContent as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.embedContent as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes embedContent without error using callback', async () => {
            ...
            client.innerApiCalls.embedContent = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.embedContent(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1.IEmbedContentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes embedContent with error', async () => {
            ...
            const expectedHeaderRequestParams = `model=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.embedContent = stubSimpleCall(undefined, expectedError);
    ...
    describe('batchEmbedContents', () => {
        it('invokes batchEmbedContents without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1.BatchEmbedContentsRequest', ['model']);
            request.model = defaultValue1;
            const expectedHeaderRequestParams = `model=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ai.generativelanguage.v1.BatchEmbedContentsResponse()
            );
            client.innerApiCalls.batchEmbedContents = stubSimpleCall(expectedResponse);
            const [response] = await client.batchEmbedContents(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchEmbedContents as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.batchEmbedContents as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes batchEmbedContents without error using callback', async () => {
            ...
            client.innerApiCalls.batchEmbedContents = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.batchEmbedContents(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1.IBatchEmbedContentsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes batchEmbedContents with error', async () => {
            ...
            const expectedHeaderRequestParams = `model=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.batchEmbedContents = stubSimpleCall(undefined, expectedError);
    ...
    describe('countTokens', () => {
        it('invokes countTokens without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1.CountTokensRequest', ['model']);
            request.model = defaultValue1;
            const expectedHeaderRequestParams = `model=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.countTokens as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.countTokens as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes countTokens without error using callback', async () => {
            ...
            client.innerApiCalls.countTokens = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.countTokens(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1.ICountTokensResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('streamGenerateContent', () => {
        it('invokes streamGenerateContent without error', async () => {
            ...
            client.innerApiCalls.streamGenerateContent = stubServerStreamingCall(expectedResponse);
            ...
            const response = await promise;
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.streamGenerateContent as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.streamGenerateContent as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes streamGenerateContent with closed client', async () => {
            ...
            const expectedError = new Error('The client has already been closed.');
            client.close().catch(err => {throw err});
            const stream = client.streamGenerateContent(request, {retryRequestOptions: {noResponseRetries: 0}});
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.ai.generativelanguage.v1.GenerateContentResponse) => {
                    resolve(response);
                });
