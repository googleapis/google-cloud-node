  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          textserviceModule.v1beta.TextServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          textserviceModule.v1beta.TextServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'generativelanguage.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new textserviceModule.v1beta.TextServiceClient({
          universe_domain: 'example.com',
    ...
    it('invokes generateText without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.generateText(
          ...
          (
            err?: Error | null,
            result?: protos.google.ai.generativelanguage.v1beta.IGenerateTextResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes embedText without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.embedText(
          ...
          (
            err?: Error | null,
            result?: protos.google.ai.generativelanguage.v1beta.IEmbedTextResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchEmbedText without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchEmbedText(
          ...
          (
            err?: Error | null,
            result?: protos.google.ai.generativelanguage.v1beta.IBatchEmbedTextResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes countTextTokens without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.countTextTokens(
          ...
          (
            err?: Error | null,
            result?: protos.google.ai.generativelanguage.v1beta.ICountTextTokensResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
