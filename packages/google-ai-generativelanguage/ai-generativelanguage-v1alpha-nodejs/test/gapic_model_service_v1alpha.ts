...
describe('v1alpha.ModelServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = modelserviceModule.v1alpha.ModelServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = modelserviceModule.v1alpha.ModelServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'generativelanguage.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new modelserviceModule.v1alpha.ModelServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'generativelanguage.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new modelserviceModule.v1alpha.ModelServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'generativelanguage.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new modelserviceModule.v1alpha.ModelServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new modelserviceModule.v1alpha.ModelServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = modelserviceModule.v1alpha.ModelServiceClient.port;
            assert(port);
    ...
    describe('getModel', () => {
        it('invokes getModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.GetModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ai.generativelanguage.v1alpha.Model()
            );
        ...
        it('invokes getModel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getModel(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1alpha.IModel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getTunedModel', () => {
        it('invokes getTunedModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.GetTunedModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.ai.generativelanguage.v1alpha.TunedModel()
            );
        ...
        it('invokes getTunedModel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getTunedModel(
                    request,
                    (err?: Error|null, result?: protos.google.ai.generativelanguage.v1alpha.ITunedModel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateTunedModel', () => {
        it('invokes updateTunedModel without error', async () => {
            ...
            request.tunedModel ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.UpdateTunedModelRequest', ['tunedModel', 'name']);
    ...
    describe('deleteTunedModel', () => {
        it('invokes deleteTunedModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.ai.generativelanguage.v1alpha.DeleteTunedModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes createTunedModel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createTunedModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.ai.generativelanguage.v1alpha.ITunedModel, protos.google.ai.generativelanguage.v1alpha.ICreateTunedModelMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.ai.generativelanguage.v1alpha.ITunedModel, protos.google.ai.generativelanguage.v1alpha.ICreateTunedModelMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
        });
    ...
    describe('listModels', () => {
        it('invokes listModels without error', async () => {
            ...
            const request = generateSampleMessage(
              ...
              generateSampleMessage(new protos.google.ai.generativelanguage.v1alpha.Model()),
              generateSampleMessage(new protos.google.ai.generativelanguage.v1alpha.Model()),
              generateSampleMessage(new protos.google.ai.generativelanguage.v1alpha.Model()),
            ];
        ...
        it('invokes listModelsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ai.generativelanguage.v1alpha.Model[] = [];
                stream.on('data', (response: protos.google.ai.generativelanguage.v1alpha.Model) => {
        ...
        it('uses async iteration with listModels without error', async () => {
            ...
            const responses: protos.google.ai.generativelanguage.v1alpha.IModel[] = [];
    ...
    describe('listTunedModels', () => {
        it('invokes listTunedModels without error', async () => {
            ...
            const request = generateSampleMessage(
              ...
              generateSampleMessage(new protos.google.ai.generativelanguage.v1alpha.TunedModel()),
              generateSampleMessage(new protos.google.ai.generativelanguage.v1alpha.TunedModel()),
              generateSampleMessage(new protos.google.ai.generativelanguage.v1alpha.TunedModel()),
            ];
        ...
        it('invokes listTunedModelsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ai.generativelanguage.v1alpha.TunedModel[] = [];
                stream.on('data', (response: protos.google.ai.generativelanguage.v1alpha.TunedModel) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listTunedModels without error', async () => {
            ...
            const responses: protos.google.ai.generativelanguage.v1alpha.ITunedModel[] = [];
