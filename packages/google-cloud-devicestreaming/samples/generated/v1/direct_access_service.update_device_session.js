...
function main(deviceSession) {
  ...
  async function callUpdateDeviceSession() {
    // Construct request
    const request = {
      deviceSession,
    };
    ...
    // Run request
    const response = await devicestreamingClient.updateDeviceSession(request);
    console.log(response);
  }

  callUpdateDeviceSession();
