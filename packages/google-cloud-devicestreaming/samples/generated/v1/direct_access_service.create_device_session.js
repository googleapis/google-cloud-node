...
function main(parent, deviceSession) {
  ...
  async function callCreateDeviceSession() {
    // Construct request
    const request = {
      parent,
      deviceSession,
    ...
    // Run request
    const response = await devicestreamingClient.createDeviceSession(request);
    console.log(response);
  }

  callCreateDeviceSession();
