...
describe('v2.ConferenceRecordsServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          conferencerecordsserviceModule.v2.ConferenceRecordsServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        conferencerecordsserviceModule.v2.ConferenceRecordsServiceClient.port;
      assert(port);
    ...
    it('invokes getConferenceRecord without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getConferenceRecord(
          ...
          (
            err?: Error | null,
            result?: protos.google.apps.meet.v2.IConferenceRecord | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getParticipant', () => {
    it('invokes getParticipant without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.apps.meet.v2.GetParticipantRequest',
        ['name']
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
    ...
    it('invokes getParticipant without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getParticipant(
          ...
          (
            err?: Error | null,
            result?: protos.google.apps.meet.v2.IParticipant | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getParticipantSession without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getParticipantSession(
          ...
          (
            err?: Error | null,
            result?: protos.google.apps.meet.v2.IParticipantSession | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getRecording', () => {
    it('invokes getRecording without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.apps.meet.v2.GetRecordingRequest',
        ['name']
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
    ...
    it('invokes getRecording without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getRecording(
          ...
          (
            err?: Error | null,
            result?: protos.google.apps.meet.v2.IRecording | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getTranscript without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getTranscript(
          ...
          (
            err?: Error | null,
            result?: protos.google.apps.meet.v2.ITranscript | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getTranscriptEntry without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getTranscriptEntry(
          ...
          (
            err?: Error | null,
            result?: protos.google.apps.meet.v2.ITranscriptEntry | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listConferenceRecords', () => {
    ...
    it('invokes listConferenceRecordsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.apps.meet.v2.ConferenceRecord) => {
  ...
  describe('listParticipants', () => {
    ...
    it('invokes listParticipantsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.apps.meet.v2.Participant) => {
            responses.push(response);
          }
        );
        stream.on('end', () => {
  ...
  describe('listParticipantSessions', () => {
    ...
    it('invokes listParticipantSessionsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.apps.meet.v2.ParticipantSession) => {
            responses.push(response);
          }
        );
        stream.on('end', () => {
  ...
  describe('listTranscriptEntries', () => {
    ...
    it('invokes listTranscriptEntriesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.apps.meet.v2.TranscriptEntry) => {
            responses.push(response);
          }
        );
        stream.on('end', () => {
