...
describe('v2.ConferenceRecordsServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new conferencerecordsserviceModule.v2.ConferenceRecordsServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = conferencerecordsserviceModule.v2.ConferenceRecordsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = conferencerecordsserviceModule.v2.ConferenceRecordsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'meet.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new conferencerecordsserviceModule.v2.ConferenceRecordsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'meet.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new conferencerecordsserviceModule.v2.ConferenceRecordsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'meet.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new conferencerecordsserviceModule.v2.ConferenceRecordsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new conferencerecordsserviceModule.v2.ConferenceRecordsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = conferencerecordsserviceModule.v2.ConferenceRecordsServiceClient.port;
            assert(port);
    ...
    describe('getConferenceRecord', () => {
        it('invokes getConferenceRecord without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.meet.v2.GetConferenceRecordRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.apps.meet.v2.ConferenceRecord()
            );
            client.innerApiCalls.getConferenceRecord = stubSimpleCall(expectedResponse);
            const [response] = await client.getConferenceRecord(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getConferenceRecord as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getConferenceRecord as SinonStub)
        ...
        it('invokes getConferenceRecord without error using callback', async () => {
            ...
            client.innerApiCalls.getConferenceRecord = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getConferenceRecord(
                    request,
                    (err?: Error|null, result?: protos.google.apps.meet.v2.IConferenceRecord|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getConferenceRecord with error', async () => {
            ...
            client.innerApiCalls.getConferenceRecord = stubSimpleCall(undefined, expectedError);
    ...
    describe('getParticipant', () => {
        it('invokes getParticipant without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.meet.v2.GetParticipantRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getParticipant as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getParticipant as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getParticipant without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getParticipant(
                    request,
                    (err?: Error|null, result?: protos.google.apps.meet.v2.IParticipant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getParticipantSession', () => {
        it('invokes getParticipantSession without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.meet.v2.GetParticipantSessionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.apps.meet.v2.ParticipantSession()
            );
            client.innerApiCalls.getParticipantSession = stubSimpleCall(expectedResponse);
            const [response] = await client.getParticipantSession(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getParticipantSession as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getParticipantSession as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getParticipantSession without error using callback', async () => {
            ...
            client.innerApiCalls.getParticipantSession = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getParticipantSession(
                    request,
                    (err?: Error|null, result?: protos.google.apps.meet.v2.IParticipantSession|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getParticipantSession with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getParticipantSession = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getParticipantSession(request), expectedError);
            const actualRequest = (client.innerApiCalls.getParticipantSession as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getParticipantSession as SinonStub)
    ...
    describe('getRecording', () => {
        it('invokes getRecording without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.meet.v2.GetRecordingRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getRecording as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getRecording as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getRecording without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getRecording(
                    request,
                    (err?: Error|null, result?: protos.google.apps.meet.v2.IRecording|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getTranscript', () => {
        it('invokes getTranscript without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.meet.v2.GetTranscriptRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getTranscript as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getTranscript as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getTranscript without error using callback', async () => {
            ...
            client.innerApiCalls.getTranscript = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getTranscript(
                    request,
                    (err?: Error|null, result?: protos.google.apps.meet.v2.ITranscript|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getTranscript with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getTranscript = stubSimpleCall(undefined, expectedError);
    ...
    describe('getTranscriptEntry', () => {
        it('invokes getTranscriptEntry without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.meet.v2.GetTranscriptEntryRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.apps.meet.v2.TranscriptEntry()
            );
            client.innerApiCalls.getTranscriptEntry = stubSimpleCall(expectedResponse);
            const [response] = await client.getTranscriptEntry(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getTranscriptEntry as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getTranscriptEntry as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getTranscriptEntry without error using callback', async () => {
            ...
            client.innerApiCalls.getTranscriptEntry = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getTranscriptEntry(
                    request,
                    (err?: Error|null, result?: protos.google.apps.meet.v2.ITranscriptEntry|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getTranscriptEntry with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getTranscriptEntry = stubSimpleCall(undefined, expectedError);
    ...
    describe('listConferenceRecords', () => {
        it('invokes listConferenceRecords without error', async () => {
            ...
            const request = generateSampleMessage(
              ...
              generateSampleMessage(new protos.google.apps.meet.v2.ConferenceRecord()),
              generateSampleMessage(new protos.google.apps.meet.v2.ConferenceRecord()),
              generateSampleMessage(new protos.google.apps.meet.v2.ConferenceRecord()),
            ];
            client.innerApiCalls.listConferenceRecords = stubSimpleCall(expectedResponse);
        ...
        it('invokes listConferenceRecords without error using callback', async () => {
            ...
            client.innerApiCalls.listConferenceRecords = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listConferenceRecords with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listConferenceRecords = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listConferenceRecords(request), expectedError);
        });
        ...
        it('invokes listConferenceRecordsStream without error', async () => {
            ...
            client.descriptors.page.listConferenceRecords.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listConferenceRecordsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.apps.meet.v2.ConferenceRecord[] = [];
                stream.on('data', (response: protos.google.apps.meet.v2.ConferenceRecord) => {
            ...
            assert((client.descriptors.page.listConferenceRecords.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listConferenceRecords, request));
        });
        ...
        it('invokes listConferenceRecordsStream with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.descriptors.page.listConferenceRecords.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listConferenceRecordsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.apps.meet.v2.ConferenceRecord[] = [];
                stream.on('data', (response: protos.google.apps.meet.v2.ConferenceRecord) => {
        ...
        it('uses async iteration with listConferenceRecords without error', async () => {
            ...
            client.descriptors.page.listConferenceRecords.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(
                (client.descriptors.page.listConferenceRecords.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listConferenceRecords with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.descriptors.page.listConferenceRecords.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listConferenceRecordsAsync(request);
    ...
    describe('listParticipants', () => {
        it('invokes listParticipants without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.meet.v2.ListParticipantsRequest', ['parent']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listParticipants as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listParticipants as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listParticipantsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.apps.meet.v2.Participant[] = [];
                stream.on('data', (response: protos.google.apps.meet.v2.Participant) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listParticipants without error', async () => {
            ...
            const responses: protos.google.apps.meet.v2.IParticipant[] = [];
    ...
    describe('listParticipantSessions', () => {
        it('invokes listParticipantSessions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.meet.v2.ListParticipantSessionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.apps.meet.v2.ParticipantSession()),
              generateSampleMessage(new protos.google.apps.meet.v2.ParticipantSession()),
              generateSampleMessage(new protos.google.apps.meet.v2.ParticipantSession()),
            ];
            client.innerApiCalls.listParticipantSessions = stubSimpleCall(expectedResponse);
            const [response] = await client.listParticipantSessions(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listParticipantSessions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listParticipantSessions as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listParticipantSessions without error using callback', async () => {
            ...
            client.innerApiCalls.listParticipantSessions = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listParticipantSessions with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listParticipantSessions = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listParticipantSessions(request), expectedError);
            const actualRequest = (client.innerApiCalls.listParticipantSessions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listParticipantSessions as SinonStub)
        ...
        it('invokes listParticipantSessionsStream without error', async () => {
            ...
            client.descriptors.page.listParticipantSessions.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listParticipantSessionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.apps.meet.v2.ParticipantSession[] = [];
                stream.on('data', (response: protos.google.apps.meet.v2.ParticipantSession) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listParticipantSessions.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listParticipantSessions, request));
            assert(
                (client.descriptors.page.listParticipantSessions.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listParticipantSessionsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listParticipantSessions.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listParticipantSessionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.apps.meet.v2.ParticipantSession[] = [];
                stream.on('data', (response: protos.google.apps.meet.v2.ParticipantSession) => {
        ...
        it('uses async iteration with listParticipantSessions without error', async () => {
            ...
            client.descriptors.page.listParticipantSessions.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listParticipantSessions.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listParticipantSessions.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listParticipantSessions with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listParticipantSessions.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listParticipantSessionsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.apps.meet.v2.IParticipantSession[] = [];
                for await (const resource of iterable) {
    ...
    describe('listRecordings', () => {
        it('invokes listRecordings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.meet.v2.ListRecordingsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listRecordings as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listRecordings as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('uses async iteration with listRecordings without error', async () => {
            ...
            const responses: protos.google.apps.meet.v2.IRecording[] = [];
    ...
    describe('listTranscripts', () => {
        it('invokes listTranscripts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.meet.v2.ListTranscriptsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listTranscripts as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listTranscripts as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listTranscripts without error using callback', async () => {
            ...
            client.innerApiCalls.listTranscripts = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listTranscripts with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listTranscripts = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listTranscriptsStream without error', async () => {
            ...
            client.descriptors.page.listTranscripts.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listTranscripts.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listTranscripts, request));
            assert(
        ...
        it('invokes listTranscriptsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listTranscripts.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listTranscriptsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.apps.meet.v2.Transcript[] = [];
                stream.on('data', (response: protos.google.apps.meet.v2.Transcript) => {
        ...
        it('uses async iteration with listTranscripts without error', async () => {
            ...
            client.descriptors.page.listTranscripts.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.apps.meet.v2.ITranscript[] = [];
        ...
        it('uses async iteration with listTranscripts with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listTranscripts.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listTranscriptsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.apps.meet.v2.ITranscript[] = [];
                for await (const resource of iterable) {
    ...
    describe('listTranscriptEntries', () => {
        it('invokes listTranscriptEntries without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.apps.meet.v2.ListTranscriptEntriesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
            ...
            client.innerApiCalls.listTranscriptEntries = stubSimpleCall(expectedResponse);
            const [response] = await client.listTranscriptEntries(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listTranscriptEntries as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listTranscriptEntries as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listTranscriptEntries without error using callback', async () => {
            ...
            client.innerApiCalls.listTranscriptEntries = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listTranscriptEntries with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listTranscriptEntries = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listTranscriptEntries(request), expectedError);
            const actualRequest = (client.innerApiCalls.listTranscriptEntries as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listTranscriptEntries as SinonStub)
        ...
        it('invokes listTranscriptEntriesStream without error', async () => {
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listTranscriptEntries.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listTranscriptEntries, request));
            assert(
                (client.descriptors.page.listTranscriptEntries.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listTranscriptEntriesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listTranscriptEntries.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listTranscriptEntriesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.apps.meet.v2.TranscriptEntry[] = [];
                stream.on('data', (response: protos.google.apps.meet.v2.TranscriptEntry) => {
        ...
        it('uses async iteration with listTranscriptEntries without error', async () => {
            ...
            client.descriptors.page.listTranscriptEntries.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.apps.meet.v2.ITranscriptEntry[] = [];
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listTranscriptEntries.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listTranscriptEntries.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listTranscriptEntries with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listTranscriptEntries.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listTranscriptEntriesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.apps.meet.v2.ITranscriptEntry[] = [];
                for await (const resource of iterable) {
