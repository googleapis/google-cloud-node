...
[![npm version](https://img.shields.io/npm/v/@google-cloud/meet.svg)](https://www.npmjs.org/package/@google-cloud/meet)
...
For example, `npm install @google-cloud/meet@legacy-8` installs client libraries
