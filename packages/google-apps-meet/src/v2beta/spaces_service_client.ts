...
export class SpacesServiceClient {
   ...
   * @param {google.apps.meet.v2beta.ConnectActiveConferenceRequest.ConnectionConfig} [request.config]
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v2beta/spaces_service.update_member.js</caption>
   * region_tag:meet_v2beta_generated_SpacesService_UpdateMember_async
   */
  updateMember(
    request?: protos.google.apps.meet.v2beta.IUpdateMemberRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.apps.meet.v2beta.IMember,
      protos.google.apps.meet.v2beta.IUpdateMemberRequest | undefined,
      {} | undefined,
    ]
  >;
  updateMember(
    ...
    callback: Callback<
      protos.google.apps.meet.v2beta.IMember,
      protos.google.apps.meet.v2beta.IUpdateMemberRequest | null | undefined,
      {} | null | undefined
    >,
  ): void;
  updateMember(
  ...
  updateMember(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.apps.meet.v2beta.IMember,
          | protos.google.apps.meet.v2beta.IUpdateMemberRequest
          | null
          | undefined,
          {} | null | undefined
        >,
  ...
  > | void {
    ...
    this._log.info('updateMember request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.apps.meet.v2beta.IMember,
          | protos.google.apps.meet.v2beta.IUpdateMemberRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('updateMember response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .updateMember(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.apps.meet.v2beta.IMember,
          protos.google.apps.meet.v2beta.IUpdateMemberRequest | undefined,
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.apps.meet.v2beta.BatchUpdateMembersResponse|BatchUpdateMembersResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v2beta/spaces_service.batch_update_members.js</caption>
   * region_tag:meet_v2beta_generated_SpacesService_BatchUpdateMembers_async
   */
  batchUpdateMembers(
    request?: protos.google.apps.meet.v2beta.IBatchUpdateMembersRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.apps.meet.v2beta.IBatchUpdateMembersResponse,
      protos.google.apps.meet.v2beta.IBatchUpdateMembersRequest | undefined,
      {} | undefined,
    ]
  >;
  batchUpdateMembers(
    ...
    callback: Callback<
      protos.google.apps.meet.v2beta.IBatchUpdateMembersResponse,
      | protos.google.apps.meet.v2beta.IBatchUpdateMembersRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    this._log.info('batchUpdateMembers request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.apps.meet.v2beta.IBatchUpdateMembersResponse,
          | protos.google.apps.meet.v2beta.IBatchUpdateMembersRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('batchUpdateMembers response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .batchUpdateMembers(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.apps.meet.v2beta.IBatchUpdateMembersResponse,
          protos.google.apps.meet.v2beta.IBatchUpdateMembersRequest | undefined,
