...
describe('v2alpha.GenerativeQuestionServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new generativequestionserviceModule.v2alpha.GenerativeQuestionServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          generativequestionserviceModule.v2alpha
            .GenerativeQuestionServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        ...
        const apiEndpoint =
          generativequestionserviceModule.v2alpha
            .GenerativeQuestionServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'retail.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        generativequestionserviceModule.v2alpha.GenerativeQuestionServiceClient
          .port;
      assert(port);
    ...
    it('invokes updateGenerativeQuestionsFeatureConfig without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.updateGenerativeQuestionsFeatureConfig(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.retail.v2alpha.IGenerativeQuestionsFeatureConfig | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listGenerativeQuestionConfigs without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listGenerativeQuestionConfigs(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.retail.v2alpha.IListGenerativeQuestionConfigsResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes updateGenerativeQuestionConfig without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.updateGenerativeQuestionConfig(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.retail.v2alpha.IGenerativeQuestionConfig | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchUpdateGenerativeQuestionConfigs without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchUpdateGenerativeQuestionConfigs(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.retail.v2alpha.IBatchUpdateGenerativeQuestionConfigsResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
