...
describe('v2beta.ProductServiceClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new productserviceModule.v2beta.ProductServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new productserviceModule.v2beta.ProductServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new productserviceModule.v2beta.ProductServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new productserviceModule.v2beta.ProductServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createProduct', () => {
        it('invokes createProduct without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.CreateProductRequest', ['parent']);
    ...
    describe('getProduct', () => {
        it('invokes getProduct without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.GetProductRequest', ['name']);
    ...
    describe('updateProduct', () => {
        it('invokes updateProduct without error', async () => {
            ...
            request.product ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.UpdateProductRequest', ['product', 'name']);
    ...
    describe('deleteProduct', () => {
        it('invokes deleteProduct without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.DeleteProductRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('purgeProducts', () => {
        it('invokes purgeProducts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.PurgeProductsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes purgeProducts without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.purgeProducts(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.retail.v2beta.IPurgeProductsResponse, protos.google.cloud.retail.v2beta.IPurgeProductsMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.retail.v2beta.IPurgeProductsResponse, protos.google.cloud.retail.v2beta.IPurgeProductsMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.purgeProducts as SinonStub)
                .getCall(0).args[0];
    ...
    describe('importProducts', () => {
        it('invokes importProducts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.ImportProductsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('exportProducts', () => {
        it('invokes exportProducts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.ExportProductsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes exportProducts without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.exportProducts(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.retail.v2beta.IExportProductsResponse, protos.google.cloud.retail.v2beta.IExportMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.retail.v2beta.IExportProductsResponse, protos.google.cloud.retail.v2beta.IExportMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportProducts as SinonStub)
                .getCall(0).args[0];
    ...
    describe('setInventory', () => {
        it('invokes setInventory without error', async () => {
            ...
            request.inventory ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.SetInventoryRequest', ['inventory', 'name']);
    ...
    describe('addFulfillmentPlaces', () => {
        it('invokes addFulfillmentPlaces without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.AddFulfillmentPlacesRequest', ['product']);
    ...
    describe('removeFulfillmentPlaces', () => {
        it('invokes removeFulfillmentPlaces without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.RemoveFulfillmentPlacesRequest', ['product']);
            request.product = defaultValue1;
            const expectedHeaderRequestParams = `product=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('addLocalInventories', () => {
        it('invokes addLocalInventories without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.AddLocalInventoriesRequest', ['product']);
            request.product = defaultValue1;
            const expectedHeaderRequestParams = `product=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('removeLocalInventories', () => {
        it('invokes removeLocalInventories without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.RemoveLocalInventoriesRequest', ['product']);
            request.product = defaultValue1;
            const expectedHeaderRequestParams = `product=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listProducts', () => {
        it('invokes listProducts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.ListProductsRequest', ['parent']);
            request.parent = defaultValue1;
