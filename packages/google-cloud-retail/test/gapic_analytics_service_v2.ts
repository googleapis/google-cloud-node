...
describe('v2.AnalyticsServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client = new analyticsserviceModule.v2.AnalyticsServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          analyticsserviceModule.v2.AnalyticsServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          analyticsserviceModule.v2.AnalyticsServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'retail.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new analyticsserviceModule.v2.AnalyticsServiceClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = analyticsserviceModule.v2.AnalyticsServiceClient.port;
      assert(port);
  ...
  describe('exportAnalyticsMetrics', () => {
    it('invokes exportAnalyticsMetrics without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.retail.v2.ExportAnalyticsMetricsRequest()
      );
