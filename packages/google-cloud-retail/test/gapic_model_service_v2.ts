...
describe('v2.ModelServiceClient', () => {
    ...
    describe('getModel', () => {
        it('invokes getModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.GetModelRequest', ['name']);
        ...
        it('invokes getModel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getModel(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2.IModel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('pauseModel', () => {
        it('invokes pauseModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.PauseModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2.Model()
    ...
    describe('resumeModel', () => {
        it('invokes resumeModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.ResumeModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2.Model()
    ...
    describe('deleteModel', () => {
        it('invokes deleteModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.DeleteModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateModel', () => {
        it('invokes updateModel without error', async () => {
            ...
            request.model ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.UpdateModelRequest', ['model', 'name']);
    ...
    describe('createModel', () => {
        it('invokes createModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.CreateModelRequest', ['parent']);
        ...
        it('invokes createModel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.retail.v2.IModel, protos.google.cloud.retail.v2.ICreateModelMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.retail.v2.IModel, protos.google.cloud.retail.v2.ICreateModelMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createModel as SinonStub)
                .getCall(0).args[0];
    ...
    describe('tuneModel', () => {
        it('invokes tuneModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.TuneModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes tuneModel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.tuneModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.retail.v2.ITuneModelResponse, protos.google.cloud.retail.v2.ITuneModelMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.retail.v2.ITuneModelResponse, protos.google.cloud.retail.v2.ITuneModelMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.tuneModel as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listModels', () => {
        it('invokes listModels without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.ListModelsRequest', ['parent']);
            request.parent = defaultValue1;
