  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          generativequestionserviceModule.v2.GenerativeQuestionServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        generativequestionserviceModule.v2.GenerativeQuestionServiceClient.port;
      assert(port);
    ...
    it('invokes updateGenerativeQuestionsFeatureConfig without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.updateGenerativeQuestionsFeatureConfig(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.retail.v2.IGenerativeQuestionsFeatureConfig | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listGenerativeQuestionConfigs without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listGenerativeQuestionConfigs(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.retail.v2.IListGenerativeQuestionConfigsResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes updateGenerativeQuestionConfig without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.updateGenerativeQuestionConfig(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.retail.v2.IGenerativeQuestionConfig | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchUpdateGenerativeQuestionConfigs without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchUpdateGenerativeQuestionConfigs(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.retail.v2.IBatchUpdateGenerativeQuestionConfigsResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
