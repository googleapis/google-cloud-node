...
describe('v2beta.GenerativeQuestionServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          generativequestionserviceModule.v2beta.GenerativeQuestionServiceClient
            .servicePath;
  ...
  describe('updateGenerativeQuestionsFeatureConfig', () => {
    it('invokes updateGenerativeQuestionsFeatureConfig without error', async () => {
      ...
      const [response] =
        await client.updateGenerativeQuestionsFeatureConfig(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateGenerativeQuestionsFeatureConfig as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes updateGenerativeQuestionsFeatureConfig without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.updateGenerativeQuestionsFeatureConfig(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.retail.v2beta.IGenerativeQuestionsFeatureConfig | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes updateGenerativeQuestionsFeatureConfig with error', async () => {
      ...
      await assert.rejects(
        client.updateGenerativeQuestionsFeatureConfig(request),
        expectedError
      );
      const actualRequest = (
        client.innerApiCalls.updateGenerativeQuestionsFeatureConfig as SinonStub
  ...
  describe('getGenerativeQuestionsFeatureConfig', () => {
    it('invokes getGenerativeQuestionsFeatureConfig without error', async () => {
      ...
      client.innerApiCalls.getGenerativeQuestionsFeatureConfig =
        stubSimpleCall(expectedResponse);
      const [response] =
        await client.getGenerativeQuestionsFeatureConfig(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getGenerativeQuestionsFeatureConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getGenerativeQuestionsFeatureConfig as SinonStub
    ...
    it('invokes getGenerativeQuestionsFeatureConfig with error', async () => {
      ...
      await assert.rejects(
        client.getGenerativeQuestionsFeatureConfig(request),
        expectedError
      );
      const actualRequest = (
        client.innerApiCalls.getGenerativeQuestionsFeatureConfig as SinonStub
  ...
  describe('listGenerativeQuestionConfigs', () => {
    it('invokes listGenerativeQuestionConfigs without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listGenerativeQuestionConfigs as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listGenerativeQuestionConfigs as SinonStub
    ...
    it('invokes listGenerativeQuestionConfigs without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listGenerativeQuestionConfigs(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.retail.v2beta.IListGenerativeQuestionConfigsResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listGenerativeQuestionConfigs with error', async () => {
      ...
      await assert.rejects(
        client.listGenerativeQuestionConfigs(request),
        expectedError
      );
      const actualRequest = (
        client.innerApiCalls.listGenerativeQuestionConfigs as SinonStub
  ...
  describe('updateGenerativeQuestionConfig', () => {
    it('invokes updateGenerativeQuestionConfig without error', async () => {
      ...
      client.innerApiCalls.updateGenerativeQuestionConfig =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateGenerativeQuestionConfig(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateGenerativeQuestionConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateGenerativeQuestionConfig as SinonStub
    ...
    it('invokes updateGenerativeQuestionConfig without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.updateGenerativeQuestionConfig(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.retail.v2beta.IGenerativeQuestionConfig | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes updateGenerativeQuestionConfig with error', async () => {
      ...
      await assert.rejects(
        client.updateGenerativeQuestionConfig(request),
        expectedError
      );
      const actualRequest = (
        client.innerApiCalls.updateGenerativeQuestionConfig as SinonStub
  ...
  describe('batchUpdateGenerativeQuestionConfigs', () => {
    it('invokes batchUpdateGenerativeQuestionConfigs without error', async () => {
      ...
      client.innerApiCalls.batchUpdateGenerativeQuestionConfigs =
        stubSimpleCall(expectedResponse);
      const [response] =
        await client.batchUpdateGenerativeQuestionConfigs(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchUpdateGenerativeQuestionConfigs as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchUpdateGenerativeQuestionConfigs as SinonStub
    ...
    it('invokes batchUpdateGenerativeQuestionConfigs without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchUpdateGenerativeQuestionConfigs(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.retail.v2beta.IBatchUpdateGenerativeQuestionConfigsResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchUpdateGenerativeQuestionConfigs with error', async () => {
      ...
      client.innerApiCalls.batchUpdateGenerativeQuestionConfigs =
        stubSimpleCall(undefined, expectedError);
      await assert.rejects(
        client.batchUpdateGenerativeQuestionConfigs(request),
        expectedError
      );
      const actualRequest = (
        client.innerApiCalls.batchUpdateGenerativeQuestionConfigs as SinonStub
