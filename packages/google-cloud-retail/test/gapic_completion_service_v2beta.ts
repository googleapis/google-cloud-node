...
describe('v2beta.CompletionServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = completionserviceModule.v2beta.CompletionServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = completionserviceModule.v2beta.CompletionServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'retail.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new completionserviceModule.v2beta.CompletionServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new completionserviceModule.v2beta.CompletionServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new completionserviceModule.v2beta.CompletionServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new completionserviceModule.v2beta.CompletionServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = completionserviceModule.v2beta.CompletionServiceClient.port;
            assert(port);
    ...
    describe('completeQuery', () => {
        it('invokes completeQuery without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.CompleteQueryRequest', ['catalog']);
            request.catalog = defaultValue1;
            const expectedHeaderRequestParams = `catalog=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2beta.CompleteQueryResponse()
            );
        ...
        it('invokes completeQuery without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.completeQuery(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2beta.ICompleteQueryResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('importCompletionData', () => {
        it('invokes importCompletionData without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.retail.v2beta.ImportCompletionDataRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.ImportCompletionDataRequest', ['parent']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importCompletionData as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.importCompletionData as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes importCompletionData without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.importCompletionData(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.retail.v2beta.IImportCompletionDataResponse, protos.google.cloud.retail.v2beta.IImportMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.retail.v2beta.IImportCompletionDataResponse, protos.google.cloud.retail.v2beta.IImportMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importCompletionData as SinonStub)
                .getCall(0).args[0];
