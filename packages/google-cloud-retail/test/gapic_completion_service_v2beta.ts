...
describe('v2beta.CompletionServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new completionserviceModule.v2beta.CompletionServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          completionserviceModule.v2beta.CompletionServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          completionserviceModule.v2beta.CompletionServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'retail.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('invokes completeQuery without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.completeQuery(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.retail.v2beta.ICompleteQueryResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
