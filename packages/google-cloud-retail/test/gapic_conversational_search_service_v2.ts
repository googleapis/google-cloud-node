...
describe('v2.ConversationalSearchServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new conversationalsearchserviceModule.v2.ConversationalSearchServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          conversationalsearchserviceModule.v2.ConversationalSearchServiceClient
            .servicePath;
  ...
  describe('conversationalSearch', () => {
    it('invokes conversationalSearch without error', async () => {
      ...
      client.innerApiCalls.conversationalSearch =
      ...
      const promise = new Promise((resolve, reject) => {
        stream.on(
          'data',
          (
            response: protos.google.cloud.retail.v2.ConversationalSearchResponse,
          ) => {
            resolve(response);
          },
        );
      ...
      const actualRequest = (
        client.innerApiCalls.conversationalSearch as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes conversationalSearch with error', async () => {
      ...
      client.innerApiCalls.conversationalSearch = stubServerStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.conversationalSearch(request);
