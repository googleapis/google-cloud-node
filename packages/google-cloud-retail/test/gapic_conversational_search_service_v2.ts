...
describe('v2.ConversationalSearchServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new conversationalsearchserviceModule.v2.ConversationalSearchServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = conversationalsearchserviceModule.v2.ConversationalSearchServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = conversationalsearchserviceModule.v2.ConversationalSearchServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'retail.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new conversationalsearchserviceModule.v2.ConversationalSearchServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new conversationalsearchserviceModule.v2.ConversationalSearchServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new conversationalsearchserviceModule.v2.ConversationalSearchServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new conversationalsearchserviceModule.v2.ConversationalSearchServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = conversationalsearchserviceModule.v2.ConversationalSearchServiceClient.port;
            assert(port);
    ...
    describe('conversationalSearch', () => {
        it('invokes conversationalSearch without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.retail.v2.ConversationalSearchRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.ConversationalSearchRequest', ['placement']);
            request.placement = defaultValue1;
            const expectedHeaderRequestParams = `placement=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2.ConversationalSearchResponse()
            );
            ...
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.retail.v2.ConversationalSearchResponse) => {
                    resolve(response);
                });
