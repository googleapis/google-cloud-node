  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          projectserviceModule.v2beta.ProjectServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          projectserviceModule.v2beta.ProjectServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'retail.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new projectserviceModule.v2beta.ProjectServiceClient({
          universe_domain: 'example.com',
    ...
    it('invokes getAlertConfig without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getAlertConfig(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.retail.v2beta.IAlertConfig | null
          ) => {
            if (err) {
              reject(err);
            } else {
