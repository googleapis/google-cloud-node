...
describe('v2beta.UserEventServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          usereventserviceModule.v2beta.UserEventServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          usereventserviceModule.v2beta.UserEventServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'retail.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new usereventserviceModule.v2beta.UserEventServiceClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'retail.example.com');
          if (saved) {
    ...
    it('invokes writeUserEvent without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.writeUserEvent(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.retail.v2beta.IUserEvent | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('collectUserEvent', () => {
    it('invokes collectUserEvent without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.retail.v2beta.CollectUserEventRequest',
        ['parent']
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      const promise = new Promise((resolve, reject) => {
        client.importUserEvents(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.retail.v2beta.IImportUserEventsResponse,
      ...
      const promise = new Promise((resolve, reject) => {
        client.exportUserEvents(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.retail.v2beta.IExportUserEventsResponse,
      ...
      const promise = new Promise((resolve, reject) => {
        client.rejoinUserEvents(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.retail.v2beta.IRejoinUserEventsResponse,
