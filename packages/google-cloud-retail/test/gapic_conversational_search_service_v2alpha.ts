...
describe('v2alpha.ConversationalSearchServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new conversationalsearchserviceModule.v2alpha.ConversationalSearchServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          conversationalsearchserviceModule.v2alpha
    ...
    it('invokes conversationalSearch without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        stream.on(
          'data',
          (
            response: protos.google.cloud.retail.v2alpha.ConversationalSearchResponse
          ) => {
            resolve(response);
          }
        );
