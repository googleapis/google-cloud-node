...
function main(name) {
  ...
  const {ProjectServiceClient} = require('@google-cloud/retail').v2beta;

  // Instantiates a client
  const retailClient = new ProjectServiceClient();

  async function callGetAlertConfig() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await retailClient.getAlertConfig(request);
