...
export class SearchServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.retail.v2.SearchService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.searchServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.retail.v2.SearchService') :
 ...
 *   {@link protos.google.cloud.retail.v2.SearchRequest.filter|filter} and
 *   {@link protos.google.cloud.retail.v2.SearchRequest.page_categories|page_categories}.
 ...
 *   {@link protos.google.cloud.retail.v2.UserEvent.visitor_id|UserEvent.visitor_id}.
 *
 ...
 *   A page token
 *   {@link protos.google.cloud.retail.v2.SearchResponse.next_page_token|SearchResponse.next_page_token},
 *   received from a previous
 *   {@link protos.google.cloud.retail.v2.SearchService.Search|SearchService.Search} call.
 *   Provide this to retrieve the subsequent page.
 *
 *   When paginating, all other parameters provided to
 *   {@link protos.google.cloud.retail.v2.SearchService.Search|SearchService.Search} must
 *   match the call that provided the page token. Otherwise, an INVALID_ARGUMENT
 *   error is returned.
 * @param {number} request.offset
 *   A 0-indexed integer that specifies the current offset (that is, starting
 *   result location, amongst the {@link protos.google.cloud.retail.v2.Product|Product}s
 *   deemed by the API as relevant) in search results. This field is only
 *   considered if {@link protos.google.cloud.retail.v2.SearchRequest.page_token|page_token}
 *   is unset.
 *
 *   If this field is negative, an INVALID_ARGUMENT is returned.
 ...
 *   and
 *   {@link protos.google.cloud.retail.v2.SearchRequest.boost_spec|SearchRequest.boost_spec}
 ...
 *   {@link protos.google.cloud.retail.v2.Product|Product}s attributes,
 *   {@link protos.google.cloud.retail.v2.FulfillmentInfo|FulfillmentInfo} or
 *   {@link protos.google.cloud.retail.v2.LocalInventory|LocalInventory}s attributes. The
 *   attributes from all the matching
 *   {@link protos.google.cloud.retail.v2.Product.Type.VARIANT|variant}
 *   {@link protos.google.cloud.retail.v2.Product|Product}s or
 *   {@link protos.google.cloud.retail.v2.LocalInventory|LocalInventory}s are merged and
 *   de-duplicated. Notice that rollup attributes will lead to extra query
 *   latency. Maximum number of keys is 30.
 *
 *   For {@link protos.google.cloud.retail.v2.FulfillmentInfo|FulfillmentInfo}, a
 ...
 *     {@link protos.google.cloud.retail.v2.LocalInventory.attributes|Product.local_inventories.attributes}
 *     map.
 *   * attributes.key, where key is any key in the
 *     {@link protos.google.cloud.retail.v2.Product.attributes|Product.attributes} map.
 *   * pickupInStore.id, where id is any
 *   {@link protos.google.cloud.retail.v2.FulfillmentInfo.place_ids|FulfillmentInfo.place_ids}
 *   for {@link protos.google.cloud.retail.v2.FulfillmentInfo.type|FulfillmentInfo.type}
 *     "pickup-in-store".
 ...
 *
 *   Notice that if both
 *   {@link protos.google.cloud.retail.v2.ServingConfig.personalization_spec|ServingConfig.personalization_spec}
 *   and
 *   {@link protos.google.cloud.retail.v2.SearchRequest.personalization_spec|SearchRequest.personalization_spec}
 *   are set.
 *   {@link protos.google.cloud.retail.v2.SearchRequest.personalization_spec|SearchRequest.personalization_spec}
 *   will override
 *   {@link protos.google.cloud.retail.v2.ServingConfig.personalization_spec|ServingConfig.personalization_spec}.
 ...
 *   The first element of the array is Array of {@link protos.google.cloud.retail.v2.SearchResponse.SearchResult|SearchResult}.
 ...
 */
  ...
  search(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.retail.v2.SearchResponse.ISearchResult>): void;
  search(
      request: protos.google.cloud.retail.v2.ISearchRequest,
      callback: PaginationCallback<
          protos.google.cloud.retail.v2.ISearchRequest,
  ...
  search(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.retail.v2.ISearchRequest,
      protos.google.cloud.retail.v2.ISearchResponse|null|undefined,
      protos.google.cloud.retail.v2.SearchResponse.ISearchResult>|undefined = callback
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.cloud.retail.v2.SearchResponse.SearchResult|SearchResult} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   {@link protos.google.cloud.retail.v2.SearchResponse.SearchResult|SearchResult}. The API will be called under the hood as needed, once per the page,
...
/**
   ...
   * @returns {string} Resource name string.
   */
  experimentPath(project:string,location:string,catalog:string,experiment:string) {
  ...
  matchCatalogFromExperimentName(experimentName: string) {
    return this.pathTemplates.experimentPathTemplate.match(experimentName).catalog;
  }
