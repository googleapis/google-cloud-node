 ...
 * `src/v2/completion_service_client_config.json`.
...
export class CompletionServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const importCompletionDataResponse = protoFilesRoot.lookup(
      '.google.cloud.retail.v2.ImportCompletionDataResponse') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.retail.v2.CompletionService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.completionServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.retail.v2.CompletionService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.retail.v2.CompletionService,
 ...
 *   {@link protos.google.cloud.retail.v2.CompletionService.ImportCompletionData|CompletionService.ImportCompletionData}.
 ...
 *   {@link protos.google.cloud.retail.v2.UserEvent.entity|UserEvent.entity} to get
 ...
 *   The first element of the array is an object representing {@link protos.google.cloud.retail.v2.CompleteQueryResponse|CompleteQueryResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v2/completion_service.complete_query.js</caption>
 ...
 */
  completeQuery(
      ...
      Promise<[
        ...
        protos.google.cloud.retail.v2.ICompleteQueryRequest|undefined, {}|undefined
      ]>;
  completeQuery(
      request: protos.google.cloud.retail.v2.ICompleteQueryRequest,
      options: CallOptions,
 ...
 *   for more details and examples.
 * @example <caption>include:samples/generated/v2/completion_service.import_completion_data.js</caption>
 ...
 */
  importCompletionData(
      ...
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.retail.v2.IImportCompletionDataResponse, protos.google.cloud.retail.v2.IImportMetadata>,
  ...
  importCompletionData(
    ...
    const wrappedCallback: Callback<
      ...
      ? (error, response, rawResponse, _) => {
          this._log.info('importCompletionData response %j', rawResponse);
          callback!(error, response, rawResponse, _); // We verified callback above.
        }
      : undefined;
    this._log.info('importCompletionData request %j', request);
    return this.innerApiCalls.importCompletionData(request, options, wrappedCallback)
 ...
 * region_tag:retail_v2_generated_CompletionService_ImportCompletionData_async
 */
  async checkImportCompletionDataProgress(name: string): Promise<LROperation<protos.google.cloud.retail.v2.ImportCompletionDataResponse, protos.google.cloud.retail.v2.ImportMetadata>>{
    this._log.info('importCompletionData long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.importCompletionData, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.retail.v2.ImportCompletionDataResponse, protos.google.cloud.retail.v2.ImportMetadata>;
  }
/**
