...
export class UserEventServiceClient {
  ...
  writeUserEvent(
    ...
    callback: Callback<
      protos.google.cloud.retail.v2alpha.IUserEvent,
      | protos.google.cloud.retail.v2alpha.IWriteUserEventRequest
      | null
      | undefined,
      {} | null | undefined
    >
  ...
  async checkPurgeUserEventsProgress(
    ...
    LROperation<
      protos.google.cloud.retail.v2alpha.PurgeUserEventsResponse,
  ...
  async checkImportUserEventsProgress(
    ...
    LROperation<
      protos.google.cloud.retail.v2alpha.ImportUserEventsResponse,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .exportUserEvents(request, options, wrappedCallback)
      ?.then(
        ([response, rawResponse, _]: [
          LROperation<
            protos.google.cloud.retail.v2alpha.IExportUserEventsResponse,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .rejoinUserEvents(request, options, wrappedCallback)
      ?.then(
        ([response, rawResponse, _]: [
          LROperation<
            protos.google.cloud.retail.v2alpha.IRejoinUserEventsResponse,
  ...
  async checkRejoinUserEventsProgress(
    ...
    LROperation<
      protos.google.cloud.retail.v2alpha.RejoinUserEventsResponse,
      protos.google.cloud.retail.v2alpha.RejoinUserEventsMetadata
    >
  > {
