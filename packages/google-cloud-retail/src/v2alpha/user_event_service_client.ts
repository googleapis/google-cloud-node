 ...
 * `src/v2alpha/user_event_service_client_config.json`.
...
export class UserEventServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const purgeUserEventsResponse = protoFilesRoot.lookup(
      '.google.cloud.retail.v2alpha.PurgeUserEventsResponse') as gax.protobuf.Type;
    const purgeUserEventsMetadata = protoFilesRoot.lookup(
      '.google.cloud.retail.v2alpha.PurgeMetadata') as gax.protobuf.Type;
    const importUserEventsResponse = protoFilesRoot.lookup(
      '.google.cloud.retail.v2alpha.ImportUserEventsResponse') as gax.protobuf.Type;
    ...
    const exportUserEventsResponse = protoFilesRoot.lookup(
      '.google.cloud.retail.v2alpha.ExportUserEventsResponse') as gax.protobuf.Type;
    const exportUserEventsMetadata = protoFilesRoot.lookup(
      '.google.cloud.retail.v2alpha.ExportMetadata') as gax.protobuf.Type;
    const rejoinUserEventsResponse = protoFilesRoot.lookup(
      '.google.cloud.retail.v2alpha.RejoinUserEventsResponse') as gax.protobuf.Type;
    const rejoinUserEventsMetadata = protoFilesRoot.lookup(
      '.google.cloud.retail.v2alpha.RejoinUserEventsMetadata') as gax.protobuf.Type;
    ...
    this.descriptors.longrunning = {
      ...
      rejoinUserEvents: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        rejoinUserEventsResponse.decode.bind(rejoinUserEventsResponse),
        rejoinUserEventsMetadata.decode.bind(rejoinUserEventsMetadata))
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.retail.v2alpha.UserEventService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.userEventServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.retail.v2alpha.UserEventService') :
    ...
    const userEventServiceStubMethods =
        ['writeUserEvent', 'collectUserEvent', 'purgeUserEvents', 'importUserEvents', 'exportUserEvents', 'rejoinUserEvents'];
 ...
 */
  writeUserEvent(
      ...
      Promise<[
        ...
        protos.google.cloud.retail.v2alpha.IWriteUserEventRequest|undefined, {}|undefined
      ]>;
  writeUserEvent(
      request: protos.google.cloud.retail.v2alpha.IWriteUserEventRequest,
      options: CallOptions,
 ...
 */
  collectUserEvent(
      ...
      Promise<[
        ...
        protos.google.cloud.retail.v2alpha.ICollectUserEventRequest|undefined, {}|undefined
      ]>;
  collectUserEvent(
      request: protos.google.cloud.retail.v2alpha.ICollectUserEventRequest,
      options: CallOptions,
 ...
 * region_tag:retail_v2alpha_generated_UserEventService_PurgeUserEvents_async
 */
  async checkPurgeUserEventsProgress(name: string): Promise<LROperation<protos.google.cloud.retail.v2alpha.PurgeUserEventsResponse, protos.google.cloud.retail.v2alpha.PurgeMetadata>>{
 ...
 * region_tag:retail_v2alpha_generated_UserEventService_ImportUserEvents_async
 */
  async checkImportUserEventsProgress(name: string): Promise<LROperation<protos.google.cloud.retail.v2alpha.ImportUserEventsResponse, protos.google.cloud.retail.v2alpha.ImportMetadata>>{
 ...
 */
  ...
  exportUserEvents(
    ...
    const wrappedCallback: Callback<
          ...
          {}|null|undefined>|undefined = callback
      ? (error, response, rawResponse, _) => {
          this._log.info('exportUserEvents response %j', rawResponse);
          callback!(error, response, rawResponse, _); // We verified callback above.
        }
      : undefined;
    this._log.info('exportUserEvents request %j', request);
    return this.innerApiCalls.exportUserEvents(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.retail.v2alpha.IExportUserEventsResponse, protos.google.cloud.retail.v2alpha.IExportMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:retail_v2alpha_generated_UserEventService_ExportUserEvents_async
 */
  async checkExportUserEventsProgress(name: string): Promise<LROperation<protos.google.cloud.retail.v2alpha.ExportUserEventsResponse, protos.google.cloud.retail.v2alpha.ExportMetadata>>{
    this._log.info('exportUserEvents long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.exportUserEvents, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.retail.v2alpha.ExportUserEventsResponse, protos.google.cloud.retail.v2alpha.ExportMetadata>;
  }
/**
 ...
 */
  ...
  rejoinUserEvents(
    ...
    const wrappedCallback: Callback<
          ...
          {}|null|undefined>|undefined = callback
      ? (error, response, rawResponse, _) => {
          this._log.info('rejoinUserEvents response %j', rawResponse);
          callback!(error, response, rawResponse, _); // We verified callback above.
        }
      : undefined;
    this._log.info('rejoinUserEvents request %j', request);
    return this.innerApiCalls.rejoinUserEvents(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.retail.v2alpha.IRejoinUserEventsResponse, protos.google.cloud.retail.v2alpha.IRejoinUserEventsMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:retail_v2alpha_generated_UserEventService_RejoinUserEvents_async
 */
  async checkRejoinUserEventsProgress(name: string): Promise<LROperation<protos.google.cloud.retail.v2alpha.RejoinUserEventsResponse, protos.google.cloud.retail.v2alpha.RejoinUserEventsMetadata>>{
    this._log.info('rejoinUserEvents long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.rejoinUserEvents, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.retail.v2alpha.RejoinUserEventsResponse, protos.google.cloud.retail.v2alpha.RejoinUserEventsMetadata>;
  }
/**
