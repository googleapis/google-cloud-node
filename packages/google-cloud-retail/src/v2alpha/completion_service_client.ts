...
export class CompletionServiceClient {
   ...
   *   {@link protos.google.cloud.retail.v2alpha.CompletionService.ImportCompletionData|CompletionService.ImportCompletionData}.
   ...
   *   The first element of the array is an object representing {@link protos.google.cloud.retail.v2alpha.CompleteQueryResponse|CompleteQueryResponse}.
