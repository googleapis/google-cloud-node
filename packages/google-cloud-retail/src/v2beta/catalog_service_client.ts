...
export class CatalogServiceClient {
   ...
   *   {@link google.cloud.retail.v2beta.Catalog|Catalog} to update. If not set, will
   *   only update the
   *   {@link google.cloud.retail.v2beta.Catalog.product_level_config|Catalog.product_level_config}
