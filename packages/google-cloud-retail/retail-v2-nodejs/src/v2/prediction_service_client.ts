...
export class PredictionServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.retail.v2.PredictionService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.predictionServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.retail.v2.PredictionService') :
 ...
 */
  predict(
      ...
      Promise<[
        ...
        protos.google.cloud.retail.v2.IPredictRequest|undefined, {}|undefined
      ]>;
  predict(
      request: protos.google.cloud.retail.v2.IPredictRequest,
      options: CallOptions,
