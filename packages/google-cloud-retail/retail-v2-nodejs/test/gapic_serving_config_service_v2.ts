...
describe('v2.ServingConfigServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new servingconfigserviceModule.v2.ServingConfigServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = servingconfigserviceModule.v2.ServingConfigServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = servingconfigserviceModule.v2.ServingConfigServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'retail.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new servingconfigserviceModule.v2.ServingConfigServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new servingconfigserviceModule.v2.ServingConfigServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new servingconfigserviceModule.v2.ServingConfigServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new servingconfigserviceModule.v2.ServingConfigServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = servingconfigserviceModule.v2.ServingConfigServiceClient.port;
            assert(port);
    ...
    describe('createServingConfig', () => {
        it('invokes createServingConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.CreateServingConfigRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2.ServingConfig()
            );
            client.innerApiCalls.createServingConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.createServingConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createServingConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createServingConfig as SinonStub)
        ...
        it('invokes createServingConfig without error using callback', async () => {
            ...
            client.innerApiCalls.createServingConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createServingConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2.IServingConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createServingConfig with error', async () => {
            ...
            client.innerApiCalls.createServingConfig = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteServingConfig', () => {
        it('invokes deleteServingConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.DeleteServingConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteServingConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteServingConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteServingConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteServingConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteServingConfig without error using callback', async () => {
            ...
            client.innerApiCalls.deleteServingConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteServingConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteServingConfig = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateServingConfig', () => {
        it('invokes updateServingConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.UpdateServingConfigRequest', ['servingConfig', 'name']);
            request.servingConfig.name = defaultValue1;
            const expectedHeaderRequestParams = `serving_config.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2.ServingConfig()
            );
            client.innerApiCalls.updateServingConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.updateServingConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateServingConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateServingConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateServingConfig without error using callback', async () => {
            ...
            client.innerApiCalls.updateServingConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateServingConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `serving_config.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateServingConfig = stubSimpleCall(undefined, expectedError);
    ...
    describe('getServingConfig', () => {
        it('invokes getServingConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.GetServingConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2.ServingConfig()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getServingConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getServingConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getServingConfig without error using callback', async () => {
            ...
            client.innerApiCalls.getServingConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getServingConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getServingConfig = stubSimpleCall(undefined, expectedError);
    ...
    describe('addControl', () => {
        it('invokes addControl without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.AddControlRequest', ['servingConfig']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.addControl as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.addControl as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes addControl without error using callback', async () => {
            ...
            client.innerApiCalls.addControl = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.addControl(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2.IServingConfig|null) => {
        ...
        it('invokes addControl with error', async () => {
            ...
            const expectedHeaderRequestParams = `serving_config=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.addControl = stubSimpleCall(undefined, expectedError);
    ...
    describe('removeControl', () => {
        it('invokes removeControl without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.RemoveControlRequest', ['servingConfig']);
            request.servingConfig = defaultValue1;
            const expectedHeaderRequestParams = `serving_config=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2.ServingConfig()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.removeControl as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.removeControl as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes removeControl without error using callback', async () => {
            ...
            client.innerApiCalls.removeControl = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes removeControl with error', async () => {
            ...
            const expectedHeaderRequestParams = `serving_config=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.removeControl = stubSimpleCall(undefined, expectedError);
    ...
    describe('listServingConfigs', () => {
        it('invokes listServingConfigs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.ListServingConfigsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.retail.v2.ServingConfig()),
              generateSampleMessage(new protos.google.cloud.retail.v2.ServingConfig()),
              generateSampleMessage(new protos.google.cloud.retail.v2.ServingConfig()),
            ];
            client.innerApiCalls.listServingConfigs = stubSimpleCall(expectedResponse);
            const [response] = await client.listServingConfigs(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listServingConfigs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listServingConfigs as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listServingConfigs without error using callback', async () => {
            ...
            client.innerApiCalls.listServingConfigs = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listServingConfigs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listServingConfigs = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listServingConfigsStream without error', async () => {
            ...
            client.descriptors.page.listServingConfigs.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listServingConfigsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.retail.v2.ServingConfig[] = [];
                stream.on('data', (response: protos.google.cloud.retail.v2.ServingConfig) => {
            ...
            assert((client.descriptors.page.listServingConfigs.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listServingConfigs, request));
            assert(
        ...
        it('invokes listServingConfigsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listServingConfigs.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listServingConfigsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.retail.v2.ServingConfig[] = [];
                stream.on('data', (response: protos.google.cloud.retail.v2.ServingConfig) => {
        ...
        it('uses async iteration with listServingConfigs without error', async () => {
            ...
            client.descriptors.page.listServingConfigs.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.retail.v2.IServingConfig[] = [];
        ...
        it('uses async iteration with listServingConfigs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listServingConfigs.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listServingConfigsAsync(request);
