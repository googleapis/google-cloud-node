...
describe('v2.CompletionServiceClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new completionserviceModule.v2.CompletionServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new completionserviceModule.v2.CompletionServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'retail.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new completionserviceModule.v2.CompletionServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new completionserviceModule.v2.CompletionServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('completeQuery', () => {
        it('invokes completeQuery without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.retail.v2.CompleteQueryRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.CompleteQueryRequest', ['catalog']);
            request.catalog = defaultValue1;
            const expectedHeaderRequestParams = `catalog=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2.CompleteQueryResponse()
            );
    ...
    describe('importCompletionData', () => {
        it('invokes importCompletionData without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.retail.v2.ImportCompletionDataRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.ImportCompletionDataRequest', ['parent']);
