...
describe('v1beta1.TranscoderServiceClient', () => {
  it('has servicePath', () => {
    const servicePath =
      transcoderserviceModule.v1beta1.TranscoderServiceClient.servicePath;
    assert(servicePath);
  });

  it('has apiEndpoint', () => {
    const apiEndpoint =
      transcoderserviceModule.v1beta1.TranscoderServiceClient.apiEndpoint;
    assert(apiEndpoint);
  });
    ...
    it('invokes createJob without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createJob(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.video.transcoder.v1beta1.IJob | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createJobTemplate without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createJobTemplate(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.video.transcoder.v1beta1.IJobTemplate | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listJobTemplatesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.video.transcoder.v1beta1.JobTemplate
          ) => {
            responses.push(response);
          }
        );
