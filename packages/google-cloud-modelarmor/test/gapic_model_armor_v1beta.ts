...
describe('v1beta.ModelArmorClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = modelarmorModule.v1beta.ModelArmorClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = modelarmorModule.v1beta.ModelArmorClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'modelarmor.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new modelarmorModule.v1beta.ModelArmorClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'modelarmor.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new modelarmorModule.v1beta.ModelArmorClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'modelarmor.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new modelarmorModule.v1beta.ModelArmorClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new modelarmorModule.v1beta.ModelArmorClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getTemplate', () => {
        it('invokes getTemplate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.modelarmor.v1beta.GetTemplateRequest', ['name']);
        ...
        it('invokes getTemplate without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getTemplate(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.modelarmor.v1beta.ITemplate|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createTemplate', () => {
        it('invokes createTemplate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.modelarmor.v1beta.CreateTemplateRequest', ['parent']);
    ...
    describe('updateTemplate', () => {
        it('invokes updateTemplate without error', async () => {
            ...
            request.template ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.modelarmor.v1beta.UpdateTemplateRequest', ['template', 'name']);
    ...
    describe('deleteTemplate', () => {
        it('invokes deleteTemplate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.modelarmor.v1beta.DeleteTemplateRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getFloorSetting', () => {
        it('invokes getFloorSetting without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.modelarmor.v1beta.GetFloorSettingRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getFloorSetting without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getFloorSetting(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.modelarmor.v1beta.IFloorSetting|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateFloorSetting', () => {
        it('invokes updateFloorSetting without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.modelarmor.v1beta.UpdateFloorSettingRequest', ['floorSetting', 'name']);
    ...
    describe('sanitizeUserPrompt', () => {
        it('invokes sanitizeUserPrompt without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.modelarmor.v1beta.SanitizeUserPromptRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes sanitizeUserPrompt without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.sanitizeUserPrompt(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.modelarmor.v1beta.ISanitizeUserPromptResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('sanitizeModelResponse', () => {
        it('invokes sanitizeModelResponse without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.modelarmor.v1beta.SanitizeModelResponseRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes sanitizeModelResponse without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.sanitizeModelResponse(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.modelarmor.v1beta.ISanitizeModelResponseResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('streamSanitizeUserPrompt', () => {
        it('invokes streamSanitizeUserPrompt without error', async () => {
            ...
            client.innerApiCalls.streamSanitizeUserPrompt = stubBidiStreamingCall(expectedResponse);
            const stream = client.streamSanitizeUserPrompt();
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.modelarmor.v1beta.SanitizeUserPromptResponse) => {
                    resolve(response);
                });
            ...
            const response = await promise;
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.streamSanitizeUserPrompt as SinonStub)
        ...
        it('invokes streamSanitizeUserPrompt with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.streamSanitizeUserPrompt = stubBidiStreamingCall(undefined, expectedError);
            const stream = client.streamSanitizeUserPrompt();
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.modelarmor.v1beta.SanitizeUserPromptResponse) => {
                    resolve(response);
    ...
    describe('streamSanitizeModelResponse', () => {
        it('invokes streamSanitizeModelResponse without error', async () => {
            ...
            client.innerApiCalls.streamSanitizeModelResponse = stubBidiStreamingCall(expectedResponse);
            ...
            const response = await promise;
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.streamSanitizeModelResponse as SinonStub)
                .getCall(0).calledWith(null));
            assert.deepStrictEqual(((stream as unknown as PassThrough)
                ._transform as SinonStub).getCall(0).args[0], request);
        });
        ...
        it('invokes streamSanitizeModelResponse with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.streamSanitizeModelResponse = stubBidiStreamingCall(undefined, expectedError);
            const stream = client.streamSanitizeModelResponse();
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.modelarmor.v1beta.SanitizeModelResponseResponse) => {
                    resolve(response);
    ...
    describe('listTemplates', () => {
        it('invokes listTemplates without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.modelarmor.v1beta.ListTemplatesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.modelarmor.v1beta.Template()),
              generateSampleMessage(new protos.google.cloud.modelarmor.v1beta.Template()),
              generateSampleMessage(new protos.google.cloud.modelarmor.v1beta.Template()),
            ];
        ...
        it('invokes listTemplatesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.modelarmor.v1beta.Template) => {
