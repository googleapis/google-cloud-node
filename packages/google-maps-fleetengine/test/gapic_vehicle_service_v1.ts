...
describe('v1.VehicleServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          vehicleserviceModule.v1.VehicleServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          vehicleserviceModule.v1.VehicleServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'fleetengine.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new vehicleserviceModule.v1.VehicleServiceClient({
          universe_domain: 'example.com',
  ...
  describe('createVehicle', () => {
    it('invokes createVehicle without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.createVehicle as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes createVehicle without error using callback', async () => {
      ...
      client.innerApiCalls.createVehicle =
      ...
      const promise = new Promise((resolve, reject) => {
        client.createVehicle(
          ...
          (
            err?: Error | null,
            result?: protos.maps.fleetengine.v1.IVehicle | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createVehicle with error', async () => {
      ...
      client.innerApiCalls.createVehicle = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getVehicle', () => {
    it('invokes getVehicle without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getVehicle as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getVehicle as SinonStub
    ...
    it('invokes getVehicle with error', async () => {
      ...
      const expectedHeaderRequestParams = 'provider_id=providers%2Fvalue';
      const expectedError = new Error('expected');
      client.innerApiCalls.getVehicle = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteVehicle', () => {
    it('invokes deleteVehicle without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteVehicle as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteVehicle as SinonStub
    ...
    it('invokes deleteVehicle without error using callback', async () => {
      ...
      client.innerApiCalls.deleteVehicle =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes deleteVehicle with error', async () => {
      ...
      const expectedHeaderRequestParams = 'provider_id=providers%2Fvalue';
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteVehicle = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateVehicle', () => {
    it('invokes updateVehicle without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateVehicle as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateVehicle as SinonStub
    ...
    it('invokes updateVehicle without error using callback', async () => {
      ...
      client.innerApiCalls.updateVehicle =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes updateVehicle with error', async () => {
      ...
      const expectedHeaderRequestParams = 'provider_id=providers%2Fvalue';
      const expectedError = new Error('expected');
      client.innerApiCalls.updateVehicle = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateVehicleAttributes', () => {
    it('invokes updateVehicleAttributes without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateVehicleAttributes as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateVehicleAttributes as SinonStub
    ...
    it('invokes updateVehicleAttributes without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.updateVehicleAttributes(
          ...
          (
            err?: Error | null,
            result?: protos.maps.fleetengine.v1.IUpdateVehicleAttributesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes updateVehicleAttributes with error', async () => {
      ...
      const expectedHeaderRequestParams = 'provider_id=providers%2Fvalue';
      const expectedError = new Error('expected');
      client.innerApiCalls.updateVehicleAttributes = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('searchVehicles', () => {
    it('invokes searchVehicles without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.searchVehicles as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.searchVehicles as SinonStub
    ...
    it('invokes searchVehicles without error using callback', async () => {
      ...
      client.innerApiCalls.searchVehicles =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.searchVehicles(
          ...
          (
            err?: Error | null,
            result?: protos.maps.fleetengine.v1.ISearchVehiclesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes searchVehicles with error', async () => {
      ...
      const expectedHeaderRequestParams = 'provider_id=providers%2Fvalue';
      const expectedError = new Error('expected');
      client.innerApiCalls.searchVehicles = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listVehicles', () => {
    it('invokes listVehicles without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listVehicles as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listVehicles as SinonStub
    ...
    it('invokes listVehicles without error using callback', async () => {
      ...
      client.innerApiCalls.listVehicles =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listVehicles(
          request,
    ...
    it('invokes listVehicles with error', async () => {
      ...
      const expectedHeaderRequestParams = 'provider_id=providers%2Fvalue';
      const expectedError = new Error('expected');
      client.innerApiCalls.listVehicles = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listVehiclesStream without error', async () => {
      ...
      client.descriptors.page.listVehicles.createStream =
      ...
      assert(
        (client.descriptors.page.listVehicles.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listVehicles, request),
      );
      assert(
        (client.descriptors.page.listVehicles.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listVehiclesStream with error', async () => {
      ...
      const expectedHeaderRequestParams = 'provider_id=providers%2Fvalue';
      const expectedError = new Error('expected');
      client.descriptors.page.listVehicles.createStream = stubPageStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.listVehiclesStream(request);
    ...
    it('uses async iteration with listVehicles without error', async () => {
      ...
      client.descriptors.page.listVehicles.asyncIterate =
  ...
  describe('Path templates', () => {
    describe('trip', async () => {
      ...
      await client.initialize();
      client.pathTemplates.tripPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.tripPathTemplate.match = sinon
        .stub()
      ...
      it('tripPath', () => {
        ...
        assert(
          (client.pathTemplates.tripPathTemplate.render as SinonStub)
            .getCall(-1)
      ...
      it('matchProviderFromTripName', () => {
        ...
        assert(
          (client.pathTemplates.tripPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('vehicle', async () => {
      ...
      await client.initialize();
      client.pathTemplates.vehiclePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.vehiclePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);
      ...
      it('vehiclePath', () => {
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.vehiclePathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProviderFromVehicleName', () => {
        ...
        assert.strictEqual(result, 'providerValue');
        assert(
          (client.pathTemplates.vehiclePathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
