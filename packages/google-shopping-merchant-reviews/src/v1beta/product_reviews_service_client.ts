 ...
 * `src/v1beta/product_reviews_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './product_reviews_service_client_config.json';
 ...
 * @memberof v1beta
 */
export class ProductReviewsServiceClient {
  ...
  productReviewsServiceStub?: Promise<{[name: string]: Function}>;
  ...
  initialize() {
    ...
    if (this.productReviewsServiceStub) {
      return this.productReviewsServiceStub;
    }
  ...
  > | void {
    ...
    this.initialize();
    return this.innerApiCalls.getProductReview(request, options, callback);
  }
  /**
  ...
  > | void {
    ...
    this.initialize();
    return this.innerApiCalls.insertProductReview(request, options, callback);
  }
  /**
  ...
  > | void {
    ...
    this.initialize();
    return this.innerApiCalls.deleteProductReview(request, options, callback);
  }
  ...
  > | void {
    ...
    this.initialize();
    return this.innerApiCalls.listProductReviews(request, options, callback);
  }
  ...
  listProductReviewsAsync(
    ...
    return this.descriptors.page.listProductReviews.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.shopping.merchant.reviews.v1beta.IProductReview>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  close(): Promise<void> {
    if (this.productReviewsServiceStub && !this._terminated) {
      return this.productReviewsServiceStub.then(stub => {
