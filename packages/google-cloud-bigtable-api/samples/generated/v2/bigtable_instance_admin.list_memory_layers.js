...
function main(parent) {
  // [START bigtableadmin_v2_generated_BigtableInstanceAdmin_ListMemoryLayers_async]
  /**
  ...
  async function callListMemoryLayers() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = adminClient.listMemoryLayersAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListMemoryLayers();
  // [END bigtableadmin_v2_generated_BigtableInstanceAdmin_ListMemoryLayers_async]
}
