...
>>>>>>> main
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new datastreamModule.v1.DatastreamClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'datastream.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new datastreamModule.v1.DatastreamClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'datastream.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new datastreamModule.v1.DatastreamClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new datastreamModule.v1.DatastreamClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getConnectionProfile', () => {
        it('invokes getConnectionProfile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datastream.v1.GetConnectionProfileRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.datastream.v1.ConnectionProfile()
            ...
            const [response] = await client.getConnectionProfile(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getConnectionProfile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getConnectionProfile as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getConnectionProfile without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getConnectionProfile(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datastream.v1.IConnectionProfile|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('discoverConnectionProfile', () => {
        it('invokes discoverConnectionProfile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datastream.v1.DiscoverConnectionProfileRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.datastream.v1.DiscoverConnectionProfileResponse()
            ...
            const [response] = await client.discoverConnectionProfile(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.discoverConnectionProfile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.discoverConnectionProfile as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes discoverConnectionProfile without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.discoverConnectionProfile(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datastream.v1.IDiscoverConnectionProfileResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getStream', () => {
        it('invokes getStream without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datastream.v1.GetStreamRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.datastream.v1.Stream()
        ...
        it('invokes getStream without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getStream(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datastream.v1.IStream|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getStreamObject', () => {
        it('invokes getStreamObject without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datastream.v1.GetStreamObjectRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.datastream.v1.StreamObject()
            ...
            const [response] = await client.getStreamObject(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getStreamObject as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getStreamObject as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getStreamObject without error using callback', async () => {
            ...
            client.innerApiCalls.getStreamObject = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getStreamObject(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datastream.v1.IStreamObject|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getStreamObject with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getStreamObject = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getStreamObject(request), expectedError);
            const actualRequest = (client.innerApiCalls.getStreamObject as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
    ...
    describe('lookupStreamObject', () => {
        it('invokes lookupStreamObject without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datastream.v1.LookupStreamObjectRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.datastream.v1.StreamObject()
            );
            client.innerApiCalls.lookupStreamObject = stubSimpleCall(expectedResponse);
            const [response] = await client.lookupStreamObject(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.lookupStreamObject as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.lookupStreamObject as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes lookupStreamObject without error using callback', async () => {
            ...
            client.innerApiCalls.lookupStreamObject = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.lookupStreamObject(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datastream.v1.IStreamObject|null) => {
        ...
        it('invokes lookupStreamObject with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.lookupStreamObject = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.lookupStreamObject(request), expectedError);
            const actualRequest = (client.innerApiCalls.lookupStreamObject as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
    ...
    describe('startBackfillJob', () => {
        it('invokes startBackfillJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datastream.v1.StartBackfillJobRequest', ['object']);
            request.object = defaultValue1;
            const expectedHeaderRequestParams = `object=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.datastream.v1.StartBackfillJobResponse()
            ...
            const [response] = await client.startBackfillJob(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.startBackfillJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.startBackfillJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes startBackfillJob without error using callback', async () => {
            ...
            client.innerApiCalls.startBackfillJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.startBackfillJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datastream.v1.IStartBackfillJobResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes startBackfillJob with error', async () => {
            ...
            const expectedHeaderRequestParams = `object=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.startBackfillJob = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.startBackfillJob(request), expectedError);
            const actualRequest = (client.innerApiCalls.startBackfillJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
    ...
    describe('stopBackfillJob', () => {
        it('invokes stopBackfillJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datastream.v1.StopBackfillJobRequest', ['object']);
            request.object = defaultValue1;
            const expectedHeaderRequestParams = `object=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.datastream.v1.StopBackfillJobResponse()
            ...
            const [response] = await client.stopBackfillJob(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.stopBackfillJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.stopBackfillJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes stopBackfillJob without error using callback', async () => {
            ...
            client.innerApiCalls.stopBackfillJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.stopBackfillJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datastream.v1.IStopBackfillJobResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes stopBackfillJob with error', async () => {
            ...
            const expectedHeaderRequestParams = `object=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.stopBackfillJob = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.stopBackfillJob(request), expectedError);
            const actualRequest = (client.innerApiCalls.stopBackfillJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
    ...
    describe('getPrivateConnection', () => {
        it('invokes getPrivateConnection without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datastream.v1.GetPrivateConnectionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.datastream.v1.PrivateConnection()
        ...
        it('invokes getPrivateConnection without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getPrivateConnection(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datastream.v1.IPrivateConnection|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getRoute', () => {
        it('invokes getRoute without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datastream.v1.GetRouteRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.datastream.v1.Route()
            ...
            const [response] = await client.getRoute(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getRoute as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getRoute as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getRoute without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getRoute(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datastream.v1.IRoute|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createConnectionProfile', () => {
        it('invokes createConnectionProfile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datastream.v1.CreateConnectionProfileRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createConnectionProfile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createConnectionProfile as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createConnectionProfile without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createConnectionProfile(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.datastream.v1.IConnectionProfile, protos.google.cloud.datastream.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.datastream.v1.IConnectionProfile, protos.google.cloud.datastream.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createConnectionProfile as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateConnectionProfile', () => {
        it('invokes updateConnectionProfile without error', async () => {
            ...
            request.connectionProfile ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datastream.v1.UpdateConnectionProfileRequest', ['connectionProfile', 'name']);
            request.connectionProfile.name = defaultValue1;
            const expectedHeaderRequestParams = `connection_profile.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateConnectionProfile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateConnectionProfile as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('deleteConnectionProfile', () => {
        it('invokes deleteConnectionProfile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datastream.v1.DeleteConnectionProfileRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteConnectionProfile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteConnectionProfile as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteConnectionProfile without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deleteConnectionProfile(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.datastream.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.datastream.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteConnectionProfile as SinonStub)
                .getCall(0).args[0];
    ...
    describe('createStream', () => {
        it('invokes createStream without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datastream.v1.CreateStreamRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createStream without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createStream(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.datastream.v1.IStream, protos.google.cloud.datastream.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.datastream.v1.IStream, protos.google.cloud.datastream.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createStream as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateStream', () => {
        it('invokes updateStream without error', async () => {
            ...
            request.stream ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datastream.v1.UpdateStreamRequest', ['stream', 'name']);
            request.stream.name = defaultValue1;
            const expectedHeaderRequestParams = `stream.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('deleteStream', () => {
        it('invokes deleteStream without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datastream.v1.DeleteStreamRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('runStream', () => {
        it('invokes runStream without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datastream.v1.RunStreamRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.runStream as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.runStream as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes runStream without error using callback', async () => {
            ...
            client.innerApiCalls.runStream = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.runStream(
                    request,
                    (err?: Error|null,
        ...
        it('invokes runStream with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.runStream = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.runStream(request), expectedError);
            const actualRequest = (client.innerApiCalls.runStream as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
        ...
        it('invokes runStream with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.runStream = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.runStream(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.runStream as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkRunStreamProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkRunStreamProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('createPrivateConnection', () => {
        it('invokes createPrivateConnection without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datastream.v1.CreatePrivateConnectionRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createPrivateConnection without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createPrivateConnection(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.datastream.v1.IPrivateConnection, protos.google.cloud.datastream.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.datastream.v1.IPrivateConnection, protos.google.cloud.datastream.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createPrivateConnection as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deletePrivateConnection', () => {
        it('invokes deletePrivateConnection without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datastream.v1.DeletePrivateConnectionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createRoute', () => {
        it('invokes createRoute without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datastream.v1.CreateRouteRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createRoute as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createRoute as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createRoute without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createRoute(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.datastream.v1.IRoute, protos.google.cloud.datastream.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.datastream.v1.IRoute, protos.google.cloud.datastream.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createRoute as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteRoute', () => {
        it('invokes deleteRoute without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datastream.v1.DeleteRouteRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteRoute as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteRoute as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('listConnectionProfiles', () => {
        it('invokes listConnectionProfiles without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datastream.v1.ListConnectionProfilesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.datastream.v1.ConnectionProfile()),
              generateSampleMessage(new protos.google.cloud.datastream.v1.ConnectionProfile()),
              generateSampleMessage(new protos.google.cloud.datastream.v1.ConnectionProfile()),
            ];
            ...
            const [response] = await client.listConnectionProfiles(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listConnectionProfiles as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listConnectionProfiles as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listConnectionProfilesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.datastream.v1.ConnectionProfile[] = [];
                stream.on('data', (response: protos.google.cloud.datastream.v1.ConnectionProfile) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listStreams', () => {
        it('invokes listStreams without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datastream.v1.ListStreamsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
        ...
        it('invokes listStreamsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.datastream.v1.Stream) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listStreamObjects', () => {
        it('invokes listStreamObjects without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datastream.v1.ListStreamObjectsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.datastream.v1.StreamObject()),
              generateSampleMessage(new protos.google.cloud.datastream.v1.StreamObject()),
              generateSampleMessage(new protos.google.cloud.datastream.v1.StreamObject()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listStreamObjects as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listStreamObjects as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listStreamObjects without error using callback', async () => {
            ...
            client.innerApiCalls.listStreamObjects = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listStreamObjects with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listStreamObjects = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listStreamObjectsStream without error', async () => {
            ...
            client.descriptors.page.listStreamObjects.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listStreamObjectsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.datastream.v1.StreamObject[] = [];
                stream.on('data', (response: protos.google.cloud.datastream.v1.StreamObject) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listStreamObjects.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listStreamObjects, request));
            assert(
        ...
        it('invokes listStreamObjectsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listStreamObjects.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listStreamObjectsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.datastream.v1.StreamObject[] = [];
                stream.on('data', (response: protos.google.cloud.datastream.v1.StreamObject) => {
        ...
        it('uses async iteration with listStreamObjects without error', async () => {
            ...
            client.descriptors.page.listStreamObjects.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listStreamObjects with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listStreamObjects.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listStreamObjectsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.datastream.v1.IStreamObject[] = [];
                for await (const resource of iterable) {
    ...
    describe('fetchStaticIps', () => {
        it('invokes fetchStaticIps without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datastream.v1.FetchStaticIpsRequest', ['name']);
            request.name = defaultValue1;
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.fetchStaticIps as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.fetchStaticIps as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('listPrivateConnections', () => {
        it('invokes listPrivateConnections without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datastream.v1.ListPrivateConnectionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.datastream.v1.PrivateConnection()),
              generateSampleMessage(new protos.google.cloud.datastream.v1.PrivateConnection()),
              generateSampleMessage(new protos.google.cloud.datastream.v1.PrivateConnection()),
            ];
...
<<<<<<< HEAD
        ...
        it('invokes listPrivateConnectionsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.datastream.v1.PrivateConnection) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listRoutes', () => {
        it('invokes listRoutes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datastream.v1.ListRoutesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listRoutes as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listRoutes as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listRoutesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.datastream.v1.Route) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
...
>>>>>>> main
    ...
    describe('Path templates', () => {
        ...
        describe('streamObject', async () => {
            ...
            await client.initialize();
            client.pathTemplates.streamObjectPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.streamObjectPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('streamObjectPath', () => {
                const result = client.streamObjectPath("projectValue", "locationValue", "streamValue", "objectValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.streamObjectPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromStreamObjectName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.streamObjectPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
