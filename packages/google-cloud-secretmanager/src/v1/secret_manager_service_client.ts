...
export class SecretManagerServiceClient {
   ...
   * @returns {string} A string representing the project.
   */
  matchProjectFromProjectLocationSecretsName(
    projectLocationSecretsName: string,
  ) {
    return this.pathTemplates.projectLocationSecretsPathTemplate.match(
      projectLocationSecretsName,
    ).project;
  }
   ...
   * @returns {string} A string representing the location.
   */
  matchLocationFromProjectLocationSecretsName(
    projectLocationSecretsName: string,
  ) {
    return this.pathTemplates.projectLocationSecretsPathTemplate.match(
      projectLocationSecretsName,
   ...
   * @returns {string} A string representing the secret.
   */
  matchSecretFromProjectLocationSecretsName(
    projectLocationSecretsName: string,
  ) {
    return this.pathTemplates.projectLocationSecretsPathTemplate.match(
      projectLocationSecretsName,
  ...
  matchProjectFromProjectSecretsName(projectSecretsName: string) {
    return this.pathTemplates.projectSecretsPathTemplate.match(
      projectSecretsName,
    ).project;
  }
