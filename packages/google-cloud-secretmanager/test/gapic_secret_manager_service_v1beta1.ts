...
describe('v1beta1.SecretManagerServiceClient', () => {
    ...
    describe('createSecret', () => {
        ...
        it('invokes createSecret with error', async () => {
            ...
            await assert.rejects(async () => { await client.createSecret(request); }, expectedError);
            assert((client.innerApiCalls.createSecret as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('addSecretVersion', () => {
        ...
        it('invokes addSecretVersion with error', async () => {
            ...
            await assert.rejects(async () => { await client.addSecretVersion(request); }, expectedError);
            assert((client.innerApiCalls.addSecretVersion as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getSecret', () => {
        ...
        it('invokes getSecret with error', async () => {
            ...
            await assert.rejects(async () => { await client.getSecret(request); }, expectedError);
            assert((client.innerApiCalls.getSecret as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateSecret', () => {
        ...
        it('invokes updateSecret with error', async () => {
            ...
            await assert.rejects(async () => { await client.updateSecret(request); }, expectedError);
            assert((client.innerApiCalls.updateSecret as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deleteSecret', () => {
        ...
        it('invokes deleteSecret with error', async () => {
            ...
            await assert.rejects(async () => { await client.deleteSecret(request); }, expectedError);
            assert((client.innerApiCalls.deleteSecret as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getSecretVersion', () => {
        ...
        it('invokes getSecretVersion with error', async () => {
            ...
            await assert.rejects(async () => { await client.getSecretVersion(request); }, expectedError);
            assert((client.innerApiCalls.getSecretVersion as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('accessSecretVersion', () => {
        ...
        it('invokes accessSecretVersion with error', async () => {
            ...
            await assert.rejects(async () => { await client.accessSecretVersion(request); }, expectedError);
            assert((client.innerApiCalls.accessSecretVersion as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('disableSecretVersion', () => {
        ...
        it('invokes disableSecretVersion with error', async () => {
            ...
            await assert.rejects(async () => { await client.disableSecretVersion(request); }, expectedError);
            assert((client.innerApiCalls.disableSecretVersion as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('enableSecretVersion', () => {
        ...
        it('invokes enableSecretVersion with error', async () => {
            ...
            await assert.rejects(async () => { await client.enableSecretVersion(request); }, expectedError);
            assert((client.innerApiCalls.enableSecretVersion as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('destroySecretVersion', () => {
        ...
        it('invokes destroySecretVersion with error', async () => {
            ...
            await assert.rejects(async () => { await client.destroySecretVersion(request); }, expectedError);
            assert((client.innerApiCalls.destroySecretVersion as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('listSecrets', () => {
        ...
        it('invokes listSecrets with error', async () => {
            ...
            await assert.rejects(async () => { await client.listSecrets(request); }, expectedError);
            assert((client.innerApiCalls.listSecrets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listSecretVersions', () => {
        ...
        it('invokes listSecretVersions with error', async () => {
            ...
            await assert.rejects(async () => { await client.listSecretVersions(request); }, expectedError);
            assert((client.innerApiCalls.listSecretVersions as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
