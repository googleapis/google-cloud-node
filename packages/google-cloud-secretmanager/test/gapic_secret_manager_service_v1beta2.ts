...
describe('v1beta2.SecretManagerServiceClient', () => {
  ...
  describe('Path templates', () => {
    ...
    describe('projectLocationSecrets', async () => {
      ...
      await client.initialize();
      client.pathTemplates.projectLocationSecretsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.projectLocationSecretsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('projectLocationSecretsPath', () => {
        const result = client.projectLocationSecretsPath(
          'projectValue',
          'locationValue',
          'secretValue',
        );
        ...
        assert(
          (
            client.pathTemplates.projectLocationSecretsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromProjectLocationSecretsName', () => {
        const result =
          client.matchProjectFromProjectLocationSecretsName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.projectLocationSecretsPathTemplate
      ...
      it('matchLocationFromProjectLocationSecretsName', () => {
        const result =
          client.matchLocationFromProjectLocationSecretsName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.projectLocationSecretsPathTemplate
      ...
      it('matchSecretFromProjectLocationSecretsName', () => {
        const result =
          client.matchSecretFromProjectLocationSecretsName(fakePath);
        assert.strictEqual(result, 'secretValue');
        assert(
          (
            client.pathTemplates.projectLocationSecretsPathTemplate
    ...
    describe('projectSecrets', async () => {
      ...
      await client.initialize();
      client.pathTemplates.projectSecretsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.projectSecretsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);
      ...
      it('projectSecretsPath', () => {
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.projectSecretsPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromProjectSecretsName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.projectSecretsPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
