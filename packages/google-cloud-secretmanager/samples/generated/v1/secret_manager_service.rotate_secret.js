...
function main(parent) {
  ...
  async function callRotateSecret() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const response = await secretmanagerClient.rotateSecret(request);
    console.log(response);
  }

  callRotateSecret();
  // [END secretmanager_v1_generated_SecretManagerService_RotateSecret_async]
}
