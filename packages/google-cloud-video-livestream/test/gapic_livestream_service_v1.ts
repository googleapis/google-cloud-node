...
describe('v1.LivestreamServiceClient', () => {
  ...
  describe('previewInput', () => {
    it('invokes previewInput without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.previewInput as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.previewInput as SinonStub
    ...
    it('invokes previewInput without error using callback', async () => {
      ...
      client.innerApiCalls.previewInput =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.previewInput(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.video.livestream.v1.IPreviewInputResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes previewInput with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.previewInput = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('startDistribution', () => {
    it('invokes startDistribution without error', async () => {
      ...
      client.innerApiCalls.startDistribution =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.startDistribution(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.startDistribution as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.startDistribution as SinonStub
    ...
    it('invokes startDistribution with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.startDistribution = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkStartDistributionProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkStartDistributionProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('stopDistribution', () => {
    it('invokes stopDistribution without error', async () => {
      ...
      client.innerApiCalls.stopDistribution =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.stopDistribution(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.stopDistribution as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.stopDistribution as SinonStub
    ...
    it('invokes stopDistribution with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.stopDistribution = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkStopDistributionProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkStopDistributionProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
