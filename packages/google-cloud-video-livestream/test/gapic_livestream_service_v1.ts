...
describe('v1.LivestreamServiceClient', () => {
    ...
    describe('previewInput', () => {
        it('invokes previewInput without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.video.livestream.v1.PreviewInputRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.video.livestream.v1.PreviewInputRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.video.livestream.v1.PreviewInputResponse()
            );
            client.innerApiCalls.previewInput = stubSimpleCall(expectedResponse);
            const [response] = await client.previewInput(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.previewInput as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.previewInput as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes previewInput without error using callback', async () => {
            ...
            client.innerApiCalls.previewInput = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.previewInput(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.video.livestream.v1.IPreviewInputResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes previewInput with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.previewInput = stubSimpleCall(undefined, expectedError);
    ...
    describe('startDistribution', () => {
        it('invokes startDistribution without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.video.livestream.v1.StartDistributionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.video.livestream.v1.StartDistributionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.startDistribution = stubLongRunningCall(expectedResponse);
            const [operation] = await client.startDistribution(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.startDistribution as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.startDistribution as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes startDistribution without error using callback', async () => {
            ...
            client.innerApiCalls.startDistribution = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes startDistribution with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.startDistribution = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.startDistribution(request), expectedError);
            const actualRequest = (client.innerApiCalls.startDistribution as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.startDistribution as SinonStub)
        ...
        it('invokes startDistribution with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.startDistribution = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.startDistribution(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.startDistribution as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkStartDistributionProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkStartDistributionProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkStartDistributionProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkStartDistributionProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('stopDistribution', () => {
        it('invokes stopDistribution without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.video.livestream.v1.StopDistributionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.video.livestream.v1.StopDistributionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.stopDistribution = stubLongRunningCall(expectedResponse);
            const [operation] = await client.stopDistribution(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.stopDistribution as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.stopDistribution as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes stopDistribution without error using callback', async () => {
            ...
            client.innerApiCalls.stopDistribution = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes stopDistribution with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.stopDistribution = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.stopDistribution(request), expectedError);
            const actualRequest = (client.innerApiCalls.stopDistribution as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.stopDistribution as SinonStub)
        ...
        it('invokes stopDistribution with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.stopDistribution = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.stopDistribution(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.stopDistribution as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkStopDistributionProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkStopDistributionProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkStopDistributionProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkStopDistributionProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
