...
function main(parent, dvrSessionId, dvrSession) {
  ...
  async function callCreateDvrSession() {
    // Construct request
    const request = {
      parent,
      dvrSessionId,
    ...
    // Run request
    const [operation] = await livestreamClient.createDvrSession(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callCreateDvrSession();
