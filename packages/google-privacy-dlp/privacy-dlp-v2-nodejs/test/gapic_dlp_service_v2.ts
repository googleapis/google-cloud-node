...
describe('v2.DlpServiceClient', () => {
    ...
    describe('listInfoTypes', () => {
        it('invokes listInfoTypes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.privacy.dlp.v2.ListInfoTypesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('hybridInspectJobTrigger', () => {
        it('invokes hybridInspectJobTrigger without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.privacy.dlp.v2.HybridInspectJobTriggerRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.hybridInspectJobTrigger as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.hybridInspectJobTrigger as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('createDiscoveryConfig', () => {
        it('invokes createDiscoveryConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.privacy.dlp.v2.CreateDiscoveryConfigRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.privacy.dlp.v2.DiscoveryConfig()
            );
            client.innerApiCalls.createDiscoveryConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.createDiscoveryConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createDiscoveryConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createDiscoveryConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createDiscoveryConfig without error using callback', async () => {
            ...
            client.innerApiCalls.createDiscoveryConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createDiscoveryConfig(
                    request,
                    (err?: Error|null, result?: protos.google.privacy.dlp.v2.IDiscoveryConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createDiscoveryConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createDiscoveryConfig = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createDiscoveryConfig(request), expectedError);
            const actualRequest = (client.innerApiCalls.createDiscoveryConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createDiscoveryConfig as SinonStub)
    ...
    describe('updateDiscoveryConfig', () => {
        it('invokes updateDiscoveryConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.privacy.dlp.v2.UpdateDiscoveryConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.privacy.dlp.v2.DiscoveryConfig()
            );
            client.innerApiCalls.updateDiscoveryConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.updateDiscoveryConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateDiscoveryConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateDiscoveryConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateDiscoveryConfig without error using callback', async () => {
            ...
            client.innerApiCalls.updateDiscoveryConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateDiscoveryConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateDiscoveryConfig = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateDiscoveryConfig(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateDiscoveryConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateDiscoveryConfig as SinonStub)
    ...
    describe('getDiscoveryConfig', () => {
        it('invokes getDiscoveryConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.privacy.dlp.v2.GetDiscoveryConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.privacy.dlp.v2.DiscoveryConfig()
            );
            client.innerApiCalls.getDiscoveryConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.getDiscoveryConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getDiscoveryConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDiscoveryConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getDiscoveryConfig without error using callback', async () => {
            ...
            client.innerApiCalls.getDiscoveryConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getDiscoveryConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getDiscoveryConfig = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteDiscoveryConfig', () => {
        it('invokes deleteDiscoveryConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.privacy.dlp.v2.DeleteDiscoveryConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteDiscoveryConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteDiscoveryConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteDiscoveryConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteDiscoveryConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteDiscoveryConfig without error using callback', async () => {
            ...
            client.innerApiCalls.deleteDiscoveryConfig = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteDiscoveryConfig with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteDiscoveryConfig = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.deleteDiscoveryConfig(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteDiscoveryConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteDiscoveryConfig as SinonStub)
    ...
    describe('getProjectDataProfile', () => {
        it('invokes getProjectDataProfile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.privacy.dlp.v2.GetProjectDataProfileRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.privacy.dlp.v2.ProjectDataProfile()
            );
            client.innerApiCalls.getProjectDataProfile = stubSimpleCall(expectedResponse);
            const [response] = await client.getProjectDataProfile(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getProjectDataProfile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getProjectDataProfile as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getProjectDataProfile without error using callback', async () => {
            ...
            client.innerApiCalls.getProjectDataProfile = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getProjectDataProfile(
                    request,
                    (err?: Error|null, result?: protos.google.privacy.dlp.v2.IProjectDataProfile|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getProjectDataProfile with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getProjectDataProfile = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getProjectDataProfile(request), expectedError);
            const actualRequest = (client.innerApiCalls.getProjectDataProfile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getProjectDataProfile as SinonStub)
    ...
    describe('getFileStoreDataProfile', () => {
        it('invokes getFileStoreDataProfile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.privacy.dlp.v2.GetFileStoreDataProfileRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.privacy.dlp.v2.FileStoreDataProfile()
            );
            client.innerApiCalls.getFileStoreDataProfile = stubSimpleCall(expectedResponse);
            const [response] = await client.getFileStoreDataProfile(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getFileStoreDataProfile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getFileStoreDataProfile as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getFileStoreDataProfile without error using callback', async () => {
            ...
            client.innerApiCalls.getFileStoreDataProfile = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getFileStoreDataProfile(
                    request,
                    (err?: Error|null, result?: protos.google.privacy.dlp.v2.IFileStoreDataProfile|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getFileStoreDataProfile with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getFileStoreDataProfile = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getFileStoreDataProfile(request), expectedError);
            const actualRequest = (client.innerApiCalls.getFileStoreDataProfile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getFileStoreDataProfile as SinonStub)
    ...
    describe('deleteFileStoreDataProfile', () => {
        it('invokes deleteFileStoreDataProfile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.privacy.dlp.v2.DeleteFileStoreDataProfileRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteFileStoreDataProfile = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteFileStoreDataProfile(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteFileStoreDataProfile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteFileStoreDataProfile as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteFileStoreDataProfile without error using callback', async () => {
            ...
            client.innerApiCalls.deleteFileStoreDataProfile = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteFileStoreDataProfile with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteFileStoreDataProfile = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.deleteFileStoreDataProfile(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteFileStoreDataProfile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteFileStoreDataProfile as SinonStub)
    ...
    describe('getTableDataProfile', () => {
        it('invokes getTableDataProfile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.privacy.dlp.v2.GetTableDataProfileRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.privacy.dlp.v2.TableDataProfile()
            );
            client.innerApiCalls.getTableDataProfile = stubSimpleCall(expectedResponse);
            const [response] = await client.getTableDataProfile(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getTableDataProfile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getTableDataProfile as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getTableDataProfile without error using callback', async () => {
            ...
            client.innerApiCalls.getTableDataProfile = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getTableDataProfile(
                    request,
                    (err?: Error|null, result?: protos.google.privacy.dlp.v2.ITableDataProfile|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getTableDataProfile with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getTableDataProfile = stubSimpleCall(undefined, expectedError);
    ...
    describe('getColumnDataProfile', () => {
        it('invokes getColumnDataProfile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.privacy.dlp.v2.GetColumnDataProfileRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.privacy.dlp.v2.ColumnDataProfile()
            );
            client.innerApiCalls.getColumnDataProfile = stubSimpleCall(expectedResponse);
            const [response] = await client.getColumnDataProfile(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getColumnDataProfile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getColumnDataProfile as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getColumnDataProfile without error using callback', async () => {
            ...
            client.innerApiCalls.getColumnDataProfile = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getColumnDataProfile(
                    request,
                    (err?: Error|null, result?: protos.google.privacy.dlp.v2.IColumnDataProfile|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getColumnDataProfile with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getColumnDataProfile = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteTableDataProfile', () => {
        it('invokes deleteTableDataProfile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.privacy.dlp.v2.DeleteTableDataProfileRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteTableDataProfile = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteTableDataProfile(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteTableDataProfile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteTableDataProfile as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteTableDataProfile without error using callback', async () => {
            ...
            client.innerApiCalls.deleteTableDataProfile = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteTableDataProfile with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteTableDataProfile = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.deleteTableDataProfile(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteTableDataProfile as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteTableDataProfile as SinonStub)
    ...
    describe('hybridInspectDlpJob', () => {
        it('invokes hybridInspectDlpJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.privacy.dlp.v2.HybridInspectDlpJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.privacy.dlp.v2.HybridInspectResponse()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.hybridInspectDlpJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.hybridInspectDlpJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('finishDlpJob', () => {
        it('invokes finishDlpJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.privacy.dlp.v2.FinishDlpJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.finishDlpJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.finishDlpJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('createConnection', () => {
        it('invokes createConnection without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.privacy.dlp.v2.CreateConnectionRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes createConnection without error using callback', async () => {
            ...
            client.innerApiCalls.createConnection = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createConnection(
                    request,
                    (err?: Error|null, result?: protos.google.privacy.dlp.v2.IConnection|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createConnection with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createConnection = stubSimpleCall(undefined, expectedError);
    ...
    describe('getConnection', () => {
        it('invokes getConnection without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.privacy.dlp.v2.GetConnectionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.privacy.dlp.v2.Connection()
    ...
    describe('deleteConnection', () => {
        it('invokes deleteConnection without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.privacy.dlp.v2.DeleteConnectionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
        ...
        it('invokes deleteConnection without error using callback', async () => {
            ...
            client.innerApiCalls.deleteConnection = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteConnection with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteConnection = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateConnection', () => {
        it('invokes updateConnection without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.privacy.dlp.v2.UpdateConnectionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.privacy.dlp.v2.Connection()
        ...
        it('invokes updateConnection without error using callback', async () => {
            ...
            client.innerApiCalls.updateConnection = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateConnection with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateConnection = stubSimpleCall(undefined, expectedError);
    ...
    describe('listDiscoveryConfigs', () => {
        it('invokes listDiscoveryConfigs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.privacy.dlp.v2.ListDiscoveryConfigsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.privacy.dlp.v2.DiscoveryConfig()),
              generateSampleMessage(new protos.google.privacy.dlp.v2.DiscoveryConfig()),
              generateSampleMessage(new protos.google.privacy.dlp.v2.DiscoveryConfig()),
            ];
            client.innerApiCalls.listDiscoveryConfigs = stubSimpleCall(expectedResponse);
            const [response] = await client.listDiscoveryConfigs(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listDiscoveryConfigs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listDiscoveryConfigs as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listDiscoveryConfigs without error using callback', async () => {
            ...
            client.innerApiCalls.listDiscoveryConfigs = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listDiscoveryConfigs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listDiscoveryConfigs = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listDiscoveryConfigsStream without error', async () => {
            ...
            client.descriptors.page.listDiscoveryConfigs.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listDiscoveryConfigsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.privacy.dlp.v2.DiscoveryConfig[] = [];
                stream.on('data', (response: protos.google.privacy.dlp.v2.DiscoveryConfig) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listDiscoveryConfigs.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listDiscoveryConfigs, request));
            assert(
        ...
        it('invokes listDiscoveryConfigsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDiscoveryConfigs.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listDiscoveryConfigsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.privacy.dlp.v2.DiscoveryConfig[] = [];
                stream.on('data', (response: protos.google.privacy.dlp.v2.DiscoveryConfig) => {
        ...
        it('uses async iteration with listDiscoveryConfigs without error', async () => {
            ...
            client.descriptors.page.listDiscoveryConfigs.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listDiscoveryConfigs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDiscoveryConfigs.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listDiscoveryConfigsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.privacy.dlp.v2.IDiscoveryConfig[] = [];
                for await (const resource of iterable) {
    ...
    describe('listProjectDataProfiles', () => {
        it('invokes listProjectDataProfiles without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.privacy.dlp.v2.ListProjectDataProfilesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
            ...
            client.innerApiCalls.listProjectDataProfiles = stubSimpleCall(expectedResponse);
            const [response] = await client.listProjectDataProfiles(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listProjectDataProfiles as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listProjectDataProfiles as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listProjectDataProfiles without error using callback', async () => {
            ...
            client.innerApiCalls.listProjectDataProfiles = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listProjectDataProfiles with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listProjectDataProfiles = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listProjectDataProfiles(request), expectedError);
            const actualRequest = (client.innerApiCalls.listProjectDataProfiles as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listProjectDataProfiles as SinonStub)
        ...
        it('invokes listProjectDataProfilesStream without error', async () => {
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listProjectDataProfiles.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listProjectDataProfiles, request));
            assert(
                (client.descriptors.page.listProjectDataProfiles.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listProjectDataProfilesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listProjectDataProfiles.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listProjectDataProfilesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.privacy.dlp.v2.ProjectDataProfile[] = [];
                stream.on('data', (response: protos.google.privacy.dlp.v2.ProjectDataProfile) => {
        ...
        it('uses async iteration with listProjectDataProfiles without error', async () => {
            ...
            client.descriptors.page.listProjectDataProfiles.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listProjectDataProfiles.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listProjectDataProfiles.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listProjectDataProfiles with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listProjectDataProfiles.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listProjectDataProfilesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.privacy.dlp.v2.IProjectDataProfile[] = [];
                for await (const resource of iterable) {
    ...
    describe('listTableDataProfiles', () => {
        it('invokes listTableDataProfiles without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.privacy.dlp.v2.ListTableDataProfilesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.privacy.dlp.v2.TableDataProfile()),
              generateSampleMessage(new protos.google.privacy.dlp.v2.TableDataProfile()),
              generateSampleMessage(new protos.google.privacy.dlp.v2.TableDataProfile()),
            ];
            client.innerApiCalls.listTableDataProfiles = stubSimpleCall(expectedResponse);
            const [response] = await client.listTableDataProfiles(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listTableDataProfiles as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listTableDataProfiles as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listTableDataProfiles without error using callback', async () => {
            ...
            client.innerApiCalls.listTableDataProfiles = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listTableDataProfiles with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listTableDataProfiles = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listTableDataProfiles(request), expectedError);
            const actualRequest = (client.innerApiCalls.listTableDataProfiles as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listTableDataProfiles as SinonStub)
        ...
        it('invokes listTableDataProfilesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.privacy.dlp.v2.TableDataProfile) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listTableDataProfiles.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listTableDataProfiles, request));
            assert(
                (client.descriptors.page.listTableDataProfiles.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listTableDataProfilesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listTableDataProfiles.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listTableDataProfilesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.privacy.dlp.v2.TableDataProfile[] = [];
                stream.on('data', (response: protos.google.privacy.dlp.v2.TableDataProfile) => {
        ...
        it('uses async iteration with listTableDataProfiles without error', async () => {
            ...
            client.descriptors.page.listTableDataProfiles.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listTableDataProfiles.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listTableDataProfiles.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listTableDataProfiles with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listTableDataProfiles.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listTableDataProfilesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.privacy.dlp.v2.ITableDataProfile[] = [];
                for await (const resource of iterable) {
    ...
    describe('listColumnDataProfiles', () => {
        it('invokes listColumnDataProfiles without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.privacy.dlp.v2.ListColumnDataProfilesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.privacy.dlp.v2.ColumnDataProfile()),
              generateSampleMessage(new protos.google.privacy.dlp.v2.ColumnDataProfile()),
              generateSampleMessage(new protos.google.privacy.dlp.v2.ColumnDataProfile()),
            ];
            client.innerApiCalls.listColumnDataProfiles = stubSimpleCall(expectedResponse);
            const [response] = await client.listColumnDataProfiles(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listColumnDataProfiles as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listColumnDataProfiles as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listColumnDataProfiles without error using callback', async () => {
            ...
            client.innerApiCalls.listColumnDataProfiles = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listColumnDataProfiles with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listColumnDataProfiles = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listColumnDataProfiles(request), expectedError);
            const actualRequest = (client.innerApiCalls.listColumnDataProfiles as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listColumnDataProfiles as SinonStub)
        ...
        it('invokes listColumnDataProfilesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.privacy.dlp.v2.ColumnDataProfile) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listColumnDataProfiles.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listColumnDataProfiles, request));
            assert(
                (client.descriptors.page.listColumnDataProfiles.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listColumnDataProfilesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listColumnDataProfiles.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listColumnDataProfilesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.privacy.dlp.v2.ColumnDataProfile[] = [];
                stream.on('data', (response: protos.google.privacy.dlp.v2.ColumnDataProfile) => {
        ...
        it('uses async iteration with listColumnDataProfiles without error', async () => {
            ...
            client.descriptors.page.listColumnDataProfiles.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listColumnDataProfiles.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listColumnDataProfiles.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listColumnDataProfiles with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listColumnDataProfiles.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listColumnDataProfilesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.privacy.dlp.v2.IColumnDataProfile[] = [];
                for await (const resource of iterable) {
    ...
    describe('listFileStoreDataProfiles', () => {
        it('invokes listFileStoreDataProfiles without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.privacy.dlp.v2.ListFileStoreDataProfilesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.privacy.dlp.v2.FileStoreDataProfile()),
              generateSampleMessage(new protos.google.privacy.dlp.v2.FileStoreDataProfile()),
              generateSampleMessage(new protos.google.privacy.dlp.v2.FileStoreDataProfile()),
            ];
            client.innerApiCalls.listFileStoreDataProfiles = stubSimpleCall(expectedResponse);
            const [response] = await client.listFileStoreDataProfiles(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listFileStoreDataProfiles as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listFileStoreDataProfiles as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listFileStoreDataProfiles without error using callback', async () => {
            ...
            client.innerApiCalls.listFileStoreDataProfiles = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listFileStoreDataProfiles with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listFileStoreDataProfiles = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listFileStoreDataProfiles(request), expectedError);
            const actualRequest = (client.innerApiCalls.listFileStoreDataProfiles as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listFileStoreDataProfiles as SinonStub)
        ...
        it('invokes listFileStoreDataProfilesStream without error', async () => {
            ...
            client.descriptors.page.listFileStoreDataProfiles.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.privacy.dlp.v2.FileStoreDataProfile) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listFileStoreDataProfiles.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listFileStoreDataProfiles, request));
            assert(
                (client.descriptors.page.listFileStoreDataProfiles.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listFileStoreDataProfilesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listFileStoreDataProfiles.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listFileStoreDataProfilesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.privacy.dlp.v2.FileStoreDataProfile[] = [];
                stream.on('data', (response: protos.google.privacy.dlp.v2.FileStoreDataProfile) => {
        ...
        it('uses async iteration with listFileStoreDataProfiles without error', async () => {
            ...
            client.descriptors.page.listFileStoreDataProfiles.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listFileStoreDataProfiles.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listFileStoreDataProfiles.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listFileStoreDataProfiles with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listFileStoreDataProfiles.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listFileStoreDataProfilesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.privacy.dlp.v2.IFileStoreDataProfile[] = [];
                for await (const resource of iterable) {
    ...
    describe('listConnections', () => {
        it('invokes listConnections without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.privacy.dlp.v2.ListConnectionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
        ...
        it('invokes listConnectionsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.privacy.dlp.v2.Connection) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('searchConnections', () => {
        it('invokes searchConnections without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.privacy.dlp.v2.SearchConnectionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.privacy.dlp.v2.Connection()),
              generateSampleMessage(new protos.google.privacy.dlp.v2.Connection()),
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.searchConnections as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.searchConnections as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes searchConnections without error using callback', async () => {
            ...
            client.innerApiCalls.searchConnections = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes searchConnections with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.searchConnections = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes searchConnectionsStream without error', async () => {
            ...
            client.descriptors.page.searchConnections.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.searchConnections.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.searchConnections, request));
            assert(
        ...
        it('invokes searchConnectionsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.searchConnections.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.searchConnectionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.privacy.dlp.v2.Connection[] = [];
                stream.on('data', (response: protos.google.privacy.dlp.v2.Connection) => {
        ...
        it('uses async iteration with searchConnections without error', async () => {
            ...
            client.descriptors.page.searchConnections.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.privacy.dlp.v2.IConnection[] = [];
        ...
        it('uses async iteration with searchConnections with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.searchConnections.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.searchConnectionsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.privacy.dlp.v2.IConnection[] = [];
                for await (const resource of iterable) {
    ...
    describe('Path templates', () => {
        ...
        describe('discoveryConfig', async () => {
            ...
            it('discoveryConfigPath', () => {
                const result = client.discoveryConfigPath("projectValue", "locationValue", "discoveryConfigValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.discoveryConfigPathTemplate.render as SinonStub)
            ...
            it('matchProjectFromDiscoveryConfigName', () => {
                ...
                assert((client.pathTemplates.discoveryConfigPathTemplate.match as SinonStub)
            ...
            it('matchDiscoveryConfigFromDiscoveryConfigName', () => {
                const result = client.matchDiscoveryConfigFromDiscoveryConfigName(fakePath);
        ...
        describe('organizationLocationColumnDataProfile', async () => {
            ...
            it('organizationLocationColumnDataProfilePath', () => {
                const result = client.organizationLocationColumnDataProfilePath("organizationValue", "locationValue", "columnDataProfileValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationLocationColumnDataProfilePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationLocationColumnDataProfileName', () => {
                const result = client.matchOrganizationFromOrganizationLocationColumnDataProfileName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationLocationColumnDataProfilePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromOrganizationLocationColumnDataProfileName', () => {
                const result = client.matchLocationFromOrganizationLocationColumnDataProfileName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.organizationLocationColumnDataProfilePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchColumnDataProfileFromOrganizationLocationColumnDataProfileName', () => {
                const result = client.matchColumnDataProfileFromOrganizationLocationColumnDataProfileName(fakePath);
        ...
        describe('organizationLocationConnection', async () => {
            ...
            it('organizationLocationConnectionPath', () => {
                const result = client.organizationLocationConnectionPath("organizationValue", "locationValue", "connectionValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationLocationConnectionPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationLocationConnectionName', () => {
                const result = client.matchOrganizationFromOrganizationLocationConnectionName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationLocationConnectionPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromOrganizationLocationConnectionName', () => {
                const result = client.matchLocationFromOrganizationLocationConnectionName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.organizationLocationConnectionPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchConnectionFromOrganizationLocationConnectionName', () => {
                const result = client.matchConnectionFromOrganizationLocationConnectionName(fakePath);
        ...
        describe('organizationLocationFileStoreDataProfile', async () => {
            ...
            it('organizationLocationFileStoreDataProfilePath', () => {
                const result = client.organizationLocationFileStoreDataProfilePath("organizationValue", "locationValue", "fileStoreDataProfileValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationLocationFileStoreDataProfilePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationLocationFileStoreDataProfileName', () => {
                const result = client.matchOrganizationFromOrganizationLocationFileStoreDataProfileName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationLocationFileStoreDataProfilePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromOrganizationLocationFileStoreDataProfileName', () => {
                const result = client.matchLocationFromOrganizationLocationFileStoreDataProfileName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.organizationLocationFileStoreDataProfilePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchFileStoreDataProfileFromOrganizationLocationFileStoreDataProfileName', () => {
                const result = client.matchFileStoreDataProfileFromOrganizationLocationFileStoreDataProfileName(fakePath);
        ...
        describe('organizationLocationProjectDataProfile', async () => {
            ...
            it('organizationLocationProjectDataProfilePath', () => {
                const result = client.organizationLocationProjectDataProfilePath("organizationValue", "locationValue", "projectDataProfileValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationLocationProjectDataProfilePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationLocationProjectDataProfileName', () => {
                const result = client.matchOrganizationFromOrganizationLocationProjectDataProfileName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationLocationProjectDataProfilePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromOrganizationLocationProjectDataProfileName', () => {
                const result = client.matchLocationFromOrganizationLocationProjectDataProfileName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.organizationLocationProjectDataProfilePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchProjectDataProfileFromOrganizationLocationProjectDataProfileName', () => {
                const result = client.matchProjectDataProfileFromOrganizationLocationProjectDataProfileName(fakePath);
        ...
        describe('organizationLocationTableDataProfile', async () => {
            ...
            it('organizationLocationTableDataProfilePath', () => {
                const result = client.organizationLocationTableDataProfilePath("organizationValue", "locationValue", "tableDataProfileValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.organizationLocationTableDataProfilePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchOrganizationFromOrganizationLocationTableDataProfileName', () => {
                const result = client.matchOrganizationFromOrganizationLocationTableDataProfileName(fakePath);
                assert.strictEqual(result, "organizationValue");
                assert((client.pathTemplates.organizationLocationTableDataProfilePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromOrganizationLocationTableDataProfileName', () => {
                const result = client.matchLocationFromOrganizationLocationTableDataProfileName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.organizationLocationTableDataProfilePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchTableDataProfileFromOrganizationLocationTableDataProfileName', () => {
                const result = client.matchTableDataProfileFromOrganizationLocationTableDataProfileName(fakePath);
        ...
        describe('projectLocationColumnDataProfile', async () => {
            ...
            it('projectLocationColumnDataProfilePath', () => {
                const result = client.projectLocationColumnDataProfilePath("projectValue", "locationValue", "columnDataProfileValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectLocationColumnDataProfilePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectLocationColumnDataProfileName', () => {
                const result = client.matchProjectFromProjectLocationColumnDataProfileName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectLocationColumnDataProfilePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromProjectLocationColumnDataProfileName', () => {
                const result = client.matchLocationFromProjectLocationColumnDataProfileName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.projectLocationColumnDataProfilePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchColumnDataProfileFromProjectLocationColumnDataProfileName', () => {
                const result = client.matchColumnDataProfileFromProjectLocationColumnDataProfileName(fakePath);
                assert.strictEqual(result, "columnDataProfileValue");
                assert((client.pathTemplates.projectLocationColumnDataProfilePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('projectLocationConnection', async () => {
            ...
            it('projectLocationConnectionPath', () => {
                const result = client.projectLocationConnectionPath("projectValue", "locationValue", "connectionValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectLocationConnectionPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectLocationConnectionName', () => {
                const result = client.matchProjectFromProjectLocationConnectionName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectLocationConnectionPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromProjectLocationConnectionName', () => {
                const result = client.matchLocationFromProjectLocationConnectionName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.projectLocationConnectionPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchConnectionFromProjectLocationConnectionName', () => {
                const result = client.matchConnectionFromProjectLocationConnectionName(fakePath);
                assert.strictEqual(result, "connectionValue");
                assert((client.pathTemplates.projectLocationConnectionPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('projectLocationFileStoreDataProfile', async () => {
            ...
            it('projectLocationFileStoreDataProfilePath', () => {
                const result = client.projectLocationFileStoreDataProfilePath("projectValue", "locationValue", "fileStoreDataProfileValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectLocationFileStoreDataProfilePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectLocationFileStoreDataProfileName', () => {
                const result = client.matchProjectFromProjectLocationFileStoreDataProfileName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectLocationFileStoreDataProfilePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromProjectLocationFileStoreDataProfileName', () => {
                const result = client.matchLocationFromProjectLocationFileStoreDataProfileName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.projectLocationFileStoreDataProfilePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchFileStoreDataProfileFromProjectLocationFileStoreDataProfileName', () => {
                const result = client.matchFileStoreDataProfileFromProjectLocationFileStoreDataProfileName(fakePath);
                assert.strictEqual(result, "fileStoreDataProfileValue");
                assert((client.pathTemplates.projectLocationFileStoreDataProfilePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('projectLocationProjectDataProfile', async () => {
            ...
            it('projectLocationProjectDataProfilePath', () => {
                const result = client.projectLocationProjectDataProfilePath("projectValue", "locationValue", "projectDataProfileValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectLocationProjectDataProfilePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectLocationProjectDataProfileName', () => {
                const result = client.matchProjectFromProjectLocationProjectDataProfileName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectLocationProjectDataProfilePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromProjectLocationProjectDataProfileName', () => {
                const result = client.matchLocationFromProjectLocationProjectDataProfileName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.projectLocationProjectDataProfilePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchProjectDataProfileFromProjectLocationProjectDataProfileName', () => {
                const result = client.matchProjectDataProfileFromProjectLocationProjectDataProfileName(fakePath);
                assert.strictEqual(result, "projectDataProfileValue");
                assert((client.pathTemplates.projectLocationProjectDataProfilePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('projectLocationTableDataProfile', async () => {
            ...
            it('projectLocationTableDataProfilePath', () => {
                const result = client.projectLocationTableDataProfilePath("projectValue", "locationValue", "tableDataProfileValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectLocationTableDataProfilePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectLocationTableDataProfileName', () => {
                const result = client.matchProjectFromProjectLocationTableDataProfileName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectLocationTableDataProfilePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchTableDataProfileFromProjectLocationTableDataProfileName', () => {
                const result = client.matchTableDataProfileFromProjectLocationTableDataProfileName(fakePath);
                assert.strictEqual(result, "tableDataProfileValue");
                assert((client.pathTemplates.projectLocationTableDataProfilePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
