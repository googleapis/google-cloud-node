...
describe('v1alpha.EvaluationServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new evaluationserviceModule.v1alpha.EvaluationServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = evaluationserviceModule.v1alpha.EvaluationServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = evaluationserviceModule.v1alpha.EvaluationServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'discoveryengine.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new evaluationserviceModule.v1alpha.EvaluationServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'discoveryengine.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new evaluationserviceModule.v1alpha.EvaluationServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'discoveryengine.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new evaluationserviceModule.v1alpha.EvaluationServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new evaluationserviceModule.v1alpha.EvaluationServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getEvaluation', () => {
        it('invokes getEvaluation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.discoveryengine.v1alpha.GetEvaluationRequest', ['name']);
        ...
        it('invokes getEvaluation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getEvaluation(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.discoveryengine.v1alpha.IEvaluation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createEvaluation', () => {
        it('invokes createEvaluation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.discoveryengine.v1alpha.CreateEvaluationRequest', ['parent']);
        ...
        it('invokes createEvaluation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createEvaluation(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.discoveryengine.v1alpha.IEvaluation, protos.google.cloud.discoveryengine.v1alpha.ICreateEvaluationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.discoveryengine.v1alpha.IEvaluation, protos.google.cloud.discoveryengine.v1alpha.ICreateEvaluationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createEvaluation as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listEvaluations', () => {
        it('invokes listEvaluations without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.discoveryengine.v1alpha.ListEvaluationsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.discoveryengine.v1alpha.Evaluation()),
              generateSampleMessage(new protos.google.cloud.discoveryengine.v1alpha.Evaluation()),
              generateSampleMessage(new protos.google.cloud.discoveryengine.v1alpha.Evaluation()),
            ];
        ...
        it('invokes listEvaluationsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.discoveryengine.v1alpha.Evaluation) => {
    ...
    describe('listEvaluationResults', () => {
        it('invokes listEvaluationResults without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.discoveryengine.v1alpha.ListEvaluationResultsRequest', ['evaluation']);
            request.evaluation = defaultValue1;
            const expectedHeaderRequestParams = `evaluation=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.discoveryengine.v1alpha.ListEvaluationResultsResponse.EvaluationResult()),
              generateSampleMessage(new protos.google.cloud.discoveryengine.v1alpha.ListEvaluationResultsResponse.EvaluationResult()),
              generateSampleMessage(new protos.google.cloud.discoveryengine.v1alpha.ListEvaluationResultsResponse.EvaluationResult()),
            ];
        ...
        it('invokes listEvaluationResults without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listEvaluationResults(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.discoveryengine.v1alpha.ListEvaluationResultsResponse.IEvaluationResult[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listEvaluationResultsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.discoveryengine.v1alpha.ListEvaluationResultsResponse.EvaluationResult) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
