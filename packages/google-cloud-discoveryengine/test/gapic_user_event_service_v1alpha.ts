...
describe('v1alpha.UserEventServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = usereventserviceModule.v1alpha.UserEventServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = usereventserviceModule.v1alpha.UserEventServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'discoveryengine.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new usereventserviceModule.v1alpha.UserEventServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'discoveryengine.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new usereventserviceModule.v1alpha.UserEventServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'discoveryengine.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new usereventserviceModule.v1alpha.UserEventServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new usereventserviceModule.v1alpha.UserEventServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('writeUserEvent', () => {
        it('invokes writeUserEvent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.discoveryengine.v1alpha.WriteUserEventRequest', ['parent']);
        ...
        it('invokes writeUserEvent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.writeUserEvent(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.discoveryengine.v1alpha.IUserEvent|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('collectUserEvent', () => {
        it('invokes collectUserEvent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.discoveryengine.v1alpha.CollectUserEventRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('purgeUserEvents', () => {
        it('invokes purgeUserEvents without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.discoveryengine.v1alpha.PurgeUserEventsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes purgeUserEvents without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.purgeUserEvents(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.discoveryengine.v1alpha.IPurgeUserEventsResponse, protos.google.cloud.discoveryengine.v1alpha.IPurgeUserEventsMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.discoveryengine.v1alpha.IPurgeUserEventsResponse, protos.google.cloud.discoveryengine.v1alpha.IPurgeUserEventsMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.purgeUserEvents as SinonStub)
                .getCall(0).args[0];
    ...
    describe('importUserEvents', () => {
        it('invokes importUserEvents without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.discoveryengine.v1alpha.ImportUserEventsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes importUserEvents without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.importUserEvents(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.discoveryengine.v1alpha.IImportUserEventsResponse, protos.google.cloud.discoveryengine.v1alpha.IImportUserEventsMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.discoveryengine.v1alpha.IImportUserEventsResponse, protos.google.cloud.discoveryengine.v1alpha.IImportUserEventsMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importUserEvents as SinonStub)
                .getCall(0).args[0];
