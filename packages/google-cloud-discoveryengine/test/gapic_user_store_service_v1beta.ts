...
import * as userstoreserviceModule from '../src';
...
describe('v1beta.UserStoreServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client = new userstoreserviceModule.v1beta.UserStoreServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          userstoreserviceModule.v1beta.UserStoreServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          userstoreserviceModule.v1beta.UserStoreServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'discoveryengine.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new userstoreserviceModule.v1beta.UserStoreServiceClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'discoveryengine.example.com');
          if (saved) {
    ...
    it('has port', () => {
      const port = userstoreserviceModule.v1beta.UserStoreServiceClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.userStoreServiceStub, undefined);
      await client.initialize();
      assert(client.userStoreServiceStub);
    });
  ...
  describe('getUserStore', () => {
    it('invokes getUserStore without error', async () => {
      const client = new userstoreserviceModule.v1beta.UserStoreServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.GetUserStoreRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.discoveryengine.v1beta.GetUserStoreRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.UserStore(),
      );
      client.innerApiCalls.getUserStore = stubSimpleCall(expectedResponse);
      const [response] = await client.getUserStore(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getUserStore as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getUserStore without error using callback', async () => {
      const client = new userstoreserviceModule.v1beta.UserStoreServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.getUserStore =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getUserStore(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.discoveryengine.v1beta.IUserStore | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getUserStore with error', async () => {
      const client = new userstoreserviceModule.v1beta.UserStoreServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.getUserStore = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.getUserStore(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.getUserStore as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes getUserStore with closed client', async () => {
      const client = new userstoreserviceModule.v1beta.UserStoreServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
  ...
  describe('updateUserStore', () => {
    it('invokes updateUserStore without error', async () => {
      const client = new userstoreserviceModule.v1beta.UserStoreServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.UpdateUserStoreRequest(),
      );
      request.userStore ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.discoveryengine.v1beta.UpdateUserStoreRequest',
        ['userStore', 'name'],
      );
      request.userStore.name = defaultValue1;
      const expectedHeaderRequestParams = `user_store.name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.UserStore(),
      );
      client.innerApiCalls.updateUserStore = stubSimpleCall(expectedResponse);
      const [response] = await client.updateUserStore(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateUserStore as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateUserStore as SinonStub
    ...
    it('invokes updateUserStore without error using callback', async () => {
      const client = new userstoreserviceModule.v1beta.UserStoreServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.updateUserStore =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.updateUserStore(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.discoveryengine.v1beta.IUserStore | null,
    ...
    it('invokes updateUserStore with error', async () => {
      const client = new userstoreserviceModule.v1beta.UserStoreServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `user_store.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateUserStore = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.updateUserStore(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.updateUserStore as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes updateUserStore with closed client', async () => {
      const client = new userstoreserviceModule.v1beta.UserStoreServiceClient({
        credentials: { client_email: 'bogus', private_key: 'bogus' },
        projectId: 'bogus',
      });
