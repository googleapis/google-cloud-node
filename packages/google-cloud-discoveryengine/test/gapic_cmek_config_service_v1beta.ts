...
describe('v1beta.CmekConfigServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new cmekconfigserviceModule.v1beta.CmekConfigServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          cmekconfigserviceModule.v1beta.CmekConfigServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          cmekconfigserviceModule.v1beta.CmekConfigServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'discoveryengine.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port = cmekconfigserviceModule.v1beta.CmekConfigServiceClient.port;
      assert(port);
  ...
  describe('getCmekConfig', () => {
    it('invokes getCmekConfig without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.GetCmekConfigRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.discoveryengine.v1beta.GetCmekConfigRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.CmekConfig(),
      );
    ...
    it('invokes getCmekConfig without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getCmekConfig(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.discoveryengine.v1beta.ICmekConfig | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listCmekConfigs', () => {
    it('invokes listCmekConfigs without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.ListCmekConfigsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.discoveryengine.v1beta.ListCmekConfigsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.ListCmekConfigsResponse(),
      );
    ...
    it('invokes listCmekConfigs without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listCmekConfigs(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.discoveryengine.v1beta.IListCmekConfigsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('updateCmekConfig', () => {
    it('invokes updateCmekConfig without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.UpdateCmekConfigRequest(),
      );
      request.config ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.discoveryengine.v1beta.UpdateCmekConfigRequest',
        ['config', 'name'],
      );
  ...
  describe('deleteCmekConfig', () => {
    it('invokes deleteCmekConfig without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.DeleteCmekConfigRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.discoveryengine.v1beta.DeleteCmekConfigRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
