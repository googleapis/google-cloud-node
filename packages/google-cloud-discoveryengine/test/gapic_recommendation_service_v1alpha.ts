  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          recommendationserviceModule.v1alpha.RecommendationServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        recommendationserviceModule.v1alpha.RecommendationServiceClient.port;
      assert(port);
    ...
    it('invokes recommend without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.recommend(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.discoveryengine.v1alpha.IRecommendResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
