...
describe('v1beta.UserLicenseServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new userlicenseserviceModule.v1beta.UserLicenseServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          userlicenseserviceModule.v1beta.UserLicenseServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          userlicenseserviceModule.v1beta.UserLicenseServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'discoveryengine.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        userlicenseserviceModule.v1beta.UserLicenseServiceClient.port;
      assert(port);
  ...
  describe('listLicenseConfigsUsageStats', () => {
    it('invokes listLicenseConfigsUsageStats without error', async () => {
      const client =
        new userlicenseserviceModule.v1beta.UserLicenseServiceClient({
          credentials: { client_email: 'bogus', private_key: 'bogus' },
          projectId: 'bogus',
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.ListLicenseConfigsUsageStatsRequest(),
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.ListLicenseConfigsUsageStatsResponse(),
      );
      client.innerApiCalls.listLicenseConfigsUsageStats =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listLicenseConfigsUsageStats(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listLicenseConfigsUsageStats as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes listLicenseConfigsUsageStats without error using callback', async () => {
      const client =
        new userlicenseserviceModule.v1beta.UserLicenseServiceClient({
          credentials: { client_email: 'bogus', private_key: 'bogus' },
          projectId: 'bogus',
      ...
      const promise = new Promise((resolve, reject) => {
        client.listLicenseConfigsUsageStats(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.discoveryengine.v1beta.IListLicenseConfigsUsageStatsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listLicenseConfigsUsageStats with error', async () => {
      const client =
        new userlicenseserviceModule.v1beta.UserLicenseServiceClient({
          credentials: { client_email: 'bogus', private_key: 'bogus' },
          projectId: 'bogus',
      ...
      client.innerApiCalls.listLicenseConfigsUsageStats = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listLicenseConfigsUsageStats(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listLicenseConfigsUsageStats as SinonStub
    ...
    it('invokes listLicenseConfigsUsageStats with closed client', async () => {
      const client =
        new userlicenseserviceModule.v1beta.UserLicenseServiceClient({
          credentials: { client_email: 'bogus', private_key: 'bogus' },
          projectId: 'bogus',
  ...
  describe('batchUpdateUserLicenses', () => {
    it('invokes batchUpdateUserLicenses without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.BatchUpdateUserLicensesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('listUserLicenses', () => {
    it('invokes listUserLicenses without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.ListUserLicensesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.discoveryengine.v1beta.ListUserLicensesRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.discoveryengine.v1beta.UserLicense(),
        ),
        generateSampleMessage(
          new protos.google.cloud.discoveryengine.v1beta.UserLicense(),
        ),
      ...
      const promise = new Promise((resolve, reject) => {
        client.listUserLicenses(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.discoveryengine.v1beta.IUserLicense[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listUserLicensesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.discoveryengine.v1beta.UserLicense[] =
          [];
        stream.on(
          'data',
          (
            response: protos.google.cloud.discoveryengine.v1beta.UserLicense,
          ) => {
    ...
    it('uses async iteration with listUserLicenses without error', async () => {
      ...
      const responses: protos.google.cloud.discoveryengine.v1beta.IUserLicense[] =
        [];
