...
describe('v1beta.DocumentServiceClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new documentserviceModule.v1beta.DocumentServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'discoveryengine.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new documentserviceModule.v1beta.DocumentServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'discoveryengine.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new documentserviceModule.v1beta.DocumentServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new documentserviceModule.v1beta.DocumentServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('batchGetDocumentsMetadata', () => {
        it('invokes batchGetDocumentsMetadata without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.discoveryengine.v1beta.BatchGetDocumentsMetadataRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes batchGetDocumentsMetadata without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchGetDocumentsMetadata(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.discoveryengine.v1beta.IBatchGetDocumentsMetadataResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('purgeDocuments', () => {
        it('invokes purgeDocuments without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.discoveryengine.v1beta.PurgeDocumentsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes purgeDocuments without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.purgeDocuments(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.discoveryengine.v1beta.IPurgeDocumentsResponse, protos.google.cloud.discoveryengine.v1beta.IPurgeDocumentsMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.discoveryengine.v1beta.IPurgeDocumentsResponse, protos.google.cloud.discoveryengine.v1beta.IPurgeDocumentsMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.purgeDocuments as SinonStub)
                .getCall(0).args[0];
