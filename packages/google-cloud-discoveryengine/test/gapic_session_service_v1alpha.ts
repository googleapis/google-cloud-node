...
describe('v1alpha.SessionServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          sessionserviceModule.v1alpha.SessionServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          sessionserviceModule.v1alpha.SessionServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'discoveryengine.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new sessionserviceModule.v1alpha.SessionServiceClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'discoveryengine.example.com');
          if (saved) {
    ...
    it('invokes createSession without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createSession(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.discoveryengine.v1alpha.ISession | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listSessions', () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listSessions(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.discoveryengine.v1alpha.ISession[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listSessionsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.discoveryengine.v1alpha.Session) => {
  ...
  describe('listFiles', () => {
    it('invokes listFiles without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.discoveryengine.v1alpha.FileMetadata(),
        ),
        generateSampleMessage(
          new protos.google.cloud.discoveryengine.v1alpha.FileMetadata(),
        ),
    ...
    it('invokes listFilesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.discoveryengine.v1alpha.FileMetadata,
          ) => {
            responses.push(response);
          },
        );
