...
describe('v1beta.ServingConfigServiceClient', () => {
  ...
  describe('createServingConfig', () => {
    it('invokes createServingConfig without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.CreateServingConfigRequest(),
      );
  ...
  describe('deleteServingConfig', () => {
    it('invokes deleteServingConfig without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.DeleteServingConfigRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.discoveryengine.v1beta.DeleteServingConfigRequest',
        ['name'],
      );
