  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          rankserviceModule.v1alpha.RankServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          rankserviceModule.v1alpha.RankServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'discoveryengine.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new rankserviceModule.v1alpha.RankServiceClient({
          universe_domain: 'example.com',
    ...
    it('invokes rank without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.rank(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.discoveryengine.v1alpha.IRankResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
