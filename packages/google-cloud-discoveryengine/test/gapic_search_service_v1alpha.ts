  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          searchserviceModule.v1alpha.SearchServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          searchserviceModule.v1alpha.SearchServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'discoveryengine.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new searchserviceModule.v1alpha.SearchServiceClient({
          universe_domain: 'example.com',
    ...
    it('invokes search without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.discoveryengine.v1alpha.SearchResponse.SearchResult()
        ),
        generateSampleMessage(
          new protos.google.cloud.discoveryengine.v1alpha.SearchResponse.SearchResult()
        ),
    ...
    it('invokes searchStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.discoveryengine.v1alpha.SearchResponse.SearchResult
          ) => {
