  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          searchtuningserviceModule.v1alpha.SearchTuningServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        searchtuningserviceModule.v1alpha.SearchTuningServiceClient.port;
      assert(port);
    ...
    it('invokes listCustomModels without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listCustomModels(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.discoveryengine.v1alpha.IListCustomModelsResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
