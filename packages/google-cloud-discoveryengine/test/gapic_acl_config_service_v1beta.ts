...
describe('v1beta.AclConfigServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client = new aclconfigserviceModule.v1beta.AclConfigServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          aclconfigserviceModule.v1beta.AclConfigServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          aclconfigserviceModule.v1beta.AclConfigServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'discoveryengine.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new aclconfigserviceModule.v1beta.AclConfigServiceClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'discoveryengine.example.com');
          if (saved) {
    ...
    it('has port', () => {
      const port = aclconfigserviceModule.v1beta.AclConfigServiceClient.port;
      assert(port);
  ...
  describe('updateAclConfig', () => {
    it('invokes updateAclConfig without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.UpdateAclConfigRequest(),
      );
      request.aclConfig ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.discoveryengine.v1beta.UpdateAclConfigRequest',
        ['aclConfig', 'name'],
      );
      request.aclConfig.name = defaultValue1;
      const expectedHeaderRequestParams = `acl_config.name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.AclConfig(),
      );
      ...
      const actualRequest = (
        client.innerApiCalls.updateAclConfig as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes updateAclConfig without error using callback', async () => {
      ...
      client.innerApiCalls.updateAclConfig =
      ...
      const promise = new Promise((resolve, reject) => {
        client.updateAclConfig(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.discoveryengine.v1beta.IAclConfig | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getAclConfig', () => {
    it('invokes getAclConfig without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.GetAclConfigRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.discoveryengine.v1beta.GetAclConfigRequest',
        ['name'],
      );
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getAclConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getAclConfig as SinonStub
    ...
    it('invokes getAclConfig without error using callback', async () => {
      ...
      client.innerApiCalls.getAclConfig =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getAclConfig(
          request,
