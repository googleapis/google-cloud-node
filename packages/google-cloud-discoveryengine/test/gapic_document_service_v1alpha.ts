  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          documentserviceModule.v1alpha.DocumentServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          documentserviceModule.v1alpha.DocumentServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'discoveryengine.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('invokes getDocument without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDocument(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.discoveryengine.v1alpha.IDocument | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchGetDocumentsMetadata without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchGetDocumentsMetadata(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.discoveryengine.v1alpha.IBatchGetDocumentsMetadataResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listDocuments', () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listDocuments(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.discoveryengine.v1alpha.IDocument[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listDocumentsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.discoveryengine.v1alpha.Document) => {
