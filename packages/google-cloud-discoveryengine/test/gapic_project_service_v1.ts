  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          projectserviceModule.v1.ProjectServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          projectserviceModule.v1.ProjectServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'discoveryengine.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new projectserviceModule.v1.ProjectServiceClient({
          universe_domain: 'example.com',
      ...
      const promise = new Promise((resolve, reject) => {
        client.provisionProject(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.discoveryengine.v1.IProject,
              protos.google.cloud.discoveryengine.v1.IProvisionProjectMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
