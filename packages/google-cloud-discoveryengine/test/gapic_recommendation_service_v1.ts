...
describe('v1.RecommendationServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new recommendationserviceModule.v1.RecommendationServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          recommendationserviceModule.v1.RecommendationServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        recommendationserviceModule.v1.RecommendationServiceClient.port;
      assert(port);
    ...
    it('invokes recommend without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.recommend(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.discoveryengine.v1.IRecommendResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
