...
describe('v1.ConversationalSearchServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new conversationalsearchserviceModule.v1.ConversationalSearchServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          conversationalsearchserviceModule.v1.ConversationalSearchServiceClient
            .servicePath;
    ...
    it('invokes converseConversation without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.converseConversation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.discoveryengine.v1.IConverseConversationResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createConversation without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createConversation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.discoveryengine.v1.IConversation | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes answerQuery without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.answerQuery(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.discoveryengine.v1.IAnswerQueryResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getAnswer without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getAnswer(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.discoveryengine.v1.IAnswer | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createSession without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createSession(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.discoveryengine.v1.ISession | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes streamAnswerQuery without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        stream.on(
          'data',
          (
            response: protos.google.cloud.discoveryengine.v1.AnswerQueryResponse,
          ) => {
            resolve(response);
          },
        );
  ...
  describe('listConversations', () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listConversations(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.discoveryengine.v1.IConversation[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listConversationsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.discoveryengine.v1.Conversation) => {
  ...
  describe('listSessions', () => {
    ...
    it('invokes listSessionsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.discoveryengine.v1.Session) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
