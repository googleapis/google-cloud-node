...
describe('v1beta.LicenseConfigServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          licenseconfigserviceModule.v1beta.LicenseConfigServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        licenseconfigserviceModule.v1beta.LicenseConfigServiceClient.port;
      assert(port);
  ...
  describe('createLicenseConfig', () => {
    it('invokes createLicenseConfig without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.CreateLicenseConfigRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.discoveryengine.v1beta.CreateLicenseConfigRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.LicenseConfig(),
      );
      client.innerApiCalls.createLicenseConfig =
        stubSimpleCall(expectedResponse);
      const [response] = await client.createLicenseConfig(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createLicenseConfig as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes createLicenseConfig without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createLicenseConfig(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.discoveryengine.v1beta.ILicenseConfig | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createLicenseConfig with error', async () => {
      ...
      client.innerApiCalls.createLicenseConfig = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateLicenseConfig', () => {
    it('invokes updateLicenseConfig without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.UpdateLicenseConfigRequest(),
      );
      request.licenseConfig ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.discoveryengine.v1beta.UpdateLicenseConfigRequest',
        ['licenseConfig', 'name'],
      );
      request.licenseConfig.name = defaultValue1;
      const expectedHeaderRequestParams = `license_config.name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.LicenseConfig(),
      );
      client.innerApiCalls.updateLicenseConfig =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateLicenseConfig(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateLicenseConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateLicenseConfig as SinonStub
    ...
    it('invokes updateLicenseConfig with error', async () => {
      ...
      const expectedHeaderRequestParams = `license_config.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateLicenseConfig = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getLicenseConfig', () => {
    it('invokes getLicenseConfig without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.GetLicenseConfigRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.discoveryengine.v1beta.GetLicenseConfigRequest',
        ['name'],
      );
      ...
      client.innerApiCalls.getLicenseConfig = stubSimpleCall(expectedResponse);
      const [response] = await client.getLicenseConfig(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getLicenseConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getLicenseConfig as SinonStub
    ...
    it('invokes getLicenseConfig without error using callback', async () => {
      ...
      client.innerApiCalls.getLicenseConfig =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes getLicenseConfig with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getLicenseConfig = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('distributeLicenseConfig', () => {
    it('invokes distributeLicenseConfig without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.DistributeLicenseConfigRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `billing_account_license_config=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.DistributeLicenseConfigResponse(),
      );
      client.innerApiCalls.distributeLicenseConfig =
        stubSimpleCall(expectedResponse);
      const [response] = await client.distributeLicenseConfig(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.distributeLicenseConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.distributeLicenseConfig as SinonStub
    ...
    it('invokes distributeLicenseConfig without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.distributeLicenseConfig(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.discoveryengine.v1beta.IDistributeLicenseConfigResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes distributeLicenseConfig with error', async () => {
      ...
      const expectedHeaderRequestParams = `billing_account_license_config=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.distributeLicenseConfig = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.distributeLicenseConfig(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.distributeLicenseConfig as SinonStub
  ...
  describe('retractLicenseConfig', () => {
    it('invokes retractLicenseConfig without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.RetractLicenseConfigRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `billing_account_license_config=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.RetractLicenseConfigResponse(),
      );
      client.innerApiCalls.retractLicenseConfig =
        stubSimpleCall(expectedResponse);
      const [response] = await client.retractLicenseConfig(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.retractLicenseConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.retractLicenseConfig as SinonStub
    ...
    it('invokes retractLicenseConfig without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.retractLicenseConfig(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.discoveryengine.v1beta.IRetractLicenseConfigResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes retractLicenseConfig with error', async () => {
      ...
      const expectedHeaderRequestParams = `billing_account_license_config=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.retractLicenseConfig = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listLicenseConfigs', () => {
    it('invokes listLicenseConfigs without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.discoveryengine.v1beta.ListLicenseConfigsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.listLicenseConfigs =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listLicenseConfigs(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listLicenseConfigs as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listLicenseConfigs as SinonStub
    ...
    it('invokes listLicenseConfigs without error using callback', async () => {
      ...
      client.innerApiCalls.listLicenseConfigs =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listLicenseConfigs(
          request,
          (
            err?: Error | null,
            result?:
              | protos.google.cloud.discoveryengine.v1beta.ILicenseConfig[]
              | null,
          ) => {
            if (err) {
              reject(err);
    ...
    it('invokes listLicenseConfigs with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listLicenseConfigs = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(client.listLicenseConfigs(request), expectedError);
      const actualRequest = (
        client.innerApiCalls.listLicenseConfigs as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
    ...
    it('invokes listLicenseConfigsStream without error', async () => {
      ...
      client.descriptors.page.listLicenseConfigs.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listLicenseConfigsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.discoveryengine.v1beta.LicenseConfig[] =
          [];
        stream.on(
          'data',
          (
            response: protos.google.cloud.discoveryengine.v1beta.LicenseConfig,
          ) => {
      ...
      assert(
        (client.descriptors.page.listLicenseConfigs.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listLicenseConfigs, request),
      );
      assert(
        (client.descriptors.page.listLicenseConfigs.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listLicenseConfigs without error', async () => {
      ...
      client.descriptors.page.listLicenseConfigs.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.discoveryengine.v1beta.ILicenseConfig[] =
        [];
      const iterable = client.listLicenseConfigsAsync(request);
  ...
  describe('Path templates', () => {
    ...
    describe('billingAccountLicenseConfig', async () => {
      const fakePath = '/rendered/path/billingAccountLicenseConfig';
      const expectedParameters = {
        billing_account: 'billingAccountValue',
        billing_account_license_config: 'billingAccountLicenseConfigValue',
      };
      const client =
        new licenseconfigserviceModule.v1beta.LicenseConfigServiceClient({
          credentials: { client_email: 'bogus', private_key: 'bogus' },
      ...
      await client.initialize();
      client.pathTemplates.billingAccountLicenseConfigPathTemplate.render =
        sinon.stub().returns(fakePath);
      client.pathTemplates.billingAccountLicenseConfigPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('billingAccountLicenseConfigPath', () => {
        const result = client.billingAccountLicenseConfigPath(
          'billingAccountValue',
          'billingAccountLicenseConfigValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.billingAccountLicenseConfigPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchBillingAccountFromBillingAccountLicenseConfigName', () => {
        const result =
          client.matchBillingAccountFromBillingAccountLicenseConfigName(
            fakePath,
          );
      ...
      it('matchBillingAccountLicenseConfigFromBillingAccountLicenseConfigName', () => {
        const result =
          client.matchBillingAccountLicenseConfigFromBillingAccountLicenseConfigName(
            fakePath,
          );
        assert.strictEqual(result, 'billingAccountLicenseConfigValue');
        assert(
          (
            client.pathTemplates.billingAccountLicenseConfigPathTemplate
              .match as SinonStub
