...
export class EngineServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const createEngineResponse = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1.Engine') as gax.protobuf.Type;
    const createEngineMetadata = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1.CreateEngineMetadata') as gax.protobuf.Type;
    const deleteEngineResponse = protoFilesRoot.lookup(
      '.google.protobuf.Empty') as gax.protobuf.Type;
    const deleteEngineMetadata = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1.DeleteEngineMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.discoveryengine.v1.EngineService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.engineServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.discoveryengine.v1.EngineService') :
 ...
 */
  updateEngine(
      ...
      Promise<[
        ...
        protos.google.cloud.discoveryengine.v1.IUpdateEngineRequest|undefined, {}|undefined
      ]>;
  updateEngine(
      request: protos.google.cloud.discoveryengine.v1.IUpdateEngineRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.discoveryengine.v1.IEngine,
          protos.google.cloud.discoveryengine.v1.IUpdateEngineRequest|null|undefined,
          {}|null|undefined>): void;
  updateEngine(
      request: protos.google.cloud.discoveryengine.v1.IUpdateEngineRequest,
      callback: Callback<
 ...
 */
  getEngine(
      ...
      Promise<[
        protos.google.cloud.discoveryengine.v1.IEngine,
        protos.google.cloud.discoveryengine.v1.IGetEngineRequest|undefined, {}|undefined
      ]>;
  getEngine(
      request: protos.google.cloud.discoveryengine.v1.IGetEngineRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.discoveryengine.v1.IEngine,
          protos.google.cloud.discoveryengine.v1.IGetEngineRequest|null|undefined,
          {}|null|undefined>): void;
  getEngine(
      request: protos.google.cloud.discoveryengine.v1.IGetEngineRequest,
      callback: Callback<
 ...
 * region_tag:discoveryengine_v1_generated_EngineService_CreateEngine_async
 */
  async checkCreateEngineProgress(name: string): Promise<LROperation<protos.google.cloud.discoveryengine.v1.Engine, protos.google.cloud.discoveryengine.v1.CreateEngineMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.discoveryengine.v1.Engine, protos.google.cloud.discoveryengine.v1.CreateEngineMetadata>;
  }
/**
 ...
 * region_tag:discoveryengine_v1_generated_EngineService_DeleteEngine_async
 */
  async checkDeleteEngineProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.discoveryengine.v1.DeleteEngineMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.protobuf.Empty, protos.google.cloud.discoveryengine.v1.DeleteEngineMetadata>;
  }
 /**
 ...
 */
  ...
  listEngines(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.discoveryengine.v1.IListEnginesResponse|null|undefined,
          protos.google.cloud.discoveryengine.v1.IEngine>): void;
  listEngines(
      request: protos.google.cloud.discoveryengine.v1.IListEnginesRequest,
      callback: PaginationCallback<
          protos.google.cloud.discoveryengine.v1.IListEnginesRequest,
  ...
  listEngines(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.discoveryengine.v1.IListEnginesRequest,
      protos.google.cloud.discoveryengine.v1.IListEnginesResponse|null|undefined,
      protos.google.cloud.discoveryengine.v1.IEngine>|undefined = callback
