...
export class UserLicenseServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this.descriptors.page = {
      listUserLicenses:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'userLicenses')
    };
    ...
    const batchUpdateUserLicensesResponse = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1.BatchUpdateUserLicensesResponse') as gax.protobuf.Type;
    const batchUpdateUserLicensesMetadata = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1.BatchUpdateUserLicensesMetadata') as gax.protobuf.Type;

    this.descriptors.longrunning = {
      batchUpdateUserLicenses: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        batchUpdateUserLicensesResponse.decode.bind(batchUpdateUserLicensesResponse),
        batchUpdateUserLicensesMetadata.decode.bind(batchUpdateUserLicensesMetadata))
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.discoveryengine.v1.UserLicenseService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.userLicenseServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.discoveryengine.v1.UserLicenseService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.discoveryengine.v1.UserLicenseService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const userLicenseServiceStubMethods =
        ['listUserLicenses', 'batchUpdateUserLicenses'];
 ...
 */
  batchUpdateUserLicenses(
      request?: protos.google.cloud.discoveryengine.v1.IBatchUpdateUserLicensesRequest,
      options?: CallOptions):
      Promise<[
 ...
 * region_tag:discoveryengine_v1_generated_UserLicenseService_BatchUpdateUserLicenses_async
 */
  async checkBatchUpdateUserLicensesProgress(name: string): Promise<LROperation<protos.google.cloud.discoveryengine.v1.BatchUpdateUserLicensesResponse, protos.google.cloud.discoveryengine.v1.BatchUpdateUserLicensesMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.discoveryengine.v1.BatchUpdateUserLicensesResponse, protos.google.cloud.discoveryengine.v1.BatchUpdateUserLicensesMetadata>;
  }
 /**
 ...
 */
  listUserLicenses(
      request?: protos.google.cloud.discoveryengine.v1.IListUserLicensesRequest,
      options?: CallOptions):
      Promise<[
  ...
  listUserLicenses(
      ...
      callback: PaginationCallback<
          protos.google.cloud.discoveryengine.v1.IListUserLicensesRequest,
          protos.google.cloud.discoveryengine.v1.IListUserLicensesResponse|null|undefined,
          protos.google.cloud.discoveryengine.v1.IUserLicense>): void;
  listUserLicenses(
      request: protos.google.cloud.discoveryengine.v1.IListUserLicensesRequest,
      callback: PaginationCallback<
          protos.google.cloud.discoveryengine.v1.IListUserLicensesRequest,
  ...
  listUserLicenses(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.discoveryengine.v1.IListUserLicensesRequest,
      protos.google.cloud.discoveryengine.v1.IListUserLicensesResponse|null|undefined,
      protos.google.cloud.discoveryengine.v1.IUserLicense>|undefined = callback
 ...
 */
  listUserLicensesStream(
    ...
    return this.descriptors.page.listUserLicenses.createStream(
      this.innerApiCalls.listUserLicenses as GaxCall,
      request,
      callSettings
    );
  }
 ...
 */
  listUserLicensesAsync(
      request?: protos.google.cloud.discoveryengine.v1.IListUserLicensesRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.discoveryengine.v1.IUserLicense>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listUserLicenses.asyncIterate(
      this.innerApiCalls['listUserLicenses'] as GaxCall,
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.discoveryengine.v1.IUserLicense>;
  }
/**
