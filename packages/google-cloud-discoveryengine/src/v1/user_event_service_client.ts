...
export class UserEventServiceClient {
  ...
  constructor(
    ...
    const purgeUserEventsMetadata = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1.PurgeUserEventsMetadata'
    ) as gax.protobuf.Type;
  ...
  async checkPurgeUserEventsProgress(
    ...
    LROperation<
      protos.google.cloud.discoveryengine.v1.PurgeUserEventsResponse,
      protos.google.cloud.discoveryengine.v1.PurgeUserEventsMetadata
    >
  > {
    const request =
