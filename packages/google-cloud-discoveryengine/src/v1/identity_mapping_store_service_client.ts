...
export class IdentityMappingStoreServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof IdentityMappingStoreServiceClient;
    ...
    this.descriptors.page = {
      listIdentityMappings:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'identityMappingEntries'),
      listIdentityMappingStores:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'identityMappingStores')
    };
    ...
    const deleteIdentityMappingStoreMetadata = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1.DeleteIdentityMappingStoreMetadata') as gax.protobuf.Type;
    const importIdentityMappingsResponse = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1.ImportIdentityMappingsResponse') as gax.protobuf.Type;
    const importIdentityMappingsMetadata = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1.IdentityMappingEntryOperationMetadata') as gax.protobuf.Type;
    ...
    this.descriptors.longrunning = {
      deleteIdentityMappingStore: new this._gaxModule.LongrunningDescriptor(
        ...
        deleteIdentityMappingStoreResponse.decode.bind(deleteIdentityMappingStoreResponse),
        deleteIdentityMappingStoreMetadata.decode.bind(deleteIdentityMappingStoreMetadata)),
      importIdentityMappings: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        importIdentityMappingsResponse.decode.bind(importIdentityMappingsResponse),
        importIdentityMappingsMetadata.decode.bind(importIdentityMappingsMetadata)),
      purgeIdentityMappings: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        purgeIdentityMappingsResponse.decode.bind(purgeIdentityMappingsResponse),
        purgeIdentityMappingsMetadata.decode.bind(purgeIdentityMappingsMetadata))
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.discoveryengine.v1.IdentityMappingStoreService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.identityMappingStoreServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.discoveryengine.v1.IdentityMappingStoreService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.discoveryengine.v1.IdentityMappingStoreService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const identityMappingStoreServiceStubMethods =
        ['createIdentityMappingStore', 'getIdentityMappingStore', 'deleteIdentityMappingStore', 'importIdentityMappings', 'purgeIdentityMappings', 'listIdentityMappings', 'listIdentityMappingStores'];
 ...
 */
  createIdentityMappingStore(
      ...
      Promise<[
        ...
        protos.google.cloud.discoveryengine.v1.ICreateIdentityMappingStoreRequest|undefined, {}|undefined
      ]>;
  createIdentityMappingStore(
      request: protos.google.cloud.discoveryengine.v1.ICreateIdentityMappingStoreRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.discoveryengine.v1.IIdentityMappingStore,
          protos.google.cloud.discoveryengine.v1.ICreateIdentityMappingStoreRequest|null|undefined,
          {}|null|undefined>): void;
  createIdentityMappingStore(
      request: protos.google.cloud.discoveryengine.v1.ICreateIdentityMappingStoreRequest,
      callback: Callback<
 ...
 */
  getIdentityMappingStore(
      ...
      Promise<[
        protos.google.cloud.discoveryengine.v1.IIdentityMappingStore,
        protos.google.cloud.discoveryengine.v1.IGetIdentityMappingStoreRequest|undefined, {}|undefined
      ]>;
  getIdentityMappingStore(
      request: protos.google.cloud.discoveryengine.v1.IGetIdentityMappingStoreRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.discoveryengine.v1.IIdentityMappingStore,
          protos.google.cloud.discoveryengine.v1.IGetIdentityMappingStoreRequest|null|undefined,
          {}|null|undefined>): void;
  getIdentityMappingStore(
      request: protos.google.cloud.discoveryengine.v1.IGetIdentityMappingStoreRequest,
      callback: Callback<
 ...
 * region_tag:discoveryengine_v1_generated_IdentityMappingStoreService_DeleteIdentityMappingStore_async
 */
  async checkDeleteIdentityMappingStoreProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.discoveryengine.v1.DeleteIdentityMappingStoreMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.protobuf.Empty, protos.google.cloud.discoveryengine.v1.DeleteIdentityMappingStoreMetadata>;
  }
/**
 ...
 * region_tag:discoveryengine_v1_generated_IdentityMappingStoreService_ImportIdentityMappings_async
 */
  async checkImportIdentityMappingsProgress(name: string): Promise<LROperation<protos.google.cloud.discoveryengine.v1.ImportIdentityMappingsResponse, protos.google.cloud.discoveryengine.v1.IdentityMappingEntryOperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.discoveryengine.v1.ImportIdentityMappingsResponse, protos.google.cloud.discoveryengine.v1.IdentityMappingEntryOperationMetadata>;
  }
/**
 ...
 * region_tag:discoveryengine_v1_generated_IdentityMappingStoreService_PurgeIdentityMappings_async
 */
  async checkPurgeIdentityMappingsProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.discoveryengine.v1.IdentityMappingEntryOperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.protobuf.Empty, protos.google.cloud.discoveryengine.v1.IdentityMappingEntryOperationMetadata>;
  }
 /**
 ...
 */
  ...
  listIdentityMappings(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.discoveryengine.v1.IListIdentityMappingsResponse|null|undefined,
          protos.google.cloud.discoveryengine.v1.IIdentityMappingEntry>): void;
  listIdentityMappings(
      request: protos.google.cloud.discoveryengine.v1.IListIdentityMappingsRequest,
      callback: PaginationCallback<
          protos.google.cloud.discoveryengine.v1.IListIdentityMappingsRequest,
  ...
  listIdentityMappings(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.discoveryengine.v1.IListIdentityMappingsRequest,
      protos.google.cloud.discoveryengine.v1.IListIdentityMappingsResponse|null|undefined,
      protos.google.cloud.discoveryengine.v1.IIdentityMappingEntry>|undefined = callback
 ...
 */
  ...
  listIdentityMappingStores(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.discoveryengine.v1.IListIdentityMappingStoresResponse|null|undefined,
          protos.google.cloud.discoveryengine.v1.IIdentityMappingStore>): void;
  listIdentityMappingStores(
      request: protos.google.cloud.discoveryengine.v1.IListIdentityMappingStoresRequest,
      callback: PaginationCallback<
          protos.google.cloud.discoveryengine.v1.IListIdentityMappingStoresRequest,
  ...
  listIdentityMappingStores(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.discoveryengine.v1.IListIdentityMappingStoresRequest,
      protos.google.cloud.discoveryengine.v1.IListIdentityMappingStoresResponse|null|undefined,
      protos.google.cloud.discoveryengine.v1.IIdentityMappingStore>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
