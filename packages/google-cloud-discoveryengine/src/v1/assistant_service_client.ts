 ...
 */
import * as gapicConfig from './assistant_service_client_config.json';
...
export class AssistantServiceClient {
  ...
  assistantServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof AssistantServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.discoveryengine.v1.AssistantService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.assistantServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.discoveryengine.v1.AssistantService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.discoveryengine.v1.AssistantService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const assistantServiceStubMethods =
        ['streamAssist'];
 ...
 */
  streamAssist(
      request?: protos.google.cloud.discoveryengine.v1.IStreamAssistRequest,
      options?: CallOptions):
