...
export class ProjectServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const provisionProjectResponse = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1.Project') as gax.protobuf.Type;
    const provisionProjectMetadata = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1.ProvisionProjectMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.discoveryengine.v1.ProjectService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.projectServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.discoveryengine.v1.ProjectService') :
 ...
 * region_tag:discoveryengine_v1_generated_ProjectService_ProvisionProject_async
 */
  async checkProvisionProjectProgress(name: string): Promise<LROperation<protos.google.cloud.discoveryengine.v1.Project, protos.google.cloud.discoveryengine.v1.ProvisionProjectMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.discoveryengine.v1.Project, protos.google.cloud.discoveryengine.v1.ProvisionProjectMetadata>;
  }
/**
