...
export class RecommendationServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.discoveryengine.v1.RecommendationService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.recommendationServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.discoveryengine.v1.RecommendationService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.discoveryengine.v1.RecommendationService,
 ...
 */
  recommend(
      request?: protos.google.cloud.discoveryengine.v1.IRecommendRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.discoveryengine.v1.IRecommendResponse,
        protos.google.cloud.discoveryengine.v1.IRecommendRequest|undefined, {}|undefined
      ]>;
  recommend(
      request: protos.google.cloud.discoveryengine.v1.IRecommendRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.discoveryengine.v1.IRecommendResponse,
          protos.google.cloud.discoveryengine.v1.IRecommendRequest|null|undefined,
          {}|null|undefined>): void;
  recommend(
      request: protos.google.cloud.discoveryengine.v1.IRecommendRequest,
      callback: Callback<
