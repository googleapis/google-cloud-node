...
export class EvaluationServiceClient {
  ...
  constructor(
    ...
    const createEvaluationMetadata = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1beta.CreateEvaluationMetadata',
    ) as gax.protobuf.Type;
  ...
  getEvaluation(
    ...
    [
      ...
      (
        | protos.google.cloud.discoveryengine.v1beta.IGetEvaluationRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  async checkCreateEvaluationProgress(
    ...
    LROperation<
      protos.google.cloud.discoveryengine.v1beta.Evaluation,
      protos.google.cloud.discoveryengine.v1beta.CreateEvaluationMetadata
    >
  > {
   ...
   *
   *   If the caller does not have permission to list
   *   {@link protos.google.cloud.discoveryengine.v1beta.ListEvaluationResultsResponse.EvaluationResult|ListEvaluationResultsResponse.EvaluationResult}
