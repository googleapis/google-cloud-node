...
export class EvaluationServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const createEvaluationResponse = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1beta.Evaluation') as gax.protobuf.Type;
    const createEvaluationMetadata = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1beta.CreateEvaluationMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.discoveryengine.v1beta.EvaluationService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.evaluationServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.discoveryengine.v1beta.EvaluationService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.discoveryengine.v1beta.EvaluationService,
 ...
 */
  getEvaluation(
      request?: protos.google.cloud.discoveryengine.v1beta.IGetEvaluationRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.discoveryengine.v1beta.IEvaluation,
        protos.google.cloud.discoveryengine.v1beta.IGetEvaluationRequest|undefined, {}|undefined
      ]>;
  getEvaluation(
      request: protos.google.cloud.discoveryengine.v1beta.IGetEvaluationRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.discoveryengine.v1beta.IEvaluation,
          protos.google.cloud.discoveryengine.v1beta.IGetEvaluationRequest|null|undefined,
          {}|null|undefined>): void;
  getEvaluation(
      request: protos.google.cloud.discoveryengine.v1beta.IGetEvaluationRequest,
      callback: Callback<
 ...
 */
  createEvaluation(
      request?: protos.google.cloud.discoveryengine.v1beta.ICreateEvaluationRequest,
      options?: CallOptions):
      Promise<[
 ...
 * region_tag:discoveryengine_v1beta_generated_EvaluationService_CreateEvaluation_async
 */
  async checkCreateEvaluationProgress(name: string): Promise<LROperation<protos.google.cloud.discoveryengine.v1beta.Evaluation, protos.google.cloud.discoveryengine.v1beta.CreateEvaluationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.discoveryengine.v1beta.Evaluation, protos.google.cloud.discoveryengine.v1beta.CreateEvaluationMetadata>;
  }
 /**
 * Gets a list of
 * {@link protos.google.cloud.discoveryengine.v1beta.Evaluation|Evaluation}s.
 ...
 */
  listEvaluations(
      request?: protos.google.cloud.discoveryengine.v1beta.IListEvaluationsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.discoveryengine.v1beta.IEvaluation[],
  ...
  listEvaluations(
      ...
      callback: PaginationCallback<
          protos.google.cloud.discoveryengine.v1beta.IListEvaluationsRequest,
          protos.google.cloud.discoveryengine.v1beta.IListEvaluationsResponse|null|undefined,
          protos.google.cloud.discoveryengine.v1beta.IEvaluation>): void;
  listEvaluations(
      request: protos.google.cloud.discoveryengine.v1beta.IListEvaluationsRequest,
      callback: PaginationCallback<
          protos.google.cloud.discoveryengine.v1beta.IListEvaluationsRequest,
  ...
  listEvaluations(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.discoveryengine.v1beta.IListEvaluationsRequest,
      protos.google.cloud.discoveryengine.v1beta.IListEvaluationsResponse|null|undefined,
      protos.google.cloud.discoveryengine.v1beta.IEvaluation>|undefined = callback
 ...
 */
  listEvaluationsAsync(
      request?: protos.google.cloud.discoveryengine.v1beta.IListEvaluationsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.discoveryengine.v1beta.IEvaluation>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listEvaluations.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.discoveryengine.v1beta.IEvaluation>;
  }
 /**
 ...
 */
  listEvaluationResults(
      request?: protos.google.cloud.discoveryengine.v1beta.IListEvaluationResultsRequest,
      options?: CallOptions):
      Promise<[
  ...
  listEvaluationResults(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.discoveryengine.v1beta.IListEvaluationResultsResponse|null|undefined,
          protos.google.cloud.discoveryengine.v1beta.ListEvaluationResultsResponse.IEvaluationResult>): void;
  listEvaluationResults(
      request: protos.google.cloud.discoveryengine.v1beta.IListEvaluationResultsRequest,
      callback: PaginationCallback<
          protos.google.cloud.discoveryengine.v1beta.IListEvaluationResultsRequest,
  ...
  listEvaluationResults(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.discoveryengine.v1beta.IListEvaluationResultsRequest,
      protos.google.cloud.discoveryengine.v1beta.IListEvaluationResultsResponse|null|undefined,
      protos.google.cloud.discoveryengine.v1beta.ListEvaluationResultsResponse.IEvaluationResult>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
 ...
 */
  listEvaluationResultsAsync(
      request?: protos.google.cloud.discoveryengine.v1beta.IListEvaluationResultsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.discoveryengine.v1beta.ListEvaluationResultsResponse.IEvaluationResult>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listEvaluationResults.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.discoveryengine.v1beta.ListEvaluationResultsResponse.IEvaluationResult>;
  }
/**
