...
export class UserEventServiceClient {
   ...
   *   with {@link protos.google.cloud.discoveryengine.v1beta.Document|Document} across
   *   multiple {@link protos.google.cloud.discoveryengine.v1beta.DataStore|DataStore}, the
