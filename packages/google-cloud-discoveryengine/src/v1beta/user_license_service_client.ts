 ...
 * `src/v1beta/user_license_service_client_config.json`.
...
export class UserLicenseServiceClient {
  ...
  constructor(
    ...
    const batchUpdateUserLicensesMetadata = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1beta.BatchUpdateUserLicensesMetadata',
    ) as gax.protobuf.Type;
  ...
  /**
   * Lists all the
   * {@link protos.google.cloud.discoveryengine.v1beta.LicenseConfigUsageStats|LicenseConfigUsageStats}s
   ...
   *   The first element of the array is an object representing {@link protos.google.cloud.discoveryengine.v1beta.ListLicenseConfigsUsageStatsResponse|ListLicenseConfigsUsageStatsResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/user_license_service.list_license_configs_usage_stats.js</caption>
   * region_tag:discoveryengine_v1beta_generated_UserLicenseService_ListLicenseConfigsUsageStats_async
   */
  listLicenseConfigsUsageStats(
    request?: protos.google.cloud.discoveryengine.v1beta.IListLicenseConfigsUsageStatsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.discoveryengine.v1beta.IListLicenseConfigsUsageStatsResponse,
      (
        | protos.google.cloud.discoveryengine.v1beta.IListLicenseConfigsUsageStatsRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('listLicenseConfigsUsageStats response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .listLicenseConfigsUsageStats(request, options, wrappedCallback)
      ?.then(
   ...
   * @param {Object} request
   *   The request object that will be sent.
   * @param {google.cloud.discoveryengine.v1beta.BatchUpdateUserLicensesRequest.InlineSource} request.inlineSource
   *   The inline source for the input content for document embeddings.
   * @param {string} request.parent
   *   Required. The parent
   *   {@link protos.google.cloud.discoveryengine.v1beta.UserStore|UserStore} resource name,
   *   format:
   *   `projects/{project}/locations/{location}/userStores/{user_store_id}`.
   ...
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/user_license_service.batch_update_user_licenses.js</caption>
   * region_tag:discoveryengine_v1beta_generated_UserLicenseService_BatchUpdateUserLicenses_async
   */
  batchUpdateUserLicenses(
    request?: protos.google.cloud.discoveryengine.v1beta.IBatchUpdateUserLicensesRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<
        protos.google.cloud.discoveryengine.v1beta.IBatchUpdateUserLicensesResponse,
        protos.google.cloud.discoveryengine.v1beta.IBatchUpdateUserLicensesMetadata
      >,
  ...
  async checkBatchUpdateUserLicensesProgress(
    ...
    LROperation<
      protos.google.cloud.discoveryengine.v1beta.BatchUpdateUserLicensesResponse,
      protos.google.cloud.discoveryengine.v1beta.BatchUpdateUserLicensesMetadata
    >
  > {
   ...
   *   {@link protos.google.cloud.discoveryengine.v1beta.UserLicense|UserLicense}s are listed.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of {@link protos.google.cloud.discoveryengine.v1beta.UserLicense|UserLicense}.
   ...
   */
  listUserLicenses(
    request?: protos.google.cloud.discoveryengine.v1beta.IListUserLicensesRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.discoveryengine.v1beta.IUserLicense[],
      protos.google.cloud.discoveryengine.v1beta.IListUserLicensesRequest | null,
      protos.google.cloud.discoveryengine.v1beta.IListUserLicensesResponse,
    ]
  >;
  listUserLicenses(
    request: protos.google.cloud.discoveryengine.v1beta.IListUserLicensesRequest,
    ...
    callback: PaginationCallback<
      protos.google.cloud.discoveryengine.v1beta.IListUserLicensesRequest,
      | protos.google.cloud.discoveryengine.v1beta.IListUserLicensesResponse
      | null
      | undefined,
      protos.google.cloud.discoveryengine.v1beta.IUserLicense
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing {@link protos.google.cloud.discoveryengine.v1beta.UserLicense|UserLicense} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
   ...
   *   {@link protos.google.cloud.discoveryengine.v1beta.UserLicense|UserLicense}. The API will be called under the hood as needed, once per the page,
   *   so you can stop the iteration when you don't need more results.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/user_license_service.list_user_licenses.js</caption>
   * region_tag:discoveryengine_v1beta_generated_UserLicenseService_ListUserLicenses_async
   */
  listUserLicensesAsync(
    request?: protos.google.cloud.discoveryengine.v1beta.IListUserLicensesRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.cloud.discoveryengine.v1beta.IUserLicense> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listUserLicenses.asyncIterate(
      ...
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.cloud.discoveryengine.v1beta.IUserLicense>;
  }
