 ...
 * `src/v1beta/cmek_config_service_client_config.json`.
...
export class CmekConfigServiceClient {
  ...
  constructor(
    ...
    const updateCmekConfigResponse = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1beta.CmekConfig',
    ) as gax.protobuf.Type;
    const updateCmekConfigMetadata = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1beta.UpdateCmekConfigMetadata',
    ) as gax.protobuf.Type;
    const deleteCmekConfigResponse = protoFilesRoot.lookup(
      '.google.protobuf.Empty',
    ) as gax.protobuf.Type;
    const deleteCmekConfigMetadata = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1beta.DeleteCmekConfigMetadata',
    ) as gax.protobuf.Type;
  ...
  // -------------------
  /**
   * Gets the {@link protos.google.cloud.discoveryengine.v1beta.CmekConfig|CmekConfig}.
   *
   * @param {Object} request
   *   The request object that will be sent.
   * @param {string} request.name
   *   Required. Resource name of
   *   {@link protos.google.cloud.discoveryengine.v1beta.CmekConfig|CmekConfig}, such as
   *   `projects/* /locations/* /cmekConfig` or
   *   `projects/* /locations/* /cmekConfigs/*`.
   *
   *   If the caller does not have permission to access the
   *   {@link protos.google.cloud.discoveryengine.v1beta.CmekConfig|CmekConfig}, regardless of
   *   whether or not it exists, a PERMISSION_DENIED error is returned.
   * @param {object} [options]
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.cloud.discoveryengine.v1beta.CmekConfig|CmekConfig}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/cmek_config_service.get_cmek_config.js</caption>
   * region_tag:discoveryengine_v1beta_generated_CmekConfigService_GetCmekConfig_async
   */
  getCmekConfig(
    request?: protos.google.cloud.discoveryengine.v1beta.IGetCmekConfigRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.discoveryengine.v1beta.ICmekConfig,
      (
        | protos.google.cloud.discoveryengine.v1beta.IGetCmekConfigRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  /**
   * Lists all the {@link protos.google.cloud.discoveryengine.v1beta.CmekConfig|CmekConfig}s
   * with the project.
   *
   * @param {Object} request
   *   The request object that will be sent.
   ...
   *   {@link protos.google.cloud.discoveryengine.v1beta.CmekConfig|CmekConfig}s under this
   *   location, regardless of whether or not a CmekConfig exists, a
   *   PERMISSION_DENIED error is returned.
   * @param {object} [options]
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.cloud.discoveryengine.v1beta.ListCmekConfigsResponse|ListCmekConfigsResponse}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/cmek_config_service.list_cmek_configs.js</caption>
   * region_tag:discoveryengine_v1beta_generated_CmekConfigService_ListCmekConfigs_async
   */
  listCmekConfigs(
    request?: protos.google.cloud.discoveryengine.v1beta.IListCmekConfigsRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.discoveryengine.v1beta.IListCmekConfigsResponse,
      (
        | protos.google.cloud.discoveryengine.v1beta.IListCmekConfigsRequest
        | undefined
      ),
      {} | undefined,
    ]
   ...
   * @param {Object} request
   *   The request object that will be sent.
   * @param {google.cloud.discoveryengine.v1beta.CmekConfig} request.config
   ...
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/cmek_config_service.update_cmek_config.js</caption>
   * region_tag:discoveryengine_v1beta_generated_CmekConfigService_UpdateCmekConfig_async
   */
  updateCmekConfig(
    request?: protos.google.cloud.discoveryengine.v1beta.IUpdateCmekConfigRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<
        protos.google.cloud.discoveryengine.v1beta.ICmekConfig,
        protos.google.cloud.discoveryengine.v1beta.IUpdateCmekConfigMetadata
      >,
  ...
  async checkUpdateCmekConfigProgress(
    ...
    LROperation<
      protos.google.cloud.discoveryengine.v1beta.CmekConfig,
      protos.google.cloud.discoveryengine.v1beta.UpdateCmekConfigMetadata
    >
  > {
   ...
   *   {@link protos.google.cloud.discoveryengine.v1beta.CmekConfig|CmekConfig} to delete,
   *   such as
   *   `projects/{project}/locations/{location}/cmekConfigs/{cmek_config}`.
   * @param {object} [options]
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/cmek_config_service.delete_cmek_config.js</caption>
   * region_tag:discoveryengine_v1beta_generated_CmekConfigService_DeleteCmekConfig_async
   */
  deleteCmekConfig(
    request?: protos.google.cloud.discoveryengine.v1beta.IDeleteCmekConfigRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<
        protos.google.protobuf.IEmpty,
        protos.google.cloud.discoveryengine.v1beta.IDeleteCmekConfigMetadata
      >,
      protos.google.longrunning.IOperation | undefined,
      {} | undefined,
    ]
  ...
  async checkDeleteCmekConfigProgress(
    ...
    LROperation<
      ...
      protos.google.cloud.discoveryengine.v1beta.DeleteCmekConfigMetadata
    >
  > {
