 ...
 * `src/v1beta/user_store_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './user_store_service_client_config.json';
 ...
 * @memberof v1beta
 */
export class UserStoreServiceClient {
  ...
  userStoreServiceStub?: Promise<{ [name: string]: Function }>;

  /**
   * Construct an instance of UserStoreServiceClient.
   *
   ...
   *     const client = new UserStoreServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(
    opts?: ClientOptions,
    ...
    const staticMembers = this.constructor as typeof UserStoreServiceClient;
    if (
  ...
  initialize() {
    ...
    if (this.userStoreServiceStub) {
      return this.userStoreServiceStub;
    }

    // Put together the "service stub" for
    // google.cloud.discoveryengine.v1beta.UserStoreService.
    this.userStoreServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
    ...
    for (const methodName of userStoreServiceStubMethods) {
      const callPromise = this.userStoreServiceStub.then(
        (stub) =>
          (...args: Array<{}>) => {
            if (this._terminated) {
   ...
   *   The first element of the array is an object representing {@link protos.google.cloud.discoveryengine.v1beta.UserStore|UserStore}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/user_store_service.get_user_store.js</caption>
   * region_tag:discoveryengine_v1beta_generated_UserStoreService_GetUserStore_async
   */
  getUserStore(
    request?: protos.google.cloud.discoveryengine.v1beta.IGetUserStoreRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.discoveryengine.v1beta.IUserStore,
      (
        | protos.google.cloud.discoveryengine.v1beta.IGetUserStoreRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('getUserStore response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .getUserStore(request, options, wrappedCallback)
      ?.then(
   ...
   * @param {Object} request
   *   The request object that will be sent.
   * @param {google.cloud.discoveryengine.v1beta.UserStore} request.userStore
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/user_store_service.update_user_store.js</caption>
   * region_tag:discoveryengine_v1beta_generated_UserStoreService_UpdateUserStore_async
   */
  updateUserStore(
    request?: protos.google.cloud.discoveryengine.v1beta.IUpdateUserStoreRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.discoveryengine.v1beta.IUserStore,
      (
        | protos.google.cloud.discoveryengine.v1beta.IUpdateUserStoreRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('updateUserStore response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .updateUserStore(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.cloud.discoveryengine.v1beta.IUserStore,
          (
