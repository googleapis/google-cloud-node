...
export class ProjectServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const provisionProjectResponse = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1beta.Project') as gax.protobuf.Type;
    const provisionProjectMetadata = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1beta.ProvisionProjectMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.discoveryengine.v1beta.ProjectService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.projectServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.discoveryengine.v1beta.ProjectService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.discoveryengine.v1beta.ProjectService,
 ...
 * region_tag:discoveryengine_v1beta_generated_ProjectService_ProvisionProject_async
 */
  async checkProvisionProjectProgress(name: string): Promise<LROperation<protos.google.cloud.discoveryengine.v1beta.Project, protos.google.cloud.discoveryengine.v1beta.ProvisionProjectMetadata>>{
    this._log.info('provisionProject long-running');
    ...
    return decodeOperation as LROperation<protos.google.cloud.discoveryengine.v1beta.Project, protos.google.cloud.discoveryengine.v1beta.ProvisionProjectMetadata>;
  }
/**
