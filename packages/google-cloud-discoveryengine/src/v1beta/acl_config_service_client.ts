 ...
 * `src/v1beta/acl_config_service_client_config.json`.
...
export class AclConfigServiceClient {
   ...
   * @param {google.cloud.discoveryengine.v1beta.AclConfig} request.aclConfig
   * @param {object} [options]
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing {@link protos.google.cloud.discoveryengine.v1beta.AclConfig|AclConfig}.
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/acl_config_service.update_acl_config.js</caption>
   * region_tag:discoveryengine_v1beta_generated_AclConfigService_UpdateAclConfig_async
   */
  updateAclConfig(
    request?: protos.google.cloud.discoveryengine.v1beta.IUpdateAclConfigRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.discoveryengine.v1beta.IAclConfig,
      (
        | protos.google.cloud.discoveryengine.v1beta.IUpdateAclConfigRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  /**
   * Gets the {@link protos.google.cloud.discoveryengine.v1beta.AclConfig|AclConfig}.
   *
   * @param {Object} request
   *   The request object that will be sent.
   * @param {string} request.name
   *   Required. Resource name of
   *   {@link protos.google.cloud.discoveryengine.v1beta.AclConfig|AclConfig}, such as
   *   `projects/* /locations/* /aclConfig`.
   *
   *   If the caller does not have permission to access the
   *   {@link protos.google.cloud.discoveryengine.v1beta.AclConfig|AclConfig}, regardless of
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1beta/acl_config_service.get_acl_config.js</caption>
   * region_tag:discoveryengine_v1beta_generated_AclConfigService_GetAclConfig_async
   */
  getAclConfig(
    request?: protos.google.cloud.discoveryengine.v1beta.IGetAclConfigRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.discoveryengine.v1beta.IAclConfig,
      (
        | protos.google.cloud.discoveryengine.v1beta.IGetAclConfigRequest
        | undefined
      ),
      {} | undefined,
    ]
