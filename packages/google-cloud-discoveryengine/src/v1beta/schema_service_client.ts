...
export class SchemaServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const createSchemaResponse = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1beta.Schema') as gax.protobuf.Type;
    const createSchemaMetadata = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1beta.CreateSchemaMetadata') as gax.protobuf.Type;
    const updateSchemaResponse = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1beta.Schema') as gax.protobuf.Type;
    const updateSchemaMetadata = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1beta.UpdateSchemaMetadata') as gax.protobuf.Type;
    const deleteSchemaResponse = protoFilesRoot.lookup(
      '.google.protobuf.Empty') as gax.protobuf.Type;
    const deleteSchemaMetadata = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1beta.DeleteSchemaMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.discoveryengine.v1beta.SchemaService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.schemaServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.discoveryengine.v1beta.SchemaService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.discoveryengine.v1beta.SchemaService,
 ...
 */
  getSchema(
      ...
      Promise<[
        ...
        protos.google.cloud.discoveryengine.v1beta.IGetSchemaRequest|undefined, {}|undefined
      ]>;
  getSchema(
      request: protos.google.cloud.discoveryengine.v1beta.IGetSchemaRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.discoveryengine.v1beta.ISchema,
          protos.google.cloud.discoveryengine.v1beta.IGetSchemaRequest|null|undefined,
          {}|null|undefined>): void;
  getSchema(
      request: protos.google.cloud.discoveryengine.v1beta.IGetSchemaRequest,
      callback: Callback<
 ...
 * region_tag:discoveryengine_v1beta_generated_SchemaService_CreateSchema_async
 */
  async checkCreateSchemaProgress(name: string): Promise<LROperation<protos.google.cloud.discoveryengine.v1beta.Schema, protos.google.cloud.discoveryengine.v1beta.CreateSchemaMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.discoveryengine.v1beta.Schema, protos.google.cloud.discoveryengine.v1beta.CreateSchemaMetadata>;
  }
/**
 ...
 * region_tag:discoveryengine_v1beta_generated_SchemaService_UpdateSchema_async
 */
  async checkUpdateSchemaProgress(name: string): Promise<LROperation<protos.google.cloud.discoveryengine.v1beta.Schema, protos.google.cloud.discoveryengine.v1beta.UpdateSchemaMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.discoveryengine.v1beta.Schema, protos.google.cloud.discoveryengine.v1beta.UpdateSchemaMetadata>;
  }
/**
 ...
 * region_tag:discoveryengine_v1beta_generated_SchemaService_DeleteSchema_async
 */
  async checkDeleteSchemaProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.discoveryengine.v1beta.DeleteSchemaMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.protobuf.Empty, protos.google.cloud.discoveryengine.v1beta.DeleteSchemaMetadata>;
  }
 /**
 ...
 */
  ...
  listSchemas(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.discoveryengine.v1beta.IListSchemasResponse|null|undefined,
          protos.google.cloud.discoveryengine.v1beta.ISchema>): void;
  listSchemas(
      request: protos.google.cloud.discoveryengine.v1beta.IListSchemasRequest,
      callback: PaginationCallback<
          protos.google.cloud.discoveryengine.v1beta.IListSchemasRequest,
  ...
  listSchemas(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.discoveryengine.v1beta.IListSchemasRequest,
      protos.google.cloud.discoveryengine.v1beta.IListSchemasResponse|null|undefined,
      protos.google.cloud.discoveryengine.v1beta.ISchema>|undefined = callback
