 ...
 */
import * as gapicConfig from './chunk_service_client_config.json';
 ...
 * @memberof v1alpha
 */
export class ChunkServiceClient {
  ...
  chunkServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof ChunkServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.discoveryengine.v1alpha.ChunkService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.chunkServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.discoveryengine.v1alpha.ChunkService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.discoveryengine.v1alpha.ChunkService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const chunkServiceStubMethods =
        ['getChunk', 'listChunks'];
 ...
 */
  getChunk(
      request?: protos.google.cloud.discoveryengine.v1alpha.IGetChunkRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.discoveryengine.v1alpha.IChunk,
        protos.google.cloud.discoveryengine.v1alpha.IGetChunkRequest|undefined, {}|undefined
      ]>;
  getChunk(
      request: protos.google.cloud.discoveryengine.v1alpha.IGetChunkRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.discoveryengine.v1alpha.IChunk,
          protos.google.cloud.discoveryengine.v1alpha.IGetChunkRequest|null|undefined,
          {}|null|undefined>): void;
  getChunk(
      request: protos.google.cloud.discoveryengine.v1alpha.IGetChunkRequest,
      callback: Callback<
 ...
 */
  listChunks(
      request?: protos.google.cloud.discoveryengine.v1alpha.IListChunksRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.discoveryengine.v1alpha.IChunk[],
  ...
  listChunks(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.discoveryengine.v1alpha.IListChunksResponse|null|undefined,
          protos.google.cloud.discoveryengine.v1alpha.IChunk>): void;
  listChunks(
      request: protos.google.cloud.discoveryengine.v1alpha.IListChunksRequest,
      callback: PaginationCallback<
          protos.google.cloud.discoveryengine.v1alpha.IListChunksRequest,
  ...
  listChunks(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.discoveryengine.v1alpha.IListChunksRequest,
      protos.google.cloud.discoveryengine.v1alpha.IListChunksResponse|null|undefined,
      protos.google.cloud.discoveryengine.v1alpha.IChunk>|undefined = callback
 ...
 */
  listChunksAsync(
      request?: protos.google.cloud.discoveryengine.v1alpha.IListChunksRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.discoveryengine.v1alpha.IChunk>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listChunks.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.discoveryengine.v1alpha.IChunk>;
  }
/**
