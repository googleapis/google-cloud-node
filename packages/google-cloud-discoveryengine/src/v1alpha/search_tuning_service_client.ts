...
export class SearchTuningServiceClient {
  ...
  constructor(
    ...
    const trainCustomModelResponse = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1alpha.TrainCustomModelResponse'
    ) as gax.protobuf.Type;
    const trainCustomModelMetadata = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1alpha.TrainCustomModelMetadata'
    ) as gax.protobuf.Type;
  ...
  listCustomModels(
    ...
    [
      ...
      (
        | protos.google.cloud.discoveryengine.v1alpha.IListCustomModelsRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  trainCustomModel(
    ...
    [
      LROperation<
        protos.google.cloud.discoveryengine.v1alpha.ITrainCustomModelResponse,
        protos.google.cloud.discoveryengine.v1alpha.ITrainCustomModelMetadata
      >,
  ...
  async checkTrainCustomModelProgress(
    ...
    LROperation<
      protos.google.cloud.discoveryengine.v1alpha.TrainCustomModelResponse,
      protos.google.cloud.discoveryengine.v1alpha.TrainCustomModelMetadata
    >
  > {
    const request =
