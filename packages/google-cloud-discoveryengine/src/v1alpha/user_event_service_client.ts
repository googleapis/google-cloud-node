...
export class UserEventServiceClient {
  ...
  constructor(
    ...
    const purgeUserEventsResponse = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1alpha.PurgeUserEventsResponse'
    ) as gax.protobuf.Type;
    const purgeUserEventsMetadata = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1alpha.PurgeUserEventsMetadata'
    ) as gax.protobuf.Type;
    ...
    const importUserEventsMetadata = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1alpha.ImportUserEventsMetadata'
    ) as gax.protobuf.Type;
  ...
  writeUserEvent(
    ...
    [
      ...
      (
        | protos.google.cloud.discoveryengine.v1alpha.IWriteUserEventRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  collectUserEvent(
    ...
    [
      ...
      (
        | protos.google.cloud.discoveryengine.v1alpha.ICollectUserEventRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  async checkPurgeUserEventsProgress(
    ...
    LROperation<
      protos.google.cloud.discoveryengine.v1alpha.PurgeUserEventsResponse,
      protos.google.cloud.discoveryengine.v1alpha.PurgeUserEventsMetadata
    >
  > {
    const request =
  ...
  async checkImportUserEventsProgress(
    ...
    LROperation<
      protos.google.cloud.discoveryengine.v1alpha.ImportUserEventsResponse,
      protos.google.cloud.discoveryengine.v1alpha.ImportUserEventsMetadata
    >
  > {
    const request =
      new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest(
