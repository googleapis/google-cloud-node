...
export class EvaluationServiceClient {
  ...
  constructor(
    ...
    const createEvaluationMetadata = protoFilesRoot.lookup(
      '.google.cloud.discoveryengine.v1alpha.CreateEvaluationMetadata'
    ) as gax.protobuf.Type;
  ...
  getEvaluation(
    ...
    [
      ...
      (
        | protos.google.cloud.discoveryengine.v1alpha.IGetEvaluationRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  async checkCreateEvaluationProgress(
    ...
    LROperation<
      protos.google.cloud.discoveryengine.v1alpha.Evaluation,
      protos.google.cloud.discoveryengine.v1alpha.CreateEvaluationMetadata
    >
  > {
    const request =
