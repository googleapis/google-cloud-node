...
export class ServingConfigServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.discoveryengine.v1alpha.ServingConfigService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.servingConfigServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.discoveryengine.v1alpha.ServingConfigService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.discoveryengine.v1alpha.ServingConfigService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const servingConfigServiceStubMethods =
        ['updateServingConfig', 'getServingConfig', 'listServingConfigs'];
 ...
 */
  updateServingConfig(
      ...
      Promise<[
        ...
        protos.google.cloud.discoveryengine.v1alpha.IUpdateServingConfigRequest|undefined, {}|undefined
      ]>;
  updateServingConfig(
      request: protos.google.cloud.discoveryengine.v1alpha.IUpdateServingConfigRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.discoveryengine.v1alpha.IServingConfig,
          protos.google.cloud.discoveryengine.v1alpha.IUpdateServingConfigRequest|null|undefined,
          {}|null|undefined>): void;
  updateServingConfig(
      request: protos.google.cloud.discoveryengine.v1alpha.IUpdateServingConfigRequest,
      callback: Callback<
 ...
 */
  getServingConfig(
      ...
      Promise<[
        protos.google.cloud.discoveryengine.v1alpha.IServingConfig,
        protos.google.cloud.discoveryengine.v1alpha.IGetServingConfigRequest|undefined, {}|undefined
      ]>;
  getServingConfig(
      request: protos.google.cloud.discoveryengine.v1alpha.IGetServingConfigRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.discoveryengine.v1alpha.IServingConfig,
          protos.google.cloud.discoveryengine.v1alpha.IGetServingConfigRequest|null|undefined,
          {}|null|undefined>): void;
  getServingConfig(
      request: protos.google.cloud.discoveryengine.v1alpha.IGetServingConfigRequest,
      callback: Callback<
 ...
 */
  ...
  listServingConfigs(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.discoveryengine.v1alpha.IListServingConfigsResponse|null|undefined,
          protos.google.cloud.discoveryengine.v1alpha.IServingConfig>): void;
  listServingConfigs(
      request: protos.google.cloud.discoveryengine.v1alpha.IListServingConfigsRequest,
      callback: PaginationCallback<
          protos.google.cloud.discoveryengine.v1alpha.IListServingConfigsRequest,
  ...
  listServingConfigs(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.discoveryengine.v1alpha.IListServingConfigsRequest,
      protos.google.cloud.discoveryengine.v1alpha.IListServingConfigsResponse|null|undefined,
      protos.google.cloud.discoveryengine.v1alpha.IServingConfig>|undefined = callback
