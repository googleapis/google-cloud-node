...
function main(name) {
  // [START discoveryengine_v1beta_generated_ServingConfigService_DeleteServingConfig_async]
  /**
  ...
  async function callDeleteServingConfig() {
    ...
    // Run request
    const response = await discoveryengineClient.deleteServingConfig(request);
    console.log(response);
  }

  callDeleteServingConfig();
  // [END discoveryengine_v1beta_generated_ServingConfigService_DeleteServingConfig_async]
}
