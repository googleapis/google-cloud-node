...
function main(name) {
  ...
  async function callDeleteSampleQuery() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await discoveryengineClient.deleteSampleQuery(request);
    console.log(response);
  }

  callDeleteSampleQuery();
  // [END discoveryengine_v1beta_generated_SampleQueryService_DeleteSampleQuery_async]
}
