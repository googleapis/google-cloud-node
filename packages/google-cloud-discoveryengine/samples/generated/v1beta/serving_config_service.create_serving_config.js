...
function main(parent, servingConfig, servingConfigId) {
  // [START discoveryengine_v1beta_generated_ServingConfigService_CreateServingConfig_async]
  /**
  ...
  async function callCreateServingConfig() {
    ...
    // Run request
    const response = await discoveryengineClient.createServingConfig(request);
    console.log(response);
  }

  callCreateServingConfig();
  // [END discoveryengine_v1beta_generated_ServingConfigService_CreateServingConfig_async]
}
