...
function main(dataStore) {
  // [START discoveryengine_v1alpha_generated_SearchTuningService_ListCustomModels_async]
  /**
  ...
  async function callListCustomModels() {
    // Construct request
    const request = {
      dataStore,
    };
    ...
    // Run request
    const response = await discoveryengineClient.listCustomModels(request);
    console.log(response);
  }

  callListCustomModels();
  // [END discoveryengine_v1alpha_generated_SearchTuningService_ListCustomModels_async]
}
