...
function main(documentProcessingConfig) {
  ...
  async function callUpdateDocumentProcessingConfig() {
    // Construct request
    const request = {
    ...
    // Run request
    const response = await discoveryengineClient.updateDocumentProcessingConfig(request);
    console.log(response);
  }

  callUpdateDocumentProcessingConfig();
