...
function main(parent) {
  // [START discoveryengine_v1alpha_generated_SampleQuerySetService_ListSampleQuerySets_async]
  /**
  ...
  async function callListSampleQuerySets() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = discoveryengineClient.listSampleQuerySetsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListSampleQuerySets();
  // [END discoveryengine_v1alpha_generated_SampleQuerySetService_ListSampleQuerySets_async]
}
