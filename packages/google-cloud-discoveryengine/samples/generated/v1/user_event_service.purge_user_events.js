...
function main(parent, filter) {
  // [START discoveryengine_v1_generated_UserEventService_PurgeUserEvents_async]
  /**
  ...
  async function callPurgeUserEvents() {
    ...
    // Run request
    const [operation] = await discoveryengineClient.purgeUserEvents(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callPurgeUserEvents();
  // [END discoveryengine_v1_generated_UserEventService_PurgeUserEvents_async]
}
