...
function main(name) {
  // [START eventarc_v1_generated_Eventarc_DeleteMessageBus_async]
  /**
  ...
  async function callDeleteMessageBus() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const [operation] = await eventarcClient.deleteMessageBus(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callDeleteMessageBus();
  // [END eventarc_v1_generated_Eventarc_DeleteMessageBus_async]
}
