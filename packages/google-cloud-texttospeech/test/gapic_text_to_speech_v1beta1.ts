    ...
    it('invokes listVoices without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listVoices(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.texttospeech.v1beta1.IListVoicesResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes synthesizeSpeech without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.synthesizeSpeech(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.texttospeech.v1beta1.ISynthesizeSpeechResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes streamingSynthesize without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        stream.on(
          'data',
          (
            response: protos.google.cloud.texttospeech.v1beta1.StreamingSynthesizeResponse
          ) => {
            resolve(response);
          }
        );
