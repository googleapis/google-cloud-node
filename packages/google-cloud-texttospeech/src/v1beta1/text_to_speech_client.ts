...
export class TextToSpeechClient {
  ...
  // -------------------
  listVoices(
    request: protosTypes.google.cloud.texttospeech.v1beta1.IListVoicesRequest,
  ...
  synthesizeSpeech(
    request: protosTypes.google.cloud.texttospeech.v1beta1.ISynthesizeSpeechRequest,
    options?: gax.CallOptions
  ): Promise<
    [
