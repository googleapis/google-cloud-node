...
function main(name) {
  // [START analyticsdata_v1alpha_generated_AlphaAnalyticsData_GetReportTask_async]
  /**
  ...
  async function callGetReportTask() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await dataClient.getReportTask(request);
