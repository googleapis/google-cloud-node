...
[![codecov](https://img.shields.io/codecov/c/github/googleapis/nodejs-deploy/master.svg?style=flat)](https://codecov.io/gh/googleapis/nodejs-deploy)
...
[the CHANGELOG](https://github.com/googleapis/nodejs-deploy/blob/master/CHANGELOG.md).
...
Samples are in the [`samples/`](https://github.com/googleapis/nodejs-deploy/tree/master/samples) directory. Each sample's `README.md` has instructions for running its sample.

| Sample                      | Source Code                       | Try it |
| --------------------------- | --------------------------------- | ------ |
| Quickstart | [source code](https://github.com/googleapis/nodejs-deploy/blob/master/samples/quickstart.js) | [![Open in Cloud Shell][shell_img]](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/googleapis/nodejs-deploy&page=editor&open_in_editor=samples/quickstart.js,samples/README.md) |
...
Contributions welcome! See the [Contributing Guide](https://github.com/googleapis/nodejs-deploy/blob/master/CONTRIBUTING.md).
...
See [LICENSE](https://github.com/googleapis/nodejs-deploy/blob/master/LICENSE)
