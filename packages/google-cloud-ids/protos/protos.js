                ...
                ids.v1 = (function() {
                    ...
                    v1.Endpoint = (function() {
                        ...
                        Endpoint.toObject = function toObject(message, options) {
                            ...
                            if (message.severity != null && message.hasOwnProperty("severity"))
                                object.severity = options.enums === String ? $root.google.cloud.ids.v1.Endpoint.Severity[message.severity] : message.severity;
                            if (message.state != null && message.hasOwnProperty("state"))
                                object.state = options.enums === String ? $root.google.cloud.ids.v1.Endpoint.State[message.state] : message.state;
                            if (message.trafficLogs != null && message.hasOwnProperty("trafficLogs"))
