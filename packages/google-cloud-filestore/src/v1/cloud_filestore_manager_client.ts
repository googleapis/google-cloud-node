...
export class CloudFilestoreManagerClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const createSnapshotResponse = protoFilesRoot.lookup(
      '.google.cloud.filestore.v1.Snapshot') as gax.protobuf.Type;
  ...
  initialize() {
    ...
    const cloudFilestoreManagerStubMethods =
        ['listInstances', 'getInstance', 'createInstance', 'updateInstance', 'restoreInstance', 'revertInstance', 'deleteInstance', 'listSnapshots', 'getSnapshot', 'createSnapshot', 'deleteSnapshot', 'updateSnapshot', 'listBackups', 'getBackup', 'createBackup', 'deleteBackup', 'updateBackup', 'promoteReplica'];
 ...
 */
  getSnapshot(
      ...
      Promise<[
        ...
        protos.google.cloud.filestore.v1.IGetSnapshotRequest|undefined, {}|undefined
      ]>;
  getSnapshot(
      request: protos.google.cloud.filestore.v1.IGetSnapshotRequest,
      options: CallOptions,
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/cloud_filestore_manager.revert_instance.js</caption>
 * region_tag:file_v1_generated_CloudFilestoreManager_RevertInstance_async
 */
  revertInstance(
      request?: protos.google.cloud.filestore.v1.IRevertInstanceRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.filestore.v1.IInstance, protos.google.cloud.common.IOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
 ...
 * region_tag:file_v1_generated_CloudFilestoreManager_RevertInstance_async
 */
  async checkRevertInstanceProgress(name: string): Promise<LROperation<protos.google.cloud.filestore.v1.Instance, protos.google.cloud.common.OperationMetadata>>{
 ...
 * region_tag:file_v1_generated_CloudFilestoreManager_CreateSnapshot_async
 */
  async checkCreateSnapshotProgress(name: string): Promise<LROperation<protos.google.cloud.filestore.v1.Snapshot, protos.google.cloud.common.OperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.filestore.v1.Snapshot, protos.google.cloud.common.OperationMetadata>;
  }
/**
 * Deletes a snapshot.
 *
 ...
 * region_tag:file_v1_generated_CloudFilestoreManager_UpdateSnapshot_async
 */
  async checkUpdateSnapshotProgress(name: string): Promise<LROperation<protos.google.cloud.filestore.v1.Snapshot, protos.google.cloud.common.OperationMetadata>>{
 ...
 * region_tag:file_v1_generated_CloudFilestoreManager_PromoteReplica_async
 */
  async checkPromoteReplicaProgress(name: string): Promise<LROperation<protos.google.cloud.filestore.v1.Instance, protos.google.cloud.common.OperationMetadata>>{
 ...
 */
  ...
  listInstances(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.filestore.v1.IListInstancesRequest,
      protos.google.cloud.filestore.v1.IListInstancesResponse|null|undefined,
      protos.google.cloud.filestore.v1.IInstance>|undefined = callback
 ...
 */
  ...
  listSnapshots(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.filestore.v1.IListSnapshotsResponse|null|undefined,
          protos.google.cloud.filestore.v1.ISnapshot>): void;
  listSnapshots(
      request: protos.google.cloud.filestore.v1.IListSnapshotsRequest,
      callback: PaginationCallback<
          protos.google.cloud.filestore.v1.IListSnapshotsRequest,
  ...
  listSnapshots(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.filestore.v1.IListSnapshotsRequest,
      protos.google.cloud.filestore.v1.IListSnapshotsResponse|null|undefined,
      protos.google.cloud.filestore.v1.ISnapshot>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
 ...
 */
  ...
  listBackups(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.filestore.v1.IListBackupsRequest,
      protos.google.cloud.filestore.v1.IListBackupsResponse|null|undefined,
      protos.google.cloud.filestore.v1.IBackup>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
