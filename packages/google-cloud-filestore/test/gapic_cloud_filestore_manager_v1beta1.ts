...
describe('v1beta1.CloudFilestoreManagerClient', () => {
  describe('Common methods', () => {
    ...
    it('has port', () => {
      const port =
        cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient.port;
      assert(port);
    ...
    it('invokes getInstance without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getInstance(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.filestore.v1beta1.IInstance | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getSnapshot without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getSnapshot(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.filestore.v1beta1.ISnapshot | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getBackup without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getBackup(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.filestore.v1beta1.IBackup | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getShare', () => {
    it('invokes getShare without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getShare as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getShare as SinonStub
    ...
    it('invokes getShare without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getShare(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.filestore.v1beta1.IShare | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createShare', () => {
    it('invokes createShare without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createShare as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createShare as SinonStub
    ...
    it('invokes createShare without error using callback', async () => {
      ...
      client.innerApiCalls.createShare =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createShare(
          request,
    ...
    it('invokes createShare with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createShare = stubLongRunningCall(
        undefined,
        expectedError
      );
    ...
    it('invokes checkCreateShareProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkCreateShareProgress(
        expectedResponse.name
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('deleteShare', () => {
    it('invokes deleteShare without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteShare as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteShare as SinonStub
    ...
    it('invokes deleteShare without error using callback', async () => {
      ...
      client.innerApiCalls.deleteShare =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.deleteShare(
          request,
    ...
    it('invokes deleteShare with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteShare = stubLongRunningCall(
        undefined,
        expectedError
      );
    ...
    it('invokes checkDeleteShareProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkDeleteShareProgress(
        expectedResponse.name
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('updateShare', () => {
    it('invokes updateShare without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateShare as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateShare as SinonStub
    ...
    it('invokes updateShare without error using callback', async () => {
      ...
      client.innerApiCalls.updateShare =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.updateShare(
          request,
    ...
    it('invokes updateShare with call error', async () => {
      ...
      const expectedHeaderRequestParams = `share.name=${defaultValue1}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateShare = stubLongRunningCall(
        undefined,
        expectedError
      );
    ...
    it('invokes checkUpdateShareProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkUpdateShareProgress(
        expectedResponse.name
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('listInstances', () => {
    ...
    it('invokes listInstancesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.filestore.v1beta1.Instance) => {
  ...
  describe('listSnapshots', () => {
    ...
    it('invokes listSnapshotsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.filestore.v1beta1.Snapshot) => {
            responses.push(response);
          }
        );
        stream.on('end', () => {
  ...
  describe('listBackups', () => {
    ...
    it('invokes listBackupsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.filestore.v1beta1.Backup) => {
            responses.push(response);
          }
        );
        stream.on('end', () => {
  ...
  describe('listShares', () => {
    it('invokes listShares without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listShares as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listShares as SinonStub
    ...
    it('invokes listShares without error using callback', async () => {
      ...
      client.innerApiCalls.listShares =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listShares(
          request,
    ...
    it('invokes listShares with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listShares = stubSimpleCall(
        undefined,
        expectedError
      );
    ...
    it('invokes listSharesStream without error', async () => {
      ...
      client.descriptors.page.listShares.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.filestore.v1beta1.Share) => {
            responses.push(response);
          }
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listShares.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listShares, request)
      );
      assert(
        (client.descriptors.page.listShares.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listSharesStream with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listShares.createStream = stubPageStreamingCall(
        undefined,
        expectedError
      );
      const stream = client.listSharesStream(request);
    ...
    it('uses async iteration with listShares without error', async () => {
      ...
      client.descriptors.page.listShares.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      ...
      assert.deepStrictEqual(responses, expectedResponse);
      assert.deepStrictEqual(
        (client.descriptors.page.listShares.asyncIterate as SinonStub).getCall(
          0
        ).args[1],
        request
      );
    ...
    it('uses async iteration with listShares with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listShares.asyncIterate = stubAsyncIterationCall(
        undefined,
        expectedError
      );
      const iterable = client.listSharesAsync(request);
  ...
  describe('Path templates', () => {
    ...
    describe('share', () => {
      ...
      client.initialize();
      client.pathTemplates.sharePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.sharePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('sharePath', () => {
        const result = client.sharePath(
          'projectValue',
          'locationValue',
          'instanceValue',
          'shareValue'
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.sharePathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters)
        );
      });
      ...
      it('matchProjectFromShareName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.sharePathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath)
        );
      });
