...
function main(name) {
  ...
  async function callGetClientConnectorService() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await clientconnectorservicesClient.getClientConnectorService(request);
    console.log(response);
  }

  callGetClientConnectorService();
