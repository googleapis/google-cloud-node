  ...
  createMigrationWorkflow(
    ...
    return this.innerApiCalls.createMigrationWorkflow(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.bigquery.migration.v2alpha.IMigrationWorkflow,
        protos.google.cloud.bigquery.migration.v2alpha.ICreateMigrationWorkflowRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('createMigrationWorkflow response %j', response);
 ...
 */
  ...
  getMigrationWorkflow(
    ...
    return this.innerApiCalls.getMigrationWorkflow(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.bigquery.migration.v2alpha.IMigrationWorkflow,
        protos.google.cloud.bigquery.migration.v2alpha.IGetMigrationWorkflowRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getMigrationWorkflow response %j', response);
        return [response, options, rawResponse];
 ...
 */
  ...
  deleteMigrationWorkflow(
    ...
    return this.innerApiCalls.deleteMigrationWorkflow(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.protobuf.IEmpty,
        protos.google.cloud.bigquery.migration.v2alpha.IDeleteMigrationWorkflowRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('deleteMigrationWorkflow response %j', response);
        return [response, options, rawResponse];
 ...
 */
  ...
  startMigrationWorkflow(
    ...
    return this.innerApiCalls.startMigrationWorkflow(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.protobuf.IEmpty,
        protos.google.cloud.bigquery.migration.v2alpha.IStartMigrationWorkflowRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('startMigrationWorkflow response %j', response);
        return [response, options, rawResponse];
 ...
 */
  ...
  getMigrationSubtask(
    ...
    return this.innerApiCalls.getMigrationSubtask(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.bigquery.migration.v2alpha.IMigrationSubtask,
        protos.google.cloud.bigquery.migration.v2alpha.IGetMigrationSubtaskRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getMigrationSubtask response %j', response);
        return [response, options, rawResponse];
 ...
 */
  ...
  listMigrationWorkflows(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.bigquery.migration.v2alpha.IListMigrationWorkflowsRequest,
      protos.google.cloud.bigquery.migration.v2alpha.IListMigrationWorkflowsResponse|null|undefined,
      protos.google.cloud.bigquery.migration.v2alpha.IMigrationWorkflow>|undefined = callback
 ...
 */
  ...
  listMigrationSubtasks(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.bigquery.migration.v2alpha.IListMigrationSubtasksRequest,
      protos.google.cloud.bigquery.migration.v2alpha.IListMigrationSubtasksResponse|null|undefined,
      protos.google.cloud.bigquery.migration.v2alpha.IMigrationSubtask>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
