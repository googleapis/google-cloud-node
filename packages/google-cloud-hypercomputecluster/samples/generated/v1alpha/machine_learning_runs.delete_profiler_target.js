...
function main(name) {
  // [START hypercomputecluster_v1alpha_generated_MachineLearningRuns_DeleteProfilerTarget_async]
  /**
  ...
  async function callDeleteProfilerTarget() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await hypercomputeclusterClient.deleteProfilerTarget(request);
    console.log(response);
  }

  callDeleteProfilerTarget();
  // [END hypercomputecluster_v1alpha_generated_MachineLearningRuns_DeleteProfilerTarget_async]
}
