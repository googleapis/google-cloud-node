...
function main(name) {
  // [START hypercomputecluster_v1alpha_generated_MachineLearningRuns_DeleteMonitoredEvent_async]
  /**
  ...
  async function callDeleteMonitoredEvent() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const [operation] = await hypercomputeclusterClient.deleteMonitoredEvent(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callDeleteMonitoredEvent();
  // [END hypercomputecluster_v1alpha_generated_MachineLearningRuns_DeleteMonitoredEvent_async]
}
