...
function main(name) {
  // [START hypercomputecluster_v1alpha_generated_MachineLearningRuns_DeleteProfilerSession_async]
  /**
  ...
  async function callDeleteProfilerSession() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await hypercomputeclusterClient.deleteProfilerSession(request);
    console.log(response);
  }

  callDeleteProfilerSession();
  // [END hypercomputecluster_v1alpha_generated_MachineLearningRuns_DeleteProfilerSession_async]
}
