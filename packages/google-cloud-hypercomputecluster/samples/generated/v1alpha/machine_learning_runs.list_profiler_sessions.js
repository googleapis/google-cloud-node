...
function main(parent) {
  // [START hypercomputecluster_v1alpha_generated_MachineLearningRuns_ListProfilerSessions_async]
  /**
  ...
  async function callListProfilerSessions() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = hypercomputeclusterClient.listProfilerSessionsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListProfilerSessions();
  // [END hypercomputecluster_v1alpha_generated_MachineLearningRuns_ListProfilerSessions_async]
}
