...
describe('v1beta.HypercomputeClusterClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          hypercomputeclusterModule.v1beta.HypercomputeClusterClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        hypercomputeclusterModule.v1beta.HypercomputeClusterClient.port;
      assert(port);
    ...
    it('invokes getCluster without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getCluster(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.hypercomputecluster.v1beta.ICluster | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listClustersStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.hypercomputecluster.v1beta.Cluster,
          ) => {
  ...
  describe('Path templates', () => {
    ...
    describe('lustreInstance', async () => {
      ...
      await client.initialize();
      client.pathTemplates.lustreInstancePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.lustreInstancePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('lustreInstancePath', () => {
        const result = client.lustreInstancePath(
          'projectValue',
          'locationValue',
          'instanceValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.lustreInstancePathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromLustreInstanceName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.lustreInstancePathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
