...
describe('v1.HypercomputeClusterClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new hypercomputeclusterModule.v1.HypercomputeClusterClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          hypercomputeclusterModule.v1.HypercomputeClusterClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          hypercomputeclusterModule.v1.HypercomputeClusterClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'hypercomputecluster.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port = hypercomputeclusterModule.v1.HypercomputeClusterClient.port;
      assert(port);
  ...
  describe('getCluster', () => {
    it('invokes getCluster without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.hypercomputecluster.v1.GetClusterRequest(),
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.hypercomputecluster.v1.Cluster(),
      );
    ...
    it('invokes getCluster without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getCluster(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.hypercomputecluster.v1.ICluster | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createCluster', () => {
    it('invokes createCluster without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.hypercomputecluster.v1.CreateClusterRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('updateCluster', () => {
    it('invokes updateCluster without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.hypercomputecluster.v1.UpdateClusterRequest(),
      );
      request.cluster ??= {};
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('deleteCluster', () => {
    it('invokes deleteCluster without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.hypercomputecluster.v1.DeleteClusterRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('listClusters', () => {
    it('invokes listClusters without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.hypercomputecluster.v1.ListClustersRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const promise = new Promise((resolve, reject) => {
        client.listClusters(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.hypercomputecluster.v1.ICluster[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listClustersStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.hypercomputecluster.v1.Cluster[] =
          [];
        stream.on(
          'data',
          (response: protos.google.cloud.hypercomputecluster.v1.Cluster) => {
    ...
    it('uses async iteration with listClusters without error', async () => {
      ...
      const responses: protos.google.cloud.hypercomputecluster.v1.ICluster[] =
        [];
  ...
  describe('Path templates', () => {
    ...
    describe('computeInstance', async () => {
      ...
      await client.initialize();
      client.pathTemplates.computeInstancePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.computeInstancePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('computeInstancePath', () => {
        const result = client.computeInstancePath(
          'projectValue',
          'zoneValue',
          'instanceValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.computeInstancePathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromComputeInstanceName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.computeInstancePathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('diskType', async () => {
      ...
      await client.initialize();
      client.pathTemplates.diskTypePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.diskTypePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('diskTypePath', () => {
        const result = client.diskTypePath(
          'projectValue',
          'zoneValue',
          'diskTypeValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.diskTypePathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromDiskTypeName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.diskTypePathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('fileInstance', async () => {
      const fakePath = '/rendered/path/fileInstance';
      const expectedParameters = {
        project: 'projectValue',
        location: 'locationValue',
        instance: 'instanceValue',
      ...
      await client.initialize();
      client.pathTemplates.fileInstancePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.fileInstancePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('fileInstancePath', () => {
        const result = client.fileInstancePath(
          'projectValue',
          'locationValue',
          'instanceValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.fileInstancePathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });

      it('matchProjectFromFileInstanceName', () => {
        const result = client.matchProjectFromFileInstanceName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.fileInstancePathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });

      it('matchLocationFromFileInstanceName', () => {
        const result = client.matchLocationFromFileInstanceName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (client.pathTemplates.fileInstancePathTemplate.match as SinonStub)
            .getCall(-1)
      ...
      it('matchInstanceFromFileInstanceName', () => {
        const result = client.matchInstanceFromFileInstanceName(fakePath);
        assert.strictEqual(result, 'instanceValue');
        assert(
          (client.pathTemplates.fileInstancePathTemplate.match as SinonStub)
            .getCall(-1)
    ...
    describe('subnetwork', async () => {
      ...
      await client.initialize();
      client.pathTemplates.subnetworkPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.subnetworkPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('subnetworkPath', () => {
        const result = client.subnetworkPath(
          'projectValue',
          'regionValue',
          'subnetworkValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.subnetworkPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromSubnetworkName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.subnetworkPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
