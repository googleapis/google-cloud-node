...
describe('v1alpha.HypercomputeClusterClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new hypercomputeclusterModule.v1alpha.HypercomputeClusterClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          hypercomputeclusterModule.v1alpha.HypercomputeClusterClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        hypercomputeclusterModule.v1alpha.HypercomputeClusterClient.port;
      assert(port);
    ...
    it('invokes getCluster without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getCluster(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.hypercomputecluster.v1alpha.ICluster | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getNode', () => {
    it('invokes getNode without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.hypercomputecluster.v1alpha.GetNodeRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
    ...
    it('invokes getNode without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getNode(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.hypercomputecluster.v1alpha.INode | null,
          ) => {
            if (err) {
              reject(err);
            } else {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listClusters(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.hypercomputecluster.v1alpha.ICluster[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listClustersStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.hypercomputecluster.v1alpha.Cluster,
          ) => {
  ...
  describe('listNodes', () => {
    it('invokes listNodes without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.hypercomputecluster.v1alpha.ListNodesRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      const promise = new Promise((resolve, reject) => {
        client.listNodes(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.hypercomputecluster.v1alpha.INode[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listNodesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.hypercomputecluster.v1alpha.Node) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('Path templates', () => {
    ...
    describe('image', async () => {
      ...
      await client.initialize();
      client.pathTemplates.imagePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.imagePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);
      ...
      it('imagePath', () => {
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.imagePathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromImageName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.imagePathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('pod', async () => {
      ...
      await client.initialize();
      client.pathTemplates.podPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.podPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('podPath', () => {
        const result = client.podPath(
          'projectValue',
          'locationValue',
          'clusterValue',
          'namespaceValue',
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.podPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromPodName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.podPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('reservationBlock', async () => {
      ...
      await client.initialize();
      client.pathTemplates.reservationBlockPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.reservationBlockPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('reservationBlockPath', () => {
        const result = client.reservationBlockPath(
          'projectValue',
          'zoneValue',
          'reservationValue',
        ...
        assert(
          (
            client.pathTemplates.reservationBlockPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromReservationBlockName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.reservationBlockPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchReservationFromReservationBlockName', () => {
        const result =
          client.matchReservationFromReservationBlockName(fakePath);
        assert.strictEqual(result, 'reservationValue');
        assert(
          (client.pathTemplates.reservationBlockPathTemplate.match as SinonStub)
            .getCall(-1)
      ...
      it('matchReservationBlockFromReservationBlockName', () => {
        const result =
          client.matchReservationBlockFromReservationBlockName(fakePath);
    ...
    describe('reservationSubBlock', async () => {
      ...
      await client.initialize();
      client.pathTemplates.reservationSubBlockPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.reservationSubBlockPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('reservationSubBlockPath', () => {
        const result = client.reservationSubBlockPath(
          'projectValue',
          'zoneValue',
          'reservationValue',
          'reservationBlockValue',
        ...
        assert(
          (
            client.pathTemplates.reservationSubBlockPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchReservationFromReservationSubBlockName', () => {
        const result =
          client.matchReservationFromReservationSubBlockName(fakePath);
        assert.strictEqual(result, 'reservationValue');
        assert(
          (
            client.pathTemplates.reservationSubBlockPathTemplate
      ...
      it('matchReservationBlockFromReservationSubBlockName', () => {
        const result =
          client.matchReservationBlockFromReservationSubBlockName(fakePath);
        assert.strictEqual(result, 'reservationBlockValue');
        assert(
          (
            client.pathTemplates.reservationSubBlockPathTemplate
      ...
      it('matchReservationSubBlockFromReservationSubBlockName', () => {
        const result =
          client.matchReservationSubBlockFromReservationSubBlockName(fakePath);
