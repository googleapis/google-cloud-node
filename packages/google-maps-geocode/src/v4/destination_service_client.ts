 ...
 * `src/v4/destination_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './destination_service_client_config.json';
...
export class DestinationServiceClient {
  ...
  initialize() {
    ...
    if (this.destinationServiceStub) {
      return this.destinationServiceStub;
    }
