  ...
  describe('Path templates', () => {
    ...
    describe('organizationProtectedResourceScope', async () => {
      ...
      it('organizationProtectedResourceScopePath', () => {
        const result =
          client.organizationProtectedResourceScopePath('organizationValue');
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.organizationProtectedResourceScopePathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchOrganizationFromOrganizationProtectedResourceScopeName', () => {
        const result =
          client.matchOrganizationFromOrganizationProtectedResourceScopeName(
            fakePath,
          );
        assert.strictEqual(result, 'organizationValue');
        assert(
