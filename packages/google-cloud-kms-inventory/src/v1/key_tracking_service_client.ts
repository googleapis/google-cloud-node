...
export class KeyTrackingServiceClient {
  ...
  constructor(
    ...
    this.pathTemplates = {
      ...
      organizationProtectedResourceScopePathTemplate:
   ...
   * @returns {string} A string representing the organization.
   */
  matchOrganizationFromOrganizationProtectedResourceScopeName(
    organizationProtectedResourceScopeName: string,
  ) {
    return this.pathTemplates.organizationProtectedResourceScopePathTemplate.match(
      organizationProtectedResourceScopeName,
    ).organization;
  }
