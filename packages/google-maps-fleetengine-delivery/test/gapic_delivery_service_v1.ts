...
describe('v1.DeliveryServiceClient', () => {
  ...
  describe('searchTasks', () => {
    it('invokes searchTasks without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.searchTasks as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.searchTasks as SinonStub
    ...
    it('invokes searchTasks with error', async () => {
      ...
      const expectedHeaderRequestParams = 'provider_id=providers%2Fvalue';
      const expectedError = new Error('expected');
      client.innerApiCalls.searchTasks = stubSimpleCall(
        undefined,
        expectedError
      );
    ...
    it('invokes searchTasksStream without error', async () => {
      ...
      client.descriptors.page.searchTasks.createStream =
      ...
      assert(
        (client.descriptors.page.searchTasks.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.searchTasks, request)
      );
      assert(
        (client.descriptors.page.searchTasks.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes searchTasksStream with error', async () => {
      ...
      const expectedHeaderRequestParams = 'provider_id=providers%2Fvalue';
      const expectedError = new Error('expected');
      client.descriptors.page.searchTasks.createStream = stubPageStreamingCall(
        undefined,
        expectedError
      );
      const stream = client.searchTasksStream(request);
    ...
    it('uses async iteration with searchTasks without error', async () => {
      ...
      client.descriptors.page.searchTasks.asyncIterate =
      ...
      assert.deepStrictEqual(
        (client.descriptors.page.searchTasks.asyncIterate as SinonStub).getCall(
          0
        ).args[1],
        request
      );
    ...
    it('uses async iteration with searchTasks with error', async () => {
      ...
      const expectedHeaderRequestParams = 'provider_id=providers%2Fvalue';
      const expectedError = new Error('expected');
      client.descriptors.page.searchTasks.asyncIterate = stubAsyncIterationCall(
        undefined,
        expectedError
      );
      const iterable = client.searchTasksAsync(request);
