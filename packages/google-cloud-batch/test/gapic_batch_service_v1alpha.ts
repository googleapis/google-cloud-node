...
describe('v1alpha.BatchServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = batchserviceModule.v1alpha.BatchServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = batchserviceModule.v1alpha.BatchServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'batch.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new batchserviceModule.v1alpha.BatchServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'batch.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new batchserviceModule.v1alpha.BatchServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'batch.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new batchserviceModule.v1alpha.BatchServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new batchserviceModule.v1alpha.BatchServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createJob', () => {
        it('invokes createJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.batch.v1alpha.CreateJobRequest', ['parent']);
        ...
        it('invokes createJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.batch.v1alpha.IJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getJob', () => {
        it('invokes getJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.batch.v1alpha.GetJobRequest', ['name']);
    ...
    describe('updateJob', () => {
        it('invokes updateJob without error', async () => {
            ...
            request.job ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.batch.v1alpha.UpdateJobRequest', ['job', 'name']);
    ...
    describe('getTask', () => {
        it('invokes getTask without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.batch.v1alpha.GetTaskRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getTask without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getTask(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.batch.v1alpha.ITask|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createResourceAllowance', () => {
        it('invokes createResourceAllowance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.batch.v1alpha.CreateResourceAllowanceRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.batch.v1alpha.ResourceAllowance()
            );
            client.innerApiCalls.createResourceAllowance = stubSimpleCall(expectedResponse);
            const [response] = await client.createResourceAllowance(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createResourceAllowance as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createResourceAllowance as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createResourceAllowance without error using callback', async () => {
            ...
            client.innerApiCalls.createResourceAllowance = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createResourceAllowance(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.batch.v1alpha.IResourceAllowance|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createResourceAllowance with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createResourceAllowance = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createResourceAllowance(request), expectedError);
            const actualRequest = (client.innerApiCalls.createResourceAllowance as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createResourceAllowance as SinonStub)
    ...
    describe('getResourceAllowance', () => {
        it('invokes getResourceAllowance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.batch.v1alpha.GetResourceAllowanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.batch.v1alpha.ResourceAllowance()
            );
            client.innerApiCalls.getResourceAllowance = stubSimpleCall(expectedResponse);
            const [response] = await client.getResourceAllowance(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getResourceAllowance as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getResourceAllowance as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getResourceAllowance without error using callback', async () => {
            ...
            client.innerApiCalls.getResourceAllowance = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getResourceAllowance with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getResourceAllowance = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateResourceAllowance', () => {
        it('invokes updateResourceAllowance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.batch.v1alpha.UpdateResourceAllowanceRequest', ['resourceAllowance', 'name']);
            request.resourceAllowance.name = defaultValue1;
            const expectedHeaderRequestParams = `resource_allowance.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.batch.v1alpha.ResourceAllowance()
            );
            client.innerApiCalls.updateResourceAllowance = stubSimpleCall(expectedResponse);
            const [response] = await client.updateResourceAllowance(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateResourceAllowance as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateResourceAllowance as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateResourceAllowance without error using callback', async () => {
            ...
            client.innerApiCalls.updateResourceAllowance = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateResourceAllowance with error', async () => {
            ...
            const expectedHeaderRequestParams = `resource_allowance.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateResourceAllowance = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updateResourceAllowance(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateResourceAllowance as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateResourceAllowance as SinonStub)
    ...
    describe('deleteJob', () => {
        it('invokes deleteJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.batch.v1alpha.DeleteJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes deleteJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deleteJob(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.batch.v1alpha.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.batch.v1alpha.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteJob as SinonStub)
                .getCall(0).args[0];
    ...
    describe('cancelJob', () => {
        it('invokes cancelJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.batch.v1alpha.CancelJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes cancelJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.cancelJob(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.batch.v1alpha.ICancelJobResponse, protos.google.cloud.batch.v1alpha.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.batch.v1alpha.ICancelJobResponse, protos.google.cloud.batch.v1alpha.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.cancelJob as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteResourceAllowance', () => {
        it('invokes deleteResourceAllowance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.batch.v1alpha.DeleteResourceAllowanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteResourceAllowance = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteResourceAllowance(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteResourceAllowance as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteResourceAllowance as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteResourceAllowance without error using callback', async () => {
            ...
            client.innerApiCalls.deleteResourceAllowance = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteResourceAllowance with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteResourceAllowance = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteResourceAllowance(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteResourceAllowance as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteResourceAllowance as SinonStub)
        ...
        it('invokes deleteResourceAllowance with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteResourceAllowance = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteResourceAllowance(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteResourceAllowance as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteResourceAllowanceProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteResourceAllowanceProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteResourceAllowanceProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteResourceAllowanceProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listJobs', () => {
        it('invokes listJobs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.batch.v1alpha.ListJobsRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listTasks', () => {
        it('invokes listTasks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.batch.v1alpha.ListTasksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
        ...
        it('invokes listTasksStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.batch.v1alpha.Task) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listResourceAllowances', () => {
        it('invokes listResourceAllowances without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.batch.v1alpha.ListResourceAllowancesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.batch.v1alpha.ResourceAllowance()),
              generateSampleMessage(new protos.google.cloud.batch.v1alpha.ResourceAllowance()),
              generateSampleMessage(new protos.google.cloud.batch.v1alpha.ResourceAllowance()),
            ];
            client.innerApiCalls.listResourceAllowances = stubSimpleCall(expectedResponse);
            const [response] = await client.listResourceAllowances(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listResourceAllowances as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listResourceAllowances as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listResourceAllowances without error using callback', async () => {
            ...
            client.innerApiCalls.listResourceAllowances = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listResourceAllowances with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listResourceAllowances = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listResourceAllowances(request), expectedError);
            const actualRequest = (client.innerApiCalls.listResourceAllowances as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listResourceAllowances as SinonStub)
        ...
        it('invokes listResourceAllowancesStream without error', async () => {
            ...
            client.descriptors.page.listResourceAllowances.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.batch.v1alpha.ResourceAllowance) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listResourceAllowances.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listResourceAllowances, request));
            assert(
                (client.descriptors.page.listResourceAllowances.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listResourceAllowancesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listResourceAllowances.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listResourceAllowancesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.batch.v1alpha.ResourceAllowance[] = [];
                stream.on('data', (response: protos.google.cloud.batch.v1alpha.ResourceAllowance) => {
        ...
        it('uses async iteration with listResourceAllowances without error', async () => {
            ...
            client.descriptors.page.listResourceAllowances.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listResourceAllowances.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listResourceAllowances.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listResourceAllowances with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listResourceAllowances.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listResourceAllowancesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.batch.v1alpha.IResourceAllowance[] = [];
                for await (const resource of iterable) {
    ...
    describe('Path templates', () => {
        ...
        describe('resourceAllowance', async () => {
            ...
            await client.initialize();
            client.pathTemplates.resourceAllowancePathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.resourceAllowancePathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('resourceAllowancePath', () => {
                const result = client.resourceAllowancePath("projectValue", "locationValue", "resourceAllowanceValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.resourceAllowancePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromResourceAllowanceName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.resourceAllowancePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchResourceAllowanceFromResourceAllowanceName', () => {
                const result = client.matchResourceAllowanceFromResourceAllowanceName(fakePath);
