...
describe('v1.BatchServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new batchserviceModule.v1.BatchServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = batchserviceModule.v1.BatchServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = batchserviceModule.v1.BatchServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'batch.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new batchserviceModule.v1.BatchServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'batch.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new batchserviceModule.v1.BatchServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'batch.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new batchserviceModule.v1.BatchServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new batchserviceModule.v1.BatchServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = batchserviceModule.v1.BatchServiceClient.port;
            assert(port);
    ...
    describe('createJob', () => {
        it('invokes createJob without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.batch.v1.CreateJobRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.batch.v1.CreateJobRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.batch.v1.Job()
            );
        ...
        it('invokes createJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.batch.v1.IJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getJob', () => {
        it('invokes getJob without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.batch.v1.GetJobRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.batch.v1.GetJobRequest', ['name']);
    ...
    describe('getTask', () => {
        it('invokes getTask without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.batch.v1.GetTaskRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.batch.v1.GetTaskRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.batch.v1.Task()
            );
        ...
        it('invokes getTask without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getTask(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.batch.v1.ITask|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deleteJob', () => {
        it('invokes deleteJob without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.batch.v1.DeleteJobRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.batch.v1.DeleteJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteJob without error using callback', async () => {
            ...
            client.innerApiCalls.deleteJob = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteJob(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.batch.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.batch.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteJob as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes deleteJob with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteJob = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes deleteJob with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteJob = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteJob(request);
        ...
        it('invokes checkDeleteJobProgress without error', async () => {
            ...
            const decodedOperation = await client.checkDeleteJobProgress(expectedResponse.name);
    ...
    describe('cancelJob', () => {
        it('invokes cancelJob without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.batch.v1.CancelJobRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.batch.v1.CancelJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes cancelJob without error using callback', async () => {
            ...
            client.innerApiCalls.cancelJob = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.cancelJob(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.batch.v1.ICancelJobResponse, protos.google.cloud.batch.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.batch.v1.ICancelJobResponse, protos.google.cloud.batch.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.cancelJob as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes cancelJob with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.cancelJob = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes cancelJob with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.cancelJob = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.cancelJob(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.cancelJob as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkCancelJobProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkCancelJobProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('listJobs', () => {
        it('invokes listJobs without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.batch.v1.ListJobsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.batch.v1.ListJobsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.batch.v1.Job()),
              generateSampleMessage(new protos.google.cloud.batch.v1.Job()),
              generateSampleMessage(new protos.google.cloud.batch.v1.Job()),
            ];
        ...
        it('invokes listJobsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.batch.v1.Job[] = [];
                stream.on('data', (response: protos.google.cloud.batch.v1.Job) => {
        ...
        it('uses async iteration with listJobs without error', async () => {
            ...
            const responses: protos.google.cloud.batch.v1.IJob[] = [];
    ...
    describe('listTasks', () => {
        it('invokes listTasks without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.batch.v1.ListTasksRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.batch.v1.ListTasksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.batch.v1.Task()),
              generateSampleMessage(new protos.google.cloud.batch.v1.Task()),
              generateSampleMessage(new protos.google.cloud.batch.v1.Task()),
            ];
        ...
        it('invokes listTasksStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.batch.v1.Task[] = [];
                stream.on('data', (response: protos.google.cloud.batch.v1.Task) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listTasks without error', async () => {
            ...
            const responses: protos.google.cloud.batch.v1.ITask[] = [];
    ...
    describe('Path templates', () => {
        ...
        describe('task', async () => {
            ...
            it('taskPath', () => {
                const result = client.taskPath("projectValue", "locationValue", "jobValue", "taskGroupValue", "taskValue");
                assert.strictEqual(result, fakePath);
        ...
        describe('taskGroup', async () => {
            ...
            await client.initialize();
            client.pathTemplates.taskGroupPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.taskGroupPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('taskGroupPath', () => {
                const result = client.taskGroupPath("projectValue", "locationValue", "jobValue", "taskGroupValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.taskGroupPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromTaskGroupName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.taskGroupPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
