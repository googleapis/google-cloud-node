  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          batchserviceModule.v1.BatchServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          batchserviceModule.v1.BatchServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'batch.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new batchserviceModule.v1.BatchServiceClient({
          universe_domain: 'example.com',
    ...
    it('invokes createJob without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createJob(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.batch.v1.IJob | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getTask without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getTask(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.batch.v1.ITask | null
          ) => {
            if (err) {
              reject(err);
            } else {
