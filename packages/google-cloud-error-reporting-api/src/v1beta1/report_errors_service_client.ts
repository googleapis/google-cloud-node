...
export class ReportErrorsServiceClient {
   ...
   *     const client = new ReportErrorsServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(
    opts?: ClientOptions,
  ...
  initialize() {
    ...
    const reportErrorsServiceStubMethods = ['reportErrorEvent'];
   ...
   *   The first element of the array is an object representing {@link protos.google.devtools.clouderrorreporting.v1beta1.ReportErrorEventResponse|ReportErrorEventResponse}.
  ...
  reportErrorEvent(
    ...
    [
      ...
      (
        | protos.google.devtools.clouderrorreporting.v1beta1.IReportErrorEventRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    this._log.info('reportErrorEvent request %j', request);
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('reportErrorEvent response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .reportErrorEvent(request, options, wrappedCallback)
      ?.then(
   ...
   */
  close(): Promise<void> {
    if (this.reportErrorsServiceStub && !this._terminated) {
