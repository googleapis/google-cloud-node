...
function main(name) {
  // [START managedkafka_v1_generated_ManagedSchemaRegistry_GetVersion_async]
  /**
  ...
  async function callGetVersion() {
    ...
    // Run request
    const response = await schemaregistryClient.getVersion(request);
    console.log(response);
  }

  callGetVersion();
  // [END managedkafka_v1_generated_ManagedSchemaRegistry_GetVersion_async]
}
