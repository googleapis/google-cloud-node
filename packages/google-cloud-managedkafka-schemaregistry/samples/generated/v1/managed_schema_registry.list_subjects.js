...
function main(parent) {
  // [START managedkafka_v1_generated_ManagedSchemaRegistry_ListSubjects_async]
  /**
  ...
  async function callListSubjects() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const response = await schemaregistryClient.listSubjects(request);
    console.log(response);
  }

  callListSubjects();
  // [END managedkafka_v1_generated_ManagedSchemaRegistry_ListSubjects_async]
}
