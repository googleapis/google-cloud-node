...
function main(parent) {
  // [START managedkafka_v1_generated_ManagedSchemaRegistry_ListVersions_async]
  /**
  ...
  async function callListVersions() {
    ...
    // Run request
    const response = await schemaregistryClient.listVersions(request);
    console.log(response);
  }

  callListVersions();
  // [END managedkafka_v1_generated_ManagedSchemaRegistry_ListVersions_async]
}
