...
function main(name) {
  // [START managedkafka_v1_generated_ManagedSchemaRegistry_DeleteSchemaRegistry_async]
  /**
  ...
  async function callDeleteSchemaRegistry() {
    ...
    // Run request
    const response = await schemaregistryClient.deleteSchemaRegistry(request);
    console.log(response);
  }

  callDeleteSchemaRegistry();
  // [END managedkafka_v1_generated_ManagedSchemaRegistry_DeleteSchemaRegistry_async]
}
