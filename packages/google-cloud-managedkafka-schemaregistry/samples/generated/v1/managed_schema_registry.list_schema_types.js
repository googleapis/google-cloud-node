...
function main(parent) {
  // [START managedkafka_v1_generated_ManagedSchemaRegistry_ListSchemaTypes_async]
  /**
  ...
  async function callListSchemaTypes() {
    ...
    // Run request
    const response = await schemaregistryClient.listSchemaTypes(request);
    console.log(response);
  }

  callListSchemaTypes();
  // [END managedkafka_v1_generated_ManagedSchemaRegistry_ListSchemaTypes_async]
}
