...
function main(name) {
  // [START managedkafka_v1_generated_ManagedSchemaRegistry_DeleteSchemaConfig_async]
  /**
  ...
  async function callDeleteSchemaConfig() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await schemaregistryClient.deleteSchemaConfig(request);
    console.log(response);
  }

  callDeleteSchemaConfig();
  // [END managedkafka_v1_generated_ManagedSchemaRegistry_DeleteSchemaConfig_async]
}
