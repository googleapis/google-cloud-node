...
function main(name, mode) {
  // [START managedkafka_v1_generated_ManagedSchemaRegistry_UpdateSchemaMode_async]
  /**
  ...
  async function callUpdateSchemaMode() {
    // Construct request
    const request = {
      name,
      mode,
    ...
    // Run request
    const response = await schemaregistryClient.updateSchemaMode(request);
    console.log(response);
  }

  callUpdateSchemaMode();
  // [END managedkafka_v1_generated_ManagedSchemaRegistry_UpdateSchemaMode_async]
}
