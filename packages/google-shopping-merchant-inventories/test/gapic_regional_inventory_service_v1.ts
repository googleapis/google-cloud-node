...
describe('v1.RegionalInventoryServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new regionalinventoryserviceModule.v1.RegionalInventoryServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          regionalinventoryserviceModule.v1.RegionalInventoryServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        regionalinventoryserviceModule.v1.RegionalInventoryServiceClient.port;
      assert(port);
  ...
  describe('insertRegionalInventory', () => {
    it('invokes insertRegionalInventory without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.shopping.merchant.inventories.v1.InsertRegionalInventoryRequest(),
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.shopping.merchant.inventories.v1.RegionalInventory(),
      );
    ...
    it('invokes insertRegionalInventory without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.insertRegionalInventory(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.inventories.v1.IRegionalInventory | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('deleteRegionalInventory', () => {
    it('invokes deleteRegionalInventory without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.shopping.merchant.inventories.v1.DeleteRegionalInventoryRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('listRegionalInventories', () => {
    it('invokes listRegionalInventories without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.shopping.merchant.inventories.v1.ListRegionalInventoriesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const promise = new Promise((resolve, reject) => {
        client.listRegionalInventories(
          ...
          (
            err?: Error | null,
            result?:
              | protos.google.shopping.merchant.inventories.v1.IRegionalInventory[]
              | null,
          ) => {
            if (err) {
              reject(err);
    ...
    it('invokes listRegionalInventoriesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.shopping.merchant.inventories.v1.RegionalInventory[] =
          [];
        stream.on(
          'data',
          (
            response: protos.google.shopping.merchant.inventories.v1.RegionalInventory,
          ) => {
    ...
    it('uses async iteration with listRegionalInventories without error', async () => {
      ...
      const responses: protos.google.shopping.merchant.inventories.v1.IRegionalInventory[] =
        [];
