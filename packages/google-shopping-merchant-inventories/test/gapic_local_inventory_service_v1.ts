...
describe('v1.LocalInventoryServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          localinventoryserviceModule.v1.LocalInventoryServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        localinventoryserviceModule.v1.LocalInventoryServiceClient.port;
      assert(port);
  ...
  describe('insertLocalInventory', () => {
    it('invokes insertLocalInventory without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.shopping.merchant.inventories.v1.InsertLocalInventoryRequest(),
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.shopping.merchant.inventories.v1.LocalInventory(),
      );
    ...
    it('invokes insertLocalInventory without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.insertLocalInventory(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.inventories.v1.ILocalInventory | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('deleteLocalInventory', () => {
    it('invokes deleteLocalInventory without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.shopping.merchant.inventories.v1.DeleteLocalInventoryRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('listLocalInventories', () => {
    it('invokes listLocalInventories without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.shopping.merchant.inventories.v1.ListLocalInventoriesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const promise = new Promise((resolve, reject) => {
        client.listLocalInventories(
          ...
          (
            err?: Error | null,
            result?:
              | protos.google.shopping.merchant.inventories.v1.ILocalInventory[]
              | null,
          ) => {
            if (err) {
              reject(err);
    ...
    it('invokes listLocalInventoriesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.shopping.merchant.inventories.v1.LocalInventory[] =
          [];
        stream.on(
          'data',
          (
            response: protos.google.shopping.merchant.inventories.v1.LocalInventory,
          ) => {
    ...
    it('uses async iteration with listLocalInventories without error', async () => {
      ...
      const responses: protos.google.shopping.merchant.inventories.v1.ILocalInventory[] =
        [];
