...
describe('v1beta.RegionalInventoryServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          regionalinventoryserviceModule.v1beta.RegionalInventoryServiceClient
            .servicePath;
  ...
  describe('insertRegionalInventory', () => {
    it('invokes insertRegionalInventory without error', async () => {
      ...
      client.innerApiCalls.insertRegionalInventory =
        stubSimpleCall(expectedResponse);
      const [response] = await client.insertRegionalInventory(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.insertRegionalInventory as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes insertRegionalInventory without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.insertRegionalInventory(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.inventories.v1beta.IRegionalInventory | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('deleteRegionalInventory', () => {
    it('invokes deleteRegionalInventory without error', async () => {
      ...
      client.innerApiCalls.deleteRegionalInventory =
        stubSimpleCall(expectedResponse);
      const [response] = await client.deleteRegionalInventory(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteRegionalInventory as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteRegionalInventory as SinonStub
  ...
  describe('listRegionalInventories', () => {
    it('invokes listRegionalInventories without error', async () => {
      ...
      client.innerApiCalls.listRegionalInventories =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listRegionalInventories(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listRegionalInventories as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listRegionalInventories as SinonStub
    ...
    it('invokes listRegionalInventories with error', async () => {
      ...
      await assert.rejects(
        client.listRegionalInventories(request),
        expectedError
      );
      const actualRequest = (
        client.innerApiCalls.listRegionalInventories as SinonStub
    ...
    it('invokes listRegionalInventoriesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.shopping.merchant.inventories.v1beta.RegionalInventory
          ) => {
      ...
      assert(
        (
          client.descriptors.page.listRegionalInventories
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listRegionalInventories, request)
      );
      assert(
        (
          client.descriptors.page.listRegionalInventories
