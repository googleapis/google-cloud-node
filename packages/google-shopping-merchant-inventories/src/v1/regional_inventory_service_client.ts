 ...
 * `src/v1/regional_inventory_service_client_config.json`.
...
export class RegionalInventoryServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.shopping.merchant.inventories.v1.RegionalInventoryService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.regionalInventoryServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.shopping.merchant.inventories.v1.RegionalInventoryService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.shopping.merchant.inventories.v1.RegionalInventoryService,
 ...
 * {@link protos.google.shopping.merchant.inventories.v1.RegionalInventory.region|`region`}
 ...
 * @param {google.shopping.merchant.inventories.v1.RegionalInventory} request.regionalInventory
 ...
 *   The first element of the array is an object representing {@link protos.google.shopping.merchant.inventories.v1.RegionalInventory|RegionalInventory}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/regional_inventory_service.insert_regional_inventory.js</caption>
 * region_tag:merchantapi_v1_generated_RegionalInventoryService_InsertRegionalInventory_async
 */
  insertRegionalInventory(
      request?: protos.google.shopping.merchant.inventories.v1.IInsertRegionalInventoryRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.inventories.v1.IRegionalInventory,
        protos.google.shopping.merchant.inventories.v1.IInsertRegionalInventoryRequest|undefined, {}|undefined
      ]>;
  insertRegionalInventory(
      request: protos.google.shopping.merchant.inventories.v1.IInsertRegionalInventoryRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.inventories.v1.IRegionalInventory,
          protos.google.shopping.merchant.inventories.v1.IInsertRegionalInventoryRequest|null|undefined,
          {}|null|undefined>): void;
  insertRegionalInventory(
      request: protos.google.shopping.merchant.inventories.v1.IInsertRegionalInventoryRequest,
      callback: Callback<
  ...
  insertRegionalInventory(
    ...
    return this.innerApiCalls.insertRegionalInventory(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.inventories.v1.IRegionalInventory,
        protos.google.shopping.merchant.inventories.v1.IInsertRegionalInventoryRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('insertRegionalInventory response %j', response);
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/regional_inventory_service.delete_regional_inventory.js</caption>
 * region_tag:merchantapi_v1_generated_RegionalInventoryService_DeleteRegionalInventory_async
 */
  deleteRegionalInventory(
      request?: protos.google.shopping.merchant.inventories.v1.IDeleteRegionalInventoryRequest,
      options?: CallOptions):
      Promise<[
        protos.google.protobuf.IEmpty,
        protos.google.shopping.merchant.inventories.v1.IDeleteRegionalInventoryRequest|undefined, {}|undefined
      ]>;
  deleteRegionalInventory(
      request: protos.google.shopping.merchant.inventories.v1.IDeleteRegionalInventoryRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.protobuf.IEmpty,
          protos.google.shopping.merchant.inventories.v1.IDeleteRegionalInventoryRequest|null|undefined,
          {}|null|undefined>): void;
  deleteRegionalInventory(
      request: protos.google.shopping.merchant.inventories.v1.IDeleteRegionalInventoryRequest,
      callback: Callback<
  ...
  deleteRegionalInventory(
    ...
    return this.innerApiCalls.deleteRegionalInventory(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.protobuf.IEmpty,
        protos.google.shopping.merchant.inventories.v1.IDeleteRegionalInventoryRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('deleteRegionalInventory response %j', response);
        return [response, options, rawResponse];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.shopping.merchant.inventories.v1.RegionalInventory|RegionalInventory}.
 ...
 */
  listRegionalInventories(
      request?: protos.google.shopping.merchant.inventories.v1.IListRegionalInventoriesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.inventories.v1.IRegionalInventory[],
        protos.google.shopping.merchant.inventories.v1.IListRegionalInventoriesRequest|null,
        protos.google.shopping.merchant.inventories.v1.IListRegionalInventoriesResponse
      ]>;
  listRegionalInventories(
      request: protos.google.shopping.merchant.inventories.v1.IListRegionalInventoriesRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.shopping.merchant.inventories.v1.IListRegionalInventoriesRequest,
          protos.google.shopping.merchant.inventories.v1.IListRegionalInventoriesResponse|null|undefined,
          protos.google.shopping.merchant.inventories.v1.IRegionalInventory>): void;
  listRegionalInventories(
      request: protos.google.shopping.merchant.inventories.v1.IListRegionalInventoriesRequest,
      callback: PaginationCallback<
          protos.google.shopping.merchant.inventories.v1.IListRegionalInventoriesRequest,
  ...
  listRegionalInventories(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.shopping.merchant.inventories.v1.IListRegionalInventoriesRequest,
      protos.google.shopping.merchant.inventories.v1.IListRegionalInventoriesResponse|null|undefined,
      protos.google.shopping.merchant.inventories.v1.IRegionalInventory>|undefined = callback
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.shopping.merchant.inventories.v1.RegionalInventory|RegionalInventory} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   {@link protos.google.shopping.merchant.inventories.v1.RegionalInventory|RegionalInventory}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/regional_inventory_service.list_regional_inventories.js</caption>
 * region_tag:merchantapi_v1_generated_RegionalInventoryService_ListRegionalInventories_async
 */
  listRegionalInventoriesAsync(
      request?: protos.google.shopping.merchant.inventories.v1.IListRegionalInventoriesRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.shopping.merchant.inventories.v1.IRegionalInventory>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listRegionalInventories.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.shopping.merchant.inventories.v1.IRegionalInventory>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
