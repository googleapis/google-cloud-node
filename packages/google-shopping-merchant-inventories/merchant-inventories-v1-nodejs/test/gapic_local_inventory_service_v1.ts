...
describe('v1.LocalInventoryServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new localinventoryserviceModule.v1.LocalInventoryServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = localinventoryserviceModule.v1.LocalInventoryServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = localinventoryserviceModule.v1.LocalInventoryServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'merchantapi.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new localinventoryserviceModule.v1.LocalInventoryServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new localinventoryserviceModule.v1.LocalInventoryServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'merchantapi.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new localinventoryserviceModule.v1.LocalInventoryServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new localinventoryserviceModule.v1.LocalInventoryServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = localinventoryserviceModule.v1.LocalInventoryServiceClient.port;
            assert(port);
    ...
    describe('insertLocalInventory', () => {
        it('invokes insertLocalInventory without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.inventories.v1.InsertLocalInventoryRequest', ['parent']);
        ...
        it('invokes insertLocalInventory without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.insertLocalInventory(
                    request,
                    (err?: Error|null, result?: protos.google.shopping.merchant.inventories.v1.ILocalInventory|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deleteLocalInventory', () => {
        it('invokes deleteLocalInventory without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.inventories.v1.DeleteLocalInventoryRequest', ['name']);
    ...
    describe('listLocalInventories', () => {
        it('invokes listLocalInventories without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.shopping.merchant.inventories.v1.ListLocalInventoriesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.shopping.merchant.inventories.v1.LocalInventory()),
              generateSampleMessage(new protos.google.shopping.merchant.inventories.v1.LocalInventory()),
              generateSampleMessage(new protos.google.shopping.merchant.inventories.v1.LocalInventory()),
            ];
        ...
        it('invokes listLocalInventoriesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.shopping.merchant.inventories.v1.LocalInventory) => {
