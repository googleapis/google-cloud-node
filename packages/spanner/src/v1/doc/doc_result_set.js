...
/**
 * Results from {@link Read} or
 * {@link ExecuteSql}.
 *
 * @property {Object} metadata
 *   Metadata about the result set, such as row type information.
 *
 *   This object should have the same structure as [ResultSetMetadata]{@link ResultSetMetadata}
 *
 * @property {Object[]} rows
 *   Each element in `rows` is a row whose format is defined by
 *   {@link metadata.row_type}. The ith element
 *   in each row matches the ith field in
 *   {@link metadata.row_type}. Elements are
 ...
 *   {@link ExecuteSqlRequest.query_mode}.
 *
 *   This object should have the same structure as [ResultSetStats]{@link ResultSetStats}
 *
 * @class
 ...
 *   `PartialResultSet`(s). This is denoted by the {@link chunked_value}
 ...
 *   If true, then the final value in {@link values} is chunked, and must
 ...
 *   {@link ExecuteSqlRequest.query_mode} and are sent
...
/**
 * Metadata about a {@link ResultSet} or {@link PartialResultSet}.
 *
 ...
 *       ]
 *
 *   This object should have the same structure as [StructType]{@link StructType}
 *
 * @property {Object} transaction
 *   If the read or SQL query began a transaction as a side-effect, the
 *   information about the new transaction is yielded here.
 *
 *   This object should have the same structure as [Transaction]{@link Transaction}
 *
 * @class
...
/**
 * Additional statistics about a {@link ResultSet} or {@link PartialResultSet}.
 *
 * @property {Object} queryPlan
 *   {@link QueryPlan} for the query associated with this result.
 *
 *   This object should have the same structure as [QueryPlan]{@link QueryPlan}
 *
