...
function main(name, expression) {
  ...
  async function callValidateIapAttributeExpression() {
    // Construct request
    const request = {
      name,
      expression,
    ...
    // Run request
    const response = await iapClient.validateIapAttributeExpression(request);
    console.log(response);
  }

  callValidateIapAttributeExpression();
