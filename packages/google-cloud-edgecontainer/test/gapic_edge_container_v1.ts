...
describe('v1.EdgeContainerClient', () => {
  ...
  describe('getMachine', () => {
    it('invokes getMachine without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('GetMachineRequest', ['name']);
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1}`;
      const expectedResponse = generateSampleMessage(
  ...
  describe('getVpnConnection', () => {
    it('invokes getVpnConnection without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('GetVpnConnectionRequest', [
        'name',
      ]);
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1}`;
  ...
  describe('createVpnConnection', () => {
    it('invokes createVpnConnection without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('CreateVpnConnectionRequest', [
        'parent',
      ]);
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1}`;
  ...
  describe('deleteVpnConnection', () => {
    it('invokes deleteVpnConnection without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('DeleteVpnConnectionRequest', [
        'name',
      ]);
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1}`;
  ...
  describe('listMachines', () => {
    it('invokes listMachines without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('ListMachinesRequest', [
        'parent',
      ]);
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1}`;
  ...
  describe('listVpnConnections', () => {
    it('invokes listVpnConnections without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('ListVpnConnectionsRequest', [
        'parent',
      ]);
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1}`;
