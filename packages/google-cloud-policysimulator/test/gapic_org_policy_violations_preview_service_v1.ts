...
describe('v1.OrgPolicyViolationsPreviewServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          orgpolicyviolationspreviewserviceModule.v1
            .OrgPolicyViolationsPreviewServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        ...
        const apiEndpoint =
          orgpolicyviolationspreviewserviceModule.v1
            .OrgPolicyViolationsPreviewServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'policysimulator.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        orgpolicyviolationspreviewserviceModule.v1
          .OrgPolicyViolationsPreviewServiceClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(
        client.orgPolicyViolationsPreviewServiceStub,
        undefined,
      );
  ...
  describe('getOrgPolicyViolationsPreview', () => {
    it('invokes getOrgPolicyViolationsPreview without error', async () => {
      ...
      client.innerApiCalls.getOrgPolicyViolationsPreview =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getOrgPolicyViolationsPreview(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getOrgPolicyViolationsPreview as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getOrgPolicyViolationsPreview without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getOrgPolicyViolationsPreview(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.policysimulator.v1.IOrgPolicyViolationsPreview | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getOrgPolicyViolationsPreview with error', async () => {
      ...
      client.innerApiCalls.getOrgPolicyViolationsPreview = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getOrgPolicyViolationsPreview(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getOrgPolicyViolationsPreview as SinonStub
  ...
  describe('createOrgPolicyViolationsPreview', () => {
    it('invokes createOrgPolicyViolationsPreview without error', async () => {
      ...
      client.innerApiCalls.createOrgPolicyViolationsPreview =
        stubLongRunningCall(expectedResponse);
      const [operation] =
        await client.createOrgPolicyViolationsPreview(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createOrgPolicyViolationsPreview as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createOrgPolicyViolationsPreview as SinonStub
    ...
    it('invokes createOrgPolicyViolationsPreview with call error', async () => {
      ...
      await assert.rejects(
        client.createOrgPolicyViolationsPreview(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createOrgPolicyViolationsPreview as SinonStub
    ...
    it('invokes checkCreateOrgPolicyViolationsPreviewProgress without error', async () => {
      ...
      const decodedOperation =
        await client.checkCreateOrgPolicyViolationsPreviewProgress(
    ...
    it('invokes checkCreateOrgPolicyViolationsPreviewProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateOrgPolicyViolationsPreviewProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listOrgPolicyViolationsPreviews', () => {
    it('invokes listOrgPolicyViolationsPreviews without error', async () => {
      ...
      client.innerApiCalls.listOrgPolicyViolationsPreviews =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listOrgPolicyViolationsPreviews(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listOrgPolicyViolationsPreviews as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listOrgPolicyViolationsPreviews as SinonStub
    ...
    it('invokes listOrgPolicyViolationsPreviews with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listOrgPolicyViolationsPreviews = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listOrgPolicyViolationsPreviews(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listOrgPolicyViolationsPreviews as SinonStub
    ...
    it('invokes listOrgPolicyViolationsPreviewsStream without error', async () => {
      ...
      client.descriptors.page.listOrgPolicyViolationsPreviews.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.policysimulator.v1.OrgPolicyViolationsPreview,
          ) => {
      ...
      assert(
        (
          client.descriptors.page.listOrgPolicyViolationsPreviews
    ...
    it('uses async iteration with listOrgPolicyViolationsPreviews without error', async () => {
      ...
      client.descriptors.page.listOrgPolicyViolationsPreviews.asyncIterate =
  ...
  describe('listOrgPolicyViolations', () => {
    it('invokes listOrgPolicyViolations without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.policysimulator.v1.OrgPolicyViolation(),
        ),
        generateSampleMessage(
          new protos.google.cloud.policysimulator.v1.OrgPolicyViolation(),
        ),
      ...
      client.innerApiCalls.listOrgPolicyViolations =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listOrgPolicyViolations(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listOrgPolicyViolations as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listOrgPolicyViolations as SinonStub
    ...
    it('invokes listOrgPolicyViolations with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listOrgPolicyViolations = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listOrgPolicyViolations(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listOrgPolicyViolations as SinonStub
    ...
    it('invokes listOrgPolicyViolationsStream without error', async () => {
      ...
      client.descriptors.page.listOrgPolicyViolations.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.policysimulator.v1.OrgPolicyViolation,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (
          client.descriptors.page.listOrgPolicyViolations
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listOrgPolicyViolations, request),
      );
      assert(
        (
          client.descriptors.page.listOrgPolicyViolations
    ...
    it('uses async iteration with listOrgPolicyViolations without error', async () => {
      ...
      client.descriptors.page.listOrgPolicyViolations.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
