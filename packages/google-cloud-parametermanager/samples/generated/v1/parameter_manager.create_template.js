...
function main(parent, templateId, template) {
  // [START parametermanager_v1_generated_ParameterManager_CreateTemplate_async]
  /**
  ...
  async function callCreateTemplate() {
    ...
    // Run request
    const response = await parametermanagerClient.createTemplate(request);
    console.log(response);
  }

  callCreateTemplate();
  // [END parametermanager_v1_generated_ParameterManager_CreateTemplate_async]
}
