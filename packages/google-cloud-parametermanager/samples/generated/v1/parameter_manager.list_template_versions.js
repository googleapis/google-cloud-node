...
function main(parent) {
  // [START parametermanager_v1_generated_ParameterManager_ListTemplateVersions_async]
  /**
  ...
  async function callListTemplateVersions() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = parametermanagerClient.listTemplateVersionsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListTemplateVersions();
  // [END parametermanager_v1_generated_ParameterManager_ListTemplateVersions_async]
}
