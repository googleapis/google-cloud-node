...
function main(templateVersion) {
  ...
  async function callUpdateTemplateVersion() {
    // Construct request
    const request = {
      templateVersion,
    };
    ...
    // Run request
    const response = await parametermanagerClient.updateTemplateVersion(request);
    console.log(response);
  }

  callUpdateTemplateVersion();
