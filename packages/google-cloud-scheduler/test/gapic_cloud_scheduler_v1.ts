...
describe('v1.CloudSchedulerClient', () => {
    ...
    describe('getJob', () => {
        it('invokes getJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.scheduler.v1.GetJobRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.scheduler.v1.Job());
    ...
    describe('createJob', () => {
        it('invokes createJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.scheduler.v1.CreateJobRequest());
            request.parent = '';
    ...
    describe('updateJob', () => {
        it('invokes updateJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.scheduler.v1.UpdateJobRequest());
            request.job = {};
            request.job.name = '';
    ...
    describe('pauseJob', () => {
        it('invokes pauseJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.scheduler.v1.PauseJobRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('runJob', () => {
        it('invokes runJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.scheduler.v1.RunJobRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listJobs', () => {
        it('invokes listJobs without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.scheduler.v1.ListJobsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
