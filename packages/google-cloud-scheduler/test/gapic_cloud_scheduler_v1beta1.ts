...
describe('v1beta1.CloudSchedulerClient', () => {
    ...
    describe('getJob', () => {
        it('invokes getJob without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.scheduler.v1beta1.Job());
    ...
    describe('createJob', () => {
        ...
        it('invokes createJob with error', async () => {
            ...
            await assert.rejects(async () => { await client.createJob(request); }, expectedError);
            assert((client.innerApiCalls.createJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('pauseJob', () => {
        it('invokes pauseJob without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.pauseJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes pauseJob with error', async () => {
            ...
            await assert.rejects(async () => { await client.pauseJob(request); }, expectedError);
            assert((client.innerApiCalls.pauseJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('resumeJob', () => {
        it('invokes resumeJob without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.resumeJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes resumeJob with error', async () => {
            ...
            await assert.rejects(async () => { await client.resumeJob(request); }, expectedError);
            assert((client.innerApiCalls.resumeJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('runJob', () => {
        it('invokes runJob without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.runJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes runJob with error', async () => {
            ...
            await assert.rejects(async () => { await client.runJob(request); }, expectedError);
            assert((client.innerApiCalls.runJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
