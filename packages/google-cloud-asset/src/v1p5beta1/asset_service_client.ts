...
export class AssetServiceClient {
   ...
   *   The first element is Array of [Asset]{@link google.cloud.asset.v1p5beta1.Asset} that corresponds to
   *   the one page received from the API server.
   *   If the second element is not null it contains the request object of type [ListAssetsRequest]{@link google.cloud.asset.v1p5beta1.ListAssetsRequest}
   *   that can be used to obtain the next page of the results.
   *   If it is null, the next page does not exist.
   *   The third element contains the raw response received from the API server. Its type is
   *   [ListAssetsResponse]{@link google.cloud.asset.v1p5beta1.ListAssetsResponse}.
   *
