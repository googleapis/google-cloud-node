...
describe('v1p1beta1.AssetServiceClient', () => {
  ...
  describe('searchResources', () => {
    it('invokes searchResources without error', done => {
      const client = new assetserviceModule.v1p1beta1.AssetServiceClient({
      ...
      client.searchResources(request, (err: FakeError, response: {}) => {
        assert.ifError(err);
  ...
  describe('searchResourcesStream', () => {
    it('invokes searchResourcesStream without error', done => {
      const client = new assetserviceModule.v1p1beta1.AssetServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
  ...
  describe('searchIamPolicies', () => {
    it('invokes searchIamPolicies without error', done => {
      const client = new assetserviceModule.v1p1beta1.AssetServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      client.searchIamPolicies(request, (err: FakeError, response: {}) => {
        assert.ifError(err);
        assert.deepStrictEqual(response, expectedResponse);
        done();
      });
  ...
  describe('searchIamPoliciesStream', () => {
    it('invokes searchIamPoliciesStream without error', done => {
      const client = new assetserviceModule.v1p1beta1.AssetServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      const stream = client
        .searchIamPoliciesStream(request, {})
        .on('data', (response: {}) => {
          assert.deepStrictEqual(response, expectedResponse);
          done();
        })
