...
[![npm version](https://img.shields.io/npm/v/@google-cloud/workflows-executions.svg)](https://www.npmjs.org/package/@google-cloud/workflows-executions)
...
```bash
npm install @google-cloud/workflows-executions
```
...
For example, `npm install @google-cloud/workflows-executions@legacy-8` installs client libraries
