...
shutil.rmtree('packages/google-cloud-workflows-executions/v1', ignore_errors=True)
shutil.rmtree('packages/google-cloud-workflows-executions/v1beta', ignore_errors=True)
