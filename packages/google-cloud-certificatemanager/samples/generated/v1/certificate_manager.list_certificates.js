...
function main(parent) {
  // [START certificatemanager_v1_generated_CertificateManager_ListCertificates_async]
  /**
  ...
  async function callListCertificates() {
    ...
    // Run request
    const iterable = certificatemanagerClient.listCertificatesAsync(request);
  ...
  // [END certificatemanager_v1_generated_CertificateManager_ListCertificates_async]
}
