...
[the CHANGELOG](googleapis/nodejs-certificate-manager/CHANGELOG.md).

* [Certificate Manager Node.js Client API Reference][client-docs]
* [Certificate Manager Documentation][product-docs]
* [github.com/googleapis/nodejs-certificate-manager](googleapis/nodejs-certificate-manager)
