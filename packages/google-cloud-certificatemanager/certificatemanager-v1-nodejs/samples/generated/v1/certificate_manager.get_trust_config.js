...
function main(name) {
  // [START certificatemanager_v1_generated_CertificateManager_GetTrustConfig_async]
  /**
  ...
  async function callGetTrustConfig() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await certificatemanagerClient.getTrustConfig(request);
