...
function main(parent) {
  // [START certificatemanager_v1_generated_CertificateManager_ListDnsAuthorizations_async]
  /**
  ...
  async function callListDnsAuthorizations() {
    ...
    // Run request
    const iterable = certificatemanagerClient.listDnsAuthorizationsAsync(request);
  ...
  // [END certificatemanager_v1_generated_CertificateManager_ListDnsAuthorizations_async]
}
