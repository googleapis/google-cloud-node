...
describe('v1.LookupServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = lookupserviceModule.v1.LookupServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = lookupserviceModule.v1.LookupServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'servicedirectory.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new lookupserviceModule.v1.LookupServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'servicedirectory.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new lookupserviceModule.v1.LookupServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'servicedirectory.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new lookupserviceModule.v1.LookupServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new lookupserviceModule.v1.LookupServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('resolveService', () => {
        it('invokes resolveService without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.servicedirectory.v1.ResolveServiceRequest', ['name']);
        ...
        it('invokes resolveService without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.resolveService(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.servicedirectory.v1.IResolveServiceResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
