...
export class LookupServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.servicedirectory.v1beta1.LookupService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.lookupServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.servicedirectory.v1beta1.LookupService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.servicedirectory.v1beta1.LookupService,
 ...
 */
  resolveService(
      ...
      Promise<[
        ...
        protos.google.cloud.servicedirectory.v1beta1.IResolveServiceRequest|undefined, {}|undefined
      ]>;
  resolveService(
      request: protos.google.cloud.servicedirectory.v1beta1.IResolveServiceRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.servicedirectory.v1beta1.IResolveServiceResponse,
          protos.google.cloud.servicedirectory.v1beta1.IResolveServiceRequest|null|undefined,
          {}|null|undefined>): void;
  resolveService(
      request: protos.google.cloud.servicedirectory.v1beta1.IResolveServiceRequest,
      callback: Callback<
