...
describe('v1.DeviceManagerClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new devicemanagerModule.v1.DeviceManagerClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'cloudiot.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new devicemanagerModule.v1.DeviceManagerClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'cloudiot.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new devicemanagerModule.v1.DeviceManagerClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new devicemanagerModule.v1.DeviceManagerClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createDeviceRegistry', () => {
        it('invokes createDeviceRegistry without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.iot.v1.CreateDeviceRegistryRequest', ['parent']);
    ...
    describe('getDeviceRegistry', () => {
        it('invokes getDeviceRegistry without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.iot.v1.GetDeviceRegistryRequest', ['name']);
    ...
    describe('updateDeviceRegistry', () => {
        it('invokes updateDeviceRegistry without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.iot.v1.UpdateDeviceRegistryRequest', ['deviceRegistry', 'name']);
    ...
    describe('deleteDeviceRegistry', () => {
        it('invokes deleteDeviceRegistry without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.iot.v1.DeleteDeviceRegistryRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createDevice', () => {
        it('invokes createDevice without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.iot.v1.CreateDeviceRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getDevice', () => {
        it('invokes getDevice without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.iot.v1.GetDeviceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.iot.v1.Device()
    ...
    describe('updateDevice', () => {
        it('invokes updateDevice without error', async () => {
            ...
            request.device ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.iot.v1.UpdateDeviceRequest', ['device', 'name']);
    ...
    describe('deleteDevice', () => {
        it('invokes deleteDevice without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.iot.v1.DeleteDeviceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('modifyCloudToDeviceConfig', () => {
        it('invokes modifyCloudToDeviceConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.iot.v1.ModifyCloudToDeviceConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listDeviceConfigVersions', () => {
        it('invokes listDeviceConfigVersions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.iot.v1.ListDeviceConfigVersionsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listDeviceStates', () => {
        it('invokes listDeviceStates without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.iot.v1.ListDeviceStatesRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('sendCommandToDevice', () => {
        it('invokes sendCommandToDevice without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.iot.v1.SendCommandToDeviceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('bindDeviceToGateway', () => {
        it('invokes bindDeviceToGateway without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.iot.v1.BindDeviceToGatewayRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('unbindDeviceFromGateway', () => {
        it('invokes unbindDeviceFromGateway without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.iot.v1.UnbindDeviceFromGatewayRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listDeviceRegistries', () => {
        it('invokes listDeviceRegistries without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.iot.v1.ListDeviceRegistriesRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listDevices', () => {
        it('invokes listDevices without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.iot.v1.ListDevicesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
