...
function main(parent) {
  // [START developerconnect_v1_generated_InsightsConfigService_ListDeploymentEvents_async]
  /**
  ...
  async function callListDeploymentEvents() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = developerconnectClient.listDeploymentEventsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListDeploymentEvents();
  // [END developerconnect_v1_generated_InsightsConfigService_ListDeploymentEvents_async]
}
