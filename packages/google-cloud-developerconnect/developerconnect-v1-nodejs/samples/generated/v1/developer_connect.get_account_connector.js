...
function main(name) {
  // [START developerconnect_v1_generated_DeveloperConnect_GetAccountConnector_async]
  /**
  ...
  async function callGetAccountConnector() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await developerconnectClient.getAccountConnector(request);
    console.log(response);
  }

  callGetAccountConnector();
