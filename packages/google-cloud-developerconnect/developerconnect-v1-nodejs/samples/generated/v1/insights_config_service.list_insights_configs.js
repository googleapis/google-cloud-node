...
function main(parent) {
  // [START developerconnect_v1_generated_InsightsConfigService_ListInsightsConfigs_async]
  /**
  ...
  async function callListInsightsConfigs() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = developerconnectClient.listInsightsConfigsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListInsightsConfigs();
