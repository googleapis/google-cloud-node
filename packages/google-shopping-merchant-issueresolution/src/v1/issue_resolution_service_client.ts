...
export class IssueResolutionServiceClient {
    ...
    this.issueResolutionServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ...
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.shopping.merchant.issueresolution.v1
  ...
  renderAccountIssues(
    ...
    [
      ...
      (
        | protos.google.shopping.merchant.issueresolution.v1.IRenderAccountIssuesRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  renderProductIssues(
    ...
    [
      ...
      (
        | protos.google.shopping.merchant.issueresolution.v1.IRenderProductIssuesRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  triggerAction(
    ...
    [
      ...
      (
        | protos.google.shopping.merchant.issueresolution.v1.ITriggerActionRequest
        | undefined
      ),
      {} | undefined,
    ]
   ...
   * @returns {string} A string representing the account.
   */
  matchAccountFromAggregateProductStatusName(
    aggregateProductStatusName: string,
  ) {
    return this.pathTemplates.aggregateProductStatusPathTemplate.match(
   ...
   */
  matchAggregateProductStatusFromAggregateProductStatusName(
    aggregateProductStatusName: string,
  ) {
    return this.pathTemplates.aggregateProductStatusPathTemplate.match(
      aggregateProductStatusName,
