 ...
 * `src/v1/issue_resolution_service_client_config.json`.
...
export class IssueResolutionServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.shopping.merchant.issueresolution.v1.IssueResolutionService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.issueResolutionServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.shopping.merchant.issueresolution.v1.IssueResolutionService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.shopping.merchant.issueresolution.v1.IssueResolutionService,
 ...
 *   The first element of the array is an object representing {@link protos.google.shopping.merchant.issueresolution.v1.RenderAccountIssuesResponse|RenderAccountIssuesResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/issue_resolution_service.render_account_issues.js</caption>
 * region_tag:merchantapi_v1_generated_IssueResolutionService_RenderAccountIssues_async
 */
  renderAccountIssues(
      request?: protos.google.shopping.merchant.issueresolution.v1.IRenderAccountIssuesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.issueresolution.v1.IRenderAccountIssuesResponse,
        protos.google.shopping.merchant.issueresolution.v1.IRenderAccountIssuesRequest|undefined, {}|undefined
      ]>;
  renderAccountIssues(
      request: protos.google.shopping.merchant.issueresolution.v1.IRenderAccountIssuesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.issueresolution.v1.IRenderAccountIssuesResponse,
          protos.google.shopping.merchant.issueresolution.v1.IRenderAccountIssuesRequest|null|undefined,
          {}|null|undefined>): void;
  renderAccountIssues(
      request: protos.google.shopping.merchant.issueresolution.v1.IRenderAccountIssuesRequest,
      callback: Callback<
  ...
  renderAccountIssues(
    ...
    return this.innerApiCalls.renderAccountIssues(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.issueresolution.v1.IRenderAccountIssuesResponse,
        protos.google.shopping.merchant.issueresolution.v1.IRenderAccountIssuesRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('renderAccountIssues response %j', response);
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.shopping.merchant.issueresolution.v1.RenderProductIssuesResponse|RenderProductIssuesResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/issue_resolution_service.render_product_issues.js</caption>
 * region_tag:merchantapi_v1_generated_IssueResolutionService_RenderProductIssues_async
 */
  renderProductIssues(
      request?: protos.google.shopping.merchant.issueresolution.v1.IRenderProductIssuesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.issueresolution.v1.IRenderProductIssuesResponse,
        protos.google.shopping.merchant.issueresolution.v1.IRenderProductIssuesRequest|undefined, {}|undefined
      ]>;
  renderProductIssues(
      request: protos.google.shopping.merchant.issueresolution.v1.IRenderProductIssuesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.issueresolution.v1.IRenderProductIssuesResponse,
          protos.google.shopping.merchant.issueresolution.v1.IRenderProductIssuesRequest|null|undefined,
          {}|null|undefined>): void;
  renderProductIssues(
      request: protos.google.shopping.merchant.issueresolution.v1.IRenderProductIssuesRequest,
      callback: Callback<
  ...
  renderProductIssues(
    ...
    return this.innerApiCalls.renderProductIssues(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.issueresolution.v1.IRenderProductIssuesResponse,
        protos.google.shopping.merchant.issueresolution.v1.IRenderProductIssuesRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('renderProductIssues response %j', response);
        return [response, options, rawResponse];
 ...
 * {@link protos.google.shopping.merchant.issueresolution.v1.InputField.id|Ids} for all
 ...
 *   Format: `accounts/{account}`
 * @param {google.shopping.merchant.issueresolution.v1.TriggerActionPayload} request.payload
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.shopping.merchant.issueresolution.v1.TriggerActionResponse|TriggerActionResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/issue_resolution_service.trigger_action.js</caption>
 * region_tag:merchantapi_v1_generated_IssueResolutionService_TriggerAction_async
 */
  triggerAction(
      request?: protos.google.shopping.merchant.issueresolution.v1.ITriggerActionRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.issueresolution.v1.ITriggerActionResponse,
        protos.google.shopping.merchant.issueresolution.v1.ITriggerActionRequest|undefined, {}|undefined
      ]>;
  triggerAction(
      request: protos.google.shopping.merchant.issueresolution.v1.ITriggerActionRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.shopping.merchant.issueresolution.v1.ITriggerActionResponse,
          protos.google.shopping.merchant.issueresolution.v1.ITriggerActionRequest|null|undefined,
          {}|null|undefined>): void;
  triggerAction(
      request: protos.google.shopping.merchant.issueresolution.v1.ITriggerActionRequest,
      callback: Callback<
  ...
  triggerAction(
    ...
    return this.innerApiCalls.triggerAction(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.shopping.merchant.issueresolution.v1.ITriggerActionResponse,
        protos.google.shopping.merchant.issueresolution.v1.ITriggerActionRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('triggerAction response %j', response);
        return [response, options, rawResponse];
