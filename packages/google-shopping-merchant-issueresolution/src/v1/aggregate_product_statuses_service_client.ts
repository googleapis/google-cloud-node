 ...
 * `src/v1/aggregate_product_statuses_service_client_config.json`.
...
export class AggregateProductStatusesServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.shopping.merchant.issueresolution.v1.AggregateProductStatusesService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.aggregateProductStatusesServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.shopping.merchant.issueresolution.v1.AggregateProductStatusesService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.shopping.merchant.issueresolution.v1.AggregateProductStatusesService,
 ...
 *   The first element of the array is Array of {@link protos.google.shopping.merchant.issueresolution.v1.AggregateProductStatus|AggregateProductStatus}.
 ...
 */
  listAggregateProductStatuses(
      request?: protos.google.shopping.merchant.issueresolution.v1.IListAggregateProductStatusesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.shopping.merchant.issueresolution.v1.IAggregateProductStatus[],
        protos.google.shopping.merchant.issueresolution.v1.IListAggregateProductStatusesRequest|null,
        protos.google.shopping.merchant.issueresolution.v1.IListAggregateProductStatusesResponse
      ]>;
  listAggregateProductStatuses(
      request: protos.google.shopping.merchant.issueresolution.v1.IListAggregateProductStatusesRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.shopping.merchant.issueresolution.v1.IListAggregateProductStatusesRequest,
          protos.google.shopping.merchant.issueresolution.v1.IListAggregateProductStatusesResponse|null|undefined,
          protos.google.shopping.merchant.issueresolution.v1.IAggregateProductStatus>): void;
  listAggregateProductStatuses(
      request: protos.google.shopping.merchant.issueresolution.v1.IListAggregateProductStatusesRequest,
      callback: PaginationCallback<
          protos.google.shopping.merchant.issueresolution.v1.IListAggregateProductStatusesRequest,
  ...
  listAggregateProductStatuses(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.shopping.merchant.issueresolution.v1.IListAggregateProductStatusesRequest,
      protos.google.shopping.merchant.issueresolution.v1.IListAggregateProductStatusesResponse|null|undefined,
      protos.google.shopping.merchant.issueresolution.v1.IAggregateProductStatus>|undefined = callback
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.shopping.merchant.issueresolution.v1.AggregateProductStatus|AggregateProductStatus} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   {@link protos.google.shopping.merchant.issueresolution.v1.AggregateProductStatus|AggregateProductStatus}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/aggregate_product_statuses_service.list_aggregate_product_statuses.js</caption>
 * region_tag:merchantapi_v1_generated_AggregateProductStatusesService_ListAggregateProductStatuses_async
 */
  listAggregateProductStatusesAsync(
      request?: protos.google.shopping.merchant.issueresolution.v1.IListAggregateProductStatusesRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.shopping.merchant.issueresolution.v1.IAggregateProductStatus>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listAggregateProductStatuses.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.shopping.merchant.issueresolution.v1.IAggregateProductStatus>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
