...
export {v1, AggregateProductStatusesServiceClient, IssueResolutionServiceClient};
export default {v1, AggregateProductStatusesServiceClient, IssueResolutionServiceClient};
