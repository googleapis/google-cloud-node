  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          issueresolutionserviceModule.v1.IssueResolutionServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        issueresolutionserviceModule.v1.IssueResolutionServiceClient.port;
      assert(port);
    ...
    it('invokes renderAccountIssues without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.renderAccountIssues(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.issueresolution.v1.IRenderAccountIssuesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes renderProductIssues without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.renderProductIssues(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.issueresolution.v1.IRenderProductIssuesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes triggerAction without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.triggerAction(
          ...
          (
            err?: Error | null,
            result?: protos.google.shopping.merchant.issueresolution.v1.ITriggerActionResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
