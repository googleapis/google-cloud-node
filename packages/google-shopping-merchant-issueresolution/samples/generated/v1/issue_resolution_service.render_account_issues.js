...
function main(name) {
  // [START merchantapi_v1_generated_IssueResolutionService_RenderAccountIssues_async]
  /**
  ...
  async function callRenderAccountIssues() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await issueresolutionClient.renderAccountIssues(request);
    console.log(response);
  }

  callRenderAccountIssues();
  // [END merchantapi_v1_generated_IssueResolutionService_RenderAccountIssues_async]
}
