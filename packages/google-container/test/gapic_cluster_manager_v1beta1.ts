...
describe('v1beta1.ClusterManagerClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new clustermanagerModule.v1beta1.ClusterManagerClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'container.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new clustermanagerModule.v1beta1.ClusterManagerClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'container.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new clustermanagerModule.v1beta1.ClusterManagerClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new clustermanagerModule.v1beta1.ClusterManagerClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('listClusters', () => {
        it('invokes listClusters without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.ListClustersRequest', ['parent']);
            request.parent = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.ListClustersRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.ListClustersRequest', ['zone']);
            ...
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.ListClustersResponse()
            );
    ...
    describe('getCluster', () => {
        it('invokes getCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.GetClusterRequest', ['name']);
            request.name = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.GetClusterRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.GetClusterRequest', ['zone']);
            request.zone = defaultValue3;
            const defaultValue4 =
              getTypeDefaultValue('.google.container.v1beta1.GetClusterRequest', ['clusterId']);
            ...
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.Cluster()
            );
    ...
    describe('createCluster', () => {
        it('invokes createCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.CreateClusterRequest', ['parent']);
            request.parent = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.CreateClusterRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.CreateClusterRequest', ['zone']);
            request.zone = defaultValue3;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }&project_id=${defaultValue2 ?? '' }&zone=${defaultValue3 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateCluster', () => {
        it('invokes updateCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.UpdateClusterRequest', ['name']);
            request.name = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.UpdateClusterRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.UpdateClusterRequest', ['zone']);
            request.zone = defaultValue3;
            const defaultValue4 =
              getTypeDefaultValue('.google.container.v1beta1.UpdateClusterRequest', ['clusterId']);
            request.clusterId = defaultValue4;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }&project_id=${defaultValue2 ?? '' }&zone=${defaultValue3 ?? '' }&cluster_id=${defaultValue4 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.Operation()
    ...
    describe('updateNodePool', () => {
        it('invokes updateNodePool without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.UpdateNodePoolRequest', ['name']);
            request.name = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.UpdateNodePoolRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.UpdateNodePoolRequest', ['zone']);
            request.zone = defaultValue3;
            const defaultValue4 =
              getTypeDefaultValue('.google.container.v1beta1.UpdateNodePoolRequest', ['clusterId']);
            request.clusterId = defaultValue4;
            const defaultValue5 =
              getTypeDefaultValue('.google.container.v1beta1.UpdateNodePoolRequest', ['nodePoolId']);
    ...
    describe('setNodePoolAutoscaling', () => {
        it('invokes setNodePoolAutoscaling without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.SetNodePoolAutoscalingRequest', ['name']);
            request.name = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.SetNodePoolAutoscalingRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.SetNodePoolAutoscalingRequest', ['zone']);
            request.zone = defaultValue3;
            const defaultValue4 =
              getTypeDefaultValue('.google.container.v1beta1.SetNodePoolAutoscalingRequest', ['clusterId']);
            request.clusterId = defaultValue4;
            const defaultValue5 =
              getTypeDefaultValue('.google.container.v1beta1.SetNodePoolAutoscalingRequest', ['nodePoolId']);
            request.nodePoolId = defaultValue5;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }&project_id=${defaultValue2 ?? '' }&zone=${defaultValue3 ?? '' }&cluster_id=${defaultValue4 ?? '' }&node_pool_id=${defaultValue5 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.Operation()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.setNodePoolAutoscaling as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.setNodePoolAutoscaling as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('setLoggingService', () => {
        it('invokes setLoggingService without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.SetLoggingServiceRequest', ['name']);
            request.name = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.SetLoggingServiceRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.SetLoggingServiceRequest', ['zone']);
            request.zone = defaultValue3;
            const defaultValue4 =
              getTypeDefaultValue('.google.container.v1beta1.SetLoggingServiceRequest', ['clusterId']);
            request.clusterId = defaultValue4;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }&project_id=${defaultValue2 ?? '' }&zone=${defaultValue3 ?? '' }&cluster_id=${defaultValue4 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.Operation()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.setLoggingService as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.setLoggingService as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('setMonitoringService', () => {
        it('invokes setMonitoringService without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.SetMonitoringServiceRequest', ['name']);
            request.name = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.SetMonitoringServiceRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.SetMonitoringServiceRequest', ['zone']);
            request.zone = defaultValue3;
            const defaultValue4 =
              getTypeDefaultValue('.google.container.v1beta1.SetMonitoringServiceRequest', ['clusterId']);
            request.clusterId = defaultValue4;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }&project_id=${defaultValue2 ?? '' }&zone=${defaultValue3 ?? '' }&cluster_id=${defaultValue4 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.Operation()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.setMonitoringService as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.setMonitoringService as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('setAddonsConfig', () => {
        it('invokes setAddonsConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.SetAddonsConfigRequest', ['name']);
            request.name = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.SetAddonsConfigRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.SetAddonsConfigRequest', ['zone']);
            request.zone = defaultValue3;
            const defaultValue4 =
              getTypeDefaultValue('.google.container.v1beta1.SetAddonsConfigRequest', ['clusterId']);
            request.clusterId = defaultValue4;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }&project_id=${defaultValue2 ?? '' }&zone=${defaultValue3 ?? '' }&cluster_id=${defaultValue4 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.Operation()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.setAddonsConfig as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.setAddonsConfig as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('setLocations', () => {
        it('invokes setLocations without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.SetLocationsRequest', ['name']);
            request.name = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.SetLocationsRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.SetLocationsRequest', ['zone']);
            request.zone = defaultValue3;
            const defaultValue4 =
              getTypeDefaultValue('.google.container.v1beta1.SetLocationsRequest', ['clusterId']);
            request.clusterId = defaultValue4;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }&project_id=${defaultValue2 ?? '' }&zone=${defaultValue3 ?? '' }&cluster_id=${defaultValue4 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.Operation()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.setLocations as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.setLocations as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('updateMaster', () => {
        it('invokes updateMaster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.UpdateMasterRequest', ['name']);
            request.name = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.UpdateMasterRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.UpdateMasterRequest', ['zone']);
            request.zone = defaultValue3;
            const defaultValue4 =
              getTypeDefaultValue('.google.container.v1beta1.UpdateMasterRequest', ['clusterId']);
            request.clusterId = defaultValue4;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }&project_id=${defaultValue2 ?? '' }&zone=${defaultValue3 ?? '' }&cluster_id=${defaultValue4 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.Operation()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateMaster as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateMaster as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('setMasterAuth', () => {
        it('invokes setMasterAuth without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.SetMasterAuthRequest', ['name']);
            request.name = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.SetMasterAuthRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.SetMasterAuthRequest', ['zone']);
            request.zone = defaultValue3;
            const defaultValue4 =
              getTypeDefaultValue('.google.container.v1beta1.SetMasterAuthRequest', ['clusterId']);
            request.clusterId = defaultValue4;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }&project_id=${defaultValue2 ?? '' }&zone=${defaultValue3 ?? '' }&cluster_id=${defaultValue4 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.Operation()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.setMasterAuth as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.setMasterAuth as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('deleteCluster', () => {
        it('invokes deleteCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.DeleteClusterRequest', ['name']);
            request.name = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.DeleteClusterRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.DeleteClusterRequest', ['zone']);
            request.zone = defaultValue3;
            const defaultValue4 =
              getTypeDefaultValue('.google.container.v1beta1.DeleteClusterRequest', ['clusterId']);
            request.clusterId = defaultValue4;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }&project_id=${defaultValue2 ?? '' }&zone=${defaultValue3 ?? '' }&cluster_id=${defaultValue4 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.Operation()
    ...
    describe('listOperations', () => {
        it('invokes listOperations without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.ListOperationsRequest', ['parent']);
            request.parent = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.ListOperationsRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.ListOperationsRequest', ['zone']);
            request.zone = defaultValue3;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }&project_id=${defaultValue2 ?? '' }&zone=${defaultValue3 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.ListOperationsResponse()
            );
            client.innerApiCalls.listOperations = stubSimpleCall(expectedResponse);
            const [response] = await client.listOperations(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listOperations as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listOperations as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('getOperation', () => {
        it('invokes getOperation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.GetOperationRequest', ['name']);
            request.name = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.GetOperationRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.GetOperationRequest', ['zone']);
            request.zone = defaultValue3;
            const defaultValue4 =
              getTypeDefaultValue('.google.container.v1beta1.GetOperationRequest', ['operationId']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getOperation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getOperation as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('cancelOperation', () => {
        it('invokes cancelOperation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.CancelOperationRequest', ['name']);
            request.name = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.CancelOperationRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.CancelOperationRequest', ['zone']);
            request.zone = defaultValue3;
            const defaultValue4 =
              getTypeDefaultValue('.google.container.v1beta1.CancelOperationRequest', ['operationId']);
            request.operationId = defaultValue4;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }&project_id=${defaultValue2 ?? '' }&zone=${defaultValue3 ?? '' }&operation_id=${defaultValue4 ?? '' }`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.cancelOperation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.cancelOperation as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('getServerConfig', () => {
        it('invokes getServerConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.GetServerConfigRequest', ['name']);
            request.name = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.GetServerConfigRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.GetServerConfigRequest', ['zone']);
            request.zone = defaultValue3;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }&project_id=${defaultValue2 ?? '' }&zone=${defaultValue3 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.ServerConfig()
            );
    ...
    describe('getJSONWebKeys', () => {
        it('invokes getJSONWebKeys without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.GetJSONWebKeysRequest', ['parent']);
            request.parent = defaultValue1;
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getJsonWebKeys as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getJsonWebKeys as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('listNodePools', () => {
        it('invokes listNodePools without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.ListNodePoolsRequest', ['parent']);
            request.parent = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.ListNodePoolsRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.ListNodePoolsRequest', ['zone']);
            request.zone = defaultValue3;
            const defaultValue4 =
              getTypeDefaultValue('.google.container.v1beta1.ListNodePoolsRequest', ['clusterId']);
            request.clusterId = defaultValue4;
            ...
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.ListNodePoolsResponse()
            );
    ...
    describe('getNodePool', () => {
        it('invokes getNodePool without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.GetNodePoolRequest', ['name']);
            request.name = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.GetNodePoolRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.GetNodePoolRequest', ['zone']);
            request.zone = defaultValue3;
            const defaultValue4 =
              getTypeDefaultValue('.google.container.v1beta1.GetNodePoolRequest', ['clusterId']);
            request.clusterId = defaultValue4;
            const defaultValue5 =
              getTypeDefaultValue('.google.container.v1beta1.GetNodePoolRequest', ['nodePoolId']);
            request.nodePoolId = defaultValue5;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }&project_id=${defaultValue2 ?? '' }&zone=${defaultValue3 ?? '' }&cluster_id=${defaultValue4 ?? '' }&node_pool_id=${defaultValue5 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.NodePool()
            );
    ...
    describe('createNodePool', () => {
        it('invokes createNodePool without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.CreateNodePoolRequest', ['parent']);
            request.parent = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.CreateNodePoolRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.CreateNodePoolRequest', ['zone']);
            request.zone = defaultValue3;
            const defaultValue4 =
              getTypeDefaultValue('.google.container.v1beta1.CreateNodePoolRequest', ['clusterId']);
            request.clusterId = defaultValue4;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }&project_id=${defaultValue2 ?? '' }&zone=${defaultValue3 ?? '' }&cluster_id=${defaultValue4 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.Operation()
    ...
    describe('deleteNodePool', () => {
        it('invokes deleteNodePool without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.DeleteNodePoolRequest', ['name']);
            request.name = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.DeleteNodePoolRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.DeleteNodePoolRequest', ['zone']);
            request.zone = defaultValue3;
            const defaultValue4 =
              getTypeDefaultValue('.google.container.v1beta1.DeleteNodePoolRequest', ['clusterId']);
            request.clusterId = defaultValue4;
            const defaultValue5 =
              getTypeDefaultValue('.google.container.v1beta1.DeleteNodePoolRequest', ['nodePoolId']);
            request.nodePoolId = defaultValue5;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }&project_id=${defaultValue2 ?? '' }&zone=${defaultValue3 ?? '' }&cluster_id=${defaultValue4 ?? '' }&node_pool_id=${defaultValue5 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.Operation()
    ...
    describe('completeNodePoolUpgrade', () => {
        it('invokes completeNodePoolUpgrade without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.CompleteNodePoolUpgradeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.completeNodePoolUpgrade = stubSimpleCall(expectedResponse);
            const [response] = await client.completeNodePoolUpgrade(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.completeNodePoolUpgrade as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.completeNodePoolUpgrade as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes completeNodePoolUpgrade without error using callback', async () => {
            ...
            client.innerApiCalls.completeNodePoolUpgrade = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes completeNodePoolUpgrade with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.completeNodePoolUpgrade = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.completeNodePoolUpgrade(request), expectedError);
            const actualRequest = (client.innerApiCalls.completeNodePoolUpgrade as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.completeNodePoolUpgrade as SinonStub)
    ...
    describe('rollbackNodePoolUpgrade', () => {
        it('invokes rollbackNodePoolUpgrade without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.RollbackNodePoolUpgradeRequest', ['name']);
            request.name = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.RollbackNodePoolUpgradeRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.RollbackNodePoolUpgradeRequest', ['zone']);
            request.zone = defaultValue3;
            const defaultValue4 =
              getTypeDefaultValue('.google.container.v1beta1.RollbackNodePoolUpgradeRequest', ['clusterId']);
            request.clusterId = defaultValue4;
            const defaultValue5 =
              getTypeDefaultValue('.google.container.v1beta1.RollbackNodePoolUpgradeRequest', ['nodePoolId']);
            request.nodePoolId = defaultValue5;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }&project_id=${defaultValue2 ?? '' }&zone=${defaultValue3 ?? '' }&cluster_id=${defaultValue4 ?? '' }&node_pool_id=${defaultValue5 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.Operation()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.rollbackNodePoolUpgrade as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.rollbackNodePoolUpgrade as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('setNodePoolManagement', () => {
        it('invokes setNodePoolManagement without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.SetNodePoolManagementRequest', ['name']);
            request.name = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.SetNodePoolManagementRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.SetNodePoolManagementRequest', ['zone']);
            request.zone = defaultValue3;
            const defaultValue4 =
              getTypeDefaultValue('.google.container.v1beta1.SetNodePoolManagementRequest', ['clusterId']);
            request.clusterId = defaultValue4;
            const defaultValue5 =
              getTypeDefaultValue('.google.container.v1beta1.SetNodePoolManagementRequest', ['nodePoolId']);
            request.nodePoolId = defaultValue5;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }&project_id=${defaultValue2 ?? '' }&zone=${defaultValue3 ?? '' }&cluster_id=${defaultValue4 ?? '' }&node_pool_id=${defaultValue5 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.Operation()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.setNodePoolManagement as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.setNodePoolManagement as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('setLabels', () => {
        it('invokes setLabels without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.SetLabelsRequest', ['name']);
            request.name = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.SetLabelsRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.SetLabelsRequest', ['zone']);
            request.zone = defaultValue3;
            const defaultValue4 =
              getTypeDefaultValue('.google.container.v1beta1.SetLabelsRequest', ['clusterId']);
            request.clusterId = defaultValue4;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }&project_id=${defaultValue2 ?? '' }&zone=${defaultValue3 ?? '' }&cluster_id=${defaultValue4 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.Operation()
    ...
    describe('setLegacyAbac', () => {
        it('invokes setLegacyAbac without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.SetLegacyAbacRequest', ['name']);
            request.name = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.SetLegacyAbacRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.SetLegacyAbacRequest', ['zone']);
            request.zone = defaultValue3;
            const defaultValue4 =
              getTypeDefaultValue('.google.container.v1beta1.SetLegacyAbacRequest', ['clusterId']);
            request.clusterId = defaultValue4;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }&project_id=${defaultValue2 ?? '' }&zone=${defaultValue3 ?? '' }&cluster_id=${defaultValue4 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.Operation()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.setLegacyAbac as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.setLegacyAbac as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('startIPRotation', () => {
        it('invokes startIPRotation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.StartIPRotationRequest', ['name']);
            request.name = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.StartIPRotationRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.StartIPRotationRequest', ['zone']);
            request.zone = defaultValue3;
            const defaultValue4 =
              getTypeDefaultValue('.google.container.v1beta1.StartIPRotationRequest', ['clusterId']);
            request.clusterId = defaultValue4;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }&project_id=${defaultValue2 ?? '' }&zone=${defaultValue3 ?? '' }&cluster_id=${defaultValue4 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.Operation()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.startIpRotation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.startIpRotation as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('completeIPRotation', () => {
        it('invokes completeIPRotation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.CompleteIPRotationRequest', ['name']);
            request.name = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.CompleteIPRotationRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.CompleteIPRotationRequest', ['zone']);
            request.zone = defaultValue3;
            const defaultValue4 =
              getTypeDefaultValue('.google.container.v1beta1.CompleteIPRotationRequest', ['clusterId']);
            request.clusterId = defaultValue4;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }&project_id=${defaultValue2 ?? '' }&zone=${defaultValue3 ?? '' }&cluster_id=${defaultValue4 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.Operation()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.completeIpRotation as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.completeIpRotation as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('setNodePoolSize', () => {
        it('invokes setNodePoolSize without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.SetNodePoolSizeRequest', ['name']);
            request.name = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.SetNodePoolSizeRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.SetNodePoolSizeRequest', ['zone']);
            request.zone = defaultValue3;
            const defaultValue4 =
              getTypeDefaultValue('.google.container.v1beta1.SetNodePoolSizeRequest', ['clusterId']);
            request.clusterId = defaultValue4;
            const defaultValue5 =
              getTypeDefaultValue('.google.container.v1beta1.SetNodePoolSizeRequest', ['nodePoolId']);
            request.nodePoolId = defaultValue5;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }&project_id=${defaultValue2 ?? '' }&zone=${defaultValue3 ?? '' }&cluster_id=${defaultValue4 ?? '' }&node_pool_id=${defaultValue5 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.Operation()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.setNodePoolSize as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.setNodePoolSize as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('setNetworkPolicy', () => {
        it('invokes setNetworkPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.SetNetworkPolicyRequest', ['name']);
            request.name = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.SetNetworkPolicyRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.SetNetworkPolicyRequest', ['zone']);
            request.zone = defaultValue3;
            const defaultValue4 =
              getTypeDefaultValue('.google.container.v1beta1.SetNetworkPolicyRequest', ['clusterId']);
            request.clusterId = defaultValue4;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }&project_id=${defaultValue2 ?? '' }&zone=${defaultValue3 ?? '' }&cluster_id=${defaultValue4 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.Operation()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.setNetworkPolicy as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.setNetworkPolicy as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('setMaintenancePolicy', () => {
        it('invokes setMaintenancePolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.SetMaintenancePolicyRequest', ['name']);
            request.name = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.container.v1beta1.SetMaintenancePolicyRequest', ['projectId']);
            request.projectId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.container.v1beta1.SetMaintenancePolicyRequest', ['zone']);
            request.zone = defaultValue3;
            const defaultValue4 =
              getTypeDefaultValue('.google.container.v1beta1.SetMaintenancePolicyRequest', ['clusterId']);
            request.clusterId = defaultValue4;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }&project_id=${defaultValue2 ?? '' }&zone=${defaultValue3 ?? '' }&cluster_id=${defaultValue4 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.Operation()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.setMaintenancePolicy as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.setMaintenancePolicy as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('checkAutopilotCompatibility', () => {
        it('invokes checkAutopilotCompatibility without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.CheckAutopilotCompatibilityRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.CheckAutopilotCompatibilityResponse()
            );
            client.innerApiCalls.checkAutopilotCompatibility = stubSimpleCall(expectedResponse);
            const [response] = await client.checkAutopilotCompatibility(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.checkAutopilotCompatibility as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.checkAutopilotCompatibility as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes checkAutopilotCompatibility without error using callback', async () => {
            ...
            client.innerApiCalls.checkAutopilotCompatibility = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.checkAutopilotCompatibility(
                    request,
                    (err?: Error|null, result?: protos.google.container.v1beta1.ICheckAutopilotCompatibilityResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes checkAutopilotCompatibility with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.checkAutopilotCompatibility = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkAutopilotCompatibility(request), expectedError);
            const actualRequest = (client.innerApiCalls.checkAutopilotCompatibility as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.checkAutopilotCompatibility as SinonStub)
    ...
    describe('listLocations', () => {
        it('invokes listLocations without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.ListLocationsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.ListLocationsResponse()
            );
        ...
        it('invokes listLocations with closed client', async () => {
            const client = new clustermanagerModule.v1beta1.ClusterManagerClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('fetchClusterUpgradeInfo', () => {
        it('invokes fetchClusterUpgradeInfo without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.FetchClusterUpgradeInfoRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.ClusterUpgradeInfo()
            );
            client.innerApiCalls.fetchClusterUpgradeInfo = stubSimpleCall(expectedResponse);
            const [response] = await client.fetchClusterUpgradeInfo(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.fetchClusterUpgradeInfo as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.fetchClusterUpgradeInfo as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes fetchClusterUpgradeInfo without error using callback', async () => {
            ...
            client.innerApiCalls.fetchClusterUpgradeInfo = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.fetchClusterUpgradeInfo(
                    request,
                    (err?: Error|null, result?: protos.google.container.v1beta1.IClusterUpgradeInfo|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes fetchClusterUpgradeInfo with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.fetchClusterUpgradeInfo = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.fetchClusterUpgradeInfo(request), expectedError);
            const actualRequest = (client.innerApiCalls.fetchClusterUpgradeInfo as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.fetchClusterUpgradeInfo as SinonStub)
    ...
    describe('fetchNodePoolUpgradeInfo', () => {
        it('invokes fetchNodePoolUpgradeInfo without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.FetchNodePoolUpgradeInfoRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.container.v1beta1.NodePoolUpgradeInfo()
            );
            client.innerApiCalls.fetchNodePoolUpgradeInfo = stubSimpleCall(expectedResponse);
            const [response] = await client.fetchNodePoolUpgradeInfo(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.fetchNodePoolUpgradeInfo as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.fetchNodePoolUpgradeInfo as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes fetchNodePoolUpgradeInfo without error using callback', async () => {
            ...
            client.innerApiCalls.fetchNodePoolUpgradeInfo = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.fetchNodePoolUpgradeInfo(
                    request,
                    (err?: Error|null, result?: protos.google.container.v1beta1.INodePoolUpgradeInfo|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes fetchNodePoolUpgradeInfo with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.fetchNodePoolUpgradeInfo = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.fetchNodePoolUpgradeInfo(request), expectedError);
            const actualRequest = (client.innerApiCalls.fetchNodePoolUpgradeInfo as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.fetchNodePoolUpgradeInfo as SinonStub)
    ...
    describe('listUsableSubnetworks', () => {
        it('invokes listUsableSubnetworks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.container.v1beta1.ListUsableSubnetworksRequest', ['parent']);
            request.parent = defaultValue1;
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listUsableSubnetworks as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listUsableSubnetworks as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
