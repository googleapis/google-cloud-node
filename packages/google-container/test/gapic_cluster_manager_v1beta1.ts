...
describe('v1beta1.ClusterManagerClient', () => {
    ...
    it('invokes listClusters without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listClusters(
          ...
          (
            err?: Error | null,
            result?: protos.google.container.v1beta1.IListClustersResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getCluster', () => {
    it('invokes getCluster without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.container.v1beta1.GetClusterRequest',
        ['name'],
      );
    ...
    it('invokes getCluster without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getCluster(
          ...
          (
            err?: Error | null,
            result?: protos.google.container.v1beta1.ICluster | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createCluster without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createCluster(
          ...
          (
            err?: Error | null,
            result?: protos.google.container.v1beta1.IOperation | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listOperations without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listOperations(
          ...
          (
            err?: Error | null,
            result?: protos.google.container.v1beta1.IListOperationsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getServerConfig without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getServerConfig(
          ...
          (
            err?: Error | null,
            result?: protos.google.container.v1beta1.IServerConfig | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listNodePools without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listNodePools(
          ...
          (
            err?: Error | null,
            result?: protos.google.container.v1beta1.IListNodePoolsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getNodePool', () => {
    it('invokes getNodePool without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.container.v1beta1.GetNodePoolRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
    ...
    it('invokes getNodePool without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getNodePool(
          ...
          (
            err?: Error | null,
            result?: protos.google.container.v1beta1.INodePool | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes checkAutopilotCompatibility without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.checkAutopilotCompatibility(
          ...
          (
            err?: Error | null,
            result?: protos.google.container.v1beta1.ICheckAutopilotCompatibilityResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listLocations without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listLocations(
          ...
          (
            err?: Error | null,
            result?: protos.google.container.v1beta1.IListLocationsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('completeControlPlaneUpgrade', () => {
    it('invokes completeControlPlaneUpgrade without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.container.v1beta1.CompleteControlPlaneUpgradeRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.completeControlPlaneUpgrade =
        stubSimpleCall(expectedResponse);
      const [response] = await client.completeControlPlaneUpgrade(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.completeControlPlaneUpgrade as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.completeControlPlaneUpgrade as SinonStub
    ...
    it('invokes completeControlPlaneUpgrade with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.completeControlPlaneUpgrade = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
  ...
  describe('listUsableSubnetworks', () => {
    it('invokes listUsableSubnetworks without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.container.v1beta1.UsableSubnetwork(),
        ),
        generateSampleMessage(
          new protos.google.container.v1beta1.UsableSubnetwork(),
        ),
    ...
    it('invokes listUsableSubnetworks without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listUsableSubnetworks(
          ...
          (
            err?: Error | null,
            result?: protos.google.container.v1beta1.IUsableSubnetwork[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listUsableSubnetworksStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.container.v1beta1.UsableSubnetwork) => {
