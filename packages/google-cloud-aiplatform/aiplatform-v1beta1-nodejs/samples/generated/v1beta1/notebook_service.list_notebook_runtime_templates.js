...
function main(parent) {
  // [START aiplatform_v1beta1_generated_NotebookService_ListNotebookRuntimeTemplates_async]
  /**
  ...
  async function callListNotebookRuntimeTemplates() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = aiplatformClient.listNotebookRuntimeTemplatesAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListNotebookRuntimeTemplates();
  // [END aiplatform_v1beta1_generated_NotebookService_ListNotebookRuntimeTemplates_async]
}
