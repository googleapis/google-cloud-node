...
describe('v1beta1.DeploymentResourcePoolServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new deploymentresourcepoolserviceModule.v1beta1.DeploymentResourcePoolServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = deploymentresourcepoolserviceModule.v1beta1.DeploymentResourcePoolServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = deploymentresourcepoolserviceModule.v1beta1.DeploymentResourcePoolServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new deploymentresourcepoolserviceModule.v1beta1.DeploymentResourcePoolServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new deploymentresourcepoolserviceModule.v1beta1.DeploymentResourcePoolServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new deploymentresourcepoolserviceModule.v1beta1.DeploymentResourcePoolServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new deploymentresourcepoolserviceModule.v1beta1.DeploymentResourcePoolServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = deploymentresourcepoolserviceModule.v1beta1.DeploymentResourcePoolServiceClient.port;
            assert(port);
        ...
        it('invokes getDeploymentResourcePool without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getDeploymentResourcePool(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IDeploymentResourcePool|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createDeploymentResourcePool', () => {
        it('invokes createDeploymentResourcePool without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.CreateDeploymentResourcePoolRequest', ['parent']);
        ...
        it('invokes createDeploymentResourcePool without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createDeploymentResourcePool(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IDeploymentResourcePool, protos.google.cloud.aiplatform.v1beta1.ICreateDeploymentResourcePoolOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IDeploymentResourcePool, protos.google.cloud.aiplatform.v1beta1.ICreateDeploymentResourcePoolOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createDeploymentResourcePool as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateDeploymentResourcePool', () => {
        it('invokes updateDeploymentResourcePool without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.UpdateDeploymentResourcePoolRequest()
            );
            request.deploymentResourcePool ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.UpdateDeploymentResourcePoolRequest', ['deploymentResourcePool', 'name']);
        ...
        it('invokes updateDeploymentResourcePool without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updateDeploymentResourcePool(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IDeploymentResourcePool, protos.google.cloud.aiplatform.v1beta1.IUpdateDeploymentResourcePoolOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IDeploymentResourcePool, protos.google.cloud.aiplatform.v1beta1.IUpdateDeploymentResourcePoolOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateDeploymentResourcePool as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteDeploymentResourcePool', () => {
        it('invokes deleteDeploymentResourcePool without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.DeleteDeploymentResourcePoolRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listDeploymentResourcePools', () => {
        it('invokes listDeploymentResourcePools without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ListDeploymentResourcePoolsRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('queryDeployedModels', () => {
        it('invokes queryDeployedModels without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.QueryDeployedModelsRequest', ['deploymentResourcePool']);
            ...
            const expectedHeaderRequestParams = `deployment_resource_pool=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.DeployedModel()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.DeployedModel()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.DeployedModel()),
            ];
        ...
        it('invokes queryDeployedModels without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.queryDeployedModels(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IDeployedModel[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes queryDeployedModelsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.DeployedModel) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
