...
function main() {
  ...
  const exampleStoreServiceClient = new aiplatform.ExampleStoreServiceClient();
  const extensionExecutionServiceClient = new aiplatform.ExtensionExecutionServiceClient();
  const extensionRegistryServiceClient = new aiplatform.ExtensionRegistryServiceClient();
  ...
  const memoryBankServiceClient = new aiplatform.MemoryBankServiceClient();
  ...
  const modelMonitoringServiceClient = new aiplatform.ModelMonitoringServiceClient();
