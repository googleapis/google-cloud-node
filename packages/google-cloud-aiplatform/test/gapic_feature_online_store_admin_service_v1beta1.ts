    ...
    it('invokes getFeatureOnlineStore without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getFeatureOnlineStore(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IFeatureOnlineStore | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getFeatureView without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getFeatureView(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IFeatureView | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes syncFeatureView without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.syncFeatureView(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.ISyncFeatureViewResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getFeatureViewSync without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getFeatureViewSync(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IFeatureViewSync | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listFeatureOnlineStoresStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.aiplatform.v1beta1.FeatureOnlineStore,
          ) => {
  ...
  describe('listFeatureViews', () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listFeatureViews(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.aiplatform.v1beta1.IFeatureView[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listFeatureViewsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.aiplatform.v1beta1.FeatureView) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listFeatureViewSyncs(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.aiplatform.v1beta1.IFeatureViewSync[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listFeatureViewSyncsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.aiplatform.v1beta1.FeatureViewSync,
          ) => {
            responses.push(response);
          },
        );
